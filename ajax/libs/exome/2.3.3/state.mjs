...
var $ = (e, t, o) => t in e ? O(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o, y = (e, t) => {
  for (var o in t || (t = {}))
    l.call(t, o) && $(e, o, t[o]);
  if (c)
    for (var o of c(t))
...
import { exomeId as T, exomeName as N, runMiddleware as S, updateAll as R } from "exome";
var b = {}, D = (e) => {
