...
var S = (e, n, t) => n in e ? V(e, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[n] = t, $ = (e, n) => {
  for (var t in n || (n = {}))
...
import { Exome as X, getExomeId as v, updateAll as z } from "exome";
var b = /* @__PURE__ */ new Map();
function D(e, n = []) {
  if (e == null || typeof e != "object")
    return e;
  if (e instanceof X && v(e)) {
    let o = v(e);
    if (n.indexOf(o) > -1)
      return {
        $$exome_id: o
...
// src/devtools-exome.ts
var w = /* @__PURE__ */ new Map(), _ = [], C = Object.getOwnPropertyDescriptor, H = ({
  name: e = "Exome",
  maxAge: n = 20,
  ignoreListActions: t = [],
  ignoreListStores: o = []
...
https://github.com/Marcisbee/exome-devtools`
  ...
  return window.addEventListener("beforeunload", i.disconnect, {
    ...
    if (t.indexOf(`${p}.${c}`) > -1)
      return;
    let g = m(s), J = String(Math.random()), L = ((h = new Error().stack) == null ? void 0 : h.split(/\n/g)[6]) || "", A = performance.now();
    f += 1;
    let x = {
      id: J,
      name: c,
