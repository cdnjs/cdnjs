...
import { Exome as V, getExomeId as v, updateAll as z } from "exome";
...
var D = () => {
  ...
  return y.subscribe((r) => {
    ...
    if (c)
      return O.has(c) || O.set(c, /* @__PURE__ */ new Map()), i === "NEW" && ((d = O.get(c)) == null || d.set(v(r), r), y.send({ type: u, payload: void 0 }, D())), () => {
        let p = [];
        try {
...
var w = /* @__PURE__ */ new Map(), _ = [], C = Object.getOwnPropertyDescriptor, H = ({
  ...
  return window.addEventListener("beforeunload", i.disconnect, {
    ...
    if (w.has(p) || w.set(p, /* @__PURE__ */ new Map()), c === "NEW")
      return (M = w.get(p)) == null || M.set(d, s), i.send({
        event: "send",
        type: "state",
        payload: [d, m(s)]
      }), () => {
