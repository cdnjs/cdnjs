...
// src/constants.ts
var m = Symbol(), f = Symbol(), u = "function", x = "constructor";
  ...
  for (; (e = Object.getPrototypeOf(e)) && e !== Object.prototype; )
    r.push(
      ...Object.getOwnPropertyNames(e).filter(
        (o) => {
          var t;
          return o !== x && e.hasOwnProperty(o) && typeof ((t = Object.getOwnPropertyDescriptor(e, o)) == null ? void 0 : t.get) !== u;
        }
      )
    );
  return r;
...
var E = class {
  constructor() {
    let r = this[f] || this[x].name, o = this[m] = r + "-" + N(), t = a(this, "NEW", []);
