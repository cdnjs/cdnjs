// src/constants.ts
var m = Symbol(), u = Symbol(), c = "function", x = "constructor";
  ...
  for (; (e = Object.getPrototypeOf(e)) && e !== Object.prototype; )
    r.push(
      ...Object.getOwnPropertyNames(e).filter(
        (o) => {
          var t;
          return o !== x && e.hasOwnProperty(o) && typeof ((t = Object.getOwnPropertyDescriptor(e, o)) == null ? void 0 : t.get) !== c;
        }
      )
    );
  return r;
...
var T = class {
  constructor() {
    let r = this[u] || this[x].name, o = this[m] = r + "-" + O(), t = f(this, "NEW", []);
