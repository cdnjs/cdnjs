...
var B = Object.getOwnPropertyNames, v = Object.getOwnPropertySymbols;
...
var G = (e, n) => {
  ...
  if (n && typeof n == "object" || typeof n == "function")
    for (let s of B(n))
      !N.call(e, s) && s !== t && w(e, s, { get: () => n[s], enumerable: !(o = z(n, s)) || o.enumerable });
  return e;
};
var F = (e) => W(w({}, "__esModule", { value: !0 }), e);

// src/devtools.ts
var H = {};
G(H, {
  exomeReduxDevtools: () => C,
  unstableExomeDevtools: () => J
});
module.exports = F(H);
...
var u = require("exome"), _ = /* @__PURE__ */ new Map(), $ = [], P = Object.getOwnPropertyDescriptor, J = ({
  name: e = "Exome",
  maxAge: n = 20,
  ignoreListActions: t = [],
  ignoreListStores: o = []
...
https://github.com/Marcisbee/exome-devtools`
  ...
  return window.addEventListener("beforeunload", a.disconnect, {
    ...
    if (t.indexOf(`${p}.${c}`) > -1)
      return;
    let b = x(i), V = String(Math.random()), X = ((S = new Error().stack) == null ? void 0 : S.split(/\n/g)[6]) || "", h = performance.now();
    f += 1;
    let E = {
      id: V,
      name: c,
...
function x(e) {
  ...
  for (let r of t) {
    if (r === "constructor")
      continue;
    if (typeof ((g = P(n, r)) == null ? void 0 : g.get) == "function") {
      s[`$$exome_gt:${r}`] = null;
      continue;
    }
    s[`$$exome_ac:${r}`] = String("@TODO");
  }
  for (let r of o) {
    let a = (f = P(e, r)) == null ? void 0 : f.value;
