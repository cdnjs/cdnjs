    ...
    function(module, exports, __webpack_require__) {
        ...
        var _createClass = function() {
            ...
            return _inherits(VirtualScroll, _Component), _createClass(VirtualScroll, [ {
                ...
                key: "render",
                value: function() {
                    var _props = this.props, autoHeight = _props.autoHeight, className = _props.className, estimatedRowSize = _props.estimatedRowSize, height = _props.height, noRowsRenderer = _props.noRowsRenderer, rowHeight = _props.rowHeight, overscanRowCount = _props.overscanRowCount, rowClassName = _props.rowClassName, rowCount = _props.rowCount, rowStyle = _props.rowStyle, scrollToAlignment = _props.scrollToAlignment, scrollToIndex = _props.scrollToIndex, scrollTop = _props.scrollTop, style = _props.style, tabIndex = _props.tabIndex, width = _props.width, classNames = (0, 
