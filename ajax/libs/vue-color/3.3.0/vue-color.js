...
const Pe = (e, t = 20) => {
  ...
  setup(e, { emit: t }) {
    ...
    const d = Pe(_, 20);
    function A(h) {
      h.type.startsWith("mouse") ? (window.addEventListener("mousemove", d), window.addEventListener("mouseup", d), window.addEventListener("mouseup", k)) : h.type.startsWith("touch") && (window.addEventListener("touchmove", d), window.addEventListener("touchend", d), window.addEventListener("touchend", k));
    }
    function k() {
      H();
    }
  ...
  for (const [r, l] of t)
    a[r] = l;
  return a;
}, Se = /* @__PURE__ */ N(gt, [["__scopeId", "data-v-cf852467"]]), $e = (e) => typeof e < "u", mt = { class: "vc-base-slider" }, _t = {
  key: 0,
  class: "background"
