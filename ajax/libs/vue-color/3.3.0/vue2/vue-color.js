...
const Ee = (n, a = 20) => {
  ...
  setup(n, { emit: a }) {
    ...
    const d = Ee(b, 20);
    function k(h) {
      h.type.startsWith("mouse") ? (window.addEventListener("mousemove", d), window.addEventListener("mouseup", d), window.addEventListener("mouseup", C)) : h.type.startsWith("touch") && (window.addEventListener("touchmove", d), window.addEventListener("touchend", d), window.addEventListener("touchend", C));
    }
    function C() {
      A();
    }
