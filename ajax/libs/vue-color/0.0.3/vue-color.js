...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".c-photoshop {\n  background: #dcdcdc;\n  border-radius: 4px;\n  box-shadow: 0 0 0 1px rgba(0,0,0,0.25), 0 8px 16px rgba(0,0,0,0.15);\n  box-sizing: initial;\n  width: 513px;\n  font-family: Roboto;\n}\n.c-photoshop .head {\n  background-image: -webkit-linear-gradient(top, #f0f0f0 0%, #d4d4d4 100%);\n  background-image: linear-gradient(-180deg, #f0f0f0 0%, #d4d4d4 100%);\n  border-bottom: 1px solid #b1b1b1;\n  box-shadow: inset 0 1px 0 0 rgba(255,255,255,0.2), inset 0 -1px 0 0 rgba(0,0,0,0.02);\n  height: 23px;\n  line-height: 24px;\n  border-radius: 4px 4px 0 0;\n  font-size: 13px;\n  color: #4d4d4d;\n  text-align: center;\n}\n.c-photoshop .body {\n  padding: 15px;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n}\n.c-photoshop .saturation-wrap {\n  width: 256px;\n  height: 256px;\n  position: relative;\n  border: 2px solid #b3b3b3;\n  border-bottom: 2px solid #f0f0f0;\n  overflow: hidden;\n}\n.c-photoshop .hue-wrap {\n  position: relative;\n  height: 256px;\n  width: 19px;\n  margin-left: 10px;\n  border: 2px solid #b3b3b3;\n  border-bottom: 2px solid #f0f0f0;\n}\n.c-photoshop .hue-pointer {\n  position: relative;\n}\n.c-photoshop .hue-pointer .left,\n.c-photoshop .hue-pointer .right {\n  position: absolute;\n  width: 0;\n  height: 0;\n  border-style: solid;\n  border-width: 5px 0 5px 8px;\n  border-color: transparent transparent transparent #555;\n}\n.c-photoshop .hue-pointer .left:after,\n.c-photoshop .hue-pointer .right:after {\n  content: \"\";\n  width: 0;\n  height: 0;\n  border-style: solid;\n  border-width: 4px 0 4px 6px;\n  border-color: transparent transparent transparent #fff;\n  position: absolute;\n  top: 1px;\n  left: 1px;\n  -webkit-transform: translate(-8px, -5px);\n          transform: translate(-8px, -5px);\n}\n.c-photoshop .hue-pointer .left {\n  -webkit-transform: translate(-13px, -4px);\n          transform: translate(-13px, -4px);\n}\n.c-photoshop .hue-pointer .right {\n  -webkit-transform: translate(20px, -4px) rotate(180deg);\n          transform: translate(20px, -4px) rotate(180deg);\n}\n.c-photoshop .controls {\n  width: 180px;\n  margin-left: 10px;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n}\n.c-photoshop .actions {\n  margin-left: 20px;\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n      -ms-flex: 1;\n          flex: 1;\n}\n.c-photoshop .actions .ac-btn {\n  background-image: -webkit-linear-gradient(top, #fff 0%, #e6e6e6 100%);\n  background-image: linear-gradient(-180deg, #fff 0%, #e6e6e6 100%);\n  border: 1px solid #878787;\n  border-radius: 2px;\n  height: 20px;\n  box-shadow: 0 1px 0 0 #eaeaea;\n  font-size: 14px;\n  color: #000;\n  line-height: 20px;\n  text-align: center;\n  margin-bottom: 10px;\n}\n.c-photoshop .previews {\n  width: 60px;\n}\n.c-photoshop .previews .swatches {\n  border: 1px solid #b3b3b3;\n  border-bottom: 1px solid #f0f0f0;\n  margin-bottom: 2px;\n  margin-top: 1px;\n}\n.c-photoshop .previews .pr-color {\n  height: 34px;\n  box-shadow: inset 1px 0 0 #000, inset -1px 0 0 #000, inset 0 1px 0 #000;\n}\n.c-photoshop .previews .label {\n  font-size: 14px;\n  color: #000;\n  text-align: center;\n}\n.c-photoshop .fields {\n  padding-top: 5px;\n  padding-bottom: 9px;\n  width: 80px;\n  position: relative;\n}\n.c-photoshop .fields .divider {\n  height: 5px;\n}\n.c-photoshop .fields .input {\n  margin-left: 40%;\n  width: 40%;\n  height: 18px;\n  border: 1px solid #888;\n  box-shadow: inset 0 1px 1px rgba(0,0,0,0.1), 0 1px 0 0 #ececec;\n  margin-bottom: 5px;\n  font-size: 13px;\n  padding-left: 3px;\n  margin-right: 10px;\n}\n.c-photoshop .fields .label {\n  top: 0;\n  left: 0;\n  width: 34px;\n  text-transform: uppercase;\n  font-size: 13px;\n  height: 18px;\n  line-height: 22px;\n  position: absolute;\n}\n.c-photoshop .fields .hex .input {\n  margin-left: 20%;\n  width: 80%;\n  height: 18px;\n  border: 1px solid #888;\n  box-shadow: inset 0 1px 1px rgba(0,0,0,0.1), 0 1px 0 0 #ececec;\n  margin-bottom: 6px;\n  font-size: 13px;\n  padding-left: 3px;\n}\n.c-photoshop .fields .hex .label {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 14px;\n  text-transform: uppercase;\n  font-size: 13px;\n  height: 18px;\n  line-height: 22px;\n}\n", "", {"version":3,"sources":["/./src/components/Photoshop.vue.style","/./src/components/Photoshop.vue"],"names":[],"mappings":"AACA;EACE,oBAAA;EACA,mBAAA;EACA,oEAAA;EACA,oBAAA;EACA,aAAA;EACA,oBAAA;CCAD;ADCC;EACE,yEAAA;EAAA,qEAAA;EACA,iCAAA;EACA,qFAAA;EACA,aAAA;EACA,kBAAA;EACA,2BAAA;EACA,gBAAA;EACA,eAAA;EACA,mBAAA;CCCH;ADAC;EACE,cAAA;EACA,qBAAA;EAAA,sBAAA;EAAA,qBAAA;EAAA,cAAA;CCEH;ADDC;EACE,aAAA;EACA,cAAA;EACA,mBAAA;EACA,0BAAA;EACA,iCAAA;EACA,iBAAA;CCGH;ADFC;EACE,mBAAA;EACA,cAAA;EACA,YAAA;EACA,kBAAA;EACA,0BAAA;EACA,iCAAA;CCIH;ADHC;EACE,mBAAA;CCKH;ADJG;;EAEE,mBAAA;EACA,SAAA;EACA,UAAA;EACA,oBAAA;EACA,4BAAA;EACA,uDAAA;CCML;ADLK;;EACE,YAAA;EACA,SAAA;EACA,UAAA;EACA,oBAAA;EACA,4BAAA;EACA,uDAAA;EACA,mBAAA;EACA,SAAA;EACA,UAAA;EACA,yCAAA;UAAA,iCAAA;CCQP;ADPG;EACE,0CAAA;UAAA,kCAAA;CCSL;ADRG;EACE,wDAAA;UAAA,gDAAA;CCUL;ADTC;EACE,aAAA;EACA,kBAAA;EACA,qBAAA;EAAA,sBAAA;EAAA,qBAAA;EAAA,cAAA;CCWH;ADVC;EACE,kBAAA;EACA,oBAAA;EAAA,gBAAA;MAAA,YAAA;UAAA,QAAA;CCYH;ADXG;EACE,sEAAA;EAAA,kEAAA;EACA,0BAAA;EACA,mBAAA;EACA,aAAA;EACA,8BAAA;EACA,gBAAA;EACA,YAAA;EACA,kBAAA;EACA,mBAAA;EACA,oBAAA;CCaL;ADZC;EACE,YAAA;CCcH;ADbG;EACE,0BAAA;EACA,iCAAA;EACA,mBAAA;EACA,gBAAA;CCeL;ADdG;EACE,aAAA;EACA,wEAAA;CCgBL;ADfG;EACE,gBAAA;EACA,YAAA;EACA,mBAAA;CCiBL;ADfC;EACE,iBAAA;EACA,oBAAA;EACA,YAAA;EACA,mBAAA;CCiBH;ADhBG;EACE,YAAA;CCkBL;ADjBG;EACE,iBAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;EACA,+DAAA;EACA,mBAAA;EACA,gBAAA;EACA,kBAAA;EACA,mBAAA;CCmBL;ADlBG;EACE,OAAA;EACA,QAAA;EACA,YAAA;EACA,0BAAA;EACA,gBAAA;EACA,aAAA;EACA,kBAAA;EACA,mBAAA;CCoBL;ADlBK;EACE,iBAAA;EACA,WAAA;EACA,aAAA;EACA,uBAAA;EACA,+DAAA;EACA,mBAAA;EACA,gBAAA;EACA,kBAAA;CCoBP;ADnBK;EACE,mBAAA;EACA,OAAA;EACA,QAAA;EACA,YAAA;EACA,0BAAA;EACA,gBAAA;EACA,aAAA;EACA,kBAAA;CCqBP","file":"Photoshop.vue","sourcesContent":["\n.c-photoshop\n  background #DCDCDC\n  border-radius 4px\n  box-shadow 0 0 0 1px rgba(0,0,0,.25), 0 8px 16px rgba(0,0,0,.15)\n  box-sizing initial\n  width 513px\n  font-family Roboto\n  .head\n    background-image linear-gradient(-180deg, #F0F0F0 0%, #D4D4D4 100%)\n    border-bottom 1px solid #B1B1B1\n    box-shadow inset 0 1px 0 0 rgba(255,255,255,.2), inset 0 -1px 0 0 rgba(0,0,0,.02)\n    height 23px\n    line-height 24px\n    border-radius 4px 4px 0 0\n    font-size 13px\n    color #4D4D4D\n    text-align center\n  .body\n    padding 15px\n    display flex\n  .saturation-wrap\n    width 256px\n    height 256px\n    position relative\n    border 2px solid #B3B3B3\n    border-bottom 2px solid #F0F0F0\n    overflow hidden\n  .hue-wrap\n    position relative\n    height 256px\n    width 19px\n    margin-left 10px\n    border 2px solid #B3B3B3\n    border-bottom 2px solid #F0F0F0\n  .hue-pointer\n    position relative\n    .left\n    .right\n      position absolute\n      width 0\n      height 0\n      border-style solid\n      border-width 5px 0 5px 8px\n      border-color transparent transparent transparent #555\n      &:after\n        content \"\"\n        width 0\n        height 0\n        border-style solid\n        border-width 4px 0 4px 6px\n        border-color transparent transparent transparent #fff\n        position absolute\n        top 1px\n        left 1px\n        transform translate(-8px, -5px)\n    .left\n      transform translate(-13px, -4px)\n    .right\n      transform translate(20px, -4px) rotate(180deg)\n  .controls\n    width 180px\n    margin-left 10px\n    display flex\n  .actions\n    margin-left 20px\n    flex 1\n    .ac-btn\n      background-image linear-gradient(-180deg, #FFFFFF 0%, #E6E6E6 100%)\n      border 1px solid #878787\n      border-radius 2px\n      height 20px\n      box-shadow 0 1px 0 0 #EAEAEA\n      font-size 14px\n      color #000\n      line-height 20px\n      text-align center\n      margin-bottom 10px\n  .previews\n    width 60px\n    .swatches\n      border 1px solid #B3B3B3\n      border-bottom 1px solid #F0F0F0\n      margin-bottom 2px\n      margin-top 1px\n    .pr-color\n      height 34px\n      box-shadow inset 1px 0 0 #000, inset -1px 0 0 #000, inset 0 1px 0 #000\n    .label\n      font-size 14px\n      color #000\n      text-align center\n  \n  .fields\n    padding-top 5px\n    padding-bottom 9px\n    width 80px\n    position relative\n    .divider\n      height 5px\n    .input\n      margin-left 40%\n      width 40%\n      height 18px\n      border 1px solid #888888\n      box-shadow inset 0 1px 1px rgba(0,0,0,.1), 0 1px 0 0 #ECECEC\n      margin-bottom 5px\n      font-size 13px\n      padding-left 3px\n      margin-right 10px\n    .label\n      top 0\n      left 0\n      width 34px\n      text-transform uppercase\n      font-size 13px\n      height 18px\n      line-height 22px\n      position absolute\n    .hex \n      .input\n        margin-left 20%\n        width 80%\n        height 18px\n        border 1px solid #888888\n        box-shadow inset 0 1px 1px rgba(0,0,0,.1), 0 1px 0 0 #ECECEC\n        margin-bottom 6px\n        font-size 13px\n        padding-left 3px\n      .label\n        position absolute\n        top 0\n        left 0\n        width 14px\n        text-transform uppercase\n        font-size 13px\n        height 18px\n        line-height 22px\n",".c-photoshop {\n  background: #dcdcdc;\n  border-radius: 4px;\n  box-shadow: 0 0 0 1px rgba(0,0,0,0.25), 0 8px 16px rgba(0,0,0,0.15);\n  box-sizing: initial;\n  width: 513px;\n  font-family: Roboto;\n}\n.c-photoshop .head {\n  background-image: linear-gradient(-180deg, #f0f0f0 0%, #d4d4d4 100%);\n  border-bottom: 1px solid #b1b1b1;\n  box-shadow: inset 0 1px 0 0 rgba(255,255,255,0.2), inset 0 -1px 0 0 rgba(0,0,0,0.02);\n  height: 23px;\n  line-height: 24px;\n  border-radius: 4px 4px 0 0;\n  font-size: 13px;\n  color: #4d4d4d;\n  text-align: center;\n}\n.c-photoshop .body {\n  padding: 15px;\n  display: flex;\n}\n.c-photoshop .saturation-wrap {\n  width: 256px;\n  height: 256px;\n  position: relative;\n  border: 2px solid #b3b3b3;\n  border-bottom: 2px solid #f0f0f0;\n  overflow: hidden;\n}\n.c-photoshop .hue-wrap {\n  position: relative;\n  height: 256px;\n  width: 19px;\n  margin-left: 10px;\n  border: 2px solid #b3b3b3;\n  border-bottom: 2px solid #f0f0f0;\n}\n.c-photoshop .hue-pointer {\n  position: relative;\n}\n.c-photoshop .hue-pointer .left,\n.c-photoshop .hue-pointer .right {\n  position: absolute;\n  width: 0;\n  height: 0;\n  border-style: solid;\n  border-width: 5px 0 5px 8px;\n  border-color: transparent transparent transparent #555;\n}\n.c-photoshop .hue-pointer .left:after,\n.c-photoshop .hue-pointer .right:after {\n  content: \"\";\n  width: 0;\n  height: 0;\n  border-style: solid;\n  border-width: 4px 0 4px 6px;\n  border-color: transparent transparent transparent #fff;\n  position: absolute;\n  top: 1px;\n  left: 1px;\n  transform: translate(-8px, -5px);\n}\n.c-photoshop .hue-pointer .left {\n  transform: translate(-13px, -4px);\n}\n.c-photoshop .hue-pointer .right {\n  transform: translate(20px, -4px) rotate(180deg);\n}\n.c-photoshop .controls {\n  width: 180px;\n  margin-left: 10px;\n  display: flex;\n}\n.c-photoshop .actions {\n  margin-left: 20px;\n  flex: 1;\n}\n.c-photoshop .actions .ac-btn {\n  background-image: linear-gradient(-180deg, #fff 0%, #e6e6e6 100%);\n  border: 1px solid #878787;\n  border-radius: 2px;\n  height: 20px;\n  box-shadow: 0 1px 0 0 #eaeaea;\n  font-size: 14px;\n  color: #000;\n  line-height: 20px;\n  text-align: center;\n  margin-bottom: 10px;\n}\n.c-photoshop .previews {\n  width: 60px;\n}\n.c-photoshop .previews .swatches {\n  border: 1px solid #b3b3b3;\n  border-bottom: 1px solid #f0f0f0;\n  margin-bottom: 2px;\n  margin-top: 1px;\n}\n.c-photoshop .previews .pr-color {\n  height: 34px;\n  box-shadow: inset 1px 0 0 #000, inset -1px 0 0 #000, inset 0 1px 0 #000;\n}\n.c-photoshop .previews .label {\n  font-size: 14px;\n  color: #000;\n  text-align: center;\n}\n.c-photoshop .fields {\n  padding-top: 5px;\n  padding-bottom: 9px;\n  width: 80px;\n  position: relative;\n}\n.c-photoshop .fields .divider {\n  height: 5px;\n}\n.c-photoshop .fields .input {\n  margin-left: 40%;\n  width: 40%;\n  height: 18px;\n  border: 1px solid #888;\n  box-shadow: inset 0 1px 1px rgba(0,0,0,0.1), 0 1px 0 0 #ececec;\n  margin-bottom: 5px;\n  font-size: 13px;\n  padding-left: 3px;\n  margin-right: 10px;\n}\n.c-photoshop .fields .label {\n  top: 0;\n  left: 0;\n  width: 34px;\n  text-transform: uppercase;\n  font-size: 13px;\n  height: 18px;\n  line-height: 22px;\n  position: absolute;\n}\n.c-photoshop .fields .hex .input {\n  margin-left: 20%;\n  width: 80%;\n  height: 18px;\n  border: 1px solid #888;\n  box-shadow: inset 0 1px 1px rgba(0,0,0,0.1), 0 1px 0 0 #ececec;\n  margin-bottom: 6px;\n  font-size: 13px;\n  padding-left: 3px;\n}\n.c-photoshop .fields .hex .label {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 14px;\n  text-transform: uppercase;\n  font-size: 13px;\n  height: 18px;\n  line-height: 22px;\n}\n"],"sourceRoot":"webpack://"}]);
