/*! qwest 1.5.2 (https://github.com/pyrsmk/qwest) */
		...
		var send=function(){
			...
			if(crossOrigin){
				if(!('withCredentials' in xhr) && win.XDomainRequest){
					if(xhr.responseType=='auto'){
						throw "XDomainRequest does not support the auto mode, please specify explicitly your response type";
					}
