...
var hatExports = {};
var hat$1 = {
  get exports(){ return hatExports; },
  set exports(v){ hatExports = v; },
};
...
var Point$1 = function(ctx, geojson) {
...
var traverseExports = {};
var traverse$2 = {
  get exports(){ return traverseExports; },
  set exports(v){ traverseExports = v; },
};
...
function setupAPI(ctx, api) {
  ...
  api.add = function (geojson) {
    var featureCollection = JSON.parse(JSON.stringify(geojsonNormalize$1(geojson)));

    var ids = featureCollection.features.map(function (feature) {
      feature.id = feature.id || hatExports();
