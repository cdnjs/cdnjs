...
${p}o ${m.helpSection_flags||"Boolean options"}:[0m`," -6, --ipv6                  Generate IPv6 address."," -m, --mac                   Generate MAC address.",` -q, --quiet                 ${m.optionDesc_quiet||"Suppress all logging except errors"}.`],infoCmds:[`
