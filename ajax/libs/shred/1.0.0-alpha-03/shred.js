...
(function() {
  var Authorization, EventChannel, base64, clone, include, overload, querystring, request, resolve_url, resource, returning, type, _ref,
    __slice = [].slice;
  ...
  EventChannel = require("mutual").EventChannel;

  request = require("./request").request;

  returning = function(value, block) {
    block(value);
    return value;
  };
