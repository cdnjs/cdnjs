...
(function (global, factory) {
  ...
  var template$1G = (function(){var $0,$1=void 0,$3=!0,$5={"class":"bell-description-title"},$6={"class":"bell-description-extra"},$7={"class":"bell-description-header"},$8={"class":"bell-description-item-label"},$9={"class":"bell-description-item-content"},$10={"class":"bell-description-item-wrapper"},$11={"class":"bell-description-row"},$12={"class":"bell-description-table"},$13={"class":"bell-description-cell bell-description-item-label"};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_A,_B,_C,_D,_E,_F,_G,_H,_I,_M,_N,_L){_L.push(function(_K){_p(_I,_I.length-1,"style").value?_K.nativeStyles=_b(_p(_I,_I.length-1,"style").value):$1;return _K}({children:function(){var _L=[];_p(_I,_I.length-1,"title").value?_L.push({children:function(){var _L=[];_L.push({context:_A,nativeAttrs:$5,operator:_v,tag:"div",text:_s(_p(_I,_I.length-1,"title").value),type:3});_p(_I,_I.length-1,"$slot_extra").value?_L.push({children:function(){var _L=[];($0={children:_k("$slot_extra"),context:_A,operator:_z,tag:"slot",type:7},$0.children&&$0.children.length&&_L.push($0));return _L.length?_L:$1}(),context:_A,nativeAttrs:$6,operator:_v,tag:"div",type:3}):_L.push({isPure:$3,operator:_u,text:"",type:2});return _L.length?_L:$1}(),context:_A,nativeAttrs:$7,operator:_v,tag:"div",type:3}):_L.push({isPure:$3,operator:_u,text:"",type:2});_p(_I,_I.length-1,"simple").value?_L.push({children:function(){var _L=[];_i(_p(_I,_I.length-1,"cells"),function(_I,_M,_N,_O,rowIndex){_L.push({children:function(){var _L=[];_i(($0=_I[_I.length-1],_r($0.getScope(),$0.keypath)),function(_I,_M,_N,_O,colIndex){_L.push(function(_K){_r(_M.span,_I[_I.length-1].getKeypath("span")).value>1?_l(_K,"nativeAttrs","colspan",_m("colspan",(_r(_M.span,_I[_I.length-1].getKeypath("span")).value*2)-1)):$1;return _K}({children:function(){var _L=[];_L.push({children:function(){var _L=[];_L.push({context:_A,nativeAttrs:$8,operator:_v,tag:"div",text:_s(_r(_M.label,_I[_I.length-1].getKeypath("label")).value),type:3});_L.push({children:function(){var _L=[];($0={children:_k("$slot_"+(_r(_M.name,_I[_I.length-1].getKeypath("name")).value)),context:_A,operator:_z,tag:"slot",type:7},$0.children&&$0.children.length&&_L.push($0));return _L.length?_L:$1}(),context:_A,nativeAttrs:$9,operator:_v,tag:"div",type:3});return _L.length?_L:$1}(),context:_A,nativeAttrs:$10,operator:_v,tag:"div",type:3});return _L.length?_L:$1}(),context:_A,nativeAttrs:{"class":"bell-description-cell"},operator:_v,tag:"td",type:3}));});return _L.length?_L:$1}(),context:_A,nativeAttrs:$11,operator:_v,tag:"tr",type:3});});return _L.length?_L:$1}(),context:_A,nativeAttrs:$12,operator:_v,tag:"table",type:3}):_L.push({children:function(){var _L=[];_i(_p(_I,_I.length-1,"cells"),function(_I,_M,_N,_O,rowIndex){_L.push({children:function(){var _L=[];_i(($0=_I[_I.length-1],_r($0.getScope(),$0.keypath)),function(_I,_M,_N,_O,colIndex){_L.push({context:_A,nativeAttrs:$13,operator:_v,tag:"td",text:_s(_r(_M.label,_I[_I.length-1].getKeypath("label")).value),type:3});_L.push(function(_K){_r(_M.span,_I[_I.length-1].getKeypath("span")).value>1?_l(_K,"nativeAttrs","colspan",_m("colspan",(_r(_M.span,_I[_I.length-1].getKeypath("span")).value*2)-1)):$1;return _K}({children:function(){var _L=[];($0={children:_k("$slot_"+(_r(_M.name,_I[_I.length-1].getKeypath("name")).value)),context:_A,operator:_z,tag:"slot",type:7},$0.children&&$0.children.length&&_L.push($0));return _L.length?_L:$1}(),context:_A,nativeAttrs:{"class":"bell-description-cell bell-description-item-content"},operator:_v,tag:"td",type:3}));});return _L.length?_L:$1}(),context:_A,nativeAttrs:$11,operator:_v,tag:"tr",type:3});});return _L.length?_L:$1}(),context:_A,nativeAttrs:$12,operator:_v,tag:"table",type:3});return _L.length?_L:$1}(),context:_A,nativeAttrs:{"class":"bell-description"+(_p(_I,_I.length-1,"simple").value?" bell-description-simple":" bell-description-bordered"+(_p(_I,_I.length-1,"size").value?" bell-description-"+_s(_p(_I,_I.length-1,"size").value):""))+(_p(_I,_I.length-1,"className").value?" "+_s(_p(_I,_I.length-1,"className").value):"")},operator:_v,tag:"div",type:3}));}})();
