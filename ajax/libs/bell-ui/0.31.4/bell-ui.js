...
module.exports = (function(){var $0,$1=void 0,$2=null,$3=!0,$4=!1,$5={class:'bell-list-empty'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_A,_B,_C,_D,_E,_F,_G,_H,_I,_J,_K,_O,_P,_N){_N.push({children:function(){var _N=[];($0={children:_k('$slot_children')||function(){var _N=[];_N.push({context:_D,operator:_z,slots:{$slot_children:function(_L){var _N=[];_N.push({isPure:$3,operator:_w,text:'暂无数据',type:1});return _N.length?_N:$1}},tag:'Empty',type:4});return _N.length?_N:$1}(),context:_D,operator:_C,tag:'slot',type:7},$0.children&&$0.children.length&&_N.push($0));return _N.length?_N:$1}(),context:_D,nativeAttrs:$5,operator:_y,tag:'div',type:3})}})();
