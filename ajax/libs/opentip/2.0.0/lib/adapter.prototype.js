...
(function($) {
  ...
  Adapter = (function() {
    ...
    Adapter.prototype.wrap = function(element) {
      $(element);
      if (((element != null ? element.length : void 0) != null) && element.length > 1) {
    ...
    Adapter.prototype.append = function(element, child) {
      return this.wrap(element).insert(child);
    };
    ...
    Adapter.prototype.observe = function(element, eventName, observer) {
      return this.wrap(element).observe(eventName, observer);
    };

    Adapter.prototype.stopObserving = function(element, eventName, observer) {
      return this.wrap(element).stopObserving(eventName, observer);
    };
    ...
    Adapter.prototype.extend = function() {
      var source, sources, target, _i, _len, _results;
      target = arguments[0], sources = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      _results = [];
      for (_i = 0, _len = sources.length; _i < _len; _i++) {
        source = sources[_i];
        _results.push(Object.extend(target, source));
      }
      return _results;
    };
