...
(function (factory) {
  ...
  var _objectKeysInternal = function _objectKeysInternal(object, names) {
    ...
    for (key in O) {
      if (key != IE_PROTO$2) _has(O, key) && result.push(key);
  ...
  $Symbol[PROTOTYPE][TO_PRIMITIVE$1] || _hide($Symbol[PROTOTYPE], TO_PRIMITIVE$1, $Symbol[PROTOTYPE].valueOf); // 19.4.3.5 Symbol.prototype[@@toStringTag]
  ...
  if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
    ...
    for (var keys$1 = _descriptors ? gOPN$1(Base$1) : ( // ES3:
  ...
  var exp$2 = Math.exp; // V8 near Chromium 38 has a problem with very small numbers
  ...
  var $at$2 = _stringAt(true); // 21.1.3.27 String.prototype[@@iterator]()
  ...
  if (!(TO_PRIMITIVE in proto$2)) _hide(proto$2, TO_PRIMITIVE, _dateToPrimitive); // 22.1.2.2 / 15.4.3.2 Array.isArray(arg)
  ...
  _addToUnscopables(KEY$1); // 22.1.3.9 Array.prototype.findIndex(predicate, thisArg = undefined)
  ...
  if (_descriptors && (!CORRECT_NEW || _fails(function () {
    ...
    for (var keys = gOPN(Base), i$2 = 0; keys.length > i$2;) {
      proxy(keys[i$2++]);
    }
