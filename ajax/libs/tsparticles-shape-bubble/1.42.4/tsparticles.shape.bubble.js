...
;// CONCATENATED MODULE: ./dist/BubbleDrawer.js
class BubbleDrawer {
...
function loadBubbleShape(engine) {
...
loadBubbleShape(external_commonjs_tsparticles_commonjs2_tsparticles_amd_tsparticles_root_window_.tsParticles);
}();
