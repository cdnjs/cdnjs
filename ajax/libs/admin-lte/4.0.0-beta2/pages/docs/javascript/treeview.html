...
<head>
    ...
    <title>Treeview Plugin | AdminLTE 4</title><!--begin::Primary Meta Tags-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-filetype-js"></i>
                                <p>
                                    Javascript
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="../../docs/javascript/treeview.html" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Treeview</p>
                                    </a> </li>
                            </ul>
                        </li>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="app-content"> <!--begin::Container-->
                <div class="container-fluid">
                    <p>The Treeview plugin converts a nested list into a tree view where sub menus can be expanded.</p>
                    <h5 id="usage">Usage</h5>
                    <p>This plugin can be used as the data api.</p>
                    <p><strong>Data API</strong></p>
                    <p>Add <code>data-lte-toggle=&quot;treeview&quot;</code> to any ul or ol element to activate the plugin.</p>
                    <pre class="astro-code dark-plus" style="background-color:#1E1E1E;color:#D4D4D4;overflow-x:auto" tabindex="0" data-language="html"><code><span class="line"><span style="color:#808080">&lt;</span><span style="color:#569CD6">ul</span><span style="color:#9CDCFE"> data-lte-toggle</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;treeview&quot;</span><span style="color:#808080">&gt;</span></span>
...
<span class="line"></span></code></pre>
                    ...
                    <ul data-lte-toggle="treeview">
                        ...
                        <li class="nav-item menu-open"><a class="nav-link" href="#">
                                <p>Multilevel</p>
                            </a>
