...
<head>
    ...
    <title>Browser Support | AdminLTE 4</title><!--begin::Primary Meta Tags-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="../docs/browser-support.html" class="nav-link active"> <i class="nav-icon bi bi-browser-edge"></i>
                                <p>Browser Support</p>
                            </a> </li>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="app-content"> <!--begin::Container-->
                <div class="container-fluid">
                    ...
                    <blockquote>
                        <h5 id="excerpt-from-bootstraps-official-documentation">Excerpt from Bootstrap’s official Documentation!</h5>
                        <p>Bootstrap supports the <strong>latest, stable releases</strong> of all major browsers and platforms.</p>
                        <p>For more details <a href="https://getbootstrap.com/docs/5.0/getting-started/browsers-devices/#supported-browsers">look here</a>.</p>
                    </blockquote>
                    <p>You can find our supported range of browsers and their versions in <a href="https://github.com/ColorlibHQ/AdminLTE/blob/master/.browserslistrc">our .browserslistrc file</a>:</p>
                    <pre class="astro-code dark-plus" style="background-color:#1E1E1E;color:#D4D4D4;overflow-x:auto" tabindex="0" data-language="plaintext"><code><span class="line"><span># https://github.com/browserslist/browserslist#readme</span></span>
