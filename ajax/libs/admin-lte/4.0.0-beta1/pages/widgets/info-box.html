...
<head>
    ...
    <title>AdminLTE 4 | Widgets - Info Box</title><!--begin::Primary Meta Tags-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="../widgets/info-box.html" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>info Box</p>
                                    </a> </li>
