...
<head>
    ...
    <title>AdminLTE 4 | Layout RTL</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="../../../dist/css/adminlte.rtl.css"><!--end::Required Plugin(AdminLTE)-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-clipboard-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="../layout/layout-rtl.html" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Layout RTL</p>
                                    </a> </li>
                            </ul>
                        </li>
