 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */Zone.__load_patch("ZoneAwarePromise",((e,t,n)=>{const r=Object.getOwnPropertyDescriptor,o=Object.defineProperty,s=n.symbol,i=[],a=!0===e[s("DISABLE_WRAPPING_UNCAUGHT_PROMISE_REJECTION")],c=s("Promise"),l=s("then");n.onUnhandledError=e=>{if(n.showUncaughtError()){const t=e&&e.rejection;t?console.error("Unhandled Promise rejection:",t instanceof Error?t.message:t,"; Zone:",e.zone.name,"; Task:",e.task&&e.task.source,"; Value:",t,t instanceof Error?t.stack:void 0):console.error(e)}},n.microtaskDrainDone=()=>{for(;i.length;){const e=i.shift();try{e.zone.runGuarded((()=>{if(e.throwOriginal)throw e.rejection;throw e}))}catch(e){h(e)}}};const u=s("unhandledPromiseRejectionHandler");function h(e){n.onUnhandledError(e);try{const n=t[u];"function"==typeof n&&n.call(this,e)}catch(e){}}function p(e){return e&&e.then}function d(e){return e}function f(e){return C.reject(e)}const _=s("state"),m=s("value"),T=s("finally"),y=s("parentPromiseValue"),k=s("parentPromiseState"),g=null,E=!0,b=!1;function S(e,t){return n=>{try{w(e,t,n)}catch(t){w(e,!1,t)}}}const v=function(){let e=!1;return function t(n){return function(){e||(e=!0,n.apply(null,arguments))}}},P=s("currentTaskTrace");function w(e,r,s){const c=v();if(e===s)throw new TypeError("Promise resolved with itself");if(e[_]===g){let l=null;try{"object"!=typeof s&&"function"!=typeof s||(l=s&&s.then)}catch(t){return c((()=>{w(e,!1,t)}))(),e}if(r!==b&&s instanceof C&&s.hasOwnProperty(_)&&s.hasOwnProperty(m)&&s[_]!==g)O(s),w(e,s[_],s[m]);else if(r!==b&&"function"==typeof l)try{l.call(s,c(S(e,r)),c(S(e,!1)))}catch(t){c((()=>{w(e,!1,t)}))()}else{e[_]=r;const c=e[m];if(e[m]=s,e[T]===T&&r===E&&(e[_]=e[k],e[m]=e[y]),r===b&&s instanceof Error){const e=t.currentTask&&t.currentTask.data&&t.currentTask.data.__creationTrace__;e&&o(s,P,{configurable:!0,enumerable:!1,writable:!0,value:e})}for(let t=0;t<c.length;)D(e,c[t++],c[t++],c[t++],c[t++]);if(0==c.length&&r==b){e[_]=0;let r=s;try{throw new Error("Uncaught (in promise): "+function e(t){return t&&t.toString===Object.prototype.toString?(t.constructor&&t.constructor.name||"")+": "+JSON.stringify(t):t?t.toString():Object.prototype.toString.call(t)}(s)+(s&&s.stack?"\n"+s.stack:""))}catch(e){r=e}a&&(r.throwOriginal=!0),r.rejection=s,r.promise=e,r.zone=t.current,r.task=t.currentTask,i.push(r),n.scheduleMicroTask()}}}return e}const Z=s("rejectionHandledHandler");function O(e){if(0===e[_]){try{const n=t[Z];n&&"function"==typeof n&&n.call(this,{rejection:e[m],promise:e})}catch(e){}e[_]=b;for(let t=0;t<i.length;t++)e===i[t].promise&&i.splice(t,1)}}function D(e,t,n,r,o){O(e);const s=e[_],i=s?"function"==typeof r?r:d:"function"==typeof o?o:f;t.scheduleMicroTask("Promise.then",(()=>{try{const r=e[m],o=!!n&&T===n[T];o&&(n[y]=r,n[k]=s);const a=t.run(i,void 0,o&&i!==f&&i!==d?[]:[r]);w(n,!0,a)}catch(e){w(n,!1,e)}}),n)}const A=function(){},I=e.AggregateError;class C{static toString(){return"function ZoneAwarePromise() { [native code] }"}static resolve(e){return w(new this(null),E,e)}static reject(e){return w(new this(null),b,e)}static any(e){if(!e||"function"!=typeof e[Symbol.iterator])return Promise.reject(new I([],"All promises were rejected"));const t=[];let n=0;try{for(let r of e)n++,t.push(C.resolve(r))}catch(e){return Promise.reject(new I([],"All promises were rejected"))}if(0===n)return Promise.reject(new I([],"All promises were rejected"));let r=!1;const o=[];return new C(((e,s)=>{for(let i=0;i<t.length;i++)t[i].then((t=>{r||(r=!0,e(t))}),(e=>{o.push(e),n--,0===n&&(r=!0,s(new I(o,"All promises were rejected")))}))}))}static race(e){let t,n,r=new this(((e,r)=>{t=e,n=r}));function o(e){t(e)}function s(e){n(e)}for(let t of e)p(t)||(t=this.resolve(t)),t.then(o,s);return r}static all(e){return C.allWithCallback(e)}static allSettled(e){return(this&&this.prototype instanceof C?this:C).allWithCallback(e,{thenCallback:e=>({status:"fulfilled",value:e}),errorCallback:e=>({status:"rejected",reason:e})})}static allWithCallback(e,t){let n,r,o=new this(((e,t)=>{n=e,r=t})),s=2,i=0;const a=[];for(let o of e){p(o)||(o=this.resolve(o));const e=i;try{o.then((r=>{a[e]=t?t.thenCallback(r):r,s--,0===s&&n(a)}),(o=>{t?(a[e]=t.errorCallback(o),s--,0===s&&n(a)):r(o)}))}catch(e){r(e)}s++,i++}return s-=2,0===s&&n(a),o}constructor(e){const t=this;if(!(t instanceof C))throw new Error("Must be an instanceof Promise.");t[_]=g,t[m]=[];try{const n=v();e&&e(n(S(t,E)),n(S(t,b)))}catch(e){w(t,!1,e)}}get[Symbol.toStringTag](){return"Promise"}get[Symbol.species](){return C}then(e,n){var r;let o=null===(r=this.constructor)||void 0===r?void 0:r[Symbol.species];o&&"function"==typeof o||(o=this.constructor||C);const s=new o(A),i=t.current;return this[_]==g?this[m].push(i,s,e,n):D(this,i,s,e,n),s}catch(e){return this.then(null,e)}finally(e){var n;let r=null===(n=this.constructor)||void 0===n?void 0:n[Symbol.species];r&&"function"==typeof r||(r=C);const o=new r(A);o[T]=T;const s=t.current;return this[_]==g?this[m].push(s,o,e,e):D(this,s,o,e,e),o}}C.resolve=C.resolve,C.reject=C.reject,C.race=C.race,C.all=C.all;const M=e[c]=e.Promise;e.Promise=C;const j=s("thenPatched");function N(e){const t=e.prototype,n=r(t,"then");if(n&&(!1===n.writable||!n.configurable))return;const o=t.then;t[l]=o,e.prototype.then=function(e,t){return new C(((e,t)=>{o.call(this,e,t)})).then(e,t)},e[j]=!0}return n.patchThen=N,M&&(N(M),patchMethod(e,"fetch",(e=>function t(e){return function(t,n){let r=e.apply(t,n);if(r instanceof C)return r;let o=r.constructor;return o[j]||N(o),r}}(e)))),Promise[t.__symbol__("uncaughtPromiseErrors")]=i,C})),
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function patchCallbacks(e,t,n,r,o){const s=Zone.__symbol__(r);if(t[s])return;const i=t[s]=t[r];t[r]=function(s,a,c){return a&&a.prototype&&o.forEach((function(t){const o=`${n}.${r}::`+t,s=a.prototype;try{if(s.hasOwnProperty(t)){const n=e.ObjectGetOwnPropertyDescriptor(s,t);n&&n.value?(n.value=e.wrapWithCurrentZone(n.value,o),e._redefineProperty(a.prototype,t,n)):s[t]&&(s[t]=e.wrapWithCurrentZone(s[t],o))}else s[t]&&(s[t]=e.wrapWithCurrentZone(s[t],o))}catch(e){}})),i.call(t,s,a,c)},e.attachOriginToPatched(t[r],i)}
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
