/* Garlicjs dist/garlic.min.js build version 1.0.0 http://garlicjs.org */
...
i;a.fn.garlic.defaults={destroy:!0,inputs:"input[type=text], input[type=radio], input[type=checkbox], textarea, select",events:"DOMAttrModified textInput input change keypress paste focus".split(" "),domain:!1,conflictManager:{enabled:!0,garlicPriority:!0,template:'<span class="garlic-swap"></span>',message:"This is your saved data. Click here to see default one",onConflictDetected:function(){return!0}}};a(window).on("load",function(){a('[data-persist="garlic"]').each(function(){a(this).garlic()})})}(window.jQuery||
window.Zepto);
