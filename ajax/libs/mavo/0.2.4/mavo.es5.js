...
(async function ($, $$) {
  ...
  let _ = self.Mavo = $.Class((_temp = _class = class Mavo {
    constructor(element) {
    ...
    edit() {
      ...
      if ((_this$bar = this.bar) !== null && _this$bar !== void 0 && _this$bar.edit) {
        this.bar.edit.click();
      }
    ...
    updateBackend(role) {
      ...
      if (!backend) {
        backend = _.Functions.url("".concat(this.id, "-").concat(role)) || _.Functions.url("".concat(this.id.toLowerCase(), "-").concat(role)) || this.element.getAttribute(attribute) || null;
      }
      ...
      if (backend) {
        ...
        if (!(existing !== null && existing !== void 0 && (_existing$equals = existing.equals) !== null && _existing$equals !== void 0 && _existing$equals.call(existing, backend))) {
          ...
          changed = true; // Shim for previous mv-login and mv-logout events that were on the Mavo root

          $.bind(backend, "mv-login mv-logout", evt => {
            $.fire(this.element, evt.type, {
              backend
            });
          });
        }
      ...
      if (changed) {
        ...
        (_this$sourceBackend = this.sourceBackend) === null || _this$sourceBackend === void 0 ? void 0 : _this$sourceBackend.addEventListener("mv-remotedatachange", updateListener);
      }
    ...
    async load({
      ...
      backend = (_backend = backend) !== null && _backend !== void 0 ? _backend : this.sourceBackend;
    ...
    destroy() {
      ...
      (_this$bar2 = this.bar) === null || _this$bar2 === void 0 ? void 0 : _this$bar2.destroy(); // .index starts from 1, .all starts from 0
  ...
  }, _defineProperty(_class, "version", "v0.2.4"), _defineProperty(_class, "all", {}), _defineProperty(_class, "superKey", navigator.platform.indexOf("Mac") === 0 ? "metaKey" : "ctrlKey"), _defineProperty(_class, "base", location.protocol == "about:" ? document.currentScript ? document.currentScript.src : "http://mavo.io" : location), _defineProperty(_class, "dependencies", [// Plugins.load() must be run after DOM load to pick up all mv-plugins attributes
  $.ready().then(() => _.Plugins.load())]), _defineProperty(_class, "polyfillsNeeded", {
  ...
  }), _defineProperty(_class, "polyfills", []), _defineProperty(_class, "defer", delay => new Promise(resolve => delay === undefined ? requestAnimationFrame(resolve) : setTimeout(resolve, delay))), _defineProperty(_class, "UI", {}), _defineProperty(_class, "hooks", new $.Hooks()), _defineProperty(_class, "properties", new Set()), _defineProperty(_class, "attributes", ["mv-app", "mv-storage", "mv-source", "mv-init", "mv-path", "mv-format", "mv-attribute", "mv-default", "mv-mode", "mv-edit", "mv-editor", "mv-permisssions", "mv-rel", "mv-value"]), _temp), {
    live: {
      inProgress(value) {
      ...
      storage(value) {
        if (value !== this._storage && !value) {
          let permissions = new Mavo.Permissions({
            edit: true,
            save: false
          });
  ...
  });
  {
    ...
    s.primitive = s.property + ":not(".concat(s.group, ", ").concat(s.list, ")");
    s.childGroup = s.property + ":is(".concat(s.group, ")");
    s.scope = ":is(".concat(s.group, ", ").concat(s.multiple, ", ").concat(s.list, ")");
  ...
  $$("[mv-list-item], [mv-multiple]").forEach(item => {
    ...
    if (!item.hasAttribute("mv-list-item")) {
      ...
      if (!item.hasAttribute("property")) {
        if (multiple) {
          // mv-multiple has a value
          item.setAttribute("property", multiple);
        } else {
          let property = _.Node.getImplicitPropertyName(item) || _.Node.generatePropertyName("collection", item);
    ...
    let itemProperty = item.getAttribute("property"); // Make sure mv-list and mv-list-item have the same property (and that one exists)
    ...
    subset: function (obj, path, value) {
      if (arguments.length == 3) {
        ...
        return path.reduce((obj, property, i) => {
          ...
          let ret;
          let idQuery = property !== null && property !== void 0 && (_property$startsWith = property.startsWith) !== null && _property$startsWith !== void 0 && _property$startsWith.call(property, "id=") ? property.substring(3) : null;

          if (idQuery !== null) {
            let index = obj.findIndex(o => Mavo.Functions.get(o, "id") == idQuery);
            ret = index > -1 ? obj[index] : {
              id: idQuery
...
(function ($, $$) {
  ...
  let _ = Mavo.UI.Bar = class Bar {
    ...
    static getControls(template, controls = _.controls) {
      ...
      template = (_template = template) === null || _template === void 0 ? void 0 : _template.trim();
      ...
      let ids = template.split(/\s+/); // Convert both into sets
      ...
      all = [...all]; // At this point all has all the buttons we want in the default order and ids has a subset, in the specified order
    ...
    edit: {
      ...
      cleanup: function () {
        if (this.editing) {
          ...
          if ((_this$bar3 = this.bar) !== null && _this$bar3 !== void 0 && _this$bar3.edit) {
            this.bar.edit.textContent = this._("edit");
          }
        }
      },
...
(function ($, $$) {
   ...
   */
  var _ = Mavo.Backend = (_temp2 = _class2 = class Backend extends EventTarget {
    constructor(url, o = {}) {
      super(); // Permissions of this particular backend.
  ...
  }, _defineProperty(_class2, "types", []), _temp2);
  /**
  ...
  _.register(class Element extends _ {
    ...
    update(url, o) {
      ...
      this.element = (_$ = $(this.source)) !== null && _$ !== void 0 ? _$ : $.create("script", {
        type: "application/json",
        id: this.source.slice(1),
        inside: document.body
      });
      this.observer = (_this$observer5 = this.observer) !== null && _this$observer5 !== void 0 ? _this$observer5 : new MutationObserver(records => {
...
(function ($, $$) {
  var _ = Mavo.Node = class Node {
    ...
    static getImplicitPropertyName(element) {
      return element.getAttribute("itemprop") || element.getAttribute("mv-list") || element.getAttribute("mv-list-item") || element.name || element.id || [...element.classList].filter(n => !n.startsWith("mv-"))[0];
    }
    /**
    ...
    static get(element, prioritizePrimitive) {
      let nodes = _.elements.get(element) || []; // Do not return implicit collections
    ...
    static getClosest(element, prioritizePrimitive) {
      ...
      } while (!node && (element = (_element2 = element) === null || _element2 === void 0 ? void 0 : _element2.parentNode));
  ...
  var _ = Mavo.Group = class Group extends Mavo.Node {
    constructor(element, mavo, o) {
      ...
      if (Mavo.Primitive.getValueAttribute(this.element)) {
        this.children[this.property] = new Mavo.Primitive(this.element, this.mavo, {
          group: this
        });
      ...
      let properties = $$("[property]:not(:scope ".concat(Mavo.selectors.scope, " [property])"), this.element);
...
(async function ($, $$) {
  var _ = Mavo.Primitive = class Primitive extends Mavo.Node {
        ...
        if (this.default === null) {
          ...
          if (this.modes) {
            ...
            if (this.options) {
              ...
              this._default = (_this$_default = this._default) !== null && _this$_default !== void 0 ? _this$_default : firstOption;
            }
    ...
    get pausedObserver() {
      ...
      return ((_this$observerPauses = this.observerPauses) === null || _this$observerPauses === void 0 ? void 0 : _this$observerPauses.length) > 0;
    }
    ...
    resumeObserver() {
      ...
      Mavo.observers.flush();
      (_this$observerPauses2 = this.observerPauses) === null || _this$observerPauses2 === void 0 ? void 0 : (_this$observerPauses3 = _this$observerPauses2.pop) === null || _this$observerPauses3 === void 0 ? void 0 : _this$observerPauses3.call(_this$observerPauses2);
    }
    ...
    updateEditType() {
      ...
      let ret = (_this$element$getAttr = (_this$element$getAttr2 = this.element.getAttribute("mv-edit-type")) === null || _this$element$getAttr2 === void 0 ? void 0 : _this$element$getAttr2.trim()) !== null && _this$element$getAttr !== void 0 ? _this$element$getAttr : "auto";

      if (ret === "auto") {
        var _this$config$editType;

        // attribute may be "auto", in which case we want to get in here
        ret = (_this$config$editType = this.config.editType) !== null && _this$config$editType !== void 0 ? _this$config$editType : "auto";
      }
    ...
    originalEditorUpdated({
      ...
      if (this.originalEditor) {
        ...
        if (!this.template || this.originalEditor !== this.template.originalEditor) {
          ...
          (_this$originalEditorO2 = this.originalEditorObserver) === null || _this$originalEditorO2 === void 0 ? void 0 : _this$originalEditorO2.destroy();
          this.originalEditorObserver = new Mavo.Observer(this.originalEditor, "all", records => {
            ...
            for (let primitive of nodes) {
              primitive.originalEditorUpdated({
                force: true
              });
      ...
      let editor = (_this$editor2 = this.editor) !== null && _this$editor2 !== void 0 ? _this$editor2 : this.originalEditor;

      if (editor !== null && editor !== void 0 && editor.matches("select:not(.mv-options-select")) {
        // This is a select menu that is not automatically generated from mv-options
        // We need to update this.options
        let obj = [...editor.options].filter(o => !o.classList.contains("mv-volatile")).map(o => [o.value, o.textContent]);
    ...
    edit(o = {}) {
      ...
      if (!wasEditing) {
        ...
        if (!this.modes) {
          $.bind(this.element, "click.mavo:edit", evt => {
            ...
            if ((_this$editor3 = this.editor) !== null && _this$editor3 !== void 0 && _this$editor3.contains(evt.target)) {
              evt.preventDefault();
            }
          });
        }
      ...
      if (this.closestCollection && this.editType === "inline" && (_this$editor4 = this.editor) !== null && _this$editor4 !== void 0 && _this$editor4.matches(Mavo.selectors.textInput)) {
      ...
      if (this.editType === "popup") {
        ...
        (_this$popup = this.popup) === null || _this$popup === void 0 ? void 0 : _this$popup.close();
      ...
      if ((_this$editor5 = this.editor) !== null && _this$editor5 !== void 0 && _this$editor5.matches("select")) {
  ...
  $.Class(_, {
    ...
    live: {
      editor: function (value) {
        ...
        (_this$_editor = this._editor) === null || _this$_editor === void 0 ? void 0 : _this$_editor.replaceWith(value);
        this._editor = value;
  ...
  Mavo.observe({
    ...
    if (node instanceof Mavo.Primitive && node.config && !node.pausedObserver) {
      if (attribute === "mv-default" && !node.defaultExpression) {
        ...
        (_node$editor = node.editor) === null || _node$editor === void 0 ? void 0 : _node$editor.setAttribute(attribute.slice(10), element.getAttribute(attribute));
      ...
      let parentNode = Mavo.Node.getClosest(element.parentNode, true); // subtree changed on node for which we are monitoring this
      // primarily used for monitoring changes to <select> options

      if (parentNode !== null && parentNode !== void 0 && (_parentNode$config = parentNode.config) !== null && _parentNode$config !== void 0 && _parentNode$config.subtree) {
        parentNode.value = parentNode.getValue();
      }
    }
  });
  await $.ready(); // Migration from mv-edit-* to mv-editor-*

  let inputTypes = ["checkbox", "color", "date", "datetime-local", "email", "file", "month", "number", "password", "radio", "range", "search", "submit", "tel", "text", "time", "url", "week", "datetime"];
  let oldMvEdit = Mavo.attributeStartsWith("mv-edit-").filter(a => a.name !== "mv-edit-type" || inputTypes.includes(a.value)).map(a => a.name);
  ...
  if (oldMvEdit.length > 0) {
    ...
    for (let name of oldMvEditUnique) {
      ...
      console.log("You are using attribute ".concat(name, " on ").concat(elements.length, " element(s). This syntax is deprecated and will be removed in the next version of Mavo. Please use ").concat(newName, " instead."));
  ...
  _.register({
    ...
    "time": {
      ...
      defaultFormats: {
        ...
        "month": name => "[readable_datetime(".concat(name, ", 'months')] "),
  ...
  var _ = Mavo.Collection = class Collection extends Mavo.Node {
    constructor(element, mavo, o) {
      ...
      if (!this.fromTemplate("templateElement", "accepts", "initialItems")) {
        ...
        this.initialItems = +(this.element.getAttribute("mv-initial-items") || 1); // Must clone because otherwise once expressions are parsed on the template element
    ...
    initializeData() {
      let item = this.add(this.firstItemElement, undefined, {
        silent: true
      });
    ...
    static getClosestAcceptingCollection(target, property) {
      let collection = target.closest("[mv-list]:is([property=\"".concat(property, "\"], [mv-accepts~=\"").concat(property, "\"])"));
      return Mavo.Node.get(collection);
    ...
    getDragula() {
      ...
      if (this.template) {
        ...
        if (containers.indexOf(this.element) === -1) {
      ...
      this.dragula = dragula({
        ...
        accepts: function (el, target, source, next) {
          ...
          let collection = _.getClosestAcceptingCollection(target, property);

          if (!collection) {
            return false;
          }

          let item = Mavo.Node.get(el);
          return item === null || item === void 0 ? void 0 : item.collection.isCompatible(collection);
        }
      });
      this.dragula.on("cancel", (...args) => {
        console.log("cancel", ...args);
      });
      this.dragula.on("drop", (el, target, source) => {
        let item = Mavo.Node.get(el); // var oldIndex = item && item.index;

        let property = el.getAttribute("property");

        let collection = _.getClosestAcceptingCollection(target, property);

        if (collection && item.collection.isCompatible(collection)) {
          var _el$nextElementSiblin, _el$previousElementSi;

          let next = Mavo.Node.get((_el$nextElementSiblin = el.nextElementSibling) === null || _el$nextElementSiblin === void 0 ? void 0 : _el$nextElementSiblin.closest("[mv-list-item][property=\"".concat(collection.property, "\"]")));
          let previous = Mavo.Node.get((_el$previousElementSi = el.previousElementSibling) === null || _el$previousElementSi === void 0 ? void 0 : _el$previousElementSi.closest("[mv-list-item][property=\"".concat(collection.property, "\"]")));
          let index = previous ? previous.index + 1 : next ? next.index : collection.length;
          collection.add(item, index);
        } else {// return this.dragula.cancel(true);
        }
      });
...
(function ($, $$) {
  var _ = Mavo.UI.Itembar = class Itembar {
    constructor(item) {
      ...
      this.item = item; // Is there an existing .mv-item-bar element?

      this.element = $$(".mv-item-bar:is(:not([mv-rel]), [mv-rel=\"".concat(this.item.property, "\"])"), this.item.element).filter(el => {
      ...
      if (!this.element && (_this$item$template = this.item.template) !== null && _this$item$template !== void 0 && _this$item$template.itembar) {
        ...
        this.template = this.element.getAttribute("mv-item-bar") || this.item.element.getAttribute("mv-item-bar") || this.collection.element.getAttribute("mv-item-bar") || "";
        let controls = Object.assign({}, _.controls); // If item is a primitive, move button is optional
      ...
      controls: {
        ...
        add: {
          create(existing) {
            ...
            Mavo.setAttributeShy(button, "mv-action", "if($cmd, add($item, ".concat(args, "), add(").concat(args, "))"));
            return button;
          }
  ...
  var _ = Mavo.DOMExpression = $.Class({
    async constructor(o = {}) {
      ...
      if (this.node.nodeType === 3 && this.element === this.node) {
        this.element = this.node.parentNode; // If no element siblings consider making this.node the element, which is more robust
...
(function ($, val) {
  var _ = Mavo.Functions = {
    ...
    get: function (obj, property, ...properties) {
      ...
      let ret;
      property = val(property); // Get same case property name if it exists,
    ...
    pluralize: $.extend(function (num, ...args) {
      ...
      let pl = new Intl.PluralRules(lang, {
        type: o.type || "cardinal"
      });
...
(function ($, val, _, $u = _.util) {
  ...
  function parsePrecision(precision) {
    ...
    precision = ((_precision = precision) === null || _precision === void 0 ? void 0 : _precision.trim()) || "";
  ...
  $.extend(_, {
    ...
    datetime: $.extend((date, precision = "minutes") => {
      ...
      return "".concat(ret, "T").concat(_.time(date, precision));
    }, {
      multiValued: true
    }),
    // Return an ISO date
    ...
    readable_datetime: $.extend((date, ...options) => {
      options = options.map(o => typeof o === "string" || o instanceof String ? {
        precision: o
      } : o);
    ...
    dateComponent: function (component, date, format, locale = Mavo.locale) {
      ...
      if (format) {
        if (/^0+$/.test(format)) {
          ...
          ret = dateO.toLocaleString(locale, {
            [component]: format
          });
    ...
    operators: {
      ...
      "concatenate": {
        ...
        scalar: (a, b) => {
          ...
          a = (_Mavo$value = Mavo.value(a)) !== null && _Mavo$value !== void 0 ? _Mavo$value : "";
          b = (_Mavo$value2 = Mavo.value(b)) !== null && _Mavo$value2 !== void 0 ? _Mavo$value2 : "";
          return "" + a + b;
        },
        precedence: 10
      },
    ...
    serializers: {
      ...
      "MemberExpression": (node, parent) => {
        ...
        while (n.type === "MemberExpression") {
          let serialized = n.computed ? _.serialize(n.property, n) : "\"".concat(n.property.name, "\"");
          properties.push(serialized);
          objectParent = n;
          object = n = n.object;
        }

        return "$fn.get(".concat(_.serialize(object, objectParent), ", ").concat(properties.reverse().join(", "), ")");
      },
...
(function ($, $$) {
  var _ = Mavo.Data = $.Class(class Data {
    ...
    static: {
      ...
      isCollection(data) {
        return Array.isArray(data) && (data === null || data === void 0 ? void 0 : data[Mavo.toNode]) instanceof Mavo.Collection;
      },
      ...
      findUp(property, data) {
        ...
        do {
          ...
          if (!_.isCollection(parent) || isDataArray) {
            ...
            let ret = _.find(property, parent, {
              exclude: child
            });
...
(function ($, $$) {
  ...
  let _ = Mavo.Backend.register((_temp3 = _class6 = class Github extends Mavo.Backend {
    constructor(url, o) {
      super(url, o);
    ...
    update(url, o) {
      super.update(url, o); // Extract info for username, repo, branch, filepath from URL
    ...
    async get(url) {
      if (this.isAuthenticated() || !this.path || url) {
        ...
        let response = await this.request(info.apiCall, {
          ref: this.branch
        }, "GET", req);
        ...
        if (isRawAPICall) {
          ...
          /* subtract 1 because we already fetched a page */
          ...
          if (maxPages > 0 && params.get("page") === null && Array.isArray(json)) {
            ...
            do {
              ...
              next = (_response$headers$get = response.headers.get("Link")) === null || _response$headers$get === void 0 ? void 0 : (_response$headers$get2 = _response$headers$get.match(/<(.+?)>; rel="next"/)) === null || _response$headers$get2 === void 0 ? void 0 : _response$headers$get2[1];
    ...
    put(serialized, path = this.path, o = {}) {
      ...
      let repoCall = "repos/".concat(this.username, "/").concat(this.repo);
      let fileCall = "".concat(repoCall, "/contents/").concat(path);
      let commitPrefix = this.mavo.element.getAttribute("mv-github-commit-prefix") || ""; // Create repo if it doesn’t exist

      let repoInfo = this.repoInfo ? Promise.resolve(this.repoInfo) : this.request("user/repos", {
        name: this.repo
  ...
  }, _defineProperty(_class6, "apiDomain", "https://api.github.com/"), _defineProperty(_class6, "oAuth", "https://github.com/login/oauth/authorize"), _defineProperty(_class6, "key", "7e08e016048000bc594e"), _defineProperty(_class6, "btoa", str => btoa(unescape(encodeURIComponent(str)))), _defineProperty(_class6, "atob", str => decodeURIComponent(escape(window.atob(str)))), _temp3));
})(Bliss, Bliss.$);
