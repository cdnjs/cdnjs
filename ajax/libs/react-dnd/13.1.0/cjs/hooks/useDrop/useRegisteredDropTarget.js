...
var _useDropTargetMonitor3 = require("./useDropTargetMonitor");
...
function useRegisteredDropTarget(spec) {
  var manager = (0, _useDragDropManager.useDragDropManager)();

  var _useDropTargetMonitor = (0, _useDropTargetMonitor3.useDropTargetMonitor)(manager),
  ...
  var dropTarget = (0, _useDropTarget.useDropTarget)(spec, monitor); // Reconnect on accept change
