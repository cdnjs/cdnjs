(function (global, factory) {
  ...
  */
  ...
  function useRegisteredDragSource(spec) {
    ...
    var _useDragSourceMonitor = useDragSourceMonitor(manager),
  ...
  function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray$6(arr) || _nonIterableSpread(); }
  ...
  function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$6(arr); }
  ...
  function useDrag(specArg, deps) {
    ...
    var _useRegisteredDragSou = useRegisteredDragSource(spec),
        _useRegisteredDragSou2 = _slicedToArray$6(_useRegisteredDragSou, 2),
  ...
  function useDrop(specArg, deps) {
    ...
    var _useRegisteredDropTar = useRegisteredDropTarget(spec),
        _useRegisteredDropTar2 = _slicedToArray$8(_useRegisteredDropTar, 2),
  ...
  function useDragLayer(collect) {
    ...
    var _useCollector = useCollector(monitor, collect),
        _useCollector2 = _slicedToArray$9(_useCollector, 2),
        collected = _useCollector2[0],
        updateCollected = _useCollector2[1];
