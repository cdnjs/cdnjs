...
export function useRegisteredDropTarget(spec) {
  var manager = useDragDropManager();

  var _useDropTargetMonitor = useDropTargetMonitor(manager),
  ...
  var dropTarget = useDropTarget(spec, monitor); // Reconnect on accept change
