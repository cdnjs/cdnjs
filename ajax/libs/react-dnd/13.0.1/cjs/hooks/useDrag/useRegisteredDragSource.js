...
var _useDragSourceMonitor3 = require("./useDragSourceMonitor");
...
function useRegisteredDragSource(spec) {
  var manager = (0, _useDragDropManager.useDragDropManager)();

  var _useDragSourceMonitor = (0, _useDragSourceMonitor3.useDragSourceMonitor)(manager),
