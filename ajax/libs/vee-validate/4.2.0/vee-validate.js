...
(function (global, factory) {
  ...
  function useMeta(initialValue, currentValue, errors) {
      const meta = vue.reactive({
          touched: false,
          pending: false,
          valid: vue.computed(() => !errors.value.length),
  ...
  function useFormMeta(fields, errors, currentValues, initialValues) {
      ...
      return vue.computed(() => {
          ...
          return Object.assign(Object.assign({ initialValues: vue.unref(initialValues) }, flags), { dirty: isDirty.value, valid: isValid.value });
      });
  }
