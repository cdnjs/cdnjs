  ...
  var ValidationProvider = Vue__default['default'].extend({
      ...
      watch: {
          rules: {
              ...
              handler: function (val, oldVal) {
                  this._needsValidation = !es6(val, oldVal);
              }
          }
      },
      data: data$1,
          ...
          if (this.detectInput) {
              ...
              if (inputs.length) {
                  inputs.forEach(function (input, idx) {
                      ...
                      if (!es6(_this._resolvedRules, resolved)) {
      ...
      methods: {
          ...
          syncValue: function (v) {
              ...
              this.value = value;
              this.flags.changed = !es6(this.initialValue, value);
          },
          reset: function () {
              var _this = this;
              this.errors = [];
          ...
          applyResult: function (_a) {
              ...
              this.setFlags({
                  ...
                  validated: true,
                  changed: !es6(this.value, this.initialValue)
              });
          },
