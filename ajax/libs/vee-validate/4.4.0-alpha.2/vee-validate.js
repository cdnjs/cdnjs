...
(function (global, factory) {
  ...
  async function validateYupSchema(schema, values) {
      ...
      const results = errors.reduce((acc, err) => {
          ...
          acc[err.path] = { valid: !messages.length, errors: messages };
          return acc;
      }, {});
      return {
          valid: !errors.length,
  ...
  async function validateObjectSchema(schema, values, opts) {
      ...
      const validations = paths.map(async (path) => {
          ...
          const fieldResult = await validate(getFromPath(values, path), schema[path], {
              ...
              values: values,
              bails: (_b = opts === null || opts === void 0 ? void 0 : opts.bails) !== null && _b !== void 0 ? _b : true,
          });
  ...
  function useValidationState({ name, initValue, form, type, checkedValue, }) {
      ...
      const initialValue = vue.computed(() => {
          var _a;
          return ((_a = getFromPath(vue.unref(formInitialValues), vue.unref(name))) !== null && _a !== void 0 ? _a : vue.unref(initialValueRef));
      });
      ...
      function resetValidationState(state) {
          ...
          const newValue = state && 'value' in state
              ? state.value
              : ((_a = getFromPath(vue.unref(formInitialValues), fieldPath)) !== null && _a !== void 0 ? _a : vue.unref(initValue));
          if (form) {
  ...
  function useForm(opts) {
      ...
      async function validateSchema(mode) {
          ...
          const formResult = isYupValidator(schemaValue)
              ...
              : await validateObjectSchema(schemaValue, formValues, { names: fieldNames.value });
          // fields by id lookup
          ...
          return paths.reduce((validation, path) => {
              ...
              return validation;
          }, { valid: formResult.valid, results: {} });
      }
