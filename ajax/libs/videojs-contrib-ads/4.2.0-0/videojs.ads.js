...
cueTextTracks.process = function (player, processTrack) {
  ...
  var prepareTrack = function prepareTrack(track) {
  ...
  for (var i = 0; i < cues.length; i++) {
    ...
    if (cueData === -1) {
      ...
      if (cueIncluded(player, cueId)) {
        _video2.default.log('Skipping already included ad with ID ' + cueId);
        return;
      }
...
**/
var cueIncluded = function cueIncluded(player, cueId) {
...
* @param cueId The Id associated with a cue
**/
var setCueIncluded = function setCueIncluded(player, cueId) {
...
},{"./cancelContentPlay.js":1,"./contentupdate.js":2,"./cueTextTracks.js":3,"./macros.js":4,"./redispatch.js":5,"./snapshot.js":6}]},{},[7])(7)
});