function initializeCommentBarrage(){window.commentBarrageInitialized=!0;var e={maxBarrage:1,barrageTime:8e3,walineUrl:GLOBAL_CONFIG.comment.url,pageUrl:window.location.pathname};new class{commentInterval=null;constructor(e){this.config={...e,barrageTimer:[],barrageList:[],barrageIndex:0,dom:document.querySelector(".comment-barrage")},this.commentInterval=null,this.hoverOnCommentBarrage=!1,this.init()}async fetchComments(){const e=new URL(this.config.walineUrl+"/api/comment");var t,r,a={path:this.config.pageUrl,sortBy:"insertedAt_asc"};for([t,r]of Object.entries(a))e.searchParams.append(t,r);try{const n=await fetch(e,{method:"GET",headers:{"Content-Type":"application/json"}});if(n.ok)return(await n.json()).data;throw new Error("HTTP error! status: "+n.status)}catch(e){console.error("An error occurred while fetching comments: ",e)}}commentLinkFilter(e){return e.data.flatMap(e=>this.getCommentReplies(e))}getCommentReplies(e){return e.replies?[e,...e.replies.flatMap(e=>this.getCommentReplies(e))]:[e]}processCommentContent(e){e=e.replace(/<blockquote\b[^>]*>[\s\S]*?<\/blockquote>|<[^>]*>|\n/g,"").trim();return e?`<p>${e}</p>`:""}createCommentBarrage(e){if(!this.processCommentContent(e.comment).trim())return!1;const t=document.createElement("div");return t.classList.add("comment-barrage-item"),t.innerHTML=`
        <div class="barrageHead">
            ...
            <img class="barrageAvatar" src="${GLOBAL_CONFIG.comment.avatar}/avatar/${e.avatar}"/>
