...
function compileAndInsert(style) {
  var _atomic = (0, _compiler.atomic)((0, _compiler.preprocess)(style)),
      compiledStyle = _atomic[0],
      compiledOrderedRules = _atomic[1];

  var _atomic2 = (0, _compiler.atomic)((0, _compiler.preprocess)(style, true)),
...
function StyleSheet(styles, isRTL) {
  ...
  if (Array.isArray(styleProps) && styleProps[1] != null) {
    styleProps[1] = (0, _compiler.inline)((0, _compiler.preprocess)(styleProps[1], isRTL));
  }
