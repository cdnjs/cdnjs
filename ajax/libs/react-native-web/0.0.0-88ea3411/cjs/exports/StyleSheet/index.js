...
function compileAndInsert(style) {
  var _atomic = (0, _compiler.atomic)((0, _compiler.logicalStylePolyfill)(style)),
      compiledStyle = _atomic[0],
      compiledOrderedRules = _atomic[1];

  var _atomic2 = (0, _compiler.atomic)((0, _compiler.logicalStylePolyfill)(style, true)),
    ...
    if (styleObj != null) {
      if (key.indexOf('$raw') > -1) {
        ...
        if (process.env.NODE_ENV !== 'production') {
          (0, _validate.validate)(key, styles);
...
function StyleSheet(styles, isRTL) {
  ...
  if (Array.isArray(styleProps) && styleProps[1] != null) {
    styleProps[1] = (0, _compiler.inline)((0, _compiler.logicalStylePolyfill)(styleProps[1], isRTL));
  }
