...
var createDOMProps = function createDOMProps(elementType, props) {
  ...
  if (isNativeInteractiveElement || role === 'button' || role === 'menuitem' || focusable === true && !disabled) {
