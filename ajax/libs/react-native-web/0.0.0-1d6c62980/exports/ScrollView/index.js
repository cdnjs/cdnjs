...
const ScrollView = createReactClass({
  ...
  render() {
    ...
    const children = hasStickyHeaderIndices || pagingEnabled ? React.Children.map(this.props.children, (child, i) => {
    ...
    const contentContainer = /*#__PURE__*/React.createElement(View, _extends({}, contentSizeChangeProps, {
      children: children,
      collapsable: false,
    ...
    const props = _objectSpread(_objectSpread({}, other), {}, {
    ...
    const scrollView = /*#__PURE__*/React.createElement(ScrollViewClass, _extends({}, props, {
...
const ForwardedScrollView = /*#__PURE__*/React.forwardRef((props, forwardedRef) => {
