...
class FlatList extends React.PureComponent {
  ...
  constructor(_props) {
    ...
    this._keyExtractor = (items, index) => {
      ...
      const numColumns = numColumnsOrDefault(this.props.numColumns);
      const keyExtractor = (_this$props$keyExtrac = this.props.keyExtractor) !== null && _this$props$keyExtrac !== void 0 ? _this$props$keyExtrac : _VirtualizeUtils.keyExtractor;
        ...
        [virtualizedListRenderKey]: info => {
          if (numColumns > 1) {
            const item = info.item,
                  index = info.index;
            (0, _invariant.default)(Array.isArray(item), 'Expected array of items with numColumns > 1');
  ...
  _pushMultiColumnViewable(arr, v) {
    ...
    const numColumns = numColumnsOrDefault(this.props.numColumns);
    const keyExtractor = (_this$props$keyExtrac2 = this.props.keyExtractor) !== null && _this$props$keyExtrac2 !== void 0 ? _this$props$keyExtrac2 : _VirtualizeUtils.keyExtractor;
