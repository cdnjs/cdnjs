...
class VirtualizedSectionList extends React.PureComponent {
  constructor() {
    ...
    this._convertViewable = viewable => {
      ...
      const keyExtractorWithNonNullableIndex = this.props.keyExtractor || _VirtualizeUtils.keyExtractor;
      const key = keyExtractorWithNullableIndex != null ? keyExtractorWithNullableIndex(viewable.item, info.index) : keyExtractorWithNonNullableIndex(viewable.item, (_info$index = info.index) !== null && _info$index !== void 0 ? _info$index : 0);
    ...
    this._onViewableItemsChanged = _ref => {
      let viewableItems = _ref.viewableItems,
    ...
    this._renderItem = listItemCount => _ref2 => {
      ...
      if (infoIndex == null) {
        ...
        if (info.header === true) {
          ...
          const renderSectionFooter = this.props.renderSectionFooter;
  ...
  scrollToLocation(params) {
    ...
    const toIndexParams = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, params), {}, {
      viewOffset,
      index
    });
  ...
  _subExtractor(index) {
    ...
    for (let i = 0; i < sections.length; i++) {
      ...
      if (itemIndex >= getItemCount(sectionData) + 1) {
        ...
        const extractor = section.keyExtractor || keyExtractor || _VirtualizeUtils.keyExtractor;
        return {
          section,
  ...
  _getSeparatorComponent(index, info, listItemCount) {
    ...
    const SectionSeparatorComponent = this.props.SectionSeparatorComponent;
...
function ItemWithSeparator(props) {
  const LeadingSeparatorComponent = props.LeadingSeparatorComponent,
  ...
  const _React$useState4 = React.useState({
  ...
  const leadingSeparator = LeadingSeparatorComponent != null && /*#__PURE__*/React.createElement(LeadingSeparatorComponent, (0, _extends2.default)({
    highlighted: leadingSeparatorHiglighted
  }, leadingSeparatorProps));
  const separator = SeparatorComponent != null && /*#__PURE__*/React.createElement(SeparatorComponent, (0, _extends2.default)({
