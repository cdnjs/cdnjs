...
class VirtualizedList extends React.PureComponent {
  ...
  _keyExtractor(item, index) {
    ...
    const key = (0, _VirtualizeUtils.keyExtractor)(item, index);
  ...
  render() {
    ...
    if (itemCount > 0) {
      ...
      cells.push( /*#__PURE__*/React.cloneElement(element, {
        ...
        style: _StyleSheet.default.compose(inversionStyle, element.props.style)
      }));
    }
    ...
    const scrollProps = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, this.props), {}, {
    ...
    const innerRet = /*#__PURE__*/React.createElement(_VirtualizedListContext.VirtualizedListContextProvider, {
      value: {
        cellKey: null,
