...
const NativeAnimatedAPI = _NativeAnimatedHelper.default.API;
...
class AnimatedNode {
  ...
  __getNativeTag() {
    ...
    const nativeTag = (_this$__nativeTag = this.__nativeTag) !== null && _this$__nativeTag !== void 0 ? _this$__nativeTag : _NativeAnimatedHelper.default.generateNewNodeTag();
