...
function useEvent(event, options) {
  const targetListeners = (0, _useStable.default)(() => new Map());
  const addListener = (0, _useStable.default)(() => {
    const addEventListener = (0, _createEventHandle.default)(event, options);
