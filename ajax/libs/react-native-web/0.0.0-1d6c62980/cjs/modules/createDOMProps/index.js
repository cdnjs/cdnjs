...
const createDOMProps = (elementType, props, options) => {
  ...
  const role = _AccessibilityUtil.default.propsToAriaRole(props); // ACCESSIBILITY
  ...
  const _StyleSheet = (0, _StyleSheet2.default)([style, pointerEvents && pointerEventsStyles[pointerEvents]], {
