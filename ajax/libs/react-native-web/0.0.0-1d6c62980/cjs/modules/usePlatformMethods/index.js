...
function setNativeProps(node, nativeProps, pointerEvents, style, previousStyleRef) {
  ...
  if (node != null && nativeProps) {
    const domProps = (0, _createDOMProps.default)(null, (0, _objectSpread2.default)((0, _objectSpread2.default)({
      pointerEvents
    }, nativeProps), {}, {
...
function usePlatformMethods(_ref) {
  let pointerEvents = _ref.pointerEvents,
      style = _ref.style;
  const previousStyleRef = (0, _react.useRef)(null);
  const setNativePropsArgsRef = (0, _react.useRef)(null);
  ...
  const ref = (0, _useStable.default)(() => hostNode => {
    if (hostNode != null) {
