...
const _excluded = ["contentContainerStyle", "horizontal", "onContentSizeChange", "refreshControl", "stickyHeaderIndices", "pagingEnabled", "forwardedRef", "keyboardDismissMode", "onScroll"];
const emptyObject = {};
/* eslint-disable react/prefer-es6-class */

const ScrollView = (0, _createReactClass.default)({
  ...
  render() {
    ...
    if (process.env.NODE_ENV !== 'production' && this.props.style) {
      const style = _StyleSheet.default.flatten(this.props.style);
    ...
    const children = hasStickyHeaderIndices || pagingEnabled ? _react.default.Children.map(this.props.children, (child, i) => {
    ...
    const contentContainer = /*#__PURE__*/_react.default.createElement(_View.default, (0, _extends2.default)({}, contentSizeChangeProps, {
      children: children,
      collapsable: false,
    ...
    const props = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, other), {}, {
    ...
    const ScrollViewClass = _ScrollViewBase.default;
    (0, _invariant.default)(ScrollViewClass !== undefined, 'ScrollViewClass must not be undefined');

    const scrollView = /*#__PURE__*/_react.default.createElement(ScrollViewClass, (0, _extends2.default)({}, props, {
  ...
  _setScrollNodeRef(node) {
    ...
    const ref = (0, _mergeRefs.default)(this.props.forwardedRef);
    ref(node);
  }
...
const ForwardedScrollView = /*#__PURE__*/_react.default.forwardRef((props, forwardedRef) => {
