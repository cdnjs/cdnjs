...
const pickProps = props => (0, _pick.default)(props, forwardPropsList); // If an Input Method Editor is processing key input, the 'keyCode' is 229.
...
const TextInput = /*#__PURE__*/React.forwardRef((props, forwardedRef) => {
  const _props$autoCapitalize = props.autoCapitalize,
  ...
  function handleKeyDown(e) {
    const hostNode = e.target; // Prevent key events bubbling (see #612)
  ...
  const setRef = (0, _useMergeRefs.default)(hostRef, platformMethodsRef, imperativeRef, forwardedRef);
