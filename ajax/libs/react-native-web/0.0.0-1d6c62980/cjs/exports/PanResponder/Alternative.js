...
const PanResponder = {
  ...
  _updateGestureStateOnMove(gestureState, touchHistory) {
    ...
    const deltaY = prevDeltaY + (y - prevY); // TODO: This must be filtered intelligently.
  ...
  create(config) {
    ...
    const onStartShouldSetResponder = config.onStartShouldSetResponder,
    ...
    const panHandlers = {
      ...
      onResponderStart(event) {
        const numberActiveTouches = event.touchHistory.numberActiveTouches;
