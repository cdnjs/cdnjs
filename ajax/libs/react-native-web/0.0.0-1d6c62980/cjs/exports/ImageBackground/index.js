...
const _excluded = ["children", "style", "imageStyle", "imageRef"];
const emptyObject = {};
/**
 * Very simple drop-in replacement for <Image> which supports nesting views.
 */

const ImageBackground = /*#__PURE__*/(0, React.forwardRef)((props, forwardedRef) => {
  ...
  const _StyleSheet$flatten = _StyleSheet.default.flatten(style),
