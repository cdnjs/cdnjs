...
const _excluded = ["color", "disabled", "onChange", "onValueChange", "style", "value"];
const CheckBox = /*#__PURE__*/React.forwardRef((props, forwardedRef) => {
  ...
  const fakeControl = /*#__PURE__*/React.createElement(_View.default, {
  ...
  const nativeControl = (0, _createElement.default)('input', {
    checked: value,
    disabled: disabled,
