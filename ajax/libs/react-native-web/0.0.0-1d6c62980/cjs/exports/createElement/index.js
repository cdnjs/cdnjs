...
const createElement = (component, props, options) => {
  ...
  const domProps = (0, _createDOMProps.default)(Component, props, options);

  const element = /*#__PURE__*/_react.default.createElement(Component, domProps); // Update locale context if element's writing direction prop changes


  const elementWithLocaleProvider = domProps.dir ? /*#__PURE__*/_react.default.createElement(_useLocale.LocaleProvider, {
    children: element,
