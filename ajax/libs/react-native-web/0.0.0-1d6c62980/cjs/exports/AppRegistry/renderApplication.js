...
function renderApplication(RootComponent, WrapperComponent, callback, options) {
  ...
  const renderFn = shouldHydrate ? _render.hydrate : _render.default;
...
function getApplication(RootComponent, initialProps, WrapperComponent) {
  const element = /*#__PURE__*/_react.default.createElement(_AppContainer.default, {
    WrapperComponent: WrapperComponent,
    rootTag: {}
  ...
  const getStyleElement = props => {
    const sheet = _StyleSheet.default.getSheet();
