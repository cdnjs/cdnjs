...
const _excluded = ["stickySectionHeadersEnabled"];
...
export default class SectionList extends React.PureComponent {
  ...
  render() {
    ...
    const stickySectionHeadersEnabled = _stickySectionHeadersEnabled !== null && _stickySectionHeadersEnabled !== void 0 ? _stickySectionHeadersEnabled : Platform.OS === 'ios';
