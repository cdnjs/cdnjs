...
const _excluded = ["numColumns", "columnWrapperStyle", "removeClippedSubviews"];
...
class FlatList extends React.PureComponent {
  ...
  constructor(_props) {
    ...
    this._keyExtractor = (items, index) => {
      ...
      const numColumns = numColumnsOrDefault(this.props.numColumns);
      const keyExtractor = (_this$props$keyExtrac = this.props.keyExtractor) !== null && _this$props$keyExtrac !== void 0 ? _this$props$keyExtrac : defaultKeyExtractor;
  ...
  _pushMultiColumnViewable(arr, v) {
    ...
    const numColumns = numColumnsOrDefault(this.props.numColumns);
    const keyExtractor = (_this$props$keyExtrac2 = this.props.keyExtractor) !== null && _this$props$keyExtrac2 !== void 0 ? _this$props$keyExtrac2 : defaultKeyExtractor;
