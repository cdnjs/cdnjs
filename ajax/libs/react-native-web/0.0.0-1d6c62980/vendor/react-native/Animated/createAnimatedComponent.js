...
function createAnimatedComponent(Component, options) {
  ...
  class AnimatedComponent extends React.Component {
    ...
    _attachNativeEvents() {
      ...
      const scrollableNode = (_this$_component = this._component) != null && _this$_component.getScrollableNode ? this._component.getScrollableNode() : this._component;
    ...
    render() {
      const _ref = this._propsAnimated.__getValue() || {},
            _ref$style = _ref.style,
            style = _ref$style === void 0 ? {} : _ref$style,
            props = _objectWithoutPropertiesLoose(_ref, _excluded);

      const _ref2 = this.props.passthroughAnimatedPropExplicitValues || {},
            _ref2$style = _ref2.style,
            passthruStyle = _ref2$style === void 0 ? {} : _ref2$style,
            passthruProps = _objectWithoutPropertiesLoose(_ref2, _excluded2);

      const mergedStyle = _objectSpread(_objectSpread({}, style), passthruStyle);
