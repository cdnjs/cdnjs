...
class VirtualizedSectionList extends React.PureComponent {
  ...
  scrollToLocation(params) {
    ...
    const toIndexParams = _objectSpread(_objectSpread({}, params), {}, {
      viewOffset,
      index
    });
...
function ItemWithSeparator(props) {
  ...
  const leadingSeparator = LeadingSeparatorComponent != null && /*#__PURE__*/React.createElement(LeadingSeparatorComponent, _extends({
    highlighted: leadingSeparatorHiglighted
  }, leadingSeparatorProps));
  const separator = SeparatorComponent != null && /*#__PURE__*/React.createElement(SeparatorComponent, _extends({
