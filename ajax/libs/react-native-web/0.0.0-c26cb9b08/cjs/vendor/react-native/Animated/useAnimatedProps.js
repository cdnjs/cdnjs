...
function useAnimatedProps(props) {
  ...
  var onUpdateRef = (0, _react.useRef)(null); // TODO: Only invalidate `node` if animated props or `style` change. In the
  ...
  var refEffect = (0, _react.useCallback)(instance => {
    ...
    return () => {
      ...
      for (var _iterator = (0, _createForOfIteratorHelperLoose2.default)(events), _step; !(_step = _iterator()).done;) {
