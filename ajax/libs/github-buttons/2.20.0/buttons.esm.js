...
var lightHighContrast = ".btn{color:#24292f;background-color:#f7f7f7;border-color:#1a1c21;border-color:rgba(1,4,9,.9);background-image:url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg'%3e%3clinearGradient id='o' x2='0' y2='1'%3e%3cstop stop-color='%23FFFFFF'/%3e%3cstop offset='90%25' stop-color='%23f7f7f7'/%3e%3c/linearGradient%3e%3crect width='100%25' height='100%25' fill='url(%23o)'/%3e%3c/svg%3e\");background-image:-moz-linear-gradient(top, #FFFFFF, #f7f7f7 90%);background-image:linear-gradient(180deg, #FFFFFF, #f7f7f7 90%);filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FFFFFFFF', endColorstr='#FFF6F6F6')}:root .btn{filter:none}.btn:focus,.btn:hover{background-color:#e9ebef;background-position:0 -0.5em;border-color:#181b20;border-color:rgba(1,4,9,.9);background-image:url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg'%3e%3clinearGradient id='o' x2='0' y2='1'%3e%3cstop stop-color='%23f3f4f6'/%3e%3cstop offset='90%25' stop-color='%23e9ebef'/%3e%3c/linearGradient%3e%3crect width='100%25' height='100%25' fill='url(%23o)'/%3e%3c/svg%3e\");background-image:-moz-linear-gradient(top, #f3f4f6, #e9ebef 90%);background-image:linear-gradient(180deg, #f3f4f6, #e9ebef 90%);filter:progid:DXImageTransform.Microsoft.Gradient(startColorstr='#FFF3F4F6', endColorstr='#FFE8EAEE')}:root .btn:focus,:root .btn:hover{filter:none}.btn:active{background-color:#f0f0f0;border-color:#191c20;border-color:rgba(1,4,9,.9);box-shadow:inset 0 .15em .3em rgba(1,4,9,.15);background-image:none;filter:none}.social-count{color:#24292f;background-color:#fff;border-color:#1a1d22;border-color:rgba(1,4,9,.9)}.social-count:focus,.social-count:hover{color:#0349b4}.octicon-heart{color:#971368}";
