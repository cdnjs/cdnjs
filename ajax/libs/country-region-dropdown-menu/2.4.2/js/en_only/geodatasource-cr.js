...
<div class="menu">' + countries + '</div>');
    ...
    var translate = function(countryElement){
        ...
        var af_region=["Badakhshan_AF","Badghis_AF","Baghlan_AF","Balkh_AF","Bamyan_AF","Daykundi_AF","Farah_AF","Faryab_AF","Ghazni_AF","Ghor_AF","Helmand_AF","Herat_AF","Jowzjan_AF","Kabul_AF","Kandahar_AF","Khost_AF","Kunduz_AF","Laghman_AF","Logar_AF","Nangarhar_AF","Nimroz_AF","Paktika_AF","Paktiya_AF","Parwan_AF","Samangan_AF","Sar-e Pul_AF","Takhar_AF","Uruzgan_AF","Zabul_AF"];
        var ag_region=["Barbuda_AG","Saint George_AG","Saint John_AG","Saint Mary_AG","Saint Paul_AG","Saint Peter_AG","Saint Philip_AG"];
        ...
        var ao_region=["Bengo_AO","Benguela_AO","Bie_AO","Cabinda_AO","Cuando Cubango_AO","Cuanza-Norte_AO","Cuanza-Sul_AO","Cunene_AO","Huambo_AO","Huila_AO","Luanda_AO","Lunda-Norte_AO","Lunda-Sul_AO","Malange_AO","Moxico_AO","Namibe_AO","Uige_AO","Zaire_AO"];
        ...
        var ax_region=["Eckeroe_AX","Finstroem_AX","Hammarland_AX","Jomala_AX","Lemland_AX","Mariehamn_AX","Saltvik_AX"];
        var az_region=["Abseron_AZ","Agcabadi_AZ","Agdas_AZ","Agstafa_AZ","Agsu_AZ","Astara_AZ","Baki_AZ","Balakan_AZ","Barda_AZ","Beylaqan_AZ","Calilabad_AZ","Gadabay_AZ","Ganca_AZ","Goranboy_AZ","Goycay_AZ","Goygol_AZ","Imisli_AZ","Ismayilli_AZ","Kalbacar_AZ","Kurdamir_AZ","Lankaran_AZ","Masalli_AZ","Mingacevir_AZ","Naftalan_AZ","Naxcivan_AZ","Neftcala_AZ","Oguz_AZ","Qabala_AZ","Qazax_AZ","Qobustan_AZ","Quba_AZ","Qusar_AZ","Saatli_AZ","Sabirabad_AZ","Saki_AZ","Salyan_AZ","Samaxi_AZ","Samkir_AZ","Samux_AZ","Sirvan_AZ","Siyazan_AZ","Sumqayit_AZ","Tartar_AZ","Tovuz_AZ","Ucar_AZ","Xacmaz_AZ","Xizi_AZ","Xocavand_AZ","Yardimli_AZ","Yevlax_AZ","Zaqatala_AZ","Zardab_AZ"];
        ...
        var bd_region=["Barishal_BD","Chattogram_BD","Dhaka_BD","Khulna_BD","Rajshahi_BD","Rangpur_BD","Sylhet_BD"];
        ...
        var bf_region=["Bale_BF","Bam_BF","Banwa_BF","Bazega_BF","Boulgou_BF","Boulkiemde_BF","Comoe_BF","Ganzourgou_BF","Gnagna_BF","Gourma_BF","Houet_BF","Kadiogo_BF","Kenedougou_BF","Kompienga_BF","Kossi_BF","Kouritenga_BF","Kourweogo_BF","Leraba_BF","Loroum_BF","Mouhoun_BF","Nahouri_BF","Namentenga_BF","Nayala_BF","Oubritenga_BF","Oudalan_BF","Passore_BF","Poni_BF","Sanmatenga_BF","Seno_BF","Sissili_BF","Soum_BF","Tapoa_BF","Tuy_BF","Yatenga_BF","Ziro_BF","Zondoma_BF","Zoundweogo_BF"];
        ...
        var bi_region=["Bujumbura Mairie_BI","Bururi_BI","Cibitoke_BI","Gitega_BI","Kirundo_BI","Mwaro_BI","Ngozi_BI","Rumonge_BI","Rutana_BI","Ruyigi_BI"];
        var bj_region=["Atacora_BJ","Atlantique_BJ","Borgou_BJ","Collines_BJ","Donga_BJ","Littoral_BJ","Mono_BJ","Oueme_BJ","Plateau_BJ","Zou_BJ"];
        ...
        var br_region=["Acre_BR","Alagoas_BR","Amapa_BR","Amazonas_BR","Bahia_BR","Ceara_BR","Distrito Federal_BR","Espirito Santo_BR","Goias_BR","Maranhao_BR","Mato Grosso_BR","Mato Grosso do Sul_BR","Minas Gerais_BR","Para_BR","Paraiba_BR","Parana_BR","Pernambuco_BR","Piaui_BR","Rio Grande do Norte_BR","Rio Grande do Sul_BR","Rio de Janeiro_BR","Rondonia_BR","Roraima_BR","Santa Catarina_BR","Sao Paulo_BR","Sergipe_BR","Tocantins_BR"];
        var bs_region=["Black Point_BS","Central Abaco_BS","City of Freeport_BS","East Grand Bahama_BS","Harbour Island_BS","Long Island_BS","Moore's Island_BS","New Providence_BS","North Andros_BS","North Eleuthera_BS","San Salvador_BS","South Eleuthera_BS","West Grand Bahama_BS"];
        var bt_region=["Bumthang_BT","Chhukha_BT","Dagana_BT","Gasa_BT","Lhuentse_BT","Monggar_BT","Paro_BT","Pema Gatshel_BT","Punakha_BT","Samdrup Jongkhar_BT","Samtse_BT","Sarpang_BT","Thimphu_BT","Trashigang_BT","Trongsa_BT","Tsirang_BT","Wangdue Phodrang_BT"];
        var bv_region=["Bouvet Island_BV"];
        var bw_region=["Central_BW","Chobe_BW","Ghanzi_BW","Kgalagadi_BW","Kgatleng_BW","Kweneng_BW","North East_BW","North West_BW","South East_BW","Southern_BW"];
        var by_region=["Brestskaya voblasts'_BY","Homyel'skaya voblasts'_BY","Horad Minsk_BY","Hrodzyenskaya voblasts'_BY","Mahilyowskaya voblasts'_BY","Minskaya voblasts'_BY","Vitsyebskaya voblasts'_BY"];
        ...
        var cd_region=["Equateur_CD","Haut-Katanga_CD","Haut-Lomami_CD","Ituri_CD","Kasai_CD","Kasai Central_CD","Kasai Oriental_CD","Kinshasa_CD","Lualaba_CD","Maniema_CD","Nord-Kivu_CD","Sankuru_CD","Sud-Kivu_CD","Tanganyika_CD","Tshopo_CD","Tshuapa_CD"];
        var cf_region=["Bamingui-Bangoran_CF","Bangui_CF","Gribingui_CF","Haut-Mbomou_CF","Haute-Kotto_CF","Kemo-Gribingui_CF","Lobaye_CF","Mambere-Kadei_CF","Nana-Mambere_CF","Ouaka_CF","Ouham_CF","Ouham-Pende_CF","Sangha_CF","Vakaga_CF"];
        var cg_region=["Bouenza_CG","Brazzaville_CG","Cuvette_CG","Likouala_CG","Niari_CG","Pointe-Noire_CG","Sangha_CG"];
        ...
        var cl_region=["Aisen del General Carlos Ibanez del Campo_CL","Antofagasta_CL","Arica y Parinacota_CL","Atacama_CL","Biobio_CL","Coquimbo_CL","La Araucania_CL","Libertador General Bernardo O'Higgins_CL","Los Lagos_CL","Los Rios_CL","Magallanes_CL","Maule_CL","Nuble_CL","Region Metropolitana de Santiago_CL","Tarapaca_CL","Valparaiso_CL"];
        ...
        var cn_region=["Anhui_CN","Beijing_CN","Chongqing_CN","Fujian_CN","Gansu_CN","Guangdong_CN","Guangxi Zhuangzu_CN","Guizhou_CN","Hainan_CN","Hebei_CN","Heilongjiang_CN","Henan_CN","Hubei_CN","Hunan_CN","Jiangsu_CN","Jiangxi_CN","Jilin_CN","Liaoning_CN","Nei Mongol_CN","Ningxia Huizu_CN","Qinghai_CN","Shaanxi_CN","Shandong_CN","Shanghai_CN","Shanxi_CN","Sichuan_CN","Tianjin_CN","Xinjiang Uygur_CN","Xizang_CN","Yunnan_CN","Zhejiang_CN"];
        var co_region=["Amazonas_CO","Antioquia_CO","Arauca_CO","Atlantico_CO","Bolivar_CO","Boyaca_CO","Caldas_CO","Caqueta_CO","Casanare_CO","Cauca_CO","Cesar_CO","Choco_CO","Cordoba_CO","Cundinamarca_CO","Distrito Capital de Bogota_CO","Guainia_CO","Guaviare_CO","Huila_CO","La Guajira_CO","Magdalena_CO","Meta_CO","Narino_CO","Norte de Santander_CO","Putumayo_CO","Quindio_CO","Risaralda_CO","San Andres, Providencia y Santa Catalina_CO","Santander_CO","Sucre_CO","Tolima_CO","Valle del Cauca_CO","Vichada_CO"];
        ...
        var cv_region=["Boa Vista_CV","Mosteiros_CV","Porto Novo_CV","Praia_CV","Ribeira Grande_CV","Ribeira Grande de Santiago_CV","Sal_CV","Santa Catarina_CV","Sao Domingos_CV","Sao Filipe_CV","Sao Lourenco dos Orgaos_CV","Sao Vicente_CV","Tarrafal_CV","Tarrafal de Sao Nicolau_CV"];
        ...
        var dj_region=["Ali Sabieh_DJ","Arta_DJ","Dikhil_DJ","Djibouti_DJ"];
        var dk_region=["Hovedstaden_DK","Midtjylland_DK","Nordjylland_DK","Sjaelland_DK","Syddanmark_DK"];
        var dm_region=["Saint Andrew_DM","Saint George_DM","Saint John_DM","Saint Joseph_DM","Saint Luke_DM","Saint Patrick_DM","Saint Paul_DM"];
        ...
        var er_region=["Al Awsat_ER","Qash-Barkah_ER"];
        ...
        var et_region=["Addis Ababa_ET","Afar_ET","Amara_ET","Benshangul-Gumaz_ET","Dire Dawa_ET","Harari People_ET","Oromia_ET","Somali_ET","Southern Nations, Nationalities and Peoples_ET","Tigrai_ET"];
        ...
        var fo_region=["Eysturoy_FO","Nordoyar_FO","Streymoy_FO","Suduroy_FO","Vagar_FO"];
        ...
        var gh_region=["Ahafo_GH","Ashanti_GH","Bono_GH","Bono East_GH","Central_GH","Eastern_GH","Greater Accra_GH","Northern_GH","Upper East_GH","Upper West_GH","Volta_GH","Western_GH"];
        ...
        var gm_region=["Banjul_GM","Central River_GM","Lower River_GM","North Bank_GM","Western_GM"];
        var gn_region=["Beyla_GN","Boke_GN","Conakry_GN","Coyah_GN","Dabola_GN","Dinguiraye_GN","Dubreka_GN","Fria_GN","Kankan_GN","Kouroussa_GN","Labe_GN","Mamou_GN","Pita_GN","Siguiri_GN"];
        var gp_region=["Guadeloupe_GP"];
        var gq_region=["Bioko Norte_GQ","Centro Sur_GQ","Kie-Ntem_GQ","Litoral_GQ","Wele-Nzas_GQ"];
        var gr_region=["Anatoliki Makedonia kai Thraki_GR","Attiki_GR","Dytiki Ellada_GR","Dytiki Makedonia_GR","Ionia Nisia_GR","Ipeiros_GR","Kentriki Makedonia_GR","Kriti_GR","Notio Aigaio_GR","Peloponnisos_GR","Sterea Ellada_GR","Thessalia_GR","Voreio Aigaio_GR"];
        ...
        var gu_region=["Agana Heights_GU","Agat_GU","Barrigada_GU","Chalan Pago-Ordot_GU","Dededo_GU","Hagatna_GU","Inarajan_GU","Mangilao_GU","Mongmong-Toto-Maite_GU","Piti_GU","Santa Rita_GU","Sinajana_GU","Talofofo_GU","Tamuning-Tumon-Harmon_GU","Yigo_GU","Yona_GU"];
        var gw_region=["Bafata_GW","Bissau_GW","Cacheu_GW","Gabu_GW","Oio_GW","Quinara_GW"];
        var gy_region=["Barima-Waini_GY","Cuyuni-Mazaruni_GY","Demerara-Mahaica_GY","East Berbice-Corentyne_GY","Essequibo Islands-West Demerara_GY","Mahaica-Berbice_GY","Pomeroon-Supenaam_GY","Potaro-Siparuni_GY","Upper Demerara-Berbice_GY"];
        var hk_region=["Hong Kong_HK"];
        var hm_region=["Heard Island and McDonald Islands_HM"];
        var hn_region=["Atlantida_HN","Choluteca_HN","Colon_HN","Comayagua_HN","Copan_HN","Cortes_HN","El Paraiso_HN","Francisco Morazan_HN","Intibuca_HN","Islas de la Bahia_HN","La Paz_HN","Lempira_HN","Ocotepeque_HN","Olancho_HN","Santa Barbara_HN","Valle_HN","Yoro_HN"];
        ...
        var ht_region=["Artibonite_HT","Centre_HT","Grande'Anse_HT","Nippes_HT","Nord_HT","Nord-Ouest_HT","Ouest_HT","Sud_HT","Sud-Est_HT"];
        var hu_region=["Bacs-Kiskun_HU","Baranya_HU","Bekes_HU","Borsod-Abauj-Zemplen_HU","Budapest_HU","Csongrad-Csanad_HU","Fejer_HU","Gyor-Moson-Sopron_HU","Hajdu-Bihar_HU","Heves_HU","Jasz-Nagykun-Szolnok_HU","Komarom-Esztergom_HU","Nograd_HU","Pest_HU","Somogy_HU","Szabolcs-Szatmar-Bereg_HU","Tolna_HU","Vas_HU","Veszprem_HU","Zala_HU"];
        ...
        var in_region=["Andaman and Nicobar Islands_IN","Andhra Pradesh_IN","Arunachal Pradesh_IN","Assam_IN","Bihar_IN","Chandigarh_IN","Chhattisgarh_IN","Dadra and Nagar Haveli and Daman and Diu_IN","Delhi_IN","Goa_IN","Gujarat_IN","Haryana_IN","Himachal Pradesh_IN","Jammu and Kashmir_IN","Jharkhand_IN","Karnataka_IN","Kerala_IN","Lakshadweep_IN","Madhya Pradesh_IN","Maharashtra_IN","Manipur_IN","Meghalaya_IN","Mizoram_IN","Nagaland_IN","Odisha_IN","Puducherry_IN","Punjab_IN","Rajasthan_IN","Sikkim_IN","Tamil Nadu_IN","Telangana_IN","Tripura_IN","Uttar Pradesh_IN","Uttarakhand_IN","West Bengal_IN"];
        ...
        var kg_region=["Batken_KG","Bishkek Shaary_KG","Chuy_KG","Jalal-Abad_KG","Naryn_KG","Osh Shaary_KG","Talas_KG","Ysyk-Kol_KG"];
        var kh_region=["Baat Dambang_KH","Banteay Mean Choay_KH","Kaeb_KH","Kampong Chaam_KH","Kampong Chhnang_KH","Kampong Spueu_KH","Kampong Thum_KH","Kampot_KH","Kandaal_KH","Kaoh Kong_KH","Kracheh_KH","Mondol Kiri_KH","Otdar Mean Chey_KH","Pailin_KH","Phnom Penh_KH","Pousaat_KH","Preah Sihanouk_KH","Preah Vihear_KH","Prey Veaeng_KH","Rotanak Kiri_KH","Siem Reab_KH","Stueng Traeng_KH","Svaay Rieng_KH","Taakaev_KH"];
        var ki_region=["Gilbert Islands_KI","Line Islands_KI"];
        var km_region=["Grande Comore_KM","Moheli_KM"];
        var kn_region=["Christ Church Nichola Town_KN","Saint Anne Sandy Point_KN","Saint George Basseterre_KN","Saint James Windward_KN","Saint John Capisterre_KN","Saint John Figtree_KN","Saint Mary Cayon_KN","Saint Paul Capisterre_KN","Saint Paul Charlestown_KN","Saint Peter Basseterre_KN","Saint Thomas Lowland_KN","Saint Thomas Middle Island_KN","Trinity Palmetto Point_KN"];
        var kp_region=["P'yongyang_KP"];
        var kr_region=["Busan-gwangyeoksi_KR","Chungcheongbuk-do_KR","Chungcheongnam-do_KR","Daegu-gwangyeoksi_KR","Daejeon-gwangyeoksi_KR","Gangwon-teukbyeoljachido_KR","Gwangju-gwangyeoksi_KR","Gyeonggi-do_KR","Gyeongsangbuk-do_KR","Gyeongsangnam-do_KR","Incheon-gwangyeoksi_KR","Jeju-teukbyeoljachido_KR","Jeollabuk-do_KR","Jeollanam-do_KR","Sejong_KR","Seoul-teukbyeolsi_KR","Ulsan-gwangyeoksi_KR"];
        ...
        var li_region=["Balzers_LI","Eschen_LI","Gamprin_LI","Mauren_LI","Ruggell_LI","Schaan_LI","Triesen_LI","Triesenberg_LI","Vaduz_LI"];
        ...
        var lr_region=["Bomi_LR","Bong_LR","Grand Bassa_LR","Grand Cape Mount_LR","Grand Gedeh_LR","Margibi_LR","Montserrado_LR","River Cess_LR","River Gee_LR","Sinoe_LR"];
        var ls_region=["Berea_LS","Botha-Bothe_LS","Leribe_LS","Mafeteng_LS","Maseru_LS","Mohale's Hoek_LS","Mokhotlong_LS","Qacha's Nek_LS","Quthing_LS","Thaba-Tseka_LS"];
        ...
        var lu_region=["Capellen_LU","Clervaux_LU","Diekirch_LU","Echternach_LU","Esch-sur-Alzette_LU","Grevenmacher_LU","Luxembourg_LU","Mersch_LU","Redange_LU","Remich_LU","Vianden_LU","Wiltz_LU"];
        var lv_region=["Adazu novads_LV","Aizkraukles novads_LV","Aluksnes novads_LV","Augsdaugavas novads_LV","Balvu novads_LV","Bauskas novads_LV","Cesu novads_LV","Daugavpils_LV","Dienvidkurzemes novads_LV","Dobeles novads_LV","Gulbenes novads_LV","Jekabpils novads_LV","Jelgava_LV","Jelgavas novads_LV","Jurmala_LV","Kekavas novads_LV","Kraslavas novads_LV","Kuldigas novads_LV","Liepaja_LV","Limbazu novads_LV","Livanu novads_LV","Ludzas novads_LV","Madonas novads_LV","Marupes novads_LV","Ogres novads_LV","Olaines novads_LV","Preilu novads_LV","Rezeknes novads_LV","Riga_LV","Ropazu novads_LV","Salaspils novads_LV","Saldus novads_LV","Saulkrastu novads_LV","Siguldas novads_LV","Smiltenes novads_LV","Talsu novads_LV","Tukuma novads_LV","Valkas novads_LV","Valmieras novads_LV","Varaklanu novads_LV","Ventspils novads_LV"];
        var ly_region=["Al Butnan_LY","Al Jabal al Akhdar_LY","Al Jabal al Gharbi_LY","Al Jafarah_LY","Al Jufrah_LY","Al Kufrah_LY","Al Marj_LY","Al Marqab_LY","Al Wahat_LY","An Nuqat al Khams_LY","Az Zawiyah_LY","Banghazi_LY","Darnah_LY","Misratah_LY","Murzuq_LY","Nalut_LY","Sabha_LY","Surt_LY","Tarabulus_LY","Wadi al Hayat_LY","Wadi ash Shati'_LY"];
        ...
        var me_region=["Bar_ME","Berane_ME","Bijelo Polje_ME","Budva_ME","Cetinje_ME","Danilovgrad_ME","Gusinje_ME","Herceg-Novi_ME","Kolasin_ME","Kotor_ME","Mojkovac_ME","Niksic_ME","Plav_ME","Pljevlja_ME","Pluzine_ME","Podgorica_ME","Rozaje_ME","Savnik_ME","Tivat_ME","Tuzi_ME","Ulcinj_ME","Zabljak_ME","Zeta_ME"];
        ...
        var mh_region=["Kwajalein_MH","Majuro_MH"];
        var mk_region=["Aracinovo_MK","Berovo_MK","Bitola_MK","Bogdanci_MK","Bogovinje_MK","Bosilovo_MK","Brvenica_MK","Butel_MK","Caska_MK","Centar_MK","Centar Zupa_MK","Cucer Sandevo_MK","Debar_MK","Debarca_MK","Delcevo_MK","Demir Hisar_MK","Demir Kapija_MK","Dojran_MK","Dolneni_MK","Gazi Baba_MK","Gevgelija_MK","Gostivar_MK","Gradsko_MK","Ilinden_MK","Jegunovce_MK","Karbinci_MK","Kavadarci_MK","Kicevo_MK","Kisela Voda_MK","Kocani_MK","Konce_MK","Kratovo_MK","Kriva Palanka_MK","Krivogastani_MK","Krusevo_MK","Kumanovo_MK","Lipkovo_MK","Lozovo_MK","Makedonska Kamenica_MK","Makedonski Brod_MK","Mavrovo i Rostusa_MK","Mogila_MK","Negotino_MK","Novo Selo_MK","Ohrid_MK","Pehcevo_MK","Petrovec_MK","Plasnica_MK","Prilep_MK","Probistip_MK","Radovis_MK","Rankovce_MK","Resen_MK","Rosoman_MK","Saraj_MK","Staro Nagoricane_MK","Stip_MK","Struga_MK","Strumica_MK","Studenicani_MK","Sveti Nikole_MK","Tearce_MK","Tetovo_MK","Valandovo_MK","Vasilevo_MK","Veles_MK","Vevcani_MK","Vinica_MK","Vrapciste_MK","Zelenikovo_MK","Zelino_MK"];
        ...
        var mn_region=["Bayan-Olgiy_MN","Bayanhongor_MN","Bulgan_MN","Darhan uul_MN","Dornod_MN","Dundgovi_MN","Dzavhan_MN","Govi-Altay_MN","Hovd_MN","Hovsgol_MN","Omnogovi_MN","Orhon_MN","Ovorhangay_MN","Selenge_MN","Tov_MN","Ulaanbaatar_MN"];
        var mo_region=["Macao_MO"];
        var mp_region=["Northern Mariana Islands_MP"];
        var mq_region=["Martinique_MQ"];
        var mr_region=["Adrar_MR","Assaba_MR","Brakna_MR","Dakhlet Nouadhibou_MR","Gorgol_MR","Guidimaka_MR","Hodh el Gharbi_MR","Inchiri_MR","Nouakchott Ouest_MR","Tagant_MR","Tiris Zemmour_MR","Trarza_MR"];
        var ms_region=["Saint Anthony_MS","Saint Peter_MS"];
        var mt_region=["Attard_MT","Balzan_MT","Birgu_MT","Birkirkara_MT","Birzebbuga_MT","Bormla_MT","Dingli_MT","Fgura_MT","Floriana_MT","Fontana_MT","Gharb_MT","Gharghur_MT","Ghasri_MT","Ghaxaq_MT","Gudja_MT","Gzira_MT","Hamrun_MT","Iklin_MT","Isla_MT","Kalkara_MT","Kirkop_MT","Lija_MT","Luqa_MT","Marsa_MT","Marsaskala_MT","Marsaxlokk_MT","Mdina_MT","Mellieha_MT","Mgarr_MT","Mosta_MT","Mqabba_MT","Msida_MT","Mtarfa_MT","Munxar_MT","Nadur_MT","Naxxar_MT","Paola_MT","Pembroke_MT","Pieta_MT","Qala_MT","Qormi_MT","Qrendi_MT","Rabat Gozo_MT","Rabat Malta_MT","Safi_MT","Saint John_MT","Saint Julian's_MT","Saint Lucia's_MT","Saint Paul's Bay_MT","Sannat_MT","Santa Venera_MT","Siggiewi_MT","Sliema_MT","Swieqi_MT","Ta' Xbiex_MT","Tarxien_MT","Valletta_MT","Xaghra_MT","Xewkija_MT","Xghajra_MT","Zabbar_MT","Zebbug Gozo_MT","Zejtun_MT","Zurrieq_MT"];
        var mu_region=["Black River_MU","Flacq_MU","Grand Port_MU","Moka_MU","Pamplemousses_MU","Plaines Wilhems_MU","Port Louis_MU","Riviere du Rempart_MU","Rodrigues Islands_MU","Savanne_MU"];
        var mv_region=["Addu City_MV","Faadhippolhu_MV","Felidhu Atoll_MV","Fuvammulah_MV","Hahdhunmathi_MV","Kolhumadulu_MV","Male_MV","Mulaku Atoll_MV","North Ari Atoll_MV","North Huvadhu Atoll_MV","North Maalhosmadulu_MV","North Miladhunmadulu_MV","North Nilandhe Atoll_MV","North Thiladhunmathi_MV","South Ari Atoll_MV","South Huvadhu Atoll_MV","South Maalhosmadulu_MV","South Miladhunmadulu_MV","South Nilandhe Atoll_MV","South Thiladhunmathi_MV"];
        var mw_region=["Balaka_MW","Blantyre_MW","Chikwawa_MW","Chiradzulu_MW","Chitipa_MW","Dedza_MW","Dowa_MW","Karonga_MW","Lilongwe_MW","Machinga_MW","Mangochi_MW","Mwanza_MW","Mzimba_MW","Neno_MW","Nkhata Bay_MW","Nkhotakota_MW","Ntchisi_MW","Salima_MW","Thyolo_MW","Zomba_MW"];
        ...
        var na_region=["Erongo_NA","Hardap_NA","Karas_NA","Kavango East_NA","Kavango West_NA","Khomas_NA","Kunene_NA","Ohangwena_NA","Omaheke_NA","Omusati_NA","Oshana_NA","Oshikoto_NA","Otjozondjupa_NA","Zambezi_NA"];
        var nc_region=["Province Nord_NC","Province Sud_NC","Province des iles Loyaute_NC"];
        var ne_region=["Agadez_NE","Diffa_NE","Maradi_NE","Niamey_NE","Tahoua_NE","Tillaberi_NE","Zinder_NE"];
        ...
        var no_region=["Agder_NO","Innlandet_NO","More og Romsdal_NO","Nordland_NO","Oslo_NO","Rogaland_NO","Troms og Finnmark_NO","Trondelag_NO","Vestfold og Telemark_NO","Vestland_NO","Viken_NO"];
        var np_region=["Bagmati_NP","Gandaki_NP","Karnali_NP","Koshi_NP","Lumbini_NP","Madhesh_NP","Sudurpashchim_NP"];
        var nr_region=["Aiwo_NR","Anetan_NR","Yaren_NR"];
        var nu_region=["Niue_NU"];
        var nz_region=["Auckland_NZ","Bay of Plenty_NZ","Canterbury_NZ","Chatham Islands Territory_NZ","Gisborne_NZ","Greater Wellington_NZ","Hawke's Bay_NZ","Manawatu-Whanganui_NZ","Marlborough_NZ","Nelson_NZ","Northland_NZ","Otago_NZ","Southland_NZ","Taranaki_NZ","Tasman_NZ","Waikato_NZ","West Coast_NZ"];
        ...
        var pa_region=["Bocas del Toro_PA","Chiriqui_PA","Cocle_PA","Colon_PA","Darien_PA","Herrera_PA","Los Santos_PA","Ngobe-Bugle_PA","Panama_PA","Veraguas_PA"];
        ...
        var pf_region=["Iles Australes_PF","Iles Marquises_PF","Iles Sous-le-Vent_PF","Iles Tuamotu-Gambier_PF","Iles du Vent_PF"];
        var pg_region=["Bougainville_PG","Central_PG","East New Britain_PG","Eastern Highlands_PG","Enga_PG","Madang_PG","Manus_PG","Milne Bay_PG","Morobe_PG","National Capital District (Port Moresby)_PG","New Ireland_PG","Northern_PG","Southern Highlands_PG","West New Britain_PG","West Sepik_PG","Western_PG","Western Highlands_PG"];
        var ph_region=["Abra_PH","Agusan del Norte_PH","Agusan del Sur_PH","Aklan_PH","Albay_PH","Antique_PH","Apayao_PH","Aurora_PH","Basilan_PH","Bataan_PH","Batanes_PH","Batangas_PH","Benguet_PH","Biliran_PH","Bohol_PH","Bukidnon_PH","Bulacan_PH","Cagayan_PH","Camarines Norte_PH","Camarines Sur_PH","Camiguin_PH","Capiz_PH","Catanduanes_PH","Cavite_PH","Cebu_PH","Cotabato_PH","Davao Oriental_PH","Davao de Oro_PH","Davao del Norte_PH","Davao del Sur_PH","Dinagat Islands_PH","Eastern Samar_PH","Guimaras_PH","Ifugao_PH","Ilocos Norte_PH","Ilocos Sur_PH","Iloilo_PH","Isabela_PH","Kalinga_PH","La Union_PH","Laguna_PH","Lanao del Norte_PH","Lanao del Sur_PH","Leyte_PH","Maguindanao_PH","Marinduque_PH","Masbate_PH","Mindoro Occidental_PH","Mindoro Oriental_PH","Misamis Occidental_PH","Misamis Oriental_PH","Mountain Province_PH","National Capital Region_PH","Negros Occidental_PH","Negros Oriental_PH","Northern Samar_PH","Nueva Ecija_PH","Nueva Vizcaya_PH","Palawan_PH","Pampanga_PH","Pangasinan_PH","Quezon_PH","Quirino_PH","Rizal_PH","Romblon_PH","Samar_PH","Sarangani_PH","Siquijor_PH","Sorsogon_PH","South Cotabato_PH","Southern Leyte_PH","Sultan Kudarat_PH","Sulu_PH","Surigao del Norte_PH","Surigao del Sur_PH","Tarlac_PH","Tawi-Tawi_PH","Zambales_PH","Zamboanga Sibugay_PH","Zamboanga del Norte_PH","Zamboanga del Sur_PH"];
        var pk_region=["Azad Jammu and Kashmir_PK","Balochistan_PK","Gilgit-Baltistan_PK","Islamabad_PK","Khyber Pakhtunkhwa_PK","Punjab_PK","Sindh_PK"];
        ...
        var pw_region=["Airai_PW","Koror_PW","Melekeok_PW","Ngaraard_PW","Ngardmau_PW","Ngatpang_PW","Sonsorol_PW"];
        var py_region=["Alto Parana_PY","Amambay_PY","Asuncion_PY","Boqueron_PY","Caaguazu_PY","Caazapa_PY","Canindeyu_PY","Central_PY","Concepcion_PY","Cordillera_PY","Guaira_PY","Itapua_PY","Misiones_PY","Neembucu_PY","Paraguari_PY","Presidente Hayes_PY","San Pedro_PY"];
        ...
        var sb_region=["Guadalcanal_SB","Isabel_SB","Makira-Ulawa_SB","Western_SB"];
        var sc_region=["Anse Boileau_SC","Anse Royale_SC","Anse aux Pins_SC","Baie Lazare_SC","Baie Sainte Anne_SC","Beau Vallon_SC","Bel Ombre_SC","Cascade_SC","English River_SC","Grand Anse Mahe_SC","Grand Anse Praslin_SC","La Digue_SC","Pointe Larue_SC","Takamaka_SC"];
        var sd_region=["Blue Nile_SD","Central Darfur_SD","Gedaref_SD","Gezira_SD","Kassala_SD","Khartoum_SD","North Darfur_SD","North Kordofan_SD","Northern_SD","Red Sea_SD","River Nile_SD","Sennar_SD","South Darfur_SD","South Kordofan_SD","West Darfur_SD","West Kordofan_SD","White Nile_SD"];
        ...
        var sm_region=["Chiesanuova_SM","Citta di San Marino_SM","Faetano_SM","Serravalle_SM"];
        var sn_region=["Dakar_SN","Diourbel_SN","Fatick_SN","Kaffrine_SN","Kaolack_SN","Kedougou_SN","Louga_SN","Matam_SN","Saint-Louis_SN","Sedhiou_SN","Tambacounda_SN","Thies_SN","Ziguinchor_SN"];
        var so_region=["Awdal_SO","Banaadir_SO","Bari_SO","Bay_SO","Galguduud_SO","Jubbada Hoose_SO","Mudug_SO","Nugaal_SO","Sool_SO","Togdheer_SO","Woqooyi Galbeed_SO"];
        var sr_region=["Brokopondo_SR","Commewijne_SR","Coronie_SR","Nickerie_SR","Para_SR","Paramaribo_SR","Saramacca_SR","Sipaliwini_SR","Wanica_SR"];
        ...
        var st_region=["Agua Grande_ST","Principe_ST"];
        ...
        var sz_region=["Hhohho_SZ","Lubombo_SZ","Manzini_SZ"];
        var tc_region=["Turks and Caicos Islands_TC"];
        var td_region=["Bahr el Ghazal_TD","Chari-Baguirmi_TD","Guera_TD","Lac_TD","Mayo-Kebbi-Est_TD","Ouaddai_TD","Sila_TD","Ville de Ndjamena_TD","Wadi Fira_TD"];
        ...
        var tl_region=["Aileu_TL","Ainaro_TL","Baucau_TL","Bobonaro_TL","Dili_TL","Ermera_TL","Liquica_TL","Oecussi_TL"];
        var tm_region=["Ahal_TM","Balkan_TM","Lebap_TM","Mary_TM"];
        ...
        var ug_region=["Abim_UG","Adjumani_UG","Agago_UG","Alebtong_UG","Apac_UG","Arua_UG","Budaka_UG","Bududa_UG","Bugiri_UG","Buhweju_UG","Buikwe_UG","Bukedea_UG","Bukomansibi_UG","Bulambuli_UG","Buliisa_UG","Bundibugyo_UG","Bushenyi_UG","Busia_UG","Buvuma_UG","Buyende_UG","Gomba_UG","Gulu_UG","Hoima_UG","Ibanda_UG","Iganga_UG","Isingiro_UG","Jinja_UG","Kaabong_UG","Kabale_UG","Kabarole_UG","Kaberamaido_UG","Kalangala_UG","Kaliro_UG","Kalungu_UG","Kampala_UG","Kamuli_UG","Kamwenge_UG","Kanungu_UG","Kapchorwa_UG","Kasese_UG","Katakwi_UG","Kayunga_UG","Kibaale_UG","Kiboga_UG","Kibuku_UG","Kiruhura_UG","Kiryandongo_UG","Kisoro_UG","Kitgum_UG","Koboko_UG","Kole_UG","Kotido_UG","Kumi_UG","Kween_UG","Kyankwanzi_UG","Kyegegwa_UG","Kyenjojo_UG","Lamwo_UG","Lira_UG","Luuka_UG","Luwero_UG","Lwengo_UG","Lyantonde_UG","Manafwa_UG","Maracha_UG","Masaka_UG","Masindi_UG","Mayuge_UG","Mbale_UG","Mbarara_UG","Mitooma_UG","Mityana_UG","Moroto_UG","Moyo_UG","Mpigi_UG","Mubende_UG","Mukono_UG","Nakapiripirit_UG","Nakaseke_UG","Nakasongola_UG","Napak_UG","Nebbi_UG","Ntoroko_UG","Ntungamo_UG","Nwoya_UG","Oyam_UG","Pader_UG","Rakai_UG","Rubirizi_UG","Rukungiri_UG","Sembabule_UG","Sheema_UG","Sironko_UG","Soroti_UG","Tororo_UG","Wakiso_UG","Yumbe_UG","Zombo_UG"];
        var um_region=["Palmyra Atoll_UM"];
        ...
        var vc_region=["Charlotte_VC","Grenadines_VC","Saint George_VC","Saint Patrick_VC"];
        var ve_region=["Amazonas_VE","Anzoategui_VE","Apure_VE","Aragua_VE","Barinas_VE","Bolivar_VE","Carabobo_VE","Cojedes_VE","Delta Amacuro_VE","Dependencias Federales_VE","Distrito Capital_VE","Falcon_VE","Guarico_VE","La Guaira_VE","Lara_VE","Merida_VE","Miranda_VE","Monagas_VE","Nueva Esparta_VE","Portuguesa_VE","Sucre_VE","Tachira_VE","Trujillo_VE","Yaracuy_VE","Zulia_VE"];
        var vg_region=["Virgin Islands, British_VG"];
        var vi_region=["Virgin Islands, U.S._VI"];
        var vn_region=["An Giang_VN","Ba Ria - Vung Tau_VN","Bac Giang_VN","Bac Kan_VN","Bac Lieu_VN","Bac Ninh_VN","Ben Tre_VN","Binh Dinh_VN","Binh Duong_VN","Binh Phuoc_VN","Binh Thuan_VN","Ca Mau_VN","Can Tho_VN","Cao Bang_VN","Da Nang_VN","Dak Lak_VN","Dak Nong_VN","Dien Bien_VN","Dong Nai_VN","Dong Thap_VN","Gia Lai_VN","Ha Giang_VN","Ha Nam_VN","Ha Noi_VN","Ha Tinh_VN","Hai Duong_VN","Hai Phong_VN","Hau Giang_VN","Ho Chi Minh_VN","Hoa Binh_VN","Hung Yen_VN","Khanh Hoa_VN","Kien Giang_VN","Kon Tum_VN","Lai Chau_VN","Lam Dong_VN","Lang Son_VN","Lao Cai_VN","Long An_VN","Nam Dinh_VN","Nghe An_VN","Ninh Binh_VN","Ninh Thuan_VN","Phu Tho_VN","Phu Yen_VN","Quang Binh_VN","Quang Nam_VN","Quang Ngai_VN","Quang Ninh_VN","Quang Tri_VN","Soc Trang_VN","Son La_VN","Tay Ninh_VN","Thai Binh_VN","Thai Nguyen_VN","Thanh Hoa_VN","Thua Thien-Hue_VN","Tien Giang_VN","Tra Vinh_VN","Tuyen Quang_VN","Vinh Long_VN","Vinh Phuc_VN","Yen Bai_VN"];
        var vu_region=["Sanma_VU","Shefa_VU","Tafea_VU"];
        var wf_region=["Sigave_WF","Uvea_WF"];
        var ws_region=["Atua_WS","Fa'asaleleaga_WS","Tuamasaga_WS"];
        var ye_region=["'Adan_YE","'Amran_YE","Ad Dali'_YE","Al Bayda'_YE","Al Hudaydah_YE","Al Jawf_YE","Al Mahwit_YE","Amanat al 'Asimah_YE","Dhamar_YE","Hadramawt_YE","Hajjah_YE","Ibb_YE","Lahij_YE","Ma'rib_YE","Sa'dah_YE","San'a'_YE","Shabwah_YE","Ta'izz_YE"];
        var yt_region=["Bandraboua_YT","Bandrele_YT","Kani-Keli_YT","Mamoudzou_YT","Pamandzi_YT","Tsingoni_YT"];
        ...
        var zm_region=["Central_ZM","Copperbelt_ZM","Eastern_ZM","Luapula_ZM","Lusaka_ZM","Muchinga_ZM","North-Western_ZM","Northern_ZM","Southern_ZM","Western_ZM"];
