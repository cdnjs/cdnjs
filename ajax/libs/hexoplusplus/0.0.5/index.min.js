const hpp_domain="blogadmin.cyfan.top",hpp_userimage="https://cdn.jsdelivr.net/gh/ChenYFan/CDN/img/avatar.png",hpp_title="ChenYFan的后台",hpp_usericon="https://cdn.jsdelivr.net/gh/ChenYFan/CDN/img/ico/apple-touch-icon.png",hpp_password="",hpp_username="",hpp_cors="*",hpp_CDNver="b8a6e54",hpp_githubdoctoken="",hpp_githubimagetoken=hpp_githubdoctoken,hpp_githubdocusername="",hpp_githubdocrepo="",hpp_githubdocpath="",hpp_githubdocbranch="",hpp_githubimageusername="",hpp_githubimagerepo="",hpp_githubimagepath="",hpp_githubimagebranch="",hpp_ver="HexoPlusPlus@0.0.5",hpp_githubgetimageinit={method:"GET",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubimagetoken}},hpp_githubgetdocinit={method:"GET",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubdoctoken}},hpp_loginhtml='<!DOCTYPE html><html lang="zh-cmn-Hans"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no"><script src="https://cdn.jsdelivr.net/npm/jquery@3.4.1"><\/script><link rel="shortcut icon" href="'+hpp_usericon+'" type="image/x-icon" /><title>'+hpp_title+'</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/HexoPlusPlus/HexoPlusPlus@'+hpp_CDNver+'/dist/login.css">   </head><body><div id="all"><div class="wrapper"><div class="bg-container"><div class="container"><h1 style="margin: 0;" id="bar">Welcome</h1><form class="form" id="fm"><input id="username" type="text" placeholder="用户名" value name="username" /><input id="password" type="password" placeholder="密码" value name="password" /><button type="button" id="login-button">登陆</button><br /><br /><a href="https://github.com/HexoPlusPlus/HexoPlusPlus" id="tips">@HexoPP</a></form></div></div><ul class="bg-bubbles"><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div></div><script>  $("#login-button").click(function (event) {   document.cookie="username=" + document.getElementById("username").value;  document.cookie="password="+document.getElementById("password").value;  location.reload();  });<\/script></body></html>',hpp_adminhtml=`
...
`,hpp_filemanager_p1=`<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"> 
...
</html>`,hpp_filemanager_docs=hpp_filemanager_p1+hpp_filemanager_docs1+hpp_filemanager_p2+hpp_filemanager_docs2,hpp_filemanager_img=hpp_filemanager_p1+hpp_filemanager_img1+hpp_filemanager_p2+hpp_filemanager_img2;function getCookie(t,i){let a="";const e=t.headers.get("Cookie");if(e){const s=e.split(";");s.forEach(t=>{const e=t.split("=",2);e[0].trim()===i&&(t=e[1],a=t)})}return a}async function handleRequest(t){var e=0,i=t.url;const a=new URL(i),s=a.href.substr(a.origin.length);if(getCookie(t,"password")==hpp_password&&getCookie(t,"username")==hpp_username&&(e=1,i=Date.now(new Date),await KVNAME.put("hpp_activetime",i),Date.now(new Date)),s.startsWith("/hpp/admin")){if(1!=e)return"/hpp/admin"==s?new Response(hpp_loginhtml,{headers:{"content-type":"text/html;charset=UTF-8"}}):Response.redirect("https://"+hpp_domain+"/hpp/admin",302);if("/hpp/admin/docsmanager"==s)return new Response(hpp_filemanager_docs,{headers:{"content-type":"text/html;charset=UTF-8"}});if("/hpp/admin/imgsmanager"==s)return new Response(hpp_filemanager_img,{headers:{"content-type":"text/html;charset=UTF-8"}});if(s.startsWith("/hpp/admin/api/adddoc/"))return i=await t.text(),e=s.substr("/hpp/admin/api/adddoc/".length),e=`https://api.github.com/repos/${hpp_githubdocusername}/${hpp_githubdocrepo}/contents`+hpp_githubdocpath+e,p=JSON.parse(await(await fetch(e,hpp_githubgetdocinit)).text()).sha,i={branch:hpp_githubdocbranch,message:`Upload from ${hpp_ver} By `+hpp_githubdocusername,content:i,sha:p},p={body:JSON.stringify(i),method:"PUT",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubdoctoken}},200==(i=await(await fetch(e,p)).status)||201==i?new Response("Update Success",{status:i}):new Response("Fail To Update",{status:i});if(s.startsWith("/hpp/admin/api/addimage"))return e=await t.text(),p=Date.parse(new Date),i=s.substr("/hpp/admin/api/addimage/".length),t=`https://api.github.com/repos/${hpp_githubimageusername}/${hpp_githubimagerepo}/contents${hpp_githubimagepath}${p}.`+i,e={branch:hpp_githubimagebranch,message:`Upload from ${hpp_ver} By `+hpp_githubdocusername,content:e},e={body:JSON.stringify(e),method:"PUT",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubdoctoken}},200==(t=await(await fetch(t,e)).status)||201==t?new Response(`https://cdn.jsdelivr.net/gh/${hpp_githubimageusername}/${hpp_githubimagerepo}@${hpp_githubimagebranch}${hpp_githubimagepath}${p}.`+i,{status:t}):new Response("Fail To Upload Image",{status:t});if(s.startsWith("/hpp/admin/api/deldoc"))return e=s.substr("/hpp/admin/api/deldoc/".length),p=`https://api.github.com/repos/${hpp_githubdocusername}/${hpp_githubdocrepo}/contents`+hpp_githubdocpath+e,i=JSON.parse(await(await fetch(p,hpp_githubgetdocinit)).text()).sha,t={branch:hpp_githubdocbranch,message:`Delete from ${hpp_ver} By `+hpp_githubdocusername,sha:i},e={body:JSON.stringify(t),method:"DELETE",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubdoctoken}},200==(i=await(await fetch(p,e)).status)?new Response("Delete Success",{status:i}):new Response("Fail To Delete doc",{status:i});if(s.startsWith("/hpp/admin/api/delimage"))return t=s.substr("/hpp/admin/api/delimage/".length),p=`https://api.github.com/repos/${hpp_githubimageusername}/${hpp_githubimagerepo}/contents${hpp_githubimagepath}${t}?ref=`+hpp_githubimagebranch,e=JSON.parse(await(await fetch(p,hpp_githubgetimageinit)).text()).sha,i={branch:hpp_githubimagebranch,message:`Delete from ${hpp_ver} By `+hpp_githubdocusername,sha:e},t={body:JSON.stringify(i),method:"DELETE",headers:{"content-type":"application/json;charset=UTF-8","user-agent":hpp_ver,Authorization:"token "+hpp_githubdoctoken}},200==(e=await(await fetch(p,t)).status)?new Response("Delete Success",{status:e}):new Response("Fail To Delete doc",{status:e});if(s.startsWith("/hpp/admin/api/getdoc"))return i=s.substr("/hpp/admin/api/getdoc/".length),fetch(`https://raw.githubusercontent.com/${hpp_githubdocusername}/${hpp_githubdocrepo}/${hpp_githubdocbranch}${hpp_githubdocpath}${i}?ref=`+hpp_githubdocbranch);if("/hpp/admin/api/getlist"==s){var p=`https://api.github.com/repos/${hpp_githubdocusername}/${hpp_githubdocrepo}/contents${hpp_githubdocpath}?ref=`+hpp_githubdocbranch;const n=await fetch(p,hpp_githubgetdocinit);return new Response(await n.text(),{headers:{"content-type":"application/json;charset=UTF-8","Access-Control-Allow-Origin":hpp_cors}})}if("/hpp/admin/api/getimglist"!=s)return new Response(hpp_adminhtml,{headers:{"content-type":"text/html;charset=UTF-8"}});{t=`https://api.github.com/repos/${hpp_githubimageusername}/${hpp_githubimagerepo}/contents${hpp_githubimagepath}?ref=`+hpp_githubimagebranch;const h=await fetch(t,hpp_githubgetimageinit);return new Response(await h.text(),{headers:{"content-type":"application/json;charset=UTF-8","Access-Control-Allow-Origin":hpp_cors}})}}return s.startsWith("/hpp/api")?"/hpp/api/getblogeractive"==s?(e=await KVNAME.get("hpp_activetime"),(i=(Date.parse(new Date)-e)/1e3)<30?new Response("document.getElementById(\"bloggeractivetime\").innerHTML='博主刚刚还在这儿呢'",{headers:{headers:"content-type: application/javascript; charset=utf-8"}}):i<60?new Response('document.getElementById("bloggeractivetime").innerHTML=\'博主在'+i+"秒前离开这儿'",{headers:{headers:"content-type: application/javascript; charset=utf-8"}}):i<3600?new Response('document.getElementById("bloggeractivetime").innerHTML=\'博主在'+Math.round(i/60)+"分钟前偷偷瞄了一眼博客'",{headers:{headers:"content-type: application/javascript; charset=utf-8"}}):i<86400?new Response('document.getElementById("bloggeractivetime").innerHTML=\'博主在'+Math.round(i/3600)+"小时前活跃了一次'",{headers:{headers:"content-type: application/javascript; charset=utf-8"}}):new Response(e)):new Response("APIERROR"):new Response("ERROR")}addEventListener("fetch",t=>{t.respondWith(handleRequest(t.request))});