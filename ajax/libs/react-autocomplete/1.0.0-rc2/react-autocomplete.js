...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', _extends({ style: _extends({}, this.props.wrapperStyle) }, this.props.wrapperProps), React.createElement('label', { htmlFor: this.id, ref: 'label' }, this.props.labelText), React.createElement('input', _extends({}, this.props.inputProps, {
	      role: 'combobox',
