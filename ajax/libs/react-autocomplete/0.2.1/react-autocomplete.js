...
/***/ function(module, exports, __webpack_require__) {
	...
	var scrollIntoView = __webpack_require__(5);
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement('div', { style: { display: 'inline-block' } }, React.createElement('label', { htmlFor: this.id, ref: 'label' }, this.props.labelText), React.createElement('input', _extends({}, this.props.inputProps, {
	      role: 'combobox',
