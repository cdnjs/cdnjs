  ...
  addSplitParticle(parent, splitParticlesOptions) {
    ...
    if (splitOptions.color) {
      ...
      options.color.load({
        value: {
          hsl: {
            h: parentColor.h + (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)((_a = splitOptions.colorOffset.h) !== null && _a !== void 0 ? _a : 0),
            s: parentColor.s + (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)((_b = splitOptions.colorOffset.s) !== null && _b !== void 0 ? _b : 0),
            l: parentColor.l + (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)((_c = splitOptions.colorOffset.l) !== null && _c !== void 0 ? _c : 0)
          }
        }
      });
    } else {
