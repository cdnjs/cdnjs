...
class DestroyUpdater {
  ...
  init(particle) {
    ...
    if (destroyBounds.bottom) {
      particle.destroyBounds.bottom = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(destroyBounds.bottom) * container.canvas.size.height / 100;
    }
    if (destroyBounds.left) {
      particle.destroyBounds.left = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(destroyBounds.left) * container.canvas.size.width / 100;
    }
    if (destroyBounds.right) {
      particle.destroyBounds.right = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(destroyBounds.right) * container.canvas.size.width / 100;
    }
    if (destroyBounds.top) {
      particle.destroyBounds.top = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(destroyBounds.top) * container.canvas.size.height / 100;
    }
  }
  isEnabled(particle) {
  ...
  addSplitParticle(parent, splitParticlesOptions) {
    ...
    const splitOptions = destroyOptions.split,
      options = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.loadParticlesOptions)(this.engine, this.container, parent.options),
