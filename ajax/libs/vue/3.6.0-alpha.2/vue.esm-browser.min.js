...
`,0),l()),c||o("return "),t.codegenNode?genNode(t.codegenNode,n):o("null"),p&&(a(),o("}")),a(),o("}"),{ast:t,code:n.code,preamble:"",map:n.map?n.map.toJSON():void 0,helpers:t.helpers}}function genFunctionPreamble(e,t){const{push:n,newline:r,runtimeGlobalName:o}=t;var s=o;const i=Array.from(e.helpers);0<i.length&&(n(`const _Vue = ${s}
