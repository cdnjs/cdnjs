...
class RenderEffect extends ReactiveEffect {
  constructor(render) {
    ...
    this.render = render;
    const instance = currentInstance;
    if (!this.subs && !isVaporComponent(instance)) {
...
const createFor = (src, renderItem, getKey, flags = 0, setup) => {
  ...
  let parent;
  let currentKey;
  const parentAnchor = createComment("for") ;
