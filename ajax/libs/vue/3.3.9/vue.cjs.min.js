...
`+e:t)}const m=new Function("Vue",r)(runtimeDom__namespace);return m._rc=!0,compileCache[t]=m}runtimeDom.registerRuntimeCompiler(compileToFunction),exports.compile=compileToFunction,Object.keys(runtimeDom).forEach(function(e){"default"===e||Object.prototype.hasOwnProperty.call(exports,e)||(exports[e]=runtimeDom[e])});