...
Server rendered element contains more child nodes than client vdom.`),t=!0),logMismatchError());var h=e;e=e.nextSibling,w(h)}}else 8&c&&n.textContent!==r.children&&(isMismatchAllowed(n,0)||(warn$1("Hydration text content mismatch on",n,`
  - rendered on server: ${n.textContent}
  - expected on client: `+r.children),logMismatchError()),n.textContent=r.children);if(l){var m=n.tagName.includes("-");for(const v in l)u&&u.some(e=>e.dir.created)||!propHasMismatch(n,v,l[v],r,o)||logMismatchError(),(f&&(v.endsWith("value")||"indeterminate"===v)||isOn(v)&&!isReservedProp(v)||"."===v[0]||m)&&y(n,v,null,l[v],void 0,o)}let t;(t=l&&l.onVnodeBeforeMount)&&invokeVNodeHook(t,o,r),u&&invokeDirectiveHook(r,null,o,"beforeMount"),((t=l&&l.onVnodeMounted)||u||e)&&queueEffectWithSuspense(()=>{t&&invokeVNodeHook(t,o,r),e&&d.enter(n),u&&invokeDirectiveHook(r,null,o,"mounted")},s)}return n.nextSibling},k=(t,e,n,r,o,s,i)=>{i=i||!!e.dynamicChildren;const a=e.children;var l=a.length;let c=!1;for(let e=0;e<l;e++){const p=i?a[e]:a[e]=normalizeVNode(a[e]);var u,d=p.type===Text;t?(d&&!i&&(u=a[e+1])&&(u=normalizeVNode(u)).type===Text&&(_(b(t.data.slice(p.children.length)),n,S(t)),t.data=p.children),t=T(t,p,r,o,s,i)):d&&!p.children?_(p.el=b(""),n):(isMismatchAllowed(n,1)||(c||(warn$1("Hydration children mismatch on",n,`
Server rendered element contains fewer child nodes than client vdom.`),c=!0),logMismatchError()),f(null,p,n,null,r,o,getContainerType(n),s))}return t},E=(e,t,n,r,o,s)=>{var i=t["slotScopeIds"],i=(i&&(o=o?o.concat(i):i),C(e)),e=k(S(e),t,i,n,r,o,s);return e&&isComment(e)&&"]"===e.data?S(t.anchor=e):(logMismatchError(),_(t.anchor=a("]"),i,e),e)},A=(e,t,n,r,o,s)=>{if(isMismatchAllowed(e.parentElement,1)||(warn$1(`Hydration node mismatch:
