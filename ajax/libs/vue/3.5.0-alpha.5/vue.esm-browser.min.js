...
Server rendered element contains more child nodes than client vdom.`),t=!0),logMismatchError());var f=e;e=e.nextSibling,C(f)}}else 8&c&&n.textContent!==r.children&&(isMismatchAllowed(n,0)||(warn$1("Hydration text content mismatch on",n,`
  ...
  - expected on client: `+r.children),logMismatchError()),n.textContent=r.children);if(l)for(const m in l)d&&d.some(e=>e.dir.created)||!propHasMismatch(n,m,l[m],r,o)||logMismatchError(),(h&&(m.endsWith("value")||"indeterminate"===m)||isOn(m)&&!isReservedProp(m)||"."===m[0])&&y(n,m,null,l[m],void 0,o);let t;(t=l&&l.onVnodeBeforeMount)&&invokeVNodeHook(t,o,r),d&&invokeDirectiveHook(r,null,o,"beforeMount"),((t=l&&l.onVnodeMounted)||d||e)&&queueEffectWithSuspense(()=>{t&&invokeVNodeHook(t,o,r),e&&p.enter(n),d&&invokeDirectiveHook(r,null,o,"mounted")},s)}return n.nextSibling},R=(t,e,n,r,o,s,i)=>{i=i||!!e.dynamicChildren;const a=e.children;var l=a.length;let c=!1;for(let e=0;e<l;e++){const u=i?a[e]:a[e]=normalizeVNode(a[e]);var d,p=u.type===Text;t?(p&&!i&&(d=a[e+1])&&(d=normalizeVNode(d)).type===Text&&(T(S(t.data.slice(u.children.length)),n,E(t)),t.data=u.children),t=x(t,u,r,o,s,i)):p&&!u.children?T(u.el=S(""),n):(isMismatchAllowed(n,1)||(c||(warn$1("Hydration children mismatch on",n,`
