  ...
  ***************************************************************************** */
  ...
  function initSetup(vm) {
      ...
      if (setup) {
          ...
          var setupResult = invokeWithErrorHandling(setup, null, [vm._props, ctx], vm, "setup");
          setCurrentInstance();
  ...
  function proxySetupProperty(vm, setupResult, key) {
      var raw = setupResult[key];
      var unwrap = isRef(raw);
      Object.defineProperty(vm, key, {
          enumerable: true,
          configurable: true,
          get: unwrap ? function () { return raw.value; } : function () { return setupResult[key]; },
          set: unwrap ? function (v) { return (raw.value = v); } : function (v) { return (setupResult[key] = v); }
      });
  }
  ...
  function registerRef(vnode, isRemoval) {
      ...
      var setupRefKey = vnode.data.ref_key;
