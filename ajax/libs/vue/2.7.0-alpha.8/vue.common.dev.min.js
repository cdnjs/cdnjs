...
`+`  Raw expression: ${n.trim()}
`,o)}}const range=2;function generateCodeFrame(e,n=0,r=e.length){var o,i,a,s=e.split(/\r?\n/);let c=0;const l=[];for(let t=0;t<s.length;t++)if((c+=s[t].length+1)>=n){for(let e=t-range;e<=t+range||r>c;e++)e<0||e>=s.length||(l.push(`${e+1}${repeat(" ",3-String(e+1).length)}|  `+s[e]),o=s[e].length,e===t?(a=n-(c-o)+1,i=r>c?o-a:r-n,l.push("   |  "+repeat(" ",a)+repeat("^",i))):e>t&&(r>c&&(a=Math.min(r-c,o),l.push("   |  "+repeat("^",a))),c+=o+1));break}return l.join("\n")}function repeat(e,t){let n="";if(0<t)for(;;){if(1&t&&(n+=e),(t>>>=1)<=0)break;e+=e}return n}function createFunction(t,n){try{return new Function(t)}catch(e){return n.push({err:e,code:t}),noop}}function createCompileToFunctionFn(c){const l=Object.create(null);return function(t,e,n){const r=(e=extend({},e)).warn||warn$2;delete e.warn;try{new Function("return 1")}catch(e){e.toString().match(/unsafe-eval|CSP/)&&r("It seems you are using the standalone build of Vue.js in an environment with Content Security Policy that prohibits unsafe-eval. The template compiler cannot work in this environment. Consider relaxing the policy to allow unsafe-eval or pre-compiling your templates into render functions.")}var o=e.delimiters?String(e.delimiters)+t:t;if(l[o])return l[o];const i=c(t,e),a=(i.errors&&i.errors.length&&(e.outputSourceRange?i.errors.forEach(e=>{r(`Error compiling template:
...
`+i.errors.map(e=>"- "+e).join("\n")+"\n",n)),i.tips&&i.tips.length&&(e.outputSourceRange?i.tips.forEach(e=>tip(e.msg,n)):i.tips.forEach(e=>tip(e,n))),{}),s=[];return a.render=createFunction(i.render,s),a.staticRenderFns=i.staticRenderFns.map(e=>createFunction(e,s)),i.errors&&i.errors.length||!s.length||r(`Failed to generate render function:

`+s.map(({err:e,code:t})=>e.toString()+` in

${t}
`).join("\n"),n),l[o]=a}}function createCompilerCreator(d){return function(l){function e(e,t){const n=Object.create(l),o=[],i=[];let r=(e,t,n)=>{(n?i:o).push(e)};if(t){if(t.outputSourceRange){const s=e.match(/^\s*/)[0].length;r=(e,t,n)=>{const r="string"==typeof e?{msg:e}:e;t&&(null!=t.start&&(r.start=t.start+s),null!=t.end&&(r.end=t.end+s)),(n?i:o).push(r)}}t.modules&&(n.modules=(l.modules||[]).concat(t.modules)),t.directives&&(n.directives=extend(Object.create(l.directives||null),t.directives));for(const c in t)"modules"!==c&&"directives"!==c&&(n[c]=t[c])}n.warn=r;const a=d(e.trim(),n);return detectErrors(a.ast,r),a.errors=o,a.tips=i,a}return{compile:e,compileToFunctions:createCompileToFunctionFn(e)}}}const createCompiler=createCompilerCreator(function(e,t){e=parse(e.trim(),t),!1!==t.optimize&&optimize(e,t),t=generate(e,t);return{ast:e,render:t.render,staticRenderFns:t.staticRenderFns}}),{compile,compileToFunctions}=createCompiler(baseOptions);let div;function getShouldDecode(e){return(div=div||document.createElement("div")).innerHTML=e?`<a href="
"/>`:`<div a="
