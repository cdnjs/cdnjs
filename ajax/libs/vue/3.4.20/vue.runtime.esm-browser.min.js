...
- expected on client:`,t.type),t.el=null,s)for(var a=x(e);;){var i=C(e);if(!i||i===a)break;S(i)}var s=C(e),l=w(e);return S(e),d(null,t,l,s,n,r,getContainerType(l),o),s},x=(e,t="[",n="]")=>{let r=0;for(;e;)if((e=C(e))&&isComment(e)&&(e.data===t&&r++,e.data===n)){if(0===r)return C(e);r--}return e},O=(e,t,n)=>{const r=t.parentNode;r&&r.replaceChild(e,t);let o=n;for(;o;)o.vnode.el===t&&(o.vnode.el=o.subTree.el=e),o=o.parent},I=e=>1===e.nodeType&&"template"===e.tagName.toLowerCase();return[(e,t)=>{if(!t.hasChildNodes())return warn$1("Attempting to hydrate existing markup but container is empty. Performing full mount instead."),d(null,e,t),flushPostFlushCbs(),void(t._vnode=e);hasMismatch=!1,T(t.firstChild,e,null,null,null),flushPostFlushCbs(),t._vnode=e,hasMismatch&&console.error("Hydration completed but contains mismatches.")},T]}function propHasMismatch(e,t,n,r,o){let s,a,i,l;if("class"===t)i=e.getAttribute("class"),l=normalizeClass(n),isSetEqual(toClassSet(i||""),toClassSet(l))||(s=a="class");else if("style"===t){i=e.getAttribute("style"),l=isString(n)?n:stringifyStyle(normalizeStyle(n));var c=toStyleMap(i);const f=toStyleMap(l);if(r.dirs)for(var{dir:u,value:d}of r.dirs)"show"!==u.name||d||f.set("display","none");const h=null==o?void 0:o.subTree;if(r===h||(null==h?void 0:h.type)===Fragment&&h.children.includes(r)){var p=null==(r=null==o?void 0:o.getCssVars)?void 0:r.call(o);for(const m in p)f.set("--"+m,String(p[m]))}isMapEqual(c,f)||(s=a="style")}else(e instanceof SVGElement&&isKnownSvgAttr(t)||e instanceof HTMLElement&&(isBooleanAttr(t)||isKnownHtmlAttr(t)))&&(l=isBooleanAttr(t)?(i=e.hasAttribute(t),includeBooleanAttr(n)):null==n?(i=e.hasAttribute(t),!1):(i=e.hasAttribute(t)?e.getAttribute(t):"value"===t&&"TEXTAREA"===e.tagName&&e.value,!!isRenderableAttrValue(n)&&String(n)),i!==l&&(s="attribute",a=t));return!!s&&(r=e=>!1===e?"(not rendered)":a+`="${e}"`,warn$1(`Hydration ${s} mismatch on`,e,`
  - rendered on server: ${r(i)}
