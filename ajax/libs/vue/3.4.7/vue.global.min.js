...
Server rendered element contains more child nodes than client vdom.`),t=!0);var f=e;e=e.nextSibling,S(f)}}else 8&c&&n.textContent!==r.children&&(bi=!0,oe("Hydration text content mismatch on",n,`
  ...
  - expected on client: `+r.children),n.textContent=r.children);if(l)for(const m in l)!function(e,t,n,r){let o,i,s,a;if("class"===t)s=wi(e.getAttribute("class")||""),a=wi(_e(n)),!function(e,t){if(e.size!==t.size)return;for(const n of e)if(!t.has(n))return;return 1}(s,a)&&(o=i="class");else if("style"===t){if(s=Ci(e.getAttribute("style")||""),a=Ci(ce(n)?n:function(e){let t="";if(!e||ce(e))return t;for(const o in e){var n=e[o],r=o.startsWith("--")?o:M(o);!ce(n)&&"number"!=typeof n||(t+=r+`:${n};`)}return t}(ve(n))),r.dirs)for(var{dir:l,value:c}of r.dirs)"show"!==l.name||c||a.set("display","none");!function(e,t){if(e.size!==t.size)return;for(var[n,r]of e)if(r!==t.get(n))return;return 1}(s,a)&&(o=i="style")}else(e instanceof SVGElement&&Ie(t)||e instanceof HTMLElement&&(Ee(t)||Ne(t)))&&(s=e.hasAttribute(t)?e.getAttribute(t):t in e?e[t]:"",a=Ee(t)?!!Ae(n)&&"":null==n?"":String(n),s!==a&&(o="attribute",i=t));if(o)return r=e=>!1===e?"(not rendered)":i+`="${e}"`,oe(`Hydration ${o} mismatch on`,e,`
