...
- expected on client:`,t.type),t.el=null,s)for(var a=x(e);;){var i=C(e);if(!i||i===a)break;S(i)}var s=C(e),l=w(e);return S(e),d(null,t,l,s,n,r,getContainerType(l),o),s},x=(e,t="[",n="]")=>{let r=0;for(;e;)if((e=C(e))&&isComment(e)&&(e.data===t&&r++,e.data===n)){if(0===r)return C(e);r--}return e},O=(e,t,n)=>{const r=t.parentNode;r&&r.replaceChild(e,t);let o=n;for(;o;)o.vnode.el===t&&(o.vnode.el=o.subTree.el=e),o=o.parent},I=e=>1===e.nodeType&&"template"===e.tagName.toLowerCase();return[(e,t)=>{if(!t.hasChildNodes())return warn$1("Attempting to hydrate existing markup but container is empty. Performing full mount instead."),d(null,e,t),flushPostFlushCbs(),void(t._vnode=e);hasMismatch=!1,T(t.firstChild,e,null,null,null),flushPostFlushCbs(),t._vnode=e,hasMismatch&&console.error("Hydration completed but contains mismatches.")},T]}function propHasMismatch(e,t,n,r){let o,s,a,i;if("class"===t)a=toClassSet(e.getAttribute("class")||""),i=toClassSet(normalizeClass(n)),isSetEqual(a,i)||(o=s="class");else if("style"===t){if(a=toStyleMap(e.getAttribute("style")||""),i=toStyleMap(isString(n)?n:stringifyStyle(normalizeStyle(n))),r.dirs)for(var{dir:l,value:c}of r.dirs)"show"!==l.name||c||i.set("display","none");isMapEqual(a,i)||(o=s="style")}else(e instanceof SVGElement&&isKnownSvgAttr(t)||e instanceof HTMLElement&&(isBooleanAttr(t)||isKnownHtmlAttr(t)))&&(a=e.hasAttribute(t)?e.getAttribute(t):t in e?e[t]:"",i=isBooleanAttr(t)?!!includeBooleanAttr(n)&&"":null==n?"":String(n),a!==i&&(o="attribute",s=t));return!!o&&(r=e=>!1===e?"(not rendered)":s+`="${e}"`,warn$1(`Hydration ${o} mismatch on`,e,`
