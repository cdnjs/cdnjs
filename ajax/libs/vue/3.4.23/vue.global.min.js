...
`,-1),l())),t.components.length&&(Pu(t.components,"component",n),(t.directives.length||0<t.temps)&&l()),t.directives.length&&(Pu(t.directives,"directive",n),0<t.temps&&l()),0<t.temps){o("let ");for(let e=0;e<t.temps;e++)o(`${0<e?", ":""}_temp`+e)}return(t.components.length||t.directives.length||t.temps)&&(o(`
`,0),l()),c||o("return "),t.codegenNode?ue(t.codegenNode,n):o("null"),d&&(a(),o("}")),a(),o("}"),{ast:t,code:n.code,preamble:"",map:n.map?n.map.toJSON():void 0}}function Pu(n,r,{helper:e,push:o,newline:i,isTS:s}){var a=e("component"===r?Ll:Dl);for(let t=0;t<n.length;t++){let e=n[t];var l=e.endsWith("__self");o(`const ${Gc(e=l?e.slice(0,-6):e,r)} = ${a}(${JSON.stringify(e)}${l?", true":""})`+(s?"!":"")),t<n.length-1&&i()}}function Fu(e,t){var n=3<e.length||e.some(e=>le(e)||!function(e){return ce(e)||4===e.type||2===e.type||5===e.type||8===e.type}(e));t.push("["),n&&t.indent(),Lu(e,t,n),n&&t.deindent(),t.push("]")}function Lu(t,n,r=!1,o=!0){const{push:i,newline:s}=n;for(let e=0;e<t.length;e++){var a=t[e];ce(a)?i(a,-3):(le(a)?Fu:ue)(a,n),e<t.length-1&&(r?(o&&i(","),s()):o&&i(", "))}}function ue(e,t){if(ce(e))t.push(e,-3);else if(de(e))t.push(t.helper(e));else switch(e.type){case 1:case 9:case 11:Lc(null!=e.codegenNode,"Codegen node is missing for element/if/for node. Apply appropriate transforms first."),ue(e.codegenNode,t);break;case 2:n=e,t.push(JSON.stringify(n.content),-3,n);break;case 4:Vu(e,t);break;case 5:{var n=e;var r=t;const{push:p,helper:h,pure:f}=r;f&&p(Ru);p(h(zl)+"("),ue(n.content,r),p(")")}break;case 12:ue(e.codegenNode,t);break;case 8:Du(e,t);break;case 3:{r=e;var o=t;const{push:m,helper:V,pure:D}=o;D&&m(Ru);m(`${V($l)}(${JSON.stringify(r.content)})`,-3,r)}break;case 13:{o=e;var i=t;const{push:v,helper:g,pure:j}=i,{tag:B,props:U,children:H,patchFlag:q,dynamicProps:z,directives:y,isBlock:b,disableTracking:W,isComponent:K}=o;y&&v(g(Bl)+"(");b&&v(`(${g(Nl)}(${W?"true":""}), `);j&&v(Ru);var s=(b?yc:gc)(i.inSSR,K);v(g(s)+"(",-2,o),Lu(function(e){let t=e.length;for(;t--&&null==e[t];);return e.slice(0,t+1).map(e=>e||"null")}([B,U,H,q,z]),i),v(")"),b&&v(")");y&&(v(", "),ue(y,i),v(")"))}break;case 14:{s=e;i=t;const{push:_,helper:G,pure:J}=i,Y=ce(s.callee)?s.callee:G(s.callee);J&&_(Ru);_(Y+"(",-2,s),Lu(s.arguments,i),_(")")}break;case 15:{var a=e;var l=t;const{push:x,indent:X,deindent:Q,newline:Z}=l,S=a["properties"];if(S.length){var c=1<S.length||S.some(e=>4!==e.value.type);x(c?"{":"{ "),c&&X();for(let e=0;e<S.length;e++){var{key:F,value:L}=S[e];!function(e,t){const n=t["push"];8===e.type?(n("["),Du(e,t),n("]")):e.isStatic?(t=Rc(e.content)?e.content:JSON.stringify(e.content),n(t,-2,e)):n(`[${e.content}]`,-3,e)}(F,l),x(": "),ue(L,l),e<S.length-1&&(x(","),Z())}c&&Q(),x(c?"}":" }")}else x("{}",-2,a)}break;case 17:Fu(e.elements,t);break;case 18:{c=e;a=t;const{push:w,indent:ee,deindent:te}=a,{params:C,returns:k,body:T,newline:E,isSlot:A}=c;A&&w(`_${cc[oc]}(`);w("(",-2,c),le(C)?Lu(C,a):C&&ue(C,a);w(") => "),(E||T)&&(w("{"),ee());k?(E&&w("return "),(le(k)?Fu:ue)(k,a)):T&&ue(T,a);(E||T)&&(te(),w("}"));A&&w(")")}break;case 19:{var u=e;var d=t;const{test:N,consequent:ne,alternate:I,newline:O}=u,{push:R,indent:re,deindent:oe,newline:ie}=d;4===N.type?((u=!Rc(N.content))&&R("("),Vu(N,d),u&&R(")")):(R("("),ue(N,d),R(")"));O&&re(),d.indentLevel++,O||R(" "),R("? "),ue(ne,d),d.indentLevel--,O&&ie(),O||R(" "),R(": ");u=19===I.type;u||d.indentLevel++;ue(I,d),u||d.indentLevel--;O&&oe(!0)}break;case 20:{u=e;d=t;const{push:M,helper:$,indent:se,deindent:ae,newline:P}=d;M(`_cache[${u.index}] || (`),u.isVNode&&(se(),M($(tc)+"(-1),"),P());M(`_cache[${u.index}] = `),ue(u.value,d),u.isVNode&&(M(","),P(),M($(tc)+"(1),"),P(),M(`_cache[${u.index}]`),ae());M(")")}break;case 21:Lu(e.body,t,!0,!1);break;case 22:case 23:case 24:case 25:case 26:case 10:break;default:Lc(!1,"unhandled codegen node type: "+e.type)}}function Vu(e,t){var{content:n,isStatic:r}=e;t.push(r?JSON.stringify(n):n,-3,e)}function Du(t,n){for(let e=0;e<t.children.length;e++){var r=t.children[e];ce(r)?n.push(r,-3):ue(r,n)}}const ju=new RegExp("\\b"+"arguments,await,break,case,catch,class,const,continue,debugger,default,delete,do,else,export,extends,finally,for,function,if,import,let,new,return,super,switch,throw,try,var,void,while,with,yield".split(",").join("\\b|\\b")+"\\b"),Bu=/'(?:[^'\\]|\\.)*'|"(?:[^"\\]|\\.)*"|`(?:[^`\\]|\\.)*\$\{|\}(?:[^`\\]|\\.)*`|`(?:[^`\\]|\\.)*`/g;function Uu(n,r,e=!1,o=!1){const i=n.content;if(i.trim())try{new Function(o?` ${i} `:"return "+(e?`(${i}) => {}`:`(${i})`))}catch(e){let t=e.message;o=i.replace(Bu,"").match(ju);o&&(t=`avoid using JavaScript keyword as property name: "${o[0]}"`),r.onError(W(45,n.loc,void 0,t))}}const Hu=(t,n)=>{if(5===t.type)t.content=qu(t.content,n);else if(1===t.type)for(let e=0;e<t.props.length;e++){const i=t.props[e];var r,o;7===i.type&&"for"!==i.name&&(r=i.exp,o=i.arg,!r||4!==r.type||"on"===i.name&&o||(i.exp=qu(r,n,"slot"===i.name)),o&&4===o.type&&!o.isStatic&&(i.arg=qu(o,n)))}};function qu(e,t,n=!1,r=!1,o=Object.create(t.identifiers)){return Uu(e,t,n,r),e}const zu=Ou(/^(if|else|else-if)$/,(e,t,a)=>{var n=e,r=t,o=a,i=(t,n,r)=>{const e=a.parent.children;let o=e.indexOf(t),i=0;for(;0<=o--;){var s=e[o];s&&9===s.type&&(i+=s.branches.length)}return()=>{if(r)t.codegenNode=Ku(n,i,a);else{const e=function(e){for(;;)if(19===e.type){if(19!==e.alternate.type)return e;e=e.alternate}else 20===e.type&&(e=e.value)}(t.codegenNode);e.alternate=Ku(n,i+t.branches.length-1,a)}}};if("else"===r.name||r.exp&&r.exp.content.trim()||(s=(r.exp||n).loc,o.onError(W(28,r.loc)),r.exp=q("true",!1,s)),r.exp&&Uu(r.exp,o),"if"===r.name){var s=Wu(n,r),e={type:9,loc:n.loc,branches:[s]};if(o.replaceNode(e),i)return i(e,s,!0)}else{const l=o.parent.children,c=[];let e=l.indexOf(n);for(;-1<=e--;){const u=l[e];if(u&&3===u.type)o.removeNode(u),c.unshift(u);else{if(!u||2!==u.type||u.content.trim().length){if(u&&9===u.type){"else-if"===r.name&&void 0===u.branches[u.branches.length-1].condition&&o.onError(W(30,n.loc)),o.removeNode();const d=Wu(n,r);c.length&&(!o.parent||1!==o.parent.type||"transition"!==o.parent.tag&&"Transition"!==o.parent.tag)&&(d.children=[...c,...d.children]);{const h=d.userKey;h&&u.branches.forEach(({userKey:e})=>{!function(e,t){if(!e||e.type!==t.type)return;if(6===e.type){if(e.value.content!==t.value.content)return}else{e=e.exp,t=t.exp;if(e.type!==t.type)return;if(4!==e.type||e.isStatic!==t.isStatic||e.content!==t.content)return}return 1}(e,h)||o.onError(W(29,d.userKey.loc))})}u.branches.push(d);const p=i&&i(u,d,!1);Iu(d,o),p&&p(),o.currentNode=null}else o.onError(W(30,n.loc));break}o.removeNode(u)}}}});function Wu(e,t){var n=3===e.tagType;return{type:10,loc:e.loc,condition:"else"===t.name?void 0:t.exp,children:n&&!Vc(e,"for")?e.children:[e],userKey:Dc(e,"key"),isTemplateIf:n}}function Ku(e,t,n){return e.condition?vc(e.condition,Gu(e,t,n),z(n.helper($l),['"v-if"',"true"])):Gu(e,t,n)}function Gu(n,r,o){const i=o["helper"];r=H("key",q(""+r,!1,uc,2));const s=n["children"];var e,t,a=s[0];if(1===s.length&&1===a.type)return e=a.codegenNode,13===(t=14===(t=e).type&&t.callee===ac?t.arguments[1].returns:t).type&&bc(t,o),Wc(t,r,o),e;if(1===s.length&&11===a.type)return Wc(t=a.codegenNode,r,o),t;{let e=64,t=Q[64];return n.isTemplateIf||1!==s.filter(e=>3!==e.type).length||(e|=2048,t+=", "+Q[2048]),dc(o,i(Cl),hc([r]),s,e+` /* ${t} */`,void 0,void 0,!0,!1,!1,n.loc)}}const Ju=Ou("for",(p,e,h)=>{const{helper:f,removeHelper:m}=h;var t=p,n=h,r=i=>{const s=z(f(Ul),[i.source]),a=Hc(p),l=Vc(p,"memo");var e=Dc(p,"key");const c=e&&(6===e.type?q(e.value.content,!0):e.exp),u=e?H("key",c):null,d=4===i.source.type&&0<i.source.constType;e=d?64:e?128:256;return i.codegenNode=dc(h,f(Cl),void 0,s,e+` /* ${Q[e]} */`,void 0,void 0,!0,!d,!1,p.loc),()=>{let e;var t=i["children"],n=(a&&p.children.some(e=>{if(1===e.type){e=Dc(e,"key");if(e)return h.onError(W(33,e.loc)),!0}}),1!==t.length||1!==t[0].type),r=qc(p)?p:a&&1===p.children.length&&qc(p.children[0])?p.children[0]:null;if(r?(e=r.codegenNode,a&&u&&Wc(e,u,h)):n?e=dc(h,f(Cl),u?hc([u]):void 0,p.children,64+` /* ${Q[64]} */`,void 0,void 0,!0,void 0,!1):(e=t[0].codegenNode,a&&u&&Wc(e,u,h),e.isBlock!==!d&&(e.isBlock?(m(Nl),m(yc(h.inSSR,e.isComponent))):m(gc(h.inSSR,e.isComponent))),e.isBlock=!d,e.isBlock?(f(Nl),f(yc(h.inSSR,e.isComponent))):f(gc(h.inSSR,e.isComponent))),l){const o=mc(Xu(i.parseResult,[q("_cached")]));o.body={type:21,body:[fc(["const _memo = (",l.exp,")"]),fc(["if (_cached",...c?[" && _cached.key === ",c]:[],` && ${h.helperString(lc)}(_cached, _memo)) return _cached`]),fc(["const _item = ",e]),q("_item.memo = _memo"),q("return _item")],loc:uc},s.arguments.push(o,q("_cache"),q(String(h.cached++)))}else s.arguments.push(mc(Xu(i.parseResult),e,!0))}};if(e.exp){var o=e.forParseResult;if(o){Yu(o,n);const c=n["scopes"];var{source:i,value:s,key:a,index:l}=o,i={type:11,loc:e.loc,source:i,valueAlias:s,keyAlias:a,objectIndexAlias:l,parseResult:o,children:Hc(t)?t.children:[t]};n.replaceNode(i),c.vFor++;const u=r&&r(i);return()=>{c.vFor--,u&&u()}}n.onError(W(32,e.loc))}else n.onError(W(31,e.loc))});function Yu(e,t){e.finalized||(Uu(e.source,t),e.key&&Uu(e.key,t,!0),e.index&&Uu(e.index,t,!0),e.value&&Uu(e.value,t,!0),e.finalized=!0)}function Xu({value:t,key:n,index:r},o=[]){{var i=[t,n,r,...o];let e=i.length;for(;e--&&!i[e];);return i.slice(0,e+1).map((e,t)=>e||q("_".repeat(t+1),!1))}}const Qu=q("undefined",!1),Zu=(e,t)=>{if(1===e.type&&(1===e.tagType||3===e.tagType)){e=Vc(e,"slot");if(e)return e.exp,t.scopes.vSlot++,()=>{t.scopes.vSlot--}}},ed=(e,t,n,r)=>mc(e,n,!1,!0,n.length?n[0].loc:r);function td(e,r,o=ed){r.helper(oc);const{children:i,loc:n}=e,s=[],a=[];let l=0<r.scopes.vSlot||0<r.scopes.vFor;var t,c=Vc(e,"slot",!0);c&&({arg:t,exp:S}=c,t&&!Nc(t)&&(l=!0),s.push(H(t||q("default",!0),o(S,void 0,i,n))));let u=!1,d=!1;const p=[],h=new Set;let f=0;for(let n=0;n<i.length;n++){var m=i[n];let t;if(Hc(m)&&(t=Vc(m,"slot",!0))){if(c){r.onError(W(37,t.loc));break}u=!0;var{children:v,loc:g}=m,{arg:y=q("default",!0),exp:b,loc:_}=t;let e;Nc(y)?e=y?y.content:"default":l=!0;var x=Vc(m,"for"),b=o(b,x,v,g);if(v=Vc(m,"if"))l=!0,a.push(vc(v.exp,nd(y,b,f++),Qu));else if(g=Vc(m,/^else(-if)?$/,!0)){let e=n,t;for(;e--&&3===(t=i[e]).type;);if(t&&Hc(t)&&Vc(t,"if")){i.splice(n,1),n--;let e=a[a.length-1];for(;19===e.alternate.type;)e=e.alternate;e.alternate=g.exp?vc(g.exp,nd(y,b,f++),Qu):nd(y,b,f++)}else r.onError(W(30,g.loc))}else if(x){l=!0;v=x.forParseResult;v?(Yu(v,r),a.push(z(r.helper(Ul),[v.source,mc(Xu(v),nd(y,b),!0)]))):r.onError(W(32,x.loc))}else{if(e){if(h.has(e)){r.onError(W(38,_));continue}h.add(e),"default"===e&&(d=!0)}s.push(H(y,b))}}else 3!==m.type&&p.push(m)}c||(t=(e,t)=>{return H("default",o(e,void 0,t,n))},u?p.length&&p.some(e=>function e(t){if(2!==t.type&&12!==t.type)return!0;return 2===t.type?!!t.content.trim():e(t.content)}(e))&&(d?r.onError(W(39,p[0].loc)):s.push(t(void 0,p))):s.push(t(void 0,i)));var S=l?2:function t(n){for(let e=0;e<n.length;e++){const r=n[e];switch(r.type){case 1:if(2===r.tagType||t(r.children))return!0;break;case 9:if(t(r.branches))return!0;break;case 10:case 11:if(t(r.children))return!0}}return!1}(e.children)?3:1;let w=hc(s.concat(H("_",q(S+` /* ${Z[S]} */`,!1))),n);return{slots:w=a.length?z(r.helper(ql),[w,pc(a)]):w,hasDynamicSlots:l}}function nd(e,t,n){const r=[H("name",e),H("fn",t)];return null!=n&&r.push(H("key",q(String(n),!0))),hc(r)}const rd=new WeakMap,od=(f,m)=>function(){if(1===(f=m.currentNode).type&&(0===f.tagType||1===f.tagType)){var{tag:l,props:c}=f,u=1===f.tagType,d=u?function(e,t,n=!1){let r=e["tag"];const o=ad(r),i=Dc(e,"is",!1,!0);if(i)if(o){let e;if(e=6===i.type?i.value&&q(i.value.content,!0):(e=i.exp)||q("is",!1,i.loc))return z(t.helper(Vl),[e])}else 6===i.type&&i.value.content.startsWith("vue:")&&(r=i.value.content.slice(4));e=Ic(r)||t.isBuiltInComponent(r);if(e)return n||t.helper(e),e;return t.helper(Ll),t.components.add(r),Gc(r,"component")}(f,m):`"${l}"`,p=re(d)&&d.callee===Vl;let e,t,n,r=0,o,i,s,a=p||d===kl||d===Tl||!u&&("svg"===l||"foreignObject"===l);if(0<c.length){var l=id(f,m,void 0,u,p);e=l.props,r=l.patchFlag,i=l.dynamicPropNames;const h=l.directives;s=h&&h.length?pc(h.map(e=>{{var t=m;const n=[],r=rd.get(e);if(r?n.push(t.helperString(r)):(t.helper(Dl),t.directives.add(e.name),n.push(Gc(e.name,"directive"))),t=e.loc,e.exp&&n.push(e.exp),e.arg&&(e.exp||n.push("void 0"),n.push(e.arg)),Object.keys(e.modifiers).length){e.arg||(e.exp||n.push("void 0"),n.push("void 0"));const o=q("true",!1,t);n.push(hc(e.modifiers.map(e=>H(e,o)),t))}return pc(n,e.loc)}})):void 0,l.shouldUseBlock&&(a=!0)}0<f.children.length&&(d===El&&(a=!0,r|=1024,1<f.children.length&&m.onError(W(46,{start:f.children[0].loc.start,end:f.children[f.children.length-1].loc.end,source:""}))),u&&d!==kl&&d!==El?({slots:c,hasDynamicSlots:p}=td(f,m),t=c,p&&(r|=1024)):t=1===f.children.length&&d!==kl?((p=5===(c=(l=f.children[0]).type)||8===c)&&0===wu(l,m)&&(r|=1),p||2===c?l:f.children):f.children),0!==r&&(n=r<0?r+` /* ${Q[r]} */`:(p=Object.keys(Q).map(Number).filter(e=>0<e&&r&e).map(e=>Q[e]).join(", "),r+` /* ${p} */`),i&&i.length&&(o=function(n){let r="[";for(let e=0,t=n.length;e<t;e++)r+=JSON.stringify(n[e]),e<t-1&&(r+=", ");return r+"]"}(i))),f.codegenNode=dc(m,d,e,t,n,o,s,!!a,!1,u,f.loc)}};function id(t,o,n=t.props,r,F,i=!1){const{tag:s,loc:a,children:L}=t;let l=[];const c=[],u=[];var d=0<L.length;let p=!1,h=0,f=!1,m=!1,v=!1,g=!1,y=!1,V=!1;const b=[];var _=e=>{l.length&&(c.push(hc(sd(l),a)),l=[]),e&&c.push(e)},D=({key:e,value:t})=>{if(Nc(e)){const n=e.content;e=K(n);!e||r&&!F||"onclick"===n.toLowerCase()||"onUpdate:modelValue"===n||pe(n)||(g=!0),e&&pe(n)&&(V=!0),20===(t=e&&14===t.type?t.arguments[0]:t).type||(4===t.type||8===t.type)&&0<wu(t,o)||("ref"===n?f=!0:"class"===n?m=!0:"style"===n?v=!0:"key"===n||b.includes(n)||b.push(n),!r||"class"!==n&&"style"!==n||b.includes(n)||b.push(n))}else y=!0};for(let e=0;e<n.length;e++){var x=n[e];if(6===x.type){const{loc:j,name:T,nameLoc:B,value:E}=x;"ref"===T&&(f=!0,0<o.scopes.vFor&&l.push(H(q("ref_for",!0),q("true")))),"is"===T&&(ad(s)||E&&E.content.startsWith("vue:"))||l.push(H(q(T,!0,B),q(E?E.content:"",!0,E?E.loc:j)))}else{const{name:A,arg:N,exp:I,loc:O,modifiers:U}=x;var S="bind"===A,w="on"===A;if("slot"===A)r||o.onError(W(40,O));else if("once"!==A&&"memo"!==A&&!("is"===A||S&&jc(N,"is")&&ad(s)||w&&i))if((S&&jc(N,"key")||w&&d&&jc(N,"vue:before-update"))&&(p=!0),S&&jc(N,"ref")&&0<o.scopes.vFor&&l.push(H(q("ref_for",!0),q("true"))),N||!S&&!w){S&&U.includes("prop")&&(h|=32);const R=o.directiveTransforms[A];if(R){const{props:M,needRuntime:$}=R(x,t,o);i||M.forEach(D),w&&N&&!Nc(N)?_(hc(M,a)):l.push(...M),$&&(u.push(x),de($)&&rd.set(x,$))}else J(A)||(u.push(x),d&&(p=!0))}else y=!0,I?S?(_(),c.push(I)):_({type:14,loc:O,callee:o.helper(Xl),arguments:r?[I]:[I,"true"]}):o.onError(W(S?34:35,O))}}let C=void 0;if(c.length?(_(),C=1<c.length?z(o.helper(Wl),c,a):c[0]):l.length&&(C=hc(sd(l),a)),y?h|=16:(m&&!r&&(h|=2),v&&!r&&(h|=4),b.length&&(h|=8),g&&(h|=32)),p||0!==h&&32!==h||!(f||V||0<u.length)||(h|=512),!o.inSSR&&C)switch(C.type){case 15:let t=-1,n=-1,r=!1;for(let e=0;e<C.properties.length;e++){var k=C.properties[e].key;Nc(k)?"class"===k.content?t=e:"style"===k.content&&(n=e):k.isHandlerKey||(r=!0)}const e=C.properties[t],P=C.properties[n];r?C=z(o.helper(Jl),[C]):(e&&!Nc(e.value)&&(e.value=z(o.helper(Kl),[e.value])),P&&(v||4===P.value.type&&"["===P.value.content.trim()[0]||17===P.value.type)&&(P.value=z(o.helper(Gl),[P.value])));break;case 14:break;default:C=z(o.helper(Jl),[z(o.helper(Yl),[C])])}return{props:C,directives:u,patchFlag:h,dynamicPropNames:b,shouldUseBlock:p}}function sd(t){const n=new Map,r=[];for(let e=0;e<t.length;e++){var o,i=t[e];8!==i.key.type&&i.key.isStatic?(o=i.key.content,(s=n.get(o))?"style"!==o&&"class"!==o&&!K(o)||(a=i,17===(s=s).value.type?s.value.elements.push(a.value):s.value=pc([s.value,a.value],s.loc)):(n.set(o,i),r.push(i))):r.push(i)}var s,a;return r}function ad(e){return"component"===e||"Component"===e}const ld=(t,n)=>{if(qc(t)){var{children:r,loc:o}=t,{slotName:i,slotProps:s}=function(t,e){let n='"default"',r=void 0;const o=[];for(let e=0;e<t.props.length;e++){const l=t.props[e];var i;6===l.type?l.value&&("name"===l.name?n=JSON.stringify(l.value.content):(l.name=R(l.name),o.push(l))):"bind"===l.name&&jc(l.arg,"name")?l.exp?n=l.exp:l.arg&&4===l.arg.type&&(i=R(l.arg.content),n=l.exp=q(i,!1,l.arg.loc)):("bind"===l.name&&l.arg&&Nc(l.arg)&&(l.arg.content=R(l.arg.content)),o.push(l))}{var s,a;0<o.length&&({props:s,directives:a}=id(t,e,o,!1,!1),r=s,a.length&&e.onError(W(36,a[0].loc)))}return{slotName:n,slotProps:r}}(t,n);const a=[n.prefixIdentifiers?"_ctx.$slots":"$slots",i,"{}","undefined","true"];let e=2;s&&(a[2]=s,e=3),r.length&&(a[3]=mc([],r,!1,!1,o),e=4),n.scopeId&&!n.slotted&&(e=5),a.splice(e),t.codegenNode=z(n.helper(Hl),a,o)}};const cd=/^\s*([\w$_]+|(async\s*)?\([^)]*?\))\s*(:[^=]+)?=>|^\s*(async\s+)?function(?:\s+[\w$]+)?\s*\(/,ud=(e,t,n,r)=>{var{loc:o,modifiers:i,arg:s}=e;e.exp||i.length||n.onError(W(35,o));let a;if(4===s.type)if(s.isStatic){let e=s.content;e.startsWith("vnode")&&n.onError(W(51,s.loc)),e.startsWith("vue:")&&(e="vnode-"+e.slice(4));i=0!==t.tagType||e.startsWith("vnode")||!/[A-Z]/.test(e)?D(R(e)):"on:"+e;a=q(i,!0,s.loc)}else a=fc([n.helperString(ec)+"(",s,")"]);else(a=s).children.unshift(n.helperString(ec)+"("),a.children.push(")");let l=e.exp;l&&!l.content.trim()&&(l=void 0);t=n.cacheHandlers&&!l&&!n.inVOnce;l&&(s=!((i=Fc(l.content))||cd.test(l.content)),e=l.content.includes(";"),Uu(l,n,!1,e),(s||t&&i)&&(l=fc([`${s?"$event":"(...args)"} => `+(e?"{":"("),l,e?"}":")"])));let c={props:[H(a,l||q("() => {}",!1,o))]};return r&&(c=r(c)),t&&(c.props[0].value=n.cache(c.props[0].value)),c.props.forEach(e=>e.key.isHandlerKey=!0),c},dd=(e,t,n)=>{const{modifiers:r,loc:o}=e,i=e.arg;let s=e["exp"];if(!(s=s&&4===s.type&&!s.content.trim()?void 0:s)){if(4!==i.type||!i.isStatic)return n.onError(W(52,i.loc)),{props:[H(i,q("",!0,o))]};var a=R(i.content);s=e.exp=q(a,!1,i.loc)}return 4!==i.type?(i.children.unshift("("),i.children.push(') || ""')):i.isStatic||(i.content=i.content+' || ""'),r.includes("camel")&&(4===i.type?i.isStatic?i.content=R(i.content):i.content=`${n.helperString(Ql)}(${i.content})`:(i.children.unshift(n.helperString(Ql)+"("),i.children.push(")"))),n.inSSR||(r.includes("prop")&&pd(i,"."),r.includes("attr")&&pd(i,"^")),{props:[H(i,s)]}},pd=(e,t)=>{4===e.type?e.isStatic?e.content=t+e.content:e.content=`\`${t}\${${e.content}}\``:(e.children.unshift(`'${t}' + (`),e.children.push(")"))},hd=(a,l)=>{if(0===a.type||1===a.type||11===a.type||10===a.type)return()=>{const n=a.children;let r=void 0,e=!1;for(let t=0;t<n.length;t++){var o=n[t];if(Bc(o)){e=!0;for(let e=t+1;e<n.length;e++){var i=n[e];if(!Bc(i)){r=void 0;break}(r=r||(n[t]=fc([o],o.loc))).children.push(" + ",i),n.splice(e,1),e--}}}if(e&&(1!==n.length||0!==a.type&&(1!==a.type||0!==a.tagType||a.props.find(e=>7===e.type&&!l.directiveTransforms[e.name]))))for(let e=0;e<n.length;e++){var t=n[e];if(Bc(t)||8===t.type){const s=[];2===t.type&&" "===t.content||s.push(t),l.ssr||0!==wu(t,l)||s.push(1+` /* ${Q[1]} */`),n[e]={type:12,content:t,loc:t.loc,codegenNode:z(l.helper(Pl),s)}}}}},fd=new WeakSet,md=(e,t)=>{if(1===e.type&&Vc(e,"once",!0)&&!(fd.has(e)||t.inVOnce||t.inSSR))return fd.add(e),t.inVOnce=!0,t.helper(tc),()=>{t.inVOnce=!1;const e=t.currentNode;e.codegenNode&&(e.codegenNode=t.cache(e.codegenNode,!0))}},vd=(e,t,n)=>{var{exp:r,arg:o}=e;if(!r)return n.onError(W(41,e.loc)),gd();var i=r.loc.source;const s=4===r.type?r.content:i;i=n.bindingMetadata[i];if("props"===i||"props-aliased"===i)return n.onError(W(44,r.loc)),gd();if(!s.trim()||!Fc(s))return n.onError(W(42,r.loc)),gd();var i=o||q("modelValue",!0),a=o?Nc(o)?"onUpdate:"+R(o.content):fc(['"onUpdate:" + ',o]):"onUpdate:modelValue",n=fc([(n.isTS?"($event: any)":"$event")+" => ((",r,") = $event)"]);const l=[H(i,e.exp),H(a,n)];return e.modifiers.length&&1===t.tagType&&(r=e.modifiers.map(e=>(Rc(e)?e:JSON.stringify(e))+": true").join(", "),i=o?Nc(o)?o.content+"Modifiers":fc([o,' + "Modifiers"']):"modelModifiers",l.push(H(i,q(`{ ${r} }`,!1,e.loc,2)))),gd(l)};function gd(e=[]){return{props:e}}const yd=new WeakSet,bd=(t,n)=>{if(1===t.type){const r=Vc(t,"memo");if(r&&!yd.has(t))return yd.add(t),()=>{var e=t.codegenNode||n.currentNode.codegenNode;e&&13===e.type&&(1!==t.tagType&&bc(e,n),t.codegenNode=z(n.helper(ac),[r.exp,mc(void 0,e),"_cache",String(n.cached++)]))}}};function _d(e,t={}){const n=t.onError||Tc;var r="module"===t.mode,r=(!0===t.prefixIdentifiers?n(W(47)):r&&n(W(48)),t.cacheHandlers&&n(W(49)),t.scopeId&&!r&&n(W(50)),I({},t,{prefixIdentifiers:!1})),e=ce(e)?_u(e,r):e,[o,i]=[[md,zu,bd,Ju,Hu,ld,od,Zu,hd],{on:ud,bind:dd,model:vd}];return Nu(e,I({},r,{nodeTransforms:[...o,...t.nodeTransforms||[]],directiveTransforms:I({},i,t.directiveTransforms||{})})),$u(e,r)}var xd;const Sd=Symbol("vModelRadio"),wd=Symbol("vModelCheckbox"),Cd=Symbol("vModelText"),kd=Symbol("vModelSelect"),Td=Symbol("vModelDynamic"),Ed=Symbol("vOnModifiersGuard"),Ad=Symbol("vOnKeysGuard"),Nd=Symbol("vShow"),Id=Symbol("Transition"),Od=Symbol("TransitionGroup");xd={[Sd]:"vModelRadio",[wd]:"vModelCheckbox",[Cd]:"vModelText",[kd]:"vModelSelect",[Td]:"vModelDynamic",[Ed]:"withModifiers",[Ad]:"withKeys",[Nd]:"vShow",[Id]:"Transition",[Od]:"TransitionGroup"},Object.getOwnPropertySymbols(xd).forEach(e=>{cc[e]=xd[e]});let Rd;const Md={parseMode:"html",isVoidTag:T,isNativeTag:e=>Se(e)||we(e)||Ce(e),isPreTag:e=>"pre"===e,decodeEntities:function(e,t=!1){return Rd=Rd||document.createElement("div"),t?(Rd.innerHTML=`<div foo="${e.replace(/"/g,"&quot;")}">`,Rd.children[0].getAttribute("foo")):(Rd.innerHTML=e,Rd.textContent)},isBuiltInComponent:e=>"Transition"===e||"transition"===e?Id:"TransitionGroup"===e||"transition-group"===e?Od:void 0,getNamespace(e,t,n){let r=t?t.ns:n;if(t&&2===r)if("annotation-xml"===t.tag){if("svg"===e)return 1;t.props.some(e=>6===e.type&&"encoding"===e.name&&null!=e.value&&("text/html"===e.value.content||"application/xhtml+xml"===e.value.content))&&(r=0)}else/^m(?:[ions]|text)$/.test(t.tag)&&"mglyph"!==e&&"malignmark"!==e&&(r=0);else!t||1!==r||"foreignObject"!==t.tag&&"desc"!==t.tag&&"title"!==t.tag||(r=0);if(0===r){if("svg"===e)return 1;if("math"===e)return 2}return r}};function $d(e,t){return W(e,t,Pd)}const Pd={[53]:"v-html is missing expression.",54:"v-html will override element children.",55:"v-text is missing expression.",56:"v-text will override element children.",57:"v-model can only be used on <input>, <textarea> and <select> elements.",58:"v-model argument is not supported on plain elements.",59:"v-model cannot be used on file inputs since they are read-only. Use a v-on:change listener instead.",60:"Unnecessary value binding used alongside v-model. It will interfere with v-model's behavior.",61:"v-show is missing expression.",62:"<Transition> expects exactly one child element or component.",63:"Tags with side effect (<script> and <style>) are ignored in client component templates."};const Fd=t("passive,once,capture"),Ld=t("stop,prevent,self,ctrl,shift,alt,meta,exact,middle"),Vd=t("left,right"),Dd=t("onkeyup,onkeydown,onkeypress",!0),jd=(e,t)=>{return Nc(e)&&"onclick"===e.content.toLowerCase()?q(t,!0):4!==e.type?fc(["(",e,`) === "onClick" ? "${t}" : (`,e,")"]):e};function Bd(e){e=e.children=e.children.filter(e=>3!==e.type&&!(2===e.type&&!e.content.trim()));const t=e[0];return 1!==e.length||11===t.type||9===t.type&&t.branches.some(Bd)}const Ud=(e,t)=>{1!==e.type||0!==e.tagType||"script"!==e.tag&&"style"!==e.tag||(t.onError($d(63,e.loc)),t.removeNode())},Hd=[n=>{1===n.type&&n.props.forEach((e,t)=>{6===e.type&&"style"===e.name&&e.value&&(n.props[t]={type:7,name:"bind",arg:q("style",!0,e.loc),exp:((e,t)=>{const n=_e(e);return q(JSON.stringify(n),false,t,3)})(e.value.content,e.loc),modifiers:[],loc:e.loc})})},(n,r)=>{if(1===n.type&&1===n.tagType&&r.isBuiltInComponent(n.tag)===Id)return()=>{if(n.children.length){Bd(n)&&r.onError($d(62,{start:n.children[0].loc.start,end:n.children[n.children.length-1].loc.end,source:""}));var e=n.children[0];if(1===e.type)for(const t of e.props)7===t.type&&"show"===t.name&&n.props.push({type:6,name:"persisted",nameLoc:n.loc,value:void 0,loc:n.loc})}}}],qd={cloak:()=>({props:[]}),html:(e,t,n)=>{var{exp:e,loc:r}=e;return e||n.onError($d(53,r)),t.children.length&&(n.onError($d(54,r)),t.children.length=0),{props:[H(q("innerHTML",!0,r),e||q("",!0))]}},text:(e,t,n)=>{var{exp:e,loc:r}=e;return e||n.onError($d(55,r)),t.children.length&&(n.onError($d(56,r)),t.children.length=0),{props:[H(q("textContent",!0),e?0<wu(e,n)?e:z(n.helperString(zl),[e],r):q("",!0))]}},model:(n,r,o)=>{const i=vd(n,r,o);if(!i.props.length||1===r.tagType)return i;function s(){var e=Vc(r,"bind");e&&jc(e.arg,"value")&&o.onError($d(60,e.loc))}n.arg&&o.onError($d(58,n.arg.loc));var a=r["tag"],l=o.isCustomElement(a);if("input"===a||"textarea"===a||"select"===a||l){let e=Cd,t=!1;if("input"===a||l){l=Dc(r,"type");if(l){if(7===l.type)e=Td;else if(l.value)switch(l.value.content){case"radio":e=Sd;break;case"checkbox":e=wd;break;case"file":t=!0,o.onError($d(59,n.loc));break;default:s()}}else r.props.some(e=>!(7!==e.type||"bind"!==e.name||e.arg&&4===e.arg.type&&e.arg.isStatic))?e=Td:s()}else"select"===a?e=kd:s();t||(i.needRuntime=o.helper(e))}else o.onError($d(57,n.loc));return i.props=i.props.filter(e=>!(4===e.key.type&&"modelValue"===e.key.content)),i},on:(a,e,l)=>ud(a,e,l,e=>{var t=a["modifiers"];if(!t.length)return e;let{key:n,value:r}=e.props[0];const{keyModifiers:o,nonKeyModifiers:i,eventOptionModifiers:s}=((t,n)=>{const r=[],o=[],i=[];for(let e=0;e<n.length;e++){var s=n[e];Fd(s)?i.push(s):Vd(s)?Nc(t)?(Dd(t.content)?r:o).push(s):(r.push(s),o.push(s)):(Ld(s)?o:r).push(s)}return{keyModifiers:r,nonKeyModifiers:o,eventOptionModifiers:i}})(n,t,a.loc);return i.includes("right")&&(n=jd(n,"onContextmenu")),i.includes("middle")&&(n=jd(n,"onMouseup")),i.length&&(r=z(l.helper(Ed),[r,JSON.stringify(i)])),!o.length||Nc(n)&&!Dd(n.content)||(r=z(l.helper(Ad),[r,JSON.stringify(o)])),s.length&&(e=s.map(V).join(""),n=Nc(n)?q(""+n.content+e,!0):fc(["(",n,`) + "${e}"`])),{props:[H(n,r)]}}),show:(e,t,n)=>{var{exp:e,loc:r}=e;return e||n.onError($d(61,r)),{props:[],needRuntime:n.helper(Nd)}}};console.info(`You are running a development build of Vue.
