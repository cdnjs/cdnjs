...
var YUI = function() {
        _yuitest_coverfunc("build/yui/yui.js", "YUI", 59);
...
var i = 0,
            ...
            instanceOf = function(o, type) {
                _yuitest_coverfunc("build/yui/yui.js", "instanceOf", 64);
...
if (!(instanceOf(Y, YUI))) {
            _yuitest_coverline("build/yui/yui.js", 70);
Y = new YUI();
        } else {
            // set up the core environment
            _yuitest_coverline("build/yui/yui.js", 73);
Y._init();
...
if (YUI.GlobalConfig) {
                _yuitest_coverline("build/yui/yui.js", 101);
...
if (gconf) {
                _yuitest_coverline("build/yui/yui.js", 130);
Y.applyConfig(gconf);
            }
...
if (!l) {
                _yuitest_coverline("build/yui/yui.js", 135);
Y._setup();
            }
        }

        _yuitest_coverline("build/yui/yui.js", 139);
if (l) {
...
Y._setup();
        ...
        _yuitest_coverline("build/yui/yui.js", 151);
...
_yuitest_coverline("build/yui/yui.js", 156);
(function() {

    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 1)", 156);
_yuitest_coverline("build/yui/yui.js", 158);
var proto, prop,
        VERSION = '@VERSION@',
        PERIOD = '.',
        ...
        */
        ...
        add = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui/yui.js", "add", 181);
_yuitest_coverline("build/yui/yui.js", 182);
if (el && el.addEventListener) {
                _yuitest_coverline("build/yui/yui.js", 183);
el.addEventListener(type, fn, capture);
            } else {_yuitest_coverline("build/yui/yui.js", 184);
if (el && el.attachEvent) {
                _yuitest_coverline("build/yui/yui.js", 185);
el.attachEvent('on' + type, fn);
            }}
        },
        remove = function(el, type, fn, capture) {
            _yuitest_coverfunc("build/yui/yui.js", "remove", 188);
...
el.removeEventListener(type, fn, capture);
            ...
            } else {_yuitest_coverline("build/yui/yui.js", 194);
if (el && el.detachEvent) {
                _yuitest_coverline("build/yui/yui.js", 195);
el.detachEvent('on' + type, fn);
            }}
        },
        handleLoad = function() {
            _yuitest_coverfunc("build/yui/yui.js", "handleLoad", 198);
...
if (hasWin) {
                _yuitest_coverline("build/yui/yui.js", 202);
remove(window, 'load', handleLoad);
            }
        },
        getLoader = function(Y, o) {
            _yuitest_coverfunc("build/yui/yui.js", "getLoader", 205);
_yuitest_coverline("build/yui/yui.js", 206);
...
if (mods && mods.loader) {
                _yuitest_coverline("build/yui/yui.js", 223);
lCore = [].concat(lCore, YUI.Env.loaderExtras);
            }
            _yuitest_coverline("build/yui/yui.js", 225);
YUI.Env.core = Y.Array.dedupe([].concat(YUI.Env.core, lCore));

            _yuitest_coverline("build/yui/yui.js", 227);
return loader;
        },

        clobber = function(r, s) {
            _yuitest_coverfunc("build/yui/yui.js", "clobber", 230);
_yuitest_coverline("build/yui/yui.js", 231);
for (var i in s) {
                _yuitest_coverline("build/yui/yui.js", 232);
if (s.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui/yui.js", 233);
r[i] = s[i];
                }
            }
        },
...
_yuitest_coverline("build/yui/yui.js", 254);
proto = {
    /**
    ...
    **/
    applyConfig: function(o) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "applyConfig", 264);
_yuitest_coverline("build/yui/yui.js", 266);
o = o || NOOP;

        _yuitest_coverline("build/yui/yui.js", 268);
var attr,
            name,
            // detail,
            config = this.config,
...
if (mods && name == 'modules') {
                    _yuitest_coverline("build/yui/yui.js", 281);
clobber(mods, attr);
                } else {_yuitest_coverline("build/yui/yui.js", 282);
if (aliases && name == 'aliases') {
                    _yuitest_coverline("build/yui/yui.js", 283);
clobber(aliases, attr);
                } else {_yuitest_coverline("build/yui/yui.js", 284);
...
config[name] = (attr && attr.contentWindow) || attr;
                    _yuitest_coverline("build/yui/yui.js", 288);
config.doc = config[name] ? config[name].document : null;
                } else {_yuitest_coverline("build/yui/yui.js", 289);
if (name == '_yuid') {
                    // preserve the guid
                } else {
                    _yuitest_coverline("build/yui/yui.js", 292);
config[name] = attr;
                }}}}}
            }
        }
...
if (loader) {
            _yuitest_coverline("build/yui/yui.js", 298);
loader._config(o);
        }
    ...
    **/
    _config: function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "_config", 311);
_yuitest_coverline("build/yui/yui.js", 312);
this.applyConfig(o);
    },
    ...
    **/
    _init: function() {
        _yuitest_coverfunc("build/yui/yui.js", "_init", 321);
_yuitest_coverline("build/yui/yui.js", 322);
var filter, el,
            Y = this,
            G_ENV = YUI.Env,
            Env = Y.Env,
        ...
        **/
        _yuitest_coverline("build/yui/yui.js", 337);
Y.version = VERSION;

        _yuitest_coverline("build/yui/yui.js", 339);
if (!Env) {
            _yuitest_coverline("build/yui/yui.js", 340);
Y.Env = {
                ...
                parseBasePath: function(src, pattern) {
                    _yuitest_coverfunc("build/yui/yui.js", "parseBasePath", 385);
_yuitest_coverline("build/yui/yui.js", 386);
...
path = RegExp.leftContext || src.slice(0, src.indexOf(match[0]));
                        ...
                        _yuitest_coverline("build/yui/yui.js", 394);
filter = match[3];
...
path += '?' + match[1];
                        ...
                        _yuitest_coverline("build/yui/yui.js", 401);
path = {
                            filter: filter,
                            path: path
                        };
...
return path;
                ...
                getBase: G_ENV && G_ENV.getBase ||
                        function(pattern) {
                            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 2)", 409);
...
Env = Y.Env;
            ...
            _yuitest_coverline("build/yui/yui.js", 434);
Env._loaded[VERSION] = {};
...
Env._yidx = ++G_ENV._yidx;
                _yuitest_coverline("build/yui/yui.js", 438);
Env._guidp = ('yui_' + VERSION + '_' +
                             Env._yidx + '_' + time).replace(/[^a-z0-9_]+/g, '_');
            } else {_yuitest_coverline("build/yui/yui.js", 440);
if (YUI._YUI) {
...
if (!(prop in Env)) {
                        _yuitest_coverline("build/yui/yui.js", 448);
Env[prop] = G_ENV[prop];
                    }
                }
...
Y.id = Y.stamp(Y);
            _yuitest_coverline("build/yui/yui.js", 456);
instances[Y.id] = Y;

        }

        _yuitest_coverline("build/yui/yui.js", 460);
Y.constructor = YUI;

        // configuration defaults
        _yuitest_coverline("build/yui/yui.js", 463);
Y.config = Y.config || {
            bootstrap: true,
            cacheUse: true,
            debug: true,
...
filter = 'min';
        ...
        _yuitest_coverline("build/yui/yui.js", 497);
filter = (filter) ? '-' + filter : filter;
        _yuitest_coverline("build/yui/yui.js", 498);
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
    ...
    **/
    _setup: function() {
        _yuitest_coverfunc("build/yui/yui.js", "_setup", 509);
...
var i, Y = this,
        ...
        _yuitest_coverline("build/yui/yui.js", 515);
for (i = 0; i < extras.length; i++) {
            _yuitest_coverline("build/yui/yui.js", 516);
if (mods[extras[i]]) {
                _yuitest_coverline("build/yui/yui.js", 517);
core.push(extras[i]);
            }
        }
...
Y._attach(core);
        ...
        _yuitest_coverline("build/yui/yui.js", 524);
if (Y.Loader) {
            _yuitest_coverline("build/yui/yui.js", 525);
getLoader(Y);
        }
    ...
    **/
    applyTo: function(id, method, args) {
        _yuitest_coverfunc("build/yui/yui.js", "applyTo", 542);
_yuitest_coverline("build/yui/yui.js", 543);
...
for (i = 0; i < nest.length; i = i + 1) {
                _yuitest_coverline("build/yui/yui.js", 553);
m = m[nest[i]];
                _yuitest_coverline("build/yui/yui.js", 554);
if (!m) {
...
return m && m.apply(instance, args);
        ...
        _yuitest_coverline("build/yui/yui.js", 561);
return null;
    },
...
**/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui/yui.js", "add", 611);
_yuitest_coverline("build/yui/yui.js", 612);
details = details || {};
        _yuitest_coverline("build/yui/yui.js", 613);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
        ...
        _yuitest_coverline("build/yui/yui.js", 625);
env.mods[name] = mod;
...
loader = inst.Env._loader;
                    _yuitest_coverline("build/yui/yui.js", 635);
if (loader) {
                        _yuitest_coverline("build/yui/yui.js", 636);
if (!loader.moduleInfo[name] || loader.moduleInfo[name].temp) {
                            _yuitest_coverline("build/yui/yui.js", 637);
...
return this;
    ...
    **/
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui/yui.js", "_attach", 657);
...
mod = mods[name];
                ...
                _yuitest_coverline("build/yui/yui.js", 694);
...
for (j = 0; j < req.length; j++) {
                            _yuitest_coverline("build/yui/yui.js", 752);
if (!done[req[j]]) {
...
for (j = 0; j < after.length; j++) {
                            _yuitest_coverline("build/yui/yui.js", 763);
if (!done[after[j]]) {
                                _yuitest_coverline("build/yui/yui.js", 764);
if (!Y._attach(after, true)) {
                                    _yuitest_coverline("build/yui/yui.js", 765);
return false;
                                }
                                _yuitest_coverline("build/yui/yui.js", 767);
break;
                            }
                        }
                    }

                    _yuitest_coverline("build/yui/yui.js", 772);
if (mod.fn) {
...
mod.fn(Y, name);
                                    ...
                                    _yuitest_coverline("build/yui/yui.js", 779);
Y.error('Attach error: ' + name, e, name);
                                _yuitest_coverline("build/yui/yui.js", 780);
return false;
                            }
                        }
                    }
...
if (!Y._attach(use)) {
                                    _yuitest_coverline("build/yui/yui.js", 789);
return false;
                                }
...
break;
        ...
        _yuitest_coverline("build/yui/yui.js", 802);
return true;
    },
    ...
    **/
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_delayCallback", 816);
...
until = (Y.Lang.isObject(until) ? until : { event: until });
        ...
        _yuitest_coverline("build/yui/yui.js", 823);
if (until.event === 'load') {
...
return function() {
            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 3)", 827);
_yuitest_coverline("build/yui/yui.js", 828);
var args = arguments;
            _yuitest_coverline("build/yui/yui.js", 829);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 4)", 829);
_yuitest_coverline("build/yui/yui.js", 830);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 5)", 830);
_yuitest_coverline("build/yui/yui.js", 831);
args[1].delayUntil = until.event;
                    _yuitest_coverline("build/yui/yui.js", 832);
cb.apply(Y, args);
                }, until.args);
            });
        };
    ...
    **/
    use: function() {
        _yuitest_coverfunc("build/yui/yui.js", "use", 901);
_yuitest_coverline("build/yui/yui.js", 902);
...
if (!Env._attached[name]) {
                    _yuitest_coverline("build/yui/yui.js", 926);
provisioned = false;
                    _yuitest_coverline("build/yui/yui.js", 927);
break;
                }
            }

            _yuitest_coverline("build/yui/yui.js", 931);
if (provisioned) {
                _yuitest_coverline("build/yui/yui.js", 932);
if (args.length) {
                }
                _yuitest_coverline("build/yui/yui.js", 934);
Y._notify(callback, ALREADY_DONE, args);
                _yuitest_coverline("build/yui/yui.js", 935);
return Y;
            }
        }
...
Y._useQueue.add([args, callback]);
            ...
            _yuitest_coverline("build/yui/yui.js", 943);
Y._use(args, function(Y, response) {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 6)", 943);
_yuitest_coverline("build/yui/yui.js", 944);
Y._notify(callback, response, args);
            });
        }

        _yuitest_coverline("build/yui/yui.js", 948);
return Y;
    },
    ...
    **/
    _notify: function(callback, response, args) {
        _yuitest_coverfunc("build/yui/yui.js", "_notify", 960);
_yuitest_coverline("build/yui/yui.js", 961);
if (!response.success && this.config.loadErrorFn) {
            _yuitest_coverline("build/yui/yui.js", 962);
this.config.loadErrorFn.call(this, this, callback, response, args);
        } else {_yuitest_coverline("build/yui/yui.js", 963);
if (callback) {
...
response.success = false;
            ...
            _yuitest_coverline("build/yui/yui.js", 968);
...
callback(this, response);
                    ...
                    _yuitest_coverline("build/yui/yui.js", 974);
this.error('use callback error', e, args);
    ...
    **/
    _use: function(args, callback) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_use", 990);
_yuitest_coverline("build/yui/yui.js", 992);
if (!this.Array) {
            _yuitest_coverline("build/yui/yui.js", 993);
...
var len, loader, handleBoot,
            ...
            process = function(names, skip) {
                ...
                _yuitest_coverfunc("build/yui/yui.js", "process", 1013);
_yuitest_coverline("build/yui/yui.js", 1015);
var i = 0, a = [], name, len, m, req, use;

                _yuitest_coverline("build/yui/yui.js", 1017);
if (!names.length) {
...
for (i = 0; i < len; i++) {
                        _yuitest_coverline("build/yui/yui.js", 1024);
if (aliases[names[i]] && !mods[names[i]]) {
                            _yuitest_coverline("build/yui/yui.js", 1025);
a = [].concat(a, aliases[names[i]]);
                        } else {
                            _yuitest_coverline("build/yui/yui.js", 1027);
a.push(names[i]);
                        }
                    }
                    _yuitest_coverline("build/yui/yui.js", 1030);
names = a;
                }
...
m = mods[name];
                    _yuitest_coverline("build/yui/yui.js", 1047);
req = null;
...
use = m.details.use;
                        ...
                        // been loaded
                        _yuitest_coverline("build/yui/yui.js", 1057);
if (!G_ENV._loaded[VERSION][name]) {
                            _yuitest_coverline("build/yui/yui.js", 1058);
missing.push(name);
                        } else {
                            _yuitest_coverline("build/yui/yui.js", 1060);
used[name] = true; // probably css
                        }
                    }

                    // make sure requirements are attached
                    _yuitest_coverline("build/yui/yui.js", 1065);
if (req && req.length) {
...
process(req);
                    ...
                    _yuitest_coverline("build/yui/yui.js", 1070);
if (use && use.length) {
                        _yuitest_coverline("build/yui/yui.js", 1071);
process(use, 1);
                    }
                }
            ...
            handleLoader = function(fromLoader) {
                _yuitest_coverfunc("build/yui/yui.js", "handleLoader", 1077);
...
redo = missing.length;
                    _yuitest_coverline("build/yui/yui.js", 1094);
if (redo) {
...
Y._use(missing, function() {
                        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 7)", 1104);
_yuitest_coverline("build/yui/yui.js", 1105);
if (Y._attach(data)) {
                            _yuitest_coverline("build/yui/yui.js", 1106);
...
ret = Y._attach(data);
                    ...
                    _yuitest_coverline("build/yui/yui.js", 1113);
if (ret) {
                        _yuitest_coverline("build/yui/yui.js", 1114);
Y._notify(callback, response, args);
                    }
                }
...
if (mods.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui/yui.js", 1130);
args.push(i);
                }
            }
...
return Y;
        ...
        _yuitest_coverline("build/yui/yui.js", 1140);
...
args = loader.sorted;
            _yuitest_coverline("build/yui/yui.js", 1154);
loader._boot = false;
        }
...
process(args);
        ...
        _yuitest_coverline("build/yui/yui.js", 1159);
len = missing.length;


        _yuitest_coverline("build/yui/yui.js", 1162);
if (len) {
            _yuitest_coverline("build/yui/yui.js", 1163);
missing = YArray.dedupe(missing);
            _yuitest_coverline("build/yui/yui.js", 1164);
len = missing.length;
        }
...
loader.ignoreRegistered = false;
            _yuitest_coverline("build/yui/yui.js", 1176);
loader.require(missing);
            _yuitest_coverline("build/yui/yui.js", 1177);
loader.insert(null, (fetchCSS) ? null : 'js');

        } else {_yuitest_coverline("build/yui/yui.js", 1179);
...
handleBoot = function() {
                _yuitest_coverfunc("build/yui/yui.js", "handleBoot", 1183);
...
G_ENV._bootstrapping = false;
                _yuitest_coverline("build/yui/yui.js", 1188);
if (Y._attach(['loader'])) {
                    _yuitest_coverline("build/yui/yui.js", 1189);
Y._use(args, callback);
                }
            };

            _yuitest_coverline("build/yui/yui.js", 1193);
if (G_ENV._bootstrapping) {
                _yuitest_coverline("build/yui/yui.js", 1194);
queue.add(handleBoot);
            } else {
                _yuitest_coverline("build/yui/yui.js", 1196);
...
if (ret) {
                _yuitest_coverline("build/yui/yui.js", 1205);
handleLoader();
            }
        }}

        _yuitest_coverline("build/yui/yui.js", 1209);
return Y;
    },
    ...
    **/
    namespace: function() {
        _yuitest_coverfunc("build/yui/yui.js", "namespace", 1252);
...
for (j = (d[0] == 'YAHOO') ? 1 : 0; j < d.length; j++) {
                    _yuitest_coverline("build/yui/yui.js", 1261);
o[d[j]] = o[d[j]] || {};
                    _yuitest_coverline("build/yui/yui.js", 1262);
o = o[d[j]];
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 1265);
o[arg] = o[arg] || {};
                _yuitest_coverline("build/yui/yui.js", 1266);
o = o[arg]; //Reset base object to the new object so it's returned
            }
        }
        _yuitest_coverline("build/yui/yui.js", 1269);
return o;
    },
    ...
    dump: function (o) { _yuitest_coverfunc("build/yui/yui.js", "dump", 1276);
_yuitest_coverline("build/yui/yui.js", 1276);
return ''+o; },
    ...
    **/
    error: function(msg, e, src) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "error", 1295);
_yuitest_coverline("build/yui/yui.js", 1298);
var Y = this, ret;

        _yuitest_coverline("build/yui/yui.js", 1300);
if (Y.config.errorFn) {
            _yuitest_coverline("build/yui/yui.js", 1301);
ret = Y.config.errorFn.apply(Y, arguments);
        }

        _yuitest_coverline("build/yui/yui.js", 1304);
if (!ret) {
...
return Y;
    ...
    **/
    guid: function(pre) {
        _yuitest_coverfunc("build/yui/yui.js", "guid", 1321);
_yuitest_coverline("build/yui/yui.js", 1322);
var id = this.Env._guidp + '_' + (++this.Env._uidx);
        _yuitest_coverline("build/yui/yui.js", 1323);
return (pre) ? (pre + id) : id;
    ...
    **/
    stamp: function(o, readOnly) {
        _yuitest_coverfunc("build/yui/yui.js", "stamp", 1343);
_yuitest_coverline("build/yui/yui.js", 1344);
var uid;
        _yuitest_coverline("build/yui/yui.js", 1345);
if (!o) {
            _yuitest_coverline("build/yui/yui.js", 1346);
return o;
        }

        // IE generates its own unique ID for dom nodes
        // The uniqueID property of a document node returns a new ID
        _yuitest_coverline("build/yui/yui.js", 1351);
if (o.uniqueID && o.nodeType && o.nodeType !== 9) {
            _yuitest_coverline("build/yui/yui.js", 1352);
uid = o.uniqueID;
        } else {
            _yuitest_coverline("build/yui/yui.js", 1354);
...
if (!readOnly) {
                _yuitest_coverline("build/yui/yui.js", 1360);
try {
                    _yuitest_coverline("build/yui/yui.js", 1361);
o._yuid = uid;
                } catch (e) {
                    _yuitest_coverline("build/yui/yui.js", 1363);
uid = null;
                }
            }
        }
...
return uid;
    ...
    **/
    destroy: function() {
        _yuitest_coverfunc("build/yui/yui.js", "destroy", 1376);
_yuitest_coverline("build/yui/yui.js", 1377);
var Y = this;
        _yuitest_coverline("build/yui/yui.js", 1378);
if (Y.Event) {
...
delete instances[Y.id];
        _yuitest_coverline("build/yui/yui.js", 1382);
delete Y.Env;
...
delete Y.config;
    ...
    **/
    ...
    _yuitest_coverline("build/yui/yui.js", 1400);
YUI.prototype = proto;

    // inheritance utilities are not available yet
    _yuitest_coverline("build/yui/yui.js", 1403);
for (prop in proto) {
        _yuitest_coverline("build/yui/yui.js", 1404);
if (proto.hasOwnProperty(prop)) {
            _yuitest_coverline("build/yui/yui.js", 1405);
YUI[prop] = proto[prop];
        }
    }
...
YUI.applyConfig = function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "applyConfig", 1444);
_yuitest_coverline("build/yui/yui.js", 1445);
if (!o) {
            _yuitest_coverline("build/yui/yui.js", 1446);
return;
        }
        //If there is a GlobalConfig, apply it first to set the defaults
        _yuitest_coverline("build/yui/yui.js", 1449);
if (YUI.GlobalConfig) {
            _yuitest_coverline("build/yui/yui.js", 1450);
...
this.prototype.applyConfig.call(this, o);
        ...
        _yuitest_coverline("build/yui/yui.js", 1455);
...
YUI._init();
    ...
    _yuitest_coverline("build/yui/yui.js", 1461);
if (hasWin) {
...
add(window, 'load', handleLoad);
        ...
        _yuitest_coverline("build/yui/yui.js", 1467);
handleLoad();
    }

    _yuitest_coverline("build/yui/yui.js", 1470);
YUI.Env.add = add;
    _yuitest_coverline("build/yui/yui.js", 1471);
YUI.Env.remove = remove;

    /*global exports*/
    // Support the CommonJS method for exporting our single global
    _yuitest_coverline("build/yui/yui.js", 1475);
if (typeof exports == 'object') {
        _yuitest_coverline("build/yui/yui.js", 1476);
exports.YUI = YUI;
        /**
        ...
        */
        _yuitest_coverline("build/yui/yui.js", 1490);
YUI.setLoadHook = function(fn) {
            _yuitest_coverfunc("build/yui/yui.js", "setLoadHook", 1490);
_yuitest_coverline("build/yui/yui.js", 1491);
YUI._getLoadHook = fn;
        };
        /**
        ...
        */
        _yuitest_coverline("build/yui/yui.js", 1500);
...
@since 3.6.0
**/
_yuitest_coverline("build/yui/yui.js", 1751);
...
_yuitest_coverfunc("build/yui/yui.js", "(anonymous 8)", 1751);
_yuitest_coverline("build/yui/yui.js", 1773);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 1821);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui/yui.js", "_isNative", 1821);
_yuitest_coverline("build/yui/yui.js", 1822);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 1839);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui/yui.js", "isArray", 1839);
_yuitest_coverline("build/yui/yui.js", 1840);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1850);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isBoolean", 1850);
_yuitest_coverline("build/yui/yui.js", 1851);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1861);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isDate", 1861);
_yuitest_coverline("build/yui/yui.js", 1862);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1889);
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isFunction", 1889);
_yuitest_coverline("build/yui/yui.js", 1890);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1900);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNull", 1900);
_yuitest_coverline("build/yui/yui.js", 1901);
return o === null;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1911);
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNumber", 1911);
_yuitest_coverline("build/yui/yui.js", 1912);
...
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui/yui.js", "isObject", 1926);
_yuitest_coverline("build/yui/yui.js", 1927);
var t = typeof o;
    _yuitest_coverline("build/yui/yui.js", 1928);
return (o && (t === 'object' ||
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1939);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isString", 1939);
_yuitest_coverline("build/yui/yui.js", 1940);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isUndefined", 1950);
_yuitest_coverline("build/yui/yui.js", 1951);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 1963);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isValue", 1963);
_yuitest_coverline("build/yui/yui.js", 1964);
var t = L.type(o);

    _yuitest_coverline("build/yui/yui.js", 1966);
switch (t) {
        case 'number':
            _yuitest_coverline("build/yui/yui.js", 1968);
return isFinite(o);
 ...
 * @since 3.3.0
 */
_yuitest_coverline("build/yui/yui.js", 1987);
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 9)", 1987);
_yuitest_coverline("build/yui/yui.js", 1988);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 2002);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui/yui.js", "sub", 2002);
_yuitest_coverline("build/yui/yui.js", 2003);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 10)", 2003);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2016);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 11)", 2016);
_yuitest_coverline("build/yui/yui.js", 2017);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2018);
_yuitest_coverline("build/yui/yui.js", 2019);
try {
        _yuitest_coverline("build/yui/yui.js", 2020);
return s.replace(TRIMREGEX, '');
    } catch (e) {
        _yuitest_coverline("build/yui/yui.js", 2022);
return s;
    }
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2033);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 12)", 2033);
_yuitest_coverline("build/yui/yui.js", 2034);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2035);
_yuitest_coverline("build/yui/yui.js", 2036);
return s.replace(/^\s+/, '');
};
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2046);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 13)", 2046);
_yuitest_coverline("build/yui/yui.js", 2047);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2048);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "type", 2079);
_yuitest_coverline("build/yui/yui.js", 2080);
...
_yuitest_coverline("build/yui/yui.js", 2087);
var Lang   = Y.Lang,
...
@return {Array} A native array created from _thing_, according to the rules
  described above.
**/
_yuitest_coverline("build/yui/yui.js", 2120);
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui/yui.js", "YArray", 2120);
_yuitest_coverline("build/yui/yui.js", 2121);
var len, result;

    /*jshint expr: true*/
    _yuitest_coverline("build/yui/yui.js", 2124);
startIndex || (startIndex = 0);

    _yuitest_coverline("build/yui/yui.js", 2126);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("build/yui/yui.js", 2128);
try {
            _yuitest_coverline("build/yui/yui.js", 2129);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("build/yui/yui.js", 2131);
result = [];

            _yuitest_coverline("build/yui/yui.js", 2133);
for (len = thing.length; startIndex < len; ++startIndex) {
                _yuitest_coverline("build/yui/yui.js", 2134);
result.push(thing[startIndex]);
            }

            _yuitest_coverline("build/yui/yui.js", 2137);
return result;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2141);
return [thing];
}

_yuitest_coverline("build/yui/yui.js", 2144);
Y.Array = YArray;
...
@since 3.4.0
**/
_yuitest_coverline("build/yui/yui.js", 2160);
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui/yui.js", "dedupe", 2160);
_yuitest_coverline("build/yui/yui.js", 2161);
var hash    = {},
        results = [],
        i, item, len;
...
for (i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2166);
item = array[i];

        _yuitest_coverline("build/yui/yui.js", 2168);
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("build/yui/yui.js", 2169);
hash[item] = 1;
            _yuitest_coverline("build/yui/yui.js", 2170);
results.push(item);
        }
    }
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 14)", 2192);
_yuitest_coverline("build/yui/yui.js", 2193);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui/yui.js", 2194);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2195);
_yuitest_coverline("build/yui/yui.js", 2196);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2197);
if (i in array) {
            _yuitest_coverline("build/yui/yui.js", 2198);
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2229);
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui/yui.js", "hash", 2229);
_yuitest_coverline("build/yui/yui.js", 2230);
var hash = {},
        vlen = (values && values.length) || 0,
        i, len;

    _yuitest_coverline("build/yui/yui.js", 2234);
for (i = 0, len = keys.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2235);
if (i in keys) {
            _yuitest_coverline("build/yui/yui.js", 2236);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2240);
return hash;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2257);
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 15)", 2257);
_yuitest_coverline("build/yui/yui.js", 2258);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui/yui.js", "}", 2259);
_yuitest_coverline("build/yui/yui.js", 2261);
var len = array.length;

    _yuitest_coverline("build/yui/yui.js", 2263);
from = +from || 0;
    _yuitest_coverline("build/yui/yui.js", 2264);
from = (from > 0 || -1) * Math.floor(Math.abs(from));

    _yuitest_coverline("build/yui/yui.js", 2266);
if (from < 0) {
        _yuitest_coverline("build/yui/yui.js", 2267);
from += len;

        _yuitest_coverline("build/yui/yui.js", 2269);
if (from < 0) {
            _yuitest_coverline("build/yui/yui.js", 2270);
from = 0;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2274);
for (; from < len; ++from) {
        _yuitest_coverline("build/yui/yui.js", 2275);
if (from in array && array[from] === value) {
            _yuitest_coverline("build/yui/yui.js", 2276);
return from;
        }
    }
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2302);
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "numericSort", 2302);
_yuitest_coverline("build/yui/yui.js", 2303);
return a - b;
};
...
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 16)", 2322);
_yuitest_coverline("build/yui/yui.js", 2323);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2324);
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2352);
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "test", 2352);
_yuitest_coverline("build/yui/yui.js", 2353);
var result = 0;

    _yuitest_coverline("build/yui/yui.js", 2355);
if (Lang.isArray(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2356);
result = 1;
    } else {_yuitest_coverline("build/yui/yui.js", 2357);
...
try {
            ...
            _yuitest_coverline("build/yui/yui.js", 2362);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2386);
function Queue() {
    _yuitest_coverfunc("build/yui/yui.js", "Queue", 2386);
_yuitest_coverline("build/yui/yui.js", 2387);
this._init();
    _yuitest_coverline("build/yui/yui.js", 2388);
...
Queue.prototype = {
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui/yui.js", "_init", 2398);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui/yui.js", "next", 2415);
_yuitest_coverline("build/yui/yui.js", 2416);
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui/yui.js", "last", 2425);
_yuitest_coverline("build/yui/yui.js", 2426);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui/yui.js", "add", 2436);
_yuitest_coverline("build/yui/yui.js", 2437);
this._q.push.apply(this._q, arguments);

        _yuitest_coverline("build/yui/yui.js", 2439);
return this;
    },
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui/yui.js", "size", 2448);
_yuitest_coverline("build/yui/yui.js", 2449);
...
_yuitest_coverline("build/yui/yui.js", 2466);
...
@for YUI
**/
_yuitest_coverline("build/yui/yui.js", 2495);
Y.cached = function (source, cache, refetch) {
    /*jshint expr: true*/
    _yuitest_coverfunc("build/yui/yui.js", "cached", 2495);
_yuitest_coverline("build/yui/yui.js", 2497);
cache || (cache = {});

    _yuitest_coverline("build/yui/yui.js", 2499);
return function (arg) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 17)", 2499);
...
var key = arguments.length > 1 ?
        ...
        /*jshint eqeqeq: false*/
        _yuitest_coverline("build/yui/yui.js", 2505);
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui/yui.js", 2506);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "getLocation", 2529);
_yuitest_coverline("build/yui/yui.js", 2533);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui/yui.js", 2539);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui/yui.js", "merge", 2554);
_yuitest_coverline("build/yui/yui.js", 2555);
var i      = 0,
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2562);
obj = arguments[i];

        _yuitest_coverline("build/yui/yui.js", 2564);
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 2565);
...
result[key] = obj[key];
    ...
    _yuitest_coverline("build/yui/yui.js", 2571);
return result;
};
...
**/
_yuitest_coverline("build/yui/yui.js", 2608);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 2608);
_yuitest_coverline("build/yui/yui.js", 2609);
...
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui/yui.js", 2615);
return receiver || Y;
    }
...
if (mode) {
        ...
        // handled later on.
        _yuitest_coverline("build/yui/yui.js", 2622);
if (mode === 2) {
            _yuitest_coverline("build/yui/yui.js", 2623);
Y.mix(receiver.prototype, supplier.prototype, overwrite,
        ...
        _yuitest_coverline("build/yui/yui.js", 2629);
...
if (!from || !to) {
            _yuitest_coverline("build/yui/yui.js", 2636);
return receiver;
        }
    } else {
        _yuitest_coverline("build/yui/yui.js", 2639);
from = supplier;
        _yuitest_coverline("build/yui/yui.js", 2640);
to   = receiver;
    }
...
if (whitelist) {
        _yuitest_coverline("build/yui/yui.js", 2648);
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 2649);
key = whitelist[i];
...
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 2657);
continue;
            }
            ...
            _yuitest_coverline("build/yui/yui.js", 2663);
...
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui/yui.js", 2675);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2676);
if (overwrite || !exists) {
                // We're not in merge mode, so we'll only copy the `from` value
                // to the `to` value if we're in overwrite mode or if the
                // current key doesn't exist on the `to` object.
                _yuitest_coverline("build/yui/yui.js", 2680);
to[key] = from[key];
            }}
        }
    } else {
        _yuitest_coverline("build/yui/yui.js", 2684);
for (key in from) {
            ...
            _yuitest_coverline("build/yui/yui.js", 2690);
if (!hasOwn.call(from, key)) {
                _yuitest_coverline("build/yui/yui.js", 2691);
continue;
            }
...
exists = alwaysOverwrite ? false : key in to;
            ...
            _yuitest_coverline("build/yui/yui.js", 2699);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui/yui.js", 2701);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2702);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui/yui.js", 2703);
to[key] = from[key];
            }}
        }
        ...
        // the buggy properties as the whitelist.
        _yuitest_coverline("build/yui/yui.js", 2710);
...
_yuitest_coverline("build/yui/yui.js", 2731);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 18)", 2747);
_yuitest_coverline("build/yui/yui.js", 2753);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 19)", 2754);
_yuitest_coverline("build/yui/yui.js", 2756);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui/yui.js", 2759);
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 20)", 2759);
_yuitest_coverline("build/yui/yui.js", 2760);
F.prototype = obj;
        _yuitest_coverline("build/yui/yui.js", 2761);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 2822);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2858);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 2858);
_yuitest_coverline("build/yui/yui.js", 2859);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 2860);
throw new TypeError('Object.keys called on a non-object');
    }

    _yuitest_coverline("build/yui/yui.js", 2863);
var keys = [],
        i, key, len;

    _yuitest_coverline("build/yui/yui.js", 2866);
if (hasProtoEnumBug && typeof obj === 'function') {
        _yuitest_coverline("build/yui/yui.js", 2867);
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 2868);
...
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 2874);
if (owns(obj, key)) {
...
if (hasEnumBug) {
        _yuitest_coverline("build/yui/yui.js", 2881);
for (i = 0, len = forceEnum.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 2882);
key = forceEnum[i];

            _yuitest_coverline("build/yui/yui.js", 2884);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 2885);
keys.push(key);
            }
        }
    }
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2910);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 2910);
_yuitest_coverline("build/yui/yui.js", 2911);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];

    _yuitest_coverline("build/yui/yui.js", 2916);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2917);
...
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 2931);
_yuitest_coverline("build/yui/yui.js", 2932);
try {
        _yuitest_coverline("build/yui/yui.js", 2933);
return O.keys(obj).length;
    } catch (ex) {
        _yuitest_coverline("build/yui/yui.js", 2935);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 2949);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2973);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 2973);
_yuitest_coverline("build/yui/yui.js", 2974);
var key;

    _yuitest_coverline("build/yui/yui.js", 2976);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 2977);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 2978);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2982);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3005);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 3005);
_yuitest_coverline("build/yui/yui.js", 3006);
var key;

    _yuitest_coverline("build/yui/yui.js", 3008);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3009);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3010);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui/yui.js", 3011);
return true;
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3016);
return false;
};
 ...
 */
_yuitest_coverline("build/yui/yui.js", 3032);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 3032);
_yuitest_coverline("build/yui/yui.js", 3033);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui/yui.js", 3034);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui/yui.js", 3037);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui/yui.js", 3041);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui/yui.js", 3042);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui/yui.js", 3045);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 3062);
...
var i,
    ...
    _yuitest_coverline("build/yui/yui.js", 3068);
if (leafIdx >= 0) {
...
ref[p[i]] = val;
            ...
            _yuitest_coverline("build/yui/yui.js", 3076);
return UNDEFINED;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3080);
return o;
};
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 3092);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 3092);
_yuitest_coverline("build/yui/yui.js", 3093);
...
*/
_yuitest_coverline("build/yui/yui.js", 3128);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 3128);
_yuitest_coverline("build/yui/yui.js", 3130);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 3130);
_yuitest_coverline("build/yui/yui.js", 3131);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 3132);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 22)", 3132);
_yuitest_coverline("build/yui/yui.js", 3133);
return (c++ === 1) ? '' : '.';
            }));
        },
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui/yui.js", 3376);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3377);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui/yui.js", 3378);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3379);
o.os = 'android';
        } else {_yuitest_coverline("build/yui/yui.js", 3380);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3381);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui/yui.js", 3382);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3383);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 3384);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3385);
o.os = 'rhino';
        }}}}}}
...
if ((/IEMobile|XBLWP7/).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3393);
o.mobile = 'windows';
        }
...
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui/yui.js", 3402);
o.safari = o.webkit;

            _yuitest_coverline("build/yui/yui.js", 3404);
...
if (/ Mobile\//.test(ua) || (/iPad|iPod|iPhone/).test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3413);
o.mobile = 'Apple'; // iPhone or iPod Touch

                _yuitest_coverline("build/yui/yui.js", 3415);
m = ua.match(/OS ([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3416);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3417);
m = numberify(m[1].replace('_', '.'));
                }
                _yuitest_coverline("build/yui/yui.js", 3419);
o.ios = m;
...
if (m) {
                    ...
                    _yuitest_coverline("build/yui/yui.js", 3431);
o.mobile = m[0];
                }
                _yuitest_coverline("build/yui/yui.js", 3433);
if (/webOS/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3434);
o.mobile = 'WebOS';
                    _yuitest_coverline("build/yui/yui.js", 3435);
m = ua.match(/webOS\/([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 3436);
if (m && m[1]) {
...
if (/ Android/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3441);
if (/Mobile/.test(ua)) {
...
m = ua.match(/Android ([^\s]*);/);
                    _yuitest_coverline("build/yui/yui.js", 3445);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3446);
...
m = ua.match(/Silk\/([^\s]*)\)/);
                    _yuitest_coverline("build/yui/yui.js", 3452);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3453);
o.silk = numberify(m[1]);
                    }
                    _yuitest_coverline("build/yui/yui.js", 3455);
if (!o.android) {
...
o.os = 'Android';
                    ...
                    _yuitest_coverline("build/yui/yui.js", 3459);
...
if (m[1] === 'CrMo') {
                    _yuitest_coverline("build/yui/yui.js", 3470);
o.mobile = 'chrome';
                }
            } else {
                _yuitest_coverline("build/yui/yui.js", 3473);
m = ua.match(/AdobeAIR\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3474);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3475);
...
// @todo check Opera/8.01 (J2ME/MIDP; Opera Mini/2.0.4509/1316; fi; U; ssr)
            _yuitest_coverline("build/yui/yui.js", 3482);
if (/Opera/.test(ua)) {
                _yuitest_coverline("build/yui/yui.js", 3483);
m = ua.match(/Opera[\s\/]([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3484);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3485);
o.opera = numberify(m[1]);
                }
                _yuitest_coverline("build/yui/yui.js", 3487);
m = ua.match(/Version\/([^\s]*)/);
                _yuitest_coverline("build/yui/yui.js", 3488);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3489);
o.opera = numberify(m[1]); // opera 10+
                }

                _yuitest_coverline("build/yui/yui.js", 3492);
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui/yui.js", 3493);
o.mobile = 'opera';
                    _yuitest_coverline("build/yui/yui.js", 3494);
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3495);
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3496);
o.opera = numberify(m[1]);
                    }
                }
...
m = ua.match(/Opera Mini[^;]*/);
                ...
                _yuitest_coverline("build/yui/yui.js", 3501);
if (m) {
                    _yuitest_coverline("build/yui/yui.js", 3502);
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                }
            } else { // not opera or webkit
                _yuitest_coverline("build/yui/yui.js", 3505);
m = ua.match(/MSIE\s([^;]*)/);
                _yuitest_coverline("build/yui/yui.js", 3506);
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3507);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui/yui.js", 3509);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3510);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 3511);
o.gecko = 1; // Gecko detected, look for revision
                        _yuitest_coverline("build/yui/yui.js", 3512);
m = ua.match(/rv:([^\s\)]*)/);
                        _yuitest_coverline("build/yui/yui.js", 3513);
if (m && m[1]) {
                            _yuitest_coverline("build/yui/yui.js", 3514);
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui/yui.js", 3524);
...
if (!subUA) {
        ...
        _yuitest_coverline("build/yui/yui.js", 3531);
...
YUI.Env.UA = o;
    ...
    _yuitest_coverline("build/yui/yui.js", 3544);
return o;
};


_yuitest_coverline("build/yui/yui.js", 3548);
...
@return -1 if _a_ is lower than _b_, 0 if they're equivalent, 1 if _a_ is
    higher than _b_.
**/
_yuitest_coverline("build/yui/yui.js", 3570);
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 3570);
_yuitest_coverline("build/yui/yui.js", 3571);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui/yui.js", 3573);
if (a === b) {
...
bParts = (b + '').split('.');
    ...
    _yuitest_coverline("build/yui/yui.js", 3580);
...
bPart = parseInt(bParts[i], 10);
        ...
        /*jshint expr: true*/
        _yuitest_coverline("build/yui/yui.js", 3585);
isNaN(aPart) && (aPart = 0);
...
return -1;
        ...
        _yuitest_coverline("build/yui/yui.js", 3592);
if (aPart > bPart) {
            _yuitest_coverline("build/yui/yui.js", 3593);
return 1;
        }
    }
