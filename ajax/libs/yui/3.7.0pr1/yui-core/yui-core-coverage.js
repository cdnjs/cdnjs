...
var args   = arguments,
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2756);
for (; i < len; ++i) {
...
**/
_yuitest_coverline("build/yui-core/yui-core.js", 2797);
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "mix", 2797);
_yuitest_coverline("build/yui-core/yui-core.js", 2798);
var alwaysOverwrite, exists, from, i, key, len, to;

    // If no supplier is given, we return the receiver. If no receiver is given,
    // we return Y. Returning Y doesn't make much sense to me, but it's
    // grandfathered in for backcompat reasons.
    _yuitest_coverline("build/yui-core/yui-core.js", 2803);
if (!receiver || !supplier) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2804);
return receiver || Y;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2807);
if (mode) {
...
if (mode === 2) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2812);
...
to   = receiver;
    ...
    _yuitest_coverline("build/yui-core/yui-core.js", 2834);
alwaysOverwrite = overwrite && !merge;

    _yuitest_coverline("build/yui-core/yui-core.js", 2836);
if (whitelist) {
        _yuitest_coverline("build/yui-core/yui-core.js", 2837);
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2838);
key = whitelist[i];
...
if (merge && exists && isObject(to[key], true)
                ...
                _yuitest_coverline("build/yui-core/yui-core.js", 2864);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 2865);
if (overwrite || !exists) {
...
to[key] = from[key];
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 2873);
for (key in from) {
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 2879);
if (!hasOwn.call(from, key)) {
...
exists = alwaysOverwrite ? false : key in to;
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 2888);
if (merge && exists && isObject(to[key], true)
                    && isObject(from[key], true)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2890);
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui-core/yui-core.js", 2891);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui-core/yui-core.js", 2892);
to[key] = from[key];
            }}
        }
...
if (Y.Object._hasEnumBug) {
            _yuitest_coverline("build/yui-core/yui-core.js", 2900);
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 2904);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
_yuitest_coverline("build/yui-core/yui-core.js", 2920);
var Lang   = Y.Lang,
    hasOwn = Object.prototype.hasOwnProperty,
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 18)", 2936);
_yuitest_coverline("build/yui-core/yui-core.js", 2942);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 19)", 2943);
_yuitest_coverline("build/yui-core/yui-core.js", 2945);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui-core/yui-core.js", 2948);
return function (obj) {
        _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 20)", 2948);
_yuitest_coverline("build/yui-core/yui-core.js", 2949);
F.prototype = obj;
        _yuitest_coverline("build/yui-core/yui-core.js", 2950);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "owns", 3011);
_yuitest_coverline("build/yui-core/yui-core.js", 3012);
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3024);
O.hasKey = owns;
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3047);
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "keys", 3047);
_yuitest_coverline("build/yui-core/yui-core.js", 3048);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3049);
throw new TypeError('Object.keys called on a non-object');
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3052);
var keys = [],
        i, key, len;
...
for (key in obj) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3057);
if (owns(obj, key) && key !== 'prototype') {
                _yuitest_coverline("build/yui-core/yui-core.js", 3058);
keys.push(key);
            }
        }
    } else {
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3099);
O.values = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "values", 3099);
_yuitest_coverline("build/yui-core/yui-core.js", 3100);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];

    _yuitest_coverline("build/yui-core/yui-core.js", 3105);
for (; i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3106);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3109);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3120);
O.size = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "size", 3120);
_yuitest_coverline("build/yui-core/yui-core.js", 3121);
try {
        _yuitest_coverline("build/yui-core/yui-core.js", 3122);
return O.keys(obj).length;
    } catch (ex) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3124);
...
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "hasValue", 3138);
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3162);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "each", 3162);
_yuitest_coverline("build/yui-core/yui-core.js", 3163);
var key;

    _yuitest_coverline("build/yui-core/yui-core.js", 3165);
for (key in obj) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3166);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3167);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3171);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3194);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "some", 3194);
_yuitest_coverline("build/yui-core/yui-core.js", 3195);
var key;

    _yuitest_coverline("build/yui-core/yui-core.js", 3197);
for (key in obj) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3198);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3199);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui-core/yui-core.js", 3200);
return true;
            }
        }
    }
 ...
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3221);
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "getValue", 3221);
_yuitest_coverline("build/yui-core/yui-core.js", 3222);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3223);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3226);
var i,
        p = Y.Array(path),
        l = p.length;
...
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3231);
o = o[p[i]];
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3234);
return o;
};
...
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "setValue", 3251);
_yuitest_coverline("build/yui-core/yui-core.js", 3252);
var i,
        p = Y.Array(path),
        leafIdx = p.length - 1,
        ref = o;

    _yuitest_coverline("build/yui-core/yui-core.js", 3257);
if (leafIdx >= 0) {
...
ref = ref[p[i]];
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 3262);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3263);
ref[p[i]] = val;
        } else {
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui-core/yui-core.js", 3281);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "isEmpty", 3281);
...
*/
_yuitest_coverline("build/yui-core/yui-core.js", 3317);
YUI.Env.parseUA = function(subUA) {

    _yuitest_coverfunc("build/yui-core/yui-core.js", "parseUA", 3317);
_yuitest_coverline("build/yui-core/yui-core.js", 3319);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui-core/yui-core.js", "numberify", 3319);
_yuitest_coverline("build/yui-core/yui-core.js", 3320);
var c = 0;
            _yuitest_coverline("build/yui-core/yui-core.js", 3321);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui-core/yui-core.js", "(anonymous 22)", 3321);
_yuitest_coverline("build/yui-core/yui-core.js", 3322);
return (c++ == 1) ? '' : '.';
            }));
        },
    ...
    * @static
    */
    _yuitest_coverline("build/yui-core/yui-core.js", 3549);
o.userAgent = ua;


    _yuitest_coverline("build/yui-core/yui-core.js", 3552);
o.secure = href && (href.toLowerCase().indexOf('https') === 0);

    _yuitest_coverline("build/yui-core/yui-core.js", 3554);
if (ua) {

        _yuitest_coverline("build/yui-core/yui-core.js", 3556);
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3557);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3558);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3559);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3560);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3561);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3562);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3563);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3564);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3565);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3566);
if ((/rhino/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3567);
o.os = 'rhino';
        }}}}}}
...
if ((/KHTML/).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3572);
o.webkit = 1;
        }
        _yuitest_coverline("build/yui-core/yui-core.js", 3574);
...
m = ua.match(/AppleWebKit\/([^\s]*)/);
        _yuitest_coverline("build/yui-core/yui-core.js", 3582);
if (m && m[1]) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3583);
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui-core/yui-core.js", 3584);
o.safari = o.webkit;
...
o.phantomjs = numberify(m[1]);
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 3594);
...
if (m && m[1]) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3628);
...
if (m && m[1]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3667);
...
m = ua.replace('Opera Mobi', '').match(/Opera ([^\s]*)/);
                    _yuitest_coverline("build/yui-core/yui-core.js", 3677);
if (m && m[1]) {
...
o.mobile = m[0]; // ex: Opera Mini/2.0.4509/1316
                ...
                _yuitest_coverline("build/yui-core/yui-core.js", 3687);
m = ua.match(/MSIE\s([^;]*)/);
...
if (m && m[1]) {
                            _yuitest_coverline("build/yui-core/yui-core.js", 3696);
...
_yuitest_coverline("build/yui-core/yui-core.js", 3724);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "compareVersions", 3746);
_yuitest_coverline("build/yui-core/yui-core.js", 3747);
var aPart, aParts, bPart, bParts, i, len;

    _yuitest_coverline("build/yui-core/yui-core.js", 3749);
if (a === b) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3750);
return 0;
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3753);
aParts = (a + '').split('.');
    _yuitest_coverline("build/yui-core/yui-core.js", 3754);
bParts = (b + '').split('.');

    _yuitest_coverline("build/yui-core/yui-core.js", 3756);
for (i = 0, len = Math.max(aParts.length, bParts.length); i < len; ++i) {
        _yuitest_coverline("build/yui-core/yui-core.js", 3757);
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui-core/yui-core.js", 3758);
bPart = parseInt(bParts[i], 10);

        _yuitest_coverline("build/yui-core/yui-core.js", 3760);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui-core/yui-core.js", 3761);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui-core/yui-core.js", 3763);
if (aPart < bPart) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3764);
return -1;
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3767);
if (aPart > bPart) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3768);
return 1;
        }
    }

    _yuitest_coverline("build/yui-core/yui-core.js", 3772);
return 0;
};
