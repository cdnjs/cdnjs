...
_yuitest_coverage["build/view/view.js"].lines = {"1":0,"35":0,"36":0,"39":0,"129":0,"132":0,"135":0,"138":0,"145":0,"163":0,"168":0,"169":0,"173":0,"177":0,"178":0,"198":0,"202":0,"204":0,"206":0,"207":0,"209":0,"211":0,"212":0,"214":0,"216":0,"217":0,"220":0,"225":0,"244":0,"257":0,"258":0,"261":0,"262":0,"273":0,"274":0,"275":0,"300":0,"312":0,"313":0,"330":0,"331":0,"334":0,"335":0,"340":0,"341":0,"345":0,"363":0};
_yuitest_coverage["build/view/view.js"].functions = {"View:35":0,"initializer:128":0,"(anonymous 2):168":0,"destroy:161":0,"destructor:176":0,"attachEvents:197":0,"create:243":0,"(anonymous 3):257":0,"detachEvents:256":0,"remove:272":0,"render:299":0,"_destroyContainer:311":0,"_getContainer:325":0,"_afterContainerChange:362":0,"(anonymous 1):1":0};
_yuitest_coverage["build/view/view.js"].coveredLines = 47;
...
handler = handlers[name];
                ...
                _yuitest_coverline("build/view/view.js", 216);
if (typeof handler === 'string') {
                    _yuitest_coverline("build/view/view.js", 217);
handler = this[handler];
                }

                _yuitest_coverline("build/view/view.js", 220);
this._attachedViewEvents.push(
                    container.delegate(name, handler, selector, this));
            }
        }

        _yuitest_coverline("build/view/view.js", 225);
return this;
    },
    ...
    **/
    create: function (container) {
        _yuitest_coverfunc("build/view/view.js", "create", 243);
_yuitest_coverline("build/view/view.js", 244);
return container ? Y.one(container) :
    ...
    **/
    detachEvents: function () {
        _yuitest_coverfunc("build/view/view.js", "detachEvents", 256);
_yuitest_coverline("build/view/view.js", 257);
Y.Array.each(this._attachedViewEvents, function (handle) {
            _yuitest_coverfunc("build/view/view.js", "(anonymous 3)", 257);
_yuitest_coverline("build/view/view.js", 258);
handle.detach();
        });

        _yuitest_coverline("build/view/view.js", 261);
this._attachedViewEvents = [];
        _yuitest_coverline("build/view/view.js", 262);
return this;
    },
    ...
    **/
    remove: function () {
        _yuitest_coverfunc("build/view/view.js", "remove", 272);
_yuitest_coverline("build/view/view.js", 273);
var container = this.get('container');
        _yuitest_coverline("build/view/view.js", 274);
container && container.remove();
        _yuitest_coverline("build/view/view.js", 275);
return this;
    },
    ...
    **/
    render: function () {
        _yuitest_coverfunc("build/view/view.js", "render", 299);
_yuitest_coverline("build/view/view.js", 300);
return this;
    },
    ...
    **/
    _destroyContainer: function () {
        _yuitest_coverfunc("build/view/view.js", "_destroyContainer", 311);
_yuitest_coverline("build/view/view.js", 312);
var container = this.get('container');
        _yuitest_coverline("build/view/view.js", 313);
container && container.remove(true);
    ...
    **/
    _getContainer: function (value) {
        ...
        _yuitest_coverfunc("build/view/view.js", "_getContainer", 325);
_yuitest_coverline("build/view/view.js", 330);
if (!this._container) {
            _yuitest_coverline("build/view/view.js", 331);
if (value) {
                // Attach events to the container when it's specified via a
                // valueFn, which won't fire the containerChange event.
                _yuitest_coverline("build/view/view.js", 334);
this._container = value;
                _yuitest_coverline("build/view/view.js", 335);
this.attachEvents();
            } else {
                // Create a default container and set that as the new attribute
                // value. The `this._container` property prevents infinite
                // recursion.
                _yuitest_coverline("build/view/view.js", 340);
value = this._container = this.create();
                _yuitest_coverline("build/view/view.js", 341);
this._set('container', value);
            }
        }

        _yuitest_coverline("build/view/view.js", 345);
return value;
    },
    ...
    **/
    _afterContainerChange: function () {
        _yuitest_coverfunc("build/view/view.js", "_afterContainerChange", 362);
_yuitest_coverline("build/view/view.js", 363);
