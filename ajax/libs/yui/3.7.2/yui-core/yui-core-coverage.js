...
if ((/windows|win32/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3564);
o.os = 'windows';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3565);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3566);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3567);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3568);
o.os = 'android';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3569);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3570);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3571);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3572);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui-core/yui-core.js", 3573);
if ((/rhino/i).test(ua)) {
...
if (m && m[1]) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3590);
o.webkit = numberify(m[1]);
            _yuitest_coverline("build/yui-core/yui-core.js", 3591);
o.safari = o.webkit;
            
            _yuitest_coverline("build/yui-core/yui-core.js", 3593);
...
o.mobile = 'Apple'; // iPhone or iPod Touch
                ...
                _yuitest_coverline("build/yui-core/yui-core.js", 3604);
m = ua.match(/OS ([^\s]*)/);
...
if (m && m[0]) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3614);
...
o.silk = numberify(m[1]);
                    ...
                    _yuitest_coverline("build/yui-core/yui-core.js", 3644);
if (!o.android) {
                        _yuitest_coverline("build/yui-core/yui-core.js", 3645);
...
o.accel = true;
            ...
            _yuitest_coverline("build/yui-core/yui-core.js", 3654);
...
if (/Opera Mobi/.test(ua)) {
                    _yuitest_coverline("build/yui-core/yui-core.js", 3682);
o.mobile = 'opera';
...
if (!subUA) {
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 3714);
...
o.nodejs = numberify(process.versions.node);
        ...
        _yuitest_coverline("build/yui-core/yui-core.js", 3723);
YUI.Env.UA = o;
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui-core/yui-core.js", "compareVersions", 3753);
...
aPart = parseInt(aParts[i], 10);
        _yuitest_coverline("build/yui-core/yui-core.js", 3765);
bPart = parseInt(bParts[i], 10);
...
if (aPart < bPart) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3771);
return -1;
        }

        _yuitest_coverline("build/yui-core/yui-core.js", 3774);
if (aPart > bPart) {
            _yuitest_coverline("build/yui-core/yui-core.js", 3775);
return 1;
        }
    }
