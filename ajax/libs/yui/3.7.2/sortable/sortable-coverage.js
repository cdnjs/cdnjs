...
_yuitest_coverage["build/sortable/sortable.js"].lines = {"1":0,"16":0,"17":0,"30":0,"44":0,"55":0,"56":0,"58":0,"60":0,"62":0,"67":0,"72":0,"74":0,"81":0,"82":0,"87":0,"88":0,"89":0,"90":0,"93":0,"102":0,"105":0,"107":0,"117":0,"118":0,"120":0,"121":0,"124":0,"125":0,"127":0,"130":0,"131":0,"133":0,"134":0,"136":0,"138":0,"139":0,"140":0,"141":0,"143":0,"145":0,"147":0,"148":0,"151":0,"153":0,"154":0,"157":0,"160":0,"161":0,"163":0,"165":0,"166":0,"168":0,"169":0,"170":0,"171":0,"176":0,"178":0,"181":0,"182":0,"191":0,"193":0,"194":0,"196":0,"197":0,"206":0,"207":0,"211":0,"222":0,"223":0,"225":0,"227":0,"235":0,"236":0,"239":0,"240":0,"241":0,"257":0,"258":0,"259":0,"261":0,"262":0,"264":0,"265":0,"267":0,"268":0,"271":0,"280":0,"281":0,"290":0,"291":0,"300":0,"309":0,"318":0,"320":0,"321":0,"322":0,"326":0,"327":0,"329":0,"415":0,"416":0,"417":0,"419":0,"421":0,"430":0,"432":0,"433":0,"434":0,"435":0,"437":0,"438":0,"439":0,"442":0,"452":0,"453":0,"455":0,"465":0,"466":0,"468":0,"469":0,"470":0,"472":0,"473":0,"474":0,"480":0};
_yuitest_coverage["build/sortable/sortable.js"].functions = {"Sortable:16":0,"initializer:43":0,"_onDrag:86":0,"_onDropEnter:101":0,"_onDragOver:116":0,"_onDragStart:190":0,"_onDragEnd:205":0,"plug:220":0,"sync:234":0,"destructor:238":0,"join:256":0,"_join_none:279":0,"_join_full:289":0,"_join_outer:299":0,"_join_inner:308":0,"callback:321":0,"(anonymous 2):326":0,"getOrdering:317":0,"_test:414":0,"(anonymous 3):437":0,"getSortable:429":0,"reg:451":0,"(anonymous 4):472":0,"unreg:464":0,"(anonymous 1):1":0};
...
sel.delegate.dd.addToGroup(this.get(ID));
        ...
        */
        getOrdering: function(callback) {
            _yuitest_coverfunc("build/sortable/sortable.js", "getOrdering", 317);
_yuitest_coverline("build/sortable/sortable.js", 318);
var ordering = [];

            _yuitest_coverline("build/sortable/sortable.js", 320);
if (!Y.Lang.isFunction(callback)) {
                _yuitest_coverline("build/sortable/sortable.js", 321);
callback = function (node) {
                    _yuitest_coverfunc("build/sortable/sortable.js", "callback", 321);
...
Y.one(this.get(CONT)).all(this.get(NODES)).each(function(node) {
                _yuitest_coverfunc("build/sortable/sortable.js", "(anonymous 2)", 326);
_yuitest_coverline("build/sortable/sortable.js", 327);
ordering.push(callback(node));
            });
            _yuitest_coverline("build/sortable/sortable.js", 329);
return ordering;
       }
    }, {
        NAME: 'sortable',
        ...
        */
        _test: function(node, test) {
            _yuitest_coverfunc("build/sortable/sortable.js", "_test", 414);
...
ret = (test === node);
                ...
                _yuitest_coverline("build/sortable/sortable.js", 419);
ret = node.test(test);
            }
            _yuitest_coverline("build/sortable/sortable.js", 421);
return ret;
        },
        /**
        * @static
        ...
        */
        getSortable: function(node) {
            _yuitest_coverfunc("build/sortable/sortable.js", "getSortable", 429);
...
return Y.Sortable._sortables[id];
            ...
            _yuitest_coverline("build/sortable/sortable.js", 437);
Y.Object.each(Y.Sortable._sortables, function(v) {
                _yuitest_coverfunc("build/sortable/sortable.js", "(anonymous 3)", 437);
...
return s;
        ...
        */
        reg: function(s, id) {
            _yuitest_coverfunc("build/sortable/sortable.js", "reg", 451);
_yuitest_coverline("build/sortable/sortable.js", 452);
if (!id) {
                _yuitest_coverline("build/sortable/sortable.js", 453);
id = s.get(ID);
            }
            _yuitest_coverline("build/sortable/sortable.js", 455);
Y.Sortable._sortables[id] = s;
        ...
        */
        unreg: function(s, id) {
            _yuitest_coverfunc("build/sortable/sortable.js", "unreg", 464);
_yuitest_coverline("build/sortable/sortable.js", 465);
if (!id) {
                _yuitest_coverline("build/sortable/sortable.js", 466);
id = s.get(ID);
            }
            _yuitest_coverline("build/sortable/sortable.js", 468);
if (id && Y.Sortable._sortables[id]) {
...
return;
            ...
            _yuitest_coverline("build/sortable/sortable.js", 472);
Y.Object.each(Y.Sortable._sortables, function(v, k) {
                _yuitest_coverfunc("build/sortable/sortable.js", "(anonymous 4)", 472);
...
delete Sortable._sortables[k];
    ...
    _yuitest_coverline("build/sortable/sortable.js", 480);
Y.Sortable = Sortable;
