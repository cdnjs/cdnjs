...
_yuitest_coverage["build/series-marker/series-marker.js"].lines = {"1":0,"20":0,"30":0,"44":0,"46":0,"48":0,"49":0,"63":0,"64":0};
_yuitest_coverage["build/series-marker/series-marker.js"].functions = {"drawSeries:28":0,"_setStyles:42":0,"_getDefaultStyles:61":0,"(anonymous 1):1":0};
_yuitest_coverage["build/series-marker/series-marker.js"].coveredLines = 9;
_yuitest_coverage["build/series-marker/series-marker.js"].coveredFunctions = 4;
...
Y.MarkerSeries = Y.Base.create("markerSeries", Y.CartesianSeries, [Y.Plots], {
    ...
    drawSeries: function()
    {
        _yuitest_coverfunc("build/series-marker/series-marker.js", "drawSeries", 28);
_yuitest_coverline("build/series-marker/series-marker.js", 30);
this.drawPlots();
    },
    ...
    {
        _yuitest_coverfunc("build/series-marker/series-marker.js", "_setStyles", 42);
_yuitest_coverline("build/series-marker/series-marker.js", 44);
if(!val.marker)
        {
            _yuitest_coverline("build/series-marker/series-marker.js", 46);
val = {marker:val};
        }
        _yuitest_coverline("build/series-marker/series-marker.js", 48);
val = this._parseMarkerStyles(val);
        _yuitest_coverline("build/series-marker/series-marker.js", 49);
return Y.MarkerSeries.superclass._mergeStyles.apply(this, [val, this._getDefaultStyles()]);
    ...
    {
        _yuitest_coverfunc("build/series-marker/series-marker.js", "_getDefaultStyles", 61);
_yuitest_coverline("build/series-marker/series-marker.js", 63);
var styles = this._mergeStyles({marker:this._getPlotDefaults()}, Y.MarkerSeries.superclass._getDefaultStyles());
        _yuitest_coverline("build/series-marker/series-marker.js", 64);
return styles;
    }
},{
    ATTRS : {
...
}, '@VERSION@', {"requires": ["series-plot-util"]});
