    ...
    ATTRS: {
        ...
        listNode: {
            setter: function(node) {
                _yuitest_coverfunc("build/tabview/tabview.js", "setter", 150);
...
return node;
        ...
        panelNode: {
            setter: function(node) {
                _yuitest_coverfunc("build/tabview/tabview.js", "setter", 162);
...
Y.Tab = Y.Base.create('tab', Y.Widget, [Y.WidgetChild], {
    ...
    _uiSetSelectedPanel: function(selected) {
        _yuitest_coverfunc("build/tabview/tabview.js", "_uiSetSelectedPanel", 203);
_yuitest_coverline("build/tabview/tabview.js", 204);
this.get('panelNode').toggleClass(_classNames.selectedPanel, selected);
    },

    _afterTabSelectedChange: function(event) {
       _yuitest_coverfunc("build/tabview/tabview.js", "_afterTabSelectedChange", 207);
_yuitest_coverline("build/tabview/tabview.js", 208);
this._uiSetSelectedPanel(event.newVal);
    },

    _afterParentChange: function(e) {
        _yuitest_coverfunc("build/tabview/tabview.js", "_afterParentChange", 211);
_yuitest_coverline("build/tabview/tabview.js", 212);
if (!e.newVal) {
            _yuitest_coverline("build/tabview/tabview.js", 213);
this._remove();
        } else {
...
this._add();
    ...
    _initAria: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_initAria", 219);
...
anchor.set('role', 'tab');
        _yuitest_coverline("build/tabview/tabview.js", 230);
anchor.get('parentNode').set('role', 'presentation');
 
 
        //  Apply the ARIA roles, states and properties to each panel
        _yuitest_coverline("build/tabview/tabview.js", 234);
panel.setAttrs({
            role: 'tabpanel',
            'aria-labelledby': id
        });
    ...
    syncUI: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "syncUI", 240);
...
this._uiSetSelectedPanel(this.get('selected'));
    ...
    bindUI: function() {
       _yuitest_coverfunc("build/tabview/tabview.js", "bindUI", 246);
_yuitest_coverline("build/tabview/tabview.js", 247);
this.after('selectedChange', this._afterTabSelectedChange);
       _yuitest_coverline("build/tabview/tabview.js", 248);
this.after('parentChange', this._afterParentChange);
    },

    renderUI: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "renderUI", 251);
...
this._initAria();
    ...
    _renderPanel: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_renderPanel", 256);
...
this.get('parent').get('panelNode')
    ...
    _add: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_add", 261);
...
if (panel) {
            _yuitest_coverline("build/tabview/tabview.js", 271);
panel.appendChild(this.get('panelNode'));
        }
    },
    
    _remove: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_remove", 275);
...
this.get('panelNode').remove();
    ...
    _onActivate: function(e) {
         _yuitest_coverfunc("build/tabview/tabview.js", "_onActivate", 280);
...
e.domEvent.preventDefault();
             _yuitest_coverline("build/tabview/tabview.js", 285);
e.target.set('selected', 1);
         }
    },
    
    initializer: function() {
       _yuitest_coverfunc("build/tabview/tabview.js", "initializer", 289);
_yuitest_coverline("build/tabview/tabview.js", 290);
this.publish(this.get('triggerEvent'), {
    ...
    _defLabelSetter: function(label) {
        _yuitest_coverfunc("build/tabview/tabview.js", "_defLabelSetter", 295);
_yuitest_coverline("build/tabview/tabview.js", 296);
...
return label;
    ...
    _defContentSetter: function(content) {
        _yuitest_coverfunc("build/tabview/tabview.js", "_defContentSetter", 300);
_yuitest_coverline("build/tabview/tabview.js", 301);
this.get('panelNode').setContent(content);
        _yuitest_coverline("build/tabview/tabview.js", 302);
return content;
    },

    _defContentGetter: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_defContentGetter", 305);
...
return this.get('panelNode').getContent();
    ...
    _defPanelNodeValueFn: function() {
        _yuitest_coverfunc("build/tabview/tabview.js", "_defPanelNodeValueFn", 310);
...
return panel;
    ...
    ATTRS: {
        ...
        panelNode: {
            setter: function(node) {
                _yuitest_coverfunc("build/tabview/tabview.js", "setter", 370);
_yuitest_coverline("build/tabview/tabview.js", 371);
node = Y.one(node);
                _yuitest_coverline("build/tabview/tabview.js", 372);
if (node) {
                    _yuitest_coverline("build/tabview/tabview.js", 373);
...
return node;
    ...
    HTML_PARSER: {
        selected: function() {
            _yuitest_coverfunc("build/tabview/tabview.js", "selected", 388);
_yuitest_coverline("build/tabview/tabview.js", 389);
var ret = (this.get('boundingBox').hasClass(_classNames.selectedTab)) ?
                        1 : 0;
            _yuitest_coverline("build/tabview/tabview.js", 391);
return ret;
        }
    }
