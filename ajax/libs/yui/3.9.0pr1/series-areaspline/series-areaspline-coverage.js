...
_yuitest_coverline("build/series-areaspline/series-areaspline.js", 20);
Y.AreaSplineSeries = Y.Base.create("areaSplineSeries", Y.AreaSeries, [Y.CurveUtil], {
    ...
    drawSeries: function()
    {
        _yuitest_coverfunc("build/series-areaspline/series-areaspline.js", "drawSeries", 28);
_yuitest_coverline("build/series-areaspline/series-areaspline.js", 30);
this.drawAreaSpline();
    }
}, {
	ATTRS : {
