...
_yuitest_coverage["build/graphics/graphics.js"].lines = {"1":0,"32":0,"50":0,"52":0,"55":0,"57":0,"58":0,"59":0,"62":0,"72":0,"78":0,"80":0,"82":0,"83":0,"85":0,"87":0,"89":0,"90":0,"92":0,"96":0,"101":0,"102":0,"104":0,"106":0,"107":0,"109":0,"112":0,"114":0,"117":0,"119":0,"121":0,"125":0,"141":0,"144":0,"146":0,"147":0,"149":0,"151":0,"153":0,"156":0,"158":0,"172":0,"174":0,"176":0,"178":0,"180":0,"186":0,"202":0,"206":0,"208":0,"209":0,"211":0,"212":0,"214":0,"218":0,"221":0,"225":0,"226":0,"237":0,"239":0,"241":0,"242":0,"245":0,"246":0,"247":0,"248":0,"249":0,"250":0,"252":0,"254":0,"257":0,"259":0,"269":0,"272":0,"273":0,"287":0,"291":0,"292":0,"293":0,"294":0,"295":0,"296":0};
_yuitest_coverage["build/graphics/graphics.js"].functions = {"AttributeLite:50":0,"addAttrs:70":0,"get:139":0,"set:170":0,"_set:200":0,"GraphicBase:237":0,"init:267":0,"_camelCaseConcat:285":0,"(anonymous 1):1":0};
...
var attr = arguments[0],
                i;
            _yuitest_coverline("build/graphics/graphics.js", 174);
if(Y_LANG.isObject(attr))
            {
                _yuitest_coverline("build/graphics/graphics.js", 176);
for(i in attr)
                {
                    _yuitest_coverline("build/graphics/graphics.js", 178);
if(attr.hasOwnProperty(i))
                    {
                        _yuitest_coverline("build/graphics/graphics.js", 180);
this._set(i, attr[i]);
                    }
                }
            }
            ...
            {
                _yuitest_coverline("build/graphics/graphics.js", 186);
this._set.apply(this, arguments);
		...
		{
			_yuitest_coverfunc("build/graphics/graphics.js", "_set", 200);
_yuitest_coverline("build/graphics/graphics.js", 202);
var host = this,
				setter,
				args,
				attrConfig = host.constructor.ATTRS;
			_yuitest_coverline("build/graphics/graphics.js", 206);
...
setter = attrConfig[attr].setter;
				_yuitest_coverline("build/graphics/graphics.js", 209);
if(setter)
				{
					_yuitest_coverline("build/graphics/graphics.js", 211);
args = [val];
					_yuitest_coverline("build/graphics/graphics.js", 212);
if(typeof setter === STR)
					{
						_yuitest_coverline("build/graphics/graphics.js", 214);
val = host[setter].apply(host, args);
					}
					else
                    {
                        _yuitest_coverline("build/graphics/graphics.js", 218);
val = attrConfig[attr].setter.apply(host, args);
                    }
				}
				_yuitest_coverline("build/graphics/graphics.js", 221);
...
Y.mix(AttributeLite, Y.EventTarget, false, null, 1);
	_yuitest_coverline("build/graphics/graphics.js", 226);
Y.AttributeLite = AttributeLite;
     ...
     */
    _yuitest_coverline("build/graphics/graphics.js", 237);
GraphicBase = function(cfg)
    {
        _yuitest_coverfunc("build/graphics/graphics.js", "GraphicBase", 237);
_yuitest_coverline("build/graphics/graphics.js", 239);
var host = this,
            PluginHost = Y.Plugin && Y.Plugin.Host;
        _yuitest_coverline("build/graphics/graphics.js", 241);
if (host._initPlugins && PluginHost) {
            _yuitest_coverline("build/graphics/graphics.js", 242);
...
host.init.apply(this, arguments);
        _yuitest_coverline("build/graphics/graphics.js", 250);
if (host._initPlugins) {
            // Need to initPlugins manually, to handle constructor parsing, static Plug parsing
            _yuitest_coverline("build/graphics/graphics.js", 252);
host._initPlugins(cfg);
        }
        _yuitest_coverline("build/graphics/graphics.js", 254);
host.initialized = true;
    };

    _yuitest_coverline("build/graphics/graphics.js", 257);
GraphicBase.NAME = "baseGraphic";

    _yuitest_coverline("build/graphics/graphics.js", 259);
GraphicBase.prototype = {
        ...
        init: function()
        {
            _yuitest_coverfunc("build/graphics/graphics.js", "init", 267);
_yuitest_coverline("build/graphics/graphics.js", 269);
this.publish("init", {
                fireOnce:true
            });
            _yuitest_coverline("build/graphics/graphics.js", 272);
this.initializer.apply(this, arguments);
            _yuitest_coverline("build/graphics/graphics.js", 273);
this.fire("init", {cfg: arguments[0]});
        ...
        {
            _yuitest_coverfunc("build/graphics/graphics.js", "_camelCaseConcat", 285);
_yuitest_coverline("build/graphics/graphics.js", 287);
...
_yuitest_coverline("build/graphics/graphics.js", 296);
