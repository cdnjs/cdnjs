...
switch (method) {
                ...
                case 'HEAD':
                case 'DELETE':
                    _yuitest_coverline("build/io-base/io-base.js", 677);
u = io._concat(u, data);
                    _yuitest_coverline("build/io-base/io-base.js", 678);
data = '';
                    _yuitest_coverline("build/io-base/io-base.js", 679);
break;
                case 'POST':
                case 'PUT':
                    // If Content-Type is defined in the configuration object, or
...
break;
        ...
        _yuitest_coverline("build/io-base/io-base.js", 692);
if (transaction.xdr) {
            // Route data to io-xdr module for flash and XDomainRequest.
            _yuitest_coverline("build/io-base/io-base.js", 694);
return io.xdr(u, transaction, config);
        }
        else {_yuitest_coverline("build/io-base/io-base.js", 696);
if (transaction.notify) {
...
return transaction.c.send(transaction, uri, config);
        ...
        _yuitest_coverline("build/io-base/io-base.js", 701);
if (!sync && !transaction.upload) {
            _yuitest_coverline("build/io-base/io-base.js", 702);
transaction.c.onreadystatechange = function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "onreadystatechange", 702);
...
io.start(transaction, config);
            ...
            _yuitest_coverline("build/io-base/io-base.js", 716);
...
response.getAllResponseHeaders = function() {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getAllResponseHeaders", 732);
...
response.getResponseHeader = function(name) {
                    _yuitest_coverfunc("build/io-base/io-base.js", "getResponseHeader", 736);
_yuitest_coverline("build/io-base/io-base.js", 737);
return transaction.c.getResponseHeader(name);
                };

                _yuitest_coverline("build/io-base/io-base.js", 740);
io.complete(transaction, config);
...
if (config.timeout) {
            _yuitest_coverline("build/io-base/io-base.js", 763);
io._startTimeout(transaction, config.timeout);
        }

        _yuitest_coverline("build/io-base/io-base.js", 766);
return {
            id: transaction.id,
            abort: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "abort", 768);
_yuitest_coverline("build/io-base/io-base.js", 769);
return transaction.c ? io._abort(transaction, 'abort') : false;
            },
            isInProgress: function() {
                _yuitest_coverfunc("build/io-base/io-base.js", "isInProgress", 771);
_yuitest_coverline("build/io-base/io-base.js", 772);
...
Y.io = function(url, config) {
    ...
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "io", 884);
_yuitest_coverline("build/io-base/io-base.js", 887);
var transaction = Y.io._map['io:0'] || new IO();
    _yuitest_coverline("build/io-base/io-base.js", 888);
...
Y.io.header = function(name, value) {
    // Calling IO through the static interface will use and reuse
    // an instance of IO.
    _yuitest_coverfunc("build/io-base/io-base.js", "header", 902);
...
_yuitest_coverline("build/io-base/io-base.js", 909);
Y.IO = IO;
// Map of all IO instances created.
_yuitest_coverline("build/io-base/io-base.js", 911);
Y.io._map = {};
...
_yuitest_coverline("build/io-base/io-base.js", 921);
Y.mix(Y.IO, {
    /**
    ...
    */
    defaultTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "defaultTransport", 936);
_yuitest_coverline("build/io-base/io-base.js", 937);
if (id) {
            _yuitest_coverline("build/io-base/io-base.js", 938);
Y.IO._default = id;
        } else {
...
var o = {
            ...
            _yuitest_coverline("build/io-base/io-base.js", 944);
return o;
        }
    },
    /**
    ...
    */
    transports: {
        xhr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xhr", 954);
_yuitest_coverline("build/io-base/io-base.js", 955);
return XHR ? new XMLHttpRequest() :
                AX ? new ActiveXObject('Microsoft.XMLHTTP') : null;
        },
        xdr: function () {
            _yuitest_coverfunc("build/io-base/io-base.js", "xdr", 958);
_yuitest_coverline("build/io-base/io-base.js", 959);
return XDR ? new XDomainRequest() : null;
        },
        iframe: function () { _yuitest_coverfunc("build/io-base/io-base.js", "iframe", 961);
...
return {}; },
    ...
    */
    customTransport: function(id) {
        _yuitest_coverfunc("build/io-base/io-base.js", "customTransport", 971);
_yuitest_coverline("build/io-base/io-base.js", 972);
var o = { c: Y.IO.transports[id]() };

        _yuitest_coverline("build/io-base/io-base.js", 974);
...
_yuitest_coverline("build/io-base/io-base.js", 979);
Y.mix(Y.IO.prototype, {
    ...
    */
    notify: function(event, transaction, config) {
        _yuitest_coverfunc("build/io-base/io-base.js", "notify", 988);
...
switch (event) {
            ...
            case 'transport error':
                _yuitest_coverline("build/io-base/io-base.js", 995);
transaction.c = { status: 0, statusText: event };
                _yuitest_coverline("build/io-base/io-base.js", 996);
event = 'failure';
            default:
                _yuitest_coverline("build/io-base/io-base.js", 998);
