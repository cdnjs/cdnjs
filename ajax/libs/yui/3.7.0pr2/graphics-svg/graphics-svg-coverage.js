...
return this.node;
    ...
    data: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2073);
...
return val;
	...
	graphic: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2093);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2095);
return this._graphic;
		}
	}
};
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2099);
Y.SVGShape = SVGShape;
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGPath", 2112);
...
SVGPath.ATTRS = Y.merge(Y.SVGShape.ATTRS, {
	...
	path: {
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2185);
...
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2218);
Y.SVGPath = SVGPath;
/**
...
SVGRect = function()
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGRect", 2229);
...
SVGRect.NAME = "rect";
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2234);
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGEllipse", 2256);
...
Y.extend(SVGEllipse, SVGShape, {
	...
	_draw: function()
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2279);
...
SVGEllipse.ATTRS = Y.merge(SVGShape.ATTRS, {
	...
	xRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2308);
...
this.set("width", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2313);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2315);
var val = this.get("width");
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2316);
if(val) 
			{
...
return val;
	...
	yRadius: {
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2332);
...
this.set("height", val * 2);
		...
		getter: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2337);
...
SVGCircle = function(cfg)
 {
    _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGCircle", 2359);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2361);
SVGCircle.superclass.constructor.apply(this, arguments);
 };
    
 _yuitest_coverline("build/graphics-svg/graphics-svg.js", 2364);
...
Y.extend(SVGCircle, Y.SVGShape, {    
    ...
    _draw: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2383);
...
SVGCircle.ATTRS = Y.merge(Y.SVGShape.ATTRS, {
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2408);
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2414);
...
return this.get("radius") * 2;
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2427);
...
return val;
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2433);
...
{
	_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGPieSlice", 2457);
...
Y.extend(SVGPieSlice, Y.SVGShape, Y.mix({
	...
	_draw: function(e)
	{
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_draw", 2478);
...
this.clear();
        _yuitest_coverline("build/graphics-svg/graphics-svg.js", 2486);
...
SVGGraphic = function(cfg) {
    _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "SVGGraphic", 2539);
...
SVGGraphic.ATTRS = {
	...
	id: {
		valueFn: function()
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "valueFn", 2561);
...
return Y.guid();
		...
		setter: function(val)
		{
			_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2566);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2568);
var node = this._node;
			_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2569);
if(node)
			{
...
return val;
    ...
    shapes: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2587);
...
return this._shapes;
    ...
    contentBounds: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2603);
...
return this._contentBounds;
    ...
    node: {
        ...
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2619);
...
return this._node;
    ...
    width: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2632);
...
return val; 
    ...
    height: {
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2649);
...
return val;
    ...
    x: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2723);
...
return this._x;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2728);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2730);
this._x = val;
            _yuitest_coverline("build/graphics-svg/graphics-svg.js", 2731);
if(this._node)
            {
...
return val;
    ...
    y: {
        getter: function()
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getter", 2746);
...
return this._y;
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2751);
_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2753);
this._y = val;
...
return val;
    ...
    visible: {
        ...
        setter: function(val)
        {
            _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "setter", 2778);
...
Y.extend(SVGGraphic, Y.GraphicBase, {
	...
	{
		_yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "set", 2806);
...
var host = this,
            ...
            key,
            forceRedraw = false;
		_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2817);
AttributeLite.prototype.set.apply(host, arguments);	
...
forceRedraw = true;
            ...
            else {_yuitest_coverline("build/graphics-svg/graphics-svg.js", 2824);
...
host._redraw();
    ...
    getXY: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getXY", 2866);
...
return xy;
    ...
    initializer: function() {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "initializer", 2883);
...
this.render(render);
    ...
    render: function(render) {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "render", 2915);
...
return this;
    ...
    destroy: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "destroy", 2932);
...
this._node = null;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "addShape", 2959);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_appendShape", 2979);
...
this._getDocFrag().appendChild(node);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "removeShape", 2999);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "removeAllShapes", 3025);
...
this._shapes = {};
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_removeChildren", 3046);
...
node.removeChild(child);
     ...
     */
    clear: function() {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "clear", 3065);
...
this.removeAllShapes();
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_toggleVisible", 3076);
...
this._node.style.visibility = visibility;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_getShapeClass", 3109);
...
return val;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getShapeById", 3141);
...
return shape;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "batch", 3153);
...
this.set("autoDraw", autoDraw);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_getDocFrag", 3168);
...
return this._frag;
    ...
    _redraw: function()
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_redraw", 3183);
...
this._frag = null;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "addToRedrawQueue", 3259);
...
this._redraw();
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_getUpdatedContentBounds", 3289);
...
return box;
    ...
    _createGraphics: function() {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_createGraphics", 3322);
...
return contentNode;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_createGraphicNode", 3343);
...
return node;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "getGradientNode", 3363);
...
return gradient;
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_toFront", 3399);
...
contentNode.appendChild(shape);
    ...
    {
        _yuitest_coverfunc("build/graphics-svg/graphics-svg.js", "_toBack", 3419);
