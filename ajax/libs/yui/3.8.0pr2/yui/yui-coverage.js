...
if (doc.body) {
                _yuitest_coverline("build/yui/yui.js", 471);
doc.body.appendChild(YUI.Env.cssStampEl);
            } else {
                _yuitest_coverline("build/yui/yui.js", 473);
...
filter = (filter) ? '-' + filter : filter;
        _yuitest_coverline("build/yui/yui.js", 485);
Y.config.loaderPath = YUI.config.loaderPath || 'loader/loader' + filter + '.js';
     ...
     */
    _setup: function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "_setup", 495);
_yuitest_coverline("build/yui/yui.js", 496);
var i, Y = this,
            core = [],
            mods = YUI.Env.mods,
...
if (mods[extras[i]]) {
                _yuitest_coverline("build/yui/yui.js", 503);
core.push(extras[i]);
            }
        }
...
Y._attach(['yui-base']);
        _yuitest_coverline("build/yui/yui.js", 508);
Y._attach(core);

        _yuitest_coverline("build/yui/yui.js", 510);
if (Y.Loader) {
            _yuitest_coverline("build/yui/yui.js", 511);
getLoader(Y);
        }
...
if (!m) {
                    _yuitest_coverline("build/yui/yui.js", 539);
...
*/
    add: function(name, fn, version, details) {
        _yuitest_coverfunc("build/yui/yui.js", "add", 583);
_yuitest_coverline("build/yui/yui.js", 584);
details = details || {};
        _yuitest_coverline("build/yui/yui.js", 585);
var env = YUI.Env,
            mod = {
                name: name,
                fn: fn,
...
versions[version] = versions[version] || {};
        _yuitest_coverline("build/yui/yui.js", 599);
...
loader.addModule(details, name);
        ...
        _yuitest_coverline("build/yui/yui.js", 616);
return this;
    },
    ...
    _attach: function(r, moot) {
        _yuitest_coverfunc("build/yui/yui.js", "_attach", 627);
...
if (go) {
                            _yuitest_coverline("build/yui/yui.js", 650);
c.push(def.name);
                        }
                    }
                }
...
r = c;
        _yuitest_coverline("build/yui/yui.js", 657);
len = r.length;
...
name = r[i];
                _yuitest_coverline("build/yui/yui.js", 662);
mod = mods[name];
...
Y._attach(aliases[name]);
                    _yuitest_coverline("build/yui/yui.js", 666);
continue;
                }
...
Y.Env._missed = Y.Array.dedupe(Y.Env._missed);
                            _yuitest_coverline("build/yui/yui.js", 681);
Y.message('NOT loaded: ' + name, 'warn', 'yui');
                        }
                    }
                } else {
                    _yuitest_coverline("build/yui/yui.js", 685);
done[name] = true;
...
use = details.use;
                    _yuitest_coverline("build/yui/yui.js", 713);
after = details.after;
...
if (!Y._attach(req)) {
                                    _yuitest_coverline("build/yui/yui.js", 724);
return false;
                                }
...
if (!Y._attach(after, true)) {
                                    _yuitest_coverline("build/yui/yui.js", 735);
return false;
                                }
...
return true;
    ...
    */
    _delayCallback: function(cb, until) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_delayCallback", 781);
...
return function() {
            _yuitest_coverfunc("build/yui/yui.js", "(anonymous 3)", 792);
_yuitest_coverline("build/yui/yui.js", 793);
var args = arguments;
            _yuitest_coverline("build/yui/yui.js", 794);
Y._use(mod, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 4)", 794);
_yuitest_coverline("build/yui/yui.js", 795);
Y.on(until.event, function() {
                    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 5)", 795);
_yuitest_coverline("build/yui/yui.js", 796);
args[1].delayUntil = until.event;
                    _yuitest_coverline("build/yui/yui.js", 797);
cb.apply(Y, args);
                }, until.args);
            });
        };
     ...
     */
    use: function() {
        _yuitest_coverfunc("build/yui/yui.js", "use", 851);
_yuitest_coverline("build/yui/yui.js", 852);
...
if (Y.config.delayUntil) {
                _yuitest_coverline("build/yui/yui.js", 865);
callback = Y._delayCallback(callback, Y.config.delayUntil);
            }
        } else {
            _yuitest_coverline("build/yui/yui.js", 868);
callback = null;
        }
        _yuitest_coverline("build/yui/yui.js", 870);
if (Y.Lang.isArray(args[0])) {
            _yuitest_coverline("build/yui/yui.js", 871);
args = args[0];
        }
...
provisioned = false;
                    _yuitest_coverline("build/yui/yui.js", 878);
break;
                }
            }
...
if (provisioned) {
                _yuitest_coverline("build/yui/yui.js", 883);
if (args.length) {
                }
                _yuitest_coverline("build/yui/yui.js", 885);
Y._notify(callback, ALREADY_DONE, args);
                _yuitest_coverline("build/yui/yui.js", 886);
return Y;
            }
        }
...
Y._useQueue = Y._useQueue || new Y.Queue();
            _yuitest_coverline("build/yui/yui.js", 892);
Y._useQueue.add([args, callback]);
        } else {
            _yuitest_coverline("build/yui/yui.js", 894);
Y._use(args, function(Y, response) {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 6)", 894);
_yuitest_coverline("build/yui/yui.js", 895);
...
this.error('use callback error', e, args);
    ...
    */
    _use: function(args, callback) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "_use", 939);
...
this._attach(['yui-base']);
        ...
        _yuitest_coverline("build/yui/yui.js", 945);
var len, loader, handleBoot, handleRLS,
            ...
            process = function(names, skip) {
                ...
                _yuitest_coverfunc("build/yui/yui.js", "process", 962);
...
a = [].concat(a, aliases[names[i]]);
                            ...
                            _yuitest_coverline("build/yui/yui.js", 976);
a.push(names[i]);
                        }
                    }
                    _yuitest_coverline("build/yui/yui.js", 979);
names = a;
                }
                
                _yuitest_coverline("build/yui/yui.js", 982);
len = names.length;
...
if (!skip) {
                        _yuitest_coverline("build/yui/yui.js", 987);
r.push(name);
                    }
...
req = null;
                    _yuitest_coverline("build/yui/yui.js", 997);
use = null;
...
req = m.details.requires;
                        _yuitest_coverline("build/yui/yui.js", 1002);
use = m.details.use;
                    } else {
...
if (!G_ENV._loaded[VERSION][name]) {
                            _yuitest_coverline("build/yui/yui.js", 1007);
missing.push(name);
                        } else {
                            _yuitest_coverline("build/yui/yui.js", 1009);
...
process(use, 1);
            ...
            handleLoader = function(fromLoader) {
                _yuitest_coverfunc("build/yui/yui.js", "handleLoader", 1026);
...
Y._use(missing, function() {
                        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 7)", 1053);
...
if (mods.hasOwnProperty(i)) {
                    _yuitest_coverline("build/yui/yui.js", 1079);
args.push(i);
                }
            }
...
loader.insert(null, (fetchCSS) ? null : 'js');
        ...
        } else {_yuitest_coverline("build/yui/yui.js", 1128);
...
handleBoot = function() {
                _yuitest_coverfunc("build/yui/yui.js", "handleBoot", 1132);
...
if (G_ENV._bootstrapping) {
                _yuitest_coverline("build/yui/yui.js", 1143);
...
handleLoader();
        ...
        _yuitest_coverline("build/yui/yui.js", 1158);
return Y;
    },
    ...
    **/
    namespace: function() {
        _yuitest_coverfunc("build/yui/yui.js", "namespace", 1195);
...
o = o[arg]; //Reset base object to the new object so it's returned
        ...
        _yuitest_coverline("build/yui/yui.js", 1212);
return o;
    },
    ...
    dump: function (o) { _yuitest_coverfunc("build/yui/yui.js", "dump", 1219);
_yuitest_coverline("build/yui/yui.js", 1219);
return ''+o; },
    ...
    error: function(msg, e, src) {
        ...
        _yuitest_coverfunc("build/yui/yui.js", "error", 1234);
_yuitest_coverline("build/yui/yui.js", 1237);
var Y = this, ret;

        _yuitest_coverline("build/yui/yui.js", 1239);
if (Y.config.errorFn) {
            _yuitest_coverline("build/yui/yui.js", 1240);
ret = Y.config.errorFn.apply(Y, arguments);
        }

        _yuitest_coverline("build/yui/yui.js", 1243);
if (!ret) {
            _yuitest_coverline("build/yui/yui.js", 1244);
throw (e || new Error(msg));
        } else {
            _yuitest_coverline("build/yui/yui.js", 1246);
Y.message(msg, 'error', ''+src); // don't scrub this one
        }

        _yuitest_coverline("build/yui/yui.js", 1249);
return Y;
    },
     ...
     */
    guid: function(pre) {
        _yuitest_coverfunc("build/yui/yui.js", "guid", 1258);
...
return (pre) ? (pre + id) : id;
    ...
    stamp: function(o, readOnly) {
        _yuitest_coverfunc("build/yui/yui.js", "stamp", 1273);
...
if (o.uniqueID && o.nodeType && o.nodeType !== 9) {
            _yuitest_coverline("build/yui/yui.js", 1282);
uid = o.uniqueID;
        } else {
            _yuitest_coverline("build/yui/yui.js", 1284);
...
try {
                    _yuitest_coverline("build/yui/yui.js", 1291);
o._yuid = uid;
                } catch (e) {
                    _yuitest_coverline("build/yui/yui.js", 1293);
uid = null;
                }
            }
        }
        _yuitest_coverline("build/yui/yui.js", 1297);
return uid;
    },
     ...
     */
    destroy: function() {
        _yuitest_coverfunc("build/yui/yui.js", "destroy", 1305);
...
delete Y.Env;
        _yuitest_coverline("build/yui/yui.js", 1312);
delete Y.config;
    }
    ...
    _yuitest_coverline("build/yui/yui.js", 1326);
YUI.prototype = proto;
...
if (proto.hasOwnProperty(prop)) {
            _yuitest_coverline("build/yui/yui.js", 1331);
YUI[prop] = proto[prop];
        }
    }
...
YUI.applyConfig = function(o) {
        _yuitest_coverfunc("build/yui/yui.js", "applyConfig", 1367);
_yuitest_coverline("build/yui/yui.js", 1368);
if (!o) {
            _yuitest_coverline("build/yui/yui.js", 1369);
return;
        }
        //If there is a GlobalConfig, apply it first to set the defaults
        _yuitest_coverline("build/yui/yui.js", 1372);
if (YUI.GlobalConfig) {
            _yuitest_coverline("build/yui/yui.js", 1373);
...
YUI._init();
    ...
    _yuitest_coverline("build/yui/yui.js", 1384);
if (hasWin) {
        // add a window load event at load time so we can capture
        // the case where it fires before dynamic loading is
        // complete.
        _yuitest_coverline("build/yui/yui.js", 1388);
add(window, 'load', handleLoad);
    } else {
        _yuitest_coverline("build/yui/yui.js", 1390);
handleLoad();
    }

    _yuitest_coverline("build/yui/yui.js", 1393);
YUI.Env.add = add;
    _yuitest_coverline("build/yui/yui.js", 1394);
...
if (typeof exports == 'object') {
        _yuitest_coverline("build/yui/yui.js", 1399);
exports.YUI = YUI;
    }
...
_yuitest_coverfunc("build/yui/yui.js", "(anonymous 8)", 1960);
_yuitest_coverline("build/yui/yui.js", 1982);
var L = Y.Lang || (Y.Lang = {}),
...
@since 3.5.0
**/
_yuitest_coverline("build/yui/yui.js", 2030);
L._isNative = function (fn) {
    _yuitest_coverfunc("build/yui/yui.js", "_isNative", 2030);
_yuitest_coverline("build/yui/yui.js", 2031);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 2048);
L.isArray = L._isNative(Array.isArray) ? Array.isArray : function (o) {
    _yuitest_coverfunc("build/yui/yui.js", "isArray", 2048);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2059);
L.isBoolean = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isBoolean", 2059);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2070);
L.isDate = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isDate", 2070);
_yuitest_coverline("build/yui/yui.js", 2071);
...
L.isFunction = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isFunction", 2098);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2109);
L.isNull = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNull", 2109);
...
L.isNumber = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isNumber", 2120);
 ...
 * @see isPlainObject
 */
_yuitest_coverline("build/yui/yui.js", 2135);
L.isObject = function(o, failfn) {
    _yuitest_coverfunc("build/yui/yui.js", "isObject", 2135);
_yuitest_coverline("build/yui/yui.js", 2136);
var t = typeof o;
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2148);
L.isString = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isString", 2148);
...
L.isUndefined = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isUndefined", 2159);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2172);
L.isValue = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "isValue", 2172);
_yuitest_coverline("build/yui/yui.js", 2173);
var t = L.type(o);

    _yuitest_coverline("build/yui/yui.js", 2175);
switch (t) {
        case 'number':
            _yuitest_coverline("build/yui/yui.js", 2177);
return isFinite(o);

        case 'null': // fallthru
        case 'undefined':
            _yuitest_coverline("build/yui/yui.js", 2181);
return false;

        default:
            _yuitest_coverline("build/yui/yui.js", 2184);
return !!t;
    }
};
...
L.now = Date.now || function () {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 9)", 2196);
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 2211);
L.sub = function(s, o) {
    _yuitest_coverfunc("build/yui/yui.js", "sub", 2211);
_yuitest_coverline("build/yui/yui.js", 2212);
return s.replace ? s.replace(SUBREGEX, function (match, key) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 10)", 2212);
_yuitest_coverline("build/yui/yui.js", 2213);
 ...
 */
_yuitest_coverline("build/yui/yui.js", 2225);
L.trim = STRING_PROTO.trim ? function(s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 11)", 2225);
_yuitest_coverline("build/yui/yui.js", 2226);
return s && s.trim ? s.trim() : s;
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2227);
_yuitest_coverline("build/yui/yui.js", 2228);
try {
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2242);
L.trimLeft = STRING_PROTO.trimLeft ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 12)", 2242);
_yuitest_coverline("build/yui/yui.js", 2243);
return s.trimLeft();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2244);
 ...
 * @return {string} the trimmed string.
 */
_yuitest_coverline("build/yui/yui.js", 2255);
L.trimRight = STRING_PROTO.trimRight ? function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 13)", 2255);
_yuitest_coverline("build/yui/yui.js", 2256);
return s.trimRight();
} : function (s) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2257);
...
L.type = function(o) {
    _yuitest_coverfunc("build/yui/yui.js", "type", 2288);
_yuitest_coverline("build/yui/yui.js", 2289);
...
_yuitest_coverline("build/yui/yui.js", 2296);
var Lang   = Y.Lang,
...
function YArray(thing, startIndex, force) {
    _yuitest_coverfunc("build/yui/yui.js", "YArray", 2329);
_yuitest_coverline("build/yui/yui.js", 2330);
var len, result;

    _yuitest_coverline("build/yui/yui.js", 2332);
startIndex || (startIndex = 0);

    _yuitest_coverline("build/yui/yui.js", 2334);
if (force || YArray.test(thing)) {
        // IE throws when trying to slice HTMLElement collections.
        _yuitest_coverline("build/yui/yui.js", 2336);
try {
            _yuitest_coverline("build/yui/yui.js", 2337);
return Native.slice.call(thing, startIndex);
        } catch (ex) {
            _yuitest_coverline("build/yui/yui.js", 2339);
result = [];

            _yuitest_coverline("build/yui/yui.js", 2341);
...
return result;
    ...
    _yuitest_coverline("build/yui/yui.js", 2349);
return [thing];
}
...
YArray.dedupe = function (array) {
    _yuitest_coverfunc("build/yui/yui.js", "dedupe", 2368);
_yuitest_coverline("build/yui/yui.js", 2369);
var hash    = {},
        results = [],
        i, item, len;
...
for (i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2374);
item = array[i];

        _yuitest_coverline("build/yui/yui.js", 2376);
if (!hasOwn.call(hash, item)) {
            _yuitest_coverline("build/yui/yui.js", 2377);
hash[item] = 1;
            _yuitest_coverline("build/yui/yui.js", 2378);
results.push(item);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2382);
return results;
};
...
YArray.each = YArray.forEach = Lang._isNative(Native.forEach) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 14)", 2400);
_yuitest_coverline("build/yui/yui.js", 2401);
Native.forEach.call(array || [], fn, thisObj || Y);
    _yuitest_coverline("build/yui/yui.js", 2402);
return Y;
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2403);
_yuitest_coverline("build/yui/yui.js", 2404);
for (var i = 0, len = (array && array.length) || 0; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2405);
if (i in array) {
...
YArray.hash = function (keys, values) {
    _yuitest_coverfunc("build/yui/yui.js", "hash", 2437);
_yuitest_coverline("build/yui/yui.js", 2438);
var hash = {},
        vlen = (values && values.length) || 0,
        i, len;

    _yuitest_coverline("build/yui/yui.js", 2442);
for (i = 0, len = keys.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2443);
if (i in keys) {
            _yuitest_coverline("build/yui/yui.js", 2444);
hash[keys[i]] = vlen > i && i in values ? values[i] : true;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2448);
return hash;
};
...
YArray.indexOf = Lang._isNative(Native.indexOf) ? function (array, value, from) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 15)", 2465);
_yuitest_coverline("build/yui/yui.js", 2466);
return Native.indexOf.call(array, value, from);
} : function (array, value, from) {
    // http://es5.github.com/#x15.4.4.14
    _yuitest_coverfunc("build/yui/yui.js", "}", 2467);
_yuitest_coverline("build/yui/yui.js", 2469);
var len = array.length;

    _yuitest_coverline("build/yui/yui.js", 2471);
from = +from || 0;
...
if (from < 0) {
        _yuitest_coverline("build/yui/yui.js", 2475);
from += len;

        _yuitest_coverline("build/yui/yui.js", 2477);
if (from < 0) {
...
from = 0;
    ...
    _yuitest_coverline("build/yui/yui.js", 2482);
for (; from < len; ++from) {
        _yuitest_coverline("build/yui/yui.js", 2483);
...
YArray.numericSort = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "numericSort", 2510);
_yuitest_coverline("build/yui/yui.js", 2511);
return a - b;
};
...
@static
**/
_yuitest_coverline("build/yui/yui.js", 2530);
YArray.some = Lang._isNative(Native.some) ? function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 16)", 2530);
_yuitest_coverline("build/yui/yui.js", 2531);
return Native.some.call(array, fn, thisObj);
} : function (array, fn, thisObj) {
    _yuitest_coverfunc("build/yui/yui.js", "}", 2532);
_yuitest_coverline("build/yui/yui.js", 2533);
for (var i = 0, len = array.length; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2534);
if (i in array && fn.call(thisObj, array[i], i, array)) {
            _yuitest_coverline("build/yui/yui.js", 2535);
return true;
        }
    }
...
YArray.test = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "test", 2560);
...
result = 1;
    } else {_yuitest_coverline("build/yui/yui.js", 2565);
...
result = 2;
    ...
    _yuitest_coverline("build/yui/yui.js", 2576);
return result;
};
/**
 * The YUI module contains the components required for building the YUI
...
function Queue() {
    _yuitest_coverfunc("build/yui/yui.js", "Queue", 2594);
_yuitest_coverline("build/yui/yui.js", 2595);
this._init();
    _yuitest_coverline("build/yui/yui.js", 2596);
this.add.apply(this, arguments);
}

_yuitest_coverline("build/yui/yui.js", 2599);
Queue.prototype = {
    /**
    ...
    _init: function() {
         ...
         * @protected
         */
        _yuitest_coverfunc("build/yui/yui.js", "_init", 2606);
...
this._q = [];
     ...
     */
    next: function() {
        _yuitest_coverfunc("build/yui/yui.js", "next", 2623);
...
return this._q.shift();
     ...
     */
    last: function() {
        _yuitest_coverfunc("build/yui/yui.js", "last", 2633);
_yuitest_coverline("build/yui/yui.js", 2634);
return this._q.pop();
    },
     ...
     */
    add: function() {
        _yuitest_coverfunc("build/yui/yui.js", "add", 2644);
...
return this;
     ...
     */
    size: function() {
        _yuitest_coverfunc("build/yui/yui.js", "size", 2656);
_yuitest_coverline("build/yui/yui.js", 2657);
return this._q.length;
    }
};

_yuitest_coverline("build/yui/yui.js", 2661);
Y.Queue = Queue;
...
_yuitest_coverline("build/yui/yui.js", 2674);
...
Y.cached = function (source, cache, refetch) {
    _yuitest_coverfunc("build/yui/yui.js", "cached", 2703);
_yuitest_coverline("build/yui/yui.js", 2704);
cache || (cache = {});

    _yuitest_coverline("build/yui/yui.js", 2706);
return function (arg) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 17)", 2706);
_yuitest_coverline("build/yui/yui.js", 2707);
...
if (!(key in cache) || (refetch && cache[key] == refetch)) {
            _yuitest_coverline("build/yui/yui.js", 2712);
...
Y.getLocation = function () {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "getLocation", 2735);
_yuitest_coverline("build/yui/yui.js", 2739);
var win = Y.config.win;
    ...
    _yuitest_coverline("build/yui/yui.js", 2745);
...
Y.merge = function () {
    _yuitest_coverfunc("build/yui/yui.js", "merge", 2760);
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 2768);
obj = arguments[i];

        _yuitest_coverline("build/yui/yui.js", 2770);
for (key in obj) {
            _yuitest_coverline("build/yui/yui.js", 2771);
if (hasOwn.call(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 2772);
result[key] = obj[key];
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 2777);
return result;
};
...
Y.mix = function(receiver, supplier, overwrite, whitelist, mode, merge) {
    _yuitest_coverfunc("build/yui/yui.js", "mix", 2814);
...
var alwaysOverwrite, exists, from, i, key, len, to;
    ...
    _yuitest_coverline("build/yui/yui.js", 2820);
...
if (!from || !to) {
            _yuitest_coverline("build/yui/yui.js", 2842);
return receiver;
        }
    } else {
...
to   = receiver;
    ...
    _yuitest_coverline("build/yui/yui.js", 2851);
...
for (i = 0, len = whitelist.length; i < len; ++i) {
            _yuitest_coverline("build/yui/yui.js", 2855);
key = whitelist[i];
            ...
            // method.
            _yuitest_coverline("build/yui/yui.js", 2862);
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2882);
if (overwrite || !exists) {
...
for (key in from) {
            ...
            _yuitest_coverline("build/yui/yui.js", 2896);
if (!hasOwn.call(from, key)) {
...
continue;
            ...
            // compatibility reasons. It prevents undesired shadowing of
            // prototype members on `to`.
            _yuitest_coverline("build/yui/yui.js", 2903);
exists = alwaysOverwrite ? false : key in to;
...
Y.mix(to[key], from[key], overwrite, null, 0, merge);
            } else {_yuitest_coverline("build/yui/yui.js", 2908);
if (overwrite || !exists) {
                _yuitest_coverline("build/yui/yui.js", 2909);
to[key] = from[key];
            }}
        }
...
Y.mix(to, from, overwrite, Y.Object._forceEnum, mode, merge);
    ...
    _yuitest_coverline("build/yui/yui.js", 2921);
return receiver;
};
/**
 * The YUI module contains the components required for building the YUI
...
O = Y.Object = Lang._isNative(Object.create) ? function (obj) {
    ...
    // Object.create().
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 18)", 2953);
_yuitest_coverline("build/yui/yui.js", 2959);
return Object.create(obj);
} : (function () {
    // Reusable constructor function for the Object.create() shim.
    _yuitest_coverfunc("build/yui/yui.js", "(anonymous 19)", 2960);
_yuitest_coverline("build/yui/yui.js", 2962);
function F() {}

    // The actual shim.
    _yuitest_coverline("build/yui/yui.js", 2965);
return function (obj) {
        _yuitest_coverfunc("build/yui/yui.js", "(anonymous 20)", 2965);
_yuitest_coverline("build/yui/yui.js", 2966);
F.prototype = obj;
        _yuitest_coverline("build/yui/yui.js", 2967);
return new F();
    };
}()),
...
owns = O.owns = function (obj, key) {
    _yuitest_coverfunc("build/yui/yui.js", "owns", 3028);
...
O.keys = Lang._isNative(Object.keys) ? Object.keys : function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "keys", 3064);
_yuitest_coverline("build/yui/yui.js", 3065);
if (!Lang.isObject(obj)) {
        _yuitest_coverline("build/yui/yui.js", 3066);
...
key = forceEnum[i];
            ...
            _yuitest_coverline("build/yui/yui.js", 3090);
if (owns(obj, key)) {
                _yuitest_coverline("build/yui/yui.js", 3091);
keys.push(key);
            }
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3096);
return keys;
};
...
O.values = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "values", 3116);
_yuitest_coverline("build/yui/yui.js", 3117);
var keys   = O.keys(obj),
        i      = 0,
        len    = keys.length,
        values = [];
...
for (; i < len; ++i) {
        _yuitest_coverline("build/yui/yui.js", 3123);
values.push(obj[keys[i]]);
    }

    _yuitest_coverline("build/yui/yui.js", 3126);
return values;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3137);
O.size = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "size", 3137);
_yuitest_coverline("build/yui/yui.js", 3138);
try {
        _yuitest_coverline("build/yui/yui.js", 3139);
return O.keys(obj).length;
    } catch (ex) {
        _yuitest_coverline("build/yui/yui.js", 3141);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3155);
O.hasValue = function (obj, value) {
    _yuitest_coverfunc("build/yui/yui.js", "hasValue", 3155);
_yuitest_coverline("build/yui/yui.js", 3156);
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3179);
O.each = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "each", 3179);
_yuitest_coverline("build/yui/yui.js", 3180);
var key;

    _yuitest_coverline("build/yui/yui.js", 3182);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3183);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3184);
fn.call(thisObj || Y, obj[key], key, obj);
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3188);
return Y;
};
 ...
 * @static
 */
_yuitest_coverline("build/yui/yui.js", 3211);
O.some = function (obj, fn, thisObj, proto) {
    _yuitest_coverfunc("build/yui/yui.js", "some", 3211);
_yuitest_coverline("build/yui/yui.js", 3212);
var key;

    _yuitest_coverline("build/yui/yui.js", 3214);
for (key in obj) {
        _yuitest_coverline("build/yui/yui.js", 3215);
if (proto || owns(obj, key)) {
            _yuitest_coverline("build/yui/yui.js", 3216);
if (fn.call(thisObj || Y, obj[key], key, obj)) {
                _yuitest_coverline("build/yui/yui.js", 3217);
return true;
            }
        }
    }
...
O.getValue = function(o, path) {
    _yuitest_coverfunc("build/yui/yui.js", "getValue", 3238);
_yuitest_coverline("build/yui/yui.js", 3239);
if (!Lang.isObject(o)) {
        _yuitest_coverline("build/yui/yui.js", 3240);
return UNDEFINED;
    }

    _yuitest_coverline("build/yui/yui.js", 3243);
var i,
        p = Y.Array(path),
        l = p.length;

    _yuitest_coverline("build/yui/yui.js", 3247);
for (i = 0; o !== UNDEFINED && i < l; i++) {
        _yuitest_coverline("build/yui/yui.js", 3248);
o = o[p[i]];
    }
 ...
 */
_yuitest_coverline("build/yui/yui.js", 3268);
O.setValue = function(o, path, val) {
    _yuitest_coverfunc("build/yui/yui.js", "setValue", 3268);
...
var i,
    ...
    _yuitest_coverline("build/yui/yui.js", 3274);
if (leafIdx >= 0) {
        _yuitest_coverline("build/yui/yui.js", 3275);
for (i = 0; ref !== UNDEFINED && i < leafIdx; i++) {
            _yuitest_coverline("build/yui/yui.js", 3276);
ref = ref[p[i]];
        }

        _yuitest_coverline("build/yui/yui.js", 3279);
if (ref !== UNDEFINED) {
            _yuitest_coverline("build/yui/yui.js", 3280);
ref[p[i]] = val;
        } else {
...
return UNDEFINED;
    ...
    _yuitest_coverline("build/yui/yui.js", 3286);
return o;
};
 ...
 * @since 3.2.0
 */
_yuitest_coverline("build/yui/yui.js", 3298);
O.isEmpty = function (obj) {
    _yuitest_coverfunc("build/yui/yui.js", "isEmpty", 3298);
_yuitest_coverline("build/yui/yui.js", 3299);
...
YUI.Env.parseUA = function(subUA) {
    ...
    _yuitest_coverfunc("build/yui/yui.js", "parseUA", 3334);
_yuitest_coverline("build/yui/yui.js", 3336);
var numberify = function(s) {
            _yuitest_coverfunc("build/yui/yui.js", "numberify", 3336);
_yuitest_coverline("build/yui/yui.js", 3337);
var c = 0;
            _yuitest_coverline("build/yui/yui.js", 3338);
return parseFloat(s.replace(/\./g, function() {
                _yuitest_coverfunc("build/yui/yui.js", "(anonymous 22)", 3338);
_yuitest_coverline("build/yui/yui.js", 3339);
return (c++ === 1) ? '' : '.';
            }));
        },
...
o.userAgent = ua;
    ...
    _yuitest_coverline("build/yui/yui.js", 3576);
...
o.os = 'windows';
        } else {_yuitest_coverline("build/yui/yui.js", 3582);
if ((/macintosh|mac_powerpc/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3583);
o.os = 'macintosh';
        } else {_yuitest_coverline("build/yui/yui.js", 3584);
if ((/android/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3585);
o.os = 'android';
        } else {_yuitest_coverline("build/yui/yui.js", 3586);
if ((/symbos/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3587);
o.os = 'symbos';
        } else {_yuitest_coverline("build/yui/yui.js", 3588);
if ((/linux/i).test(ua)) {
            _yuitest_coverline("build/yui/yui.js", 3589);
o.os = 'linux';
        } else {_yuitest_coverline("build/yui/yui.js", 3590);
if ((/rhino/i).test(ua)) {
...
if (m && m[1]) {
                        _yuitest_coverline("build/yui/yui.js", 3643);
...
o.air = m[0]; // Adobe AIR 1.0 or better
        ...
        _yuitest_coverline("build/yui/yui.js", 3686);
...
if (m && m[1]) {
                    _yuitest_coverline("build/yui/yui.js", 3713);
o.ie = numberify(m[1]);
                } else { // not opera, webkit, or ie
                    _yuitest_coverline("build/yui/yui.js", 3715);
m = ua.match(/Gecko\/([^\s]*)/);
                    _yuitest_coverline("build/yui/yui.js", 3716);
if (m) {
                        _yuitest_coverline("build/yui/yui.js", 3717);
...
o.gecko = numberify(m[1]);
    ...
    _yuitest_coverline("build/yui/yui.js", 3730);
...
o.touchEnabled = (("ontouchstart" in win) || (("msMaxTouchPoints" in nav) && (nav.msMaxTouchPoints > 0)));
    ...
    _yuitest_coverline("build/yui/yui.js", 3735);
if (!subUA) {

        _yuitest_coverline("build/yui/yui.js", 3737);
if (typeof process === 'object') {

            _yuitest_coverline("build/yui/yui.js", 3739);
if (process.versions && process.versions.node) {
                //NodeJS
                _yuitest_coverline("build/yui/yui.js", 3741);
o.os = process.platform;
                _yuitest_coverline("build/yui/yui.js", 3742);
...
Y.UA.compareVersions = function (a, b) {
    _yuitest_coverfunc("build/yui/yui.js", "compareVersions", 3776);
...
bParts = (b + '').split('.');
    ...
    _yuitest_coverline("build/yui/yui.js", 3786);
...
bPart = parseInt(bParts[i], 10);
        ...
        _yuitest_coverline("build/yui/yui.js", 3790);
isNaN(aPart) && (aPart = 0);
        _yuitest_coverline("build/yui/yui.js", 3791);
isNaN(bPart) && (bPart = 0);

        _yuitest_coverline("build/yui/yui.js", 3793);
if (aPart < bPart) {
            _yuitest_coverline("build/yui/yui.js", 3794);
return -1;
        }

        _yuitest_coverline("build/yui/yui.js", 3797);
if (aPart > bPart) {
            _yuitest_coverline("build/yui/yui.js", 3798);
return 1;
        }
    }

    _yuitest_coverline("build/yui/yui.js", 3802);
return 0;
};
_yuitest_coverline("build/yui/yui.js", 3804);
YUI.Env.aliases = {
