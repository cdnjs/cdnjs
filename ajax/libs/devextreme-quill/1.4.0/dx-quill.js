...
var get_id = __webpack_require__(48);
  ...
  lite_createClass(TableLite, [{
    ...
    value: function addKeyboardHandlers() {
      ...
      Object.keys(bindings).forEach(function (name) {
        if (bindings[name]) {
          _this2.quill.keyboard.addBinding(bindings[name]);
        }
      });
    }
  }, {
    ...
    value: function getTable() {
      ...
      var allowedBlots = [TableCell.blotName, TableHeaderCell.blotName];

      if (!Object(is_defined["a" /* default */])(cell) || allowedBlots.indexOf(cell.statics.blotName) === -1) {
        return EMPTY_RESULT;
      }
    ...
    value: function listenBalanceCells() {
      ...
      this.quill.on(core_quill["a" /* default */].events.SCROLL_OPTIMIZE, function (mutations) {
        mutations.some(function (mutation) {
          if (['TD', 'TH', 'TR', 'TBODY', 'THEAD', 'TABLE'].indexOf(mutation.target.tagName) !== -1) {
            _this3.quill.once(core_quill["a" /* default */].events.TEXT_CHANGE, function (delta, old, source) {
              if (source !== core_quill["a" /* default */].sources.USER) return;

              _this3.balanceTables();
            });
      ...
      this.quill.on(core_quill["a" /* default */].events.CONTENT_SETTED, function () {
        _this3.quill.once(core_quill["a" /* default */].events.TEXT_CHANGE, function () {
          _this3.balanceTables();
        });
      });
    }
...
var isForced = __webpack_require__(121);
...
var isCallable = __webpack_require__(17);
var tryToString = __webpack_require__(111);
...
var DESCRIPTORS = __webpack_require__(41);
var propertyIsEnumerableModule = __webpack_require__(114);
var createPropertyDescriptor = __webpack_require__(55);
var toIndexedObject = __webpack_require__(73);
var toPropertyKey = __webpack_require__(67);
var has = __webpack_require__(29);
var IE8_DOM_DEFINE = __webpack_require__(85);
...
var table_Table = /*#__PURE__*/function (_Module) {
  ...
  table_createClass(Table, [{
    ...
    value: function getTable() {
      ...
      var allowedBlots = [CellLine.blotName, HeaderCellLine.blotName];

      if (!Object(is_defined["a" /* default */])(cellLine) || allowedBlots.indexOf(cellLine.statics.blotName) === -1) {
        return EMPTY_RESULT;
      }
    ...
    value: function listenBalanceCells() {
      ...
      this.quill.on(quill["a" /* default */].events.SCROLL_OPTIMIZE, function (mutations) {
        mutations.some(function (mutation) {
          if (['TD', 'TH', 'TR', 'TBODY', 'THEAD', 'TABLE'].indexOf(mutation.target.tagName) !== -1) {
            _this3.quill.once(quill["a" /* default */].events.TEXT_CHANGE, function (delta, old, source) {
      ...
      this.quill.on(quill["a" /* default */].events.CONTENT_SETTED, function () {
        _this3.quill.once(quill["a" /* default */].events.TEXT_CHANGE, function () {
          _this3.balanceTables();
        });
      });
    }
...
table_Table.keyboardBindings = {
  ...
  'table cell enter': {
    ...
    handler: function handler(range, context) {
      ...
      var lineFormats = Object.keys(context.format).reduce(function (formats, format) {
        if (_this4.quill.scroll.query(format, parchment["Scope"].BLOCK) && !Array.isArray(context.format[format])) {
          formats[format] = context.format[format];
        }
      ...
      Object.keys(context.format).forEach(function (name) {
        ...
        _this4.quill.format(name, context.format[name], quill["a" /* default */].sources.USER);
      });
    }
  },
  'table tab': {
...
var has = __webpack_require__(29);
var toIndexedObject = __webpack_require__(73);
var indexOf = __webpack_require__(119).indexOf;
var hiddenKeys = __webpack_require__(71);
...
var ends_with = __webpack_require__(145);
...
var syntax = __webpack_require__(59);
...
var lite = __webpack_require__(49);
...
var isSymbol = __webpack_require__(87);
var getMethod = __webpack_require__(68);
var ordinaryToPrimitive = __webpack_require__(112);
var wellKnownSymbol = __webpack_require__(23);
...
var isConstructor = __webpack_require__(134);
var toLength = __webpack_require__(57);
