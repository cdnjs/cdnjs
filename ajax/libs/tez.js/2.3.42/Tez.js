...
var _attrs2 = __webpack_require__(5);
...
var _getItem2 = __webpack_require__(7);
...
var TD = function () {
	function TD(query) {
		...
		query = this.query = _slice.call(typeof query === "string" ? query.indexOf("<") === -1 ? context.querySelectorAll(query) : function () {
		...
		this.domc = [];
		(0, _each3.default)(query, function (item, i) {
			_this[i] = item;
			_this.domc[i] = new _domClass2.default(item);
		});
	...
	_createClass(TD, [{
		...
		value: function find(_item) {
			...
			(0, _each3.default)(this.query, function (item, i) {
				delete _this2[i];
				delete _this2.domc[i];
				delete _this2.query[i];
			});
			(0, _each3.default)(_p, function (item, i) {
				_this2[i] = item;
				_this2.domc[i] = new _domClass2.default(item);
			});
		...
		value: function domEach(fn) {
			...
			if (!_ok) return this;
			(0, _each3.default)(this.domc, fn, this);
			return this;
		}
	}, {
		key: 'virtualsync',
		...
		key: 'props',
		value: function props(name, value) {
			if (typeof name === "string") {
				if (typeof value !== "undefined") {
		...
		value: function each(arr, fn) {
			return (0, _each3.default)(arr, fn);
		}
	}, {
		key: 'extend',
		...
		key: 'queue',
		value: function queue(target, fn) {
			var pfx = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "_";
			var stack = arguments[3];

			var _queueList = target ? target[pfx + "queue"] || (target[pfx + "queue"] = []) : _queue;
			_queueList[stack ? 'unshift' : 'push'](fn);
		}
	}, {
		key: 'dequeue',
		value: function dequeue(target, fn) {
			var pfx = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "_";
			var stack = arguments[3];

			var _queueList = target ? target[pfx + "queue"] || (target[pfx + "queue"] = []) : _queue;
			var action = stack ? 'shift' : 'pop';
			var noop = function noop() {};
			var q1 = stack && _queueList.length ? _queueList.length - 1 : 0,
			    q2 = stack && _queueList.length ? Math.max(0, _queueList.length - 2) : 1;
			if (_queueList[q1] && _queueList[q1] === "inprogress") {
				_queueList[q1] = noop;
			}
			if (_queueList.length > 1) {
				if (_queueList[q2] === "inprogress") {
					_queueList[q2] = noop;
				}
				if (typeof _queueList[q2] === "function" && _queueList[q1](_queueList[q2])) {
					_queueList.splice(q1, 1);
					_queueList.splice(q2, 1);
				}
			} else {
				if (_queueList[q1](noop)) {
					_queueList.splice(q1, 1);
				}
			}
		}
		...
		key: 'stack',
		value: function stack(target, fn, pfx) {
			return Tez.queue(target, fn, pfx, true);
		}
	}, {
		key: 'destack',
		value: function destack(target, fn, pfx) {
			return Tez.dequeue(target, fn, pfx, true);
		}
	}]);
...
var _attrs3 = __webpack_require__(5);
...
exports.Wrapper = exports.tezClass = exports.URLComponent = exports.hashURL = exports.XHR = exports.domClass = exports.DOMManager = exports.TweenManager = exports.CallManager = exports.LogicManager = exports.CompositeManager = exports.DiffManager = exports.FunctionManager = exports.PluginManager = exports.createElement = exports.Data = undefined;
...
var _FunctionManager = __webpack_require__(10);

var _FunctionManager2 = _interopRequireDefault(_FunctionManager);

var _DiffManager = __webpack_require__(9);

var _DiffManager2 = _interopRequireDefault(_DiffManager);

var _Managers2Fn = __webpack_require__(11);

var _TweenManager = __webpack_require__(12);

var _TweenManager2 = _interopRequireDefault(_TweenManager);

var _DOMManager = __webpack_require__(8);
...
exports.Wrapper = _helper2.default;
