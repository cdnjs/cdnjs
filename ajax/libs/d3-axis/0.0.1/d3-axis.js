(function (global, factory) {
  ...
  var orientTop = {name: "top"};
  var orientRight = {name: "right"};
  var orientBottom = {name: "bottom"};
  var orientLeft = {name: "left"};
  ...
  var axisOrientTop = orientTop;
  var axisOrientRight = orientRight;
  var axisOrientBottom = orientBottom;
  var axisOrientLeft = orientLeft;

  var version = "0.0.1";

  exports.version = version;
  exports.axisOrientTop = axisOrientTop;
  exports.axisOrientRight = axisOrientRight;
  exports.axisOrientBottom = axisOrientBottom;
  exports.axisOrientLeft = axisOrientLeft;
  exports.axis = axis;
