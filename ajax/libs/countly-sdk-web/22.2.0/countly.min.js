...
"="+encodeURIComponent(h[t]));return r.join("&")}function Da(h){return"/"===h.substr(h.length-1)?h.substr(0,h.length-1):h}function ja(h,r){for(var t={},z,I=0;I<r.length;I++)z=r[I],"undefined"!==typeof h[z]&&(t[z]=h[z]);return t}function R(h,r,t,z,I,S){var N={};if(h){if(Object.keys(h).length>z){var P={},F=0,W;for(W in h)F<z&&(P[W]=h[W],F++);h=P}for(var fa in h)z=w(fa,r,I,S),P=w(h[fa],t,I,S),N[z]=P}return N}function w(h,r,t,z){var I=h;"number"===typeof h&&(h=h.toString());"string"===typeof h&&h.length>
...
function Sa(h,r,t,z,I,S){var N=document.createElement(h),P;N.setAttribute(r,t);N.setAttribute(z,I);S&&(N.onreadystatechange=function(){N.onload=function(){P||S();P=!0}});document.getElementsByTagName("head")[0].appendChild(N)}function Ta(h,r){Sa("script","type","text/javascript","src",h,r)}function ra(h,r){Sa("link","rel","stylesheet","href",h,r)}function Ua(){var h=document.getElementById("cly-loader");if(!h){var r=document.head||document.getElementsByTagName("head")[0],t=document.createElement("style");
...
a._id;var k=document.createElement("span");k.className="countly-feedback-close-icon";k.id="countly-feedback-close-icon-"+a._id;k.innerText="x";var l=document.createElement("iframe");l.name="countly-feedback-iframe";l.id="countly-feedback-iframe";l.src=f.url+"/feedback?widget_id="+a._id+"&app_key="+f.app_key+"&device_id="+f.device_id+"&sdk_version=22.02.0";document.body.appendChild(d);d.appendChild(k);d.appendChild(l);x(document.getElementById("countly-feedback-close-icon-"+a._id),"click",function(){document.getElementById("countly-iframe-wrapper-"+
...
A&&(A.style.fill=7>a.trigger_font_color.length?"#"+a.trigger_font_color:a.trigger_font_color);x(document.getElementById("countly-feedback-sticker-"+a._id),"click",function(){document.getElementById("countly-iframe-wrapper-"+a._id).style.display="block";document.getElementById("cfbg").style.display="block"})}else document.getElementById("countly-iframe-wrapper-"+a._id).style.display="block",document.getElementById("cfbg").style.display="block"}catch(O){c(g.ERROR,"Somethings went wrong while element injecting process: "+
O)}}function I(){var a;if("undefined"!==typeof f.onload&&0<f.onload.length){for(a=0;a<f.onload.length;a++)if("function"===typeof f.onload[a])f.onload[a](f);f.onload=[]}}function S(){if(Y){var a={name:Y};f.check_consent("views")&&r({key:"[CLY]_view",dur:Z?C()-ka:la,segmentation:a});Y=null}}function N(){if(ma){var a=m("cly_session");if(!a||parseInt(a)<=C())T=!1,f.begin_session(!na);m("cly_session",C()+60*Ga)}}function P(a){a.app_key=f.app_key;a.device_id=f.device_id;a.sdk_name="javascript_native_web";
a.sdk_version="22.02.0";a.t=D;f.check_consent("location")?(f.country_code&&(a.country_code=f.country_code),f.city&&(a.city=f.city),null!==f.ip_address&&(a.ip_address=f.ip_address)):a.location="";a.timestamp=Ba();var b=new Date;a.hour=b.getHours();a.dow=b.getDay()}function F(a){f.ignore_visitor?c(g.WARNING,"User is opt_out will ignore the request: "+a):f.app_key&&f.device_id?(P(a),E.length>Xa&&E.shift(),E.push(a),m("cly_queue",E,!0)):c(g.ERROR,"app_key or device_id is missing ",f.app_key,f.device_id)}
...
typeof k.userData[e]&&k.userData[e].apply(k,d.slice(l+1))}else"function"===typeof n[d[l]]&&n[d[l]].apply(n,d.slice(l+1))}}}T&&na&&Z&&(a=C(),a-aa>Ya&&(f.session_duration(a-aa),aa=a));0<H.length&&(H.length<=Ha?(F({events:JSON.stringify(H)}),H=[]):(a=H.splice(0,Ha),F({events:JSON.stringify(a)})),m("cly_event",H));!K&&0<E.length&&ua&&C()>Ia&&(ua=!1,a=E[0],c(g.DEBUG,"Processing request",a),m("cly_queue",E,!0),f.tests||ha("send_request_queue",f.url+Za,a,function(p,q){c(g.DEBUG,"Request Finished",q,p);p?
...
b[11]!==window.location.hostname){b=!1;if(X&&X.length)for(d=0;d<X.length;d++)try{if((new RegExp(X[d])).test(document.referrer)){c(g.DEBUG,"Ignored: "+document.referrer);b=!0;break}}catch(l){c(g.ERROR,"Problem with ignoring: "+X[d],", error: "+l)}b||(a._store=a._store||document.referrer)}c(g.DEBUG,"Got metrics",a);return a}function c(a,b){if(f.debug&&"undefined"!==typeof console){arguments[2]&&"object"===typeof arguments[2]&&(arguments[2]=JSON.stringify(arguments[2]));ta||(b="["+f.app_key+"] "+b);
...
"Http response status code is not within the expected range: "+a),!1;try{var d=JSON.parse(b);return"[object Object]"===Object.prototype.toString.call(d)||Array.isArray(d)?!0:(c(g.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(k){return c(g.ERROR,"Http response is not JSON: "+k),!1}}function db(a){m("cly_token",a)}function m(a,b,d,k){function l(q,u,A){var O=new Date;O.setTime(O.getTime()+864E5*A);A="; expires="+O.toGMTString();document.cookie=q+"="+u+A+"; path=/"}function e(q){q+=
"=";for(var u=document.cookie.split(";"),A=0,O=u.length;A<O;A++){for(var G=u[A];" "===G.charAt(0);)G=G.substring(1,G.length);if(0===G.indexOf(q))return G.substring(q.length,G.length)}return null}if("none"===f.storage)c(g.WARNING,"Storage is disabled. Value with key: "+a+" won't be stored or retrieved");else{k||(a=f.app_key+"/"+a,f.namespace&&(a=Da(f.namespace)+"/"+a));d=d||"localstorage"===f.storage;var p;"undefined"!==typeof b&&null!==b&&(b=f.serialize(b),ba?localStorage.setItem(a,b):d||l(a,b,30));
...
var f=this,ta=!n.i,T=!1,Za="/i",Ja="/o/sdk",ab=v("interval",h,500),Xa=v("queue_size",h,1E3),E=[],H=[],L={},ca=[],da={},X=v("ignore_referrers",h,[]),Ka=null,na=!0,aa,La=0,Y=null,ka=0,la=0,Ia=0,$a=v("fail_timeout",h,60),Ma=v("inactivity_time",h,20),oa=0,Ya=v("session_update",h,60),Ha=v("max_events",h,100),wa=v("max_logs",h,null),ma=v("use_session_cookie",h,!0),Ga=v("session_cookie_timeout",h,30),ua=!0,sa=!1,K=v("offline_mode",h,!1),U={},Z=!0,eb=C(),ba=!0,ia=null,D=1;try{localStorage.setItem("cly_testLocal",
...
"initialize, Generating the device ID"),this.device_id=v("device_id",h,fa()),h&&Object.keys(h).length?void 0!==h.device_id&&(D=0):void 0!==n.device_id&&(D=0));m("cly_id",this.device_id);m("cly_id_type",D);if(d){for(var p in this.utm)k[p]?this.userData.set("utm_"+p,k[p]):this.userData.unset("utm_"+p);this.userData.save()}I();setTimeout(function(){W();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);document.documentElement.setAttribute("data-countly-useragent",navigator.userAgent)}};this.halt=
function(){c(g.WARNING,"halt, Resetting Countly");n.i=void 0;ta=!n.i;T=!1;Za="/i";Ja="/o/sdk";ab=500;Xa=1E3;E=[];H=[];L={};ca=[];da={};X=[];Ka=null;na=!0;La=0;Y=null;Ia=la=ka=0;$a=60;Ma=20;oa=0;Ya=60;Ha=100;wa=null;ma=!0;Ga=30;ua=!0;K=sa=!1;U={};Z=!0;eb=C();ba=!0;ia=null;D=1;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(b){ba=!1}n.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
this.begin_session=function(a,b){c(g.INFO,"begin_session, Starting the session");a&&c(g.INFO,"begin_session, Heartbeats are disabled");b&&c(g.INFO,"begin_session, Session starts irrespective of session cookie");if(this.check_consent("sessions")){if(!T){this.enableOrientationTracking&&(this.report_orientation(),x(window,"resize",function(){f.report_orientation()}));aa=C();T=!0;na=!a;var d=m("cly_session");if(b||!ma||!d||parseInt(d)<=C())c(g.INFO,"begin_session, Session started"),null===ia&&(ia=!0),
d={begin_session:1},d.metrics=JSON.stringify(va()),F(d);m("cly_session",C()+60*Ga)}}else U.begin_session=arguments};this.session_duration=function(a){c(g.INFO,"session_duration, Reporting session duration");this.check_consent("sessions")&&T&&(c(g.INFO,"session_duration, Session extended",a),F({session_duration:a}),N())};this.end_session=function(a,b){c(g.INFO,"end_session, Ending the current session");this.check_consent("sessions")&&T&&(a=a||C()-aa,S(),!ma||b?(c(g.INFO,"end_session, Session ended"),
F({end_session:1,session_duration:a})):this.session_duration(a),T=!1)};this.change_id=function(a,b){c(g.INFO,"change_id, Changing the ID");b&&c(g.INFO,"change_id, Will merge the IDs");if(!a||"string"!==typeof a||0===a.length)c(g.ERROR,"change_id, The provided ID: ["+a+"] is not a valid ID");else if(K)c(g.WARNING,"change_id, Offline mode was on, initiating disabling sequence instead."),this.disable_offline_mode(a);else if(this.device_id!==a){b||(0<H.length&&(F({events:JSON.stringify(H)}),H=[],m("cly_event",
...
"track_pageview, Problem with finding ignore list item: "+b[k]+", error: "+p)}Y=a;ka=C();k={name:a,visit:1,view:f.getViewUrl()};k=R(k,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"track_pageview",c);this.track_domains&&(k.domain=window.location.hostname);if(ma)if(T)ia&&(ia=!1,k.start=1);else{var l=m("cly_session");if(!l||parseInt(l)<=C())ia=!1,k.start=1}else"undefined"!==typeof document.referrer&&document.referrer.length&&(l=Wa.exec(document.referrer))&&l[11]&&l[11]!==window.location.hostname&&
(k.start=1);if(d)for(var e in d)"undefined"===typeof k[e]&&(k[e]=d[e]);this.check_consent("views")?r({key:"[CLY]_view",segmentation:k}):U.track_pageview=arguments}};this.track_view=function(a,b,d){c(g.INFO,"track_view, Initiating tracking page views");this.track_pageview(a,b,d)};this.track_clicks=function(a){c(g.INFO,"track_clicks, Starting to track clicks");a&&c(g.INFO,"track_clicks, Tracking the specified children");a=a||document;var b=!0;x(a,"click",function(d){if(b){b=!1;Ea(d);if("undefined"!==
typeof d.pageX&&"undefined"!==typeof d.pageY){var k=qa(),l=Fa();f.check_consent("clicks")&&(d={type:"click",x:d.pageX,y:d.pageY,width:l,height:k,view:f.getViewUrl()},d=R(d,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processClick",c),f.track_domains&&(d.domain=window.location.hostname),r({key:"[CLY]_action",segmentation:d}))}setTimeout(function(){b=!0},1E3)}})};this.track_scrolls=function(a){c(g.INFO,"track_scrolls, Starting to track scrolls");a&&c(g.INFO,"track_scrolls, Tracking the specified children");
a=a||window;var b=!0,d=0;x(a,"scroll",function(){d=Math.max(d,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop)});x(a,"beforeunload",function(){if(b){b=!1;var k=qa(),l=Fa(),e=Ra();f.check_consent("scrolls")&&(k={type:"scroll",y:d+e,width:l,height:k,view:f.getViewUrl()},k=R(k,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",c),f.track_domains&&(k.domain=window.location.hostname),r({key:"[CLY]_action",segmentation:k}))}})};this.track_links=function(a){c(g.INFO,
...
e)}}f.user_details(d)})};this.opt_out=function(){c(g.INFO,"opt_out, Opting out the user");this.ignore_visitor=!0;m("cly_ignore",!0)};this.opt_in=function(){c(g.INFO,"opt_in, Opting in the user");m("cly_ignore",!1);this.ignore_visitor=!1;t();this.ignore_visitor||sa||W()};this.report_feedback=function(a){c(g.WARNING,"report_feedback, Deprecated function call! Use 'recordRatingWidgetWithID' in place of this call. Call will be redirected now!");this.recordRatingWidgetWithID(a)};this.recordRatingWidgetWithID=
...
"present_feedback_widget, Loading css for rating widget.");var q="ratings";ra(this.url+"/star-rating/stylesheets/countly-feedback-web.css")}else c(g.DEBUG,"present_feedback_widget, Loading css for survey or nps."),ra(this.url+"/surveys/stylesheets/countly-surveys.css"),q="surveys";e+="?widget_id="+a._id;e+="&app_key="+this.app_key;e+="&device_id="+this.device_id;e+="&sdk_name=javascript_native_web";e+="&platform="+this.platform;e+="&app_version="+this.app_version;e+="&sdk_version=22.02.0";e+="&origin="+
p;e+="&widget_v=web";var u=document.createElement("iframe");u.src=e;u.name="countly-"+q+"-iframe";u.id="countly-"+q+"-iframe";var A=!1;u.onload=function(){A&&(document.getElementById("countly-"+q+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display="none");A=!0;c(g.DEBUG,"present_feedback_widget, Loaded iframe.")};for(var O=document.getElementById("csbg");O;)O.remove(),O=document.getElementById("csbg"),c(g.DEBUG,"present_feedback_widget, Removing past overlay.");var G=
