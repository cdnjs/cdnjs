...
function xb(l,k){for(var q=0;q<k.length;q++){var v=k[q];v.enumerable=v.enumerable||!1;v.configurable=!0;"value"in v&&(v.writable=!0);Object.defineProperty(l,Tb(v.key),v)}}function Tb(l){a:if("object"===typeof l&&null!==l){var k=l[Symbol.toPrimitive];if(void 0!==k){l=k.call(l,"string");if("object"!==typeof l)break a;throw new TypeError("@@toPrimitive must return a primitive value.");}l=String(l)}return"symbol"===typeof l?l:String(l)}function yb(l){var k=[];if("undefined"!==typeof l.options)for(var q=
0;q<l.options.length;q++)l.options[q].selected&&k.push(l.options[q].value);return k.join(", ")}function fb(){var l=zb("xxxxxxxx","[x]");var k=Date.now().toString();return l+k}function gb(){return zb("xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx","[xy]")}function zb(l,k){var q=(new Date).getTime();return l.replace(new RegExp(k,"g"),function(v){var G=(q+16*Math.random())%16|0;return("x"===v?G:G&3|8).toString(16)})}function F(){return Math.floor((new Date).getTime()/1E3)}function hb(){var l=(new Date).getTime();
...
k.appendChild(q);l=document.createElement("div");l.setAttribute("id","cly-loader");document.body.onload=function(){if(p.showLoaderProtection)Ca()&&console.warn("[WARNING] [Countly] showloader, Loader is already on");else try{document.body.appendChild(l)}catch(v){Ca()&&console.error("[ERROR] [Countly] showLoader, Body is not loaded for loader to append: "+v)}}}l.style.display="block"}}function Ca(){return p&&p.debug&&"undefined"!==typeof console?!0:!1}function Gb(){if(x){p.showLoaderProtection=!0;
var l=document.getElementById("cly-loader");l&&(l.style.display="none")}}function Ub(l){var k=document.createElement("script"),q=document.createElement("script");k.async=!0;q.async=!0;k.src=p.customSourceBoomerang||Hb.BOOMERANG_SRC;q.src=p.customSourceCountlyBoomerang||Hb.CLY_BOOMERANG_SRC;document.getElementsByTagName("head")[0].appendChild(k);document.getElementsByTagName("head")[0].appendChild(q);var v=!1,G=!1;k.onload=function(){v=!0};q.onload=function(){G=!0};var Q=0,O=setInterval(function(){Q+=
50;if(v&&G||1500<=Q){if(p.debug){var V="BoomerangJS loaded:["+v+"], countly_boomerang loaded:["+G+"].";v&&G?console.log("[DEBUG] "+V):console.warn("[WARNING] "+V+" Initializing without APM.")}p.init(l);clearInterval(O)}},50)}var M={NPS:"[CLY]_nps",SURVEY:"[CLY]_survey",STAR_RATING:"[CLY]_star_rating",VIEW:"[CLY]_view",ORIENTATION:"[CLY]_orientation",ACTION:"[CLY]_action"},Vb=Object.values(M),c={ERROR:"[ERROR] ",WARNING:"[WARNING] ",INFO:"[INFO] ",DEBUG:"[DEBUG] ",VERBOSE:"[VERBOSE] "},Hb={BOOMERANG_SRC:"https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/boomerang.min.js",
CLY_BOOMERANG_SRC:"https://cdn.jsdelivr.net/npm/countly-sdk-web@latest/plugin/boomerang/countly_boomerang.js"},T=Object.freeze({errorCount:"cly_hc_error_count",warningCount:"cly_hc_warning_count",statusCode:"cly_hc_status_code",errorMessage:"cly_hc_error_message"}),Ib=/^(((([^:\/#\?]+:)?(?:(\/\/)((?:(([^:@\/#\?]+)(?::([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?::([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,x="undefined"!==typeof window,p=globalThis.Countly||{},
Pa=0,Rb=function(l,k,q){k&&xb(l.prototype,k);q&&xb(l,q);Object.defineProperty(l,"prototype",{writable:!1});return l}(function q(k){function v(a,d){if(f.ignore_visitor)b(c.ERROR,"Adding event failed. Possible bot or user opt out");else if(a.key){a.count||(a.count=1);Vb.includes(a.key)||(a.key=z(a.key,f.maxKeyLength,"add_cly_event",b));a.segmentation=aa(a.segmentation,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"add_cly_event",b);a=za(a,["key","count","sum","dur","segmentation"]);a.timestamp=
...
(J.length<=Ka?(N({events:JSON.stringify(J)}),J=[]):(a=J.splice(0,Ka),N({events:JSON.stringify(a)})),w("cly_event",J));!K&&0<H.length&&$a&&F()>lb&&($a=!1,a=H[0],a.rr=H.length,b(c.DEBUG,"Processing request",a),w("cly_queue",H,!0),f.test_mode||ba("send_request_queue",f.url+mb,a,function(n,r){n?lb=F()+ab:H.shift();w("cly_queue",H,!0);$a=!0},!1));setTimeout(Wa,bb)}}function nb(){var a=y("cly_id");return a?(D=y("cly_id_type"),a):gb()}function Jb(){return f.metrics._ua||ua()}function Ta(){var a=JSON.parse(JSON.stringify(f.metrics||
...
a._density||window.devicePixelRatio);d=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage;"undefined"!==typeof d&&(a._locale=a._locale||d);ob()&&(a._store=a._store||document.referrer);b(c.DEBUG,"Got metrics",a);return a}function ob(a){if(!x)return!1;a=a||document.referrer;var d=!1;if("undefined"===typeof a||0===a.length)b(c.DEBUG,"Invalid referrer:["+a+"], ignoring.");else{var e=Ib.exec(a);if(e)if(e[11])if(e[11]===window.location.hostname)b(c.DEBUG,"Referrer is current host:["+
...
"] "+d);a||(a=c.DEBUG);for(var e="",h=2;h<arguments.length;h++)e+=arguments[h];e=a+"[Countly] "+d+e;a===c.ERROR?(console.error(e),qa.incrementErrorCount()):a===c.WARNING?(console.warn(e),qa.incrementWarningCount()):a===c.INFO?console.info(e):a===c.VERBOSE?console.log(e):console.debug(e)}}function ba(a,d,e,h,m){x?Kb(a,d,e,h,m):Lb(a,d,e,h,m)}function Kb(a,d,e,h,m){m=m||!1;try{b(c.DEBUG,"Sending XML HTTP request");var g=new XMLHttpRequest;e=e||{};var n=ya(e),r="GET";if(f.force_post||2E3<=n.length)r=
"POST";"GET"===r?g.open("GET",d+"?"+n,!0):(g.open("POST",d,!0),g.setRequestHeader("Content-type","application/x-www-form-urlencoded"));for(var u in f.headers)g.setRequestHeader(u,f.headers[u]);g.onreadystatechange=function(){4===this.readyState&&(b(c.DEBUG,a+" HTTP request completed with status code: ["+this.status+"] and response: ["+this.responseText+"]"),(m?pb(this.status,this.responseText):qb(this.status,this.responseText))?"function"===typeof h&&h(!1,e,this.responseText):(b(c.ERROR,a+" Invalid response from server"),
"send_request_queue"===a&&qa.saveRequestCounters(this.status,this.responseText),"function"===typeof h&&h(!0,e,this.status,this.responseText)))};"GET"===r?g.send():g.send(n)}catch(I){b(c.ERROR,a+" Something went wrong while making an XML HTTP request: "+I),"function"===typeof h&&h(!0,e)}}function Lb(a,d,e,h,m){m=m||!1;var g;try{b(c.DEBUG,"Sending Fetch request");var n="GET",r={"Content-type":"application/x-www-form-urlencoded"},u=null;e=e||{};f.force_post||2E3<=ya(e).length?(n="POST",u=ya(e)):d+="?"+
ya(e);for(var I in f.headers)r[I]=f.headers[I];fetch(d,{method:n,headers:r,body:u}).then(function(C){g=C;return g.text()}).then(function(C){b(c.DEBUG,a+" Fetch request completed wit status code: ["+g.status+"] and response: ["+C+"]");(m?pb(g.status,C):qb(g.status,C))?"function"===typeof h&&h(!1,e,C):(b(c.ERROR,a+" Invalid response from server"),"send_request_queue"===a&&qa.saveRequestCounters(g.status,C),"function"===typeof h&&h(!0,e,g.status,C))})["catch"](function(C){b(c.ERROR,a+" Failed Fetch request: "+
C);"function"===typeof h&&h(!0,e)})}catch(C){b(c.ERROR,a+" Something went wrong with the Fetch request attempt: "+C),"function"===typeof h&&h(!0,e)}}function qb(a,d){if(!(200<=a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(d);return"[object Object]"!==Object.prototype.toString.call(e)?(b(c.ERROR,"Http response is not JSON Object"),!1):!!e.result}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function pb(a,d){if(!(200<=
a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(d);return"[object Object]"===Object.prototype.toString.call(e)||Array.isArray(e)?!0:(b(c.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function Mb(){x?La=Math.max(La,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop):b(c.WARNING,"processScroll, window object is not available. Not processing scroll.")}
function rb(){if(!x)b(c.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Ma){Ma=!1;var a=Ra(),d=kb(),e=Cb();f.check_consent("scrolls")&&(a={type:"scroll",y:La+e,width:d,height:a,view:f.getViewUrl()},a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}function Nb(a){w("cly_token",a)}function Ob(a,d,e){var h=new Date;h.setTime(h.getTime()+
...
L(f.storage)&&"function"===typeof f.storage.setItem?f.storage.setItem(a,d):(void 0===e&&(e=ra),d=f.serialize(d),e?localStorage.setItem(a,d):"localstorage"!==f.storage&&Ob(a,d,30))))}function S(a,d,e){"none"===f.storage||"object"!==L(f.storage)&&!x?b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be removed"):(e||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a)),"object"===L(f.storage)&&"function"===typeof f.storage.removeItem?f.storage.removeItem(a):(void 0===d&&(d=ra),d?localStorage.removeItem(a):
...
this.passed_data.app_key===this.app_key||this.passed_data&&!this.passed_data.app_key&&Ya)&&this.passed_data.token&&this.passed_data.purpose){this.passed_data.token!==y("cly_old_token")&&(Nb(this.passed_data.token),w("cly_old_token",this.passed_data.token));var a=[];Array.isArray(this.heatmapWhitelist)?(this.heatmapWhitelist.push(this.url),a=this.heatmapWhitelist.map(function(r){return ta(r)})):a=[this.url];a.includes(this.passed_data.url)&&"heatmap"===this.passed_data.purpose&&(this.ignore_visitor=
!0,Fb(),Eb(this.passed_data.url+"/views/heatmap.js",Gb))}if(this.ignore_visitor)b(c.WARNING,"initialize, ignore_visitor:["+this.ignore_visitor+"], this user will not be tracked");else{"javascript_native_web"===va&&"23.12.3"===oa?b(c.DEBUG,"initialize, SDK name:["+va+"], version:["+oa+"]"):b(c.DEBUG,"initialize, SDK name:["+va+"], version:["+oa+"], default name:[javascript_native_web] and default version:[23.12.3]");b(c.DEBUG,"initialize, app_key:["+this.app_key+"], url:["+this.url+"]");b(c.DEBUG,
...
this.device_id=t("device_id",k,nb()),k&&Object.keys(k).length?void 0!==k.device_id&&(D=0):void 0!==p.device_id&&(D=0));w("cly_id",this.device_id);w("cly_id_type",D);if(d){ka={};for(var n in this.utm)e[n]?(this.userData.set("utm_"+n,e[n]),ka[n]=e[n]):this.userData.unset("utm_"+n);this.userData.save()}Aa();setTimeout(function(){Wa();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);x&&document.documentElement.setAttribute("data-countly-useragent",ua());qa.sendInstantHCRequest()}};this.halt=
function(){b(c.WARNING,"halt, Resetting Countly");p.i=void 0;Ya=!p.i;W=!1;mb="/i";Ua="/o/sdk";bb=500;Va=1E3;H=[];J=[];R={};sa=[];da={};ca=[];sb=null;Ia=!0;tb=0;X=null;lb=Ha=Ga=0;ab=60;Na=20;Oa=0;Za=60;Ka=100;wa=null;ia=!0;Ja=30;$a=!0;K=Xa=!1;ea={};pa=!0;Pb=F();ra=!0;xa=null;D=1;Ma=!1;La=0;ub=!1;ka=Da=ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(d){b(c.ERROR,"halt, Local storage test failed, will fallback to cookies"),ra=!1}p.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
"check_any_consent, require_consent is off, no consent is necessary"),!0;for(var a in E)if(E[a]&&E[a].optin)return!0;b(c.INFO,"check_any_consent, No consents given");return!1};this.add_consent=function(a){b(c.INFO,"add_consent, Adding consent for ["+a+"]");if(Array.isArray(a))for(var d=0;d<a.length;d++)this.add_consent(a[d]);else E[a]?E[a].features?(E[a].optin=!0,this.add_consent(E[a].features)):!0!==E[a].optin&&(E[a].optin=!0,Qb(),setTimeout(function(){"sessions"===a&&ea.begin_session?(f.begin_session.apply(f,
...
d):(E[a].optin=!1,d&&!1!==E[a].optin&&Qb()):b(c.WARNING,"remove_consent, No feature available for ["+a+"]")};var cb,Qb=function(){cb&&(clearTimeout(cb),cb=null);cb=setTimeout(function(){for(var a={},d=0;d<p.features.length;d++)a[p.features[d]]=!0===E[p.features[d]].optin?!0:!1;N({consent:JSON.stringify(a)});b(c.DEBUG,"Consent update request has been sent to the queue.")},1E3)};this.enable_offline_mode=function(){b(c.INFO,"enable_offline_mode, Enabling offline mode");this.remove_consent_internal(p.features,
!1);K=!0;this.device_id="[CLY]_temp_id";f.device_id=this.device_id;D=2};this.disable_offline_mode=function(a){if(K){b(c.INFO,"disable_offline_mode, Disabling offline mode");K=!1;a&&this.device_id!==a?(this.device_id=a,f.device_id=this.device_id,D=0,w("cly_id",this.device_id),w("cly_id_type",0),b(c.INFO,"disable_offline_mode, Changing id to: "+this.device_id)):(this.device_id=nb(),"[CLY]_temp_id"===this.device_id&&(this.device_id=gb()),f.device_id=this.device_id,this.device_id!==y("cly_id")&&(w("cly_id",
...
pa&&(pa=!1,tb=F()-ja,Ha=F()-Ga)};this.start_time=function(){b(c.INFO,"start_time, Starting tracking duration");pa||(pa=!0,ja=F()-tb,Ga=F()-Ha,Ha=0,Ba())};this.track_sessions=function(){function a(){document[e]||!document.hasFocus()?f.stop_time():f.start_time()}function d(){Oa>=Na&&f.start_time();Oa=0}if(x){b(c.INFO,"track_session, Starting tracking user session");this.begin_session();this.start_time();A(window,"beforeunload",function(){O();f.end_session()});var e="hidden";A(window,"focus",a);A(window,
...
d);A(window,"keydown",d);A(window,"scroll",d);setInterval(function(){Oa++;Oa>=Na&&f.stop_time()},6E4)}else b(c.WARNING,"track_sessions, window object is not available. Not tracking sessions.")};this.track_pageview=function(a,d,e){if(x||a)if(b(c.INFO,"track_pageview, Tracking page views"),b(c.VERBOSE,"track_pageview, last view is:["+X+"], current view ID is:["+ha+"], previous view ID is:["+Da+"]"),X&&ub&&(b(c.DEBUG,"track_pageview, Scroll registry triggered"),rb(),Ma=!0,La=0),ma(),Da=ha,ha=fb(),(a=
...
(m=Ib.exec(document.referrer))&&m[11]&&m[11]!==window.location.hostname&&(h.start=1);if(ka&&Object.keys(ka).length){b(c.INFO,"track_pageview, Adding fresh utm tags to segmentation:["+JSON.stringify(ka)+"]");for(var g in ka)"undefined"===typeof h["utm_"+g]&&(h["utm_"+g]=ka[g])}x&&ob()&&(b(c.INFO,"track_pageview, Adding referrer to segmentation:["+document.referrer+"]"),h.referrer=document.referrer);if(e){e=aa(e,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"track_pageview",b);for(var n in e)"undefined"===
...
a=a||document;var d=!0;A(a,"click",function(e){if(d){d=!1;jb(e);if("undefined"!==typeof e.pageX&&"undefined"!==typeof e.pageY){var h=Ra(),m=kb();f.check_consent("clicks")&&(e={type:"click",x:e.pageX,y:e.pageY,width:m,height:h,view:f.getViewUrl()},e=aa(e,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processClick",b),f.track_domains&&(e.domain=window.location.hostname),v({key:M.ACTION,segmentation:e}))}setTimeout(function(){d=!0},1E3)}})}else b(c.WARNING,"track_clicks, window object is not available. Not tracking clicks.")};
this.track_scrolls=function(a){x?(b(c.INFO,"track_scrolls, Starting to track scrolls"),a&&b(c.INFO,"track_scrolls, Tracking the specified children"),a=a||window,ub=Ma=!0,A(a,"scroll",Mb),A(a,"beforeunload",rb)):b(c.WARNING,"track_scrolls, window object is not available. Not tracking scrolls.")};this.track_links=function(a){x?(b(c.INFO,"track_links, Starting to track clicks to links"),a&&b(c.INFO,"track_links, Tracking the specified children"),a=a||document,A(a,"click",function(d){a:{var e=Qa(d);var h;
for(h="A";e;){if(e.nodeName.toUpperCase()===h)break a;e=e.parentElement}e=void 0}e&&(jb(d),f.check_consent("clicks")&&v({key:"linkClick",segmentation:{href:e.href,text:e.innerText,id:e.id,view:f.getViewUrl()}}))})):b(c.WARNING,"track_links, window object is not available. Not tracking links.")};this.track_forms=function(a,d){function e(h){return h.name||h.id||h.type||h.nodeName}x?(b(c.INFO,"track_forms, Starting to track form submissions. DOM object provided:["+!!a+"] Tracking hidden inputs :["+!!d+
...
g[e].is_active){var n=g[e].target_devices,r=Ab();if(n[r])if("string"===typeof g[e].hide_sticker&&(g[e].hide_sticker="true"===g[e].hide_sticker),"all"!==g[e].target_page||g[e].hide_sticker){var u=g[e].target_pages;for(h=0;h<u.length;h++){var I=u[h].substr(0,u[h].length-1)===window.location.pathname.substr(0,u[h].length-1),C=u[h]===window.location.pathname;(u[h].includes("*")&&I||C)&&!g[e].hide_sticker&&V(g[e],!0)}}else V(g[e],!0)}}catch(na){b(c.ERROR,"initializeRatingWidgets, JSON parse error: "+na)}},
...
if("rating"===a.type){var wb=document.createElement("div");wb.className="countly-ratings-overlay";wb.id="countly-ratings-overlay-"+a._id;Z.appendChild(wb);b(c.DEBUG,"present_feedback_widget, appended the rating overlay to wrapper");A(document.getElementById("countly-ratings-overlay-"+a._id),"click",function(){document.getElementById("countly-ratings-wrapper-"+a._id).style.display="none"})}Z.appendChild(C);b(c.DEBUG,"present_feedback_widget, Appended the iframe");A(window,"message",function(B){var U=
{};try{U=JSON.parse(B.data),b(c.DEBUG,"present_feedback_widget, Parsed response message "+U)}catch(Xb){b(c.ERROR,"present_feedback_widget, Error while parsing message body "+Xb)}U.close?(document.getElementById("countly-"+u+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display="none"):b(c.DEBUG,"present_feedback_widget, Closing signal not sent yet")});if("survey"===a.type){var P=!1;switch(a.showPolicy){case "afterPageLoad":"complete"===document.readyState?P||(P=!0,
...
case "cly_event":J=f.deserialize(d||"[]");break;case "cly_remote_configs":R=f.deserialize(d||"{}");break;case "cly_ignore":f.ignore_visitor=f.deserialize(d);break;case "cly_id":f.device_id=d;break;case "cly_id_type":D=f.deserialize(d)}};this._internals={store:w,getDocWidth:kb,getDocHeight:Ra,getViewportHeight:Cb,get_page_coord:jb,get_event_target:Qa,add_event_listener:A,createNewObjectFromProperties:za,truncateObject:aa,truncateSingleValue:z,stripTrailingSlash:ta,prepareParams:ya,sendXmlHttpRequest:Kb,
isResponseValid:qb,getInternalDeviceIdType:function(){return D},getMsTimestamp:hb,getTimestamp:F,isResponseValidBroad:pb,secureRandom:fb,log:b,checkIfLoggingIsOn:Ca,getMetrics:Ta,getUA:Jb,prepareRequest:Ea,generateUUID:gb,sendEventsForced:O,isUUID:function(a){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(a)},isReferrerUsable:ob,getId:nb,heartBeat:Wa,toRequestQueue:N,reportViewDuration:ma,loadJS:Eb,loadCSS:Sa,getLastView:function(){return X},setToken:Nb,
getToken:function(){var a=y("cly_token");S("cly_token");return a},showLoader:Fb,hideLoader:Gb,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:v,processScrollView:rb,processScroll:Mb,currentUserAgentString:ua,userAgentDeviceDetection:Ab,userAgentSearchBotDetection:Bb,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Lb,makeNetworkRequest:ba,clearQueue:function(){H=[];w("cly_queue",[]);J=[];w("cly_event",[])},getLocalQueues:function(){return{eventQ:J,
requestQ:H}}};var qa={sendInstantHCRequest:function(){var a=z(f.hcErrorMessage,1E3,"healthCheck",b);a={el:f.hcErrorCount,wl:f.hcWarningCount,sc:f.hcStatusCode,em:JSON.stringify(a)};a={hc:JSON.stringify(a),metrics:JSON.stringify({_app_version:f.app_version})};Ea(a);ba("[healthCheck]",f.url+mb,a,function(d){d||qa.resetAndSaveCounters()},!0)},resetAndSaveCounters:function(){qa.resetCounters();w(T.errorCount,f.hcErrorCount);w(T.warningCount,f.hcWarningCount);w(T.statusCode,f.hcStatusCode);w(T.errorMessage,
f.hcErrorMessage)},incrementErrorCount:function(){f.hcErrorCount++},incrementWarningCount:function(){f.hcWarningCount++},resetCounters:function(){f.hcErrorCount=0;f.hcWarningCount=0;f.hcStatusCode=-1;f.hcErrorMessage=""},saveRequestCounters:function(a,d){f.hcStatusCode=a;f.hcErrorMessage=d;w(T.statusCode,f.hcStatusCode);w(T.errorMessage,f.hcErrorMessage)}};this.initialize()}),Sb=!0;p.features="apm attribution clicks crashes events feedback forms location remote-config scrolls sessions star-rating users views".split(" ");
p.q=p.q||[];p.onload=p.onload||[];p.CountlyClass=Rb;p.init=function(k){k=k||{};if(p.loadAPMScriptsAsync&&Sb)Sb=!1,Ub(k);else{var q=k.app_key||p.app_key;if(!p.i||!p.i[q]){k=new Rb(k);if(!p.i){p.i={};for(var v in k)p[v]=k[v]}p.i[q]=k}return p.i[q]}};p.serialize=function(k){"object"===L(k)&&(k=JSON.stringify(k));return k};p.deserialize=function(k){if(""===k)return k;try{k=JSON.parse(k)}catch(q){Ca()&&console.warn("[WARNING] [Countly] deserialize, Could not parse the file:["+k+"], error: "+q)}return k};
