...
P)}}function Z(){var a;if("undefined"!==typeof g.onload&&0<g.onload.length){for(a=0;a<g.onload.length;a++)if("function"===typeof g.onload[a])g.onload[a](g);g.onload=[]}}function aa(){if(Q){var a={name:Q};g.check_consent("views")&&p({key:"[CLY]_view",dur:da?B()-ra:sa,segmentation:a});Q=null}}function qa(){if(ea){var a=y("cly_session");if(!a||parseInt(a)<=B())V=!1,g.begin_session(!ta);v("cly_session",B()+60*ua)}}function ba(a){a.app_key=g.app_key;a.device_id=g.device_id;a.sdk_name="javascript_native_web";
a.sdk_version="22.06.5";a.t=D;var b=kb();if(a.metrics){var e=JSON.parse(a.metrics);e._ua||(e._ua=b,a.metrics=JSON.stringify(e))}else a.metrics=JSON.stringify({_ua:b});g.check_consent("location")?(g.country_code&&(a.country_code=g.country_code),g.city&&(a.city=g.city),null!==g.ip_address&&(a.ip_address=g.ip_address)):a.location="";a.timestamp=Qa();b=new Date;a.hour=b.getHours();a.dow=b.getDay()}function F(a){g.ignore_visitor?c(d.WARNING,"User is opt_out will ignore the request: "+a):g.app_key&&g.device_id?
(ba(a),E.length>Fa&&E.shift(),E.push(a),v("cly_queue",E,!0)):c(d.ERROR,"app_key or device_id is missing ",g.app_key,g.device_id)}function Ga(){Z();if(g.ignore_visitor)Ha=!1,c(d.WARNING,"User opt_out, no heartbeat");else{Ha=!0;var a=0;if(Ia&&"undefined"!==typeof n.q&&0<n.q.length){var b=n.q;n.q=[];for(a=0;a<b.length;a++){var e=b[a];c(d.DEBUG,"Processing queued call",e);if("function"===typeof e)e();else if(Array.isArray(e)&&0<e.length){var k=g,l=0;n.i[e[l]]&&(k=n.i[e[l]],l++);if("function"===typeof k[e[l]])k[e[l]].apply(k,
e.slice(l+1));else if(0===e[l].indexOf("userData.")){var f=e[l].replace("userData.","");"function"===typeof k.userData[f]&&k.userData[f].apply(k,e.slice(l+1))}else"function"===typeof n[e[l]]&&n[e[l]].apply(n,e.slice(l+1))}}}V&&ta&&da&&(a=B(),a-fa>Ja&&(g.session_duration(a-fa),fa=a));0<H.length&&(H.length<=va?(F({events:JSON.stringify(H)}),H=[]):(a=H.splice(0,va),F({events:JSON.stringify(a)})),v("cly_event",H));!J&&0<E.length&&Ka&&B()>Ua&&(Ka=!1,a=E[0],c(d.DEBUG,"Processing request",a),v("cly_queue",
E,!0),g.test_mode||ca("send_request_queue",g.url+lb,a,function(m,q){c(d.DEBUG,"Request Finished",q,m);m?(Ua=B()+La,c(d.ERROR,"Request error: ",m)):E.shift();v("cly_queue",E,!0);Ka=!0},!1));setTimeout(Ga,Ma)}}function Va(){var a=y("cly_id");return a?(D=y("cly_id_type"),a):ab()}function kb(){return g.metrics._ua||la()}function Da(){var a=JSON.parse(JSON.stringify(g.metrics||{}));a._app_version=a._app_version||g.app_version;a._ua=a._ua||la();if(screen.width){var b=screen.width?parseInt(screen.width):
...
"undefined"!==typeof b&&(a._locale=a._locale||b);if("undefined"!==typeof document.referrer&&document.referrer.length&&(b=jb.exec(document.referrer))&&b[11]&&b[11]!==window.location.hostname){b=!1;if(R&&R.length)for(e=0;e<R.length;e++)try{if((new RegExp(R[e])).test(document.referrer)){c(d.DEBUG,"Ignored: "+document.referrer);b=!0;break}}catch(l){c(d.ERROR,"Problem with ignoring: "+R[e],", error: "+l)}b||(a._store=a._store||document.referrer)}c(d.DEBUG,"Got metrics",a);return a}function c(a,b){if(g.debug&&
"undefined"!==typeof console){arguments[2]&&"object"===typeof arguments[2]&&(arguments[2]=JSON.stringify(arguments[2]));Ia||(b="["+g.app_key+"] "+b);a||(a=d.DEBUG);for(var e="",k=2;k<arguments.length;k++)e+=arguments[k];e=a+b+e;a===d.ERROR?console.error(e):a===d.WARNING?console.warn(e):a===d.INFO?console.info(e):a===d.VERBOSE?console.log(e):console.debug(e)}}function ca(a,b,e,k,l){l=l||!1;try{c(d.DEBUG,"Sending XML HTTP request");var f=null;window.XMLHttpRequest?f=new window.XMLHttpRequest:window.ActiveXObject&&
(f=new window.ActiveXObject("Microsoft.XMLHTTP"));e=e||{};var m=bb(e),q="GET";if(g.force_post||2E3<=m.length)q="POST";"GET"===q?f.open("GET",b+"?"+m,!0):(f.open("POST",b,!0),f.setRequestHeader("Content-type","application/x-www-form-urlencoded"));for(var t in g.headers)f.setRequestHeader(t,g.headers[t]);f.onreadystatechange=function(){4===this.readyState&&(c(d.DEBUG,a+" HTTP request completed ["+this.status+"]["+this.responseText+"]"),(l?mb(this.status,this.responseText):nb(this.status,this.responseText))?
"function"===typeof k&&k(!1,e,this.responseText):(c(d.ERROR,a+" Failed Server XML HTTP request, ",this.status),"function"===typeof k&&k(!0,e)))};"GET"===q?f.send():f.send(m)}catch(I){c(d.ERROR,a+" Failed XML HTTP request: "+I),"function"===typeof k&&k(!0,e)}}function nb(a,b){if(!(200<=a&&300>a))return c(d.ERROR,"Http response status code is not within the expected range:["+a+"]"),!1;try{var e=JSON.parse(b);return"[object Object]"!==Object.prototype.toString.call(e)?(c(d.ERROR,"Http response is not JSON Object"),
!1):!!e.result}catch(k){return c(d.ERROR,"Http response is not JSON: "+k),!1}}function mb(a,b){if(!(200<=a&&300>a))return c(d.ERROR,"Http response status code is not within the expected range: "+a),!1;try{var e=JSON.parse(b);return"[object Object]"===Object.prototype.toString.call(e)||Array.isArray(e)?!0:(c(d.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(k){return c(d.ERROR,"Http response is not JSON: "+k),!1}}function ob(){wa=Math.max(wa,window.scrollY,document.body.scrollTop,
document.documentElement.scrollTop)}function Wa(){if(xa){xa=!1;var a=Ba(),b=Ta(),e=eb();g.check_consent("scrolls")&&(a={type:"scroll",y:wa+e,width:b,height:a,view:g.getViewUrl()},a=U(a,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"processScrollView",c),g.track_domains&&(a.domain=window.location.hostname),p({key:"[CLY]_action",segmentation:a}))}}function pb(a){v("cly_token",a)}function qb(a,b,e){var k=new Date;k.setTime(k.getTime()+864E5*e);e="; expires="+k.toGMTString();document.cookie=a+
"="+b+e+"; path=/"}function y(a,b,e){if("none"===g.storage)c(d.WARNING,"Storage is disabled. Value with key: "+a+" won't be retrieved");else{e||(a=g.app_key+"/"+a,g.namespace&&(a=ka(g.namespace)+"/"+a));void 0===b&&(b=ha);if(b)var k=localStorage.getItem(a);else if("localstorage"!==g.storage)a:{a+="=";b=document.cookie.split(";");e=0;for(k=b.length;e<k;e++){for(var l=b[e];" "===l.charAt(0);)l=l.substring(1,l.length);if(0===l.indexOf(a)){k=l.substring(a.length,l.length);break a}}k=null}return g.deserialize(k)}}
function v(a,b,e,k){"none"===g.storage?c(d.WARNING,"Storage is disabled. Value with key: "+a+" won't be stored"):(k||(a=g.app_key+"/"+a,g.namespace&&(a=ka(g.namespace)+"/"+a)),void 0===e&&(e=ha),"undefined"!==typeof b&&null!==b&&(b=g.serialize(b),e?localStorage.setItem(a,b):"localstorage"!==g.storage&&qb(a,b,30)))}function S(a,b,e){"none"===g.storage?c(d.WARNING,"Storage is disabled. Value with key: "+a+" won't be removed"):(e||(a=g.app_key+"/"+a,g.namespace&&(a=ka(g.namespace)+"/"+a)),void 0===b&&
(b=ha),b?localStorage.removeItem(a):"localstorage"!==g.storage&&qb(a,"",-1))}function tb(){if(y(g.namespace+"cly_id",!1,!0)){v("cly_id",y(g.namespace+"cly_id",!1,!0));v("cly_id_type",y(g.namespace+"cly_id_type",!1,!0));v("cly_event",y(g.namespace+"cly_event",!1,!0));v("cly_session",y(g.namespace+"cly_session",!1,!0));var a=y(g.namespace+"cly_queue",!1,!0);Array.isArray(a)&&(a=a.filter(function(b){return b.app_key===g.app_key}),v("cly_queue",a));y(g.namespace+"cly_cmp_id",!1,!0)&&(v("cly_cmp_id",y(g.namespace+
"cly_cmp_id",!1,!0)),v("cly_cmp_uid",y(g.namespace+"cly_cmp_uid",!1,!0)));y(g.namespace+"cly_ignore",!1,!0)&&v("cly_ignore",y(g.namespace+"cly_ignore",!1,!0));S("cly_id",!1,!0);S("cly_id_type",!1,!0);S("cly_event",!1,!0);S("cly_session",!1,!0);S("cly_queue",!1,!0);S("cly_cmp_id",!1,!0);S("cly_cmp_uid",!1,!0);S("cly_ignore",!1,!0)}}var g=this,Ia=!n.i,V=!1,lb="/i",Ea="/o/sdk",Ma=r("interval",h,500),Fa=r("queue_size",h,1E3),E=[],H=[],M={},ia=[],W={},R=r("ignore_referrers",h,[]),Xa=null,ta=!0,fa,Ya=0,
Q=null,ra=0,sa=0,Ua=0,La=r("fail_timeout",h,60),ya=r("inactivity_time",h,20),za=0,Ja=r("session_update",h,60),va=r("max_events",h,100),na=r("max_logs",h,null),ea=r("use_session_cookie",h,!0),ua=r("session_cookie_timeout",h,30),Ka=!0,Ha=!1,J=r("offline_mode",h,!1),X={},da=!0,rb=B(),ha=!0,oa=null,D=1,xa=!1,wa=0;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){c(d.ERROR,"Local storage test failed, Halting local storage support: "+a),ha=!1}for(var A={},Za=
0;Za<n.features.length;Za++)A[n.features[Za]]={};this.initialize=function(){this.serialize=r("serialize",h,n.serialize);this.deserialize=r("deserialize",h,n.deserialize);this.getViewName=r("getViewName",h,n.getViewName);this.getViewUrl=r("getViewUrl",h,n.getViewUrl);this.getSearchQuery=r("getSearchQuery",h,n.getSearchQuery);this.DeviceIdType=n.DeviceIdType;this.namespace=r("namespace",h,"");this.clearStoredId=r("clear_stored_id",h,!1);this.app_key=r("app_key",h,null);this.onload=r("onload",h,[]);
this.utm=r("utm",h,{source:!0,medium:!0,campaign:!0,term:!0,content:!0});this.ignore_prefetch=r("ignore_prefetch",h,!0);this.rcAutoOptinAb=r("rc_automatic_optin_for_ab",h,!0);this.useExplicitRcApi=r("use_explicit_rc_api",h,!1);this.debug=r("debug",h,!1);this.test_mode=r("test_mode",h,!1);this.metrics=r("metrics",h,{});this.headers=r("headers",h,{});this.url=ka(r("url",h,""));this.app_version=r("app_version",h,"0.0");this.country_code=r("country_code",h,null);this.city=r("city",h,null);this.ip_address=
r("ip_address",h,null);this.ignore_bots=r("ignore_bots",h,!0);this.force_post=r("force_post",h,!1);this.remote_config=r("remote_config",h,!1);this.ignore_visitor=r("ignore_visitor",h,!1);this.require_consent=r("require_consent",h,!1);this.track_domains=r("track_domains",h,!0);this.storage=r("storage",h,"default");this.enableOrientationTracking=r("enable_orientation_tracking",h,!0);this.maxKeyLength=r("max_key_length",h,128);this.maxValueSize=r("max_value_size",h,256);this.maxSegmentationValues=r("max_segmentation_values",
h,30);this.maxBreadcrumbCount=r("max_breadcrumb_count",h,null);this.maxStackTraceLinesPerThread=r("max_stack_trace_lines_per_thread",h,30);this.maxStackTraceLineLength=r("max_stack_trace_line_length",h,200);this.heatmapWhitelist=r("heatmap_whitelist",h,[]);na&&!this.maxBreadcrumbCount?(this.maxBreadcrumbCount=na,c(d.WARNING,"initialize, 'maxCrashLogs' is deprecated. Use 'maxBreadcrumbCount' instead!")):na||this.maxBreadcrumbCount||(this.maxBreadcrumbCount=100);"cookie"===this.storage&&(ha=!1);this.rcAutoOptinAb||
this.useExplicitRcApi||(c(d.WARNING,"initialize, Auto opting is disabled, switching to explicit RC API"),this.useExplicitRcApi=!0);Array.isArray(R)||(R=[]);""===this.url&&(c(d.ERROR,"initialize, Please provide server URL"),this.ignore_visitor=!0);y("cly_ignore")&&(this.ignore_visitor=!0);tb();this.clearStoredId&&(c(d.INFO,"initialize, Clearing the device ID storage"),localStorage.removeItem(this.app_key+"/cly_id"),localStorage.removeItem(this.app_key+"/cly_id_type"));E=y("cly_queue")||[];H=y("cly_event")||
[];M=y("cly_remote_configs")||{};C();if(window.name&&0===window.name.indexOf("cly:"))try{this.passed_data=JSON.parse(window.name.replace("cly:",""))}catch(q){c(d.ERROR,"initialize, Could not parse name: "+window.name+", error: "+q)}else if(location.hash&&0===location.hash.indexOf("#cly:"))try{this.passed_data=JSON.parse(location.hash.replace("#cly:",""))}catch(q){c(d.ERROR,"initialize, Could not parse hash: "+location.hash+", error: "+q)}if((this.passed_data&&this.passed_data.app_key&&this.passed_data.app_key===
this.app_key||this.passed_data&&!this.passed_data.app_key&&Ia)&&this.passed_data.token&&this.passed_data.purpose){this.passed_data.token!==y("cly_old_token")&&(pb(this.passed_data.token),v("cly_old_token",this.passed_data.token));var a=[];Array.isArray(this.heatmapWhitelist)?(this.heatmapWhitelist.push(this.url),a=this.heatmapWhitelist.map(function(q){return ka(q)})):a=[this.url];a.includes(this.passed_data.url)&&"heatmap"===this.passed_data.purpose&&(this.ignore_visitor=!0,hb(),gb(this.passed_data.url+
"/views/heatmap.js",ib))}if(this.ignore_visitor)c(d.WARNING,"initialize, ignore_visitor:["+this.ignore_visitor+"], this user will not be tracked");else{c(d.DEBUG,"initialize, app_key:["+this.app_key+"], url:["+this.url+"]");c(d.DEBUG,"initialize, device_id:["+r("device_id",h,void 0)+"]");c(d.DEBUG,"initialize, require_consent is enabled:["+this.require_consent+"]");try{c(d.DEBUG,"initialize, metric override:["+JSON.stringify(this.metrics)+"]"),c(d.DEBUG,"initialize, header override:["+JSON.stringify(this.headers)+
"]"),c(d.DEBUG,"initialize, number of onload callbacks provided:["+this.onload.length+"]"),c(d.DEBUG,"initialize, utm tags:["+JSON.stringify(this.utm)+"]"),R&&c(d.DEBUG,"initialize, referrers to ignore :["+JSON.stringify(R)+"]")}catch(q){c(d.ERROR,"initialize, Could not stringify some config object values")}c(d.DEBUG,"initialize, app_version:["+this.app_version+"]");c(d.DEBUG,"initialize, provided location info; country_code:["+this.country_code+"], city:["+this.city+"], ip_address:["+this.ip_address+
"]");""!==this.namespace&&c(d.DEBUG,"initialize, namespace given:["+this.namespace+"]");this.clearStoredId&&c(d.DEBUG,"initialize, clearStoredId flag set to:["+this.clearStoredId+"]");this.ignore_prefetch&&c(d.DEBUG,"initialize, ignoring pre-fetching and pre-rendering from counting as real website visits :["+this.ignore_prefetch+"]");this.test_mode&&c(d.WARNING,"initialize, test_mode:["+this.test_mode+"], queues won't be processed");this.heatmapWhitelist&&c(d.DEBUG,"initialize, heatmap whitelist:["+
JSON.stringify(this.heatmapWhitelist)+"], these domains will be whitelisted");"default"!==this.storage&&c(d.DEBUG,"initialize, storage is set to:["+this.storage+"]");this.ignore_bots&&c(d.DEBUG,"initialize, ignore traffic from bots :["+this.ignore_bots+"]");this.force_post&&c(d.DEBUG,"initialize, forced post method for all requests:["+this.force_post+"]");this.remote_config&&c(d.DEBUG,"initialize, remote_config callback provided:["+!!this.remote_config+"]");"boolean"===typeof this.rcAutoOptinAb&&
c(d.DEBUG,"initialize, automatic RC optin is enabled:["+this.rcAutoOptinAb+"]");this.useExplicitRcApi||c(d.WARNING,"initialize, will use legacy RC API. Consider enabling new API during init with use_explicit_rc_api flag");this.track_domains&&c(d.DEBUG,"initialize, tracking domain info:["+this.track_domains+"]");this.enableOrientationTracking&&c(d.DEBUG,"initialize, enableOrientationTracking:["+this.enableOrientationTracking+"]");ea||c(d.WARNING,"initialize, use_session_cookie is enabled:["+ea+"]");
J&&c(d.DEBUG,"initialize, offline_mode:["+J+"], user info won't be send to the servers");J&&c(d.DEBUG,"initialize, stored remote configs:["+JSON.stringify(M)+"]");c(d.DEBUG,"initialize, 'getViewName' callback override provided:["+!!this.getViewName+"]");c(d.DEBUG,"initialize, 'getSearchQuery' callback override provided:["+!!this.getSearchQuery+"]");128!==this.maxKeyLength&&c(d.DEBUG,"initialize, maxKeyLength set to:["+this.maxKeyLength+"] characters");256!==this.maxValueSize&&c(d.DEBUG,"initialize, maxValueSize set to:["+
this.maxValueSize+"] characters");30!==this.maxSegmentationValues&&c(d.DEBUG,"initialize, maxSegmentationValues set to:["+this.maxSegmentationValues+"] key/value pairs");100!==this.maxBreadcrumbCount&&c(d.DEBUG,"initialize, maxBreadcrumbCount for custom logs set to:["+this.maxBreadcrumbCount+"] entries");30!==this.maxStackTraceLinesPerThread&&c(d.DEBUG,"initialize, maxStackTraceLinesPerThread set to:["+this.maxStackTraceLinesPerThread+"] lines");200!==this.maxStackTraceLineLength&&c(d.DEBUG,"initialize, maxStackTraceLineLength set to:["+
this.maxStackTraceLineLength+"] characters");500!==Ma&&c(d.DEBUG,"initialize, interval for heartbeats set to:["+Ma+"] milliseconds");1E3!==Fa&&c(d.DEBUG,"initialize, queue_size set to:["+Fa+"] items max");60!==La&&c(d.DEBUG,"initialize, fail_timeout set to:["+La+"] seconds of wait time after a failed connection to server");20!==ya&&c(d.DEBUG,"initialize, inactivity_time set to:["+ya+"] minutes to consider a user as inactive after no observable action");60!==Ja&&c(d.DEBUG,"initialize, session_update set to:["+
Ja+"] seconds to check if extending a session is needed while the user is active");100!==va&&c(d.DEBUG,"initialize, max_events set to:["+va+"] events to send in one batch");na&&c(d.WARNING,"initialize, max_logs set to:["+na+"] breadcrumbs to store for crash logs max, deprecated ");30!==ua&&c(d.DEBUG,"initialize, session_cookie_timeout set to:["+ua+"] minutes to expire a cookies session");c(d.INFO,"initialize, Countly initialized");a=null;var b=g.getSearchQuery(),e=!1,k={};if(b){b=b.substring(1).split("&");
for(var l=0;l<b.length;l++){var f=b[l].split("=");"cly_id"===f[0]?v("cly_cmp_id",f[1]):"cly_uid"===f[0]?v("cly_cmp_uid",f[1]):"cly_device_id"===f[0]?a=f[1]:0===(f[0]+"").indexOf("utm_")&&this.utm[f[0].replace("utm_","")]&&(k[f[0].replace("utm_","")]=f[1],e=!0)}}b="[CLY]_temp_id"===y("cly_id");l=r("device_id",h,void 0);y("cly_id")&&!b?(this.device_id=y("cly_id"),c(d.INFO,"initialize, Set the stored device ID"),D=y("cly_id_type"),D||(c(d.INFO,"initialize, No device ID type info from the previous session, falling back to DEVELOPER_SUPPLIED"),
D=0)):null!==a?(c(d.INFO,"initialize, Device ID set by URL"),this.device_id=a,D=3):l?(c(d.INFO,"initialize, Device ID set by developer"),this.device_id=l,h&&Object.keys(h).length?void 0!==h.device_id&&(D=0):void 0!==n.device_id&&(D=0)):J||b?(this.device_id="[CLY]_temp_id",D=2,J&&b?c(d.INFO,"initialize, Temp ID set, continuing offline mode from previous app session"):J&&!b?c(d.INFO,"initialize, Temp ID set, entering offline mode"):(J=!0,c(d.INFO,"initialize, Temp ID set, enabling offline mode"))):
(c(d.INFO,"initialize, Generating the device ID"),this.device_id=r("device_id",h,Va()),h&&Object.keys(h).length?void 0!==h.device_id&&(D=0):void 0!==n.device_id&&(D=0));v("cly_id",this.device_id);v("cly_id_type",D);if(e){for(var m in this.utm)k[m]?this.userData.set("utm_"+m,k[m]):this.userData.unset("utm_"+m);this.userData.save()}Z();setTimeout(function(){Ga();g.remote_config&&g.fetch_remote_config(g.remote_config)},1);document.documentElement.setAttribute("data-countly-useragent",la())}};this.halt=
function(){c(d.WARNING,"halt, Resetting Countly");n.i=void 0;Ia=!n.i;V=!1;lb="/i";Ea="/o/sdk";Ma=500;Fa=1E3;E=[];H=[];M={};ia=[];W={};R=[];Xa=null;ta=!0;Ya=0;Q=null;Ua=sa=ra=0;La=60;ya=20;za=0;Ja=60;va=100;na=null;ea=!0;ua=30;Ka=!0;J=Ha=!1;X={};da=!0;rb=B();ha=!0;oa=null;D=1;xa=!1;wa=0;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(b){c(d.ERROR,"halt, Local storage test failed, will fallback to cookies"),ha=!1}n.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
A={};for(var a=0;a<n.features.length;a++)A[n.features[a]]={};g.app_key=void 0;g.device_id=void 0;g.onload=void 0;g.utm=void 0;g.ignore_prefetch=void 0;g.debug=void 0;g.test_mode=void 0;g.metrics=void 0;g.headers=void 0;g.url=void 0;g.app_version=void 0;g.country_code=void 0;g.city=void 0;g.ip_address=void 0;g.ignore_bots=void 0;g.force_post=void 0;g.rcAutoOptinAb=void 0;g.useExplicitRcApi=void 0;g.remote_config=void 0;g.ignore_visitor=void 0;g.require_consent=void 0;g.track_domains=void 0;g.storage=
void 0;g.enableOrientationTracking=void 0;g.maxKeyLength=void 0;g.maxValueSize=void 0;g.maxSegmentationValues=void 0;g.maxBreadcrumbCount=void 0;g.maxStackTraceLinesPerThread=void 0;g.maxStackTraceLineLength=void 0};this.group_features=function(a){c(d.INFO,"group_features, Grouping features");if(a)for(var b in a)A[b]?c(d.WARNING,"group_features, Feature name ["+b+"] is already reserved"):"string"===typeof a[b]?A[b]={features:[a[b]]}:a[b]&&Array.isArray(a[b])&&a[b].length?A[b]={features:a[b]}:c(d.ERROR,
"group_features, Incorrect feature list for ["+b+"] value: ["+a[b]+"]");else c(d.ERROR,"group_features, Incorrect features:["+a+"]")};this.check_consent=function(a){c(d.INFO,"check_consent, Checking if consent is given for specific feature:["+a+"]");if(!this.require_consent)return c(d.INFO,"check_consent, require_consent is off, no consent is necessary"),!0;if(A[a])return!(!A[a]||!A[a].optin);c(d.ERROR,"check_consent, No feature available for ["+a+"]");return!1};this.get_device_id_type=function(){c(d.INFO,
"check_device_id_type, Retrieving the current device id type.["+D+"]");switch(D){case 1:var a=g.DeviceIdType.SDK_GENERATED;break;case 3:case 0:a=g.DeviceIdType.DEVELOPER_SUPPLIED;break;case 2:a=g.DeviceIdType.TEMPORARY_ID;break;default:a=-1}return a};this.get_device_id=function(){c(d.INFO,"get_device_id, Retrieving the device id: ["+this.device_id+"]");return this.device_id};this.check_any_consent=function(){c(d.INFO,"check_any_consent, Checking if any consent is given");if(!this.require_consent)return c(d.INFO,
"check_any_consent, require_consent is off, no consent is necessary"),!0;for(var a in A)if(A[a]&&A[a].optin)return!0;c(d.INFO,"check_any_consent, No consents given");return!1};this.add_consent=function(a){c(d.INFO,"add_consent, Adding consent for ["+a+"]");if(Array.isArray(a))for(var b=0;b<a.length;b++)this.add_consent(a[b]);else A[a]?A[a].features?(A[a].optin=!0,this.add_consent(A[a].features)):!0!==A[a].optin&&(A[a].optin=!0,sb(),setTimeout(function(){"sessions"===a&&X.begin_session?(g.begin_session.apply(g,
X.begin_session),X.begin_session=null):"views"===a&&X.track_pageview&&(Q=null,g.track_pageview.apply(g,X.track_pageview),X.track_pageview=null)},1)):c(d.ERROR,"add_consent, No feature available for ["+a+"]")};this.remove_consent=function(a){c(d.INFO,"remove_consent, Removing consent for ["+a+"]");this.remove_consent_internal(a,!0)};this.remove_consent_internal=function(a,b){b=b||!1;if(Array.isArray(a))for(var e=0;e<a.length;e++)this.remove_consent_internal(a[e],b);else A[a]?A[a].features?this.remove_consent_internal(A[a].features,
b):(A[a].optin=!1,b&&!1!==A[a].optin&&sb()):c(d.ERROR,"remove_consent, No feature available for ["+a+"]")};var Na,sb=function(){Na&&(clearTimeout(Na),Na=null);Na=setTimeout(function(){for(var a={},b=0;b<n.features.length;b++)a[n.features[b]]=!0===A[n.features[b]].optin?!0:!1;F({consent:JSON.stringify(a)});c(d.DEBUG,"Consent update request has been sent to the queue.")},1E3)};this.enable_offline_mode=function(){c(d.INFO,"enable_offline_mode, Enabling offline mode");this.remove_consent_internal(n.features,
!1);J=!0;this.device_id="[CLY]_temp_id";D=2};this.disable_offline_mode=function(a){c(d.INFO,"disable_offline_mode, Disabling offline mode");J=!1;a&&this.device_id!==a?(this.device_id=a,D=0,v("cly_id",this.device_id),v("cly_id_type",0),c(d.INFO,"disable_offline_mode, Changing id to: "+this.device_id)):(this.device_id=Va(),this.device_id!==y("cly_id")&&(v("cly_id",this.device_id),v("cly_id_type",1)));a=!1;if(0<E.length)for(var b=0;b<E.length;b++)"[CLY]_temp_id"===E[b].device_id&&(E[b].device_id=this.device_id,
a=!0);a&&v("cly_queue",E,!0)};this.begin_session=function(a,b){c(d.INFO,"begin_session, Starting the session");a&&c(d.INFO,"begin_session, Heartbeats are disabled");b&&c(d.INFO,"begin_session, Session starts irrespective of session cookie");if(this.check_consent("sessions")){if(!V){this.enableOrientationTracking&&(this.report_orientation(),x(window,"resize",function(){g.report_orientation()}));fa=B();V=!0;ta=!a;var e=y("cly_session");if(b||!ea||!e||parseInt(e)<=B())c(d.INFO,"begin_session, Session started"),
null===oa&&(oa=!0),e={begin_session:1},e.metrics=JSON.stringify(Da()),F(e);v("cly_session",B()+60*ua)}}else X.begin_session=arguments};this.session_duration=function(a){c(d.INFO,"session_duration, Reporting session duration");this.check_consent("sessions")&&V&&(c(d.INFO,"session_duration, Session extended: ",a),F({session_duration:a}),qa())};this.end_session=function(a,b){c(d.INFO,"end_session, Ending the current session");this.check_consent("sessions")&&V&&(a=a||B()-fa,aa(),!ea||b?(c(d.INFO,"end_session, Session ended"),
F({end_session:1,session_duration:a})):this.session_duration(a),V=!1)};this.change_id=function(a,b){c(d.INFO,"change_id, Changing the ID");b&&c(d.INFO,"change_id, Will merge the IDs");if(!a||"string"!==typeof a||0===a.length)c(d.ERROR,"change_id, The provided ID: ["+a+"] is not a valid ID");else if(J)c(d.WARNING,"change_id, Offline mode was on, initiating disabling sequence instead."),this.disable_offline_mode(a);else if(this.device_id!==a){b||(G(),this.end_session(null,!0),W={},this.remove_consent_internal(n.features,
...
case "[CLY]_star_rating":b=this.check_consent("star-rating");break;case "[CLY]_view":b=this.check_consent("views");break;case "[CLY]_orientation":b=this.check_consent("users");break;case "[CLY]_push_action":b=this.check_consent("push");break;case "[CLY]_action":b=this.check_consent("clicks")||this.check_consent("scroll");break;default:b=this.check_consent("events")}b&&p(a)};this.start_event=function(a){a&&"string"===typeof a?(c(d.INFO,"start_event, Starting timed event with key: ["+a+"]"),a=w(a,g.maxKeyLength,
"start_event",c),W[a]?c(d.WARNING,"start_event, Timed event with key: ["+a+"] already started"):W[a]=B()):c(d.WARNING,"start_event, you have to provide a valid string key instead of: ["+a+"]")};this.cancel_event=function(a){if(!a||"string"!==typeof a)return c(d.WARNING,"cancel_event, you have to provide a valid string key instead of: ["+a+"]"),!1;c(d.INFO,"cancel_event, Canceling timed event with key: ["+a+"]");a=w(a,g.maxKeyLength,"cancel_event",c);if(W[a])return delete W[a],c(d.INFO,"cancel_event, Timed event with key: ["+
a+"] is canceled"),!0;c(d.WARNING,"cancel_event, Timed event with key: ["+a+"] was not found");return!1};this.end_event=function(a){a?(c(d.INFO,"end_event, Ending timed event"),"string"===typeof a&&(a=w(a,g.maxKeyLength,"end_event",c),a={key:a}),a.key?W[a.key]?(a.dur=B()-W[a.key],this.add_event(a),delete W[a.key]):c(d.ERROR,"end_event, Timed event with key: ["+a.key+"] was not started"):c(d.ERROR,"end_event, Timed event must have a key property")):c(d.WARNING,"end_event, you have to provide a valid string key or event object instead of: ["+
a+"]")};this.report_orientation=function(a){c(d.INFO,"report_orientation, Reporting orientation");this.check_consent("users")&&p({key:"[CLY]_orientation",segmentation:{mode:a||(window.innerWidth>window.innerHeight?"landscape":"portrait")}})};this.report_conversion=function(a,b){c(d.WARNING,"report_conversion, Deprecated function call! Use 'recordDirectAttribution' in place of this call. Call will be redirected now!");this.recordDirectAttribution(a,b)};this.recordDirectAttribution=function(a,b){c(d.INFO,
"recordDirectAttribution, Recording the attribution for campaign ID: ["+a+"] and the user ID: ["+b+"]");this.check_consent("attribution")&&(a=a||y("cly_cmp_id")||"cly_organic",(b=b||y("cly_cmp_uid"))?F({campaign_id:a,campaign_user:b}):F({campaign_id:a}))};this.user_details=function(a){c(d.INFO,"user_details, Trying to add user details: ",a);this.check_consent("users")&&(G(),c(d.INFO,"user_details, flushed the event queue"),a.name=w(a.name,g.maxValueSize,"user_details",c),a.username=w(a.username,g.maxValueSize,
"user_details",c),a.email=w(a.email,g.maxValueSize,"user_details",c),a.organization=w(a.organization,g.maxValueSize,"user_details",c),a.phone=w(a.phone,g.maxValueSize,"user_details",c),a.picture=w(a.picture,4096,"user_details",c),a.gender=w(a.gender,g.maxValueSize,"user_details",c),a.byear=w(a.byear,g.maxValueSize,"user_details",c),a.custom=U(a.custom,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"user_details",c),F({user_details:JSON.stringify(pa(a,"name username email organization phone picture gender byear custom".split(" ")))}))};
var T={},Y=function(a,b,e){g.check_consent("users")&&(T[a]||(T[a]={}),"$push"===e||"$pull"===e||"$addToSet"===e?(T[a][e]||(T[a][e]=[]),T[a][e].push(b)):T[a][e]=b)};this.userData={set:function(a,b){c(d.INFO,"set, Setting user's custom property value: ["+b+"] under the key: ["+a+"]");a=w(a,g.maxKeyLength,"userData set",c);b=w(b,g.maxValueSize,"userData set",c);T[a]=b},unset:function(a){c(d.INFO,"unset, Resetting user's custom property with key: ["+a+"] ");T[a]=""},set_once:function(a,b){c(d.INFO,"set_once, Setting user's unique custom property value: ["+
b+"] under the key: ["+a+"] ");a=w(a,g.maxKeyLength,"userData set_once",c);b=w(b,g.maxValueSize,"userData set_once",c);Y(a,b,"$setOnce")},increment:function(a){c(d.INFO,"increment, Increasing user's custom property value under the key: ["+a+"] by one");a=w(a,g.maxKeyLength,"userData increment",c);Y(a,1,"$inc")},increment_by:function(a,b){c(d.INFO,"increment_by, Increasing user's custom property value under the key: ["+a+"] by: ["+b+"]");a=w(a,g.maxKeyLength,"userData increment_by",c);b=w(b,g.maxValueSize,
"userData increment_by",c);Y(a,b,"$inc")},multiply:function(a,b){c(d.INFO,"multiply, Multiplying user's custom property value under the key: ["+a+"] by: ["+b+"]");a=w(a,g.maxKeyLength,"userData multiply",c);b=w(b,g.maxValueSize,"userData multiply",c);Y(a,b,"$mul")},max:function(a,b){c(d.INFO,"max, Saving user's maximum custom property value compared to the value: ["+b+"] under the key: ["+a+"]");a=w(a,g.maxKeyLength,"userData max",c);b=w(b,g.maxValueSize,"userData max",c);Y(a,b,"$max")},min:function(a,
b){c(d.INFO,"min, Saving user's minimum custom property value compared to the value: ["+b+"] under the key: ["+a+"]");a=w(a,g.maxKeyLength,"userData min",c);b=w(b,g.maxValueSize,"userData min",c);Y(a,b,"$min")},push:function(a,b){c(d.INFO,"push, Pushing a value: ["+b+"] under the key: ["+a+"] to user's custom property array");a=w(a,g.maxKeyLength,"userData push",c);b=w(b,g.maxValueSize,"userData push",c);Y(a,b,"$push")},push_unique:function(a,b){c(d.INFO,"push_unique, Pushing a unique value: ["+b+
"] under the key: ["+a+"] to user's custom property array");a=w(a,g.maxKeyLength,"userData push_unique",c);b=w(b,g.maxValueSize,"userData push_unique",c);Y(a,b,"$addToSet")},pull:function(a,b){c(d.INFO,"pull, Removing the value: ["+b+"] under the key: ["+a+"] from user's custom property array");Y(a,b,"$pull")},save:function(){c(d.INFO,"save, Saving changes to user's custom property");g.check_consent("users")&&(G(),c(d.INFO,"user_details, flushed the event queue"),F({user_details:JSON.stringify({custom:T})}));
T={}}};this.report_trace=function(a){c(d.INFO,"report_trace, Reporting performance trace");if(this.check_consent("apm")){for(var b="type name stz etz apm_metrics apm_attr".split(" "),e=0;e<b.length;e++)if("apm_attr"!==b[e]&&"undefined"===typeof a[b[e]]){c(d.WARNING,"report_trace, APM trace don't have the property: "+b[e]);return}a.name=w(a.name,g.maxKeyLength,"report_trace",c);a.app_metrics=U(a.app_metrics,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"report_trace",c);b=pa(a,b);b.timestamp=
a.stz;a=new Date;b.hour=a.getHours();b.dow=a.getDay();F({apm:JSON.stringify(b)});c(d.INFO,"report_trace, Successfully adding APM trace: ",b)}};this.track_errors=function(a){c(d.INFO,"track_errors, Started tracking errors");n.i[this.app_key].tracking_crashes=!0;window.cly_crashes||(window.cly_crashes=!0,Xa=a,window.onerror=function q(e,k,l,f,m){if(void 0!==m&&null!==m)Ra(m,!1);else{f=f||window.event&&window.event.errorCharacter;m="";"undefined"!==typeof e&&(m+=e+"\n");"undefined"!==typeof k&&(m+="at "+
k);"undefined"!==typeof l&&(m+=":"+l);"undefined"!==typeof f&&(m+=":"+f);m+="\n";try{e=[];for(var t=q.caller;t;)e.push(t.name),t=t.caller;m+=e.join("\n")}catch(I){c(d.ERROR,"track_errors, Call stack generation experienced a problem: "+I)}Ra(m,!1)}},window.addEventListener("unhandledrejection",function(e){Ra(Error("Unhandled rejection (reason: "+(e.reason&&e.reason.stack?e.reason.stack:e.reason)+")."),!0)}))};this.log_error=function(a,b){c(d.INFO,"log_error, Logging errors");this.recordError(a,!0,
b)};this.add_log=function(a){c(d.INFO,"add_log, Adding a new log of breadcrumbs: [ "+a+" ]");if(this.check_consent("crashes")){for(a=w(a,g.maxValueSize,"add_log",c);ia.length>=g.maxBreadcrumbCount;)ia.shift(),c(d.WARNING,"add_log, Reached maximum crashLogs size. Will erase the oldest one.");ia.push(a)}};this.fetch_remote_config=function(a,b,e){var k=null,l=null,f=null;a&&(e||"function"!==typeof a?Array.isArray(a)&&(k=a):f=a);b&&(e||"function"!==typeof b?Array.isArray(b)&&(l=b):f=b);f||"function"!==
typeof e||(f=e);this.useExplicitRcApi?(c(d.INFO,"fetch_remote_config, Fetching remote config"),u(k,l,this.rcAutoOptinAb?1:0,null,f)):(c(d.WARNING,"fetch_remote_config, Fetching remote config, with legacy API"),u(k,l,null,"legacy",f))};this.enrollUserToAb=function(a){c(d.INFO,"enrollUserToAb, Providing AB test keys to opt in for");a&&Array.isArray(a)&&0!==a.length?(a={method:"ab",keys:JSON.stringify(a)},ba(a),ca("enrollUserToAb",this.url+Ea,a,function(b,e,k){if(b)c(d.ERROR,"enrollUserToAb, An error occurred: "+
b);else try{var l=JSON.parse(k);c(d.DEBUG,"enrollUserToAb, Parsed the response's result: ["+l.result+"]")}catch(f){c(d.ERROR,"enrollUserToAb, Had an issue while parsing the response: "+f)}},!0)):c(d.ERROR,"enrollUserToAb, No keys provided")};this.get_remote_config=function(a){c(d.INFO,"get_remote_config, Getting remote config from storage");return"undefined"!==typeof a?M[a]:M};this.stop_time=function(){c(d.INFO,"stop_time, Stopping tracking duration");da&&(da=!1,Ya=B()-fa,sa=B()-ra)};this.start_time=
function(){c(d.INFO,"start_time, Starting tracking duration");da||(da=!0,fa=B()-Ya,ra=B()-sa,sa=0,qa())};this.track_sessions=function(){function a(){document[e]||!document.hasFocus()?g.stop_time():g.start_time()}function b(){za>=ya&&g.start_time();za=0}c(d.INFO,"track_session, Starting tracking user session");this.begin_session();this.start_time();x(window,"beforeunload",function(){G();g.end_session()});var e="hidden";x(window,"focus",a);x(window,"blur",a);x(window,"pageshow",a);x(window,"pagehide",
a);"onfocusin"in document&&(x(window,"focusin",a),x(window,"focusout",a));e in document?document.addEventListener("visibilitychange",a):"mozHidden"in document?(e="mozHidden",document.addEventListener("mozvisibilitychange",a)):"webkitHidden"in document?(e="webkitHidden",document.addEventListener("webkitvisibilitychange",a)):"msHidden"in document&&(e="msHidden",document.addEventListener("msvisibilitychange",a));x(window,"mousemove",b);x(window,"click",b);x(window,"keydown",b);x(window,"scroll",b);setInterval(function(){za++;
za>=ya&&g.stop_time()},6E4)};this.track_pageview=function(a,b,e){c(d.INFO,"track_pageview, Tracking page views");c(d.VERBOSE,"track_pageview, last view is:["+Q+"]");Q&&(c(d.DEBUG,"track_pageview, Scroll registry triggered"),Wa(),xa=!0,wa=0);aa();(a=w(a,g.maxKeyLength,"track_pageview",c))&&Array.isArray(a)&&(b=a,a=null);a||(a=this.getViewName());if(void 0===a||""===a)c(d.ERROR,"track_pageview, No page name to track (it is either undefined or empty string). No page view can be tracked.");else if(null===
a)c(d.ERROR,"track_pageview, View name returned as null. Page view will be ignored.");else{if(b&&b.length)for(var k=0;k<b.length;k++)try{if((new RegExp(b[k])).test(a)){c(d.INFO,"track_pageview, Ignoring the page: "+a);return}}catch(m){c(d.ERROR,"track_pageview, Problem with finding ignore list item: "+b[k]+", error: "+m)}Q=a;ra=B();c(d.VERBOSE,"track_pageview, last view is assigned:["+Q+"]");k={name:a,visit:1,view:g.getViewUrl()};k=U(k,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"track_pageview",
c);this.track_domains&&(k.domain=window.location.hostname);if(ea)if(V)oa&&(oa=!1,k.start=1);else{var l=y("cly_session");if(!l||parseInt(l)<=B())oa=!1,k.start=1}else"undefined"!==typeof document.referrer&&document.referrer.length&&(l=jb.exec(document.referrer))&&l[11]&&l[11]!==window.location.hostname&&(k.start=1);if(e){e=U(e,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"track_pageview",c);for(var f in e)"undefined"===typeof k[f]&&(k[f]=e[f])}this.check_consent("views")?p({key:"[CLY]_view",
segmentation:k}):X.track_pageview=arguments}};this.track_view=function(a,b,e){c(d.INFO,"track_view, Initiating tracking page views");this.track_pageview(a,b,e)};this.track_clicks=function(a){c(d.INFO,"track_clicks, Starting to track clicks");a&&c(d.INFO,"track_clicks, Tracking the specified children:["+a+"]");a=a||document;var b=!0;x(a,"click",function(e){if(b){b=!1;Sa(e);if("undefined"!==typeof e.pageX&&"undefined"!==typeof e.pageY){var k=Ba(),l=Ta();g.check_consent("clicks")&&(e={type:"click",x:e.pageX,
y:e.pageY,width:l,height:k,view:g.getViewUrl()},e=U(e,g.maxKeyLength,g.maxValueSize,g.maxSegmentationValues,"processClick",c),g.track_domains&&(e.domain=window.location.hostname),p({key:"[CLY]_action",segmentation:e}))}setTimeout(function(){b=!0},1E3)}})};this.track_scrolls=function(a){c(d.INFO,"track_scrolls, Starting to track scrolls");a&&c(d.INFO,"track_scrolls, Tracking the specified children");a=a||window;xa=!0;x(a,"scroll",ob);x(a,"beforeunload",Wa)};this.track_links=function(a){c(d.INFO,"track_links, Starting to track clicks to links");
...
!!a+"] Tracking hidden inputs :["+!!b+"]");a=a||document;x(a,"submit",function(k){k=Oa(k);var l={id:k.attributes.id&&k.attributes.id.nodeValue,name:k.attributes.name&&k.attributes.name.nodeValue,action:k.attributes.action&&k.attributes.action.nodeValue,method:k.attributes.method&&k.attributes.method.nodeValue,view:g.getViewUrl()},f;if("undefined"!==typeof k.elements){for(var m=0;m<k.elements.length;m++)(f=k.elements[m])&&"password"!==f.type&&-1===f.className.indexOf("cly_user_ignore")&&("undefined"===
typeof l["input:"+e(f)]&&(l["input:"+e(f)]=[]),"select"===f.nodeName.toLowerCase()?"undefined"!==typeof f.multiple?l["input:"+e(f)].push(ja(f)):l["input:"+e(f)].push(f.options[f.selectedIndex].value):"input"===f.nodeName.toLowerCase()?"undefined"!==typeof f.type?"checkbox"===f.type.toLowerCase()||"radio"===f.type.toLowerCase()?f.checked&&l["input:"+e(f)].push(f.value):("hidden"!==f.type.toLowerCase()||b)&&l["input:"+e(f)].push(f.value):l["input:"+e(f)].push(f.value):"textarea"===f.nodeName.toLowerCase()?
l["input:"+e(f)].push(f.value):"undefined"!==typeof f.value&&l["input:"+e(f)].push(f.value));for(var q in l)l[q]&&"function"===typeof l[q].join&&(l[q]=l[q].join(", "))}g.check_consent("forms")&&p({key:"formSubmit",segmentation:l})})};this.collect_from_forms=function(a,b){c(d.INFO,"collect_from_forms, Starting to collect possible user data. DOM object provided:["+!!a+"] Submitting custom user property:["+!!b+"]");a=a||document;x(a,"submit",function(e){e=Oa(e);var k={},l=!1,f;if("undefined"!==typeof e.elements){var m=
{},q=a.getElementsByTagName("LABEL"),t;for(t=0;t<q.length;t++)q[t].htmlFor&&""!==q[t].htmlFor&&(m[q[t].htmlFor]=q[t].innerText||q[t].textContent||q[t].innerHTML);for(t=0;t<e.elements.length;t++)if((f=e.elements[t])&&"password"!==f.type&&-1===f.className.indexOf("cly_user_ignore"))if(q="","select"===f.nodeName.toLowerCase()?q="undefined"!==typeof f.multiple?ja(f):f.options[f.selectedIndex].value:"input"===f.nodeName.toLowerCase()?"undefined"!==typeof f.type?"checkbox"===f.type.toLowerCase()||"radio"===
f.type.toLowerCase()?f.checked&&(q=f.value):q=f.value:q=f.value:"textarea"===f.nodeName.toLowerCase()?q=f.value:"undefined"!==typeof f.value&&(q=f.value),f.className&&-1!==f.className.indexOf("cly_user_")){var I=f.className.split(" ");for(f=0;f<I.length;f++)if(0===I[f].indexOf("cly_user_")){k[I[f].replace("cly_user_","")]=q;l=!0;break}}else if(f.type&&"email"===f.type.toLowerCase()||f.name&&-1!==f.name.toLowerCase().indexOf("email")||f.id&&-1!==f.id.toLowerCase().indexOf("email")||f.id&&m[f.id]&&
-1!==m[f.id].toLowerCase().indexOf("email")||/[^@\s]+@[^@\s]+\.[^@\s]+/.test(q))k.email||(k.email=q),l=!0;else if(f.name&&-1!==f.name.toLowerCase().indexOf("username")||f.id&&-1!==f.id.toLowerCase().indexOf("username")||f.id&&m[f.id]&&-1!==m[f.id].toLowerCase().indexOf("username"))k.username||(k.username=q),l=!0;else if(f.name&&(-1!==f.name.toLowerCase().indexOf("tel")||-1!==f.name.toLowerCase().indexOf("phone")||-1!==f.name.toLowerCase().indexOf("number"))||f.id&&(-1!==f.id.toLowerCase().indexOf("tel")||
-1!==f.id.toLowerCase().indexOf("phone")||-1!==f.id.toLowerCase().indexOf("number"))||f.id&&m[f.id]&&(-1!==m[f.id].toLowerCase().indexOf("tel")||-1!==m[f.id].toLowerCase().indexOf("phone")||-1!==m[f.id].toLowerCase().indexOf("number")))k.phone||(k.phone=q),l=!0;else if(f.name&&(-1!==f.name.toLowerCase().indexOf("org")||-1!==f.name.toLowerCase().indexOf("company"))||f.id&&(-1!==f.id.toLowerCase().indexOf("org")||-1!==f.id.toLowerCase().indexOf("company"))||f.id&&m[f.id]&&(-1!==m[f.id].toLowerCase().indexOf("org")||
-1!==m[f.id].toLowerCase().indexOf("company")))k.organization||(k.organization=q),l=!0;else if(f.name&&-1!==f.name.toLowerCase().indexOf("name")||f.id&&-1!==f.id.toLowerCase().indexOf("name")||f.id&&m[f.id]&&-1!==m[f.id].toLowerCase().indexOf("name"))k.name||(k.name=""),k.name+=q+" ",l=!0}l&&(c(d.INFO,"collect_from_forms, Gathered user data",k),b?g.user_details({custom:k}):g.user_details(k))})};this.collect_from_facebook=function(a){c(d.INFO,"collect_from_facebook, Starting to collect possible user data");
FB&&FB.api&&FB.api("/me",function(b){var e={};b.name&&(e.name=b.name);b.email&&(e.email=b.email);"male"===b.gender?e.gender="M":"female"===b.gender&&(e.gender="F");if(b.birthday){var k=b.birthday.split("/").pop();k&&4===k.length&&(e.byear=k)}b.work&&b.work[0]&&b.work[0].employer&&b.work[0].employer.name&&(e.organization=b.work[0].employer.name);if(a){e.custom={};for(var l in a){k=a[l].split(".");for(var f=b,m=0;m<k.length&&(f=f[k[m]],"undefined"!==typeof f);m++);"undefined"!==typeof f&&(e.custom[l]=
f)}}g.user_details(e)})};this.opt_out=function(){c(d.INFO,"opt_out, Opting out the user");this.ignore_visitor=!0;v("cly_ignore",!0)};this.opt_in=function(){c(d.INFO,"opt_in, Opting in the user");v("cly_ignore",!1);this.ignore_visitor=!1;C();this.ignore_visitor||Ha||Ga()};this.report_feedback=function(a){c(d.WARNING,"report_feedback, Deprecated function call! Use 'recordRatingWidgetWithID' or 'reportFeedbackWidgetManually' in place of this call. Call will be redirected to 'recordRatingWidgetWithID' now!");
this.recordRatingWidgetWithID(a)};this.recordRatingWidgetWithID=function(a){c(d.INFO,"recordRatingWidgetWithID, Providing information about user with ID: [ "+a.widget_id+" ]");if(this.check_consent("star-rating"))if(a.widget_id)if(a.rating){var b={key:"[CLY]_star_rating",count:1,segmentation:{}};b.segmentation=pa(a,"widget_id contactMe platform app_version rating email comment".split(" "));b.segmentation.app_version||(b.segmentation.app_version=this.metrics._app_version||this.app_version);5<b.segmentation.rating?
...
this.initializeRatingWidgets(a)};this.initializeRatingWidgets=function(a){c(d.INFO,"initializeRatingWidgets, Initializing rating widget with provided widget IDs:[ "+a+"]");if(this.check_consent("star-rating")){a||(a=y("cly_fb_widgets"));for(var b=document.getElementsByClassName("countly-feedback-sticker");0<b.length;)b[0].remove();ca("initializeRatingWidgets",this.url+"/o/feedback/multiple-widgets-by-id",{widgets:JSON.stringify(a)},function(e,k,l){if(e)c(d.ERROR,"initializeRatingWidgets, An error occurred: "+
e);else try{var f=JSON.parse(l);for(e=0;e<f.length;e++)if("true"===f[e].is_active){var m=f[e].target_devices,q=cb();if(m[q])if("string"===typeof f[e].hide_sticker&&(f[e].hide_sticker="true"===f[e].hide_sticker),"all"!==f[e].target_page||f[e].hide_sticker){var t=f[e].target_pages;for(k=0;k<t.length;k++){var I=t[k].substr(0,t[k].length-1)===window.location.pathname.substr(0,t[k].length-1),P=t[k]===window.location.pathname;(t[k].includes("*")&&I||P)&&!f[e].hide_sticker&&O(f[e],!0)}}else O(f[e],!0)}}catch(K){c(d.ERROR,
...
this.platform;f+="&app_version="+this.app_version;f+="&sdk_version=22.06.5";f+="&origin="+m;f+="&widget_v=web";var t=document.createElement("iframe");t.src=f;t.name="countly-"+q+"-iframe";t.id="countly-"+q+"-iframe";var I=!1;t.onload=function(){I&&(document.getElementById("countly-"+q+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display="none");I=!0;c(d.DEBUG,"present_feedback_widget, Loaded iframe.")};for(var P=document.getElementById("csbg");P;)P.remove(),P=document.getElementById("csbg"),
c(d.DEBUG,"present_feedback_widget, Removing past overlay.");var K=document.getElementsByClassName("countly-"+q+"-wrapper");for(f=0;f<K.length;f++)K[f].remove(),c(d.DEBUG,"present_feedback_widget, Removed a wrapper.");K=document.createElement("div");K.className="countly-"+q+"-wrapper";K.id="countly-"+q+"-wrapper-"+a._id;"survey"===a.type&&(K.className=K.className+" "+a.appearance.position);var ma=document.body;f=!1;b&&(document.getElementById(b)?(ma=document.getElementById(b),f=!0):c(d.ERROR,"present_feedback_widget, Provided ID not found."));
f||e&&(document.getElementsByClassName(e)[0]?ma=document.getElementsByClassName(e)[0]:c(d.ERROR,"present_feedback_widget, Provided class not found."));ma.insertAdjacentHTML("beforeend",'<div id="csbg"></div>');ma.appendChild(K);if("rating"===a.type){var $a=document.createElement("div");$a.className="countly-ratings-overlay";$a.id="countly-ratings-overlay-"+a._id;K.appendChild($a);c(d.DEBUG,"present_feedback_widget, appended the rating overlay to wrapper");x(document.getElementById("countly-ratings-overlay-"+
a._id),"click",function(){document.getElementById("countly-ratings-wrapper-"+a._id).style.display="none"})}K.appendChild(t);c(d.DEBUG,"present_feedback_widget, Appended the iframe");x(window,"message",function(z){var N={};try{N=JSON.parse(z.data),c(d.DEBUG,"present_feedback_widget, Parsed response message "+N)}catch(ub){c(d.ERROR,"present_feedback_widget, Error while parsing message body "+ub)}N.close?(document.getElementById("countly-"+q+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display=
...
(a[k]=a[k].substring(0,g.maxStackTraceLineLength));k=a.join("\n")}b=!!b;a=Da();k={_resolution:a._resolution,_error:k,_app_version:a._app_version,_run:B()-rb,_not_os_specific:!0,_javascript:!0};if(l=navigator.battery||navigator.webkitBattery||navigator.mozBattery||navigator.msBattery)k._bat=Math.floor(100*l.level);"undefined"!==typeof navigator.onLine&&(k._online=!!navigator.onLine);k._background=!document.hasFocus();0<ia.length&&(k._logs=ia.join("\n"));ia=[];k._nonfatal=b;k._view=this.getViewName();
...
"[]");break;case "cly_event":H=g.deserialize(b||"[]");break;case "cly_remote_configs":M=g.deserialize(b||"{}");break;case "cly_ignore":g.ignore_visitor=g.deserialize(b);break;case "cly_id":g.device_id=g.deserialize(b);break;case "cly_id_type":D=g.deserialize(b)}};this._internals={store:v,getDocWidth:Ta,getDocHeight:Ba,getViewportHeight:eb,get_page_coord:Sa,get_event_target:Oa,add_event:x,createNewObjectFromProperties:pa,truncateObject:U,truncateSingleValue:w,stripTrailingSlash:ka,prepareParams:bb,
sendXmlHttpRequest:ca,isResponseValid:nb,getInternalDeviceIdType:function(){return D},getMsTimestamp:Qa,getTimestamp:B,isResponseValidBroad:mb,log:c,getMetrics:Da,getUA:kb,prepareRequest:ba,generateUUID:ab,sendEventsForced:G,isUUID:function(a){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(a)},getId:Va,heartBeat:Ga,toRequestQueue:F,reportViewDuration:aa,loadJS:gb,loadCSS:Ca,getLastView:function(){return Q},setToken:pb,getToken:function(){var a=y("cly_token");
S("cly_token");return a},showLoader:hb,hideLoader:ib,setValueInStorage:v,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:p,processScrollView:Wa,processScroll:ob,currentUserAgentString:la,userAgentDeviceDetection:cb,userAgentSearchBotDetection:db,getRequestQueue:function(){return E},getEventQueue:function(){return H},clearQueue:function(){E=[];v("cly_queue",[]);H=[];v("cly_event",[])}};this.initialize()};n.init=function(h){h=h||{};var p=h.app_key||n.app_key;if(!n.i||!n.i[p]){h=new n.CountlyClass(h);
if(!n.i){n.i={};for(var u in h)n[u]=h[u]}n.i[p]=h}return n.i[p]};var Aa=0,x=function(h,p,u){"undefined"!==typeof h.addEventListener?h.addEventListener(p,u,!1):h.attachEvent("on"+p,u)},Oa=function(h){return h?"undefined"!==typeof h.target?h.target:h.srcElement:window.event.srcElement};window.addEventListener("storage",function(h){var p=(h.key+"").split("/"),u=p.pop();p=p.pop();if(n.i&&n.i[p])n.i[p].onStorageChange(u,h.newValue)});n.serialize=function(h){"object"===typeof h&&(h=JSON.stringify(h));return h};
n.deserialize=function(h){try{h=JSON.parse(h)}catch(p){}return h};n.getViewName=function(){return window.location.pathname};n.getViewUrl=function(){return window.location.pathname};n.getSearchQuery=function(){return window.location.search};n.DeviceIdType={DEVELOPER_SUPPLIED:0,SDK_GENERATED:1,TEMPORARY_ID:2};return n}});
