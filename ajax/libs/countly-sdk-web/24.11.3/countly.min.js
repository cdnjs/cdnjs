...
l(H,a,0)),b(Fa,a).call(a),a.device_id=void 0,l(H,a,1)),b(e,a).call(a,f.INFO,"initialize, Clearing the device ID storage"),b(T,a).call(a,"cly_id"),b(T,a).call(a,"cly_id_type"),b(T,a).call(a,"cly_session"),d=!1);"javascript_native_web"===b(ua,a)&&"24.11.3"===b(pa,a)?b(e,a).call(a,f.DEBUG,"initialize, SDK name:["+b(ua,a)+"], version:["+b(pa,a)+"]"):b(e,a).call(a,f.DEBUG,"initialize, SDK name:["+b(ua,a)+"], version:["+b(pa,a)+"], default name:[javascript_native_web] and default version:[24.11.3]");b(e,
a).call(a,f.DEBUG,"initialize, app_key:["+a.app_key+"], url:["+a.url+"]");b(e,a).call(a,f.DEBUG,"initialize, device_id:["+x("device_id",c,void 0)+"]");b(e,a).call(a,f.DEBUG,"initialize, require_consent is enabled:["+a.require_consent+"]");try{b(e,a).call(a,f.DEBUG,"initialize, metric override:["+JSON.stringify(a.metrics)+"]"),b(e,a).call(a,f.DEBUG,"initialize, header override:["+JSON.stringify(a.headers)+"]"),b(e,a).call(a,f.DEBUG,"initialize, number of onload callbacks provided:["+a.onload.length+
...
var r;"legacy"===h&&(k.method="fetch_remote_config");0===g&&(k.oi=0);1===g&&(k.oi=1);"function"===typeof n&&(r=n);a.check_consent("sessions")&&(k.metrics=JSON.stringify(b(jb,a).call(a)));a.check_consent("remote-config")?(b(Ga,a).call(a,k),b(ea,a).call(a,"fetch_remote_config_explicit",a.url+b(Na,a),k,function(u,y,G){if(!u){try{var U=JSON.parse(G);if(k.keys||k.omit_keys)for(var J in U)b(P,a)[J]=U[J];else l(P,a,U);b(z,a).call(a,"cly_remote_configs",b(P,a))}catch(Ya){b(e,a).call(a,f.ERROR,"fetch_remote_config_explicit, Had an issue while parsing the response: "+
...
cly_ws:1,cly_origin:window.location.origin};b(Ga,a).call(a,d);return d});q(this,Rb,function(){b(e,a).call(a,f.DEBUG,"sendContentRequest, sending content request");var c=b(oc,a).call(a);b(ea,a).call(a,"sendContentRequest,",a.url+b(Kb,a),c,function(d,g,h){if(!d){b(e,a).call(a,f.DEBUG,"sendContentRequest, received content: ["+h+"]");b(pc,a).call(a,h);clearInterval(b(Va,a));window.addEventListener("message",function(k){b(qc,a).call(a,k)});var n;window.addEventListener("resize",function(){clearTimeout(n);
n=setTimeout(function(){var k=window.innerWidth,r=window.innerHeight;document.getElementById(b(Xa,a)).contentWindow.postMessage({type:"resize",width:k,height:r},"*")},200)})}},!0)});q(this,pc,function(c){if(c){b(e,a).call(a,f.DEBUG,"displayContent, displaying content");c=JSON.parse(c);var d=document.createElement("iframe");d.id=b(Xa,a);d.src=c.html;d.style.position="absolute";var g=c.geo.p,h=b(kb,a).call(a,!0);h.width>=h.height&&(g=c.geo.l);d.style.left=g.x+"px";d.style.top=g.y+"px";d.style.width=
g.w+"px";d.style.height=g.h+"px";d.style.border="none";d.style.zIndex="999999";document.body.appendChild(d)}else b(e,a).call(a,f.DEBUG,"displayContent, no content to display")});q(this,qc,function(c){if(c.origin===a.url){b(e,a).call(a,f.DEBUG,"sendContentRequest, Received message from: ["+c.origin+"] with data: ["+JSON.stringify(c.data)+"]");var d=c.data;c=d.close;var g=d.link,h=d.event;d=d.resize_me;if(h){b(e,a).call(a,f.DEBUG,"sendContentRequest, Received event");1===c&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Closing content frame for event"),
b(tb,a).call(a));if(!Array.isArray(h)){if("object"===R(h))throw new TypeError('"event" is read-only');b(e,a).call(a,f.ERROR,"sendContentRequest, Invalid event type: ["+R(h)+"]");return}for(var n=0;n<h.length;n++)b(Y,a).call(a,h[n])}g&&(1===c&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Closing content frame for link"),b(tb,a).call(a)),window.open(g,"_blank"),b(e,a).call(a,f.DEBUG,"sendContentRequest, Opened link in new tab: [".concat(g,"]")));d&&(b(e,a).call(a,f.DEBUG,"sendContentRequest, Resizing iframe"),
h=b(kb,a).call(a,!0),g=d.p,h.width>=h.height&&(g=d.l),d=document.getElementById(b(Xa,a)),d.style.left=g.x+"px",d.style.top=g.y+"px",d.style.width=g.w+"px",d.style.height=g.h+"px");1===c&&b(tb,a).call(a)}});q(this,tb,function(){var c=document.getElementById(b(Xa,a));c&&(c.remove(),b(e,a).call(a,f.DEBUG,"sendContentRequest, removed iframe"),b(Ea,a)&&b(Qb,a).call(a,!0))});q(this,Fa,function(){0<b(N,a).length&&(b(e,a).call(a,f.DEBUG,"Flushing events"),b(Q,a).call(a,{events:JSON.stringify(b(N,a))}),l(N,
a,[]),b(z,a).call(a,"cly_event",b(N,a)))});q(this,ub,function(c,d){if(A)if(document.getElementById("countly-feedback-sticker-"+c._id))b(e,a).call(a,f.ERROR,"Widget with same ID exists");else try{var g=document.createElement("div");g.className="countly-iframe-wrapper";g.id="countly-iframe-wrapper-"+c._id;var h=document.createElement("span");h.className="countly-feedback-close-icon";h.id="countly-feedback-close-icon-"+c._id;h.innerText="x";var n=document.createElement("iframe");n.name="countly-feedback-iframe";
n.id="countly-feedback-iframe";n.src=a.url+"/feedback?widget_id="+c._id+"&app_key="+a.app_key+"&device_id="+a.device_id+"&sdk_version="+b(pa,a);document.body.appendChild(g);g.appendChild(h);g.appendChild(n);D(document.getElementById("countly-feedback-close-icon-"+c._id),"click",function(){document.getElementById("countly-iframe-wrapper-"+c._id).style.display="none";document.getElementById("cfbg").style.display="none"});if(d){var k=document.createElementNS("http://www.w3.org/2000/svg","svg");k.id=
"feedback-sticker-svg";k.setAttribute("aria-hidden","true");k.setAttribute("data-prefix","far");k.setAttribute("data-icon","grin");k.setAttribute("class","svg-inline--fa fa-grin fa-w-16");k.setAttribute("role","img");k.setAttribute("xmlns","http://www.w3.org/2000/svg");k.setAttribute("viewBox","0 0 496 512");var r=document.createElementNS("http://www.w3.org/2000/svg","path");r.id="smileyPathInStickerSvg";r.setAttribute("fill","white");r.setAttribute("d","M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm0 448c-110.3 0-200-89.7-200-200S137.7 56 248 56s200 89.7 200 200-89.7 200-200 200zm105.6-151.4c-25.9 8.3-64.4 13.1-105.6 13.1s-79.6-4.8-105.6-13.1c-9.9-3.1-19.4 5.4-17.7 15.3 7.9 47.1 71.3 80 123.3 80s115.3-32.9 123.3-80c1.6-9.8-7.7-18.4-17.7-15.3zM168 240c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32zm160 0c17.7 0 32-14.3 32-32s-14.3-32-32-32-32 14.3-32 32 14.3 32 32 32z");
var u=document.createElement("span");u.innerText=c.trigger_button_text;var y=document.createElement("div");y.style.color=7>c.trigger_font_color.length?"#"+c.trigger_font_color:c.trigger_font_color;y.style.backgroundColor=7>c.trigger_bg_color.length?"#"+c.trigger_bg_color:c.trigger_bg_color;y.className="countly-feedback-sticker  "+c.trigger_position+"-"+c.trigger_size;y.id="countly-feedback-sticker-"+c._id;k.appendChild(r);y.appendChild(k);y.appendChild(u);document.body.appendChild(y);var G=document.getElementById("smileyPathInStickerSvg");
...
1));else if(0===g[n].indexOf("userData.")){var k=g[n].replace("userData.","");"function"===typeof h.userData[k]&&h.userData[k].apply(h,g.slice(n+1))}else"function"===typeof t[g[n]]&&t[g[n]].apply(t,g.slice(n+1))}}}});q(this,wb,function(){var c=b(B,a).call(a,"cly_id");return c?(l(H,a,b(B,a).call(a,"cly_id_type")),c):Db()});q(this,tc,function(c){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(c)});q(this,Ub,function(){return a.metrics._ua||La()});q(this,
jb,function(){var c=JSON.parse(JSON.stringify(a.metrics||{}));c._app_version=c._app_version||a.app_version;c._ua=c._ua||La();var d=b(kb,a).call(a);d&&(d=""+d.width+"x"+d.height,c._resolution=c._resolution||d);A&&window.devicePixelRatio&&(c._density=c._density||window.devicePixelRatio);d=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage;"undefined"!==typeof d&&(c._locale=c._locale||d);b(xb,a).call(a)&&(c._store=c._store||document.referrer);b(e,a).call(a,
f.DEBUG,"Got metrics",c);return c});q(this,kb,function(c){b(e,a).call(a,f.DEBUG,"Getting the resolution of the device");if(!A||!screen)return b(e,a).call(a,f.DEBUG,"No screen available"),null;var d=screen.width?parseInt(screen.width):0,g=screen.height?parseInt(screen.height):0;if(c){c=Math.min(window.innerWidth,document.documentElement.clientWidth);var h=Math.min(window.innerHeight,document.documentElement.clientHeight);d=c?parseInt(c):d;g=h?parseInt(h):g}if(0===d||0===g)return b(e,a).call(a,f.DEBUG,
"Screen width or height is non existent"),null;navigator.platform&&/iPad|iPhone|iPod/.test(navigator.platform)&&window.devicePixelRatio&&(b(e,a).call(a,f.VERBOSE,"Mobile Mac device detected, adjusting resolution"),d=Math.round(d*window.devicePixelRatio),g=Math.round(g*window.devicePixelRatio));90===Math.abs(screen.orientation.angle)&&(b(e,a).call(a,f.VERBOSE,"Screen is in landscape mode, adjusting resolution"),c=d,d=g,g=c);return{width:d,height:g,orientation:screen.orientation.angle}});q(this,xb,
function(c){if(!A)return!1;c=c||document.referrer;var d=!1;if("undefined"===typeof c||0===c.length)b(e,a).call(a,f.DEBUG,"Invalid referrer:["+c+"], ignoring.");else{var g=lc.exec(c);if(g)if(g[11])if(g[11]===window.location.hostname)b(e,a).call(a,f.DEBUG,"Referrer is current host:["+c+"], ignoring.");else if(b(ba,a)&&b(ba,a).length)for(d=!0,g=0;g<b(ba,a).length;g++){if(0<=c.indexOf(b(ba,a)[g])){b(e,a).call(a,f.DEBUG,"Referrer in ignore list:["+c+"], ignoring.");d=!1;break}}else b(e,a).call(a,f.DEBUG,
"Valid referrer:["+c+"]"),d=!0;else b(e,a).call(a,f.DEBUG,"No path found in referrer:["+c+"], ignoring.");else b(e,a).call(a,f.DEBUG,"Referrer is corrupt:["+c+"], ignoring.")}return d});q(this,e,function(c,d,g){if(a.debug&&"undefined"!==typeof console){g&&"object"===R(g)&&(g=JSON.stringify(g));b(Ma,a)||(d="["+a.app_key+"] "+d);c||(c=f.DEBUG);var h="";g&&(h=" "+g);d=c+"[Countly] "+d+h;c===f.ERROR?(console.error(d),b(qa,a).incrementErrorCount()):c===f.WARNING?(console.warn(d),b(qa,a).incrementWarningCount()):
c===f.INFO?console.info(d):c===f.VERBOSE?console.log(d):console.debug(d)}});q(this,ea,function(c,d,g,h,n){b(hb,a).push({functionName:c,url:d,params:g});A?b(Vb,a).call(a,c,d,g,h,n):b(Wb,a).call(a,c,d,g,h,n)});q(this,Vb,function(c,d,g,h,n){n=n||!1;try{b(e,a).call(a,f.DEBUG,"Sending XML HTTP request");var k=new XMLHttpRequest;g=g||{};Gb(g,a.salt).then(function(r){var u="POST";if(a.force_post||2E3<=r.length)u="POST";"GET"===u?k.open("GET",d+"?"+r,!0):(k.open("POST",d,!0),k.setRequestHeader("Content-type",
"application/x-www-form-urlencoded"));for(var y in a.headers)k.setRequestHeader(y,a.headers[y]);k.onreadystatechange=function(){4===k.readyState&&(b(e,a).call(a,f.DEBUG,c+" HTTP request completed with status code: ["+k.status+"] and response: ["+k.responseText+"]"),(n?b(zb,a).call(a,k.status,k.responseText):b(yb,a).call(a,k.status,k.responseText))?"function"===typeof h&&h(!1,g,k.responseText):(b(e,a).call(a,f.ERROR,c+" Invalid response from server"),"send_request_queue"===c&&b(qa,a).saveRequestCounters(k.status,
k.responseText),"function"===typeof h&&h(!0,g,k.status,k.responseText)))};"GET"===u?k.send():k.send(r)})}catch(r){b(e,a).call(a,f.ERROR,c+" Something went wrong while making an XML HTTP request: "+r),"function"===typeof h&&h(!0,g)}});q(this,Wb,function(c,d,g,h,n){n=n||!1;var k;try{b(e,a).call(a,f.DEBUG,"Sending Fetch request");var r="POST",u={"Content-type":"application/x-www-form-urlencoded"},y=null;g=g||{};Gb(g,a.salt).then(function(G){a.force_post||2E3<=G.length?(r="POST",y=G):d+="?"+G;for(var U in a.headers)u[U]=
a.headers[U];fetch(d,{method:r,headers:u,body:y}).then(function(J){k=J;return k.text()}).then(function(J){b(e,a).call(a,f.DEBUG,c+" Fetch request completed wit status code: ["+k.status+"] and response: ["+J+"]");(n?b(zb,a).call(a,k.status,J):b(yb,a).call(a,k.status,J))?"function"===typeof h&&h(!1,g,J):(b(e,a).call(a,f.ERROR,c+" Invalid response from server"),"send_request_queue"===c&&b(qa,a).saveRequestCounters(k.status,J),"function"===typeof h&&h(!0,g,k.status,J))})["catch"](function(J){b(e,a).call(a,
f.ERROR,c+" Failed Fetch request: "+J);"function"===typeof h&&h(!0,g)})})}catch(G){b(e,a).call(a,f.ERROR,c+" Something went wrong with the Fetch request attempt: "+G),"function"===typeof h&&h(!0,g)}});q(this,yb,function(c,d){if(!(200<=c&&300>c))return b(e,a).call(a,f.ERROR,"Http response status code:["+c+"] is not within the expected range"),!1;try{var g=JSON.parse(d);return"[object Object]"!==Object.prototype.toString.call(g)?(b(e,a).call(a,f.ERROR,"Http response is not JSON Object"),!1):!!g.result}catch(h){return b(e,
a).call(a,f.ERROR,"Http response is not JSON: "+h),!1}});q(this,zb,function(c,d){if(!(200<=c&&300>c))return b(e,a).call(a,f.ERROR,"Http response status code:["+c+"] is not within the expected range"),!1;try{var g=JSON.parse(d);return"[object Object]"===Object.prototype.toString.call(g)||Array.isArray(g)?!0:(b(e,a).call(a,f.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(h){return b(e,a).call(a,f.ERROR,"Http response is not JSON: "+h),!1}});q(this,Xb,function(){A?l(Da,a,Math.max(b(Da,
a),window.scrollY,document.body.scrollTop,document.documentElement.scrollTop)):b(e,a).call(a,f.WARNING,"processScroll, window object is not available. Not processing scroll.")});q(this,Ab,function(){if(!A)b(e,a).call(a,f.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(b(Ca,a)){l(Ca,a,!1);var c=nb(),d=Jb(),g=fc();a.check_consent("scrolls")&&(c={type:"scroll",y:b(Da,a)+g,width:d,height:c,view:a.getViewUrl()},c=ka(c,a.maxKeyLength,a.maxValueSize,a.maxSegmentationValues,
"processScrollView",b(e,a)),a.track_domains&&(c.domain=window.location.hostname),b(Y,a).call(a,{key:O.ACTION,segmentation:c}))}});q(this,uc,function(){return b(H,a)});q(this,Yb,function(c){b(z,a).call(a,"cly_token",c)});q(this,vc,function(){var c=b(B,a).call(a,"cly_token");b(T,a).call(a,"cly_token");return c});q(this,wc,function(){return b(N,a)});q(this,xc,function(){return b(K,a)});q(this,yc,function(c){c+="=";for(var d=document.cookie.split(";"),g=0,h=d.length;g<h;g++){for(var n=d[g];" "===n.charAt(0);)n=
n.substring(1,n.length);if(0===n.indexOf(c))return n.substring(c.length,n.length)}return null});q(this,Zb,function(c,d,g){var h=new Date;h.setTime(h.getTime()+864E5*g);g="; expires="+h.toGMTString();document.cookie=c+"="+d+g+"; path=/"});q(this,B,function(c,d,g){if("none"===a.storage||"object"!==R(a.storage)&&!A)b(e,a).call(a,f.DEBUG,"Storage is disabled. Value with key: ["+c+"] won't be retrieved");else{g||(c=a.app_key+"/"+c,a.namespace&&(c=Ka(a.namespace)+"/"+c));if("object"===R(a.storage)&&"function"===
typeof a.storage.getItem){var h=a.storage.getItem(c);return c.endsWith("cly_id")?h:a.deserialize(h)}void 0===d&&(d=b(na,a));d?h=localStorage.getItem(c):"localstorage"!==a.storage&&(h=b(yc,a).call(a,c));return c.endsWith("cly_id")?h:a.deserialize(h)}});q(this,z,function(c,d,g,h){"none"===a.storage||"object"!==R(a.storage)&&!A?b(e,a).call(a,f.DEBUG,"Storage is disabled. Value with key: "+c+" won't be stored"):(h||(c=a.app_key+"/"+c,a.namespace&&(c=Ka(a.namespace)+"/"+c)),"undefined"!==typeof d&&null!==
d&&("object"===R(a.storage)&&"function"===typeof a.storage.setItem?a.storage.setItem(c,d):(void 0===g&&(g=b(na,a)),d=a.serialize(d),g?localStorage.setItem(c,d):"localstorage"!==a.storage&&b(Zb,a).call(a,c,d,30))))});q(this,T,function(c,d,g){"none"===a.storage||"object"!==R(a.storage)&&!A?b(e,a).call(a,f.DEBUG,"Storage is disabled. Value with key: "+c+" won't be removed"):(g||(c=a.app_key+"/"+c,a.namespace&&(c=Ka(a.namespace)+"/"+c)),"object"===R(a.storage)&&"function"===typeof a.storage.removeItem?
a.storage.removeItem(c):(void 0===d&&(d=b(na,a)),d?localStorage.removeItem(c):"localstorage"!==a.storage&&b(Zb,a).call(a,c,"",-1)))});q(this,zc,function(){if(b(B,a).call(a,a.namespace+"cly_id",!1,!0)){b(z,a).call(a,"cly_id",b(B,a).call(a,a.namespace+"cly_id",!1,!0));b(z,a).call(a,"cly_id_type",b(B,a).call(a,a.namespace+"cly_id_type",!1,!0));b(z,a).call(a,"cly_event",b(B,a).call(a,a.namespace+"cly_event",!1,!0));b(z,a).call(a,"cly_session",b(B,a).call(a,a.namespace+"cly_session",!1,!0));var c=b(B,
a).call(a,a.namespace+"cly_queue",!1,!0);Array.isArray(c)&&(c=c.filter(function(d){return d.app_key===a.app_key}),b(z,a).call(a,"cly_queue",c));b(B,a).call(a,a.namespace+"cly_cmp_id",!1,!0)&&(b(z,a).call(a,"cly_cmp_id",b(B,a).call(a,a.namespace+"cly_cmp_id",!1,!0)),b(z,a).call(a,"cly_cmp_uid",b(B,a).call(a,a.namespace+"cly_cmp_uid",!1,!0)));b(B,a).call(a,a.namespace+"cly_ignore",!1,!0)&&b(z,a).call(a,"cly_ignore",b(B,a).call(a,a.namespace+"cly_ignore",!1,!0));b(T,a).call(a,"cly_id",!1,!0);b(T,a).call(a,
"cly_id_type",!1,!0);b(T,a).call(a,"cly_event",!1,!0);b(T,a).call(a,"cly_session",!1,!0);b(T,a).call(a,"cly_queue",!1,!0);b(T,a).call(a,"cly_cmp_id",!1,!0);b(T,a).call(a,"cly_cmp_uid",!1,!0);b(T,a).call(a,"cly_ignore",!1,!0)}});q(this,Ac,function(c,d){b(e,a).call(a,f.DEBUG,"onStorageChange, Applying storage changes for key:",c);b(e,a).call(a,f.DEBUG,"onStorageChange, Applying storage changes for value:",d);switch(c){case "cly_queue":l(K,a,a.deserialize(d||"[]"));break;case "cly_event":l(N,a,a.deserialize(d||
"[]"));break;case "cly_remote_configs":l(P,a,a.deserialize(d||"{}"));break;case "cly_ignore":a.ignore_visitor=a.deserialize(d);break;case "cly_id":a.device_id=d;break;case "cly_id_type":l(H,a,a.deserialize(d))}});q(this,Bc,function(){l(K,a,[]);b(z,a).call(a,"cly_queue",[]);l(N,a,[]);b(z,a).call(a,"cly_event",[])});q(this,Cc,function(){return{eventQ:b(N,a),requestQ:b(K,a)}});w(this,"_internals",{store:b(z,this),getDocWidth:Jb,getDocHeight:nb,getViewportHeight:fc,get_page_coord:Ib,get_event_target:mb,
add_event_listener:D,createNewObjectFromProperties:Za,truncateObject:ka,truncateSingleValue:C,stripTrailingSlash:Ka,prepareParams:Gb,sendXmlHttpRequest:b(Vb,this),isResponseValid:b(yb,this),getInternalDeviceIdType:b(uc,this),getMsTimestamp:Eb,getTimestamp:M,isResponseValidBroad:b(zb,this),secureRandom:Cb,log:b(e,this),checkIfLoggingIsOn:$a,getMetrics:b(jb,this),getUA:b(Ub,this),prepareRequest:b(Ga,this),generateUUID:Db,sendEventsForced:b(Fa,this),isUUID:b(tc,this),calculateChecksum:cc,isReferrerUsable:b(xb,
this),getId:b(wb,this),heartBeat:b(ib,this),toRequestQueue:b(Q,this),reportViewDuration:b(vb,this),loadJS:hc,loadCSS:ob,getLastView:b(rc,this),setToken:b(Yb,this),getToken:b(vc,this),showLoader:ic,hideLoader:jc,setValueInStorage:b(z,this),getValueFromStorage:b(B,this),removeValueFromStorage:b(T,this),add_cly_events:b(Y,this),processScrollView:b(Ab,this),processScroll:b(Xb,this),currentUserAgentString:La,currentUserAgentDataString:Hb,userAgentDeviceDetection:dc,userAgentSearchBotDetection:ec,getRequestQueue:b(xc,
this),getEventQueue:b(wc,this),sendFetchRequest:b(Wb,this),processAsyncQueue:b(Ha,this),makeNetworkRequest:b(ea,this),onStorageChange:b(Ac,this),clearQueue:b(Bc,this),getLocalQueues:b(Cc,this),testingGetRequests:b(sc,this)});q(this,qa,{sendInstantHCRequest:function(){if(b(L,a))b(e,a).call(a,f.DEBUG,"sendInstantHCRequest, Offline mode is active. Not sending health check request."),l(gb,a,!0);else{var c=C(a.hcErrorMessage,1E3,"healthCheck",b(e,a));""!==c&&(c=JSON.stringify(c));c={hc:JSON.stringify({el:a.hcErrorCount,
wl:a.hcWarningCount,sc:a.hcStatusCode,em:c}),metrics:JSON.stringify({_app_version:a.app_version})};b(Ga,a).call(a,c);b(ea,a).call(a,"[healthCheck]",a.url+b(bb,a),c,function(d){d||b(qa,a).resetAndSaveCounters()},!0)}},resetAndSaveCounters:function(){b(qa,a).resetCounters();b(z,a).call(a,Z.errorCount,a.hcErrorCount);b(z,a).call(a,Z.warningCount,a.hcWarningCount);b(z,a).call(a,Z.statusCode,a.hcStatusCode);b(z,a).call(a,Z.errorMessage,a.hcErrorMessage)},incrementErrorCount:function(){a.hcErrorCount++},
incrementWarningCount:function(){a.hcWarningCount++},resetCounters:function(){a.hcErrorCount=0;a.hcWarningCount=0;a.hcStatusCode=-1;a.hcErrorMessage=""},saveRequestCounters:function(c,d){a.hcStatusCode=c;a.hcErrorMessage=d;b(z,a).call(a,Z.statusCode,a.hcStatusCode);b(z,a).call(a,Z.errorMessage,a.hcErrorMessage)}});l(mc,this,this);l(Ma,this,!t.i);l(X,this,!1);l(bb,this,"/i");l(Na,this,"/o/sdk");l(Oa,this,x("interval",p,500));l(Pa,this,x("queue_size",p,1E3));l(K,this,[]);l(N,this,[]);l(P,this,{});l(la,
this,[]);l(aa,this,{});l(ba,this,x("ignore_referrers",p,[]));l(cb,this,null);l(wa,this,!0);b(fa,this);l(db,this,0);l(S,this,null);l(xa,this,0);l(ya,this,0);l(eb,this,0);l(Qa,this,x("fail_timeout",p,60));l(za,this,x("inactivity_time",p,20));l(ra,this,0);l(Ra,this,x("session_update",p,60));l(Aa,this,x("max_events",p,100));l(sa,this,x("max_logs",p,null));l(ha,this,x("use_session_cookie",p,!0));l(Ba,this,x("session_cookie_timeout",p,30));l(Sa,this,!0);l(Ta,this,!1);l(L,this,x("offline_mode",p,!1));l(ca,
this,{});l(ma,this,!0);l(pb,this,M());l(na,this,!0);l(ta,this,null);l(H,this,1);l(Ca,this,!1);l(Da,this,0);l(fb,this,!1);l(oa,this,null);l(Ua,this,null);l(ia,this,null);l(ua,this,x("sdk_name",p,"javascript_native_web"));l(pa,this,x("sdk_version",p,"24.11.3"));l(gb,this,!1);l(hb,this,[]);l(qb,this,3E4);l(Kb,this,"/o/sdk/content");l(Ea,this,!1);l(Va,this,null);l(Xa,this,"cly-content-iframe");try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(c){b(e,this).call(this,
f.ERROR,"Local storage test failed, Halting local storage support: "+c),l(na,this,!1)}l(I,this,{});for(var F=0;F<t.features.length;F++)b(I,this)[t.features[F]]={};b(nc,this).call(this,p)}),Fc=!0;t.features="apm attribution clicks crashes events feedback forms location remote-config scrolls sessions star-rating users views".split(" ");t.q=t.q||[];t.onload=t.onload||[];t.CountlyClass=Ec;t.init=function(p){p=p||{};if(t.loadAPMScriptsAsync&&Fc)Fc=!1,Gc(p);else{var v=p.app_key||t.app_key;if(!t.i||!t.i[v]){p=
new Ec(p);if(!t.i){t.i={};for(var a in p)t[a]=p[a]}t.i[v]=p}return t.i[v]}};t.serialize=function(p){"object"===R(p)&&(p=JSON.stringify(p));return p};t.deserialize=function(p){if(""===p)return p;try{p=JSON.parse(p)}catch(v){$a()&&console.warn("[WARNING] [Countly] deserialize, Could not parse the file:["+p+"], error: "+v)}return p};t.getViewName=function(){return A?window.location.pathname:"web_worker"};t.getViewUrl=function(){return A?window.location.pathname:"web_worker"};t.getSearchQuery=function(){if(A)return window.location.search};
t.DeviceIdType={DEVELOPER_SUPPLIED:0,SDK_GENERATED:1,TEMPORARY_ID:2};A&&window.addEventListener("storage",function(p){var v=(p.key+"").split("/"),a=v.pop();v=v.pop();if(t.i&&t.i[v])t.i[v]._internals.onStorageChange(a,p.newValue)});va.default=t;Object.defineProperty(va,"__esModule",{value:!0})});
