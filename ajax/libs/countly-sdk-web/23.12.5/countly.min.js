...
function zb(l,k){for(var q=0;q<k.length;q++){var v=k[q];v.enumerable=v.enumerable||!1;v.configurable=!0;"value"in v&&(v.writable=!0);Object.defineProperty(l,Vb(v.key),v)}}function Vb(l){a:if("object"===typeof l&&null!==l){var k=l[Symbol.toPrimitive];if(void 0!==k){l=k.call(l,"string");if("object"!==typeof l)break a;throw new TypeError("@@toPrimitive must return a primitive value.");}l=String(l)}return"symbol"===typeof l?l:String(l)}function Ab(l){var k=[];if("undefined"!==typeof l.options)for(var q=
0;q<l.options.length;q++)l.options[q].selected&&k.push(l.options[q].value);return k.join(", ")}function gb(){var l=Bb("xxxxxxxx","[x]");var k=Date.now().toString();return l+k}function hb(){return Bb("xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx","[xy]")}function Bb(l,k){var q=(new Date).getTime();return l.replace(new RegExp(k,"g"),function(v){var G=(q+16*Math.random())%16|0;return("x"===v?G:G&3|8).toString(16)})}function F(){return Math.floor((new Date).getTime()/1E3)}function ib(){var l=(new Date).getTime();
Qa>=l?Qa++:Qa=l;return Qa}function t(l,k,q){if(k&&Object.keys(k).length){if("undefined"!==typeof k[l])return k[l]}else if("undefined"!==typeof p[l])return p[l];return q}function jb(l,k,q){for(var v in p.i)p.i[v].tracking_crashes&&p.i[v].recordError(l,k,q)}function za(l){var k=[],q;for(q in l)k.push(q+"="+encodeURIComponent(l[q]));return k.join("&")}function ua(l){return"string"===typeof l&&"/"===l.substring(l.length-1)?l.substring(0,l.length-1):l}function Aa(l,k){for(var q={},v,G=0,Q=k.length;G<Q;G++)v=
k[G],"undefined"!==typeof l[v]&&(q[v]=l[v]);return q}function aa(l,k,q,v,G,Q){var O={};if(l){if(Object.keys(l).length>v){var V={},Ba=0,ma;for(ma in l)Ba<v&&(V[ma]=l[ma],Ba++);l=V}for(var Ca in l)v=z(Ca,k,G,Q),V=z(l[Ca],q,G,Q),O[v]=V}return O}function z(l,k,q,v){var G=l;"number"===typeof l&&(l=l.toString());"string"===typeof l&&l.length>k&&(G=l.substring(0,k),v(c.DEBUG,q+", Key: [ "+l+" ] is longer than accepted length. It will be truncated."));return G}function A(l,k,q){x&&(null===l||"undefined"===
typeof l?Da()&&console.warn("[WARNING] [Countly] add_event_listener, Can't bind ["+k+"] event to nonexisting element"):"undefined"!==typeof l.addEventListener?l.addEventListener(k,q,!1):l.attachEvent("on"+k,q))}function Ra(l){return l?"undefined"!==typeof l.target?l.target:l.srcElement:window.event.srcElement}function va(l){if(l)return l;(l=navigator.userAgent)||(l=kb());return l}function kb(l){if(l)return l;l="";navigator.userAgentData&&(l=navigator.userAgentData.brands.map(function(k){return k.brand+
":"+k.version}).join(),l+=navigator.userAgentData.mobile?" mobi ":" ",l+=navigator.userAgentData.platform);return l}function Cb(l){if(!l){if(navigator.userAgentData&&navigator.userAgentData.mobile)return"phone";l=va()}l=l.toLowerCase();var k="desktop",q=/(mobi|ipod|phone|blackberry|opera mini|fennec|minimo|symbian|psp|nintendo ds|archos|skyfire|puffin|blazer|bolt|gobrowser|iris|maemo|semc|teashark|uzard)/;/(ipad|tablet|(android(?!.*mobile))|(windows(?!.*phone)(.*touch))|kindle|playbook|silk|(puffin(?!.*(IP|AP|WP))))/.test(l)?
k="tablet":q.test(l)&&(k="phone");return k}function Db(l){var k=/(CountlySiteBot|nuhk|Googlebot|GoogleSecurityScanner|Yammybot|Openbot|Slurp|MSNBot|Ask Jeeves\/Teoma|ia_archiver|bingbot|Google Web Preview|Mediapartners-Google|AdsBot-Google|Baiduspider|Ezooms|YahooSeeker|AltaVista|AVSearch|Mercator|Scooter|InfoSeek|Ultraseek|Lycos|Wget|YandexBot|Yandex|YaDirectFetcher|SiteBot|Exabot|AhrefsBot|MJ12bot|TurnitinBot|magpie-crawler|Nutch Crawler|CMS Crawler|rogerbot|Domnutch|ssearch_bot|XoviBot|netseer|digincore|fr-crawler|wesee|AliasIO|contxbot|PingdomBot|BingPreview|HeadlessChrome|Lighthouse)/;
if(l)return k.test(l);l=k.test(va());k=k.test(kb());return l||k}function lb(l){"undefined"===typeof l.pageY&&"number"===typeof l.clientX&&document.documentElement&&(l.pageX=l.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,l.pageY=l.clientY+document.body.scrollTop+document.documentElement.scrollTop);return l}function Sa(){var l=document;return Math.max(Math.max(l.body.scrollHeight,l.documentElement.scrollHeight),Math.max(l.body.offsetHeight,l.documentElement.offsetHeight),Math.max(l.body.clientHeight,
l.documentElement.clientHeight))}function mb(){var l=document;return Math.max(Math.max(l.body.scrollWidth,l.documentElement.scrollWidth),Math.max(l.body.offsetWidth,l.documentElement.offsetWidth),Math.max(l.body.clientWidth,l.documentElement.clientWidth))}function Eb(){var l=document;return Math.min(Math.min(l.body.clientHeight,l.documentElement.clientHeight),Math.min(l.body.offsetHeight,l.documentElement.offsetHeight),window.innerHeight)}function Fb(l,k,q,v,G,Q){l=document.createElement(l);var O;
l.setAttribute(k,q);l.setAttribute(v,G);k=function(){O||Q();O=!0};Q&&(l.onreadystatechange=k,l.onload=k);document.getElementsByTagName("head")[0].appendChild(l)}function Gb(l,k){Fb("script","type","text/javascript","src",l,k)}function Ta(l,k){Fb("link","rel","stylesheet","href",l,k)}function Hb(){if(x){var l=document.getElementById("cly-loader");if(!l){var k=document.head||document.getElementsByTagName("head")[0],q=document.createElement("style");q.type="text/css";q.styleSheet?q.styleSheet.cssText=
...
k.appendChild(q);l=document.createElement("div");l.setAttribute("id","cly-loader");document.body.onload=function(){if(p.showLoaderProtection)Da()&&console.warn("[WARNING] [Countly] showloader, Loader is already on");else try{document.body.appendChild(l)}catch(v){Da()&&console.error("[ERROR] [Countly] showLoader, Body is not loaded for loader to append: "+v)}}}l.style.display="block"}}function Da(){return p&&p.debug&&"undefined"!==typeof console?!0:!1}function Ib(){if(x){p.showLoaderProtection=!0;
var l=document.getElementById("cly-loader");l&&(l.style.display="none")}}function Wb(l){var k=document.createElement("script"),q=document.createElement("script");k.async=!0;q.async=!0;k.src=p.customSourceBoomerang||Jb.BOOMERANG_SRC;q.src=p.customSourceCountlyBoomerang||Jb.CLY_BOOMERANG_SRC;document.getElementsByTagName("head")[0].appendChild(k);document.getElementsByTagName("head")[0].appendChild(q);var v=!1,G=!1;k.onload=function(){v=!0};q.onload=function(){G=!0};var Q=0,O=setInterval(function(){Q+=
...
Qa=0,Tb=function(l,k,q){k&&zb(l.prototype,k);q&&zb(l,q);Object.defineProperty(l,"prototype",{writable:!1});return l}(function q(k){function v(a,d){if(f.ignore_visitor)b(c.ERROR,"Adding event failed. Possible bot or user opt out");else if(a.key){a.count||(a.count=1);Xb.includes(a.key)||(a.key=z(a.key,f.maxKeyLength,"add_cly_event",b));a.segmentation=aa(a.segmentation,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"add_cly_event",b);a=Aa(a,["key","count","sum","dur","segmentation"]);a.timestamp=
ib();var e=new Date;a.hour=e.getHours();a.dow=e.getDay();a.id=d||gb();a.key===M.VIEW?a.pvid=Ea||"":a.cvid=ha||"";J.push(a);w("cly_event",J);b(c.INFO,"With event ID: ["+a.id+"], successfully adding the last event:",a)}else b(c.ERROR,"Adding event failed. Event must have a key property")}function G(a,d,e,h,m){b(c.INFO,"fetch_remote_config_explicit, Fetching sequence initiated");var g={method:"rc",av:f.app_version};a&&(g.keys=JSON.stringify(a));d&&(g.omit_keys=JSON.stringify(d));var n;"legacy"===h&&
(g.method="fetch_remote_config");0===e&&(g.oi=0);1===e&&(g.oi=1);"function"===typeof m&&(n=m);f.check_consent("sessions")&&(g.metrics=JSON.stringify(Ua()));f.check_consent("remote-config")?(Fa(g),ba("fetch_remote_config_explicit",f.url+Va,g,function(r,u,I){if(!r){try{var C=JSON.parse(I);if(g.keys||g.omit_keys)for(var na in C)R[na]=C[na];else R=C;w("cly_remote_configs",R)}catch(Ga){b(c.ERROR,"fetch_remote_config_explicit, Had an issue while parsing the response: "+Ga)}n&&(b(c.INFO,"fetch_remote_config_explicit, Callback function is provided"),
n(r,R))}},!0)):(b(c.ERROR,"fetch_remote_config_explicit, Remote config requires explicit consent"),n&&n(Error("Remote config requires explicit consent"),R))}function Q(){b(c.INFO,"checkIgnore, Checking if user or visit should be ignored");f.ignore_prefetch&&x&&"undefined"!==typeof document.visibilityState&&"prerender"===document.visibilityState&&(f.ignore_visitor=!0,b(c.DEBUG,"checkIgnore, Ignoring visit due to prerendering"));f.ignore_bots&&Db()&&(f.ignore_visitor=!0,b(c.DEBUG,"checkIgnore, Ignoring visit due to bot"))}
...
C)}else b(c.WARNING,"processWidget, window object is not available. Not processing widget.")}function Ba(){var a;if("undefined"!==typeof f.onload&&0<f.onload.length){for(a=0;a<f.onload.length;a++)if("function"===typeof f.onload[a])f.onload[a](f);f.onload=[]}}function ma(){if(X){var a={name:X};f.check_consent("views")&&(v({key:M.VIEW,dur:pa?F()-Ha:Ia,segmentation:a},ha),X=null)}}function Ca(){if(ia){var a=y("cly_session");if(!a||parseInt(a)<=F())W=!1,f.begin_session(!Ja);w("cly_session",F()+60*Ka)}}
function Fa(a){a.app_key=f.app_key;a.device_id=f.device_id;a.sdk_name=wa;a.sdk_version=oa;a.t=D;a.av=f.app_version;var d=Lb();if(a.metrics){var e=JSON.parse(a.metrics);e._ua||(e._ua=d,a.metrics=JSON.stringify(e))}else a.metrics=JSON.stringify({_ua:d});f.check_consent("location")?(f.country_code&&(a.country_code=f.country_code),f.city&&(a.city=f.city),null!==f.ip_address&&(a.ip_address=f.ip_address)):a.location="";a.timestamp=ib();d=new Date;a.hour=d.getHours();a.dow=d.getDay()}function N(a){f.ignore_visitor?
b(c.WARNING,"User is opt_out will ignore the request: "+a):f.app_key&&f.device_id?(Fa(a),H.length>Wa&&H.shift(),H.push(a),w("cly_queue",H,!0)):b(c.ERROR,"app_key or device_id is missing ",f.app_key,f.device_id)}function Xa(){Ba();if(f.ignore_visitor)Ya=!1,b(c.WARNING,"User opt_out, no heartbeat");else{Ya=!0;Za&&"undefined"!==typeof p.q&&0<p.q.length&&qa();if(W&&Ja&&pa){var a=F();a-ja>$a&&(f.session_duration(a-ja),ja=a,0<f.hcErrorCount&&w(T.errorCount,f.hcErrorCount),0<f.hcWarningCount&&w(T.warningCount,
f.hcWarningCount))}0<J.length&&!f.test_mode_eq&&(J.length<=La?(N({events:JSON.stringify(J)}),J=[]):(a=J.splice(0,La),N({events:JSON.stringify(a)})),w("cly_event",J));!K&&0<H.length&&ab&&F()>nb&&(ab=!1,a=H[0],a.rr=H.length,b(c.DEBUG,"Processing request",a),w("cly_queue",H,!0),f.test_mode||ba("send_request_queue",f.url+ob,a,function(d,e){d?nb=F()+bb:H.shift();w("cly_queue",H,!0);ab=!0},!1));setTimeout(Xa,cb)}}function qa(){var a=p.q;p.q=[];for(var d=0;d<a.length;d++){var e=a[d];b(c.DEBUG,"Processing queued calls:"+
e);if("function"===typeof e)e();else if(Array.isArray(e)&&0<e.length){var h=f,m=0;try{p.i[e[m]]&&(h=p.i[e[m]],m++)}catch(n){b(c.DEBUG,"No instance found for the provided key while processing async queue")}if("function"===typeof h[e[m]])h[e[m]].apply(h,e.slice(m+1));else if(0===e[m].indexOf("userData.")){var g=e[m].replace("userData.","");"function"===typeof h.userData[g]&&h.userData[g].apply(h,e.slice(m+1))}else"function"===typeof p[e[m]]&&p[e[m]].apply(p,e.slice(m+1))}}}function pb(){var a=y("cly_id");
return a?(D=y("cly_id_type"),a):hb()}function Lb(){return f.metrics._ua||va()}function Ua(){var a=JSON.parse(JSON.stringify(f.metrics||{}));a._app_version=a._app_version||f.app_version;a._ua=a._ua||va();if(x&&screen.width){var d=screen.width?parseInt(screen.width):0,e=screen.height?parseInt(screen.height):0;if(0!==d&&0!==e){if(navigator.platform&&/iPad|iPhone|iPod/.test(navigator.platform)&&window.devicePixelRatio)d=Math.round(d*window.devicePixelRatio),e=Math.round(e*window.devicePixelRatio);else if(90===
Math.abs(window.orientation)){var h=d;d=e;e=h}a._resolution=a._resolution||""+d+"x"+e}}x&&window.devicePixelRatio&&(a._density=a._density||window.devicePixelRatio);d=navigator.language||navigator.browserLanguage||navigator.systemLanguage||navigator.userLanguage;"undefined"!==typeof d&&(a._locale=a._locale||d);qb()&&(a._store=a._store||document.referrer);b(c.DEBUG,"Got metrics",a);return a}function qb(a){if(!x)return!1;a=a||document.referrer;var d=!1;if("undefined"===typeof a||0===a.length)b(c.DEBUG,
"Invalid referrer:["+a+"], ignoring.");else{var e=Kb.exec(a);if(e)if(e[11])if(e[11]===window.location.hostname)b(c.DEBUG,"Referrer is current host:["+a+"], ignoring.");else if(ca&&ca.length)for(d=!0,e=0;e<ca.length;e++){if(0<=a.indexOf(ca[e])){b(c.DEBUG,"Referrer in ignore list:["+a+"], ignoring.");d=!1;break}}else b(c.DEBUG,"Valid referrer:["+a+"]"),d=!0;else b(c.DEBUG,"No path found in referrer:["+a+"], ignoring.");else b(c.DEBUG,"Referrer is corrupt:["+a+"], ignoring.")}return d}function b(a,d){if(f.debug&&
"undefined"!==typeof console){arguments[2]&&"object"===L(arguments[2])&&(arguments[2]=JSON.stringify(arguments[2]));Za||(d="["+f.app_key+"] "+d);a||(a=c.DEBUG);for(var e="",h=2;h<arguments.length;h++)e+=arguments[h];e=a+"[Countly] "+d+e;a===c.ERROR?(console.error(e),ra.incrementErrorCount()):a===c.WARNING?(console.warn(e),ra.incrementWarningCount()):a===c.INFO?console.info(e):a===c.VERBOSE?console.log(e):console.debug(e)}}function ba(a,d,e,h,m){x?Mb(a,d,e,h,m):Nb(a,d,e,h,m)}function Mb(a,d,e,h,m){m=
m||!1;try{b(c.DEBUG,"Sending XML HTTP request");var g=new XMLHttpRequest;e=e||{};var n=za(e),r="GET";if(f.force_post||2E3<=n.length)r="POST";"GET"===r?g.open("GET",d+"?"+n,!0):(g.open("POST",d,!0),g.setRequestHeader("Content-type","application/x-www-form-urlencoded"));for(var u in f.headers)g.setRequestHeader(u,f.headers[u]);g.onreadystatechange=function(){4===this.readyState&&(b(c.DEBUG,a+" HTTP request completed with status code: ["+this.status+"] and response: ["+this.responseText+"]"),(m?rb(this.status,
this.responseText):sb(this.status,this.responseText))?"function"===typeof h&&h(!1,e,this.responseText):(b(c.ERROR,a+" Invalid response from server"),"send_request_queue"===a&&ra.saveRequestCounters(this.status,this.responseText),"function"===typeof h&&h(!0,e,this.status,this.responseText)))};"GET"===r?g.send():g.send(n)}catch(I){b(c.ERROR,a+" Something went wrong while making an XML HTTP request: "+I),"function"===typeof h&&h(!0,e)}}function Nb(a,d,e,h,m){m=m||!1;var g;try{b(c.DEBUG,"Sending Fetch request");
var n="GET",r={"Content-type":"application/x-www-form-urlencoded"},u=null;e=e||{};f.force_post||2E3<=za(e).length?(n="POST",u=za(e)):d+="?"+za(e);for(var I in f.headers)r[I]=f.headers[I];fetch(d,{method:n,headers:r,body:u}).then(function(C){g=C;return g.text()}).then(function(C){b(c.DEBUG,a+" Fetch request completed wit status code: ["+g.status+"] and response: ["+C+"]");(m?rb(g.status,C):sb(g.status,C))?"function"===typeof h&&h(!1,e,C):(b(c.ERROR,a+" Invalid response from server"),"send_request_queue"===
a&&ra.saveRequestCounters(g.status,C),"function"===typeof h&&h(!0,e,g.status,C))})["catch"](function(C){b(c.ERROR,a+" Failed Fetch request: "+C);"function"===typeof h&&h(!0,e)})}catch(C){b(c.ERROR,a+" Something went wrong with the Fetch request attempt: "+C),"function"===typeof h&&h(!0,e)}}function sb(a,d){if(!(200<=a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(d);return"[object Object]"!==Object.prototype.toString.call(e)?
(b(c.ERROR,"Http response is not JSON Object"),!1):!!e.result}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function rb(a,d){if(!(200<=a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(d);return"[object Object]"===Object.prototype.toString.call(e)||Array.isArray(e)?!0:(b(c.ERROR,"Http response is not JSON Object nor JSON Array"),!1)}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function Ob(){x?
Ma=Math.max(Ma,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop):b(c.WARNING,"processScroll, window object is not available. Not processing scroll.")}function tb(){if(!x)b(c.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Na){Na=!1;var a=Sa(),d=mb(),e=Eb();f.check_consent("scrolls")&&(a={type:"scroll",y:Ma+e,width:d,height:a,view:f.getViewUrl()},a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",
b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}function Pb(a){w("cly_token",a)}function Qb(a,d,e){var h=new Date;h.setTime(h.getTime()+864E5*e);e="; expires="+h.toGMTString();document.cookie=a+"="+d+e+"; path=/"}function y(a,d,e){if("none"===f.storage||"object"!==L(f.storage)&&!x)b(c.DEBUG,"Storage is disabled. Value with key: ["+a+"] won't be retrieved");else{e||(a=f.app_key+"/"+a,f.namespace&&(a=ua(f.namespace)+"/"+a));if("object"===L(f.storage)&&"function"===
typeof f.storage.getItem){var h=f.storage.getItem(a);return a.endsWith("cly_id")?h:f.deserialize(h)}void 0===d&&(d=sa);if(d)h=localStorage.getItem(a);else if("localstorage"!==f.storage)a:{d=a+"=";e=document.cookie.split(";");h=0;for(var m=e.length;h<m;h++){for(var g=e[h];" "===g.charAt(0);)g=g.substring(1,g.length);if(0===g.indexOf(d)){h=g.substring(d.length,g.length);break a}}h=null}return a.endsWith("cly_id")?h:f.deserialize(h)}}function w(a,d,e,h){"none"===f.storage||"object"!==L(f.storage)&&!x?
b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be stored"):(h||(a=f.app_key+"/"+a,f.namespace&&(a=ua(f.namespace)+"/"+a)),"undefined"!==typeof d&&null!==d&&("object"===L(f.storage)&&"function"===typeof f.storage.setItem?f.storage.setItem(a,d):(void 0===e&&(e=sa),d=f.serialize(d),e?localStorage.setItem(a,d):"localstorage"!==f.storage&&Qb(a,d,30))))}function S(a,d,e){"none"===f.storage||"object"!==L(f.storage)&&!x?b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be removed"):
(e||(a=f.app_key+"/"+a,f.namespace&&(a=ua(f.namespace)+"/"+a)),"object"===L(f.storage)&&"function"===typeof f.storage.removeItem?f.storage.removeItem(a):(void 0===d&&(d=sa),d?localStorage.removeItem(a):"localstorage"!==f.storage&&Qb(a,"",-1)))}function Yb(){if(y(f.namespace+"cly_id",!1,!0)){w("cly_id",y(f.namespace+"cly_id",!1,!0));w("cly_id_type",y(f.namespace+"cly_id_type",!1,!0));w("cly_event",y(f.namespace+"cly_event",!1,!0));w("cly_session",y(f.namespace+"cly_session",!1,!0));var a=y(f.namespace+
"cly_queue",!1,!0);Array.isArray(a)&&(a=a.filter(function(d){return d.app_key===f.app_key}),w("cly_queue",a));y(f.namespace+"cly_cmp_id",!1,!0)&&(w("cly_cmp_id",y(f.namespace+"cly_cmp_id",!1,!0)),w("cly_cmp_uid",y(f.namespace+"cly_cmp_uid",!1,!0)));y(f.namespace+"cly_ignore",!1,!0)&&w("cly_ignore",y(f.namespace+"cly_ignore",!1,!0));S("cly_id",!1,!0);S("cly_id_type",!1,!0);S("cly_event",!1,!0);S("cly_session",!1,!0);S("cly_queue",!1,!0);S("cly_cmp_id",!1,!0);S("cly_cmp_uid",!1,!0);S("cly_ignore",!1,
!0)}}if(!(this instanceof q))throw new TypeError("Cannot call a class as a function");var f=this,Za=!p.i,W=!1,ob="/i",Va="/o/sdk",cb=t("interval",k,500),Wa=t("queue_size",k,1E3),H=[],J=[],R={},ta=[],da={},ca=t("ignore_referrers",k,[]),ub=null,Ja=!0,ja,vb=0,X=null,Ha=0,Ia=0,nb=0,bb=t("fail_timeout",k,60),Oa=t("inactivity_time",k,20),Pa=0,$a=t("session_update",k,60),La=t("max_events",k,100),xa=t("max_logs",k,null),ia=t("use_session_cookie",k,!0),Ka=t("session_cookie_timeout",k,30),ab=!0,Ya=!1,K=t("offline_mode",
k,!1),ea={},pa=!0,Rb=F(),sa=!0,ya=null,D=1,Na=!1,Ma=0,wb=!1,ha=null,Ea=null,ka=null,wa=t("sdk_name",k,"javascript_native_web"),oa=t("sdk_version",k,"23.12.5");try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){b(c.ERROR,"Local storage test failed, Halting local storage support: "+a),sa=!1}for(var E={},xb=0;xb<p.features.length;xb++)E[p.features[xb]]={};this.initialize=function(){this.serialize=t("serialize",k,p.serialize);this.deserialize=t("deserialize",
k,p.deserialize);this.getViewName=t("getViewName",k,p.getViewName);this.getViewUrl=t("getViewUrl",k,p.getViewUrl);this.getSearchQuery=t("getSearchQuery",k,p.getSearchQuery);this.DeviceIdType=p.DeviceIdType;this.namespace=t("namespace",k,"");this.clearStoredId=t("clear_stored_id",k,!1);this.app_key=t("app_key",k,null);this.onload=t("onload",k,[]);this.utm=t("utm",k,{source:!0,medium:!0,campaign:!0,term:!0,content:!0});this.ignore_prefetch=t("ignore_prefetch",k,!0);this.rcAutoOptinAb=t("rc_automatic_optin_for_ab",
k,!0);this.useExplicitRcApi=t("use_explicit_rc_api",k,!1);this.debug=t("debug",k,!1);this.test_mode=t("test_mode",k,!1);this.test_mode_eq=t("test_mode_eq",k,!1);this.metrics=t("metrics",k,{});this.headers=t("headers",k,{});this.url=ua(t("url",k,""));this.app_version=t("app_version",k,"0.0");this.country_code=t("country_code",k,null);this.city=t("city",k,null);this.ip_address=t("ip_address",k,null);this.ignore_bots=t("ignore_bots",k,!0);this.force_post=t("force_post",k,!1);this.remote_config=t("remote_config",
k,!1);this.ignore_visitor=t("ignore_visitor",k,!1);this.require_consent=t("require_consent",k,!1);this.track_domains=x?t("track_domains",k,!0):void 0;this.storage=t("storage",k,"default");this.enableOrientationTracking=x?t("enable_orientation_tracking",k,!0):void 0;this.maxKeyLength=t("max_key_length",k,128);this.maxValueSize=t("max_value_size",k,256);this.maxSegmentationValues=t("max_segmentation_values",k,100);this.maxBreadcrumbCount=t("max_breadcrumb_count",k,null);this.maxStackTraceLinesPerThread=
t("max_stack_trace_lines_per_thread",k,30);this.maxStackTraceLineLength=t("max_stack_trace_line_length",k,200);this.heatmapWhitelist=t("heatmap_whitelist",k,[]);f.hcErrorCount=y(T.errorCount)||0;f.hcWarningCount=y(T.warningCount)||0;f.hcStatusCode=y(T.statusCode)||-1;f.hcErrorMessage=y(T.errorMessage)||"";xa&&!this.maxBreadcrumbCount?(this.maxBreadcrumbCount=xa,b(c.WARNING,"initialize, 'maxCrashLogs' is deprecated. Use 'maxBreadcrumbCount' instead!")):xa||this.maxBreadcrumbCount||(this.maxBreadcrumbCount=
100);"cookie"===this.storage&&(sa=!1);this.rcAutoOptinAb||this.useExplicitRcApi||(b(c.WARNING,"initialize, Auto opting is disabled, switching to explicit RC API"),this.useExplicitRcApi=!0);Array.isArray(ca)||(ca=[]);""===this.url&&(b(c.ERROR,"initialize, Please provide server URL"),this.ignore_visitor=!0);y("cly_ignore")&&(this.ignore_visitor=!0);Yb();H=y("cly_queue")||[];J=y("cly_event")||[];R=y("cly_remote_configs")||{};this.clearStoredId&&(y("cly_id")&&!g&&(this.device_id=y("cly_id"),b(c.DEBUG,
"initialize, temporarily using the previous device ID to flush existing events"),D=y("cly_id_type"),D||(b(c.DEBUG,"initialize, No device ID type info from the previous session, falling back to DEVELOPER_SUPPLIED, for event flushing"),D=0),qa(),O(),this.device_id=void 0,D=1),b(c.INFO,"initialize, Clearing the device ID storage"),S("cly_id"),S("cly_id_type"),S("cly_session"));Q();if(x)if(window.name&&0===window.name.indexOf("cly:"))try{this.passed_data=JSON.parse(window.name.replace("cly:",""))}catch(r){b(c.ERROR,
"initialize, Could not parse name: "+window.name+", error: "+r)}else if(location.hash&&0===location.hash.indexOf("#cly:"))try{this.passed_data=JSON.parse(location.hash.replace("#cly:",""))}catch(r){b(c.ERROR,"initialize, Could not parse hash: "+location.hash+", error: "+r)}if((this.passed_data&&this.passed_data.app_key&&this.passed_data.app_key===this.app_key||this.passed_data&&!this.passed_data.app_key&&Za)&&this.passed_data.token&&this.passed_data.purpose){this.passed_data.token!==y("cly_old_token")&&
(Pb(this.passed_data.token),w("cly_old_token",this.passed_data.token));var a=[];Array.isArray(this.heatmapWhitelist)?(this.heatmapWhitelist.push(this.url),a=this.heatmapWhitelist.map(function(r){return ua(r)})):a=[this.url];a.includes(this.passed_data.url)&&"heatmap"===this.passed_data.purpose&&(this.ignore_visitor=!0,Hb(),Gb(this.passed_data.url+"/views/heatmap.js",Ib))}if(this.ignore_visitor)b(c.WARNING,"initialize, ignore_visitor:["+this.ignore_visitor+"], this user will not be tracked");else{"javascript_native_web"===
wa&&"23.12.5"===oa?b(c.DEBUG,"initialize, SDK name:["+wa+"], version:["+oa+"]"):b(c.DEBUG,"initialize, SDK name:["+wa+"], version:["+oa+"], default name:[javascript_native_web] and default version:[23.12.5]");b(c.DEBUG,"initialize, app_key:["+this.app_key+"], url:["+this.url+"]");b(c.DEBUG,"initialize, device_id:["+t("device_id",k,void 0)+"]");b(c.DEBUG,"initialize, require_consent is enabled:["+this.require_consent+"]");try{b(c.DEBUG,"initialize, metric override:["+JSON.stringify(this.metrics)+"]"),
b(c.DEBUG,"initialize, header override:["+JSON.stringify(this.headers)+"]"),b(c.DEBUG,"initialize, number of onload callbacks provided:["+this.onload.length+"]"),b(c.DEBUG,"initialize, utm tags:["+JSON.stringify(this.utm)+"]"),ca&&b(c.DEBUG,"initialize, referrers to ignore :["+JSON.stringify(ca)+"]")}catch(r){b(c.ERROR,"initialize, Could not stringify some config object values")}b(c.DEBUG,"initialize, app_version:["+this.app_version+"]");b(c.DEBUG,"initialize, provided location info; country_code:["+
this.country_code+"], city:["+this.city+"], ip_address:["+this.ip_address+"]");""!==this.namespace&&b(c.DEBUG,"initialize, namespace given:["+this.namespace+"]");this.clearStoredId&&b(c.DEBUG,"initialize, clearStoredId flag set to:["+this.clearStoredId+"]");this.ignore_prefetch&&b(c.DEBUG,"initialize, ignoring pre-fetching and pre-rendering from counting as real website visits :["+this.ignore_prefetch+"]");this.test_mode&&b(c.WARNING,"initialize, test_mode:["+this.test_mode+"], request queue won't be processed");
...
this.force_post+"]");this.remote_config&&b(c.DEBUG,"initialize, remote_config callback provided:["+!!this.remote_config+"]");"boolean"===typeof this.rcAutoOptinAb&&b(c.DEBUG,"initialize, automatic RC optin is enabled:["+this.rcAutoOptinAb+"]");this.useExplicitRcApi||b(c.WARNING,"initialize, will use legacy RC API. Consider enabling new API during init with use_explicit_rc_api flag");this.track_domains&&b(c.DEBUG,"initialize, tracking domain info:["+this.track_domains+"]");this.enableOrientationTracking&&
b(c.DEBUG,"initialize, enableOrientationTracking:["+this.enableOrientationTracking+"]");ia||b(c.WARNING,"initialize, use_session_cookie is enabled:["+ia+"]");K&&b(c.DEBUG,"initialize, offline_mode:["+K+"], user info won't be send to the servers");K&&b(c.DEBUG,"initialize, stored remote configs:["+JSON.stringify(R)+"]");b(c.DEBUG,"initialize, 'getViewName' callback override provided:["+(this.getViewName!==p.getViewName)+"]");b(c.DEBUG,"initialize, 'getSearchQuery' callback override provided:["+(this.getSearchQuery!==
p.getSearchQuery)+"]");128!==this.maxKeyLength&&b(c.DEBUG,"initialize, maxKeyLength set to:["+this.maxKeyLength+"] characters");256!==this.maxValueSize&&b(c.DEBUG,"initialize, maxValueSize set to:["+this.maxValueSize+"] characters");100!==this.maxSegmentationValues&&b(c.DEBUG,"initialize, maxSegmentationValues set to:["+this.maxSegmentationValues+"] key/value pairs");100!==this.maxBreadcrumbCount&&b(c.DEBUG,"initialize, maxBreadcrumbCount for custom logs set to:["+this.maxBreadcrumbCount+"] entries");
30!==this.maxStackTraceLinesPerThread&&b(c.DEBUG,"initialize, maxStackTraceLinesPerThread set to:["+this.maxStackTraceLinesPerThread+"] lines");200!==this.maxStackTraceLineLength&&b(c.DEBUG,"initialize, maxStackTraceLineLength set to:["+this.maxStackTraceLineLength+"] characters");500!==cb&&b(c.DEBUG,"initialize, interval for heartbeats set to:["+cb+"] milliseconds");1E3!==Wa&&b(c.DEBUG,"initialize, queue_size set to:["+Wa+"] items max");60!==bb&&b(c.DEBUG,"initialize, fail_timeout set to:["+bb+"] seconds of wait time after a failed connection to server");
20!==Oa&&b(c.DEBUG,"initialize, inactivity_time set to:["+Oa+"] minutes to consider a user as inactive after no observable action");60!==$a&&b(c.DEBUG,"initialize, session_update set to:["+$a+"] seconds to check if extending a session is needed while the user is active");100!==La&&b(c.DEBUG,"initialize, max_events set to:["+La+"] events to send in one batch");xa&&b(c.WARNING,"initialize, max_logs set to:["+xa+"] breadcrumbs to store for crash logs max, deprecated ");30!==Ka&&b(c.DEBUG,"initialize, session_cookie_timeout set to:["+
Ka+"] minutes to expire a cookies session");b(c.INFO,"initialize, Countly initialized");a=null;g=f.getSearchQuery();var d=!1,e={};if(g){0===g.indexOf("?")&&(g=g.substring(1));g=g.split("&");for(var h=0;h<g.length;h++){var m=g[h].split("=");"cly_id"===m[0]?w("cly_cmp_id",m[1]):"cly_uid"===m[0]?w("cly_cmp_uid",m[1]):"cly_device_id"===m[0]?a=m[1]:0===(m[0]+"").indexOf("utm_")&&this.utm[m[0].replace("utm_","")]&&(e[m[0].replace("utm_","")]=m[1],d=!0)}}var g="[CLY]_temp_id"===y("cly_id");h=t("device_id",
k,void 0);"number"===typeof h&&(h=h.toString());y("cly_id")&&!g?(this.device_id=y("cly_id"),b(c.INFO,"initialize, Set the stored device ID"),D=y("cly_id_type"),D||(b(c.INFO,"initialize, No device ID type info from the previous session, falling back to DEVELOPER_SUPPLIED"),D=0)):null!==a?(b(c.INFO,"initialize, Device ID set by URL"),this.device_id=a,D=3):h?(b(c.INFO,"initialize, Device ID set by developer"),this.device_id=h,k&&Object.keys(k).length?void 0!==k.device_id&&(D=0):void 0!==p.device_id&&
(D=0)):K||g?(this.device_id="[CLY]_temp_id",D=2,K&&g?b(c.INFO,"initialize, Temp ID set, continuing offline mode from previous app session"):K&&!g?b(c.INFO,"initialize, Temp ID set, entering offline mode"):(K=!0,b(c.INFO,"initialize, Temp ID set, enabling offline mode"))):(b(c.INFO,"initialize, Generating the device ID"),this.device_id=t("device_id",k,pb()),k&&Object.keys(k).length?void 0!==k.device_id&&(D=0):void 0!==p.device_id&&(D=0));w("cly_id",this.device_id);w("cly_id_type",D);if(d){ka={};for(var n in this.utm)e[n]?
(this.userData.set("utm_"+n,e[n]),ka[n]=e[n]):this.userData.unset("utm_"+n);this.userData.save()}Ba();setTimeout(function(){p.noHeartBeat?b(c.WARNING,"initialize, Heartbeat disabled. This is for testing purposes only!"):Xa();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);x&&document.documentElement.setAttribute("data-countly-useragent",va());ra.sendInstantHCRequest()}};this.halt=function(){b(c.WARNING,"halt, Resetting Countly");p.i=void 0;p.q=[];p.noHeartBeat=void 0;Za=!p.i;W=!1;ob="/i";
Va="/o/sdk";cb=500;Wa=1E3;H=[];J=[];R={};ta=[];da={};ca=[];ub=null;Ja=!0;vb=0;X=null;nb=Ia=Ha=0;bb=60;Oa=20;Pa=0;$a=60;La=100;xa=null;ia=!0;Ka=30;ab=!0;K=Ya=!1;ea={};pa=!0;Rb=F();sa=!0;ya=null;D=1;Na=!1;Ma=0;wb=!1;ka=Ea=ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(d){b(c.ERROR,"halt, Local storage test failed, will fallback to cookies"),sa=!1}p.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
"check_any_consent, require_consent is off, no consent is necessary"),!0;for(var a in E)if(E[a]&&E[a].optin)return!0;b(c.INFO,"check_any_consent, No consents given");return!1};this.add_consent=function(a){b(c.INFO,"add_consent, Adding consent for ["+a+"]");if(Array.isArray(a))for(var d=0;d<a.length;d++)this.add_consent(a[d]);else E[a]?E[a].features?(E[a].optin=!0,this.add_consent(E[a].features)):!0!==E[a].optin&&(E[a].optin=!0,Sb(),setTimeout(function(){"sessions"===a&&ea.begin_session?(f.begin_session.apply(f,
...
if(this.check_consent("sessions")){if(!W){this.enableOrientationTracking&&(this.report_orientation(),A(window,"resize",function(){f.report_orientation()}));ja=F();W=!0;Ja=!a;var e=y("cly_session");b(c.VERBOSE,"begin_session, Session state, forced: ["+d+"], useSessionCookie: ["+ia+"], seconds to expire: ["+(e-ja)+"], expired: ["+(parseInt(e)<=F())+"] ");if(d||!ia||!e||parseInt(e)<=F())b(c.INFO,"begin_session, Session started"),null===ya&&(ya=!0),e={begin_session:1},e.metrics=JSON.stringify(Ua()),N(e);
w("cly_session",F()+60*Ka)}}else ea.begin_session=arguments};this.session_duration=function(a){b(c.INFO,"session_duration, Reporting session duration");this.check_consent("sessions")&&W&&(b(c.INFO,"session_duration, Session extended: ",a),N({session_duration:a}),Ca())};this.end_session=function(a,d){b(c.INFO,"end_session, Ending the current session. There was an on going session:["+W+"]");this.check_consent("sessions")&&W&&(a=a||F()-ja,ma(),!ia||d?(b(c.INFO,"end_session, Session ended"),N({end_session:1,
session_duration:a})):this.session_duration(a),W=!1)};this.change_id=function(a,d){b(c.INFO,"change_id, Changing the ID");d&&b(c.INFO,"change_id, Will merge the IDs");if(!a||"string"!==typeof a||0===a.length)b(c.ERROR,"change_id, The provided ID: ["+a+"] is not a valid ID");else if(K)b(c.WARNING,"change_id, Offline mode was on, initiating disabling sequence instead."),this.disable_offline_mode(a);else if(this.device_id!=a){d||(qa(),O(),this.end_session(null,!0),da={},this.remove_consent_internal(p.features,
!1));var e=this.device_id;this.device_id=a;f.device_id=this.device_id;D=0;w("cly_id",this.device_id);w("cly_id_type",0);b(c.INFO,"change_id, Changing ID from:["+e+"] to ["+a+"]");d?N({old_device_id:e}):this.begin_session(!Ja,!0);this.remote_config&&(R={},w("cly_remote_configs",R),this.fetch_remote_config(this.remote_config))}};this.add_event=function(a){b(c.INFO,"add_event, Adding event: ",a);switch(a.key){case M.NPS:var d=this.check_consent("feedback");break;case M.SURVEY:d=this.check_consent("feedback");
...
(qa(),O(),b(c.INFO,"user_details, flushed the event queue"),N({user_details:JSON.stringify({custom:Y})}));Y={}}};this.report_trace=function(a){b(c.INFO,"report_trace, Reporting performance trace");if(this.check_consent("apm")){for(var d="type name stz etz apm_metrics apm_attr".split(" "),e=0;e<d.length;e++)if("apm_attr"!==d[e]&&"undefined"===typeof a[d[e]]){b(c.WARNING,"report_trace, APM trace don't have the property: "+d[e]);return}a.name=z(a.name,f.maxKeyLength,"report_trace",b);a.app_metrics=aa(a.app_metrics,
f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"report_trace",b);d=Aa(a,d);d.timestamp=a.stz;a=new Date;d.hour=a.getHours();d.dow=a.getDay();N({apm:JSON.stringify(d)});b(c.INFO,"report_trace, Successfully adding APM trace: ",d)}};this.track_errors=function(a){x?(b(c.INFO,"track_errors, Started tracking errors"),p.i[this.app_key].tracking_crashes=!0,window.cly_crashes||(window.cly_crashes=!0,ub=a,window.onerror=function r(e,h,m,g,n){if(void 0!==n&&null!==n)jb(n,!1);else{g=g||window.event&&window.event.errorCharacter;
n="";"undefined"!==typeof e&&(n+=e+"\n");"undefined"!==typeof h&&(n+="at "+h);"undefined"!==typeof m&&(n+=":"+m);"undefined"!==typeof g&&(n+=":"+g);n+="\n";try{e=[];for(var u=r.caller;u;)e.push(u.name),u=u.caller;n+=e.join("\n")}catch(I){b(c.ERROR,"track_errors, Call stack generation experienced a problem: "+I)}jb(n,!1)}},window.addEventListener("unhandledrejection",function(e){jb(Error("Unhandled rejection (reason: "+(e.reason&&e.reason.stack?e.reason.stack:e.reason)+")."),!0)}))):b(c.WARNING,"track_errors, window object is not available. Not tracking errors.")};
this.log_error=function(a,d){b(c.INFO,"log_error, Logging errors");this.recordError(a,!0,d)};this.add_log=function(a){b(c.INFO,"add_log, Adding a new log of breadcrumbs: [ "+a+" ]");if(this.check_consent("crashes")){for(a=z(a,f.maxValueSize,"add_log",b);ta.length>=f.maxBreadcrumbCount;)ta.shift(),b(c.WARNING,"add_log, Reached maximum crashLogs size. Will erase the oldest one.");ta.push(a)}};this.fetch_remote_config=function(a,d,e){var h=null,m=null,g=null;a&&(e||"function"!==typeof a?Array.isArray(a)&&
...
Fa(a),ba("enrollUserToAb",this.url+Va,a,function(d,e,h){if(!d)try{var m=JSON.parse(h);b(c.DEBUG,"enrollUserToAb, Parsed the response's result: ["+m.result+"]")}catch(g){b(c.ERROR,"enrollUserToAb, Had an issue while parsing the response: "+g)}},!0)):b(c.ERROR,"enrollUserToAb, No keys provided")};this.get_remote_config=function(a){b(c.INFO,"get_remote_config, Getting remote config from storage");return"undefined"!==typeof a?R[a]:R};this.stop_time=function(){b(c.INFO,"stop_time, Stopping tracking duration");
pa&&(pa=!1,vb=F()-ja,Ia=F()-Ha)};this.start_time=function(){b(c.INFO,"start_time, Starting tracking duration");pa||(pa=!0,ja=F()-vb,Ha=F()-Ia,Ia=0,Ca())};this.track_sessions=function(){function a(){document[e]||!document.hasFocus()?f.stop_time():f.start_time()}function d(){Pa>=Oa&&f.start_time();Pa=0}if(x){b(c.INFO,"track_session, Starting tracking user session");this.begin_session();this.start_time();A(window,"beforeunload",function(){qa();O();f.end_session()});var e="hidden";A(window,"focus",a);
...
"click",d);A(window,"keydown",d);A(window,"scroll",d);setInterval(function(){Pa++;Pa>=Oa&&f.stop_time()},6E4)}else b(c.WARNING,"track_sessions, window object is not available. Not tracking sessions.")};this.track_pageview=function(a,d,e){if(x||a)if(b(c.INFO,"track_pageview, Tracking page views"),b(c.VERBOSE,"track_pageview, last view is:["+X+"], current view ID is:["+ha+"], previous view ID is:["+Ea+"]"),X&&wb&&(b(c.DEBUG,"track_pageview, Scroll registry triggered"),tb(),Na=!0,Ma=0),ma(),Ea=ha,ha=
gb(),(a=z(a,f.maxKeyLength,"track_pageview",b))&&Array.isArray(a)&&(d=a,a=null),a||(a=this.getViewName()),void 0===a||""===a)b(c.ERROR,"track_pageview, No page name to track (it is either undefined or empty string). No page view can be tracked.");else if(null===a)b(c.ERROR,"track_pageview, View name returned as null. Page view will be ignored.");else{if(d&&d.length)for(var h=0;h<d.length;h++)try{if((new RegExp(d[h])).test(a)){b(c.INFO,"track_pageview, Ignoring the page: "+a);return}}catch(r){b(c.ERROR,
"track_pageview, Problem with finding ignore list item: "+d[h]+", error: "+r)}X=a;Ha=F();b(c.VERBOSE,"track_pageview, last view is assigned:["+X+"], current view ID is:["+ha+"], previous view ID is:["+Ea+"]");h={name:a,visit:1,view:f.getViewUrl()};h=aa(h,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"track_pageview",b);this.track_domains&&(h.domain=window.location.hostname);if(ia)if(W)ya&&(ya=!1,h.start=1);else{var m=y("cly_session");if(!m||parseInt(m)<=F())ya=!1,h.start=1}else x&&"undefined"!==
typeof document.referrer&&document.referrer.length&&(m=Kb.exec(document.referrer))&&m[11]&&m[11]!==window.location.hostname&&(h.start=1);if(ka&&Object.keys(ka).length){b(c.INFO,"track_pageview, Adding fresh utm tags to segmentation:["+JSON.stringify(ka)+"]");for(var g in ka)"undefined"===typeof h["utm_"+g]&&(h["utm_"+g]=ka[g])}x&&qb()&&(b(c.INFO,"track_pageview, Adding referrer to segmentation:["+document.referrer+"]"),h.referrer=document.referrer);if(e){e=aa(e,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,
...
a+"]");a=a||document;var d=!0;A(a,"click",function(e){if(d){d=!1;lb(e);if("undefined"!==typeof e.pageX&&"undefined"!==typeof e.pageY){var h=Sa(),m=mb();f.check_consent("clicks")&&(e={type:"click",x:e.pageX,y:e.pageY,width:m,height:h,view:f.getViewUrl()},e=aa(e,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processClick",b),f.track_domains&&(e.domain=window.location.hostname),v({key:M.ACTION,segmentation:e}))}setTimeout(function(){d=!0},1E3)}})}else b(c.WARNING,"track_clicks, window object is not available. Not tracking clicks.")};
this.track_scrolls=function(a){x?(b(c.INFO,"track_scrolls, Starting to track scrolls"),a&&b(c.INFO,"track_scrolls, Tracking the specified children"),a=a||window,wb=Na=!0,A(a,"scroll",Ob),A(a,"beforeunload",tb)):b(c.WARNING,"track_scrolls, window object is not available. Not tracking scrolls.")};this.track_links=function(a){x?(b(c.INFO,"track_links, Starting to track clicks to links"),a&&b(c.INFO,"track_links, Tracking the specified children"),a=a||document,A(a,"click",function(d){a:{var e=Ra(d);var h;
for(h="A";e;){if(e.nodeName.toUpperCase()===h)break a;e=e.parentElement}e=void 0}e&&(lb(d),f.check_consent("clicks")&&v({key:"linkClick",segmentation:{href:e.href,text:e.innerText,id:e.id,view:f.getViewUrl()}}))})):b(c.WARNING,"track_links, window object is not available. Not tracking links.")};this.track_forms=function(a,d){function e(h){return h.name||h.id||h.type||h.nodeName}x?(b(c.INFO,"track_forms, Starting to track form submissions. DOM object provided:["+!!a+"] Tracking hidden inputs :["+!!d+
"]"),a=a||document,A(a,"submit",function(h){h=Ra(h);var m={id:h.attributes.id&&h.attributes.id.nodeValue,name:h.attributes.name&&h.attributes.name.nodeValue,action:h.attributes.action&&h.attributes.action.nodeValue,method:h.attributes.method&&h.attributes.method.nodeValue,view:f.getViewUrl()},g;if("undefined"!==typeof h.elements){for(var n=0;n<h.elements.length;n++)(g=h.elements[n])&&"password"!==g.type&&-1===g.className.indexOf("cly_user_ignore")&&("undefined"===typeof m["input:"+e(g)]&&(m["input:"+
...
g[e].is_active){var n=g[e].target_devices,r=Cb();if(n[r])if("string"===typeof g[e].hide_sticker&&(g[e].hide_sticker="true"===g[e].hide_sticker),"all"!==g[e].target_page||g[e].hide_sticker){var u=g[e].target_pages;for(h=0;h<u.length;h++){var I=u[h].substr(0,u[h].length-1)===window.location.pathname.substr(0,u[h].length-1),C=u[h]===window.location.pathname;(u[h].includes("*")&&I||C)&&!g[e].hide_sticker&&V(g[e],!0)}}else V(g[e],!0)}}catch(na){b(c.ERROR,"initializeRatingWidgets, JSON parse error: "+na)}},
...
n+="/feedback/survey";else if("rating"===a.type)b(c.DEBUG,"present_feedback_widget, Widget type: rating."),n+="/feedback/rating";else{b(c.ERROR,"present_feedback_widget, Feedback widget only accepts nps, rating and survey types.");return}var r=window.origin||window.location.origin;if("rating"===a.type){b(c.DEBUG,"present_feedback_widget, Loading css for rating widget.");var u="ratings";Ta(this.url+"/star-rating/stylesheets/countly-feedback-web.css")}else b(c.DEBUG,"present_feedback_widget, Loading css for survey or nps."),
Ta(this.url+"/surveys/stylesheets/countly-surveys.css"),u="surveys";n+="?widget_id="+a._id;n+="&app_key="+this.app_key;n+="&device_id="+this.device_id;n+="&sdk_name="+wa;n+="&platform="+this.platform;n+="&app_version="+this.app_version;n+="&sdk_version="+oa;if(h){var I={};I.sg=h;n+="&custom="+JSON.stringify(I)}n+="&origin="+r;n+="&widget_v=web";var C=document.createElement("iframe");C.src=n;C.name="countly-"+u+"-iframe";C.id="countly-"+u+"-iframe";var na=!1;C.onload=function(){na&&(document.getElementById("countly-"+
u+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display="none");na=!0;b(c.DEBUG,"present_feedback_widget, Loaded iframe.")};for(var Ga=document.getElementById("csbg");Ga;)Ga.remove(),Ga=document.getElementById("csbg"),b(c.DEBUG,"present_feedback_widget, Removing past overlay.");var Z=document.getElementsByClassName("countly-"+u+"-wrapper");for(h=0;h<Z.length;h++)Z[h].remove(),b(c.DEBUG,"present_feedback_widget, Removed a wrapper.");Z=document.createElement("div");Z.className=
"countly-"+u+"-wrapper";Z.id="countly-"+u+"-wrapper-"+a._id;"survey"===a.type&&(Z.className=Z.className+" "+a.appearance.position);var eb=document.body;h=!1;d&&(document.getElementById(d)?(eb=document.getElementById(d),h=!0):b(c.ERROR,"present_feedback_widget, Provided ID not found."));h||e&&(document.getElementsByClassName(e)[0]?eb=document.getElementsByClassName(e)[0]:b(c.ERROR,"present_feedback_widget, Provided class not found."));eb.insertAdjacentHTML("beforeend",'<div id="csbg"></div>');eb.appendChild(Z);
if("rating"===a.type){var yb=document.createElement("div");yb.className="countly-ratings-overlay";yb.id="countly-ratings-overlay-"+a._id;Z.appendChild(yb);b(c.DEBUG,"present_feedback_widget, appended the rating overlay to wrapper");A(document.getElementById("countly-ratings-overlay-"+a._id),"click",function(){document.getElementById("countly-ratings-wrapper-"+a._id).style.display="none"})}Z.appendChild(C);b(c.DEBUG,"present_feedback_widget, Appended the iframe");A(window,"message",function(B){var U=
{};try{U=JSON.parse(B.data),b(c.DEBUG,"present_feedback_widget, Parsed response message "+U)}catch(Zb){b(c.ERROR,"present_feedback_widget, Error while parsing message body "+Zb)}U.close?(document.getElementById("countly-"+u+"-wrapper-"+a._id).style.display="none",document.getElementById("csbg").style.display="none"):b(c.DEBUG,"present_feedback_widget, Closing signal not sent yet")});if("survey"===a.type){var P=!1;switch(a.showPolicy){case "afterPageLoad":"complete"===document.readyState?P||(P=!0,
...
document.body.scrollTop,document.documentElement.scrollTop),U=Sa();B>=U/2&&(P=!0,m(a))}});break;default:P||(P=!0,m(a))}}else if("nps"===a.type)document.getElementById("countly-"+u+"-wrapper-"+a._id).style.display="block",document.getElementById("csbg").style.display="block";else if("rating"===a.type){var fb=!1;"complete"===document.readyState?fb||(fb=!0,g(a)):A(document,"readystatechange",function(B){"complete"!==B.target.readyState||fb||(fb=!0,g(a))})}}catch(B){b(c.ERROR,"present_feedback_widget, Something went wrong while presenting the widget: "+
...
case "cly_event":J=f.deserialize(d||"[]");break;case "cly_remote_configs":R=f.deserialize(d||"{}");break;case "cly_ignore":f.ignore_visitor=f.deserialize(d);break;case "cly_id":f.device_id=d;break;case "cly_id_type":D=f.deserialize(d)}};this._internals={store:w,getDocWidth:mb,getDocHeight:Sa,getViewportHeight:Eb,get_page_coord:lb,get_event_target:Ra,add_event_listener:A,createNewObjectFromProperties:Aa,truncateObject:aa,truncateSingleValue:z,stripTrailingSlash:ua,prepareParams:za,sendXmlHttpRequest:Mb,
isResponseValid:sb,getInternalDeviceIdType:function(){return D},getMsTimestamp:ib,getTimestamp:F,isResponseValidBroad:rb,secureRandom:gb,log:b,checkIfLoggingIsOn:Da,getMetrics:Ua,getUA:Lb,prepareRequest:Fa,generateUUID:hb,sendEventsForced:O,isUUID:function(a){return/[0-9a-fA-F]{8}\-[0-9a-fA-F]{4}\-4[0-9a-fA-F]{3}\-[0-9a-fA-F]{4}\-[0-9a-fA-F]{12}/.test(a)},isReferrerUsable:qb,getId:pb,heartBeat:Xa,toRequestQueue:N,reportViewDuration:ma,loadJS:Gb,loadCSS:Ta,getLastView:function(){return X},setToken:Pb,
getToken:function(){var a=y("cly_token");S("cly_token");return a},showLoader:Hb,hideLoader:Ib,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:v,processScrollView:tb,processScroll:Ob,currentUserAgentString:va,currentUserAgentDataString:kb,userAgentDeviceDetection:Cb,userAgentSearchBotDetection:Db,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Nb,processAsyncQueue:qa,makeNetworkRequest:ba,clearQueue:function(){H=[];w("cly_queue",
[]);J=[];w("cly_event",[])},getLocalQueues:function(){return{eventQ:J,requestQ:H}}};var ra={sendInstantHCRequest:function(){var a=z(f.hcErrorMessage,1E3,"healthCheck",b);a={el:f.hcErrorCount,wl:f.hcWarningCount,sc:f.hcStatusCode,em:JSON.stringify(a)};a={hc:JSON.stringify(a),metrics:JSON.stringify({_app_version:f.app_version})};Fa(a);ba("[healthCheck]",f.url+ob,a,function(d){d||ra.resetAndSaveCounters()},!0)},resetAndSaveCounters:function(){ra.resetCounters();w(T.errorCount,f.hcErrorCount);w(T.warningCount,
f.hcWarningCount);w(T.statusCode,f.hcStatusCode);w(T.errorMessage,f.hcErrorMessage)},incrementErrorCount:function(){f.hcErrorCount++},incrementWarningCount:function(){f.hcWarningCount++},resetCounters:function(){f.hcErrorCount=0;f.hcWarningCount=0;f.hcStatusCode=-1;f.hcErrorMessage=""},saveRequestCounters:function(a,d){f.hcStatusCode=a;f.hcErrorMessage=d;w(T.statusCode,f.hcStatusCode);w(T.errorMessage,f.hcErrorMessage)}};this.initialize()}),Ub=!0;p.features="apm attribution clicks crashes events feedback forms location remote-config scrolls sessions star-rating users views".split(" ");
p.q=p.q||[];p.onload=p.onload||[];p.CountlyClass=Tb;p.init=function(k){k=k||{};if(p.loadAPMScriptsAsync&&Ub)Ub=!1,Wb(k);else{var q=k.app_key||p.app_key;if(!p.i||!p.i[q]){k=new Tb(k);if(!p.i){p.i={};for(var v in k)p[v]=k[v]}p.i[q]=k}return p.i[q]}};p.serialize=function(k){"object"===L(k)&&(k=JSON.stringify(k));return k};p.deserialize=function(k){if(""===k)return k;try{k=JSON.parse(k)}catch(q){Da()&&console.warn("[WARNING] [Countly] deserialize, Could not parse the file:["+k+"], error: "+q)}return k};
