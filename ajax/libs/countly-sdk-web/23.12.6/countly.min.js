...
Qa>=l?Qa++:Qa=l;return Qa}function t(l,k,q){if(k&&Object.keys(k).length){if("undefined"!==typeof k[l])return k[l]}else if("undefined"!==typeof p[l])return p[l];return q}function jb(l,k,q){for(var v in p.i)p.i[v].tracking_crashes&&p.i[v].recordError(l,k,q)}function za(l){var k=[],q;for(q in l)k.push(q+"="+encodeURIComponent(l[q]));return k.join("&")}function ta(l){return"string"===typeof l&&"/"===l.substring(l.length-1)?l.substring(0,l.length-1):l}function Aa(l,k){for(var q={},v,G=0,Q=k.length;G<Q;G++)v=
...
e.slice(m+1))}else"function"===typeof p[e[m]]&&p[e[m]].apply(p,e.slice(m+1))}}}}function pb(){var a=y("cly_id");return a?(D=y("cly_id_type"),a):hb()}function Lb(){return f.metrics._ua||ua()}function Ua(){var a=JSON.parse(JSON.stringify(f.metrics||{}));a._app_version=a._app_version||f.app_version;a._ua=a._ua||ua();if(x&&screen.width){var d=screen.width?parseInt(screen.width):0,e=screen.height?parseInt(screen.height):0;if(0!==d&&0!==e){if(navigator.platform&&/iPad|iPhone|iPod/.test(navigator.platform)&&
...
function qb(a){if(!x)return!1;a=a||document.referrer;var d=!1;if("undefined"===typeof a||0===a.length)b(c.DEBUG,"Invalid referrer:["+a+"], ignoring.");else{var e=Kb.exec(a);if(e)if(e[11])if(e[11]===window.location.hostname)b(c.DEBUG,"Referrer is current host:["+a+"], ignoring.");else if(ca&&ca.length)for(d=!0,e=0;e<ca.length;e++){if(0<=a.indexOf(ca[e])){b(c.DEBUG,"Referrer in ignore list:["+a+"], ignoring.");d=!1;break}}else b(c.DEBUG,"Valid referrer:["+a+"]"),d=!0;else b(c.DEBUG,"No path found in referrer:["+
a+"], ignoring.");else b(c.DEBUG,"Referrer is corrupt:["+a+"], ignoring.")}return d}function b(a,d){if(f.debug&&"undefined"!==typeof console){arguments[2]&&"object"===L(arguments[2])&&(arguments[2]=JSON.stringify(arguments[2]));Za||(d="["+f.app_key+"] "+d);a||(a=c.DEBUG);for(var e="",h=2;h<arguments.length;h++)e+=arguments[h];e=a+"[Countly] "+d+e;a===c.ERROR?(console.error(e),qa.incrementErrorCount()):a===c.WARNING?(console.warn(e),qa.incrementWarningCount()):a===c.INFO?console.info(e):a===c.VERBOSE?
console.log(e):console.debug(e)}}function ba(a,d,e,h,m){x?Mb(a,d,e,h,m):Nb(a,d,e,h,m)}function Mb(a,d,e,h,m){m=m||!1;try{b(c.DEBUG,"Sending XML HTTP request");var g=new XMLHttpRequest;e=e||{};var n=za(e),r="GET";if(f.force_post||2E3<=n.length)r="POST";"GET"===r?g.open("GET",d+"?"+n,!0):(g.open("POST",d,!0),g.setRequestHeader("Content-type","application/x-www-form-urlencoded"));for(var u in f.headers)g.setRequestHeader(u,f.headers[u]);g.onreadystatechange=function(){4===this.readyState&&(b(c.DEBUG,
...
I),"function"===typeof h&&h(!0,e)}}function Nb(a,d,e,h,m){m=m||!1;var g;try{b(c.DEBUG,"Sending Fetch request");var n="GET",r={"Content-type":"application/x-www-form-urlencoded"},u=null;e=e||{};f.force_post||2E3<=za(e).length?(n="POST",u=za(e)):d+="?"+za(e);for(var I in f.headers)r[I]=f.headers[I];fetch(d,{method:n,headers:r,body:u}).then(function(C){g=C;return g.text()}).then(function(C){b(c.DEBUG,a+" Fetch request completed wit status code: ["+g.status+"] and response: ["+C+"]");(m?rb(g.status,C):
sb(g.status,C))?"function"===typeof h&&h(!1,e,C):(b(c.ERROR,a+" Invalid response from server"),"send_request_queue"===a&&qa.saveRequestCounters(g.status,C),"function"===typeof h&&h(!0,e,g.status,C))})["catch"](function(C){b(c.ERROR,a+" Failed Fetch request: "+C);"function"===typeof h&&h(!0,e)})}catch(C){b(c.ERROR,a+" Something went wrong with the Fetch request attempt: "+C),"function"===typeof h&&h(!0,e)}}function sb(a,d){if(!(200<=a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),
!1;try{var e=JSON.parse(d);return"[object Object]"!==Object.prototype.toString.call(e)?(b(c.ERROR,"Http response is not JSON Object"),!1):!!e.result}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function rb(a,d){if(!(200<=a&&300>a))return b(c.ERROR,"Http response status code:["+a+"] is not within the expected range"),!1;try{var e=JSON.parse(d);return"[object Object]"===Object.prototype.toString.call(e)||Array.isArray(e)?!0:(b(c.ERROR,"Http response is not JSON Object nor JSON Array"),
!1)}catch(h){return b(c.ERROR,"Http response is not JSON: "+h),!1}}function Ob(){x?Ma=Math.max(Ma,window.scrollY,document.body.scrollTop,document.documentElement.scrollTop):b(c.WARNING,"processScroll, window object is not available. Not processing scroll.")}function tb(){if(!x)b(c.WARNING,"processScrollView, window object is not available. Not processing scroll view.");else if(Na){Na=!1;var a=Sa(),d=mb(),e=Eb();f.check_consent("scrolls")&&(a={type:"scroll",y:Ma+e,width:d,height:a,view:f.getViewUrl()},
a=aa(a,f.maxKeyLength,f.maxValueSize,f.maxSegmentationValues,"processScrollView",b),f.track_domains&&(a.domain=window.location.hostname),v({key:M.ACTION,segmentation:a}))}}function Pb(a){w("cly_token",a)}function Qb(a,d,e){var h=new Date;h.setTime(h.getTime()+864E5*e);e="; expires="+h.toGMTString();document.cookie=a+"="+d+e+"; path=/"}function y(a,d,e){if("none"===f.storage||"object"!==L(f.storage)&&!x)b(c.DEBUG,"Storage is disabled. Value with key: ["+a+"] won't be retrieved");else{e||(a=f.app_key+
...
h:f.deserialize(h)}}function w(a,d,e,h){"none"===f.storage||"object"!==L(f.storage)&&!x?b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be stored"):(h||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a)),"undefined"!==typeof d&&null!==d&&("object"===L(f.storage)&&"function"===typeof f.storage.setItem?f.storage.setItem(a,d):(void 0===e&&(e=ra),d=f.serialize(d),e?localStorage.setItem(a,d):"localstorage"!==f.storage&&Qb(a,d,30))))}function S(a,d,e){"none"===f.storage||"object"!==L(f.storage)&&
!x?b(c.DEBUG,"Storage is disabled. Value with key: "+a+" won't be removed"):(e||(a=f.app_key+"/"+a,f.namespace&&(a=ta(f.namespace)+"/"+a)),"object"===L(f.storage)&&"function"===typeof f.storage.removeItem?f.storage.removeItem(a):(void 0===d&&(d=ra),d?localStorage.removeItem(a):"localstorage"!==f.storage&&Qb(a,"",-1)))}function Yb(){if(y(f.namespace+"cly_id",!1,!0)){w("cly_id",y(f.namespace+"cly_id",!1,!0));w("cly_id_type",y(f.namespace+"cly_id_type",!1,!0));w("cly_event",y(f.namespace+"cly_event",
!1,!0));w("cly_session",y(f.namespace+"cly_session",!1,!0));var a=y(f.namespace+"cly_queue",!1,!0);Array.isArray(a)&&(a=a.filter(function(d){return d.app_key===f.app_key}),w("cly_queue",a));y(f.namespace+"cly_cmp_id",!1,!0)&&(w("cly_cmp_id",y(f.namespace+"cly_cmp_id",!1,!0)),w("cly_cmp_uid",y(f.namespace+"cly_cmp_uid",!1,!0)));y(f.namespace+"cly_ignore",!1,!0)&&w("cly_ignore",y(f.namespace+"cly_ignore",!1,!0));S("cly_id",!1,!0);S("cly_id_type",!1,!0);S("cly_event",!1,!0);S("cly_session",!1,!0);S("cly_queue",
!1,!0);S("cly_cmp_id",!1,!0);S("cly_cmp_uid",!1,!0);S("cly_ignore",!1,!0)}}if(!(this instanceof q))throw new TypeError("Cannot call a class as a function");var f=this,Za=!p.i,W=!1,ob="/i",Va="/o/sdk",cb=t("interval",k,500),Wa=t("queue_size",k,1E3),H=[],J=[],R={},sa=[],da={},ca=t("ignore_referrers",k,[]),ub=null,Ja=!0,ja,vb=0,X=null,Ha=0,Ia=0,nb=0,bb=t("fail_timeout",k,60),Oa=t("inactivity_time",k,20),Pa=0,$a=t("session_update",k,60),La=t("max_events",k,100),xa=t("max_logs",k,null),ia=t("use_session_cookie",
k,!0),Ka=t("session_cookie_timeout",k,30),ab=!0,Ya=!1,K=t("offline_mode",k,!1),ea={},pa=!0,Rb=F(),ra=!0,ya=null,D=1,Na=!1,Ma=0,wb=!1,ha=null,Ea=null,ka=null,va=t("sdk_name",k,"javascript_native_web"),oa=t("sdk_version",k,"23.12.6");try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(a){b(c.ERROR,"Local storage test failed, Halting local storage support: "+a),ra=!1}for(var E={},xb=0;xb<p.features.length;xb++)E[p.features[xb]]={};this.initialize=function(){this.serialize=
...
Ka+"] minutes to expire a cookies session");a=null;g=f.getSearchQuery();var d=!1,e={};if(g){0===g.indexOf("?")&&(g=g.substring(1));g=g.split("&");for(var h=0;h<g.length;h++){var m=g[h].split("=");"cly_id"===m[0]?w("cly_cmp_id",m[1]):"cly_uid"===m[0]?w("cly_cmp_uid",m[1]):"cly_device_id"===m[0]?a=m[1]:0===(m[0]+"").indexOf("utm_")&&this.utm[m[0].replace("utm_","")]&&(e[m[0].replace("utm_","")]=m[1],d=!0)}}var g="[CLY]_temp_id"===y("cly_id");h=t("device_id",k,void 0);"number"===typeof h&&(h=h.toString());
y("cly_id")&&!g?(this.device_id=y("cly_id"),b(c.INFO,"initialize, Set the stored device ID"),D=y("cly_id_type"),D||(b(c.INFO,"initialize, No device ID type info from the previous session, falling back to DEVELOPER_SUPPLIED"),D=0)):null!==a?(b(c.INFO,"initialize, Device ID set by URL"),this.device_id=a,D=3):h?(b(c.INFO,"initialize, Device ID set by developer"),this.device_id=h,k&&Object.keys(k).length?void 0!==k.device_id&&(D=0):void 0!==p.device_id&&(D=0)):K||g?(this.device_id="[CLY]_temp_id",D=2,
...
n,e[n]),ka[n]=e[n]):this.userData.unset("utm_"+n);this.userData.save()}Ba();setTimeout(function(){p.noHeartBeat?b(c.WARNING,"initialize, Heartbeat disabled. This is for testing purposes only!"):Xa();f.remote_config&&f.fetch_remote_config(f.remote_config)},1);x&&document.documentElement.setAttribute("data-countly-useragent",ua());qa.sendInstantHCRequest();b(c.INFO,"initialize, Countly initialized")}};this.halt=function(){b(c.WARNING,"halt, Resetting Countly");p.i=void 0;p.q=[];p.noHeartBeat=void 0;
Za=!p.i;W=!1;ob="/i";Va="/o/sdk";cb=500;Wa=1E3;H=[];J=[];R={};sa=[];da={};ca=[];ub=null;Ja=!0;vb=0;X=null;nb=Ia=Ha=0;bb=60;Oa=20;Pa=0;$a=60;La=100;xa=null;ia=!0;Ka=30;ab=!0;K=Ya=!1;ea={};pa=!0;Rb=F();ra=!0;ya=null;D=1;Na=!1;Ma=0;wb=!1;ka=Ea=ha=null;try{localStorage.setItem("cly_testLocal",!0),localStorage.removeItem("cly_testLocal")}catch(d){b(c.ERROR,"halt, Local storage test failed, will fallback to cookies"),ra=!1}p.features="sessions events views scrolls clicks forms crashes attribution users star-rating location apm feedback remote-config".split(" ");
...
getToken:function(){var a=y("cly_token");S("cly_token");return a},showLoader:Hb,hideLoader:Ib,setValueInStorage:w,getValueFromStorage:y,removeValueFromStorage:S,add_cly_events:v,processScrollView:tb,processScroll:Ob,currentUserAgentString:ua,currentUserAgentDataString:kb,userAgentDeviceDetection:Cb,userAgentSearchBotDetection:Db,getRequestQueue:function(){return H},getEventQueue:function(){return J},sendFetchRequest:Nb,processAsyncQueue:wa,makeNetworkRequest:ba,clearQueue:function(){H=[];w("cly_queue",
[]);J=[];w("cly_event",[])},getLocalQueues:function(){return{eventQ:J,requestQ:H}}};var qa={sendInstantHCRequest:function(){var a=z(f.hcErrorMessage,1E3,"healthCheck",b);a={el:f.hcErrorCount,wl:f.hcWarningCount,sc:f.hcStatusCode,em:JSON.stringify(a)};a={hc:JSON.stringify(a),metrics:JSON.stringify({_app_version:f.app_version})};Fa(a);ba("[healthCheck]",f.url+ob,a,function(d){d||qa.resetAndSaveCounters()},!0)},resetAndSaveCounters:function(){qa.resetCounters();w(T.errorCount,f.hcErrorCount);w(T.warningCount,
