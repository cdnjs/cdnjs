...
declare class Projection$2 {
	...
	locationPoint(tr: Transform, lngLat: LngLat, altitude?: number, terrain?: boolean): Point;
...
type StyleImages = Record<string, StyleImage>;
...
type ActorCallback = Callback<unknown> & {
	metadata?: TaskMetadata;
};
declare class Actor {
	target: Worker;
	 ...
	 * @private
	 */
	send(type: string, data: unknown, callback?: ActorCallback, targetMapId?: string | null, mustQueue?: boolean, callbackMetadata?: ActorCallback["metadata"]): Cancelable | undefined;
...
declare class Dispatcher {
	...
	constructor(workerPool: WorkerPool, parent: any, name?: string, count?: number);
	/**
	 * Broadcast a message to all Workers.
	 * @private
	 */
	broadcast(type: string, data: unknown, cb?: Callback<unknown>): void;
	/**
...
declare class ImageRasterizer {
	...
	getFromCache(imageVariant: ImageVariant, scope: string, mapId: any): RGBAImage | undefined;
	...
	rasterize(imageVariant: ImageVariant, image: StyleImage, scope: string, mapId: string, rasterize?: (icon: Icon, options: RasterizationOptions) => ImageData): RGBAImage;
}
type Pattern = {
	bin: PotpackBox;
...
type RasterizeImagesParameters = {
	scope: string;
...
declare class ImageManager extends Evented {
	...
	createIconset(scope: string, iconsetId: string): void;
	isLoaded(): boolean;
	...
	rasterizeImages({ scope, tasks }: RasterizeImagesParameters, callback: Callback<RasterizedImageMap>): void;
...
declare class SymbolStyleLayer extends StyleLayer {
	...
	getValueAndResolveTokens(name: any, feature: Feature, canonical: CanonicalTileID, availableImages: ImageId[]): string;
...
declare class SymbolBucket implements Bucket {
	...
	update(states: FeatureStates, vtLayer: VectorTileLayer, availableImages: ImageId[], imagePositions: SpritePositions, layers: Array<TypedStyleLayer>, isBrightnessChanged: boolean, brightness?: number | null): void;
	updateRoadElevation(): void;
	updateZOffset(): void;
	isEmpty(): boolean;
	...
	_updateTextDebugCollisionBoxes(size: any, zoom: number, collisionBoxArray: CollisionBoxArray, startIndex: number, endIndex: number, instance: SymbolInstance, scaleFactor: number): void;
	_updateIconDebugCollisionBoxes(size: any, zoom: number, collisionBoxArray: CollisionBoxArray, startIndex: number, endIndex: number, instance: SymbolInstance, iconScaleFactor: number): void;
...
declare class Placement {
	...
	getBucketParts(results: Array<BucketPart>, styleLayer: StyleLayer, tile: Tile, sortAcrossTiles: boolean, scaleFactor?: number): void;
...
declare class LayerPlacement {
	...
	continuePlacement(tiles: Array<Tile>, placement: Placement, showCollisionBoxes: boolean, styleLayer: StyleLayer, shouldPausePlacement: () => boolean, scaleFactor: number): boolean;
}
...
declare class Style$1 extends Evented<MapEvents> {
	...
	precompilePrograms(layer: StyleLayer, parameters: EvaluationParameters): void;
	/**
	...
	_afterImageUpdated(id: ImageId): void;
	listImages(): ImageId[];
	...
	_updateFilteredLayers(filter: (layer: StyleLayer) => boolean): void;
	...
	queryRenderedFeatures(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], params: QueryRenderedFeaturesParams | undefined, transform: Transform): GeoJSONFeature[];
	queryRenderedFeatureset(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], params: QueryRenderedFeaturesetParams | undefined, transform: Transform): TargetFeature[];
	queryRenderedTargets(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], targets: QrfTarget[], transform: Transform): Feature$1[];
	_queryRenderedFeatures(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], queries: Record<string, QrfQuery & {
		has3DLayers?: boolean;
	}>, transform: Transform): Array<QueryResult>;
	...
	getImages(mapId: string, params: GetImagesParameters, callback: Callback<StyleImageMap<StringifiedImageId>>): void;
	rasterizeImages(mapId: string, params: RasterizeImagesParameters, callback: Callback<RasterizedImageMap>): void;
	getGlyphs(mapId: string, params: GetGlyphsParameters, callback: Callback<GlyphMap>): void;
...
type FillDefinesType = "ELEVATED_ROADS";
...
declare class CircleBucket<Layer extends CircleStyleLayer | HeatmapStyleLayer> implements Bucket {
	...
	upload(context: Context): void;
	destroy(): void;
	addFeature(feature: BucketFeature, geometry: Array<Array<Point>>, index: number, availableImages: ImageId[], canonical: CanonicalTileID, projection?: Projection$2 | null, brightness?: number | null): void;
}
...
declare class LineBucket implements Bucket {
	...
	addFeature(feature: BucketFeature, geometry: Array<Array<Point>>, index: number, canonical: CanonicalTileID, imagePositions: SpritePositions, availableImages: ImageId[], brightness?: number | null): void;
...
type LineDefinesType = "RENDER_LINE_GRADIENT" | "RENDER_LINE_DASH" | "RENDER_LINE_TRIM_OFFSET" | "RENDER_LINE_BORDER" | "LINE_JOIN_NONE" | "ELEVATED" | "VARIABLE_LINE_WIDTH" | "CROSS_SLOPE_VERTICAL" | "CROSS_SLOPE_HORIZONTAL" | "ELEVATION_REFERENCE_SEA";
...
type DynamicDefinesType = GlobalDefinesType | CircleDefinesType | SymbolDefinesType | LineDefinesType | FillDefinesType | HeatmapDefinesType | GlobeDefinesType | RasterDefinesType | RasterParticleDefinesType | FogDefinesType | HillshadeDefinesType | TerrainDepthAccessDefinesType | ModelDefinesType;
...
declare class Painter {
	...
	renderLayer(painter: Painter, sourceCache: SourceCache | undefined, layer: StyleLayer, coords?: Array<OverscaledTileID>): void;
...
declare class FeatureIndex$1 {
	...
	loadMatchingFeature(result: QueryResult, featureIndexData: FeatureIndices, query: QrfQuery, availableImages: ImageId[], intersectionTest?: IntersectionTest): void;
	loadMatchingModelFeature(result: QueryResult, featureIndexData: FeatureIndices, query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, transform: Transform): void;
	...
	lookupSymbolFeatures(symbolFeatureIndexes: Array<number>, bucketIndex: number, sourceLayerIndex: number, query: QrfQuery, availableImages: ImageId[]): QueryResult;
...
declare class ElevatedStructures {
	...
	addRenderableRing(polygonIdx: number, vertexOffset: number, count: number, isTunnel: boolean, area: Bounds): void;
...
declare class FillBufferData {
	...
	upload(context: Context): void;
	destroy(): void;
	populatePaintArrays(feature: BucketFeature, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness?: number | null): void;
}
declare class FillBucket implements Bucket {
	...
	setEvaluatedPortalGraph(graph: ElevationPortalGraph): void;
	private addElevatedRoadFeature;
	private addElevatedGeometry;
	private addGeometry;
	private getElevationFeature;
}
type LayoutProps$4 = {
...
declare class GroundEffect {
	...
	addPaintPropertiesData(feature: Feature, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness?: number | null): void;
	upload(context: Context): void;
	uploadPaintProperties(context: Context): void;
	update(states: FeatureStates, vtLayer: VectorTileLayer, layers: any, availableImages: ImageId[], imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness?: number | null): void;
...
declare class ClipBucket implements Bucket {
	...
	update(_states: FeatureStates, _vtLayer: VectorTileLayer, _availableImages: ImageId[], _imagePositions: SpritePositions, layers: Array<TypedStyleLayer>, isBrightnessChanged: boolean, brightness?: number | null): void;
	destroy(): void;
...
interface AttributeBinder {
	...
	populatePaintArray: (length: number, feature: Feature, imagePositions: SpritePositions, availableImages: ImageId[], canonical?: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection) => void;
	updatePaintArray: (start: number, length: number, feature: Feature, featureState: FeatureState, availableImages: ImageId[], imagePositions: SpritePositions, brightness: number) => void;
...
declare class ProgramConfiguration {
	...
	populatePaintArrays(newLength: number, feature: Feature, imagePositions: SpritePositions, availableImages: ImageId[], canonical?: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection): void;
	setConstantPatternPositions(posTo: SpritePosition): void;
	updatePaintArrays(featureStates: FeatureStates, featureMap: FeaturePositionMap, featureMapWithoutIds: FeaturePositionMap, vtLayer: VectorTileLayer, layer: TypedStyleLayer, availableImages: ImageId[], imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness: number): boolean;
...
declare class ProgramConfigurationSet<Layer extends TypedStyleLayer> {
	...
	populatePaintArrays(length: number, feature: Feature, index: number, imagePositions: SpritePositions, availableImages: ImageId[], canonical: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection): void;
	updatePaintArrays(featureStates: FeatureStates, vtLayer: VectorTileLayer, layers: ReadonlyArray<TypedStyleLayer>, availableImages: ImageId[], imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness?: number | null): void;
...
declare class Program$1<Us extends UniformBindings> {
	...
	constructor(context: Context, name: string, source: ShaderSource, configuration: ProgramConfiguration | null | undefined, fixedUniforms: (arg1: Context) => Us, fixedDefines: DynamicDefinesType[]);
...
declare class Tile {
	...
	queryRenderedFeatures(query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, availableImages: ImageId[], transform: Transform, sourceCacheTransform: Transform, visualizeQueryGeometry: boolean): QueryResult;
	...
	_globePoint(x: number, y: number, id: CanonicalTileID, tr: Transform, normalizationMatrix: mat4, worldToECEFMatrix: mat4 | null | undefined, phase: number): vec3;
	_makeGlobeTileDebugBorderBuffer(context: Context, id: CanonicalTileID, tr: Transform, normalizationMatrix: mat4, worldToECEFMatrix: mat4 | null | undefined, phase: number): void;
	_makeGlobeTileDebugTextBuffer(context: Context, id: CanonicalTileID, tr: Transform, normalizationMatrix: mat4, worldToECEFMatrix: mat4 | null | undefined, phase: number): void;
	/**
...
declare class Iconset {
	 ...
	 * @private
	 */
	constructor(id: string, style: Style$1);
...
export declare class RasterArrayTileSource extends RasterTileSource<"raster-array"> implements ISource {
	...
	addIconset(iconsetId: string, iconset: Iconset): void;
}
...
declare class IndoorManager extends Evented<IndoorEvents> {
	...
	_onLoad(): void;
	_onMove(): void;
	_checkFloorplanVisible(queryWholeScreen: any): void;
	_floorplanSelected(withUserInput: boolean): void;
	_buildingSelected(selectedBuilding: any, animated: any): void;
	_levelSelected(id: any): void;
	_updateLevels(selectedLevel: any, animated: boolean): void;
...
declare class Camera extends Evented<MapEvents> {
	...
	_ease(frame: (_: number) => Transform | void, finish: () => void, options: EasingOptions): void;
...
declare class HandlerManager {
	...
	mergeHandlerResult(mergedHandlerResult: HandlerResult, eventsInProgress: any, handlerResult: HandlerResult, name: string, e?: InputEvent$1 | RenderFrameEvent): void;
	_applyChanges(): void;
