...
declare class FillExtrusionWallStruct extends Struct {
	...
	get a_join_normal_inside_polygon0(): number;
	get a_join_normal_inside_polygon1(): number;
	get a_join_normal_inside_polygon2(): number;
	get a_join_normal_inside_polygon3(): number;
}
declare class FillExtrusionWallArray extends StructArrayLayout4i8 {
	/**
...
declare class Placement {
	...
	updateBucketOpacities(bucket: SymbolBucket, seenCrossTileIDs: Set<number>, collisionBoxArray: CollisionBoxArray | null | undefined, layerIndex: number, replacementSource: ReplacementSource | null | undefined, coord: OverscaledTileID, scope: string): void;
