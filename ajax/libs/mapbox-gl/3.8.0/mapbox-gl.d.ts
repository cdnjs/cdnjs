...
declare class Style$1 extends Evented<MapEvents> {
	...
	queryRenderedFeaturesForInteractions(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], targets: QueryRenderedFeaturesetParams[], transform: Transform): Array<GeoJSONFeature>;
...
declare class Tile {
	...
	queryRenderedFeatures(layers: Record<string, StyleLayer>, sourceFeatureState: SourceFeatureState, tileResult: TilespaceQueryGeometry, filter: FilterSpecification, layerIds: string[], availableImages: Array<string>, transform: Transform, pixelPosMatrix: Float32Array, visualizeQueryGeometry: boolean): QueryResult;
...
declare class InteractionEvent extends Event$1<MapEvents, MapInteractionEventType> {
	type: MapInteractionEventType;
	target: Map$1;
	originalEvent: MouseEvent;
	point: Point;
...
declare class Map$1 extends Camera {
	...
	isRotating(): boolean;
	_isDragging(): boolean;
	_createDelegatedListener<T extends MapEventType>(type: T, targets: string[] | FeaturesetDescriptor, listener: Listener$1<T>): DelegatedListener;
	...
	on<T extends MapEventType | (string & {})>(type: T, targets: string | string[] | FeaturesetDescriptor, listener: Listener$1<Extract<T, MapEventType>>): this;
	/**
	 * Adds a listener that will be called only once to a specified event type,
	...
	once<T extends MapEventType | (string & {})>(type: T, targets: string | string[] | FeaturesetDescriptor): Promise<MapEventOf<Extract<T, MapEventType>>>;
	once<T extends MapEventType | (string & {})>(type: T, targets: string | string[] | FeaturesetDescriptor, listener: Listener$1<Extract<T, MapEventType>>): this;
	/**
	...
	off<T extends MapEventType | (string & {})>(type: T, targets: string | string[] | FeaturesetDescriptor, listener: Listener$1<Extract<T, MapEventType>>): this;
	/** @section {Querying features} */
	/**
	...
	queryRenderedFeatures(geometry: PointLike | [
		PointLike,
		PointLike
	], options?: QueryRenderedFeaturesParams | QueryRenderedFeaturesetParams): Array<GeoJSONFeature>;
