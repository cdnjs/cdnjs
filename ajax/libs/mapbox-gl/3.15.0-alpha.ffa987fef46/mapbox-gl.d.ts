...
type ConstantExpression = {
	kind: "constant";
	configDependencies: Set<string>;
	readonly evaluate: (globals: GlobalProperties, feature?: Feature, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: ImageId[], formattedSection?: FormattedSection, iconImageUseTheme?: string) => any;
};
