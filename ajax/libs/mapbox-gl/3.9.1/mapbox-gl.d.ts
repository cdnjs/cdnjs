...
declare class ImageRasterizer {
	...
	getFromCache(imageIdWithOptions: ImageIdWithOptions, scope: string, mapId: any): RGBAImage | undefined;
	...
	rasterize(imageIdWithOptions: ImageIdWithOptions, image: StyleImage, scope: string, mapId: string, rasterize?: (icon: Icon, options: RasterizationOptions) => ImageData): RGBAImage;
}
type Pattern = {
	bin: PotpackBox;
...
declare class ImageManager extends Evented {
	...
	removeFromImageRasterizerCache(id: string, scope: string): void;
	...
	rasterizeImages({ scope, imageTasks }: {
		scope: string;
		imageTasks: {
			[_: string]: ImageIdWithOptions;
		};
	}, callback: Callback<{
		[_: string]: RGBAImage;
	}>): void;
	rasterizeImagesInMainThread(input: {
		imageTasks: {
			[_: string]: {
				image: StyleImage;
...
declare class Projection$2 {
	...
	locationPoint(tr: Transform$1, lngLat: LngLat, terrain?: boolean): Point;
...
declare class SymbolBucket implements Bucket {
	...
	update(states: FeatureStates, vtLayer: VectorTileLayer, availableImages: Array<string>, imagePositions: SpritePositions, layers: Array<TypedStyleLayer>, isBrightnessChanged: boolean, brightness?: number | null): void;
	updateZOffset(): void;
	isEmpty(): boolean;
...
declare class Style$1 extends Evented<MapEvents> {
	...
	updateImage(id: string, image: StyleImage, performSymbolLayout?: boolean): void;
	...
	rasterizeImages(mapId: string, params: {
		scope: string;
		imageTasks: {
			[_: string]: ImageIdWithOptions;
		};
...
declare class LineBucket implements Bucket {
	...
	zOffsetVertexArray: StructArrayLayout2f8;
	zOffsetVertexBuffer: VertexBuffer;
	indexArray: StructArrayLayout3ui6;
	indexBuffer: IndexBuffer;
	hasPattern: boolean;
...
declare class Painter {
	...
	scaleFactor: number;
	constructor(gl: WebGL2RenderingContext, contextCreateOptions: ContextOptions, transform: Transform$1, scaleFactor: number, tp: ITrackedParameters);
...
declare class SourceCache extends Evented {
	...
	*/
	 ...
	 */
	update(transform: Transform$1, tileSize?: number, updateForTerrain?: boolean, directionalLight?: vec3): void;
	 ...
	 * @returns {Object} Returns `this` | Promise.
	 */
	_preloadTiles(transform: Transform$1 | Array<Transform$1>, callback: Callback<any>): void;
}
type QrfQuery = {
	layers: QrfLayers;
	sourceCache: SourceCache;
...
declare class FeatureIndex$1 {
	...
	loadMatchingFeature(result: QueryResult, featureIndexData: FeatureIndices, query: QrfQuery, availableImages: Array<string>, intersectionTest?: IntersectionTest): void;
	loadMatchingModelFeature(result: QueryResult, featureIndexData: FeatureIndices, query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, transform: Transform$1): void;
	updateFeatureProperties(feature: Feature$1, target: QrfTarget, availableImages?: Array<string>): void;
	/**
	 ...
	 */
	addFeatureVariant(feature: Feature$1, target: QrfTarget, availableImages?: Array<string>): void;
	appendToResult(result: QueryResult, layerID: string, featureIndex: number, geojsonFeature: Feature$1, intersectionZ?: number): void;
	lookupSymbolFeatures(symbolFeatureIndexes: Array<number>, bucketIndex: number, sourceLayerIndex: number, query: QrfQuery, availableImages: Array<string>): QueryResult;
...
declare class GroundEffect {
	...
	update(states: FeatureStates, vtLayer: VectorTileLayer, layers: any, availableImages: Array<string>, imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness?: number | null): void;
...
declare class ClipBucket implements Bucket {
	...
	update(_states: FeatureStates, _vtLayer: VectorTileLayer, _availableImages: Array<string>, _imagePositions: SpritePositions, layers: Array<TypedStyleLayer>, isBrightnessChanged: boolean, brightness?: number | null): void;
	destroy(): void;
...
declare class ProgramConfiguration {
	...
	updatePaintArrays(featureStates: FeatureStates, featureMap: FeaturePositionMap, featureMapWithoutIds: FeaturePositionMap, vtLayer: VectorTileLayer, layer: TypedStyleLayer, availableImages: Array<string>, imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness: number): boolean;
...
declare class ProgramConfigurationSet<Layer extends TypedStyleLayer> {
	...
	updatePaintArrays(featureStates: FeatureStates, vtLayer: VectorTileLayer, layers: ReadonlyArray<TypedStyleLayer>, availableImages: Array<string>, imagePositions: SpritePositions, isBrightnessChanged: boolean, brightness?: number | null): void;
...
declare class Tile {
	...
	loadModelData(data: WorkerTileResult | null | undefined, painter: Painter, justReloaded?: boolean | null): void;
	getBucket(layer: StyleLayer): Bucket;
	upload(context: Context): void;
	prepare(imageManager: ImageManager, painter: Painter | null | undefined, scope: string): void;
	queryRenderedFeatures(query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, availableImages: Array<string>, transform: Transform$1, sourceCacheTransform: Transform$1, visualizeQueryGeometry: boolean): QueryResult;
...
declare class Camera extends Evented<MapEvents> {
	...
	_emulate(frame: any, duration: number, initialTransform: Transform$1): Array<Transform$1>;
	_preloadTiles(_transform: Transform$1 | Array<Transform$1>, _callback?: Callback<any>): any;
}
...
type DelegatedHandlers = {
	mousemove: (InteractionEvent: any) => boolean | void;
	mouseout: (InteractionEvent: any) => boolean | void;
};
/**
