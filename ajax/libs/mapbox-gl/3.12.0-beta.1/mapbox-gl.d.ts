...
interface WorkerSourceConstructor {
	new (actor?: Actor, layerIndex?: StyleLayerIndex, availableImages?: ImageId[], isSpriteLoaded?: boolean, loadData?: (params: {
		source: string;
		scope: string;
...
type ResourceTiming = Record<string, Array<PerformanceResourceTiming>>;
type LoadGeoJSONResult = {
