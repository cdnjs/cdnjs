...
declare class StyleExpression {
	...
	evaluateWithoutErrorHandling(globals: GlobalProperties, feature?: Feature, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: Array<string>, formattedSection?: FormattedSection, featureTileCoord?: Point, featureDistanceData?: FeatureDistanceData): any;
	evaluate(globals: GlobalProperties, feature?: Feature, featureState?: FeatureState, canonical?: CanonicalTileID$1, availableImages?: Array<string>, formattedSection?: FormattedSection, featureTileCoord?: Point, featureDistanceData?: FeatureDistanceData): any;
}
...
declare class StructArrayLayout2f9i15ui1ul4f1ub80 extends StructArray implements IStructArrayLayout {
	uint8: Uint8Array;
	float32: Float32Array;
	int16: Int16Array;
	uint16: Uint16Array;
...
declare class SymbolInstanceArray extends StructArrayLayout2f9i15ui1ul4f1ub80 {
	/**
...
declare class ImagePosition implements SpritePosition {
	...
	padding: number;
	constructor(paddedRect: Rect, { pixelRatio, version, stretchX, stretchY, content, }: StyleImage, padding: number);
	get tl(): [
		number,
		number
	];
...
declare class ImageAtlas {
	...
	addImages(images: {
		...
		[_: string]: ImagePosition;
	}, padding: number, bins: Array<Rect>): void;
...
type ActorCallback = Callback<any> & {
	metadata?: any;
};
declare class Actor {
	target: any;
	 ...
	 * @private
	 */
	send(type: string, data: unknown, callback?: ActorCallback, targetMapId?: string | null, mustQueue?: boolean, callbackMetadata?: ActorCallback["metadata"]): Cancelable | null | undefined;
...
type LineDefinesType = "RENDER_LINE_GRADIENT" | "RENDER_LINE_DASH" | "RENDER_LINE_TRIM_OFFSET" | "RENDER_LINE_BORDER" | "LINE_JOIN_NONE" | "ELEVATED" | "CROSS_SLOPE_VERTICAL" | "CROSS_SLOPE_HORIZONTAL" | "ELEVATION_REFERENCE_SEA";
type SizeData = {
	kind: "constant";
	layoutSize: number;
} | {
...
declare class ModelStyleLayer extends StyleLayer {
	...
	queryIntersectsMatchingFeature(queryGeometry: TilespaceQueryGeometry, featureIndex: number, filter: FeatureFilter, transform: Transform): {
		queryFeature: Feature$1 | null | undefined;
...
type DynamicDefinesType = GlobalDefinesType | CircleDefinesType | SymbolDefinesType | LineDefinesType | HeatmapDefinesType | GlobeDefinesType | RasterDefinesType | RasterParticleDefinesType | FogDefinesType | HillshadeDefinesType | TerrainDepthAccessDefinesType | ModelDefinesType;
...
interface AttributeBinder {
	...
	populatePaintArray: (length: number, feature: Feature, imagePositions: SpritePositions, availableImages: Array<string>, canonical?: CanonicalTileID, brightness?: number | null, formattedSection?: FormattedSection) => void;
...
declare class Tile {
	...
	queryRenderedFeatures(layers: {
		[_: string]: StyleLayer;
	}, sourceFeatureState: SourceFeatureState, tileResult: TilespaceQueryGeometry, filter: FilterSpecification, layerIds: string[], availableImages: Array<string>, transform: Transform, pixelPosMatrix: Float32Array, visualizeQueryGeometry: boolean): QueryResult;
	...
	updateBuckets(painter: Painter): void;
	holdingForFade(): boolean;
...
declare class FeatureIndex$1 {
	...
	appendToResult(result: QueryResult, layerID: string, featureIndex: number, geojsonFeature: Feature$1, intersectionZ: boolean | number): void;
	lookupSymbolFeatures(symbolFeatureIndexes: Array<number>, bucketIndex: number, sourceLayerIndex: number, filterSpec: FilterSpecification, filterLayerIDs: Array<string>, availableImages: Array<string>, styleLayers: {
		[_: string]: StyleLayer;
	}): QueryResult;
...
declare class Style$1 extends Evented<MapEvents> {
	...
	_appendFeaturesetFeatures(features: Array<GeoJSONFeature>, feature: Feature$1, layerId: string): void;
	...
	queryRenderedFeaturesets(queryGeometry: PointLike | [
		PointLike,
		PointLike
	], targets: Array<FeaturesetQueryTarget>, transform: Transform): Array<GeoJSONFeature>;
...
declare class InteractionEvent extends Event$1<MapEvents, MapMouseEventType> {
	type: MapMouseEventType;
	target: Map$1;
	originalEvent: MouseEvent;
	point: Point;
...
declare class InteractionSet {
	...
	handleType(event: MapMouseEvent): void;
}
...
declare class Map$1 extends Camera {
	...
	on<T extends MapEventType | (string & {})>(type: T, layerIds: string | string[], listener: Listener$1<Extract<T, MapEventType>>): this;
	/**
	 * Adds a listener that will be called only once to a specified event type,
	...
	once<T extends MapEventType | (string & {})>(type: T, layerIds: string | string[], listener: Listener$1<Extract<T, MapEventType>>): this;
	/**
	...
	off<T extends MapEventType | (string & {})>(type: T, layerIds: string | string[], listener: Listener$1<Extract<T, MapEventType>>): this;
	/** @section {Querying features} */
	/**
	...
	queryRenderedFeatures(geometry: PointLike | [
		PointLike,
		PointLike
	], options?: QueryRenderedFeaturesParams): Array<GeoJSONFeature>;
	queryRenderedFeatures(geometry: PointLike | [
		PointLike,
		PointLike
	], targets?: Array<FeaturesetQueryTarget>): Array<GeoJSONFeature>;
