...
type BuildingDefinesType = "DEBUG_SHOW_NORMALS" | "HAS_ATTRIBUTE_a_part_color_emissive" | "HAS_ATTRIBUTE_a_bloom_attenuation";
...
declare class BuildingBucket implements BucketWithGroundEffect {
	...
	get segments(): SegmentVector;
	get bloomGeometry(): BuildingBloomGeometry;
	footprintLookup: {
	...
	evaluate(layer: BuildingStyleLayer): void;
...
declare class RasterArrayTile extends Tile implements Tile {
	 ...
	 * @private
	 */
	flushQueues(sourceLayer: string): void;
	/**
	 * @private
	 */
	flushAllQueues(): void;
	fetchHeader(fetchLength: number | null | undefined, callback: ResponseCallback<ArrayBuffer | null | undefined>): Cancelable;
	fetchBand(sourceLayer: string, layerId: string, band: string | number, callback: Callback<TextureImage | null | undefined>): void;
...
declare class IndoorDataQuery {
	...
	_findBuildingAtCenter(centerPoint: [
		number,
		number
	], buildings: Array<TargetFeature>): TargetFeature | null;
...
declare class IndoorFloorSelectionState {
	...
	setFloors(floors: Array<TargetFeature>): void;
...
declare class IndoorManager extends Evented<IndoorEvents> {
	...
	_onMove(): void;
	_queryIndoor(): void;
	_selectFloors(indoorData: IndoorData): void;
	_clearIndoorData(): void;
	_updateUI(): void;
	_updateIndoorConfig(): void;
