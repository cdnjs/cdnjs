...
declare class Actor {
	 ...
	 * @private
	 */
	send(type: string, data: unknown, callback?: ActorCallback, targetMapId?: number, mustQueue?: boolean, callbackMetadata?: ActorCallback["metadata"]): Cancelable | undefined;
...
declare class Style$1 extends Evented<MapEvents> {
	...
	getImages(mapId: number, params: GetImagesParameters, callback: Callback<StyleImageMap<StringifiedImageId>>): void;
...
type FillDefinesType = "ELEVATED_ROADS" | "DEPTH_RECONSTRUCTION";
...
declare class Iconset {
	...
	addIcons(images: StyleImageMap<string>): void;
}
/**
