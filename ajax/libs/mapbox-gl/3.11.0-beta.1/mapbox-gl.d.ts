...
type StyleImageMap = Record<string, StyleImage>;
...
type ImagePositionMap = Record<string, ImagePosition>;
...
declare class ImageAtlas {
	...
	lut: LUT$1 | null;
	constructor(icons: StyleImageMap, patterns: StyleImageMap, lut: LUT$1 | null);
	addImages(images: StyleImageMap, positions: ImagePositionMap, padding: number, bins: Array<Rect>): void;
...
type ImageRasterizationWorkerTasks = Record<string, ImageRasterizationWorkerTask>;
type ImageRasterizationTasks = Record<string, ImageIdWithOptions>;
type RasterizeImagesParameters = {
	scope: string;
	tasks: ImageRasterizationTasks;
};
type ImageDictionary = Record<string, RGBAImage>;
...
declare class ImageManager extends Evented {
	...
	getImages(ids: Array<string>, scope: string, callback: Callback<StyleImageMap>): void;
	rasterizeImages({ scope, tasks }: RasterizeImagesParameters, callback: Callback<ImageDictionary>): void;
	_rasterizeImages(scope: string, tasks: ImageRasterizationWorkerTasks, callback?: Callback<ImageDictionary>): void;
	getUpdatedImages(scope: string): Record<string, boolean>;
	_notify(ids: Array<string>, scope: string, callback: Callback<StyleImageMap>): void;
	getPixelSize(scope: string): Size;
	getPattern(id: string, scope: string, lut: LUT$1 | null): ImagePosition | null | undefined;
	getPatternInFlightId(scope: string, id: string): string;
	storePatternImage(id: string, scope: string, image: StyleImage, lut: LUT$1, result?: ImageDictionary | null): void;
	storePattern(scope: string, id: string, image: StyleImage, lut: LUT$1): void;
...
declare class Style$1 extends Evented<MapEvents> {
	...
	getImages(mapId: string, params: GetImagesParameters, callback: Callback<StyleImageMap>): void;
	rasterizeImages(mapId: string, params: RasterizeImagesParameters, callback: Callback<ImageDictionary>): void;
...
type ImageDependencies = Record<string, Array<ImageIdWithOptions>>;
...
declare class FillBufferData {
	...
	upload(context: Context): void;
	destroy(): void;
	populatePaintArrays(feature: BucketFeature, index: number, imagePositions: SpritePositions, availableImages: Array<string>, canonical: CanonicalTileID, brightness?: number | null): void;
}
declare class FillBucket implements Bucket {
	...
	upload(context: Context): void;
	destroy(): void;
	addFeature(feature: BucketFeature, geometry: Array<Array<Point>>, index: number, canonical: CanonicalTileID, imagePositions: SpritePositions, availableImages?: Array<string>, brightness?: number | null, elevationFeatures?: ElevationFeature[]): void;
...
declare class Tile {
	...
	queryRenderedFeatures(query: QrfQuery, tilespaceGeometry: TilespaceQueryGeometry, availableImages: Array<string>, transform: Transform, sourceCacheTransform: Transform, visualizeQueryGeometry: boolean): QueryResult;
