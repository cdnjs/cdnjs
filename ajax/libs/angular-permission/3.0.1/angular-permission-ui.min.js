...
!function () {
  ...
  a.$inject = ["$stateProvider"], b.$inject = ["$rootScope", "$state", "TransitionProperties", "TransitionEvents", "StateAuthorization", "StatePermissionMap"], angular.module("permission.ui", ["permission", "ui.router"]).config(a).run(b)
}(), function () {
  "use strict";
  function a(a, b, c, d) {
    "ngInject";
