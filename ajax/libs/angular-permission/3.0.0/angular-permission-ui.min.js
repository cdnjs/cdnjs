...
!function () {
  ...
  function b(a, b, c, d, e, f) {
    a.$on("$stateChangeStart", function (a, g, h, i, j, k) {
      ...
      function o() {
        ...
        var a = angular.extend({}, c.options, {notify: !1, location: "replace"});
  ...
  angular.module("permission.ui", ["permission", "ui.router"]).config(a).run(b)
}(), function () {
  "use strict";
  function a(a, b, c, d) {
    function e() {
  ...
  angular.module("permission.ui").decorator("TransitionEvents", a)
}(), function () {
  "use strict";
  var a = {
  ...
  angular.module("permission").service("StateAuthorization", a)
}(), function () {
  "use strict";
  function a(a) {
    function b(b) {
      var d = b.$$state(), e = d.path.slice().reverse();
  ...
  angular.module("permission.ui").factory("StatePermissionMap", a)
}();
