...
const adaptCSSVal = (t, n) => !$[t] && isNumber(n) ? `${n}px` : n;
...
const createDOMObserver = (t, n, o, s) => {
  let e = false;
  const {Y: c, J: r, K: l, Z: i, tt: a, nt: u} = s || {};
...
const createScrollbarsSetupElements = (t, n, o, s) => {
  ...
  const {slot: i} = r;
  const {At: a, it: u, ut: f, Et: _, Tt: v, Dt: h, dt: p} = n;
  ...
  const x = dynamicInitializationElement([ a, u, f ], (() => p && h ? a : u), i, b);
  ...
  const appendElements = () => {
    appendChildren(x, O[0].kt);
    appendChildren(x, C[0].kt);
    d((() => {
    ...
    const createInteractiveScrollEvents = () => {
      ...
      return addEventListener(f, "pointerdown", (o => {
        ...
        if (p) {
          ...
          const v = createRelativeHandleMove(getElmentScroll(e)[x] || 0, 1 / d);
          const h = o[w];
          const p = i();
          const g = u();
          const b = p[y];
...
const createScrollbarsSetup = (t, n, o, s, e, c) => {
  ...
  const k = [ b, $, y, S, p, v, () => f(), addEventListener(H, "pointerover", onHostMouseEnter, {
    C: true
  ...
  return [ () => bind(runEachAndClear, push(k, C())), ({xt: t, Ot: n, Ft: e, Wt: c}) => {
    const {Xt: a, Yt: d, Jt: v} = c || {};
    const {bt: h, st: p} = e || {};
    const {lt: g} = o;
    const {A: b} = getEnvironment();
    const {zt: w, Kt: y, Zt: S} = s;
...
const createStructureSetupElements = t => {
  ...
  const q = {
    ...
    dt: E,
    sn: k,
    vt: (t, n) => hasAttrClass(V, E ? K : et, E ? n : t),
    ht: (t, n, o) => attrClass(V, E ? K : et, E ? n : t, o)
  };
...
const createOverflowUpdateSegment = ({it: t, Qt: n, ut: o, tn: s, dt: e, ht: c, Dt: i, nn: a}, u) => {
  ...
  const [q, F] = y ? y.D(m, g, o, s, u, getViewportOverflowState, hideNativeScrollbars) : [ () => m, () => [ noop ] ];
  return ({xt: s, Ft: r, en: i, Ot: _}, {rn: d}) => {
    const {ct: v, yt: h, wt: p, gt: y, bt: m, St: C} = r || {};
    const {rt: H, lt: z} = i;
    ...
    const Ot = st && ct && ($t.x || $t.y) || st && $t.x && !$t.y || ct && $t.y && !$t.x;
    const Ct = d || m || C || xt || mt || gt || wt || X || R || J || ot;
    if (Ct) {
      const n = {
        [A]: 0,
        [E]: 0,
      ...
      const s = setViewportOverflowState(Y, $t, W, n);
      const c = q(s, yt, St, z);
      if (!e) {
    ...
    const [Ht, zt] = G(getViewportOverflowState(Y).Kt);
    assignDeep(u, {
      Kt: Ht,
      It: {
        x: pt.w,
...
const createSetups = (t, n, o, s) => {
  ...
  const update = (t, s) => {
    const {an: e, Ot: r, $t: l, un: i} = t;
    const a = e || {};
    const _ = !!r;
    const v = {
      xt: createOptionCheck(n, a, _),
      an: a,
      Ot: _
    };
    if (i) {
  ...
  if (n && !r) {
    ...
    const m = {
      ...
      state() {
        const {fn: t, _n: n} = b();
        const {lt: o} = t;
        const {It: s, zt: e, Kt: c, Zt: l, Qt: i, cn: a} = n;
        return assignDeep({}, {
          overflowEdge: s,
          overflowAmount: e,
          overflowStyle: c,
...
exports.ScrollbarsHidingPlugin = Nt;
