...
const createScrollbarsSetup = (t, n, o, s, e, c) => {
  ...
  const {Ft: H, Ut: z, Nt: I, qt: A, Bt: D} = S;
...
const createStructureSetupElements = t => {
  ...
  const {vt: j, ht: X, rn: W, ot: J, bt: Q} = F;
  const Z = [ () => {
    removeAttrs(X, [ U, V ]);
    removeAttrs(j, V);
    if (h) {
  ...
  let tt = contents([ Q, J, W, X, j ].find((t => t && !elementIsGenerated(t))));
  const nt = E ? j : Q || J;
  ...
  const appendElements = () => {
    ...
    focusElement(!H && h && n === j && t.top === t ? J : n);
    c();
    tt = 0;
    return ot;
  };
  return [ F, appendElements, ot ];
};
...
const createOverflowUpdateSegment = (t, s) => {
  ...
  return ({zt: n, Qt: o, un: i, At: a}, {_n: u}) => {
    ...
    const _t = u || b || y || it || rt || ot || et || j || B || J;
  ...
  if (n && !r) {
    ...
    const S = {
      ...
      state() {
        const {hn: t, gn: n} = b();
        const {ct: o} = t;
        const {Rt: s, Mt: e, K: c, cn: l, rn: i, dn: a, Vt: u} = n;
        return assignDeep({}, {
          overflowEdge: s,
          overflowAmount: e,
          overflowStyle: c,
