...
var OverlayScrollbarsGlobal = function(r) {
  ...
  var Ve = "arrange";
  var Re = "measuring";
  var Fe = "scrollbarHidden";
  var Ne = "scrollbarPressed";
  var je = "noContent";
  var Ue = Ee + "-padding";
  var qe = Ee + "-content";
  ...
  var Ka = function createObserversSetup(r, a, t, n) {
    ...
    var p = r.gr, _ = r.hr, h = r.tr, b = r.br, m = r.mr, S = r.ar, w = r.Sr, O = r.yr, E = r.wr;
    ...
    var R = function onContentMutation(r, e) {
      var a = z(), t = a[1];
      var v = {
        Ar: t
      };
    ...
    var F = function onHostMutation(r, e, a) {
      var t = {
        Hr: e
      };
      I(t);
  ...
  var Qa = function createScrollbarsSetupElements(r, e, a, t) {
    ...
    var f = l.slot;
    var s = e.gr, d = e.hr, p = e.tr, _ = e.Mr, g = e.br, b = e.Sr, m = e.ar;
    ...
    var j = function generateScrollbarDOM(r) {
      ...
      var u = T[e];
      I(r ? E : A, o);
      I(x, [ Fr(n, v), Fr(v, i), or(Rr, n), u && u.Ir(o), t(o, L, r) ]);
      return o;
    };
    var U = or(j, true);
    var q = or(j, false);
  ...
  var rt = function createScrollbarsSetupEvents(r, e, a, t) {
    return function(n, v, u) {
      var c = e.hr, l = e.tr, s = e.ar, d = e.br, p = e.Jr, _ = e.wr;
      var g = n.Lr, h = n.Fr, b = n.Nr;
      ...
      var A = function createInteractiveScrollEvents() {
        ...
        return ue(h, "pointerdown", (function(a) {
          ...
          if (A) {
            ...
            var B = function addScrollbarPressedClass() {
              return _(Ne, true);
            };
            var Y = B();
            var W = [ function() {
  ...
  var et = function createScrollbarsSetup(r, e, a, t, n, v) {
    ...
    var P = n.hr, T = n.Kr, D = n.Sr;
    var z = A.Yr, M = A.jr, L = A.Ur, k = A.qr, V = A.Br;
    ...
    return [ function() {
      ...
      var e = r.Tr, n = r.zr, v = r.Qr, i = r.re;
      var d = i || {}, p = d.ee, _ = d.ae, g = d.te, h = d.ne;
      var b = v || {}, m = b.Cr, S = b.pr;
      var w = a.ir;
      var O = ba(), C = O.I;
      var x = t.K, E = t.ve;
  ...
  var at = function createStructureSetupElements(r) {
    ...
    var Y = B.gr, W = B.hr, X = B.ie, $ = B.tr, J = B.mr;
    var K = [ function() {
      Sr(W, [ ze, Pe ]);
      Sr(Y, Pe);
      if (b) {
    ...
    var Q = Mr([ J, $, X, W, Y ].find((function(r) {
      return r && !U(r);
    })));
    var rr = D ? Y : J || $;
    var er = or(N, K);
  ...
  var nt = function createPaddingUpdateSegment(r, a) {
    var t = r.hr, n = r.ie, v = r.tr, i = r.ar;
    var o = e({
      i: vr,
      v: Xr()
    }, or(Xr, t, "padding", "")), u = o[0], c = o[1];
    return function(r) {
      var e = r.Tr, t = r.Qr, o = r.ce, l = r.zr;
      var f = c(l), s = f[0], d = f[1];
      var p = ba(), _ = p.k;
      var g = t || {}, h = g._r, b = g.Ar, m = g.Cr;
      var S = o.ir;
  ...
  var vt = function createOverflowUpdateSegment(r, a) {
    var v = ba();
    var i = r.hr, o = r.ie, u = r.tr, c = r.ar, f = r.Kr, s = r.br, d = r.Sr, p = r.wr, _ = r.ue;
    var g = v.k;
    var h = d && c;
    var b = or(n, 0);
    ...
    var A = e(S, or(ee, u)), H = A[0], P = A[1];
    var T = e(S), D = T[0], z = T[1];
    var M = e(y), L = M[0];
    ...
    return function(e, t) {
      var n = e.Tr, c = e.Qr, l = e.ce, f = e.zr;
      var s = t.fe;
      var d = c || {}, m = d.Cr, S = d.pr, y = d.Pr;
      var C = Y && Y.er(r, a, l, v, n);
      var A = C || {}, T = A.lr, M = A.sr, I = A.dr;
      ...
      var Dr = $ && J && (Pr.x || Pr.y) || $ && Pr.x && !Pr.y || J && Pr.y && !Pr.x;
  ...
  var it = function createStructureSetup(r) {
    ...
    var o = t.gr, u = t.br, c = t.ar;
    var l = ba(), f = l.k, s = l.I;
    var d = !f && (s.x || s.y);
  ...
  var ot = function createSetups(r, e, a, t, n) {
    ...
    var w = function update(r, n) {
      ...
      var i = r.de, o = r.zr, u = r.Dr, l = r.pe;
      var f = i || {};
      var s = !!o || !v;
      var d = {
        Tr: xe(e, f, s),
  ...
  var ut = function OverlayScrollbars(r, e, a) {
    ...
    if (e && !o) {
      ...
      var w = ot(r, s, (function() {
        ...
        var a = r.de, t = r.zr;
        var n = e.Qr, v = e.re;
        var i = n._r, o = n.Cr, u = n.Er, c = n.Ar, l = n.Hr, f = n.pr;
        var s = v.ee, d = v.ae, p = v.te, _ = v.ne;
        y("updated", [ T, {
          updateHints: {
            sizeChanged: !!i,
            directionChanged: !!o,
      ...
      var T = {
        ...
        state: function state() {
          var r = x(), e = r._e, a = r.ge;
          var t = e.ir;
          var n = a.Vr, v = a.kr, i = a.K, o = a.ve, c = a.ie, l = a.le, f = a.Rr;
          return sr({}, {
            overflowEdge: n,
            overflowAmount: v,
            overflowStyle: i,
        ...
        elements: function elements() {
          var r = E.he, e = r.gr, a = r.hr, t = r.ie, n = r.tr, v = r.mr, i = r.br, o = r.Kr;
          var u = E.be, c = u.Wr, l = u.$r;
          var f = function translateScrollbarStructure(r) {
            var e = r.Nr, a = r.Fr, t = r.Lr;
            return {
              scrollbar: t,
              track: a,
              handle: e
