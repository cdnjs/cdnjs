    ...
    static: () => ({
      tt: (t, n, o, s, e) => {
        ...
        const readViewportOverflowState = () => {
          ...
          const [t, n] = getStatePerAxis(C);
          const [o, s] = getStatePerAxis(x);
          return {
            G: {
              x: t,
              y: o
...
export { Mt as ClickScrollPlugin, OverlayScrollbars, Dt as ScrollbarsHidingPlugin, At as SizeObserverPlugin };
