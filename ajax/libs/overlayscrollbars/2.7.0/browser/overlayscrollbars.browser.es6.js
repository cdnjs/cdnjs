...
var OverlayScrollbarsGlobal = function(t) {
  ...
  const createEnvironment = () => {
    ...
    const n = createDOM(`<div class="${U}"><div></div></div>`);
    const s = n[0];
  ...
  const createScrollbarsSetupElements = (t, n, o, s) => {
    ...
    const {slot: l} = r;
    const {gt: i, bt: a, D: u, Dt: f, kt: d, Rt: _, V: h} = n;
    ...
    const y = dynamicInitializationElement([ i, a, u ], (() => h && _ ? i : a), l, g);
      ...
      const createInteractiveScrollEvents = () => {
        ...
        return addEventListener(d, "pointerdown", (o => {
          ...
          if (p) {
            ...
            const f = c(getBoundingClientRect(r)[y]) / k(r)[O] || 1;
  ...
  const createScrollbarsSetup = (t, n, o, s, e, c) => {
    ...
    return [ () => bind(runEachAndClear, push(I, y())), ({Et: t, Tt: n, Zt: e, Qt: c}) => {
  ...
  const createStructureSetupElements = t => {
    ...
    const appendElements = () => {
      ...
      if (!z && y.top === y && t === p) {
        ...
        push(K, [ revertViewportTabIndex, o ]);
      } else {
        focusElm(t);
      }
      n();
  ...
  const createOverflowUpdateSegment = (t, n) => {
    ...
    return ({Et: o, Zt: u, an: h, Tt: p}, {fn: I}) => {
      ...
      if (X) {
        ...
        const S = {
          w: v((_ ? h.w : d.w + v(i.w - c.w)) + o.w),
          h: v((_ ? h.h : d.h + v(i.h - c.h)) + o.h)
        };
        ct = O(S);
      ...
      const gt = I || T || D || vt || dt || it || ut || N || U || X;
      if (gt) {
        const n = {};
