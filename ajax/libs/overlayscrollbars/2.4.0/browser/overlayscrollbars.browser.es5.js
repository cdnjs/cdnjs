...
var OverlayScrollbarsGlobal = function(r) {
  ...
  var Ce = function registerPluginModuleInstances(r, a, e, t) {
    return z(r).map((function(n) {
      var v = r[n], i = v.static, o = v.instance;
      var u = e ? o : i;
      if (u) {
        var l = e ? u(e, a) : u(a);
        return (t || Oe)[n] = l;
  ...
  var St = function OverlayScrollbars(r, a, e) {
    ...
    if (a && !l) {
      ...
      var p = P({}, n(), d(a));
      var _ = Ca(e), h = _[0], b = _[1], g = _[2];
      var S = mt(r, p, (function(r, a) {
        var e = r.ca, t = r.Er;
        var n = a.Zr, v = a.$r;
      ...
      var R = {
        ...
        elements: function elements() {
          var r = C._a, a = r.zr, e = r.sr, t = r.ea, n = r.dr, v = r.pr, i = r.Ar, o = r.Xr;
          var u = C.ha, l = u.Fr, c = u.Yr;
      ...
      O(f, [ v(D), i(D), E ]);
      Qe(u, R);
      Ce(we, OverlayScrollbars, R, s);
      if (Je(C._a.Rr, !o && r.cancel)) {
        H(true);
        return R;
      }
      O(f, y());
