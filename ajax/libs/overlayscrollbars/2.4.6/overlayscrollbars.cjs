...
const createScrollbarsSetupElements = (t, n, o, s) => {
  ...
  const refreshScrollbarsScrollbarOffset = () => {
    if (h) {
      if (w && y) {
        const {zt: t} = o;
        const n = !!$.find((({kt: t}) => getDirectionIsRTL(t)));
...
const createScrollbarsSetup = (t, n, o, s, e, c) => {
  ...
  const k = [ b, $, y, m, p, v, () => f(), addEventListener(H, "pointerover", onHostMouseEnter, {
    C: true
...
const createOverflowUpdateSegment = ({it: t, Qt: n, ut: o, tn: s, dt: e, ht: c, Dt: i, nn: a}, u) => {
  ...
  return ({xt: s, Ft: r, en: i, Ot: _}, {rn: d}) => {
    ...
    const Ct = d || S || C || xt || St || gt || wt || X || R || K || ot;
    if (Ct) {
      const n = {
        [A]: 0,
        [E]: 0,
