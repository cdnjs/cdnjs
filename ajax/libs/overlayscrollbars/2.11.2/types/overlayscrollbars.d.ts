    ...
    __osScrollbarsHidingPlugin: {
        static: () => {
            _viewportArrangement: (structureSetupElements: StructureSetupElementsObj, structureSetupState: StructureSetupState, observersSetupState: ObserversSetupState, env: Env, checkOptions: OptionsCheckFn<Options>) => {
                _getViewportOverflowHideOffset: (viewportOverflowStyle: XY<OverflowStyle>) => {
                ...
                _undoViewportArrange: () => readonly [() => void, XY<OverflowStyle>] | readonly [() => void];
                _hideNativeScrollbars: (viewportOverflowStyle: XY<OverflowStyle>, { _directionIsRTL }: ObserversSetupState, viewportArrange: boolean) => StyleObject | undefined;
            };
        };
    };
};
