...
var OverlayScrollbarsGlobal = function(t) {
  ...
  const {min: sn, max: en, round: cn} = Math;
  ...
  const createScrollbarsSetup = (t, n, o, s) => {
    ...
    const {J: z, et: E, it: A} = o.Gt;
    const {tn: I, Wt: H, Zt: L, Jt: M, Kt: P, Qt: D} = C;
    ...
    k.qt = O;
    return [ (t, s, l) => {
      const {Ht: f, Lt: d, It: _, St: h, Mt: g} = l;
