...
var OverlayScrollbarsGlobal = function(r) {
  ...
  var ha = "updating";
  var ga = "data-overlayscrollbars-viewport";
  var pa = "arrange";
          ...
          if (r) {
            ...
            if (n) {
              ...
              if (C) {
                ...
                if (O) {
                  if (!O.length) {
                    C.insertRule("#" + L(n, "id") + " + [" + ga + "~='" + pa + "']::before {}", 0);
                  }
                  var x = O[0].style;
                  x.width = S.w;
                  x.height = S.h;
  ...
  var je = function createStructureSetupElements(r) {
    ...
    var fr = {
      ...
      dr: function _viewportHasClass(r, a) {
        return M(nr, Y ? ua : ga, Y ? a : r);
      },
      hr: function _viewportAddRemoveClass(r, a, e) {
        return R(nr, Y ? ua : ga, Y ? a : r, e);
      }
    };
    ...
    var sr = fr.Z, dr = fr.$, hr = fr.K, gr = fr.J, _r = fr.rr, wr = fr.ar;
    var br = [ function() {
      H(dr, ua);
      H(dr, oa);
      H(sr, oa);
    ...
    var mr = E && cr(dr);
    var yr = E ? sr : U([ _r, gr, hr, dr, sr ].find((function(r) {
      return false === cr(r);
    })));
    var Sr = $ ? sr : _r || gr;
  ...
  var Ke = function createOverflowUpdateSegment(r, e) {
    ...
    var d = xe(), h = d.V, g = d.j, p = d.A, w = d.L;
    var b = Ga()[ge];
    var m = !f && !p && (w.x || w.y);
    var y = c && f;
    ...
    var q = b ? b.R(m, g, o, u, n, B, U) : [ function() {
      return m;
    }, function() {
      return [ xr ];
    } ], F = q[0], N = q[1];
    return function(r, a, e) {
      ...
      if (u || h || d || m || q) {
        ...
        var _r = {
          w: Ne((y ? s.innerWidth : gr.w + Ne(dr.w - cr.w)) + ur.w),
          h: Ne((y ? s.innerHeight + ur.h : gr.h + Ne(dr.h - cr.h)) + ur.h)
        };
        er = M(_r);
        ar = T($e(pr, _r), e);
      }
  ...
  var gn = function createStructureSetupObservers(r, e, n) {
    var t;
    var v;
    var i;
  ...
  var Rn = function createScrollbarsSetup(r, a, e, n) {
    ...
    return [ function(r, n, o) {
      ...
      var P = p("scrollbars.visibility"), T = P[0], A = P[1];
      var L = p("scrollbars.autoHide"), H = L[0], R = L[1];
      var M = p("scrollbars.autoHideDelay"), I = M[0];
