...
const createObserversSetup = (t, n, o, s) => {
  ...
  const {vt: v, gt: p, ot: g, ht: h, bt: b, nt: w, wt: y, yt: S, St: m, Ot: O} = t;
  ...
  const [T, k] = createDOMObserver(p, false, onHostMutation, {
    X: d,
    j: d
  });
  const M = w && f && new f((t => {
...
const createScrollbarsSetupElements = (t, n, o, s) => {
  ...
  const {slot: a} = i;
  const {vt: u, gt: _, ot: d, Tt: f, ht: p, wt: g, nt: h} = n;
...
const createScrollbarsSetupEvents = (t, n, o, s) => (r, l, i) => {
  const {gt: u, ot: _, nt: d, ht: f, Kt: v, Ot: p} = n;
...
const createScrollbarsSetup = (t, n, o, s, e, c) => {
  ...
  const T = [ y, g, b, v, () => _(), addEventListener(O, "pointerover", onHostMouseEnter, {
    A: true
...
const createStructureSetupElements = t => {
  ...
  const B = !elementIsGenerated(T) && elementHasOverflow(T) ? T : p;
  const F = E ? b : T;
  const j = E ? h : T;
  const X = {
    vt: p,
...
const createOverflowUpdateSegment = (t, s) => {
  ...
  const {gt: c, ln: r, ot: l, nt: a, Qt: u, ht: _, wt: d, St: f, un: v} = t;
  const {R: p} = e;
  const g = d && a;
  const h = bind(o, 0);
  const b = {
  ...
  return ({It: n, Zt: o, _n: i, Dt: a}, {fn: u}) => {
    ...
    const [vt, pt] = R(ft.K);
    const [gt, ht] = V(a);
    const bt = b || w || ht || ut || a;
    const [wt, yt] = bt ? U(getMeasuredScrollCoordinates(gt), a) : N();
    if (dt) {
...
const OverlayScrollbars = (t, n, o) => {
  ...
  if (n && !r) {
    ...
    const [g, h, b, w, y] = createSetups(t, a, (() => r), (({pn: t, Dt: n}, {Zt: o, tn: s}) => {
