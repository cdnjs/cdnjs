...
var OverlayScrollbarsGlobal = function(t) {
  ...
  const createObserversSetup = (t, n, o, s) => {
    ...
    const {vt: f, gt: p, ot: g, ht: h, bt: b, nt: w, wt: y, yt: S, St: m, Ot: O} = t;
  ...
  const createOverflowUpdateSegment = (t, n) => {
    ...
    const {gt: c, ln: r, ot: l, nt: i, Qt: u, ht: _, wt: d, St: f, un: v} = t;
    const {R: p} = e;
    const g = d && i;
    const h = bind(s, 0);
    ...
    const [O, $] = createCache(w, bind(T, l));
    ...
    const P = getStaticPluginModuleInstance(It);
    ...
    return ({It: o, Zt: s, _n: i, Dt: a}, {fn: u}) => {
      const {ft: _, Ht: d, Ct: b, dt: w, zt: y} = s || {};
      const H = P && P.tt(t, n, i, e, o);
      const {it: E, ut: z, _t: T} = H || {};
