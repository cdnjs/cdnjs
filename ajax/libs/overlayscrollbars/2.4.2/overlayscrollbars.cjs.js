...
const OverlayScrollbars = (t, n, o) => {
  ...
  if (n && !i) {
    ...
    const [b, w, y, m, S] = createSetups(t, f, (({_n: t, Ct: n}, {Yt: o, Zt: s}) => {
    ...
    const $ = {
      ...
      elements() {
        const {It: t, ft: n, sn: o, _t: s, dt: e, Et: c, Xt: r} = m.gn;
        const {jt: l, Wt: i} = m.bn;
    ...
    if (cancelInitialization(m.gn.Tt, !r && t.cancel)) {
      destroy(true);
      return $;
    }
    push(a, b());
