...
const OverlayScrollbars = (t, n, o) => {
  ...
  if (n && !i) {
    ...
    const [_, d, v] = createEventListenerHub();
    const [h, p, g] = createEventListenerHub(o);
    const triggerEvent = (t, n) => {
      g(t, n);
      v(t, n);
    };
    const [b, w, y, m, S] = createSetups(t, f, (({fn: t, Ot: n}, {Xt: o, Yt: s}) => {
    ...
    }), (t => triggerEvent("scroll", [ $, t ])));
    const destroy = t => {
      removeInstance(l);
      runEachAndClear(a);
      i = true;
      triggerEvent("destroyed", [ $, t ]);
      d();
      p();
    };
    const $ = {
      ...
      elements() {
        const {Ht: t, ut: n, nn: o, ft: s, _t: e, At: c, Ft: r} = m.pn;
        const {Bt: l, qt: i} = m.gn;
    ...
    push(a, [ e(onWindowResize), c(onWindowResize), S ]);
    addInstance(l, $);
    registerPluginModuleInstances(Mt, OverlayScrollbars, [ $, _, u ]);
    if (cancelInitialization(m.pn.Et, !r && t.cancel)) {
      destroy(true);
      return $;
    }
    push(a, b());
