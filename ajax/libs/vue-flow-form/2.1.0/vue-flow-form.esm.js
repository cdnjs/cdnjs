import { openBlock, createBlock, createVNode, createCommentVNode, Fragment, renderList, toDisplayString, resolveDirective, withDirectives, resolveComponent, withKeys, withModifiers, vModelText, createTextVNode, resolveDynamicComponent, renderSlot } from 'vue';
...
var _hoisted_3$3 = /*#__PURE__*/createVNode("span", { class: "f-arrow-down" }, [
  /*#__PURE__*/createVNode("svg", {
    ...
    /*#__PURE__*/createVNode("g", null, [
      /*#__PURE__*/createVNode("path", { d: "M119.1,330.6l-14.3-14.3c-1.9-1.9-4.1-2.9-6.6-2.9c-2.5,0-4.7,1-6.6,2.9L-20.5,428.5l-112.2-112.2c-1.9-1.9-4.1-2.9-6.6-2.9c-2.5,0-4.7,0.9-6.6,2.9l-14.3,14.3c-1.9,1.9-2.9,4.1-2.9,6.6c0,2.5,1,4.7,2.9,6.6l133,133c1.9,1.9,4.1,2.9,6.6,2.9s4.7-1,6.6-2.9l133.1-133c1.9-1.9,2.8-4.1,2.8-6.6C121.9,334.7,121,332.5,119.1,330.6z" })
    ])
  ])
], -1 /* HOISTED */);
  ...
  return (openBlock(), createBlock("span", _hoisted_1$4, [
    createVNode("select", {
      ...
      (_ctx.question.required)
        ? (openBlock(), createBlock("option", _hoisted_2$4, " "))
        : createCommentVNode("v-if", true),
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.question.options, function (option, index) {
        return (openBlock(), createBlock("option", {
          disabled: option.disabled,
          value: option.choiceValue(),
          key: 'o' + index
        }, toDisplayString(option.choiceLabel()), 9 /* TEXT, PROPS */, ["disabled", "value"]))
      }), 128 /* KEYED_FRAGMENT */))
      ...
      (openBlock(true), createBlock(Fragment, null, renderList(_ctx.question.options, function (option, index) {
        return (openBlock(), createBlock("li", {
          ...
          createVNode("div", _hoisted_3$2, [
            createVNode("span", _hoisted_4$2, toDisplayString($options.getToggleKey(index)), 1 /* TEXT */),
            (option.choiceLabel())
              ? (openBlock(), createBlock("span", _hoisted_5$2, toDisplayString(option.choiceLabel()), 1 /* TEXT */))
              : createCommentVNode("v-if", true)
          ])
      ...
      (!$data.hasImages && _ctx.question.allowOther)
        ? (openBlock(), createBlock("li", {
            ...
            createVNode("div", _hoisted_6$2, [
              (!$data.editingOther)
                ? (openBlock(), createBlock("span", _hoisted_7$2, toDisplayString($options.getToggleKey(_ctx.question.options.length)), 1 /* TEXT */))
                : createCommentVNode("v-if", true),
              ($data.editingOther)
                ...
                : (_ctx.question.other)
                  ? (openBlock(), createBlock("span", _hoisted_8$2, [
                      createVNode("span", _hoisted_9$2, toDisplayString(_ctx.question.other), 1 /* TEXT */)
                    ]))
                  : (openBlock(), createBlock("span", _hoisted_10$2, toDisplayString(_ctx.language.otherPrompt), 1 /* TEXT */))
            ])
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (_ctx.question.content)
    ? (openBlock(), createBlock("div", _hoisted_1$2, [
        createVNode("span", _hoisted_2$2, toDisplayString(_ctx.question.content), 1 /* TEXT */)
      ]))
    : createCommentVNode("v-if", true)
}
...
var _hoisted_5$1 = /*#__PURE__*/createVNode("span", { "aria-hidden": "true" }, "*", -1 /* HOISTED */);
var _hoisted_6$1 = {
  key: 1,
  class: "f-answer"
};
      ...
      createVNode("div", {
        ...
        createVNode("div", {
          ...
          ($props.question.tagline)
            ? (openBlock(), createBlock("span", _hoisted_2$1, toDisplayString($props.question.tagline), 1 /* TEXT */))
            : createCommentVNode("v-if", true),
          ($props.question.title)
            ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                ($props.question.type === $data.QuestionType.SectionBreak)
                  ? (openBlock(), createBlock("span", _hoisted_3$1, toDisplayString($props.question.title), 1 /* TEXT */))
                  : (openBlock(), createBlock("span", _hoisted_4$1, [
                      ...
                      ($props.question.inline)
                        ? (openBlock(), createBlock("span", _hoisted_6$1, [
          ...
          ($options.showHelperText)
            ? (openBlock(), createBlock("span", _hoisted_7$1, [
                ($props.question.subtitle)
                  ? (openBlock(), createBlock("span", _hoisted_8$1, toDisplayString($props.question.subtitle), 1 /* TEXT */))
                  : createCommentVNode("v-if", true),
                ...
                ($props.question.type === $data.QuestionType.MultipleChoice && $props.question.multiple)
                  ? (openBlock(), createBlock("span", _hoisted_9$1, toDisplayString($props.question.helpText || $props.language.multipleChoiceHelpText), 1 /* TEXT */))
                  : ($props.question.type === $data.QuestionType.MultipleChoice)
                    ? (openBlock(), createBlock("span", _hoisted_10$1, toDisplayString($props.question.helpText || $props.language.multipleChoiceHelpTextSingle), 1 /* TEXT */))
                    : createCommentVNode("v-if", true)
              ]))
            : createCommentVNode("v-if", true),
          (!$props.question.inline)
            ? (openBlock(), createBlock("div", _hoisted_11$1, [
                (openBlock(), createBlock(resolveDynamicComponent($props.question.type), {
                  ref: "questionComponent",
                  question: $props.question,
                  language: $props.language,
        ...
        ($props.question.description || $props.question.descriptionLink.length !== 0)
          ? (openBlock(), createBlock("p", _hoisted_12$1, [
              ($props.question.description)
                ? (openBlock(), createBlock("span", _hoisted_13$1, toDisplayString($props.question.description), 1 /* TEXT */))
                : createCommentVNode("v-if", true),
              (openBlock(true), createBlock(Fragment, null, renderList($props.question.descriptionLink, function (link, index) {
                return (openBlock(), createBlock("a", {
                  class: "f-link",
                  key: 'm' + index,
                  href: link.url,
                  target: link.target
                }, toDisplayString(link.text || link.url), 9 /* TEXT, PROPS */, ["href", "target"]))
              }), 128 /* KEYED_FRAGMENT */))
            ]))
          : createCommentVNode("v-if", true)
      ], 2 /* CLASS */),
      ($options.showOkButton())
        ? (openBlock(), createBlock("div", _hoisted_14$1, [
            createVNode("button", {
              class: "o-btn-action",
              type: "button",
              ref: "button",
              ...
              ($props.question.type === $data.QuestionType.SectionBreak)
                ? (openBlock(), createBlock("span", _hoisted_15$1, toDisplayString($props.language.continue), 1 /* TEXT */))
                : ($options.showSkip())
                  ? (openBlock(), createBlock("span", _hoisted_16, toDisplayString($props.language.skip), 1 /* TEXT */))
                  : (openBlock(), createBlock("span", _hoisted_17, toDisplayString($props.language.ok), 1 /* TEXT */))
            ], 8 /* PROPS */, ["aria-label"]),
            ($props.question.type !== $data.QuestionType.LongText || !_ctx.isMobile)
        ...
        : createCommentVNode("v-if", true),
      ($options.showInvalid())
        ? (openBlock(), createBlock("div", _hoisted_18, toDisplayString($options.errorMessage), 1 /* TEXT */))
        : createCommentVNode("v-if", true)
    ])
  ], 2 /* CLASS */))
}
...
var _hoisted_11 = /*#__PURE__*/createVNode("svg", {
  ...
  /*#__PURE__*/createVNode("path", { d: "M82.039,31.971L100,11.442l17.959,20.529L120,30.187L101.02,8.492c-0.258-0.295-0.629-0.463-1.02-0.463c-0.39,0-0.764,0.168-1.02,0.463L80,30.187L82.039,31.971z" })
], -1 /* HOISTED */);
var _hoisted_12 = {
  class: "f-nav-text",
  "aria-hidden": "true"
};
var _hoisted_13 = /*#__PURE__*/createVNode("svg", {
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "xmlns:xlink": "http://www.w3.org/1999/xlink",
  x: "0px",
  ...
  /*#__PURE__*/createVNode("path", { d: "M117.963,8.031l-17.961,20.529L82.042,8.031l-2.041,1.784l18.98,21.695c0.258,0.295,0.629,0.463,1.02,0.463c0.39,0,0.764-0.168,1.02-0.463l18.98-21.695L117.963,8.031z" })
], -1 /* HOISTED */);
var _hoisted_14 = {
  class: "f-nav-text",
  "aria-hidden": "true"
  ...
  return (openBlock(), createBlock("div", {
    ...
    createVNode("div", _hoisted_1, [
      createVNode("div", _hoisted_2, [
        (openBlock(true), createBlock(Fragment, null, renderList($data.questionList, function (q, index) {
          ...
          ? (openBlock(), createBlock("div", _hoisted_3, [
              renderSlot(_ctx.$slots, "complete", {}, function () { return [
                ...
                createVNode("div", _hoisted_4, [
                  createVNode("p", null, [
                    createVNode("span", _hoisted_5, toDisplayString($props.language.thankYouText), 1 /* TEXT */)
                  ])
                ])
              ]; }),
              renderSlot(_ctx.$slots, "completeButton", {}, function () { return [
                ...
                (!$data.submitted)
                  ? (openBlock(), createBlock("button", {
                      ...
                      createVNode("span", null, toDisplayString($props.language.submitText), 1 /* TEXT */)
                    ], 8 /* PROPS */, ["aria-label"]))
                  : createCommentVNode("v-if", true),
                (!$data.submitted)
                  ? (openBlock(), createBlock("a", {
                      ...
                      class: "f-enter-desc",
                      href: "#",
                      onClick: _cache[2] || (_cache[2] = withModifiers(function ($event) { return ($options.submit()); }, ["prevent"])),
                      innerHTML: $props.language.formatString($props.language.pressEnter)
                    }, null, 8 /* PROPS */, ["innerHTML"]))
                  : createCommentVNode("v-if", true),
                ($data.submitted)
                  ? (openBlock(), createBlock("p", _hoisted_6, toDisplayString($props.language.successText), 1 /* TEXT */))
                  : createCommentVNode("v-if", true)
              ]; })
            ]))
          : createCommentVNode("v-if", true)
        ...
        ($props.navigation)
          ? (openBlock(), createBlock("div", _hoisted_10, [
              createVNode("a", {
                ...
                href: "#",
                onClick: _cache[3] || (_cache[3] = withModifiers(function ($event) { return ($options.goToPreviousQuestion()); }, ["prevent"])),
                role: "button",
                "aria-label": $props.language.ariaPrev
              }, [
                _hoisted_11,
                createVNode("span", _hoisted_12, toDisplayString($props.language.prev), 1 /* TEXT */)
              ], 10 /* CLASS, PROPS */, ["aria-label"]),
              createVNode("a", {
                class: ["f-next", {'f-disabled': !$options.isNextQuestionAvailable()}],
                href: "#",
                onClick: _cache[4] || (_cache[4] = withModifiers(function ($event) { return ($options.goToNextQuestion()); }, ["prevent"])),
                role: "button",
                "aria-label": $props.language.ariaNext
              }, [
                _hoisted_13,
                createVNode("span", _hoisted_14, toDisplayString($props.language.next), 1 /* TEXT */)
              ], 10 /* CLASS, PROPS */, ["aria-label"])
            ]))
          : createCommentVNode("v-if", true),
        ($props.timer)
          ? (openBlock(), createBlock("div", _hoisted_15, [
              createVNode("span", null, toDisplayString($options.formatTime($data.time)), 1 /* TEXT */)
            ]))
          : createCommentVNode("v-if", true)
      ])
    ])
...
export { ChoiceOption, script$1 as FlowForm, LanguageModel, LinkOption, MaskPresets, script as Question, QuestionModel, QuestionType };
