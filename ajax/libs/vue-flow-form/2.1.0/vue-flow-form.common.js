...
script$i.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/BaseType.vue";
...
script$h.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/DropdownType.vue";
...
script$g.__file = "//HAL9000/work/_open source/_vff/_git - phre/node_modules/vue-the-mask/src/component.vue";
...
script$f.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/TextType.vue";
...
script$e.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/EmailType.vue";
...
script$d.__file = "//HAL9000/work/_open source/_vff/_git - phre/node_modules/vue-textarea-autosize/src/components/TextareaAutosize.vue";
...
script$c.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/LongTextType.vue";
...
script$b.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/MultipleChoiceType.vue";
...
script$a.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/MultiplePictureChoiceType.vue";
...
script$9.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/NumberType.vue";
...
script$8.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/PasswordType.vue";
...
script$7.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/PhoneType.vue";
...
script$6.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/SectionBreakType.vue";
...
script$5.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/UrlType.vue";
...
script$4.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/DateType.vue";
...
var script$3 = {
    ...
    methods: {
      ...
      validate: function validate() {
        ...
        if (this.question.accept) {
          if (!Array.from(this.files).every(function (file) { return this$1.mimeTypeRegex.test(file.type); })) {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 40 /* PROPS, HYDRATE_EVENTS */, ["accept", "multiple", "value", "required"]))
}

script$3.render = render$2;
script$3.__file = "//HAL9000/work/_open source/_vff/_git - phre/src/components/QuestionTypes/FileType.vue";

var script$2 = {
    name: 'FlowFormQuestion',

    components: {
      FlowFormDateType: script$4,
      FlowFormDropdownType: script$h,
      FlowFormEmailType: script$e,
      FlowFormLongTextType: script$c,
      FlowFormMultipleChoiceType: script$b,
      FlowFormMultiplePictureChoiceType: script$a,
      FlowFormNumberType: script$9,
      FlowFormPasswordType: script$8,
      FlowFormPhoneType: script$7,
      FlowFormSectionBreakType: script$6,
      FlowFormTextType: script$f,
      FlowFormFileType: script$3,
      FlowFormUrlType: script$5
    },
  ...
  return (vue.openBlock(), vue.createBlock("div", {
    ...
    vue.createVNode("div", _hoisted_1$1, [
      ...
      ($options.showOkButton())
        ...
        : vue.createCommentVNode("v-if", true),
      ($options.showInvalid())
        ? (vue.openBlock(), vue.createBlock("div", _hoisted_18, vue.toDisplayString($options.errorMessage), 1 /* TEXT */))
        : vue.createCommentVNode("v-if", true)
    ])
  ], 2 /* CLASS */))
}
          ...
          if (!this.questions) {
            ...
            if (children) {
              children
                ...
                .forEach(function (q) {
                  var props = q.props;
                  var componentInstance = this$1.getInstance(props.id);
      ...
      goToQuestion: function goToQuestion(index) {
        ...
        if (index !== this.activeQuestionIndex) {
          ...
          if (!this.submitted && index <= this.questionListActivePath.length - 1) {
            ...
            do {
              var previousQuestion = index > 0 ? this.questionListActivePath[index - 1] : null;
