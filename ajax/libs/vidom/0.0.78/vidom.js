...
var FunctionComponentNode = (function () {
    ...
    _createClass(FunctionComponentNode, [{
        ...
        value: function _getRootNode() {
            ...
            var renderRes = this._component(this._attrs, this._children) || new _TagNode2.default('noscript');
...
},{"./TagNode":21}],21:[function(require,module,exports){
'use strict';
...
function normalizeChildren(children) {
    ...
    while (i < len) {
        ...
        if (child === null) {
            ...
            } else if ((typeof child === 'undefined' ? 'undefined' : _typeof(child)) === 'object' && children[i] === child) {
                if (res !== children) {
                    res = join(res, child);
                }
            } else {
...
},{"../createNode":18}],30:[function(require,module,exports){
'use strict';
...
},{"./Component":1,"./client/mounter":9,"./createComponent":17,"./createNode":18,"./renderToString":22,"./utils/console":23,"./utils/normalizeChildren":29}]},{},[30])(30)
});