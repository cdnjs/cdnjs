...
var Input = createComponent({
    onInit: function () {
        ...
        this.onChange = function (e) {
            var attrs = _this.getAttrs(),
                control = _this.getDomRef('control');
            ...
            if (_this.isMounted()) {
                ...
                var name = _getAttrs2.name;
                var type = _getAttrs2.type;
                var checked = _getAttrs2.checked; // attrs could be changed during applyBatch()
    ...
    onUnmount: function () {
        ...
        var type = _getAttrs3.type;
        var name = _getAttrs3.name;
