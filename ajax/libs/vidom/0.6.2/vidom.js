...
TagNode.prototype = {
    ...
    ref: function (ref) {
        ...
        ref.setResolver(function () {
            return _this._domNode;
        });
...
ComponentNode.prototype = {
    ...
    ref: function (ref) {
        ...
        ref.setResolver(function () {
            return _this._instance.onRefRequest();
        });
...
if (IS_DEBUG) {
    TextNode.prototype.ref = function () {
        consoleWrapper.error('Text nodes don\'t support refs.');
        return this;
    };
}
...
Ref.prototype = {
    ...
    resolve: function () {
        if (IS_DEBUG) {
            if (!this._resolver) {
                consoleWrapper.error('Reference can\'t be resolved.');
            }
        }
