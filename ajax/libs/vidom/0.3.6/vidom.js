...
},{"../globalHook":21,"../nodes/TopNode":26,"./domOps":4,"./getDomNodeId":9,"./ns":11,"./rafBatch":13}],11:[function(require,module,exports){
'use strict';
...
},{"./domAttrs":3,"./domOps":4,"./events/attrsToEvents":5,"./events/domEventManager":7,"./ns":11}],13:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../client/rafBatch":13,"../createComponent":19,"../nodes/TagNode":25}],17:[function(require,module,exports){
'use strict';
...
},{"../client/rafBatch":13,"../createComponent":19,"../nodes/TagNode":25}],18:[function(require,module,exports){
'use strict';
...
},{"../client/rafBatch":13,"../createComponent":19,"../nodes/TagNode":25}],19:[function(require,module,exports){
'use strict';
...
},{"./client/rafBatch":13,"./createNode":20,"./globalHook":21,"./utils/console":32,"./utils/emptyObj":34,"./utils/noOp":38}],20:[function(require,module,exports){
'use strict';
...
},{"../client/patchOps":12,"../utils/console":32,"../utils/emptyObj":34,"./utils/checkChildren":27,"./utils/nodeTypes":28,"./utils/patchChildren":29}],24:[function(require,module,exports){
'use strict';
...
},{"../utils/emptyObj":34,"./TagNode":25,"./utils/nodeTypes":28}],25:[function(require,module,exports){
'use strict';
...
TagNode.prototype = {
    ...
    renderToDom: function renderToDom(parentNs) {
        ...
        var domNode = (0, _createElement2.default)(ns, this._tag),
            attrs = this._attrs;
        ...
        if (children) {
            if (typeof children === 'string') {
                ...
                while (i < len) {
                    _domOps2.default.append(domNode, children[i++].renderToDom(ns));
                }
            }
        }
...
},{"../client/browsers":2,"../client/domAttrs":3,"../client/domOps":4,"../client/events/attrsToEvents":5,"../client/events/domEventManager":7,"../client/patchOps":12,"../client/utils/createElement":14,"../client/utils/createElementByHtml":15,"../utils/console":32,"../utils/emptyObj":34,"../utils/escapeHtml":36,"../utils/isInArray":37,"./utils/checkChildren":27,"./utils/nodeTypes":28,"./utils/patchChildren":29}],26:[function(require,module,exports){
'use strict';
...
},{"../../client/patchOps":12}],30:[function(require,module,exports){
"use strict";
