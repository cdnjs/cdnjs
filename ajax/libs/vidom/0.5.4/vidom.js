...
var Input = createComponent({
        ...
        this.onChange = function (e) {
            ...
            if (_this.isMounted()) {
                var _getAttrs4 = _this.getAttrs(),
                    name = _getAttrs4.name,
                    type = _getAttrs4.type,
                    checked = _getAttrs4.checked; // attrs could be changed during applyBatch()
    ...
    onUnmount: function () {
        var _getAttrs5 = this.getAttrs(),
            type = _getAttrs5.type,
            name = _getAttrs5.name;
...
var Textarea = createComponent({
    onInit: function () {
        ...
        this.onInput = function (e) {
            ...
            if (_this.isMounted()) {
                var control = _this.getDomRef('control'),
                    _getAttrs = _this.getAttrs(),
                    value = _getAttrs.value; // attrs could be changed during applyBatch()
