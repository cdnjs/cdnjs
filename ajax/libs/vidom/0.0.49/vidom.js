...
},{"../utils/dasherize":22,"../utils/escapeAttr":23,"../utils/isInArray":25}],4:[function(require,module,exports){
"use strict";
...
function patchComponent(attrs, children, parentNode) {
    ...
    if (this.isMounted()) {
        var shouldUpdate = this.shouldUpdate(this.getAttrs(), prevAttrs || emptyAttrs);
...
},{"./client/rafBatch":13,"./createNode":17,"./utils/console":21,"./utils/noOp":26}],17:[function(require,module,exports){
'use strict';
    ...
    _createClass(ComponentNode, [{
        ...
        value: function patch(node, parentNode) {
            if (this.type !== node.type || this._component !== node._component) {
                _clientPatchOps2['default'].replace(this._parentNode, this, parentNode);
                return;
            }
            ...
            if (attrs) {
                ...
                for (_name2 in attrs) {
                    ...
                    if (value != null) {
                        ...
                        if (!_clientEventsAttrsToEvents2['default'][_name2] && (attrHtml = (0, _clientDomAttrsMutators2['default'])(_name2).toString(_name2, value))) {
                            res += ' ' + attrHtml;
                        }
                    }
                }
...
},{"../client/browsers":2,"../client/domAttrsMutators":3,"../client/events/attrsToEvents":6,"../client/events/domEventManager":7,"../client/patchOps":12,"../client/utils/createElement":14,"../client/utils/createElementByHtml":15,"../utils/console":21,"../utils/escapeHtml":24,"../utils/isInArray":25}],20:[function(require,module,exports){
"use strict";
...
},{"./noOp":26}],22:[function(require,module,exports){
'use strict';
...
},{"./Component":1,"./client/mounter":11,"./createComponent":16,"./createNode":17,"./renderToString":20,"./utils/console":21}]},{},[27])(27)
});