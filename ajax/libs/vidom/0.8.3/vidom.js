...
FunctionComponentNode.prototype = {
    ...
    _getRootNode: function () {
        ...
        var rootNode = this._component(this.attrs || obj, this.children, this._ctx) || createNode('!');
...
function buildComponentAttrs(attrs) {
    ...
    var defaultAttrs = this.constructor.defaultAttrs,
        resAttrs = attrs ? defaultAttrs ? merge(defaultAttrs, attrs) : attrs : defaultAttrs || obj;
