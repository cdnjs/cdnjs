(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts'), require('echarts/core'), require('vue')) :
    typeof define === 'function' && define.amd ? define(['echarts', 'echarts/core', 'vue'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.VueECharts = factory(global.echarts, global.echarts, global.Vue));
}(this, (function (echarts, core, vue) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function useAutoresize(chart, autoresize, root, option) {
        ...
        vue.watch([root, chart, autoresize], function (_a, _, cleanup) {
    ...
    function useLoading(chart, loading, loadingOptions) {
        var defaultLoadingOptions = vue.inject(LOADING_OPTIONS_KEY, {});
        var realLoadingOptions = vue.computed(function () { return (__assign(__assign({}, vue.unref(defaultLoadingOptions)), loadingOptions === null || loadingOptions === void 0 ? void 0 : loadingOptions.value)); });
    ...
    var ECharts = vue.defineComponent({
        ...
        setup: function (props, _a) {
            var attrs = _a.attrs;
            var root = vue.ref();
            var chart = vue.shallowRef();
            var manualOption = vue.shallowRef();
            var defaultTheme = vue.inject(THEME_KEY, null);
            var defaultInitOptions = vue.inject(INIT_OPTIONS_KEY, null);
            var defaultUpdateOptions = vue.inject(UPDATE_OPTIONS_KEY, null);
            var realOption = vue.computed(function () { return manualOption.value || props.option || Object.create(null); });
            var realTheme = vue.computed(function () { return props.theme || vue.unref(defaultTheme) || {}; });
            var realInitOptions = vue.computed(function () { return props.initOptions || vue.unref(defaultInitOptions) || {}; });
            var realUpdateOptions = vue.computed(function () { return props.updateOptions || vue.unref(defaultUpdateOptions) || {}; });
            var _b = vue.toRefs(props), autoresize = _b.autoresize, manualUpdate = _b.manualUpdate, loading = _b.loading, loadingOptions = _b.loadingOptions;
            ...
            vue.watch(manualUpdate, function (manualUpdate) {
                if (typeof unwatchOption === "function") {
                    unwatchOption();
                    unwatchOption = null;
                }
                if (!manualUpdate) {
                    unwatchOption = vue.watch(function () { return props.option; }, function (option) {
                        if (!option) {
                            return;
                        }
                        if (!chart.value) {
            ...
            vue.watch([function () { return props.theme; }, function () { return props.initOptions; }], function () {
                cleanup();
                init();
            }, {
                deep: true
            ...
            Object.defineProperty(exposed, "chart", {
                get: function () {
                    return vue.unref(chart);
                }
            });
            return exposed;
        },
        render: function () {
            return vue.h("div", { class: "echarts", ref: "root" });
        }
    });
