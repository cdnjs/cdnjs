(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('echarts'), require('vue-demi'), require('echarts/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'echarts', 'vue-demi', 'echarts/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueECharts = {}, global.echarts, global.VueDemi, global.echarts));
}(this, (function (exports, echarts, vueDemi, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var css_248z$1 = ".echarts{width:100%;height:100%}";
    ...
    var ECharts = vueDemi.defineComponent({
        ...
        render: function () {
            return vueDemi.h("div", { class: "echarts", ref: "root" });
        }
    });
