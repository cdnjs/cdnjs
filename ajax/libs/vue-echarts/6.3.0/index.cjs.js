...
function unwrapInjected(injection, defaultValue) {
    var value = vueDemi.unref(injection);
...
var css = "x-vue-echarts{display:block;width:100%;height:100%;overflow:hidden}\n";
n(css,{});
...
var ECharts = vueDemi.defineComponent({
    ...
    render: function () {
        var attrs = (vueDemi.Vue2 ? { attrs: this.nonEventAttrs } : __assign({}, this.nonEventAttrs));
        attrs.ref = "root";
