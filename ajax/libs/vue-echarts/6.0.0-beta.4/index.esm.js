import { watch, inject, computed, unref, watchEffect, defineComponent, ref, shallowRef, toRefs, toRef, onMounted, onUnmounted, h, mergeProps, Vue2 } from 'vue-demi';
...
function filterObjectValue(source, predicate) {
    var target = {};
...
var ECharts = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var nonEventAttrs = computed(function () {
            return filterObjectValue(attrs, function (value) { return typeof value !== "function"; });
        });
    ...
    render: function () {
        return h(TAG_NAME, mergeProps({ class: "echarts", ref: "root" }, this.nonEventAttrs));
    }
});
