...
export var Snackbar = function Snackbar(_ref) {
  ...
  return /*#__PURE__*/React.createElement(AppRootPortal, null, /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    className: classNamesString("vkuiSnackbar", platform === Platform.IOS && "vkuiSnackbar--ios", styles["Snackbar--layout-".concat(layout)], styles["Snackbar--mode-".concat(mode)], closing && "vkuiSnackbar--closing", touched && "vkuiSnackbar--touched", isDesktop && "vkuiSnackbar--desktop", className)
