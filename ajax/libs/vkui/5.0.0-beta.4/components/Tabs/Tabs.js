...
export var Tabs = function Tabs(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    ref: getRootRef,
    className: classNamesString("vkuiTabs", platform === Platform.VKCOM && styles["Tabs--".concat(platform)], getSizeXClassName("vkuiTabs", sizeX), withGaps && "vkuiTabs--withGaps", styles["Tabs--mode-".concat(mode)], className),
    role: role
