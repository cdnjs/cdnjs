...
var RemovableIos = function RemovableIos(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classNamesString("vkuiRemovable__action", "vkuiRemovable__toggle"),
...
export var Removable = function Removable(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    ref: ref,
    className: classNamesString("vkuiRemovable", platform === Platform.IOS && "vkuiRemovable--ios", styles["Removable--align-".concat(align)], getSizeYClassName("vkuiRemovable", sizeY), className)
