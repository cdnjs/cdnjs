...
var _excluded = ["defaultValue", "grow", "style", "onResize", "className", "getRootRef", "getRef", "rows", "maxHeight", "status"];
...
export var Textarea = function Textarea(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, {
    className: classNamesString("vkuiTextarea", getSizeYClassName("vkuiTextarea", sizeY), className),
    style: style,
