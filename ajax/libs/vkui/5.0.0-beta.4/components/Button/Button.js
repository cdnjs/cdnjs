...
export var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({
    ...
    className: classNamesString(className, "vkuiButton", styles["Button--size-".concat(size)], styles["Button--mode-".concat(mode)], styles["Button--appearance-".concat(appearance)], styles["Button--align-".concat(align)], getSizeYClassName("vkuiButton", sizeY), platform === Platform.ANDROID && "vkuiButton--android", platform === Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
