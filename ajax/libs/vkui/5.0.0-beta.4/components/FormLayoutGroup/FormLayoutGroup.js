...
export var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ref: rootEl,
    className: classNamesString("vkuiFormLayoutGroup", getSizeYClassName("vkuiFormLayoutGroup", sizeY), styles["FormLayoutGroup--mode-".concat(mode)], isRemovable && "vkuiFormLayoutGroup--removable", isSegmented && "vkuiFormLayoutGroup--segmented", className)
