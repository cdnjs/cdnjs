...
var Input = function Input(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_FormField.FormField, {
    style: style,
    className: (0, _classNames.classNamesString)("vkuiInput", align && styles["Input--align-".concat(align)], (0, _getSizeYClassName.getSizeYClassName)("vkuiInput", sizeY), before && "vkuiInput--hasBefore", after && "vkuiInput--hasAfter", className),
