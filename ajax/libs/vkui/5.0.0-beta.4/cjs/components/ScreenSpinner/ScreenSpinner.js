...
var ScreenSpinner = function ScreenSpinner(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_PopoutWrapper.PopoutWrapper, {
    hasMask: false,
    className: (0, _classNames.classNamesString)("vkuiScreenSpinner", hideSpinner && "vkuiScreenSpinner--hideSpinner", styles["ScreenSpinner--state-".concat(state)], className),
    style: style
