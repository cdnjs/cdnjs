...
var ModalPageHeader = function ModalPageHeader(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _classNames.classNamesString)("vkuiModalPageHeader", (0, _getPlatformClassName.getPlatformClassName)("vkuiModalPageHeader", platform), platform !== _platform.Platform.VKCOM && "vkuiModalPageHeader--withGaps", isDesktop && "vkuiModalPageHeader--desktop"),
    ref: getRef
  }, /*#__PURE__*/React.createElement(_PanelHeader.PanelHeader, (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiModalPageHeader__in", className)
  }, restProps, {
    fixed: false,
    separator: false,
    transparent: true
