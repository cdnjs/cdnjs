...
export var HorizontalScrollArrow = function HorizontalScrollArrow(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    ...
    hasHover: false,
    hasActive: false,
    className: classNamesString("vkuiHorizontalScrollArrow", styles["HorizontalScrollArrow--size-".concat(size)], styles["HorizontalScrollArrow--direction-".concat(direction)], className),
    onClick: onClick
