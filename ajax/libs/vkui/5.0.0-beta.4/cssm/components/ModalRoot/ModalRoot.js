  ...
  _createClass(ModalRootTouchComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(TouchRootContext.Provider, {
        ...
        className: classNamesString("vkuiModalRoot", ((_this$props$configPro = this.props.configProvider) === null || _this$props$configPro === void 0 ? void 0 : _this$props$configPro.webviewType) === WebviewType.VKAPPS && "vkuiModalRoot--vkapps", touchDown && "vkuiModalRoot--touched", !!(enteringModal || exitingModal) && "vkuiModalRoot--switching"),
        ...
        return /*#__PURE__*/React.createElement(FocusTrap, {
          ...
          className: classNamesString("vkuiModalRoot__modal", modalId === activeModal && "vkuiModalRoot__modal--active", modalId === exitingModal && "vkuiModalRoot__modal--prev", (exitingModal && modalId === activeModal || modalId === enteringModal) && "vkuiModalRoot__modal--next", dragging && "vkuiModalRoot__modal--dragging", isPage && modalState.expandable && "vkuiModalRoot__modal--expandable", isPage && modalState.expanded && "vkuiModalRoot__modal--expanded", isPage && modalState.collapsed && "vkuiModalRoot__modal--collapsed"),
          restoreFocus: false
        }, Modal);
      })))));
    }
