...
import "./ScreenSpinner.module.css";
/**
...
export var ScreenSpinner = function ScreenSpinner(_ref) {
  ...
  return /*#__PURE__*/React.createElement(PopoutWrapper, {
    hasMask: false,
    className: classNamesString("vkuiScreenSpinner", hideSpinner && "vkuiScreenSpinner--hideSpinner", styles["ScreenSpinner--state-".concat(state)], className),
    style: style
