...
export var PanelHeaderContent = function PanelHeaderContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, rootProps, {
    style: style,
    className: classNamesString("vkuiPanelHeaderContent", getPlatformClassName("vkuiPanelHeaderContent", platform), className)
    ...
    className: classNamesString("vkuiPanelHeaderContent__in", !before && platform !== Platform.ANDROID && "vkuiPanelHeaderContent__in--centered")
