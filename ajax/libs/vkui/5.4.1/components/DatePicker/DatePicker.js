...
var DatePickerCustom = function(_param) {
    var name = _param.name, _param_min = _param.min, min = _param_min === void 0 ? {
        ...
        month: 12,
        year: 2100
    } : _param_max, dayPlaceholder = _param.dayPlaceholder, monthPlaceholder = _param.monthPlaceholder, yearPlaceholder = _param.yearPlaceholder, popupDirection = _param.popupDirection, defaultValue = _param.defaultValue, monthNames = _param.monthNames, _param_day = _param.day, day = _param_day === void 0 ? 0 : _param_day, _param_month = _param.month, month = _param_month === void 0 ? 0 : _param_month, _param_year = _param.year, year = _param_year === void 0 ? 0 : _param_year, onDateChange = _param.onDateChange, disabled = _param.disabled, className = _param.className, restProps = _object_without_properties(_param, [
        "name",
        "min",
        "max",
        "dayPlaceholder",
