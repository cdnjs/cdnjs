...
function PathElement(_param) {
    var photoSize = _param.photoSize, direction = _param.direction, props = _objectWithoutProperties(_param, [
        "photoSize",
        "direction"
    ]);
    switch(direction){
        case "circle":
            ...
            return /*#__PURE__*/ _react.createElement("circle", _objectSpread({
                cx: radius,
                cy: radius,
                r: radius
            }, props));
        case "right":
            switch(photoSize){
                case 24:
                    return /*#__PURE__*/ _react.createElement("path", _objectSpread({
...
var UsersStack = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, restProps), {
        className: (0, _vkjs.classNames)("vkuiInternalUsersStack", "vkuiUsersStack", {
