...
var FocusTrap = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(null), 2), focusableNodes = _React_useState[0], setFocusableNodes = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(null), 2), restoreFocusTo = _React_useState1[0], setRestoreFocusTo = _React_useState1[1];
    // HANDLE TRAP MOUNT
    ...
    return /*#__PURE__*/ _react.createElement(Component, _objectSpread({
        tabIndex: -1,
        ref: ref
    }, restProps), children);
};
