...
var Tappable = function Tappable(_ref) {
  ...
  function onStart(_ref2) {
    ...
    if (hasActive) {
      ...
      if (platform === _platform.ANDROID) {
        ...
        var x = (0, _touch.coordX)(originalEvent) - left;
        var y = (0, _touch.coordY)(originalEvent) - top;
  ...
  }), !props.disabled && (0, _jsxRuntime.createScopedElement)(_FocusVisible.FocusVisible, {
