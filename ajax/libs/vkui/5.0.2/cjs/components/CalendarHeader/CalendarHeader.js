...
var CalendarHeader = function CalendarHeader(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _classNames.classNamesString)("vkuiCalendarHeader", className)
    ...
    className: (0, _classNames.classNamesString)("vkuiCalendarHeader__nav-icon", "vkuiCalendarHeader__nav-icon-prev", prevMonthClassName),
    onClick: onPrevMonth,
    ...
    className: (0, _classNames.classNamesString)("vkuiCalendarHeader__nav-icon", "vkuiCalendarHeader__nav-icon-next", nextMonthClassName),
    onClick: onNextMonth,
