...
var ViewInfiniteComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function ViewInfiniteComponent(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMoveX", function (e) {
      ...
      if (platform === _platform.Platform.IOS && !(configProvider !== null && configProvider !== void 0 && configProvider.isWebView) && (e.startX <= 70 || e.startX >= _this.window.innerWidth - 70) && !_this.state.browserSwipe) {
        _this.setState({
          browserSwipe: true
        });
      }
      if (platform === _platform.Platform.IOS && configProvider !== null && configProvider !== void 0 && configProvider.isWebView && _this.props.onSwipeBack) {
  ...
  (0, _createClass2.default)(ViewInfiniteComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_Touch.Touch, (0, _extends2.default)({
        ...
        className: (0, _classNames.classNamesString)("vkuiView", (0, _getPlatformClassName.getPlatformClassName)("vkuiView", platform), !disableAnimation && this.state.animated && "vkuiView--animated", !disableAnimation && this.state.swipingBack && "vkuiView--swiping-back", disableAnimation && "vkuiView--no-motion", className),
