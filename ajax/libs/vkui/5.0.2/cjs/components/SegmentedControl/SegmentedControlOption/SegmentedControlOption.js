...
var SegmentedControlOption = function SegmentedControlOption(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: (0, _classNames.classNamesString)("vkuiSegmentedControlOption", restProps.checked && "vkuiSegmentedControlOption--checked", focusVisible && "vkuiSegmentedControlOption--focus-visible", className),
    style: style
    ...
    className: (0, _classNames.classNamesString)("vkuiSegmentedControlOption__content", (0, _getSizeYClassName.getSizeYClassName)("vkuiSegmentedControlOption__content", sizeY))
