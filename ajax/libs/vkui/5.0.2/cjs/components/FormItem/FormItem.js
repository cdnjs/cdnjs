...
var FormItem = function FormItem(_ref) {
  ...
  var wrappedChildren = /*#__PURE__*/React.createElement(React.Fragment, null, (0, _utils.hasReactNode)(top) && /*#__PURE__*/React.createElement(_Subhead.Subhead, {
    className: "vkuiFormItem__top"
  }, top), children, (0, _utils.hasReactNode)(bottom) && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
    className: "vkuiFormItem__bottom"
  }, bottom));
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({}, restProps, {
    ref: rootEl,
    className: (0, _classNames.classNamesString)("vkuiFormItem", status !== "default" && styles["FormItem--status-".concat(status)], (0, _getSizeYClassName.getSizeYClassName)("vkuiFormItem", sizeY), (0, _utils.hasReactNode)(top) && "vkuiFormItem--withTop", removable && "vkuiFormItem--removable", className)
