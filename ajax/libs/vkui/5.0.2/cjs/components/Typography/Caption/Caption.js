...
var Caption = function Caption(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)(className, "vkuiCaption", styles["Caption--level-".concat(level)], caps && "vkuiCaption--caps", weight && styles["Caption--weight-".concat(weight)])
  }), children);
};
