...
var Text = function Text(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({}, restProps, {
    ref: getRootRef,
    className: (0, _classNames.classNamesString)(className, "vkuiText", (0, _getSizeYClassName.getSizeYClassName)("vkuiText", sizeY), weight && styles["Text--weight-".concat(weight)])
  }), children);
};
exports.Text = Text;
var styles = {
