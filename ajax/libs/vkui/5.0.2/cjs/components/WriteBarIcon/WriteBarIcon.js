...
var WriteBarIcon = function WriteBarIcon(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({
    ...
    className: (0, _classNames.classNamesString)("vkuiWriteBarIcon", platform === _platform.Platform.IOS && "vkuiWriteBarIcon--ios", mode && styles["WriteBarIcon--mode-".concat(mode)], className)
  }), /*#__PURE__*/React.createElement("span", {
    className: "vkuiWriteBarIcon__in"
  }, icon || children), (0, _utils.hasReactNode)(count) && /*#__PURE__*/React.createElement(_Counter.Counter, {
