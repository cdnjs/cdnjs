...
var Group = function Group(_ref) {
  ...
  var separatorClassName = (0, _classNames.classNamesString)("vkuiGroup__separator", separator === "show" && "vkuiGroup__separator--force");
  return /*#__PURE__*/React.createElement("section", (0, _extends2.default)({}, restProps, {
    tabIndex: tabIndex,
    ref: getRootRef,
    className: (0, _classNames.classNamesString)("vkuiGroup", platform === _platform.Platform.IOS && "vkuiGroup--ios", (0, _getSizeXClassName.getSizeXClassName)("vkuiGroup", sizeX), mode && styles["Group--mode-".concat(mode)], styles["Group--padding-".concat(padding)], className)
  }), /*#__PURE__*/React.createElement("div", {
    className: "vkuiGroup__inner"
  }, header, children, (0, _utils.hasReactNode)(description) && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
    ...
    className: (0, _classNames.classNamesString)(separatorClassName, "vkuiGroup__separator--spacing"),
    size: 16
  }), /*#__PURE__*/React.createElement(_Separator.Separator, {
    className: (0, _classNames.classNamesString)(separatorClassName, "vkuiGroup__separator--separator")
  })));
};
exports.Group = Group;
var styles = {
