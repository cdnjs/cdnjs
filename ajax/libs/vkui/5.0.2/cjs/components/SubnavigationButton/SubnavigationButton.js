...
var SubnavigationButton = function SubnavigationButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    ...
    className: (0, _classNames.classNamesString)("vkuiSubnavigationButton", styles["SubnavigationButton--size-".concat(size)], styles["SubnavigationButton--mode-".concat(mode)], selected && "vkuiSubnavigationButton--selected", (0, _getSizeYClassName.getSizeYClassName)("vkuiSubnavigationButton", sizeY), className),
