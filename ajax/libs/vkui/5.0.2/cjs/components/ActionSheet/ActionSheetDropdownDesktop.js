...
var ActionSheetDropdownDesktop = function ActionSheetDropdownDesktop(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Popper.Popper, {
    ...
    className: (0, _classNames.classNamesString)("vkuiActionSheet", platform === _platform.Platform.IOS && "vkuiActionSheet--ios", "vkuiActionSheet--desktop", (0, _getSizeYClassName.getSizeYClassName)("vkuiActionSheet", sizeY), className),
    style: style,
    getRef: elementRef,
    forcePortal: false
