...
export var PanelHeaderContext = function PanelHeaderContext(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FixedLayout, _extends({}, restProps, {
    className: classNamesString("vkuiPanelHeaderContext", platform === Platform.IOS && "vkuiPanelHeaderContext--ios", opened && "vkuiPanelHeaderContext--opened", closing && "vkuiPanelHeaderContext--closing", getSizeXClassName("vkuiPanelHeaderContext", sizeX), "vkuiPanelHeaderContext--rounded", className),
    vertical: "top"
