...
export var ModalPageHeader = function ModalPageHeader(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiModalPageHeader", getPlatformClassName("vkuiModalPageHeader", platform), platform !== Platform.VKCOM && "vkuiModalPageHeader--withGaps", isDesktop && "vkuiModalPageHeader--desktop"),
    ref: getRef
  }, /*#__PURE__*/React.createElement(PanelHeader, _extends({
    className: classNamesString("vkuiModalPageHeader__in", className)
  }, restProps, {
    fixed: false,
    separator: false,
    transparent: true
