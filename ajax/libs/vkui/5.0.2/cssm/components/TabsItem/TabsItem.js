...
export var TabsItem = function TabsItem(_ref) {
  ...
  if (status) {
    statusComponent = typeof status === "number" ? /*#__PURE__*/React.createElement(Subhead, {
      Component: "span",
      className: classNamesString("vkuiTabsItem__status", "vkuiTabsItem__status--count"),
      weight: "2"
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    className: classNamesString("vkuiTabsItem", mode && styles["TabsItem--mode-".concat(mode)], selected && "vkuiTabsItem--selected", getSizeYClassName("vkuiTabsItem", sizeY), withGaps && "vkuiTabsItem--withGaps", className),
