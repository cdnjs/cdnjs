...
const CustomSelectOption = (_param)=>{
    var { children, hierarchy = 0, hovered, selected, before, after, description, disabled, style: styleProp, className, onClick } = _param, restProps = _object_without_properties._(_param, [
        "children",
        "hierarchy",
        "hovered",
        "selected",
    ...
    return /*#__PURE__*/ _react.createElement(_Paragraph.Paragraph, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        className: (0, _vkjs.classNames)("vkuiCustomSelectOption", sizeY !== 'compact' && sizeYClassNames[sizeY], hovered && !disabled && "vkuiCustomSelectOption--hover", disabled && "vkuiCustomSelectOption--disabled", hierarchy > 0 && "vkuiCustomSelectOption--hierarchy", className),
        style: style
