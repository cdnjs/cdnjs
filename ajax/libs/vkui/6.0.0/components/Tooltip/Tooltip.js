...
import { getArrowCoordsByMiddlewareData, useFloatingMiddlewaresBootstrap, useFloatingWithInteractions } from '../../lib/floating';
 ...
 */ export const Tooltip = (_param)=>{
    ...
    id: idProp, getRootRef, text, header, appearance = 'neutral', style: styleProp, className, zIndex = 'var(--vkui--z_index_popout)' } = _param, popperProps = _object_without_properties(_param, [
        "placement",
        "arrowPadding",
        "arrowHeight",
        "offsetByMainAxis",
