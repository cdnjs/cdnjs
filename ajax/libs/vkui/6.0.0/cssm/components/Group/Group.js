 ...
 */ export const Group = ({ header, description, children, separator = 'auto', mode: modeProps, padding = 'm', tabIndex: tabIndexProp, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(RootComponent, {
        ...
        ...restProps,
        tabIndex: tabIndex,
        baseClassName: classNames('vkuiInternalGroup', styles['Group'], isInsideModal && styles['Group--inside-modal'], platform === 'ios' && styles['Group--ios'], sizeX !== 'regular' && sizeXClassNames[sizeX], mode && stylesMode[mode], stylesPadding[padding])
