...
import { useFloatingMiddlewaresBootstrap, useFloatingWithInteractions } from '../../lib/floating';
...
placement: expectedPlacement = 'bottom-start', trigger = 'click', content, hoverDelay = 150, closeAfterClick, offsetByMainAxis = 8, offsetByCrossAxis = 0, sameWidth, hideWhenReferenceHidden, disabled, disableInteractive, disableCloseOnClickOutside, disableCloseOnEscKey, // uncontrolled
