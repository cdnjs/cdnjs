 ...
 */ export const Chip = ({ Component = 'span', value = '', removable = true, onRemove = noop, removeLabel = 'Удалить', before, after, disabled, children, className, onFocus: onFocusProp, onBlur: onBlurProp, ...restProps })=>{
