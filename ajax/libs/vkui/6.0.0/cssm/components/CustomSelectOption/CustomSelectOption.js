 ...
 */ export const CustomSelectOption = ({ children, hierarchy = 0, hovered, selected, before, after, description, disabled, style: styleProp, className, onClick, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Paragraph, {
        ...
        className: classNames(styles['CustomSelectOption'], sizeY !== 'compact' && sizeYClassNames[sizeY], hovered && !disabled && styles['CustomSelectOption--hover'], disabled && styles['CustomSelectOption--disabled'], hierarchy > 0 && styles['CustomSelectOption--hierarchy'], className),
        style: style
