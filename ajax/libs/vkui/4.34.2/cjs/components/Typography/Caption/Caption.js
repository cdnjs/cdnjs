...
var warn = (0, _warnOnce.warnOnce)("Caption");
/**
...
var Caption = function Caption(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(Component, (0, _extends2.default)({}, restProps, {
    vkuiClass: (0, _classNames.classNames)("Caption", "Caption--l-".concat(level), caps && "Caption--caps", weight && "Caption--w-".concat(weight))
  }), children);
};
