...
export var VIEW_WIDTH_TO_CSS_BREAKPOINT_MAP = (_VIEW_WIDTH_TO_CSS_BR = {}, _defineProperty(_VIEW_WIDTH_TO_CSS_BR, ViewWidth.SMALL_MOBILE, 'smallMobileMinus'), _defineProperty(_VIEW_WIDTH_TO_CSS_BR, ViewWidth.MOBILE, 'mobile'), _defineProperty(_VIEW_WIDTH_TO_CSS_BR, ViewWidth.SMALL_TABLET, 'smallTablet'), _defineProperty(_VIEW_WIDTH_TO_CSS_BR, ViewWidth.TABLET, 'tablet'), _defineProperty(_VIEW_WIDTH_TO_CSS_BR, ViewWidth.DESKTOP, 'desktopPlus'), _VIEW_WIDTH_TO_CSS_BR);
