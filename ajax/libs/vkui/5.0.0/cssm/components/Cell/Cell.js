...
export var Cell = function Cell(_ref) {
  ...
  var cellClasses = classNames("Cell", platform === Platform.IOS && "Cell--ios", dragging && "Cell--dragging", removable && "Cell--removable", selectable && "Cell--selectable", disabled && "Cell--disabled");
  var simpleCell = createScopedElement(SimpleCell, _extends({
    ...
    before: createScopedElement(React.Fragment, null, draggable && platform !== Platform.IOS && dragger, selectable && checkbox, before),
    after: createScopedElement(React.Fragment, null, draggable && platform === Platform.IOS && dragger, after)
  }));
