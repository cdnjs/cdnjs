...
var BADGE_ONLINE = {
  className: classNamesString(styles["Avatar__badge"], styles["Avatar__badge--online"]),
  background: "stroke",
  Icon: Icon12Circle
};
var BADGE_ONLINE_MOBILE = {
  className: classNamesString(styles["Avatar__badge"], styles["Avatar__badge--online-mobile"]),
  background: "stroke",
  ...
  switch (badgeProp) {
    ...
    default:
      badge = _objectSpread(_objectSpread({}, typeof badgeProp === "function" ? {
        ...
        className: classNamesString(styles["Avatar__badge"], size < 96 && styles["Avatar__badge--shifted"])
      });
  }

  return createScopedElement(ImageBase, _extends({}, restProps, {
    size: size,
    badge: badge,
    className: classNamesString(styles["Avatar"], gradientName && styles["Avatar--has-gradient"], gradientName !== "custom" && styles["Avatar--gradient-".concat(gradientName)], className),
