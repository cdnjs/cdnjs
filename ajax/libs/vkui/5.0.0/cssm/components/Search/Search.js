...
var SearchComponent = function SearchComponent(_ref2) {
  ...
  return createScopedElement("div", {
    vkuiClass: classNames("Search", platform === Platform.IOS && "Search--ios", getSizeYClassName("Search", sizeY), isFocused && "Search--focused", value && "Search--has-value", icon && "Search--has-after", after && "Search--has-icon"),
    className: className,
    style: style
    ...
    onChange: onChange,
    value: value
  })), platform === Platform.IOS && after && createScopedElement("div", {
    ...
    platform: platform
  }, placeholder)), isFocused && platform === Platform.IOS && after && createScopedElement("div", {
    vkuiClass: "Search__after-width"
  }, after))), createScopedElement("div", {
    ...
    vkuiClass: "Search__icon"
  }, platform === Platform.IOS ? createScopedElement(Icon16Clear, null) : createScopedElement(Icon24Cancel, null))), platform === Platform.IOS && after && createScopedElement("div", {
