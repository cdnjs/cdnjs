...
var _excluded = ["min", "max", "step", "value", "defaultValue", "onChange", "getRootRef", "disabled"];
...
export var UniversalSlider = function UniversalSlider(_ref) {
  ...
  return createScopedElement(Touch, _extends({
    ...
    vkuiClass: classNames("Slider", getSizeYClassName("Slider", sizeY), disabled && "Slider--disabled")
