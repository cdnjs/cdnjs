...
export var SubnavigationButton = function SubnavigationButton(_ref2) {
  ...
  return createScopedElement(Tappable, _extends({}, restProps, {
    ...
    vkuiClass: classNames("SubnavigationButton", "SubnavigationButton--size-".concat(size), "SubnavigationButton--mode-".concat(mode), selected && "SubnavigationButton--selected", "SubnavigationButton--sizeY-".concat(sizeY)),
