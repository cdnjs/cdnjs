...
export var PopoutWrapper = function PopoutWrapper(_ref) {
  ...
  return createScopedElement("div", _extends({}, restProps, {
    vkuiClass: classNames("PopoutWrapper", "PopoutWrapper--alignY-".concat(alignY), "PopoutWrapper--alignX-".concat(alignX), closing && "PopoutWrapper--closing", opened && "PopoutWrapper--opened", fixed && "PopoutWrapper--fixed", hasMask && "PopoutWrapper--masked"),
