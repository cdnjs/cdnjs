...
var AlertText = function AlertText(props) {
  ...
  switch (platform) {
    case Platform.VKCOM:
      return createScopedElement(Footnote, _extends({
...
var AlertAction = function AlertAction(_ref) {
  ...
  if (platform === Platform.IOS) {
    ...
    return createScopedElement(Tappable, _extends({
      ...
      vkuiClass: classNames("Alert__action", "Alert__action--mode-".concat(action.mode)),
  ...
  return createScopedElement(Button, {
    vkuiClass: classNames("Alert__button", "Alert__button--mode-".concat(action.mode)),
    mode: mode,
    size: "m",
    onClick: handleItemClick,
...
export var Alert = function Alert(_ref2) {
  ...
  return createScopedElement(PopoutWrapper, {
    ...
    onClose: close,
    timeout: timeout,
    vkuiClass: classNames("Alert", platform === Platform.IOS && "Alert--ios", platform === Platform.VKCOM && "Alert--vkcom", resolvedActionsLayout === "vertical" ? "Alert--v" : "Alert--h", closing && "Alert--closing", isDesktop && "Alert--desktop"),
    role: "alertdialog",
    "aria-modal": true,
  ...
  })), isDesktop && createScopedElement(ModalDismissButton, {
    onClick: close,
