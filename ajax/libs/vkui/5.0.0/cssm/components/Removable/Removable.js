...
export var Removable = function Removable(_ref2) {
  ...
  return createScopedElement("div", _extends({}, restProps, {
    ref: ref,
    vkuiClass: classNames("Removable", platform === Platform.IOS && "Removable--ios", "Removable--align-".concat(align), getSizeYClassName("Removable", sizeY))
    ...
    vkuiClass: "Removable__offset",
    "aria-hidden": true
  })), platform === Platform.IOS && createScopedElement(RemovableIos, {
