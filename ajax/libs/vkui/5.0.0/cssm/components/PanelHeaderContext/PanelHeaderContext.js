...
export var PanelHeaderContext = function PanelHeaderContext(_ref) {
  ...
  return createScopedElement(FixedLayout, _extends({}, restProps, {
    vkuiClass: classNames("PanelHeaderContext", platform === Platform.IOS && "PanelHeaderContext--ios", opened && "PanelHeaderContext--opened", closing && "PanelHeaderContext--closing", getSizeXClassName("PanelHeaderContext", sizeX), "PanelHeaderContext--rounded"),
    vertical: "top"
  ...
  }, visible && children)), visible && createScopedElement("div", {
