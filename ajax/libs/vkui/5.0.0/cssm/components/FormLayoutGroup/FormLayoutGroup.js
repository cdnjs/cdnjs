...
export var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return createScopedElement("div", _extends({
    ref: rootEl,
    vkuiClass: classNames("FormLayoutGroup", getSizeYClassName("FormLayoutGroup", sizeY), "FormLayoutGroup--mode-".concat(mode), isRemovable && "FormLayoutGroup--removable", isSegmented && "FormLayoutGroup--segmented")
