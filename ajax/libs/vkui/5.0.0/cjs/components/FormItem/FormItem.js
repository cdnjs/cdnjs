...
var FormItem = function FormItem(_ref) {
  ...
  }, top), children, (0, _utils.hasReactNode)(bottom) && (0, _jsxRuntime.createScopedElement)(_Footnote.Footnote, {
    vkuiClass: "FormItem__bottom"
  }, bottom));
  return (0, _jsxRuntime.createScopedElement)(Component, (0, _extends2.default)({}, restProps, {
    ref: rootEl,
    vkuiClass: (0, _classNames.classNames)("FormItem", "FormItem--status-".concat(status), (0, _getSizeYClassName.getSizeYClassName)("FormItem", sizeY), (0, _utils.hasReactNode)(top) && "FormItem--withTop", removable && "FormItem--removable")
