...
var _excluded = ["children", "layout", "action", "before", "after", "duration", "onActionClick", "onClose", "mode"];
...
var Snackbar = function Snackbar(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_AppRootPortal.AppRootPortal, null, (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({}, restProps, {
    vkuiClass: (0, _classNames.classNames)("Snackbar", platform === _platform.Platform.IOS && "Snackbar--ios", "Snackbar--layout-".concat(layout), "Snackbar--mode-".concat(mode), closing && "Snackbar--closing", touched && "Snackbar--touched", isDesktop && "Snackbar--desktop")
