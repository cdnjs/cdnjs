...
var FormField = function FormField(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(Component, (0, _extends2.default)({
    ...
    vkuiClass: (0, _classNames.classNames)("FormField", "FormField--mode-".concat(mode), "FormField--status-".concat(status), (0, _getSizeYClassName.getSizeYClassName)("FormField", sizeY), disabled && "FormField--disabled", !disabled && hover && "FormField--hover")
