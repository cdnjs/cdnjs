    ...
    switch (page) {
      ...
      case "end-ellipsis":
        return (0, _jsxRuntime.createScopedElement)("li", {
          ...
          vkuiClass: (0, _classNames.classNames)("Pagination__page", "Pagination__page--type-ellipsis", (0, _getSizeYClassName.getSizeYClassName)("Pagination__page", sizeY), disabled && "Pagination__page--disabled")
        }, "..."));
      ...
      default:
        {
          ...
          return (0, _jsxRuntime.createScopedElement)("li", {
            ...
            vkuiClass: (0, _classNames.classNames)("Pagination__page", (0, _getSizeYClassName.getSizeYClassName)("Pagination__page", sizeY), _isCurrent && "Pagination__page--current", disabled && "Pagination__page--disabled"),
