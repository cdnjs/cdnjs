...
var _excluded = ["activePanel", "history", "nav", "onTransition", "onSwipeBack", "onSwipeBackStart", "onSwipeBackCancel", "children"];
...
var View = function View(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Touch.Touch, (0, _extends2.default)({
    ...
    vkuiClass: (0, _classNames.classNames)("View", platform === _platform.Platform.IOS && "View--ios", !disableAnimation && animated && "View--animated", !disableAnimation && swipingBack && "View--swiping-back", disableAnimation && "View--no-motion"),
    onMoveX: onMoveX,
    onEnd: onEnd
