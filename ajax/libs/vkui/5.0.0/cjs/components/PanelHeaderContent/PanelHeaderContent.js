...
var PanelHeaderContent = function PanelHeaderContent(_ref2) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({}, rootProps, {
    vkuiClass: (0, _classNames.classNames)("PanelHeaderContent", (0, _getPlatformClassName.getPlatformClassName)("PanelHeaderContent", platform)),
    style: style,
    className: className
    ...
    vkuiClass: (0, _classNames.classNames)("PanelHeaderContent__in", !before && platform !== _platform.Platform.ANDROID && "PanelHeaderContent__in--centered")
  }), (0, _utils.hasReactNode)(status) && (0, _jsxRuntime.createScopedElement)(_Footnote.Footnote, {
