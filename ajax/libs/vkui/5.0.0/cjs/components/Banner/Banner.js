...
var Banner = function Banner(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("section", (0, _extends2.default)({}, restProps, {
    vkuiClass: (0, _classNames.classNames)("Banner", platform === _platform.Platform.IOS && "Banner--ios", "Banner--mode-".concat(mode), "Banner--size-".concat(size), mode === "image" && imageTheme === "dark" && "Banner--inverted")
    ...
    hoverMode: "opacity",
    hasActive: false
  }, platform === _platform.Platform.IOS ? (0, _jsxRuntime.createScopedElement)(IconDismissIOS, null) : (0, _jsxRuntime.createScopedElement)(_icons.Icon24Cancel, null)))));
};
