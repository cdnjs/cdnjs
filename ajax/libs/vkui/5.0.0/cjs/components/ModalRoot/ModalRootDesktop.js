  ...
  (0, _createClass2.default)(ModalRootDesktopComponent, [{
    ...
    value: function render() {
      ...
      return (0, _jsxRuntime.createScopedElement)(_ModalRootContext.ModalRootContext.Provider, {
        ...
        vkuiClass: (0, _classNames.classNames)("ModalRoot", ((_this$props$configPro = this.props.configProvider) === null || _this$props$configPro === void 0 ? void 0 : _this$props$configPro.webviewType) === _ConfigProviderContext.WebviewType.VKAPPS && "ModalRoot--vkapps", "ModalRoot--desktop")
      }, (0, _jsxRuntime.createScopedElement)("div", {
