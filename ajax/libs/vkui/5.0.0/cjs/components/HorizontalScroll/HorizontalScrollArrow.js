...
var HorizontalScrollArrow = function HorizontalScrollArrow(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    ...
    hasHover: false,
    hasActive: false,
    vkuiClass: (0, _classNames.classNames)("HorizontalScrollArrow", "HorizontalScrollArrow--size-".concat(size), "HorizontalScrollArrow--direction-".concat(direction), platform === _platform.Platform.IOS && "HorizontalScrollArrow--ios"),
    onClick: onClick
