...
var _excluded = ["children", "getScrollToLeft", "getScrollToRight", "showArrows", "arrowSize", "scrollAnimationDuration", "getRef"];
...
var HorizontalScroll = function HorizontalScroll(_ref2) {
  ...
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollLeft && (0, _jsxRuntime.createScopedElement)(_HorizontalScrollArrow.HorizontalScrollArrow, {
    size: arrowSize,
    direction: "left",
    vkuiClass: "HorizontalScroll__arrowLeft",
    onClick: scrollToLeft
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollRight && (0, _jsxRuntime.createScopedElement)(_HorizontalScrollArrow.HorizontalScrollArrow, {
    size: arrowSize,
    direction: "right",
