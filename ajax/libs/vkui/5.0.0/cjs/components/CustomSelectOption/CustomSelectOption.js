...
var CustomSelectOption = function CustomSelectOption(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Paragraph.Paragraph, (0, _extends2.default)({}, restProps, {
    ...
    vkuiClass: (0, _classNames.classNames)("CustomSelectOption", (0, _getSizeYClassName.getSizeYClassName)("CustomSelectOption", sizeY), hovered && !disabled && "CustomSelectOption--hover", selected && "CustomSelectOption--selected", // Note: пустой класс
