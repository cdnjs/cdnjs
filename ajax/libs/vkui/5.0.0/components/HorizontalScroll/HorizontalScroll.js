...
export var HorizontalScroll = function HorizontalScroll(_ref2) {
  ...
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollLeft && createScopedElement(HorizontalScrollArrow, {
    size: arrowSize,
    direction: "left",
    vkuiClass: "HorizontalScroll__arrowLeft",
    onClick: scrollToLeft
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollRight && createScopedElement(HorizontalScrollArrow, {
    size: arrowSize,
    direction: "right",
