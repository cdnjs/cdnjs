...
export var PanelHeaderContent = function PanelHeaderContent(_ref2) {
  ...
  return createScopedElement("div", _extends({}, rootProps, {
    vkuiClass: classNames("PanelHeaderContent", getPlatformClassName("PanelHeaderContent", platform)),
    style: style,
    className: className
    ...
    vkuiClass: classNames("PanelHeaderContent__in", !before && platform !== Platform.ANDROID && "PanelHeaderContent__in--centered")
  }), hasReactNode(status) && createScopedElement(Footnote, {
