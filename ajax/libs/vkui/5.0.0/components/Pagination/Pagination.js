    ...
    switch (page) {
      ...
      case "end-ellipsis":
        return createScopedElement("li", {
          ...
          vkuiClass: classNames("Pagination__page", "Pagination__page--type-ellipsis", getSizeYClassName("Pagination__page", sizeY), disabled && "Pagination__page--disabled")
        }, "..."));
      ...
      default:
        {
          ...
          return createScopedElement("li", {
            ...
            vkuiClass: classNames("Pagination__page", getSizeYClassName("Pagination__page", sizeY), _isCurrent && "Pagination__page--current", disabled && "Pagination__page--disabled"),
