 ...
 */ export const Group = (_param)=>{
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(RootComponent, _object_spread_props(_object_spread({
        ...
        tabIndex: tabIndex,
        baseClassName: classNames('vkuiInternalGroup', "vkuiGroup", isInsideModal && "vkuiGroup--inside-modal", platform === 'ios' && "vkuiGroup--ios", sizeX !== 'regular' && sizeXClassNames[sizeX], mode && stylesMode[mode], stylesPadding[padding])
