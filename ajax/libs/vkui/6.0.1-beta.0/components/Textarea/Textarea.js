 ...
 */ export const Textarea = (_param)=>{
    var { defaultValue = '', grow = true, style, onResize, className, getRootRef, getRef, rows = 2, maxHeight, status, onChange: onChangeProp, value: valueProp, align, mode } = _param, restProps = _object_without_properties(_param, [
        "defaultValue",
        "grow",
        "style",
        "onResize",
