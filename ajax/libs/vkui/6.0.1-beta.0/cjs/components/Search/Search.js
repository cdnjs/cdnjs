...
const Search = (_param)=>{
    var { id: idProp, before = /*#__PURE__*/ _react.createElement(_icons.Icon16SearchOutline, null), className, defaultValue = '', placeholder = 'Поиск', after = 'Отмена', getRef, icon, onIconClick = _vkjs.noop, style, autoComplete = 'off', onChange: onChangeProp, value: valueProp, iconLabel, clearLabel = 'Очистить', noPadding, getRootRef, findButtonText = 'Найти', onFindButtonClick } = _param, inputProps = _object_without_properties._(_param, [
        "id",
        "before",
        "className",
        "defaultValue",
    ...
    return /*#__PURE__*/ _react.createElement("div", {
        className: (0, _vkjs.classNames)('vkuiInternalSearch', "vkuiSearch", sizeY === 'none' && "vkuiSearch--sizeY-none", sizeY === 'compact' && "vkuiSearch--sizeY-compact", isFocused && "vkuiSearch--focused", value && "vkuiSearch--has-value", after && "vkuiSearch--has-after", icon && "vkuiSearch--has-icon", inputProps.disabled && "vkuiSearch--disabled", !noPadding && "vkuiSearch--withPadding", className),
        ref: getRootRef,
        style: style
