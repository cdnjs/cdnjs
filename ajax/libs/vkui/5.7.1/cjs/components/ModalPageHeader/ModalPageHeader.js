...
var ModalPageHeader = function(_param) {
    var children = _param.children, _param_separator = _param.separator, separator = _param_separator === void 0 ? true : _param_separator, getRef = _param.getRef, className = _param.className, restProps = _object_without_properties._(_param, [
        "children",
        "separator",
        "getRef",
        "className"
