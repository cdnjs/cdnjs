 ...
 */ export const SimpleCell = ({ badgeBeforeTitle , badgeAfterTitle , badgeBeforeSubtitle , badgeAfterSubtitle , before , indicator , children , after , expandable , multiline , subhead , subtitle , extraSubtitle , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Tappable, {
        ...
        className: styles['SimpleCell__main']
        ...
        className: classNames(styles['SimpleCell__typography'], styles['SimpleCell__text'], styles['SimpleCell__subtitle'])
        ...
        className: classNames(styles['SimpleCell__typography'], styles['SimpleCell__text'], styles['SimpleCell__extraSubtitle'])
