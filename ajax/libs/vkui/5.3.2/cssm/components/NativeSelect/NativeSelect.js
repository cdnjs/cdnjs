 ...
 */ const NativeSelect = ({ style , defaultValue ='' , align , placeholder , children , className , getRef , getRootRef , disabled , multiline , selectType ='default' , status , onChange: onChangeProp , value: valueProp , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(FormField, {
        Component: "label",
        className: classNames(styles['Select'], 'vkuiInternalNativeSelect', empty && styles['Select--empty'], multiline && styles['Select--multiline'], placeholder?.length && styles['Select--hasPlaceholder'], align === 'center' && styles['Select--align-center'], align === 'right' && styles['Select--align-right'], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], className),
        style: style,
