...
var HorizontalScroll = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(false), 2), canScrollLeft = _React_useState[0], setCanScrollLeft = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(false), 2), canScrollRight = _React_useState1[0], setCanScrollRight = _React_useState1[1];
    ...
    var onscroll = _react.useCallback(function() {
   ...
   */ var onwheel = _react.useCallback(function(e) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, restProps), {
        className: (0, _vkjs.classNames)("vkuiHorizontalScroll", "vkuiInternalHorizontalScroll", showArrows === "always" && "vkuiInternalHorizontalScroll--withConstArrows", className)
