...
var PanelHeaderContext = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement(_fixedLayout.FixedLayout, _objectSpreadProps(_objectSpread({}, restProps), {
        className: (0, _vkjs.classNames)("vkuiPanelHeaderContext", platform === _platform.Platform.IOS && "vkuiPanelHeaderContext--ios", opened && "vkuiPanelHeaderContext--opened", closing && "vkuiPanelHeaderContext--closing", sizeXClassNames[sizeX], "vkuiPanelHeaderContext--rounded", className),
        vertical: "top"
