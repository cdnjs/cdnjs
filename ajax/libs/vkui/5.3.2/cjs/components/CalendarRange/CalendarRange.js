...
var CalendarRange = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(), 2), hintedDate = _React_useState[0], setHintedDate = _React_useState[1];
