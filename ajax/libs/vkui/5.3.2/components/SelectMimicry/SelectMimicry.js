 ...
 */ export var SelectMimicry = function(_param) {
    ...
    return /*#__PURE__*/ React.createElement(FormField, _object_spread_props(_object_spread({}, restProps), {
        ...
        className: classNames("vkuiSelect", sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], !children && "vkuiSelect--empty", multiline && "vkuiSelect--multiline", align === "center" && "vkuiSelect--align-center", align === "right" && "vkuiSelect--align-right", before && "vkuiSelect--hasBefore", after && "vkuiSelect--hasAfter", className),
