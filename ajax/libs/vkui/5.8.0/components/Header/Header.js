 ...
 */ export var Header = function(_param) {
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, _object_spread_props(_object_spread({
        ...
        baseClassName: classNames("vkuiHeader", platform === Platform.IOS && "vkuiHeader--ios", stylesMode[mode], isPrimitiveReactNode(indicator) && "vkuiHeader--pi", hasReactNode(subtitle) && "vkuiHeader--with-subtitle")
