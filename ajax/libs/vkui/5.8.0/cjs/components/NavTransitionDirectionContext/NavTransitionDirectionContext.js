...
var TransitionDirectionContext = /*#__PURE__*/ _react.default.createContext(undefined);
var NavTransitionDirectionProvider = function(param) {
    var children = param.children, isBackProp = param.isBack;
    var parentIsBack = _react.default.useContext(TransitionDirectionContext);
    ...
    var _React_useState = _sliced_to_array._(_react.default.useState(isBack), 1), isBackOnMount = _React_useState[0];
    return /*#__PURE__*/ _react.default.createElement(TransitionDirectionContext.Provider, {
        value: isBackOnMount
    }, children);
};
var useNavDirection = function() {
    var isBack = _react.default.useContext(TransitionDirectionContext);
