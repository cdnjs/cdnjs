...
export const Tappable = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(Clickable, _object_spread_props(_object_spread({
        baseClassName: classNames(baseClassName, "vkuiTappable__host", sizeX !== SizeType.REGULAR && sizeXClassNames[sizeX], borderRadiusMode === 'inherit' && "vkuiTappable__borderRadiusInherit", hasPointerClassName(hasPointer)),
