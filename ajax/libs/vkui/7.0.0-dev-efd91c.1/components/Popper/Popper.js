 ...
 */ export const Popper = (_param)=>{
    ...
    const dropdown = /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        ...
        style: _object_spread({}, convertFloatingDataToReactCSSProperties(floatingPositionStrategy, floatingDataX, floatingDataY, sameWidth ? null : undefined, middlewareData), styleProp),
        children: [
