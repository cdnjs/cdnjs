 ...
 */ export const HorizontalScroll = ({ children, getScrollToLeft, getScrollToRight, showArrows = true, arrowSize = 'm', arrowOffsetY, scrollAnimationDuration = SCROLL_ONE_FRAME_TIME, getRef, scrollOnAnyWheel = false, ...restProps })=>{
   ...
   */ const onScrollWheel = React.useCallback((e)=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, {
        ...restProps,
        baseClassName: classNames(styles.host, 'vkuiInternalHorizontalScroll', showArrows === 'always' && styles.withConstArrows),
