 ...
 */ export const Switch = ({ style, className, getRootRef, getRef, checked: checkedProp, disabled, onBlur: onBlurProp, onFocus: onFocusProp, onClick, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs("label", {
        className: classNames(styles.host, sizeY !== 'regular' && sizeYClassNames[sizeY], platform === 'ios' ? styles.ios : styles.default, disabled && styles.disabled, focusVisibleClassNames, className),
        style: style,
        ref: getRootRef,
        children: [
