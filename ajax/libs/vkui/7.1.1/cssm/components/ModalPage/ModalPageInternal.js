    ...
    return /*#__PURE__*/ _jsxs(ModalOutlet, {
        ...
        children: [
            ...
            /*#__PURE__*/ _jsx(FocusTrap, {
                ...
                className: classNames(className, styles.host, sizeX === 'regular' && 'vkuiInternalModalPage--sizeX-regular', hasCustomPanelHeaderAfter ? styles.hostSafeAreaInsetTopWithCustomOffset : styles.hostSafeAreaInsetTop, desktopMaxWidthClassName),
                style: {
                    ...style,
