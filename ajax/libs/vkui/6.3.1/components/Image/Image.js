 ...
 */ export const Image = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(ImageBase, _object_spread_props(_object_spread({}, restProps), {
        ...
        className: classNames(className, "vkuiImage", borderStartStartRadius && "vkuiImage--borderStartStartRadius", borderStartEndRadius && "vkuiImage--borderStartEndRadius", borderEndStartRadius && "vkuiImage--borderEndStartRadius", borderEndEndRadius && "vkuiImage--borderEndEndRadius")
    }));
};
