...
const Snackbar = (_param)=>{
    var { placement = 'bottom-start', children, layout, action, before, after, duration = 4000, onActionClick = _vkjs.noop, onClose, mode = 'default', subtitle, offsetY, style, getRootRef } = _param, restProps = _object_without_properties._(_param, [
        "placement",
        "children",
        "layout",
        "action",
    ...
    const updateShiftAxisCSSProperties = _react.useCallback((x, y)=>{
