...
const FormField = (_param)=>{
    var { Component = 'span', status = 'default', children, getRootRef, before, after, beforeAlign = 'center', afterAlign = 'center', disabled, mode = 'default', className } = _param, restProps = _object_without_properties._(_param, [
        "Component",
        "status",
        "children",
        "getRootRef",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(Component, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        children: [
            before && /*#__PURE__*/ (0, _jsxruntime.jsx)("span", {
                className: (0, _vkjs.classNames)("vkuiFormField__before", iconAlignClassNames[beforeAlign]),
                children: before
            }),
            children,
            after && /*#__PURE__*/ (0, _jsxruntime.jsx)("span", {
                className: (0, _vkjs.classNames)("vkuiFormField__after", iconAlignClassNames[afterAlign], 'vkuiInternalFormField__after'),
                children: after
            }),
