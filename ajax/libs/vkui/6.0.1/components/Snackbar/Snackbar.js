 ...
 */ export const Snackbar = (_param)=>{
    var { children, layout: layoutProps = 'horizontal', action, before, after, duration = 4000, onActionClick, onClose, mode = 'default', subtitle, offsetY, style } = _param, restProps = _object_without_properties(_param, [
        "children",
        "layout",
        "action",
        "before",
