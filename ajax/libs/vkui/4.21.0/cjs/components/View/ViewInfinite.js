  ...
  function ViewInfinite(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "transitionEndHandler", function (e) {
      if (!e || ['vkui-animation-ios-next-forward', 'vkui-animation-ios-prev-back', 'vkui-animation-view-next-forward', 'vkui-animation-view-prev-back'].includes(e.animationName)) {
        ...
        var prevPanelScrolls = (0, _toConsumableArray2.default)(_this.scrolls[prevPanel] || []).slice(0, -1);
        var newPanelScrolls = (0, _toConsumableArray2.default)(_this.scrolls[activePanel] || []);
        var scrollPosition = isBack ? newPanelScrolls.pop() : 0;

        if (isBack) {
          var _objectSpread2;

          _this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, _this.scrolls), {}, (_objectSpread2 = {}, (0, _defineProperty2.default)(_objectSpread2, prevPanel, prevPanelScrolls), (0, _defineProperty2.default)(_objectSpread2, activePanel, newPanelScrolls), _objectSpread2));
        }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onMoveX", function (e) {
      ...
      if (platform === _platform.IOS && configProvider.isWebView && _this.props.onSwipeBack) {
        ...
        if (e.startX <= 70 && !_this.state.swipingBack && _this.props.history.length > 1) {
          ...
          _this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, _this.scrolls), {}, (0, _defineProperty2.default)({}, _this.state.activePanel, [].concat((0, _toConsumableArray2.default)(prevScrolls), [_this.props.scroll.getScroll().y])));
  ...
  (0, _createClass2.default)(ViewInfinite, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && !prevState.swipingBack && !prevState.browserSwipe) {
        ...
        var scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, this.scrolls), {}, (0, _defineProperty2.default)({}, prevProps.activePanel, [].concat((0, _toConsumableArray2.default)(prevScrolls), [this.props.scroll.getScroll().y])));
      ...
      if (prevProps.activePanel !== this.props.activePanel && prevState.swipingBack) {
        ...
        this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, this.scrolls), {}, (_objectSpread5 = {}, (0, _defineProperty2.default)(_objectSpread5, nextPanel, newPanelScrolls), (0, _defineProperty2.default)(_objectSpread5, prevPanel, prevPanelScrolls), _objectSpread5));
        this.setState({
          swipeBackPrevPanel: null,
          swipeBackNextPanel: null,
          swipingBack: false,
      ...
      if (prevState.swipeBackResult === SwipeBackResults.fail && !this.state.swipeBackResult) {
        ...
        this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, this.scrolls), {}, (0, _defineProperty2.default)({}, this.state.activePanel, _newPanelScrolls));
    ...
    value: function render() {
      ...
      return (0, _jsxRuntime.createScopedElement)(_Touch.Touch, (0, _extends2.default)({
        ...
        return (0, _jsxRuntime.createScopedElement)("div", {
          ...
          style: {
            marginTop: compensateScroll ? -scroll : null
          }
