...
export var SimpleCell = function SimpleCell(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    className: classNames("vkuiSimpleCell", getPlatformClassName("vkuiSimpleCell", platform), sizeYClassNames[sizeY], expandable && "vkuiSimpleCell--exp", multiline && "vkuiSimpleCell--mult", className)
