...
export var sizeXCompactClassNames = _defineProperty({
  mq: {
...
export var sizeXRegularClassNames = _defineProperty({
  mq: {
...
export var sizeYCompactClassNames = _defineProperty({
  mq: {
...
export var sizeYRegularClassNames = _defineProperty({
  mq: {
...
export var viewWidthClassNames = {
  tabletMinus: {
    mq: {
...
export var deviceTypeClassNames = {
  mobile: {
    mq: {
