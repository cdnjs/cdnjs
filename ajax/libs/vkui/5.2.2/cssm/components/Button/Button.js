...
}, _defineProperty(_sizeYClassNames, SizeType.COMPACT, "vkuiButton--sizeY-compact"), _defineProperty(_sizeYClassNames, SizeType.REGULAR, "vkuiButton--sizeY-regular"), _sizeYClassNames);
/**
...
export var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({
    ...
    className: classNames(className, "vkuiButton", styles["Button--size-".concat(size)], styles["Button--mode-".concat(mode)], styles["Button--appearance-".concat(appearance)], styles["Button--align-".concat(align)], sizeYClassNames[sizeY], platform === Platform.ANDROID && "vkuiButton--android", platform === Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && !stretched && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
