...
import "./DateRangeInput.module.css";
import "../DateInput/DateInput.module.css";
...
export var DateRangeInput = function DateRangeInput(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, _extends({
    style: style,
    className: classNames("vkuiDateRangeInput", sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], className),
