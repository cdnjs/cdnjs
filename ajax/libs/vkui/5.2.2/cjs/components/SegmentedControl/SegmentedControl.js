...
var SegmentedControl = function SegmentedControl(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _vkjs.classNames)("vkuiSegmentedControl", sizeY !== _adaptivity.SizeType.COMPACT && sizeYClassNames[sizeY], styles["SegmentedControl--size-".concat(size)], className),
    ref: getRootRef
