...
var SplitCol = function SplitCol(props) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    ...
    ref: baseRef,
    className: (0, _vkjs.classNames)("vkuiSplitCol", (0, _adaptivity.viewWidthToClassName)(breakpointClassNames, viewWidth), spaced && "vkuiSplitCol--spaced", spaced === undefined && "vkuiSplitCol--spaced-none", autoSpaced && "vkuiSplitCol--spaced-auto", fixed && "vkuiSplitCol--fixed", stretchedOnMobile && "vkuiSplitCol--stretched-on-mobile", className)
