 ...
 */ export var useTrackerVisibility = function() {
    ...
    var _React_useState = _sliced_to_array(React.useState(!autoHideScrollbar), 2), trackerVisible = _React_useState[0], setTrackerVisible = _React_useState[1];
    var isMouseOver = React.useRef(false);
    var isTrackerDragging = React.useRef(false);
    var _useTimeout = useTimeout(function() {
        return setTrackerVisible(false);
    }, autoHideScrollbarDelay), setVisibilityTimeout = _useTimeout.set, clearVisibilityTimeout = _useTimeout.clear;
