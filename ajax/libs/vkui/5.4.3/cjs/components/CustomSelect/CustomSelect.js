...
function defaultRenderOptionFn(_param) {
    var option = _param.option, props = _objectWithoutProperties(_param, [
        "option"
    ]);
...
function CustomSelect(props) {
    ...
    var _React_useState4 = _slicedToArray(_react.useState(function() {
    ...
    var _React_useState5 = _slicedToArray(_react.useState(""), 2), keyboardInput = _React_useState5[0], setKeyboardInput = _React_useState5[1];
    var _React_useState6 = _slicedToArray(_react.useState(undefined), 2), popperPlacement = _React_useState6[0], setPopperPlacement = _React_useState6[1];
    var _React_useState7 = _slicedToArray(_react.useState(optionsProp), 2), options = _React_useState7[0], setOptions = _React_useState7[1];
    var _props_value1;
    var _React_useState8 = _slicedToArray(_react.useState(findSelectedIndex(optionsProp, (_props_value1 = props.value) !== null && _props_value1 !== void 0 ? _props_value1 : props.defaultValue, allowClearButton)), 2), selectedOptionIndex = _React_useState8[0], setSelectedOptionIndex = _React_useState8[1];
   ...
   */ var onLabelClick = _react.useCallback(function(e) {
    ...
    }, opened && searchable ? /*#__PURE__*/ _react.createElement(_input.Input, _objectSpreadProps(_objectSpread({}, restProps), {
        autoFocus: true,
        onBlur: onBlur,
    ...
    })) : /*#__PURE__*/ _react.createElement(_selectMimicry.SelectMimicry, _objectSpreadProps(_objectSpread({}, restProps), {
        "aria-hidden": true,
        onClick: onClick,
