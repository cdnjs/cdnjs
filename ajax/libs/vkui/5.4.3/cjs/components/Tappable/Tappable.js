...
var _mitt = /*#__PURE__*/ _interopRequireDefault(require("mitt"));
...
var _touch1 = require("../Touch/Touch");
var _touchContext = /*#__PURE__*/ _interopRequireDefault(require("../Touch/TouchContext"));
var sizeXClassNames = {
...
function useActivity(hasActive, stopDelay) {
    ...
    var _React_useState = _slicedToArray(_react.useState(TapState.none), 2), activity = _React_useState[0], setActivity = _React_useState[1];
    var _stop = function() {
...
var Tappable = function(_param) {
   ...
   */ function onKeyDown(e) {
    ...
    var addClick = function addClick(x, y) {
        ...
        setClicks(_toConsumableArray(filteredClicks).concat([
            {
                x: x,
                y: y,
                id: dateNow
    ...
    var _React_useState = _slicedToArray(_react.useState([]), 2), clicks = _React_useState[0], setClicks = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(false), 2), childHover = _React_useState1[0], setChildHover = _React_useState1[1];
    ...
    var isPresetFocusVisibleMode = [
        "inside",
        "outside"
    ].includes(focusVisibleMode);
    var _useActivity = _slicedToArray(useActivity(hasActive, activeEffectDelay), 2), activity = _useActivity[0], _useActivity_ = _useActivity[1], start = _useActivity_.start, stop = _useActivity_.stop, delayStart = _useActivity_.delayStart;
    ...
    return /*#__PURE__*/ _react.createElement(_touch1.Touch, _objectSpread(_objectSpreadProps(_objectSpread({
    ...
    }), !props.disabled && isPresetFocusVisibleMode && /*#__PURE__*/ _react.createElement(_focusVisible.FocusVisible, {
