...
var SegmentedControl = function(_param) {
    var _param_size = _param.size, size = _param_size === void 0 ? "l" : _param_size, name = _param.name, options = _param.options, getRootRef = _param.getRootRef, _param_defaultValue = _param.defaultValue, defaultValue = _param_defaultValue === void 0 ? (_options_ = options[0]) === null || _options_ === void 0 ? void 0 : _options_.value : _param_defaultValue, children = _param.children, className = _param.className, onChangeProp = _param.onChange, valueProp = _param.value, restProps = _objectWithoutProperties(_param, [
        "size",
        "name",
        "options",
        "getRootRef",
    ...
    var _useCustomEnsuredControl = _slicedToArray((0, _useEnsuredControl.useCustomEnsuredControl)({
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, restProps), {
        ...
        var label = _param.label, optionClassName = _param.className, optionProps = _objectWithoutProperties(_param, [
            "label",
            "className"
        ]);
        return _react.createElement(_segmentedControlOption.SegmentedControlOption, _objectSpreadProps(_objectSpread({
