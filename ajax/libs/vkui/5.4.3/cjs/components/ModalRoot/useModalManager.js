...
function useModalManager(activeModal, children) {
    ...
    var _React_useReducer = _slicedToArray(_react.useReducer(modalTransitionReducer, {
...
function withModalManager() {
    ...
    return function(Wrapped) {
        return function WithModalManager(props) {
            ...
            return /*#__PURE__*/ _react.createElement(Wrapped, _objectSpread({}, props, transitionManager));
        };
    };
}
