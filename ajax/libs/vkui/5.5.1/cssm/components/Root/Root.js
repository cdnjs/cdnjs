 ...
 */ export const Root = ({ children , activeView: _activeView , onTransition , nav , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...restProps,
        className: classNames(styles['Root'], platform === Platform.IOS && styles['Root--ios'], transition && styles['Root--transition'], className)
    }, views.map((view)=>{
