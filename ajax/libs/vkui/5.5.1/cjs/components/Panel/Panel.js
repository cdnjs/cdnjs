...
var Panel = function(_param) {
    var _param_centered = _param.centered, centered = _param_centered === void 0 ? false : _param_centered, children = _param.children, getRootRef = _param.getRootRef, nav = _param.nav, className = _param.className, restProps = _object_without_properties._(_param, [
        "centered",
        "children",
        "getRootRef",
        "nav",
