...
export var SelectTypography = function SelectTypography(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: classNames("vkuiSelectTypography", platformClassNames.hasOwnProperty(platform) && platformClassNames[platform], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], selectTypeClassNames[selectType], className)
  }, restProps), children);
};
