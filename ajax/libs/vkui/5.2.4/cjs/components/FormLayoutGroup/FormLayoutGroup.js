...
}, _adaptivity.SizeType.COMPACT, "vkuiFormLayoutGroup--sizeY-compact");
/**
...
var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
    ref: rootEl,
    className: (0, _vkjs.classNames)("vkuiFormLayoutGroup", sizeY !== _adaptivity.SizeType.REGULAR && sizeYClassNames[sizeY], styles["FormLayoutGroup--mode-".concat(mode)], isRemovable && "vkuiFormLayoutGroup--removable", isSegmented && "vkuiFormLayoutGroup--segmented", className)
