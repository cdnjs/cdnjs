...
var Search = function Search(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _vkjs.classNames)("vkuiSearch", platform === _platform.Platform.IOS && "vkuiSearch--ios", sizeY !== _adaptivity.SizeType.COMPACT && sizeYClassNames[sizeY], isFocused && "vkuiSearch--focused", value && "vkuiSearch--has-value", after && "vkuiSearch--has-after", icon && "vkuiSearch--has-icon", className),
    style: style
