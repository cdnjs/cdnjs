...
var PanelHeaderBack = function PanelHeaderBack(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_PanelHeaderButton.PanelHeaderButton, (0, _extends2.default)({}, restProps, {
    className: (0, _vkjs.classNames)("vkuiPanelHeaderBack", sizeX === _adaptivity.SizeType.COMPACT && "vkuiPanelHeaderBack--sizeX-compact", platform === _platform.Platform.IOS && "vkuiPanelHeaderBack--ios", platform === _platform.Platform.VKCOM && "vkuiPanelHeaderBack--vkcom", showLabel && !!label && "vkuiPanelHeaderBack--has-label", className),
