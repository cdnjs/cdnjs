...
}, (0, _defineProperty2.default)(_sizeYClassNames, _adaptivity.SizeType.COMPACT, "vkuiButton--sizeY-compact"), (0, _defineProperty2.default)(_sizeYClassNames, _adaptivity.SizeType.REGULAR, "vkuiButton--sizeY-regular"), _sizeYClassNames);
/**
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({
    ...
    className: (0, _vkjs.classNames)(className, "vkuiButton", styles["Button--size-".concat(size)], styles["Button--mode-".concat(mode)], styles["Button--appearance-".concat(appearance)], styles["Button--align-".concat(align)], sizeYClassNames[sizeY], platform === _platform.Platform.ANDROID && "vkuiButton--android", platform === _platform.Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && !stretched && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
