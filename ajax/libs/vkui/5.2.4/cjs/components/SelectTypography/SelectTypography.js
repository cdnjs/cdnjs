...
var SelectTypography = function SelectTypography(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", (0, _extends2.default)({
    className: (0, _vkjs.classNames)("vkuiSelectTypography", platformClassNames.hasOwnProperty(platform) && platformClassNames[platform], sizeY !== _adaptivity.SizeType.REGULAR && sizeYClassNames[sizeY], selectTypeClassNames[selectType], className)
  }, restProps), children);
};
