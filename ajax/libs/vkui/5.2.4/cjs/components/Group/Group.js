...
}, (0, _defineProperty2.default)(_sizeXClassNames, _adaptivity.SizeType.COMPACT, "vkuiGroup--sizeX-compact"), (0, _defineProperty2.default)(_sizeXClassNames, _adaptivity.SizeType.REGULAR, "vkuiGroup--sizeX-regular"), _sizeXClassNames);
...
var Group = function Group(_ref) {
  ...
  return /*#__PURE__*/React.createElement("section", (0, _extends2.default)({}, restProps, {
    tabIndex: tabIndex,
    ref: getRootRef,
    className: (0, _vkjs.classNames)("vkuiGroup", platform === _platform.Platform.IOS && "vkuiGroup--ios", sizeXClassNames[sizeX], mode && styles["Group--mode-".concat(mode)], styles["Group--padding-".concat(padding)], className)
