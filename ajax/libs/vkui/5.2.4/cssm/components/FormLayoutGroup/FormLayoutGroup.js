...
var sizeYClassNames = _defineProperty({
  none: "vkuiFormLayoutGroup--sizeY-none"
}, SizeType.COMPACT, "vkuiFormLayoutGroup--sizeY-compact");
/**
...
export var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ref: rootEl,
    className: classNames("vkuiFormLayoutGroup", sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], styles["FormLayoutGroup--mode-".concat(mode)], isRemovable && "vkuiFormLayoutGroup--removable", isSegmented && "vkuiFormLayoutGroup--segmented", className)
