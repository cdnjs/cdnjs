...
}, _defineProperty(_sizeYClassNames, SizeType.COMPACT, "vkuiSimpleCell--sizeY-compact"), _defineProperty(_sizeYClassNames, SizeType.REGULAR, "vkuiSimpleCell--sizeY-regular"), _sizeYClassNames);
/**
...
export var SimpleCell = function SimpleCell(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    className: classNames("vkuiSimpleCell", platformClassNames.hasOwnProperty(platform) ? platformClassNames[platform] : platformClassNames.android, sizeYClassNames[sizeY], expandable && "vkuiSimpleCell--exp", multiline && "vkuiSimpleCell--mult", className)
