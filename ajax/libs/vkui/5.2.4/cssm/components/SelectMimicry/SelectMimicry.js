...
export var SelectMimicry = function SelectMimicry(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, _extends({}, restProps, {
    ...
    className: classNames("vkuiSelect", sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], !children && "vkuiSelect--empty", multiline && "vkuiSelect--multiline", align && styles["Select--align-".concat(align)], before && "vkuiSelect--hasBefore", after && "vkuiSelect--hasAfter", className),
