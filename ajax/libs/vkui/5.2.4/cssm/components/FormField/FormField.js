...
export var FormField = function FormField(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, _extends({}, restProps, {
    ...
    className: classNames("vkuiFormField", styles["FormField--mode-".concat(mode)], styles["FormField--status-".concat(status)], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], disabled && "vkuiFormField--disabled", !disabled && hover && "vkuiFormField--hover", className)
