...
const sizeYClassNames = {
    ...
    [SizeType.COMPACT]: classNames(styles['FormLayoutGroup--sizeY-compact'], 'vkuiInternalFormLayoutGroup--sizeY-compact')
};
/**
 ...
 */ export const FormLayoutGroup = ({ children, mode = 'vertical', removable, segmented, removePlaceholder = 'Удалить', onRemove = noop, getRootRef, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        getRootRef: rootEl,
        baseClassName: classNames(sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], mode === 'horizontal' && classNames(styles['FormLayoutGroup--mode-horizontal'], 'vkuiInternalFormLayoutGroup--mode-horizontal'), isRemovable && classNames(styles['FormLayoutGroup--removable'], 'vkuiInternalFormLayoutGroup--removable'), isSegmented && classNames(styles['FormLayoutGroup--segmented'], 'vkuiInternalFormLayoutGroup--segmented')),
        ...restProps
