 ...
 */ export const Header = ({ mode = 'primary', size = 'regular', children, subtitle, indicator, aside, multiline, ...restProps })=>{
    const platform = usePlatform();
    return /*#__PURE__*/ React.createElement(RootComponent, {
        Component: "header",
        ...restProps,
        baseClassName: classNames(styles['Header'], platform === Platform.IOS && styles['Header--ios'], stylesMode[mode], isPrimitiveReactNode(indicator) && styles['Header--pi'], hasReactNode(subtitle) && styles['Header--with-subtitle'])
