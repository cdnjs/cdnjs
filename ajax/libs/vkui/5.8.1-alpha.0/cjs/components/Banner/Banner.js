...
var Banner = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({
        ...
        baseClassName: (0, _vkjs.classNames)("vkuiBanner", !noPadding && "vkuiBanner--withPadding", platform === _platform.Platform.IOS && "vkuiBanner--ios", mode === "image" && "vkuiBanner--mode-image", stylesSize[size], mode === "image" && imageTheme === "dark" && "vkuiBanner--inverted")
