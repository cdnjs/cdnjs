...
const CalendarHeader = (_param)=>{
    ...
    const nextMonthHidden = nextMonthHiddenProp || currentMonth === 11 && currentYear === _calendar.DEFAULT_MAX_YEAR;
    const prevMonthHidden = prevMonthHiddenProp || currentMonth === 0 && currentYear === _calendar.DEFAULT_MIN_YEAR;
