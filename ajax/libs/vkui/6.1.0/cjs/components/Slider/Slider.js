...
const Slider = (_param)=>{
    var { step = 1, min = 0, max = 100, value: valueProp, multiple: multipleProp, defaultValue = multipleProp ? [
        min,
        max
    ] : min, disabled, className, getRootRef, getAriaLabel, getAriaValueText, onChange, withTooltip, size = 'l' } = _param, restProps = _object_without_properties._(_param, [
        "step",
        "min",
        "max",
        "value",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_Touch.Touch, _object_spread_props._(_object_spread._({
        "data-value": multiple ? `${startValue},${endValue}` : startValue
    }, restPropsWithoutAriaAttributes), {
        className: (0, _vkjs.classNames)("vkuiSlider", disabled && "vkuiSlider--disabled", sizeY !== 'regular' && sizeYClassNames[sizeY], sizeClassNames[size], className),
