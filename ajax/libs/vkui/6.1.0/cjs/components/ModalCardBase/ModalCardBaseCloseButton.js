...
function ModalCardBaseCloseButton({ children = 'Закрыть', testId, mode, onClose }) {
    ...
    if (isDesktop && mode === 'outside') {
        return /*#__PURE__*/ (0, _jsxruntime.jsx)(_ModalDismissButton.ModalDismissButton, {
            "data-testid": testId,
            onClick: onClose,
            children: children
        });
    ...
    if (mode === 'inside' || platform === 'ios' && !isDesktop) {
        return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_Tappable.Tappable, {
            ...
            children: [
                ...
                platform === 'ios' ? /*#__PURE__*/ (0, _jsxruntime.jsx)(_icons.Icon24Dismiss, {}) : /*#__PURE__*/ (0, _jsxruntime.jsx)(_icons.Icon20Cancel, {})
            ]
        });
    }
    return null;
