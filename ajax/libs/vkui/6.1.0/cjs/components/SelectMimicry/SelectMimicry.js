...
const SelectMimicry = (_param)=>{
    var { tabIndex = 0, placeholder, children, align, getRootRef, multiline, disabled, onClick, before, after = /*#__PURE__*/ (0, _jsxruntime.jsx)(_DropdownIcon.DropdownIcon, {}), selectType = 'default', status, className, autoFocus } = _param, restProps = _object_without_properties._(_param, [
        "tabIndex",
        "placeholder",
        "children",
        "align",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_FormField.FormField, _object_spread_props._(_object_spread._({}, restProps), {
