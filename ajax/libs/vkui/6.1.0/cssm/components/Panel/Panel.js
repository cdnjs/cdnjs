 ...
 */ export const Panel = ({ centered = false, children, nav, mode: modeProp, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsx(NavPanelIdContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsx(RootComponent, {
            ...restProps,
            baseClassName: classNames(styles['Panel'], sizeXClassNames[sizeX], centered && 'vkuiInternalPanel--centered', stylesMode[mode]),
