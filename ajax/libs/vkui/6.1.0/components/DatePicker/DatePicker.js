...
const DatePickerNative = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(Input, _object_spread(_object_spread_props(_object_spread({}, inputProps), {
        type: "date",
 ...
 */ export const DatePicker = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(Cmp, _object_spread_props(_object_spread({}, props, value), {
