...
const animationStateClassNames = {
    ...
    exited: "vkuiSnackbar--state-exited"
};
/**
 * @see https://vkcom.github.io/VKUI/#/Snackbar
 */ export const Snackbar = (_param)=>{
    var { placement = 'bottom-start', children, layout, action, before, after, duration = 4000, onActionClick = noop, onClose, mode = 'default', subtitle, offsetY, style, getRootRef } = _param, restProps = _object_without_properties(_param, [
        "placement",
        "children",
        "layout",
        "action",
