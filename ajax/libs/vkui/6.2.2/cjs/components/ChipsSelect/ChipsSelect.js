...
const ChipsSelect = (_param)=>{
    ...
    getRef, value: valueProp, defaultValue, inputValue: inputValueProp, defaultInputValue, disabled, readOnly, getOptionValue = _constants.getOptionValueDefault, getOptionLabel = _constants.getOptionLabelDefault, getNewOptionData = _constants.getNewOptionDataDefault, renderChip = _constants.renderChipDefault, renderOption = _constants1.renderOptionDefault, onChange, onFocus: onFocusProp, onInputChange: onInputChangeProp, onBlur: onBlurProp, onKeyDown: onKeyDownProp, dropdownOffsetDistance = 0 } = _param, restProps = _object_without_properties._(_param, [
        "id",
        "getRootRef",
        "className",
        "status",
