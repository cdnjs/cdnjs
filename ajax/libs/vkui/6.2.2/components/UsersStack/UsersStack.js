 ...
 */ export const UsersStack = (_param)=>{
    var { photos = [], visibleCount = 3, count = Math.max(0, photos.length - visibleCount), size = 'm', children, direction = 'row' } = _param, restProps = _object_without_properties(_param, [
        "photos",
        "visibleCount",
        "count",
        "size",
    ...
    const othersElement = canShowOthers ? /*#__PURE__*/ _jsxs(CounterTypography, {
        caps: true,
        weight: "1",
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("vkuiUsersStack", stylesSize[size], stylesDirection[direction]),
        children: [
