 ...
 */ export const Panel = (_param)=>{
    var { centered = false, children, nav, mode: modeProp } = _param, restProps = _object_without_properties(_param, [
        "centered",
        "children",
        "nav",
        "mode"
    ...
    return /*#__PURE__*/ _jsx(NavPanelIdContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
            baseClassName: classNames("vkuiPanel", sizeXClassNames[sizeX], centered && 'vkuiInternalPanel--centered', stylesMode[mode]),
