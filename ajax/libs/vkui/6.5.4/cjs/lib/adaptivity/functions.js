...
function getViewWidthByViewportWidth(viewportWidth) {
    if (viewportWidth >= _breakpoints.BREAKPOINTS.DESKTOP) {
        return _constants.ViewWidth.DESKTOP;
    }
    if (viewportWidth >= _breakpoints.BREAKPOINTS.TABLET) {
        return _constants.ViewWidth.TABLET;
    }
    if (viewportWidth >= _breakpoints.BREAKPOINTS.SMALL_TABLET) {
        return _constants.ViewWidth.SMALL_TABLET;
    }
    if (viewportWidth >= _breakpoints.BREAKPOINTS.MOBILE) {
...
function getViewHeightByViewportHeight(viewportHeight) {
    if (viewportHeight >= _breakpoints.BREAKPOINTS.MEDIUM_HEIGHT) {
        return _constants.ViewHeight.MEDIUM;
    }
    if (viewportHeight >= _breakpoints.BREAKPOINTS.MOBILE_LANDSCAPE_HEIGHT) {
