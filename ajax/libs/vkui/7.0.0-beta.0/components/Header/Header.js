...
const stylesMode = {
    primary: "vkuiHeader__modePrimary",
    secondary: "vkuiHeader__modeSecondary",
    tertiary: "vkuiHeader__modeTertiary"
};
/**
 * @see https://vkcom.github.io/VKUI/#/Header
 */ export const Header = (_param)=>{
    var { mode = 'primary', size = 'm', Component = 'h2', children, subtitle, subtitleComponent = 'span', indicator, aside, multiline, before, beforeTitle, afterTitle, beforeSubtitle, afterSubtitle } = _param, restProps = _object_without_properties(_param, [
        "mode",
        "size",
        "Component",
        "children",
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("vkuiHeader__host", stylesMode[mode], size === 'l' && "vkuiHeader__large", isPrimitiveReactNode(indicator) && "vkuiHeader__pi", hasReactNode(subtitle) && "vkuiHeader__withSubtitle"),
        children: [
