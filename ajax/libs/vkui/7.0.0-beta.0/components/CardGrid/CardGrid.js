 ...
 */ export const CardGrid = (_param)=>{
    var { size = 's', spaced = false, Component = 'ul' } = _param, restProps = _object_without_properties(_param, [
        "size",
        "spaced",
        "Component"
    ]);
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        Component: Component,
        baseClassName: classNames("vkuiCardGrid__host", 'vkuiInternalCardGrid', spaced && "vkuiCardGrid__spaced", stylesSize[size], sizeX !== 'regular' && sizeXClassNames[sizeX])
    }));
};
