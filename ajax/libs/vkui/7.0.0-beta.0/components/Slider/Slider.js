 ...
 */ export const Slider = (_param)=>{
    var { step = 1, min = 0, max = 100, value: valueProp, multiple: multipleProp, defaultValue = multipleProp ? [
        min,
        max
    ] : min, disabled, className, getRootRef, getAriaLabel, getAriaValueText, onChange, withTooltip, size = 'l' } = _param, restProps = _object_without_properties(_param, [
        "step",
        "min",
        "max",
        "value",
    ...
    return /*#__PURE__*/ _jsxs(Touch, _object_spread_props(_object_spread({
        ...
        className: classNames("vkuiSlider__host", disabled && "vkuiSlider__disabled", sizeY !== 'regular' && sizeYClassNames[sizeY], sizeClassNames[size], className),
