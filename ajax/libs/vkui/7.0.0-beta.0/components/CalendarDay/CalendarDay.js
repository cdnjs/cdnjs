...
export const CalendarDay = /*#__PURE__*/ React.memo((_param)=>{
    ...
    return /*#__PURE__*/ _jsx(Tappable, _object_spread_props(_object_spread({
        className: classNames("vkuiCalendarDay__host", size === 's' && "vkuiCalendarDay__sizeS", today && "vkuiCalendarDay__today", selected && !disabled && "vkuiCalendarDay__selected", selectionStart && "vkuiCalendarDay__selectionStart", selectionEnd && "vkuiCalendarDay__selectionEnd", disabled && "vkuiCalendarDay__disabled", !sameMonth && "vkuiCalendarDay__notSameMonth", className),
        hoverMode: active ? '' : "vkuiCalendarDay__hover",
        hasActive: false,
        onClick: onClick,
        disabled: disabled,
        tabIndex: -1,
