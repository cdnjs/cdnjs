 ...
 */ export const CardScroll = (_param)=>{
    var { children, size = 's', showArrows = true, noSpaces = false, Component = 'ul' } = _param, restProps = _object_without_properties(_param, [
        "children",
        "size",
        "showArrows",
        "noSpaces",
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        Component: Component,
        baseClassName: classNames("vkuiCardScroll__host", 'vkuiInternalCardScroll', size !== false && stylesSize[size], !noSpaces && "vkuiCardScroll__withSpaces"),
