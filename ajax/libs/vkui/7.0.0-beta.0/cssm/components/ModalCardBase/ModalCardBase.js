 ...
 */ export const ModalCardBase = ({ icon, header, headerComponent = 'span', subheader, subheaderComponent = 'span', children, actions, onClose, dismissLabel = 'Скрыть', style, size: sizeProp, modalDismissButtonTestId, dismissButtonMode = 'outside', preventClose, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, {
        ...
        children: /*#__PURE__*/ _jsxs("div", {
            className: classNames(styles.container, isSoftwareKeyboardOpened && styles.containerSoftwareKeyboardOpened),
            children: [
