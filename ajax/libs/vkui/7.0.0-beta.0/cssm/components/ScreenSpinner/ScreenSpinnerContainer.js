...
export const ScreenSpinnerContainer = ({ state = 'loading', mode = 'shadow', customIcon, caption, children, ...restProps })=>{
    return /*#__PURE__*/ _jsx(ScreenSpinnerContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsxs(RootComponent, {
            baseClassName: classNames(styles.host, modeClassNames[mode], state !== 'loading' && stateClassNames[state], hasReactNode(caption) && styles.hasCaption),
            ...restProps,
            children: [
                /*#__PURE__*/ _jsx("div", {
