...
const _FormFieldClearButton = require("../FormFieldClearButton/FormFieldClearButton");
...
const ChipsInputBase = (_param)=>{
    ...
    const handleRootClick = (event)=>{
        if (event.defaultPrevented || (0, _dom1.contains)(event.currentTarget, (0, _dom1.getActiveElementByAnotherElement)(event.currentTarget))) {
            return;
        }
        if (inputRef.current) {
    ...
    const afterItems = _react.useMemo(()=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_FormField.FormField, {
        ...
        children: /*#__PURE__*/ (0, _jsxruntime.jsxs)("div", {
            ...
            children: [
                value.map((option, index)=>/*#__PURE__*/ (0, _jsxruntime.jsx)(_react.Fragment, {
                        children: renderChip({
                            'Component': 'div',
                            'value': option.value,
                            'label': option.label,
