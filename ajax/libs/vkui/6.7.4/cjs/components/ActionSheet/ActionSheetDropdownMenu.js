...
const ActionSheetDropdownMenu = (_param)=>{
    var { children, toggleRef, closing, onClose, className, style, popupOffsetDistance = 0, placement, onAnimationStart, onAnimationEnd } = _param, restProps = _object_without_properties._(_param, [
        "children",
        "toggleRef",
        "closing",
        "onClose",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_Popper.Popper, {
        ...
        placement: placement,
        className: (0, _vkjs.classNames)("vkuiActionSheet", platform === 'ios' && "vkuiActionSheet--ios", "vkuiActionSheet--menu", closing ? "vkuiActionSheet--closing" : "vkuiActionSheet--opening", sizeY === 'compact' && "vkuiActionSheet--sizeY-compact", className),
        style: style,
