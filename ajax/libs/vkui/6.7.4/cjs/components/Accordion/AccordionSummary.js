...
const AccordionSummary = (_param)=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_SimpleCell.SimpleCell, _object_spread_props._(_object_spread._({
        id: labelId,
        "aria-expanded": expanded,
        "aria-controls": contentId,
        onClick: (0, _callMultiple.callMultiple)(toggle, onClick),
        before: /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
            children: [
                iconPosition === 'before' && icon,
                before
            ]
        }),
        after: /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
            children: [
                after,
