...
const SliderThumb = (_param)=>{
    var { className, getRootRef, inputProps, withTooltip, isActive } = _param, restProps = _object_without_properties._(_param, [
        "className",
        "getRootRef",
        "inputProps",
        "withTooltip",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_react.Fragment, {
        children: [
            /*#__PURE__*/ (0, _jsxruntime.jsx)("span", _object_spread_props._(_object_spread._({}, restProps), {
                ...
                className: (0, _vkjs.classNames)("vkuiSliderThumb", focusVisibleClassNames, isActive && "vkuiSliderThumb--active", isHovered && "vkuiSliderThumb--hover", className),
