...
var useAdaptivityWithJSMediaQueries = function() {
    ...
    }), 2), _React_useState_ = _slicedToArray(_React_useState[0], 2), viewWidthLocal = _React_useState_[0], viewHeightLocal = _React_useState_[1], setViewSizeLocal = _React_useState[1];
    ...
    _react.useEffect(function() {
        var handleMediaQuery = function() {
            setViewSizeLocal(function(prevSizeLocal) {
                ...
                var _prevSizeLocal = _slicedToArray(prevSizeLocal, 2), prevViewWidthLocal = _prevSizeLocal[0], prevViewHeightLocal = _prevSizeLocal[1];
