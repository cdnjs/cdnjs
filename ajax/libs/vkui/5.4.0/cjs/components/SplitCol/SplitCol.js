...
function useTransitionAnimate(animateProp) {
    ...
    var _React_useState = _slicedToArray(_react.useState(Boolean(animateProp)), 2), animate = _React_useState[0], setAnimate = _React_useState[1];
...
var SplitCol = function(props) {
    ...
    var baseRef = _react.useRef(null);
    var viewWidth = (0, _useAdaptivity.useAdaptivity)().viewWidth;
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, restProps), {
        ...
        ref: baseRef,
        className: (0, _vkjs.classNames)("vkuiSplitCol", (0, _adaptivity.viewWidthToClassName)(breakpointClassNames, viewWidth), spaced && (0, _vkjs.classNames)("vkuiSplitCol--spaced", "vkuiInternalSplitCol--spaced"), spaced === undefined && (0, _vkjs.classNames)("vkuiSplitCol--spaced-none", "vkuiInternalSplitCol--spaced-none"), autoSpaced && (0, _vkjs.classNames)("vkuiSplitCol--spaced-auto", "vkuiInternalSplitCol--spaced-auto"), fixed && "vkuiSplitCol--fixed", stretchedOnMobile && "vkuiSplitCol--stretched-on-mobile", className)
