...
var PullToRefresh = function(_param) {
    var children = _param.children, isFetching = _param.isFetching, onRefresh = _param.onRefresh, className = _param.className, restProps = _objectWithoutProperties(_param, [
        "children",
        "isFetching",
        "onRefresh",
        "className"
    ...
    var _React_useState = _slicedToArray(_react.useState(initParams.start), 2), spinnerY = _React_useState[0], setSpinnerY = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(false), 2), watching = _React_useState1[0], setWatching = _React_useState1[1];
    var _React_useState2 = _slicedToArray(_react.useState(false), 2), refreshing = _React_useState2[0], setRefreshing = _React_useState2[1];
    var _React_useState3 = _slicedToArray(_react.useState(false), 2), canRefresh = _React_useState3[0], setCanRefresh = _React_useState3[1];
    var _React_useState4 = _slicedToArray(_react.useState(false), 2), touchDown = _React_useState4[0], setTouchDown = _React_useState4[1];
    var prevTouchDown = (0, _usePrevious.usePrevious)(touchDown);
    var touchY = _react.useRef(0);
    var _React_useState5 = _slicedToArray(_react.useState(0), 2), contentShift = _React_useState5[0], setContentShift = _React_useState5[1];
    var _React_useState6 = _slicedToArray(_react.useState(0), 2), spinnerProgress = _React_useState6[0], setSpinnerProgress = _React_useState6[1];
    ...
    return /*#__PURE__*/ _react.createElement(_touchContext.default.Provider, {
        value: true
    }, /*#__PURE__*/ _react.createElement(_touch.Touch, _objectSpreadProps(_objectSpread({}, restProps), {
