...
export var HorizontalScrollArrow = function(_param) {
    var _param_size = _param.size, size = _param_size === void 0 ? "l" : _param_size, offsetY = _param.offsetY, direction = _param.direction, onClick = _param.onClick, className = _param.className, restProps = _object_without_properties(_param, [
        "size",
        "offsetY",
        "direction",
        "onClick",
