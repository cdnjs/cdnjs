 ...
 */ export var PanelHeaderContent = function(_param) {
    var className = _param.className, style = _param.style, aside = _param.aside, status = _param.status, before = _param.before, children = _param.children, onClick = _param.onClick, restProps = _object_without_properties(_param, [
        "className",
        "style",
        "aside",
        "status",
    ...
    return /*#__PURE__*/ React.createElement("div", _object_spread_props(_object_spread({}, rootProps), {
        style: style,
        className: classNames("vkuiPanelHeaderContent", platformClassNames.hasOwnProperty(platform) ? platformClassNames[platform] : platformClassNames.android, className)
        ...
        className: classNames("vkuiInternalPanelHeaderContent__children", "vkuiPanelHeaderContent__children")
