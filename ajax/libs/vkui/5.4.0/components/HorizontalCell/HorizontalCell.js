...
var CellTypography = function(_param) {
    var size = _param.size, children = _param.children, restProps = _object_without_properties(_param, [
        "size",
        "children"
    ]);
 ...
 */ export var HorizontalCell = function(_param) {
    var className = _param.className, header = _param.header, style = _param.style, subtitle = _param.subtitle, _param_size = _param.size, size = _param_size === void 0 ? "s" : _param_size, _param_children = _param.children, children = _param_children === void 0 ? /*#__PURE__*/ React.createElement(Avatar, {
        size: 56
    }) : _param_children, getRootRef = _param.getRootRef, getRef = _param.getRef, restProps = _object_without_properties(_param, [
        "className",
        "header",
        "style",
        "subtitle",
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ref: getRootRef,
        style: style,
        className: classNames("vkuiHorizontalCell", {
