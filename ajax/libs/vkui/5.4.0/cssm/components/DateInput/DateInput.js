 ...
 */ export const DateInput = ({ enableTime , shouldDisableDate , disableFuture , disablePast , value , onChange , calendarPlacement ='bottom-start' , style , className , doneButtonText , closeOnChange =true , disablePickers , getRootRef , name , autoFocus , disabled , onClick , onFocus , prevMonthAriaLabel , nextMonthAriaLabel , showNeighboringMonth , size , changeMonthAriaLabel ='Изменить месяц' , changeYearAriaLabel ='Изменить год' , changeDayAriaLabel ='Изменить день' , changeHoursAriaLabel ='Изменить час' , changeMinutesAriaLabel ='Изменить минуту' , clearFieldAriaLabel ='Очистить поле' , showCalendarAriaLabel ='Показать календарь' , viewDate , onHeaderChange , onNextMonth , onPrevMonth , prevMonthIcon , nextMonthIcon , disableCalendar =false , ...props })=>{
