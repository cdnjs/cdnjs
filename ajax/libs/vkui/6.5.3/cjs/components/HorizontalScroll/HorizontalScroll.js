...
const HorizontalScroll = (_param)=>{
    var { children, getScrollToLeft, getScrollToRight, showArrows = true, arrowSize = 'l', arrowOffsetY, scrollAnimationDuration = SCROLL_ONE_FRAME_TIME, getRef, scrollOnAnyWheel = false, inline = false } = _param, restProps = _object_without_properties._(_param, [
        "children",
        "getScrollToLeft",
        "getScrollToRight",
        "showArrows",
    ...
    const [directionRef, textDirection] = (0, _useDirection.useDirection)();
   ...
   */ const onwheel = _react.useCallback((e)=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
        baseClassName: (0, _vkjs.classNames)("vkuiHorizontalScroll", 'vkuiInternalHorizontalScroll', showArrows === 'always' && "vkuiHorizontalScroll--withConstArrows", inline && "vkuiHorizontalScroll--inline"),
        onMouseEnter: calculateArrowsVisibility,
        children: [
            showArrows && (hasPointer || hasPointer === undefined) && canScrollLeft && /*#__PURE__*/ (0, _jsxruntime.jsx)(_ScrollArrow.ScrollArrow, {
            ...
            showArrows && (hasPointer || hasPointer === undefined) && canScrollRight && /*#__PURE__*/ (0, _jsxruntime.jsx)(_ScrollArrow.ScrollArrow, {
                "data-testid": process.env.NODE_ENV === 'test' ? 'ScrollArrow' : undefined,
                size: arrowSize,
                offsetY: arrowOffsetY,
                direction: "right",
