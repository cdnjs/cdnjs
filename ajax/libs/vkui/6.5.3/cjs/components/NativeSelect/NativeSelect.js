 ...
 */ const NativeSelect = (_param)=>{
    var { style, align, placeholder, children, className, getRef, getRootRef, disabled, multiline, selectType = 'default', status, icon = /*#__PURE__*/ (0, _jsxruntime.jsx)(_DropdownIcon.DropdownIcon, {}), before, onChange } = _param, restProps = _object_without_properties._(_param, [
        "style",
        "align",
        "placeholder",
        "children",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_FormField.FormField, {
        Component: "div",
        ...
        children: [
            /*#__PURE__*/ (0, _jsxruntime.jsxs)("select", _object_spread_props._(_object_spread._({}, restProps), {
                disabled: disabled,
