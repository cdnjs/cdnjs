 ...
 */ export const DateRangeInput = ({ shouldDisableDate, disableFuture, disablePast, value, onChange, calendarPlacement = 'bottom-start', style, className, closeOnChange = true, disablePickers, getRootRef, name, autoFocus, disabled, onClick, onFocus, prevMonthAriaLabel, nextMonthAriaLabel, changeDayAriaLabel, changeMonthAriaLabel, changeYearAriaLabel, changeStartDayAriaLabel = 'Изменить день начала', changeStartMonthAriaLabel = 'Изменить месяц начала', changeStartYearAriaLabel = 'Изменить год начала', changeEndDayAriaLabel = 'Изменить день окончания', changeEndMonthAriaLabel = 'Изменить месяц окончания', changeEndYearAriaLabel = 'Изменить год окончания', clearFieldAriaLabel = 'Очистить поле', showCalendarAriaLabel = 'Показать календарь', prevMonthIcon, nextMonthIcon, disableCalendar = false, ...props })=>{
