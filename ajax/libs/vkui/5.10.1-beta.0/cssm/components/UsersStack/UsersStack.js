 ...
 */ export const UsersStack = ({ photos = [], visibleCount = 3, count = Math.max(0, photos.length - visibleCount), size = 'm', layout, children, direction: directionProp = 'row', ...restProps })=>{
    const cmpId = useId();
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        ...restProps,
        baseClassName: classNames('vkuiInternalUsersStack', styles['UsersStack'], stylesSize[size], stylesDirection[direction])
