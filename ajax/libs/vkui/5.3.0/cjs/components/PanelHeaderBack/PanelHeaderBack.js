...
var PanelHeaderBack = function(_param) {
    var label = _param.label, tmp = _param["aria-label"], ariaLabel = tmp === void 0 ? "Назад" : tmp, className = _param.className, restProps = _objectWithoutProperties(_param, [
        "label",
        "aria-label",
        "className"
    ]);
    ...
    return /*#__PURE__*/ _react.createElement(_panelHeaderButton.PanelHeaderButton, _objectSpreadProps(_objectSpread({}, restProps), {
