...
var Tappable = function(_param) {
   ...
   */ function onKeyDown(e) {
    ...
    var classes = (0, _vkjs.classNames)(className, "vkuiTappable", "vkuiInternalTappable", platform === _platform.Platform.IOS && "vkuiTappable--ios", sizeX !== _adaptivity.SizeType.REGULAR && sizeXClassNames[sizeX], hasHoverContext && "vkuiTappable--hover-has", hasActive && "vkuiTappable--hasActive", hasHover && hovered && !isPresetHoverMode && hoverMode, hasActive && active && !isPresetActiveMode && activeMode, focusVisible && !isPresetFocusVisibleMode && focusVisibleMode, hasHover && hovered && isPresetHoverMode && ({
