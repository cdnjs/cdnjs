...
var View = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(false), 2), animated = _React_useState[0], setAnimated = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState([
        activePanelProp
    ]), 2), visiblePanels = _React_useState1[0], setVisiblePanels = _React_useState1[1];
    var _React_useState2 = _slicedToArray(_react.useState(activePanelProp), 2), activePanel = _React_useState2[0], setActivePanel = _React_useState2[1];
    var _React_useState3 = _slicedToArray(_react.useState(undefined), 2), isBack = _React_useState3[0], setIsBack = _React_useState3[1];
    var _React_useState4 = _slicedToArray(_react.useState(null), 2), prevPanel = _React_useState4[0], setPrevPanel = _React_useState4[1];
    var _React_useState5 = _slicedToArray(_react.useState(null), 2), nextPanel = _React_useState5[0], setNextPanel = _React_useState5[1];
    var _React_useState6 = _slicedToArray(_react.useState(false), 2), swipingBack = _React_useState6[0], setSwipingBack = _React_useState6[1];
    var _React_useState7 = _slicedToArray(_react.useState(false), 2), swipeBackPrevented = _React_useState7[0], setSwipeBackPrevented = _React_useState7[1];
    var _React_useState8 = _slicedToArray(_react.useState(0), 2), swipeBackStartX = _React_useState8[0], setSwipeBackStartX = _React_useState8[1];
    var _React_useState9 = _slicedToArray(_react.useState(0), 2), swipeBackShift = _React_useState9[0], setSwipeBackShift = _React_useState9[1];
    var _React_useState10 = _slicedToArray(_react.useState(null), 2), swipeBackNextPanel = _React_useState10[0], setSwipeBackNextPanel = _React_useState10[1];
    var _React_useState11 = _slicedToArray(_react.useState(null), 2), swipeBackPrevPanel = _React_useState11[0], setSwipeBackPrevPanel = _React_useState11[1];
    var _React_useState12 = _slicedToArray(_react.useState(null), 2), swipeBackResult = _React_useState12[0], setSwipeBackResult = _React_useState12[1];
    var _React_useState13 = _slicedToArray(_react.useState(false), 2), browserSwipe = _React_useState13[0], setBrowserSwipe = _React_useState13[1];
    ...
    var disableAnimation = (configProvider === null || configProvider === void 0 ? void 0 : configProvider.transitionMotionEnabled) === false || !(splitCol === null || splitCol === void 0 ? void 0 : splitCol.animate) || platform === _platform.Platform.VKCOM;
    ...
    var onMoveX = function(event) {
        ...
        if (!(configProvider === null || configProvider === void 0 ? void 0 : configProvider.isWebView)) {
