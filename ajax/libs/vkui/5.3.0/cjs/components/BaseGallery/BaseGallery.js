...
var BaseGallery = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(SHIFT_DEFAULT_STATE), 2), shiftState = _React_useState[0], setShiftState = _React_useState[1];
   ...
   */ var getTarget = function(e) {
    ...
    var onEnd = function(e) {
        ...
        setShiftState(function(prevState) {
            return _objectSpread({}, prevState, nextShiftState);
        });
        if (targetIndex !== slideIndex) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, restProps), {
        className: (0, _vkjs.classNames)("vkuiBaseGallery", "vkuiInternalBaseGallery", align === "center" && "vkuiBaseGallery--align-center", slideWidth === "custom" && "vkuiBaseGallery--custom-width", isDraggable && "vkuiBaseGallery--draggable", className),
        ref: rootRef
        ...
        "aria-hidden": true,
        className: (0, _vkjs.classNames)("vkuiBaseGallery__bullets", {
    ...
    })), showArrows && hasPointer && canSlideLeft && /*#__PURE__*/ _react.createElement(_horizontalScrollArrow.HorizontalScrollArrow, {
        direction: "left",
        onClick: slideLeft,
        size: arrowSize
    }), showArrows && hasPointer && canSlideRight && /*#__PURE__*/ _react.createElement(_horizontalScrollArrow.HorizontalScrollArrow, {
        direction: "right",
        onClick: slideRight,
        size: arrowSize
    }));
