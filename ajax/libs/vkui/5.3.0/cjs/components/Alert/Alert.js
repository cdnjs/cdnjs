...
var AlertText = function(props) {
    ...
    switch(platform){
        ...
        default:
            return /*#__PURE__*/ _react.createElement(_text.Text, _objectSpread({
                Component: "span",
                className: "vkuiAlert__text",
                weight: "3"
            }, props));
...
var AlertAction = function(_param) {
    var action = _param.action, onItemClick = _param.onItemClick, restProps = _objectWithoutProperties(_param, [
        "action",
        "onItemClick"
    ]);
    var platform = (0, _usePlatform.usePlatform)();
    ...
    if (platform === _platform.Platform.IOS) {
        var title = action.title, actionProp = action.action, autoClose = action.autoClose, mode = action.mode, restActionProps = _objectWithoutProperties(action, [
            "title",
            "action",
            "autoClose",
            "mode"
...
var Alert = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement(_popoutWrapper.PopoutWrapper, {
        ...
        style: style,
        onClick: close
    }, /*#__PURE__*/ _react.createElement(_focusTrap.FocusTrap, _objectSpreadProps(_objectSpread({}, restProps), {
