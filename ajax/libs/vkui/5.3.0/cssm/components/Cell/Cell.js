 ...
 */ export const Cell = ({ mode , onRemove =noop , removePlaceholder ='Удалить' , onDragFinish , before , after , disabled , draggable , Component , onChange , name , value , checked , defaultChecked , getRootRef , draggerLabel ='Перенести ячейку' , className , style , ...restProps })=>{
    ...
    const cellClasses = classNames(styles['Cell'], platform === Platform.IOS && styles['Cell--ios'], dragging && styles['Cell--dragging'], removable && styles['Cell--removable'], selectable && styles['Cell--selectable'], disabled && styles['Cell--disabled']);
