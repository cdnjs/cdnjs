 ...
 */ export const Tappable = ({ children , Component , onClick , onKeyDown: _onKeyDown , activeEffectDelay =ACTIVE_EFFECT_DELAY , stopPropagation =false , getRootRef , hasHover: _hasHover = true , hoverMode ='background' , hasActive: _hasActive = true , activeMode ='background' , focusVisibleMode ='inside' , onEnter , onLeave , className , ...props })=>{
   ...
   */ function onKeyDown(e) {
    ...
    const classes = classNames(className, styles['Tappable'], 'vkuiInternalTappable', platform === Platform.IOS && styles['Tappable--ios'], sizeX !== SizeType.REGULAR && sizeXClassNames[sizeX], hasHoverContext && styles['Tappable--hover-has'], hasActive && styles['Tappable--hasActive'], hasHover && hovered && !isPresetHoverMode && hoverMode, hasActive && active && !isPresetActiveMode && activeMode, focusVisible && !isPresetFocusVisibleMode && focusVisibleMode, hasHover && hovered && isPresetHoverMode && ({
