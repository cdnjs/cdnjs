 ...
 */ export const Pagination = ({ currentPage =1 , siblingCount =1 , boundaryCount =1 , totalPages =1 , disabled , getPageAriaLabel =getPageAriaLabelDefault , prevButtonAriaLabel ='Перейти на предыдущую страницу' , nextButtonAriaLabel ='Перейти на следующую страницу' , getRootRef , onChange , className , ...resetProps })=>{
        ...
        switch(page){
            ...
            case 'end-ellipsis':
                return /*#__PURE__*/ React.createElement("li", {
                    ...
                    className: classNames(styles['Pagination__page'], styles['Pagination__page--type-ellipsis'], pageSizeYClassNames[sizeY], disabled && styles['Pagination__page--disabled'])
                }, "…"));
            default:
                {
                    ...
                    return /*#__PURE__*/ React.createElement("li", {
                        ...
                        className: classNames(styles['Pagination__page'], pageSizeYClassNames[sizeY], isCurrent && styles['Pagination__page--current'], disabled && styles['Pagination__page--disabled']),
