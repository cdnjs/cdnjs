...
export const BaseGallery = ({ bullets =false , getRootRef , children , slideWidth ='100%' , slideIndex =0 , isDraggable: isDraggableProp = true , onDragStart , onDragEnd , onChange , onPrevClick , onNextClick , align ='left' , showArrows , getRef , className , arrowSize ='l' , ...restProps })=>{
   ...
   */ const getTarget = (e)=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...restProps,
        className: classNames(styles['BaseGallery'], 'vkuiInternalBaseGallery', align === 'center' && styles['BaseGallery--align-center'], slideWidth === 'custom' && styles['BaseGallery--custom-width'], isDraggable && styles['BaseGallery--draggable'], className),
        ref: rootRef
