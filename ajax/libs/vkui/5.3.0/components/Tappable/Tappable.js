 ...
 */ export var Tappable = function(_param) {
   ...
   */ function onKeyDown(e) {
    ...
    var classes = classNames(className, "vkuiTappable", "vkuiInternalTappable", platform === Platform.IOS && "vkuiTappable--ios", sizeX !== SizeType.REGULAR && sizeXClassNames[sizeX], hasHoverContext && "vkuiTappable--hover-has", hasActive && "vkuiTappable--hasActive", hasHover && hovered && !isPresetHoverMode && hoverMode, hasActive && active && !isPresetActiveMode && activeMode, focusVisible && !isPresetFocusVisibleMode && focusVisibleMode, hasHover && hovered && isPresetHoverMode && ({
