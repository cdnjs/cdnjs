 ...
 */ export const Snackbar = ({ placement = 'bottom-start', children, layout, action, before, after, duration = 4000, onActionClick = noop, onClose, mode = 'default', subtitle, offsetY, style, getRootRef, ...restProps })=>{
