...
const OnboardingTooltip = (_param)=>{
    var { id: idProp, children, shown: shownProp = true, arrowPadding = _DefaultIcon.DEFAULT_ARROW_PADDING, arrowHeight = _DefaultIcon.DEFAULT_ARROW_HEIGHT, offsetByMainAxis = 0, offsetByCrossAxis = 0, arrowOffset = 0, isStaticArrowOffset = false, onClose, placement: placementProp = 'bottom-start', maxWidth = _TooltipBase.TOOLTIP_MAX_WIDTH, style: styleProp, getRootRef, disableArrow = false, onPlacementChange, disableFlipMiddleware = false } = _param, restProps = _object_without_properties._(_param, [
        "id",
        "children",
        "shown",
        "arrowPadding",
    ...
    if (shown) {
        ...
        tooltip = (0, _createPortal.createPortal)(/*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
            children: [
                /*#__PURE__*/ (0, _jsxruntime.jsx)(_TooltipBase.TooltipBase, _object_spread_props._(_object_spread._({}, restProps), {
                    id: tooltipId,
