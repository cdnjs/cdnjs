...
class ViewInfiniteComponent extends (_React_Component = _react.Component) {
    ...
    disposeTransition() {
        ...
        this.transitionDisposer = _vkjs.noop;
    }
    ...
    constructor(props){
        super(props), _define_property._(this, "swipeBackPrevented", false), _define_property._(this, "scrolls", scrollsCache[(0, _getNavId.getNavId)(this.props, warn)] || {}), _define_property._(this, "transitionFinishTimeout", undefined), _define_property._(this, "animationFinishTimeout", undefined), _define_property._(this, "panelNodes", {}), _define_property._(this, "transitionDisposer", _vkjs.noop), _define_property._(this, "transitionEndHandler", ()=>{
