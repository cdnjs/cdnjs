...
const TabsItem = (_param)=>{
    var { before, children, status, after, selected = false, className, role = 'tab', tabIndex: tabIndexProp, getRootRef, hoverMode = "vkuiTabsItem--hover", activeMode = '', hovered, activated, hasHover, hasActive = false, focusVisibleMode = 'inside' } = _param, restProps = _object_without_properties._(_param, [
        "before",
        "children",
        "status",
        "after",
    ...
    if ((0, _vkjs.hasReactNode)(status)) {
        statusComponent = typeof status === 'number' ? /*#__PURE__*/ (0, _jsxruntime.jsxs)(_Subhead.Subhead, {
            Component: "span",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_Tappable.Tappable, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        children: [
            ...
            mode === 'default' && /*#__PURE__*/ (0, _jsxruntime.jsx)("div", {
