 ...
 */ export const ImageBase = ({ alt, crossOrigin, decoding, loading, referrerPolicy, sizes, src, srcSet, useMap, getRef, size = 24, width, height, style, withBorder = true, fallbackIcon: fallbackIconProp, children, onLoad, onError, ...restProps })=>{
