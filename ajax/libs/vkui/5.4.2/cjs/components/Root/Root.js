...
var Root = function(_param) {
    var children = _param.children, _activeView = _param.activeView, onTransition = _param.onTransition, nav = _param.nav, className = _param.className, restProps = _objectWithoutProperties(_param, [
        "children",
        "activeView",
        "onTransition",
        "nav",
    ...
    var _React_useState = _slicedToArray(_react.useState({
