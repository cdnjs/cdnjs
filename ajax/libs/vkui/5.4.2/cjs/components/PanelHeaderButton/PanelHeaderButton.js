...
var PanelHeaderButton = function(_param) {
    var children = _param.children, _param_primary = _param.primary, primary = _param_primary === void 0 ? false : _param_primary, label = _param.label, className = _param.className, restProps = _objectWithoutProperties(_param, [
        "children",
        "primary",
        "label",
        "className"
