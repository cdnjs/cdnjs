...
var AccordionSummary = function(_param) {
    var className = _param.className, after = _param.after, before = _param.before, _param_ExpandIcon = _param.ExpandIcon, ExpandIcon = _param_ExpandIcon === void 0 ? _icons.Icon24ChevronDown : _param_ExpandIcon, _param_CollapseIcon = _param.CollapseIcon, CollapseIcon = _param_CollapseIcon === void 0 ? _icons.Icon24ChevronUp : _param_CollapseIcon, _param_iconPosition = _param.iconPosition, iconPosition = _param_iconPosition === void 0 ? "after" : _param_iconPosition, children = _param.children, restProps = _objectWithoutProperties(_param, [
        "className",
        "after",
        "before",
        "ExpandIcon",
    ...
    return /*#__PURE__*/ _react.default.createElement(_simpleCell.SimpleCell, _objectSpread({
