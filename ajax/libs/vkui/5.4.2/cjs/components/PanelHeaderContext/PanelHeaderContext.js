...
}, _defineProperty(_obj, _adaptivity.SizeType.COMPACT, "vkuiPanelHeaderContext--sizeX-compact"), _defineProperty(_obj, _adaptivity.SizeType.REGULAR, "vkuiPanelHeaderContext--sizeX-regular"), _obj);
var PanelHeaderContext = function(_param) {
    var children = _param.children, onClose = _param.onClose, _param_opened = _param.opened, opened = _param_opened === void 0 ? false : _param_opened, className = _param.className, restProps = _objectWithoutProperties(_param, [
        "children",
        "onClose",
        "opened",
        "className"
    ...
    var _React_useState = _slicedToArray(_react.useState(opened), 2), visible = _React_useState[0], setVisible = _React_useState[1];
    ...
    return /*#__PURE__*/ _react.createElement(_fixedLayout.FixedLayout, _objectSpreadProps(_objectSpread({}, restProps), {
