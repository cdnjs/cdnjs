...
function useCalendar(param) {
    ...
    var _ref;
    var _React_useState = _slicedToArray(_react.useState((_ref = Array.isArray(value) ? value[0] : value) !== null && _ref !== void 0 ? _ref : new Date()), 2), viewDate = _React_useState[0], setViewDate = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(), 2), focusedDay = _React_useState1[0], setFocusedDay = _React_useState1[1];
