...
function useDateInput(param) {
    ...
    var _React_useState = _slicedToArray(_react.useState([]), 2), internalValue = _React_useState[0], setInternalValue = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(null), 2), focusedElement = _React_useState1[0], setFocusedElement = _React_useState1[1];
