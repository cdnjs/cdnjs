 ...
 */ export var CellButton = function(_param) {
    ...
    return /*#__PURE__*/ React.createElement(SimpleCell, _object_spread_props(_object_spread({
        ...
        className: classNames("vkuiCellButton", "vkuiInternalCellButton", mode === "danger" && classNames("vkuiCellButton--mode-danger", "vkuiInternalCellButton--mode-danger"), centered && "vkuiCellButton--centered", className)
    }));
};
