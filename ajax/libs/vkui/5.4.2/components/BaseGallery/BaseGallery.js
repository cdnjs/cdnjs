...
export var BaseGallery = function(_param) {
   ...
   */ var getTarget = function(e) {
    ...
    return /*#__PURE__*/ React.createElement("div", _object_spread_props(_object_spread({}, restProps), {
        className: classNames("vkuiBaseGallery", "vkuiInternalBaseGallery", align === "center" && "vkuiBaseGallery--align-center", slideWidth === "custom" && "vkuiBaseGallery--custom-width", isDraggable && "vkuiBaseGallery--draggable", className),
        ref: rootRef
