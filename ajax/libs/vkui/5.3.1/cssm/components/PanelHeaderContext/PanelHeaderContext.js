 ...
 */ export const PanelHeaderContext = ({ children , onClose , opened =false , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(FixedLayout, {
        ...restProps,
        className: classNames(styles['PanelHeaderContext'], platform === Platform.IOS && styles['PanelHeaderContext--ios'], opened && styles['PanelHeaderContext--opened'], closing && styles['PanelHeaderContext--closing'], sizeXClassNames[sizeX], styles['PanelHeaderContext--rounded'], className),
        vertical: "top"
