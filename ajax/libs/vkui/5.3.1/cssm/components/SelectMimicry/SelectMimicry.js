 ...
 */ export const SelectMimicry = ({ tabIndex =0 , placeholder , children , align , getRootRef , multiline , disabled , onClick , before , after =/*#__PURE__*/ React.createElement(DropdownIcon, null) , selectType ='default' , status , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(FormField, {
        ...
        className: classNames(styles['Select'], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], !children && styles['Select--empty'], multiline && styles['Select--multiline'], align === 'center' && styles['Select--align-center'], align === 'right' && styles['Select--align-right'], before && styles['Select--hasBefore'], after && styles['Select--hasAfter'], className),
