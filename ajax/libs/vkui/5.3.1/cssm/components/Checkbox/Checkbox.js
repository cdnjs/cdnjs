 ...
 */ export const Checkbox = ({ children , className , style , getRootRef , getRef , description , indeterminate , defaultIndeterminate , hoverMode , activeMode , hasHover , hasActive , focusVisibleMode , onChange , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Tappable, {
        ...
        className: styles['Checkbox__children']
