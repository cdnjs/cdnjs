 ...
 */ export const Tabbar = ({ children , shadow =true , mode , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: classNames(styles['Tabbar'], platform === Platform.IOS && styles['Tabbar--ios'], getItemsLayoutClassName(mode, children), shadow && styles['Tabbar--shadow'], className),
        ...restProps
    }, /*#__PURE__*/ React.createElement("div", {
        className: styles['Tabbar__in']
    }, children));
};
