...
const sizeYClassNames = {
    ...
    [SizeType.COMPACT]: classNames(styles['FormItem--sizeY-compact'], 'vkuiInternalFormItem--sizeY-compact')
};
/**
 ...
 */ export const FormItem = ({ children , top , bottom , status ='default' , Component ='div' , removable , onRemove =noop , removePlaceholder ='Удалить' , getRootRef , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Component, {
        ...restProps,
        ref: rootEl,
        className: classNames(styles['FormItem'], 'vkuiInternalFormItem', status !== 'default' && ({
        ...
        })[status], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], hasReactNode(top) && classNames(styles['FormItem--withTop'], 'vkuiInternalFormItem--withTop'), removable && classNames(styles['FormItem--removable'], 'vkuiInternalFormItem--removable'), className)
