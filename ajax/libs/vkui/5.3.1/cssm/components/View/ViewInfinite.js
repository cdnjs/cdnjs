...
class ViewInfiniteComponent extends React.Component {
    ...
    render() {
        ...
        return /*#__PURE__*/ React.createElement(Touch, {
            Component: "section",
            ...restProps,
            className: classNames(styles['View'], platform === Platform.IOS && iosStyles['View--ios'], !disableAnimation && this.state.animated && styles['View--animated'], !disableAnimation && this.state.swipingBack && styles['View--swiping-back'], disableAnimation && styles['View--no-motion'], className),
