 ...
 */ export const Placeholder = ({ icon , header , action , children , stretched , getRootRef , className , ...restProps })=>/*#__PURE__*/ React.createElement("div", {
        ...restProps,
        ref: getRootRef,
        className: classNames(styles['Placeholder'], stretched && styles['Placeholder--stretched'], className)
    }, /*#__PURE__*/ React.createElement("div", {
        className: styles['Placeholder__in']
