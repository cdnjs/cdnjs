 ...
 */ export var Avatar = function(_param) {
    var _param_size = _param.size, size = _param_size === void 0 ? AVATAR_DEFAULT_SIZE : _param_size, className = _param.className, gradientColor = _param.gradientColor, initials = _param.initials, fallbackIcon = _param.fallbackIcon, children = _param.children, restProps = _object_without_properties(_param, [
        "size",
        "className",
        "gradientColor",
        "initials",
