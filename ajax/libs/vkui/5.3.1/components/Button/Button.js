 ...
 */ export var Button = function(_param) {
    ...
    return /*#__PURE__*/ React.createElement(Tappable, _object_spread_props(_object_spread({
        ...
        }[align], sizeY !== SizeType.COMPACT && sizeYClassNames[sizeY], platform === Platform.ANDROID && "vkuiButton--android", platform === Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && !stretched && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
