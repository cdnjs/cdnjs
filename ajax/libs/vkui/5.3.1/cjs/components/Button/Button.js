...
var Button = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement(_tappable.Tappable, _objectSpreadProps(_objectSpread({
        ...
        }[align], sizeY !== _adaptivity.SizeType.COMPACT && sizeYClassNames[sizeY], platform === _platform.Platform.ANDROID && "vkuiButton--android", platform === _platform.Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && !stretched && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
