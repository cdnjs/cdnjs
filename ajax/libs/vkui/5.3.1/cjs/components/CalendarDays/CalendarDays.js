...
var CalendarDays = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _objectSpreadProps(_objectSpread({}, props), {
        ...
        /*#__PURE__*/ return _react.createElement("div", {
            className: (0, _vkjs.classNames)("vkuiCalendarDays__row", size === "s" && "vkuiCalendarDays__row--size-s"),
            key: i
        }, week.map(function(day, i) {
            var sameMonth = (0, _date.isSameMonth)(day, viewDate);
            return /*#__PURE__*/ _react.createElement(_calendarDay.CalendarDay, _objectSpread({
                key: day.toISOString(),
                day: day,
