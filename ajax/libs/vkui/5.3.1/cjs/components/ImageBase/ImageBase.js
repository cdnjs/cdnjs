...
var ImageBase = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(false), 2), loaded = _React_useState[0], setLoaded = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(false), 2), failed = _React_useState1[0], setFailed = _React_useState1[1];
