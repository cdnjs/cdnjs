...
var Popover = function(_param) {
    ...
    var _React_useState = _slicedToArray(_react.useState(shownProp || false), 2), computedShown = _React_useState[0], setComputedShown = _React_useState[1];
    var _React_useState1 = _slicedToArray(_react.useState(null), 2), dropdownNode = _React_useState1[0], setPopperNode = _React_useState1[1];
    ...
    return /*#__PURE__*/ _react.createElement(_react.Fragment, null, child, shown && /*#__PURE__*/ _react.createElement(_popper.Popper, _objectSpreadProps(_objectSpread({}, restProps), {
        ...
        _objectSpreadProps(_objectSpread({}, styleProp), {
