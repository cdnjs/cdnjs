...
var SelectMimicry = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement(_formField.FormField, _objectSpreadProps(_objectSpread({}, restProps), {
        tabIndex: disabled ? undefined : tabIndex,
        className: (0, _vkjs.classNames)("vkuiSelect", sizeY !== _adaptivity.SizeType.REGULAR && sizeYClassNames[sizeY], !children && "vkuiSelect--empty", multiline && "vkuiSelect--multiline", align === "center" && "vkuiSelect--align-center", align === "right" && "vkuiSelect--align-right", before && "vkuiSelect--hasBefore", after && "vkuiSelect--hasAfter", className),
