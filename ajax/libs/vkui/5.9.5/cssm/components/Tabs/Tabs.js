 ...
 */ export const Tabs = ({ children, mode = 'default', role = 'tablist', ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        ...restProps,
        baseClassName: classNames(styles['Tabs'], 'vkuiInternalTabs', platform === Platform.VKCOM && 'vkuiInternalTabs--vkcom', withGaps && classNames(styles['Tabs--withGaps'], 'vkuiInternalTabs--withGaps'), mode === 'default' && styles['Tabs--mode-default']),
        role: role
