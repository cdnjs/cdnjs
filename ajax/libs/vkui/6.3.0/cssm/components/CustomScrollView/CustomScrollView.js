...
export const CustomScrollView = ({ className, children, boxRef: externalBoxRef, windowResize, autoHideScrollbar = false, autoHideScrollbarDelay, onScroll, getRootRef, overscrollBehavior = 'auto', ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs("div", {
        ...
        children: [
            /*#__PURE__*/ _jsx("div", {
                className: classNames(styles['CustomScrollView__box'], overscrollBehaviorClassNames[overscrollBehavior]),
                tabIndex: -1,
                ref: boxRef,
                onScroll: scroll,
