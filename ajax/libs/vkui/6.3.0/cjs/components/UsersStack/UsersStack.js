...
function PathElement(_param) {
    ...
    switch(direction){
        case 'circle':
            ...
            return /*#__PURE__*/ (0, _jsxruntime.jsx)("circle", _object_spread._({
                cx: radius,
                cy: radius,
                r: radius
            }, props));
        case 'right':
            switch(photoSize){
                case 24:
                    return /*#__PURE__*/ (0, _jsxruntime.jsx)("path", _object_spread._({
...
const UsersStack = (_param)=>{
    ...
    const photosElements = photos.slice(0, visibleCount).map((photo, i)=>{
        ...
        let photoElement = /*#__PURE__*/ (0, _jsxruntime.jsxs)("svg", {
            ...
            children: [
                /*#__PURE__*/ (0, _jsxruntime.jsx)("defs", {
                    children: /*#__PURE__*/ (0, _jsxruntime.jsx)(PathElement, {
                        id: id,
                        direction: direction,
                        photoSize: photoSize
                    })
    ...
    const othersElement = canShowOthers ? /*#__PURE__*/ (0, _jsxruntime.jsx)("div", {
        className: "vkuiUsersStack__photoWrapper",
        children: /*#__PURE__*/ (0, _jsxruntime.jsxs)(CounterTypography, {
            caps: true,
            weight: "1",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        children: [
            (photosElements.length > 0 || othersElement) && /*#__PURE__*/ (0, _jsxruntime.jsxs)("div", {
            ...
            (0, _vkjs.hasReactNode)(children) && /*#__PURE__*/ (0, _jsxruntime.jsx)(_Footnote.Footnote, {
