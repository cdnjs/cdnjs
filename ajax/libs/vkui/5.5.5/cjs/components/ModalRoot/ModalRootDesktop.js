...
var ModalRootDesktop = function(param) {
    ...
    var _useConfigProvider = (0, _ConfigProviderContext.useConfigProvider)(), webviewType = _useConfigProvider.webviewType, platform = _useConfigProvider.platform;
    ...
    return /*#__PURE__*/ _react.createElement(_ModalRootContext.ModalRootContext.Provider, {
        ...
        className: (0, _vkjs.classNames)("vkuiModalRoot", webviewType === _ConfigProviderContext.WebviewType.VKAPPS && "vkuiModalRoot--vkapps", "vkuiModalRoot--desktop")
    }, /*#__PURE__*/ _react.createElement("div", {
