 ...
 */ export const Slider = ({ // TODO [>=6]: Выставить 1 как значение по умолчанию, чтобы было как в браузерном <input type="range" />
step , min =0 , max =100 , value: valueProp , multiple: multipleProp , defaultValue =multipleProp ? [
    ...
    return /*#__PURE__*/ React.createElement(Touch, {
        ...
        className: classNames(styles['Slider'], disabled && styles['Slider--disabled'], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], className),
        ...
        className: styles['Slider__thumbs']
