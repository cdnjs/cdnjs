    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsxs(RootComponent, {
                ...
                ...restProps,
                tabIndex: tabIndex,
                baseClassName: classNames('vkuiInternalGroup', styles['Group'], sizeX !== 'regular' && sizeXClassNames[sizeX], mode === 'plain' && isInsideModal && styles['Group--mode-plain-inside-modal'], stylesMode[mode], stylesPadding[padding]),
                children: [
