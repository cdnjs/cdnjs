 ...
 */ export const ToolButton = (_param)=>{
    var { mode = 'primary', appearance = 'accent', direction = 'row', onClick = noop, className, children, IconCompact, IconRegular, rounded } = _param, restProps = _object_without_properties(_param, [
        "mode",
        "appearance",
        "direction",
        "onClick",
    ...
    return /*#__PURE__*/ _jsxs(Tappable, _object_spread_props(_object_spread({
        ...
        onClick: onClick,
        className: classNames(className, "vkuiToolButton", rounded && !hasChildren && "vkuiToolButton--rounded", stylesMode[mode], stylesAppearance[appearance], stylesDirection[direction], sizeY !== 'compact' && sizeYClassNames[sizeY])
    }, restProps), {
        children: [
