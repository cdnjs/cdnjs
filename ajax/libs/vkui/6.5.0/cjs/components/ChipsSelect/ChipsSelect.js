...
const ChipsSelect = (_param)=>{
    ...
    getRef, value: valueProp, defaultValue, inputValue: inputValueProp, defaultInputValue, disabled, readOnly, getOptionValue = _constants.getOptionValueDefault, getOptionLabel = _constants.getOptionLabelDefault, getNewOptionData = _constants.getNewOptionDataDefault, renderChip = _constants.renderChipDefault, renderOption = _constants1.renderOptionDefault, onChange, onFocus: onFocusProp, onInputChange: onInputChangeProp, onBlur: onBlurProp, onKeyDown: onKeyDownProp, dropdownOffsetDistance = 0, allowClearButton, clearButtonTestId } = _param, restProps = _object_without_properties._(_param, [
        "id",
        "getRootRef",
        "className",
        "status",
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
        children: [
            /*#__PURE__*/ (0, _jsxruntime.jsx)(_ChipsInputBase.ChipsInputBase, _object_spread_props._(_object_spread._({}, restProps), {
                disabled: disabled,
                readOnly: readOnly,
                ...
                id: labelledbyId,
                getRootRef: rootRef,
                className: (0, _vkjs.classNames)("vkuiChipsSelect", openedClassNames, className),
                status: status,
                after: dropdownIconProp || /*#__PURE__*/ (0, _jsxruntime.jsx)(_DropdownIcon.DropdownIcon, {
                    opened: opened,
            ...
            opened && /*#__PURE__*/ (0, _jsxruntime.jsx)(_CustomSelectDropdown.CustomSelectDropdown, {
                ...
                children: options.map((option, index)=>{
                    ...
                    if ((0, _constants1.isEmptyOptionPreset)(option)) {
                        return /*#__PURE__*/ (0, _jsxruntime.jsx)(_Footnote.Footnote, {
                            className: "vkuiChipsSelect__empty",
                            children: option.placeholder
                        }, "empty-text");
                    }
                    if ((0, _constants1.isCreateNewOptionPreset)(option)) {
                        return /*#__PURE__*/ (0, _jsxruntime.jsx)(_CustomSelectOption.CustomSelectOption, {
                            id: dropdownItemId,
