 ...
 */ export const Banner = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(Tappable, _object_spread_props(_object_spread({
        ...
        baseClassName: classNames("vkuiBanner__host", platform === 'ios' && "vkuiBanner__ios", mode === 'image' && "vkuiBanner__modeImage", size === 'm' && "vkuiBanner__sizeM", mode === 'image' && imageTheme === 'dark' && "vkuiBanner__inverted", className)
    }, restProps), {
        children: [
            content,
            after
