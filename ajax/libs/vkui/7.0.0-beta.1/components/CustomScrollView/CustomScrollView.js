 ...
 */ export const CustomScrollView = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread({
        className: classNames(className, "vkuiCustomScrollView__host", enableHorizontalScroll && "vkuiCustomScrollView__horizontalScrollEnabled", overscrollBehaviorClassNames[overscrollBehavior], scrollbarHidden && "vkuiCustomScrollView__scrollbarHidden"),
        ref: getRootRef,
        onScroll: onScroll
    }, restProps), {
        children: children
