 ...
 */ export function CustomSelect(props) {
    ...
    var _props_value;
    const [selectedOptionIndex, setSelectedOptionIndex] = React.useState(findSelectedIndex(optionsProp, (_props_value = props.value) !== null && _props_value !== void 0 ? _props_value : defaultValue, allowClearButton));
    React.useEffect(()=>{
