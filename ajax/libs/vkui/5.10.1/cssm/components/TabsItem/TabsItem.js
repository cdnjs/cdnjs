 ...
 */ export const TabsItem = ({ before, children, status, after, selected = false, className, role = 'tab', tabIndex: tabIndexProp, getRootRef, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Tappable, {
        ...restProps,
        getRootRef: rootRef,
        className: classNames(styles['TabsItem'], mode && stylesMode[mode], selected && styles['TabsItem--selected'], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], withGaps && styles['TabsItem--withGaps'], layoutFillMode !== 'auto' && fillModeClassNames[layoutFillMode], className),
