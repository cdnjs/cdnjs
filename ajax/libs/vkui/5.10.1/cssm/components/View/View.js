 ...
 */ export const View = ({ activePanel: activePanelProp, history, nav, onTransition, onSwipeBack, onSwipeBackStart, onSwipeBackCancel: onSwipeBackCancelProp, children, className, ...restProps })=>{
    ...
    const disableAnimation = !configProvider.transitionMotionEnabled || !splitCol.animate || platform === Platform.VKCOM;
    const iOSSwipeBackSimulationEnabled = !disableAnimation && platform === Platform.IOS && configProvider.isWebView && Boolean(onSwipeBack);
    const pickPanel = (id)=>{
        if (id === null) {
            return null;
        }
    ...
    const calcPanelSwipeBackOverlayStyles = (panelId)=>{
        ...
        const opacityOnSwipeEnd = swipeBackResult === 2 ? 0 : swipeBackResult === 1 ? 1 : null;
        return {
            display: 'block',
    ...
    React.useEffect(function restoreScrollPositionWhenSwipeBackIsCancelled() {
        ...
        const swipeBackCancelledInTheMiddleOfAction = prevSwipeBackResult === 1 && !swipeBackResult;
    ...
    return /*#__PURE__*/ React.createElement(NavViewIdContext.Provider, {
        ...
        return /*#__PURE__*/ React.createElement("div", {
            className: classNames(styles['View__panel'], panelId === activePanel && styles['View__panel--active'], panelId === prevPanel && styles['View__panel--prev'], panelId === nextPanel && styles['View__panel--next'], panelId === swipeBackPrevPanel && styles['View__panel--swipe-back-prev'], panelId === swipeBackNextPanel && styles['View__panel--swipe-back-next'], swipeBackResult === 2 && styles['View__panel--swipe-back-success'], swipeBackResult === 1 && styles['View__panel--swipe-back-failed']),
