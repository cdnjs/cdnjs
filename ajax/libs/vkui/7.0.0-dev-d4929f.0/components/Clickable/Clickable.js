 ...
 */ const RealClickable = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({
        baseClassName: classNames(baseClassName, "Clickable__realClickable--xJHDn", focusVisibleClassNames, stateClassName)
    }, handlers, restProps), {
...
const getUserAgentResetClassName = (Component)=>{
    if (Component === 'a') {
        return "Clickable__resetLinkStyle--q1sBr";
    }
    if (Component === 'button') {
        return "Clickable__resetButtonStyle--ajcZ8";
    }
    return;
};
/**
 ...
 */ export const Clickable = (_param)=>{
    ...
    const baseClassName = classNames(baseClassNameProp, getUserAgentResetClassName(commonProps.Component), "Clickable__host--odsbW");
    if (isClickable) {
