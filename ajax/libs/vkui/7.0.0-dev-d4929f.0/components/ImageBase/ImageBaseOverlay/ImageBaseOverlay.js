    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread(_object_spread_props(_object_spread({}, restProps), {
                tabIndex: 0,
                role: "button",
                className: classNames("ImageBaseOverlay__clickable--hEysf", (focusVisible || overlayShown) && "ImageBaseOverlay__visible--vJ4UM", focusVisibleClassNames, className),
                ref: getRootRef,
...
const ImageBaseOverlayNonInteractive = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread({}, restProps), {
        ref: rootRef,
        className: classNames((overlayShown || overlayShownProps) && "ImageBaseOverlay__visible--vJ4UM", className),
 ...
 */ export const ImageBaseOverlay = (_param)=>{
    ...
    const commonClassNames = classNames("ImageBaseOverlay__host--7b5sl", theme === 'light' && "ImageBaseOverlay__themeLight--Im0Kk", theme === 'dark' && "ImageBaseOverlay__themeDark--jXgY2", className);
    const commonProps = {
