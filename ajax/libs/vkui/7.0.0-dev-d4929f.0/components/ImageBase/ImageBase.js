...
const getObjectFitClassName = (objectFit)=>{
    switch(objectFit){
        case 'contain':
            return "ImageBase__imgObjectFitContain--fOmx4";
        case 'cover':
            return "ImageBase__imgObjectFitCover--vSbMS";
        case 'none':
            return "ImageBase__imgObjectFitNone--VhkVA";
        case 'scale-down':
            return "ImageBase__imgObjectFitScaleDown--M6Wk3";
    }
    return undefined;
};
const parsePx = (value)=>{
 ...
 */ export const ImageBase = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(ImageBaseContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsxs(Clickable, _object_spread_props(_object_spread({
            ...
            baseClassName: classNames("ImageBase__host--IXx3Y", loaded && "ImageBase__loaded--UX3Ez", withTransparentBackground && "ImageBase__transparentBackground--Le6rc")
        }, restProps), {
            children: [
                hasSrc && /*#__PURE__*/ _jsx("img", _object_spread({
                    ref: imgRef,
                    alt: alt,
                    className: classNames("ImageBase__img--92i3F", getObjectFitClassName(objectFit), keepAspectRatio && "ImageBase__imgKeepRatio--dlLFo"),
                ...
                fallbackIcon && /*#__PURE__*/ _jsx("div", {
                    className: "ImageBase__fallback---MbKn",
                    children: fallbackIcon
                }),
                children && /*#__PURE__*/ _jsx("div", {
                    className: "ImageBase__children--DXasq",
                    children: children
                }),
                !noBorder && /*#__PURE__*/ _jsx("div", {
                    "aria-hidden": true,
                    className: "ImageBase__border--euTPv"
                })
            ]
        }))
    });
