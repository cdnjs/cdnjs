...
const sizeYClassNames = {
    none: classNames("FormItem__sizeYNone--j9K8r", 'vkuiInternalFormItem--sizeY-none'),
    compact: classNames("FormItem__sizeYCompact--gGxiK", 'vkuiInternalFormItem--sizeY-compact')
};
const stylesStatus = {
    error: classNames("FormItem__statusError--hF6M1", 'vkuiInternalFormItem--status-error'),
    valid: classNames("FormItem__statusValid--xr-oi", 'vkuiInternalFormItem--status-valid')
};
/**
 ...
 */ export const FormItem = (_param)=>{
    ...
    const wrappedChildren = /*#__PURE__*/ _jsxs(React.Fragment, {
        children: [
            ...
            hasReactNode(bottom) && /*#__PURE__*/ _jsx(Footnote, {
                className: "FormItem__bottom---2jr1",
                id: bottomId,
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        getRootRef: rootEl,
        baseClassName: classNames("FormItem__host--Qie-R", !noPadding && "FormItem__withPadding--p2fsy", 'vkuiInternalFormItem', status !== 'default' && stylesStatus[status], sizeY !== 'regular' && sizeYClassNames[sizeY], hasReactNode(top) && classNames("FormItem__withTop--V7kDI", 'vkuiInternalFormItem--withTop'), removable && classNames("FormItem__withRemovable--ukQTL", 'vkuiInternalFormItem--removable')),
        children: /*#__PURE__*/ _jsx(FormItemContext.Provider, {
            ...
            children: removable ? /*#__PURE__*/ _jsx(Removable, {
                ...
                children: /*#__PURE__*/ _jsx("div", {
                    className: classNames("FormItem__removable--HYTbb", 'vkuiInternalFormItem__removable'),
