 ...
 */ export const Search = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs("div", {
        className: classNames('vkuiInternalSearch', "Search__host--d3Sgv", sizeY === 'none' && "Search__sizeYNone--k9jdq", sizeY === 'compact' && "Search__sizeYCompact--gHkc9", isFocused && "Search__focused--hItoW", hasValue && "Search__hasValue--1BF87", hasAfter && "Search__hasAfter--X5OBU", iconProp && "Search__hasIcon--RWWiS", inputProps.disabled && "Search__disabled--i0B4d", !noPadding && "Search__withPadding--6Hmyc", className),
        ref: getRootRef,
        style: style,
        children: [
            /*#__PURE__*/ _jsxs("div", {
                className: "Search__field--6tYk-",
                children: [
                    /*#__PURE__*/ _jsx("label", {
                        htmlFor: inputId,
                        className: "Search__label--QRHHj",
                        children: placeholder
                    }),
                    /*#__PURE__*/ _jsxs("div", {
                        className: "Search__input--sjnK8",
                        children: [
                            before,
                            /*#__PURE__*/ _jsx(Headline, _object_spread_props(_object_spread({
                                ...
                                getRootRef: inputRef,
                                className: "Search__nativeInput--LeArw",
                                onFocus: onFocus,
                                onBlur: onBlur,
                    ...
                    /*#__PURE__*/ _jsxs("div", {
                        className: "Search__controls--Lj3vY",
                        children: [
                            ...
                            adaptiveSizeY.compact && onFindButtonClick && /*#__PURE__*/ _jsx(Button, {
                                mode: "primary",
                                size: "m",
                                className: classNames("Search__findButton--rV9oh", adaptiveSizeY.compact.className),
            ...
            hasAfter && /*#__PURE__*/ _jsx("div", {
                ...
                children: /*#__PURE__*/ _jsx(Button, {
                    ...
                    children: /*#__PURE__*/ _jsx("span", {
                        className: "Search__afterTextClip--t9WO-",
                        children: after
                    })
                })
            })
