 ...
 */ const NativeSelect = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(FormField, {
        Component: "div",
        className: classNames("Select__host--75d0g", 'vkuiInternalNativeSelect', before && "Select__hasBefore--kS-rU", empty && "Select__empty--KmYrm", multiline && "Select__multiline--hfSXV", align === 'center' && "Select__alignCenter--En5CZ", align === 'right' && "Select__alignRight--sxXgj", sizeY !== 'regular' && sizeYClassNames[sizeY], className),
        style: style,
