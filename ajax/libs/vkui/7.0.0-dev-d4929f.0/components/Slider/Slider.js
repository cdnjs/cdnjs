...
const sizeYClassNames = {
    none: "Slider__sizeYNone--c-4ey",
    compact: "Slider__sizeYCompact--dws6T"
};
const sizeClassNames = {
    l: "Slider__sizeL--P1DJw",
    m: "Slider__sizeM--8pRUU",
    s: "Slider__sizeS--Vffc5"
};
/**
 ...
 */ export const Slider = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(Touch, _object_spread_props(_object_spread({
        ...
        className: classNames("Slider__host--HyTZ3", disabled && "Slider__disabled--lOP--", sizeY !== 'regular' && sizeYClassNames[sizeY], sizeClassNames[size], className),
        ...
        children: [
            /*#__PURE__*/ _jsx("div", {
                className: "Slider__track--kaJkL"
            }),
            /*#__PURE__*/ _jsx("div", {
                className: "Slider__trackFill--14e9I",
                style: multiple ? {
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                className: "Slider__thumbs--LFiKI",
                children: [
                    /*#__PURE__*/ _jsx(SliderThumb, {
                        "data-type": "start",
                        className: "Slider__thumb--Dc5w2",
                        style: {
                            left: `${startValueInPercent}%`,
