...
const stylesBullets = {
    dark: "BaseGallery__bulletsDark--mU0q7",
    light: "BaseGallery__bulletsLight--xdSA2"
};
...
export const CarouselBase = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("BaseGallery__host--33dcc", slideWidth === 'custom' && "BaseGallery__customWidth--dM-b4", isDraggable && "BaseGallery__draggable--n6W80"),
        getRootRef: rootRef,
        children: [
            /*#__PURE__*/ _jsx(Touch, {
                className: "BaseGallery__viewport--dGWTx",
                onStartX: onStart,
                onMoveX: onMoveX,
                onEnd: onEnd,
                style: {
                ...
                children: /*#__PURE__*/ _jsx("div", {
                    className: "BaseGallery__layer--5htz1",
                    ref: layerRef,
                    children: React.Children.map(children, (item, i)=>/*#__PURE__*/ _jsx("div", {
                            className: "BaseGallery__slide--uTbNE",
            ...
            bullets && /*#__PURE__*/ _jsx("div", {
                "aria-hidden": true,
                className: classNames("BaseGallery__bullets--t1w-x", stylesBullets[bullets]),
                children: React.Children.map(children, (_item, index)=>/*#__PURE__*/ _jsx("div", {
                        className: classNames("BaseGallery__bullet--7wIVz", index === slideIndex && "BaseGallery__bulletActive--qJ9pX")
                    }, index))
            }),
            showArrows && hasPointer && canSlideLeft && /*#__PURE__*/ _jsx(ScrollArrow, {
                className: "BaseGallery__arrow--FZ-4p",
                direction: "left",
                onClick: slideLeft,
                size: arrowSize
            }),
