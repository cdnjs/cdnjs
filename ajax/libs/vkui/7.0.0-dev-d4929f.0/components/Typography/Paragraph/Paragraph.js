...
const sizeYClassNames = {
    none: "Paragraph__sizeYNone--dhqLr",
    compact: "Paragraph__sizeYCompact--h6BTt"
};
/**
 ...
 */ export const Paragraph = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(Typography, _object_spread({
        ...
        normalize: normalize,
        inline: inline,
        className: classNames(className, "Paragraph__host--Vx6kz", sizeY !== 'regular' && sizeYClassNames[sizeY])
    }, restProps));
};
