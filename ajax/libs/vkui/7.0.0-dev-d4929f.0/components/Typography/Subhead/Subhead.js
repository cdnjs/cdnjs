...
const sizeYClassNames = {
    none: "Subhead__sizeYNone--c-wDl",
    compact: "Subhead__sizeYCompact--V6NLJ"
};
/**
 ...
 */ export const Subhead = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(Typography, _object_spread({
        ...
        normalize: normalize,
        inline: inline,
        className: classNames(className, "Subhead__host--yaDHD", sizeY !== 'regular' && sizeYClassNames[sizeY])
    }, restProps));
};
