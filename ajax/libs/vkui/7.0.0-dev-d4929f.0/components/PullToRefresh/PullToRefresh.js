 ...
 */ export const PullToRefresh = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(TouchRootContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsxs(Touch, _object_spread_props(_object_spread({
            ...
            onMove: onTouchMove,
            onEnd: onTouchEnd,
            className: classNames("PullToRefresh__host--2JAqM", platform === 'ios' && "PullToRefresh__ios--i-71j", watching && "PullToRefresh__watching--g3L-t", refreshing && "PullToRefresh__refreshing--O-5j4", className),
            children: [
                /*#__PURE__*/ _jsx(FixedLayout, {
                    className: "PullToRefresh__controls--9WA2o",
                    useParentWidth: true,
                ...
                /*#__PURE__*/ _jsx("div", {
                    className: "PullToRefresh__content--CRzJq",
                    style: {
