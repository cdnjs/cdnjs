...
const sizeYClassNames = {
    none: "CustomSelect__sizeYNone--1CYIo",
    compact: "CustomSelect__sizeYCompact--Mu5u7"
};
 ...
 */ export function CustomSelect(props) {
    ...
    const openedClassNames = React.useMemo(()=>opened && dropdownOffsetDistance === 0 && (popperPlacement.includes('top') ? "CustomSelect__popUp---jvDB" : "CustomSelect__popDown--KQpuW") || undefined, [
        dropdownOffsetDistance,
        opened,
        popperPlacement
    ]);
   ...
   */ const close = React.useCallback(()=>{
    ...
    const resolvedContent = React.useMemo(()=>{
        const defaultDropdownContent = options.length > 0 ? /*#__PURE__*/ _jsx("div", {
            ...
            className: "CustomSelect__empty--a9aSx",
            children: emptyText
        });
    ...
    const clearButton = React.useMemo(()=>{
        ...
        return /*#__PURE__*/ _jsx(ClearButton, {
            className: iconProp === undefined ? "CustomSelect__clearIcon--B8q48" : undefined,
    ...
    const icon = React.useMemo(()=>{
        ...
        return /*#__PURE__*/ _jsx(DropdownIcon, {
            className: clearButtonShown ? "CustomSelect__dropdownIcon--GgYP7" : undefined,
            opened: opened
        });
    }, [
        clearButtonShown,
    ...
    return /*#__PURE__*/ _jsxs("div", {
        className: classNames("CustomSelect__host--Y2Jtu", sizeY !== 'regular' && sizeYClassNames[sizeY], className),
        style: style,
        ref: handleRootRef,
        ...
        children: [
            ...
            /*#__PURE__*/ _jsxs("select", {
                ...
                "aria-hidden": true,
                className: "CustomSelect__control--SM8JV",
