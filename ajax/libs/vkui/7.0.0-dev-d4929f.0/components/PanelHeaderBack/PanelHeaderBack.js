...
const sizeXClassNames = {
    none: "PanelHeaderButton__backSizeXNone--mX5MB",
    compact: "PanelHeaderButton__backSizeXCompact--oZUqV"
};
 ...
 */ export const PanelHeaderBack = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(PanelHeaderButton, _object_spread_props(_object_spread({}, restProps), {
        className: classNames(sizeX !== 'regular' && sizeXClassNames[sizeX], platform === 'ios' && "PanelHeaderButton__backIos--dkuXv", platform === 'vkcom' && "PanelHeaderButton__backVkcom--BuDpO", showLabel && !!label && "PanelHeaderButton__backHasLabel--f2bmT", className),
