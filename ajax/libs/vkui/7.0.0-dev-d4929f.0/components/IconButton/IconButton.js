...
const sizeYClassNames = {
    none: "IconButton__sizeYNone--WFlAF",
    compact: "IconButton__sizeYCompact--nnprb"
};
 ...
 */ export const IconButton = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(Tappable, _object_spread_props(_object_spread({
        ...
        className: classNames("IconButton__host--Q-J9r", sizeY !== 'regular' && sizeYClassNames[sizeY], platform === 'ios' && "IconButton__ios--uJfGx", className),
        children: [
