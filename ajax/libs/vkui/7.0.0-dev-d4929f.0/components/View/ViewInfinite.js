    ...
    render() {
        ...
        return /*#__PURE__*/ _jsx(NavViewIdContext.Provider, {
            ...
            children: /*#__PURE__*/ _jsx(Touch, _object_spread_props(_object_spread({
                ...
                className: classNames("View__host--mdlSy", platform === 'ios' && classNames("View__ios--I6AO3", 'vkuiInternalView--ios'), !disableAnimation && this.state.animated && "View__animated--IOujv", !disableAnimation && this.state.swipingBack && "View__swipingBack--XpMOI", disableAnimation && "View__noMotion--RRqpU", className),
                ...
                children: /*#__PURE__*/ _jsx("div", {
                    ...
                    children: panels.map((panel)=>{
                        ...
                        return /*#__PURE__*/ _jsx("div", {
                            className: classNames("View__panel--Bjhuf", panelId === activePanel && "View__panelActive--dXZ1R", panelId === prevPanel && "View__panelPrev--71gHv", panelId === nextPanel && "View__panelNext--jbBl1", panelId === swipeBackPrevPanel && "View__panelSwipeBackPrev--RtztD", panelId === swipeBackNextPanel && "View__panelSwipeBackNext--LHcI0", swipeBackResult === 'success' && "View__panelSwipeBackSuccess--e5OEN", swipeBackResult === 'fail' && "View__panelSwipeBackFailed--ou9fJ"),
