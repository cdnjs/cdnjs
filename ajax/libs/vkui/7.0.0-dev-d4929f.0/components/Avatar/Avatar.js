...
const gradientStyles = {
    'red': "Avatar__gradientRed--224Ic",
    'orange': "Avatar__gradientOrange--dCZJt",
    'yellow': "Avatar__gradientYellow--nuPwY",
    'green': "Avatar__gradientGreen--elSFY",
    'blue': "Avatar__gradientBlue--LLhrM",
    'l-blue': "Avatar__gradientLBlue---B6kg",
    'violet': "Avatar__gradientViolet--JGwPk"
};
/**
 ...
 */ export const Avatar = (_param)=>{
    ...
    const fallbackIcon = initials ? /*#__PURE__*/ _jsx("div", {
        className: "Avatar__initials--bAEcn",
        style: {
    ...
    return /*#__PURE__*/ _jsx(ImageBase, _object_spread_props(_object_spread({}, restProps), {
        ...
        className: classNames("Avatar__host--d7A9e", gradientName && "Avatar__hasGradient--vsRqE", isGradientNotCustom && gradientStyles[gradientName], className),
        children: children
    }));
};
