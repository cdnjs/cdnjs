...
export const AvatarBadgeWithPreset = (_param)=>{
    ...
    const presetClassName = isOnlinePreset ? "AvatarBadge__presetOnline--jrJqT" : "AvatarBadge__presetOnlineMobile--io7Tk";
    ...
    return /*#__PURE__*/ _jsx(ImageBase.Badge, _object_spread_props(_object_spread({
        background: "stroke",
        className: classNames("AvatarBadge__host---o5jV", presetClassName, className)
    }, restProps), {
