 ...
 */ export const Tabs = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("Tabs__host--6-odF", 'vkuiInternalTabs', platform === 'vkcom' && 'vkuiInternalTabs--vkcom', withGaps && classNames("Tabs__withGaps--G-ct2", 'vkuiInternalTabs--withGaps'), mode === 'default' && "Tabs__modeDefault--pij2u"),
        role: role,
        children: /*#__PURE__*/ _jsx("div", {
            className: "Tabs__in--p6Rw2",
            ref: tabsRef,
