    ...
    if (shown || keepMounted) {
        ...
        if (withArrow) {
            ...
            arrow = /*#__PURE__*/ _jsx(FloatingArrow, _object_spread_props(_object_spread({
                iconClassName: noStyling ? undefined : "Popover__arrow--5A-0e"
            }, arrowProps), {
                coords: arrowCoords,
        ...
        popover = /*#__PURE__*/ _jsx(AppRootPortal, {
            ...
            children: /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread({
                ...
                className: classNames("Popover__host--t8-sk", hidden && "Popover__hidden--U5763")
            }, floatingProps), {
                ...
                children: /*#__PURE__*/ _jsxs(FocusTrap, _object_spread_props(_object_spread({}, restPopoverProps), {
                    role: role,
                    className: classNames("Popover__in--VY43C", noStyling ? undefined : "Popover__inWithStyling--kQVK4", willBeHide ? animationFadeClassNames.out : animationFadeClassNames.in, transformOriginClassNames[resolvedPlacement], className),
                    mount: !hidden,
                    disabled: hidden,
