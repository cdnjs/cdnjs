...
export const ModalRootDesktop = ({ activeModal: activeModalProp, children, noFocusToDialog = false, onOpen, onOpened, onClose, onClosed, modalOverlayTestId })=>{
    ...
    return /*#__PURE__*/ _jsx(ModalRootContext.Provider, {
        ...
        children: /*#__PURE__*/ _jsxs("div", {
            className: classNames("ModalRoot__host--y0j43", hasCustomPanelHeaderAfter && "ModalRoot__hasCustomPanelHeaderAfterSlot--grnw7", "ModalRoot__desktop--u-QHa"),
            children: [
                /*#__PURE__*/ _jsx("div", {
                ...
                /*#__PURE__*/ _jsx("div", {
                    ...
                    children: modals.map((Modal)=>{
                        ...
                        return /*#__PURE__*/ _jsx(FocusTrap, {
                            ...
                            onClose: onExit,
                            timeout: timeout,
                            className: "ModalRoot__modal--ot4eX",
                            children: Modal
                        }, key);
                    })
                })
