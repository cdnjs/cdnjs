...
const sizeYClassNames = {
    none: "CheckboxSimple__sizeYNone--TAe1J",
    compact: "CheckboxSimple__sizeYCompact--eGtmK"
};
export function CheckboxSimple(_param) {
    ...
    return /*#__PURE__*/ _jsx(Tappable, {
        className: classNames(className, "CheckboxSimple__host--atSm-", sizeY !== 'regular' && sizeYClassNames[sizeY]),
        style: style,
