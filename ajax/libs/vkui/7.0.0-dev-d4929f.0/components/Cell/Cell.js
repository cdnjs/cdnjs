 ...
 */ export const Cell = (_param)=>{
    ...
    const dragger = draggable ? /*#__PURE__*/ _jsx(CellDragger, {
        elRef: rootElRef,
        className: classNames("Cell__dragger--Ohc-u", !before && !selectable && "Cell__controlNoBefore--aHp3U"),
    ...
    if (selectable) {
        ...
        checkbox = /*#__PURE__*/ _jsx(CellCheckbox, _object_spread({
            className: classNames("Cell__checkbox--AC9ZV", !before && "Cell__controlNoBefore--aHp3U")
        }, checkboxProps));
    }
    const hasActive = !disabled && !dragging;
    const cellClasses = classNames("Cell__host--2zSBz", dragging && "Cell__dragging--YF8zh", platform === 'ios' && "Cell__ios--z7OG8", removable && "Cell__removable--DQHAk", Component === 'label' && "Cell__selectable--8JBSL");
    const simpleCellProps = _object_spread_props(_object_spread(_object_spread_props(_object_spread({
        hasActive: hasActive,
        hasHover: hasActive && !removable,
        disabled
    }, restProps), {
        className: "Cell__content--v3brf"
    }), Component && {
        Component
    }), {
