...
const placementClassNames = {
    right: "FloatingArrow__placementRight--DG3x5",
    bottom: "FloatingArrow__placementBottom--loE25",
    left: "FloatingArrow__placementLeft--05fV4"
};
/**
 * @private
 */ export const FloatingArrow = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread({
        ref: getRootRef,
        style: arrowStyles,
        className: classNames("FloatingArrow__host--rVvbj", arrowPlacement && placementClassNames[arrowPlacement])
    }, restProps), {
        children: /*#__PURE__*/ _jsx(Icon, {
            className: classNames("FloatingArrow__in--22cQi", iconClassName),
            style: iconStyle
        })
    }));
};
