...
const platformClassNames = {
    ios: "ModalCard__ios--RuCjv",
    android: "ModalCard__android--O3oY4",
    vkcom: "ModalCard__vkcom--XpJ77"
};
const warn = warnOnce('ModalCard');
/**
 * @see https://vkcom.github.io/VKUI/#/ModalCard
 */ export const ModalCard = (_param)=>{
    var { icon, title, titleComponent, description, descriptionComponent, children, actions, onClose, nav, id, size, modalDismissButtonTestId, getRootRef, dismissButtonMode, dismissLabel } = _param, restProps = _object_without_properties(_param, [
        "icon",
        "title",
        "titleComponent",
        "description",
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        ...
        id: id,
        baseClassName: classNames("ModalCard__host--RclEc", platformClassNames.hasOwnProperty(platform) ? platformClassNames[platform] : platformClassNames.android, isDesktop && "ModalCard__desktop--M1zmy"),
        children: /*#__PURE__*/ _jsx(ModalCardBase, {
            className: "ModalCard__in--RMLj8",
