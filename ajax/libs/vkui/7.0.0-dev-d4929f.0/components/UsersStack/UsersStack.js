...
const stylesSize = {
    s: "UsersStack__sizeS--hOmA9",
    m: "UsersStack__sizeM--YocyO",
    l: "UsersStack__sizeL--BDf9B"
};
const avatarsPositionStyles = {
    'inline-start': "UsersStack__avatarsPositionInlineStart---65IK",
    'inline-end': "UsersStack__avatarsPositionInlineEnd--nPSev",
    'block-start': "UsersStack__avatarsPositionBlockStart--CkpFV"
};
 ...
 */ export const UsersStack = (_param)=>{
    ...
    const photosElements = photos.slice(0, visibleCount).map((photo, i)=>{
        ...
        let photoElement = /*#__PURE__*/ _jsxs("svg", {
            ...
            className: "UsersStack__photo--6f2Hb",
            "aria-hidden": true,
            display: "block",
            children: [
                /*#__PURE__*/ _jsx("defs", {
                ...
                /*#__PURE__*/ _jsxs("g", {
                    ...
                    children: [
                        /*#__PURE__*/ _jsx("use", {
                            href: hrefID,
                            className: "UsersStack__fill--cIPO0"
                        }),
                        /*#__PURE__*/ _jsx("image", {
                            href: photoSrc,
                            width: photoSize,
        ...
        return /*#__PURE__*/ _jsx("div", {
            className: "UsersStack__photoWrapper--o8vFn",
            children: photoElement
        }, i);
    });
    const othersElement = canShowOthers ? /*#__PURE__*/ _jsx("div", {
        ...
        children: /*#__PURE__*/ _jsxs(CounterTypography, {
            caps: true,
            weight: "1",
            className: classNames("UsersStack__photo--6f2Hb", "UsersStack__photoOthers--lj2Xn"),
            children: [
                "+",
                count
            ]
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("UsersStack__host--NW03t", stylesSize[size], avatarsPositionStyles[avatarsPosition]),
        children: [
            (photosElements.length > 0 || othersElement) && /*#__PURE__*/ _jsxs("div", {
                className: "UsersStack__photos--duhp9",
                "aria-hidden": true,
                children: [
                    photosElements,
                    othersElement
            ...
            hasReactNode(children) && /*#__PURE__*/ _jsx(Footnote, {
                className: "UsersStack__text--ve6Fx",
                children: children
            })
        ]
    }));
