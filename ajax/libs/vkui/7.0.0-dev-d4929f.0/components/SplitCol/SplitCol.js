...
const breakpointClassNames = {
    none: classNames("SplitCol__viewWidthNone--IEJRN", 'vkuiInternalSplitCol--viewWidth-none'),
    tabletMinus: "SplitCol__viewWidthTabletMinus--oTvqH",
    smallTabletPlus: "SplitCol__viewWidthSmallTabletPlus--OAuCZ",
 ...
 */ export const SplitCol = (props)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        ...
        getRootRef: baseRef,
        baseClassName: classNames("SplitCol__host--a1Axp", viewWidthToClassName(breakpointClassNames, viewWidth), autoSpaced && classNames("SplitCol__spacedAuto--6TJlz", 'vkuiInternalSplitCol--spaced-auto'), fixed && "SplitCol__fixed--FquQu", stretchedOnMobile && "SplitCol__stretchedOnMobile--UM4-z"),
        children: /*#__PURE__*/ _jsx(SplitColContext.Provider, {
            value: contextValue,
            children: fixed ? /*#__PURE__*/ _jsx("div", {
                className: "SplitCol__fixedInner--58v-t",
                children: children
            }) : children
        })
    }));
