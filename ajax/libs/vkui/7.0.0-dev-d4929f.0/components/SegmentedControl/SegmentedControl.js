...
const sizeYClassNames = {
    none: "SegmentedControl__sizeYNone--FGHIr",
    regular: "SegmentedControl__sizeYRegular--uZ3lW"
};
 ...
 */ export const SegmentedControl = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("SegmentedControl__host--tvs4a", sizeY !== 'compact' && sizeYClassNames[sizeY], size === 'l' && "SegmentedControl__sizeL--9aTnU"),
        children: /*#__PURE__*/ _jsxs("div", {
            role: "radiogroup",
            className: "SegmentedControl__in--zic74",
            children: [
                actualIndex > -1 && /*#__PURE__*/ _jsx("div", {
                    "aria-hidden": true,
                    className: "SegmentedControl__slider---1-Gc",
                    style: {
