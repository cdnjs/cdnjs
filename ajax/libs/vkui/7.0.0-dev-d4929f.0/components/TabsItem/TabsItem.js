...
const sizeYClassNames = {
    none: "TabsItem__sizeYNone--ZV-hQ",
    compact: "TabsItem__sizeYCompact--eZVN6"
};
const stylesMode = {
    default: "TabsItem__modeDefault--ym14R",
    accent: "TabsItem__modeAccent--QwYUa",
    secondary: "TabsItem__modeSecondary--fdvLi"
};
const fillModeClassNames = {
    stretched: "TabsItem__stretched--a7ULc",
    shrinked: "TabsItem__shrinked--w85O4"
};
const warn = warnOnce('TabsItem');
/**
 * @see https://vkcom.github.io/VKUI/#/TabsItem
 */ export const TabsItem = (_param)=>{
    var { before, children, status, after, selected = false, className, role = 'tab', tabIndex: tabIndexProp, getRootRef, hoverMode = "TabsItem__hover--12S-3", activeMode = '', hovered, activated, hasHover, hasActive = false, focusVisibleMode = 'inside' } = _param, restProps = _object_without_properties(_param, [
        "before",
        "children",
        "status",
        "after",
    ...
    if (hasReactNode(status)) {
        statusComponent = typeof status === 'number' ? /*#__PURE__*/ _jsxs(Subhead, {
            Component: "span",
            className: classNames("TabsItem__status--7wEHd", "TabsItem__statusCount--tSigX"),
            weight: "2",
            children: [
            ...
            className: "TabsItem__status--7wEHd",
            children: [
                /*#__PURE__*/ _jsx(VisuallyHidden, {
                    children: " "
                }),
    ...
    return /*#__PURE__*/ _jsxs(Tappable, _object_spread_props(_object_spread({}, restProps), {
        getRootRef: rootRef,
        className: classNames("TabsItem__host--HsfkE", mode && stylesMode[mode], selected && "TabsItem__selected--4cjV7", sizeY !== 'regular' && sizeYClassNames[sizeY], withGaps && "TabsItem__withGaps--GaPym", layoutFillMode !== 'auto' && fillModeClassNames[layoutFillMode], className),
        hoverMode: hoverMode,
        ...
        children: [
            before && /*#__PURE__*/ _jsx("div", {
                className: "TabsItem__before--f-QUA",
                children: before
            }),
            /*#__PURE__*/ _jsx(Headline, {
                Component: "span",
                className: "TabsItem__label--vHR17",
            ...
            after && /*#__PURE__*/ _jsx("div", {
                className: "TabsItem__after--vlnrO",
                children: after
            }),
            mode === 'default' && /*#__PURE__*/ _jsx("div", {
                className: "TabsItem__underline--q3diY",
                "aria-hidden": true,
