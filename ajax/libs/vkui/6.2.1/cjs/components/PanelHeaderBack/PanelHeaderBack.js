...
const getBackIcon = (platform)=>{
    switch(platform){
        case 'ios':
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(_icons.Icon28ChevronBack, {});
        case 'vkcom':
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(_AdaptiveIconRenderer.AdaptiveIconRenderer, {
                IconCompact: _icons.Icon20ChevronLeftOutline,
...
const PanelHeaderBack = (_param)=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_PanelHeaderButton.PanelHeaderButton, _object_spread_props._(_object_spread._({}, restProps), {
