...
const Panel = (_param)=>{
    var { centered = false, children, nav, mode: modeProp } = _param, restProps = _object_without_properties._(_param, [
        "centered",
        "children",
        "nav",
        "mode"
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_NavIdContext.NavPanelIdContext.Provider, {
        ...
        children: /*#__PURE__*/ (0, _jsxruntime.jsx)(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
            baseClassName: (0, _vkjs.classNames)("vkuiPanel", sizeXClassNames[sizeX], centered && 'vkuiInternalPanel--centered', stylesMode[mode]),
