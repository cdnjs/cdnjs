...
export var Pagination = function Pagination(_ref) {
    ...
    switch (page) {
      ...
      case "end-ellipsis":
        return /*#__PURE__*/React.createElement("li", {
          ...
          className: classNamesString("vkuiPagination__page", "vkuiPagination__page--type-ellipsis", getSizeYClassName("vkuiPagination__page", sizeY), disabled && "vkuiPagination__page--disabled")
        }, "..."));
      ...
      default:
        {
          ...
          return /*#__PURE__*/React.createElement("li", {
            ...
            className: classNamesString("vkuiPagination__page", getSizeYClassName("vkuiPagination__page", sizeY), _isCurrent && "vkuiPagination__page--current", disabled && "vkuiPagination__page--disabled"),
  ...
  return /*#__PURE__*/React.createElement("nav", _extends({
    className: classNamesString("vkuiPagination", className),
    role: "navigation",
