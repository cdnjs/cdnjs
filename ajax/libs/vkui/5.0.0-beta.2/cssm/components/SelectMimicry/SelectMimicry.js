...
export var SelectMimicry = function SelectMimicry(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, _extends({}, restProps, {
    ...
    className: classNamesString("vkuiSelect", getPlatformClassName("vkuiSelect", platform), getSizeXClassName("vkuiSelect", sizeX), getSizeYClassName("vkuiSelect", sizeY), multiline && "vkuiSelect--multiline", align && styles["Select--align-".concat(align)], before && "vkuiSelect--hasBefore", after && "vkuiSelect--hasAfter", className),
