...
export var ModalPage = function ModalPage(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    id: id,
    className: classNamesString("vkuiModalPage", platform === Platform.IOS && "vkuiModalPage--ios", platform === Platform.VKCOM && "vkuiModalPage--vkcom", getSizeXClassName("vkuiModalPage", sizeX), isDesktop && "vkuiModalPage--desktop", styles["ModalPage--size-".concat(size)], className)
