...
export var ActionSheetDropdownDesktop = function ActionSheetDropdownDesktop(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Popper, {
    ...
    className: classNamesString("vkuiActionSheet", platform === Platform.IOS && "vkuiActionSheet--ios", "vkuiActionSheet--desktop", getSizeYClassName("vkuiActionSheet", sizeY), className),
    style: style,
    getRef: elementRef,
    forcePortal: false
