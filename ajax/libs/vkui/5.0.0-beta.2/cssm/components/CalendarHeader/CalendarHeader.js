...
export var CalendarHeader = function CalendarHeader(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiCalendarHeader", className)
  }, prevMonth && /*#__PURE__*/React.createElement(AdaptivityProvider, {
    sizeX: SizeType.REGULAR
  }, /*#__PURE__*/React.createElement(Tappable, _extends({
    className: classNamesString("vkuiCalendarHeader__nav-icon", "vkuiCalendarHeader__nav-icon-prev", prevMonthClassName),
    onClick: onPrevMonth,
    ...
    className: classNamesString("vkuiCalendarHeader__nav-icon", "vkuiCalendarHeader__nav-icon-next", nextMonthClassName),
    onClick: onNextMonth,
