...
export var Group = function Group(_ref) {
  ...
  var separatorClassName = classNamesString("vkuiGroup__separator", separator === "show" && "vkuiGroup__separator--force");
  return /*#__PURE__*/React.createElement("section", _extends({}, restProps, {
    tabIndex: tabIndex,
    ref: getRootRef,
    className: classNamesString("vkuiGroup", platform === Platform.IOS && "vkuiGroup--ios", getSizeXClassName("vkuiGroup", sizeX), mode && styles["Group--mode-".concat(mode)], styles["Group--padding-".concat(padding)], className)
    ...
    className: classNamesString(separatorClassName, "vkuiGroup__separator--spacing"),
    size: 16
  }), /*#__PURE__*/React.createElement(Separator, {
    className: classNamesString(separatorClassName, "vkuiGroup__separator--separator")
  })));
};
var styles = {
