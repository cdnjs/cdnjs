...
export var SimpleCell = function SimpleCell(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    className: classNamesString("vkuiSimpleCell", getPlatformClassName("vkuiSimpleCell", platform), getSizeYClassName("vkuiSimpleCell", sizeY), expandable && "vkuiSimpleCell--exp", multiline && "vkuiSimpleCell--mult", className)
  }), before, /*#__PURE__*/React.createElement("div", {
    className: "vkuiSimpleCell__main"
  }, subhead && /*#__PURE__*/React.createElement(Subhead, {
    Component: "span",
    className: classNamesString("vkuiSimpleCell__text", "vkuiSimpleCell__subhead")
    ...
    className: classNamesString("vkuiSimpleCell__typography", "vkuiSimpleCell__text", "vkuiSimpleCell__subtitle")
    ...
    className: classNamesString("vkuiSimpleCell__typography", "vkuiSimpleCell__text", "vkuiSimpleCell__extraSubtitle")
