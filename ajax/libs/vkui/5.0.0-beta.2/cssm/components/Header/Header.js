...
export var Header = function Header(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("header", _extends({}, restProps, {
    ref: getRootRef,
    className: classNamesString("vkuiHeader", platform === Platform.VKCOM && "vkuiHeader--vkcom", platform === Platform.ANDROID && "vkuiHeader--android", platform === Platform.IOS && "vkuiHeader--ios", styles["Header--mode-".concat(mode)], isPrimitiveReactNode(indicator) && "vkuiHeader--pi", className)
    ...
    className: classNamesString("vkuiHeader__content-in", multiline && "vkuiHeader__content-in--multiline")
