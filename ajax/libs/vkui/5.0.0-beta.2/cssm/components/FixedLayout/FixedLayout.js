...
export var FixedLayout = function FixedLayout(_ref) {
  ...
  return /*#__PURE__*/React.createElement(TooltipContainer, _extends({}, restProps, {
    fixed: true,
    ref: getRootRef,
    className: classNamesString("vkuiFixedLayout", platform === Platform.IOS && "vkuiFixedLayout--ios", filled && "vkuiFixedLayout--filled", vertical && styles["FixedLayout--vertical-".concat(vertical)], className),
    style: _objectSpread(_objectSpread({}, style), {}, {
      width: width
    })
  }), /*#__PURE__*/React.createElement("div", {
    className: "vkuiFixedLayout__in",
    ref: getRef
  }, children));
};
var styles = {
