...
var Headline = function Headline(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({}, restProps, {
    ref: getRootRef,
    className: (0, _classNames.classNamesString)(className, "vkuiHeadline", (0, _getSizeYClassName.getSizeYClassName)("vkuiHeadline", sizeY), styles["Headline--level-".concat(level)], styles["Headline--weight-".concat(weight)])
  }), children);
};
