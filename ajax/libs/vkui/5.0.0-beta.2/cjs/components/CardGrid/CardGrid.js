...
var CardGrid = function CardGrid(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiCardGrid", spaced && "vkuiCardGrid--spaced", styles["CardGrid--size-".concat(size)], (0, _getSizeXClassName.getSizeXClassName)("vkuiCardGrid", sizeX), className)
  }), children);
};
