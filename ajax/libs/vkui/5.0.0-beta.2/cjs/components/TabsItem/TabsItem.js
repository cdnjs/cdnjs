...
var TabsItem = function TabsItem(_ref) {
  ...
  if (status) {
    statusComponent = typeof status === "number" ? /*#__PURE__*/React.createElement(_Subhead.Subhead, {
      Component: "span",
      className: (0, _classNames.classNamesString)("vkuiTabsItem__status", "vkuiTabsItem__status--count"),
      weight: "2"
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiTabsItem", mode && styles["TabsItem--mode-".concat(mode)], selected && "vkuiTabsItem--selected", (0, _getSizeYClassName.getSizeYClassName)("vkuiTabsItem", sizeY), withGaps && "vkuiTabsItem--withGaps", className),
