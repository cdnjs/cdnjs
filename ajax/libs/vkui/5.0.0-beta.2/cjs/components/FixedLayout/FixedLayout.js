...
var FixedLayout = function FixedLayout(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_TooltipContainer.TooltipContainer, (0, _extends2.default)({}, restProps, {
    fixed: true,
    ref: getRootRef,
    className: (0, _classNames.classNamesString)("vkuiFixedLayout", platform === _platform.Platform.IOS && "vkuiFixedLayout--ios", filled && "vkuiFixedLayout--filled", vertical && styles["FixedLayout--vertical-".concat(vertical)], className),
