...
var AlertAction = function AlertAction(_ref) {
  ...
  if (platform === _platform.Platform.IOS) {
    ...
    return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({
      ...
      className: (0, _classNames.classNamesString)("vkuiAlert__action", styles["Alert__action--mode-".concat(action.mode)]),
  ...
  return /*#__PURE__*/React.createElement(_Button.Button, {
    className: (0, _classNames.classNamesString)("vkuiAlert__button", styles["Alert__button--mode-".concat(action.mode)]),
    mode: mode,
    size: "m",
    onClick: handleItemClick,
...
var Alert = function Alert(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(_PopoutWrapper.PopoutWrapper, {
    ...
    onClose: close,
    timeout: timeout,
    className: (0, _classNames.classNamesString)("vkuiAlert", platform === _platform.Platform.IOS && "vkuiAlert--ios", platform === _platform.Platform.VKCOM && "vkuiAlert--vkcom", resolvedActionsLayout === "vertical" ? "vkuiAlert--v" : "vkuiAlert--h", closing && "vkuiAlert--closing", isDesktop && "vkuiAlert--desktop"),
    role: "alertdialog",
    "aria-modal": true,
  ...
  }, (0, _utils.hasReactNode)(header) && /*#__PURE__*/React.createElement(AlertHeader, {
    id: "vkui--alert--title"
  }, header), (0, _utils.hasReactNode)(text) && /*#__PURE__*/React.createElement(AlertText, {
    id: "vkui--alert--desc"
