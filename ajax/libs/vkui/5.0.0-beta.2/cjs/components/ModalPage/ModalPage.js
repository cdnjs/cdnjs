...
var ModalPage = function ModalPage(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    id: id,
    className: (0, _classNames.classNamesString)("vkuiModalPage", platform === _platform.Platform.IOS && "vkuiModalPage--ios", platform === _platform.Platform.VKCOM && "vkuiModalPage--vkcom", (0, _getSizeXClassName.getSizeXClassName)("vkuiModalPage", sizeX), isDesktop && "vkuiModalPage--desktop", styles["ModalPage--size-".concat(size)], className)
