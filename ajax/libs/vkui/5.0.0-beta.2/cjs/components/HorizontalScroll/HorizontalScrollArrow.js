...
var HorizontalScrollArrow = function HorizontalScrollArrow(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    ...
    hasHover: false,
    hasActive: false,
    className: (0, _classNames.classNamesString)("vkuiHorizontalScrollArrow", styles["HorizontalScrollArrow--size-".concat(size)], styles["HorizontalScrollArrow--direction-".concat(direction)], className),
    onClick: onClick
