...
var PanelHeaderContext = function PanelHeaderContext(_ref) {
  ...
  (0, _ScrollContext.useScrollLock)(platform !== _platform.Platform.VKCOM && opened); // start closing on outer click
  ...
  return /*#__PURE__*/React.createElement(_FixedLayout.FixedLayout, (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiPanelHeaderContext", platform === _platform.Platform.IOS && "vkuiPanelHeaderContext--ios", opened && "vkuiPanelHeaderContext--opened", closing && "vkuiPanelHeaderContext--closing", (0, _getSizeXClassName.getSizeXClassName)("vkuiPanelHeaderContext", sizeX), "vkuiPanelHeaderContext--rounded", className),
    vertical: "top"
  ...
  }, visible && children)), visible && /*#__PURE__*/React.createElement("div", {
