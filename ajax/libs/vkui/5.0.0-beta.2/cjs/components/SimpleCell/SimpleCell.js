...
var SimpleCell = function SimpleCell(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiSimpleCell", (0, _getPlatformClassName.getPlatformClassName)("vkuiSimpleCell", platform), (0, _getSizeYClassName.getSizeYClassName)("vkuiSimpleCell", sizeY), expandable && "vkuiSimpleCell--exp", multiline && "vkuiSimpleCell--mult", className)
  }), before, /*#__PURE__*/React.createElement("div", {
    className: "vkuiSimpleCell__main"
  }, subhead && /*#__PURE__*/React.createElement(_Subhead.Subhead, {
    Component: "span",
    className: (0, _classNames.classNamesString)("vkuiSimpleCell__text", "vkuiSimpleCell__subhead")
    ...
    weight: "3"
  }, children), (0, _utils.hasReactNode)(badgeAfterTitle) && /*#__PURE__*/React.createElement("span", {
    className: "vkuiSimpleCell__badge"
    ...
    className: (0, _classNames.classNamesString)("vkuiSimpleCell__typography", "vkuiSimpleCell__text", "vkuiSimpleCell__subtitle")
    ...
    className: (0, _classNames.classNamesString)("vkuiSimpleCell__typography", "vkuiSimpleCell__text", "vkuiSimpleCell__extraSubtitle")
  }, extraSubtitle)), (0, _utils.hasReactNode)(indicator) && /*#__PURE__*/React.createElement(_Headline.Headline, {
    Component: "span",
    weight: "3",
