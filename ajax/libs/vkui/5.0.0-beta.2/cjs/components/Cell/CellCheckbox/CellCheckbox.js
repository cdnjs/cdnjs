...
var CellCheckbox = function CellCheckbox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _classNames.classNamesString)("vkuiCellCheckbox", (0, _getPlatformClassName.getPlatformClassName)("vkuiCellCheckbox", platform), className),
    style: style
    ...
    className: (0, _classNames.classNamesString)("vkuiCellCheckbox__icon", "vkuiCellCheckbox__icon--off")
  }), /*#__PURE__*/React.createElement(IconOn, {
    className: (0, _classNames.classNamesString)("vkuiCellCheckbox__icon", "vkuiCellCheckbox__icon--on")
  }));
};
