...
var View = function View(_ref) {
  ...
  var onMoveX = function onMoveX(e) {
    ...
    if (platform === _platform.Platform.IOS && !(configProvider !== null && configProvider !== void 0 && configProvider.isWebView) && (e.startX <= 70 || e.startX >= window.innerWidth - 70) && !browserSwipe) {
      setBrowserSwipe(true);
    }

    if (platform === _platform.Platform.IOS && configProvider !== null && configProvider !== void 0 && configProvider.isWebView && onSwipeBack) {
  ...
  return /*#__PURE__*/React.createElement(_Touch.Touch, (0, _extends2.default)({
    ...
    className: (0, _classNames.classNamesString)("vkuiView", platform === _platform.Platform.IOS && "vkuiView--ios", !disableAnimation && animated && "vkuiView--animated", !disableAnimation && swipingBack && "vkuiView--swiping-back", disableAnimation && "vkuiView--no-motion", className),
    onMoveX: onMoveX,
    onEnd: onEnd
