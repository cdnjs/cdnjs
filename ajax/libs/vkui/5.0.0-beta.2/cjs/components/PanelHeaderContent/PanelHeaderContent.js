...
var PanelHeaderContent = function PanelHeaderContent(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, rootProps, {
    style: style,
    className: (0, _classNames.classNamesString)("vkuiPanelHeaderContent", (0, _getPlatformClassName.getPlatformClassName)("vkuiPanelHeaderContent", platform), className)
  }), (0, _utils.hasReactNode)(before) && /*#__PURE__*/React.createElement("div", {
    className: "vkuiPanelHeaderContent__before"
  }, before), /*#__PURE__*/React.createElement(InComponent, (0, _extends2.default)({}, inProps, {
    className: (0, _classNames.classNamesString)("vkuiPanelHeaderContent__in", !before && platform !== _platform.Platform.ANDROID && "vkuiPanelHeaderContent__in--centered")
  }), (0, _utils.hasReactNode)(status) && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
  ...
  }, children), (0, _utils.hasReactNode)(aside) && /*#__PURE__*/React.createElement("div", {
    className: "vkuiPanelHeaderContent__aside"
  }, aside)), (0, _utils.hasReactNode)(before) && /*#__PURE__*/React.createElement("div", {
