...
var Header = function Header(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("header", (0, _extends2.default)({}, restProps, {
    ref: getRootRef,
    className: (0, _classNames.classNamesString)("vkuiHeader", platform === _platform.Platform.VKCOM && "vkuiHeader--vkcom", platform === _platform.Platform.ANDROID && "vkuiHeader--android", platform === _platform.Platform.IOS && "vkuiHeader--ios", styles["Header--mode-".concat(mode)], (0, _utils.isPrimitiveReactNode)(indicator) && "vkuiHeader--pi", className)
    ...
    className: (0, _classNames.classNamesString)("vkuiHeader__content-in", multiline && "vkuiHeader__content-in--multiline")
  }, children), (0, _utils.hasReactNode)(indicator) && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
    className: "vkuiHeader__indicator",
    weight: mode === "primary" || mode === "secondary" ? "1" : undefined
  }, indicator)), (0, _utils.hasReactNode)(subtitle) && /*#__PURE__*/React.createElement(SubtitleTypography, {
    className: "vkuiHeader__subtitle",
    Component: "span"
  }, subtitle)), (0, _utils.hasReactNode)(aside) && /*#__PURE__*/React.createElement(AsideTypography, {
