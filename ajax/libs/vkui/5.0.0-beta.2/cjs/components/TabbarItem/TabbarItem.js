...
var TabbarItem = function TabbarItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({}, restProps, {
    disabled: disabled,
    href: href,
    className: (0, _classNames.classNamesString)("vkuiTabbarItem", platform === _platform.Platform.IOS && "vkuiTabbarItem--ios", platform === _platform.Platform.ANDROID && "vkuiTabbarItem--android", selected && "vkuiTabbarItem--selected", !!text && "vkuiTabbarItem--text", className)
  ...
  }, (0, _utils.hasReactNode)(indicator) && indicator)), text && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
    Component: "div",
