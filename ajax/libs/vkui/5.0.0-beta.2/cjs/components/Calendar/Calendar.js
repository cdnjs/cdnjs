...
var _excluded = ["value", "onChange", "disablePast", "disableFuture", "shouldDisableDate", "onClose", "enableTime", "doneButtonText", "weekStartsOn", "getRootRef", "disablePickers", "changeHoursAriaLabel", "changeMinutesAriaLabel", "prevMonthAriaLabel", "nextMonthAriaLabel", "changeMonthAriaLabel", "changeYearAriaLabel", "showNeighboringMonth", "changeDayAriaLabel", "size", "viewDate", "onHeaderChange", "onNextMonth", "onPrevMonth", "prevMonthIcon", "nextMonthIcon", "prevMonthProps", "nextMonthProps", "dayProps", "className"];
...
var Calendar = function Calendar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, props, {
    ref: getRootRef,
    className: (0, _classNames.classNamesString)("vkuiCalendar", styles["Calendar--size-".concat(size)], className)
