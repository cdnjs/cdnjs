...
var SplitLayout = function SplitLayout(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_PopoutRoot.PopoutRoot, {
    className: (0, _classNames.classNamesString)("vkuiSplitLayout", platform === _platform.Platform.IOS && "vkuiSplitLayout--ios"),
    popout: popout,
    modal: modal,
    getRootRef: getRootRef
  }, header, /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    ref: getRef,
    className: (0, _classNames.classNamesString)("vkuiSplitLayout__inner", !!header && "vkuiSplitLayout__inner--header", className)
  }), children));
};
