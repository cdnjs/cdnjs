...
var MiniInfoCell = function MiniInfoCell(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({
    ...
    className: (0, _classNames.classNamesString)("vkuiMiniInfoCell", styles["MiniInfoCell--textWrap-".concat(textWrap)], mode !== "base" && styles["MiniInfoCell--mode-".concat(mode)], className)
