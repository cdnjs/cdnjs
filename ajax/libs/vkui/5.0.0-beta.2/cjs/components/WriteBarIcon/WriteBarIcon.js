...
var WriteBarIcon = function WriteBarIcon(_ref) {
  ...
  switch (mode) {
    case "attach":
      icon = platform === _platform.Platform.IOS ? /*#__PURE__*/React.createElement(_icons.Icon28AddCircleOutline, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(_icons.Icon28AttachOutline, {
        "aria-hidden": true
      });
    ...
    case "send":
      icon = platform === _platform.Platform.IOS ? /*#__PURE__*/React.createElement(_icons.Icon48WritebarSend, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(_icons.Icon24Send, {
        "aria-hidden": true
      });
      ariaLabel = "Отправить";
      break;
    ...
    case "done":
      icon = platform === _platform.Platform.IOS ? /*#__PURE__*/React.createElement(_icons.Icon48WritebarDone, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(_icons.Icon28CheckCircleOutline, {
        "aria-hidden": true
      });
      ariaLabel = "Готово";
      break;
