...
var PullToRefresh = function PullToRefresh(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_TouchContext.default.Provider, {
    ...
    onMove: onTouchMove,
    onEnd: onTouchEnd,
    className: (0, _classNames.classNamesString)("vkuiPullToRefresh", platform === _platform.Platform.IOS && "vkuiPullToRefresh--ios", watching && "vkuiPullToRefresh--watching", refreshing && "vkuiPullToRefresh--refreshing", className)
