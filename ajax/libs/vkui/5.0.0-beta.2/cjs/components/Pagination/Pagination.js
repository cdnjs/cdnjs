...
var Pagination = function Pagination(_ref) {
    ...
    switch (page) {
      ...
      case "end-ellipsis":
        return /*#__PURE__*/React.createElement("li", {
          ...
          className: (0, _classNames.classNamesString)("vkuiPagination__page", "vkuiPagination__page--type-ellipsis", (0, _getSizeYClassName.getSizeYClassName)("vkuiPagination__page", sizeY), disabled && "vkuiPagination__page--disabled")
        }, "..."));
      ...
      default:
        {
          ...
          return /*#__PURE__*/React.createElement("li", {
            ...
            className: (0, _classNames.classNamesString)("vkuiPagination__page", (0, _getSizeYClassName.getSizeYClassName)("vkuiPagination__page", sizeY), _isCurrent && "vkuiPagination__page--current", disabled && "vkuiPagination__page--disabled"),
  ...
  return /*#__PURE__*/React.createElement("nav", (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiPagination", className),
    role: "navigation",
