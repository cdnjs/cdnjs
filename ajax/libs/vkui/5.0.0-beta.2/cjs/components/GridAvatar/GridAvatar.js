...
var GridAvatar = function GridAvatar(_ref) {
  ...
  var badge = badgeProp ? (0, _objectSpread2.default)((0, _objectSpread2.default)({}, typeof badgeProp === "function" ? {
    ...
    className: (0, _classNames.classNamesString)("vkuiGridAvatar__badge", size < 96 && "vkuiGridAvatar__badge--shifted")
  }) : undefined;
  return /*#__PURE__*/React.createElement(_ImageBase.ImageBase, (0, _extends2.default)({}, restProps, {
    size: size,
    badge: badge,
    className: (0, _classNames.classNamesString)("vkuiGridAvatar", className)
