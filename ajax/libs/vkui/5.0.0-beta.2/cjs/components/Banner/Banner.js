...
var Banner = function Banner(_ref) {
  ...
  }, (0, _utils.hasReactNode)(header) && /*#__PURE__*/React.createElement(HeaderTypography, {
    Component: "span",
    className: "vkuiBanner__header",
    weight: "2",
    level: size === "m" ? "2" : "1"
  }, header), (0, _utils.hasReactNode)(subheader) && /*#__PURE__*/React.createElement(SubheaderTypography, {
    Component: "span",
    className: "vkuiBanner__subheader"
  }, subheader), (0, _utils.hasReactNode)(text) && /*#__PURE__*/React.createElement(_Text.Text, {
    className: "vkuiBanner__text"
  }, text), (0, _utils.hasReactNode)(actions) && React.Children.count(actions) > 0 && /*#__PURE__*/React.createElement("div", {
    className: "vkuiBanner__actions"
  }, actions)));
  return /*#__PURE__*/React.createElement("section", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiBanner", platform === _platform.Platform.IOS && "vkuiBanner--ios", styles["Banner--mode-".concat(mode)], styles["Banner--size-".concat(size)], mode === "image" && imageTheme === "dark" && "vkuiBanner--inverted", className)
