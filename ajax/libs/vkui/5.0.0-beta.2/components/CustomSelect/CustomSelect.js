...
export function CustomSelect(props) {
  ...
  var openedClassNames = React.useMemo(function () {
    return classNamesString(opened && dropdownOffsetDistance === 0 && (popperPlacement !== null && popperPlacement !== void 0 && popperPlacement.includes("top") ? "vkuiCustomSelect--pop-up" : "vkuiCustomSelect--pop-down"));
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: classNamesString("vkuiCustomSelect", className),
    style: style,
