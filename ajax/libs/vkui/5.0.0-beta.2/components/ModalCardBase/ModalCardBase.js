...
export var ModalCardBase = function ModalCardBase(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    className: classNamesString("vkuiModalCardBase", getPlatformClassName("vkuiModalCardBase", platform), isDesktop && "vkuiModalCardBase--desktop", className),
    ref: getRootRef
  }), /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiModalCardBase__container", isSoftwareKeyboardOpened && "vkuiModalCardBase__container--softwareKeyboardOpened")
