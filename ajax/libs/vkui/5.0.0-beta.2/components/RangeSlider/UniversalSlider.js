...
export var UniversalSlider = function UniversalSlider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Touch, _extends({
    ...
    className: classNamesString("vkuiSlider", getSizeYClassName("vkuiSlider", sizeY), disabled && "vkuiSlider--disabled", className)
    ...
    className: classNamesString("vkuiSlider__thumb", "vkuiSlider__thumb--start"),
    ref: thumbStart
  }), /*#__PURE__*/React.createElement("span", {
    className: classNamesString("vkuiSlider__thumb", "vkuiSlider__thumb--end"),
    ref: thumbEnd
  }))));
};
