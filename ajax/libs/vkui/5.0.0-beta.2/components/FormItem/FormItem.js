...
export var FormItem = function FormItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, _extends({}, restProps, {
    ref: rootEl,
    className: classNamesString("vkuiFormItem", status !== "default" && styles["FormItem--status-".concat(status)], getSizeYClassName("vkuiFormItem", sizeY), hasReactNode(top) && "vkuiFormItem--withTop", removable && "vkuiFormItem--removable", className)
