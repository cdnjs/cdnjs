...
export var CellCheckbox = function CellCheckbox(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiCellCheckbox", getPlatformClassName("vkuiCellCheckbox", platform), className),
    style: style
  }, /*#__PURE__*/React.createElement("input", _extends({
    className: "vkuiCellCheckbox__input",
    type: "checkbox"
  }, restProps)), /*#__PURE__*/React.createElement(IconOff, {
    className: classNamesString("vkuiCellCheckbox__icon", "vkuiCellCheckbox__icon--off")
  }), /*#__PURE__*/React.createElement(IconOn, {
    className: classNamesString("vkuiCellCheckbox__icon", "vkuiCellCheckbox__icon--on")
  }));
};
