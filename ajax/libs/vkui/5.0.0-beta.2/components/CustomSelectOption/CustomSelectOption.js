...
export var CustomSelectOption = function CustomSelectOption(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Paragraph, _extends({}, restProps, {
    ...
    className: classNamesString("vkuiCustomSelectOption", getSizeYClassName("vkuiCustomSelectOption", sizeY), hovered && !disabled && "vkuiCustomSelectOption--hover", // Note: пустой класс
