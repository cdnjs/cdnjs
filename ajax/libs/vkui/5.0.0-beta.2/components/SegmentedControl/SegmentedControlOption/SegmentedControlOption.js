...
export var SegmentedControlOption = function SegmentedControlOption(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: classNamesString("vkuiSegmentedControlOption", restProps.checked && "vkuiSegmentedControlOption--checked", focusVisible && "vkuiSegmentedControlOption--focus-visible", className),
    style: style
    ...
    className: classNamesString("vkuiSegmentedControlOption__content", getSizeYClassName("vkuiSegmentedControlOption__content", sizeY))
