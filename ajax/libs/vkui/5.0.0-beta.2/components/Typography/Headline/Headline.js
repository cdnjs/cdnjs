...
export var Headline = function Headline(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, _extends({}, restProps, {
    ref: getRootRef,
    className: classNamesString(className, "vkuiHeadline", getSizeYClassName("vkuiHeadline", sizeY), styles["Headline--level-".concat(level)], styles["Headline--weight-".concat(weight)])
  }), children);
};
var styles = {
