...
var AlertAction = function AlertAction(_ref) {
  ...
  if (platform === Platform.IOS) {
    ...
    return /*#__PURE__*/React.createElement(Tappable, _extends({
      ...
      className: classNamesString("vkuiAlert__action", styles["Alert__action--mode-".concat(action.mode)]),
  ...
  return /*#__PURE__*/React.createElement(Button, {
    className: classNamesString("vkuiAlert__button", styles["Alert__button--mode-".concat(action.mode)]),
    mode: mode,
    size: "m",
    onClick: handleItemClick,
...
export var Alert = function Alert(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(PopoutWrapper, {
    ...
    onClose: close,
    timeout: timeout,
    className: classNamesString("vkuiAlert", platform === Platform.IOS && "vkuiAlert--ios", platform === Platform.VKCOM && "vkuiAlert--vkcom", resolvedActionsLayout === "vertical" ? "vkuiAlert--v" : "vkuiAlert--h", closing && "vkuiAlert--closing", isDesktop && "vkuiAlert--desktop"),
    role: "alertdialog",
    "aria-modal": true,
