...
export var ContentCard = function ContentCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    style: style,
    className: classNamesString("vkuiContentCard", restProps.disabled && "vkuiContentCard--disabled", className)
    ...
    className: classNamesString("vkuiContentCard__text", "vkuiContentCard__subtitle"),
    weight: "1",
    level: "3",
    caps: true
    ...
    className: classNamesString("vkuiContentCard__text", "vkuiContentCard__caption")
  }, caption))));
};
