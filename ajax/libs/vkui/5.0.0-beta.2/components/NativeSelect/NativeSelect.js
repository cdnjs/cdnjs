...
var NativeSelect = function NativeSelect(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, {
    Component: "label",
    className: classNamesString("vkuiSelect", getPlatformClassName("vkuiSelect", platform), empty && "vkuiSelect--empty", multiline && "vkuiSelect--multiline", align && styles["Select--align-".concat(align)], getSizeXClassName("vkuiSelect", sizeX), getSizeYClassName("vkuiSelect", sizeY), className),
    style: style,
