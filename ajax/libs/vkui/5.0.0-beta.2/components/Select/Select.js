...
export var SelectTypography = function SelectTypography(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: classNamesString("vkuiSelectTypography", getPlatformClassName("vkuiSelectTypography", platform), getSizeYClassName("vkuiSelectTypography", sizeY), styles["SelectTypography--selectType-".concat(selectType)], className)
  }, restProps), children);
};
/**
...
export var Select = function Select(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, (hasMouse === undefined || hasMouse === true) && /*#__PURE__*/React.createElement(CustomSelect, _extends({
    className: classNamesString("vkuiSelect__custom", getMouseClassName("vkuiSelect__custom", hasMouse), className),
    options: options,
    popupDirection: popupDirection,
    renderOption: renderOption
  }, props)), (hasMouse === undefined || hasMouse === false) && /*#__PURE__*/React.createElement(NativeSelect, _extends({
    className: classNamesString("vkuiSelect__native", getMouseClassName("vkuiSelect__native", hasMouse), className)
