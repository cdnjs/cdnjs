...
var useDraggable = function(param) {
    ...
    var _React_useState1 = _sliced_to_array._(_react.useState([]), 2), siblings = _React_useState1[0], setSiblings = _React_useState1[1];
    var _React_useState2 = _sliced_to_array._(_react.useState(0), 2), dragStartIndex = _React_useState2[0], setDragStartIndex = _React_useState2[1];
    var _React_useState3 = _sliced_to_array._(_react.useState(0), 2), dragEndIndex = _React_useState3[0], setDragEndIndex = _React_useState3[1];
    var _React_useState4 = _sliced_to_array._(_react.useState(0), 2), dragShift = _React_useState4[0], setDragShift = _React_useState4[1];
    var _React_useState5 = _sliced_to_array._(_react.useState(undefined), 2), dragDirection = _React_useState5[0], setDragDirection = _React_useState5[1];
