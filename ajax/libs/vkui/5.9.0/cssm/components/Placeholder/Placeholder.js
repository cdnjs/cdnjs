...
const PlaceholderContainer = ({ stretched, withPadding = true, ...restProps })=>/*#__PURE__*/ React.createElement(RootComponent, {
        baseClassName: classNames(styles['Placeholder'], stretched && styles['Placeholder--stretched'], withPadding && styles['Placeholder--withPadding']),
        ...restProps
    });
 ...
 */ export const Placeholder = ({ icon, header, children, action, withPadding = true, ...restProps })=>/*#__PURE__*/ React.createElement(PlaceholderContainer, {
