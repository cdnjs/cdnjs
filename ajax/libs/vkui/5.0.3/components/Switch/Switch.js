...
export var Switch = function Switch(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: classNamesString("vkuiSwitch", getPlatformClassName("vkuiSwitch", platform), getSizeYClassName("vkuiSwitch", sizeY), restProps.disabled && "vkuiSwitch--disabled", focusVisible && "vkuiSwitch--focus-visible", className),
    style: style,
    ref: getRootRef,
    role: "presentation"
