...
var ModalCard = function ModalCard(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    id: id,
    className: (0, _classNames.classNamesString)("vkuiModalCard", (0, _getPlatformClassName.getPlatformClassName)("vkuiModalCard", platform), isDesktop && "vkuiModalCard--desktop", className)
