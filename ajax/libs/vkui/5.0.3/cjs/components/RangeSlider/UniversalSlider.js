...
var UniversalSlider = function UniversalSlider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Touch.Touch, (0, _extends2.default)({
    ...
    className: (0, _classNames.classNamesString)("vkuiSlider", (0, _getSizeYClassName.getSizeYClassName)("vkuiSlider", sizeY), disabled && "vkuiSlider--disabled", className)
    ...
    className: (0, _classNames.classNamesString)("vkuiSlider__thumb", "vkuiSlider__thumb--start"),
    ref: thumbStart
  }), /*#__PURE__*/React.createElement("span", {
    className: (0, _classNames.classNamesString)("vkuiSlider__thumb", "vkuiSlider__thumb--end"),
    ref: thumbEnd
  }))));
};
