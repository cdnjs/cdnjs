...
export var MiniInfoCell = function MiniInfoCell(_ref) {
  ...
  var cellClasses = classNamesString("vkuiMiniInfoCell", styles["MiniInfoCell--textWrap-".concat(textWrap)], mode !== "base" && styles["MiniInfoCell--mode-".concat(mode)], className);
