...
export var SplitLayout = function SplitLayout(_ref) {
  ...
  return /*#__PURE__*/React.createElement(PopoutRoot, {
    className: classNamesString("vkuiSplitLayout", platform === Platform.IOS && "vkuiSplitLayout--ios"),
    popout: popout,
    modal: modal,
    getRootRef: getRootRef
  }, header, /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    ref: getRef,
    className: classNamesString("vkuiSplitLayout__inner", !!header && "vkuiSplitLayout__inner--header", className)
  }), children));
};
