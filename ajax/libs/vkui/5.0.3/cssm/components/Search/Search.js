...
var _excluded = ["children"],
  _excluded2 = ["before", "className", "defaultValue", "placeholder", "after", "getRef", "icon", "onIconClick", "style", "autoComplete"];
...
export var Search = function Search(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiSearch", platform === Platform.IOS && "vkuiSearch--ios", getSizeYClassName("vkuiSearch", sizeY), isFocused && "vkuiSearch--focused", value && "vkuiSearch--has-value", after && "vkuiSearch--has-after", icon && "vkuiSearch--has-icon", className),
    style: style
