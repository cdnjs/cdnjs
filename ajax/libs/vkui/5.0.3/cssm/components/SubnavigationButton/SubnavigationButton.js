...
import "./SubnavigationButton.module.css";
...
export var SubnavigationButton = function SubnavigationButton(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    ...
    className: classNamesString("vkuiSubnavigationButton", styles["SubnavigationButton--size-".concat(size)], styles["SubnavigationButton--mode-".concat(mode)], selected && "vkuiSubnavigationButton--selected", getSizeYClassName("vkuiSubnavigationButton", sizeY), className),
