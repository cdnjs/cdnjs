...
const Textarea = (_param)=>{
    var { grow = true, style, onResize, className, getRootRef, getRef, rows = 2, maxHeight, status, onChange, align, mode, after, before, afterAlign, beforeAlign } = _param, restProps = _object_without_properties._(_param, [
        "grow",
        "style",
        "onResize",
        "className",
