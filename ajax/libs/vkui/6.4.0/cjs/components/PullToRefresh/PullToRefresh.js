...
const PullToRefresh = (_param)=>{
    ...
    (0, _useIsomorphicLayoutEffect.useIsomorphicLayoutEffect)(function toggleDocumentOverscrollBehavior() {
        return window && (watching || refreshing) ? (0, _dom.initializeBrowserGesturePreventionEffect)(window) : undefined;
    }, [
        window,
        watching,
        refreshing
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_TouchContext.default.Provider, {
        value: true,
        children: /*#__PURE__*/ (0, _jsxruntime.jsxs)(_Touch.Touch, _object_spread_props._(_object_spread._({
            "aria-live": "polite",
            ...
            children: [
                /*#__PURE__*/ (0, _jsxruntime.jsx)(_FixedLayout.FixedLayout, {
