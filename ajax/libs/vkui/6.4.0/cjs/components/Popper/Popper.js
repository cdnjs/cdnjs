...
const Popper = (_param)=>{
    ...
    placement: placementProp = 'bottom-start', sameWidth, hideWhenReferenceHidden, offsetByMainAxis = 8, offsetByCrossAxis = 0, arrow, arrowHeight = _DefaultIcon.DEFAULT_ARROW_HEIGHT, arrowPadding = _DefaultIcon.DEFAULT_ARROW_PADDING, customMiddlewares, disableFlipMiddleware = false, // UseFloatingProps
    ...
    (0, _floating.usePlacementChangeCallback)(placementProp, resolvedPlacement, onPlacementChange);
    ...
    const dropdown = /*#__PURE__*/ (0, _jsxruntime.jsxs)(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        children: [
            arrow && /*#__PURE__*/ (0, _jsxruntime.jsx)(_FloatingArrow.FloatingArrow, _object_spread_props._(_object_spread._({}, arrowProps), {
                coords: arrowCoords,
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_AppRootPortal.AppRootPortal, {
        usePortal: usePortal,
        children: dropdown
    });
};
