...
_export(exports, {
    ...
    clickByKeyboardHandler: function() {
        return clickByKeyboardHandler;
    },
...
function getFetchPriorityProp(value) {
    if (_react.version.startsWith('19')) {
        return {
            fetchPriority: value
        };
    }
...
function clickByKeyboardHandler(event) {
    ...
    if (!(0, _dom.isHTMLElement)(event.target) || !(0, _accessibility.shouldTriggerClickOnEnterOrSpace)(event)) {
        return;
    }
