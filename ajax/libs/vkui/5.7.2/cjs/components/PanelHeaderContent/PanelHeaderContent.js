...
var PanelHeaderContent = function(_param) {
    var className = _param.className, style = _param.style, aside = _param.aside, status = _param.status, before = _param.before, children = _param.children, onClick = _param.onClick, restProps = _object_without_properties._(_param, [
        "className",
        "style",
        "aside",
        "status",
    ...
    return /*#__PURE__*/ _react.createElement("div", _object_spread_props._(_object_spread._({}, rootProps), {
        style: style,
