...
var Tooltip = function(_param) {
    ...
    /* eslint-disable no-restricted-properties */ var tooltipContainer = _react.useMemo(function() {
        var _target;
        return (_target = target) === null || _target === void 0 ? void 0 : _target.closest("[".concat(_TooltipContainer.tooltipContainerAttr, "]"));
    }, [
        target
    ]);
    ...
    var floatingPositionStrategy = _react.useMemo(function() {
        var _target;
        return ((_target = target) === null || _target === void 0 ? void 0 : _target.style.position) === "fixed" ? "fixed" : "absolute";
    }, [
        target
    ]);
