...
var ViewInfiniteComponent = /*#__PURE__*/ function(_superClass) {
    ...
    function ViewInfiniteComponent(props) {
        ...
        _define_property._(_assert_this_initialized._(_this), "onMoveX", function(event) {
        ...
        _define_property._(_assert_this_initialized._(_this), "onEnd", function(event) {
...
_define_property._(ViewInfiniteComponent, "SWIPE_BACK_AREA", 70);
