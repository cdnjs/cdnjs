 ...
 */ export const UsersStack = ({ photos = [], visibleCount = 3, count = Math.max(0, photos.length - visibleCount), size = 'm', layout, children, className, direction: directionProp = 'row', ...restProps })=>{
    const cmpId = useId();
