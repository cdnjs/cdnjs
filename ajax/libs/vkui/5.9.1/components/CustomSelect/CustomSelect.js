 ...
 */ export function CustomSelect(props) {
    ...
    var _props_value;
    var _React_useState8 = _sliced_to_array(React.useState(findSelectedIndex(optionsProp, (_props_value = props.value) !== null && _props_value !== void 0 ? _props_value : props.defaultValue, allowClearButton)), 2), selectedOptionIndex = _React_useState8[0], setSelectedOptionIndex = _React_useState8[1];
