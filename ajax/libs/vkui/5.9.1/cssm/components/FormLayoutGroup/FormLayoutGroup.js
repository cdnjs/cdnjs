 ...
 */ export const FormLayoutGroup = ({ children, mode = 'vertical', removable, segmented, removePlaceholder = 'Удалить', onRemove = noop, getRootRef, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        getRootRef: rootEl,
        baseClassName: classNames(sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], mode === 'horizontal' && classNames(styles['FormLayoutGroup--mode-horizontal'], 'vkuiInternalFormLayoutGroup--mode-horizontal'), mode === 'vertical' && classNames(styles['FormLayoutGroup--mode-vertical'], 'vkuiInternalFormLayoutGroup--mode-vertical'), isRemovable && classNames(styles['FormLayoutGroup--removable'], 'vkuiInternalFormLayoutGroup--removable'), segmented && classNames(styles['FormLayoutGroup--segmented'], 'vkuiInternalFormLayoutGroup--segmented')),
        ...restProps
