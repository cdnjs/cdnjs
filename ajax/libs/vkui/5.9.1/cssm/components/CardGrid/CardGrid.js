 ...
 */ export const CardGrid = ({ size = 's', spaced = false, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        ...restProps,
        baseClassName: classNames(styles['CardGrid'], 'vkuiInternalCardGrid', spaced && styles['CardGrid--spaced'], stylesSize[size], sizeX !== SizeType.REGULAR && sizeXClassNames[sizeX])
    });
};
