...
var ModalPageComponent = function ModalPageComponent(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({}, restProps, {
    id: id,
    vkuiClass: (0, _classNames.classNames)("ModalPage", platform === _platform.Platform.IOS && "ModalPage--ios", platform === _platform.Platform.VKCOM && "ModalPage--vkcom", "ModalPage--sizeX-".concat(sizeX), // TODO v5.0.0 поправить под новую адаптивность
