 ...
 */ export const TabbarItem = ({ children , selected , indicator , text , href , Component =href ? 'a' : 'button' , disabled , className , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Component, {
        ...
        disabled: disabled,
        href: href,
        className: classNames(styles['TabbarItem'], platform === Platform.IOS && styles['TabbarItem--ios'], platform === Platform.ANDROID && styles['TabbarItem--android'], selected && styles['TabbarItem--selected'], !!text && styles['TabbarItem--text'], className)
