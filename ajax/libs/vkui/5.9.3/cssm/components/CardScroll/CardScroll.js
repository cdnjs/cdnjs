 ...
 */ export const CardScroll = ({ children, size = 's', showArrows = true, withSpaces = true, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        ...restProps,
        baseClassName: classNames(styles['CardScroll'], 'vkuiInternalCardScroll', size !== false && stylesSize[size], withSpaces && styles['CardScroll--withSpaces'])
