 ...
 */ export var AppRoot = function(_param) {
    var children = _param.children, _param_mode = _param.mode, mode = _param_mode === void 0 ? "full" : _param_mode, _param_scroll = _param.scroll, scroll = _param_scroll === void 0 ? "global" : _param_scroll, tmp = _param.portalRoot, portalRootProp = tmp === void 0 ? null : tmp, disablePortal = _param.disablePortal, className = _param.className, safeAreaInsets = _param.safeAreaInsets, props = _object_without_properties(_param, [
        "children",
        "mode",
        "scroll",
        "portalRoot",
