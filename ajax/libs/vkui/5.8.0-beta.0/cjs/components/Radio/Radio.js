...
var Radio = function(_param) {
    var children = _param.children, description = _param.description, style = _param.style, className = _param.className, getRootRef = _param.getRootRef, titleAfter = _param.titleAfter, getRef = _param.getRef, restProps = _object_without_properties._(_param, [
        "children",
        "description",
        "style",
        "className",
