 ...
 */ export var ModalCard = function(_param) {
    var icon = _param.icon, header = _param.header, subheader = _param.subheader, children = _param.children, actions = _param.actions, onClose = _param.onClose, nav = _param.nav, id = _param.id, size = _param.size, getRootRef = _param.getRootRef, restProps = _object_without_properties(_param, [
        "icon",
        "header",
        "subheader",
        "children",
