...
const ActionSheetDropdownSheet = (_param)=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsx)(_FocusTrap.FocusTrap, _object_spread_props._(_object_spread._({}, restProps), {
        onClick: stopPropagation,
        className: (0, _vkjs.classNames)("vkuiActionSheet", platform === 'ios' && "vkuiActionSheet--ios", closing ? "vkuiActionSheet--closing" : "vkuiActionSheet--opening", sizeY === 'compact' && "vkuiActionSheet--sizeY-compact", className),
        children: children
    }));
};
