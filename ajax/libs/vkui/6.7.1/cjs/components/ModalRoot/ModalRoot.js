...
class ModalRootTouchComponent extends _react.Component {
   ...
   */ animateTranslate(modalState, percent) {
    ...
    constructor(props){
        super(props), _define_property._(this, "maskElementRef", void 0), _define_property._(this, "viewportRef", /*#__PURE__*/ _react.createRef()), _define_property._(this, "maskAnimationFrame", undefined), _define_property._(this, "modalRootContext", void 0), _define_property._(this, "frameIds", void 0), _define_property._(this, "restoreFocusTo", undefined), _define_property._(this, "updateModalHeight", ()=>{
            const modalState = this.props.getModalState(this.props.activeModal);
