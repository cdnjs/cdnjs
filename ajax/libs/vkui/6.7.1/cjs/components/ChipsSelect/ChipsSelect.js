...
const ChipsSelect = (_param)=>{
    ...
    const onDropdownIconClick = _react.useCallback((e)=>{
        if (opened) {
            e.preventDefault();
            setOpened(false);
        }
    ...
    const dropdownContent = _react.useMemo(()=>{
        ...
        children: [
            /*#__PURE__*/ (0, _jsxruntime.jsx)(_ChipsInputBase.ChipsInputBase, _object_spread_props._(_object_spread._({}, restProps), {
                ...
                after: dropdownIconProp || /*#__PURE__*/ (0, _jsxruntime.jsx)(_DropdownIcon.DropdownIcon, {
                    ...
                    className: (0, _vkjs.classNames)("vkuiChipsSelect__dropdown-icon", clearButtonShown && "vkuiChipsSelect__dropdown-icon--withOffset")
                }),
                // option
                value: value,
