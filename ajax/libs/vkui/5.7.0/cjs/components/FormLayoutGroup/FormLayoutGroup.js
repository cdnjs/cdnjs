...
var FormLayoutGroup = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _object_spread._({
        ref: rootEl,
        className: (0, _vkjs.classNames)(sizeY !== _adaptivity.SizeType.REGULAR && sizeYClassNames[sizeY], mode === "horizontal" && (0, _vkjs.classNames)("vkuiFormLayoutGroup--mode-horizontal", "vkuiInternalFormLayoutGroup--mode-horizontal"), isRemovable && (0, _vkjs.classNames)("vkuiFormLayoutGroup--removable", "vkuiInternalFormLayoutGroup--removable"), isSegmented && (0, _vkjs.classNames)("vkuiFormLayoutGroup--segmented", "vkuiInternalFormLayoutGroup--segmented"), className)
