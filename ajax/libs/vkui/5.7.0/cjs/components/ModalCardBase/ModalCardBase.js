...
var ModalCardBase = function(_param) {
    ...
    return /*#__PURE__*/ _react.createElement("div", _object_spread_props._(_object_spread._({}, restProps), {
        className: (0, _vkjs.classNames)("vkuiInternalModalCardBase", platform === _platform.Platform.IOS && "vkuiModalCardBase--ios", isDesktop && "vkuiModalCardBase--desktop", className),
        ref: getRootRef,
