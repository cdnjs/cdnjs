 ...
 */ export const Chip = ({ value = '', option, removable = true, onRemove = noop, removeAriaLabel = 'Удалить', before = null, after, children, className, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        className: classNames(styles['Chip'], sizeY !== SizeType.REGULAR && sizeYClassNames[sizeY], removable && styles['Chip--removable'], className),
        role: "option",
        "aria-label": title,
        ...restProps
