 ...
 */ export const Tabbar = ({ shadow = true, mode, ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(RootComponent, {
        baseClassName: classNames('vkuiInternalTabbar', styles['Tabbar'], platform === 'ios' && styles['Tabbar--ios'], getItemsLayoutClassName(mode, restProps.children), shadow && styles['Tabbar--shadow']),
        ...restProps
    });
};
