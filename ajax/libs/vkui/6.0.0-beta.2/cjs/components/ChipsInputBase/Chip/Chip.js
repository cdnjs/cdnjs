...
const Chip = (_param)=>{
    var { Component = 'span', value = '', removable = true, onRemove = _vkjs.noop, removeLabel = 'Удалить', before, after, disabled, children, className, onFocus: onFocusProp, onBlur: onBlurProp } = _param, restProps = _object_without_properties._(_param, [
        "Component",
        "value",
        "removable",
        "onRemove",
    ...
    }, after)), removable && /*#__PURE__*/ _react.createElement("div", {
