...
const Tabbar = (_param)=>{
    var { shadow = true, mode } = _param, restProps = _object_without_properties._(_param, [
        "shadow",
        "mode"
    ]);
    const platform = (0, _usePlatform.usePlatform)();
    return /*#__PURE__*/ _react.createElement(_RootComponent.RootComponent, _object_spread._({
        baseClassName: (0, _vkjs.classNames)('vkuiInternalTabbar', "vkuiTabbar", platform === 'ios' && "vkuiTabbar--ios", getItemsLayoutClassName(mode, restProps.children), shadow && "vkuiTabbar--shadow")
    }, restProps));
};
