...
const PopoutWrapper = (_param)=>{
    var { alignY = 'center', alignX = 'center', closing = false, hasMask = true, fixed = true, children, onClick } = _param, restProps = _object_without_properties._(_param, [
        "alignY",
        "alignX",
        "closing",
        "hasMask",
    ...
    const [opened, setOpened] = _react.useState(!hasMask);
    const onFadeInEnd = (e)=>{
