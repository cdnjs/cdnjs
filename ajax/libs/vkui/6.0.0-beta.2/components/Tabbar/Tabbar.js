 ...
 */ export const Tabbar = (_param)=>{
    var { shadow = true, mode } = _param, restProps = _object_without_properties(_param, [
        "shadow",
        "mode"
    ]);
    const platform = usePlatform();
    return /*#__PURE__*/ React.createElement(RootComponent, _object_spread({
        baseClassName: classNames('vkuiInternalTabbar', "vkuiTabbar", platform === 'ios' && "vkuiTabbar--ios", getItemsLayoutClassName(mode, restProps.children), shadow && "vkuiTabbar--shadow")
    }, restProps));
};
