/* eslint-disable no-restricted-syntax */ import { _ as _object_spread } from "@swc/helpers/_/_object_spread";
...
export const Tappable = (_param)=>{
    ...
    }, handlers, restProps), children, isClickable && (hoverMode === 'background' || activeMode === 'background') && /*#__PURE__*/ React.createElement(Ripple, {
