...
const PlaceholderContainer = (_param)=>/*#__PURE__*/ {
    var { stretched, withPadding = true } = _param, restProps = _object_without_properties(_param, [
        "stretched",
        "withPadding"
    ]);
...
const PlaceholderHeader = (_param)=>/*#__PURE__*/ {
...
const PlaceholderText = (_param)=>/*#__PURE__*/ {
    var { className } = _param, restProps = _object_without_properties(_param, [
        "className"
    ]);
 ...
 */ export const Placeholder = (_param)=>/*#__PURE__*/ {
    var { icon, header, children, action, withPadding = true } = _param, restProps = _object_without_properties(_param, [
        "icon",
        "header",
        "children",
        "action",
