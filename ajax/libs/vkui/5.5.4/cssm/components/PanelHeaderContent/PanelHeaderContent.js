 ...
 */ export const PanelHeaderContent = ({ className , style , aside , status , before , children , onClick , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...rootProps,
        style: style,
        className: classNames(styles['PanelHeaderContent'], platformClassNames.hasOwnProperty(platform) ? platformClassNames[platform] : platformClassNames.android, className)
