...
var Tabbar = function Tabbar(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({
    vkuiClass: (0, _classNames.classNames)("Tabbar", platform === _platform.Platform.IOS && "Tabbar--ios", "Tabbar-layout-".concat(getItemsLayout(mode, children)), shadow && "Tabbar--shadow")
