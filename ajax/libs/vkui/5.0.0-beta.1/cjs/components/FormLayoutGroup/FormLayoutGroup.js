...
var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({
    ref: rootEl,
    vkuiClass: (0, _classNames.classNames)("FormLayoutGroup", (0, _getSizeYClassName.getSizeYClassName)("FormLayoutGroup", sizeY), "FormLayoutGroup--mode-".concat(mode), isRemovable && "FormLayoutGroup--removable", isSegmented && "FormLayoutGroup--segmented")
