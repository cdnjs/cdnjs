...
var SubnavigationButton = function SubnavigationButton(_ref2) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    ...
    vkuiClass: (0, _classNames.classNames)("SubnavigationButton", "SubnavigationButton--size-".concat(size), "SubnavigationButton--mode-".concat(mode), selected && "SubnavigationButton--selected", "SubnavigationButton--sizeY-".concat(sizeY)),
