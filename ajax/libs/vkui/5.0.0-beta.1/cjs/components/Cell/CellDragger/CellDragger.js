...
var CellDragger = function CellDragger(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Touch.Touch, (0, _extends2.default)({
    ...
    onEnd: onDragEnd,
    onClick: onClick
  }, restProps), platform === _platform.Platform.IOS ? (0, _jsxRuntime.createScopedElement)(_icons.Icon24ReorderIos, null) : (0, _jsxRuntime.createScopedElement)(_icons.Icon24Reorder, null));
};
