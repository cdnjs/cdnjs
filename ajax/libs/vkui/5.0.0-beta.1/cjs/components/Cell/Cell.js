...
var Cell = function Cell(_ref) {
  ...
  var cellClasses = (0, _classNames.classNames)("Cell", platform === _platform.Platform.IOS && "Cell--ios", dragging && "Cell--dragging", removable && "Cell--removable", selectable && "Cell--selectable", disabled && "Cell--disabled");
  var simpleCell = (0, _jsxRuntime.createScopedElement)(_SimpleCell.SimpleCell, (0, _extends2.default)({
    ...
    before: (0, _jsxRuntime.createScopedElement)(React.Fragment, null, draggable && platform !== _platform.Platform.IOS && dragger, selectable && checkbox, before),
    after: (0, _jsxRuntime.createScopedElement)(React.Fragment, null, draggable && platform === _platform.Platform.IOS && dragger, after)
  }));
