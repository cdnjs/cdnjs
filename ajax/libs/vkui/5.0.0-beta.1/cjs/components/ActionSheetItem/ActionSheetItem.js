...
var ActionSheetItem = function ActionSheetItem(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    ...
    vkuiClass: (0, _classNames.classNames)("ActionSheetItem", platform === _platform.Platform.IOS && "ActionSheetItem--ios", "ActionSheetItem--mode-".concat(mode), (0, _getSizeYClassName.getSizeYClassName)("ActionSheetItem", sizeY), isRich && "ActionSheetItem--rich", isDesktop && "ActionSheetItem--desktop"),
    Component: Component
  ...
  }, children), meta && (0, _jsxRuntime.createScopedElement)(_Text.Text, {
    vkuiClass: "ActionSheetItem__meta"
  }, meta)), subtitle && (0, _jsxRuntime.createScopedElement)(_Subhead.Subhead, {
