...
var ActionSheetDropdownDesktop = function ActionSheetDropdownDesktop(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Popper.Popper, {
    ...
    vkuiClass: (0, _classNames.classNames)("ActionSheet", platform === _platform.Platform.IOS && "ActionSheet--ios", "ActionSheet--desktop", (0, _getSizeYClassName.getSizeYClassName)("ActionSheet", sizeY)),
    className: className,
    style: style,
    getRef: elementRef,
    forcePortal: false
