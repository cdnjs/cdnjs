...
var CellTypography = function CellTypography(_ref) {
  ...
  return size === "s" ? (0, _jsxRuntime.createScopedElement)(_Caption.Caption, restProps, children) : (0, _jsxRuntime.createScopedElement)(_Subhead.Subhead, restProps, children);
};
...
var HorizontalCell = function HorizontalCell(_ref2) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", {
    vkuiClass: (0, _classNames.classNames)("HorizontalCell", "HorizontalCell--size-".concat(size)),
    ref: getRootRef,
    style: style,
    className: className
