...
var Switch = function Switch(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("label", {
    vkuiClass: (0, _classNames.classNames)((0, _getClassName.getClassName)("Switch", platform), (0, _getSizeYClassName.getSizeYClassName)("Switch", sizeY), restProps.disabled && "Switch--disabled", focusVisible && "Switch--focus-visible"),
    className: className,
    style: style,
    ref: getRootRef,
    role: "presentation"
