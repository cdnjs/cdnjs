...
var PullToRefresh = function PullToRefresh(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_TouchContext.default.Provider, {
    ...
    onMove: onTouchMove,
    onEnd: onTouchEnd,
    vkuiClass: (0, _classNames.classNames)("PullToRefresh", platform === _platform.Platform.IOS && "PullToRefresh--ios", watching && "PullToRefresh--watching", refreshing && "PullToRefresh--refreshing")
