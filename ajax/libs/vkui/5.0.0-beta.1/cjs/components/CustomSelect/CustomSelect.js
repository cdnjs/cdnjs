...
function CustomSelect(props) {
  ...
  var resolvedContent = React.useMemo(function () {
    var defaultDropdownContent = (options === null || options === void 0 ? void 0 : options.length) > 0 ? options.map(renderOption) : (0, _jsxRuntime.createScopedElement)(_Footnote.Footnote, {
