...
var FixedLayout = function FixedLayout(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_TooltipContainer.TooltipContainer, (0, _extends2.default)({}, restProps, {
    fixed: true,
    ref: getRootRef,
    vkuiClass: (0, _classNames.classNames)("FixedLayout", platform === _platform.Platform.IOS && "FixedLayout--ios", filled && "FixedLayout--filled", vertical && "FixedLayout--vertical-".concat(vertical)),
