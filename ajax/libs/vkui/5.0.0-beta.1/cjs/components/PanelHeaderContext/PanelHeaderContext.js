...
var PanelHeaderContext = function PanelHeaderContext(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_FixedLayout.FixedLayout, (0, _extends2.default)({}, restProps, {
    vkuiClass: (0, _classNames.classNames)("PanelHeaderContext", platform === _platform.Platform.IOS && "PanelHeaderContext--ios", opened && "PanelHeaderContext--opened", closing && "PanelHeaderContext--closing", (0, _getSizeXClassName.getSizeXClassName)("PanelHeaderContext", sizeX), "PanelHeaderContext--rounded"),
    vertical: "top"
  ...
  }, visible && children)), visible && (0, _jsxRuntime.createScopedElement)("div", {
