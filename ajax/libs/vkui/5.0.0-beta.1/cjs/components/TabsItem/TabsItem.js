...
var TabsItem = function TabsItem(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({}, restProps, {
    vkuiClass: (0, _classNames.classNames)("TabsItem", (platform === _platform.Platform.IOS || platform === _platform.Platform.VKCOM) && "TabsItem--".concat(platform), mode && "TabsItem--mode-".concat(mode), selected && "TabsItem--selected", (0, _getSizeYClassName.getSizeYClassName)("TabsItem", sizeY), withGaps && "TabsItem--withGaps"),
