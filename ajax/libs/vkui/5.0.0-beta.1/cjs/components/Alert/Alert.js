...
var AlertAction = function AlertAction(_ref) {
  ...
  if (platform === _platform.Platform.IOS) {
    ...
    return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({
      ...
      vkuiClass: (0, _classNames.classNames)("Alert__action", "Alert__action--mode-".concat(action.mode)),
  ...
  return (0, _jsxRuntime.createScopedElement)(_Button.Button, {
    vkuiClass: (0, _classNames.classNames)("Alert__button", "Alert__button--mode-".concat(action.mode)),
    mode: mode,
    size: "m",
    onClick: handleItemClick,
...
var Alert = function Alert(_ref2) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_PopoutWrapper.PopoutWrapper, {
    ...
    onClose: close,
    timeout: timeout,
    vkuiClass: (0, _classNames.classNames)("Alert", platform === _platform.Platform.IOS && "Alert--ios", platform === _platform.Platform.VKCOM && "Alert--vkcom", resolvedActionsLayout === "vertical" ? "Alert--v" : "Alert--h", closing && "Alert--closing", isDesktop && "Alert--desktop"),
    role: "alertdialog",
    "aria-modal": true,
  ...
  })), isDesktop && (0, _jsxRuntime.createScopedElement)(_ModalDismissButton.ModalDismissButton, {
    onClick: close,
