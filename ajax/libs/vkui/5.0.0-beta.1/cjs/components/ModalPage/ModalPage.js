...
var ModalPage = function ModalPage(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)("div", (0, _extends2.default)({}, restProps, {
    id: id,
    vkuiClass: (0, _classNames.classNames)("ModalPage", platform === _platform.Platform.IOS && "ModalPage--ios", platform === _platform.Platform.VKCOM && "ModalPage--vkcom", (0, _getSizeXClassName.getSizeXClassName)("ModalPage", sizeX), isDesktop && "ModalPage--desktop", "ModalPage--size-".concat(size))
