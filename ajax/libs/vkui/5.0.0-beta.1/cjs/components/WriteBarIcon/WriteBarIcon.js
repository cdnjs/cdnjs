...
var WriteBarIcon = function WriteBarIcon(_ref) {
  ...
  switch (mode) {
    case "attach":
      icon = platform === _platform.Platform.IOS ? (0, _jsxRuntime.createScopedElement)(_icons.Icon28AddCircleOutline, {
        "aria-hidden": true
    ...
    case "send":
      icon = platform === _platform.Platform.IOS ? (0, _jsxRuntime.createScopedElement)(_icons.Icon48WritebarSend, {
        "aria-hidden": true
    ...
    case "done":
      icon = platform === _platform.Platform.IOS ? (0, _jsxRuntime.createScopedElement)(_icons.Icon48WritebarDone, {
        "aria-hidden": true
  ...
  return (0, _jsxRuntime.createScopedElement)(_Tappable.Tappable, (0, _extends2.default)({
    ...
    vkuiClass: (0, _classNames.classNames)("WriteBarIcon", platform === _platform.Platform.IOS && "WriteBarIcon--ios", mode && "WriteBarIcon--mode-".concat(mode))
