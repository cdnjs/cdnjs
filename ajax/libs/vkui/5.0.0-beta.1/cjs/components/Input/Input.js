...
var Input = function Input(_ref) {
  ...
  return (0, _jsxRuntime.createScopedElement)(_FormField.FormField, {
    vkuiClass: (0, _classNames.classNames)("Input", align && "Input--align-".concat(align), (0, _getSizeYClassName.getSizeYClassName)("Input", sizeY), before && "Input--hasBefore", after && "Input--hasAfter"),
    style: style,
    className: className,
