...
export var TabsItem = function TabsItem(_ref) {
  ...
  return createScopedElement(Tappable, _extends({}, restProps, {
    vkuiClass: classNames("TabsItem", (platform === Platform.IOS || platform === Platform.VKCOM) && "TabsItem--".concat(platform), mode && "TabsItem--mode-".concat(mode), selected && "TabsItem--selected", getSizeYClassName("TabsItem", sizeY), withGaps && "TabsItem--withGaps"),
