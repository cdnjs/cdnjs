...
export var Banner = function Banner(_ref) {
  ...
  return createScopedElement("section", _extends({}, restProps, {
    vkuiClass: classNames("Banner", platform === Platform.IOS && "Banner--ios", "Banner--mode-".concat(mode), "Banner--size-".concat(size), mode === "image" && imageTheme === "dark" && "Banner--inverted")
    ...
    hoverMode: "opacity",
    hasActive: false
  }, platform === Platform.IOS ? createScopedElement(IconDismissIOS, null) : createScopedElement(Icon24Cancel, null)))));
};
