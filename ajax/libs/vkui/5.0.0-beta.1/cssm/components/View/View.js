...
export var View = function View(_ref) {
  ...
  return createScopedElement(Touch, _extends({
    ...
    vkuiClass: classNames("View", platform === Platform.IOS && "View--ios", !disableAnimation && animated && "View--animated", !disableAnimation && swipingBack && "View--swiping-back", disableAnimation && "View--no-motion"),
    onMoveX: onMoveX,
    onEnd: onEnd
