...
export var CustomSelectOption = function CustomSelectOption(_ref) {
  ...
  return createScopedElement(Paragraph, _extends({}, restProps, {
    ...
    vkuiClass: classNames("CustomSelectOption", getSizeYClassName("CustomSelectOption", sizeY), hovered && !disabled && "CustomSelectOption--hover", selected && "CustomSelectOption--selected", // Note: пустой класс
