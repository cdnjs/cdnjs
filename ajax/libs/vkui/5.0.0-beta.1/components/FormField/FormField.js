...
export var FormField = function FormField(_ref) {
  ...
  return createScopedElement(Component, _extends({
    ...
    vkuiClass: classNames("FormField", "FormField--mode-".concat(mode), "FormField--status-".concat(status), getSizeYClassName("FormField", sizeY), disabled && "FormField--disabled", !disabled && hover && "FormField--hover")
