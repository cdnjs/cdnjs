...
export var SplitCol = function SplitCol(props) {
  ...
  return createScopedElement("div", _extends({}, restProps, {
    ...
    ref: baseRef,
    vkuiClass: classNames("SplitCol", getSizeXClassName("SplitCol", sizeX), getViewWidthClassName("SplitCol", viewWidth), spaced && "SplitCol--spaced", spaced === undefined && "SplitCol--spaced-none", autoSpaced && "SplitCol--spaced-auto", fixed && "SplitCol--fixed", stretchedOnMobile && "SplitCol--stretched-on-mobile")
