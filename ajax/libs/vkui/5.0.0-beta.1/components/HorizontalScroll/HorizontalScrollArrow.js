...
export var HorizontalScrollArrow = function HorizontalScrollArrow(_ref) {
  ...
  return createScopedElement(Tappable, _extends({}, restProps, {
    ...
    hasHover: false,
    hasActive: false,
    vkuiClass: classNames("HorizontalScrollArrow", "HorizontalScrollArrow--size-".concat(size), "HorizontalScrollArrow--direction-".concat(direction), platform === Platform.IOS && "HorizontalScrollArrow--ios"),
    onClick: onClick
