...
var CellTypography = function CellTypography(_ref) {
  ...
  return size === "s" ? createScopedElement(Caption, restProps, children) : createScopedElement(Subhead, restProps, children);
};
...
export var HorizontalCell = function HorizontalCell(_ref2) {
  ...
  return createScopedElement("div", {
    vkuiClass: classNames("HorizontalCell", "HorizontalCell--size-".concat(size)),
    ref: getRootRef,
    style: style,
    className: className
