...
export var WriteBarIcon = function WriteBarIcon(_ref) {
  ...
  switch (mode) {
    case "attach":
      icon = platform === Platform.IOS ? createScopedElement(Icon28AddCircleOutline, {
        "aria-hidden": true
    ...
    case "send":
      icon = platform === Platform.IOS ? createScopedElement(Icon48WritebarSend, {
        "aria-hidden": true
    ...
    case "done":
      icon = platform === Platform.IOS ? createScopedElement(Icon48WritebarDone, {
        "aria-hidden": true
  ...
  return createScopedElement(Tappable, _extends({
    ...
    vkuiClass: classNames("WriteBarIcon", platform === Platform.IOS && "WriteBarIcon--ios", mode && "WriteBarIcon--mode-".concat(mode))
