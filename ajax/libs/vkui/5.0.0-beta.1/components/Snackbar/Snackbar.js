...
export var Snackbar = function Snackbar(_ref) {
  ...
  return createScopedElement(AppRootPortal, null, createScopedElement("div", _extends({}, restProps, {
    vkuiClass: classNames("Snackbar", platform === Platform.IOS && "Snackbar--ios", "Snackbar--layout-".concat(layout), "Snackbar--mode-".concat(mode), closing && "Snackbar--closing", touched && "Snackbar--touched", isDesktop && "Snackbar--desktop")
