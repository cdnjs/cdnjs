  ...
  _createClass(ModalRootTouchComponent, [{
    ...
    value: function render() {
      ...
      return createScopedElement(TouchRootContext.Provider, {
        ...
        vkuiClass: classNames("ModalRoot", ((_this$props$configPro = this.props.configProvider) === null || _this$props$configPro === void 0 ? void 0 : _this$props$configPro.webviewType) === WebviewType.VKAPPS && "ModalRoot--vkapps", touchDown && "ModalRoot--touched", !!(enteringModal || exitingModal) && "ModalRoot--switching"),
