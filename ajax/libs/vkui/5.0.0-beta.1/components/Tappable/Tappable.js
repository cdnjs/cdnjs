...
var styles = {
  "Tappable": "vkuiTappable",
  "Tappable--hover-has-not": "vkuiTappable--hover-has-not",
  "Tappable--hover-has": "vkuiTappable--hover-has",
  "Tappable--hasActive": "vkuiTappable--hasActive",
  "Tappable--hover-none": "vkuiTappable--hover-none",
  "Tappable--active": "vkuiTappable--active",
  "Tappable--focus-visible": "vkuiTappable--focus-visible",
  "Tappable--active-background": "vkuiTappable--active-background",
  "Tappable--active-opacity": "vkuiTappable--active-opacity",
  "Tappable__hoverShadow": "vkuiTappable__hoverShadow",
  "Tappable--hover-background": "vkuiTappable--hover-background",
  "Tappable--hover-opacity": "vkuiTappable--hover-opacity",
  "Tappable--mouse": "vkuiTappable--mouse",
  "Tappable--ios": "vkuiTappable--ios",
  "Tappable__waves": "vkuiTappable__waves",
  "Tappable__wave": "vkuiTappable__wave",
  "vkui-animation-wave": "vkui-animation-wave",
  "Tappable--sizeX-regular": "vkuiTappable--sizeX-regular",
  "Tappable--sizeX-compact": "vkuiTappable--sizeX-compact",
  "Tappable--sizeX-none": "vkuiTappable--sizeX-none"
};
var WAVE_LIVE = 225;
...
export var Tappable = function Tappable(_ref) {
  ...
  var _useAdaptivity = useAdaptivity(),
      ...
      deviceHasHover = _useAdaptivity.deviceHasHover;
  ...
  var hasHover = deviceHasHover !== false && _hasHover && !childHover;
  ...
  var needWaves = platform === Platform.ANDROID && !hasMouse && hasActive && activeMode === "background";
  ...
  var classes = classNamesString(className, styles.Tappable, platform === Platform.IOS && styles["Tappable--ios"], getSizeXClassName("Tappable", sizeX, styles), getHoverClassName("Tappable", deviceHasHover, styles), hasActive && styles["Tappable--hasActive"], hasHover && hovered && !isPresetHoverMode && hoverMode, hasActive && active && !isPresetActiveMode && activeMode, focusVisible && !isPresetFocusVisibleMode && focusVisibleMode, hasActive && active && styles["Tappable--active"], hasMouse && styles["Tappable--mouse"], hasHover && hovered && isPresetHoverMode && styles["Tappable--hover-".concat(hoverMode)], hasActive && active && isPresetActiveMode && styles["Tappable--active-".concat(activeMode)], focusVisible && styles["Tappable--focus-visible"]);
  var handlers = {
  ...
  return createScopedElement(Touch, _extends({
    ...
    "aria-hidden": "true",
    className: styles.Tappable__hoverShadow
