  ...
  (0, _createClass2.default)(ViewInfinite, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.activePanel !== this.props.activePanel && prevState.swipingBack) {
        ...
        this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, this.scrolls), {}, (_objectSpread4 = {}, (0, _defineProperty2.default)(_objectSpread4, nextPanel, newPanelScrolls), (0, _defineProperty2.default)(_objectSpread4, prevPanel, prevPanelScrolls), _objectSpread4));
        this.setState({
          swipeBackPrevPanel: null,
          swipeBackNextPanel: null,
          swipingBack: false,
    ...
    value: function flushTransition(prevPanel, isBack) {
      ...
      if (isBack) {
        ...
        this.scrolls = (0, _objectSpread7.default)((0, _objectSpread7.default)({}, this.scrolls), {}, (_objectSpread6 = {}, (0, _defineProperty2.default)(_objectSpread6, prevPanel, prevPanelScrolls), (0, _defineProperty2.default)(_objectSpread6, activePanel, newPanelScrolls), _objectSpread6));
      }
