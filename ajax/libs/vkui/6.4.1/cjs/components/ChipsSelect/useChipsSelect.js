...
creatable = false, emptyText = _constants1.DEFAULT_EMPTY_TEXT, filterFn = _select.defaultFilterFn, selectedBehavior = _constants1.DEFAULT_SELECTED_BEHAVIOR, options: optionsProp = _constants.DEFAULT_VALUE, onClose, onOpen })=>{
    ...
    const handleOpened = _react.useCallback((isOpened)=>{
