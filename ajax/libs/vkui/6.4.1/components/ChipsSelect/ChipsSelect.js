 ...
 */ export const ChipsSelect = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsx(ChipsInputBase, _object_spread_props(_object_spread({}, restProps), {
                disabled: disabled,
                readOnly: readOnly,
                ...
                after: dropdownIconProp || /*#__PURE__*/ _jsx(DropdownIcon, {
                    opened: opened,
                    className: clearButtonShown ? "vkuiChipsSelect__dropdown-icon" : undefined
                }),
                // option
                value: value,
