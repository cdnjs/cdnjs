...
export const CustomScrollView = (_param)=>{
    var { className, children, boxRef: externalBoxRef, windowResize, autoHideScrollbar = false, autoHideScrollbarDelay, onScroll, getRootRef, overscrollBehavior = 'auto' } = _param, restProps = _object_without_properties(_param, [
        "className",
        "children",
        "boxRef",
        "windowResize",
    ...
    return /*#__PURE__*/ _jsxs("div", _object_spread_props(_object_spread({
        ...
        children: [
            /*#__PURE__*/ _jsx("div", {
                className: classNames("vkuiCustomScrollView__box", overscrollBehaviorClassNames[overscrollBehavior]),
                tabIndex: -1,
                ref: boxRef,
                onScroll: scroll,
