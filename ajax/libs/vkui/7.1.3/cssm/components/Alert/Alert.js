 ...
 */ export const Alert = ({ actions, actionsLayout = 'horizontal', children, className, style, title, description, onClose, dismissLabel = 'Закрыть предупреждение', renderAction, actionsAlign, dismissButtonMode = 'outside', dismissButtonTestId, getRootRef, usePortal, ...restProps })=>{
