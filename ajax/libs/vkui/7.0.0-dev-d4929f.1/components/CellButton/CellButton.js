...
export const appearanceClassNames = {
    accent: "CellButton__appearanceAccent--HJhEm",
    neutral: "CellButton__appearanceNeutral--CxQYx",
    negative: "CellButton__appearanceNegative--jxkln"
};
/**
 ...
 */ export const CellButton = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(SimpleCell, _object_spread_props(_object_spread({}, restProps), {
        className: classNames("CellButton__host--jj1Ol", appearanceClassNames[appearance], centered && "CellButton__centered--nxo6S", className)
    }));
};
