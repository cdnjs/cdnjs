...
export function CheckboxInput(_param) {
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, {
        baseClassName: "CheckboxInput__host--cCzLs",
        className: className,
        style: style,
        ...
        children: [
            /*#__PURE__*/ _jsx(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
                ...
                className: "CheckboxInput__input--3cMgG",
                getRootRef: inputRef
            })),
            platform === 'vkcom' ? /*#__PURE__*/ _jsx(IconOnCompact, {
                className: "CheckboxInput__iconOn--q32UI"
            }) : /*#__PURE__*/ _jsxs(React.Fragment, {
                children: [
                    adaptiveSizeY.compact && /*#__PURE__*/ _jsx(IconOnCompact, {
                        className: classNames("CheckboxInput__iconOn--q32UI", adaptiveSizeY.compact.className)
                    }),
                    adaptiveSizeY.regular && /*#__PURE__*/ _jsx(IconOnRegular, {
                        className: classNames("CheckboxInput__iconOn--q32UI", adaptiveSizeY.regular.className)
                    })
                ]
            }),
            platform === 'vkcom' ? /*#__PURE__*/ _jsx(IconOffCompact, {
                className: "CheckboxInput__iconOff--3FAYR"
            }) : /*#__PURE__*/ _jsxs(React.Fragment, {
                children: [
                    adaptiveSizeY.compact && /*#__PURE__*/ _jsx(IconOffCompact, {
                        className: classNames("CheckboxInput__iconOff--3FAYR", adaptiveSizeY.compact.className)
                    }),
                    adaptiveSizeY.regular && /*#__PURE__*/ _jsx(IconOffRegular, {
                        className: classNames("CheckboxInput__iconOff--3FAYR", adaptiveSizeY.regular.className)
                    })
                ]
            }),
            platform === 'vkcom' ? /*#__PURE__*/ _jsx(IconIndeterminate, {
                width: 20,
                height: 20,
                className: "CheckboxInput__iconIndeterminate--s68Pf"
            }) : /*#__PURE__*/ _jsxs(React.Fragment, {
                children: [
                    adaptiveSizeY.compact && /*#__PURE__*/ _jsx(IconIndeterminate, {
                        className: classNames("CheckboxInput__iconIndeterminate--s68Pf", adaptiveSizeY.compact.className),
                        width: 20,
                        height: 20
                    }),
                    adaptiveSizeY.regular && /*#__PURE__*/ _jsx(IconIndeterminate, {
                        className: classNames("CheckboxInput__iconIndeterminate--s68Pf", adaptiveSizeY.regular.className),
                        width: 24,
                        height: 24
                    })
                ]
