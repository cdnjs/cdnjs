 ...
 */ export const SegmentedControlOption = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(Clickable, {
        Component: "label",
        baseClassName: "SegmentedControlOption__host--YXdhB",
        hoverClassName: "SegmentedControlOption__hover--Tcli0",
        activeClassName: "SegmentedControlOption__hover--Tcli0",
        className: className,
        ...
        children: [
            ...
            hasReactNode(before) && /*#__PURE__*/ _jsx("div", {
                className: "SegmentedControlOption__before--5m6Or",
                children: before
            }),
