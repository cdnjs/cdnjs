 ...
 */ export const HorizontalScroll = (_param)=>{
   ...
   */ const onwheel = React.useCallback((e)=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("HorizontalScroll__host--RKQSm", 'vkuiInternalHorizontalScroll', showArrows === 'always' && "HorizontalScroll__withConstArrows--Q6WYZ"),
        ...
        children: [
            showArrows && (hasPointer || hasPointer === undefined) && canScrollLeft && /*#__PURE__*/ _jsx(ScrollArrow, {
                ...
                "aria-hidden": true,
                tabIndex: -1,
                className: classNames("HorizontalScroll__arrow--yQyDe", "HorizontalScroll__arrowLeft--Fko-q"),
            ...
            showArrows && (hasPointer || hasPointer === undefined) && canScrollRight && /*#__PURE__*/ _jsx(ScrollArrow, {
                ...
                "aria-hidden": true,
                tabIndex: -1,
                className: classNames("HorizontalScroll__arrow--yQyDe", "HorizontalScroll__arrowRight--EnAKB"),
                onClick: scrollToRight
            }),
            /*#__PURE__*/ _jsx("div", {
                className: "HorizontalScroll__in--FmIM7",
                ref: scrollerRef,
                children: /*#__PURE__*/ _jsx("div", {
                    className: "HorizontalScroll__inWrapper--0fp0E",
                    children: children
                })
            })
        ]
