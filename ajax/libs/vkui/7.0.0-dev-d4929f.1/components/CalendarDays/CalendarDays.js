...
export const CalendarDays = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, props), {
        baseClassName: "CalendarDays__host--8UaLv",
        getRootRef: ref,
        children: [
            /*#__PURE__*/ _jsx("div", {
                className: classNames("CalendarDays__row--RyB8e", size === 's' && "CalendarDays__rowSizeS--F27yM"),
                children: daysNames.map((dayName)=>/*#__PURE__*/ _jsx(Footnote, {
                        className: "CalendarDays__weekday--ZinNP",
                        children: dayName
                    }, dayName))
            }),
            weeks.map((week, i)=>/*#__PURE__*/ _jsx("div", {
                    ...
                    children: week.map((day, i)=>{
                        ...
                        return /*#__PURE__*/ _jsx(CalendarDay, _object_spread_props(_object_spread({
                            ...
                            className: classNames(dayProps === null || dayProps === void 0 ? void 0 : dayProps.className, "CalendarDays__rowDay--6gUb5")
                        }), day.toISOString());
                    })
                }, i))
        ]
