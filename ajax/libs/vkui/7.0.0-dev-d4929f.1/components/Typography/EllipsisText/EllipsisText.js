 ...
 */ const EllipsisText = (_param)=>{
    var { className, getRootRef, children, maxWidth, maxLines = 1, disableNativeTitle = false } = _param, restProps = _object_without_properties(_param, [
        "className",
        "getRootRef",
        "children",
        "maxWidth",
    ...
    return /*#__PURE__*/ _jsx("span", _object_spread_props(_object_spread({
        ref: getRootRef,
        className: classNames("EllipsisText__host--OBPq0", disableNativeTitle && "EllipsisText__disableNativeTitle--9smWQ", className),
        ...
        children: /*#__PURE__*/ _jsx("span", {
            ...
            ref: contentRef,
            className: classNames("EllipsisText__content--tg1WU", maxLines > 1 && "EllipsisText__contentMultiline--B2dJq"),
            children: children
        })
    }));
};
