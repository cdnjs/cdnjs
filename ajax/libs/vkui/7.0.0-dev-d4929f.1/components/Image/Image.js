 ...
 */ export const Image = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(ImageBase, _object_spread_props(_object_spread({}, restProps), {
        ...
        className: classNames(className, "Image__host--rNCSn", borderStartStartRadius && "Image__borderStartStartRadius--e7QQz", borderStartEndRadius && "Image__borderStartEndRadius--wyR5F", borderEndStartRadius && "Image__borderEndStartRadius--e27e6", borderEndEndRadius && "Image__borderEndEndRadius--HR40A")
    }));
};
