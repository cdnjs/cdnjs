 ...
 */ export const ChipsSelect = (_param)=>{
        ...
        const defaultDropdownContent = options.map((option, index)=>{
            ...
            if (isEmptyOptionPreset(option)) {
                return /*#__PURE__*/ _jsx(Footnote, {
                    className: "ChipsSelect__empty--wgyDe",
    ...
    const openedClassNames = React.useMemo(()=>opened && dropdownOffsetDistance === 0 && (dropdownVerticalPlacement.includes('top') ? "ChipsSelect__popUp--dG5-F" : "ChipsSelect__popDown--twVKu") || undefined, [
        dropdownOffsetDistance,
        opened,
    ...
    return /*#__PURE__*/ _jsxs(_Fragment, {
        children: [
            /*#__PURE__*/ _jsx(ChipsInputBase, _object_spread_props(_object_spread({}, restProps), {
                ...
                id: labelledbyId,
                getRootRef: rootRef,
                className: classNames("ChipsSelect__host--egqIa", openedClassNames, className),
                status: status,
                after: dropdownIconProp || /*#__PURE__*/ _jsx(DropdownIcon, {
                    opened: opened,
                    onClick: onDropdownIconClick,
                    className: classNames("ChipsSelect__dropdownIcon--SEiS5", clearButtonShown && "ChipsSelect__dropdownIconWithOffset--D3W5B")
                }),
                // option
                value: value,
