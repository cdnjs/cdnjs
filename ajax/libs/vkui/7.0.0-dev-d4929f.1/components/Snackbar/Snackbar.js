...
const placementClassNames = {
    'top-start': "Snackbar__placementTopStart--FRzgi",
    'top': "Snackbar__placementTop--5n49k",
    'top-end': "Snackbar__placementTopEnd--3MeKO",
    'bottom-start': "Snackbar__placementBottomStart--2xjFM",
    'bottom': "Snackbar__placementBottom--c1qzB",
    'bottom-end': "Snackbar__placementBottomEnd--pqc79"
};
const animationStateClassNames = {
    enter: "Snackbar__stateEnter--9f0sg",
    entering: "Snackbar__stateEntering--oGNaZ",
    entered: "Snackbar__stateEntered--vL7gp",
    exit: "Snackbar__stateExit--RIOrZ",
    exiting: "Snackbar__stateExiting--FJyU-",
    exited: undefined
};
/**
 ...
 */ export const Snackbar = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        role: "presentation",
        baseClassName: classNames("Snackbar__host--ZJd4z", platform === 'ios' && "Snackbar__ios--IrTdq", touched && "Snackbar__touched--rSV8l", placementClassNames[placement], animationStateClassNames[animationState]),
        style: resolveOffsetYCssStyle(placement, style, offsetY),
        getRootRef: rootRef,
        children: /*#__PURE__*/ _jsx("div", _object_spread_props(_object_spread({
            role: "alert",
            className: "Snackbar__in--Kyyrh",
            ref: inRef,
            // mobile
