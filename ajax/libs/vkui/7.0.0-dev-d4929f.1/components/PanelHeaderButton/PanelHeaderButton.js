...
const platformClassNames = {
    ios: "PanelHeaderButton__ios--4C-Xh",
    android: "PanelHeaderButton__android--7Iu6P",
    vkcom: "PanelHeaderButton__vkcom--lpJUU"
};
 ...
 */ export const PanelHeaderButton = (_param)=>{
    ...
    switch(platform){
        case 'ios':
            ...
            break;
        case 'vkcom':
            hoverMode = "PanelHeaderButton__hover--BT8wT";
            activeMode = "PanelHeaderButton__active--MV6tc";
            break;
        default:
            hoverMode = 'background';
    ...
    return /*#__PURE__*/ _jsxs(Tappable, _object_spread_props(_object_spread({
        ...
        className: classNames("PanelHeaderButton__host--bg7h-", platformClassNames.hasOwnProperty(platform) ? platformClassNames[platform] : platformClassNames.android, isPrimitive && "PanelHeaderButton__primitive--BNtKu", !isPrimitive && !isPrimitiveLabel && "PanelHeaderButton__notPrimitive--3S6So", className),
        children: [
            ...
            isPrimitiveLabel ? /*#__PURE__*/ _jsx(ButtonTypography, {
                primary: primary,
                className: "PanelHeaderButton__label--eLC9P",
                children: label
            }) : label
        ]
    }));
