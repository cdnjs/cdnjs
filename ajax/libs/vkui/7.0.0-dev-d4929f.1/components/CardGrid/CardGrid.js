...
const sizeXClassNames = {
    none: "CardGrid__sizeXNone--OVA1e",
    compact: "CardGrid__sizeXCompact--eAzaY"
};
const stylesSize = {
 ...
 */ export const CardGrid = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        Component: Component,
        baseClassName: classNames("CardGrid__host--lYHAD", 'vkuiInternalCardGrid', padding && "CardGrid__padding--Wisgt", stylesSize[size], sizeX !== 'regular' && sizeXClassNames[sizeX])
    }));
};
