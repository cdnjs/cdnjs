...
const sizeYClassNames = {
    none: "ChipsInputBase__sizeYNone--6CnO6",
    compact: "ChipsInputBase__sizeYCompact--oislw"
};
export const ChipsInputBase = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(FormField, {
        ...
        children: /*#__PURE__*/ _jsxs("div", {
            className: classNames("ChipsInputBase__host--2bcSM", sizeY !== 'regular' && sizeYClassNames[sizeY], withPlaceholder && "ChipsInputBase__hasPlaceholder--bkc8r"),
            // для a11y
            ref: listboxRef,
            role: "listbox",
            ...
            children: [
                value.map((option, index)=>/*#__PURE__*/ _jsx(React.Fragment, {
                        children: renderChip({
                            ...
                            'className': "ChipsInputBase__chip--qb0ij",
                ...
                /*#__PURE__*/ _jsx(Text, _object_spread_props(_object_spread({
                    ...
                    getRootRef: inputRef,
                    className: "ChipsInputBase__el--OOJGu",
                    disabled: disabled,
                    readOnly: readOnly,
