...
export const CellCheckbox = (_param)=>{
    ...
    return /*#__PURE__*/ _jsxs("span", {
        className: classNames("CellCheckbox__host--e7lXw", className),
        style: style,
        ref: getRootRef,
        children: [
            /*#__PURE__*/ _jsx(VisuallyHidden, _object_spread_props(_object_spread({}, restProps), {
                Component: "input",
                type: "checkbox",
                className: "CellCheckbox__input--5uH1g",
                getRootRef: getRef
            })),
            /*#__PURE__*/ _jsx("span", {
                className: classNames("CellCheckbox__icon--1eC9s", "CellCheckbox__iconOff--2xEc-"),
                "aria-hidden": true,
                children: /*#__PURE__*/ _jsx(IconOff, {})
            }),
            /*#__PURE__*/ _jsx("span", {
                className: classNames("CellCheckbox__icon--1eC9s", "CellCheckbox__iconOn--kYr1l"),
                "aria-hidden": true,
