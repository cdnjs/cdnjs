...
export const BaseGallery = (_param)=>{
   ...
   */ const getTarget = (e)=>{
    ...
    return /*#__PURE__*/ _jsxs(RootComponent, _object_spread_props(_object_spread({}, restProps), {
        baseClassName: classNames("BaseGallery__host--33dcc", align === 'center' && "BaseGallery__alignCenter--scdu1", slideWidth === 'custom' && "BaseGallery__customWidth--dM-b4", isDraggable && "BaseGallery__draggable--n6W80"),
        getRootRef: rootRef,
        children: [
            /*#__PURE__*/ _jsx(Touch, {
