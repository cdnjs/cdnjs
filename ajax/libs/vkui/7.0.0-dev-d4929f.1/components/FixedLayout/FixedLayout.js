...
const stylesVertical = {
    top: "FixedLayout__verticalTop--27BDZ",
    bottom: classNames("FixedLayout__verticalBottom--xLeQb", 'vkuiInternalFixedLayout--vertical-bottom')
};
/**
 ...
 */ export const FixedLayout = (_param)=>{
    ...
    return /*#__PURE__*/ _jsx(OnboardingTooltipContainer, _object_spread_props(_object_spread({}, restProps), {
        fixed: true,
        ref: handleRootRef,
        className: classNames("FixedLayout__host--LM7Vh", platform === 'ios' && 'vkuiInternalFixedLayout--ios', filled && "FixedLayout__filled--08fwU", vertical && stylesVertical[vertical], className),
