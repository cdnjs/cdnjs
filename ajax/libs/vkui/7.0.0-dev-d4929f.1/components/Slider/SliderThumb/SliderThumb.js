...
export const SliderThumb = (_param)=>{
    ...
    const focusVisibleClassNames = useFocusVisibleClassName({
        focusVisible,
        mode: "SliderThumb__focusVisible--Vkq7e"
    });
    ...
    return /*#__PURE__*/ _jsxs(React.Fragment, {
        children: [
            /*#__PURE__*/ _jsx("span", _object_spread_props(_object_spread({}, restProps), {
                ...
                className: classNames("SliderThumb__host--WwsXu", focusVisibleClassNames, isActive && "SliderThumb__active--KC0yc", isHovered && "SliderThumb__hover--2Nuo6", className),
                children: /*#__PURE__*/ _jsx("input", _object_spread_props(_object_spread({}, inputProps), {
                    type: "range",
                    className: "SliderThumb__nativeInput--yfD5d",
