...
export var Input = function Input(_ref) {
  ...
  return /*#__PURE__*/React.createElement(FormField, {
    style: style,
    className: classNamesString("vkuiInput", align && styles["Input--align-".concat(align)], getSizeYClassName("vkuiInput", sizeY), before && "vkuiInput--hasBefore", after && "vkuiInput--hasAfter", className),
