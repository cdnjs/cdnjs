...
export var FormField = function FormField(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, _extends({
    ...
    className: classNamesString("vkuiFormField", styles["FormField--mode-".concat(mode)], styles["FormField--status-".concat(status)], getSizeYClassName("vkuiFormField", sizeY), disabled && "vkuiFormField--disabled", !disabled && hover && "vkuiFormField--hover", className)
