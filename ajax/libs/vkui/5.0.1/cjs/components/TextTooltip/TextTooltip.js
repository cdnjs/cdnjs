...
var TextTooltip = function TextTooltip(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_HoverPopper.HoverPopper, (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiTextTooltip", styles["TextTooltip--appearance-".concat(appearance)], className),
    arrow: true,
    arrowClassName: "vkuiTextTooltip__arrow",
    content: /*#__PURE__*/React.createElement(React.Fragment, null, (0, _utils.hasReactNode)(header) && /*#__PURE__*/React.createElement(_Subhead.Subhead, {
      weight: "2",
      className: "vkuiTextTooltip__header"
    }, header), (0, _utils.hasReactNode)(text) && /*#__PURE__*/React.createElement(_Subhead.Subhead, {
