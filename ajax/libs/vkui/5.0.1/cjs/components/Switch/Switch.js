...
var Switch = function Switch(_ref) {
  ...
  return /*#__PURE__*/React.createElement("label", {
    className: (0, _classNames.classNamesString)("vkuiSwitch", (0, _getPlatformClassName.getPlatformClassName)("vkuiSwitch", platform), (0, _getSizeYClassName.getSizeYClassName)("vkuiSwitch", sizeY), restProps.disabled && "vkuiSwitch--disabled", focusVisible && "vkuiSwitch--focus-visible", className),
    style: style,
    ref: getRootRef,
    role: "presentation"
