...
var ButtonGroup = function ButtonGroup(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
    className: (0, _classNames.classNamesString)(className, "vkuiButtonGroup", styles["ButtonGroup--mode-".concat(mode)], gap !== "none" && styles["ButtonGroup--gap-".concat(gap)], stretched && "vkuiButtonGroup--stretched", align && styles["ButtonGroup--align-".concat(align)]),
    role: "group",
    ref: getRootRef
  }, restProps), children);
};
