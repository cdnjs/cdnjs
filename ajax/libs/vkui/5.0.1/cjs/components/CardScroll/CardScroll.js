...
var CardScroll = function CardScroll(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiCardScroll", (0, _getSizeXClassName.getSizeXClassName)("vkuiCardScroll", sizeX), styles["CardScroll--size-".concat(size)], withSpaces && "vkuiCardScroll--withSpaces", className)
