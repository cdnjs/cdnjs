...
var Cell = function Cell(_ref) {
  ...
  var cellClasses = (0, _classNames.classNamesString)("vkuiCell", platform === _platform.Platform.IOS && "vkuiCell--ios", dragging && "vkuiCell--dragging", removable && "vkuiCell--removable", selectable && "vkuiCell--selectable", disabled && "vkuiCell--disabled");
  ...
  if (removable) {
    return /*#__PURE__*/React.createElement(_Removable.Removable, {
      className: (0, _classNames.classNamesString)(cellClasses, className),
      style: style,
