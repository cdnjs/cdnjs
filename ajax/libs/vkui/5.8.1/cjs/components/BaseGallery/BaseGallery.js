...
var BaseGallery = function(_param) {
    ...
    var layoutState = _react.useRef(LAYOUT_DEFAULT_STATE);
    var _React_useState = _sliced_to_array._(_react.useState(SHIFT_DEFAULT_STATE), 2), shiftState = _React_useState[0], setShiftState = _React_useState[1];
   ...
   */ var calculateDragIndent = function() {
    ...
    var initializeSlides = function() {
        ...
        var localSlides = (_React_Children_map = _react.Children.map(children, function(_item, i) {
            var _elem, _elem1;
   ...
   */ var getTarget = function(e) {
    ...
    var onEnd = function(e) {
        ...
        setShiftState(function(prevState) {
            return _object_spread._({}, prevState, nextShiftState);
        });
        if (targetIndex !== slideIndex) {
            var _onChange;
