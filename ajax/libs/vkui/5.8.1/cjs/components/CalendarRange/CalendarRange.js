...
var CalendarRange = function(_param) {
    ...
    var handleKeyDown = _react.useCallback(function(event) {
        ...
        var newFocusedDay = (0, _calendar.navigateDate)(focusedDay !== null && focusedDay !== void 0 ? focusedDay : (_value = value) === null || _value === void 0 ? void 0 : _value[1], event.key);
    ...
    var isDayActive = _react.useCallback(function(day) {
        var _value, _value1;
        return Boolean(((_value = value) === null || _value === void 0 ? void 0 : _value[0]) && (0, _date.isSameDay)(day, value[0]) || ((_value1 = value) === null || _value1 === void 0 ? void 0 : _value1[1]) && (0, _date.isSameDay)(day, value[1]));
    }, [
        value
    ]);
    var isDaySelectionEnd = _react.useCallback(function(day, dayOfWeek) {
        var _value;
        return Boolean((0, _calendar.isLastDay)(day, dayOfWeek) || ((_value = value) === null || _value === void 0 ? void 0 : _value[1]) && (0, _date.isSameDay)(day, value[1]));
    }, [
        value
    ]);
    var isHintedDaySelectionEnd = _react.useCallback(function(day, dayOfWeek) {
        var _hintedDate;
        return Boolean((0, _calendar.isLastDay)(day, dayOfWeek) || ((_hintedDate = hintedDate) === null || _hintedDate === void 0 ? void 0 : _hintedDate[1]) && (0, _date.isSameDay)(day, hintedDate[1]));
    }, [
        hintedDate
    ]);
    var isDaySelectionStart = _react.useCallback(function(day, dayOfWeek) {
        var _value;
        return Boolean((0, _calendar.isFirstDay)(day, dayOfWeek) || ((_value = value) === null || _value === void 0 ? void 0 : _value[0]) && (0, _date.isSameDay)(day, value[0]));
    }, [
        value
    ]);
    var isHintedDaySelectionStart = _react.useCallback(function(day, dayOfWeek) {
        var _hintedDate;
        return Boolean((0, _calendar.isFirstDay)(day, dayOfWeek) || ((_hintedDate = hintedDate) === null || _hintedDate === void 0 ? void 0 : _hintedDate[0]) && (0, _date.isSameDay)(day, hintedDate[0]));
    }, [
        hintedDate
    ]);
