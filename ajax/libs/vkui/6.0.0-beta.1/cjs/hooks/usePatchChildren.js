...
const usePatchChildren = (children, injectProps, externRef)=>{
    ...
    const childRef = (0, _useExternRef.useExternRef)(isDOMTypeElementResult ? children.ref : isValidElementResult ? children.props.getRootRef : undefined, externRef);
    ...
    const props = isDOMTypeElementResult ? _object_spread._({
        ref: childRef
