...
const PlaceholderContainer = (_param)=>/*#__PURE__*/ {
    var { stretched, withPadding = true } = _param, restProps = _object_without_properties._(_param, [
        "stretched",
        "withPadding"
    ]);
...
const Placeholder = (_param)=>/*#__PURE__*/ {
    var { icon, header, children, action, withPadding = true } = _param, restProps = _object_without_properties._(_param, [
        "icon",
        "header",
        "children",
        "action",
