...
const PanelHeaderIn = ({ before, after, separator, children, typographyProps = {} })=>{
    ...
    return /*#__PURE__*/ _react.createElement(_react.Fragment, null, /*#__PURE__*/ _react.createElement(_OnboardingTooltipContainer.OnboardingTooltipContainer, {
        fixed: true,
    ...
    }, afterSlotProps))), separator && platform === 'vkcom' && /*#__PURE__*/ _react.createElement(_Separator.Separator, {
        className: "vkuiPanelHeader__separator",
        wide: true
    }));
};
const PanelHeader = (_param)=>{
    var { before, children, after, separator = true, visor = true, transparent = false, shadow, getRef, getRootRef, fixed, typographyProps } = _param, restProps = _object_without_properties._(_param, [
        "before",
        "children",
        "after",
        "separator",
    ...
    return /*#__PURE__*/ _react.createElement(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        separator: separator,
        typographyProps: typographyProps
    }, children), separator && visor && platform !== 'vkcom' && /*#__PURE__*/ _react.createElement(_react.Fragment, null, adaptiveSizeX.compact && /*#__PURE__*/ _react.createElement(_Separator.Separator, {
