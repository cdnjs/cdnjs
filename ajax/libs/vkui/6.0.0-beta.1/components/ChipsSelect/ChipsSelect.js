...
import { DEFAULT_INPUT_LABEL, getNewOptionDataDefault, getOptionLabelDefault, getOptionValueDefault, renderChipDefault } from '../ChipsInputBase/constants';
import { CustomSelectDropdown } from '../CustomSelectDropdown/CustomSelectDropdown';
import { CustomSelectOption } from '../CustomSelectOption/CustomSelectOption';
import { DropdownIcon } from '../DropdownIcon/DropdownIcon';
import { IconButton } from '../IconButton/IconButton';
import { Footnote } from '../Typography/Footnote/Footnote';
import { DEFAULT_EMPTY_TEXT, DEFAULT_SELECTED_BEHAVIOR, FOCUS_ACTION_NEXT, FOCUS_ACTION_PREV, getIconLabelDefault, isCreateNewOptionPreset, isEmptyOptionPreset, isNotServicePreset, renderOptionDefault } from './constants';
 ...
 */ export const ChipsSelect = (_param)=>{
    var { // FormFieldProps
    getRootRef, className, status = 'default', before, icon, getIconLabel = getIconLabelDefault, onChangeStart, // CustomSelectDropdownProps
    options: optionsProp, placement: placementProp = 'bottom', closeAfterSelect = true, selectedBehavior = DEFAULT_SELECTED_BEHAVIOR, emptyText = DEFAULT_EMPTY_TEXT, creatable = false, fetching = false, fixDropdownWidth, forceDropdownPortal, noMaxHeight = false, filterFn = defaultFilterFn, dropdownTestId, // ChipsInputProps
    getRef, value: valueProp, defaultValue, inputValue: inputValueProp, defaultInputValue, inputLabel = DEFAULT_INPUT_LABEL, disabled, getOptionValue = getOptionValueDefault, getOptionLabel = getOptionLabelDefault, getNewOptionData = getNewOptionDataDefault, renderChip = renderChipDefault, renderOption = renderOptionDefault, onChange, onFocus, onInputChange: onInputChangeProp, onBlur, onKeyDown } = _param, restProps = _object_without_properties(_param, [
        "getRootRef",
        "className",
        "status",
        "before",
