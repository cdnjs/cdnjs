 ...
 */ const NativeSelect = (_param)=>{
    var { style, defaultValue = '', align, placeholder, children, className, getRef, getRootRef, disabled, multiline, selectType = 'default', status, icon = /*#__PURE__*/ _react.createElement(_DropdownIcon.DropdownIcon, null), before, onChange: onChangeProp, value: valueProp } = _param, restProps = _object_without_properties._(_param, [
        "style",
        "defaultValue",
        "align",
        "placeholder",
