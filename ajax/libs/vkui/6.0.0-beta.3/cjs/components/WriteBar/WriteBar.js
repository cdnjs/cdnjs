...
const WriteBar = (_param)=>{
    var { className, style, before, inlineAfter, after, getRootRef, getRef, onHeightChange, shadow = false, defaultValue } = _param, restProps = _object_without_properties._(_param, [
        "className",
        "style",
        "before",
        "inlineAfter",
    ...
    const platform = (0, _usePlatform.usePlatform)();
    const [value, onChange] = (0, _useEnsuredControl.useEnsuredControl)(_object_spread._({
        defaultValue
    }, restProps));
