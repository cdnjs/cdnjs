...
const Group = (_param)=>{
    ...
    return /*#__PURE__*/ _react.createElement(_react.Fragment, null, /*#__PURE__*/ _react.createElement(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({
        ...
        tabIndex: tabIndex,
        baseClassName: (0, _vkjs.classNames)('vkuiInternalGroup', "vkuiGroup", isInsideModal && "vkuiGroup--inside-modal", platform === 'ios' && "vkuiGroup--ios", sizeX !== 'regular' && sizeXClassNames[sizeX], mode && stylesMode[mode], stylesPadding[padding])
