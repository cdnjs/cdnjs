...
const DatePickerNative = (_param)=>{
    var { min = {
        ...
        month: 12,
        year: 2100
    }, dayPlaceholder, monthPlaceholder, yearPlaceholder, popupDirection, defaultValue, day, month, year, onDateChange } = _param, restProps = _object_without_properties._(_param, [
        "min",
        "max",
        "dayPlaceholder",
        "monthPlaceholder",
