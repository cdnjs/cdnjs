...
const ChipsSelect = (_param)=>{
    var { // FormFieldProps
    getRootRef, className, status = 'default', before, icon, getIconLabel = _constants1.getIconLabelDefault, onChangeStart, // CustomSelectDropdownProps
    ...
    const dropdownAriaId = _react.useId();
