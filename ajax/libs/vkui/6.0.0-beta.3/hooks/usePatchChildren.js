 ...
 */ export const usePatchChildren = (children, injectProps, externRef)=>{
    ...
    const childRef = useExternRef(isDOMTypeElementResult ? children.ref : isValidElementResult ? children.props.getRootRef : undefined, externRef);
    const mergedEventsByInjectProps = getMergedSameEventsByProps(injectProps ? injectProps : {}, isValidElementResult ? children.props : {});
    const props = isDOMTypeElementResult ? _object_spread({
        ref: childRef
