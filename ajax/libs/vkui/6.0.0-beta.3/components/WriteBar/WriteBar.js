 ...
 */ export const WriteBar = (_param)=>{
    var { className, style, before, inlineAfter, after, getRootRef, getRef, onHeightChange, shadow = false, defaultValue } = _param, restProps = _object_without_properties(_param, [
        "className",
        "style",
        "before",
        "inlineAfter",
    ...
    const platform = usePlatform();
    const [value, onChange] = useEnsuredControl(_object_spread({
        defaultValue
    }, restProps));
