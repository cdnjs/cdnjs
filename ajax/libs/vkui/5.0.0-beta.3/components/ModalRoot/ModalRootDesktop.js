  ...
  _createClass(ModalRootDesktopComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(ModalRootContext.Provider, {
        ...
        className: classNamesString("vkuiModalRoot", ((_this$props$configPro = this.props.configProvider) === null || _this$props$configPro === void 0 ? void 0 : _this$props$configPro.webviewType) === WebviewType.VKAPPS && "vkuiModalRoot--vkapps", "vkuiModalRoot--desktop")
      }, /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement(FocusTrap, {
          ...
          key: key,
          className: classNamesString("vkuiModalRoot__modal", !exitingModal && !enteringModal && modalId === activeModal && "vkuiModalRoot__modal--active", modalId === exitingModal && "vkuiModalRoot__modal--prev", Boolean(exitingModal) && modalId === activeModal && "vkuiModalRoot__modal--next")
        }, Modal);
      }))));
    }
  }]);
