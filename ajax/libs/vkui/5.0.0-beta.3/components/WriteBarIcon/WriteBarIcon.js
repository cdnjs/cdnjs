...
export var WriteBarIcon = function WriteBarIcon(_ref) {
  ...
  switch (mode) {
    case "attach":
      icon = platform === Platform.IOS ? /*#__PURE__*/React.createElement(Icon28AddCircleOutline, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(Icon28AttachOutline, {
        "aria-hidden": true
      });
      ariaLabel = "Прикрепить файл";
      break;
    case "send":
      icon = platform === Platform.IOS ? /*#__PURE__*/React.createElement(Icon48WritebarSend, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(Icon24Send, {
        "aria-hidden": true
      });
      ariaLabel = "Отправить";
      break;
    case "done":
      icon = platform === Platform.IOS ? /*#__PURE__*/React.createElement(Icon48WritebarDone, {
        "aria-hidden": true
      }) : /*#__PURE__*/React.createElement(Icon28CheckCircleOutline, {
        "aria-hidden": true
      });
      ariaLabel = "Готово";
      break;
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({
    ...
    className: classNamesString("vkuiWriteBarIcon", platform === Platform.IOS && "vkuiWriteBarIcon--ios", mode && styles["WriteBarIcon--mode-".concat(mode)], className)
