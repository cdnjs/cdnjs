...
export var BaseGallery = function BaseGallery(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    className: classNamesString("vkuiBaseGallery", styles["BaseGallery--align-".concat(align)], shiftState.dragging && "vkuiBaseGallery--dragging", slideWidth === "custom" && "vkuiBaseGallery--custom-width", className),
    ref: rootRef
    ...
    "aria-hidden": "true",
    className: classNamesString("vkuiBaseGallery__bullets", styles["BaseGallery__bullets--".concat(bullets)])
  }, React.Children.map(children, function (_item, index) {
    return /*#__PURE__*/React.createElement("div", {
      className: classNamesString("vkuiBaseGallery__bullet", index === slideIndex && "vkuiBaseGallery__bullet--active"),
      key: index
    });
  })), showArrows && hasMouse && canSlideLeft && /*#__PURE__*/React.createElement(HorizontalScrollArrow, {
    direction: "left",
    onClick: slideLeft
  }), showArrows && hasMouse && canSlideRight && /*#__PURE__*/React.createElement(HorizontalScrollArrow, {
    direction: "right",
    onClick: slideRight
  }));
};
