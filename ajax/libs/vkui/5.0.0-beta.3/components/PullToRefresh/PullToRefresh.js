...
export var PullToRefresh = function PullToRefresh(_ref) {
  ...
  return /*#__PURE__*/React.createElement(TouchRootContext.Provider, {
    ...
    onMove: onTouchMove,
    onEnd: onTouchEnd,
    className: classNamesString("vkuiPullToRefresh", platform === Platform.IOS && "vkuiPullToRefresh--ios", watching && "vkuiPullToRefresh--watching", refreshing && "vkuiPullToRefresh--refreshing", className)
