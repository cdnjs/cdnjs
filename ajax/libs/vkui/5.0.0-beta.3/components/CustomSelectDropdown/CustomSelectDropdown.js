...
export var CustomSelectDropdown = function CustomSelectDropdown(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Popper, _extends({
    ...
    placement: placement,
    className: classNamesString("vkuiCustomSelectDropdown", offsetDistance === 0 && (isTop ? "vkuiCustomSelectDropdown--top" : "vkuiCustomSelectDropdown--bottom"), sameWidth && "vkuiCustomSelectDropdown--wide", className),
