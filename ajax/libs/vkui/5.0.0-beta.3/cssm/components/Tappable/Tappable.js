...
export var Tappable = function Tappable(_ref) {
  ...
  var classes = classNamesString(className, "vkuiTappable", platform === Platform.IOS && "vkuiTappable--ios", getSizeXClassName("vkuiTappable", sizeX), getHoverClassName("vkuiTappable", deviceHasHover), hasActive && "vkuiTappable--hasActive", hasHover && hovered && !isPresetHoverMode && hoverMode, hasActive && active && !isPresetActiveMode && activeMode, focusVisible && !isPresetFocusVisibleMode && focusVisibleMode, hasActive && active && "vkuiTappable--active", hasMouse && "vkuiTappable--mouse", hasHover && hovered && isPresetHoverMode && styles["Tappable--hover-".concat(hoverMode)], hasActive && active && isPresetActiveMode && styles["Tappable--active-".concat(activeMode)], focusVisible && "vkuiTappable--focus-visible");
  var handlers = {
  ...
  })), hasHover && hoverMode === "background" && /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    className: "vkuiTappable__hoverShadow"
