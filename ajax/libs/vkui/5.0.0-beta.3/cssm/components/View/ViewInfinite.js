...
var ViewInfiniteComponent = /*#__PURE__*/function (_React$Component) {
  ...
  function ViewInfiniteComponent(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onMoveX", function (e) {
      ...
      if (platform === Platform.IOS && !(configProvider !== null && configProvider !== void 0 && configProvider.isWebView) && (e.startX <= 70 || e.startX >= _this.window.innerWidth - 70) && !_this.state.browserSwipe) {
        _this.setState({
          browserSwipe: true
        });
      }
      if (platform === Platform.IOS && configProvider !== null && configProvider !== void 0 && configProvider.isWebView && _this.props.onSwipeBack) {
  ...
  _createClass(ViewInfiniteComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Touch, _extends({
        ...
        className: classNamesString("vkuiView", getPlatformClassName("vkuiView", platform), !disableAnimation && this.state.animated && "vkuiView--animated", !disableAnimation && this.state.swipingBack && "vkuiView--swiping-back", disableAnimation && "vkuiView--no-motion", className),
