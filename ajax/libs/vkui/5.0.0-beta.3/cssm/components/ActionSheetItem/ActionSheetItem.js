...
import "./ActionSheetItem.module.css";
var defaultIconChecked = /*#__PURE__*/React.createElement(SizeYConditionalRender, {
  compact: /*#__PURE__*/React.createElement(Icon20CheckCircleOn, {
    "aria-hidden": true
  }),
  regular: /*#__PURE__*/React.createElement(Icon24CheckCircleOn, {
    "aria-hidden": true
  })
});
/**
...
var ActionSheetItem = function ActionSheetItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tappable, _extends({}, restProps, {
    ...
    className: classNamesString("vkuiActionSheetItem", platform === Platform.IOS && "vkuiActionSheetItem--ios", styles["ActionSheetItem--mode-".concat(mode)], getSizeYClassName("vkuiActionSheetItem", sizeY), isRich && "vkuiActionSheetItem--rich", isDesktop && "vkuiActionSheetItem--desktop", className),
    Component: Component
  }), before && /*#__PURE__*/React.createElement("div", {
    className: "vkuiActionSheetItem__before"
  }, before), /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiActionSheetItem__container", !multiline && "vkuiActionSheetItem--ellipsis")
  }, /*#__PURE__*/React.createElement("div", {
    className: classNamesString("vkuiActionSheetItem__content", isCentered && "vkuiActionSheetItem--centered")
