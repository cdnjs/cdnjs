...
export var Banner = function Banner(_ref) {
  ...
  return /*#__PURE__*/React.createElement("section", _extends({}, restProps, {
    className: classNamesString("vkuiBanner", platform === Platform.IOS && "vkuiBanner--ios", styles["Banner--mode-".concat(mode)], styles["Banner--size-".concat(size)], mode === "image" && imageTheme === "dark" && "vkuiBanner--inverted", className)
