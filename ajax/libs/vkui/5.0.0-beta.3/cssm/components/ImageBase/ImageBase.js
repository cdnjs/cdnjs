...
export var ImageBase = function ImageBase(_ref) {
  ...
  var badgeComponent = size >= 24 && badgeProp ? /*#__PURE__*/React.createElement(ImageBaseBadge, _extends({}, badgeProp, {
    imageSize: size
  })) : null;
  var overlayComponent = overlayProp ? /*#__PURE__*/React.createElement(ImageBaseOverlay, _extends({}, typeof overlayProp === "boolean" ? undefined : overlayProp, {
    imageSize: size,
    onClick: onClick
  })) : null;
  ...
  return /*#__PURE__*/React.createElement("div", _extends({}, restProps, {
    ...
    className: classNamesString(className, "vkuiImageBase", styles["ImageBase--size-".concat(size)], withBorder && "vkuiImageBase--withBorder", loaded && "vkuiImageBase--loaded"),
