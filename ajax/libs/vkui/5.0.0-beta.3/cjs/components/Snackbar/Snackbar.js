...
var _excluded = ["children", "layout", "action", "before", "after", "duration", "onActionClick", "onClose", "mode", "className"];
/**
...
var Snackbar = function Snackbar(_ref) {
  ...
  var layout = after || isDesktop ? "vertical" : layoutProps;
  return /*#__PURE__*/React.createElement(_AppRootPortal.AppRootPortal, null, /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiSnackbar", platform === _platform.Platform.IOS && "vkuiSnackbar--ios", styles["Snackbar--layout-".concat(layout)], styles["Snackbar--mode-".concat(mode)], closing && "vkuiSnackbar--closing", touched && "vkuiSnackbar--touched", isDesktop && "vkuiSnackbar--desktop", className)
  ...
  }, children), action && /*#__PURE__*/React.createElement(_Button.Button, {
    align: "left",
    hasHover: false,
    mode: "tertiary",
