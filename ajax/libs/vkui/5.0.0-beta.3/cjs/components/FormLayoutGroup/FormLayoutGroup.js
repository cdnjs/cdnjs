...
var FormLayoutGroup = function FormLayoutGroup(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
    ref: rootEl,
    className: (0, _classNames.classNamesString)("vkuiFormLayoutGroup", (0, _getSizeYClassName.getSizeYClassName)("vkuiFormLayoutGroup", sizeY), styles["FormLayoutGroup--mode-".concat(mode)], isRemovable && "vkuiFormLayoutGroup--removable", isSegmented && "vkuiFormLayoutGroup--segmented", className)
