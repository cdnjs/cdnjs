...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Tappable.Tappable, (0, _extends2.default)({
    hoverMode: hasNewTokens ? "vkuiButton--hover" : "background",
    activeMode: hasNewTokens ? "vkuiButton--active" : "opacity"
  }, restProps, {
    Component: restProps.href ? "a" : Component,
    onClick: loading ? undefined : onClick,
    focusVisibleMode: "outside",
    stopPropagation: stopPropagation,
    className: (0, _classNames.classNamesString)(className, "vkuiButton", styles["Button--size-".concat(size)], styles["Button--mode-".concat(mode)], styles["Button--appearance-".concat(appearance)], styles["Button--align-".concat(align)], (0, _getSizeYClassName.getSizeYClassName)("vkuiButton", sizeY), platform === _platform.Platform.ANDROID && "vkuiButton--android", platform === _platform.Platform.IOS && "vkuiButton--ios", stretched && "vkuiButton--stretched", hasIcons && "vkuiButton--with-icon", hasIconOnly && "vkuiButton--singleIcon", loading && "vkuiButton--loading"),
    ...
    role: "presentation"
  }, before), children && /*#__PURE__*/React.createElement("span", {
