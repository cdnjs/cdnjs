  ...
  (0, _createClass2.default)(ModalRootDesktopComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(_ModalRootContext.ModalRootContext.Provider, {
        ...
        className: (0, _classNames.classNamesString)("vkuiModalRoot", ((_this$props$configPro = this.props.configProvider) === null || _this$props$configPro === void 0 ? void 0 : _this$props$configPro.webviewType) === _ConfigProviderContext.WebviewType.VKAPPS && "vkuiModalRoot--vkapps", "vkuiModalRoot--desktop")
      }, /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement(_FocusTrap.FocusTrap, {
          ...
          key: key,
          className: (0, _classNames.classNamesString)("vkuiModalRoot__modal", !exitingModal && !enteringModal && modalId === activeModal && "vkuiModalRoot__modal--active", modalId === exitingModal && "vkuiModalRoot__modal--prev", Boolean(exitingModal) && modalId === activeModal && "vkuiModalRoot__modal--next")
        }, Modal);
      }))));
    }
  }]);
