...
var SelectTypography = function SelectTypography(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiSelectTypography", (0, _getPlatformClassName.getPlatformClassName)("vkuiSelectTypography", platform), (0, _getSizeYClassName.getSizeYClassName)("vkuiSelectTypography", sizeY), styles["SelectTypography--selectType-".concat(selectType)], className)
  }, restProps), children);
};
...
var Select = function Select(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, (hasMouse === undefined || hasMouse === true) && /*#__PURE__*/React.createElement(_CustomSelect.CustomSelect, (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiSelect__custom", (0, _getMouseClassName.getMouseClassName)("vkuiSelect__custom", hasMouse), className),
    options: options,
    popupDirection: popupDirection,
    renderOption: renderOption
  }, props)), (hasMouse === undefined || hasMouse === false) && /*#__PURE__*/React.createElement(_NativeSelect.NativeSelect, (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiSelect__native", (0, _getMouseClassName.getMouseClassName)("vkuiSelect__native", hasMouse), className)
