...
var HorizontalScroll = function HorizontalScroll(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiHorizontalScroll", showArrows === "always" && "vkuiHorizontalScroll--withConstArrows", className)
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollLeft && /*#__PURE__*/React.createElement(_HorizontalScrollArrow.HorizontalScrollArrow, {
    size: arrowSize,
    direction: "left",
    className: "vkuiHorizontalScroll__arrowLeft",
    onClick: scrollToLeft
  }), showArrows && (hasMouse || hasMouse === undefined) && canScrollRight && /*#__PURE__*/React.createElement(_HorizontalScrollArrow.HorizontalScrollArrow, {
    size: arrowSize,
    direction: "right",
