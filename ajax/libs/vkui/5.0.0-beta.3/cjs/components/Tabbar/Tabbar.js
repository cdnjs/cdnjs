...
var Tabbar = function Tabbar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({
    className: (0, _classNames.classNamesString)("vkuiTabbar", platform === _platform.Platform.IOS && "vkuiTabbar--ios", getItemsLayoutClassName(mode, children), shadow && "vkuiTabbar--shadow", className)
