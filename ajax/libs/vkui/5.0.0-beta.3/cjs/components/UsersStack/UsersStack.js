...
var UsersStack = function UsersStack(_ref2) {
  ...
  var othersElement = canShowOthers ? /*#__PURE__*/React.createElement(CounterTypography, {
    caps: true,
    weight: "1",
    className: (0, _classNames.classNamesString)("vkuiUsersStack__photo", "vkuiUsersStack__photo--others"),
    "aria-hidden": true
  }, /*#__PURE__*/React.createElement("span", null, "+", count)) : null;
  return /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, restProps, {
    className: (0, _classNames.classNamesString)("vkuiUsersStack", styles["UsersStack--size-".concat(size)], styles["UsersStack--layout-".concat(layout)], canShowOthers && "vkuiUsersStack--others", className)
  }), (photosElements.length > 0 || othersElement) && /*#__PURE__*/React.createElement("div", {
    className: "vkuiUsersStack__photos",
    role: "presentation"
  }, photosElements, othersElement), (0, _utils.hasReactNode)(children) && /*#__PURE__*/React.createElement(_Footnote.Footnote, {
