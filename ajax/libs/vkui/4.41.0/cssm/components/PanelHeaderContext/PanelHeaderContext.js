...
export var PanelHeaderContext = function PanelHeaderContext(_ref) {
  ...
  return createScopedElement(FixedLayout, _extends({}, restProps, {
    vkuiClass: classNames("PanelHeaderContext", platform === IOS && "PanelHeaderContext--ios", opened && "PanelHeaderContext--opened", closing && "PanelHeaderContext--closing", isDesktop && "PanelHeaderContext--desktop",
