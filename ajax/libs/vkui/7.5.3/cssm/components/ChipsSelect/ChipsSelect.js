...
chipsListLabel, ...restProps })=>{
    ...
    const openedClassNames = React.useMemo(()=>opened && dropdownOffsetDistance === 0 && (dropdownVerticalPlacement.includes('top') ? styles.popUp : styles.popDown) || undefined, [
        ...
        children: [
            /*#__PURE__*/ _jsx(ChipsInputBase, {
                ...
                after: dropdownIconProp || /*#__PURE__*/ _jsx(DropdownIcon, {
                    ...
                    className: classNames(styles.dropdownIcon, clearButtonShown && styles.dropdownIconWithOffset)
                }),
                // option
                value: value,
