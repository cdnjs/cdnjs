...
const ContentCard = (_param)=>{
    ...
    getRef, maxHeight, src, srcSet, alt = '', width, height, crossOrigin, decoding, loading, referrerPolicy, sizes, useMap, fetchPriority, hasHover = false, hasActive = false } = _param, restProps = _object_without_properties._(_param, [
        "subtitle",
        "header",
        "headerComponent",
        "text",
