...
const FormItem = (_param)=>{
    var { children, top, topMultiline, topComponent: topComponentProp, bottom, status = 'default', removable, onRemove = _vkjs.noop, removePlaceholder = 'Удалить', getRootRef, htmlFor, bottomId, noPadding, topNode, required = false } = _param, restProps = _object_without_properties._(_param, [
        "children",
        "top",
        "topMultiline",
        "topComponent",
