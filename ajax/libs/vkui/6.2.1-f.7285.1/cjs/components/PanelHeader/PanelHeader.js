...
const PanelHeaderIn = ({ before, after, children, typographyProps = {} })=>{
    ...
    const typographyNode = platform === 'vkcom' ? /*#__PURE__*/ (0, _jsxruntime.jsx)(_Text.Text, _object_spread_props._(_object_spread._({
        weight: "2",
        Component: Component
    }, restProps), {
        children: children
    })) : /*#__PURE__*/ (0, _jsxruntime.jsx)(Component, _object_spread_props._(_object_spread._({
        className: "vkuiPanelHeader__content-in"
    }, restProps), {
        children: children
    }));
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_OnboardingTooltipContainer.OnboardingTooltipContainer, {
        fixed: true,
...
const PanelHeader = (_param)=>{
    ...
    return /*#__PURE__*/ (0, _jsxruntime.jsxs)(_RootComponent.RootComponent, _object_spread_props._(_object_spread._({}, restProps), {
        ...
        children: [
            isFixed ? /*#__PURE__*/ (0, _jsxruntime.jsx)(_FixedLayout.FixedLayout, {
                className: (0, _vkjs.classNames)("vkuiPanelHeader__fixed", 'vkuiInternalPanelHeader__fixed'),
                vertical: "top",
                getRootRef: getRef,
                children: /*#__PURE__*/ (0, _jsxruntime.jsx)(PanelHeaderIn, {
                    before: before,
                    after: after,
                    typographyProps: typographyProps,
                    children: children
                })
            }) : /*#__PURE__*/ (0, _jsxruntime.jsx)(PanelHeaderIn, {
                before: before,
                after: after,
                typographyProps: typographyProps,
                children: children
            }),
            !isVKCOM && /*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
                children: [
                    staticSeparatorVisible && adaptiveSizeX.compact && /*#__PURE__*/ (0, _jsxruntime.jsx)(_Separator.Separator, {
                        className: adaptiveSizeX.compact.className
                    }),
                    staticSpacingVisible && adaptiveSizeX.regular && /*#__PURE__*/ (0, _jsxruntime.jsx)(_Spacing.Spacing, {
                        className: adaptiveSizeX.regular.className,
                        size: 16
                    })
                ]
            }),
            separatorVisible && isVKCOM && /*#__PURE__*/ (0, _jsxruntime.jsx)(_Separator.Separator, {
