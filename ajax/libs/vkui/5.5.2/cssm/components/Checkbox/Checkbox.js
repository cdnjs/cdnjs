 ...
 */ export const Checkbox = ({ children , className , style , getRootRef , getRef , description , indeterminate , defaultIndeterminate , hoverMode , activeMode , hasHover , hasActive , focusVisibleMode , onChange , titleAfter , ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement(Tappable, {
        Component: "label",
        className: classNames(styles['Checkbox'], platform === Platform.VKCOM && styles['Checkbox--vkcom'], sizeYClassNames[sizeY], !(hasReactNode(children) || hasReactNode(description)) && styles['Checkbox--simple'], className),
        style: style,
