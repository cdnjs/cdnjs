 ...
 */ export var CardScroll = function(_param) {
    ...
    var children = _param.children, _param_size = _param.size, size = _param_size === void 0 ? "s" : _param_size, _param_showArrows = _param.showArrows, showArrows = _param_showArrows === void 0 ? true : _param_showArrows, _param_withSpaces = _param.withSpaces, withSpaces = _param_withSpaces === void 0 ? true : _param_withSpaces, className = _param.className, restProps = _object_without_properties(_param, [
        "children",
        "size",
        "showArrows",
        "withSpaces",
    ...
    return /*#__PURE__*/ React.createElement("div", _object_spread_props(_object_spread({}, restProps), {
        className: classNames("vkuiCardScroll", "vkuiInternalCardScroll", size !== false && ({
