...
export var Search = function Search(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames("vkuiSearch", platform === Platform.IOS && "vkuiSearch--ios", sizeY !== SizeType.COMPACT && sizeYClassNames[sizeY], isFocused && "vkuiSearch--focused", value && "vkuiSearch--has-value", after && "vkuiSearch--has-after", icon && "vkuiSearch--has-icon", className),
    style: style
