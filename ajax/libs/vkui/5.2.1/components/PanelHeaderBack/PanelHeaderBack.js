...
export var PanelHeaderBack = function PanelHeaderBack(_ref) {
  ...
  return /*#__PURE__*/React.createElement(PanelHeaderButton, _extends({}, restProps, {
    className: classNames("vkuiPanelHeaderBack", sizeX === SizeType.COMPACT && "vkuiPanelHeaderBack--sizeX-compact", platform === Platform.IOS && "vkuiPanelHeaderBack--ios", platform === Platform.VKCOM && "vkuiPanelHeaderBack--vkcom", showLabel && !!label && "vkuiPanelHeaderBack--has-label", className),
