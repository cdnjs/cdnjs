...
var AccordionSummary = function(_param) {
    ...
    }), /*#__PURE__*/ _react.default.createElement(CollapseIcon, {
        className: (0, _vkjs.classNames)("vkuiAccordionSummary__icon", "vkuiAccordionSummary__icon--collapse")
    }));
    return /*#__PURE__*/ _react.default.createElement(_SimpleCell.SimpleCell, _object_spread._({
        className: (0, _vkjs.classNames)("vkuiAccordionSummary", className),
        Component: "summary",
        before: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, iconPosition === "before" && accordionIcon, before),
        after: /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, after, iconPosition === "after" && accordionIcon)
    }, restProps), children);
};
