...
var Header = function(_param) {
    var _param_mode = _param.mode, mode = _param_mode === void 0 ? "primary" : _param_mode, _param_size = _param.size, size = _param_size === void 0 ? "regular" : _param_size, children = _param.children, subtitle = _param.subtitle, indicator = _param.indicator, aside = _param.aside, getRootRef = _param.getRootRef, multiline = _param.multiline, className = _param.className, restProps = _object_without_properties._(_param, [
        "mode",
        "size",
        "children",
        "subtitle",
    ...
    var platform = (0, _usePlatform.usePlatform)();
    return /*#__PURE__*/ _react.createElement("header", _object_spread_props._(_object_spread._({}, restProps), {
        ref: getRootRef,
        className: (0, _vkjs.classNames)("vkuiHeader", platform === _platform.Platform.IOS && "vkuiHeader--ios", {
