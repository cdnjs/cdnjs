...
var ScrollArrow = function(_param) {
    var _param_size = _param.size, size = _param_size === void 0 ? "l" : _param_size, offsetY = _param.offsetY, direction = _param.direction, className = _param.className, getRootRef = _param.getRootRef, _param_children = _param.children, children = _param_children === void 0 ? /*#__PURE__*/ _react.createElement(ArrowIcon, {
        direction: direction,
        size: size
    ...
    return /*#__PURE__*/ _react.createElement("button", _object_spread._({
        className: (0, _vkjs.classNames)("vkuiScrollArrow", {
