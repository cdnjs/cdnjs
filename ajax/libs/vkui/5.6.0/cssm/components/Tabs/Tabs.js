 ...
 */ export const Tabs = ({ children, mode = 'default', getRootRef, className, role = 'tablist', ...restProps })=>{
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...restProps,
        ref: getRootRef,
        className: classNames(styles['Tabs'], 'vkuiInternalTabs', platform === Platform.VKCOM && 'vkuiInternalTabs--vkcom', withGaps && classNames(styles['Tabs--withGaps'], 'vkuiInternalTabs--withGaps'), mode === 'default' && styles['Tabs--mode-default'], className),
        role: role
