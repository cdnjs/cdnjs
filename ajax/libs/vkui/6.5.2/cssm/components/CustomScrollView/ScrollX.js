...
export const ScrollX = ({ barHandlers, boxRef, autoHideScrollbar, autoHideScrollbarDelay })=>{
    ...
    return /*#__PURE__*/ _jsx("div", {
        className: styles['CustomScrollView__barX'],
        ref: barX,
        onClick: stopPropagation,
        children: /*#__PURE__*/ _jsx("div", {
            className: classNames(styles['CustomScrollView__trackerX'], !horizontalTrackerVisible && styles['CustomScrollView__trackerX--hidden']),
