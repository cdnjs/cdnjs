...
var ChipsSelect = function ChipsSelect(props) {
  ...
  var _useChipsSelect = useChipsSelect(props),
  ...
  return createScopedElement("div", {
    ...
    vkuiClass: classNames((_classNames = {}, _defineProperty(_classNames, 'ChipsSelect__open', opened), _defineProperty(_classNames, 'ChipsSelect__open--popupDirectionTop', popupDirection === 'top'), _classNames)),
    getRef: getRef,
    disabled: disabled,
    onInputChange: handleInputChange,
    after: createScopedElement(DropdownIcon, null)
  })), opened && createScopedElement("div", {
    vkuiClass: classNames('ChipsSelect__options', _defineProperty({}, 'ChipsSelect__options--popupDirectionTop', popupDirection === 'top')),
    ...
    size: "small"
  })) : createScopedElement(React.Fragment, null, showCreatable && createScopedElement(CustomSelectOption, {
