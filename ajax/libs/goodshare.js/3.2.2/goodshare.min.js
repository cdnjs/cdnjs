...
title:c.title},a);return"https://www.instapaper.com/edit?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},ra:function(a){a=b.extend({url:location.href},a);return"http://www.readability.com/save?url="+encodeURIComponent(a.url)},xi:function(a){a=b.extend({url:location.href},a);return"https://www.xing.com/spi/shares/new?url="+encodeURIComponent(a.url)},vi:function(a){a=b.extend({url:location.href,title:c.title},a);return"viber://forward?text="+encodeURIComponent(a.title+" "+a.url)},
popup:function(a){return e.open(a,"","toolbar=0,status=0,scrollbars=0,width=630,height=440")}};b.fn.getCount=function(){var a=function(a){return 999<a&&999999>=a?a/1E3+"k":999999<a?">1M":a},c=function(a){return 0<b(a).length};c('[data-counter="vk"]')&&(b.getJSON("https://vk.com/share.php?act=count&index=1&url="+encodeURIComponent(location.href)+"&callback=?",function(a){}),e.VK||(VK={}),VK.Share={count:function(c,d){b('[data-counter="vk"]').text(a(d))}});c('[data-counter="fb"]')&&b.getJSON("http://graph.facebook.com/?id="+
encodeURIComponent(location.href)+"&callback=?",function(c){c.shares===f?b('[data-counter="fb"]').text("0"):b('[data-counter="fb"]').text(a(c.shares))});c('[data-counter="ok"]')&&(b.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){}),e.ODKL||(ODKL={}),ODKL.updateCount=function(c,d){b('[data-counter="ok"]').text(a(d))});c('[data-counter="tw"]')&&b.getJSON("http://cdn.api.twitter.com/1/urls/count.json?url="+encodeURIComponent(location.href)+
"&callback=?",function(c){b('[data-counter="tw"]').text(a(c.count))});c('[data-counter="gp"]')&&b.ajax({type:"POST",url:"https://clients6.google.com/rpc",processData:!0,contentType:"application/json",data:JSON.stringify({method:"pos.plusones.get",id:location.href,params:{nolog:!0,id:location.href,source:"widget",userId:"@viewer",groupId:"@self"},jsonrpc:"2.0",key:"p",apiVersion:"v1"}),success:function(c){b('[data-counter="gp"]').text(a(c.result.metadata.globalCounts.count))}});c('[data-counter="mr"]')&&
b.getJSON("http://connect.mail.ru/share_count?url_list="+encodeURIComponent(location.href)+"&callback=1&func=?",function(c){var d=encodeURIComponent(location.href);for(d in c)if(c.hasOwnProperty(d)){var e=c[d].shares;break}b.isEmptyObject(c)?b('[data-counter="mr"]').text("0"):b('[data-counter="mr"]').text(a(e))});c('[data-counter="li"]')&&b.getJSON("http://www.linkedin.com/countserv/count/share?url="+encodeURIComponent(location.href)+"&callback=?",function(c){b('[data-counter="li"]').text(a(c.count))});
c('[data-counter="tm"]')&&b.getJSON("http://api.tumblr.com/v2/share/stats?url="+encodeURIComponent(location.href)+"&callback=?",function(c){b('[data-counter="tm"]').text(a(c.response.note_count))});c('[data-counter="pt"]')&&b.getJSON("http://api.pinterest.com/v1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",function(c){b('[data-counter="pt"]').text(a(c.count))});c('[data-counter="rd"]')&&b.getJSON("https://www.reddit.com/api/info.json?url="+encodeURIComponent(location.href)+
"&jsonp=?",function(c){c=c.data.children;0===c.length?b('[data-counter="rd"]').text("0"):b('[data-counter="rd"]').text(a(c[0].data.score))});c('[data-counter="su"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="http://www.stumbleupon.com/services/1.01/badge.getinfo?url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(c){c=b.parseJSON(c.query.results.html.body);c.result.views===f?b('[data-counter="su"]').text("0"):b('[data-counter="su"]').text(a(c.result.views))});
c('[data-counter="po"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://widgets.getpocket.com/v1/button?count=horizontal&url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(c){b('[data-counter="po"]').text(a(c.query.results.html.body.div.a.span.em.content))});c('[data-counter="bf"]')&&b.getJSON("https://api.bufferapp.com/1/links/shares.json?url="+encodeURIComponent(location.href)+"&callback=?",function(c){b('[data-counter="bf"]').text(a(c.shares))});
c('[data-counter="xi"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://www.xing-share.com/app/share?op=get_share_button;counter=top;url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(c){b('[data-counter="xi"]').text(a(c.query.results.html.body.div[0].div[0].span.content))})};b(c).on("click",".goodshare",function(a){a.preventDefault();goodshare.init(this)});b(c).getCount()})})(jQuery,window,document);
