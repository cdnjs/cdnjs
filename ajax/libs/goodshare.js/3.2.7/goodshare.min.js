...
xi:function(a){a=c.extend({url:location.href},a);return"https://www.xing.com/spi/shares/new?url="+encodeURIComponent(a.url)},wp:function(a){a=c.extend({url:location.href,title:b.title,text:d,image:f},a);return"https://wordpress.com/wp-admin/press-this.php?u="+encodeURIComponent(a.url)+"&t="+encodeURIComponent(a.title)+"&s="+encodeURIComponent(a.text)+"&i="+encodeURIComponent(a.image)+"&v=2"},rr:function(a){a=c.extend({url:location.href,title:b.title},a);return"http://share.renren.com/share/buttonshare.do?link="+
encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},wb:function(a){a=c.extend({url:location.href,title:b.title},a);return"http://service.weibo.com/share/share.php?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},tg:function(a){a=c.extend({url:location.href,title:b.title},a);return"tg://msg?text="+encodeURIComponent(a.title+" "+a.url)},vi:function(a){a=c.extend({url:location.href,title:b.title},a);return"viber://forward?text="+encodeURIComponent(a.title+" "+a.url)},
wa:function(a){a=c.extend({url:location.href,title:b.title},a);return"whatsapp://send?text="+encodeURIComponent(a.title+" "+a.url)},ln:function(a){a=c.extend({url:location.href,title:b.title},a);return"line://msg/text/"+encodeURIComponent(a.title+" "+a.url)},popup:function(a){return g.open(a,"","left="+(screen.width-630)/2+",top="+(screen.height-440)/2+",toolbar=0,status=0,scrollbars=0,menubar=0,location=0,width=630,height=440")}};c.fn.getCount=function(){var a=function(a){return 999<a&&999999>=a?
a/1E3+"k":999999<a?">1M":a},b=function(a){return 0<c(a).length};b('[data-counter="vk"]')&&(c.getJSON("https://vk.com/share.php?act=count&index=1&url="+encodeURIComponent(location.href)+"&callback=?",function(a){}),g.VK||(VK={}),VK.Share={count:function(b,e){c('[data-counter="vk"]').text(a(e))}});b('[data-counter="fb"]')&&c.getJSON("https://graph.facebook.com/?id="+encodeURIComponent(location.href)+"&callback=?",function(b){b.shares===h?c('[data-counter="fb"]').text("0"):c('[data-counter="fb"]').text(a(b.shares))});
b('[data-counter="ok"]')&&(c.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref="+encodeURIComponent(location.href)+"&callback=?",function(a){}),g.ODKL||(ODKL={}),ODKL.updateCount=function(b,e){c('[data-counter="ok"]').text(a(e))});b('[data-counter="gp"]')&&c.ajax({type:"POST",url:"https://clients6.google.com/rpc",processData:!0,contentType:"application/json",data:JSON.stringify({method:"pos.plusones.get",id:location.href,params:{nolog:!0,id:location.href,source:"widget",userId:"@viewer",
groupId:"@self"},jsonrpc:"2.0",key:"p",apiVersion:"v1"}),success:function(b){c('[data-counter="gp"]').text(a(b.result.metadata.globalCounts.count))}});b('[data-counter="mr"]')&&c.getJSON("https://connect.mail.ru/share_count?url_list="+encodeURIComponent(location.href)+"&callback=1&func=?",function(b){var e=encodeURIComponent(location.href);for(e in b)if(b.hasOwnProperty(e)){var d=b[e].shares;break}c.isEmptyObject(b)?c('[data-counter="mr"]').text("0"):c('[data-counter="mr"]').text(a(d))});b('[data-counter="li"]')&&
c.getJSON("https://www.linkedin.com/countserv/count/share?url="+encodeURIComponent(location.href)+"&callback=?",function(b){c('[data-counter="li"]').text(a(b.count))});b('[data-counter="tm"]')&&c.getJSON("https://api.tumblr.com/v2/share/stats?url="+encodeURIComponent(location.href)+"&callback=?",function(b){c('[data-counter="tm"]').text(a(b.response.note_count))});b('[data-counter="pt"]')&&c.getJSON("https://api.pinterest.com/v1/urls/count.json?url="+encodeURIComponent(location.href)+"&callback=?",
function(b){c('[data-counter="pt"]').text(a(b.count))});b('[data-counter="rd"]')&&c.getJSON("https://www.reddit.com/api/info.json?url="+encodeURIComponent(location.href)+"&jsonp=?",function(b){b=b.data.children;0===b.length?c('[data-counter="rd"]').text("0"):c('[data-counter="rd"]').text(a(b[0].data.score))});b('[data-counter="su"]')&&c.getJSON("https://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="http://www.stumbleupon.com/services/1.01/badge.getinfo?url='+
location.href+'" and xpath="*"')+"&format=json&callback=?",function(b){b=c.parseJSON(b.query.results.html.body);b.result.views===h?c('[data-counter="su"]').text("0"):c('[data-counter="su"]').text(a(b.result.views))});b('[data-counter="po"]')&&c.getJSON("https://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://widgets.getpocket.com/v1/button?count=horizontal&url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(b){c('[data-counter="po"]').text(a(b.query.results.html.body.div.a.span.em.content))});
b('[data-counter="bf"]')&&c.getJSON("https://api.bufferapp.com/1/links/shares.json?url="+encodeURIComponent(location.href)+"&callback=?",function(b){c('[data-counter="bf"]').text(a(b.shares))});b('[data-counter="xi"]')&&c.getJSON("https://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://www.xing-share.com/app/share?op=get_share_button;counter=top;url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(b){c('[data-counter="xi"]').text(a(b.query.results.html.body.div[0].div[0].span.content))})};
c(b).on("click",".goodshare",function(a){a.preventDefault();goodshare.init(this)});c(b).getCount()})})(jQuery,window,document);
