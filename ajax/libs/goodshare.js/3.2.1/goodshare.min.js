 ...
 */
!(function(b,e,c,g){b(c).ready(function(){goodshare={init:function(a,h){var f=goodshare,d=b.extend({type:"vk",url:location.href,title:c.title,text:b('meta[property="og:description"]').attr("content"),image:b('meta[property="og:image"]').attr("content")},b(a).data(),h);if(null!==f.popup(link=f[d.type](d)))return!1},vk:function(a){a=b.extend({url:location.href,title:c.title,text:b('meta[property="og:description"]').attr("content"),image:b('meta[property="og:image"]').attr("content")},a);return"http://vk.com/share.php?url="+
...
title:c.title},a);return"https://www.instapaper.com/edit?url="+encodeURIComponent(a.url)+"&title="+encodeURIComponent(a.title)},ra:function(a){a=b.extend({url:location.href},a);return"http://www.readability.com/save?url="+encodeURIComponent(a.url)},xi:function(a){a=b.extend({url:location.href},a);return"https://www.xing.com/spi/shares/new?url="+encodeURIComponent(a.url)},popup:function(a){return e.open(a,"","toolbar=0,status=0,scrollbars=0,width=630,height=440")}};b.fn.getCount=function(){var a=function(a){return 999<
a&&999999>=a?a/1E3+"k":999999<a?">1M":a},c=function(a){return 0<b(a).length};c('[data-counter="vk"]')&&(b.getJSON("https://vk.com/share.php?act=count&index=1&url="+encodeURIComponent(location.href)+"&callback=?",function(a){}),e.VK||(VK={}),VK.Share={count:function(f,c){b('[data-counter="vk"]').text(a(c))}});c('[data-counter="fb"]')&&b.getJSON("http://graph.facebook.com/?id="+encodeURIComponent(location.href)+"&callback=?",function(c){c.shares===g?b('[data-counter="fb"]').text("0"):b('[data-counter="fb"]').text(a(c.shares))});
...
encodeURIComponent('select * from html where url="http://www.stumbleupon.com/services/1.01/badge.getinfo?url='+location.href+'" and xpath="*"')+"&format=json&callback=?",function(c){c=b.parseJSON(c.query.results.html.body);c.result.views===g?b('[data-counter="su"]').text("0"):b('[data-counter="su"]').text(a(c.result.views))});c('[data-counter="po"]')&&b.getJSON("http://query.yahooapis.com/v1/public/yql?q="+encodeURIComponent('select * from html where url="https://widgets.getpocket.com/v1/button?count=horizontal&url='+
