...
encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="pt"]').text(d(a.count))});b.getJSON("https://api.bufferapp.com/1/links/shares.json?url="+encodeURIComponent(location.href)+"&callback=?",function(a){b('[data-counter="bf"]').text(d(a.shares))});b(c).on("click",".goodshare",function(a){a.preventDefault();goodshare.init(this)})})})(jQuery,window,document);
