...
var FFmpegWasmEngine = function (_ConvertEngine) {
  ...
  function FFmpegWasmEngine(player, options) {
    ...
    _this = _callSuper(this, FFmpegWasmEngine, [player, options]);
    _this.debug = false;
    _this.coreURL = '/node_modules/@ffmpeg/core-mt/dist/umd/ffmpeg-core.js';
    _this.convertWorkerURL = '/node_modules/@ffmpeg/core-mt/dist/umd/ffmpeg-core.worker.js';
    _this.audioWebAssemblyURL = '/node_modules/@ffmpeg/core-mt/dist/umd/ffmpeg-core.wasm';
  ...
  (0, _createClass2.default)(FFmpegWasmEngine, [{
    ...
    value: (function () {
      var _convert = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(data) {
        var _FFmpegUtil, fetchFile, _FFmpegWASM, FFmpeg, timestamp, tempInputName, tempOutputName, opts, output, result;
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _FFmpegUtil = FFmpegUtil, fetchFile = _FFmpegUtil.fetchFile;
              _FFmpegWASM = FFmpegWASM, FFmpeg = _FFmpegWASM.FFmpeg;
              if (!(this.ffmpeg === null)) {
                _context.next = 10;
                break;
              }
              ...
              if (this.debug) {
                this.ffmpeg.on('log', function (_ref) {
            ...
            case 25:
              console.log(opts);
              _context.next = 28;
              return this.ffmpeg.exec(opts);
            case 28:
              _context.next = 30;
              return this.ffmpeg.readFile(tempOutputName);
            case 30:
...
var _default = exports["default"] = FFmpegWasmEngine;
