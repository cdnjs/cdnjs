...
var ToastStyle = require('primevue/toast/style');
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    "aria-live": "assertive",
    "aria-atomic": "true"
  }, _ctx.ptm('message')), [$props.templates.container ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.container), {
    key: 0,
  ...
  }, _ctx.ptm('messageContent')), [!$props.templates.message ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 0
  }, [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.messageicon ? $props.templates.messageicon : $props.templates.icon ? $props.templates.icon : $options.iconComponent && $options.iconComponent.name ? $options.iconComponent : 'span'), vue.mergeProps({
    "class": _ctx.cx('messageIcon')
  }, _ctx.ptm('messageIcon')), null, 16, ["class"])), vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('messageText')
  }, _ctx.ptm('messageText')), [vue.createElementVNode("span", vue.mergeProps({
