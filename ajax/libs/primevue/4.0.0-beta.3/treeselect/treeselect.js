...
this.primevue.treeselect = (function (Chip, ChevronDownIcon, OverlayEventBus, Portal, Ripple, Tree, utils, BaseComponent, TreeSelectStyle, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return [_ctx.display === 'comma' ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          ...
          }, _ctx.ptm('chipItem')), [vue.createVNode(_component_Chip, {
        ...
        "aria-haspopup": "tree",
        "aria-expanded": $data.overlayVisible
      }, _ctx.ptm('dropdown')), [vue.renderSlot(_ctx.$slots, _ctx.$slots.dropdownicon ? 'dropdownicon' : 'triggericon', {
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              }, _ctx.ptm('treeContainer')), [vue.createVNode(_component_TSTree, {
                ref: "tree",
                id: $options.listId,
                value: _ctx.options,
...
})(primevue.chip, primevue.icons.chevrondown, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.tree, primevue.utils, primevue.basecomponent, primevue.treeselect.style, Vue);
