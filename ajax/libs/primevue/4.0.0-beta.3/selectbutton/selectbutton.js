        ...
        return vue.openBlock(), vue.createBlock(_component_ToggleButton, {
          ...
          fn: vue.withCtx(function () {
            return [vue.renderSlot(_ctx.$slots, "option", {
              ...
              return [vue.createElementVNode("span", vue.normalizeProps(vue.guardReactiveProps(_ctx.ptm('pcButton')['label'])), vue.toDisplayString($options.getOptionLabel(option)), 17)];
            })];
          }),
          key: "0"
