...
var _hoisted_1$1 = ["id", "aria-label", "aria-selected", "aria-expanded", "aria-level", "aria-setsize", "aria-posinset", "data-p-option-group", "data-p-highlight", "data-p-focus", "data-p-disabled"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
    ...
    "class": _ctx.cx('list')
  }, $props.level === 0 ? _ctx.ptm('list') : _ctx.ptm('optionList')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.options, function (processedOption, index) {
    return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
    ...
    }, $options.getPTOptions(processedOption, index, 'optionContent')), [$props.templates['option'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['option']), {
      key: 0,
    ...
    }, $options.getPTOptions(processedOption, index, 'optionText')), vue.toDisplayString($options.getOptionLabelToRender(processedOption)), 17)), $options.isOptionGroup(processedOption) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: 2
      ...
      key: 0,
      role: "group",
      "class": vue.normalizeClass(_ctx.cx('optionList')),
    ...
    "default": vue.withCtx(function () {
      return [vue.createVNode(vue.Transition, vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          ...
          }, _objectSpread(_objectSpread(_objectSpread({}, _ctx.panelProps), _ctx.overlayProps), _ctx.ptm('overlay'))), [vue.createElementVNode("div", vue.mergeProps({
            "class": _ctx.cx('listContainer')
          }, _ctx.ptm('listContainer')), [vue.createVNode(_component_CascadeSelectSub, {
            id: $data.id + '_tree',
            role: "tree",
