...
var script = {
  ...
  methods: {
    ...
    findNextOptionIndex: function findNextOptionIndex(index) {
      var links = DomHandler.find(this.container, 'li[data-pc-section="item"][data-p-disabled="false"]');
        ...
        "default": withCtx(function () {
          return [(_ctx.popup ? $data.overlayVisible : true) ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            return openBlock(), createElementBlock(Fragment, {
              ...
              role: "none"
            }, _ctx.ptm('submenuItem')), [renderSlot(_ctx.$slots, _ctx.$slots.submenuitem ? 'submenuitem' : 'submenuheader', {
              item: item
            }, function () {
