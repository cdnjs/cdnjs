      ...
      return [vue.createVNode(vue.Transition, vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          return [$data.overlayVisible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
            ...
            }, null, 8, ["field", "filterModel", "filterCallback", "applyFilter"])) : vue.createCommentVNode("", true), $options.showRemoveIcon ? (vue.openBlock(), vue.createElementBlock("div", vue.normalizeProps(vue.mergeProps({
              key: 2
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("th", vue.mergeProps({
    ...
    size: "small"
  }), null, 16, ["class", "value"])) : vue.createCommentVNode("", true), $options.columnProp('selectionMode') === 'multiple' && $props.filterDisplay !== 'row' ? (vue.openBlock(), vue.createBlock(_component_DTHeaderCheckbox, {
    key: 4,
