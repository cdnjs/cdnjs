...
this.primevue.inputchips = (function (Chip, utils, BaseComponent, InputChipsStyle, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      }, _ctx.ptm('input')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.modelValue, function (val, i) {
        ...
        role: "option"
      }, _ctx.ptm('inputItem')), [vue.createElementVNode("input", vue.mergeProps({
        ref: "input",
        id: _ctx.inputId,
        type: "text",
