...
this.primevue.select = (function (api, IconField, BlankIcon, CheckIcon, ChevronDownIcon, SearchIcon, SpinnerIcon, TimesIcon, InputIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, BaseComponent, SelectStyle, vue) {
    'use strict';
    ...
    var SelectStyle__default = /*#__PURE__*/_interopDefaultLegacy(SelectStyle);
    ...
    var script$1 = {
      ...
      style: SelectStyle__default["default"],
    ...
    var script = {
      ...
      methods: {
        ...
        onOverlayEnter: function onOverlayEnter(el) {
          ...
          this.alignOverlay();
          this.scrollInView();
          this.autoFilterFocus && utils.DomHandler.focus(this.$refs.filterInput.$el);
        },
    ...
    var _hoisted_4 = ["id"];
    var _hoisted_5 = ["id"];
    var _hoisted_6 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove", "data-p-highlight", "data-p-focused", "data-p-disabled"];
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, _ctx.ptm('label')), null, 16, _hoisted_2)) : (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        key: 1,
        ref: "focusInput",
        id: _ctx.labelId || _ctx.inputId,
        "class": [_ctx.cx('label'), _ctx.inputClass, _ctx.labelClass],
            ...
            "default": vue.withCtx(function () {
              return [$data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                "default": vue.withCtx(function () {
                  ...
                  }, null, 8, ["value", "onVnodeMounted", "onVnodeUpdated", "class", "placeholder", "invalid", "variant", "unstyled", "aria-owns", "aria-activedescendant", "onKeydown", "onBlur", "onInput", "pt"]), vue.createVNode(_component_InputIcon, vue.mergeProps({
                    unstyled: _ctx.unstyled
                ...
                content: vue.withCtx(function (_ref) {
                  ...
                  return [vue.createElementVNode("ul", vue.mergeProps({
                    ...
                    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                      ...
                      }, _ctx.ptm('optionGroupLabel')), vue.toDisplayString($options.getOptionGroupLabel(option.optionGroup)), 17)];
                    ...
                    }, $options.getPTItemOptions(option, getItemOptions, i, 'option')), [_ctx.checkmark ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                      key: 0
                      ...
                      }, _ctx.ptm('optionLabel')), vue.toDisplayString($options.getOptionLabel(option)), 17)];
...
})(primevue.api, primevue.iconfield, primevue.icons.blank, primevue.icons.check, primevue.icons.chevrondown, primevue.icons.search, primevue.icons.spinner, primevue.icons.times, primevue.inputicon, primevue.inputtext, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.utils, primevue.virtualscroller, primevue.basecomponent, primevue.select.style, Vue);
