...
this.primevue.dock = (function (BaseComponent, DockStyle, Ripple, Tooltip, utils, vue) {
    'use strict';
    ...
    var script$1 = {
      ...
      methods: {
        ...
        onEndKey: function onEndKey() {
          this.changeFocusedOptionIndex(utils.DomHandler.find(this.$refs.list, 'li[data-pc-section="item"][data-p-disabled="false"]').length - 1);
        },
        onSpaceKey: function onSpaceKey() {
          ...
          var anchorElement = element && utils.DomHandler.findSingle(element, '[data-pc-section="itemlink"]');
          anchorElement ? anchorElement.click() : element && element.click();
        },
        findNextOptionIndex: function findNextOptionIndex(index) {
          var menuitems = utils.DomHandler.find(this.$refs.list, 'li[data-pc-section="item"][data-p-disabled="false"]');
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      }, _ctx.ptm('listContainer')), [vue.createElementVNode("ul", vue.mergeProps({
        ref: "list",
        id: $data.id,
        "class": _ctx.cx('list'),
        role: "menu",
      ...
      }, _ctx.ptm('list')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.model, function (processedItem, index) {
        return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
        ...
        }, $options.getPTOptions('itemContent', processedItem, index)), [!$props.templates['item'] ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("a", vue.mergeProps({
          key: 0,
          ...
          tabindex: "-1",
          "aria-hidden": "true"
        }, $options.getPTOptions('itemLink', processedItem, index)), [!$props.templates['icon'] && !$props.templates['itemicon'] ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
          key: 0,
          "class": [_ctx.cx('itemIcon'), processedItem.icon]
        }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16)), [[_directive_ripple]]) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['icon'] || $props.templates['itemicon']), {
          key: 1,
          item: processedItem,
          "class": vue.normalizeClass(_ctx.cx('itemIcon'))
        }, null, 8, ["item", "class"]))], 16, _hoisted_3)), [[_directive_tooltip, {
          value: processedItem.label,
          disabled: !$props.tooltipOptions
        }, $props.tooltipOptions]]) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['item']), {
          key: 1,
          item: processedItem,
          index: index,
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        style: _ctx.style
      }, _ctx.ptmi('root')), [vue.createVNode(_component_DockSub, {
        model: _ctx.model,
...
})(primevue.basecomponent, primevue.dock.style, primevue.ripple, primevue.tooltip, primevue.utils, Vue);
