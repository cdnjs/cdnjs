...
this.primevue.datepicker = (function (Button, CalendarIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, InputText, OverlayEventBus, Portal, Ripple, utils, BaseComponent, DatePickerStyle, vue) {
    ...
    var script = {
      ...
      methods: {
          ...
          if (this.navigationState) {
            if (this.navigationState.button) {
              ...
              if (this.navigationState.backward) {
                var cells;
                if (this.currentView === 'month') {
                  cells = utils.DomHandler.find(this.overlay, '[data-pc-section="monthview"] [data-pc-section="month"]:not([data-p-disabled="true"])');
                } else if (this.currentView === 'year') {
                  cells = utils.DomHandler.find(this.overlay, '[data-pc-section="yearview"] [data-pc-section="year"]:not([data-p-disabled="true"])');
                } else {
                ...
                if (this.currentView === 'month') {
                  cell = utils.DomHandler.findSingle(this.overlay, '[data-pc-section="monthview"] [data-pc-section="month"]:not([data-p-disabled="true"])');
                } else if (this.currentView === 'year') {
                  cell = utils.DomHandler.findSingle(this.overlay, '[data-pc-section="yearview"] [data-pc-section="year"]:not([data-p-disabled="true"])');
                } else {
        ...
        initFocusableCell: function initFocusableCell() {
          var cell;
          if (this.currentView === 'month') {
            var cells = utils.DomHandler.find(this.overlay, '[data-pc-section="monthview"] [data-pc-section="month"]');
            var selectedCell = utils.DomHandler.findSingle(this.overlay, '[data-pc-section="monthview"] [data-pc-section="month"][data-p-highlight="true"]');
            cells.forEach(function (cell) {
              return cell.tabIndex = -1;
            });
            cell = selectedCell || cells[0];
          } else if (this.currentView === 'year') {
            var _cells2 = utils.DomHandler.find(this.overlay, '[data-pc-section="yearview"] [data-pc-section="year"]');
            var _selectedCell = utils.DomHandler.findSingle(this.overlay, '[data-pc-section="yearview"] [data-pc-section="year"][data-p-highlight="true"]');
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        ...
        id: _ctx.inputId,
        role: "combobox",
        "class": vue.normalizeClass([_ctx.inputClass, _ctx.cx('pcInput')]),
      ...
      }) : _ctx.showIcon && _ctx.iconDisplay === 'input' ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
        key: 2
      }, [_ctx.$slots.inputicon || _ctx.showIcon ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        key: 0,
        "class": _ctx.cx('inputIconContainer')
      }, _ctx.ptm('inputIconContainer')), [vue.renderSlot(_ctx.$slots, "inputicon", {
      ...
      })], 16)) : vue.createCommentVNode("", true)], 64)) : vue.createCommentVNode("", true), vue.createVNode(_component_Portal, {
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [_ctx.inline || $data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              }, _ctx.ptm('calendarContainer')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.months, function (month, groupIndex) {
                return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                }, _ctx.ptm('decade')), [vue.renderSlot(_ctx.$slots, "decade", {
                  ...
                  role: "grid"
                }, _ctx.ptm('dayView')), [vue.createElementVNode("thead", vue.normalizeProps(vue.guardReactiveProps(_ctx.ptm('tableHeader'))), [vue.createElementVNode("tr", vue.normalizeProps(vue.guardReactiveProps(_ctx.ptm('tableHeaderRow'))), [_ctx.showWeek ? (vue.openBlock(), vue.createElementBlock("th", vue.mergeProps({
                  key: 0,
                  scope: "col",
              ...
              }, _ctx.ptm('monthView')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.monthPickerValues, function (m, i) {
              ...
              }, _ctx.ptm('yearView')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.yearPickerValues, function (y) {
                return vue.withDirectives((vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
                  key: y.value,
                  onClick: function onClick($event) {
                ...
                _: 3
              }, 16, ["class", "aria-label", "unstyled", "onKeydown", "pt"])], 16), vue.createElementVNode("div", vue.mergeProps(_ctx.ptm('separatorContainer'), {
                "data-pc-group-section": "timepickerContainer"
