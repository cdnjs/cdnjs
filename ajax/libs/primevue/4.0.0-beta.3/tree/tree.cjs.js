...
var script$1 = {
  ...
  methods: {
    ...
    onClick: function onClick(event) {
      if (this.toggleClicked || utils.DomHandler.getAttribute(event.target, '[data-pc-section="nodetogglebutton"]') || utils.DomHandler.getAttribute(event.target.parentElement, '[data-pc-section="nodetogglebutton"]')) {
    ...
    onArrowLeft: function onArrowLeft(event) {
      var togglerElement = utils.DomHandler.findSingle(event.currentTarget, '[data-pc-section="nodetogglebutton"]');
    ...
    setAllNodesTabIndexes: function setAllNodesTabIndexes() {
      var nodes = utils.DomHandler.find(this.$refs.currentNode.closest('[data-pc-section="rootchildren"]'), '[role="treeitem"]');
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
  ...
  }, $props.level === 1 ? $options.getPTOptions('node') : _ctx.ptm('nodeChildren')), [vue.createElementVNode("div", vue.mergeProps({
    ...
    tabindex: "-1",
    "aria-hidden": "true"
  }, $options.getPTOptions('nodeToggleButton')), [$props.node.loading && $props.loadingMode === 'icon' ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 0
    ...
    "class": vue.normalizeClass(_ctx.cx('nodeToggleIcon'))
  ...
  }, $options.getPTOptions('nodeToggleIcon')), null, 16, ["class"])) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.node.collapsedIcon ? 'span' : 'ChevronRightIcon'), vue.mergeProps({
    key: 2,
    "class": _ctx.cx('nodeToggleIcon')
  }, $options.getPTOptions('nodeToggleIcon')), null, 16, ["class"]))], 64))], 16)), [[_directive_ripple]]), $options.checkboxMode ? (vue.openBlock(), vue.createBlock(_component_Checkbox, {
    key: 0,
    ...
    _: 1
  }, 8, ["modelValue", "indeterminate", "class", "unstyled", "pt", "data-p-partialchecked"])) : vue.createCommentVNode("", true), $props.templates['nodeicon'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['nodeicon']), vue.mergeProps({
    key: 1,
    node: $props.node,
    ...
    key: 1
  }, [vue.createTextVNode(vue.toDisplayString($options.label($props.node)), 1)], 64))], 16)], 16, _hoisted_2), $options.hasChildren && $options.expanded ? (vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
    key: 0,
    "class": _ctx.cx('nodeChildren'),
    role: "group"
  }, _ctx.ptm('nodeChildren')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.node.children, function (childNode) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
  ...
  })], 16)) : vue.createCommentVNode("", true), _ctx.filter ? (vue.openBlock(), vue.createBlock(_component_IconField, vue.mergeProps({
    key: 1,
    unstyled: _ctx.unstyled
  }, _ctx.ptm('pcFilterContainer')), {
    "default": vue.withCtx(function () {
      return [vue.createVNode(_component_InputText, vue.mergeProps({
      ...
      }, _ctx.ptm('pcFilterInput')), null, 16, ["modelValue", "class", "placeholder", "unstyled", "onKeydown"]), vue.createVNode(_component_InputIcon, vue.mergeProps({
        unstyled: _ctx.unstyled
      }, _ctx.ptm('pcFilterIconContainer')), {
        "default": vue.withCtx(function () {
          return [vue.renderSlot(_ctx.$slots, _ctx.$slots.filtericon ? 'filtericon' : 'searchicon', {
    ...
    _: 3
  }, 16, ["unstyled"])) : vue.createCommentVNode("", true), vue.createElementVNode("div", vue.mergeProps({
  ...
  }, _ctx.ptm('rootChildren')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.valueToRender, function (node, index) {
    return vue.openBlock(), vue.createBlock(_component_TreeNode, {
      key: node.key,
      node: node,
