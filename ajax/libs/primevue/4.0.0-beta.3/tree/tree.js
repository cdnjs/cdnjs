...
this.primevue.tree = (function (IconField, SearchIcon, SpinnerIcon, InputIcon, InputText, utils, BaseComponent, TreeStyle, Checkbox, CheckIcon, ChevronDownIcon, ChevronRightIcon, MinusIcon, Ripple, vue) {
    'use strict';
...
})(primevue.iconfield, primevue.icons.search, primevue.icons.spinner, primevue.inputicon, primevue.inputtext, primevue.utils, primevue.basecomponent, primevue.tree.style, primevue.checkbox, primevue.icons.check, primevue.icons.chevrondown, primevue.icons.chevronright, primevue.icons.minus, primevue.ripple, Vue);
