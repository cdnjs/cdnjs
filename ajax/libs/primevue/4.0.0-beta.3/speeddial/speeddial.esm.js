...
var script = {
  ...
  mounted: function mounted() {
    ...
    if (this.type !== 'linear') {
      var button = DomHandler.findSingle(this.container, '[data-pc-name="pcbutton"]');
      var firstItem = DomHandler.findSingle(this.list, '[data-pc-section="item"]');
      if (button && firstItem) {
  ...
  methods: {
    ...
    onEnterKey: function onEnterKey(event) {
      var _this = this;
      var items = DomHandler.find(this.container, '[data-pc-section="item"]');
    ...
    changeFocusedOptionIndex: function changeFocusedOptionIndex(index) {
      ...
      if (filteredItems[index]) {
        ...
        var buttonEl = DomHandler.findSingle(filteredItems[index], '[type="button"]');
        buttonEl && DomHandler.focus(buttonEl);
      }
    },
