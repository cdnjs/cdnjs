...
var script = {
  ...
  methods: {
    ...
    rootPTOptions: function rootPTOptions() {
      return vue.mergeProps(this.ptmi('root'), this.ptm('button'));
    },
    iconPTOptions: function iconPTOptions() {
      return vue.mergeProps(this.ptmi('root')['icon'], this.ptm('button')['icon']);
    }
  },
  computed: {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(vue.Transition, vue.mergeProps({
    ...
    "default": vue.withCtx(function () {
      return [$data.visible ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
        key: 0,
        ...
        _: 3
      }, 16, ["class", "onClick", "aria-label", "unstyled", "pt"])) : vue.createCommentVNode("", true)];
    }),
    _: 3
