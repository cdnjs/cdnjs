...
this.primevue.carousel = (function (Button, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, Ripple, utils, BaseComponent, CarouselStyle, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      }, _ctx.ptm('content')), [_ctx.showNavigators ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
        key: 0,
        ...
        _: 3
      }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : vue.createCommentVNode("", true), vue.createElementVNode("div", vue.mergeProps({
      ...
      }, _ctx.ptm('viewport')), [vue.createElementVNode("div", vue.mergeProps({
        ref: "itemsContainer",
      ...
      }, _ctx.ptm('itemList')), [$options.isCircular() ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
        key: 0
        ...
        }, _ctx.ptm('itemClone')), [vue.renderSlot(_ctx.$slots, "item", {
          data: item,
          index: index
        })], 16);
      }), 128)) : vue.createCommentVNode("", true)], 16)], 16), _ctx.showNavigators ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
        key: 1,
        ...
        _: 3
      }, 16, ["class", "disabled", "aria-label", "unstyled", "onClick", "pt"])) : vue.createCommentVNode("", true)], 16, _hoisted_1), $options.totalIndicators >= 0 && _ctx.showIndicators ? (vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
        key: 0,
      ...
      }, _ctx.ptm('indicatorList')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.totalIndicators, function (indicator, i) {
...
})(primevue.button, primevue.icons.chevrondown, primevue.icons.chevronleft, primevue.icons.chevronright, primevue.icons.chevronup, primevue.ripple, primevue.utils, primevue.basecomponent, primevue.carousel.style, Vue);
