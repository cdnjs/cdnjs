...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('preview')), null, 16, _hoisted_1)) : vue.createCommentVNode("", true), vue.createVNode(_component_Portal, {
    ...
    "default": vue.withCtx(function () {
      return [vue.createVNode(vue.Transition, vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          ...
          }, _ctx.ptm('colorSelector')), [vue.createElementVNode("div", vue.mergeProps({
            "class": _ctx.cx('colorBackground')
          }, _ctx.ptm('colorBackground')), [vue.createElementVNode("div", vue.mergeProps({
