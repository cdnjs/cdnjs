...
this.primevue.multiselect = (function (api, Checkbox, Chip, IconField, CheckIcon, ChevronDownIcon, SearchIcon, SpinnerIcon, TimesIcon, InputIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, BaseComponent, MultiSelectStyle, vue) {
    'use strict';
                ...
                content: vue.withCtx(function (_ref2) {
                  ...
                  return [vue.createElementVNode("ul", vue.mergeProps({
                    ...
                    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                      ...
                      return [vue.createElementVNode("span", vue.normalizeProps(vue.guardReactiveProps(_ctx.ptm('optionLabel'))), vue.toDisplayString($options.getOptionLabel(option)), 17)];
