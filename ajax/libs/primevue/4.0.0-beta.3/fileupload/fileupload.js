...
this.primevue.fileupload = (function (Button, PlusIcon, TimesIcon, UploadIcon, Message, ProgressBar, Ripple, utils, BaseComponent, FileUploadStyle, Badge, vue) {
    'use strict';
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.files, function (file, index) {
        return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
          ...
          "class": vue.normalizeClass(_ctx.cx('pcFileBadge')),
          ...
          rounded: "",
          severity: "danger",
          "class": vue.normalizeClass(_ctx.cx('pcFileRemoveButton')),
          unstyled: _ctx.unstyled,
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.isAdvanced ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return [vue.createVNode(_component_Button, vue.mergeProps({
          ...
          _: 3
        }, 16, ["label", "class", "style", "disabled", "unstyled", "onClick", "onKeydown", "onFocus", "onBlur", "pt"]), _ctx.showUploadButton ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
          key: 0,
          ...
          _: 3
        }, 16, ["class", "label", "onClick", "disabled", "unstyled", "pt"])) : vue.createCommentVNode("", true), _ctx.showCancelButton ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
          key: 1,
          ...
          _: 3
        }, 16, ["class", "label", "onClick", "disabled", "unstyled", "pt"])) : vue.createCommentVNode("", true)];
        ...
        return [$options.hasFiles ? (vue.openBlock(), vue.createBlock(_component_ProgressBar, {
          key: 0,
          value: $data.progress,
          showValue: false,
          unstyled: _ctx.unstyled,
        ...
        }), 128)), $options.hasFiles ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 1,
          ...
          unstyled: _ctx.unstyled,
          pt: _ctx.pt
        }, null, 8, ["files", "onRemove", "badgeValue", "previewWidth", "templates", "unstyled", "pt"])], 2)) : vue.createCommentVNode("", true), $options.hasUploadedFiles ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 2,
          "class": vue.normalizeClass(_ctx.cx('fileList'))
        }, [vue.createVNode(_component_FileContent, {
      ...
      }), _ctx.$slots.empty && !$options.hasFiles && !$options.hasUploadedFiles ? (vue.openBlock(), vue.createElementBlock("div", vue.normalizeProps(vue.mergeProps({
        key: 0
        ...
        _: 3
      }, 16, ["label", "class", "style", "disabled", "unstyled", "onMouseup", "onKeydown", "onFocus", "onBlur"]), !_ctx.auto ? vue.renderSlot(_ctx.$slots, "filelabel", {
        key: 0,
        "class": vue.normalizeClass(_ctx.cx('filelabel'))
      }, function () {
        return [vue.createElementVNode("span", {
          "class": vue.normalizeClass(_ctx.cx('filelabel')),
          files: $data.files
        }, vue.toDisplayString($options.basicFileChosenLabel), 11, _hoisted_2)];
      }) : vue.createCommentVNode("", true), !$options.hasFiles ? (vue.openBlock(), vue.createElementBlock("input", vue.mergeProps({
        key: 1,
        ref: "fileInput",
        type: "file",
        accept: _ctx.accept,
      ...
      }, _ctx.ptm('input')), null, 16, _hoisted_3)) : vue.createCommentVNode("", true)], 16)) : vue.createCommentVNode("", true);
    }
...
})(primevue.button, primevue.icons.plus, primevue.icons.times, primevue.icons.upload, primevue.message, primevue.progressbar, primevue.ripple, primevue.utils, primevue.basecomponent, primevue.fileupload.style, primevue.badge, Vue);
