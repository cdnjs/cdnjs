...
this.primevue.knob = (function (BaseComponent, KnobStyle, themes, vue) {
    'use strict';
      ...
      props: {
        ...
        valueColor: {
          ...
          "default": function _default() {
            return themes.$dt('knob.value.background').variable;
          }
        },
        rangeColor: {
          type: String,
          "default": function _default() {
            return themes.$dt('knob.range.background').variable;
          }
        },
        textColor: {
          type: String,
          "default": function _default() {
            return themes.$dt('knob.text.color').variable;
          }
        },
        strokeWidth: {
          type: Number,
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        fill: _ctx.textColor,
        "class": _ctx.cx('text')
      }, _ctx.ptm('text')), vue.toDisplayString($options.valueToDisplay), 17, _hoisted_4)) : vue.createCommentVNode("", true)], 16, _hoisted_1))], 16);
    }
...
})(primevue.basecomponent, primevue.knob.style, primevue.themes, Vue);
