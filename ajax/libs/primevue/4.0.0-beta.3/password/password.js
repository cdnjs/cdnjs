...
this.primevue.password = (function (EyeIcon, EyeSlashIcon, InputText, OverlayEventBus, Portal, utils, BaseComponent, PasswordStyle, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        "class": [_ctx.cx('ptInput'), _ctx.inputClass],
      ...
      }), null, 16, ["id", "type", "class", "style", "value", "aria-labelledby", "aria-label", "aria-controls", "aria-expanded", "placeholder", "required", "disabled", "variant", "invalid", "onInput", "onFocus", "onBlur", "onKeyup", "onInvalid", "pt", "unstyled"]), _ctx.toggleMask && $data.unmasked ? vue.renderSlot(_ctx.$slots, _ctx.$slots.maskicon ? 'maskicon' : 'hideicon', {
        key: 0,
        onClick: $options.onMaskToggle,
        toggleCallback: $options.onMaskToggle
      }, function () {
        return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.maskIcon || _ctx.hideIcon ? 'i' : 'EyeSlashIcon'), vue.mergeProps({
          "class": [_ctx.cx('maskIcon'), _ctx.maskIcon || _ctx.hideIcon],
          onClick: $options.onMaskToggle
        }, _ctx.ptm('maskIcon')), null, 16, ["class", "onClick"]))];
      }) : vue.createCommentVNode("", true), _ctx.toggleMask && !$data.unmasked ? vue.renderSlot(_ctx.$slots, _ctx.$slots.unmaskicon ? 'unmaskicon' : 'showicon', {
        key: 1,
        onClick: $options.onMaskToggle,
        toggleCallback: $options.onMaskToggle
      }, function () {
        return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.unmaskIcon || _ctx.showIcon ? 'i' : 'EyeIcon'), vue.mergeProps({
          "class": [_ctx.cx('unmaskIcon'), _ctx.unmaskIcon || _ctx.showIcon],
          onClick: $options.onMaskToggle
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              }, _objectSpread(_objectSpread(_objectSpread({}, _ctx.panelProps), _ctx.overlayProps), _ctx.ptm('overlay'))), [vue.renderSlot(_ctx.$slots, "header"), vue.renderSlot(_ctx.$slots, "content", {}, function () {
