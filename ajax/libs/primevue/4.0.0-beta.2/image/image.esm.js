...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread(_objectSpread({}, _ctx.previewButtonProps), _ctx.ptm('previewMask'))), [renderSlot(_ctx.$slots, "indicatoricon", {}, function () {
      ...
      return [$data.maskVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
        ...
        "default": withCtx(function () {
          return [$data.previewVisible ? (openBlock(), createElementBlock("div", normalizeProps(mergeProps({
            key: 0
          }, _ctx.ptm('originalContainer'))), [renderSlot(_ctx.$slots, "preview", {
