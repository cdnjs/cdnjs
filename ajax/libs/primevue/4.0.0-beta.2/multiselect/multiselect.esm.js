    ...
    return [_ctx.display === 'comma' ? (openBlock(), createElementBlock(Fragment, {
      ...
      return openBlock(), createElementBlock("span", mergeProps({
        ...
        return [createVNode(_component_Chip, {
          "class": normalizeClass(_ctx.cx('tokenLabel')),
    ...
    "default": withCtx(function () {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          ...
          }, _ctx.ptm('panel')), [createElementVNode("span", mergeProps({
          ...
          }, _ctx.ptm('filterContainer')), [createVNode(_component_InputText, {
            ref: "filterInput",
            value: $data.filterValue,
            onVnodeMounted: $options.onFilterUpdated,
            onVnodeUpdated: $options.onFilterUpdated,
            "class": normalizeClass(_ctx.cx('filterInput')),
          ...
          }, null, 8, ["value", "onVnodeMounted", "onVnodeUpdated", "class", "placeholder", "invalid", "disabled", "variant", "unstyled", "aria-owns", "aria-activedescendant", "onKeydown", "onBlur", "onInput", "pt"]), renderSlot(_ctx.$slots, "filtericon", {
