  ...
  methods: {
    ...
    _loadStyles: function _loadStyles() {
      ...
      var _load = function _load() {
        // @todo
        if (!Base__default["default"].isStyleNameLoaded('base')) {
          BaseStyle__default["default"].loadCSS(_this2.$styleOptions);
          _this2._loadGlobalStyles();
          Base__default["default"].setLoadedStyleName('base');
        }
    ...
    _loadCoreStyles: function _loadCoreStyles() {
      ...
      if (!Base__default["default"].isStyleNameLoaded((_this$$style = this.$style) === null || _this$$style === void 0 ? void 0 : _this$$style.name) && (_this$$style2 = this.$style) !== null && _this$$style2 !== void 0 && _this$$style2.name) {
        BaseComponentStyle.loadCSS(this.$styleOptions);
        this.$options.style && this.$style.loadCSS(this.$styleOptions);
        Base__default["default"].setLoadedStyleName(this.$style.name);
      }
    },
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      utils.ObjectUtils.isNotEmpty(globalCSS) && BaseStyle__default["default"].load(globalCSS, _objectSpread({
        name: 'global'
      }, this.$styleOptions));
    },
    _loadThemeStyles: function _loadThemeStyles() {
      ...
      if (!Theme__default["default"].isStyleNameLoaded('common')) {
        ...
        var _ref3 = ((_this$$style3 = this.$style) === null || _this$$style3 === void 0 || (_this$$style3$getComm = _this$$style3.getCommonThemeCSS) === null || _this$$style3$getComm === void 0 ? void 0 : _this$$style3$getComm.call(_this$$style3)) || {},
          primitive = _ref3.primitive,
          semantic = _ref3.semantic;
        BaseStyle__default["default"].load(primitive, _objectSpread({
          name: 'primitive-variables'
        }, this.$styleOptions));
        BaseStyle__default["default"].load(semantic, _objectSpread({
          name: 'semantic-variables'
        }, this.$styleOptions));
        BaseStyle__default["default"].loadTheme(_objectSpread({
          name: 'global-style'
        }, this.$styleOptions));
      ...
      // component
      if (!Theme__default["default"].isStyleNameLoaded((_this$$style4 = this.$style) === null || _this$$style4 === void 0 ? void 0 : _this$$style4.name) && (_this$$style5 = this.$style) !== null && _this$$style5 !== void 0 && _this$$style5.name) {
        var _this$$style6, _this$$style6$getComp, _this$$style7, _this$$style8;
        var _ref4 = ((_this$$style6 = this.$style) === null || _this$$style6 === void 0 || (_this$$style6$getComp = _this$$style6.getComponentThemeCSS) === null || _this$$style6$getComp === void 0 ? void 0 : _this$$style6$getComp.call(_this$$style6)) || {},
          variables = _ref4.variables;
        (_this$$style7 = this.$style) === null || _this$$style7 === void 0 || _this$$style7.load(variables, _objectSpread({
      ...
      if (!Theme__default["default"].isStyleNameLoaded('layer-order')) {
        ...
        BaseStyle__default["default"].load(layerOrder, _objectSpread({
          name: 'layer-order',
          first: true
        }, this.$styleOptions));
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
      ...
      var _ref5 = ((_this$$style10 = this.$style) === null || _this$$style10 === void 0 || (_this$$style10$getPre = _this$$style10.getPresetThemeCSS) === null || _this$$style10$getPre === void 0 ? void 0 : _this$$style10$getPre.call(_this$$style10, preset, "[".concat(this.$attrSelector, "]"))) || {},
        variables = _ref5.variables;
      var scopedStyle = (_this$$style11 = this.$style) === null || _this$$style11 === void 0 ? void 0 : _this$$style11.load(variables, _objectSpread({
    ...
    _themeChangeListener: function _themeChangeListener() {
      ...
      Base__default["default"].clearLoadedStyleNames();
      Theme.ThemeService.on('theme:change', callback);
    },
    ...
    _getPTValue: function _getPTValue() {
      ...
      var _ref6 = this._getPropValue('ptOptions') || ((_this$$config2 = this.$config) === null || _this$$config2 === void 0 ? void 0 : _this$$config2.ptOptions) || {},
    ...
    _getPT: function _getPT(pt) {
      ...
      var getValue = function getValue(value) {
        ...
        var _cKey = utils.ObjectUtils.toFlatCase(_this3.$name);
    ...
    _usePT: function _usePT(pt, callback, key, params) {
      ...
      if (pt !== null && pt !== void 0 && pt.hasOwnProperty('_usept')) {
        var _this$$config3;
        var _ref9 = pt['_usept'] || ((_this$$config3 = this.$config) === null || _this$$config3 === void 0 ? void 0 : _this$$config3.ptOptions) || {},
  ...
  computed: {
    ...
    defaultPT: function defaultPT() {
      ...
      return this._getPT((_this$$config5 = this.$config) === null || _this$$config5 === void 0 ? void 0 : _this$$config5.pt, undefined, function (value) {
        return _this5._getOptionValue(value, _this5.$name, _objectSpread({}, _this5.$params)) || utils.ObjectUtils.getItemValue(value, _objectSpread({}, _this5.$params));
      });
    },
