...
this.primevue.tree = (function (SearchIcon, SpinnerIcon, InputText, utils, BaseComponent, TreeStyle, Checkbox, CheckIcon, ChevronDownIcon, ChevronRightIcon, MinusIcon, Ripple, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, _ctx.ptm('filterContainer')), [vue.createVNode(_component_InputText, vue.mergeProps({
      ...
      }, _ctx.ptm('input')), null, 16, ["modelValue", "class", "placeholder", "onKeydown"]), vue.renderSlot(_ctx.$slots, "searchicon", {
...
})(primevue.icons.search, primevue.icons.spinner, primevue.inputtext, primevue.utils, primevue.basecomponent, primevue.tree.style, primevue.checkbox, primevue.icons.check, primevue.icons.chevrondown, primevue.icons.chevronright, primevue.icons.minus, primevue.ripple, Vue);
