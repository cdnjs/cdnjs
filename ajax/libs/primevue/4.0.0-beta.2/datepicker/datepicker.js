...
this.primevue.datepicker = (function (Button, CalendarIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, InputText, OverlayEventBus, Portal, Ripple, utils, BaseComponent, DatePickerStyle, vue) {
    'use strict';
...
})(primevue.button, primevue.icons.calendar, primevue.icons.chevrondown, primevue.icons.chevronleft, primevue.icons.chevronright, primevue.icons.chevronup, primevue.inputtext, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.utils, primevue.basecomponent, primevue.datepicker.style, Vue);
