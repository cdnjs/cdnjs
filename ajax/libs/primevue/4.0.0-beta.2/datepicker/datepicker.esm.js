...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, mergeProps, createBlock, normalizeClass, normalizeStyle, createCommentVNode, renderSlot, createElementVNode, resolveDynamicComponent, createVNode, withCtx, Transition, Fragment, renderList, withDirectives, vShow, toDisplayString, createTextVNode, normalizeProps, guardReactiveProps, withKeys } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    id: _ctx.inputId,
    role: "combobox",
    "class": normalizeClass([_ctx.inputClass, _ctx.cx('input')]),
    ...
    return [createElementVNode("button", mergeProps({
      ...
      "aria-expanded": $data.overlayVisible,
      "aria-controls": $options.panelId
    }, _ctx.ptm('dropdownButton')), [renderSlot(_ctx.$slots, "dropdownicon", {
  ...
  }) : _ctx.showIcon && _ctx.iconDisplay === 'input' ? (openBlock(), createElementBlock("span", {
    key: 2,
    "class": normalizeClass(_ctx.cx('inputIconContainer'))
  ...
  })], 2)) : createCommentVNode("", true), createVNode(_component_Portal, {
      ...
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          return [_ctx.inline || $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            "class": _ctx.cx('group')
          }, _ctx.ptm('group')), [(openBlock(true), createElementBlock(Fragment, null, renderList($options.months, function (month, groupIndex) {
            return openBlock(), createElementBlock("div", mergeProps({
              ...
              "class": _ctx.cx('grid'),
              role: "grid"
            }, _ctx.ptm('grid')), [createElementVNode("thead", normalizeProps(guardReactiveProps(_ctx.ptm('tableHeader'))), [createElementVNode("tr", normalizeProps(guardReactiveProps(_ctx.ptm('tableHeaderRow'))), [_ctx.showWeek ? (openBlock(), createElementBlock("th", mergeProps({
              key: 0,
              scope: "col",
            ...
            _: 3
          }, 16, ["class", "aria-label", "unstyled", "onKeydown", "pt"])], 16), createElementVNode("div", mergeProps({
