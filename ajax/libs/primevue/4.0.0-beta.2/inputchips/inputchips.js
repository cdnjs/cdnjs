...
this.primevue.inputchips = (function (Chip, utils, BaseComponent, InputChipsStyle, vue) {
    'use strict';
    ...
    var InputChipsStyle__default = /*#__PURE__*/_interopDefaultLegacy(InputChipsStyle);
    ...
    var script$1 = {
      ...
      style: InputChipsStyle__default["default"],
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_Chip = vue.resolveComponent("Chip");
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
          ...
          return [vue.createVNode(_component_Chip, {
            "class": vue.normalizeClass(_ctx.cx('label')),
            label: val,
            removeIcon: _ctx.removeTokenIcon,
            removable: "",
            ...
            removeicon: vue.withCtx(function () {
              return [vue.renderSlot(_ctx.$slots, "removetokenicon", {
...
})(primevue.chip, primevue.utils, primevue.basecomponent, primevue.inputchips.style, Vue);
