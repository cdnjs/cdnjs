...
this.primevue.autocomplete = (function (Chip, ChevronDownIcon, SpinnerIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, AutoCompleteStyle, BaseComponent, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
          ...
          return [vue.createVNode(_component_Chip, {
            "class": vue.normalizeClass(_ctx.cx('tokenLabel')),
      ...
      }, _ctx.ptm('input')), null, 16, _hoisted_3)], 16)], 16, _hoisted_1)) : vue.createCommentVNode("", true), $data.searching || _ctx.loading ? vue.renderSlot(_ctx.$slots, "loadingicon", {
        key: 2,
      ...
      }) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, "dropdownbutton", {
        ...
        return [_ctx.dropdown ? (vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
          ...
          ref: "dropdownButton",
          type: "button",
          "class": [_ctx.cx('dropdownButton'), _ctx.dropdownClass],
          disabled: _ctx.disabled,
          "aria-haspopup": "listbox",
          "aria-expanded": $data.overlayVisible,
          "aria-controls": $options.panelId,
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              }, _ctx.ptm('panel')), [vue.renderSlot(_ctx.$slots, "header", {
