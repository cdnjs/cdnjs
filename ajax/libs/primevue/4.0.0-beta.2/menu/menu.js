...
this.primevue.menu = (function (OverlayEventBus, Portal, utils, BaseComponent, MenuStyle, Ripple, vue) {
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.visible() ? (vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
      ...
      }, $options.getPTOptions('itemContent')), [!$props.templates.item ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("a", vue.mergeProps({
        key: 0,
        href: $props.item.url,
        ...
        tabindex: "-1",
        "aria-hidden": "true"
      }, $options.getPTOptions('itemLink')), [$props.templates.itemicon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.itemicon), {
        key: 0,
        item: $props.item,
      ...
      }, $options.getPTOptions('itemIcon')), null, 16)) : vue.createCommentVNode("", true), vue.createElementVNode("span", vue.mergeProps({
        "class": _ctx.cx('label')
    ...
    var script = {
      ...
      methods: {
        ...
        onEndKey: function onEndKey(event) {
          this.changeFocusedOptionIndex(utils.DomHandler.find(this.container, 'li[data-pc-section="item"][data-p-disabled="false"]').length - 1);
          event.preventDefault();
        },
        ...
        findNextOptionIndex: function findNextOptionIndex(index) {
          var links = utils.DomHandler.find(this.container, 'li[data-pc-section="item"][data-p-disabled="false"]');
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [(_ctx.popup ? $data.overlayVisible : true) ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              }, _ctx.ptm('list')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.model, function (item, i) {
                return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                  ...
                  key: 0,
                  id: $data.id + '_' + i,
                  "class": [_ctx.cx('submenuItem'), item["class"]],
                  role: "none"
                }, _ctx.ptm('submenuItem')), [vue.renderSlot(_ctx.$slots, _ctx.$slots.submenuheader ? 'submenuheader' : 'submenuitem', {
                  item: item
                }, function () {
                  ...
                  return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                    ...
                    pt: _ctx.pt
                  }, null, 8, ["id", "item", "templates", "focusedOptionId", "unstyled", "onItemClick", "onItemMousemove", "pt"])) : $options.visible(child) && child.separator ? (vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
                    key: 'separator' + i + j,
