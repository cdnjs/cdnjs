...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
    ...
    role: "presentation"
  }, _ctx.ptm('submenuItem')), vue.toDisplayString($options.getItemLabel($props.submenu)), 17)) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, function (processedItem, index) {
    ...
    }, $props.level === 0 ? $options.getPTOptions(processedItem, index, 'label') : $options.getPTOptions(processedItem, index, 'submenuItemLabel')), vue.toDisplayString($options.getItemLabel(processedItem)), 17), $options.isItemGroup(processedItem) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: 2
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    key: 0,
    "class": _ctx.cx('start')
  }, _ctx.ptm('start')), [vue.renderSlot(_ctx.$slots, "start")], 16)) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, _ctx.$slots.menubutton ? 'menubutton' : 'button', {
    id: $data.id,
    ...
    }, _ctx.ptm('button')), [vue.renderSlot(_ctx.$slots, _ctx.$slots.menubuttonicon ? 'menubuttonicon' : 'buttonicon', {}, function () {
