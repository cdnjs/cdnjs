...
this.primevue.dialog = (function (Button, FocusTrap, TimesIcon, WindowMaximizeIcon, WindowMinimizeIcon, Portal, Ripple, utils, vue, BaseComponent, DialogStyle) {
    'use strict';
          ...
          return [$data.containerVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [_ctx.visible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                icon: vue.withCtx(function (slotProps) {
                  return [vue.renderSlot(_ctx.$slots, "maximizeicon", {
                    ...
                    return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.maximizeIconComponent), vue.mergeProps({
                      "class": [_ctx.cx('maximizableIcon'), slotProps["class"], $data.maximized ? _ctx.minimizeIcon : _ctx.maximizeIcon]
                    }, _ctx.ptm('maximizableButton')['icon']), null, 16, ["class"]))];
                  })];
                }),
                _: 3
                ...
                icon: vue.withCtx(function (slotProps) {
                  return [vue.renderSlot(_ctx.$slots, "closeicon", {
                    ...
                    return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.closeIcon ? 'span' : 'TimesIcon'), vue.mergeProps({
                      "class": [_ctx.cx('closeButtonIcon'), _ctx.closeIcon, slotProps["class"]]
...
})(primevue.button, primevue.focustrap, primevue.icons.times, primevue.icons.windowmaximize, primevue.icons.windowminimize, primevue.portal, primevue.ripple, primevue.utils, Vue, primevue.basecomponent, primevue.dialog.style);
