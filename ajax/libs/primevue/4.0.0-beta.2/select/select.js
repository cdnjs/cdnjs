...
this.primevue.select = (function (api, BlankIcon, CheckIcon, ChevronDownIcon, SearchIcon, SpinnerIcon, TimesIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, BaseComponent, SelectStyle, vue) {
    'use strict';
