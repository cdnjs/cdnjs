...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !$props.empty ? (openBlock(), createElementBlock(Fragment, {
    ...
    type: "button"
  }, _ctx.ptm('rowToggleButton')), [$props.templates['rowgrouptogglericon'] ? (openBlock(), createBlock(resolveDynamicComponent($props.templates['rowgrouptogglericon']), {
    key: 0,
        ...
        "default": withCtx(function () {
          return [$data.overlayVisible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            return openBlock(), createElementBlock("div", mergeProps({
              ...
              "class": normalizeClass(_ctx.cx('filterConstraintDropdown')),
              optionLabel: "label",
              optionValue: "value",
            ...
            }, null, 8, ["field", "filterModel", "filterCallback", "applyFilter"])) : createCommentVNode("", true), createElementVNode("div", normalizeProps(guardReactiveProps($options.getColumnPT('filterRemove'))), [$options.showRemoveIcon ? (openBlock(), createBlock(_component_Button, mergeProps({
              key: 0,
              type: "button",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('overlay')), [_ctx.$slots.loading ? renderSlot(_ctx.$slots, "loading", {
    key: 0
