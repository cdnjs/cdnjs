...
this.primevue.datatable = (function (api, ArrowDownIcon, ArrowUpIcon, SpinnerIcon, Paginator, utils, VirtualScroller, BaseComponent, DataTableStyle, ChevronDownIcon, ChevronRightIcon, vue, Button, BarsIcon, CheckIcon, PencilIcon, TimesIcon, OverlayEventBus, Ripple, Checkbox, RadioButton, FocusTrap, FilterIcon, FilterSlashIcon, PlusIcon, TrashIcon, Portal, Select, SortAltIcon, SortAmountDownIcon, SortAmountUpAltIcon) {
    'use strict';
