...
function render$9(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.loading ? (vue.openBlock(), vue.createElementBlock("td", vue.mergeProps({
    ...
    key: 3,
    "class": _ctx.cx('rowToggleIcon')
  }, $options.getColumnPT('rowToggleIcon')), null, 16, ["class"])) : vue.createCommentVNode("", true)], 64))], 16, _hoisted_2$2)), [[_directive_ripple]]) : $props.editMode === 'row' && $options.columnProp('rowEditor') ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 7
  }, [!$data.d_editing ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
    key: 0,
    "class": _ctx.cx('rowEditorInit'),
    "aria-label": $options.initButtonAriaLabel,
    unstyled: _ctx.unstyled,
    onClick: $options.onRowEditInit
  }, _objectSpread$a(_objectSpread$a({}, $options.getColumnPT('rowEditorInit')), $props.editButtonProps.init), {
    "data-pc-group-section": "rowactionbutton"
  }), {
    icon: vue.withCtx(function (slotProps) {
      return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children && $props.column.children.roweditoriniticon || 'PencilIcon'), vue.mergeProps({
        "class": slotProps["class"]
      }, $options.getColumnPT('rowEditorInit')['icon']), null, 16, ["class"]))];
    }),
    _: 1
  }, 16, ["class", "aria-label", "unstyled", "onClick"])) : vue.createCommentVNode("", true), $data.d_editing ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
    key: 1,
    "class": _ctx.cx('rowEditorSave'),
    "aria-label": $options.saveButtonAriaLabel,
    unstyled: _ctx.unstyled,
    onClick: $options.onRowEditSave
  }, _objectSpread$a(_objectSpread$a({}, $options.getColumnPT('rowEditorSave')), $props.editButtonProps.save), {
    "data-pc-group-section": "rowactionbutton"
  }), {
    icon: vue.withCtx(function (slotProps) {
      return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children && $props.column.children.roweditorsaveicon || 'CheckIcon'), vue.mergeProps({
        "class": slotProps["class"]
      }, $options.getColumnPT('rowEditorSave')['icon']), null, 16, ["class"]))];
    }),
    _: 1
  }, 16, ["class", "aria-label", "unstyled", "onClick"])) : vue.createCommentVNode("", true), $data.d_editing ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
    key: 2,
    "class": _ctx.cx('rowEditorCancel'),
    "aria-label": $options.cancelButtonAriaLabel,
    unstyled: _ctx.unstyled,
    onClick: $options.onRowEditCancel
  }, _objectSpread$a(_objectSpread$a({}, $options.getColumnPT('rowEditorCancel')), $props.editButtonProps.cancel), {
    "data-pc-group-section": "rowactionbutton"
  }), {
    icon: vue.withCtx(function (slotProps) {
      return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children && $props.column.children.roweditorcancelicon || 'TimesIcon'), vue.mergeProps({
        "class": slotProps["class"]
      }, $options.getColumnPT('rowEditorCancel')['icon']), null, 16, ["class"]))];
    }),
    _: 1
  }, 16, ["class", "aria-label", "unstyled", "onClick"])) : vue.createCommentVNode("", true)], 64)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 8
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !$props.empty ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    ...
    type: "button"
  }, _ctx.ptm('rowToggleButton')), [$props.templates['rowgrouptogglericon'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['rowgrouptogglericon']), {
    key: 0,
    ...
    data: $props.rowData,
    index: $options.rowIndex
  }, null, 8, ["data", "index"]))], 16, _hoisted_4)], 16, _hoisted_3)) : vue.createCommentVNode("", true), $props.templates['groupfooter'] && $props.rowGroupMode === 'subheader' && $options.shouldRenderRowGroupFooter ? (vue.openBlock(), vue.createElementBlock("tr", vue.mergeProps({
    key: 3,
...
var script$4 = {
  ...
  methods: {
    ...
    findNextItem: function findNextItem(item) {
      ...
      if (nextItem) return utils.DomHandler.getAttribute(nextItem, 'data-pc-section') === 'filterconstraintseparator' ? this.findNextItem(nextItem) : nextItem;else return item.parentElement.firstElementChild;
    },
    findPrevItem: function findPrevItem(item) {
      var prevItem = item.previousElementSibling;
      if (prevItem) return utils.DomHandler.getAttribute(prevItem, 'data-pc-section') === 'filterconstraintseparator' ? this.findPrevItem(prevItem) : prevItem;else return item.parentElement.lastElementChild;
    },
    hide: function hide() {
      this.overlayVisible = false;
      this.showMenuButton && utils.DomHandler.focus(this.$refs.icon.$el);
    },
    ...
    onOverlayEnter: function onOverlayEnter(el) {
      ...
      utils.DomHandler.absolutePosition(this.overlay, this.$refs.icon.$el);
    ...
    bindScrollListener: function bindScrollListener() {
      ...
      if (!this.scrollHandler) {
        this.scrollHandler = new utils.ConnectedOverlayScrollHandler(this.$refs.icon.$el, function () {
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    "class": _ctx.cx('columnFilterButton'),
    unstyled: _ctx.unstyled,
  ...
  }, _objectSpread$4(_objectSpread$4({}, $options.getColumnPT('columnFilterButton', $options.ptmFilterMenuParams)), $props.filterButtonProps.filter)), {
    icon: vue.withCtx(function (slotProps) {
    ...
    key: 2,
    "class": _ctx.cx('columnFilterClearButton'),
    unstyled: _ctx.unstyled,
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $options.clearFilter();
    })
  }, _objectSpread$4(_objectSpread$4({}, $options.getColumnPT('columnFilterClearButton', $options.ptmHeaderFilterClearParams)), $props.filterButtonProps.inline.clear)), {
    icon: vue.withCtx(function (slotProps) {
        ...
        "default": vue.withCtx(function () {
          return [$data.overlayVisible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
            ...
            return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
              ...
              tabindex: i === 0 ? '0' : null
            }, $options.getColumnPT('filterConstraint', $options.ptmFilterConstraintOptions(matchMode))), vue.toDisplayString(matchMode.label), 17, _hoisted_2);
            ...
            return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              "class": vue.normalizeClass(_ctx.cx('filterConstraintDropdown')),
              optionLabel: "label",
              optionValue: "value",
              ...
              unstyled: _ctx.unstyled,
              pt: $options.getColumnPT('filterConstraintDropdown')
            ...
            }, null, 8, ["field", "filterModel", "filterCallback", "applyFilter"])) : vue.createCommentVNode("", true), vue.createElementVNode("div", vue.normalizeProps(vue.guardReactiveProps($options.getColumnPT('filterRemove'))), [$options.showRemoveIcon ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
              key: 0,
              type: "button",
              "class": _ctx.cx('filterRemoveRuleButton'),
              onClick: function onClick($event) {
              ...
              pt: $options.getColumnPT('filterRemoveRuleButton')
            }), {
              icon: vue.withCtx(function (iconProps) {
                ...
                }, $options.getColumnPT('filterRemoveRuleButton')['icon']), null, 16, ["class"]))];
              }),
              _: 2
            }, 1040, ["class", "onClick", "label", "unstyled", "pt"])) : vue.createCommentVNode("", true)], 16)], 16);
            ...
            filterModel: $props.filters[$props.field],
            filterCallback: $options.filterCallback
          }, null, 8, ["field", "filterModel", "filterCallback"]))], 16, _hoisted_1$1)), [[_directive_focustrap]]) : vue.createCommentVNode("", true)];
        }),
        _: 1
...
var script = {
  ...
  methods: {
    ...
    onRowMouseDown: function onRowMouseDown(event) {
      if (utils.DomHandler.getAttribute(event.target, 'data-pc-section') === 'reorderablerowhandle' || utils.DomHandler.getAttribute(event.target.parentElement, 'data-pc-section') === 'reorderablerowhandle') event.currentTarget.draggable = true;else event.currentTarget.draggable = false;
    },
    ...
    createResponsiveStyle: function createResponsiveStyle() {
      if (!this.responsiveStyleElement) {
        ...
        var tableSelector = ".p-datatable-table-container ".concat(this.virtualScrollerDisabled ? '' : '> .p-virtualscroller', " > .p-datatable-table");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('overlay')), [_ctx.$slots.loading ? vue.renderSlot(_ctx.$slots, "loading", {
    key: 0
