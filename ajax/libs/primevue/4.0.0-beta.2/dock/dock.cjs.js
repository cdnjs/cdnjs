...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
      ...
      tabindex: "-1",
      "aria-hidden": "true"
    }, $options.getPTOptions('itemLink', processedItem, index)), [!$props.templates['icon'] ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
      key: 0,
      "class": [_ctx.cx('itemIcon'), processedItem.icon]
    }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16)), [[_directive_ripple]]) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['icon']), {
      key: 1,
      item: processedItem,
