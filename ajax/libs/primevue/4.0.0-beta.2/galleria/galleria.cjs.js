...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('itemsContainer')), [vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('items')
  }, _ctx.ptm('items')), [$props.showItemNavigators ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
    key: 0,
    type: "button",
  ...
  }, _ctx.ptm('indicatorList')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.value, function (item, index) {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
  ...
  }, _ctx.ptm('thumbnails')), [vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('thumbnailContent')
  }, _ctx.ptm('thumbnailContent')), [$props.showThumbnailNavigators ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
    key: 0,
    ...
    }, _ctx.ptm('thumbnail')), [$props.templates.thumbnail ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.thumbnail), {
      key: 0,
      item: item
