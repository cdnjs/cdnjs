...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("ol", vue.mergeProps({
    ...
    return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
      key: index + '_label',
      "class": _ctx.cx('label')
    }, _ctx.ptm('label')), [vue.renderSlot(_ctx.$slots, "icon", {
      value: val,
    ...
    }, _ctx.ptm('labelText')), vue.toDisplayString(val.label) + " (" + vue.toDisplayString(_ctx.$parentInstance.percentValue(val.value)) + ")", 17)], 16);
  }), 128))], 16);
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('meters')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.value, function (val, index) {
