...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("fieldset", mergeProps({
    ...
    }, _ctx.ptm('legendLabel')), toDisplayString(_ctx.legend), 17, _hoisted_1)];
  ...
  }, _objectSpread(_objectSpread({}, _ctx.toggleButtonProps), _ctx.ptm('toggler'))), [renderSlot(_ctx.$slots, _ctx.$slots.togglericon ? 'togglericon' : 'toggleicon', {
