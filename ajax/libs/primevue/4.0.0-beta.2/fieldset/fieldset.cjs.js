...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("fieldset", vue.mergeProps({
    ...
    }, _ctx.ptm('legendLabel')), vue.toDisplayString(_ctx.legend), 17, _hoisted_1)];
  ...
  }, _objectSpread(_objectSpread({}, _ctx.toggleButtonProps), _ctx.ptm('toggler'))), [vue.renderSlot(_ctx.$slots, _ctx.$slots.togglericon ? 'togglericon' : 'toggleicon', {
    ...
    return [vue.createElementVNode("span", vue.mergeProps({
      "class": _ctx.cx('legendLabel')
    }, _ctx.ptm('legendLabel')), vue.toDisplayString(_ctx.legend), 17)];
