...
import { resolveComponent, openBlock, createElementBlock, Fragment, renderList, mergeProps, createElementVNode, toDisplayString, createVNode, normalizeClass, withCtx, createBlock, resolveDynamicComponent, renderSlot, normalizeStyle, withKeys, createCommentVNode, createTextVNode } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(true), createElementBlock(Fragment, null, renderList($props.files, function (file, index) {
    return openBlock(), createElementBlock("div", mergeProps({
      ...
      "class": normalizeClass(_ctx.cx('fileBadge')),
      ...
      rounded: "",
      severity: "danger",
      "class": normalizeClass(_ctx.cx('fileRemoveButton')),
      unstyled: _ctx.unstyled,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.isAdvanced ? (openBlock(), createElementBlock("div", mergeProps({
    ...
    return [createVNode(_component_Button, {
      ...
      "class": normalizeClass($options.chooseButtonClass),
      ...
      _: 3
    }, 8, ["label", "class", "style", "disabled", "unstyled", "onClick", "onKeydown", "onFocus", "onBlur", "pt"]), _ctx.showUploadButton ? (openBlock(), createBlock(_component_Button, {
      key: 0,
      "class": normalizeClass(_ctx.cx('uploadButton')),
      ...
      _: 3
    }, 8, ["class", "label", "onClick", "disabled", "unstyled", "pt"])) : createCommentVNode("", true), _ctx.showCancelButton ? (openBlock(), createBlock(_component_Button, {
      key: 1,
      "class": normalizeClass(_ctx.cx('cancelButton')),
      ...
      _: 3
    }, 8, ["class", "label", "onClick", "disabled", "unstyled", "pt"])) : createCommentVNode("", true)];
    ...
    return [$options.hasFiles ? (openBlock(), createElementBlock(Fragment, {
    ...
    }, null, 8, ["value", "unstyled", "pt"]), $options.hasFiles ? (openBlock(), createElementBlock("div", {
      key: 0,
      ...
      unstyled: _ctx.unstyled,
      pt: _ctx.pt
    }, null, 8, ["files", "onRemove", "badgeValue", "previewWidth", "templates", "unstyled", "pt"])], 2)) : createCommentVNode("", true)], 64)) : createCommentVNode("", true), (openBlock(true), createElementBlock(Fragment, null, renderList($data.messages, function (msg) {
    ...
    }), 128)), $options.hasUploadedFiles ? (openBlock(), createElementBlock("div", {
      key: 1,
      "class": normalizeClass(_ctx.cx('fileList'))
    }, [createVNode(_component_FileContent, {
    ...
    _: 3
  }, 16, ["label", "class", "style", "disabled", "unstyled", "onMouseup", "onKeydown", "onFocus", "onBlur"]), !$options.hasFiles ? (openBlock(), createElementBlock("input", mergeProps({
    key: 0,
    ref: "fileInput",
    type: "file",
    accept: _ctx.accept,
  ...
  }, _ctx.ptm('input')), null, 16, _hoisted_2)) : createCommentVNode("", true)], 16)) : createCommentVNode("", true);
}
