...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    }, $options.getPTOptions('eventOpposite', index)), [vue.renderSlot(_ctx.$slots, "opposite", {
      item: item,
      index: index
    })], 16), vue.createElementVNode("div", vue.mergeProps({
      "class": _ctx.cx('eventSeparator')
    }, $options.getPTOptions('eventSeparator', index)), [vue.renderSlot(_ctx.$slots, "marker", {
      item: item,
      index: index
    }, function () {
    ...
    }, $options.getPTOptions('eventContent', index)), [vue.renderSlot(_ctx.$slots, "content", {
      item: item,
      index: index
    })], 16)], 16);
  }), 128))], 16);
