...
var DomHandler = {
  ...
  absolutePosition: function absolutePosition(element, target) {
    ...
    if (element) {
      ...
      gutter && (element.style.marginTop = origin === 'bottom' ? themes.$dt('{anchor.gutter} * -1').variable : themes.$dt('anchor.gutter').variable);
    }
  },
  ...
  blockBodyScroll: function blockBodyScroll() {
    ...
    document.body.style.setProperty(themes.$dt('scrollbar.width').name, this.calculateBodyScrollbarWidth() + 'px');
    this.addClass(document.body, className);
  },
  unblockBodyScroll: function unblockBodyScroll() {
    var className = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'p-overflow-hidden';
    document.body.style.removeProperty(themes.$dt('scrollbar.width').name);
