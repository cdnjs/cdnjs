          ...
          default: withCtx(() => [
            ($props.inline ? true : $data.overlayVisible)
              ? (openBlock(), createElementBlock("div", mergeProps({
                  ...
                  createElementVNode("div", mergeProps({ class: "p-colorpicker-content" }, _ctx.ptm('content')), [
                    createElementVNode("div", mergeProps({
                      ...
                      createElementVNode("div", mergeProps({ class: "p-colorpicker-color" }, _ctx.ptm('color')), [
                        createElementVNode("div", mergeProps({
