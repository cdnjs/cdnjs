...
var script = {
  ...
  methods: {
    ...
    findNextItem: function findNextItem(items, index) {
      ...
      if (nextItem) return DomHandler.getAttribute(nextItem, 'data-p-disabled') ? this.findNextItem(items, i) : {
        nextItem: nextItem,
        i: i
      };else return null;
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('menu')), [(openBlock(true), createElementBlock(Fragment, null, renderList($options.focusableItems, function (item, i) {
