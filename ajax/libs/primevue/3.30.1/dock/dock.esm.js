...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock("li", mergeProps({
    ...
    }, $options.getPTOptions($options.getItemId(index), 'content')), [!$props.templates['item'] ? (openBlock(), createElementBlock(Fragment, {
      key: 0
      ...
      "default": withCtx(function (_ref) {
        ...
        }, $options.getPTOptions($options.getItemId(index), 'action')), [!$props.templates['icon'] ? withDirectives((openBlock(), createElementBlock("span", mergeProps({
          key: 0,
          "class": [_ctx.cx('icon'), processedItem.icon]
        }, $options.getPTOptions($options.getItemId(index), 'icon')), null, 16)), [[_directive_ripple]]) : (openBlock(), createBlock(resolveDynamicComponent($props.templates['icon']), {
          key: 1,
          item: processedItem,
