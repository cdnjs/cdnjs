...
this.primevue.megamenu = (function (utils, BaseComponent, MegaMenuStyle, AngleDownIcon, AngleRightIcon, Ripple, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, null, 8, ["id", "tabindex", "aria-label", "aria-labelledby", "aria-disabled", "aria-orientation", "aria-activedescendant", "menuId", "focusedItemId", "items", "horizontal", "templates", "activeItem", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter"]), _ctx.$slots.end ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        key: 1,
        "class": _ctx.cx('end')
...
})(primevue.utils, primevue.basecomponent, primevue.megamenu.style, primevue.icons.angledown, primevue.icons.angleright, primevue.ripple, Vue);
