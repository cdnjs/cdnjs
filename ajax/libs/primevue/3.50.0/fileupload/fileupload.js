...
this.primevue.fileupload = (function (Button, PlusIcon, TimesIcon, UploadIcon, Message, ProgressBar, Ripple, utils, BaseComponent, FileUploadStyle, Badge, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.isAdvanced ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return [$options.hasFiles ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
        ...
        }, null, 8, ["value", "unstyled", "pt"]), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.messages, function (msg) {
          ...
          unstyled: _ctx.unstyled,
          pt: _ctx.pt
        }, null, 8, ["files", "onRemove", "badgeValue", "previewWidth", "templates", "unstyled", "pt"])], 64)) : vue.createCommentVNode("", true), vue.createVNode(_component_FileContent, {
