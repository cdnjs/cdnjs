...
this.primevue.treetable = (function (api, SpinnerIcon, Paginator, utils, BaseComponent, TreeTableStyle, vue, SortAltIcon, SortAmountDownIcon, SortAmountUpAltIcon, CheckIcon, ChevronDownIcon, ChevronRightIcon, MinusIcon, Ripple) {
    ...
    function render$2(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("td", vue.mergeProps({
        ...
        key: 2,
        "class": _ctx.cx('rowTogglerIcon')
      }, $options.getColumnPT('rowTogglerIcon')), null, 16, ["class"]))], 64))], 16)), [[_directive_ripple]]) : vue.createCommentVNode("", true), $options.checkboxSelectionMode && $options.columnProp('expander') ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        key: 1,
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createElementVNode("tr", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          ...
          pt: _ctx.pt
        }, null, 8, ["column", "node", "level", "leaf", "indentation", "expanded", "selectionMode", "checked", "partialChecked", "templates", "onCheckboxToggle", "index", "loadingMode", "pt"])) : vue.createCommentVNode("", true)], 64);
