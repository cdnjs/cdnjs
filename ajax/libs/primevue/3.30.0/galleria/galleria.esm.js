...
import { resolveDirective, openBlock, createElementBlock, mergeProps, createElementVNode, withDirectives, createBlock, resolveDynamicComponent, createCommentVNode, Fragment, renderList, normalizeClass, resolveComponent, createVNode, withCtx, Transition } from 'vue';
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock("li", mergeProps({
      ...
      type: "button",
      tabindex: "-1",
      "class": normalizeClass(_ctx.cx('indicatorButton'))
    }, null, 2)) : createCommentVNode("", true), $props.templates.indicator ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.indicator), {
      key: 1,
      index: index
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread$1(_objectSpread$1({}, $props.prevButtonProps), _ctx.ptm('previousThumbnailButton'))), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.previousthumbnailicon || ($props.isVertical ? 'ChevronUpIcon' : 'ChevronLeftIcon')), mergeProps({
  ...
  }, _objectSpread$1(_objectSpread$1({}, $props.nextButtonProps), _ctx.ptm('nextThumbnailButton'))), [(openBlock(), createBlock(resolveDynamicComponent($props.templates.nextthumbnailicon || ($props.isVertical ? 'ChevronDownIcon' : 'ChevronRightIcon')), mergeProps({
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('closeButton')), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates['closeicon'] || 'TimesIcon'), mergeProps({
    "class": _ctx.cx('closeIcon')
  }, _ctx.ptm('closeIcon')), null, 16, ["class"]))], 16, _hoisted_2)), [[_directive_ripple]]) : createCommentVNode("", true), _ctx.$attrs.templates && _ctx.$attrs.templates['header'] ? (openBlock(), createElementBlock("div", mergeProps({
    key: 1,
    "class": _ctx.cx('header')
  }, _ctx.ptm('header')), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates['header'])))], 16)) : createCommentVNode("", true), createElementVNode("div", mergeProps({
    "class": _ctx.cx('content'),
    "aria-live": _ctx.$attrs.autoPlay ? 'polite' : 'off'
  }, _ctx.ptm('content')), [createVNode(_component_GalleriaItem, {
    id: $data.id,
  ...
  }, _ctx.ptm('footer')), [(openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates['footer'])))], 16)) : createCommentVNode("", true)], 16, _hoisted_1$1)) : createCommentVNode("", true);
}
