...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.loading ? (openBlock(), createElementBlock("td", mergeProps({
    ...
    role: "cell"
  }, _objectSpread$d(_objectSpread$d({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(openBlock(), createBlock(resolveDynamicComponent($props.column.children.loading), {
    data: $props.rowData,
    column: $props.column,
    field: $options.field,
    ...
    key: 1,
    "class": normalizeClass([_ctx.cx('rowReorderIcon'), $options.columnProp('rowReorderIcon')])
  }, null, 2)) : (openBlock(), createBlock(_component_BarsIcon, {
    key: 2,
    "class": normalizeClass(_ctx.cx('rowReorderIcon')),
...
function render$7(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("tbody", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, null, [$props.templates['groupheader'] && $props.rowGroupMode === 'subheader' && $options.shouldRenderRowGroupHeader($props.value, rowData, $options.getRowIndex(index)) ? (openBlock(), createElementBlock("tr", mergeProps({
    ...
    }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [$props.expandableRowGroups ? (openBlock(), createElementBlock("button", mergeProps({
      key: 0,
      ...
      type: "button"
    }, $options.getColumnPT('rowGroupToggler')), [$props.templates['rowgrouptogglericon'] ? (openBlock(), createBlock(resolveDynamicComponent($props.templates['rowgrouptogglericon']), {
      key: 0,
    ...
    }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16)) : $options.isRowGroupExpanded(rowData) && !$props.expandedRowIcon ? (openBlock(), createBlock(_component_ChevronDownIcon, mergeProps({
      key: 1,
      "class": _ctx.cx('rowGroupTogglerIcon')
    }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16, ["class"])) : !$options.isRowGroupExpanded(rowData) && $props.collapsedRowIcon ? (openBlock(), createElementBlock("span", mergeProps({
      key: 2,
      "class": [_ctx.cx('rowGroupTogglerIcon'), $props.collapsedRowIcon]
    }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16)) : !$options.isRowGroupExpanded(rowData) && !$props.collapsedRowIcon ? (openBlock(), createBlock(_component_ChevronRightIcon, mergeProps({
      key: 3,
      "class": _ctx.cx('rowGroupTogglerIcon')
    }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16, ["class"])) : createCommentVNode("", true)], 64))], 16, _hoisted_2$1)) : createCommentVNode("", true), (openBlock(), createBlock(resolveDynamicComponent($props.templates['groupheader']), {
      data: rowData,
    ...
    }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(openBlock(), createBlock(resolveDynamicComponent($props.templates['expansion']), {
      data: rowData,
      index: $options.getRowIndex(index)
      ...
      colspan: $options.columnsLength - 1
    }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(openBlock(), createBlock(resolveDynamicComponent($props.templates['groupfooter']), {
      data: rowData,
      index: $options.getRowIndex(index)
    ...
    colspan: $options.columnsLength
  }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [$props.templates.empty ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.empty), {
    key: 0
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread$a(_objectSpread$a({}, $options.getColumnPT('root')), $options.getColumnPT('footerCell'))), [$props.column.children && $props.column.children.footer ? (openBlock(), createBlock(resolveDynamicComponent($props.column.children.footer), {
    key: 0,
    column: $props.column
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.hasFooter ? (openBlock(), createElementBlock("tfoot", mergeProps({
    ...
    return openBlock(), createElementBlock("tr", mergeProps({
      key: i,
      role: "row"
    }, _objectSpread$8(_objectSpread$8({}, _ctx.ptm('footerRow')), $options.getRowPT(row, 'root', i))), [(openBlock(true), createElementBlock(Fragment, null, renderList($options.getFooterColumns(row), function (col, j) {
      return openBlock(), createElementBlock(Fragment, {
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread$6(_objectSpread$6({}, $props.filterInputProps), $options.getColumnPT('filterInput'))), [(openBlock(), createBlock(resolveDynamicComponent($props.filterElement), {
    field: $props.field,
