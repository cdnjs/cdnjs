...
this.primevue.datatable = (function (api, ArrowDownIcon, ArrowUpIcon, SpinnerIcon, Paginator, utils, VirtualScroller, BaseComponent, usestyle, ChevronDownIcon, ChevronRightIcon, BarsIcon, CheckIcon, PencilIcon, TimesIcon, OverlayEventBus, Ripple, vue, Button, Dropdown, FocusTrap, FilterIcon, FilterSlashIcon, PlusIcon, TrashIcon, Portal, SortAltIcon, SortAmountDownIcon, SortAmountUpAltIcon) {
    'use strict';
    ...
    function render$8(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.loading ? (vue.openBlock(), vue.createElementBlock("td", vue.mergeProps({
        ...
        role: "cell"
      }, _objectSpread$d(_objectSpread$d({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children.loading), {
        data: $props.rowData,
        column: $props.column,
        field: $options.field,
        ...
        key: 1,
        "class": vue.normalizeClass([_ctx.cx('rowReorderIcon'), $options.columnProp('rowReorderIcon')])
      }, null, 2)) : (vue.openBlock(), vue.createBlock(_component_BarsIcon, {
        key: 2,
        "class": vue.normalizeClass(_ctx.cx('rowReorderIcon')),
    ...
    function render$7(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("tbody", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [$props.templates['groupheader'] && $props.rowGroupMode === 'subheader' && $options.shouldRenderRowGroupHeader($props.value, rowData, $options.getRowIndex(index)) ? (vue.openBlock(), vue.createElementBlock("tr", vue.mergeProps({
        ...
        }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [$props.expandableRowGroups ? (vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
          key: 0,
          ...
          type: "button"
        }, $options.getColumnPT('rowGroupToggler')), [$props.templates['rowgrouptogglericon'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['rowgrouptogglericon']), {
          key: 0,
        ...
        }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16)) : $options.isRowGroupExpanded(rowData) && !$props.expandedRowIcon ? (vue.openBlock(), vue.createBlock(_component_ChevronDownIcon, vue.mergeProps({
          key: 1,
          "class": _ctx.cx('rowGroupTogglerIcon')
        }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16, ["class"])) : !$options.isRowGroupExpanded(rowData) && $props.collapsedRowIcon ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
          key: 2,
          "class": [_ctx.cx('rowGroupTogglerIcon'), $props.collapsedRowIcon]
        }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16)) : !$options.isRowGroupExpanded(rowData) && !$props.collapsedRowIcon ? (vue.openBlock(), vue.createBlock(_component_ChevronRightIcon, vue.mergeProps({
          key: 3,
          "class": _ctx.cx('rowGroupTogglerIcon')
        }, $options.getColumnPT('rowGroupTogglerIcon')), null, 16, ["class"])) : vue.createCommentVNode("", true)], 64))], 16, _hoisted_2$1)) : vue.createCommentVNode("", true), (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['groupheader']), {
          data: rowData,
        ...
        }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['expansion']), {
          data: rowData,
          index: $options.getRowIndex(index)
          ...
          colspan: $options.columnsLength - 1
        }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['groupfooter']), {
          data: rowData,
          index: $options.getRowIndex(index)
        ...
        colspan: $options.columnsLength
      }, _objectSpread$c(_objectSpread$c({}, $options.getColumnPT('root')), $options.getColumnPT('bodyCell'))), [$props.templates.empty ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.empty), {
        key: 0
    ...
    function render$6(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, _objectSpread$a(_objectSpread$a({}, $options.getColumnPT('root')), $options.getColumnPT('footerCell'))), [$props.column.children && $props.column.children.footer ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children.footer), {
        key: 0,
        column: $props.column
    ...
    function render$5(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.hasFooter ? (vue.openBlock(), vue.createElementBlock("tfoot", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock("tr", vue.mergeProps({
          key: i,
          role: "row"
        }, _objectSpread$8(_objectSpread$8({}, _ctx.ptm('footerRow')), $options.getRowPT(row, 'root', i))), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.getFooterColumns(row), function (col, j) {
          return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    ...
    function render$4(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, _objectSpread$6(_objectSpread$6({}, $props.filterInputProps), $options.getColumnPT('filterInput'))), [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.filterElement), {
        field: $props.field,
