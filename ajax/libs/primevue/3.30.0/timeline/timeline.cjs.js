...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      "class": _ctx.cx('event')
    }, _ctx.ptm('event')), [vue.createElementVNode("div", vue.mergeProps({
      "class": _ctx.cx('opposite')
    }, _ctx.ptm('opposite')), [vue.renderSlot(_ctx.$slots, "opposite", {
      item: item,
      index: index
    })], 16), vue.createElementVNode("div", vue.mergeProps({
      "class": _ctx.cx('separator')
    }, _ctx.ptm('separator')), [vue.renderSlot(_ctx.$slots, "marker", {
      item: item,
      index: index
    }, function () {
      return [vue.createElementVNode("div", vue.mergeProps({
        "class": _ctx.cx('marker')
      }, _ctx.ptm('marker')), null, 16)];
