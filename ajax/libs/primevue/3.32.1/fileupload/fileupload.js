...
this.primevue.fileupload = (function (Button, PlusIcon, TimesIcon, UploadIcon, Message, ProgressBar, Ripple, utils, BaseComponent, usestyle, Badge, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.isAdvanced ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return [$options.hasFiles ? (vue.openBlock(), vue.createBlock(_component_FileUploadProgressBar, {
          key: 0,
          value: $data.progress,
          showValue: false,
          unstyled: _ctx.unstyled,
          pt: _ctx.ptm('progressbar')
        }, null, 8, ["value", "unstyled", "pt"])) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($data.messages, function (msg) {
        ...
        }), 128)), $options.hasFiles ? (vue.openBlock(), vue.createBlock(_component_FileContent, {
          key: 1,
          files: $data.files,
          ...
          unstyled: _ctx.unstyled,
          pt: _ctx.pt
        }, null, 8, ["files", "onRemove", "badgeValue", "previewWidth", "templates", "unstyled", "pt"])) : vue.createCommentVNode("", true), vue.createVNode(_component_FileContent, {
...
})(primevue.button, primevue.icons.plus, primevue.icons.times, primevue.icons.upload, primevue.message, primevue.progressbar, primevue.ripple, primevue.utils, primevue.basecomponent, primevue.usestyle, primevue.badge, Vue);
