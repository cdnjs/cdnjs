...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }) : _ctx.showIcon && _ctx.iconDisplay === 'input' ? vue.renderSlot(_ctx.$slots, "inputicon", {
    key: 2,
    ...
    "default": vue.withCtx(function () {
      return [vue.createVNode(vue.Transition, vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          return [_ctx.inline || $data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
          ...
          }), null, 16, ["label", "class", "onKeydown", "pt"]), vue.createVNode(_component_Button, vue.mergeProps({
            ...
            "data-pc-group-section": "button"
          }), null, 16, ["label", "class", "onKeydown", "pt"])], 16)) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, "footer")], 16, _hoisted_3)) : vue.createCommentVNode("", true)];
        }),
        _: 3
