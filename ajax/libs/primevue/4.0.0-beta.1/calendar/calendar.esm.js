...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }) : _ctx.showIcon && _ctx.iconDisplay === 'input' ? renderSlot(_ctx.$slots, "inputicon", {
    key: 2,
    ...
    "default": withCtx(function () {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          return [_ctx.inline || $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
          ...
          }), null, 16, ["label", "class", "onKeydown", "pt"]), createVNode(_component_Button, mergeProps({
            ...
            "data-pc-group-section": "button"
          }), null, 16, ["label", "class", "onKeydown", "pt"])], 16)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "footer")], 16, _hoisted_3)) : createCommentVNode("", true)];
        }),
        _: 3
