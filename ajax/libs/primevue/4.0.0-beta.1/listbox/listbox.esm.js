...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, mergeProps, createElementVNode, normalizeClass, renderSlot, createCommentVNode, createVNode, createBlock, resolveDynamicComponent, toDisplayString, createSlots, withCtx, Fragment, renderList, createTextVNode, withDirectives } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, null, 8, ["modelValue", "class", "placeholder", "invalid", "disabled", "unstyled", "aria-owns", "aria-activedescendant", "tabindex", "onInput", "onBlur", "onKeydown", "pt"]), renderSlot(_ctx.$slots, "filtericon", {
