...
this.primevue.listbox = (function (api, SearchIcon, InputText, Ripple, utils, VirtualScroller, BaseComponent, ListboxStyle, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, null, 8, ["modelValue", "class", "placeholder", "invalid", "disabled", "unstyled", "aria-owns", "aria-activedescendant", "tabindex", "onInput", "onBlur", "onKeydown", "pt"]), vue.renderSlot(_ctx.$slots, "filtericon", {
...
})(primevue.api, primevue.icons.search, primevue.inputtext, primevue.ripple, primevue.utils, primevue.virtualscroller, primevue.basecomponent, primevue.listbox.style, Vue);
