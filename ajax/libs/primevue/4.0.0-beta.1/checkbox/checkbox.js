...
this.primevue.checkbox = (function (CheckIcon, MinusIcon, utils, BaseComponent, CheckboxStyle, vue) {
    'use strict';
    ...
    var script = {
      ...
      computed: {
        checked: function checked() {
          return this.d_indeterminate ? false : this.binary ? this.modelValue === this.trueValue : utils.ObjectUtils.contains(this.value, this.modelValue);
        }
      },
      components: {
    ...
    var _hoisted_1 = ["data-p-highlight", "data-p-checked", "data-p-indeterminate", "data-p-disabled"];
...
})(primevue.icons.check, primevue.icons.minus, primevue.utils, primevue.basecomponent, primevue.checkbox.style, Vue);
