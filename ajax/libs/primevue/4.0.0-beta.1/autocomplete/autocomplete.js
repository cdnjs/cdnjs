...
this.primevue.autocomplete = (function (ChevronDownIcon, SpinnerIcon, TimesCircleIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, AutoCompleteStyle, BaseComponent, vue) {
    'use strict';
    ...
    var script = {
      ...
      methods: {
        ...
        show: function show(isFocus) {
          ...
          isFocus && utils.DomHandler.focus(this.$refs.focusInput.$el);
        },
        hide: function hide(isFocus) {
          ...
          var _hide = function _hide() {
            ...
            isFocus && utils.DomHandler.focus(_this2.$refs.focusInput.$el);
          };
          setTimeout(function () {
            _hide();
          }, 0); // For ScreenReaders
          ...
          if (this.forceSelection) {
            ...
            if (this.visibleOptions && !this.multiple) {
              var matchedValue = this.visibleOptions.find(function (option) {
                return _this4.isOptionMatched(option, _this4.$refs.focusInput.$el.value || '');
              });
        ...
        onContainerClick: function onContainerClick(event) {
          ...
          if (!this.overlay || !this.overlay.contains(event.target)) {
            utils.DomHandler.focus(this.$refs.focusInput.$el);
          }
        },
        ...
        onBackspaceKey: function onBackspaceKey(event) {
          if (this.multiple) {
            if (utils.ObjectUtils.isNotEmpty(this.modelValue) && !this.$refs.focusInput.$el.value) {
    ...
    var _hoisted_3 = ["disabled", "aria-expanded", "aria-controls"];
    var _hoisted_4 = ["id"];
    var _hoisted_5 = ["id"];
    var _hoisted_6 = ["id"];
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        role: "option"
      }, _ctx.ptm('inputToken')), [vue.createVNode(_component_InputText, {
        ref: "focusInput",
        id: _ctx.inputId,
        style: vue.normalizeStyle(_ctx.inputStyle),
        "class": vue.normalizeClass(_ctx.inputClass),
        value: $data.multipleInputValue,
        placeholder: _ctx.placeholder,
        tabindex: !_ctx.disabled ? _ctx.tabindex : -1,
        disabled: _ctx.disabled,
        invalid: _ctx.invalid,
        ...
        onChange: $options.onChange,
        pt: _ctx.ptm('input')
      }, null, 8, ["id", "style", "class", "value", "placeholder", "tabindex", "disabled", "invalid", "variant", "unstyled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "onChange", "pt"])], 16)], 16, _hoisted_1)) : vue.createCommentVNode("", true), $data.searching || _ctx.loading ? vue.renderSlot(_ctx.$slots, "loadingicon", {
        key: 2,
          ...
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [$data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                "data-p-hidden-accessible": true
              }), vue.toDisplayString($options.selectedMessageText), 17)], 16, _hoisted_4)) : vue.createCommentVNode("", true)];
            }),
            _: 3
...
})(primevue.icons.chevrondown, primevue.icons.spinner, primevue.icons.timescircle, primevue.inputtext, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.utils, primevue.virtualscroller, primevue.autocomplete.style, primevue.basecomponent, Vue);
