  ...
  methods: {
    ...
    hide: function hide(isFocus) {
      ...
      var _hide = function _hide() {
        ...
        isFocus && DomHandler.focus(_this2.$refs.focusInput.$el);
      };
      setTimeout(function () {
        _hide();
      }, 0); // For ScreenReaders
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    role: "option"
  }, _ctx.ptm('inputToken')), [createVNode(_component_InputText, {
    ref: "focusInput",
    id: _ctx.inputId,
    style: normalizeStyle(_ctx.inputStyle),
    ...
    onChange: $options.onChange,
    pt: _ctx.ptm('input')
  }, null, 8, ["id", "style", "class", "value", "placeholder", "tabindex", "disabled", "invalid", "variant", "unstyled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "onChange", "pt"])], 16)], 16, _hoisted_1)) : createCommentVNode("", true), $data.searching || _ctx.loading ? renderSlot(_ctx.$slots, "loadingicon", {
    key: 2,
  ...
  }) : createCommentVNode("", true), renderSlot(_ctx.$slots, "dropdownbutton", {
    ...
    "default": withCtx(function () {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
          ...
          }, _ctx.ptm('panel')), [renderSlot(_ctx.$slots, "header", {
            ...
            "data-p-hidden-accessible": true
          }), toDisplayString($options.selectedMessageText), 17)], 16, _hoisted_4)) : createCommentVNode("", true)];
        }),
        _: 3
