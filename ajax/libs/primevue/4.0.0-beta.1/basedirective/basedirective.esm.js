...
var BaseDirective = {
  ...
  _loadStyles: function _loadStyles(el, binding, vnode) {
    ...
    ThemeService.on('theme:change', function () {
      var _config$csp4;
  ...
  _loadThemeStyles: function _loadThemeStyles() {
    ...
    // directive
    if (!Theme.isStyleNameLoaded((_instance$$style2 = instance.$style) === null || _instance$$style2 === void 0 ? void 0 : _instance$$style2.name) && (_instance$$style3 = instance.$style) !== null && _instance$$style3 !== void 0 && _instance$$style3.name) {
