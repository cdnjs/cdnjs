...
this.primevue.inputnumber = (function (AngleDownIcon, AngleUpIcon, InputText, utils, BaseComponent, InputNumberStyle, vue) {
    'use strict';
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        ...
        id: _ctx.inputId,
        role: "spinbutton",
        "class": vue.normalizeClass([_ctx.cx('input'), _ctx.inputClass]),
      ...
      }, null, 8, ["id", "class", "style", "value", "aria-valuemin", "aria-valuemax", "aria-valuenow", "disabled", "readonly", "placeholder", "aria-labelledby", "aria-label", "invalid", "variant", "onInput", "onKeydown", "onPaste", "onClick", "onFocus", "onBlur", "pt", "unstyled"]), _ctx.showButtons && _ctx.buttonLayout === 'stacked' ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        key: 0,
        ...
        return [vue.createElementVNode("button", vue.mergeProps({
          ...
          tabindex: -1,
          "aria-hidden": "true"
        }, _ctx.ptm('incrementButton')), [vue.renderSlot(_ctx.$slots, "incrementbuttonicon", {}, function () {
        ...
        return [vue.createElementVNode("button", vue.mergeProps({
          ...
          tabindex: -1,
          "aria-hidden": "true"
        }, _ctx.ptm('decrementButton')), [vue.renderSlot(_ctx.$slots, "decrementbuttonicon", {}, function () {
...
})(primevue.icons.angledown, primevue.icons.angleup, primevue.inputtext, primevue.utils, primevue.basecomponent, primevue.inputnumber.style, Vue);
