...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    id: _ctx.inputId,
    role: "spinbutton",
    "class": normalizeClass([_ctx.cx('input'), _ctx.inputClass]),
  ...
  }, null, 8, ["id", "class", "style", "value", "aria-valuemin", "aria-valuemax", "aria-valuenow", "disabled", "readonly", "placeholder", "aria-labelledby", "aria-label", "invalid", "variant", "onInput", "onKeydown", "onPaste", "onClick", "onFocus", "onBlur", "pt", "unstyled"]), _ctx.showButtons && _ctx.buttonLayout === 'stacked' ? (openBlock(), createElementBlock("span", mergeProps({
    key: 0,
    ...
    return [createElementVNode("button", mergeProps({
      ...
      tabindex: -1,
      "aria-hidden": "true"
    }, _ctx.ptm('incrementButton')), [renderSlot(_ctx.$slots, "incrementbuttonicon", {}, function () {
    ...
    return [createElementVNode("button", mergeProps({
      ...
      tabindex: -1,
      "aria-hidden": "true"
    }, _ctx.ptm('decrementButton')), [renderSlot(_ctx.$slots, "decrementbuttonicon", {}, function () {
