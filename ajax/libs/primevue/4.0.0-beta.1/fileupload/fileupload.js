...
this.primevue.fileupload = (function (Button, PlusIcon, TimesIcon, UploadIcon, Message, ProgressBar, Ripple, utils, BaseComponent, FileUploadStyle, Badge, vue) {
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.files, function (file, index) {
        ...
        }, _ctx.ptm('fileSize')), vue.toDisplayString($options.formatSize(file.size)), 17), vue.createVNode(_component_Badge, {
        ...
        }, _ctx.ptm('actions')), [vue.createVNode(_component_Button, {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $options.isAdvanced ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        return [vue.createVNode(_component_Button, {
          ...
          icon: vue.withCtx(function (iconProps) {
            return [vue.renderSlot(_ctx.$slots, "chooseicon", {
          ...
          _: 3
        }, 8, ["label", "onClick", "disabled", "unstyled", "pt"])) : vue.createCommentVNode("", true), _ctx.showCancelButton ? (vue.openBlock(), vue.createBlock(_component_Button, {
          key: 1,
        ...
        icon: vue.withCtx(function (iconProps) {
          return [!$options.hasFiles || _ctx.auto ? vue.renderSlot(_ctx.$slots, "uploadicon", {
            ...
            return [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.uploadIcon ? 'span' : 'UploadIcon'), vue.mergeProps({
              "class": [iconProps["class"], _ctx.cx('uploadIcon'), _ctx.uploadIcon],
              "aria-hidden": "true"
        ...
        _: 3
      }, 16, ["label", "class", "style", "onMouseup", "onKeydown", "onFocus", "onBlur"]), !$options.hasFiles ? (vue.openBlock(), vue.createElementBlock("input", vue.mergeProps({
        key: 0,
        ref: "fileInput",
        type: "file",
        accept: _ctx.accept,
