...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(true), createElementBlock(Fragment, null, renderList($props.files, function (file, index) {
    ...
    }, _ctx.ptm('fileSize')), toDisplayString($options.formatSize(file.size)), 17), createVNode(_component_Badge, {
    ...
    }, _ctx.ptm('actions')), [createVNode(_component_Button, {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.isAdvanced ? (openBlock(), createElementBlock("div", mergeProps({
    ...
    return [createVNode(_component_Button, {
      ...
      icon: withCtx(function (iconProps) {
        return [renderSlot(_ctx.$slots, "chooseicon", {
      ...
      _: 3
    }, 8, ["label", "onClick", "disabled", "unstyled", "pt"])) : createCommentVNode("", true), _ctx.showCancelButton ? (openBlock(), createBlock(_component_Button, {
      key: 1,
    ...
    _: 3
  }, 16, ["label", "class", "style", "onMouseup", "onKeydown", "onFocus", "onBlur"]), !$options.hasFiles ? (openBlock(), createElementBlock("input", mergeProps({
    key: 0,
    ref: "fileInput",
    type: "file",
    accept: _ctx.accept,
