...
this.primevue.dropdown = (function (api, BlankIcon, CheckIcon, ChevronDownIcon, SearchIcon, SpinnerIcon, TimesIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, BaseComponent, DropdownStyle, vue) {
    'use strict';
    ...
    var script = {
      ...
      methods: {
        ...
        show: function show(isFocus) {
          ...
          isFocus && utils.DomHandler.focus(this.editable ? this.$refs.focusInput.$el : this.$refs.focusInput);
        },
        hide: function hide(isFocus) {
          ...
          var _hide = function _hide() {
            ...
            isFocus && utils.DomHandler.focus(_this2.editable ? _this2.$refs.focusInput.$el : _this2.$refs.focusInput);
          };
          setTimeout(function () {
            _hide();
          }, 0); // For ScreenReaders
    ...
    var _hoisted_1 = ["id"];
    var _hoisted_2 = ["id", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-disabled"];
    var _hoisted_3 = ["id"];
    var _hoisted_4 = ["id"];
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      }, _ctx.ptmi('root')), [_ctx.editable ? (vue.openBlock(), vue.createBlock(_component_InputText, {
        key: 0,
        ref: "focusInput",
        id: _ctx.inputId,
        type: "text",
        ...
        onInput: $options.onEditableInput,
        pt: _ctx.ptm('input')
      }, null, 8, ["id", "class", "style", "value", "placeholder", "tabindex", "disabled", "invalid", "variant", "unstyled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "pt"])) : (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
        key: 1,
        ref: "focusInput",
        id: _ctx.inputId,
      ...
      }, _ctx.ptm('input')), [vue.renderSlot(_ctx.$slots, "value", {
        value: _ctx.modelValue,
        placeholder: _ctx.placeholder
      }, function () {
        return [vue.createTextVNode(vue.toDisplayString($options.label === 'p-emptylabel' ? ' ' : $options.label || 'empty'), 1)];
      })], 16, _hoisted_2)), _ctx.showClear && _ctx.modelValue != null ? vue.renderSlot(_ctx.$slots, "clearicon", {
        key: 2,
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              }, null, 8, ["value", "onVnodeMounted", "onVnodeUpdated", "class", "placeholder", "invalid", "variant", "unstyled", "aria-owns", "aria-activedescendant", "onKeydown", "onBlur", "onInput", "pt"]), vue.renderSlot(_ctx.$slots, "filtericon", {
