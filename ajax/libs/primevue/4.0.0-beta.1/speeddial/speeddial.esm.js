...
import { $dtp, $dt } from 'primevue/themes';
  ...
  mounted: function mounted() {
    ...
    if (this.type !== 'linear') {
      ...
      if (button && firstItem) {
        ...
        this.list.style.setProperty($dtp('item.diff.x').name, "".concat(wDiff / 2, "px"));
        this.list.style.setProperty($dtp('item.diff.y').name, "".concat(hDiff / 2, "px"));
      }
    }
