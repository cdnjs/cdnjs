    ...
    var script$1 = {
      ...
      methods: {
        ...
        onNodeClick: function onNodeClick(event) {
          if (utils.DomHandler.isAttributeEquals(event.target, 'data-pc-section', 'nodetoggler') || utils.DomHandler.isAttributeEquals(event.target, 'data-pc-section', 'nodetogglericon')) {
            return;
          }
