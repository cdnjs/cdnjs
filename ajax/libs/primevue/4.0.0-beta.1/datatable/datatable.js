          ...
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [$data.overlayVisible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                }, null, 8, ["field", "filterModel", "filterCallback", "applyFilter"])) : vue.createCommentVNode("", true), vue.createElementVNode("div", vue.normalizeProps(vue.guardReactiveProps($options.getColumnPT('filterRemove'))), [$options.showRemoveIcon ? (vue.openBlock(), vue.createBlock(_component_CFButton, vue.mergeProps({
                  key: 0,
                  type: "button",
              ...
              }, $options.getColumnPT('filterAddRule')), [vue.createVNode(_component_CFButton, vue.mergeProps({
                type: "button",
              ...
              }, $options.getColumnPT('filterButtonbar')), [!$props.filterClearTemplate && $props.showClearButton ? (vue.openBlock(), vue.createBlock(_component_CFButton, vue.mergeProps({
                key: 0,
                type: "button",
                ...
                key: 2
              }, [!$props.filterApplyTemplate ? (vue.openBlock(), vue.createBlock(_component_CFButton, vue.mergeProps({
                key: 0,
                type: "button",
