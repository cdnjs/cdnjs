...
this.primevue.confirmpopup = (function (Button, ConfirmationEventBus, FocusTrap, OverlayEventBus, Portal, themes, utils, BaseComponent, ConfirmPopupStyle, vue) {
    'use strict';
    ...
    var script = {
      ...
      methods: {
        ...
        alignOverlay: function alignOverlay() {
          ...
          this.container.style.setProperty(themes.$dtp('overlay.arrow.left').name, "".concat(arrowLeft, "px"));
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              return [$data.visible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              }, _ctx.ptm('footer')), [vue.createVNode(_component_Button, vue.mergeProps({
                ...
                key: "0"
              } : undefined]), 1040, ["class", "autofocus", "unstyled", "size", "text", "onKeydown", "label", "pt"]), vue.createVNode(_component_Button, vue.mergeProps({
                ...
                key: "0"
              } : undefined]), 1040, ["class", "autofocus", "unstyled", "size", "onKeydown", "label", "pt"])], 16)], 64))], 16, _hoisted_1)), [[_directive_focustrap]]) : vue.createCommentVNode("", true)];
            }),
            _: 3
...
})(primevue.button, primevue.confirmationeventbus, primevue.focustrap, primevue.overlayeventbus, primevue.portal, primevue.themes, primevue.utils, primevue.basecomponent, primevue.confirmpopup.style, Vue);
