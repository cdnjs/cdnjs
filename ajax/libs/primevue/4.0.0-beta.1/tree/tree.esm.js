...
var _hoisted_2 = ["data-p-highlight", "data-p-selectable"];
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("li", mergeProps({
    ...
    _: 1
  }, 8, ["modelValue", "indeterminate", "class", "unstyled", "pt", "data-p-partialchecked"])) : createCommentVNode("", true), $props.templates['nodeicon'] ? (openBlock(), createBlock(resolveDynamicComponent($props.templates['nodeicon']), {
    key: 1,
    node: $props.node,
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm('filterContainer')), [createVNode(_component_InputText, mergeProps({
  ...
  }, _ctx.ptm('input')), null, 16, ["modelValue", "class", "placeholder", "onKeydown"]), renderSlot(_ctx.$slots, "searchicon", {
