...
this.primevue.multiselect = (function (api, Checkbox, CheckIcon, ChevronDownIcon, SearchIcon, SpinnerIcon, TimesIcon, TimesCircleIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, BaseComponent, MultiSelectStyle, vue) {
    'use strict';
    ...
    var _hoisted_3 = ["id"];
    var _hoisted_4 = ["id"];
    var _hoisted_5 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove", "data-p-highlight", "data-p-focused", "data-p-disabled"];
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [$data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              }, _ctx.ptm('panel')), [vue.createElementVNode("span", vue.mergeProps({
              ...
              }, _ctx.ptm('filterContainer')), [vue.createVNode(_component_InputText, {
                ref: "filterInput",
                value: $data.filterValue,
                onVnodeMounted: $options.onFilterUpdated,
                onVnodeUpdated: $options.onFilterUpdated,
                "class": vue.normalizeClass(_ctx.cx('filterInput')),
                ...
                pt: _ctx.ptm('filterInput')
              }, null, 8, ["value", "onVnodeMounted", "onVnodeUpdated", "class", "placeholder", "invalid", "disabled", "variant", "unstyled", "aria-owns", "aria-activedescendant", "onKeydown", "onBlur", "onInput", "pt"]), vue.renderSlot(_ctx.$slots, "filtericon", {
