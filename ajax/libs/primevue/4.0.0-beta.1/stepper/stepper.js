...
this.primevue.stepper = (function (utils, vue, BaseComponent, StepperStyle) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        }, null, 8, ["id", "template", "stepperpanel", "index", "active", "highlighted", "clickCallback", "prevCallback", "nextCallback", "getStepPT", "aria-labelledby"])), [[vue.vShow, $options.isStepActive(index)]]);
