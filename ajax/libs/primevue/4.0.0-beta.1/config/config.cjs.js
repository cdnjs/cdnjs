...
function setupTheme(app, PrimeVue) {
  ...
  vue.watch(PrimeVue.config.theme, function (newValue) {
    if (!isChanged.value) {
      Theme__default["default"].setTheme(newValue);
    }
  ...
  Theme.ThemeService.on('theme:change', function (newTheme) {
