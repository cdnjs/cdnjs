...
var Theme = require('primevue/themes');
...
var script = {
  ...
  beforeCreate: function beforeCreate() {
    var _this$pt, _this$pt2, _this$pt3, _ref, _ref$onBeforeCreate, _this$$config, _this$$primevue, _this$$primevue2, _this$$primevue3, _ref2, _ref2$onBeforeCreate;
    ...
    var _useptInConfig = (_this$$config = this.$config) === null || _this$$config === void 0 || (_this$$config = _this$$config.pt) === null || _this$$config === void 0 ? void 0 : _this$$config['_usept'];
  ...
  mounted: function mounted() {
    ...
    var rootElement = utils.DomHandler.findSingle(this.$el, "[data-pc-name=\"".concat(utils.ObjectUtils.toFlatCase(this.$.type.name), "\"]"));
    rootElement === null || rootElement === void 0 || rootElement.setAttribute(this.$attrSelector, '');
  ...
  methods: {
    ...
    _loadStyles: function _loadStyles() {
      BaseStyle__default["default"].loadStyle(this.$styleOptions);
      this._loadGlobalStyles();
      this._loadThemeStyles();
      Theme.ThemeService.on('theme:change', this._loadThemeStyles);
    },
    _loadGlobalStyles: function _loadGlobalStyles() {
      ...
      utils.ObjectUtils.isNotEmpty(globalCSS) && BaseStyle__default["default"].loadStyle(globalCSS, _objectSpread({
        name: 'global'
      }, this.$styleOptions));
    },
    _loadThemeStyles: function _loadThemeStyles() {
      var _this$$style2, _this$$style3;
      if (this.isUnstyled) return;

      // common
      if (!Theme__default["default"].isStyleNameLoaded('common')) {
        var _this$$style, _this$$style$getCommo;
        var _ref3 = ((_this$$style = this.$style) === null || _this$$style === void 0 || (_this$$style$getCommo = _this$$style.getCommonThemeCSS) === null || _this$$style$getCommo === void 0 ? void 0 : _this$$style$getCommo.call(_this$$style)) || {},
      ...
      // component
      if (!Theme__default["default"].isStyleNameLoaded((_this$$style2 = this.$style) === null || _this$$style2 === void 0 ? void 0 : _this$$style2.name) && (_this$$style3 = this.$style) !== null && _this$$style3 !== void 0 && _this$$style3.name) {
        var _this$$style4, _this$$style4$getComp, _this$$style5, _this$$style6;
        var _ref4 = ((_this$$style4 = this.$style) === null || _this$$style4 === void 0 || (_this$$style4$getComp = _this$$style4.getComponentThemeCSS) === null || _this$$style4$getComp === void 0 ? void 0 : _this$$style4$getComp.call(_this$$style4)) || {},
          variables = _ref4.variables,
          style = _ref4.style;
        (_this$$style5 = this.$style) === null || _this$$style5 === void 0 || _this$$style5.loadTheme(variables, _objectSpread({
          name: "".concat(this.$style.name, "-variables")
        }, this.$styleOptions));
        (_this$$style6 = this.$style) === null || _this$$style6 === void 0 || _this$$style6.loadTheme(style, _objectSpread({
          name: "".concat(this.$style.name, "-style")
        }, this.$styleOptions));
        Theme__default["default"].setLoadedStyleName(this.$style.name);
      }

      // layer order
      if (!Theme__default["default"].isStyleNameLoaded('layer-order')) {
        var _this$$style7, _this$$style7$getLaye;
        var layerOrder = (_this$$style7 = this.$style) === null || _this$$style7 === void 0 || (_this$$style7$getLaye = _this$$style7.getLayerOrderThemeCSS) === null || _this$$style7$getLaye === void 0 ? void 0 : _this$$style7$getLaye.call(_this$$style7);
    ...
    _loadScopedThemeStyles: function _loadScopedThemeStyles(preset) {
      var _this$$style8, _this$$style8$getPres, _this$$style9;
      var variables = ((_this$$style8 = this.$style) === null || _this$$style8 === void 0 || (_this$$style8$getPres = _this$$style8.getPresetThemeCSS) === null || _this$$style8$getPres === void 0 ? void 0 : _this$$style8$getPres.call(_this$$style8, preset, "[".concat(this.$attrSelector, "]"))) || {};
      var scopedStyle = (_this$$style9 = this.$style) === null || _this$$style9 === void 0 ? void 0 : _this$$style9.loadTheme(variables, _objectSpread({
    ...
    _getPTValue: function _getPTValue() {
      ...
      var _ref5 = this._getPropValue('ptOptions') || ((_this$$config2 = this.$config) === null || _this$$config2 === void 0 ? void 0 : _this$$config2.ptOptions) || {},
        _ref5$mergeSections = _ref5.mergeSections,
        mergeSections = _ref5$mergeSections === void 0 ? true : _ref5$mergeSections,
        _ref5$mergeProps = _ref5.mergeProps,
        useMergeProps = _ref5$mergeProps === void 0 ? false : _ref5$mergeProps;
    ...
    _getPT: function _getPT(pt) {
      ...
      var getValue = function getValue(value) {
        ...
        return (_ref7 = checkSameKey ? _key !== _cKey ? computedValue === null || computedValue === void 0 ? void 0 : computedValue[_key] : undefined : computedValue === null || computedValue === void 0 ? void 0 : computedValue[_key]) !== null && _ref7 !== void 0 ? _ref7 : computedValue;
      };
    ...
    _usePT: function _usePT(pt, callback, key, params) {
      ...
      if (pt !== null && pt !== void 0 && pt.hasOwnProperty('_usept')) {
        var _this$$config3;
        var _ref8 = pt['_usept'] || ((_this$$config3 = this.$config) === null || _this$$config3 === void 0 ? void 0 : _this$$config3.ptOptions) || {},
          _ref8$mergeSections = _ref8.mergeSections,
          mergeSections = _ref8$mergeSections === void 0 ? true : _ref8$mergeSections,
          _ref8$mergeProps = _ref8.mergeProps,
          useMergeProps = _ref8$mergeProps === void 0 ? false : _ref8$mergeProps;
  ...
  computed: {
    globalPT: function globalPT() {
      var _this$$config4,
        _this2 = this;
      return this._getPT((_this$$config4 = this.$config) === null || _this$$config4 === void 0 ? void 0 : _this$$config4.pt, undefined, function (value) {
    ...
    defaultPT: function defaultPT() {
      var _this$$config5,
        _this3 = this;
      return this._getPT((_this$$config5 = this.$config) === null || _this$$config5 === void 0 ? void 0 : _this$$config5.pt, undefined, function (value) {
    ...
    isUnstyled: function isUnstyled() {
      var _this$$config6;
      return this.unstyled !== undefined ? this.unstyled : (_this$$config6 = this.$config) === null || _this$$config6 === void 0 ? void 0 : _this$$config6.unstyled;
    },
    $theme: function $theme() {
      var _this$$config7;
      return (_this$$config7 = this.$config) === null || _this$$config7 === void 0 ? void 0 : _this$$config7.theme;
    },
    ...
    $styleOptions: function $styleOptions() {
      var _this$$config8;
      return {
        nonce: (_this$$config8 = this.$config) === null || _this$$config8 === void 0 || (_this$$config8 = _this$$config8.csp) === null || _this$$config8 === void 0 ? void 0 : _this$$config8.nonce
      };
    },
    ...
    $_attrsPT: function $_attrsPT() {
      return Object.entries(this.$attrs || {}).filter(function (_ref9) {
    ...
    $attrSelector: function $attrSelector() {
      return utils.UniqueComponentId('pc');
    }
  }
};
