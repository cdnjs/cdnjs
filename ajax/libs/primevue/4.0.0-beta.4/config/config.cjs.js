...
var PrimeVueService = require('primevue/service');
...
function setupTheme(app, PrimeVue) {
  ...
  vue.watch(PrimeVue.config, function (newValue, oldValue) {
    PrimeVueService__default["default"].emit('config:change', {
      newValue: newValue,
      oldValue: oldValue
    });
  }, {
  ...
  vue.watch(function () {
    ...
    PrimeVueService__default["default"].emit('config:ripple:change', {
      newValue: newValue,
      oldValue: oldValue
    });
  }, {
  ...
  vue.watch(function () {
    ...
    if (!isChanged.value) {
      themes.Theme.setTheme(newValue);
    }
    isChanged.value = false;
    PrimeVueService__default["default"].emit('config:theme:change', {
      newValue: newValue,
      oldValue: oldValue
    });
  }, {
  ...
  themes.ThemeService.on('theme:change', function (newTheme) {
