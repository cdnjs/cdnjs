...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
  ...
  }, $props.level === 0 ? _ctx.ptm('rootList') : _ctx.ptm('submenu')), [$props.submenu ? (vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
    key: 0,
    ...
    role: "presentation"
  }, _ctx.ptm('submenuLabel')), vue.toDisplayString($options.getItemLabel($props.submenu)), 17)) : vue.createCommentVNode("", true), (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, function (processedItem, index) {
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      ref_for: true
    }, $options.getPTOptions(processedItem, index, 'itemLabel')), vue.toDisplayString($options.getItemLabel(processedItem)), 17), $options.isItemGroup(processedItem) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: 2
      ...
      ref_for: true
    }, _ctx.ptm('overlay')), [vue.createElementVNode("div", vue.mergeProps({
      "class": _ctx.cx('grid'),
      ref_for: true
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    }, _ctx.ptm('button')), [vue.renderSlot(_ctx.$slots, _ctx.$slots.buttonicon ? 'buttonicon' : 'menubuttonicon', {}, function () {
