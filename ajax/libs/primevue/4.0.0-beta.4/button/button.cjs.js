...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
    ...
    }), _ctx.label ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
      key: 2,
      "class": _ctx.cx('label')
    }, _ctx.ptm('label')), vue.toDisplayString(_ctx.label), 17)) : vue.createCommentVNode("", true), _ctx.badge ? (vue.openBlock(), vue.createBlock(_component_Badge, vue.mergeProps({
      key: 3,
      value: _ctx.badge,
