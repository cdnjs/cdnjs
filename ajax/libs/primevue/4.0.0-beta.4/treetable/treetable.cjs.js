...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getColumnPT('sortIcon')), null, 16, ["sorted", "sortOrder", "class"]))], 16)) : vue.createCommentVNode("", true), $options.isMultiSorted() ? (vue.openBlock(), vue.createBlock(_component_Badge, vue.mergeProps({
    key: 3,
    "class": _ctx.cx('pcSortBadge')
  }, $options.getColumnPT('pcSortBadge'), {
    value: $options.getMultiSortMetaIndex() + 1,
    size: "small"
  }), null, 16, ["class", "value"])) : vue.createCommentVNode("", true)], 16)], 16, _hoisted_1$3);
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("td", vue.mergeProps({
  ...
  }, $options.getColumnPT('bodyCellContent')), [$options.columnProp('expander') ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
    key: 0,
    type: "button",
    ...
    key: 0
  }, [$props.templates['nodetoggleicon'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['nodetoggleicon']), {
    key: 0
  })) : vue.createCommentVNode("", true), $props.templates['nodetogglericon'] ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates['nodetogglericon']), {
    key: 1
  })) : (vue.openBlock(), vue.createBlock(_component_SpinnerIcon, vue.mergeProps({
    key: 2,
    spin: ""
  }, _ctx.ptm('nodetoggleicon')), null, 16))], 64)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 1
  }, [$props.column.children && $props.column.children.rowtoggleicon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children.rowtoggleicon), {
    key: 0,
    node: $props.node,
    expanded: $props.expanded,
    "class": vue.normalizeClass(_ctx.cx('rowToggleIcon'))
  }, null, 8, ["node", "expanded", "class"])) : vue.createCommentVNode("", true), $props.column.children && $props.column.children.rowtogglericon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children.rowtogglericon), {
    key: 1,
    node: $props.node,
    expanded: $props.expanded,
    "class": vue.normalizeClass(_ctx.cx('rowToggleIcon'))
  ...
  }, $options.getColumnPT('rowToggleIcon')), null, 16, ["class"])) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.node.collapsedIcon ? 'span' : 'ChevronRightIcon'), vue.mergeProps({
    key: 3,
    "class": _ctx.cx('rowToggleIcon')
  }, $options.getColumnPT('rowToggleIcon')), null, 16, ["class"]))], 64))], 16)), [[_directive_ripple]]) : vue.createCommentVNode("", true), $options.checkboxSelectionMode && $options.columnProp('expander') ? (vue.openBlock(), vue.createBlock(_component_Checkbox, {
    key: 1,
    modelValue: $props.checked,
    binary: true,
    "class": vue.normalizeClass(_ctx.cx('pcNodeCheckbox')),
    ...
    icon: vue.withCtx(function (slotProps) {
      ...
      }, null, 8, ["checked", "partialChecked", "class"])) : vue.createCommentVNode("", true)];
    }),
    _: 1
  }, 8, ["modelValue", "class", "onChange", "indeterminate", "unstyled", "pt", "data-p-partialchecked"])) : vue.createCommentVNode("", true), $props.column.children && $props.column.children.body ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.column.children.body), {
    key: 2,
    node: $props.node,
    column: $props.column
  }, null, 8, ["node", "column"])) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 3
  }, [vue.createTextVNode(vue.toDisplayString($options.resolveFieldData($props.node.data, $options.columnProp('field'))), 1)], 64))], 16)], 16, _hoisted_1$2);
}
...
var script$1 = {
  ...
  methods: {
    ...
    onClick: function onClick(event) {
      if (utils.DomHandler.isClickable(event.target) || utils.DomHandler.getAttribute(event.target, 'data-pc-section') === 'rowtogglebutton' || utils.DomHandler.getAttribute(event.target, 'data-pc-section') === 'rowtoggleicon' || event.target.tagName === 'path') {
        return;
      }
    ...
    onArrowRightKey: function onArrowRightKey(event) {
      ...
      var togglerElement = utils.DomHandler.findSingle(this.$refs.node, '[data-pc-section="rowtogglebutton"]');
    ...
    onArrowLeftKey: function onArrowLeftKey(event) {
      ...
      var togglerElement = utils.DomHandler.findSingle(currentTarget, '[data-pc-section="rowtogglebutton"]');
...
var script = {
  ...
  methods: {
    ...
    onColumnResize: function onColumnResize(event) {
      ...
      !this.isUnstyled && utils.DomHandler.addStyles(this.$el, {
        'user-select': 'none'
      });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
  ...
  }, _ctx.ptm('loading')), [vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('mask')
  }, _ctx.ptm('mask')), [vue.renderSlot(_ctx.$slots, "loadingicon", {
  ...
  }, _ctx.ptm('tableContainer')), [vue.createElementVNode("table", vue.mergeProps({
    ref: "table",
    role: "table",
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      unstyled: _ctx.unstyled,
      pt: _ctx.pt
    }, null, 8, ["column", "resizableColumns", "sortField", "sortOrder", "multiSortMeta", "sortMode", "index", "unstyled", "pt"])) : vue.createCommentVNode("", true)], 64);
