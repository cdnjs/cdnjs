...
var IconField = require('primevue/iconfield');
...
var InputIcon = require('primevue/inputicon');
...
var _hoisted_3 = ["id"];
var _hoisted_4 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove", "data-p-highlight", "data-p-focused", "data-p-disabled"];
        ...
        "default": vue.withCtx(function () {
          return [$data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
            ...
            icon: vue.withCtx(function (slotProps) {
              ...
              }, $options.getHeaderCheckboxPTOptions('pcHeaderCheckbox.icon')), null, 16, ["class"])) : vue.createCommentVNode("", true)];
            }),
            _: 1
          }, 8, ["modelValue", "disabled", "variant", "aria-label", "onChange", "unstyled", "pt"])) : vue.createCommentVNode("", true), vue.createVNode(_component_IconField, {
            "class": vue.normalizeClass(_ctx.cx('pcFilterContainer')),
            unstyled: _ctx.unstyled,
            ...
            "default": vue.withCtx(function () {
              ...
              }, null, 8, ["value", "onVnodeMounted", "onVnodeUpdated", "class", "placeholder", "invalid", "disabled", "variant", "unstyled", "aria-owns", "aria-activedescendant", "onKeydown", "onBlur", "onInput", "pt"]), vue.createVNode(_component_InputIcon, vue.mergeProps({
                unstyled: _ctx.unstyled
            ...
            _: 3
          }, 8, ["class", "unstyled", "pt"]), _ctx.filter ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
            key: 1,
            role: "status",
            "aria-live": "polite",
            "class": "p-hidden-accessible"
            ...
            "data-p-hidden-accessible": true
          }), vue.toDisplayString($options.filterResultMessageText), 17)) : vue.createCommentVNode("", true)], 16)) : vue.createCommentVNode("", true), vue.createElementVNode("div", vue.mergeProps({
            ...
            content: vue.withCtx(function (_ref2) {
              ...
              return [vue.createElementVNode("ul", vue.mergeProps({
                ...
                return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                ...
                })], 16, _hoisted_3)) : vue.withDirectives((vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
                  key: 1,
                  id: $data.id + '_' + $options.getOptionIndex(i, getItemOptions),
                  style: {
                    height: itemSize ? itemSize + 'px' : undefined
                  ...
                  icon: vue.withCtx(function (slotProps) {
                    return [_ctx.$slots.optioncheckboxicon || _ctx.$slots.itemcheckboxicon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.$slots.optioncheckboxicon || _ctx.$slots.itemcheckboxicon), {
                      key: 0,
                      checked: slotProps.checked,
                      "class": vue.normalizeClass(slotProps["class"])
                    }, null, 8, ["checked", "class"])) : slotProps.checked ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.checkboxIcon ? 'span' : 'CheckIcon'), vue.mergeProps({
                      ...
                      "class": [slotProps["class"], _defineProperty({}, _ctx.checkboxIcon, slotProps.checked)],
                      ref_for: true
                    }, $options.getCheckboxPTOptions(option, getItemOptions, i, 'pcOptionCheckbox.icon')), null, 16, ["class"])) : vue.createCommentVNode("", true)];
                  }),
                  _: 2
              ...
              })], 16)) : vue.createCommentVNode("", true)], 16, _hoisted_2)];
            }),
            _: 2
          }, [_ctx.$slots.loader ? {
            name: "loader",
