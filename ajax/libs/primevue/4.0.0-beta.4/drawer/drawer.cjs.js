...
var DrawerStyle = require('primevue/drawer/style');
var vue = require('vue');
...
var DrawerStyle__default = /*#__PURE__*/_interopDefaultLegacy(DrawerStyle);
...
var script$1 = {
  ...
  style: DrawerStyle__default["default"],
    ...
    "default": vue.withCtx(function () {
      return [$data.containerVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          return [_ctx.visible ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
          ...
          }), _ctx.showCloseIcon ? (vue.openBlock(), vue.createBlock(_component_Button, vue.mergeProps({
            key: 0,
            ...
            _: 3
          }, 16, ["class", "aria-label", "unstyled", "onClick", "pt"])) : vue.createCommentVNode("", true)], 16), vue.createElementVNode("div", vue.mergeProps({
            ref: $options.contentRef,
            "class": _ctx.cx('content')
          }, _ctx.ptm('content')), [vue.renderSlot(_ctx.$slots, "default")], 16), vue.createElementVNode("div", vue.mergeProps({
            ref: $options.footerContainerRef,
            "class": _ctx.cx('footer')
          }, _ctx.ptm('footer')), [vue.renderSlot(_ctx.$slots, "footer")], 16)], 64))], 16, _hoisted_1)), [[_directive_focustrap]]) : vue.createCommentVNode("", true)];
        }),
        _: 3
