...
var DialogStyle = require('primevue/dialog/style');
...
var script = {
  ...
  methods: {
    ...
    onBeforeLeave: function onBeforeLeave() {
      if (this.modal) {
        !this.isUnstyled && utils.DomHandler.addClass(this.mask, 'p-overlay-mask-leave');
      }
    },
    ...
    initDrag: function initDrag(event) {
      ...
      if (this.draggable) {
        ...
        !this.isUnstyled && utils.DomHandler.addStyles(document.body, {
          'user-select': 'none'
        });
      }
    },
