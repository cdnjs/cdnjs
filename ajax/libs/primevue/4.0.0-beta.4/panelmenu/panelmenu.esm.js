  ...
  methods: {
    ...
    onEnterKey: function onEnterKey(event) {
      if (ObjectUtils.isNotEmpty(this.focusedItem)) {
        ...
        var anchorElement = element && (DomHandler.findSingle(element, '[data-pc-section="itemlink"]') || DomHandler.findSingle(element, 'a,button'));
...
var script = {
  ...
  methods: {
    ...
    onHeaderArrowDownKey: function onHeaderArrowDownKey(event) {
      var rootList = DomHandler.getAttribute(event.currentTarget, 'data-p-highlight') === true ? DomHandler.findSingle(event.currentTarget.nextElementSibling, '[data-pc-section="rootlist"]') : null;
    ...
    onHeaderArrowUpKey: function onHeaderArrowUpKey(event) {
      ...
      var rootList = DomHandler.getAttribute(prevHeader, 'data-p-highlight') === true ? DomHandler.findSingle(prevHeader.nextElementSibling, '[data-pc-section="rootlist"]') : null;
      rootList ? DomHandler.focus(rootList) : this.updateFocusedHeader({
        originalEvent: event,
        focusOnNext: false
      });
    ...
    onHeaderEnterKey: function onHeaderEnterKey(event, item) {
      var headerAction = DomHandler.findSingle(event.currentTarget, '[data-pc-section="headerlink"]');
