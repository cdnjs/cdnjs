...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("ul", {
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      "aria-hidden": "true",
      ref_for: true
    }, $options.getPTOptions('itemLink', processedItem, index)), [$options.isItemGroup(processedItem) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      key: 0
      ...
      ref_for: true
    }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16)) : vue.createCommentVNode("", true), vue.createElementVNode("span", vue.mergeProps({
      "class": _ctx.cx('itemLabel'),
      ref_for: true
    }, $options.getPTOptions('itemLabel', processedItem, index)), vue.toDisplayString($options.getItemLabel(processedItem)), 17)], 16, _hoisted_4$1)), [[_directive_ripple]]) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.item), {
      key: 1,
      item: processedItem.item,
      root: false,
      active: $options.isItemActive(processedItem),
      ...
      "default": vue.withCtx(function () {
        return [vue.withDirectives(vue.createElementVNode("div", vue.mergeProps({
          ...
          ref_for: true
        }, _ctx.ptm('contentContainer')), [$options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (vue.openBlock(), vue.createBlock(_component_PanelMenuSub, vue.mergeProps({
          key: 0,
  ...
  methods: {
    ...
    onEnterKey: function onEnterKey(event) {
      if (utils.ObjectUtils.isNotEmpty(this.focusedItem)) {
        ...
        var anchorElement = element && (utils.DomHandler.findSingle(element, '[data-pc-section="itemlink"]') || utils.DomHandler.findSingle(element, 'a,button'));
...
var script = {
  ...
  methods: {
    ...
    onHeaderArrowDownKey: function onHeaderArrowDownKey(event) {
      var rootList = utils.DomHandler.getAttribute(event.currentTarget, 'data-p-highlight') === true ? utils.DomHandler.findSingle(event.currentTarget.nextElementSibling, '[data-pc-section="rootlist"]') : null;
    ...
    onHeaderArrowUpKey: function onHeaderArrowUpKey(event) {
      ...
      var rootList = utils.DomHandler.getAttribute(prevHeader, 'data-p-highlight') === true ? utils.DomHandler.findSingle(prevHeader.nextElementSibling, '[data-pc-section="rootlist"]') : null;
      rootList ? utils.DomHandler.focus(rootList) : this.updateFocusedHeader({
        originalEvent: event,
        focusOnNext: false
      });
    ...
    onHeaderEnterKey: function onHeaderEnterKey(event, item) {
      var headerAction = utils.DomHandler.findSingle(event.currentTarget, '[data-pc-section="headerlink"]');
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      tabindex: -1,
      ref_for: true
    }, $options.getPTOptions('headerLink', item, index)), [$options.getItemProp(item, 'items') ? vue.renderSlot(_ctx.$slots, "submenuicon", {
      key: 0,
      ...
      "default": vue.withCtx(function () {
        return [vue.withDirectives(vue.createElementVNode("div", vue.mergeProps({
          ...
          ref_for: true
        }, _ctx.ptm('contentContainer')), [$options.getItemProp(item, 'items') ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
          key: 0,
          "class": _ctx.cx('content'),
          ref_for: true
        }, _ctx.ptm('content')), [vue.createVNode(_component_PanelMenuList, {
