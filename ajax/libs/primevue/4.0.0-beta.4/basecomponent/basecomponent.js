...
this.primevue.basecomponent = (function (Base, BaseStyle, themes, utils, vue) {
    'use strict';
    ...
    var script = {
      ...
      mounted: function mounted() {
        ...
        this.rootEl = utils.DomHandler.findSingle(this.$el, "[data-pc-name=\"".concat(utils.ObjectUtils.toFlatCase(this.$.type.name), "\"]"));
        if (this.rootEl) {
      ...
      methods: {
        ...
        _loadThemeStyles: function _loadThemeStyles() {
          ...
          // component
          if (!themes.Theme.isStyleNameLoaded((_this$$style4 = this.$style) === null || _this$$style4 === void 0 ? void 0 : _this$$style4.name) && (_this$$style5 = this.$style) !== null && _this$$style5 !== void 0 && _this$$style5.name) {
            ...
            themes.Theme.setLoadedStyleName(this.$style.name);
          }
...
})(primevue.base, primevue.base.style, primevue.themes, primevue.utils, Vue);
