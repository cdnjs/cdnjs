...
this.primevue.stepper = (function (utils, vue, BaseComponent, StepperStyle) {
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        id: $props.id,
        "class": _ctx.cx('stepper.panelContent', {
          stepperpanel: $props.stepperpanel,
          index: $props.index
        }),
        role: "tabpanel",
        "aria-labelledby": $props.ariaLabelledby
      }, _objectSpread$1(_objectSpread$1({}, $props.getStepPT($props.stepperpanel, 'root', $props.index)), $props.getStepPT($props.stepperpanel, 'panelContent', $props.index)), {
    ...
    function render$2(_ctx, _cache, $props, $setup, $data, $options) {
      return $props.template ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.template), {
        ...
        active: $props.active,
        highlighted: $props.highlighted,
        "class": vue.normalizeClass(_ctx.cx('stepper.itemHeader')),
        headerClass: _ctx.cx('stepper.itemHeader'),
        numberClass: _ctx.cx('stepper.itemNumber'),
        titleClass: _ctx.cx('stepper.itemTitle'),
        clickCallback: function clickCallback(event) {
        ...
        key: 1,
        id: $props.id,
        "class": _ctx.cx('stepper.itemHeader'),
        role: "tab",
      ...
      }, $props.getStepPT($props.stepperpanel, 'itemHeader', $props.index)), [vue.createElementVNode("span", vue.mergeProps({
        "class": _ctx.cx('stepper.itemNumber')
      }, $props.getStepPT($props.stepperpanel, 'itemNumber', $props.index)), vue.toDisplayString($props.index + 1), 17), vue.createElementVNode("span", vue.mergeProps({
        "class": _ctx.cx('stepper.itemTitle')
      }, $props.getStepPT($props.stepperpanel, 'itemTitle', $props.index)), vue.toDisplayString($props.getStepProp($props.stepperpanel, 'header')), 17)], 16, _hoisted_1$1));
    }
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        ref: "nav",
        "class": _ctx.cx('list')
      }, _ctx.ptm('list')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.stepperpanels, function (step, index) {
        return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
          key: $options.getStepKey(step, index),
          "class": _ctx.cx('stepper.item', {
            step: step,
            index: index
          }),
          ...
          role: "presentation",
          ref_for: true
        }, _objectSpread(_objectSpread({}, $options.getStepPT(step, 'root', index)), $options.getStepPT(step, 'item', index)), {
          "data-pc-name": "stepperpanel",
        ...
        "class": _ctx.cx('panels')
      }, _ctx.ptm('panels')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.stepperpanels, function (step, index) {
        var _step$children3;
        ...
        return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
          ...
          ref_for: true
        }, $options.getStepPT(step, 'item', index)), [vue.renderSlot(_ctx.$slots, "header", {}, function () {
          var _step$children4;
          return [vue.createVNode(_component_StepperHeader, {
            id: $options.getStepHeaderActionId(index),
          ...
          "default": vue.withCtx(function () {
            return [vue.withDirectives(vue.createElementVNode("div", vue.mergeProps({
              "class": _ctx.cx('stepper.panelContentContainer'),
              ref_for: true
            }, $options.getStepPT(step, 'panelContentContainer', index)), [index !== $options.stepperpanels.length - 1 ? vue.renderSlot(_ctx.$slots, "separator", {
              key: 0
            }, function () {
              var _step$children5;
              return [vue.createVNode(_component_StepperSeparator, {
