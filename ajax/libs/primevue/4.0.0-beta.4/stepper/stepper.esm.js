...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.template ? (openBlock(), createBlock(resolveDynamicComponent($props.template), {
    ...
    active: $props.active,
    highlighted: $props.highlighted,
    "class": normalizeClass(_ctx.cx('stepper.itemHeader')),
  ...
  }, $props.getStepPT($props.stepperpanel, 'itemHeader', $props.index)), [createElementVNode("span", mergeProps({
    "class": _ctx.cx('stepper.itemNumber')
  }, $props.getStepPT($props.stepperpanel, 'itemNumber', $props.index)), toDisplayString($props.index + 1), 17), createElementVNode("span", mergeProps({
    "class": _ctx.cx('stepper.itemTitle')
  }, $props.getStepPT($props.stepperpanel, 'itemTitle', $props.index)), toDisplayString($props.getStepProp($props.stepperpanel, 'header')), 17)], 16, _hoisted_1$1));
}
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    ref: "nav",
    "class": _ctx.cx('list')
  }, _ctx.ptm('list')), [(openBlock(true), createElementBlock(Fragment, null, renderList($options.stepperpanels, function (step, index) {
  ...
  }, _ctx.ptm('panels')), [(openBlock(true), createElementBlock(Fragment, null, renderList($options.stepperpanels, function (step, index) {
    var _step$children3;
    ...
    return openBlock(), createElementBlock("div", mergeProps({
      ...
      ref_for: true
    }, $options.getStepPT(step, 'item', index)), [renderSlot(_ctx.$slots, "header", {}, function () {
      var _step$children4;
      return [createVNode(_component_StepperHeader, {
        id: $options.getStepHeaderActionId(index),
      ...
      "default": withCtx(function () {
        return [withDirectives(createElementVNode("div", mergeProps({
          ...
          ref_for: true
        }, $options.getStepPT(step, 'panelContentContainer', index)), [index !== $options.stepperpanels.length - 1 ? renderSlot(_ctx.$slots, "separator", {
          key: 0
        }, function () {
          var _step$children5;
          return [createVNode(_component_StepperSeparator, {
