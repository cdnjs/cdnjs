...
this.primevue.basedirective = (function (Base, BaseStyle, PrimeVueService, themes, utils, vue) {
    'use strict';
    ...
    var PrimeVueService__default = /*#__PURE__*/_interopDefaultLegacy(PrimeVueService);
    ...
    var BaseDirective = {
      ...
      _loadCoreStyles: function _loadCoreStyles() {
        ...
        if (!Base__default["default"].isStyleNameLoaded((_instance$$style = instance.$style) === null || _instance$$style === void 0 ? void 0 : _instance$$style.name) && (_instance$$style2 = instance.$style) !== null && _instance$$style2 !== void 0 && _instance$$style2.name) {
          var _instance$$style3;
          BaseStyle__default["default"].loadCSS(useStyleOptions);
          ...
          Base__default["default"].setLoadedStyleName(instance.$style.name);
        }
      },
      _loadThemeStyles: function _loadThemeStyles() {
        ...
        // common
        if (!themes.Theme.isStyleNameLoaded('common')) {
          ...
          BaseStyle__default["default"].load(primitive === null || primitive === void 0 ? void 0 : primitive.css, _objectSpread({
            name: 'primitive-variables'
          }, useStyleOptions));
          BaseStyle__default["default"].load(semantic === null || semantic === void 0 ? void 0 : semantic.css, _objectSpread({
            name: 'semantic-variables'
          }, useStyleOptions));
          BaseStyle__default["default"].loadTheme(_objectSpread({
            name: 'global-style'
          }, useStyleOptions));
          themes.Theme.setLoadedStyleName('common');
        }

        // directive
        if (!themes.Theme.isStyleNameLoaded((_instance$$style5 = instance.$style) === null || _instance$$style5 === void 0 ? void 0 : _instance$$style5.name) && (_instance$$style6 = instance.$style) !== null && _instance$$style6 !== void 0 && _instance$$style6.name) {
          ...
          themes.Theme.setLoadedStyleName(instance.$style.name);
        }

        // layer order
        if (!themes.Theme.isStyleNameLoaded('layer-order')) {
          ...
          themes.Theme.setLoadedStyleName('layer-order');
        }
      },
      ...
      _themeChangeListener: function _themeChangeListener() {
        ...
        themes.ThemeService.on('theme:change', callback);
      },
      ...
      _extend: function _extend(name) {
        ...
        var handleWatch = function handleWatch(el) {
          ...
          PrimeVueService__default["default"].on('config:change', function (_ref8) {
          ...
          PrimeVueService__default["default"].on('config:ripple:change', function (_ref9) {
...
})(primevue.base, primevue.base.style, primevue.service, primevue.themes, primevue.utils, Vue);
