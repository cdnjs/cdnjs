...
this.primevue.autocomplete = (function (Chip, ChevronDownIcon, SpinnerIcon, InputText, OverlayEventBus, Portal, Ripple, utils, VirtualScroller, AutoCompleteStyle, BaseComponent, vue) {
    'use strict';
    ...
    var script = {
      ...
      methods: {
        ...
        show: function show(isFocus) {
          ...
          isFocus && utils.DomHandler.focus(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
        },
        hide: function hide(isFocus) {
          ...
          var _hide = function _hide() {
            ...
            isFocus && utils.DomHandler.focus(_this2.multiple ? _this2.$refs.focusInput : _this2.$refs.focusInput.$el);
          };
          setTimeout(function () {
            _hide();
          }, 0); // For ScreenReaders
        ...
        onContainerClick: function onContainerClick(event) {
          ...
          if (!this.overlay || !this.overlay.contains(event.target)) {
            utils.DomHandler.focus(this.multiple ? this.$refs.focusInput : this.$refs.focusInput.$el);
          }
        },
    ...
    var _hoisted_7 = ["id"];
    var _hoisted_8 = ["id", "aria-label", "aria-selected", "aria-disabled", "aria-setsize", "aria-posinset", "onClick", "onMousemove", "data-p-highlight", "data-p-focus", "data-p-disabled"];
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
      ...
      }, _ctx.ptmi('root')), [!_ctx.multiple ? (vue.openBlock(), vue.createBlock(_component_InputText, {
        key: 0,
        ref: "focusInput",
        id: _ctx.inputId,
        type: "text",
        ...
        pt: _ctx.ptm('pcInput')
      }, null, 8, ["id", "class", "style", "value", "placeholder", "tabindex", "disabled", "invalid", "variant", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "onFocus", "onBlur", "onKeydown", "onInput", "onChange", "unstyled", "pt"])) : vue.createCommentVNode("", true), _ctx.multiple ? (vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
        key: 1,
        ref: "multiContainer",
      ...
      }, _ctx.ptm('inputMultiple')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.modelValue, function (option, i) {
        return vue.openBlock(), vue.createElementBlock("li", vue.mergeProps({
          ...
          "aria-posinset": i + 1,
          ref_for: true
        }, _ctx.ptm('chipItem')), [vue.renderSlot(_ctx.$slots, "chip", {
          "class": vue.normalizeClass(_ctx.cx('pcChip')),
          value: option,
          index: i,
          ...
          return [vue.createVNode(_component_Chip, {
            ...
            removeicon: vue.withCtx(function () {
              return [vue.renderSlot(_ctx.$slots, _ctx.$slots.chipicon ? 'chipicon' : 'removetokenicon', {
                "class": vue.normalizeClass(_ctx.cx('chipIcon')),
                index: i,
                removeCallback: function removeCallback(event) {
                  return $options.removeOption(event, i);
                }
        ...
        role: "option"
      }, _ctx.ptm('inputChip')), [vue.createElementVNode("input", vue.mergeProps({
        ref: "focusInput",
        id: _ctx.inputId,
        type: "text",
      ...
      }, _ctx.ptm('input')), null, 16, _hoisted_3)], 16)], 16, _hoisted_1)) : vue.createCommentVNode("", true), $data.searching || _ctx.loading ? vue.renderSlot(_ctx.$slots, _ctx.$slots.loader ? 'loader' : 'loadingicon', {
        key: 2,
        "class": vue.normalizeClass(_ctx.cx('loader'))
      }, function () {
        return [_ctx.loader || _ctx.loadingIcon ? (vue.openBlock(), vue.createElementBlock("i", vue.mergeProps({
          key: 0,
          "class": ['pi-spin', _ctx.cx('loader'), _ctx.loader, _ctx.loadingIcon],
          "aria-hidden": "true"
        }, _ctx.ptm('loader')), null, 16)) : (vue.openBlock(), vue.createBlock(_component_SpinnerIcon, vue.mergeProps({
          key: 1,
          "class": _ctx.cx('loader'),
          spin: "",
          "aria-hidden": "true"
        }, _ctx.ptm('loader')), null, 16, ["class"]))];
      }) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, _ctx.$slots.dropdown ? 'dropdown' : 'dropdownbutton', {
        toggleCallback: function toggleCallback(event) {
          return $options.onDropdownClick(event);
        }
      }, function () {
        return [_ctx.dropdown ? (vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
          key: 0,
          ref: "dropdownButton",
          type: "button",
        ...
        }, _ctx.ptm('dropdown')), [vue.renderSlot(_ctx.$slots, "dropdownicon", {
        ...
        })], 16, _hoisted_4)) : vue.createCommentVNode("", true)];
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              return [$data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
              ...
              }, _ctx.ptm('overlay')), [vue.renderSlot(_ctx.$slots, "header", {
                ...
                content: vue.withCtx(function (_ref) {
                  ...
                  return [vue.createElementVNode("ul", vue.mergeProps({
                    ...
                    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                      ...
                      ref_for: true
                    }, $options.getPTOptions(option, getItemOptions, i, 'option')), [_ctx.$slots.option ? vue.renderSlot(_ctx.$slots, "option", {
                      key: 0,
                      option: option,
                      index: $options.getOptionIndex(i, getItemOptions)
                    }, function () {
                ...
                "data-p-hidden-accessible": true
              }), vue.toDisplayString($options.selectedMessageText), 17)], 16, _hoisted_5)) : vue.createCommentVNode("", true)];
            }),
            _: 3
...
})(primevue.chip, primevue.icons.chevrondown, primevue.icons.spinner, primevue.inputtext, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.utils, primevue.virtualscroller, primevue.autocomplete.style, primevue.basecomponent, Vue);
