    ...
    "default": vue.withCtx(function () {
      return [($props.level === 0 ? true : $props.visible) ? (vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
        ...
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          ...
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemLabel')), vue.toDisplayString($options.getItemLabel(processedItem)), 17, _hoisted_5), $options.getItemProp(processedItem, 'items') ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          key: 2
