...
this.primevue.fieldset = (function (MinusIcon, PlusIcon, Ripple, utils, BaseComponent, FieldsetStyle, vue) {
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("fieldset", vue.mergeProps({
      ...
      }, _ctx.ptm('legend')), [vue.renderSlot(_ctx.$slots, "legend", {
        toggleCallback: $options.toggle
      }, function () {
        return [!_ctx.toggleable ? (vue.openBlock(), vue.createElementBlock("span", vue.mergeProps({
          key: 0,
          id: $data.id + '_header',
          "class": _ctx.cx('legendLabel')
        }, _ctx.ptm('legendLabel')), vue.toDisplayString(_ctx.legend), 17, _hoisted_1)) : vue.createCommentVNode("", true), _ctx.toggleable ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
          key: 1,
          id: $data.id + '_header',
          type: "button",
        ...
        }, _objectSpread(_objectSpread({}, _ctx.toggleButtonProps), _ctx.ptm('toggleButton'))), [vue.renderSlot(_ctx.$slots, _ctx.$slots.toggleicon ? 'toggleicon' : 'togglericon', {
          ...
          "class": _ctx.cx('legendLabel')
        }, _ctx.ptm('legendLabel')), vue.toDisplayString(_ctx.legend), 17)], 16, _hoisted_2)), [[_directive_ripple]]) : vue.createCommentVNode("", true)];
