            ...
            "default": vue.withCtx(function () {
              return [_ctx.inline || $data.overlayVisible ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                ...
                return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
                  ...
                  role: "grid",
                  ref_for: true
                }, _ctx.ptm('dayView')), [vue.createElementVNode("thead", vue.mergeProps({
                  ref_for: true
                }, _ctx.ptm('tableHeader')), [vue.createElementVNode("tr", vue.mergeProps({
                  ref_for: true
                }, _ctx.ptm('tableHeaderRow')), [_ctx.showWeek ? (vue.openBlock(), vue.createElementBlock("th", vue.mergeProps({
                  key: 0,
                  scope: "col",
                ...
                }), 128))], 16)], 16), vue.createElementVNode("tbody", vue.mergeProps({
                  ref_for: true
                }, _ctx.ptm('tableBody')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(month.dates, function (week, i) {
