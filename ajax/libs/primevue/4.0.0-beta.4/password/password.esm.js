...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.maskIcon || _ctx.hideIcon ? 'i' : 'EyeSlashIcon'), mergeProps({
    ...
    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.unmaskIcon || _ctx.showIcon ? 'i' : 'EyeIcon'), mergeProps({
