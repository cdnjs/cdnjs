...
this.primevue.menubar = (function (BarsIcon, utils, BaseComponent, MenubarStyle, AngleDownIcon, AngleRightIcon, Ripple, vue) {
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
      ...
      }, $props.level === 0 ? _ctx.ptm('rootList') : _ctx.ptm('submenu')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.items, function (processedItem, index) {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          ...
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemContent')), [!$props.templates.item ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("a", vue.mergeProps({
          key: 0,
          ...
          "aria-hidden": "true",
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemLink')), [$props.templates.itemicon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.itemicon), {
          key: 0,
          item: processedItem.item,
          ...
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemIcon')), null, 16)) : vue.createCommentVNode("", true), vue.createElementVNode("span", vue.mergeProps({
          id: $options.getItemLabelId(processedItem),
          "class": _ctx.cx('itemLabel'),
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemLabel')), vue.toDisplayString($options.getItemLabel(processedItem)), 17, _hoisted_4), $options.getItemProp(processedItem, 'items') ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
          key: 2
      ...
      methods: {
        ...
        onEnterKey: function onEnterKey(event) {
          if (this.focusedItemInfo.index !== -1) {
            ...
            var anchorElement = element && utils.DomHandler.findSingle(element, 'a[data-pc-section="itemlink"]');
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        ...
        key: 0,
        "class": _ctx.cx('start')
      }, _ctx.ptm('start')), [vue.renderSlot(_ctx.$slots, "start")], 16)) : vue.createCommentVNode("", true), vue.renderSlot(_ctx.$slots, _ctx.$slots.button ? 'button' : 'menubutton', {
        id: $data.id,
        ...
        }, _objectSpread(_objectSpread({}, _ctx.buttonProps), _ctx.ptm('button'))), [vue.renderSlot(_ctx.$slots, _ctx.$slots.buttonicon ? 'buttonicon' : 'menubuttonicon', {}, function () {
          return [vue.createVNode(_component_BarsIcon, vue.normalizeProps(vue.guardReactiveProps(_ctx.ptm('buttonicon'))), null, 16)];
