...
var script$1 = {
  ...
  methods: {
    ...
    onNodeClick: function onNodeClick(event) {
      if (utils.DomHandler.isAttributeEquals(event.target, 'data-pc-section', 'nodetogglebutton') || utils.DomHandler.isAttributeEquals(event.target, 'data-pc-section', 'nodetogglebuttonicon')) {
        return;
      }
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("table", vue.mergeProps({
  ...
  }, $options.getPTOptions('nodeToggleButton')), [$props.templates.togglericon ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.togglericon), vue.mergeProps({
    key: 0,
    expanded: $options.expanded,
    "class": _ctx.cx('nodeToggleButtonIcon')
  }, $options.getPTOptions('nodeToggleButtonIcon')), null, 16, ["expanded", "class"])) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.expanded ? 'ChevronDownIcon' : 'ChevronUpIcon'), vue.mergeProps({
    key: 1,
    "class": _ctx.cx('nodeToggleButtonIcon')
  }, $options.getPTOptions('nodeToggleButtonIcon')), null, 16, ["class"]))], 16)) : vue.createCommentVNode("", true)], 16)], 16, _hoisted_1)], 16)) : vue.createCommentVNode("", true), vue.createElementVNode("tr", vue.mergeProps({
    style: $options.childStyle,
    "class": _ctx.cx('connectors')
  }, _ctx.ptm('connectors')), [vue.createElementVNode("td", vue.mergeProps({
    colspan: $options.colspan
  }, _ctx.ptm('lineCell')), [vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('connectorDown')
  }, _ctx.ptm('connectorDown')), null, 16)], 16, _hoisted_2)], 16), vue.createElementVNode("tr", vue.mergeProps({
    style: $options.childStyle,
    "class": _ctx.cx('connectors')
  }, _ctx.ptm('connectors')), [$props.node.children && $props.node.children.length === 1 ? (vue.openBlock(), vue.createElementBlock("td", vue.mergeProps({
    key: 0,
    colspan: $options.colspan
  }, _ctx.ptm('lineCell')), [vue.createElementVNode("div", vue.mergeProps({
    "class": _ctx.cx('connectorDown')
  }, _ctx.ptm('connectorDown')), null, 16)], 16, _hoisted_3)) : vue.createCommentVNode("", true), $props.node.children && $props.node.children.length > 1 ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
    key: 1
    ...
    return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
      ...
      ref_for: true
    }, $options.getNodeOptions(!(i === 0), 'connectorLeft')), " ", 16), vue.createElementVNode("td", vue.mergeProps({
  ...
  }, _ctx.ptm('nodeChildren')), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($props.node.children, function (child) {
