...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, $options.getPTOptions('itemLabel')), vue.toDisplayString($options.label()), 17)], 16, _hoisted_2$1)), [[_directive_ripple]]) : $props.templates.item ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.item), {
    key: 1,
    item: $props.item,
    label: $options.label(),
        ...
        "default": vue.withCtx(function () {
          return [(_ctx.popup ? $data.overlayVisible : true) ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
            ...
            return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
              ...
              role: "none",
              ref_for: true
            }, _ctx.ptm('submenuItem')), [vue.renderSlot(_ctx.$slots, _ctx.$slots.submenuitem ? 'submenuitem' : 'submenuheader', {
              item: item
            }, function () {
