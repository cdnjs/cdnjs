                      ...
                      (!$props.disabled)
                        ? vue.renderSlot(_ctx.$slots, "removetokenicon", {
                            ...
                            ($props.removeTokenIcon)
                              ...
                              : (vue.openBlock(), vue.createBlock(_component_TimesCircleIcon, {
                                  key: 1,
                                  class: "p-multiselect-token-icon",
                                  onClick: vue.withModifiers($event => ($options.removeOption($event, item)), ["stop"])
                                }, null, 8, ["onClick"]))
      ...
      ($props.loading)
        ? vue.renderSlot(_ctx.$slots, "loadingicon", {
            ...
            ($props.loadingIcon)
              ? (vue.openBlock(), vue.createElementBlock("span", {
                  key: 0,
                  class: vue.normalizeClass(['p-multiselect-trigger-icon pi-spin', $props.loadingIcon]),
                  "aria-hidden": "true"
                }, null, 2))
        ...
        : vue.renderSlot(_ctx.$slots, "dropdownicon", {
            ...
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.dropdownIcon ? 'span' : 'ChevronDownIcon'), {
              class: vue.normalizeClass(['p-multiselect-trigger-icon', $props.dropdownIcon]),
              "aria-hidden": "true"
            }, null, 8, ["class"]))
          ])
    ]),
                          ...
                          ? (vue.openBlock(), vue.createElementBlock("div", {
                              ...
                              vue.createElementVNode("div", {
                                ...
                                vue.renderSlot(_ctx.$slots, "headercheckboxicon", {
                                  ...
                                  (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.checkboxIcon ? 'span' : 'CheckIcon'), {
