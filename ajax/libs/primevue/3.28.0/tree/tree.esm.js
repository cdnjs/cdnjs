...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, normalizeClass, createElementVNode, normalizeStyle, withDirectives, createBlock, resolveDynamicComponent, createCommentVNode, Fragment, createTextVNode, toDisplayString, renderList, renderSlot, vModelText, createVNode } from 'vue';
        ...
        ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
            createElementVNode("div", {
              ...
              ($props.templates['checkboxicon'])
                ...
                : (openBlock(), createBlock(resolveDynamicComponent($options.checked ? 'CheckIcon' : $options.partialChecked ? 'MinusIcon' : null), {
                    key: 1,
                    class: "p-checkbox-icon"
                  }))
            ], 2)
