...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("th", {
    ...
    ($options.isMultiSorted())
      ? (openBlock(), createElementBlock("span", _hoisted_4$1, toDisplayString($options.getMultiSortMetaIndex() + 1), 1))
      : createCommentVNode("", true)
  ], 46, _hoisted_1$3))
}
          ...
          createElementVNode("div", _hoisted_2, [
            renderSlot(_ctx.$slots, "loadingicon", {}, () => [
              (openBlock(), createBlock(resolveDynamicComponent($props.loadingIcon ? 'span' : 'SpinnerIcon'), {
                spin: "",
                class: normalizeClass(['p-treetable-loading-icon', $props.loadingIcon])
              }, null, 8, ["class"]))
            ])
          ])
        ]))
