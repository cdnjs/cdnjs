...
import { resolveDirective, openBlock, createElementBlock, createElementVNode, withDirectives, normalizeClass, createBlock, resolveDynamicComponent, createCommentVNode, Fragment, renderList, mergeProps, normalizeStyle, resolveComponent, createVNode, withCtx, Transition } from 'vue';
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList($props.value, (item, index) => {
            return (openBlock(), createElementBlock("li", {
              ...
              (!$props.templates['indicator'])
                ? (openBlock(), createElementBlock("button", _hoisted_9))
                : createCommentVNode("", true),
              ($props.templates.indicator)
