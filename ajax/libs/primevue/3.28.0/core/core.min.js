...
this.primevue=this.primevue||{},this.primevue.basecomponent=function(t){"use strict";return{name:"BaseComponent",props:{pt:{type:Object,default:void 0}},methods:{getPTItem(e={},s=""){const i=t.ObjectUtils.convertToFlatCase(s);return e[Object.keys(e).find((e=>t.ObjectUtils.convertToFlatCase(e)===i))||""]},getPTValue(e={},s="",i={}){const r=t.ObjectUtils.getItemValue(this.getPTItem(e,s),i),p=this.getPTItem(this.$primevue.config.pt,this.$.type.name);return{...t.ObjectUtils.getItemValue(this.getPTItem(p,s),i),...r}},ptm(t="",e={}){return this.getPTValue(this.pt,t,{props:this.$props,state:this.$data,...e})},ptmo(t={},e="",s={}){return this.getPTValue(t,e,s)}}}}(primevue.utils);
