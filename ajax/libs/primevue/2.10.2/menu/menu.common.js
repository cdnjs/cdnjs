...
var render = function render() {
  ...
  return _c('transition', {
    ...
    }, [_vm._v(_vm._s(_vm.label(item)))]) : _vm._e(), _vm._l(item.items, function (child, j) {
...
/* harmony default export */ var Menuvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    alignOverlay: function alignOverlay() {
      if (this.relativeAlign) DomHandler_DomHandler.relativePosition(this.$refs.container, this.target);else DomHandler_DomHandler.absolutePosition(this.$refs.container, this.target);
    },
...
var Menuvue_type_style_index_0_id_a93d5590_prod_lang_css_ = __webpack_require__("1405");
