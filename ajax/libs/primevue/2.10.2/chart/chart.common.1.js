((typeof self !== 'undefined' ? self : this)["webpackJsonpchart"] = (typeof self !== 'undefined' ? self : this)["webpackJsonpchart"] || []).push([[1],{
...
class chart_esm_Chart {
  constructor(item, config) {
    const me = this;
    this.config = config = new chart_esm_Config(config);
  ...
  _initializePlatform(canvas, config) {
    ...
    return new chart_esm_DomPlatform();
  }
  clear() {
...
class chart_esm_TimeSeriesScale extends chart_esm_TimeScale {
  constructor(props) {
    super(props);
    this._table = [];
...
chart_esm_TimeSeriesScale.id = 'timeseries';
chart_esm_TimeSeriesScale.defaults = chart_esm_TimeScale.defaults;
...
TimeSeriesScale: chart_esm_TimeSeriesScale
});
...
chart_esm_Chart.register(...registerables);

/* harmony default export */ var auto_esm = __webpack_exports__["default"] = (chart_esm_Chart);
