...
this.primevue.splitter = (function (utils, BaseComponent, usestyle, vue) {
    'use strict';
    ...
    var script = {
      ...
      methods: {
        getPTOptions: function getPTOptions() {
          ...
          return {
            context: {
              nested: utils.DomHandler.getAttribute((_this$$parentInstance = this.$parentInstance) === null || _this$$parentInstance === void 0 ? void 0 : _this$$parentInstance.$el, 'data-pc-name') === 'splitterpanel'
            }
          };
        },
        ...
        validateResize: function validateResize(newPrevPanelSize, newNextPanelSize) {
          var prevPanelMinSize = utils.ObjectUtils.getVNodeProp(this.panels[0], 'minSize');
          if (this.panels[0].props && prevPanelMinSize && prevPanelMinSize > newPrevPanelSize) {
            return false;
          }
          var newPanelMinSize = utils.ObjectUtils.getVNodeProp(this.panels[1], 'minSize');
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }), [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.panels, function (panel, i) {
