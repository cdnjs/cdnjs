    ...
    var script$1 = {
      ...
      methods: {
        ...
        position: function position() {
          ...
          var containerOffset = utils.DomHandler.getOffset(this.$refs.container.parentElement);
          var viewport = utils.DomHandler.getViewport();
          var sublistWidth = this.$refs.container.offsetParent ? this.$refs.container.offsetWidth : utils.DomHandler.getHiddenElementOuterWidth(this.$refs.container);
      ...
      return vue.openBlock(), vue.createBlock(vue.Transition, vue.mergeProps({
        ...
        "default": vue.withCtx(function () {
          return [($props.root ? true : $props.visible) ? (vue.openBlock(), vue.createElementBlock("ul", vue.mergeProps({
            ...
            return vue.openBlock(), vue.createElementBlock(vue.Fragment, {
              ...
              "default": vue.withCtx(function (_ref) {
                ...
                return [vue.withDirectives((vue.openBlock(), vue.createElementBlock("a", vue.mergeProps({
                  ...
                  "class": _ctx.cx('label')
                }, $options.getPTOptions('label', processedItem, index)), vue.toDisplayString($options.getItemLabel(processedItem)), 17)], 16, _hoisted_4)), [[_directive_ripple]])];
              }),
              _: 2
            ...
            }, $options.getPTOptions('submenuicon', processedItem, index)), null, 16, ["class"]))], 64)) : vue.createCommentVNode("", true)], 16, _hoisted_5)), [[_directive_ripple]])], 64)) : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.templates.item), {
              key: 1,
              item: processedItem.item,
              label: $options.getItemLabel(processedItem),
              props: $options.getMenuItemProps(processedItem, index)
            }, null, 8, ["item", "label", "props"]))], 16, _hoisted_3), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (vue.openBlock(), vue.createBlock(_component_ContextMenuSub, vue.mergeProps({
              key: 0,
        ...
        "default": vue.withCtx(function () {
          return [vue.createVNode(vue.Transition, vue.mergeProps({
            ...
            "default": vue.withCtx(function () {
              ...
              }, null, 8, ["id", "class", "tabindex", "aria-activedescendant", "menuId", "focusedItemId", "items", "templates", "activeItemPath", "exact", "aria-labelledby", "aria-label", "visible", "pt", "unstyled", "onFocus", "onBlur", "onKeydown", "onItemClick", "onItemMouseenter"])], 16)) : vue.createCommentVNode("", true)];
            }),
            _: 1
