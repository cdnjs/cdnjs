...
this.primevue.carousel = (function (ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, Ripple, utils, vue) {
    'use strict';
            ...
            ($props.showNavigators)
              ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
                  ...
                  vue.renderSlot(_ctx.$slots, "previousicon", {}, () => [
                    (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.isVertical() ? 'ChevronUpIcon' : 'ChevronLeftIcon'), { class: "p-carousel-next-icon" }))
                  ])
                ], 16, _hoisted_3)), [
                  [_directive_ripple]
                ])
            ...
            ($props.showNavigators)
              ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
                  ...
                  vue.renderSlot(_ctx.$slots, "nexticon", {}, () => [
                    (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.isVertical() ? 'ChevronDownIcon' : 'ChevronRightIcon'), { class: "p-carousel-prev-icon" }))
                  ])
                ], 16, _hoisted_5)), [
                  [_directive_ripple]
                ])
...
})(primevue.icons.chevrondown, primevue.icons.chevronleft, primevue.icons.chevronright, primevue.icons.chevronup, primevue.ripple, primevue.utils, Vue);
