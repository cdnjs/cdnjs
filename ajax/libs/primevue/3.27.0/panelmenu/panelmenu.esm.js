...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, renderList, normalizeStyle, normalizeClass, createElementVNode, createBlock, withCtx, withDirectives, resolveDynamicComponent, createCommentVNode, toDisplayString, createVNode, Transition, vShow, renderSlot } from 'vue';
                            ...
                            ($options.isItemGroup(processedItem))
                              ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                                  ($props.templates.submenuicon)
                                    ...
                                    : (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(processedItem) ? 'ChevronDownIcon' : 'ChevronRightIcon'), {
                                        key: 1,
                                        class: "p-submenu-icon"
                                      }))
                                ], 64))
                  ...
                  withDirectives(createElementVNode("div", _hoisted_8$1, [
                    ($options.isItemVisible(processedItem) && $options.isItemGroup(processedItem))
                      ? (openBlock(), createBlock(_component_PanelMenuSub, {
                        ...
                        }, null, 8, ["id", "panelId", "focusedItemId", "items", "level", "templates", "activeItemPath", "exact", "onItemToggle"]))
                      : createCommentVNode("", true)
                  ], 512), [
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_PanelMenuSub, {
    ...
    onItemToggle: $options.onItemToggle
  }, null, 8, ["id", "aria-activedescendant", "panelId", "focusedItemId", "items", "templates", "activeItemPath", "exact", "onFocus", "onBlur", "onKeydown", "onItemToggle"]))
}
                          ...
                          : (openBlock(), createElementBlock("a", {
                              ...
                              ($options.getItemProp(item, 'items'))
                                ? renderSlot(_ctx.$slots, "submenuicon", {
                                    ...
                                    (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(item) ? 'ChevronDownIcon' : 'ChevronRightIcon'), { class: "p-submenu-icon" }))
                                  ])
                                : createCommentVNode("", true),
                              (_ctx.$slots.headericon)
                                ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.headericon), {
                    ...
                    ($options.getItemProp(item, 'items'))
                      ? (openBlock(), createElementBlock("div", _hoisted_9, [
                          createVNode(_component_PanelMenuList, {
                            ...
                            exact: $props.exact
                          }, null, 8, ["panelId", "items", "templates", "expandedKeys", "onItemToggle", "onHeaderFocus", "exact"])
                        ]))
                      : createCommentVNode("", true)
                  ], 8, _hoisted_8), [
