...
this.primevue.panelmenu = (function (ChevronDownIcon, ChevronRightIcon, utils, Ripple, vue) {
    'use strict';
                                ...
                                ($options.isItemGroup(processedItem))
                                  ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                                      ($props.templates.submenuicon)
                                        ...
                                        : (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.isItemActive(processedItem) ? 'ChevronDownIcon' : 'ChevronRightIcon'), {
                                            key: 1,
                                            class: "p-submenu-icon"
                                          }))
                                    ], 64))
                              ...
                              : (vue.openBlock(), vue.createElementBlock("a", {
                                  ...
                                  ($options.getItemProp(item, 'items'))
                                    ? vue.renderSlot(_ctx.$slots, "submenuicon", {
                                        ...
                                        (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($options.isItemActive(item) ? 'ChevronDownIcon' : 'ChevronRightIcon'), { class: "p-submenu-icon" }))
                                      ])
                                    : vue.createCommentVNode("", true),
                                  (_ctx.$slots.headericon)
                                    ? (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(_ctx.$slots.headericon), {
...
})(primevue.icons.chevrondown, primevue.icons.chevronright, primevue.utils, primevue.ripple, Vue);
