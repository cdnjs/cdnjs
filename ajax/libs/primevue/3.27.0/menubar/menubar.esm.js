...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, renderList, normalizeStyle, normalizeClass, createElementVNode, createBlock, withCtx, withDirectives, resolveDynamicComponent, createCommentVNode, toDisplayString, renderSlot, mergeProps, createVNode } from 'vue';
                            ...
                            ($options.getItemProp(processedItem, 'items'))
                              ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                                  ($props.templates.submenuicon)
                                    ...
                                    : (openBlock(), createBlock(resolveDynamicComponent($props.root ? 'AngleDownIcon' : 'AngleRightIcon'), {
                                        key: 1,
                                        class: "p-submenu-icon"
                                      }))
                                ], 64))
