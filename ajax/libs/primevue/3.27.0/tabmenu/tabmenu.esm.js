...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, createElementVNode, Fragment, renderList, createBlock, withCtx, normalizeClass, normalizeStyle, withDirectives, resolveDynamicComponent, createCommentVNode, toDisplayString } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    createElementVNode("ul", {
                    ...
                    ? withDirectives((openBlock(), createElementBlock("a", {
                        ...
                        (_ctx.$slots.itemicon)
                          ...
                          : (item.icon)
                            ...
                            : createCommentVNode("", true),
                        createElementVNode("span", _hoisted_7, toDisplayString($options.label(item)), 1)
                      ], 8, _hoisted_6)), [
                        [_directive_ripple]
                      ])
                    : (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.item), {
      ...
      createElementVNode("li", _hoisted_8, null, 512)
    ], 8, _hoisted_2)
  ]))
}
