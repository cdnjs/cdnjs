...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, renderList, normalizeStyle, normalizeClass, createElementVNode, createBlock, withCtx, withDirectives, resolveDynamicComponent, createCommentVNode, toDisplayString, createVNode, Transition, mergeProps } from 'vue';
                            ...
                            ($options.getItemProp(processedItem, 'items'))
                              ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                                  ($props.templates.submenuicon)
                                    ...
                                    : (openBlock(), createBlock(_component_AngleRightIcon, {
                                        key: 1,
                                        class: "p-submenu-icon"
                                      }))
                                ], 64))
