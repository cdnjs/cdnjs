...
this.primevue.overlaypanel = (function (FocusTrap, TimesIcon, OverlayEventBus, Portal, Ripple, utils, vue) {
    'use strict';
                      ...
                      ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", {
                          ...
                          vue.renderSlot(_ctx.$slots, "closeicon", {}, () => [
                            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.closeIcon ? 'span' : 'TimesIcon'), {
                              class: vue.normalizeClass(['p-overlaypanel-close-icon ', $props.closeIcon])
                            }, null, 8, ["class"]))
                          ])
                        ], 40, _hoisted_2)), [
                          [_directive_ripple]
...
})(primevue.focustrap, primevue.icons.times, primevue.overlayeventbus, primevue.portal, primevue.ripple, primevue.utils, Vue);
