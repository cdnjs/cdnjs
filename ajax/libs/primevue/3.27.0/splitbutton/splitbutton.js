...
this.primevue.splitbutton = (function (Button, ChevronDownIcon, TieredMenu, utils, vue) {
    'use strict';
            ...
            icon: vue.withCtx((slotProps) => [
              vue.renderSlot(_ctx.$slots, "icon", {}, () => [
                vue.createElementVNode("span", {
                  class: vue.normalizeClass([$props.icon, slotProps.class])
                }, null, 2)
              ])
            ]),
            _: 3
        ...
        vue.createVNode(_component_PVSButton, vue.mergeProps({
          ...
          icon: vue.withCtx((slotProps) => [
            vue.renderSlot(_ctx.$slots, "menubuttonicon", {}, () => [
              (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.menuButtonIcon ? 'span' : 'ChevronDownIcon'), {
                class: vue.normalizeClass([$props.menuButtonIcon, slotProps.class])
              }, null, 8, ["class"]))
            ])
          ]),
          _: 3
    ...
    script.__scopeId = "data-v-5a8b8d41";

    return script;

})(primevue.button, primevue.icons.chevrondown, primevue.tieredmenu, primevue.utils, Vue);
