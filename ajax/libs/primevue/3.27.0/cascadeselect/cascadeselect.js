...
this.primevue.cascadeselect = (function (AngleRightIcon, ChevronDownIcon, SpinnerIcon, OverlayEventBus, Portal, utils, Ripple, vue) {
    'use strict';
          ...
          ($props.loading)
            ? vue.renderSlot(_ctx.$slots, "loadingicon", {
                ...
                ($props.loadingIcon)
                  ? (vue.openBlock(), vue.createElementBlock("span", {
                      key: 0,
                      class: vue.normalizeClass(['p-cascadeselect-trigger-icon pi-spin', $props.loadingIcon]),
                      "aria-hidden": "true"
                    }, null, 2))
            ...
            : vue.renderSlot(_ctx.$slots, "dropdownicon", {
                ...
                (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.dropdownIcon ? 'span' : 'ChevronDownIcon'), {
                  class: vue.normalizeClass(['p-cascadeselect-trigger-icon', $props.dropdownIcon]),
                  "aria-hidden": "true"
                }, null, 8, ["class"]))
              ])
        ]),
...
})(primevue.icons.angleright, primevue.icons.chevrondown, primevue.icons.spinner, primevue.overlayeventbus, primevue.portal, primevue.utils, primevue.ripple, Vue);
