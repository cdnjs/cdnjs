...
this.primevue=this.primevue||{},this.primevue.basecomponent=function(t){"use strict";return{name:"BaseComponent",props:{pt:{type:Object,value:{}}},methods:{getPTItem(e={},s=""){const i=t.ObjectUtils.convertToFlatCase(s);return e[Object.keys(e).find((e=>t.ObjectUtils.convertToFlatCase(e)===i))||""]},ptm(e="",s={}){return t.ObjectUtils.getItemValue(this.getPTItem(this.pt,e),{props:this.$props,state:this.$data,...s})},ptmo(e={},s="",i={}){return t.ObjectUtils.getItemValue(this.getPTItem(e,s),i)}}}}(primevue.utils);

this.primevue=this.primevue||{},this.primevue.baseicon=function(e){"use strict";var n={name:"BaseIcon",props:{label:{type:String,value:void 0},spin:{type:Boolean,value:!1}},methods:{pti(){const n=e.ObjectUtils.isEmpty(this.label);return{class:["p-icon",{"p-icon-spin":this.spin}],role:n?void 0:"img","aria-label":n?void 0:this.label,"aria-hidden":n}}}};return function(e,n){void 0===n&&(n={});var t=n.insertAt;if(e&&"undefined"!=typeof document){var i=document.head||document.getElementsByTagName("head")[0],r=document.createElement("style");r.type="text/css","top"===t&&i.firstChild?i.insertBefore(r,i.firstChild):i.appendChild(r),r.styleSheet?r.styleSheet.cssText=e:r.appendChild(document.createTextNode(e))}}("\n.p-icon {\n    display: inline-block;\n}\n.p-icon-spin {\n    -webkit-animation: p-icon-spin 2s infinite linear;\n    animation: p-icon-spin 2s infinite linear;\n}\n@-webkit-keyframes p-icon-spin {\n0% {\n        -webkit-transform: rotate(0deg);\n        transform: rotate(0deg);\n}\n100% {\n        -webkit-transform: rotate(359deg);\n        transform: rotate(359deg);\n}\n}\n@keyframes p-icon-spin {\n0% {\n        -webkit-transform: rotate(0deg);\n        transform: rotate(0deg);\n}\n100% {\n        -webkit-transform: rotate(359deg);\n        transform: rotate(359deg);\n}\n}\n"),n}(primevue.utils);
