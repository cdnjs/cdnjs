...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({ class: $options.contentClasses }, _ctx.ptm('root')), [
    vue.createElementVNode("div", vue.mergeProps({ class: "p-tabview-nav-container" }, _ctx.ptm('navcontainer')), [
      ($props.scrollable && !$data.isPrevButtonDisabled)
        ? vue.withDirectives((vue.openBlock(), vue.createElementBlock("button", vue.mergeProps({
            ...
            vue.renderSlot(_ctx.$slots, "previcon", {}, () => [
              (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.prevIcon ? 'span' : 'ChevronLeftIcon'), vue.mergeProps({
                "aria-hidden": "true",
    ...
    vue.createElementVNode("div", vue.mergeProps({ class: "p-tabview-panels" }, _ctx.ptm('panelcontainer')), [
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList($options.tabs, (tab, i) => {
