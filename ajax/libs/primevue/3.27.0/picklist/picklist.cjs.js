      ...
      vue.createVNode(_component_PLButton, vue.mergeProps({
        ...
        icon: vue.withCtx(() => [
          vue.renderSlot(_ctx.$slots, "movetotargeticon", { viewChanged: $data.viewChanged }, () => [
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($data.viewChanged ? 'AngleDownIcon' : 'AngleRightIcon')))
          ])
        ]),
        _: 3
      ...
      vue.createVNode(_component_PLButton, vue.mergeProps({
        ...
        icon: vue.withCtx(() => [
          vue.renderSlot(_ctx.$slots, "movealltotargeticon", { viewChanged: $data.viewChanged }, () => [
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($data.viewChanged ? 'AngleDoubleDownIcon' : 'AngleDoubleRightIcon')))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
      vue.createVNode(_component_PLButton, vue.mergeProps({
        ...
        icon: vue.withCtx(() => [
          vue.renderSlot(_ctx.$slots, "movetosourceicon", { viewChanged: $data.viewChanged }, () => [
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($data.viewChanged ? 'AngleUpIcon' : 'AngleLeftIcon')))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
      vue.createVNode(_component_PLButton, vue.mergeProps({
        ...
        icon: vue.withCtx(() => [
          vue.renderSlot(_ctx.$slots, "movealltosourceicon", { viewChanged: $data.viewChanged }, () => [
            (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($data.viewChanged ? 'AngleDoubleUpIcon' : 'AngleDoubleLeftIcon')))
          ])
        ]),
        _: 3
      }, 16, ["aria-label", "onClick", "disabled"]),
