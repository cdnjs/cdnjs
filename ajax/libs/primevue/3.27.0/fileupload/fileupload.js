...
this.primevue.fileupload = (function (Button, PlusIcon, TimesIcon, UploadIcon, Message, ProgressBar, Ripple, utils, Badge, vue) {
    'use strict';
              ...
              vue.renderSlot(_ctx.$slots, "header", {
                ...
                vue.withDirectives((vue.openBlock(), vue.createElementBlock("span", {
                  ...
                  vue.renderSlot(_ctx.$slots, "chooseicon", {}, () => [
                    (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.chooseIcon ? 'span' : 'PlusIcon'), {
                      class: vue.normalizeClass(['p-button-icon p-button-icon-left', $props.chooseIcon]),
                      "aria-hidden": "true"
                    }, null, 8, ["class"]))
                  ]),
                  ...
                  ? (vue.openBlock(), vue.createBlock(_component_FileUploadButton, {
                      ...
                      icon: vue.withCtx((iconProps) => [
                        vue.renderSlot(_ctx.$slots, "uploadicon", {}, () => [
                          (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.uploadIcon ? 'span' : 'UploadIcon'), {
                            class: vue.normalizeClass([iconProps.class, $props.uploadIcon]),
                            "aria-hidden": "true"
                          }, null, 8, ["class"]))
                        ])
                      ]),
                      _: 3
                    }, 8, ["label", "onClick", "disabled"]))
                  ...
                  ? (vue.openBlock(), vue.createBlock(_component_FileUploadButton, {
                      ...
                      icon: vue.withCtx((iconProps) => [
                        vue.renderSlot(_ctx.$slots, "cancelicon", {}, () => [
                          (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.cancelIcon ? 'span' : 'TimesIcon'), {
                            class: vue.normalizeClass([iconProps.class, $props.cancelIcon]),
                            "aria-hidden": "true"
                          }, null, 8, ["class"]))
                        ])
                      ]),
              ...
              vue.withDirectives((vue.openBlock(), vue.createElementBlock("span", {
                ...
                (!$options.hasFiles || $props.auto)
                  ? vue.renderSlot(_ctx.$slots, "uploadicon", { key: 0 }, () => [
                      (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent($props.uploadIcon ? 'span' : 'UploadIcon'), {
                        class: vue.normalizeClass(['p-button-icon p-button-icon-left', $props.uploadIcon]),
                        "aria-hidden": "true"
                      }, null, 8, ["class"]))
                    ])
...
})(primevue.button, primevue.icons.plus, primevue.icons.times, primevue.icons.upload, primevue.message, primevue.progressbar, primevue.ripple, primevue.utils, primevue.badge, Vue);
