...
this.primevue.tristatecheckbox = (function (CheckIcon, TimesIcon, vue) {
    'use strict';
    ...
    const _hoisted_4 = /*#__PURE__*/vue.createElementVNode("span", { class: "p-checkbox-icon" }, null, -1);
        ...
        vue.createElementVNode("div", {
          ...
          ($props.modelValue === true)
            ? vue.renderSlot(_ctx.$slots, "checkicon", { key: 0 }, () => [
                (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent('CheckIcon'), { class: "p-checkbox-icon" }))
              ])
            : ($props.modelValue === false)
              ? vue.renderSlot(_ctx.$slots, "uncheckicon", { key: 1 }, () => [
                  (vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent('TimesIcon'), { class: "p-checkbox-icon" }))
                ])
...
})(primevue.icons.check, primevue.icons.times, Vue);
