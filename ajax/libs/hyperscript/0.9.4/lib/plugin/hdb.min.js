export default a=>{function i(t,e,o){this.ctx=t,this.runtime=e,this.cmd=o,this._hyperscript=a,this.cmdMap=[],this.bus=new EventTarget}a.addCommand("breakpoint",function(t,e,o){var n;if(o.matchToken("breakpoint"))return{op:function(t){globalThis.hdb=n=new i(t,e,this);try{return n.break(t)}catch(t){console.error(t,t.stack)}}}}),i.prototype.break=function(o){return console.log("=== HDB///_hyperscript/debugger ==="),this.ui(),new Promise((e,t)=>{this.bus.addEventListener("continue",()=>{if(this.ctx!==o){for(var t in o)delete o[t];Object.assign(o,this.ctx)}delete window.hdb,e(this.runtime.findNext(this.cmd,this.ctx))},{once:!0})})},i.prototype.continueExec=function(){this.bus.dispatchEvent(new Event("continue"))},i.prototype.stepOver=function(){if(!this.cmd)return this.continueExec();var t=this.cmd&&"breakpointCommand"===this.cmd.type?this.runtime.findNext(this.cmd,this.ctx):this.runtime.unifiedEval(this.cmd,this.ctx);return"implicitReturn"===t.type?this.stepOut():t&&t.then instanceof Function?t.then(t=>{this.cmd=t,this.bus.dispatchEvent(new Event("step")),this.logCommand()}):void(t.halt_flag?this.bus.dispatchEvent(new Event("continue")):(this.cmd=t,this.bus.dispatchEvent(new Event("step")),this.logCommand()))},i.prototype.stepOut=function(){if(!this.ctx.meta.caller)return this.continueExec();var t=this.ctx.meta.callingCommand,e=this.ctx.me;this.ctx=this.ctx.meta.caller,console.log("[hdb] stepping out into "+this.ctx.meta.feature.displayName),this.ctx.me instanceof Element&&this.ctx.me!==e&&console.log("[hdb] me: ",this.ctx.me),this.cmd=this.runtime.findNext(t,this.ctx),this.cmd=this.runtime.findNext(this.cmd,this.ctx),this.logCommand(),this.bus.dispatchEvent(new Event("step"))},i.prototype.skipTo=function(t){this.cmd=t.cmd,this.bus.dispatchEvent(new Event("skip"))},i.prototype.rewrite=function(t,e){console.log("##",t);var o=t.cmd.parent;let n;for(n of o.children)if(n.next===t.cmd)break;var i=t.next,r=a.internals.lexer.tokenize(e);const s=a.internals.parser.requireElement("command",r);console.log(s),s.startToken=t.startToken,s.endToken=t.endToken,s.programSource=t.programSource,s.sourceFor=function(){return e},(n.next=s).next=i,s.parent=o,this.bus.dispatchEvent(new Event("step"))},i.prototype.logCommand=function(){var t=this.cmd.sourceFor instanceof Function?this.cmd.sourceFor():"-- "+this.cmd.type;console.log("[hdb] current command: "+t)},i.prototype.traverse=function(t){const n=[];return function t(e){n.push(e);for(const o of e.children)t(n)}(t),n};i.prototype.ui=function(){var t=document.createElement("div"),e=t.attachShadow({mode:"open"});t.style.cssText="all: initial",e.innerHTML=`
<div class="hdb" _="
	...
	* {
	...
	`,document.body.appendChild(t),a.processNode(e.querySelector(".hdb"))}};