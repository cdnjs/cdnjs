import { scaleService, Scale, helpers, defaults, pluginService } from 'chart.js';
...
var defaultConfig = Object.assign({}, scaleService.getScaleDefaults('category'), {
  /**
...
var HierarchicalScale = Scale.extend({
...
var HierarchicalPlugin = {
  ...
  beforeDatasetsDraw: function beforeDatasetsDraw(chart) {
    ...
    var scaleLabelFontColor = helpers.valueOrDefault(scaleLabel.fontColor, defaults.global.defaultFontColor);
...
export { HierarchicalPlugin as HierarchialPlugin, HierarchicalScale as HierarchialScale };
