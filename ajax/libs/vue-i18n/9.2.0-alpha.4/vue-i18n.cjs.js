 ...
 * @VueI18nGeneral
 */
const VERSION = '9.2.0-alpha.4';

const I18nWarnCodes = {
    FALLBACK_TO_ROOT: coreBase.CoreWarnCodes.__EXTEND_POINT__,
    NOT_SUPPORTED_PRESERVE: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 1,
    NOT_SUPPORTED_FORMATTER: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 2,
    NOT_SUPPORTED_PRESERVE_DIRECTIVE: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 3,
    NOT_SUPPORTED_GET_CHOICE_INDEX: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 4,
    COMPONENT_NAME_LEGACY_COMPATIBLE: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 5,
    NOT_FOUND_PARENT_SCOPE: coreBase.CoreWarnCodes.__EXTEND_POINT__ + 6
};
const warnMessages = {
...
const I18nErrorCodes = {
    ...
    UNEXPECTED_RETURN_TYPE: coreBase.CompileErrorCodes.__EXTEND_POINT__,
    // legacy module errors
    INVALID_ARGUMENT: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 1,
    // i18n module errors
    MUST_BE_CALL_SETUP_TOP: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 2,
    NOT_INSLALLED: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 3,
    NOT_AVAILABLE_IN_LEGACY_MODE: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 4,
    // directive module errors
    REQUIRED_VALUE: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 5,
    INVALID_VALUE: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 6,
    // vue-devtools errors
    CANNOT_SETUP_VUE_DEVTOOLS_PLUGIN: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 7,
    // unexpected error
    UNEXPECTED_ERROR: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 8,
    // for enhancement
    __EXTEND_POINT__: coreBase.CompileErrorCodes.__EXTEND_POINT__ + 9
};
...
const Translation = {
    ...
    setup(props, context) {
        ...
        return () => {
            ...
            return shared.isString(props.tag) || shared.isObject(props.tag)
