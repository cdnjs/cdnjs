 ...
 * @internal
 */
const VERSION$1 = '10.0.0-alpha.3';
...
const I18nWarnCodes = {
    ...
    COMPONENT_NAME_LEGACY_COMPATIBLE: inc$1(), // 9
    NOT_FOUND_PARENT_SCOPE: inc$1(), // 10
    IGNORE_OBJ_FLATTEN: inc$1(), // 11
    NOTICE_DROP_TRANSLATE_EXIST_COMPATIBLE_FLAG: inc$1() // 12
};
const warnMessages = {
