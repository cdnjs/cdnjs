...
import type { IsEmptyObject } from '@intlify/core-base';
...
import type { PickupFormatPathKeys } from '@intlify/core-base';
...
declare type RemovedIndexResources<T> = RemoveIndexSignature<{
    [K in keyof T]: T[K];
}>;
