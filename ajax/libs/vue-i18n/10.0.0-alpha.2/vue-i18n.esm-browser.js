...
const CoreWarnCodes = {
    NOT_FOUND_KEY: code$3, // 1
    FALLBACK_TO_TRANSLATE: inc$3(), // 2
    CANNOT_FORMAT_NUMBER: inc$3(), // 3
    FALLBACK_TO_NUMBER_FORMAT: inc$3(), // 4
    CANNOT_FORMAT_DATE: inc$3(), // 5
    FALLBACK_TO_DATE_FORMAT: inc$3(), // 6
    EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER: inc$3(), // 7
    __EXTEND_POINT__: inc$3() // 8
};
/** @internal */
 ...
 * @internal
 */
const VERSION$1 = '10.0.0-alpha.2';
...
const I18nWarnCodes = {
    ...
    NOTICE_DROP_TRANSLATE_EXIST_COMPATIBLE_FLAG: inc$1() // 16
};
const warnMessages = {
