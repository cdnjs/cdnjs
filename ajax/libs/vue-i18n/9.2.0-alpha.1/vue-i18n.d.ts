...
import type { PickupKeys } from '@intlify/core-base';
...
export declare interface Composer<Message = VueMessageType, Messages = {}, DateTimeFormats = {}, NumberFormats = {}, OptionLocale = Locale, ResourceLocales = PickupLocales<NonNullable<Messages>> | PickupLocales<NonNullable<DateTimeFormats>> | PickupLocales<NonNullable<NumberFormats>>, Locales = OptionLocale extends Locale ? [ResourceLocales] extends [never] ? Locale : ResourceLocales : OptionLocale | ResourceLocales> {
     ...
     */
    tm<Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>, Locale extends PickupLocales<NonNullable<Messages>> = PickupLocales<NonNullable<Messages>>, Target = NonNullable<Messages>[Locale], Return = ResourceKeys extends ResourcePath<Target> ? ResourceValue<Target, ResourceKeys> : Record<string, any>>(key: Key | ResourceKeys): Return;
    /**
     * Get locale message
     *
     * @remarks
     ...
     */
    getLocaleMessage<MessageSchema extends LocaleMessage<Message> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<Messages>> = PickupLocales<NonNullable<Messages>>, Return = [MessageSchema] extends [never] ? NonNullable<Messages>[Locale] : MessageSchema>(locale: LocaleSchema | Locale): Return;
    /**
     * Set locale message
     *
     * @remarks
     ...
     * @typeParam MessageSchema - The locale message schema, default `never`
     */
    setLocaleMessage<MessageSchema extends LocaleMessage<Message> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<Messages>> = PickupLocales<NonNullable<Messages>>, Message = [MessageSchema] extends [never] ? NonNullable<Messages>[Locale] : MessageSchema>(locale: LocaleSchema | Locale, message: Message): void;
    /**
     ...
     * @typeParam MessageSchema - The locale message schema, default `never`
     */
    mergeLocaleMessage<MessageSchema extends LocaleMessage<Message> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<Messages>> = PickupLocales<NonNullable<Messages>>, Message = [MessageSchema] extends [never] ? Record<string, any> : MessageSchema>(locale: LocaleSchema | Locale, message: Message): void;
    /**
     * Get datetime format
     *
     * @remarks
     ...
     */
    getDateTimeFormat<DateTimeSchema extends Record<string, any> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<DateTimeFormats>> = PickupLocales<NonNullable<DateTimeFormats>>, Return = [DateTimeSchema] extends [never] ? NonNullable<DateTimeFormats>[Locale] : DateTimeSchema>(locale: LocaleSchema | Locale): Return;
    /**
     * Set datetime format
     *
     * @remarks
     ...
     * @typeParam DateTimeSchema - The datetime format schema, default `never`
     */
    setDateTimeFormat<DateTimeSchema extends Record<string, any> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<DateTimeFormats>> = PickupLocales<NonNullable<DateTimeFormats>>, Formats = [DateTimeSchema] extends [never] ? NonNullable<DateTimeFormats>[Locale] : DateTimeSchema>(locale: LocaleSchema | Locale, format: Formats): void;
    /**
     ...
     * @typeParam DateTimeSchema - The datetime format schema, default `never`
     */
    mergeDateTimeFormat<DateTimeSchema extends Record<string, any> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<DateTimeFormats>> = PickupLocales<NonNullable<DateTimeFormats>>, Formats = [DateTimeSchema] extends [never] ? Record<string, any> : DateTimeSchema>(locale: LocaleSchema | Locale, format: Formats): void;
    /**
     * Get number format
     *
     * @remarks
     ...
     */
    getNumberFormat<NumberSchema extends Record<string, any> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<NumberFormats>> = PickupLocales<NonNullable<NumberFormats>>, Return = [NumberSchema] extends [never] ? NonNullable<NumberFormats>[Locale] : NumberSchema>(locale: LocaleSchema | Locale): Return;
    /**
     * Set number format
     *
     * @remarks
     ...
     * @typeParam NumberSchema - The number format schema, default `never`
     */
    mergeNumberFormat<NumberSchema extends Record<string, any> = never, LocaleSchema extends string = string, Locale extends PickupLocales<NonNullable<NumberFormats>> = PickupLocales<NonNullable<NumberFormats>>, Formats = [NumberSchema] extends [never] ? Record<string, any> : NumberSchema>(locale: LocaleSchema | Locale, format: Formats): void;
    /**
 ...
 * @VueI18nComposition
 */
export declare interface ComposerDateTimeFormatting<DateTimeFormats = {}, Locales = 'en-US'> {
    /**
     * Datetime formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Value extends number | Date | string = number, Key extends string = string, ResourceKeys extends PickupFormatKeys<DateTimeFormats> = PickupFormatKeys<DateTimeFormats>>(value: Value, keyOrOptions: Key | ResourceKeys | DateTimeOptions<Key | ResourceKeys, Locales>): string;
    /**
     * Datetime formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Value extends number | Date | string = number, Key extends string = string, ResourceKeys extends PickupFormatKeys<DateTimeFormats> = PickupFormatKeys<DateTimeFormats>>(value: Value, keyOrOptions: Key | ResourceKeys | DateTimeOptions<Key | ResourceKeys, Locales>, locale: Locales): string;
}
 ...
 * @VueI18nComposition
 */
export declare interface ComposerNumberFormatting<NumberFormats = {}, Locales = 'en-US'> {
    /**
     * Number Formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Key extends string = string, ResourceKeys extends PickupFormatKeys<NumberFormats> = PickupFormatKeys<NumberFormats>>(value: number, keyOrOptions: Key | ResourceKeys | NumberOptions<Key | ResourceKeys, Locales>): string;
    /**
     * Number Formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Key extends string = string, ResourceKeys extends PickupFormatKeys<NumberFormats> = PickupFormatKeys<NumberFormats>>(value: number, keyOrOptions: Key | ResourceKeys | NumberOptions<Key | ResourceKeys, Locales>, locale: Locales): string;
}
 ...
 * @VueI18nComposition
 */
export declare interface ComposerOptions<Message = VueMessageType, Schema extends {
    message?: unknown;
    datetime?: unknown;
    number?: unknown;
} = {
    message: LocaleMessage<Message>;
    datetime: IntlDateTimeFormat;
    number: IntlNumberFormat;
}, Locales extends {
    messages: unknown;
 ...
 * @VueI18nComposition
 */
export declare interface ComposerResolveLocaleMessageTranslation<Message, Locales = 'en-US'> {
    /**
     * Resolve locale message translation
     *
     * @remarks
     ...
     */
    (message: MessageFunction<Message> | Message, plural: number, options?: TranslateOptions<Locales>): string;
    /**
     ...
     */
    (message: MessageFunction<Message> | Message, list: unknown[], options?: TranslateOptions<Locales>): string;
    /**
     ...
     */
    (message: MessageFunction<Message> | Message, named: NamedValue, options?: TranslateOptions<Locales>): string;
}
 ...
 * @VueI18nComposition
 */
export declare interface ComposerTranslation<Messages = {}, Locales = 'en-US'> {
    /**
     * Locale message translation
     *
     * @remarks
     ...
     * @VueI18nSee [Scope and Locale Changing](../guide/essentials/scope)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number): string;
    /**
     ...
     * @VueI18nSee [Pluralization](../guide/essentials/pluralization)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, plural: number, options?: TranslateOptions<Locales>): string;
    /**
     ...
     * @returns Translated message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, defaultMsg: string, options?: TranslateOptions<Locales>): string;
    /**
     ...
     * @VueI18nSee [List interpolation](../guide/essentials/syntax#list-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, list: unknown[], options?: TranslateOptions<Locales>): string;
    /**
     ...
     * @VueI18nSee [List interpolation](../guide/essentials/syntax#list-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, list: unknown[], plural: number): string;
    /**
     ...
     * @VueI18nSee [List interpolation](../guide/essentials/syntax#list-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, list: unknown[], defaultMsg: string): string;
    /**
     ...
     * @VueI18nSee [Named interpolation](../guide/essentials/syntax#named-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, named: NamedValue, options?: TranslateOptions<Locales>): string;
    /**
     ...
     * @VueI18nSee [Named interpolation](../guide/essentials/syntax#named-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys | number, named: NamedValue, plural: number): string;
    /**
     * Locale message translation for named interpolations and plurals
     *
     * @remarks
...
export declare interface CustomLocaleMessage extends LocaleMessage<VueMessageType> {
}
 ...
 * @VueI18nGeneral
 */
export declare interface I18n<Messages = {}, DateTimeFormats = {}, NumberFormats = {}, OptionLocale = Locale, Legacy = true> {
    /**
     * Vue I18n API mode
     *
     * @remarks
     ...
     */
    readonly global: Legacy extends true ? VueI18n<VueMessageType, Messages, DateTimeFormats, NumberFormats, OptionLocale> : Legacy extends false ? Composer<VueMessageType, Messages, DateTimeFormats, NumberFormats, OptionLocale> : unknown;
    /**
     * Install entry point
     *
...
export declare type I18nOptions<Schema extends {
    ...
    datetimeFormats: unknown;
    numberFormats: unknown;
} | string = Locale> = I18nAdditionalOptions & (ComposerOptions<VueMessageType, Schema, Locales> | VueI18nOptions<VueMessageType, Schema, Locales>);
...
export declare function useI18n<Options extends UseI18nOptions = UseI18nOptions, F = keyof CustomLocaleMessage>(options?: Options): Composer<VueMessageType, NonNullable<Options['messages']>, NonNullable<Options['datetimeFormats']>, NonNullable<Options['numberFormats']>, NonNullable<Options['locale']>>;
 ...
 * @VueI18nComposition
 */
export declare function useI18n<Schema = LocaleMessage, Locales = 'en-US', Options extends UseI18nOptions<SchemaParams<Schema, VueMessageType>, LocaleParams<Locales>> = UseI18nOptions<SchemaParams<Schema, VueMessageType>, LocaleParams<Locales>>, F = keyof CustomLocaleMessage>(options?: Options): Composer<VueMessageType, NonNullable<Options['messages']>, NonNullable<Options['datetimeFormats']>, NonNullable<Options['numberFormats']>, NonNullable<Options['locale']>>;
...
export declare type UseI18nOptions<Schema extends {
    ...
    datetimeFormats: unknown;
    numberFormats: unknown;
} | string = Locale> = ComposerAdditionalOptions & ComposerOptions<VueMessageType, Schema, Locales>;
 ...
 *  @VueI18nLegacy
 */
export declare interface VueI18n<Message = VueMessageType, Messages = {}, DateTimeFormats = {}, NumberFormats = {}, OptionLocale = Locale, ResourceLocales = PickupLocales<NonNullable<Messages>> | PickupLocales<NonNullable<DateTimeFormats>> | PickupLocales<NonNullable<NumberFormats>>, Locales = OptionLocale extends string ? [ResourceLocales] extends [never] ? Locale : ResourceLocales : OptionLocale | ResourceLocales, Composition extends Composer<Message, Messages, DateTimeFormats, NumberFormats> = Composer<Message, Messages, DateTimeFormats, NumberFormats>> {
    /**
     * @remarks
     * Instance ID.
     */
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nDateTimeFormatting<DateTimeFormats = {}, Locales = 'en-US'> {
    /**
     * Datetime formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Value extends number | Date = number, Key extends string = string, ResourceKeys extends PickupFormatKeys<DateTimeFormats> = PickupFormatKeys<DateTimeFormats>>(value: Value, key: Key | ResourceKeys): DateTimeFormatResult;
    /**
     * Datetime formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Value extends number | Date = number, Key extends string = string, ResourceKeys extends PickupFormatKeys<DateTimeFormats> = PickupFormatKeys<DateTimeFormats>>(value: Value, key: Key | ResourceKeys, locale: Locales): DateTimeFormatResult;
    /**
     * Datetime formatting
     *
     * @remarks
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nNumberFormatting<NumberFormats = {}, Locales = 'en-US'> {
    /**
     * Number formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Key extends string = string, ResourceKeys extends PickupFormatKeys<NumberFormats> = PickupFormatKeys<NumberFormats>>(value: number, key: Key | ResourceKeys): NumberFormatResult;
    /**
     * Number formatting
     *
     * @remarks
     ...
     * @returns Formatted value
     */
    <Key extends string = string, ResourceKeys extends PickupFormatKeys<NumberFormats> = PickupFormatKeys<NumberFormats>>(value: number, key: Key | ResourceKeys, locale: Locales): NumberFormatResult;
    /**
     * Number formatting
     *
     * @remarks
 ...
 *  @VueI18nLegacy
 */
export declare interface VueI18nOptions<Message = VueMessageType, Schema extends {
    message?: unknown;
    datetime?: unknown;
    number?: unknown;
} = {
    ...
    datetimeFormats: unknown;
    numberFormats: unknown;
} | string = Locale, Options extends ComposerOptions<Message, Schema, Locales> = ComposerOptions<Message, Schema, Locales>> {
    /**
     * @remarks
     * The locale of localization.
     *
 ...
 * @VueI18nLegacy
 */
export declare type VueI18nResolveLocaleMessageTranslation<Message, Locales = 'en-US'> = ComposerResolveLocaleMessageTranslation<Message, Locales>;
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nTranslation<Messages = {}, Locales = 'en-US'> {
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @VueI18nSee [Scope and Locale Changing](../guide/essentials/scope)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys): TranslateResult;
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @returns Translated message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, locale: Locales | Locale): TranslateResult;
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @VueI18nSee [List interpolation](../guide/essentials/syntax#list-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, locale: Locales | Locale, list: unknown[]): TranslateResult;
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @VueI18nSee [Named interpolation](../guide/essentials/syntax#named-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, locale: Locales | Locale, named: Record<string, unknown>): TranslateResult;
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @VueI18nSee [List interpolation](../guide/essentials/syntax#list-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, list: unknown[]): TranslateResult;
    /**
     * Locale message translation.
     *
     * @remarks
     ...
     * @VueI18nSee [Named interpolation](../guide/essentials/syntax#named-interpolation)
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, named: Record<string, unknown>): TranslateResult;
}
 ...
 * @VueI18nLegacy
 */
export declare interface VueI18nTranslationChoice<Messages = {}, Locales = 'en-US'> {
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @VueI18nSee [Pluralization](../guide/essentials/pluralization)
     */
    <Key extends string = string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys): TranslateResult;
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @returns Pluraled message
     */
    <Key extends string = string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, locale: Locales | Locale): TranslateResult;
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @returns Pluraled message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, choice: number): TranslateResult;
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @returns Pluraled message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, choice: number, locale: Locales | Locale): TranslateResult;
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @returns Pluraled message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, choice: number, list: unknown[]): TranslateResult;
    /**
     * Locale message pluralization
     *
     * @remarks
     ...
     * @returns Pluraled message
     */
    <Key extends string, ResourceKeys extends PickupKeys<Messages> = PickupKeys<Messages>>(key: Key | ResourceKeys, choice: number, named: Record<string, unknown>): TranslateResult;
}
