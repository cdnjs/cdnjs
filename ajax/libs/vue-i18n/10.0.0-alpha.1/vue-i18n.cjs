...
const I18nWarnCodes = {
    FALLBACK_TO_ROOT: code$1, // 8
    NOT_SUPPORTED_PRESERVE: inc$1(), // 9
    NOT_SUPPORTED_FORMATTER: inc$1(), // 10
    NOT_SUPPORTED_PRESERVE_DIRECTIVE: inc$1(), // 11
    NOT_SUPPORTED_GET_CHOICE_INDEX: inc$1(), // 12
    COMPONENT_NAME_LEGACY_COMPATIBLE: inc$1(), // 13
    NOT_FOUND_PARENT_SCOPE: inc$1(), // 14
    IGNORE_OBJ_FLATTEN: inc$1(), // 15
    NOTICE_DROP_ALLOW_COMPOSITION: inc$1(), // 16
    NOTICE_DROP_TRANSLATE_EXIST_COMPATIBLE_FLAG: inc$1() // 17
};
const warnMessages = {
