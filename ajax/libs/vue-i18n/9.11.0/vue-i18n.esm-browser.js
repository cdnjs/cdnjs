...
const CoreErrorCodes = {
    INVALID_ARGUMENT: code$2, // 18
    INVALID_DATE_ARGUMENT: inc$2(), // 19
    INVALID_ISO_DATE_ARGUMENT: inc$2(), // 20
    NOT_SUPPORT_NON_STRING_MESSAGE: inc$2(), // 21
    NOT_SUPPORT_LOCALE_PROMISE_VALUE: inc$2(), // 22
    NOT_SUPPORT_LOCALE_ASYNC_FUNCTION: inc$2(), // 23
    NOT_SUPPORT_LOCALE_TYPE: inc$2(), // 24
    __EXTEND_POINT__: inc$2() // 25
};
