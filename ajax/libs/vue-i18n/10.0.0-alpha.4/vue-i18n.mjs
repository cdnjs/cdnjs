/*!
  ...
  */
import { getGlobalThis, incrementer, format, makeSymbol, isObject, isPlainObject, isArray, deepCopy, isString, hasOwn, warn, isBoolean, isRegExp, isFunction, inBrowser, assign, isNumber, warnOnce, createEmitter, isEmptyObject } from '@intlify/shared';
...
const I18nWarnCodes = {
    ...
    NOT_FOUND_PARENT_SCOPE: inc$1(), // 9
    IGNORE_OBJ_FLATTEN: inc$1(), // 10
    DEPRECATE_TC: inc$1(), // 11
    __EXTEND_POINT__: inc$1() // 12
};
const warnMessages = {
