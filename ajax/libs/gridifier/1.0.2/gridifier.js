...
(function(a, b) {
    ...
    e.VerticalGrid.Appender = function(a, b, c, d, f, g, h, i, j) {
        var k = this;
        this._gridifier = null;
        this._settings = null;
        this._sizesResolverManager = null;
        ...
        this._construct = function() {
            ...
            k._connectors = d;
            k._connections = f;
            k._connectorsCleaner = new e.VerticalGrid.ConnectorsCleaner(k._connectors, k._connections, k._settings);
            k._connectorsShifter = new e.ConnectorsShifter(k._gridifier, k._connections, k._settings);
            k._connectorsSelector = new e.VerticalGrid.ConnectorsSelector(k._guid);
            k._connectorsSorter = new e.VerticalGrid.ConnectorsSorter();
            k._itemCoordsExtractor = new e.VerticalGrid.ItemCoordsExtractor(k._gridifier, k._sizesResolverManager);
            k._connectionsIntersector = new e.VerticalGrid.ConnectionsIntersector(k._connections);
        };
        this._bindEvents = function() {};
        this._unbindEvents = function() {};
        this.destruct = function() {
    ...
    e.VerticalGrid.Appender.prototype.append = function(a) {
        this._initConnectors();
        var b = this._createConnectionPerItem(a);
        this._connections.attachConnectionToRanges(b);
    ...
    e.VerticalGrid.Appender.prototype._initConnectors = function() {
        if (this._operation.isInitialOperation(e.OPERATIONS.APPEND)) {
            this.createInitialConnector();
            return;
        }
    ...
    e.VerticalGrid.Appender.prototype.createInitialConnector = function() {
        this._connectors.addAppendConnector(e.Connectors.SIDES.LEFT.TOP, parseFloat(this._gridifier.getGridX2()), 0);
    };
    e.VerticalGrid.Appender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
        var a = a || false;
        if (!a) this._connectors.flush();
        var b = this._connections.get();
        for (var c = 0; c < b.length; c++) {
    ...
    e.VerticalGrid.Appender.prototype._addItemConnectors = function(a, b) {
        if (a.x1 - 1 >= 0) {
            this._connectors.addAppendConnector(e.Connectors.SIDES.LEFT.TOP, parseFloat(a.x1 - 1), parseFloat(a.y1), d.toInt(b));
        }
        this._connectors.addAppendConnector(e.Connectors.SIDES.BOTTOM.RIGHT, parseFloat(a.x2), parseFloat(a.y2 + 1), d.toInt(b));
    };
    e.VerticalGrid.Appender.prototype._createConnectionPerItem = function(a) {
        var b = this._filterConnectorsPerNextConnection();
        var c = this._findItemConnectionCoords(a, b);
        var d = this._connections.add(a, c);
        if (this._settings.isNoIntersectionsStrategy()) {
    ...
    e.VerticalGrid.Appender.prototype._filterConnectorsPerNextConnection = function() {
        var a = this._connectors.getClone();
        this._connectorsSelector.attachConnectors(a);
        this._connectorsSelector.selectOnlySpecifiedSideConnectorsOnPrependedItems(e.Connectors.SIDES.BOTTOM.RIGHT);
        a = this._connectorsSelector.getSelectedConnectors();
        if (this._settings.isDefaultIntersectionStrategy()) {
            this._connectorsShifter.attachConnectors(a);
            this._connectorsShifter.shiftAllConnectors();
            ...
            var b = e.Connectors.SIDES.BOTTOM.RIGHT;
            this._connectorsSelector.attachConnectors(a);
    ...
    e.VerticalGrid.Appender.prototype._findItemConnectionCoords = function(a, b) {
        var c = null;
        for (var d = 0; d < b.length; d++) {
            var f = this._itemCoordsExtractor.connectorToAppendedItemCoords(a, b[d]);
            if (f.x1 < this._normalizer.normalizeLowRounding(0)) {
                continue;
            }
            var g = this._connectionsIntersector.findAllMaybeIntersectableConnectionsOnAppend(b[d]);
            if (this._connectionsIntersector.isIntersectingAnyConnection(g, f)) {
            ...
            c = f;
            var h = this._connections.getAllConnectionsBelowY(f.y2);
            if (this._connections.isAnyConnectionItemGUIDSmallerThan(h, a)) {
                continue;
            }
            if (this._settings.isNoIntersectionsStrategy()) {
        ...
        if (c == null) {
            var i = e.Error.ERROR_TYPES.INSERTER.TOO_WIDE_ITEM_ON_VERTICAL_GRID_INSERT;
            new e.Error(i, a);
        }
        return c;
    };
    e.VerticalGrid.ItemCoordsExtractor = function(a, b) {
        var c = this;
        this._gridifier = null;
        this._sizesResolverManager = null;
        this._transformedItemMarker = null;
    ...
    e.VerticalGrid.ItemCoordsExtractor.prototype._getItemSizesPerAppend = function(a) {
        if (this._transformedItemMarker.isTransformedItem(a)) {
            var b = this._transformedItemMarker.getTransformedItemTargetPxSizes(a);
            return {
                targetWidth: parseFloat(b.targetPxWidth),
    ...
    e.VerticalGrid.ItemCoordsExtractor.prototype.getItemTargetSizes = function(a) {
        return this._getItemSizesPerAppend(a);
    };
    e.VerticalGrid.ItemCoordsExtractor.prototype.connectorToAppendedItemCoords = function(a, b) {
        var c = this._getItemSizesPerAppend(a);
        return {
            x1: parseFloat(b.x - c.targetWidth + 1),
            x2: parseFloat(b.x),
    ...
    e.VerticalGrid.ItemCoordsExtractor.prototype.connectorToReversedAppendedItemCoords = function(a, b) {
        var c = this._getItemSizesPerAppend(a);
        return {
            x1: parseFloat(b.x),
            x2: parseFloat(b.x + c.targetWidth - 1),
    ...
    e.VerticalGrid.ItemCoordsExtractor.prototype.connectorToPrependedItemCoords = function(a, b) {
        var c = this._getItemSizesPerAppend(a);
        return {
            x1: parseFloat(b.x),
            x2: parseFloat(b.x + c.targetWidth - 1),
    ...
    e.VerticalGrid.ItemCoordsExtractor.prototype.connectorToReversedPrependedItemCoords = function(a, b) {
        var c = this._getItemSizesPerAppend(a);
        return {
            x1: parseFloat(b.x - c.targetWidth + 1),
            x2: parseFloat(b.x),
    ...
    e.VerticalGrid.Prepender = function(a, b, c, d, f, g, h, i, j) {
        var k = this;
        this._gridifier = null;
        this._settings = null;
        this._sizesResolverManager = null;
    ...
    e.VerticalGrid.Prepender.prototype.prepend = function(a) {
        this._initConnectors();
        var b = this._createConnectionPerItem(a);
    ...
    e.VerticalGrid.Prepender.prototype._initConnectors = function() {
        if (this._operation.isInitialOperation(e.OPERATIONS.PREPEND)) {
            this.createInitialConnector();
            return;
        }
    ...
    e.VerticalGrid.Prepender.prototype.createInitialConnector = function() {
        this._connectors.addPrependConnector(e.Connectors.SIDES.RIGHT.BOTTOM, 0, 0);
    };
    e.VerticalGrid.Prepender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
        var a = a || false;
        if (!a) this._connectors.flush();
        var b = this._connections.get();
        for (var c = 0; c < b.length; c++) {
    ...
    e.VerticalGrid.Prepender.prototype._addItemConnectors = function(a, b) {
        if (a.x2 + 1 <= this._gridifier.getGridX2()) {
            this._connectors.addPrependConnector(e.Connectors.SIDES.RIGHT.BOTTOM, parseFloat(a.x2 + 1), parseFloat(a.y2), d.toInt(b));
        }
        this._connectors.addPrependConnector(e.Connectors.SIDES.TOP.LEFT, parseFloat(a.x1), parseFloat(a.y1 - 1), d.toInt(b));
    };
    e.VerticalGrid.Prepender.prototype._createConnectionPerItem = function(a) {
        var b = this._filterConnectorsPerNextConnection();
        var c = this._findItemConnectionCoords(a, b);
        var d = this._connections.add(a, c);
        if (this._settings.isNoIntersectionsStrategy()) {
    ...
    e.VerticalGrid.Prepender.prototype._filterConnectorsPerNextConnection = function() {
        var a = this._connectors.getClone();
        this._connectorsSelector.attachConnectors(a);
        this._connectorsSelector.selectOnlySpecifiedSideConnectorsOnAppendedItems(e.Connectors.SIDES.TOP.LEFT);
        a = this._connectorsSelector.getSelectedConnectors();
        if (this._settings.isDefaultIntersectionStrategy()) {
            this._connectorsShifter.attachConnectors(a);
            this._connectorsShifter.shiftAllConnectors();
            ...
            var b = e.Connectors.SIDES.TOP.LEFT;
            this._connectorsSelector.attachConnectors(a);
    ...
    e.VerticalGrid.Prepender.prototype._findItemConnectionCoords = function(a, b) {
        var c = null;
        for (var d = 0; d < b.length; d++) {
            var f = this._itemCoordsExtractor.connectorToPrependedItemCoords(a, b[d]);
            if (f.x2 > this._normalizer.normalizeHighRounding(this._gridifier.getGridX2())) {
                continue;
            }
            var g = this._connectionsIntersector.findAllMaybeIntersectableConnectionsOnPrepend(b[d]);
            if (this._connectionsIntersector.isIntersectingAnyConnection(g, f)) {
            ...
            c = f;
            var h = this._connections.getAllConnectionsAboveY(f.y1);
            if (this._connections.isAnyConnectionItemGUIDBiggerThan(h, a)) {
                continue;
            }
            if (this._settings.isNoIntersectionsStrategy()) {
    ...
    e.VerticalGrid.ReversedAppender = function(a, b, c, d, f, g, h, i, j) {
        var k = this;
        this._gridifier = null;
        this._settings = null;
        this._sizesResolverManager = null;
    ...
    e.VerticalGrid.ReversedAppender.prototype.reversedAppend = function(a) {
        this._initConnectors();
        var b = this._createConnectionPerItem(a);
        this._connections.attachConnectionToRanges(b);
        this._connectorsCleaner.deleteAllTooHighConnectorsFromMostBottomConnector();
    ...
    e.VerticalGrid.ReversedAppender.prototype._initConnectors = function() {
        if (this._operation.isInitialOperation(e.OPERATIONS.REVERSED_APPEND)) {
            this.createInitialConnector();
            return;
        }
    ...
    e.VerticalGrid.ReversedAppender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
        var a = a || false;
        if (!a) this._connectors.flush();
        var b = this._connections.get();
        for (var c = 0; c < b.length; c++) {
    ...
    e.VerticalGrid.ReversedAppender.prototype._addItemConnectors = function(a, b) {
        if (a.x2 + 1 <= this._gridifier.getGridX2()) {
            this._connectors.addAppendConnector(e.Connectors.SIDES.RIGHT.TOP, parseFloat(a.x2 + 1), parseFloat(a.y1), d.toInt(b));
        }
        this._connectors.addAppendConnector(e.Connectors.SIDES.BOTTOM.LEFT, parseFloat(a.x1), parseFloat(a.y2 + 1), d.toInt(b));
    };
    e.VerticalGrid.ReversedAppender.prototype._createConnectionPerItem = function(a) {
        var b = this._filterConnectorsPerNextConnection();
        var c = this._findItemConnectionCoords(a, b);
        var d = this._connections.add(a, c);
        if (this._settings.isNoIntersectionsStrategy()) {
    ...
    e.VerticalGrid.ReversedAppender.prototype._filterConnectorsPerNextConnection = function() {
        var a = this._connectors.getClone();
        this._connectorsSelector.attachConnectors(a);
        this._connectorsSelector.selectOnlySpecifiedSideConnectorsOnPrependedItems(e.Connectors.SIDES.BOTTOM.LEFT);
        a = this._connectorsSelector.getSelectedConnectors();
        if (this._settings.isDefaultIntersectionStrategy()) {
            this._connectorsShifter.attachConnectors(a);
            this._connectorsShifter.shiftAllConnectors();
            ...
            var b = e.Connectors.SIDES.BOTTOM.LEFT;
            this._connectorsSelector.attachConnectors(a);
            this._connectorsSelector.selectOnlyMostBottomConnectorFromSide(b);
            a = this._connectorsSelector.getSelectedConnectors();
            this._connectorsShifter.attachConnectors(a);
    ...
    e.VerticalGrid.ReversedAppender.prototype._findItemConnectionCoords = function(a, b) {
        var c = null;
        for (var d = 0; d < b.length; d++) {
            var f = this._itemCoordsExtractor.connectorToReversedAppendedItemCoords(a, b[d]);
            if (f.x2 > this._normalizer.normalizeHighRounding(this._gridifier.getGridX2())) {
    ...
    e.VerticalGrid.ReversedPrepender = function(a, b, c, d, f, g, h, i, j) {
        var k = this;
        this._gridifier = null;
        this._settings = null;
        this._sizesResolverManager = null;
    ...
    e.VerticalGrid.ReversedPrepender.prototype.reversedPrepend = function(a) {
        this._initConnectors();
        var b = this._createConnectionPerItem(a);
        var c = this._connections.normalizeVerticalPositionsOfAllConnectionsAfterPrepend(b, this._connectors.get());
        this._connections.attachConnectionToRanges(b);
    ...
    e.VerticalGrid.ReversedPrepender.prototype._initConnectors = function() {
        if (this._operation.isInitialOperation(e.OPERATIONS.REVERSED_PREPEND)) {
            this.createInitialConnector();
            return;
        }
    ...
    e.VerticalGrid.ReversedPrepender.prototype.createInitialConnector = function() {
        this._connectors.addPrependConnector(e.Connectors.SIDES.LEFT.BOTTOM, this._gridifier.getGridX2(), 0);
    };
    e.VerticalGrid.ReversedPrepender.prototype.recreateConnectorsPerAllConnectedItems = function(a) {
        var a = a || false;
        if (!a) this._connectors.flush();
        var b = this._connections.get();
        for (var c = 0; c < b.length; c++) {
    ...
    e.VerticalGrid.ReversedPrepender.prototype._addItemConnectors = function(a, b) {
        if (a.x1 - 1 >= 0) {
            this._connectors.addPrependConnector(e.Connectors.SIDES.LEFT.BOTTOM, parseFloat(a.x1 - 1), parseFloat(a.y2), d.toInt(b));
        }
        this._connectors.addPrependConnector(e.Connectors.SIDES.TOP.RIGHT, parseFloat(a.x2), parseFloat(a.y1 - 1), d.toInt(b));
    };
    e.VerticalGrid.ReversedPrepender.prototype._createConnectionPerItem = function(a) {
        var b = this._filterConnectorsPerNextConnection();
        var c = this._findItemConnectionCoords(a, b);
        var d = this._connections.add(a, c);
        if (this._settings.isNoIntersectionsStrategy()) {
    ...
    e.VerticalGrid.ReversedPrepender.prototype._filterConnectorsPerNextConnection = function() {
        var a = this._connectors.getClone();
        this._connectorsSelector.attachConnectors(a);
        this._connectorsSelector.selectOnlySpecifiedSideConnectorsOnAppendedItems(e.Connectors.SIDES.TOP.RIGHT);
        a = this._connectorsSelector.getSelectedConnectors();
        if (this._settings.isDefaultIntersectionStrategy()) {
            this._connectorsShifter.attachConnectors(a);
            this._connectorsShifter.shiftAllConnectors();
            ...
            var b = e.Connectors.SIDES.TOP.RIGHT;
            this._connectorsSelector.attachConnectors(a);
            this._connectorsSelector.selectOnlyMostTopConnectorFromSide(b);
            a = this._connectorsSelector.getSelectedConnectors();
            this._connectorsShifter.attachConnectors(a);
    ...
    e.VerticalGrid.ReversedPrepender.prototype._findItemConnectionCoords = function(a, b) {
        var c = null;
        for (var d = 0; d < b.length; d++) {
            var f = this._itemCoordsExtractor.connectorToReversedPrependedItemCoords(a, b[d]);
            if (f.x1 < this._normalizer.normalizeLowRounding(0)) {
    ...
    e.VerticalGrid.Connections = function(a, b, c, d, f) {
        var g = this;
        this._gridifier = null;
        this._guid = null;
        this._settings = null;
        ...
        this._construct = function() {
            ...
            g._sizesResolverManager = d;
            g._eventEmitter = f;
            g._ranges = new e.VerticalGrid.ConnectionsRanges(g);
            g._ranges.init();
            g._sorter = new e.VerticalGrid.ConnectionsSorter(g, g._settings, g._guid);
            g._itemCoordsExtractor = new e.VerticalGrid.ItemCoordsExtractor(g._gridifier, g._sizesResolverManager);
            g._connectionsCore = new e.Connections(g._gridifier, g, g._guid, g._sorter, g._sizesResolverManager);
            g._connectionsVerticalIntersector = new e.VerticalGrid.ConnectionsVerticalIntersector(g, g._settings, g._itemCoordsExtractor);
        };
        this._bindEvents = function() {};
        this._unbindEvents = function() {};
        this.destruct = function() {
    ...
    e.VerticalGrid.Connections.prototype.getConnectionsSorter = function() {
        return this._sorter;
    };
    e.VerticalGrid.Connections.prototype.setSizesTransformerInstance = function(a) {
        this._sizesTransformer = a;
        this._connectionsCore.setSizesTransformerInstance(a);
    };
    e.VerticalGrid.Connections.prototype.attachConnectionToRanges = function(a) {
        this._ranges.attachConnection(a, this._connections.length - 1);
    };
    e.VerticalGrid.Connections.prototype.reinitRanges = function() {
        this._ranges.init();
    };
    e.VerticalGrid.Connections.prototype.getAllHorizontallyIntersectedAndUpperConnections = function(a) {
        return this._ranges.getAllConnectionsFromIntersectedAndUpperRanges(a.y);
    };
    e.VerticalGrid.Connections.prototype.getAllHorizontallyIntersectedConnections = function(a) {
        return this._ranges.getAllConnectionsFromIntersectedRange(a.y);
    };
    e.VerticalGrid.Connections.prototype.getAllHorizontallyIntersectedAndLowerConnections = function(a) {
        return this._ranges.getAllConnectionsFromIntersectedAndLowerRanges(a.y);
    };
    e.VerticalGrid.Connections.prototype.mapAllIntersectedAndLowerConnectionsPerEachConnector = function(a) {
        return this._ranges.mapAllIntersectedAndLowerConnectionsPerEachConnector(a);
    };
    e.VerticalGrid.Connections.prototype.mapAllIntersectedAndUpperConnectionsPerEachConnector = function(a) {
        return this._ranges.mapAllIntersectedAndUpperConnectionsPerEachConnector(a);
    };
    e.VerticalGrid.Connections.prototype.getLastRowVerticallyExpandedConnections = function() {
        return this._connectionsVerticalIntersector.getLastRowVerticallyExpandedConnections();
    };
    e.VerticalGrid.Connections.prototype.get = function() {
        return this._connections;
    };
    e.VerticalGrid.Connections.prototype.count = function() {
        return this._connections.length;
    };
    e.VerticalGrid.Connections.prototype.restore = function(a) {
        this._connections = this._connections.concat(a);
    };
    e.VerticalGrid.Connections.prototype.restoreOnCustomSortDispersionMode = function(a) {
        var b = this._sorter.sortConnectionsPerReappend(this._connections);
        var c = b[b.length - 1];
        if (this._settings.isDefaultAppend()) {
            var d = c.x1;
    ...
    e.VerticalGrid.Connections.prototype.getMaxX2 = function() {
        return this._connectionsCore.getMaxX2();
    };
    e.VerticalGrid.Connections.prototype.getMaxY2 = function() {
        return this._connectionsCore.getMaxY2();
    };
    e.VerticalGrid.Connections.prototype.findConnectionByItem = function(a, b) {
        var c = b || false;
        return this._connectionsCore.findConnectionByItem(a, b);
    };
    e.VerticalGrid.Connections.prototype.remapAllItemGUIDS = function() {
        this._connectionsCore.remapAllItemGUIDS();
    };
    e.VerticalGrid.Connections.prototype.remapAllItemGUIDSInSortedConnections = function(a) {
        this._connectionsCore.remapAllItemGUIDSInSortedConnections(a);
    };
    e.VerticalGrid.Connections.prototype.add = function(a, b) {
        var c = this._connectionsCore.createItemConnection(a, b);
        this._connections.push(c);
        this._eventEmitter.emitConnectionCreateEvent(this);
        return c;
    };
    e.VerticalGrid.Connections.prototype.removeConnection = function(a) {
        for (var b = 0; b < this._connections.length; b++) {
            if (this._guid.getItemGUID(a.item) == this._guid.getItemGUID(this._connections[b].item)) {
                this._connections.splice(b, 1);
                return;
    ...
    e.VerticalGrid.Connections.prototype.getConnectionsByItemGUIDS = function(a) {
        return this._connectionsCore.getConnectionsByItemGUIDS(a);
    };
    e.VerticalGrid.Connections.prototype.syncConnectionParams = function(a) {
        this._connectionsCore.syncConnectionParams(a);
    };
    e.VerticalGrid.Connections.prototype.getMinConnectionWidth = function() {
        return this._connectionsCore.getMinConnectionWidth();
    };
    e.VerticalGrid.Connections.prototype.getMinConnectionHeight = function() {
        return this._connectionsCore.getMinConnectionHeight();
    };
    e.VerticalGrid.Connections.prototype.isAnyConnectionItemGUIDSmallerThan = function(a, b) {
        return this._connectionsCore.isAnyConnectionItemGUIDSmallerThan(a, b);
    };
    e.VerticalGrid.Connections.prototype.isAnyConnectionItemGUIDBiggerThan = function(a, b) {
        return this._connectionsCore.isAnyConnectionItemGUIDBiggerThan(a, b);
    };
    e.VerticalGrid.Connections.prototype.getAllConnectionsBelowY = function(a) {
        var b = [];
        for (var c = 0; c < this._connections.length; c++) {
            if (this._settings.isDisabledSortDispersion()) {
    ...
    e.VerticalGrid.Connections.prototype.getAllConnectionsAboveY = function(a) {
        var b = [];
        for (var c = 0; c < this._connections.length; c++) {
            if (this._settings.isDisabledSortDispersion()) {
    ...
    e.VerticalGrid.Connections.prototype.getMaxYFromAllConnections = function() {
        var a = 0;
        for (var b = 0; b < this._connections.length; b++) {
            if (this._connections[b].y2 > a) a = this._connections[b].y2;
        }
    ...
    e.VerticalGrid.Connections.prototype.isIntersectingMoreThanOneConnectionItemVertically = function(a) {
        return this._connectionsVerticalIntersector.isIntersectingMoreThanOneConnectionItemVertically(a);
    };
    e.VerticalGrid.Connections.prototype.getMostTallFromAllVerticallyIntersectedConnections = function(a) {
        return this._connectionsVerticalIntersector.getMostTallFromAllVerticallyIntersectedConnections(a);
    };
    e.VerticalGrid.Connections.prototype.getAllVerticallyIntersectedConnections = function(a) {
        return this._connectionsVerticalIntersector.getAllVerticallyIntersectedConnections(a);
    };
    e.VerticalGrid.Connections.prototype.expandVerticallyAllRowConnectionsToMostTall = function(a) {
        this._connectionsVerticalIntersector.expandVerticallyAllRowConnectionsToMostTall(a);
    };
    e.VerticalGrid.Connections.prototype.normalizeVerticalPositionsOfAllConnectionsAfterPrepend = function(a, b) {
    ...
    e.VerticalGrid.ConnectionsVerticalIntersector = function(a, b, c) {
        var d = this;
        this._connections = null;
        this._settings = null;
        this._itemCoordsExtractor = null;
    ...
    e.VerticalGrid.ConnectionsVerticalIntersector.prototype.getLastRowVerticallyExpandedConnections = function() {
        return this._lastRowVerticallyExpandedConnections;
    };
    e.VerticalGrid.ConnectionsVerticalIntersector.prototype.isIntersectingMoreThanOneConnectionItemVertically = function(a) {
        var b = this;
        var c = this._connections.get();
        var d = [];
        var e = function(a) {
    ...
    e.VerticalGrid.ConnectionsVerticalIntersector.prototype.getMostTallFromAllVerticallyIntersectedConnections = function(a) {
        var b = this;
        var c = this._connections.get();
        var d = null;
        for (var e = 0; e < c.length; e++) {
    ...
    e.VerticalGrid.ConnectionsVerticalIntersector.prototype.getAllVerticallyIntersectedConnections = function(a) {
        var b = this;
        var c = this._connections.get();
        var d = [];
        for (var e = 0; e < c.length; e++) {
    ...
    e.VerticalGrid.ConnectionsVerticalIntersector.prototype.expandVerticallyAllRowConnectionsToMostTall = function(a) {
    ...
    e.VerticalGrid.ConnectionsIntersector = function(a) {
        var b = this;
        this._connections = null;
        this._intersectorCore = null;
        this._css = {};
    ...
    e.VerticalGrid.ConnectionsIntersector.prototype.isIntersectingAnyConnection = function(a, b) {
        return this._intersectorCore.isIntersectingAnyConnection(a, b);
    };
    e.VerticalGrid.ConnectionsIntersector.prototype.getAllConnectionsWithIntersectedCenter = function(a) {
        return this._intersectorCore.getAllConnectionsWithIntersectedCenter(a);
    };
    e.VerticalGrid.ConnectionsIntersector.prototype.findAllMaybeIntersectableConnectionsOnAppend = function(a) {
        var b = this._connections.get();
        var c = [];
        for (var d = 0; d < b.length; d++) {
    ...
    e.VerticalGrid.ConnectionsIntersector.prototype.findAllMaybeIntersectableConnectionsOnPrepend = function(a) {
        var b = this._connections.get();
        var c = [];
        for (var d = 0; d < b.length; d++) {
    ...
    e.VerticalGrid.ConnectionsRanges = function(a) {
        var b = this;
        this._connections = null;
        this._ranges = null;
        this._css = {};
    ...
    e.VerticalGrid.ConnectionsRanges.RANGE_PX_HEIGHT = 500;
    e.VerticalGrid.ConnectionsRanges.prototype.init = function() {
        this._ranges = [];
        this._ranges.push({
            y1: -1,
            y2: e.VerticalGrid.ConnectionsRanges.RANGE_PX_HEIGHT,
            connectionIndexes: []
        });
        this._attachAllConnections();
    };
    e.VerticalGrid.ConnectionsRanges.prototype.shiftAllRangesBy = function(a) {
        for (var b = 0; b < this._ranges.length; b++) {
            this._ranges[b].y1 += a;
            this._ranges[b].y2 += a;
        }
    };
    e.VerticalGrid.ConnectionsRanges.prototype.createPrependedRange = function(a, b) {
        this._ranges.unshift({
            y1: -1,
            y2: b,
            connectionIndexes: []
    ...
    e.VerticalGrid.ConnectionsRanges.prototype._createNextRange = function() {
        var a = this._ranges[this._ranges.length - 1].y2 + 1;
        this._ranges.push({
            y1: a,
            y2: a + e.VerticalGrid.ConnectionsRanges.RANGE_PX_HEIGHT,
            connectionIndexes: []
        });
    };
    e.VerticalGrid.ConnectionsRanges.prototype.attachConnection = function(a, b) {
    ...
    e.VerticalGrid.ConnectionsRanges.prototype._attachAllConnections = function() {
        var a = this._connections.get();
        for (var b = 0; b < a.length; b++) this.attachConnection(a[b], b);
    };
    e.VerticalGrid.ConnectionsRanges.prototype.mapAllIntersectedAndUpperConnectionsPerEachConnector = function(a) {
        var b = this._ranges.length - 1;
        var c = [];
        for (var d = 0; d < a.length; d++) {
            var e = false;
    ...
    e.VerticalGrid.ConnectionsRanges.prototype.getAllConnectionsFromIntersectedAndLowerRanges = function(a) {
        var b = [];
        var c = null;
        for (var d = 0; d < this._ranges.length; d++) {
    ...
    e.VerticalGrid.ConnectionsRanges.prototype.mapAllIntersectedAndLowerConnectionsPerEachConnector = function(a) {
        var b = 0;
        var c = [];
        for (var d = 0; d < a.length; d++) {
            var e = false;
    ...
    e.VerticalGrid.ConnectionsRanges.prototype.getAllConnectionsFromIntersectedRange = function(a) {
        for (var b = 0; b < this._ranges.length; b++) {
    ...
    e.VerticalGrid.ConnectionsRanges.prototype.getAllConnectionsFromIntersectedAndUpperRanges = function(a) {
        var b = [];
        var c = null;
        for (var d = this._ranges.length - 1; d >= 0; d--) {
            if (a >= this._ranges[d].y1 && a <= this._ranges[d].y2) {
    ...
    e.VerticalGrid.ConnectionsSorter = function(a, b, c) {
        var d = this;
        this._connections = null;
        this._settings = null;
        this._guid = null;
    ...
    e.VerticalGrid.ConnectionsSorter.prototype.sortConnectionsPerReappend = function(a) {
        var b = this;
        if (this._settings.isDisabledSortDispersion()) {
            a.sort(function(a, c) {
                if (b._guid.getItemGUID(a.item) > b._guid.getItemGUID(c.item)) return 1;
    ...
    e.VerticalGrid.ConnectorsCleaner = function(a, b, c) {
        var d = this;
        this._connectors = null;
        this._connections = null;
        this._settings = null;
    ...
    e.VerticalGrid.ConnectorsCleaner.CONNECTION_ITEM_INTERSECTION_STRATEGIES = {
        CONNECTOR_INSIDE_CONNECTION_ITEM: 0,
        CONNECTOR_INSIDE_OR_BEFORE_CONNECTION_ITEM: 1
    };
    e.VerticalGrid.ConnectorsCleaner.MAX_VALID_VERTICAL_DISTANCE = {
        FROM_MOST_BOTTOM_CONNECTOR: 3e3,
        FROM_MOST_TOP_CONNECTOR: 3e3
    };
    e.VerticalGrid.ConnectorsCleaner.prototype.setConnectorInsideItemIntersectionStrategy = function() {
        var a = e.VerticalGrid.ConnectorsCleaner.CONNECTION_ITEM_INTERSECTION_STRATEGIES;
        this._connectionItemIntersectionStrategy = a.CONNECTOR_INSIDE_CONNECTION_ITEM;
    };
    e.VerticalGrid.ConnectorsCleaner.prototype.setConnectorInsideOrBeforeItemIntersectionStrategy = function() {
        var a = e.VerticalGrid.ConnectorsCleaner.CONNECTION_ITEM_INTERSECTION_STRATEGIES;
        this._connectionItemIntersectionStrategy = a.CONNECTOR_INSIDE_OR_BEFORE_CONNECTION_ITEM;
    };
    e.VerticalGrid.ConnectorsCleaner.prototype._updateConnectorIntersectionStrategy = function() {
        if (this._settings.isDisabledSortDispersion()) {
            this.setConnectorInsideOrBeforeItemIntersectionStrategy();
        } else if (this._settings.isCustomSortDispersion() || this._settings.isCustomAllEmptySpaceSortDispersion()) {
            this.setConnectorInsideItemIntersectionStrategy();
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype.isConnectorInsideItemIntersectionStrategy = function() {
        this._updateConnectorIntersectionStrategy();
        var a = e.VerticalGrid.ConnectorsCleaner.CONNECTION_ITEM_INTERSECTION_STRATEGIES;
        return this._connectionItemIntersectionStrategy == a.CONNECTOR_INSIDE_CONNECTION_ITEM;
    };
    e.VerticalGrid.ConnectorsCleaner.prototype.isConnectorInsideOrBeforeItemIntersectionStrategy = function() {
        this._updateConnectorIntersectionStrategy();
        var a = e.VerticalGrid.ConnectorsCleaner.CONNECTION_ITEM_INTERSECTION_STRATEGIES;
        return this._connectionItemIntersectionStrategy == a.CONNECTOR_INSIDE_OR_BEFORE_CONNECTION_ITEM;
    };
    e.VerticalGrid.ConnectorsCleaner.prototype._isMappedConnectorIntersectingAnyTopConnectionItem = function(a) {
        var b = this._connections.get();
        for (var c = 0; c < a.connectionIndexes.length; c++) {
            for (var d = 0; d < a.connectionIndexes[c].length; d++) {
                var e = b[a.connectionIndexes[c][d]];
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype.deleteAllIntersectedFromTopConnectors = function() {
        var a = this._connectors.get();
        var b = this._connectors.getClone();
        b.sort(function(a, b) {
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype.deleteAllTooLowConnectorsFromMostTopConnector = function() {
        var a = this._connectors.get();
        if (a.length == 0) return;
        var b = a[0];
        for (var c = 1; c < a.length; c++) {
        ...
        var d = e.VerticalGrid.ConnectorsCleaner;
        var f = b.y + this._settings.getMaxInsertionRange();
        for (var c = 0; c < a.length; c++) {
            if (a[c].y > f) {
                a.splice(c, 1);
                c--;
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype._isMappedConnectorIntersectingAnyBottomConnectionItem = function(a) {
        var b = this._connections.get();
        for (var c = 0; c < a.connectionIndexes.length; c++) {
            for (var d = 0; d < a.connectionIndexes[c].length; d++) {
                var e = b[a.connectionIndexes[c][d]];
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype.deleteAllIntersectedFromBottomConnectors = function() {
        var a = this._connectors.get();
        var b = this._connectors.getClone();
        b.sort(function(a, b) {
            if (a.y == b.y) return 0; else if (a.y < b.y) return -1; else return 1;
    ...
    e.VerticalGrid.ConnectorsCleaner.prototype.deleteAllTooHighConnectorsFromMostBottomConnector = function() {
        var a = this._connectors.get();
        if (a.length == 0) return;
        var b = a[0];
        for (var c = 1; c < a.length; c++) {
    ...
    e.VerticalGrid.ConnectorsSelector = function(a) {
        var b = this;
        this._connectors = null;
        this._guid = null;
        this._css = {};
    ...
    e.VerticalGrid.ConnectorsSelector.prototype.attachConnectors = function(a) {
        this._connectors = a;
    };
    e.VerticalGrid.ConnectorsSelector.prototype.getSelectedConnectors = function() {
        return this._connectors;
    };
    e.VerticalGrid.ConnectorsSelector.prototype.selectOnlyMostBottomConnectorFromSide = function(a) {
        var b = null;
        var c = null;
        var d = this._connectors.length;
        while (d--) {
    ...
    e.VerticalGrid.ConnectorsSelector.prototype.selectOnlyMostTopConnectorFromSide = function(a) {
        var b = null;
        var c = null;
        var d = this._connectors.length;
        while (d--) {
    ...
    e.VerticalGrid.ConnectorsSelector.prototype._isInitialConnector = function(a) {
        return a.itemGUID == e.Connectors.INITIAL_CONNECTOR_ITEM_GUID;
    };
    e.VerticalGrid.ConnectorsSelector.prototype.selectOnlySpecifiedSideConnectorsOnAppendedItems = function(a) {
        for (var b = 0; b < this._connectors.length; b++) {
            if (!this._isInitialConnector(this._connectors[b]) && !this._guid.wasItemPrepended(this._connectors[b].itemGUID) && a != this._connectors[b].side) {
                this._connectors.splice(b, 1);
                b--;
    ...
    e.VerticalGrid.ConnectorsSelector.prototype.selectOnlySpecifiedSideConnectorsOnPrependedItems = function(a) {
        for (var b = 0; b < this._connectors.length; b++) {
            if (!this._isInitialConnector(this._connectors[b]) && this._guid.wasItemPrepended(this._connectors[b].itemGUID) && a != this._connectors[b].side) {
                this._connectors.splice(b, 1);
                b--;
    ...
    e.VerticalGrid.ConnectorsSorter = function() {
        var a = this;
        this._connectors = null;
        this._css = {};
        this._construct = function() {};
    ...
    e.VerticalGrid.ConnectorsSorter.prototype.attachConnectors = function(a) {
        this._connectors = a;
    };
    e.VerticalGrid.ConnectorsSorter.prototype.getConnectors = function() {
        return this._connectors;
    };
    e.VerticalGrid.ConnectorsSorter.prototype.sortConnectorsForPrepend = function(a) {
        var b = this;
        this._connectors.sort(function(b, c) {
    ...
    e.VerticalGrid.ConnectorsSorter.prototype.sortConnectorsForAppend = function(a) {
        var b = this;
        this._connectors.sort(function(b, c) {
