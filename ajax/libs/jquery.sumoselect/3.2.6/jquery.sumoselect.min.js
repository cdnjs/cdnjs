...
for(var c=b.E.find(":checked").not(":disabled"),d=0;d<c.length;d++)if(d+1>=f.csvDispCount&&f.csvDispCount){b.placeholder=c.length===b.E.find("option").length&&f.captionFormatAllSelected?f.captionFormatAllSelected.replace(/\{0\}/g,c.length)+",":f.captionFormat.replace(/\{0\}/g,c.length)+",";break}else b.placeholder+=a(c[d]).text()+", ";b.placeholder=b.placeholder.replace(/,([^,]*)$/,"$1")}else b.placeholder=b.E.find(":checked").not(":disabled").text();var e=!1;b.placeholder||(e=!0,b.placeholder=b.E.attr("placeholder"),!b.placeholder&&(//if placeholder is there then set it
b.placeholder=b.E.find("option:disabled:checked").text())),b.placeholder=b.placeholder?f.prefix+" "+b.placeholder:f.placeholder,b.caption.text(b.placeholder),f.showTitle&&b.CaptionCont.attr("title",b.placeholder);//set the hidden field if post as csv is true.
var g=b.select.find("input.HEMANT123");return g.length&&g.val(b.getSelStr()),e?b.caption.addClass("placeholder"):b.caption.removeClass("placeholder"),b.placeholder},isMobile:function isMobile(){// Adapted from http://www.detectmobilebrowsers.com
...
toggSelAll:function toggSelAll(b,c){var d=this,e=a.extend(!0,{},a._data(d.E.get(0),"events"));d.E.off(),d.E.find("option:not(:disabled), option:not(:hidden)").each(function(c,d){var e=d.selected,f=a(d).data("li");f.hasClass("hidden")||(b?!e&&f.trigger("click"):e&&f.trigger("click"))}),a.each(e,function(b,c){a.each(c,function(a,b){d.E.on(b.type,b.handler)})}),d.callChange(),c||(!d.mob&&d.selAll&&d.selAll.removeClass("partial").toggleClass("selected",!!b),d.setText(),d.setPstate())},/* outside accessibility options
