...
(function() {
  var Color, DecomposedMatrix, InterpolableArray, InterpolableColor, InterpolableObject, InterpolableWithUnit, Matrix, Set, Vector, addTimeout, animationTick, animations, animationsTimeouts, applyDefaults, applyFrame, applyProperties, axisForTransformProperty, cacheFn, cancelTimeout, createInterpolable, defaultValueForKey, degProperties, dynamics, getCurrentProperties, interpolate, isDocumentVisible, lastTime, leftDelayForTimeout, makeArrayFn, observeVisibilityChange, parseProperties, prefixFor, propertyWithPrefix, pxProperties, rAF, roundf, runLoopPaused, runLoopRunning, runLoopTick, setRealTimeout, startAnimation, startRunLoop, svgProperties, timeBeforeVisibilityChange, timeoutLastId, timeouts, toDashed, transformProperties, transformValueForProperty, unitForProperty,
  ...
  applyProperties = function(el, properties, onlyCSS) {
    var isSVG, k, transforms, v, _ref, _ref1;
    if (onlyCSS == null) {
      onlyCSS = false;
    }
    ...
    if ((typeof SVGElement !== "undefined" && SVGElement !== null) && (typeof SVGSVGElement !== "undefined" && SVGSVGElement !== null)) {
      ...
      isSVG = (_ref = (_ref1 = dynamics.tests) != null ? typeof _ref1.isSVG === "function" ? _ref1.isSVG(el) : void 0 : void 0) != null ? _ref : false;
    }
    for (k in properties) {
      v = properties[k];
  ...
  getCurrentProperties = function(el, keys) {
    var key, properties, style, v, _i, _j, _len, _len1;
    properties = {};
    if (el.style != null) {
  ...
  startAnimation = function(el, properties, options) {
    var endProperties, k, startProperties, transforms, v, _base;
    dynamics.stop(el);
    properties = parseProperties(properties);
    ...
    if (transforms.length > 0) {
      endProperties['transform'] = Matrix.fromTransform(Matrix.matrixForTransform(transforms.join(' '))).decompose();
    }
    animations.push({
      el: el,
      properties: {
