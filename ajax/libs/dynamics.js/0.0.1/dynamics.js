...
(function() {
  var Color, DecomposedMatrix, InterpolableColor, InterpolableConcatenatedArray, InterpolableWithUnit, Matrix, Set, Vector, addTimeout, animationTick, animations, applyDefaults, applyFrame, axisForTransformProperty, cacheFn, cancelTimeout, createInterpolable, defaultValueForKey, degProperties, dynamics, getCurrentProperties, interpolate, isCSSProperty, isDocumentVisible, lastTime, leftDelayForTimeout, noUnitProperties, observeVisibilityChange, parseProperties, prefixFor, propertyWithPrefix, pxProperties, rAF, roundf, runLoopPaused, runLoopRunning, runLoopTick, setRealTimeout, startRunLoop, timeBeforeVisibilityChange, timeoutLastId, timeouts, toDashed, transformProperties, transformValueForProperty, unitForProperty,
  ...
  noUnitProperties = new Set(['opacity', 'transform', 'background', 'backgroundColor', 'borderBottomColor', 'borderTopColor', 'borderLeftColor', 'borderRightColor']);
  ...
  Matrix = (function() {
    ...
    Matrix.matrix3dForTransform = cacheFn(function(transform) {
      ...
      result = (_ref = (_ref1 = style.transform) != null ? _ref1 : style[propertyWithPrefix("transform")]) != null ? _ref : (_ref2 = dynamics.tests) != null ? _ref2.matrix3dForTransform(transform) : void 0;
    ...
    Matrix.fromTransform = function(transform) {
      ...
      match = transform != null ? transform.match(/matrix3?d?\(([-0-9, \.]*)\)/) : void 0;
      if (match) {
  ...
  leftDelayForTimeout = function(time, timeout) {
    ...
    if (time != null) {
      ...
      return timeout.delay - consumedDelay;
    } else {
  ...
  dynamics.animate = function(el, properties, options) {
    ...
    if (transforms.length > 0) {
      endProperties['transform'] = Matrix.fromTransform(Matrix.matrix3dForTransform(transforms.join(' '))).decompose();
    }
