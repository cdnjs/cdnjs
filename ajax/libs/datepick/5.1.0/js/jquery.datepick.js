				...
				if (event.keyCode === 9) { // Tab - close
					...
					for (var name in commands) {
						...
						if (command.keystroke.keyCode === event.keyCode &&
								!!command.keystroke.ctrlKey === !!(event.ctrlKey || event.metaKey) && // jshint ignore:line
								!!command.keystroke.altKey === event.altKey && // jshint ignore:line
								!!command.keystroke.shiftKey === event.shiftKey) { // jshint ignore:line
