...
;// CONCATENATED MODULE: ./dist/Pusher.js
...
class Pusher extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      if (mode !== external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ClickMode.push) {
        return;
      }
