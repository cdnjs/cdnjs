    ...
    function h(_tag, _props, _children) {
        ...
        if (isElement) {
            ...
            if (flags & 8192 /* VNodeFlags.Fragment */) {
                return inferno.createFragment(_children || children, 0 /* ChildFlags.UnknownChildren */, key);
            }
            if (newProps.contenteditable !== void 0) {
                flags |= 4096 /* VNodeFlags.ContentEditable */;
            }
            return inferno.createVNode(flags, tag, className, _children || children, 0 /* ChildFlags.UnknownChildren */, newProps, key, ref);
        }
        if (children || _children) {
            newProps.children = children || _children;
        }
        return inferno.createComponentVNode(2 /* VNodeFlags.ComponentUnknown */, tag, newProps, key, ref);
    }
