(function (global, factory) {
    ...
    function h(_tag, _props, _children) {
      ...
      var _extractProps = extractProps(_props, isElement, _tag),
        tag = _extractProps.tag,
        props = _extractProps.props,
        key = _extractProps.key,
        ref = _extractProps.ref,
        children = _extractProps.children,
        className = _extractProps.className;
      if (isElement) {
        var flags = inferno.getFlagsForElementVnode(tag);
        if (props.contenteditable !== void 0) {
          flags |= 4096 /* VNodeFlags.ContentEditable */;
        }
        return inferno.createVNode(flags, tag, className, _children || children, 0 /* ChildFlags.UnknownChildren */, props, key, ref);
      } else {
        if (children || _children) {
          props.children = children || _children;
        }
        return inferno.createComponentVNode(2 /* VNodeFlags.ComponentUnknown */, tag, props, key, ref);
      }
    }
