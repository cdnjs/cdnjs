    ...
    constructor(provider) {
        ...
        class ContractBuilder extends web3_eth_contract_1.default {
            constructor(jsonInterface, addressOrOptions, options) {
                ...
                else if (!(0, web3_utils_1.isNullish)(addressOrOptions) && (0, web3_utils_1.isNullish)(options)) {
                    super(jsonInterface, addressOrOptions !== null && addressOrOptions !== void 0 ? addressOrOptions : {}, self.getContextObject());
                }
                else if ((0, web3_utils_1.isNullish)(addressOrOptions) && !(0, web3_utils_1.isNullish)(options)) {
                    super(jsonInterface, options !== null && options !== void 0 ? options : {}, self.getContextObject());
                }
                else {
