declare const _default: {
    ...
    decodeLog: <ReturnType_1 extends import("web3-eth-abi").DecodedParams>(inputs: import("web3-eth-abi").AbiParameter[], data: string, topics: string | string[]) => ReturnType_1;
};
