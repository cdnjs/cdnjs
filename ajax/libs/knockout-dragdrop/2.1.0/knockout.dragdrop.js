            ...
            init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
                ...
                element.addEventListener('mousedown', function (downEvent) {
                    ...
                    function startDragging(startEvent) {
                        element.removeEventListener('mouseup', onMouseUpStartDrag);
                        element.removeEventListener('click', onMouseUpStartDrag);
                        element.removeEventListener('mouseleave', onMouseUpStartDrag);
                        element.removeEventListener('mousemove', onMouseMoveStartDrag);
                    ...
                    element.addEventListener('mouseup', onMouseUpStartDrag);
                    element.addEventListener('click', onMouseUpStartDrag);
                    element.addEventListener('mouseleave', onMouseUpStartDrag);
                    ...
                    element.addEventListener('mousemove', onMouseMoveStartDrag);
