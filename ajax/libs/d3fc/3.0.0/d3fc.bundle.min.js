...
return{width:parseFloat(b.width)-parseFloat(b.paddingLeft)-parseFloat(b.paddingRight),height:parseFloat(b.height)-parseFloat(b.paddingTop)-parseFloat(b.paddingBottom)}}function e(a){for(;a.ownerSVGElement;)a=a.ownerSVGElement;return a}function f(a){if(!a)return{};var b=a.split(";"),c={};return b.forEach(function(a){var b=a.split(":");if(2===b.length){var d=b[0].trim(),e=b[1].trim();c[d]=isNaN(e)?e:Number(e)}}),c}function g(a){function b(){for(var b=[],c=0;c<a.childNodes.length;c++){var d=a.childNodes[c];1===d.nodeType&&d.getAttribute("layout-style")&&b.push(g(d))}return b}return{style:f(a.getAttribute("layout-style")),children:b(a),element:a}}function h(a,b){b&&(a.element.setAttribute("layout-width",a.layout.width),a.element.setAttribute("layout-height",a.layout.height)),a.element.setAttribute("layout-x",a.layout.left),a.element.setAttribute("layout-y",a.layout.top),a.element.nodeName.match(/(?:svg|rect)/i)?(a.element.setAttribute("width",a.layout.width),a.element.setAttribute("height",a.layout.height),a.element.setAttribute("x",a.layout.left),a.element.setAttribute("y",a.layout.top)):a.element.setAttribute("transform","translate("+a.layout.left+", "+a.layout.top+")"),a.children.forEach(function(a){h(a,!0)})}function i(a){return a.hasAttribute("layout-width")&&a.hasAttribute("layout-height")?{width:Number(a.getAttribute("layout-width")),height:Number(a.getAttribute("layout-height"))}:d(a)}function j(a){return a.hasAttribute("layout-x")&&a.hasAttribute("layout-y")?{x:Number(a.getAttribute("layout-x")),y:Number(a.getAttribute("layout-y"))}:{x:0,y:0}}function k(b){if("suspended"!==e(b).__layout__){var c=i(b),d=j(b),f=g(b);f.style.width=c.width,f.style.height=c.height,f.style.left=d.x,f.style.top=d.y,a(f),h(f)}}function l(a){return arguments.length?this.each(function(){e(this).__layout__=a?"suspended":""}):Boolean(e(this.node()).__layout__)}function m(a,b){var c=arguments.length;if(1===c&&"string"==typeof a){var d=this.node();return Number(d.getAttribute("layout-"+a))}return this.each(function(){if(2===c)"string"!=typeof a?(this.setAttribute("layout-width",a),this.setAttribute("layout-height",b),k(this)):this.setAttribute("layout-style",a+":"+b);else if(1===c){if("string"!=typeof a){var d=a,e=Object.keys(d).map(function(a){return a+":"+d[a]}).join(";");this.setAttribute("layout-style",e)}}else 0===c&&k(this)})}function n(a){var b=null;return function(){null==b&&(b=requestAnimationFrame(function(){b=null,a()}))}}function o(a,b){return function(c,d){var e={xInDomainUnits:!1,x:c,yInDomainUnits:!1,y:d};return a.invert&&(e.xInDomainUnits=!0,e.x=a.invert(c)),b.invert&&(e.yInDomainUnits=!0,e.y=b.invert(d)),e}}function p(a,b,c,d,e,f){return f=f||function(a,b,c,d){var e=a-c,f=b-d;return e*e+f*f},function(g,h){var i=e.map(function(e){var i=f(g,h,a(c(e)),b(d(e)));return[i,e]}).reduce(function(a,b){return a[0]>b[0]?b:a},[Number.MAX_VALUE,null])[1];return{datum:i,x:i?c(i):g,xInDomainUnits:Boolean(i),y:i?d(i):h,yInDomainUnits:Boolean(i)}}}function q(a,b,c){return function(d,e){var f=a.xScale(),g=a.yScale(),h=a.xValue(),i=(a.yValue||a.yCloseValue).call(a);return p(f,g,h,i,b,c)(d,e)}}function r(a,b){function c(a,b,c,d){var e=a-c;return Math.abs(e)}return q(a,b,c)}function s(a,b){function c(a,b,c,d){var e=b-d;return Math.abs(e)}return q(a,b,c)}function t(a){return a.rangeExtent}function u(a){return t(a)?a.rangeExtent():a.range()}function v(a,c,d){return"object"!=typeof d?b.rebind.apply(b,arguments):(Object.keys(d).forEach(function(b){var e=c[d[b]];if("function"!=typeof e)throw new Error("The method "+d[b]+" does not exist on the source object");a[b]=function(){var b=e.apply(c,arguments);return b===c?a:b}}),a)}function w(a){return a[0].toUpperCase()+a.slice(1)}function x(a,b,c,d){function e(a){return d.some(function(b){return a.match(b)})}function f(a){return""!==c?c+w(a):a}c="undefined"!=typeof c?c:"",4===arguments.length&&Array.isArray(d)||(d=Array.prototype.slice.call(arguments,3)),d=d.map(function(a){if("string"==typeof a){if(!b.hasOwnProperty(a))throw new Error("The method "+a+" does not exist on the source object");a=new RegExp("^"+a+"$")}return a});var g={};for(var h in b)b.hasOwnProperty(h)&&!e(h)&&(g[f(h)]=h);v(a,b,g)}function y(a){return function(c){if(c.length<=1)return 10;c.sort();var d=b.pairs(c).map(function(a){return Math.abs(a[0]-a[1])}),e=b.min(d);return a*e}}function z(){return this}function A(a){return a}function B(a,b){return b}function C(a){}function D(a,c){if(Array.isArray(a[0])||(a=[a]),2===arguments.length)Array.isArray(c)||(c=[c]);else{var d=Array.prototype.slice.call(arguments);c=d.slice(1)}return c=c.map(function(a){return"string"!=typeof a?a:function(b){return b[a]}}),[b.min(a,function(a){return b.min(a,function(a){return b.min(c.map(function(b){return b(a)}))})}),b.max(a,function(a){return b.max(a,function(a){return b.max(c.map(function(b){return b(a)}))})})]}function E(a){var b=a;return"number"==typeof b&&(b={top:a,bottom:a,left:a,right:a}),["top","bottom","left","right"].forEach(function(a){b[a]||(b[a]=0)}),b}function F(){var a="g",c=!1,d="g",e={},f=B,g=function(g,h){var i=h||A;g.selectAll&&g.node||(g=b.select(g));var j=g.selectAll(a);c&&(j=j.filter(function(){return this.parentNode===g.node()}));var k=j.data(i,f),l=k.enter().insert(d).attr(e).style("opacity",Qa),m=b.transition(k.exit()).style("opacity",Qa).remove();return k=b.transition(k).style("opacity",1),k.enter=b.functor(l),k.exit=b.functor(m),k};return g.selector=function(b){return arguments.length?(a=b,g):a},g.children=function(a){return arguments.length?(c=a,g):c},g.element=function(a){return arguments.length?(d=a,g):d},g.attr=function(a){if(!arguments.length)return e;if(1===arguments.length)e=arguments[0];else if(2===arguments.length){var b=arguments[0],c=arguments[1];e[b]=c}return g},g.key=function(a){return arguments.length?(f=a,g):f},g}function G(){function a(){var a=b.select(this),c=a.datum()[0];if("DONE"!==c.state){var d=b.mouse(this),e=j.apply(this,d);if("SELECT_SOURCE"===c.state)c.source=c.target=e;else{if("SELECT_TARGET"!==c.state)throw new Error("Unknown state "+c.state);c.target=e}}}function c(){var c=b.select(this).on("click.measure",f).on("mousemove.measure",d).on("mouseleave.measure",e),g=c.datum();null==g[0]&&g.push({state:"SELECT_SOURCE"}),a.call(this),c.call(s)}function d(){var c=b.select(this);a.call(this),c.call(s)}function e(){var a=b.select(this),c=a.datum();null!=c[0]&&"SELECT_SOURCE"===c[0].state&&c.pop(),a.on("click.measure",null).on("mousemove.measure",null).on("mouseleave.measure",null)}function f(){var c=b.select(this),d=c.datum()[0];switch(d.state){case"SELECT_SOURCE":a.call(this),g.measuresource.apply(this,arguments),d.state="SELECT_TARGET";break;case"SELECT_TARGET":a.call(this),g.measuretarget.apply(this,arguments),d.state="DONE";break;case"DONE":g.measureclear.apply(this,arguments),d.state="SELECT_SOURCE",a.call(this);break;default:throw new Error("Unknown state "+d.state)}c.call(s)}var g=b.dispatch("measuresource","measuretarget","measureclear"),h=b.time.scale(),i=b.scale.linear(),j=function(a,b){return o(h,i)(a,b)},k=C,l=b.functor(""),m=b.functor(""),n=b.functor(2),p=function(a){return a.xInDomainUnits?h(a.x):a.x},q=function(a){return a.yInDomainUnits?i(a.y):a.y},r=F().selector("g.measure").element("g").attr("class","measure"),s=function(a){a.each(function(a,d){var e=b.select(this).style("pointer-events","all").on("mouseenter.measure",c),f=e.selectAll("rect").data([a]);f.enter().append("rect").style("visibility","hidden"),e.select("rect").attr("x",h.range()[0]).attr("y",i.range()[1]).attr("width",h.range()[1]).attr("height",i.range()[0]);var g=r(e,a),j=g.enter();j.append("line").attr("class","tangent"),j.append("line").attr("class","horizontal"),j.append("line").attr("class","vertical"),j.append("text").attr("class","horizontal"),j.append("text").attr("class","vertical"),g.select("line.tangent").attr("x1",function(a){return p(a.source)}).attr("y1",function(a){return q(a.source)}).attr("x2",function(a){return p(a.target)}).attr("y2",function(a){return q(a.target)}),g.select("line.horizontal").attr("x1",function(a){return p(a.source)}).attr("y1",function(a){return q(a.source)}).attr("x2",function(a){return p(a.target)}).attr("y2",function(a){return q(a.source)}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}),g.select("line.vertical").attr("x1",function(a){return p(a.target)}).attr("y1",function(a){return q(a.target)}).attr("x2",function(a){return p(a.target)}).attr("y2",function(a){return q(a.source)}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"});var o=n.apply(this,arguments);g.select("text.horizontal").attr("x",function(a){return p(a.source)+(p(a.target)-p(a.source))/2}).attr("y",function(a){return q(a.source)-o}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}).text(l),g.select("text.vertical").attr("x",function(a){return p(a.target)+o}).attr("y",function(a){return q(a.source)+(q(a.target)-q(a.source))/2}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}).text(m),k(g,a,d)})};return s.xScale=function(a){return arguments.length?(h=a,s):h},s.yScale=function(a){return arguments.length?(i=a,s):i},s.snap=function(a){return arguments.length?(j=a,s):j},s.decorate=function(a){return arguments.length?(k=a,s):k},s.xLabel=function(a){return arguments.length?(l=b.functor(a),s):l},s.yLabel=function(a){return arguments.length?(m=b.functor(a),s):m},s.padding=function(a){return arguments.length?(n=b.functor(a),s):n},b.rebind(s,g,"on"),s}function H(){function a(){var a=b.select(this),c=a.datum()[0];if("DONE"!==c.state){var d=b.mouse(this),e=j.apply(this,d);if("SELECT_SOURCE"===c.state)c.source=c.target=e;else{if("SELECT_TARGET"!==c.state)throw new Error("Unknown state "+c.state);c.target=e}}}function c(){var c=b.select(this).on("click.fan",f).on("mousemove.fan",d).on("mouseleave.fan",e),g=c.datum();null==g[0]&&g.push({state:"SELECT_SOURCE"}),a.call(this),c.call(p)}function d(){var c=b.select(this);a.call(this),c.call(p)}function e(){var a=b.select(this),c=a.datum();null!=c[0]&&"SELECT_SOURCE"===c[0].state&&c.pop(),a.on("click.fan",null).on("mousemove.fan",null).on("mouseleave.fan",null)}function f(){var c=b.select(this),d=c.datum()[0];switch(d.state){case"SELECT_SOURCE":a.call(this),g.fansource.apply(this,arguments),d.state="SELECT_TARGET";break;case"SELECT_TARGET":a.call(this),g.fantarget.apply(this,arguments),d.state="DONE";break;case"DONE":g.fanclear.apply(this,arguments),d.state="SELECT_SOURCE",a.call(this);break;default:throw new Error("Unknown state "+d.state)}c.call(p)}var g=b.dispatch("fansource","fantarget","fanclear"),h=b.time.scale(),i=b.scale.linear(),j=function(a,b){return o(h,i)(a,b)},k=C,l=function(a){return a.xInDomainUnits?h(a.x):a.x},m=function(a){return a.yInDomainUnits?i(a.y):a.y},n=F().selector("g.fan").element("g").attr("class","fan"),p=function(a){a.each(function(a,d){var e=b.select(this).style("pointer-events","all").on("mouseenter.fan",c),f=e.selectAll("rect").data([a]);f.enter().append("rect").style("visibility","hidden"),e.select("rect").attr("x",h.range()[0]).attr("y",i.range()[1]).attr("width",h.range()[1]).attr("height",i.range()[0]);var g=n(e,a);g.each(function(a){if(a.x=h.range()[1],a.ay=a.by=a.cy=m(a.target),l(a.source)!==l(a.target)){if("DONE"===a.state&&l(a.source)>l(a.target)){var b=a.source;a.source=a.target,a.target=b}var c=(m(a.target)-m(a.source))/(l(a.target)-l(a.source)),d=a.x-l(a.source),e=c*d;a.ay=.618*e+m(a.source),a.by=.5*e+m(a.source),a.cy=.382*e+m(a.source)}});var j=g.enter();j.append("line").attr("class","trend"),j.append("line").attr("class","a"),j.append("line").attr("class","b"),j.append("line").attr("class","c"),j.append("polygon").attr("class","area"),g.select("line.trend").attr("x1",function(a){return l(a.source)}).attr("y1",function(a){return m(a.source)}).attr("x2",function(a){return l(a.target)}).attr("y2",function(a){return m(a.target)}),g.select("line.a").attr("x1",function(a){return l(a.source)}).attr("y1",function(a){return m(a.source)}).attr("x2",function(a){return a.x}).attr("y2",function(a){return a.ay}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}),g.select("line.b").attr("x1",function(a){return l(a.source)}).attr("y1",function(a){return m(a.source)}).attr("x2",function(a){return a.x}).attr("y2",function(a){return a.by}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}),g.select("line.c").attr("x1",function(a){return l(a.source)}).attr("y1",function(a){return m(a.source)}).attr("x2",function(a){return a.x}).attr("y2",function(a){return a.cy}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}),g.select("polygon.area").attr("points",function(a){return l(a.source)+","+m(a.source)+" "+a.x+","+a.ay+" "+a.x+","+a.cy}).style("visibility",function(a){return"DONE"!==a.state?"hidden":"visible"}),k(g,a,d)})};return p.xScale=function(a){return arguments.length?(h=a,p):h},p.yScale=function(a){return arguments.length?(i=a,p):i},p.snap=function(a){return arguments.length?(j=a,p):j},p.decorate=function(a){return arguments.length?(k=a,p):k},b.rebind(p,g,"on"),p}function I(){var a=b.time.scale(),c=b.scale.linear(),d=[],e=z,f=B,g=C,h=F().selector("g.multi").children(!0).attr("class","multi").element("g").key(function(a,b){var c=this.__series__||a;return f.call(this,c,b)}),i=function(f){f.each(function(f){var i=h(this,d);i.each(function(d,g){this.__series__=d,(d.xScale||d.x).call(d,a),(d.yScale||d.y).call(d,c),b.select(this).datum(e.call(f,d,g)).call(d)}),b.selection.prototype.order.call(i),g(i)})};return i.xScale=function(b){return arguments.length?(a=b,i):a},i.yScale=function(a){return arguments.length?(c=a,i):c},i.series=function(a){return arguments.length?(d=a,i):d},i.mapping=function(a){return arguments.length?(e=a,i):e},i.key=function(a){return arguments.length?(f=a,i):f},i.decorate=function(a){return arguments.length?(g=a,i):g},i}function J(){var a=b.time.scale(),c=b.scale.linear(),d=A,e=B,f=d,g=C,h="horizontal",i=F().selector("g.annotation").element("g").attr("class","annotation"),j=function(e){e.each(function(e,j){var k,l,m,n,o,p,q={x:-5,y:-5};switch(h){case"horizontal":m=function(a,b){return"translate("+a+", "+b+")"},n="x2",l=a,k=c,o="left-handle",p="right-handle";break;case"vertical":m=function(a,b){return"translate("+b+", "+a+")"},n="y2",l=c,k=a,q.transform="rotate(-90)",o="bottom-handle",p="top-handle";break;default:throw new Error("Invalid orientation")}var r=u(l),s=function(a){var b=k(d(a));return m(r[0],b)},t=r[1]-r[0],v=b.select(this),w=i(v,e),x=w.enter().attr("transform",s);x.append("line").attr(n,t),x.append("g").classed(o,!0),x.append("g").classed(p,!0).attr("transform",m(t,0)).append("text").attr(q),w.attr("transform",s),w.select("line").attr(n,t),w.select("g."+p).attr("transform",m(t,0)),w.select("text").text(f),g(w,e,j)})};return j.xScale=function(b){return arguments.length?(a=b,j):a},j.yScale=function(a){return arguments.length?(c=a,j):c},j.value=function(a){return arguments.length?(d=b.functor(a),j):d},j.keyValue=function(a){return arguments.length?(e=b.functor(a),j):e},j.label=function(a){return arguments.length?(f=b.functor(a),j):f},j.decorate=function(a){return arguments.length?(g=a,j):g},j.orient=function(a){return arguments.length?(h=a,j):h},j}function K(){function a(){}var c=b.time.scale(),d=b.scale.linear(),e=b.functor(0),f=b.functor(0),g=function(a,b){return a.date},h=function(a,b){return a.close};return a.x0=function(a,b){return c(f(a,b))},a.y0=function(a,b){return d(e(a,b))},a.x=a.x1=function(a,b){return c(g(a,b))},a.y=a.y1=function(a,b){return d(h(a,b))},a.defined=function(a,b){return null!=f(a,b)&&null!=e(a,b)&&null!=g(a,b)&&null!=h(a,b)},a.xScale=function(b){return arguments.length?(c=b,a):c},a.yScale=function(b){return arguments.length?(d=b,a):d},a.x0Value=function(c){return arguments.length?(f=b.functor(c),a):f},a.y0Value=function(c){return arguments.length?(e=b.functor(c),a):e},a.xValue=a.x1Value=function(c){return arguments.length?(g=b.functor(c),a):g},a.yValue=a.y1Value=function(c){return arguments.length?(h=b.functor(c),a):h},a}function L(){var a=C,c=b.functor(5),d=K(),e=F().selector("g.point").element("g").attr("class","point"),f=function(a,b){return"translate("+d.x(a,b)+", "+d.y(a,b)+")"},g=function(b){b.each(function(b,g){var h=b.filter(d.defined),i=e(this,h);i.enter().attr("transform",f).append("circle"),i.attr("transform",f),i.select("circle").attr("r",c),a(i,b,g)})};return g.decorate=function(b){return arguments.length?(a=b,g):a},g.radius=function(a){return arguments.length?(c=a,g):c},b.rebind(g,d,"xScale","xValue","yScale","yValue"),b.rebind(g,e,"key"),g}function M(){function a(a){return b.scale.identity().range(u(a))}function c(){var a=b.mouse(this),c=b.select(this),d=i.apply(this,a),e=c.datum();e.push(d),c.call(r),f.trackingstart.apply(this,arguments)}function d(){var a=b.mouse(this),c=b.select(this),d=i.apply(this,a),e=c.datum();e[e.length-1]=d,c.call(r),f.trackingmove.apply(this,arguments)}function e(){var a=b.select(this),c=a.datum();c.pop(),a.call(r),f.trackingend.apply(this,arguments)}var f=b.dispatch("trackingstart","trackingmove","trackingend"),g=b.time.scale(),h=b.scale.linear(),i=function(a,b){return o(g,h)(a,b)},j=C,k=function(a){return a.xInDomainUnits?g(a.x):a.x},l=function(a){return a.yInDomainUnits?h(a.y):a.y},m=F().children(!0).selector("g.crosshair").element("g").attr("class","crosshair"),n=L().xValue(k).yValue(l),p=J().value(l).label(function(a){return a.y}),q=J().orient("vertical").value(k).label(function(a){return a.x}),r=function(f){f.each(function(f,i){var k=b.select(this).style("pointer-events","all").on("mouseenter.crosshair",c).on("mousemove.crosshair",d).on("mouseleave.crosshair",e),l=k.selectAll("rect").data([f]);l.enter().append("rect").style("visibility","hidden"),k.select("rect").attr("x",u(g)[0]).attr("y",u(h)[1]).attr("width",u(g)[1]).attr("height",u(h)[0]);var o=m(k,f);o.enter().style("pointer-events","none");var r=I().series([p,q,n]).xScale(a(g)).yScale(a(h)).mapping(function(){return[this]});o.call(r),j(o,f,i)})};return r.xScale=function(a){return arguments.length?(g=a,r):g},r.yScale=function(a){return arguments.length?(h=a,r):h},r.snap=function(a){return arguments.length?(i=a,r):i},r.decorate=function(a){return arguments.length?(j=a,r):j},b.rebind(r,f,"on"),v(r,p,{yLabel:"label"}),v(r,q,{xLabel:"label"}),r}function N(){var a=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=b.functor(3),h=function(b){return b.map(function(b,h){var i=a(b,h),j=c(b,h),k=d(b,h),l=e(b,h),m=f(b,h),n=g(b,h)/2,o="M"+i+","+l,p="V"+k,q="M"+i+","+j+"h"+-n,r="M"+i+","+m+"h"+n;return o+p+q+r}).join("")};return h.x=function(b){return arguments.length?(a=b,h):a},h.open=function(a){return arguments.length?(c=a,h):c},h.high=function(a){return arguments.length?(d=a,h):d},h.low=function(a){return arguments.length?(e=a,h):e},h.close=function(a){return arguments.length?(f=a,h):f},h.width=function(a){return arguments.length?(g=b.functor(a),h):g},h}function O(){var a=function(a,b){return a.date},c=function(a,b){return a.open},d=function(a,b){return a.high},e=function(a,b){return a.low},f=function(a,b){return a.close},g=b.functor(3),h=function(b){return b.map(function(b,h){var i=a(b,h),j=c(b,h),k=d(b,h),l=e(b,h),m=f(b,h),n=g(b,h),o="M"+(i-n/2)+","+j+"h"+n+"V"+m+"h"+-n+"V"+j+"z",p="M"+i+","+Math.min(m,j)+"V"+k,q="M"+i+","+Math.max(m,j)+"V"+l;return o+p+q}).join("")};return h.x=function(b){return arguments.length?(a=b,h):a},h.open=function(a){return arguments.length?(c=a,h):c},h.high=function(a){return arguments.length?(d=a,h):d},h.low=function(a){return arguments.length?(e=a,h):e},h.close=function(a){return arguments.length?(f=a,h):f},h.width=function(a){return arguments.length?(g=b.functor(a),h):g},h}function P(){var a=function(a,b){return a.x},c=function(a,b){return a.y},d="center",e="center",f=function(a,b){return a.height},g=b.functor(3),h=function(b,h){return b.map(function(b,i){var j,k=a.call(this,b,h||i),l=c.call(this,b,h||i),m=f.call(this,b,h||i),n=g.call(this,b,h||i);switch(d){case"left":j=n;break;case"right":j=0;break;case"center":j=n/2;break;default:throw new Error("Invalid horizontal alignment "+d)}var o;switch(e){case"bottom":o=-m;break;case"top":o=0;break;case"center":o=m/2;break;default:throw new Error("Invalid vertical alignment "+e)}var p="M"+(k-j)+","+(l-o)+"h"+n+"v"+m+"h"+-n+"z";return p},this).join("")};return h.x=function(c){return arguments.length?(a=b.functor(c),h):a},h.y=function(a){return arguments.length?(c=b.functor(a),h):c},h.width=function(a){return arguments.length?(g=b.functor(a),h):g},h.horizontalAlign=function(a){return arguments.length?(d=a,h):d},h.height=function(a){return arguments.length?(f=b.functor(a),h):f},h.verticalAlign=function(a){return arguments.length?(e=a,h):e},h}function Q(){function a(a,b){return function(c){return b(a(c),0)}}function c(a,b){return e()?"translate("+b+", "+a+")":"translate("+a+", "+b+")"}function d(a){return e()?a.map(function(a){return[a[1],a[0]]}):a}function e(){return"left"===i||"right"===i}function f(a,b){return g[a]?g[a].apply(g,j):b}var g=b.scale.identity(),h=C,i="bottom",j=[10],k=null,l=null,m=6,n=6,o=3,p=b.svg.line(),q=F().selector("g.tick").element("g").key(A).attr("class","tick"),r=F().selector("path.domain").element("path").attr("class","domain"),s=function(e){e.each(function(e,j){var s=this.__chart__||g;this.__chart__=g.copy();var v=null==k?f("ticks",g.domain()):k,w=null==l?f("tickFormat",A):l,x="bottom"===i||"right"===i?1:-1,y=b.select(this),z=u(g),B=d([[z[0],x*m],[z[0],0],[z[1],0],[z[1],x*m]]),C=r(y,[e]);C.attr("d",p(B)),q.attr({transform:a(t(g)?g:s,c)});var D=q(y,v);D.enter().append("path");var E=x*(n+o);D.enter().append("text").attr("transform",c(0,E)),D.attr("class","tick orient-"+i),D.attr("transform",a(g,c)),D.selectAll("path").attr("d",function(a){return p(d([[0,0],[0,x*n]]))}),D.selectAll("text").attr("transform",c(0,E)).text(w),t(g)||D.exit().attr("transform",a(g,c)),h(D,e,j)})};return s.scale=function(a){return arguments.length?(g=a,s):g},s.ticks=function(a){return arguments.length?(j=arguments,s):j},s.tickValues=function(a){return arguments.length?(k=a,s):k},s.tickFormat=function(a){return arguments.length?(l=a,s):l},s.tickSize=function(a){var b=arguments.length;return b?(n=Number(a),m=Number(arguments[b-1]),s):n},s.innerTickSize=function(a){return arguments.length?(n=Number(a),s):n},s.outerTickSize=function(a){return arguments.length?(m=Number(a),s):m},s.tickPadding=function(a){return arguments.length?(o=a,s):o},s.orient=function(a){return arguments.length?(i=a,s):i},s.decorate=function(a){return arguments.length?(h=a,s):h},s}function R(){function a(){}var c=b.time.scale(),d=b.scale.linear(),e=function(a,b){return a.date},f=function(a,b){return a.open},g=function(a,b){return a.high},h=function(a,b){return a.low},i=function(a,b){return a.close},j=y(.75),k=function(a,b){return c(e(a,b))};return a.width=function(a){return j(a.map(k))},a.defined=function(a,b){return null!=e(a,b)&&null!=f(a,b)&&null!=h(a,b)&&null!=g(a,b)&&null!=i(a,b)},a.values=function(a,b){var c=i(a,b),e=f(a,b),j="";return c>e?j="up":e>c&&(j="down"),{x:k(a,b),yOpen:d(e),yHigh:d(g(a,b)),yLow:d(h(a,b)),yClose:d(c),direction:j}},a.xScale=function(b){return arguments.length?(c=b,a):c},a.yScale=function(b){return arguments.length?(d=b,a):d},a.xValue=function(b){return arguments.length?(e=b,a):e},a.yOpenValue=function(b){return arguments.length?(f=b,a):f},a.yHighValue=function(b){return arguments.length?(g=b,a):g},a.yLowValue=function(b){return arguments.length?(h=b,a):h},a.yValue=a.yCloseValue=function(b){return arguments.length?(i=b,a):i},a.barWidth=function(c){return arguments.length?(j=b.functor(c),a):j},a}function S(){function a(a,b){return"vertical"===i?"translate("+k.x1(a,b)+", "+k.y0(a,b)+")":"translate("+k.x0(a,b)+", "+k.y1(a,b)+")"}function c(a,b){return"vertical"===i?k.y1(a,b)-k.y0(a,b):k.x1(a,b)-k.x0(a,b)}function d(a){return"vertical"===i?a.height:a.width}function e(a){return"vertical"===i?a.width:a.height}function f(){return"vertical"===i?k.x:k.y}var g=C,h=y(.75),i="vertical",j=P(),k=K().xValue(function(a,b){return"vertical"===i?a.date:a.close}).yValue(function(a,b){return"vertical"===i?a.close:a.date}),l=F().selector("g.bar").element("g"),m=function(b){b.each(function(b,m){if("vertical"!==i&&"horizontal"!==i)throw new Error("The bar series does not support an orientation of "+i);l.attr("class","bar "+i);var n=b.filter(k.defined);j.x(0).y(0).width(0).height(0),"vertical"===i?j.verticalAlign("top"):j.horizontalAlign("right");var o=h(n.map(f()));e(j)(o);var p=l(this,n);p.enter().attr("transform",a).append("path").attr("d",function(a){return j([a])}),d(j)(c),p.attr("transform",a).select("path").attr("d",function(a){return j([a])}),g(p,n,m)})};return m.decorate=function(a){return arguments.length?(g=a,m):g},m.barWidth=function(a){return arguments.length?(h=b.functor(a),m):h},m.orient=function(a){return arguments.length?(i=a,m):i},b.rebind(m,k,"xScale","xValue","x1Value","x0Value","yScale","yValue","y1Value","y0Value"),b.rebind(m,l,"key"),m}function T(){var a=S(),c=y(.75),d=C,e=b.scale.linear(),f=b.scale.linear(),g=F().selector("g.stacked").element("g").attr("class","stacked"),h=function(b,c){return e(a.xValue()(b,c))},i=function(i){i.each(function(i){var j=c(i[0].map(h)),k=j/(i.length-1);a.barWidth(k);var l=j/2;f.domain([0,i.length-1]).range([-l,l]);var m=g(this,i);m.each(function(c,g){var h=b.select(this),i=function(a){return e(a)+f(g)};a.xScale(i),a.decorate(function(a,b){d(a,b,g)}),h.call(a)})})};return i.decorate=function(a){return arguments.length?(d=a,i):d},i.xScale=function(a){return arguments.length?(e=a,i):e},b.rebind(i,a,"yValue","xValue","yScale"),i}function U(){var a=C,c=function(c){c.each(function(c){var d=b.select(this),e=F().selector("g.stacked").element("g").attr("class","stacked");e(d,c).call(a)})};return c.series=function(b){return arguments.length?(a=b,c):a},c}function V(){var a=C,c=K(),d=b.svg.line().defined(c.defined).x(c.x).y(c.y),e=F().selector("path.line").element("path").attr("class","line"),f=function(b){b.each(function(b,c){var f=e(this,[b]);f.attr("d",d),a(f,b,c)})};return f.decorate=function(b){return arguments.length?(a=b,f):a},b.rebind(f,c,"xScale","xValue","yScale","yValue"),b.rebind(f,e,"key"),b.rebind(f,d,"interpolate","tension"),f}function W(){var a=V().yValue(function(a){return a.y0+a.y}),b=U().series(a),c=function(a){a.call(b)};return x(c,a),c}function X(){var a=S().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=U().series(a),c=function(a){a.call(b)};return x(c,a),c}function Y(){var a=C,c=K(),d=b.svg.area().defined(c.defined).x(c.x).y0(c.y0).y1(c.y1),e=F().selector("path.area").element("path").attr("class","area"),f=function(b){b.each(function(b,c){var f=e(this,[b]);f.attr("d",d),a(f,b,c)})};return f.decorate=function(b){return arguments.length?(a=b,f):a},b.rebind(f,c,"xScale","xValue","yScale","yValue","y1Value","y0Value"),b.rebind(f,e,"key"),b.rebind(f,d,"interpolate","tension"),f}function Z(){var a=Y().yValue(function(a){return a.y0+a.y}).y0Value(function(a){return a.y0}),b=U().series(a),c=function(a){a.call(b)};return x(c,a),c}function $(a){var c=C,d=R(),e=F().selector("g.ohlc").element("g").attr("class","ohlc"),f=function(a){a.each(function(a,f){var g=a.filter(d.defined),h=e(this,g);h.enter().append("path");var i=N().width(d.width(g));h.each(function(a,c){var e=d.values(a,c),f=b.select(this).attr("class","ohlc "+e.direction).attr("transform","translate("+e.x+", "+e.yHigh+")");i.x(b.functor(0)).open(function(){return e.yOpen-e.yHigh}).high(function(){return e.yHigh-e.yHigh}).low(function(){return e.yLow-e.yHigh}).close(function(){return e.yClose-e.yHigh}),f.select("path").attr("d",i([a]))}),c(h,a,f)})};return f.decorate=function(a){return arguments.length?(c=a,f):c},b.rebind(f,e,"key"),x(f,d),f}function _(){var a=C,c=b.scale.linear(),d=b.scale.linear(),e=function(a,b){return a.date.getDay()},f=b.scale.linear(),g=V(),h=y(.75),i=F().selector("g.cycle").element("g").attr("class","cycle"),j=function(j){j.each(function(j,k){var l=b.nest().key(e).map(j),m=Object.keys(l),n=h(m.map(c)),o=n/2,p=i(this,m);p.each(function(a,e){var h=b.select(this);h.attr("transform","translate("+c(a)+", 0)"),(f.rangeBands||f.range)([-o,o]),g.xScale(f).yScale(d),b.select(this).datum(l[a]).call(g)}),a(p,m,k)})};return j.decorate=function(b){return arguments.length?(a=b,j):a},j.xScale=function(a){return arguments.length?(c=a,j):c},j.yScale=function(a){return arguments.length?(d=a,j):d},j.xValue=function(a){return arguments.length?(e=a,j):e},j.subScale=function(a){return arguments.length?(f=a,j):f},j.subSeries=function(a){return arguments.length?(g=a,j):g},j.barWidth=function(a){return arguments.length?(h=b.functor(a),j):h},b.rebind(j,i,"key"),j}function aa(){var a=C,c=R(),d=F().selector("g.candlestick").element("g").attr("class","candlestick"),e=function(e){e.each(function(e,f){var g=e.filter(c.defined),h=d(this,g);h.enter().append("path");var i=O().width(c.width(g));h.each(function(a,d){var e=c.values(a,d),f=b.select(this).attr("class","candlestick "+e.direction).attr("transform","translate("+e.x+", "+e.yHigh+")");i.x(b.functor(0)).open(function(){return e.yOpen-e.yHigh}).high(function(){return e.yHigh-e.yHigh}).low(function(){return e.yLow-e.yHigh}).close(function(){return e.yClose-e.yHigh}),f.select("path").attr("d",i([a]))}),a(h,e,f)})};return e.decorate=function(b){return arguments.length?(a=b,e):a},b.rebind(e,d,"key"),x(e,c),e}function ba(){var a=Q(),c=b.functor(0),d=C,e=b.time.scale(),f=b.scale.linear(),g=F().selector("g.axis-adapter").element("g").attr({"class":"axis axis-adapter"}),h=function(b){b.each(function(b,i){var j,k=g(this,[b]);switch(h.orient()){case"top":case"bottom":j="translate(0,"+f(c(b))+")",a.scale(e);break;case"left":case"right":j="translate("+e(c(b))+",0)",a.scale(f);break;default:throw new Error("Invalid orientation")}k.enter().attr("transform",j),k.attr("transform",j),k.call(a),d(k,b,i)})};return h.baseline=function(a){return arguments.length?(c=b.functor(a),h):c},h.decorate=function(a){return arguments.length?(d=a,h):d},h.xScale=function(a){return arguments.length?(e=a,h):e},h.yScale=function(a){return arguments.length?(f=a,h):f},b.rebind(h,a,"orient","ticks","tickValues","tickSize","innerTickSize","outerTickSize","tickPadding","tickFormat")}function ca(){var a={};return a.distance=function(a,b){return b.getTime()-a.getTime()},a.offset=function(a,b){return new Date(a.getTime()+b)},a.clampUp=A,a.clampDown=A,a.copy=function(){return a},a}function da(a,b,c){var d=a.map(function(d,e){if(e<a.length-1)return b.clampUp(d);var f=b.clampUp(d);return f<c[1]?f:b.clampDown(d)}),e=d.reduce(function(a,b){return 0===a.filter(function(a){return a.getTime()===b.getTime()}).length&&a.push(b),a},[]);return e}function ea(a,c){function d(b){var d=a.domain(),e=a.range(),f=c.distance(d[0],d[1]),g=c.distance(d[0],b),h=g/f,i=h*(e[1]-e[0])+e[0];return i}return arguments.length||(a=b.time.scale(),c=ca()),d.invert=function(b){var d=a.domain(),e=a.range(),f=(b-e[0])/(e[1]-e[0]),g=c.distance(d[0],d[1]),h=f*g;return c.offset(d[0],h)},d.domain=function(b){if(!arguments.length)return a.domain();var e=c.clampUp(b[0]),f=c.clampDown(b[1]);return a.domain([e,f]),d},d.nice=function(){a.nice();var b=a.domain(),e=c.clampUp(b[0]),f=c.clampDown(b[1]);return a.domain([e,f]),d},d.ticks=function(){var b=a.ticks.apply(this,arguments);return da(b,c,d.domain())},d.copy=function(){return ea(a.copy(),c.copy())},d.discontinuityProvider=function(a){return arguments.length?(c=a,d):c},b.rebind(d,a,"range","rangeRound","interpolate","clamp","tickFormat")}function fa(){return ea()}function ga(){function a(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};return f.clampDown=function(c){if(c&&a(c)){var d=0===c.getDay()?2:1,e=b.time.day.ceil(c);return b.time.day.offset(e,-d)}return c},f.clampUp=function(c){if(c&&a(c)){var d=0===c.getDay()?1:2,e=b.time.day.floor(c);
return b.time.day.offset(e,d)}return c},f.distance=function(a,c){a=f.clampUp(a),c=f.clampDown(c);var g=b.time.saturday.ceil(a);if(g>c)return c.getTime()-a.getTime();var h=g.getTime()-a.getTime(),i=b.time.saturday.ceil(c),j=i.getTime()-c.getTime(),k=(i.getTime()-g.getTime())/e;return k*d+h-j},f.offset=function(c,e){var g=a(c)?f.clampUp(c):c,h=e,i=b.time.saturday.ceil(g);if(h-=i.getTime()-g.getTime(),0>h)return new Date(g.getTime()+e);g=b.time.day.offset(i,2);var j=Math.floor(h/d);return g=b.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f}function ha(){var a=b.time.scale(),c=b.scale.linear(),d=I(),e=C,f=J(),g=V().yValue(function(a,b){return a.force}),h=function(b){d.xScale(a).yScale(c).series([f,g]).mapping(function(a){return a===f?[0]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["annotations","indicator"][b]}),e(a,b,c)}),b.call(d)};return h.xScale=function(b){return arguments.length?(a=b,f.xScale(b),h):a},h.yScale=function(a){return arguments.length?(c=a,f.yScale(a),h):c},h.decorate=function(a){return arguments.length?(e=a,h):e},b.rebind(h,g,"yValue","xValue"),h}function ia(){var a=b.time.scale(),c=b.scale.linear(),d=80,e=20,f=I(),g=C,h=J(),i=V().yValue(function(a,b){return a.stochastic.d}),j=V().yValue(function(a,b){return a.stochastic.k}),k=function(b){f.xScale(a).yScale(c).series([h,i,j]).mapping(function(a){return a===h?[d,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi stochastic "+["annotations","stochastic-d","stochastic-k"][b]}),g(a,b,c)}),b.call(f)};return k.xScale=function(b){return arguments.length?(a=b,k):a},k.yScale=function(a){return arguments.length?(c=a,k):c},k.upperValue=function(a){return arguments.length?(d=a,k):d},k.lowerValue=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(g=a,k):g},b.rebind(k,i,"yDValue","xDValue"),b.rebind(k,j,"yKValue","xKValue"),k}function ja(){var a=b.time.scale(),c=b.scale.linear(),d=70,e=30,f=I(),g=C,h=J(),i=V().yValue(function(a,b){return a.rsi}),j=function(b){f.xScale(a).yScale(c).series([i,h]).mapping(function(a){return a===h?[d,50,e]:this}).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi rsi "+["indicator","annotations"][b]}),g(a,b,c)}),b.call(f)};return j.xScale=function(b){return arguments.length?(a=b,j):a},j.yScale=function(a){return arguments.length?(c=a,j):c},j.upperValue=function(a){return arguments.length?(d=a,j):d},j.lowerValue=function(a){return arguments.length?(e=a,j):e},j.decorate=function(a){return arguments.length?(g=a,j):g},b.rebind(j,i,"yValue","xValue"),j}function ka(){var a=b.time.scale(),c=b.scale.linear(),d=function(a){return a.date},e=function(a){return a.macd},f=V(),g=V(),h=S(),i=I(),j=C,k=function(b){f.xValue(d).yValue(function(a,b){return e(a).macd}),g.xValue(d).yValue(function(a,b){return e(a).signal}),h.xValue(d).yValue(function(a,b){return e(a).divergence}),i.xScale(a).yScale(c).series([h,f,g]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi "+["macd-divergence","macd","macd-signal"][b]}),j(a,b,c)}),b.call(i)};return k.xScale=function(b){return arguments.length?(a=b,k):a},k.xValue=function(a){return arguments.length?(d=a,k):d},k.yScale=function(a){return arguments.length?(c=a,k):c},k.root=function(a){return arguments.length?(e=a,k):e},k.decorate=function(a){return arguments.length?(j=a,k):j},k}function la(){var a=b.time.scale(),c=b.scale.linear(),d=function(a,b){return a.close},e=function(a,b){return a.date},f=function(a){return a.bollingerBands},g=C,h=Y().y0Value(function(a,b){return f(a).upper}).y1Value(function(a,b){return f(a).lower}),i=V().yValue(function(a,b){return f(a).upper}),j=V().yValue(function(a,b){return f(a).average}),k=V().yValue(function(a,b){return f(a).lower}),l=function(b){var d=I().xScale(a).yScale(c).series([h,i,k,j]).decorate(function(a,b,c){a.enter().attr("class",function(a,b){return"multi bollinger "+["area","upper","lower","average"][b]}),g(a,b,c)});h.xValue(e),i.xValue(e),j.xValue(e),k.xValue(e),b.call(d)};return l.xScale=function(b){return arguments.length?(a=b,l):a},l.yScale=function(a){return arguments.length?(c=a,l):c},l.xValue=function(a){return arguments.length?(e=a,l):e},l.yValue=function(a){return arguments.length?(d=a,l):d},l.root=function(a){return arguments.length?(f=a,l):f},l.decorate=function(a){return arguments.length?(g=a,l):g},l}function ma(){var a=b.functor(void 0),c=b.functor(10),d=C,e=A,f=function(b){var f=c.apply(this,arguments),g=b.slice(0,f).map(e);return b.map(function(b,c){return f-1>c?a(b,c):(c>=f&&(g.shift(),g.push(e(b,c))),d(g))})};return f.undefinedValue=function(c){return arguments.length?(a=b.functor(c),f):a},f.windowSize=function(a){return arguments.length?(c=b.functor(a),f):c},f.accumulator=function(a){return arguments.length?(d=a,f):d},f.value=function(a){return arguments.length?(e=a,f):e},f}function na(){var a=C,c=ma(),d=function(d){return b.zip(d,c(d)).forEach(function(b){a(b[0],b[1])})};return d.algorithm=function(a){return arguments.length?(c=a,d):c},d.merge=function(b){return arguments.length?(a=b,d):a},d}function oa(){var a=function(a,b){return a.volume},c=function(a,b){return a.close},d=ma().windowSize(2).accumulator(function(b){return(c(b[1])-c(b[0]))*a(b[1])}),e=function(a){return d(a)};return e.volumeValue=function(b){return arguments.length?(a=b,e):a},e.closeValue=function(a){return arguments.length?(c=a,e):c},b.rebind(e,d,"windowSize"),e}function pa(){var a=oa(),c=na().algorithm(a).merge(function(a,b){a.force=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"windowSize","volumeValue","closeValue"),d}function qa(){var a=function(a,b){return a.close},c=function(a,b){return a.high},d=function(a,b){return a.low},e=ma().windowSize(5).accumulator(function(e){var f=b.max(e,c),g=b.min(e,d);return 100*(a(e[e.length-1])-g)/(f-g)}),f=ma().windowSize(3).accumulator(function(a){return void 0===a[0]?void 0:b.mean(a)}),g=function(a){var b=e(a),c=f(b);return b.map(function(a,b){var d=c[b];return{k:a,d:d}})};return g.closeValue=function(b){return arguments.length?(a=b,g):a},g.highValue=function(a){return arguments.length?(c=a,g):c},g.lowValue=function(a){return arguments.length?(d=a,g):c},v(g,e,{kWindowSize:"windowSize"}),v(g,f,{dWindowSize:"windowSize"}),g}function ra(){var a=qa(),c=na().algorithm(a).merge(function(a,b){a.stochastic=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"kWindowSize","dWindowSize","lowValue","closeValue","highValue"),d}function sa(){var a=function(a,b){return a.open},c=function(a,b){return a.close},d=function(a){for(var b=1/a.length,c=a[0],d=1,e=a.length;e>d;d++)c=b*a[d]+(1-b)*c;return c},e=ma().windowSize(14).accumulator(function(b){for(var e=[],f=[],g=0,h=b.length;h>g;g++){var i=b[g],j=a(i),k=c(i);e.push(j>k?j-k:0),f.push(k>j?k-j:0)}var l=d(e);if(0===l)return 100;var m=d(f)/l;return 100-100/(1+m)}),f=function(a){return e(a)};return f.openValue=function(b){return arguments.length?(a=b,f):a},f.closeValue=function(a){return arguments.length?(c=a,f):c},b.rebind(f,e,"windowSize"),f}function ta(){var a=sa(),c=na().algorithm(a).merge(function(a,b){a.rsi=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"windowSize","openValue","closeValue"),d}function ua(){var a=ma().accumulator(b.mean).value(function(a){return a.close}),c=na().algorithm(a).merge(function(a,b){a.movingAverage=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"windowSize","undefinedValue","value"),d}function va(){function a(a){return Array.apply(null,new Array(a)).map(d)}var c=ma().accumulator(b.mean),d=b.functor(void 0),e=function(a){return void 0===a},f=function(b){for(var d=0;e(b[d])&&d<b.length;)d++;var f=b.slice(d);return a(d).concat(c(f))};return f.algorithm=function(a){return arguments.length?(c=a,f):c},f.undefinedValue=function(a){return arguments.length?(d=b.functor(a),f):d},f.defined=function(a){return arguments.length?(e=a,f):e},f}function wa(){var a=9,b=A,c=function(c){var d,e=2/(a+1),f=0;return c.map(function(c,g){if(a-1>g)return void(f+=b(c,g));if(g===a-1){f+=b(c,g);var h=f/a;return d=h,h}var i=b(c,g)*e+(1-e)*d;return d=i,i})};return c.windowSize=function(b){return arguments.length?(a=b,c):a},c.value=function(a){return arguments.length?(b=a,c):b},c}function xa(){var a=A,c=wa().windowSize(12),d=wa().windowSize(29),e=wa().windowSize(9),f=va().algorithm(e),g=function(e){c.value(a),d.value(a);var g=b.zip(c(e),d(e)).map(function(a){return void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}),h=f(g),i=b.zip(g,h).map(function(a){return{macd:a[0],signal:a[1],divergence:void 0!==a[0]&&void 0!==a[1]?a[0]-a[1]:void 0}});return i};return g.value=function(b){return arguments.length?(a=b,g):a},v(g,c,{fastPeriod:"windowSize"}),v(g,d,{slowPeriod:"windowSize"}),v(g,e,{signalPeriod:"windowSize"}),g}function ya(){var a=xa().value(function(a){return a.close}),c=na().algorithm(a).merge(function(a,b){a.macd=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"fastPeriod","slowPeriod","signalPeriod","value"),d}function za(){var a=wa().value(function(a){return a.close}),c=na().algorithm(a).merge(function(a,b){a.exponentialMovingAverage=b}),d=function(a){return c(a)};return b.rebind(d,c,"merge"),b.rebind(d,a,"windowSize","value"),d}function Aa(){var a=b.functor(0),c=A,d=function(b){if(0===b.length)return[];var d=c(b[a(b)]);return b.map(function(a,b){return(c(a,b)-d)/d})};return d.baseIndex=function(c){return arguments.length?(a=b.functor(c),d):a},d.value=function(a){return arguments.length?(c=a,d):c},d}function Ba(){var a=2,c=ma().undefinedValue({upper:void 0,average:void 0,lower:void 0}).accumulator(function(c){var d=b.mean(c),e=b.deviation(c);return{upper:d+a*e,average:d,lower:d-a*e}}),d=function(a){return c(a)};return d.multiplier=function(b){return arguments.length?(a=b,d):a},b.rebind(d,c,"windowSize","value"),d}function Ca(){var a=Ba().value(function(a){return a.close}),c=na().algorithm(a).merge(function(a,b){a.bollingerBands=b}),d=function(a){return c(a)};return d.root=function(a){return a.bollingerBands},b.rebind(d,c,"merge"),b.rebind(d,a,"windowSize","value","multiplier"),d}function Da(){var a="",b=function(a,b){return a[b]?Number(a[b]):0},c=function(c){var d=Object.keys(c[0]).filter(function(b){return b!==a}).map(function(d){var e=c.map(function(c){return{x:c[a],y:b(c,d)}});return e.key=d,e});return d};return c.xValueKey=function(b){return arguments.length?(a=b,c):a},c.yValue=function(a){return arguments.length?(b=a,c):b},c}function Ea(a,c,d,e,f){var g,h,i=b.random.normal(),j=a/c,k=new Array(c+1);for(h=1;h<k.length;h+=1)g=i(),g*=Math.sqrt(j),g*=e,g+=(d-e*e/2)*j,k[h]=Math.exp(g);for(k[0]=f,h=1;h<k.length;h+=1)k[h]=k[h-1]*k[h];return k}function Fa(){var a=.1,b=.1,c=100,d=1e5,e=new Date,f=50,g=.3,h=function(a){return!(0===a.getDay()||6===a.getDay())},i=function(a,b,c){for(var d,g=[],h=0,i=0;g.length<a;)d=b.slice(i,i+f),g.push({date:new Date(e.getTime()),open:d[0],high:Math.max.apply({},d),low:Math.min.apply({},d),close:d[f-1],volume:c[h]}),i+=f,h+=1,e.setUTCDate(e.getUTCDate()+1);return g},j=function(j){var k=new Date(e.getTime());k.setUTCDate(e.getUTCDate()+j);var l=315569e5,m=(k.getTime()-e.getTime())/l,n=Ea(m,j*f,a,b,c),o=Ea(m,j,0,b,d);return o=o.map(function(a){var b=Math.min(0,Math.max(g,1)),c=1+b*(1-2*Math.random());return Math.floor(a*c)}),c=n[n.length-1],d=o[o.length-1],i(j,n,o).filter(function(a){return!h||h(a.date)})};return j.mu=function(b){return arguments.length?(a=b,j):a},j.sigma=function(a){return arguments.length?(b=a,j):b},j.startPrice=function(a){return arguments.length?(c=a,j):c},j.startVolume=function(a){return arguments.length?(d=a,j):d},j.startDate=function(a){return arguments.length?(e=a,j):e},j.stepsPerDay=function(a){return arguments.length?(f=a,j):f},j.volumeNoiseFactor=function(a){return arguments.length?(g=a,j):g},j.filter=function(a){return arguments.length?(h=a,j):h},j}function Ga(){function a(a){return a[0].toLowerCase()+a.substr(1)}var c="YAHOO",d="GOOG",e=null,f=null,g=null,h=null,i=!1,j=null,k=a,l=function(a){var l=[];null!=e&&l.push("api_key="+e),null!=f&&l.push("start_date="+f.toISOString().substring(0,10)),null!=g&&l.push("end_date="+g.toISOString().substring(0,10)),null!=h&&l.push("rows="+h),i||l.push("order=asc"),null!=j&&l.push("collapse="+j);var m="https://www.quandl.com/api/v3/datasets/"+c+"/"+d+"/data.json?"+l.join("&");b.json(m,function(b,c){if(b)return void a(b);var d=c.dataset_data,e=k||function(a){return a},f=d.column_names.map(function(a,b){return[b,e(a)]}).filter(function(a){return a[1]}),g=d.data.map(function(a){var b={};return f.forEach(function(c){b[c[1]]=0===c[0]?new Date(a[c[0]]):a[c[0]]}),b});a(b,g)})};return l.database=function(a){return arguments.length?(c=a,l):c},l.dataset=function(a){return arguments.length?(d=a,l):d},l.apiKey=function(a){return arguments.length?(e=a,l):e},l.start=function(a){return arguments.length?(f=a,l):f},l.end=function(a){return arguments.length?(g=a,l):g},l.rows=function(a){return arguments.length?(h=a,l):h},l.descending=function(a){return arguments.length?(i=a,l):i},l.collapse=function(a){return arguments.length?(j=a,l):j},l.columnNameMap=function(a){return arguments.length?(k=a,l):k},l.defaultColumnNameMap=a,l}function Ha(){var a="BTC-USD",c=null,d=null,e=null,f=function(f){var g=[];null!=c&&g.push("start="+c.toISOString()),null!=d&&g.push("end="+d.toISOString()),null!=e&&g.push("granularity="+e);var h="https://api.exchange.coinbase.com/products/"+a+"/candles?"+g.join("&");b.json(h,function(a,b){return a?void f(a):(b=b.map(function(a){return{date:new Date(1e3*a[0]),open:a[3],high:a[2],low:a[1],close:a[4],volume:a[5]}}),void f(a,b))})};return f.product=function(b){return arguments.length?(a=b,f):a},f.start=function(a){return arguments.length?(c=a,f):c},f.end=function(a){return arguments.length?(d=a,f):d},f.granularity=function(a){return arguments.length?(e=a,f):e},f}function Ia(){function a(a){function c(b){return a.filter(function(a){return e(a)===b})[0]}var d=j.xValue(),e=j.yValue(),f=b.max(a,e),g=b.min(a,e);return[{x:d(a[0]),y:e(a[0])},{x:d(c(f)),y:f},{x:d(c(g)),y:g},{x:d(a[a.length-1]),y:e(a[a.length-1])}]}var c=fa(),e=b.scale.linear(),f=2,g=V(),h=L().xValue(function(a){return a.x}).yValue(function(a){return a.y}).decorate(function(a){a.attr("class",function(a,b){switch(b){case 0:return"open";case 1:return"high";case 2:return"low";case 3:return"close"}})}),i=I().series([g,h]).mapping(function(b){switch(b){case h:return a(this);default:return this}}),j=function(a){h.radius(f),a.each(function(a){var g=b.select(this),h=d(this),j=f;c.range([j,h.width-j]),e.range([h.height-j,j]),i.xScale(c).yScale(e),g.call(i)})};return v(j,c,{xDiscontinuityProvider:"discontinuityProvider",xDomain:"domain"}),v(j,e,{yDomain:"domain"}),v(j,g,"xValue","yValue"),j.xScale=function(){return c},j.yScale=function(){return e},j.radius=function(a){return arguments.length?(f=a,j):f},j}function Ja(){var a=20,c=0,d=V(),e=fa(),f=b.scale.linear(),g=Q().scale(e).orient("bottom"),h=Q().scale(f).orient("left"),i=function(i){i.each(function(i){var j=b.select(this),k={position:"absolute",top:0,right:c,bottom:a,left:0},l=j.selectAll("rect.background").data([i]);l.enter().append("rect").attr("class","background").layout(k);var m=j.selectAll("svg.plot-area").data([i]);m.enter().append("svg").attr({"class":"plot-area"}).layout(k);var n=j.selectAll("g.x-axis").data([i]);n.enter().append("g").attr("class","axis x-axis").layout({position:"absolute",left:0,bottom:0,right:c,height:a});var o=j.selectAll("g.y-axis").data([i]);o.enter().append("g").attr("class","axis y-axis").layout({position:"absolute",top:0,right:0,bottom:a,width:c}),j.layout(),e.range([0,n.layout("width")]),f.range([o.layout("height"),0]),n.call(g),o.call(h),d.xScale(e).yScale(f),m.call(d)})};return v(i,e,{xDiscontinuityProvider:"discontinuityProvider",xDomain:"domain",xNice:"nice"}),v(i,f,{yDomain:"domain",yNice:"nice"}),x(i,g,"x","scale"),x(i,h,"y","scale"),i.xScale=function(){return e},i.yScale=function(){return f},i.plotArea=function(a){return arguments.length?(d=a,i):d},i.xAxisHeight=function(b){return arguments.length?(a=b,i):a},i.yAxisWidth=function(a){return arguments.length?(c=a,i):c},i}function Ka(){var a=C,c=C,d=[["datum",function(a){return a.datum}]],e=F().selector("table.legend").element("table").attr("class","legend"),f=F().selector("tr.row").element("tr").attr("class","row"),g=function(g){g.each(function(g,h){var i=b.select(this),j=d.map(function(a,c){return{datum:g,header:b.functor(a[0]),value:b.functor(a[1])}}),k=e(i,[j]),l=f(k),m=l.enter();m.append("th"),m.append("td"),l.select("th").html(function(a,b){return a.header.call(this,a.datum,b)}),l.select("td").html(function(a,b){return a.value.call(this,a.datum,b)}),a(k,g,h),c(l,g,h)})};return g.items=function(a){return arguments.length?(d=a,g):d},g.rowDecorate=function(a){return arguments.length?(c=a,g):c},g.tableDecorate=function(b){return arguments.length?(a=b,g):a},g}function La(a,c){function d(a,b){t(a)?a.rangePoints(b,1):a.range(b)}a=a||b.scale.linear(),c=c||b.scale.linear();var e={bottom:30,right:30},f="",g="",h=null,i=null,j="",k=V(),l=C,m=ba().orient("bottom").baseline(function(){if(null!==h)return c(h.apply(this,arguments));var a=u(c);return"bottom"===m.orient()?a[0]:a[1]}),n=ba().orient("right").baseline(function(){if(null!==i)return a(i.apply(this,arguments));var b=u(a);return"left"===n.orient()?b[0]:b[1]}),o=F().selector("svg.cartesian-chart").element("svg").attr({"class":"cartesian-chart","layout-style":"flex: 1"}),p=function(h){h.each(function(h,i){var p=b.select(this),q=o(p,[h]);q.enter().html('<g class="title">                         <g layout-style="height: 0; width: 0">                             <text class="label"/>                         </g>                     </g>                     <g class="y-axis">                         <g layout-style="height: 0; width: 0">                             <text class="label"/>                         </g>                     </g>                     <g class="x-axis">                         <g layout-style="height: 0; width: 0">                             <text class="label"/>                         </g>                     </g>                     <g class="plot-area-container">                         <rect class="background"                             layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                         <svg class="axes-container"                             layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0">                             <g class="x-axis" layout-style="height: 0; width: 0"/>                             <g class="y-axis" layout-style="height: 0; width: 0"/>                         </svg>                         <svg class="plot-area"                             layout-style="position: absolute; top: 0; bottom: 0; left: 0; right: 0"/>                     </g>');var r=E(e);q.select(".plot-area-container").layout({position:"absolute",top:r.top,left:r.left,bottom:r.bottom,right:r.right}),q.select(".title").layout({position:"absolute",top:0,alignItems:"center",left:r.left,right:r.right});var s={position:"absolute",top:r.top,bottom:r.bottom,alignItems:"center",flexDirection:"row"};s[n.orient()]=0,q.select(".y-axis").attr("class","y-axis "+n.orient()).layout(s);var t={position:"absolute",left:r.left,right:r.right,alignItems:"center"};t[m.orient()]=0,q.select(".x-axis").attr("class","x-axis "+m.orient()).layout(t),p.layout(),q.select(".title .label").text(j),q.select(".y-axis .label").text(f).attr("transform","right"===n.orient()?"rotate(90)":"rotate(-90)"),q.select(".x-axis .label").text(g);var u=q.select(".plot-area");d(a,[0,u.layout("width")]),d(c,[u.layout("height"),0]),m.xScale(a).yScale(b.scale.identity()),n.yScale(c).xScale(b.scale.identity()),q.select(".axes-container .x-axis").call(m),q.select(".axes-container .y-axis").call(n),k.xScale(a).yScale(c),u.call(k),l(q,h,i)})},q=[/range\w*/,/tickFormat/];x(p,a,"x",q),x(p,c,"y",q);var r=["baseline","xScale","yScale"];return x(p,m,"x",r),x(p,n,"y",r),p.xBaseline=function(a){return arguments.length?(h=b.functor(a),p):h},p.yBaseline=function(a){return arguments.length?(i=b.functor(a),p):i},p.chartLabel=function(a){return arguments.length?(j=a,p):j},p.plotArea=function(a){return arguments.length?(k=a,p):k},p.xLabel=function(a){return arguments.length?(g=a,p):g},p.margin=function(a){return arguments.length?(e=a,p):e},p.yLabel=function(a){return arguments.length?(f=a,p):f},p.decorate=function(a){return arguments.length?(l=a,p):l},p}function Ma(){var a=b.time.scale(),c=b.scale.linear(),d=10,e=10,f=C,g=C,h=F().selector("line.x").element("line").attr("class","x gridline"),i=F().selector("line.y").element("line").attr("class","y gridline"),j=function(b){b.each(function(b,j){var k=a.ticks(d),l=h(this,k);l.attr({x1:a,x2:a,y1:c.range()[0],y2:c.range()[1]}),f(l,k,j);var m=c.ticks(e),n=i(this,m);n.attr({x1:a.range()[0],x2:a.range()[1],y1:c,y2:c}),g(n,m,j)})};return j.xScale=function(b){return arguments.length?(a=b,j):a},j.yScale=function(a){return arguments.length?(c=a,j):c},j.xTicks=function(a){return arguments.length?(d=a,j):d},j.yTicks=function(a){return arguments.length?(e=a,j):e},j.yDecorate=function(a){return arguments.length?(g=a,j):g},j.xDecorate=function(a){return arguments.length?(f=a,j):f},j}function Na(){var a,c,d,e,f=b.time.scale(),g=b.scale.linear(),h=function(){return u(f)[0]},i=function(){return u(f)[1]},j=function(){return u(g)[0]},k=function(){return u(g)[1]},l=C,m=F().selector("g.annotation").element("g").attr("class","annotation"),n=function(a){a.each(function(a,c){var d=b.select(this),e=m(d,a);e.enter().append("path").classed("band",!0);var f=P().horizontalAlign("right").verticalAlign("top").x(h).y(j).height(function(){return k.apply(this,arguments)-j.apply(this,arguments)}).width(function(){return i.apply(this,arguments)-h.apply(this,arguments)});e.select("path").attr("d",function(a,b){return f.call(this,[a],b)}),l(e,a,c)})};return n.xScale=function(a){return arguments.length?(f=a,n):f},n.yScale=function(a){return arguments.length?(g=a,n):g},n.decorate=function(a){return arguments.length?(l=a,n):l},n.x0=function(c){return arguments.length?(a=b.functor(c),h=function(){return f(a.apply(this,arguments))},n):a},n.x1=function(a){return arguments.length?(c=b.functor(a),i=function(){return f(c.apply(this,arguments))},n):c},n.y0=function(a){return arguments.length?(d=b.functor(a),j=function(){return g(d.apply(this,arguments))},n):d},n.y1=function(a){return arguments.length?(e=b.functor(a),k=function(){return g(e.apply(this,arguments))},n):e},n}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b;var Oa={get isOrdinal(){return t},get range(){return u}},Pa={get context(){return z},get identity(){return A},get index(){return B},get noop(){return C}};b.selection.prototype.layoutSuspended=l,b.transition.prototype.layoutSuspended=l,b.selection.prototype.layout=m,b.transition.prototype.layout=m;var Qa=1e-6,Ra={dataJoin:F,expandMargin:E,extent:D,fn:Pa,fractionalBarWidth:y,innerDimensions:d,rebind:v,rebindAll:x,scale:Oa,noSnap:o,pointSnap:p,seriesPointSnap:q,seriesPointSnapXOnly:r,seriesPointSnapYOnly:s,render:n},Sa={crosshair:M,fibonacciFan:H,measure:G},Ta={axis:Q,bar:P,candlestick:O,ohlc:N},Ua={area:Z,bar:X,stack:U,line:W},Va={area:Y,axis:ba,bar:S,candlestick:aa,cycle:_,line:V,multi:I,ohlc:$,point:L,stacked:Ua,groupedBar:T,xyBase:K,ohlcBase:R};fa.tickTransformer=da;var Wa={discontinuity:{identity:ca,skipWeekends:ga},dateTime:fa},Xa={bollingerBands:la,macd:ka,relativeStrengthIndex:ja,stochasticOscillator:ia,forceIndex:ha},Ya={bollingerBands:Ba,exponentialMovingAverage:wa,macd:xa,percentageChange:Aa,relativeStrengthIndex:sa,stochasticOscillator:qa,slidingWindow:ma,undefinedInputAdapter:va,forceIndex:oa},Za={bollingerBands:Ca,calculator:Ya,exponentialMovingAverage:za,macd:ya,merge:na,movingAverage:ua,relativeStrengthIndex:ta,stochasticOscillator:ra,forceIndex:pa},$a={algorithm:Za,renderer:Xa},_a={financial:Fa,walk:Ea},ab={coinbase:Ha,quandl:Ga},bb={feed:ab,random:_a,spread:Da},cb={cartesian:La,legend:Ka,linearTimeSeries:Ja,sparkline:Ia},db={band:Na,gridline:Ma,line:J},eb="3.0.0",fb={annotation:db,chart:cb,data:bb,indicator:$a,scale:Wa,series:Va,svg:Ta,tool:Sa,util:Ra,version:eb};return fb});
