...
var scale = Object.freeze({
      ...
      var cartesian = function cartesian(selection) {
          ...
          selection.each(function (data, index) {
              ...
              svg.enter().call(function (s) {
                  ...
                  // label containers
                  plotContainer.append('g').classed('x-axis label-container', true).append('g').layout({ height: 0, width: 0 }).append('text').classed('label', true).attr('dy', '-0.5em');
                  plotContainer.append('g').classed('y-axis label-container', true).append('g').layout({ height: 0, width: 0 }).append('text').classed('label', true);
                  plotContainer.append('g').classed('title label-container', true).append('g').layout({ height: 0, width: 0 }).append('text').classed('label', true);
              });
  ...
  */
  ...
  function calculator$3 () {
      ...
      var makeAccumulator = function makeAccumulator(prevClose, prevDownChangesAvg, prevUpChangesAvg) {
          return function (closes) {
              ...
              closes.forEach(function (close) {
                  var downChange = prevClose < close ? 0 : prevClose - close;
                  var upChange = prevClose > close ? 0 : close - prevClose;
