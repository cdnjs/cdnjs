  ...
  methods: {
    ...
    renderOptions: function renderOptions(options, selectedOption, tabIndex) {
      ...
      var renderOption = function renderOption(option) {
        ...
        }, [h("span", [option[_this4.textKey]]), isSelected ? h(es_icon, {
          "attrs": {
            "name": "success"
          },
...
// EXTERNAL MODULE: ./node_modules/@vant/popperjs/lib/index.js
...
/* harmony default export */ var popover = (popover_createComponent({
  ...
  methods: {
    createPopper: function createPopper() {
      return Object(lib["createPopper"])(this.$refs.wrapper, this.$refs.popover.$el, {
