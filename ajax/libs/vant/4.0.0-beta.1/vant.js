(function(global, factory) {
  ...
  var stdin_default$1p = vue.defineComponent({
    ...
    setup(props, {
      ...
      const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => vue.createVNode(stdin_default$1q, {
  ...
  var stdin_default$10 = vue.defineComponent({
    ...
    setup(props, {
      ...
      return () => {
        ...
        }) : [renderHeader(), (_a = slots["nav-bottom"]) == null ? void 0 : _a.call(slots)], vue.createVNode(stdin_default$11, {
          "ref": contentRef,
