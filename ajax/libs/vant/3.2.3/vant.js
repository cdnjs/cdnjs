(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("vue")) : typeof define === "function" && define.amd ? define(["exports", "vue"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.vant = {}, global2.Vue));
  ...
  function useScrollParent(el, root2 = defaultRoot) {
    ...
    vue.onMounted(() => {
      if (el.value) {
        scrollParent2.value = getScrollParent$1(el.value, root2);
      }
    });
  ...
  var _ActionBarButton = vue.defineComponent({
    ...
    setup(props2, {
      ...
      var isFirst = vue.computed(() => {
        if (parent) {
          var prev2 = parent.children[index2.value - 1];
          return !(prev2 && "isButton" in prev2);
        }
      });
  ...
  var _Sticky = vue.defineComponent({
    ...
    setup(props2, {
      ...
      var root2 = vue.ref();
      var scrollParent2 = useScrollParent(root2);
      var state = vue.reactive({
        fixed: false,
        width: 0,
        height: 0,
  ...
  var _Tabs = vue.defineComponent({
    ...
    setup(props2, {
      ...
      var wrapRef = vue.ref();
      var windowSize = useWindowSize();
      var scroller = useScrollParent(root2);
      ...
      var setLine = () => {
        ...
        vue.nextTick(() => {
          var titles = titleRefs.value;
          if (!titles || !titles[state.currentIndex] || props2.type !== "line" || isHidden(root2.value)) {
            return;
          }
          var title = titles[state.currentIndex].$el;
          var {
  ...
  var _DatetimePicker = vue.defineComponent({
    ...
    setup(props2, {
      ...
      useExpose({
        getPicker: () => {
          var _root$value;
          return (_root$value = root2.value) == null ? void 0 : _root$value.getPicker();
        }
      });
      return () => {
  ...
  var _SwipeCell = vue.defineComponent({
    ...
    setup(props2, {
      ...
      useClickAway(root2, () => onClick("outside"), {
        eventName: "touchstart"
      });
      return () => {
        var wrapperStyle = {
  ...
  var _Tabbar = vue.defineComponent({
    ...
    setup(props2, {
      ...
      var renderPlaceholder = usePlaceholder(root2, bem$3);
      var enableSafeArea = () => {
