...
dialog_Dialog.Component = withInstall(Dialog);
  ...
  setup(props, {
    ...
    var onAreaConfirm = values => {
      ...
      if (values.some(value => !value.code)) {
        toast_Toast(AddressEdit_t('areaEmpty'));
        return;
      }
  ...
  setup(props, {
    ...
    var checkRange = date => {
      ...
      if (maxRange && calcDateNum(date) > maxRange) {
        toast_Toast(rangePrompt || utils_t('rangePrompt', maxRange));
        return false;
      }
    ...
    var onClickDay = item => {
      ...
      if (type === 'range') {
        ...
        if (selected) {
          ...
          toast_Toast(props.rangePrompt || utils_t('rangePrompt', props.maxRange));
        } else {
...
image_preview_ImagePreview.Component = withInstall(ImagePreview);
...
notify_Notify.Component = withInstall(Notify);
  ...
  setup(props, {
    ...
    var previewImage = item => {
      if (props.previewFullImage) {
        ...
        imagePreview = image_preview_ImagePreview(_extends({
          images,
