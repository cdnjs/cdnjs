import { type MethodData, Method } from '../types/Method';
...
export declare function keccak256Method(data: object | string | Uint8Array | null): string;
...
export declare const COMPACT_BYTES_ARRAY_STRING_AT_END: RegExp;
