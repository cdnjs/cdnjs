 ...
 */
export declare function encodeKeyValue(valueContent: string, valueType: ERC725JSONSchemaValueType | string, decodedValue: string | string[] | number | number[] | URLDataToEncode | URLDataToEncode[] | boolean | boolean[] | Array<string | string[] | number | number[] | URLDataToEncode | URLDataToEncode[] | boolean | boolean[]>, name?: string): string | false;
/**
 *
...
decodedValues: Array<string | number | URLDataToEncode | boolean | (string | number | boolean)[]>) => string;
/**
 *
 ...
 */
export declare function encodeKey(schema: ERC725JSONSchema, value: string | number | URLDataToEncode | URLDataToEncode[] | boolean | Array<string | number | (string | number | boolean | string[])[] | URLDataToEncode | URLDataToEncode[] | boolean>, startingIndex?: number, totalArrayLength?: number): string | false | {
    key: string;
    value: string;
}[] | null;
/**
