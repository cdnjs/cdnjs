...
import { DynamicNameSchema, ERC725JSONSchema, ERC725JSONSchemaKeyType, ERC725JSONSchemaValueContent, ERC725JSONSchemaValueType } from './types/ERC725JSONSchema';
...
export declare class ERC725 {
     ...
     */
    getSchema(keyOrKeys: string[], providedSchemas?: ERC725JSONSchema[]): Record<string, ERC725JSONSchema | DynamicNameSchema | null>;
    getSchema(keyOrKeys: string, providedSchemas?: ERC725JSONSchema[]): ERC725JSONSchema | DynamicNameSchema | null;
    /**
