...
const getDataMultiple = (erc725Options, keyNames) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allRawData = yield ((_b = erc725Options.provider) === null || _b === void 0 ? void 0 : _b.getAllData(erc725Options.address, schemas.map((schema) => schema.key)));
 ...
 */
export const getData = (erc725Options, keyOrKeys) => __awaiter(void 0, void 0, void 0, function* () {
    if (!keyOrKeys) {
