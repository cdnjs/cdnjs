    ...
    static supportsInterface(interfaceIdOrName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return supportsInterface(interfaceIdOrName, {
                ...
                provider: ERC725.initializeProvider(options.rpcUrl, (options === null || options === void 0 ? void 0 : options.gas) ? options === null || options === void 0 ? void 0 : options.gas : DEFAULT_GAS_VALUE),
            });
        });
    }
    /**
