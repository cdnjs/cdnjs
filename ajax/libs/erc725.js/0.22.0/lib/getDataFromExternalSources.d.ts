...
export declare const getDataFromExternalSources: (schemas: ERC725JSONSchema[], dataFromChain: DecodeDataOutput[], ipfsGateway: string) => Promise<GetDataExternalSourcesOutput[]>;
