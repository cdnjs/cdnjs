...
export class ProviderWrapper {
    constructor(provider, gasInfo) {
        if (typeof provider.request === 'function') {
            this.type = "ETHEREUM" /* ProviderTypes.ETHEREUM */;
        }
        else {
            this.type = "WEB3" /* ProviderTypes.WEB3 */;
        }
    ...
    supportsInterface(address, interfaceId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.type === "ETHEREUM" /* ProviderTypes.ETHEREUM */) {
    ...
    isValidSignature(address, hash, signature) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.type === "ETHEREUM" /* ProviderTypes.ETHEREUM */) {
                ...
                const result = yield this.callContract(constructJSONRPC(address, Method.IS_VALID_SIGNATURE, this.gas, encodedParams));
                if (result.error) {
                    throw result.error;
                }
            ...
            const results = yield this.callContract([
                constructJSONRPC(address, Method.IS_VALID_SIGNATURE, this.gas, encodedParams),
            ]);
            if (results.error) {
                throw results.error;
            }
    ...
    _getAllDataGeneric(address, keyHashes, method) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.type === "ETHEREUM" /* ProviderTypes.ETHEREUM */) {
                const encodedResults = yield this.callContract(constructJSONRPC(address, method, this.gas, abiCoder.encodeParameter('bytes32[]', keyHashes)));
            ...
            const payload = [
                constructJSONRPC(address, method, this.gas, abiCoder.encodeParameter('bytes32[]', keyHashes)),
            ];
