 ...
 * @date 2020
 */
import { checkAddressChecksum, hexToBytes, isAddress, leftPad, numberToHex, padLeft, stripHexPrefix, } from 'web3-utils';
...
export function encodeKeyValue(valueContent, valueType, decodedValue, name) {
    const isSupportedValueContent = !!valueContentMap(valueContent) || valueContent.slice(0, 2) === '0x';
...
export const encodeTupleKeyValue = (valueContent, // i.e. (bytes4,Number,bytes16)
