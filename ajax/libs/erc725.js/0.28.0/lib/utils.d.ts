 ...
 * @date 2020
 */
import type { URLDataToEncode, EncodeDataReturn, URLDataWithHash, Verification } from '../types';
import type { ERC725JSONSchema, ERC725JSONSchemaKeyType, ERC725JSONSchemaValueType } from '../types/ERC725JSONSchema';
import { type SUPPORTED_VERIFICATION_METHODS, type SUPPORTED_VERIFICATION_METHOD_STRINGS } from '../constants/constants';
 ...
 */
export declare function encodeKeyValue(valueContent: string, valueType: ERC725JSONSchemaValueType | string, decodedValue: string | string[] | bigint | bigint[] | number | number[] | URLDataToEncode | URLDataToEncode[] | boolean | boolean[] | Array<string | string[] | bigint | bigint[] | number | number[] | URLDataToEncode | URLDataToEncode[] | boolean | boolean[]>, name?: string): string | false;
/**
 *
 ...
 */
export declare function encodeArrayKey(key: string, index: number): `0x${string}`;
/**
 *
...
export declare const encodeTupleKeyValue: (valueContent: string, // i.e. (Bytes4,Number,Bytes16,Address)
valueType: string, // i.e. (bytes4,uint128,bytes16,address)
decodedValues: Array<string | number | bigint | URLDataToEncode | boolean | (string | number | boolean)[]>) => string;
/**
 *
 ...
 */
export declare function encodeKey(schema: ERC725JSONSchema, value: string | bigint | number | URLDataToEncode | URLDataToEncode[] | boolean | Array<string | bigint | number | (string | bigint | number | boolean | string[])[] | URLDataToEncode | URLDataToEncode[] | boolean>, startingIndex?: number, totalArrayLength?: number): string | false | {
    key: string;
    value: string;
}[] | null;
/**
 ...
 */
export declare function patchIPFSUrlsIfApplicable(receivedData: URLDataWithHash, ipfsGateway: string | ERC725Options): URLDataWithHash;
export declare function countNumberOfBytes(data: Hex): number;
export declare function countSignificantBits(data: Hex): number;
/**
