...
value: string | string[] | bigint | bigint[] | number | number[] | boolean | boolean[]): string;
...
export declare function encodeValueContent(valueContent: string, value: string | bigint | AssetURLEncode | URLDataToEncode | boolean | unknown): string;
export declare function decodeValueContent(valueContent: string, value: string): string | URLDataWithHash | bigint | boolean | null;
