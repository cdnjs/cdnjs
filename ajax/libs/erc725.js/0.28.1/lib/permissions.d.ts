...
export declare function encodePermissions(permissions: Permissions): Hex;
export declare function decodePermissions(permissionHex: Hex): {
    CHANGEOWNER: boolean;
 ...
 */
export declare const checkPermissions: (requiredPermissions: string[] | string, _grantedPermissions: Hex) => boolean;
