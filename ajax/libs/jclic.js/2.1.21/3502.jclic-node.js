...
/* harmony export */ });
/* unused harmony exports HolePuzzle, HolePuzzlePanel */
 ...
 */
class HolePuzzle extends _Activity_js__WEBPACK_IMPORTED_MODULE_1__/* .Activity */ .I {
  /**
 ...
 */
class HolePuzzlePanel extends _Activity_js__WEBPACK_IMPORTED_MODULE_1__/* .ActivityPanel */ .S {
  /**
  ...
  buildVisualComponents() {
    ...
    if (abc) {
      ...
      this.parkBg = new _boxes_ActiveBoxGrid_js__WEBPACK_IMPORTED_MODULE_2__["default"](null, this, abc.style, this.act.margin, this.act.margin,
        this.hiddenBox.dim.width, this.hiddenBox.dim.height, new _shapers_Rectangular_js__WEBPACK_IMPORTED_MODULE_5__["default"](1, 1));
  ...
  setDimension(preferredMaxSize) {
    return !this.bg || !this.parkBg || this.getBounds().equals(preferredMaxSize) ?
      preferredMaxSize :
      _boxes_BoxBag_js__WEBPACK_IMPORTED_MODULE_3__["default"].layoutDouble(preferredMaxSize, this.bg, this.parkBg, this.act.boxGridPos, this.act.margin);
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_Activity_js__WEBPACK_IMPORTED_MODULE_1__/* .Activity */ .I.registerClass('@puzzles.HolePuzzle', HolePuzzle));
...
;
//# sourceMappingURL=3502.jclic-node.js.map