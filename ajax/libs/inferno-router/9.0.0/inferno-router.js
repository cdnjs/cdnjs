(function (global, factory) {
    ...
    function matchPath(pathname, options) {
      ...
      var _options = options,
        ...
        initialData = _options$initialData === undefined ? {} : _options$initialData;
    ...
    function _objectWithoutPropertiesLoose$5(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (e.includes(n)) continue; t[n] = r[n]; } return t; }
    ...
    var Route = /*#__PURE__*/function (_Component) {
      function Route(props, context) {
        ...
        _this.state = {
          __loaderData__: match == null ? undefined : match.loaderData,
          match: match
        };
        return _this;
      }
    ...
    function _isSwitch(node) {
      ...
      return (node == null || (_node$type = node.type) == null ? undefined : _node$type.prototype) instanceof Switch || (node == null ? undefined : node.type) === Switch;
    }
    function _isRoute(node) {
      ...
      return (node == null || (_node$type2 = node.type) == null ? undefined : _node$type2.prototype) instanceof Route || (node == null ? undefined : node.type) === Route;
    }
    ...
    function _traverseLoaders(location, tree, base, parentIsSwitch) {
      ...
      if (_isRoute(tree) && tree.props) {
        ...
        var _tree$props = tree.props,
          ...
          exact = _tree$props$exact === undefined ? false : _tree$props$exact,
          _tree$props$strict = _tree$props.strict,
          strict = _tree$props$strict === undefined ? false : _tree$props$strict,
          _tree$props$sensitive = _tree$props.sensitive,
          sensitive = _tree$props$sensitive === undefined ? false : _tree$props$sensitive;
      ...
      // Traverse children
      var children = (_tree$children = tree.children) != null ? _tree$children : (_tree$props4 = tree.props) == null ? undefined : _tree$props4.children;
    ...
    function createClientSideURL(location, base) {
      if (base === undefined && typeof window !== 'undefined') {
        ...
        base = ((_window = window) == null || (_window = _window.location) == null ? undefined : _window.origin) !== 'null' ? window.location.origin : window.location.href;
      }
    ...
    var Router = /*#__PURE__*/function (_Component) {
      ...
      _proto.getChildContext = function getChildContext() {
        ...
        router.route = {
          ...
          match: (_this$state = this.state) == null ? undefined : _this$state.match // Why are we sending this? it appears useless.
        };
        router.initialData = (_this$state2 = this.state) == null ? undefined : _this$state2.initialData; // this is a dictionary of all data available
        return {
          router: router
        };
      };
      ...
      _proto.componentWillMount = function componentWillMount() {
        ...
        if (isUndefined(this.props.initialData)) {
          var _this$state3;
          this._matchAndResolveLoaders((_this$state3 = this.state) == null ? undefined : _this$state3.match);
        }
      };
    ...
    function _objectWithoutPropertiesLoose$4(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (e.includes(n)) continue; t[n] = r[n]; } return t; }
    ...
    function handleClick(_ref, event) {
      ...
      !isModifiedEvent(event) // ignore clicks with modifier keys
        ...
        var _props$replace = props.replace,
          replace = _props$replace === undefined ? false : _props$replace,
          toPropIn = props.to;
    ...
    var Redirect = /*#__PURE__*/function (_Component) {
      ...
      _proto.isStatic = function isStatic() {
        ...
        return Boolean((_this$context$router = this.context.router) == null ? undefined : _this$context$router.staticContext);
      };
      _proto.componentWillMount = function componentWillMount() {
      ...
      _proto.perform = function perform() {
        ...
        var _this$props = this.props,
          ...
          push = _this$props$push === undefined ? false : _this$props$push,
          to = _this$props.to;
        if (push) {
          history.push(to);
        } else {
    ...
    function useLoaderData(props) {
      ...
      return (_props$__loaderData__ = props.__loaderData__) == null ? undefined : _props$__loaderData__.res;
    }
    function useLoaderError(props) {
      var _props$__loaderData__2;
      return (_props$__loaderData__2 = props.__loaderData__) == null ? undefined : _props$__loaderData__2.err;
    }
