...
`}),n}get nodeName(){return"OBJECT"}get data(){return this.getAttribute("data")}set data(e){if(e){const n=document.createAttribute("data");n.value=e,this.attributes.setNamedItem(n)}else this.attributes.removeNamedItem("data")}static isInterdictable(e){if(cn(e))return!1;if(0<e.getElementsByTagName("ruffle-object").length||0<e.getElementsByTagName("ruffle-embed").length)return!1;const n=e.attributes.getNamedItem("data")?.value.toLowerCase(),t=e.attributes.getNamedItem("type")?.value??null,a=kn(e);let r;if(n){if(ln(n))return un(e,"data"),!1;r=n}else{if(!a||!a.movie)return!1;if(ln(a.movie)){const n=e.querySelector("param[name='movie']");if(n){un(n,"value");const t=n.getAttribute("value");t&&e.setAttribute("data",t)}return!1}r=a.movie}var o=e.attributes.getNamedItem("classid")?.value.toLowerCase();return o==="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase()?!Array.from(e.getElementsByTagName("object")).some(yn.isInterdictable)&&!Array.from(e.getElementsByTagName("embed")).some(D.isInterdictable):!o&&Ne(r,t)}static fromNativeObjectElement(e){const n=en("ruffle-object",yn),t=document.createElement(n);for(const n of Array.from(e.getElementsByTagName("embed")))D.isInterdictable(n)&&n.remove();for(const n of Array.from(e.getElementsByTagName("object")))yn.isInterdictable(n)&&n.remove();return wn(e,t),t}get height(){return this.getAttribute("height")||""}set height(e){this.setAttribute("height",e)}get width(){return this.getAttribute("width")||""}set width(e){this.setAttribute("width",e)}get type(){return this.getAttribute("type")||""}set type(e){this.setAttribute("type",e)}}class Rn{constructor(n){if(this.__mimeTypes=[],this.__namedMimeTypes={},n)for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=new xn(e),t=this.__mimeTypes.length;this.__mimeTypes.push(n),this.__namedMimeTypes[e.type]=n,this[n.type]=n,this[t]=n}item(e){return this.__mimeTypes[e>>>0]}namedItem(e){return this.__namedMimeTypes[e]}get length(){return this.__mimeTypes.length}[Symbol.iterator](){return this.__mimeTypes[Symbol.iterator]()}get[Symbol.toStringTag](){return"MimeTypeArray"}}class xn{constructor(e){this.__mimeType=e}get type(){return this.__mimeType.type}get description(){return this.__mimeType.description}get suffixes(){return this.__mimeType.suffixes}get enabledPlugin(){return this.__mimeType.enabledPlugin}get[Symbol.toStringTag](){return"MimeType"}}class zn{constructor(n){this.__plugins=[],this.__namedPlugins={};for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=this.__plugins.length;this.__plugins.push(e),this.__namedPlugins[e.name]=e,this[e.name]=e,this[n]=e}item(e){return this.__plugins[e>>>0]}namedItem(e){return this.__namedPlugins[e]}refresh(){}[Symbol.iterator](){return this.__plugins[Symbol.iterator]()}get[Symbol.toStringTag](){return"PluginArray"}get length(){return this.__plugins.length}}const M=new class extends Rn{constructor(e,n,t){super(),this.name=e,this.description=n,this.filename=t}}("Shockwave Flash","Shockwave Flash 32.0 r0","ruffle.js"),jn=(M.install({type:We,description:"Shockwave Flash",suffixes:"spl",enabledPlugin:M}),M.install({type:$e,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),M.install({type:Le,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),M.install({type:_e,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),window.RufflePlayer?.config??{}),Sn=function(e){let n=Ue?.href??"";return""===(n=!j&&"publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(jn)+"ruffle.js";let Cn,En,An,qn;function Fn(){try{Cn=Cn??document.getElementsByTagName("object"),En=En??document.getElementsByTagName("embed");for(const t of Array.from(Cn)){var e;yn.isInterdictable(t)&&(e=yn.fromNativeObjectElement(t),t.replaceWith(e))}for(const a of Array.from(En)){var n;D.isInterdictable(a)&&(n=D.fromNativeEmbedElement(a),a.replaceWith(n))}}catch(e){console.error("Serious error encountered when polyfilling native Flash elements: "+e)}}function Pn(){An=An??document.getElementsByTagName("iframe"),qn=qn??document.getElementsByTagName("frame"),[An,qn].forEach(e=>{for(const n of e)if(void 0===n.dataset.rufflePolyfilled){n.dataset.rufflePolyfilled="";const e=n.contentWindow,t=`Couldn't load Ruffle into ${n.tagName}[${n.src}]: `;try{"complete"===e.document.readyState&&Dn(e,t)}catch(e){j||console.warn(t+e)}n.addEventListener("load",()=>{Dn(e,t)},!1)}})}async function Dn(e,n){let t;await new Promise(e=>{window.setTimeout(()=>{e()},100)});try{if(!(t=e.document))return}catch(e){return void(j||console.warn(n+e))}if(j||void 0===t.documentElement.dataset.ruffleOptout)if(j)e.RufflePlayer||(e.RufflePlayer={}),e.RufflePlayer.config={...jn,...e.RufflePlayer.config??{}};else if(!e.RufflePlayer){const n=t.createElement("script");n.setAttribute("src",Sn),n.onload=()=>{e.RufflePlayer={},e.RufflePlayer.config=jn},t.head.appendChild(n)}}const Mn={version:p.versionNumber+"+"+p.buildDate.substring(0,10),polyfill(){("favorFlash"in jn&&!1===jn.favorFlash||"ruffle.js"===(navigator.plugins.namedItem("Shockwave Flash")?.filename??"ruffle.js"))&&(Fn(),Pn(),new MutationObserver(function(e){e.some(e=>Array.from(e.addedNodes).some(e=>["EMBED","OBJECT"].includes(e.nodeName)||e instanceof Element&&null!==e.querySelector("embed, object")))&&(Fn(),Pn())}).observe(document,{childList:!0,subtree:!0}))},pluginPolyfill(){var n=M;if(!navigator.plugins.namedItem("Shockwave Flash")){"install"in navigator.plugins&&navigator.plugins.install||(Object.defineProperty(window,"PluginArray",{value:zn}),Object.defineProperty(navigator,"plugins",{value:new zn(navigator.plugins),writable:!1})),navigator.plugins.install(n),0<n.length&&!("install"in navigator.mimeTypes&&navigator.mimeTypes.install)&&(Object.defineProperty(window,"MimeTypeArray",{value:Rn}),Object.defineProperty(window,"MimeType",{value:xn}),Object.defineProperty(navigator,"mimeTypes",{value:new Rn(navigator.mimeTypes),writable:!1}));const t=navigator.mimeTypes;for(let e=0;e<n.length;e+=1)t.install(n[e])}},createPlayer(){var e=en("ruffle-player",bn);return document.createElement(e)},options:{}};let On=null;try{if(void 0!==document.currentScript&&null!==document.currentScript&&"src"in document.currentScript&&""!==document.currentScript.src){let e=document.currentScript.src;e.endsWith(".js")||e.endsWith("/")||(e+="/"),On=new URL(".",e)}}catch(c){console.warn("Unable to get currentScript URL")}{var O={onFirstLoad:()=>{f.p=function(e){let n=On?.href??"";return""===(n="publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(window.RufflePlayer?.config)}};let e;window.RufflePlayer instanceof I?e=window.RufflePlayer:(e=new I(window.RufflePlayer),window.RufflePlayer=e),(e.sources.local=Mn).options=O,!1!==(!("polyfills"in e.config)||e.config.polyfills)&&Mn.pluginPolyfill()}})();