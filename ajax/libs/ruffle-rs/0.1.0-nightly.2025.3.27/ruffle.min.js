...
`}),n}get nodeName(){return"OBJECT"}get data(){return this.getAttribute("data")}set data(e){if(e){const n=document.createAttribute("data");n.value=e,this.attributes.setNamedItem(n)}else this.attributes.removeNamedItem("data")}static isInterdictable(e){if(cn(e))return!1;if(0<e.getElementsByTagName("ruffle-object").length||0<e.getElementsByTagName("ruffle-embed").length)return!1;const n=e.attributes.getNamedItem("data")?.value.toLowerCase(),t=e.attributes.getNamedItem("type")?.value??null,a=kn(e);let r;if(n){if(ln(n))return un(e,"data"),!1;r=n}else{if(!a||!a.movie)return!1;if(ln(a.movie)){const n=e.querySelector("param[name='movie']");if(n){un(n,"value");const t=n.getAttribute("value");t&&e.setAttribute("data",t)}return!1}r=a.movie}var o=e.attributes.getNamedItem("classid")?.value.toLowerCase();return o==="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase()?!Array.from(e.getElementsByTagName("object")).some(P.isInterdictable)&&!Array.from(e.getElementsByTagName("embed")).some(F.isInterdictable):!o&&_e(r,t)}static fromNativeObjectElement(e){const n=en("ruffle-object",P),t=document.createElement(n);for(const n of Array.from(e.getElementsByTagName("embed")))F.isInterdictable(n)&&n.remove();for(const n of Array.from(e.getElementsByTagName("object")))P.isInterdictable(n)&&n.remove();return wn(e,t),t}get height(){return this.getAttribute("height")||""}set height(e){this.setAttribute("height",e)}get width(){return this.getAttribute("width")||""}set width(e){this.setAttribute("width",e)}get type(){return this.getAttribute("type")||""}set type(e){this.setAttribute("type",e)}}class yn{constructor(n){if(this.__mimeTypes=[],this.__namedMimeTypes={},n)for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=new Rn(e),t=this.__mimeTypes.length;this.__mimeTypes.push(n),this.__namedMimeTypes[e.type]=n,this[n.type]=n,this[t]=n}item(e){return this.__mimeTypes[e>>>0]}namedItem(e){return this.__namedMimeTypes[e]}get length(){return this.__mimeTypes.length}[Symbol.iterator](){return this.__mimeTypes[Symbol.iterator]()}get[Symbol.toStringTag](){return"MimeTypeArray"}}class Rn{constructor(e){this.__mimeType=e}get type(){return this.__mimeType.type}get description(){return this.__mimeType.description}get suffixes(){return this.__mimeType.suffixes}get enabledPlugin(){return this.__mimeType.enabledPlugin}get[Symbol.toStringTag](){return"MimeType"}}class xn{constructor(n){this.__plugins=[],this.__namedPlugins={};for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=this.__plugins.length;this.__plugins.push(e),this.__namedPlugins[e.name]=e,this[e.name]=e,this[n]=e}item(e){return this.__plugins[e>>>0]}namedItem(e){return this.__namedPlugins[e]}refresh(){}[Symbol.iterator](){return this.__plugins[Symbol.iterator]()}get[Symbol.toStringTag](){return"PluginArray"}get length(){return this.__plugins.length}}const D=new class extends yn{constructor(e,n,t){super(),this.name=e,this.description=n,this.filename=t}}("Shockwave Flash","Shockwave Flash 32.0 r0","ruffle.js"),O=(D.install({type:$e,description:"Shockwave Flash",suffixes:"spl",enabledPlugin:D}),D.install({type:Te,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:D}),D.install({type:We,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:D}),D.install({type:Le,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:D}),window.RufflePlayer?.config??{}),zn=function(e){let n=Ne?.href??"";return""===(n=!z&&"publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(O)+"ruffle.js";let jn,Sn,Cn,En;function An(){try{jn=jn??document.getElementsByTagName("object"),Sn=Sn??document.getElementsByTagName("embed");for(const t of Array.from(jn)){var e;P.isInterdictable(t)&&(e=P.fromNativeObjectElement(t),t.replaceWith(e))}for(const a of Array.from(Sn)){var n;F.isInterdictable(a)&&(n=F.fromNativeEmbedElement(a),a.replaceWith(n))}}catch(e){console.error("Serious error encountered when polyfilling native Flash elements: "+e)}}function qn(){Cn=Cn??document.getElementsByTagName("iframe"),En=En??document.getElementsByTagName("frame"),[Cn,En].forEach(e=>{for(const n of e)if(void 0===n.dataset.rufflePolyfilled){n.dataset.rufflePolyfilled="";const e=n.contentWindow,t=`Couldn't load Ruffle into ${n.tagName}[${n.src}]: `;try{"complete"===e.document.readyState&&Fn(e,t)}catch(e){z||console.warn(t+e)}n.addEventListener("load",()=>{Fn(e,t)},!1)}})}async function Fn(e,n){let t;await new Promise(e=>{window.setTimeout(()=>{e()},100)});try{if(!(t=e.document))return}catch(e){return void(z||console.warn(n+e))}if(z||void 0===t.documentElement.dataset.ruffleOptout)if(z)e.RufflePlayer||(e.RufflePlayer={}),e.RufflePlayer.config={...O,...e.RufflePlayer.config??{}};else if(!e.RufflePlayer){const n=t.createElement("script");n.setAttribute("src",zn),n.onload=()=>{e.RufflePlayer={},e.RufflePlayer.config=O},t.head.appendChild(n)}}const Pn={version:p.versionNumber+"+"+p.buildDate.substring(0,10),polyfill(){("favorFlash"in O&&!1===O.favorFlash||"ruffle.js"===(navigator.plugins.namedItem("Shockwave Flash")?.filename??"ruffle.js"))&&(An(),qn(),new MutationObserver(function(e){e.some(e=>Array.from(e.addedNodes).some(e=>["EMBED","OBJECT"].includes(e.nodeName)||e instanceof Element&&null!==e.querySelector("embed, object")))&&(An(),qn())}).observe(document,{childList:!0,subtree:!0}))},pluginPolyfill(){var n=D;if(!navigator.plugins.namedItem("Shockwave Flash")){"install"in navigator.plugins&&navigator.plugins.install||(Object.defineProperty(window,"PluginArray",{value:xn}),Object.defineProperty(navigator,"plugins",{value:new xn(navigator.plugins),writable:!1})),navigator.plugins.install(n),0<n.length&&!("install"in navigator.mimeTypes&&navigator.mimeTypes.install)&&(Object.defineProperty(window,"MimeTypeArray",{value:yn}),Object.defineProperty(window,"MimeType",{value:Rn}),Object.defineProperty(navigator,"mimeTypes",{value:new yn(navigator.mimeTypes),writable:!1}));const t=navigator.mimeTypes;for(let e=0;e<n.length;e+=1)t.install(n[e])}},createPlayer(){var e=en("ruffle-player",bn);return document.createElement(e)},options:{}};let Dn=null;try{if(void 0!==document.currentScript&&null!==document.currentScript&&"src"in document.currentScript&&""!==document.currentScript.src){let e=document.currentScript.src;e.endsWith(".js")||e.endsWith("/")||(e+="/"),Dn=new URL(".",e)}}catch(c){console.warn("Unable to get currentScript URL")}{var M={onFirstLoad:()=>{f.p=function(e){let n=Dn?.href??"";return""===(n="publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(window.RufflePlayer?.config)}};let e;window.RufflePlayer instanceof $?e=window.RufflePlayer:(e=new $(window.RufflePlayer),window.RufflePlayer=e),(e.sources.local=Pn).options=M,!1!==(!("polyfills"in e.config)||e.config.polyfills)&&Pn.pluginPolyfill()}})();