...
`);t.push(this.getPanicData()),Ge(this.container,n,t,this.swfUrl),this.destroy()}}}addOpenInNewTabMessage(e,n){const t=new URL(n);if(this.loadedConfig?.parameters){const e=rn(this.loadedConfig?.parameters);Object.entries(e).forEach(([e,n])=>{t.searchParams.set(e,n)})}this.hideSplashScreen();const a=document.createElement("div"),r=(a.id="message-overlay",document.createElement("div")),o=(r.className="message",r.appendChild(b("message-cant-embed")),document.createElement("div")),i=document.createElement("a");i.innerText=g("open-in-new-tab"),i.onclick=()=>e(t),o.appendChild(i),r.appendChild(o),a.appendChild(r),this.container.prepend(a)}displayRootMovieDownloadFailedMessage(e){const n=this.loadedConfig?.openInNewTab;if(n&&this.swfUrl&&window.location.origin!==this.swfUrl.origin)this.addOpenInNewTabMessage(n,this.swfUrl);else{const n=new(e?Je:Ve)(this.swfUrl);this.panic(n)}}displayMessage(e){const n=document.createElement("div"),t=(n.id="message-overlay",document.createElement("div")),a=(t.className="message",document.createElement("p")),r=(a.textContent=e,t.appendChild(a),document.createElement("div")),o=document.createElement("button");o.id="continue-btn",o.textContent=g("continue"),r.appendChild(o),t.appendChild(r),n.appendChild(t),this.container.prepend(n),this.container.querySelector("#continue-btn").onclick=()=>{n.parentNode.removeChild(n)}}displayUnsupportedVideo(e){const n=this.videoModal.querySelector("#video-holder");if(n){const t=document.createElement("video");t.addEventListener("contextmenu",e=>e.stopPropagation()),t.src=e,t.autoplay=!0,t.controls=!0,n.textContent="",n.appendChild(t),this.videoModal.classList.remove("hidden")}}displayClipboardModal(e){const n=this.clipboardModal.querySelector("#clipboard-modal-description");n&&(n.textContent=g("clipboard-message-description",{variant:e?"access-denied":"unsupported"}),this.clipboardModal.classList.remove("hidden"))}hideSplashScreen(){this.splashScreen.classList.add("hidden"),this.container.classList.remove("hidden")}showSplashScreen(){this.splashScreen.classList.remove("hidden"),this.container.classList.add("hidden")}setMetadata(e){this.metadata=e,this._readyState=o.Loaded,this.hideSplashScreen(),this.element.dispatchEvent(new CustomEvent(n.LOADED_METADATA)),this.element.dispatchEvent(new CustomEvent(n.LOADED_DATA))}}n.LOADED_METADATA="loadedmetadata",n.LOADED_DATA="loadeddata";class sn{constructor(e,n){this.isMuted=e,this.volume=n}get_volume(){return this.isMuted?0:this.volume/100}}function ln(e,n){const t={url:e},a=n("allowNetworking");null!==a&&(t.allowNetworking=a);var r=vn(n("allowScriptAccess"),e),r=(null!==r&&(t.allowScriptAccess=r),n("bgcolor")),r=(null!==r&&(t.backgroundColor=r),n("base"));if(null!==r)if("."===r){const n=new URL(e,document.baseURI);t.base=new URL(r,n).href}else t.base=r;e=hn(n("menu")),null!==e&&(t.menu=e),r=hn(n("allowFullScreen")),null!==r&&(t.allowFullscreen=r),e=n("flashvars"),null!==e&&(t.parameters=e),r=n("quality"),null!==r&&(t.quality=r),e=n("salign"),null!==e&&(t.salign=e),r=n("scale"),null!==r&&(t.scale=r),e=n("wmode");return null!==e&&(t.wmode=e),t}function un(t){if(t){let e="",n="";try{var a=new URL(t,j);e=a.pathname,n=a.hostname}catch(t){}if(e.startsWith("/v/")&&/^(?:(?:www\.|m\.)?youtube(?:-nocookie)?\.com)|(?:youtu\.be)$/i.test(n))return 1}}function cn(e,n){var t=e.getAttribute(n),a=window.RufflePlayer?.config??{};if(t)try{const r=new URL(t);"http:"!==r.protocol||"https:"!==window.location.protocol||"upgradeToHttps"in a&&!1===a.upgradeToHttps||(r.protocol="https:",e.setAttribute(n,r.toString()))}catch(e){}}function dn(e){let n=e.parentElement;for(;null!==n;){switch(n.tagName){case"AUDIO":case"VIDEO":return 1}n=n.parentElement}}function fn(e,n){const t=URL.createObjectURL(e),a=document.createElement("a");a.href=t,a.download=n,a.click(),URL.revokeObjectURL(t)}function mn(e){e=atob(e);return Uint8Array.from(e,e=>e.charCodeAt(0))}function pn(e){try{const n=atob(e);return 0===(t=n).charCodeAt(0)&&191===t.charCodeAt(1)&&"TCSO"===t.slice(6,10)&&[0,4,0,0,0,0].every((e,n)=>t.charCodeAt(10+n)===e)}catch(e){return!1}var t}function hn(e){switch(e?.toLowerCase()){case"true":return!0;case"false":return!1;default:return null}}function vn(e,n){switch(e?.toLowerCase()){case"always":return!0;case"never":return!1;case"samedomain":try{return new URL(window.location.href).origin===new URL(n,window.location.href).origin}catch{return!1}default:return null}}function r(e,n,t,a){if("a"===t&&!a)throw new TypeError("Private accessor was defined without a getter");if("function"==typeof n?e===n&&a:n.has(e))return"m"===t?a:"a"===t?a.call(e):a?a.value:n.get(e);throw new TypeError("Cannot read private member from an object whose class did not declare it")}class gn{constructor(e){F.set(this,void 0);var n=this,t=F,a="f",r=void 0;if("m"===a)throw new TypeError("Private method is not writable");if("a"===a&&!r)throw new TypeError("Private accessor was defined without a setter");if("function"==typeof t?n!==t||!r:!t.has(n))throw new TypeError("Cannot write private member to an object whose class did not declare it");"a"===a?r.call(n,e):r?r.value=e:t.set(n,e)}addFSCommandHandler(e){r(this,F,"f").addFSCommandHandler(e)}get readyState(){return r(this,F,"f")._readyState}get metadata(){return r(this,F,"f").metadata}get loadedConfig(){return r(this,F,"f").loadedConfig??null}async reload(){await r(this,F,"f").reload()}async load(e,n=!1){await r(this,F,"f").load(e,n)}resume(){r(this,F,"f").play()}get isPlaying(){return r(this,F,"f").isPlaying}get volume(){return r(this,F,"f").volume}set volume(e){r(this,F,"f").volume=e}get fullscreenEnabled(){return r(this,F,"f").fullscreenEnabled}get isFullscreen(){return r(this,F,"f").isFullscreen}setFullscreen(e){r(this,F,"f").setFullscreen(e)}requestFullscreen(){r(this,F,"f").enterFullscreen()}exitFullscreen(){r(this,F,"f").exitFullscreen()}async downloadSwf(){await r(this,F,"f").downloadSwf()}displayMessage(e){r(this,F,"f").displayMessage(e)}suspend(){r(this,F,"f").pause()}get suspended(){return!r(this,F,"f").isPlaying}set traceObserver(e){r(this,F,"f").traceObserver=e}get config(){return r(this,F,"f").config}set config(e){r(this,F,"f").config=e}callExternalInterface(e,...n){return r(this,F,"f").callExternalInterface(e,n)}}function E(e,n,t,a){if("a"===t&&!a)throw new TypeError("Private accessor was defined without a getter");if("function"==typeof n?e===n&&a:n.has(e))return"m"===t?a:"a"===t?a.call(e):a?a.value:n.get(e);throw new TypeError("Cannot read private member from an object whose class did not declare it")}function bn(e,n,t,a,r){if("m"===a)throw new TypeError("Private method is not writable");if("a"===a&&!r)throw new TypeError("Private accessor was defined without a setter");if("function"==typeof n?e===n&&r:n.has(e))return"a"===a?r.call(e,t):r?r.value=t:n.set(e,t);throw new TypeError("Cannot write private member to an object whose class did not declare it")}var A,q,F=new WeakMap;class wn extends HTMLElement{get onFSCommand(){return E(this,q,"f")}set onFSCommand(e){bn(this,q,e,"f")}get readyState(){return E(this,A,"f")._readyState}get metadata(){return E(this,A,"f").metadata}constructor(){super(),A.set(this,void 0),q.set(this,null),bn(this,A,new n(this,()=>this.debugPlayerInfo(),n=>{try{Object.defineProperty(this,n,{value:(...e)=>E(this,A,"f").callExternalInterface(n,e),configurable:!0})}catch(e){console.warn("Error setting ExternalInterface legacy callback for "+n,e)}}),"f"),E(this,A,"f").addFSCommandHandler((e,n)=>{E(this,q,"f")?.call(this,e,n)})}ruffle(e){if(1===(e??1))return new gn(E(this,A,"f"));throw new Error(`Version ${e} not supported.`)}get loadedConfig(){return E(this,A,"f").loadedConfig??null}connectedCallback(){E(this,A,"f").updateStyles()}static get observedAttributes(){return["width","height"]}attributeChangedCallback(e,n,t){"width"!==e&&"height"!==e||E(this,A,"f").updateStyles()}disconnectedCallback(){E(this,A,"f").destroy()}async reload(){await E(this,A,"f").reload()}async load(e,n=!1){await E(this,A,"f").load(e,n)}play(){E(this,A,"f").play()}get isPlaying(){return E(this,A,"f").isPlaying}get volume(){return E(this,A,"f").volume}set volume(e){E(this,A,"f").volume=e}get fullscreenEnabled(){return E(this,A,"f").fullscreenEnabled}get isFullscreen(){return E(this,A,"f").isFullscreen}setFullscreen(e){E(this,A,"f").setFullscreen(e)}enterFullscreen(){E(this,A,"f").enterFullscreen()}exitFullscreen(){E(this,A,"f").exitFullscreen()}async downloadSwf(){await E(this,A,"f").downloadSwf()}pause(){E(this,A,"f").pause()}set traceObserver(e){E(this,A,"f").traceObserver=e}debugPlayerInfo(){return""}PercentLoaded(){return E(this,A,"f")._readyState===o.Loaded?100:0}get config(){return E(this,A,"f").config}set config(e){E(this,A,"f").config=e}displayMessage(e){E(this,A,"f").displayMessage(e)}}function kn(e,n){if(e){for(const t of e.attributes)if(t.specified){if("title"===t.name&&"Adobe Flash Player"===t.value)continue;try{n.setAttribute(t.name,t.value)}catch(e){console.warn(`Unable to set attribute ${t.name} on Ruffle instance`)}}for(const a of Array.from(e.children))n.appendChild(a)}}A=new WeakMap,q=new WeakMap;class P extends wn{connectedCallback(){super.connectedCallback();var e=this.attributes.getNamedItem("src");e&&(e=ln(e.value,e=>this.attributes.getNamedItem(e)?.value??null),this.load(e,!0))}get nodeName(){return"EMBED"}get src(){return this.attributes.getNamedItem("src")?.value}set src(e){if(e){const n=document.createAttribute("src");n.value=e,this.attributes.setNamedItem(n)}else this.attributes.removeNamedItem("src")}static get observedAttributes(){return["src","width","height"]}attributeChangedCallback(e,n,t){if(super.attributeChangedCallback(e,n,t),this.isConnected&&"src"===e){const e=this.attributes.getNamedItem("src");if(e){const n=e=>this.attributes.getNamedItem(e)?.value??null,t=ln(e.value,n);this.load(t,!0)}}}static isInterdictable(e){var n=e.getAttribute("src"),t=e.getAttribute("type");return!!n&&!dn(e)&&(un(n)?(cn(e,"src"),!1):Ue(n,t))}static fromNativeEmbedElement(e){var n=nn("ruffle-embed",P),n=document.createElement(n);return kn(e,n),n}get height(){return this.getAttribute("height")||""}set height(e){this.setAttribute("height",e)}get width(){return this.getAttribute("width")||""}set width(e){this.setAttribute("width",e)}get type(){return this.getAttribute("type")||""}set type(e){this.setAttribute("type",e)}}function yn(e){const n={};for(const t of e.children)if(t instanceof HTMLParamElement){const e=t.attributes.getNamedItem("name")?.value,a=t.attributes.getNamedItem("value")?.value;e&&a&&(n[e]=a)}return n}class D extends wn{constructor(){super(...arguments),this.params={}}connectedCallback(){super.connectedCallback(),this.params=yn(this);let e=null;if(this.attributes.getNamedItem("data")?e=this.attributes.getNamedItem("data")?.value:this.params.movie&&(e=this.params.movie),e){const o=["allowNetworking","base","bgcolor","flashvars"],n=ln(e,e=>{var n=this.params,t=e,a=o.includes(e)?this.getAttribute(e):null;t=t.toLowerCase();for(const[a,r]of Object.entries(n))if(a.toLowerCase()===t)return r;return a});this.load(n,!0)}}debugPlayerInfo(){let n="Player type: Object\n",e=null;return this.attributes.getNamedItem("data")?e=this.attributes.getNamedItem("data")?.value:this.params.movie&&(e=this.params.movie),n+=`SWF URL: ${e}
...
`}),n}get nodeName(){return"OBJECT"}get data(){return this.getAttribute("data")}set data(e){if(e){const n=document.createAttribute("data");n.value=e,this.attributes.setNamedItem(n)}else this.attributes.removeNamedItem("data")}static isInterdictable(e){if(dn(e))return!1;if(0<e.getElementsByTagName("ruffle-object").length||0<e.getElementsByTagName("ruffle-embed").length)return!1;const n=e.attributes.getNamedItem("data")?.value.toLowerCase(),t=e.attributes.getNamedItem("type")?.value??null,a=yn(e);let r;if(n){if(un(n))return cn(e,"data"),!1;r=n}else{if(!a||!a.movie)return!1;if(un(a.movie)){const n=e.querySelector("param[name='movie']");if(n){cn(n,"value");const t=n.getAttribute("value");t&&e.setAttribute("data",t)}return!1}r=a.movie}var o=e.attributes.getNamedItem("classid")?.value.toLowerCase();return o==="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase()?!Array.from(e.getElementsByTagName("object")).some(D.isInterdictable)&&!Array.from(e.getElementsByTagName("embed")).some(P.isInterdictable):!o&&Ue(r,t)}static fromNativeObjectElement(e){const n=nn("ruffle-object",D),t=document.createElement(n);for(const n of Array.from(e.getElementsByTagName("embed")))P.isInterdictable(n)&&n.remove();for(const n of Array.from(e.getElementsByTagName("object")))D.isInterdictable(n)&&n.remove();return kn(e,t),t}get height(){return this.getAttribute("height")||""}set height(e){this.setAttribute("height",e)}get width(){return this.getAttribute("width")||""}set width(e){this.setAttribute("width",e)}get type(){return this.getAttribute("type")||""}set type(e){this.setAttribute("type",e)}}class Rn{constructor(n){if(this.__mimeTypes=[],this.__namedMimeTypes={},n)for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=new xn(e),t=this.__mimeTypes.length;this.__mimeTypes.push(n),this.__namedMimeTypes[e.type]=n,this[n.type]=n,this[t]=n}item(e){return this.__mimeTypes[e>>>0]}namedItem(e){return this.__namedMimeTypes[e]}get length(){return this.__mimeTypes.length}[Symbol.iterator](){return this.__mimeTypes[Symbol.iterator]()}get[Symbol.toStringTag](){return"MimeTypeArray"}}class xn{constructor(e){this.__mimeType=e}get type(){return this.__mimeType.type}get description(){return this.__mimeType.description}get suffixes(){return this.__mimeType.suffixes}get enabledPlugin(){return this.__mimeType.enabledPlugin}get[Symbol.toStringTag](){return"MimeType"}}class zn{constructor(n){this.__plugins=[],this.__namedPlugins={};for(let e=0;e<n.length;e++)this.install(n[e])}install(e){var n=this.__plugins.length;this.__plugins.push(e),this.__namedPlugins[e.name]=e,this[e.name]=e,this[n]=e}item(e){return this.__plugins[e>>>0]}namedItem(e){return this.__namedPlugins[e]}refresh(){}[Symbol.iterator](){return this.__plugins[Symbol.iterator]()}get[Symbol.toStringTag](){return"PluginArray"}get length(){return this.__plugins.length}}const M=new class extends Rn{constructor(e,n,t){super(),this.name=e,this.description=n,this.filename=t}}("Shockwave Flash","Shockwave Flash 32.0 r0","ruffle.js"),jn=(M.install({type:Le,description:"Shockwave Flash",suffixes:"spl",enabledPlugin:M}),M.install({type:We,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),M.install({type:_e,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),M.install({type:Ne,description:"Shockwave Flash",suffixes:"swf",enabledPlugin:M}),window.RufflePlayer?.config??{}),Sn=function(e){let n=Be?.href??"";return""===(n=!z&&"publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(jn)+"ruffle.js";let Cn,En,An,qn;function Fn(){try{Cn=Cn??document.getElementsByTagName("object"),En=En??document.getElementsByTagName("embed");for(const t of Array.from(Cn)){var e;D.isInterdictable(t)&&(e=D.fromNativeObjectElement(t),t.replaceWith(e))}for(const a of Array.from(En)){var n;P.isInterdictable(a)&&(n=P.fromNativeEmbedElement(a),a.replaceWith(n))}}catch(e){console.error("Serious error encountered when polyfilling native Flash elements: "+e)}}function Pn(){An=An??document.getElementsByTagName("iframe"),qn=qn??document.getElementsByTagName("frame"),[An,qn].forEach(e=>{for(const n of e)if(void 0===n.dataset.rufflePolyfilled){n.dataset.rufflePolyfilled="";const e=n.contentWindow,t=`Couldn't load Ruffle into ${n.tagName}[${n.src}]: `;try{"complete"===e.document.readyState&&Dn(e,t)}catch(e){z||console.warn(t+e)}n.addEventListener("load",()=>{Dn(e,t)},!1)}})}async function Dn(e,n){let t;await new Promise(e=>{window.setTimeout(()=>{e()},100)});try{if(!(t=e.document))return}catch(e){return void(z||console.warn(n+e))}if(z||void 0===t.documentElement.dataset.ruffleOptout)if(z)e.RufflePlayer||(e.RufflePlayer={}),e.RufflePlayer.config={...jn,...e.RufflePlayer.config??{}};else if(!e.RufflePlayer){const n=t.createElement("script");n.setAttribute("src",Sn),n.onload=()=>{e.RufflePlayer={},e.RufflePlayer.config=jn},t.head.appendChild(n)}}const Mn={version:p.versionNumber+"+"+p.buildDate.substring(0,10),polyfill(){("favorFlash"in jn&&!1===jn.favorFlash||"ruffle.js"===(navigator.plugins.namedItem("Shockwave Flash")?.filename??"ruffle.js"))&&(Fn(),Pn(),new MutationObserver(function(e){e.some(e=>Array.from(e.addedNodes).some(e=>["EMBED","OBJECT"].includes(e.nodeName)||e instanceof Element&&null!==e.querySelector("embed, object")))&&(Fn(),Pn())}).observe(document,{childList:!0,subtree:!0}))},pluginPolyfill(){var n=M;if(!navigator.plugins.namedItem("Shockwave Flash")){"install"in navigator.plugins&&navigator.plugins.install||(Object.defineProperty(window,"PluginArray",{value:zn}),Object.defineProperty(navigator,"plugins",{value:new zn(navigator.plugins),writable:!1})),navigator.plugins.install(n),0<n.length&&!("install"in navigator.mimeTypes&&navigator.mimeTypes.install)&&(Object.defineProperty(window,"MimeTypeArray",{value:Rn}),Object.defineProperty(window,"MimeType",{value:xn}),Object.defineProperty(navigator,"mimeTypes",{value:new Rn(navigator.mimeTypes),writable:!1}));const t=navigator.mimeTypes;for(let e=0;e<n.length;e+=1)t.install(n[e])}},createPlayer(){var e=nn("ruffle-player",wn);return document.createElement(e)},options:{}};let On=null;try{if(void 0!==document.currentScript&&null!==document.currentScript&&"src"in document.currentScript&&""!==document.currentScript.src){let e=document.currentScript.src;e.endsWith(".js")||e.endsWith("/")||(e+="/"),On=new URL(".",e)}}catch(c){console.warn("Unable to get currentScript URL")}{var O={onFirstLoad:()=>{f.p=function(e){let n=On?.href??"";return""===(n="publicPath"in e&&null!==e.publicPath&&void 0!==e.publicPath?e.publicPath:n)||n.endsWith("/")||(n+="/"),n}(window.RufflePlayer?.config)}};let e;window.RufflePlayer instanceof T?e=window.RufflePlayer:(e=new T(window.RufflePlayer),window.RufflePlayer=e),(e.sources.local=Mn).options=O,!1!==(!("polyfills"in e.config)||e.config.polyfills)&&Mn.pluginPolyfill()}})();