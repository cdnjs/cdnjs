...
g});-1<b&&jsPanel.activePanels.list.splice(b,1);jsPanel.remMinReplacement(a);"modal"===a.option.paneltype&&jsPanel.removeModalBackdrop(a);a.option.paneltype.tooltip&&e.classList.remove("hasTooltip");$(document).trigger("jspanelclosed",g);$(document).trigger("jspanelstatuschange",g);var d=b=b=void 0;jsPanel.lastbeforeclose&&(b=jsPanel.lastbeforeclose.parent,b=$("."+jsPanel.lastbeforeclose["class"],b),d=jsPanel.lastbeforeclose["class"]);b&&(b.each(function(a,b){b.classList.remove(d)}),b.each(function(b,
...
a||"smallify"===a||"close"===a)b[a]()},dragit:function(a){function b(a){a.preventDefault()}var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},d=void 0,d="string"===typeof a?document.querySelector(a):a.jquery?a[0]:a,f=a.jquery?a:d,g=void 0,e=Object.assign({},$.jsPanel.defaults.dragit,c),h=e.containment,l=void 0,k=void 0,r=c=void 0,y=void 0,n=void 0,z=d.parentElement,q=window.getComputedStyle(d,null).getPropertyValue("position"),v=z.tagName.toLowerCase(),c=window.getComputedStyle(z,null),
u=c.getPropertyValue("position"),w=parseInt(c.getPropertyValue("border-left-width"),10),B=parseInt(c.getPropertyValue("border-right-width"),10),D=parseInt(c.getPropertyValue("border-top-width"),10),I=parseInt(c.getPropertyValue("border-bottom-width"),10),t=void 0,E=void 0,A=void 0;navigator.appVersion.includes("Trident")?(t=document.createEvent("CustomEvent"),E=document.createEvent("CustomEvent"),A=document.createEvent("CustomEvent"),t.initCustomEvent("dragstart",!0,!0,{}),E.initCustomEvent("drag",
!0,!0,{}),A.initCustomEvent("dragstop",!0,!0,{})):(t=new Event("dragstart"),E=new Event("drag"),A=new Event("dragstop"));for(var c=e.handles?d.querySelectorAll(e.handles):[d],p=0;p<c.length;++p)c[p].style.cursor=e.cursor;"number"===typeof h?h=[].concat(h,h,h,h):"[object Array]"===Object.prototype.toString.call(h)&&(2===h.length?h=h.concat(h):3===h.length&&(h[3]=h[1]));"[object Array]"===Object.prototype.toString.call(h)&&(l=h,e.containment="body"===v?h="window":h="parent");h&&"body"===v&&(e.containment=
h="window");"onpointerup"in window?(r="pointerdown",y="pointermove",n="pointerup"):"ontouchend"in window?(r="touchstart",y="touchmove",n="touchend"):(r="mousedown",y="mousemove",n="mouseup");for(p=0;p<c.length;p++)c[p].addEventListener(r,function(a){a.stopPropagation();var c=d.getBoundingClientRect(),p=z.getBoundingClientRect(),n=void 0,A=void 0,N=a.pageX,J=a.pageY,R=window.scrollX||window.pageXOffset,m=window.scrollY||window.pageYOffset,M=void 0,H=void 0,G=void 0,O=void 0;"fixed"===q?(n=c.left,A=
c.top):"body"===v||"static"===u?(n=c.left+R,A=c.top+m):"body"!==v&&(n=c.left-p.left-w+z.scrollLeft,A=c.top-p.top-D+z.scrollTop);window.addEventListener(r,b(a),!1);"body"===v&&h?"fixed"===q?(G=M=0,H=document.documentElement.clientWidth-c.width,O=document.documentElement.clientHeight-c.height):(M=R,G=m,H=document.documentElement.clientWidth-c.width+R,O=document.documentElement.clientHeight-c.height+m):"parent"===h?"static"===u?(M=p.left+w+R,G=p.top+D+m,H=M+p.width-c.width-w-B,O=G+p.height-c.height-
D-I):(G=M=0,H=p.width-c.width-w-B,O=p.height-c.height-D-I):"window"===h&&("static"===u?(M=R,G=m,H=document.documentElement.clientWidth-c.width+R,O=document.documentElement.clientHeight-c.height+m):(M=-p.left-w,G=-p.top-D,H=document.documentElement.clientWidth-p.left-c.width-B,O=document.documentElement.clientHeight-p.top-c.height-I));l&&(M+=l[3],G+=l[0],H-=l[1],O-=l[2]);k=function(a){a.stopPropagation();g||(document.dispatchEvent(t),d.style.opacity=e.opacity,"function"===typeof e.start&&e.start.call(f,
f));g=1;document.dispatchEvent(E);var b=n+a.pageX-N;a=A+a.pageY-J;b<=M?b=M:b>=H&&(b=H);a<=G?a=G:a>=O&&(a=O);"x"===e.axis?d.style.left=b+"px":("y"!==e.axis&&(d.style.left=b+"px"),d.style.top=a+"px");window.getSelection().removeAllRanges();"function"===typeof e.drag&&e.drag.call(f,f)};document.addEventListener(y,k,!1)},!1);document.addEventListener(n,function(){document.removeEventListener(y,k,!1);g&&(document.dispatchEvent(A),d.style.opacity=1,g=void 0,"function"===typeof e.stop&&e.stop.call(f,f));
window.removeEventListener(n,b,!1)},!1);return f},resizeit:function(a){function b(a){a.preventDefault()}var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},d=void 0,d="string"===typeof a?document.querySelector(a):a.jquery?a[0]:a,f=a.jquery?a:d,g=void 0,e=Object.assign({},$.jsPanel.defaults.resizeit,c),h=e.containment,l=void 0,k=void 0,r=void 0,y=void 0,n=void 0,c=window.getComputedStyle(d,null),z=c.getPropertyValue("position"),q=parseInt(c.getPropertyValue("border-left-width"),10),v=parseInt(c.getPropertyValue("border-top-width"),
10),u=parseInt(c.getPropertyValue("border-right-width"),10),w=parseInt(c.getPropertyValue("border-bottom-width"),10),B=d.parentElement,D=B.tagName.toLowerCase(),c=window.getComputedStyle(B,null),I=c.getPropertyValue("position"),t=parseInt(c.getPropertyValue("border-left-width"),10),E=parseInt(c.getPropertyValue("border-top-width"),10),A=parseInt(c.getPropertyValue("border-bottom-width"),10),p="function"===typeof e.maxWidth?e.maxWidth():e.maxWidth,C="function"===typeof e.maxHeight?e.maxHeight():e.maxHeight,
F="function"===typeof e.minWidth?e.minWidth():e.minWidth,x="function"===typeof e.minHeight?e.minHeight():e.minHeight,S=void 0,T=void 0,N=void 0;navigator.appVersion.includes("Trident")?(S=document.createEvent("CustomEvent"),T=document.createEvent("CustomEvent"),N=document.createEvent("CustomEvent"),S.initCustomEvent("dragstart",!0,!0,{}),T.initCustomEvent("drag",!0,!0,{}),N.initCustomEvent("dragstop",!0,!0,{})):(S=new Event("dragstart"),T=new Event("drag"),N=new Event("dragstop"));"number"===typeof h?
h=[].concat(h,h,h,h):"[object Array]"===Object.prototype.toString.call(h)&&(2===h.length?h=h.concat(h):3===h.length&&(h[3]=h[1]));"[object Array]"===Object.prototype.toString.call(h)&&(l=h,e.containment="body"===D?h="window":h="parent");h&&"body"===D&&(e.containment=h="window");"onpointerup"in window?(r="pointerdown",y="pointermove",n="pointerup"):"ontouchend"in window?(r="touchstart",y="touchmove",n="touchend"):(r="mousedown",y="mousemove",n="mouseup");e.handles.split(",").forEach(function(a){var b=
document.createElement("DIV");b.className="jsPanel-resizeit-handle jsPanel-resizeit-"+a.trim();b.style.zIndex=90;d.appendChild(b)});for(var c=d.getElementsByClassName("jsPanel-resizeit-handle"),J=0;J<c.length;J++)c[J].addEventListener(r,function(c){c.stopPropagation();var m=d.getBoundingClientRect(),n=B.getBoundingClientRect(),H=c.pageX,G=c.pageY,O=window.scrollX||window.pageXOffset,N=window.scrollY||window.pageYOffset,V=m.width,J=m.height,W=void 0,X=void 0,U=c.target,P=1E4,K=1E4,Q=1E4,L=1E4;"fixed"===
z?(W=m.left-q-u,X=m.top-v-w):"body"===D||"static"===I?(W=m.left+O-q-u,X=m.top+N-v-w):"body"!==D&&(W=m.left-n.left-t+B.scrollLeft-q-u,X=m.top-n.top-E+B.scrollTop-v-w);"body"===D&&h?(P=document.documentElement.clientWidth-m.left-q-u,Q=document.documentElement.clientHeight-m.top-v-w,K=m.width+m.left-q-u,L=m.height+m.top-v-w):"parent"===h?"static"===I?(P=n.width-m.left-q-O,Q=n.height+n.top-m.top+v-E-A,K=m.width+(m.left-n.left)-t,L=m.height+(m.top-n.top)-E):(P=B.clientWidth-(m.left-n.left)+q,Q=B.clientHeight-
(m.top-n.top)+v,K=m.width+(m.left-n.left)-t-q-u,L=d.clientHeight+(m.top-n.top)-v-v-w):"window"===h&&(P=document.documentElement.clientWidth-m.left-q-u,Q=document.documentElement.clientHeight-m.top-v-w,K=m.left+m.width-q-u,L=m.top+m.height-v-w);l&&(K-=l[3],L-=l[0],P-=l[1],Q-=l[2]);window.addEventListener(r,b(c),!1);k=function(b){g||(document.dispatchEvent(S),"function"===typeof e.start&&e.start.call(f,f));g=1;document.dispatchEvent(T);if(U.classList.contains("jsPanel-resizeit-e"))b=V+b.pageX-H,b>=
P&&(b=P),b>=p?b=p:b<=F&&(b=F),d.style.width=b+"px";else if(U.classList.contains("jsPanel-resizeit-se")){var c=V+b.pageX-H;b=J+b.pageY-G;c>=P&&(c=P);b>=Q&&(b=Q);c>=p?c=p:c<=F&&(c=F);b>=C?b=C:b<=x&&(b=x);d.style.width=c+"px";d.style.height=b+"px"}else U.classList.contains("jsPanel-resizeit-s")?(b=J+b.pageY-G,b>=Q&&(b=Q),b>=C?b=C:b<=x&&(b=x),d.style.height=b+"px"):U.classList.contains("jsPanel-resizeit-w")?(c=V+H-b.pageX,c<=p&&c>=F&&c<=K&&(d.style.left=W+b.pageX-H+"px"),c>=K&&(c=K),c>=p?c=p:c<=F&&(c=
F),d.style.width=c+"px"):U.classList.contains("jsPanel-resizeit-n")?(c=J+G-b.pageY,c<=C&&c>=x&&c<=L&&(d.style.top=X+b.pageY-G+"px"),c>=L&&(c=L),c>=C?c=C:c<=x&&(c=x),d.style.height=c+"px"):U.classList.contains("jsPanel-resizeit-sw")?(c=J+b.pageY-G,c>=Q&&(c=Q),c>=C?c=C:c<=x&&(c=x),d.style.height=c+"px",c=V+H-b.pageX,c<=p&&c>=F&&c<=K&&(d.style.left=W+b.pageX-H+"px"),c>=K&&(c=K),c>=p?c=p:c<=F&&(c=F),d.style.width=c+"px"):U.classList.contains("jsPanel-resizeit-nw")?(c=J+G-b.pageY,c<=C&&c>=x&&c<=L&&(d.style.top=
X+b.pageY-G+"px"),c>=L&&(c=L),c>=C?c=C:c<=x&&(c=x),d.style.height=c+"px",c=V+H-b.pageX,c<=p&&c>=F&&c<=K&&(d.style.left=W+b.pageX-H+"px"),c>=K&&(c=K),c>=p?c=p:c<=F&&(c=F),d.style.width=c+"px"):U.classList.contains("jsPanel-resizeit-ne")&&(c=J+G-b.pageY,c<=C&&c>=x&&c<=L&&(d.style.top=X+b.pageY-G+"px"),c>=L&&(c=L),c>=C?c=C:c<=x&&(c=x),d.style.height=c+"px",b=V+b.pageX-H,b>=P&&(b=P),b>=p?b=p:b<=F&&(b=F),d.style.width=b+"px");jsPanel.contentResize(a);window.getSelection().removeAllRanges();"function"===
typeof e.resize&&e.resize.call(f,f)};document.addEventListener(y,k,!1)},!1);document.addEventListener(n,function(){document.removeEventListener(y,k,!1);g&&(document.dispatchEvent(N),g=void 0,("smallified"===$(d).data("status")||"smallifiedMax"===$(d).data("status"))&&$(d).height()>$(d).header.height()&&($(d).hideControls([".jsPanel-btn-normalize",".jsPanel-btn-smallifyrev"]),$(d).data("status","normalized"),$(document).trigger("jspanelnormalized"),$(document).trigger("jspanelstatuschange")),jsPanel.calcPositionFactors(a),
"function"===typeof e.stop&&e.stop.call(f,f));window.removeEventListener(n,b,!1)},!1);return f},exportPanels:function(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:".jsPanel",b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"jspanels",c=[],a=$(".jsPanel").not(".jsPanel-tooltip, .jsPanel-hint, .jsPanel-modal").filter(a);a.each(function(a,b){"normalized"!==$(b).data("status")&&$(".jsPanel-btn-normalize",b).trigger("click")});a.each(function(a,b){var g,e,h,l;g=$(b).data("container");
e=$(b).offset();h=$(b).position();"minimized"===$(b).data("status")?("body"===g.toLowerCase()?(g=$(b).data("paneltop")-$(window).scrollTop(),e=$(b).data("panelleft")-$(window).scrollLeft()):(g=$(b).data("paneltop"),e=$(b).data("panelleft")),h=$(b).data("panelwidth"),l=$(b).data("panelheight")):("body"===g.toLowerCase()?(g=Math.floor(e.top-$(window).scrollTop()),e=Math.floor(e.left-$(window).scrollLeft())):(g=Math.floor(h.top),e=Math.floor(h.left)),h=$(b).css("width"),l=$(".jsPanel-content",b).css("height"));
g={status:$(b).data("status"),id:$(b).prop("id"),headerTitle:$(".jsPanel-title",b).html(),custom:$(b).data("custom"),content:$(b).data("content"),contentSize:{width:h,height:l},position:{my:"left-top",at:"left-top",offsetX:e,offsetY:g}};$(b).data("ajaxURL")&&(g.contentAjax={url:$(b).data("ajaxURL"),autoload:!0});if($(b).data("iframeDOC")||$(b).data("iframeSRC"))g.contentIframe={src:$(b).data("iframeSRC")||"",srcdoc:$(b).data("iframeDOC")||""};c.push(g);switch(g.status){case "minimized":$(".jsPanel-btn-minimize",
...
"auto"===a.option.contentSize.height||c.height?b.prop("height",c.height):b.css("height","100%");c.name&&b.prop("name",c.name);c.sandbox&&b.prop("sandox",c.sandbox);c.id&&b.prop("id",c.id);$.isPlainObject(c.style)&&b.css(c.style);"string"===typeof c.classname?b.addClass(c.classname):$.isFunction(c.classname)&&b.addClass(c.classname());a.content.append(b)},importPanels:function(a){var b=a["default"]||{},c=void 0;JSON.parse(localStorage[1<arguments.length&&void 0!==arguments[1]?arguments[1]:"jspanels"]).forEach(function(d){c=
"string"===typeof d.custom.config?$.extend(!0,{},b,a[d.custom.config],d):$.extend(!0,{},b,d);$.jsPanel(c)})},insertModalBackdrop:function(a){var b=0===$(".jsPanel-modal-backdrop").length?"jsPanel-modal-backdrop":"jsPanel-modal-backdrop jsPanel-modal-backdrop-multi";a='<div id="jsPanel-modal-backdrop-'+a.attr("id")+'" class="'+b+'" style="z-index:'+(this.modalcount+9999)+'"></div>';$("body").append(a);this.modalcount+=1},removeModalBackdrop:function(a){var b=$("#jsPanel-modal-backdrop-"+a.attr("id"));
b[0].classList.add("jsPanel-modal-backdrop-out");a=1E3*parseFloat(b.css("animation-duration"),10);window.setTimeout(function(){b.remove()},a)},lighten:function(a,b){var c=this.color(a).hsl,d=parseFloat(c.l);return"hsl("+c.h+","+c.s+","+(d+(100-d)*b+"%")+")"},maximize:function(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:!0,d=a.option.maximizedMargin,f=a[0].parentNode,g=a.attr("id");$.isPlainObject(d)&&(d=[d.top||5,d.right||5,d.bottom||5,d.left||5]);"number"===typeof d?d=[].concat(d,
d,d,d):$.isArray(d)&&2===d.length?d=d.concat(d):$.isArray(d)&&3===d.length&&(d[3]=d[1]);"normalized"===a.data("status")&&a.updateCachedData();$(document).trigger("jspanelbeforemaximize",g);if($.isFunction(a.option.onbeforemaximize)&&!1===a.option.onbeforemaximize.call(a,a))return a;a.css("overflow","visible");f===document.body?(a.css({width:document.documentElement.clientWidth-d[3]-d[1]+"px",height:document.documentElement.clientHeight-d[0]-d[2]+"px",left:d[3]+"px",top:d[0]+"px"}),!1===a.option.position.fixed&&
a.css({left:window.pageXOffset+d[3]+"px",top:window.pageYOffset+d[0]+"px"})):a.css({width:f.clientWidth-d[3]-d[1]+"px",height:f.clientHeight-d[0]-d[2]+"px",left:d[3]+"px",top:d[0]+"px"});a.contentResize().data("status","maximized");c&&a.css("z-index",this.setZi(a));a.hideControls([".jsPanel-btn-maximize",".jsPanel-btn-smallifyrev"]);this.remMinReplacement(a);$(document).trigger("jspanelmaximized",g);$(document).trigger("jspanelstatuschange",g);$.isFunction(a.option.onmaximized)&&a.option.onmaximized.call(a,
...
$(document).trigger("jspanelstatuschange",c);$.isFunction(a.option.onnormalized)&&a.option.onnormalized.call(a,a);b&&$.isFunction(b)&&b.call(a,a);return a},noscroll:function(a){a.preventDefault()},perceivedBrightness:function(a){a=this.color(a).rgb;return a.r/255*.2627+a.g/255*.678+a.b/255*.0593},position:function(a,b){function c(a){var b={};v.includes(a)?b.left=window.pageXOffset:u.includes(a)?b.left=window.pageXOffset+document.documentElement.clientWidth/2:w.includes(a)?b.left=window.pageXOffset+
document.documentElement.clientWidth:b.left=window.pageXOffset;B.includes(a)?b.top=window.pageYOffset:D.includes(a)?b.top=window.pageYOffset+window.innerHeight/2:I.includes(a)?b.top=window.pageYOffset+window.innerHeight:b.top=window.pageYOffset;return b}function d(a){var b={},c=e(k.of);v.includes(a)?b.left=c.left:u.includes(a)?b.left=c.left+c.width/2:w.includes(a)?b.left=c.left+c.width:b.left=c.left;B.includes(a)?b.top=c.top:D.includes(a)?b.top=c.top+c.height/2:I.includes(a)?b.top=c.top+c.height:
b.top=c.top;return b}function f(a){var b={},c=r.getBoundingClientRect();v.includes(a)?b.left=0:u.includes(a)?b.left=c.width/2:w.includes(a)?b.left=c.width:b.left=0;B.includes(a)?b.top=0:D.includes(a)?b.top=c.height/2:I.includes(a)?b.top=c.height:b.top=0;return b}function g(a){var b={},c=r.getBoundingClientRect(),d=document.querySelector(k.of).getBoundingClientRect(),e=d.left-c.left,c=d.top-c.top;v.includes(a)?b.left=e:u.includes(a)?b.left=e+d.width/2:w.includes(a)?b.left=e+d.width:b.left=e;B.includes(a)?
b.top=c:D.includes(a)?b.top=c+d.height/2:I.includes(a)?b.top=c+d.height:b.top=c;return b}function e(a){a=a.jquery?a[0].getBoundingClientRect():"string"===typeof a?document.querySelector(a).getBoundingClientRect():a.getBoundingClientRect();return{width:Math.round(a.width),height:Math.round(a.height),left:Math.round(a.left+window.pageXOffset),top:Math.round(a.top+window.pageYOffset)}}var h=void 0,l=void 0,k=void 0,r=void 0,y=0,n=0,z=l=void 0,q=void 0,v=["left-top","left-center","left-bottom"],u=["center-top",
"center","center-bottom"],w=["right-top","right-center","right-bottom"],B=["left-top","center-top","right-top"],D=["left-center","center","right-center"],I=["left-bottom","center-bottom","right-bottom"];if("string"===typeof b){var l=b.match(/\b[a-z]{4,6}-{1}[a-z]{3,6}\b/),t=b.match(/DOWN|UP|RIGHT|LEFT/),E=b.match(/[+-]?\d+\.?\d*%?/g),A=void 0,A=$.isArray(l)?{my:l[0],at:l[0]}:{my:"center",at:"center"};$.isArray(t)&&(A.autoposition=t[0]);$.isArray(E)&&(A.offsetX=E[0],2===E.length&&(A.offsetY=E[1]));
b=A}else l=0===b.left||b.left,t=0===b.top||b.top,E=0===b.right||b.right,A=0===b.bottom||b.bottom,l&&t?(b.my="left-top",b.at="left-top",b.offsetX=b.left,b.offsetY=b.top):l&&A?(b.my="left-bottom",b.at="left-bottom",b.offsetX=b.left,b.offsetY=-b.bottom):E&&t?(b.my="right-top",b.at="right-top",b.offsetX=-b.right,b.offsetY=b.top):E&&A&&(b.my="right-bottom",b.at="right-bottom",b.offsetX=-b.right,b.offsetY=-b.bottom);k=Object.assign({my:"center",at:"center",offsetX:0,offsetY:0,modify:!1,fixed:"true"},b);
h="string"===typeof a?document.querySelector(a):a.jquery?a[0]:a;if("boolean"===typeof b&&!1===b)return h.style.opacity=1,h.style.position="inherit",h;r=h.parentElement||document.body;k.of||(r===document.body?k.of="window":k.of=r);l=e(h);"string"===typeof k.offsetX&&"%"===k.offsetX.slice(-1)?k.offsetX="window"===k.of?window.innerWidth*(parseInt(k.offsetX,10)/100):r.clientWidth*(parseInt(k.offsetX,10)/100):"string"===typeof k.offsetX?k.offsetX=parseFloat(k.offsetX):$.isFunction(k.offsetX)&&(k.offsetX=
parseInt(k.offsetX.call(a,a),10));"string"===typeof k.offsetY&&"%"===k.offsetY.slice(-1)?k.offsetY="window"===k.of?window.innerHeight*(parseInt(k.offsetY,10)/100):r.clientHeight*(parseInt(k.offsetY,10)/100):"string"===typeof k.offsetY?k.offsetY=parseFloat(k.offsetY):$.isFunction(k.offsetY)&&(k.offsetY=parseInt(k.offsetY.call(a,a),10));t=parseInt(window.getComputedStyle(r)["border-left-width"],10)||0;v.includes(k.my)?y=t:u.includes(k.my)?y=l.width/2+t:w.includes(k.my)&&(y=l.width+t);t=parseInt(window.getComputedStyle(r)["border-top-width"],
10)||0;B.includes(k.my)?n=t:D.includes(k.my)?n=l.height/2+t:I.includes(k.my)&&(n=l.height+t);h.parentElement===document.body?"window"===k.of?(l=c(k.at),k.fixed?(z=l.left-y+k.offsetX-window.pageXOffset,q=l.top-n+k.offsetY-window.pageYOffset):(z=l.left-y+k.offsetX,q=l.top-n+k.offsetY)):(l=d(k.at),z=l.left-y+k.offsetX,q=l.top-n+k.offsetY):(l=l=void 0,l="string"===typeof k.of?document.querySelector(k.of):k.of.jquery?k.of[0]:k.of,l=r===l?f(k.at):g(k.at),z=l.left-y+k.offsetX,q=l.top-n+k.offsetY);k.autoposition&&
function(){var a=void 0,b=[];k.my===k.at&&(a=k.my);h.classList.add(a);b=Array.prototype.slice.call(r.getElementsByClassName(a));"DOWN"===k.autoposition?b.forEach(function(a,c){0<c&&(q+=b[--c].getBoundingClientRect().height+jsPanel.autopositionSpacing)}):"UP"===k.autoposition?b.forEach(function(a,c){0<c&&(q-=b[--c].getBoundingClientRect().height+jsPanel.autopositionSpacing)}):"RIGHT"===k.autoposition?b.forEach(function(a,c){0<c&&(z+=b[--c].getBoundingClientRect().width+jsPanel.autopositionSpacing)}):
"LEFT"===k.autoposition&&b.forEach(function(a,c){0<c&&(z-=b[--c].getBoundingClientRect().width+jsPanel.autopositionSpacing)})}();l={left:z,top:q};"function"===typeof k.modify&&(l=k.modify.call(l,l));h.style.position="absolute";h.style.left=l.left+"px";h.style.top=l.top+"px";h.style.opacity=1;"window"===k.of&&k.fixed&&r===document.body&&(h.style.position="fixed");return h},remMinReplacement:function(a){$('[id^="'+a.prop("id")+'-min"]').remove()},reposition:function(a){var b=1<arguments.length&&void 0!==
arguments[1]?arguments[1]:a.option.position,c=arguments[2];if("minimized"!==a.data("status")){a.option.position=b;if(a.option.paneltype.tooltip){var d=a.attr("class").split(" ");$.each(d,function(b,c){0===c.indexOf("jsPanel-tooltip-")&&a.removeClass(c)});this.setTooltipClass(a);$(".jsPanel-connector",a).remove();a.option.paneltype.connector&&this.addConnector(a)}this.position(a,b)}c&&$.isFunction(c)&&c.call(a,a);return a},resetZis:function(){var a=[];$(".jsPanel:not(.jsPanel-modal):not(.jsPanel-hint)").each(function(b,
...
b,"enabled"),$(".jsPanel-btn-"+b,d).css({pointerEvents:"auto",opacity:1,cursor:"pointer"})):"remove"===c&&($(".jsPanel-btn-"+b,d).remove(),f.setAttribute("data-btn"+b,"removed"))},setTooltipClass:function(a){var b=a.option.position.my+a.option.position.at;"center-bottomcenter-top"===b?a[0].classList.add("jsPanel-tooltip-top"):"left-bottomright-top"===b?a[0].classList.add("jsPanel-tooltip-righttopcorner"):"left-centerright-center"===b?a[0].classList.add("jsPanel-tooltip-right"):"left-topright-bottom"===
b?a[0].classList.add("jsPanel-tooltip-rightbottomcorner"):"center-topcenter-bottom"===b?a[0].classList.add("jsPanel-tooltip-bottom"):"right-topleft-bottom"===b?a[0].classList.add("jsPanel-tooltip-leftbottomcorner"):"right-centerleft-center"===b?a[0].classList.add("jsPanel-tooltip-left"):"right-bottomleft-top"===b?a[0].classList.add("jsPanel-tooltip-lefttopcorner"):"centercenter"===b?a[0].classList.add("jsPanel-tooltip-center"):"right-topleft-top"===b?a[0].classList.add("jsPanel-tooltip-lefttop"):
...
(g.position=g.position());"tooltip"===g.paneltype&&(g.paneltype={tooltip:!0});g.paneltype?"modal"===g.paneltype?e.option=a.extend(!0,{},a.jsPanel.defaults,a.jsPanel.modaldefaults,g):g.paneltype.tooltip?e.option=a.extend(!0,{},a.jsPanel.defaults,a.jsPanel.tooltipdefaults,g):"hint"===g.paneltype&&(e.option=a.extend(!0,{},a.jsPanel.defaults,a.jsPanel.hintdefaults,g)):e.option=a.extend(!0,{},a.jsPanel.defaults,g);var h=e.option,g=h.autoclose,l=h.border,d=h.callback,f=h.closeOnEscape,k=h.container,r=h.content,
y=h.contentAjax,n=h.contentIframe,z=h.contentOverflow,q=h.contentSize,v=h.custom,u=h.dblclicks,w=h.draggable,B=h.dragit,D=h.footerToolbar,I=h.headerControls,t=h.headerLogo,E=h.headerRemove,A=h.headerTitle,p=h.headerToolbar,C=h.id,F=h.onwindowresize,x=h.paneltype,S=h.position,T=h.resizable,N=h.resizeit,J=h.rtl,R=h.setstatus,m=h.show,M=h.theme;if(x.tooltip&&(b=jsPanel.setTrigger(S),b.classList.contains("hasTooltip")))return!1;"string"===typeof C?c=C:"function"===typeof C&&(c=C());if(0<a("#"+c).length)return console.warn("jsPanel Error: No jsPanel created - id attribute passed with option.id already exists in document"),
!1;e[0].id=c;e.data("custom",v);e.header=a(".jsPanel-hdr",e);e.header.headerbar=a(".jsPanel-headerbar",e.header);e.header.logo=a(".jsPanel-headerlogo",e.header.headerbar);e.header.title=a(".jsPanel-title",e.header.headerbar);e.header.controls=a(".jsPanel-controlbar",e.header.headerbar);e.header.toolbar=a(".jsPanel-hdr-toolbar",e.header);e.content=a(".jsPanel-content",e);e.footer=a(".jsPanel-ftr",e);e.data("status","initialized");e.cachedData={};e.close=function(){for(var a=arguments.length,b=Array(a),
...
function(a){a.preventDefault();jsPanel.minimize(e)});a(".jsPanel-btn-maximize",e).on("click",function(a){a.preventDefault();jsPanel.maximize(e)});a(".jsPanel-btn-normalize",e).on("click",function(a){a.preventDefault();jsPanel.normalize(e)});a(".jsPanel-btn-smallify, .jsPanel-btn-smallifyrev",e).on("click",function(a){a.preventDefault();jsPanel.smallify(e)});e.appendTo(a(k)[0]);jsPanel.activePanels.list.push(c);a(document).trigger("jspanelloaded",c);e.data("container",k);e.setTheme();E?(e.header.remove(),
e.content[0].classList.add("jsPanel-content-noheader"),jsPanel.controls.forEach(function(a){e[0].setAttribute("data-btn"+a,"removed")})):("closeonly"===I.controls?jsPanel.controls.forEach(function(a){"close"!==a&&jsPanel.setControlStatus(e,a,"remove")}):"none"===I.controls?jsPanel.controls.forEach(function(a){jsPanel.setControlStatus(e,a,"remove")}):jsPanel.controls.forEach(function(a){"disable"===I[a]?jsPanel.setControlStatus(e,a,"disable"):"remove"===I[a]?jsPanel.setControlStatus(e,a,"remove"):
e[0].setAttribute("data-btn"+a,"enabled")}),t&&("string"===typeof t&&"<"!==t.substring(0,1)?e.header.logo.append('<img src="'+t+'" alt="logo">'):e.header.logo.append(t)));(E||1>a(".jsPanel-hdr").length)&&e.content.css("border","none");jsPanel.configIconfont(e);"modal"===x?(jsPanel.insertModalBackdrop(e),e[0].classList.add("jsPanel-modal"),e.css("z-index",jsPanel.modalcount+9999)):"hint"===x?(e[0].classList.add("jsPanel-hint"),e.css("z-index",1E4)):x.tooltip&&(b=jsPanel.setTrigger(S),e[0].classList.add("jsPanel-tooltip"),
jsPanel.setTooltipClass(e),x.solo&&jsPanel.closeTooltips(),jsPanel.setTooltipMode(e,b));x.tooltip&&b.classList.add("hasTooltip");p&&!E&&e.toolbarAdd("header",p);D&&e.toolbarAdd("footer",D);r&&(e.content.append(r),e.data("content",r));y&&("string"===typeof y&&(e.option.contentAjax={url:y,autoload:!0}),jsPanel.ajax(e));a.isPlainObject(n)&&(n.src||n.srcdoc)&&jsPanel.iframe(e);x.connector&&jsPanel.addConnector(e);if("string"===typeof q){b=q.trim().split(/\s{1,}/);for(h=0;h<b.length;h++)b[h].match(/^\d{1,}$/)&&
(b[h]=parseInt(b[h],10));q={width:b[0],height:b[1]}}0===q.height&&(q.height="0");e.content.css({width:q.width||a.jsPanel.defaults.contentSize.width,height:q.height||a.jsPanel.defaults.contentSize.height});e.css({width:function(){return 0<a(".jsPanel-content",e).length?e.content.outerWidth()+"px":q.width||a.jsPanel.defaults.contentSize.width},zIndex:function(){jsPanel.setZi(e)}});e.content.css("width","100%");jsPanel.position(e,S);jsPanel.calcPositionFactors(e);e.data("status","normalized");a(document).trigger("jspanelstatuschange",
c);if(!x&&u){if(u.title)e.header.headerbar.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(u.title,e)});if(u.content)e.content.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(u.content,e)});if(u.footer)e.footer.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(u.footer,e)})}"string"===typeof z?e.content.css("overflow",z):a.isPlainObject(z)&&e.content.css({"overflow-y":z.vertical||z["overflow-y"],"overflow-x":z.horizontal||z["overflow-x"]});
jQuery.ui&&jQuery.ui.draggable&&!B.disableui?a.isPlainObject(w)?e.draggable(w):"disabled"===w?(a(".jsPanel-titlebar, .jsPanel-ftr",e).css("cursor","default"),e.draggable({disabled:!0})):a(".jsPanel-titlebar, .jsPanel-ftr",e).css("cursor","default"):B?jsPanel.dragit(e,B):a(".jsPanel-titlebar, .jsPanel-ftr",e).css("cursor","default");jQuery.ui&&jQuery.ui.resizable&&!N.disableui?a.isPlainObject(T)?e.resizable(T):"disabled"===T&&(e.resizable({disabled:!0}),a(".ui-icon-gripsmall-diagonal-se, .ui-resizable-handle.ui-resizable-sw",
e).css({"background-image":"none","text-indent":-9999}),a(".ui-resizable-handle",e).css({cursor:"inherit"})):N&&jsPanel.resizeit(e,N);!0===J.rtl&&(a(".jsPanel-hdr, .jsPanel-headerbar, .jsPanel-titlebar, .jsPanel-controlbar, .jsPanel-hdr-toolbar, .jsPanel-ftr",e).addClass("jsPanel-rtl"),[e.header.title,e.content,a("*",e.header.toolbar),a("*",e.footer)].forEach(function(a){a.prop("dir","rtl");J.lang&&a.prop("lang",J.lang)}),a(".ui-icon-gripsmall-diagonal-se",e).css({backgroundImage:"none",textIndent:-9999}));
"string"===typeof m&&e.addClass(m).css("opacity",1);e.header.title.empty().prepend(A);e.updateCachedData();"string"===typeof R&&("maximize smallify"===R?e.maximize().smallify():e[R]());"number"===typeof g&&0<g&&window.setTimeout(function(){e&&e.close()},g);jQuery.ui&&jQuery.ui.resizable&&(e.on("resize",function(){return jsPanel.contentResize(e)}),e.on("resizestop",function(){if("smallified"===e.data("status")||"smallifiedMax"===e.data("status"))e.hideControls([".jsPanel-btn-normalize",".jsPanel-btn-smallifyrev"]),
...
e[0].setAttribute("data-closeonescape","true");F&&a(window).resize(function(b){if(b.target===window){var c=e.data("status");if("maximized"===c&&!a.isFunction(F))e.maximize(!1,!1);else if("normalized"===c||"smallified"===c||"maximized"===c)a.isFunction(F)?F.call(e,b,e):e.reposition({left:function(){var b;b="body"===this.option.container?(a(window).outerWidth()-this.outerWidth())*this.hf:(this.parent().outerWidth()-this.outerWidth())*this.hf;return 0>=b?0:b},top:function(){var b;b="body"===this.option.container?
