...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(b) {
    if (void 0 === b || null === b) throw new TypeError("Cannot convert first argument to object");for (var c = Object(b), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), a = Object.keys(Object(e)), f = 0, n = a.length; f < n; f++) {
        var p = a[f],
            k = Object.getOwnPropertyDescriptor(e, p);void 0 !== k && k.enumerable && (c[p] = e[p]);
      }
    }return c;
  } });
...
var jsPanel = { version: "3.0.0 RC1.13", date: "2016-05-24 21:03", id: 0, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(b) {
    ...
    function d(a, b) {
      ...
      offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);k = "string" === typeof b ? document.querySelector(b) : b.jquery ? b[0] : b;h = k.parentElement;g.of || (h === document.body ? g.of = "window" : g.of = h);l = p(k);"string" === typeof g.offsetX && "%" === g.offsetX.slice(-1) ? g.offsetX = "window" === g.of ? window.innerWidth * (parseInt(g.offsetX, 10) / 100) : h.clientWidth * (parseInt(g.offsetX, 10) / 100) : "string" === typeof g.offsetX ? g.offsetX = parseFloat(g.offsetX) : $.isFunction(g.offsetX) && (g.offsetX = parseInt(g.offsetX.call(b, b)));"string" === typeof g.offsetY && "%" === g.offsetY.slice(-1) ? g.offsetY = "window" === g.of ? window.innerHeight * (parseInt(g.offsetY, 10) / 100) : h.clientHeight * (parseInt(g.offsetY, 10) / 100) : "string" === typeof g.offsetY ? g.offsetY = parseFloat(g.offsetY) : $.isFunction(g.offsetY) && (g.offsetY = parseInt(g.offsetY.call(b, b)));q = parseInt(d(h, "border-left-width"));u.includes(g.my) ? r = q : v.includes(g.my) ? r = l.width / 2 + q : w.includes(g.my) && (r = l.width + q);q = parseInt(d(h, "border-top-width"));x.includes(g.my) ? t = q : y.includes(g.my) ? t = l.height / 2 + q : z.includes(g.my) && (t = l.height + q);k.parentElement === document.body ? "window" === g.of ? (l = e(g.at), g.fixed ? (r = l.left - r + g.offsetX - window.pageXOffset, t = l.top - t + g.offsetY - window.pageYOffset) : (r = l.left - r + g.offsetX, t = l.top - t + g.offsetY)) : (l = a(g.at), r = l.left - r + g.offsetX, t = l.top - t + g.offsetY) : (l = "string" === typeof g.of ? document.querySelector(g.of) : g.of.jquery ? g.of[0] : g.of, l = h === l ? f(g.at) : n(g.at), r = l.left - r + g.offsetX, t = l.top - t + g.offsetY);if (g.autoposition) {
      l = [];q = this.autopositionSpacing;g.my === g.at && (m = g.my);k.setAttribute("data-autoposition", g.autoposition);$.isFunction(g.offsetX) || k.setAttribute("data-offsetx", g.offsetX);$.isFunction(g.offsetY) || k.setAttribute("data-offsety", g.offsetY);k.classList.add(m);m = document.getElementsByClassName(m);for (var A = 0; A < m.length; A++) {
        m[A].parentElement === h && l.push(m[A]);
      }if ("DOWN" === g.autoposition) for (m = 0; m < l.length - 1; m++) {
        t += l[m].getBoundingClientRect().height + q;
      } else if ("UP" === g.autoposition) for (m = 0; m < l.length - 1; m++) {
        t -= l[m].getBoundingClientRect().height + q;
      } else if ("RIGHT" === g.autoposition) for (m = 0; m < l.length - 1; m++) {
        r += l[m].getBoundingClientRect().width + q;
      } else if ("LEFT" === g.autoposition) for (m = 0; m < l.length - 1; m++) {
        r -= l[m].getBoundingClientRect().width + q;
      }
    }m = { left: r, top: t };"function" === typeof g.modify && (m = g.modify.call(m, m));k.style.position = "absolute";k.style.left = m.left + "px";k.style.top = m.top + "px";k.style.opacity = 1;"window" === g.of && g.fixed && h === document.body && (k.style.position = "fixed");return k;
    ...
    function c(a) {
      if (a.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== b.footer.css("display") ? p : 0 < parseFloat(b.option.contentSize.height) ? n : k;
    }function d(a) {
      if (a.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!b.option.headerRemove) return k;if (0 < parseFloat(b.option.contentSize.height)) return n;if ("none" !== b.footer.css("display")) return p;
      }
    }function e(a) {
      if (a.match(/lefttop|righttop/)) return b.option.headerRemove ? n : k;
    }function a(a) {
      if (a.match(/left|right/)) {
        if (0 < parseFloat(b.option.contentSize.height)) return n;if (!b.option.headerRemove) return k;if ("none" !== b.footer.css("display")) return p;
      }
  ...
  toolbar: function toolbar(b, c, d) {
    ...
    });window.localStorage.setItem("jspanels", JSON.stringify(p));return p;
  ...
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
      ...
      b(document).trigger("jspanelbeforeclose", d);if (b.isFunction(a.option.onbeforeclose) && !1 === a.option.onbeforeclose.call(a, a)) return a;var c = a.option.position;if (c.autoposition || "string" === typeof c && c.match(/DOWN|RIGHT|UP|LEFT/)) {
        ...
        return a === d;
      });-1 < c && jsPanel.activePanels.list.splice(c, 1);b("#" + d + "-min").remove();"modal" === a.option.paneltype && b("#jsPanel-modal-backdrop-" + a.attr("id")).remove();a.option.paneltype.tooltip && b(f).removeClass("hasTooltip");b(document).trigger("jspanelclosed", d);b(document).trigger("jspanelstatuschange", d);var e, k;jsPanel.lastbeforeclose && (e = jsPanel.lastbeforeclose.parent, e = b("." + jsPanel.lastbeforeclose["class"], e), k = jsPanel.lastbeforeclose["class"]);e && (e.each(function (a, c) {
        b(c).removeClass(k);
      }), e.each(function (a, b) {
        var c = b.getAttribute("data-autoposition"),
            d = b.getAttribute("data-offsetx"),
            l = b.getAttribute("data-offsety");jsPanel.position(b, { my: k, at: k, autoposition: c, offsetX: d, offsetY: l });
      ...
      c = void 0 === c ? a.option.theme.toLowerCase().replace(/ /g, "") : c;c = c.toLowerCase().replace(/ /g, "");var e = [],
          f,
          k;jsPanel.themes.forEach(function (b, c, d) {
      ...
      a.outerWidth() !== p && a.outerHeight() === n ? (jsPanel.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallify", a), a.data("status", "smallified"), b(document).trigger("jspanelsmallified", d), b(document).trigger("jspanelstatuschange", d)) : a.outerHeight() !== n && (jsPanel.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev", a), a.data("status", "normalized"), b(document).trigger("jspanelnormalized", d), b(document).trigger("jspanelstatuschange", d));
