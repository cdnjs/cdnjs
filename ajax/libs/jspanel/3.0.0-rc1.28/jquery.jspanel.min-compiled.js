...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(a) {
    if (void 0 === a || null === a) throw new TypeError("Cannot convert first argument to object");for (var c = Object(a), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), b = Object.keys(Object(e)), f = 0, m = b.length; f < m; f++) {
        var q = b[f],
            h = Object.getOwnPropertyDescriptor(e, q);void 0 !== h && h.enumerable && (c[q] = e[q]);
      }
    }return c;
  } });
Array.prototype.find || (Array.prototype.find = function (a, c) {
  if (null == this) throw new TypeError("Array.prototype.find called on null or undefined");if ("function" !== typeof a) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, b, f = 0; f < e; f++) {
    if (b = d[f], a.call(c, b, f, d)) return b;
  }
});
Array.prototype.findIndex || (Array.prototype.findIndex = function (a, c) {
  if (null === this) throw new TypeError("Array.prototype.findIndex called on null or undefined");if ("function" !== typeof a) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, b, f = 0; f < e; f++) {
    if (b = d[f], a.call(c, b, f, d)) return f;
  }return -1;
});
Array.prototype.includes || (Array.prototype.includes = function (a, c) {
  var d = Object(this),
      e = parseInt(d.length) || 0;if (0 === e) return !1;var b = parseInt(c) || 0;0 <= b || (b = e + b, 0 > b && (b = 0));for (var f; b < e;) {
    f = d[b];if (a === f || a !== a && f !== f) return !0;b++;
  }return !1;
...
var jsPanel = { version: "3.0.0 RC1.28", date: "2016-06-02 22:28", id: 0, ziBase: 100, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(a) {
    ...
    function d(b, a) {
      ...
      var a = {},
          c = q(g.of);u.includes(b) ? a.left = c.left : v.includes(b) ? a.left = c.left + c.width / 2 : w.includes(b) ? a.left = c.left + c.width : a.left = c.left;x.includes(b) ? a.top = c.top : y.includes(b) ? a.top = c.top + c.height / 2 : z.includes(b) ? a.top = c.top + c.height : a.top = c.top;return a;
    }function f(b) {
      var a = {},
    ...
    }g = Object.assign({ my: "center",
      at: "center", offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);h = "string" === typeof a ? document.querySelector(a) : a.jquery ? a[0] : a;p = h.parentElement;g.of || (p === document.body ? g.of = "window" : g.of = p);k = q(h);"string" === typeof g.offsetX && "%" === g.offsetX.slice(-1) ? g.offsetX = "window" === g.of ? window.innerWidth * (parseInt(g.offsetX, 10) / 100) : p.clientWidth * (parseInt(g.offsetX, 10) / 100) : "string" === typeof g.offsetX ? g.offsetX = parseFloat(g.offsetX) : $.isFunction(g.offsetX) && (g.offsetX = parseInt(g.offsetX.call(a, a)));"string" === typeof g.offsetY && "%" === g.offsetY.slice(-1) ? g.offsetY = "window" === g.of ? window.innerHeight * (parseInt(g.offsetY, 10) / 100) : p.clientHeight * (parseInt(g.offsetY, 10) / 100) : "string" === typeof g.offsetY ? g.offsetY = parseFloat(g.offsetY) : $.isFunction(g.offsetY) && (g.offsetY = parseInt(g.offsetY.call(a, a)));r = parseInt(d(p, "border-left-width"));u.includes(g.my) ? t = r : v.includes(g.my) ? t = k.width / 2 + r : w.includes(g.my) && (t = k.width + r);r = parseInt(d(p, "border-top-width"));x.includes(g.my) ? n = r : y.includes(g.my) ? n = k.height / 2 + r : z.includes(g.my) && (n = k.height + r);h.parentElement === document.body ? "window" === g.of ? (k = e(g.at), g.fixed ? (t = k.left - t + g.offsetX - window.pageXOffset, n = k.top - n + g.offsetY - window.pageYOffset) : (t = k.left - t + g.offsetX, n = k.top - n + g.offsetY)) : (k = b(g.at), t = k.left - t + g.offsetX, n = k.top - n + g.offsetY) : (k = "string" === typeof g.of ? document.querySelector(g.of) : g.of.jquery ? g.of[0] : g.of, k = p === k ? f(g.at) : m(g.at), t = k.left - t + g.offsetX, n = k.top - n + g.offsetY);if (g.autoposition) {
      k = [];r = this.autopositionSpacing;g.my === g.at && (l = g.my);h.setAttribute("data-autoposition", g.autoposition);$.isFunction(g.offsetX) || h.setAttribute("data-offsetx", g.offsetX);$.isFunction(g.offsetY) || h.setAttribute("data-offsety", g.offsetY);h.classList.add(l);l = document.getElementsByClassName(l);for (var A = 0; A < l.length; A++) {
        l[A].parentElement === p && k.push(l[A]);
      }if ("DOWN" === g.autoposition) for (l = 0; l < k.length - 1; l++) {
        n += k[l].getBoundingClientRect().height + r;
      } else if ("UP" === g.autoposition) for (l = 0; l < k.length - 1; l++) {
        n -= k[l].getBoundingClientRect().height + r;
      } else if ("RIGHT" === g.autoposition) for (l = 0; l < k.length - 1; l++) {
        t += k[l].getBoundingClientRect().width + r;
      } else if ("LEFT" === g.autoposition) for (l = 0; l < k.length - 1; l++) {
        t -= k[l].getBoundingClientRect().width + r;
      }
    }l = { left: t, top: n };"function" === typeof g.modify && (l = g.modify.call(l, l));h.style.position = "absolute";h.style.left = l.left + "px";h.style.top = l.top + "px";h.style.opacity = 1;"window" === g.of && g.fixed && p === document.body && (h.style.position = "fixed");return h;
  }, reposition: function reposition(a, c, d) {
    c = void 0 === c ? a.option.position : c;"minimized" !== a.data("status") && (0 < $(".jsPanel-connector", a).length && $(".jsPanel-connector", a).remove(), this.position(a, c), a.option.position = c);d && $.isFunction(d) && d.call(a, a);return a;
    ...
    if (0 === c) d = c = a = d;else {
      var e = function e(b, a, c) {
        0 > c && (c += 1);1 < c && --c;return c < 1 / 6 ? b + 6 * (a - b) * c : .5 > c ? a : c < 2 / 3 ? b + (a - b) * (2 / 3 - c) * 6 : b;
          ...
          b = .5 > d ? d * (1 + c) : d + c - d * c,
          f = 2 * d - b;d = e(f, b, a + 1 / 3);c = e(f, b, a);a = e(f, b, a - 1 / 3);
    ...
    a /= 255;c /= 255;d /= 255;var e = Math.max(a, c, d),
        b = Math.min(a, c, d),
        f,
        m = (e + b) / 2;if (e === b) f = b = 0;else {
      var q = e - b,
          b = .5 < m ? q / (2 - e - b) : q / (e + b);switch (e) {case a:
          f = (c - d) / q + (c < d ? 6 : 0);break;case c:
          f = (d - a) / q + 2;break;case d:
          f = (a - c) / q + 4;}f /= 6;
    }f *= 360;b = 100 * b + "%";m = 100 * m + "%";return { css: "hsl(" + f + "," + b + "," + m + ")", h: f, s: b, l: m };
    ...
    a = this.color(a).rgb;return a.r / 255 * .2627 + a.g / 255 * .678 + a.b / 255 * .0593;
    ...
    var c = this.color(a),
        ...
        b,
        f,
        m;this.perceivedBrightness(a) <= this.pbTreshold ? b = "#ffffff" : b = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? f = "#ffffff" : f = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? m = "#000000" : m = "#ffffff";return [c.hsl.css, d, e, b, f, m];
...
(function (a) {
  a.jsPanel = function (c) {
    ...
    b.contentReload = function () {
      ...
      e.length ? (a(".jsPanel-minimized-box").length || a(e[0]).append("<div class='jsPanel-minimized-box'>"), a(".jsPanel-minimized-box").append(f)) : a("#jsPanel-replacement-container").append(f);a(document).trigger("jspanelminimized", d);a(document).trigger("jspanelstatuschange", d);a.isFunction(b.option.onminimized) && b.option.onminimized.call(b, b);c && a.isFunction(c) && c.call(b, b);a(".jsPanel-btn-normalize", f).css("display", "block").click(function () {
    ...
    }, !1);a(document.body).append("<div id='jsPanel-replacement-container'>");window.addEventListener("keydown", function (a) {
