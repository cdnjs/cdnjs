...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(b) {
    if (void 0 === b || null === b) throw new TypeError("Cannot convert first argument to object");for (var c = Object(b), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), a = Object.keys(Object(e)), h = 0, n = a.length; h < n; h++) {
        var m = a[h],
...
var jsPanel = { version: "3.0.0 RC1.12", date: "2016-05-24 10:57", id: 0, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(b) {
    ...
    function d(a, b) {
      ...
      var b = {},
          c = t.getBoundingClientRect();u.includes(a) ? b.left = 0 : v.includes(a) ? b.left = c.width / 2 : w.includes(a) ? b.left = c.width : b.left = 0;x.includes(a) ? b.top = 0 : y.includes(a) ? b.top = c.height / 2 : z.includes(a) ? b.top = c.height : b.top = 0;return b;
    }function n(a) {
      var b = {},
      ...
      offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);k = "string" === typeof b ? document.querySelector(b) : b.jquery ? b[0] : b;t = k.parentElement;f.of || (t === document.body ? f.of = "window" : f.of = t);g = m(k);"string" === typeof f.offsetX && "%" === f.offsetX.slice(-1) ? f.offsetX = "window" === f.of ? window.innerWidth * (parseInt(f.offsetX, 10) / 100) : t.clientWidth * (parseInt(f.offsetX, 10) / 100) : "string" === typeof f.offsetX ? f.offsetX = parseFloat(f.offsetX) : $.isFunction(f.offsetX) && (f.offsetX = parseInt(f.offsetX.call(b, b)));"string" === typeof f.offsetY && "%" === f.offsetY.slice(-1) ? f.offsetY = "window" === f.of ? window.innerHeight * (parseInt(f.offsetY, 10) / 100) : t.clientHeight * (parseInt(f.offsetY, 10) / 100) : "string" === typeof f.offsetY ? f.offsetY = parseFloat(f.offsetY) : $.isFunction(f.offsetY) && (f.offsetY = parseInt(f.offsetY.call(b, b)));p = parseInt(d(t, "border-left-width"));u.includes(f.my) ? q = p : v.includes(f.my) ? q = g.width / 2 + p : w.includes(f.my) && (q = g.width + p);p = parseInt(d(t, "border-top-width"));x.includes(f.my) ? r = p : y.includes(f.my) ? r = g.height / 2 + p : z.includes(f.my) && (r = g.height + p);k.parentElement === document.body ? "window" === f.of ? (g = e(f.at), f.fixed ? (q = g.left - q + f.offsetX - window.pageXOffset, r = g.top - r + f.offsetY - window.pageYOffset) : (q = g.left - q + f.offsetX, r = g.top - r + f.offsetY)) : (g = a(f.at), q = g.left - q + f.offsetX, r = g.top - r + f.offsetY) : (g = "string" === typeof f.of ? document.querySelector(f.of) : f.of.jquery ? f.of[0] : f.of, g = t === g ? h(f.at) : n(f.at), q = g.left - q + f.offsetX, r = g.top - r + f.offsetY);if (f.autoposition) {
    ...
    b /= 255;c /= 255;d /= 255;var e = Math.max(b, c, d),
        a = Math.min(b, c, d),
        h,
        n = (e + a) / 2;if (e === a) h = a = 0;else {
      var m = e - a,
          a = .5 < n ? m / (2 - e - a) : m / (e + a);switch (e) {case b:
          h = (c - d) / m + (c < d ? 6 : 0);break;case c:
          h = (d - b) / m + 2;break;case d:
          h = (b - c) / m + 4;}h /= 6;
    }h *= 360;a = 100 * a + "%";n = 100 * n + "%";return { css: "hsl(" + h + "," + a + "," + n + ")", h: h, s: a, l: n };
    ...
    var c = this.color(b),
        ...
        a,
        h,
        n;this.perceivedBrightness(b) <= this.pbTreshold ? a = "#ffffff" : a = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? h = "#ffffff" : h = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? n = "#000000" : n = "#ffffff";return [c.hsl.css, d, e, a, h, n];
    ...
    function c(a) {
      if (a.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== b.footer.css("display") ? m : 0 < parseFloat(b.option.contentSize.height) ? n : k;
    }function d(a) {
      if (a.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!b.option.headerRemove) return k;if (0 < parseFloat(b.option.contentSize.height)) return n;if ("none" !== b.footer.css("display")) return m;
      }
    }function e(a) {
      if (a.match(/lefttop|righttop/)) return b.option.headerRemove ? n : k;
    }function a(a) {
      if (a.match(/left|right/)) {
        if (0 < parseFloat(b.option.contentSize.height)) return n;if (!b.option.headerRemove) return k;if ("none" !== b.footer.css("display")) return m;
      }
  ...
  toolbar: function toolbar(b, c, d) {
    ...
    var b,
        ...
        m = [],
        k,
        g = $(".jsPanel").not(".jsPanel-tooltip, .jsPanel-hint, .jsPanel-modal");g.each(function (a, b) {
      "normalized" !== $(b).data("status") && $(".jsPanel-btn-normalize", b).trigger("click");
    });g.each(function (f, g) {
      n = $(g).data("container");
      b = $(g).offset();c = $(g).position();"body" === n.toLowerCase() ? (d = Math.floor(b.top - $(window).scrollTop()), e = Math.floor(b.left - $(window).scrollLeft())) : (d = Math.floor(c.top), e = Math.floor(c.left));a = $(g).css("width");h = $(".jsPanel-content", g).css("height");k = { status: $(g).data("status"), id: $(g).prop("id"), headerTitle: $(".jsPanel-title", g).html(), custom: $(g).data("custom"), content: $(g).data("content"), contentSize: { width: a, height: h }, position: { my: "left-top", at: "left-top", offsetX: e, offsetY: d } };$(g).data("ajaxURL") && (k.contentAjax = { url: $(g).data("ajaxURL"), autoload: !0 });if ($(g).data("iframeDOC") || $(g).data("iframeSRC")) k.contentIframe = { src: $(g).data("iframeSRC") || "", srcdoc: $(g).data("iframeDOC") || "" };m.push(k);switch (k.status) {case "minimized":
    ...
    var b = [];$(".jsPanel:not(.jsPanel-modal):not(.jsPanel-hint)").each(function (c, d) {
      ...
      (jsPanel.zi += 1) > $(b).css("z-index") && $(b).css("z-index", 100 + d);
    });this.zi = 99 + b.length;
  },
  ...
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
      ...
      if ("minimized" === a.data("status")) return a;b(document).trigger("jspanelbeforeminimize", d);if (b.isFunction(a.option.onbeforeminimize) && !1 === a.option.onbeforeminimize.call(a, a)) return a;var c = a.header.headerbar.css("color"),
          e;e = a.hasClass("panel") ? "transparent" === a.header.css("background-color") ? a.css("background-color") : a.header.css("background-color") : a.css("background-color");"normalized" === a.data("status") && jsPanel.updateCachedData(a);var g = b(jsPanel.replacementTemplate);g.left = a.css("left");a.css("left", "-9999px").data("status", "minimized");g.css({ backgroundColor: e }).prop("id", a.prop("id") + "-min").find("h3").css({ color: c }).html(a.headerTitle());b(".jsPanel-btn", g).css({ color: c });c = b(a.option.container).closest(".jsPanel-content");
      c.length ? (b(".jsPanel-minimized-box").length || b(c[0]).append("<div class='jsPanel-minimized-box'>"), b(".jsPanel-minimized-box").append(g)) : b("#jsPanel-replacement-container").append(g);b(document).trigger("jspanelminimized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onminimized) && a.option.onminimized.call(a, a);b(".jsPanel-btn-normalize", g).css("display", "block").click(function () {
      ...
      a && a.close();
    }, a.option.autoclose);a[0].jspanel = { options: a.option, close: function close() {
        a.close();
