...
b(".jsPanel-headerbar",a.header);a.header.logo=b(".jsPanel-headerlogo",a.header.headerbar);a.header.title=b(".jsPanel-title",a.header.headerbar);a.header.controls=b(".jsPanel-controlbar",a.header.headerbar);a.header.toolbar=b(".jsPanel-hdr-toolbar",a.header);a.content=b(".jsPanel-content",a);a.footer=b(".jsPanel-ftr",a);a.data("status","initialized");a.cachedData={};a.close=function(c){b(document).trigger("jspanelbeforeclose",d);if(b.isFunction(a.option.onbeforeclose)&&!1===a.option.onbeforeclose.call(a,
a))return a;var k=a.option.position;if(k.autoposition||"string"===typeof k&&k.match(/DOWN|RIGHT|UP|LEFT/)){var k=b("#"+d).parent(),f=document.getElementById(d).className.match(/left-top|center-top|right-top|left-center|center|right-center|left-bottom|center-bottom|right-bottom/);f&&(jsPanel.lastbeforeclose={parent:k,"class":f[0]})}a.closeChildpanels().remove();if(!b("#"+d).length){k=jsPanel.activePanels.list.findIndex(function(a){return a===d});-1<k&&jsPanel.activePanels.list.splice(k,1);b("#"+d+
"-min").remove();"modal"===a.option.paneltype&&b("#jsPanel-modal-backdrop-"+a.attr("id")).remove();a.option.paneltype.tooltip&&b(h).removeClass("hasTooltip");b(document).trigger("jspanelclosed",d);b(document).trigger("jspanelstatuschange",d);var e,g;jsPanel.lastbeforeclose&&(e=jsPanel.lastbeforeclose.parent,e=b("."+jsPanel.lastbeforeclose["class"],e),g=jsPanel.lastbeforeclose["class"]);e&&(e.each(function(a,c){b(c).removeClass(g)}),e.each(function(b,c){jsPanel.position(c,a.option.position)}));jsPanel.lastbeforeclose=
...
10)+parseInt(a.css("border-bottom-width"),10);a.footer.hasClass("active")?d=a.header.outerHeight()+a.footer.outerHeight():d=a.header.outerHeight();a.content.css({height:a.outerHeight()-d-f});c&&b.isFunction(c)&&c.call(a,a);return a};a.front=function(c){a.css("z-index",jsPanel.setZi(a));jsPanel.resetZis();b(document).trigger("jspanelfronted",d);if(b.isFunction(a.option.onfronted)){if(!1===a.option.onfronted.call(a,a))return a;a.option.onfronted.call(a,a)}c&&b.isFunction(c)&&c.call(a,a);return a};a.headerControl=
function(c,d){d=void 0===d?"enable":d;var f=function(c,d){var l=a.header.headerbar,f=a[0];"disable"===d?"removed"!==f.getAttribute("data-btn"+c)&&(f.setAttribute("data-btn"+c,"disabled"),b(".jsPanel-btn-"+c,l).css({pointerEvents:"none",opacity:.4,cursor:"default"})):"enable"===d?"removed"!==f.getAttribute("data-btn"+c)&&(f.setAttribute("data-btn"+c,"enabled"),b(".jsPanel-btn-"+c,l).css({pointerEvents:"auto",opacity:1,cursor:"pointer"})):"remove"===d&&"close"!==c&&(f.setAttribute("data-btn"+c,"removed"),
b(".jsPanel-btn-"+c,l).remove())};c?f(c,d):["close","maximize","minimize","normalize","smallify"].forEach(function(a){f(a,d)});return a};a.headerTitle=function(b){return b?(a.header.title.empty().append(b),a):a.header.title.html()};a.hideControls=function(c){var d=a.header.headerbar;b("div",d).css("display","flex");b(c,d).css("display","none")};a.maximize=function(c,k){k=void 0===k?!0:k;var f=a.option.maximizedMargin,e=a[0].parentNode;"normalized"===a.data("status")&&a.updateCachedData();b(document).trigger("jspanelbeforemaximize",
d);if(b.isFunction(a.option.onbeforemaximize)&&!1===a.option.onbeforemaximize.call(a,a))return a;a.css("overflow","visible");if(e===document.body){var g;jsPanel.isIE||jsPanel.isEdge?g=11:g=0;a.css({width:document.documentElement.clientWidth-f.left-f.right-g+"px",height:document.documentElement.clientHeight-f.top-f.bottom+"px",left:f.left+"px",top:f.top+"px"});!1===a.option.position.fixed&&a.css({left:window.pageXOffset+f.left+"px",top:window.pageYOffset+f.top+"px"})}else a.css({width:e.clientWidth-
f.left-f.right+"px",height:e.clientHeight-f.top-f.bottom+"px",left:f.left+"px",top:f.top+"px"});a.contentResize().data("status","maximized");k&&a.css("z-index",jsPanel.setZi(a));a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev");b("#"+a.prop("id")+"-min").remove();b(document).trigger("jspanelmaximized",d);b(document).trigger("jspanelstatuschange",d);b.isFunction(a.option.onmaximized)&&a.option.onmaximized.call(a,a);c&&b.isFunction(c)&&c.call(a,a);return a};a.minimize=function(c){if("minimized"===
a.data("status"))return a;b(document).trigger("jspanelbeforeminimize",d);if(b.isFunction(a.option.onbeforeminimize)&&!1===a.option.onbeforeminimize.call(a,a))return a;var k=a.header.headerbar.css("color"),f;f=a.hasClass("panel")?"transparent"===a.header.css("background-color")?a.css("background-color"):a.header.css("background-color"):a.header.css("background-color");"normalized"===a.data("status")&&a.updateCachedData();var e=b(jsPanel.replacementTemplate);e.left=a.css("left");a.css("left","-9999px").data("status",
"minimized");e.css({backgroundColor:f}).prop("id",a.prop("id")+"-min").find("h3").css({color:k}).prop("title",a.header.title[0].textContent).html(a.headerTitle());a.header.logo.children().length&&(f=a.header.logo.clone(),b(".jsPanel-headerbar",e).prepend(f));f=a.option.headerControls.iconfont;if("font-awesome"===f)b(".jsglyph.jsglyph-normalize",e).removeClass().addClass("fa fa-expand"),b(".jsglyph.jsglyph-maximize",e).removeClass().addClass("fa fa-arrows-alt"),b(".jsglyph.jsglyph-close",e).removeClass().addClass("fa fa-times");
else if("bootstrap"===f||"glyphicon"===f)b(".jsglyph.jsglyph-normalize",e).removeClass().addClass("glyphicon glyphicon-resize-full"),b(".jsglyph.jsglyph-maximize",e).removeClass().addClass("glyphicon glyphicon-fullscreen"),b(".jsglyph.jsglyph-close",e).removeClass().addClass("glyphicon glyphicon-remove");b(".jsPanel-btn span",e).css({color:k});k=b(a.option.container).closest(".jsPanel-content");k.length?(b(".jsPanel-minimized-box").length||b(k[0]).append("<div class='jsPanel-minimized-box'>"),b(".jsPanel-minimized-box").append(e)):
b("#jsPanel-replacement-container").append(e);b(document).trigger("jspanelminimized",d);b(document).trigger("jspanelstatuschange",d);b.isFunction(a.option.onminimized)&&a.option.onminimized.call(a,a);c&&b.isFunction(c)&&c.call(a,a);b(".jsPanel-btn-normalize",e).css("display","block").on("click",function(){a.css("left",e.left);e.remove();b(".jsPanel-btn-normalize",a).trigger("click")});"disabled"===a[0].dataset.btnnormalize?b(".jsPanel-btn-normalize",e).css({pointerEvents:"none",opacity:.5,cursor:"default"}):
"removed"===a[0].dataset.btnnormalize&&b(".jsPanel-btn-normalize",e).remove();b(".jsPanel-btn-maximize",e).on("click",function(){a.css("left",e.left);e.remove();b(".jsPanel-btn-maximize",a).trigger("click")});"disabled"===a[0].dataset.btnmaximize?b(".jsPanel-btn-maximize",e).css({pointerEvents:"none",opacity:.5,cursor:"default"}):"removed"===a[0].dataset.btnmaximize&&b(".jsPanel-btn-maximize",e).remove();b(".jsPanel-btn-close",e).on("click",function(){e.remove();a.close()});"disabled"===a[0].dataset.btnclose&&
b(".jsPanel-btn-close",e).css({pointerEvents:"none",opacity:.5,cursor:"default"});return a};a.normalize=function(c){if("normalized"===a.data("status"))return a;b(document).trigger("jspanelbeforenormalize",d);if(b.isFunction(a.option.onbeforenormalize)&&!1===a.option.onbeforenormalize.call(a,a))return a;if("smallified"===a.data("status"))return a.smallify(),b(document).trigger("jspanelnormalized",d),b(document).trigger("jspanelstatuschange",d),b.isFunction(a.option.onnormalized)&&a.option.onnormalized.call(a,
a),a;a.css({left:a.cachedData.left,top:a.cachedData.top,width:a.cachedData.width,height:a.cachedData.height,zIndex:function(){jsPanel.setZi(a)},overflow:"visible"}).data("status","normalized").contentResize();a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev");b("#"+a.prop("id")+"-min").remove();b(document).trigger("jspanelnormalized",d);b(document).trigger("jspanelstatuschange",d);b.isFunction(a.option.onnormalized)&&a.option.onnormalized.call(a,a);c&&b.isFunction(c)&&c.call(a,a);
return a};a.reposition=function(c,d){c=void 0===c?a.option.position:c;if("minimized"!==a.data("status")){a.option.position=c;if(a.option.paneltype.tooltip){var f=a.attr("class").split(" ");b.each(f,function(b,c){0==c.indexOf("jsPanel-tooltip-")&&a.removeClass(c)});jsPanel.setTooltipClass(a);b(".jsPanel-connector",a).remove();a.option.paneltype.connector&&jsPanel.addConnector(a)}jsPanel.position(a,c)}d&&b.isFunction(d)&&d.call(a,a);return a};a.resize=function(c,d,f){if("minimized"!==a.data("status")){if(!arguments.length)return a.resize({});
if(b.isFunction(a.option.onbeforeresize)&&!1===a.option.onbeforeresize.call(a,a))return a;if(1===arguments.length&&b.isPlainObject(arguments[0])){var e=b.extend({},!1,b.jsPanel.resizedefaults,arguments[0]),g,h;e.width&&"auto"===e.width?(a.content.css("width","auto"),a.css("width","auto"),a.css("width",a.outerWidth())):e.width&&a.css("width",e.width);e.height&&"auto"===e.height?(a.content.css("height","auto"),a.css("height","auto")):e.height&&a.css("height",e.height);g=a.outerWidth();h=a.outerHeight();
e.minwidth&&g<e.minwidth&&a.css("width",e.minwidth);e.maxwidth&&g>e.maxwidth&&a.css("width",e.maxwidth);e.minheight&&h<e.minheight&&a.css("height",e.minheight);e.maxheight&&h>e.maxheight&&a.css("height",e.maxheight);a.contentResize();if(b.isFunction(a.option.onresized)&&!1===a.option.onresized.call(a,a))return a;e.callback&&b.isFunction(e.callback)&&e.callback.call(a,a)}else{c&&null!==c?("auto"===c&&a.content.css("width","auto"),a.css("width",c),a.css("width",a.outerWidth())):(e=a.content.css("width")+
a.content.css("border-left-width"),a.css("width",e));d&&null!==d&&("auto"===d&&a.content.css("height","auto"),a.css("height",d));a.contentResize();if(b.isFunction(a.option.onresized)&&!1===a.option.onresized.call(a,a))return a;f&&b.isFunction(f)&&f.call(a,a)}}return a};a.setTheme=function(c,d){c=void 0===c?a.option.theme.toLowerCase().replace(/ /g,""):c;c=c.toLowerCase().replace(/ /g,"");var f=[],e,g,h,p;jsPanel.themes.forEach(function(b,c,d){a.removeClass("panel card card-inverse jsPanel-theme-"+
b+"  panel-"+b+" card-"+b);a.header.removeClass("panel-heading jsPanel-theme-"+b)});a.css({borderWidth:"",borderStyle:"",borderColor:""});b("*",a).css({background:"",color:""});a.header.title.removeClass("panel-title");a.header.toolbar.css({boxShadow:"",width:"",marginLeft:""});a.content.removeClass("panel-body").css({borderTop:"",borderTopColor:""});a.footer.removeClass("panel-footer card-footer");"filled"===c.substr(-6,6)?(f[1]="filled",f[0]=c.substr(0,c.length-6)):"filledlight"===c.substr(-11,
11)?(f[1]="filledlight",f[0]=c.substr(0,c.length-11)):(f[1]="",f[0]=c);f[0].match("-")&&(e=f[0].split("-"),g=!0);g?(a.addClass("panel panel-"+e[1]).addClass("card card-inverse card-"+e[1]).header.addClass("panel-heading").title.addClass("panel-title"),a.content.addClass("panel-body").css("border-top-color",function(){return a.header.css("border-top-color")}),a.footer.addClass("panel-footer card-footer"),p="transparent"===b(".panel-heading",a).css("background-color")?a.css("background-color").replace(/\s+/g,
""):b(".panel-heading",a).css("background-color").replace(/\s+/g,""),e=jsPanel.calcColors(p),b("*",a.header).css("color",e[3]),a.option.headerToolbar?a.header.toolbar.css({boxShadow:"0 0 1px "+e[3]+" inset",width:"calc(100% + 4px)",marginLeft:"-1px"}):a.content.css({borderTop:"1px solid "+e[3]}),"filled"===f[1]?a.content.css({backgroundColor:p,color:e[3]}):"filledlight"===f[1]&&a.content.css({backgroundColor:e[1],color:"#000000"})):jsPanel.themes.includes(f[0])?(a.addClass("jsPanel-theme-"+f[0]).header.addClass("jsPanel-theme-"+
f[0]),"filled"===f[1]?a.content.css("background","").addClass("jsPanel-content-filled"):"filledlight"===f[1]&&a.content.css("background","").addClass("jsPanel-content-filledlight"),a.option.headerToolbar||a.content.css({borderTop:"1px solid "+a.header.title.css("color")})):(h=jsPanel.calcColors(f[0]),a.header.css("background-color",h[0]),b(".jsPanel-hdr *",a).css({color:h[3]}),a.option.headerToolbar?a.header.toolbar.css({boxShadow:"0 0 1px "+h[3]+" inset",width:"calc(100% + 4px)",marginLeft:"-1px"}):
a.content.css({borderTop:"1px solid "+h[3]}),"filled"===f[1]?a.content.css({"background-color":h[0],color:h[3]}):"filledlight"===f[1]&&a.content.css({"background-color":h[1]}));a.option.border?(e=a.option.border.split(" "),a.css({"border-width":e[0],"border-style":e[1]}),a.header.css({"border-top-left-radius":0,"border-top-right-radius":0}),g?a.css("border-color",p):jsPanel.themes.includes(f[0])||a.css("border-color",h[0])):a.css({borderWidth:"",borderStyle:"",borderColor:""});d&&b.isFunction(d)&&
d.call(a,a);return a};a.smallify=function(c){if("normalized"===a.data("status")||"maximized"===a.data("status")){if("smallified"!==a.data("status")&&"smallifiedMax"!==a.data("status")){b(document).trigger("jspanelbeforesmallify",d);if(b.isFunction(a.option.onbeforesmallify)&&!1===a.option.onbeforesmallify.call(a,a))return a;a.smallify.height=a.outerHeight();a.css("overflow","hidden");a.animate({height:a.header.headerbar.outerHeight()+"px"},{done:function(){"maximized"===a.data("status")?(a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallify"),
a.data("status","smallifiedMax"),b(document).trigger("jspanelsmallifiedmax",d)):(a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallify"),a.data("status","smallified"),b(document).trigger("jspanelsmallified",d));b.isFunction(a.option.onsmallified)&&a.option.onsmallified.call(a,a);b(document).trigger("jspanelstatuschange",d)}})}}else if("minimized"!==a.data("status")){b(document).trigger("jspanelbeforeunsmallify",d);if(b.isFunction(a.option.onbeforeunsmallify)&&!1===a.option.onbeforeunsmallify.call(a,
a))return a;a.css("overflow","visible");a.animate({height:a.smallify.height},{done:function(){"smallified"===a.data("status")?(a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"),a.data("status","normalized"),b(document).trigger("jspanelnormalized",d)):(a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev"),a.data("status","maximized"),b(document).trigger("jspanelmaximized",d));b(document).trigger("jspanelunsmallified",d);b(document).trigger("jspanelstatuschange",d);b.isFunction(a.option.onunsmallified)&&
a.option.onunsmallified.call(a,a)}})}a.css("z-index",jsPanel.setZi(a));c&&b.isFunction(c)&&c.call(a,a);return a};a.toolbarAdd=function(c,d,f){c=void 0===c?"header":c;d=void 0===d?[]:d;"header"===c?(a.header.toolbar.addClass("active"),b.isArray(d)?jsPanel.configToolbar(d,a.header.toolbar,a):b.isFunction(d)?a.header.toolbar.append(d(a.header)):a.header.toolbar.append(d)):"footer"===c&&(a.content.removeClass("jsPanel-content-nofooter"),a.footer.addClass("active"),b.isArray(d)?jsPanel.configToolbar(d,
a.footer,a):b.isFunction(d)?a.footer.append(d(a.footer)):a.footer.append(d));a.contentResize();f&&b.isFunction(f)&&f.call(a,a);return a};a.updateCachedData=function(){a.cachedData.top=a.css("top");a.cachedData.left=a.css("left");a.cachedData.width=a.css("width");a.cachedData.height=a.css("height")};b(".jsPanel-btn-close",a).on("click",function(b){b.preventDefault();a.close()});b(".jsPanel-btn-minimize",a).on("click",function(b){b.preventDefault();a.minimize()});b(".jsPanel-btn-maximize",a).on("click",
function(b){b.preventDefault();a.maximize()});b(".jsPanel-btn-normalize",a).on("click",function(b){b.preventDefault();a.normalize()});b(".jsPanel-btn-smallify, .jsPanel-btn-smallifyrev",a).on("click",function(b){b.preventDefault();a.smallify()});a.appendTo(a.option.container);jsPanel.activePanels.list.push(d);b(document).trigger("jspanelloaded",d);a.data("container",a.option.container);a.setTheme();a.option.headerRemove?(a.header.remove(),a.content.addClass("jsPanel-content-noheader"),["close","maximize",
"minimize","normalize","smallify"].forEach(function(b){a[0].setAttribute("data-btn"+b,"removed")})):("closeonly"===a.option.headerControls.controls?(b(".jsPanel-btn:not(.jsPanel-btn-close)",a.header.headerbar).remove(),["maximize","minimize","normalize","smallify"].forEach(function(b){a[0].setAttribute("data-btn"+b,"removed")}),a[0].setAttribute("data-btn-close","enabled")):"none"===a.option.headerControls.controls?(b(a.header.controls).remove(),["close","maximize","minimize","normalize","smallify"].forEach(function(b){a[0].setAttribute("data-btn"+
b,"removed")})):["close","maximize","minimize","normalize","smallify"].forEach(function(b){"disable"===a.option.headerControls[b]?a.headerControl(b,"disable"):"remove"===a.option.headerControls[b]?a.headerControl(b,"remove"):a[0].setAttribute("data-btn"+b,"enabled")}),a.option.headerLogo&&(c=a.option.headerLogo,"string"===typeof c&&"<"!==c.substring(0,1)?a.header.logo.append('<img src="'+c+'" height="38" alt="logo">'):a.header.logo.append(c)));(a.option.headerRemove||1>b(".jsPanel-hdr").length)&&
...
jsPanel.iframe(a);a.option.paneltype.connector&&jsPanel.addConnector(a);"string"===typeof a.option.contentSize&&(c=a.option.contentSize.trim().split(" "),g=c.length,a.option.contentSize={width:c[0],height:c[--g]});0===a.option.contentSize.height&&(a.option.contentSize.height="0");a.content.css({width:a.option.contentSize.width||b.jsPanel.defaults.contentSize.width,height:a.option.contentSize.height||b.jsPanel.defaults.contentSize.height});a.css({width:function(){return 0<b(".jsPanel-content",a).length?
a.content.outerWidth()+"px":a.option.contentSize.width||b.jsPanel.defaults.contentSize.width},zIndex:function(){jsPanel.setZi(a)}});a.content.css("width","100%");jsPanel.position(a,a.option.position);jsPanel.calcPositionFactors(a);a.data("status","normalized");b(document).trigger("jspanelstatuschange",d);if(!a.option.paneltype&&a.option.dblclicks){if(a.option.dblclicks.title)a.header.headerbar.on("dblclick",function(b){b.preventDefault();jsPanel.dblclickhelper(a.option.dblclicks.title,a)});if(a.option.dblclicks.content)a.content.on("dblclick",
...
a).css({backgroundImage:"none",textIndent:-9999}));"string"===typeof a.option.show&&a.addClass(a.option.show).css("opacity",1);a.header.title.empty().prepend(a.option.headerTitle);a[0].addEventListener("mousedown",function(c){b(c.target).hasClass("jsglyph-close")||b(c.target).hasClass("jsglyph-minimize")||(c=b(c.target).closest(".jsPanel").css("z-index"),!a.hasClass("jsPanel-modal")&&c<=jsPanel.zi&&a.front())},!1);a.updateCachedData();"string"===typeof a.option.setstatus&&("maximize smallify"===a.option.setstatus?
a.maximize().smallify():a[a.option.setstatus]());"number"===typeof a.option.autoclose&&0<a.option.autoclose&&window.setTimeout(function(){a&&a.close()},a.option.autoclose);a.on("resizestop",function(){if("maximized"===a.data("status")||"normalized"===a.data("status"))a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"),a.data("status","normalized"),b(document).trigger("jspanelnormalized",d),b(document).trigger("jspanelstatuschange",d);else if("smallified"===a.data("status")||"smallifiedMax"===
a.data("status")){var c=parseInt(a.smallify.height)-a.header.outerHeight();a.content.css("height",c)}jsPanel.calcPositionFactors(a)});a.option.onwindowresize&&b(window).resize(function(c){if(c.target==window){var d=a.option.onwindowresize,f=a.data("status");if("maximized"===f&&!b.isFunction(d))a.maximize(!1,!1);else if("normalized"===f||"smallified"===f||"maximized"===f)b.isFunction(d)?d.call(a,c,a):a.reposition({left:function(){var a;a="body"===this.option.container?(b(window).outerWidth()-this.outerWidth())*
this.hf:(this.parent().outerWidth()-this.outerWidth())*this.hf;return 0>=a?0:a},top:function(){var a;a="body"===this.option.container?(b(window).outerHeight()-this.outerHeight())*this.vf:(this.parent().outerHeight()-this.outerHeight())*this.vf;return 0>=a?0:a}})}});a[0].jspanel={options:a.option,close:function(b){a.close(b)},normalize:function(b){a.normalize(b);return a},maximize:function(b){a.maximize(b);return a},minimize:function(b){a.minimize(b);return a},smallify:function(b){a.smallify(b);return a},
front:function(b){a.front(b);return a},closeChildpanels:function(b){a.closeChildpanels(b);return a},reposition:function(b,c){a.reposition(b,c);return a},resize:function(b,c,d){a.resize(b,c,d);return a},contentResize:function(b){a.contentResize(b);return a},contentReload:function(b){a.contentReload(b);return a},headerTitle:function(b){a.headerTitle(b);return a},headerControl:function(b,c){a.headerControl(b,c);return a},toolbarAdd:function(b,c,d){a.toolbarAdd(b,c,d);return a},setTheme:function(b,c){a.setTheme(b,
c);return a},noop:function(){return a}};a.option.callback&&b.isFunction(a.option.callback)?a.option.callback.call(a,a):b.isArray(a.option.callback)&&a.option.callback.forEach(function(c){b.isFunction(c)&&c.call(a,a)});return a};b.jsPanel.defaults={autoclose:!1,border:!1,callback:!1,container:"body",content:!1,contentAjax:!1,contentIframe:!1,contentOverflow:"hidden",contentSize:{width:400,height:200},custom:!1,dblclicks:!1,draggable:{handle:"div.jsPanel-titlebar, div.jsPanel-ftr",opacity:.8},footerToolbar:!1,
...
onunsmallified:!1,onfronted:!1,onwindowresize:!1,paneltype:!1,position:{my:"center",at:"center"},resizable:{handles:"n, e, s, w, ne, se, sw, nw",autoHide:!1,minWidth:40,minHeight:40},rtl:!1,setstatus:!1,show:!1,template:!1,theme:"default"};b.jsPanel.modaldefaults={draggable:"disabled",headerControls:{controls:"closeonly"},position:"center",resizable:"disabled",onwindowresize:!0};b.jsPanel.tooltipdefaults={draggable:!1,headerControls:{controls:"closeonly"},position:{fixed:!1},resizable:!1};b.jsPanel.hintdefaults=
{autoclose:8E3,draggable:!1,headerControls:{controls:"closeonly"},resizable:!1};b.jsPanel.resizedefaults={width:!1,height:!1,minwidth:!1,maxwidth:!1,minheight:!1,maxheight:!1,callback:!1};b(document).ready(function(){document.body.addEventListener("click",function(c){1>b(c.target).closest(".jsPanel").length&&!b(c.target).hasClass("hasTooltip")&&(jsPanel.closeTooltips(),b(".hasTooltip").removeClass("hasTooltip"))},!1);b(document.body).append("<div id='jsPanel-replacement-container'>");window.addEventListener("keydown",
function(b){b=b.key||b.code;("Escape"===b||"Esc"===b)&&jsPanel.closeOnEscape&&jsPanel.activePanels.getPanel(jsPanel.getTopmostPanel()).close()},!1)})})(jQuery);
