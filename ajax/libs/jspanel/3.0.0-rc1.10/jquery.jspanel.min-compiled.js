...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(a) {
    if (void 0 === a || null === a) throw new TypeError("Cannot convert first argument to object");for (var c = Object(a), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), b = Object.keys(Object(e)), h = 0, n = b.length; h < n; h++) {
        var m = b[h],
            k = Object.getOwnPropertyDescriptor(e, m);void 0 !== k && k.enumerable && (c[m] = e[m]);
      }
    }return c;
  } });
Array.prototype.find || (Array.prototype.find = function (a, c) {
  if (null == this) throw new TypeError("Array.prototype.find called on null or undefined");if ("function" !== typeof a) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, b, h = 0; h < e; h++) {
    if (b = d[h], a.call(c, b, h, d)) return b;
  }
});
Array.prototype.findIndex || (Array.prototype.findIndex = function (a, c) {
  if (null === this) throw new TypeError("Array.prototype.findIndex called on null or undefined");if ("function" !== typeof a) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, b, h = 0; h < e; h++) {
    if (b = d[h], a.call(c, b, h, d)) return h;
  }return -1;
});
Array.prototype.includes || (Array.prototype.includes = function (a, c) {
  var d = Object(this),
      e = parseInt(d.length) || 0;if (0 === e) return !1;var b = parseInt(c) || 0;0 <= b || (b = e + b, 0 > b && (b = 0));for (var h; b < e;) {
    h = d[b];if (a === h || a !== a && h !== h) return !0;b++;
  }return !1;
...
var jsPanel = { version: "3.0.0 RC1.10", date: "2016-05-21 16:25", id: 0, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(a) {
    ...
    function d(b, a) {
      ...
      var a = {},
          c = m(f.of);u.includes(b) ? a.left = c.left : v.includes(b) ? a.left = c.left + c.width / 2 : w.includes(b) ? a.left = c.left + c.width : a.left = c.left;x.includes(b) ? a.top = c.top : y.includes(b) ? a.top = c.top + c.height / 2 : z.includes(b) ? a.top = c.top + c.height : a.top = c.top;return a;
    }function h(b) {
      var a = {},
          c = t.getBoundingClientRect();u.includes(b) ? a.left = 0 : v.includes(b) ? a.left = c.width / 2 : w.includes(b) ? a.left = c.width : a.left = 0;x.includes(b) ? a.top = 0 : y.includes(b) ? a.top = c.height / 2 : z.includes(b) ? a.top = c.height : a.top = 0;return a;
    }function n(b) {
      var a = {},
          c = t.getBoundingClientRect(),
          d = document.querySelector(f.of).getBoundingClientRect(),
          m = d.left - c.left,
          c = d.top - c.top;u.includes(b) ? a.left = m : v.includes(b) ? a.left = m + d.width / 2 : w.includes(b) ? a.left = m + d.width : a.left = m;x.includes(b) ? a.top = c : y.includes(b) ? a.top = c + d.height / 2 : z.includes(b) ? a.top = c + d.height : a.top = c;return a;
    }function m(b) {
      ...
      k = c.match(/\b[a-z]{4,6}-{1}[a-z]{3,6}\b/);g = c.match(/DOWN|UP|RIGHT|LEFT/);var p = c.match(/[+-]?\d+\.?\d*%?/g);c = $.isArray(k) ? { my: k[0], at: k[0] } : { my: "center", at: "center" };$.isArray(g) && (c.autoposition = g[0]);$.isArray(p) && (c.offsetX = p[0], 2 === p.length && (c.offsetY = p[1]));
    }f = Object.assign({ my: "center", at: "center",
      offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);k = "string" === typeof a ? document.querySelector(a) : a.jquery ? a[0] : a;t = k.parentElement;f.of || (t === document.body ? f.of = "window" : f.of = t);g = m(k);"string" === typeof f.offsetX && "%" === f.offsetX.slice(-1) ? f.offsetX = "window" === f.of ? window.innerWidth * (parseInt(f.offsetX, 10) / 100) : t.clientWidth * (parseInt(f.offsetX, 10) / 100) : "string" === typeof f.offsetX ? f.offsetX = parseFloat(f.offsetX) : $.isFunction(f.offsetX) && (f.offsetX = parseInt(f.offsetX.call(a, a)));"string" === typeof f.offsetY && "%" === f.offsetY.slice(-1) ? f.offsetY = "window" === f.of ? window.innerHeight * (parseInt(f.offsetY, 10) / 100) : t.clientHeight * (parseInt(f.offsetY, 10) / 100) : "string" === typeof f.offsetY ? f.offsetY = parseFloat(f.offsetY) : $.isFunction(f.offsetY) && (f.offsetY = parseInt(f.offsetY.call(a, a)));p = parseInt(d(t, "border-left-width"));u.includes(f.my) ? q = p : v.includes(f.my) ? q = g.width / 2 + p : w.includes(f.my) && (q = g.width + p);p = parseInt(d(t, "border-top-width"));x.includes(f.my) ? r = p : y.includes(f.my) ? r = g.height / 2 + p : z.includes(f.my) && (r = g.height + p);k.parentElement === document.body ? "window" === f.of ? (g = e(f.at), f.fixed ? (q = g.left - q + f.offsetX - window.pageXOffset, r = g.top - r + f.offsetY - window.pageYOffset) : (q = g.left - q + f.offsetX, r = g.top - r + f.offsetY)) : (g = b(f.at), q = g.left - q + f.offsetX, r = g.top - r + f.offsetY) : (g = "string" === typeof f.of ? document.querySelector(f.of) : f.of.jquery ? f.of[0] : f.of, g = t === g ? h(f.at) : n(f.at), q = g.left - q + f.offsetX, r = g.top - r + f.offsetY);if (f.autoposition) {
      g = [];p = this.autopositionSpacing;f.my === f.at && (l = f.my);k.setAttribute("data-autoposition", f.autoposition);$.isFunction(f.offsetX) || k.setAttribute("data-offsetx", f.offsetX);$.isFunction(f.offsetY) || k.setAttribute("data-offsety", f.offsetY);k.classList.add(l);l = document.getElementsByClassName(l);for (var A = 0; A < l.length; A++) {
        l[A].parentElement === t && g.push(l[A]);
      }if ("DOWN" === f.autoposition) for (l = 0; l < g.length - 1; l++) {
        r += g[l].getBoundingClientRect().height + p;
      } else if ("UP" === f.autoposition) for (l = 0; l < g.length - 1; l++) {
        r -= g[l].getBoundingClientRect().height + p;
      } else if ("RIGHT" === f.autoposition) for (l = 0; l < g.length - 1; l++) {
        q += g[l].getBoundingClientRect().width + p;
      } else if ("LEFT" === f.autoposition) for (l = 0; l < g.length - 1; l++) {
        q -= g[l].getBoundingClientRect().width + p;
      }
    }l = { left: q, top: r };"function" === typeof f.modify && (l = f.modify.call(l, l));k.style.position = "absolute";k.style.left = l.left + "px";k.style.top = l.top + "px";k.style.opacity = 1;"window" === f.of && f.fixed && t === document.body && (k.style.position = "fixed");return k;
    ...
    if (0 === c) d = c = a = d;else {
      var e = function e(b, a, c) {
        0 > c && (c += 1);1 < c && --c;return c < 1 / 6 ? b + 6 * (a - b) * c : .5 > c ? a : c < 2 / 3 ? b + (a - b) * (2 / 3 - c) * 6 : b;
      },
          b = .5 > d ? d * (1 + c) : d + c - d * c,
          h = 2 * d - b;d = e(h, b, a + 1 / 3);c = e(h, b, a);a = e(h, b, a - 1 / 3);
    ...
    a /= 255;c /= 255;d /= 255;var e = Math.max(a, c, d),
        b = Math.min(a, c, d),
        h,
        n = (e + b) / 2;if (e === b) h = b = 0;else {
      var m = e - b,
          b = .5 < n ? m / (2 - e - b) : m / (e + b);switch (e) {case a:
          h = (c - d) / m + (c < d ? 6 : 0);break;case c:
          h = (d - a) / m + 2;break;case d:
          h = (a - c) / m + 4;}h /= 6;
    }h *= 360;b = 100 * b + "%";n = 100 * n + "%";return { css: "hsl(" + h + "," + b + "," + n + ")", h: h, s: b, l: n };
    ...
    var c = a.toLowerCase(),
        d,
        e,
        b;a = {};d = /^rgba?\(([0-9]{1,3}),([0-9]{1,3}),([0-9]{1,3}),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;e = /^hsla?\(([0-9]{1,3}),([0-9]{1,3}\%),([0-9]{1,3}\%),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;
    b = { aliceblue: "f0f8ff", antiquewhite: "faebd7", aqua: "0ff", aquamarine: "7fffd4", azure: "f0ffff", beige: "f5f5dc", bisque: "ffe4c4", black: "000", blanchedalmond: "ffebcd", blue: "00f", blueviolet: "8a2be2", brown: "a52a2a", burlywood: "deb887", cadetblue: "5f9ea0", chartreuse: "7fff00", chocolate: "d2691e", coral: "ff7f50", cornflowerblue: "6495ed", cornsilk: "fff8dc", crimson: "dc143c", cyan: "0ff", darkblue: "00008b", darkcyan: "008b8b", darkgoldenrod: "b8860b", darkgray: "a9a9a9", darkgrey: "a9a9a9", darkgreen: "006400", darkkhaki: "bdb76b", darkmagenta: "8b008b",
      ...
      springgreen: "00ff7f", steelblue: "4682b4", tan: "d2b48c", teal: "008080", thistle: "d8bfd8", tomato: "ff6347", turquoise: "40e0d0", violet: "ee82ee", wheat: "f5deb3", white: "fff", whitesmoke: "f5f5f5", yellow: "ff0", yellowgreen: "9acd32" };b[c] && (c = b[c]);null !== c.match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/gi) ? (c = c.replace("#", ""), 1 === c.length % 2 ? (d = c.substr(0, 1).repeat(2), e = c.substr(1, 1).repeat(2), c = c.substr(2, 1).repeat(2), a.rgb = { r: parseInt(d, 16), g: parseInt(e, 16), b: parseInt(c, 16) }, a.hex = "#" + d + e + c) : (a.rgb = { r: parseInt(c.substr(0, 2), 16), g: parseInt(c.substr(2, 2), 16), b: parseInt(c.substr(4, 2), 16) }, a.hex = "#" + c), c = this.rgbToHsl(a.rgb.r, a.rgb.g, a.rgb.b), a.hsl = c, a.rgb.css = "rgb(" + a.rgb.r + "," + a.rgb.g + "," + a.rgb.b + ")") : c.match(d) ? (d = d.exec(c), a.rgb = { css: c, r: d[1], g: d[2], b: d[3] }, a.hex = this.rgbToHex(d[1], d[2], d[3]), c = this.rgbToHsl(d[1], d[2], d[3]), a.hsl = c) : c.match(e) ? (d = e.exec(c), c = d[1] / 360, e = d[2].substr(0, d[2].length - 1) / 100, b = d[3].substr(0, d[3].length - 1) / 100, c = this.hslToRgb(c, e, b), a.rgb = { css: "rgb(" + c[0] + "," + c[1] + "," + c[2] + ")", r: c[0], g: c[1],
    ...
    var c = this.color(a),
        ...
        b,
        h,
        n;this.perceivedBrightness(a) <= this.pbTreshold ? b = "#ffffff" : b = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? h = "#ffffff" : h = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? n = "#000000" : n = "#ffffff";return [c.hsl.css, d, e, b, h, n];
    ...
    function c(b) {
      if (b.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== a.footer.css("display") ? m : 0 < parseFloat(a.option.contentSize.height) ? n : k;
    }function d(b) {
      if (b.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!a.option.headerRemove) return k;if (0 < parseFloat(a.option.contentSize.height)) return n;if ("none" !== a.footer.css("display")) return m;
      }
    }function e(b) {
      if (b.match(/lefttop|righttop/)) return a.option.headerRemove ? n : k;
    }function b(b) {
      if (b.match(/left|right/)) {
        if (0 < parseFloat(a.option.contentSize.height)) return n;if (!a.option.headerRemove) return k;if ("none" !== a.footer.css("display")) return m;
      }
    }var h = a.option.paneltype.connectorBG || null,
        n = a.content.css("background-color"),
        m = a.footer.css("background-color"),
        k = a.css("background-color");a.hasClass("jsPanel-tooltip-top") ? (a.append("<div class='jsPanel-connector jsPanel-connector-top'>"), $(".jsPanel-connector-top", a).css("border-top-color", h || c("top")), a.option.position.offsetY = a.option.position.offsetY - 10 || -10) : a.hasClass("jsPanel-tooltip-bottom") ? (a.append("<div class='jsPanel-connector jsPanel-connector-bottom'>"), $(".jsPanel-connector-bottom", a).css("border-bottom-color", h || d("bottom")), a.option.position.offsetY = a.option.position.offsetY + 10 || 10) : a.hasClass("jsPanel-tooltip-left") ? (a.append("<div class='jsPanel-connector jsPanel-connector-left'>"), $(".jsPanel-connector-left", a).css("border-left-color", h || b("left")), a.option.position.offsetX = a.option.position.offsetX - 12 || -12) : a.hasClass("jsPanel-tooltip-right") ? (a.append("<div class='jsPanel-connector jsPanel-connector-right'>"), $(".jsPanel-connector-right", a).css("border-right-color", h || b("right")), a.option.position.offsetX = a.option.position.offsetX + 12 || 12) : a.hasClass("jsPanel-tooltip-lefttopcorner") ? (a.append("<div class='jsPanel-connector jsPanel-connector-lefttopcorner'>"), $(".jsPanel-connector-lefttopcorner", a).css("background-color", h || c("lefttopcorner"))) : a.hasClass("jsPanel-tooltip-righttopcorner") ? (a.append("<div class='jsPanel-connector jsPanel-connector-righttopcorner'>"), $(".jsPanel-connector-righttopcorner", a).css("background-color", h || c("righttopcorner"))) : a.hasClass("jsPanel-tooltip-rightbottomcorner") ? (a.append("<div class='jsPanel-connector jsPanel-connector-rightbottomcorner'>"), $(".jsPanel-connector-rightbottomcorner", a).css("background-color", h || d("rightbottomcorner"))) : a.hasClass("jsPanel-tooltip-leftbottomcorner") ? (a.append("<div class='jsPanel-connector jsPanel-connector-leftbottomcorner'>"), $(".jsPanel-connector-leftbottomcorner", a).css("background-color", h || d("leftbottomcorner"))) : a.hasClass("jsPanel-tooltip-lefttop") ? (a.append("<div class='jsPanel-connector jsPanel-connector-lefttop'>"), $(".jsPanel-connector-lefttop", a).css("border-left-color", h || e("lefttop")), a.option.position.offsetX = a.option.position.offsetX - 12 || -12) : a.hasClass("jsPanel-tooltip-leftbottom") ? (a.append("<div class='jsPanel-connector jsPanel-connector-leftbottom'>"), $(".jsPanel-connector-leftbottom", a).css("border-left-color", h || c("leftbottom")), a.option.position.offsetX = a.option.position.offsetX - 12 || -12) : a.hasClass("jsPanel-tooltip-topleft") ? (a.append("<div class='jsPanel-connector jsPanel-connector-topleft'>"), $(".jsPanel-connector-topleft", a).css("border-top-color", h || c("topleft")), a.option.position.offsetY = a.option.position.offsetY - 10 || -10) : a.hasClass("jsPanel-tooltip-topright") ? (a.append("<div class='jsPanel-connector jsPanel-connector-topright'>"), $(".jsPanel-connector-topright", a).css("border-top-color", h || c("topright")), a.option.position.offsetY = a.option.position.offsetY - 10 || -10) : a.hasClass("jsPanel-tooltip-righttop") ? (a.append("<div class='jsPanel-connector jsPanel-connector-righttop'>"), $(".jsPanel-connector-righttop", a).css("border-right-color", h || e("righttop")), a.option.position.offsetX = a.option.position.offsetX + 12 || 12) : a.hasClass("jsPanel-tooltip-rightbottom") ? (a.append("<div class='jsPanel-connector jsPanel-connector-rightbottom'>"), $(".jsPanel-connector-rightbottom", a).css("border-right-color", h || c("rightbottom")), a.option.position.offsetX = a.option.position.offsetX + 12 || 12) : a.hasClass("jsPanel-tooltip-bottomleft") ? (a.append("<div class='jsPanel-connector jsPanel-connector-bottomleft'>"), $(".jsPanel-connector-bottomleft", a).css("border-bottom-color", h || d("bottomleft")), a.option.position.offsetY = a.option.position.offsetY + 10 || 10) : a.hasClass("jsPanel-tooltip-bottomright") && (a.append("<div class='jsPanel-connector jsPanel-connector-bottomright'>"), $(".jsPanel-connector-bottomright", a).css("border-bottom-color", h || d("bottomright")), a.option.position.offsetY = a.option.position.offsetY + 10 || 10);
    ...
    var c = "close maximize normalize minimize smallify smallifyrev".split(" "),
        ...
        h = a.header.headerbar;"bootstrap" === b || "glyphicon" === b ? (c.forEach(function (b, a) {
      $(".jsPanel-btn-" + b + " span", h).removeClass().addClass("glyphicon glyphicon-" + d[a]);
    }), $(".jsPanel-headerbar .jsPanel-btn", a).css("padding-top", "4px")) : "font-awesome" === b && c.forEach(function (b, a) {
      $(".jsPanel-btn-" + b + " span", h).removeClass().addClass("fa fa-" + e[a]);
    });
  }, headerControl: function headerControl(a, c, d) {
    var e = a.header.headerbar,
        b = a[0];"disable" === d ? "removed" !== b.getAttribute("data-btn" + c) && (b.setAttribute("data-btn" + c, "disabled"), $(".jsPanel-btn-" + c, e).css({ pointerEvents: "none", opacity: .4, cursor: "default" })) : "enable" === d ? "removed" !== b.getAttribute("data-btn" + c) && (b.setAttribute("data-btn" + c, "enabled"), $(".jsPanel-btn-" + c, e).css({ pointerEvents: "auto", opacity: 1, cursor: "pointer" })) : "remove" === d && "close" !== c && (b.setAttribute("data-btn" + c, "removed"), $(".jsPanel-btn-" + c, e).remove());return a;
  ...
  toolbar: function toolbar(a, c, d) {
    ...
    var a,
        ...
        m = [],
        k,
        g = $(".jsPanel").not(".jsPanel-tooltip, .jsPanel-hint, .jsPanel-modal");g.each(function (b, a) {
      "normalized" !== $(a).data("status") && $(".jsPanel-btn-normalize", a).trigger("click");
    });g.each(function (f, g) {
      n = $(g).data("container");
      a = $(g).offset();c = $(g).position();"body" === n.toLowerCase() ? (d = Math.floor(a.top - $(window).scrollTop()), e = Math.floor(a.left - $(window).scrollLeft())) : (d = Math.floor(c.top), e = Math.floor(c.left));b = $(g).css("width");h = $(".jsPanel-content", g).css("height");k = { status: $(g).data("status"), id: $(g).prop("id"), headerTitle: $(".jsPanel-title", g).html(), custom: $(g).data("custom"), content: $(g).data("content"), contentSize: { width: b, height: h }, position: { my: "left-top", at: "left-top", offsetX: e, offsetY: d } };$(g).data("ajaxURL") && (k.contentAjax = { url: $(g).data("ajaxURL"), autoload: !0 });if ($(g).data("iframeDOC") || $(g).data("iframeSRC")) k.contentIframe = { src: $(g).data("iframeSRC") || "", srcdoc: $(g).data("iframeDOC") || "" };m.push(k);switch (k.status) {case "minimized":
          $(".jsPanel-btn-minimize", g).trigger("click");break;case "maximized":
          $(".jsPanel-btn-maximize", g).trigger("click");break;case "smallified":
          $(".jsPanel-btn-smallify", g).trigger("click");break;case "smallifiedMax":
          $(".jsPanel-btn-smallify", g).trigger("click");}
    });window.localStorage.setItem("jspanels", JSON.stringify(m));return m;
  }, importPanels: function importPanels(a) {
    var c = JSON.parse(localStorage.jspanels) || {},
        d = a["default"] || {},
        e;c.forEach(function (b) {
      e = "string" === typeof b.custom.config ? $.extend(!0, {}, d, a[b.custom.config], b) : $.extend(!0, {}, d, b);$.jsPanel(e);
    });
  ...
  a.jsPanel = function (c) {
    var d;c = c || {};var e = a.extend(!0, {}, c.config || {}, c),
      ...
      a(document).trigger("jspanelbeforeclose", d);if (a.isFunction(b.option.onbeforeclose) && !1 === b.option.onbeforeclose.call(b, b)) return b;var c = b.option.position;if (c.autoposition || "string" === typeof c && c.match(/DOWN|RIGHT|UP|LEFT/)) {
        var c = a("#" + d).parent(),
            e = document.getElementById(d).className.match(/left-top|center-top|right-top|left-center|center|right-center|left-bottom|center-bottom|right-bottom/);
        e && (jsPanel.lastbeforeclose = { parent: c, "class": e[0] });
      }b.closeChildpanels().remove();c = jsPanel.activePanels.list.findIndex(function (b) {
        return b === d;
      });-1 < c && jsPanel.activePanels.list.splice(c, 1);a("#" + d + "-min").remove();"modal" === b.option.paneltype && a("#jsPanel-modal-backdrop-" + b.attr("id")).remove();b.option.paneltype.tooltip && a(h).removeClass("hasTooltip");a(document).trigger("jspanelclosed", d);a(document).trigger("jspanelstatuschange", d);var g, f;jsPanel.lastbeforeclose && (g = jsPanel.lastbeforeclose.parent, g = a("." + jsPanel.lastbeforeclose["class"], g), f = jsPanel.lastbeforeclose["class"]);g && (g.each(function (b, c) {
        a(c).removeClass(f);
      }), g.each(function (b, a) {
        var c = a.getAttribute("data-autoposition"),
            d = a.getAttribute("data-offsetx"),
            m = a.getAttribute("data-offsety");jsPanel.position(a, { my: f, at: f, autoposition: c, offsetX: d, offsetY: m });
      ...
      b.css("z-index", jsPanel.setZi(b));jsPanel.resetZis();a(document).trigger("jspanelfronted", d);a.isFunction(b.option.onfronted) && !1 !== b.option.onfronted.call(b, b) && b.option.onfronted.call(b, b);return b;
      ...
      var c = b.option.maximizedMargin,
          e = b[0].parentNode;if ("maximized" === b.data("status")) return b;"normalized" === b.data("status") && jsPanel.updateCachedData(b);a(document).trigger("jspanelbeforemaximize", d);if (a.isFunction(b.option.onbeforemaximize) && !1 === b.option.onbeforemaximize.call(b, b)) return b;e === document.body ? (b.css({ width: document.documentElement.clientWidth - c.left - c.right + "px", height: document.documentElement.clientHeight - c.top - c.bottom + "px", left: c.left + "px", top: c.top + "px" }), !1 === b.option.position.fixed && b.css({ left: window.pageXOffset + c.left + "px", top: window.pageYOffset + c.top + "px" })) : b.css({ width: e.clientWidth - c.left - c.right + "px", height: e.clientHeight - c.top - c.bottom + "px", left: c.left + "px", top: c.top + "px" });b.contentResize().data("status", "maximized").css("z-index", jsPanel.setZi(b));
      jsPanel.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev", b);a("#" + b.prop("id") + "-min").remove();a(document).trigger("jspanelmaximized", d);a(document).trigger("jspanelstatuschange", d);a.isFunction(b.option.onmaximized) && b.option.onmaximized.call(b, b);return b;
    };b.minimize = function () {
      if ("minimized" === b.data("status")) return b;a(document).trigger("jspanelbeforeminimize", d);if (a.isFunction(b.option.onbeforeminimize) && !1 === b.option.onbeforeminimize.call(b, b)) return b;var c = b.header.headerbar.css("color"),
          e;e = b.hasClass("panel") ? "transparent" === b.header.css("background-color") ? b.css("background-color") : b.header.css("background-color") : b.css("background-color");"normalized" === b.data("status") && jsPanel.updateCachedData(b);var g = a(jsPanel.replacementTemplate);g.left = b.css("left");b.css("left", "-9999px").data("status", "minimized");g.css({ backgroundColor: e }).prop("id", b.prop("id") + "-min").find("h3").css({ color: c }).html(b.headerTitle());a(".jsPanel-btn", g).css({ color: c });c = a(b.option.container).closest(".jsPanel-content");
      c.length ? (a(".jsPanel-minimized-box").length || a(c[0]).append("<div class='jsPanel-minimized-box'>"), a(".jsPanel-minimized-box").append(g)) : a("#jsPanel-replacement-container").append(g);a(document).trigger("jspanelminimized", d);a(document).trigger("jspanelstatuschange", d);a.isFunction(b.option.onminimized) && b.option.onminimized.call(b, b);a(".jsPanel-btn-normalize", g).css("display", "block").click(function () {
        b.css("left", g.left);g.remove();a(".jsPanel-btn-normalize", b).trigger("click");
      });"disabled" === b[0].dataset.btnnormalize ? a(".jsPanel-btn-normalize", g).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === b[0].dataset.btnnormalize && a(".jsPanel-btn-normalize", g).remove();a(".jsPanel-btn-maximize", g).click(function () {
        b.css("left", g.left);g.remove();a(".jsPanel-btn-maximize", b).trigger("click");
      });"disabled" === b[0].dataset.btnmaximize ? a(".jsPanel-btn-maximize", g).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === b[0].dataset.btnmaximize && a(".jsPanel-btn-maximize", g).remove();a(".jsPanel-btn-close", g).click(function () {
        g.remove();b.close();
      });"disabled" === b[0].dataset.btnclose && a(".jsPanel-btn-close", g).css({ pointerEvents: "none", opacity: .5, cursor: "default" });return b;
    ...
    };b.setTheme = function (c) {
      c = void 0 === c ? b.option.theme.toLowerCase().replace(/ /g, "") : c;c = c.toLowerCase().replace(/ /g, "");var d = [],
          e,
          f;jsPanel.themes.forEach(function (a, c, d) {
        b.removeClass("panel card card-inverse jsPanel-theme-" + a + "  panel-" + a + " card-" + a);
      });b.header.removeClass("panel-heading").title.removeClass("panel-title");b.content.removeClass("panel-body").css("border-top-color", "");b.footer.removeClass("panel-footer card-footer");b.css("background", "").content.css({ borderTop: "", backgroundColor: "", color: "" });a(".jsPanel-hdr *", b).css({ color: "" });b.header.toolbar.css({ boxShadow: "", width: "", marginLeft: "" });c.endsWith("filled") ? (d[1] = "filled", d[0] = c.substr(0, c.length - 6)) : c.endsWith("filledlight") ? (d[1] = "filledlight", d[0] = c.substr(0, c.length - 11)) : (d[1] = "", d[0] = c);d[0].match("-") && (e = d[0].split("-"), f = !0);f ? (b.addClass("panel panel-" + e[1]).addClass("card card-inverse card-" + e[1]).header.addClass("panel-heading").title.addClass("panel-title"), b.content.addClass("panel-body").css("border-top-color", function () {
        return b.header.css("border-top-color");
      }), b.footer.addClass("panel-footer card-footer"), c = "transparent" === a(".panel-heading", b).css("background-color") ? b.css("background-color").replace(/\s+/g, "") : a(".panel-heading", b).css("background-color").replace(/\s+/g, ""), e = jsPanel.calcColors(c), a("*", b.header).css("color", e[3]), b.option.headerToolbar ? b.header.toolbar.css({ boxShadow: "0 0 1px " + e[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : b.content.css({ borderTop: "1px solid " + e[3] }), "filled" === d[1] ? b.content.css({ backgroundColor: c, color: e[3] }) : "filledlight" === d[1] && b.content.css({ backgroundColor: e[1], color: "#000000" })) : jsPanel.themes.includes(d[0]) ? (b.addClass("jsPanel-theme-" + d[0]), "filled" === d[1] ? b.content.css("background", "").addClass("jsPanel-content-filled") : "filledlight" === d[1] && b.content.css("background", "").addClass("jsPanel-content-filledlight"), b.option.headerToolbar || b.content.css({ borderTop: "1px solid " + b.header.title.css("color") })) : (c = jsPanel.calcColors(d[0]), b.css("background-color", c[0]), a(".jsPanel-hdr *", b).css({ color: c[3] }), b.option.headerToolbar ? b.header.toolbar.css({ boxShadow: "0 0 1px " + c[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : b.content.css({ borderTop: "1px solid " + c[3] }), "filled" === d[1] ? b.content.css({ "background-color": c[0], color: c[3] }) : "filledlight" === d[1] && b.content.css({ "background-color": c[1] }));return b;
    ...
    b.css({ width: function width() {
      ...
      c = a(c.target).closest(".jsPanel").css("z-index");!b.hasClass("jsPanel-modal") && c <= jsPanel.zi && b.front();
      ...
      b && b.close();
    }, b.option.autoclose);b[0].jspanel = { options: b.option, close: function close() {
        b.close();
    ...
    }, load: !1, maximizedMargin: { top: 5, right: 5, bottom: 5, left: 5 }, onbeforeclose: !1, onbeforemaximize: !1, onbeforeminimize: !1, onbeforenormalize: !1, onclosed: !1, onmaximized: !1, onminimized: !1, onnormalized: !1, onbeforeresize: !1, onresized: !1, onsmallified: !1, onunsmallified: !1, onfronted: !1, paneltype: !1, position: { my: "center", at: "center" }, resizable: { handles: "n, e, s, w, ne, se, sw, nw", autoHide: !1, minWidth: 40, minHeight: 40 }, rtl: !1, setstatus: !1, show: !1, template: !1, theme: "default" };a.jsPanel.modaldefaults = { draggable: "disabled",
    headerControls: { controls: "closeonly" }, position: { my: "center", at: "center" }, resizable: "disabled" };a.jsPanel.tooltipdefaults = { draggable: !1, headerControls: { controls: "closeonly" }, position: { fixed: !1 }, resizable: !1 };a.jsPanel.hintdefaults = { autoclose: 8E3, draggable: !1, headerControls: { controls: "closeonly" }, resizable: !1 };document.body.addEventListener("click", function (c) {
