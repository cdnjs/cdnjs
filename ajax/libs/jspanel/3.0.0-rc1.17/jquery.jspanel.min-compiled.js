...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(b) {
    if (void 0 === b || null === b) throw new TypeError("Cannot convert first argument to object");for (var c = Object(b), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), a = Object.keys(Object(e)), g = 0, m = a.length; g < m; g++) {
        var n = a[g],
            l = Object.getOwnPropertyDescriptor(e, n);void 0 !== l && l.enumerable && (c[n] = e[n]);
      }
    }return c;
  } });
...
var jsPanel = { version: "3.0.0 RC1.17", date: "2016-05-27 19:25", id: 0, ziBase: 100, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(b) {
    ...
    function d(a, b) {
      ...
      l = c.match(/\b[a-z]{4,6}-{1}[a-z]{3,6}\b/);h = c.match(/DOWN|UP|RIGHT|LEFT/);var q = c.match(/[+-]?\d+\.?\d*%?/g);c = $.isArray(l) ? { my: l[0], at: l[0] } : { my: "center", at: "center" };$.isArray(h) && (c.autoposition = h[0]);$.isArray(q) && (c.offsetX = q[0], 2 === q.length && (c.offsetY = q[1]));
    }f = Object.assign({ my: "center", at: "center",
      offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);l = "string" === typeof b ? document.querySelector(b) : b.jquery ? b[0] : b;r = l.parentElement;f.of || (r === document.body ? f.of = "window" : f.of = r);h = n(l);"string" === typeof f.offsetX && "%" === f.offsetX.slice(-1) ? f.offsetX = "window" === f.of ? window.innerWidth * (parseInt(f.offsetX, 10) / 100) : r.clientWidth * (parseInt(f.offsetX, 10) / 100) : "string" === typeof f.offsetX ? f.offsetX = parseFloat(f.offsetX) : $.isFunction(f.offsetX) && (f.offsetX = parseInt(f.offsetX.call(b, b)));"string" === typeof f.offsetY && "%" === f.offsetY.slice(-1) ? f.offsetY = "window" === f.of ? window.innerHeight * (parseInt(f.offsetY, 10) / 100) : r.clientHeight * (parseInt(f.offsetY, 10) / 100) : "string" === typeof f.offsetY ? f.offsetY = parseFloat(f.offsetY) : $.isFunction(f.offsetY) && (f.offsetY = parseInt(f.offsetY.call(b, b)));q = parseInt(d(r, "border-left-width"));u.includes(f.my) ? p = q : v.includes(f.my) ? p = h.width / 2 + q : w.includes(f.my) && (p = h.width + q);q = parseInt(d(r, "border-top-width"));x.includes(f.my) ? t = q : y.includes(f.my) ? t = h.height / 2 + q : z.includes(f.my) && (t = h.height + q);l.parentElement === document.body ? "window" === f.of ? (h = e(f.at), f.fixed ? (p = h.left - p + f.offsetX - window.pageXOffset, t = h.top - t + f.offsetY - window.pageYOffset) : (p = h.left - p + f.offsetX, t = h.top - t + f.offsetY)) : (h = a(f.at), p = h.left - p + f.offsetX, t = h.top - t + f.offsetY) : (h = "string" === typeof f.of ? document.querySelector(f.of) : f.of.jquery ? f.of[0] : f.of, h = r === h ? g(f.at) : m(f.at), p = h.left - p + f.offsetX, t = h.top - t + f.offsetY);if (f.autoposition) {
      h = [];q = this.autopositionSpacing;f.my === f.at && (k = f.my);l.setAttribute("data-autoposition", f.autoposition);$.isFunction(f.offsetX) || l.setAttribute("data-offsetx", f.offsetX);$.isFunction(f.offsetY) || l.setAttribute("data-offsety", f.offsetY);l.classList.add(k);k = document.getElementsByClassName(k);for (var A = 0; A < k.length; A++) {
        k[A].parentElement === r && h.push(k[A]);
      }if ("DOWN" === f.autoposition) for (k = 0; k < h.length - 1; k++) {
        t += h[k].getBoundingClientRect().height + q;
      } else if ("UP" === f.autoposition) for (k = 0; k < h.length - 1; k++) {
        t -= h[k].getBoundingClientRect().height + q;
      } else if ("RIGHT" === f.autoposition) for (k = 0; k < h.length - 1; k++) {
        p += h[k].getBoundingClientRect().width + q;
      } else if ("LEFT" === f.autoposition) for (k = 0; k < h.length - 1; k++) {
        p -= h[k].getBoundingClientRect().width + q;
      }
    }k = { left: p, top: t };"function" === typeof f.modify && (k = f.modify.call(k, k));l.style.position = "absolute";l.style.left = k.left + "px";l.style.top = k.top + "px";l.style.opacity = 1;"window" === f.of && f.fixed && r === document.body && (l.style.position = "fixed");return l;
    ...
    b /= 255;c /= 255;d /= 255;var e = Math.max(b, c, d),
        a = Math.min(b, c, d),
        g,
        m = (e + a) / 2;if (e === a) g = a = 0;else {
      var n = e - a,
          a = .5 < m ? n / (2 - e - a) : n / (e + a);switch (e) {case b:
          g = (c - d) / n + (c < d ? 6 : 0);break;case c:
          g = (d - b) / n + 2;break;case d:
          g = (b - c) / n + 4;}g /= 6;
    }g *= 360;a = 100 * a + "%";m = 100 * m + "%";return { css: "hsl(" + g + "," + a + "," + m + ")", h: g, s: a, l: m };
    ...
    var c = b.toLowerCase(),
        d,
        e,
        a;b = {};d = /^rgba?\(([0-9]{1,3}),([0-9]{1,3}),([0-9]{1,3}),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;e = /^hsla?\(([0-9]{1,3}),([0-9]{1,3}\%),([0-9]{1,3}\%),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;
    ...
    var c = this.color(b),
        ...
        a,
        g,
        m;this.perceivedBrightness(b) <= this.pbTreshold ? a = "#ffffff" : a = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? g = "#ffffff" : g = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? m = "#000000" : m = "#ffffff";return [c.hsl.css, d, e, a, g, m];
    ...
    function c(a) {
      if (a.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== b.footer.css("display") ? n : 0 < parseFloat(b.option.contentSize.height) ? m : l;
    }function d(a) {
      if (a.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!b.option.headerRemove) return l;if (0 < parseFloat(b.option.contentSize.height)) return m;if ("none" !== b.footer.css("display")) return n;
      }
    }function e(a) {
      if (a.match(/lefttop|righttop/)) return b.option.headerRemove ? m : l;
    }function a(a) {
      if (a.match(/left|right/)) {
        if (0 < parseFloat(b.option.contentSize.height)) return m;if (!b.option.headerRemove) return l;if ("none" !== b.footer.css("display")) return n;
      }
    }var g = b.option.paneltype.connectorBG || null,
        m = b.content.css("background-color"),
    ...
    var c = b.option.contentAjax;$.ajax(c).done(function (d, e, a) {
      ...
      $.isFunction(c.done) && c.done.call(b, d, e, a, b);
    }).fail(function (d, e, a) {
    ...
    var c;b.footer.hasClass("active") ? c = b.header.outerHeight() + b.footer.outerHeight() : c = b.header.outerHeight();b.content.css({ height: b.outerHeight() - c });return b;
    ...
    var e = b.header.headerbar,
        a = b[0];"disable" === d ? "removed" !== a.getAttribute("data-btn" + c) && (a.setAttribute("data-btn" + c, "disabled"), $(".jsPanel-btn-" + c, e).css({ pointerEvents: "none", opacity: .4, cursor: "default" })) : "enable" === d ? "removed" !== a.getAttribute("data-btn" + c) && (a.setAttribute("data-btn" + c, "enabled"), $(".jsPanel-btn-" + c, e).css({ pointerEvents: "auto", opacity: 1, cursor: "pointer" })) : "remove" === d && "close" !== c && (a.setAttribute("data-btn" + c, "removed"), $(".jsPanel-btn-" + c, e).remove());return b;
  ...
  toolbar: function toolbar(b, c, d) {
    ...
    });window.localStorage.setItem(c, JSON.stringify(h));return h;
...
(function (b) {
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
        ...
        g,
        m,
        n;"tooltip" === e.paneltype && (e.paneltype = { tooltip: !0 });e.paneltype ? "modal" === e.paneltype ? a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.modaldefaults, e) : e.paneltype.tooltip ? a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.tooltipdefaults, e) : "hint" === e.paneltype && (a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.hintdefaults, e)) : a.option = b.extend(!0, {}, b.jsPanel.defaults, e);if (a.option.paneltype.tooltip && (g = jsPanel.setTrigger(a.option.position), b(g).hasClass("hasTooltip"))) return !1;var l = "container contentAjax contentIframe contentOverflow contentSize footerToolbar headerControls headerRemove headerTitle headerToolbar".split(" ");"selector ajax iframe overflow size toolbarFooter controls removeHeader title toolbarHeader".split(" ").forEach(function (b, c) {
      a.option[b] && (a.option[l[c]] = a.option[b]);
      ...
      a.css("z-index", jsPanel.setZi(a));jsPanel.resetZis();b(document).trigger("jspanelfronted", d);b.isFunction(a.option.onfronted) && !1 !== a.option.onfronted.call(a, a) && a.option.onfronted.call(a, a);return a;
      ...
      if ("normalized" === a.data("status")) return a;b(document).trigger("jspanelbeforenormalize", d);if (b.isFunction(a.option.onbeforenormalize) && !1 === a.option.onbeforenormalize.call(a, a)) return a;a.css({ left: a.cachedData.left, top: a.cachedData.top, width: a.cachedData.width, height: a.cachedData.height, zIndex: function zIndex() {
          jsPanel.setZi(a);
        } }).data("status", "normalized").contentResize();jsPanel.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev", a);b("#" + a.prop("id") + "-min").remove();b(document).trigger("jspanelnormalized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onnormalized) && a.option.onnormalized.call(a, a);return a;
    };a.maximize = function () {
      var c = a.option.maximizedMargin,
          f = a[0].parentNode;if ("maximized" === a.data("status")) return a;"normalized" === a.data("status") && jsPanel.updateCachedData(a);b(document).trigger("jspanelbeforemaximize", d);if (b.isFunction(a.option.onbeforemaximize) && !1 === a.option.onbeforemaximize.call(a, a)) return a;f === document.body ? (a.css({ width: document.documentElement.clientWidth - c.left - c.right + "px", height: document.documentElement.clientHeight - c.top - c.bottom + "px", left: c.left + "px", top: c.top + "px" }), !1 === a.option.position.fixed && a.css({ left: window.pageXOffset + c.left + "px", top: window.pageYOffset + c.top + "px" })) : a.css({ width: f.clientWidth - c.left - c.right + "px", height: f.clientHeight - c.top - c.bottom + "px", left: c.left + "px", top: c.top + "px" });a.contentResize().data("status", "maximized").css("z-index", jsPanel.setZi(a));
      jsPanel.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev", a);b("#" + a.prop("id") + "-min").remove();b(document).trigger("jspanelmaximized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onmaximized) && a.option.onmaximized.call(a, a);return a;
    };a.minimize = function () {
      if ("minimized" === a.data("status")) return a;b(document).trigger("jspanelbeforeminimize", d);if (b.isFunction(a.option.onbeforeminimize) && !1 === a.option.onbeforeminimize.call(a, a)) return a;var c = a.header.headerbar.css("color"),
      ...
      c.length ? (b(".jsPanel-minimized-box").length || b(c[0]).append("<div class='jsPanel-minimized-box'>"), b(".jsPanel-minimized-box").append(e)) : b("#jsPanel-replacement-container").append(e);b(document).trigger("jspanelminimized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onminimized) && a.option.onminimized.call(a, a);b(".jsPanel-btn-normalize", e).css("display", "block").click(function () {
    ...
    });a.option.headerRemove ? (a.header.remove(), a.content.addClass("jsPanel-content-noheader"), ["close", "maximize", "minimize", "normalize", "smallify"].forEach(function (b) {
    ...
    a.setTheme();(a.option.headerRemove || 1 > b(".jsPanel-hdr").length) && a.content.css("border", "none");a.option.headerToolbar && !a.option.headerRemove && jsPanel.toolbar(a, "header", a.option.headerToolbar);a.option.footerToolbar && jsPanel.toolbar(a, "footer", a.option.footerToolbar);a.option.content && (a.content.append(a.option.content), a.data("content", a.option.content));"string" === typeof a.option.contentAjax ? (a.option.contentAjax = { url: a.option.contentAjax, autoload: !0 }, jsPanel.ajax(a)) : b.isPlainObject(a.option.contentAjax) && jsPanel.ajax(a);b.isPlainObject(a.option.contentIframe) && (a.option.contentIframe.src || a.option.contentIframe.srcdoc) && jsPanel.iframe(a);a.option.paneltype.connector && jsPanel.addConnector(a);"string" === typeof a.option.contentSize && (c = a.option.contentSize.trim().split(" "), e = c.length, a.option.contentSize = { width: c[0], height: c[--e] });0 === a.option.contentSize.height && (a.option.contentSize.height = "0");a.content.css({ width: a.option.contentSize.width || b.jsPanel.defaults.contentSize.width, height: a.option.contentSize.height || b.jsPanel.defaults.contentSize.height });a.css({ width: function width() {
      ...
      if (a.option.dblclicks.title) a.header.headerbar.on("dblclick", function (b) {
        b.preventDefault();
        jsPanel.dblclickhelper(a.option.dblclicks.title, a);
      ...
      b.prop("dir", "rtl");
      a.option.rtl.lang && b.prop("lang", a.option.rtl.lang);
      ...
      c = b(c.target).closest(".jsPanel").css("z-index");!a.hasClass("jsPanel-modal") && c <= jsPanel.zi && a.front();
      ...
      n = a.outerWidth();m = a.outerHeight();
    });a.on("resizestop", function () {
      a.outerWidth() !== n && a.outerHeight() === m ? (jsPanel.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallify", a), a.data("status", "smallified"), b(document).trigger("jspanelsmallified", d), b(document).trigger("jspanelstatuschange", d), b.isFunction(a.option.onsmallified) && a.option.onsmallified.call(a, a)) : a.outerHeight() !== m && (jsPanel.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev", a), a.data("status", "normalized"), b(document).trigger("jspanelnormalized", d), b(document).trigger("jspanelstatuschange", d), b.isFunction(a.option.onnormalized) && a.option.onnormalized.call(a, a));
  ...
  };b.jsPanel.defaults = { autoclose: !1, border: !1, callback: !1, container: "body", content: !1, contentAjax: !1, contentIframe: !1, contentOverflow: "hidden", contentSize: { width: 400, height: 200 }, custom: !1, dblclicks: !1, draggable: { handle: "div.jsPanel-hdr, div.jsPanel-ftr",
      opacity: .8 }, footerToolbar: !1, headerControls: { close: !1, maximize: !1, minimize: !1, normalize: !1, smallify: !1, controls: "all", iconfont: "jsglyph" }, headerRemove: !1, headerTitle: "jsPanel", headerToolbar: !1, id: function id() {
      return "jsPanel-" + (jsPanel.id += 1);
    }, load: !1, maximizedMargin: { top: 5, right: 5, bottom: 5, left: 5 }, onbeforeclose: !1, onbeforemaximize: !1, onbeforeminimize: !1, onbeforenormalize: !1, onclosed: !1, onmaximized: !1, onminimized: !1, onnormalized: !1, onbeforeresize: !1, onresized: !1, onsmallified: !1, onunsmallified: !1, onfronted: !1,
    ...
    resizable: !1 };b(document).ready(function () {
    ...
    }, !1);b(document.body).append("<div id='jsPanel-replacement-container'>");
  });
})(jQuery);
