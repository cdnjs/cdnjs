...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            _commandcolumn: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('commandcolumn', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('commandcolumn');
                }
            },
            _commandcolumnrenderer: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('commandcolumnrenderer', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('commandcolumnrenderer');
                }
            },
            ...
            _showfilterbar: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('showfilterbar', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('showfilterbar');
                }
            },
            _filterbarmode: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('filterbarmode', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('filterbarmode');
                }
            },
            ...
            _enableSanitize: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('enableSanitize', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('enableSanitize');
                }
            },
            _cardview: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('cardview', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('cardview');
                }
            },
            _cardviewcolumns: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('cardviewcolumns', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('cardviewcolumns');
                }
            },
            _cardheight: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('cardheight', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('cardheight');
                }
            },
            _cardsize: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('cardsize', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('cardsize');
                }
            },
            ...
            _batcheditable: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('batcheditable', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('batcheditable');
                }
            },
            ...
            _autofill: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('autofill', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('autofill');
                }
            },
            ...
            _sortmodekey: function(arg) {
                if (arg !== undefined) {
                    JQXLite(this.componentSelector).jqxGrid('sortmodekey', arg)
                } else {
                    return JQXLite(this.componentSelector).jqxGrid('sortmodekey');
                }
            },
            ...
            __extendProps__: function () {
                ...
                Object.defineProperty(that, 'commandcolumn', {
                    get: function() {
                        return that._commandcolumn();
                    },
                    set: function(newValue) {
                        that._commandcolumn(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'commandcolumnrenderer', {
                    get: function() {
                        return that._commandcolumnrenderer();
                    },
                    set: function(newValue) {
                        that._commandcolumnrenderer(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(that, 'showfilterbar', {
                    get: function() {
                        return that._showfilterbar();
                    },
                    set: function(newValue) {
                        that._showfilterbar(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'filterbarmode', {
                    get: function() {
                        return that._filterbarmode();
                    },
                    set: function(newValue) {
                        that._filterbarmode(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(that, 'enableSanitize', {
                    get: function() {
                        return that._enableSanitize();
                    },
                    set: function(newValue) {
                        that._enableSanitize(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'cardview', {
                    get: function() {
                        return that._cardview();
                    },
                    set: function(newValue) {
                        that._cardview(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'cardviewcolumns', {
                    get: function() {
                        return that._cardviewcolumns();
                    },
                    set: function(newValue) {
                        that._cardviewcolumns(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'cardheight', {
                    get: function() {
                        return that._cardheight();
                    },
                    set: function(newValue) {
                        that._cardheight(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(that, 'cardsize', {
                    get: function() {
                        return that._cardsize();
                    },
                    set: function(newValue) {
                        that._cardsize(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(that, 'batcheditable', {
                    get: function() {
                        return that._batcheditable();
                    },
                    set: function(newValue) {
                        that._batcheditable(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(that, 'autofill', {
                    get: function() {
                        return that._autofill();
                    },
                    set: function(newValue) {
                        that._autofill(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
                ...
                Object.defineProperty(that, 'sortmodekey', {
                    get: function() {
                        return that._sortmodekey();
                    },
                    set: function(newValue) {
                        that._sortmodekey(newValue);
                    },
                    enumerable: true,
                    configurable: true
                });
