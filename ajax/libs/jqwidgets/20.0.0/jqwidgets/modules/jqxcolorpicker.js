    ...
    $.extend($.jqx._jqxDropDownButton.prototype, {
        ...
        createInstance: function (args) {
            ...
            var dropDownButtonStructure = $("<div style='background-color: transparent; -webkit-appearance: none; outline: none; width:100%; height: 100%; padding: 0px; margin: 0px; border: 0px; position: relative;'>" +
                ...
                "<div id='dropDownButtonContent' unselectable='on' style='outline: none; background-color: transparent; border: none; float: left; position: relative;'></div>" +
            ...
            that.host.addClass(that.toThemeProperty('jqx-dropdownbutton'));
        ...
        render: function () {
            ...
            self.dropDownButtonWrapper.append(label);
            self.label = label;

            var bar = $("<span></span>");
            self.dropDownButtonWrapper.append(bar);
        ...
        open: function () {
            ...
            else if (that.animationType === 'transform') {
                that.container.css('visibility', 'visible');
                that.container.css('display', 'block');
                $.data(document.body, "openedJQXButtonParent", self);
                $.data(document.body, "openedJQXButton" + that.element.id, popup);
            ...
            that.container.addClass('jqx-popup-show');
        },
        ...
        close: function () {
            ...
            container.removeClass('jqx-popup-show');
        ...
        destroy: function () {
            ...
            that.removeHandler(that.host, 'keydown');
            that.host.removeClass();
            that.removeHandler($(document), 'mousedown.' + that.element.id, that.closeOpenedDropDown);
            that.host.remove();
