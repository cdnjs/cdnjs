...
| Updated:  Monday,    January   28, 2013    [2013.01.28.00.40-08.00]
|+-----------------------------------------------------------------------------+
|
...
(function/*com.iskitz.ajile*/(VERSION, global, undefined)
{
   ...
   function cloakModule(moduleName, container)
   {
      ...
      module && cloakObject ((isFunction (module) ? module : module.constructor));
      ...
      for(var id, src, sys, loaders=getLoaders(), i=loaders.length; --i >= 0;)
      {
         ...
         id && !moduleName && (module = GetModule (id));

         if(sys || (moduleName ? ((!src && id) || isCloaked || CLOAK) : (id && module)))
   ...
   function ensureFailSafe(owner, isOn)
   {
      ...
      if(onLoad != executeFailSafe.onLoad)  //HACK: Need a set, could have multiple unique onload listeners.
