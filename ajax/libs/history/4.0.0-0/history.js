...
/***/ function(module, exports, __webpack_require__) {
	...
	var createTransitionManager = function createTransitionManager() {
	  ...
	  var setPrompt = function setPrompt(nextPrompt) {
	    !(typeof nextPrompt === 'string' || typeof nextPrompt === 'function') ?  false ? (0, _invariant2.default)(false, 'A history prompt must be a string or a function') : (0, _invariant2.default)(false) : void 0;
	    ...
	    if (prompt) {
	      if (typeof getUserConfirmation === 'function') {
	        ...
	        if (typeof message === 'string') {
	         ...
	         false ? (0, _warning2.default)(false, 'A history needs a getUserConfirmation function in order to use a prompt') : void 0;
