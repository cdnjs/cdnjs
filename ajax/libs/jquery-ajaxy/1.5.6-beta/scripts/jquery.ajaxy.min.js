...
f;g=f.controller||b.match(a)||undefined;f.controller=g;f.Request.url=f.Request.url||b.options.root_url+b.options.base_url+(a||"?");b.storeState(f);b.trigger(g,"request");g={data:f.Request.data,url:f.Request.url,type:"post",success:function(l){b.options.debug&&window.console.debug("Ajaxy.request.success:",[this,arguments]);l=c.extend(true,{},b.defaults.State.Response.data,l);l.Ajaxy=l.Ajaxy||{};if(l.Ajaxy.redirected){var m=b.extractState(l.Ajaxy.redirected.to);b.redirected={status:true,from:a,to:m};
d.go(m)}b.ajaxQueue.shift();if((m=b.ajaxQueue.pop())&&m!==a){b.ajaxQueue=[];b.stateChange(m);return false}f.Response.data=l;f.Error.data={};m=l.controller||f.controller||null;if(m===null){m="_generic";window.console.warn("Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[l.controller,f.controller])}if(f.Response.callback)if(f.Response.callback.apply(f,arguments)||m==="callback")return true;return b.trigger(m,"response",f)},error:function(l,
m,r,o){b.options.debug&&window.console.debug("Ajaxy.request.error:",[this,arguments]);o||(o={responseText:l.responseText.trim()||false});b.ajaxQueue.shift();var p=b.ajaxQueue.pop();if(p&&p!==a){b.ajaxQueue=[];b.stateChange(p);return false}f.Request.XMLHttpRequest=l;f.Response.data=o;f.Error.data={};p=o.controller||f.controller||null;if(p===null){p="_generic";window.console.warn("Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.",[this,arguments],[o.controller,
...
b.findAndSelf("a.ajaxy").once("click",a.ajaxify_helpers.a);b.findAndSelf("form.ajaxy").once("submit",a.ajaxify_helpers.form);return b},ajaxifyController:function(a){var b=c.Ajaxy,d=b.getController(a);if(d&&(d.selector||0))c(function(){c(d.selector).data("ajaxy-controller",a).once("click",b.ajaxify_helpers.a)});return true},ajaxify_helpers:{a:function(a){var b=c.Ajaxy,d=c(this),e=b.extractRelativeUrl(d.attr("href")).replace(/^\/?\.\//,"/"),f=b.extractState(e);e=b.extractAnchor(e);if("/"+e===f||e===
f)e="";var g=!d.hasClass(b.options.no_log_class);d=d.data("ajaxy-controller")||null;b.go({state:f,controller:d,log:g,anchor:e});a.stopPropagation();a.preventDefault();return false},form:function(a){var b=c.Ajaxy,d=c(this),e=d.attr("disabled");if(e=e||e==="false")return false;if(d.attr("target"))return true;d=b.extractState(d.attr("action"));b.go({state:d,form:this});a.stopPropagation();a.preventDefault();return false}}};c.Ajaxy.construct()}})(jQuery);
