...
true;b.bind(function(d){return a.stateChange(d)});c.fn.ajaxify=a.ajaxify;c.fn.ajaxy=a.ajaxify;c(function(){a.domReady();b.domReady()});return true}},domReady:function(){c.Sparkle&&c.Sparkle.addExtension("ajaxy",function(){c(this).ajaxify()});return true},ajaxify:function(a){var b=c.Ajaxy,d=c(this).addClass("ajaxy");a=c.extend({complete:true},a);if(a.complete){c.each(b.Controllers,function(e){b.ajaxifyController(e)});b.options.track_all_internal_links&&d.findAndSelf("a[href^=/],a[href^=./]").filter(":not(.ajaxy,.no-ajaxy)").addClass("ajaxy");
b.options.track_all_anchors&&d.findAndSelf("a[href^=#]:not(.ajaxy,.no-ajaxy)").addClass("ajaxy")}d.findAndSelf("a.ajaxy").once("click",b.ajaxify_helpers.a);d.findAndSelf("form.ajaxy").once("submit",b.ajaxify_helpers.form);return d},ajaxifyController:function(a){var b=c.Ajaxy.getController(a);if(b&&(b.selector||0))c(function(){c(b.selector).data("ajaxy-controller",a).ajaxify({complete:false})});return true},ajaxify_helpers:{a:function(a){var b=c.Ajaxy,d=c(this),e=b.extractRelativeUrl(d.attr("href")).replace(/^\/?\.\//,
"/"),f=b.extractState(e);e=b.extractAnchor(e);if("/"+e===f||e===f)e="";var g=!d.hasClass(b.options.no_log_class);d=d.data("ajaxy-controller")||null;b.go({state:f,controller:d,log:g,anchor:e});a.stopPropagation();a.preventDefault();return false},form:function(a){var b=c.Ajaxy,d=c(this),e=d.attr("disabled");if(e=e||e==="false")return false;if(d.attr("target"))return true;d=b.extractRelativeUrl(d.attr("action")).replace(/^\/?\.\//,"/");d=b.extractState(d);b.go({state:d,form:this});a.stopPropagation();
