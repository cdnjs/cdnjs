/*! tableSorter 2.15+ widgets - updated 4/22/2014 (v2.16.1-beta) */
;(function(k){
...
c.setFilters=function(b,a,e,f){var d=b?k(b)[0].config:"";b=c.getFilters(b,!0,a,f);d&&e&&(d.lastCombinedFilter=null,c.filter.findRows(d.$table[0],a,(a||[]).join("")),d.$table.trigger("filterFomatterUpdate"));return!!b};
