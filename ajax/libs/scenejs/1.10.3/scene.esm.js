...
import { reactive, getObservers, computed, partialReactive, observe, isObserver } from '@cfcs/core';
...
var SCENE_REACTIVE = {
    ...
    created: function (data) {
        ...
        var scene = isScene(dataObject)
            ? dataObject
            : new Scene(dataObject, __assign({ noRegisterElement: false }, data.options));
        var obj = scene.state;
...
var SCENE_ITEM_REACTIVE = {
    ...
    created: function (data) {
        ...
        var sceneItem = isSceneItem(dataObject)
            ? dataObject
            : new SceneItem(dataObject, __assign({ noRegisterElement: false }, data.options));
