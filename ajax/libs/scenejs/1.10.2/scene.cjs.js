...
var Animator = /*#__PURE__*/ (function (_super) {
  ...
  animator.getTime() // 10
    ...
    Animator.prototype.setTime = function (time, isTick, isParent, exec) {
        ...
        var numericTime = utils.isString(time) ? parseFloat(time) : time;
...
item.setElement(document.querySelectorAll(".class"));
    ...
    SceneItem.prototype.setElement = function (target) {
        ...
        var elements = [];
        if (utils.isFunction(selectorTarget)) {
            nextTarget = selectorTarget(this.getId(), 0);
        }
        if (!nextTarget) {
            return this;
        }
        else if (nextTarget === true || utils.isString(nextTarget)) {
            ...
            elements = utils.toArray(nextTarget);
        }
...
var SCENE_REACTIVE = {
    ...
    created: function (data) {
        ...
        var nextReactiveObject = core.partialReactive(nextObj);
...
var FRAME_REACTIVE = {
    ...
    created: function (data) {
        ...
        var nextReactiveObject = core.partialReactive(__assign({ cssText: cssText, cssObject: cssObject, camelCasedCSSObject: camelCasedCSSObject, onUpdate: onUpdate }, FRAME_METHODS.reduce(function (obj, cur) {
            obj[cur] = function () {
                var _a;
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
