    ...
    */
                ...
                if (isScene(object) || isSceneItem(object)) {
                    ...
                    if (!elementsLength) {
                        ...
                        scene.state[SELECTOR] = function (id) {
                            subElements_1 = subElements_1 || $("".concat(isFunction$1(selector) ? selector(name_1) : name_1), true);
    ...
    var SCENE_REACTIVE = {
        ...
        created: function (data) {
            ...
            var nextObj = __assign$1(__assign$1({ totalDuration: totalDuration }, observers), SCENE_METHODS.reduce(function (methodObject, cur) {
    ...
    var SCENE_ITEM_REACTIVE = {
        ...
        created: function (data) {
            ...
            var nextObj = __assign$1(__assign$1({ totalDuration: totalDuration }, observers), SCENE_ITEM_METHODS.reduce(function (methodObject, cur) {
                methodObject[cur] = function () {
                    var _a;
                    var args = [];
                    for (var _i = 0; _i < arguments.length; _i++) {
