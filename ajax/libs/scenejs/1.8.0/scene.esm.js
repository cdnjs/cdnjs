        ...
        var _loop_1 = function (name_1) {
            ...
            if (isScene(object) || isSceneItem(object)) {
                ...
                for (var i = 0; i < length_1; ++i) {
                    ...
                    var item_1 = scene.newItem(i);
                    item_1.setId().load(object(i, elements[i]));
                    if (element) {
                        item_1.setElement(element);
                    }
                }
                if (!elementsLength) {
                    var elements_1 = [];
                    scene.state[SELECTOR] = function (id) {
                        elements_1 = elements_1 || $("".concat(isFunction(selector) ? selector(name_1) : name_1), true);
                        return elements_1[id];
                    };
                }
...
var SCENE_REACTIVE = {
    created: function (data) {
        ...
        var nextObj = __assign(__assign({ totalDuration: totalDuration }, observers), SCENE_METHODS.reduce(function (obj, cur) {
            obj[cur] = function () {
                var _a;
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
...
var SCENE_ITEM_REACTIVE = {
    created: function (data) {
        ...
        var nextObj = __assign(__assign({ totalDuration: totalDuration }, observers), SCENE_ITEM_METHODS.reduce(function (obj, cur) {
            obj[cur] = function () {
                var _a;
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
