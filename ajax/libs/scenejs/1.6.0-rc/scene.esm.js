...
function (_super) {
  ...
  * @param - The target frame
  ...
  __proto.getCurrentFrame = function (needUpdate, parentEasing) {
    var iterationTime = this.getIterationTime();
    var frame = needUpdate || this.needUpdate ? this.getComputedFrame(iterationTime, parentEasing) : this.temp;
    this.temp = frame;
    return frame;
  };
  /**
...
export { Animator, EASE, EASE_IN, EASE_IN_OUT, EASE_OUT, EVENTS, FIXED, Frame, LINEAR, NAME_SEPARATOR, OPTIONS, ROLES, STEP_END, STEP_START, SceneItem, animate, animateItem, bezier, isFrame, isRole, isScene, isSceneItem, setAlias, setRole, steps };
