...
(function (global, factory) {
    ...
    */
    ...
    function () {
      ...
      /**
      * get flatted property names
      * @example
      frame.getFlattedNames()
      */


      __proto.getFlattedNames = function (names) {
      ...
      /**
        * get full properties orders
        * @param - Start property names
        * @param - Whether to include all names in orders
        * @example
        * // [
        * //   ["width"],
        * //   ["transform", "translate"],
        ...
        * //   ["scale"],
        * // ]
        * frame.getFullOrders(["transform"]) // => []
        * // [
        * //   ["transform", "translate"],
        * //   ["transform", "scale"],
        * // ]
        * frame.getFullOrders(["transform"], true)
        */


      __proto.getFullOrders = function (names, includeNames) {
        if (includeNames === void 0) {
          includeNames = false;
        }

        return this.orderMap.gets(names, includeNames);
      };
      /**
