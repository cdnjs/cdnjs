...
var SCENE_REACTIVE = {
    ...
    created: function (data) {
        ...
        var scene = isScene(dataObject)
            ? dataObject
            : new Scene(dataObject === null || dataObject === void 0 ? void 0 : dataObject.props, data.options);
        var obj = scene.state;
...
var SCENE_ITEM_REACTIVE = {
    ...
    created: function (data) {
        ...
        var sceneItem = isSceneItem(dataObject)
            ? dataObject
            : new SceneItem(dataObject === null || dataObject === void 0 ? void 0 : dataObject.props, data.options);
