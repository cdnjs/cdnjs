...
var SCENE_REACTIVE = {
    ...
    created: function (data) {
        var dataObject = isFunction(data) ? data() : data;
        var scene = isScene(dataObject)
            ? dataObject
            : new Scene(dataObject === null || dataObject === void 0 ? void 0 : dataObject.props, dataObject === null || dataObject === void 0 ? void 0 : dataObject.options);
        var obj = scene.state;
...
var SCENE_ITEM_REACTIVE = {
    ...
    created: function (data) {
        ...
        var sceneItem = isSceneItem(dataObject)
            ? dataObject
            : new SceneItem(dataObject === null || dataObject === void 0 ? void 0 : dataObject.props, dataObject === null || dataObject === void 0 ? void 0 : dataObject.options);
...
var FRAME_REACTIVE = {
    ...
    created: function (data) {
        ...
        var nextReactiveObject = reactive(__assign({ cssText: cssText, cssObject: cssObject, camelCasedCSSObject: camelCasedCSSObject, onUpdate: onUpdate }, FRAME_METHODS.reduce(function (obj, cur) {
            obj[cur] = function () {
                var _a;
                var args = [];
                for (var _i = 0; _i < arguments.length; _i++) {
