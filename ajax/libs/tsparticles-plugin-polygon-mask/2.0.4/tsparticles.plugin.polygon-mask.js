...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMaskDrawStroke.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMaskDraw.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMaskInline.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMaskLocalSvg.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMaskMove.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/PolygonMask.js
...
;// CONCATENATED MODULE: ./dist/PolygonMaskInstance.js
...
class PolygonMaskPlugin {
  constructor(engine) {
    ...
    dist_classPrivateFieldSet(this, _PolygonMaskPlugin_engine, engine, "f");
  }

  getPlugin(container) {
    return new PolygonMaskInstance(container, dist_classPrivateFieldGet(this, _PolygonMaskPlugin_engine, "f"));
  }
...
function loadPolygonMaskPlugin(engine) {
  return dist_awaiter(this, void 0, void 0, function* () {
    if (!(0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isSsr)() && !("SVGPathSeg" in window)) {
      yield __webpack_require__.e(/* import() */ 561).then(__webpack_require__.t.bind(__webpack_require__, 561, 23));
    }
