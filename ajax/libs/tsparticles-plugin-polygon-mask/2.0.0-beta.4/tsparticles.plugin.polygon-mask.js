...
;// CONCATENATED MODULE: ./dist/Enums/InlineArrangement.js
...
;// CONCATENATED MODULE: ./dist/Enums/MoveType.js
var MoveType;
...
;// CONCATENATED MODULE: ./dist/Enums/Type.js
var Type;
...
;// CONCATENATED MODULE: ./dist/Options/Classes/DrawStroke.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/Draw.js
...
class Draw {
  ...
  set lineColor(value) {
    this.stroke.color = OptionsColor/* OptionsColor.create */.O.create(this.stroke.color, value);
  }
...
;// CONCATENATED MODULE: ./dist/Options/Classes/Move.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/Inline.js
...
;// CONCATENATED MODULE: ./dist/Options/Classes/LocalSvg.js
class LocalSvg {
  constructor() {
    this.path = [];
    this.size = {
...
class PolygonMaskInstance {
  ...
  polygonBounce(particle, _delta, direction) {
    ...
    if (!this.raw || !options.enable || direction !== external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.OutModeDirection.top) {
      return false;
    }
  ...
  initRawData(force) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.createPath2D();
      external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.tsParticles.dispatchEvent("polygonMaskLoaded", {
...
function loadPolygonMaskPlugin(tsParticles) {
  return dist_awaiter(this, void 0, void 0, function* () {
    if (!(0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isSsr)() && !window.SVGPathSeg) {
