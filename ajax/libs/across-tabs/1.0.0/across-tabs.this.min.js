 ...
 * 
 */
this.AcrossTabs=function(e){function t(a){if(n[a])return n[a].exports;var i=n[a]={exports:{},id:a,loaded:!1};return e[a].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var i=n(1),r=a(i),o=n(11),s=a(o),u={Parent:r["default"],Child:s["default"]};t["default"]=u,e.exports=t["default"]},function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},o=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),s=n(2),u=a(s),d=n(3),l=a(d),f=n(9),c=a(f),h=n(6),v=a(h),_=n(7),g=a(_),w=n(4),b=a(w),p=n(10),E=a(p),y=void 0,O=void 0,N=function(){function e(t){i(this,e),t=t||{},"undefined"==typeof t.heartBeatInterval&&(t.heartBeatInterval=500),"undefined"==typeof t.shouldInitImmediately&&(t.shouldInitImmediately=!0),l["default"].tabs=[],this.Tab=u["default"],r(this,t),l["default"].config=t,this.shouldInitImmediately&&this.init()}return o(e,[{key:"addInterval",value:function(){var e=void 0,t=l["default"].getAll(),n=l["default"].getOpened();if(!n||!n.length)return window.clearInterval(y),y=null,!1;for(e=0;e<t.length;e++)this.removeClosedTabs&&this.watchStatus(t[e]),t[e]&&(t[e].status=t[e].ref.closed?v["default"].CLOSE:v["default"].OPEN);this.onPollingCallback&&this.onPollingCallback()}},{key:"startPollingTabs",value:function(){var e=this;y=window.setInterval(function(){return e.addInterval()},this.heartBeatInterval)}},{key:"watchStatus",value:function(e){if(!e)return!1;var t=e.ref.closed?v["default"].CLOSE:v["default"].OPEN,n=e.status;return!(!t||t===n)&&void(n===v["default"].OPEN&&t===v["default"].CLOSE&&l["default"]._remove(e))}},{key:"onChildUnload",value:function(e){this.onChildDisconnect&&this.onChildDisconnect(e.detail)}},{key:"customEventUnListener",value:function(e){this.enableElements(),this.onHandshakeCallback&&this.onHandshakeCallback(e.detail)}},{key:"addEventListeners",value:function(){var e=this;window.removeEventListener("message",E["default"].onNewTab),window.addEventListener("message",E["default"].onNewTab),window.removeEventListener("toggleElementDisabledAttribute",this.customEventUnListener),window.addEventListener("toggleElementDisabledAttribute",function(t){return e.customEventUnListener(t)}),window.removeEventListener("onChildUnload",this.onChildUnload),window.addEventListener("onChildUnload",function(t){return e.onChildUnload(t)}),window.onbeforeunload=function(){l["default"].broadCastAll(b["default"].PARENT_DISCONNECTED)}}},{key:"enableElements",value:function(){c["default"].enable("data-tab-opener")}},{key:"getAllTabs",value:function(){return l["default"].getAll()}},{key:"getOpenedTabs",value:function(){return l["default"].getOpened()}},{key:"getClosedTabs",value:function(){return l["default"].getClosed()}},{key:"closeAllTabs",value:function(){return l["default"].closeAll()}},{key:"closeTab",value:function(e){return l["default"].closeTab(e)}},{key:"broadCastAll",value:function(e){return l["default"].broadCastAll(e)}},{key:"broadCastTo",value:function(e,t){return l["default"].broadCastTo(e,t)}},{key:"openNewTab",value:function(e){if(!e)throw new Error(g["default"].CONFIG_REQUIRED);var t=e.url;if(!t)throw new Error(g["default"].URL_REQUIRED);return O=new this.Tab,O.create(e),y||this.startPollingTabs(),O}},{key:"init",value:function(){this.addEventListeners()}}]),e}();t["default"]=N,e.exports=t["default"]},function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},o=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),s=n(3),u=a(s),d=n(8),l=a(d),f=n(9),c=a(f),h=function(){function e(){i(this,e),window.name=window.name||"PARENT_TAB"}return o(e,[{key:"create",value:function(e){return e=e||{},r(this,e),this.id=l["default"].generate()||u["default"].tabs.length+1,this.status="open",this.ref=window.open(this.url,"_blank",e.windowFeatures),c["default"].disable("data-tab-opener"),window.newlyTabOpened={id:this.id,name:this.name,ref:this.ref},u["default"].addNew(this),this}}]),e}();t["default"]=h,e.exports=t["default"]},function(e,t,n){"use strict";function a(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var i=n(4),r=a(i),o=n(5),s=a(o),u=n(6),d=a(u),l=n(7),f=a(l),c={tabs:[],config:{}};c._remove=function(e){var t=void 0;t=s["default"].searchByKeyName(c.tabs,"id",e.id,"index"),c.tabs.splice(t,1)},c._preProcessMessage=function(e){try{e=JSON.stringify(e)}catch(t){throw new Error(f["default"].INVALID_JSON)}return e.indexOf(r["default"].PARENT_COMMUNICATED)===-1&&(e=r["default"].PARENT_COMMUNICATED+e),e},c.addNew=function(e){c.tabs.push(e)},c.getOpened=function(){return c.tabs.filter(function(e){return e.status===d["default"].OPEN})},c.getClosed=function(){return c.tabs.filter(function(e){return e.status===d["default"].CLOSE})},c.getAll=function(){return c.tabs},c.closeTab=function(e){var t=s["default"].searchByKeyName(c.tabs,"id",e);return t&&t.ref&&(t.ref.close(),t.status=d["default"].CLOSE),c},c.closeAll=function(){var e=void 0;for(e=0;e<c.tabs.length;e++)c.tabs[e]&&c.tabs[e].ref&&(c.tabs[e].ref.close(),c.tabs[e].status=d["default"].CLOSE);return c},c.broadCastAll=function(e,t){var n=void 0,a=c.getOpened();for(e=c._preProcessMessage(e),n=0;n<a.length;n++)c.sendMessage(a[n],e,t);return c},c.broadCastTo=function(e,t,n){var a=void 0,i=c.getAll();return t=c._preProcessMessage(t),a=s["default"].searchByKeyName(i,"id",e),c.sendMessage(a,t,n),c},c.sendMessage=function(e,t,n){var a=c.config.origin||"*";n?e.ref[0].postMessage(t,a):e.ref.top.postMessage(t,a)},t["default"]=c,e.exports=t["default"]},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n={LOADED:"__TAB__LOADED_EVENT__",CUSTOM:"__TAB__CUSTOM_EVENT__",ON_BEFORE_UNLOAD:"__TAB__ON_BEFORE_UNLOAD__",PARENT_DISCONNECTED:"__PARENT_DISCONNECTED__",HANDSHAKE_WITH_PARENT:"__HANDSHAKE_WITH_PARENT__",PARENT_COMMUNICATED:"__PARENT_COMMUNICATED__"};t["default"]=n,e.exports=t["default"]},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n={},a={INDEX:"index",OBJECT:"object",BOTH:"both"};n.searchByKeyName=function(e,t,n,i){if(!e||!t)return!1;i=i||a[1];var r=void 0,o=void 0,s=void 0,u=-1;for(r=0;r<e.length;r++){if(o=e[r],!isNaN(n)&&parseInt(o[t],10)===parseInt(n,10)){u=r;break}if(isNaN(n)&&o[t]===n){u=r;break}}switch(u===-1&&(e[u]={}),i){case a.INDEX:s=u;break;case a.BOTH:s={obj:e[u],index:u};break;case a.OBJECT:default:s=e[u]}return s},t["default"]=n,e.exports=t["default"]},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n={OPEN:"open",CLOSE:"close"};t["default"]=n,e.exports=t["default"]},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n={INVALID_JSON:"Invalid JSON Object!",INVALID_DATA:"Some wrong message is being sent by Parent.",CONFIG_REQUIRED:"Configuration options required. Please read docs.",URL_REQUIRED:"Url is needed for creating and opening a new window/tab. Please read docs."};t["default"]=n,e.exports=t["default"]},function(e,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});/**
