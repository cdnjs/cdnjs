      ...
      if ((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)(shapeType, options.particles.shape.type)) {
        ...
        if (shapeOptions instanceof Array) {
          for (const character of shapeOptions) {
            yield (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.loadFont)(character.font, character.weight);
          }
        } else {
          if (shapeOptions !== undefined) {
            yield (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.loadFont)(shapeOptions.font, shapeOptions.weight);
          }
        }
      }
    });
