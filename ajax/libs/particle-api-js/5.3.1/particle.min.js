...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_http=require("http"),_http2=_interopRequireDefault(_http),_https=require("https"),_https2=_interopRequireDefault(_https),_url=require("url"),_url2=_interopRequireDefault(_url),_events=require("events"),EventStream=function(e){function t(e,r,n){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,Object.getPrototypeOf(t).call(this));return o.uri=e,o.token=r,o.reconnectInterval=2e3,Object.assign(o,n),o}return _inherits(t,e),_createClass(t,[{key:"connect",value:function(){var e=this;return new Promise(function(t,r){var n=_url2["default"].parse(e.uri),o=n.hostname,i=n.protocol,s=n.port,a=n.path;e.origin=i+"//"+o+(s?":"+s:"");var u="https:"===i,f=u?_https2["default"]:_http2["default"],c=f.request({hostname:o,protocol:i,path:a+"?history_limit=30&access_token="+e.token,method:"get",port:s||(u?443:80),avoidFetch:!0,mode:"prefer-streaming"});e.req=c,e.debug&&e.debug(e),c.on("error",function(t){r({error:t,errorDescription:"Network error from "+e.uri})}),c.on("response",function(n){var o=n.statusCode;if(200!==o){var i=function(){var t="";return n.on("data",function(e){return t+=e}),n.on("end",function(){try{t=JSON.parse(t)}catch(n){}e.emit("response",{statusCode:o,body:t});var i="HTTP error "+o+" from "+e.uri;t&&t.error_description&&(i+=" - "+t.error_description),r({statusCode:o,errorDescription:i,body:t}),e.req=void 0}),{v:void 0}}();if("object"===("undefined"==typeof i?"undefined":_typeof(i)))return i.v}e.data="",e.buf="",e.eventName,e.lastEventId,n.on("data",e.parse.bind(e)),n.once("end",e.end.bind(e)),t(e)}),c.end()})}},{key:"abort",value:function(){this.req&&(this.req.abort(),this.req=void 0),this.removeAllListeners()}},{key:"end",value:function(){var e=this;this.req=void 0,setTimeout(function(){e.connect()["catch"](function(t){e.emit("error",t),e.removeAllListeners()})},this.reconnectInterval)}},{key:"parse",value:function(e){this.buf+=e;for(var t=0,r=this.buf.length,n=!1;r>t;){n&&("\n"===this.buf[t]&&++t,n=!1);for(var o=-1,i=-1,s=t;0>o&&r>s;++s){var a=this.buf[s];":"===a?0>i&&(i=s-t):"\r"===a?(n=!0,o=s-t):"\n"===a&&(o=s-t)}if(0>o)break;this.parseEventStreamLine(t,i,o),t+=o+1}t===r?this.buf="":t>0&&(this.buf=this.buf.slice(t))}},{key:"parseEventStreamLine",value:function(e,t,r){if(0===r)try{if(this.data.length>0&&this.event){var n=JSON.parse(this.data);n.name=this.eventName||"","event"!==this.eventName&&this.emit(this.eventName,n),this.emit("event",n),this.data=""}this.eventName=void 0,this.event=!1}catch(o){}else if(t>0){var i=this.buf.slice(e,e+t),s=0;s=" "!==this.buf[e+t+1]?t+1:t+2,e+=s;var a=r-s,u=this.buf.slice(e,e+a);if("data"===i)this.data+=u+"\n";else if("event"===i)this.eventName=u,this.event=!0;else if("id"===i)this.lastEventId=u;else if("retry"===i){var f=parseInt(u,10);Number.isNaN(f)||(this.reconnectInterval=f)}}}}]),t}(_events.EventEmitter);exports["default"]=EventStream,module.exports=exports["default"];
},{"events":198,"http":224,"https":224,"url":222}],3:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},_createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var u=t[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,r,u){return r&&e(t.prototype,r),u&&e(t,u),t}}();require("babel-polyfill");var _superagent=require("superagent"),_superagent2=_interopRequireDefault(_superagent),_superagentPrefix=require("superagent-prefix"),_superagentPrefix2=_interopRequireDefault(_superagentPrefix),_Defaults=require("./Defaults"),_Defaults2=_interopRequireDefault(_Defaults),_EventStream=require("./EventStream"),_EventStream2=_interopRequireDefault(_EventStream),Particle=function(){function e(){var t=arguments.length<=0||void 0===arguments[0]?_Defaults2["default"]:arguments[0];_classCallCheck(this,e),Object.assign(this,t),this.prefix=(0,_superagentPrefix2["default"])(this.baseUrl)}return _createClass(e,[{key:"login",value:function(e){var t=e.username,r=e.password,u=e.tokenDuration,a=void 0===u?this.tokenDuration:u;return this.request({uri:"/oauth/token",form:{username:t,password:r,grant_type:"password",client_id:this.clientId,client_secret:this.clientSecret,expires_in:a},method:"post"})}},{key:"createUser",value:function(e){var t=e.username,r=e.password;return this.post("/v1/users",{username:t,password:r})}},{key:"resetPassword",value:function(e){var t=e.username;return this.post("/v1/user/password-reset",{username:t})}},{key:"removeAccessToken",value:function(e){var t=e.username,r=e.password,u=e.token;return this["delete"]("/v1/access_tokens/"+u,{access_token:u},{username:t,password:r})}},{key:"listAccessTokens",value:function(e){var t=e.username,r=e.password;return this.get("/v1/access_tokens",{username:t,password:r})}},{key:"listDevices",value:function(e){var t=e.auth;return this.get("/v1/devices",t)}},{key:"getDevice",value:function(e){var t=e.deviceId,r=e.auth;return this.get("/v1/devices/"+t,r)}},{key:"claimDevice",value:function(e){var t=e.deviceId,r=e.requestTransfer,u=e.auth;return this.request({uri:"/v1/devices",form:{id:t,request_transfer:!!r},auth:u,method:"post"})}},{key:"removeDevice",value:function(e){var t=e.deviceId,r=e.auth;return this["delete"]("/v1/devices/"+t,null,r)}},{key:"renameDevice",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.put("/v1/devices/"+t,{name:r},u)}},{key:"getClaimCode",value:function(e){var t=e.auth,r=e.iccid,u=void 0===r?void 0:r;return this.post("/v1/device_claims",{iccid:u},t)}},{key:"validatePromoCode",value:function(e){var t=e.auth,r=e.promoCode;return this.get("/v1/promo_code/"+r,t)}},{key:"changeProduct",value:function(e){var t=e.deviceId,r=e.productId,u=e.shouldUpdate,a=e.auth;return this.put("/v1/devices/"+t,{product_id:r,update_after_claim:u||!1},a)}},{key:"getVariable",value:function(e){var t=e.deviceId,r=e.name,u=e.auth;return this.get("/v1/devices/"+t+"/"+r,u)}},{key:"signalDevice",value:function(e){var t=e.deviceId,r=e.signal,u=e.auth;return this.put("/v1/devices/"+t,{signal:r?"1":"0"},u)}},{key:"flashDevice",value:function(e){var t=e.deviceId,r=e.files,u=e.targetVersion,a=e.auth,i={};return u?i.build_target_version=u:i.latest="true",this.request({uri:"/v1/devices/"+t,files:r,auth:a,form:i,method:"put"})}},{key:"flashTinker",value:function(e){var t=e.deviceId,r=e.auth;return this.put("/v1/devices/"+t,{app:"tinker"},r)}},{key:"compileCode",value:function(e){var t=e.files,r=e.platformId,u=e.targetVersion,a=e.auth,i={platform_id:r};return u?i.build_target_version=u:i.latest="true",this.request({uri:"/v1/binaries",files:t,auth:a,form:i,method:"post"})}},{key:"downloadFirmwareBinary",value:function(e){var t=e.binaryId,r=e.auth,u="/v1/binaries/"+t,a=(0,_superagent2["default"])("get",u);return a.use(this.prefix),this.headers(a,r),this.debug&&this.debug(a),a}},{key:"sendPublicKey",value:function(e){var t=e.deviceId,r=e.key,u=e.algorithm,a=e.auth;return this.post("/v1/provisioning/"+t,{deviceID:t,publicKey:"string"==typeof r?r:r.toString(),filename:"particle-api",order:"manual_"+Date.now(),algorithm:u||"rsa"},a)}},{key:"callFunction",value:function(e){var t=e.deviceId,r=e.name,u=e.argument,a=e.auth;return this.post("/v1/devices/"+t+"/"+r,{args:u},a)}},{key:"getEventStream",value:function(e){var t=e.deviceId,r=e.name,u=e.org,a=e.product,i=e.auth,n="/v1/";return u&&(n+="orgs/"+u+"/"),a&&(n+="products/"+a+"/"),t&&(n+="devices/","mine"!==t.toLowerCase()&&(n+=t+"/")),n+="events",r&&(n+="/"+encodeURIComponent(r)),new _EventStream2["default"](""+this.baseUrl+n,i,{debug:this.debug}).connect()}},{key:"publishEvent",value:function(e){var t=e.name,r=e.data,u=e.isPrivate,a=e.auth;return this.post("/v1/devices/events",{name:t,data:r,"private":u},a)}},{key:"createWebhook",value:function(e){var t=e.deviceId,r=e.name,u=e.url,a=e.requestType,i=e.headers,n=e.json,o=e.query,s=e.responseTemplate,v=e.responseTopic,d=e.rejectUnauthorized,c=e.webhookAuth,l=e.form,h=e.auth,f={event:r,url:u,requestType:a,headers:i,json:n,query:o,responseTemplate:s,responseTopic:v,rejectUnauthorized:d,auth:c,form:l};return"mine"===t?f.mydevices=!0:f.deviceid=t,this.post("/v1/webhooks",f,h)}},{key:"deleteWebhook",value:function(e){var t=e.hookId,r=e.auth;return this["delete"]("/v1/webhooks/"+t,null,r)}},{key:"listWebhooks",value:function(e){var t=e.auth;return this.get("/v1/webhooks",t)}},{key:"getUserInfo",value:function(e){var t=e.auth;return this.get("/v1/user",t)}},{key:"setUserInfo",value:function(e){var t=e.stripeToken,r=e.auth;return this.put("/v1/user",{stripe_token:t},r)}},{key:"checkSIM",value:function(e){var t=e.iccid,r=e.auth;return this.head("/v1/sims/"+t,r)}},{key:"activateSIM",value:function(e){var t=e.iccid,r=e.countryCode,u=e.promoCode,a=e.auth;return this.put("/v1/sims/"+t,{country:r,promo_code:u,action:"activate"},a)}},{key:"listBuildTargets",value:function(e){var t=e.auth,r=e.onlyFeatured,u=void 0===r?void 0:r,a=void 0;return void 0!==u&&(a={featured:!!u}),this.get("/v1/build_targets",t,a)}},{key:"get",value:function(e,t){var r=arguments.length<=2||void 0===arguments[2]?void 0:arguments[2];return this.request({uri:e,auth:t,method:"get",query:r})}},{key:"head",value:function(e,t){return this.request({uri:e,auth:t,method:"head"})}},{key:"post",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"post"})}},{key:"put",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"put"})}},{key:"delete",value:function(e,t,r){return this.request({uri:e,data:t,auth:r,method:"delete"})}},{key:"request",value:function(e){var t=e.uri,r=e.method,u=e.data,a=void 0===u?void 0:u,i=e.auth,n=e.query,o=void 0===n?void 0:n,s=e.form,v=void 0===s?void 0:s,d=e.files,c=void 0===d?void 0:d,l=void 0;return c&&(l={},Object.keys(c).forEach(function(e,t){var r=t?"file"+(t+1):"file";l[r]={data:c[e],path:e}})),this._request({uri:t,method:r,data:a,auth:i,query:o,form:v,files:l})}},{key:"_request",value:function(e){var t=this,r=e.uri,u=e.method,a=e.data,i=e.auth,n=e.query,o=e.form,s=e.files;return new Promise(function(e,v){var d=(0,_superagent2["default"])(u,r);d.use(t.prefix),t.headers(d,i),n&&d.query(n),s?(Object.keys(s).forEach(function(e){d.attach(e,s[e].data,s[e].path)}),o&&Object.keys(o).forEach(function(e){d.field(e,o[e])})):o?(d.type("form"),d.send(o)):a&&d.send(a),t.debug&&t.debug(d),d.end(function(t,u){var a=u&&u.body;if(t){var i=t.status,n=(i?"HTTP error":"Network error")+" "+i+" from "+r;a&&a.error_description&&(n+=" - "+a.error_description),v({statusCode:i,errorDescription:n,error:t,body:a})}else e({body:a,statusCode:u.statusCode})})})}},{key:"headers",value:function(e,t){t&&("object"===("undefined"==typeof t?"undefined":_typeof(t))?e.auth(t.username,t.password):e.set({Authorization:"Bearer "+t}))}}]),e}();exports["default"]=Particle,module.exports=exports["default"];
},{"./Defaults":1,"./EventStream":2,"babel-polyfill":4,"superagent":233,"superagent-prefix":232}],4:[function(require,module,exports){
(function (global){
...
},{"babel-regenerator-runtime":5,"core-js/shim":192}],5:[function(require,module,exports){
...
"use strict";var toObject=require("./$.to-object"),toIndex=require("./$.to-index"),toLength=require("./$.to-length");module.exports=[].copyWithin||function(t,e){var o=toObject(this),n=toLength(o.length),i=toIndex(t,n),r=toIndex(e,n),d=arguments,h=d.length>2?d[2]:void 0,u=Math.min((void 0===h?n:toIndex(h,n))-r,n-i),c=1;for(i>r&&r+u>i&&(c=-1,r+=u-1,i+=u-1);u-- >0;)r in o?o[i]=o[r]:delete o[i],i+=c,r+=c;return o};
...
var $export=require("./$.export"),abs=Math.abs;$export($export.S,"Math",{hypot:function(r,t){for(var a,e,o=0,h=0,p=arguments,n=p.length,s=0;n>h;)a=abs(p[h++]),a>s?(e=s/a,o=o*e*e+1,s=a):a>0?(e=a/s,o+=e*e):o+=a;return s===1/0?1/0:s*Math.sqrt(o)}});
...
function get(e,t){var r,i,o=arguments.length<3?e:arguments[2];return anObject(e)===o?e[t]:(r=$.getDesc(e,t))?has(r,"value")?r.value:void 0!==r.get?r.get.call(o):void 0:isObject(i=$.getProto(e))?get(i,t,o):void 0}var $=require("./$"),has=require("./$.has"),$export=require("./$.export"),isObject=require("./$.is-object"),anObject=require("./$.an-object");$export($export.S,"Reflect",{get:get});
...
var $export=require("./$.export"),toIObject=require("./$.to-iobject"),toLength=require("./$.to-length");$export($export.S,"String",{raw:function(t){for(var r=toIObject(t.raw),e=toLength(r.length),o=arguments,n=o.length,i=[],g=0;e>g;)i.push(String(r[g++])),n>g&&i.push(String(o[g]));return i.join("")}});
...
},{"base64-js":195,"ieee754":196,"isarray":197}],195:[function(require,module,exports){
...
},{"./decode":204,"./encode":205}],207:[function(require,module,exports){
...
},{"./_stream_readable":210,"./_stream_writable":212,"core-util-is":213,"inherits":199,"process-nextick-args":214}],209:[function(require,module,exports){
...
},{"./_stream_transform":211,"core-util-is":213,"inherits":199}],210:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":208,"_process":202,"buffer":194,"core-util-is":213,"events":198,"inherits":199,"isarray":201,"process-nextick-args":214,"stream":220,"string_decoder/":221,"util":193}],211:[function(require,module,exports){
...
},{"./_stream_duplex":208,"core-util-is":213,"inherits":199}],212:[function(require,module,exports){
...
},{"./_stream_duplex":208,"buffer":194,"core-util-is":213,"events":198,"inherits":199,"process-nextick-args":214,"stream":220,"util-deprecate":215}],213:[function(require,module,exports){
(function (Buffer){
...
},{"../../../../insert-module-globals/node_modules/is-buffer/index.js":200}],214:[function(require,module,exports){
(function (process){
...
},{"_process":202}],215:[function(require,module,exports){
(function (global){
...
},{"./lib/_stream_passthrough.js":209}],217:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":208,"./lib/_stream_passthrough.js":209,"./lib/_stream_readable.js":210,"./lib/_stream_transform.js":211,"./lib/_stream_writable.js":212,"stream":220}],218:[function(require,module,exports){
module.exports=require("./lib/_stream_transform.js");
},{"./lib/_stream_transform.js":211}],219:[function(require,module,exports){
...
},{"events":198,"inherits":199,"readable-stream/duplex.js":207,"readable-stream/passthrough.js":216,"readable-stream/readable.js":217,"readable-stream/transform.js":218,"readable-stream/writable.js":219}],221:[function(require,module,exports){
...
},{"buffer":194}],222:[function(require,module,exports){
...
},{"./util":223,"punycode":203,"querystring":206}],223:[function(require,module,exports){
...
},{"./lib/request":226,"builtin-status-codes":228,"url":222,"xtend":231}],225:[function(require,module,exports){
(function (global){
...
},{"./capability":225,"_process":202,"buffer":194,"inherits":229,"stream":220}],228:[function(require,module,exports){
...
},{"dup":199}],230:[function(require,module,exports){
...
},{"buffer":194}],231:[function(require,module,exports){
...
},{"emitter":234,"reduce":235}],234:[function(require,module,exports){
