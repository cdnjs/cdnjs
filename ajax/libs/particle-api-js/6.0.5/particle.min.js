...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _assign=require("babel-runtime/core-js/object/assign"),_assign2=_interopRequireDefault(_assign),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_Particle=require("./Particle"),_Particle2=_interopRequireDefault(_Particle),_Library=require("./Library"),_Library2=_interopRequireDefault(_Library),Client=function(){function e(r){var a=r.auth,t=r.api,i=void 0===t?new _Particle2.default:t;(0,_classCallCheck3.default)(this,e),(0,_assign2.default)(this,{auth:a,api:i})}return(0,_createClass3.default)(e,[{key:"libraries",value:function(){var e=this,r=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return this.api.listLibraries((0,_assign2.default)({},r,{auth:this.auth})).then(function(r){var a=r.body.data||[];return a.map(function(r){return new _Library2.default(e,r)})})}},{key:"library",value:function(e){var r=this,a=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return this.api.getLibrary((0,_assign2.default)({},a,{name:e,auth:this.auth})).then(function(e){var a=e.body.data||{};return new _Library2.default(r,a)})}},{key:"publishLibrary",value:function(e){var r=this;return this.api.publishLibrary({archive:e,auth:this.auth}).then(function(e){var a=e.body.data||{};return new _Library2.default(r,a)},function(e){if(e.body&&e.body.errors){var r=e.body.errors.map(function(e){return e.message}).join("\n");throw new Error(r)}throw e})}},{key:"downloadFile",value:function(e){return this.api.downloadFile({url:e})}},{key:"compileCode",value:function(e,r,a){return this.api.compileCode({files:e,platformId:r,targetVersion:a,auth:this.auth})}}]),e}();exports.default=Client,module.exports=exports.default;
