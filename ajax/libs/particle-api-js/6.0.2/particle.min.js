...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _keys=require("babel-runtime/core-js/object/keys"),_keys2=_interopRequireDefault(_keys),_slicedToArray2=require("babel-runtime/helpers/slicedToArray"),_slicedToArray3=_interopRequireDefault(_slicedToArray2),_entries=require("babel-runtime/core-js/object/entries"),_entries2=_interopRequireDefault(_entries),_getIterator2=require("babel-runtime/core-js/get-iterator"),_getIterator3=_interopRequireDefault(_getIterator2),_assign=require("babel-runtime/core-js/object/assign"),_assign2=_interopRequireDefault(_assign),_promise=require("babel-runtime/core-js/promise"),_promise2=_interopRequireDefault(_promise),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_superagent=require("superagent"),_superagent2=_interopRequireDefault(_superagent),_superagentPrefix=require("superagent-prefix"),_superagentPrefix2=_interopRequireDefault(_superagentPrefix),Agent=function(){function e(r){(0,_classCallCheck3.default)(this,e),this.prefix=(0,_superagentPrefix2.default)(r)}return(0,_createClass3.default)(e,[{key:"get",value:function(e,r,t){return this.request({uri:e,auth:r,method:"get",query:t})}},{key:"head",value:function(e,r){return this.request({uri:e,auth:r,method:"head"})}},{key:"post",value:function(e,r,t){return this.request({uri:e,data:r,auth:t,method:"post"})}},{key:"put",value:function(e,r,t){return this.request({uri:e,data:r,auth:t,method:"put"})}},{key:"delete",value:function(e,r,t){return this.request({uri:e,data:r,auth:t,method:"delete"})}},{key:"request",value:function(e){var r=e.uri,t=e.method,u=e.data,a=void 0===u?void 0:u,i=e.auth,s=e.query,o=void 0===s?void 0:s,n=e.form,l=void 0===n?void 0:n,d=e.files,f=void 0===d?void 0:d,_=this._sanitizeFiles(f);return this._request({uri:r,method:t,data:a,auth:i,query:o,form:l,files:_})}},{key:"_request",value:function(e){var r=e.uri,t=e.method,u=e.data,a=e.auth,i=e.query,s=e.form,o=e.files,n=this._buildRequest({uri:r,method:t,data:u,auth:a,query:i,form:s,files:o});return this._promiseResponse(n)}},{key:"_promiseResponse",value:function(e){var r=this;return new _promise2.default(function(t,u){return r._sendRequest(e,t,u)})}},{key:"_sendRequest",value:function(e,r,t){e.end(function(u,a){var i=a&&a.body;if(u){var s=e.url,o=u.status,n=(o?"HTTP error "+o:"Network error")+" from "+s;i&&i.error_description&&(n+=" - "+i.error_description);var l=new Error(n);(0,_assign2.default)(l,{statusCode:o,errorDescription:n,error:u,body:i}),t(l)}else r({body:i,statusCode:a.statusCode})})}},{key:"_buildRequest",value:function(e){var r=e.uri,t=e.method,u=e.data,a=e.auth,i=e.query,s=e.form,o=e.files,n=e.makerequest,l=void 0===n?_superagent2.default:n,d=l(t,r);if(this.prefix&&d.use(this.prefix),this._authorizationHeader(d,a),i&&d.query(i),o){var f=!0,_=!1,c=void 0;try{for(var h,p=(0,_getIterator3.default)((0,_entries2.default)(o));!(f=(h=p.next()).done);f=!0){var v=(0,_slicedToArray3.default)(h.value,2),y=v[0],q=v[1];d.attach(y,q.data,q.path)}}catch(e){_=!0,c=e}finally{try{!f&&p.return&&p.return()}finally{if(_)throw c}}if(s){var m=!0,b=!1,g=void 0;try{for(var k,C=(0,_getIterator3.default)((0,_entries2.default)(s));!(m=(k=C.next()).done);m=!0){var R=(0,_slicedToArray3.default)(k.value,2),y=R[0],x=R[1];d.field(y,x)}}catch(e){b=!0,g=e}finally{try{!m&&C.return&&C.return()}finally{if(b)throw g}}}}else s?(d.type("form"),d.send(s)):u&&d.send(u);return d}},{key:"_authorizationHeader",value:function(e,r){return r&&(void 0!==r.username?e.auth(r.username,r.password):e.set({Authorization:"Bearer "+r})),e}},{key:"_sanitizeFiles",value:function(e){var r=void 0;return e&&(r={},(0,_keys2.default)(e).forEach(function(t,u){var a=u?"file"+(u+1):"file";r[a]={data:e[t],path:t}})),r}}]),e}();exports.default=Agent,module.exports=exports.default;
},{"babel-runtime/core-js/get-iterator":8,"babel-runtime/core-js/object/assign":11,"babel-runtime/core-js/object/entries":14,"babel-runtime/core-js/object/keys":16,"babel-runtime/core-js/promise":18,"babel-runtime/helpers/classCallCheck":21,"babel-runtime/helpers/createClass":22,"babel-runtime/helpers/slicedToArray":25,"superagent":166,"superagent-prefix":165}],2:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _assign=require("babel-runtime/core-js/object/assign"),_assign2=_interopRequireDefault(_assign),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_Particle=require("./Particle"),_Particle2=_interopRequireDefault(_Particle),_Library=require("./Library"),_Library2=_interopRequireDefault(_Library),Client=function(){function e(a){var r=a.auth,t=a.api,i=void 0===t?new _Particle2.default:t;(0,_classCallCheck3.default)(this,e),(0,_assign2.default)(this,{auth:r,api:i})}return(0,_createClass3.default)(e,[{key:"libraries",value:function(){var e=this,a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return this.api.listLibraries((0,_assign2.default)({},a,{auth:this.auth})).then(function(a){var r=a.body.data||[];return r.map(function(a){return new _Library2.default(e,a)})})}},{key:"library",value:function(e){var a=this,r=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return this.api.getLibrary((0,_assign2.default)({},r,{name:e,auth:this.auth})).then(function(e){var r=e.body.data||{};return new _Library2.default(a,r)})}},{key:"downloadFile",value:function(e){return this.api.downloadFile({url:e})}},{key:"compileCode",value:function(e,a,r){return this.api.compileCode({files:e,platformId:a,targetVersion:r})}}]),e}();exports.default=Client,module.exports=exports.default;
...
},{"babel-runtime/core-js/number/is-nan":10,"babel-runtime/core-js/object/assign":11,"babel-runtime/core-js/object/get-prototype-of":15,"babel-runtime/core-js/promise":18,"babel-runtime/helpers/classCallCheck":21,"babel-runtime/helpers/createClass":22,"babel-runtime/helpers/inherits":23,"babel-runtime/helpers/possibleConstructorReturn":24,"babel-runtime/helpers/typeof":26,"events":138,"http":160,"https":160,"url":171}],5:[function(require,module,exports){
...
},{"./Agent":1,"./Client":2,"./Defaults":3,"./EventStream":4,"./superagent-binary-parser":7,"babel-runtime/core-js/object/assign":11,"babel-runtime/helpers/classCallCheck":21,"babel-runtime/helpers/createClass":22,"superagent":166}],7:[function(require,module,exports){
(function (Buffer){
...
},{"./_stream_readable":152,"./_stream_writable":154,"core-util-is":137,"inherits":140,"process-nextick-args":143}],151:[function(require,module,exports){
...
},{"./_stream_transform":153,"core-util-is":137,"inherits":140}],152:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":150,"_process":144,"buffer":30,"buffer-shims":29,"core-util-is":137,"events":138,"inherits":140,"isarray":142,"process-nextick-args":143,"stream":159,"string_decoder/":164,"util":28}],153:[function(require,module,exports){
...
},{"./_stream_duplex":150,"core-util-is":137,"inherits":140}],154:[function(require,module,exports){
(function (process){
...
},{"./_stream_duplex":150,"_process":144,"buffer":30,"buffer-shims":29,"core-util-is":137,"events":138,"inherits":140,"process-nextick-args":143,"stream":159,"util-deprecate":173}],155:[function(require,module,exports){
...
},{"./lib/_stream_duplex.js":150,"./lib/_stream_passthrough.js":151,"./lib/_stream_readable.js":152,"./lib/_stream_transform.js":153,"./lib/_stream_writable.js":154,"_process":144,"stream":159}],157:[function(require,module,exports){
...
},{"events":138,"inherits":140,"readable-stream/duplex.js":149,"readable-stream/passthrough.js":155,"readable-stream/readable.js":156,"readable-stream/transform.js":157,"readable-stream/writable.js":158}],160:[function(require,module,exports){
(function (global){
...
},{"./lib/request":162,"builtin-status-codes":31,"url":171,"xtend":174}],161:[function(require,module,exports){
(function (global){
...
},{"./capability":161,"./response":163,"_process":144,"buffer":30,"inherits":140,"stream":159,"to-arraybuffer":170}],163:[function(require,module,exports){
(function (process,global,Buffer){
...
},{"./capability":161,"_process":144,"buffer":30,"inherits":140,"stream":159}],164:[function(require,module,exports){
...
},{"buffer":30}],165:[function(require,module,exports){
...
},{"./is-object":167,"./request":169,"./request-base":168,"emitter":32}],167:[function(require,module,exports){
...
},{"./is-object":167}],169:[function(require,module,exports){
...
},{"./util":172,"punycode":145,"querystring":148}],172:[function(require,module,exports){
