...
var F0 = (e) => {
  ...
  "NonZeroMessageOutputRecipient",
  "ZeroedMessageOutputRecipient"
], gB = "https://docs.rs/fuel-asm/latest/fuel_asm/enum.PanicReason.html", gA, pB = typeof process < "u" && ((gA = process == null ? void 0 : process.env) == null ? void 0 : gA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/graphql", mB = "https://beta-5.fuel.network/graphql";
export {
  Sr as ASSET_ID_LEN,
