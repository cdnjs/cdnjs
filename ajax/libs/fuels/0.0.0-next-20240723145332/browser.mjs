...
var D = (e, t, n) => fd(e, typeof t != "symbol" ? t + "" : t, n), ri = (e, t, n) => t.has(e) || Ko("Cannot " + n);
var Fe = (e, t, n) => (ri(e, t, "read from private field"), n ? n.call(e) : t.get(e)), Rt = (e, t, n) => t.has(e) ? Ko("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), Ot = (e, t, n, r) => (ri(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n), Ur = (e, t, n) => (ri(e, t, "access private method"), n);
function Sc() {
  return {
    FORC: "0.62.0",
    FUEL_CORE: "0.31.0",
...
(function(e) {
  (function(t, n) {
    ...
    var z = function(a, u, l) {
      ...
      I = (m + (d >>> 13) | 0) + (ks >>> 26) | 0, ks &= 67108863, g = Math.imul(re, Ze), d = Math.imul(re, We), d = d + Math.imul(se, Ze) | 0, m = Math.imul(se, We), g = g + Math.imul(W, Je) | 0, d = d + Math.imul(W, qe) | 0, d = d + Math.imul(K, Je) | 0, m = m + Math.imul(K, qe) | 0;
      var Ps = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ps >>> 26) | 0, Ps &= 67108863, g = Math.imul(fe, Ze), d = Math.imul(fe, We), d = d + Math.imul(oe, Ze) | 0, m = Math.imul(oe, We), g = g + Math.imul(re, Je) | 0, d = d + Math.imul(re, qe) | 0, d = d + Math.imul(se, Je) | 0, m = m + Math.imul(se, qe) | 0, g = g + Math.imul(W, je) | 0, d = d + Math.imul(W, $e) | 0, d = d + Math.imul(K, je) | 0, m = m + Math.imul(K, $e) | 0;
      var Us = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Us >>> 26) | 0, Us &= 67108863, g = Math.imul(Ae, Ze), d = Math.imul(Ae, We), d = d + Math.imul(he, Ze) | 0, m = Math.imul(he, We), g = g + Math.imul(fe, Je) | 0, d = d + Math.imul(fe, qe) | 0, d = d + Math.imul(oe, Je) | 0, m = m + Math.imul(oe, qe) | 0, g = g + Math.imul(re, je) | 0, d = d + Math.imul(re, $e) | 0, d = d + Math.imul(se, je) | 0, m = m + Math.imul(se, $e) | 0, g = g + Math.imul(W, Ke) | 0, d = d + Math.imul(W, et) | 0, d = d + Math.imul(K, Ke) | 0, m = m + Math.imul(K, et) | 0;
      var Gs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Gs >>> 26) | 0, Gs &= 67108863, g = Math.imul(ve, Ze), d = Math.imul(ve, We), d = d + Math.imul(ye, Ze) | 0, m = Math.imul(ye, We), g = g + Math.imul(Ae, Je) | 0, d = d + Math.imul(Ae, qe) | 0, d = d + Math.imul(he, Je) | 0, m = m + Math.imul(he, qe) | 0, g = g + Math.imul(fe, je) | 0, d = d + Math.imul(fe, $e) | 0, d = d + Math.imul(oe, je) | 0, m = m + Math.imul(oe, $e) | 0, g = g + Math.imul(re, Ke) | 0, d = d + Math.imul(re, et) | 0, d = d + Math.imul(se, Ke) | 0, m = m + Math.imul(se, et) | 0, g = g + Math.imul(W, tt) | 0, d = d + Math.imul(W, nt) | 0, d = d + Math.imul(K, tt) | 0, m = m + Math.imul(K, nt) | 0;
      ...
      I = (m + (d >>> 13) | 0) + (Hs >>> 26) | 0, Hs &= 67108863, g = Math.imul(Pe, Ze), d = Math.imul(Pe, We), d = d + Math.imul(Ue, Ze) | 0, m = Math.imul(Ue, We), g = g + Math.imul(Qe, Je) | 0, d = d + Math.imul(Qe, qe) | 0, d = d + Math.imul(Te, Je) | 0, m = m + Math.imul(Te, qe) | 0, g = g + Math.imul(ve, je) | 0, d = d + Math.imul(ve, $e) | 0, d = d + Math.imul(ye, je) | 0, m = m + Math.imul(ye, $e) | 0, g = g + Math.imul(Ae, Ke) | 0, d = d + Math.imul(Ae, et) | 0, d = d + Math.imul(he, Ke) | 0, m = m + Math.imul(he, et) | 0, g = g + Math.imul(fe, tt) | 0, d = d + Math.imul(fe, nt) | 0, d = d + Math.imul(oe, tt) | 0, m = m + Math.imul(oe, nt) | 0, g = g + Math.imul(re, rt) | 0, d = d + Math.imul(re, st) | 0, d = d + Math.imul(se, rt) | 0, m = m + Math.imul(se, st) | 0, g = g + Math.imul(W, it) | 0, d = d + Math.imul(W, ot) | 0, d = d + Math.imul(K, it) | 0, m = m + Math.imul(K, ot) | 0;
      var Xs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Xs >>> 26) | 0, Xs &= 67108863, g = Math.imul(Ge, Ze), d = Math.imul(Ge, We), d = d + Math.imul(ze, Ze) | 0, m = Math.imul(ze, We), g = g + Math.imul(Pe, Je) | 0, d = d + Math.imul(Pe, qe) | 0, d = d + Math.imul(Ue, Je) | 0, m = m + Math.imul(Ue, qe) | 0, g = g + Math.imul(Qe, je) | 0, d = d + Math.imul(Qe, $e) | 0, d = d + Math.imul(Te, je) | 0, m = m + Math.imul(Te, $e) | 0, g = g + Math.imul(ve, Ke) | 0, d = d + Math.imul(ve, et) | 0, d = d + Math.imul(ye, Ke) | 0, m = m + Math.imul(ye, et) | 0, g = g + Math.imul(Ae, tt) | 0, d = d + Math.imul(Ae, nt) | 0, d = d + Math.imul(he, tt) | 0, m = m + Math.imul(he, nt) | 0, g = g + Math.imul(fe, rt) | 0, d = d + Math.imul(fe, st) | 0, d = d + Math.imul(oe, rt) | 0, m = m + Math.imul(oe, st) | 0, g = g + Math.imul(re, it) | 0, d = d + Math.imul(re, ot) | 0, d = d + Math.imul(se, it) | 0, m = m + Math.imul(se, ot) | 0, g = g + Math.imul(W, at) | 0, d = d + Math.imul(W, ct) | 0, d = d + Math.imul(K, at) | 0, m = m + Math.imul(K, ct) | 0;
      var Vs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Vs >>> 26) | 0, Vs &= 67108863, g = Math.imul(He, Ze), d = Math.imul(He, We), d = d + Math.imul(Xe, Ze) | 0, m = Math.imul(Xe, We), g = g + Math.imul(Ge, Je) | 0, d = d + Math.imul(Ge, qe) | 0, d = d + Math.imul(ze, Je) | 0, m = m + Math.imul(ze, qe) | 0, g = g + Math.imul(Pe, je) | 0, d = d + Math.imul(Pe, $e) | 0, d = d + Math.imul(Ue, je) | 0, m = m + Math.imul(Ue, $e) | 0, g = g + Math.imul(Qe, Ke) | 0, d = d + Math.imul(Qe, et) | 0, d = d + Math.imul(Te, Ke) | 0, m = m + Math.imul(Te, et) | 0, g = g + Math.imul(ve, tt) | 0, d = d + Math.imul(ve, nt) | 0, d = d + Math.imul(ye, tt) | 0, m = m + Math.imul(ye, nt) | 0, g = g + Math.imul(Ae, rt) | 0, d = d + Math.imul(Ae, st) | 0, d = d + Math.imul(he, rt) | 0, m = m + Math.imul(he, st) | 0, g = g + Math.imul(fe, it) | 0, d = d + Math.imul(fe, ot) | 0, d = d + Math.imul(oe, it) | 0, m = m + Math.imul(oe, ot) | 0, g = g + Math.imul(re, at) | 0, d = d + Math.imul(re, ct) | 0, d = d + Math.imul(se, at) | 0, m = m + Math.imul(se, ct) | 0, g = g + Math.imul(W, ut) | 0, d = d + Math.imul(W, dt) | 0, d = d + Math.imul(K, ut) | 0, m = m + Math.imul(K, dt) | 0;
      var Ys = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ys >>> 26) | 0, Ys &= 67108863, g = Math.imul(Ve, Ze), d = Math.imul(Ve, We), d = d + Math.imul(Ye, Ze) | 0, m = Math.imul(Ye, We), g = g + Math.imul(He, Je) | 0, d = d + Math.imul(He, qe) | 0, d = d + Math.imul(Xe, Je) | 0, m = m + Math.imul(Xe, qe) | 0, g = g + Math.imul(Ge, je) | 0, d = d + Math.imul(Ge, $e) | 0, d = d + Math.imul(ze, je) | 0, m = m + Math.imul(ze, $e) | 0, g = g + Math.imul(Pe, Ke) | 0, d = d + Math.imul(Pe, et) | 0, d = d + Math.imul(Ue, Ke) | 0, m = m + Math.imul(Ue, et) | 0, g = g + Math.imul(Qe, tt) | 0, d = d + Math.imul(Qe, nt) | 0, d = d + Math.imul(Te, tt) | 0, m = m + Math.imul(Te, nt) | 0, g = g + Math.imul(ve, rt) | 0, d = d + Math.imul(ve, st) | 0, d = d + Math.imul(ye, rt) | 0, m = m + Math.imul(ye, st) | 0, g = g + Math.imul(Ae, it) | 0, d = d + Math.imul(Ae, ot) | 0, d = d + Math.imul(he, it) | 0, m = m + Math.imul(he, ot) | 0, g = g + Math.imul(fe, at) | 0, d = d + Math.imul(fe, ct) | 0, d = d + Math.imul(oe, at) | 0, m = m + Math.imul(oe, ct) | 0, g = g + Math.imul(re, ut) | 0, d = d + Math.imul(re, dt) | 0, d = d + Math.imul(se, ut) | 0, m = m + Math.imul(se, dt) | 0, g = g + Math.imul(W, At) | 0, d = d + Math.imul(W, lt) | 0, d = d + Math.imul(K, At) | 0, m = m + Math.imul(K, lt) | 0;
      var Zs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Zs >>> 26) | 0, Zs &= 67108863, g = Math.imul(Ve, Je), d = Math.imul(Ve, qe), d = d + Math.imul(Ye, Je) | 0, m = Math.imul(Ye, qe), g = g + Math.imul(He, je) | 0, d = d + Math.imul(He, $e) | 0, d = d + Math.imul(Xe, je) | 0, m = m + Math.imul(Xe, $e) | 0, g = g + Math.imul(Ge, Ke) | 0, d = d + Math.imul(Ge, et) | 0, d = d + Math.imul(ze, Ke) | 0, m = m + Math.imul(ze, et) | 0, g = g + Math.imul(Pe, tt) | 0, d = d + Math.imul(Pe, nt) | 0, d = d + Math.imul(Ue, tt) | 0, m = m + Math.imul(Ue, nt) | 0, g = g + Math.imul(Qe, rt) | 0, d = d + Math.imul(Qe, st) | 0, d = d + Math.imul(Te, rt) | 0, m = m + Math.imul(Te, st) | 0, g = g + Math.imul(ve, it) | 0, d = d + Math.imul(ve, ot) | 0, d = d + Math.imul(ye, it) | 0, m = m + Math.imul(ye, ot) | 0, g = g + Math.imul(Ae, at) | 0, d = d + Math.imul(Ae, ct) | 0, d = d + Math.imul(he, at) | 0, m = m + Math.imul(he, ct) | 0, g = g + Math.imul(fe, ut) | 0, d = d + Math.imul(fe, dt) | 0, d = d + Math.imul(oe, ut) | 0, m = m + Math.imul(oe, dt) | 0, g = g + Math.imul(re, At) | 0, d = d + Math.imul(re, lt) | 0, d = d + Math.imul(se, At) | 0, m = m + Math.imul(se, lt) | 0;
      var Ws = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ws >>> 26) | 0, Ws &= 67108863, g = Math.imul(Ve, je), d = Math.imul(Ve, $e), d = d + Math.imul(Ye, je) | 0, m = Math.imul(Ye, $e), g = g + Math.imul(He, Ke) | 0, d = d + Math.imul(He, et) | 0, d = d + Math.imul(Xe, Ke) | 0, m = m + Math.imul(Xe, et) | 0, g = g + Math.imul(Ge, tt) | 0, d = d + Math.imul(Ge, nt) | 0, d = d + Math.imul(ze, tt) | 0, m = m + Math.imul(ze, nt) | 0, g = g + Math.imul(Pe, rt) | 0, d = d + Math.imul(Pe, st) | 0, d = d + Math.imul(Ue, rt) | 0, m = m + Math.imul(Ue, st) | 0, g = g + Math.imul(Qe, it) | 0, d = d + Math.imul(Qe, ot) | 0, d = d + Math.imul(Te, it) | 0, m = m + Math.imul(Te, ot) | 0, g = g + Math.imul(ve, at) | 0, d = d + Math.imul(ve, ct) | 0, d = d + Math.imul(ye, at) | 0, m = m + Math.imul(ye, ct) | 0, g = g + Math.imul(Ae, ut) | 0, d = d + Math.imul(Ae, dt) | 0, d = d + Math.imul(he, ut) | 0, m = m + Math.imul(he, dt) | 0, g = g + Math.imul(fe, At) | 0, d = d + Math.imul(fe, lt) | 0, d = d + Math.imul(oe, At) | 0, m = m + Math.imul(oe, lt) | 0;
      var Js = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Js >>> 26) | 0, Js &= 67108863, g = Math.imul(Ve, Ke), d = Math.imul(Ve, et), d = d + Math.imul(Ye, Ke) | 0, m = Math.imul(Ye, et), g = g + Math.imul(He, tt) | 0, d = d + Math.imul(He, nt) | 0, d = d + Math.imul(Xe, tt) | 0, m = m + Math.imul(Xe, nt) | 0, g = g + Math.imul(Ge, rt) | 0, d = d + Math.imul(Ge, st) | 0, d = d + Math.imul(ze, rt) | 0, m = m + Math.imul(ze, st) | 0, g = g + Math.imul(Pe, it) | 0, d = d + Math.imul(Pe, ot) | 0, d = d + Math.imul(Ue, it) | 0, m = m + Math.imul(Ue, ot) | 0, g = g + Math.imul(Qe, at) | 0, d = d + Math.imul(Qe, ct) | 0, d = d + Math.imul(Te, at) | 0, m = m + Math.imul(Te, ct) | 0, g = g + Math.imul(ve, ut) | 0, d = d + Math.imul(ve, dt) | 0, d = d + Math.imul(ye, ut) | 0, m = m + Math.imul(ye, dt) | 0, g = g + Math.imul(Ae, At) | 0, d = d + Math.imul(Ae, lt) | 0, d = d + Math.imul(he, At) | 0, m = m + Math.imul(he, lt) | 0;
      var qs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (qs >>> 26) | 0, qs &= 67108863, g = Math.imul(Ve, tt), d = Math.imul(Ve, nt), d = d + Math.imul(Ye, tt) | 0, m = Math.imul(Ye, nt), g = g + Math.imul(He, rt) | 0, d = d + Math.imul(He, st) | 0, d = d + Math.imul(Xe, rt) | 0, m = m + Math.imul(Xe, st) | 0, g = g + Math.imul(Ge, it) | 0, d = d + Math.imul(Ge, ot) | 0, d = d + Math.imul(ze, it) | 0, m = m + Math.imul(ze, ot) | 0, g = g + Math.imul(Pe, at) | 0, d = d + Math.imul(Pe, ct) | 0, d = d + Math.imul(Ue, at) | 0, m = m + Math.imul(Ue, ct) | 0, g = g + Math.imul(Qe, ut) | 0, d = d + Math.imul(Qe, dt) | 0, d = d + Math.imul(Te, ut) | 0, m = m + Math.imul(Te, dt) | 0, g = g + Math.imul(ve, At) | 0, d = d + Math.imul(ve, lt) | 0, d = d + Math.imul(ye, At) | 0, m = m + Math.imul(ye, lt) | 0;
      var js = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (js >>> 26) | 0, js &= 67108863, g = Math.imul(Ve, rt), d = Math.imul(Ve, st), d = d + Math.imul(Ye, rt) | 0, m = Math.imul(Ye, st), g = g + Math.imul(He, it) | 0, d = d + Math.imul(He, ot) | 0, d = d + Math.imul(Xe, it) | 0, m = m + Math.imul(Xe, ot) | 0, g = g + Math.imul(Ge, at) | 0, d = d + Math.imul(Ge, ct) | 0, d = d + Math.imul(ze, at) | 0, m = m + Math.imul(ze, ct) | 0, g = g + Math.imul(Pe, ut) | 0, d = d + Math.imul(Pe, dt) | 0, d = d + Math.imul(Ue, ut) | 0, m = m + Math.imul(Ue, dt) | 0, g = g + Math.imul(Qe, At) | 0, d = d + Math.imul(Qe, lt) | 0, d = d + Math.imul(Te, At) | 0, m = m + Math.imul(Te, lt) | 0;
      var $s = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + ($s >>> 26) | 0, $s &= 67108863, g = Math.imul(Ve, it), d = Math.imul(Ve, ot), d = d + Math.imul(Ye, it) | 0, m = Math.imul(Ye, ot), g = g + Math.imul(He, at) | 0, d = d + Math.imul(He, ct) | 0, d = d + Math.imul(Xe, at) | 0, m = m + Math.imul(Xe, ct) | 0, g = g + Math.imul(Ge, ut) | 0, d = d + Math.imul(Ge, dt) | 0, d = d + Math.imul(ze, ut) | 0, m = m + Math.imul(ze, dt) | 0, g = g + Math.imul(Pe, At) | 0, d = d + Math.imul(Pe, lt) | 0, d = d + Math.imul(Ue, At) | 0, m = m + Math.imul(Ue, lt) | 0;
      var Ks = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ks >>> 26) | 0, Ks &= 67108863, g = Math.imul(Ve, at), d = Math.imul(Ve, ct), d = d + Math.imul(Ye, at) | 0, m = Math.imul(Ye, ct), g = g + Math.imul(He, ut) | 0, d = d + Math.imul(He, dt) | 0, d = d + Math.imul(Xe, ut) | 0, m = m + Math.imul(Xe, dt) | 0, g = g + Math.imul(Ge, At) | 0, d = d + Math.imul(Ge, lt) | 0, d = d + Math.imul(ze, At) | 0, m = m + Math.imul(ze, lt) | 0;
      var ei = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (ei >>> 26) | 0, ei &= 67108863, g = Math.imul(Ve, ut), d = Math.imul(Ve, dt), d = d + Math.imul(Ye, ut) | 0, m = Math.imul(Ye, dt), g = g + Math.imul(He, At) | 0, d = d + Math.imul(He, lt) | 0, d = d + Math.imul(Xe, At) | 0, m = m + Math.imul(Xe, lt) | 0;
      var ti = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (ti >>> 26) | 0, ti &= 67108863, g = Math.imul(Ve, At), d = Math.imul(Ve, lt), d = d + Math.imul(Ye, At) | 0, m = Math.imul(Ye, lt);
      var ni = (I + g | 0) + ((d & 8191) << 13) | 0;
      return I = (m + (d >>> 13) | 0) + (ni >>> 26) | 0, ni &= 67108863, y[0] = ks, y[1] = Ps, y[2] = Us, y[3] = Gs, y[4] = zs, y[5] = Hs, y[6] = Xs, y[7] = Vs, y[8] = Ys, y[9] = Zs, y[10] = Ws, y[11] = Js, y[12] = qs, y[13] = js, y[14] = $s, y[15] = Ks, y[16] = ei, y[17] = ti, y[18] = ni, I !== 0 && (y[19] = I, l.length++), l;
    };
    Math.imul || (z = T);
    function k(b, a, u) {
...
var Mc = B(0), Ii = B(58), ds = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz", zr = null;
function Ud(e) {
  if (zr == null) {
    zr = {};
...
function Gd(e) {
  ...
  for (let n = 0; n < e.length; n++)
    t = t.mul(Ii), t = t.add(Ud(e[n].toString()));
  return t;
}
function ji(e, t, n) {
  const r = X(e);
...
const iA = (e, t) => BigInt(e >>> 0) << Ei | BigInt(t >>> 0), oA = (e, t, n) => e >>> n, aA = (e, t, n) => e << 32 - n | t >>> n, cA = (e, t, n) => e >>> n | t << 32 - n, uA = (e, t, n) => e << 32 - n | t >>> n, dA = (e, t, n) => e << 64 - n | t >>> n - 32, AA = (e, t, n) => e >>> n - 32 | t << 64 - n, lA = (e, t) => t, fA = (e, t) => e, Hc = (e, t, n) => e << n | t >>> 32 - n, Xc = (e, t, n) => t << n | e >>> 32 - n, Vc = (e, t, n) => t << n - 32 | e >>> 64 - n, Yc = (e, t, n) => e << n - 32 | t >>> 64 - n;
function hA(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
const SA = (e, t, n) => Bs(() => new so(t, e, n)), QA = /* @__PURE__ */ SA(1, 136, 256 / 8), NA = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), qc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), DA = /* @__PURE__ */ qc.map((e) => (9 * e + 5) % 16);
let io = [qc], oo = [DA];
for (let e = 0; e < 4; e++)
  for (let t of [io, oo])
...
const kA = /* @__PURE__ */ Bs(() => new LA()), [PA, UA] = le.split([
  "0x428a2f98d728ae22",
  "0x7137449123ef65cd",
  "0xb5c0fbcfec4d3b2f",
  "0xe9b5dba58189dbbc",
...
var bi = (e) => xs.getRandomValues(new Uint8Array(e)), ts = (e, t = "base64") => {
  switch (t) {
    case "utf-8":
  ...
  const n = bi(16), r = bi(32), s = ao(e, r), i = JSON.stringify(t), o = Gn(i, "utf-8"), c = {
    name: s0,
    counter: n,
    length: 64
...
}, al = "u8", cl = "u16", ul = "u32", dl = "u64", Al = "u256", ll = "raw untyped ptr", fl = "raw untyped slice", hl = "bool", gl = "b256", pl = "struct B512", Jn = "enum Option", ml = "struct Vec", wl = "struct Bytes", yl = "struct String", Il = "str", c0 = /str\[(?<length>[0-9]+)\]/, Ci = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, u0 = /^struct (?<name>\w+)$/, d0 = /^enum (?<name>\w+)$/, El = /^\((?<items>.*)\)$/, bl = /^generic (?<name>\w+)$/, As = "1", ge = 8, pn = 32, ls = pn + 2, fs = pn, Cl = pn, Bl = pn, xl = ge * 4, _l = ge * 2, A0 = 2 ** 32 - 1, l0 = ({ maxInputs: e }) => pn + // Tx ID
fs + // Base asset ID
// Asset ID/Balance coin input pairs
e * (fs + ge) + ge, f0 = ge + // Identifier
ge + // Gas limit
ge + // Script size
ge + // Script data size
ge + // Policies
...
var Dl = class extends ce {
  ...
  getArgSignaturePrefix() {
    return u0.test(this.type) ? "s" : Ci.test(this.type) ? "a" : d0.test(this.type) ? "e" : "";
  }
...
const hs = "qpzry9x8gf2tvdw0s3jn54khce6mua7l", x0 = {};
...
}, ln = new WeakMap(), _c), jn = class extends _s {
  constructor() {
    super("TxPointer", {
...
const Q0 = /* @__PURE__ */ BigInt(0), vs = /* @__PURE__ */ BigInt(1), ef = /* @__PURE__ */ BigInt(2);
function Tn(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
function Nr(e) {
...
function af(e, t, n) {
  return e | (n ? vs : Q0) << BigInt(t);
}
const mo = (e) => (ef << BigInt(e - 1)) - vs, ii = (e) => new Uint8Array(e), Ma = (e) => Uint8Array.from(e);
function T0(e, t, n) {
...
function Bf(e, t) {
  ...
  for (; s < r; ) {
    ...
    throw ht(
      e.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : ir(i) || Rs(n, s) ? `Unexpected character: ${Fn(e, s)}.` : `Invalid character: ${Fn(e, s)}.`
    );
  }
...
function _f(e, t, n) {
  ...
  if (i === 46 && (o = !0, i = r.charCodeAt(++s), s = ai(e, s, i), i = r.charCodeAt(s)), (i === 69 || i === 101) && (o = !0, i = r.charCodeAt(++s), (i === 43 || i === 45) && (i = r.charCodeAt(++s)), s = ai(e, s, i), i = r.charCodeAt(s)), i === 46 || k0(i))
    throw ht(
      e.source,
      s,
...
Qs.ReactNativeFile = Y0;
Qs.extractFiles = oh;
Qs.isExtractableFile = Z0;
...
var W0 = Qs, uh = ch(ah), dh = Fr, Ah = function(e) {
...
var as = /* @__PURE__ */ new Map(), Ni = /* @__PURE__ */ new Map(), q0 = !0, Is = !1;
function j0(e) {
...
function Bh(e) {
  ...
  return e.definitions.forEach(function(r) {
    if (r.kind === "FragmentDefinition") {
      var s = r.name.value, i = Ch(r.loc), o = Ni.get(s);
...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const ui = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), kt = (e, t) => e << 32 - t | e >>> t;
...
function bo(e) {
  return typeof e == "string" && (e = qh(e)), Ns(e), e;
}
function jh(...e) {
  let t = 0;
  for (let r = 0; r < e.length; r++) {
...
class su extends ru {
  ...
  digestInto(t) {
    Es(this), Ns(t, this.outputLen), this.finished = !0, this.iHash.digestInto(t), this.oHash.update(t), this.oHash.digestInto(t), this.destroy();
  }
  digest() {
    const t = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(t), t;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const gt = BigInt(0), ke = BigInt(1), _n = BigInt(2), ag = BigInt(3), Ti = BigInt(4), Ja = BigInt(5), qa = BigInt(8);
BigInt(9);
BigInt(16);
function Et(e, t) {
  const n = e % t;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const du = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), $a = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), vg = BigInt(1), Mi = BigInt(2), Ka = (e, t) => (e + t / Mi) / t;
function Rg(e) {
  const t = du, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), A = BigInt(88), h = e * e * e % t, E = h * h * e % t, w = _t(E, n, t) * E % t, x = _t(w, n, t) * E % t, _ = _t(x, Mi, t) * h % t, R = _t(_, s, t) * _ % t, C = _t(R, i, t) * R % t, M = _t(C, c, t) * C % t, T = _t(M, A, t) * M % t, z = _t(T, c, t) * C % t, k = _t(z, n, t) * E % t, J = _t(k, o, t) * R % t, O = _t(J, r, t) * h % t, F = _t(O, Mi, t);
  if (!Oi.eql(Oi.sqr(F), e))
    throw new Error("Cannot find square root");
  return F;
}
const Oi = gg(du, void 0, void 0, { sqrt: Rg }), sn = _g({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
...
Be.prototype.once = function(t, n) {
  return Ds(n), this.on(t, hu(this, t, n)), this;
};
Be.prototype.prependOnceListener = function(t, n) {
  return Ds(n), this.prependListener(t, hu(this, t, n)), this;
};
...
}, Dt = (e, t, n, r) => (Bo(e, t, "write to private field"), t.set(e, n), n), Li = (e, t, n) => (Bo(e, t, "access private method"), n), xo = (e) => {
  let t, n, r;
...
function fm(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const n = xe(e.sender), r = xe(e.recipient), s = xe(e.nonce), i = B(e.amount), o = e.data ? X(e.data) : Uint8Array.from([]), c = xe(e.digest), A = ws.getMessageId({
        sender: n,
        recipient: r,
        nonce: s,
        amount: i,
...
}, ar = (e) => e.type === Ce.Coin, Qo = (e) => e.type === Ce.Message, gn = (e) => ar(e) || Qo(e), Qu = (e) => ar(e) ? e.owner : e.recipient, Ui = (e, t) => Qu(e) === t.toB256(), Em = (e, t, n) => e.filter(gn).reduce((r, s) => ar(s) && s.assetId === t || Qo(s) && t === n ? r.add(s.amount) : r, B(0)), Zy = (e) => e.filter(gn).reduce(
...
`)
  ...
  async sendTransaction(e, { estimateTxDependencies: t = !0, awaitExecution: n = !1 } = {}) {
    const r = yt(e);
    Li(this, zi, ku).call(this, r.inputs), t && await this.estimateTxDependencies(r);
  ...
  async getTransactionCost(e, { signatureCallback: t } = {}) {
    ...
    if (n.maxFee = c, r) {
      ...
      T = Fs(_), n.gasLimit = T, { maxFee: c, maxGas: A, minFee: h, minGas: E, gasPrice: w } = await this.estimateTxGasAndFee({
...
var pw = "https://cdn.fuel.network/assets/", mw = [
  ...
  const t = ww(e);
  await Eo();
  const n = Ph(16, 0, Gh.ScriptData), r = Xa(17, 16, 32), s = Di(18, 17, 0), i = Xa(19, 17, 8), o = kh(16, 18, 19), c = tu(1);
...
}, dc = 13, Ac = 8, lc = 1, hi = 32, Ew = 16, fc = (e) => /^0x/.test(e) ? e.slice(2) : e;
async function bw(e, t, n) {
  const r = fn(fc(e), "hex"), s = de.fromAddressOrString(t), i = Ft(hi), o = i0({
    password: fn(n),
    salt: i,
    dklen: hi,
    n: 2 ** dc,
...
var It, xn, Ut, Hi, Wu, Xi, Ju, qu = class extends yu.EventEmitter {
  ...
  async loadState() {
    ...
    if (e) {
      ...
      Dt(this, It, Li(this, Xi, Ju).call(this, t.vaults));
    }
  }
  /**
  ...
  async saveState() {
    ...
    const e = await $A(Re(this, xn), {
      vaults: Li(this, Hi, Wu).call(this, Re(this, It))
    });
...
var rI = class {
  ...
  populateTransactionPredicateData(t) {
    ...
    return r !== -1 && n.removeWitness(r), n.inputs.filter(gn).forEach((s) => {
      Ui(s, this.address) && (s.predicate = H(this.bytes), s.predicateData = H(this.getPredicateData()), s.witnessIndex = 0);
    }), n;
  }
  /**
...
var $w = (e) => e === ue.Return || e === ue.ReturnData, Kw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const E = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], M = h, T = M + ge, z = T + fs, k = z + Cl + ge + ge, J = k + C.fnSelectorBytes.byteLength, O = X(C.data);
      let F = 0;
  ...
  var _;
  const { funcScope: t, isMultiCall: n, program: r, transactionResponse: s } = e, i = await s.waitForResult(), { receipts: o } = i, c = Array.isArray(t) ? t : [t], A = (_ = c[0]) == null ? void 0 : _.getCallConfig(), h = td(o, A, c), E = id(c, o, n, h), w = Fs(o);
  return {
    isMultiCall: n,
    functionScopes: c,
    value: E,
  ...
  var w;
  const { funcScopes: t, callResult: n, isMultiCall: r } = e, { receipts: s } = n, i = Array.isArray(t) ? t : [t], o = (w = i[0]) == null ? void 0 : w.getCallConfig(), c = td(s, o, i), A = id(i, s, r, c), h = Fs(s);
  return {
    functionScopes: i,
    callResult: n,
    isMultiCall: r,
...
var cd = 102400, ud = (e) => {
  ...
  createTransactionRequest(e) {
    ...
    const r = n.stateRoot || dd(n.storageSlots), s = Ad(this.bytecode, n.salt, r), i = new Gi({
