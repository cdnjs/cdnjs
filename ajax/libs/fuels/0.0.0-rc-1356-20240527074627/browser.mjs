...
function UA(e, t, n) {
  ...
  const R = Ji(Qn, e, t, { c: 1, dkLen: I * o }), C = Zr(R), M = Zr(new Uint8Array(I * s)), F = Zr(new Uint8Array(I));
  let X = () => {
  };
  if (b) {
...
class bl extends Wi {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const R = 4 - v, C = yl[v], M = Il[v], F = ji[v], X = $i[v], k = ml[v], Z = wl[v];
      for (let O = 0; O < 16; O++) {
...
class _l extends Wi {
  ...
  process(t, n) {
    ...
    for (let k = 0; k < 80; k++) {
      const Z = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & v ^ ~I & C, L = _ & R ^ ~_ & M, U = le.add5L(X, O, L, Bl[k], en[k]), q = le.add5H(U, F, Z, T, Cl[k], Kt[k]), Y = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), E = r & i ^ r & d ^ i & d, a = s & o ^ s & A ^ o & A;
...
function Oh(e, t, n = Ed) {
  ...
  do {
    ...
    if (!Array.isArray(h)) {
      ...
      if (k = Z == null ? void 0 : Z.call(t, h, b, I, _, v), k === Mh)
        break;
      if (k === !1) {
        if (!F) {
          _.pop();
...
function Md() {
  return Da || (Da = 1, function(e) {
    ...
    var h = s(Jf), b = h, I = Qh, _ = Gh, v = A(lo), R = Sr, C = Et, M = Qr;
...
BigInt(4);
function H0(e) {
  const t = z0(e), { Fp: n } = t, r = t.toBytes || ((R, C, M) => {
    const F = C.toAffine();
...
var Cw = (e) => e === de.Return || e === de.ReturnData, Bw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const b = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], M = h, F = M + fe, X = F + as, k = X + cf + fe + fe, Z = k + C.fnSelectorBytes.byteLength, O = z(C.data);
      let T = 0;
