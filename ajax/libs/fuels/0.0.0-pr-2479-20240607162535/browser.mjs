...
(function(e) {
  (function(t, n) {
    ...
    i.prototype.mulTo = function(a, c) {
      ...
      return this.length === 10 && a.length === 10 ? l = G(this, a, c) : p < 63 ? l = M(this, a, c) : p < 1024 ? l = k(this, a, c) : l = H(this, a, c), l;
    }, i.prototype.mul = function(a) {
      var c = new i(null);
      return c.words = new Array(this.length + a.length), this.mulTo(a, c);
    }, i.prototype.mulf = function(a) {
      var c = new i(null);
      return c.words = new Array(this.length + a.length), H(this, a, c);
    ...
    function ee(E) {
      Z.call(this, E), this.shift = this.m.bitLength(), this.shift % 26 !== 0 && (this.shift += 26 - this.shift % 26), this.r = new i(1).iushln(this.shift), this.r2 = this.imod(this.r.sqr()), this.rinv = this.r._invmp(this.m), this.minv = this.rinv.mul(this.r).isubn(1).div(this.m), this.minv = this.minv.umod(this.r), this.minv = this.r.sub(this.minv);
    }
...
function zo(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], d = e[t++] ^ n[r++], A = e[t++] ^ n[r++], h = e[t++] ^ n[r++], b = e[t++] ^ n[r++], I = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], x = e[t++] ^ n[r++], R = e[t++] ^ n[r++], C = e[t++] ^ n[r++], F = e[t++] ^ n[r++], M = e[t++] ^ n[r++], G = e[t++] ^ n[r++], k = e[t++] ^ n[r++], H = e[t++] ^ n[r++], O = e[t++] ^ n[r++], T = o, L = d, U = A, q = h, V = b, Z = I, ee = _, E = x, a = R, c = C, l = F, p = M, f = G, w = k, y = H, g = O;
  for (let u = 0; u < 8; u += 2)
    V ^= we(T + f | 0, 7), a ^= we(V + T | 0, 9), f ^= we(a + V | 0, 13), T ^= we(f + a | 0, 18), c ^= we(Z + L | 0, 7), w ^= we(c + Z | 0, 9), L ^= we(w + c | 0, 13), Z ^= we(L + w | 0, 18), y ^= we(l + ee | 0, 7), U ^= we(y + l | 0, 9), ee ^= we(U + y | 0, 13), l ^= we(ee + U | 0, 18), q ^= we(g + p | 0, 7), E ^= we(q + g | 0, 9), p ^= we(E + q | 0, 13), g ^= we(p + E | 0, 18), L ^= we(T + q | 0, 7), U ^= we(L + T | 0, 9), q ^= we(U + L | 0, 13), T ^= we(q + U | 0, 18), ee ^= we(Z + V | 0, 7), E ^= we(ee + Z | 0, 9), V ^= we(E + ee | 0, 13), Z ^= we(V + E | 0, 18), p ^= we(l + c | 0, 7), a ^= we(p + l | 0, 9), c ^= we(a + p | 0, 13), l ^= we(c + a | 0, 18), f ^= we(g + y | 0, 7), w ^= we(f + g | 0, 9), y ^= we(w + f | 0, 13), g ^= we(y + w | 0, 18);
  s[i++] = o + T | 0, s[i++] = d + L | 0, s[i++] = A + U | 0, s[i++] = h + q | 0, s[i++] = b + V | 0, s[i++] = I + Z | 0, s[i++] = _ + ee | 0, s[i++] = x + E | 0, s[i++] = R + a | 0, s[i++] = C + c | 0, s[i++] = F + l | 0, s[i++] = M + p | 0, s[i++] = G + f | 0, s[i++] = k + w | 0, s[i++] = H + y | 0, s[i++] = O + g | 0;
}
...
function kA(e, t, n) {
  ...
  const R = Ji(Rn, e, t, { c: 1, dkLen: I * o }), C = Zr(R), F = Zr(new Uint8Array(I * s)), M = Zr(new Uint8Array(I));
  let G = () => {
  };
  if (b) {
    const k = 2 * s * o, H = Math.max(Math.floor(k / 1e4), 1);
    let O = 0;
    G = () => {
      O++, b && (!(O % H) || O === k) && b(O / k);
    };
  }
  return { N: s, r: i, p: o, dkLen: d, blockSize32: _, V: F, B32: C, B: R, tmp: M, blockMixCb: G, asyncTick: A };
}
...
class y0 extends Zi {
  ...
  process(t, n) {
    ...
    for (let x = 0; x < 5; x++) {
      const R = 4 - x, C = m0[x], F = w0[x], M = qi[x], G = ji[x], k = g0[x], H = p0[x];
      for (let O = 0; O < 16; O++) {
        const T = kr(r + Jo(x, i, d, h) + Pr[M[O]] + C, k[O]) + I | 0;
        r = I, I = h, h = kr(d, 10) | 0, d = i, i = T;
      }
      for (let O = 0; O < 16; O++) {
        const T = kr(s + Jo(R, o, A, b) + Pr[G[O]] + F, H[O]) + _ | 0;
...
class C0 extends Zi {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: d, Dl: A, Eh: h, El: b, Fh: I, Fl: _, Gh: x, Gl: R, Hh: C, Hl: F } = this;
    return [t, n, r, s, i, o, d, A, h, b, I, _, x, R, C, F];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, d, A, h, b, I, _, x, R, C, F) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = d | 0, this.Dl = A | 0, this.Eh = h | 0, this.El = b | 0, this.Fh = I | 0, this.Fl = _ | 0, this.Gh = x | 0, this.Gl = R | 0, this.Hh = C | 0, this.Hl = F | 0;
  }
  process(t, n) {
    for (let k = 0; k < 16; k++, n += 4)
      Kt[k] = t.getUint32(n), en[k] = t.getUint32(n += 4);
    for (let k = 16; k < 80; k++) {
      const H = Kt[k - 15] | 0, O = en[k - 15] | 0, T = le.rotrSH(H, O, 1) ^ le.rotrSH(H, O, 8) ^ le.shrSH(H, O, 7), L = le.rotrSL(H, O, 1) ^ le.rotrSL(H, O, 8) ^ le.shrSL(H, O, 7), U = Kt[k - 2] | 0, q = en[k - 2] | 0, V = le.rotrSH(U, q, 19) ^ le.rotrBH(U, q, 61) ^ le.shrSH(U, q, 6), Z = le.rotrSL(U, q, 19) ^ le.rotrBL(U, q, 61) ^ le.shrSL(U, q, 6), ee = le.add4L(L, Z, en[k - 7], en[k - 16]), E = le.add4H(ee, T, V, Kt[k - 7], Kt[k - 16]);
      Kt[k] = E | 0, en[k] = ee | 0;
    }
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: d, Cl: A, Dh: h, Dl: b, Eh: I, El: _, Fh: x, Fl: R, Gh: C, Gl: F, Hh: M, Hl: G } = this;
    for (let k = 0; k < 80; k++) {
      const H = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & x ^ ~I & C, L = _ & R ^ ~_ & F, U = le.add5L(G, O, L, E0[k], en[k]), q = le.add5H(U, M, H, T, b0[k], Kt[k]), V = U | 0, Z = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), E = r & i ^ r & d ^ i & d, a = s & o ^ s & A ^ o & A;
      M = C | 0, G = F | 0, C = x | 0, F = R | 0, x = I | 0, R = _ | 0, { h: I, l: _ } = le.add(h | 0, b | 0, q | 0, V | 0), h = d | 0, b = A | 0, d = i | 0, A = o | 0, i = r | 0, o = s | 0;
      const c = le.add3L(V, ee, a);
      r = le.add3H(c, q, Z, E), s = c | 0;
    }
    ({ h: r, l: s } = le.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = le.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: d, l: A } = le.add(this.Ch | 0, this.Cl | 0, d | 0, A | 0), { h, l: b } = le.add(this.Dh | 0, this.Dl | 0, h | 0, b | 0), { h: I, l: _ } = le.add(this.Eh | 0, this.El | 0, I | 0, _ | 0), { h: x, l: R } = le.add(this.Fh | 0, this.Fl | 0, x | 0, R | 0), { h: C, l: F } = le.add(this.Gh | 0, this.Gl | 0, C | 0, F | 0), { h: M, l: G } = le.add(this.Hh | 0, this.Hl | 0, M | 0, G | 0), this.set(r, s, i, o, d, A, h, b, I, _, x, R, C, F, M, G);
  }
  roundClean() {
    Kt.fill(0), en.fill(0);
  }
...
}, Er = new WeakMap(), ac), X = class extends ce {
  constructor() {
...
function ld(e) {
  ...
  function r(o, d) {
    ...
    for (let C = 0; C < _.length; ++C) {
      const F = _.charAt(C), M = Ad[F];
      if (M === void 0)
        return "Unknown character " + F;
      x = On(x) ^ M, !(C + 6 >= _.length) && R.push(M);
    }
...
var Fl = /* @__PURE__ */ function() {
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.txID)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.outputIndex)), t.push(new X().encode(e.owner)), t.push(new D("u64").encode(e.amount)), t.push(new X().encode(e.assetId)), t.push(new Hn().encode(e.txPointer)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.witnessIndex)), t.push(new D("u64").encode(e.predicateGasUsed)), t.push(new D("u64").encode(e.predicateLength)), t.push(new D("u64").encode(e.predicateDataLength)), t.push(new Ce(e.predicateLength.toNumber()).encode(e.predicate)), t.push(
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.txID)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.outputIndex)), t.push(new X().encode(e.balanceRoot)), t.push(new X().encode(e.stateRoot)), t.push(new Hn().encode(e.txPointer)), t.push(new X().encode(e.contractID)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new X().decode(e, r);
...
var gn = class extends ce {
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.sender)), t.push(new X().encode(e.recipient)), t.push(new D("u64").encode(e.amount)), t.push(new X().encode(e.nonce)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.data.length)), t.push(new X().encode(e.digest)), t.push(new Ce(e.data.length).encode(e.data)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new X().decode(e, r);
  ...
  encode(e) {
    const t = [];
    return t.push(new Hn().encode(e.txPointer)), t.push(new us().encode(e.inputContract)), t.push(new As().encode(e.outputContract)), t.push(new D("u64").encode(e.mintAmount)), t.push(new X().encode(e.mintAssetId)), t.push(new D("u64").encode(e.gasPrice)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new Hn().decode(e, r);
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.root)), t.push(new $("u16").encode(e.witnessIndex)), t.push(new $("u16").encode(e.subsectionIndex)), t.push(new $("u16").encode(e.subsectionsNumber)), t.push(new $("u16").encode(e.proofSetCount)), t.push(new $("u32").encode(e.policyTypes)), t.push(new $("u16").encode(e.inputsCount)), t.push(new $("u16").encode(e.outputsCount)), t.push(new $("u16").encode(e.witnessesCount)), t.push(new ye(new X(), e.proofSetCount).encode(e.proofSet)), t.push(new gn().encode(e.policies)), t.push(new ye(new fn(), e.inputsCount).encode(e.inputs)), t.push(new ye(new hn(), e.outputsCount).encode(e.outputs)), t.push(new ye(new pn(), e.witnessesCount).encode(e.witnesses)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new X().decode(e, r);
...
function Ff(e, t, n = Ed) {
  ...
  do {
    d++;
    const M = d === o.length, G = M && A.length !== 0;
    if (M) {
      if (b = x.length === 0 ? void 0 : _[_.length - 1], h = I, I = x.pop(), G)
        if (i) {
          h = h.slice();
          let H = 0;
          for (const [O, T] of A) {
            const L = O - H;
            T === null ? (h.splice(L, 1), H++) : h[L] = T;
          }
        } else {
    ...
    if (!Array.isArray(h)) {
      ...
      const H = M ? (R = r.get(h.kind)) === null || R === void 0 ? void 0 : R.leave : (C = r.get(h.kind)) === null || C === void 0 ? void 0 : C.enter;
      if (k = H == null ? void 0 : H.call(t, h, b, I, _, x), k === Tf)
        break;
      if (k === !1) {
        if (!M) {
          _.pop();
    ...
    if (k === void 0 && G && A.push([b, h]), M)
      ...
      s = {
        ...
        edits: A,
        prev: s
      }, i = Array.isArray(h), o = i ? h : (F = n[h.kind]) !== null && F !== void 0 ? F : [], d = -1, A = [], I && x.push(I), I = h;
    }
  } while (s !== void 0);
...
function rh() {
  ...
  var r = Qr, s = Md(), i = "connection_init", o = "connection_ack", d = "ping", A = "pong", h = "subscribe", b = "next", I = "error", _ = "complete", x = (
    ...
    function() {
      function O(T, L) {
        var U = this, q = L.onInit, V = L.onAcknowledged, Z = L.onPing, ee = L.onPong;
      ...
      return O.prototype.makeSubscribe = function(T, L, U, q) {
        ...
        return this.socketState.subscriptions[Z] = { query: T, variables: U, subscriber: q }, this.socket.send(k(Z, { query: T, operationName: L, variables: U }).text), function() {
          V.socket.send(H(Z).text), delete V.socketState.subscriptions[Z];
        };
...
function Md() {
  return Na || (Na = 1, function(e) {
    ...
    var h = s(Hl), b = h, I = Rf, _ = Pf, x = A(Ao), R = Sr, C = Et, F = Qr;
      ...
      function() {
        ...
        return f.prototype.rawRequest = function(w, y, g) {
          return i(this, void 0, void 0, function() {
            ...
            return o(this, function(Ae) {
              return u = C.parseRawRequestArgs(w, y, g), m = this.options, J = m.headers, W = m.fetch, K = W === void 0 ? h.default : W, j = m.method, re = j === void 0 ? "POST" : j, se = m.requestMiddleware, Se = m.responseMiddleware, he = d(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, u.signal !== void 0 && (he.signal = u.signal), xe = E(u.query).operationName, [2, L({
                ...
                headers: t(t({}, M(a(J))), M(u.requestHeaders)),
                operationName: xe,
                fetch: K,
                method: re,
                fetchOptions: he,
          ...
          return L({
            ...
            headers: t(t({}, M(a(K))), M(J.requestHeaders)),
            operationName: ve,
            fetch: re,
            method: Se,
            fetchOptions: xe,
    ...
    function L(f) {
      ...
      return i(this, void 0, void 0, function() {
        ...
        return o(this, function(Qe) {
          switch (Qe.label) {
            case 0:
              return se = K.toUpperCase() === "POST" ? H : O, Se = Array.isArray(y), [4, se({
                url: w,
                query: y,
                variables: g,
                operationName: m,
            ...
            case 1:
              return he = Qe.sent(), [4, Z(he, j.jsonSerializer)];
            case 2:
              ...
              throw rr = typeof oe == "string" ? { error: oe } : oe, new F.ClientError(t(t({}, rr), { status: he.status, headers: he.headers }), { query: y, variables: g });
          }
        });
      });
    }
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let R = 0; R < d; R++) {
        ...
        let F = Number(o & I);
        o >>= x, F > A && (F -= _, o += si);
        const M = C, G = C + Math.abs(F) - 1, k = R % 2 !== 0, H = F < 0;
        F === 0 ? b = b.add(n(k, i[M])) : h = h.add(n(H, i[G]));
      }
      return { p: h, f: b };
    },
    wNAFCached(s, i, o, d) {
...
BigInt(4);
function Vh(e) {
  const t = Gh(e), { Fp: n } = t, r = t.toBytes || ((R, C, F) => {
    const M = C.toAffine();
  ...
  class I {
    ...
    equals(C) {
      b(C);
      const { px: F, py: M, pz: G } = this, { px: k, py: H, pz: O } = C, T = n.eql(n.mul(F, O), n.mul(k, G)), L = n.eql(n.mul(M, O), n.mul(H, G));
      return T && L;
    }
    /**
    ...
    double() {
      const { a: C, b: F } = t, M = n.mul(F, Pa), { px: G, py: k, pz: H } = this;
      let O = n.ZERO, T = n.ZERO, L = n.ZERO, U = n.mul(G, G), q = n.mul(k, k), V = n.mul(H, H), Z = n.mul(G, k);
      return Z = n.add(Z, Z), L = n.mul(G, H), L = n.add(L, L), O = n.mul(C, L), T = n.mul(M, V), T = n.add(O, T), O = n.sub(q, T), T = n.add(q, T), T = n.mul(O, T), O = n.mul(Z, O), L = n.mul(M, L), V = n.mul(C, V), Z = n.sub(U, V), Z = n.mul(C, Z), Z = n.add(Z, L), L = n.add(U, U), U = n.add(L, U), U = n.add(U, V), U = n.mul(U, Z), T = n.add(T, U), V = n.mul(k, H), V = n.add(V, V), U = n.mul(V, Z), O = n.sub(O, U), L = n.mul(V, q), L = n.add(L, L), L = n.add(L, L), new I(O, T, L);
    }
    ...
    add(C) {
      b(C);
      const { px: F, py: M, pz: G } = this, { px: k, py: H, pz: O } = C;
      let T = n.ZERO, L = n.ZERO, U = n.ZERO;
      const q = t.a, V = n.mul(t.b, Pa);
      let Z = n.mul(F, k), ee = n.mul(M, H), E = n.mul(G, O), a = n.add(F, M), c = n.add(k, H);
      a = n.mul(a, c), c = n.add(Z, ee), a = n.sub(a, c), c = n.add(F, G);
      let l = n.add(k, O);
      return c = n.mul(c, l), l = n.add(Z, E), c = n.sub(c, l), l = n.add(M, G), T = n.add(H, O), l = n.mul(l, T), T = n.add(ee, E), l = n.sub(l, T), U = n.mul(q, c), T = n.mul(V, E), U = n.add(T, U), T = n.sub(ee, U), U = n.add(ee, U), L = n.mul(T, U), ee = n.add(Z, Z), ee = n.add(ee, Z), E = n.mul(q, E), c = n.mul(V, c), ee = n.add(ee, E), E = n.sub(Z, E), E = n.mul(q, E), c = n.add(c, E), Z = n.mul(ee, c), L = n.add(L, Z), Z = n.mul(l, c), T = n.mul(a, T), T = n.sub(T, Z), Z = n.mul(a, ee), U = n.mul(l, U), U = n.add(U, Z), new I(T, L, U);
    }
    subtract(C) {
    ...
    wNAF(C) {
      return x.wNAFCached(this, h, C, (F) => {
        const M = n.invertBatch(F.map((G) => G.pz));
        return F.map((G, k) => G.toAffine(M[k])).map(I.fromAffine);
      });
    }
    /**
    ...
    multiplyUnsafe(C) {
      ...
      let { k1neg: G, k1: k, k2neg: H, k2: O } = M.splitScalar(C), T = F, L = F, U = this;
      for (; k > Zt || O > Zt; )
        k & Rt && (T = T.add(U)), O & Rt && (L = L.add(U)), U = U.double(), k >>= Rt, O >>= Rt;
      return G && (T = T.negate()), H && (L = L.negate()), L = new I(n.mul(L.px, M.beta), L.py, L.pz), T.add(L);
    }
    /**
    ...
    multiply(C) {
      ...
      const { endo: k } = t;
      if (k) {
        const { k1neg: H, k1: O, k2neg: T, k2: L } = k.splitScalar(F);
        let { p: U, f: q } = this.wNAF(O), { p: V, f: Z } = this.wNAF(L);
        U = x.constTimeNegate(H, U), V = x.constTimeNegate(T, V), V = new I(n.mul(V.px, k.beta), V.py, V.pz), M = U.add(V), G = q.add(Z);
      } else {
        const { p: H, f: O } = this.wNAF(F);
        M = H, G = O;
      }
    ...
    multiplyAndAddUnsafe(C, F, M) {
      const G = I.BASE, k = (O, T) => T === Zt || T === Rt || !O.equals(G) ? O.multiplyUnsafe(T) : O.multiply(T), H = k(this, F).add(k(C, M));
    ...
    // (x, y, z) ∋ (x=x/z, y=y/z)
    toAffine(C) {
      const { px: F, py: M, pz: G } = this, k = this.is0();
      C == null && (C = k ? n.ONE : n.inv(G));
      const H = n.mul(F, C), O = n.mul(M, C), T = n.mul(G, C);
      if (k)
...
function Hh(e) {
  ...
  class M {
    ...
    normalizeS() {
      return this.hasHighS() ? new M(this.r, d(-this.s), this.recovery) : this;
    }
    // DER-encoded
    toDERRawBytes() {
  ...
  function V(c, l, p = Z) {
    ...
    function re(se) {
      ...
      return y && R(Ae) && (Tt = C(Ae), ge ^= 1), new M(xe, Tt, ge);
    }
...
function qh(e) {
  const t = Zd, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), d = BigInt(44), A = BigInt(88), h = e * e * e % t, b = h * h * e % t, I = vt(b, n, t) * b % t, _ = vt(I, n, t) * b % t, x = vt(_, Ri, t) * h % t, R = vt(x, s, t) * x % t, C = vt(R, i, t) * R % t, F = vt(C, d, t) * C % t, M = vt(F, A, t) * F % t, G = vt(M, d, t) * C % t, k = vt(G, n, t) * b % t, H = vt(k, o, t) * R % t, O = vt(H, r, t) * h % t, T = vt(O, Ri, t);
...
var Lp = "https://fuellabs.github.io/block-explorer-v2", kp = (e, t) => `${{
  ...
  ], h = A.filter((H) => !!H.value).map(({ key: H, value: O }) => ({
    key: H,
    value: O
  })), b = h.length > 0;
  if (h.length > 1)
    throw new v(
      ...
      `Only one of the following can be passed in to buildBlockExplorerUrl: ${A.map((H) => H.key).join(", ")}.`
    );
  if (n && h.length > 0) {
    const H = A.map(({ key: O }) => O).join(", ");
    throw new v(
      N.ERROR_BUILDING_BLOCK_EXPLORER_URL,
  ...
  const I = b ? kp(
    h[0].key,
    h[0].value
  ) : "", _ = /^\/|\/$/gm, x = n ? n.replace(_, "") : I, R = d.replace(_, ""), C = r == null ? void 0 : r.replace(_, ""), F = C ? encodeURIComponent(C) : void 0, M = R.match(/^https?:\/\//) ? "" : "https://", G = C != null && C.match(/^https?:\/\//) ? "" : "https://";
  return `${M}${R}/${x}${F ? `?providerUrl=${G}${F}` : ""}`;
}, uu = (e) => e.filter(
...
var Wp = (e) => {
  ...
  const G = Au({
    ...
    metadataGas: F,
    txBytesSize: b.length
  }), k = (L = C.find((U) => U.type === Qt.WitnessLimit)) == null ? void 0 : L.data, H = x.reduce((U, q) => U + q.dataLength, 0), O = wo({
    gasPerByte: A,
    minGas: G,
    witnessesLength: H,
    gasLimit: M,
...
function Em({
  ...
  const d = mm(n);
  return cm(t).reduce((b, I) => {
    const _ = im(e, I.inputIndex);
    return _ ? d.reduce((R, C) => {
      var F;
      if (C.to === _.contractID) {
        const M = C.amount.gt(0) ? C.assetId : o, G = gu(e, M);
        if (G) {
          const k = Co(G), H = [], O = r == null ? void 0 : r[_.contractID];
          return O && H.push(
            Kp({
              abi: O,
              receipt: C,
            ...
            assetsSent: (F = C.amount) != null && F.isZero() ? void 0 : [
              {
                amount: C.amount,
                assetId: C.assetId
              }
...
function xm({
  ...
  return wu(e) ? [
    ...
    ...bm({ inputs: t, receipts: r, baseAssetId: d })
  ] : [...Bm(n)];
}
var cn = (e) => {
  const t = Op(e);
...
function Ss(e) {
  ...
  const {
    ...
    maxInputs: h,
    baseAssetId: x
  }), M = mu(i.type), G = B((l = (c = i.policies) == null ? void 0 : c.find((p) => p.type === Qt.Tip)) == null ? void 0 : l.data), { isStatusFailure: k, isStatusPending: H, isStatusSuccess: O, blockId: T, status: L, time: U, totalFee: q } = Qm(d), V = $p({
    totalFee: q,
    gasPrice: _,
    rawPayload: C,
    tip: G,
...
var rs = class {
  ...
  async getTransactionSummary(e) {
    ...
    const s = r.map(cn) || [], { gasPerByte: i, gasPriceFactor: o, gasCosts: d, maxGasPerTx: A } = this.provider.getGasConfig(), h = await this.provider.getLatestGasPrice(), b = this.provider.getChain().consensusParameters.txParameters.maxInputs, I = this.provider.getBaseAssetId();
    return Ss({
      id: this.id,
      receipts: s,
      transaction: n,
...
`)
    ...
    for (; s.length > 0 && i < qa; ) {
      ...
      for (let h = 0; h < d.dryRun.length; h++) {
        ...
        if (F && (M == null ? void 0 : M.type) === Le.Script) {
          x.outputVariables += R.length, M.addVariableOutputs(R.length), C.forEach(({ contractId: k }) => {
            M.addContractInputAndOutput(ue.fromString(k)), x.missingContractIds.push(k);
          });
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    ...
    let { maxFee: _, maxGas: x, minFee: R, minGas: C, gasPrice: F, gasLimit: M } = await this.estimateTxGasAndFee({
      transactionRequest: b
    }), G = [], k, H = [], O = 0, T = B(0);
    if (s.maxFee = _, i) {
      if (s.gasLimit = M, n && await n(s), { receipts: G, missingContractIds: H, outputVariables: O, dryRunStatus: k } = await this.estimateTxDependencies(s), k && "reason" in k)
        throw this.extractDryRunError(s, G, k);
      T = uu(G), s.gasLimit = T, { maxFee: _, maxGas: x, minFee: R, minGas: C, gasPrice: F } = await this.estimateTxGasAndFee({
...
async function yy(e) {
  ...
  } = n.getChain(), x = await n.getLatestGasPrice(), R = n.getBaseAssetId(), C = Ss({
    id: s.id,
    receipts: d,
    transaction: i,
...
async function Iy(e) {
  const { provider: t, transactionRequest: n, abiMap: r } = e, { receipts: s } = await t.call(n), { gasPerByte: i, gasPriceFactor: o, gasCosts: d, maxGasPerTx: A } = t.getGasConfig(), h = t.getChain().consensusParameters.txParameters.maxInputs, b = n.toTransaction(), I = n.toTransactionBytes(), _ = await t.getLatestGasPrice(), x = t.getBaseAssetId();
  return Ss({
    receipts: s,
    transaction: b,
    transactionBytes: I,
...
async function by(e) {
  ...
  } = n.getChain(), _ = await n.getLatestGasPrice(), x = n.getBaseAssetId();
  return {
    transactions: i.map((C) => {
      const { node: F } = C, { id: M, rawPayload: G, status: k } = F, [H] = new mn().decode(Y(G), 0);
      let O = [];
      F != null && F.status && "receipts" in F.status && (O = F.status.receipts);
      const T = O.map(cn), L = Ss({
        id: M,
        receipts: T,
        transaction: H,
...
var Gm = "https://cdn.fuel.network/assets/", Xm = [
  ...
  async fund(t, n) {
    var M;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, d = t.maxFee, A = this.provider.getBaseAssetId(), h = ((M = i.find((G) => G.assetId === A)) == null ? void 0 : M.amount) || B(0), b = _g({
      amount: B(d),
      assetId: A,
      coinQuantities: i
    }), I = {};
    b.forEach(({ amount: G, assetId: k }) => {
      I[k] = {
        required: G,
        owned: B(0)
      };
    }), t.inputs.filter(jn).forEach((G) => {
      const H = nr(G) ? String(G.assetId) : A;
      I[H] && (I[H].owned = I[H].owned.add(G.amount));
    });
    let _ = [];
    Object.entries(I).forEach(([G, { owned: k, required: H }]) => {
      k.lt(H) && _.push({
        assetId: G,
        amount: H.sub(k)
      });
    ...
    for (; x && R < zm; ) {
      ...
      if (r && Array.from({ length: r }).forEach(
        ...
        break;
      const { maxFee: H } = await this.provider.estimateTxGasAndFee({
...
var Cw = (e) => e === de.Return || e === de.ReturnData, Bw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const b = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], F = h, M = F + fe, G = M + as, k = G + il + fe + fe, H = k + C.fnSelectorBytes.byteLength, O = Y(C.data);
      let T = 0;
      b.push(new D("u64").encode(C.amount || 0)), b.push(new X().encode(((x = C.assetId) == null ? void 0 : x.toString()) || Ne)), b.push(C.contractId.toBytes()), b.push(new D("u64").encode(k)), b.push(new D("u64").encode(H)), b.push(C.fnSelectorBytes), b.push(O), C.gas && (b.push(new D("u64").encode(C.gas)), T = H + O.byteLength);
      const L = {
        amountOffset: F,
        assetIdOffset: M,
        gasForwardedOffset: T,
