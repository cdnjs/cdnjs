...
function nA(e, t) {
  switch (typeof e) {
    case "bigint":
      return e;
    case "number":
      return wt(Number.isInteger(e), "underflow", t || "value", e), wt(e >= -Un && e <= Un, "overflow", t || "value", e), BigInt(e);
    case "string":
      try {
        if (e === "")
...
function rA(e, t) {
  switch (typeof e) {
    case "bigint":
      return wt(e >= -Un && e <= Un, "overflow", t || "value", e), Number(e);
    case "number":
      return wt(Number.isInteger(e), "underflow", t || "value", e), wt(e >= -Un && e <= Un, "overflow", t || "value", e), e;
    case "string":
      try {
        if (e === "")
          throw new Error("empty string");
...
const cA = Ur(() => new wl()), Kr = BigInt(2 ** 32 - 1), Gi = BigInt(32);
function AA(e, t = !1) {
...
class eh extends yo {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      ...
      for (let O = 0; O < 16; O++) {
        const k = es(s + Ra(_, o, u, I) + ts[G[O]] + M, X[O]) + b | 0;
...
}, FA = "u8", PA = "u16", UA = "u32", GA = "u64", HA = "u256", JA = "raw untyped ptr", YA = "raw untyped slice", ZA = "bool", VA = "b256", XA = "struct B512", Ro = "enum Option", So = "struct Vec", No = "struct Bytes", ko = "struct String", jA = "str", Mo = /str\[(?<length>[0-9]+)\]/, Cs = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Oo = /^struct (?<name>\w+)$/, To = /^enum (?<name>\w+)$/, qA = /^\((?<items>.*)\)$/, zh = /^generic (?<name>\w+)$/, Ut = "0", nr = "1", ee = 8, bn = 32, Ji = bn + 2, kn = bn, WA = bn, Kh = bn, ef = ee * 4, tf = ee * 2, Lo = 2 ** 32 - 1, js = ({ maxInputs: e }) => bn + // Tx ID
kn + // Base asset ID
...
var lf = (e) => Object.values(e).every(
...
), qn, In, Ps, rd, Us, sd, Hc, nd = (Hc = class extends ie {
  constructor(t, n) {
  ...
  decode(t, n) {
    ...
    return r += u, [s, r] = c.decode(t, r), lf(this.coders) ? cn(this, Us, sd).call(this, o, r) : [{ [o]: s }, r];
  }
...
}, Us = new WeakSet(), sd = function(t, n) {
  return [t, n];
...
var Tn = (e, t) => {
  ...
  if (e.type === So) {
    const v = ud(r), _ = new en(e.abi, v), C = Tn(_, { isSmallBytes: !0, encoding: Ut });
    return new Ad(C);
  }
  ...
  if ((b = qA.exec(e.type)) == null ? void 0 : b.groups) {
    const v = r.map(
      (_) => Tn(_, { isRightPadded: !0, encoding: Ut })
    );
    return new cd(v);
  }
...
var mf = (e) => Object.values(e).every(
  // @ts-expect-error complicated types
  ({ type: t, coders: n }) => t === "()" && JSON.stringify(n) === JSON.stringify([])
), $n, zn, Gs, fd, Hs, gd, Yc, hd = (Yc = class extends ie {
  constructor(t, n) {
    const r = new R("u64"), s = Object.values(n).reduce(
      (i, o) => Math.max(i, o.encodedLength),
      0
  ...
  encode(t) {
    if (typeof t == "string" && this.coders[t])
      return cn(this, Gs, fd).call(this, t);
    const [n, ...r] = Object.keys(t);
    if (!n)
      throw new x(D.INVALID_DECODE_VALUE, "A field for the case must be provided.");
    if (r.length !== 0)
...
}, $n = new WeakMap(), zn = new WeakMap(), Gs = new WeakSet(), fd = function(t) {
...
var Gn = class {
  ...
  constructor(e, t) {
    ...
    S(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = gf(this.jsonAbi, t), this.name = t, this.signature = fs.getSignature(this.jsonAbi, this.jsonFn), this.selector = fs.getFunctionSelector(this.signature), this.selectorBytes = new Uo().encode(t), this.encoding = dd(e.encoding), this.isInputDataPointer = cn(this, Js, Ed).call(this), this.outputMetadata = {
  ...
  decodeArguments(e) {
    ...
    return n.reduce(
      (s, i) => {
        const o = Gn.getCoder(this.jsonAbi, i, { encoding: this.encoding }), [c, u] = o.decode(t, s.offset);
        return {
          decoded: [...s.decoded, c],
          offset: s.offset + u
        };
...
var Ff = /* @__PURE__ */ function() {
...
}, me = /* @__PURE__ */ ((e) => (e[e.Coin = 0] = "Coin", e[e.Contract = 1] = "Contract", e[e.Message = 2] = "Message", e))(me || {}), Ua = class extends ie {
  constructor() {
    super("InputCoin", "struct InputCoin", 0);
  }
  encode(e) {
    const t = [];
    return t.push(new U().encode(e.txID)), t.push(new ce("u16").encode(e.outputIndex)), t.push(new U().encode(e.owner)), t.push(new R("u64").encode(e.amount)), t.push(new U().encode(e.assetId)), t.push(new sr().encode(e.txPointer)), t.push(new ce("u16").encode(e.witnessIndex)), t.push(new R("u64").encode(e.predicateGasUsed)), t.push(new R("u64").encode(e.predicateLength)), t.push(new R("u64").encode(e.predicateDataLength)), t.push(new we(e.predicateLength.toNumber()).encode(e.predicate)), t.push(
  ...
  encode(e) {
    const t = [];
    return t.push(new U().encode(e.txID)), t.push(new ce("u16").encode(e.outputIndex)), t.push(new U().encode(e.balanceRoot)), t.push(new U().encode(e.stateRoot)), t.push(new sr().encode(e.txPointer)), t.push(new U().encode(e.contractID)), re(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new U().decode(e, r);
...
}, ye = /* @__PURE__ */ ((e) => (e[e.Coin = 0] = "Coin", e[e.Contract = 1] = "Contract", e[e.Change = 2] = "Change", e[e.Variable = 3] = "Variable", e[e.ContractCreated = 4] = "ContractCreated", e))(ye || {}), Ga = class extends ie {
  constructor() {
...
var Ns = class extends ie {
  ...
  encode(e) {
    const t = [];
    return t.push(new sr().encode(e.txPointer)), t.push(new _s().encode(e.inputContract)), t.push(new Rs().encode(e.outputContract)), t.push(new R("u64").encode(e.mintAmount)), t.push(new U().encode(e.mintAssetId)), t.push(new R("u64").encode(e.gasPrice)), re(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new sr().decode(e, r);
...
const _d = BigInt(0), Ws = BigInt(1), Gf = BigInt(2);
function jt(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
...
const Xf = (e, t, n) => e | (n ? Ws : _d) << BigInt(t), Xo = (e) => (Gf << BigInt(e - 1)) - Ws, xi = (e) => new Uint8Array(e), oc = (e) => Uint8Array.from(e);
function Sd(e, t, n) {
...
const Gg = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  print: Jd
}, Symbol.toStringTag, { value: "Module" })), Hg = /* @__PURE__ */ po(Gg);
...
function Xd() {
  return hc || (hc = 1, function(e) {
    ...
    function T(f) {
      ...
      return i(this, void 0, void 0, function() {
        var ne, Re, fe, oe, Qe, ue, ge, Gt, xe, Ie, fr;
...
function qp(e) {
  ...
  class E {
    ...
    double() {
      const { a: C, b: M } = t, N = n.mul(M, wc), { px: G, py: L, pz: X } = this;
...
${yp}#variant.${e.reason}`), { errorMessage: t, reason: n };
  ...
  const { receipts: t, status: n, logs: r } = e, s = t.some(({ type: h }) => h === Ae.Panic), i = t.some(({ type: h }) => h === Ae.Revert), { errorMessage: o, reason: c } = (n == null ? void 0 : n.type) === "FailureStatus" && s ? GE(n) : HE(t, r), u = {
    logs: r,
    receipts: t,
    panic: s,
    revert: i,
...
var ZE = (e) => {
  ...
  const N = bu({
    ...
    metadataGas: C,
    txBytesSize: h.length
  }), G = (T = _.find((P) => P.type === Mt.WitnessLimit)) == null ? void 0 : T.data, L = b.reduce((P, q) => P + q.dataLength, 0), X = na({
    gasPerByte: c,
    minGas: N,
    witnessesLength: L,
    gasLimit: M,
  ...
  return iw(t).reduce((h, I) => {
    ...
    return E ? o.reduce((v, _) => {
      ...
      if (_.to === E.contractID) {
        ...
        if (M) {
          const N = sa(M), G = [], L = r == null ? void 0 : r[E.contractID];
          return L && G.push(
            WE({
              abi: L,
              receipt: _,
...
function ni(e) {
  ...
  const {
    ...
    abiMap: u,
    maxInputs: h
  }), M = Su(i.type), N = Q((a = (B = i.policies) == null ? void 0 : B.find((A) => A.type === Mt.Tip)) == null ? void 0 : a.data), { fee: G } = qE({
    gasPrice: b,
    rawPayload: _,
    tip: N,
    consensusParameters: {
...
var By = [
  ...
  async fund(t, n) {
    var N;
    const { addedSignatures: r, estimatedPredicates: s, maxFee: i, requiredQuantities: o } = n, c = this.provider.getBaseAssetId(), u = ((N = o.find((G) => G.assetId === c)) == null ? void 0 : N.amount) || Q(0), h = t, I = Rm({
      amount: Q(i),
      assetId: c,
      coinQuantities: o
    }), E = {};
    I.forEach(({ amount: G, assetId: L }) => {
      ...
      const X = oa(G) ? String(G.assetId) : c;
...
async function Gw(e, t) {
  const n = JSON.parse(e), {
    ...
    r: u,
    dklen: o
  }), M = Uint8Array.from([...C.subarray(16, 32), ...E]), N = OA(M), G = wr(N, "hex");
  if (r !== G)
    throw new x(
      D.INVALID_PASSWORD,
...
var Uu = class extends ri {
  ...
  async encrypt(t) {
    return Uw(this.privateKey, this.address, t);
  }
};
...
var Fn = class {
  ...
  constructor(e) {
    ...
    this.parentFingerprint = e.parentFingerprint || this.parentFingerprint, this.fingerprint = wo(Gr(It(this.publicKey)), 0, 4), this.depth = e.depth || this.depth, this.index = e.index || this.index, this.chainCode = e.chainCode;
  }
  get extendedKey() {
...
var Or = class {
  ...
  return t ? i.push(
    ...
    Cr(19, 19, 0),
    fc(16, 17, 18, 19)
  ) : i.push(fc(16, 17, 18, Ne.cgas().to_u8())), s.encoding === Ut && s.isHeap && i.extend([
...
var Uc = (e) => e === Ae.Return || e === Ae.ReturnData, pI = (e, t) => e.find(
  ...
  return n.receipts.filter(({ type: o }) => Uc(o)).flatMap((o, c, u) => {
    var h;
    if (!s.eq(Q(o.is)))
      return [];
    if (o.type === Ae.Return)
    ...
    if (o.type === Ae.ReturnData) {
      const I = J(o.data);
      if (t && Uc((h = u[c + 1]) == null ? void 0 : h.type)) {
        const E = u[c + 1];
...
var i0 = class {
  ...
  getDecodedValue(e) {
    ...
    if (this.functionScopes.length === 1 && n && "bytes" in n.program)
      return fI(e, n, t);
    const r = (n == null ? void 0 : n.func.encoding) === Ut && (n == null ? void 0 : n.func.outputMetadata.isHeapType) || !1, i = EI(
      e,
...
var a0 = class {
  ...
  get calls() {
    ...
    const n = t.maxInputs, r = Gc(this.functionInvocationScopes, n);
   ...
   */
  updateScriptRequest() {
    const e = this.program.provider.getChain().consensusParameters.maxInputs, t = Gc(this.functionInvocationScopes, e);
