...
var D = (e, t, n) => fd(e, typeof t != "symbol" ? t + "" : t, n), ri = (e, t, n) => t.has(e) || ea("Cannot " + n);
var Fe = (e, t, n) => (ri(e, t, "read from private field"), n ? n.call(e) : t.get(e)), Rt = (e, t, n) => t.has(e) ? ea("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), Ot = (e, t, n, r) => (ri(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n), Ur = (e, t, n) => (ri(e, t, "access private method"), n);
function Qc() {
  return {
    FORC: "0.62.0",
    FUEL_CORE: "0.31.0",
...
(function(e) {
  (function(t, n) {
    ...
    var z = function(a, u, l) {
      ...
      I = (m + (d >>> 13) | 0) + (Hs >>> 26) | 0, Hs &= 67108863, g = Math.imul(Pe, Ze), d = Math.imul(Pe, We), d = d + Math.imul(Ue, Ze) | 0, m = Math.imul(Ue, We), g = g + Math.imul(Ne, Je) | 0, d = d + Math.imul(Ne, qe) | 0, d = d + Math.imul(Te, Je) | 0, m = m + Math.imul(Te, qe) | 0, g = g + Math.imul(Re, je) | 0, d = d + Math.imul(Re, $e) | 0, d = d + Math.imul(ye, je) | 0, m = m + Math.imul(ye, $e) | 0, g = g + Math.imul(Ae, Ke) | 0, d = d + Math.imul(Ae, et) | 0, d = d + Math.imul(he, Ke) | 0, m = m + Math.imul(he, et) | 0, g = g + Math.imul(fe, tt) | 0, d = d + Math.imul(fe, nt) | 0, d = d + Math.imul(oe, tt) | 0, m = m + Math.imul(oe, nt) | 0, g = g + Math.imul(re, rt) | 0, d = d + Math.imul(re, st) | 0, d = d + Math.imul(se, rt) | 0, m = m + Math.imul(se, st) | 0, g = g + Math.imul(W, it) | 0, d = d + Math.imul(W, ot) | 0, d = d + Math.imul(K, it) | 0, m = m + Math.imul(K, ot) | 0;
      var Xs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Xs >>> 26) | 0, Xs &= 67108863, g = Math.imul(Ge, Ze), d = Math.imul(Ge, We), d = d + Math.imul(ze, Ze) | 0, m = Math.imul(ze, We), g = g + Math.imul(Pe, Je) | 0, d = d + Math.imul(Pe, qe) | 0, d = d + Math.imul(Ue, Je) | 0, m = m + Math.imul(Ue, qe) | 0, g = g + Math.imul(Ne, je) | 0, d = d + Math.imul(Ne, $e) | 0, d = d + Math.imul(Te, je) | 0, m = m + Math.imul(Te, $e) | 0, g = g + Math.imul(Re, Ke) | 0, d = d + Math.imul(Re, et) | 0, d = d + Math.imul(ye, Ke) | 0, m = m + Math.imul(ye, et) | 0, g = g + Math.imul(Ae, tt) | 0, d = d + Math.imul(Ae, nt) | 0, d = d + Math.imul(he, tt) | 0, m = m + Math.imul(he, nt) | 0, g = g + Math.imul(fe, rt) | 0, d = d + Math.imul(fe, st) | 0, d = d + Math.imul(oe, rt) | 0, m = m + Math.imul(oe, st) | 0, g = g + Math.imul(re, it) | 0, d = d + Math.imul(re, ot) | 0, d = d + Math.imul(se, it) | 0, m = m + Math.imul(se, ot) | 0, g = g + Math.imul(W, at) | 0, d = d + Math.imul(W, ct) | 0, d = d + Math.imul(K, at) | 0, m = m + Math.imul(K, ct) | 0;
      var Vs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Vs >>> 26) | 0, Vs &= 67108863, g = Math.imul(He, Ze), d = Math.imul(He, We), d = d + Math.imul(Xe, Ze) | 0, m = Math.imul(Xe, We), g = g + Math.imul(Ge, Je) | 0, d = d + Math.imul(Ge, qe) | 0, d = d + Math.imul(ze, Je) | 0, m = m + Math.imul(ze, qe) | 0, g = g + Math.imul(Pe, je) | 0, d = d + Math.imul(Pe, $e) | 0, d = d + Math.imul(Ue, je) | 0, m = m + Math.imul(Ue, $e) | 0, g = g + Math.imul(Ne, Ke) | 0, d = d + Math.imul(Ne, et) | 0, d = d + Math.imul(Te, Ke) | 0, m = m + Math.imul(Te, et) | 0, g = g + Math.imul(Re, tt) | 0, d = d + Math.imul(Re, nt) | 0, d = d + Math.imul(ye, tt) | 0, m = m + Math.imul(ye, nt) | 0, g = g + Math.imul(Ae, rt) | 0, d = d + Math.imul(Ae, st) | 0, d = d + Math.imul(he, rt) | 0, m = m + Math.imul(he, st) | 0, g = g + Math.imul(fe, it) | 0, d = d + Math.imul(fe, ot) | 0, d = d + Math.imul(oe, it) | 0, m = m + Math.imul(oe, ot) | 0, g = g + Math.imul(re, at) | 0, d = d + Math.imul(re, ct) | 0, d = d + Math.imul(se, at) | 0, m = m + Math.imul(se, ct) | 0, g = g + Math.imul(W, ut) | 0, d = d + Math.imul(W, dt) | 0, d = d + Math.imul(K, ut) | 0, m = m + Math.imul(K, dt) | 0;
      var Ys = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ys >>> 26) | 0, Ys &= 67108863, g = Math.imul(Ve, Ze), d = Math.imul(Ve, We), d = d + Math.imul(Ye, Ze) | 0, m = Math.imul(Ye, We), g = g + Math.imul(He, Je) | 0, d = d + Math.imul(He, qe) | 0, d = d + Math.imul(Xe, Je) | 0, m = m + Math.imul(Xe, qe) | 0, g = g + Math.imul(Ge, je) | 0, d = d + Math.imul(Ge, $e) | 0, d = d + Math.imul(ze, je) | 0, m = m + Math.imul(ze, $e) | 0, g = g + Math.imul(Pe, Ke) | 0, d = d + Math.imul(Pe, et) | 0, d = d + Math.imul(Ue, Ke) | 0, m = m + Math.imul(Ue, et) | 0, g = g + Math.imul(Ne, tt) | 0, d = d + Math.imul(Ne, nt) | 0, d = d + Math.imul(Te, tt) | 0, m = m + Math.imul(Te, nt) | 0, g = g + Math.imul(Re, rt) | 0, d = d + Math.imul(Re, st) | 0, d = d + Math.imul(ye, rt) | 0, m = m + Math.imul(ye, st) | 0, g = g + Math.imul(Ae, it) | 0, d = d + Math.imul(Ae, ot) | 0, d = d + Math.imul(he, it) | 0, m = m + Math.imul(he, ot) | 0, g = g + Math.imul(fe, at) | 0, d = d + Math.imul(fe, ct) | 0, d = d + Math.imul(oe, at) | 0, m = m + Math.imul(oe, ct) | 0, g = g + Math.imul(re, ut) | 0, d = d + Math.imul(re, dt) | 0, d = d + Math.imul(se, ut) | 0, m = m + Math.imul(se, dt) | 0, g = g + Math.imul(W, At) | 0, d = d + Math.imul(W, lt) | 0, d = d + Math.imul(K, At) | 0, m = m + Math.imul(K, lt) | 0;
      var Zs = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Zs >>> 26) | 0, Zs &= 67108863, g = Math.imul(Ve, Je), d = Math.imul(Ve, qe), d = d + Math.imul(Ye, Je) | 0, m = Math.imul(Ye, qe), g = g + Math.imul(He, je) | 0, d = d + Math.imul(He, $e) | 0, d = d + Math.imul(Xe, je) | 0, m = m + Math.imul(Xe, $e) | 0, g = g + Math.imul(Ge, Ke) | 0, d = d + Math.imul(Ge, et) | 0, d = d + Math.imul(ze, Ke) | 0, m = m + Math.imul(ze, et) | 0, g = g + Math.imul(Pe, tt) | 0, d = d + Math.imul(Pe, nt) | 0, d = d + Math.imul(Ue, tt) | 0, m = m + Math.imul(Ue, nt) | 0, g = g + Math.imul(Ne, rt) | 0, d = d + Math.imul(Ne, st) | 0, d = d + Math.imul(Te, rt) | 0, m = m + Math.imul(Te, st) | 0, g = g + Math.imul(Re, it) | 0, d = d + Math.imul(Re, ot) | 0, d = d + Math.imul(ye, it) | 0, m = m + Math.imul(ye, ot) | 0, g = g + Math.imul(Ae, at) | 0, d = d + Math.imul(Ae, ct) | 0, d = d + Math.imul(he, at) | 0, m = m + Math.imul(he, ct) | 0, g = g + Math.imul(fe, ut) | 0, d = d + Math.imul(fe, dt) | 0, d = d + Math.imul(oe, ut) | 0, m = m + Math.imul(oe, dt) | 0, g = g + Math.imul(re, At) | 0, d = d + Math.imul(re, lt) | 0, d = d + Math.imul(se, At) | 0, m = m + Math.imul(se, lt) | 0;
      var Ws = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Ws >>> 26) | 0, Ws &= 67108863, g = Math.imul(Ve, je), d = Math.imul(Ve, $e), d = d + Math.imul(Ye, je) | 0, m = Math.imul(Ye, $e), g = g + Math.imul(He, Ke) | 0, d = d + Math.imul(He, et) | 0, d = d + Math.imul(Xe, Ke) | 0, m = m + Math.imul(Xe, et) | 0, g = g + Math.imul(Ge, tt) | 0, d = d + Math.imul(Ge, nt) | 0, d = d + Math.imul(ze, tt) | 0, m = m + Math.imul(ze, nt) | 0, g = g + Math.imul(Pe, rt) | 0, d = d + Math.imul(Pe, st) | 0, d = d + Math.imul(Ue, rt) | 0, m = m + Math.imul(Ue, st) | 0, g = g + Math.imul(Ne, it) | 0, d = d + Math.imul(Ne, ot) | 0, d = d + Math.imul(Te, it) | 0, m = m + Math.imul(Te, ot) | 0, g = g + Math.imul(Re, at) | 0, d = d + Math.imul(Re, ct) | 0, d = d + Math.imul(ye, at) | 0, m = m + Math.imul(ye, ct) | 0, g = g + Math.imul(Ae, ut) | 0, d = d + Math.imul(Ae, dt) | 0, d = d + Math.imul(he, ut) | 0, m = m + Math.imul(he, dt) | 0, g = g + Math.imul(fe, At) | 0, d = d + Math.imul(fe, lt) | 0, d = d + Math.imul(oe, At) | 0, m = m + Math.imul(oe, lt) | 0;
      var Js = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (Js >>> 26) | 0, Js &= 67108863, g = Math.imul(Ve, Ke), d = Math.imul(Ve, et), d = d + Math.imul(Ye, Ke) | 0, m = Math.imul(Ye, et), g = g + Math.imul(He, tt) | 0, d = d + Math.imul(He, nt) | 0, d = d + Math.imul(Xe, tt) | 0, m = m + Math.imul(Xe, nt) | 0, g = g + Math.imul(Ge, rt) | 0, d = d + Math.imul(Ge, st) | 0, d = d + Math.imul(ze, rt) | 0, m = m + Math.imul(ze, st) | 0, g = g + Math.imul(Pe, it) | 0, d = d + Math.imul(Pe, ot) | 0, d = d + Math.imul(Ue, it) | 0, m = m + Math.imul(Ue, ot) | 0, g = g + Math.imul(Ne, at) | 0, d = d + Math.imul(Ne, ct) | 0, d = d + Math.imul(Te, at) | 0, m = m + Math.imul(Te, ct) | 0, g = g + Math.imul(Re, ut) | 0, d = d + Math.imul(Re, dt) | 0, d = d + Math.imul(ye, ut) | 0, m = m + Math.imul(ye, dt) | 0, g = g + Math.imul(Ae, At) | 0, d = d + Math.imul(Ae, lt) | 0, d = d + Math.imul(he, At) | 0, m = m + Math.imul(he, lt) | 0;
      ...
      var js = (I + g | 0) + ((d & 8191) << 13) | 0;
      I = (m + (d >>> 13) | 0) + (js >>> 26) | 0, js &= 67108863, g = Math.imul(Ve, rt), d = Math.imul(Ve, st), d = d + Math.imul(Ye, rt) | 0, m = Math.imul(Ye, st), g = g + Math.imul(He, it) | 0, d = d + Math.imul(He, ot) | 0, d = d + Math.imul(Xe, it) | 0, m = m + Math.imul(Xe, ot) | 0, g = g + Math.imul(Ge, at) | 0, d = d + Math.imul(Ge, ct) | 0, d = d + Math.imul(ze, at) | 0, m = m + Math.imul(ze, ct) | 0, g = g + Math.imul(Pe, ut) | 0, d = d + Math.imul(Pe, dt) | 0, d = d + Math.imul(Ue, ut) | 0, m = m + Math.imul(Ue, dt) | 0, g = g + Math.imul(Ne, At) | 0, d = d + Math.imul(Ne, lt) | 0, d = d + Math.imul(Te, At) | 0, m = m + Math.imul(Te, lt) | 0;
...
var Oc = B(0), Ii = B(58), us = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz", zr = null;
function Ud(e) {
  if (zr == null) {
    zr = {};
...
function Lc(e) {
  ...
  let n = B(t), r = "";
  for (; n.gt(Oc); )
    r = us[Number(n.mod(Ii))] + r, n = n.div(Ii);
...
const iA = (e, t) => BigInt(e >>> 0) << Ei | BigInt(t >>> 0), oA = (e, t, n) => e >>> n, aA = (e, t, n) => e << 32 - n | t >>> n, cA = (e, t, n) => e >>> n | t << 32 - n, uA = (e, t, n) => e << 32 - n | t >>> n, dA = (e, t, n) => e << 64 - n | t >>> n - 32, AA = (e, t, n) => e >>> n - 32 | t << 64 - n, lA = (e, t) => t, fA = (e, t) => e, Xc = (e, t, n) => e << n | t >>> 32 - n, Vc = (e, t, n) => t << n | e >>> 32 - n, Yc = (e, t, n) => t << n - 32 | e >>> 64 - n, Zc = (e, t, n) => e << n - 32 | t >>> 64 - n;
function hA(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
const SA = (e, t, n) => Bs(() => new io(t, e, n)), QA = /* @__PURE__ */ SA(1, 136, 256 / 8), NA = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), jc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), DA = /* @__PURE__ */ jc.map((e) => (9 * e + 5) % 16);
let oo = [jc], ao = [DA];
for (let e = 0; e < 4; e++)
  for (let t of [oo, ao])
...
var bi = (e) => xs.getRandomValues(new Uint8Array(e)), ts = (e, t = "base64") => {
  ...
  const n = bi(16), r = bi(32), s = co(e, r), i = JSON.stringify(t), o = Gn(i, "utf-8"), c = {
    name: i0,
    counter: n,
    length: 64
...
}, al = "u8", cl = "u16", ul = "u32", dl = "u64", Al = "u256", ll = "raw untyped ptr", fl = "raw untyped slice", hl = "bool", gl = "b256", pl = "struct B512", Jn = "enum Option", ml = "struct Vec", wl = "struct Bytes", yl = "struct String", Il = "str", u0 = /str\[(?<length>[0-9]+)\]/, Ci = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, d0 = /^struct (?<name>\w+)$/, A0 = /^enum (?<name>\w+)$/, El = /^\((?<items>.*)\)$/, bl = /^generic (?<name>\w+)$/, ds = "1", ge = 8, pn = 32, As = pn + 2, ls = pn, Cl = pn, Bl = pn, xl = ge * 4, _l = ge * 2, l0 = 2 ** 32 - 1, f0 = ({ maxInputs: e }) => pn + // Tx ID
ls + // Base asset ID
...
var Dl = class extends ce {
  ...
  getArgSignaturePrefix() {
    return d0.test(this.type) ? "s" : Ci.test(this.type) ? "a" : A0.test(this.type) ? "e" : "";
  }
...
}, ln = new WeakMap(), vc), jn = class extends _s {
  constructor() {
    super("TxPointer", {
...
const N0 = /* @__PURE__ */ BigInt(0), vs = /* @__PURE__ */ BigInt(1), ef = /* @__PURE__ */ BigInt(2);
function Tn(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
function Nr(e) {
...
function af(e, t, n) {
  return e | (n ? vs : N0) << BigInt(t);
}
const wo = (e) => (ef << BigInt(e - 1)) - vs, ii = (e) => new Uint8Array(e), Oa = (e) => Uint8Array.from(e);
function F0(e, t, n) {
...
function _f(e, t, n) {
  ...
  if (i === 46 && (o = !0, i = r.charCodeAt(++s), s = ai(e, s, i), i = r.charCodeAt(s)), (i === 69 || i === 101) && (o = !0, i = r.charCodeAt(++s), (i === 43 || i === 45) && (i = r.charCodeAt(++s)), s = ai(e, s, i), i = r.charCodeAt(s)), i === 46 || P0(i))
    throw ht(
      e.source,
      s,
...
Qs.ReactNativeFile = Z0;
Qs.extractFiles = oh;
Qs.isExtractableFile = W0;
...
var J0 = Qs, uh = ch(ah), dh = Fr, Ah = function(e) {
...
class iu extends su {
  ...
  digestInto(t) {
    Is(this), Ns(t, this.outputLen), this.finished = !0, this.iHash.digestInto(t), this.oHash.update(t), this.oHash.digestInto(t), this.destroy();
  }
  digest() {
    const t = new Uint8Array(this.oHash.outputLen);
    return this.digestInto(t), t;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const gt = BigInt(0), ke = BigInt(1), _n = BigInt(2), ag = BigInt(3), Ti = BigInt(4), qa = BigInt(5), ja = BigInt(8);
BigInt(9);
BigInt(16);
function Et(e, t) {
  const n = e % t;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Au = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Ka = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), vg = BigInt(1), Mi = BigInt(2), ec = (e, t) => (e + t / Mi) / t;
function Rg(e) {
  const t = Au, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), A = BigInt(88), h = e * e * e % t, E = h * h * e % t, w = _t(E, n, t) * E % t, x = _t(w, n, t) * E % t, _ = _t(x, Mi, t) * h % t, R = _t(_, s, t) * _ % t, C = _t(R, i, t) * R % t, F = _t(C, c, t) * C % t, T = _t(F, A, t) * F % t, z = _t(T, c, t) * C % t, k = _t(z, n, t) * E % t, J = _t(k, o, t) * R % t, O = _t(J, r, t) * h % t, M = _t(O, Mi, t);
  if (!Oi.eql(Oi.sqr(M), e))
    throw new Error("Cannot find square root");
  return M;
}
const Oi = gg(Au, void 0, void 0, { sqrt: Rg }), sn = _g({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
...
Be.prototype.once = function(t, n) {
  return Ds(n), this.on(t, gu(this, t, n)), this;
};
Be.prototype.prependOnceListener = function(t, n) {
  return Ds(n), this.prependListener(t, gu(this, t, n)), this;
};
...
function fm(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const n = _e(e.sender), r = _e(e.recipient), s = _e(e.nonce), i = B(e.amount), o = e.data ? X(e.data) : Uint8Array.from([]), c = _e(e.digest), A = ms.getMessageId({
        sender: n,
        recipient: r,
        nonce: s,
        amount: i,
    ...
    case "BURN": {
      const n = _e(e.id || e.contractId), r = _e(e.subId), s = _i.getAssetId(n, r);
      return {
        type: ue.Burn,
        subId: r,
        contractId: n,
...
}, ar = (e) => e.type === Ce.Coin, No = (e) => e.type === Ce.Message, gn = (e) => ar(e) || No(e), Nu = (e) => ar(e) ? e.owner : e.recipient, Ui = (e, t) => Nu(e) === t.toB256(), Em = (e, t, n) => e.filter(gn).reduce((r, s) => ar(s) && s.assetId === t || No(s) && t === n ? r.add(s.amount) : r, B(0)), Zy = (e) => e.filter(gn).reduce(
  ...
  return Lm(t).reduce((h, E) => {
    ...
    return w ? o.reduce((_, R) => {
      ...
      if (R.to === w.contractID) {
        let F;
        if (R.assetId !== xe ? F = Es(e, R.assetId) : F = Es(e), F) {
...
`)
  ...
  async sendTransaction(e, { estimateTxDependencies: t = !0 } = {}) {
    const n = yt(e);
    Li(this, Hi, ku).call(this, n.inputs), t && await this.estimateTxDependencies(n);
...
var pw = "https://cdn.fuel.network/assets/", mw = [
  ...
  const t = ww(e);
  await bo();
  const n = Ph(16, 0, Gh.ScriptData), r = Va(17, 16, 32), s = Di(18, 17, 0), i = Va(19, 17, 8), o = kh(16, 18, 19), c = nu(1);
...
}, Ac = 13, lc = 8, fc = 1, hi = 32, Ew = 16, hc = (e) => /^0x/.test(e) ? e.slice(2) : e;
async function bw(e, t, n) {
  const r = fn(hc(e), "hex"), s = de.fromAddressOrString(t), i = Ft(hi), o = o0({
    password: fn(n),
    salt: i,
    dklen: hi,
    n: 2 ** Ac,
...
var Ln = class {
  ...
  static fromMnemonic(e, t, n, r) {
    const s = Oo.mnemonicToSeed(e, n), o = mi.fromSeed(s).derivePath(t || bt.defaultPath);
...
var It, xn, Ut, Xi, Wu, Vi, Ju, qu = class extends Iu.EventEmitter {
  ...
  async loadState() {
    ...
    if (e) {
      ...
      Dt(this, It, Li(this, Vi, Ju).call(this, t.vaults));
    }
  }
  /**
  ...
  async saveState() {
    ...
    const e = await $A(Se(this, xn), {
      vaults: Li(this, Xi, Wu).call(this, Se(this, It))
    });
...
var $w = (e) => e === ue.Return || e === ue.ReturnData, Kw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const E = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], F = h, T = F + ge, z = T + ls, k = z + Cl + ge + ge, J = k + C.fnSelectorBytes.byteLength, O = X(C.data);
      let M = 0;
