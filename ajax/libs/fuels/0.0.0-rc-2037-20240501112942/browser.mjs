...
var PI = (e) => {
  ...
  return n;
}, x0 = 37, eA = BigInt(2 ** 62) + BigInt(x0), v0 = (e) => Math.floor(e / 1e3), tA = (e) => e * 1e3, _0 = (e) => Number(BigInt(e) - eA), D0 = (e) => String(BigInt(e) + eA), R0 = (e) => tA(_0(e)), us = class extends Date {
  /**
...
const dA = Hr(() => new Il()), ts = BigInt(2 ** 32 - 1), Ji = BigInt(32);
function uA(e, t = !1) {
...
Object.freeze(lr);
const ql = new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), pA = Uint8Array.from({ length: 16 }, (e, t) => t), Wl = pA.map((e) => (9 * e + 5) % 16);
let Qo = [pA], xo = [Wl];
for (let e = 0; e < 4; e++)
  for (let t of [Qo, xo])
...
].map((e) => new Uint8Array(e)), $l = Qo.map((e, t) => e.map((n) => mA[t][n])), zl = xo.map((e, t) => e.map((n) => mA[t][n])), Kl = new Uint32Array([0, 1518500249, 1859775393, 2400959708, 2840853838]), eh = new Uint32Array([1352829926, 1548603684, 1836072691, 2053994217, 0]), ns = (e, t) => e << t | e >>> 32 - t;
function Sa(e, t, n, r) {
...
class th extends Co {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      ...
      for (let O = 0; O < 16; O++) {
        const k = ns(r + Sa(v, i, c, h) + rs[N[O]] + C, L[O]) + E | 0;
        r = E, E = h, h = ns(c, 10) | 0, c = i, i = k;
      }
      for (let O = 0; O < 16; O++) {
        const k = ns(s + Sa(_, o, u, I) + rs[G[O]] + M, V[O]) + b | 0;
...
class dh extends _o {
  ...
  digestInto(t) {
    er(this), QA(t, this), this.finished = !0;
    const { buffer: n, view: r, blockLen: s, isLE: i } = this;
    let { pos: o } = this;
    n[o++] = 128, this.buffer.subarray(o).fill(0), this.padOffset > s - o && (this.process(r, 0), o = 0);
    for (let E = o; E < s; E++)
...
function mh(e, t, n) {
  ...
  const _ = RA(Yr, e, t, { c: 1, dkLen: E * o }), C = hs(_), M = hs(new Uint8Array(E * s)), N = hs(new Uint8Array(E));
  let G = () => {
  };
  if (I) {
...
const ss = /* @__PURE__ */ BigInt(2 ** 32 - 1), ka = /* @__PURE__ */ BigInt(32);
function Ih(e, t = !1) {
  return t ? { h: Number(e & ss), l: Number(e >> ka & ss) } : { h: Number(e >> ka & ss) | 0, l: Number(e & ss) | 0 };
}
function yh(e, t = !1) {
  let n = new Uint32Array(e.length), r = new Uint32Array(e.length);
  for (let s = 0; s < e.length; s++) {
...
const Bh = (e, t, n) => e << n | t >>> 32 - n, Ch = (e, t, n) => t << n | e >>> 32 - n, bh = (e, t, n) => t << n - 32 | e >>> 64 - n, Qh = (e, t, n) => e << n - 32 | t >>> 64 - n, [SA, NA, kA] = [[], [], []], xh = /* @__PURE__ */ BigInt(0), mr = /* @__PURE__ */ BigInt(1), vh = /* @__PURE__ */ BigInt(2), _h = /* @__PURE__ */ BigInt(7), Dh = /* @__PURE__ */ BigInt(256), Rh = /* @__PURE__ */ BigInt(113);
...
}, UA = "u8", GA = "u16", HA = "u32", JA = "u64", YA = "u256", ZA = "raw untyped ptr", VA = "raw untyped slice", XA = "bool", jA = "b256", qA = "struct B512", No = "enum Option", ko = "struct Vec", Mo = "struct Bytes", Oo = "struct String", WA = "str", To = /str\[(?<length>[0-9]+)\]/, Qs = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Lo = /^struct (?<name>\w+)$/, Fo = /^enum (?<name>\w+)$/, $A = /^\((?<items>.*)\)$/, Kh = /^generic (?<name>\w+)$/, Ut = "0", nr = "1", ee = 8, bn = 32, Zi = bn + 2, kn = bn, zA = bn, ef = bn, tf = ee * 4, nf = ee * 2, Po = 2 ** 32 - 1, Ws = ({ maxInputs: e }) => bn + // Tx ID
kn + // Base asset ID
...
}, df = (e) => e === ko || e === Mo || e === Oo, Dr = (e) => e % ee === 0, ed = (e) => ee - e % ee, td = (e) => {
  if (Dr(e.length))
    return e;
...
), qn, In, Gs, id, Hs, od, Yc, sd = (Yc = class extends ie {
  constructor(t, n) {
...
}, qn = new WeakMap(), In = new WeakMap(), Gs = new WeakSet(), id = function(t) {
...
var Wn, Zc, gf = (Zc = class extends ie {
  ...
  decode(t, n) {
    ...
    return [Object.keys(this.coders).reduce((i, o) => {
      ...
      let u;
      return [u, r] = c.decode(t, r), Dr(r) || (r += ed(r)), i[o] = u, i;
    }, {}), r];
  }
}, dd = class extends ie {
  constructor(t) {
  ...
  decode(t, n) {
    ...
    return [this.coders.map((i) => {
      let o;
      return [o, r] = i.decode(t, r), Dr(r) || (r += ed(r)), o;
    }), r];
  }
}, ud = class extends ie {
  constructor(t) {
...
var Tn = (e, t) => {
  ...
  if (e.type === ko) {
    const v = hd(r), _ = new en(e.abi, v), C = Tn(_, { isSmallBytes: !0, encoding: Ut });
    return new ud(C);
  }
...
var Ef = (e) => Object.values(e).every(
  // @ts-expect-error complicated types
  ({ type: t, coders: n }) => t === "()" && JSON.stringify(n) === JSON.stringify([])
), $n, zn, Js, pd, Ys, md, Vc, gd = (Vc = class extends ie {
  constructor(t, n) {
    const r = new R("u64"), s = Object.values(n).reduce(
      (i, o) => Math.max(i, o.encodedLength),
      0
...
}, $n = new WeakMap(), zn = new WeakMap(), Js = new WeakSet(), pd = function(t) {
...
var yf = class extends ie {
  ...
  if (e.type === ko) {
    const v = hd(r), _ = new en(e.abi, v), C = Ln(_);
    return new Cf(C);
  }
  const i = (I = Lo.exec(e.type)) == null ? void 0 : I.groups;
  if (i) {
...
}, Zs, Id, Vs, yd, Xs, Bd, jc, ps = (jc = class {
  constructor(e, t) {
    mt(this, Zs);
    mt(this, Vs);
    mt(this, Xs);
    ...
    S(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = pf(this.jsonAbi, t), this.name = t, this.signature = ps.getSignature(this.jsonAbi, this.jsonFn), this.selector = ps.getFunctionSelector(this.signature), this.selectorBytes = new Ho().encode(t), this.encoding = ld(e.encoding), this.isInputDataPointer = cn(this, Zs, Id).call(this), this.outputMetadata = {
...
var Br = (e) => e instanceof Cd ? e.address : e instanceof xf ? e.id : e, Nf = () => X(Xt(32)), kf = (e) => {
  let t;
  try {
    if (!qi(e))
      throw new x(
...
const rn = Uf;
var yn, qc, we = (qc = class extends ie {
  constructor(t) {
...
}, yn = new WeakMap(), qc), sr = class extends $s {
  constructor() {
    super("TxPointer", {
...
const qf = (e, t, n) => e | (n ? zs : Rd) << BigInt(t), qo = (e) => (Jf << BigInt(e - 1)) - zs, _i = (e) => new Uint8Array(e), ac = (e) => Uint8Array.from(e);
function kd(e, t, n) {
...
class Jd {
  constructor(t, n = "GraphQL request", r = {
    ...
    typeof t == "string" || ws(!1, `Body must be a string. Received: ${Hd(t)}.`), this.body = t, this.name = n, this.locationOffset = r, this.locationOffset.line > 0 || ws(
      !1,
...
function Pg(e, t, n = Td) {
  ...
  do {
    ...
    if (!Array.isArray(h)) {
      var _, C;
      dc(h) || ws(!1, `Invalid AST Node: ${Hd(h)}.`);
...
var jg = typeof self == "object" ? self.FormData : window.FormData, jr = {};
...
var qg = Be && Be.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty($o, "__esModule", { value: !0 });
var qd = ti, Wg = qg(jg), $g = jr, zg = function(e) {
  return qd.isExtractableFile(e) || e !== null && typeof e == "object" && typeof e.pipe == "function";
};
function Kg(e, t, n, r) {
  r === void 0 && (r = $g.defaultJsonSerializer);
  var s = qd.extractFiles({ query: e, variables: t, operationName: n }, "", zg), i = s.clone, o = s.files;
  if (o.size === 0) {
    if (!Array.isArray(e))
  ...
  var u = typeof FormData > "u" ? Wg.default : FormData, h = new u();
...
var qr = {}, op = Be && Be.__extends || function() {
  var e = function(t, n) {
...
function Wd() {
  return fc || (fc = 1, function(e) {
    ...
    var h = s(zf), I = h, E = kg, b = Yg, v = u($o), _ = jr, C = bt, M = qr;
...
const { bytesToNumberBE: qp, hexToBytes: Wp } = $f, Rn = {
  ...
  _parseInt(e) {
    ...
    return { d: qp(r), l: e.subarray(n + 2) };
  },
  toSig(e) {
    const { Err: t } = Rn, n = typeof e == "string" ? Wp(e) : e;
    if (!jt(n))
...
var Ko = { exports: {} }, Xn = typeof Reflect == "object" ? Reflect : null, bc = Xn && typeof Xn.apply == "function" ? Xn.apply : function(t, n, r) {
...
var Dm = class {
  ...
  sideNodesForRoot(e, t) {
    ...
    for (let h = 0; h < Kt; h += 1) {
      if ([s, i] = ym(r), Jn(e, h) === 1 ? (c = s, o = i) : (c = i, o = s), n.push(c), o === vt) {
        r = "";
        break;
      }
...
${Cp}#variant.${e.reason}`), { errorMessage: t, reason: n };
}, Ir = (e) => JSON.stringify(e, null, 2), YE = (e, t) => {
...
}, gr = (e) => e.type === me.Coin, sa = (e) => e.type === me.Message, Ar = (e) => gr(e) || sa(e), VE = (e) => gr(e) ? e.owner : e.recipient, _c = (e, t) => VE(e) === t.toB256(), XE = (e, t, n) => e.filter(Ar).reduce((r, s) => gr(s) && s.assetId === t || sa(s) && t === n ? r.add(s.amount) : r, Q(0)), py = (e) => e.filter(Ar).reduce(
  ...
  (n, r) => (gr(r) && r.owner === t.toB256() ? n.utxos.push(r.id) : sa(r) && r.recipient === t.toB256() && n.messages.push(r.nonce), n),
  {
    utxos: [],
    messages: []
  }
  ...
  getBaseTransaction() {
    var i, o, c;
    const e = ((i = this.inputs) == null ? void 0 : i.map(NE)) ?? [], t = ((o = this.outputs) == null ? void 0 : o.map(kE)) ?? [], n = ((c = this.witnesses) == null ? void 0 : c.map(qE)) ?? [], { policyTypes: r, policies: s } = Or.getPolicyMeta(this);
    return {
      policyTypes: r,
      inputs: e,
      outputs: t,
...
var WE = (e) => {
  ...
  const N = vu({
    ...
    metadataGas: C,
    txBytesSize: h.length
  }), G = (T = _.find((P) => P.type === Mt.WitnessLimit)) == null ? void 0 : T.data, L = b.reduce((P, q) => P + q.dataLength, 0), V = ra({
    gasPerByte: c,
    minGas: N,
    witnessesLength: L,
    gasLimit: M,
...
function si(e) {
  ...
  }), { isStatusFailure: L, isStatusPending: V, isStatusSuccess: O, blockId: k, status: T, time: P } = Dw(c), q = xw(n), H = vw(n);
  let Y;
...
var xy = [
  ...
  const t = Pw(e);
  await zo();
  const n = _p(16, 0, Rp.ScriptData), r = pc(17, 16, 32), s = Qr(18, 17, 0), i = pc(19, 17, 8), o = xp(16, 18, 19), c = nu(1);
...
async function Jw(e, t, n) {
  const r = Bn(Oc(e), "hex"), s = de.fromAddressOrString(t), i = Xt(Mi), o = TA({
    ...
    r: kc,
    p: Mc
  }), c = Xt(Hw), u = await Xh(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...u]), I = LA(h), E = yr(I, "hex"), b = {
    id: cm(),
    version: 3,
...
async function Yw(e, t) {
  const n = JSON.parse(e), {
    ...
    r: u,
    dklen: o
  }), M = Uint8Array.from([...C.subarray(16, 32), ...E]), N = LA(M), G = yr(N, "hex");
  if (r !== G)
    throw new x(
      D.INVALID_PASSWORD,
...
var Ww = lo("Bitcoin seed"), $w = "0x0488ade4", zw = "0x04358394", Tc = [12, 15, 18, 21, 24];
function Lc(e) {
  if (e.length !== 2048)
    throw new x(
      D.INVALID_WORD_LIST,
...
var Fn = class {
  ...
  static fromExtendedKey(e) {
    const t = W0(K0(e)), n = J(t), r = Fc(n.slice(0, 78)) === e;
    if (n.length !== 82 || !nI(n))
...
var vy = class {
  ...
  getIndexFromPlaceholderWitness(t) {
    var i;
    const n = t.inputs.filter(Ar).filter((o) => _c(o, this.address));
    let r = -1;
...
var lI = 2e3, hI = 5e3, { warn: fI } = console, vr = class extends AI {
  ...
  async pingConnector(t) {
    ...
    if (!n)
      return !1;
    try {
      return await dI(async () => As(n.ping()), {
        key: n.name,
  ...
  async selectConnector(t, n = {
    ...
    return s ? (this._currentConnector = r, this.emit(this.events.currentConnector, r), this.setupConnectorEvents(Object.values(ua)), await ((o = this._storage) == null ? void 0 : o.setItem(vr.STORAGE_KEY, r.name)), n.emitEvents && this.triggerConnectorEvents(), !0) : !1;
  }
  /**
  ...
  async hasConnector() {
    ...
    return this.once(this.events.currentConnector, () => {
      t.resolve(!0);
    }), As(t.promise, lI).then(() => !0).catch(() => !1);
  }
  async hasWallet() {
...
}, Vt = new WeakMap(), Wc), gI = (e) => Uo + Ws({ maxInputs: e }), r0 = ee + kn + zA + ee + ee;
function pI(e) {
  const t = [...e.receipts];
  let n, r;
  if (t.forEach((i) => {
...
var Hc = (e) => e === Ae.Return || e === Ae.ReturnData, wI = (e, t) => e.find(
  ...
  var E;
  const n = [], r = t, s = r + ee, i = s + kn, o = i + zA + ee + ee, c = o + e.fnSelectorBytes.byteLength, u = J(e.data);
  let h = 0;
