...
var er, Jc, yh = (Jc = class extends oe {
  ...
  return n;
}, Oa = (e, t) => t.filter((n) => rn(e, n.type).type !== "()"), pu = (e) => {
  var r;
...
var Un = (e, t) => {
  ...
  if (e.type === Qo) {
    const v = pu(r), R = new tn(e.abi, v), B = Un(R, { isSmallBytes: !0, encoding: Ut });
    return new hu(B);
  }
...
var xh = class extends oe {
  ...
  if (e.type === Qo) {
    const v = pu(r), R = new tn(e.abi, v), B = Gn(R);
    return new vh(B);
  }
  const i = (I = Oo.exec(e.type)) == null ? void 0 : I.groups;
  if (i) {
...
var Br = (e) => e instanceof _u ? e.address : e instanceof Dh ? e.id : e, Oh = () => Z(Jt(32)), Lh = (e) => {
  let t;
  try {
    if (!Zi(e))
      throw new _(
...
function em(e) {
  ...
  class w {
    ...
    multiplyAndAddUnsafe(B, M, T) {
      const H = w.BASE, k = (O, F) => F === nn || F === Nt || !O.equals(H) ? O.multiplyUnsafe(F) : O.multiply(F), J = k(this, M).add(k(B, T));
...
${_p}#variant.${e.reason}`), { errorMessage: t, reason: n };
  ...
  fundWithFakeUtxos(e, t, n) {
    const r = (i) => this.inputs.find((o) => "assetId" in o ? o.assetId === i : !1), s = (i, o) => {
      const c = r(i);
      let A = o;
      i === t && (A = x("1000000000000000000")), c && "assetId" in c ? (c.id = Z(Jt(Vi)), c.amount = A) : this.addResources([
        {
          id: Z(Jt(Vi)),
          amount: A,
          assetId: i,
...
`)
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    const s = Zt(bt(e)), i = s.type === Le.Script, o = this.getBaseAssetId(), c = s.maxFee.eq(0), A = s.getCoinOutputsQuantities(), f = Oy(A, r);
    ...
    return s.maxFee = C, i && (s.gasLimit = T, n && await n(s), { receipts: H, missingContractIds: J, outputVariables: O, dryRunStatus: k } = await this.estimateTxDependencies(s), F = i ? R0(H) : F, s.gasLimit = F, { maxFee: C, maxGas: v, minFee: R, minGas: B, gasPrice: M } = await this.estimateTxGasAndFee({
...
var Nb = [
  ...
  async fund(t, n) {
    var T;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, c = t.maxFee, A = this.provider.getBaseAssetId(), f = ((T = i.find((H) => H.assetId === A)) == null ? void 0 : T.amount) || x(0), I = Mm({
      amount: x(c),
      assetId: A,
      coinQuantities: i
    }), w = {};
    I.forEach(({ amount: H, assetId: k }) => {
      ...
      const J = oa(H) ? String(H.assetId) : A;
    ...
    for (; v && R < Zy; ) {
      ...
      t.addResources(H), t.shiftPredicateData(), t.updatePredicateGasUsed(s);
      const k = Zt(t);
  ...
  static generatePrivateKey(e) {
    return e ? on(re([Jt(32), X(e)])) : Jt(32);
  }
  /**
...
async function Wy(e, t, n) {
  const r = En(kc(e), "hex"), s = Ae.fromAddressOrString(t), i = Jt(Qi), o = Pd({
    password: En(n),
    salt: i,
    dklen: Qi,
    n: 2 ** Mc,
    r: Oc,
    p: Lc
  }), c = Jt(Jy), A = await $f(r, o, c), f = Uint8Array.from([...o.subarray(16, 32), ...A]), I = Ud(f), w = Cr(I, "hex"), C = {
    id: Am(),
    version: 3,
...
var Hn = class {
  ...
  static fromMnemonic(e, t, n, r) {
    const s = aa.mnemonicToSeed(e, n), o = Mi.fromSeed(s).derivePath(t || Bt.defaultPath);
...
var Et, Qn, Yt, lo, K0, fo, eA, tA = class extends y0.EventEmitter {
  constructor(e) {
    super(), wn(this, lo), wn(this, fo), Fe(this, "storage", new uI()), Fe(this, "STORAGE_KEY", "WalletManager"), wn(this, Et, []), wn(this, Qn, ""), wn(this, Yt, !0), this.storage = (e == null ? void 0 : e.storage) || this.storage;
  }
  get isLocked() {
    return Se(this, Yt);
  }
