...
var x = (e, t, n) => (H0(e, typeof t != "symbol" ? t + "" : t, n), n), Ti = (e, t, n) => {
  if (!t.has(e))
...
const tl = {}, nl = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: tl
}, Symbol.toStringTag, { value: "Module" })), rl = /* @__PURE__ */ To(nl);
Po.exports;
(function(e) {
  (function(t, n) {
    function r(B, c) {
    ...
    var Z = function(c, A, l) {
      ...
      y = (m + (u >>> 13) | 0) + (Ei >>> 26) | 0, Ei &= 67108863, g = Math.imul(ne, Ye), u = Math.imul(ne, Ve), u = u + Math.imul(re, Ye) | 0, m = Math.imul(re, Ve), g = g + Math.imul(V, Xe) | 0, u = u + Math.imul(V, je) | 0, u = u + Math.imul($, Xe) | 0, m = m + Math.imul($, je) | 0;
      var Ii = (y + g | 0) + ((u & 8191) << 13) | 0;
      y = (m + (u >>> 13) | 0) + (Ii >>> 26) | 0, Ii &= 67108863, g = Math.imul(fe, Ye), u = Math.imul(fe, Ve), u = u + Math.imul(ae, Ye) | 0, m = Math.imul(ae, Ve), g = g + Math.imul(ne, Xe) | 0, u = u + Math.imul(ne, je) | 0, u = u + Math.imul(re, Xe) | 0, m = m + Math.imul(re, je) | 0, g = g + Math.imul(V, qe) | 0, u = u + Math.imul(V, We) | 0, u = u + Math.imul($, qe) | 0, m = m + Math.imul($, We) | 0;
      var yi = (y + g | 0) + ((u & 8191) << 13) | 0;
      y = (m + (u >>> 13) | 0) + (yi >>> 26) | 0, yi &= 67108863, g = Math.imul(le, Ye), u = Math.imul(le, Ve), u = u + Math.imul(ge, Ye) | 0, m = Math.imul(ge, Ve), g = g + Math.imul(fe, Xe) | 0, u = u + Math.imul(fe, je) | 0, u = u + Math.imul(ae, Xe) | 0, m = m + Math.imul(ae, je) | 0, g = g + Math.imul(ne, qe) | 0, u = u + Math.imul(ne, We) | 0, u = u + Math.imul(re, qe) | 0, m = m + Math.imul(re, We) | 0, g = g + Math.imul(V, $e) | 0, u = u + Math.imul(V, Ke) | 0, u = u + Math.imul($, $e) | 0, m = m + Math.imul($, Ke) | 0;
      var Bi = (y + g | 0) + ((u & 8191) << 13) | 0;
      y = (m + (u >>> 13) | 0) + (Bi >>> 26) | 0, Bi &= 67108863, g = Math.imul(Re, Ye), u = Math.imul(Re, Ve), u = u + Math.imul(ye, Ye) | 0, m = Math.imul(ye, Ve), g = g + Math.imul(le, Xe) | 0, u = u + Math.imul(le, je) | 0, u = u + Math.imul(ge, Xe) | 0, m = m + Math.imul(ge, je) | 0, g = g + Math.imul(fe, qe) | 0, u = u + Math.imul(fe, We) | 0, u = u + Math.imul(ae, qe) | 0, m = m + Math.imul(ae, We) | 0, g = g + Math.imul(ne, $e) | 0, u = u + Math.imul(ne, Ke) | 0, u = u + Math.imul(re, $e) | 0, m = m + Math.imul(re, Ke) | 0, g = g + Math.imul(V, ze) | 0, u = u + Math.imul(V, et) | 0, u = u + Math.imul($, ze) | 0, m = m + Math.imul($, et) | 0;
      ...
      var bi = (y + g | 0) + ((u & 8191) << 13) | 0;
      y = (m + (u >>> 13) | 0) + (bi >>> 26) | 0, bi &= 67108863, g = Math.imul(Le, Ye), u = Math.imul(Le, Ve), u = u + Math.imul(Te, Ye) | 0, m = Math.imul(Te, Ve), g = g + Math.imul(_e, Xe) | 0, u = u + Math.imul(_e, je) | 0, u = u + Math.imul(Me, Xe) | 0, m = m + Math.imul(Me, je) | 0, g = g + Math.imul(Re, qe) | 0, u = u + Math.imul(Re, We) | 0, u = u + Math.imul(ye, qe) | 0, m = m + Math.imul(ye, We) | 0, g = g + Math.imul(le, $e) | 0, u = u + Math.imul(le, Ke) | 0, u = u + Math.imul(ge, $e) | 0, m = m + Math.imul(ge, Ke) | 0, g = g + Math.imul(fe, ze) | 0, u = u + Math.imul(fe, et) | 0, u = u + Math.imul(ae, ze) | 0, m = m + Math.imul(ae, et) | 0, g = g + Math.imul(ne, tt) | 0, u = u + Math.imul(ne, nt) | 0, u = u + Math.imul(re, tt) | 0, m = m + Math.imul(re, nt) | 0, g = g + Math.imul(V, rt) | 0, u = u + Math.imul(V, st) | 0, u = u + Math.imul($, rt) | 0, m = m + Math.imul($, st) | 0;
...
const El = BigInt(0), ho = BigInt(58);
function DA(e) {
  let t = pl(Gt(e)), n = "";
  for (; t; )
...
const _A = Ir(() => new Jl()), us = BigInt(2 ** 32 - 1), go = BigInt(32);
function kA(e, t = !1) {
  return t ? { h: Number(e & us), l: Number(e >> go & us) } : { h: Number(e >> go & us) | 0, l: Number(e & us) | 0 };
}
function Zl(e, t = !1) {
...
const Yl = (e, t) => BigInt(e >>> 0) << go | BigInt(t >>> 0), Vl = (e, t, n) => e >>> n, Xl = (e, t, n) => e << 32 - n | t >>> n, jl = (e, t, n) => e >>> n | t << 32 - n, ql = (e, t, n) => e << 32 - n | t >>> n, Wl = (e, t, n) => e << 64 - n | t >>> n - 32, $l = (e, t, n) => e >>> n - 32 | t << 64 - n, Kl = (e, t) => t, zl = (e, t) => e, eh = (e, t, n) => e << n | t >>> 32 - n, th = (e, t, n) => t << n | e >>> 32 - n, nh = (e, t, n) => t << n - 32 | e >>> 64 - n, rh = (e, t, n) => e << n - 32 | t >>> 64 - n;
function sh(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
var po = (e) => ai.getRandomValues(new Uint8Array(e)), Bs = (e, t = "base64") => {
  switch (t) {
    case "utf-8":
  ...
  const n = po(16), r = po(32), s = Ko(e, r), i = JSON.stringify(t), o = Wn(i, "utf-8"), a = {
    name: fu,
    counter: n,
    length: 64
  ...
  const r = ai.subtle, s = new Uint8Array(t.subarray(0, 16)), i = n, o = e, a = await r.importKey(
    "raw",
    s,
  ...
  const r = ai.subtle, s = new Uint8Array(t.subarray(0, 16)).buffer, i = new Uint8Array(n).buffer, o = new Uint8Array(e).buffer, a = await r.importKey(
    "raw",
    s,
    { name: "AES-CTR", length: 128 },
    !1,
...
var Lr = (e) => e % z === 0, Su = (e) => z - e % z, _u = (e) => {
...
}, to, Ys, Mu, mo = (to = class extends oe {
  constructor() {
...
}, x(to, "memorySize", 1), to), Wf = (e) => Object.values(e).every(
...
}, no, js, Uu, Kf = (no = class extends oe {
  constructor() {
  ...
  return r && n.push(new Uint8Array(r)), se(n);
}, x(no, "memorySize", 1), no), ir, pA, zf = (pA = class extends oe {
  constructor(t) {
    let n = (8 - t) % 8;
    n = n < 0 ? n + 8 : n;
...
}, ir = new WeakMap(), pA), Ai = class extends oe {
  constructor(t, n) {
...
var Un = (e, t) => {
  ...
  if (e.type === ea) {
    ...
    const b = new ui(e.abi, F), N = Un(b, { isSmallBytes: !0, encoding: Or });
    return new Hu(N);
  }
...
}, x(ro, "memorySize", 1), ro), ng = (e) => Object.values(e).every(
  // @ts-expect-error complicated types
  ({ type: t, coders: n }) => t === "()" && JSON.stringify(n) === JSON.stringify([])
  ...
  encode(e) {
    if (!Array.isArray(e))
      throw new v(R.ENCODE_ERROR, "Expected array value.");
    const n = new ht(new wo("u8"), e.length).encode(e), r = new S("u64").encode(n.length);
...
}, x(so, "memorySize", 1), so), io, ig = (io = class extends oe {
  constructor() {
...
}, x(io, "memorySize", 1), io), og = class extends oe {
  constructor(e) {
...
var Yn = class {
  ...
  try {
    ...
    return t instanceof Hu ? t.coder.encodedLength : t instanceof mo ? mo.memorySize : t.encodedLength;
  } catch {
    return 0;
  }
}, kn), rn = class {
...
}, pn = new WeakMap(), wA), hr = class extends Ai {
  constructor() {
    super("TxPointer", {
...
const od = BigInt(0), di = BigInt(1), Cg = BigInt(2);
function jt(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
...
const Dg = (e, t, n) => e | (n ? di : od) << BigInt(t), ga = (e) => (Cg << BigInt(e - 1)) - di, Ji = (e) => new Uint8Array(e), kc = (e) => Uint8Array.from(e);
function Ad(e, t, n) {
...
function Vg(e, t) {
  ...
  for (; s < r; ) {
    ...
    throw gt(
      e.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : Cr(i) || li(n, s) ? `Unexpected character: ${Ln(e, s)}.` : `Invalid character: ${Ln(e, s)}.`
    );
  }
...
function jg(e, t, n) {
  ...
  if (i === 46 && (o = !0, i = r.charCodeAt(++s), s = Yi(e, s, i), i = r.charCodeAt(s)), (i === 69 || i === 101) && (o = !0, i = r.charCodeAt(++s), (i === 43 || i === 45) && (i = r.charCodeAt(++s)), s = Yi(e, s, i), i = r.charCodeAt(s)), i === 46 || fd(i))
    throw gt(
      e.source,
      s,
...
const lp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  parseType: dp,
  parseValue: Ap
}, Symbol.toStringTag, { value: "Module" })), hp = /* @__PURE__ */ To(lp);
function fp(e) {
...
const Cp = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  print: Bd
}, Symbol.toStringTag, { value: "Module" })), bp = /* @__PURE__ */ To(Cp);
var ma = {}, fi = {}, Cd = function(t) {
...
fi.ReactNativeFile = Cd;
fi.extractFiles = vp;
fi.isExtractableFile = bd;
...
var Qd = fi, Rp = Dp(Fp), Np = rs, Sp = function(e) {
...
var vs = /* @__PURE__ */ new Map(), vo = /* @__PURE__ */ new Map(), Dd = !0, Js = !1;
function Rd(e) {
...
function $p(e) {
  ...
  return e.definitions.forEach(function(r) {
    if (r.kind === "FragmentDefinition") {
      var s = r.name.value, i = Wp(r.loc), o = vo.get(s);
...
wa();
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const pt = BigInt(0), Oe = BigInt(1), Rn = BigInt(2), Bm = BigInt(3), Fo = BigInt(4), Yc = BigInt(5), Vc = BigInt(8);
BigInt(9);
BigInt(16);
function bt(e, t) {
  const n = e % t;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ud = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), jc = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), Hm = BigInt(1), Ro = BigInt(2), qc = (e, t) => (e + t / Ro) / t;
function Jm(e) {
  const t = Ud, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), a = BigInt(44), d = BigInt(88), h = e * e * e % t, I = h * h * e % t, E = Nt(I, n, t) * I % t, C = Nt(E, n, t) * I % t, D = Nt(C, Ro, t) * h % t, F = Nt(D, s, t) * D % t, b = Nt(F, i, t) * F % t, N = Nt(b, a, t) * b % t, _ = Nt(N, d, t) * N % t, Z = Nt(_, a, t) * b % t, T = Nt(Z, n, t) * I % t, X = Nt(T, o, t) * F % t, M = Nt(X, r, t) * h % t, k = Nt(M, Ro, t);
  if (!No.eql(No.sqr(k), e))
    throw new Error("Cannot find square root");
  return k;
}
const No = Rm(Ud, void 0, void 0, { sqrt: Jm }), dn = Gm({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
...
function gE(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const N = Fe(e.sender), _ = Fe(e.recipient), Z = Fe(e.nonce), T = Q(e.amount), X = e.data ? J(e.data) : Uint8Array.from([]), M = Fe(e.digest), k = yo.getMessageId({
        sender: N,
        recipient: _,
        nonce: Z,
        amount: T,
    ...
    case "BURN": {
      const N = Fe((b = e.contract) == null ? void 0 : b.id), _ = Fe(e.subId), Z = Bo.getAssetId(N, _);
      return {
        type: ue.Burn,
        subId: _,
        contractId: N,
...
function So(e) {
  return Object.keys(e).forEach((t) => {
    const n = e[t];
    switch (!0) {
      case n instanceof ri:
        e[t] = n.toHex();
        break;
      case n instanceof me:
        e[t] = n.toB256();
        break;
...
var QE = (e) => {
  ...
  if (e instanceof er || e instanceof _o)
    return e;
  const { type: t } = e;
  switch (e.type) {
    case Et.Script:
...
var oI = (e, t) => {
  ...
  async sendTransaction(t, { estimateTxDependencies: n = !0, awaitExecution: r = !1 } = {}) {
    ...
    if (s.type === Et.Script && (o = s.abis), r) {
      ...
      const h = s.getTransactionId(this.getChainId()), I = new qi(h, this, o);
      return await I.fetch(), I;
    }
    const {
      submit: { id: a }
    } = await this.operations.submit({ encodedTransaction: i });
    return new qi(a, this, o);
  }
  /**
  ...
  async estimatePredicates(t) {
    if (!!!t.inputs.find(
      (o) => "predicate" in o && o.predicate && !cd(J(o.predicate), J("0x")) && new ri(o.predicateGasUsed).isZero()
    ))
      return t;
...
async function Ky(e) {
  ...
  return {
    transactions: i.map((C) => {
      const { node: D } = C, { id: F, rawPayload: b, receipts: N, status: _ } = D, [Z] = new bn().decode(J(b), 0), T = (N == null ? void 0 : N.map(tr)) || [], X = mi({
        id: F,
        receipts: T,
        transaction: Z,
...
var nB = [
  ...
  const { assetId: t, amountToTransfer: n, hexlifiedContractId: r } = e, i = new S("u64").encode(new ri(n).toNumber());
...
}, sA = 13, iA = 8, oA = 1, Wi = 32, mI = 16, aA = (e) => /^0x/.test(e) ? e.slice(2) : e;
async function wI(e, t, n) {
  const r = En(aA(e), "hex"), s = me.fromAddressOrString(t), i = Cn(Wi), o = gu({
    password: En(n),
    salt: i,
    dklen: Wi,
    n: 2 ** sA,
 ...
 */
x(oo, "defaultPath", "m/44'/1179993420'/0'/0/0"), oo), ms = [
  "abandon",
  "ability",
  "able",
  "about",
...
var xI = ko("Bitcoin seed"), vI = "0x0488ade4", FI = "0x04358394", cA = [12, 15, 18, 21, 24];
function AA(e) {
  if (e.length !== 2048)
    throw new v(
      R.INVALID_WORD_LIST,
...
var RI = class ln {
  ...
  static mnemonicToSeed(t, n = "") {
    Ki($i(t));
    const r = ko(CI(t)), s = ko(`mnemonic${n}`);
...
var MI = class Hn {
  ...
  static fromSeed(t, n, r) {
    const i = zi.fromSeed(t).derivePath(n || hn.defaultPath);
  ...
  static fromMnemonic(t, n, r, s) {
    const i = Da.mnemonicToSeed(t, r), a = zi.fromSeed(i).derivePath(n || hn.defaultPath);
...
}, mn = new WeakMap(), x(ao, "type", "mnemonic"), ao), co, zt, TI = (co = class {
  /**
 ...
 *
 */
x(Ar, "Vaults", [LI, TI]), Ar), Ao, sB = (Ao = class {
  constructor(e) {
  ...
  getPredicateData(n) {
    ...
    const r = (a = this.interface) == null ? void 0 : a.functions.main, s = new Ie(this.bytes.length).encode(this.bytes), o = ci({
...
}, Vt = new WeakMap(), EA), XI = (e) => ca + ci({ maxInputs: e }), F0 = z + On + Du + z + z;
function jI(e) {
  const t = [...e.receipts];
  let n, r;
  if (t.forEach((i) => {
...
var M0 = class {
  ...
  async simulate() {
    ...
    return eo.build(this.functionInvocationScopes, e, this.isMultiCall);
  }
  /**
...
var L0 = (e) => {
...
}, Oo = (e) => j(e.startsWith("0x") ? e : `0x${e}`), dB = class U0 {
  /**
  ...
  createTransactionRequest(t) {
    ...
    const s = r.stateRoot || T0(r.storageSlots), i = P0(this.bytecode, r.salt, s), o = new _o({
      gasPrice: 0,
