...
(function(e) {
  (function(t, n) {
    ...
    var Y = function(a, c, l) {
      var p = a.words, f = c.words, w = l.words, I = 0, g, u, m, Z = p[0] | 0, V = Z & 8191, $ = Z >>> 13, q = p[1] | 0, ne = q & 8191, re = q >>> 13, Ne = p[2] | 0, fe = Ne & 8191, oe = Ne >>> 13, Fe = p[3] | 0, de = Fe & 8191, ge = Fe >>> 13, Ht = p[4] | 0, De = Ht & 8191, ye = Ht >>> 13, Er = p[5] | 0, Se = Er & 8191, Me = Er >>> 13, os = p[6] | 0, Te = os & 8191, Pe = os >>> 13, va = p[7] | 0, Ue = va & 8191, Ge = va >>> 13, xa = p[8] | 0, He = xa & 8191, Je = xa >>> 13, Fa = p[9] | 0, Ze = Fa & 8191, Ye = Fa >>> 13, Da = f[0] | 0, Ve = Da & 8191, Xe = Da >>> 13, Ra = f[1] | 0, je = Ra & 8191, qe = Ra >>> 13, Na = f[2] | 0, We = Na & 8191, $e = Na >>> 13, Sa = f[3] | 0, ze = Sa & 8191, Ke = Sa >>> 13, _a = f[4] | 0, et = _a & 8191, tt = _a >>> 13, ka = f[5] | 0, nt = ka & 8191, rt = ka >>> 13, Ma = f[6] | 0, st = Ma & 8191, it = Ma >>> 13, Oa = f[7] | 0, ot = Oa & 8191, at = Oa >>> 13, La = f[8] | 0, ct = La & 8191, At = La >>> 13, Ta = f[9] | 0, ut = Ta & 8191, dt = Ta >>> 13;
...
function Tl(e, t, n, r) {
  ...
  const d = Sn(t), h = Sn(n), y = new Uint8Array(o), E = _o.create(e, d), C = E._cloneInto().update(h);
...
let Yl = class extends ko {
  ...
  process(t, n) {
    ...
    for (let E = 16; E < 64; E++) {
      const C = an[E - 15], v = an[E - 2], F = Jt(C, 7) ^ Jt(C, 18) ^ C >>> 3, b = Jt(v, 17) ^ Jt(v, 19) ^ v >>> 10;
      an[E] = b + an[E - 7] + F + an[E - 16] | 0;
    }
    let { A: r, B: s, C: i, D: o, E: A, F: d, G: h, H: y } = this;
    for (let E = 0; E < 64; E++) {
      const C = Jt(A, 6) ^ Jt(A, 11) ^ Jt(A, 25), v = y + C + Hl(A, d, h) + Zl[E] + an[E] | 0, b = (Jt(r, 2) ^ Jt(r, 13) ^ Jt(r, 22)) + Jl(r, s, i) | 0;
...
function xh(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    for (let o = 0; o < 10; o += 2) {
      const A = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = Za(h, y, 1) ^ n[A], C = Ya(h, y, 1) ^ n[A + 1];
      for (let v = 0; v < 50; v += 10)
        e[o + v] ^= E, e[o + v + 1] ^= C;
    }
    let s = e[2], i = e[3];
    for (let o = 0; o < 24; o++) {
      const A = _A[o], d = Za(s, i, A), h = Ya(s, i, A), y = SA[o];
...
class Mh extends ko {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      ...
      for (let M = 0; M < 16; M++) {
        const k = us(r + Va(v, i, A, h) + ds[_[M]] + b, T[M]) + E | 0;
...
class sf extends ef {
  ...
  process(t, n) {
    ...
    for (let E = 16; E < 64; E++) {
      const C = dn[E - 15], v = dn[E - 2], F = Zt(C, 7) ^ Zt(C, 18) ^ C >>> 3, b = Zt(v, 17) ^ Zt(v, 19) ^ v >>> 10;
      dn[E] = b + dn[E - 7] + F + dn[E - 16] | 0;
    }
    let { A: r, B: s, C: i, D: o, E: A, F: d, G: h, H: y } = this;
    for (let E = 0; E < 64; E++) {
      const C = Zt(A, 6) ^ Zt(A, 11) ^ Zt(A, 25), v = y + C + tf(A, d, h) + rf[E] + dn[E] | 0, b = (Zt(r, 2) ^ Zt(r, 13) ^ Zt(r, 22)) + nf(r, s, i) | 0;
      y = h, h = d, d = A, A = o + v | 0, o = i, i = s, s = r, r = v + b | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, i = i + this.C | 0, o = o + this.D | 0, A = A + this.E | 0, d = d + this.F | 0, h = h + this.G | 0, y = y + this.H | 0, this.set(r, s, i, o, A, d, h, y);
  }
...
function of(e, t, n, r) {
  ...
  if (Dt(i), Dt(o), Dt(A), i < 1)
    throw new Error("PBKDF2: iterations (c) should be >= 1");
  const d = ir(t), h = ir(n), y = new Uint8Array(o), E = Go.create(e, d), C = E._cloneInto().update(h);
  return { c: i, dkLen: o, asyncTick: A, DK: y, PRF: E, PRFSalt: C };
}
...
function za(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], A = e[t++] ^ n[r++], d = e[t++] ^ n[r++], h = e[t++] ^ n[r++], y = e[t++] ^ n[r++], E = e[t++] ^ n[r++], C = e[t++] ^ n[r++], v = e[t++] ^ n[r++], F = e[t++] ^ n[r++], b = e[t++] ^ n[r++], N = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], Y = e[t++] ^ n[r++], T = e[t++] ^ n[r++], X = e[t++] ^ n[r++], M = e[t++] ^ n[r++], k = o, O = A, P = d, W = h, U = y, H = E, ee = C, B = v, a = F, c = b, l = N, p = _, f = Y, w = T, I = X, g = M;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + k | 0, s[i++] = A + O | 0, s[i++] = d + P | 0, s[i++] = h + W | 0, s[i++] = y + U | 0, s[i++] = E + H | 0, s[i++] = C + ee | 0, s[i++] = v + B | 0, s[i++] = F + a | 0, s[i++] = b + c | 0, s[i++] = N + l | 0, s[i++] = _ + p | 0, s[i++] = Y + f | 0, s[i++] = T + w | 0, s[i++] = X + I | 0, s[i++] = M + g | 0;
}
...
function cf(e, t, n) {
  ...
  const F = nu($r, e, t, { c: 1, dkLen: E * o }), b = ys(F), N = ys(new Uint8Array(E * s)), _ = ys(new Uint8Array(E));
  let Y = () => {
  };
  if (y) {
...
function uf(e, t, n) {
  const { N: r, r: s, p: i, dkLen: o, blockSize32: A, V: d, B32: h, B: y, tmp: E, blockMixCb: C } = cf(e, t, n);
  for (let v = 0; v < i; v++) {
    const F = A * v;
    for (let b = 0; b < A; b++)
      d[b] = h[F + b];
...
function bf(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    for (let o = 0; o < 10; o++)
      n[o] = e[o] ^ e[o + 10] ^ e[o + 20] ^ e[o + 30] ^ e[o + 40];
    for (let o = 0; o < 10; o += 2) {
      const A = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = ec(h, y, 1) ^ n[A], C = tc(h, y, 1) ^ n[A + 1];
      for (let v = 0; v < 50; v += 10)
        e[o + v] ^= E, e[o + v + 1] ^= C;
    }
    let s = e[2], i = e[3];
    for (let o = 0; o < 24; o++) {
      const A = su[o], d = ec(s, i, A), h = tc(s, i, A), y = ru[o];
      s = e[y], i = e[y + 1], e[y] = d, e[y + 1] = h;
    }
    for (let o = 0; o < 50; o += 10) {
      for (let A = 0; A < 10; A++)
...
var On = (e, t) => {
  ...
  const o = (E = Wo.exec(e.type)) == null ? void 0 : E.groups;
  if (o) {
...
var ag = (e) => Object.values(e).every(
  ...
  decode(t, n) {
    ...
    return ag(this.coders) ? sn(this, zs, Ju).call(this, i, h) : [{ [i]: d }, h];
  }
...
function sd(e, t, n) {
  ...
  const o = () => {
    ...
    s = A(xc([0]), E), r = A(), E.length !== 0 && (s = A(xc([1]), E), r = A());
  }, h = () => {
    if (i++ >= 1e3)
...
class ca extends Error {
  ...
  constructor(t, ...n) {
    var r, s, i;
    const { nodes: o, source: A, positions: d, path: h, originalError: y, extensions: E } = Ug(n);
...
function Vg(e, t) {
  const n = e.replace(/"""/g, '\\"""'), r = n.split(/\r\n|[\n\r]/g), s = r.length === 1, i = r.length > 1 && r.slice(1).every((v) => v.length === 0 || ho(v.charCodeAt(0))), o = n.endsWith('\\"""'), A = e.endsWith('"') && !o, d = e.endsWith("\\"), h = A || d, y = !(t != null && t.minimize) && // add leading and trailing new lines only if it improves readability
  (!s || e.length > 70 || h || i || o);
  let E = "";
...
function Yp() {
  ...
  var r = rs, s = yd(), i = "connection_init", o = "connection_ack", A = "ping", d = "pong", h = "subscribe", y = "next", E = "error", C = "complete", v = (
    /** @class */
    function() {
      function M(k, O, P) {
...
function yd() {
  return kc || (kc = 1, function(e) {
    ...
    var h = s(Mg), y = h, E = pp, C = xp, v = d(Aa), F = ns, b = vt, N = rs;
        ...
        return f.prototype.rawRequest = function(w, I, g) {
          return i(this, void 0, void 0, function() {
            ...
            return o(this, function(de) {
              return u = b.parseRawRequestArgs(w, I, g), m = this.options, Z = m.headers, V = m.fetch, $ = V === void 0 ? h.default : V, q = m.method, ne = q === void 0 ? "POST" : q, re = m.requestMiddleware, Ne = m.responseMiddleware, fe = A(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, u.signal !== void 0 && (fe.signal = u.signal), Fe = B(u.query).operationName, [2, O({
                url: oe,
                query: u.query,
          ...
          for (var I = [], g = 1; g < arguments.length; g++)
            I[g - 1] = arguments[g];
          var u = I[0], m = I[1], Z = b.parseRequestArgs(w, u, m), V = this.options, $ = V.headers, q = V.fetch, ne = q === void 0 ? h.default : q, re = V.method, Ne = re === void 0 ? "POST" : re, fe = V.requestMiddleware, oe = V.responseMiddleware, Fe = A(V, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), de = this.url;
...
function Fm(e) {
  ...
  if (e % Pc === Tc) {
    const t = (e - Tc) / Pc;
    return function(r, s) {
      const i = r.mul(s, Fn), o = r.pow(i, t), A = r.mul(s, o), d = r.mul(r.mul(A, Fn), o), h = r.mul(A, r.sub(d, r.ONE));
      if (!r.eql(r.sqr(h), s))
        throw new Error("Cannot find square root");
      return h;
    };
...
function Um(e) {
  ...
  class E {
    ...
    double() {
      ...
      return H = n.add(H, H), O = n.mul(Y, X), O = n.add(O, O), M = n.mul(b, O), k = n.mul(_, U), k = n.add(M, k), M = n.sub(W, k), k = n.add(W, k), k = n.mul(M, k), M = n.mul(H, M), O = n.mul(_, O), U = n.mul(b, U), H = n.sub(P, U), H = n.mul(b, H), H = n.add(H, O), O = n.add(P, P), P = n.add(O, P), P = n.add(P, U), P = n.mul(P, H), k = n.add(k, P), U = n.mul(T, X), U = n.add(U, U), P = n.mul(U, H), M = n.sub(M, P), O = n.mul(U, W), O = n.add(O, O), O = n.add(O, O), new E(M, k, O);
    }
    ...
    multiplyUnsafe(b) {
      ...
      return Y && (k = k.negate()), X && (O = O.negate()), O = new E(n.mul(O.px, _.beta), O.py, O.pz), k.add(O);
    }
    /**
    ...
    multiply(b) {
      ...
      if (T) {
        ...
        P = v.constTimeNegate(X, P), U = v.constTimeNegate(k, U), U = new E(n.mul(U.px, T.beta), U.py, U.pz), _ = P.add(U), Y = W.add(H);
      } else {
    ...
    multiplyAndAddUnsafe(b, N, _) {
      const Y = E.BASE, T = (M, k) => k === en || k === St || !M.equals(Y) ? M.multiplyUnsafe(k) : M.multiply(k), X = T(this, N).add(T(b, _));
  ...
  const C = t.nBitLength, v = Om(E, t.endo ? Math.ceil(C / 2) : C);
  return {
    CURVE: t,
    ProjectivePoint: E,
...
function Hm(e) {
  ...
  const { ProjectivePoint: h, normPrivateKeyToScalar: y, weierstrassEquation: E, isWithinCurveOrder: C } = Um({
    ...t,
    toBytes(c, l, p) {
      const f = l.toAffine(), w = n.toBytes(f.x), I = Lr;
  ...
  class _ {
    ...
    static fromDER(l) {
      const { r: p, s: f } = Rn.toSig(Tt("DER", l));
      return new _(p, f);
    }
    assertValidity() {
      if (!C(this.r))
  ...
  function U(c, l, p = H) {
    ...
    function ne(re) {
      ...
      if (!C(Ne))
        return;
      const fe = d(Ne), oe = h.BASE.multiply(Ne).toAffine(), Fe = A(oe.x);
      if (Fe === en)
        return;
  ...
  function B(c, l, p = H) {
    ...
    return sd(I.hash.outputLen, I.nByteLength, I.hmac)(f, w);
  }
...
function Vm(e) {
  const t = Md, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), A = BigInt(44), d = BigInt(88), h = e * e * e % t, y = h * h * e % t, E = Nt(y, n, t) * y % t, C = Nt(E, n, t) * y % t, v = Nt(C, mo, t) * h % t, F = Nt(v, s, t) * v % t, b = Nt(F, i, t) * F % t, N = Nt(b, A, t) * b % t, _ = Nt(N, d, t) * N % t, Y = Nt(_, A, t) * b % t, T = Nt(Y, n, t) * y % t, X = Nt(T, o, t) * F % t, M = Nt(X, r, t) * h % t, k = Nt(M, mo, t);
...
var ww = class {
  ...
  sideNodesForRoot(e, t) {
    ...
    for (let h = 0; h < zt; h += 1) {
      if ([s, i] = uw(r), Jn(e, h) === 1 ? (A = s, o = i) : (A = i, o = s), n.push(A), o === Ft) {
        r = "";
        break;
      }
      ...
      if (t[y] !== "") {
        if (A = t[y], o === "")
          if (d = this.get(A), Vi(d)) {
            ...
            o = Ft, h = !0;
        !h && A === Ft || (h || (h = !0), Jn(e, t.length - 1 - y) === 1 ? [i, o] = Mn(A, o) : [i, o] = Mn(o, A), this.set(i, o), o = i);
      }
    return i === "" && (i = Ft), i;
  }
  updateWithSideNodes(e, t, n, r, s) {
    ...
    for (let d = 0; d < zt; d += 1) {
      ...
      if (d - y < 0 || n[d - y] === "")
        ...
        h = n[d - y];
      Jn(e, zt - 1 - d) === 1 ? [i, o] = Mn(h, o) : [i, o] = Mn(o, h), this.set(i, o), o = i;
    }
    return i;
  }
  update(e, t) {
...
function EE(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const N = ve(e.sender), _ = ve(e.recipient), Y = ve(e.nonce), T = Q(e.amount), X = e.data ? J(e.data) : Uint8Array.from([]), M = ve(e.digest), k = Zs.getMessageId({
        sender: N,
        recipient: _,
        nonce: Y,
        amount: T,
    ...
    case "MINT": {
      const N = ve((F = e.contract) == null ? void 0 : F.id), _ = ve(e.subId), Y = Or.getAssetId(N, _);
      return {
        type: Ae.Mint,
        subId: _,
        contractId: N,
    ...
    case "BURN": {
      const N = ve((b = e.contract) == null ? void 0 : b.id), _ = ve(e.subId), Y = co.getAssetId(N, _);
      return {
        type: Ae.Burn,
        subId: _,
        contractId: N,
...
${lm}#variant.${e.reason}`), { errorMessage: t, reason: n };
  ...
  const { receipts: t, status: n, logs: r } = e, s = t.some(({ type: h }) => h === Ae.Panic), i = t.some(({ type: h }) => h === Ae.Revert), { errorMessage: o, reason: A } = (n == null ? void 0 : n.type) === "FailureStatus" && s ? QE(n) : vE(t, r), d = {
    logs: r,
    receipts: t,
    panic: s,
    revert: i,
   ...
   */
  addEmptyWitness() {
    return this.addWitness(se([xe, xe])), this.witnesses.length - 1;
  }
  /**
  ...
  fundWithFakeUtxos(e, t) {
    ...
    const r = () => {
      const o = String(n++);
      return xe.slice(0, -o.length).concat(o);
...
function t0(e, t) {
  ...
  n.type === Et.Script && (n.receiptsRoot = xe), n.inputs = n.inputs.map((i) => {
    const o = Pr(i);
    switch (o.type) {
      case we.Coin:
        return o.txPointer = {
    ...
    switch (o.type) {
      ...
      case Be.Variable:
        return o.to = xe, o.amount = Q(0), o.assetId = xe, o;
      default:
        return o;
    }
...
var DE = (e) => {
  ...
  constructor({ bytecodeWitnessIndex: t, salt: n, storageSlots: r, ...s }) {
    ...
    D(this, "storageSlots");
    this.bytecodeWitnessIndex = t ?? 0, this.salt = j(n ?? xe), this.storageSlots = [...r ?? []];
  }
  static from(t) {
...
function eI({
  ...
  const o = qE(n);
  return HE(t).reduce((h, y) => {
    const E = PE(e, y.inputIndex);
    return E ? o.reduce((v, F) => {
      var b;
      if (F.to === E.contractID) {
        const N = n0(e, F.assetId);
        if (N) {
          const _ = Ea(N), Y = [], T = r == null ? void 0 : r[E.contractID];
          return T && Y.push(
            _E({
              abi: T,
              receipt: F,
...
var uI = (e, t) => {
  ...
  async getTransactionCost(e, t = [], {
    ...
    const o = Pr(_t(e)), A = this.getChain(), { gasPriceFactor: d, minGasPrice: h, maxGasPerTx: y } = this.getGasConfig(), E = cl(o.gasPrice, h), C = o.type === Et.Script, v = o.getCoinOutputsQuantities(), F = uI(v, t);
    ...
    const X = C ? Wd(_) : b, M = qn(
      ...
      E,
      d
    ).normalizeZeroToOne(), k = qn(b, E, d).normalizeZeroToOne(), O = qn(N, E, d).normalizeZeroToOne();
    return {
  ...
  async getResourcesToSpend(e, t, n) {
    ...
    const i = {
      owner: r.toB256(),
      queryPerAsset: t.map(ha).map(({ assetId: E, amount: C, max: v }) => ({
        assetId: j(E),
...
var rB = [
  ...
  async transferToContract(t, n, r, s = {}) {
    ...
    const i = he.fromAddressOrString(t), { minGasPrice: o } = this.provider.getGasConfig(), A = this.provider.getBaseAssetId(), d = r ?? this.provider.getBaseAssetId(), h = { gasPrice: o, baseAssetId: A, ...s }, { script: y, scriptData: E } = await II({
...
async function BI(e, t, n) {
  const r = En(Kc(e), "hex"), s = he.fromAddressOrString(t), i = yn(Xi), o = cu({
    ...
    r: $c,
    p: zc
  }), A = yn(yI), d = await Tf(r, o, A), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = Au(h), E = Qr(y, "hex"), C = {
    id: $m(),
    version: 3,
...
async function CI(e, t) {
  const n = JSON.parse(e), {
  ...
  } = n, E = En(s, "hex"), C = En(i, "hex"), v = En(y, "hex"), F = En(t), b = cu({
    password: F,
    salt: v,
    n: A,
    p: h,
    r: d,
    dklen: o
  }), N = Uint8Array.from([...b.subarray(16, 32), ...E]), _ = Au(N), Y = Qr(_, "hex");
  if (r !== Y)
    throw new x(
      R.INVALID_PASSWORD,
      "Failed to decrypt the keystore wallet, the provided password is incorrect."
    );
  const T = await Lf(E, b, C);
  return j(T);
}
...
var hn = class {
  ...
  static seedToExtendedKey(e, t = !1) {
    const n = hn.masterKeysFromSeed(e), r = J(t ? NI : RI), s = "0x00", i = "0x00000000", o = "0x00000000", A = n.slice(32), d = n.slice(0, 32), h = se([
      r,
      s,
      i,
      o,
...
var Gr = class {
  ...
  callDataOffset: 0
}, $I = xe, D0 = ({ callDataOffset: e, gasForwardedOffset: t, amountOffset: n, assetIdOffset: r }, s) => {
  const i = new v0(
    fs(16, e),
    fs(17, n),
    Dr(17, 17, 0),
...
var oA = (e) => e === Ae.Return || e === Ae.ReturnData, zI = (e, t) => e.find(
  ...
  return n.receipts.filter(({ type: o }) => oA(o)).flatMap((o, A, d) => {
    ...
    if (o.type === Ae.ReturnData) {
      const y = J(o.data);
      if (t && oA((h = d[A + 1]) == null ? void 0 : h.type)) {
        const E = d[A + 1];
  ...
  if (n.push(new S("u64").encode(e.amount || 0)), n.push(new G().encode(((o = e.assetId) == null ? void 0 : o.toString()) || xe)), n.push(e.contractId.toBytes()), n.push(new S("u64").encode(e.fnSelector)), e.gas && (n.push(new S("u64").encode(e.gas)), r = K), e.isInputDataPointer) {
    const A = t + x0 + r;
  ...
  const n = [], r = t + K;
  let s = 0;
  n.push(new S("u64").encode(e.amount || 0)), n.push(new G().encode(((h = e.assetId) == null ? void 0 : h.toString()) || xe)), e.gas && (n.push(new S("u64").encode(e.gas)), s = K);
  const i = {
    amountOffset: r,
    assetIdOffset: r + K,
  ...
  (n) => {
    ...
    const s = ty(n), i = (8 - s % 8) % 8, o = s + i, A = jI(t.toNumber()) + o, d = [], h = [];
    let y = A;
    const E = [];
    for (let F = 0; F < r; F += 1) {
...
var k0 = (e) => {
  ...
  createTransactionRequest(e) {
    ...
    const r = n.stateRoot || M0(n.storageSlots), s = O0(this.bytecode, n.salt, r), i = this.provider.getBaseAssetId(), o = new yo({
      baseAssetId: i,
      gasPrice: 0,
