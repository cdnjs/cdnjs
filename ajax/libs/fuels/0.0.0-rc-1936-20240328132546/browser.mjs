...
var vr = (e) => e instanceof Yu ? e.address : e instanceof Ag ? e.id : e, Bg = () => X(Bn(32)), Cg = (e) => {
  let t;
  try {
    if (!uo(e))
      throw new v(
...
async function fI(e, t, n) {
  const r = In(zc(e), "hex"), s = he.fromAddressOrString(t), i = Bn(qi), o = Au({
    ...
    r: $c,
    p: Kc
  }), c = Bn(hI), d = await Rf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = uu(h), p = Qr(y, "hex"), b = {
    id: Zm(),
    version: 3,
...
var B0 = class {
   ...
   */
  getAbiFromAllCalls() {
    return this.functionScopes.reduce((e, t, n) => {
