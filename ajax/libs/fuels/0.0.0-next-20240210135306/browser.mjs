...
}, vt = (e, t, n, r) => (Yi(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n);
...
const ar = class {
  ...
  constructor(t, n) {
    ...
    wt(this, gr, void 0);
    wt(this, Dn, void 0);
    vt(this, fr, t), vt(this, gr, Jn(n)), vt(this, Dn, /* @__PURE__ */ new Map());
  }
  /**
...
var Xr = (e) => e % ne === 0, Ju = (e) => ne - e % ne, Zu = (e) => {
  ...
  constructor(t, n) {
    ...
    wt(this, pr, void 0);
    wt(this, Rn, void 0);
    this.name = t, this.coders = n, vt(this, pr, r), vt(this, Rn, s);
  }
  encode(t) {
...
var Sg = (e) => Object.values(e).every(
  ...
  constructor(t, n) {
    ...
    wt(this, ni, void 0);
    wt(this, rs, void 0);
    this.name = t, this.coders = n, vt(this, ni, r), vt(this, rs, s);
  }
  encode(t) {
...
}, xt = /* @__PURE__ */ ((e) => (e[e.Script = 0] = "Script", e[e.Create = 1] = "Create", e[e.Mint = 2] = "Mint", e))(xt || {}), Nc = class extends ie {
  constructor() {
...
function B0(e, t) {
  ...
  n.type === xt.Script && (n.receiptsRoot = Me), n.inputs = n.inputs.map((i) => {
    const o = Wr(i);
    switch (o.type) {
      case Qe.Coin:
        return o.txPointer = {
...
var Ay = (e, t) => {
  ...
  async sendTransaction(e, { estimateTxDependencies: t = !0, awaitExecution: n = !1 } = {}) {
    ...
    if (r.type === xt.Script && Q(s).gt(Q(r.gasLimit)))
      throw new v(
        R.GAS_LIMIT_TOO_LOW,
    ...
    if (n) {
      ...
      for await (const { submitAndAwait: C } of l)
        if (C.type !== "SubmittedStatus")
          break;
      const I = r.getTransactionId(this.getChainId()), g = new To(I, this);
  ...
  async getTransactionCost(e, t = [], { estimateTxDependencies: n = !0, estimatePredicates: r = !0 } = {}) {
    const s = Ht(Wr(e)), i = this.getChain(), { gasPriceFactor: o, minGasPrice: c, maxGasPerTx: d } = this.getGasConfig(), l = Kl(s.gasPrice, c), I = s.type === xt.Script;
    s.hasPredicateInput() && r && (I && (s.gasLimit = Q(0)), await this.estimatePredicates(s));
    const g = s.calculateMinGas(i), C = s.calculateMaxGas(i, g), x = s.getCoinOutputsQuantities(), D = Ay(x, t);
...
var hy = (e) => {
  ...
  async withdrawToBaseLayer(t, n, r = {}) {
    const s = fe.fromAddressOrString(t), i = Y(
      ...
      ...i,
      ...o
    ]), ...r }, l = new hr(d), I = [{ amount: Q(n), assetId: Bt }], { requiredQuantities: g, maxFee: C, gasUsed: x } = await this.provider.getTransactionCost(
      l,
      I
    );
...
var V0 = class {
  ...
  async simulate() {
    ...
    return Jo.build(this.functionInvocationScopes, o, this.isMultiCall);
  }
  /**
