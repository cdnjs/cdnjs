...
(function(e) {
  (function(t, n) {
    ...
    i.prototype._parseHex = function(a, c, l) {
      ...
      if (l === "be")
        for (p = a.length - 1; p >= c; p -= 2)
          I = A(a, c, p) << f, this.words[y] |= I & 67108863, f >= 18 ? (f -= 18, y += 1, this.words[y] |= I >>> 26) : f += 8;
      else {
        var g = a.length - c;
    ...
    function h(E, a, c, l) {
      for (var p = 0, f = 0, y = Math.min(E.length, c), I = a; I < y; I++) {
    ...
    i.prototype._parseBase = function(a, c, l) {
      ...
      if (I !== 0) {
        var X = 1;
        for (d = h(a, m, a.length, c), m = 0; m < I; m++)
          X *= c;
    ...
    i.prototype.zeroBits = function() {
      ...
      for (var f = 0, y = 0; y < p.length; y++)
        c = (l.words[y] | 0) + (p.words[y] | 0) + f, this.words[y] = c & 67108863, f = c >>> 26;
      for (; f !== 0 && y < l.length; y++)
        c = (l.words[y] | 0) + f, this.words[y] = c & 67108863, f = c >>> 26;
      ...
      for (var y = 0, I = 0; I < f.length; I++)
        c = (p.words[I] | 0) - (f.words[I] | 0) + y, y = c >> 26, this.words[I] = c & 67108863;
      for (; y !== 0 && I < p.length; I++)
        c = (p.words[I] | 0) + y, y = c >> 26, this.words[I] = c & 67108863;
    ...
    i.prototype.mulTo = function(a, c) {
      ...
      return this.length === 10 && a.length === 10 ? l = G(this, a, c) : p < 63 ? l = M(this, a, c) : p < 1024 ? l = O(this, a, c) : l = Z(this, a, c), l;
      ...
      var p, f, y;
      return this.negative !== 0 && a.negative === 0 ? (y = this.neg().divmod(a, c), c !== "mod" && (p = y.div.neg()), c !== "div" && (f = y.mod.neg(), l && f.negative !== 0 && f.iadd(a)), {
        div: p,
        mod: f
      }) : this.negative === 0 && a.negative !== 0 ? (y = this.divmod(a.neg(), c), c !== "mod" && (p = y.div.neg()), {
        div: p,
        mod: y.mod
      }) : this.negative & a.negative ? (y = this.neg().divmod(a.neg(), c), c !== "div" && (f = y.mod.neg(), l && f.negative !== 0 && f.isub(a)), {
        div: y.div,
        mod: f
      ...
      if (c.mod.isZero())
        return c.div;
      var l = c.div.negative !== 0 ? c.mod.isub(a) : c.mod, p = a.ushrn(1), f = a.andln(1), y = l.cmp(p);
      return y < 0 || f === 1 && y === 0 ? c.div : c.div.negative !== 0 ? c.div.isubn(1) : c.div.iaddn(1);
      ...
      for (var p = new i(1), f = new i(0), y = new i(0), I = new i(1), g = 0; c.isEven() && l.isEven(); )
        c.iushrn(1), l.iushrn(1), ++g;
      for (var d = l.clone(), m = c.clone(); !c.isZero(); ) {
        for (var X = 0, J = 1; !(c.words[0] & J) && X < 26; ++X, J <<= 1)
          ;
        if (X > 0)
          for (c.iushrn(X); X-- > 0; )
        ...
        c.cmp(l) >= 0 ? (c.isub(l), p.isub(y), f.isub(I)) : (l.isub(c), y.isub(p), I.isub(f));
      }
      return {
        a: y,
        b: I,
      ...
      var c = this, l = a.clone();
      c.negative !== 0 ? c = c.umod(a) : c = c.clone();
      for (var p = new i(1), f = new i(0), y = l.clone(); c.cmpn(1) > 0 && l.cmpn(1) > 0; ) {
      ...
      var X;
      return c.cmpn(1) === 0 ? X = p : X = f, X.cmpn(0) < 0 && X.iadd(a), X;
    ...
    s(k, T), k.prototype.split = function(a, c) {
      ...
      var y = a.words[9];
      for (c.words[c.length++] = y & l, f = 10; f < a.length; f++) {
        var I = a.words[f] | 0;
    ...
    W.prototype._verify1 = function(a) {
    ...
    }, W.prototype._verify2 = function(a, c) {
      ...
      var y = p[0], I = 0, g = 0, d = c.bitLength() % 26;
      for (d === 0 && (d = 26), f = c.length - 1; f >= 0; f--) {
        for (var m = c.words[f], X = d - 1; X >= 0; X--) {
          var J = m >> X & 1;
    ...
    s(ee, W), ee.prototype.convertTo = function(a) {
      ...
      var l = a.imul(c), p = l.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), f = l.isub(p).iushrn(this.shift), y = f;
      return f.cmp(this.m) >= 0 ? y = f.isub(this.m) : f.cmpn(0) < 0 && (y = f.iadd(this.m)), y._forceRed(this);
    }, ee.prototype.mul = function(a, c) {
      if (a.isZero() || c.isZero())
        return new i(0)._forceRed(this);
      var l = a.mul(c), p = l.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m), f = l.isub(p).iushrn(this.shift), y = f;
      return f.cmp(this.m) >= 0 ? y = f.isub(this.m) : f.cmpn(0) < 0 && (y = f.iadd(this.m)), y._forceRed(this);
...
var Rc = 9, Sc = 3, Ii = 9;
function _d(e, t) {
  const { precision: n = Rc, minPrecision: r = Sc } = t || {}, [s = "0", i = "0"] = String(e || "0.0").split("."), o = /(\d)(?=(\d{3})+\b)/g, u = s.replace(o, "$1,");
  let A = i.slice(0, n);
  if (r < n) {
...
function zd(e) {
  ...
  for (; r < t.length; ) {
    ...
    for (let A = 0; A < i; A++) {
      const h = t[r];
      if ((h & 192) !== 128) {
        r += bn("MISSING_CONTINUE", r, t), u = null;
        break;
      }
      u = u << 6 | h & 63, r++;
    }
...
let $d = class extends no {
  ...
  process(t, n) {
    ...
    let { A: r, B: s, C: i, D: o, E: u, F: A, G: h, H: b } = this;
    for (let w = 0; w < 64; w++) {
      const x = Lt(u, 6) ^ Lt(u, 11) ^ Lt(u, 25), _ = b + x + Jd(u, A, h) + jd[w] + Kt[w] | 0, C = (Lt(r, 2) ^ Lt(r, 13) ^ Lt(r, 22)) + qd(r, s, i) | 0;
      b = h, h = A, A = u, u = o + _ | 0, o = i, i = s, s = r, r = _ + C | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, i = i + this.C | 0, o = o + this.D | 0, u = u + this.E | 0, A = A + this.F | 0, h = h + this.G | 0, b = b + this.H | 0, this.set(r, s, i, o, u, A, h, b);
  }
  roundClean() {
    Kt.fill(0);
  }
...
function Kd(e, t, n, r) {
  Mc(e);
  const s = Oc({ dkLen: 32, asyncTick: 10 }, r), { c: i, dkLen: o, asyncTick: u } = s;
  if (_t(i), _t(o), _t(u), i < 1)
    throw new Error("PBKDF2: iterations (c) should be >= 1");
  const A = Wn(t), h = Wn(n), b = new Uint8Array(o), w = ro.create(e, A), x = w._cloneInto().update(h);
  return { c: i, dkLen: o, asyncTick: u, DK: b, PRF: w, PRFSalt: x };
}
...
function so(e, t, n, r) {
  ...
  let h;
  const b = new Uint8Array(4), w = Kr(b), x = new Uint8Array(u.outputLen);
...
function na(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], u = e[t++] ^ n[r++], A = e[t++] ^ n[r++], h = e[t++] ^ n[r++], b = e[t++] ^ n[r++], w = e[t++] ^ n[r++], x = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], R = e[t++] ^ n[r++], C = e[t++] ^ n[r++], F = e[t++] ^ n[r++], M = e[t++] ^ n[r++], G = e[t++] ^ n[r++], O = e[t++] ^ n[r++], Z = e[t++] ^ n[r++], L = e[t++] ^ n[r++], T = o, k = u, U = A, q = h, Y = b, W = w, ee = x, E = _, a = R, c = C, l = F, p = M, f = G, y = O, I = Z, g = L;
  for (let d = 0; d < 8; d += 2)
    Y ^= me(T + f | 0, 7), a ^= me(Y + T | 0, 9), f ^= me(a + Y | 0, 13), T ^= me(f + a | 0, 18), c ^= me(W + k | 0, 7), y ^= me(c + W | 0, 9), k ^= me(y + c | 0, 13), W ^= me(k + y | 0, 18), I ^= me(l + ee | 0, 7), U ^= me(I + l | 0, 9), ee ^= me(U + I | 0, 13), l ^= me(ee + U | 0, 18), q ^= me(g + p | 0, 7), E ^= me(q + g | 0, 9), p ^= me(E + q | 0, 13), g ^= me(p + E | 0, 18), k ^= me(T + q | 0, 7), U ^= me(k + T | 0, 9), q ^= me(U + k | 0, 13), T ^= me(q + U | 0, 18), ee ^= me(W + Y | 0, 7), E ^= me(ee + W | 0, 9), Y ^= me(E + ee | 0, 13), W ^= me(Y + E | 0, 18), p ^= me(l + c | 0, 7), a ^= me(p + l | 0, 9), c ^= me(a + p | 0, 13), l ^= me(c + a | 0, 18), f ^= me(g + I | 0, 7), y ^= me(f + g | 0, 9), I ^= me(y + f | 0, 13), g ^= me(I + y | 0, 18);
  s[i++] = o + T | 0, s[i++] = u + k | 0, s[i++] = A + U | 0, s[i++] = h + q | 0, s[i++] = b + Y | 0, s[i++] = w + W | 0, s[i++] = x + ee | 0, s[i++] = _ + E | 0, s[i++] = R + a | 0, s[i++] = C + c | 0, s[i++] = F + l | 0, s[i++] = M + p | 0, s[i++] = G + f | 0, s[i++] = O + y | 0, s[i++] = Z + I | 0, s[i++] = L + g | 0;
}
function oi(e, t, n, r, s) {
  ...
  for (let u = 0; u < s; u++, i += 16, t += 16)
    na(n, o, e, t, n, i), u > 0 && (o += 16), na(n, i, e, t += 16, n, o);
}
function tA(e, t, n) {
  const r = Oc({
    dkLen: 32,
    asyncTick: 10,
    maxmem: 1073742848
  }, n), { N: s, r: i, p: o, dkLen: u, asyncTick: A, maxmem: h, onProgress: b } = r;
  if (_t(s), _t(i), _t(o), _t(u), _t(A), _t(h), b !== void 0 && typeof b != "function")
  ...
  return { N: s, r: i, p: o, dkLen: u, blockSize32: x, V: F, B32: C, B: R, tmp: M, blockMixCb: G, asyncTick: A };
}
...
function rA(e, t, n) {
  const { N: r, r: s, p: i, dkLen: o, blockSize32: u, V: A, B32: h, B: b, tmp: w, blockMixCb: x } = tA(e, t, n);
  for (let _ = 0; _ < i; _++) {
    const R = u * _;
    for (let C = 0; C < u; C++)
      A[C] = h[R + C];
...
function vA(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    for (let o = 0; o < 10; o += 2) {
      const u = (o + 8) % 10, A = (o + 2) % 10, h = n[A], b = n[A + 1], w = ra(h, b, 1) ^ n[u], x = sa(h, b, 1) ^ n[u + 1];
      for (let _ = 0; _ < 50; _ += 10)
        e[o + _] ^= w, e[o + _ + 1] ^= x;
    }
    let s = e[2], i = e[3];
    for (let o = 0; o < 24; o++) {
      const u = Xc[o], A = ra(s, i, u), h = sa(s, i, u), b = Yc[o];
...
class LA extends no {
  ...
  process(t, n) {
    ...
    let r = this.h0 | 0, s = r, i = this.h1 | 0, o = i, u = this.h2 | 0, A = u, h = this.h3 | 0, b = h, w = this.h4 | 0, x = w;
    for (let _ = 0; _ < 5; _++) {
      const R = 4 - _, C = FA[_], F = MA[_], M = oo[_], G = ao[_], O = DA[_], Z = TA[_];
      for (let L = 0; L < 16; L++) {
        const T = Vr(r + ia(_, i, u, h) + Hr[M[L]] + C, O[L]) + w | 0;
        r = w, w = h, h = Vr(u, 10) | 0, u = i, i = T;
      }
      for (let L = 0; L < 16; L++) {
    ...
    this.set(this.h1 + u + b | 0, this.h2 + h + x | 0, this.h3 + w + s | 0, this.h4 + r + o | 0, this.h0 + i + A | 0);
  }
  roundClean() {
    Hr.fill(0);
  }
...
class UA extends no {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: u, Dl: A, Eh: h, El: b, Fh: w, Fl: x, Gh: _, Gl: R, Hh: C, Hl: F } = this;
    return [t, n, r, s, i, o, u, A, h, b, w, x, _, R, C, F];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, u, A, h, b, w, x, _, R, C, F) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = u | 0, this.Dl = A | 0, this.Eh = h | 0, this.El = b | 0, this.Fh = w | 0, this.Fl = x | 0, this.Gh = _ | 0, this.Gl = R | 0, this.Hh = C | 0, this.Hl = F | 0;
  }
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: u, Cl: A, Dh: h, Dl: b, Eh: w, El: x, Fh: _, Fl: R, Gh: C, Gl: F, Hh: M, Hl: G } = this;
    for (let O = 0; O < 80; O++) {
      const Z = le.rotrSH(w, x, 14) ^ le.rotrSH(w, x, 18) ^ le.rotrBH(w, x, 41), L = le.rotrSL(w, x, 14) ^ le.rotrSL(w, x, 18) ^ le.rotrBL(w, x, 41), T = w & _ ^ ~w & C, k = x & R ^ ~x & F, U = le.add5L(G, L, k, PA[O], tn[O]), q = le.add5H(U, M, Z, T, kA[O], en[O]), Y = U | 0, W = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), E = r & i ^ r & u ^ i & u, a = s & o ^ s & A ^ o & A;
      M = C | 0, G = F | 0, C = _ | 0, F = R | 0, _ = w | 0, R = x | 0, { h: w, l: x } = le.add(h | 0, b | 0, q | 0, Y | 0), h = u | 0, b = A | 0, u = i | 0, A = o | 0, i = r | 0, o = s | 0;
      const c = le.add3L(Y, ee, a);
      r = le.add3H(c, q, W, E), s = c | 0;
    }
    ({ h: r, l: s } = le.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = le.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: u, l: A } = le.add(this.Ch | 0, this.Cl | 0, u | 0, A | 0), { h, l: b } = le.add(this.Dh | 0, this.Dl | 0, h | 0, b | 0), { h: w, l: x } = le.add(this.Eh | 0, this.El | 0, w | 0, x | 0), { h: _, l: R } = le.add(this.Fh | 0, this.Fl | 0, _ | 0, R | 0), { h: C, l: F } = le.add(this.Gh | 0, this.Gl | 0, C | 0, F | 0), { h: M, l: G } = le.add(this.Hh | 0, this.Hl | 0, M | 0, G | 0), this.set(r, s, i, o, u, A, h, b, w, x, _, R, C, F, M, G);
  }
  roundClean() {
    en.fill(0), tn.fill(0);
  }
...
var Ci = (e) => Rs.getRandomValues(new Uint8Array(e)), es = (e, t = "base64") => {
  ...
  const n = Ci(16), r = Ci(32), s = co(e, r), i = JSON.stringify(t), o = Un(i, "utf-8"), u = {
    name: n0,
    counter: n,
    length: 64
  ...
  const r = Rs.subtle, s = new Uint8Array(t.subarray(0, 16)), i = n, o = e, u = await r.importKey(
    "raw",
    s,
  ...
  const r = Rs.subtle, s = new Uint8Array(t.subarray(0, 16)).buffer, i = new Uint8Array(n).buffer, o = new Uint8Array(e).buffer, u = await r.importKey(
    "raw",
    s,
    { name: "AES-CTR", length: 128 },
    !1,
...
var Rn, _r, Vn, Cs, h0, Bs, g0, xs, p0, Ic, f0 = (Ic = class extends ce {
  ...
  decode(t, n) {
    ...
    const o = this.coders[i], u = n + Fe(this, Rn).encodedLength;
    if (Fe(this, Vn) && t.length < u + o.encodedLength)
      throw new v(Q.DECODE_ERROR, "Invalid enum data size.");
...
var wr = class {
  ...
  decodeArguments(e) {
    ...
    return n.reduce(
      (s, i) => {
        const o = wr.getCoder(this.jsonAbi, i, { encoding: this.encoding }), [u, A] = o.decode(t, s.offset);
        return {
          decoded: [...s.decoded, u],
          offset: s.offset + A
        };
...
function _0(e, t, n) {
  ...
  var r = function(i) {
    ...
    n.set(e, i);
    for (var u in e)
      Object.prototype.hasOwnProperty.call(e, u) && (i[u] = t ? _0(e[u], !0, n) : e[u]);
    return i;
  };
  switch (Wl(e)) {
    case "Object":
...
var yn = class extends ce {
  ...
  decode(e, t) {
    ...
    const x = n;
    [n, r] = new Ee(u.toNumber()).decode(e, r);
    const _ = n;
  ...
  decode(e, t) {
    ...
    const b = n;
    [n, r] = new we(new wn(), u).decode(e, r);
    const w = n;
...
function $n(e) {
  ...
  for (let s = 0, i = 0; s < n; s++, i += 2) {
    const o = Fa(e.charCodeAt(i)), u = Fa(e.charCodeAt(i + 1));
...
function N0(e, t, n) {
  ...
  const o = () => {
    ...
    s = u(Ma([0]), w), r = u(), w.length !== 0 && (s = u(Ma([1]), w), r = u());
  }, h = () => {
    if (i++ >= 1e3)
...
class yo extends Error {
  ...
  constructor(t, ...n) {
    var r, s, i;
    const { nodes: o, source: u, positions: A, path: h, originalError: b, extensions: w } = hf(n);
    ...
    this.source = u ?? (x == null || (s = x[0]) === null || s === void 0 ? void 0 : s.source), this.positions = A ?? (x == null ? void 0 : x.map((R) => R.start)), this.locations = A && u ? A.map((R) => Si(u, R)) : x == null ? void 0 : x.map((R) => Si(R.source, R.start));
    const _ = df(
...
function If(e, t) {
  const n = e.replace(/"""/g, '\\"""'), r = n.split(/\r\n|[\n\r]/g), s = r.length === 1, i = r.length > 1 && r.slice(1).every((_) => _.length === 0 || Ni(_.charCodeAt(0))), o = n.endsWith('\\"""'), u = e.endsWith('"') && !o, A = e.endsWith("\\"), h = u || A, b = !(t != null && t.minimize) && // add leading and trailing new lines only if it improves readability
  (!s || e.length > 70 || h || i || o);
  let w = "";
...
function qf(e, t, n = F0) {
  ...
  for (const M of Object.values(ae))
    r.set(M, jf(t, M));
  let s, i = Array.isArray(e), o = [e], u = -1, A = [], h = e, b, w;
  const x = [], _ = [];
  do {
    u++;
    ...
    if (O === void 0 && G && A.push([b, h]), M)
      ...
      s = {
        ...
        edits: A,
        prev: s
      }, i = Array.isArray(h), o = i ? h : (F = n[h.kind]) !== null && F !== void 0 ? F : [], u = -1, A = [], w && _.push(w), w = h;
    }
  } while (s !== void 0);
...
function yh() {
  ...
  var r = Fr, s = W0(), i = "connection_init", o = "connection_ack", u = "ping", A = "pong", h = "subscribe", b = "next", w = "error", x = "complete", _ = (
    /** @class */
    function() {
      function L(T, k, U) {
        ...
        return f.prototype.rawRequest = function(y, I, g) {
          return i(this, void 0, void 0, function() {
            ...
            return o(this, function(Ae) {
              return d = C.parseRawRequestArgs(y, I, g), m = this.options, X = m.headers, J = m.fetch, K = J === void 0 ? h.default : J, j = m.method, re = j === void 0 ? "POST" : j, se = m.requestMiddleware, Se = m.responseMiddleware, fe = u(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, d.signal !== void 0 && (fe.signal = d.signal), _e = E(d.query).operationName, [2, k({
                url: oe,
                query: d.query,
          ...
          for (var I = [], g = 1; g < arguments.length; g++)
            I[g - 1] = arguments[g];
          var d = I[0], m = I[1], X = C.parseRequestArgs(y, d, m), J = this.options, K = J.headers, j = J.fetch, re = j === void 0 ? h.default : j, se = J.method, Se = se === void 0 ? "POST" : se, fe = J.requestMiddleware, oe = J.responseMiddleware, _e = u(J, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), Ae = this.url;
          ...
          var g = C.parseBatchRequestArgs(y, I), d = this.options, m = d.headers, X = d.fetch, J = X === void 0 ? h.default : X, K = d.method, j = K === void 0 ? "POST" : K, re = d.requestMiddleware, se = d.responseMiddleware, Se = u(d, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), fe = this.url;
          ...
          switch (Qe.label) {
            ...
            case 2:
              if (oe = Qe.sent(), _e = Se && Array.isArray(oe) ? !oe.some(function(Te) {
                ...
                return he = fe.headers, Ft = fe.status, oe.errors, ve = u(oe, ["errors"]), ye = j.errorPolicy === "ignore" ? ve : oe, [2, t(t({}, Se ? { data: ye } : ye), { headers: he, status: Ft })];
...
class rg extends tg {
  ...
  process(t, n) {
    ...
    let { A: r, B: s, C: i, D: o, E: u, F: A, G: h, H: b } = this;
    for (let w = 0; w < 64; w++) {
      const x = Ot(u, 6) ^ Ot(u, 11) ^ Ot(u, 25), _ = b + x + Kh(u, A, h) + ng[w] + rn[w] | 0, C = (Ot(r, 2) ^ Ot(r, 13) ^ Ot(r, 22)) + eg(r, s, i) | 0;
      b = h, h = A, A = u, u = o + _ | 0, o = i, i = s, s = r, r = _ + C | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, i = i + this.C | 0, o = o + this.D | 0, u = u + this.E | 0, A = A + this.F | 0, h = h + this.G | 0, b = b + this.H | 0, this.set(r, s, i, o, u, A, h, b);
  }
...
function ag(e) {
  ...
  return function(u, A) {
    if (u.pow(A, t) === u.neg(u.ONE))
      throw new Error("Cannot find square root");
    let h = r, b = u.pow(u.mul(u.ONE, s), n), w = u.pow(A, i), x = u.pow(A, n);
    for (; !u.eql(x, u.ONE); ) {
      if (u.eql(x, u.ZERO))
        return u.ZERO;
      let _ = 1;
      for (let C = u.sqr(x); _ < h && !u.eql(C, u.ONE); _++)
        C = u.sqr(C);
      const R = u.pow(b, ke << BigInt(h - _ - 1));
      b = u.sqr(R), w = u.mul(w, R), x = u.mul(x, b), h = _;
    }
    return w;
  };
}
function cg(e) {
  ...
  if (e % qa === Ja) {
    const t = (e - Ja) / qa;
    return function(r, s) {
      const i = r.mul(s, xn), o = r.pow(i, t), u = r.mul(s, o), A = r.mul(r.mul(u, xn), o), h = r.mul(u, r.sub(A, r.ONE));
      if (!r.eql(r.sqr(h), s))
        throw new Error("Cannot find square root");
      return h;
    };
...
function hg(e, t, n = !1) {
  ...
  const o = n ? Qn(e) : po(e), u = It(o, t - ke) + ke;
  return n ? mo(u, s) : Kn(u, s);
}
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function pg(e, t) {
  ...
  return {
    ...
    unsafeLadder(s, i) {
      let o = e.ZERO, u = s;
      for (; i > gg; )
        i & li && (o = o.add(u)), u = u.double(), i >>= li;
      return o;
    },
    /**
...
const { bytesToNumberBE: wg, hexToBytes: yg } = cf, _n = {
  ...
  toSig(e) {
    ...
    const { d: s, l: i } = _n._parseInt(n.subarray(2)), { d: o, l: u } = _n._parseInt(i);
    if (u.length)
...
function Ig(e) {
  ...
  class w {
    ...
    add(C) {
      ...
      let W = n.mul(F, O), ee = n.mul(M, Z), E = n.mul(G, L), a = n.add(F, M), c = n.add(O, Z);
      a = n.mul(a, c), c = n.add(W, ee), a = n.sub(a, c), c = n.add(F, G);
      let l = n.add(O, L);
      return c = n.mul(c, l), l = n.add(W, E), c = n.sub(c, l), l = n.add(M, G), T = n.add(Z, L), l = n.mul(l, T), T = n.add(ee, E), l = n.sub(l, T), U = n.mul(q, c), T = n.mul(Y, E), U = n.add(T, U), T = n.sub(ee, U), U = n.add(ee, U), k = n.mul(T, U), ee = n.add(W, W), ee = n.add(ee, W), E = n.mul(q, E), c = n.mul(Y, c), ee = n.add(ee, E), E = n.sub(W, E), E = n.mul(q, E), c = n.add(c, E), W = n.mul(ee, c), k = n.add(k, W), W = n.mul(l, c), T = n.mul(a, T), T = n.sub(T, W), W = n.mul(a, ee), U = n.mul(l, U), U = n.add(U, W), new w(T, k, U);
    }
    subtract(C) {
...
function Eg(e) {
  ...
  class M {
    ...
    recoverPublicKey(l) {
      ...
      const d = y & 1 ? "03" : "02", m = h.fromHex(d + _(g)), X = A(g), J = u(-I * X), K = u(f * X), j = h.BASE.multiplyAndAddUnsafe(m, J, K);
      if (!j)
  ...
  function Z(c) {
    const l = Dn(c), p = typeof c == "string", f = (l || p) && c.length;
  ...
  const T = t.bits2int || function(c) {
    const l = Qn(c), p = c.length * 8 - t.nBitLength;
  ...
  function Y(c, l, p = W) {
    ...
    I == null && (I = !0), c = Nt("msgHash", c), g && (c = Nt("prehashed msgHash", f(c)));
    const m = k(c), X = b(l), J = [q(X), q(m)];
    if (d != null && d !== !1) {
    ...
    function re(se) {
      ...
      if (!x(Se))
        return;
      const fe = A(Se), oe = h.BASE.multiply(Se).toAffine(), _e = u(oe.x);
      if (_e === Wt)
        return;
      const Ae = u(fe * u(j + _e * X));
      if (Ae === Wt)
        return;
  ...
  function E(c, l, p = W) {
    const { seed: f, k2sig: y } = Y(c, l, p), I = t;
  ...
  function a(c, l, p, f = ee) {
    ...
    if (I && d.hasHighS())
      return !1;
    g && (l = t.hash(l));
    const { r: X, s: J } = d, K = k(l), j = A(J), re = u(K * j), se = u(X * j), Se = (oe = h.BASE.multiplyAndAddUnsafe(m, re, se)) == null ? void 0 : oe.toAffine();
    return Se ? u(Se.x) === X : !1;
  }
  return {
    CURVE: t,
    getPublicKey: O,
...
function _g(e) {
  const t = cu, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), u = BigInt(44), A = BigInt(88), h = e * e * e % t, b = h * h * e % t, w = vt(b, n, t) * b % t, x = vt(w, n, t) * b % t, _ = vt(x, Li, t) * h % t, R = vt(_, s, t) * _ % t, C = vt(R, i, t) * R % t, F = vt(C, u, t) * C % t, M = vt(F, A, t) * F % t, G = vt(M, u, t) * C % t, O = vt(G, n, t) * b % t, Z = vt(O, o, t) * R % t, L = vt(Z, r, t) * h % t, T = vt(L, Li, t);
...
const Oi = fg(cu, void 0, void 0, { sqrt: _g }), sn = Bg({
  ...
  endo: {
    ...
    splitScalar: (e) => {
      const t = $a, n = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), r = -xg * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), s = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), i = n, o = BigInt("0x100000000000000000000000000000000"), u = Ka(i * e, t), A = Ka(-r * e, t);
      let h = It(e - u * n - A * s, t), b = It(-u * r - A * i, t);
      const w = h > o, x = b > o;
...
function Au(e, t, n, r) {
  ...
  if (Ms(n), i = e._events, i === void 0 ? (i = e._events = /* @__PURE__ */ Object.create(null), e._eventsCount = 0) : (i.newListener !== void 0 && (e.emit(
    ...
    u.name = "MaxListenersExceededWarning", u.emitter = e, u.type = t, u.count = o.length, Dg(u);
  }
  return e;
}
...
Be.prototype.removeListener = function(t, n) {
  ...
  if (r === n || r.listener === n)
    ...
    if (i < 0)
      return this;
    i === 0 ? r.shift() : Fg(r, i), r.length === 1 && (s[t] = r[0]), s.removeListener !== void 0 && this.emit("removeListener", t, u || n);
  }
  return this;
};
...
function wu(e) {
  ...
  for (; ; ) {
    ...
    for (; i < r - s; i += 1) {
      ...
      t[i] = new rc(n[o].index, n[o + 1].index, -1, u, "");
    }
...
var $g = class {
  ...
  sideNodesForRoot(e, t) {
    ...
    for (let h = 0; h < Xt; h += 1) {
      if ([s, i] = Hg(r), kn(e, h) === 1 ? (u = s, o = i) : (u = i, o = s), n.push(u), o === xt) {
        r = "";
        break;
      }
  ...
  deleteWithSideNodes(e, t, n, r) {
    ...
    for (let b = 0; b < t.length; b += 1)
      if (t[b] !== "") {
        if (u = t[b], o === "")
          if (A = this.get(u), gi(A)) {
            i = u, o = u;
            continue;
          } else
            o = xt, h = !0;
        !h && u === xt || (h || (h = !0), kn(e, t.length - 1 - b) === 1 ? [i, o] = Fn(u, o) : [i, o] = Fn(o, u), this.set(i, o), o = i);
      }
    return i === "" && (i = xt), i;
  }
  updateWithSideNodes(e, t, n, r, s) {
    ...
    u !== Xt && (kn(e, u) === 1 ? [i, o] = Fn(r, o) : [i, o] = Fn(o, r), this.set(i, o), o = i);
...
function Am(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const n = xe(e.sender), r = xe(e.recipient), s = xe(e.nonce), i = B(e.amount), o = e.data ? H(e.data) : Uint8Array.from([]), u = xe(e.digest), A = ws.getMessageId({
        sender: n,
        recipient: r,
        nonce: s,
        amount: i,
...
var lm = "https://fuellabs.github.io/block-explorer-v2", fm = (e, t) => `${{
  ...
  const { blockExplorerUrl: t, path: n, providerUrl: r, address: s, txId: i, blockNumber: o } = e, u = t || lm, A = [
    {
      key: "address",
      value: s
    },
  ...
  const w = b ? fm(
    h[0].key,
    h[0].value
  ) : "", x = /^\/|\/$/gm, _ = n ? n.replace(x, "") : w, R = u.replace(x, ""), C = r == null ? void 0 : r.replace(x, ""), F = C ? encodeURIComponent(C) : void 0, M = R.match(/^https?:\/\//) ? "" : "https://", G = C != null && C.match(/^https?:\/\//) ? "" : "https://";
...
function vu(e) {
  const { gasCosts: t, gasPerByte: n, inputs: r, metadataGas: s, txBytesSize: i } = e, o = hn(i, t.vmInitialization), u = B(i).mul(n), A = hm(r, i, t);
...
function Ru({
  ...
  const s = hn(r, e.contractRoot), i = hn(t, e.stateRoot), o = hn(n, e.s256), u = B(100), A = hn(u, e.s256);
...
${Fh}#variant.${e}`), { errorMessage: t, reason: e };
  ...
  if (r)
    switch (B(r.val).toHex()) {
      ...
      default:
        throw new v(
          Q.UNKNOWN_ERROR,
          `The transaction reverted with an unknown reason: ${r.val}`
        );
    }
  return { errorMessage: n, reason: s };
}, Qo = (e) => {
  const { receipts: t, statusReason: n, logs: r } = e, s = t.some(({ type: h }) => h === ue.Panic), i = t.some(({ type: h }) => h === ue.Revert), { errorMessage: o, reason: u } = s ? pm(n) : mm(t, r), A = {
    logs: r,
    receipts: t,
    panic: s,
    revert: i,
  ...
  return new v(Q.SCRIPT_REVERTED, o, A);
  ...
  getBaseTransaction() {
    var i, o, u;
    const e = ((i = this.inputs) == null ? void 0 : i.map(om)) ?? [], t = ((o = this.outputs) == null ? void 0 : o.map(am)) ?? [], n = ((u = this.witnesses) == null ? void 0 : u.map(bm)) ?? [], { policyTypes: r, policies: s } = Do.getPolicyMeta(this);
    return {
      policyTypes: r,
      inputs: e,
      outputs: t,
  ...
  fundWithFakeUtxos(e, t, n) {
    const r = (i) => this.inputs.find((o) => "assetId" in o ? o.assetId === i : !1), s = (i, o) => {
      const u = r(i);
      let A = o;
      i === t && (A = B("1000000000000000000")), u && "assetId" in u ? (u.id = V(Tt(ls)), u.amount = A) : this.addResources([
        {
          id: V(Tt(ls)),
          amount: A,
          assetId: i,
...
function tr(e, t) {
  var s, i, o;
  const n = [...e], r = n.findIndex((u) => Wm(u, t));
  if (n[r]) {
    const u = { ...n[r] };
    (s = t.assetsSent) != null && s.length && (u.assetsSent = (i = u.assetsSent) != null && i.length ? Xm(u, t) : t.assetsSent), (o = t.calls) != null && o.length && (u.calls = [...u.calls || [], ...t.calls]), n[r] = u;
  } else
    n.push(t);
  return n;
}
...
function Km({
  ...
  return Mu(e) ? [
    ...
    ...Zm({ inputs: t, receipts: r, baseAssetId: u })
  ] : [...jm(n)];
}
var An = (e) => {
  const t = Am(e);
...
function Os(e) {
  ...
  const {
    ...
    maxInputs: h,
    baseAssetId: _
  }), M = Fu(i.type), G = B((l = (c = i.policies) == null ? void 0 : c.find((p) => p.type === Qt.Tip)) == null ? void 0 : l.data), { isStatusFailure: O, isStatusPending: Z, isStatusSuccess: L, blockId: T, status: k, time: U, totalFee: q } = rw(u), Y = xm({
    totalFee: q,
    gasPrice: x,
    rawPayload: C,
    tip: G,
...
var cs = class {
  ...
  async getTransactionSummary(e) {
    ...
    const s = r.map(An) || [], { gasPerByte: i, gasPriceFactor: o, gasCosts: u, maxGasPerTx: A } = this.provider.getGasConfig(), h = await this.provider.getLatestGasPrice(), b = this.provider.getChain().consensusParameters.txParameters.maxInputs, w = this.provider.getBaseAssetId();
    return Os({
      id: this.id,
      receipts: s,
      transaction: n,
...
`)
  ...
  async sendTransaction(e, { estimateTxDependencies: t = !0, awaitExecution: n = !1 } = {}) {
    ...
    if (r.type === Oe.Script && (i = r.abis), n) {
      ...
      for await (const { submitAndAwait: b } of u) {
  ...
  async estimateMultipleTxDependencies(e) {
    ...
    for (; s.length > 0 && i < ac; ) {
      ...
      for (let h = 0; h < u.dryRun.length; h++) {
        const b = s[h], { receipts: w, status: x } = u.dryRun[h], _ = t[b];
  ...
  async simulate(e, { estimateTxDependencies: t = !0 } = {}) {
    ...
    return { receipts: s.map((o) => {
      const { id: u, receipts: A, status: h } = o, b = A.map(An);
      return { id: u, receipts: b, status: h };
    })[0].receipts };
  }
  /**
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    const s = Gt(wt(e)), i = s.type === Oe.Script, o = this.getBaseAssetId(), u = s.maxFee.eq(0), A = s.getCoinOutputsQuantities(), h = iw(A, r);
...
async function qy(e) {
  const { provider: t, transactionRequest: n, abiMap: r } = e, { receipts: s } = await t.dryRun(n), { gasPerByte: i, gasPriceFactor: o, gasCosts: u, maxGasPerTx: A } = t.getGasConfig(), h = t.getChain().consensusParameters.txParameters.maxInputs, b = n.toTransaction(), w = n.toTransactionBytes(), x = await t.getLatestGasPrice(), _ = t.getBaseAssetId();
  return Os({
    receipts: s,
    transaction: b,
    transactionBytes: w,
...
var hw = "https://cdn.fuel.network/assets/", gw = [
  ...
  const t = pw(e);
  await Eo();
  const n = Oh(16, 0, Ph.ScriptData), r = Ha(17, 16, 32), s = Ti(18, 17, 0), i = Ha(19, 17, 8), o = Lh(16, 18, 19), u = K0(1);
  ...
  async fund(t, n) {
    var M;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, u = t.maxFee, A = this.provider.getBaseAssetId(), h = ((M = i.find((G) => G.assetId === A)) == null ? void 0 : M.amount) || B(0), b = tp({
      amount: B(u),
      assetId: A,
      coinQuantities: i
    }), w = {};
  ...
  async transferToContract(t, n, r, s = {}) {
    ...
    const i = de.fromAddressOrString(t), o = r ?? this.provider.getBaseAssetId(), { script: u, scriptData: A } = await mw({
  ...
  static recoverPublicKey(e, t) {
    ...
    s[0] &= 127;
    const u = new sn.Signature(BigInt(V(r)), BigInt(V(s))).addRecoveryBit(
      i
...
async function Iw(e, t, n) {
  const r = fn(Ac(e), "hex"), s = de.fromAddressOrString(t), i = Tt(pi), o = r0({
    ...
    r: uc,
    p: dc
  }), u = Tt(yw), A = await KA(r, o, u), h = Uint8Array.from([...o.subarray(16, 32), ...A]), b = s0(h), w = lr(b, "hex"), x = {
    id: Ng(),
    version: 3,
...
async function bw(e, t) {
  const n = JSON.parse(e), {
    crypto: {
      ...
      ciphertext: s,
      cipherparams: { iv: i },
      kdfparams: { dklen: o, n: u, r: A, p: h, salt: b }
    }
...
function _w(e, t) {
  ...
  const i = 32 * e.length / 3, o = e.length / 3, u = Gu(o);
  if ((H(mt(r.slice(0, i / 8)))[0] & u) !== (r[r.length - 1] & u))
    throw new v(
      Q.INVALID_CHECKSUM,
...
var on = class {
  ...
  static seedToExtendedKey(e, t = !1) {
    const n = on.masterKeysFromSeed(e), r = H(t ? Sw : Rw), s = "0x00", i = "0x00000000", o = "0x00000000", u = n.slice(32), A = n.slice(0, 32), h = ie([
      r,
      s,
      i,
      o,
...
var Ln = class {
  ...
  deriveIndex(e) {
    ...
    s.set(Zt(e, 4), 33);
    const i = H(i0("sha512", r, s)), o = i.slice(0, 32), u = i.slice(32);
    if (t) {
  ...
  toExtendedKey(e = !1, t = !1) {
    ...
    const n = Nw(this.privateKey == null || e, t), r = V(Uint8Array.from([this.depth])), s = this.parentFingerprint, i = qi(this.index, 4), o = this.chainCode, u = this.privateKey != null && !e ? ie(["0x00", this.privateKey]) : this.publicKey, A = H(ie([n, r, s, i, o, u]));
    return hc(A);
  }
  /**
...
var tI = class {
  ...
  constructor({
    ...
    const { predicateBytes: o, predicateInterface: u } = gc.processPredicateData(
      t,
      n,
      i
    ), A = de.fromB256(kw(o));
...
var qw = (e) => e === ue.Return || e === ue.ReturnData, jw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const s = ey(n), i = (8 - s % 8) % 8, o = s + i, u = Xw(t.toNumber()) + o, A = [];
    let h = u;
    const b = [];
    for (let R = 0; R < r; R += 1) {
...
var od = class {
  ...
  setDefaultTxParams(e, t, n) {
    var u, A;
    const r = Nn((u = this.txParameters) == null ? void 0 : u.gasLimit) || this.hasCallParamsGasLimit, s = Nn((A = this.txParameters) == null ? void 0 : A.maxFee), { gasLimit: i, maxFee: o } = e;
    if (!r)
      e.gasLimit = t;
    else if (i.lt(t))
      throw new v(
