...
var Ad = class extends da {
  ...
  static fromSeed(t, e, n) {
    const s = Zi.fromSeed(t).derivePath(e || Qe.defaultPath);
    return new Qe(s.privateKey, n);
  }
  /**
  ...
  static fromMnemonic(t, e, n, r) {
    const s = Y0.mnemonicToSeed(t, n), o = Zi.fromSeed(s).derivePath(e || Qe.defaultPath);
    return new Qe(o.privateKey, r);
  }
  /**
