...
function Pl(e, t, n, r) {
  ...
  return { c: i, dkLen: o, asyncTick: c, DK: y, PRF: E, PRFSalt: C };
}
...
function Gl(e, t, n, r) {
  ...
  let h;
  const y = new Uint8Array(4), E = Is(y), C = new Uint8Array(c.outputLen);
...
let Vl = class extends Mo {
  ...
  process(t, n) {
    ...
    for (let E = 0; E < 64; E++) {
      const C = Jt(c, 6) ^ Jt(c, 11) ^ Jt(c, 25), v = y + C + Jl(c, d, h) + Yl[E] + cn[E] | 0, b = (Jt(r, 2) ^ Jt(r, 13) ^ Jt(r, 22)) + Zl(r, s, i) | 0;
...
class Oo extends Mo {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: c, Dl: d, Eh: h, El: y, Fh: E, Fl: C, Gh: v, Gl: F, Hh: b, Hl: N } = this;
    return [t, n, r, s, i, o, c, d, h, y, E, C, v, F, b, N];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, c, d, h, y, E, C, v, F, b, N) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = c | 0, this.Dl = d | 0, this.Eh = h | 0, this.El = y | 0, this.Fh = E | 0, this.Fl = C | 0, this.Gh = v | 0, this.Gl = F | 0, this.Hh = b | 0, this.Hl = N | 0;
  }
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: h, Dl: y, Eh: E, El: C, Fh: v, Fl: F, Gh: b, Gl: N, Hh: _, Hl: Y } = this;
    for (let T = 0; T < 80; T++) {
      const j = ue.rotrSH(E, C, 14) ^ ue.rotrSH(E, C, 18) ^ ue.rotrBH(E, C, 41), M = ue.rotrSL(E, C, 14) ^ ue.rotrSL(E, C, 18) ^ ue.rotrBL(E, C, 41), k = E & v ^ ~E & b, O = C & F ^ ~C & N, P = ue.add5L(Y, M, O, gh[T], un[T]), W = ue.add5H(P, _, j, k, fh[T], An[T]), U = P | 0, H = ue.rotrSH(r, s, 28) ^ ue.rotrBH(r, s, 34) ^ ue.rotrBH(r, s, 39), ee = ue.rotrSL(r, s, 28) ^ ue.rotrBL(r, s, 34) ^ ue.rotrBL(r, s, 39), B = r & i ^ r & c ^ i & c, a = s & o ^ s & d ^ o & d;
      _ = b | 0, Y = N | 0, b = v | 0, N = F | 0, v = E | 0, F = C | 0, { h: E, l: C } = ue.add(h | 0, y | 0, W | 0, U | 0), h = c | 0, y = d | 0, c = i | 0, d = o | 0, i = r | 0, o = s | 0;
...
function Fh(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    for (let o = 0; o < 10; o += 2) {
      const c = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = Ya(h, y, 1) ^ n[c], C = Va(h, y, 1) ^ n[c + 1];
...
class Oh extends Mo {
  ...
  process(t, n) {
    ...
    let r = this.h0 | 0, s = r, i = this.h1 | 0, o = i, c = this.h2 | 0, d = c, h = this.h3 | 0, y = h, E = this.h4 | 0, C = E;
    for (let v = 0; v < 5; v++) {
      const F = 4 - v, b = kh[v], N = Mh[v], _ = Lo[v], Y = To[v], T = Sh[v], j = _h[v];
      for (let M = 0; M < 16; M++) {
        const k = us(r + Xa(v, i, c, h) + ds[_[M]] + b, T[M]) + E | 0;
        r = E, E = h, h = us(c, 10) | 0, c = i, i = k;
      }
      for (let M = 0; M < 16; M++) {
    ...
    this.set(this.h1 + c + y | 0, this.h2 + h + C | 0, this.h3 + E + s | 0, this.h4 + r + o | 0, this.h0 + i + d | 0);
  }
  roundClean() {
    ds.fill(0);
  }
...
class of extends tf {
  ...
  process(t, n) {
    ...
    let { A: r, B: s, C: i, D: o, E: c, F: d, G: h, H: y } = this;
    for (let E = 0; E < 64; E++) {
      const C = Zt(c, 6) ^ Zt(c, 11) ^ Zt(c, 25), v = y + C + nf(c, d, h) + sf[E] + ln[E] | 0, b = (Zt(r, 2) ^ Zt(r, 13) ^ Zt(r, 22)) + rf(r, s, i) | 0;
      y = h, h = d, d = c, c = o + v | 0, o = i, i = s, s = r, r = v + b | 0;
    }
    r = r + this.A | 0, s = s + this.B | 0, i = i + this.C | 0, o = o + this.D | 0, c = c + this.E | 0, d = d + this.F | 0, h = h + this.G | 0, y = y + this.H | 0, this.set(r, s, i, o, c, d, h, y);
  }
...
function ru(e, t, n, r) {
  ...
  let h;
  const y = new Uint8Array(4), E = Bs(y), C = new Uint8Array(c.outputLen);
  for (let v = 1, F = 0; F < i; v++, F += c.outputLen) {
    const b = o.subarray(F, F + c.outputLen);
    E.setInt32(0, v, !1), (h = d._cloneInto(h)).update(y).digestInto(C), b.set(C.subarray(0, b.length));
    for (let N = 1; N < s; N++) {
...
function za(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], h = e[t++] ^ n[r++], y = e[t++] ^ n[r++], E = e[t++] ^ n[r++], C = e[t++] ^ n[r++], v = e[t++] ^ n[r++], F = e[t++] ^ n[r++], b = e[t++] ^ n[r++], N = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], Y = e[t++] ^ n[r++], T = e[t++] ^ n[r++], j = e[t++] ^ n[r++], M = e[t++] ^ n[r++], k = o, O = c, P = d, W = h, U = y, H = E, ee = C, B = v, a = F, A = b, l = N, p = _, f = Y, w = T, I = j, g = M;
  for (let u = 0; u < 8; u += 2)
    U ^= me(k + f | 0, 7), a ^= me(U + k | 0, 9), f ^= me(a + U | 0, 13), k ^= me(f + a | 0, 18), A ^= me(H + O | 0, 7), w ^= me(A + H | 0, 9), O ^= me(w + A | 0, 13), H ^= me(O + w | 0, 18), I ^= me(l + ee | 0, 7), P ^= me(I + l | 0, 9), ee ^= me(P + I | 0, 13), l ^= me(ee + P | 0, 18), W ^= me(g + p | 0, 7), B ^= me(W + g | 0, 9), p ^= me(B + W | 0, 13), g ^= me(p + B | 0, 18), O ^= me(k + W | 0, 7), P ^= me(O + k | 0, 9), W ^= me(P + O | 0, 13), k ^= me(W + P | 0, 18), ee ^= me(H + U | 0, 7), B ^= me(ee + H | 0, 9), U ^= me(B + ee | 0, 13), H ^= me(U + B | 0, 18), p ^= me(l + A | 0, 7), a ^= me(p + l | 0, 9), A ^= me(a + p | 0, 13), l ^= me(A + a | 0, 18), f ^= me(g + I | 0, 7), w ^= me(f + g | 0, 9), I ^= me(w + f | 0, 13), g ^= me(I + w | 0, 18);
  s[i++] = o + k | 0, s[i++] = c + O | 0, s[i++] = d + P | 0, s[i++] = h + W | 0, s[i++] = y + U | 0, s[i++] = E + H | 0, s[i++] = C + ee | 0, s[i++] = v + B | 0, s[i++] = F + a | 0, s[i++] = b + A | 0, s[i++] = N + l | 0, s[i++] = _ + p | 0, s[i++] = Y + f | 0, s[i++] = T + w | 0, s[i++] = j + I | 0, s[i++] = M + g | 0;
}
...
function df(e, t, n) {
  const { N: r, r: s, p: i, dkLen: o, blockSize32: c, V: d, B32: h, B: y, tmp: E, blockMixCb: C } = Af(e, t, n);
  for (let v = 0; v < i; v++) {
    const F = c * v;
    for (let b = 0; b < c; b++)
      d[b] = h[F + b];
...
function Qf(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    for (let o = 0; o < 10; o++)
      n[o] = e[o] ^ e[o + 10] ^ e[o + 20] ^ e[o + 30] ^ e[o + 40];
    for (let o = 0; o < 10; o += 2) {
      const c = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = tc(h, y, 1) ^ n[c], C = nc(h, y, 1) ^ n[c + 1];
      for (let v = 0; v < 50; v += 10)
        e[o + v] ^= E, e[o + v + 1] ^= C;
    }
    let s = e[2], i = e[3];
...
var no = (e) => ii.getRandomValues(new Uint8Array(e)), Cs = (e, t = "base64") => {
  ...
  const n = no(16), r = no(32), s = Zo(e, r), i = JSON.stringify(t), o = Xn(i, "utf-8"), c = {
    name: cu,
    counter: n,
    length: 64
...
var rg = (e) => Object.values(e).every(
  ...
  decode(t, n) {
    ...
    return r += d, [s, r] = c.decode(t, r), rg(this.coders) ? on(this, Ws, ku).call(this, o, r) : [{ [o]: s }, r];
  }
...
function id(e, t, n) {
  ...
  const o = () => {
    ...
    s = c(Fc([0]), E), r = c(), E.length !== 0 && (s = c(Fc([1]), E), r = c());
  }, h = () => {
    if (i++ >= 1e3)
...
class Aa extends Error {
  ...
  constructor(t, ...n) {
    var r, s, i;
    const { nodes: o, source: c, positions: d, path: h, originalError: y, extensions: E } = Gg(n);
    ...
    this.source = c ?? (C == null || (s = C[0]) === null || s === void 0 ? void 0 : s.source), this.positions = d ?? (C == null ? void 0 : C.map((F) => F.start)), this.locations = d && c ? d.map((F) => lo(c, F)) : C == null ? void 0 : C.map((F) => lo(F.source, F.start));
    const v = Lg(
...
function Vp() {
  ...
  var r = rs, s = Bd(), i = "connection_init", o = "connection_ack", c = "ping", d = "pong", h = "subscribe", y = "next", E = "error", C = "complete", v = (
    /** @class */
    function() {
      function M(k, O, P) {
        ...
        return f.prototype.rawRequest = function(w, I, g) {
          return i(this, void 0, void 0, function() {
            ...
            return o(this, function(de) {
              return u = b.parseRawRequestArgs(w, I, g), m = this.options, Z = m.headers, V = m.fetch, $ = V === void 0 ? h.default : V, q = m.method, ne = q === void 0 ? "POST" : q, re = m.requestMiddleware, Ne = m.responseMiddleware, fe = c(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, u.signal !== void 0 && (fe.signal = u.signal), xe = B(u.query).operationName, [2, O({
                url: oe,
                query: u.query,
          ...
          for (var I = [], g = 1; g < arguments.length; g++)
            I[g - 1] = arguments[g];
          var u = I[0], m = I[1], Z = b.parseRequestArgs(w, u, m), V = this.options, $ = V.headers, q = V.fetch, ne = q === void 0 ? h.default : q, re = V.method, Ne = re === void 0 ? "POST" : re, fe = V.requestMiddleware, oe = V.responseMiddleware, xe = c(V, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), de = this.url;
          ...
          var g = b.parseBatchRequestArgs(w, I), u = this.options, m = u.headers, Z = u.fetch, V = Z === void 0 ? h.default : Z, $ = u.method, q = $ === void 0 ? "POST" : $, ne = u.requestMiddleware, re = u.responseMiddleware, Ne = c(u, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), fe = this.url;
...
function Fm(e) {
  ...
  return function(c, d) {
    if (c.pow(d, t) === c.neg(c.ONE))
      throw new Error("Cannot find square root");
    let h = r, y = c.pow(c.mul(c.ONE, s), n), E = c.pow(d, i), C = c.pow(d, n);
    for (; !c.eql(C, c.ONE); ) {
      if (c.eql(C, c.ZERO))
        return c.ZERO;
      let v = 1;
      ...
      y = c.sqr(F), E = c.mul(E, F), C = c.mul(C, y), h = v;
    }
    return E;
  };
}
...
function Jm(e) {
  ...
  class _ {
    ...
    recoverPublicKey(l) {
      ...
      const u = w & 1 ? "03" : "02", m = h.fromHex(u + v(g)), Z = d(g), V = c(-I * Z), $ = c(f * Z), q = h.BASE.multiplyAndAddUnsafe(m, V, $);
      if (!q)
  ...
  function B(A, l, p = H) {
    const { seed: f, k2sig: w } = U(A, l, p), I = t;
...
function Xm(e) {
  const t = Od, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), h = e * e * e % t, y = h * h * e % t, E = St(y, n, t) * y % t, C = St(E, n, t) * y % t, v = St(C, wo, t) * h % t, F = St(v, s, t) * v % t, b = St(F, i, t) * F % t, N = St(b, c, t) * b % t, _ = St(N, d, t) * N % t, Y = St(_, c, t) * b % t, T = St(Y, n, t) * y % t, j = St(T, o, t) * F % t, M = St(j, r, t) * h % t, k = St(M, wo, t);
...
var Ew = class {
  ...
  sideNodesForRoot(e, t) {
    ...
    for (let h = 0; h < zt; h += 1) {
      if ([s, i] = dw(r), Zn(e, h) === 1 ? (c = s, o = i) : (c = i, o = s), n.push(c), o === Ft) {
        r = "";
        break;
      }
  ...
  updateWithSideNodes(e, t, n, r, s) {
    ...
    c !== zt && (Zn(e, c) === 1 ? [i, o] = On(r, o) : [i, o] = On(o, r), this.set(i, o), o = i);
...
`)
      ...
      const n = qd.textDecoder.decode(e).replace(`:keep-alive-text
...
function IE(e) {
  var n, r, s, i, o, c, d, h, y, E, C, v, F, b;
...
var yE = "https://fuellabs.github.io/block-explorer-v2", BE = (e, t) => `${{
  ...
  const E = y ? BE(
    h[0].key,
    h[0].value
  ) : "", C = /^\/|\/$/gm, v = n ? n.replace(C, "") : E, F = c.replace(C, ""), b = r == null ? void 0 : r.replace(C, ""), N = b ? encodeURIComponent(b) : void 0, _ = F.match(/^https?:\/\//) ? "" : "https://", Y = b != null && b.match(/^https?:\/\//) ? "" : "https://";
...
${hm}#variant.${e.reason}`), { errorMessage: t, reason: n };
  ...
  constructor({
    ...
    D(this, "baseAssetId");
    this.gasPrice = Q(e), this.maturity = t ?? 0, this.witnessLimit = r ? Q(r) : void 0, this.maxFee = n ? Q(n) : void 0, this.inputs = s ?? [], this.outputs = i ?? [], this.witnesses = o ?? [], this.baseAssetId = c;
  }
  ...
  getBaseTransaction() {
    var i, o, c;
    const e = ((i = this.inputs) == null ? void 0 : i.map(gE)) ?? [], t = ((o = this.outputs) == null ? void 0 : o.map(pE)) ?? [], n = ((c = this.witnesses) == null ? void 0 : c.map(DE)) ?? [], { policyTypes: r, policies: s } = fi.getPolicyMeta(this);
    return {
      policyTypes: r,
      inputs: e,
      outputs: t,
...
var dI = (e, t) => {
  ...
  async getTransactionCost(e, t = [], {
    ...
    const o = Ur(kt(e)), { minGasPrice: c } = this.getGasConfig(), d = Al(o.gasPrice, c), h = o.type === pt.Script, y = o.getCoinOutputsQuantities(), E = dI(y, t);
...
var sB = [
  ...
  async createTransfer(t, n, r, s = {}) {
    const { minGasPrice: i } = this.provider.getGasConfig(), o = this.provider.getBaseAssetId(), c = r ?? this.provider.getBaseAssetId(), d = { gasPrice: i, baseAssetId: o, ...s }, h = new Wn(d);
    h.addCoinOutput(he.fromAddressOrString(t), n, c);
  ...
  async transferToContract(t, n, r, s = {}) {
    ...
    const i = he.fromAddressOrString(t), { minGasPrice: o } = this.provider.getGasConfig(), c = this.provider.getBaseAssetId(), d = r ?? this.provider.getBaseAssetId(), h = { gasPrice: o, baseAssetId: c, ...s }, { script: y, scriptData: E } = await yI({
...
async function CI(e, t, n) {
  const r = In(eA(e), "hex"), s = he.fromAddressOrString(t), i = jt(Xi), o = Au({
    ...
    r: Kc,
    p: zc
  }), c = jt(BI), d = await Pf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = uu(h), E = vr(y, "hex"), C = {
    id: Km(),
    version: 3,
...
var aA = (e) => e === Ae.Return || e === Ae.ReturnData, zI = (e, t) => e.find(
  ...
  }, o = i.callDataOffset + Qu + z + z, c = o + e.fnSelectorBytes.length, d = J(e.data);
  ...
  (n) => {
    ...
    for (let F = 0; F < r; F += 1) {
      ...
      }), E.push(se(N)), d.push(_), y = c + se(E).byteLength;
    }
    const C = oA(d, h);
...
var M0 = (e) => {
  ...
  createTransactionRequest(e) {
    var c;
    const t = (c = e == null ? void 0 : e.storageSlots) == null ? void 0 : c.map(({ key: d, value: h }) => ({
      key: xo(d),
      value: xo(h)
...
}, AB = 9, uB = 3, dB = 9, lB = 9, hB = 18, fB = 15, gB = 12, pB = 9, gA, mB = typeof process < "u" && ((gA = process == null ? void 0 : process.env) == null ? void 0 : gA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/graphql", wB = "https://beta-5.fuel.network/graphql";
export {
  kn as ASSET_ID_LEN,
