...
(function(e) {
  (function(t, n) {
    ...
    function M(E, a, c) {
      ...
      for (var u = 1; u < l; u++) {
        for (var m = g >>> 26, Z = g & 67108863, W = Math.min(u, a.length - 1), K = Math.max(0, u - E.length + 1); K <= W; K++) {
          var j = u - K | 0;
          p = E.words[j] | 0, f = a.words[K] | 0, w = p * f + Z, m += w / 67108864 | 0, Z = w & 67108863;
        }
        c.words[u] = Z | 0, g = m | 0;
      }
    ...
    function L(E, a, c) {
      ...
      for (var l = 0, p = 0, f = 0; f < c.length - 1; f++) {
        ...
        for (var y = l & 67108863, g = Math.min(f, a.length - 1), u = Math.max(0, f - E.length + 1); u <= g; u++) {
          var m = f - u, Z = E.words[m] | 0, W = a.words[u] | 0, K = Z * W, j = K & 67108863;
    ...
    i.prototype.mulTo = function(a, c) {
      ...
      return this.length === 10 && a.length === 10 ? l = G(this, a, c) : p < 63 ? l = M(this, a, c) : p < 1024 ? l = L(this, a, c) : l = J(this, a, c), l;
    ...
    H.prototype._verify1 = function(a) {
      ...
      for (u = new i(2 * u * u).toRed(this); this.pow(u, g).cmp(y) !== 0; )
        u.redIAdd(y);
      for (var m = this.pow(u, p), Z = this.pow(a, p.addn(1).iushrn(1)), W = this.pow(a, p), K = f; W.cmp(w) !== 0; ) {
        for (var j = W, re = 0; j.cmp(w) !== 0; re++)
          j = j.redSqr();
        r(re < K);
        var se = this.pow(m, new i(1).iushln(K - re - 1));
        Z = Z.redMul(se), m = se.redSqr(), W = W.redMul(m), K = re;
      }
      return Z;
      ...
      for (u === 0 && (u = 26), f = c.length - 1; f >= 0; f--) {
        for (var m = c.words[f], Z = u - 1; Z >= 0; Z--) {
          ...
          y <<= 1, y |= W, g++, !(g !== l && (f !== 0 || Z !== 0)) && (w = this.mul(w, p[y]), g = 0, y = 0);
        }
        u = 26;
      }
      return w;
...
function Ho(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], d = e[t++] ^ n[r++], A = e[t++] ^ n[r++], h = e[t++] ^ n[r++], b = e[t++] ^ n[r++], I = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], v = e[t++] ^ n[r++], R = e[t++] ^ n[r++], C = e[t++] ^ n[r++], F = e[t++] ^ n[r++], M = e[t++] ^ n[r++], G = e[t++] ^ n[r++], L = e[t++] ^ n[r++], J = e[t++] ^ n[r++], O = e[t++] ^ n[r++], T = o, k = d, U = A, q = h, Y = b, H = I, ee = _, E = v, a = R, c = C, l = F, p = M, f = G, w = L, y = J, g = O;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + T | 0, s[i++] = d + k | 0, s[i++] = A + U | 0, s[i++] = h + q | 0, s[i++] = b + Y | 0, s[i++] = I + H | 0, s[i++] = _ + ee | 0, s[i++] = v + E | 0, s[i++] = R + a | 0, s[i++] = C + c | 0, s[i++] = F + l | 0, s[i++] = M + p | 0, s[i++] = G + f | 0, s[i++] = L + w | 0, s[i++] = J + y | 0, s[i++] = O + g | 0;
}
...
function PA(e, t, n) {
  ...
  const R = Wi(Qn, e, t, { c: 1, dkLen: I * o }), C = Zr(R), F = Zr(new Uint8Array(I * s)), M = Zr(new Uint8Array(I));
  let G = () => {
  };
  if (b) {
...
class Il extends Ji {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const R = 4 - v, C = wl[v], F = yl[v], M = ji[v], G = $i[v], L = pl[v], J = ml[v];
      for (let O = 0; O < 16; O++) {
        const T = kr(r + Wo(v, i, d, h) + Pr[M[O]] + C, L[O]) + I | 0;
        r = I, I = h, h = kr(d, 10) | 0, d = i, i = T;
      }
      for (let O = 0; O < 16; O++) {
        const T = kr(s + Wo(R, o, A, b) + Pr[G[O]] + F, J[O]) + _ | 0;
...
class Bl extends Ji {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: d, Dl: A, Eh: h, El: b, Fh: I, Fl: _, Gh: v, Gl: R, Hh: C, Hl: F } = this;
    return [t, n, r, s, i, o, d, A, h, b, I, _, v, R, C, F];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, d, A, h, b, I, _, v, R, C, F) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = d | 0, this.Dl = A | 0, this.Eh = h | 0, this.El = b | 0, this.Fh = I | 0, this.Fl = _ | 0, this.Gh = v | 0, this.Gl = R | 0, this.Hh = C | 0, this.Hl = F | 0;
  }
  process(t, n) {
    for (let L = 0; L < 16; L++, n += 4)
      Kt[L] = t.getUint32(n), en[L] = t.getUint32(n += 4);
    for (let L = 16; L < 80; L++) {
      const J = Kt[L - 15] | 0, O = en[L - 15] | 0, T = le.rotrSH(J, O, 1) ^ le.rotrSH(J, O, 8) ^ le.shrSH(J, O, 7), k = le.rotrSL(J, O, 1) ^ le.rotrSL(J, O, 8) ^ le.shrSL(J, O, 7), U = Kt[L - 2] | 0, q = en[L - 2] | 0, Y = le.rotrSH(U, q, 19) ^ le.rotrBH(U, q, 61) ^ le.shrSH(U, q, 6), H = le.rotrSL(U, q, 19) ^ le.rotrBL(U, q, 61) ^ le.shrSL(U, q, 6), ee = le.add4L(k, H, en[L - 7], en[L - 16]), E = le.add4H(ee, T, Y, Kt[L - 7], Kt[L - 16]);
      Kt[L] = E | 0, en[L] = ee | 0;
    }
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: d, Cl: A, Dh: h, Dl: b, Eh: I, El: _, Fh: v, Fl: R, Gh: C, Gl: F, Hh: M, Hl: G } = this;
    for (let L = 0; L < 80; L++) {
      const J = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & v ^ ~I & C, k = _ & R ^ ~_ & F, U = le.add5L(G, O, k, Cl[L], en[L]), q = le.add5H(U, M, J, T, El[L], Kt[L]), Y = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), E = r & i ^ r & d ^ i & d, a = s & o ^ s & A ^ o & A;
      M = C | 0, G = F | 0, C = v | 0, F = R | 0, v = I | 0, R = _ | 0, { h: I, l: _ } = le.add(h | 0, b | 0, q | 0, Y | 0), h = d | 0, b = A | 0, d = i | 0, A = o | 0, i = r | 0, o = s | 0;
      const c = le.add3L(Y, ee, a);
      r = le.add3H(c, q, H, E), s = c | 0;
    }
    ({ h: r, l: s } = le.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = le.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: d, l: A } = le.add(this.Ch | 0, this.Cl | 0, d | 0, A | 0), { h, l: b } = le.add(this.Dh | 0, this.Dl | 0, h | 0, b | 0), { h: I, l: _ } = le.add(this.Eh | 0, this.El | 0, I | 0, _ | 0), { h: v, l: R } = le.add(this.Fh | 0, this.Fl | 0, v | 0, R | 0), { h: C, l: F } = le.add(this.Gh | 0, this.Gl | 0, C | 0, F | 0), { h: M, l: G } = le.add(this.Hh | 0, this.Hl | 0, M | 0, G | 0), this.set(r, s, i, o, d, A, h, b, I, _, v, R, C, F, M, G);
  }
  roundClean() {
    Kt.fill(0), en.fill(0);
  }
...
function ld(e) {
  ...
  function r(o, d) {
    ...
    for (let C = 0; C < _.length; ++C) {
      ...
      v = kn(v) ^ M, !(C + 6 >= _.length) && R.push(M);
    }
...
var Of = /* @__PURE__ */ function() {
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.txID)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.outputIndex)), t.push(new X().encode(e.owner)), t.push(new D("u64").encode(e.amount)), t.push(new X().encode(e.assetId)), t.push(new Zn().encode(e.txPointer)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.witnessIndex)), t.push(new D("u64").encode(e.predicateGasUsed)), t.push(new D("u64").encode(e.predicateLength)), t.push(new D("u64").encode(e.predicateDataLength)), t.push(new Ee(e.predicateLength.toNumber()).encode(e.predicate)), t.push(
...
var pn = class extends ce {
  ...
  encode(e) {
    const t = [];
    return t.push(new X().encode(e.sender)), t.push(new X().encode(e.recipient)), t.push(new D("u64").encode(e.amount)), t.push(new X().encode(e.nonce)), t.push(new $("u16", { padToWordSize: !0 }).encode(e.data.length)), t.push(new X().encode(e.digest)), t.push(new Ee(e.data.length).encode(e.data)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new X().decode(e, r);
  ...
  encode(e) {
    const t = [];
    return t.push(new Zn().encode(e.txPointer)), t.push(new us().encode(e.inputContract)), t.push(new As().encode(e.outputContract)), t.push(new D("u64").encode(e.mintAmount)), t.push(new X().encode(e.mintAssetId)), t.push(new D("u64").encode(e.gasPrice)), ie(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new Zn().decode(e, r);
...
function Mh(e, t, n = Ed) {
  ...
  do {
    ...
    if (M) {
      if (b = v.length === 0 ? void 0 : _[_.length - 1], h = I, I = v.pop(), G)
        if (i) {
          h = h.slice();
          let J = 0;
          for (const [O, T] of A) {
            const k = O - J;
            T === null ? (h.splice(k, 1), J++) : h[k] = T;
          }
        } else {
    ...
    if (!Array.isArray(h)) {
      ...
      const J = M ? (R = r.get(h.kind)) === null || R === void 0 ? void 0 : R.leave : (C = r.get(h.kind)) === null || C === void 0 ? void 0 : C.enter;
      if (L = J == null ? void 0 : J.call(t, h, b, I, _, v), L === Fh)
        break;
      if (L === !1) {
        if (!M) {
          _.pop();
    ...
    if (L === void 0 && G && A.push([b, h]), M)
      ...
      s = {
        ...
        edits: A,
        prev: s
      }, i = Array.isArray(h), o = i ? h : (F = n[h.kind]) !== null && F !== void 0 ? F : [], d = -1, A = [], I && v.push(I), I = h;
    }
  } while (s !== void 0);
    ...
    function() {
      ...
      return O.prototype.makeSubscribe = function(T, k, U, q) {
        ...
        return this.socketState.subscriptions[H] = { query: T, variables: U, subscriber: q }, this.socket.send(L(H, { query: T, operationName: k, variables: U }).text), function() {
          Y.socket.send(J(H).text), delete Y.socketState.subscriptions[H];
        };
...
function Md() {
  return Da || (Da = 1, function(e) {
    ...
    var h = s(Jf), b = h, I = Sh, _ = Uh, v = A(lo), R = Sr, C = Et, F = Qr;
    ...
    var M = function(f) {
      ...
      var w = f.url, y = f.query, g = f.variables, u = f.operationName, m = f.headers, Z = f.fetch, W = f.fetchOptions, K = f.middleware;
      ...
      function() {
        ...
        return f.prototype.rawRequest = function(w, y, g) {
          return i(this, void 0, void 0, function() {
            var u, m, Z, W, K, j, re, se, Se, he, oe, ve;
            return o(this, function(Ae) {
              return u = C.parseRawRequestArgs(w, y, g), m = this.options, Z = m.headers, W = m.fetch, K = W === void 0 ? h.default : W, j = m.method, re = j === void 0 ? "POST" : j, se = m.requestMiddleware, Se = m.responseMiddleware, he = d(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, u.signal !== void 0 && (he.signal = u.signal), ve = E(u.query).operationName, [2, k({
                url: oe,
                query: u.query,
                variables: u.variables,
                headers: t(t({}, M(a(Z))), M(u.requestHeaders)),
                operationName: ve,
                fetch: K,
                method: re,
                fetchOptions: he,
          ...
          for (var y = [], g = 1; g < arguments.length; g++)
            y[g - 1] = arguments[g];
          var u = y[0], m = y[1], Z = C.parseRequestArgs(w, u, m), W = this.options, K = W.headers, j = W.fetch, re = j === void 0 ? h.default : j, se = W.method, Se = se === void 0 ? "POST" : se, he = W.requestMiddleware, oe = W.responseMiddleware, ve = d(W, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), Ae = this.url;
          Z.signal !== void 0 && (ve.signal = Z.signal);
          var ge = E(Z.document), Tt = ge.query, xe = ge.operationName;
          return k({
            url: Ae,
            query: Tt,
          ...
          var g = C.parseBatchRequestArgs(w, y), u = this.options, m = u.headers, Z = u.fetch, W = Z === void 0 ? h.default : Z, K = u.method, j = K === void 0 ? "POST" : K, re = u.requestMiddleware, se = u.responseMiddleware, Se = d(u, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), he = this.url;
    ...
    e.GraphQLClient = T;
    function k(f) {
      var w = f.url, y = f.query, g = f.variables, u = f.headers, m = f.operationName, Z = f.fetch, W = f.method, K = W === void 0 ? "POST" : W, j = f.fetchOptions, re = f.middleware;
      return i(this, void 0, void 0, function() {
        var se, Se, he, oe, ve, Ae, ge, Tt, xe, ye, rr;
        return o(this, function(Qe) {
          switch (Qe.label) {
            case 0:
              return se = K.toUpperCase() === "POST" ? J : O, Se = Array.isArray(y), [4, se({
                url: w,
                query: y,
                variables: g,
                operationName: m,
    ...
    function q(f, w) {
      ...
      return i(this, void 0, void 0, function() {
        ...
        return o(this, function(K) {
          return u = y[0], m = y[1], Z = C.parseRequestExtendedArgs(f, w, u, m), W = new T(Z.url), [2, W.request(t({}, Z))];
        });
      });
    }
    e.request = q;
    ...
    function H(f, w) {
      return w === void 0 && (w = R.defaultJsonSerializer), i(this, void 0, void 0, function() {
        ...
        return o(this, function(m) {
          switch (m.label) {
            case 0:
              return f.headers.forEach(function(Z, W) {
                W.toLowerCase() === "content-type" && (y = Z);
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let R = 0; R < d; R++) {
        ...
        let F = Number(o & I);
        o >>= v, F > A && (F -= _, o += si);
        const M = C, G = C + Math.abs(F) - 1, L = R % 2 !== 0, J = F < 0;
        F === 0 ? b = b.add(n(L, i[M])) : h = h.add(n(J, i[G]));
      }
      return { p: h, f: b };
    },
    wNAFCached(s, i, o, d) {
...
BigInt(4);
function V0(e) {
  const t = X0(e), { Fp: n } = t, r = t.toBytes || ((R, C, F) => {
    const M = C.toAffine();
  ...
  class I {
    ...
    equals(C) {
      b(C);
      const { px: F, py: M, pz: G } = this, { px: L, py: J, pz: O } = C, T = n.eql(n.mul(F, O), n.mul(L, G)), k = n.eql(n.mul(M, O), n.mul(J, G));
      return T && k;
    }
    /**
    ...
    double() {
      const { a: C, b: F } = t, M = n.mul(F, Ua), { px: G, py: L, pz: J } = this;
      let O = n.ZERO, T = n.ZERO, k = n.ZERO, U = n.mul(G, G), q = n.mul(L, L), Y = n.mul(J, J), H = n.mul(G, L);
      return H = n.add(H, H), k = n.mul(G, J), k = n.add(k, k), O = n.mul(C, k), T = n.mul(M, Y), T = n.add(O, T), O = n.sub(q, T), T = n.add(q, T), T = n.mul(O, T), O = n.mul(H, O), k = n.mul(M, k), Y = n.mul(C, Y), H = n.sub(U, Y), H = n.mul(C, H), H = n.add(H, k), k = n.add(U, U), U = n.add(k, U), U = n.add(U, Y), U = n.mul(U, H), T = n.add(T, U), Y = n.mul(L, J), Y = n.add(Y, Y), U = n.mul(Y, H), O = n.sub(O, U), k = n.mul(Y, q), k = n.add(k, k), k = n.add(k, k), new I(O, T, k);
    }
    ...
    add(C) {
      b(C);
      const { px: F, py: M, pz: G } = this, { px: L, py: J, pz: O } = C;
      let T = n.ZERO, k = n.ZERO, U = n.ZERO;
      const q = t.a, Y = n.mul(t.b, Ua);
      let H = n.mul(F, L), ee = n.mul(M, J), E = n.mul(G, O), a = n.add(F, M), c = n.add(L, J);
      a = n.mul(a, c), c = n.add(H, ee), a = n.sub(a, c), c = n.add(F, G);
      let l = n.add(L, O);
      return c = n.mul(c, l), l = n.add(H, E), c = n.sub(c, l), l = n.add(M, G), T = n.add(J, O), l = n.mul(l, T), T = n.add(ee, E), l = n.sub(l, T), U = n.mul(q, c), T = n.mul(Y, E), U = n.add(T, U), T = n.sub(ee, U), U = n.add(ee, U), k = n.mul(T, U), ee = n.add(H, H), ee = n.add(ee, H), E = n.mul(q, E), c = n.mul(Y, c), ee = n.add(ee, E), E = n.sub(H, E), E = n.mul(q, E), c = n.add(c, E), H = n.mul(ee, c), k = n.add(k, H), H = n.mul(l, c), T = n.mul(a, T), T = n.sub(T, H), H = n.mul(a, ee), U = n.mul(l, U), U = n.add(U, H), new I(T, k, U);
    }
    subtract(C) {
    ...
    multiplyUnsafe(C) {
      ...
      let { k1neg: G, k1: L, k2neg: J, k2: O } = M.splitScalar(C), T = F, k = F, U = this;
      for (; L > Zt || O > Zt; )
        L & Rt && (T = T.add(U)), O & Rt && (k = k.add(U)), U = U.double(), L >>= Rt, O >>= Rt;
      return G && (T = T.negate()), J && (k = k.negate()), k = new I(n.mul(k.px, M.beta), k.py, k.pz), T.add(k);
    }
    /**
    ...
    multiply(C) {
      ...
      const { endo: L } = t;
      if (L) {
        const { k1neg: J, k1: O, k2neg: T, k2: k } = L.splitScalar(F);
        let { p: U, f: q } = this.wNAF(O), { p: Y, f: H } = this.wNAF(k);
        U = v.constTimeNegate(J, U), Y = v.constTimeNegate(T, Y), Y = new I(n.mul(Y.px, L.beta), Y.py, Y.pz), M = U.add(Y), G = q.add(H);
      } else {
    ...
    multiplyAndAddUnsafe(C, F, M) {
      const G = I.BASE, L = (O, T) => T === Zt || T === Rt || !O.equals(G) ? O.multiplyUnsafe(T) : O.multiply(T), J = L(this, F).add(L(C, M));
    ...
    toAffine(C) {
      ...
      const J = n.mul(F, C), O = n.mul(M, C), T = n.mul(G, C);
      if (L)
...
function Z0(e) {
  ...
  class M {
    ...
    recoverPublicKey(l) {
      ...
      const u = w & 1 ? "03" : "02", m = h.fromHex(u + v(g)), Z = A(g), W = d(-y * Z), K = d(f * Z), j = h.BASE.multiplyAndAddUnsafe(m, W, K);
      if (!j)
  ...
  function Y(c, l, p = H) {
    ...
    function re(se) {
      ...
      if (ve === Zt)
        return;
      const Ae = d(he * d(j + ve * Z));
      if (Ae === Zt)
        return;
      let ge = (oe.x === ve ? 0 : 2) | Number(oe.y & Rt), Tt = Ae;
      return y && R(Ae) && (Tt = C(Ae), ge ^= 1), new M(ve, Tt, ge);
    }
  ...
  function a(c, l, p, f = ee) {
    ...
    if (y && u.hasHighS())
      return !1;
    g && (l = t.hash(l));
    const { r: Z, s: W } = u, K = k(l), j = A(W), re = d(K * j), se = d(Z * j), Se = (oe = h.BASE.multiplyAndAddUnsafe(m, re, se)) == null ? void 0 : oe.toAffine();
    return Se ? d(Se.x) === Z : !1;
  }
  return {
    CURVE: t,
    getPublicKey: L,
...
function j0(e) {
  const t = Zd, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), d = BigInt(44), A = BigInt(88), h = e * e * e % t, b = h * h * e % t, I = xt(b, n, t) * b % t, _ = xt(I, n, t) * b % t, v = xt(_, Ri, t) * h % t, R = xt(v, s, t) * v % t, C = xt(R, i, t) * R % t, F = xt(C, d, t) * C % t, M = xt(F, A, t) * F % t, G = xt(M, d, t) * C % t, L = xt(G, n, t) * b % t, J = xt(L, o, t) * R % t, O = xt(J, r, t) * h % t, T = xt(O, Ri, t);
...
var kp = "https://fuellabs.github.io/block-explorer-v2", Pp = (e, t) => `${{
  ...
  const I = b ? Pp(
    h[0].key,
    h[0].value
  ) : "", _ = /^\/|\/$/gm, v = n ? n.replace(_, "") : I, R = d.replace(_, ""), C = r == null ? void 0 : r.replace(_, ""), F = C ? encodeURIComponent(C) : void 0, M = R.match(/^https?:\/\//) ? "" : "https://", G = C != null && C.match(/^https?:\/\//) ? "" : "https://";
...
var Wp = (e) => {
  ...
  const G = Au({
    ...
    metadataGas: F,
    txBytesSize: b.length
  }), L = (k = C.find((U) => U.type === Qt.WitnessLimit)) == null ? void 0 : k.data, J = v.reduce((U, q) => U + q.dataLength, 0), O = yo({
    gasPerByte: A,
    minGas: G,
    witnessesLength: J,
    gasLimit: M,
...
function Ss(e) {
  ...
  const {
    ...
    maxInputs: h,
    baseAssetId: v
  }), M = wu(i.type), G = B((l = (c = i.policies) == null ? void 0 : c.find((p) => p.type === Qt.Tip)) == null ? void 0 : l.data), { isStatusFailure: L, isStatusPending: J, isStatusSuccess: O, blockId: T, status: k, time: U, totalFee: q } = Qm(d), Y = $p({
    totalFee: q,
    gasPrice: _,
    rawPayload: C,
    tip: G,
...
`)
      ...
      for (let h = 0; h < d.dryRun.length; h++) {
        ...
        if (F && (M == null ? void 0 : M.type) === Le.Script) {
          v.outputVariables += R.length, M.addVariableOutputs(R.length), C.forEach(({ contractId: L }) => {
            M.addContractInputAndOutput(ue.fromString(L)), v.missingContractIds.push(L);
          });
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    ...
    if (n && i) {
      ...
      await n(b), I = b.witnesses.length - k;
    }
    ...
    if (s.maxFee = _, i) {
      if (s.gasLimit = M, n && await n(s), { receipts: G, missingContractIds: J, outputVariables: O, dryRunStatus: L } = await this.estimateTxDependencies(s), L && "reason" in L)
        throw this.extractDryRunError(s, G, L);
      T = uu(G), s.gasLimit = T, { maxFee: _, maxGas: v, minFee: R, minGas: C, gasPrice: F } = await this.estimateTxGasAndFee({
...
async function Iy(e) {
  const { provider: t, transactionRequest: n, abiMap: r } = e, { receipts: s } = await t.call(n), { gasPerByte: i, gasPriceFactor: o, gasCosts: d, maxGasPerTx: A } = t.getGasConfig(), h = t.getChain().consensusParameters.txParameters.maxInputs, b = n.toTransaction(), I = n.toTransactionBytes(), _ = await t.getLatestGasPrice(), v = t.getBaseAssetId();
  return Ss({
    receipts: s,
    transaction: b,
    transactionBytes: I,
...
async function by(e) {
  ...
  return {
    transactions: i.map((C) => {
      const { node: F } = C, { id: M, rawPayload: G, status: L } = F, [J] = new wn().decode(z(G), 0);
      let O = [];
...
var Gm = "https://cdn.fuel.network/assets/", Xm = [
  ...
  async fund(t, n) {
    var M;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, d = t.maxFee, A = this.provider.getBaseAssetId(), h = ((M = i.find((G) => G.assetId === A)) == null ? void 0 : M.amount) || B(0), b = vg({
      amount: B(d),
      assetId: A,
      coinQuantities: i
    }), I = {};
    b.forEach(({ amount: G, assetId: L }) => {
      ...
      const J = nr(G) ? String(G.assetId) : A;
      I[J] && (I[J].owned = I[J].owned.add(G.amount));
    });
    let _ = [];
    Object.entries(I).forEach(([G, { owned: L, required: J }]) => {
      L.lt(J) && _.push({
        assetId: G,
        amount: J.sub(L)
      });
...
var Cw = (e) => e === de.Return || e === de.ReturnData, Bw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const b = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], F = h, M = F + fe, G = M + as, L = G + af + fe + fe, J = L + C.fnSelectorBytes.byteLength, O = z(C.data);
      let T = 0;
      b.push(new D("u64").encode(C.amount || 0)), b.push(new X().encode(((v = C.assetId) == null ? void 0 : v.toString()) || Ne)), b.push(C.contractId.toBytes()), b.push(new D("u64").encode(L)), b.push(new D("u64").encode(J)), b.push(C.fnSelectorBytes), b.push(O), C.gas && (b.push(new D("u64").encode(C.gas)), T = J + O.byteLength);
      const k = {
        amountOffset: F,
        assetIdOffset: M,
        gasForwardedOffset: T,
