...
(function(e) {
  (function(t, n) {
    ...
    i.prototype.mulTo = function(a, A) {
      ...
      return this.length === 10 && a.length === 10 ? l = Z(this, a, A) : p < 63 ? l = S(this, a, A) : p < 1024 ? l = L(this, a, A) : l = j(this, a, A), l;
...
class To extends Oo {
  ...
  process(t, n) {
    ...
    for (let L = 16; L < 80; L++) {
      const j = cn[L - 15] | 0, M = An[L - 15] | 0, k = ue.rotrSH(j, M, 1) ^ ue.rotrSH(j, M, 8) ^ ue.shrSH(j, M, 7), O = ue.rotrSL(j, M, 1) ^ ue.rotrSL(j, M, 8) ^ ue.shrSL(j, M, 7), P = cn[L - 2] | 0, W = An[L - 2] | 0, U = ue.rotrSH(P, W, 19) ^ ue.rotrBH(P, W, 61) ^ ue.shrSH(P, W, 6), H = ue.rotrSL(P, W, 19) ^ ue.rotrBL(P, W, 61) ^ ue.shrSL(P, W, 6), z = ue.add4L(O, H, An[L - 7], An[L - 16]), B = ue.add4H(z, k, U, cn[L - 7], cn[L - 16]);
      cn[L] = B | 0, An[L] = z | 0;
    }
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: f, Dl: y, Eh: m, El: b, Fh: F, Fl: x, Gh: C, Gl: N, Hh: S, Hl: Z } = this;
    for (let L = 0; L < 80; L++) {
      const j = ue.rotrSH(m, b, 14) ^ ue.rotrSH(m, b, 18) ^ ue.rotrBH(m, b, 41), M = ue.rotrSL(m, b, 14) ^ ue.rotrSL(m, b, 18) ^ ue.rotrBL(m, b, 41), k = m & F ^ ~m & C, O = b & x ^ ~b & N, P = ue.add5L(Z, M, O, ah[L], An[L]), W = ue.add5H(P, S, j, k, oh[L], cn[L]), U = P | 0, H = ue.rotrSH(r, s, 28) ^ ue.rotrBH(r, s, 34) ^ ue.rotrBH(r, s, 39), z = ue.rotrSL(r, s, 28) ^ ue.rotrBL(r, s, 34) ^ ue.rotrBL(r, s, 39), B = r & i ^ r & c ^ i & c, a = s & o ^ s & d ^ o & d;
...
class Fh extends Oo {
  ...
  process(t, n) {
    ...
    for (let F = 0; F < 5; F++) {
      const x = 4 - F, C = vh[F], N = xh[F], S = Lo[F], Z = Po[F], L = bh[F], j = Qh[F];
      for (let M = 0; M < 16; M++) {
        const k = os(r + Va(F, i, c, f) + as[S[M]] + C, L[M]) + m | 0;
        r = m, m = f, f = os(c, 10) | 0, c = i, i = k;
      }
      for (let M = 0; M < 16; M++) {
        const k = os(s + Va(x, o, d, y) + as[Z[M]] + N, j[M]) + b | 0;
...
function Ka(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], f = e[t++] ^ n[r++], y = e[t++] ^ n[r++], m = e[t++] ^ n[r++], b = e[t++] ^ n[r++], F = e[t++] ^ n[r++], x = e[t++] ^ n[r++], C = e[t++] ^ n[r++], N = e[t++] ^ n[r++], S = e[t++] ^ n[r++], Z = e[t++] ^ n[r++], L = e[t++] ^ n[r++], j = e[t++] ^ n[r++], M = e[t++] ^ n[r++], k = o, O = c, P = d, W = f, U = y, H = m, z = b, B = F, a = x, A = C, l = N, p = S, h = Z, E = L, I = j, g = M;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + k | 0, s[i++] = c + O | 0, s[i++] = d + P | 0, s[i++] = f + W | 0, s[i++] = y + U | 0, s[i++] = m + H | 0, s[i++] = b + z | 0, s[i++] = F + B | 0, s[i++] = x + a | 0, s[i++] = C + A | 0, s[i++] = N + l | 0, s[i++] = S + p | 0, s[i++] = Z + h | 0, s[i++] = L + E | 0, s[i++] = j + I | 0, s[i++] = M + g | 0;
}
...
var Qr = (e) => e instanceof Zu ? e.address : e instanceof ug ? e.id : e, Cg = () => X(yn(32)), bg = (e) => {
  let t;
  try {
    if (!Ao(e))
      throw new v(
...
function Bp(e, t, n = nd) {
  ...
  do {
    ...
    if (!Array.isArray(f)) {
      ...
      if (L = j == null ? void 0 : j.call(t, f, y, m, b, F), L === yp)
        break;
      if (L === !1) {
        if (!S) {
          b.pop();
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let x = 0; x < c; x++) {
        ...
        let N = Number(o & m);
        o >>= F, N > d && (N -= b, o += Yi);
        const S = C, Z = C + Math.abs(N) - 1, L = x % 2 !== 0, j = N < 0;
        N === 0 ? y = y.add(n(L, i[S])) : f = f.add(n(j, i[Z]));
      }
      return { p: f, f: y };
    },
    wNAFCached(s, i, o, c) {
...
function km(e) {
  ...
  class m {
    ...
    equals(C) {
      y(C);
      const { px: N, py: S, pz: Z } = this, { px: L, py: j, pz: M } = C, k = n.eql(n.mul(N, M), n.mul(L, Z)), O = n.eql(n.mul(S, M), n.mul(j, Z));
      return k && O;
    }
    /**
    ...
    double() {
      const { a: C, b: N } = t, S = n.mul(N, Pc), { px: Z, py: L, pz: j } = this;
      let M = n.ZERO, k = n.ZERO, O = n.ZERO, P = n.mul(Z, Z), W = n.mul(L, L), U = n.mul(j, j), H = n.mul(Z, L);
      return H = n.add(H, H), O = n.mul(Z, j), O = n.add(O, O), M = n.mul(C, O), k = n.mul(S, U), k = n.add(M, k), M = n.sub(W, k), k = n.add(W, k), k = n.mul(M, k), M = n.mul(H, M), O = n.mul(S, O), U = n.mul(C, U), H = n.sub(P, U), H = n.mul(C, H), H = n.add(H, O), O = n.add(P, P), P = n.add(O, P), P = n.add(P, U), P = n.mul(P, H), k = n.add(k, P), U = n.mul(L, j), U = n.add(U, U), P = n.mul(U, H), M = n.sub(M, P), O = n.mul(U, W), O = n.add(O, O), O = n.add(O, O), new m(M, k, O);
    }
    ...
    add(C) {
      y(C);
      const { px: N, py: S, pz: Z } = this, { px: L, py: j, pz: M } = C;
      let k = n.ZERO, O = n.ZERO, P = n.ZERO;
      const W = t.a, U = n.mul(t.b, Pc);
      let H = n.mul(N, L), z = n.mul(S, j), B = n.mul(Z, M), a = n.add(N, S), A = n.add(L, j);
    ...
    multiplyUnsafe(C) {
      ...
      let { k1neg: Z, k1: L, k2neg: j, k2: M } = S.splitScalar(C), k = N, O = N, P = this;
      for (; L > tn || M > tn; )
    ...
    multiply(C) {
      ...
      const { endo: L } = t;
      if (L) {
        const { k1neg: j, k1: M, k2neg: k, k2: O } = L.splitScalar(N);
        let { p: P, f: W } = this.wNAF(M), { p: U, f: H } = this.wNAF(O);
        P = F.constTimeNegate(j, P), U = F.constTimeNegate(k, U), U = new m(n.mul(U.px, L.beta), U.py, U.pz), S = P.add(U), Z = W.add(H);
      } else {
    ...
    multiplyAndAddUnsafe(C, N, S) {
      const Z = m.BASE, L = (M, k) => k === tn || k === _t || !M.equals(Z) ? M.multiplyUnsafe(k) : M.multiply(k), j = L(this, N).add(L(C, S));
...
function Um(e) {
  const t = Dd, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), f = e * e * e % t, y = f * f * e % t, m = St(y, n, t) * y % t, b = St(m, n, t) * y % t, F = St(b, Eo, t) * f % t, x = St(F, s, t) * F % t, C = St(x, i, t) * x % t, N = St(C, c, t) * C % t, S = St(N, d, t) * N % t, Z = St(S, c, t) * C % t, L = St(Z, n, t) * y % t, j = St(L, o, t) * x % t, M = St(j, r, t) * f % t, k = St(M, Eo, t);
...
function hE(e) {
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const N = xe(e.sender), S = xe(e.recipient), Z = xe(e.nonce), L = Q(e.amount), j = e.data ? J(e.data) : Uint8Array.from([]), M = xe(e.digest), k = Ps.getMessageId({
        sender: N,
        recipient: S,
        nonce: Z,
        amount: L,
...
var yE = (e) => {
  ...
  constructor({
    ...
    D(this, "storageSlots");
    this.bytecodeWitnessIndex = t ?? 0, this.salt = X(n ?? ve), this.storageSlots = [...r ?? []];
  }
  static from(t) {
  ...
  const C = Yd({
    ...
    gasLimit: x,
    witnessLimit: S
  }), j = jn(t, N, o), M = jn(C, N, o), k = jn(L, N, o);
  return {
    fee: M.add(j),
    minFee: M,
    maxFee: k,
...
function pi(e) {
  ...
  }), { isStatusFailure: N, isStatusPending: S, isStatusSuccess: Z, blockId: L, status: j, time: M } = eI(c), k = $E(n), O = KE(n);
  let P;
...
async function tB(e) {
  ...
  return {
    transactions: i.map((b) => {
      const { node: F } = b, { id: x, rawPayload: C, receipts: N, status: S } = F, [Z] = new Bn().decode(J(C), 0), L = (N == null ? void 0 : N.map(Wn)) || [], j = pi({
        id: x,
        receipts: L,
        transaction: Z,
...
}, ya = hn, o0 = 2147483648, a0 = X("0x0488ade4"), Ba = X("0x0488b21e"), c0 = X("0x04358394"), Ca = X("0x043587cf");
function tA(e) {
...
var Tn = class {
  ...
  toExtendedKey(e = !1, t = !1) {
    ...
    const n = QI(this.privateKey == null || e, t), r = X(Uint8Array.from([this.depth])), s = this.parentFingerprint, i = _o(this.index, 4), o = this.chainCode, c = this.privateKey != null && !e ? se(["0x00", this.privateKey]) : this.publicKey, d = J(se([n, r, s, i, o, c]));
    return tA(d);
  }
  /**
