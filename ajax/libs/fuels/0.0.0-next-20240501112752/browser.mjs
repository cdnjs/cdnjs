...
var LI = (e) => {
  ...
  return n;
}, Q0 = 37, $c = BigInt(2 ** 62) + BigInt(Q0), x0 = (e) => Math.floor(e / 1e3), zc = (e) => e * 1e3, v0 = (e) => Number(BigInt(e) - $c), _0 = (e) => String(BigInt(e) + $c), D0 = (e) => zc(v0(e)), As = class extends Date {
  /**
...
const aA = Ur(() => new wl()), Kr = BigInt(2 ** 32 - 1), Gi = BigInt(32);
function cA(e, t = !1) {
...
].map((e) => new Uint8Array(e)), Wl = Co.map((e, t) => e.map((n) => fA[t][n])), $l = bo.map((e, t) => e.map((n) => fA[t][n])), zl = new Uint32Array([0, 1518500249, 1859775393, 2400959708, 2840853838]), Kl = new Uint32Array([1352829926, 1548603684, 1836072691, 2053994217, 0]), es = (e, t) => e << t | e >>> 32 - t;
function Da(e, t, n, r) {
...
class eh extends yo {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      ...
      for (let O = 0; O < 16; O++) {
        const k = es(r + Da(v, i, c, h) + ts[N[O]] + C, L[O]) + E | 0;
        r = E, E = h, h = es(c, 10) | 0, c = i, i = k;
      }
      for (let O = 0; O < 16; O++) {
        const k = es(s + Da(_, o, u, I) + ts[G[O]] + M, X[O]) + b | 0;
...
class Ah extends xo {
  ...
  digestInto(t) {
    er(this), BA(t, this), this.finished = !0;
    const { buffer: n, view: r, blockLen: s, isLE: i } = this;
    let { pos: o } = this;
    n[o++] = 128, this.buffer.subarray(o).fill(0), this.padOffset > s - o && (this.process(r, 0), o = 0);
    for (let E = o; E < s; E++)
...
function ph(e, t, n) {
  ...
  const _ = vA(Hr, e, t, { c: 1, dkLen: E * o }), C = us(_), M = us(new Uint8Array(E * s)), N = us(new Uint8Array(E));
  let G = () => {
  };
  if (I) {
...
const ns = /* @__PURE__ */ BigInt(2 ** 32 - 1), Sa = /* @__PURE__ */ BigInt(32);
function wh(e, t = !1) {
  return t ? { h: Number(e & ns), l: Number(e >> Sa & ns) } : { h: Number(e >> Sa & ns) | 0, l: Number(e & ns) | 0 };
}
function Ih(e, t = !1) {
  let n = new Uint32Array(e.length), r = new Uint32Array(e.length);
  for (let s = 0; s < e.length; s++) {
...
const yh = (e, t, n) => e << n | t >>> 32 - n, Bh = (e, t, n) => t << n | e >>> 32 - n, Ch = (e, t, n) => t << n - 32 | e >>> 64 - n, bh = (e, t, n) => e << n - 32 | t >>> 64 - n, [_A, DA, RA] = [[], [], []], Qh = /* @__PURE__ */ BigInt(0), gr = /* @__PURE__ */ BigInt(1), xh = /* @__PURE__ */ BigInt(2), vh = /* @__PURE__ */ BigInt(7), _h = /* @__PURE__ */ BigInt(256), Dh = /* @__PURE__ */ BigInt(113);
...
}, LA = "u8", FA = "u16", PA = "u32", UA = "u64", GA = "u256", HA = "raw untyped ptr", JA = "raw untyped slice", YA = "bool", ZA = "b256", VA = "struct B512", Ro = "enum Option", So = "struct Vec", No = "struct Bytes", ko = "struct String", XA = "str", Mo = /str\[(?<length>[0-9]+)\]/, Cs = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Oo = /^struct (?<name>\w+)$/, To = /^enum (?<name>\w+)$/, jA = /^\((?<items>.*)\)$/, zh = /^generic (?<name>\w+)$/, Ut = "0", nr = "1", ee = 8, bn = 32, Ji = bn + 2, kn = bn, qA = bn, Kh = bn, ef = ee * 4, tf = ee * 2, Lo = 2 ** 32 - 1, js = ({ maxInputs: e }) => bn + // Tx ID
kn + // Base asset ID
...
}, Af = (e) => e === So || e === No || e === ko, vr = (e) => e % ee === 0, $A = (e) => ee - e % ee, zA = (e) => {
  if (vr(e.length))
    return e;
...
), qn, In, Ps, nd, Us, rd, Gc, td = (Gc = class extends ie {
  constructor(t, n) {
...
}, qn = new WeakMap(), In = new WeakMap(), Ps = new WeakSet(), nd = function(t) {
...
Jr(od, "memorySize", 1);
var Wn, Hc, ff = (Hc = class extends ie {
  constructor(t) {
    let n = (8 - t) % 8;
    n = n < 0 ? n + 8 : n;
...
}, Wn = new WeakMap(), Hc), qs = class extends ie {
  constructor(t, n) {
  ...
  decode(t, n) {
    ...
    return [Object.keys(this.coders).reduce((i, o) => {
      ...
      let u;
      return [u, r] = c.decode(t, r), vr(r) || (r += $A(r)), i[o] = u, i;
    }, {}), r];
  }
}, ad = class extends ie {
  constructor(t) {
  ...
  decode(t, n) {
    ...
    return [this.coders.map((i) => {
      let o;
      return [o, r] = i.decode(t, r), vr(r) || (r += $A(r)), o;
    }), r];
  }
}, cd = class extends ie {
  constructor(t) {
...
var Tn = (e, t) => {
  ...
  if (e.type === So) {
    const v = dd(r), _ = new en(e.abi, v), C = Tn(_, { isSmallBytes: !0, encoding: Ut });
    return new cd(C);
  }
...
var mf = (e) => Object.values(e).every(
  // @ts-expect-error complicated types
  ({ type: t, coders: n }) => t === "()" && JSON.stringify(n) === JSON.stringify([])
), $n, zn, Gs, hd, Hs, fd, Jc, ld = (Jc = class extends ie {
  constructor(t, n) {
    const r = new R("u64"), s = Object.values(n).reduce(
      (i, o) => Math.max(i, o.encodedLength),
      0
...
}, $n = new WeakMap(), zn = new WeakMap(), Gs = new WeakSet(), hd = function(t) {
...
var If = class extends ie {
  ...
  if (e.type === So) {
    const v = dd(r), _ = new en(e.abi, v), C = Ln(_);
    return new Bf(C);
  }
  const i = (I = Oo.exec(e.type)) == null ? void 0 : I.groups;
  if (i) {
...
}, Js, md, Ys, Ed, Zs, wd, Zc, fs = (Zc = class {
  constructor(e, t) {
    mt(this, Js);
    mt(this, Ys);
    mt(this, Zs);
    ...
    S(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = gf(this.jsonAbi, t), this.name = t, this.signature = fs.getSignature(this.jsonAbi, this.jsonFn), this.selector = fs.getFunctionSelector(this.signature), this.selectorBytes = new Uo().encode(t), this.encoding = Ad(e.encoding), this.isInputDataPointer = cn(this, Js, md).call(this), this.outputMetadata = {
...
var Ir = (e) => e instanceof Id ? e.address : e instanceof Qf ? e.id : e, Sf = () => V(Xt(32)), Nf = (e) => {
  let t;
  try {
    if (!Xi(e))
      throw new x(
...
}, yn = new WeakMap(), Vc), sr = class extends qs {
  constructor() {
    super("TxPointer", {
...
class Ud {
  constructor(t, n = "GraphQL request", r = {
    ...
    typeof t == "string" || ms(!1, `Body must be a string. Received: ${Pd(t)}.`), this.body = t, this.name = n, this.locationOffset = r, this.locationOffset.line > 0 || ms(
      !1,
...
function Fg(e, t, n = kd) {
  ...
  do {
    ...
    if (!Array.isArray(h)) {
      var _, C;
      cc(h) || ms(!1, `Invalid AST Node: ${Pd(h)}.`);
...
var Xg = typeof self == "object" ? self.FormData : window.FormData, Vr = {};
...
var Vd = Ks, qg = jg(Xg), Wg = Vr, $g = function(e) {
...
var Xr = {}, ip = Be && Be.__extends || function() {
  var e = function(t, n) {
...
function Xd() {
  return lc || (lc = 1, function(e) {
    ...
    var h = s($f), I = h, E = Ng, b = Jg, v = u(qo), _ = Vr, C = bt, M = Xr;
...
var $o = { exports: {} }, Xn = typeof Reflect == "object" ? Reflect : null, Bc = Xn && typeof Xn.apply == "function" ? Xn.apply : function(t, n, r) {
...
${Bp}#variant.${e.reason}`), { errorMessage: t, reason: n };
}, Er = (e) => JSON.stringify(e, null, 2), JE = (e, t) => {
  ...
  getBaseTransaction() {
    var i, o, c;
    const e = ((i = this.inputs) == null ? void 0 : i.map(SE)) ?? [], t = ((o = this.outputs) == null ? void 0 : o.map(NE)) ?? [], n = ((c = this.witnesses) == null ? void 0 : c.map(ZE)) ?? [], { policyTypes: r, policies: s } = kr.getPolicyMeta(this);
    return {
      policyTypes: r,
      inputs: e,
      outputs: t,
...
var Cy = [
  ...
  const t = Lw(e);
  await Wo();
  const n = vp(16, 0, Dp.ScriptData), r = fc(17, 16, 32), s = Cr(18, 17, 0), i = fc(19, 17, 8), o = Qp(16, 18, 19), c = Kd(1);
...
async function Gw(e, t, n) {
  const r = Bn(Nc(e), "hex"), s = de.fromAddressOrString(t), i = Xt(Ni), o = kA({
    ...
    r: Rc,
    p: Sc
  }), c = Xt(Uw), u = await Vh(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...u]), I = MA(h), E = wr(I, "hex"), b = {
    id: am(),
    version: 3,
...
async function Hw(e, t) {
  const n = JSON.parse(e), {
    ...
    r: u,
    dklen: o
  }), M = Uint8Array.from([...C.subarray(16, 32), ...E]), N = MA(M), G = wr(N, "hex");
  if (r !== G)
    throw new x(
      D.INVALID_PASSWORD,
...
var dI = 2e3, uI = 5e3, { warn: lI } = console, Qr = class extends aI {
  ...
  async pingConnector(t) {
    ...
    if (!n)
      return !1;
    try {
      return await cI(async () => as(n.ping()), {
        key: n.name,
  ...
  async selectConnector(t, n = {
    ...
    return s ? (this._currentConnector = r, this.emit(this.events.currentConnector, r), this.setupConnectorEvents(Object.values(Aa)), await ((o = this._storage) == null ? void 0 : o.setItem(Qr.STORAGE_KEY, r.name)), n.emitEvents && this.triggerConnectorEvents(), !0) : !1;
  }
  /**
  ...
  async hasConnector() {
    ...
    return this.once(this.events.currentConnector, () => {
      t.resolve(!0);
    }), as(t.promise, dI).then(() => !0).catch(() => !1);
  }
  async hasWallet() {
...
}, Vt = new WeakMap(), Xc), hI = (e) => Fo + js({ maxInputs: e }), n0 = ee + kn + qA + ee + ee;
function fI(e) {
  const t = [...e.receipts];
  let n, r;
  if (t.forEach((i) => {
...
var Pc = (e) => e === Ae.Return || e === Ae.ReturnData, mI = (e, t) => e.find(
  ...
  var E;
  const n = [], r = t, s = r + ee, i = s + kn, o = i + qA + ee + ee, c = o + e.fnSelectorBytes.byteLength, u = J(e.data);
  let h = 0;
