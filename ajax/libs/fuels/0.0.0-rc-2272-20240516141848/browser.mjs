...
}, by = 9, Ey = 3, Cy = 9, By = 9, _y = 18, xy = 15, vy = 12, Ry = 9, sc, Sy = typeof process < "u" && ((sc = process == null ? void 0 : process.env) == null ? void 0 : sc.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", Qy = "https://devnet.fuel.network/v1/graphql";
export {
  ts as ASSET_ID_LEN,
  ...
  Qy as FUEL_TESTNET_NETWORK_URL,
  Ru as Fuel,
  iw as FuelConnector,
