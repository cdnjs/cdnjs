...
class Lo extends Oo {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: c, Dl: d, Eh: h, El: y, Fh: p, Fl: b, Gh: F, Gl: x, Hh: C, Hl: R } = this;
    return [t, n, r, s, i, o, c, d, h, y, p, b, F, x, C, R];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, c, d, h, y, p, b, F, x, C, R) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = c | 0, this.Dl = d | 0, this.Eh = h | 0, this.El = y | 0, this.Fh = p | 0, this.Fl = b | 0, this.Gh = F | 0, this.Gl = x | 0, this.Hh = C | 0, this.Hl = R | 0;
  }
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: h, Dl: y, Eh: p, El: b, Fh: F, Fl: x, Gh: C, Gl: R, Hh: S, Hl: Z } = this;
    for (let T = 0; T < 80; T++) {
      ...
      S = C | 0, Z = R | 0, C = F | 0, R = x | 0, F = p | 0, x = b | 0, { h: p, l: b } = ue.add(h | 0, y | 0, W | 0, U | 0), h = c | 0, y = d | 0, c = i | 0, d = o | 0, i = r | 0, o = s | 0;
...
function Ih(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    let s = e[2], i = e[3];
    for (let o = 0; o < 24; o++) {
      const c = SA[o], d = Za(s, i, c), h = Ya(s, i, c), y = RA[o];
...
function Ka(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], h = e[t++] ^ n[r++], y = e[t++] ^ n[r++], p = e[t++] ^ n[r++], b = e[t++] ^ n[r++], F = e[t++] ^ n[r++], x = e[t++] ^ n[r++], C = e[t++] ^ n[r++], R = e[t++] ^ n[r++], S = e[t++] ^ n[r++], Z = e[t++] ^ n[r++], T = e[t++] ^ n[r++], j = e[t++] ^ n[r++], M = e[t++] ^ n[r++], k = o, O = c, P = d, W = h, U = y, H = p, z = b, B = F, a = x, A = C, l = R, m = S, f = Z, E = T, I = j, g = M;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + k | 0, s[i++] = c + O | 0, s[i++] = d + P | 0, s[i++] = h + W | 0, s[i++] = y + U | 0, s[i++] = p + H | 0, s[i++] = b + z | 0, s[i++] = F + B | 0, s[i++] = x + a | 0, s[i++] = C + A | 0, s[i++] = R + l | 0, s[i++] = S + m | 0, s[i++] = Z + f | 0, s[i++] = T + E | 0, s[i++] = j + I | 0, s[i++] = M + g | 0;
}
...
function mp(e, t, n = ed) {
  ...
  do {
    ...
    if (!Array.isArray(h)) {
      ...
      if (T = j == null ? void 0 : j.call(t, h, y, p, b, F), T === pp)
        break;
      if (T === !1) {
        if (!S) {
          b.pop();
    ...
    if (T === void 0 && Z && d.push([y, h]), S)
      ...
      s = {
        ...
        edits: d,
        prev: s
      }, i = Array.isArray(h), o = i ? h : (R = n[h.kind]) !== null && R !== void 0 ? R : [], c = -1, d = [], p && F.push(p), p = h;
    }
  } while (s !== void 0);
...
function fd() {
  return _c || (_c = 1, function(e) {
    ...
    var h = s(Ng), y = h, p = dp, b = Bp, F = d(Aa), x = zr, C = Ft, R = es;
      ...
      function() {
        ...
        return f.prototype.rawRequest = function(E, I, g) {
          ...
          for (var I = [], g = 1; g < arguments.length; g++)
            I[g - 1] = arguments[g];
          var u = I[0], w = I[1], Y = C.parseRequestArgs(E, u, w), V = this.options, $ = V.headers, q = V.fetch, te = q === void 0 ? h.default : q, ne = V.method, Re = ne === void 0 ? "POST" : ne, fe = V.requestMiddleware, oe = V.responseMiddleware, xe = c(V, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), de = this.url;
          ...
          var g = C.parseBatchRequestArgs(E, I), u = this.options, w = u.headers, Y = u.fetch, V = Y === void 0 ? h.default : Y, $ = u.method, q = $ === void 0 ? "POST" : $, te = u.requestMiddleware, ne = u.responseMiddleware, Re = c(u, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), fe = this.url;
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let x = 0; x < c; x++) {
        ...
        R === 0 ? y = y.add(n(T, i[S])) : h = h.add(n(j, i[Z]));
      }
      return { p: h, f: y };
    },
    wNAFCached(s, i, o, c) {
...
function Mm(e) {
  ...
  class p {
    ...
    wNAF(C) {
      return F.wNAFCached(this, h, C, (R) => {
...
function Lm(e) {
  ...
  class S {
    ...
    static fromDER(l) {
      const { r: m, s: f } = Rn.toSig(Ut("DER", l));
      return new S(m, f);
    }
    assertValidity() {
      if (!b(this.r))
  ...
  function a(A, l, m, f = z) {
    ...
    if (I && u.hasHighS())
      return !1;
    g && (l = t.hash(l));
    const { r: Y, s: V } = u, $ = O(l), q = d(V), te = c($ * q), ne = c(Y * q), Re = (oe = h.BASE.multiplyAndAddUnsafe(w, te, ne)) == null ? void 0 : oe.toAffine();
...
function Gm(e) {
  const t = Fd, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), h = e * e * e % t, y = h * h * e % t, p = _t(y, n, t) * y % t, b = _t(p, n, t) * y % t, F = _t(b, Eo, t) * h % t, x = _t(F, s, t) * F % t, C = _t(x, i, t) * x % t, R = _t(C, c, t) * C % t, S = _t(R, d, t) * R % t, Z = _t(S, c, t) * C % t, T = _t(Z, n, t) * y % t, j = _t(T, o, t) * x % t, M = _t(j, r, t) * h % t, k = _t(M, Eo, t);
...
var hw = class {
  ...
  sideNodesForRoot(e, t) {
    ...
    for (let h = 0; h < en; h += 1) {
      if ([s, i] = iw(r), Jn(e, h) === 1 ? (c = s, o = i) : (c = i, o = s), n.push(c), o === Nt) {
        r = "";
        break;
      }
      ...
      if (t[y] !== "") {
        if (c = t[y], o === "")
          if (d = this.get(c), ji(d)) {
            ...
            o = Nt, h = !0;
        !h && c === Nt || (h || (h = !0), Jn(e, t.length - 1 - y) === 1 ? [i, o] = Mn(c, o) : [i, o] = Mn(o, c), this.set(i, o), o = i);
      }
    return i === "" && (i = Nt), i;
  }
...
async function mI(e, t, n) {
  const r = In(Kc(e), "hex"), s = he.fromAddressOrString(t), i = Bn(qi), o = au({
    ...
    r: Wc,
    p: $c
  }), c = Bn(pI), d = await Rf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = cu(h), p = Qr(y, "hex"), b = {
    id: Vm(),
    version: 3,
  ...
  (n) => {
    ...
    for (let C = 0; C < r; C += 1) {
      ...
      if (d.push({
        amountOffset: h,
        assetIdOffset: h + re,
        gasForwardedOffset: R.gas ? h + re + Sr : 0,
