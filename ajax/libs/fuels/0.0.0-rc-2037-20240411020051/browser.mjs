...
const vA = pr(() => new Yl()), us = BigInt(2 ** 32 - 1), no = BigInt(32);
function xA(e, t = !1) {
...
}, lu = "u8", hu = "u16", fu = "u32", gu = "u64", pu = "u256", mu = "raw untyped ptr", wu = "raw untyped slice", Eu = "bool", Iu = "b256", yu = "struct B512", Yo = "enum Option", Vo = "struct Vec", Xo = "struct Bytes", jo = "struct String", Bu = "str", qo = /str\[(?<length>[0-9]+)\]/, Ms = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Wo = /^struct (?<name>\w+)$/, $o = /^enum (?<name>\w+)$/, Cu = /^\((?<items>.*)\)$/, Zf = /^generic (?<name>\w+)$/, _r = "0", zo = "1", K = 8, es = 32, kn = es, bu = es, Yf = es, Vf = K * 4, Xf = K * 2, Ko = 2 ** 32 - 1, ai = ({ maxInputs: e }) => es + // Tx ID
K + // Tx size
...
var Ln = (e, t) => {
  ...
  if (e.type === Vo) {
    const v = Pu(r), F = new en(e.abi, v), C = Ln(F, { isSmallBytes: !0, encoding: _r });
    return new Tu(C);
  }
...
var xr = (e) => e instanceof Wu ? e.address : e instanceof gg ? e.id : e, yg = () => X(Bn(32)), Bg = (e) => {
  let t;
  try {
    if (!ao(e))
      throw new x(
...
var sB = [
  ...
  const t = II(e);
  await da();
  const n = mm(16, 0, Em.ScriptData), r = Lc(17, 16, 32), s = Rr(18, 17, 0), i = Lc(19, 17, 8), o = gm(16, 18, 19), c = Dd(1);
...
async function CI(e, t, n) {
  const r = In(Kc(e), "hex"), s = he.fromAddressOrString(t), i = Bn(ji), o = cu({
    ...
    r: $c,
    p: zc
  }), c = Bn(BI), d = await Tf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = Au(h), m = vr(y, "hex"), b = {
    id: $m(),
    version: 3,
