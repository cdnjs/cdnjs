...
var Gn = (t, e, n) => (Fi(t, e, "access private method"), n);
function sA() {
  return {
    FORC: "0.49.2",
    FUEL_CORE: "0.22.0",
...
function Zn(t) {
  ...
  switch (typeof t) {
    ...
    case "object": {
      ...
      return e.sort(), "{ " + e.map((n) => `${Zn(n)}: ${Zn(t[n])}`).join(", ") + " }";
    }
  }
...
function Cd(t, e, n) {
  {
    ...
    if (n) {
      if ("message" in n || "code" in n || "name" in n)
        throw new Error(`value will overwrite populated values: ${Zn(n)}`);
      for (const i in n) {
        const o = n[i];
        s.push(i + "=" + Zn(o));
      }
...
function Dn(t, e) {
  switch (typeof t) {
    case "bigint":
      return t;
    case "number":
      return Ct(Number.isInteger(t), "underflow", e || "value", t), Ct(t >= -Yn && t <= Yn, "overflow", e || "value", t), BigInt(t);
    case "string":
      try {
        if (t === "")
...
function AA(t, e) {
  switch (typeof t) {
    case "bigint":
      return Ct(t >= -Yn && t <= Yn, "overflow", e || "value", t), Number(t);
    case "number":
      return Ct(Number.isInteger(t), "underflow", e || "value", t), Ct(t >= -Yn && t <= Yn, "overflow", e || "value", t), t;
    case "string":
      try {
        if (t === "")
          throw new Error("empty string");
...
function qd(t, e, n, r) {
  ...
  const d = Ln(e), l = Ln(n), E = new Uint8Array(o), g = Fo.create(t, d), C = g._cloneInto().update(l);
...
const qn = class {
   ...
   */
  clone() {
    const e = new qn(this.name, this.chainId);
  ...
  static from(e) {
    ...
    if (typeof e == "object") {
      ...
      const n = new qn(e.name, e.chainId);
...
function Po(t) {
  const e = (r) => t().update(Tn(r)).digest(), n = t();
  return e.outputLen = n.outputLen, e.blockLen = n.blockLen, e.create = () => t(), e;
}
function Bl(t) {
  const e = (r, s) => t(s).update(Tn(r)).digest(), n = t({});
  return e.outputLen = n.outputLen, e.blockLen = n.blockLen, e.create = (r) => t(r), e;
}
function yl(t, e, n, r) {
  if (typeof t.setBigUint64 == "function")
...
function vl(t, e, n, r) {
  ...
  if (Ft.number(i), Ft.number(o), Ft.number(c), i < 1)
    throw new Error("PBKDF2: iterations (c) should be >= 1");
  const d = Tn(e), l = Tn(n), E = new Uint8Array(o), g = jA.create(t, d), C = g._cloneInto().update(l);
  return { c: i, dkLen: o, asyncTick: c, DK: E, PRF: g, PRFSalt: C };
}
...
var Ki = (t) => $s.getRandomValues(new Uint8Array(t)), Is = (t, e = "base64") => {
  ...
  const n = $n(String(t).normalize("NFKC"), "utf-8"), r = mr(n, e, 1e5, 32, "sha256");
  return Y(r);
}, ff = async (t, e) => {
  const n = Ki(16), r = Ki(32), s = Uo(t, r), i = JSON.stringify(e), o = $n(i, "utf-8"), c = {
    name: nu,
    counter: n,
    length: 64
  ...
  const n = $n(e.iv), r = $n(e.salt), s = Uo(t, r), i = $n(e.data), o = {
    name: nu,
    counter: n,
    length: 64
...
var Mr = (t) => t % st === 0, mu = (t) => st - t % st, Iu = (t) => {
  ...
  encode(e) {
    if (typeof e == "string" && this.coders[e])
      return Gn(this, Gs, Eu).call(this, e);
  ...
  decode(e, n) {
    ...
    return r += d, [s, r] = c.decode(e, r), Pf(this.coders) ? Gn(this, Hs, Bu).call(this, o, r) : [{ [o]: s }, r];
  }
...
var mn = class {
  ...
  constructor(t, e) {
    ...
    N(this, "jsonAbi");
    this.jsonAbi = t, this.jsonFn = Re(this.jsonAbi.functions, (n) => n.name === e), this.name = e, this.signature = ws.getSignature(this.jsonAbi, this.jsonFn), this.selector = ws.getFunctionSelector(this.signature), this.isInputDataPointer = Gn(this, Js, vu).call(this), this.outputMetadata = {
      isHeapType: Gn(this, Zs, Du).call(this),
      encodedLength: Gn(this, Ys, Nu).call(this)
...
function Lu(t) {
  ...
  function r(o, c) {
    ...
    for (let b = 0; b < C.length; ++b) {
      ...
      x = Wn(x) ^ S, !(b + 6 >= C.length) && F.push(S);
    }
...
function wg(t, e) {
  ...
  for (; s < r; ) {
    ...
    throw ge(
      t.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : Ir(i) || Ks(n, s) ? `Unexpected character: ${On(t, s)}.` : `Invalid character: ${On(t, s)}.`
    );
  }
...
vt.fromValue = Xe;
var Ec = 65536, kp = 1 << 24, cr = Ec * Ec, o0 = cr * cr, Bc = o0 / 2, yc = Un(kp), Ue = Un(0);
vt.ZERO = Ue;
var Rn = Un(0, !0);
vt.UZERO = Rn;
var Vn = Un(1);
...
W.comp = W.compare;
W.negate = function() {
  return !this.unsigned && this.eq(Fe) ? Fe : this.not().add(Vn);
};
W.neg = W.negate;
W.add = function(e) {
  ve(e) || (e = Xe(e));
...
W.divide = function(e) {
  ...
  if (this.unsigned) {
    ...
    if (this.eq(Fe)) {
      ...
      if (e.eq(Fe))
        return Vn;
      var o = this.shr(1);
      return r = o.div(e).shl(1), r.eq(Ue) ? e.isNegative() ? Vn : ho : (s = this.sub(e.mul(r)), i = r.add(s.div(e)), i);
    } else if (e.eq(Fe))
      return this.unsigned ? Rn : Ue;
    if (this.isNegative())
  ...
  for (s = this; s.gte(e); ) {
    ...
    l.isZero() && (l = Vn), i = i.add(l), s = s.sub(E);
  }
  return i;
};
W.div = W.divide;
...
var Op = Vo, d0 = i0.TAI64 = Op.TAI64, Pp = Object.defineProperty, Up = (t, e, n) => e in t ? Pp(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, zn = (t, e, n) => (Up(t, typeof e != "symbol" ? e + "" : e, n), n), Gp = (t, e, n) => {
  if (!e.has(t))
    throw TypeError("Cannot " + n);
}, Hp = (t, e, n) => {
  if (e.has(t))
...
zn(f0, "textDecoder", new TextDecoder());
async function* _m({
  url: t,
  variables: e,
  query: n,
...
}, Kn = (t, e, n) => Q(Math.ceil(t.mul(e).toNumber() / n.toNumber())), g0 = (t) => t.filter(
...
var $m = (t) => {
  ...
  const b = p0({
    ...
    gasLimit: F,
    witnessLimit: S
  }), j = Kn(e, v, o), M = Kn(b, v, o), _ = Kn(O, v, o);
  return {
    fee: M.add(j),
    minFee: M,
    maxFee: _,
...
var kI = (t, e) => {
   ...
   */
  constructor(t, e = {}) {
    this.url = t, Hp(this, mo), zn(this, "operations"), zn(this, "cache"), zn(this, "options", {
      timeout: void 0,
      cacheUtxo: void 0,
      fetch: void 0,
      retryOptions: void 0
  ...
  async estimateTxDependencies(t) {
    ...
    do {
      ...
      if (e = c.length, n = d.length, e === 0 && n === 0)
        return;
      s instanceof kn && (s.addVariableOutputs(e), d.forEach(
  ...
  async getTransactionCost(t, e = [], { estimateTxDependencies: n = !0, estimatePredicates: r = !0 } = {}) {
    ...
    const S = Kn(
      ...
      l,
      o
    ).normalizeZeroToOne(), J = Kn(g, l, o).normalizeZeroToOne(), O = Kn(C, l, o).normalizeZeroToOne();
    return {
...
function Lw(t, e) {
  let n = 0;
  for (let r = 0; r < nn && jn(t, r) === jn(e, r); r += 1)
    n += 1;
  return n;
}
function Tw(t) {
...
var Ow = class {
  ...
  sideNodesForRoot(t, e) {
    ...
    for (let l = 0; l < nn; l += 1) {
      if ([s, i] = Nw(r), jn(t, l) === 1 ? (c = s, o = i) : (c = i, o = s), n.push(c), o === Ne) {
        r = "";
        break;
      }
      ...
      if (e[E] !== "") {
        if (c = e[E], o === "")
          if (d = this.get(c), Ti(d)) {
            ...
            o = Ne, l = !0;
        !l && c === Ne || (l || (l = !0), jn(t, e.length - 1 - E) === 1 ? [i, o] = Hn(c, o) : [i, o] = Hn(o, c), this.set(i, o), o = i);
      }
    return i === "" && (i = Ne), i;
  }
  updateWithSideNodes(t, e, n, r, s) {
    ...
    c !== nn && (jn(t, c) === 1 ? [i, o] = Hn(r, o) : [i, o] = Hn(o, r), this.set(i, o), o = i);
    for (let d = 0; d < nn; d += 1) {
      ...
      if (d - E < 0 || n[d - E] === "")
        ...
        l = n[d - E];
      jn(t, nn - 1 - d) === 1 ? [i, o] = Hn(l, o) : [i, o] = Hn(o, l), this.set(i, o), o = i;
    }
    return i;
  }
  update(t, e) {
...
function SE(t, e, n = !1) {
  ...
  const o = n ? Mn(t) : oa(t), c = be(o, e - Pt) + Pt;
...
function TE(t) {
  ...
  function d(F) {
    ...
    let O;
    try {
      O = typeof F == "bigint" ? F : Mn(Ye("private key", F, v));
    } catch {
...
function PE(t) {
  ...
  const _ = e.bits2int || function(A) {
    const h = Mn(A), m = A.length * 8 - e.nBitLength;
...
}, Zi = Jn, KE = Object.defineProperty, tB = (t, e, n) => e in t ? KE(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, Er = (t, e, n) => (tB(t, typeof e != "symbol" ? e + "" : e, n), n), eB = async () => {
  await na();
