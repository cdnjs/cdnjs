...
var ld = Object.defineProperty, fd = (e, t, n) => t in e ? ld(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, hd = (e, t, n) => (fd(e, typeof t != "symbol" ? t + "" : t, n), n), Vw = (e) => e.length ? e[0].toUpperCase() + e.slice(1) : e, yc = (e, t) => {
  const n = [];
...
var Hw = (e) => {
  ...
  return n;
}, gd = 37, Ic = BigInt(2 ** 62) + BigInt(gd), pd = (e) => Math.floor(e / 1e3), Ec = (e) => e * 1e3, md = (e) => Number(BigInt(e) - Ic), wd = (e) => String(BigInt(e) + Ic), yd = (e) => Ec(md(e)), Hr = class extends Date {
  /**
...
function Vn(e) {
  if (typeof e == "string" && (e = Qd(e)), !vc(e))
...
class kd extends Wi {
  ...
  process(t, n) {
    ...
    for (let I = 0; I < 64; I++) {
      const _ = Ot(u, 6) ^ Ot(u, 11) ^ Ot(u, 25), v = E + _ + Md(u, A, h) + Ld[I] + $t[I] | 0, B = (Ot(r, 2) ^ Ot(r, 13) ^ Ot(r, 22)) + Od(r, s, i) | 0;
...
const Yd = (e, t) => BigInt(e >>> 0) << hi | BigInt(t >>> 0), Vd = (e, t, n) => e >>> n, Hd = (e, t, n) => e << 32 - n | t >>> n, Zd = (e, t, n) => e >>> n | t << 32 - n, Wd = (e, t, n) => e << 32 - n | t >>> n, Jd = (e, t, n) => e << 64 - n | t >>> n - 32, qd = (e, t, n) => e >>> n - 32 | t << 64 - n, jd = (e, t) => t, $d = (e, t) => e, Nc = (e, t, n) => e << n | t >>> 32 - n, Dc = (e, t, n) => t << n | e >>> 32 - n, Tc = (e, t, n) => t << n - 32 | e >>> 64 - n, Fc = (e, t, n) => e << n - 32 | t >>> 64 - n;
function Kd(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
const eA = (e, t, n) => (e >>> 0) + (t >>> 0) + (n >>> 0), tA = (e, t, n, r) => t + n + r + (e / 2 ** 32 | 0) | 0, nA = (e, t, n, r) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0), rA = (e, t, n, r, s) => t + n + r + s + (e / 2 ** 32 | 0) | 0, sA = (e, t, n, r, s) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (s >>> 0), iA = (e, t, n, r, s, i) => t + n + r + s + i + (e / 2 ** 32 | 0) | 0, le = {
  ...
  add5H: iA,
  add5L: sA
}, [Mc, Oc, Lc] = [[], [], []], oA = /* @__PURE__ */ BigInt(0), sr = /* @__PURE__ */ BigInt(1), aA = /* @__PURE__ */ BigInt(2), cA = /* @__PURE__ */ BigInt(7), uA = /* @__PURE__ */ BigInt(256), dA = /* @__PURE__ */ BigInt(113);
...
const [AA, lA] = /* @__PURE__ */ Qc(Lc, !0), Zo = (e, t, n) => n > 32 ? Tc(e, t, n) : Nc(e, t, n), Wo = (e, t, n) => n > 32 ? Fc(e, t, n) : Dc(e, t, n);
function fA(e, t = 24) {
...
const hA = (e, t, n) => Is(() => new qi(t, e, n)), gA = /* @__PURE__ */ hA(1, 136, 256 / 8), pA = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), kc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), mA = /* @__PURE__ */ kc.map((e) => (9 * e + 5) % 16);
let ji = [kc], $i = [mA];
for (let e = 0; e < 4; e++)
  for (let t of [ji, $i])
...
].map((e) => new Uint8Array(e)), wA = /* @__PURE__ */ ji.map((e, t) => e.map((n) => Pc[t][n])), yA = /* @__PURE__ */ $i.map((e, t) => e.map((n) => Pc[t][n])), IA = /* @__PURE__ */ new Uint32Array([
  0,
  1518500249,
  1859775393,
  2400959708,
...
class vA extends Wi {
  ...
  process(t, n) {
    ...
    for (let L = 0; L < 80; L++) {
      const W = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & v ^ ~I & B, k = _ & R ^ ~_ & F, U = le.add5L(G, O, k, _A[L], en[L]), q = le.add5H(U, M, W, T, BA[L], Kt[L]), V = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), b = r & i ^ r & u ^ i & u, a = s & o ^ s & A ^ o & A;
...
}, HA = "u8", ZA = "u16", WA = "u32", JA = "u64", qA = "u256", jA = "raw untyped ptr", $A = "raw untyped slice", KA = "bool", el = "b256", tl = "struct B512", gr = "enum Option", nl = "struct Vec", rl = "struct Bytes", sl = "struct String", il = "str", qc = /str\[(?<length>[0-9]+)\]/, pi = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, jc = /^struct (?<name>\w+)$/, $c = /^enum (?<name>\w+)$/, ol = /^\((?<items>.*)\)$/, al = /^generic (?<name>\w+)$/, os = "1", ge = 8, fn = 32, as = fn + 2, cs = fn, cl = fn, ul = fn, dl = ge * 4, Al = ge * 2, Kc = 2 ** 32 - 1, e0 = ({ maxInputs: e }) => fn + // Tx ID
cs + // Base asset ID
...
var gl = (e) => Object.values(e).every(
  ...
  decode(t, n) {
    ...
    return gl(this.coders) ? Ks(this, ws, i0).call(this, i, h) : [{ [i]: A }, h];
  }
...
var hr = class {
  ...
  constructor(e, t) {
    ...
    S(this, "attributes");
    S(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = Il(this.jsonAbi, t), this.name = t, this.signature = qr.getSignature(this.jsonAbi, this.jsonFn), this.selector = qr.getFunctionSelector(this.signature), this.selectorBytes = new to().encode(t), this.encoding = u0(e.encoding), this.attributes = this.jsonFn.attributes ?? [];
  }
...
var ur = (e) => e instanceof d0 ? e.address : e instanceof Bl ? e.id : e, Ql = () => z(Tt(32)), Nl = (e) => {
  let t;
  try {
    if (!mi(e))
      throw new x(
...
}, un = new WeakMap(), fc), Zn = class extends Cs {
  constructor() {
    super("TxPointer", {
...
const m0 = BigInt(0), Bs = BigInt(1), Ul = BigInt(2);
function Gt(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
...
const Hl = (e, t, n) => e | (n ? Bs : m0) << BigInt(t), co = (e) => (Ul << BigInt(e - 1)) - Bs, ni = (e) => new Uint8Array(e), _a = (e) => Uint8Array.from(e);
function I0(e, t, n) {
...
function bf(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > R0 ? "[" + Bf(e) + "]" : "{ " + n.map(
    ([s, i]) => s + ": " + vs(i, t)
  ).join(", ") + " }";
}
function Cf(e, t) {
...
var M0 = xs, Wf = Zf(Hf), Jf = Sr, qf = function(e) {
  return M0.isExtractableFile(e) || e !== null && typeof e == "object" && typeof e.pipe == "function";
};
function jf(e, t, n, r) {
  r === void 0 && (r = Jf.defaultJsonSerializer);
  var s = M0.extractFiles({ query: e, variables: t, operationName: n }, "", qf), i = s.clone, o = s.files;
  if (o.size === 0) {
    if (!Array.isArray(e))
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const W0 = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Ga = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), $h = BigInt(1), Ri = BigInt(2), Xa = (e, t) => (e + t / Ri) / t;
function Kh(e) {
...
const Si = Uh(W0, void 0, void 0, { sqrt: Kh }), tn = jh({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
...
function K0(e, t, n) {
  ...
  if (r === void 0)
    return [];
  var s = r[t];
  return s === void 0 ? [] : typeof s == "function" ? n ? [s.listener || s] : [s] : n ? cg(s) : tu(s, s.length);
}
...
function ug(e, t) {
  return new Promise(function(n, r) {
    ...
    nu(e, t, i, { once: !0 }), t !== "error" && dg(e, s, { once: !0 });
  });
}
function dg(e, t, n) {
...
var ru = ho.exports, Ag = "0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", lg = class {
...
}, nr = (e) => e.type === Ce.Coin, Eo = (e) => e.type === Ce.Message, ln = (e) => nr(e) || Eo(e), gu = (e) => nr(e) ? e.owner : e.recipient, Ti = (e, t) => gu(e) === t.toB256(), Zp = (e, t, n) => e.filter(ln).reduce((r, s) => nr(s) && s.assetId === t || Eo(s) && t === n ? r.add(s.amount) : r, C(0)), py = (e) => e.filter(ln).reduce(
...
function pu(e, t) {
  ...
  const r = XA(t), s = ie([r, new wn().encode(n)]);
  return mt(s);
}
var qp = (e) => {
...
function Qs(e) {
  ...
  const {
    ...
    maxInputs: h,
    baseAssetId: v
  }), M = yu(i.type), G = C((l = (c = i.policies) == null ? void 0 : c.find((p) => p.type === Qt.Tip)) == null ? void 0 : l.data), { isStatusFailure: L, isStatusPending: W, isStatusSuccess: O, blockId: T, status: k, time: U, totalFee: q } = Nm(u), V = Kp({
    totalFee: q,
    gasPrice: _,
    rawPayload: B,
    tip: G,
...
var Xm = "https://cdn.fuel.network/assets/", zm = [
  ...
  const t = Ym(e);
  await fo();
  const n = Bh(16, 0, vh.ScriptData), r = Fa(17, 16, 32), s = _i(18, 17, 0), i = Fa(19, 17, 8), o = Ch(16, 18, 19), u = X0(1);
...
async function Wm(e, t, n) {
  const r = dn(ec(e), "hex"), s = de.fromAddressOrString(t), i = Tt(ci), o = Zc({
    password: dn(n),
    salt: i,
    dklen: ci,
    n: 2 ** ja,
    r: $a,
    p: Ka
  }), u = Tt(Zm), A = await PA(r, o, u), h = Uint8Array.from([...o.subarray(16, 32), ...A]), E = Wc(h), I = cr(E, "hex"), _ = {
    id: sg(),
    version: 3,
...
}, vo = nn, xu = 2147483648, Ru = z("0x0488ade4"), xo = z("0x0488b21e"), Su = z("0x04358394"), Ro = z("0x043587cf");
function rc(e) {
...
var yt, bn, kt, Oi, Tu, Li, Fu, Mu = class extends ru.EventEmitter {
  constructor(e) {
    super(), an(this, Oi), an(this, Li), De(this, "storage", new uw()), De(this, "STORAGE_KEY", "WalletManager"), an(this, yt, []), an(this, bn, ""), an(this, kt, !0), this.storage = (e == null ? void 0 : e.storage) || this.storage;
  }
  get isLocked() {
    return Re(this, kt);
  }
