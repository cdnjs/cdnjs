...
function Bd(e) {
  ...
  for (let n = 0; n < e.length; n++)
    t = t.mul(li), t = t.add(Cd(e[n].toString()));
  return t;
}
function Yi(e, t, n) {
  const r = z(e);
...
const Wr = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Mt = (e, t) => e << 32 - t | e >>> t, Rd = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!Rd)
...
class Ld extends Wi {
  ...
  process(t, n) {
    ...
    for (let I = 0; I < 64; I++) {
      const _ = Mt(u, 6) ^ Mt(u, 11) ^ Mt(u, 25), v = E + _ + Fd(u, A, h) + Od[I] + $t[I] | 0, C = (Mt(r, 2) ^ Mt(r, 13) ^ Mt(r, 22)) + Md(r, s, i) | 0;
...
const zd = (e, t) => BigInt(e >>> 0) << fi | BigInt(t >>> 0), Yd = (e, t, n) => e >>> n, Vd = (e, t, n) => e << 32 - n | t >>> n, Hd = (e, t, n) => e >>> n | t << 32 - n, Zd = (e, t, n) => e << 32 - n | t >>> n, Wd = (e, t, n) => e << 64 - n | t >>> n - 32, Jd = (e, t, n) => e >>> n - 32 | t << 64 - n, qd = (e, t) => t, jd = (e, t) => e, Qc = (e, t, n) => e << n | t >>> 32 - n, Nc = (e, t, n) => t << n | e >>> 32 - n, Dc = (e, t, n) => t << n - 32 | e >>> 64 - n, Tc = (e, t, n) => e << n - 32 | t >>> 64 - n;
function $d(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
const fA = (e, t, n) => ys(() => new qi(t, e, n)), hA = /* @__PURE__ */ fA(1, 136, 256 / 8), gA = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), Lc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), pA = /* @__PURE__ */ Lc.map((e) => (9 * e + 5) % 16);
let ji = [Lc], $i = [pA];
for (let e = 0; e < 4; e++)
  for (let t of [ji, $i])
...
class EA extends Wi {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const R = 4 - v, C = yA[v], F = IA[v], M = ji[v], G = $i[v], L = mA[v], W = wA[v];
      for (let O = 0; O < 16; O++) {
...
const bA = /* @__PURE__ */ ys(() => new EA()), [CA, BA] = le.split([
  "0x428a2f98d728ae22",
  "0x7137449123ef65cd",
  "0xb5c0fbcfec4d3b2f",
  "0xe9b5dba58189dbbc",
...
class _A extends Wi {
  ...
  process(t, n) {
    ...
    for (let L = 0; L < 80; L++) {
      const W = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & v ^ ~I & C, k = _ & R ^ ~_ & F, U = le.add5L(G, O, k, BA[L], en[L]), q = le.add5H(U, M, W, T, CA[L], Kt[L]), Y = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), b = r & i ^ r & u ^ i & u, a = s & o ^ s & A ^ o & A;
...
}, VA = "u8", HA = "u16", ZA = "u32", WA = "u64", JA = "u256", qA = "raw untyped ptr", jA = "raw untyped slice", $A = "bool", KA = "b256", el = "struct B512", gr = "enum Option", tl = "struct Vec", nl = "struct Bytes", rl = "struct String", sl = "str", Jc = /str\[(?<length>[0-9]+)\]/, gi = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, qc = /^struct (?<name>\w+)$/, jc = /^enum (?<name>\w+)$/, il = /^\((?<items>.*)\)$/, ol = /^generic (?<name>\w+)$/, os = "1", ge = 8, fn = 32, pi = fn + 2, as = fn, al = fn, cl = fn, ul = ge * 4, dl = ge * 2, $c = 2 ** 32 - 1, Kc = ({ maxInputs: e }) => fn + // Tx ID
as + // Base asset ID
...
var hl = (e) => Object.values(e).every(
  ...
  decode(t, n) {
    ...
    return hl(this.coders) ? $s(this, ms, s0).call(this, i, h) : [{ [i]: A }, h];
  }
...
var Tn = (e, t) => {
  ...
  if (e.type === tl) {
    const v = Il(r), R = new on(e.abi, v), C = Tn(R);
    return new wl(C);
  }
...
var ur = (e) => e instanceof u0 ? e.address : e instanceof Cl ? e.id : e, Sl = () => V(Ut(32)), Ql = (e) => {
  let t;
  try {
    if (!mi(e))
      throw new x(
...
const p0 = BigInt(0), Cs = BigInt(1), Pl = BigInt(2);
function Gt(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
...
const Vl = (e, t, n) => e | (n ? Cs : p0) << BigInt(t), co = (e) => (Pl << BigInt(e - 1)) - Cs, ti = (e) => new Uint8Array(e), _a = (e) => Uint8Array.from(e);
function y0(e, t, n) {
...
var F0 = vs, Zf = Hf(Vf), Wf = Sr, Jf = function(e) {
...
function M0() {
  return Da || (Da = 1, function(e) {
    ...
    var h = s(Wl), E = h, I = Qf, _ = Gf, v = A(lo), R = Sr, C = bt, F = Qr;
...
BigInt(4);
function Hh(e) {
  const t = zh(e), { Fp: n } = t, r = t.toBytes || ((R, C, F) => {
    const M = C.toAffine();
...
function Au(e) {
  const { gasCosts: t, gasPerByte: n, inputs: r, metadataGas: s, txBytesSize: i } = e, o = An(i, t.vmInitialization), u = B(i).mul(n), A = Gp(r, i, t);
...
Supported fuel-core version: ${r}.`
   ...
   */
  createOperations() {
    const e = Ot.getFetchFn(this.options), t = new oh.GraphQLClient(this.url, {
...
var Gm = "https://cdn.fuel.network/assets/", Xm = [
  ...
  async fund(t, n) {
    var M;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, u = t.maxFee, A = this.provider.getBaseAssetId(), h = ((M = i.find((G) => G.assetId === A)) == null ? void 0 : M.amount) || B(0), E = xg({
      amount: B(u),
      assetId: A,
      coinQuantities: i
    }), I = {};
...
async function Zm(e, t, n) {
  const r = dn(ec(e), "hex"), s = de.fromAddressOrString(t), i = Ut(ai), o = Hc({
    ...
    r: $a,
    p: Ka
  }), u = Ut(Hm), A = await kA(r, o, u), h = Uint8Array.from([...o.subarray(16, 32), ...A]), E = Zc(h), I = cr(E, "hex"), _ = {
    id: rg(),
    version: 3,
...
var Fn = class {
  ...
  static fromExtendedKey(e) {
    const t = V(Wt(Bd(e))), n = z(t), r = rc(n.slice(0, 78)) === e;
    if (n.length !== 82 || !ow(n))
...
var Cw = (e) => e === ue.Return || e === ue.ReturnData, Bw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const E = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], F = h, M = F + ge, G = M + as, L = G + al + ge + ge, W = L + C.fnSelectorBytes.byteLength, O = z(C.data);
      let T = 0;
