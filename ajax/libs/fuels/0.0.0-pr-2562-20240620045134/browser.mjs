...
class Gd extends Ji {
  ...
  process(t, n) {
    ...
    for (let I = 16; I < 64; I++) {
      const _ = Kt[I - 15], x = Kt[I - 2], R = Ot(_, 7) ^ Ot(_, 18) ^ _ >>> 3, B = Ot(x, 17) ^ Ot(x, 19) ^ x >>> 10;
      Kt[I] = B + Kt[I - 7] + R + Kt[I - 16] | 0;
    }
    let { A: r, B: s, C: i, D: o, E: u, F: A, G: h, H: E } = this;
    for (let I = 0; I < 64; I++) {
      const _ = Ot(u, 6) ^ Ot(u, 11) ^ Ot(u, 25), x = E + _ + kd(u, A, h) + Ud[I] + Kt[I] | 0, B = (Ot(r, 2) ^ Ot(r, 13) ^ Ot(r, 22)) + Pd(r, s, i) | 0;
      E = h, h = A, A = u, u = o + x | 0, o = i, i = s, s = r, r = x + B | 0;
    }
...
function qi(e, t, n, r) {
  ...
  for (let x = 1, R = 0; R < i; x++, R += u.outputLen) {
    const B = o.subarray(R, R + u.outputLen);
    I.setInt32(0, x, !1), (h = A._cloneInto(h)).update(E).digestInto(_), B.set(_.subarray(0, B.length));
    for (let F = 1; F < s; F++) {
...
function Wo(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], u = e[t++] ^ n[r++], A = e[t++] ^ n[r++], h = e[t++] ^ n[r++], E = e[t++] ^ n[r++], I = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], x = e[t++] ^ n[r++], R = e[t++] ^ n[r++], B = e[t++] ^ n[r++], F = e[t++] ^ n[r++], M = e[t++] ^ n[r++], G = e[t++] ^ n[r++], L = e[t++] ^ n[r++], Z = e[t++] ^ n[r++], O = e[t++] ^ n[r++], T = o, k = u, U = A, q = h, X = E, H = I, ee = _, b = x, a = R, c = B, l = F, p = M, f = G, w = L, y = Z, g = O;
  for (let d = 0; d < 8; d += 2)
  ...
  s[i++] = o + T | 0, s[i++] = u + k | 0, s[i++] = A + U | 0, s[i++] = h + q | 0, s[i++] = E + X | 0, s[i++] = I + H | 0, s[i++] = _ + ee | 0, s[i++] = x + b | 0, s[i++] = R + a | 0, s[i++] = B + c | 0, s[i++] = F + l | 0, s[i++] = M + p | 0, s[i++] = G + f | 0, s[i++] = L + w | 0, s[i++] = Z + y | 0, s[i++] = O + g | 0;
}
...
class _A extends Ji {
  ...
  process(t, n) {
    ...
    for (let x = 0; x < 5; x++) {
      const R = 4 - x, B = CA[x], F = BA[x], M = $i[x], G = Ki[x], L = EA[x], Z = bA[x];
      for (let O = 0; O < 16; O++) {
        const T = Pr(r + qo(x, i, u, h) + Ur[M[O]] + B, L[O]) + I | 0;
...
class SA extends Ji {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: u, Dl: A, Eh: h, El: E, Fh: I, Fl: _, Gh: x, Gl: R, Hh: B, Hl: F } = this;
    return [t, n, r, s, i, o, u, A, h, E, I, _, x, R, B, F];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, u, A, h, E, I, _, x, R, B, F) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = u | 0, this.Dl = A | 0, this.Eh = h | 0, this.El = E | 0, this.Fh = I | 0, this.Fl = _ | 0, this.Gh = x | 0, this.Gl = R | 0, this.Hh = B | 0, this.Hl = F | 0;
  }
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: u, Cl: A, Dh: h, Dl: E, Eh: I, El: _, Fh: x, Fl: R, Gh: B, Gl: F, Hh: M, Hl: G } = this;
    for (let L = 0; L < 80; L++) {
      const Z = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & x ^ ~I & B, k = _ & R ^ ~_ & F, U = le.add5L(G, O, k, RA[L], tn[L]), q = le.add5H(U, M, Z, T, xA[L], en[L]), X = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), b = r & i ^ r & u ^ i & u, a = s & o ^ s & A ^ o & A;
      M = B | 0, G = F | 0, B = x | 0, F = R | 0, x = I | 0, R = _ | 0, { h: I, l: _ } = le.add(h | 0, E | 0, q | 0, X | 0), h = u | 0, E = A | 0, u = i | 0, A = o | 0, i = r | 0, o = s | 0;
      const c = le.add3L(X, ee, a);
      r = le.add3H(c, q, H, b), s = c | 0;
    }
    ({ h: r, l: s } = le.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = le.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: u, l: A } = le.add(this.Ch | 0, this.Cl | 0, u | 0, A | 0), { h, l: E } = le.add(this.Dh | 0, this.Dl | 0, h | 0, E | 0), { h: I, l: _ } = le.add(this.Eh | 0, this.El | 0, I | 0, _ | 0), { h: x, l: R } = le.add(this.Fh | 0, this.Fl | 0, x | 0, R | 0), { h: B, l: F } = le.add(this.Gh | 0, this.Gl | 0, B | 0, F | 0), { h: M, l: G } = le.add(this.Hh | 0, this.Hl | 0, M | 0, G | 0), this.set(r, s, i, o, u, A, h, E, I, _, x, R, B, F, M, G);
  }
  roundClean() {
    en.fill(0), tn.fill(0);
  }
...
var Tn = (e, t) => {
  ...
  if (e.type === il) {
    const x = Cl(r), R = new an(e.abi, x), B = Tn(R);
    return new El(B);
  }
  const i = (E = $c.exec(e.type)) == null ? void 0 : E.groups;
  if (i) {
    const x = Ko(r, { getCoder: Tn });
    return new _s(i.name, x);
  }
  const o = (I = Kc.exec(e.type)) == null ? void 0 : I.groups;
  if (o) {
    const x = Ko(r, { getCoder: Tn });
    return e.type === Hn ? new c0(o.name, x) : new s0(o.name, x);
  }
  if ((_ = ul.exec(e.type)) == null ? void 0 : _.groups) {
    const x = r.map((R) => Tn(R));
    return new d0(x);
  }
  throw new v(
    Q.CODER_NOT_FOUND,
...
function g0(e) {
  ...
  function r(o, u) {
    ...
    for (let B = 0; B < _.length; ++B) {
      ...
      x = Pn(x) ^ M, !(B + 6 >= _.length) && R.push(M);
    }
...
function uf(e, t) {
  const n = e.replace(/"""/g, '\\"""'), r = n.split(/\r\n|[\n\r]/g), s = r.length === 1, i = r.length > 1 && r.slice(1).every((x) => x.length === 0 || Bi(x.charCodeAt(0))), o = n.endsWith('\\"""'), u = e.endsWith('"') && !o, A = e.endsWith("\\"), h = u || A, E = !(t != null && t.minimize) && // add leading and trailing new lines only if it improves readability
  (!s || e.length > 70 || h || i || o);
  let I = "";
...
function Pf(e, t, n = _0) {
  ...
  do {
    ...
    if (M) {
      if (E = x.length === 0 ? void 0 : _[_.length - 1], h = I, I = x.pop(), G)
        if (i) {
          h = h.slice();
          let Z = 0;
          for (const [O, T] of A) {
    ...
    if (!Array.isArray(h)) {
      ...
      if (L = Z == null ? void 0 : Z.call(t, h, E, I, _, x), L === kf)
        break;
      if (L === !1) {
        if (!M) {
          _.pop();
    ...
    if (L === void 0 && G && A.push([E, h]), M)
      ...
      s = {
        ...
        edits: A,
        prev: s
      }, i = Array.isArray(h), o = i ? h : (F = n[h.kind]) !== null && F !== void 0 ? F : [], u = -1, A = [], I && x.push(I), I = h;
    }
  } while (s !== void 0);
...
function Kf(e, t, n, r) {
  ...
  return o.forEach(function(_) {
    E[++I] = _;
  }), h.append("map", r.stringify(E)), I = 0, o.forEach(function(_, x) {
    h.append("" + ++I, x);
  }), h;
}
fo.default = Kf;
...
function ch() {
  ...
  var r = Qr, s = k0(), i = "connection_init", o = "connection_ack", u = "ping", A = "pong", h = "subscribe", E = "next", I = "error", _ = "complete", x = (
    /** @class */
    function() {
      function O(T, k, U) {
...
function k0() {
  return Ta || (Ta = 1, function(e) {
    ...
    var h = s(jl), E = h, I = Tf, _ = Yf, x = A(fo), R = Sr, B = bt, F = Qr;
    ...
    var M = function(f) {
      ...
      return i(void 0, void 0, void 0, function() {
        ...
        return o(this, function(se) {
          switch (se.label) {
            case 0:
              return j = x.default(y, g, d, J.jsonSerializer), re = t({ method: "POST", headers: t(t({}, typeof j == "string" ? { "Content-Type": "application/json" } : {}), m), body: j }, J), K ? [4, Promise.resolve(K(re))] : [3, 2];
            case 1:
...
let lr = null;
function V0() {
  return (lr === null || lr.byteLength === 0) && (lr = new Uint8Array(N.memory.buffer)), lr;
}
function Bh(e, t) {
...
let fr = null;
function Oa() {
  return (fr === null || fr.byteLength === 0) && (fr = new Int32Array(N.memory.buffer)), fr;
}
function xh(e, t) {
...
function Nh(e, t) {
  return N = e.exports, X0.__wbindgen_wasm_module = t, fr = null, lr = null, N;
}
async function X0(e) {
  if (N !== void 0)
    return N;
...
function Dh(e, t, n, r) {
  function s(I, _, x) {
    var R = x ? WebAssembly.instantiateStreaming : WebAssembly.instantiate, B = x ? WebAssembly.compileStreaming : WebAssembly.compile;
    return _ ? R(I, _) : B(I);
  }
  ...
  return function(u, A) {
    ...
    for (; !u.eql(_, u.ONE); ) {
      if (u.eql(_, u.ZERO))
        return u.ZERO;
      let x = 1;
      for (let B = u.sqr(_); x < h && !u.eql(B, u.ONE); x++)
        B = u.sqr(B);
      const R = u.pow(E, ke << BigInt(h - x - 1));
      E = u.sqr(R), I = u.mul(I, R), _ = u.mul(_, E), h = x;
    }
    return I;
  };
}
...
function Jh(e) {
  ...
  class I {
    ...
    wNAF(B) {
      return x.wNAFCached(this, h, B, (F) => {
    ...
    multiply(B) {
      ...
      if (L) {
        ...
        U = x.constTimeNegate(Z, U), X = x.constTimeNegate(T, X), X = new I(n.mul(X.px, L.beta), X.py, X.pz), M = U.add(X), G = q.add(H);
      } else {
  ...
  const _ = t.nBitLength, x = Xh(I, t.endo ? Math.ceil(_ / 2) : _);
  return {
    CURVE: t,
    ProjectivePoint: I,
...
function jh(e) {
  ...
  class M {
    ...
    recoverPublicKey(l) {
      ...
      const d = w & 1 ? "03" : "02", m = h.fromHex(d + x(g)), W = A(g), J = u(-y * W), K = u(f * W), j = h.BASE.multiplyAndAddUnsafe(m, J, K);
      if (!j)
...
function tg(e) {
  const t = q0, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), u = BigInt(44), A = BigInt(88), h = e * e * e % t, E = h * h * e % t, I = xt(E, n, t) * E % t, _ = xt(I, n, t) * E % t, x = xt(_, Si, t) * h % t, R = xt(x, s, t) * x % t, B = xt(R, i, t) * R % t, F = xt(B, u, t) * B % t, M = xt(F, A, t) * F % t, G = xt(M, u, t) * B % t, L = xt(G, n, t) * E % t, Z = xt(L, o, t) * R % t, O = xt(Z, r, t) * h % t, T = xt(O, Si, t);
...
var Gp = "https://fuellabs.github.io/block-explorer-v2", zp = (e, t) => `${{
  ...
  const I = E ? zp(
    h[0].key,
    h[0].value
  ) : "", _ = /^\/|\/$/gm, x = n ? n.replace(_, "") : I, R = u.replace(_, ""), B = r == null ? void 0 : r.replace(_, ""), F = B ? encodeURIComponent(B) : void 0, M = R.match(/^https?:\/\//) ? "" : "https://", G = B != null && B.match(/^https?:\/\//) ? "" : "https://";
...
var jp = (e) => {
  ...
  if (s)
    return s;
  const A = C(o.gasPerByte), h = C(o.gasPriceFactor), E = Y(n), [I] = new Jt().decode(E, 0), { type: _, witnesses: x, inputs: R, policies: B } = I;
  let F = C(0), M = C(0);
  if (_ !== Le.Create && _ !== Le.Script)
    return C(0);
  if (_ === Le.Create) {
    const { bytecodeWitnessIndex: U, storageSlots: q } = I, X = C(Y(x[U].data).length);
    F = pu({
      contractBytesSize: X,
      gasCosts: i,
  ...
  const G = gu({
    ...
    metadataGas: F,
    txBytesSize: E.length
  }), L = (k = B.find((U) => U.type === Qt.WitnessLimit)) == null ? void 0 : k.data, Z = x.reduce((U, q) => U + q.dataLength, 0), O = Io({
    gasPerByte: A,
    minGas: G,
    witnessesLength: Z,
    gasLimit: M,
  ...
  return A && (u = i.reduce((I, _, x) => {
    const R = A[x], B = _.name;
    return B ? {
      ...I,
...
function qa({
  ...
  s.forEach((h) => {
    const { amount: E, assetId: I, to: _ } = h, x = o.find((R) => R.assetId === I);
    x && (r = Kn(r, {
      name: "Transfer asset",
      from: {
        type: 1,
...
`)
  ...
  async estimateMultipleTxDependencies(e) {
    ...
    for (; s.length > 0 && i < ja; ) {
      ...
      for (let h = 0; h < u.dryRun.length; h++) {
        const E = s[h], { receipts: I, status: _ } = u.dryRun[h], x = t[E];
        x.receipts = I.map(un), x.dryRunStatus = _;
        ...
        if (F && (M == null ? void 0 : M.type) === Le.Script) {
          x.outputVariables += R.length, M.addVariableOutputs(R.length), B.forEach(({ contractId: L }) => {
            M.addContractInputAndOutput(de.fromString(L)), x.missingContractIds.push(L);
          });
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    ...
    let { maxFee: _, maxGas: x, minFee: R, minGas: B, gasPrice: F, gasLimit: M } = await this.estimateTxGasAndFee({
      transactionRequest: E
    }), G = [], L, Z = [], O = 0, T = C(0);
    if (s.maxFee = _, i) {
      ...
      T = hu(G), s.gasLimit = T, { maxFee: _, maxGas: x, minFee: R, minGas: B, gasPrice: F } = await this.estimateTxGasAndFee({
  ...
  async getResourcesToSpend(e, t, n) {
    ...
    const i = {
      owner: r.toB256(),
      queryPerAsset: t.map(mo).map(({ assetId: I, amount: _, max: x }) => ({
        assetId: V(I),
...
async function Ey(e) {
  ...
  } = n.getChain(), x = await n.getLatestGasPrice(), R = n.getBaseAssetId(), B = Ds({
    id: s.id,
    receipts: u,
    transaction: i,
...
async function by(e) {
  const { provider: t, transactionRequest: n, abiMap: r } = e, { receipts: s } = await t.dryRun(n), { gasPerByte: i, gasPriceFactor: o, gasCosts: u, maxGasPerTx: A } = t.getGasConfig(), h = t.getChain().consensusParameters.txParameters.maxInputs, E = n.toTransaction(), I = n.toTransactionBytes(), _ = await t.getLatestGasPrice(), x = t.getBaseAssetId();
  return Ds({
    receipts: s,
    transaction: E,
    transactionBytes: I,
...
async function qm(e, t) {
  ...
  } = n, I = An(s, "hex"), _ = An(i, "hex"), x = An(E, "hex"), R = An(t), B = Zc({
    password: R,
    salt: x,
    n: u,
    p: h,
...
var _w = (e) => e === ue.Return || e === ue.ReturnData, vw = (e, t) => e.find(
  ...
  (n) => {
    ...
    for (let R = 0; R < r; R += 1) {
      ...
      let T = 0;
      E.push(new D("u64").encode(B.amount || 0)), E.push(new z().encode(((x = B.assetId) == null ? void 0 : x.toString()) || Ne)), E.push(B.contractId.toBytes()), E.push(new D("u64").encode(L)), E.push(new D("u64").encode(Z)), E.push(B.fnSelectorBytes), E.push(O), B.gas && (E.push(new D("u64").encode(B.gas)), T = Z + O.byteLength);
      const k = {
        amountOffset: F,
        assetIdOffset: M,
        gasForwardedOffset: T,
