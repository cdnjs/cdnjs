...
(function(e) {
  (function(t, n) {
    ...
    var V = function(a, A, l) {
      ...
      I = (m + (u >>> 13) | 0) + (Ii >>> 26) | 0, Ii &= 67108863, g = Math.imul(te, Ve), u = Math.imul(te, Xe), u = u + Math.imul(ne, Ve) | 0, m = Math.imul(ne, Xe), g = g + Math.imul(X, je) | 0, u = u + Math.imul(X, We) | 0, u = u + Math.imul($, je) | 0, m = m + Math.imul($, We) | 0;
      var yi = (I + g | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (yi >>> 26) | 0, yi &= 67108863, g = Math.imul(fe, Ve), u = Math.imul(fe, Xe), u = u + Math.imul(oe, Ve) | 0, m = Math.imul(oe, Xe), g = g + Math.imul(te, je) | 0, u = u + Math.imul(te, We) | 0, u = u + Math.imul(ne, je) | 0, m = m + Math.imul(ne, We) | 0, g = g + Math.imul(X, qe) | 0, u = u + Math.imul(X, $e) | 0, u = u + Math.imul($, qe) | 0, m = m + Math.imul($, $e) | 0;
      ...
      var bi = (I + g | 0) + ((u & 8191) << 13) | 0;
      I = (m + (u >>> 13) | 0) + (bi >>> 26) | 0, bi &= 67108863, g = Math.imul(Se, Ve), u = Math.imul(Se, Xe), u = u + Math.imul(Oe, Ve) | 0, m = Math.imul(Oe, Xe), g = g + Math.imul(_e, je) | 0, u = u + Math.imul(_e, We) | 0, u = u + Math.imul(ye, je) | 0, m = m + Math.imul(ye, We) | 0, g = g + Math.imul(le, qe) | 0, u = u + Math.imul(le, $e) | 0, u = u + Math.imul(ge, qe) | 0, m = m + Math.imul(ge, $e) | 0, g = g + Math.imul(fe, ze) | 0, u = u + Math.imul(fe, Ke) | 0, u = u + Math.imul(oe, ze) | 0, m = m + Math.imul(oe, Ke) | 0, g = g + Math.imul(te, et) | 0, u = u + Math.imul(te, tt) | 0, u = u + Math.imul(ne, et) | 0, m = m + Math.imul(ne, tt) | 0, g = g + Math.imul(X, nt) | 0, u = u + Math.imul(X, rt) | 0, u = u + Math.imul($, nt) | 0, m = m + Math.imul($, rt) | 0;
      ...
      I = (m + (u >>> 13) | 0) + (xi >>> 26) | 0, xi &= 67108863, g = Math.imul(Ue, Ve), u = Math.imul(Ue, Xe), u = u + Math.imul(Ge, Ve) | 0, m = Math.imul(Ge, Xe), g = g + Math.imul(Fe, je) | 0, u = u + Math.imul(Fe, We) | 0, u = u + Math.imul(Pe, je) | 0, m = m + Math.imul(Pe, We) | 0, g = g + Math.imul(Se, qe) | 0, u = u + Math.imul(Se, $e) | 0, u = u + Math.imul(Oe, qe) | 0, m = m + Math.imul(Oe, $e) | 0, g = g + Math.imul(_e, ze) | 0, u = u + Math.imul(_e, Ke) | 0, u = u + Math.imul(ye, ze) | 0, m = m + Math.imul(ye, Ke) | 0, g = g + Math.imul(le, et) | 0, u = u + Math.imul(le, tt) | 0, u = u + Math.imul(ge, et) | 0, m = m + Math.imul(ge, tt) | 0, g = g + Math.imul(fe, nt) | 0, u = u + Math.imul(fe, rt) | 0, u = u + Math.imul(oe, nt) | 0, m = m + Math.imul(oe, rt) | 0, g = g + Math.imul(te, st) | 0, u = u + Math.imul(te, it) | 0, u = u + Math.imul(ne, st) | 0, m = m + Math.imul(ne, it) | 0, g = g + Math.imul(X, ot) | 0, u = u + Math.imul(X, at) | 0, u = u + Math.imul($, ot) | 0, m = m + Math.imul($, at) | 0;
    ...
    J.prototype._verify1 = function(a) {
      ...
      for (u === 0 && (u = 26), f = A.length - 1; f >= 0; f--) {
        for (var m = A.words[f], Y = u - 1; Y >= 0; Y--) {
          var X = m >> Y & 1;
          if (w !== p[0] && (w = this.sqr(w)), X === 0 && I === 0) {
            g = 0;
            continue;
          }
          I <<= 1, I |= X, g++, !(g !== l && (f !== 0 || Y !== 0)) && (w = this.mul(w, p[I]), g = 0, I = 0);
        }
        u = 26;
      }
      return w;
...
class Po extends Fo {
  ...
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: h, Dl: y, Eh: E, El: b, Fh: v, Fl: _, Gh: C, Gl: k, Hh: N, Hl: V } = this;
    for (let P = 0; P < 80; P++) {
      const j = ue.rotrSH(E, b, 14) ^ ue.rotrSH(E, b, 18) ^ ue.rotrBH(E, b, 41), O = ue.rotrSL(E, b, 14) ^ ue.rotrSL(E, b, 18) ^ ue.rotrBL(E, b, 41), M = E & v ^ ~E & C, T = b & _ ^ ~b & k, F = ue.add5L(V, O, T, Ih[P], dn[P]), W = ue.add5H(F, N, j, M, Eh[P], un[P]), G = F | 0, J = ue.rotrSH(r, s, 28) ^ ue.rotrBH(r, s, 34) ^ ue.rotrBH(r, s, 39), K = ue.rotrSL(r, s, 28) ^ ue.rotrBL(r, s, 34) ^ ue.rotrBL(r, s, 39), B = r & i ^ r & c ^ i & c, a = s & o ^ s & d ^ o & d;
      N = C | 0, V = k | 0, C = v | 0, k = _ | 0, v = E | 0, _ = b | 0, { h: E, l: b } = ue.add(h | 0, y | 0, W | 0, G | 0), h = c | 0, y = d | 0, c = i | 0, d = o | 0, i = r | 0, o = s | 0;
      const A = ue.add3L(G, K, a);
      r = ue.add3H(A, W, J, B), s = A | 0;
    }
    ({ h: r, l: s } = ue.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = ue.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: c, l: d } = ue.add(this.Ch | 0, this.Cl | 0, c | 0, d | 0), { h, l: y } = ue.add(this.Dh | 0, this.Dl | 0, h | 0, y | 0), { h: E, l: b } = ue.add(this.Eh | 0, this.El | 0, E | 0, b | 0), { h: v, l: _ } = ue.add(this.Fh | 0, this.Fl | 0, v | 0, _ | 0), { h: C, l: k } = ue.add(this.Gh | 0, this.Gl | 0, C | 0, k | 0), { h: N, l: V } = ue.add(this.Hh | 0, this.Hl | 0, N | 0, V | 0), this.set(r, s, i, o, c, d, h, y, E, b, v, _, C, k, N, V);
  }
  roundClean() {
    un.fill(0), dn.fill(0);
  }
...
class Gh extends Fo {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const _ = 4 - v, C = Ph[v], k = Uh[v], N = Uo[v], V = Go[v], P = Lh[v], j = Fh[v];
      for (let O = 0; O < 16; O++) {
        const M = ls(r + Xa(v, i, c, h) + hs[N[O]] + C, P[O]) + E | 0;
        r = E, E = h, h = ls(c, 10) | 0, c = i, i = M;
      }
      for (let O = 0; O < 16; O++) {
        const M = ls(s + Xa(_, o, d, y) + hs[V[O]] + k, j[O]) + b | 0;
...
function Ka(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], h = e[t++] ^ n[r++], y = e[t++] ^ n[r++], E = e[t++] ^ n[r++], b = e[t++] ^ n[r++], v = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], C = e[t++] ^ n[r++], k = e[t++] ^ n[r++], N = e[t++] ^ n[r++], V = e[t++] ^ n[r++], P = e[t++] ^ n[r++], j = e[t++] ^ n[r++], O = e[t++] ^ n[r++], M = o, T = c, F = d, W = h, G = y, J = E, K = b, B = v, a = _, A = C, l = k, p = N, f = V, w = P, I = j, g = O;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + M | 0, s[i++] = c + T | 0, s[i++] = d + F | 0, s[i++] = h + W | 0, s[i++] = y + G | 0, s[i++] = E + J | 0, s[i++] = b + K | 0, s[i++] = v + B | 0, s[i++] = _ + a | 0, s[i++] = C + A | 0, s[i++] = k + l | 0, s[i++] = N + p | 0, s[i++] = V + f | 0, s[i++] = P + w | 0, s[i++] = j + I | 0, s[i++] = O + g | 0;
}
...
function ff(e, t, n) {
  ...
  return { N: s, r: i, p: o, dkLen: c, blockSize32: b, V: k, B32: C, B: _, tmp: N, blockMixCb: V, asyncTick: d };
}
...
var Vs = class extends se {
  ...
  decode(e, t) {
    ...
    const C = n;
    [n, r] = new pt(new Zs(), y).decode(e, r);
    const k = n;
  ...
  decode(e, t) {
    ...
    const _ = n;
    return [n, r] = new pt(new js(), y).decode(e, r), [
      {
        type: 1,
...
function Mp(e, t, n = ld) {
  ...
  do {
    ...
    if (N) {
      if (y = v.length === 0 ? void 0 : b[b.length - 1], h = E, E = v.pop(), V)
        if (i) {
          h = h.slice();
          let j = 0;
          for (const [O, M] of d) {
...
function xd() {
  return Oc || (Oc = 1, function(e) {
    ...
    var N = function(f) {
      ...
      var w = f.url, I = f.query, g = f.variables, u = f.operationName, m = f.headers, Y = f.fetch, X = f.fetchOptions, $ = f.middleware;
      return i(void 0, void 0, void 0, function() {
        var q, te;
        return o(this, function(ne) {
          switch (ne.label) {
            case 0:
              return q = v.default(I, g, u, X.jsonSerializer), te = t({ method: "POST", headers: t(t({}, typeof q == "string" ? { "Content-Type": "application/json" } : {}), m), body: q }, X), $ ? [4, Promise.resolve($(te))] : [3, 2];
            case 1:
        ...
        return f.prototype.rawRequest = function(w, I, g) {
          return i(this, void 0, void 0, function() {
            ...
            return o(this, function(le) {
              return u = C.parseRawRequestArgs(w, I, g), m = this.options, Y = m.headers, X = m.fetch, $ = X === void 0 ? h.default : X, q = m.method, te = q === void 0 ? "POST" : q, ne = m.requestMiddleware, Re = m.responseMiddleware, fe = c(m, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), oe = this.url, u.signal !== void 0 && (fe.signal = u.signal), ve = B(u.query).operationName, [2, T({
                url: oe,
                query: u.query,
          ...
          for (var I = [], g = 1; g < arguments.length; g++)
            I[g - 1] = arguments[g];
          var u = I[0], m = I[1], Y = C.parseRequestArgs(w, u, m), X = this.options, $ = X.headers, q = X.fetch, te = q === void 0 ? h.default : q, ne = X.method, Re = ne === void 0 ? "POST" : ne, fe = X.requestMiddleware, oe = X.responseMiddleware, ve = c(X, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), le = this.url;
          ...
          var g = C.parseBatchRequestArgs(w, I), u = this.options, m = u.headers, Y = u.fetch, X = Y === void 0 ? h.default : Y, $ = u.method, q = $ === void 0 ? "POST" : $, te = u.requestMiddleware, ne = u.responseMiddleware, Re = c(u, ["headers", "fetch", "method", "requestMiddleware", "responseMiddleware"]), fe = this.url;
    ...
    e.GraphQLClient = M;
    function T(f) {
      var w = f.url, I = f.query, g = f.variables, u = f.headers, m = f.operationName, Y = f.fetch, X = f.method, $ = X === void 0 ? "POST" : X, q = f.fetchOptions, te = f.middleware;
      return i(this, void 0, void 0, function() {
    ...
    function W(f, w) {
      ...
      return i(this, void 0, void 0, function() {
        ...
        return o(this, function($) {
          return u = I[0], m = I[1], Y = C.parseRequestExtendedArgs(f, w, u, m), X = new M(Y.url), [2, X.request(t({}, Y))];
        });
      });
    }
    e.request = W;
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let _ = 0; _ < c; _++) {
        ...
        k === 0 ? y = y.add(n(P, i[N])) : h = h.add(n(j, i[V]));
      }
      return { p: h, f: y };
    },
    wNAFCached(s, i, o, c) {
...
function Vm(e) {
  ...
  class E {
    ...
    static fromAffine(C) {
      ...
      return V(k) && V(N) ? E.ZERO : new E(k, N, n.ONE);
    }
    get x() {
    ...
    static normalizeZ(C) {
      ...
      return C.map((N, V) => N.toAffine(k[V])).map(E.fromAffine);
    }
    /**
    ...
    double() {
      const { a: C, b: k } = t, N = n.mul(k, Gc), { px: V, py: P, pz: j } = this;
    ...
    add(C) {
      ...
      let J = n.mul(k, P), K = n.mul(N, j), B = n.mul(V, O), a = n.add(k, N), A = n.add(P, j);
      a = n.mul(a, A), A = n.add(J, K), a = n.sub(a, A), A = n.add(k, V);
      let l = n.add(P, O);
      return A = n.mul(A, l), l = n.add(J, B), A = n.sub(A, l), l = n.add(N, V), M = n.add(j, O), l = n.mul(l, M), M = n.add(K, B), l = n.sub(l, M), F = n.mul(W, A), M = n.mul(G, B), F = n.add(M, F), M = n.sub(K, F), F = n.add(K, F), T = n.mul(M, F), K = n.add(J, J), K = n.add(K, J), B = n.mul(W, B), A = n.mul(G, A), K = n.add(K, B), B = n.sub(J, B), B = n.mul(W, B), A = n.add(A, B), J = n.mul(K, A), T = n.add(T, J), J = n.mul(l, A), M = n.mul(a, M), M = n.sub(M, J), J = n.mul(a, K), F = n.mul(l, F), F = n.add(F, J), new E(M, T, F);
    }
    subtract(C) {
    ...
    wNAF(C) {
      return v.wNAFCached(this, h, C, (k) => {
        ...
        return k.map((V, P) => V.toAffine(N[P])).map(E.fromAffine);
      });
    }
    /**
    ...
    multiplyUnsafe(C) {
      ...
      return V && (M = M.negate()), j && (T = T.negate()), T = new E(n.mul(T.px, N.beta), T.py, T.pz), M.add(T);
    }
    /**
    ...
    multiply(C) {
      ...
      if (P) {
        ...
        F = v.constTimeNegate(j, F), G = v.constTimeNegate(M, G), G = new E(n.mul(G.px, P.beta), G.py, G.pz), N = F.add(G), V = W.add(J);
      } else {
        const { p: j, f: O } = this.wNAF(k);
        N = j, V = O;
      }
      return E.normalizeZ([N, V])[0];
    }
    /**
    ...
    multiplyAndAddUnsafe(C, k, N) {
      const V = E.BASE, P = (O, M) => M === nn || M === Mt || !O.equals(V) ? O.multiplyUnsafe(M) : O.multiply(M), j = P(this, k).add(P(C, N));
...
function jm(e) {
  ...
  class N {
    ...
    recoverPublicKey(l) {
      ...
      const u = w & 1 ? "03" : "02", m = h.fromHex(u + v(g)), Y = d(g), X = c(-I * Y), $ = c(f * Y), q = h.BASE.multiplyAndAddUnsafe(m, X, $);
      if (!q)
...
function zm(e) {
  const t = Fd, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), h = e * e * e % t, y = h * h * e % t, E = kt(y, n, t) * y % t, b = kt(E, n, t) * y % t, v = kt(b, yo, t) * h % t, _ = kt(v, s, t) * v % t, C = kt(_, i, t) * _ % t, k = kt(C, c, t) * C % t, N = kt(k, d, t) * k % t, V = kt(N, c, t) * C % t, P = kt(V, n, t) * y % t, j = kt(P, o, t) * _ % t, O = kt(j, r, t) * h % t, M = kt(O, yo, t);
...
var kE = "https://fuellabs.github.io/block-explorer-v2", ME = (e, t) => `${{
  ...
  const E = y ? ME(
    h[0].key,
    h[0].value
  ) : "", b = /^\/|\/$/gm, v = n ? n.replace(b, "") : E, _ = c.replace(b, ""), C = r == null ? void 0 : r.replace(b, ""), k = C ? encodeURIComponent(C) : void 0, N = _.match(/^https?:\/\//) ? "" : "https://", V = C != null && C.match(/^https?:\/\//) ? "" : "https://";
  ...
  return nI(t).reduce((h, y) => {
    ...
    return E ? o.reduce((v, _) => {
      ...
      if (_.to === E.contractID) {
        ...
        if (k) {
          const N = Ia(k), V = [], P = r == null ? void 0 : r[E.contractID];
          return P && V.push(
            XE({
              abi: P,
              receipt: _,
...
function wi(e) {
  ...
  const {
    ...
    abiMap: d,
    maxInputs: h
  }), k = A0(i.type), N = Q((a = (B = i.policies) == null ? void 0 : B.find((A) => A.type === Lt.Tip)) == null ? void 0 : a.data), { fee: V } = VE({
    gasPrice: b,
    rawPayload: _,
    tip: N,
    consensusParameters: {
...
var bI = (e, t) => {
    ...
    for (; s.length > 0 && i < $c; ) {
      ...
      for (let h = 0; h < c.dryRun.length; h++) {
        ...
        if (k && (N == null ? void 0 : N.type) === ft.Script) {
          ...
          N.maxFee = V, r.set(y, Z(N.toTransactionBytes())), d.push(y);
        }
      }
      s = d, i += 1;
    }
  ...
  async getTransactionCost(e, { resourcesOwner: t, signatureCallback: n, quantitiesToContract: r = [] } = {}) {
    ...
    if (s.updatePredicateGasUsed(d.inputs), s.maxFee = y, i) {
      ...
      k = j.receipts, V = j.outputVariables, N = j.missingContractIds, P = i ? t0(k) : P, s.gasLimit = P, { maxFee: y, maxGas: E, minFee: b, minGas: v, gasPrice: _ } = await this.estimateTxGasAndFee({
...
async function hB(e) {
  ...
  return {
    transactions: i.map((_) => {
      const { node: C } = _, { id: k, rawPayload: N, status: V } = C, [P] = new vn().decode(H(N), 0);
      let j = [];
...
var mB = [
  ...
  async fund(t, n) {
    ...
    d.forEach(({ amount: _, assetId: C }) => {
      ...
      if ("amount" in _)
        if ("owner" in _) {
          const N = String(_.assetId);
          if (h[N]) {
            const V = Q(_.amount);
            h[N].owned = h[N].owned.add(V);
          }
        } else
  ...
  async withdrawToBaseLayer(t, n, r = {}) {
    const s = de.fromAddressOrString(t), i = H(
      ...
      ...i,
      ...o
    ]), ...r }, h = new er(d), y = [{ amount: Q(n), assetId: gt }], E = await this.provider.getTransactionCost(h, { quantitiesToContract: y });
    return this.validateGasLimitAndMaxFee({
      gasUsed: E.gasUsed,
      maxFee: E.maxFee,
      txParams: r
...
async function TI(e, t) {
  const n = JSON.parse(e), {
    ...
    r: d,
    dklen: o
  }), k = Uint8Array.from([...C.subarray(16, 32), ...E]), N = du(k), V = _r(N, "hex");
  if (r !== V)
    throw new x(
      R.INVALID_PASSWORD,
