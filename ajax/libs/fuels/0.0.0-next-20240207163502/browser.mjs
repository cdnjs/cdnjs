...
var X0 = class {
  ...
  async simulate() {
    ...
    return Bo.build(this.functionInvocationScopes, r, this.isMultiCall);
  }
  /**
...
var Hn = class {
  ...
  async transferToContract(t, n, r = wt, s = {}) {
    ...
    const { maxFee: g, requiredQuantities: C } = await this.provider.getTransactionCost(I, [
      { amount: Q(n), assetId: String(r) }
    ]);
    return await this.fund(I, C, g), this.sendTransaction(I);
  }
  /**
  ...
  async withdrawToBaseLayer(t, n, r = {}) {
    const s = me.fromAddressOrString(t), i = Y(
      ...
      ...i,
      ...o
    ]), ...r }, l = new Kn(d), I = [{ amount: Q(n), assetId: wt }], { requiredQuantities: g, maxFee: C } = await this.provider.getTransactionCost(
      l,
      I
    );
