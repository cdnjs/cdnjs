...
}, uB = 9, dB = 3, lB = 9, hB = 9, fB = 18, gB = 15, pB = 12, mB = 9, pA, wB = typeof process < "u" && ((pA = process == null ? void 0 : process.env) == null ? void 0 : pA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/graphql", EB = "https://beta-5.fuel.network/graphql";
export {
  Mn as ASSET_ID_LEN,
