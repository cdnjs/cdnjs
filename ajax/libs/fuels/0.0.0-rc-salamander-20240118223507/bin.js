...
var import_test_utils3 = require("@fuel-ts/wallet/test-utils");
...
var import_test_utils = require("@fuel-ts/wallet/test-utils");
...
var import_test_utils2 = require("@fuel-ts/wallet/test-utils");
...
var buildSwayProgram = async (config, path) => {
  ...
  return new Promise((resolve4, reject) => {
    const builtInForcPath = (0, import_test_utils2.findBinPath)("fuels-forc");
...
var configureCli = () => {
  ...
  program.command("core", "Wrapper around Fuel Core binary", {
    executableFile: (0, import_test_utils3.findBinPath)("fuels-core")
  });
  program.command("forc", "Wrapper around Forc binary", {
    executableFile: (0, import_test_utils3.findBinPath)("fuels-forc")
  });
  return program;
};
