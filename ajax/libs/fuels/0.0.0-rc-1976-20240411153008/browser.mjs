...
const vA = pr(() => new Yl()), As = BigInt(2 ** 32 - 1), to = BigInt(32);
function xA(e, t = !1) {
...
Object.freeze(mr);
const [SA, _A, kA] = [[], [], []], Ih = BigInt(0), yr = BigInt(1), yh = BigInt(2), Bh = BigInt(7), Ch = BigInt(256), bh = BigInt(113);
for (let e = 0, t = yr, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], SA.push(2 * (5 * r + n)), _A.push((e + 1) * (e + 2) / 2 % 64);
  let s = Ih;
  for (let i = 0; i < 7; i++)
    t = (t << yr ^ (t >> Bh) * bh) % Ch, t & yh && (s ^= yr << (yr << BigInt(i)) - yr);
  kA.push(s);
}
...
const Cn = (e, t, n) => pr(() => new MA(t, e, n));
Cn(6, 144, 224 / 8);
Cn(6, 136, 256 / 8);
Cn(6, 104, 384 / 8);
Cn(6, 72, 512 / 8);
...
const hf = (e, t, n) => e << n | t >>> 32 - n, ff = (e, t, n) => t << n | e >>> 32 - n, gf = (e, t, n) => t << n - 32 | e >>> 64 - n, pf = (e, t, n) => e << n - 32 | t >>> 64 - n, [ru, su, iu] = [[], [], []], mf = /* @__PURE__ */ BigInt(0), Br = /* @__PURE__ */ BigInt(1), wf = /* @__PURE__ */ BigInt(2), Ef = /* @__PURE__ */ BigInt(7), If = /* @__PURE__ */ BigInt(256), yf = /* @__PURE__ */ BigInt(113);
for (let e = 0, t = Br, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], ru.push(2 * (5 * r + n)), su.push((e + 1) * (e + 2) / 2 % 64);
  let s = mf;
  for (let i = 0; i < 7; i++)
    t = (t << Br ^ (t >> Ef) * yf) % If, t & wf && (s ^= Br << (Br << /* @__PURE__ */ BigInt(i)) - Br);
  iu.push(s);
}
...
var no = (e) => ii.getRandomValues(new Uint8Array(e)), Cs = (e, t = "base64") => {
  ...
  const n = Vn(String(e).normalize("NFKC"), "utf-8"), r = wr(n, t, 1e5, 32, "sha256");
  return J(r);
}, Df = async (e, t) => {
...
}, lu = "u8", hu = "u16", fu = "u32", gu = "u64", pu = "u256", mu = "raw untyped ptr", wu = "raw untyped slice", Eu = "bool", Iu = "b256", yu = "struct B512", Zo = "enum Option", Yo = "struct Vec", Vo = "struct Bytes", Xo = "struct String", Bu = "str", jo = /str\[(?<length>[0-9]+)\]/, ks = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, qo = /^struct (?<name>\w+)$/, Wo = /^enum (?<name>\w+)$/, Cu = /^\((?<items>.*)\)$/, Zf = /^generic (?<name>\w+)$/, or = "0", $o = "1", K = 8, Kr = 32, _n = Kr, bu = Kr, Yf = Kr, Vf = K * 4, Xf = K * 2, zo = 2 ** 32 - 1, oi = ({ maxInputs: e }) => Kr + // Tx ID
K + // Tx size
...
var On = (e, t) => {
  ...
  if (e.type === Yo) {
    const v = Pu(r), F = new Kt(e.abi, v), b = On(F, { isSmallBytes: !0, encoding: or });
    return new Tu(b);
  }
  ...
  if ((C = Cu.exec(e.type)) == null ? void 0 : C.groups) {
    const v = r.map(
      (F) => On(F, { isRightPadded: !0, encoding: or })
    );
    return new Lu(v);
  }
...
var ar = kr.bech32m = kr.bech32 = void 0;
...
function ra(e) {
  return new Uint8Array(ar.fromWords(na(e).words));
}
function oc(e) {
  if (!vs(e))
    throw new x(
...
var xr = (e) => e instanceof Wu ? e.address : e instanceof gg ? e.id : e, yg = () => j(yn(32)), Bg = (e) => {
  let t;
  try {
    if (!oo(e))
      throw new x(
...
}, wn = new WeakMap(), lA), cr = class extends ai {
  constructor() {
    super("TxPointer", {
...
function qg(e, t) {
  ...
  for (; s < r; ) {
    ...
    throw gt(
      e.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : Er(i) || Ai(n, s) ? `Unexpected character: ${kn(e, s)}.` : `Invalid character: ${kn(e, s)}.`
    );
  }
...
function yd() {
  return kc || (kc = 1, function(e) {
    ...
    function O(f) {
      ...
      return i(this, void 0, void 0, function() {
        var re, Ne, fe, oe, Fe, de, ge, Ht, De, ye, Ir;
...
function Bm(e, t) {
  return le = e.exports, Rd.__wbindgen_wasm_module = t, Nr = null, Dr = null, le;
}
async function Rd(e) {
  if (le !== void 0)
    return le;
...
function Um(e) {
  ...
  function d(F) {
    ...
    if (b && typeof F != "bigint") {
      if (jt(F) && (F = Ar(F)), typeof F != "string" || !b.includes(F.length))
...
}, Qr = (e) => JSON.stringify(e, null, 2), vE = (e, t) => {
...
var rB = [
  ...
  const t = EI(e);
  await ua();
  const n = mm(16, 0, Em.ScriptData), r = Oc(17, 16, 32), s = Rr(18, 17, 0), i = Oc(19, 17, 8), o = gm(16, 18, 19), A = Dd(1);
...
async function BI(e, t, n) {
  const r = En(Kc(e), "hex"), s = he.fromAddressOrString(t), i = yn(Xi), o = cu({
    ...
    r: $c,
    p: zc
  }), A = yn(yI), d = await Tf(r, o, A), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = Au(h), E = vr(y, "hex"), C = {
    id: $m(),
    version: 3,
...
async function CI(e, t) {
  const n = JSON.parse(e), {
    ...
    r: d,
    dklen: o
  }), N = Uint8Array.from([...b.subarray(16, 32), ...E]), _ = Au(N), Y = vr(_, "hex");
  if (r !== Y)
    throw new x(
      R.INVALID_PASSWORD,
...
var YI = 2e3, VI = 5e3, { warn: XI } = console, Sr = class extends HI {
  ...
  async selectConnector(t, n = {
    ...
    return s ? (this._currentConnector = r, this.emit(this.events.currentConnector, r), this.setupConnectorEvents(Object.values(ba)), await ((o = this._storage) == null ? void 0 : o.setItem(Sr.STORAGE_KEY, r.name)), n.emitEvents && this.triggerConnectorEvents(), !0) : !1;
  }
  /**
