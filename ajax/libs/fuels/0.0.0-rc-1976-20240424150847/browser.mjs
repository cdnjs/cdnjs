...
function Dh(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    ...
    for (let o = 0; o < 10; o += 2) {
      const c = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = Va(h, y, 1) ^ n[c], C = Xa(h, y, 1) ^ n[c + 1];
...
class Lh extends Oo {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      ...
      for (let M = 0; M < 16; M++) {
        const k = ds(r + ja(v, i, c, h) + ls[_[M]] + b, T[M]) + E | 0;
...
function ec(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], h = e[t++] ^ n[r++], y = e[t++] ^ n[r++], E = e[t++] ^ n[r++], C = e[t++] ^ n[r++], v = e[t++] ^ n[r++], F = e[t++] ^ n[r++], b = e[t++] ^ n[r++], N = e[t++] ^ n[r++], _ = e[t++] ^ n[r++], Y = e[t++] ^ n[r++], T = e[t++] ^ n[r++], X = e[t++] ^ n[r++], M = e[t++] ^ n[r++], k = o, O = c, P = d, W = h, U = y, H = E, ee = C, B = v, a = F, A = b, l = N, p = _, f = Y, w = T, I = X, g = M;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + k | 0, s[i++] = c + O | 0, s[i++] = d + P | 0, s[i++] = h + W | 0, s[i++] = y + U | 0, s[i++] = E + H | 0, s[i++] = C + ee | 0, s[i++] = v + B | 0, s[i++] = F + a | 0, s[i++] = b + A | 0, s[i++] = N + l | 0, s[i++] = _ + p | 0, s[i++] = Y + f | 0, s[i++] = T + w | 0, s[i++] = X + I | 0, s[i++] = M + g | 0;
}
...
function uf(e, t, n) {
  ...
  const F = su(zr, e, t, { c: 1, dkLen: E * o }), b = Bs(F), N = Bs(new Uint8Array(E * s)), _ = Bs(new Uint8Array(E));
  let Y = () => {
  };
  if (y) {
...
function vf(e, t = 24) {
  ...
  for (let r = 24 - t; r < 24; r++) {
    for (let o = 0; o < 10; o++)
      n[o] = e[o] ^ e[o + 10] ^ e[o + 20] ^ e[o + 30] ^ e[o + 40];
    for (let o = 0; o < 10; o += 2) {
      const c = (o + 8) % 10, d = (o + 2) % 10, h = n[d], y = n[d + 1], E = nc(h, y, 1) ^ n[c], C = rc(h, y, 1) ^ n[c + 1];
      for (let v = 0; v < 50; v += 10)
        e[o + v] ^= E, e[o + v + 1] ^= C;
    }
    let s = e[2], i = e[3];
...
function bp(e, t, n = ud) {
  ...
  do {
    ...
    if (!Array.isArray(h)) {
      ...
      if (T = X == null ? void 0 : X.call(t, h, y, E, C, v), T === Cp)
        break;
      if (T === !1) {
        if (!_) {
          C.pop();
...
function Cd() {
  return Oc || (Oc = 1, function(e) {
    ...
    var h = s(Lg), y = h, E = wp, C = Dp, v = d(da), F = rs, b = vt, N = ss;
...
function Gm(e) {
  ...
  class E {
    ...
    multiplyAndAddUnsafe(b, N, _) {
      const Y = E.BASE, T = (M, k) => k === tn || k === _t || !M.equals(Y) ? M.multiplyUnsafe(k) : M.multiply(k), X = T(this, N).add(T(b, _));
...
function Xm(e) {
  const t = Ld, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), h = e * e * e % t, y = h * h * e % t, E = St(y, n, t) * y % t, C = St(E, n, t) * y % t, v = St(C, Eo, t) * h % t, F = St(v, s, t) * v % t, b = St(F, i, t) * F % t, N = St(b, c, t) * b % t, _ = St(N, d, t) * N % t, Y = St(_, c, t) * b % t, T = St(Y, n, t) * y % t, X = St(T, o, t) * F % t, M = St(X, r, t) * h % t, k = St(M, Eo, t);
  ...
  return JE(t).reduce((h, y) => {
    ...
    return E ? o.reduce((v, F) => {
      ...
      if (F.to === E.contractID) {
        ...
        if (N) {
          const _ = ya(N), Y = [], T = r == null ? void 0 : r[E.contractID];
          return T && Y.push(
            kE({
              abi: T,
              receipt: F,
...
var dI = (...e) => {
  ...
  async getTransactionCost(e, t = [], {
    ...
    const o = Gr(kt(e)), { minGasPrice: c } = this.getGasConfig(), d = ul(o.gasPrice, c), h = o.type === pt.Script, y = this.getBaseAssetId(), E = o.getCoinOutputsQuantities(), C = dI(E, t);
  ...
  async getResourcesToSpend(e, t, n) {
    ...
    const i = {
      owner: r.toB256(),
      queryPerAsset: t.map(ga).map(({ assetId: E, amount: C, max: v }) => ({
        assetId: j(E),
...
async function CI(e, t, n) {
  const r = In(tA(e), "hex"), s = he.fromAddressOrString(t), i = jt(ji), o = uu({
    ...
    r: zc,
    p: eA
  }), c = jt(BI), d = await Uf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = du(h), E = vr(y, "hex"), C = {
    id: Km(),
    version: 3,
...
async function bI(e, t) {
  const n = JSON.parse(e), {
  ...
  } = n, E = In(s, "hex"), C = In(i, "hex"), v = In(y, "hex"), F = In(t), b = uu({
    password: F,
    salt: v,
    n: c,
    p: h,
    r: d,
    dklen: o
  }), N = Uint8Array.from([...b.subarray(16, 32), ...E]), _ = du(N), Y = vr(_, "hex");
  if (r !== Y)
    throw new x(
      R.INVALID_PASSWORD,
