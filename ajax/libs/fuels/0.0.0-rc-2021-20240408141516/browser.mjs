...
}, IB = 9, yB = 3, BB = 9, pA, CB = typeof process < "u" && ((pA = process == null ? void 0 : process.env) == null ? void 0 : pA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", bB = "https://beta-5.fuel.network/graphql";
export {
  Qn as ASSET_ID_LEN,
