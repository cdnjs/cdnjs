...
var xy = (e) => {
  ...
  return n;
}, W0 = 37, EA = BigInt(2 ** 62) + BigInt(W0), $0 = (e) => Math.floor(e / 1e3), IA = (e) => e * 1e3, z0 = (e) => Number(BigInt(e) - EA), K0 = (e) => String(BigInt(e) + EA), el = (e) => IA(z0(e)), Es = class extends Date {
  /**
...
var Me = class extends as {
  ...
  divmod(t, n, r) {
    const { div: s, mod: i } = new as(this.toArray()).divmod(new Me(t), n, r);
    return {
...
const Sl = (e) => new Uint32Array(e.buffer, e.byteOffset, Math.floor(e.byteLength / 4)), Is = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Yt = (e, t) => e << 32 - t | e >>> t, _l = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!_l)
...
function Ul(e, t, n, r) {
  ...
  let f;
  const y = new Uint8Array(4), m = Is(y), b = new Uint8Array(c.outputLen);
...
const FA = pr(() => new Yl()), As = BigInt(2 ** 32 - 1), ro = BigInt(32);
function DA(e, t = !1) {
  return t ? { h: Number(e & As), l: Number(e >> ro & As) } : { h: Number(e >> ro & As) | 0, l: Number(e & As) | 0 };
}
function Vl(e, t = !1) {
...
].map((e) => new Uint8Array(e)), Nh = To.map((e, t) => e.map((n) => ZA[t][n])), Sh = Po.map((e, t) => e.map((n) => ZA[t][n])), _h = new Uint32Array([0, 1518500249, 1859775393, 2400959708, 2840853838]), kh = new Uint32Array([1352829926, 1548603684, 1836072691, 2053994217, 0]), us = (e, t) => e << t | e >>> 32 - t;
function ja(e, t, n, r) {
...
class Oh extends Mo {
  ...
  process(t, n) {
    ...
    for (let D = 0; D < 5; D++) {
      ...
      for (let O = 0; O < 16; O++) {
        const k = us(r + ja(D, i, c, f) + ds[_[O]] + C, T[O]) + m | 0;
        r = m, m = f, f = us(c, 10) | 0, c = i, i = k;
      }
      for (let O = 0; O < 16; O++) {
        const k = us(s + ja(x, o, d, y) + ds[Y[O]] + N, j[O]) + b | 0;
...
const Bs = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Vt = (e, t) => e << 32 - t | e >>> t, jh = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!jh)
  throw new Error("Non little-endian hardware is not supported");
function qh(e) {
  if (typeof e != "string")
...
function cf(e, t, n) {
  ...
  const x = su($r, e, t, { c: 1, dkLen: m * o }), C = ys(x), N = ys(new Uint8Array(m * s)), _ = ys(new Uint8Array(m));
  let Y = () => {
  };
  if (y) {
...
const ls = /* @__PURE__ */ BigInt(2 ** 32 - 1), tc = /* @__PURE__ */ BigInt(32);
function df(e, t = !1) {
  return t ? { h: Number(e & ls), l: Number(e >> tc & ls) } : { h: Number(e >> tc & ls) | 0, l: Number(e & ls) | 0 };
}
function lf(e, t = !1) {
  let n = new Uint32Array(e.length), r = new Uint32Array(e.length);
  for (let s = 0; s < e.length; s++) {
...
var so = (e) => oi.getRandomValues(new Uint8Array(e)), Cs = (e, t = "base64") => {
  switch (t) {
    case "utf-8":
...
}, fu = "u8", gu = "u16", pu = "u32", mu = "u64", wu = "u256", Eu = "raw untyped ptr", Iu = "raw untyped slice", yu = "bool", Bu = "b256", Cu = "struct B512", Vo = "enum Option", Xo = "struct Vec", jo = "struct Bytes", qo = "struct String", bu = "str", Wo = /str\[(?<length>[0-9]+)\]/, ks = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, $o = /^struct (?<name>\w+)$/, zo = /^enum (?<name>\w+)$/, Qu = /^\((?<items>.*)\)$/, Zf = /^generic (?<name>\w+)$/, Os = "0", Ko = "1", K = 8, Kr = 32, kn = Kr, vu = Kr, Yf = Kr, Vf = K * 4, Xf = K * 2, ea = 2 ** 32 - 1, ai = ({ maxInputs: e }) => Kr + // Tx ID
K + // Tx size
...
var _r = (e) => e % K === 0, Du = (e) => K - e % K, Ru = (e) => {
  if (_r(e.length))
    return e;
...
Su = function(e) {
  const t = e instanceof Uint8Array ? e : new Uint8Array(e), n = [Uint8Array.from(t)], r = (K - e.length % K) % K;
...
var nr, dA, rg = (dA = class extends ie {
  ...
  encode(t) {
    ...
    const n = Vr(t), r = new Uint8Array(Ee(this, nr));
    return se([n, r]);
  }
  decode(t, n) {
    if (t.length < this.encodedLength)
  ...
  decode(t, n) {
    ...
    return [Object.keys(this.coders).reduce((i, o) => {
      ...
      let d;
      return [d, r] = c.decode(t, r), _r(r) || (r += Du(r)), i[o] = d, i;
    }, {}), r];
  }
}, Pu = class extends ie {
  constructor(t) {
  ...
  decode(t, n) {
    ...
    return [this.coders.map((i) => {
      let o;
      return [o, r] = i.decode(t, r), _r(r) || (r += Du(r)), o;
    }), r];
  }
}, Uu = class extends ie {
  constructor(t) {
  ...
  getArgSignaturePrefix() {
    return $o.test(this.type) ? "s" : ks.test(this.type) ? "a" : zo.test(this.type) ? "e" : "";
  }
...
var Ln = (e, t) => {
  ...
  if (e.type === Xo) {
    ...
    const C = new tn(e.abi, x), N = Ln(C, { isSmallBytes: !0, encoding: Os });
    return new Uu(N);
  }
  ...
  if ((D = Qu.exec(e.type)) == null ? void 0 : D.groups) {
    const x = r.map(
      (C) => Ln(C, { isRightPadded: !0, encoding: Os })
    );
    return new Pu(x);
  }
...
}, ei, ju, ti, qu, ni, Wu, hA, bs = (hA = class {
  constructor(e, t) {
    lt(this, ei);
    lt(this, ti);
    lt(this, ni);
    ...
    F(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = xt(this.jsonAbi.functions, (n) => n.name === t), this.name = t, this.signature = bs.getSignature(this.jsonAbi, this.jsonFn), this.selector = bs.getFunctionSelector(this.signature), this.selectorBytes = new na().encode(t), this.encoding = this.jsonAbi.encoding, this.isInputDataPointer = on(this, ei, ju).call(this), this.outputMetadata = {
...
}, Gy = 16 * 1024, Hy = 16, Jy = 1024 * 1024 * 1024, Zy = 1024 * 1024 * 1024, Yy = 255, Vy = 1024 * 1024, Xy = 1024 * 1024, mg = "0xffffffffffff0000", ed = "0xffffffffffff0001", wg = "0xffffffffffff0002", Eg = "0xffffffffffff0003", Ig = "0xffffffffffff0004", yg = "0x0", Mr = {};
...
var xr = (e) => e instanceof $u ? e.address : e instanceof hg ? e.id : e, vg = () => X(Bn(32)), xg = (e) => {
  ...
  constructor(t) {
    ...
    if (this.bech32Address = Qg(t), !vs(this.bech32Address))
      throw new v(
        v.CODES.INVALID_BECH32_ADDRESS,
...
class pd {
  constructor(t, n = "GraphQL request", r = {
    ...
    typeof t == "string" || xs(!1, `Body must be a string. Received: ${gd(t)}.`), this.body = t, this.name = n, this.locationOffset = r, this.locationOffset.line > 0 || xs(
      !1,
...
function Qp(e, t, n = Ad) {
  ...
  do {
    ...
    if (!Array.isArray(f)) {
      var x, C;
      Nc(f) || xs(!1, `Invalid AST Node: ${gd(f)}.`);
...
var kp = typeof self == "object" ? self.FormData : window.FormData, ns = {};
...
var Bd = li, Mp = Op(kp), Lp = ns, Tp = function(e) {
...
var rs = {}, Vp = Ce && Ce.__extends || function() {
  var e = function(t, n) {
...
function jp() {
  ...
  var r = rs, s = Cd(), i = "connection_init", o = "connection_ack", c = "ping", d = "pong", f = "subscribe", y = "next", m = "error", b = "complete", D = (
    /** @class */
    function() {
      function O(k, M, P) {
...
function Cd() {
  return Oc || (Oc = 1, function(e) {
    ...
    var f = s(Tg), y = f, m = Ep, b = Rp, D = d(da), x = ns, C = Ft, N = rs;
...
var Ds = /* @__PURE__ */ new Map(), po = /* @__PURE__ */ new Map(), vd = !0, js = !1;
function xd(e) {
...
var iI = (e, t) => {
  ...
  async getTransactionCost(e, t = [], {
    ...
    const o = Pr(Ot(e)), c = this.getChain(), { gasPriceFactor: d, minGasPrice: f, maxGasPerTx: y } = this.getGasConfig(), m = cl(o.gasPrice, f), b = o.type === It.Script, D = o.getCoinOutputsQuantities(), x = iI(D, t);
  ...
  async getResourcesForTransaction(e, t, n = []) {
    const r = he.fromAddressOrString(e), s = Ot(Pr(t)), i = await this.getTransactionCost(s, n);
    s.addResources(
...
var Pn = class {
  ...
  constructor(e) {
    ...
    this.parentFingerprint = e.parentFingerprint || this.parentFingerprint, this.fingerprint = ko(qr(Bt(this.publicKey)), 0, 4), this.depth = e.depth || this.depth, this.index = e.index || this.index, this.chainCode = e.chainCode;
  }
  get extendedKey() {
...
var UI = 2e3, GI = 5e3, { warn: HI } = console, Sr = class extends LI {
  ...
  async pingConnector(t) {
    ...
    if (!n)
      return !1;
    try {
      return await TI(async () => ms(n.ping()), {
        key: n.name,
  ...
  async hasConnector() {
    ...
    return this.once(this.events.currentConnector, () => {
      t.resolve(!0);
    }), ms(t.promise, UI).then(() => !0).catch(() => !1);
  }
  async hasWallet() {
