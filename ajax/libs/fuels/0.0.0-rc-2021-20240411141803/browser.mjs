...
const DA = wr(() => new Kl()), ds = BigInt(2 ** 32 - 1), ro = BigInt(32);
function RA(e, t = !1) {
...
Object.freeze(Er);
const [OA, TA, LA] = [[], [], []], Dh = BigInt(0), Cr = BigInt(1), Rh = BigInt(2), Sh = BigInt(7), Nh = BigInt(256), kh = BigInt(113);
for (let e = 0, t = Cr, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], OA.push(2 * (5 * r + n)), TA.push((e + 1) * (e + 2) / 2 % 64);
  let s = Dh;
  for (let i = 0; i < 7; i++)
    t = (t << Cr ^ (t >> Sh) * kh) % Nh, t & Rh && (s ^= Cr << (Cr << BigInt(i)) - Cr);
  LA.push(s);
}
...
const vn = (e, t, n) => wr(() => new FA(t, e, n));
vn(6, 144, 224 / 8);
vn(6, 136, 256 / 8);
vn(6, 104, 384 / 8);
vn(6, 72, 512 / 8);
...
const Bf = (e, t, n) => e << n | t >>> 32 - n, Cf = (e, t, n) => t << n | e >>> 32 - n, bf = (e, t, n) => t << n - 32 | e >>> 64 - n, Qf = (e, t, n) => e << n - 32 | t >>> 64 - n, [Au, uu, du] = [[], [], []], xf = /* @__PURE__ */ BigInt(0), br = /* @__PURE__ */ BigInt(1), vf = /* @__PURE__ */ BigInt(2), _f = /* @__PURE__ */ BigInt(7), Df = /* @__PURE__ */ BigInt(256), Rf = /* @__PURE__ */ BigInt(113);
for (let e = 0, t = br, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], Au.push(2 * (5 * r + n)), uu.push((e + 1) * (e + 2) / 2 % 64);
  let s = xf;
  for (let i = 0; i < 7; i++)
    t = (t << br ^ (t >> _f) * Rf) % Df, t & vf && (s ^= br << (br << /* @__PURE__ */ BigInt(i)) - br);
  du.push(s);
}
...
var so = (e) => ci.getRandomValues(new Uint8Array(e)), Qs = (e, t = "base64") => {
  ...
  const n = qn(String(e).normalize("NFKC"), "utf-8"), r = Ir(n, t, 1e5, 32, "sha256");
  return H(r);
}, Ff = async (e, t) => {
...
}, wu = "u8", Eu = "u16", Iu = "u32", yu = "u64", Bu = "u256", Cu = "raw untyped ptr", bu = "raw untyped slice", Qu = "bool", xu = "b256", vu = "struct B512", Vo = "enum Option", Xo = "struct Vec", jo = "struct Bytes", Wo = "struct String", _u = "str", qo = /str\[(?<length>[0-9]+)\]/, Ts = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, $o = /^struct (?<name>\w+)$/, zo = /^enum (?<name>\w+)$/, Du = /^\((?<items>.*)\)$/, Kf = /^generic (?<name>\w+)$/, Ar = "0", Ko = "1", z = 8, ts = 32, Qn = ts, Ru = ts, eg = ts, tg = z * 4, ng = z * 2, ea = 2 ** 32 - 1, Ai = ({ maxInputs: e }) => ts + // Tx ID
Qn + // Base asset ID
...
var Un = (e, t) => {
  ...
  if (e.type === Xo) {
    const v = Zu(r), _ = new en(e.abi, v), C = Un(_, { isSmallBytes: !0, encoding: Ar });
    return new Yu(C);
  }
  ...
  if ((b = Du.exec(e.type)) == null ? void 0 : b.groups) {
    const v = r.map(
      (_) => Un(_, { isRightPadded: !0, encoding: Ar })
    );
    return new Ju(v);
  }
...
function ia(e) {
  return new Uint8Array(ur.fromWords(sa(e).words));
}
function cc(e) {
  if (!_s(e))
    throw new x(
...
function Dg(e) {
  const { words: t } = sa(e);
  return ur.encode(Us, t);
}
var Dr = (e) => e instanceof nd ? e.address : e instanceof bg ? e.id : e, Rg = () => Z(bn(32)), Sg = (e) => {
  let t;
  try {
    if (!co(e))
      throw new x(
...
}, In = new WeakMap(), gA), dr = class extends ui {
  constructor() {
    super("TxPointer", {
...
var Zs = class extends se {
  ...
  encode(e) {
    const t = [];
    return t.push(new dr().encode(e.txPointer)), t.push(new Gs().encode(e.inputContract)), t.push(new Js().encode(e.outputContract)), t.push(new S("u64").encode(e.mintAmount)), t.push(new U().encode(e.mintAssetId)), t.push(new S("u64").encode(e.gasPrice)), re(t);
  }
  decode(e, t) {
    let n, r = t;
    [n, r] = new dr().decode(e, r);
...
function aa(e) {
  if (!Wt(e))
    throw new Error("Uint8Array expected");
  return oa(lr(Uint8Array.from(e).reverse()));
}
function fr(e, t) {
...
function up(e, t) {
  ...
  for (; s < r; ) {
    ...
    throw mt(
      e.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : yr(i) || li(n, s) ? `Unexpected character: ${Ln(e, s)}.` : `Invalid character: ${Ln(e, s)}.`
    );
  }
...
function Sm(e, t) {
  return he = e.exports, Td.__wbindgen_wasm_module = t, kr = null, Sr = null, he;
}
async function Td(e) {
  if (he !== void 0)
    return he;
...
function Wm(e) {
  ...
  function d(_) {
    ...
    if (C && typeof _ != "bigint") {
      if (Wt(_) && (_ = lr(_)), typeof _ != "string" || !C.includes(_.length))
...
${ym}#variant.${e.reason}`), { errorMessage: t, reason: n };
}, vr = (e) => JSON.stringify(e, null, 2), GE = (e, t) => {
  ...
  fundWithFakeUtxos(e, t) {
    const n = (s) => this.inputs.find((i) => "assetId" in i ? i.assetId === s : !1), r = (s, i) => {
      const o = n(s);
      let c = i;
      s === gt && (c = Q("1000000000000000000")), o && "assetId" in o ? (o.id = Z(or(34)), o.amount = c) : this.addResources([
        {
          id: Z(or(34)),
          amount: c,
          assetId: s,
...
var EB = [
  ...
  const t = MI(e);
  await la();
  const n = xm(16, 0, _m.ScriptData), r = Fc(17, 16, 32), s = Nr(18, 17, 0), i = Fc(19, 17, 8), o = bm(16, 18, 19), c = Od(1);
  ...
  constructor(e) {
    ...
    const t = Gt(e, 32);
    this.privateKey = Z(t), this.publicKey = Z(hn.getPublicKey(t, !1).slice(1)), this.compressedPublicKey = Z(hn.getPublicKey(t, !0)), this.address = de.fromPublicKey(this.publicKey);
  }
  /**
  ...
  static recoverPublicKey(e, t) {
    ...
    s[0] &= 127;
    const c = new hn.Signature(BigInt(Z(r)), BigInt(Z(s))).addRecoveryBit(
      i
...
async function LI(e, t, n) {
  const r = yn(nA(e), "hex"), s = de.fromAddressOrString(t), i = bn(Wi), o = fu({
    ...
    r: eA,
    p: tA
  }), c = bn(TI), d = await Xf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), I = gu(h), E = _r(I, "hex"), b = {
    id: ow(),
    version: 3,
...
async function FI(e, t) {
  const n = JSON.parse(e), {
    ...
    r: d,
    dklen: o
  }), N = Uint8Array.from([...C.subarray(16, 32), ...E]), k = gu(N), V = _r(k, "hex");
  if (r !== V)
    throw new x(
      R.INVALID_PASSWORD,
...
}, Ba = fn, I0 = 2147483648, y0 = Z("0x0488ade4"), Ca = Z("0x0488b21e"), B0 = Z("0x04358394"), ba = Z("0x043587cf");
function iA(e) {
...
var Hn = class {
  ...
  toExtendedKey(e = !1, t = !1) {
    ...
    const n = jI(this.privateKey == null || e, t), r = Z(Uint8Array.from([this.depth])), s = this.parentFingerprint, i = ko(this.index, 4), o = this.chainCode, c = this.privateKey != null && !e ? re(["0x00", this.privateKey]) : this.publicKey, d = H(re([n, r, s, i, o, c]));
    return iA(d);
  }
  /**
   ...
   */
  lock() {
    return this.signer = () => new mr("0x00"), new C0(this.address, this._provider);
  }
  /**
...
var IB = class {
  ...
  const n = H(e), r = EA(n, 16384), s = $d(r.map((o) => Z(o)));
...
var oy = 2e3, ay = 5e3, { warn: cy } = console, Mr = class extends ry {
...
}, _o = (e) => Z(e.startsWith("0x") ? e : `0x${e}`), Ry = class {
  /**
