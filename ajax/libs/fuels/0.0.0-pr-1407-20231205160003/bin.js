...
async function deployContract(wallet, binaryPath, abiPath, deployConfig) {
...
function findPackageRoot(currentDir = __dirname) {
  if ((0, import_fs3.existsSync)((0, import_path3.join)(currentDir, "package.json"))) {
    return currentDir;
  }
  return findPackageRoot((0, import_path3.join)(currentDir, ".."));
}
...
var startFuelCore = async (config) => {
  ...
  return new Promise((resolve4, reject) => {
    ...
    const builtInFuelsCorePath = (0, import_path4.join)(pkgRootDir, "node_modules", ".bin", "fuels-core");
