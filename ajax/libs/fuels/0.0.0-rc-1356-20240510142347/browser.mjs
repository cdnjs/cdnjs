...
var Br = (e) => e instanceof vu ? e.address : e instanceof Nh ? e.id : e, Lh = () => Z(Jt(32)), kh = (e) => {
  let t;
  try {
    if (!Zi(e))
      throw new _(
...
function Ku() {
  return mc || (mc = 1, function(e) {
    ...
    var f = s(ng), I = f, w = Lg, C = Jg, v = A(qo), R = jr, B = xt, M = qr;
...
async function nI(e, t, n) {
  const r = En(Pc(e), "hex"), s = Ae.fromAddressOrString(t), i = Jt(Qi), o = Ud({
    ...
    r: Lc,
    p: kc
  }), c = Jt(tI), A = await Kf(r, o, c), f = Uint8Array.from([...o.subarray(16, 32), ...A]), I = Gd(f), w = Cr(I, "hex"), C = {
    id: lm(),
    version: 3,
