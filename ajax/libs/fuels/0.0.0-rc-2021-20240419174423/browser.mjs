...
}, EB = 9, IB = 3, yB = 9, BB = 9, CB = 18, bB = 15, QB = 12, xB = 9, pA, vB = typeof process < "u" && ((pA = process == null ? void 0 : process.env) == null ? void 0 : pA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", _B = "https://beta-5.fuel.network/graphql";
export {
  xn as ASSET_ID_LEN,
