...
const Kr = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Lt = (e, t) => e << 32 - t | e >>> t, Yd = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!Yd)
...
class no extends to {
  ...
  digestInto(t) {
    Xn(this), Lc(t, this), this.finished = !0;
...
function Kd(e, t, n, r) {
  Mc(e);
  const s = Oc({ dkLen: 32, asyncTick: 10 }, r), { c: i, dkLen: o, asyncTick: c } = s;
...
class LA extends no {
  ...
  process(t, n) {
    ...
    for (let _ = 0; _ < 5; _++) {
      ...
      for (let L = 0; L < 16; L++) {
        const T = Vr(r + ia(_, i, c, h) + Hr[M[L]] + C, O[L]) + w | 0;
        r = w, w = h, h = Vr(c, 10) | 0, c = i, i = T;
      }
      for (let L = 0; L < 16; L++) {
        const T = Vr(s + ia(R, o, A, b) + Hr[G[L]] + F, Z[L]) + x | 0;
...
const OA = /* @__PURE__ */ vs(() => new LA()), [kA, PA] = le.split([
  "0x428a2f98d728ae22",
  "0x7137449123ef65cd",
  "0xb5c0fbcfec4d3b2f",
  "0xe9b5dba58189dbbc",
...
var fr = (e) => e instanceof b0 ? e.address : e instanceof Ol ? e.id : e, Vl = () => V(Tt(32)), Hl = (e) => {
  let t;
  try {
    if (!xi(e))
      throw new v(
...
}, Oe = /* @__PURE__ */ ((e) => (e[e.Script = 0] = "Script", e[e.Create = 1] = "Create", e[e.Mint = 2] = "Mint", e[e.Upgrade = 3] = "Upgrade", e[e.Upload = 4] = "Upload", e))(Oe || {}), Sa = class extends ce {
  constructor() {
...
class yo extends Error {
  ...
  constructor(t, ...n) {
    ...
    super(t), this.name = "GraphQLError", this.path = h ?? void 0, this.originalError = b ?? void 0, this.nodes = Oa(
...
function Ns(e, t) {
  return O0(e.charCodeAt(t)) && k0(e.charCodeAt(t + 1));
}
function O0(e) {
...
function xf(e, t, n) {
  ...
  if (i === 46 && (o = !0, i = r.charCodeAt(++s), s = ui(e, s, i), i = r.charCodeAt(s)), (i === 69 || i === 101) && (o = !0, i = r.charCodeAt(++s), (i === 43 || i === 45) && (i = r.charCodeAt(++s)), s = ui(e, s, i), i = r.charCodeAt(s)), i === 46 || L0(i))
    throw ht(
      e.source,
      s,
...
function Rf(e, t) {
  ...
  if (O0(r) && n.charCodeAt(t + 6) === 92 && n.charCodeAt(t + 7) === 117) {
    const s = Pa(n, t + 8);
    if (k0(s))
      return {
...
function Mf(e, t) {
  ...
  return n.length === 0 ? "{}" : t.length > P0 ? "[" + Of(e) + "]" : "{ " + n.map(
    ([s, i]) => s + ": " + Ds(i, t)
  ).join(", ") + " }";
}
function Lf(e, t) {
...
/*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Ai = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Ot = (e, t) => e << 32 - t | e >>> t;
...
function Ig(e) {
  ...
  class w {
    ...
    double() {
      const { a: C, b: F } = t, M = n.mul(F, ja), { px: G, py: O, pz: Z } = this;
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const cu = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), $a = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), xg = BigInt(1), Li = BigInt(2), Ka = (e, t) => (e + t / Li) / t;
function _g(e) {
  const t = cu, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), A = BigInt(88), h = e * e * e % t, b = h * h * e % t, w = vt(b, n, t) * b % t, x = vt(w, n, t) * b % t, _ = vt(x, Li, t) * h % t, R = vt(_, s, t) * _ % t, C = vt(R, i, t) * R % t, F = vt(C, c, t) * C % t, M = vt(F, A, t) * F % t, G = vt(M, c, t) * C % t, O = vt(G, n, t) * b % t, Z = vt(O, o, t) * R % t, L = vt(Z, r, t) * h % t, T = vt(L, Li, t);
  if (!Oi.eql(Oi.sqr(T), e))
    throw new Error("Cannot find square root");
  return T;
}
const Oi = fg(cu, void 0, void 0, { sqrt: _g }), sn = Bg({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
...
function Lg(e, t) {
  return new Promise(function(n, r) {
    ...
    pu(e, t, i, { once: !0 }), t !== "error" && Og(e, s, { once: !0 });
  });
}
function Og(e, t, n) {
  ...
  return Mm(t).reduce((h, b) => {
    ...
    return w ? o.reduce((_, R) => {
      ...
      if (R.to === w.contractID) {
        ...
        if (F) {
          const M = Fo(F), G = [], O = r == null ? void 0 : r[w.contractID];
          return O && G.push(
            _m({
              abi: O,
              receipt: R,
...
`)
  ...
  async estimateMultipleTxDependencies(e) {
    ...
    n.forEach((o, c) => {
      o.type === Oe.Script && r.set(c, V(o.toTransactionBytes()));
    });
...
var hw = "https://cdn.fuel.network/assets/", gw = [
  ...
  const t = pw(e);
  await Eo();
  const n = Oh(16, 0, Ph.ScriptData), r = Ha(17, 16, 32), s = Ti(18, 17, 0), i = Ha(19, 17, 8), o = Lh(16, 18, 19), c = K0(1);
...
}, Lo = on, zu = 2147483648, Vu = V("0x0488ade4"), Oo = V("0x0488b21e"), Hu = V("0x04358394"), ko = V("0x043587cf");
function hc(e) {
  return Fc(ie([e, $i(mt(mt(e)), 0, 4)]));
}
function Nw(e = !1, t = !1) {
  return e ? t ? ko : Oo : t ? Hu : Vu;
}
function Dw(e) {
  return [Oo, ko].includes(V(e.slice(0, 4)));
}
function Tw(e) {
  return [Vu, Hu, Oo, ko].includes(
    V(e.slice(0, 4))
  );
}
function Fw(e, t = 0) {
...
var Ln = class {
  ...
  static fromMnemonic(e, t, n, r) {
    const s = Lo.mnemonicToSeed(e, n), o = yi.fromSeed(s).derivePath(t || bt.defaultPath);
...
var Mw = class {
  ...
  constructor(e) {
    dn(this, Cn, void 0), De(this, "pathKey", "{}"), De(this, "rootPath", `m/44'/1179993420'/${this.pathKey}'/0/0`), De(this, "numberOfAccounts", 0), Dt(this, Cn, e.secret || Lo.generate()), this.rootPath = e.rootPath || this.rootPath, this.numberOfAccounts = e.numberOfAccounts || 1;
  }
  getDerivePath(e) {
...
var Ps = class {
  ...
  return t ? s.push(
    ...
    Ti(19, 19, 0),
    Va(16, 17, 18, 19)
  ) : s.push(Va(16, 17, 18, Le.cgas().to_u8())), s;
};
function mc(e) {
  if (!e.length)
    return new Uint8Array();
...
var qw = (e) => e === ue.Return || e === ue.ReturnData, jw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const b = [];
    for (let R = 0; R < r; R += 1) {
      const C = n[R], F = h, M = F + ge, G = M + fs, O = G + El + ge + ge, Z = O + C.fnSelectorBytes.byteLength, L = H(C.data);
      let T = 0;
      b.push(new D("u64").encode(C.amount || 0)), b.push(new z().encode(((_ = C.assetId) == null ? void 0 : _.toString()) || Ne)), b.push(C.contractId.toBytes()), b.push(new D("u64").encode(O)), b.push(new D("u64").encode(Z)), b.push(C.fnSelectorBytes), b.push(L), C.gas && (b.push(new D("u64").encode(C.gas)), T = Z + L.byteLength);
      const k = {
        amountOffset: F,
        assetIdOffset: M,
        gasForwardedOffset: T,
...
var od = class {
  ...
  async prepareTransaction() {
    await Eo(), this.updateScriptRequest(), this.updateRequiredCoins(), this.checkGasLimitTotal(), this.transactionRequest.type === Oe.Script && (this.transactionRequest.abis = ed(this.functionInvocationScopes));
  }
  /**
...
var cd = (e) => {
  ...
  async deployContract(e = {}) {
    const { contractId: t, transactionRequest: n } = await this.prepareDeploy(e), r = this.getAccount(), { awaitExecution: s } = e, i = await r.sendTransaction(n, {
      awaitExecution: s
    }), o = new iy(t, this.interface, r);
    return { transactionResponse: i, contract: o };
  }
  /**
  ...
  getAccount() {
    if (!this.account)
      throw new v(Q.ACCOUNT_REQUIRED, "Account not assigned to contract.");
    return this.account;
  }
