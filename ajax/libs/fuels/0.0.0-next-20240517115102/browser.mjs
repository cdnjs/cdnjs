...
}, Sy = 9, Qy = 3, Ny = 9, Dy = 9, Ty = 18, Fy = 15, My = 12, Oy = 9, lc, Ly = typeof process < "u" && ((lc = process == null ? void 0 : process.env) == null ? void 0 : lc.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", ky = "https://devnet.fuel.network/v1/graphql";
export {
  as as ASSET_ID_LEN,
