...
function fl(e) {
  pr(hl.indexOf(e) >= 0, "platform missing String.prototype.normalize", "UNSUPPORTED_OPERATION", {
...
function wl(e, t) {
  const n = Fn(e, t);
  return pr(n >= ml, "unsigned value cannot be negative", "NUMERIC_FAULT", {
    fault: "overflow",
    operation: "getUint",
    value: e
  }), n;
...
const xA = mr(() => new Vl()), us = BigInt(2 ** 32 - 1), no = BigInt(32);
function FA(e, t = !1) {
...
Object.freeze(wr);
const [_A, kA, MA] = [[], [], []], yh = BigInt(0), Br = BigInt(1), Bh = BigInt(2), Ch = BigInt(7), bh = BigInt(256), Qh = BigInt(113);
for (let e = 0, t = Br, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], _A.push(2 * (5 * r + n)), kA.push((e + 1) * (e + 2) / 2 % 64);
  let s = yh;
  for (let i = 0; i < 7; i++)
    t = (t << Br ^ (t >> Ch) * Qh) % bh, t & Bh && (s ^= Br << (Br << BigInt(i)) - Br);
  MA.push(s);
}
...
const bn = (e, t, n) => mr(() => new OA(t, e, n));
bn(6, 144, 224 / 8);
bn(6, 136, 256 / 8);
bn(6, 104, 384 / 8);
bn(6, 72, 512 / 8);
...
const ff = (e, t, n) => e << n | t >>> 32 - n, gf = (e, t, n) => t << n | e >>> 32 - n, pf = (e, t, n) => t << n - 32 | e >>> 64 - n, mf = (e, t, n) => e << n - 32 | t >>> 64 - n, [su, iu, ou] = [[], [], []], wf = /* @__PURE__ */ BigInt(0), Cr = /* @__PURE__ */ BigInt(1), Ef = /* @__PURE__ */ BigInt(2), If = /* @__PURE__ */ BigInt(7), yf = /* @__PURE__ */ BigInt(256), Bf = /* @__PURE__ */ BigInt(113);
for (let e = 0, t = Cr, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], su.push(2 * (5 * r + n)), iu.push((e + 1) * (e + 2) / 2 % 64);
  let s = wf;
  for (let i = 0; i < 7; i++)
    t = (t << Cr ^ (t >> If) * Bf) % yf, t & Ef && (s ^= Cr << (Cr << /* @__PURE__ */ BigInt(i)) - Cr);
  ou.push(s);
}
...
var ro = (e) => oi.getRandomValues(new Uint8Array(e)), bs = (e, t = "base64") => {
  ...
  const n = Xn(String(e).normalize("NFKC"), "utf-8"), r = Er(n, t, 1e5, 32, "sha256");
  return J(r);
}, Rf = async (e, t) => {
...
}, hu = "u8", fu = "u16", gu = "u32", pu = "u64", mu = "u256", wu = "raw untyped ptr", Eu = "raw untyped slice", Iu = "bool", yu = "b256", Bu = "struct B512", Yo = "enum Option", Vo = "struct Vec", Xo = "struct Bytes", jo = "struct String", Cu = "str", qo = /str\[(?<length>[0-9]+)\]/, Ms = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Wo = /^struct (?<name>\w+)$/, $o = /^enum (?<name>\w+)$/, bu = /^\((?<items>.*)\)$/, Yf = /^generic (?<name>\w+)$/, ar = "0", zo = "1", K = 8, es = 32, kn = es, Qu = es, Vf = es, Xf = K * 4, jf = K * 2, Ko = 2 ** 32 - 1, ai = ({ maxInputs: e }) => es + // Tx ID
K + // Tx size
...
var Ln = (e, t) => {
  ...
  if (e.type === Vo) {
    const v = Uu(r), F = new en(e.abi, v), C = Ln(F, { isSmallBytes: !0, encoding: ar });
    return new Pu(C);
  }
  ...
  if ((b = bu.exec(e.type)) == null ? void 0 : b.groups) {
    const v = r.map(
      (F) => Ln(F, { isRightPadded: !0, encoding: ar })
    );
    return new Tu(v);
  }
...
var cr = Mr.bech32m = Mr.bech32 = void 0;
...
var Fr = (e) => e instanceof $u ? e.address : e instanceof pg ? e.id : e, Bg = () => j(Bn(32)), Cg = (e) => {
  let t;
  try {
    if (!ao(e))
      throw new x(
...
}, En = new WeakMap(), hA), Ar = class extends ci {
  constructor() {
    super("TxPointer", {
...
function oa(e) {
  if (!qt(e))
    throw new Error("Uint8Array expected");
  return ia(ur(Uint8Array.from(e).reverse()));
}
function lr(e, t) {
...
function Wg(e, t) {
  ...
  for (; s < r; ) {
    ...
    throw pt(
      e.source,
      s,
      i === 39 ? `Unexpected single quote character ('), did you mean to use a double quote (")?` : Ir(i) || ui(n, s) ? `Unexpected character: ${Mn(e, s)}.` : `Invalid character: ${Mn(e, s)}.`
    );
  }
...
function Bd() {
  return Mc || (Mc = 1, function(e) {
    ...
    function O(f) {
      ...
      return i(this, void 0, void 0, function() {
        var re, Ne, fe, oe, xe, de, ge, Jt, Fe, ye, yr;
...
function Cm(e, t) {
  return le = e.exports, Nd.__wbindgen_wasm_module = t, Sr = null, Rr = null, le;
}
async function Nd(e) {
  if (le !== void 0)
    return le;
...
}, vr = (e) => JSON.stringify(e, null, 2), xE = (e, t) => {
...
var sB = [
  ...
  const t = II(e);
  await da();
  const n = wm(16, 0, Im.ScriptData), r = Lc(17, 16, 32), s = Nr(18, 17, 0), i = Lc(19, 17, 8), o = pm(16, 18, 19), c = Rd(1);
...
async function CI(e, t, n) {
  const r = In(eA(e), "hex"), s = he.fromAddressOrString(t), i = Bn(ji), o = Au({
    ...
    r: zc,
    p: Kc
  }), c = Bn(BI), d = await Pf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = uu(h), m = xr(y, "hex"), b = {
    id: zm(),
    version: 3,
...
async function bI(e, t) {
  const n = JSON.parse(e), {
    ...
    r: d,
    dklen: o
  }), N = Uint8Array.from([...C.subarray(16, 32), ...m]), _ = uu(N), Y = xr(_, "hex");
  if (r !== Y)
    throw new x(
      R.INVALID_PASSWORD,
...
var Pn = class {
   ...
   */
  lock() {
    return this.signer = () => new gr("0x00"), new m0(this.address, this._provider);
  }
  /**
...
var VI = 2e3, XI = 5e3, { warn: jI } = console, _r = class extends JI {
  ...
  async selectConnector(t, n = {
    ...
    return s ? (this._currentConnector = r, this.emit(this.events.currentConnector, r), this.setupConnectorEvents(Object.values(Qa)), await ((o = this._storage) == null ? void 0 : o.setItem(_r.STORAGE_KEY, r.name)), n.emitEvents && this.triggerConnectorEvents(), !0) : !1;
  }
  /**
