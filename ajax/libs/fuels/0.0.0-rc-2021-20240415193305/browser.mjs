...
var $d = class {
  ...
  async next() {
    for (this.stream || await this.setStream(); ; ) {
      ...
      const n = $d.textDecoder.decode(e);
...
}, EB = 9, IB = 3, yB = 9, BB = 9, CB = 0, bB = 3, QB = 6, xB = 9, vB = 12, _B = 15, DB = 18, pA, RB = typeof process < "u" && ((pA = process == null ? void 0 : process.env) == null ? void 0 : pA.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", SB = "https://beta-5.fuel.network/graphql";
export {
  xn as ASSET_ID_LEN,
