...
const R0 = /* @__PURE__ */ BigInt(0), vs = /* @__PURE__ */ BigInt(1), $l = /* @__PURE__ */ BigInt(2);
function Tn(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
function Nr(e) {
...
const ru = (e, t, n) => new nu(e, t).update(n).digest();
ru.create = (e, t) => new nu(e, t);
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
