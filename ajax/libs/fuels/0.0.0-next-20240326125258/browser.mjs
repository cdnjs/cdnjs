...
Object.freeze(pr);
const [_A, kA, MA] = [[], [], []], lh = BigInt(0), yr = BigInt(1), hh = BigInt(2), fh = BigInt(7), gh = BigInt(256), ph = BigInt(113);
for (let e = 0, t = yr, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], _A.push(2 * (5 * r + n)), kA.push((e + 1) * (e + 2) / 2 % 64);
  let s = lh;
  for (let i = 0; i < 7; i++)
    t = (t << yr ^ (t >> fh) * ph) % gh, t & hh && (s ^= yr << (yr << BigInt(i)) - yr);
  MA.push(s);
}
...
const sf = (e, t, n) => e << n | t >>> 32 - n, of = (e, t, n) => t << n | e >>> 32 - n, af = (e, t, n) => t << n - 32 | e >>> 64 - n, cf = (e, t, n) => e << n - 32 | t >>> 64 - n, [su, iu, ou] = [[], [], []], Af = /* @__PURE__ */ BigInt(0), Br = /* @__PURE__ */ BigInt(1), uf = /* @__PURE__ */ BigInt(2), df = /* @__PURE__ */ BigInt(7), lf = /* @__PURE__ */ BigInt(256), hf = /* @__PURE__ */ BigInt(113);
for (let e = 0, t = Br, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], su.push(2 * (5 * r + n)), iu.push((e + 1) * (e + 2) / 2 % 64);
  let s = Af;
  for (let i = 0; i < 7; i++)
    t = (t << Br ^ (t >> df) * hf) % lf, t & uf && (s ^= Br << (Br << /* @__PURE__ */ BigInt(i)) - Br);
  ou.push(s);
}
...
}, hu = "u8", fu = "u16", gu = "u32", pu = "u64", mu = "u256", wu = "raw untyped ptr", Eu = "raw untyped slice", Iu = "bool", yu = "b256", Bu = "struct B512", Xo = "enum Option", jo = "struct Vec", qo = "struct Bytes", Wo = "struct String", Cu = "str", $o = /str\[(?<length>[0-9]+)\]/, Ns = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, Ko = /^struct (?<name>\w+)$/, zo = /^enum (?<name>\w+)$/, bu = /^\((?<items>.*)\)$/, Of = /^generic (?<name>\w+)$/, Ss = "0", Lf = "1", re = 8, Wr = 32, Sr = Wr, Tf = Wr, Pf = Wr, Uf = re * 4, Gf = re * 2, ea = 2 ** 32 - 1, ai = ({ maxInputs: e }) => Wr + // Tx ID
re + // Tx size
...
}, My = 16 * 1024, Oy = 16, Ly = 1024 * 1024 * 1024, Ty = 1024 * 1024 * 1024, Py = 255, Uy = 1024 * 1024, Gy = 1024 * 1024, hg = "0xffffffffffff0000", ju = "0xffffffffffff0001", fg = "0xffffffffffff0002", gg = "0xffffffffffff0003", pg = "0xffffffffffff0004", mg = "0x0", Or = {};
...
var vr = (e) => e instanceof Yu ? e.address : e instanceof Ag ? e.id : e, Bg = () => X(yn(32)), Cg = (e) => {
  let t;
  try {
    if (!uo(e))
      throw new v(
...
var pd = hi, Sp = Np(Rp), _p = zr, kp = function(e) {
...
var es = {}, Hp = Ce && Ce.__extends || function() {
  var e = function(t, n) {
...
function md() {
  return kc || (kc = 1, function(e) {
    ...
    var h = s(kg), y = h, p = gp, b = vp, F = d(ua), x = zr, C = Ft, N = es;
...
var nI = (e, t) => {
  ...
  async getTransactionCost(e, t = [], {
    ...
    const o = Pr(Mt(e)), c = this.getChain(), { gasPriceFactor: d, minGasPrice: h, maxGasPerTx: y } = this.getGasConfig(), p = el(o.gasPrice, h), b = o.type === Ct.Script, F = o.getCoinOutputsQuantities(), x = nI(F, t);
...
var iB = [
  ...
  const t = dI(e);
  await da();
  const n = um(16, 0, lm.ScriptData), r = Oc(17, 16, 32), s = Dr(18, 17, 0), i = Oc(19, 17, 8), o = cm(16, 18, 19), c = bd(1);
...
async function fI(e, t, n) {
  const r = En(zc(e), "hex"), s = he.fromAddressOrString(t), i = yn(qi), o = Au({
    ...
    r: $c,
    p: Kc
  }), c = yn(hI), d = await Rf(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...d]), y = uu(h), p = Qr(y, "hex"), b = {
    id: Zm(),
    version: 3,
...
var Tn = class {
  ...
  constructor(e) {
    ...
    this.parentFingerprint = e.parentFingerprint || this.parentFingerprint, this.fingerprint = Mo(Xr(yt(this.publicKey)), 0, 4), this.depth = e.depth || this.depth, this.index = e.index || this.index, this.chainCode = e.chainCode;
  }
  get extendedKey() {
...
var LI = 2e3, TI = 5e3, { warn: PI } = console, Nr = class extends kI {
...
}, qt = new WeakMap(), fA), ey = (e) => ta + ai({ maxInputs: e }), E0 = re + Sr + Tf + re + re;
function ty(e) {
  const t = [...e.receipts];
  let n, r;
  if (t.forEach((i) => {
