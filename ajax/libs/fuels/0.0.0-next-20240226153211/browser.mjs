...
}, KB = kh, zB = "0xa449b1ffee0e2205fa924c6740cc48b3b473aa28587df6dab12abc245d1f5298", Be = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Oh(e) {
...
(function(e) {
  (function(t, n) {
    ...
    i.prototype.mulTo = function(a, A) {
      ...
      return this.length === 10 && a.length === 10 ? h = Z(this, a, A) : m < 63 ? h = S(this, a, A) : m < 1024 ? h = T(this, a, A) : h = j(this, a, A), h;
...
class da extends Aa {
  ...
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: l, Dl: E, Eh: g, El: C, Fh: x, Fl: v, Gh: b, Gl: R, Hh: S, Hl: Z } = this;
    for (let T = 0; T < 80; T++) {
      const j = ue.rotrSH(g, C, 14) ^ ue.rotrSH(g, C, 18) ^ ue.rotrBH(g, C, 41), O = ue.rotrSL(g, C, 14) ^ ue.rotrSL(g, C, 18) ^ ue.rotrBL(g, C, 41), k = g & x ^ ~g & b, L = C & v ^ ~C & R, P = ue.add5L(Z, O, L, Xl[T], wn[T]), q = ue.add5H(P, S, j, k, Vl[T], mn[T]), U = P | 0, H = ue.rotrSH(r, s, 28) ^ ue.rotrBH(r, s, 34) ^ ue.rotrBH(r, s, 39), ee = ue.rotrSL(r, s, 28) ^ ue.rotrBL(r, s, 34) ^ ue.rotrBL(r, s, 39), B = r & i ^ r & c ^ i & c, a = s & o ^ s & d ^ o & d;
      S = b | 0, Z = R | 0, b = x | 0, R = v | 0, x = g | 0, v = C | 0, { h: g, l: C } = ue.add(l | 0, E | 0, q | 0, U | 0), l = c | 0, E = d | 0, c = i | 0, d = o | 0, i = r | 0, o = s | 0;
      const A = ue.add3L(U, ee, a);
      r = ue.add3H(A, q, H, B), s = A | 0;
    }
    ({ h: r, l: s } = ue.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = ue.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: c, l: d } = ue.add(this.Ch | 0, this.Cl | 0, c | 0, d | 0), { h: l, l: E } = ue.add(this.Dh | 0, this.Dl | 0, l | 0, E | 0), { h: g, l: C } = ue.add(this.Eh | 0, this.El | 0, g | 0, C | 0), { h: x, l: v } = ue.add(this.Fh | 0, this.Fl | 0, x | 0, v | 0), { h: b, l: R } = ue.add(this.Gh | 0, this.Gl | 0, b | 0, R | 0), { h: S, l: Z } = ue.add(this.Hh | 0, this.Hl | 0, S | 0, Z | 0), this.set(r, s, i, o, c, d, l, E, g, C, x, v, b, R, S, Z);
  }
  roundClean() {
    mn.fill(0), wn.fill(0);
  }
...
function Fc(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], l = e[t++] ^ n[r++], E = e[t++] ^ n[r++], g = e[t++] ^ n[r++], C = e[t++] ^ n[r++], x = e[t++] ^ n[r++], v = e[t++] ^ n[r++], b = e[t++] ^ n[r++], R = e[t++] ^ n[r++], S = e[t++] ^ n[r++], Z = e[t++] ^ n[r++], T = e[t++] ^ n[r++], j = e[t++] ^ n[r++], O = e[t++] ^ n[r++], k = o, L = c, P = d, q = l, U = E, H = g, ee = C, B = x, a = v, A = b, h = R, m = S, f = Z, I = T, y = j, p = O;
  for (let u = 0; u < 8; u += 2)
    U ^= Ee(k + f | 0, 7), a ^= Ee(U + k | 0, 9), f ^= Ee(a + U | 0, 13), k ^= Ee(f + a | 0, 18), A ^= Ee(H + L | 0, 7), I ^= Ee(A + H | 0, 9), L ^= Ee(I + A | 0, 13), H ^= Ee(L + I | 0, 18), y ^= Ee(h + ee | 0, 7), P ^= Ee(y + h | 0, 9), ee ^= Ee(P + y | 0, 13), h ^= Ee(ee + P | 0, 18), q ^= Ee(p + m | 0, 7), B ^= Ee(q + p | 0, 9), m ^= Ee(B + q | 0, 13), p ^= Ee(m + B | 0, 18), L ^= Ee(k + q | 0, 7), P ^= Ee(L + k | 0, 9), q ^= Ee(P + L | 0, 13), k ^= Ee(q + P | 0, 18), ee ^= Ee(H + U | 0, 7), B ^= Ee(ee + H | 0, 9), U ^= Ee(B + ee | 0, 13), H ^= Ee(U + B | 0, 18), m ^= Ee(h + A | 0, 7), a ^= Ee(m + h | 0, 9), A ^= Ee(a + m | 0, 13), h ^= Ee(A + a | 0, 18), f ^= Ee(p + y | 0, 7), I ^= Ee(f + p | 0, 9), y ^= Ee(I + f | 0, 13), p ^= Ee(y + I | 0, 18);
  s[i++] = o + k | 0, s[i++] = c + L | 0, s[i++] = d + P | 0, s[i++] = l + q | 0, s[i++] = E + U | 0, s[i++] = g + H | 0, s[i++] = C + ee | 0, s[i++] = x + B | 0, s[i++] = v + a | 0, s[i++] = b + A | 0, s[i++] = R + h | 0, s[i++] = S + m | 0, s[i++] = Z + f | 0, s[i++] = T + I | 0, s[i++] = j + y | 0, s[i++] = O + p | 0;
}
...
function Vf(e, t, n) {
  ...
  return { N: s, r: i, p: o, dkLen: c, blockSize32: C, V: R, B32: b, B: v, tmp: S, blockMixCb: Z, asyncTick: d };
}
...
var ep = (e) => Object.values(e).every(
  ...
  encode(t) {
    ...
    const s = this.coders[n], i = Object.keys(this.coders).indexOf(n), o = s.encode(t[n]), c = new Uint8Array(ye(this, Dn) - s.encodedLength);
    return Mt([ye(this, mr).encode(i), c, o]);
  }
  decode(t, n) {
    ...
    const c = this.coders[o], d = ye(this, Dn) - c.encodedLength;
          ...
          switch (Le.label) {
            ...
            case 2:
              if (ae = Le.sent(), Re = Oe && Array.isArray(ae) ? !ae.some(function(Ue) {
                ...
                return pe = ge.headers, zt = ge.status, ae.errors, Se = c(ae, ["errors"]), be = $.errorPolicy === "ignore" ? Se : ae, [2, t(t({}, Oe ? { data: be } : be), { headers: pe, status: zt })];
...
function aE(e) {
  ...
  class g {
    ...
    add(b) {
      ...
      let H = n.mul(R, T), ee = n.mul(S, j), B = n.mul(Z, O), a = n.add(R, S), A = n.add(T, j);
      a = n.mul(a, A), A = n.add(H, ee), a = n.sub(a, A), A = n.add(R, Z);
      let h = n.add(T, O);
      return A = n.mul(A, h), h = n.add(H, B), A = n.sub(A, h), h = n.add(S, Z), k = n.add(j, O), h = n.mul(h, k), k = n.add(ee, B), h = n.sub(h, k), P = n.mul(q, A), k = n.mul(U, B), P = n.add(k, P), k = n.sub(ee, P), P = n.add(ee, P), L = n.mul(k, P), ee = n.add(H, H), ee = n.add(ee, H), B = n.mul(q, B), A = n.mul(U, A), ee = n.add(ee, B), B = n.sub(H, B), B = n.mul(q, B), A = n.add(A, B), H = n.mul(ee, A), L = n.add(L, H), H = n.mul(h, A), k = n.mul(a, k), k = n.sub(k, H), H = n.mul(a, ee), P = n.mul(h, P), P = n.add(P, H), new g(k, L, P);
    }
    subtract(b) {
...
function lE(e) {
  const t = Q0, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), l = e * e * e % t, E = l * l * e % t, g = Tt(E, n, t) * E % t, C = Tt(g, n, t) * E % t, x = Tt(C, Vo, t) * l % t, v = Tt(x, s, t) * x % t, b = Tt(v, i, t) * v % t, R = Tt(b, c, t) * b % t, S = Tt(R, d, t) * R % t, Z = Tt(S, c, t) * b % t, T = Tt(Z, n, t) * E % t, j = Tt(T, o, t) * v % t, O = Tt(j, r, t) * l % t, k = Tt(O, Vo, t);
...
var GI = "https://fuellabs.github.io/block-explorer-v2", HI = (e, t) => `${{
  ...
  const g = E ? HI(
    l[0].key,
    l[0].value
  ) : "", C = /^\/|\/$/gm, x = n ? n.replace(C, "") : g, v = c.replace(C, ""), b = r == null ? void 0 : r.replace(C, ""), R = b ? encodeURIComponent(b) : void 0, S = v.match(/^https?:\/\//) ? "" : "https://", Z = b != null && b.match(/^https?:\/\//) ? "" : "https://";
...
var $I = (e) => {
  ...
  } = e, i = Q(s.gasPerByte), o = Q(s.gasPriceFactor), c = J(n), [d] = new On().decode(c, 0);
  if (d.type === vt.Mint)
    return {
      fee: Q(0),
      minFee: Q(0),
...
function sy(e) {
  return ty(e, [we.Coin, we.Message]);
}
function iy(e) {
...
function Mi(e) {
  ...
  }), { isStatusFailure: R, isStatusPending: S, isStatusSuccess: Z, blockId: T, status: j, time: O } = Dy(c), k = xy(n), L = vy(n);
  let P;
  return O && (P = zI(O)), {
    id: t,
    fee: b,
...
var Sy = (e, t) => {
  ...
  async estimateTxDependencies(e) {
    ...
    for (let n = 0; n < _y; n++) {
      ...
      t = r.map(fr);
      const { missingOutputVariables: s, missingOutputContractIds: i } = PI(t);
      if (s.length !== 0 || i.length !== 0)
        e.addVariableOutputs(s.length), i.forEach(({ contractId: c }) => {
          e.addContractInputAndOutput(fe.fromString(c));
        });
      else
        break;
    }
  ...
  async getTransactionCost(e, t = [], {
    ...
    const S = g ? U0(R) : v, Z = hr(
      ...
      E,
      c
    ).normalizeZeroToOne(), T = hr(v, E, c).normalizeZeroToOne(), j = hr(b, E, c).normalizeZeroToOne();
    return {
...
function qy(e, t) {
  ...
  if ((J(Me(r.slice(0, i / 8)))[0] & c) !== (r[r.length - 1] & c))
    throw new F(
      N.INVALID_CHECKSUM,
...
var Qn = class {
  ...
  static seedToExtendedKey(e, t = !1) {
    const n = Qn.masterKeysFromSeed(e), r = J(t ? zy : Ky), s = "0x00", i = "0x00000000", o = "0x00000000", c = n.slice(32), d = n.slice(0, 32), l = ie([
      r,
      s,
      i,
      o,
...
var er = class {
  ...
  deriveIndex(e) {
    ...
    s.set(Wt(e, 4), 33);
    const i = J(kr("sha512", r, s)), o = i.slice(0, 32), c = i.slice(32);
    if (t) {
  ...
  toExtendedKey(e = !1, t = !1) {
    ...
    const n = tB(this.privateKey == null || e, t), r = X(Uint8Array.from([this.depth])), s = this.parentFingerprint, i = oa(this.index, 4), o = this.chainCode, c = this.privateKey != null && !e ? ie(["0x00", this.privateKey]) : this.publicKey, d = J(ie([n, r, s, i, o, c]));
    return PA(d);
  }
  /**
...
var Eh = class {
  ...
  async fundWithRequiredCoins() {
    ...
    return this.setDefaultTxParams(e, r, n), e.outputs = i, this.transactionRequest.inputs = s.filter((c) => c.type !== we.Coin), await ((o = this.program.account) == null ? void 0 : o.fund(this.transactionRequest, this.requiredCoins, t)), this.transactionRequest.updatePredicateInputs(s), this.transactionRequest.outputs = this.transactionRequest.outputs.filter(
      (c) => c.type !== Ie.Contract
    ), this.transactionRequest.inputs.forEach((c, d) => {
      c.type === we.Contract && this.transactionRequest.outputs.push({ type: Ie.Contract, inputIndex: d });
    }), this;
  }
  /**
