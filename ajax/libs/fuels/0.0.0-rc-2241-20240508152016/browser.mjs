...
async function Ky(e, t, n) {
  const r = En(Pc(e), "hex"), s = Ae.fromAddressOrString(t), i = Zt(Qi), o = Ud({
    ...
    r: Lc,
    p: kc
  }), c = Zt($y), A = await $f(r, o, c), f = Uint8Array.from([...o.subarray(16, 32), ...A]), I = Gd(f), w = Cr(I, "hex"), C = {
    id: Am(),
    version: 3,
...
var bt, Qn, Yt, lo, K0, fo, eA, tA = class extends I0.EventEmitter {
  constructor(e) {
    super(), wn(this, lo), wn(this, fo), Fe(this, "storage", new hI()), Fe(this, "STORAGE_KEY", "WalletManager"), wn(this, bt, []), wn(this, Qn, ""), wn(this, Yt, !0), this.storage = (e == null ? void 0 : e.storage) || this.storage;
  }
  get isLocked() {
    return Se(this, Yt);
  }
