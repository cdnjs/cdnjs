...
let Zh = class extends qo {
  ...
  process(t, n) {
    ...
    for (let g = 16; g < 64; g++) {
      const C = pn[g - 15], x = pn[g - 2], F = nn(C, 7) ^ nn(C, 18) ^ C >>> 3, b = nn(x, 17) ^ nn(x, 19) ^ x >>> 10;
      pn[g] = b + pn[g - 7] + F + pn[g - 16] | 0;
    }
...
class Wo extends qo {
  ...
  // prettier-ignore
  get() {
    const { Ah: t, Al: n, Bh: r, Bl: s, Ch: i, Cl: o, Dh: c, Dl: d, Eh: l, El: I, Fh: g, Fl: C, Gh: x, Gl: F, Hh: b, Hl: D } = this;
    return [t, n, r, s, i, o, c, d, l, I, g, C, x, F, b, D];
  }
  // prettier-ignore
  set(t, n, r, s, i, o, c, d, l, I, g, C, x, F, b, D) {
    this.Ah = t | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = s | 0, this.Ch = i | 0, this.Cl = o | 0, this.Dh = c | 0, this.Dl = d | 0, this.Eh = l | 0, this.El = I | 0, this.Fh = g | 0, this.Fl = C | 0, this.Gh = x | 0, this.Gl = F | 0, this.Hh = b | 0, this.Hl = D | 0;
  }
  process(t, n) {
    ...
    let { Ah: r, Al: s, Bh: i, Bl: o, Ch: c, Cl: d, Dh: l, Dl: I, Eh: g, El: C, Fh: x, Fl: F, Gh: b, Gl: D, Hh: S, Hl: J } = this;
    for (let T = 0; T < 80; T++) {
      const j = Ae.rotrSH(g, C, 14) ^ Ae.rotrSH(g, C, 18) ^ Ae.rotrBH(g, C, 41), L = Ae.rotrSL(g, C, 14) ^ Ae.rotrSL(g, C, 18) ^ Ae.rotrBL(g, C, 41), k = g & x ^ ~g & b, M = C & F ^ ~C & D, P = Ae.add5L(J, L, M, ll[T], wn[T]), $ = Ae.add5H(P, S, j, k, hl[T], mn[T]), U = P | 0, H = Ae.rotrSH(r, s, 28) ^ Ae.rotrBH(r, s, 34) ^ Ae.rotrBH(r, s, 39), ee = Ae.rotrSL(r, s, 28) ^ Ae.rotrBL(r, s, 34) ^ Ae.rotrBL(r, s, 39), B = r & i ^ r & c ^ i & c, a = s & o ^ s & d ^ o & d;
      S = b | 0, J = D | 0, b = x | 0, D = F | 0, x = g | 0, F = C | 0, { h: g, l: C } = Ae.add(l | 0, I | 0, $ | 0, U | 0), l = c | 0, I = d | 0, c = i | 0, d = o | 0, i = r | 0, o = s | 0;
      const A = Ae.add3L(U, ee, a);
      r = Ae.add3H(A, $, H, B), s = A | 0;
    }
    ({ h: r, l: s } = Ae.add(this.Ah | 0, this.Al | 0, r | 0, s | 0)), { h: i, l: o } = Ae.add(this.Bh | 0, this.Bl | 0, i | 0, o | 0), { h: c, l: d } = Ae.add(this.Ch | 0, this.Cl | 0, c | 0, d | 0), { h: l, l: I } = Ae.add(this.Dh | 0, this.Dl | 0, l | 0, I | 0), { h: g, l: C } = Ae.add(this.Eh | 0, this.El | 0, g | 0, C | 0), { h: x, l: F } = Ae.add(this.Fh | 0, this.Fl | 0, x | 0, F | 0), { h: b, l: D } = Ae.add(this.Gh | 0, this.Gl | 0, b | 0, D | 0), { h: S, l: J } = Ae.add(this.Hh | 0, this.Hl | 0, S | 0, J | 0), this.set(r, s, i, o, c, d, l, I, g, C, x, F, b, D, S, J);
  }
  roundClean() {
    mn.fill(0), wn.fill(0);
  }
...
class Ll extends qo {
  ...
  process(t, n) {
    ...
    for (let x = 0; x < 5; x++) {
      const F = 4 - x, b = _l[x], D = kl[x], S = Ko[x], J = ea[x], T = Nl[x], j = Sl[x];
      for (let L = 0; L < 16; L++) {
        const k = ws(r + rc(x, i, c, l) + Es[S[L]] + b, T[L]) + g | 0;
        r = g, g = l, l = ws(c, 10) | 0, c = i, i = k;
      }
      for (let L = 0; L < 16; L++) {
        const k = ws(s + rc(F, o, d, I) + Es[J[L]] + D, j[L]) + C | 0;
...
let wu = class extends hf {
  ...
  process(t, n) {
    ...
    for (let g = 16; g < 64; g++) {
      const C = In[g - 15], x = In[g - 2], F = rn(C, 7) ^ rn(C, 18) ^ C >>> 3, b = rn(x, 17) ^ rn(x, 19) ^ x >>> 10;
      In[g] = b + In[g - 7] + F + In[g - 16] | 0;
    }
    let { A: r, B: s, C: i, D: o, E: c, F: d, G: l, H: I } = this;
    for (let g = 0; g < 64; g++) {
...
function Ac(e, t, n, r, s, i) {
  let o = e[t++] ^ n[r++], c = e[t++] ^ n[r++], d = e[t++] ^ n[r++], l = e[t++] ^ n[r++], I = e[t++] ^ n[r++], g = e[t++] ^ n[r++], C = e[t++] ^ n[r++], x = e[t++] ^ n[r++], F = e[t++] ^ n[r++], b = e[t++] ^ n[r++], D = e[t++] ^ n[r++], S = e[t++] ^ n[r++], J = e[t++] ^ n[r++], T = e[t++] ^ n[r++], j = e[t++] ^ n[r++], L = e[t++] ^ n[r++], k = o, M = c, P = d, $ = l, U = I, H = g, ee = C, B = x, a = F, A = b, h = D, m = S, f = J, E = T, y = j, p = L;
  for (let u = 0; u < 8; u += 2)
  ...
  s[i++] = o + k | 0, s[i++] = c + M | 0, s[i++] = d + P | 0, s[i++] = l + $ | 0, s[i++] = I + U | 0, s[i++] = g + H | 0, s[i++] = C + ee | 0, s[i++] = x + B | 0, s[i++] = F + a | 0, s[i++] = b + A | 0, s[i++] = D + h | 0, s[i++] = S + m | 0, s[i++] = J + f | 0, s[i++] = T + E | 0, s[i++] = j + y | 0, s[i++] = L + p | 0;
}
...
function Ef(e, t, n) {
  ...
  const F = Bu(Eu, e, t, { c: 1, dkLen: g * o }), b = Fs(F), D = Fs(new Uint8Array(g * s)), S = Fs(new Uint8Array(g));
  let J = () => {
  };
  if (I) {
  ...
  return { N: s, r: i, p: o, dkLen: c, blockSize32: C, V: D, B32: b, B: F, tmp: S, blockMixCb: J, asyncTick: d };
}
...
var Mg = class extends ie {
  ...
  static getCoderImpl(e, t = {
    ...
    if ((F = gg.exec(e.type)) == null ? void 0 : F.groups) {
      const b = s.map(
...
function hd(e) {
  ...
  function r(o, c) {
    ...
    for (let b = 0; b < C.length; ++b) {
      const D = C.charAt(b), S = dd[D];
      if (S === void 0)
        return "Unknown character " + D;
      x = Ar(x) ^ S, !(b + 6 >= C.length) && F.push(S);
    }
    return x !== t ? "Invalid checksum for " + o : { prefix: g, words: F };
  }
  function s(o, c) {
    const d = r(o, c);
    if (typeof d == "object")
...
class la extends Error {
  ...
  constructor(t, ...n) {
    ...
    this.source = c ?? (C == null || (s = C[0]) === null || s === void 0 ? void 0 : s.source), this.positions = d ?? (C == null ? void 0 : C.map((F) => F.start)), this.locations = d && c ? d.map((F) => Qo(c, F)) : C == null ? void 0 : C.map((F) => Qo(F.source, F.start));
    const x = sp(
...
function Dd() {
  return Jc || (Jc = 1, function(e) {
    ...
    var l = s(rp), I = l, g = Tp, C = qp, x = d(fa), F = As, b = Nt, D = us;
...
W.multiply = function(t) {
  ...
  var r = this.high >>> 16, s = this.high & 65535, i = this.low >>> 16, o = this.low & 65535, c = t.high >>> 16, d = t.high & 65535, l = t.low >>> 16, I = t.low & 65535, g = 0, C = 0, x = 0, F = 0;
  return F += o * I, x += F >>> 16, F &= 65535, x += i * I, C += x >>> 16, x &= 65535, x += o * l, C += x >>> 16, x &= 65535, C += s * I, g += C >>> 16, C &= 65535, C += i * l, g += C >>> 16, C &= 65535, C += o * d, g += C >>> 16, C &= 65535, g += r * I + s * l + i * d + o * c, g &= 65535, Re(x << 16 | F, g << 16 | C, this.unsigned);
};
W.mul = W.multiply;
W.divide = function(t) {
...
class cw extends sw {
  ...
  process(t, n) {
    ...
    for (let g = 16; g < 64; g++) {
      const C = Bn[g - 15], x = Bn[g - 2], F = sn(C, 7) ^ sn(C, 18) ^ C >>> 3, b = sn(x, 17) ^ sn(x, 19) ^ x >>> 10;
      Bn[g] = b + Bn[g - 7] + F + Bn[g - 16] | 0;
    }
    let { A: r, B: s, C: i, D: o, E: c, F: d, G: l, H: I } = this;
    for (let g = 0; g < 64; g++) {
  ...
  return function(c, d) {
    ...
    for (; !c.eql(C, c.ONE); ) {
      ...
      for (let b = c.sqr(C); x < l && !c.eql(b, c.ONE); x++)
        b = c.sqr(b);
      const F = c.pow(I, Ge << BigInt(l - x - 1));
      I = c.sqr(F), g = c.mul(g, F), C = c.mul(C, I), l = x;
    }
    return g;
  };
}
  ...
  return {
    ...
    wNAF(s, i, o) {
      ...
      for (let F = 0; F < c; F++) {
        ...
        let D = Number(o & g);
        o >>= x, D > d && (D -= C, o += eo);
        const S = b, J = b + Math.abs(D) - 1, T = F % 2 !== 0, j = D < 0;
...
BigInt(4);
function Lw(e) {
  const t = Sw(e), { Fp: n } = t, r = t.toBytes || ((F, b, D) => {
    const S = b.toAffine();
    return zr(Uint8Array.from([4]), n.toBytes(S.x), n.toBytes(S.y));
  }), s = t.fromBytes || ((F) => {
    const b = F.subarray(1), D = n.fromBytes(b.subarray(0, n.BYTES)), S = n.fromBytes(b.subarray(n.BYTES, 2 * n.BYTES));
    return { x: D, y: S };
  });
  function i(F) {
    const { a: b, b: D } = t, S = n.sqr(F), J = n.mul(S, F);
    return n.add(n.add(J, n.mul(F, b)), D);
  }
  if (!n.eql(n.sqr(t.Gy), i(t.Gx)))
    throw new Error("bad generator point: equation left != right");
  function o(F) {
    return typeof F == "bigint" && fn < F && F < t.n;
  }
  function c(F) {
    if (!o(F))
  ...
  function d(F) {
    ...
    if (b && typeof F != "bigint") {
      if (An(F) && (F = Br(F)), typeof F != "string" || !b.includes(F.length))
        throw new Error("Invalid key");
      F = F.padStart(D * 2, "0");
    }
    let T;
    try {
      T = typeof F == "bigint" ? F : jn(Wt("private key", F, D));
    } catch {
      throw new Error(`private key must be ${D} bytes, hex or bigint, not ${typeof F}`);
    }
  ...
  class g {
    ...
    double() {
      const { a: b, b: D } = t, S = n.mul(D, sA), { px: J, py: T, pz: j } = this;
...
function Ow(e) {
  ...
  function U(A, h, m = H) {
    ...
    function re(se) {
      ...
      return y && F(he) && (tn = b(he), pe ^= 1), new S(Ne, tn, pe);
    }
...
function Gw(e) {
  const t = s0, n = BigInt(3), r = BigInt(6), s = BigInt(11), i = BigInt(22), o = BigInt(23), c = BigInt(44), d = BigInt(88), l = e * e * e % t, I = l * l * e % t, g = Ut(I, n, t) * I % t, C = Ut(g, n, t) * I % t, x = Ut(C, _o, t) * l % t, F = Ut(x, s, t) * x % t, b = Ut(F, i, t) * F % t, D = Ut(b, c, t) * b % t, S = Ut(D, d, t) * D % t, J = Ut(S, c, t) * b % t, T = Ut(J, n, t) * I % t, j = Ut(T, o, t) * F % t, L = Ut(j, r, t) * l % t, k = Ut(L, _o, t);
...
function pI(e) {
  var n, r, s, i, o, c, d, l, I, g, C, x, F, b;
  ...
  switch (t) {
    ...
    case "MESSAGE_OUT": {
      const D = ve(e.sender), S = ve(e.recipient), J = ve(e.nonce), T = Q(e.amount), j = e.data ? Y(e.data) : Uint8Array.from([]), L = ve(e.digest), k = Ys.getMessageId({
        sender: D,
        recipient: S,
        nonce: J,
        amount: T,
    ...
    case "MINT": {
      const D = ve((F = e.contract) == null ? void 0 : F.id), S = ve(e.subId), J = jr.getAssetId(D, S);
      return {
        type: ue.Mint,
        subId: S,
        contractId: D,
    ...
    case "BURN": {
      const D = ve((b = e.contract) == null ? void 0 : b.id), S = ve(e.subId), J = yo.getAssetId(D, S);
      return {
        type: ue.Burn,
        subId: S,
        contractId: D,
...
var mI = "https://fuellabs.github.io/block-explorer-v2", wI = (e, t) => `${{
  ...
  const g = I ? wI(
    l[0].key,
    l[0].value
  ) : "", C = /^\/|\/$/gm, x = n ? n.replace(C, "") : g, F = c.replace(C, ""), b = r == null ? void 0 : r.replace(C, ""), D = b ? encodeURIComponent(b) : void 0, S = F.match(/^https?:\/\//) ? "" : "https://", J = b != null && b.match(/^https?:\/\//) ? "" : "https://";
  return `${S}${F}/${x}${D ? `?providerUrl=${J}${D}` : ""}`;
...
var QI = (e) => {
  ...
  const b = E0({
    ...
    metadataGas: x,
    txBytesSize: c.length
  }), D = Q((P = C.find((U) => U.type === $t.GasPrice)) == null ? void 0 : P.data), S = ($ = C.find((U) => U.type === $t.WitnessLimit)) == null ? void 0 : $.data, J = I.reduce((U, H) => U + H.dataLength, 0), T = Da({
    gasPerByte: i,
    minGas: b,
    witnessesLength: J,
    gasLimit: F,
  ...
  return PI(t).reduce((l, I) => {
    ...
    return g ? o.reduce((x, F) => {
      ...
      if (F.to === g.contractID) {
        const D = Ks(e, F.assetId);
        if (D) {
          const S = Kr(D), J = [], T = r == null ? void 0 : r[g.contractID];
          return T && J.push(
            RI({
              abi: T,
              receipt: F,
...
function Qi(e) {
  ...
  }), { isStatusFailure: D, isStatusPending: S, isStatusSuccess: J, blockId: T, status: j, time: L } = oy(c), k = ry(n), M = sy(n);
  let P;
  return L && (P = DI(L)), {
    id: t,
    fee: b,
...
var Ay = (e, t) => {
  ...
  async getTransactionCost(e, t = [], { estimateTxDependencies: n = !0, estimatePredicates: r = !0 } = {}) {
    const s = Ht(Wr(e)), i = this.getChain(), { gasPriceFactor: o, minGasPrice: c, maxGasPerTx: d } = this.getGasConfig(), l = Kl(s.gasPrice, c), I = s.type === vt.Script;
    s.hasPredicateInput() && r && (I && (s.gasLimit = Q(0)), await this.estimatePredicates(s));
    const g = s.calculateMinGas(i), C = s.calculateMaxGas(i, g), x = s.getCoinOutputsQuantities(), F = Ay(x, t);
    s.fundWithFakeUtxos(F);
    let b = g, D = [];
    I ? (s.gasPrice = Q(0), s.gasLimit = Q(d.sub(C).toNumber() * 0.9), D = (await this.call(s, {
...
async function t1(e) {
  ...
  return {
    transactions: i.map((C) => {
      const { node: x } = C, { id: F, rawPayload: b, receipts: D, status: S } = x, [J] = new Mn().decode(Y(b), 0), T = (D == null ? void 0 : D.map(lr)) || [], j = Qi({
        id: F,
        receipts: T,
        transaction: J,
...
var hy = (e) => {
  ...
  async withdrawToBaseLayer(t, n, r = {}) {
    const { minGasPrice: s } = this.provider.getGasConfig(), i = fe.fromAddressOrString(t), o = Y(
      ...
      ...o,
      ...c
    ]), gasPrice: s, ...r }, I = new hr(l), g = [{ amount: Q(n), assetId: Bt }], { requiredQuantities: C, maxFee: x, gasUsed: F } = await this.provider.getTransactionCost(
      I,
      g
    );
    return I.gasLimit = Q(l.gasLimit ?? F), this.validateGas({
      gasUsed: F,
      gasPrice: I.gasPrice,
      gasLimit: I.gasLimit,
      minGasPrice: s
...
async function py(e, t) {
  const n = JSON.parse(e), {
  ...
  } = n, g = Sn(s, "hex"), C = Sn(i, "hex"), x = Sn(I, "hex"), F = Sn(t), b = Ru({
    password: F,
    salt: x,
    n: c,
    p: l,
    r: d,
    dklen: o
  }), D = Uint8Array.from([...b.subarray(16, 32), ...g]), S = Nu(D), J = Or(S, "hex");
  if (r !== J)
    throw new v(
      R.INVALID_PASSWORD,
  ...
  (n) => {
    ...
    for (let b = 0; b < r; b += 1) {
      ...
      if (d.push({
        amountOffset: l,
        assetIdOffset: l + ne,
        gasForwardedOffset: D.gas ? l + ne + Yr : 0,
        callDataOffset: l + ne + Yr + S
      }), g.push(new _().encode(D.amount || 0)), g.push(new G().encode(((F = D.assetId) == null ? void 0 : F.toString()) || Bt)), g.push(D.contractId.toBytes()), g.push(new _().encode(D.fnSelector)), D.gas && (g.push(new _().encode(D.gas)), S = ne), D.isInputDataPointer) {
        const T = l + H0 + S;
