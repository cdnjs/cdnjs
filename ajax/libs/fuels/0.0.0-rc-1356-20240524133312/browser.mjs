...
const [dl, ul] = /* @__PURE__ */ Sc(Oc, !0), Ho = (e, t, n) => n > 32 ? Dc(e, t, n) : Qc(e, t, n), Zo = (e, t, n) => n > 32 ? Tc(e, t, n) : Nc(e, t, n);
function Al(e, t = 24) {
...
const ll = (e, t, n) => ys(() => new Ji(t, e, n)), fl = /* @__PURE__ */ ll(1, 136, 256 / 8), hl = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), Lc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), gl = /* @__PURE__ */ Lc.map((e) => (9 * e + 5) % 16);
let qi = [Lc], ji = [gl];
for (let e = 0; e < 4; e++)
  for (let t of [qi, ji])
...
].map((e) => new Uint8Array(e)), pl = /* @__PURE__ */ qi.map((e, t) => e.map((n) => kc[t][n])), ml = /* @__PURE__ */ ji.map((e, t) => e.map((n) => kc[t][n])), wl = /* @__PURE__ */ new Uint32Array([
  0,
  1518500249,
  1859775393,
  2400959708,
...
class Il extends Zi {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const R = 4 - v, C = wl[v], M = yl[v], F = qi[v], X = ji[v], k = pl[v], Z = ml[v];
      for (let O = 0; O < 16; O++) {
...
var Xl = Object.defineProperty, zl = (e, t, n) => t in e ? Xl(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Ki = (e, t, n) => (zl(e, typeof t != "symbol" ? t + "" : t, n), n), ce = class {
  constructor(e, t, n) {
    S(this, "name");
    S(this, "type");
...
}, Yl = "u8", Vl = "u16", Hl = "u32", Zl = "u64", Wl = "u256", Jl = "raw untyped ptr", ql = "raw untyped slice", jl = "bool", $l = "b256", Kl = "struct B512", gr = "enum Option", ef = "struct Vec", tf = "struct Bytes", nf = "struct String", rf = "str", Jc = /str\[(?<length>[0-9]+)\]/, gi = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, qc = /^struct (?<name>\w+)$/, jc = /^enum (?<name>\w+)$/, sf = /^\((?<items>.*)\)$/, of = /^generic (?<name>\w+)$/, os = "1", fe = 8, ln = 32, pi = ln + 2, as = ln, af = ln, cf = ln, df = fe * 4, uf = fe * 2, $c = 2 ** 32 - 1, Kc = ({ maxInputs: e }) => ln + // Tx ID
as + // Base asset ID
...
var mf = class extends ce {
...
}, _r = new WeakMap(), uc), Gn, Ac, wf = (Ac = class extends ce {
  constructor(t) {
  ...
  return n;
}, qo = (e, t) => t.filter((n) => _n(e, n.type).type !== "()"), If = (e) => {
  var r;
...
var Nn = (e, t) => {
  ...
  if (e.type === ef) {
    const v = If(r), R = new on(e.abi, v), C = Nn(R);
    return new wf(C);
  }
...
var hr = class {
  ...
  constructor(e, t) {
    ...
    S(this, "attributes");
    S(this, "jsonAbi");
    this.jsonAbi = e, this.jsonFn = yf(this.jsonAbi, t), this.name = t, this.signature = qr.getSignature(this.jsonAbi, this.jsonFn), this.selector = qr.getFunctionSelector(this.signature), this.selectorBytes = new eo().encode(t), this.encoding = cd(e.encoding), this.attributes = this.jsonFn.attributes ?? [];
  }
...
const Vf = (e, t, n) => e | (n ? Cs : pd) << BigInt(t), ao = (e) => (Pf << BigInt(e - 1)) - Cs, ti = (e) => new Uint8Array(e), Ba = (e) => Uint8Array.from(e);
function yd(e, t, n) {
...
const Rh = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  parseType: xh,
  parseValue: _h
}, Symbol.toStringTag, { value: "Module" })), Sh = /* @__PURE__ */ Pi(Rh);
function Qh(e) {
...
const Ph = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  print: Nd
}, Symbol.toStringTag, { value: "Module" })), Uh = /* @__PURE__ */ Pi(Ph);
...
var Vh = Ee && Ee.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Ao, "__esModule", { value: !0 });
var Fd = vs, Hh = Vh(Yh), Zh = Sr, Wh = function(e) {
  return Fd.isExtractableFile(e) || e !== null && typeof e == "object" && typeof e.pipe == "function";
};
function Jh(e, t, n, r) {
  r === void 0 && (r = Zh.defaultJsonSerializer);
  var s = Fd.extractFiles({ query: e, variables: t, operationName: n }, "", Wh), i = s.clone, o = s.files;
  if (o.size === 0) {
    if (!Array.isArray(e))
...
var Qr = {}, n0 = Ee && Ee.__extends || /* @__PURE__ */ function() {
  var e = function(t, n) {
...
function Md() {
  return Na || (Na = 1, function(e) {
    ...
    var h = s(Wf), b = h, I = Sh, _ = Uh, v = A(Ao), R = Sr, C = Et, M = Qr;
  ...
  */
  to_bytes() {
    try {
      ...
      var t = Fa()[s / 4 + 0], n = Fa()[s / 4 + 1], r = C0(t, n).slice();
...
lo();
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const gt = BigInt(0), ke = BigInt(1), En = BigInt(2), Q0 = BigInt(3), vi = BigInt(4), La = BigInt(5), ka = BigInt(8);
BigInt(9);
BigInt(16);
function It(e, t) {
  const n = e % t;
...
const { bytesToNumberBE: z0, hexToBytes: Y0 } = Zf, Cn = {
  ...
  toSig(e) {
    const { Err: t } = Cn, n = typeof e == "string" ? Y0(e) : e;
    if (!Gt(n))
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
const Zd = BigInt("0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f"), Ua = BigInt("0xfffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141"), q0 = BigInt(1), Ri = BigInt(2), Ga = (e, t) => (e + t / Ri) / t;
function j0(e) {
...
const Si = k0(Zd, void 0, void 0, { sqrt: j0 }), tn = J0({
  a: BigInt(0),
  // equation params: a, b
  b: BigInt(7),
  ...
  endo: {
    ...
    splitScalar: (e) => {
      const t = Ua, n = BigInt("0x3086d221a7d46bcde86c90e49284eb15"), r = -q0 * BigInt("0xe4437ed6010e88286f547fa90abfe4c3"), s = BigInt("0x114ca50f7a8e2f3f657c1108d9d44cfd8"), i = n, o = BigInt("0x100000000000000000000000000000000"), d = Ga(i * e, t), A = Ga(-r * e, t);
...
function hu(e, t) {
  ...
  const r = Ul(t), s = ie([r, new mn().encode(n)]);
  return mt(s);
}
var Jp = (e) => {
...
var Gm = "https://cdn.fuel.network/assets/", Xm = [
  ...
  const t = zm(e);
  await lo();
  const n = E0(16, 0, B0.ScriptData), r = Ta(17, 16, 32), s = _i(18, 17, 0), i = Ta(19, 17, 8), o = b0(16, 18, 19), d = Gd(1);
...
var Dn = class {
  ...
  constructor(e) {
    ...
    this.parentFingerprint = e.parentFingerprint || this.parentFingerprint, this.fingerprint = zi(Pl(mt(this.publicKey)), 0, 4), this.depth = e.depth || this.depth, this.index = e.index || this.index, this.chainCode = e.chainCode;
  }
  get extendedKey() {
...
var yt, bn, Lt, Mi, Nu, Oi, Du, Tu = class extends nu.EventEmitter {
  ...
  async loadState() {
    ...
    if (e) {
      const t = await Fl(Re(this, bn), JSON.parse(e));
