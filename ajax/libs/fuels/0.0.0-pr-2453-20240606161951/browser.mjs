...
const Wr = (e) => new DataView(e.buffer, e.byteOffset, e.byteLength), Ot = (e, t) => e << 32 - t | e >>> t, xd = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!xd)
...
class Od extends Wi {
  ...
  process(t, n) {
    ...
    for (let I = 0; I < 64; I++) {
      const _ = Ot(u, 6) ^ Ot(u, 11) ^ Ot(u, 25), v = E + _ + Td(u, A, h) + Md[I] + $t[I] | 0, B = (Ot(r, 2) ^ Ot(r, 13) ^ Ot(r, 22)) + Fd(r, s, i) | 0;
...
const Xd = (e, t) => BigInt(e >>> 0) << hi | BigInt(t >>> 0), zd = (e, t, n) => e >>> n, Yd = (e, t, n) => e << 32 - n | t >>> n, Vd = (e, t, n) => e >>> n | t << 32 - n, Hd = (e, t, n) => e << 32 - n | t >>> n, Zd = (e, t, n) => e << 64 - n | t >>> n - 32, Wd = (e, t, n) => e >>> n - 32 | t << 64 - n, Jd = (e, t) => t, qd = (e, t) => e, Qc = (e, t, n) => e << n | t >>> 32 - n, Nc = (e, t, n) => t << n | e >>> 32 - n, Dc = (e, t, n) => t << n - 32 | e >>> 64 - n, Tc = (e, t, n) => e << n - 32 | t >>> 64 - n;
function jd(e, t, n, r) {
  const s = (t >>> 0) + (r >>> 0);
...
const lA = (e, t, n) => Is(() => new qi(t, e, n)), fA = /* @__PURE__ */ lA(1, 136, 256 / 8), hA = /* @__PURE__ */ new Uint8Array([7, 4, 13, 1, 10, 6, 15, 3, 12, 0, 9, 5, 2, 14, 11, 8]), Lc = /* @__PURE__ */ Uint8Array.from({ length: 16 }, (e, t) => t), gA = /* @__PURE__ */ Lc.map((e) => (9 * e + 5) % 16);
let ji = [Lc], $i = [gA];
for (let e = 0; e < 4; e++)
  for (let t of [ji, $i])
...
class IA extends Wi {
  ...
  process(t, n) {
    ...
    for (let v = 0; v < 5; v++) {
      const R = 4 - v, B = wA[v], F = yA[v], M = ji[v], G = $i[v], L = pA[v], W = mA[v];
      for (let O = 0; O < 16; O++) {
...
const EA = /* @__PURE__ */ Is(() => new IA()), [bA, CA] = le.split([
  "0x428a2f98d728ae22",
  "0x7137449123ef65cd",
  "0xb5c0fbcfec4d3b2f",
  "0xe9b5dba58189dbbc",
...
class BA extends Wi {
  ...
  process(t, n) {
    ...
    for (let L = 0; L < 80; L++) {
      const W = le.rotrSH(I, _, 14) ^ le.rotrSH(I, _, 18) ^ le.rotrBH(I, _, 41), O = le.rotrSL(I, _, 14) ^ le.rotrSL(I, _, 18) ^ le.rotrBL(I, _, 41), T = I & v ^ ~I & B, k = _ & R ^ ~_ & F, U = le.add5L(G, O, k, CA[L], en[L]), q = le.add5H(U, M, W, T, bA[L], Kt[L]), V = U | 0, H = le.rotrSH(r, s, 28) ^ le.rotrBH(r, s, 34) ^ le.rotrBH(r, s, 39), ee = le.rotrSL(r, s, 28) ^ le.rotrBL(r, s, 34) ^ le.rotrBL(r, s, 39), b = r & i ^ r & u ^ i & u, a = s & o ^ s & A ^ o & A;
...
}, YA = "u8", VA = "u16", HA = "u32", ZA = "u64", WA = "u256", JA = "raw untyped ptr", qA = "raw untyped slice", jA = "bool", $A = "b256", KA = "struct B512", gr = "enum Option", el = "struct Vec", tl = "struct Bytes", nl = "struct String", rl = "str", Jc = /str\[(?<length>[0-9]+)\]/, pi = /\[(?<item>[\w\s\\[\]]+);\s*(?<length>[0-9]+)\]/, qc = /^struct (?<name>\w+)$/, jc = /^enum (?<name>\w+)$/, sl = /^\((?<items>.*)\)$/, il = /^generic (?<name>\w+)$/, os = "1", ge = 8, fn = 32, as = fn + 2, cs = fn, ol = fn, al = fn, cl = ge * 4, ul = ge * 2, $c = 2 ** 32 - 1, Kc = ({ maxInputs: e }) => fn + // Tx ID
cs + // Base asset ID
...
var fl = (e) => Object.values(e).every(
  ...
  decode(t, n) {
    ...
    return fl(this.coders) ? Ks(this, ws, s0).call(this, i, h) : [{ [i]: A }, h];
  }
...
var Tn = (e, t) => {
  ...
  if (e.type === el) {
    const v = yl(r), R = new on(e.abi, v), B = Tn(R);
    return new ml(B);
  }
...
var ur = (e) => e instanceof u0 ? e.address : e instanceof bl ? e.id : e, Rl = () => z(Tt(32)), Sl = (e) => {
  let t;
  try {
    if (!mi(e))
      throw new x(
...
const p0 = BigInt(0), Bs = BigInt(1), kl = BigInt(2);
function Gt(e) {
  return e instanceof Uint8Array || e != null && typeof e == "object" && e.constructor.name === "Uint8Array";
}
...
const Yl = (e, t, n) => e | (n ? Bs : p0) << BigInt(t), co = (e) => (kl << BigInt(e - 1)) - Bs, ni = (e) => new Uint8Array(e), _a = (e) => Uint8Array.from(e);
function y0(e, t, n) {
...
var F0 = xs, Hf = Vf(Yf), Zf = Sr, Wf = function(e) {
...
function M0() {
  return Da || (Da = 1, function(e) {
    ...
    var h = s(Zl), E = h, I = Sf, _ = Uf, v = A(lo), R = Sr, B = bt, F = Qr;
...
BigInt(4);
function Vh(e) {
  const t = Xh(e), { Fp: n } = t, r = t.toBytes || ((R, B, F) => {
    const M = B.toAffine();
...
function Au(e) {
  const { gasCosts: t, gasPerByte: n, inputs: r, metadataGas: s, txBytesSize: i } = e, o = An(i, t.vmInitialization), u = C(i).mul(n), A = Up(r, i, t);
...
Supported fuel-core version: ${r}.`
   ...
   */
  createOperations() {
    const e = Lt.getFetchFn(this.options), t = new ih.GraphQLClient(this.url, {
...
var Gm = "https://cdn.fuel.network/assets/", Xm = [
  ...
  async fund(t, n) {
    var M;
    const { addedSignatures: r, estimatedPredicates: s, requiredQuantities: i, updateMaxFee: o } = n, u = t.maxFee, A = this.provider.getBaseAssetId(), h = ((M = i.find((G) => G.assetId === A)) == null ? void 0 : M.amount) || C(0), E = vg({
      amount: C(u),
      assetId: A,
      coinQuantities: i
    }), I = {};
...
async function Zm(e, t, n) {
  const r = dn(ec(e), "hex"), s = de.fromAddressOrString(t), i = Tt(ci), o = Hc({
    ...
    r: $a,
    p: Ka
  }), u = Tt(Hm), A = await LA(r, o, u), h = Uint8Array.from([...o.subarray(16, 32), ...A]), E = Zc(h), I = cr(E, "hex"), _ = {
    id: ng(),
    version: 3,
...
var Fn = class {
  ...
  static fromExtendedKey(e) {
    const t = z(Wt(Cd(e))), n = Y(t), r = rc(n.slice(0, 78)) === e;
    if (n.length !== 82 || !ow(n))
...
var Cw = (e) => e === ue.Return || e === ue.ReturnData, Bw = (e, t) => e.find(
  ...
  (n) => {
    ...
    const E = [];
    for (let R = 0; R < r; R += 1) {
      const B = n[R], F = h, M = F + ge, G = M + cs, L = G + ol + ge + ge, W = L + B.fnSelectorBytes.byteLength, O = Y(B.data);
      let T = 0;
