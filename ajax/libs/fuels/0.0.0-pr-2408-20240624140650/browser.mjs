...
(function(e) {
  (function(t, n) {
    ...
    var G = function(a, u, l) {
      var p = a.words, f = u.words, y = l.words, I = 0, g, d, m, X = p[0] | 0, J = X & 8191, K = X >>> 13, j = p[1] | 0, re = j & 8191, se = j >>> 13, Se = p[2] | 0, fe = Se & 8191, oe = Se >>> 13, _e = p[3] | 0, Ae = _e & 8191, he = _e >>> 13, Ft = p[4] | 0, ve = Ft & 8191, ye = Ft >>> 13, cr = p[5] | 0, Qe = cr & 8191, Te = cr >>> 13, Pr = p[6] | 0, Pe = Pr & 8191, Ue = Pr >>> 13, Vo = p[7] | 0, Ge = Vo & 8191, Ve = Vo >>> 13, zo = p[8] | 0, ze = zo & 8191, He = zo >>> 13, Ho = p[9] | 0, Ye = Ho & 8191, Xe = Ho >>> 13, Yo = f[0] | 0, We = Yo & 8191, Ze = Yo >>> 13, Xo = f[1] | 0, Je = Xo & 8191, qe = Xo >>> 13, Wo = f[2] | 0, je = Wo & 8191, $e = Wo >>> 13, Zo = f[3] | 0, Ke = Zo & 8191, et = Zo >>> 13, Jo = f[4] | 0, tt = Jo & 8191, nt = Jo >>> 13, qo = f[5] | 0, rt = qo & 8191, st = qo >>> 13, jo = f[6] | 0, it = jo & 8191, ot = jo >>> 13, $o = f[7] | 0, at = $o & 8191, ct = $o >>> 13, Ko = f[8] | 0, ut = Ko & 8191, dt = Ko >>> 13, ea = f[9] | 0, At = ea & 8191, lt = ea >>> 13;
...
const hA = (e, t, n) => (e >>> 0) + (t >>> 0) + (n >>> 0), gA = (e, t, n, r) => t + n + r + (e / 2 ** 32 | 0) | 0, pA = (e, t, n, r) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0), mA = (e, t, n, r, s) => t + n + r + s + (e / 2 ** 32 | 0) | 0, wA = (e, t, n, r, s) => (e >>> 0) + (t >>> 0) + (n >>> 0) + (r >>> 0) + (s >>> 0), yA = (e, t, n, r, s, i) => t + n + r + s + i + (e / 2 ** 32 | 0) | 0, le = {
  ...
  add5H: yA,
  add5L: wA
}, [Xc, Wc, Zc] = [[], [], []], IA = /* @__PURE__ */ BigInt(0), ur = /* @__PURE__ */ BigInt(1), bA = /* @__PURE__ */ BigInt(2), EA = /* @__PURE__ */ BigInt(7), CA = /* @__PURE__ */ BigInt(256), BA = /* @__PURE__ */ BigInt(113);
for (let e = 0, t = ur, n = 1, r = 0; e < 24; e++) {
  [n, r] = [r, (2 * n + 3 * r) % 5], Xc.push(2 * (5 * r + n)), Wc.push((e + 1) * (e + 2) / 2 % 64);
  let s = IA;
  for (let i = 0; i < 7; i++)
    t = (t << ur ^ (t >> EA) * BA) % CA, t & bA && (s ^= ur << (ur << /* @__PURE__ */ BigInt(i)) - ur);
  Zc.push(s);
}
...
ge, aa = (e) => e instanceof Uint8Array, sr = (e) => {
  ...
  for (const n of t)
    if (n.type === Zn || "coder" in n && n.coder.type === Zn || "coders" in n && sr(n.coders))
      return !0;
  return !1;
}, _r, Ic, we = (Ic = class extends ce {
  constructor(t, n) {
    super("array", `[${t.type}; ${n}]`, n * t.encodedLength);
    S(this, "coder");
    S(this, "length");
    Bt(this, _r, void 0);
    this.coder = t, this.length = n, Mt(this, _r, sr([t]));
  }
  encode(t) {
    if (!Array.isArray(t))
  ...
  decode(t, n) {
    if (!Fe(this, _r) && t.length < this.encodedLength || t.length > d0)
...
}, _r = new WeakMap(), Ic), V = class extends ce {
  constructor() {
...
Ao(f0, "memorySize", 1);
var Rn, vr, zn, Bs, g0, xs, p0, _s, m0, bc, h0 = (bc = class extends ce {
  constructor(t, n) {
    ...
    Bt(this, vr, void 0);
    Bt(this, zn, void 0);
    this.name = t, this.coders = n, Mt(this, Rn, r), Mt(this, vr, s), Mt(this, zn, !(this.type === Zn || sr(n)));
  }
  encode(t) {
...
}, Rn = new WeakMap(), vr = new WeakMap(), zn = new WeakMap(), Bs = new WeakSet(), g0 = function(t) {
...
var Nl = class extends ce {
  ...
  constructor(t, n) {
    ...
    S(this, "coders");
    Bt(this, Rr, void 0);
    this.name = t, this.coders = n, Mt(this, Rr, sr(n));
  }
  encode(t) {
    return vs(
...
}, Rr = new WeakMap(), Ec), Sr, Cc, I0 = (Cc = class extends ce {
  constructor(t) {
    const n = t.reduce((r, s) => r + s.encodedLength, 0);
    super("tuple", `(${t.map((r) => r.type).join(", ")})`, n);
    S(this, "coders");
    Bt(this, Sr, void 0);
    this.coders = t, Mt(this, Sr, sr(t));
  }
  encode(t) {
...
}, Sr = new WeakMap(), Cc), Hn, Bc, Dl = (Bc = class extends ce {
  constructor(t) {
...
var hr = (e) => e instanceof E0 ? e.address : e instanceof Ol ? e.id : e, zl = () => z(Tt(32)), Hl = (e) => {
  let t;
  try {
    if (!_i(e))
      throw new v(
...
function mo(e) {
  return Nr(e), po(jn(Uint8Array.from(e).reverse()));
}
function Kn(e, t) {
...
var W0 = Fs, ah = oh(ih), ch = Fr, uh = function(e) {
...
function yh() {
  ...
  var r = Mr, s = Z0(), i = "connection_init", o = "connection_ack", c = "ping", A = "pong", h = "subscribe", b = "next", w = "error", x = "complete", _ = (
    /** @class */
    function() {
      function L(T, k, U) {
...
function Z0() {
  return za || (za = 1, function(e) {
    ...
    var h = s(uf), b = h, w = Hf, x = th, _ = A(Eo), R = Fr, C = Et, F = Mr;
...
function Vh(e, t) {
  return Q = e.exports, tu.__wbindgen_wasm_module = t, mr = null, pr = null, Q;
}
async function tu(e) {
  if (Q !== void 0)
    return Q;
...
${Fh}#variant.${e}`), { errorMessage: t, reason: e };
}, lr = (e) => JSON.stringify(e, null, 2), mm = (e, t) => {
  ...
  if (r)
    switch (B(r.val).toHex()) {
      case Sh: {
        s = "require", n = `The transaction reverted because a "require" statement has thrown ${t.length ? lr(t[0]) : "an error."}.`;
        break;
      }
      case Qh: {
        const o = t.length >= 2 ? ` comparing ${lr(t[1])} and ${lr(t[0])}.` : ".";
...
}, ar = (e) => e.type === Ce.Coin, Do = (e) => e.type === Ce.Message, gn = (e) => ar(e) || Do(e), Qu = (e) => ar(e) ? e.owner : e.recipient, Vi = (e, t) => Qu(e) === t.toB256(), ym = (e, t, n) => e.filter(gn).reduce((r, s) => ar(s) && s.assetId === t || Do(s) && t === n ? r.add(s.amount) : r, B(0)), Yy = (e) => e.filter(gn).reduce(
  ...
  (n, r) => (ar(r) && r.owner === t.toB256() ? n.utxos.push(r.id) : Do(r) && r.recipient === t.toB256() && n.messages.push(r.nonce), n),
  {
    utxos: [],
    messages: []
  }
...
`)
  ...
  async getBlocks(e) {
    ...
    } = await this.operations.getBlocks(e);
...
async function Iw(e, t, n) {
  const r = fn(lc(e), "hex"), s = de.fromAddressOrString(t), i = Tt(mi), o = s0({
    ...
    r: dc,
    p: Ac
  }), c = Tt(yw), A = await KA(r, o, c), h = Uint8Array.from([...o.subarray(16, 32), ...A]), b = i0(h), w = fr(b, "hex"), x = {
    id: Ng(),
    version: 3,
...
async function bw(e, t) {
  const n = JSON.parse(e), {
    ...
    r: A,
    dklen: o
  }), F = Uint8Array.from([...C.subarray(16, 32), ...w]), M = i0(F), G = fr(M, "hex");
  if (r !== G)
    throw new v(
      N.INVALID_PASSWORD,
...
var zw = 2e3, Hw = 5e3, { warn: Yw } = console, wr = class extends Uw {
  ...
  async selectConnector(t, n = {
    ...
    return s ? (this._currentConnector = r, this.emit(this.events.currentConnector, r), this.setupConnectorEvents(Object.values(Uo)), await ((o = this._storage) == null ? void 0 : o.setItem(wr.STORAGE_KEY, r.name)), n.emitEvents && this.triggerConnectorEvents(), !0) : !1;
  }
  /**
