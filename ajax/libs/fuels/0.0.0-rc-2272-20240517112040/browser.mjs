...
}, Ry = 9, Sy = 3, Qy = 9, Ny = 9, Dy = 18, Ty = 15, Fy = 12, My = 9, Ac, Oy = typeof process < "u" && ((Ac = process == null ? void 0 : process.env) == null ? void 0 : Ac.FUEL_NETWORK_URL) || "http://127.0.0.1:4000/v1/graphql", Ly = "https://devnet.fuel.network/v1/graphql";
export {
  os as ASSET_ID_LEN,
  ...
  Ly as FUEL_TESTNET_NETWORK_URL,
  Mu as Fuel,
  lw as FuelConnector,
