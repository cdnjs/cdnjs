...
var DiffContext=require("../contexts/diff").DiffContext,PatchContext=require("../contexts/patch").PatchContext,ReverseContext=require("../contexts/reverse").ReverseContext,lcs=require("./lcs"),ARRAY_MOVE=3,isArray="function"==typeof Array.isArray?Array.isArray:function(e){return e instanceof Array},arrayIndexOf="function"==typeof Array.prototype.indexOf?function(e,r){return e.indexOf(r)}:function(e,r){for(var t=e.length,i=0;t>i;i++)if(e[i]===r)return i;return-1},diffFilter=function(e){if(e.leftIsArray){for(var r,t,i,n,a=e.options&&e.options.objectHash,l=function(e,r,t,i,n){var l=e[t],s=r[i];if(l===s)return!0;if("object"!=typeof l||"object"!=typeof s)return!1;if(!a)return!1;var o,f;return"number"==typeof t?(n.hashCache1=n.hashCache1||[],o=n.hashCache1[t],"undefined"==typeof o&&(n.hashCache1[t]=o=a(l,t))):o=a(l),"undefined"==typeof o?!1:("number"==typeof i?(n.hashCache2=n.hashCache2||[],f=n.hashCache2[i],"undefined"==typeof f&&(n.hashCache2[i]=f=a(s,i))):f=a(s),"undefined"==typeof f?!1:o===f)},s={},o=0,f=0,c=e.left,h=e.right,d=c.length,u=h.length;d>o&&u>o&&l(c,h,o,o,s);)r=o,n=new DiffContext(e.left[r],e.right[r]),e.push(n,r),o++;for(;d>f+o&&u>f+o&&l(c,h,d-1-f,u-1-f,s);)t=d-1-f,i=u-1-f,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),f++;var v;if(o+f===d){if(d===u)return void e.setResult(void 0).exit();for(v=v||{_t:"a"},r=o;u-f>r;r++)v[r]=[h[r]];return void e.setResult(v).exit()}if(o+f===u){for(v=v||{_t:"a"},r=o;d-f>r;r++)v["_"+r]=[c[r],0,0];return void e.setResult(v).exit()}s={};var p=c.slice(o,d-f),y=h.slice(o,u-f),x=lcs.get(p,y,l,s),C=[];for(v=v||{_t:"a"},r=o;d-f>r;r++)arrayIndexOf(x.indices1,r-o)<0&&(v["_"+r]=[c[r],0,0],C.push(r));var R=!0;e.options&&e.options.arrays&&e.options.arrays.detectMove===!1&&(R=!1);var A=!1;e.options&&e.options.arrays&&e.options.arrays.includeValueOnMove&&(A=!0);var _=C.length;for(r=o;u-f>r;r++){var m=arrayIndexOf(x.indices2,r-o);if(0>m){var F=!1;if(R&&_>0)for(var g=0;_>g;g++)if(t=C[g],l(p,y,t-o,r-o,s)){v["_"+t].splice(1,2,r,ARRAY_MOVE),A||(v["_"+t][0]=""),i=r,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),C.splice(g,1),F=!0;break}F||(v[r]=[h[r]])}else t=x.indices1[m]+o,i=x.indices2[m]+o,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i)}e.setResult(v).exit()}};diffFilter.filterName="arrays";var compare={numerically:function(e,r){return e-r},numericallyBy:function(e){return function(r,t){return r[e]-t[e]}}},patchFilter=function(e){if(e.nested&&"a"===e.delta._t){var r,t,i=e.delta,n=e.left,a=[],l=[],s=[];for(r in i)if("_t"!==r)if("_"===r[0]){if(0!==i[r][2]&&i[r][2]!==ARRAY_MOVE)throw new Error("only removal or move can be applied at original array indices, invalid diff type: "+i[r][2]);a.push(parseInt(r.slice(1),10))}else 1===i[r].length?l.push({index:parseInt(r,10),value:i[r][0]}):s.push({index:parseInt(r,10),delta:i[r]});for(a=a.sort(compare.numerically),r=a.length-1;r>=0;r--){t=a[r];var o=i["_"+t],f=n.splice(t,1)[0];o[2]===ARRAY_MOVE&&l.push({index:o[1],value:f})}l=l.sort(compare.numericallyBy("index"));var c=l.length;for(r=0;c>r;r++){var h=l[r];n.splice(h.index,0,h.value)}var d,u=s.length;if(u>0)for(r=0;u>r;r++){var v=s[r];d=new PatchContext(e.left[v.index],v.delta),e.push(d,v.index)}return e.children?void e.exit():void e.setResult(e.left).exit()}};patchFilter.filterName="arrays";var collectChildrenPatchFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i=0;t>i;i++)r=e.children[i],e.left[r.childName]=r.result;e.setResult(e.left).exit()}};collectChildrenPatchFilter.filterName="arraysCollectChildren";var reverseFilter=function(e){if(!e.nested)return void(e.delta[2]===ARRAY_MOVE&&(e.newName="_"+e.delta[1],e.setResult([e.delta[0],parseInt(e.childName.substr(1),10),ARRAY_MOVE]).exit()));if("a"===e.delta._t){var r,t;for(r in e.delta)"_t"!==r&&(t=new ReverseContext(e.delta[r]),e.push(t,r));e.exit()}};reverseFilter.filterName="arrays";var reverseArrayDeltaIndex=function(e,r,t){var i=r;if("string"==typeof r&&"_"===r[0])i=parseInt(r.substr(1),10);else{var n="_"+r;if(isArray(t)&&0===t[2])i=n;else for(var a in e){var l=e[a];isArray(l)&&l[2]===ARRAY_MOVE&&l[1].toString()===r&&(i=a.substr(1))}}return i},collectChildrenReverseFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i={_t:"a"},n=0;t>n;n++){r=e.children[n];var a=r.newName;"undefined"==typeof a&&(a=reverseArrayDeltaIndex(e.delta,r.childName,r.result)),i[a]!==r.result&&(i[a]=r.result)}e.setResult(i).exit()}};collectChildrenReverseFilter.filterName="arraysCollectChildren",exports.diffFilter=diffFilter,exports.patchFilter=patchFilter,exports.collectChildrenPatchFilter=collectChildrenPatchFilter,exports.reverseFilter=reverseFilter,exports.collectChildrenReverseFilter=collectChildrenReverseFilter;
