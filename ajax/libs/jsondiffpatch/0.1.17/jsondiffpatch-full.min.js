...
(function(e){e.env.browser&&(window.diff_match_patch=require("../public/external/diff_match_patch_uncompressed")),module.exports=require("./main")}).call(this,require("_process"));
