...
var DiffContext=require("../contexts/diff").DiffContext,PatchContext=require("../contexts/patch").PatchContext,ReverseContext=require("../contexts/reverse").ReverseContext,lcs=require("./lcs"),ARRAY_MOVE=3,isArray="function"==typeof Array.isArray?Array.isArray:function(e){return e instanceof Array},arrayIndexOf="function"==typeof Array.prototype.indexOf?function(e,r){return e.indexOf(r)}:function(e,r){for(var t=e.length,i=0;t>i;i++)if(e[i]===r)return i;return-1},diffFilter=function(e){if(e.leftIsArray){for(var r,t,i,n,a=e.options&&e.options.objectHash,l=function(e,r,t,i,n){var l=e[t],s=r[i];if(l===s)return!0;if("object"!=typeof l||"object"!=typeof s)return!1;if(!a)return!1;var f,o;return"number"==typeof t?(n.hashCache1=n.hashCache1||[],f=n.hashCache1[t],"undefined"==typeof f&&(n.hashCache1[t]=f=a(l,t))):f=a(l),"undefined"==typeof f?!1:("number"==typeof i?(n.hashCache2=n.hashCache2||[],o=n.hashCache2[i],"undefined"==typeof o&&(n.hashCache2[i]=o=a(s,i))):o=a(s),"undefined"==typeof o?!1:f===o)},s={},f=0,o=0,c=e.left,h=e.right,d=c.length,u=h.length;d>f&&u>f&&l(c,h,f,f,s);)r=f,n=new DiffContext(e.left[r],e.right[r]),e.push(n,r),f++;for(;d>o+f&&u>o+f&&l(c,h,d-1-o,u-1-o,s);)t=d-1-o,i=u-1-o,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),o++;var p;if(f+o===d){if(d===u)return void e.setResult(void 0).exit();for(p=p||{_t:"a"},r=f;u-o>r;r++)p[r]=[h[r]];return void e.setResult(p).exit()}if(f+o===u){for(p=p||{_t:"a"},r=f;d-o>r;r++)p["_"+r]=[c[r],0,0];return void e.setResult(p).exit()}s={};var v=c.slice(f,d-o),y=h.slice(f,u-o),x=lcs.get(v,y,l,s),C=[];for(p=p||{_t:"a"},r=f;d-o>r;r++)arrayIndexOf(x.indices1,r-f)<0&&(p["_"+r]=[c[r],0,0],C.push(r));var R=!0;e.options&&e.options.arrays&&e.options.arrays.detectMove===!1&&(R=!1);var A=!1;e.options&&e.options.arrays&&e.options.arrays.includeValueOnMove&&(A=!0);var _=C.length;for(r=f;u-o>r;r++){var g=arrayIndexOf(x.indices2,r-f);if(0>g){var m=!1;if(R&&_>0)for(var F=0;_>F;F++)if(t=C[F],l(v,y,t-f,r-f,s)){p["_"+t].splice(1,2,r,ARRAY_MOVE),A||(p["_"+t][0]=""),i=r,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),C.splice(F,1),m=!0;break}m||(p[r]=[h[r]])}else t=x.indices1[g]+f,i=x.indices2[g]+f,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i)}e.setResult(p).exit()}};diffFilter.filterName="arrays";var compare={numerically:function(e,r){return e-r},numericallyBy:function(e){return function(r,t){return r[e]-t[e]}}},patchFilter=function(e){if(e.nested&&"a"===e.delta._t){var r,t,i=e.delta,n=e.left,a=[],l=[],s=[];for(r in i)if("_t"!==r)if("_"===r[0]){if(0!==i[r][2]&&i[r][2]!==ARRAY_MOVE)throw new Error("only removal or move can be applied at original array indices, invalid diff type: "+i[r][2]);a.push(parseInt(r.slice(1),10))}else 1===i[r].length?l.push({index:parseInt(r,10),value:i[r][0]}):s.push({index:parseInt(r,10),delta:i[r]});for(a=a.sort(compare.numerically),r=a.length-1;r>=0;r--){t=a[r];var f=i["_"+t],o=n.splice(t,1)[0];f[2]===ARRAY_MOVE&&l.push({index:f[1],value:o})}l=l.sort(compare.numericallyBy("index"));var c=l.length;for(r=0;c>r;r++){var h=l[r];n.splice(h.index,0,h.value)}var d,u=s.length;if(u>0)for(r=0;u>r;r++){var p=s[r];d=new PatchContext(e.left[p.index],p.delta),e.push(d,p.index)}return e.children?void e.exit():void e.setResult(e.left).exit()}};patchFilter.filterName="arrays";var collectChildrenPatchFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i=0;t>i;i++)r=e.children[i],e.left[r.childName]=r.result;e.setResult(e.left).exit()}};collectChildrenPatchFilter.filterName="arraysCollectChildren";var reverseFilter=function(e){if(!e.nested)return void(e.delta[2]===ARRAY_MOVE&&(e.newName="_"+e.delta[1],e.setResult([e.delta[0],parseInt(e.childName.substr(1),10),ARRAY_MOVE]).exit()));if("a"===e.delta._t){var r,t;for(r in e.delta)"_t"!==r&&(t=new ReverseContext(e.delta[r]),e.push(t,r));e.exit()}};reverseFilter.filterName="arrays";var reverseArrayDeltaIndex=function(e,r,t){var i,n=r;if("string"==typeof r&&"_"===r[0])n=parseInt(r.substr(1),10);else{var a="_"+r;if(isArray(t)&&0===t[2])n=a;else for(var l in e){var s=e[l];if(isArray(s))if(s[2]===ARRAY_MOVE){if(s[1].toString()===r){n=l.substr(1);break}}else 0===s[2]&&"string"==typeof l?(i=parseInt(l.substr(1),10),n>=i&&n++):1===s.length&&n>=l&&n--}}return n},collectChildrenReverseFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i={_t:"a"},n=0;t>n;n++){r=e.children[n];var a=r.newName;"undefined"==typeof a&&(a=reverseArrayDeltaIndex(e.delta,r.childName,r.result)),i[a]!==r.result&&(i[a]=r.result)}e.setResult(i).exit()}};collectChildrenReverseFilter.filterName="arraysCollectChildren",exports.diffFilter=diffFilter,exports.patchFilter=patchFilter,exports.collectChildrenPatchFilter=collectChildrenPatchFilter,exports.reverseFilter=reverseFilter,exports.collectChildrenReverseFilter=collectChildrenReverseFilter;
