...
var DiffContext=require("../contexts/diff").DiffContext,PatchContext=require("../contexts/patch").PatchContext,ReverseContext=require("../contexts/reverse").ReverseContext,lcs=require("./lcs"),ARRAY_MOVE=3,isArray="function"==typeof Array.isArray?Array.isArray:function(e){return e instanceof Array},arrayIndexOf="function"==typeof Array.prototype.indexOf?function(e,r){return e.indexOf(r)}:function(e,r){for(var t=e.length,i=0;t>i;i++)if(e[i]===r)return i;return-1},diffFilter=function(e){if(e.leftIsArray){for(var r,t,i,n,a=e.options&&e.options.objectHash,l=function(e,r,t,i,n){var l=e[t],s=r[i];if(l===s)return!0;if("object"!=typeof l||"object"!=typeof s)return!1;if(!a)return!1;var f,o;return"number"==typeof t?(n.hashCache1=n.hashCache1||[],f=n.hashCache1[t],"undefined"==typeof f&&(n.hashCache1[t]=f=a(l,t))):f=a(l),"undefined"==typeof f?!1:("number"==typeof i?(n.hashCache2=n.hashCache2||[],o=n.hashCache2[i],"undefined"==typeof o&&(n.hashCache2[i]=o=a(s,i))):o=a(s),"undefined"==typeof o?!1:f===o)},s={},f=0,o=0,c=e.left,h=e.right,u=c.length,d=h.length;u>f&&d>f&&l(c,h,f,f,s);)r=f,n=new DiffContext(e.left[r],e.right[r]),e.push(n,r),f++;for(;u>o+f&&d>o+f&&l(c,h,u-1-o,d-1-o,s);)t=u-1-o,i=d-1-o,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),o++;var v;if(f+o===u){if(u===d)return void e.setResult(void 0).exit();for(v=v||{_t:"a"},r=f;d-o>r;r++)v[r]=[h[r]];return void e.setResult(v).exit()}if(f+o===d){for(v=v||{_t:"a"},r=f;u-o>r;r++)v["_"+r]=[c[r],0,0];return void e.setResult(v).exit()}s={};var p=c.slice(f,u-o),y=h.slice(f,d-o),x=lcs.get(p,y,l,s),C=[];for(v=v||{_t:"a"},r=f;u-o>r;r++)arrayIndexOf(x.indices1,r-f)<0&&(v["_"+r]=[c[r],0,0],C.push(r));var R=!0;e.options&&e.options.arrays&&e.options.arrays.detectMove===!1&&(R=!1);var A=!1;e.options&&e.options.arrays&&e.options.arrays.includeValueOnMove&&(A=!0);var _=C.length;for(r=f;d-o>r;r++){var m=arrayIndexOf(x.indices2,r-f);if(0>m){var F=!1;if(R&&_>0)for(var g=0;_>g;g++)if(t=C[g],l(p,y,t-f,r-f,s)){v["_"+t].splice(1,2,r,ARRAY_MOVE),A||(v["_"+t][0]=""),i=r,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i),C.splice(g,1),F=!0;break}F||(v[r]=[h[r]])}else t=x.indices1[m]+f,i=x.indices2[m]+f,n=new DiffContext(e.left[t],e.right[i]),e.push(n,i)}e.setResult(v).exit()}};diffFilter.filterName="arrays";var compare={numerically:function(e,r){return e-r},numericallyBy:function(e){return function(r,t){return r[e]-t[e]}}},patchFilter=function(e){if(e.nested&&"a"===e.delta._t){var r,t,i=e.delta,n=e.left,a=[],l=[],s=[];for(r in i)if("_t"!==r)if("_"===r[0]){if(0!==i[r][2]&&i[r][2]!==ARRAY_MOVE)throw new Error("only removal or move can be applied at original array indices, invalid diff type: "+i[r][2]);a.push(parseInt(r.slice(1),10))}else 1===i[r].length?l.push({index:parseInt(r,10),value:i[r][0]}):s.push({index:parseInt(r,10),delta:i[r]});for(a=a.sort(compare.numerically),r=a.length-1;r>=0;r--){t=a[r];var f=i["_"+t],o=n.splice(t,1)[0];f[2]===ARRAY_MOVE&&l.push({index:f[1],value:o})}l=l.sort(compare.numericallyBy("index"));var c=l.length;for(r=0;c>r;r++){var h=l[r];n.splice(h.index,0,h.value)}var u,d=s.length;if(d>0)for(r=0;d>r;r++){var v=s[r];u=new PatchContext(e.left[v.index],v.delta),e.push(u,v.index)}return e.children?void e.exit():void e.setResult(e.left).exit()}};patchFilter.filterName="arrays";var collectChildrenPatchFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i=0;t>i;i++)r=e.children[i],e.left[r.childName]=r.result;e.setResult(e.left).exit()}};collectChildrenPatchFilter.filterName="arraysCollectChildren";var reverseFilter=function(e){if(!e.nested)return void(e.delta[2]===ARRAY_MOVE&&(e.newName="_"+e.delta[1],e.setResult([e.delta[0],parseInt(e.childName.substr(1),10),ARRAY_MOVE]).exit()));if("a"===e.delta._t){var r,t;for(r in e.delta)"_t"!==r&&(t=new ReverseContext(e.delta[r]),e.push(t,r));e.exit()}};reverseFilter.filterName="arrays";var reverseArrayDeltaIndex=function(e,r,t){if("string"==typeof r&&"_"===r[0])return parseInt(r.substr(1),10);if(isArray(t)&&0===t[2])return"_"+r;var i=+r;for(var n in e){var a=e[n];if(isArray(a))if(a[2]===ARRAY_MOVE){var l=parseInt(n.substr(1),10),s=a[1];if(s===+r)return l;i>=l&&s>i?i++:l>=i&&i>s&&i--}else if(0===a[2]){var f=parseInt(n.substr(1),10);i>=f&&i++}else 1===a.length&&i>=n&&i--}return i},collectChildrenReverseFilter=function(e){if(e&&e.children&&"a"===e.delta._t){for(var r,t=e.children.length,i={_t:"a"},n=0;t>n;n++){r=e.children[n];var a=r.newName;"undefined"==typeof a&&(a=reverseArrayDeltaIndex(e.delta,r.childName,r.result)),i[a]!==r.result&&(i[a]=r.result)}e.setResult(i).exit()}};collectChildrenReverseFilter.filterName="arraysCollectChildren",exports.diffFilter=diffFilter,exports.patchFilter=patchFilter,exports.collectChildrenPatchFilter=collectChildrenPatchFilter,exports.reverseFilter=reverseFilter,exports.collectChildrenReverseFilter=collectChildrenReverseFilter;
