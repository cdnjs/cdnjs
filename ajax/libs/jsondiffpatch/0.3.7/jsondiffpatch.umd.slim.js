...
var partitionRemovedOps = function partitionRemovedOps(jsonFormattedDiff) {
  ...
  var removeOpsOtherOps = partition(jsonFormattedDiff, isRemoveOp);
  return removeOpsOtherOps;
};

var reorderOps = function reorderOps(jsonFormattedDiff) {
  var _partitionRemovedOps = partitionRemovedOps(jsonFormattedDiff),
      _partitionRemovedOps2 = slicedToArray(_partitionRemovedOps, 2),
      removeOps = _partitionRemovedOps2[0],
      otherOps = _partitionRemovedOps2[1];
