...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadParticlesLinksInteraction": function() { return /* binding */ loadParticlesLinksInteraction; }
});

// EXTERNAL MODULE: ../../engine/dist/esm/index.js + 119 modules
var esm = __webpack_require__(317);
...
function getLinkDistance(pos1, pos2, optDistance, canvasSize, warp) {
  let distance = (0,esm.getDistance)(pos1, pos2);
  ...
  distance = (0,esm.getDistance)(pos1, pos2NE);
  ...
  distance = (0,esm.getDistance)(pos1, pos2SE);
  ...
  distance = (0,esm.getDistance)(pos1, pos2SW);
  return distance;
}

class Linker extends esm.ParticlesInteractorBase {
  constructor(container) {
    super(container);
  }
  ...
  interact(p1) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const linkOpt1 = p1.options.links,
            ...
            warp = linkOpt1.warp,
            range = warp ? new esm.CircleWarp(pos1.x, pos1.y, optDistance, canvasSize) : new esm.Circle(pos1.x, pos1.y, optDistance),
  ...
  setColor(p1) {
    ...
    if (!linkColor) {
      ...
      linkColor = (0,esm.getLinkRandomColor)(optColor, linksOptions.blink, linksOptions.consent);
...
function drawLinkLine(context, width, begin, end, maxDistance, canvasSize, warp, backgroundMask, composite, colorLine, opacity, shadow) {
  ...
  if ((0,esm.getDistance)(begin, end) <= maxDistance) {
    (0,esm.drawLine)(context, begin, end);
    drawn = true;
  } else if (warp) {
    let pi1;
    let pi2;
    ...
    const d1 = (0,esm.getDistances)(begin, endNE);
    ...
    if (d1.distance <= maxDistance) {
      ...
      const d2 = (0,esm.getDistances)(begin, endSW);
      ...
      if (d2.distance <= maxDistance) {
        ...
        const d3 = (0,esm.getDistances)(begin, endSE);
    ...
    if (pi1 && pi2) {
      (0,esm.drawLine)(context, begin, pi1);
      (0,esm.drawLine)(context, end, pi2);
      drawn = true;
    }
  }
  ...
  context.strokeStyle = (0,esm.getStyleFromRgb)(colorLine, opacity);

  if (shadow.enable) {
    const shadowColor = (0,esm.colorToRgb)(shadow.color);

    if (shadowColor) {
      context.shadowBlur = shadow.blur;
      context.shadowColor = (0,esm.getStyleFromRgb)(shadowColor);
    }
  }
...
function drawLinkTriangle(context, pos1, pos2, pos3, backgroundMask, composite, colorTriangle, opacityTriangle) {
  (0,esm.drawTriangle)(context, pos1, pos2, pos3);

  if (backgroundMask) {
    context.globalCompositeOperation = composite;
  }

  context.fillStyle = (0,esm.getStyleFromRgb)(colorTriangle, opacityTriangle);
  context.fill();
}
...
class LinkInstance {
  ...
  drawLinkTriangle(p1, link1, link2) {
    ...
    container.canvas.draw(ctx => {
      ...
      if ((0,esm.getDistance)(pos1, pos2) > container.retina.linksDistance || (0,esm.getDistance)(pos3, pos2) > container.retina.linksDistance || (0,esm.getDistance)(pos3, pos1) > container.retina.linksDistance) {
        return;
      }

      let colorTriangle = (0,esm.colorToRgb)(triangleOptions.color);
      ...
      if (!colorTriangle) {
        ...
        colorTriangle = (0,esm.getLinkColor)(p1, p2, linkColor);
      }
    ...
    container.canvas.draw(ctx => {
      ...
      if (twinkle.enable) {
        const twinkleFreq = twinkle.frequency,
              twinkleRgb = (0,esm.colorToRgb)(twinkle.color),
              twinkling = Math.random() < twinkleFreq;

        if (twinkling && twinkleRgb) {
          colorLine = twinkleRgb;
          opacity = (0,esm.getRangeValue)(twinkle.opacity);
        }
      }
      ...
      if (!colorLine) {
        const linksOptions = p1.options.links,
              linkColor = linksOptions.id !== undefined ? container.particles.linksColors.get(linksOptions.id) : container.particles.linksColor;
        colorLine = (0,esm.getLinkColor)(p1, p2, linkColor);
      }
...
const tsparticles_move_base_1 = __webpack_require__(945);

const tsparticles_shape_circle_1 = __webpack_require__(350);

const tsparticles_updater_color_1 = __webpack_require__(354);

const tsparticles_updater_opacity_1 = __webpack_require__(513);

const tsparticles_updater_out_modes_1 = __webpack_require__(316);

const tsparticles_interaction_particles_links_1 = __webpack_require__(938);

const tsparticles_updater_size_1 = __webpack_require__(465);
...
Object.defineProperty(exports, "loadLinksPreset", ({
  enumerable: true,
  get: function () {
    return _1.loadLinksPreset;
  }
}));

const tsparticles_engine_1 = __webpack_require__(317);
...
(0, _1.loadLinksPreset)(tsparticles_engine_1.tsParticles);
}();
