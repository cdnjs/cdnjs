...
(function (global, factory) {
  ...
  */
  ...
  function useFetcher(_temp3) {
    ...
    let fetchersCtx = React__namespace.useContext(FetchersContext);
    ...
    !fetchersCtx ? router.UNSAFE_invariant(false, "useFetcher must be used inside a FetchersContext")  : void 0;
    ...
    let load = React__namespace.useCallback(href => {
      !routeId ? router.UNSAFE_invariant(false, "fetcher.load routeId unavailable")  : void 0;
    ...
    let Form = React__namespace.useMemo(() => {
    ...
    return React__namespace.useMemo(() => {
      ...
      let fetcher = fetcherKey ? state.fetchers.get(fetcherKey) || router.IDLE_FETCHER : router.IDLE_FETCHER;
      return _extends({
        Form,
        submit,
        load
