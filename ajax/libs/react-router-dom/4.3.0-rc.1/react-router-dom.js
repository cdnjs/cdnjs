...
var createBrowserHistory = function createBrowserHistory() {
  ...
  invariant_1$2(canUseDOM, 'Browser history needs a DOM');
...
var createHashHistory = function createHashHistory() {
  ...
  invariant_1$2(canUseDOM, 'Hash history needs a DOM');
...
var BrowserRouter = function (_React$Component) {
  ...
  function BrowserRouter() {
    ...
    return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory(_this.props), _temp), babelHelpers.possibleConstructorReturn(_this, _ret);
  }
...
var Link = function (_React$Component) {
  ...
  function Link() {
    ...
    return _ret = (_temp = (_this = babelHelpers.possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (event) {
  ...
  Link.prototype.render = function render() {
    ...
    invariant_1$2(to !== undefined, 'You must specify the "to" property');
...
var createLocation = exports.createLocation = function createLocation(path, state, key, currentLocation) {
  ...
  if (typeof path === 'string') {
    // Two-arg form: push(path, state)
    location = (_PathUtils.parsePath)(path);
    location.state = state;
  } else {
    // One-arg form: push(location)
...
var createMemoryHistory = function createMemoryHistory() {
  ...
  var entries = initialEntries.map(function (entry) {
    return typeof entry === 'string' ? (_LocationUtils.createLocation)(entry, undefined, createKey()) : (_LocationUtils.createLocation)(entry, undefined, entry.key || createKey());
  });
  ...
  var push = function push(path, state) {
    ...
    var action = 'PUSH';
    var location = (_LocationUtils.createLocation)(path, state, createKey(), history.location);
 ...
 */
var generatePath$1 = function generatePath() {
...
exports.generatePath = generatePath$1;
