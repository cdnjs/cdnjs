declare namespace kontra {
  ...
  interface GameLoopConstructor {
    ...
    (properties: {update?: (dt: number) => void, render: Function, fps?: number, clearCanvas?: boolean, context?: CanvasRenderingContext2D, blur?: boolean}): GameLoop;
  }
  ...
  function bindKeys(keys: string | string[], callback: (evt: KeyboardEvent) => void, options?: {handler?: 'keydown' | 'keyup', preventDefault?: boolean}): void;
  function unbindKeys(keys: string | string[], options?: {handler?: 'keydown' | 'keyup'}): void;
