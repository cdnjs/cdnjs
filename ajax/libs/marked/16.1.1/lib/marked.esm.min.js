...
`+n+"</"+i+`>
`}listitem(e){let t="";var r;return e.task&&(r=this.checkbox({checked:!!e.checked}),e.loose?"paragraph"===e.tokens[0]?.type?(e.tokens[0].text=r+" "+e.tokens[0].text,e.tokens[0].tokens&&0<e.tokens[0].tokens.length&&"text"===e.tokens[0].tokens[0].type&&(e.tokens[0].tokens[0].text=r+" "+w(e.tokens[0].tokens[0].text),e.tokens[0].tokens[0].escaped=!0)):e.tokens.unshift({type:"text",raw:r+" ",text:r+" ",escaped:!0}):t+=r+" "),`<li>${t+=this.parser.parse(e.tokens,!!e.loose)}</li>
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${w(e,!0)}</code>`}br(e){return"<br>"}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:r}){var r=this.parser.parseInline(r),n=J(e);if(null===n)return r;let s='<a href="'+(e=n)+'"';return t&&(s+=' title="'+w(t)+'"'),s+=">"+r+"</a>"}image({href:e,title:t,text:r,tokens:n}){n&&(r=this.parser.parseInline(n,this.parser.textRenderer));n=J(e);if(null===n)return w(r);let s=`<img src="${e=n}" alt="${r}"`;return t&&(s+=` title="${w(t)}"`),s+=">"}text(e){return"tokens"in e&&e.tokens?this.parser.parseInline(e.tokens):"escaped"in e&&e.escaped?e.text:w(e.text)}},S=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return""+e}image({text:e}){return""+e}br(){return""}},R=class r2{options;renderer;textRenderer;constructor(e){this.options=e||O,this.options.renderer=this.options.renderer||new P,this.renderer=this.options.renderer,this.renderer.options=this.options,(this.renderer.parser=this).textRenderer=new S}static parse(e,t){return new r2(t).parse(e)}static parseInline(e,t){return new r2(t).parseInline(e)}parse(n,s=!0){let i="";for(let r=0;r<n.length;r++){var e=n[r];if(this.options.extensions?.renderers?.[e.type]){var t=e,l=this.options.extensions.renderers[t.type].call({parser:this},t);if(!1!==l||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(t.type)){i+=l||"";continue}}var a=e;switch(a.type){case"space":i+=this.renderer.space(a);continue;case"hr":i+=this.renderer.hr(a);continue;case"heading":i+=this.renderer.heading(a);continue;case"code":i+=this.renderer.code(a);continue;case"table":i+=this.renderer.table(a);continue;case"blockquote":i+=this.renderer.blockquote(a);continue;case"list":i+=this.renderer.list(a);continue;case"html":i+=this.renderer.html(a);continue;case"paragraph":i+=this.renderer.paragraph(a);continue;case"text":{let e=a,t=this.renderer.text(e);for(;r+1<n.length&&"text"===n[r+1].type;)e=n[++r],t+=`
`+this.renderer.text(e);i+=s?this.renderer.paragraph({type:"paragraph",raw:t,text:t,tokens:[{type:"text",raw:t,text:t,escaped:!0}]}):t;continue}default:var o='Token with "'+a.type+'" type was not found.';if(this.options.silent)return console.error(o),"";throw new Error(o)}}return i}parseInline(t,r=this.renderer){let n="";for(let e=0;e<t.length;e++){var s=t[e];if(this.options.extensions?.renderers?.[s.type]){var i=this.options.extensions.renderers[s.type].call({parser:this},s);if(!1!==i||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(s.type)){n+=i||"";continue}}var l=s;switch(l.type){case"escape":n+=r.text(l);break;case"html":n+=r.html(l);break;case"link":n+=r.link(l);break;case"image":n+=r.image(l);break;case"strong":n+=r.strong(l);break;case"em":n+=r.em(l);break;case"codespan":n+=r.codespan(l);break;case"br":n+=r.br(l);break;case"del":n+=r.del(l);break;case"text":n+=r.text(l);break;default:var a='Token with "'+l.type+'" type was not found.';if(this.options.silent)return console.error(a),"";throw new Error(a)}}return n}},$=class{options;block;constructor(e){this.options=e||O}static passThroughHooks=new Set(["preprocess","postprocess","processAllTokens"]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}provideLexer(){return this.block?b.lex:b.lexInline}provideParser(){return this.block?R.parse:R.parseInline}},B=class{defaults=L();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=R;Renderer=P;TextRenderer=S;Lexer=b;Tokenizer=y;Hooks=$;constructor(...e){this.use(...e)}walkTokens(e,r){let n=[];for(var s of e)switch(n=n.concat(r.call(this,s)),s.type){case"table":var t,i,l=s;for(t of l.header)n=n.concat(this.walkTokens(t.tokens,r));for(i of l.rows)for(var a of i)n=n.concat(this.walkTokens(a.tokens,r));break;case"list":l=s;n=n.concat(this.walkTokens(l.items,r));break;default:{let t=s;this.defaults.extensions?.childTokens?.[t.type]?this.defaults.extensions.childTokens[t.type].forEach(e=>{e=t[e].flat(1/0);n=n.concat(this.walkTokens(e,r))}):t.tokens&&(n=n.concat(this.walkTokens(t.tokens,r)))}}return n}use(...e){let s=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(t=>{let e={...t};if(e.async=this.defaults.async||e.async||!1,t.extensions&&(t.extensions.forEach(n=>{if(!n.name)throw new Error("extension name required");if("renderer"in n){let r=s.renderers[n.name];r?s.renderers[n.name]=function(...e){let t=n.renderer.apply(this,e);return t=!1===t?r.apply(this,e):t}:s.renderers[n.name]=n.renderer}if("tokenizer"in n){if(!n.level||"block"!==n.level&&"inline"!==n.level)throw new Error("extension level must be 'block' or 'inline'");let e=s[n.level];e?e.unshift(n.tokenizer):s[n.level]=[n.tokenizer],n.start&&("block"===n.level?s.startBlock?s.startBlock.push(n.start):s.startBlock=[n.start]:"inline"===n.level&&(s.startInline?s.startInline.push(n.start):s.startInline=[n.start]))}"childTokens"in n&&n.childTokens&&(s.childTokens[n.name]=n.childTokens)}),e.extensions=s),t.renderer){let s=this.defaults.renderer||new P(this.defaults);for(var i in t.renderer){if(!(i in s))throw new Error(`renderer '${i}' does not exist`);if(!["options","parser"].includes(i)){let e=i,r=t.renderer[e],n=s[e];s[e]=(...e)=>{let t=r.apply(s,e);return(t=!1===t?n.apply(s,e):t)||""}}}e.renderer=s}if(t.tokenizer){let s=this.defaults.tokenizer||new y(this.defaults);for(var l in t.tokenizer){if(!(l in s))throw new Error(`tokenizer '${l}' does not exist`);if(!["options","rules","lexer"].includes(l)){let e=l,r=t.tokenizer[e],n=s[e];s[e]=(...e)=>{let t=r.apply(s,e);return t=!1===t?n.apply(s,e):t}}}e.tokenizer=s}if(t.hooks){let s=this.defaults.hooks||new $;for(var a in t.hooks){if(!(a in s))throw new Error(`hook '${a}' does not exist`);if(!["options","block"].includes(a)){let e=a,r=t.hooks[e],n=s[e];$.passThroughHooks.has(a)?s[e]=e=>{if(this.defaults.async)return Promise.resolve(r.call(s,e)).then(e=>n.call(s,e));e=r.call(s,e);return n.call(s,e)}:s[e]=(...e)=>{let t=r.apply(s,e);return t=!1===t?n.apply(s,e):t}}}e.hooks=s}if(t.walkTokens){let r=this.defaults.walkTokens,n=t.walkTokens;e.walkTokens=function(e){let t=[];return t.push(n.call(this,e)),t=r?t.concat(r.call(this,e)):t}}this.defaults={...this.defaults,...e}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return b.lex(e,t??this.defaults)}parser(e,t){return R.parse(e,t??this.defaults)}parseMarkdown(a){return(r,e)=>{let t={...e},n={...this.defaults,...t},s=this.onError(!!n.silent,!!n.async);if(!0===this.defaults.async&&!1===t.async)return s(new Error("marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise."));if("u"<typeof r||null===r)return s(new Error("marked(): input parameter is undefined or null"));if("string"!=typeof r)return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(r)+", string expected"));n.hooks&&((n.hooks.options=n).hooks.block=a);let i=n.hooks?n.hooks.provideLexer():a?b.lex:b.lexInline,l=n.hooks?n.hooks.provideParser():a?R.parse:R.parseInline;if(n.async)return Promise.resolve(n.hooks?n.hooks.preprocess(r):r).then(e=>i(e,n)).then(e=>n.hooks?n.hooks.processAllTokens(e):e).then(e=>n.walkTokens?Promise.all(this.walkTokens(e,n.walkTokens)).then(()=>e):e).then(e=>l(e,n)).then(e=>n.hooks?n.hooks.postprocess(e):e).catch(s);try{n.hooks&&(r=n.hooks.preprocess(r));let e=i(r,n),t=(n.hooks&&(e=n.hooks.processAllTokens(e)),n.walkTokens&&this.walkTokens(e,n.walkTokens),l(e,n));return t=n.hooks?n.hooks.postprocess(t):t}catch(e){return s(e)}}}onError(r,n){return e=>{var t;if(e.message+=`
Please report this to https://github.com/markedjs/marked.`,r)return t="<p>An error occurred:</p><pre>"+w(e.message+"",!0)+"</pre>",n?Promise.resolve(t):t;if(n)return Promise.reject(e);throw e}}},_=new B;function d(e,t){return _.parse(e,t)}d.options=d.setOptions=function(e){return _.setOptions(e),d.defaults=_.defaults,H(d.defaults),d},d.getDefaults=L,d.defaults=O,d.use=function(...e){return _.use(...e),d.defaults=_.defaults,H(d.defaults),d},d.walkTokens=function(e,t){return _.walkTokens(e,t)},d.parseInline=_.parseInline,d.Parser=R,d.parser=R.parse,d.Renderer=P,d.TextRenderer=S,d.Lexer=b,d.lexer=b.lex,d.Tokenizer=y,d.Hooks=$;var Dt=(d.parse=d).options,Zt=d.setOptions,Gt=d.use,Ht=d.walkTokens,Nt=d.parseInline,jt=d,Ft=R.parse,Qt=b.lex;export{$ as Hooks,b as Lexer,B as Marked,R as Parser,P as Renderer,S as TextRenderer,y as Tokenizer,O as defaults,L as getDefaults,Qt as lexer,d as marked,Dt as options,jt as parse,Nt as parseInline,Ft as parser,Zt as setOptions,Gt as use,Ht as walkTokens};