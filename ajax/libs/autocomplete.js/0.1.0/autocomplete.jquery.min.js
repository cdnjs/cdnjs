...
"use strict";module.exports=require("./src/autocomplete/plugin.js");
...
"use strict";function EventBus(e){e&&e.el||$.error("EventBus initialized without el"),this.$el=$(e.el)}var namespace="typeahead:",_=require("../common/utils.js");_.mixin(EventBus.prototype,{trigger:function(e){var t=[].slice.call(arguments,1);this.$el.trigger(namespace+e,t)}}),module.exports=EventBus;
