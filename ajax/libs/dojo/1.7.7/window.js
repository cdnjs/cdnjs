...
//>>built
define("dojo/window",["./_base/lang","./_base/sniff","./_base/window","./dom","./dom-geometry","./dom-style","./dom-construct"],function(_1,_2,_3,_4,_5,_6,_7){
...
var _13=_1.getObject("dojo.window",true);
_13.getBox=function(){
var _14=(_3.doc.compatMode=="BackCompat")?_3.body():_3.doc.documentElement,_15=_5.docScroll(),w,h;
if(_2("touch")){
var _16=_3.doc.parentWindow||_3.doc.defaultView;
...
_13.scrollIntoView=function(_17,pos){
try{
_17=_4.byId(_17);
