...
_8.locale=_2.locale;
var _c="$Rev: d40757e $".match(/[0-9a-f]{7,}/);
_8.version={major:1,minor:11,patch:0,flag:"-rc2",revision:_c?_c[0]:NaN,toString:function(){
var v=_8.version;
return v.major+"."+v.minor+"."+v.patch+v.flag+" ("+v.revision+")";
}};
1||_1.add("extend-dojo",1);
if(!_1("csp-restrictions")){
...
if(!_1("host-webworker")){
1||_1.add("dojo-guarantee-console",1);
}
if(1){
_1.add("console-as-object",Function.prototype.bind&&console&&typeof console.log==="object");
