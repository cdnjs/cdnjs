...
//begin v1.x content
{
	...
	"field-wed-narrow@localeAlias218": {
		"bundle": "",
	...
	"field-wed-narrow@localeAlias219": {
		"bundle": "",
		"target": "field-wed"
	},
	...
	"quarters-format-abbr@localeAlias175": {
		"bundle": "gregorian",
	...
	"field-tue-short@localeAlias214": {
		"bundle": "",
		"target": "field-tue"
	},
	"field-month-short-relative+0": "this month",
	"field-thu-short@localeAlias220": {
		"bundle": "",
		"target": "field-thu"
	},
	"field-month-short-relative+1": "next month",
	"field-minute-short@localeAlias232": {
		"bundle": "",
		"target": "field-minute"
	},
	...
	"field-day-narrow@localeAlias206": {
		"bundle": "",
		"target": "field-day-short"
	},
	"field-week-narrow": "Week",
	"field-day-narrow@localeAlias207": {
		"bundle": "",
		"target": "field-day"
	},
	...
	"field-quarter-short@localeAlias196": {
		"bundle": "",
		"target": "field-quarter"
	},
	"field-minute-narrow": "Minute",
	"dateFormat@localeAlias190": {
		"bundle": "generic",
		"target": "dateFormat"
	},
	...
	"field-quarter-narrow@localeAlias197": {
		"bundle": "",
		"target": "field-quarter-short"
	},
	"field-quarter-narrow@localeAlias198": {
		"bundle": "",
		"target": "field-quarter"
	},
	"dayPeriods-format-wide@localeAlias182": {
		"bundle": "gregorian",
	...
	"field-mon-short@localeAlias211": {
		"bundle": "",
		"target": "field-mon"
	},
	...
	"days-standAlone-abbr@localeAlias168": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"dateTimeFormats-appendItem-Year": "{1} {0}",
	"dateTimeFormats-appendItem-Day-Of-Week": "{0} {1}",
	"days-standAlone-abbr@localeAlias169": {
		"bundle": "gregorian",
	...
	"field-second-short@localeAlias235": {
		"bundle": "",
		"target": "field-second"
	},
	...
	"dateFormatItem-d": "d",
	"quarters@localeAlias174": {
		"bundle": "gregorian",
		"target": "quarters"
	},
	"dayPeriods-format-abbr-pm": "PM",
	"dateFormatItem-h": "h a",
	"field-tue-narrow@localeAlias215": {
		"bundle": "",
	...
	"field-tue-narrow@localeAlias216": {
		"bundle": "",
		"target": "field-tue"
	},
	"dateFormatItem-yyyyQQQ": "G y QQQ",
	"field-wed-short@localeAlias217": {
		"bundle": "",
		"target": "field-wed"
	},
	...
	"field-second-narrow@localeAlias236": {
		"bundle": "",
	...
	"field-second-narrow@localeAlias237": {
		"bundle": "",
		"target": "field-second"
	},
	"dateTimeFormats-appendItem-Quarter": "{0} ({2}: {1})",
	"dayPeriods-standAlone-narrow@localeAlias184": {
		"bundle": "gregorian",
		"target": "dayPeriods-standAlone-abbr"
	},
	"dayPeriods-standAlone-narrow@localeAlias185": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	...
	"field-hour-short@localeAlias229": {
		"bundle": "",
		"target": "field-hour"
	},
	"eraNames@localeAlias188": {
		"bundle": "coptic",
		"target": "eraAbbr"
	},
	"days-format-short@localeAlias166": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-format-short@localeAlias167": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"field-year-short@localeAlias193": {
		"bundle": "",
		"target": "field-year"
	},
	"eraAbbr": [
	...
	"dayPeriods-format-narrow@localeAlias181": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	...
	"field-sat-short@localeAlias226": {
		"bundle": "",
		"target": "field-sat"
	},
	"field-month-narrow@localeAlias200": {
		"bundle": "",
		"target": "field-month-short"
	},
	"field-month-narrow@localeAlias201": {
		"bundle": "",
		"target": "field-month"
	},
	"field-second-relative+0": "now",
	"dayPeriods-standAlone-abbr@localeAlias183": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
	"quarters-standAlone-wide@localeAlias179": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	"months-standAlone-abbr@localeAlias160": {
		"bundle": "coptic",
		"target": "months-format-abbr"
	},
	"timeFormat@localeAlias191": {
		"bundle": "gregorian",
		"target": "timeFormat"
	},
	"months-standAlone-abbr@localeAlias161": {
		"bundle": "coptic",
		"target": "months-format-wide"
	},
	"field-quarter-relative+-1": "last quarter",
	"days-standAlone-wide@localeAlias173": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"field-day-short@localeAlias205": {
		"bundle": "",
		"target": "field-day"
	},
	"field-hour": "Hour",
	"quarters-format-narrow@localeAlias176": {
		"bundle": "gregorian",
		"target": "quarters-standAlone-narrow"
	},
	"field-mon-narrow@localeAlias212": {
		"bundle": "",
		"target": "field-mon-short"
	},
	"field-mon-narrow@localeAlias213": {
		"bundle": "",
		"target": "field-mon"
	},
	"field-sun-narrow@localeAlias209": {
		"bundle": "",
		"target": "field-sun-short"
	},
	"field-year-narrow@localeAlias194": {
		"bundle": "",
		"target": "field-year-short"
	},
	"field-second-narrow-relative+0": "now",
	"field-year-narrow@localeAlias195": {
		"bundle": "",
		"target": "field-year"
	},
	...
	"field-sun-narrow@localeAlias210": {
		"bundle": "",
		"target": "field-sun"
	},
	"dateTimeFormats-appendItem-Minute": "{0} ({2}: {1})",
	"field-day": "Day",
	"days-standAlone-short@localeAlias170": {
		"bundle": "gregorian",
		"target": "days-format-short"
	},
	"days-standAlone-short@localeAlias171": {
		"bundle": "gregorian",
		"target": "days-format-abbr"
	},
	"days-standAlone-short@localeAlias172": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	...
	"days-format-abbr@localeAlias164": {
		"bundle": "gregorian",
		"target": "days-format-wide"
	},
	"dayPeriods-format-abbr-am": "AM",
	"months-standAlone-wide@localeAlias162": {
		"bundle": "coptic",
		"target": "months-format-wide"
	},
	...
	"field-month-short@localeAlias199": {
		"bundle": "",
		"target": "field-month"
	},
	...
	"months-format-abbr@localeAlias158": {
		"bundle": "coptic",
		"target": "months-format-wide"
	},
	...
	"field-fri-short@localeAlias223": {
		"bundle": "",
		"target": "field-fri"
	},
	"field-quarter-short": "Quarter",
	"field-hour-narrow@localeAlias230": {
		"bundle": "",
	...
	"field-hour-narrow@localeAlias231": {
		"bundle": "",
		"target": "field-hour"
	},
	"field-week-narrow@localeAlias203": {
		"bundle": "",
		"target": "field-week-short"
	},
	"field-week-narrow@localeAlias204": {
		"bundle": "",
		"target": "field-week"
	},
	...
	"days-format-narrow@localeAlias165": {
		"bundle": "gregorian",
	...
	"field-thu-narrow@localeAlias221": {
		"bundle": "",
		"target": "field-thu-short"
	},
	"field-week-narrow-relative+-1": "last week",
	"field-thu-narrow@localeAlias222": {
		"bundle": "",
		"target": "field-thu"
	},
	...
	"field-fri-narrow@localeAlias224": {
		"bundle": "",
		"target": "field-fri-short"
	},
	"field-fri-narrow@localeAlias225": {
		"bundle": "",
		"target": "field-fri"
	},
	...
	"field-week-short@localeAlias202": {
		"bundle": "",
		"target": "field-week"
	},
	...
	"field-minute-narrow@localeAlias233": {
		"bundle": "",
		"target": "field-minute-short"
	},
	"field-minute-narrow@localeAlias234": {
		"bundle": "",
		"target": "field-minute"
	},
	"field-minute-short": "Minute",
	"months-format-narrow@localeAlias159": {
		"bundle": "coptic",
	...
	"field-sun-short@localeAlias208": {
		"bundle": "",
		"target": "field-sun"
	},
	...
	"eraNarrow@localeAlias189": {
		"bundle": "coptic",
		"target": "eraAbbr"
	},
	"field-sat-narrow-relative+-1": "last Saturday",
	"quarters-standAlone-abbr@localeAlias177": {
		"bundle": "gregorian",
		"target": "quarters-format-abbr"
	},
	"quarters-standAlone-abbr@localeAlias178": {
		"bundle": "gregorian",
		"target": "quarters-format-wide"
	},
	...
	"dayPeriods-standAlone-wide@localeAlias186": {
		"bundle": "gregorian",
		"target": "dayPeriods-standAlone-abbr"
	},
	"field-week": "Week",
	"field-day-narrow": "Day",
	"dayPeriods-standAlone-wide@localeAlias187": {
		"bundle": "gregorian",
		"target": "dayPeriods-format-abbr"
	},
