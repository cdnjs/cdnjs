...
var _6=(_5().compatMode)=="BackCompat";
var _7=">~+";
var _8=false;
var _9=function(){
return true;
...
var _3c=(typeof _5().firstChild.nextElementSibling=="undefined");
...
var _65=(d.isIE<9||d.isIE==9&&d.isQuirks)?function(_66){
...
if(!("classes" in _6b)){
_3(_6a.classes,function(_6d,idx,arr){
...
if(ecs&&/\{\s*\[native code\]\s*\}/.test(String(ecs))&&_83.classes.length&&!_6){
...
var _9e=(!!_5()[qsa]&&(!d.isSafari||(d.isSafari>3.1)||_9c));
var _9f=/n\+\d|([^ ])?([>~+])([^ =])?/g;
...
var _a9=(_9e&&(!_a5)&&(_7.indexOf(qcz)==-1)&&(!d.isIE||(_a4.indexOf(":")==-1))&&(!(_6&&(_a4.indexOf(".")>=0)))&&(_a4.indexOf(":contains")==-1)&&(_a4.indexOf(":checked")==-1)&&(_a4.indexOf("|=")==-1));
if(_a9){
...
d.query.pseudos=_4c;
d._filterQueryResult=function(_b8,_b9,_ba){
var _bb=new d._NodeListCtor(),_bc=_a(_b9),_bd=(_bc.length==1&&!/[^\w#\.]/.test(_b9))?_5c(_bc[0]):function(_be){
return dojo.query(_b9,_ba).indexOf(_be)!=-1;
};
...
return str;
},forEach:function(arr,_c0,_c1){
if(!arr||!arr.length){
return;
}
for(var i=0,l=arr.length;i<l;++i){
_c0.call(_c1||window,arr[i],i,arr);
}
...
var _c2=Math.max(dav.indexOf("WebKit"),dav.indexOf("Safari"),0);
if(_c2&&!acme.isChrome){
acme.isSafari=parseFloat(dav.split("Version/")[1]);
if(!acme.isSafari||parseFloat(dav.substr(_c2+7))<=419.3){
acme.isSafari=2;
}
}
...
_1(this["queryPortability"]||this["acme"]||_bf());
}
})();
}
