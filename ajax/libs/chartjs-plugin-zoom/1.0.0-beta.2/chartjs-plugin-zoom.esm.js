...
import { each, isNullOrUndef, callback } from 'chart.js/helpers';
...
function zoomScale(scale, zoom, center, zoomOptions) {
  ...
  callback(fn, [scale, zoom, center, zoomOptions]);
}
...
function panScale(scale, delta, panOptions) {
  ...
  callback(fn, [scale, delta, panOptions]);
}
