...
const DisqusJSLoadMoreCommentsButton = /*#__PURE__*/ g((props)=>{
...
function DisqusJSChildrenPostItems(props) {
    ...
    return /*#__PURE__*/ e("ul", {
        ...
        children: props.children.map((comment)=>/*#__PURE__*/ v$1(DisqusJSPostItem, {
                ...comment,
                admin: props.admin,
...
const DisqusJSCommentsList = (props)=>{
    ...
    return /*#__PURE__*/ e("ul", {
        ...
        children: processedComments.map((comment)=>/*#__PURE__*/ v$1(DisqusJSPostItem, {
                ...comment,
                key: comment.comment.id,
                admin: props.admin,
                adminLabel: props.adminLabel
...
const DisqusJS$1 = /*#__PURE__*/ x((props, ref)=>{
