  ...
  return {
    ...
    execute: function() {
      FormlyForm = (function(_super) {
        ...
        __decorate([core_1.Input(), __metadata('design:type', Array)], FormlyForm.prototype, "fields", void 0);
...
System.register("ng2-formly/src/main", ["./services/formly.config", "./services/formly.event.emitter", "./services/formly.messages", "./components/formly.common.component", "./components/formly.form", "./components/formly.field", "./services/formly.field.delegates", "./services/formly.providers"], function(exports_1, context_1) {
  "use strict";
  var __moduleName = context_1 && context_1.id;
  return {
