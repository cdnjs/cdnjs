...
`)},Sd=r=>ye({axis:r.attributes.getInt("axis")}),Uv=r=>{if(!r||r.length<1)throw new Error("too few inputs");let e=r[0].type,n=r[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of r){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==n)throw new Error("input tensors should have the same shape")}}});function Wv(){return Ct("abs")}function Hv(){return Ct("acos")}function qv(){return Ct("asin")}function Kv(){return Ct("atan")}function jv(){return Ct("ceil")}function Xv(){return Ct("cos")}function Zv(r){let e="elu";return{body:`
  ...
  `,name:r,type:0}}var uw,Qe,Ad,Od,Pd,Ed,ls,Cd,kd,lw,Dd,Bd,Ld,Nd,zd,Rd,cs,Md,Fd,Vd,Gd,Ud,Wd,Hd,qd,Kd,jd,Xd,fs=k(()=>{"use strict";st();Le();dr();qe();$e();uw=(r,e,n,t)=>{let o=r.session.pack?2:0,i=se(r.session.backend.glContext.version);return{...e,output:{dims:n.dims,type:n.type,textureType:o},shaderSource:`
     ${t.body}
     void main() {
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),om=(r,e,n)=>Kr(r,e,n,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),im=(r,e,n)=>Kr(r,e,n,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),am=(r,e,n)=>Kr(r,e,n,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var um,lm=k(()=>{"use strict";Le();um=(r,e)=>{let n=te.calculateReshapedDims(e[0].dims,e[1].integerData);return r.session.pack?[r.reshapePacked(e[0],n)]:[r.reshapeUnpacked(e[0],n)]}});var cm,vs,fm,dm,Un,OT,ws,jo,Ts=k(()=>{"use strict";st();qe();$e();cm={name:"Upsample",inputNames:["X"],inputTypes:[0]},vs=(r,e,n)=>(ws(e,n),[r.run({...cm,cacheHint:n.cacheKey,get:()=>OT(r,e,n)},e)]),fm=r=>Un(r,7),dm=r=>Un(r,9),Un=(r,e)=>{let n=e>=10,t=r.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let o=[];e<9&&(o=r.attributes.getFloats("scales"),jo(o,t,n));let i=r.attributes.getFloat("extrapolation_value",0),s=e>10?r.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?r.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=r.attributes.getFloat("cubic_coeff_a",-.75),c=r.attributes.getInt("exclude_outside",0)!==0;if(c&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let p=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",g=0,b=0,h=0;return e>10?r.inputs.length>2?(g=1,b=2,h=3):(b=1,h=2):e===9&&(b=1),ye({opset:e,isResize:n,mode:t,scales:o,extrapolationValue:i,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:f,excludeOutside:c,useNearest2xOptimization:p,roiInputIdx:g,scalesInputIdx:b,sizesInputIdx:h})},OT=(r,e,n)=>{let t=se(r.session.backend.glContext.version),[o,i]=r.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((h,v)=>Math.floor(h*n.scales[v])),[a,u]=r.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),c=new Array(l),p=`
    ...
    }`;return{...Sm,output:{dims:e.dims,type:e.type,textureType:0},shaderSource:l}},Cm=r=>{if(!r||r.length!==1)throw new Error("Softmax requires 1 input.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type")}});var Dm,Bm,Lm,FT,VT,GT,Nm=k(()=>{"use strict";st();Le();$e();Dm={name:"Split",inputNames:["A"],inputTypes:[0]},Bm=(r,e,n)=>{GT(e);let t=te.normalizeAxis(n.axis,e[0].dims.length),o=FT(r,e,t,n),i=[];for(let s=0;s<o;++s)i.push(r.run({...Dm,cacheHint:`${n.cacheKey};${s}`,get:()=>VT(r,e[0],n,t,s)},e));return i},Lm=r=>{let e=r.attributes.getInt("axis",0),n=r.attributes.getInts("split",[]),t=r.outputs.length;return ye({axis:e,split:n,numOutputs:t})},FT=(r,e,n,t)=>{let[,o]=Nn.splitShape(e[0].dims,n,t.split,t.numOutputs);return o.length},VT=(r,e,n,t,o)=>{let[i,s]=Nn.splitShape(e.dims,t,n.split,n.numOutputs),a=s[o],u=i[o],f=`
...
}`,Ub=r=>{let e=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"Erf",n=>`erf_vf32(${n})`,Li(e)))},Wb=r=>{r.compute(Ce(r.inputs[0],"Exp","exp"))},Hb=r=>{r.compute(Ce(r.inputs[0],"Floor","floor"))},qb=r=>{let e=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,Li(e)))},Kb=(r,e)=>{let n=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"LeakyRelu",t=>`select(leaky_relu_alpha_ * ${t}, ${t}, ${t} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${e.alpha});`,e.cacheKey))},jb=r=>{r.compute(Ce(r.inputs[0],"Not",e=>`!${e}`))},Xb=r=>{r.compute(Ce(r.inputs[0],"Neg",e=>`-${e}`))},Zb=r=>{r.compute(Ce(r.inputs[0],"Reciprocal",e=>`1.0/${e}`))},Yb=r=>{let e=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"Relu",n=>`select(vec4<${e}>(0.0), ${n}, ${n} > vec4<${e}>(0.0))`))},Jb=r=>{r.compute(Ce(r.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},Qb=r=>ce(r),eg=(r,e)=>{let n=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"HardSigmoid",t=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${e.alpha} * ${t} + vec4<${n}>(${e.beta})))`,void 0,e.cacheKey))},tg=r=>{r.compute(Ce(r.inputs[0],"Sin","sin"))},rg=r=>{r.compute(Ce(r.inputs[0],"Sinh","sinh"))},ng=r=>{r.compute(Ce(r.inputs[0],"Sqrt","sqrt"))},og=r=>{r.compute(Ce(r.inputs[0],"Tan","tan"))},ig=r=>`sign(${r}) * (1 - exp(-2 * abs(${r}))) / (1 + exp(-2 * abs(${r})))`,ag=r=>{r.compute(Ce(r.inputs[0],"Tanh",ig))},nu=(r="f32")=>`
...
`,ou=r=>`(fast_gelu_a + fast_gelu_a * tanh_v(${r} * (fast_gelu_c * ${r} * ${r} + fast_gelu_b))) * ${r}`,sg=r=>{let e=ot(r.inputs[0].dataType);r.compute(Ce(r.inputs[0],"FastGelu",ou,nu(e),void 0,r.inputs[0].dataType))},ug=(r,e)=>{let n=ot(r.inputs[0].dataType);return r.compute(Ce(r.inputs[0],"ThresholdedRelu",t=>`select(vec4<${n}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${e.alpha});`,e.cacheKey)),0},lg=r=>{r.compute(Ce(r.inputs[0],"Log","log"))},c1=(r,e)=>`
...
`},I1=(r,e,n,t,o=!1)=>{let[i,s,a,u]=t,l=Re(t[0].type.tensor);return`
  ...
  ${h?iu(v,w,ue,xe):au(v,w,ue,xe)}
    ...
    return ${rt(a,l)}(0.0);`,O=rt(u,l),E=r?rt(s,l):rt(a,l),L=r?rt(a,l):rt(s,l),N=Gt(i,O,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${O}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${he}>`:he}) {
        ...
        }`}let F=rt(p,O),ee=Gt(e,F,O);return`
            ${j}
...
`)}
  ...
  }`};r.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...U(p,g,p)]}),getShaderSource:h},{inputs:[e[0],c]})},TI=(r,e,n)=>{let t=e[0].dims,o=t,i=t[0],s=t[t.length-1],a=C.sizeFromDimension(t,1)/s,u=Ee(s),l=C.size(o)/u,f=[{type:12,data:a},{type:12,data:Math.floor(s/u)}],c=["type","type"],p=!1,g=[0,t.length-1];for(let w=0;w<t.length-2;w++)p=p||t[w+1]!==1,g.push(w+1);p=p&&t[t.length-1]!==1;let b=p?r.compute(it(r.inputs[0],g),{inputs:[r.inputs[0]],outputs:[-1]})[0]:r.inputs[0].reshape(Array.from({length:t.length},(w,_)=>t[g[_]])),h=My(r,b,e[1],e[2],i,a,s,n.epsilon),v=w=>{let _=Re(e[0].dataType),I=u===1?"vec2f":`mat${u}x2f`,$=L=>{let N=L===0?"x":"y",G=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${_}(${G}(scale.${N}))`;case 2:return`vec2<${_}>(${G}(scale[0].${N}, scale[1].${N}))`;case 4:return`vec4<${_}>(${G}(scale[0].${N}, scale[1].${N}, scale[2].${N}, scale[3].${N}))`;default:throw new Error(`Not supported compoents ${u}`)}},O=B("input",e[0].dataType,e[0].dims,u),E=V("output",e[0].dataType,o,u);return`
