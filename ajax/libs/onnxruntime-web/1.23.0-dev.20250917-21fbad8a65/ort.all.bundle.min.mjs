...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[e(r.type),r.length??1])}},E_=(n,e)=>new vc(n,e)});var vE,C_,wE,xE,TE,IE,ut,D_,k_,Zr=N(()=>{"use strict";le();he();Je();ge();vE=(n,e)=>{if(!n||n.length!==1)throw new Error("Transpose requires 1 input.");if(e.length!==0&&e.length!==n[0].dims.length)throw new Error(`perm size ${e.length} does not match input rank ${n[0].dims.length}`)},C_=(n,e)=>e.length!==0?e:[...new Array(n).keys()].reverse(),wE=(n,e)=>D.sortBasedOnPerm(n,C_(n.length,e)),xE=(n,e,r,t)=>{let o=`fn perm(i: ${t.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let i=0;i<e;++i)o+=`a[${n[i]}]=i[${i}];`;return o+="return a;}"},TE=(n,e)=>{let r=[],t=[];for(let o=0;o<n.length;++o)n[o]!==1&&r.push(n[o]),n[e[o]]!==1&&t.push(e[o]);return{newShape:r,newPerm:t}},IE=(n,e)=>{let r=0;for(let t=0;t<n.length;++t)if(e[n[t]]!==1){if(n[t]<r)return!1;r=n[t]}return!0},ut=(n,e)=>{let r=n.dataType,t=n.dims.length,o=C_(t,e),i=wE(n.dims,o),a=n.dims,s=i,u=t<2||IE(o,n.dims),l;if(u)return l=y=>{let T=R("input",r,a,4),w=V("output",r,s,4);return`
  ${y.registerUniform("output_size","u32").declareVariables(T,w)}
  ${y.mainStart()}
    ${y.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let y=D.size(i);return{outputs:[{dims:i,dataType:n.dataType}],dispatchGroup:{x:Math.ceil(y/64/4)},programUniforms:[{type:12,data:Math.ceil(y/4)}]}},getShaderSource:l};let{newShape:c,newPerm:p}=TE(n.dims,o),h=D.areEqual(p,[2,3,1]),m=D.areEqual(p,[3,1,2]);if(c.length===2||h||m){a=h?[c[0],c[1]*c[2]]:m?[c[0]*c[1],c[2]]:c,s=[a[1],a[0]];let y=16;return l=T=>{let w=R("a",r,a.length),x=V("output",r,s.length);return`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},u0=n=>{e3(n.inputs),n.compute(t3(n.inputs))}});var r3,ke,c0,d0,p0,f0,h0,m0,g0,b0,y0,n3,_0,v0,w0,x0,Wo,T0,Fa,I0,S0,$0,A0,O0,P0,E0,C0,D0,k0,N0,L0,R0,z0,M0,B0,F0,V0,$c,Ac,G0,U0,W0,o3,i3,H0,Va=N(()=>{"use strict";le();he();Je();ge();r3=(n,e,r,t,o,i,a)=>{let s=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=R("inputData",r,[s],4),c=V("outputData",t,[s],4),p=[{name:"vec_size",type:"u32"}];return a&&p.push(...a),`
  ...
  }`},ke=(n,e,r,t,o,i=n.dataType,a,s)=>{let u=[{type:12,data:Math.ceil(D.size(n.dims)/4)}];return a&&u.push(...a),{name:e,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:l=>r3(l,D.size(n.dims),n.dataType,i,r,t,s),getRunData:l=>({outputs:[{dims:n.dims,dataType:i}],dispatchGroup:{x:Math.ceil(D.size(l[0].dims)/64/4)},programUniforms:u})}},c0=n=>{n.compute(ke(n.inputs[0],"Abs","abs"))},d0=n=>{n.compute(ke(n.inputs[0],"Acos","acos"))},p0=n=>{n.compute(ke(n.inputs[0],"Acosh","acosh"))},f0=n=>{n.compute(ke(n.inputs[0],"Asin","asin"))},h0=n=>{n.compute(ke(n.inputs[0],"Asinh","asinh"))},m0=n=>{n.compute(ke(n.inputs[0],"Atan","atan"))},g0=n=>{n.compute(ke(n.inputs[0],"Atanh","atanh"))},b0=n=>ce(n),y0=(n,e)=>{let r;switch(e.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${e.to}`)}n.compute(ke(n.inputs[0],"Cast",r,void 0,e.cacheKey,e.to))},n3=n=>{let e,r,t=n.length>=2&&n[1].data!==0,o=n.length>=3&&n[2].data!==0;switch(n[0].dataType){case 1:e=t?n[1].getFloat32Array()[0]:-34028234663852886e22,r=o?n[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:e=t?n[1].getUint16Array()[0]:64511,r=o?n[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ce({min:e,max:r})},_0=(n,e)=>{let r=e||n3(n.inputs),t=st(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"Clip",o=>`clamp(${o}, vec4<${t}>(uniforms.min), vec4<${t}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:n.inputs[0].dataType,data:r.min},{type:n.inputs[0].dataType,data:r.max}],[{name:"min",type:t},{name:"max",type:t}]),{inputs:[0]})},v0=n=>{n.compute(ke(n.inputs[0],"Ceil","ceil"))},w0=n=>{n.compute(ke(n.inputs[0],"Cos","cos"))},x0=n=>{n.compute(ke(n.inputs[0],"Cosh","cosh"))},Wo=n=>ce(n),T0=(n,e)=>{let r=st(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"Elu",t=>`elu_vf32(${t})`,`
...
`,i3=n=>`quick_gelu_impl(${n})`,H0=(n,e)=>{let r=st(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"QuickGelu",i3,o3(r,e.alpha),e.cacheKey,n.inputs[0].dataType))}});var a3,s3,j0,K0=N(()=>{"use strict";he();ge();Va();a3=n=>{if(n[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(n[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(n[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(n[0].dims[2]!==n[1].dims[0])throw new Error("last dimension of input and bias are not the same")},s3=n=>{let e=n[0].dims.slice();e[2]=e[2]/2;let r=R("input",n[0].dataType,n[0].dims,4),t=R("bias",n[0].dataType,[n[0].dims[2]],4),o=V("output",n[0].dataType,e,4),i=D.size(e)/4,a=Be(n[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${n.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${w}
      }`},l3=(n,e,r,t,o,i,a=r.dataType)=>{let s=r.dims.map(y=>Number(y)??1),u=t.dims.map(y=>Number(y)??1),l=!D.areEqual(s,u),c=s,p=D.size(s),h=!1,m=!1,g=[l];if(l){let y=Vr.calcShape(s,u,!1);if(!y)throw new Error("Can't perform binary op on the given tensors");c=y.slice(),p=D.size(c);let T=D.size(s)===1,w=D.size(u)===1,x=s.length>0&&s[s.length-1]%4===0,I=u.length>0&&u[u.length-1]%4===0;g.push(T),g.push(w),g.push(x),g.push(I);let A=1;for(let P=1;P<c.length;P++){let C=s[s.length-P],L=u[u.length-P];if(C===L)A*=C;else break}A%4===0?(m=!0,h=!0):(T||w||x||I)&&(h=!0)}else h=!0;return g.push(h),{name:n,shaderCache:{hint:e+g.map(y=>y.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:y=>u3(y,s,u,c,h,l,m,o,r.dataType,t.dataType,a,i),getRunData:()=>({outputs:[{dims:c,dataType:a}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(D.size(c)/4)},...U(s,u,c)]})}},qr=(n,e,r,t,o,i)=>{n.compute(l3(e,o??"",n.inputs[0],n.inputs[1],r,t,i))},X0=n=>{qr(n,"Add",(e,r)=>`${e}+${r}`)},Z0=n=>{qr(n,"Div",(e,r)=>`${e}/${r}`)},J0=n=>{qr(n,"Equal",{scalar:(e,r)=>`u32(${e}==${r})`,vector:(e,r)=>`vec4<u32>(${e}==${r})`},void 0,void 0,9)},Q0=n=>{qr(n,"Mul",(e,r)=>`${e}*${r}`)},Y0=n=>{let e=R("input",n.inputs[0].dataType,n.inputs[0].dims).type.value;qr(n,"Pow",{scalar:(t,o)=>`pow_custom(${t},${o})`,vector:(t,o)=>`pow_vector_custom(${t},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${e}>, b : vec4<${e}>) -> vec4<${e}> {
      ...
      `)},ev=n=>{qr(n,"Sub",(e,r)=>`${e}-${r}`)},tv=n=>{qr(n,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},rv=n=>{qr(n,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},nv=n=>{qr(n,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ov=n=>{qr(n,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}});var d3,p3,f3,h3,av,sv,uv=N(()=>{"use strict";le();he();Je();ge();d3=(n,e)=>{if(!n||n.length<1)throw new Error("too few inputs");let r=0,t=n[r],o=t.dataType,i=t.dims.length;n.forEach((a,s)=>{if(s!==r){if(a.dataType!==o)throw new Error("input tensors should be one type");if(a.dims.length!==i)throw new Error("input tensors should have the same shape");a.dims.forEach((u,l)=>{if(l!==e&&u!==t.dims[l])throw new Error("non concat dimensions must match")})}})},p3=(n,e)=>`
...
`}return ee};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${p};${h};${m};${o}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:I}),getShaderSource:A}}});var m3,g3,Oc,pv,b3,Pc,y3,qo,qa=N(()=>{"use strict";le();he();ge();_n();Ha();Ua();m3=(n,e)=>n?`
...
`},y3=(n,e,r,t,o=!1)=>{let[i,a,s,u]=t,l=Be(t[0].type.tensor);return`
  ...
  ${y?Oc(T,w,ee,Y):Pc(T,w,ee,Y)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${P}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${y?`vec4<${se}>`:se}) {
        ...
        ${y?Oc(I,x,se,void 0,!l,z):Pc(I,x,se,void 0,!l,z,!1,void 0,s)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${e.cacheKey};${P};${y};${F};${$};${ne};${C};${L};${z}`,inputDependencies:ie},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:n[0].dataType}],dispatchGroup:{x:A[0],y:A[1],z:A[2]},programUniforms:J}),getShaderSource:Y}}});var v3,mv,ja,w3,gv,x3,bv,yv,_v=N(()=>{"use strict";le();Fr();he();ge();_n();Ua();v3=n=>{let e=1;for(let r=0;r<n.length;r++)e*=n[r];return e},mv=n=>typeof n=="number"?[n,n,n]:n,ja=(n,e)=>e<=1?n:n+(n-1)*(e-1),w3=(n,e,r,t=1)=>{let o=ja(e,t);return Math.floor((n[0]*(r-1)-r+o)/2)},gv=(n,e,r,t,o)=>{o==null&&(o=w3(n,e[0],t[0]));let i=[0,0,0,r];for(let a=0;a<3;a++)n[a]+2*o>=e[a]&&(i[a]=Math.trunc((n[a]-e[a]+2*o)/t[a]+1));return i},x3=(n,e,r,t,o,i,a,s,u,l)=>{let c,p,h,m;if(n==="VALID"&&(n=0),typeof n=="number"){c={top:n,bottom:n,left:n,right:n,front:n,back:n};let g=gv([e,r,t,1],[s,u,l],1,[o,i,a],n);p=g[0],h=g[1],m=g[2]}else if(Array.isArray(n)){if(!n.every((y,T,w)=>y===w[0]))throw Error(`Unsupported padding parameter: ${n}`);c={top:n[0],bottom:n[1],left:n[2],right:n[3],front:n[4],back:n[5]};let g=gv([e,r,t,1],[s,u,l],1,[o,i,a],n[0]);p=g[0],h=g[1],m=g[2]}else if(n==="SAME_UPPER"){p=Math.ceil(e/o),h=Math.ceil(r/i),m=Math.ceil(t/a);let g=(p-1)*o+s-e,y=(h-1)*i+u-r,T=(m-1)*a+l-t,w=Math.floor(g/2),x=g-w,I=Math.floor(y/2),A=y-I,P=Math.floor(T/2),C=T-P;c={top:I,bottom:A,left:P,right:C,front:w,back:x}}else throw Error(`Unknown padding parameter: ${n}`);return{padInfo:c,outDepth:p,outHeight:h,outWidth:m}},bv=(n,e,r,t,o,i=!1,a="channelsLast")=>{let s,u,l,c,p;if(a==="channelsLast")[s,u,l,c,p]=n;else if(a==="channelsFirst")[s,p,u,l,c]=n;else throw new Error(`Unknown dataFormat ${a}`);let[h,,m,g,y]=e,[T,w,x]=mv(r),[I,A,P]=mv(t),C=ja(m,I),L=ja(g,A),z=ja(y,P),{padInfo:F,outDepth:$,outHeight:ne,outWidth:Z}=x3(o,u,l,c,T,w,x,C,L,z),J=i?h*p:h,ie=[0,0,0,0,0];return a==="channelsFirst"?ie=[s,J,$,ne,Z]:a==="channelsLast"&&(ie=[s,$,ne,Z,J]),{batchSize:s,dataFormat:a,inDepth:u,inHeight:l,inWidth:c,inChannels:p,outDepth:$,outHeight:ne,outWidth:Z,outChannels:J,padInfo:F,strideDepth:T,strideHeight:w,strideWidth:x,filterDepth:m,filterHeight:g,filterWidth:y,effectiveFilterDepth:C,effectiveFilterHeight:L,effectiveFilterWidth:z,dilationDepth:I,dilationHeight:A,dilationWidth:P,inShape:n,outShape:ie,filterShape:e}},yv=(n,e,r,t,o,i)=>{let a=i==="channelsLast",s=a?n[0].dims[3]:n[0].dims[1],u=!1,l=[64,1,1],c={x:r.map((x,I)=>I)},p=[Math.ceil(v3(c.x.map(x=>r[x]))/l[0]),1,1];be("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${p}`);let h=u?a&&s%4!==0?3:4:1,m=D.size(r),g=[{type:12,data:m},{type:12,data:t},{type:12,data:o},{type:12,data:e.strides},{type:12,data:e.dilations}];Zt(e,g),g.push(...U(n[0].dims,n[1].dims));let y=["rank","rank"],T=n.length===3;T&&(g.push(...U(n[2].dims)),y.push("rank")),g.push(...U(r));let w=x=>{let I=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:t.length},{name:"pads",type:"u32",length:o.length},{name:"strides",type:"u32",length:e.strides.length},{name:"dilations",type:"u32",length:e.dilations.length}];Jt(e,I);let A=u?4:1,P=Be(n[0].dataType),C=R("x",n[0].dataType,n[0].dims.length,h===3?1:h),L=R("W",n[1].dataType,n[1].dims.length,A),z=[C,L],F=V("result",n[0].dataType,r.length,A),$="";if(T){let J=R("bias",n[2].dataType,n[2].dims.length,A);z.push(J),$+=`
  ...
  ${g.mainStart()}
    ...
    ${Qe}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${e.cacheKey};${c}${y}${g}${p}${m}`,inputDependencies:x},getRunData:()=>({dispatchGroup:{x:w[0],y:w[1],z:w[2]},outputs:[{dims:r?r(o):o,dataType:n[0].dataType}],programUniforms:z}),getShaderSource:F}}});var A3,O3,P3,Av,Ov,E3,Pv,C3,Ev,Cv=N(()=>{"use strict";$v();_n();Zr();A3=(n,e,r,t,o,i)=>(n-1)*e+r+(t-1)*o+1-i,O3=(n,e,r,t,o)=>{let i=Math.floor(n/2);e==="SAME_UPPER"?(r[t]=i,r[o]=n-i):e==="SAME_LOWER"&&(r[t]=n-i,r[o]=i)},P3=(n,e,r,t,o,i,a,s,u,l)=>{let c=n.length-2,p=l.length===0;u.length<c&&u.push(...Array(c-u.length).fill(0));let h=n[0],m=e[s?3:1]*o;for(let g=0,y=n.length-c-(s?1:0);g<c;++g,++y){let T=n[y],w=p?T*a[g]:l[g],x=A3(T,a[g],i[g],e[y],r[g],w);O3(x,t,i,g,g+c),p&&l.push(a[g]*(T-1)+u[g]+(e[y]-1)*r[g]+1-i[g]-i[g+c])}l.splice(0,0,h),l.splice(s?3:1,0,m)},Av=(n,e)=>{let r=n.kernelShape.slice();if(n.kernelShape.length===0||n.kernelShape.reduce((p,h)=>p*h,1)===0){r.length=0;for(let p=2;p<e[1].dims.length;++p)r.push(e[1].dims[p])}let t=n.format==="NHWC";r.splice(0,0,e[1].dims[0]),r.splice(t?3:1,0,e[1].dims[1]);let o=n.pads.slice(),i=n.outputShape.slice(),a=n.outputPadding.slice(),s=e[0].dims,u=n.dilations.slice();if(u.reduce((p,h)=>p+h,0)===0){let p=e[0].dims.length-2;u=new Array(p).fill(1)}let l=n.strides.slice();if(l.reduce((p,h)=>p+h,0)===0){let p=e[0].dims.length-2;l=new Array(p).fill(1)}P3(s,r,u,n.autoPad,n.group,o,l,t,a,i);let c=Object.assign({},n);return Object.assign(c,{kernelShape:r,pads:o,outputPadding:a,outputShape:i,dilations:u,strides:l}),c},Ov=n=>{let e=Ga(n),r=n.format,t=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof n.autoPad>"u"?0:n.autoPad],o=n.dilations,i=n.group,a=n.kernelShape,s=n.pads,u=n.strides,l=n.wIsConst(),c=n.outputPadding,p=n.outputShape;return{autoPad:t,format:r,dilations:o,group:i,kernelShape:a,outputPadding:c,outputShape:p,pads:s,strides:u,wIsConst:l,...e,cacheKey:`${n.format};${e.activation};`}},E3=(n,e)=>{if(!n||n.length!==2&&n.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(n[0].dims.length!==4&&n[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(n[0].dims.length!==n[1].dims.length)throw new Error("filter does not have same dimension as input");let r=n[0].dims[e.format==="NHWC"?n[0].dims.length-1:1],t=n[1].dims[0];if(r!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=n[1].dims[1]*e.group;if(n.length===3&&(n[2].dims.length!==1||n[2].dims[0]!==o))throw new Error("invalid bias");let i=n[0].dims.length-2;if(e.dilations.reduce((c,p)=>c+p,0)>0&&e.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(e.strides.reduce((c,p)=>c+p,0)>0&&e.strides.length!==i)throw new Error(`strides should be ${i}D`);if(e.pads.reduce((c,p)=>c+p,0)>0&&e.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(e.outputPadding.length!==i&&e.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(e.kernelShape.reduce((c,p)=>c+p,0)>0&&e.kernelShape.length!==0&&e.kernelShape.length!==n[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==n[0].dims.length-2)throw new Error("invalid output shape")},Pv=(n,e,r,t)=>{let o=n.kernelCustomData.wT??n.compute(ut(e[1],[2,3,0,1]),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!n.kernelCustomData.wT&&(n.kernelCustomData.wT=o);let i=[e[0],o];e.length===3&&i.push(e[2]),n.compute(Sv(i,r,t),{inputs:i})},C3=(n,e)=>{let r=e.format==="NHWC",t=[n.inputs[0].reshape(r?[n.inputs[0].dims[0],1,n.inputs[0].dims[1],n.inputs[0].dims[2]]:[n.inputs[0].dims[0],n.inputs[0].dims[1],1,n.inputs[0].dims[2]]),n.inputs[1].reshape([n.inputs[1].dims[0],n.inputs[1].dims[1],1,n.inputs[1].dims[2]])];n.inputs.length===3&&t.push(n.inputs[2]);let o=e.kernelShape;(o.length===0||o[0]===0)&&(o=[n.inputs[1].dims[2]]);let i=e.dilations;(i.length===0||i[0]===0)&&(i=[1]);let a=e.strides;(a.length===0||a[0]===0)&&(a=[1]);let s=e.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],a=[1].concat(a),i=[1].concat(i),o=[1].concat(o);let u=e.outputPadding;u=[0].concat(u);let l=Av({...e,pads:s,strides:a,dilations:i,kernelShape:o,outputPadding:u},t);Pv(n,t,l,c=>r?[c[0],c[2],c[3]]:[c[0],c[1],c[3]])},Ev=(n,e)=>{if(E3(n.inputs,e),n.inputs[0].dims.length===3)C3(n,e);else{let r=Av(e,n.inputs);Pv(n,n.inputs,r)}}});var D3,Dv,kv,Nv=N(()=>{"use strict";le();he();Je();ge();D3=(n,e,r,t)=>{let o=D.size(e),i=e.length,a=R("input",n,i),s=V("output",n,i),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),l=D.normalizeAxis(u,i),c=p=>{let h=` i32(${a.indicesGet("inputIndices","uniforms.axis")}) `,m=Q("uniforms.input_shape","uniforms.axis",i),g=t.reverse?h+(t.exclusive?" + 1":""):"0",y=t.reverse?m:h+(t.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:e,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...U(e,e)]}),getShaderSource:c}},Dv=(n,e)=>{let r=n.inputs[0].dims,t=n.inputs[0].dataType,o=n.inputs[1];n.compute(D3(t,r,o,e),{inputs:[0]})},kv=n=>{let e=n.exclusive===1,r=n.reverse===1;return ce({exclusive:e,reverse:r})}});var k3,N3,L3,Lv,Rv,zv=N(()=>{"use strict";le();he();Je();ge();k3=n=>{if(!n||n.length!==1)throw new Error("DepthToSpace requires 1 input.");if(n[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},N3=(n,e,r,t)=>{let o=[];o.push(`fn perm(i: ${t.type.indices}) -> ${r.type.indices} {
...
`)};
            ${s.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:n.map(()=>"rank")},getRunData:()=>{let c=u.filter(h=>r.symbolToInfo.has(h)).map(h=>({type:12,data:r.symbolToInfo.get(h)?.dimValue||0}));c.push({type:12,data:a});let p=n.map((h,m)=>[...U(h)]).reduce((h,m)=>h.concat(m),c);return p.push(...U(t)),{outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:p}},getShaderSource:l}},Fv=(n,e)=>{let r=new Rc(n.inputs,e.equation),t=r.outputDims,o=n.inputs.map((i,a)=>i.dims);n.compute(M3(o,n.inputs[0].dataType,r,t))},Vv=n=>{let e=n.equation.replace(/\s+/g,"");return ce({equation:e})}});var B3,Uv,F3,V3,Wv,Hv=N(()=>{"use strict";le();he();ge();B3=n=>{if(!n||n.length!==2)throw new Error("Expand requires 2 input.");let e=n[0].dims,r=Array.from(n[1].getBigInt64Array(),Number),t=r.length<e.length?0:r.length-e.length,o=e.length<r.length?0:e.length-r.length;for(;t<r.length&&o<e.length;++t,++o)if(r[t]!==e[o]&&r[t]!==1&&e[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Uv=(n,e)=>{let r=n.length-e.length,t=[];for(let o=0;o<r;++o)t.push(n[o]);for(let o=0;o<e.length;++o)t.push(e[o]===1?n[o+r]:e[o]);return t},F3=(n,e)=>n.length>e.length?Uv(n,e):Uv(e,n),V3=n=>{let e=n[0].dims,r=Array.from(n[1].getBigInt64Array(),Number),t=F3(e,r),o=n[0].dataType,i=o===9||D.size(e)===1,a=o===9||e.length>0&&e[e.length-1]%4===0?4:1,s=i||t.length>0&&t[t.length-1]%4===0?4:1,u=Math.ceil(D.size(t)/s),l=p=>{let h=R("input",o,e.length,a),m=V("output",o,t.length,s),g;if(o===9){let y=(T,w,x="")=>`
    ...
    ${g}`},c=[{type:12,data:u},...U(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:t,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},Wv=n=>{B3(n.inputs),n.compute(V3(n.inputs),{inputs:[0]})}});var G3,qv,jv=N(()=>{"use strict";le();he();ge();Va();G3=n=>{let e=n[0].dataType,r=D.size(n[0].dims),t=D.size(n[1].dims),o=t%4===0,i=a=>{let s=R("x",e,[1],4),u=R("bias",e,[1],4),l=V("y",e,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=m=>`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${e.cacheKey};${n.filter((g,y)=>y!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:n.length},(g,y)=>"rank")},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:h}),getShaderSource:m}},ew=(n,e)=>{let r=n.inputs;q3(r,e),n.compute(j3(n.inputs,e))},tw=n=>ce({blockSize:n.blockSize,gatherAxis:n.gatherAxis,quantizeAxis:n.quantizeAxis})});var K3,X3,nw,ow,iw=N(()=>{"use strict";le();he();Je();ge();K3=n=>{if(!n||n.length!==2)throw new Error("GatherElements requires 2 inputs.");if(n[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(n[0].dims.length!==n[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return p?{name:"GemmShared",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:s,dataType:n[0].dataType}],dispatchGroup:{x:l*c},programUniforms:m}),getShaderSource:T}:{name:"Gemm",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:s,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:m}),getShaderSource:y}},aw=n=>{let e=n.transA,r=n.transB,t=n.alpha,o=n.beta;return{transA:e,transB:r,alpha:t,beta:o,cacheKey:`${n.transA};${n.transB};${n.alpha===1}`}},sw=(n,e)=>{Z3(n.inputs),n.compute(J3(n.inputs,e))}});var Jr,vn,po,fo,Q3,Y3,eC,tC,rC,nC,oC,iC,lw,cw,dw=N(()=>{"use strict";le();he();Je();ge();[Jr,vn,po,fo]=[0,1,2,3],Q3=n=>{if(n[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(n[0].dims.length!==n[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(n[0].dims.length-2!==n[1].dims[n[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${n[0].dims.length-2}`);if(n[0].dims[0]!==n[1].dims[0])throw new Error("grid batch size must match input batch size")},Y3=`
