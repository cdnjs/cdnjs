...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),_d=(r,e,n)=>pr(r,e,n,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),Td=(r,e,n)=>pr(r,e,n,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),vd=(r,e,n)=>pr(r,e,n,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var Sd,$d=S(()=>{"use strict";be();Sd=(r,e)=>{let n=G.calculateReshapedDims(e[0].dims,e[1].integerData);return r.session.pack?[r.reshapePacked(e[0],n)]:[r.reshapeUnpacked(e[0],n)]}});var Ad,ta,Pd,Od,tn,yw,ra,eo,na=S(()=>{"use strict";Ge();$e();le();Ad={name:"Upsample",inputNames:["X"],inputTypes:[0]},ta=(r,e,n)=>(ra(e,n),[r.run({...Ad,cacheHint:n.cacheKey,get:()=>yw(r,e,n)},e)]),Pd=r=>tn(r,7),Od=r=>tn(r,9),tn=(r,e)=>{let n=e>=10,t=r.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let o=[];e<9&&(o=r.attributes.getFloats("scales"),eo(o,t,n));let i=r.attributes.getFloat("extrapolation_value",0),s=e>10?r.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?r.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let c=r.attributes.getFloat("cubic_coeff_a",-.75),d=r.attributes.getInt("exclude_outside",0)!==0;if(d&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let f=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",m=0,p=0,h=0;return e>10?r.inputs.length>2?(m=1,p=2,h=3):(p=1,h=2):e===9&&(p=1),ie({opset:e,isResize:n,mode:t,scales:o,extrapolationValue:i,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:c,excludeOutside:d,useNearest2xOptimization:f,roiInputIdx:m,scalesInputIdx:p,sizesInputIdx:h})},yw=(r,e,n)=>{let t=q(r.session.backend.glContext.version),[o,i]=r.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((h,y)=>Math.floor(h*n.scales[y])),[a,u]=r.calculateTextureWidthAndHeight(s,0),l=s.length,c=new Array(l),d=new Array(l),f=`
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
                ...
                `;break;default:throw new Error(`resize (packed) does not support coordinateTransformMode:                                 '${n.coordinateTransformMode}'`)}let y=Je(a),b=At(),g=`
...
`);let b="";d<2&&c>0?b="coords":b=s.map((k,N)=>`coords.${y[N+p]}`).join(", ");let g="return outputValue;",_=G.size(s)===1,I=G.size(a)===1;if(c===1&&!_&&!I)g=`
    ...
    `;return new M(E,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(n,t,o,i){let s=[o.width,o.height],a=[t.width,t.height],u=t.unpackedShape.length,l=o.unpackedShape.length,c=t.unpackedShape,d=o.unpackedShape,f=Fn(i);if(u===l&&ir.arraysEqual(a,s)){let _=`
        ...
        `;return new M(_,["coordinates.sampleTexture"])}let m=Je(l),p=Ze.getBroadcastDims(c,d),h=l-u,y,b=Tt();u===0?y="":l<2&&p.length>=1?y="coords = 0;":y=p.map(_=>`coords.${b[_+h]} = 0;`).join(`
...
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},R_=(r,e)=>{kt(r.inputs),Dt(r,"ReduceProd",e,(t,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},N_=(r,e)=>{kt(r.inputs),Dt(r,"ReduceSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},V_=(r,e)=>{kt(r.inputs),Dt(r,"ReduceSumSquare",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},Bt=(r,e,n)=>{if(e.length===0)return n;let t=1,o=1;for(let i=0;i<e.length;i++)e.indexOf(i)===-1?t*=r[i]:o*=r[i];return o<32&&t>1024},$p=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?L_(r,e):hp(r,e)},Ap=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?C_(r,e):gp(r,e)},Pp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?k_(r,e):bp(r,e)},Op=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?D_(r,e):yp(r,e)},Ep=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?B_(r,e):xp(r,e)},Cp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?z_(r,e):wp(r,e)},kp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?R_(r,e):_p(r,e)},Dp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?N_(r,e):Tp(r,e)},Bp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?V_(r,e):vp(r,e)},Lp=(r,e)=>{Bt(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?E_(r,e):Ip(r,e)}});var zp,Rp,Np,La,Vp=S(()=>{"use strict";j();Pe();No();zp=r=>{if(!r||r.length===0||r.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(r[0].dataType!==1)throw new Error("Invalid input type.")},Rp=(r,e)=>{zp(r.inputs);let n=(t,o,i)=>{let s=[];for(let a=0;a<t.rank;a++)(i.indexOf(a)>=0||i.length===0)&&s.push(`input_indices[${a}] = 0;`);return[`${s.join(`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${e.epsilon}_${e.format}_${t}_${s}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:r[0].dims,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...B(i)]:[{type:12,data:u}]})}},K_=r=>Z(r),Fp=(r,e)=>{let{inputs:n,outputCount:t}=r,o=K_({...e,outputCount:t});if(X.webgpu.validateInputContent&&H_(n,o),e.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");r.compute(q_(n,o))}});var j_,X_,Up,Wp=S(()=>{"use strict";te();ne();j_=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(r[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},X_=r=>{let e=r[0].dims,n=r[0].dims[2],t=$.size(e)/4,o=r[0].dataType,i=P("input",o,e,4),s=P("bias",o,[n],4),a=P("residual",o,e,4),u=D("output",o,e,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)}}),getShaderSource:c=>`
  ...
  }`}},Up=r=>{j_(r.inputs),r.compute(X_(r.inputs))}});var Z_,he,Hp,qp,Kp,jp,Xp,Zp,Jp,Yp,Qp,J_,em,tm,rm,nm,dn,om,Fo,im,am,sm,um,lm,cm,dm,fm,pm,mm,hm,gm,bm,ym,xm,wm,_m,Tm,Ra,Na,vm,Im,Sm,Y_,Q_,$m,Go=S(()=>{"use strict";j();te();Pe();ne();Z_=(r,e,n,t,o,i,s)=>{let a=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=P("inputData",n,[a],4),c=D("outputData",t,[a],4),d=[{name:"vec_size",type:"u32"}];return s&&d.push(...s),`
...
`,Na=r=>`(fast_gelu_a + fast_gelu_a * tanh_v(${r} * (fast_gelu_c * ${r} * ${r} + fast_gelu_b))) * ${r}`,vm=r=>{let e=Ve(r.inputs[0].dataType);r.compute(he(r.inputs[0],"FastGelu",Na,Ra(e),void 0,r.inputs[0].dataType))},Im=(r,e)=>{let n=Ve(r.inputs[0].dataType);return r.compute(he(r.inputs[0],"ThresholdedRelu",t=>`select(vec4<${n}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${e.alpha});`,e.cacheKey)),0},Sm=r=>{r.compute(he(r.inputs[0],"Log","log"))},Y_=(r,e)=>`
...
`,Q_=r=>`quick_gelu_impl(${r})`,$m=(r,e)=>{let n=Ve(r.inputs[0].dataType);r.compute(he(r.inputs[0],"QuickGelu",Q_,Y_(n,e.alpha),e.cacheKey,r.inputs[0].dataType))}});var eT,tT,Pm,Om=S(()=>{"use strict";te();ne();Go();eT=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(r[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},tT=r=>{let e=r[0].dims.slice();e[2]=e[2]/2;let n=P("input",r[0].dataType,r[0].dims,4),t=P("bias",r[0].dataType,[r[0].dims[2]],4),o=D("output",r[0].dataType,e,4),i=$.size(e)/4,s=me(r[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
...
`});var pn,qo,Ko=S(()=>{"use strict";j();te();ne();Ft();pn=(r,e,n,t,o)=>{let i=t-n;return`
...
`}return K};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${d};${f};${m};${o}`,inputDependencies:h?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:x}),getShaderSource:_}}});var lT,cT,mn,Wm,dT,hn,fT,gn,bn=S(()=>{"use strict";j();te();ne();Ft();Ko();fn();lT=(r,e)=>r?`
...
`},fT=(r,e,n,t,o=!1)=>{let[i,s,a,u]=t,l=me(t[0].type.tensor);return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${t}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${o}] = value;
        ...
        ${p?mn(g,b,_e,void 0,!u,v):hn(g,b,_e,void 0,!u,v,!1,void 0,a)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${e.cacheKey};${g};${b};${p}`,inputDependencies:C},getRunData:()=>({outputs:[{dims:n,dataType:r[0].dataType}],dispatchGroup:{x:x[0],y:x[1],z:x[2]},programUniforms:N}),getShaderSource:ee}}});var TT,Wa,ih=S(()=>{"use strict";j();vt();te();ne();TT=(r,e,n,t,o,i=!1,s,a,u=!1)=>{let l=u?1:2,c=u?2:3,d=u?3:1,f=i?2:1,m=`
  ...
  ${i?x:_}}`},Wa=(r,e,n)=>{let t=r.length>2,o=e.outputShape,i=$.size(o),s=[Math.ceil(i/64),1,1];ae("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${s}`);let a=e.format==="NHWC",u=["rank","rank"],l=[e.strides[0],e.strides[1]],c=[e.kernelShape[a?1:2],e.kernelShape[a?2:3]],d=[e.dilations[0],e.dilations[1]],f=[c[0]+(e.dilations[0]<=1?0:(e.kernelShape[a?1:2]-1)*(e.dilations[0]-1)),c[1]+(e.dilations[1]<=1?0:(e.kernelShape[a?2:3]-1)*(e.dilations[1]-1))],m=[f[0]-1-Math.floor((e.pads[0]+e.pads[2])/2),f[1]-1-Math.floor(e.pads[1]+e.pads[3])/2],p=!1,h=e.group,y=r[1].dims,b=y[0]/h,g=y[1],x=[{type:12,data:i},{type:12,data:l},{type:12,data:c},{type:12,data:d},{type:12,data:f},{type:6,data:m},{type:12,data:b},{type:12,data:g},...B(r[0].dims,r[1].dims)];t&&(x.push(...B(r[2].dims)),u.push("rank")),x.push(...B(o));let _=s[1]===1&&s[2]===1,v=I=>{let O=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:l.length},{name:"filter_dims",type:"u32",length:c.length},{name:"dilations",type:"u32",length:c.length},{name:"effective_filter_dims",type:"u32",length:f.length},{name:"pads",type:"i32",length:m.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],E=me(r[0].dataType);return`${TT(I,r,o,t,_,p,E,O,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${e.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:s[0],y:s[1],z:s[2]},outputs:[{dims:n?n(o):o,dataType:r[0].dataType}],programUniforms:x}),getShaderSource:v}}});var vT,IT,ST,ah,sh,$T,AT,PT,OT,uh,lh=S(()=>{"use strict";oh();ih();Ft();Mt();vT=(r,e,n,t,o,i)=>(r-1)*e+n+(t-1)*o+1-i,IT=(r,e,n,t,o)=>{let i=Math.floor(r/2);e==="SAME_UPPER"?(n[t]=i,n[o]=r-i):e==="SAME_LOWER"&&(n[t]=r-i,n[o]=i)},ST=(r,e,n,t,o,i,s,a,u,l)=>{let c=r.length-2,d=l.length===0;u.length<c&&u.push(...Array(c-u.length).fill(0));let f=r[0],m=e[a?3:1]*o;for(let p=0,h=r.length-c-(a?1:0);p<c;++p,++h){let y=r[h],b=d?y*s[p]:l[p],g=vT(y,s[p],i[p],e[h],n[p],b);IT(g,t,i,p,p+c),d&&l.push(s[p]*(y-1)+u[p]+(e[h]-1)*n[p]+1-i[p]-i[p+c])}l.splice(0,0,f),l.splice(a?3:1,0,m)},ah=(r,e)=>{let n=r.kernelShape.slice();if(r.kernelShape.length===0||r.kernelShape.reduce((d,f)=>d*f,1)===0){n.length=0;for(let d=2;d<e[1].dims.length;++d)n.push(e[1].dims[d])}let t=r.format==="NHWC";n.splice(0,0,e[1].dims[0]),n.splice(t?3:1,0,e[1].dims[1]);let o=r.pads.slice(),i=r.outputShape.slice(),s=r.outputPadding.slice(),a=e[0].dims,u=r.dilations.slice();if(u.reduce((d,f)=>d+f,0)===0){let d=e[0].dims.length-2;u=new Array(d).fill(1)}let l=r.strides.slice();if(l.reduce((d,f)=>d+f,0)===0){let d=e[0].dims.length-2;l=new Array(d).fill(1)}ST(a,n,u,r.autoPad,r.group,o,l,t,s,i);let c=Object.assign({},r);return Object.assign(c,{kernelShape:n,pads:o,outputPadding:s,outputShape:i,dilations:u,strides:l}),c},sh=r=>{let e=Uo(r),n=r.format,t=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof r.autoPad>"u"?0:r.autoPad],o=r.dilations,i=r.group,s=r.kernelShape,a=r.pads,u=r.strides,l=r.wIsConst(),c=r.outputPadding,d=r.outputShape;return{autoPad:t,format:n,dilations:o,group:i,kernelShape:s,outputPadding:c,outputShape:d,pads:a,strides:u,wIsConst:l,...e,cacheKey:`${r.format};${e.activation};`}},$T=(r,e)=>{if(!r||r.length!==2&&r.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(r[0].dims.length!==4&&r[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(r[0].dims.length!==r[1].dims.length)throw new Error("filter does not have same dimension as input");let n=r[0].dims[e.format==="NHWC"?r[0].dims.length-1:1],t=r[1].dims[0];if(n!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=r[1].dims[1]*e.group;if(r.length===3&&(r[2].dims.length!==1||r[2].dims[0]!==o))throw new Error("invalid bias");let i=r[0].dims.length-2;if(e.dilations.reduce((c,d)=>c+d,0)>0&&e.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(e.strides.reduce((c,d)=>c+d,0)>0&&e.strides.length!==i)throw new Error(`strides should be ${i}D`);if(e.pads.reduce((c,d)=>c+d,0)>0&&e.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(e.outputPadding.length!==i&&e.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(e.kernelShape.reduce((c,d)=>c+d,0)>0&&e.kernelShape.length!==0&&e.kernelShape.length!==r[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==r[0].dims.length-2)throw new Error("invalid output shape")},AT=[2,3,1,0],PT=(r,e,n)=>{let t=ah(n,e),o=n.format==="NHWC",i=t.outputShape,s=i[o?3:1],a=e[0].dims[o?3:1];if(t.group!==1||s===1&&a===1){r.compute(Wa(e,t));return}let u=i[o?1:2],l=i[o?2:3],c=e[1].dims[2],d=e[1].dims[3],f=o?u*l:s,m=o?s:u*l,p=c*d*a,h=!0,y=r.kernelCustomData.wT??r.compute(Me(e[1],AT),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!r.kernelCustomData.wT&&(r.kernelCustomData.wT=y);let b=[e[0],y],g=e.length===3;g&&(!o&&e[2].dims.length===1?b.push(e[2].reshape([e[2].dims[0],1,1])):b.push(e[2])),r.compute(nh(b,t,i,f,m,p,g,h),{inputs:b})},OT=(r,e)=>{let n=e.format==="NHWC",t=[r.inputs[0].reshape(n?[r.inputs[0].dims[0],1,r.inputs[0].dims[1],r.inputs[0].dims[2]]:[r.inputs[0].dims[0],r.inputs[0].dims[1],1,r.inputs[0].dims[2]]),r.inputs[1].reshape([r.inputs[1].dims[0],r.inputs[1].dims[1],1,r.inputs[1].dims[2]])];r.inputs.length===3&&t.push(r.inputs[2]);let o=e.kernelShape;(o.length===0||o[0]===0)&&(o=[r.inputs[1].dims[2]]);let i=e.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=e.strides;(s.length===0||s[0]===0)&&(s=[1]);let a=e.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],s=[1].concat(s),i=[1].concat(i),o=[1].concat(o);let u=ah({...e,pads:a,strides:s,dilations:i,kernelShape:o},t);r.compute(Wa(t,u,l=>n?[l[0],l[2],l[3]]:[l[0],l[1],l[3]]))},uh=(r,e)=>{$T(r.inputs,e),r.inputs[0].dims.length===3?OT(r,e):PT(r,r.inputs,e)}});var ET,ch,dh,fh=S(()=>{"use strict";j();te();Pe();ne();ET=(r,e,n,t)=>{let o=$.size(e),i=e.length,s=P("input",r,i),a=D("output",r,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=$.normalizeAxis(u,i),c=d=>{let f=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,m=F("uniforms.input_shape","uniforms.axis",i),p=t.reverse?f+(t.exclusive?" + 1":""):"0",h=t.reverse?m:f+(t.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:e,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...B(e,e)]}),getShaderSource:c}},ch=(r,e)=>{let n=r.inputs[0].dims,t=r.inputs[0].dataType,o=r.inputs[1];r.compute(ET(t,n,o,e),{inputs:[0]})},dh=r=>{let e=r.exclusive===1,n=r.reverse===1;return Z({exclusive:e,reverse:n})}});var CT,kT,DT,ph,mh,hh=S(()=>{"use strict";j();te();Pe();ne();CT=r=>{if(!r||r.length!==1)throw new Error("DepthToSpace requires 1 input.");if(r[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},kT=(r,e,n,t)=>{let o=[];o.push(`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${f}`},u=[{type:12,data:s},...B(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:t,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},Th=r=>{RT(r.inputs),r.compute(VT(r.inputs),{inputs:[0]})}});var MT,Ih,Sh=S(()=>{"use strict";j();te();ne();Go();MT=r=>{let e=r[0].dataType,n=$.size(r[0].dims),t=$.size(r[1].dims),o=t%4===0,i=s=>{let a=P("x",e,[1],4),u=P("bias",e,[1],4),l=D("y",e,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],d=m=>`
  ...
  }`};return d?{name:"GemmShared",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:l*c},programUniforms:m}),getShaderSource:y}:{name:"Gemm",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:m}),getShaderSource:h}},Lh=r=>{let e=r.transA,n=r.transB,t=r.alpha,o=r.beta;return{transA:e,transB:n,alpha:t,beta:o,cacheKey:`${r.transA};${r.transB};${r.alpha===1}`}},zh=(r,e)=>{KT(r.inputs),r.compute(jT(r.inputs,e))}});var Gt,Yt,zr,Rr,XT,ZT,JT,YT,QT,ev,tv,rv,Nh,Vh,Mh=S(()=>{"use strict";j();te();Pe();ne();[Gt,Yt,zr,Rr]=[0,1,2,3],XT=r=>{if(r[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(r[0].dims.length!==r[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(r[0].dims.length-2!==r[1].dims[r[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${r[0].dims.length-2}`);if(r[0].dims[0]!==r[1].dims[0])throw new Error("grid batch size must match input batch size")},ZT=`
...
`,tv=(r,e,n)=>(()=>{switch(n.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${r.setByOffset("global_idx","result")}`,rv=(r,e)=>{let n=P("x",r[0].dataType,r[0].dims.length),t=[r[1].dims[0],r[1].dims[1],r[1].dims[2]],o=P("grid",r[1].dataType,t.length,2),i=[r[0].dims[0],r[0].dims[1],r[1].dims[1],r[1].dims[2]];e.format==="NHWC"&&(i=[r[0].dims[0],r[1].dims[1],r[1].dims[2],r[0].dims[3]],[Gt,Yt,zr,Rr]=[0,3,1,2]);let s=D("output",r[0].dataType,i.length),a=n.type.value,u=$.size(i),l=[{type:12,data:u},...B(r[0].dims,t,i)],c=d=>`
...
`)}
  ...
  }`};r.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:p},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:[{type:12,data:c},...B(f,m,f)]}),getShaderSource:h},{inputs:[e[0],d]})},mv=(r,e,n)=>{let t=e[0].dims,o=t,i=t[0],s=t[t.length-1],a=$.sizeFromDimension(t,1)/s,u=xe(s),l=$.size(o)/u,c=[{type:12,data:a},{type:12,data:Math.floor(s/u)}],d=["type","type"],f=!1,m=[0,t.length-1];for(let b=0;b<t.length-2;b++)f=f||t[b+1]!==1,m.push(b+1);f=f&&t[t.length-1]!==1;let p=f?r.compute(Me(r.inputs[0],m),{inputs:[r.inputs[0]],outputs:[-1]})[0]:r.inputs[0].reshape(Array.from({length:t.length},(b,g)=>t[m[g]])),h=Xh(r,p,e[1],e[2],i,a,s,n.epsilon),y=b=>{let g=me(e[0].dataType),x=u===1?"vec2f":`mat${u}x2f`,_=O=>{let E=O===0?"x":"y",k=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${g}(${k}(scale.${E}))`;case 2:return`vec2<${g}>(${k}(scale[0].${E}, scale[1].${E}))`;case 4:return`vec4<${g}>(${k}(scale[0].${E}, scale[1].${E}, scale[2].${E}, scale[3].${E}))`;default:throw new Error(`Not supported compoents ${u}`)}},v=P("input",e[0].dataType,e[0].dims,u),I=D("output",e[0].dataType,o,u);return`
