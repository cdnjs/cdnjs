...
`)},Us=i=>F({axis:i.attributes.getInt("axis")}),Bp=i=>{if(!i||i.length<1)throw new Error("too few inputs");let e=i[0].type,o=i[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of i){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function Fp(){return Pt("abs")}function Cp(){return Pt("acos")}function Np(){return Pt("asin")}function Rp(){return Pt("atan")}function Gp(){return Pt("ceil")}function Mp(){return Pt("cos")}function Vp(i){let e="elu";return{body:`
...
}`}var yu,gu,ad,ud,qr=x(()=>{"use strict";U();R();Vt();xe();vo();yu=(i,e,o)=>(ud(e),i.session.pack?[i.run(jr(i,e,o),e)]:[i.run(To(e,o),e)]),gu=i=>Ce(i.attributes),ad=(i,e)=>({name:"MatMul",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[0,0,0]:[0,0],cacheHint:e});ud=i=>{if(!i||i.length!==2)throw new Error("MatMul requires 2 inputs.");if(i[0].dims[i[0].dims.length-1]!==i[1].dims[i[1].dims.length-2])throw new Error("shared dimension does not match.");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64")throw new Error("inputs should be float type");if(i[0].type!==i[1].type)throw new Error("inputs types should match")}});function cd(i,e,o,t){let r=[],n=[],s=o[0].dims,a=o[1].dims,u=s.length,l=a.length,f=t.length,c=f-u,d=f-l;r=s.map((v,L)=>`coords.${e[L+c]}`),r[u-1]="i*2",r.join(", "),n=a.map((v,L)=>`coords.${e[L+d]}`),n[l-2]="i*2",n.join(", ");let m=dt.getBroadcastDims(s,t),y=dt.getBroadcastDims(a,t),g=m.map(v=>`coords.${e[v+c]} = 0;`).join(`
...
`)},Cd=i=>{if(!i||i.length!==1)throw new Error("Transpose requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("input should be float tensor")}});var Du,Lu,Nd,$u=x(()=>{"use strict";Xr();Du=(i,e,o)=>{Nd(e);let t=o.blocksize,r=t*t,n=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[e[0].dims[0],t,t,e[0].dims[1]/r,e[0].dims[2],e[0].dims[3]]:[e[0].dims[0],e[0].dims[1]/r,t,t,e[0].dims[2],e[0].dims[3]],a=i.reshapeUnpacked(e[0],s),u={perm:n,cacheKey:`${n}`},[l]=Te(i,[a],u),f=[e[0].dims[0],e[0].dims[1]/r,e[0].dims[2]*t,e[0].dims[3]*t];return[i.reshapeUnpacked(l,f)]},Lu=i=>{let e=i.attributes.getInt("blocksize");if(e<1)throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);let o=i.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:e}},Nd=i=>{if(i.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${i.length}`);if(i[0].type==="string"||i[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var ku,Bu,Rd,Fu=x(()=>{"use strict";U();ku=(i,e,o)=>{Rd(e,o);let t=A.flattenShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},Bu=i=>i.attributes.getInt("axis",1),Rd=(i,e)=>{if(!i||i.length!==1)throw new Error("Flatten requires 1 input.");let o=i[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(e<-o||e>o)throw new Error("Invalid axis");if(i[0].type==="string")throw new Error("string tensor is not supported.")}});var re,nr=x(()=>{"use strict";re=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var Cu,Nu,Gd,Md,Vd,Ud,Ru=x(()=>{"use strict";at();nr();U();R();Cu=(i,e,o)=>(Ud(e,o.axis),[i.run(Vd(i,e,o),e)]),Nu=i=>F({axis:i.attributes.getInt("axis",0)}),Gd={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Md=(i,e,o,t)=>{let r=o[0].dims.slice(),n=o[1].dims.slice(),s=new Array(r.length+n.length-1);t=A.normalizeAxis(t,r.length);let a=[];for(let d=0;d<s.length;d++)d<t?(s[d]=r[d],a.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<t+n.length?(s[d]=n[d-t],a.push(`indexDataIdx[${d-t}] = outputIdx[${d}];`)):(s[d]=r[d-n.length+1],a.push(`inputIdx[${d-n.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=r.length,f=n.length||1,c=`
...
`)}
    ...
    `;return{...o,output:{dims:r,type:e[0].type,textureType:0},shaderSource:a}},Gh=i=>{if(!i||i.length!==2)throw new Error("Tile requires 2 input.");if(i[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(i[1].dims[0]!==i[0].dims.length)throw new Error("Invalid input shape.");if(re.indexOf(i[0].type)===-1)throw new Error("Invalid input type.");if(i[1].type!=="int32"&&i[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Co,uf,lf,Mh,Vh,ff=x(()=>{"use strict";U();Co=(i,e,o)=>{Mh(e);let t=A.unsqueezeShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},uf=(i,e)=>(Vh(e),Co(i,[e[0]],Array.from(e[1].integerData))),lf=i=>i.attributes.getInts("axes"),Mh=i=>{if(!i||i.length!==1)throw new Error("Unsqueeze requires 1 input.");if(i[0].type==="string")throw new Error("invalid input tensor types.")},Vh=i=>{if(!i||i.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(i[1].type!=="int32")throw new Error("Invalid input type.")}});var cf,pf=x(()=>{"use strict";ws();Bs();Ns();zs();Hr();Ou();$u();Fu();Ru();Uu();Hu();Ku();Qu();qr();nl();bl();_l();Ol();$l();Bl();Gl();Kl();Ql();rf();of();sf();Xr();xo();ff();Lo();cf=[["Abs","","6+",Ws],["Acos","","7+",Hs],["Add","","7+",vs],["And","","7+",Is],["Asin","","7+",qs],["Atan","","7+",js],["AveragePool","","7+",il,al],["BatchNormalization","","7+",xs,Ts],["Cast","","6+",Fs,Cs],["Ceil","","6+",Js],["Clip","","6-10",yo,Xs],["Clip","","11+",Ks],["Concat","","4+",Ms,Us],["Conv","","1+",So,Oo],["ConvTranspose","","1+",_u,Su],["Cos","","7+",Zs],["Div","","7+",_s],["Dropout","","7+",go],["DepthToSpace","","1+",Du,Lu],["Equal","","7+",Ss],["Elu","","6+",Ys,Qs],["Exp","","6+",tu],["Flatten","","1+",ku,Bu],["Floor","","6+",eu],["FusedConv","com.microsoft","1+",So,Oo],["Gather","","1+",Cu,Nu],["Gemm","","7-10",Ao,Mu],["Gemm","","11+",Ao,Vu],["GlobalAveragePool","","1+",ul,ll],["GlobalMaxPool","","1+",hl],["Greater","","7+",Os],["Identity","","1+",go],["ImageScaler","","1+",zu,Wu],["InstanceNormalization","","6+",ju,Xu],["LeakyRelu","","6+",ru,nu],["Less","","7+",As],["LRN","","1+",Ju,Zu],["Log","","6+",ou],["MatMul","","1+",yu,gu],["MaxPool","","1+",fl,cl],["Mul","","7+",Ps],["Neg","","6+",iu],["Not","","1+",au],["Or","","7+",Es],["Pad","","2-10",Po,tl],["Pad","","11+",el,rl],["Pow","","7+",Ds],["PRelu","","7+",Ls],["ReduceLogSum","","1+",vl,ne],["ReduceMax","","1+",xl,ne],["ReduceMean","","1+",gl,ne],["ReduceMin","","1+",Tl,ne],["ReduceProd","","1+",wl,ne],["ReduceSum","","1-12",yl,ne],["ReduceSumSquare","","1+",Il,ne],["Relu","","6+",su],["Reshape","","5+",Sl],["Resize","","10",ko,Dl],["Resize","","11+",ko,Ll],["Shape","","1+",kl],["Sigmoid","","6+",uu],["Sin","","7+",lu],["Slice","","10+",Rl],["Slice","","1-9",Fl,Cl],["Softmax","","1-12",zl,Wl],["Softmax","","13+",ql,Hl],["Split","","2-12",Zl,Yl],["Sqrt","","6+",fu],["Squeeze","","1-12",Fo,ef],["Squeeze","","13+",tf],["Sub","","7+",$s],["Sum","","6+",nf],["Tan","","7+",cu],["Tanh","","6+",pu],["Tile","","6+",af],["Transpose","","1+",Te,Pu],["Upsample","","7-8",Eo,Pl],["Upsample","","9",Eo,El],["Unsqueeze","","1-12",Co,lf],["Unsqueeze","","13+",uf],["Xor","","7+",ks]]});function hf(i){let e={},o;for(;(o=df.exec(i))!==null;){let t=o[3].split(",").map(r=>{let n=r.trim().split(" ");return n&&n.length===2?{type:n[0],name:n[1]}:null}).filter(r=>r!==null);e[o[2]]={params:t,body:o[4]}}for(let t in e){let r=Uh.replace("__FUNC__",t),n=new RegExp(r,"gm");for(;(o=n.exec(i))!==null;){let s=o[1],a=o[2],u=o[3].split(","),l=s?`${s} ${a};`:"",f=e[t].body,c="";e[t].params.forEach((m,y)=>{m&&(c+=`${m.type} ${m.name} = ${u[y]};
`)}),f=`${c}
 ${f}`,f=f.replace("return",`${a} = `);let d=`
      ...
      `;i=i.replace(o[0],d)}}return i=i.replace(df,""),i}var df,Uh,mf=x(()=>{"use strict";df=/@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm,Uh="(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;"});function Re(i,e){let o=[],t=[],r=e!=null&&Array.isArray(e)&&e.length===0,n=e==null||r?null:zh(e,i).sort(),s=0;for(let a=0;a<i.length;++a){if(n!=null){if(n[s]===a&&i[a]!==1)throw new Error(`Can't squeeze axis ${a} since its dim '${i[a]}' is not 1`);(n[s]==null||n[s]>a)&&i[a]===1&&(o.push(i[a]),t.push(a)),n[s]<=a&&s++}i[a]!==1&&(o.push(i[a]),t.push(a))}return{newShape:o,keptDims:t}}function zh(i,e){let o=e.length;return i=i==null?e.map((t,r)=>r):[].concat(i),$e(i.every(t=>t>=-o&&t<o),()=>`All values in axis param must be in range [-${o}, ${o}) but got axis ${i}`),$e(i.every(Wh),()=>`All values in axis param must be integers but got axis ${i}`),i.map(t=>t<0?o+t:t)}function Wh(i){return i%1===0}function Hh(i){if(i.length===0)return 1;let e=i[0];for(let o=1;o<i.length;o++)e*=i[o];return e}function bf(i){let e=Math.ceil(Math.sqrt(i));return[e,Math.ceil(i/e)]}var Yr,No=x(()=>{"use strict";vt();U();Yr=class{constructor(e){this.maxTextureSize=e}computeTextureWH(e,o){let t=this.computeTexture(e,o);return o&&o.isPacked&&(t[0]/=2,t[1]/=2),o&&o.reverseWH?[t[1],t[0]]:t}computeTexture(e,o){let t=o&&o.isPacked;if(e.length===0)return t?[2,2]:[1,1];let r=this.maxTextureSize;if(o&&o.breakAxis!==void 0){let a=o.breakAxis>=e.length?1:e.slice(o.breakAxis).reduce((l,f)=>l*f),u=o.breakAxis<=0?1:e.slice(0,o.breakAxis).reduce((l,f)=>l*f);if(a>r||u>r)z.verbose("TextureLayout",`Given width/height preferences were unattainable: shape:${e}, breakAxis:${o.breakAxis}`);else return[a,u]}let n=e.slice(0);t&&(r=r*2,n=n.map((a,u)=>u>=n.length-2?n[u]%2===0?n[u]:n[u]+1:n[u]),n.length===1&&(n=[2,n[0]])),n.length!==2&&(n=Re(n).newShape);let s=Hh(n);return n.length<=1&&s<=r?[1,s]:n.length===2&&n[0]<=r&&n[1]<=r?n:n.length===3&&n[0]*n[1]<=r&&n[2]<=r?[n[0]*n[1],n[2]]:n.length===3&&n[0]<=r&&n[1]*n[2]<=r?[n[0],n[1]*n[2]]:n.length===4&&n[0]*n[1]*n[2]<=r&&n[3]<=r?[n[0]*n[1]*n[2],n[3]]:n.length===4&&n[0]<=r&&n[1]*n[2]*n[3]<=r?[n[0],n[1]*n[2]*n[3]]:t?bf(s/4).map(a=>a*2):bf(s)}}});var Qr,yf=x(()=>{"use strict";U();Xt();X();No();Vt();Qr=class extends Ot{constructor(o){super(o)}getFunctions(){return{...this.offsetToCoords(),...this.coordsToOffset(),...this.toVec(),...this.valueFrom(),...this.getCommonUtilFuncs(),...this.getInputsSamplingSnippets(),...this.getOutputSamplingSnippet()}}getCustomTypes(){return{}}offsetToCoords(){let o="offsetToCoords";return{offsetToCoords:new O(`
