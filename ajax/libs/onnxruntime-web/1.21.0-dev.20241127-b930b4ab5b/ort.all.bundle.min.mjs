...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[e(n.type),n.length??1])}},Jh=(r,e)=>new Qs(r,e)});var O2,Qh,P2,E2,C2,k2,it,eb,tb,pr=k(()=>{"use strict";fe();he();Ke();ge();O2=r=>{if(!r||r.length!==1)throw new Error("Transpose requires 1 input.")},Qh=(r,e)=>e&&e.length!==r?[...new Array(r).keys()].reverse():e,P2=(r,e)=>C.sortBasedOnPerm(r,Qh(r.length,e)),E2=(r,e,n,t)=>{let o=`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let i=0;i<e;++i)o+=n.indicesSet("a",r[i],`i[${i}]`);return o+="return a;}"},C2=(r,e)=>{let n=[],t=[];for(let o=0;o<r.length;++o)r[o]!==1&&n.push(r[o]),r[e[o]]!==1&&t.push(e[o]);return{newShape:n,newPerm:t}},k2=(r,e)=>{let n=0;for(let t=0;t<r.length;++t)if(e[r[t]]!==1){if(r[t]<n)return!1;n=r[t]}return!0},it=(r,e)=>{let n=r.dataType,t=r.dims.length,o=Qh(t,e),i=P2(r.dims,o),s=r.dims,a=i,u=k2(o,r.dims),l;if(u)return l=h=>{let _=B("input",n,s,4),w=G("output",n,a,4);return`
