  ...
  ${f.mainStart()}
    ...
    ${y.setByOffset("global_idx",b.getByIndices("aIndices"))}
       ...
       `,m=f=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},ke=(e,t,n,r)=>{let o=e.inputs.length===1?n:Mn(e.inputs,n),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((h,m)=>m));let s=$.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],d=ad(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ce(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=rd(a.length,u.dims.length));let[l,c]=od(u.dims,a),p=l;o.keepDims&&(p=id(l,s)),e.compute(ud(t,o.cacheKey,[u],r,e.inputs[0].dataType,p,c),{inputs:[u]})},co=(e,t)=>{ke(e,"ReduceMeanShared",t,"mean")},po=(e,t)=>{ke(e,"ReduceL1Shared",t,"l1")},mo=(e,t)=>{ke(e,"ReduceL2Shared",t,"l2")},fo=(e,t)=>{ke(e,"ReduceLogSumExpShared",t,"logSumExp")},ho=(e,t)=>{ke(e,"ReduceMaxShared",t,"max")},go=(e,t)=>{ke(e,"ReduceMinShared",t,"min")},yo=(e,t)=>{ke(e,"ReduceProdShared",t,"prod")},bo=(e,t)=>{ke(e,"ReduceSumShared",t,"sum")},_o=(e,t)=>{ke(e,"ReduceSumSquareShared",t,"sumSquare")},wo=(e,t)=>{ke(e,"ReduceLogSumShared",t,"logSum")}});var Ee,dd,Gt,Mn,ze,ld,cd,pd,md,fd,hd,gd,yd,bd,_d,Pe,vo,xo,So,To,Io,Co,Ao,ko,Eo,zo,Wt=A(()=>{"use strict";U();W();re();H();$o();Ee=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},dd=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Gt=(e,t,n,r,o,i,s=!1,a=!1)=>{let u=[],d=n[0].dims,l=d.length,c=$.normalizeAxes(o,l),p=!a&&c.length===0;d.forEach((b,y)=>{p||c.indexOf(y)>=0?s&&u.push(1):u.push(b)});let h=u.length,m=$.size(u);return{name:e,shaderCache:t,getShaderSource:b=>{let y=[],g=S("_A",n[0].dataType,l),_=C("output",i,h),w=r(g,_,c),v=w[2];for(let x=0,T=0;x<l;x++)p||c.indexOf(x)>=0?(s&&T++,v=`for(var j${x}: u32 = 0; j${x} < ${d[x]}; j${x}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...E(i)]:[{type:12,data:u}]})}},Cd=e=>V(e),Ro=(e,t)=>{let{inputs:n,outputCount:r}=e,o=Cd({...t,outputCount:r});if(X.webgpu.validateInputContent&&Td(n,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Id(n,o))}});var Ad,kd,Vo,No=A(()=>{"use strict";W();H();Ad=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},kd=e=>{let t=e[0].dims,n=e[0].dims[2],r=$.size(t)/4,o=e[0].dataType,i=S("input",o,t,4),s=S("bias",o,[n],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:l=>`
  ...
  }`}},Vo=e=>{Ad(e.inputs),e.compute(kd(e.inputs))}});var Ed,J,Lo,Wo,Go,Ho,qo,Fo,Ko,jo,Zo,zd,Qo,Xo,Yo,Jo,pt,ei,qt,ti,ni,ri,oi,ii,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,Vn,Nn,_i,wi,$i,Pd,Bd,vi,Ft=A(()=>{"use strict";U();W();re();H();Ed=(e,t,n,r,o,i,s)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let d=S("inputData",n,[a],4),l=C("outputData",r,[a],4),c=[{name:"vec_size",type:"u32"}];return s&&c.push(...s),`
  ...
  }`},J=(e,t,n,r,o,i=e.dataType,s,a)=>{let u=[{type:12,data:Math.ceil($.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:d=>Ed(d,$.size(e.dims),e.dataType,i,n,r,a),getRunData:d=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil($.size(d[0].dims)/64/4)},programUniforms:u})}},Lo=e=>{e.compute(J(e.inputs[0],"Abs","abs"))},Wo=e=>{e.compute(J(e.inputs[0],"Acos","acos"))},Go=e=>{e.compute(J(e.inputs[0],"Acosh","acosh"))},Ho=e=>{e.compute(J(e.inputs[0],"Asin","asin"))},qo=e=>{e.compute(J(e.inputs[0],"Asinh","asinh"))},Fo=e=>{e.compute(J(e.inputs[0],"Atan","atan"))},Ko=e=>{e.compute(J(e.inputs[0],"Atanh","atanh"))},jo=e=>V(e),Zo=(e,t)=>{let n;switch(t.to){case 10:n="vec4<f16>";break;case 1:n="vec4<f32>";break;case 12:n="vec4<u32>";break;case 6:n="vec4<i32>";break;case 9:n="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(J(e.inputs[0],"Cast",n,void 0,t.cacheKey,t.to))},zd=e=>{let t,n,r=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return V({min:t,max:n})},Qo=(e,t)=>{let n=t||zd(e.inputs),r=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},Xo=e=>{e.compute(J(e.inputs[0],"Ceil","ceil"))},Yo=e=>{e.compute(J(e.inputs[0],"Cos","cos"))},Jo=e=>{e.compute(J(e.inputs[0],"Cosh","cosh"))},pt=e=>V(e),ei=(e,t)=>{let n=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,ti=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,qt(t)))},ni=e=>{e.compute(J(e.inputs[0],"Exp","exp"))},ri=e=>{e.compute(J(e.inputs[0],"Floor","floor"))},oi=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,qt(t)))},ii=(e,t)=>{let n=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},si=e=>{e.compute(J(e.inputs[0],"Not",t=>`!${t}`))},ai=e=>{e.compute(J(e.inputs[0],"Neg",t=>`-${t}`))},ui=e=>{e.compute(J(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},di=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},li=e=>{e.compute(J(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ci=e=>V(e),pi=(e,t)=>{let n=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},mi=e=>{e.compute(J(e.inputs[0],"Sin","sin"))},fi=e=>{e.compute(J(e.inputs[0],"Sinh","sinh"))},hi=e=>{e.compute(J(e.inputs[0],"Sqrt","sqrt"))},gi=e=>{e.compute(J(e.inputs[0],"Tan","tan"))},yi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,bi=e=>{e.compute(J(e.inputs[0],"Tanh",yi))},Vn=(e="f32")=>`
...
`,Nn=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,_i=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"FastGelu",Nn,Vn(t),void 0,e.inputs[0].dataType))},wi=(e,t)=>{let n=le(e.inputs[0].dataType);return e.compute(J(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},$i=e=>{e.compute(J(e.inputs[0],"Log","log"))},Pd=(e,t)=>`
...
`,Bd=e=>`quick_gelu_impl(${e})`,vi=(e,t)=>{let n=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"QuickGelu",Bd,Pd(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var Dd,Od,Si,Ti=A(()=>{"use strict";W();H();Ft();Dd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Od=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),i=$.size(t)/4,s=ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${y}
      }`},Rd=(e,t,n,r,o,i,s=n.dataType)=>{let a=n.dims.map(f=>Number(f)??1),u=r.dims.map(f=>Number(f)??1),d=!$.areEqual(a,u),l=a,c=$.size(a),p=!1,h=!1,m=[d];if(d){let f=Ae.calcShape(a,u,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");l=f.slice(),c=$.size(l);let b=$.size(a)===1,y=$.size(u)===1,g=a.length>0&&a[a.length-1]%4===0,_=u.length>0&&u[u.length-1]%4===0;m.push(b),m.push(y),m.push(g),m.push(_);let w=1;for(let v=1;v<l.length;v++){let x=a[a.length-v],T=u[u.length-v];if(x===T)w*=x;else break}w%4===0?(h=!0,p=!0):(b||y||g||_)&&(p=!0)}else p=!0;return m.push(p),{name:e,shaderCache:{hint:t+m.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>Md(f,a,u,l,p,d,h,o,n.dataType,r.dataType,s,i),getRunData:()=>({outputs:[{dims:l,dataType:s}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil($.size(l)/4)},...E(a,u,l)]})}},Be=(e,t,n,r,o,i)=>{e.compute(Rd(t,o??"",e.inputs[0],e.inputs[1],n,r,i))},Ii=e=>{Be(e,"Add",(t,n)=>`${t}+${n}`)},Ci=e=>{Be(e,"Div",(t,n)=>`${t}/${n}`)},Ai=e=>{Be(e,"Equal",{scalar:(t,n)=>`u32(${t}==${n})`,vector:(t,n)=>`vec4<u32>(${t}==${n})`},void 0,void 0,9)},ki=e=>{Be(e,"Mul",(t,n)=>`${t}*${n}`)},Ei=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Be(e,"Pow",{scalar:(r,o)=>`pow_custom(${r},${o})`,vector:(r,o)=>`pow_vector_custom(${r},${o})`},`
...
`)},Wd=(e,t,n,r)=>{let o=$.size(n),i=new Array(e.length),s=new Array(e.length),a=0,u=[],d=[],l=[{type:12,data:o}];for(let f=0;f<e.length;++f)a+=e[f].dims[t],i[f]=a,d.push(e[f].dims.length),s[f]=S(`input${f}`,r,d[f]),u.push("rank"),l.push({type:12,data:i[f]});for(let f=0;f<e.length;++f)l.push(...E(e[f].dims));l.push(...E(n));let c=C("output",r,n.length),p=c.indicesGet("indices",t),h=Array.from(Array(i.length).keys()).map(f=>`uniforms.sizeInConcatAxis${f}`).join(","),m=f=>`
  ...
  ${f.mainStart()}
    ...
    ${Ld(s,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:l}),getShaderSource:m}},Ri=(e,t)=>{let n=e.inputs,r=n[0].dims,o=$.normalizeAxis(t.axis,r.length);Vd(n,o);let i=r.slice();i[o]=n.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let s=n.filter(a=>$.size(a.dims)>0);e.compute(Wd(s,o,i,n[0].dataType),{inputs:s})},Ui=e=>V({axis:e.axis})});var Se,Te,Ie,Kt,Ne=A(()=>{"use strict";U();W();Se=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Te=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ie=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Kt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=e?.activation_params||[ro,oo];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}});var pe,Ni,jt=A(()=>{"use strict";pe=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Ni=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var Li,Wi=A(()=>{"use strict";Li=e=>`
...
`});var mt,Zt,Qt=A(()=>{"use strict";U();W();H();Ne();mt=(e,t,n,r,o)=>{let i=r-n;return`
...
`},Zt=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s[s.length-2],d=a[a.length-1],l=s[s.length-1],c=Y(d),p=Y(l),h=Y(u),m=$.size(n)/c/h,f=e.length>2,b=r?r.slice(0,-2):n.slice(0,-2),g=[$.size(b),u,d],_=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:l}];Te(t,_),_.push(...E(b,s,a)),f&&_.push(...E(e[2].dims)),_.push(...E(g));let w=v=>{let x=Lt("batch_dims",e[0].dataType,b.length),T=S("a",e[0].dataType,s.length,p),I=S("b",e[1].dataType,a.length,c),k=C("output",e[0].dataType,g.length,c),B=ee(k.type.tensor),O=Se(t,k.type.value,B),L=[T,I],P="";if(f){let N=o?c:1;L.push(S("bias",e[2].dataType,e[2].dims.length,N)),P=`${o?`value += bias[col / ${N}];`:`value += ${k.type.value}(bias[row + i]);`}`}let R=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Ie(t,R);let ne=()=>{let N=`var a_data: ${T.type.value};`;for(let q=0;q<p;q++)N+=`
...
`}return N};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${p};${h};${o}`,inputDependencies:f?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:_}),getShaderSource:w}}});var Gd,Hd,Ln,Gi,qd,Wn,Fd,ft,Xt=A(()=>{"use strict";U();W();H();Ne();Qt();jt();Gd=(e,t)=>e?`
...
`},Fd=(e,t,n,r,o=!1)=>{let[i,s,a,u]=r,d=ee(r[0].type.tensor);return`
    ...
    `},ft=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s.slice(0,-2),d=a.slice(0,-2),l=r?r.slice(0,-2):n.slice(0,-2),c=$.size(l),p=s[s.length-2],h=s[s.length-1],m=a[a.length-1],f=h%4===0&&m%4===0,b=p<=8?[4,1,1]:[4,4,1],y=[8,8,1],g=[Math.ceil(m/y[0]/b[0]),Math.ceil(p/y[1]/b[1]),Math.ceil(c/y[2]/b[2])],_=f?4:1,w=[...u,p,h/_],v=w.length,x=[...d,h,m/_],T=x.length,I=[c,p,m/_],k=[{type:6,data:p},{type:6,data:m},{type:6,data:h}];Te(t,k),k.push(...E(l,w,x));let B=["rank","rank"],O=e.length>2;O&&(k.push(...E(e[2].dims)),B.push("rank")),k.push(...E(I));let L=P=>{let R=l.length,ne=Lt("batchDims",e[0].dataType,R,1),N=ee(e[0].dataType),q=S("a",e[0].dataType,v,_),K=S("b",e[1].dataType,T,_),F=C("result",e[0].dataType,I.length,_),se=[q,K];if(O){let M=o?_:1;se.push(S("bias",e[2].dataType,e[2].dims.length,M))}let ye=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];Ie(t,ye);let ae=ee(F.type.tensor),Q=Se(t,F.type.value,ae),z=Fd(_,O,Q,[ne,q,K,F],o);return`
  ${P.registerUniforms(ye).registerInternalVariables(ne).declareVariables(...se,F)}
  ${z}
  ${f?Ln(b,y,N,ne):Wn(b,y,N,ne)}
                   `};return{name:"MatMul",shaderCache:{hint:`${b};${t.activation};${f};${o}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:k}),getShaderSource:L}}});var Kd,Hi,qi=A(()=>{"use strict";U();Ce();H();Ne();jt();Wi();Xt();Kd=(e,t,n,r,o=!1,i,s=4,a=4,u=4,d="f32")=>{let l=B=>{switch(B){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},c=B=>{switch(B){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},p=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${f?`vec4<${F}>`:F}) {
      ...
      }`,ye=S("x",e[0].dataType,e[0].dims.length,v===3?1:v),ae=S("w",e[1].dataType,e[1].dims.length,K),Q=[ye,ae],z=C("result",e[0].dataType,n.length,K);if(s){let M=S("bias",e[2].dataType,e[2].dims.length,K);Q.push(M),se+=`
        fn getBiasByOutputCoords(coords : vec4<i32>) -> ${f?`vec4<${F}>`:F} {
          return bias[coords.${d?"w":"y"}${f?"/ 4":""}];
        }`}return`
        ${Li("uniforms.result_strides")}
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${v}>`:v} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${p};${b}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:c[0],y:c[1],z:c[2]},programUniforms:m}),getShaderSource:y}}});var Xi,Yi,Ji=A(()=>{"use strict";U();W();H();Ne();Xi=(e,t,n,r)=>{let o=e.length>2,i=o?"value += b[output_channel];":"",s=e[0].dims,a=e[1].dims,u=t.format==="NHWC",d=u?n[3]:n[1],l=d/t.group,c=u&&l>=4?Y(d):1,p=$.size(n)/c,h=[{type:12,data:p},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:l}];Te(t,h),h.push(...E(s,[a[0],a[1],a[2],a[3]/c]));let m=o?["rank","rank","rank"]:["rank","rank"];h.push(...E([n[0],n[1],n[2],n[3]/c]));let f=b=>{let y=C("output",e[0].dataType,n.length,c),g=ee(y.type.tensor),_=Se(t,y.type.value,g),w=S("x",e[0].dataType,s.length),v=S("w",e[1].dataType,a.length,c),x=[w,v];o&&x.push(S("b",e[2].dataType,e[2].dims,c));let T=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Ie(t,T);let I=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${c}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Yi=(e,t,n,r)=>{let o=e.length>2,i=Y(n[3]),s=Y(n[2]),a=$.size(n)/i/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],l=[n[0],n[1],n[2],n[3]/i],c=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Te(t,c),c.push(...E(u,d,l));let p=(s-1)*t.strides[1]+d[1],h=m=>{let f=C("output",e[0].dataType,l.length,i),b=ee(f.type.tensor),y=Se(t,f.type.value,b),g=S("x",e[0].dataType,u.length,i),_=S("w",e[1].dataType,d.length,i),w=[g,_];o&&w.push(S("b",e[2].dataType,e[2].dims,i));let v=o?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ie(t,x),`
  ...
  ${m.mainStart()}
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${i};${s};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:h}}});var Xd,Gn,Yd,Hn,qn,es,Jd,el,Fn,ts=A(()=>{"use strict";W();qi();Qi();Xt();Ji();Ne();Qt();De();Xd=(e,t,n,r,o,i)=>{let s=e[0],a=e.slice(i?1:2,i?3:4),u=a.length,d=t[0],c=t.slice(2).map((m,f)=>m+(m-1)*(n[f]-1)),h=a.map((m,f)=>m+r[f]+r[f+u]).map((m,f)=>Math.floor((m-c[f]+o[f])/o[f]));return h.splice(0,0,s),h.splice(i?3:1,0,d),h},Gn=[2,3,1,0],Yd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Hn=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let i=2;i<t[1].dims.length;++i)n[i-2]===0&&(n[i-2]=t[1].dims[i]);let r=e.pads.slice();Ke.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:n,pads:r}),o},qn=e=>{let t=Kt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,i=e.group,s=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},es=(e,t,n,r)=>{let o=n.format==="NHWC",i=Xd(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o);if(n.group!==1){let x=[t[0]];if(o){let I=e.kernelCustomData.wT??e.compute(ce(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I),x.push(I)}else x.push(t[1]);t.length===3&&x.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(Yi(x,n,i,r),{inputs:x}):e.compute(Xi(x,n,i,r),{inputs:x});return}let s=t.length===3,a=t[0].dims[o?1:2],u=t[0].dims[o?2:3],d=t[0].dims[o?3:1],l=t[1].dims[2],c=t[1].dims[3],p=i[o?1:2],h=i[o?2:3],m=i[o?3:1],f=o&&l===a&&c===u&&n.pads[0]===0&&n.pads[1]===0;if(f||l===1&&c===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let x=i[0],T,I,k,B=[];if(o){let P=e.kernelCustomData.wT??e.compute(ce(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=P),f){let R=a*u*d;T=t[0].reshape([1,x,R]),I=P.reshape([1,R,m]),k=[1,x,m]}else T=t[0].reshape([x,a*u,d]),I=P.reshape([1,d,m]),k=[x,p*h,m];B.push(T),B.push(I)}else T=t[0].reshape([x,d,a*u]),I=t[1].reshape([1,m,d]),k=[x,m,p*h],B.push(I),B.push(T);s&&B.push(t[2]);let O=k[2],L=B[0].dims[B[0].dims.length-1];O<8&&L<8?e.compute(Zt(B,n,i,k,o,r),{inputs:B}):e.compute(ft(B,n,i,k,o,r),{inputs:B});return}let b=!0,y=e.kernelCustomData.wT??e.compute(ce(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=y);let g=[t[0],y];s&&g.push(t[2]);let _=o?p*h:m,w=o?m:p*h,v=l*c*d;e.compute(Hi(g,n,i,_,w,v,s,b,r),{inputs:g})},Jd=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),s=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=Hn({...t,pads:o,strides:i,dilations:s,kernelShape:a},r);es(e,r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},el=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",o=Hn(n,t),i=n.autoPad==="NOTSET"?n.pads:n.autoPad,s=ji(t[0].dims,t[1].dims,n.strides,n.dilations,i,!1,r);e.compute(Zi(t,o,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},Fn=(e,t)=>{if(Yd(e.inputs,t),e.inputs[0].dims.length===3)Jd(e,t);else if(e.inputs[0].dims.length===5)el(e,e.inputs,t);else{let n=Hn(t,e.inputs);es(e,e.inputs,n)}}});var ns,rs=A(()=>{"use strict";U();Ce();W();H();ns=(e,t,n)=>{let r=e.length>2,o=t.outputShape,i=t.format==="NHWC",s=t.group,a=e[1].dims,u=a[2]/s,d=a[3],l=i?Y(d):1,c=$.size(o)/l,p=[Math.ceil(c/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${p}`);let h=["rank","rank"],m=[t.strides[0],t.strides[1]],f=[t.kernelShape[i?1:2],t.kernelShape[i?2:3]],b=[t.dilations[0],t.dilations[1]],y=[f[0]+(t.dilations[0]<=1?0:(t.kernelShape[i?1:2]-1)*(t.dilations[0]-1)),f[1]+(t.dilations[1]<=1?0:(t.kernelShape[i?2:3]-1)*(t.dilations[1]-1))],g=[y[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),y[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],_=[{type:12,data:c},{type:12,data:m},{type:12,data:f},{type:12,data:b},{type:12,data:y},{type:6,data:g},{type:12,data:u},{type:12,data:d},...E(e[0].dims,e[1].dims)];r&&(_.push(...E(e[2].dims)),h.push("rank")),_.push(...E(o));let w=v=>{let x=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:m.length},{name:"filter_dims",type:"u32",length:f.length},{name:"dilations",type:"u32",length:f.length},{name:"effective_filter_dims",type:"u32",length:y.length},{name:"pads",type:"i32",length:g.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],T=ee(e[0].dataType),I=i?1:2,k=i?2:3,B=i?3:1,O=S("W",e[1].dataType,e[1].dims.length,l),L=S("Dy",e[0].dataType,e[0].dims.length),P=[L,O];r&&P.push(S("bias",e[2].dataType,[o[B]].length,l));let R=C("result",e[0].dataType,o.length,l),ne=`
    ...
    ${ne}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${l}`,inputDependencies:h},getRunData:()=>({dispatchGroup:{x:p[0],y:p[1],z:p[2]},outputs:[{dims:n?n(o):o,dataType:e[0].dataType}],programUniforms:_}),getShaderSource:w}}});var tl,nl,rl,os,is,ol,ss,il,as,us=A(()=>{"use strict";rs();Ne();De();tl=(e,t,n,r,o,i)=>(e-1)*t+n+(r-1)*o+1-i,nl=(e,t,n,r,o)=>{let i=Math.floor(e/2);t==="SAME_UPPER"?(n[r]=i,n[o]=e-i):t==="SAME_LOWER"&&(n[r]=e-i,n[o]=i)},rl=(e,t,n,r,o,i,s,a,u,d)=>{let l=e.length-2,c=d.length===0;u.length<l&&u.push(...Array(l-u.length).fill(0));let p=e[0],h=t[a?3:1]*o;for(let m=0,f=e.length-l-(a?1:0);m<l;++m,++f){let b=e[f],y=c?b*s[m]:d[m],g=tl(b,s[m],i[m],t[f],n[m],y);nl(g,r,i,m,m+l),c&&d.push(s[m]*(b-1)+u[m]+(t[f]-1)*n[m]+1-i[m]-i[m+l])}d.splice(0,0,p),d.splice(a?3:1,0,h)},os=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){n.length=0;for(let c=2;c<t[1].dims.length;++c)n.push(t[1].dims[c])}let r=e.format==="NHWC";n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let o=e.pads.slice(),i=e.outputShape.slice(),s=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let d=e.strides.slice();if(d.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;d=new Array(c).fill(1)}rl(a,n,u,e.autoPad,e.group,o,d,r,s,i);let l=Object.assign({},e);return Object.assign(l,{kernelShape:n,pads:o,outputPadding:s,outputShape:i,dilations:u,strides:d}),l},is=e=>{let t=Kt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,i=e.group,s=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),l=e.outputPadding,c=e.outputShape;return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,outputPadding:l,outputShape:c,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},ol=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.reduce((l,c)=>l+c,0)>0&&t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.reduce((l,c)=>l+c,0)>0&&t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.reduce((l,c)=>l+c,0)>0&&t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.outputPadding.length!==i&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(t.kernelShape.reduce((l,c)=>l+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},ss=(e,t,n,r)=>{let o=e.kernelCustomData.wT??e.compute(ce(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=o);let i=[t[0],o];t.length===3&&i.push(t[2]),e.compute(ns(i,n,r),{inputs:i})},il=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let i=t.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],s=[1].concat(s),i=[1].concat(i),o=[1].concat(o);let u=os({...t,pads:a,strides:s,dilations:i,kernelShape:o},r);ss(e,r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},as=(e,t)=>{if(ol(e.inputs,t),e.inputs[0].dims.length===3)il(e,t);else{let n=os(t,e.inputs);ss(e,e.inputs,n)}}});var sl,ds,ls,cs=A(()=>{"use strict";U();W();re();H();sl=(e,t,n,r)=>{let o=$.size(t),i=t.length,s=S("input",e,i),a=C("output",e,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),d=$.normalizeAxis(u,i),l=c=>{let p=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,h=D("uniforms.input_shape","uniforms.axis",i),m=r.reverse?p+(r.exclusive?" + 1":""):"0",f=r.reverse?h:p+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...E(t,t)]}),getShaderSource:l}},ds=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,o=e.inputs[1];e.compute(sl(r,n,o,t),{inputs:[0]})},ls=e=>{let t=e.exclusive===1,n=e.reverse===1;return V({exclusive:t,reverse:n})}});var al,ul,dl,ps,ms,fs=A(()=>{"use strict";U();W();re();H();al=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},ul=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)},dl=(e,t)=>{let n,r,o,i,s,a,u=t.format==="NHWC",d=t.blocksize,l=t.mode==="DCR";u?([n,r,o,i]=e.dims,s=l?[n,r,o,d,d,i/d**2]:[n,r,o,i/d**2,d,d],a=l?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([n,r,o,i]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=l?[n,d,d,i/d**2,r,o]:[n,i/d**2,d,d,r,o],a=l?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(s),p=c.dims.length,h=e.dataType,m=S("a",h,p),f=C("output",h,p),b=y=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:y=>{let g=u?[n,r*d,o*d,i/d**2]:[n,i/d**2,r*d,o*d],_=$.size(g),w=c.dims,v=$.sortBasedOnPerm(w,a);return{outputs:[{dims:g,dataType:y[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...E(w,v)]}},getShaderSource:b}},ps=(e,t)=>{al(e.inputs),e.compute(dl(e.inputs[0],t))},ms=e=>V({blocksize:e.blocksize,mode:e.mode,format:e.format})});var Kn,Jt,hs,ll,cl,jn,Zn,gs,pl,ys,bs,_s=A(()=>{"use strict";U();W();re();H();Kn="[a-zA-Z]|\\.\\.\\.",Jt="("+Kn+")+",hs="^"+Jt+"$",ll="("+Jt+",)*"+Jt,cl="^"+ll+"$",jn=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,n){let r=this.symbolToIndices.get(t);r===void 0?r=[n]:r.push(n),this.symbolToIndices.set(t,r)}},Zn=class{constructor(t,n){this.equation=n;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[r,o]=n.includes("->")?n.split("->",2):[n,""];if(!r.match(RegExp(cl)))throw new Error("Invalid LHS term");if(r.split(",").forEach((a,u)=>{let d=t[u].dims.slice();if(!a.match(RegExp(hs)))throw new Error("Invalid LHS term");let l=this.processTerm(a,!0,d,u);this.lhs.push(l)}),o==="")o+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!o.match(RegExp(Jt)))throw new Error("Invalid RHS");o.match(RegExp(Kn,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(o,!1,this.outputDims)}addSymbol(t,n,r){let o=this.symbolToInfo.get(t);if(o!==void 0){if(o.dimValue!==n&&o.count!==1)throw new Error("Dimension mismatch");o.count++,o.inputIndices.push(r)}else o={count:1,dimValue:n,inputIndices:[r]};this.symbolToInfo.set(t,o)}processTerm(t,n,r,o=-1){let i=r.length,s=!1,a=[],u=0;if(!t.match(RegExp(hs))&&!n&&t!=="")throw new Error("Invalid LHS term");let d=t.match(RegExp(Kn,"g")),l=new jn(o);return d?.forEach((c,p)=>{if(c==="..."){if(s)throw new Error("Only one ellipsis is allowed per input term");s=!0;let h=i-d.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=r.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(n)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let f=String.fromCharCode("0".charCodeAt(0)+m);l.addSymbol(f,p+m),this.addSymbol(f,r[u++],o)}}else l.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,r[u++],o)}),l}},gs=e=>e+"_max",pl=(e,t,n,r)=>{let i=e.map(l=>l.length).map((l,c)=>S(`input${c}`,t,l)),s=$.size(r),a=C("output",t,r.length),u=[...n.symbolToInfo.keys()].filter(l=>!n.rhs.symbolToIndices.has(l)),d=l=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",f=[],b=[],y=[],g=[],_=n.symbolToInfo.size===n.rhs.symbolToIndices.size;n.symbolToInfo.forEach((v,x)=>{if(n.rhs.symbolToIndices.has(x)){let T=n.rhs.symbolToIndices.get(x)?.[0];T!==void 0&&n.lhs.forEach((I,k)=>{if(v.inputIndices.includes(k)){let B=I.symbolToIndices.get(x);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(O=>{c.push(`${i[k].indicesSet(`input${k}Indices`,O,a.indicesGet("outputIndices",T))}`)})}})}else n.lhs.forEach((T,I)=>{if(v.inputIndices.includes(I)){let k=T.symbolToIndices.get(x);if(k===void 0)throw new Error("Invalid symbol error");k.forEach(B=>{f.push(`${i[I].indicesSet(`input${I}Indices`,B,`${x}`)}`)}),g.push(`prod *= ${i[I].getByIndices(`input${I}Indices`)};`)}}),b.push(`for(var ${x}: u32 = 0; ${x} < uniforms.${gs(x)}; ${x}++) {`),y.push("}")});let w=_?[...c,`let sum = ${i.map((v,x)=>v.getByIndices(`input${x}Indices`)).join(" * ")};`]:[...c,h,...b,...f,p,...g,m,...y];return`
            ${l.registerUniforms(u.map(v=>({name:`${gs(v)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...i,a)}
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:n.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=u.filter(p=>n.symbolToInfo.has(p)).map(p=>({type:12,data:n.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:s});let c=e.map((p,h)=>[...E(p)]).reduce((p,h)=>p.concat(h),l);return c.push(...E(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:c}},getShaderSource:d}},ys=(e,t)=>{let n=new Zn(e.inputs,t.equation),r=n.outputDims,o=e.inputs.map((i,s)=>i.dims);e.compute(pl(o,e.inputs[0].dataType,n,r))},bs=e=>{let t=e.equation.replace(/\s+/g,"");return V({equation:t})}});var ml,ws,fl,hl,$s,vs=A(()=>{"use strict";U();W();H();ml=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,o=t.length<n.length?0:t.length-n.length;for(;r<n.length&&o<t.length;++r,++o)if(n[r]!==t[o]&&n[r]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},ws=(e,t)=>{let n=e.length-t.length,r=[];for(let o=0;o<n;++o)r.push(e[o]);for(let o=0;o<t.length;++o)r.push(t[o]===1?e[o+n]:t[o]);return r},fl=(e,t)=>e.length>t.length?ws(e,t):ws(t,e),hl=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=fl(t,n),o=e[0].dataType,i=o===9||$.size(t)===1,s=o===9||t.length>0&&t[t.length-1]%4===0?4:1,a=i||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil($.size(r)/a),d=c=>{let p=S("input",o,t.length,s),h=C("output",o,r.length,a),m;if(o===9){let f=(b,y,g="")=>`
    ...
    ${m}`},l=[{type:12,data:u},...E(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${a}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l})}},$s=e=>{ml(e.inputs),e.compute(hl(e.inputs),{inputs:[0]})}});var gl,xs,Ss=A(()=>{"use strict";U();W();H();Ft();gl=e=>{let t=e[0].dataType,n=$.size(e[0].dims),r=$.size(e[1].dims),o=r%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=h=>`
  ...
  ${p.mainStart()}
  ...
  }`};return e.compute({name:"computeSliceOffsets",shaderCache:{hint:`${o.length}_${n.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:l,dataType:e.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:d}),getShaderSource:c},{inputs:[t],outputs:[-1]})[0]},As=(e,t)=>{let n=e.inputs,r=n[0].dims,o=n[0].dataType,i=n[1].dims,s=i[i.length-1],a=$.sizeToDimension(i,i.length-1),u=$.sizeFromDimension(r,t.batchDims+s),d=$.sizeToDimension(r,t.batchDims),l=$.sizeFromDimension(r,t.batchDims),c=a/d,p=new Array(s),h=u;for(let w=0;w<s;++w)p[s-1-w]=h,h*=r[t.batchDims+s-1-w];let m=_l(e,n[1],p,t.batchDims,r,a,c,l,s),f=t.batchDims+s;if(f>r.length)throw new Error("last dimension of indices must not be larger than rank of input tensor");let b=i.slice(0,-1).concat(r.slice(f)),y=$.size(b),g=[{type:12,data:y},{type:12,data:u},...E(n[0].dims,m.dims,b)],_=w=>{let v=S("data",n[0].dataType,n[0].dims.length),x=S("slice_offsets",12,m.dims.length),T=C("output",n[0].dataType,b.length);return`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,f)=>f!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,f)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:d}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},zs=(e,t)=>{let n=e.inputs;wl(n,t),e.compute($l(e.inputs,t))},Ps=e=>V({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var vl,xl,Ds,Os,Ms=A(()=>{"use strict";U();W();re();H();vl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return c?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:d*l},programUniforms:h}),getShaderSource:b}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Rs=e=>{let t=e.transA,n=e.transB,r=e.alpha,o=e.beta;return{transA:t,transB:n,alpha:r,beta:o,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Us=(e,t)=>{Sl(e.inputs),e.compute(Tl(e.inputs,t))}});var Oe,Le,Je,et,Il,Cl,Al,kl,El,zl,Pl,Bl,Ns,Ls,Ws=A(()=>{"use strict";U();W();re();H();[Oe,Le,Je,et]=[0,1,2,3],Il=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Cl=`
...
`,Pl=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Oe}], indices[${Le}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Oe}], indices[${Le}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Oe}], indices[${Le}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Oe}], indices[${Le}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Oe}], indices[${Le}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Oe}], indices[${Le}], border);
            }
          }
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:l},{inputs:[t,n],outputs:[-1]})[0]},ht=(e,t,n,r,o,i,s,a)=>{let u=i;if(s&&$.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Rl(e,i,s,t,r,n*o,a),u=u.reshape([t,r,n,o]),n===1||r===1?u:e.compute(ce(u,Gs.perm),{inputs:[u],outputs:[-1]})[0]}else return i.dims.length===3&&(u=i.reshape([t,r,n,o])),n===1||r===1?u:e.compute(ce(u,Gs.perm),{inputs:[u],outputs:[-1]})[0]},qs=(e,t)=>{let n=Ml(e.inputs,t),r=e.inputs[0],o=ge(e.inputs,1),i=ge(e.inputs,2),s=ge(e.inputs,3),a=ge(e.inputs,4),u=ge(e.inputs,5),d=ge(e.inputs,6),l=ge(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let c=o&&i&&o.dims.length===4&&i.dims.length===4,p=ht(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,s,0);if(c)return Ye(e,p,o,i,a,void 0,d,l,u,n);if(!o||!i)throw new Error("key and value must be provided");let h=ht(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,o,s,n.hiddenSize),m=ht(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,i,s,2*n.hiddenSize);Ye(e,p,h,m,a,void 0,d,l,u,n)}});var Ul,Vl,Nl,Ll,Xn,Fs,Ks,Yn=A(()=>{"use strict";U();W();re();H();Ul=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Vl=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>n.push(Number(o))),r=n.length),V({numOutputs:r,axis:t.axis,splitSizes:n})},Nl=e=>`
...
`)}
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${a};${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:b}),getShaderSource:y},{inputs:[t,n,r],outputs:[-1]})[0]},Hl=(e,t,n)=>{let r=t[0].dims,o=r,i=2,s=r[0],a=r[1],u=$.sizeFromDimension(r,i),d=Y(u),l=$.size(o)/d,c=Xs(e,t[0],t[1],t[2],s,u,a,n.epsilon),p=[s,a,u/d],h=[s,a],m=["type","none"],f=b=>{let y=S("x",t[0].dataType,p.length,d),g=S("scale_shift",1,h.length,2),_=C("output",t[0].dataType,p.length,d),w=[y,g,_];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:l}),getShaderSource:b},{inputs:[t[0],f]})},Ys=(e,t)=>{t.format==="NHWC"?ql(e,e.inputs,t):Hl(e,e.inputs,t)}});var Fl,Kl,ea,ta=A(()=>{"use strict";U();W();H();Fl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Kl=(e,t,n)=>{let r=t.simplified,o=e[0].dims,i=e[1],s=!r&&e[2],a=o,u=$.normalizeAxis(t.axis,o.length),d=$.sizeToDimension(o,u),l=$.sizeFromDimension(o,u),c=$.size(i.dims),p=s?$.size(s.dims):0;if(c!==l||s&&p!==l)throw new Error(`Size of X.shape()[axis:] == ${l}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${c} and bias size of ${p}`);let h=[];for(let v=0;v<o.length;++v)v<u?h.push(o[v]):h.push(1);let m=Y(l),f=["type","type"],b=[{type:12,data:d},{type:1,data:l},{type:12,data:Math.floor(l/m)},{type:1,data:t.epsilon}];s&&f.push("type");let y=n>1,g=n>2,_=v=>{let x=ee(e[0].dataType),T=[S("x",e[0].dataType,e[0].dims,m),S("scale",i.dataType,i.dims,m)];s&&T.push(S("bias",s.dataType,s.dims,m)),T.push(C("output",e[0].dataType,a,m)),y&&T.push(C("mean_data_output",1,h)),g&&T.push(C("inv_std_output",1,h));let I=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${v.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
          ...
          `;return ae},se=()=>{let ae=`
            ...
            col_index += 1;`;return ae},ye=()=>{let ae=`col_index = col * ${m};`;for(let Q=0;Q<m*b;Q++)ae+=`
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:c}],dispatchGroup:{x:v},programUniforms:x}),getShaderSource:B}},oa=(e,t)=>{Zl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Xl(e.inputs,t)):e.compute(Ql(e.inputs,t))},ia=e=>V(e)});var Yl,Jl,ec,tc,nc,rc,oc,ic,aa,ua=A(()=>{"use strict";U();W();H();Yl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Jl=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
      ...
      `},ec=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
          ...
          `},rc=(e,t,n)=>{switch(n.mode){case 0:return Jl(e,t,n.pads.length);case 1:return ec(e,t,n.pads.length);case 2:return tc(e,t,n.pads.length);case 3:return nc(e,t,n.pads.length);default:throw new Error("Invalid mode")}},oc=(e,t)=>{let n=$.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,o=$.size(n),i=[{type:12,data:o},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&i.push({type:s?e[2].dataType:1,data:t.value}),i.push(...E(e[0].dims,n));let a=["rank"],u=d=>{let l=C("output",e[0].dataType,n.length),c=S("x",e[0].dataType,r.length),p=c.type.value,h=rc(l,r.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:s?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},pa=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,sc=e=>`${pa(e)};${e.countIncludePad}`,ac=e=>`${pa(e)};${e.storageOrder};${e.dilations}`,ma=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),fa=(e,t,n,r)=>{let[o,i]=da(t,r,n),s=S("x",t.dataType,t.dims.length),a=s.type.value,u="value += x_val;",d="";o.countIncludePad?d+=`value /= ${a}(uniforms.kernelSize);`:d+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[l,c,p,h,m]=la(i,o);l.push(...E(t.dims,i));let f=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${p};${h};${m}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil($.size(i)/64)},programUniforms:l}),getShaderSource:b=>ca(b,s,t.dims.length,i.length,o,u,d,0,c,p,h,m)}},ha=e=>{let t=e.count_include_pad!==0,n=ma(e);if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...n,cacheKey:""};return{...r,cacheKey:sc(r)}},ga=(e,t)=>{en(e.inputs),e.compute(fa("AveragePool",e.inputs[0],!1,t))},ya={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ba=e=>{let t=e.format;return{format:t,...ya,cacheKey:t}},_a=(e,t)=>{en(e.inputs),e.compute(fa("GlobalAveragePool",e.inputs[0],!0,t))},wa=(e,t,n,r)=>{let[o,i]=da(t,r,n),s=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[l,c,p,h,m]=la(i,o);return l.push(...E(t.dims,i)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${h};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil($.size(i)/64)},programUniforms:l}),getShaderSource:f=>ca(f,u,t.dims.length,i.length,o,s,a,t.dataType===10?-65504:-1e5,c,p,h,m)}},$a=(e,t)=>{en(e.inputs),e.compute(wa("MaxPool",e.inputs[0],!1,t))},va=e=>{let t=e.storage_order,n=e.dilations,r=ma(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:n,...r,cacheKey:""};return{...o,cacheKey:ac(o)}},xa=e=>{let t=e.format;return{format:t,...ya,cacheKey:t}},Sa=(e,t)=>{en(e.inputs),e.compute(wa("GlobalMaxPool",e.inputs[0],!0,t))}});var dc,lc,Ia,Ca,Aa=A(()=>{"use strict";U();W();re();H();dc=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,i)=>i===t.axis||o===e[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},lc=(e,t)=>{let n=$.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,o=r===3,i=e[0].dims,s=e[1].dataType,a=$.size(i),u=r===3||r===2,d=u?[Math.ceil($.size(e[0].dims)/4)]:e[0].dims,l=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil($.size(c.dims)/4)]:c.dims:void 0,h=l.length===0||l.length===1&&l[0]===1,m=h===!1&&l.length===1,f=Y(a),b=h&&(!u||f===4),y=b?f:1,g=b&&!u?f:1,_=S("input",u?12:r,d.length,g),w=S("scale",s,l.length),v=c?S("zero_point",u?12:r,p.length):void 0,x=C("output",s,i.length,y),T=[_,w];v&&T.push(v);let I=[d,l];c&&I.push(p);let k=[{type:12,data:a/y},{type:12,data:n},{type:12,data:t.blockSize},...E(...I,i)],B=O=>{let L=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:v?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:i,dataType:s}],dispatchGroup:{x:Math.ceil(a/y/64),y:1,z:1},programUniforms:k})}},Ia=(e,t)=>{dc(e.inputs,t),e.compute(lc(e.inputs,t))},Ca=e=>V({axis:e.axis,blockSize:e.blockSize})});var cc,pc,ka,Ea=A(()=>{"use strict";we();U();H();cc=(e,t,n)=>{let r=e===t,o=e<t&&n<0,i=e>t&&n>0;if(r||o||i)throw new Error("Range these inputs' contents are invalid.")},pc=(e,t,n,r)=>{let o=Math.abs(Math.ceil((t-e)/n)),i=[o],s=o,a=[{type:12,data:s},{type:r,data:e},{type:r,data:n},...E(i)],u=d=>{let l=C("output",r,i.length),c=l.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${d.registerUniforms(p).declareVariables(l)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:a})}},ka=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),X.webgpu.validateInputContent&&cc(t,n,r),e.compute(pc(t,n,r,e.inputs[0].dataType),{inputs:[]})}});var mc,fc,za,Pa,Ba=A(()=>{"use strict";U();W();re();H();mc=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let o=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,i=`;
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${mc(t.reduction,"output[data_offset + i]","value",m.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:l}},za=e=>V({reduction:e.reduction}),Pa=(e,t)=>{e.compute(fc(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}});var hc,gc,yc,bc,_c,wc,$c,vc,xc,Sc,Tc,Da,Ic,Cc,Ac,kc,Ec,Oa,Ma,Ra=A(()=>{"use strict";U();W();re();H();hc=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:V({interleaved:n}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil($.size(p)/je)},programUniforms:m})}},Ua=(e,t)=>{zc(e.inputs,t),e.compute(Pc(e.inputs,t))}});var Bc,Dc,Na,La=A(()=>{"use strict";U();W();H();Bc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],n=e[1],r=e[2];if(t.dataType!==n.dataType||t.dataType!==r.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(n.dims.length!==3&&n.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=t.dims[t.dims.length-1],i=t.dims[t.dims.length-2];if(n.dims[n.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(n.dims[n.dims.length-2]!==i)throw new Error("Skip must have the same sequence length as input");if(r.dims.length!==1)throw new Error("Gamma must be 1D");if(r.dims[r.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let s=e[3];if(s.dims.length!==1)throw new Error("Beta must be 1D");if(s.dims[s.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let s=e[4];if(s.dims.length!==1)throw new Error("Bias must be 1D");if(s.dims[s.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},Dc=(e,t,n,r)=>{let o=t.simplified,i=e[0].dims,s=$.size(i),a=i,u=s,d=i.slice(-1)[0],l=r?i.slice(0,-1).concat(1):[],c=!o&&e.length>3,p=e.length>4,h=r&&n>1,m=r&&n>2,f=n>3,b=64,y=Y(d),g=[{type:12,data:u},{type:12,data:y},{type:12,data:d},{type:1,data:t.epsilon}],_=v=>{let x=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],T=[S("x",e[0].dataType,e[0].dims,y),S("skip",e[1].dataType,e[1].dims,y),S("gamma",e[2].dataType,e[2].dims,y)];c&&T.push(S("beta",e[3].dataType,e[3].dims,y)),p&&T.push(S("bias",e[4].dataType,e[4].dims,y)),T.push(C("output",e[0].dataType,a,y)),h&&T.push(C("mean_output",1,l)),m&&T.push(C("inv_std_output",1,l)),f&&T.push(C("input_skip_bias_sum",e[0].dataType,a,y));let I=ee(e[0].dataType),k=ee(1,y);return`
      ...
      }`},w=[{dims:a,dataType:e[0].dataType}];return n>1&&w.push({dims:l,dataType:1}),n>2&&w.push({dims:l,dataType:1}),n>3&&w.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${h};${m};${f}`,inputDependencies:e.map((v,x)=>"type")},getShaderSource:_,getRunData:()=>({outputs:w,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:g})}},Na=(e,t)=>{Bc(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Dc(e.inputs,t,e.outputCount,!1),{outputs:r})}});var Oc,tn,Mc,Wa,Rc,Uc,Ga,Ha,qa=A(()=>{"use strict";U();W();re();H();Oc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},tn=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},Mc=(e,t)=>{if(e.length>1){let n=tn(e,1),r=tn(e,2),o=tn(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),V({starts:n,ends:r,axes:o})}else return t},Wa=(e,t,n,r,o)=>{let i=e;return e<0&&(i+=n[r[t]]),o[t]<0?Math.max(0,Math.min(i,n[r[t]]-1)):Math.max(0,Math.min(i,n[r[t]]))},Rc=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:f})}},Ga=(e,t)=>{Oc(e.inputs,t);let n=Mc(e.inputs,t);e.compute(Uc(e.inputs,n),{inputs:[0]})},Ha=e=>{let t=e.starts,n=e.ends,r=e.axes;return V({starts:t,ends:n,axes:r})}});var Vc,Nc,Fa,Ka,ja=A(()=>{"use strict";U();W();re();De();H();Vc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Nc=(e,t)=>{let n=e.inputs[0],r=n.dims,o=$.size(r),i=r.length,s=$.normalizeAxis(t.axis,i),a=s<r.length-1,u,d=[];a?(d=Array.from({length:i},(T,I)=>I),d[s]=i-1,d[i-1]=s,u=e.compute(ce(n,d),{inputs:[n],outputs:[-1]})[0]):u=n;let l=u.dims,c=l[i-1],p=o/c,h=Y(c),m=c/h,f=64;p===1&&(f=256);let b=(T,I)=>I===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:I===2?`max(${T}.x, ${T}.y)`:I===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,y=S("x",u.dataType,u.dims,h),g=C("result",u.dataType,u.dims,h),_=y.type.value,w=ee(u.dataType)==="f32"?`var threadMax = ${_}(-3.402823e+38f);`:`var threadMax = ${_}(-65504.0h);`,v=T=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},...E(e[0].dims,o)]}),getShaderSource:d}},Qa=e=>{Lc(e.inputs),e.compute(Gc(e.inputs),{inputs:[0]})}});var Hc,qc,Ya,Ja=A(()=>{"use strict";U();W();H();Hc=(e,t,n,r,o)=>{let i=C("output_data",o,n.length,4),s=S("a_data",t[1].dataType,t[1].dims.length,4),a=S("b_data",t[2].dataType,t[2].dims.length,4),u=S("c_data",t[0].dataType,t[0].dims.length,4),d,l=(c,p,h)=>`select(${p}, ${c}, ${h})`;if(!r)d=i.setByOffset("global_idx",l(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let c=(p,h,m="")=>{let f=`a_data[index_a${h}][component_a${h}]`,b=`b_data[index_b${h}][component_b${h}]`,y=`bool(c_data[index_c${h}] & (0xffu << (component_c${h} * 8)))`;return`
