...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},so=(e,t)=>new Er(e,t),Je=(e,t)=>{let r=e.length,n=[];for(let o=0;o<r;o++){let i=r-1-o,s=e[i]||1;(t[t.length-1-o]||1)>1&&s===1&&n.unshift(i)}return n}});var gu,ao,yu,bu,ye,uo,lo,Ze=E(()=>{"use strict";R();L();ae();W();gu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},ao=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,yu=(e,t)=>_.sortBasedOnPerm(e,ao(e.length,t)),bu=(e,t,r,n)=>{let o=[];o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let i=0;i<t;++i)o.push(r.indicesSet("a",e[i],`i[${i}]`));return o.push("return a;}"),o.join(`
`)},ye=(e,t)=>{let r=e.dataType,n=e.dims.length,o=ao(n,t),i=yu(e.dims,o),s=A("output",r,i.length),a=S("a",r,n),u;if(o.length===2&&o[0]===1&&o[1]===0){let d=s.type.value,c=[16,16,1];u=l=>`
  ...
  ${d.mainStart()}
    ...
    ${s.setByOffset("global_idx",a.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:h=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Pe=(e,t,r,n)=>{let o=e.inputs.length===1?r:zr(e.inputs,r),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((f,m)=>m));let s=_.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],d=Cu(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ye(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=Su(a.length,u.dims.length));let[c,l]=xu(u.dims,a),p=c;o.keepDims&&(p=Iu(c,s)),e.compute(Au(t,{hint:o.cacheKey,inputDependencies:["type"]},[u],n,e.inputs[0].dataType,p,l),{inputs:[u]})},co=(e,t)=>{Pe(e,"ReduceMeanShared",t,"mean")},po=(e,t)=>{Pe(e,"ReduceL1Shared",t,"l1")},mo=(e,t)=>{Pe(e,"ReduceL2Shared",t,"l2")},fo=(e,t)=>{Pe(e,"ReduceLogSumExpShared",t,"logSumExp")},ho=(e,t)=>{Pe(e,"ReduceMaxShared",t,"max")},go=(e,t)=>{Pe(e,"ReduceMinShared",t,"min")},yo=(e,t)=>{Pe(e,"ReduceProdShared",t,"prod")},bo=(e,t)=>{Pe(e,"ReduceSumShared",t,"sum")},wo=(e,t)=>{Pe(e,"ReduceSumSquareShared",t,"sumSquare")},$o=(e,t)=>{Pe(e,"ReduceLogSumShared",t,"logSum")}});var ze,Eu,Ht,zr,Oe,ku,Pu,zu,Ou,Bu,Du,Ru,Mu,Uu,Vu,Be,_o,So,xo,Io,To,Co,Ao,Eo,ko,Po,Lt=E(()=>{"use strict";R();L();ae();W();vo();ze=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Eu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ht=(e,t,r,n,o,i,s=!1,a=!1)=>{let u=[],d=r[0].dims,c=d.length,l=_.normalizeAxes(o,c),p=!a&&l.length===0;d.forEach((b,y)=>{p||l.indexOf(y)>=0?s&&u.push(1):u.push(b)});let f=u.length,m=_.size(u);return{name:e,shaderCache:t,getShaderSource:b=>{let y=[],g=S("_A",r[0].dataType,c),w=A("output",i,f),$=n(g,w,l),v=$[2];for(let x=0,T=0;x<c;x++)p||l.indexOf(x)>=0?(s&&T++,v=`for(var j${x}: u32 = 0; j${x} < ${d[x]}; j${x}++) {
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${s}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...k(i)]:[{type:12,data:u}]})}},Ku=e=>U(e),Mo=(e,t)=>{let{inputs:r,outputCount:n}=e,o=Ku({...t,outputCount:n});if(K.webgpu.validateInputContent&&qu(r,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Fu(r,o))}});var ju,Zu,Vo,No=E(()=>{"use strict";L();W();ju=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Zu=e=>{let t=e[0].dims,r=e[0].dims[2],n=_.size(t)/4,o=e[0].dataType,i=S("input",o,t,4),s=S("bias",o,[r],4),a=S("residual",o,t,4),u=A("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:c=>`
  ...
  }`}},Vo=e=>{ju(e.inputs),e.compute(Zu(e.inputs))}});var Yu,Z,Wo,Go,Lo,Ho,qo,Fo,Ko,jo,Zo,Qu,Yo,Qo,Xo,Jo,Ft,ei,Kt,ti,ri,ni,oi,ii,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,Br,Dr,wi,$i,vi,jt=E(()=>{"use strict";R();L();ae();W();Yu=(e,t,r,n,o,i)=>{let s=Math.ceil(t/4),a="";typeof o=="string"?a=`${o}(a)`:a=o("a");let u=S("inputData",r,[s],4),d=A("outputData",n,[s],4);return`
  ...
  }`},Z=(e,t,r,n,o,i=e.dataType)=>({name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:s=>Yu(s,_.size(e.dims),e.dataType,i,r,n),getRunData:s=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(_.size(s[0].dims)/64/4)},programUniforms:[{type:12,data:Math.ceil(_.size(e.dims)/4)}]})}),Wo=e=>{e.compute(Z(e.inputs[0],"Abs","abs"))},Go=e=>{e.compute(Z(e.inputs[0],"Acos","acos"))},Lo=e=>{e.compute(Z(e.inputs[0],"Acosh","acosh"))},Ho=e=>{e.compute(Z(e.inputs[0],"Asin","asin"))},qo=e=>{e.compute(Z(e.inputs[0],"Asinh","asinh"))},Fo=e=>{e.compute(Z(e.inputs[0],"Atan","atan"))},Ko=e=>{e.compute(Z(e.inputs[0],"Atanh","atanh"))},jo=e=>U(e),Zo=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Z(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Qu=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:Nt,r=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:Wt;return U({min:t,max:r})},Yo=(e,t)=>{let r=e.inputs.length===1?t:Qu(e.inputs),n=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"Clip",o=>`clamp(${o}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${n}> = vec4(${n}(${r.min}));
    const clip_max_: vec4<${n}> = vec4(${n}(${r.max}));
`,r.cacheKey),{inputs:[0]})},Qo=e=>{e.compute(Z(e.inputs[0],"Ceil","ceil"))},Xo=e=>{e.compute(Z(e.inputs[0],"Cos","cos"))},Jo=e=>{e.compute(Z(e.inputs[0],"Cosh","cosh"))},Ft=e=>U(e),ei=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,ti=e=>{let t=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Kt(t)))},ri=e=>{e.compute(Z(e.inputs[0],"Exp","exp"))},ni=e=>{e.compute(Z(e.inputs[0],"Floor","floor"))},oi=e=>{let t=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Kt(t)))},ii=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},si=e=>{e.compute(Z(e.inputs[0],"Not",t=>`!${t}`))},ai=e=>{e.compute(Z(e.inputs[0],"Neg",t=>`-${t}`))},ui=e=>{e.compute(Z(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},di=e=>{let t=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},li=e=>{e.compute(Z(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},ci=e=>U(e),pi=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},mi=e=>{e.compute(Z(e.inputs[0],"Sin","sin"))},fi=e=>{e.compute(Z(e.inputs[0],"Sinh","sinh"))},hi=e=>{e.compute(Z(e.inputs[0],"Sqrt","sqrt"))},gi=e=>{e.compute(Z(e.inputs[0],"Tan","tan"))},yi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,bi=e=>{e.compute(Z(e.inputs[0],"Tanh",yi))},Br=(e="f32")=>`
...
`,Dr=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,wi=e=>{let t=le(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"FastGelu",Dr,Br(t),void 0,e.inputs[0].dataType))},$i=(e,t)=>{let r=le(e.inputs[0].dataType);return e.compute(Z(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},vi=e=>{e.compute(Z(e.inputs[0],"Log","log"))}});var Xu,Ju,Si,xi=E(()=>{"use strict";L();W();jt();Xu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Ju=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=S("input",e[0].dataType,e[0].dims,4),n=S("bias",e[0].dataType,[e[0].dims[2]],4),o=A("output",e[0].dataType,t,4),i=_.size(t)/4,s=X(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
  }`}},Si=e=>{Xu(e.inputs),e.compute(Ju(e.inputs))}});var ed,td,De,Ii,Ti,Ci,Ai,Ei,ki,Pi,zi,Oi,Bi,Di=E(()=>{"use strict";R();L();W();ed=(e,t,r,n,o,i,s,a,u,d,c,l)=>{let p,f;typeof a=="string"?p=f=(g,w)=>`${a}((${g}),(${w}))`:typeof a=="function"?p=f=a:(p=a.scalar,f=a.vector);let m=A("outputData",c,n.length,4),h=S("aData",u,t.length,4),b=S("bData",d,r.length,4),y;if(o)if(i){let g=_.size(t)===1,w=_.size(r)===1,$=t.length>0&&t[t.length-1]%4===0,v=r.length>0&&r[r.length-1]%4===0;g||w?y=m.setByOffset("global_idx",f(g?`${h.type.value}(${h.getByOffset("0")}.x)`:h.getByOffset("global_idx"),w?`${b.type.value}(${b.getByOffset("0")}.x)`:b.getByOffset("global_idx"))):y=`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${y}
      }`},td=(e,t,r,n,o,i,s=r.dataType)=>{let a=!_.areEqual(r.dims,n.dims),u=r.dims,d=_.size(r.dims),c=!1,l=!1,p=[a];if(a){let f=ke.calcShape(r.dims,n.dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");u=f,d=_.size(u);let m=_.size(r.dims)===1,h=_.size(n.dims)===1,b=r.dims.length>0&&r.dims[r.dims.length-1]%4===0,y=n.dims.length>0&&n.dims[n.dims.length-1]%4===0;p.push(m),p.push(h),p.push(b),p.push(y);let g=1;for(let w=1;w<u.length;w++){let $=r.dims[r.dims.length-w]??1,v=n.dims[n.dims.length-w]??1;if($===v)g*=$;else break}g%4===0?(l=!0,c=!0):(m||h||b||y)&&(c=!0)}else c=!0;return p.push(c),{name:e,shaderCache:{hint:t+p.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>ed(f,r.dims,n.dims,u,c,a,l,o,r.dataType,n.dataType,s,i),getRunData:()=>({outputs:[{dims:u,dataType:s}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(_.size(u)/4)},...k(r.dims,n.dims,u)]})}},De=(e,t,r,n,o,i)=>{e.compute(td(t,o??"",e.inputs[0],e.inputs[1],r,n,i))},Ii=e=>{De(e,"Add",(t,r)=>`${t}+${r}`)},Ti=e=>{De(e,"Div",(t,r)=>`${t}/${r}`)},Ci=e=>{De(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Ai=e=>{De(e,"Mul",(t,r)=>`${t}*${r}`)},Ei=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;De(e,"Pow",{scalar:(n,o)=>`pow_custom(${n},${o})`,vector:(n,o)=>`pow_vector_custom(${n},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},ki=e=>{De(e,"Sub",(t,r)=>`${t}-${r}`)},Pi=e=>{De(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},zi=e=>{De(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Oi=e=>{De(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},Bi=e=>{De(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var nd,od,id,sd,Ri,Mi,Ui=E(()=>{"use strict";R();L();ae();W();nd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,n=e[r],o=n.dataType,i=n.dims.length;e.forEach((s,a)=>{if(a!==r){if(s.dataType!==o)throw new Error("input tensors should be one type");if(s.dims.length!==i)throw new Error("input tensors should have the same shape");s.dims.forEach((u,d)=>{if(d!==t&&u!==n.dims[d])throw new Error("non concat dimensions must match")})}})},od=(e,t)=>`
...
`)},sd=(e,t,r,n)=>{let o=_.size(r),i=new Array(e.length),s=new Array(e.length),a=0,u=[],d=[],c=[{type:12,data:o}];for(let h=0;h<e.length;++h)a+=e[h].dims[t],i[h]=a,d.push(e[h].dims.length),s[h]=S(`input${h}`,n,d[h]),u.push("rank"),c.push({type:12,data:i[h]});for(let h=0;h<e.length;++h)c.push(...k(e[h].dims));c.push(...k(r));let l=A("output",n,r.length),p=l.indicesGet("indices",t),f=Array.from(Array(i.length).keys()).map(h=>`uniforms.sizeInConcatAxis${h}`).join(","),m=h=>`
  ...
  ${h.mainStart()}
    ...
    ${id(s,l)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:c}),getShaderSource:m}},Ri=(e,t)=>{let r=e.inputs,n=r[0].dims,o=_.normalizeAxis(t.axis,n.length);nd(r,o);let i=n.slice();i[o]=r.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let s=r.filter(a=>_.size(a.dims)>0);e.compute(sd(s,o,i,r[0].dataType),{inputs:s})},Mi=e=>U({axis:e.axis})});var Ce,Ae,Ee,Zt,Ne=E(()=>{"use strict";R();L();Ce=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Ae=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ee=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Zt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,n]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:n}}else if(t==="Clip"){let[r,n]=e?.activation_params||[Nt,Wt];return{activation:t,clipMax:n,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}});var ce,Yt,Qt=E(()=>{"use strict";ce=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Yt=e=>`
...
`});var ad,ud,ct,Vi,dd,pt,ld,Jt,mt=E(()=>{"use strict";R();L();W();Ne();Qt();ad=(e,t)=>e?`
        ...
        }`,ct=(e,t,r="f32",n,o=!1,i=32,s=!1,a=32)=>{let u=t[1]*e[1],d=t[0]*e[0],c=o?u:i,l=o?i:u,p=c/t[0],f=i/t[1];if(!((o&&p===4&&e[1]===4||!o&&(p===3||p===4))&&c%t[0]===0&&i%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${o} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
bIndices[${w-2}] = u32(row);
    ...
    `},Jt=(e,t,r,n,o=!1)=>{let i=e[0].dims,s=e[1].dims,a=i.slice(0,-2),u=s.slice(0,-2),d=n?n.slice(0,-2):r.slice(0,-2),c=_.size(d),l=i[i.length-2],p=i[i.length-1],f=s[s.length-1],m=p%4===0&&f%4===0,h=l<=8?[4,1,1]:[4,4,1],b=[8,8,1],y=[Math.ceil(f/b[0]/h[0]),Math.ceil(l/b[1]/h[1]),Math.ceil(c/b[2]/h[2])],g=m?4:1,w=[...a,l,p/g],$=w.length,v=[...u,p,f/g],x=v.length,T=[c,l,f/g],I=[{type:6,data:l},{type:6,data:f},{type:6,data:p}];Ae(t,I),I.push(...k(d,w,v));let z=["rank","rank"],P=e.length>2;P&&(I.push(...k(e[2].dims)),z.push("rank")),I.push(...k(T));let G=J=>{let ne=d.length,Q=Gt("batchDims",e[0].dataType,ne,1),se=X(e[0].dataType),O=S("a",e[0].dataType,$,g),Y=S("b",e[1].dataType,x,g),j=A("result",e[0].dataType,T.length,g),q=[O,Y];if(P){let C=o?g:1;q.push(S("bias",e[2].dataType,e[2].dims.length,C))}let M=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];Ee(t,M);let H=X(j.type.tensor),V=Ce(t,j.type.value,H),fe=ld(g,P,V,[Q,O,Y,j],[a,u,d],o);return`
  ${J.registerUniforms(M).registerInternalVariables(Q).declareVariables(...q,j)}
  ${fe}
  ${m?ct(h,b,se,Q):pt(h,b,se,Q)}
                   `};return{name:"MatMul",shaderCache:{hint:`${h};${t.activation};${m};${o}`,inputDependencies:z},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:y[0],y:y[1],z:y[2]},programUniforms:I}),getShaderSource:G}}});var cd,Ni,Wi=E(()=>{"use strict";R();Ue();W();Ne();Qt();Rr();mt();cd=(e,t,r,n,o=!1,i,s=4,a=4,u=4,d="f32")=>{let c=P=>{switch(P){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${P} is not supported.`)}},l=P=>{switch(P){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${P} is not supported.`)}},p=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${m?`vec4<${j}>`:j}) {
      ...
      }`,M=S("x",e[0].dataType,e[0].dims.length,$===3?1:$),H=S("w",e[1].dataType,e[1].dims.length,Y),V=[M,H],fe=A("result",e[0].dataType,r.length,Y);if(s){let C=S("bias",e[2].dataType,e[2].dims.length,Y);V.push(C),q+=`
        ...
        ${q}
        ${cd(u,I,z,P,s,t,G[0],G[1],G[2],j)}
        ${m?ct(g,y,j,void 0,!u,T):pt(g,y,j,void 0,!u,T,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${$};${m};${I};${z};${P};${v};${x};${T}`,inputDependencies:ne},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:w[0],y:w[1],z:w[2]},programUniforms:J}),getShaderSource:Q}}});var Mr,Gi,Li=E(()=>{"use strict";R();L();W();Ur();Ne();Mr=(e,t,r)=>{let n=e.length>2,o=n?"value += b[output_channel];":"",i=e[0].dims,s=e[1].dims,a=s[0]/t.group,u=t.format==="NHWC",d=er(i,s,t.dilations,t.pads,t.strides,u),c=_.size(d),l=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:a}];Ae(t,l),l.push(...k(i,s));let p=["rank","rank"];n&&(l.push(...k(e[2].dims)),p.push("rank")),l.push(...k(d));let f=m=>{let h=A("output",e[0].dataType,d.length),b=X(h.type.tensor),y=Ce(t,h.type.value,b),g=S("x",e[0].dataType,i.length),w=S("w",e[1].dataType,s.length),$=[g,w];n&&$.push(S("b",e[2].dataType,e[2].dims.length));let v=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];return Ee(t,v),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${o};${i};${l};${u[0]};${u[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:c}),getShaderSource:p}}});var Vr,pd,Hi,Nr=E(()=>{"use strict";R();L();mt();W();Ne();Vr=(e,t,r,n,o=!1)=>{let i=e[0].dims,s=e[1].dims,a=i[i.length-2],u=s[s.length-1],d=i[i.length-1],c=ee(u),l=ee(d),p=ee(a),f=_.size(r)/c/p,m=e.length>2,h=n?n.slice(0,-2):r.slice(0,-2),y=[_.size(h),a,u],g=[{type:12,data:f},{type:12,data:a},{type:12,data:u},{type:12,data:d}];Ae(t,g),g.push(...k(h,i,s)),m&&g.push(...k(e[2].dims)),g.push(...k(y));let w=$=>{let v=Gt("batch_dims",e[0].dataType,h.length),x=S("a",e[0].dataType,i.length,l),T=S("b",e[1].dataType,s.length,c),I=A("output",e[0].dataType,y.length,c),z=X(I.type.tensor),P=Ce(t,I.type.value,z),G=[x,T],J="";if(m){let M=o?c:1;G.push(S("bias",e[2].dataType,e[2].dims.length,M)),J=`${o?`value += bias[col / ${M}];`:`value += ${I.type.value}(bias[row + i]);`}`}let ne=i.slice(0,-2),Q=s.slice(0,-2),se=Je(ne,h),O=Je(Q,h),Y=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Ee(t,Y);let j=(M,H)=>{let V=M.rank,fe=M.name;if(V===2)return`var ${fe}_indices = ${M.type.indices}(0u, 0u);`;let C=v.rank,B=`var ${fe}_indices: ${M.type.indices};`;for(let F=V-2-1,Ie=C-1;F>=0;F--,Ie--)B+=`
${fe}_indices[${F}] = ${C>1?`batch_indices[${Ie}]`:"batch_indices"};`;return H.forEach(F=>{B+=`
...
`}return M};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${l};${p};${o}`,inputDependencies:m?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:g}),getShaderSource:w}},pd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Hi=e=>{pd(e.inputs);let t=ke.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&n<8?e.compute(Vr(e.inputs,{activation:""},t)):e.compute(Jt(e.inputs,{activation:""},t))}});var er,Wr,md,qi,Gr,fd,hd,Lr,Ur=E(()=>{"use strict";L();Wi();mt();Li();Ne();Nr();Ze();er=(e,t,r,n,o,i)=>{let s=e[0],a=e.slice(i?1:2,i?3:4),u=a.length,d=t[0],l=t.slice(2).map((m,h)=>m+(m-1)*(r[h]-1)),f=a.map((m,h)=>m+n[h]+n[h+u]).map((m,h)=>Math.floor((m-l[h]+o[h])/o[h]));return f.splice(0,0,s),f.splice(i?3:1,0,d),f},Wr=[2,3,1,0],md=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support conv 1D and 2D");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[1]*t.group;if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},qi=(e,t)=>{let r=e.kernelShape.slice();for(let i=2;i<t[1].dims.length;++i)r[i-2]===0&&(r[i-2]=t[1].dims[i]);let n=e.pads.slice();Fe.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,n,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:r,pads:n}),o},Gr=e=>{let t=Zt(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,i=e.group,s=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:n,format:r,dilations:o,group:i,kernelShape:s,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},fd=(e,t,r)=>{let n=qi(r,t),o=r.format==="NHWC";if(r.group!==1){if(!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1){let T=er(t[0].dims,t[1].dims,r.dilations,n.pads,r.strides,o),I=e.kernelCustomData.wT??e.compute(ye(t[1],Wr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I);let z=[t[0],I];t.length===3&&z.push(t[2]),e.compute(Gi(z,n,T),{inputs:z})}else e.compute(Mr(t,n));return}let i=t.length===3,s=t[0].dims[o?1:2],a=t[0].dims[o?2:3],u=t[0].dims[o?3:1],d=t[1].dims[2],c=t[1].dims[3],l=er(t[0].dims,t[1].dims,r.dilations,n.pads,r.strides,o),p=l[o?1:2],f=l[o?2:3],m=l[o?3:1],h=o&&d===s&&c===a&&r.pads[0]===0&&r.pads[1]===0;if(h||d===1&&c===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let x=l[0],T,I,z,P=[];if(o){let ne=e.kernelCustomData.wT??e.compute(ye(t[1],Wr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=ne),h){let Q=s*a*u;T=t[0].reshape([1,x,Q]),I=ne.reshape([1,Q,m]),z=[1,x,m]}else T=t[0].reshape([x,s*a,u]),I=ne.reshape([1,u,m]),z=[x,p*f,m];P.push(T),P.push(I)}else T=t[0].reshape([x,u,s*a]),I=t[1].reshape([1,m,u]),z=[x,m,p*f],P.push(I),P.push(T);i&&P.push(t[2]);let G=z[2],J=P[0].dims[P[0].dims.length-1];G<8&&J<8?e.compute(Vr(P,n,l,z,o),{inputs:P}):e.compute(Jt(P,n,l,z,o),{inputs:P});return}let b=!0,y=e.kernelCustomData.wT??e.compute(ye(t[1],Wr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=y);let g=[t[0],y];i&&g.push(t[2]);let w=o?p*f:m,$=o?m:p*f,v=d*c*u;e.compute(Ni(g,n,l,w,$,v,i,b),{inputs:g})},hd=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),s=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=qi({...t,pads:o,strides:i,dilations:s,kernelShape:a},n);e.compute(Mr(n,u,d=>r?[d[0],d[2],d[3]]:[]))},Lr=(e,t)=>{md(e.inputs,t),e.inputs[0].dims.length===3?hd(e,t):fd(e,e.inputs,t)}});var gd,Fi,Ki=E(()=>{"use strict";R();Ue();W();Ne();Qt();Rr();mt();gd=(e,t=!1,r,n,o=4)=>{let i=y=>{switch(y){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  ${i?w:$}}`},Hr=(e,t,r)=>{let n=e.length>2,o=t.outputShape,i=_.size(o),s=[Math.ceil(i/64),1,1];re("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${s}`);let a=t.format==="NHWC",u=["rank","rank"],d=[t.strides[0],t.strides[1]],c=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],l=[t.dilations[0],t.dilations[1]],p=[c[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),c[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],f=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,h=t.group,b=e[1].dims,y=b[0]/h,g=b[1],w=[{type:12,data:i},{type:12,data:d},{type:12,data:c},{type:12,data:l},{type:12,data:p},{type:6,data:f},{type:12,data:y},{type:12,data:g},...k(e[0].dims,e[1].dims)];n&&(w.push(...k(e[2].dims)),u.push("rank")),w.push(...k(o));let $=s[1]===1&&s[2]===1,v=x=>{let T=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:d.length},{name:"filter_dims",type:"u32",length:c.length},{name:"dilations",type:"u32",length:c.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:f.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],I=X(e[0].dataType);return`${yd(x,e,o,n,$,m,I,T,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:s[0],y:s[1],z:s[2]},outputs:[{dims:r?r(o):o,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:v}}});var bd,wd,$d,Zi,Yi,vd,_d,Sd,xd,Qi,Xi=E(()=>{"use strict";Ki();ji();Ne();Ze();bd=(e,t,r,n,o,i)=>(e-1)*t+r+(n-1)*o+1-i,wd=(e,t,r,n,o)=>{let i=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=i,r[o]=e-i):t==="SAME_LOWER"&&(r[n]=e-i,r[o]=i)},$d=(e,t,r,n,o,i,s,a,u,d)=>{let c=e.length-2,l=d.length===0;if(u.length===0)for(let m=0;m<c;++m)u.push(0);let p=e[0],f=t[a?3:1]*o;for(let m=0,h=e.length-c-(a?1:0);m<c;++m,++h){let b=e[h],y=l?b*s[m]:d[m],g=bd(b,s[m],i[m],t[h],r[m],y);wd(g,n,i,m,m+c),l&&d.push(s[m]*(b-1)+u[m]+(t[h]-1)*r[m]+1-i[m]-i[m+c])}d.splice(0,0,p),d.splice(a?3:1,0,f)},Zi=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((l,p)=>l*p,1)===0){r.length=0;for(let l=2;l<t[1].dims.length;++l)r.push(t[1].dims[l])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let o=e.pads.slice(),i=e.outputShape.slice(),s=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((l,p)=>l+p,0)===0){let l=t[0].dims.length-2;u=new Array(l).fill(1)}let d=e.strides.slice();if(d.reduce((l,p)=>l+p,0)===0){let l=t[0].dims.length-2;d=new Array(l).fill(1)}$d(a,r,u,e.autoPad,e.group,o,d,n,s,i);let c=Object.assign({},e);return Object.assign(c,{kernelShape:r,pads:o,outputPadding:s,outputShape:i,dilations:u,strides:d}),c},Yi=e=>{let t=Zt(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,i=e.group,s=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),c=e.outputPadding,l=e.outputShape;return{autoPad:n,format:r,dilations:o,group:i,kernelShape:s,outputPadding:c,outputShape:l,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},vd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.reduce((c,l)=>c+l,0)>0&&t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.reduce((c,l)=>c+l,0)>0&&t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.reduce((c,l)=>c+l,0)>0&&t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.outputPadding.length!==i&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(t.kernelShape.reduce((c,l)=>c+l,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},_d=[2,3,1,0],Sd=(e,t,r)=>{let n=Zi(r,t),o=r.format==="NHWC",i=n.outputShape,s=i[o?3:1],a=t[0].dims[o?3:1];if(n.group!==1||s===1&&a===1){e.compute(Hr(t,n));return}let u=i[o?1:2],d=i[o?2:3],c=t[1].dims[2],l=t[1].dims[3],p=o?u*d:s,f=o?s:u*d,m=c*l*a,h=!0,b=e.kernelCustomData.wT??e.compute(ye(t[1],_d),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let y=[t[0],b],g=t.length===3;g&&(!o&&t[2].dims.length===1?y.push(t[2].reshape([t[2].dims[0],1,1])):y.push(t[2])),e.compute(Fi(y,n,i,p,f,m,g,h),{inputs:y})},xd=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let i=t.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],s=[1].concat(s),i=[1].concat(i),o=[1].concat(o);let u=Zi({...t,pads:a,strides:s,dilations:i,kernelShape:o},n);e.compute(Hr(n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]]))},Qi=(e,t)=>{vd(e.inputs,t),e.inputs[0].dims.length===3?xd(e,t):Sd(e,e.inputs,t)}});var Id,Ji,es,ts=E(()=>{"use strict";R();L();ae();W();Id=(e,t,r,n)=>{let o=_.size(t),i=t.length,s=S("input",e,i),a=A("output",e,i),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=_.normalizeAxis(u,i),c=l=>{let p=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,f=D("uniforms.input_shape","uniforms.axis",i),m=n.reverse?p+(n.exclusive?" + 1":""):"0",h=n.reverse?f:p+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...k(t,t)]}),getShaderSource:c}},Ji=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,o=e.inputs[1];e.compute(Id(n,r,o,t),{inputs:[0]})},es=e=>{let t=e.exclusive===1,r=e.reverse===1;return U({exclusive:t,reverse:r})}});var Td,Cd,Ad,rs,ns,os=E(()=>{"use strict";R();L();ae();W();Td=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Cd=(e,t,r,n)=>{let o=[];o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let i=0;i<t;++i)o.push(r.indicesSet("a",e[i],`i[${i}]`));return o.push("return a;}"),o.join(`
`)},Ad=(e,t)=>{let r,n,o,i,s,a,u=t.format==="NHWC",d=t.blocksize,c=t.mode==="DCR";u?([r,n,o,i]=e.dims,s=c?[r,n,o,d,d,i/d**2]:[r,n,o,i/d**2,d,d],a=c?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,o,i]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],s=c?[r,d,d,i/d**2,n,o]:[r,i/d**2,d,d,n,o],a=c?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let l=e.reshape(s),p=l.dims.length,f=e.dataType,m=S("a",f,p),h=A("output",f,p),b=y=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:y=>{let g=u?[r,n*d,o*d,i/d**2]:[r,i/d**2,n*d,o*d],w=_.size(g),$=l.dims,v=_.sortBasedOnPerm($,a);return{outputs:[{dims:g,dataType:y[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...k($,v)]}},getShaderSource:b}},rs=(e,t)=>{Td(e.inputs),e.compute(Ad(e.inputs[0],t))},ns=e=>U({blocksize:e.blocksize,mode:e.mode,format:e.format})});var qr,tr,is,Ed,kd,Fr,Kr,ss,Pd,as,us,ds=E(()=>{"use strict";R();L();ae();W();qr="[a-zA-Z]|\\.\\.\\.",tr="("+qr+")+",is="^"+tr+"$",Ed="("+tr+",)*"+tr,kd="^"+Ed+"$",Fr=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},Kr=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,o]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(kd)))throw new Error("Invalid LHS term");if(n.split(",").forEach((a,u)=>{let d=t[u].dims.slice();if(!a.match(RegExp(is)))throw new Error("Invalid LHS term");let c=this.processTerm(a,!0,d,u);this.lhs.push(c)}),o==="")o+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!o.match(RegExp(tr)))throw new Error("Invalid RHS");o.match(RegExp(qr,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(o,!1,this.outputDims)}addSymbol(t,r,n){let o=this.symbolToInfo.get(t);if(o!==void 0){if(o.dimValue!==r&&o.count!==1)throw new Error("Dimension mismatch");o.count++,o.inputIndices.push(n)}else o={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,o)}processTerm(t,r,n,o=-1){let i=n.length,s=!1,a=[],u=0;if(!t.match(RegExp(is))&&!r&&t!=="")throw new Error("Invalid LHS term");let d=t.match(RegExp(qr,"g")),c=new Fr(o);return d?.forEach((l,p)=>{if(l==="..."){if(s)throw new Error("Only one ellipsis is allowed per input term");s=!0;let f=i-d.length+1;if(f<0)throw new Error("Ellipsis out of bounds");if(a=n.slice(u,u+f),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let h=String.fromCharCode("0".charCodeAt(0)+m);c.addSymbol(h,p+m),this.addSymbol(h,n[u++],o)}}else c.addSymbol(l,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(l,n[u++],o)}),c}},ss=e=>e+"_max",Pd=(e,t,r,n)=>{let i=e.map(c=>c.length).map((c,l)=>S(`input${l}`,t,c)),s=_.size(n),a=A("output",t,n.length),u=[...r.symbolToInfo.keys()].filter(c=>!r.rhs.symbolToIndices.has(c)),d=c=>{let l=[],p="var prod = 1.0;",f="var sum = 0.0;",m="sum += prod;",h=[],b=[],y=[],g=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach((v,x)=>{if(r.rhs.symbolToIndices.has(x)){let T=r.rhs.symbolToIndices.get(x)?.[0];T!==void 0&&r.lhs.forEach((I,z)=>{if(v.inputIndices.includes(z)){let P=I.symbolToIndices.get(x);if(P===void 0)throw new Error("Invalid symbol error");P.forEach(G=>{l.push(`${i[z].indicesSet(`input${z}Indices`,G,a.indicesGet("outputIndices",T))}`)})}})}else r.lhs.forEach((T,I)=>{if(v.inputIndices.includes(I)){let z=T.symbolToIndices.get(x);if(z===void 0)throw new Error("Invalid symbol error");z.forEach(P=>{h.push(`${i[I].indicesSet(`input${I}Indices`,P,`${x}`)}`)}),g.push(`prod *= ${i[I].getByIndices(`input${I}Indices`)};`)}}),b.push(`for(var ${x}: u32 = 0; ${x} < uniforms.${ss(x)}; ${x}++) {`),y.push("}")});let $=w?[...l,`let sum = ${i.map((v,x)=>v.getByIndices(`input${x}Indices`)).join(" * ")};`]:[...l,f,...b,...h,p,...g,m,...y];return`
            ${c.registerUniforms(u.map(v=>({name:`${ss(v)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...i,a)}
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let c=u.filter(p=>r.symbolToInfo.has(p)).map(p=>({type:12,data:r.symbolToInfo.get(p)?.dimValue||0}));c.push({type:12,data:s});let l=e.map((p,f)=>[...k(p)]).reduce((p,f)=>p.concat(f),c);return l.push(...k(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l}},getShaderSource:d}},as=(e,t)=>{let r=new Kr(e.inputs,t.equation),n=r.outputDims,o=e.inputs.map((i,s)=>i.dims);e.compute(Pd(o,e.inputs[0].dataType,r,n))},us=e=>{let t=e.equation.replace(/\s+/g,"");return U({equation:t})}});var zd,ls,Od,Bd,cs,ps=E(()=>{"use strict";R();L();W();zd=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,o=t.length<r.length?0:t.length-r.length;for(;n<r.length&&o<t.length;++n,++o)if(r[n]!==t[o]&&r[n]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},ls=(e,t)=>{let r=e.length-t.length,n=[];for(let o=0;o<r;++o)n.push(e[o]);for(let o=0;o<t.length;++o)n.push(t[o]===1?e[o+r]:t[o]);return n},Od=(e,t)=>e.length>t.length?ls(e,t):ls(t,e),Bd=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=Od(t,r),o=e[0].dataType,i=o===9?4:1,s=Math.ceil(_.size(n)/i),a=d=>{let c=S("input",o,t.length,i),l=A("output",o,n.length,i),p;if(o===9){let f=(m,h,b="")=>`
    ...
    ${p}`},u=[{type:12,data:s},...k(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},cs=e=>{zd(e.inputs),e.compute(Bd(e.inputs),{inputs:[0]})}});var Dd,ms,fs=E(()=>{"use strict";R();L();W();jt();Dd=e=>{let t=e[0].dataType,r=_.size(e[0].dims),n=_.size(e[1].dims),o=n%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=A("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],l=f=>`
    ...
    ${s.mainStart(Ke)}
      ...
      ${p.mainStart()}
        ...
        ${y}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:l}},hs=e=>U({axis:e.axis}),gs=(e,t)=>{let r=e.inputs;Rd(r),e.compute(Md(e.inputs,t))}});var Ud,Vd,bs,ws,$s=E(()=>{"use strict";R();L();ae();W();Ud=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  ${v.mainStart([l,n.kvNumHeads,1])}
    ...
    ${w}
  }`;return{name:"ConcatPastNew",shaderCache:{hint:`${n.kvNumHeads}${l}${!!t}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:r}],dispatchGroup:p,programUniforms:m}),getShaderSource:$}},Ps=e=>U({...e}),Zd=U({perm:[0,2,1,3]}),ks=(e,t,r,n,o)=>{let i=t,s=n.kvNumHeads,a=n.nReps;return t.dims.length===3&&n.kvSequenceLength!==0&&(i=t.reshape([n.batchSize,n.kvSequenceLength,s,n.headSize])),r?i=e.compute(Es(i,r,i.dataType,n),{inputs:[i,r],outputs:[n.isPastkvBSNH?o:-1]})[0]:i=e.compute(Es(i,void 0,i.dataType,n),{inputs:[i],outputs:[n.isPastkvBSNH?o:-1]})[0],a!==1&&(i=e.compute(Zr([i],[1,1,1,a]),{inputs:[i],outputs:[-1]})[0],i=i.reshape([n.batchSize,n.totalSequenceLength,s*a,n.headSize])),e.compute(ye(i,Zd.perm),{inputs:[i],outputs:[-1]})[0]},zs=(e,t)=>{let r=jd(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let n=ft(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,e.inputs[0],void 0,0),o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,i=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,s=ks(e,e.inputs[1],o,r,1),a=ks(e,e.inputs[2],i,r,2);et(e,n,s,a,void 0,void 0,void 0,void 0,void 0,r,t)}});var Yd,Qd,Xd,Bs,Ds=E(()=>{"use strict";R();L();W();Yd=(e,t)=>{let r=e[0].dims,n=r,o=2,i=_.sizeToDimension(r,o),s=_.sizeFromDimension(r,o),a=ee(s),u=s/a,d=[r[0],r[1],u],c=["rank","type","type"],l=[{type:12,data:s},{type:12,data:u}];l.push(...k(d,d));let p=f=>{let m=S("x",e[0].dataType,d.length,a),h=S("scale",e[1].dataType,e[1].dims),b=S("bias",e[2].dataType,e[2].dims),y=A("output",e[0].dataType,d.length,a),g=[m,h,b,y],w=m.type.value,$=a===1?"f32":`vec${a}<f32>`,v=64,x=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:f},{inputs:[t[0],p]})},Bs=(e,t)=>{t.format==="NHWC"?Xd(e,e.inputs,t):e.compute(Yd(e.inputs,t))}});var Jd,el,Rs,Ms=E(()=>{"use strict";R();L();W();Jd=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},el=(e,t,r)=>{let n=t.simplified,o=e[0].dims,i=e[1],s=!n&&e[2],a=o,u=_.normalizeAxis(t.axis,o.length),d=_.sizeToDimension(o,u),c=_.sizeFromDimension(o,u),l=_.size(i.dims),p=s?_.size(s.dims):0;if(l!==c||s&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
  ...
  ${v.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},$=[{dims:a,dataType:e[0].dataType}];return y&&$.push({dims:f,dataType:1}),g&&$.push({dims:f,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${r};${n}`,inputDependencies:h},getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(d/64)},programUniforms:b}),getShaderSource:w}},Rs=(e,t)=>{Jd(e.inputs),e.compute(el(e.inputs,t,e.outputCount))}});var tl,rl,Us,Vs,Ns=E(()=>{"use strict";R();L();ae();W();tl=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],n=r.dims.length;if(r.dims[n-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let o=Math.floor((t.k+t.blockSize-1)/t.blockSize),i=t.blockSize/8*t.bits,s=e[1];if(!_.areEqual(s.dims,[t.n,o,i]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(_.size(u)!==t.n*o)throw new Error("scales input size error.");if(e.length===4){let c=e[3].dims,l=t.bits>4?t.n*o:t.n*Math.floor((o+1)/2);if(_.size(c)!==l)throw new Error("zeroPoints input size error.")}},rl=(e,t,r,n)=>{let o=e[0].dims,i=o.length,s=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=o[i-2],u=t.k,d=t.n,c=o.slice(0,i-2),l=_.size(c),f=t.blockSize/8*t.bits/4,m=e[0].dataType,h=ee(a),b=ee(t.k),y=ee(f),g=qe(m),w=a*s*g,$=Math.floor(n/w),v=s<=r[0]&&$>0,x=!v||$>=4?ee(d):$>=2&&ee(d)>=2?2:1,T=c.concat([a,d]),I=_.size(T)/x/h,z=v?[]:[{type:12,data:I},{type:12,data:t.blockSize}],P=[l,a,u/b],G=_.convertShape(e[1].dims).slice();G.splice(-1,1,f/y),z.push(...k(P)),z.push(...k(G)),z.push(...k(e[2].dims)),e.length===4&&z.push(...k(_.convertShape(e[3].dims)));let J=[l,a,d/x];z.push(...k(J));let ne=Q=>{let se=P.length,O=S("a",e[0].dataType,se,b),Y=S("b",12,G.length,y),j=S("scales",e[2].dataType,e[2].dims.length),q=[O,Y,j],M=e.length===4?S("zero_points",12,e[3].dims.length):void 0;M&&q.push(M);let H=J.length,V=A("output",e[0].dataType,H,x),fe=[{name:"output_size",type:"u32"},{name:"block_size",type:"u32"}],C=X(e[0].dataType),B=(()=>{switch(b){case 1:return`array<${C}, 8>`;case 2:return`mat4x2<${C}>`;case 4:return`mat2x4<${C}>`;default:throw new Error(`${b}-component is not supported.`)}})(),F=`
        ...
        }`};return{name:v?"BlockwiseMatMulNBits":"MatMulNBits",shaderCache:{hint:`${t.cacheKey};${a};${m};${e.length}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:T,dataType:m}],name:v?"BlockwiseMatMulNBits":"MatMulNBits",dispatchGroup:v?{x:1,y:Math.ceil(d/x),z:l}:{x:Math.ceil(I/64)},programUniforms:z}),getShaderSource:ne}},Us=(e,t)=>{tl(e.inputs,t);let r=e.getMaxComputeWorkgroupSizes(),n=e.getMaxComputeWorkgroupStoragesize();e.compute(rl(e.inputs,t,r,n))},Vs=e=>U(e)});var nl,ol,il,sl,al,ul,dl,ll,Ws,Gs=E(()=>{"use strict";R();L();W();nl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},ol=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
      ...
      `},il=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
          ...
          `},ul=(e,t,r)=>{switch(r.mode){case 0:return ol(e,t,r.pads.length);case 1:return il(e,t,r.pads.length);case 2:return sl(e,t,r.pads.length);case 3:return al(e,t,r.pads.length);default:throw new Error("Invalid mode")}},dl=(e,t)=>{let r=_.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,o=_.size(r),i=[{type:12,data:o},{type:6,data:t.pads}];t.mode===0&&i.push({type:e[0].dataType,data:t.value}),i.push(...k(e[0].dims,r));let s=["rank"],a=u=>{let d=A("output",e[0].dataType,r.length),c=S("x",e[0].dataType,n.length),l=c.type.value,p=ul(d,n.length,t),f=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&f.push({name:"constant_value",type:l}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Fs=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,cl=e=>`${Fs(e)};${e.countIncludePad}`,pl=e=>`${Fs(e)};${e.storageOrder};${e.dilations}`,Ks=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),js=(e,t,r,n)=>{let[o,i]=Ls(t,n,r),s=S("x",t.dataType,t.dims.length),a=s.type.value,u="value += x_val;",d="";o.countIncludePad?d+=`value /= ${a}(uniforms.kernelSize);`:d+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[c,l,p,f,m]=Hs(i,o);c.push(...k(t.dims,i));let h=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${p};${f};${m}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(_.size(i)/64)},programUniforms:c}),getShaderSource:b=>qs(b,s,t.dims.length,i.length,o,u,d,0,l,p,f,m)}},Zs=e=>{let t=e.count_include_pad!==0,r=Ks(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:cl(n)}},Ys=(e,t)=>{rr(e.inputs),e.compute(js("AveragePool",e.inputs[0],!1,t))},Qs={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},Xs=e=>{let t=e.format;return{format:t,...Qs,cacheKey:t}},Js=(e,t)=>{rr(e.inputs),e.compute(js("GlobalAveragePool",e.inputs[0],!0,t))},ea=(e,t,r,n)=>{let[o,i]=Ls(t,n,r),s=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[c,l,p,f,m]=Hs(i,o);return c.push(...k(t.dims,i)),{name:e,shaderCache:{hint:`${n.cacheKey};${p};${f};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(_.size(i)/64)},programUniforms:c}),getShaderSource:h=>qs(h,u,t.dims.length,i.length,o,s,a,t.dataType===10?-65504:-1e5,l,p,f,m)}},ta=(e,t)=>{rr(e.inputs),e.compute(ea("MaxPool",e.inputs[0],!1,t))},ra=e=>{let t=e.storage_order,r=e.dilations,n=Ks(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:r,...n,cacheKey:""};return{...o,cacheKey:pl(o)}},na=e=>{let t=e.format;return{format:t,...Qs,cacheKey:t}},oa=(e,t)=>{rr(e.inputs),e.compute(ea("GlobalMaxPool",e.inputs[0],!0,t))}});var fl,hl,sa,aa=E(()=>{"use strict";_e();R();W();fl=(e,t,r)=>{let n=e===t,o=e<t&&r<0,i=e>t&&r>0;if(n||o||i)throw new Error("Range these inputs' contents are invalid.")},hl=(e,t,r,n)=>{let o=Math.abs(Math.ceil((t-e)/r)),i=[o],s=o,a=[{type:12,data:s},{type:n,data:e},{type:n,data:r},...k(i)],u=d=>{let c=A("output",n,i.length),l=c.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:l},{name:"delta",type:l}];return`
        ${d.registerUniforms(p).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${l}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:n}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:a})}},sa=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),K.webgpu.validateInputContent&&fl(t,r,n),e.compute(hl(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var gl,yl,bl,wl,$l,vl,_l,Sl,xl,Il,Tl,ua,Cl,Al,El,kl,Pl,da,la,ca=E(()=>{"use strict";R();L();ae();W();gl=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},$=[{dims:a,dataType:e[0].dataType}];return r>1&&$.push({dims:c,dataType:1}),r>2&&$.push({dims:c,dataType:1}),r>3&&$.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${f};${m};${h}`,inputDependencies:e.map((v,x)=>"type")},getShaderSource:w,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:g})}},fa=(e,t)=>{Bl(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Dl(e.inputs,t,e.outputCount,!1),{outputs:n})}});var Rl,nr,Ml,ga,Ul,Vl,ya,ba,wa=E(()=>{"use strict";R();L();ae();W();Rl=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},nr=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Ml=(e,t)=>{if(e.length>1){let r=nr(e,1),n=nr(e,2),o=nr(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),U({starts:r,ends:n,axes:o})}else return t},ga=(e,t,r,n,o)=>{let i=e;return e<0&&(i+=r[n[t]]),o[t]<0?Math.max(0,Math.min(i,r[n[t]]-1)):Math.max(0,Math.min(i,r[n[t]]))},Ul=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:h})}},ya=(e,t)=>{Rl(e.inputs,t);let r=Ml(e.inputs,t);e.compute(Vl(e.inputs,r),{inputs:[0]})},ba=e=>{let t=e.starts,r=e.ends,n=e.axes;return U({starts:t,ends:r,axes:n})}});var Nl,Wl,$a,va,_a=E(()=>{"use strict";R();L();ae();W();Nl=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Wl=(e,t)=>{let r=e.dims,n=_.size(r),o=64,i=t.axis;if(i<0&&(i=r.length+i),i<r.length-1)throw new Error("softmax only supports last axis for now.");let s=r[i],a=n/s,u=ee(s),d=s/u,c=(b,y)=>y===4?`max(max(${b}.x, ${b}.y), max(${b}.z, ${b}.w))`:y===2?`max(${b}.x, ${b}.y)`:y===3?`max(max(${b}.x, ${b}.y), ${b}.z)`:b,l=S("x",e.dataType,e.dims,u),p=A("result",e.dataType,e.dims,u),f=l.type.value,m=X(e.dataType)==="f32"?`var threadMax = ${f}(-3.402823e+38f);`:`var threadMax = ${f}(-65504.0h);`,h=b=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${u}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:a},programUniforms:[{type:6,data:d}]}),getShaderSource:h}},$a=(e,t)=>{Nl(e.inputs),e.compute(Wl(e.inputs[0],t))},va=e=>U({axis:e.axis})});var Gl,Ll,Hl,ql,Fl,Sa,xa,Ia=E(()=>{"use strict";R();L();ae();W();Gl=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Ll=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),n=r.length),U({numOutputs:n,axis:t.axis,splitSizes:r})},Hl=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:f,getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p})}},Sa=(e,t)=>{Gl(e.inputs);let r=e.inputs.length===1?t:Ll(e.inputs,t);e.compute(Fl(e.inputs,r),{inputs:[0]})},xa=e=>{let t=e.axis,r=e.splitSizes,n=e.numOutputs<0?r.length:e.numOutputs;if(n!==r.length)throw new Error("numOutputs and splitSizes lengh must be equal");return U({axis:t,numOutputs:n,splitSizes:r})}});var Kl,jl,Ta,Ca=E(()=>{"use strict";R();L();W();Kl=(e,t,r,n,o)=>{let i=A("output_data",o,r.length,4),s=S("a_data",t[1].dataType,t[1].dims.length,4),a=S("b_data",t[2].dataType,t[2].dims.length,4),u=S("c_data",t[0].dataType,t[0].dims.length,4),d,c=(l,p,f)=>`select(${p}, ${l}, ${f})`;if(!n)d=i.setByOffset("global_idx",c(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let l=(p,f,m="")=>{let h=`a_data[index_a${f}][component_a${f}]`,b=`b_data[index_b${f}][component_b${f}]`,y=`bool(c_data[index_c${f}] & (0xffu << (component_c${f} * 8)))`;return`
