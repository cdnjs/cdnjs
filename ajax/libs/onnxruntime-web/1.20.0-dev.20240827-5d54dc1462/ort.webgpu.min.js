...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[t(n.type),n.length??1])}},ao=(e,t)=>new Pn(e,t),Ye=(e,t)=>{let n=e.length,r=[];for(let o=0;o<n;o++){let i=n-1-o,s=e[i]||1;(t[t.length-1-o]||1)>1&&s===1&&r.unshift(i)}return r}});var Eu,uo,Pu,zu,ge,lo,co,je=A(()=>{"use strict";R();N();ie();G();Eu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},uo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Pu=(e,t)=>v.sortBasedOnPerm(e,uo(e.length,t)),zu=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
  ...
  ${d.mainStart()}
    ...
    ${s.setByOffset("global_idx",a.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:h=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Ee=(e,t,n,r)=>{let o=e.inputs.length===1?n:Bn(e.inputs,n),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((f,m)=>m));let s=v.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],d=Wu(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ge(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=Uu(a.length,u.dims.length));let[c,l]=Mu(u.dims,a),p=c;o.keepDims&&(p=Vu(c,s)),e.compute(Gu(t,{hint:o.cacheKey,inputDependencies:["type"]},[u],r,e.inputs[0].dataType,p,l),{inputs:[u]})},po=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},mo=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},fo=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},ho=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},go=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},yo=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},bo=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},wo=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},$o=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},_o=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}});var Pe,Lu,Ft,Bn,ze,Hu,qu,Fu,Ku,ju,Zu,Xu,Qu,Yu,Ju,Oe,xo,So,Io,Co,To,Ao,ko,Eo,Po,zo,qt=A(()=>{"use strict";R();N();ie();G();vo();Pe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Lu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ft=(e,t,n,r,o,i,s=!1,a=!1)=>{let u=[],d=n[0].dims,c=d.length,l=v.normalizeAxes(o,c),p=!a&&l.length===0;d.forEach((y,w)=>{p||l.indexOf(w)>=0?s&&u.push(1):u.push(y)});let f=u.length,m=v.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let w=[],g=S("_A",n[0].dataType,c),b=C("output",i,f),$=r(g,b,l),_=$[2];for(let x=0,I=0;x<c;x++)p||l.indexOf(x)>=0?(s&&I++,_=`for(var j${x}: u32 = 0; j${x} < ${d[x]}; j${x}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},No=e=>{ud(e.inputs),e.compute(dd(e.inputs))}});var ld,X,Go,Lo,Ho,qo,Fo,Ko,jo,Zo,Xo,cd,Qo,Yo,Jo,ei,ct,ti,jt,ni,ri,oi,ii,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,wi,Rn,Un,$i,_i,vi,pd,md,xi,Zt=A(()=>{"use strict";R();N();ie();G();ld=(e,t,n,r,o,i)=>{let s=Math.ceil(t/4),a="";typeof o=="string"?a=`${o}(a)`:a=o("a");let u=S("inputData",n,[s],4),d=C("outputData",r,[s],4);return`
  ...
  }`},X=(e,t,n,r,o,i=e.dataType)=>({name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:s=>ld(s,v.size(e.dims),e.dataType,i,n,r),getRunData:s=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(v.size(s[0].dims)/64/4)},programUniforms:[{type:12,data:Math.ceil(v.size(e.dims)/4)}]})}),Go=e=>{e.compute(X(e.inputs[0],"Abs","abs"))},Lo=e=>{e.compute(X(e.inputs[0],"Acos","acos"))},Ho=e=>{e.compute(X(e.inputs[0],"Acosh","acosh"))},qo=e=>{e.compute(X(e.inputs[0],"Asin","asin"))},Fo=e=>{e.compute(X(e.inputs[0],"Asinh","asinh"))},Ko=e=>{e.compute(X(e.inputs[0],"Atan","atan"))},jo=e=>{e.compute(X(e.inputs[0],"Atanh","atanh"))},Zo=e=>M(e),Xo=(e,t)=>{let n;switch(t.to){case 10:n="vec4<f16>";break;case 1:n="vec4<f32>";break;case 12:n="vec4<u32>";break;case 6:n="vec4<i32>";break;case 9:n="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(X(e.inputs[0],"Cast",n,void 0,t.cacheKey,t.to))},cd=e=>{let t=e.length>=2&&e[1].data!==0?e[1].getFloat32Array()[0]:Gt,n=e.length>=3&&e[2].data!==0?e[2].getFloat32Array()[0]:Lt;return M({min:t,max:n})},Qo=(e,t)=>{let n=e.inputs.length===1?t:cd(e.inputs),r=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"Clip",o=>`clamp(${o}, clip_min_, clip_max_)`,`
    const clip_min_: vec4<${r}> = vec4(${r}(${n.min}));
    const clip_max_: vec4<${r}> = vec4(${r}(${n.max}));
`,n.cacheKey),{inputs:[0]})},Yo=e=>{e.compute(X(e.inputs[0],"Ceil","ceil"))},Jo=e=>{e.compute(X(e.inputs[0],"Cos","cos"))},ei=e=>{e.compute(X(e.inputs[0],"Cosh","cosh"))},ct=e=>M(e),ti=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,ni=e=>{let t=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,jt(t)))},ri=e=>{e.compute(X(e.inputs[0],"Exp","exp"))},oi=e=>{e.compute(X(e.inputs[0],"Floor","floor"))},ii=e=>{let t=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,jt(t)))},si=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},ai=e=>{e.compute(X(e.inputs[0],"Not",t=>`!${t}`))},ui=e=>{e.compute(X(e.inputs[0],"Neg",t=>`-${t}`))},di=e=>{e.compute(X(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},li=e=>{let t=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},ci=e=>{e.compute(X(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},pi=e=>M(e),mi=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},fi=e=>{e.compute(X(e.inputs[0],"Sin","sin"))},hi=e=>{e.compute(X(e.inputs[0],"Sinh","sinh"))},gi=e=>{e.compute(X(e.inputs[0],"Sqrt","sqrt"))},yi=e=>{e.compute(X(e.inputs[0],"Tan","tan"))},bi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,wi=e=>{e.compute(X(e.inputs[0],"Tanh",bi))},Rn=(e="f32")=>`
...
`,Un=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,$i=e=>{let t=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"FastGelu",Un,Rn(t),void 0,e.inputs[0].dataType))},_i=(e,t)=>{let n=de(e.inputs[0].dataType);return e.compute(X(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},vi=e=>{e.compute(X(e.inputs[0],"Log","log"))},pd=(e,t)=>`
...
`,md=e=>`quick_gelu_impl(${e})`,xi=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(X(e.inputs[0],"QuickGelu",md,pd(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var fd,hd,Ii,Ci=A(()=>{"use strict";N();G();Zt();fd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},hd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),i=v.size(t)/4,s=Q(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
...
`)},vd=(e,t,n,r)=>{let o=v.size(n),i=new Array(e.length),s=new Array(e.length),a=0,u=[],d=[],c=[{type:12,data:o}];for(let h=0;h<e.length;++h)a+=e[h].dims[t],i[h]=a,d.push(e[h].dims.length),s[h]=S(`input${h}`,r,d[h]),u.push("rank"),c.push({type:12,data:i[h]});for(let h=0;h<e.length;++h)c.push(...E(e[h].dims));c.push(...E(n));let l=C("output",r,n.length),p=l.indicesGet("indices",t),f=Array.from(Array(i.length).keys()).map(h=>`uniforms.sizeInConcatAxis${h}`).join(","),m=h=>`
  ...
  ${h.mainStart()}
    ...
    ${_d(s,l)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:c}),getShaderSource:m}},Mi=(e,t)=>{let n=e.inputs,r=n[0].dims,o=v.normalizeAxis(t.axis,r.length);wd(n,o);let i=r.slice();i[o]=n.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let s=n.filter(a=>v.size(a.dims)>0);e.compute(vd(s,o,i,n[0].dataType),{inputs:s})},Vi=e=>M({axis:e.axis})});var _e,ve,xe,Xt,Re=A(()=>{"use strict";R();N();_e=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},ve=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},xe=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Xt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=e?.activation_params||[Gt,Lt];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}});var le,Qt,pt=A(()=>{"use strict";le=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Qt=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var Yt,Mn=A(()=>{"use strict";Yt=e=>`
...
`});var xd,Sd,mt,Wi,Id,ft,Cd,Jt,ht=A(()=>{"use strict";R();N();G();Re();pt();xd=(e,t)=>e?`
...
bIndices[${b-2}] = u32(row);
    ...
    `},Jt=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s.slice(0,-2),d=a.slice(0,-2),c=r?r.slice(0,-2):n.slice(0,-2),l=v.size(c),p=s[s.length-2],f=s[s.length-1],m=a[a.length-1],h=f%4===0&&m%4===0,y=p<=8?[4,1,1]:[4,4,1],w=[8,8,1],g=[Math.ceil(m/w[0]/y[0]),Math.ceil(p/w[1]/y[1]),Math.ceil(l/w[2]/y[2])],b=h?4:1,$=[...u,p,f/b],_=$.length,x=[...d,f,m/b],I=x.length,T=[l,p,m/b],P=[{type:6,data:p},{type:6,data:m},{type:6,data:f}];ve(t,P),P.push(...E(c,$,x));let z=["rank","rank"],D=e.length>2;D&&(P.push(...E(e[2].dims)),z.push("rank")),P.push(...E(T));let j=L=>{let q=c.length,ae=Ht("batchDims",e[0].dataType,q,1),U=Q(e[0].dataType),te=S("a",e[0].dataType,_,b),re=S("b",e[1].dataType,I,b),V=C("result",e[0].dataType,T.length,b),ne=[te,re];if(D){let B=o?b:1;ne.push(S("bias",e[2].dataType,e[2].dims.length,B))}let F=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];xe(t,F);let H=Q(V.type.tensor),K=_e(t,V.type.value,H),k=Cd(b,D,K,[ae,te,re,V],[u,d,c],o);return`
  ${L.registerUniforms(F).registerInternalVariables(ae).declareVariables(...ne,V)}
  ${k}
  ${h?mt(y,w,U,ae):ft(y,w,U,ae)}
                   `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${h};${o}`,inputDependencies:z},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:P}),getShaderSource:j}}});var Td,Gi,Li=A(()=>{"use strict";R();De();G();Re();pt();Mn();ht();Td=(e,t,n,r,o=!1,i,s=4,a=4,u=4,d="f32")=>{let c=z=>{switch(z){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},l=z=>{switch(z){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},p=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${_}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${V}>`:V}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${_}>`:_} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${p};${y}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:m}),getShaderSource:w}}});var Zi,Xi,Qi=A(()=>{"use strict";R();N();G();Vn();Re();Zi=(e,t,n)=>{let r=e.length>2,o=r?"value += b[output_channel];":"",i=e[0].dims,s=e[1].dims,a=s[0]/t.group,u=t.format==="NHWC",d=tn(i,s,t.dilations,t.pads,t.strides,u),c=v.size(d),l=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:a}];ve(t,l),l.push(...E(i,s));let p=["rank","rank"];r&&(l.push(...E(e[2].dims)),p.push("rank")),l.push(...E(d));let f=m=>{let h=C("output",e[0].dataType,d.length),y=Q(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,i.length),b=S("w",e[1].dataType,s.length),$=[g,b];r&&$.push(S("b",e[2].dataType,e[2].dims.length));let _=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];return xe(t,_),`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:t.cacheKey,inputDependencies:p},getRunData:()=>({outputs:[{dims:n?n(d):d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l}),getShaderSource:f}},Xi=(e,t,n,r)=>{let o=e.length>2,i=ee(n[3]),s=ee(n[2]),a=v.size(n)/i/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],c=[n[0],n[1],n[2],n[3]/i],l=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ve(t,l),l.push(...E(u,d,c));let p=(s-1)*t.strides[1]+d[1],f=m=>{let h=C("output",e[0].dataType,c.length,i),y=Q(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,u.length,i),b=S("w",e[1].dataType,d.length,i),$=[g,b];o&&$.push(S("b",e[2].dataType,e[2].dims,i));let _=o?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return xe(t,x),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${i};${s};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:f}}});var Nn,Pd,Yi,Wn=A(()=>{"use strict";R();N();ht();G();Re();Nn=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s[s.length-2],d=a[a.length-1],c=s[s.length-1],l=ee(d),p=ee(c),f=ee(u),m=v.size(n)/l/f,h=e.length>2,y=r?r.slice(0,-2):n.slice(0,-2),g=[v.size(y),u,d],b=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:c}];ve(t,b),b.push(...E(y,s,a)),h&&b.push(...E(e[2].dims)),b.push(...E(g));let $=_=>{let x=Ht("batch_dims",e[0].dataType,y.length),I=S("a",e[0].dataType,s.length,p),T=S("b",e[1].dataType,a.length,l),P=C("output",e[0].dataType,g.length,l),z=Q(P.type.tensor),D=_e(t,P.type.value,z),j=[I,T],L="";if(h){let F=o?l:1;j.push(S("bias",e[2].dataType,e[2].dims.length,F)),L=`${o?`value += bias[col / ${F}];`:`value += ${P.type.value}(bias[row + i]);`}`}let q=s.slice(0,-2),ae=a.slice(0,-2),U=Ye(q,y),te=Ye(ae,y),re=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];xe(t,re);let V=(F,H)=>{let K=F.rank,k=F.name;if(K===2)return`var ${k}_indices = ${F.type.indices}(0u, 0u);`;let B=x.rank,Y=`var ${k}_indices: ${F.type.indices};`;for(let Te=K-2-1,fe=B-1;Te>=0;Te--,fe--)Y+=`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${p};${f};${o}`,inputDependencies:h?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:$}},Pd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Yi=e=>{Pd(e.inputs);let t=ke.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];n<8&&r<8?e.compute(Nn(e.inputs,{activation:""},t)):e.compute(Jt(e.inputs,{activation:""},t))}});var tn,Gn,zd,Ln,Hn,Ji,Od,Bd,qn,Vn=A(()=>{"use strict";N();Li();ji();ht();Qi();Re();Wn();je();tn=(e,t,n,r,o,i)=>{let s=e[0],a=e.slice(i?1:2,i?3:4),u=a.length,d=t[0],l=t.slice(2).map((m,h)=>m+(m-1)*(n[h]-1)),f=a.map((m,h)=>m+r[h]+r[h+u]).map((m,h)=>Math.floor((m-l[h]+o[h])/o[h]));return f.splice(0,0,s),f.splice(i?3:1,0,d),f},Gn=[2,3,1,0],zd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Ln=(e,t)=>{let n=e.kernelShape.slice();for(let i=2;i<t[1].dims.length;++i)n[i-2]===0&&(n[i-2]=t[1].dims[i]);let r=e.pads.slice();qe.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:n,pads:r}),o},Hn=e=>{let t=Xt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,i=e.group,s=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Ji=(e,t,n,r)=>{let o=n.format==="NHWC";if(n.group!==1){if(!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1){let I=tn(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),T=e.kernelCustomData.wT??e.compute(ge(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let P=[t[0],T];t.length===3&&P.push(t[2]),e.compute(Xi(P,n,I,r),{inputs:P})}else e.compute(Zi(t,n,r));return}let i=t.length===3,s=t[0].dims[o?1:2],a=t[0].dims[o?2:3],u=t[0].dims[o?3:1],d=t[1].dims[2],c=t[1].dims[3],l=tn(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),p=l[o?1:2],f=l[o?2:3],m=l[o?3:1],h=o&&d===s&&c===a&&n.pads[0]===0&&n.pads[1]===0;if(h||d===1&&c===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let x=l[0],I,T,P,z=[];if(o){let L=e.kernelCustomData.wT??e.compute(ge(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=L),h){let q=s*a*u;I=t[0].reshape([1,x,q]),T=L.reshape([1,q,m]),P=[1,x,m]}else I=t[0].reshape([x,s*a,u]),T=L.reshape([1,u,m]),P=[x,p*f,m];z.push(I),z.push(T)}else I=t[0].reshape([x,u,s*a]),T=t[1].reshape([1,m,u]),P=[x,m,p*f],z.push(T),z.push(I);i&&z.push(t[2]);let D=P[2],j=z[0].dims[z[0].dims.length-1];D<8&&j<8?e.compute(Nn(z,n,l,P,o,r),{inputs:z}):e.compute(Jt(z,n,l,P,o,r),{inputs:z});return}let y=!0,w=e.kernelCustomData.wT??e.compute(ge(t[1],Gn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=w);let g=[t[0],w];i&&g.push(t[2]);let b=o?p*f:m,$=o?m:p*f,_=d*c*u;e.compute(Gi(g,n,l,b,$,_,i,y,r),{inputs:g})},Od=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),s=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=Ln({...t,pads:o,strides:i,dilations:s,kernelShape:a},r);Ji(e,r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Bd=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",o=Ln(n,t),i=n.autoPad==="NOTSET"?n.pads:n.autoPad,s=Fi(t[0].dims,t[1].dims,n.strides,n.dilations,i,!1,r);e.compute(Ki(t,o,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},qn=(e,t)=>{if(zd(e.inputs,t),e.inputs[0].dims.length===3)Od(e,t);else if(e.inputs[0].dims.length===5)Bd(e,e.inputs,t);else{let n=Ln(t,e.inputs);Ji(e,e.inputs,n)}}});var Dd,es,ts=A(()=>{"use strict";R();De();G();Re();pt();Mn();ht();Dd=(e,t=!1,n,r,o=4)=>{let i=w=>{switch(w){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
...
`)};
    ...
    ${p}`},u=[{type:12,data:s},...E(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},ws=e=>{Qd(e.inputs),e.compute(Jd(e.inputs),{inputs:[0]})}});var el,_s,vs=A(()=>{"use strict";R();N();G();Zt();el=e=>{let t=e[0].dataType,n=v.size(e[0].dims),r=v.size(e[1].dims),o=r%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],l=f=>`
  ...
  ${_.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${f};${m};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:l}],dispatchGroup:{x:w},programUniforms:b}),getShaderSource:I}},Zs=(e,t)=>{vl(e.inputs,t),e.compute(xl(e.inputs,t))},Xs=e=>M(e)});var Sl,Il,Cl,Tl,Al,kl,El,Pl,Ys,Js=A(()=>{"use strict";R();N();G();Sl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Il=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
