...
`}var sf,uf,Ji,Yi=x(()=>{"use strict";z();q();N();Qt();sf=a=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${a}`}),uf=(a,e,o,t)=>{let n=e.dims,r=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:a,type:0}}function Af(){let a="xor_";return{body:`
  float ${a}(float a, float b) {
    return float( bool(a) ^^ bool(b) );
  }
  vec4 ${a}(vec4 v1, vec4 v2) {
  ...
  `,name:e,type:0}}var yt,Lf,ca,pa,da,ha,ma,ba,ya,ga,xa,Ta,va,wa,Ia=x(()=>{"use strict";z();Bt();q();N();yt=(a,e,o,t=e[0].type,n)=>{let r=a.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],cacheHint:n,get:()=>Lf(a,e,o,t)}},Lf=(a,e,o,t=e[0].type)=>{let n=a.session.pack?2:0,r=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,i=a.session.pack;if(r){let f=it.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let p=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,b=e[1].dims.length!==0?e[1].dims.length:1,g=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",y=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",v=D(a.session.backend.glContext.version),_=i?`
      ${o.body}
      void main() {
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],output:{dims:e[0].dims,type:t,textureType:n},shaderSource:l,hasMain:!0}},ca=(a,e)=>[a.run(yt(a,e,gf()),e)],pa=(a,e)=>[a.run(yt(a,e,Sf(),"bool"),e)],da=(a,e)=>[a.run(yt(a,e,xf()),e)],ha=(a,e)=>[a.run(yt(a,e,wf(),"bool"),e)],ma=(a,e)=>[a.run(yt(a,e,If(),"bool"),e)],ba=(a,e)=>[a.run(yt(a,e,_f(),"bool"),e)],ya=(a,e)=>[a.run(yt(a,e,Tf()),e)],ga=(a,e)=>[a.run(yt(a,e,Of(),"bool"),e)],xa=(a,e)=>[a.run(yt(a,e,Pf()),e)],Ta=(a,e)=>[a.run(yt(a,e,Ef()),e)],va=(a,e)=>[a.run(yt(a,e,vf()),e)],wa=(a,e)=>[a.run(yt(a,e,Af(),"bool"),e)]});var _a,Sa,kf,Oa=x(()=>{"use strict";z();_a=(a,e,o)=>(kf(e),[a.cast(e[0],o)]),Sa=a=>et.tensorDataTypeFromProto(a.attributes.getInt("to")),kf=a=>{if(!a||a.length!==1)throw new Error("Cast requires 1 input.");if(a[0].type==="string")throw new Error("Invalid input type.")}});var Bf,Ff,Aa,ur,Pa=x(()=>{"use strict";q();N();Pt();Qt();Bf=(a,e)=>({name:"Concat (packed)",inputNames:Array.from({length:a},(o,t)=>`X${t}`),inputTypes:Array(a).fill(2),cacheHint:e}),Ff=(a,e,o,t)=>{let n=o[0].dims.slice();if(t>=n.length||t<-1*n.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=n.length+t);let r=n.slice(0);for(let F=1;F<o.length;F++){let st=o[F].dims.slice();for(let Ot=0;Ot<n.length;Ot++)if(Ot===t)r[t]+=st[Ot];else if(n[Ot]!==st[Ot])throw new Error("non concat dimensions must match")}let s=r.length,i=ce("coords",s),u=at(s),l=Et(),f=o.map(F=>F.dims),p=St(s),d=new Array(f.length-1);d[0]=f[0][t];for(let F=1;F<d.length;F++)d[F]=d[F-1]+f[F][t];let b=p[t],g=p.slice(-2),y=p.join(),v=`if (${b} < ${d[0]}) {
        return getChannel(
            getX0(${y}), vec2(${g.join()}));
            ...
            return getChannel(
              getX${_}(${ur(p,b,O)}),
              vec2(${ur(g,b,O)}));`;let S=D(a.session.backend.glContext.version),C=`
          ${l}
...
`;return{...o,output:{dims:l,type:e[0].type,textureType:0},shaderSource:b,hasMain:!0}},rs=(a,e,o)=>{let t=fc(e.length>2,o.cacheKey);return{...t,get:()=>cc(a,e,t,o)}}});var pc,dc,os,is=x(()=>{"use strict";q();N();Qt();pc=a=>({name:"Im2Col (packed)",inputNames:["A"],inputTypes:[2],cacheHint:a}),dc=(a,e,o,t,n,r)=>{let s=o.dims,i=t.dims,u=2,l=3,f=n.length,p=[i[1]*i[2]*i[3],n[2]*n[3]],d=i[2]*i[3],b=Et(),g=D(a.session.backend.glContext.version),y="";for(let _=0;_<=1;_++)for(let O=0;O<=1;O++)y+=`
            blockIndex = rc.x + ${O};
            pos = rc.y + ${_};
...
`),d=A.size(o)===1,b="vec4(outputValue.xx, outputValue.yy)";return d&&(b="vec4(outputValue.x)"),n?`
...
vec4 getBAtOutCoordsMatmul(int i) {
  ...
  return outputValue;
}`}function Tc(a,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${a[t]}, `;return o+=`rc.${a[e-2]}, i*2`,o}function vc(a,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${a[t]}, `;return o+=`i*2, rc.${a[e-1]}`,o}var yc,gc,cr,wn=x(()=>{"use strict";z();q();N();Pt();te();fr();yc=(a,e)=>({name:"MatMul (packed)",inputNames:a?["A","B","Bias"]:["A","B"],inputTypes:a?[2,2,2]:[2,2],cacheHint:e}),gc=(a,e,o,t)=>{let n=o.length>2,r=n?"value += getBiasForMatmul();":"",s=o[0].dims,i=o[1].dims,u=it.calcShape(s,i,!0),l=!A.areEqual(o[0].dims,o[1].dims);if(!u)throw new Error("Can't use matmul on the given tensors");let f=s[s.length-1],p=Math.ceil(f/2),d=s.length,b=i.length,g=D(a.session.backend.glContext.version),y=at(u.length),v=u.length,_=St(),{activationFunction:O,applyActivation:S}=Dt(t),C=n?`${vn(y,_,o[2].dims,u,!0)}`:"",F=l?`${xc(y,_,o,u)}`:"",st=l?"getAAtOutCoordsMatmul(i)":`getA(${Tc(_,d)})`,Ot=l?"getBAtOutCoordsMatmul(i)":`getB(${vc(_,b)})`,kr=l?"":`${y} rc =
      ...
      `,Mt=`
        ...
        `;return{...e,output:{dims:l,type:o.type,textureType:4},shaderSource:f}},fs=(a,e,o,t,n)=>{let r=wc(n.cacheKey);return{...r,get:()=>Ic(a,r,e,o,t,n)}},In=(a,e,o,t=4)=>[o[0],o[2],o[3],Math.ceil(a[1]*e[2]*e[3]/t)]});var _c,Sc,cs,ps=x(()=>{"use strict";z();q();N();te();_n();_c=(a,e)=>({name:"ConvDotProduct",inputNames:a?["Im2Col","K","B"]:["Im2Col","K"],inputTypes:a?[0,4,0]:[0,4],cacheKey:e.activationCacheKey}),Sc=(a,e,o,t,n)=>{let r=o[0].dims,s=o[1].dims,i=[s[0],Math.ceil(r[1]*s[2]*s[3]/4)],u=In(r,s,t),[l,f]=a.calculateTextureWidthAndHeight(i,4),p=A.computeStrides(u),[d,b]=a.calculateTextureWidthAndHeight(u,4),g=t.length,y=o.length<3?"0.0":"_B(b)",v=Math.ceil(r[1]*s[2]*s[3]/4),{activationFunction:_,applyActivation:O}=Dt(n),S=D(a.session.backend.glContext.version),C=`
${_}
...
`)},op=a=>{if(!a||a.length!==1)throw new Error("ImageScaler requires 1 input.");if(a[0].dims.length!==4)throw new Error("Invalid input shape.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type.")}});var Ns,Cs,Fs,ip,ap,sp,up,lp,fp,Gs=x(()=>{"use strict";q();N();Ns=(a,e,o)=>{fp(e);let t=a.run(ap(e[0]),e);return[a.run(lp(a,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},Cs=a=>a.attributes.getFloat("epsilon",1e-5),Fs={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},ip=(a,e)=>{let o=e.dims.slice(),t=o[1],n=o[2]*o[3],r=[o[0],t],s=`
    ...
    `;return{...e,output:{dims:r,type:a[0].type,textureType:0},shaderSource:l}},ru=(a,e,o)=>{let t=a[0].dims.slice(),n=Object.hasOwnProperty.call(e,"dilations"),r=e.kernelShape.slice(),s=e.strides.slice(),i=n?e.dilations.slice():[],u=e.pads.slice();Xt.adjustPoolAttributes(o,t,r,s,i,u);let l=Xt.computePoolOutputShape(o,t,s,i,r,u,e.autoPad),f=Object.assign({},e);return n?Object.assign(f,{kernelShape:r,strides:s,pads:u,dilations:i,cacheKey:e.cacheKey}):Object.assign(f,{kernelShape:r,strides:s,pads:u,cacheKey:e.cacheKey}),[f,l]},Ip={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},js={name:"GlobalMaxPool",inputNames:["X"],inputTypes:[0]},nu=(a,e)=>(hr(e),[a.run({...js,get:()=>eu(e,js,!0,Ip)},e)]),hr=a=>{if(!a||a.length!==1)throw new Error("Pool ops requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type.")},ou=(a,e,o,t,n)=>{let r=a.length;if(e.kernelShape.length<=2){let s=e.kernelShape[e.kernelShape.length-1],i=e.strides[e.strides.length-1],u=e.pads[e.pads.length/2-1],l=e.pads[e.pads.length-1],f=a[r-1],p="",d="",b="";if(u+l!==0?p=`
          ...
          for (int i = 0; i < ${s}; i++) {
            x[${r} - 1] = indices[${r} - 1] * ${i} - ${u} + i;
            ${o}
          }`,e.kernelShape.length===2){let y=e.kernelShape[e.kernelShape.length-2],v=e.strides[e.strides.length-2],_=e.pads[e.pads.length/2-2],O=e.pads[e.pads.length-2],S=a[r-2];_+O!==0?d=`
            for (int j = 0; j < ${y}; j++) {
      ...
      `}else{let s=A.size(e.kernelShape),i=A.computeStrides(e.kernelShape),u=i.length,l=e.pads.length,f=_p(u),p=dr(a,"inputDims"),d=dr(e.pads,"pads"),b=dr(i,"kernelStrides"),g=dr(e.strides,"strides"),y=e.pads.reduce((O,S)=>O+S),v="";return y?v=`
  ...
  void offsetToIndices(int offset, int[${a}] strides, out int[${a}] indices) {
    ...
    indices[${a} - 1] = offset;
  }`});var re,zt,Sp,Op,au,su,uu,lu,fu,cu,pu,du=x(()=>{"use strict";tt();Le();z();N();re=(a,e,o,t,n)=>{Op(e);let r={name:t,inputNames:["A"],inputTypes:[0]};return[a.run({...r,cacheHint:o.cacheKey,get:()=>Sp(a,e,o,t,n,r)},e)]},zt=a=>{let e=a.attributes.getInts("axes",[]),o=a.attributes.getInt("keepdims",1)===1;return $({axes:e,keepDims:o})},Sp=(a,e,o,t,n,r)=>{let s=[],i=e[0].dims.length||1,u=[],l=A.normalizeAxes(o.axes,e[0].dims.length),f=n(e,l),p=f[1];for(let g=0;g<e[0].dims.length;g++)l.indexOf(g)>=0||l.length===0?(o.keepDims&&s.push(1),p=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),fu=(a,e,o)=>re(a,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),cu=(a,e,o)=>re(a,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),pu=(a,e,o)=>re(a,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var hu,mu=x(()=>{"use strict";z();hu=(a,e)=>{let o=A.calculateReshapedDims(e[0].dims,e[1].integerData);return a.session.pack?[a.reshapePacked(e[0],o)]:[a.reshapeUnpacked(e[0],o)]}});var bu,En,yu,gu,$e,Ap,Dn,mr,Ln=x(()=>{"use strict";tt();q();N();bu={name:"Upsample",inputNames:["X"],inputTypes:[0]},En=(a,e,o)=>(Dn(e,o),[a.run({...bu,cacheHint:o.cacheKey,get:()=>Ap(a,e,o)},e)]),yu=a=>$e(a,7),gu=a=>$e(a,9),$e=(a,e)=>{let o=e>=10,t=a.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let n=[];e<9&&(n=a.attributes.getFloats("scales"),mr(n,t,o));let r=a.attributes.getFloat("extrapolation_value",0),s=e>10?a.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let i=s==="tf_crop_and_resize",u=i,l=t==="nearest"&&e>=11?a.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=a.attributes.getFloat("cubic_coeff_a",-.75),p=a.attributes.getInt("exclude_outside",0)!==0;if(p&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",b=0,g=0,y=0;return e>10?a.inputs.length>2?(b=1,g=2,y=3):(g=1,y=2):e===9&&(g=1),$({opset:e,isResize:o,mode:t,scales:n,extrapolationValue:r,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:i,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:b,scalesInputIdx:g,sizesInputIdx:y})},Ap=(a,e,o)=>{let t=D(a.session.backend.glContext.version),[n,r]=a.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((y,v)=>Math.floor(y*o.scales[v])),[i,u]=a.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),d=`
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
                ...
                `;break;default:throw new Error(`resize (packed) does not support coordinateTransformMode:                                 '${o.coordinateTransformMode}'`)}let v=at(i),_=Et(),O=`
        ...
        `;return{...$n,output:{dims:r,type:e[0].type,textureType:2},hasMain:!0,shaderSource:O}},Ep=(a,e)=>{let t=a[0].dims,n=e.scales,r;if(n.length===0){let i=a[e.scalesInputIdx];if(i&&i.size!==0){if(a[e.sizesInputIdx])throw new Error("Only one of scales or sizes must be provided as input.");n=Dp(i,e.mode,e.isResize)}else{let u=a[e.sizesInputIdx];if(!u||u.size===0)throw new Error("Either scales or sizes MUST be provided as input.");r=Array.from(u.integerData),n=Lp(r,t,e.mode,e.isResize)}}else if(a[e.sizesInputIdx])throw new Error("Only one of scales or sizes must be provided as input.");let s=r||t.map((i,u)=>Math.floor(i*n[u]));return[n,s]},Dp=(a,e,o)=>{let t=Array.from(a.floatData);return mr(t,e,o),t},Lp=(a,e,o,t)=>{let n=e.length,r=new Array(n);for(let s=0,i=n;s<i;s++)if(e[s]===0){if(a[s]!==0)throw new Error("Input dim is zero but required output dim is non-zero.");r[s]=1}else r[s]=a[s]/e[s];return mr(r,o,t),r}});var wu,$p,Iu=x(()=>{"use strict";Yt();wu=(a,e)=>($p(e),[new Y([e[0].dims.length],"int32",void 0,void 0,new Int32Array(e[0].dims))]),$p=a=>{if(!a||a.length!==1)throw new Error("Shape requires 1 input.")}});var Bn,_u,Su,Ou,kp,Au,Bp,Fp,Pu=x(()=>{"use strict";tt();Le();z();N();Bn={name:"Slice",inputNames:["A"],inputTypes:[0]},_u=(a,e,o)=>(kp(e),[a.run({...Bn,cacheHint:o.cacheKey,get:()=>Ou(a,e[0],o)},e)]),Su=a=>{let e=a.attributes.getInts("starts"),o=a.attributes.getInts("ends"),t=a.attributes.getInts("axes",[]);return $({starts:e,ends:o,axes:t})},Ou=(a,e,o)=>{let t=o.axes.length===0?e.dims.slice(0).map((p,d)=>d):o.axes,n=A.normalizeAxes(t,e.dims.length),r=o.starts.map((p,d)=>p>e.dims[n[d]]-1?e.dims[n[d]]:A.normalizeAxis(p,e.dims[n[d]])),s=o.ends.map((p,d)=>p>e.dims[n[d]]-1?e.dims[n[d]]:A.normalizeAxis(p,e.dims[n[d]])),i=e.dims.slice(),u=[];for(let p=0;p<n.length;p++)i[n[p]]=s[p]-r[p],r[p]>0&&u.push(`outputIdx[${n[p]}] += ${r[p]};`);let f=`
      float process(int outputIdx[${i.length}]) {
        ${u.join(`
      `)}
        return _A(outputIdx);
      }`;return{...Bn,output:{dims:i,type:e.type,textureType:0},shaderSource:f}},kp=a=>{if(!a||a.length!==1)throw new Error("Slice requires 1 input.");if(Vt.indexOf(a[0].type)===-1)throw new Error("Invalid input type.")},Au=(a,e)=>{Fp(e);let o=Bp(a,e);return[a.run({...Bn,cacheHint:o.cacheKey,get:()=>Ou(a,e[0],o)},[e[0]])]},Bp=(a,e)=>{if(!a.session.isInitializer(e[1].dataId)||!a.session.isInitializer(e[2].dataId)||e.length>=4&&!a.session.isInitializer(e[3].dataId)||e.length>=5&&!a.session.isInitializer(e[4].dataId))throw new Error("dynamic slice attributes are not allowed");if(e.length>=5&&e[4].integerData.some(s=>s!==1))throw new Error("currently non-1 steps is not supported for Slice");let o=Array.from(e[1].integerData),t=Array.from(e[2].integerData),n=e.length>=4?Array.from(e[3].integerData):[],r=`${n};${o};${t}`;return{starts:o,ends:t,axes:n,cacheKey:r}},Fp=a=>{if(!a||a.length<3||a.length>5)throw new Error("Invalid input number.");if(a[1].type!=="int32"||a[1].dims.length!==1)throw new Error("Invalid input type.");if(a[2].type!=="int32"||a[2].dims.length!==1)throw new Error("Invalid input type.");if(a.length>=4&&(a[3].type!=="int32"||a[3].dims.length!==1))throw new Error("Invalid input type.");if(a.length>=5&&(a[4].type!=="int32"||a[4].dims.length!==1))throw new Error("Invalid input type.")}});var Eu,Du,Lu,$u,ku,Bu,Fu,Nu,Np,Cp,Gp,Cu,Gu=x(()=>{"use strict";tt();z();q();N();pr();Eu={name:"SoftmaxComputeMax",inputNames:["A"],inputTypes:[0]},Du={name:"SoftmaxComputeScale",inputNames:["A","Max"],inputTypes:[0,0]},Lu={name:"SoftMax",inputNames:["A","Max","Norm"],inputTypes:[0,0,0]},$u=(a,e,o)=>{Cu(e);let t=e[0].dims.slice(),n=A.normalizeAxis(o.axis,t.length),r=A.sizeToDimension(t,n),s=A.sizeFromDimension(t,n);return Nu(a,e,o,r,s)},ku=a=>$({axis:a.attributes.getInt("axis",1)}),Bu=a=>$({axis:a.attributes.getInt("axis",-1)}),Fu=(a,e,o)=>{Cu(e);let t=e[0].dims.slice(),n=A.normalizeAxis(o.axis,t.length),r=t.length,s=n!==r-1,i=[],u=[],l=[],f;s&&(u=Array.from({length:r}).map((g,y)=>y),u[n]=r-1,u[r-1]=n,u.map(g=>i.push(t[g])),f=$({perm:u}),l=ee(a,e,f));let p=s?A.sizeToDimension(i,r-1):A.sizeToDimension(t,r-1),d=s?A.sizeFromDimension(i,r-1):A.sizeFromDimension(t,r-1),b=Nu(a,s?l:e,o,p,d);return s?ee(a,b,f):b},Nu=(a,e,o,t,n)=>{let r=Np(a,e[0],t,n,[t]),s=a.run({...Eu,cacheHint:o.cacheKey,get:()=>r},e),i=Cp(a,e[0],t,n,r.output.dims,[t]),u=a.run({...Du,cacheHint:o.cacheKey,get:()=>i},[e[0],s]),l=Gp(a,e[0],t,n,r.output.dims,i.output.dims);return[a.run({...Lu,cacheHint:o.cacheKey,get:()=>l},[e[0],s,u])]},Np=(a,e,o,t,n)=>{let[r,s]=a.calculateTextureWidthAndHeight(e.dims,0),i=n.length;if(o<1||t<1)throw new Error("Logical row count N and feature count D must be greater than or equal to 1");if(n.length!==1)throw new Error("Dimensionality of the output should be 1");if(n[0]!==o)throw new Error("Shape of the output should be equal to logical row count");let u=D(a.session.backend.glContext.version),l=`
    ...
    }`;return{...Lu,output:{dims:e.dims,type:e.type,textureType:0},shaderSource:l}},Cu=a=>{if(!a||a.length!==1)throw new Error("Softmax requires 1 input.");if(a[0].type!=="float32"&&a[0].type!=="float64")throw new Error("Invalid input type")}});var Ru,Vu,zu,Rp,Vp,zp,Mu=x(()=>{"use strict";tt();z();N();Ru={name:"Split",inputNames:["A"],inputTypes:[0]},Vu=(a,e,o)=>{zp(e);let t=A.normalizeAxis(o.axis,e[0].dims.length),n=Rp(a,e,t,o),r=[];for(let s=0;s<n;++s)r.push(a.run({...Ru,cacheHint:`${o.cacheKey};${s}`,get:()=>Vp(a,e[0],o,t,s)},e));return r},zu=a=>{let e=a.attributes.getInt("axis",0),o=a.attributes.getInts("split",[]),t=a.outputs.length;return $({axis:e,split:o,numOutputs:t})},Rp=(a,e,o,t)=>{let[,n]=Se.splitShape(e[0].dims,o,t.split,t.numOutputs);return n.length},Vp=(a,e,o,t,n)=>{let[r,s]=Se.splitShape(e.dims,t,o.split,o.numOutputs),i=s[n],u=r[n],f=`
      float process(int indices[${u.length}]) {
        indices[${t}] += ${i};
        return _A(indices);
      }
    `;return{...Ru,cacheHint:`${o.cacheKey}:${n}`,output:{dims:u,type:e.type,textureType:0},shaderSource:f}},zp=a=>{if(!a||a.length!==1)throw new Error("Split requires one input.");if(a[0].type!=="int8"&&a[0].type!=="uint8"&&a[0].type!=="int16"&&a[0].type!=="uint16"&&a[0].type!=="int32"&&a[0].type!=="uint32"&&a[0].type!=="float32"&&a[0].type!=="float64"&&a[0].type!=="bool")throw new Error("Invalid input type.")}});var Fn,Uu,Wu,Mp,Up,Hu=x(()=>{"use strict";z();Fn=(a,e,o)=>{Mp(e);let t=A.squeezeShape(e[0].dims,o);return[a.reshapeUnpacked(e[0],t)]},Uu=(a,e)=>(Up(e),Fn(a,[e[0]],Array.from(e[1].integerData))),Wu=a=>a.attributes.getInts("axes"),Mp=a=>{if(!a||a.length!==1)throw new Error("Squeeze requires 1 input.");if(a[0].type==="string")throw new Error("invalid input tensor types.")},Up=a=>{if(!a||a.length!==2)throw new Error("Squeeze requires 2 inputs.");if(a[1].type!=="int32")throw new Error("Invalid input type.")}});var qu,Wp,Hp,ju=x(()=>{"use strict";q();N();qu=(a,e)=>{Hp(e);let o={name:"Sum",inputNames:e.map((n,r)=>`X${r}`),inputTypes:new Array(e.length).fill(0)};return[a.run({...o,get:()=>Wp(a,e,o)},e)]},Wp=(a,e,o)=>{let t=D(a.session.backend.glContext.version),n=e[0].dims.slice(),s=`
      void main() {
...
`);let _="";p<2&&f>0?_="coords":_=s.map((Mt,Fe)=>`coords.${v[Fe+g]}`).join(", ");let O="return outputValue;",C=A.size(s)===1,st=A.size(i)===1;if(f===1&&!C&&!st)O=`
        return vec4(outputValue.xy, outputValue.xy);
      `;else if(C&&!st)p===1?O=`
          return vec4(outputValue.x, outputValue.x, 0., 0.);
        `:O=`
          return vec4(outputValue.x);
        `;else if(d.length){let Mt=f-2,Fe=f-1;d.indexOf(Mt)>-1&&d.indexOf(Fe)>-1?O="return vec4(outputValue.x);":d.indexOf(Mt)>-1?O="return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);":d.indexOf(Fe)>-1&&(O="return vec4(outputValue.xx, outputValue.zz);")}let Ot=`
...
`);let O="";l<2&&u>0?O="coords":O=t.unpackedShape.map((C,F)=>`coords.${_[F+y]}`).join(", ");let S=`
      ...
      return ${i.texture2D}(${t}, uv);
    }`;return new I(b,["coordinates.packedUVfrom2D"])}getPackedSampler3D(o,t,n){let r=n.unpackedShape,s=[n.width,n.height],i=[s[0],s[1]],u=D(this.context.glContext.version);if(r[0]===1){let y=r.slice(1),v=[1,2],_=le(r,y),O=["b","row","col"],S=JSON.parse(JSON.stringify(n));S.unpackedShape=_;let C=this.getPackedSamplerFromInput(o,t,S),st=`${C.routineBody}
      ...
      vec2 uv = packedUVfrom3D(
        ${f}, ${l}, ${d}, ${p}, b, row, col);
      return ${u.texture2D}(${t}, uv);}`;return new I(g,["coordinates.packedUVfrom3D"])}getPackedSamplerND(o,t,n){let r=n.unpackedShape,s=r.length,i=[n.width,n.height],u=D(this.context.glContext.version),l=[i[0],i[1]],f=l[1],p=l[0],d=Math.ceil(r[s-1]/2),b=d*Math.ceil(r[s-2]/2),g="int b, int row, int col",y=`b * ${b} + (row / 2) * ${d} + (col / 2)`;for(let O=2;O<s-1;O++)g=`int b${O}, `+g,b*=r[s-O-1],y=`b${O} * ${b} + `+y;let _=`vec4 ${o}(${g}) {
      int index = ${y};
      int texR = index / ${p};
      ...
      `;return new I(p,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler5D(o,t,n){let r=n.unpackedShape,s=r[4],i=r[3]*s,u=r[2]*i,l=r[1]*u,{newShape:f,keptDims:p}=he(r);if(f.length<r.length){let y=le(r,f),v=["row","col","depth","depth2","depth3"],_=JSON.parse(JSON.stringify(n));_.unpackedShape=y;let O=`
          ${this.getUnpackedSamplerFromInput(o,t,_).routineBody}
          float ${o}(int row, int col, int depth, int depth2, int depth3) {
            return ${o}(${fe(v,p)});
          }
        `;return new I(O,["coordinates.sampleTexture","coordinates.uvFromFlat"])}let d=n.width,b=n.height,g=`
        float ${o}(int row, int col, int depth, int depth2, int depth3) {
