...
`)}},Zi=e=>new ia(e),er=(e,t)=>{let r=e.length,a=[];for(let n=0;n<r;n++){let o=r-1-n,u=e[o]||1;(t[t.length-1-n]||1)>1&&u===1&&a.unshift(o)}return a},ke=e=>!0});var dd,Xi,cd,pd,dt,Qi,Ji,tr=j(()=>{"use strict";_e();He();we();dd=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},Xi=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,cd=(e,t)=>U.sortBasedOnPerm(e,Xi(e.length,t)),pd=(e,t,r,a)=>{let n=[];n.push(`fn perm(i: ${a.type.indices}) -> ${r.type.indices} {
...
var best_index : i32 = 0;`,`if (${a.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  ${m.mainStart()}
    ...
    ${i.setByOffset("global_idx","value")}
  }`}},To=e=>{Hd(e.inputs),e.compute(Ld(e.inputs))}});var Gd,Te,ko,Ro,Po,Bo,Do,Mo,zo,Uo,Wo,Fd,No,Vo,Ho,Lo,gn,Go,yn,Fo,qo,jo,Ko,Yo,Zo,Xo,Qo,Jo,es,ts,rs,ns,as,is,os,ss,ca=j(()=>{"use strict";Be();_e();He();we();Gd=(e,t,r,a,n,o)=>{let u=Math.ceil(t/4),l="";typeof n=="string"?l=`${n}(a)`:l=n("a");let i=z("inputData",r,[u],4),c=K("outputData",a,[u],4);return`
...
fn erf_vf32(v: ${e}) -> ${e} {
  ...
  ${i.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},hs=e=>{vt(e,"Sub",(t,r)=>`${t}-${r}`)},gs=e=>{vt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},ys=e=>{vt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},bs=e=>{vt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},ws=e=>{vt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Qd,Jd,ec,tc,$s,_s,xs=j(()=>{"use strict";_e();He();we();Qd=e=>{if(!e||e.length<1)throw new Error("too few inputs");let t=e[0].dataType,r=e[0].dims.length;for(let a of e){if(a.dataType!==t)throw new Error("input tensors should be one type");if(a.dims.length!==r)throw new Error("input tensors should have the same shape")}},Jd=(e,t)=>`
...
`)};
    ...
    ${I}`},m=[{type:"uint32",data:u}];return l&&m.push(...q(t)),i&&m.push(...q(a)),{name:"Expand",shaderCache:{hint:`${a.length}`,inputDependencies:[l?"rank":"dims"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:m})}},js=e=>{Sc(e.inputs),e.compute(Cc(e.inputs),{inputs:[0]})}});var Ec,Ac,Ys,Zs,Xs=j(()=>{"use strict";Be();_e();He();we();Ec=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Ac=(e,t)=>{let r=e[0].dims,a=e[1].dims,n=r.length,o=U.normalizeAxis(t.axis,n),u=r.slice(0);u.splice(o,1,...a);let l=r[o],i=e[0].dataType===9?4:1,c=Math.ceil(U.size(u)/i),m=ke(e[0].dims.length),f=m?e[0].dims.length:e[0].dims,h=ke(e[1].dims.length),w=h?e[1].dims.length:e[1].dims,b=ke(u.length),_=b?u.length:u,I=[{type:"uint32",data:c},{type:"int32",data:l},{type:"uint32",data:o}];m&&I.push(...q(e[0].dims)),h&&I.push(...q(e[1].dims)),b&&I.push(...q(u));let $=[];$.push(m?"rank":"dims"),$.push(h?"rank":"dims");let S=T=>{let E=z("data",e[0].dataType,f,i),M=z("inputIndices",e[1].dataType,w),A=K("output",e[0].dataType,_,i),N=L=>{let J=a.length,B=`var indicesIndices${L}  = ${M.type.indices}(0);`;for(let Y=0;Y<J;Y++)B+=`${J>1?`indicesIndices${L}[${Y}]`:`indicesIndices${L}`} = ${u.length>1?`outputIndices${L}[uniforms.axis + ${Y}]`:`outputIndices${L}`};`;B+=`
      ...
      ${T.mainStart()}
        ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${W}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:$},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:I}),getShaderSource:S}},Ys=e=>ge({axis:e.axis}),Zs=(e,t)=>{let r=e.inputs;Ec(r),e.compute(Ac(e.inputs,t))}});var Tc,Oc,Qs,Js,eu=j(()=>{"use strict";_e();He();we();Tc=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:l,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}),getShaderSource:f}},tu=e=>{let t=e.transA,r=e.transB,a=e.alpha,n=e.beta;return{transA:t,transB:r,alpha:a,beta:n,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},ru=(e,t)=>{kc(e.inputs),e.compute(Rc(e.inputs,t))}});var Pc,Bc,Dc,au,iu=j(()=>{"use strict";Be();_e();we();Pc=(e,t)=>{let r=e[0].dims,a=r,n=2,o=U.sizeToDimension(r,n),u=U.sizeFromDimension(r,n),l=Ve(u),i=u/l,c=[r[0],r[1],i],m=["rank","type","type"],f=[{type:"uint32",data:u},{type:"uint32",data:i}];f.push(...q(c),...q(c));let h=w=>{let b=z("x",e[0].dataType,c.length,l),_=z("scale",e[1].dataType,e[1].dims),I=z("bias",e[2].dataType,e[2].dims),$=K("output",e[0].dataType,c.length,l),S=[b,_,I,$],T=b.type.value,E=l===1?"f32":`vec${l}<f32>`,M=64,A=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${i};${l}`,inputDependencies:E},getRunData:()=>({outputs:[{dims:[n,u,2],dataType:1}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:T}),getShaderSource:M},{inputs:[S,r,a],outputs:[-1]})[0]},Dc=(e,t,r)=>{let a=t[0].dims,n=a,o=a[0],u=a[a.length-1],l=U.sizeFromDimension(a,1)/u,i=Ve(u),c=U.size(n)/i,m=[{type:"uint32",data:l},{type:"uint32",data:Math.floor(u/i)}],f=["type","type"],h=Bc(e,t[0],t[1],t[2],o,l,u,r.epsilon),w=b=>{let _=Ne(t[0].dataType),I=i===1?"vec2f":`mat2x${i}f`,$=i===1?_:`vec${i}<${_}>`,S=z("input",t[0].dataType,t[0].dims,i),T=K("output",t[0].dataType,n,i);return`
  ...
  ${f.mainStart()}
    ...
    `,l="",i=z("x",t.dataType,t.dims.length),c=["rank"],[m,f,h,w,b]=hu(o,n);return m.push(...q(t.dims),...q(o)),{name:e,shaderCache:{hint:`${a.cacheKey};${h};${w};${b}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(U.size(o)/64)},programUniforms:m}),getShaderSource:_=>gu(_,i,t.dims.length,o.length,n,u,l,-1e5,f,h,w,b)}},Cu=(e,t)=>{Sn(e.inputs),e.compute(Iu("MaxPool",e.inputs[0],!1,t))},Eu=e=>{let t=e.storage_order,r=e.dilations,a=bu(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(a.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...a,cacheKey:""};return{...n,cacheKey:Yc(n)}},Au=e=>{let t=e.format;return{format:t,..._u,cacheKey:t}},Tu=(e,t)=>{Sn(e.inputs),e.compute(Iu("GlobalMaxPool",e.inputs[0],!0,t))}});var Xc,Qc,ku,Ru=j(()=>{"use strict";ot();Be();we();Xc=(e,t,r)=>{let a=e===t,n=e<t&&r<0,o=e>t&&r>0;if(a||n||o)throw new Error("Range these inputs' contents are invalid.")},Qc=(e,t,r,a)=>{let n=Math.abs(Math.ceil((t-e)/r)),o=[n],u=n,l=et(a),i=[{type:"uint32",data:u},{type:l,data:e},{type:l,data:r},...q(o)],c=m=>{let f=K("output",a,o.length),h=f.type.value,w=[{name:"outputSize",type:"u32"},{name:"start",type:h},{name:"delta",type:h}];return`
      ...
      }`};return{name:"Range",shaderCache:{hint:`${a}`},getShaderSource:c,getRunData:()=>({outputs:[{dims:o,dataType:a}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:i})}},ku=e=>{let t=0,r=0,a=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],a=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],a=e.inputs[2].getFloat32Array()[0]),Ee.webgpu.validateInputContent&&Xc(t,r,a),e.compute(Qc(t,r,a,e.inputs[0].dataType),{inputs:[]})}});var Jc,ep,tp,rp,np,ap,ip,op,sp,up,lp,Pu,dp,cp,pp,mp,fp,Bu,Du,Mu=j(()=>{"use strict";_e();He();we();Jc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${i}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.dataType}],dispatchGroup:{x:l},programUniforms:[{type:"uint32",data:c}]}),getShaderSource:_}},Gu=(e,t)=>{$p(e.inputs),e.compute(_p(e.inputs[0],t))},Fu=e=>ge({axis:e.axis})});var xp,Sp,Ip,Cp,Ep,ju,Ku,Yu=j(()=>{"use strict";_e();He();we();xp=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Sp=(e,t)=>{let r=[],a=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),a=r.length),ge({numOutputs:a,axis:t.axis,splitSizes:r})},Ip=e=>`
