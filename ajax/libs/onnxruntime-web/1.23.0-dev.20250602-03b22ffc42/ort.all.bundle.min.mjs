...
`},XP=(r,e,n,t,o=!1)=>{let[i,a,s,u]=t,l=Ve(t[0].type.tensor);return`
  ...
  ${b.mainStart()}
    ...
    ${Se}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${e.cacheKey};${d}${_}${b}${f}${g}`,inputDependencies:x},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:n?n(o):o,dataType:r[0].dataType}],programUniforms:R}),getShaderSource:F}}});var oC,iC,aC,Wv,Hv,sC,jv,uC,qv,Kv=k(()=>{"use strict";Uv();vr();Jn();oC=(r,e,n,t,o,i)=>(r-1)*e+n+(t-1)*o+1-i,iC=(r,e,n,t,o)=>{let i=Math.floor(r/2);e==="SAME_UPPER"?(n[t]=i,n[o]=r-i):e==="SAME_LOWER"&&(n[t]=r-i,n[o]=i)},aC=(r,e,n,t,o,i,a,s,u,l)=>{let d=r.length-2,f=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let h=r[0],g=e[s?3:1]*o;for(let b=0,_=r.length-d-(s?1:0);b<d;++b,++_){let T=r[_],v=f?T*a[b]:l[b],x=oC(T,a[b],i[b],e[_],n[b],v);iC(x,t,i,b,b+d),f&&l.push(a[b]*(T-1)+u[b]+(e[_]-1)*n[b]+1-i[b]-i[b+d])}l.splice(0,0,h),l.splice(s?3:1,0,g)},Wv=(r,e)=>{let n=r.kernelShape.slice();if(r.kernelShape.length===0||r.kernelShape.reduce((f,h)=>f*h,1)===0){n.length=0;for(let f=2;f<e[1].dims.length;++f)n.push(e[1].dims[f])}let t=r.format==="NHWC";n.splice(0,0,e[1].dims[0]),n.splice(t?3:1,0,e[1].dims[1]);let o=r.pads.slice(),i=r.outputShape.slice(),a=r.outputPadding.slice(),s=e[0].dims,u=r.dilations.slice();if(u.reduce((f,h)=>f+h,0)===0){let f=e[0].dims.length-2;u=new Array(f).fill(1)}let l=r.strides.slice();if(l.reduce((f,h)=>f+h,0)===0){let f=e[0].dims.length-2;l=new Array(f).fill(1)}aC(s,n,u,r.autoPad,r.group,o,l,t,a,i);let d=Object.assign({},r);return Object.assign(d,{kernelShape:n,pads:o,outputPadding:a,outputShape:i,dilations:u,strides:l}),d},Hv=r=>{let e=Ga(r),n=r.format,t=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof r.autoPad>"u"?0:r.autoPad],o=r.dilations,i=r.group,a=r.kernelShape,s=r.pads,u=r.strides,l=r.wIsConst(),d=r.outputPadding,f=r.outputShape;return{autoPad:t,format:n,dilations:o,group:i,kernelShape:a,outputPadding:d,outputShape:f,pads:s,strides:u,wIsConst:l,...e,cacheKey:`${r.format};${e.activation};`}},sC=(r,e)=>{if(!r||r.length!==2&&r.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(r[0].dims.length!==4&&r[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(r[0].dims.length!==r[1].dims.length)throw new Error("filter does not have same dimension as input");let n=r[0].dims[e.format==="NHWC"?r[0].dims.length-1:1],t=r[1].dims[0];if(n!==t)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=r[1].dims[1]*e.group;if(r.length===3&&(r[2].dims.length!==1||r[2].dims[0]!==o))throw new Error("invalid bias");let i=r[0].dims.length-2;if(e.dilations.reduce((d,f)=>d+f,0)>0&&e.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(e.strides.reduce((d,f)=>d+f,0)>0&&e.strides.length!==i)throw new Error(`strides should be ${i}D`);if(e.pads.reduce((d,f)=>d+f,0)>0&&e.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(e.outputPadding.length!==i&&e.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(e.kernelShape.reduce((d,f)=>d+f,0)>0&&e.kernelShape.length!==0&&e.kernelShape.length!==r[1].dims.length-2)throw new Error("invalid kernel shape");if(e.outputShape.length!==0&&e.outputShape.length!==r[0].dims.length-2)throw new Error("invalid output shape")},jv=(r,e,n,t)=>{let o=r.kernelCustomData.wT??r.compute(it(e[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!r.kernelCustomData.wT&&(r.kernelCustomData.wT=o);let i=[e[0],o];e.length===3&&i.push(e[2]),r.compute(Gv(i,n,t),{inputs:i})},uC=(r,e)=>{let n=e.format==="NHWC",t=[r.inputs[0].reshape(n?[r.inputs[0].dims[0],1,r.inputs[0].dims[1],r.inputs[0].dims[2]]:[r.inputs[0].dims[0],r.inputs[0].dims[1],1,r.inputs[0].dims[2]]),r.inputs[1].reshape([r.inputs[1].dims[0],r.inputs[1].dims[1],1,r.inputs[1].dims[2]])];r.inputs.length===3&&t.push(r.inputs[2]);let o=e.kernelShape;(o.length===0||o[0]===0)&&(o=[r.inputs[1].dims[2]]);let i=e.dilations;(i.length===0||i[0]===0)&&(i=[1]);let a=e.strides;(a.length===0||a[0]===0)&&(a=[1]);let s=e.pads;s.length===0&&(s=[0,0]),s=[0,s[0],0,s[1]],a=[1].concat(a),i=[1].concat(i),o=[1].concat(o);let u=e.outputPadding;u=[0].concat(u);let l=Wv({...e,pads:s,strides:a,dilations:i,kernelShape:o,outputPadding:u},t);jv(r,t,l,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},qv=(r,e)=>{if(sC(r.inputs,e),r.inputs[0].dims.length===3)uC(r,e);else{let n=Wv(e,r.inputs);jv(r,r.inputs,n)}}});var lC,Xv,Zv,Jv=k(()=>{"use strict";le();ge();Xe();ye();lC=(r,e,n,t)=>{let o=E.size(e),i=e.length,a=N("input",r,i),s=G("output",r,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=E.normalizeAxis(u,i),d=f=>{let h=` i32(${a.indicesGet("inputIndices","uniforms.axis")}) `,g=Q("uniforms.input_shape","uniforms.axis",i),b=t.reverse?h+(t.exclusive?" + 1":""):"0",_=t.reverse?g:h+(t.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:e,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...W(e,e)]}),getShaderSource:d}},Xv=(r,e)=>{let n=r.inputs[0].dims,t=r.inputs[0].dataType,o=r.inputs[1];r.compute(lC(t,n,o,e),{inputs:[0]})},Zv=r=>{let e=r.exclusive===1,n=r.reverse===1;return ce({exclusive:e,reverse:n})}});var cC,dC,pC,Yv,Qv,e0=k(()=>{"use strict";le();ge();Xe();ye();cC=r=>{if(!r||r.length!==1)throw new Error("DepthToSpace requires 1 input.");if(r[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},dC=(r,e,n,t)=>{let o=[];o.push(`fn perm(i: ${t.type.indices}) -> ${n.type.indices} {
...
`)};
            ${s.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:n.equation,inputDependencies:r.map(()=>"rank")},getRunData:()=>{let d=u.filter(h=>n.symbolToInfo.has(h)).map(h=>({type:12,data:n.symbolToInfo.get(h)?.dimValue||0}));d.push({type:12,data:a});let f=r.map((h,g)=>[...W(h)]).reduce((h,g)=>h.concat(g),d);return f.push(...W(t)),{outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:f}},getShaderSource:l}},r0=(r,e)=>{let n=new Lc(r.inputs,e.equation),t=n.outputDims,o=r.inputs.map((i,a)=>i.dims);r.compute(mC(o,r.inputs[0].dataType,n,t))},o0=r=>{let e=r.equation.replace(/\s+/g,"");return ce({equation:e})}});var gC,a0,bC,yC,s0,u0=k(()=>{"use strict";le();ge();ye();gC=r=>{if(!r||r.length!==2)throw new Error("Expand requires 2 input.");let e=r[0].dims,n=Array.from(r[1].getBigInt64Array(),Number),t=n.length<e.length?0:n.length-e.length,o=e.length<n.length?0:e.length-n.length;for(;t<n.length&&o<e.length;++t,++o)if(n[t]!==e[o]&&n[t]!==1&&e[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},a0=(r,e)=>{let n=r.length-e.length,t=[];for(let o=0;o<n;++o)t.push(r[o]);for(let o=0;o<e.length;++o)t.push(e[o]===1?r[o+n]:e[o]);return t},bC=(r,e)=>r.length>e.length?a0(r,e):a0(e,r),yC=r=>{let e=r[0].dims,n=Array.from(r[1].getBigInt64Array(),Number),t=bC(e,n),o=r[0].dataType,i=o===9||E.size(e)===1,a=o===9||e.length>0&&e[e.length-1]%4===0?4:1,s=i||t.length>0&&t[t.length-1]%4===0?4:1,u=Math.ceil(E.size(t)/s),l=f=>{let h=N("input",o,e.length,a),g=G("output",o,t.length,s),b;if(o===9){let _=(T,v,x="")=>`
    ...
    ${b}`},d=[{type:12,data:u},...W(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:t,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},s0=r=>{gC(r.inputs),r.compute(yC(r.inputs),{inputs:[0]})}});var _C,l0,c0=k(()=>{"use strict";le();ge();ye();Va();_C=r=>{let e=r[0].dataType,n=E.size(r[0].dims),t=E.size(r[1].dims),o=t%4===0,i=a=>{let s=N("x",e,[1],4),u=N("bias",e,[1],4),l=G("y",e,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=g=>`
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${o}`,inputDependencies:["type","type"]},getShaderSource:i,getRunData:a=>({outputs:[{dims:a[0].dims,dataType:a[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:t}],dispatchGroup:{x:Math.ceil(n/Ur/4)}})}},l0=r=>{r.inputs.length<2||E.size(r.inputs[1].dims)===0?iv(r):r.compute(_C(r.inputs))}});var vC,wC,d0,p0,f0=k(()=>{"use strict";le();ge();Xe();ye();vC=r=>{if(!r||r.length!==2)throw new Error("Gather requires 2 inputs.")},wC=(r,e)=>{let n=r[0].dims,t=r[1].dims,o=n.length,i=E.normalizeAxis(e.axis,o),a=n.slice(0);a.splice(i,1,...t);let s=n[i],u=r[0].dataType===9?4:1,l=Math.ceil(E.size(a)/u),d=[{type:12,data:l},{type:6,data:s},{type:12,data:i},...W(r[0].dims,r[1].dims,a)],f=h=>{let g=N("data",r[0].dataType,r[0].dims.length,u),b=N("inputIndices",r[1].dataType,r[1].dims.length),_=G("output",r[0].dataType,a.length,u),T=x=>{let I=t.length,$=`var indicesIndices${x}  = ${b.type.indices}(0);`;for(let O=0;O<I;O++)$+=`${I>1?`indicesIndices${x}[${O}]`:`indicesIndices${x}`} = ${a.length>1?`outputIndices${x}[uniforms.axis + ${O}]`:`outputIndices${x}`};`;$+=`
  ...
  }`};return f?{name:"GemmShared",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:l*d},programUniforms:g}),getShaderSource:T}:{name:"Gemm",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:s,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:g}),getShaderSource:_}},T0=r=>{let e=r.transA,n=r.transB,t=r.alpha,o=r.beta;return{transA:e,transB:n,alpha:t,beta:o,cacheKey:`${r.transA};${r.transB};${r.alpha===1}`}},I0=(r,e)=>{AC(r.inputs),r.compute(OC(r.inputs,e))}});var Yn,wr,po,fo,PC,CC,EC,DC,kC,NC,LC,RC,$0,A0,O0=k(()=>{"use strict";le();ge();Xe();ye();[Yn,wr,po,fo]=[0,1,2,3],PC=r=>{if(r[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(r[0].dims.length!==r[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(r[0].dims.length-2!==r[1].dims[r[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${r[0].dims.length-2}`);if(r[0].dims[0]!==r[1].dims[0])throw new Error("grid batch size must match input batch size")},CC=`
...
`,LC=(r,e,n)=>(()=>{switch(n.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${r.setByOffset("global_idx","result")}`,RC=(r,e)=>{let n=N("x",r[0].dataType,r[0].dims.length),t=[r[1].dims[0],r[1].dims[1],r[1].dims[2]],o=N("grid",r[1].dataType,t.length,2),i=[r[0].dims[0],r[0].dims[1],r[1].dims[1],r[1].dims[2]];e.format==="NHWC"&&(i=[r[0].dims[0],r[1].dims[1],r[1].dims[2],r[0].dims[3]],[Yn,wr,po,fo]=[0,3,1,2]);let a=G("output",r[0].dataType,i.length),s=n.type.value,u=E.size(i),l=[{type:12,data:u},...W(r[0].dims,t,i)],d=f=>`
  ...
  }`};return r.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:s,dataType:e.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[e,n],outputs:[-1]})[0]},qo=(r,e,n,t,o,i,a,s)=>{let u=i;if(a&&E.size(a.dims)>0){if(t===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=FC(r,i,a,e,t,n*o,s),u=u.reshape([e,t,n,o]),n===1||t===1?u:r.compute(it(u,P0.perm),{inputs:[u],outputs:[-1]})[0]}else return i.dims.length===3&&(u=i.reshape([e,t,n,o])),n===1||t===1?u:r.compute(it(u,P0.perm),{inputs:[u],outputs:[-1]})[0]},E0=(r,e)=>{let n=BC(r.inputs,e),t=r.inputs[0],o=Tt(r.inputs,1),i=Tt(r.inputs,2),a=Tt(r.inputs,3),s=Tt(r.inputs,4),u=Tt(r.inputs,5),l=Tt(r.inputs,6),d=Tt(r.inputs,7);if(t.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let f=o&&i&&o.dims.length===4&&i.dims.length===4,h=qo(r,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,t,a,0);if(f)return co(r,h,o,i,s,void 0,l,d,u,n);if(!o||!i)throw new Error("key and value must be provided");let g=qo(r,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,o,a,n.hiddenSize),b=qo(r,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,i,a,2*n.hiddenSize);co(r,h,g,b,s,void 0,l,d,u,n)}});var VC,GC,UC,WC,zc,D0,k0,Mc=k(()=>{"use strict";le();ge();Xe();ye();VC=r=>{if(!r||r.length<1)throw new Error("too few inputs")},GC=(r,e)=>{let n=[],t=e.numOutputs;return r[1].dims[0]>0&&(r[1].getBigInt64Array().forEach(o=>n.push(Number(o))),t=n.length),ce({numOutputs:t,axis:e.axis,splitSizes:n})},UC=r=>`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${r};${e}`,inputDependencies:i},getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u}),getShaderSource:l}},R0=(r,e)=>{let n=jC(r.inputs,e);if(r.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(r.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let t=r.inputs[0],o=r.inputs[1]&&r.inputs[1].dims.length>0?r.inputs[1]:void 0,i=r.inputs[2]&&r.inputs[2].dims.length>0?r.inputs[2]:void 0,a=r.inputs[3]&&r.inputs[3].dims.length!==0?r.inputs[3]:void 0,s=r.inputs[4]&&r.inputs[4].dims.length!==0?r.inputs[4]:void 0,u=r.inputs.length>4?r.inputs[5]:void 0,l=r.inputs.length>5?r.inputs[6]:void 0,d=n.kvNumHeads?n.kvNumHeads:n.numHeads,f=ce({axis:2,numOutputs:3,splitSizes:[n.numHeads*n.headSize,d*n.headSize,d*n.headSize]}),[h,g,b]=!o&&!i?r.compute(zc([t],f),{inputs:[t],outputs:[-1,-1,-1]}):[t,o,i],_,T;if(e.doRotary){let $=r.compute(KC(n.batchSize,n.sequenceLength,u,l),{inputs:[u,l],outputs:[-1]})[0],O=r.inputs[7],C=r.inputs[8],L=ce({interleaved:e.rotaryInterleaved!==0,numHeads:n.numHeads,rotaryEmbeddingDim:0,scale:e.scale}),R=[h,$,O,C],F=[-1];_=r.compute(Xa(R,L),{inputs:R,outputs:F})[0],R.splice(0,1,g);let q=ce({interleaved:e.rotaryInterleaved!==0,numHeads:n.kvNumHeads,rotaryEmbeddingDim:0,scale:e.scale});T=r.compute(Xa(R,q),{inputs:R,outputs:F})[0]}let v=qo(r,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,e.doRotary?_:h,void 0,0),x=L0(r,e.doRotary?T:g,n),I=L0(r,b,n);co(r,v,x,I,void 0,void 0,a,s,void 0,n,u,l)}});var M0,XC,ZC,B0,F0=k(()=>{"use strict";le();ge();Jn();ye();M0=(r,e,n,t,o,i,a,s)=>{let u=Ce(i),l=u===1?"f32":`vec${u}f`,d=u===1?"vec2f":`mat2x${u}f`,f=o*a,h=64;f===1&&(h=256);let g=[o,a,i/u],b=[o,a,2],_=["rank","type","type"],T=[];T.push(...W(g,b));let v=x=>{let I=N("x",e.dataType,3,u),$=N("scale",n.dataType,n.dims),O=N("bias",t.dataType,t.dims),C=G("output",1,3,2),L=[I,$,O,C];return`
  ...
  }`};r.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:T},{inputs:[e[0],_]})},B0=(r,e)=>{e.format==="NHWC"?ZC(r,r.inputs,e):XC(r,r.inputs,e)}});var JC,YC,V0,G0=k(()=>{"use strict";le();ge();ye();JC=r=>{if(!r||r.length<2)throw new Error("layerNorm requires at least 2 inputs.")},YC=(r,e,n)=>{let t=e.simplified,o=r[0].dims,i=r[1],a=!t&&r[2],s=o,u=E.normalizeAxis(e.axis,o.length),l=E.sizeToDimension(o,u),d=E.sizeFromDimension(o,u),f=E.size(i.dims),h=a?E.size(a.dims):0;if(f!==d||a&&h!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${y3(e.reduction,"output[data_offset + i]","value",b.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${e.cacheKey}_${e.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:d}},yw=r=>ce({reduction:r.reduction}),_w=(r,e)=>{r.compute(_3(r.inputs,e),{inputs:[r.inputs[1],r.inputs[2]],outputs:[]})}});var v3,w3,x3,ww,T3,I3,S3,$3,A3,O3,P3,C3,xw,E3,D3,k3,N3,L3,Tw,Iw,Sw=k(()=>{"use strict";le();ge();Xe();ye();v3=(r,e)=>{if(r.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),r.length>0){if(e.mode==="linear"){if(!(r.length===2||r.length===3||r.length===4&&r[0]===1&&r[1]===1||r.length===4&&r[0]===1&&r[3]===1||r.length===5&&r[0]===1&&r[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`:"",E3=(r,e,n,t,o)=>{let[a,s,u,l]=n.length===2?[-1,0,1,-1]:[0,2,3,1],d=r.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    depth = max(0, min(depth, ${n[s]} - 1));
    ...
    }`},N3=(r,e,n,t,o,i)=>{let a=r.dims,s=S3(i,e.axes,a.length),u=$3(a,t,o,e.axes),l=t.slice();t.length===0&&(l=a.map((x,I)=>x===0?1:u[I]/x),e.keepAspectRatioPolicy!=="stretch"&&(u=A3(a,l,e)));let d=G("output",r.dataType,u.length),f=N("input",r.dataType,a.length),h=E.size(u),g=a.length===u.length&&a.every((x,I)=>x===u[I]),b=e.coordinateTransformMode==="tf_crop_and_resize",_=e.extrapolationValue,T=f.type.value,v=x=>`
      ${g?"":`
      ...
      ${(()=>{switch(e.mode){case"nearest":return`
              ...
              ${(()=>{if(a.length===2||a.length===4)return`${E3(f,d,a,b,_)}`;if(a.length===3||a.length===5)return`${k3(f,d,a,b,_)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${a.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(t/64)},programUniforms:_})}},Pw=(r,e)=>{M3(r.inputs,e);let n=B3(r.inputs,e);r.compute(V3(r.inputs,n),{inputs:[0]})},Cw=r=>{let e=r.starts,n=r.ends,t=r.axes;return ce({starts:e,ends:n,axes:t})}});var G3,U3,Dw,kw,Nw=k(()=>{"use strict";le();ge();Xe();Jn();ye();G3=r=>{if(!r||r.length!==1)throw new Error("Softmax op requires 1 input.")},U3=(r,e)=>{let n=r.inputs[0],t=n.dims,o=E.size(t),i=t.length,a=E.normalizeAxis(e.axis,i),s=a<t.length-1,u,l=[];s?(l=Array.from({length:i},(L,R)=>R),l[a]=i-1,l[i-1]=a,u=r.compute(it(n,l),{inputs:[n],outputs:[-1]})[0]):u=n;let d=u.dims,f=d[i-1],h=o/f,g=Ce(f),b=f/g,_=64;h===1&&(_=256);let T=(L,R)=>R===4?`max(max(${L}.x, ${L}.y), max(${L}.z, ${L}.w))`:R===2?`max(${L}.x, ${L}.y)`:R===3?`max(max(${L}.x, ${L}.y), ${L}.z)`:L,v=N("x",u.dataType,u.dims,g),x=G("result",u.dataType,u.dims,g),I=v.type.value,$=Ve(u.dataType)==="f32"?`var threadMax = ${I}(-3.402823e+38f);`:`var threadMax = ${I}(-65504.0h);`,O=L=>`
