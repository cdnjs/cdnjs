...
`}var Zc,Yc,is,ss=x(()=>{"use strict";U();X();R();me();Zc=i=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${i}`}),Yc=(i,e,o,t)=>{let r=e.dims,n=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:e,type:0}}var Ot,wp,Ts,ws,vs,Is,_s,Ss,Os,As,Ps,Es,Ds,Ls,$s=x(()=>{"use strict";U();jt();X();R();Ot=(i,e,o,t=e[0].type,r)=>{let n=i.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>wp(i,e,o,t)}},wp=(i,e,o,t=e[0].type)=>{let r=i.session.pack?2:0,n=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=i.session.pack;if(n){let f=ft.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let c=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,m=e[1].dims.length!==0?e[1].dims.length:1,g=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",y=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",T=D(i.session.backend.glContext.version),_=a?`
      ${o.body}
      void main() {
...
`)},Ms=i=>k({axis:i.attributes.getInt("axis")}),$p=i=>{if(!i||i.length<1)throw new Error("too few inputs");let e=i[0].type,o=i[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of i){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function kp(){return At("abs")}function Bp(){return At("acos")}function Fp(){return At("asin")}function Np(){return At("atan")}function Cp(){return At("ceil")}function Rp(){return At("cos")}function Gp(i){let e="elu";return{body:`
  ...
  `,name:i,type:0}}var Zp,Q,Us,zs,Ws,Hs,co,qs,js,Yp,Xs,Ks,Js,Zs,Ys,Qs,po,tu,eu,ru,nu,ou,iu,au,su,uu,lu,fu,ho=x(()=>{"use strict";it();U();jt();X();R();Zp=(i,e,o,t)=>{let r=i.session.pack?2:0,n=D(i.session.backend.glContext.version);return{...e,output:{dims:o.dims,type:o.type,textureType:r},shaderSource:`
     ${t.body}
     void main() {
...
}`}var mu,bu,od,ad,Ur=x(()=>{"use strict";U();R();Mt();be();go();mu=(i,e,o)=>(ad(e),i.session.pack?[i.run(zr(i,e,o),e)]:[i.run(mo(e,o),e)]),bu=i=>$e(i.attributes),od=(i,e)=>({name:"MatMul",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[0,0,0]:[0,0],cacheHint:e});ad=i=>{if(!i||i.length!==2)throw new Error("MatMul requires 2 inputs.");if(i[0].dims[i[0].dims.length-1]!==i[1].dims[i[1].dims.length-2])throw new Error("shared dimension does not match.");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64")throw new Error("inputs should be float type");if(i[0].type!==i[1].type)throw new Error("inputs types should match")}});function ld(i,e,o,t){let r=[],n=[],s=o[0].dims,a=o[1].dims,u=s.length,l=a.length,f=t.length,c=f-u,d=f-l;r=s.map((v,B)=>`coords.${e[B+c]}`),r[u-1]="i*2",r.join(", "),n=a.map((v,B)=>`coords.${e[B+d]}`),n[l-2]="i*2",n.join(", ");let m=ft.getBroadcastDims(s,t),g=ft.getBroadcastDims(a,t),y=m.map(v=>`coords.${e[v+c]} = 0;`).join(`
...
`)},Bd=i=>{if(!i||i.length!==1)throw new Error("Transpose requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("input should be float tensor")}});var Pu,Eu,Fd,Du=x(()=>{"use strict";Wr();Pu=(i,e,o)=>{Fd(e);let t=o.blocksize,r=t*t,n=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[e[0].dims[0],t,t,e[0].dims[1]/r,e[0].dims[2],e[0].dims[3]]:[e[0].dims[0],e[0].dims[1]/r,t,t,e[0].dims[2],e[0].dims[3]],a=i.reshapeUnpacked(e[0],s),u={perm:n,cacheKey:`${n}`},[l]=ge(i,[a],u),f=[e[0].dims[0],e[0].dims[1]/r,e[0].dims[2]*t,e[0].dims[3]*t];return[i.reshapeUnpacked(l,f)]},Eu=i=>{let e=i.attributes.getInt("blocksize");if(e<1)throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);let o=i.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:e}},Fd=i=>{if(i.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${i.length}`);if(i[0].type==="string"||i[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var Lu,$u,Nd,ku=x(()=>{"use strict";U();Lu=(i,e,o)=>{Nd(e,o);let t=A.flattenShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},$u=i=>i.attributes.getInt("axis",1),Nd=(i,e)=>{if(!i||i.length!==1)throw new Error("Flatten requires 1 input.");let o=i[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(e<-o||e>o)throw new Error("Invalid axis");if(i[0].type==="string")throw new Error("string tensor is not supported.")}});var te,rr=x(()=>{"use strict";te=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var Bu,Fu,Cd,Rd,Gd,Md,Nu=x(()=>{"use strict";it();rr();U();R();Bu=(i,e,o)=>(Md(e,o.axis),[i.run(Gd(i,e,o),e)]),Fu=i=>k({axis:i.attributes.getInt("axis",0)}),Cd={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Rd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=o[1].dims.slice(),s=new Array(r.length+n.length-1);t=A.normalizeAxis(t,r.length);let a=[];for(let d=0;d<s.length;d++)d<t?(s[d]=r[d],a.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<t+n.length?(s[d]=n[d-t],a.push(`indexDataIdx[${d-t}] = outputIdx[${d}];`)):(s[d]=r[d-n.length+1],a.push(`inputIdx[${d-n.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=r.length,f=n.length||1,c=`
      ...
      float process(int indices[${f}]) {
          ...
          ${m}
          return value;
      }`;return{...i,output:{dims:a,type:e[0].type,textureType:0},variables:[{name:"alpha",type:"float",data:o.alpha},{name:"beta",type:"float",data:o.beta}],shaderSource:g}},zd=(i,e)=>{if(!i)throw new Error("Input is missing");if(e.isOptionalC&&(i.length<2||i.length>3))throw new Error("Invaid input shape.");if(!e.isOptionalC&&i.length!==3)throw new Error("Gemm requires 3 inputs");if(i.length===3&&i[2].dims.length!==1&&i[2].dims.length!==2)throw new Error("Invalid input shape of C");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64"||i.length===3&&i[2].type!=="float32"&&i[2].type!=="float64")throw new Error("Invalid input type.");if(i[0].type!==i[1].type||i.length===3&&i[0].type!==i[2].type)throw new Error("Input types are mismatched")}});var Vu,Uu,Wd,Hd,qd,jd,Xd,zu=x(()=>{"use strict";it();R();Vu=(i,e,o)=>(Xd(e),[i.run(qd(i,e,o),e)]),Uu=i=>{let e=i.attributes.getFloat("scale"),o=i.attributes.getFloats("bias");return k({scale:e,bias:o})},Wd={name:"ImageScaler",inputNames:["X"],inputTypes:[0]},Hd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=r.length,a=`
      ${jd(t.bias.length)}
      float process(int indices[${n}]) {
...
`)},Xd=i=>{if(!i||i.length!==1)throw new Error("ImageScaler requires 1 input.");if(i[0].dims.length!==4)throw new Error("Invalid input shape.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")}});var Hu,qu,Wu,Kd,Jd,Zd,Yd,Qd,th,ju=x(()=>{"use strict";X();R();Hu=(i,e,o)=>{th(e);let t=i.run(Jd(e[0]),e);return[i.run(Qd(i,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},qu=i=>i.attributes.getFloat("epsilon",1e-5),Wu={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},Kd=(i,e)=>{let o=e.dims.slice(),t=o[1],r=o[2]*o[3],n=[o[0],t],s=`
  ...
  void offsetToIndices(int offset, int[${i}] strides, out int[${i}] indices) {
    ...
    indices[${i} - 1] = offset;
  }`});var ye,ee,mh,bh,ml,bl,gl,yl,xl,Tl,wl,vl=x(()=>{"use strict";it();rr();U();R();ye=(i,e,o,t,r)=>{bh(e);let n={name:t,inputNames:["A"],inputTypes:[0]};return[i.run({...n,cacheHint:o.cacheKey,get:()=>mh(i,e,o,t,r,n)},e)]},ee=i=>{let e=i.attributes.getInts("axes",[]),o=i.attributes.getInt("keepdims",1)===1;return k({axes:e,keepDims:o})},mh=(i,e,o,t,r,n)=>{let s=[],a=e[0].dims.length||1,u=[],l=A.normalizeAxes(o.axes,e[0].dims.length),f=r(e,l),c=f[1];for(let g=0;g<e[0].dims.length;g++)l.indexOf(g)>=0||l.length===0?(o.keepDims&&s.push(1),c=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),xl=(i,e,o)=>ye(i,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),Tl=(i,e,o)=>ye(i,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),wl=(i,e,o)=>ye(i,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var Il,_l=x(()=>{"use strict";U();Il=(i,e)=>{let o=A.calculateReshapedDims(e[0].dims,e[1].integerData);return i.session.pack?[i.reshapePacked(e[0],o)]:[i.reshapeUnpacked(e[0],o)]}});var Sl,_o,Ol,Al,nr,gh,So,jr,Oo=x(()=>{"use strict";it();X();R();Sl={name:"Upsample",inputNames:["X"],inputTypes:[0]},_o=(i,e,o)=>(So(e,o),[i.run({...Sl,cacheHint:o.cacheKey,get:()=>gh(i,e,o)},e)]),Ol=i=>nr(i,7),Al=i=>nr(i,9),nr=(i,e)=>{let o=e>=10,t=i.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let r=[];e<9&&(r=i.attributes.getFloats("scales"),jr(r,t,o));let n=i.attributes.getFloat("extrapolation_value",0),s=e>10?i.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?i.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=i.attributes.getFloat("cubic_coeff_a",-.75),c=i.attributes.getInt("exclude_outside",0)!==0;if(c&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",m=0,g=0,y=0;return e>10?i.inputs.length>2?(m=1,g=2,y=3):(g=1,y=2):e===9&&(g=1),k({opset:e,isResize:o,mode:t,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:f,excludeOutside:c,useNearest2xOptimization:d,roiInputIdx:m,scalesInputIdx:g,sizesInputIdx:y})},gh=(i,e,o)=>{let t=D(i.session.backend.glContext.version),[r,n]=i.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((y,T)=>Math.floor(y*o.scales[T])),[a,u]=i.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),c=new Array(l),d=`
    ...
    }`;return{...Ml,output:{dims:e.dims,type:e.type,textureType:0},shaderSource:l}},ql=i=>{if(!i||i.length!==1)throw new Error("Softmax requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type")}});var Xl,Kl,Jl,Eh,Dh,Lh,Zl=x(()=>{"use strict";it();U();R();Xl={name:"Split",inputNames:["A"],inputTypes:[0]},Kl=(i,e,o)=>{Lh(e);let t=A.normalizeAxis(o.axis,e[0].dims.length),r=Eh(i,e,t,o),n=[];for(let s=0;s<r;++s)n.push(i.run({...Xl,cacheHint:`${o.cacheKey};${s}`,get:()=>Dh(i,e[0],o,t,s)},e));return n},Jl=i=>{let e=i.attributes.getInt("axis",0),o=i.attributes.getInts("split",[]),t=i.outputs.length;return k({axis:e,split:o,numOutputs:t})},Eh=(i,e,o,t)=>{let[,r]=Je.splitShape(e[0].dims,o,t.split,t.numOutputs);return r.length},Dh=(i,e,o,t,r)=>{let[n,s]=Je.splitShape(e.dims,t,o.split,o.numOutputs),a=s[r],u=n[r],f=`
...
`)}),f=`${c}
 ${f}`,f=f.replace("return",`${a} = `);let d=`
      ...
      `;i=i.replace(o[0],d)}}return i=i.replace(cf,""),i}var cf,Mh,df=x(()=>{"use strict";cf=/@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm,Mh="(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;"});function Be(i,e){let o=[],t=[],r=e!=null&&Array.isArray(e)&&e.length===0,n=e==null||r?null:Vh(e,i).sort(),s=0;for(let a=0;a<i.length;++a){if(n!=null){if(n[s]===a&&i[a]!==1)throw new Error(`Can't squeeze axis ${a} since its dim '${i[a]}' is not 1`);(n[s]==null||n[s]>a)&&i[a]===1&&(o.push(i[a]),t.push(a)),n[s]<=a&&s++}i[a]!==1&&(o.push(i[a]),t.push(a))}return{newShape:o,keptDims:t}}function Vh(i,e){let o=e.length;return i=i==null?e.map((t,r)=>r):[].concat(i),Pe(i.every(t=>t>=-o&&t<o),()=>`All values in axis param must be in range [-${o}, ${o}) but got axis ${i}`),Pe(i.every(Uh),()=>`All values in axis param must be integers but got axis ${i}`),i.map(t=>t<0?o+t:t)}function Uh(i){return i%1===0}function zh(i){if(i.length===0)return 1;let e=i[0];for(let o=1;o<i.length;o++)e*=i[o];return e}function hf(i){let e=Math.ceil(Math.sqrt(i));return[e,Math.ceil(i/e)]}var Xr,$o=x(()=>{"use strict";wt();U();Xr=class{constructor(e){this.maxTextureSize=e}computeTextureWH(e,o){let t=this.computeTexture(e,o);return o&&o.isPacked&&(t[0]/=2,t[1]/=2),o&&o.reverseWH?[t[1],t[0]]:t}computeTexture(e,o){let t=o&&o.isPacked;if(e.length===0)return t?[2,2]:[1,1];let r=this.maxTextureSize;if(o&&o.breakAxis!==void 0){let a=o.breakAxis>=e.length?1:e.slice(o.breakAxis).reduce((l,f)=>l*f),u=o.breakAxis<=0?1:e.slice(0,o.breakAxis).reduce((l,f)=>l*f);if(a>r||u>r)z.verbose("TextureLayout",`Given width/height preferences were unattainable: shape:${e}, breakAxis:${o.breakAxis}`);else return[a,u]}let n=e.slice(0);t&&(r=r*2,n=n.map((a,u)=>u>=n.length-2?n[u]%2===0?n[u]:n[u]+1:n[u]),n.length===1&&(n=[2,n[0]])),n.length!==2&&(n=Be(n).newShape);let s=zh(n);return n.length<=1&&s<=r?[1,s]:n.length===2&&n[0]<=r&&n[1]<=r?n:n.length===3&&n[0]*n[1]<=r&&n[2]<=r?[n[0]*n[1],n[2]]:n.length===3&&n[0]<=r&&n[1]*n[2]<=r?[n[0],n[1]*n[2]]:n.length===4&&n[0]*n[1]*n[2]<=r&&n[3]<=r?[n[0]*n[1]*n[2],n[3]]:n.length===4&&n[0]<=r&&n[1]*n[2]*n[3]<=r?[n[0],n[1]*n[2]*n[3]]:t?hf(s/4).map(a=>a*2):hf(s)}}});var Kr,mf=x(()=>{"use strict";U();jt();X();$o();Mt();Kr=class extends St{constructor(o){super(o)}getFunctions(){return{...this.offsetToCoords(),...this.coordsToOffset(),...this.toVec(),...this.valueFrom(),...this.getCommonUtilFuncs(),...this.getInputsSamplingSnippets(),...this.getOutputSamplingSnippet()}}getCustomTypes(){return{}}offsetToCoords(){let o="offsetToCoords";return{offsetToCoords:new O(`
