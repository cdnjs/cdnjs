...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[t(n.type),n.length??1])}},ao=(e,t)=>new kn(e,t),Ye=(e,t)=>{let n=e.length,r=[];for(let o=0;o<n;o++){let i=n-1-o,s=e[i]||1;(t[t.length-1-o]||1)>1&&s===1&&r.unshift(i)}return r}});var Eu,uo,Pu,zu,ge,lo,co,je=A(()=>{"use strict";R();N();ie();G();Eu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},uo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Pu=(e,t)=>v.sortBasedOnPerm(e,uo(e.length,t)),zu=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`);for(let i=0;i<t;++i)o.push(n.indicesSet("a",e[i],`i[${i}]`));return o.push("return a;}"),o.join(`
`)},ge=(e,t)=>{let n=e.dataType,r=e.dims.length,o=uo(r,t),i=Pu(e.dims,o),s=C("output",n,i.length),a=S("a",n,r),u;if(o.length===2&&o[0]===1&&o[1]===0){let d=s.type.value,c=[16,16,1];u=l=>`
  ...
  ${d.mainStart()}
    ...
    ${s.setByOffset("global_idx",a.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:h=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Ee=(e,t,n,r)=>{let o=e.inputs.length===1?n:zn(e.inputs,n),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((f,m)=>m));let s=v.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],d=Wu(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ge(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=Uu(a.length,u.dims.length));let[c,l]=Mu(u.dims,a),p=c;o.keepDims&&(p=Vu(c,s)),e.compute(Gu(t,{hint:o.cacheKey,inputDependencies:["type"]},[u],r,e.inputs[0].dataType,p,l),{inputs:[u]})},po=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},mo=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},fo=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},ho=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},go=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},yo=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},bo=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},wo=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},$o=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},_o=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}});var Pe,Lu,Ht,zn,ze,Hu,qu,Fu,Ku,ju,Zu,Qu,Xu,Yu,Ju,Oe,xo,So,Io,Co,To,Ao,ko,Eo,Po,zo,Lt=A(()=>{"use strict";R();N();ie();G();vo();Pe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Lu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ht=(e,t,n,r,o,i,s=!1,a=!1)=>{let u=[],d=n[0].dims,c=d.length,l=v.normalizeAxes(o,c),p=!a&&l.length===0;d.forEach((y,w)=>{p||l.indexOf(w)>=0?s&&u.push(1):u.push(y)});let f=u.length,m=v.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let w=[],g=S("_A",n[0].dataType,c),b=C("output",i,f),$=r(g,b,l),_=$[2];for(let x=0,I=0;x<c;x++)p||l.indexOf(x)>=0?(s&&I++,_=`for(var j${x}: u32 = 0; j${x} < ${d[x]}; j${x}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...E(i)]:[{type:12,data:u}]})}},ad=e=>M(e),Mo=(e,t)=>{let{inputs:n,outputCount:r}=e,o=ad({...t,outputCount:r});if(Z.webgpu.validateInputContent&&id(n,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(sd(n,o))}});var ud,dd,No,Wo=A(()=>{"use strict";N();G();ud=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},dd=e=>{let t=e[0].dims,n=e[0].dims[2],r=v.size(t)/4,o=e[0].dataType,i=S("input",o,t,4),s=S("bias",o,[n],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:c=>`
  ...
  }`}},No=e=>{ud(e.inputs),e.compute(dd(e.inputs))}});var ld,Q,Go,Lo,Ho,qo,Fo,Ko,jo,Zo,Qo,cd,Xo,Yo,Jo,ei,ct,ti,Ft,ni,ri,oi,ii,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,wi,Bn,Dn,$i,_i,vi,pd,md,xi,Kt=A(()=>{"use strict";R();N();ie();G();ld=(e,t,n,r,o,i,s)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let d=S("inputData",n,[a],4),c=C("outputData",r,[a],4),l=[{name:"vec_size",type:"u32"}];return s&&l.push(...s),`
  ...
  }`},Q=(e,t,n,r,o,i=e.dataType,s,a)=>{let u=[{type:12,data:Math.ceil(v.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:d=>ld(d,v.size(e.dims),e.dataType,i,n,r,a),getRunData:d=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(v.size(d[0].dims)/64/4)},programUniforms:u})}},Go=e=>{e.compute(Q(e.inputs[0],"Abs","abs"))},Lo=e=>{e.compute(Q(e.inputs[0],"Acos","acos"))},Ho=e=>{e.compute(Q(e.inputs[0],"Acosh","acosh"))},qo=e=>{e.compute(Q(e.inputs[0],"Asin","asin"))},Fo=e=>{e.compute(Q(e.inputs[0],"Asinh","asinh"))},Ko=e=>{e.compute(Q(e.inputs[0],"Atan","atan"))},jo=e=>{e.compute(Q(e.inputs[0],"Atanh","atanh"))},Zo=e=>M(e),Qo=(e,t)=>{let n;switch(t.to){case 10:n="vec4<f16>";break;case 1:n="vec4<f32>";break;case 12:n="vec4<u32>";break;case 6:n="vec4<i32>";break;case 9:n="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Q(e.inputs[0],"Cast",n,void 0,t.cacheKey,t.to))},cd=e=>{let t,n,r=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return M({min:t,max:n})},Xo=(e,t)=>{let n=t||cd(e.inputs),r=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},Yo=e=>{e.compute(Q(e.inputs[0],"Ceil","ceil"))},Jo=e=>{e.compute(Q(e.inputs[0],"Cos","cos"))},ei=e=>{e.compute(Q(e.inputs[0],"Cosh","cosh"))},ct=e=>M(e),ti=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,ni=e=>{let t=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,Ft(t)))},ri=e=>{e.compute(Q(e.inputs[0],"Exp","exp"))},oi=e=>{e.compute(Q(e.inputs[0],"Floor","floor"))},ii=e=>{let t=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,Ft(t)))},si=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},ai=e=>{e.compute(Q(e.inputs[0],"Not",t=>`!${t}`))},ui=e=>{e.compute(Q(e.inputs[0],"Neg",t=>`-${t}`))},di=e=>{e.compute(Q(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},li=e=>{let t=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},ci=e=>{e.compute(Q(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},pi=e=>M(e),mi=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},fi=e=>{e.compute(Q(e.inputs[0],"Sin","sin"))},hi=e=>{e.compute(Q(e.inputs[0],"Sinh","sinh"))},gi=e=>{e.compute(Q(e.inputs[0],"Sqrt","sqrt"))},yi=e=>{e.compute(Q(e.inputs[0],"Tan","tan"))},bi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,wi=e=>{e.compute(Q(e.inputs[0],"Tanh",bi))},Bn=(e="f32")=>`
...
`,Dn=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,$i=e=>{let t=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"FastGelu",Dn,Bn(t),void 0,e.inputs[0].dataType))},_i=(e,t)=>{let n=de(e.inputs[0].dataType);return e.compute(Q(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},vi=e=>{e.compute(Q(e.inputs[0],"Log","log"))},pd=(e,t)=>`
...
`,md=e=>`quick_gelu_impl(${e})`,xi=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(Q(e.inputs[0],"QuickGelu",md,pd(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var fd,hd,Ii,Ci=A(()=>{"use strict";N();G();Kt();fd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},hd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),i=v.size(t)/4,s=X(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${w}
      }`},yd=(e,t,n,r,o,i,s=n.dataType)=>{let a=!v.areEqual(n.dims,r.dims),u=n.dims,d=v.size(n.dims),c=!1,l=!1,p=[a];if(a){let f=ke.calcShape(n.dims,r.dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");u=f,d=v.size(u);let m=v.size(n.dims)===1,h=v.size(r.dims)===1,y=n.dims.length>0&&n.dims[n.dims.length-1]%4===0,w=r.dims.length>0&&r.dims[r.dims.length-1]%4===0;p.push(m),p.push(h),p.push(y),p.push(w);let g=1;for(let b=1;b<u.length;b++){let $=n.dims[n.dims.length-b]??1,_=r.dims[r.dims.length-b]??1;if($===_)g*=$;else break}g%4===0?(l=!0,c=!0):(m||h||y||w)&&(c=!0)}else c=!0;return p.push(c),{name:e,shaderCache:{hint:t+p.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>gd(f,n.dims,r.dims,u,c,a,l,o,n.dataType,r.dataType,s,i),getRunData:()=>({outputs:[{dims:u,dataType:s}],dispatchGroup:{x:Math.ceil(d/64/4)},programUniforms:[{type:12,data:Math.ceil(v.size(u)/4)},...E(n.dims,r.dims,u)]})}},Be=(e,t,n,r,o,i)=>{e.compute(yd(t,o??"",e.inputs[0],e.inputs[1],n,r,i))},Ti=e=>{Be(e,"Add",(t,n)=>`${t}+${n}`)},Ai=e=>{Be(e,"Div",(t,n)=>`${t}/${n}`)},ki=e=>{Be(e,"Equal",{scalar:(t,n)=>`u32(${t}==${n})`,vector:(t,n)=>`vec4<u32>(${t}==${n})`},void 0,void 0,9)},Ei=e=>{Be(e,"Mul",(t,n)=>`${t}*${n}`)},Pi=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Be(e,"Pow",{scalar:(r,o)=>`pow_custom(${r},${o})`,vector:(r,o)=>`pow_vector_custom(${r},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},zi=e=>{Be(e,"Sub",(t,n)=>`${t}-${n}`)},Oi=e=>{Be(e,"Greater",{scalar:(t,n)=>`u32(${t}>${n})`,vector:(t,n)=>`vec4<u32>(${t}>${n})`},void 0,void 0,9)},Bi=e=>{Be(e,"Less",{scalar:(t,n)=>`u32(${t}<${n})`,vector:(t,n)=>`vec4<u32>(${t}<${n})`},void 0,void 0,9)},Di=e=>{Be(e,"GreaterOrEqual",{scalar:(t,n)=>`u32(${t}>=${n})`,vector:(t,n)=>`vec4<u32>(${t}>=${n})`},void 0,void 0,9)},Ri=e=>{Be(e,"LessOrEqual",{scalar:(t,n)=>`u32(${t}<=${n})`,vector:(t,n)=>`vec4<u32>(${t}<=${n})`},void 0,void 0,9)}});var wd,$d,_d,vd,Mi,Vi,Ni=A(()=>{"use strict";R();N();ie();G();wd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let n=0,r=e[n],o=r.dataType,i=r.dims.length;e.forEach((s,a)=>{if(a!==n){if(s.dataType!==o)throw new Error("input tensors should be one type");if(s.dims.length!==i)throw new Error("input tensors should have the same shape");s.dims.forEach((u,d)=>{if(d!==t&&u!==r.dims[d])throw new Error("non concat dimensions must match")})}})},$d=(e,t)=>`
...
`)},vd=(e,t,n,r)=>{let o=v.size(n),i=new Array(e.length),s=new Array(e.length),a=0,u=[],d=[],c=[{type:12,data:o}];for(let h=0;h<e.length;++h)a+=e[h].dims[t],i[h]=a,d.push(e[h].dims.length),s[h]=S(`input${h}`,r,d[h]),u.push("rank"),c.push({type:12,data:i[h]});for(let h=0;h<e.length;++h)c.push(...E(e[h].dims));c.push(...E(n));let l=C("output",r,n.length),p=l.indicesGet("indices",t),f=Array.from(Array(i.length).keys()).map(h=>`uniforms.sizeInConcatAxis${h}`).join(","),m=h=>`
  ...
  ${h.mainStart()}
    ...
    ${_d(s,l)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:c}),getShaderSource:m}},Mi=(e,t)=>{let n=e.inputs,r=n[0].dims,o=v.normalizeAxis(t.axis,r.length);wd(n,o);let i=r.slice();i[o]=n.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let s=n.filter(a=>v.size(a.dims)>0);e.compute(vd(s,o,i,n[0].dataType),{inputs:s})},Vi=e=>M({axis:e.axis})});var _e,ve,xe,jt,Re=A(()=>{"use strict";R();N();_e=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},ve=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},xe=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},jt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=e?.activation_params||[io,so];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}});var le,Zt,pt=A(()=>{"use strict";le=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Zt=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var Qt,Rn=A(()=>{"use strict";Qt=e=>`
...
`});var xd,Sd,mt,Wi,Id,ft,Cd,Xt,ht=A(()=>{"use strict";R();N();G();Re();pt();xd=(e,t)=>e?`
...
`},Cd=(e,t,n,r,o,i=!1)=>{let[s,a,u]=o,[d,c,l,p]=r,f=Ye(s,u),m=Ye(a,u),h=X(r[0].type.tensor),y=()=>{let b=c.rank,$=d.rank,_=`var aIndices: ${c.type.indices};`;for(let x=b-2-1,I=$-1;x>=0;x--,I--)_+=`
...
bIndices[${b-2}] = u32(row);
    ...
    `},Xt=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s.slice(0,-2),d=a.slice(0,-2),c=r?r.slice(0,-2):n.slice(0,-2),l=v.size(c),p=s[s.length-2],f=s[s.length-1],m=a[a.length-1],h=f%4===0&&m%4===0,y=p<=8?[4,1,1]:[4,4,1],w=[8,8,1],g=[Math.ceil(m/w[0]/y[0]),Math.ceil(p/w[1]/y[1]),Math.ceil(l/w[2]/y[2])],b=h?4:1,$=[...u,p,f/b],_=$.length,x=[...d,f,m/b],I=x.length,T=[l,p,m/b],P=[{type:6,data:p},{type:6,data:m},{type:6,data:f}];ve(t,P),P.push(...E(c,$,x));let z=["rank","rank"],D=e.length>2;D&&(P.push(...E(e[2].dims)),z.push("rank")),P.push(...E(T));let j=L=>{let q=c.length,ae=Gt("batchDims",e[0].dataType,q,1),U=X(e[0].dataType),te=S("a",e[0].dataType,_,b),re=S("b",e[1].dataType,I,b),V=C("result",e[0].dataType,T.length,b),ne=[te,re];if(D){let B=o?b:1;ne.push(S("bias",e[2].dataType,e[2].dims.length,B))}let F=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];xe(t,F);let H=X(V.type.tensor),K=_e(t,V.type.value,H),k=Cd(b,D,K,[ae,te,re,V],[u,d,c],o);return`
  ${L.registerUniforms(F).registerInternalVariables(ae).declareVariables(...ne,V)}
  ${k}
  ${h?mt(y,w,U,ae):ft(y,w,U,ae)}
                   `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${h};${o}`,inputDependencies:z},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:P}),getShaderSource:j}}});var Td,Gi,Li=A(()=>{"use strict";R();De();G();Re();pt();Rn();ht();Td=(e,t,n,r,o=!1,i,s=4,a=4,u=4,d="f32")=>{let c=z=>{switch(z){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},l=z=>{switch(z){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},p=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${_}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${V}>`:V}) {
        ...
        ${h?mt(b,g,V,void 0,!d,T):ft(b,g,V,void 0,!d,T,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${_};${h};${P};${z};${D};${x};${I};${T}`,inputDependencies:q},getRunData:()=>({outputs:[{dims:u?u(n):n,dataType:e[0].dataType}],dispatchGroup:{x:$[0],y:$[1],z:$[2]},programUniforms:L}),getShaderSource:ae}}});var Ad,Hi,Yt,kd,qi,Ed,Fi,Ki,ji=A(()=>{"use strict";R();De();N();G();Re();pt();Ad=e=>{let t=1;for(let n=0;n<e.length;n++)t*=e[n];return t},Hi=e=>typeof e=="number"?[e,e,e]:e,Yt=(e,t)=>t<=1?e:e+(e-1)*(t-1),kd=(e,t,n,r=1)=>{let o=Yt(t,r);return Math.floor((e[0]*(n-1)-n+o)/2)},qi=(e,t,n,r,o)=>{o==null&&(o=kd(e,t[0],r[0]));let i=[0,0,0,n];for(let s=0;s<3;s++)e[s]+2*o>=t[s]&&(i[s]=Math.trunc((e[s]-t[s]+2*o)/r[s]+1));return i},Ed=(e,t,n,r,o,i,s,a,u,d)=>{let c,l,p,f;if(e==="VALID"&&(e=0),typeof e=="number"){c={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=qi([t,n,r,1],[a,u,d],1,[o,i,s],e);l=m[0],p=m[1],f=m[2]}else if(Array.isArray(e)){if(!e.every((h,y,w)=>h===w[0]))throw Error(`Unsupported padding parameter: ${e}`);c={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=qi([t,n,r,1],[a,u,d],1,[o,i,s],e[0]);l=m[0],p=m[1],f=m[2]}else if(e==="SAME_UPPER"){l=Math.ceil(t/o),p=Math.ceil(n/i),f=Math.ceil(r/s);let m=(l-1)*o+a-t,h=(p-1)*i+u-n,y=(f-1)*s+d-r,w=Math.floor(m/2),g=m-w,b=Math.floor(h/2),$=h-b,_=Math.floor(y/2),x=y-_;c={top:b,bottom:$,left:_,right:x,front:w,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:c,outDepth:l,outHeight:p,outWidth:f}},Fi=(e,t,n,r,o,i=!1,s="channelsLast")=>{let a,u,d,c,l;if(s==="channelsLast")[a,u,d,c,l]=e;else if(s==="channelsFirst")[a,l,u,d,c]=e;else throw new Error(`Unknown dataFormat ${s}`);let[p,,f,m,h]=t,[y,w,g]=Hi(n),[b,$,_]=Hi(r),x=Yt(f,b),I=Yt(m,$),T=Yt(h,_),{padInfo:P,outDepth:z,outHeight:D,outWidth:j}=Ed(o,u,d,c,y,w,g,x,I,T),L=i?p*l:p,q=[0,0,0,0,0];return s==="channelsFirst"?q=[a,L,z,D,j]:s==="channelsLast"&&(q=[a,z,D,j,L]),{batchSize:a,dataFormat:s,inDepth:u,inHeight:d,inWidth:c,inChannels:l,outDepth:z,outHeight:D,outWidth:j,outChannels:L,padInfo:P,strideDepth:y,strideHeight:w,strideWidth:g,filterDepth:f,filterHeight:m,filterWidth:h,effectiveFilterDepth:x,effectiveFilterHeight:I,effectiveFilterWidth:T,dilationDepth:b,dilationHeight:$,dilationWidth:_,inShape:e,outShape:q,filterShape:t}},Ki=(e,t,n,r,o,i)=>{let s=i==="channelsLast",a=s?e[0].dims[3]:e[0].dims[1],u=!1,d=[64,1,1],c={x:n.map((g,b)=>b)},l=[Math.ceil(Ad(c.x.map(g=>n[g]))/d[0]),1,1];J("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${l}`);let p=u?s&&a%4!==0?3:4:1,f=v.size(n),m=[{type:12,data:f},{type:12,data:r},{type:12,data:o},{type:12,data:t.strides},{type:12,data:t.dilations}];ve(t,m),m.push(...E(e[0].dims,e[1].dims));let h=["rank","rank"],y=e.length===3;y&&(m.push(...E(e[2].dims)),h.push("rank")),m.push(...E(n));let w=g=>{let b=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:r.length},{name:"pads",type:"u32",length:o.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];xe(t,b);let $=u?4:1,_=X(e[0].dataType),x=S("x",e[0].dataType,e[0].dims.length,p===3?1:p),I=S("W",e[1].dataType,e[1].dims.length,$),T=[x,I],P=C("result",e[0].dataType,n.length,$),z="";if(y){let L=S("bias",e[2].dataType,e[2].dims.length,$);T.push(L),z+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${_}>`:_} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${p};${y}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:m}),getShaderSource:w}}});var Zi,Qi,Xi=A(()=>{"use strict";R();N();G();Un();Re();Zi=(e,t,n)=>{let r=e.length>2,o=r?"value += b[output_channel];":"",i=e[0].dims,s=e[1].dims,a=s[0]/t.group,u=t.format==="NHWC",d=Jt(i,s,t.dilations,t.pads,t.strides,u),c=v.size(d),l=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:a}];ve(t,l),l.push(...E(i,s));let p=["rank","rank"];r&&(l.push(...E(e[2].dims)),p.push("rank")),l.push(...E(d));let f=m=>{let h=C("output",e[0].dataType,d.length),y=X(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,i.length),b=S("w",e[1].dataType,s.length),$=[g,b];r&&$.push(S("b",e[2].dataType,e[2].dims.length));let _=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];return xe(t,_),`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:t.cacheKey,inputDependencies:p},getRunData:()=>({outputs:[{dims:n?n(d):d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l}),getShaderSource:f}},Qi=(e,t,n,r)=>{let o=e.length>2,i=ee(n[3]),s=ee(n[2]),a=v.size(n)/i/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],c=[n[0],n[1],n[2],n[3]/i],l=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ve(t,l),l.push(...E(u,d,c));let p=(s-1)*t.strides[1]+d[1],f=m=>{let h=C("output",e[0].dataType,c.length,i),y=X(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,u.length,i),b=S("w",e[1].dataType,d.length,i),$=[g,b];o&&$.push(S("b",e[2].dataType,e[2].dims,i));let _=o?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return xe(t,x),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${i};${s};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:f}}});var Mn,Pd,Yi,Vn=A(()=>{"use strict";R();N();ht();G();Re();Mn=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s[s.length-2],d=a[a.length-1],c=s[s.length-1],l=ee(d),p=ee(c),f=ee(u),m=v.size(n)/l/f,h=e.length>2,y=r?r.slice(0,-2):n.slice(0,-2),g=[v.size(y),u,d],b=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:c}];ve(t,b),b.push(...E(y,s,a)),h&&b.push(...E(e[2].dims)),b.push(...E(g));let $=_=>{let x=Gt("batch_dims",e[0].dataType,y.length),I=S("a",e[0].dataType,s.length,p),T=S("b",e[1].dataType,a.length,l),P=C("output",e[0].dataType,g.length,l),z=X(P.type.tensor),D=_e(t,P.type.value,z),j=[I,T],L="";if(h){let F=o?l:1;j.push(S("bias",e[2].dataType,e[2].dims.length,F)),L=`${o?`value += bias[col / ${F}];`:`value += ${P.type.value}(bias[row + i]);`}`}let q=s.slice(0,-2),ae=a.slice(0,-2),U=Ye(q,y),te=Ye(ae,y),re=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];xe(t,re);let V=(F,H)=>{let K=F.rank,k=F.name;if(K===2)return`var ${k}_indices = ${F.type.indices}(0u, 0u);`;let B=x.rank,Y=`var ${k}_indices: ${F.type.indices};`;for(let Te=K-2-1,fe=B-1;Te>=0;Te--,fe--)Y+=`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${p};${f};${o}`,inputDependencies:h?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:$}},Pd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Yi=e=>{Pd(e.inputs);let t=ke.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];n<8&&r<8?e.compute(Mn(e.inputs,{activation:""},t)):e.compute(Xt(e.inputs,{activation:""},t))}});var Jt,Nn,zd,Wn,Gn,Ji,Od,Bd,Ln,Un=A(()=>{"use strict";N();Li();ji();ht();Xi();Re();Vn();je();Jt=(e,t,n,r,o,i)=>{let s=e[0],a=e.slice(i?1:2,i?3:4),u=a.length,d=t[0],l=t.slice(2).map((m,h)=>m+(m-1)*(n[h]-1)),f=a.map((m,h)=>m+r[h]+r[h+u]).map((m,h)=>Math.floor((m-l[h]+o[h])/o[h]));return f.splice(0,0,s),f.splice(i?3:1,0,d),f},Nn=[2,3,1,0],zd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Wn=(e,t)=>{let n=e.kernelShape.slice();for(let i=2;i<t[1].dims.length;++i)n[i-2]===0&&(n[i-2]=t[1].dims[i]);let r=e.pads.slice();qe.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:n,pads:r}),o},Gn=e=>{let t=jt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,i=e.group,s=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Ji=(e,t,n,r)=>{let o=n.format==="NHWC";if(n.group!==1){if(!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1){let I=Jt(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),T=e.kernelCustomData.wT??e.compute(ge(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let P=[t[0],T];t.length===3&&P.push(t[2]),e.compute(Qi(P,n,I,r),{inputs:P})}else e.compute(Zi(t,n,r));return}let i=t.length===3,s=t[0].dims[o?1:2],a=t[0].dims[o?2:3],u=t[0].dims[o?3:1],d=t[1].dims[2],c=t[1].dims[3],l=Jt(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),p=l[o?1:2],f=l[o?2:3],m=l[o?3:1],h=o&&d===s&&c===a&&n.pads[0]===0&&n.pads[1]===0;if(h||d===1&&c===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let x=l[0],I,T,P,z=[];if(o){let L=e.kernelCustomData.wT??e.compute(ge(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=L),h){let q=s*a*u;I=t[0].reshape([1,x,q]),T=L.reshape([1,q,m]),P=[1,x,m]}else I=t[0].reshape([x,s*a,u]),T=L.reshape([1,u,m]),P=[x,p*f,m];z.push(I),z.push(T)}else I=t[0].reshape([x,u,s*a]),T=t[1].reshape([1,m,u]),P=[x,m,p*f],z.push(T),z.push(I);i&&z.push(t[2]);let D=P[2],j=z[0].dims[z[0].dims.length-1];D<8&&j<8?e.compute(Mn(z,n,l,P,o,r),{inputs:z}):e.compute(Xt(z,n,l,P,o,r),{inputs:z});return}let y=!0,w=e.kernelCustomData.wT??e.compute(ge(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=w);let g=[t[0],w];i&&g.push(t[2]);let b=o?p*f:m,$=o?m:p*f,_=d*c*u;e.compute(Gi(g,n,l,b,$,_,i,y,r),{inputs:g})},Od=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),s=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=Wn({...t,pads:o,strides:i,dilations:s,kernelShape:a},r);Ji(e,r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Bd=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",o=Wn(n,t),i=n.autoPad==="NOTSET"?n.pads:n.autoPad,s=Fi(t[0].dims,t[1].dims,n.strides,n.dilations,i,!1,r);e.compute(Ki(t,o,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},Ln=(e,t)=>{if(zd(e.inputs,t),e.inputs[0].dims.length===3)Od(e,t);else if(e.inputs[0].dims.length===5)Bd(e,e.inputs,t);else{let n=Wn(t,e.inputs);Ji(e,e.inputs,n)}}});var Dd,es,ts=A(()=>{"use strict";R();De();G();Re();pt();Rn();ht();Dd=(e,t=!1,n,r,o=4)=>{let i=w=>{switch(w){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${r}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${o}] = value;
        ...
        ${m?mt(g,w,ne,void 0,!u,_):ft(g,w,ne,void 0,!u,_,!1,void 0,a)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${g};${w};${m}`,inputDependencies:D},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:z}),getShaderSource:j}}});var Rd,Hn,ns=A(()=>{"use strict";R();De();N();G();Rd=(e,t,n,r,o,i=!1,s,a,u=!1)=>{let d=u?1:2,c=u?2:3,l=u?3:1,p=i?2:1,f=`
  ...
  ${i?b:$}}`},Hn=(e,t,n)=>{let r=e.length>2,o=t.outputShape,i=v.size(o),s=[Math.ceil(i/64),1,1];J("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${s}`);let a=t.format==="NHWC",u=["rank","rank"],d=[t.strides[0],t.strides[1]],c=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],l=[t.dilations[0],t.dilations[1]],p=[c[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),c[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],f=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,h=t.group,y=e[1].dims,w=y[0]/h,g=y[1],b=[{type:12,data:i},{type:12,data:d},{type:12,data:c},{type:12,data:l},{type:12,data:p},{type:6,data:f},{type:12,data:w},{type:12,data:g},...E(e[0].dims,e[1].dims)];r&&(b.push(...E(e[2].dims)),u.push("rank")),b.push(...E(o));let $=s[1]===1&&s[2]===1,_=x=>{let I=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:d.length},{name:"filter_dims",type:"u32",length:c.length},{name:"dilations",type:"u32",length:c.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:f.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],T=X(e[0].dataType);return`${Rd(x,e,o,r,$,m,T,I,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:s[0],y:s[1],z:s[2]},outputs:[{dims:n?n(o):o,dataType:e[0].dataType}],programUniforms:b}),getShaderSource:_}}});var Ud,Md,Vd,rs,os,Nd,Wd,Gd,Ld,is,ss=A(()=>{"use strict";ts();ns();Re();je();Ud=(e,t,n,r,o,i)=>(e-1)*t+n+(r-1)*o+1-i,Md=(e,t,n,r,o)=>{let i=Math.floor(e/2);t==="SAME_UPPER"?(n[r]=i,n[o]=e-i):t==="SAME_LOWER"&&(n[r]=e-i,n[o]=i)},Vd=(e,t,n,r,o,i,s,a,u,d)=>{let c=e.length-2,l=d.length===0;if(u.length===0)for(let m=0;m<c;++m)u.push(0);let p=e[0],f=t[a?3:1]*o;for(let m=0,h=e.length-c-(a?1:0);m<c;++m,++h){let y=e[h],w=l?y*s[m]:d[m],g=Ud(y,s[m],i[m],t[h],n[m],w);Md(g,r,i,m,m+c),l&&d.push(s[m]*(y-1)+u[m]+(t[h]-1)*n[m]+1-i[m]-i[m+c])}d.splice(0,0,p),d.splice(a?3:1,0,f)},rs=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((l,p)=>l*p,1)===0){n.length=0;for(let l=2;l<t[1].dims.length;++l)n.push(t[1].dims[l])}let r=e.format==="NHWC";n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let o=e.pads.slice(),i=e.outputShape.slice(),s=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((l,p)=>l+p,0)===0){let l=t[0].dims.length-2;u=new Array(l).fill(1)}let d=e.strides.slice();if(d.reduce((l,p)=>l+p,0)===0){let l=t[0].dims.length-2;d=new Array(l).fill(1)}Vd(a,n,u,e.autoPad,e.group,o,d,r,s,i);let c=Object.assign({},e);return Object.assign(c,{kernelShape:n,pads:o,outputPadding:s,outputShape:i,dilations:u,strides:d}),c},os=e=>{let t=jt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,i=e.group,s=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),c=e.outputPadding,l=e.outputShape;return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,outputPadding:c,outputShape:l,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Nd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.reduce((c,l)=>c+l,0)>0&&t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.reduce((c,l)=>c+l,0)>0&&t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.reduce((c,l)=>c+l,0)>0&&t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.outputPadding.length!==i&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(t.kernelShape.reduce((c,l)=>c+l,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Wd=[2,3,1,0],Gd=(e,t,n)=>{let r=rs(n,t),o=n.format==="NHWC",i=r.outputShape,s=i[o?3:1],a=t[0].dims[o?3:1];if(r.group!==1||s===1&&a===1){e.compute(Hn(t,r));return}let u=i[o?1:2],d=i[o?2:3],c=t[1].dims[2],l=t[1].dims[3],p=o?u*d:s,f=o?s:u*d,m=c*l*a,h=!0,y=e.kernelCustomData.wT??e.compute(ge(t[1],Wd),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=y);let w=[t[0],y],g=t.length===3;g&&(!o&&t[2].dims.length===1?w.push(t[2].reshape([t[2].dims[0],1,1])):w.push(t[2])),e.compute(es(w,r,i,p,f,m,g,h),{inputs:w})},Ld=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let i=t.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],s=[1].concat(s),i=[1].concat(i),o=[1].concat(o);let u=rs({...t,pads:a,strides:s,dilations:i,kernelShape:o},r);e.compute(Hn(r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]]))},is=(e,t)=>{Nd(e.inputs,t),e.inputs[0].dims.length===3?Ld(e,t):Gd(e,e.inputs,t)}});var Hd,as,us,ds=A(()=>{"use strict";R();N();ie();G();Hd=(e,t,n,r)=>{let o=v.size(t),i=t.length,s=S("input",e,i),a=C("output",e,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),d=v.normalizeAxis(u,i),c=l=>{let p=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,f=O("uniforms.input_shape","uniforms.axis",i),m=r.reverse?p+(r.exclusive?" + 1":""):"0",h=r.reverse?f:p+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...E(t,t)]}),getShaderSource:c}},as=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,o=e.inputs[1];e.compute(Hd(r,n,o,t),{inputs:[0]})},us=e=>{let t=e.exclusive===1,n=e.reverse===1;return M({exclusive:t,reverse:n})}});var qd,Fd,Kd,ls,cs,ps=A(()=>{"use strict";R();N();ie();G();qd=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Fd=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`);for(let i=0;i<t;++i)o.push(n.indicesSet("a",e[i],`i[${i}]`));return o.push("return a;}"),o.join(`
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:n.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let c=u.filter(p=>n.symbolToInfo.has(p)).map(p=>({type:12,data:n.symbolToInfo.get(p)?.dimValue||0}));c.push({type:12,data:s});let l=e.map((p,f)=>[...E(p)]).reduce((p,f)=>p.concat(f),c);return l.push(...E(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:l}},getShaderSource:d}},hs=(e,t)=>{let n=new Kn(e.inputs,t.equation),r=n.outputDims,o=e.inputs.map((i,s)=>i.dims);e.compute(Qd(o,e.inputs[0].dataType,n,r))},gs=e=>{let t=e.equation.replace(/\s+/g,"");return M({equation:t})}});var Xd,bs,Yd,Jd,ws,$s=A(()=>{"use strict";R();N();G();Xd=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,o=t.length<n.length?0:t.length-n.length;for(;r<n.length&&o<t.length;++r,++o)if(n[r]!==t[o]&&n[r]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},bs=(e,t)=>{let n=e.length-t.length,r=[];for(let o=0;o<n;++o)r.push(e[o]);for(let o=0;o<t.length;++o)r.push(t[o]===1?e[o+n]:t[o]);return r},Yd=(e,t)=>e.length>t.length?bs(e,t):bs(t,e),Jd=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=Yd(t,n),o=e[0].dataType,i=o===9?4:1,s=Math.ceil(v.size(r)/i),a=d=>{let c=S("input",o,t.length,i),l=C("output",o,r.length,i),p;if(o===9){let f=(m,h,y="")=>`
    ...
    ${p}`},u=[{type:12,data:s},...E(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},ws=e=>{Xd(e.inputs),e.compute(Jd(e.inputs),{inputs:[0]})}});var el,_s,vs=A(()=>{"use strict";R();N();G();Kt();el=e=>{let t=e[0].dataType,n=v.size(e[0].dims),r=v.size(e[1].dims),o=r%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],l=f=>`
    ...
    ${s.mainStart(Fe)}
      ...
      ${p}
      let x_in = x + bias;
      ${d.setByOffset("global_idx",Dn("x_in"))}
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${o}`,inputDependencies:["type","type"]},getShaderSource:i,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(n/Fe/4)}})}},_s=e=>{e.inputs.length<2||v.size(e.inputs[1].dims)===0?$i(e):e.compute(el(e.inputs))}});var tl,nl,xs,Ss,Is=A(()=>{"use strict";R();N();ie();G();tl=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},nl=(e,t)=>{let n=e[0].dims,r=e[1].dims,o=n.length,i=v.normalizeAxis(t.axis,o),s=n.slice(0);s.splice(i,1,...r);let a=n[i],u=e[0].dataType===9?4:1,d=Math.ceil(v.size(s)/u),c=[{type:12,data:d},{type:6,data:a},{type:12,data:i},...E(e[0].dims,e[1].dims,s)],l=p=>{let f=S("data",e[0].dataType,e[0].dims.length,u),m=S("inputIndices",e[1].dataType,e[1].dims.length),h=C("output",e[0].dataType,s.length,u),y=g=>{let b=r.length,$=`var indicesIndices${g}  = ${m.type.indices}(0);`;for(let _=0;_<b;_++)$+=`${b>1?`indicesIndices${g}[${_}]`:`indicesIndices${g}`} = ${s.length>1?`outputIndices${g}[uniforms.axis + ${_}]`:`outputIndices${g}`};`;$+=`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,h)=>h!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,h)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:d}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:f}},Cs=(e,t)=>{let n=e.inputs;rl(n,t),e.compute(ol(e.inputs,t))},Ts=e=>M({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var il,sl,ks,Es,Ps=A(()=>{"use strict";R();N();ie();G();il=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  ${_.mainStart([l,r.kvNumHeads,1])}
    ...
    ${b}
  }`;return{name:"ConcatPastNew",shaderCache:{hint:`${r.kvNumHeads}${l}${!!t}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:o,dataType:n}],dispatchGroup:p,programUniforms:m}),getShaderSource:$}},Gs=e=>M({...e}),gl=M({perm:[0,2,1,3]}),Ws=(e,t,n,r,o)=>{let i=t,s=r.kvNumHeads,a=r.nReps;return t.dims.length===3&&r.kvSequenceLength!==0&&(i=t.reshape([r.batchSize,r.kvSequenceLength,s,r.headSize])),n?i=e.compute(Ns(i,n,i.dataType,r),{inputs:[i,n],outputs:[r.isPastkvBSNH?o:-1]})[0]:i=e.compute(Ns(i,void 0,i.dataType,r),{inputs:[i],outputs:[r.isPastkvBSNH?o:-1]})[0],a!==1&&(i=e.compute(Zn([i],[1,1,1,a]),{inputs:[i],outputs:[-1]})[0],i=i.reshape([r.batchSize,r.totalSequenceLength,s*a,r.headSize])),e.compute(ge(i,gl.perm),{inputs:[i],outputs:[-1]})[0]},Ls=(e,t)=>{let n=hl(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let r=gt(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,e.inputs[0],void 0,0),o=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,i=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,s=Ws(e,e.inputs[1],o,n,1),a=Ws(e,e.inputs[2],i,n,2);Je(e,r,s,a,void 0,void 0,void 0,void 0,void 0,n,t)}});var yl,bl,wl,qs,Fs=A(()=>{"use strict";R();N();G();yl=(e,t)=>{let n=e[0].dims,r=n,o=2,i=v.sizeToDimension(n,o),s=v.sizeFromDimension(n,o),a=ee(s),u=s/a,d=[n[0],n[1],u],c=["rank","type","type"],l=[{type:12,data:s},{type:12,data:u}];l.push(...E(d,d));let p=f=>{let m=S("x",e[0].dataType,d.length,a),h=S("scale",e[1].dataType,e[1].dims),y=S("bias",e[2].dataType,e[2].dims),w=C("output",e[0].dataType,d.length,a),g=[m,h,y,w],b=m.type.value,$=a===1?"f32":`vec${a}<f32>`,_=64,x=[{name:"normSize",type:"u32"},{name:"normPackedSize",type:"u32"}];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:f},{inputs:[t[0],p]})},qs=(e,t)=>{t.format==="NHWC"?wl(e,e.inputs,t):e.compute(yl(e.inputs,t))}});var $l,_l,Ks,js=A(()=>{"use strict";R();N();G();$l=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},_l=(e,t,n)=>{let r=t.simplified,o=e[0].dims,i=e[1],s=!r&&e[2],a=o,u=v.normalizeAxis(t.axis,o.length),d=v.sizeToDimension(o,u),c=v.sizeFromDimension(o,u),l=v.size(i.dims),p=s?v.size(s.dims):0;if(l!==c||s&&p!==c)throw new Error(`Size of X.shape()[axis:] == ${c}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${l} and bias size of ${p}`);let f=[];for(let _=0;_<o.length;++_)_<u?f.push(o[_]):f.push(1);let m=ee(c),h=["type","type"],y=[{type:12,data:d},{type:1,data:c},{type:12,data:Math.floor(c/m)},{type:1,data:t.epsilon}];s&&h.push("type");let w=n>1,g=n>2,b=_=>{let x=X(e[0].dataType),I=[S("x",e[0].dataType,e[0].dims,m),S("scale",i.dataType,i.dims,m)];s&&I.push(S("bias",s.dataType,s.dims,m)),I.push(C("output",e[0].dataType,a,m)),w&&I.push(C("mean_data_output",1,f)),g&&I.push(C("inv_std_output",1,f));let T=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${_.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${f};${m};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:l}],dispatchGroup:{x:w},programUniforms:b}),getShaderSource:I}},Zs=(e,t)=>{vl(e.inputs,t),e.compute(xl(e.inputs,t))},Qs=e=>M(e)});var Sl,Il,Cl,Tl,Al,kl,El,Pl,Ys,Js=A(()=>{"use strict";R();N();G();Sl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Il=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
      ...
      `},Cl=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
          ...
          `},kl=(e,t,n)=>{switch(n.mode){case 0:return Il(e,t,n.pads.length);case 1:return Cl(e,t,n.pads.length);case 2:return Tl(e,t,n.pads.length);case 3:return Al(e,t,n.pads.length);default:throw new Error("Invalid mode")}},El=(e,t)=>{let n=v.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,o=v.size(n),i=[{type:12,data:o},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&i.push({type:s?e[2].dataType:1,data:t.value}),i.push(...E(e[0].dims,n));let a=["rank"],u=d=>{let c=C("output",e[0].dataType,n.length),l=S("x",e[0].dataType,r.length),p=l.type.value,f=kl(c,r.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:s?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},ra=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,zl=e=>`${ra(e)};${e.countIncludePad}`,Ol=e=>`${ra(e)};${e.storageOrder};${e.dilations}`,oa=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),ia=(e,t,n,r)=>{let[o,i]=ea(t,r,n),s=S("x",t.dataType,t.dims.length),a=s.type.value,u="value += x_val;",d="";o.countIncludePad?d+=`value /= ${a}(uniforms.kernelSize);`:d+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[c,l,p,f,m]=ta(i,o);c.push(...E(t.dims,i));let h=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(v.size(i)/64)},programUniforms:c}),getShaderSource:y=>na(y,s,t.dims.length,i.length,o,u,d,0,l,p,f,m)}},sa=e=>{let t=e.count_include_pad!==0,n=oa(e);if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...n,cacheKey:""};return{...r,cacheKey:zl(r)}},aa=(e,t)=>{tn(e.inputs),e.compute(ia("AveragePool",e.inputs[0],!1,t))},ua={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},da=e=>{let t=e.format;return{format:t,...ua,cacheKey:t}},la=(e,t)=>{tn(e.inputs),e.compute(ia("GlobalAveragePool",e.inputs[0],!0,t))},ca=(e,t,n,r)=>{let[o,i]=ea(t,r,n),s=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[c,l,p,f,m]=ta(i,o);return c.push(...E(t.dims,i)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(v.size(i)/64)},programUniforms:c}),getShaderSource:h=>na(h,u,t.dims.length,i.length,o,s,a,t.dataType===10?-65504:-1e5,l,p,f,m)}},pa=(e,t)=>{tn(e.inputs),e.compute(ca("MaxPool",e.inputs[0],!1,t))},ma=e=>{let t=e.storage_order,n=e.dilations,r=oa(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:n,...r,cacheKey:""};return{...o,cacheKey:Ol(o)}},fa=e=>{let t=e.format;return{format:t,...ua,cacheKey:t}},ha=(e,t)=>{tn(e.inputs),e.compute(ca("GlobalMaxPool",e.inputs[0],!0,t))}});var Dl,Rl,ya,ba,wa=A(()=>{"use strict";R();N();ie();G();Dl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,i)=>i===t.axis||o===e[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Rl=(e,t)=>{let n=v.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,o=r===3,i=e[0].dims,s=e[1].dataType,a=v.size(i),u=r===3||r===2,d=u?[Math.ceil(v.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,l=e.length>2?e[2]:void 0,p=l?u?[Math.ceil(v.size(l.dims)/4)]:l.dims:void 0,f=c.length===0||c.length===1&&c[0]===1,m=f===!1&&c.length===1,h=ee(a),y=f&&(!u||h===4),w=y?h:1,g=y&&!u?h:1,b=S("input",u?12:r,d.length,g),$=S("scale",s,c.length),_=l?S("zero_point",u?12:r,p.length):void 0,x=C("output",s,i.length,w),I=[b,$];_&&I.push(_);let T=[d,c];l&&T.push(p);let P=[{type:12,data:a/w},{type:12,data:n},{type:12,data:t.blockSize},...E(...T,i)],z=D=>{let j=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:_?["rank","rank","rank"]:["rank","rank"]},getShaderSource:z,getRunData:()=>({outputs:[{dims:i,dataType:s}],dispatchGroup:{x:Math.ceil(a/w/64),y:1,z:1},programUniforms:P})}},ya=(e,t)=>{Dl(e.inputs,t),e.compute(Rl(e.inputs,t))},ba=e=>M({axis:e.axis,blockSize:e.blockSize})});var Ul,Ml,$a,_a=A(()=>{"use strict";Se();R();G();Ul=(e,t,n)=>{let r=e===t,o=e<t&&n<0,i=e>t&&n>0;if(r||o||i)throw new Error("Range these inputs' contents are invalid.")},Ml=(e,t,n,r)=>{let o=Math.abs(Math.ceil((t-e)/n)),i=[o],s=o,a=[{type:12,data:s},{type:r,data:e},{type:r,data:n},...E(i)],u=d=>{let c=C("output",r,i.length),l=c.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:l},{name:"delta",type:l}];return`
        ${d.registerUniforms(p).declareVariables(c)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${l}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:a})}},$a=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),Z.webgpu.validateInputContent&&Ul(t,n,r),e.compute(Ml(t,n,r,e.inputs[0].dataType),{inputs:[]})}});var Vl,Nl,Wl,Gl,Ll,Hl,ql,Fl,Kl,jl,Zl,va,Ql,Xl,Yl,Jl,ec,xa,Sa,Ia=A(()=>{"use strict";R();N();ie();G();Vl=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`:"",Ql=(e,t,n,r,o)=>{let[s,a,u,d]=n.length===2?[-1,0,1,-1]:[0,2,3,1],c=e.type.value;return`
    ...
    }`},Xl=(e,t,n,r,o,i,s,a,u,d)=>{let c=n.length===2,l=!0,[p,f]=c?[0,1]:l?[2,3]:[1,2],m=e.type.value,h=y=>{let w=y===p?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      ${(()=>{switch(t.mode){case"nearest":return`
              ...
              ${(()=>{if(s.length===2||s.length===4)return`${Ql(l,c,s,m,h)}`;if(s.length===3||s.length===5)return`${Yl(l,c,s,m,h)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(s.length===2||s.length===4)return`${Xl(l,c,s,u,d,a,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`},$=[{dims:a,dataType:e[0].dataType}];return n>1&&$.push({dims:c,dataType:1}),n>2&&$.push({dims:c,dataType:1}),n>3&&$.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${w};${f};${m};${h}`,inputDependencies:e.map((_,x)=>"type")},getShaderSource:b,getRunData:()=>({outputs:$,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:g})}},Aa=(e,t)=>{rc(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(oc(e.inputs,t,e.outputCount,!1),{outputs:r})}});var ic,nn,sc,Ea,ac,uc,Pa,za,Oa=A(()=>{"use strict";R();N();ie();G();ic=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},nn=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},sc=(e,t)=>{if(e.length>1){let n=nn(e,1),r=nn(e,2),o=nn(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),M({starts:n,ends:r,axes:o})}else return t},Ea=(e,t,n,r,o)=>{let i=e;return e<0&&(i+=n[r[t]]),o[t]<0?Math.max(0,Math.min(i,n[r[t]]-1)):Math.max(0,Math.min(i,n[r[t]]))},ac=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[c],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:h})}},Pa=(e,t)=>{ic(e.inputs,t);let n=sc(e.inputs,t);e.compute(uc(e.inputs,n),{inputs:[0]})},za=e=>{let t=e.starts,n=e.ends,r=e.axes;return M({starts:t,ends:n,axes:r})}});var dc,lc,Ba,Da,Ra=A(()=>{"use strict";R();N();ie();G();dc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},lc=(e,t)=>{let n=e.dims,r=v.size(n),o=64,i=t.axis;if(i<0&&(i=n.length+i),i<n.length-1)throw new Error("softmax only supports last axis for now.");let s=n[i],a=r/s,u=ee(s),d=s/u,c=(y,w)=>w===4?`max(max(${y}.x, ${y}.y), max(${y}.z, ${y}.w))`:w===2?`max(${y}.x, ${y}.y)`:w===3?`max(max(${y}.x, ${y}.y), ${y}.z)`:y,l=S("x",e.dataType,e.dims,u),p=C("result",e.dataType,e.dims,u),f=l.type.value,m=X(e.dataType)==="f32"?`var threadMax = ${f}(-3.402823e+38f);`:`var threadMax = ${f}(-65504.0h);`,h=y=>`
      ...
      }`;return{name:"Softmax",shaderCache:{hint:`${u}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:n,dataType:e.dataType}],dispatchGroup:{x:a},programUniforms:[{type:6,data:d}]}),getShaderSource:h}},Ba=(e,t)=>{dc(e.inputs),e.compute(lc(e.inputs[0],t))},Da=e=>M({axis:e.axis})});var cc,pc,mc,fc,hc,Ua,Ma,Va=A(()=>{"use strict";R();N();ie();G();cc=e=>{if(!e||e.length<1)throw new Error("too few inputs")},pc=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>n.push(Number(o))),r=n.length),M({numOutputs:r,axis:t.axis,splitSizes:n})},mc=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:f,getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:p})}},Ua=(e,t)=>{cc(e.inputs);let n=e.inputs.length===1?t:pc(e.inputs,t);e.compute(hc(e.inputs,n),{inputs:[0]})},Ma=e=>{let t=e.axis,n=e.splitSizes,r=e.numOutputs<0?n.length:e.numOutputs;if(r!==n.length)throw new Error("numOutputs and splitSizes lengh must be equal");return M({axis:t,numOutputs:r,splitSizes:n})}});var gc,yc,Na,Wa=A(()=>{"use strict";R();N();G();gc=(e,t,n,r,o)=>{let i=C("output_data",o,n.length,4),s=S("a_data",t[1].dataType,t[1].dims.length,4),a=S("b_data",t[2].dataType,t[2].dims.length,4),u=S("c_data",t[0].dataType,t[0].dims.length,4),d,c=(l,p,f)=>`select(${p}, ${l}, ${f})`;if(!r)d=i.setByOffset("global_idx",c(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let l=(p,f,m="")=>{let h=`a_data[index_a${f}][component_a${f}]`,y=`b_data[index_b${f}][component_b${f}]`,w=`bool(c_data[index_c${f}] & (0xffu << (component_c${f} * 8)))`;return`
