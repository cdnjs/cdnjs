...
`}var Zc,Yc,is,ss=x(()=>{"use strict";V();X();R();me();Zc=i=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${i}`}),Yc=(i,e,o,t)=>{let r=e.dims,n=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:e,type:0}}var At,wp,Ts,ws,vs,Is,_s,Ss,Os,As,Ps,Es,Ds,Ls,$s=x(()=>{"use strict";V();Xt();X();R();At=(i,e,o,t=e[0].type,r)=>{let n=i.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>wp(i,e,o,t)}},wp=(i,e,o,t=e[0].type)=>{let r=i.session.pack?2:0,n=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=i.session.pack;if(n){let f=ct.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let c=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,m=e[1].dims.length!==0?e[1].dims.length:1,y=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",g=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",T=D(i.session.backend.glContext.version),_=a?`
      ${o.body}
      void main() {
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:e[0].dims,type:t,textureType:r},shaderSource:l,hasMain:!0}},Ts=(i,e)=>[i.run(At(i,e,up()),e)],ws=(i,e)=>[i.run(At(i,e,mp(),"bool"),e)],vs=(i,e)=>[i.run(At(i,e,lp()),e)],Is=(i,e)=>[i.run(At(i,e,pp(),"bool"),e)],_s=(i,e)=>[i.run(At(i,e,dp(),"bool"),e)],Ss=(i,e)=>[i.run(At(i,e,hp(),"bool"),e)],Os=(i,e)=>[i.run(At(i,e,fp()),e)],As=(i,e)=>[i.run(At(i,e,bp(),"bool"),e)],Ps=(i,e)=>[i.run(At(i,e,gp()),e)],Es=(i,e)=>[i.run(At(i,e,xp()),e)],Ds=(i,e)=>[i.run(At(i,e,cp()),e)],Ls=(i,e)=>[i.run(At(i,e,yp(),"bool"),e)]});var ks,Bs,Ip,Fs=x(()=>{"use strict";V();ks=(i,e,o)=>(Ip(e),[i.cast(e[0],o)]),Bs=i=>st.tensorDataTypeFromProto(i.attributes.getInt("to")),Ip=i=>{if(!i||i.length!==1)throw new Error("Cast requires 1 input.");if(i[0].type==="string")throw new Error("Invalid input type.")}});var _p,Sp,Ns,Mr,Cs=x(()=>{"use strict";X();R();Mt();me();_p=(i,e)=>({name:"Concat (packed)",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(2),cacheHint:e}),Sp=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let B=1;B<o.length;B++){let Q=o[B].dims.slice();for(let lt=0;lt<r.length;lt++)if(lt===t)n[t]+=Q[lt];else if(r[lt]!==Q[lt])throw new Error("non concat dimensions must match")}let s=n.length,a=Le("coords",s),u=pt(s),l=Ut(),f=o.map(B=>B.dims),c=Rt(s),d=new Array(f.length-1);d[0]=f[0][t];for(let B=1;B<d.length;B++)d[B]=d[B-1]+f[B][t];let m=c[t],y=c.slice(-2),g=c.join(),T=`if (${m} < ${d[0]}) {
        ...
        `;return{...e,output:{dims:n,type:o[0].type,textureType:2},shaderSource:L,hasMain:!0}},Ns=(i,e,o)=>{let t=_p(e.length,o.cacheKey);return{...t,get:()=>Sp(i,t,e,o.axis)}},Mr=(i,e,o)=>{let t=i.indexOf(e);return i.map((n,s)=>s===t?`${n} - ${o}`:n).join()}});var Rs,Op,Ap,Pp,Gs,Ep,Dp,Lp,Ms,$p,Us=x(()=>{"use strict";at();R();Cs();Rs=(i,e,o)=>($p(e),i.session.pack&&e[0].dims.length>1?[i.run(Ns(i,e,o),e)]:[i.run(Pp(i,e,o),e)]),Op=(i,e)=>({name:"Concat",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(0),cacheHint:e}),Ap=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let m=1;m<o.length;m++){let y=o[m].dims.slice();for(let g=0;g<r.length;g++)if(g===t)n[t]+=y[g];else if(r[g]!==y[g])throw new Error("non concat dimensions must match")}let s=n.length,a=new Array(o.length),u=0;for(let m=0;m<a.length;++m)u+=o[m].dims[t],a[m]=u;let l="";o.length<5?l=Gs(a):l=Ep(a);let f=Dp(o.length,s),c=Lp(a),d=`
        ${f}
        ${c}
        ${l}
...
`)},Ms=i=>F({axis:i.attributes.getInt("axis")}),$p=i=>{if(!i||i.length<1)throw new Error("too few inputs");let e=i[0].type,o=i[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of i){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function kp(){return Pt("abs")}function Bp(){return Pt("acos")}function Fp(){return Pt("asin")}function Np(){return Pt("atan")}function Cp(){return Pt("ceil")}function Rp(){return Pt("cos")}function Gp(i){let e="elu";return{body:`
  ...
  `,name:e,type:0}}function Mp(){return Pt("exp")}function Up(){return Pt("floor")}function uo(i,e){let o="clip";return{body:`
  ...
  `,name:i,type:0}}var Zp,Z,Vs,zs,Ws,Hs,co,qs,js,Yp,Xs,Ks,Js,Zs,Ys,Qs,po,tu,eu,ru,nu,ou,iu,au,su,uu,lu,fu,ho=x(()=>{"use strict";at();V();Xt();X();R();Zp=(i,e,o,t)=>{let r=i.session.pack?2:0,n=D(i.session.backend.glContext.version);return{...e,output:{dims:o.dims,type:o.type,textureType:r},shaderSource:`
     ${t.body}
     void main() {
     ...
     `,hasMain:!0}},Z=(i,e,o,t)=>{let r=i.session.pack?2:0,n={name:o.name,inputTypes:[r],inputNames:["A"],cacheHint:t};return{...n,get:()=>Zp(i,n,e,o)}},Vs=(i,e)=>[i.run(Z(i,e[0],kp()),e)],zs=(i,e)=>[i.run(Z(i,e[0],Bp()),e)],Ws=(i,e)=>[i.run(Z(i,e[0],Fp()),e)],Hs=(i,e)=>[i.run(Z(i,e[0],Np()),e)],co=(i,e,o)=>[i.run(Z(i,e[0],uo(o.min,o.max),o.cacheKey),e)],qs=i=>F({min:i.attributes.getFloat("min",pe),max:i.attributes.getFloat("max",de)}),js=(i,e)=>{let o=Yp(i,e);return co(i,[e[0]],o)},Yp=(i,e)=>{if(e.length>=3&&(!i.session.isInitializer(e[1].dataId)||!i.session.isInitializer(e[2].dataId)))throw new Error("dynamic clip attributes are not allowed");let o=e.length>=3?e[1].numberData[0]:pe,t=e.length>=3?e[2].numberData[0]:de;return F({min:o,max:t})},Xs=(i,e)=>[i.run(Z(i,e[0],Cp()),e)],Ks=(i,e)=>[i.run(Z(i,e[0],Rp()),e)],Js=(i,e,o)=>[i.run(Z(i,e[0],Gp(o.alpha),o.cacheKey),e)],Zs=i=>F({alpha:i.attributes.getFloat("alpha",1)}),Ys=(i,e)=>[i.run(Z(i,e[0],Mp()),e)],Qs=(i,e)=>[i.run(Z(i,e[0],Up()),e)],po=(i,e)=>[i.run(Z(i,e[0],Vp()),e)],tu=(i,e,o)=>[i.run(Z(i,e[0],zp(o.alpha),o.cacheKey),e)],eu=i=>F({alpha:i.attributes.getFloat("alpha",.01)}),ru=(i,e)=>[i.run(Z(i,e[0],Wp()),e)],nu=(i,e)=>[i.run(Z(i,e[0],Hp()),e)],ou=(i,e)=>[i.run(Z(i,e[0],qp()),e)],iu=(i,e)=>[i.run(Z(i,e[0],lo()),e)],au=(i,e)=>[i.run(Z(i,e[0],fo()),e)],su=(i,e)=>[i.run(Z(i,e[0],jp()),e)],uu=(i,e)=>[i.run(Z(i,e[0],Xp()),e)],lu=(i,e)=>[i.run(Z(i,e[0],Kp()),e)],fu=(i,e)=>[i.run(Z(i,e[0],Jp()),e)]});function Vt(i){let e;switch(i.activation){case"Relu":e=lo();break;case"Sigmoid":e=fo();break;case"Clip":e=uo(i.clipMin,i.clipMax);break;default:return{activationFunction:"",applyActivation:""}}let o=e.name,t=e.body,r=`value = ${o}_(value);`;return{activationFunction:t,applyActivation:r}}var $e,be=x(()=>{"use strict";V();ho();$e=i=>{let e=i.getString("activation","");if(e==="Clip"){let[o,t]=i.getFloats("activation_params",[pe,de]);return{activation:e,clipMax:t,clipMin:o,activationCacheKey:`${e}:${o},${t}`}}return{activation:e,activationCacheKey:e}}});var td,ed,cu,pu=x(()=>{"use strict";vt();X();R();Ur();be();td=(i,e)=>({name:"GroupedConv",inputNames:i?["X","W","Bias"]:["X","W"],inputTypes:i?[0,0,0]:[0,0],cacheHint:e}),ed=(i,e,o,t)=>{let n=e.length>2?"value += getBias(output_channel);":"",s=e[0].dims.slice(),a=e[1].dims.slice(),u=a[0]/t.group;z.verbose("GroupedConv",`autpPad:${t.autoPad}, dilations:${t.dilations}, group:${t.group}, kernelShape:${t.kernelShape}, pads:${t.pads}, strides:${t.strides}`);let l=ke(s,a,t.dilations,t.pads,t.strides),f=D(i.session.backend.glContext.version),{activationFunction:c,applyActivation:d}=Vt(t),m=`
...
vec4 getBAtOutCoordsMatmul(int i) {
  ...
  return outputValue;
}`}function fd(i,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${i[t]}, `;return o+=`rc.${i[e-2]}, i*2`,o}function cd(i,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${i[t]}, `;return o+=`i*2, rc.${i[e-1]}`,o}var sd,ud,zr,yo=x(()=>{"use strict";V();X();R();Mt();be();Vr();sd=(i,e)=>({name:"MatMul (packed)",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[2,2,2]:[2,2],cacheHint:e}),ud=(i,e,o,t)=>{let r=o.length>2,n=r?"value += getBiasForMatmul();":"",s=o[0].dims,a=o[1].dims,u=ct.calcShape(s,a,!0),l=!A.areEqual(o[0].dims,o[1].dims);if(!u)throw new Error("Can't use matmul on the given tensors");let f=s[s.length-1],c=Math.ceil(f/2),d=s.length,m=a.length,y=D(i.session.backend.glContext.version),g=pt(u.length),T=u.length,_=Rt(),{activationFunction:w,applyActivation:v}=Vt(t),L=r?`${bo(g,_,o[2].dims,u,!0)}`:"",B=l?`${ld(g,_,o,u)}`:"",Q=l?"getAAtOutCoordsMatmul(i)":`getA(${fd(_,d)})`,lt=l?"getBAtOutCoordsMatmul(i)":`getB(${cd(_,m)})`,Wt=l?"":`${g} rc =
      ...
      `,Tt=`
        ...
        `;return{...e,output:{dims:l,type:o.type,textureType:4},shaderSource:f}},xu=(i,e,o,t,r)=>{let n=pd(r.cacheKey);return{...n,get:()=>dd(i,n,e,o,t,r)}},go=(i,e,o,t=4)=>[o[0],o[2],o[3],Math.ceil(i[1]*e[2]*e[3]/t)]});var hd,md,Tu,wu=x(()=>{"use strict";V();X();R();be();xo();hd=(i,e)=>({name:"ConvDotProduct",inputNames:i?["Im2Col","K","B"]:["Im2Col","K"],inputTypes:i?[0,4,0]:[0,4],cacheKey:e.activationCacheKey}),md=(i,e,o,t,r)=>{let n=o[0].dims,s=o[1].dims,a=[s[0],Math.ceil(n[1]*s[2]*s[3]/4)],u=go(n,s,t),[l,f]=i.calculateTextureWidthAndHeight(a,4),c=A.computeStrides(u),[d,m]=i.calculateTextureWidthAndHeight(u,4),y=t.length,g=o.length<3?"0.0":"_B(b)",T=Math.ceil(n[1]*s[2]*s[3]/4),{activationFunction:_,applyActivation:w}=Vt(r),v=D(i.session.backend.glContext.version),L=`
${_}
...
`)},Bd=i=>{if(!i||i.length!==1)throw new Error("Transpose requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("input should be float tensor")}});var Pu,Eu,Fd,Du=x(()=>{"use strict";Wr();Pu=(i,e,o)=>{Fd(e);let t=o.blocksize,r=t*t,n=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[e[0].dims[0],t,t,e[0].dims[1]/r,e[0].dims[2],e[0].dims[3]]:[e[0].dims[0],e[0].dims[1]/r,t,t,e[0].dims[2],e[0].dims[3]],a=i.reshapeUnpacked(e[0],s),u={perm:n,cacheKey:`${n}`},[l]=ye(i,[a],u),f=[e[0].dims[0],e[0].dims[1]/r,e[0].dims[2]*t,e[0].dims[3]*t];return[i.reshapeUnpacked(l,f)]},Eu=i=>{let e=i.attributes.getInt("blocksize");if(e<1)throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);let o=i.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:e}},Fd=i=>{if(i.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${i.length}`);if(i[0].type==="string"||i[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var Lu,$u,Nd,ku=x(()=>{"use strict";V();Lu=(i,e,o)=>{Nd(e,o);let t=A.flattenShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},$u=i=>i.attributes.getInt("axis",1),Nd=(i,e)=>{if(!i||i.length!==1)throw new Error("Flatten requires 1 input.");let o=i[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(e<-o||e>o)throw new Error("Invalid axis");if(i[0].type==="string")throw new Error("string tensor is not supported.")}});var ee,rr=x(()=>{"use strict";ee=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var Bu,Fu,Cd,Rd,Gd,Md,Nu=x(()=>{"use strict";at();rr();V();R();Bu=(i,e,o)=>(Md(e,o.axis),[i.run(Gd(i,e,o),e)]),Fu=i=>F({axis:i.attributes.getInt("axis",0)}),Cd={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Rd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=o[1].dims.slice(),s=new Array(r.length+n.length-1);t=A.normalizeAxis(t,r.length);let a=[];for(let d=0;d<s.length;d++)d<t?(s[d]=r[d],a.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<t+n.length?(s[d]=n[d-t],a.push(`indexDataIdx[${d-t}] = outputIdx[${d}];`)):(s[d]=r[d-n.length+1],a.push(`inputIdx[${d-n.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=r.length,f=n.length||1,c=`
      ...
      float process(int indices[${f}]) {
          ...
          ${m}
          return value;
      }`;return{...i,output:{dims:a,type:e[0].type,textureType:0},variables:[{name:"alpha",type:"float",data:o.alpha},{name:"beta",type:"float",data:o.beta}],shaderSource:y}},zd=(i,e)=>{if(!i)throw new Error("Input is missing");if(e.isOptionalC&&(i.length<2||i.length>3))throw new Error("Invaid input shape.");if(!e.isOptionalC&&i.length!==3)throw new Error("Gemm requires 3 inputs");if(i.length===3&&i[2].dims.length!==1&&i[2].dims.length!==2)throw new Error("Invalid input shape of C");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64"||i.length===3&&i[2].type!=="float32"&&i[2].type!=="float64")throw new Error("Invalid input type.");if(i[0].type!==i[1].type||i.length===3&&i[0].type!==i[2].type)throw new Error("Input types are mismatched")}});var Uu,Vu,Wd,Hd,qd,jd,Xd,zu=x(()=>{"use strict";at();R();Uu=(i,e,o)=>(Xd(e),[i.run(qd(i,e,o),e)]),Vu=i=>{let e=i.attributes.getFloat("scale"),o=i.attributes.getFloats("bias");return F({scale:e,bias:o})},Wd={name:"ImageScaler",inputNames:["X"],inputTypes:[0]},Hd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=r.length,a=`
      ${jd(t.bias.length)}
      float process(int indices[${n}]) {
...
`)},Xd=i=>{if(!i||i.length!==1)throw new Error("ImageScaler requires 1 input.");if(i[0].dims.length!==4)throw new Error("Invalid input shape.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")}});var Hu,qu,Wu,Kd,Jd,Zd,Yd,Qd,th,ju=x(()=>{"use strict";X();R();Hu=(i,e,o)=>{th(e);let t=i.run(Jd(e[0]),e);return[i.run(Qd(i,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},qu=i=>i.attributes.getFloat("epsilon",1e-5),Wu={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},Kd=(i,e)=>{let o=e.dims.slice(),t=o[1],r=o[2]*o[3],n=[o[0],t],s=`
  ...
  void offsetToIndices(int offset, int[${i}] strides, out int[${i}] indices) {
    ...
    indices[${i} - 1] = offset;
  }`});var ge,re,mh,bh,ml,bl,yl,gl,xl,Tl,wl,vl=x(()=>{"use strict";at();rr();V();R();ge=(i,e,o,t,r)=>{bh(e);let n={name:t,inputNames:["A"],inputTypes:[0]};return[i.run({...n,cacheHint:o.cacheKey,get:()=>mh(i,e,o,t,r,n)},e)]},re=i=>{let e=i.attributes.getInts("axes",[]),o=i.attributes.getInt("keepdims",1)===1;return F({axes:e,keepDims:o})},mh=(i,e,o,t,r,n)=>{let s=[],a=e[0].dims.length||1,u=[],l=A.normalizeAxes(o.axes,e[0].dims.length),f=r(e,l),c=f[1];for(let y=0;y<e[0].dims.length;y++)l.indexOf(y)>=0||l.length===0?(o.keepDims&&s.push(1),c=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),xl=(i,e,o)=>ge(i,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),Tl=(i,e,o)=>ge(i,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),wl=(i,e,o)=>ge(i,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var Il,_l=x(()=>{"use strict";V();Il=(i,e)=>{let o=A.calculateReshapedDims(e[0].dims,e[1].integerData);return i.session.pack?[i.reshapePacked(e[0],o)]:[i.reshapeUnpacked(e[0],o)]}});var Sl,_o,Ol,Al,nr,yh,So,jr,Oo=x(()=>{"use strict";at();X();R();Sl={name:"Upsample",inputNames:["X"],inputTypes:[0]},_o=(i,e,o)=>(So(e,o),[i.run({...Sl,cacheHint:o.cacheKey,get:()=>yh(i,e,o)},e)]),Ol=i=>nr(i,7),Al=i=>nr(i,9),nr=(i,e)=>{let o=e>=10,t=i.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let r=[];e<9&&(r=i.attributes.getFloats("scales"),jr(r,t,o));let n=i.attributes.getFloat("extrapolation_value",0),s=e>10?i.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?i.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=i.attributes.getFloat("cubic_coeff_a",-.75),c=i.attributes.getInt("exclude_outside",0)!==0;if(c&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",m=0,y=0,g=0;return e>10?i.inputs.length>2?(m=1,y=2,g=3):(y=1,g=2):e===9&&(y=1),F({opset:e,isResize:o,mode:t,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:f,excludeOutside:c,useNearest2xOptimization:d,roiInputIdx:m,scalesInputIdx:y,sizesInputIdx:g})},yh=(i,e,o)=>{let t=D(i.session.backend.glContext.version),[r,n]=i.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((g,T)=>Math.floor(g*o.scales[T])),[a,u]=i.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),c=new Array(l),d=`
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
                ...
                `;break;default:throw new Error(`resize (packed) does not support coordinateTransformMode:                                 '${o.coordinateTransformMode}'`)}let T=pt(a),_=Ut(),w=`
...
`)}
    ...
    `;return{...o,output:{dims:r,type:e[0].type,textureType:0},shaderSource:a}},Ch=i=>{if(!i||i.length!==2)throw new Error("Tile requires 2 input.");if(i[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(i[1].dims[0]!==i[0].dims.length)throw new Error("Invalid input shape.");if(ee.indexOf(i[0].type)===-1)throw new Error("Invalid input type.");if(i[1].type!=="int32"&&i[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Lo,af,sf,Rh,Gh,uf=x(()=>{"use strict";V();Lo=(i,e,o)=>{Rh(e);let t=A.unsqueezeShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},af=(i,e)=>(Gh(e),Lo(i,[e[0]],Array.from(e[1].integerData))),sf=i=>i.attributes.getInts("axes"),Rh=i=>{if(!i||i.length!==1)throw new Error("Unsqueeze requires 1 input.");if(i[0].type==="string")throw new Error("invalid input tensor types.")},Gh=i=>{if(!i||i.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(i[1].type!=="int32")throw new Error("Invalid input type.")}});var lf,ff=x(()=>{"use strict";xs();$s();Fs();Us();Ur();_u();Du();ku();Nu();Mu();zu();ju();Zu();Vr();el();hl();vl();_l();Dl();$l();Cl();jl();Zl();tf();rf();of();Wr();ho();uf();Oo();lf=[["Abs","","6+",Vs],["Acos","","7+",zs],["Add","","7+",Ts],["And","","7+",ws],["Asin","","7+",Ws],["Atan","","7+",Hs],["AveragePool","","7+",nl,ol],["BatchNormalization","","7+",ys,gs],["Cast","","6+",ks,Bs],["Ceil","","6+",Xs],["Clip","","6-10",co,qs],["Clip","","11+",js],["Concat","","4+",Rs,Ms],["Conv","","1+",To,wo],["ConvTranspose","","1+",vu,Iu],["Cos","","7+",Ks],["Div","","7+",vs],["Dropout","","7+",po],["DepthToSpace","","1+",Pu,Eu],["Equal","","7+",Is],["Elu","","6+",Js,Zs],["Exp","","6+",Ys],["Flatten","","1+",Lu,$u],["Floor","","6+",Qs],["FusedConv","com.microsoft","1+",To,wo],["Gather","","1+",Bu,Fu],["Gemm","","7-10",vo,Ru],["Gemm","","11+",vo,Gu],["GlobalAveragePool","","1+",al,sl],["GlobalMaxPool","","1+",pl],["Greater","","7+",_s],["Identity","","1+",po],["ImageScaler","","1+",Uu,Vu],["InstanceNormalization","","6+",Hu,qu],["LeakyRelu","","6+",tu,eu],["Less","","7+",Ss],["LRN","","1+",Xu,Ku],["Log","","6+",ru],["MatMul","","1+",mu,bu],["MaxPool","","1+",ul,ll],["Mul","","7+",Os],["Neg","","6+",nu],["Not","","1+",ou],["Or","","7+",As],["Pad","","2-10",Io,Yu],["Pad","","11+",Qu,tl],["Pow","","7+",Ps],["PRelu","","7+",Es],["ReduceLogSum","","1+",Tl,re],["ReduceMax","","1+",yl,re],["ReduceMean","","1+",bl,re],["ReduceMin","","1+",gl,re],["ReduceProd","","1+",xl,re],["ReduceSum","","1-12",ml,re],["ReduceSumSquare","","1+",wl,re],["Relu","","6+",iu],["Reshape","","5+",Il],["Resize","","10",Po,Pl],["Resize","","11+",Po,El],["Shape","","1+",Ll],["Sigmoid","","6+",au],["Sin","","7+",su],["Slice","","10+",Nl],["Slice","","1-9",kl,Bl],["Softmax","","1-12",Ul,Vl],["Softmax","","13+",Wl,zl],["Split","","2-12",Kl,Jl],["Sqrt","","6+",uu],["Squeeze","","1-12",Do,Ql],["Squeeze","","13+",Yl],["Sub","","7+",Ds],["Sum","","6+",ef],["Tan","","7+",lu],["Tanh","","6+",fu],["Tile","","6+",nf],["Transpose","","1+",ye,Ou],["Upsample","","7-8",_o,Ol],["Upsample","","9",_o,Al],["Unsqueeze","","1-12",Lo,sf],["Unsqueeze","","13+",af],["Xor","","7+",Ls]]});function pf(i){let e={},o;for(;(o=cf.exec(i))!==null;){let t=o[3].split(",").map(r=>{let n=r.trim().split(" ");return n&&n.length===2?{type:n[0],name:n[1]}:null}).filter(r=>r!==null);e[o[2]]={params:t,body:o[4]}}for(let t in e){let r=Mh.replace("__FUNC__",t),n=new RegExp(r,"gm");for(;(o=n.exec(i))!==null;){let s=o[1],a=o[2],u=o[3].split(","),l=s?`${s} ${a};`:"",f=e[t].body,c="";e[t].params.forEach((m,y)=>{m&&(c+=`${m.type} ${m.name} = ${u[y]};
`)}),f=`${c}
 ${f}`,f=f.replace("return",`${a} = `);let d=`
      ...
      `;i=i.replace(o[0],d)}}return i=i.replace(cf,""),i}var cf,Mh,df=x(()=>{"use strict";cf=/@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm,Mh="(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;"});function Be(i,e){let o=[],t=[],r=e!=null&&Array.isArray(e)&&e.length===0,n=e==null||r?null:Uh(e,i).sort(),s=0;for(let a=0;a<i.length;++a){if(n!=null){if(n[s]===a&&i[a]!==1)throw new Error(`Can't squeeze axis ${a} since its dim '${i[a]}' is not 1`);(n[s]==null||n[s]>a)&&i[a]===1&&(o.push(i[a]),t.push(a)),n[s]<=a&&s++}i[a]!==1&&(o.push(i[a]),t.push(a))}return{newShape:o,keptDims:t}}function Uh(i,e){let o=e.length;return i=i==null?e.map((t,r)=>r):[].concat(i),Pe(i.every(t=>t>=-o&&t<o),()=>`All values in axis param must be in range [-${o}, ${o}) but got axis ${i}`),Pe(i.every(Vh),()=>`All values in axis param must be integers but got axis ${i}`),i.map(t=>t<0?o+t:t)}function Vh(i){return i%1===0}function zh(i){if(i.length===0)return 1;let e=i[0];for(let o=1;o<i.length;o++)e*=i[o];return e}function hf(i){let e=Math.ceil(Math.sqrt(i));return[e,Math.ceil(i/e)]}var Xr,$o=x(()=>{"use strict";vt();V();Xr=class{constructor(e){this.maxTextureSize=e}computeTextureWH(e,o){let t=this.computeTexture(e,o);return o&&o.isPacked&&(t[0]/=2,t[1]/=2),o&&o.reverseWH?[t[1],t[0]]:t}computeTexture(e,o){let t=o&&o.isPacked;if(e.length===0)return t?[2,2]:[1,1];let r=this.maxTextureSize;if(o&&o.breakAxis!==void 0){let a=o.breakAxis>=e.length?1:e.slice(o.breakAxis).reduce((l,f)=>l*f),u=o.breakAxis<=0?1:e.slice(0,o.breakAxis).reduce((l,f)=>l*f);if(a>r||u>r)z.verbose("TextureLayout",`Given width/height preferences were unattainable: shape:${e}, breakAxis:${o.breakAxis}`);else return[a,u]}let n=e.slice(0);t&&(r=r*2,n=n.map((a,u)=>u>=n.length-2?n[u]%2===0?n[u]:n[u]+1:n[u]),n.length===1&&(n=[2,n[0]])),n.length!==2&&(n=Be(n).newShape);let s=zh(n);return n.length<=1&&s<=r?[1,s]:n.length===2&&n[0]<=r&&n[1]<=r?n:n.length===3&&n[0]*n[1]<=r&&n[2]<=r?[n[0]*n[1],n[2]]:n.length===3&&n[0]<=r&&n[1]*n[2]<=r?[n[0],n[1]*n[2]]:n.length===4&&n[0]*n[1]*n[2]<=r&&n[3]<=r?[n[0]*n[1]*n[2],n[3]]:n.length===4&&n[0]<=r&&n[1]*n[2]*n[3]<=r?[n[0],n[1]*n[2]*n[3]]:t?hf(s/4).map(a=>a*2):hf(s)}}});var Kr,mf=x(()=>{"use strict";V();Xt();X();$o();Mt();Kr=class extends Ot{constructor(o){super(o)}getFunctions(){return{...this.offsetToCoords(),...this.coordsToOffset(),...this.toVec(),...this.valueFrom(),...this.getCommonUtilFuncs(),...this.getInputsSamplingSnippets(),...this.getOutputSamplingSnippet()}}getCustomTypes(){return{}}offsetToCoords(){let o="offsetToCoords";return{offsetToCoords:new O(`
