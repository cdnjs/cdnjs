...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},po=(e,t)=>new Rr(e,t)});var Ku,mo,ju,Zu,Xu,ce,fo,ho,Oe=A(()=>{"use strict";V();H();ie();F();Ku=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},mo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,ju=(e,t)=>x.sortBasedOnPerm(e,mo(e.length,t)),Zu=(e,t,r,n)=>{let o=`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)o+=r.indicesSet("a",e[s],`i[${s}]`);return o+="return a;}"},Xu=(e,t)=>{let r=[],n=[];for(let o=0;o<e.length;++o)e[o]!==1&&r.push(e[o]),e[t[o]]!==1&&n.push(t[o]);return{newShape:r,newPerm:n}},ce=(e,t)=>{let r=e.dataType,n=e.dims.length,o=mo(n,t),s=ju(e.dims,o),{newShape:i,newPerm:a}=Xu(e.dims,o),u=x.areEqual(a,[2,3,1]),d=x.areEqual(a,[3,1,2]),l=i.length===2&&a[0]>a[1]||u||d,c=l?i:e.dims,p=s;l&&(c=u?[i[0],i[1]*i[2]]:d?[i[0]*i[1],i[2]]:i,p=[c[1],c[0]]);let h=S("a",r,c.length),m=C("output",r,p.length),f=16,b;return l?b=y=>`
  ...
  ${y.mainStart()}
    ...
    ${m.setByOffset("global_idx",h.getByIndices("aIndices"))}
       ...
       `,m=f=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},ke=(e,t,r,n)=>{let o=e.inputs.length===1?r:Wr(e.inputs,r),s=o.axes;s.length===0&&!o.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((h,m)=>m));let i=x.normalizeAxes(s,e.inputs[0].dims.length),a=i,u=e.inputs[0],d=id(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ce(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=td(a.length,u.dims.length));let[l,c]=rd(u.dims,a),p=l;o.keepDims&&(p=nd(l,i)),e.compute(sd(t,o.cacheKey,[u],n,e.inputs[0].dataType,p,c),{inputs:[u]})},go=(e,t)=>{ke(e,"ReduceMeanShared",t,"mean")},yo=(e,t)=>{ke(e,"ReduceL1Shared",t,"l1")},bo=(e,t)=>{ke(e,"ReduceL2Shared",t,"l2")},wo=(e,t)=>{ke(e,"ReduceLogSumExpShared",t,"logSumExp")},_o=(e,t)=>{ke(e,"ReduceMaxShared",t,"max")},$o=(e,t)=>{ke(e,"ReduceMinShared",t,"min")},vo=(e,t)=>{ke(e,"ReduceProdShared",t,"prod")},xo=(e,t)=>{ke(e,"ReduceSumShared",t,"sum")},So=(e,t)=>{ke(e,"ReduceSumSquareShared",t,"sumSquare")},Io=(e,t)=>{ke(e,"ReduceLogSumShared",t,"logSum")}});var Ee,ad,Zt,Wr,Pe,ud,dd,ld,cd,pd,md,fd,hd,gd,yd,ze,Co,Ao,ko,Eo,Po,zo,Bo,Oo,Do,Mo,jt=A(()=>{"use strict";V();H();ie();F();To();Ee=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},ad=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Zt=(e,t,r,n,o,s,i=!1,a=!1)=>{let u=[],d=r[0].dims,l=d.length,c=x.normalizeAxes(o,l),p=!a&&c.length===0;d.forEach((b,y)=>{p||c.indexOf(y)>=0?i&&u.push(1):u.push(b)});let h=u.length,m=x.size(u);return{name:e,shaderCache:t,getShaderSource:b=>{let y=[],g=S("_A",r[0].dataType,l),w=C("output",s,h),_=n(g,w,c),$=_[2];for(let v=0,I=0;v<l;v++)p||c.indexOf(v)>=0?(i&&I++,$=`for(var j${v}: u32 = 0; j${v} < ${d[v]}; j${v}++) {
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${i}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...E(s)]:[{type:12,data:u}]})}},Id=e=>U(e),Lo=(e,t)=>{let{inputs:r,outputCount:n}=e,o=Id({...t,outputCount:n});if(J.webgpu.validateInputContent&&xd(r,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Sd(r,o))}});var Td,Cd,Ho,qo=A(()=>{"use strict";H();F();Td=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Cd=e=>{let t=e[0].dims,r=e[0].dims[2],n=x.size(t)/4,o=e[0].dataType,s=S("input",o,t,4),i=S("bias",o,[r],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:l=>`
  ...
  }`}},Ho=e=>{Td(e.inputs),e.compute(Cd(e.inputs))}});var Ad,Y,Fo,Ko,jo,Zo,Xo,Qo,Yo,Jo,ei,kd,ti,ri,ni,oi,lt,ii,Qt,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,wi,_i,$i,vi,xi,Hr,qr,Si,Ii,Ti,Ed,Pd,Ci,Yt=A(()=>{"use strict";V();H();ie();F();Ad=(e,t,r,n,o,s,i)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let d=S("inputData",r,[a],4),l=C("outputData",n,[a],4),c=[{name:"vec_size",type:"u32"}];return i&&c.push(...i),`
  ...
  }`},Y=(e,t,r,n,o,s=e.dataType,i,a)=>{let u=[{type:12,data:Math.ceil(x.size(e.dims)/4)}];return i&&u.push(...i),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:d=>Ad(d,x.size(e.dims),e.dataType,s,r,n,a),getRunData:d=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(x.size(d[0].dims)/64/4)},programUniforms:u})}},Fo=e=>{e.compute(Y(e.inputs[0],"Abs","abs"))},Ko=e=>{e.compute(Y(e.inputs[0],"Acos","acos"))},jo=e=>{e.compute(Y(e.inputs[0],"Acosh","acosh"))},Zo=e=>{e.compute(Y(e.inputs[0],"Asin","asin"))},Xo=e=>{e.compute(Y(e.inputs[0],"Asinh","asinh"))},Qo=e=>{e.compute(Y(e.inputs[0],"Atan","atan"))},Yo=e=>{e.compute(Y(e.inputs[0],"Atanh","atanh"))},Jo=e=>U(e),ei=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(Y(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},kd=e=>{let t,r,n=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=n?e[1].getFloat32Array()[0]:-34028234663852886e22,r=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=n?e[1].getUint16Array()[0]:64511,r=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return U({min:t,max:r})},ti=(e,t)=>{let r=t||kd(e.inputs),n=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:n},{name:"max",type:n}]),{inputs:[0]})},ri=e=>{e.compute(Y(e.inputs[0],"Ceil","ceil"))},ni=e=>{e.compute(Y(e.inputs[0],"Cos","cos"))},oi=e=>{e.compute(Y(e.inputs[0],"Cosh","cosh"))},lt=e=>U(e),ii=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,si=e=>{let t=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Qt(t)))},ai=e=>{e.compute(Y(e.inputs[0],"Exp","exp"))},ui=e=>{e.compute(Y(e.inputs[0],"Floor","floor"))},di=e=>{let t=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Qt(t)))},li=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},ci=e=>{e.compute(Y(e.inputs[0],"Not",t=>`!${t}`))},pi=e=>{e.compute(Y(e.inputs[0],"Neg",t=>`-${t}`))},mi=e=>{e.compute(Y(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},fi=e=>{let t=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},hi=e=>{e.compute(Y(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},gi=e=>U(e),yi=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},bi=e=>{e.compute(Y(e.inputs[0],"Sin","sin"))},wi=e=>{e.compute(Y(e.inputs[0],"Sinh","sinh"))},_i=e=>{e.compute(Y(e.inputs[0],"Sqrt","sqrt"))},$i=e=>{e.compute(Y(e.inputs[0],"Tan","tan"))},vi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,xi=e=>{e.compute(Y(e.inputs[0],"Tanh",vi))},Hr=(e="f32")=>`
...
`,qr=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Si=e=>{let t=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"FastGelu",qr,Hr(t),void 0,e.inputs[0].dataType))},Ii=(e,t)=>{let r=le(e.inputs[0].dataType);return e.compute(Y(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Ti=e=>{e.compute(Y(e.inputs[0],"Log","log"))},Ed=(e,t)=>`
...
`,Pd=e=>`quick_gelu_impl(${e})`,Ci=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(Y(e.inputs[0],"QuickGelu",Pd,Ed(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var zd,Bd,ki,Ei=A(()=>{"use strict";H();F();Yt();zd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Bd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=S("input",e[0].dataType,e[0].dims,4),n=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),s=x.size(t)/4,i=Q(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${y}
      }`},Dd=(e,t,r,n,o,s,i=r.dataType)=>{let a=r.dims.map(f=>Number(f)??1),u=n.dims.map(f=>Number(f)??1),d=!x.areEqual(a,u),l=a,c=x.size(a),p=!1,h=!1,m=[d];if(d){let f=Ae.calcShape(a,u,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");l=f.slice(),c=x.size(l);let b=x.size(a)===1,y=x.size(u)===1,g=a.length>0&&a[a.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;m.push(b),m.push(y),m.push(g),m.push(w);let _=1;for(let $=1;$<l.length;$++){let v=a[a.length-$],I=u[u.length-$];if(v===I)_*=v;else break}_%4===0?(h=!0,p=!0):(b||y||g||w)&&(p=!0)}else p=!0;return m.push(p),{name:e,shaderCache:{hint:t+m.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>Od(f,a,u,l,p,d,h,o,r.dataType,n.dataType,i,s),getRunData:()=>({outputs:[{dims:l,dataType:i}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(x.size(l)/4)},...E(a,u,l)]})}},Be=(e,t,r,n,o,s)=>{e.compute(Dd(t,o??"",e.inputs[0],e.inputs[1],r,n,s))},Pi=e=>{Be(e,"Add",(t,r)=>`${t}+${r}`)},zi=e=>{Be(e,"Div",(t,r)=>`${t}/${r}`)},Bi=e=>{Be(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Oi=e=>{Be(e,"Mul",(t,r)=>`${t}*${r}`)},Di=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Be(e,"Pow",{scalar:(n,o)=>`pow_custom(${n},${o})`,vector:(n,o)=>`pow_vector_custom(${n},${o})`},`
...
`)},Nd=(e,t,r,n)=>{let o=x.size(r),s=new Array(e.length),i=new Array(e.length),a=0,u=[],d=[],l=[{type:12,data:o}];for(let f=0;f<e.length;++f)a+=e[f].dims[t],s[f]=a,d.push(e[f].dims.length),i[f]=S(`input${f}`,n,d[f]),u.push("rank"),l.push({type:12,data:s[f]});for(let f=0;f<e.length;++f)l.push(...E(e[f].dims));l.push(...E(r));let c=C("output",n,r.length),p=c.indicesGet("indices",t),h=Array.from(Array(s.length).keys()).map(f=>`uniforms.sizeInConcatAxis${f}`).join(","),m=f=>`
  ...
  ${f.mainStart()}
    ...
    ${Ud(i,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:l}),getShaderSource:m}},Li=(e,t)=>{let r=e.inputs,n=r[0].dims,o=x.normalizeAxis(t.axis,n.length);Rd(r,o);let s=n.slice();s[o]=r.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let i=r.filter(a=>x.size(a.dims)>0);e.compute(Nd(i,o,s,r[0].dataType),{inputs:i})},Gi=e=>U({axis:e.axis})});var _e,$e,ve,Jt,De=A(()=>{"use strict";V();H();_e=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
...
`},rr=(e,t,r,n,o=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i[i.length-2],d=a[a.length-1],l=i[i.length-1],c=ee(d),p=ee(l),h=ee(u),m=x.size(r)/c/h,f=e.length>2,b=n?n.slice(0,-2):r.slice(0,-2),g=[x.size(b),u,d],w=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:l}];$e(t,w),w.push(...E(b,i,a)),f&&w.push(...E(e[2].dims)),w.push(...E(g));let _=$=>{let v=Kt("batch_dims",e[0].dataType,b.length),I=S("a",e[0].dataType,i.length,p),T=S("b",e[1].dataType,a.length,c),k=C("output",e[0].dataType,g.length,c),B=Q(k.type.tensor),D=_e(t,k.type.value,B),G=[I,T],z="";if(f){let R=o?c:1;G.push(S("bias",e[2].dataType,e[2].dims.length,R)),z=`${o?`value += bias[col / ${R}];`:`value += ${k.type.value}(bias[row + i]);`}`}let N=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];ve(t,N);let ne=()=>{let R=`var a_data: ${I.type.value};`;for(let W=0;W<p;W++)R+=`
...
`}return R};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${p};${h};${o}`,inputDependencies:f?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:w}),getShaderSource:_}}});var Wd,Ld,mt,qi,Gd,ft,Hd,ht,gt=A(()=>{"use strict";V();H();F();De();nr();ct();Wd=(e,t)=>e?`
...
`},Hd=(e,t,r,n,o=!1)=>{let[s,i,a,u]=n,d=Q(n[0].type.tensor);return`
  ...
  ${f?mt(b,y,R,ne):ft(b,y,R,ne)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${f?`vec4<${L}>`:L}) {
        ...
        ${f?mt(w,g,L,void 0,!d,T):ft(w,g,L,void 0,!d,T,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${$};${f};${k};${B};${D};${v};${I};${T}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:_[0],y:_[1],z:_[2]},programUniforms:z}),getShaderSource:ne}}});var Fd,ji,or,Kd,Zi,jd,Xi,Qi,Yi=A(()=>{"use strict";V();Te();H();F();De();ct();Fd=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},ji=e=>typeof e=="number"?[e,e,e]:e,or=(e,t)=>t<=1?e:e+(e-1)*(t-1),Kd=(e,t,r,n=1)=>{let o=or(t,n);return Math.floor((e[0]*(r-1)-r+o)/2)},Zi=(e,t,r,n,o)=>{o==null&&(o=Kd(e,t[0],n[0]));let s=[0,0,0,r];for(let i=0;i<3;i++)e[i]+2*o>=t[i]&&(s[i]=Math.trunc((e[i]-t[i]+2*o)/n[i]+1));return s},jd=(e,t,r,n,o,s,i,a,u,d)=>{let l,c,p,h;if(e==="VALID"&&(e=0),typeof e=="number"){l={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=Zi([t,r,n,1],[a,u,d],1,[o,s,i],e);c=m[0],p=m[1],h=m[2]}else if(Array.isArray(e)){if(!e.every((f,b,y)=>f===y[0]))throw Error(`Unsupported padding parameter: ${e}`);l={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=Zi([t,r,n,1],[a,u,d],1,[o,s,i],e[0]);c=m[0],p=m[1],h=m[2]}else if(e==="SAME_UPPER"){c=Math.ceil(t/o),p=Math.ceil(r/s),h=Math.ceil(n/i);let m=(c-1)*o+a-t,f=(p-1)*s+u-r,b=(h-1)*i+d-n,y=Math.floor(m/2),g=m-y,w=Math.floor(f/2),_=f-w,$=Math.floor(b/2),v=b-$;l={top:w,bottom:_,left:$,right:v,front:y,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:l,outDepth:c,outHeight:p,outWidth:h}},Xi=(e,t,r,n,o,s=!1,i="channelsLast")=>{let a,u,d,l,c;if(i==="channelsLast")[a,u,d,l,c]=e;else if(i==="channelsFirst")[a,c,u,d,l]=e;else throw new Error(`Unknown dataFormat ${i}`);let[p,,h,m,f]=t,[b,y,g]=ji(r),[w,_,$]=ji(n),v=or(h,w),I=or(m,_),T=or(f,$),{padInfo:k,outDepth:B,outHeight:D,outWidth:G}=jd(o,u,d,l,b,y,g,v,I,T),z=s?p*c:p,N=[0,0,0,0,0];return i==="channelsFirst"?N=[a,z,B,D,G]:i==="channelsLast"&&(N=[a,B,D,G,z]),{batchSize:a,dataFormat:i,inDepth:u,inHeight:d,inWidth:l,inChannels:c,outDepth:B,outHeight:D,outWidth:G,outChannels:z,padInfo:k,strideDepth:b,strideHeight:y,strideWidth:g,filterDepth:h,filterHeight:m,filterWidth:f,effectiveFilterDepth:v,effectiveFilterHeight:I,effectiveFilterWidth:T,dilationDepth:w,dilationHeight:_,dilationWidth:$,inShape:e,outShape:N,filterShape:t}},Qi=(e,t,r,n,o,s)=>{let i=s==="channelsLast",a=i?e[0].dims[3]:e[0].dims[1],u=!1,d=[64,1,1],l={x:r.map((g,w)=>w)},c=[Math.ceil(Fd(l.x.map(g=>r[g]))/d[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${c}`);let p=u?i&&a%4!==0?3:4:1,h=x.size(r),m=[{type:12,data:h},{type:12,data:n},{type:12,data:o},{type:12,data:t.strides},{type:12,data:t.dilations}];$e(t,m),m.push(...E(e[0].dims,e[1].dims));let f=["rank","rank"],b=e.length===3;b&&(m.push(...E(e[2].dims)),f.push("rank")),m.push(...E(r));let y=g=>{let w=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:n.length},{name:"pads",type:"u32",length:o.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];ve(t,w);let _=u?4:1,$=Q(e[0].dataType),v=S("x",e[0].dataType,e[0].dims.length,p===3?1:p),I=S("W",e[1].dataType,e[1].dims.length,_),T=[v,I],k=C("result",e[0].dataType,r.length,_),B="";if(b){let z=S("bias",e[2].dataType,e[2].dims.length,_);T.push(z),B+=`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${o}] = value;
          ...
          }`}let L=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"strides",type:"i32",length:2},{name:"dilations",type:"i32",length:2},{name:"filter_dims",type:"i32",length:I.length},{name:"pads",type:"i32",length:k.length}];ve(t,L);let re=Q(e[0].dataType,1);if(re!=="f16"&&re!=="f32")throw new Error(`elemType ${re} is not supported.`);return`
        ${tr("uniforms.result_strides")}
        ${z.registerUniforms(L).declareVariables(...W,R)};
        ${K}
        ${Jd(u,i,t,N.type.value,_)}
        ${m?mt(g,y,re,void 0,!u,$):ft(g,y,re,void 0,!u,$,!1,void 0,a)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${g};${y};${m}`,inputDependencies:D},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:w[0],y:w[1],z:w[2]},programUniforms:B}),getShaderSource:G}}});var el,Qr,ss=A(()=>{"use strict";V();Te();H();F();el=(e,t,r,n,o,s=!1,i,a,u=!1)=>{let d=u?1:2,l=u?2:3,c=u?3:1,p=s?2:1,h=`
  ...
  ${s?w:_}}`},Qr=(e,t,r)=>{let n=e.length>2,o=t.outputShape,s=x.size(o),i=[Math.ceil(s/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${i}`);let a=t.format==="NHWC",u=["rank","rank"],d=[t.strides[0],t.strides[1]],l=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],c=[t.dilations[0],t.dilations[1]],p=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],h=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,f=t.group,b=e[1].dims,y=b[0]/f,g=b[1],w=[{type:12,data:s},{type:12,data:d},{type:12,data:l},{type:12,data:c},{type:12,data:p},{type:6,data:h},{type:12,data:y},{type:12,data:g},...E(e[0].dims,e[1].dims)];n&&(w.push(...E(e[2].dims)),u.push("rank")),w.push(...E(o));let _=i[1]===1&&i[2]===1,$=v=>{let I=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:d.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:h.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],T=Q(e[0].dataType);return`${el(v,e,o,n,_,m,T,I,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:i[0],y:i[1],z:i[2]},outputs:[{dims:r?r(o):o,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:$}}});var tl,rl,nl,as,us,ol,il,sl,al,ds,ls=A(()=>{"use strict";is();ss();De();Oe();tl=(e,t,r,n,o,s)=>(e-1)*t+r+(n-1)*o+1-s,rl=(e,t,r,n,o)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=s,r[o]=e-s):t==="SAME_LOWER"&&(r[n]=e-s,r[o]=s)},nl=(e,t,r,n,o,s,i,a,u,d)=>{let l=e.length-2,c=d.length===0;u.length<l&&u.push(...Array(l-u.length).fill(0));let p=e[0],h=t[a?3:1]*o;for(let m=0,f=e.length-l-(a?1:0);m<l;++m,++f){let b=e[f],y=c?b*i[m]:d[m],g=tl(b,i[m],s[m],t[f],r[m],y);rl(g,n,s,m,m+l),c&&d.push(i[m]*(b-1)+u[m]+(t[f]-1)*r[m]+1-s[m]-s[m+l])}d.splice(0,0,p),d.splice(a?3:1,0,h)},as=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){r.length=0;for(let c=2;c<t[1].dims.length;++c)r.push(t[1].dims[c])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let o=e.pads.slice(),s=e.outputShape.slice(),i=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let d=e.strides.slice();if(d.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;d=new Array(c).fill(1)}nl(a,r,u,e.autoPad,e.group,o,d,n,i,s);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:o,outputPadding:i,outputShape:s,dilations:u,strides:d}),l},us=e=>{let t=Jt(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,s=e.group,i=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),l=e.outputPadding,c=e.outputShape;return{autoPad:n,format:r,dilations:o,group:s,kernelShape:i,outputPadding:l,outputShape:c,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},ol=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((l,c)=>l+c,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((l,c)=>l+c,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((l,c)=>l+c,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((l,c)=>l+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},il=[2,3,1,0],sl=(e,t,r)=>{let n=as(r,t),o=r.format==="NHWC",s=n.outputShape,i=s[o?3:1],a=t[0].dims[o?3:1];if(n.group!==1||i===1&&a===1){e.compute(Qr(t,n));return}let u=s[o?1:2],d=s[o?2:3],l=t[1].dims[2],c=t[1].dims[3],p=o?u*d:i,h=o?i:u*d,m=l*c*a,f=!0,b=e.kernelCustomData.wT??e.compute(ce(t[1],il),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let y=[t[0],b],g=t.length===3;g&&(!o&&t[2].dims.length===1?y.push(t[2].reshape([t[2].dims[0],1,1])):y.push(t[2])),e.compute(os(y,n,s,p,h,m,g,f),{inputs:y})},al=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let i=t.strides;(i.length===0||i[0]===0)&&(i=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],i=[1].concat(i),s=[1].concat(s),o=[1].concat(o);let u=as({...t,pads:a,strides:i,dilations:s,kernelShape:o},n);e.compute(Qr(n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]]))},ds=(e,t)=>{ol(e.inputs,t),e.inputs[0].dims.length===3?al(e,t):sl(e,e.inputs,t)}});var ul,cs,ps,ms=A(()=>{"use strict";V();H();ie();F();ul=(e,t,r,n)=>{let o=x.size(t),s=t.length,i=S("input",e,s),a=C("output",e,s),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=x.normalizeAxis(u,s),l=c=>{let p=` i32(${i.indicesGet("inputIndices","uniforms.axis")}) `,h=O("uniforms.input_shape","uniforms.axis",s),m=n.reverse?p+(n.exclusive?" + 1":""):"0",f=n.reverse?h:p+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...E(t,t)]}),getShaderSource:l}},cs=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,o=e.inputs[1];e.compute(ul(n,r,o,t),{inputs:[0]})},ps=e=>{let t=e.exclusive===1,r=e.reverse===1;return U({exclusive:t,reverse:r})}});var dl,ll,cl,fs,hs,gs=A(()=>{"use strict";V();H();ie();F();dl=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},ll=(e,t,r,n)=>{let o=[];o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
...
`)},cl=(e,t)=>{let r,n,o,s,i,a,u=t.format==="NHWC",d=t.blocksize,l=t.mode==="DCR";u?([r,n,o,s]=e.dims,i=l?[r,n,o,d,d,s/d**2]:[r,n,o,s/d**2,d,d],a=l?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,o,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],i=l?[r,d,d,s/d**2,n,o]:[r,s/d**2,d,d,n,o],a=l?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(i),p=c.dims.length,h=e.dataType,m=S("a",h,p),f=C("output",h,p),b=y=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:y=>{let g=u?[r,n*d,o*d,s/d**2]:[r,s/d**2,n*d,o*d],w=x.size(g),_=c.dims,$=x.sortBasedOnPerm(_,a);return{outputs:[{dims:g,dataType:y[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...E(_,$)]}},getShaderSource:b}},fs=(e,t)=>{dl(e.inputs),e.compute(cl(e.inputs[0],t))},hs=e=>U({blocksize:e.blocksize,mode:e.mode,format:e.format})});var Yr,ir,ys,pl,ml,Jr,en,bs,fl,ws,_s,$s=A(()=>{"use strict";V();H();ie();F();Yr="[a-zA-Z]|\\.\\.\\.",ir="("+Yr+")+",ys="^"+ir+"$",pl="("+ir+",)*"+ir,ml="^"+pl+"$",Jr=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},en=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,o]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(ml)))throw new Error("Invalid LHS term");if(n.split(",").forEach((a,u)=>{let d=t[u].dims.slice();if(!a.match(RegExp(ys)))throw new Error("Invalid LHS term");let l=this.processTerm(a,!0,d,u);this.lhs.push(l)}),o==="")o+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!o.match(RegExp(ir)))throw new Error("Invalid RHS");o.match(RegExp(Yr,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(o,!1,this.outputDims)}addSymbol(t,r,n){let o=this.symbolToInfo.get(t);if(o!==void 0){if(o.dimValue!==r&&o.count!==1)throw new Error("Dimension mismatch");o.count++,o.inputIndices.push(n)}else o={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,o)}processTerm(t,r,n,o=-1){let s=n.length,i=!1,a=[],u=0;if(!t.match(RegExp(ys))&&!r&&t!=="")throw new Error("Invalid LHS term");let d=t.match(RegExp(Yr,"g")),l=new Jr(o);return d?.forEach((c,p)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=s-d.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=n.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let f=String.fromCharCode("0".charCodeAt(0)+m);l.addSymbol(f,p+m),this.addSymbol(f,n[u++],o)}}else l.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,n[u++],o)}),l}},bs=e=>e+"_max",fl=(e,t,r,n)=>{let s=e.map(l=>l.length).map((l,c)=>S(`input${c}`,t,l)),i=x.size(n),a=C("output",t,n.length),u=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),d=l=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",f=[],b=[],y=[],g=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach(($,v)=>{if(r.rhs.symbolToIndices.has(v)){let I=r.rhs.symbolToIndices.get(v)?.[0];I!==void 0&&r.lhs.forEach((T,k)=>{if($.inputIndices.includes(k)){let B=T.symbolToIndices.get(v);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(D=>{c.push(`${s[k].indicesSet(`input${k}Indices`,D,a.indicesGet("outputIndices",I))}`)})}})}else r.lhs.forEach((I,T)=>{if($.inputIndices.includes(T)){let k=I.symbolToIndices.get(v);if(k===void 0)throw new Error("Invalid symbol error");k.forEach(B=>{f.push(`${s[T].indicesSet(`input${T}Indices`,B,`${v}`)}`)}),g.push(`prod *= ${s[T].getByIndices(`input${T}Indices`)};`)}}),b.push(`for(var ${v}: u32 = 0; ${v} < uniforms.${bs(v)}; ${v}++) {`),y.push("}")});let _=w?[...c,`let sum = ${s.map(($,v)=>$.getByIndices(`input${v}Indices`)).join(" * ")};`]:[...c,h,...b,...f,p,...g,m,...y];return`
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=u.filter(p=>r.symbolToInfo.has(p)).map(p=>({type:12,data:r.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:i});let c=e.map((p,h)=>[...E(p)]).reduce((p,h)=>p.concat(h),l);return c.push(...E(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}},getShaderSource:d}},ws=(e,t)=>{let r=new en(e.inputs,t.equation),n=r.outputDims,o=e.inputs.map((s,i)=>s.dims);e.compute(fl(o,e.inputs[0].dataType,r,n))},_s=e=>{let t=e.equation.replace(/\s+/g,"");return U({equation:t})}});var hl,vs,gl,yl,xs,Ss=A(()=>{"use strict";V();H();F();hl=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,o=t.length<r.length?0:t.length-r.length;for(;n<r.length&&o<t.length;++n,++o)if(r[n]!==t[o]&&r[n]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},vs=(e,t)=>{let r=e.length-t.length,n=[];for(let o=0;o<r;++o)n.push(e[o]);for(let o=0;o<t.length;++o)n.push(t[o]===1?e[o+r]:t[o]);return n},gl=(e,t)=>e.length>t.length?vs(e,t):vs(t,e),yl=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=gl(t,r),o=e[0].dataType,s=o===9?4:1,i=Math.ceil(x.size(n)/s),a=d=>{let l=S("input",o,t.length,s),c=C("output",o,n.length,s),p;if(o===9){let h=(m,f,b="")=>`
    ...
    ${p}`},u=[{type:12,data:i},...E(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u})}},xs=e=>{hl(e.inputs),e.compute(yl(e.inputs),{inputs:[0]})}});var bl,Is,Ts=A(()=>{"use strict";V();H();F();Yt();bl=e=>{let t=e[0].dataType,r=x.size(e[0].dims),n=x.size(e[1].dims),o=n%4===0,s=i=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=h=>`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,f)=>f!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,f)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:d}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},Es=(e,t)=>{let r=e.inputs;$l(r,t),e.compute(vl(e.inputs,t))},Ps=e=>U({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var xl,Sl,Bs,Os,Ds=A(()=>{"use strict";V();H();ie();F();xl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return c?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:d*l},programUniforms:h}),getShaderSource:b}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Ms=e=>{let t=e.transA,r=e.transB,n=e.alpha,o=e.beta;return{transA:t,transB:r,alpha:n,beta:o,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Rs=(e,t)=>{Il(e.inputs),e.compute(Tl(e.inputs,t))}});var Me,Ne,Je,et,Cl,Al,kl,El,Pl,zl,Bl,Ol,Us,Ns,Ws=A(()=>{"use strict";V();H();ie();F();[Me,Ne,Je,et]=[0,1,2,3],Cl=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Al=`
...
`)}
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},_=[{dims:a,dataType:e[0].dataType}];return y&&_.push({dims:h,dataType:1}),g&&_.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${r};${n}`,inputDependencies:f},getRunData:()=>({outputs:_,dispatchGroup:{x:Math.ceil(d/64)},programUniforms:b}),getShaderSource:w}},Js=(e,t)=>{Kl(e.inputs),e.compute(jl(e.inputs,t,e.outputCount))}});var Zl,ta,ra=A(()=>{"use strict";H();nr();gt();Zl=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},ta=e=>{Zl(e.inputs);let t=Ae.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];if(r<8&&n<8)e.compute(rr(e.inputs,{activation:""},t));else{let o=t[t.length-2],s=x.size(e.inputs[0].dims.slice(0,-2)),i=x.size(e.inputs[1].dims.slice(0,-2));if(s!==1&&o===1&&i===1){let a=e.inputs[0].reshape([1,s,n]),u=e.inputs[1].reshape([1,n,r]),d=[1,s,r],l=[a,u];e.compute(ht(l,{activation:""},t,d),{inputs:l})}else e.compute(ht(e.inputs,{activation:""},t))}}});var Xl,Ql,Yl,na,oa,ia=A(()=>{"use strict";V();H();ie();F();Xl=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],n=r.dims.length;if(r.dims[n-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let o=Math.floor((t.k+t.blockSize-1)/t.blockSize),s=t.blockSize/8*t.bits,i=e[1];if(!x.areEqual(i.dims,[t.n,o,s]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(x.size(u)!==t.n*o)throw new Error("scales input size error.");if(e.length===4){let l=e[3].dims,c=t.bits>4?t.n*o:t.n*Math.floor((o+1)/2);if(x.size(l)!==c)throw new Error("zeroPoints input size error.")}},Ql=(e,t)=>{let r=e[0].dims,n=r.length,o=r[n-2],s=t.k,i=t.n,a=r.slice(0,n-2),u=x.size(a),l=e[1].dims[2]/4,c=e[0].dataType,p=ee(t.k),h=ee(l),m=ee(i),f=a.concat([o,i]),b=o>1&&i/m%2===0?2:1,y=x.size(f)/m/b,g=64,w=[],_=[u,o,s/p],$=x.convertShape(e[1].dims).slice();$.splice(-1,1,l/h),w.push(...E(_)),w.push(...E($)),w.push(...E(e[2].dims)),e.length===4&&w.push(...E(x.convertShape(e[3].dims)));let v=[u,o,i/m];w.push(...E(v));let I=T=>{let k=_.length,B=S("a",e[0].dataType,k,p),D=S("b",12,$.length,h),G=S("scales",e[2].dataType,e[2].dims.length),z=[B,D,G],N=e.length===4?S("zero_points",12,e[3].dims.length):void 0;N&&z.push(N);let ne=v.length,R=C("output",e[0].dataType,ne,m),W=Q(e[0].dataType),K=(()=>{switch(p){case 1:return`array<${W}, 8>`;case 2:return`mat4x2<${W}>`;case 4:return`mat2x4<${W}>`;default:throw new Error(`${p}-component is not supported.`)}})(),L=()=>{let ae=`
          // reuse a data
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${h};${m};${b};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:c}],dispatchGroup:{x:y},programUniforms:w}),getShaderSource:I}},Yl=(e,t)=>{let r=e[0].dims,n=r.length,o=r[n-2],s=t.k,i=t.n,a=r.slice(0,n-2),u=x.size(a),l=e[1].dims[2]/4,c=e[0].dataType,p=ee(t.k),h=ee(l),m=a.concat([o,i]),f=128,b=i%8===0?8:i%4===0?4:1,y=f/b,g=y*h*8,w=g/p,_=g/t.blockSize,$=x.size(m)/b,v=[],I=[u,o,s/p],T=x.convertShape(e[1].dims).slice();T.splice(-1,1,l/h),v.push(...E(I)),v.push(...E(T)),v.push(...E(e[2].dims)),e.length===4&&v.push(...E(x.convertShape(e[3].dims)));let k=[u,o,i];v.push(...E(k));let B=D=>{let G=I.length,z=S("a",e[0].dataType,G,p),N=S("b",12,T.length,h),ne=S("scales",e[2].dataType,e[2].dims.length),R=[z,N,ne],W=e.length===4?S("zero_points",12,e[3].dims.length):void 0;W&&R.push(W);let K=k.length,L=C("output",e[0].dataType,K),re=Q(e[0].dataType),he=()=>{switch(p){case 1:return`
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:c}],dispatchGroup:{x:$},programUniforms:v}),getShaderSource:B}},na=(e,t)=>{Xl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Yl(e.inputs,t)):e.compute(Ql(e.inputs,t))},oa=e=>U(e)});var Jl,ec,tc,rc,nc,oc,ic,sc,sa,aa=A(()=>{"use strict";V();H();F();Jl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},ec=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
    ...
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[l,c,p,h,m]=da(s,o);return l.push(...E(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${p};${h};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:l}),getShaderSource:f=>la(f,u,t.dims.length,s.length,o,i,a,t.dataType===10?-65504:-1e5,c,p,h,m)}},_a=(e,t)=>{sr(e.inputs),e.compute(wa("MaxPool",e.inputs[0],!1,t))},$a=e=>{let t=e.storage_order,r=e.dilations,n=pa(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:r,...n,cacheKey:""};return{...o,cacheKey:uc(o)}},va=e=>{let t=e.format;return{format:t,...ga,cacheKey:t}},xa=(e,t)=>{sr(e.inputs),e.compute(wa("GlobalMaxPool",e.inputs[0],!0,t))}});var lc,cc,Ia,Ta,Ca=A(()=>{"use strict";V();H();ie();F();lc=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,n)=>r===e[2].dims[n]).reduce((r,n)=>r&&n,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,s)=>s===t.axis||o===e[0].dims[s]).reduce((o,s)=>o&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],n=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/n)||t.blockSize>Math.ceil(r/(n-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},cc=(e,t)=>{let r=x.normalizeAxis(t.axis,e[0].dims.length),n=e[0].dataType,o=n===3,s=e[0].dims,i=e[1].dataType,a=x.size(s),u=n===3||n===2,d=u?[Math.ceil(x.size(e[0].dims)/4)]:e[0].dims,l=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil(x.size(c.dims)/4)]:c.dims:void 0,h=l.length===0||l.length===1&&l[0]===1,m=h===!1&&l.length===1,f=ee(a),b=h&&(!u||f===4),y=b?f:1,g=b&&!u?f:1,w=S("input",u?12:n,d.length,g),_=S("scale",i,l.length),$=c?S("zero_point",u?12:n,p.length):void 0,v=C("output",i,s.length,y),I=[w,_];$&&I.push($);let T=[d,l];c&&T.push(p);let k=[{type:12,data:a/y},{type:12,data:r},{type:12,data:t.blockSize},...E(...T,s)],B=D=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/y/64),y:1,z:1},programUniforms:k})}},Ia=(e,t)=>{lc(e.inputs,t),e.compute(cc(e.inputs,t))},Ta=e=>U({axis:e.axis,blockSize:e.blockSize})});var pc,mc,Aa,ka=A(()=>{"use strict";xe();V();F();pc=(e,t,r)=>{let n=e===t,o=e<t&&r<0,s=e>t&&r>0;if(n||o||s)throw new Error("Range these inputs' contents are invalid.")},mc=(e,t,r,n)=>{let o=Math.abs(Math.ceil((t-e)/r)),s=[o],i=o,a=[{type:12,data:i},{type:n,data:e},{type:n,data:r},...E(s)],u=d=>{let l=C("output",n,s.length),c=l.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${d.registerUniforms(p).declareVariables(l)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:a})}},Aa=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),J.webgpu.validateInputContent&&pc(t,r,n),e.compute(mc(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var fc,hc,gc,yc,bc,wc,_c,$c,vc,xc,Sc,Ea,Ic,Tc,Cc,Ac,kc,Pa,za,Ba=A(()=>{"use strict";V();H();ie();F();fc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:U({interleaved:r}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(x.size(p)/je)},programUniforms:m})}},Oa=(e,t)=>{Ec(e.inputs,t),e.compute(Pc(e.inputs,t))}});var zc,Bc,Ma,Ra=A(()=>{"use strict";V();H();F();zc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],n=e[2];if(t.dataType!==r.dataType||t.dataType!==n.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(n.dims.length!==1)throw new Error("Gamma must be 1D");if(n.dims[n.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let i=e[3];if(i.dims.length!==1)throw new Error("Beta must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let i=e[4];if(i.dims.length!==1)throw new Error("Bias must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},Bc=(e,t,r,n)=>{let o=t.simplified,s=e[0].dims,i=x.size(s),a=s,u=i,d=s.slice(-1)[0],l=n?s.slice(0,-1).concat(1):[],c=!o&&e.length>3,p=e.length>4,h=n&&r>1,m=n&&r>2,f=r>3,b=64,y=ee(d),g=[{type:12,data:u},{type:12,data:y},{type:12,data:d},{type:1,data:t.epsilon}],w=$=>{let v=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],I=[S("x",e[0].dataType,e[0].dims,y),S("skip",e[1].dataType,e[1].dims,y),S("gamma",e[2].dataType,e[2].dims,y)];c&&I.push(S("beta",e[3].dataType,e[3].dims,y)),p&&I.push(S("bias",e[4].dataType,e[4].dims,y)),I.push(C("output",e[0].dataType,a,y)),h&&I.push(C("mean_output",1,l)),m&&I.push(C("inv_std_output",1,l)),f&&I.push(C("input_skip_bias_sum",e[0].dataType,a,y));let T=Q(e[0].dataType),k=Q(1,y);return`
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${i.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:f})}},Ua=(e,t)=>{Oc(e.inputs,t);let r=Dc(e.inputs,t);e.compute(Rc(e.inputs,r),{inputs:[0]})},Na=e=>{let t=e.starts,r=e.ends,n=e.axes;return U({starts:t,ends:r,axes:n})}});var Vc,Uc,La,Ga,Ha=A(()=>{"use strict";V();H();ie();Oe();F();Vc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Uc=(e,t)=>{let r=e.inputs[0],n=r.dims,o=x.size(n),s=n.length,i=x.normalizeAxis(t.axis,s),a=i<n.length-1,u,d=[];a?(d=Array.from({length:s},(I,T)=>T),d[i]=s-1,d[s-1]=i,u=e.compute(ce(r,d),{inputs:[r],outputs:[-1]})[0]):u=r;let l=u.dims,c=l[s-1],p=o/c,h=ee(c),m=c/h,f=64;p===1&&(f=256);let b=(I,T)=>T===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:T===2?`max(${I}.x, ${I}.y)`:T===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,y=S("x",u.dataType,u.dims,h),g=C("result",u.dataType,u.dims,h),w=y.type.value,_=Q(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=I=>`
