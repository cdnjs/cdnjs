...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},fo=(e,t)=>new Rr(e,t)});var Ku,ho,ju,Zu,Xu,ce,go,yo,Oe=A(()=>{"use strict";V();H();ie();F();Ku=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},ho=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,ju=(e,t)=>x.sortBasedOnPerm(e,ho(e.length,t)),Zu=(e,t,r,n)=>{let o=`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)o+=r.indicesSet("a",e[s],`i[${s}]`);return o+="return a;}"},Xu=(e,t)=>{let r=[],n=[];for(let o=0;o<e.length;++o)e[o]!==1&&r.push(e[o]),e[t[o]]!==1&&n.push(t[o]);return{newShape:r,newPerm:n}},ce=(e,t)=>{let r=e.dataType,n=e.dims.length,o=ho(n,t),s=ju(e.dims,o),{newShape:i,newPerm:a}=Xu(e.dims,o),u=x.areEqual(a,[2,3,1]),d=x.areEqual(a,[3,1,2]),l=i.length===2&&a[0]>a[1]||u||d,c=l?i:e.dims,p=s;l&&(c=u?[i[0],i[1]*i[2]]:d?[i[0]*i[1],i[2]]:i,p=[c[1],c[0]]);let h=S("a",r,c.length),m=C("output",r,p.length),f=16,b;return l?b=y=>`
    ...
    ${m.setByOffset("global_idx",h.getByIndices("aIndices"))}
  }`,{name:l?"TransposeShared":"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let y=x.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:l?{x:Math.ceil(p[1]/f),y:Math.ceil(p[0]/f)}:{x:Math.ceil(y/64)},programUniforms:[{type:12,data:y},...E(c,p)]}},getShaderSource:b}},go=(e,t)=>{Ku(e.inputs),e.compute(ce(e.inputs[0],t.perm))},yo=e=>U({perm:e.perm})});var Qu,Yu,Ju,ed,td,rd,nd,od,id,sd,ke,bo,wo,_o,$o,vo,xo,So,Io,To,Co,Ao=A(()=>{"use strict";V();H();F();Zt();Oe();Qu={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},Yu={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},Ju={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},ed={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},td=(e,t)=>{let r=[];for(let n=t-e;n<t;++n)r.push(n);return r},rd=(e,t)=>{let r=[],n=e.length;for(let s=0;s<n;s++)t.indexOf(s)===-1&&r.push(e[s]);let o=t.map(s=>e[s]);return[r,o]},nd=(e,t)=>{let r=e.length+t.length,n=[],o=0;for(let s=0;s<r;s++)t.indexOf(s)===-1?n.push(e[o++]):n.push(1);return n},od=(e,t)=>{for(let r=0;r<e.length;++r)if(e[e.length-r-1]!==t-1-r)return!1;return!0},id=(e,t)=>{let r=[];if(!od(e,t)){for(let n=0;n<t;++n)e.indexOf(n)===-1&&r.push(n);e.forEach(n=>r.push(n))}return r},sd=(e,t,r,n,o,s,i)=>{let a=r[0].dims,u=x.size(s),d=x.size(i),l=S("_A",r[0].dataType,a),c=C("output",o,s),p=64;u===1&&(p=256);let h=`
       ...
       `,m=f=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${c.setByOffset("outputIndex",`${n==="mean"?`${c.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${c.type.storage}(${ed[n]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},ke=(e,t,r,n)=>{let o=e.inputs.length===1?r:Wr(e.inputs,r),s=o.axes;s.length===0&&!o.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((h,m)=>m));let i=x.normalizeAxes(s,e.inputs[0].dims.length),a=i,u=e.inputs[0],d=id(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(ce(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=td(a.length,u.dims.length));let[l,c]=rd(u.dims,a),p=l;o.keepDims&&(p=nd(l,i)),e.compute(sd(t,o.cacheKey,[u],n,e.inputs[0].dataType,p,c),{inputs:[u]})},bo=(e,t)=>{ke(e,"ReduceMeanShared",t,"mean")},wo=(e,t)=>{ke(e,"ReduceL1Shared",t,"l1")},_o=(e,t)=>{ke(e,"ReduceL2Shared",t,"l2")},$o=(e,t)=>{ke(e,"ReduceLogSumExpShared",t,"logSumExp")},vo=(e,t)=>{ke(e,"ReduceMaxShared",t,"max")},xo=(e,t)=>{ke(e,"ReduceMinShared",t,"min")},So=(e,t)=>{ke(e,"ReduceProdShared",t,"prod")},Io=(e,t)=>{ke(e,"ReduceSumShared",t,"sum")},To=(e,t)=>{ke(e,"ReduceSumSquareShared",t,"sumSquare")},Co=(e,t)=>{ke(e,"ReduceLogSumShared",t,"logSum")}});var Ee,ad,Xt,Wr,Pe,ud,dd,ld,cd,pd,md,fd,hd,gd,yd,ze,ko,Eo,Po,zo,Bo,Oo,Do,Mo,Ro,Vo,Zt=A(()=>{"use strict";V();H();ie();F();Ao();Ee=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},ad=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Xt=(e,t,r,n,o,s,i=!1,a=!1)=>{let u=[],d=r[0].dims,l=d.length,c=x.normalizeAxes(o,l),p=!a&&c.length===0;d.forEach((b,y)=>{p||c.indexOf(y)>=0?i&&u.push(1):u.push(b)});let h=u.length,m=x.size(u);return{name:e,shaderCache:t,getShaderSource:b=>{let y=[],g=S("_A",r[0].dataType,l),w=C("output",s,h),_=n(g,w,c),$=_[2];for(let v=0,I=0;v<l;v++)p||c.indexOf(v)>=0?(i&&I++,$=`for(var j${v}: u32 = 0; j${v} < ${d[v]}; j${v}++) {
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:a,programUniforms:d}),getShaderSource:l},{inputs:u,outputs:[-1,-1,-1]})},Go=(e,t)=>{let r=bd(e.inputs,t),[n,o,s]=vd(e,r);return Ye(e,n,o,s,e.inputs[4],void 0,void 0,void 0,e.inputs[5],r)}});var xd,Sd,Id,Ho,qo=A(()=>{"use strict";xe();V();H();ie();F();xd=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let r=(n,o,s)=>{let i=o.length;if(i!==n.length)throw new Error(`${s}: num dimensions != ${i}`);o.forEach((a,u)=>{if(a!==n[u])throw new Error(`${s}: dim[${u}] do not match`)})};if(e[0].dims.length>1){let n=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);r(e[1].dims,n,"Invalid input scale"),r(e[2].dims,n,"Invalid input B"),r(e[3].dims,n,"Invalid input mean"),r(e[4].dims,n,"Invalid input var")}else r(e[1].dims,[1],"Invalid input scale"),r(e[2].dims,[1],"Invalid input B"),r(e[3].dims,[1],"Invalid input mean"),r(e[4].dims,[1],"Invalid input var")},Sd=(e,t)=>{let{epsilon:r,spatial:n,format:o}=t,s=e[0].dims,i=n?ee(s[s.length-1]):1,a=o==="NHWC"&&s.length>1?i:1,u=x.size(s)/i,d=n,l=d?s.length:s,c=S("x",e[0].dataType,e[0].dims,i),p=S("scale",e[1].dataType,e[1].dims,a),h=S("bias",e[2].dataType,e[2].dims,a),m=S("inputMean",e[3].dataType,e[3].dims,a),f=S("inputVar",e[4].dataType,e[4].dims,a),b=C("y",e[0].dataType,l,i),y=()=>{let w="";if(n)w=`let cOffset = ${s.length===1?"0u":o==="NHWC"?`outputIndices[${s.length-1}] / ${i}`:"outputIndices[1]"};`;else if(o==="NCHW")w=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${i}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...E(s)]:[{type:12,data:u}]})}},Id=e=>U(e),Ho=(e,t)=>{let{inputs:r,outputCount:n}=e,o=Id({...t,outputCount:n});if(Q.webgpu.validateInputContent&&xd(r,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Sd(r,o))}});var Td,Cd,Fo,Ko=A(()=>{"use strict";H();F();Td=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Cd=e=>{let t=e[0].dims,r=e[0].dims[2],n=x.size(t)/4,o=e[0].dataType,s=S("input",o,t,4),i=S("bias",o,[r],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:l=>`
  ...
  }`}},Fo=e=>{Td(e.inputs),e.compute(Cd(e.inputs))}});var Ad,J,jo,Zo,Xo,Qo,Yo,Jo,ei,ti,ri,kd,ni,oi,ii,si,pt,ai,Yt,ui,di,li,ci,pi,mi,fi,hi,gi,yi,bi,wi,_i,$i,vi,xi,Si,Ii,Hr,qr,Ti,Ci,Ai,Ed,Pd,ki,Jt=A(()=>{"use strict";V();H();ie();F();Ad=(e,t,r,n,o,s,i)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let d=S("inputData",r,[a],4),l=C("outputData",n,[a],4),c=[{name:"vec_size",type:"u32"}];return i&&c.push(...i),`
  ...
  }`},J=(e,t,r,n,o,s=e.dataType,i,a)=>{let u=[{type:12,data:Math.ceil(x.size(e.dims)/4)}];return i&&u.push(...i),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:d=>Ad(d,x.size(e.dims),e.dataType,s,r,n,a),getRunData:d=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(x.size(d[0].dims)/64/4)},programUniforms:u})}},jo=e=>{e.compute(J(e.inputs[0],"Abs","abs"))},Zo=e=>{e.compute(J(e.inputs[0],"Acos","acos"))},Xo=e=>{e.compute(J(e.inputs[0],"Acosh","acosh"))},Qo=e=>{e.compute(J(e.inputs[0],"Asin","asin"))},Yo=e=>{e.compute(J(e.inputs[0],"Asinh","asinh"))},Jo=e=>{e.compute(J(e.inputs[0],"Atan","atan"))},ei=e=>{e.compute(J(e.inputs[0],"Atanh","atanh"))},ti=e=>U(e),ri=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(J(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},kd=e=>{let t,r,n=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=n?e[1].getFloat32Array()[0]:-34028234663852886e22,r=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=n?e[1].getUint16Array()[0]:64511,r=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return U({min:t,max:r})},ni=(e,t)=>{let r=t||kd(e.inputs),n=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:n},{name:"max",type:n}]),{inputs:[0]})},oi=e=>{e.compute(J(e.inputs[0],"Ceil","ceil"))},ii=e=>{e.compute(J(e.inputs[0],"Cos","cos"))},si=e=>{e.compute(J(e.inputs[0],"Cosh","cosh"))},pt=e=>U(e),ai=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,ui=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Yt(t)))},di=e=>{e.compute(J(e.inputs[0],"Exp","exp"))},li=e=>{e.compute(J(e.inputs[0],"Floor","floor"))},ci=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Yt(t)))},pi=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},mi=e=>{e.compute(J(e.inputs[0],"Not",t=>`!${t}`))},fi=e=>{e.compute(J(e.inputs[0],"Neg",t=>`-${t}`))},hi=e=>{e.compute(J(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},gi=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},yi=e=>{e.compute(J(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},bi=e=>U(e),wi=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},_i=e=>{e.compute(J(e.inputs[0],"Sin","sin"))},$i=e=>{e.compute(J(e.inputs[0],"Sinh","sinh"))},vi=e=>{e.compute(J(e.inputs[0],"Sqrt","sqrt"))},xi=e=>{e.compute(J(e.inputs[0],"Tan","tan"))},Si=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Ii=e=>{e.compute(J(e.inputs[0],"Tanh",Si))},Hr=(e="f32")=>`
...
`,qr=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Ti=e=>{let t=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"FastGelu",qr,Hr(t),void 0,e.inputs[0].dataType))},Ci=(e,t)=>{let r=le(e.inputs[0].dataType);return e.compute(J(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Ai=e=>{e.compute(J(e.inputs[0],"Log","log"))},Ed=(e,t)=>`
...
`,Pd=e=>`quick_gelu_impl(${e})`,ki=(e,t)=>{let r=le(e.inputs[0].dataType);e.compute(J(e.inputs[0],"QuickGelu",Pd,Ed(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var zd,Bd,Pi,zi=A(()=>{"use strict";H();F();Jt();zd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Bd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=S("input",e[0].dataType,e[0].dims,4),n=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),s=x.size(t)/4,i=Y(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${y}
      }`},Dd=(e,t,r,n,o,s,i=r.dataType)=>{let a=r.dims.map(f=>Number(f)??1),u=n.dims.map(f=>Number(f)??1),d=!x.areEqual(a,u),l=a,c=x.size(a),p=!1,h=!1,m=[d];if(d){let f=Ae.calcShape(a,u,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");l=f.slice(),c=x.size(l);let b=x.size(a)===1,y=x.size(u)===1,g=a.length>0&&a[a.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;m.push(b),m.push(y),m.push(g),m.push(w);let _=1;for(let $=1;$<l.length;$++){let v=a[a.length-$],I=u[u.length-$];if(v===I)_*=v;else break}_%4===0?(h=!0,p=!0):(b||y||g||w)&&(p=!0)}else p=!0;return m.push(p),{name:e,shaderCache:{hint:t+m.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>Od(f,a,u,l,p,d,h,o,r.dataType,n.dataType,i,s),getRunData:()=>({outputs:[{dims:l,dataType:i}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(x.size(l)/4)},...E(a,u,l)]})}},Be=(e,t,r,n,o,s)=>{e.compute(Dd(t,o??"",e.inputs[0],e.inputs[1],r,n,s))},Bi=e=>{Be(e,"Add",(t,r)=>`${t}+${r}`)},Oi=e=>{Be(e,"Div",(t,r)=>`${t}/${r}`)},Di=e=>{Be(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Mi=e=>{Be(e,"Mul",(t,r)=>`${t}*${r}`)},Ri=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Be(e,"Pow",{scalar:(n,o)=>`pow_custom(${n},${o})`,vector:(n,o)=>`pow_vector_custom(${n},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Vi=e=>{Be(e,"Sub",(t,r)=>`${t}-${r}`)},Ui=e=>{Be(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},Ni=e=>{Be(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},Wi=e=>{Be(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},Li=e=>{Be(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}});var Rd,Vd,Ud,Nd,Hi,qi,Fi=A(()=>{"use strict";V();H();ie();F();Rd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,n=e[r],o=n.dataType,s=n.dims.length;e.forEach((i,a)=>{if(a!==r){if(i.dataType!==o)throw new Error("input tensors should be one type");if(i.dims.length!==s)throw new Error("input tensors should have the same shape");i.dims.forEach((u,d)=>{if(d!==t&&u!==n.dims[d])throw new Error("non concat dimensions must match")})}})},Vd=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,Ud=(e,t)=>{let r=e.length,n=[];for(let o=0;o<r;++o){let s=t.setByOffset("global_idx",e[o].getByIndices("indices"));r===1?n.push(s):o===0?n.push(`if (inputIndex == ${o}u) { ${s} }`):o===r-1?n.push(`else { ${s} }`):n.push(`else if (inputIndex == ${o}) { ${s} }`)}return n.join(`
`)},Nd=(e,t,r,n)=>{let o=x.size(r),s=new Array(e.length),i=new Array(e.length),a=0,u=[],d=[],l=[{type:12,data:o}];for(let f=0;f<e.length;++f)a+=e[f].dims[t],s[f]=a,d.push(e[f].dims.length),i[f]=S(`input${f}`,n,d[f]),u.push("rank"),l.push({type:12,data:s[f]});for(let f=0;f<e.length;++f)l.push(...E(e[f].dims));l.push(...E(r));let c=C("output",n,r.length),p=c.indicesGet("indices",t),h=Array.from(Array(s.length).keys()).map(f=>`uniforms.sizeInConcatAxis${f}`).join(","),m=f=>`
  ...
  ${f.mainStart()}
    ...
    ${Ud(i,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:l}),getShaderSource:m}},Hi=(e,t)=>{let r=e.inputs,n=r[0].dims,o=x.normalizeAxis(t.axis,n.length);Rd(r,o);let s=n.slice();s[o]=r.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let i=r.filter(a=>x.size(a.dims)>0);e.compute(Nd(i,o,s,r[0].dataType),{inputs:i})},qi=e=>U({axis:e.axis})});var _e,$e,ve,er,De=A(()=>{"use strict";V();H();_e=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},$e=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},ve=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},er=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,n]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:n}}else if(t==="Clip"){let[r,n]=e?.activation_params||[po,mo];return{activation:t,clipMax:n,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}});var me,tr,mt=A(()=>{"use strict";me=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},tr=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var rr,Fr=A(()=>{"use strict";rr=e=>`
...
`});var ft,nr,or=A(()=>{"use strict";V();H();F();De();ft=(e,t,r,n,o)=>{let s=n-r;return`
...
`},nr=(e,t,r,n,o=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i[i.length-2],d=a[a.length-1],l=i[i.length-1],c=ee(d),p=ee(l),h=ee(u),m=x.size(r)/c/h,f=e.length>2,b=n?n.slice(0,-2):r.slice(0,-2),g=[x.size(b),u,d],w=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:l}];$e(t,w),w.push(...E(b,i,a)),f&&w.push(...E(e[2].dims)),w.push(...E(g));let _=$=>{let v=jt("batch_dims",e[0].dataType,b.length),I=S("a",e[0].dataType,i.length,p),T=S("b",e[1].dataType,a.length,c),k=C("output",e[0].dataType,g.length,c),B=Y(k.type.tensor),D=_e(t,k.type.value,B),G=[I,T],z="";if(f){let R=o?c:1;G.push(S("bias",e[2].dataType,e[2].dims.length,R)),z=`${o?`value += bias[col / ${R}];`:`value += ${k.type.value}(bias[row + i]);`}`}let N=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];ve(t,N);let ne=()=>{let R=`var a_data: ${I.type.value};`;for(let W=0;W<p;W++)R+=`
...
`}return R};return`
  ...
  ${$.mainStart()}
    ...
    ${ft("a_indices",I,I.rank-2,v.rank,"batch_indices")}
    ...
    ${ft("b_indices",T,T.rank-2,v.rank,"batch_indices")}
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${p};${h};${o}`,inputDependencies:f?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:w}),getShaderSource:_}}});var Wd,Ld,ht,Ki,Gd,gt,Hd,yt,bt=A(()=>{"use strict";V();H();F();De();or();mt();Wd=(e,t)=>e?`
        ...
        }`,ht=(e,t,r="f32",n,o=!1,s=32,i=!1,a=32)=>{let u=t[1]*e[1],d=t[0]*e[0],l=o?u:s,c=o?s:u,p=l/t[0],h=s/t[1];if(!((o&&p===4&&e[1]===4||!o&&(p===3||p===4))&&l%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${o} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
`},Hd=(e,t,r,n,o=!1)=>{let[s,i,a,u]=n,d=Y(n[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${me(e,d)} {
      ...
      if(row < uniforms.dim_a_outer && col < uniforms.dim_inner)
      {
        ...
        ${ft("aIndices",i,i.rank-2,s.rank,"batchIndices")}
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${s.type.indices}) -> ${me(e,d)} {
      ...
      if(row < uniforms.dim_inner && col < uniforms.dim_b_outer)
      {
        ...
        ${ft("bIndices",a,a.rank-2,s.rank,"batchIndices")}
  ...
  ${f?ht(b,y,R,ne):gt(b,y,R,ne)}
    ...
    return ${me(i,d)}(0.0);`,_=`${c(a)}`,$=me(u,d),v=e?me(i,d):me(a,d),I=e?me(a,d):me(i,d),T=_e(s,$,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${f?`vec4<${L}>`:L}) {
        ...
        ${re}
        ${qd(d,k,B,D,i,t,G[0],G[1],G[2],L)}
        ${f?ht(w,g,L,void 0,!d,T):gt(w,g,L,void 0,!d,T,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${$};${f};${k};${B};${D};${v};${I};${T}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:_[0],y:_[1],z:_[2]},programUniforms:z}),getShaderSource:ne}}});var Fd,Xi,ir,Kd,Qi,jd,Yi,Ji,es=A(()=>{"use strict";V();Te();H();F();De();mt();Fd=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Xi=e=>typeof e=="number"?[e,e,e]:e,ir=(e,t)=>t<=1?e:e+(e-1)*(t-1),Kd=(e,t,r,n=1)=>{let o=ir(t,n);return Math.floor((e[0]*(r-1)-r+o)/2)},Qi=(e,t,r,n,o)=>{o==null&&(o=Kd(e,t[0],n[0]));let s=[0,0,0,r];for(let i=0;i<3;i++)e[i]+2*o>=t[i]&&(s[i]=Math.trunc((e[i]-t[i]+2*o)/n[i]+1));return s},jd=(e,t,r,n,o,s,i,a,u,d)=>{let l,c,p,h;if(e==="VALID"&&(e=0),typeof e=="number"){l={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=Qi([t,r,n,1],[a,u,d],1,[o,s,i],e);c=m[0],p=m[1],h=m[2]}else if(Array.isArray(e)){if(!e.every((f,b,y)=>f===y[0]))throw Error(`Unsupported padding parameter: ${e}`);l={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=Qi([t,r,n,1],[a,u,d],1,[o,s,i],e[0]);c=m[0],p=m[1],h=m[2]}else if(e==="SAME_UPPER"){c=Math.ceil(t/o),p=Math.ceil(r/s),h=Math.ceil(n/i);let m=(c-1)*o+a-t,f=(p-1)*s+u-r,b=(h-1)*i+d-n,y=Math.floor(m/2),g=m-y,w=Math.floor(f/2),_=f-w,$=Math.floor(b/2),v=b-$;l={top:w,bottom:_,left:$,right:v,front:y,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:l,outDepth:c,outHeight:p,outWidth:h}},Yi=(e,t,r,n,o,s=!1,i="channelsLast")=>{let a,u,d,l,c;if(i==="channelsLast")[a,u,d,l,c]=e;else if(i==="channelsFirst")[a,c,u,d,l]=e;else throw new Error(`Unknown dataFormat ${i}`);let[p,,h,m,f]=t,[b,y,g]=Xi(r),[w,_,$]=Xi(n),v=ir(h,w),I=ir(m,_),T=ir(f,$),{padInfo:k,outDepth:B,outHeight:D,outWidth:G}=jd(o,u,d,l,b,y,g,v,I,T),z=s?p*c:p,N=[0,0,0,0,0];return i==="channelsFirst"?N=[a,z,B,D,G]:i==="channelsLast"&&(N=[a,B,D,G,z]),{batchSize:a,dataFormat:i,inDepth:u,inHeight:d,inWidth:l,inChannels:c,outDepth:B,outHeight:D,outWidth:G,outChannels:z,padInfo:k,strideDepth:b,strideHeight:y,strideWidth:g,filterDepth:h,filterHeight:m,filterWidth:f,effectiveFilterDepth:v,effectiveFilterHeight:I,effectiveFilterWidth:T,dilationDepth:w,dilationHeight:_,dilationWidth:$,inShape:e,outShape:N,filterShape:t}},Ji=(e,t,r,n,o,s)=>{let i=s==="channelsLast",a=i?e[0].dims[3]:e[0].dims[1],u=!1,d=[64,1,1],l={x:r.map((g,w)=>w)},c=[Math.ceil(Fd(l.x.map(g=>r[g]))/d[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${c}`);let p=u?i&&a%4!==0?3:4:1,h=x.size(r),m=[{type:12,data:h},{type:12,data:n},{type:12,data:o},{type:12,data:t.strides},{type:12,data:t.dilations}];$e(t,m),m.push(...E(e[0].dims,e[1].dims));let f=["rank","rank"],b=e.length===3;b&&(m.push(...E(e[2].dims)),f.push("rank")),m.push(...E(r));let y=g=>{let w=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:n.length},{name:"pads",type:"u32",length:o.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];ve(t,w);let _=u?4:1,$=Y(e[0].dataType),v=S("x",e[0].dataType,e[0].dims.length,p===3?1:p),I=S("W",e[1].dataType,e[1].dims.length,_),T=[v,I],k=C("result",e[0].dataType,r.length,_),B="";if(b){let z=S("bias",e[2].dataType,e[2].dims.length,_);T.push(z),B+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${$}>`:$} {
          return bias[${i?O("coords",4,5):O("coords",1,5)}${u?"/ 4":""}];
        }`}let D=me(p,$),G=_e(t,D,$);return`
            ${B}
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${c}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},rs=(e,t,r,n)=>{let o=e.length>2,s=ee(r[3]),i=ee(r[2]),a=x.size(r)/s/i,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],l=[r[0],r[1],r[2],r[3]/s],c=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];$e(t,c),c.push(...E(u,d,l));let p=(i-1)*t.strides[1]+d[1],h=m=>{let f=C("output",e[0].dataType,l.length,s),b=Y(f.type.tensor),y=_e(t,f.type.value,b),g=S("x",e[0].dataType,u.length,s),w=S("w",e[1].dataType,d.length,s),_=[g,w];o&&_.push(S("b",e[2].dataType,e[2].dims,s));let $=o?"value += b[output_channel];":"",v=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return ve(t,v),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${s};${i};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:h}}});var Zd,Kr,Xd,jr,Zr,os,Qd,Yd,Xr,is=A(()=>{"use strict";H();Zi();es();bt();ns();De();or();Oe();Zd=(e,t,r,n,o,s)=>{let i=e[0],a=e.slice(s?1:2,s?3:4),u=a.length,d=t[0],c=t.slice(2).map((m,f)=>m+(m-1)*(r[f]-1)),h=a.map((m,f)=>m+n[f]+n[f+u]).map((m,f)=>Math.floor((m-c[f]+o[f])/o[f]));return h.splice(0,0,i),h.splice(s?3:1,0,d),h},Kr=[2,3,1,0],Xd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[1]*t.group;if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},jr=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let n=e.pads.slice();Ke.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,n,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:r,pads:n}),o},Zr=e=>{let t=er(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,s=e.group,i=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:n,format:r,dilations:o,group:s,kernelShape:i,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},os=(e,t,r,n)=>{let o=r.format==="NHWC",s=Zd(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,o);if(r.group!==1){let v=[t[0]];if(o){let T=e.kernelCustomData.wT??e.compute(ce(t[1],Kr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T),v.push(T)}else v.push(t[1]);t.length===3&&v.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(rs(v,r,s,n),{inputs:v}):e.compute(ts(v,r,s,n),{inputs:v});return}let i=t.length===3,a=t[0].dims[o?1:2],u=t[0].dims[o?2:3],d=t[0].dims[o?3:1],l=t[1].dims[2],c=t[1].dims[3],p=s[o?1:2],h=s[o?2:3],m=s[o?3:1],f=o&&l===a&&c===u&&r.pads[0]===0&&r.pads[1]===0;if(f||l===1&&c===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let v=s[0],I,T,k,B=[];if(o){let z=e.kernelCustomData.wT??e.compute(ce(t[1],Kr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=z),f){let N=a*u*d;I=t[0].reshape([1,v,N]),T=z.reshape([1,N,m]),k=[1,v,m]}else I=t[0].reshape([v,a*u,d]),T=z.reshape([1,d,m]),k=[v,p*h,m];B.push(I),B.push(T)}else I=t[0].reshape([v,d,a*u]),T=t[1].reshape([1,m,d]),k=[v,m,p*h],B.push(T),B.push(I);i&&B.push(t[2]);let D=k[2],G=B[0].dims[B[0].dims.length-1];D<8&&G<8?e.compute(nr(B,r,s,k,o,n),{inputs:B}):e.compute(yt(B,r,s,k,o,n),{inputs:B});return}let b=!0,y=e.kernelCustomData.wT??e.compute(ce(t[1],Kr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=y);let g=[t[0],y];i&&g.push(t[2]);let w=o?p*h:m,_=o?m:p*h,$=l*c*d;e.compute(ji(g,r,s,w,_,$,i,b,n),{inputs:g})},Qd=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),i=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=jr({...t,pads:o,strides:s,dilations:i,kernelShape:a},n);os(e,n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Yd=(e,t,r)=>{let n=r.format==="NHWC"?"channelsLast":"channelsFirst",o=jr(r,t),s=r.autoPad==="NOTSET"?r.pads:r.autoPad,i=Yi(t[0].dims,t[1].dims,r.strides,r.dilations,s,!1,n);e.compute(Ji(t,o,i.outShape,[i.filterDepth,i.filterHeight,i.filterWidth],[i.padInfo.front,i.padInfo.top,i.padInfo.left],n))},Xr=(e,t)=>{if(Xd(e.inputs,t),e.inputs[0].dims.length===3)Qd(e,t);else if(e.inputs[0].dims.length===5)Yd(e,e.inputs,t);else{let r=jr(t,e.inputs);os(e,e.inputs,r)}}});var Jd,ss,as=A(()=>{"use strict";V();Te();F();De();mt();Fr();bt();Jd=(e,t=!1,r,n,o=4)=>{let s=y=>{switch(y){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${o}] = value;
        ...
        ${K}
        ${Jd(u,i,t,N.type.value,_)}
        ${m?ht(g,y,re,void 0,!u,$):gt(g,y,re,void 0,!u,$,!1,void 0,a)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${g};${y};${m}`,inputDependencies:D},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:w[0],y:w[1],z:w[2]},programUniforms:B}),getShaderSource:G}}});var el,Qr,us=A(()=>{"use strict";V();Te();H();F();el=(e,t,r,n,o,s=!1,i,a,u=!1)=>{let d=u?1:2,l=u?2:3,c=u?3:1,p=s?2:1,h=`
  ...
  ${s?w:_}}`},Qr=(e,t,r)=>{let n=e.length>2,o=t.outputShape,s=x.size(o),i=[Math.ceil(s/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${i}`);let a=t.format==="NHWC",u=["rank","rank"],d=[t.strides[0],t.strides[1]],l=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],c=[t.dilations[0],t.dilations[1]],p=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],h=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,f=t.group,b=e[1].dims,y=b[0]/f,g=b[1],w=[{type:12,data:s},{type:12,data:d},{type:12,data:l},{type:12,data:c},{type:12,data:p},{type:6,data:h},{type:12,data:y},{type:12,data:g},...E(e[0].dims,e[1].dims)];n&&(w.push(...E(e[2].dims)),u.push("rank")),w.push(...E(o));let _=i[1]===1&&i[2]===1,$=v=>{let I=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:d.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:h.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],T=Y(e[0].dataType);return`${el(v,e,o,n,_,m,T,I,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:i[0],y:i[1],z:i[2]},outputs:[{dims:r?r(o):o,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:$}}});var tl,rl,nl,ds,ls,ol,il,sl,al,cs,ps=A(()=>{"use strict";as();us();De();Oe();tl=(e,t,r,n,o,s)=>(e-1)*t+r+(n-1)*o+1-s,rl=(e,t,r,n,o)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=s,r[o]=e-s):t==="SAME_LOWER"&&(r[n]=e-s,r[o]=s)},nl=(e,t,r,n,o,s,i,a,u,d)=>{let l=e.length-2,c=d.length===0;u.length<l&&u.push(...Array(l-u.length).fill(0));let p=e[0],h=t[a?3:1]*o;for(let m=0,f=e.length-l-(a?1:0);m<l;++m,++f){let b=e[f],y=c?b*i[m]:d[m],g=tl(b,i[m],s[m],t[f],r[m],y);rl(g,n,s,m,m+l),c&&d.push(i[m]*(b-1)+u[m]+(t[f]-1)*r[m]+1-s[m]-s[m+l])}d.splice(0,0,p),d.splice(a?3:1,0,h)},ds=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){r.length=0;for(let c=2;c<t[1].dims.length;++c)r.push(t[1].dims[c])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let o=e.pads.slice(),s=e.outputShape.slice(),i=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let d=e.strides.slice();if(d.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;d=new Array(c).fill(1)}nl(a,r,u,e.autoPad,e.group,o,d,n,i,s);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:o,outputPadding:i,outputShape:s,dilations:u,strides:d}),l},ls=e=>{let t=er(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,s=e.group,i=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),l=e.outputPadding,c=e.outputShape;return{autoPad:n,format:r,dilations:o,group:s,kernelShape:i,outputPadding:l,outputShape:c,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},ol=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((l,c)=>l+c,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((l,c)=>l+c,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((l,c)=>l+c,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((l,c)=>l+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},il=[2,3,1,0],sl=(e,t,r)=>{let n=ds(r,t),o=r.format==="NHWC",s=n.outputShape,i=s[o?3:1],a=t[0].dims[o?3:1];if(n.group!==1||i===1&&a===1){e.compute(Qr(t,n));return}let u=s[o?1:2],d=s[o?2:3],l=t[1].dims[2],c=t[1].dims[3],p=o?u*d:i,h=o?i:u*d,m=l*c*a,f=!0,b=e.kernelCustomData.wT??e.compute(ce(t[1],il),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let y=[t[0],b],g=t.length===3;g&&(!o&&t[2].dims.length===1?y.push(t[2].reshape([t[2].dims[0],1,1])):y.push(t[2])),e.compute(ss(y,n,s,p,h,m,g,f),{inputs:y})},al=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let i=t.strides;(i.length===0||i[0]===0)&&(i=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],i=[1].concat(i),s=[1].concat(s),o=[1].concat(o);let u=ds({...t,pads:a,strides:i,dilations:s,kernelShape:o},n);e.compute(Qr(n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]]))},cs=(e,t)=>{ol(e.inputs,t),e.inputs[0].dims.length===3?al(e,t):sl(e,e.inputs,t)}});var ul,ms,fs,hs=A(()=>{"use strict";V();H();ie();F();ul=(e,t,r,n)=>{let o=x.size(t),s=t.length,i=S("input",e,s),a=C("output",e,s),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=x.normalizeAxis(u,s),l=c=>{let p=` i32(${i.indicesGet("inputIndices","uniforms.axis")}) `,h=O("uniforms.input_shape","uniforms.axis",s),m=n.reverse?p+(n.exclusive?" + 1":""):"0",f=n.reverse?h:p+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...E(t,t)]}),getShaderSource:l}},ms=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,o=e.inputs[1];e.compute(ul(n,r,o,t),{inputs:[0]})},fs=e=>{let t=e.exclusive===1,r=e.reverse===1;return U({exclusive:t,reverse:r})}});var dl,ll,cl,gs,ys,bs=A(()=>{"use strict";V();H();ie();F();dl=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},ll=(e,t,r,n)=>{let o=[];o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)o.push(r.indicesSet("a",e[s],`i[${s}]`));return o.push("return a;}"),o.join(`
`)},cl=(e,t)=>{let r,n,o,s,i,a,u=t.format==="NHWC",d=t.blocksize,l=t.mode==="DCR";u?([r,n,o,s]=e.dims,i=l?[r,n,o,d,d,s/d**2]:[r,n,o,s/d**2,d,d],a=l?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,o,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],i=l?[r,d,d,s/d**2,n,o]:[r,s/d**2,d,d,n,o],a=l?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(i),p=c.dims.length,h=e.dataType,m=S("a",h,p),f=C("output",h,p),b=y=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:y=>{let g=u?[r,n*d,o*d,s/d**2]:[r,s/d**2,n*d,o*d],w=x.size(g),_=c.dims,$=x.sortBasedOnPerm(_,a);return{outputs:[{dims:g,dataType:y[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...E(_,$)]}},getShaderSource:b}},gs=(e,t)=>{dl(e.inputs),e.compute(cl(e.inputs[0],t))},ys=e=>U({blocksize:e.blocksize,mode:e.mode,format:e.format})});var Yr,sr,ws,pl,ml,Jr,en,_s,fl,$s,vs,xs=A(()=>{"use strict";V();H();ie();F();Yr="[a-zA-Z]|\\.\\.\\.",sr="("+Yr+")+",ws="^"+sr+"$",pl="("+sr+",)*"+sr,ml="^"+pl+"$",Jr=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},en=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,o]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(ml)))throw new Error("Invalid LHS term");if(n.split(",").forEach((a,u)=>{let d=t[u].dims.slice();if(!a.match(RegExp(ws)))throw new Error("Invalid LHS term");let l=this.processTerm(a,!0,d,u);this.lhs.push(l)}),o==="")o+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!o.match(RegExp(sr)))throw new Error("Invalid RHS");o.match(RegExp(Yr,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(o,!1,this.outputDims)}addSymbol(t,r,n){let o=this.symbolToInfo.get(t);if(o!==void 0){if(o.dimValue!==r&&o.count!==1)throw new Error("Dimension mismatch");o.count++,o.inputIndices.push(n)}else o={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,o)}processTerm(t,r,n,o=-1){let s=n.length,i=!1,a=[],u=0;if(!t.match(RegExp(ws))&&!r&&t!=="")throw new Error("Invalid LHS term");let d=t.match(RegExp(Yr,"g")),l=new Jr(o);return d?.forEach((c,p)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=s-d.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=n.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let f=String.fromCharCode("0".charCodeAt(0)+m);l.addSymbol(f,p+m),this.addSymbol(f,n[u++],o)}}else l.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,n[u++],o)}),l}},_s=e=>e+"_max",fl=(e,t,r,n)=>{let s=e.map(l=>l.length).map((l,c)=>S(`input${c}`,t,l)),i=x.size(n),a=C("output",t,n.length),u=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),d=l=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",f=[],b=[],y=[],g=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach(($,v)=>{if(r.rhs.symbolToIndices.has(v)){let I=r.rhs.symbolToIndices.get(v)?.[0];I!==void 0&&r.lhs.forEach((T,k)=>{if($.inputIndices.includes(k)){let B=T.symbolToIndices.get(v);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(D=>{c.push(`${s[k].indicesSet(`input${k}Indices`,D,a.indicesGet("outputIndices",I))}`)})}})}else r.lhs.forEach((I,T)=>{if($.inputIndices.includes(T)){let k=I.symbolToIndices.get(v);if(k===void 0)throw new Error("Invalid symbol error");k.forEach(B=>{f.push(`${s[T].indicesSet(`input${T}Indices`,B,`${v}`)}`)}),g.push(`prod *= ${s[T].getByIndices(`input${T}Indices`)};`)}}),b.push(`for(var ${v}: u32 = 0; ${v} < uniforms.${_s(v)}; ${v}++) {`),y.push("}")});let _=w?[...c,`let sum = ${s.map(($,v)=>$.getByIndices(`input${v}Indices`)).join(" * ")};`]:[...c,h,...b,...f,p,...g,m,...y];return`
            ${l.registerUniforms(u.map($=>({name:`${_s($)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...s,a)}
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=u.filter(p=>r.symbolToInfo.has(p)).map(p=>({type:12,data:r.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:i});let c=e.map((p,h)=>[...E(p)]).reduce((p,h)=>p.concat(h),l);return c.push(...E(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}},getShaderSource:d}},$s=(e,t)=>{let r=new en(e.inputs,t.equation),n=r.outputDims,o=e.inputs.map((s,i)=>s.dims);e.compute(fl(o,e.inputs[0].dataType,r,n))},vs=e=>{let t=e.equation.replace(/\s+/g,"");return U({equation:t})}});var hl,Ss,gl,yl,Is,Ts=A(()=>{"use strict";V();H();F();hl=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,o=t.length<r.length?0:t.length-r.length;for(;n<r.length&&o<t.length;++n,++o)if(r[n]!==t[o]&&r[n]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Ss=(e,t)=>{let r=e.length-t.length,n=[];for(let o=0;o<r;++o)n.push(e[o]);for(let o=0;o<t.length;++o)n.push(t[o]===1?e[o+r]:t[o]);return n},gl=(e,t)=>e.length>t.length?Ss(e,t):Ss(t,e),yl=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=gl(t,r),o=e[0].dataType,s=o===9?4:1,i=Math.ceil(x.size(n)/s),a=d=>{let l=S("input",o,t.length,s),c=C("output",o,n.length,s),p;if(o===9){let h=(m,f,b="")=>`
    ...
    ${p}`},u=[{type:12,data:i},...E(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u})}},Is=e=>{hl(e.inputs),e.compute(yl(e.inputs),{inputs:[0]})}});var bl,Cs,As=A(()=>{"use strict";V();H();F();Jt();bl=e=>{let t=e[0].dataType,r=x.size(e[0].dims),n=x.size(e[1].dims),o=n%4===0,s=i=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=h=>`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,f)=>f!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,f)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:d}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},zs=(e,t)=>{let r=e.inputs;$l(r,t),e.compute(vl(e.inputs,t))},Bs=e=>U({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var xl,Sl,Ds,Ms,Rs=A(()=>{"use strict";V();H();ie();F();xl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},Sl=(e,t)=>{let r=e[0].dims,n=e[0].dataType,o=r.length,s=e[1].dims,i=e[1].dataType,a=x.normalizeAxis(t.axis,o),u=r[a],d=s.slice(0),l=x.size(d),c=S("input",n,o),p=S("indicesInput",i,s.length),h=C("output",n,d.length),m=[{type:12,data:l},{type:6,data:u},{type:12,data:a}];return m.push(...E(r,s,d)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:m}),getShaderSource:y=>`
  ...
  }`};return c?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:d*l},programUniforms:h}),getShaderSource:b}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Vs=e=>{let t=e.transA,r=e.transB,n=e.alpha,o=e.beta;return{transA:t,transB:r,alpha:n,beta:o,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Us=(e,t)=>{Il(e.inputs),e.compute(Tl(e.inputs,t))}});var Me,We,Je,et,Cl,Al,kl,El,Pl,zl,Bl,Ol,Ws,Ls,Gs=A(()=>{"use strict";V();H();ie();F();[Me,We,Je,et]=[0,1,2,3],Cl=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Al=`
...
`,zl=(e,t,r)=>`
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${t} {
     ...
     indices[${Me}] = batch;
     indices[${We}] = channel;`+(()=>{switch(r.paddingMode){case"zeros":return`
          if (r >= 0 && r < H && c >=0 && c < W) {
            indices[${Je}] = u32(r);
            indices[${et}] = u32(c);
          }
...
`,Bl=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${Me}], indices[${We}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${Me}], indices[${We}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${Me}], indices[${We}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${Me}], indices[${We}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${Me}], indices[${We}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${Me}], indices[${We}], border);
            }
          }
        ...
        `;default:throw new Error(`mode ${r.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,Ol=(e,t)=>{let r=S("x",e[0].dataType,e[0].dims.length),n=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],o=S("grid",e[1].dataType,n.length,2),s=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(s=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[Me,We,Je,et]=[0,3,1,2]);let i=C("output",e[0].dataType,s.length),a=r.type.value,u=x.size(s),d=[{type:12,data:u},...E(e[0].dims,n,s)],l=c=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:l},{inputs:[t,r],outputs:[-1]})[0]},wt=(e,t,r,n,o,s,i,a)=>{let u=s;if(i&&x.size(i.dims)>0){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Vl(e,s,i,t,n,r*o,a),u=u.reshape([t,n,r,o]),r===1||n===1?u:e.compute(ce(u,Hs.perm),{inputs:[u],outputs:[-1]})[0]}else return s.dims.length===3&&(u=s.reshape([t,n,r,o])),r===1||n===1?u:e.compute(ce(u,Hs.perm),{inputs:[u],outputs:[-1]})[0]},Fs=(e,t)=>{let r=Rl(e.inputs,t),n=e.inputs[0],o=be(e.inputs,1),s=be(e.inputs,2),i=be(e.inputs,3),a=be(e.inputs,4),u=be(e.inputs,5),d=be(e.inputs,6),l=be(e.inputs,7);if(n.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let c=o&&s&&o.dims.length===4&&s.dims.length===4,p=wt(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,n,i,0);if(c)return Ye(e,p,o,s,a,void 0,d,l,u,r);if(!o||!s)throw new Error("key and value must be provided");let h=wt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,o,i,r.hiddenSize),m=wt(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,i,2*r.hiddenSize);Ye(e,p,h,m,a,void 0,d,l,u,r)}});var Ul,Nl,Wl,Ll,rn,Ks,js,nn=A(()=>{"use strict";V();H();ie();F();Ul=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Nl=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),n=r.length),U({numOutputs:n,axis:t.axis,splitSizes:r})},Wl=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,Ll=e=>{let t=e.length,r=[];for(let n=0;n<t;++n){let o=e[n].setByIndices("indices","input[global_idx]");t===1?r.push(o):n===0?r.push(`if (output_number == ${n}u) { ${o} }`):n===t-1?r.push(`else { ${o} }`):r.push(`else if (output_number == ${n}) { ${o} }`)}return`
...
`)}
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${a};${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:b}),getShaderSource:y},{inputs:[t,r,n],outputs:[-1]})[0]},ql=(e,t,r)=>{let n=t[0].dims,o=n,s=2,i=n[0],a=n[1],u=x.sizeFromDimension(n,s),d=ee(u),l=x.size(o)/d,c=Ys(e,t[0],t[1],t[2],i,u,a,r.epsilon),p=[i,a,u/d],h=[i,a],m=["type","none"],f=b=>{let y=S("x",t[0].dataType,p.length,d),g=S("scale_shift",1,h.length,2),w=C("output",t[0].dataType,p.length,d),_=[y,g,w];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:l}),getShaderSource:b},{inputs:[t[0],f]})},Js=(e,t)=>{t.format==="NHWC"?Fl(e,e.inputs,t):ql(e,e.inputs,t)}});var Kl,jl,ta,ra=A(()=>{"use strict";V();H();F();Kl=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},jl=(e,t,r)=>{let n=t.simplified,o=e[0].dims,s=e[1],i=!n&&e[2],a=o,u=x.normalizeAxis(t.axis,o.length),d=x.sizeToDimension(o,u),l=x.sizeFromDimension(o,u),c=x.size(s.dims),p=i?x.size(i.dims):0;if(c!==l||i&&p!==l)throw new Error(`Size of X.shape()[axis:] == ${l}.
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},_=[{dims:a,dataType:e[0].dataType}];return y&&_.push({dims:h,dataType:1}),g&&_.push({dims:h,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${r};${n}`,inputDependencies:f},getRunData:()=>({outputs:_,dispatchGroup:{x:Math.ceil(d/64)},programUniforms:b}),getShaderSource:w}},ta=(e,t)=>{Kl(e.inputs),e.compute(jl(e.inputs,t,e.outputCount))}});var Zl,na,oa=A(()=>{"use strict";H();or();bt();Zl=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},na=e=>{Zl(e.inputs);let t=Ae.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];if(r<8&&n<8)e.compute(nr(e.inputs,{activation:""},t));else{let o=t[t.length-2],s=x.size(e.inputs[0].dims.slice(0,-2)),i=x.size(e.inputs[1].dims.slice(0,-2));if(s!==1&&o===1&&i===1){let a=e.inputs[0].reshape([1,s,n]),u=e.inputs[1].reshape([1,n,r]),d=[1,s,r],l=[a,u];e.compute(yt(l,{activation:""},t,d),{inputs:l})}else e.compute(yt(e.inputs,{activation:""},t))}}});var Xl,Ql,Yl,ia,sa,aa=A(()=>{"use strict";V();H();ie();F();Xl=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let r=e[0],n=r.dims.length;if(r.dims[n-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let o=Math.floor((t.k+t.blockSize-1)/t.blockSize),s=t.blockSize/8*t.bits,i=e[1];if(!x.areEqual(i.dims,[t.n,o,s]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(x.size(u)!==t.n*o)throw new Error("scales input size error.");if(e.length===4){let l=e[3].dims,c=t.bits>4?t.n*o:t.n*Math.floor((o+1)/2);if(x.size(l)!==c)throw new Error("zeroPoints input size error.")}},Ql=(e,t)=>{let r=e[0].dims,n=r.length,o=r[n-2],s=t.k,i=t.n,a=r.slice(0,n-2),u=x.size(a),l=e[1].dims[2]/4,c=e[0].dataType,p=ee(t.k),h=ee(l),m=ee(i),f=a.concat([o,i]),b=o>1&&i/m%2===0?2:1,y=x.size(f)/m/b,g=64,w=[],_=[u,o,s/p],$=x.convertShape(e[1].dims).slice();$.splice(-1,1,l/h),w.push(...E(_)),w.push(...E($)),w.push(...E(e[2].dims)),e.length===4&&w.push(...E(x.convertShape(e[3].dims)));let v=[u,o,i/m];w.push(...E(v));let I=T=>{let k=_.length,B=S("a",e[0].dataType,k,p),D=S("b",12,$.length,h),G=S("scales",e[2].dataType,e[2].dims.length),z=[B,D,G],N=e.length===4?S("zero_points",12,e[3].dims.length):void 0;N&&z.push(N);let ne=v.length,R=C("output",e[0].dataType,ne,m),W=Y(e[0].dataType),K=(()=>{switch(p){case 1:return`array<${W}, 8>`;case 2:return`mat4x2<${W}>`;case 4:return`mat2x4<${W}>`;default:throw new Error(`${p}-component is not supported.`)}})(),L=()=>{let ae=`
          // reuse a data
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:c}],dispatchGroup:{x:$},programUniforms:v}),getShaderSource:B}},ia=(e,t)=>{Xl(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Yl(e.inputs,t)):e.compute(Ql(e.inputs,t))},sa=e=>U(e)});var Jl,ec,tc,rc,nc,oc,ic,sc,ua,da=A(()=>{"use strict";V();H();F();Jl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},ec=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
      ...
      `},tc=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
                k = i32(${e.indicesGet("indices",o)}) - ${O("uniforms.pads",o,r)};
                if (k < 0) {
                  k = -k;
                }
          ...
          `},nc=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
            ...
            `;return`
              ...
              ${n}
              value = x[offset];
          `},oc=(e,t,r)=>{switch(r.mode){case 0:return ec(e,t,r.pads.length);case 1:return tc(e,t,r.pads.length);case 2:return rc(e,t,r.pads.length);case 3:return nc(e,t,r.pads.length);default:throw new Error("Invalid mode")}},ic=(e,t)=>{let r=x.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,o=x.size(r),s=[{type:12,data:o},{type:6,data:t.pads}],i=e.length>=3&&e[2].data;t.mode===0&&s.push({type:i?e[2].dataType:1,data:t.value}),s.push(...E(e[0].dims,r));let a=["rank"],u=d=>{let l=C("output",e[0].dataType,r.length),c=S("x",e[0].dataType,n.length),p=c.type.value,h=oc(l,n.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:i?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},ma=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,ac=e=>`${ma(e)};${e.countIncludePad}`,uc=e=>`${ma(e)};${e.storageOrder};${e.dilations}`,fa=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),ha=(e,t,r,n)=>{let[o,s]=la(t,n,r),i=S("x",t.dataType,t.dims.length),a=i.type.value,u="value += x_val;",d="";o.countIncludePad?d+=`value /= ${a}(uniforms.kernelSize);`:d+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[l,c,p,h,m]=ca(s,o);l.push(...E(t.dims,s));let f=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${p};${h};${m}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:l}),getShaderSource:b=>pa(b,i,t.dims.length,s.length,o,u,d,0,c,p,h,m)}},ga=e=>{let t=e.count_include_pad!==0,r=fa(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:ac(n)}},ya=(e,t)=>{ar(e.inputs),e.compute(ha("AveragePool",e.inputs[0],!1,t))},ba={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},wa=e=>{let t=e.format;return{format:t,...ba,cacheKey:t}},_a=(e,t)=>{ar(e.inputs),e.compute(ha("GlobalAveragePool",e.inputs[0],!0,t))},$a=(e,t,r,n)=>{let[o,s]=la(t,n,r),i=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[l,c,p,h,m]=ca(s,o);return l.push(...E(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${p};${h};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:l}),getShaderSource:f=>pa(f,u,t.dims.length,s.length,o,i,a,t.dataType===10?-65504:-1e5,c,p,h,m)}},va=(e,t)=>{ar(e.inputs),e.compute($a("MaxPool",e.inputs[0],!1,t))},xa=e=>{let t=e.storage_order,r=e.dilations,n=fa(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:r,...n,cacheKey:""};return{...o,cacheKey:uc(o)}},Sa=e=>{let t=e.format;return{format:t,...ba,cacheKey:t}},Ia=(e,t)=>{ar(e.inputs),e.compute($a("GlobalMaxPool",e.inputs[0],!0,t))}});var lc,cc,Ca,Aa,ka=A(()=>{"use strict";V();H();ie();F();lc=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,n)=>r===e[2].dims[n]).reduce((r,n)=>r&&n,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,s)=>s===t.axis||o===e[0].dims[s]).reduce((o,s)=>o&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],n=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/n)||t.blockSize>Math.ceil(r/(n-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},cc=(e,t)=>{let r=x.normalizeAxis(t.axis,e[0].dims.length),n=e[0].dataType,o=n===3,s=e[0].dims,i=e[1].dataType,a=x.size(s),u=n===3||n===2,d=u?[Math.ceil(x.size(e[0].dims)/4)]:e[0].dims,l=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil(x.size(c.dims)/4)]:c.dims:void 0,h=l.length===0||l.length===1&&l[0]===1,m=h===!1&&l.length===1,f=ee(a),b=h&&(!u||f===4),y=b?f:1,g=b&&!u?f:1,w=S("input",u?12:n,d.length,g),_=S("scale",i,l.length),$=c?S("zero_point",u?12:n,p.length):void 0,v=C("output",i,s.length,y),I=[w,_];$&&I.push($);let T=[d,l];c&&T.push(p);let k=[{type:12,data:a/y},{type:12,data:r},{type:12,data:t.blockSize},...E(...T,s)],B=D=>{let G=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/y/64),y:1,z:1},programUniforms:k})}},Ca=(e,t)=>{lc(e.inputs,t),e.compute(cc(e.inputs,t))},Aa=e=>U({axis:e.axis,blockSize:e.blockSize})});var pc,mc,Ea,Pa=A(()=>{"use strict";xe();V();F();pc=(e,t,r)=>{let n=e===t,o=e<t&&r<0,s=e>t&&r>0;if(n||o||s)throw new Error("Range these inputs' contents are invalid.")},mc=(e,t,r,n)=>{let o=Math.abs(Math.ceil((t-e)/r)),s=[o],i=o,a=[{type:12,data:i},{type:n,data:e},{type:n,data:r},...E(s)],u=d=>{let l=C("output",n,s.length),c=l.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${d.registerUniforms(p).declareVariables(l)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:a})}},Ea=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),Q.webgpu.validateInputContent&&pc(t,r,n),e.compute(mc(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var fc,hc,gc,yc,bc,wc,_c,$c,vc,xc,Sc,za,Ic,Tc,Cc,Ac,kc,Ba,Oa,Da=A(()=>{"use strict";V();H();ie();F();fc=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},hc=(e,t,r)=>{t.every(o=>o>=0&&o<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let n=new Array(r).fill(1);return t.forEach((o,s)=>n[o]=e[s]),n},gc=(e,t,r,n,o,s)=>{let[i,a,u]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(i>0&&e.length>i&&e[i].dims.length>0)e[i].getFloat32Array().forEach(l=>s.push(l));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(a>0&&e.length>a&&e[a].dims.length===1&&e[a].dims[0]>0){if(e[a].getFloat32Array().forEach(l=>n.push(l)),n.length!==0&&n.length!==d&&r>=18&&n.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");fc(n,t),t.axes.length>0&&hc(n,t.axes,d).forEach((l,c)=>n[c]=l)}if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0&&(e[u].getBigInt64Array().forEach(l=>o.push(Number(l))),o.length!==0&&o.length!==d&&r>=18&&o.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(o.length!==0&&o.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof n<"u"&&typeof o<"u"&&n.length>0&&o.length>d)throw new Error("Resize requires only of scales or sizes to be specified")},yc=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`return ${t}(xResized) / ${t}(xScale);`;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",bc=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",wc=(e,t,r)=>{let n=new Array(r).fill(0).concat(new Array(r).fill(1)),o=e.length===0?n:e.slice();return t.length>0?(t.forEach((s,i)=>{n[s]=o[i],n[i+r]=o[t.length+i]}),n):o},_c=(e,t,r,n)=>{let o=[];if(r.length>0)if(n.length>0){if(e.forEach(s=>o.push(s)),Math.max(...n)>e.length)throw new Error("axes is out of bound");n.forEach((s,i)=>o[s]=r[i])}else r.forEach(s=>o.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");o=e.map((s,i)=>Math.round(s*t[i]))}return o},$c=(e,t,r)=>{let n=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(s=>t[s]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(s=>t[s]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let o=e.slice();return r.axes.length>0?(r.axes.forEach(s=>t[s]=n),r.axes.forEach(s=>o[s]=Math.round(e[s]*t[s]))):(t.fill(n,0,t.length),o.forEach((s,i)=>o[i]=Math.round(s*t[i]))),o},vc=(e,t,r,n,o)=>`
...
`:"",Ic=(e,t,r,n,o)=>{let[i,a,u,d]=r.length===2?[-1,0,1,-1]:[0,2,3,1],l=e.type.value;return`
    ...
    }`},Tc=(e,t,r,n,o,s,i,a,u,d)=>{let l=r.length===2,c=!0,[p,h]=l?[0,1]:c?[2,3]:[1,2],m=e.type.value,f=b=>{let y=b===p?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    `},Cc=(e,t,r,n,o)=>{let[i,a,u,d,l]=r.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],c=e.type.value;return`
    ...
    }`},Ac=(e,t,r,n,o,s)=>{let i=e.dims,a=wc(s,t.axes,i.length),u=_c(i,n,o,t.axes),d=n.slice();n.length===0&&(d=i.map((g,w)=>g===0?1:u[w]/g),t.keepAspectRatioPolicy!=="stretch"&&(u=$c(i,d,t)));let l=C("output",e.dataType,u.length),c=S("input",e.dataType,i.length),p=x.size(u),h=i.length===u.length&&i.every((g,w)=>g===u[w]),m=t.coordinateTransformMode==="tf_crop_and_resize",f=t.extrapolationValue,b=c.type.value,y=g=>`
      ${h?"":`
      ${yc(t.coordinateTransformMode,b)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Sc(c,i)};
              ${bc(t.nearestMode,r,b)};
              ${xc(c,l,i,u,d.length,a.length,m)};
              `;case"linear":return`
              ${vc(l,i,u,d.length,a.length)};
              ${(()=>{if(i.length===2||i.length===4)return`${Ic(c,l,i,m,f)}`;if(i.length===3||i.length===5)return`${Cc(c,l,i,m,f)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(i.length===2||i.length===4)return`${Tc(c,l,i,u,d,a,t.cubicCoeffA,m,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      }`;return{name:"Resize",shaderCache:{hint:`${t.cacheKey}|${r}|${d.length>0?d:""}|${o.length>0?o:""}|${a.length>0?a:""}|${h}|${i}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[{dims:u,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:[{type:12,data:p},{type:1,data:d},{type:1,data:a},...E(i,u)]})}},kc=e=>{let t=e.customDataBuffer;return new Uint32Array(t,t.byteOffset,1)[0]},Ba=(e,t)=>{let r=[],n=[],o=[],s=kc(e);if(t.antialias!==0)throw Error("Only default value (0) for Antialias attribute is supported");gc(e.inputs,t,s,r,n,o),e.compute(Ac(e.inputs[0],t,s,r,n,o),{inputs:[0]})},Oa=e=>{let t=e.antialias,r=e.axes,n=e.coordinateTransformMode,o=e.cubicCoeffA,s=e.excludeOutside!==0,i=e.extrapolationValue,a=e.keepAspectRatioPolicy,u=e.mode,d=e.nearestMode===""?"simple":e.nearestMode;return U({antialias:t,axes:r,coordinateTransformMode:n,cubicCoeffA:o,excludeOutside:s,extrapolationValue:i,keepAspectRatioPolicy:a,mode:u,nearestMode:d})}});var Ec,Pc,Ma,Ra=A(()=>{"use strict";V();H();ie();F();Ec=(e,t)=>{let[r,n,o,s]=e,{numHeads:i,rotaryEmbeddingDim:a}=t;if(r.dims.length!==3&&r.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${r.dims.length}`);if(!x.areEqual(n.dims,[])&&!x.areEqual(n.dims,[1])&&n.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${n.dims.length}`);if(o.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${o.dims.length}`);if(s.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${s.dims.length}`);if(!x.areEqual(o.dims,s.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(a>0&&i===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let u=r.dims[0],d=r.dims[r.dims.length-2],l=o.dims[0],c=x.sizeFromDimension(r.dims,1)/d,p=a===0?o.dims[1]*2:c/i;if(a>p)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(n.dims.length===2){if(u!==n.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${n.dims[0]}`);if(d!==n.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${n.dims[1]}`)}if(p/2!==o.dims[1]&&a/2!==o.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${o.dims[1]}`);if(d>l)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},Pc=(e,t)=>{let{interleaved:r,numHeads:n,rotaryEmbeddingDim:o,scale:s}=t,i=e[0].dims[0],a=x.sizeFromDimension(e[0].dims,1),u=e[0].dims[e[0].dims.length-2],d=a/u,l=e[2].dims[1],c=o===0?l*2:d/n,p=new Array(i,u,d/c,c-l),h=x.computeStrides(p),m=[{type:1,data:s},{type:12,data:p},{type:12,data:h},...e[0].dims.length===3?new Array({type:12,data:[a,d,c,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[a,c,u*c,1]}):[],...E(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],f=b=>{let y=S("input",e[0].dataType,e[0].dims.length),g=S("position_ids",e[1].dataType,e[1].dims.length),w=S("cos_cache",e[2].dataType,e[2].dims.length),_=S("sin_cache",e[3].dataType,e[3].dims.length),$=C("output",e[0].dataType,e[0].dims.length);return b.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:p.length},{name:"global_strides",type:"u32",length:h.length},{name:"input_output_strides",type:"u32",length:h.length}]),`
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:U({interleaved:r}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(x.size(p)/je)},programUniforms:m})}},Ma=(e,t)=>{Ec(e.inputs,t),e.compute(Pc(e.inputs,t))}});var zc,Bc,Va,Ua=A(()=>{"use strict";V();H();F();zc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],n=e[2];if(t.dataType!==r.dataType||t.dataType!==n.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(n.dims.length!==1)throw new Error("Gamma must be 1D");if(n.dims[n.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let i=e[3];if(i.dims.length!==1)throw new Error("Beta must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let i=e[4];if(i.dims.length!==1)throw new Error("Bias must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},Bc=(e,t,r,n)=>{let o=t.simplified,s=e[0].dims,i=x.size(s),a=s,u=i,d=s.slice(-1)[0],l=n?s.slice(0,-1).concat(1):[],c=!o&&e.length>3,p=e.length>4,h=n&&r>1,m=n&&r>2,f=r>3,b=64,y=ee(d),g=[{type:12,data:u},{type:12,data:y},{type:12,data:d},{type:1,data:t.epsilon}],w=$=>{let v=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],I=[S("x",e[0].dataType,e[0].dims,y),S("skip",e[1].dataType,e[1].dims,y),S("gamma",e[2].dataType,e[2].dims,y)];c&&I.push(S("beta",e[3].dataType,e[3].dims,y)),p&&I.push(S("bias",e[4].dataType,e[4].dims,y)),I.push(C("output",e[0].dataType,a,y)),h&&I.push(C("mean_output",1,l)),m&&I.push(C("inv_std_output",1,l)),f&&I.push(C("input_skip_bias_sum",e[0].dataType,a,y));let T=Y(e[0].dataType),k=Y(1,y);return`
      ...
      }`},_=[{dims:a,dataType:e[0].dataType}];return r>1&&_.push({dims:l,dataType:1}),r>2&&_.push({dims:l,dataType:1}),r>3&&_.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${h};${m};${f}`,inputDependencies:e.map(($,v)=>"type")},getShaderSource:w,getRunData:()=>({outputs:_,dispatchGroup:{x:Math.ceil(u/d)},programUniforms:g})}},Va=(e,t)=>{zc(e.inputs);let n=[0];e.outputCount>1&&n.push(-3),e.outputCount>2&&n.push(-3),e.outputCount>3&&n.push(3),e.compute(Bc(e.inputs,t,e.outputCount,!1),{outputs:n})}});var Oc,ur,Dc,Na,Mc,Rc,Wa,La,Ga=A(()=>{"use strict";V();H();ie();F();Oc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},ur=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Dc=(e,t)=>{if(e.length>1){let r=ur(e,1),n=ur(e,2),o=ur(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),U({starts:r,ends:n,axes:o})}else return t},Na=(e,t,r,n,o)=>{let s=e;return e<0&&(s+=r[n[t]]),o[t]<0?Math.max(0,Math.min(s,r[n[t]]-1)):Math.max(0,Math.min(s,r[n[t]]))},Mc=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${i.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:f})}},Wa=(e,t)=>{Oc(e.inputs,t);let r=Dc(e.inputs,t);e.compute(Rc(e.inputs,r),{inputs:[0]})},La=e=>{let t=e.starts,r=e.ends,n=e.axes;return U({starts:t,ends:r,axes:n})}});var Vc,Uc,Ha,qa,Fa=A(()=>{"use strict";V();H();ie();Oe();F();Vc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Uc=(e,t)=>{let r=e.inputs[0],n=r.dims,o=x.size(n),s=n.length,i=x.normalizeAxis(t.axis,s),a=i<n.length-1,u,d=[];a?(d=Array.from({length:s},(I,T)=>T),d[i]=s-1,d[s-1]=i,u=e.compute(ce(r,d),{inputs:[r],outputs:[-1]})[0]):u=r;let l=u.dims,c=l[s-1],p=o/c,h=ee(c),m=c/h,f=64;p===1&&(f=256);let b=(I,T)=>T===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:T===2?`max(${I}.x, ${I}.y)`:T===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,y=S("x",u.dataType,u.dims,h),g=C("result",u.dataType,u.dims,h),w=y.type.value,_=Y(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=I=>`
      ...
      ${u.setByOffset("global_idx",a.getByIndices("input_indices"))}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${d}
      }`},Hc=e=>{let t=e[1].dims,r=e[2].dims,n=e[0].dims,o=e[1].dataType,s=!(x.areEqual(t,r)&&x.areEqual(r,n)),i=t,a=x.size(t);if(s){let d=Ae.calcShape(Ae.calcShape(t,r,!1),n,!1);if(!d)throw new Error("Can't perform where op on the given tensors");i=d,a=x.size(i)}let u=Math.ceil(a/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:d=>Gc(d,e,i,s,o),getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:Math.ceil(a/64/4)},programUniforms:[{type:12,data:u},...E(n,t,r,i)]})}},Xa=e=>{e.compute(Hc(e.inputs))}});var Ya,Ja=A(()=>{"use strict";Lo();Qt();qo();Ko();zi();Gi();Fi();is();ps();hs();bs();xs();Ts();As();Ps();Os();Rs();Ns();Gs();Qs();ea();ra();oa();aa();tn();da();Ta();ka();Pa();Zt();Da();Ra();Ua();Ga();Fa();nn();Za();Oe();Jt();Qa();Ya=new Map([["Abs",[jo]],["Acos",[Zo]],["Acosh",[Xo]],["Add",[Bi]],["ArgMax",[Wo,Lr]],["ArgMin",[No,Lr]],["Asin",[Qo]],["Asinh",[Yo]],["Atan",[Jo]],["Atanh",[ei]],["Attention",[Go]],["AveragePool",[ya,ga]],["BatchNormalization",[Ho]],["BiasAdd",[Fo]],["BiasSplitGelu",[Pi]],["Cast",[ri,ti]],["Ceil",[oi]],["Clip",[ni]],["Concat",[Hi,qi]],["Conv",[Xr,Zr]],["ConvTranspose",[cs,ls]],["Cos",[ii]],["Cosh",[si]],["CumSum",[ms,fs]],["DepthToSpace",[gs,ys]],["DequantizeLinear",[Ca,Aa]],["Div",[Oi]],["Einsum",[$s,vs]],["Elu",[ai,pt]],["Equal",[Di]],["Erf",[ui]],["Exp",[di]],["Expand",[Is]],["FastGelu",[Cs]],["Floor",[li]],["FusedConv",[Xr,Zr]],["Gather",[Es,ks]],["GatherElements",[Ms,Ds]],["GatherBlockQuantized",[zs,Bs]],["Gelu",[ci]],["Gemm",[Us,Vs]],["GlobalAveragePool",[_a,wa]],["GlobalMaxPool",[Ia,Sa]],["Greater",[Ui]],["GreaterOrEqual",[Wi]],["GridSample",[Ws,Ls]],["GroupQueryAttention",[Xs]],["HardSigmoid",[wi,bi]],["InstanceNormalization",[Js]],["LayerNormalization",[ta]],["LeakyRelu",[pi,pt]],["Less",[Ni]],["LessOrEqual",[Li]],["Log",[Ai]],["MatMul",[na]],["MatMulNBits",[ia,sa]],["MaxPool",[va,xa]],["Mul",[Mi]],["MultiHeadAttention",[Fs,qs]],["Neg",[fi]],["Not",[mi]],["Pad",[ua]],["Pow",[Ri]],["QuickGelu",[ki,pt]],["Range",[Ea]],["Reciprocal",[hi]],["ReduceMin",[Oo]],["ReduceMean",[ko]],["ReduceMax",[Bo]],["ReduceSum",[Mo]],["ReduceProd",[Do]],["ReduceL1",[Eo]],["ReduceL2",[Po]],["ReduceLogSum",[Vo]],["ReduceLogSumExp",[zo]],["ReduceSumSquare",[Ro]],["Relu",[gi]],["Resize",[Ba,Oa]],["RotaryEmbedding",[Ma]],["Sigmoid",[yi]],["Sin",[_i]],["Sinh",[$i]],["Slice",[Wa,La]],["SkipLayerNormalization",[Va]],["Split",[Ks,js]],["Sqrt",[vi]],["Softmax",[Ha,qa]],["Sub",[Vi]],["Tan",[xi]],["Tanh",[Ii]],["ThresholdedRelu",[Ci,pt]],["Tile",[ja]],["Transpose",[go,yo]],["Where",[Xa]]])});var dr,eu=A(()=>{"use strict";xe();Te();F();dr=class{constructor(t){this.backend=t;this.repo=new Map,this.attributesBound=!1}getArtifact(t){return this.repo.get(t)}setArtifact(t,r){this.repo.set(t,r)}run(t,r,n,o,s){ye(t.programInfo.name);let i=this.backend.device,a=this.backend.getComputePassEncoder();this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2);let u=[];for(let l of r)u.push({binding:u.length,resource:{buffer:l.buffer}});for(let l of n)u.push({binding:u.length,resource:{buffer:l.buffer}});s&&u.push({binding:u.length,resource:s});let d=i.createBindGroup({layout:t.computePipeline.getBindGroupLayout(0),entries:u,label:t.programInfo.name});if(this.backend.sessionStatus==="capturing"){let l={kernelId:this.backend.currentKernelId,computePipeline:t.computePipeline,bindGroup:d,dispatchGroup:o};this.backend.capturedCommandList.get(this.backend.currentSessionId).push(l)}a.setPipeline(t.computePipeline),a.setBindGroup(0,d),a.dispatchWorkgroups(...o),this.backend.writeTimestamp(this.backend.pendingDispatchNumber*2+1),this.backend.pendingDispatchNumber++,(this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber||this.backend.queryType==="at-passes")&&this.backend.endComputePass(),this.backend.pendingDispatchNumber>=this.backend.maxDispatchNumber&&this.backend.flush(),ge(t.programInfo.name)}dispose(){}build(t,r){ye(t.name);let n=this.backend.device,o=[];[{feature:"shader-f16",extension:"f16"},{feature:"subgroups",extension:"subgroups"},{feature:"subgroups-f16",extension:"subgroups_f16"}].forEach(c=>{n.features.has(c.feature)&&o.push(`enable ${c.extension};`)});let i=fo(r,this.backend.device.limits),a=t.getShaderSource(i),u=`${o.join(`
`)}
${i.additionalImplementations}
${a}`,d=n.createShaderModule({code:u,label:t.name});j("verbose",()=>`[WebGPU] ${t.name} shader code: ${u}`);let l=n.createComputePipeline({compute:{module:d,entryPoint:"main"},layout:"auto",label:t.name});return ge(t.name),{programInfo:t,computePipeline:l,uniformVariablesInfo:i.variablesInfo}}normalizeDispatchGroupSize(t){let r=typeof t=="number"?t:t.x,n=typeof t=="number"?1:t.y||1,o=typeof t=="number"?1:t.z||1,s=this.backend.device.limits.maxComputeWorkgroupsPerDimension;if(r<=s&&n<=s&&o<=s)return[r,n,o];let i=r*n*o,a=Math.ceil(Math.sqrt(i));if(a>s){if(a=Math.ceil(Math.cbrt(i)),a>s)throw new Error("Total dispatch size exceeds WebGPU maximum.");return[a,a,a]}else return[a,a,1]}}});var qc,Fc,on,sn,lr,tu=A(()=>{"use strict";xe();V();Te();Er();co();Ja();eu();qc=(e,t)=>{if(t.length!==e.length)throw new Error(`inputDependencies length ${t.length} is not equal to inputTensors length ${e.length}.`);let r=[];for(let n=0;n<e.length;++n){let o=e[n].dataType;switch(t[n]){case"none":{r.push("");break}case"type":{r.push(`${o}`);break}case"rank":{let s=e[n].dims.length;r.push(`${o};${s}`);break}case"dims":{let s=e[n].dims.join(",");r.push(`${o};${s}`);break}default:throw new Error(`unsupported input dependency: ${t[n]}`)}}return r.join("|")},Fc=(e,t,r)=>{let n=e.name;return e.shaderCache?.hint&&(n+="["+e.shaderCache.hint+"]"),n+=":"+r+`:${qc(t,e.shaderCache?.inputDependencies??new Array(t.length).fill("dims"))}`,n},on=class{constructor(t){t&&(this.architecture=t.architecture,this.vendor=t.vendor)}isArchitecture(t){return this.architecture===t}isVendor(t){return this.vendor===t}},sn=class{constructor(t){this.subgroupsSupported=t.features.has("subgroups"),this.subgroupsF16Supported=t.features.has("subgroups");let r=t.limits;!this.subgroupsSupported||!r.minSubgroupSize||!r.maxSubgroupSize?this.subgroupSizeRange=void 0:this.subgroupSizeRange=[r.minSubgroupSize,r.maxSubgroupSize]}},lr=class{constructor(){this.currentSessionId=null;this.currentKernelId=null;this.commandEncoder=null;this.computePassEncoder=null;this.maxDispatchNumber=16;this.pendingDispatchNumber=0;this.pendingKernels=[];this.pendingQueries=new Map;this.sessionStatus="default";this.capturedCommandList=new Map;this.capturedPendingKernels=new Map;this.sessionExternalDataMapping=new Map}get currentKernelCustomData(){if(this.currentKernelId===null)throw new Error("currentKernelCustomData(): currentKernelId is null. (should not happen)");let t=this.kernelCustomData.get(this.currentKernelId);return t||(t={},this.kernelCustomData.set(this.currentKernelId,t)),t}async initialize(t,r){this.env=t;let n=[],o={requiredLimits:{maxComputeWorkgroupStorageSize:r.limits.maxComputeWorkgroupStorageSize,maxComputeWorkgroupsPerDimension:r.limits.maxComputeWorkgroupsPerDimension,maxStorageBufferBindingSize:r.limits.maxStorageBufferBindingSize,maxBufferSize:r.limits.maxBufferSize,maxComputeInvocationsPerWorkgroup:r.limits.maxComputeInvocationsPerWorkgroup,maxComputeWorkgroupSizeX:r.limits.maxComputeWorkgroupSizeX,maxComputeWorkgroupSizeY:r.limits.maxComputeWorkgroupSizeY,maxComputeWorkgroupSizeZ:r.limits.maxComputeWorkgroupSizeZ},requiredFeatures:n},s=i=>r.features.has(i)&&n.push(i)&&!0;s("chromium-experimental-timestamp-query-inside-passes")||s("timestamp-query"),s("shader-f16"),s("subgroups")&&s("subgroups-f16"),this.device=await r.requestDevice(o),this.deviceInfo=new sn(this.device),this.adapterInfo=new on(r.info||await r.requestAdapterInfo()),this.gpuDataManager=lo(this),this.programManager=new dr(this),this.kernels=new Map,this.kernelPersistentData=new Map,this.kernelCustomData=new Map,Ht(t.logLevel,!!t.debug),this.device.onuncapturederror=i=>{i.error instanceof GPUValidationError&&console.error(`An uncaught WebGPU validation error was raised: ${i.error.message}`)},Object.defineProperty(this.env.webgpu,"device",{value:this.device,writable:!1,enumerable:!0,configurable:!1}),Object.defineProperty(this.env.webgpu,"adapter",{value:r,writable:!1,enumerable:!0,configurable:!1}),this.setQueryType()}dispose(){typeof this.querySet<"u"&&this.querySet.destroy(),this.gpuDataManager.dispose()}getCommandEncoder(){return this.commandEncoder||(this.commandEncoder=this.device.createCommandEncoder()),this.commandEncoder}getComputePassEncoder(){if(!this.computePassEncoder){let t=this.getCommandEncoder(),r={};this.queryType==="at-passes"&&(r.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:this.pendingDispatchNumber*2,endOfPassWriteIndex:this.pendingDispatchNumber*2+1}),this.computePassEncoder=t.beginComputePass(r)}return this.computePassEncoder}endComputePass(){this.computePassEncoder&&(this.computePassEncoder.end(),this.computePassEncoder=null)}flush(){if(!this.commandEncoder)return;ye(),this.endComputePass();let t;this.queryType!=="none"&&(this.commandEncoder.resolveQuerySet(this.querySet,0,this.pendingDispatchNumber*2,this.queryResolveBuffer,0),t=this.device.createBuffer({size:this.pendingDispatchNumber*2*8,usage:GPUBufferUsage.MAP_READ|GPUBufferUsage.COPY_DST}),this.pendingQueries.set(t,this.pendingKernels),this.pendingKernels=[],this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer,0,t,0,this.pendingDispatchNumber*2*8)),this.device.queue.submit([this.commandEncoder.finish()]),this.gpuDataManager.refreshPendingBuffers(),this.commandEncoder=null,this.pendingDispatchNumber=0,this.queryType!=="none"&&t.mapAsync(GPUMapMode.READ).then(()=>{let r=new BigUint64Array(t.getMappedRange()),n=this.pendingQueries.get(t);for(let o=0;o<r.length/2;o++){let s=n[o],i=s.kernelId,a=this.kernels.get(i),u=a.kernelType,d=a.kernelName,l=s.programName,c=s.inputTensorViews,p=s.outputTensorViews,h=r[o*2],m=r[o*2+1];typeof this.queryTimeBase>"u"&&(this.queryTimeBase=h);let f=Number(h-this.queryTimeBase),b=Number(m-this.queryTimeBase);if(!Number.isSafeInteger(f)||!Number.isSafeInteger(b))throw new RangeError("incorrect timestamp range");if(this.env.webgpu.profiling?.ondata)this.env.webgpu.profiling.ondata({version:1,inputsMetadata:c.map(y=>({dims:y.dims,dataType:Ne(y.dataType)})),outputsMetadata:p.map(y=>({dims:y.dims,dataType:Ne(y.dataType)})),kernelId:i,kernelType:u,kernelName:d,programName:l,startTime:f,endTime:b});else{let y="";c.forEach((w,_)=>{y+=`input[${_}]: [${w.dims}] | ${Ne(w.dataType)}, `});let g="";p.forEach((w,_)=>{g+=`output[${_}]: [${w.dims}] | ${Ne(w.dataType)}, `}),console.log(`[profiling] kernel "${i}|${u}|${d}|${l}" ${y}${g}execution time: ${b-f} ns`)}it("GPU",`${l}::${h}::${m}`)}t.unmap(),this.pendingQueries.delete(t)}),ge()}run(t,r,n,o,s,i){ye(t.name);let a=[];for(let w=0;w<r.length;++w){let _=r[w].data;if(_===0)continue;let $=this.gpuDataManager.get(_);if(!$)throw new Error(`no GPU data for input: ${_}`);a.push($)}let{outputs:u,dispatchGroup:d,programUniforms:l}=t.getRunData(r),c=n.length===0?u.map((w,_)=>_):n;if(c.length!==u.length)throw new Error(`Output size ${c.length} must be equal to ${u.length}.`);let p=[],h=[];for(let w=0;w<u.length;++w){if(!Number.isInteger(c[w])||c[w]<-3||c[w]>=i)throw new Error(`Invalid output index: ${c[w]}`);if(c[w]===-3)continue;let _=c[w]===-1,$=c[w]===-2,v=_||$?s(u[w].dataType,u[w].dims):o(c[w],u[w].dataType,u[w].dims);if(p.push(v),v.data===0)continue;let I=this.gpuDataManager.get(v.data);if(!I)throw new Error(`no GPU data for output: ${v.data}`);if(_&&this.temporaryData.push(I),$){let T=this.kernelPersistentData.get(this.currentKernelId);T||(T=[],this.kernelPersistentData.set(this.currentKernelId,T)),T.push(I)}h.push(I)}if(a.length!==r.length||h.length!==p.length){if(h.length===0)return ge(t.name),p;throw new Error(`Program ${t.name} has zero-sized tensor(s) in inputs or outputs. This is not supported now.`)}let m;if(l){let w=0,_=[];l.forEach(T=>{let k=typeof T.data=="number"?[T.data]:T.data;if(k.length===0)return;let B=T.type===10?2:4,D,G;T.type===10?(G=k.length>4?16:k.length>2?8:k.length*B,D=k.length>4?16:B*k.length):(G=k.length<=2?k.length*B:16,D=16),w=Math.ceil(w/G)*G,_.push(w);let z=T.type===10?8:4;w+=k.length>4?Math.ceil(k.length/z)*D:k.length*B});let $=16;w=Math.ceil(w/$)*$;let v=new ArrayBuffer(w);l.forEach((T,k)=>{let B=_[k],D=typeof T.data=="number"?[T.data]:T.data;if(T.type===6)new Int32Array(v,B,D.length).set(D);else if(T.type===12)new Uint32Array(v,B,D.length).set(D);else if(T.type===10)new Uint16Array(v,B,D.length).set(D);else if(T.type===1)new Float32Array(v,B,D.length).set(D);else throw new Error(`Unsupported uniform type: ${Ne(T.type)}`)});let I=this.gpuDataManager.create(w,GPUBufferUsage.COPY_DST|GPUBufferUsage.UNIFORM);this.device.queue.writeBuffer(I.buffer,0,v,0,w),this.gpuDataManager.release(I.id),m={offset:0,size:w,buffer:I.buffer}}let f=this.programManager.normalizeDispatchGroupSize(d),b=f[1]===1&&f[2]===1,y=Fc(t,r,b),g=this.programManager.getArtifact(y);if(g||(g=this.programManager.build(t,f),this.programManager.setArtifact(y,g),j("info",()=>`[artifact] key: ${y}, programName: ${t.name}`)),l&&g.uniformVariablesInfo){if(l.length!==g.uniformVariablesInfo.length)throw new Error(`Uniform variables count mismatch: expect ${g.uniformVariablesInfo.length}, got ${l.length} in program "${g.programInfo.name}".`);for(let w=0;w<l.length;w++){let _=l[w],$=_.type,v=typeof _.data=="number"?1:_.data.length,[I,T]=g.uniformVariablesInfo[w];if($!==I||v!==T)throw new Error(`Uniform variable ${w} mismatch: expect type ${I} with size ${T}, got type ${$} with size ${v} in program "${g.programInfo.name}".`)}}if(j("info",()=>`[ProgramManager] run "${t.name}" (key=${y}) with ${f[0]}x${f[1]}x${f[2]}`),this.queryType!=="none"||this.sessionStatus==="capturing"){let w={kernelId:this.currentKernelId,programName:g.programInfo.name,inputTensorViews:r,outputTensorViews:p};this.pendingKernels.push(w),this.sessionStatus==="capturing"&&this.capturedPendingKernels.get(this.currentSessionId).push(w)}return this.programManager.run(g,a,h,f,m),ge(t.name),p}upload(t,r){this.gpuDataManager.upload(t,r)}memcpy(t,r){this.gpuDataManager.memcpy(t,r)}async download(t,r){await this.gpuDataManager.download(t,r)}alloc(t){return this.gpuDataManager.create(t).id}free(t){return this.gpuDataManager.release(t)}createKernel(t,r,n,o){let s=Ya.get(t);if(!s)throw new Error(`kernel not implemented: ${t}`);let i={kernelType:t,kernelName:o,kernelEntry:s[0],attributes:[s[1],n]};this.kernels.set(r,i)}releaseKernel(t){let r=this.kernelPersistentData.get(t);if(r){for(let n of r)this.gpuDataManager.release(n.id);this.kernelPersistentData.delete(t)}this.kernelCustomData.delete(t),this.kernels.delete(t)}computeKernel(t,r,n){let o=this.kernels.get(t);if(!o)throw new Error(`kernel not created: ${t}`);let s=o.kernelType,i=o.kernelName,a=o.kernelEntry,u=o.attributes;if(this.currentKernelId!==null)throw new Error(`kernel "[${s}] ${i}" is not allowed to be called recursively`);this.currentKernelId=t,u[0]&&(u[1]=u[0](u[1]),u[0]=void 0),j("info",()=>`[WebGPU] Start to run kernel "[${s}] ${i}"...`);let d=this.env.debug;this.temporaryData=[];try{return d&&this.device.pushErrorScope("validation"),a(r,u[1]),0}catch(l){return n.push(Promise.resolve(`[WebGPU] Kernel "[${s}] ${i}" failed. ${l}`)),1}finally{d&&n.push(this.device.popErrorScope().then(l=>l?`GPU validation error for kernel "[${s}] ${i}": ${l.message}`:null));for(let l of this.temporaryData)this.gpuDataManager.release(l.id);this.temporaryData=[],this.currentKernelId=null}}registerBuffer(t,r,n,o){let s=this.sessionExternalDataMapping.get(t);s||(s=new Map,this.sessionExternalDataMapping.set(t,s));let i=s.get(r),a=this.gpuDataManager.registerExternalBuffer(n,o,i);return s.set(r,[a,n]),a}unregisterBuffers(t){let r=this.sessionExternalDataMapping.get(t);r&&(r.forEach(n=>this.gpuDataManager.unregisterExternalBuffer(n[0])),this.sessionExternalDataMapping.delete(t))}getBuffer(t){let r=this.gpuDataManager.get(t);if(!r)throw new Error(`no GPU data for buffer: ${t}`);return r.buffer}createDownloader(t,r,n){return async()=>{let o=await Or(this,t,r);return qt(o.buffer,n)}}writeTimestamp(t){this.queryType==="inside-passes"&&this.computePassEncoder.writeTimestamp(this.querySet,t)}setQueryType(){this.queryType="none",(this.env.webgpu.profiling?.mode==="default"||(typeof this.env.trace>"u"?this.env.wasm.trace:this.env.trace))&&(this.device.features.has("chromium-experimental-timestamp-query-inside-passes")?this.queryType="inside-passes":this.device.features.has("timestamp-query")&&(this.queryType="at-passes"),this.queryType!=="none"&&typeof this.querySet>"u"&&(this.querySet=this.device.createQuerySet({type:"timestamp",count:this.maxDispatchNumber*2}),this.queryResolveBuffer=this.device.createBuffer({size:this.maxDispatchNumber*2*8,usage:GPUBufferUsage.COPY_SRC|GPUBufferUsage.QUERY_RESOLVE})))}captureBegin(){j("info","captureBegin"),this.capturedCommandList.get(this.currentSessionId)||this.capturedCommandList.set(this.currentSessionId,[]),this.capturedPendingKernels.get(this.currentSessionId)||this.capturedPendingKernels.set(this.currentSessionId,[]),this.flush(),this.sessionStatus="capturing"}captureEnd(){j("info","captureEnd"),this.flush(),this.sessionStatus="default"}replay(){j("info","replay"),this.sessionStatus="replaying";let t=this.capturedCommandList.get(this.currentSessionId),r=this.capturedPendingKernels.get(this.currentSessionId),n=t.length;this.pendingKernels=[];for(let o=0;o<n;o++){let s=this.getComputePassEncoder(),i=t[o];this.writeTimestamp(this.pendingDispatchNumber*2),s.setPipeline(i.computePipeline),s.setBindGroup(0,i.bindGroup),s.dispatchWorkgroups(...i.dispatchGroup),this.writeTimestamp(this.pendingDispatchNumber*2+1),this.pendingDispatchNumber++,this.queryType!=="none"&&this.pendingKernels.push(r[o]),(this.pendingDispatchNumber>=this.maxDispatchNumber||this.queryType==="at-passes")&&this.endComputePass(),this.pendingDispatchNumber>=this.maxDispatchNumber&&this.flush()}this.flush(),this.sessionStatus="default"}onCreateSession(){this.gpuDataManager.onCreateSession()}onReleaseSession(t){this.unregisterBuffers(t),this.capturedCommandList.has(t)&&this.capturedCommandList.delete(t),this.capturedPendingKernels.has(t)&&this.capturedPendingKernels.delete(t),this.gpuDataManager.onReleaseSession(t)}onRunStart(t){this.currentSessionId=t,this.setQueryType()}}});var Kc,ru,jc,nu,cr,pr,an,ou,iu=A(()=>{"use strict";Te();Kc=1,ru=()=>Kc++,jc=new Map([["float32",32],["float16",16],["int32",32],["uint32",32],["int64",64],["uint64",64],["int8",8],["uint8",8],["int4",4],["uint4",4]]),nu=(e,t)=>{let r=jc.get(e);if(!r)throw new Error("Unsupported data type.");return Math.ceil(t.reduce((n,o)=>n*o)*r/8)},cr=class{constructor(t){this.sessionId=t.sessionId,this.mlContext=t.context,this.mlTensor=t.tensor,this.dataType=t.dataType,this.tensorShape=t.shape}get tensor(){return this.mlTensor}get type(){return this.dataType}get shape(){return this.tensorShape}get byteLength(){return nu(this.dataType,this.tensorShape)}destroy(){j("verbose",()=>"[WebNN] TensorWrapper.destroy"),this.mlTensor.destroy()}write(t){this.mlContext.writeTensor(this.mlTensor,t)}async read(t){return t?this.mlContext.readTensor(this.mlTensor,t):this.mlContext.readTensor(this.mlTensor)}sameTypeAndShape(t,r){return this.dataType===t&&this.tensorShape.length===r.length&&this.tensorShape.every((n,o)=>n===r[o])}},pr=class{constructor(t,r){this.tensorManager=t;this.wrapper=r}get tensorWrapper(){return this.wrapper}releaseTensor(){this.tensorWrapper&&(this.tensorManager.releaseTensor(this.tensorWrapper),this.wrapper=void 0)}async ensureTensor(t,r,n){if(this.wrapper){if(this.wrapper.sameTypeAndShape(t,r))return this.wrapper.tensor;if(n){if(this.wrapper.byteLength!==nu(t,r))throw new Error("Unable to copy data to tensor with different size.");this.activeUpload=new Uint8Array(await this.wrapper.read())}this.tensorManager.releaseTensor(this.wrapper)}let o=MLTensorUsage.READ|MLTensorUsage.WRITE;return this.wrapper=await this.tensorManager.getCachedTensor(t,r,o,!0,!0),n&&this.activeUpload&&(this.wrapper.write(this.activeUpload),this.activeUpload=void 0),this.wrapper.tensor}upload(t){if(this.wrapper)if(t.byteLength===this.wrapper.byteLength){this.wrapper.write(t);return}else j("verbose",()=>"Data size does not match tensor size. Releasing tensor."),this.releaseTensor();this.activeUpload?this.activeUpload.set(t):this.activeUpload=new Uint8Array(t)}async download(t){if(this.activeUpload)if(t){t instanceof ArrayBuffer?new Uint8Array(t).set(this.activeUpload):new Uint8Array(t.buffer,t.byteOffset,t.byteLength).set(this.activeUpload);return}else return this.activeUpload.buffer;if(!this.wrapper)throw new Error("Tensor has not been created.");return t?this.wrapper.read(t):this.wrapper.read()}},an=class{constructor(t){this.backend=t;this.tensorTrackersById=new Map;this.freeTensors=[];this.externalTensors=new Set}reserveTensorId(){let t=ru();return this.tensorTrackersById.set(t,new pr(this)),t}releaseTensorId(t){let r=this.tensorTrackersById.get(t);r&&(this.tensorTrackersById.delete(t),r.tensorWrapper&&this.releaseTensor(r.tensorWrapper))}async ensureTensor(t,r,n,o){j("verbose",()=>`[WebNN] TensorManager.ensureTensor {tensorId: ${t}, dataType: ${r}, shape: ${n}, copyOld: ${o}}`);let s=this.tensorTrackersById.get(t);if(!s)throw new Error("Tensor not found.");return s.ensureTensor(r,n,o)}upload(t,r){let n=this.tensorTrackersById.get(t);if(!n)throw new Error("Tensor not found.");n.upload(r)}async download(t,r){j("verbose",()=>`[WebNN] TensorManager.download {tensorId: ${t}, dstBuffer: ${r?.byteLength}}`);let n=this.tensorTrackersById.get(t);if(!n)throw new Error("Tensor not found.");return n.download(r)}releaseTensorsForSession(t){for(let r of this.freeTensors)r.sessionId===t&&r.destroy();this.freeTensors=this.freeTensors.filter(r=>r.sessionId!==t)}registerTensor(t,r,n,o){let s=ru(),i=new cr({sessionId:this.backend.currentSessionId,context:t,tensor:r,dataType:n,shape:o});return this.tensorTrackersById.set(s,new pr(this,i)),this.externalTensors.add(i),s}async getCachedTensor(t,r,n,o,s){let i=this.backend.currentSessionId;for(let[d,l]of this.freeTensors.entries())if(l.sameTypeAndShape(t,r)){j("verbose",()=>`[WebNN] Reusing tensor {dataType: ${t}, shape: ${r}}`);let c=this.freeTensors.splice(d,1)[0];return c.sessionId=i,c}let a=this.backend.currentContext;j("verbose",()=>`[WebNN] MLContext.createTensor {dataType: ${t}, shape: ${r}}`);let u=await a.createTensor({dataType:t,shape:r,dimensions:r,usage:n,writable:o,readable:s});return new cr({sessionId:i,context:a,tensor:u,dataType:t,shape:r})}releaseTensor(t){this.externalTensors.has(t)&&this.externalTensors.delete(t),this.freeTensors.push(t)}},ou=(...e)=>new an(...e)});var su,Zc,mr,au=A(()=>{"use strict";V();Ue();Er();iu();Te();su=new Map([[1,"float32"],[10,"float16"],[6,"int32"],[12,"uint32"],[7,"int64"],[13,"uint64"],[22,"int4"],[21,"uint4"],[3,"int8"],[2,"uint8"],[9,"uint8"]]),Zc=(e,t)=>{if(e===t)return!0;if(e===void 0||t===void 0)return!1;let r=Object.keys(e).sort(),n=Object.keys(t).sort();return r.length===n.length&&r.every((o,s)=>o===n[s]&&e[o]===t[o])},mr=class{constructor(t){this.tensorManager=ou(this);this.mlContextBySessionId=new Map;this.sessionIdsByMLContext=new Map;this.mlContextCache=[];Ht(t.logLevel,!!t.debug)}get currentSessionId(){if(this.activeSessionId===void 0)throw new Error("No active session");return this.activeSessionId}onRunStart(t){this.activeSessionId=t}async createMLContext(t){if(t instanceof GPUDevice){let n=this.mlContextCache.findIndex(o=>o.gpuDevice===t);if(n!==-1)return this.mlContextCache[n].mlContext;{let o=await navigator.ml.createContext(t);return this.mlContextCache.push({gpuDevice:t,mlContext:o}),o}}else if(t===void 0){let n=this.mlContextCache.findIndex(o=>o.options===void 0&&o.gpuDevice===void 0);if(n!==-1)return this.mlContextCache[n].mlContext;{let o=await navigator.ml.createContext();return this.mlContextCache.push({mlContext:o}),o}}let r=this.mlContextCache.findIndex(n=>Zc(n.options,t));if(r!==-1)return this.mlContextCache[r].mlContext;{let n=await navigator.ml.createContext(t);return this.mlContextCache.push({options:t,mlContext:n}),n}}get currentContext(){let t=this.getMLContext(this.currentSessionId);if(!t)throw new Error(`No MLContext found for session ${this.currentSessionId}`);return t}registerMLContext(t,r){this.mlContextBySessionId.set(t,r);let n=this.sessionIdsByMLContext.get(r);n||(n=new Set,this.sessionIdsByMLContext.set(r,n)),n.add(t)}onReleaseSession(t){let r=this.mlContextBySessionId.get(t);if(!r)return;this.tensorManager.releaseTensorsForSession(t),this.mlContextBySessionId.delete(t);let n=this.sessionIdsByMLContext.get(r);if(n.delete(t),n.size===0){this.sessionIdsByMLContext.delete(r);let o=this.mlContextCache.findIndex(s=>s.mlContext===r);o!==-1&&this.mlContextCache.splice(o,1)}}getMLContext(t){return this.mlContextBySessionId.get(t)}reserveTensorId(){return this.tensorManager.reserveTensorId()}releaseTensorId(t){j("verbose",()=>`[WebNN] releaseTensorId {tensorId: ${t}}`),this.tensorManager.releaseTensorId(t)}async ensureTensor(t,r,n,o){let s=su.get(r);if(!s)throw new Error(`Unsupported ONNX data type: ${r}`);return this.tensorManager.ensureTensor(t,s,n,o)}uploadTensor(t,r){if(!oe().shouldTransferToMLTensor)throw new Error("Trying to upload to a MLTensor while shouldTransferToMLTensor is false");j("verbose",()=>`[WebNN] uploadTensor {tensorId: ${t}, data: ${r.byteLength}}`),this.tensorManager.upload(t,r)}async downloadTensor(t,r){return this.tensorManager.download(t,r)}createMLTensorDownloader(t,r){return async()=>{let n=await this.tensorManager.download(t);return qt(n,r)}}registerMLTensor(t,r,n){let o=su.get(r);if(!o)throw new Error(`Unsupported ONNX data type: ${r}`);let s=this.tensorManager.registerTensor(this.currentContext,t,o,n);return j("verbose",()=>`[WebNN] registerMLTensor {tensor: ${t}, dataType: ${o}, dimensions: ${n}} -> {tensorId: ${s}}`),s}registerMLConstant(t,r,n,o,s,i){if(!i)throw new Error("External mounted files are not available.");let a=t;t.startsWith("./")&&(a=t.substring(2));let u=i.get(a);if(!u)throw new Error(`File with name ${a} not found in preloaded files.`);if(r+n>u.byteLength)throw new Error("Out of bounds: data offset and length exceed the external file data size.");let d=u.slice(r,r+n).buffer,l;switch(s.dataType){case"float32":l=new Float32Array(d);break;case"float16":l=new Uint16Array(d);break;case"int32":l=new Int32Array(d);break;case"uint32":l=new Uint32Array(d);break;case"int64":l=new BigInt64Array(d);break;case"uint64":l=new BigUint64Array(d);break;case"int8":l=new Int8Array(d);break;case"int4":case"uint4":case"uint8":l=new Uint8Array(d);break;default:throw new Error(`Unsupported data type: ${s.dataType} in creating WebNN Constant from external data.`)}return j("verbose",()=>`[WebNN] registerMLConstant {dataType: ${s.dataType}, shape: ${s.shape}}}`),o.constant(s,l)}flush(){}}});var uu={};nt(uu,{init:()=>Xc});var _t,un,Xc,du=A(()=>{"use strict";V();tu();Te();H();au();_t=class e{constructor(t,r,n,o){this.module=t;this.dataType=r;this.data=n;this.dims=o}getFloat32Array(){if(this.dataType!==1)throw new Error("Invalid data type");let t=x.size(this.dims);return t===0?new Float32Array:new Float32Array(this.module.HEAP8.buffer,this.data,t)}getBigInt64Array(){if(this.dataType!==7)throw new Error("Invalid data type");let t=x.size(this.dims);return t===0?new BigInt64Array:new BigInt64Array(this.module.HEAP8.buffer,this.data,t)}getInt32Array(){if(this.dataType!==6)throw new Error("Invalid data type");let t=x.size(this.dims);return t===0?new Int32Array:new Int32Array(this.module.HEAP8.buffer,this.data,t)}getUint16Array(){if(this.dataType!==10&&this.dataType!==4)throw new Error("Invalid data type");let t=x.size(this.dims);return t===0?new Uint16Array:new Uint16Array(this.module.HEAP8.buffer,this.data,t)}reshape(t){if(x.size(t)!==x.size(this.dims))throw new Error("Invalid new shape");return new e(this.module,this.dataType,this.data,t)}},un=class{constructor(t,r,n){this.module=t;this.backend=r;this.customDataOffset=0;this.customDataSize=0;this.adapterInfo=r.adapterInfo,this.deviceInfo=r.deviceInfo;let o=t.PTR_SIZE,s=n/t.PTR_SIZE,i=o===4?"i32":"i64";this.opKernelContext=Number(t.getValue(o*s++,i));let a=Number(t.getValue(o*s++,i));this.outputCount=Number(t.getValue(o*s++,i)),this.customDataOffset=Number(t.getValue(o*s++,"*")),this.customDataSize=Number(t.getValue(o*s++,i));let u=[];for(let d=0;d<a;d++){let l=Number(t.getValue(o*s++,i)),c=Number(t.getValue(o*s++,"*")),p=Number(t.getValue(o*s++,i)),h=[];for(let m=0;m<p;m++)h.push(Number(t.getValue(o*s++,i)));u.push(new _t(t,l,c,h))}this.inputs=u}get kernelCustomData(){return this.backend.currentKernelCustomData}get customDataBuffer(){return this.module.HEAPU8.subarray(this.customDataOffset,this.customDataOffset+this.customDataSize)}compute(t,r){let n=r?.inputs?.map(a=>typeof a=="number"?this.inputs[a]:a)??this.inputs,o=r?.outputs??[],s=(a,u,d)=>new _t(this.module,u,this.output(a,d),d),i=(a,u)=>{let d=Fe(a,u);if(!d)throw new Error(`Unsupported data type: ${a}`);let l=d>0?this.backend.gpuDataManager.create(d).id:0;return new _t(this.module,a,l,u)};return this.backend.run(t,n,o,s,i,this.outputCount)}output(t,r){let n=this.module.stackSave();try{let o=this.module.PTR_SIZE,s=o===4?"i32":"i64",i=this.module.stackAlloc((1+r.length)*o);this.module.setValue(i,r.length,s);for(let a=0;a<r.length;a++)this.module.setValue(i+o*(a+1),r[a],s);return this.module._JsepOutput(this.opKernelContext,t,i)}catch(o){throw new Error(`Failed to generate kernel's output[${t}] with dims [${r}]. If you are running with pre-allocated output, please make sure the output type/dims are correct. Error: ${o}`)}finally{this.module.stackRestore(n)}}},Xc=async(e,t,r,n)=>{let o=t.jsepInit;if(!o)throw new Error("Failed to initialize JSEP. The WebAssembly module is not built with JSEP support.");if(e==="webgpu"){let s=new lr;await s.initialize(r,n),o("webgpu",[s,i=>s.alloc(Number(i)),i=>s.free(i),(i,a,u,d=!1)=>{if(d)j("verbose",()=>`[WebGPU] jsepCopyGpuToGpu: src=${Number(i)}, dst=${Number(a)}, size=${Number(u)}`),s.memcpy(Number(i),Number(a));else{j("verbose",()=>`[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(i)}, gpuDataId=${Number(a)}, size=${Number(u)}`);let l=t.HEAPU8.subarray(Number(i>>>0),Number(i>>>0)+Number(u));s.upload(Number(a),l)}},async(i,a,u)=>{j("verbose",()=>`[WebGPU] jsepCopyGpuToCpu: gpuDataId=${i}, dataOffset=${a}, size=${u}`),await s.download(Number(i),()=>t.HEAPU8.subarray(Number(a)>>>0,Number(a+u)>>>0))},(i,a,u)=>s.createKernel(i,Number(a),u,t.UTF8ToString(t._JsepGetNodeName(Number(a)))),i=>s.releaseKernel(i),(i,a,u,d)=>{j("verbose",()=>`[WebGPU] jsepRun: sessionHandle=${u}, kernel=${i}, contextDataOffset=${a}`);let l=new un(t,s,Number(a));return s.computeKernel(Number(i),l,d)},()=>s.captureBegin(),()=>s.captureEnd(),()=>s.replay()])}else{let s=new mr(r);o("webnn",[s,()=>s.reserveTensorId(),i=>s.releaseTensorId(i),async(i,a,u,d)=>s.ensureTensor(i,a,u,d),(i,a)=>{s.uploadTensor(i,a)},async(i,a)=>s.downloadTensor(i,a)])}}});var Qc,zt,Bt,Xe,Yc,at,Ot,Dt,lu,Mt,Rt,Vt,Ir=A(()=>{"use strict";to();no();V();Ue();Nt();kr();Qc=(e,t)=>{oe()._OrtInit(e,t)!==0&&Z("Can't initialize onnxruntime.")},zt=async e=>{Qc(e.wasm.numThreads,lt(e.logLevel))},Bt=async(e,t)=>{{let r=(du(),vt(uu)).init;if(t==="webgpu"){if(typeof navigator>"u"||!navigator.gpu)throw new Error("WebGPU is not supported in current environment");let n=e.webgpu.adapter;if(n){if(typeof n.limits!="object"||typeof n.features!="object"||typeof n.requestDevice!="function")throw new Error("Invalid GPU adapter set in `env.webgpu.adapter`. It must be a GPUAdapter object.")}else{let o=e.webgpu.powerPreference;if(o!==void 0&&o!=="low-power"&&o!=="high-performance")throw new Error(`Invalid powerPreference setting: "${o}"`);let s=e.webgpu.forceFallbackAdapter;if(s!==void 0&&typeof s!="boolean")throw new Error(`Invalid forceFallbackAdapter setting: "${s}"`);if(n=await navigator.gpu.requestAdapter({powerPreference:o,forceFallbackAdapter:s}),!n)throw new Error('Failed to get GPU adapter. You may need to enable flag "--enable-unsafe-webgpu" if you are using Chrome.')}await r("webgpu",oe(),e,n)}if(t==="webnn"){if(typeof navigator>"u"||!navigator.ml)throw new Error("WebNN is not supported in current environment");await r("webnn",oe(),e)}}},Xe=new Map,Yc=e=>{let t=oe(),r=t.stackSave();try{let n=t.PTR_SIZE,o=t.stackAlloc(2*n);t._OrtGetInputOutputCount(e,o,o+n)!==0&&Z("Can't get session input/output count.");let i=n===4?"i32":"i64";return[Number(t.getValue(o,i)),Number(t.getValue(o+n,i))]}finally{t.stackRestore(r)}},at=e=>{let t=oe(),r=t._malloc(e.byteLength);if(r===0)throw new Error(`Can't create a session. failed to allocate a buffer of size ${e.byteLength}.`);return t.HEAPU8.set(e,r),[r,e.byteLength]},Ot=async(e,t)=>{let r,n,o=oe();Array.isArray(e)?[r,n]=e:e.buffer===o.HEAPU8.buffer?[r,n]=[e.byteOffset,e.byteLength]:[r,n]=at(e);let s=0,i=0,a=0,u=[],d=[],l=[];try{if([i,u]=ro(t),t?.externalData&&o.mountExternalData){let g=[];for(let w of t.externalData){let _=typeof w=="string"?w:w.path;g.push(ct(typeof w=="string"?w:w.data).then($=>{o.mountExternalData(_,$)}))}await Promise.all(g)}for(let g of t?.executionProviders??[])if((typeof g=="string"?g:g.name)==="webnn"){if(o.shouldTransferToMLTensor=!1,o.currentContext)throw new Error("WebNN execution provider is already set.");if(typeof g!="string"){let _=g,$=_?.context,v=_?.gpuDevice,I=_?.deviceType,T=_?.powerPreference;$?o.currentContext=$:v?o.currentContext=await o.jsepCreateMLContext(v):o.currentContext=await o.jsepCreateMLContext({deviceType:I,powerPreference:T})}else o.currentContext=await o.jsepCreateMLContext();break}s=await o._OrtCreateSession(r,n,i),s===0&&Z("Can't create a session."),o.jsepOnCreateSession?.(),o.currentContext&&(o.jsepRegisterMLContext(s,o.currentContext),o.currentContext=void 0,o.shouldTransferToMLTensor=!0);let[c,p]=Yc(s),h=!!t?.enableGraphCapture,m=[],f=[],b=[];for(let g=0;g<c;g++){let w=o._OrtGetInputName(s,g);w===0&&Z("Can't get an input name."),d.push(w),m.push(o.UTF8ToString(w))}for(let g=0;g<p;g++){let w=o._OrtGetOutputName(s,g);w===0&&Z("Can't get an output name."),l.push(w);let _=o.UTF8ToString(w);f.push(_);{if(h&&t?.preferredOutputLocation===void 0){b.push("gpu-buffer");continue}let $=typeof t?.preferredOutputLocation=="string"?t.preferredOutputLocation:t?.preferredOutputLocation?.[_]??"cpu";if($!=="cpu"&&$!=="cpu-pinned"&&$!=="gpu-buffer"&&$!=="ml-tensor")throw new Error(`Not supported preferred output location: ${$}.`);if(h&&$!=="gpu-buffer")throw new Error(`Not supported preferred output location: ${$}. Only 'gpu-buffer' location is supported when enableGraphCapture is true.`);b.push($)}}let y=null;return b.some(g=>g==="gpu-buffer"||g==="ml-tensor")&&(a=o._OrtCreateBinding(s),a===0&&Z("Can't create IO binding."),y={handle:a,outputPreferredLocations:b,outputPreferredLocationsEncoded:b.map(g=>Ar(g))}),Xe.set(s,[s,d,l,y,h,!1]),[s,m,f]}catch(c){throw d.forEach(p=>o._OrtFree(p)),l.forEach(p=>o._OrtFree(p)),a!==0&&o._OrtReleaseBinding(a)!==0&&Z("Can't release IO binding."),s!==0&&o._OrtReleaseSession(s)!==0&&Z("Can't release session."),c}finally{o._free(r),i!==0&&o._OrtReleaseSessionOptions(i)!==0&&Z("Can't release session options."),u.forEach(c=>o._free(c)),o.unmountExternalData?.()}},Dt=e=>{let t=oe(),r=Xe.get(e);if(!r)throw new Error(`cannot release session. invalid session id: ${e}`);let[n,o,s,i,a]=r;i&&(a&&t._OrtClearBoundOutputs(i.handle)!==0&&Z("Can't clear bound outputs."),t._OrtReleaseBinding(i.handle)!==0&&Z("Can't release IO binding.")),t.jsepOnReleaseSession?.(e),o.forEach(u=>t._OrtFree(u)),s.forEach(u=>t._OrtFree(u)),t._OrtReleaseSession(n)!==0&&Z("Can't release session."),Xe.delete(e)},lu=(e,t,r,n,o,s=!1)=>{if(!e){t.push(0);return}let i=oe(),a=i.PTR_SIZE,u=e[0],d=e[1],l=e[3],c,p;if(u==="string"&&(l==="gpu-buffer"||l==="ml-tensor"))throw new Error("String tensor is not supported on GPU.");if(s&&l!=="gpu-buffer")throw new Error(`External buffer must be provided for input/output index ${o} when enableGraphCapture is true.`);if(l==="gpu-buffer"){let f=e[2].gpuBuffer;p=Fe(dt(u),d);let b=i.jsepRegisterBuffer;if(!b)throw new Error('Tensor location "gpu-buffer" is not supported without using WebGPU.');c=b(n,o,f,p)}else if(l==="ml-tensor"){let f=e[2].mlTensor;p=Fe(dt(u),d);let b=i.jsepRegisterMLTensor;if(!b)throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');c=b(f,dt(u),d)}else{let f=e[2];if(Array.isArray(f)){p=a*f.length,c=i._malloc(p),r.push(c);for(let b=0;b<f.length;b++){if(typeof f[b]!="string")throw new TypeError(`tensor data at index ${b} is not a string`);i.setValue(c+b*a,de(f[b],r),"*")}}else p=f.byteLength,c=i._malloc(p),r.push(c),i.HEAPU8.set(new Uint8Array(f.buffer,f.byteOffset,p),c)}let h=i.stackSave(),m=i.stackAlloc(4*d.length);try{d.forEach((b,y)=>i.setValue(m+y*a,b,a===4?"i32":"i64"));let f=i._OrtCreateTensor(dt(u),c,p,m,d.length,Ar(l));f===0&&Z(`Can't create tensor for input/output. session=${n}, index=${o}.`),t.push(f)}finally{i.stackRestore(h)}},Mt=async(e,t,r,n,o,s)=>{let i=oe(),a=i.PTR_SIZE,u=Xe.get(e);if(!u)throw new Error(`cannot run inference. invalid session id: ${e}`);let d=u[0],l=u[1],c=u[2],p=u[3],h=u[4],m=u[5],f=t.length,b=n.length,y=0,g=[],w=[],_=[],$=[],v=i.stackSave(),I=i.stackAlloc(f*a),T=i.stackAlloc(f*a),k=i.stackAlloc(b*a),B=i.stackAlloc(b*a);try{i.jsepOnRunStart?.(d),[y,g]=eo(s);for(let z=0;z<f;z++)lu(r[z],w,$,e,t[z],h);for(let z=0;z<b;z++)lu(o[z],_,$,e,f+n[z],h);for(let z=0;z<f;z++)i.setValue(I+z*a,w[z],"*"),i.setValue(T+z*a,l[t[z]],"*");for(let z=0;z<b;z++)i.setValue(k+z*a,_[z],"*"),i.setValue(B+z*a,c[n[z]],"*");if(p&&!m){let{handle:z,outputPreferredLocations:N,outputPreferredLocationsEncoded:ne}=p;if(l.length!==f)throw new Error(`input count from feeds (${f}) is expected to be always equal to model's input count (${l.length}).`);for(let R=0;R<f;R++){let W=t[R];await i._OrtBindInput(z,l[W],w[R])!==0&&Z(`Can't bind input[${R}] for session=${e}.`)}for(let R=0;R<b;R++){let W=n[R];o[R]?.[3]?i._OrtBindOutput(z,c[W],_[R],0)!==0&&Z(`Can't bind pre-allocated output[${R}] for session=${e}.`):i._OrtBindOutput(z,c[W],0,ne[W])!==0&&Z(`Can't bind output[${R}] to ${N[R]} for session=${e}.`)}Xe.set(e,[d,l,c,p,h,!0])}let D;p?D=await i._OrtRunWithBinding(d,p.handle,b,k,y):D=await i._OrtRun(d,T,I,f,B,b,k,y),D!==0&&Z("failed to call OrtRun().");let G=[];for(let z=0;z<b;z++){let N=Number(i.getValue(k+z*a,"*"));if(N===_[z]){G.push(o[z]);continue}let ne=i.stackSave(),R=i.stackAlloc(4*a),W=!1,K,L=0;try{i._OrtGetTensorData(N,R,R+a,R+2*a,R+3*a)!==0&&Z(`Can't access output tensor data on index ${z}.`);let he=a===4?"i32":"i64",ae=Number(i.getValue(R,he));L=i.getValue(R+a,"*");let X=i.getValue(R+a*2,"*"),P=Number(i.getValue(R+a*3,he)),M=[];for(let se=0;se<P;se++)M.push(Number(i.getValue(X+se*a,he)));i._OrtFree(X)!==0&&Z("Can't free memory for tensor dims.");let te=M.reduce((se,ue)=>se*ue,1);K=Ne(ae);let Re=p?.outputPreferredLocations[n[z]];if(K==="string"){if(Re==="gpu-buffer"||Re==="ml-tensor")throw new Error("String tensor is not supported on GPU.");let se=[];for(let ue=0;ue<te;ue++){let Le=i.getValue(L+ue*a,"*"),xu=i.getValue(L+(ue+1)*a,"*"),Su=ue===te-1?void 0:xu-Le;se.push(i.UTF8ToString(Le,Su))}G.push([K,M,se,"cpu"])}else if(Re==="gpu-buffer"&&te>0){let se=i.jsepGetBuffer;if(!se)throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');let ue=se(L),Le=Fe(ae,te);if(Le===void 0||!Lt(K))throw new Error(`Unsupported data type: ${K}`);W=!0,G.push([K,M,{gpuBuffer:ue,download:i.jsepCreateDownloader(ue,Le,K),dispose:()=>{i._OrtReleaseTensor(N)!==0&&Z("Can't release tensor.")}},"gpu-buffer"])}else if(Re==="ml-tensor"&&te>0){let se=i.jsepEnsureTensor;if(!se)throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');if(Fe(ae,te)===void 0||!Gt(K))throw new Error(`Unsupported data type: ${K}`);let Le=await se(L,ae,M,!1);W=!0,G.push([K,M,{mlTensor:Le,download:i.jsepCreateMLTensorDownloader(L,K),dispose:()=>{i.jsepReleaseTensorId(L),i._OrtReleaseTensor(N)}},"ml-tensor"])}else{let se=Wt(K),ue=new se(te);new Uint8Array(ue.buffer,ue.byteOffset,ue.byteLength).set(i.HEAPU8.subarray(L,L+ue.byteLength)),G.push([K,M,ue,"cpu"])}}finally{i.stackRestore(ne),K==="string"&&L&&i._free(L),W||i._OrtReleaseTensor(N)}}return p&&!h&&(i._OrtClearBoundOutputs(p.handle)!==0&&Z("Can't clear bound outputs."),Xe.set(e,[d,l,c,p,h,!1])),G}finally{i.stackRestore(v),w.forEach(D=>i._OrtReleaseTensor(D)),_.forEach(D=>i._OrtReleaseTensor(D)),$.forEach(D=>i._free(D)),y!==0&&i._OrtReleaseRunOptions(y),g.forEach(D=>i._free(D))}},Rt=e=>{let t=oe(),r=Xe.get(e);if(!r)throw new Error("invalid session id");let n=r[0],o=t._OrtEndProfiling(n);o===0&&Z("Can't get an profile file name."),t._OrtFree(o)},Vt=e=>{let t=[];for(let r of e){let n=r[2];!Array.isArray(n)&&"buffer"in n&&t.push(n.buffer)}return t}});var Qe,Ie,$t,hr,gr,fr,dn,ln,tt,rt,ep,cu,pu,mu,fu,hu,gu,yu,cn=A(()=>{"use strict";xe();Ir();Ue();st();Qe=()=>!!Q.wasm.proxy&&typeof document<"u",$t=!1,hr=!1,gr=!1,ln=new Map,tt=(e,t)=>{let r=ln.get(e);r?r.push(t):ln.set(e,[t])},rt=()=>{if($t||!hr||gr||!Ie)throw new Error("worker not ready")},ep=e=>{switch(e.data.type){case"init-wasm":$t=!1,e.data.err?(gr=!0,dn[1](e.data.err)):(hr=!0,dn[0]()),fr&&(URL.revokeObjectURL(fr),fr=void 0);break;case"init-ep":case"copy-from":case"create":case"release":case"run":case"end-profiling":{let t=ln.get(e.data.type);e.data.err?t.shift()[1](e.data.err):t.shift()[0](e.data.out);break}default:}},cu=async()=>{if(!hr){if($t)throw new Error("multiple calls to 'initWasm()' detected.");if(gr)throw new Error("previous call to 'initWasm()' failed.");if($t=!0,Qe())return new Promise((e,t)=>{Ie?.terminate(),Qn().then(([r,n])=>{try{Ie=n,Ie.onerror=s=>t(s),Ie.onmessage=ep,dn=[e,t];let o={type:"init-wasm",in:Q};Ie.postMessage(o),fr=r}catch(o){t(o)}},t)});try{await Pt(Q.wasm),await zt(Q),hr=!0}catch(e){throw gr=!0,e}finally{$t=!1}}},pu=async e=>{if(Qe())return rt(),new Promise((t,r)=>{tt("init-ep",[t,r]);let n={type:"init-ep",in:{epName:e,env:Q}};Ie.postMessage(n)});await Bt(Q,e)},mu=async e=>Qe()?(rt(),new Promise((t,r)=>{tt("copy-from",[t,r]);let n={type:"copy-from",in:{buffer:e}};Ie.postMessage(n,[e.buffer])})):at(e),fu=async(e,t)=>{if(Qe()){if(t?.preferredOutputLocation)throw new Error('session option "preferredOutputLocation" is not supported for proxy.');return rt(),new Promise((r,n)=>{tt("create",[r,n]);let o={type:"create",in:{model:e,options:{...t}}},s=[];e instanceof Uint8Array&&s.push(e.buffer),Ie.postMessage(o,s)})}else return Ot(e,t)},hu=async e=>{if(Qe())return rt(),new Promise((t,r)=>{tt("release",[t,r]);let n={type:"release",in:e};Ie.postMessage(n)});Dt(e)},gu=async(e,t,r,n,o,s)=>{if(Qe()){if(r.some(i=>i[3]!=="cpu"))throw new Error("input tensor on GPU is not supported for proxy.");if(o.some(i=>i))throw new Error("pre-allocated output tensor is not supported for proxy.");return rt(),new Promise((i,a)=>{tt("run",[i,a]);let u=r,d={type:"run",in:{sessionId:e,inputIndices:t,inputs:u,outputIndices:n,options:s}};Ie.postMessage(d,Vt(u))})}else return Mt(e,t,r,n,o,s)},yu=async e=>{if(Qe())return rt(),new Promise((t,r)=>{tt("end-profiling",[t,r]);let n={type:"end-profiling",in:e};Ie.postMessage(n)});Rt(e)}});var bu,tp,yr,wu=A(()=>{"use strict";xe();cn();V();Et();kr();bu=(e,t)=>{switch(e.location){case"cpu":return[e.type,e.dims,e.data,"cpu"];case"gpu-buffer":return[e.type,e.dims,{gpuBuffer:e.gpuBuffer},"gpu-buffer"];case"ml-tensor":return[e.type,e.dims,{mlTensor:e.mlTensor},"ml-tensor"];default:throw new Error(`invalid data location: ${e.location} for ${t()}`)}},tp=e=>{switch(e[3]){case"cpu":return new pe(e[0],e[2],e[1]);case"gpu-buffer":{let t=e[0];if(!Lt(t))throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);let{gpuBuffer:r,download:n,dispose:o}=e[2];return pe.fromGpuBuffer(r,{dataType:t,dims:e[1],download:n,dispose:o})}case"ml-tensor":{let t=e[0];if(!Gt(t))throw new Error(`not supported data type: ${t} for deserializing MLTensor tensor`);let{mlTensor:r,download:n,dispose:o}=e[2];return pe.fromMLTensor(r,{dataType:t,dims:e[1],download:n,dispose:o})}default:throw new Error(`invalid data location: ${e[3]}`)}},yr=class{async fetchModelAndCopyToWasmMemory(t){return mu(await ct(t))}async loadModel(t,r){ye();let n;typeof t=="string"?!1?n=await ct(t):n=await this.fetchModelAndCopyToWasmMemory(t):n=t,[this.sessionId,this.inputNames,this.outputNames]=await fu(n,r),ge()}async dispose(){return hu(this.sessionId)}async run(t,r,n){ye();let o=[],s=[];Object.entries(t).forEach(p=>{let h=p[0],m=p[1],f=this.inputNames.indexOf(h);if(f===-1)throw new Error(`invalid input '${h}'`);o.push(m),s.push(f)});let i=[],a=[];Object.entries(r).forEach(p=>{let h=p[0],m=p[1],f=this.outputNames.indexOf(h);if(f===-1)throw new Error(`invalid output '${h}'`);i.push(m),a.push(f)});let u=o.map((p,h)=>bu(p,()=>`input "${this.inputNames[s[h]]}"`)),d=i.map((p,h)=>p?bu(p,()=>`output "${this.outputNames[a[h]]}"`):null),l=await gu(this.sessionId,s,u,a,d,n),c={};for(let p=0;p<l.length;p++)c[this.outputNames[a[p]]]=i[p]??tp(l[p]);return ge(),c}startProfiling(){}endProfiling(){yu(this.sessionId)}}});var $u={};nt($u,{OnnxruntimeWebAssemblyBackend:()=>br,initializeFlags:()=>_u,wasmBackend:()=>rp});var _u,br,rp,vu=A(()=>{"use strict";xe();cn();wu();st();_u=()=>{if((typeof Q.wasm.initTimeout!="number"||Q.wasm.initTimeout<0)&&(Q.wasm.initTimeout=0),Q.wasm.simd===!1&&console.warn('Deprecated property "env.wasm.simd" is set to false. non-SIMD build is no longer provided, and this setting will be ignored.'),typeof Q.wasm.proxy!="boolean"&&(Q.wasm.proxy=!1),typeof Q.wasm.trace!="boolean"&&(Q.wasm.trace=!1),typeof Q.wasm.numThreads!="number"||!Number.isInteger(Q.wasm.numThreads)||Q.wasm.numThreads<=0)if(typeof self<"u"&&!self.crossOriginIsolated)Q.wasm.numThreads=1;else{let e=typeof navigator>"u"?_r("node:os").cpus().length:navigator.hardwareConcurrency;Q.wasm.numThreads=Math.min(4,Math.ceil((e||1)/2))}Q.wasm.wasmPaths===void 0&&Se&&Se.indexOf("blob:")!==0&&(Q.wasm.wasmPaths=Se.substring(0,Se.lastIndexOf("/")+1))},br=class{async init(t){_u(),await cu(),await pu(t)}async createInferenceSessionHandler(t,r){let n=new yr;return await n.loadModel(t,r),Promise.resolve(n)}},rp=new br});var op={};nt(op,{InferenceSession:()=>On,TRACE:()=>it,TRACE_FUNC_BEGIN:()=>ye,TRACE_FUNC_END:()=>ge,Tensor:()=>pe,TrainingSession:()=>Wn,default:()=>np,env:()=>Q,registerBackend:()=>Ve});xe();xe();xe();var Gn="1.21.0-dev.20241109-d3ad76b2cf";var np=Sr;{let e=(vu(),vt($u)).wasmBackend;Ve("webgpu",e,5),Ve("webnn",e,5),Ve("cpu",e,10),Ve("wasm",e,10)}Object.defineProperty(Q.versions,"web",{value:Gn,enumerable:!0});return vt(op);})();
/**
 * @license
