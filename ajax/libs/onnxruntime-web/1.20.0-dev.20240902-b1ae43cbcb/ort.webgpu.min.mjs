...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[t(n.type),n.length??1])}},io=(e,t)=>new kn(e,t),Ye=(e,t)=>{let n=e.length,r=[];for(let o=0;o<n;o++){let i=n-1-o,s=e[i]||1;(t[t.length-1-o]||1)>1&&s===1&&r.unshift(i)}return r}});var Eu,so,Pu,zu,he,ao,uo,je=A(()=>{"use strict";R();N();ie();G();Eu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},so=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Pu=(e,t)=>v.sortBasedOnPerm(e,so(e.length,t)),zu=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
  ...
  ${d.mainStart()}
    ...
    ${s.setByOffset("global_idx",a.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:h=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Ee=(e,t,n,r)=>{let o=e.inputs.length===1?n:zn(e.inputs,n),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((f,m)=>m));let s=v.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],d=Wu(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(he(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=Uu(a.length,u.dims.length));let[c,l]=Mu(u.dims,a),p=c;o.keepDims&&(p=Vu(c,s)),e.compute(Gu(t,{hint:o.cacheKey,inputDependencies:["type"]},[u],r,e.inputs[0].dataType,p,l),{inputs:[u]})},lo=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},co=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},po=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},mo=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},fo=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},ho=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},go=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},yo=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},bo=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},wo=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}});var Pe,Lu,Lt,zn,ze,Hu,qu,Fu,Ku,ju,Zu,Qu,Xu,Yu,Ju,Oe,_o,vo,xo,So,Io,Co,To,Ao,ko,Eo,Gt=A(()=>{"use strict";R();N();ie();G();$o();Pe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Lu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Lt=(e,t,n,r,o,i,s=!1,a=!1)=>{let u=[],d=n[0].dims,c=d.length,l=v.normalizeAxes(o,c),p=!a&&l.length===0;d.forEach((y,w)=>{p||l.indexOf(w)>=0?s&&u.push(1):u.push(y)});let f=u.length,m=v.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let w=[],g=S("_A",n[0].dataType,c),b=C("output",i,f),$=r(g,b,l),_=$[2];for(let x=0,I=0;x<c;x++)p||l.indexOf(x)>=0?(s&&I++,_=`for(var j${x}: u32 = 0; j${x} < ${d[x]}; j${x}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Mo=e=>{ud(e.inputs),e.compute(dd(e.inputs))}});var ld,Z,No,Wo,Go,Lo,Ho,qo,Fo,Ko,jo,cd,Zo,Qo,Xo,Yo,dt,Jo,qt,ei,ti,ni,ri,oi,ii,si,ai,ui,di,li,ci,pi,mi,fi,hi,gi,yi,Bn,Dn,bi,wi,$i,pd,md,_i,Ft=A(()=>{"use strict";R();N();ie();G();ld=(e,t,n,r,o,i,s)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let d=S("inputData",n,[a],4),c=C("outputData",r,[a],4),l=[{name:"vec_size",type:"u32"}];return s&&l.push(...s),`
...
`,Dn=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,bi=e=>{let t=de(e.inputs[0].dataType);e.compute(Z(e.inputs[0],"FastGelu",Dn,Bn(t),void 0,e.inputs[0].dataType))},wi=(e,t)=>{let n=de(e.inputs[0].dataType);return e.compute(Z(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},$i=e=>{e.compute(Z(e.inputs[0],"Log","log"))},pd=(e,t)=>`
...
`});var xd,Sd,ct,Vi,Id,pt,Cd,Qt,mt=A(()=>{"use strict";R();N();G();Re();lt();xd=(e,t)=>e?`
...
bIndices[${b-2}] = u32(row);
    ...
    `},Qt=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s.slice(0,-2),d=a.slice(0,-2),c=r?r.slice(0,-2):n.slice(0,-2),l=v.size(c),p=s[s.length-2],f=s[s.length-1],m=a[a.length-1],h=f%4===0&&m%4===0,y=p<=8?[4,1,1]:[4,4,1],w=[8,8,1],g=[Math.ceil(m/w[0]/y[0]),Math.ceil(p/w[1]/y[1]),Math.ceil(l/w[2]/y[2])],b=h?4:1,$=[...u,p,f/b],_=$.length,x=[...d,f,m/b],I=x.length,T=[l,p,m/b],P=[{type:6,data:p},{type:6,data:m},{type:6,data:f}];ve(t,P),P.push(...E(c,$,x));let z=["rank","rank"],D=e.length>2;D&&(P.push(...E(e[2].dims)),z.push("rank")),P.push(...E(T));let j=L=>{let q=c.length,ae=Wt("batchDims",e[0].dataType,q,1),U=X(e[0].dataType),te=S("a",e[0].dataType,_,b),re=S("b",e[1].dataType,I,b),V=C("result",e[0].dataType,T.length,b),ne=[te,re];if(D){let B=o?b:1;ne.push(S("bias",e[2].dataType,e[2].dims.length,B))}let F=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];xe(t,F);let H=X(V.type.tensor),K=_e(t,V.type.value,H),k=Cd(b,D,K,[ae,te,re,V],[u,d,c],o);return`
  ${L.registerUniforms(F).registerInternalVariables(ae).declareVariables(...ne,V)}
  ${k}
  ${h?ct(y,w,U,ae):pt(y,w,U,ae)}
                   `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${h};${o}`,inputDependencies:z},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:P}),getShaderSource:j}}});var Td,Ni,Wi=A(()=>{"use strict";R();De();G();Re();lt();Rn();mt();Td=(e,t,n,r,o=!1,i,s=4,a=4,u=4,d="f32")=>{let c=z=>{switch(z){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},l=z=>{switch(z){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${z} is not supported.`)}},p=e?`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${_}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${V}>`:V}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${_}>`:_} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${p};${y}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:l[0],y:l[1],z:l[2]},programUniforms:m}),getShaderSource:w}}});var Ki,ji,Zi=A(()=>{"use strict";R();N();G();Un();Re();Ki=(e,t,n)=>{let r=e.length>2,o=r?"value += b[output_channel];":"",i=e[0].dims,s=e[1].dims,a=s[0]/t.group,u=t.format==="NHWC",d=Yt(i,s,t.dilations,t.pads,t.strides,u),c=v.size(d),l=[{type:12,data:c},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:a}];ve(t,l),l.push(...E(i,s));let p=["rank","rank"];r&&(l.push(...E(e[2].dims)),p.push("rank")),l.push(...E(d));let f=m=>{let h=C("output",e[0].dataType,d.length),y=X(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,i.length),b=S("w",e[1].dataType,s.length),$=[g,b];r&&$.push(S("b",e[2].dataType,e[2].dims.length));let _=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];return xe(t,_),`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:t.cacheKey,inputDependencies:p},getRunData:()=>({outputs:[{dims:n?n(d):d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:l}),getShaderSource:f}},ji=(e,t,n,r)=>{let o=e.length>2,i=ee(n[3]),s=ee(n[2]),a=v.size(n)/i/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],c=[n[0],n[1],n[2],n[3]/i],l=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ve(t,l),l.push(...E(u,d,c));let p=(s-1)*t.strides[1]+d[1],f=m=>{let h=C("output",e[0].dataType,c.length,i),y=X(h.type.tensor),w=_e(t,h.type.value,y),g=S("x",e[0].dataType,u.length,i),b=S("w",e[1].dataType,d.length,i),$=[g,b];o&&$.push(S("b",e[2].dataType,e[2].dims,i));let _=o?"value += b[output_channel];":"",x=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return xe(t,x),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${i};${s};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:l}),getShaderSource:f}}});var Mn,Pd,Qi,Vn=A(()=>{"use strict";R();N();mt();G();Re();Mn=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s[s.length-2],d=a[a.length-1],c=s[s.length-1],l=ee(d),p=ee(c),f=ee(u),m=v.size(n)/l/f,h=e.length>2,y=r?r.slice(0,-2):n.slice(0,-2),g=[v.size(y),u,d],b=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:c}];ve(t,b),b.push(...E(y,s,a)),h&&b.push(...E(e[2].dims)),b.push(...E(g));let $=_=>{let x=Wt("batch_dims",e[0].dataType,y.length),I=S("a",e[0].dataType,s.length,p),T=S("b",e[1].dataType,a.length,l),P=C("output",e[0].dataType,g.length,l),z=X(P.type.tensor),D=_e(t,P.type.value,z),j=[I,T],L="";if(h){let F=o?l:1;j.push(S("bias",e[2].dataType,e[2].dims.length,F)),L=`${o?`value += bias[col / ${F}];`:`value += ${P.type.value}(bias[row + i]);`}`}let q=s.slice(0,-2),ae=a.slice(0,-2),U=Ye(q,y),te=Ye(ae,y),re=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];xe(t,re);let V=(F,H)=>{let K=F.rank,k=F.name;if(K===2)return`var ${k}_indices = ${F.type.indices}(0u, 0u);`;let B=x.rank,Y=`var ${k}_indices: ${F.type.indices};`;for(let Te=K-2-1,me=B-1;Te>=0;Te--,me--)Y+=`
...
`}return F};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${l};${p};${f};${o}`,inputDependencies:h?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:$}},Pd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Qi=e=>{Pd(e.inputs);let t=ke.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];n<8&&r<8?e.compute(Mn(e.inputs,{activation:""},t)):e.compute(Qt(e.inputs,{activation:""},t))}});var Yt,Nn,zd,Wn,Gn,Xi,Od,Bd,Ln,Un=A(()=>{"use strict";N();Wi();Fi();mt();Zi();Re();Vn();je();Yt=(e,t,n,r,o,i)=>{let s=e[0],a=e.slice(i?1:2,i?3:4),u=a.length,d=t[0],l=t.slice(2).map((m,h)=>m+(m-1)*(n[h]-1)),f=a.map((m,h)=>m+r[h]+r[h+u]).map((m,h)=>Math.floor((m-l[h]+o[h])/o[h]));return f.splice(0,0,s),f.splice(i?3:1,0,d),f},Nn=[2,3,1,0],zd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Wn=(e,t)=>{let n=e.kernelShape.slice();for(let i=2;i<t[1].dims.length;++i)n[i-2]===0&&(n[i-2]=t[1].dims[i]);let r=e.pads.slice();qe.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:n,pads:r}),o},Gn=e=>{let t=Kt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,i=e.group,s=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Xi=(e,t,n,r)=>{let o=n.format==="NHWC";if(n.group!==1){if(!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1){let I=Yt(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),T=e.kernelCustomData.wT??e.compute(he(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=T);let P=[t[0],T];t.length===3&&P.push(t[2]),e.compute(ji(P,n,I,r),{inputs:P})}else e.compute(Ki(t,n,r));return}let i=t.length===3,s=t[0].dims[o?1:2],a=t[0].dims[o?2:3],u=t[0].dims[o?3:1],d=t[1].dims[2],c=t[1].dims[3],l=Yt(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o),p=l[o?1:2],f=l[o?2:3],m=l[o?3:1],h=o&&d===s&&c===a&&n.pads[0]===0&&n.pads[1]===0;if(h||d===1&&c===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let x=l[0],I,T,P,z=[];if(o){let L=e.kernelCustomData.wT??e.compute(he(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=L),h){let q=s*a*u;I=t[0].reshape([1,x,q]),T=L.reshape([1,q,m]),P=[1,x,m]}else I=t[0].reshape([x,s*a,u]),T=L.reshape([1,u,m]),P=[x,p*f,m];z.push(I),z.push(T)}else I=t[0].reshape([x,u,s*a]),T=t[1].reshape([1,m,u]),P=[x,m,p*f],z.push(T),z.push(I);i&&z.push(t[2]);let D=P[2],j=z[0].dims[z[0].dims.length-1];D<8&&j<8?e.compute(Mn(z,n,l,P,o,r),{inputs:z}):e.compute(Qt(z,n,l,P,o,r),{inputs:z});return}let y=!0,w=e.kernelCustomData.wT??e.compute(he(t[1],Nn),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=w);let g=[t[0],w];i&&g.push(t[2]);let b=o?p*f:m,$=o?m:p*f,_=d*c*u;e.compute(Ni(g,n,l,b,$,_,i,y,r),{inputs:g})},Od=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],i=[1].concat(t.strides),s=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=Wn({...t,pads:o,strides:i,dilations:s,kernelShape:a},r);Xi(e,r,u,d=>n?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Bd=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",o=Wn(n,t),i=n.autoPad==="NOTSET"?n.pads:n.autoPad,s=Hi(t[0].dims,t[1].dims,n.strides,n.dilations,i,!1,r);e.compute(qi(t,o,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},Ln=(e,t)=>{if(zd(e.inputs,t),e.inputs[0].dims.length===3)Od(e,t);else if(e.inputs[0].dims.length===5)Bd(e,e.inputs,t);else{let n=Wn(t,e.inputs);Xi(e,e.inputs,n)}}});var Dd,Yi,Ji=A(()=>{"use strict";R();De();G();Re();lt();Rn();mt();Dd=(e,t=!1,n,r,o=4)=>{let i=w=>{switch(w){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
...
`)};
    ...
    ${p}`},u=[{type:12,data:s},...E(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},ys=e=>{Xd(e.inputs),e.compute(Jd(e.inputs),{inputs:[0]})}});var el,ws,$s=A(()=>{"use strict";R();N();G();Ft();el=e=>{let t=e[0].dataType,n=v.size(e[0].dims),r=v.size(e[1].dims),o=r%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],l=f=>`
  ...
  ${_.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${f};${m};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:l}],dispatchGroup:{x:w},programUniforms:b}),getShaderSource:I}},Ks=(e,t)=>{vl(e.inputs,t),e.compute(xl(e.inputs,t))},js=e=>M(e)});var Sl,Il,Cl,Tl,Al,kl,El,Pl,Qs,Xs=A(()=>{"use strict";R();N();G();Sl=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Il=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
    ...
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[c,l,p,f,m]=Js(i,o);return c.push(...E(t.dims,i)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(v.size(i)/64)},programUniforms:c}),getShaderSource:h=>ea(h,u,t.dims.length,i.length,o,s,a,t.dataType===10?-65504:-1e5,l,p,f,m)}},la=(e,t)=>{en(e.inputs),e.compute(da("MaxPool",e.inputs[0],!1,t))},ca=e=>{let t=e.storage_order,n=e.dilations,r=na(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:n,...r,cacheKey:""};return{...o,cacheKey:Ol(o)}},pa=e=>{let t=e.format;return{format:t,...sa,cacheKey:t}},ma=(e,t)=>{en(e.inputs),e.compute(da("GlobalMaxPool",e.inputs[0],!0,t))}});var Dl,Rl,ha,ga,ya=A(()=>{"use strict";R();N();ie();G();Dl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,i)=>i===t.axis||o===e[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Rl=(e,t)=>{let n=v.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,o=r===3,i=e[0].dims,s=e[1].dataType,a=v.size(i),u=r===3||r===2,d=u?[Math.ceil(v.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,l=e.length>2?e[2]:void 0,p=l?u?[Math.ceil(v.size(l.dims)/4)]:l.dims:void 0,f=c.length===0||c.length===1&&c[0]===1,m=f===!1&&c.length===1,h=ee(a),y=f&&(!u||h===4),w=y?h:1,g=y&&!u?h:1,b=S("input",u?12:r,d.length,g),$=S("scale",s,c.length),_=l?S("zero_point",u?12:r,p.length):void 0,x=C("output",s,i.length,w),I=[b,$];_&&I.push(_);let T=[d,c];l&&T.push(p);let P=[{type:12,data:a/w},{type:12,data:n},{type:12,data:t.blockSize},...E(...T,i)],z=D=>{let j=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:a})}},ba=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),Q.webgpu.validateInputContent&&Ul(t,n,r),e.compute(Ml(t,n,r,e.inputs[0].dataType),{inputs:[]})}});var Vl,Nl,Wl,Gl,Ll,Hl,ql,Fl,Kl,jl,Zl,$a,Ql,Xl,Yl,Jl,ec,_a,va,xa=A(()=>{"use strict";R();N();ie();G();Vl=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
