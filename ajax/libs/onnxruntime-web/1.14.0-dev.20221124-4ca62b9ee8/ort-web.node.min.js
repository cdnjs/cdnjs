...
`}(o)}
  ...
  `,name:e,type:o.FunctionType.ValueBased}}r.glslAbs=a,r.glslAcos=s,r.glslAsin=u,r.glslAtan=p,r.glslCeil=d,r.glslCos=f,r.glslElu=h,r.glslExp=g,r.glslFloor=m,r.glslClip=b,r.glslIdentity=y,r.glslLeakyRelu=_,r.glslLog=v,r.glslNeg=w,r.glslNot=x,r.glslSin=T,r.glslRelu=O,r.glslSigmoid=S,r.glslSqrt=A,r.glslTan=I,r.glslTanh=E;const D=(o,a,s,e)=>{const t=o.session.pack?c.TextureType.packed:c.TextureType.unpacked,u={name:s.name,inputTypes:[t],inputNames:["A"],cacheHint:e};return Object.assign(Object.assign({},u),{get:()=>{var e=o,t=u,n=a,r=s,i=e.session.pack?c.TextureType.packed:c.TextureType.unpacked,e=l.getGlsl(e.session.backend.glContext.version);return Object.assign(Object.assign({},t),{output:{dims:n.dims,type:n.type,textureType:i},shaderSource:`
   ...
   `;return Object.assign(Object.assign({},h),{hasMain:!0,output:{dims:t.dims,type:t.type,textureType:p.TextureType.unpacked},shaderSource:l})},n.createUnpackProgramInfoLoader=(e,t)=>Object.assign(Object.assign({},h),{get:()=>n.createUnpackProgramInfo(e,t)})},8428:(e,n,t)=>{"use strict";Object.defineProperty(n,"__esModule",{value:!0}),n.parseUnsqueezeAttributes=n.unsqueezeV13=n.unsqueeze=void 0;const r=t(2517),i=(n.unsqueeze=(e,t,n)=>{i(t);n=r.ShapeUtil.unsqueezeShape(t[0].dims,n);return[e.reshapeUnpacked(t[0],n)]},n.unsqueezeV13=(e,t)=>(o(t),n.unsqueeze(e,[t[0]],Array.from(t[1].integerData))),n.parseUnsqueezeAttributes=e=>e.attributes.getInts("axes"),e=>{if(!e||1!==e.length)throw new Error("Unsqueeze requires 1 input.");if("string"===e[0].type)throw new Error("invalid input tensor types.")}),o=e=>{if(!e||2!==e.length)throw new Error("Unsqueeze requires 2 inputs.");if("int32"!==e[1].type)throw new Error("Invalid input type.")}},9793:(e,m,t)=>{"use strict";Object.defineProperty(m,"__esModule",{value:!0}),m.scalesValidation=m.validateInputs=m.parseUpsampleAttributes=m.parseUpsampleAttributesV9=m.parseUpsampleAttributesV7=m.upsample=void 0;const b=t(246),f=t(5060),h=t(2039),g={name:"Upsample",inputNames:["X"],inputTypes:[h.TextureType.unpacked]},r=(m.upsample=(e,t,n)=>(m.validateInputs(t,n),[e.run(Object.assign(Object.assign({},g),{cacheHint:n.cacheKey,get:()=>r(e,t,n)}),t)]),m.parseUpsampleAttributesV7=e=>m.parseUpsampleAttributes(e,7),m.parseUpsampleAttributesV9=e=>m.parseUpsampleAttributes(e,9),m.parseUpsampleAttributes=(e,t)=>{var n=10<=t,r=e.attributes.getString("mode","nearest");if("nearest"!==r&&"linear"!==r&&(t<11||"cubic"!==r))throw new Error("unrecognized mode: "+r);let i=[];t<9&&(i=e.attributes.getFloats("scales"),m.scalesValidation(i,r,n));var o=e.attributes.getFloat("extrapolation_value",0),a=10<t?e.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(-1===["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(a))throw new Error(`coordinate_transform_mode '${a}' is not supported`);var s="tf_crop_and_resize"===a,u=s,l="nearest"===r&&11<=t?e.attributes.getString("nearest_mode","round_prefer_floor"):"";if(-1===["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l))throw new Error(`nearest_mode '${l}' is not supported`);var c=e.attributes.getFloat("cubic_coeff_a",-.75),p=0!==e.attributes.getInt("exclude_outside",0);if(p&&"cubic"!==r)throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");var d=t<11||"nearest"===r&&"asymmetric"===a&&"floor"===l;let f=0,h=0,g=0;return 10<t?g=2<e.inputs.length?(f=1,h=2,3):(h=1,2):9===t&&(h=1),b.createAttributeWithCacheKey({opset:t,isResize:n,mode:r,scales:i,extrapolationValue:o,coordinateTransformMode:a,useExtrapolation:u,needRoiInput:s,nearestMode:l,cubicCoefficientA:c,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:f,scalesInputIdx:h,sizesInputIdx:g})},(e,t,n)=>{const r=f.getGlsl(e.session.backend.glContext.version),[i,o]=e.calculateTextureWidthAndHeight(t[0].dims,h.TextureType.unpacked),a=t[0].dims.map((e,t)=>Math.floor(e*n.scales[t])),[s,u]=e.calculateTextureWidthAndHeight(a,h.TextureType.unpacked),l=a.length,c=new Array(l),p=new Array(l);let d=`
