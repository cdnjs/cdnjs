...
`}var Zw,Yw,qf,Kf=E(()=>{"use strict";Me();je();Pe();Gr();Zw=r=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${r}`}),Yw=(r,e,n,t)=>{let o=e.dims,i=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:e,type:0}}var Bt,wv,sd,ud,ld,cd,fd,dd,pd,md,hd,bd,gd,yd,xd=E(()=>{"use strict";Me();dr();je();Pe();Bt=(r,e,n,t=e[0].type,o)=>{let i=r.session.pack?2:0;return{name:n.name,inputNames:["A","B"],inputTypes:[i,i],cacheHint:o,get:()=>wv(r,e,n,t)}},wv=(r,e,n,t=e[0].type)=>{let o=r.session.pack?2:0,i=!ee.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=r.session.pack;if(i){let f=ht.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let c=s.length,p=e[0].dims.length!==0?e[0].dims.length:1,g=e[1].dims.length!==0?e[1].dims.length:1,b=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",h=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",v=ae(r.session.backend.glContext.version),T=a?`
    ...
    `;return{name:n.name,inputNames:["A","B"],inputTypes:[o,o],output:{dims:e[0].dims,type:t,textureType:o},shaderSource:l,hasMain:!0}},sd=(r,e)=>[r.run(Bt(r,e,sv()),e)],ud=(r,e)=>[r.run(Bt(r,e,mv(),"bool"),e)],ld=(r,e)=>[r.run(Bt(r,e,uv()),e)],cd=(r,e)=>[r.run(Bt(r,e,fv(),"bool"),e)],fd=(r,e)=>[r.run(Bt(r,e,dv(),"bool"),e)],dd=(r,e)=>[r.run(Bt(r,e,pv(),"bool"),e)],pd=(r,e)=>[r.run(Bt(r,e,lv()),e)],md=(r,e)=>[r.run(Bt(r,e,hv(),"bool"),e)],hd=(r,e)=>[r.run(Bt(r,e,gv()),e)],bd=(r,e)=>[r.run(Bt(r,e,yv()),e)],gd=(r,e)=>[r.run(Bt(r,e,cv()),e)],yd=(r,e)=>[r.run(Bt(r,e,bv(),"bool"),e)]});var wd,vd,Tv,Td=E(()=>{"use strict";Me();wd=(r,e,n)=>(Tv(e),[r.cast(e[0],n)]),vd=r=>dt.tensorDataTypeFromProto(r.attributes.getInt("to")),Tv=r=>{if(!r||r.length!==1)throw new Error("Cast requires 1 input.");if(r[0].type==="string")throw new Error("Invalid input type.")}});var _v,Iv,_d,Wo,Id=E(()=>{"use strict";je();Pe();Jt();Gr();_v=(r,e)=>({name:"Concat (packed)",inputNames:Array.from({length:r},(n,t)=>`X${t}`),inputTypes:Array(r).fill(2),cacheHint:e}),Iv=(r,e,n,t)=>{let o=n[0].dims.slice();if(t>=o.length||t<-1*o.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=o.length+t);let i=o.slice(0);for(let A=1;A<n.length;A++){let C=n[A].dims.slice();for(let B=0;B<o.length;B++)if(B===t)i[t]+=C[B];else if(o[B]!==C[B])throw new Error("non concat dimensions must match")}let s=i.length,a=dn("coords",s),u=bt(s),l=Qt(),f=n.map(A=>A.dims),c=Ut(s),p=new Array(f.length-1);p[0]=f[0][t];for(let A=1;A<p.length;A++)p[A]=p[A-1]+f[A][t];let g=c[t],b=c.slice(-2),h=c.join(),v=`if (${g} < ${p[0]}) {
        ...
        `;return{...e,output:{dims:i,type:n[0].type,textureType:2},shaderSource:$,hasMain:!0}},_d=(r,e,n)=>{let t=_v(e.length,n.cacheKey);return{...t,get:()=>Iv(r,t,e,n.axis)}},Wo=(r,e,n)=>{let t=r.indexOf(e);return r.map((i,s)=>s===t?`${i} - ${n}`:i).join()}});var Sd,Sv,$v,Av,$d,Pv,Ov,Cv,Ad,Ev,Pd=E(()=>{"use strict";ut();Pe();Id();Sd=(r,e,n)=>(Ev(e),r.session.pack&&e[0].dims.length>1?[r.run(_d(r,e,n),e)]:[r.run(Av(r,e,n),e)]),Sv=(r,e)=>({name:"Concat",inputNames:Array.from({length:r},(n,t)=>`X${t}`),inputTypes:Array(r).fill(0),cacheHint:e}),$v=(r,e,n,t)=>{let o=n[0].dims.slice();if(t>=o.length||t<-1*o.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=o.length+t);let i=o.slice(0);for(let g=1;g<n.length;g++){let b=n[g].dims.slice();for(let h=0;h<o.length;h++)if(h===t)i[t]+=b[h];else if(o[h]!==b[h])throw new Error("non concat dimensions must match")}let s=i.length,a=new Array(n.length),u=0;for(let g=0;g<a.length;++g)u+=n[g].dims[t],a[g]=u;let l="";n.length<5?l=$d(a):l=Pv(a);let f=Ov(n.length,s),c=Cv(a),p=`
        ${f}
        ${c}
        ${l}
...
vec4 getBAtOutCoordsMatmul(int i) {
  ...
  return outputValue;
}`}function lT(r,e){let n="";for(let t=0;t<e-2;t++)n+=`rc.${r[t]}, `;return n+=`rc.${r[e-2]}, i*2`,n}function cT(r,e){let n="";for(let t=0;t<e-2;t++)n+=`rc.${r[t]}, `;return n+=`i*2, rc.${r[e-1]}`,n}var aT,sT,jo,ps=E(()=>{"use strict";Me();je();Pe();Jt();Ur();qo();aT=(r,e)=>({name:"MatMul (packed)",inputNames:r?["A","B","Bias"]:["A","B"],inputTypes:r?[2,2,2]:[2,2],cacheHint:e}),sT=(r,e,n,t)=>{let o=n.length>2,i=o?"value += getBiasForMatmul();":"",s=n[0].dims,a=n[1].dims,u=ht.calcShape(s,a,!0),l=!ee.areEqual(n[0].dims,n[1].dims);if(!u)throw new Error("Can't use matmul on the given tensors");let f=s[s.length-1],c=Math.ceil(f/2),p=s.length,g=a.length,b=ae(r.session.backend.glContext.version),h=bt(u.length),v=u.length,T=Ut(),{activationFunction:w,applyActivation:_}=er(t),$=o?`${ds(h,T,n[2].dims,u,!0)}`:"",A=l?`${uT(h,T,n,u)}`:"",C=l?"getAAtOutCoordsMatmul(i)":`getA(${lT(T,p)})`,B=l?"getBAtOutCoordsMatmul(i)":`getB(${cT(T,g)})`,R=l?"":`${h} rc =
      ...
      `,F=`
            ...
            void main() {
              ...
              ${_}
              ${b.output} = value;
            }`;return{...e,output:{dims:u,type:n[0].type,textureType:2},shaderSource:F,hasMain:!0}},jo=(r,e,n)=>{let t=aT(e.length>2,n.activationCacheKey);return{...t,get:()=>sT(r,t,e,n)}}});var op,ip=E(()=>{"use strict";Ho();tp();ps();op=(r,e,n)=>{let t=e[0].dims,o=e[1].dims,i=mn(t,o,n.dilations,n.pads,n.strides),s=r.run(ep(r,e[0],e[1],i,n),[e[0]]),a=r.reshapePacked(e[1],[o[0],o[1]*o[2]*o[3]]),u=e.length===3?[a,s,e[2]]:[a,s],l=r.run(jo(r,u,n),u);return r.reshapePacked(l,i)}});var fT,dT,ap,ms,hs=E(()=>{"use strict";Pe();fT=r=>({name:"Im2Col",inputNames:["X"],inputTypes:[0],cacheHint:r}),dT=(r,e,n,t,o,i)=>{let s=n.dims,a=t.dims,u=o.length,l=ms(s,a,o,4),f=`
        const int XC = ${s[1]};
        const int XH = ${s[2]};
        const int XW = ${s[3]};
...
`)},jT=r=>{if(!r||r.length!==1)throw new Error("ImageScaler requires 1 input.");if(r[0].dims.length!==4)throw new Error("Invalid input shape.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")}});var kp,Dp,Ep,KT,XT,ZT,YT,JT,QT,Bp=E(()=>{"use strict";je();Pe();kp=(r,e,n)=>{QT(e);let t=r.run(XT(e[0]),e);return[r.run(JT(r,e[0],n,t.dims),[e[0],t,e[1],e[2]])]},Dp=r=>r.attributes.getFloat("epsilon",1e-5),Ep={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},KT=(r,e)=>{let n=e.dims.slice(),t=n[1],o=n[2]*n[3],i=[n[0],t],s=`
    ...
    `;return{...e,output:{dims:i,type:r[0].type,textureType:0},shaderSource:l}},Jp=(r,e,n)=>{let t=r[0].dims.slice(),o=Object.hasOwnProperty.call(e,"dilations"),i=e.kernelShape.slice(),s=e.strides.slice(),a=o?e.dilations.slice():[],u=e.pads.slice();zr.adjustPoolAttributes(n,t,i,s,a,u);let l=zr.computePoolOutputShape(n,t,s,a,i,u,e.autoPad),f=Object.assign({},e);return o?Object.assign(f,{kernelShape:i,strides:s,pads:u,dilations:a,cacheKey:e.cacheKey}):Object.assign(f,{kernelShape:i,strides:s,pads:u,cacheKey:e.cacheKey}),[f,l]},d_={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},Up={name:"GlobalMaxPool",inputNames:["X"],inputTypes:[0]},Qp=(r,e)=>(Zo(e),[r.run({...Up,get:()=>Yp(e,Up,!0,d_)},e)]),Zo=r=>{if(!r||r.length!==1)throw new Error("Pool ops requires 1 input.");if(r[0].type!=="float32"&&r[0].type!=="float64")throw new Error("Invalid input type.")},em=(r,e,n,t,o)=>{let i=r.length;if(e.kernelShape.length<=2){let s=e.kernelShape[e.kernelShape.length-1],a=e.strides[e.strides.length-1],u=e.pads[e.pads.length/2-1],l=e.pads[e.pads.length-1],f=r[i-1],c="",p="",g="";if(u+l!==0?c=`
      ...
      `}else{let s=ee.size(e.kernelShape),a=ee.computeStrides(e.kernelShape),u=a.length,l=e.pads.length,f=p_(u),c=Xo(r,"inputDims"),p=Xo(e.pads,"pads"),g=Xo(a,"kernelStrides"),b=Xo(e.strides,"strides"),h=e.pads.reduce((w,_)=>w+_),v="";return h?v=`
...
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},N2=(r,e)=>{or(r.inputs),ir(r,"ReduceProd",e,(t,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},R2=(r,e)=>{or(r.inputs),ir(r,"ReduceSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},z2=(r,e)=>{or(r.inputs),ir(r,"ReduceSumSquare",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},ar=(r,e,n)=>{if(e.length===0)return n;let t=1,o=1;for(let i=0;i<e.length;i++)e.indexOf(i)===-1?t*=r[i]:o*=r[i];return o<32&&t>1024},fb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?B2(r,e):eb(r,e)},db=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?C2(r,e):tb(r,e)},pb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?E2(r,e):rb(r,e)},mb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?k2(r,e):nb(r,e)},hb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?D2(r,e):ob(r,e)},bb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?L2(r,e):ib(r,e)},gb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?N2(r,e):ab(r,e)},yb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?R2(r,e):sb(r,e)},xb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?z2(r,e):ub(r,e)},wb=(r,e)=>{ar(r.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?O2(r,e):lb(r,e)}});var vb,Tb,_b,tu,Ib=E(()=>{"use strict";fe();Ze();Bi();vb=r=>{if(!r||r.length===0||r.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(r[0].dataType!==1)throw new Error("Invalid input type.")},Tb=(r,e)=>{vb(r.inputs);let n=(t,o,i)=>{let s=[];for(let a=0;a<t.rank;a++)(i.indexOf(a)>=0||i.length===0)&&s.push(`input_indices[${a}] = 0;`);return[`${s.join(`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`}},Pb=r=>{j2(r.inputs),r.compute(K2(r.inputs))}});var X2,Be,Cb,Eb,kb,Db,Bb,Lb,Nb,Rb,zb,Z2,Mb,Vb,Fb,Gb,Xn,Ub,Ri,Wb,Hb,qb,jb,Kb,Xb,Zb,Yb,Jb,Qb,eg,tg,rg,ng,og,ig,ag,sg,nu,ou,ug,lg,cg,Y2,J2,fg,zi=E(()=>{"use strict";fe();ge();Ze();ye();X2=(r,e,n,t,o,i,s)=>{let a=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=L("inputData",n,[a],4),f=G("outputData",t,[a],4),c=[{name:"vec_size",type:"u32"}];return s&&c.push(...s),`
...
`,J2=r=>`quick_gelu_impl(${r})`,fg=(r,e)=>{let n=ot(r.inputs[0].dataType);r.compute(Be(r.inputs[0],"QuickGelu",J2,Y2(n,e.alpha),e.cacheKey,r.inputs[0].dataType))}});var Q2,e1,pg,mg=E(()=>{"use strict";ge();ye();zi();Q2=r=>{if(r[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(r[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(r[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(r[0].dims[2]!==r[1].dims[0])throw new Error("last dimension of input and bias are not the same")},e1=r=>{let e=r[0].dims.slice();e[2]=e[2]/2;let n=L("input",r[0].dataType,r[0].dims,4),t=L("bias",r[0].dataType,[r[0].dims[2]],4),o=G("output",r[0].dataType,e,4),i=k.size(e)/4,s=De(r[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
...
`});var u1,l1,Yn,Og,c1,Jn,f1,Qn,eo=E(()=>{"use strict";fe();ge();ye();mr();Zn();u1=(r,e)=>r?`
...
`},f1=(r,e,n,t,o,i=!1)=>{let[s,a,u]=o,[l,f,c,p]=t,g=xn(s,u),b=xn(a,u),h=De(t[0].type.tensor),v=()=>{let _=f.rank,$=l.rank,A=`var aIndices: ${f.type.indices};`;for(let C=_-2-1,B=$-1;C>=0;C--,B--)A+=`
...
bIndices[${_-2}] = u32(row);
  ...
  ${h?Yn(v,T,ce,we):Jn(v,T,ce,we)}
    ...
    }`},Cg=(r,e,n,t,o,i,s,a,u)=>{let l=e.format==="NHWC",f=l?r[0].dims[3]:r[0].dims[1],c=n[0],p=l?n[2]:n[3],g=l?n[1]:n[2],b=l?n[3]:n[1],h=l&&(f%4===0||f%3===0)&&b%4===0,v=l?b:p*g,T=l?p*g:b,w=[8,8,1],_=t<=8?[4,1,1]:[4,4,1],$=[Math.ceil(v/w[0]/_[0]),Math.ceil(T/w[1]/_[1]),Math.ceil(c/w[2]/_[2])];Te("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${$}`);let A=h?l&&f%4!==0?3:4:1,C=w[1]*_[1],B=w[0]*_[0],R=Math.max(w[0]*A,w[1]),F=t%C===0,q=o%B===0,V=i%R===0,te=h?[A,4,4]:[1,1,1],j=[{type:6,data:t},{type:6,data:o},{type:6,data:i},{type:6,data:[e.pads[0],e.pads[1]]},{type:6,data:e.strides},{type:6,data:e.dilations}];St(e,j),j.push(...H(r[0].dims,r[1].dims));let le=["rank","rank"];s&&(j.push(...H(r[2].dims)),le.push("rank")),j.push(...H(n));let we=ce=>{let he=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];$t(e,he);let se=h?4:1,ue=De(r[0].dataType),Le=`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${e.cacheKey};${i};${s};${p};${l[0]};${l[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:t?t(n):n,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:g}}});var au,b1,Vg,su=E(()=>{"use strict";fe();ge();eo();ye();mr();au=(r,e,n,t,o=!1,i)=>{let s=r[0].dims,a=r[1].dims,u=s[s.length-2],l=a[a.length-1],f=s[s.length-1],c=Ge(l),p=Ge(f),g=Ge(u),b=k.size(n)/c/g,h=r.length>2,v=t?t.slice(0,-2):n.slice(0,-2),w=[k.size(v),u,l],_=[{type:12,data:b},{type:12,data:u},{type:12,data:l},{type:12,data:f}];St(e,_),_.push(...H(v,s,a)),h&&_.push(...H(r[2].dims)),_.push(...H(w));let $=A=>{let C=Di("batch_dims",r[0].dataType,v.length),B=L("a",r[0].dataType,s.length,p),R=L("b",r[1].dataType,a.length,c),F=G("output",r[0].dataType,w.length,c),q=De(F.type.tensor),V=It(e,F.type.value,q),te=[B,R],j="";if(h){let Ne=o?c:1;te.push(L("bias",r[2].dataType,r[2].dims.length,Ne)),j=`${o?`value += bias[col / ${Ne}];`:`value += ${F.type.value}(bias[row + i]);`}`}let le=s.slice(0,-2),we=a.slice(0,-2),ce=xn(le,v),he=xn(we,v),se=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];$t(e,se);let ue=(Ne,Ie)=>{let me=Ne.rank,U=Ne.name;if(me===2)return`var ${U}_indices = ${Ne.type.indices}(0u, 0u);`;let Y=C.rank,Se=`var ${U}_indices: ${Ne.type.indices};`;for(let ct=me-2-1,Ce=Y-1;ct>=0;ct--,Ce--)Se+=`
...
`}return Ne};return`
  ...
  }`},Ug=(r,e,n,t,o,i,s,a)=>{let u=e.format==="NHWC",l=u?r[0].dims[3]:r[0].dims[1],f=n[0],c=u?n[2]:n[3],p=u?n[1]:n[2],g=u?n[3]:n[1],b=u&&l%4===0&&l%3&&g%4===0,h=u?g:c*p,v=u?c*p:g,T=[8,8,1],w=t<=8?[4,1,1]:[4,4,1],_=[Math.ceil(h/T[0]/w[0]),Math.ceil(v/T[1]/w[1]),Math.ceil(f/T[2]/w[2])];Te("verbose",()=>`[conv_backprop_mm_webgpu] dispatch = ${_}`);let $=b?4:1,A=Math.max(T[0]*$,T[1]),C=b?4:1,B=[e.kernelShape[u?1:2],e.kernelShape[u?2:3]],R=[B[0]+(e.dilations[0]<=1?0:(B[0]-1)*(e.dilations[0]-1)),B[1]+(e.dilations[1]<=1?0:(B[1]-1)*(e.dilations[1]-1))],F=[R[0]-1-Math.floor((e.pads[0]+e.pads[2])/2),R[1]-1-Math.floor((e.pads[1]+e.pads[3])/2)],q=[{type:6,data:t},{type:6,data:o},{type:6,data:i},{type:6,data:e.strides},{type:6,data:e.dilations},{type:6,data:B},{type:6,data:F}];St(e,q),q.push(...H(r[0].dims,r[1].dims));let V=["rank","rank"];s&&(q.push(...H(r[2].dims)),V.push("rank")),q.push(...H(n));let te=j=>{let le=L("x",r[0].dataType,r[0].dims.length,C),we=L("w",r[1].dataType,r[1].dims.length,1),ce=G("result",r[0].dataType,n.length,C),he=[le,we],se="";if(s){let Ne=L("bias",r[2].dataType,r[2].dims.length,C);he.push(Ne),se+=`
...
`)};
    ...
    ${p}`},u=[{type:12,data:s},...H(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:t,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},uy=r=>{R1(r.inputs),r.compute(M1(r.inputs),{inputs:[0]})}});var V1,cy,fy=E(()=>{"use strict";fe();ge();ye();zi();V1=r=>{let e=r[0].dataType,n=k.size(r[0].dims),t=k.size(r[1].dims),o=t%4===0,i=s=>{let a=L("x",e,[1],4),u=L("bias",e,[1],4),l=G("y",e,[1],4),f=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=g=>`
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${o}`,inputDependencies:["type","type"]},getShaderSource:i,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:t}],dispatchGroup:{x:Math.ceil(n/Kr/4)}})}},cy=r=>{r.inputs.length<2||k.size(r.inputs[1].dims)===0?ug(r):r.compute(V1(r.inputs))}});var F1,G1,dy,py,my=E(()=>{"use strict";fe();ge();Ze();ye();F1=r=>{if(!r||r.length!==2)throw new Error("Gather requires 2 inputs.")},G1=(r,e)=>{let n=r[0].dims,t=r[1].dims,o=n.length,i=k.normalizeAxis(e.axis,o),s=n.slice(0);s.splice(i,1,...t);let a=n[i],u=r[0].dataType===9?4:1,l=Math.ceil(k.size(s)/u),f=[{type:12,data:l},{type:6,data:a},{type:12,data:i},...H(r[0].dims,r[1].dims,s)],c=p=>{let g=L("data",r[0].dataType,r[0].dims.length,u),b=L("inputIndices",r[1].dataType,r[1].dims.length),h=G("output",r[0].dataType,s.length,u),v=w=>{let _=t.length,$=`var indicesIndices${w}  = ${b.type.indices}(0);`;for(let A=0;A<_;A++)$+=`${_>1?`indicesIndices${w}[${A}]`:`indicesIndices${w}`} = ${s.length>1?`outputIndices${w}[uniforms.axis + ${A}]`:`outputIndices${w}`};`;$+=`
...
`)}
  ...
  }`};return r.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${a};${p}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:b,dataType:1}],dispatchGroup:{x:c},programUniforms:v}),getShaderSource:T},{inputs:[e,n,t],outputs:[-1]})[0]},iI=(r,e,n)=>{let t=e[0].dims,o=t,i=2,s=t[0],a=t[1],u=k.sizeFromDimension(t,i),l=Ge(u),f=k.size(o)/l,c=ky(r,e[0],e[1],e[2],s,u,a,n.epsilon),p=[s,a,u/l],g=[s,a],b=["type","none"],h=v=>{let T=L("x",e[0].dataType,p.length,l),w=L("scale_shift",1,g.length,2),_=G("output",e[0].dataType,p.length,l),$=[T,w,_];return`
  ...
  }`};r.compute({name:"InstanceNormalization",shaderCache:{hint:`${l}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(f/64)},programUniforms:[{type:12,data:f},...H(p,g,p)]}),getShaderSource:h},{inputs:[e[0],c]})},aI=(r,e,n)=>{let t=e[0].dims,o=t,i=t[0],s=t[t.length-1],a=k.sizeFromDimension(t,1)/s,u=Ge(s),l=k.size(o)/u,f=[{type:12,data:a},{type:12,data:Math.floor(s/u)}],c=["type","type"],p=!1,g=[0,t.length-1];for(let T=0;T<t.length-2;T++)p=p||t[T+1]!==1,g.push(T+1);p=p&&t[t.length-1]!==1;let b=p?r.compute(it(r.inputs[0],g),{inputs:[r.inputs[0]],outputs:[-1]})[0]:r.inputs[0].reshape(Array.from({length:t.length},(T,w)=>t[g[w]])),h=ky(r,b,e[1],e[2],i,a,s,n.epsilon),v=T=>{let w=De(e[0].dataType),_=u===1?"vec2f":`mat${u}x2f`,$=B=>{let R=B===0?"x":"y",F=u===1?"f32":`vec${u}f`;switch(u){case 1:return`${w}(${F}(scale.${R}))`;case 2:return`vec2<${w}>(${F}(scale[0].${R}, scale[1].${R}))`;case 4:return`vec4<${w}>(${F}(scale[0].${R}, scale[1].${R}, scale[2].${R}, scale[3].${R}))`;default:throw new Error(`Not supported compoents ${u}`)}},A=L("input",e[0].dataType,e[0].dims,u),C=G("output",e[0].dataType,o,u);return`
  ...
  ${A.mainStart()}
    ...
    `,a="",u=L("x",e.dataType,e.dims.length),l=["rank"],[f,c,p,g,b]=Uy(i,o);return f.push(...H(e.dims,i)),{name:r,shaderCache:{hint:`${t.cacheKey};${p};${g};${b}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(k.size(i)/64)},programUniforms:f}),getShaderSource:h=>Wy(h,u,e.dims.length,i.length,o,s,a,e.dataType===10?-65504:-1e5,c,p,g,b)}},ex=(r,e)=>{Wi(r.inputs),r.compute(Qy("MaxPool",r.inputs[0],!1,e))},tx=r=>{let e=r.storage_order,n=r.dilations,t=qy(r);if(e!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(t.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:e,dilations:n,...t,cacheKey:""};return{...o,cacheKey:vI(o)}},rx=r=>{let e=r.format;return{format:e,...Zy,cacheKey:e}},nx=(r,e)=>{Wi(r.inputs),r.compute(Qy("GlobalMaxPool",r.inputs[0],!0,e))}});var _I,II,ix,ax,sx=E(()=>{"use strict";fe();ge();Ze();ye();_I=(r,e)=>{if(r.length<2||r.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(r.length===3&&r[1].dims===r[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(r.length===3&&r[0].dataType!==r[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(r[0].dataType===6&&r.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(r[1].dims.length!==0&&r[1].dims.length!==1&&r[1].dims.length!==r[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(r.length>2){if(r[0].dataType!==r[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(r[1].dims.length!==r[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!r[1].dims.map((n,t)=>n===r[2].dims[t]).reduce((n,t)=>n&&t,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(e.blockSize>0){if(r[1].dims.length===0||r[1].dims.length===1&&r[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!r[1].dims.map((o,i)=>i===e.axis||o===r[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(r[1].dims.length!==r[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=r[0].dims[e.axis],t=r[1].dims[e.axis];if(e.blockSize<Math.ceil(n/t)||e.blockSize>Math.ceil(n/(t-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},II=(r,e)=>{let n=k.normalizeAxis(e.axis,r[0].dims.length),t=r[0].dataType,o=t===3,i=r[0].dims,s=r[1].dataType,a=k.size(i),u=t===3||t===2,l=u?[Math.ceil(k.size(r[0].dims)/4)]:r[0].dims,f=r[1].dims,c=r.length>2?r[2]:void 0,p=c?u?[Math.ceil(k.size(c.dims)/4)]:c.dims:void 0,g=f.length===0||f.length===1&&f[0]===1,b=g===!1&&f.length===1,h=Ge(a),v=g&&(!u||h===4),T=v?h:1,w=v&&!u?h:1,_=L("input",u?12:t,l.length,w),$=L("scale",s,f.length),A=c?L("zero_point",u?12:t,p.length):void 0,C=G("output",s,i.length,T),B=[_,$];A&&B.push(A);let R=[l,f];c&&R.push(p);let F=[{type:12,data:a/T},{type:12,data:n},{type:12,data:e.blockSize},...H(...R,i)],q=V=>{let te=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:e.cacheKey,inputDependencies:A?["rank","rank","rank"]:["rank","rank"]},getShaderSource:q,getRunData:()=>({outputs:[{dims:i,dataType:s}],dispatchGroup:{x:Math.ceil(a/T/64),y:1,z:1},programUniforms:F})}},ix=(r,e)=>{_I(r.inputs,e),r.compute(II(r.inputs,e))},ax=r=>de({axis:r.axis,blockSize:r.blockSize})});var SI,$I,ux,lx=E(()=>{"use strict";pt();fe();ye();SI=(r,e,n)=>{let t=r===e,o=r<e&&n<0,i=r>e&&n>0;if(t||o||i)throw new Error("Range these inputs' contents are invalid.")},$I=(r,e,n,t)=>{let o=Math.abs(Math.ceil((e-r)/n)),i=[o],s=o,a=[{type:12,data:s},{type:t,data:r},{type:t,data:n},...H(i)],u=l=>{let f=G("output",t,i.length),c=f.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
...
`:"",zI=(r,e,n,t,o)=>{let[s,a,u,l]=n.length===2?[-1,0,1,-1]:[0,2,3,1],f=r.type.value;return`
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    }`},FI=(r,e,n,t,o,i)=>{let s=r.dims,a=kI(i,e.axes,s.length),u=DI(s,t,o,e.axes),l=t.slice();t.length===0&&(l=s.map((w,_)=>w===0?1:u[_]/w),e.keepAspectRatioPolicy!=="stretch"&&(u=BI(s,l,e)));let f=G("output",r.dataType,u.length),c=L("input",r.dataType,s.length),p=k.size(u),g=s.length===u.length&&s.every((w,_)=>w===u[_]),b=e.coordinateTransformMode==="tf_crop_and_resize",h=e.extrapolationValue,v=c.type.value,T=w=>`
      ${g?"":`
