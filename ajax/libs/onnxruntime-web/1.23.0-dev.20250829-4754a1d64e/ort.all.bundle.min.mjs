  ...
  ${y.mainStart()}
    ...
    ${w.setByOffset("global_idx",T.getByIndices("aIndices"))}
       ...
       `,g=y=>`
        ...
        }`;return{name:n,shaderCache:{hint:`${e};${h}`,inputDependencies:["type"]},getShaderSource:g,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Vr=(n,e,r,t)=>{let o=n.inputs.length===1?r:xc(n.inputs,r),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=n.inputs[0].dims.map((m,g)=>g));let a=D.normalizeAxes(i,n.inputs[0].dims.length),s=a,u=n.inputs[0],l=kE(s,n.inputs[0].dims.length);l.length>0&&(u=n.compute(st(n.inputs[0],l),{inputs:[0],outputs:[-1]})[0],s=PE(s.length,u.dims.length));let[c,p]=EE(u.dims,s),h=c;o.keepDims&&(h=CE(c,a)),n.compute(NE(e,o.cacheKey,[u],t,n.inputs[0].dataType,h,p),{inputs:[u]})},N_=(n,e)=>{Vr(n,"ReduceMeanShared",e,"mean")},L_=(n,e)=>{Vr(n,"ReduceL1Shared",e,"l1")},R_=(n,e)=>{Vr(n,"ReduceL2Shared",e,"l2")},z_=(n,e)=>{Vr(n,"ReduceLogSumExpShared",e,"logSumExp")},M_=(n,e)=>{Vr(n,"ReduceMaxShared",e,"max")},B_=(n,e)=>{Vr(n,"ReduceMinShared",e,"min")},F_=(n,e)=>{Vr(n,"ReduceProdShared",e,"prod")},V_=(n,e)=>{Vr(n,"ReduceSumShared",e,"sum")},G_=(n,e)=>{Vr(n,"ReduceSumSquareShared",e,"sumSquare")},U_=(n,e)=>{Vr(n,"ReduceLogSumShared",e,"logSum")}});var Gr,LE,Ma,xc,Ur,RE,zE,ME,BE,FE,VE,GE,UE,WE,HE,Wr,H_,q_,j_,K_,X_,Z_,J_,Q_,Y_,e0,za=N(()=>{"use strict";ue();pe();Je();he();W_();Gr=n=>{if(!n||n.length===0||n.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(n.length===2&&n[1].dims.length!==1)throw new Error("Invalid axes input dims.")},LE=n=>["","",`var value = ${n.getByIndices("input_indices")};`,""],Ma=(n,e,r,t,o,i,a=!1,s=!1)=>{let u=[],l=r[0].dims,c=l.length,p=D.normalizeAxes(o,c),h=!s&&p.length===0;l.forEach((T,w)=>{h||p.indexOf(w)>=0?a&&u.push(1):u.push(T)});let m=u.length,g=D.size(u);return{name:n,shaderCache:e,getShaderSource:T=>{let w=[],x=z("_A",r[0].dataType,c),I=V("output",i,m),A=t(x,I,p),P=A[2];for(let C=0,R=0;C<c;C++)h||p.indexOf(C)>=0?(a&&R++,P=`for(var j${C}: u32 = 0; j${C} < ${l[C]}; j${C}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:u,dataType:i}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:[{type:12,data:g},...U(l,u)]})}},xc=(n,e)=>{let r=[];return n[1].dims[0]>0&&n[1].getBigInt64Array().forEach(t=>r.push(Number(t))),le({axes:r,keepDims:e.keepDims,noopWithEmptyAxes:e.noopWithEmptyAxes})},Ur=(n,e,r,t)=>{let o=n.inputs,i=o.length===1?r:xc(o,r);n.compute(Ma(e,{hint:i.cacheKey,inputDependencies:["rank"]},[o[0]],i.noopWithEmptyAxes&&i.axes.length===0?LE:t,i.axes,o[0].dataType,i.keepDims,i.noopWithEmptyAxes),{inputs:[0]})},RE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceLogSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,"value = log(value);"])},zE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceL1",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += abs(${t.getByIndices("input_indices")});`,""])},ME=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceL2",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])},BE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceLogSumExp",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += exp(${t.getByIndices("input_indices")});`,"value = log(value);"])},FE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceMax",e,(t,o,i)=>{let a=[];for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&a.push(t.indicesSet("input_indices",s,0));return[`${a.join(`
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = max(value, ${t.getByIndices("input_indices")});`,""]})},VE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceMean",e,(t,o,i)=>{let a=1;for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&(a*=n.inputs[0].dims[s]);return["var sum = f32(0);","",`sum += f32(${t.getByIndices("input_indices")});`,`let value = ${o.type.value}(sum / ${a});`]})},GE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceMin",e,(t,o,i)=>{let a=[];for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&a.push(`input_indices[${s}] = 0;`);return[`${a.join(`
`)}`,`var value = ${t.getByIndices("input_indices")};`,`value = min(value, ${t.getByIndices("input_indices")});`,""]})},UE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceProd",e,(t,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${t.getByIndices("input_indices")};`,""])},WE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceSum",e,(t,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${t.getByIndices("input_indices")};`,""])},HE=(n,e)=>{Gr(n.inputs),Ur(n,"ReduceSumSquare",e,(t,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${t.getByIndices("input_indices")}; value += t * t;`,""])},Wr=(n,e,r)=>{if(e.length===0)return r;let t=1,o=1;for(let i=0;i<e.length;i++)e.indexOf(i)===-1?t*=n[i]:o*=n[i];return o<32&&t>1024},H_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?VE(n,e):N_(n,e)},q_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?zE(n,e):L_(n,e)},j_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?ME(n,e):R_(n,e)},K_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?BE(n,e):z_(n,e)},X_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?FE(n,e):M_(n,e)},Z_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?GE(n,e):B_(n,e)},J_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?UE(n,e):F_(n,e)},Q_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?WE(n,e):V_(n,e)},Y_=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?HE(n,e):G_(n,e)},e0=(n,e)=>{Wr(n.inputs[0].dims,e.axes,e.noopWithEmptyAxes)?RE(n,e):U_(n,e)}});var t0,r0,n0,Tc,o0=N(()=>{"use strict";ue();Je();za();t0=n=>{if(!n||n.length===0||n.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(n[0].dataType!==1)throw new Error("Invalid input type.")},r0=(n,e)=>{t0(n.inputs);let r=(t,o,i)=>{let a=[];for(let s=0;s<t.rank;s++)(i.indexOf(s)>=0||i.length===0)&&a.push(`input_indices[${s}] = 0;`);return[`${a.join(`
...
var best_index : i32 = 0;`,`if (${t.getByIndices("input_indices")} ${e.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${e.epsilon}_${e.format}_${t}_${a}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:x,getRunData:()=>({outputs:[{dims:n[0].dims,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...U(i)]:[{type:12,data:u}]})}},YE=n=>le(n),a0=(n,e)=>{let{inputs:r,outputCount:t}=n,o=YE({...e,outputCount:t});if(de.webgpu.validateInputContent&&JE(r,o),e.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");n.compute(QE(r,o))}});var e3,t3,u0,l0=N(()=>{"use strict";pe();he();e3=n=>{if(n[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(n[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(n[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(n[0].dims[2]!==n[1].dims[0])throw new Error("last dimension of input and bias are not the same")},t3=n=>{let e=n[0].dims,r=n[0].dims[2],t=D.size(e)/4,o=n[0].dataType,i=z("input",o,e,4),a=z("bias",o,[r],4),s=z("residual",o,e,4),u=V("output",o,e,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:e,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(t/64)}}),getShaderSource:c=>`
  ...
  }`}},u0=n=>{e3(n.inputs),n.compute(t3(n.inputs))}});var r3,ke,c0,d0,p0,f0,h0,m0,g0,b0,y0,n3,_0,v0,w0,x0,Uo,T0,Fa,I0,S0,$0,A0,O0,P0,E0,C0,D0,k0,N0,L0,R0,z0,M0,B0,F0,V0,Sc,$c,G0,U0,W0,o3,i3,H0,Va=N(()=>{"use strict";ue();pe();Je();he();r3=(n,e,r,t,o,i,a)=>{let s=Math.ceil(e/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=z("inputData",r,[s],4),c=V("outputData",t,[s],4),p=[{name:"vec_size",type:"u32"}];return a&&p.push(...a),`
  ...
  }`},ke=(n,e,r,t,o,i=n.dataType,a,s)=>{let u=[{type:12,data:Math.ceil(D.size(n.dims)/4)}];return a&&u.push(...a),{name:e,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:l=>r3(l,D.size(n.dims),n.dataType,i,r,t,s),getRunData:l=>({outputs:[{dims:n.dims,dataType:i}],dispatchGroup:{x:Math.ceil(D.size(l[0].dims)/64/4)},programUniforms:u})}},c0=n=>{n.compute(ke(n.inputs[0],"Abs","abs"))},d0=n=>{n.compute(ke(n.inputs[0],"Acos","acos"))},p0=n=>{n.compute(ke(n.inputs[0],"Acosh","acosh"))},f0=n=>{n.compute(ke(n.inputs[0],"Asin","asin"))},h0=n=>{n.compute(ke(n.inputs[0],"Asinh","asinh"))},m0=n=>{n.compute(ke(n.inputs[0],"Atan","atan"))},g0=n=>{n.compute(ke(n.inputs[0],"Atanh","atanh"))},b0=n=>le(n),y0=(n,e)=>{let r;switch(e.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${e.to}`)}n.compute(ke(n.inputs[0],"Cast",r,void 0,e.cacheKey,e.to))},n3=n=>{let e,r,t=n.length>=2&&n[1].data!==0,o=n.length>=3&&n[2].data!==0;switch(n[0].dataType){case 1:e=t?n[1].getFloat32Array()[0]:-34028234663852886e22,r=o?n[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:e=t?n[1].getUint16Array()[0]:64511,r=o?n[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return le({min:e,max:r})},_0=(n,e)=>{let r=e||n3(n.inputs),t=at(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"Clip",o=>`clamp(${o}, vec4<${t}>(uniforms.min), vec4<${t}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:n.inputs[0].dataType,data:r.min},{type:n.inputs[0].dataType,data:r.max}],[{name:"min",type:t},{name:"max",type:t}]),{inputs:[0]})},v0=n=>{n.compute(ke(n.inputs[0],"Ceil","ceil"))},w0=n=>{n.compute(ke(n.inputs[0],"Cos","cos"))},x0=n=>{n.compute(ke(n.inputs[0],"Cosh","cosh"))},Uo=n=>le(n),T0=(n,e)=>{let r=at(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"Elu",t=>`elu_vf32(${t})`,`
...
`,$c=n=>`(fast_gelu_a + fast_gelu_a * tanh_v(${n} * (fast_gelu_c * ${n} * ${n} + fast_gelu_b))) * ${n}`,G0=n=>{let e=at(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"FastGelu",$c,Sc(e),void 0,n.inputs[0].dataType))},U0=(n,e)=>{let r=at(n.inputs[0].dataType);return n.compute(ke(n.inputs[0],"ThresholdedRelu",t=>`select(vec4<${r}>(0.0), ${t}, ${t} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${e.alpha});`,e.cacheKey)),0},W0=n=>{n.compute(ke(n.inputs[0],"Log","log"))},o3=(n,e)=>`
...
`,i3=n=>`quick_gelu_impl(${n})`,H0=(n,e)=>{let r=at(n.inputs[0].dataType);n.compute(ke(n.inputs[0],"QuickGelu",i3,o3(r,e.alpha),e.cacheKey,n.inputs[0].dataType))}});var a3,s3,j0,K0=N(()=>{"use strict";pe();he();Va();a3=n=>{if(n[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(n[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(n[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(n[0].dims[2]!==n[1].dims[0])throw new Error("last dimension of input and bias are not the same")},s3=n=>{let e=n[0].dims.slice();e[2]=e[2]/2;let r=z("input",n[0].dataType,n[0].dims,4),t=z("bias",n[0].dataType,[n[0].dims[2]],4),o=V("output",n[0].dataType,e,4),i=D.size(e)/4,a=Fe(n[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:e,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${n.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${w}
      }`},l3=(n,e,r,t,o,i,a=r.dataType)=>{let s=r.dims.map(y=>Number(y)??1),u=t.dims.map(y=>Number(y)??1),l=!D.areEqual(s,u),c=s,p=D.size(s),h=!1,m=!1,g=[l];if(l){let y=Fr.calcShape(s,u,!1);if(!y)throw new Error("Can't perform binary op on the given tensors");c=y.slice(),p=D.size(c);let T=D.size(s)===1,w=D.size(u)===1,x=s.length>0&&s[s.length-1]%4===0,I=u.length>0&&u[u.length-1]%4===0;g.push(T),g.push(w),g.push(x),g.push(I);let A=1;for(let P=1;P<c.length;P++){let C=s[s.length-P],R=u[u.length-P];if(C===R)A*=C;else break}A%4===0?(m=!0,h=!0):(T||w||x||I)&&(h=!0)}else h=!0;return g.push(h),{name:n,shaderCache:{hint:e+g.map(y=>y.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:y=>u3(y,s,u,c,h,l,m,o,r.dataType,t.dataType,a,i),getRunData:()=>({outputs:[{dims:c,dataType:a}],dispatchGroup:{x:Math.ceil(p/64/4)},programUniforms:[{type:12,data:Math.ceil(D.size(c)/4)},...U(s,u,c)]})}},Hr=(n,e,r,t,o,i)=>{n.compute(l3(e,o??"",n.inputs[0],n.inputs[1],r,t,i))},X0=n=>{Hr(n,"Add",(e,r)=>`${e}+${r}`)},Z0=n=>{Hr(n,"Div",(e,r)=>`${e}/${r}`)},J0=n=>{Hr(n,"Equal",{scalar:(e,r)=>`u32(${e}==${r})`,vector:(e,r)=>`vec4<u32>(${e}==${r})`},void 0,void 0,9)},Q0=n=>{Hr(n,"Mul",(e,r)=>`${e}*${r}`)},Y0=n=>{let e=z("input",n.inputs[0].dataType,n.inputs[0].dims).type.value;Hr(n,"Pow",{scalar:(t,o)=>`pow_custom(${t},${o})`,vector:(t,o)=>`pow_vector_custom(${t},${o})`},`
    ...
    fn pow_vector_custom(a : vec4<${e}>, b : vec4<${e}>) -> vec4<${e}> {
      ...
      `)},ev=n=>{Hr(n,"Sub",(e,r)=>`${e}-${r}`)},tv=n=>{Hr(n,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},rv=n=>{Hr(n,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},nv=n=>{Hr(n,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ov=n=>{Hr(n,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}});var d3,p3,f3,h3,av,sv,uv=N(()=>{"use strict";ue();pe();Je();he();d3=(n,e)=>{if(!n||n.length<1)throw new Error("too few inputs");let r=0,t=n[r],o=t.dataType,i=t.dims.length;n.forEach((a,s)=>{if(s!==r){if(a.dataType!==o)throw new Error("input tensors should be one type");if(a.dims.length!==i)throw new Error("input tensors should have the same shape");a.dims.forEach((u,l)=>{if(l!==e&&u!==t.dims[l])throw new Error("non concat dimensions must match")})}})},p3=(n,e)=>`
...
`}return oe};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${e.activation};${p};${h};${m};${o}`,inputDependencies:y?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(r):r,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:I}),getShaderSource:A}}});var m3,g3,Ac,pv,b3,Oc,y3,Ho,qa=N(()=>{"use strict";ue();pe();he();_n();Ha();Ua();m3=(n,e)=>n?`
...
`},y3=(n,e,r,t,o=!1)=>{let[i,a,s,u]=t,l=Fe(t[0].type.tensor);return`
...
`)};
            ${s.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:n.map(()=>"rank")},getRunData:()=>{let c=u.filter(h=>r.symbolToInfo.has(h)).map(h=>({type:12,data:r.symbolToInfo.get(h)?.dimValue||0}));c.push({type:12,data:a});let p=n.map((h,m)=>[...U(h)]).reduce((h,m)=>h.concat(m),c);return p.push(...U(t)),{outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:p}},getShaderSource:l}},Fv=(n,e)=>{let r=new Lc(n.inputs,e.equation),t=r.outputDims,o=n.inputs.map((i,a)=>i.dims);n.compute(M3(o,n.inputs[0].dataType,r,t))},Vv=n=>{let e=n.equation.replace(/\s+/g,"");return le({equation:e})}});var B3,Uv,F3,V3,Wv,Hv=N(()=>{"use strict";ue();pe();he();B3=n=>{if(!n||n.length!==2)throw new Error("Expand requires 2 input.");let e=n[0].dims,r=Array.from(n[1].getBigInt64Array(),Number),t=r.length<e.length?0:r.length-e.length,o=e.length<r.length?0:e.length-r.length;for(;t<r.length&&o<e.length;++t,++o)if(r[t]!==e[o]&&r[t]!==1&&e[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Uv=(n,e)=>{let r=n.length-e.length,t=[];for(let o=0;o<r;++o)t.push(n[o]);for(let o=0;o<e.length;++o)t.push(e[o]===1?n[o+r]:e[o]);return t},F3=(n,e)=>n.length>e.length?Uv(n,e):Uv(e,n),V3=n=>{let e=n[0].dims,r=Array.from(n[1].getBigInt64Array(),Number),t=F3(e,r),o=n[0].dataType,i=o===9||D.size(e)===1,a=o===9||e.length>0&&e[e.length-1]%4===0?4:1,s=i||t.length>0&&t[t.length-1]%4===0?4:1,u=Math.ceil(D.size(t)/s),l=p=>{let h=z("input",o,e.length,a),m=V("output",o,t.length,s),g;if(o===9){let y=(T,w,x="")=>`
    ...
    ${g}`},c=[{type:12,data:u},...U(e,t)];return{name:"Expand",shaderCache:{hint:`${t.length};${a}${s}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:t,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c})}},Wv=n=>{B3(n.inputs),n.compute(V3(n.inputs),{inputs:[0]})}});var G3,qv,jv=N(()=>{"use strict";ue();pe();he();Va();G3=n=>{let e=n[0].dataType,r=D.size(n[0].dims),t=D.size(n[1].dims),o=t%4===0,i=a=>{let s=z("x",e,[1],4),u=z("bias",e,[1],4),l=V("y",e,[1],4),c=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],p=m=>`
  ...
  ${h.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${e.cacheKey};${n.filter((g,y)=>y!==1).map(g=>g.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:n.length},(g,y)=>"rank")},getRunData:()=>({outputs:[{dims:s,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:h}),getShaderSource:m}},ew=(n,e)=>{let r=n.inputs;q3(r,e),n.compute(j3(n.inputs,e))},tw=n=>le({blockSize:n.blockSize,gatherAxis:n.gatherAxis,quantizeAxis:n.quantizeAxis})});var K3,X3,nw,ow,iw=N(()=>{"use strict";ue();pe();Je();he();K3=n=>{if(!n||n.length!==2)throw new Error("GatherElements requires 2 inputs.");if(n[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(n[0].dims.length!==n[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return p?{name:"GemmShared",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:s,dataType:n[0].dataType}],dispatchGroup:{x:l*c},programUniforms:m}),getShaderSource:T}:{name:"Gemm",shaderCache:{hint:`${e.cacheKey}`,inputDependencies:g},getRunData:()=>({outputs:[{dims:s,dataType:n[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:m}),getShaderSource:y}},aw=n=>{let e=n.transA,r=n.transB,t=n.alpha,o=n.beta;return{transA:e,transB:r,alpha:t,beta:o,cacheKey:`${n.transA};${n.transB};${n.alpha===1}`}},sw=(n,e)=>{Z3(n.inputs),n.compute(J3(n.inputs,e))}});var Zr,vn,lo,co,Q3,Y3,eC,tC,rC,nC,oC,iC,lw,cw,dw=N(()=>{"use strict";ue();pe();Je();he();[Zr,vn,lo,co]=[0,1,2,3],Q3=n=>{if(n[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(n[0].dims.length!==n[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(n[0].dims.length-2!==n[1].dims[n[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${n[0].dims.length-2}`);if(n[0].dims[0]!==n[1].dims[0])throw new Error("grid batch size must match input batch size")},Y3=`
