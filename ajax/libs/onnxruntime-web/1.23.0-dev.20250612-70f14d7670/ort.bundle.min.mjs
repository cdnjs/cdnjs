...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[t(n.type),n.length??1])}},ss=(e,t)=>new po(e,t)});var ym,us,bm,_m,wm,vm,ke,ls,ds,dt=W(()=>{"use strict";ee();ae();Se();ue();ym=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},us=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),bm=(e,t)=>E.sortBasedOnPerm(e,us(e.length,t)),_m=(e,t,n,r)=>{let o=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
  ...
  }`},{name:"TransposeShared",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let x=E.size(a);return{outputs:[{dims:a,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(u[1]/w),y:Math.ceil(u[0]/w)},programUniforms:[{type:12,data:x},...L(s,u)]}},getShaderSource:c}}return c=w=>{let x=P("a",n,s.length),v=N("output",n,u.length);return`
  ${w.registerUniform("output_size","u32").declareVariables(x,v)}
  ...
  ${w.mainStart()}
    ...
    ${v.setByOffset("global_idx",x.getByIndices("aIndices"))}
       ...
       `,b=w=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:b,getRunData:()=>({outputs:[{dims:a,dataType:o}],dispatchGroup:{x:d},programUniforms:[{type:12,data:c}]})}},rt=(e,t,n,r)=>{let o=e.inputs.length===1?n:ho(e.inputs,n),a=o.axes;a.length===0&&!o.noopWithEmptyAxes&&(a=e.inputs[0].dims.map((_,b)=>b));let s=E.normalizeAxes(a,e.inputs[0].dims.length),u=s,d=e.inputs[0],c=km(u,e.inputs[0].dims.length);c.length>0&&(d=e.compute(ke(e.inputs[0],c),{inputs:[0],outputs:[-1]})[0],u=Cm(u.length,d.dims.length));let[m,f]=Im(d.dims,u),g=m;o.keepDims&&(g=Am(m,s)),e.compute(Pm(t,o.cacheKey,[d],r,e.inputs[0].dataType,g,f),{inputs:[d]})},cs=(e,t)=>{rt(e,"ReduceMeanShared",t,"mean")},ps=(e,t)=>{rt(e,"ReduceL1Shared",t,"l1")},ms=(e,t)=>{rt(e,"ReduceL2Shared",t,"l2")},fs=(e,t)=>{rt(e,"ReduceLogSumExpShared",t,"logSumExp")},hs=(e,t)=>{rt(e,"ReduceMaxShared",t,"max")},gs=(e,t)=>{rt(e,"ReduceMinShared",t,"min")},ys=(e,t)=>{rt(e,"ReduceProdShared",t,"prod")},bs=(e,t)=>{rt(e,"ReduceSumShared",t,"sum")},_s=(e,t)=>{rt(e,"ReduceSumSquareShared",t,"sumSquare")},ws=(e,t)=>{rt(e,"ReduceLogSumShared",t,"logSum")}});var nt,Om,Qr,ho,ot,zm,Dm,Bm,Mm,Rm,Um,Nm,Vm,Wm,Lm,it,$s,xs,Ss,Ts,Cs,Is,As,Es,ks,Ps,Zr=W(()=>{"use strict";ee();ae();Se();ue();vs();nt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Om=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Qr=(e,t,n,r,o,a,s=!1,u=!1)=>{let d=[],c=n[0].dims,m=c.length,f=E.normalizeAxes(o,m),g=!u&&f.length===0;c.forEach((x,v)=>{g||f.indexOf(v)>=0?s&&d.push(1):d.push(x)});let _=d.length,b=E.size(d);return{name:e,shaderCache:t,getShaderSource:x=>{let v=[],$=P("_A",n[0].dataType,m),T=N("output",a,_),C=r($,T,f),A=C[2];for(let I=0,z=0;I<m;I++)g||f.indexOf(I)>=0?(s&&z++,A=`for(var j${I}: u32 = 0; j${I} < ${c[I]}; j${I}++) {
...
`)}`,`var value = ${r.getByIndices("input_indices")};`,`value = min(value, ${r.getByIndices("input_indices")});`,""]})},Vm=(e,t)=>{nt(e.inputs),ot(e,"ReduceProd",t,(r,o)=>[`var value = ${o.type.storage}(1);`,"",`value *= ${r.getByIndices("input_indices")};`,""])},Wm=(e,t)=>{nt(e.inputs),ot(e,"ReduceSum",t,(r,o)=>[`var value = ${o.type.storage}(0);`,"",`value += ${r.getByIndices("input_indices")};`,""])},Lm=(e,t)=>{nt(e.inputs),ot(e,"ReduceSumSquare",t,(r,o)=>[`var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,"",`t = ${r.getByIndices("input_indices")}; value += t * t;`,""])},it=(e,t,n)=>{if(t.length===0)return n;let r=1,o=1;for(let a=0;a<t.length;a++)t.indexOf(a)===-1?r*=e[a]:o*=e[a];return o<32&&r>1024},$s=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Um(e,t):cs(e,t)},xs=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Dm(e,t):ps(e,t)},Ss=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Bm(e,t):ms(e,t)},Ts=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Mm(e,t):fs(e,t)},Cs=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Rm(e,t):hs(e,t)},Is=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Nm(e,t):gs(e,t)},As=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Vm(e,t):ys(e,t)},Es=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Wm(e,t):bs(e,t)},ks=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Lm(e,t):_s(e,t)},Ps=(e,t)=>{it(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?zm(e,t):ws(e,t)}});var Os,zs,Ds,go,Bs=W(()=>{"use strict";ee();Se();Zr();Os=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},zs=(e,t)=>{Os(e.inputs);let n=(r,o,a)=>{let s=[];for(let u=0;u<r.rank;u++)(a.indexOf(u)>=0||a.length===0)&&s.push(`input_indices[${u}] = 0;`);return[`${s.join(`
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
    ...
    `,Hm=(e,t,n,r,o,a,s,u)=>{let d=he(s?1:a),c=64,m=a/d;m<c&&(c=32);let f=Math.ceil(a/d/c),g=[{type:12,data:t},{type:12,data:n},{type:12,data:r},{type:12,data:o},{type:12,data:m},{type:12,data:f}],_=ve(e.dataType,d),b=Ee(1,d),w=["type"];s&&w.push("type"),u&&w.push("type");let x=v=>{let $=N("x",e.dataType,e.dims,d),T=[$],C=s?P("seq_lens",s.dataType,s.dims):void 0;C&&T.push(C);let A=u?P("total_sequence_length_input",u.dataType,u.dims):void 0;A&&T.push(A);let I=Ee(e.dataType),z=[{name:"batch_size",type:"u32"},{name:"num_heads",type:"u32"},{name:"past_sequence_length",type:"u32"},{name:"sequence_length",type:"u32"},{name:"total_sequence_length",type:"u32"},{name:"elements_per_thread",type:"u32"}];return`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:c?["rank","type","type","type","type"]:void 0},getShaderSource:$,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c?[{type:12,data:d},...L(a)]:[{type:12,data:d}]})}},Qm=e=>te(e),Rs=(e,t)=>{let{inputs:n,outputCount:r}=e,o=Qm({...t,outputCount:r});if(we.webgpu.validateInputContent&&Km(n,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(Zm(n,o))}});var Ym,Xm,Ns,Vs=W(()=>{"use strict";ae();ue();Ym=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Xm=e=>{let t=e[0].dims,n=e[0].dims[2],r=E.size(t)/4,o=e[0].dataType,a=P("input",o,t,4),s=P("bias",o,[n],4),u=P("residual",o,t,4),d=N("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:m=>`
  ...
  }`}},Ns=e=>{Ym(e.inputs),e.compute(Xm(e.inputs))}});var Jm,be,Ws,Ls,Gs,Hs,Fs,qs,js,Ks,Zs,ef,Qs,Ys,Xs,Js,or,eu,Xr,tu,ru,nu,ou,iu,au,su,uu,lu,du,cu,pu,mu,fu,hu,gu,yu,bu,bo,_o,_u,wu,vu,tf,rf,$u,Jr=W(()=>{"use strict";ee();ae();Se();ue();Jm=(e,t,n,r,o,a,s)=>{let u=Math.ceil(t/4),d="";typeof o=="string"?d=`${o}(a)`:d=o("a");let c=P("inputData",n,[u],4),m=N("outputData",r,[u],4),f=[{name:"vec_size",type:"u32"}];return s&&f.push(...s),`
...
}`,tu=e=>{let t=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,Xr(t)))},ru=e=>{e.compute(be(e.inputs[0],"Exp","exp"))},nu=e=>{e.compute(be(e.inputs[0],"Floor","floor"))},ou=e=>{let t=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,Xr(t)))},iu=(e,t)=>{let n=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},au=e=>{e.compute(be(e.inputs[0],"Not",t=>`!${t}`))},su=e=>{e.compute(be(e.inputs[0],"Neg",t=>`-${t}`))},uu=e=>{e.compute(be(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},lu=e=>{let t=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},du=e=>{e.compute(be(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},cu=e=>te(e),pu=(e,t)=>{let n=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},mu=e=>{e.compute(be(e.inputs[0],"Sin","sin"))},fu=e=>{e.compute(be(e.inputs[0],"Sinh","sinh"))},hu=e=>{e.compute(be(e.inputs[0],"Sqrt","sqrt"))},gu=e=>{e.compute(be(e.inputs[0],"Tan","tan"))},yu=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,bu=e=>{e.compute(be(e.inputs[0],"Tanh",yu))},bo=(e="f32")=>`
...
`,_o=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,_u=e=>{let t=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"FastGelu",_o,bo(t),void 0,e.inputs[0].dataType))},wu=(e,t)=>{let n=Ee(e.inputs[0].dataType);return e.compute(be(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},vu=e=>{e.compute(be(e.inputs[0],"Log","log"))},tf=(e,t)=>`
...
`,rf=e=>`quick_gelu_impl(${e})`,$u=(e,t)=>{let n=Ee(e.inputs[0].dataType);e.compute(be(e.inputs[0],"QuickGelu",rf,tf(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var nf,of,Su,Tu=W(()=>{"use strict";ae();ue();Jr();nf=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},of=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=P("input",e[0].dataType,e[0].dims,4),r=P("bias",e[0].dataType,[e[0].dims[2]],4),o=N("output",e[0].dataType,t,4),a=E.size(t)/4,s=ve(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:d=>`
...
`});var ir,rn,nn=W(()=>{"use strict";ee();ae();ue();St();ir=(e,t,n,r,o)=>{let a=r-n;return`
...
`},rn=(e,t,n,r,o=!1,a)=>{let s=e[0].dims,u=e[1].dims,d=s[s.length-2],c=u[u.length-1],m=s[s.length-1],f=he(c),g=he(m),_=he(d),b=E.size(n)/f/_,w=e.length>2,x=r?r.slice(0,-2):n.slice(0,-2),$=[E.size(x),d,c],T=[{type:12,data:b},{type:12,data:d},{type:12,data:c},{type:12,data:m}];Ze(t,T),T.push(...L(x,s,u)),w&&T.push(...L(e[2].dims)),T.push(...L($));let C=A=>{let I=Kr("batch_dims",e[0].dataType,x.length),z=P("a",e[0].dataType,s.length,g),D=P("b",e[1].dataType,u.length,f),R=N("output",e[0].dataType,$.length,f),H=ve(R.type.tensor),q=Ke(t,R.type.value,H),Y=[z,D],ne="";if(w){let oe=o?f:1;Y.push(P("bias",e[2].dataType,e[2].dims.length,oe)),ne=`${o?`value += bias[col / ${oe}];`:`value += ${R.type.value}(bias[row + i]);`}`}let F=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];Qe(t,F);let me=()=>{let oe=`var a_data: ${z.type.value};`;for(let j=0;j<g;j++)oe+=`
...
`}return oe};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${f};${g};${_};${o}`,inputDependencies:w?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(b/64)},programUniforms:T}),getShaderSource:C}}});var mf,ff,wo,Gu,hf,vo,gf,ar,on=W(()=>{"use strict";ee();ae();ue();St();nn();tn();mf=(e,t)=>e?`
...
`},gf=(e,t,n,r,o=!1)=>{let[a,s,u,d]=r,c=ve(r[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${a.type.indices}) -> ${Ie(e,c)} {
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${a.type.indices}) -> ${Ie(e,c)} {
      var value = ${Ie(e,c)}(0.0);
      let col = colIn * ${e};
  ...
  ${w?wo(x,v,oe,me):vo(x,v,oe,me)}
    ...
    return ${Ie(u,c)}(0.0);`,A=Ie(d,c),I=e?Ie(s,c):Ie(u,c),z=e?Ie(u,c):Ie(s,c),D=Ke(a,A,c);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${A}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${w?`vec4<${Z}>`:Z}) {
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${d?`vec4<${A}>`:A} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${g};${x}`,inputDependencies:w},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:f[0],y:f[1],z:f[2]},programUniforms:b}),getShaderSource:v}}});var Yu,Xu,Ju=W(()=>{"use strict";ee();ae();ue();St();Yu=(e,t,n,r)=>{let o=e.length>2,a=o?"value += b[output_channel];":"",s=e[0].dims,u=e[1].dims,d=t.format==="NHWC",c=d?n[3]:n[1],m=c/t.group,f=d&&m>=4?he(c):1,g=E.size(n)/f,_=[{type:12,data:g},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:m}];Ze(t,_),_.push(...L(s,[u[0],u[1],u[2],u[3]/f]));let b=o?["rank","rank","rank"]:["rank","rank"];_.push(...L([n[0],n[1],n[2],n[3]/f]));let w=x=>{let v=N("output",e[0].dataType,n.length,f),$=ve(v.type.tensor),T=Ke(t,v.type.value,$),C=P("x",e[0].dataType,s.length),A=P("w",e[1].dataType,u.length,f),I=[C,A];o&&I.push(P("b",e[2].dataType,e[2].dims,f));let z=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Qe(t,z);let D=d?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${f}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:w}},Xu=(e,t,n,r)=>{let o=e.length>2,a=he(n[3]),s=he(n[2]),u=E.size(n)/a/s,d=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/a],c=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/a],m=[n[0],n[1],n[2],n[3]/a],f=[{type:12,data:u},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Ze(t,f),f.push(...L(d,c,m));let g=(s-1)*t.strides[1]+c[1],_=b=>{let w=N("output",e[0].dataType,m.length,a),x=ve(w.type.tensor),v=Ke(t,w.type.value,x),$=P("x",e[0].dataType,d.length,a),T=P("w",e[1].dataType,c.length,a),C=[$,T];o&&C.push(P("b",e[2].dataType,e[2].dims,a));let A=o?"value += b[output_channel];":"",I=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Qe(t,I),`
  ...
  ${b.mainStart()}
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${a};${s};${g};${c[0]};${c[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:f}),getShaderSource:_}}});var vf,$o,$f,xo,So,el,xf,Sf,To,tl=W(()=>{"use strict";ae();Fu();Qu();on();Ju();St();nn();dt();vf=(e,t,n,r,o,a)=>{let s=e[0],u=e.slice(a?1:2,a?3:4),d=u.length,c=t[0],f=t.slice(2).map((b,w)=>b+(b-1)*(n[w]-1)),_=u.map((b,w)=>b+r[w]+r[w+d]).map((b,w)=>Math.floor((b-f[w]+o[w])/o[w]));return _.splice(0,0,s),_.splice(a?3:1,0,c),_},$o=[2,3,1,0],$f=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[1]*t.group;if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},xo=(e,t)=>{let n=e.kernelShape.slice();n.length<t[1].dims.length-2&&n.push(...Array(t[1].dims.length-2-n.length).fill(0));for(let a=2;a<t[1].dims.length;++a)n[a-2]===0&&(n[a-2]=t[1].dims[a]);let r=e.pads.slice();zt.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,n,r,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:n,pads:r}),o},So=e=>{let t=en(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,a=e.group,s=e.kernel_shape,u=e.pads,d=e.strides,c=e.w_is_const();return{autoPad:r,format:n,dilations:o,group:a,kernelShape:s,pads:u,strides:d,wIsConst:c,...t,cacheKey:`${e.format};${t.activation};`}},el=(e,t,n,r)=>{let o=n.format==="NHWC",a=vf(t[0].dims,t[1].dims,n.dilations,n.pads,n.strides,o);if(n.group!==1){let I=[t[0]];if(o){let D=e.kernelCustomData.wT??e.compute(ke(t[1],$o),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=D),I.push(D)}else I.push(t[1]);t.length===3&&I.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===n.group&&t[1].dims[1]===1&&n.dilations[0]===1&&n.dilations[1]===1?e.compute(Xu(I,n,a,r),{inputs:I}):e.compute(Yu(I,n,a,r),{inputs:I});return}let s=t.length===3,u=t[0].dims[o?1:2],d=t[0].dims[o?2:3],c=t[0].dims[o?3:1],m=t[1].dims[2],f=t[1].dims[3],g=a[o?1:2],_=a[o?2:3],b=a[o?3:1],w=o&&m===u&&f===d&&n.pads[0]===0&&n.pads[1]===0;if(w||m===1&&f===1&&n.dilations[0]===1&&n.dilations[1]===1&&n.strides[0]===1&&n.strides[1]===1&&n.pads[0]===0&&n.pads[1]===0){let I=a[0],z,D,R,H=[];if(o){let ne=e.kernelCustomData.wT??e.compute(ke(t[1],$o),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];if(n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=ne),w){let F=u*d*c;z=t[0].reshape([1,I,F]),D=ne.reshape([1,F,b]),R=[1,I,b]}else z=t[0].reshape([I,u*d,c]),D=ne.reshape([1,c,b]),R=[I,g*_,b];H.push(z),H.push(D)}else z=t[0].reshape([I,c,u*d]),D=t[1].reshape([1,b,c]),R=[I,b,g*_],H.push(D),H.push(z);s&&H.push(t[2]);let q=R[2],Y=H[0].dims[H[0].dims.length-1];q<8&&Y<8?e.compute(rn(H,n,a,R,o,r),{inputs:H}):e.compute(ar(H,n,a,R,o,r),{inputs:H});return}let x=!0,v=e.kernelCustomData.wT??e.compute(ke(t[1],$o),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=v);let $=[t[0],v];s&&$.push(t[2]);let T=o?g*_:b,C=o?b:g*_,A=m*f*c;e.compute(Hu($,n,a,T,C,A,s,x,r),{inputs:$})},xf=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],a=[1].concat(t.strides),s=[1].concat(t.dilations),u=[1].concat(t.kernelShape),d=xo({...t,pads:o,strides:a,dilations:s,kernelShape:u},r);el(e,r,d,c=>n?[c[0],c[2],c[3]]:[c[0],c[1],c[3]])},Sf=(e,t,n)=>{let r=n.format==="NHWC"?"channelsLast":"channelsFirst",o=xo(n,t),a=n.autoPad==="NOTSET"?n.pads:n.autoPad,s=Ku(t[0].dims,t[1].dims,n.strides,n.dilations,a,!1,r);e.compute(Zu(t,o,s.outShape,[s.filterDepth,s.filterHeight,s.filterWidth],[s.padInfo.front,s.padInfo.top,s.padInfo.left],r))},To=(e,t)=>{if($f(e.inputs,t),e.inputs[0].dims.length===3)xf(e,t);else if(e.inputs[0].dims.length===5)Sf(e,e.inputs,t);else{let n=xo(t,e.inputs);el(e,e.inputs,n)}}});var rl,nl=W(()=>{"use strict";ee();et();ae();ue();rl=(e,t,n)=>{let r=e.length>2,o=t.outputShape,a=t.format==="NHWC",s=t.group,u=e[1].dims,d=u[2]/s,c=u[3],m=a?he(d):1,f=a&&c===1&&d>=4,g=f?Math.floor(d/4)*4:Math.floor(d/m)*m,_=d-g,b=a?he(c):1,w=a?c===1?m:b:1,x=E.size(o)/b,v=[Math.ceil(x/64),1,1];le("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${v}`);let $=["rank","rank"],T=[t.strides[0],t.strides[1]],C=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],A=[t.dilations[0],t.dilations[1]],I=[C[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),C[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],z=[I[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),I[1]-1-Math.floor((t.pads[1]+t.pads[3])/2)],D=[{type:12,data:x},{type:12,data:T},{type:12,data:C},{type:12,data:A},{type:12,data:I},{type:6,data:z},{type:12,data:g},{type:12,data:d},{type:12,data:c},...L(e[0].dims,e[1].dims)];r&&(D.push(...L(e[2].dims)),$.push("rank")),D.push(...L(o));let R=H=>{let q=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:T.length},{name:"filter_dims",type:"u32",length:C.length},{name:"dilations",type:"u32",length:C.length},{name:"effective_filter_dims",type:"u32",length:I.length},{name:"pads",type:"i32",length:z.length},{name:"input_channels_per_group_int",type:"u32"},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],Y=ve(e[0].dataType),ne=a?1:2,F=a?2:3,me=a?3:1,oe=P("W",e[1].dataType,e[1].dims.length,w),j=P("Dy",e[0].dataType,e[0].dims.length,m),ie=[j,oe];r&&ie.push(P("bias",e[2].dataType,[o[me]].length,b));let Z=N("result",e[0].dataType,o.length,b),ce=()=>{let J="";if(f)m===4?J+=`
    ...
    ${pe}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${m}${w}${b}${f}${_}`,inputDependencies:$},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:n?n(o):o,dataType:e[0].dataType}],programUniforms:D}),getShaderSource:R}}});var Tf,Cf,If,ol,il,Af,al,Ef,sl,ul=W(()=>{"use strict";nl();St();dt();Tf=(e,t,n,r,o,a)=>(e-1)*t+n+(r-1)*o+1-a,Cf=(e,t,n,r,o)=>{let a=Math.floor(e/2);t==="SAME_UPPER"?(n[r]=a,n[o]=e-a):t==="SAME_LOWER"&&(n[r]=e-a,n[o]=a)},If=(e,t,n,r,o,a,s,u,d,c)=>{let m=e.length-2,f=c.length===0;d.length<m&&d.push(...Array(m-d.length).fill(0));let g=e[0],_=t[u?3:1]*o;for(let b=0,w=e.length-m-(u?1:0);b<m;++b,++w){let x=e[w],v=f?x*s[b]:c[b],$=Tf(x,s[b],a[b],t[w],n[b],v);Cf($,r,a,b,b+m),f&&c.push(s[b]*(x-1)+d[b]+(t[w]-1)*n[b]+1-a[b]-a[b+m])}c.splice(0,0,g),c.splice(u?3:1,0,_)},ol=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((f,g)=>f*g,1)===0){n.length=0;for(let f=2;f<t[1].dims.length;++f)n.push(t[1].dims[f])}let r=e.format==="NHWC";n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let o=e.pads.slice(),a=e.outputShape.slice(),s=e.outputPadding.slice(),u=t[0].dims,d=e.dilations.slice();if(d.reduce((f,g)=>f+g,0)===0){let f=t[0].dims.length-2;d=new Array(f).fill(1)}let c=e.strides.slice();if(c.reduce((f,g)=>f+g,0)===0){let f=t[0].dims.length-2;c=new Array(f).fill(1)}If(u,n,d,e.autoPad,e.group,o,c,r,s,a);let m=Object.assign({},e);return Object.assign(m,{kernelShape:n,pads:o,outputPadding:s,outputShape:a,dilations:d,strides:c}),m},il=e=>{let t=en(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,a=e.group,s=e.kernelShape,u=e.pads,d=e.strides,c=e.wIsConst(),m=e.outputPadding,f=e.outputShape;return{autoPad:r,format:n,dilations:o,group:a,kernelShape:s,outputPadding:m,outputShape:f,pads:u,strides:d,wIsConst:c,...t,cacheKey:`${e.format};${t.activation};`}},Af=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let a=e[0].dims.length-2;if(t.dilations.reduce((m,f)=>m+f,0)>0&&t.dilations.length!==a)throw new Error(`dilations should be ${a}D`);if(t.strides.reduce((m,f)=>m+f,0)>0&&t.strides.length!==a)throw new Error(`strides should be ${a}D`);if(t.pads.reduce((m,f)=>m+f,0)>0&&t.pads.length!==a*2)throw new Error(`pads should be ${a*2}D`);if(t.outputPadding.length!==a&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${a}D`);if(t.kernelShape.reduce((m,f)=>m+f,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},al=(e,t,n,r)=>{let o=e.kernelCustomData.wT??e.compute(ke(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=o);let a=[t[0],o];t.length===3&&a.push(t[2]),e.compute(rl(a,n,r),{inputs:a})},Ef=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let a=t.dilations;(a.length===0||a[0]===0)&&(a=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],s=[1].concat(s),a=[1].concat(a),o=[1].concat(o);let d=t.outputPadding;d=[0].concat(d);let c=ol({...t,pads:u,strides:s,dilations:a,kernelShape:o,outputPadding:d},r);al(e,r,c,m=>n?[m[0],m[2],m[3]]:[m[0],m[1],m[3]])},sl=(e,t)=>{if(Af(e.inputs,t),e.inputs[0].dims.length===3)Ef(e,t);else{let n=ol(t,e.inputs);al(e,e.inputs,n)}}});var kf,ll,dl,cl=W(()=>{"use strict";ee();ae();Se();ue();kf=(e,t,n,r)=>{let o=E.size(t),a=t.length,s=P("input",e,a),u=N("output",e,a),d=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),c=E.normalizeAxis(d,a),m=f=>{let g=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,_=K("uniforms.input_shape","uniforms.axis",a),b=r.reverse?g+(r.exclusive?" + 1":""):"0",w=r.reverse?_:g+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:c},...L(t,t)]}),getShaderSource:m}},ll=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,o=e.inputs[1];e.compute(kf(r,n,o,t),{inputs:[0]})},dl=e=>{let t=e.exclusive===1,n=e.reverse===1;return te({exclusive:t,reverse:n})}});var Pf,Of,zf,pl,ml,fl=W(()=>{"use strict";ee();ae();Se();ue();Pf=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},Of=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)};
    ...
    ${b}`},m=[{type:12,data:d},...L(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${u}`,inputDependencies:["rank"]},getShaderSource:c,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:m})}},vl=e=>{Rf(e.inputs),e.compute(Nf(e.inputs),{inputs:[0]})}});var Vf,xl,Sl=W(()=>{"use strict";ee();ae();ue();Jr();Vf=e=>{let t=e[0].dataType,n=E.size(e[0].dims),r=E.size(e[1].dims),o=r%4===0,a=s=>{let u=P("x",t,[1],4),d=P("bias",t,[1],4),c=N("y",t,[1],4),m=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],f=_=>`
    ...
    ${s.mainStart(Dt)}
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${o}`,inputDependencies:["type","type"]},getShaderSource:a,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(n/Dt/4)}})}},xl=e=>{e.inputs.length<2||E.size(e.inputs[1].dims)===0?_u(e):e.compute(Vf(e.inputs))}});var Wf,Lf,Tl,Cl,Il=W(()=>{"use strict";ee();ae();Se();ue();Wf=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},Lf=(e,t)=>{let n=e[0].dims,r=e[1].dims,o=n.length,a=E.normalizeAxis(t.axis,o),s=n.slice(0);s.splice(a,1,...r);let u=n[a],d=e[0].dataType===9?4:1,c=Math.ceil(E.size(s)/d),m=[{type:12,data:c},{type:6,data:u},{type:12,data:a},...L(e[0].dims,e[1].dims,s)],f=g=>{let _=P("data",e[0].dataType,e[0].dims.length,d),b=P("inputIndices",e[1].dataType,e[1].dims.length),w=N("output",e[0].dataType,s.length,d),x=$=>{let T=r.length,C=`var indicesIndices${$}  = ${b.type.indices}(0);`;for(let A=0;A<T;A++)C+=`${T>1?`indicesIndices${$}[${A}]`:`indicesIndices${$}`} = ${s.length>1?`outputIndices${$}[uniforms.axis + ${A}]`:`outputIndices${$}`};`;C+=`
      ...
      ${g.mainStart()}
        ...
        ${v}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(c/64)},programUniforms:m}),getShaderSource:f}},Tl=e=>te({axis:e.axis}),Cl=(e,t)=>{let n=e.inputs;Wf(n),e.compute(Lf(e.inputs,t))}});var Gf,Al,El,kl=W(()=>{"use strict";ee();ae();ue();Gf=(e,t,n,r,o,a,s,u,d)=>{let c=[{type:12,data:a},{type:12,data:r},{type:12,data:o},{type:12,data:n},{type:12,data:s},{type:12,data:u},{type:12,data:d}],m=[a];c.push(...L(t.dims,m));let f=g=>{let _=P("indices_data",t.dataType,t.dims.length),b=N("input_slice_offsets_data",12,1,1),w=[_,b],x=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:o.length},{name:"sizes_from_slice_dims_data",type:"u32",length:n.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((b,w)=>w!==1).map(b=>b.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(b,w)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:c}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:g}),getShaderSource:_}},Pl=(e,t)=>{let n=e.inputs;Hf(n,t),e.compute(Ff(e.inputs,t))},Ol=e=>te({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var qf,jf,Dl,Bl,Ml=W(()=>{"use strict";ee();ae();Se();ue();qf=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},jf=(e,t)=>{let n=e[0].dims,r=e[0].dataType,o=n.length,a=e[1].dims,s=e[1].dataType,u=E.normalizeAxis(t.axis,o),d=n[u],c=a.slice(0),m=E.size(c),f=P("input",r,o),g=P("indicesInput",s,a.length),_=N("output",r,c.length),b=[{type:12,data:m},{type:6,data:d},{type:12,data:u}];return b.push(...L(n,a,c)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:c,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:v=>`
  ...
  }`};return f?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:c*m},programUniforms:_}),getShaderSource:x}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:_}),getShaderSource:w}},Rl=e=>{let t=e.transA,n=e.transB,r=e.alpha,o=e.beta;return{transA:t,transB:n,alpha:r,beta:o,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Ul=(e,t)=>{Kf(e.inputs),e.compute(Zf(e.inputs,t))}});var ct,Tt,Ht,Ft,Qf,Yf,Xf,Jf,eh,th,rh,nh,Vl,Wl,Ll=W(()=>{"use strict";ee();ae();Se();ue();[ct,Tt,Ht,Ft]=[0,1,2,3],Qf=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Yf=`
...
`,rh=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${ct}], indices[${Tt}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${ct}], indices[${Tt}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${ct}], indices[${Tt}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${ct}], indices[${Tt}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${ct}], indices[${Tt}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${ct}], indices[${Tt}], border);
            }
          }
        ...
        `;default:throw new Error(`mode ${n.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,nh=(e,t)=>{let n=P("x",e[0].dataType,e[0].dims.length),r=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],o=P("grid",e[1].dataType,r.length,2),a=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(a=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[ct,Tt,Ht,Ft]=[0,3,1,2]);let s=N("output",e[0].dataType,a.length),u=n.type.value,d=E.size(a),c=[{type:12,data:d},...L(e[0].dims,r,a)],m=f=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:c}),getShaderSource:m},{inputs:[t,n],outputs:[-1]})[0]},sr=(e,t,n,r,o,a,s,u)=>{let d=a;if(s&&E.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return d=sh(e,a,s,t,r,n*o,u),d=d.reshape([t,r,n,o]),n===1||r===1?d:e.compute(ke(d,Gl.perm),{inputs:[d],outputs:[-1]})[0]}else return a.dims.length===3&&(d=a.reshape([t,r,n,o])),n===1||r===1?d:e.compute(ke(d,Gl.perm),{inputs:[d],outputs:[-1]})[0]},Fl=(e,t)=>{let n=ah(e.inputs,t),r=e.inputs[0],o=Re(e.inputs,1),a=Re(e.inputs,2),s=Re(e.inputs,3),u=Re(e.inputs,4),d=Re(e.inputs,5),c=Re(e.inputs,6),m=Re(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let f=o&&a&&o.dims.length===4&&a.dims.length===4,g=sr(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,s,0);if(f)return Gt(e,g,o,a,u,void 0,c,m,d,n);if(!o||!a)throw new Error("key and value must be provided");let _=sr(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,o,s,n.hiddenSize),b=sr(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,a,s,2*n.hiddenSize);Gt(e,g,_,b,u,void 0,c,m,d,n)}});var uh,lh,dh,ch,ko,ql,jl,Po=W(()=>{"use strict";ee();ae();Se();ue();uh=e=>{if(!e||e.length<1)throw new Error("too few inputs")},lh=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>n.push(Number(o))),r=n.length),te({numOutputs:r,axis:t.axis,splitSizes:n})},dh=e=>`
...
`)}
  ...
  }`;return{name:"Split",shaderCache:{hint:t.cacheKey,inputDependencies:["rank"]},getShaderSource:_,getRunData:()=>({outputs:c,dispatchGroup:{x:Math.ceil(r/64)},programUniforms:g})}},ql=(e,t)=>{uh(e.inputs);let n=e.inputs.length===1?t:lh(e.inputs,t);e.compute(ko(e.inputs,n),{inputs:[0]})},jl=e=>{let t=e.axis,n=e.splitSizes,r=e.numOutputs<0?n.length:e.numOutputs;if(r!==n.length)throw new Error("numOutputs and splitSizes length must be equal");return te({axis:t,numOutputs:r,splitSizes:n})}});var ph,un,Kl,Oo=W(()=>{"use strict";ee();ae();Se();ue();ph=(e,t)=>{let[n,r,o,a]=e,{numHeads:s,rotaryEmbeddingDim:u}=t;if(n.dims.length!==3&&n.dims.length!==4)throw new Error(`Input 'x' is expected to have 3 or 4 dimensions, got ${n.dims.length}`);if(!E.areEqual(r.dims,[])&&!E.areEqual(r.dims,[1])&&r.dims.length!==2)throw new Error(`Input 'position_ids' is expected to have 0, 1, or 2 dimensions, got ${r.dims.length}`);if(o.dims.length!==2)throw new Error(`Input 'cos_cache' is expected to have 2 dimensions, got ${o.dims.length}`);if(a.dims.length!==2)throw new Error(`Input 'sin_cache' is expected to have 2 dimensions, got ${a.dims.length}`);if(!E.areEqual(o.dims,a.dims))throw new Error("Inputs 'cos_cache' and 'sin_cache' are expected to have the same shape");if(u>0&&s===0)throw new Error("num_heads must be provided if rotary_embedding_dim is specified");let d=n.dims[0],c=n.dims[n.dims.length-2],m=o.dims[0],f=E.sizeFromDimension(n.dims,1)/c,g=u===0?o.dims[1]*2:f/s;if(u>g)throw new Error("rotary_embedding_dim must be less than or equal to head_size");if(r.dims.length===2){if(d!==r.dims[0])throw new Error(`Input 'position_ids' dimension 0 should be of size batch_size, got ${r.dims[0]}`);if(c!==r.dims[1])throw new Error(`Input 'position_ids' dimension 1 should be of size sequence_length, got ${r.dims[1]}`)}if(g/2!==o.dims[1]&&u/2!==o.dims[1])throw new Error(`Input 'cos_cache' dimension 1 should be same as head_size / 2 or rotary_embedding_dim / 2, got ${o.dims[1]}`);if(c>m)throw new Error("Updating cos_cache and sin_cache in RotaryEmbedding is not currently supported")},un=(e,t)=>{let{interleaved:n,numHeads:r,rotaryEmbeddingDim:o,scale:a}=t,s=e[0].dims[0],u=E.sizeFromDimension(e[0].dims,1),d=e[0].dims[e[0].dims.length-2],c=u/d,m=e[2].dims[1],f=o===0?m*2:c/r,g=new Array(s,d,c/f,f-m),_=E.computeStrides(g),b=[{type:1,data:a},{type:12,data:g},{type:12,data:_},...e[0].dims.length===3?new Array({type:12,data:[u,c,f,1]}):[],...e[0].dims.length===4?new Array({type:12,data:[u,f,d*f,1]}):[],...L(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)],w=x=>{let v=P("input",e[0].dataType,e[0].dims.length),$=P("position_ids",e[1].dataType,e[1].dims.length),T=P("cos_cache",e[2].dataType,e[2].dims.length),C=P("sin_cache",e[3].dataType,e[3].dims.length),A=N("output",e[0].dataType,e[0].dims.length);return x.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:g.length},{name:"global_strides",type:"u32",length:_.length},{name:"input_output_strides",type:"u32",length:_.length}]),`
  ...
  ${A.mainStart()}
    ...
    for (var j: u32 = 0; j < uniforms.norm_size_vectorized; j++) {
      let f32input = ${Bt(I,b,"x[j + offset]")};
      let f32scale = ${Bt(I,b,"scale[j]")};
    ...
    ${$?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},C=[{dims:u,dataType:e[0].dataType}];return v&&C.push({dims:_,dataType:1}),$&&C.push({dims:_,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${b};${n};${r}`,inputDependencies:w},getRunData:()=>({outputs:C,dispatchGroup:{x:Math.ceil(c/64)},programUniforms:x}),getShaderSource:T}},td=(e,t)=>{bh(e.inputs),e.compute(_h(e.inputs,t,e.outputCount))}});var wh,nd,od=W(()=>{"use strict";ae();nn();on();wh=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},nd=e=>{wh(e.inputs);let t=tt.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(rn(e.inputs,{activation:""},t));else{let o=t[t.length-2],a=E.size(e.inputs[0].dims.slice(0,-2)),s=E.size(e.inputs[1].dims.slice(0,-2));if(a!==1&&o===1&&s===1){let u=e.inputs[0].reshape([1,a,r]),d=e.inputs[1].reshape([1,r,n]),c=[1,a,n],m=[u,d];e.compute(ar(m,{activation:""},t,c),{inputs:m})}else e.compute(ar(e.inputs,{activation:""},t))}}});var vh,$h,xh,id,ad,sd=W(()=>{"use strict";ee();ae();Se();ue();vh=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let o=Math.floor((t.k+t.blockSize-1)/t.blockSize),a=t.blockSize/8*t.bits,s=e[1];if(!E.areEqual(s.dims,[t.n,o,a]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let d=e[2].dims;if(E.size(d)!==t.n*o)throw new Error("scales input size error.");if(e.length===4){let m=e[3].dims,f=t.n*(t.bits===8?o:Math.floor((o*t.bits+7)/8));if(E.size(m)!==f)throw new Error("zeroPoints input size error.")}},$h=(e,t)=>{let n=e[0].dims,r=n.length,o=n[r-2],a=t.k,s=t.n,u=n.slice(0,r-2),d=E.size(u),m=e[1].dims[2]/4,f=e[0].dataType,g=he(t.k),_=he(m),b=he(s),w=u.concat([o,s]),x=o>1&&s/b%2===0?2:1,v=E.size(w)/b/x,$=64,T=[],C=[d,o,a/g],A=E.convertShape(e[1].dims).slice();A.splice(-1,1,m/_),T.push(...L(C)),T.push(...L(A)),T.push(...L(e[2].dims)),e.length===4&&T.push(...L(E.convertShape(e[3].dims)));let I=[d,o,s/b];T.push(...L(I));let z=D=>{let R=C.length,H=P("a",e[0].dataType,R,g),q=P("b",12,A.length,_),Y=P("scales",e[2].dataType,e[2].dims.length),ne=[H,q,Y],F=e.length===4?P("zero_points",12,e[3].dims.length):void 0;F&&ne.push(F);let me=I.length,oe=N("output",e[0].dataType,me,b),j=ve(e[0].dataType),ie=(()=>{switch(g){case 1:return`array<${j}, 8>`;case 2:return`mat4x2<${j}>`;case 4:return`mat2x4<${j}>`;default:throw new Error(`${g}-component is not supported.`)}})(),Z=()=>{let pe=`
          // reuse a data
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${g};${_};${b};${x};${$}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:w,dataType:f}],dispatchGroup:{x:v},programUniforms:T}),getShaderSource:z}},xh=(e,t)=>{let n=e[0].dims,r=n.length,o=n[r-2],a=t.k,s=t.n,u=n.slice(0,r-2),d=E.size(u),m=e[1].dims[2]/4,f=e[0].dataType,g=he(t.k),_=he(m),b=u.concat([o,s]),w=128,x=s%8===0?8:s%4===0?4:1,v=w/x,$=v*_*8,T=$/g,C=$/t.blockSize,A=E.size(b)/x,I=[],z=[d,o,a/g],D=E.convertShape(e[1].dims).slice();D.splice(-1,1,m/_),I.push(...L(z)),I.push(...L(D)),I.push(...L(e[2].dims)),e.length===4&&I.push(...L(E.convertShape(e[3].dims)));let R=[d,o,s];I.push(...L(R));let H=q=>{let Y=z.length,ne=P("a",e[0].dataType,Y,g),F=P("b",12,D.length,_),me=P("scales",e[2].dataType,e[2].dims.length),oe=[ne,F,me],j=e.length===4?P("zero_points",12,e[3].dims.length):void 0;j&&oe.push(j);let ie=R.length,Z=N("output",e[0].dataType,ie),ce=ve(e[0].dataType),Te=()=>{switch(g){case 1:return`
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${g};${_};${v};${x}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:b,dataType:f}],dispatchGroup:{x:A},programUniforms:I}),getShaderSource:H}},id=(e,t)=>{vh(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(xh(e.inputs,t)):e.compute($h(e.inputs,t))},ad=e=>te(e)});var Sh,Th,Ch,Ih,Ah,Eh,kh,Ph,ud,ld=W(()=>{"use strict";ee();ae();ue();Sh=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Th=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
    ...
    `,u="",d=P("x",t.dataType,t.dims.length),c=["rank"],[m,f,g,_,b]=cd(a,o);return m.push(...L(t.dims,a)),{name:e,shaderCache:{hint:`${r.cacheKey};${g};${_};${b}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(E.size(a)/64)},programUniforms:m}),getShaderSource:w=>pd(w,d,t.dims.length,a.length,o,s,u,t.dataType===10?-65504:-1e5,f,g,_,b)}},$d=(e,t)=>{ln(e.inputs),e.compute(vd("MaxPool",e.inputs[0],!1,t))},xd=e=>{let t=e.storage_order,n=e.dilations,r=fd(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:n,...r,cacheKey:""};return{...o,cacheKey:zh(o)}},Sd=e=>{let t=e.format;return{format:t,...bd,cacheKey:t}},Td=(e,t)=>{ln(e.inputs),e.compute(vd("GlobalMaxPool",e.inputs[0],!0,t))}});var Bh,Mh,Id,Ad,Ed=W(()=>{"use strict";ee();ae();Se();ue();Bh=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,a)=>a===t.axis||o===e[0].dims[a]).reduce((o,a)=>o&&a,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Mh=(e,t)=>{let n=E.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,o=r===3,a=e[0].dims,s=e[1].dataType,u=E.size(a),d=r===3||r===2,c=d?[Math.ceil(E.size(e[0].dims)/4)]:e[0].dims,m=e[1].dims,f=e.length>2?e[2]:void 0,g=f?d?[Math.ceil(E.size(f.dims)/4)]:f.dims:void 0,_=m.length===0||m.length===1&&m[0]===1,b=_===!1&&m.length===1,w=he(u),x=_&&(!d||w===4),v=x?w:1,$=x&&!d?w:1,T=P("input",d?12:r,c.length,$),C=P("scale",s,m.length),A=f?P("zero_point",d?12:r,g.length):void 0,I=N("output",s,a.length,v),z=[T,C];A&&z.push(A);let D=[c,m];f&&D.push(g);let R=[{type:12,data:u/v},{type:12,data:n},{type:12,data:t.blockSize},...L(...D,a)],H=q=>{let Y=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:A?["rank","rank","rank"]:["rank","rank"]},getShaderSource:H,getRunData:()=>({outputs:[{dims:a,dataType:s}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:R})}},Id=(e,t)=>{Bh(e.inputs,t),e.compute(Mh(e.inputs,t))},Ad=e=>te({axis:e.axis,blockSize:e.blockSize})});var Rh,Uh,kd,Pd=W(()=>{"use strict";Ne();ee();ue();Rh=(e,t,n)=>{let r=e===t,o=e<t&&n<0,a=e>t&&n>0;if(r||o||a)throw new Error("Range these inputs' contents are invalid.")},Uh=(e,t,n,r)=>{let o=Math.abs(Math.ceil((t-e)/n)),a=[o],s=o,u=[{type:12,data:s},{type:r,data:e},{type:r,data:n},...L(a)],d=c=>{let m=N("output",r,a.length),f=m.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${c.registerUniforms(g).declareVariables(m)}
        ${c.mainStart()}
        ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:d,getRunData:()=>({outputs:[{dims:a,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:u})}},kd=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),we.webgpu.validateInputContent&&Rh(t,n,r),e.compute(Uh(t,n,r,e.inputs[0].dataType),{inputs:[]})}});var Nh,Vh,Od,zd,Dd=W(()=>{"use strict";ee();ae();Se();ue();Nh=(e,t,n,r)=>{if(e!=="none"&&r!=="i32"&&r!=="u32"&&r!=="f32")throw new Error(`Input ${r} is not supported with reduction ${e}.`);let o=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,a=`;
...
`}
      ...
      }`},C=[{dims:u,dataType:e[0].dataType}];return n>1&&C.push({dims:m,dataType:1}),n>2&&C.push({dims:m,dataType:1}),n>3&&C.push({dims:a,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${_};${b};${w}`,inputDependencies:e.map((A,I)=>"type")},getShaderSource:T,getRunData:()=>({outputs:C,dispatchGroup:{x:Math.ceil(d/c)},programUniforms:$})}},Vd=(e,t)=>{ng(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(og(e.inputs,t,e.outputCount,!1),{outputs:r})}});var ig,dn,ag,Ld,sg,ug,Gd,Hd,Fd=W(()=>{"use strict";ee();ae();Se();ue();ig=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},dn=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},ag=(e,t)=>{if(e.length>1){let n=dn(e,1),r=dn(e,2),o=dn(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),te({starts:n,ends:r,axes:o})}else return t},Ld=(e,t,n,r,o)=>{let a=e;return e<0&&(a+=n[r[t]]),o[t]<0?Math.max(0,Math.min(a,n[r[t]]-1)):Math.max(0,Math.min(a,n[r[t]]))},sg=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${d.length}_${s.length}_${a.length}`,inputDependencies:["rank"]},getShaderSource:x,getRunData:()=>({outputs:[m],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:w})}},Gd=(e,t)=>{ig(e.inputs,t);let n=ag(e.inputs,t);e.compute(ug(e.inputs,n),{inputs:[0]})},Hd=e=>{let t=e.starts,n=e.ends,r=e.axes;return te({starts:t,ends:n,axes:r})}});var lg,dg,qd,jd,Kd=W(()=>{"use strict";ee();ae();Se();dt();ue();lg=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},dg=(e,t)=>{let n=e.inputs[0],r=n.dims,o=E.size(r),a=r.length,s=E.normalizeAxis(t.axis,a),u=s<r.length-1,d,c=[];u?(c=Array.from({length:a},(z,D)=>D),c[s]=a-1,c[a-1]=s,d=e.compute(ke(n,c),{inputs:[n],outputs:[-1]})[0]):d=n;let m=d.dims,f=m[a-1],g=o/f,_=he(f),b=f/_,w=64;g===1&&(w=256);let x=(z,D)=>D===4?`max(max(${z}.x, ${z}.y), max(${z}.z, ${z}.w))`:D===2?`max(${z}.x, ${z}.y)`:D===3?`max(max(${z}.x, ${z}.y), ${z}.z)`:z,v=P("x",d.dataType,d.dims,_),$=N("result",d.dataType,d.dims,_),T=v.type.value,C=ve(d.dataType)==="f32"?`var threadMax = ${T}(-3.402823e+38f);`:`var threadMax = ${T}(-65504.0h);`,A=z=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:[{type:12,data:a},...L(e[0].dims,o)]}),getShaderSource:c}},Qd=e=>{cg(e.inputs),e.compute(mg(e.inputs),{inputs:[0]})}});var fg,hg,Xd,Jd=W(()=>{"use strict";ee();ae();ue();fg=(e,t,n,r,o)=>{let a=N("output_data",o,n.length,4),s=P("a_data",t[1].dataType,t[1].dims.length,4),u=P("b_data",t[2].dataType,t[2].dims.length,4),d=P("c_data",t[0].dataType,t[0].dims.length,4),c,m=(f,g,_)=>`select(${g}, ${f}, ${_})`;if(!r)c=a.setByOffset("global_idx",m(s.getByOffset("global_idx"),u.getByOffset("global_idx"),d.getByOffset("global_idx")));else{let f=(g,_,b="")=>{let w=`a_data[index_a${_}][component_a${_}]`,x=`b_data[index_b${_}][component_b${_}]`,v=`bool(c_data[index_c${_}] & (0xffu << (component_c${_} * 8)))`;return`
