...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},lo=(e,t)=>new Pr(e,t),Xe=(e,t)=>{let r=e.length,o=[];for(let n=0;n<r;n++){let s=r-1-n,i=e[s]||1;(t[t.length-1-n]||1)>1&&i===1&&o.unshift(s)}return o}});var Uu,co,Nu,Lu,Wu,pe,po,mo,Oe=k(()=>{"use strict";M();q();ue();F();Uu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},co=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Nu=(e,t)=>x.sortBasedOnPerm(e,co(e.length,t)),Lu=(e,t,r,o)=>{let n=`fn perm(i: ${o.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)n+=r.indicesSet("a",e[s],`i[${s}]`);return n+="return a;}"},Wu=(e,t)=>{let r=[],o=[];for(let n=0;n<e.length;++n)e[n]!==1&&r.push(e[n]),e[t[n]]!==1&&o.push(t[n]);return{newShape:r,newPerm:o}},pe=(e,t)=>{let r=e.dataType,o=e.dims.length,n=co(o,t),s=Nu(e.dims,n),{newShape:i,newPerm:a}=Wu(e.dims,n),u=x.areEqual(a,[2,3,1]),l=x.areEqual(a,[3,1,2]),d=i.length===2&&a[0]>a[1]||u||l,c=d?i:e.dims,p=s;d&&(c=u?[i[0],i[1]*i[2]]:l?[i[0]*i[1],i[2]]:i,p=[c[1],c[0]]);let h=S("a",r,c.length),m=C("output",r,p.length),f=16,b;return d?b=y=>`
  ...
  ${y.mainStart()}
    ...
    ${m.setByOffset("global_idx",h.getByIndices("aIndices"))}
       ...
       `,m=f=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},Ee=(e,t,r,o)=>{let n=e.inputs.length===1?r:Or(e.inputs,r),s=n.axes;s.length===0&&!n.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((h,m)=>m));let i=x.normalizeAxes(s,e.inputs[0].dims.length),a=i,u=e.inputs[0],l=Qu(a,e.inputs[0].dims.length);l.length>0&&(u=e.compute(pe(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],a=Ku(a.length,u.dims.length));let[d,c]=ju(u.dims,a),p=d;n.keepDims&&(p=Zu(d,i)),e.compute(Yu(t,n.cacheKey,[u],o,e.inputs[0].dataType,p,c),{inputs:[u]})},fo=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},ho=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},go=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},yo=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},bo=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},wo=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},_o=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},$o=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},vo=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},xo=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}});var Pe,Ju,Ft,Or,ze,el,tl,rl,nl,ol,il,sl,al,ul,ll,Be,Io,To,Co,Ao,ko,Eo,Po,zo,Bo,Do,qt=k(()=>{"use strict";M();q();ue();F();So();Pe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Ju=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ft=(e,t,r,o,n,s,i=!1,a=!1)=>{let u=[],l=r[0].dims,d=l.length,c=x.normalizeAxes(n,d),p=!a&&c.length===0;l.forEach((b,y)=>{p||c.indexOf(y)>=0?i&&u.push(1):u.push(b)});let h=u.length,m=x.size(u);return{name:e,shaderCache:t,getShaderSource:b=>{let y=[],g=S("_A",r[0].dataType,d),w=C("output",s,h),_=o(g,w,c),$=_[2];for(let v=0,I=0;v<d;v++)p||c.indexOf(v)>=0?(i&&I++,$=`for(var j${v}: u32 = 0; j${v} < ${l[v]}; j${v}++) {
...
var best_index : i32 = 0;`,`if (${o.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${o}_${i}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...E(s)]:[{type:12,data:u}]})}},yl=e=>U(e),No=(e,t)=>{let{inputs:r,outputCount:o}=e,n=yl({...t,outputCount:o});if(J.webgpu.validateInputContent&&hl(r,n),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(gl(r,n))}});var bl,wl,Wo,Go=k(()=>{"use strict";q();F();bl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},wl=e=>{let t=e[0].dims,r=e[0].dims[2],o=x.size(t)/4,n=e[0].dataType,s=S("input",n,t,4),i=S("bias",n,[r],4),a=S("residual",n,t,4),u=C("output",n,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(o/64)}}),getShaderSource:d=>`
  ...
  }`}},Wo=e=>{bl(e.inputs),e.compute(wl(e.inputs))}});var _l,te,Ho,qo,Fo,Ko,jo,Zo,Xo,Qo,Yo,$l,Jo,ei,ti,ri,lt,ni,jt,oi,ii,si,ai,ui,li,di,ci,pi,mi,fi,hi,gi,yi,bi,wi,_i,$i,Vr,Ur,vi,xi,Si,vl,xl,Ii,Zt=k(()=>{"use strict";M();q();ue();F();_l=(e,t,r,o,n,s,i)=>{let a=Math.ceil(t/4),u="";typeof n=="string"?u=`${n}(a)`:u=n("a");let l=S("inputData",r,[a],4),d=C("outputData",o,[a],4),c=[{name:"vec_size",type:"u32"}];return i&&c.push(...i),`
  ...
  }`},te=(e,t,r,o,n,s=e.dataType,i,a)=>{let u=[{type:12,data:Math.ceil(x.size(e.dims)/4)}];return i&&u.push(...i),{name:t,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:l=>_l(l,x.size(e.dims),e.dataType,s,r,o,a),getRunData:l=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(x.size(l[0].dims)/64/4)},programUniforms:u})}},Ho=e=>{e.compute(te(e.inputs[0],"Abs","abs"))},qo=e=>{e.compute(te(e.inputs[0],"Acos","acos"))},Fo=e=>{e.compute(te(e.inputs[0],"Acosh","acosh"))},Ko=e=>{e.compute(te(e.inputs[0],"Asin","asin"))},jo=e=>{e.compute(te(e.inputs[0],"Asinh","asinh"))},Zo=e=>{e.compute(te(e.inputs[0],"Atan","atan"))},Xo=e=>{e.compute(te(e.inputs[0],"Atanh","atanh"))},Qo=e=>U(e),Yo=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(te(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},$l=e=>{let t,r,o=e.length>=2&&e[1].data!==0,n=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=o?e[1].getFloat32Array()[0]:-34028234663852886e22,r=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=o?e[1].getUint16Array()[0]:64511,r=n?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return U({min:t,max:r})},Jo=(e,t)=>{let r=t||$l(e.inputs),o=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Clip",n=>`clamp(${n}, vec4<${o}>(uniforms.min), vec4<${o}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:o},{name:"max",type:o}]),{inputs:[0]})},ei=e=>{e.compute(te(e.inputs[0],"Ceil","ceil"))},ti=e=>{e.compute(te(e.inputs[0],"Cos","cos"))},ri=e=>{e.compute(te(e.inputs[0],"Cosh","cosh"))},lt=e=>U(e),ni=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Elu",o=>`elu_vf32(${o})`,`
...
}`,oi=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,jt(t)))},ii=e=>{e.compute(te(e.inputs[0],"Exp","exp"))},si=e=>{e.compute(te(e.inputs[0],"Floor","floor"))},ai=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,jt(t)))},ui=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"LeakyRelu",o=>`select(leaky_relu_alpha_ * ${o}, ${o}, ${o} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},li=e=>{e.compute(te(e.inputs[0],"Not",t=>`!${t}`))},di=e=>{e.compute(te(e.inputs[0],"Neg",t=>`-${t}`))},ci=e=>{e.compute(te(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},pi=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},mi=e=>{e.compute(te(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},fi=e=>U(e),hi=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"HardSigmoid",o=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${o} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},gi=e=>{e.compute(te(e.inputs[0],"Sin","sin"))},yi=e=>{e.compute(te(e.inputs[0],"Sinh","sinh"))},bi=e=>{e.compute(te(e.inputs[0],"Sqrt","sqrt"))},wi=e=>{e.compute(te(e.inputs[0],"Tan","tan"))},_i=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,$i=e=>{e.compute(te(e.inputs[0],"Tanh",_i))},Vr=(e="f32")=>`
...
`,Ur=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,vi=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"FastGelu",Ur,Vr(t),void 0,e.inputs[0].dataType))},xi=(e,t)=>{let r=ce(e.inputs[0].dataType);return e.compute(te(e.inputs[0],"ThresholdedRelu",o=>`select(vec4<${r}>(0.0), ${o}, ${o} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Si=e=>{e.compute(te(e.inputs[0],"Log","log"))},vl=(e,t)=>`
...
`,xl=e=>`quick_gelu_impl(${e})`,Ii=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"QuickGelu",xl,vl(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var Sl,Il,Ci,Ai=k(()=>{"use strict";q();F();Zt();Sl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Il=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=S("input",e[0].dataType,e[0].dims,4),o=S("bias",e[0].dataType,[e[0].dims[2]],4),n=C("output",e[0].dataType,t,4),s=x.size(t)/4,i=ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
...
`)},zl=(e,t,r,o)=>{let n=x.size(r),s=new Array(e.length),i=new Array(e.length),a=0,u=[],l=[],d=[{type:12,data:n}];for(let f=0;f<e.length;++f)a+=e[f].dims[t],s[f]=a,l.push(e[f].dims.length),i[f]=S(`input${f}`,o,l[f]),u.push("rank"),d.push({type:12,data:s[f]});for(let f=0;f<e.length;++f)d.push(...E(e[f].dims));d.push(...E(r));let c=C("output",o,r.length),p=c.indicesGet("indices",t),h=Array.from(Array(s.length).keys()).map(f=>`uniforms.sizeInConcatAxis${f}`).join(","),m=f=>`
  ...
  ${f.mainStart()}
    ...
    ${Pl(i,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:o}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:d}),getShaderSource:m}},Ni=(e,t)=>{let r=e.inputs,o=r[0].dims,n=x.normalizeAxis(t.axis,o.length);kl(r,n);let s=o.slice();s[n]=r.reduce((a,u)=>a+(u.dims.length>n?u.dims[n]:0),0);let i=r.filter(a=>x.size(a.dims)>0);e.compute(zl(i,n,s,r[0].dataType),{inputs:i})},Li=e=>U({axis:e.axis})});var $e,ve,xe,Xt,Re=k(()=>{"use strict";M();q();$e=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},ve=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},xe=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Xt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,o]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:o}}else if(t==="Clip"){let[r,o]=e?.activation_params||[ao,uo];return{activation:t,clipMax:o,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}});var fe,Qt,dt=k(()=>{"use strict";fe=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Qt=e=>`
...
`});var Bl,Dl,ct,Gi,Ol,pt,Rl,mt,ft=k(()=>{"use strict";M();q();F();Re();dt();Bl=(e,t)=>e?`
        ...
        }`,ct=(e,t,r="f32",o,n=!1,s=32,i=!1,a=32)=>{let u=t[1]*e[1],l=t[0]*e[0],d=n?u:s,c=n?s:u,p=d/t[0],h=s/t[1];if(!((n&&p===4&&e[1]===4||!n&&(p===3||p===4))&&d%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${n} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `,Ol=e=>e?"let ACached = mm_Asub[k][tileRow + innerRow];":"let ACached = mm_Asub[tileRow + innerRow][k];",pt=(e,t,r="f32",o,n=!1,s=32,i=!1,a=32,u=!1)=>{let l=e[1]*t[1],d=e[0]*t[0],c=n?l:s,p=n?s:l;if(!(p%t[1]===0&&c%t[0]===0&&s%t[1]===0))throw new Error(`tileAHight ${p} must be divisible by workgroupSize[1]${t[1]}, tileAWidth ${c} must be divisible by workgroupSize[0]${t[0]}, tileInner ${s} must be divisible by workgroupSize[1]${t[1]}`);let h=p/t[1],m=c/t[0],f=s/t[1],b=u?`
    let localRow = i32(localId.y);
...
`},Rl=(e,t,r,o,n,s=!1)=>{let[i,a,u]=n,[l,d,c,p]=o,h=Xe(i,u),m=Xe(a,u),f=ee(o[0].type.tensor),b=()=>{let w=d.rank,_=l.rank,$=`var aIndices: ${d.type.indices};`;for(let v=w-2-1,I=_-1;v>=0;v--,I--)$+=`
...
bIndices[${w-2}] = u32(row);
    ...
    `},mt=(e,t,r,o,n=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i.slice(0,-2),l=a.slice(0,-2),d=o?o.slice(0,-2):r.slice(0,-2),c=x.size(d),p=i[i.length-2],h=i[i.length-1],m=a[a.length-1],f=h%4===0&&m%4===0,b=p<=8?[4,1,1]:[4,4,1],y=[8,8,1],g=[Math.ceil(m/y[0]/b[0]),Math.ceil(p/y[1]/b[1]),Math.ceil(c/y[2]/b[2])],w=f?4:1,_=[...u,p,h/w],$=_.length,v=[...l,h,m/w],I=v.length,T=[c,p,m/w],A=[{type:6,data:p},{type:6,data:m},{type:6,data:h}];ve(t,A),A.push(...E(d,_,v));let B=["rank","rank"],O=e.length>2;O&&(A.push(...E(e[2].dims)),B.push("rank")),A.push(...E(T));let W=z=>{let N=d.length,se=Ht("batchDims",e[0].dataType,N,1),L=ee(e[0].dataType),Z=S("a",e[0].dataType,$,w),K=S("b",e[1].dataType,I,w),V=C("result",e[0].dataType,T.length,w),ne=[Z,K];if(O){let R=n?w:1;ne.push(S("bias",e[2].dataType,e[2].dims.length,R))}let oe=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];xe(t,oe);let Q=ee(V.type.tensor),H=$e(t,V.type.value,Q),P=Rl(w,O,H,[se,Z,K,V],[u,l,d],n);return`
  ${z.registerUniforms(oe).registerInternalVariables(se).declareVariables(...ne,V)}
  ${P}
  ${f?ct(b,y,L,se):pt(b,y,L,se)}
                   `};return{name:"MatMul",shaderCache:{hint:`${b};${t.activation};${f};${n}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:A}),getShaderSource:W}}});var Ml,Hi,qi=k(()=>{"use strict";M();Ce();F();Re();dt();Nr();ft();Ml=(e,t,r,o,n=!1,s,i=4,a=4,u=4,l="f32")=>{let d=B=>{switch(B){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},c=B=>{switch(B){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},p=e?`
    ...
    return ${fe(i,l)}(0.0);`,_=`${c(a)}`,$=fe(u,l),v=e?fe(i,l):fe(a,l),I=e?fe(a,l):fe(i,l),T=$e(s,$,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${f?`vec4<${V}>`:V}) {
        ...
        ${f?ct(w,g,V,void 0,!l,T):pt(w,g,V,void 0,!l,T,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${$};${f};${A};${B};${O};${v};${I};${T}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:_[0],y:_[1],z:_[2]},programUniforms:z}),getShaderSource:se}}});var Vl,Fi,Jt,Ul,Ki,Nl,ji,Zi,Xi=k(()=>{"use strict";M();Ce();q();F();Re();dt();Vl=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Fi=e=>typeof e=="number"?[e,e,e]:e,Jt=(e,t)=>t<=1?e:e+(e-1)*(t-1),Ul=(e,t,r,o=1)=>{let n=Jt(t,o);return Math.floor((e[0]*(r-1)-r+n)/2)},Ki=(e,t,r,o,n)=>{n==null&&(n=Ul(e,t[0],o[0]));let s=[0,0,0,r];for(let i=0;i<3;i++)e[i]+2*n>=t[i]&&(s[i]=Math.trunc((e[i]-t[i]+2*n)/o[i]+1));return s},Nl=(e,t,r,o,n,s,i,a,u,l)=>{let d,c,p,h;if(e==="VALID"&&(e=0),typeof e=="number"){d={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=Ki([t,r,o,1],[a,u,l],1,[n,s,i],e);c=m[0],p=m[1],h=m[2]}else if(Array.isArray(e)){if(!e.every((f,b,y)=>f===y[0]))throw Error(`Unsupported padding parameter: ${e}`);d={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=Ki([t,r,o,1],[a,u,l],1,[n,s,i],e[0]);c=m[0],p=m[1],h=m[2]}else if(e==="SAME_UPPER"){c=Math.ceil(t/n),p=Math.ceil(r/s),h=Math.ceil(o/i);let m=(c-1)*n+a-t,f=(p-1)*s+u-r,b=(h-1)*i+l-o,y=Math.floor(m/2),g=m-y,w=Math.floor(f/2),_=f-w,$=Math.floor(b/2),v=b-$;d={top:w,bottom:_,left:$,right:v,front:y,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:d,outDepth:c,outHeight:p,outWidth:h}},ji=(e,t,r,o,n,s=!1,i="channelsLast")=>{let a,u,l,d,c;if(i==="channelsLast")[a,u,l,d,c]=e;else if(i==="channelsFirst")[a,c,u,l,d]=e;else throw new Error(`Unknown dataFormat ${i}`);let[p,,h,m,f]=t,[b,y,g]=Fi(r),[w,_,$]=Fi(o),v=Jt(h,w),I=Jt(m,_),T=Jt(f,$),{padInfo:A,outDepth:B,outHeight:O,outWidth:W}=Nl(n,u,l,d,b,y,g,v,I,T),z=s?p*c:p,N=[0,0,0,0,0];return i==="channelsFirst"?N=[a,z,B,O,W]:i==="channelsLast"&&(N=[a,B,O,W,z]),{batchSize:a,dataFormat:i,inDepth:u,inHeight:l,inWidth:d,inChannels:c,outDepth:B,outHeight:O,outWidth:W,outChannels:z,padInfo:A,strideDepth:b,strideHeight:y,strideWidth:g,filterDepth:h,filterHeight:m,filterWidth:f,effectiveFilterDepth:v,effectiveFilterHeight:I,effectiveFilterWidth:T,dilationDepth:w,dilationHeight:_,dilationWidth:$,inShape:e,outShape:N,filterShape:t}},Zi=(e,t,r,o,n,s)=>{let i=s==="channelsLast",a=i?e[0].dims[3]:e[0].dims[1],u=!1,l=[64,1,1],d={x:r.map((g,w)=>w)},c=[Math.ceil(Vl(d.x.map(g=>r[g]))/l[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${c}`);let p=u?i&&a%4!==0?3:4:1,h=x.size(r),m=[{type:12,data:h},{type:12,data:o},{type:12,data:n},{type:12,data:t.strides},{type:12,data:t.dilations}];ve(t,m),m.push(...E(e[0].dims,e[1].dims));let f=["rank","rank"],b=e.length===3;b&&(m.push(...E(e[2].dims)),f.push("rank")),m.push(...E(r));let y=g=>{let w=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:o.length},{name:"pads",type:"u32",length:n.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];xe(t,w);let _=u?4:1,$=ee(e[0].dataType),v=S("x",e[0].dataType,e[0].dims.length,p===3?1:p),I=S("W",e[1].dataType,e[1].dims.length,_),T=[v,I],A=C("result",e[0].dataType,r.length,_),B="";if(b){let z=S("bias",e[2].dataType,e[2].dims.length,_);T.push(z),B+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${$}>`:$} {
          return bias[${i?D("coords",4,5):D("coords",1,5)}${u?"/ 4":""}];
        }`}let O=fe(p,$),W=$e(t,O,$);return`
            ${B}
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${i};${p};${b}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:c[0],y:c[1],z:c[2]},programUniforms:m}),getShaderSource:y}}});var Qi,Yi,Ji=k(()=>{"use strict";M();q();F();Re();Qi=(e,t,r,o)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",i=e[0].dims,a=e[1].dims,u=t.format==="NHWC",l=u?r[3]:r[1],d=l/t.group,c=u&&d>=4?re(l):1,p=x.size(r)/c,h=[{type:12,data:p},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];ve(t,h),h.push(...E(i,[a[0],a[1],a[2],a[3]/c]));let m=n?["rank","rank","rank"]:["rank","rank"];h.push(...E([r[0],r[1],r[2],r[3]/c]));let f=b=>{let y=C("output",e[0].dataType,r.length,c),g=ee(y.type.tensor),w=$e(t,y.type.value,g),_=S("x",e[0].dataType,i.length),$=S("w",e[1].dataType,a.length,c),v=[_,$];n&&v.push(S("b",e[2].dataType,e[2].dims,c));let I=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];xe(t,I);let T=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${c}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:o?o(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Yi=(e,t,r,o)=>{let n=e.length>2,s=re(r[3]),i=re(r[2]),a=x.size(r)/s/i,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],d=[r[0],r[1],r[2],r[3]/s],c=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ve(t,c),c.push(...E(u,l,d));let p=(i-1)*t.strides[1]+l[1],h=m=>{let f=C("output",e[0].dataType,d.length,s),b=ee(f.type.tensor),y=$e(t,f.type.value,b),g=S("x",e[0].dataType,u.length,s),w=S("w",e[1].dataType,l.length,s),_=[g,w];n&&_.push(S("b",e[2].dataType,e[2].dims,s));let $=n?"value += b[output_channel];":"",v=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return xe(t,v),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${s};${i};${p};${l[0]};${l[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:o?o(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:h}}});var Lr,Ll,es,Wr=k(()=>{"use strict";M();q();ft();F();Re();Lr=(e,t,r,o,n=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i[i.length-2],l=a[a.length-1],d=i[i.length-1],c=re(l),p=re(d),h=re(u),m=x.size(r)/c/h,f=e.length>2,b=o?o.slice(0,-2):r.slice(0,-2),g=[x.size(b),u,l],w=[{type:12,data:m},{type:12,data:u},{type:12,data:l},{type:12,data:d}];ve(t,w),w.push(...E(b,i,a)),f&&w.push(...E(e[2].dims)),w.push(...E(g));let _=$=>{let v=Ht("batch_dims",e[0].dataType,b.length),I=S("a",e[0].dataType,i.length,p),T=S("b",e[1].dataType,a.length,c),A=C("output",e[0].dataType,g.length,c),B=ee(A.type.tensor),O=$e(t,A.type.value,B),W=[I,T],z="";if(f){let oe=n?c:1;W.push(S("bias",e[2].dataType,e[2].dims.length,oe)),z=`${n?`value += bias[col / ${oe}];`:`value += ${A.type.value}(bias[row + i]);`}`}let N=i.slice(0,-2),se=a.slice(0,-2),L=Xe(N,b),Z=Xe(se,b),K=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];xe(t,K);let V=(oe,Q)=>{let H=oe.rank,P=oe.name;if(H===2)return`var ${P}_indices = ${oe.type.indices}(0u, 0u);`;let R=v.rank,Y=`var ${P}_indices: ${oe.type.indices};`;for(let ye=H-2-1,ie=R-1;ye>=0;ye--,ie--)Y+=`
${P}_indices[${ye}] = ${R>1?`batch_indices[${ie}]`:"batch_indices"};`;return Q.forEach(ye=>{Y+=`
...
`}return oe};return`
  ...
  ${s?w:_}}`},Kr=(e,t,r)=>{let o=e.length>2,n=t.outputShape,s=x.size(n),i=[Math.ceil(s/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${i}`);let a=t.format==="NHWC",u=["rank","rank"],l=[t.strides[0],t.strides[1]],d=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],c=[t.dilations[0],t.dilations[1]],p=[d[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),d[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],h=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,f=t.group,b=e[1].dims,y=b[0]/f,g=b[1],w=[{type:12,data:s},{type:12,data:l},{type:12,data:d},{type:12,data:c},{type:12,data:p},{type:6,data:h},{type:12,data:y},{type:12,data:g},...E(e[0].dims,e[1].dims)];o&&(w.push(...E(e[2].dims)),u.push("rank")),w.push(...E(n));let _=i[1]===1&&i[2]===1,$=v=>{let I=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:l.length},{name:"filter_dims",type:"u32",length:d.length},{name:"dilations",type:"u32",length:d.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:h.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],T=ee(e[0].dataType);return`${Kl(v,e,n,o,_,m,T,I,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:i[0],y:i[1],z:i[2]},outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:$}}});var jl,Zl,Xl,ss,as,Ql,Yl,Jl,ed,us,ls=k(()=>{"use strict";os();is();Re();Oe();jl=(e,t,r,o,n,s)=>(e-1)*t+r+(o-1)*n+1-s,Zl=(e,t,r,o,n)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[o]=s,r[n]=e-s):t==="SAME_LOWER"&&(r[o]=e-s,r[n]=s)},Xl=(e,t,r,o,n,s,i,a,u,l)=>{let d=e.length-2,c=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let p=e[0],h=t[a?3:1]*n;for(let m=0,f=e.length-d-(a?1:0);m<d;++m,++f){let b=e[f],y=c?b*i[m]:l[m],g=jl(b,i[m],s[m],t[f],r[m],y);Zl(g,o,s,m,m+d),c&&l.push(i[m]*(b-1)+u[m]+(t[f]-1)*r[m]+1-s[m]-s[m+d])}l.splice(0,0,p),l.splice(a?3:1,0,h)},ss=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){r.length=0;for(let c=2;c<t[1].dims.length;++c)r.push(t[1].dims[c])}let o=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(o?3:1,0,t[1].dims[1]);let n=e.pads.slice(),s=e.outputShape.slice(),i=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let l=e.strides.slice();if(l.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;l=new Array(c).fill(1)}Xl(a,r,u,e.autoPad,e.group,n,l,o,i,s);let d=Object.assign({},e);return Object.assign(d,{kernelShape:r,pads:n,outputPadding:i,outputShape:s,dilations:u,strides:l}),d},as=e=>{let t=Xt(e),r=e.format,o=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],n=e.dilations,s=e.group,i=e.kernelShape,a=e.pads,u=e.strides,l=e.wIsConst(),d=e.outputPadding,c=e.outputShape;return{autoPad:o,format:r,dilations:n,group:s,kernelShape:i,outputPadding:d,outputShape:c,pads:a,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},Ql=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],o=e[1].dims[0];if(r!==o)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let n=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==n))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((d,c)=>d+c,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((d,c)=>d+c,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((d,c)=>d+c,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((d,c)=>d+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Yl=[2,3,1,0],Jl=(e,t,r)=>{let o=ss(r,t),n=r.format==="NHWC",s=o.outputShape,i=s[n?3:1],a=t[0].dims[n?3:1];if(o.group!==1||i===1&&a===1){e.compute(Kr(t,o));return}let u=s[n?1:2],l=s[n?2:3],d=t[1].dims[2],c=t[1].dims[3],p=n?u*l:i,h=n?i:u*l,m=d*c*a,f=!0,b=e.kernelCustomData.wT??e.compute(pe(t[1],Yl),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let y=[t[0],b],g=t.length===3;g&&(!n&&t[2].dims.length===1?y.push(t[2].reshape([t[2].dims[0],1,1])):y.push(t[2])),e.compute(ns(y,o,s,p,h,m,g,f),{inputs:y})},ed=(e,t)=>{let r=t.format==="NHWC",o=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&o.push(e.inputs[2]);let n=t.kernelShape;(n.length===0||n[0]===0)&&(n=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let i=t.strides;(i.length===0||i[0]===0)&&(i=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],i=[1].concat(i),s=[1].concat(s),n=[1].concat(n);let u=ss({...t,pads:a,strides:i,dilations:s,kernelShape:n},o);e.compute(Kr(o,u,l=>r?[l[0],l[2],l[3]]:[l[0],l[1],l[3]]))},us=(e,t)=>{Ql(e.inputs,t),e.inputs[0].dims.length===3?ed(e,t):Jl(e,e.inputs,t)}});var td,ds,cs,ps=k(()=>{"use strict";M();q();ue();F();td=(e,t,r,o)=>{let n=x.size(t),s=t.length,i=S("input",e,s),a=C("output",e,s),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),l=x.normalizeAxis(u,s),d=c=>{let p=` i32(${i.indicesGet("inputIndices","uniforms.axis")}) `,h=D("uniforms.input_shape","uniforms.axis",s),m=o.reverse?p+(o.exclusive?" + 1":""):"0",f=o.reverse?h:p+(o.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:o.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:[{type:12,data:n},{type:12,data:l},...E(t,t)]}),getShaderSource:d}},ds=(e,t)=>{let r=e.inputs[0].dims,o=e.inputs[0].dataType,n=e.inputs[1];e.compute(td(o,r,n,t),{inputs:[0]})},cs=e=>{let t=e.exclusive===1,r=e.reverse===1;return U({exclusive:t,reverse:r})}});var rd,nd,od,ms,fs,hs=k(()=>{"use strict";M();q();ue();F();rd=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},nd=(e,t,r,o)=>{let n=[];n.push(`fn perm(i: ${o.type.indices}) -> ${r.type.indices} {
...
`)},od=(e,t)=>{let r,o,n,s,i,a,u=t.format==="NHWC",l=t.blocksize,d=t.mode==="DCR";u?([r,o,n,s]=e.dims,i=d?[r,o,n,l,l,s/l**2]:[r,o,n,s/l**2,l,l],a=d?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,o,n,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],i=d?[r,l,l,s/l**2,o,n]:[r,s/l**2,l,l,o,n],a=d?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(i),p=c.dims.length,h=e.dataType,m=S("a",h,p),f=C("output",h,p),b=y=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:y=>{let g=u?[r,o*l,n*l,s/l**2]:[r,s/l**2,o*l,n*l],w=x.size(g),_=c.dims,$=x.sortBasedOnPerm(_,a);return{outputs:[{dims:g,dataType:y[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...E(_,$)]}},getShaderSource:b}},ms=(e,t)=>{rd(e.inputs),e.compute(od(e.inputs[0],t))},fs=e=>U({blocksize:e.blocksize,mode:e.mode,format:e.format})});var jr,er,gs,id,sd,Zr,Xr,ys,ad,bs,ws,_s=k(()=>{"use strict";M();q();ue();F();jr="[a-zA-Z]|\\.\\.\\.",er="("+jr+")+",gs="^"+er+"$",id="("+er+",)*"+er,sd="^"+id+"$",Zr=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let o=this.symbolToIndices.get(t);o===void 0?o=[r]:o.push(r),this.symbolToIndices.set(t,o)}},Xr=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[o,n]=r.includes("->")?r.split("->",2):[r,""];if(!o.match(RegExp(sd)))throw new Error("Invalid LHS term");if(o.split(",").forEach((a,u)=>{let l=t[u].dims.slice();if(!a.match(RegExp(gs)))throw new Error("Invalid LHS term");let d=this.processTerm(a,!0,l,u);this.lhs.push(d)}),n==="")n+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!n.match(RegExp(er)))throw new Error("Invalid RHS");n.match(RegExp(jr,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(n,!1,this.outputDims)}addSymbol(t,r,o){let n=this.symbolToInfo.get(t);if(n!==void 0){if(n.dimValue!==r&&n.count!==1)throw new Error("Dimension mismatch");n.count++,n.inputIndices.push(o)}else n={count:1,dimValue:r,inputIndices:[o]};this.symbolToInfo.set(t,n)}processTerm(t,r,o,n=-1){let s=o.length,i=!1,a=[],u=0;if(!t.match(RegExp(gs))&&!r&&t!=="")throw new Error("Invalid LHS term");let l=t.match(RegExp(jr,"g")),d=new Zr(n);return l?.forEach((c,p)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=s-l.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=o.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let f=String.fromCharCode("0".charCodeAt(0)+m);d.addSymbol(f,p+m),this.addSymbol(f,o[u++],n)}}else d.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,o[u++],n)}),d}},ys=e=>e+"_max",ad=(e,t,r,o)=>{let s=e.map(d=>d.length).map((d,c)=>S(`input${c}`,t,d)),i=x.size(o),a=C("output",t,o.length),u=[...r.symbolToInfo.keys()].filter(d=>!r.rhs.symbolToIndices.has(d)),l=d=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",f=[],b=[],y=[],g=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach(($,v)=>{if(r.rhs.symbolToIndices.has(v)){let I=r.rhs.symbolToIndices.get(v)?.[0];I!==void 0&&r.lhs.forEach((T,A)=>{if($.inputIndices.includes(A)){let B=T.symbolToIndices.get(v);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(O=>{c.push(`${s[A].indicesSet(`input${A}Indices`,O,a.indicesGet("outputIndices",I))}`)})}})}else r.lhs.forEach((I,T)=>{if($.inputIndices.includes(T)){let A=I.symbolToIndices.get(v);if(A===void 0)throw new Error("Invalid symbol error");A.forEach(B=>{f.push(`${s[T].indicesSet(`input${T}Indices`,B,`${v}`)}`)}),g.push(`prod *= ${s[T].getByIndices(`input${T}Indices`)};`)}}),b.push(`for(var ${v}: u32 = 0; ${v} < uniforms.${ys(v)}; ${v}++) {`),y.push("}")});let _=w?[...c,`let sum = ${s.map(($,v)=>$.getByIndices(`input${v}Indices`)).join(" * ")};`]:[...c,h,...b,...f,p,...g,m,...y];return`
            ${d.registerUniforms(u.map($=>({name:`${ys($)}`,type:"u32"}))).registerUniform("outputSize","u32").declareVariables(...s,a)}
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let d=u.filter(p=>r.symbolToInfo.has(p)).map(p=>({type:12,data:r.symbolToInfo.get(p)?.dimValue||0}));d.push({type:12,data:i});let c=e.map((p,h)=>[...E(p)]).reduce((p,h)=>p.concat(h),d);return c.push(...E(o)),{outputs:[{dims:o,dataType:t}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}},getShaderSource:l}},bs=(e,t)=>{let r=new Xr(e.inputs,t.equation),o=r.outputDims,n=e.inputs.map((s,i)=>s.dims);e.compute(ad(n,e.inputs[0].dataType,r,o))},ws=e=>{let t=e.equation.replace(/\s+/g,"");return U({equation:t})}});var ud,$s,ld,dd,vs,xs=k(()=>{"use strict";M();q();F();ud=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=r.length<t.length?0:r.length-t.length,n=t.length<r.length?0:t.length-r.length;for(;o<r.length&&n<t.length;++o,++n)if(r[o]!==t[n]&&r[o]!==1&&t[n]!==1)throw new Error("Expand requires shape to be broadcastable to input")},$s=(e,t)=>{let r=e.length-t.length,o=[];for(let n=0;n<r;++n)o.push(e[n]);for(let n=0;n<t.length;++n)o.push(t[n]===1?e[n+r]:t[n]);return o},ld=(e,t)=>e.length>t.length?$s(e,t):$s(t,e),dd=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),o=ld(t,r),n=e[0].dataType,s=n===9?4:1,i=Math.ceil(x.size(o)/s),a=l=>{let d=S("input",n,t.length,s),c=C("output",n,o.length,s),p;if(n===9){let h=(m,f,b="")=>`
    ...
    ${p}`},u=[{type:12,data:i},...E(t,o)];return{name:"Expand",shaderCache:{hint:`${o.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u})}},vs=e=>{ud(e.inputs),e.compute(dd(e.inputs),{inputs:[0]})}});var cd,Ss,Is=k(()=>{"use strict";M();q();F();Zt();cd=e=>{let t=e[0].dataType,r=x.size(e[0].dims),o=x.size(e[1].dims),n=o%4===0,s=i=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),l=C("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=h=>`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,f)=>f!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,f)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},ks=(e,t)=>{let r=e.inputs;fd(r,t),e.compute(hd(e.inputs,t))},Es=e=>U({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var gd,yd,zs,Bs,Ds=k(()=>{"use strict";M();q();ue();F();gd=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,r],outputs:[-1]})[0]},ht=(e,t,r,o,n,s,i,a)=>{let u=s;if(i&&x.size(i.dims)>0){if(o===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=xd(e,s,i,t,o,r*n,a),u=u.reshape([t,o,r,n]),r===1||o===1?u:e.compute(pe(u,Vs.perm),{inputs:[u],outputs:[-1]})[0]}else return s.dims.length===3&&(u=s.reshape([t,o,r,n])),r===1||o===1?u:e.compute(pe(u,Vs.perm),{inputs:[u],outputs:[-1]})[0]},Ns=(e,t)=>{let r=vd(e.inputs,t),o=e.inputs[0],n=we(e.inputs,1),s=we(e.inputs,2),i=we(e.inputs,3),a=we(e.inputs,4),u=we(e.inputs,5),l=we(e.inputs,6),d=we(e.inputs,7);if(o.dims.length===5)throw new Error("Packed QKV is not implemented");if(n?.dims.length===5)throw new Error("Packed KV is not implemented");let c=n&&s&&n.dims.length===4&&s.dims.length===4,p=ht(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,o,i,0);if(c)return Qe(e,p,n,s,a,void 0,l,d,u,r);if(!n||!s)throw new Error("key and value must be provided");let h=ht(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,n,i,r.hiddenSize),m=ht(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,i,2*r.hiddenSize);Qe(e,p,h,m,a,void 0,l,d,u,r)}});var Sd,Id,Td,Cd,Yr,Ls,Ws,Jr=k(()=>{"use strict";M();q();ue();F();Sd=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Id=(e,t)=>{let r=[],o=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(n=>r.push(Number(n))),o=r.length),U({numOutputs:o,axis:t.axis,splitSizes:r})},Td=e=>`
...
`)}
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${a};${p}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:b}),getShaderSource:y},{inputs:[t,r,o],outputs:[-1]})[0]},Ed=(e,t,r)=>{let o=t[0].dims,n=o,s=2,i=o[0],a=o[1],u=x.sizeFromDimension(o,s),l=re(u),d=x.size(n)/l,c=Fs(e,t[0],t[1],t[2],i,u,a,r.epsilon),p=[i,a,u/l],h=[i,a],m=["type","none"],f=b=>{let y=S("x",t[0].dataType,p.length,l),g=S("scale_shift",1,h.length,2),w=C("output",t[0].dataType,p.length,l),_=[y,g,w];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:n,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:b},{inputs:[t[0],f]})},Ks=(e,t)=>{t.format==="NHWC"?Pd(e,e.inputs,t):Ed(e,e.inputs,t)}});var zd,Bd,Zs,Xs=k(()=>{"use strict";M();q();F();zd=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Bd=(e,t,r)=>{let o=t.simplified,n=e[0].dims,s=e[1],i=!o&&e[2],a=n,u=x.normalizeAxis(t.axis,n.length),l=x.sizeToDimension(n,u),d=x.sizeFromDimension(n,u),c=x.size(s.dims),p=i?x.size(i.dims):0;if(c!==d||i&&p!==d)throw new Error(`Size of X.shape()[axis:] == ${d}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${c} and bias size of ${p}`);let h=[];for(let $=0;$<n.length;++$)$<u?h.push(n[$]):h.push(1);let m=re(d),f=["type","type"],b=[{type:12,data:l},{type:1,data:d},{type:12,data:Math.floor(d/m)},{type:1,data:t.epsilon}];i&&f.push("type");let y=r>1,g=r>2,w=$=>{let v=ee(e[0].dataType),I=[S("x",e[0].dataType,e[0].dims,m),S("scale",s.dataType,s.dims,m)];i&&I.push(S("bias",i.dataType,i.dims,m)),I.push(C("output",e[0].dataType,a,m)),y&&I.push(C("mean_data_output",1,h)),g&&I.push(C("inv_std_output",1,h));let T=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${h};${y};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:c}],dispatchGroup:{x:$},programUniforms:v}),getShaderSource:B}},Qs=(e,t)=>{Dd(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Rd(e.inputs,t)):e.compute(Od(e.inputs,t))},Ys=e=>U(e)});var Md,Vd,Ud,Nd,Ld,Wd,Gd,Hd,ea,ta=k(()=>{"use strict";M();q();F();Md=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Vd=(e,t,r)=>{let o="";for(let n=t-1;n>=0;--n)o+=`
      ...
      `},Ud=(e,t,r)=>{let o="";for(let n=t-1;n>=0;--n)o+=`
          ...
          `},Wd=(e,t,r)=>{switch(r.mode){case 0:return Vd(e,t,r.pads.length);case 1:return Ud(e,t,r.pads.length);case 2:return Nd(e,t,r.pads.length);case 3:return Ld(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Gd=(e,t)=>{let r=x.padShape(e[0].dims.slice(),t.pads),o=e[0].dims,n=x.size(r),s=[{type:12,data:n},{type:6,data:t.pads}],i=e.length>=3&&e[2].data;t.mode===0&&s.push({type:i?e[2].dataType:1,data:t.value}),s.push(...E(e[0].dims,r));let a=["rank"],u=l=>{let d=C("output",e[0].dataType,r.length),c=S("x",e[0].dataType,o.length),p=c.type.value,h=Wd(d,o.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:i?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},ia=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,qd=e=>`${ia(e)};${e.countIncludePad}`,Fd=e=>`${ia(e)};${e.storageOrder};${e.dilations}`,sa=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),aa=(e,t,r,o)=>{let[n,s]=ra(t,o,r),i=S("x",t.dataType,t.dims.length),a=i.type.value,u="value += x_val;",l="";n.countIncludePad?l+=`value /= ${a}(uniforms.kernelSize);`:l+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[d,c,p,h,m]=na(s,n);d.push(...E(t.dims,s));let f=["rank"];return{name:e,shaderCache:{hint:`${o.cacheKey};${p};${h};${m}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:d}),getShaderSource:b=>oa(b,i,t.dims.length,s.length,n,u,l,0,c,p,h,m)}},ua=e=>{let t=e.count_include_pad!==0,r=sa(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let o={countIncludePad:t,...r,cacheKey:""};return{...o,cacheKey:qd(o)}},la=(e,t)=>{tr(e.inputs),e.compute(aa("AveragePool",e.inputs[0],!1,t))},da={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ca=e=>{let t=e.format;return{format:t,...da,cacheKey:t}},pa=(e,t)=>{tr(e.inputs),e.compute(aa("GlobalAveragePool",e.inputs[0],!0,t))},ma=(e,t,r,o)=>{let[n,s]=ra(t,o,r),i=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),l=["rank"],[d,c,p,h,m]=na(s,n);return d.push(...E(t.dims,s)),{name:e,shaderCache:{hint:`${o.cacheKey};${p};${h};${m}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:d}),getShaderSource:f=>oa(f,u,t.dims.length,s.length,n,i,a,t.dataType===10?-65504:-1e5,c,p,h,m)}},fa=(e,t)=>{tr(e.inputs),e.compute(ma("MaxPool",e.inputs[0],!1,t))},ha=e=>{let t=e.storage_order,r=e.dilations,o=sa(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(o.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let n={storageOrder:t,dilations:r,...o,cacheKey:""};return{...n,cacheKey:Fd(n)}},ga=e=>{let t=e.format;return{format:t,...da,cacheKey:t}},ya=(e,t)=>{tr(e.inputs),e.compute(ma("GlobalMaxPool",e.inputs[0],!0,t))}});var jd,Zd,wa,_a,$a=k(()=>{"use strict";M();q();ue();F();jd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,o)=>r===e[2].dims[o]).reduce((r,o)=>r&&o,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((n,s)=>s===t.axis||n===e[0].dims[s]).reduce((n,s)=>n&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],o=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/o)||t.blockSize>Math.ceil(r/(o-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Zd=(e,t)=>{let r=x.normalizeAxis(t.axis,e[0].dims.length),o=e[0].dataType,n=o===3,s=e[0].dims,i=e[1].dataType,a=x.size(s),u=o===3||o===2,l=u?[Math.ceil(x.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil(x.size(c.dims)/4)]:c.dims:void 0,h=d.length===0||d.length===1&&d[0]===1,m=h===!1&&d.length===1,f=re(a),b=h&&(!u||f===4),y=b?f:1,g=b&&!u?f:1,w=S("input",u?12:o,l.length,g),_=S("scale",i,d.length),$=c?S("zero_point",u?12:o,p.length):void 0,v=C("output",i,s.length,y),I=[w,_];$&&I.push($);let T=[l,d];c&&T.push(p);let A=[{type:12,data:a/y},{type:12,data:r},{type:12,data:t.blockSize},...E(...T,s)],B=O=>{let W=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/y/64),y:1,z:1},programUniforms:A})}},wa=(e,t)=>{jd(e.inputs,t),e.compute(Zd(e.inputs,t))},_a=e=>U({axis:e.axis,blockSize:e.blockSize})});var Xd,Qd,va,xa=k(()=>{"use strict";Se();M();F();Xd=(e,t,r)=>{let o=e===t,n=e<t&&r<0,s=e>t&&r>0;if(o||n||s)throw new Error("Range these inputs' contents are invalid.")},Qd=(e,t,r,o)=>{let n=Math.abs(Math.ceil((t-e)/r)),s=[n],i=n,a=[{type:12,data:i},{type:o,data:e},{type:o,data:r},...E(s)],u=l=>{let d=C("output",o,s.length),c=d.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${l.registerUniforms(p).declareVariables(d)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${o}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:a})}},va=e=>{let t=0,r=0,o=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],o=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],o=e.inputs[2].getFloat32Array()[0]),J.webgpu.validateInputContent&&Xd(t,r,o),e.compute(Qd(t,r,o,e.inputs[0].dataType),{inputs:[]})}});var Yd,Jd,ec,tc,rc,nc,oc,ic,sc,ac,uc,Sa,lc,dc,cc,pc,mc,Ia,Ta,Ca=k(()=>{"use strict";M();q();ue();F();Yd=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:U({interleaved:r}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(x.size(p)/Fe)},programUniforms:m})}},Aa=(e,t)=>{fc(e.inputs,t),e.compute(hc(e.inputs,t))}});var gc,yc,Ea,Pa=k(()=>{"use strict";M();q();F();gc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],o=e[2];if(t.dataType!==r.dataType||t.dataType!==o.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let n=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==n)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(o.dims.length!==1)throw new Error("Gamma must be 1D");if(o.dims[o.dims.length-1]!==n)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let i=e[3];if(i.dims.length!==1)throw new Error("Beta must be 1D");if(i.dims[i.dims.length-1]!==n)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let i=e[4];if(i.dims.length!==1)throw new Error("Bias must be 1D");if(i.dims[i.dims.length-1]!==n)throw new Error("Bias must have the same hidden size as input")}},yc=(e,t,r,o)=>{let n=t.simplified,s=e[0].dims,i=x.size(s),a=s,u=i,l=s.slice(-1)[0],d=o?s.slice(0,-1).concat(1):[],c=!n&&e.length>3,p=e.length>4,h=o&&r>1,m=o&&r>2,f=r>3,b=64,y=re(l),g=[{type:12,data:u},{type:12,data:y},{type:12,data:l},{type:1,data:t.epsilon}],w=$=>{let v=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],I=[S("x",e[0].dataType,e[0].dims,y),S("skip",e[1].dataType,e[1].dims,y),S("gamma",e[2].dataType,e[2].dims,y)];c&&I.push(S("beta",e[3].dataType,e[3].dims,y)),p&&I.push(S("bias",e[4].dataType,e[4].dims,y)),I.push(C("output",e[0].dataType,a,y)),h&&I.push(C("mean_output",1,d)),m&&I.push(C("inv_std_output",1,d)),f&&I.push(C("input_skip_bias_sum",e[0].dataType,a,y));let T=ee(e[0].dataType),A=ee(1,y);return`
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${i.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:b,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:f})}},Ba=(e,t)=>{bc(e.inputs,t);let r=wc(e.inputs,t);e.compute($c(e.inputs,r),{inputs:[0]})},Da=e=>{let t=e.starts,r=e.ends,o=e.axes;return U({starts:t,ends:r,axes:o})}});var vc,xc,Ra,Ma,Va=k(()=>{"use strict";M();q();ue();Oe();F();vc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},xc=(e,t)=>{let r=e.inputs[0],o=r.dims,n=x.size(o),s=o.length,i=x.normalizeAxis(t.axis,s),a=i<o.length-1,u,l=[];a?(l=Array.from({length:s},(I,T)=>T),l[i]=s-1,l[s-1]=i,u=e.compute(pe(r,l),{inputs:[r],outputs:[-1]})[0]):u=r;let d=u.dims,c=d[s-1],p=n/c,h=re(c),m=c/h,f=64;p===1&&(f=256);let b=(I,T)=>T===4?`max(max(${I}.x, ${I}.y), max(${I}.z, ${I}.w))`:T===2?`max(${I}.x, ${I}.y)`:T===3?`max(max(${I}.x, ${I}.y), ${I}.z)`:I,y=S("x",u.dataType,u.dims,h),g=C("result",u.dataType,u.dims,h),w=y.type.value,_=ee(u.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=I=>`
