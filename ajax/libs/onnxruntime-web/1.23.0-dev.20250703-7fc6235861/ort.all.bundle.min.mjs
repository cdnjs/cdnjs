...
`)}
  ...
  ${O.mainStart()}
    ...
    ${x?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${e.blockSize};${h};${g};${v};${T}`,inputDependencies:Array(r.length).fill("rank")},getRunData:()=>({outputs:[{dims:b,dataType:f}],dispatchGroup:{x:O},programUniforms:E}),getShaderSource:q}},H0=(r,e)=>{e3(r.inputs,e),e.blockSize===32&&r.adapterInfo.isVendor("intel")&&r.adapterInfo.isArchitecture("gen-12lp")?r.compute(n3(r.inputs,e)):r.compute(t3(r.inputs,e))},j0=r=>ce(r)});var r3,o3,i3,a3,s3,u3,l3,c3,K0,X0=k(()=>{"use strict";le();ge();ye();r3=r=>{if(!r||r.length<1)throw new Error("Too few inputs");if(r[0].dataType!==1&&r[0].dataType!==10)throw new Error("Input type must be float or float16.");if(r.length>=2){let e=r[0].dims.length*2===r[1].dims[0];if(r.length===4&&(e=r[3].dims[0]*2===r[1].dims[0]),!e)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},o3=(r,e,n)=>{let t="";for(let o=e-1;o>=0;--o)t+=`
      ...
      `},i3=(r,e,n)=>{let t="";for(let o=e-1;o>=0;--o)t+=`
                k = i32(${r.indicesGet("indices",o)}) - ${Q("uniforms.pads",o,n)};
                if (k < 0) {
                  k = -k;
                }
            ...
            `;return`
              ...
              ${t}
              value = x[offset];
          `},a3=(r,e,n)=>{let t="";for(let o=e-1;o>=0;--o)t+=`
                k = i32(${r.indicesGet("indices",o)}) - ${Q("uniforms.pads",o,n)};
                if (k < 0) {
                  k = 0;
                }
            ...
            `;return`
              ...
              ${t}
              value = x[offset];
          `},s3=(r,e,n)=>{let t="";for(let o=e-1;o>=0;--o)t+=`
                k = i32(${r.indicesGet("indices",o)}) - ${Q("uniforms.pads",o,n)};
                if (k < 0)  {
            ...
            `;return`
              ...
              ${t}
              value = x[offset];
          `},u3=(r,e,n)=>{switch(n.mode){case 0:return o3(r,e,n.pads.length);case 1:return i3(r,e,n.pads.length);case 2:return a3(r,e,n.pads.length);case 3:return s3(r,e,n.pads.length);default:throw new Error("Invalid mode")}},l3=(r,e)=>{let n=C.padShape(r[0].dims.slice(),e.pads),t=r[0].dims,o=C.size(n),i=[{type:12,data:o},{type:6,data:e.pads}],a=r.length>=3&&r[2].data;e.mode===0&&i.push({type:a?r[2].dataType:1,data:e.value}),i.push(...W(r[0].dims,n));let s=["rank"],u=l=>{let d=G("output",r[0].dataType,n.length),f=N("x",r[0].dataType,t.length),h=f.type.value,g=u3(d,t.length,e),b=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:e.pads.length}];return e.mode===0&&b.push({name:"constant_value",type:a?h:"f32"}),`
    ...
    `,s="",u=N("x",e.dataType,e.dims.length),l=["rank"],[d,f,h,g,b]=J0(i,o);return d.push(...W(e.dims,i)),{name:r,shaderCache:{hint:`${t.cacheKey};${h};${g};${b}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(C.size(i)/64)},programUniforms:d}),getShaderSource:_=>Y0(_,u,e.dims.length,i.length,o,a,s,e.dataType===10?-65504:-1e5,f,h,g,b)}},uw=(r,e)=>{Za(r.inputs),r.compute(sw("MaxPool",r.inputs[0],!1,e))},lw=r=>{let e=r.storage_order,n=r.dilations,t=ew(r);if(e!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(t.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:e,dilations:n,...t,cacheKey:""};return{...o,cacheKey:p3(o)}},cw=r=>{let e=r.format;return{format:e,...ow,cacheKey:e}},dw=(r,e)=>{Za(r.inputs),r.compute(sw("GlobalMaxPool",r.inputs[0],!0,e))}});var h3,m3,fw,hw,mw=k(()=>{"use strict";le();ge();Xe();ye();h3=(r,e)=>{if(r.length<2||r.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(r.length===3&&r[1].dims===r[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(r.length===3&&r[0].dataType!==r[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(r[0].dataType===6&&r.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(r[1].dims.length!==0&&r[1].dims.length!==1&&r[1].dims.length!==r[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(r.length>2){if(r[0].dataType!==r[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(r[1].dims.length!==r[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!r[1].dims.map((n,t)=>n===r[2].dims[t]).reduce((n,t)=>n&&t,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(e.blockSize>0){if(r[1].dims.length===0||r[1].dims.length===1&&r[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!r[1].dims.map((o,i)=>i===e.axis||o===r[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(r[1].dims.length!==r[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=r[0].dims[e.axis],t=r[1].dims[e.axis];if(e.blockSize<Math.ceil(n/t)||e.blockSize>Math.ceil(n/(t-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},m3=(r,e)=>{let n=C.normalizeAxis(e.axis,r[0].dims.length),t=r[0].dataType,o=t===3,i=r[0].dims,a=r[1].dataType,s=C.size(i),u=t===3||t===2,l=u?[Math.ceil(C.size(r[0].dims)/4)]:r[0].dims,d=r[1].dims,f=r.length>2?r[2]:void 0,h=f?u?[Math.ceil(C.size(f.dims)/4)]:f.dims:void 0,g=d.length===0||d.length===1&&d[0]===1,b=g===!1&&d.length===1,_=Ee(s),T=g&&(!u||_===4),v=T?_:1,x=T&&!u?_:1,I=N("input",u?12:t,l.length,x),$=N("scale",a,d.length),O=f?N("zero_point",u?12:t,h.length):void 0,E=G("output",a,i.length,v),L=[I,$];O&&L.push(O);let R=[l,d];f&&R.push(h);let F=[{type:12,data:s/v},{type:12,data:n},{type:12,data:e.blockSize},...W(...R,i)],q=Z=>{let re=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:e.cacheKey,inputDependencies:O?["rank","rank","rank"]:["rank","rank"]},getShaderSource:q,getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(s/v/64),y:1,z:1},programUniforms:F})}},fw=(r,e)=>{h3(r.inputs,e),r.compute(m3(r.inputs,e))},hw=r=>ce({axis:r.axis,blockSize:r.blockSize})});var g3,b3,gw,bw=k(()=>{"use strict";pt();le();ye();g3=(r,e,n)=>{let t=r===e,o=r<e&&n<0,i=r>e&&n>0;if(t||o||i)throw new Error("Range these inputs' contents are invalid.")},b3=(r,e,n,t)=>{let o=Math.abs(Math.ceil((e-r)/n)),i=[o],a=o,s=[{type:12,data:a},{type:t,data:r},{type:t,data:n},...W(i)],u=l=>{let d=G("output",t,i.length),f=d.type.value,h=[{name:"outputSize",type:"u32"},{name:"start",type:f},{name:"delta",type:f}];return`
        ${l.registerUniforms(h).declareVariables(d)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${f}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${t}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:t}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:s})}},gw=r=>{let e=0,n=0,t=0;r.inputs[0].dataType===6?(e=r.inputs[0].getInt32Array()[0],n=r.inputs[1].getInt32Array()[0],t=r.inputs[2].getInt32Array()[0]):r.inputs[0].dataType===1&&(e=r.inputs[0].getFloat32Array()[0],n=r.inputs[1].getFloat32Array()[0],t=r.inputs[2].getFloat32Array()[0]),me.webgpu.validateInputContent&&g3(e,n,t),r.compute(b3(e,n,t,r.inputs[0].dataType),{inputs:[]})}});var y3,_3,yw,_w,vw=k(()=>{"use strict";le();ge();Xe();ye();y3=(r,e,n,t)=>{if(r!=="none"&&t!=="i32"&&t!=="u32"&&t!=="f32")throw new Error(`Input ${t} is not supported with reduction ${r}.`);let o=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,i=`;
  ...
  return whole + fract;
`,T3=(r,e)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${e} { `+(()=>{switch(r){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${e}(xResized) + 0.5) / ${e}(xScale)) - 0.5;`;case"half_pixel":return`return ((${e}(xResized) + 0.5) / ${e}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${r} is not supported`)}})()+"}",I3=(r,e,n)=>`fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {`+(()=>{switch(r){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";case"simple":default:if(e<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${r} is not supported`)}})()+"}",S3=(r,e,n)=>{let t=new Array(n).fill(0).concat(new Array(n).fill(1)),o=r.length===0?t:r.slice();return e.length>0?(e.forEach((i,a)=>{t[i]=o[a],t[a+n]=o[e.length+a]}),t):o},$3=(r,e,n,t)=>{let o=[];if(n.length>0)if(t.length>0){if(r.forEach(i=>o.push(i)),Math.max(...t)>r.length)throw new Error("axes is out of bound");t.forEach((i,a)=>o[i]=n[a])}else n.forEach(i=>o.push(i));else{if(e.length===0)throw new Error("Resize requires either scales or sizes.");o=r.map((i,a)=>Math.round(i*e[a]))}return o},A3=(r,e,n)=>{let t=(()=>{switch(n.keepAspectRatioPolicy){case"not_larger":return n.axes.length>0?Math.min(...n.axes.map(i=>e[i]),Number.MAX_VALUE):Math.min(...e,Number.MAX_VALUE);case"not_smaller":return n.axes.length>0?Math.max(...n.axes.map(i=>e[i]),Number.MIN_VALUE):Math.max(...e,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${n.keepAspectRatioPolicy} is not supported`)}})();e.fill(1,0,e.length);let o=r.slice();return n.axes.length>0?(n.axes.forEach(i=>e[i]=t),n.axes.forEach(i=>o[i]=Math.round(r[i]*e[i]))):(e.fill(t,0,e.length),o.forEach((i,a)=>o[a]=Math.round(i*e[a]))),o},O3=(r,e,n,t,o)=>`
...
`:"",C3=(r,e,n,t,o)=>{let[a,s,u,l]=n.length===2?[-1,0,1,-1]:[0,2,3,1],d=r.type.value;return`
    ...
    }`},D3=(r,e,n,t,o,i,a,s,u,l)=>{let d=n.length===2,f=!0,[h,g]=d?[0,1]:f?[2,3]:[1,2],b=r.type.value,_=T=>{let v=T===h?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    `},k3=(r,e,n,t,o)=>{let[a,s,u,l,d]=n.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],f=r.type.value;return`
    ...
    }`},N3=(r,e,n,t,o,i)=>{let a=r.dims,s=S3(i,e.axes,a.length),u=$3(a,t,o,e.axes),l=t.slice();t.length===0&&(l=a.map((x,I)=>x===0?1:u[I]/x),e.keepAspectRatioPolicy!=="stretch"&&(u=A3(a,l,e)));let d=G("output",r.dataType,u.length),f=N("input",r.dataType,a.length),h=C.size(u),g=a.length===u.length&&a.every((x,I)=>x===u[I]),b=e.coordinateTransformMode==="tf_crop_and_resize",_=e.extrapolationValue,T=f.type.value,v=x=>`
      ${g?"":`
      ${T3(e.coordinateTransformMode,T)};
      ${(()=>{switch(e.mode){case"nearest":return`
              ${E3(f,a)};
              ${I3(e.nearestMode,n,T)};
              ${P3(f,d,a,u,l.length,s.length,b)};
              `;case"linear":return`
              ${O3(d,a,u,l.length,s.length)};
              ${(()=>{if(a.length===2||a.length===4)return`${C3(f,d,a,b,_)}`;if(a.length===3||a.length===5)return`${k3(f,d,a,b,_)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(a.length===2||a.length===4)return`${D3(f,d,a,u,l,s,e.cubicCoeffA,b,e.extrapolationValue,e.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${a.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:T,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(t/64)},programUniforms:_})}},Pw=(r,e)=>{M3(r.inputs,e);let n=B3(r.inputs,e);r.compute(V3(r.inputs,n),{inputs:[0]})},Ew=r=>{let e=r.starts,n=r.ends,t=r.axes;return ce({starts:e,ends:n,axes:t})}});var G3,U3,Dw,kw,Nw=k(()=>{"use strict";le();ge();Xe();Yn();ye();G3=r=>{if(!r||r.length!==1)throw new Error("Softmax op requires 1 input.")},U3=(r,e)=>{let n=r.inputs[0],t=n.dims,o=C.size(t),i=t.length,a=C.normalizeAxis(e.axis,i),s=a<t.length-1,u,l=[];s?(l=Array.from({length:i},(L,R)=>R),l[a]=i-1,l[i-1]=a,u=r.compute(at(n,l),{inputs:[n],outputs:[-1]})[0]):u=n;let d=u.dims,f=d[i-1],h=o/f,g=Ee(f),b=f/g,_=64;h===1&&(_=256);let T=(L,R)=>R===4?`max(max(${L}.x, ${L}.y), max(${L}.z, ${L}.w))`:R===2?`max(${L}.x, ${L}.y)`:R===3?`max(max(${L}.x, ${L}.y), ${L}.z)`:L,v=N("x",u.dataType,u.dims,g),x=G("result",u.dataType,u.dims,g),I=v.type.value,$=Ve(u.dataType)==="f32"?`var threadMax = ${I}(-3.402823e+38f);`:`var threadMax = ${I}(-65504.0h);`,O=L=>`
