...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},uo=(e,t)=>new Pr(e,t),Xe=(e,t)=>{let r=e.length,n=[];for(let o=0;o<r;o++){let s=r-1-o,i=e[s]||1;(t[t.length-1-o]||1)>1&&i===1&&n.unshift(s)}return n}});var Mu,lo,Vu,Uu,Nu,pe,co,po,De=A(()=>{"use strict";M();q();ue();F();Mu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},lo=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Vu=(e,t)=>x.sortBasedOnPerm(e,lo(e.length,t)),Uu=(e,t,r,n)=>{let o=`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)o+=r.indicesSet("a",e[s],`i[${s}]`);return o+="return a;}"},Nu=(e,t)=>{let r=[],n=[];for(let o=0;o<e.length;++o)e[o]!==1&&r.push(e[o]),e[t[o]]!==1&&n.push(t[o]);return{newShape:r,newPerm:n}},pe=(e,t)=>{let r=e.dataType,n=e.dims.length,o=lo(n,t),s=Vu(e.dims,o),{newShape:i,newPerm:a}=Nu(e.dims,o),u=x.areEqual(a,[2,3,1]),d=x.areEqual(a,[3,1,2]),l=i.length===2&&a[0]>a[1]||u||d,c=l?i:e.dims,p=s;l&&(c=u?[i[0],i[1]*i[2]]:d?[i[0]*i[1],i[2]]:i,p=[c[1],c[0]]);let h=S("a",r,c.length),m=C("output",r,p.length),f=16,y;return l?y=b=>`
  ...
  ${b.mainStart()}
    ...
    ${m.setByOffset("global_idx",h.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:t,getShaderSource:f=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:s,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:d}]})}},Ee=(e,t,r,n)=>{let o=e.inputs.length===1?r:Dr(e.inputs,r),s=o.axes;s.length===0&&!o.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((h,m)=>m));let i=x.normalizeAxes(s,e.inputs[0].dims.length),a=i,u=e.inputs[0],d=Zu(a,e.inputs[0].dims.length);d.length>0&&(u=e.compute(pe(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],a=qu(a.length,u.dims.length));let[l,c]=Fu(u.dims,a),p=l;o.keepDims&&(p=Ku(l,i)),e.compute(Xu(t,{hint:o.cacheKey,inputDependencies:["type"]},[u],n,e.inputs[0].dataType,p,c),{inputs:[u]})},mo=(e,t)=>{Ee(e,"ReduceMeanShared",t,"mean")},fo=(e,t)=>{Ee(e,"ReduceL1Shared",t,"l1")},ho=(e,t)=>{Ee(e,"ReduceL2Shared",t,"l2")},go=(e,t)=>{Ee(e,"ReduceLogSumExpShared",t,"logSumExp")},yo=(e,t)=>{Ee(e,"ReduceMaxShared",t,"max")},bo=(e,t)=>{Ee(e,"ReduceMinShared",t,"min")},wo=(e,t)=>{Ee(e,"ReduceProdShared",t,"prod")},_o=(e,t)=>{Ee(e,"ReduceSumShared",t,"sum")},$o=(e,t)=>{Ee(e,"ReduceSumSquareShared",t,"sumSquare")},vo=(e,t)=>{Ee(e,"ReduceLogSumShared",t,"logSum")}});var Pe,Qu,qt,Dr,ze,Yu,Ju,ed,td,rd,nd,od,id,sd,ad,Be,So,To,Io,Co,Ao,ko,Eo,Po,zo,Bo,Ht=A(()=>{"use strict";M();q();ue();F();xo();Pe=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Qu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],qt=(e,t,r,n,o,s,i=!1,a=!1)=>{let u=[],d=r[0].dims,l=d.length,c=x.normalizeAxes(o,l),p=!a&&c.length===0;d.forEach((y,b)=>{p||c.indexOf(b)>=0?i&&u.push(1):u.push(y)});let h=u.length,m=x.size(u);return{name:e,shaderCache:t,getShaderSource:y=>{let b=[],g=S("_A",r[0].dataType,l),w=C("output",s,h),_=n(g,w,c),$=_[2];for(let v=0,T=0;v<l;v++)p||c.indexOf(v)>=0?(i&&T++,$=`for(var j${v}: u32 = 0; j${v} < ${d[v]}; j${v}++) {
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${i}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d?[{type:12,data:u},...k(s)]:[{type:12,data:u}]})}},hd=e=>U(e),Uo=(e,t)=>{let{inputs:r,outputCount:n}=e,o=hd({...t,outputCount:n});if(J.webgpu.validateInputContent&&md(r,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(fd(r,o))}});var gd,yd,Wo,Lo=A(()=>{"use strict";q();F();gd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},yd=e=>{let t=e[0].dims,r=e[0].dims[2],n=x.size(t)/4,o=e[0].dataType,s=S("input",o,t,4),i=S("bias",o,[r],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:l=>`
  ...
  }`},te=(e,t,r,n,o,s=e.dataType,i,a)=>{let u=[{type:12,data:Math.ceil(x.size(e.dims)/4)}];return i&&u.push(...i),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:d=>bd(d,x.size(e.dims),e.dataType,s,r,n,a),getRunData:d=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(x.size(d[0].dims)/64/4)},programUniforms:u})}},Go=e=>{e.compute(te(e.inputs[0],"Abs","abs"))},Ho=e=>{e.compute(te(e.inputs[0],"Acos","acos"))},qo=e=>{e.compute(te(e.inputs[0],"Acosh","acosh"))},Fo=e=>{e.compute(te(e.inputs[0],"Asin","asin"))},Ko=e=>{e.compute(te(e.inputs[0],"Asinh","asinh"))},jo=e=>{e.compute(te(e.inputs[0],"Atan","atan"))},Zo=e=>{e.compute(te(e.inputs[0],"Atanh","atanh"))},Xo=e=>U(e),Qo=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(te(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},wd=e=>{let t,r,n=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=n?e[1].getFloat32Array()[0]:-34028234663852886e22,r=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=n?e[1].getUint16Array()[0]:64511,r=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return U({min:t,max:r})},Yo=(e,t)=>{let r=t||wd(e.inputs),n=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:n},{name:"max",type:n}]),{inputs:[0]})},Jo=e=>{e.compute(te(e.inputs[0],"Ceil","ceil"))},ei=e=>{e.compute(te(e.inputs[0],"Cos","cos"))},ti=e=>{e.compute(te(e.inputs[0],"Cosh","cosh"))},dt=e=>U(e),ri=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,ni=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Kt(t)))},oi=e=>{e.compute(te(e.inputs[0],"Exp","exp"))},ii=e=>{e.compute(te(e.inputs[0],"Floor","floor"))},si=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Kt(t)))},ai=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},ui=e=>{e.compute(te(e.inputs[0],"Not",t=>`!${t}`))},di=e=>{e.compute(te(e.inputs[0],"Neg",t=>`-${t}`))},li=e=>{e.compute(te(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},ci=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},pi=e=>{e.compute(te(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},mi=e=>U(e),fi=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},hi=e=>{e.compute(te(e.inputs[0],"Sin","sin"))},gi=e=>{e.compute(te(e.inputs[0],"Sinh","sinh"))},yi=e=>{e.compute(te(e.inputs[0],"Sqrt","sqrt"))},bi=e=>{e.compute(te(e.inputs[0],"Tan","tan"))},wi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,_i=e=>{e.compute(te(e.inputs[0],"Tanh",wi))},Vr=(e="f32")=>`
...
`,Ur=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,$i=e=>{let t=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"FastGelu",Ur,Vr(t),void 0,e.inputs[0].dataType))},vi=(e,t)=>{let r=ce(e.inputs[0].dataType);return e.compute(te(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},xi=e=>{e.compute(te(e.inputs[0],"Log","log"))},_d=(e,t)=>`
...
`,$d=e=>`quick_gelu_impl(${e})`,Si=(e,t)=>{let r=ce(e.inputs[0].dataType);e.compute(te(e.inputs[0],"QuickGelu",$d,_d(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var vd,xd,Ii,Ci=A(()=>{"use strict";q();F();jt();vd=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},xd=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=S("input",e[0].dataType,e[0].dims,4),n=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),s=x.size(t)/4,i=ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${b}
      }`},Td=(e,t,r,n,o,s,i=r.dataType)=>{let a=r.dims.map(f=>Number(f)??1),u=n.dims.map(f=>Number(f)??1),d=!x.areEqual(a,u),l=a,c=x.size(a),p=!1,h=!1,m=[d];if(d){let f=ke.calcShape(a,u,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");l=f.slice(),c=x.size(l);let y=x.size(a)===1,b=x.size(u)===1,g=a.length>0&&a[a.length-1]%4===0,w=u.length>0&&u[u.length-1]%4===0;m.push(y),m.push(b),m.push(g),m.push(w);let _=1;for(let $=1;$<l.length;$++){let v=a[a.length-$],T=u[u.length-$];if(v===T)_*=v;else break}_%4===0?(h=!0,p=!0):(y||b||g||w)&&(p=!0)}else p=!0;return m.push(p),{name:e,shaderCache:{hint:t+m.map(f=>f.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:f=>Sd(f,a,u,l,p,d,h,o,r.dataType,n.dataType,i,s),getRunData:()=>({outputs:[{dims:l,dataType:i}],dispatchGroup:{x:Math.ceil(c/64/4)},programUniforms:[{type:12,data:Math.ceil(x.size(l)/4)},...k(a,u,l)]})}},Oe=(e,t,r,n,o,s)=>{e.compute(Td(t,o??"",e.inputs[0],e.inputs[1],r,n,s))},Ai=e=>{Oe(e,"Add",(t,r)=>`${t}+${r}`)},ki=e=>{Oe(e,"Div",(t,r)=>`${t}/${r}`)},Ei=e=>{Oe(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Pi=e=>{Oe(e,"Mul",(t,r)=>`${t}*${r}`)},zi=e=>{let t=S("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Oe(e,"Pow",{scalar:(n,o)=>`pow_custom(${n},${o})`,vector:(n,o)=>`pow_vector_custom(${n},${o})`},`
...
`)},Ed=(e,t,r,n)=>{let o=x.size(r),s=new Array(e.length),i=new Array(e.length),a=0,u=[],d=[],l=[{type:12,data:o}];for(let f=0;f<e.length;++f)a+=e[f].dims[t],s[f]=a,d.push(e[f].dims.length),i[f]=S(`input${f}`,n,d[f]),u.push("rank"),l.push({type:12,data:s[f]});for(let f=0;f<e.length;++f)l.push(...k(e[f].dims));l.push(...k(r));let c=C("output",n,r.length),p=c.indicesGet("indices",t),h=Array.from(Array(s.length).keys()).map(f=>`uniforms.sizeInConcatAxis${f}`).join(","),m=f=>`
  ...
  ${f.mainStart()}
    ...
    ${kd(i,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:l}),getShaderSource:m}},Ui=(e,t)=>{let r=e.inputs,n=r[0].dims,o=x.normalizeAxis(t.axis,n.length);Cd(r,o);let s=n.slice();s[o]=r.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let i=r.filter(a=>x.size(a.dims)>0);e.compute(Ed(i,o,s,r[0].dataType),{inputs:i})},Ni=e=>U({axis:e.axis})});var $e,ve,xe,Zt,Re=A(()=>{"use strict";M();q();$e=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},ve=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},xe=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Zt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,n]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:n}}else if(t==="Clip"){let[r,n]=e?.activation_params||[so,ao];return{activation:t,clipMax:n,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}});var fe,Xt,lt=A(()=>{"use strict";fe=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Xt=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var Qt,Nr=A(()=>{"use strict";Qt=e=>`
...
`});var Pd,zd,ct,Li,Bd,pt,Od,Yt,mt=A(()=>{"use strict";M();q();F();Re();lt();Pd=(e,t)=>e?`
        ...
        }`,ct=(e,t,r="f32",n,o=!1,s=32,i=!1,a=32)=>{let u=t[1]*e[1],d=t[0]*e[0],l=o?u:s,c=o?s:u,p=l/t[0],h=s/t[1];if(!((o&&p===4&&e[1]===4||!o&&(p===3||p===4))&&l%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${o} is true, innerElementSize ${p} and workPerThread[1] ${e[1]} must be 4.
...
`},Od=(e,t,r,n,o,s=!1)=>{let[i,a,u]=o,[d,l,c,p]=n,h=Xe(i,u),m=Xe(a,u),f=ee(n[0].type.tensor),y=()=>{let w=l.rank,_=d.rank,$=`var aIndices: ${l.type.indices};`;for(let v=w-2-1,T=_-1;v>=0;v--,T--)$+=`
...
bIndices[${w-2}] = u32(row);
    ...
    `},Yt=(e,t,r,n,o=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i.slice(0,-2),d=a.slice(0,-2),l=n?n.slice(0,-2):r.slice(0,-2),c=x.size(l),p=i[i.length-2],h=i[i.length-1],m=a[a.length-1],f=h%4===0&&m%4===0,y=p<=8?[4,1,1]:[4,4,1],b=[8,8,1],g=[Math.ceil(m/b[0]/y[0]),Math.ceil(p/b[1]/y[1]),Math.ceil(c/b[2]/y[2])],w=f?4:1,_=[...u,p,h/w],$=_.length,v=[...d,h,m/w],T=v.length,I=[c,p,m/w],P=[{type:6,data:p},{type:6,data:m},{type:6,data:h}];ve(t,P),P.push(...k(l,_,v));let B=["rank","rank"],D=e.length>2;D&&(P.push(...k(e[2].dims)),B.push("rank")),P.push(...k(I));let L=z=>{let N=l.length,se=Gt("batchDims",e[0].dataType,N,1),W=ee(e[0].dataType),Z=S("a",e[0].dataType,$,w),K=S("b",e[1].dataType,T,w),V=C("result",e[0].dataType,I.length,w),ne=[Z,K];if(D){let R=o?w:1;ne.push(S("bias",e[2].dataType,e[2].dims.length,R))}let oe=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];xe(t,oe);let Q=ee(V.type.tensor),H=$e(t,V.type.value,Q),E=Od(w,D,H,[se,Z,K,V],[u,d,l],o);return`
  ${z.registerUniforms(oe).registerInternalVariables(se).declareVariables(...ne,V)}
  ${E}
  ${f?ct(y,b,W,se):pt(y,b,W,se)}
                   `};return{name:"MatMul",shaderCache:{hint:`${y};${t.activation};${f};${o}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:P}),getShaderSource:L}}});var Dd,Gi,Hi=A(()=>{"use strict";M();Ce();F();Re();lt();Nr();mt();Dd=(e,t,r,n,o=!1,s,i=4,a=4,u=4,d="f32")=>{let l=B=>{switch(B){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${d}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},c=B=>{switch(B){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},p=e?`
    ...
    return ${fe(i,d)}(0.0);`,_=`${c(a)}`,$=fe(u,d),v=e?fe(i,d):fe(a,d),T=e?fe(a,d):fe(i,d),I=$e(s,$,d);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${f?`vec4<${V}>`:V}) {
        ...
        ${f?ct(w,g,V,void 0,!d,I):pt(w,g,V,void 0,!d,I,!1,void 0,a)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${$};${f};${P};${B};${D};${v};${T};${I}`,inputDependencies:N},getRunData:()=>({outputs:[{dims:u?u(r):r,dataType:e[0].dataType}],dispatchGroup:{x:_[0],y:_[1],z:_[2]},programUniforms:z}),getShaderSource:se}}});var Rd,qi,Jt,Md,Fi,Vd,Ki,ji,Zi=A(()=>{"use strict";M();Ce();q();F();Re();lt();Rd=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},qi=e=>typeof e=="number"?[e,e,e]:e,Jt=(e,t)=>t<=1?e:e+(e-1)*(t-1),Md=(e,t,r,n=1)=>{let o=Jt(t,n);return Math.floor((e[0]*(r-1)-r+o)/2)},Fi=(e,t,r,n,o)=>{o==null&&(o=Md(e,t[0],n[0]));let s=[0,0,0,r];for(let i=0;i<3;i++)e[i]+2*o>=t[i]&&(s[i]=Math.trunc((e[i]-t[i]+2*o)/n[i]+1));return s},Vd=(e,t,r,n,o,s,i,a,u,d)=>{let l,c,p,h;if(e==="VALID"&&(e=0),typeof e=="number"){l={top:e,bottom:e,left:e,right:e,front:e,back:e};let m=Fi([t,r,n,1],[a,u,d],1,[o,s,i],e);c=m[0],p=m[1],h=m[2]}else if(Array.isArray(e)){if(!e.every((f,y,b)=>f===b[0]))throw Error(`Unsupported padding parameter: ${e}`);l={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let m=Fi([t,r,n,1],[a,u,d],1,[o,s,i],e[0]);c=m[0],p=m[1],h=m[2]}else if(e==="SAME_UPPER"){c=Math.ceil(t/o),p=Math.ceil(r/s),h=Math.ceil(n/i);let m=(c-1)*o+a-t,f=(p-1)*s+u-r,y=(h-1)*i+d-n,b=Math.floor(m/2),g=m-b,w=Math.floor(f/2),_=f-w,$=Math.floor(y/2),v=y-$;l={top:w,bottom:_,left:$,right:v,front:b,back:g}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:l,outDepth:c,outHeight:p,outWidth:h}},Ki=(e,t,r,n,o,s=!1,i="channelsLast")=>{let a,u,d,l,c;if(i==="channelsLast")[a,u,d,l,c]=e;else if(i==="channelsFirst")[a,c,u,d,l]=e;else throw new Error(`Unknown dataFormat ${i}`);let[p,,h,m,f]=t,[y,b,g]=qi(r),[w,_,$]=qi(n),v=Jt(h,w),T=Jt(m,_),I=Jt(f,$),{padInfo:P,outDepth:B,outHeight:D,outWidth:L}=Vd(o,u,d,l,y,b,g,v,T,I),z=s?p*c:p,N=[0,0,0,0,0];return i==="channelsFirst"?N=[a,z,B,D,L]:i==="channelsLast"&&(N=[a,B,D,L,z]),{batchSize:a,dataFormat:i,inDepth:u,inHeight:d,inWidth:l,inChannels:c,outDepth:B,outHeight:D,outWidth:L,outChannels:z,padInfo:P,strideDepth:y,strideHeight:b,strideWidth:g,filterDepth:h,filterHeight:m,filterWidth:f,effectiveFilterDepth:v,effectiveFilterHeight:T,effectiveFilterWidth:I,dilationDepth:w,dilationHeight:_,dilationWidth:$,inShape:e,outShape:N,filterShape:t}},ji=(e,t,r,n,o,s)=>{let i=s==="channelsLast",a=i?e[0].dims[3]:e[0].dims[1],u=!1,d=[64,1,1],l={x:r.map((g,w)=>w)},c=[Math.ceil(Rd(l.x.map(g=>r[g]))/d[0]),1,1];j("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${c}`);let p=u?i&&a%4!==0?3:4:1,h=x.size(r),m=[{type:12,data:h},{type:12,data:n},{type:12,data:o},{type:12,data:t.strides},{type:12,data:t.dilations}];ve(t,m),m.push(...k(e[0].dims,e[1].dims));let f=["rank","rank"],y=e.length===3;y&&(m.push(...k(e[2].dims)),f.push("rank")),m.push(...k(r));let b=g=>{let w=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:n.length},{name:"pads",type:"u32",length:o.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];xe(t,w);let _=u?4:1,$=ee(e[0].dataType),v=S("x",e[0].dataType,e[0].dims.length,p===3?1:p),T=S("W",e[1].dataType,e[1].dims.length,_),I=[v,T],P=C("result",e[0].dataType,r.length,_),B="";if(y){let z=S("bias",e[2].dataType,e[2].dims.length,_);I.push(z),B+=`
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${$}>`:$} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${i};${p};${y}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:c[0],y:c[1],z:c[2]},programUniforms:m}),getShaderSource:b}}});var Xi,Qi,Yi=A(()=>{"use strict";M();q();F();Re();Xi=(e,t,r,n)=>{let o=e.length>2,s=o?"value += b[output_channel];":"",i=e[0].dims,a=e[1].dims,u=t.format==="NHWC",d=u?r[3]:r[1],l=d/t.group,c=u&&l>=4?re(d):1,p=x.size(r)/c,h=[{type:12,data:p},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:l}];ve(t,h),h.push(...k(i,[a[0],a[1],a[2],a[3]/c]));let m=o?["rank","rank","rank"]:["rank","rank"];h.push(...k([r[0],r[1],r[2],r[3]/c]));let f=y=>{let b=C("output",e[0].dataType,r.length,c),g=ee(b.type.tensor),w=$e(t,b.type.value,g),_=S("x",e[0].dataType,i.length),$=S("w",e[1].dataType,a.length,c),v=[_,$];o&&v.push(S("b",e[2].dataType,e[2].dims,c));let T=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];xe(t,T);let I=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${c}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:h}),getShaderSource:f}},Qi=(e,t,r,n)=>{let o=e.length>2,s=re(r[3]),i=re(r[2]),a=x.size(r)/s/i,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],l=[r[0],r[1],r[2],r[3]/s],c=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];ve(t,c),c.push(...k(u,d,l));let p=(i-1)*t.strides[1]+d[1],h=m=>{let f=C("output",e[0].dataType,l.length,s),y=ee(f.type.tensor),b=$e(t,f.type.value,y),g=S("x",e[0].dataType,u.length,s),w=S("w",e[1].dataType,d.length,s),_=[g,w];o&&_.push(S("b",e[2].dataType,e[2].dims,s));let $=o?"value += b[output_channel];":"",v=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return xe(t,v),`
  ...
  }`};return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${t.cacheKey};${s};${i};${p};${d[0]};${d[1]}`,inputDependencies:o?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:h}}});var Wr,Ud,Ji,Lr=A(()=>{"use strict";M();q();mt();F();Re();Wr=(e,t,r,n,o=!1,s)=>{let i=e[0].dims,a=e[1].dims,u=i[i.length-2],d=a[a.length-1],l=i[i.length-1],c=re(d),p=re(l),h=re(u),m=x.size(r)/c/h,f=e.length>2,y=n?n.slice(0,-2):r.slice(0,-2),g=[x.size(y),u,d],w=[{type:12,data:m},{type:12,data:u},{type:12,data:d},{type:12,data:l}];ve(t,w),w.push(...k(y,i,a)),f&&w.push(...k(e[2].dims)),w.push(...k(g));let _=$=>{let v=Gt("batch_dims",e[0].dataType,y.length),T=S("a",e[0].dataType,i.length,p),I=S("b",e[1].dataType,a.length,c),P=C("output",e[0].dataType,g.length,c),B=ee(P.type.tensor),D=$e(t,P.type.value,B),L=[T,I],z="";if(f){let oe=o?c:1;L.push(S("bias",e[2].dataType,e[2].dims.length,oe)),z=`${o?`value += bias[col / ${oe}];`:`value += ${P.type.value}(bias[row + i]);`}`}let N=i.slice(0,-2),se=a.slice(0,-2),W=Xe(N,y),Z=Xe(se,y),K=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];xe(t,K);let V=(oe,Q)=>{let H=oe.rank,E=oe.name;if(H===2)return`var ${E}_indices = ${oe.type.indices}(0u, 0u);`;let R=v.rank,Y=`var ${E}_indices: ${oe.type.indices};`;for(let ye=H-2-1,ie=R-1;ye>=0;ye--,ie--)Y+=`
...
`}return oe};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${p};${h};${o}`,inputDependencies:f?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:w}),getShaderSource:_}},Ud=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},Ji=e=>{Ud(e.inputs);let t=ke.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let r=t[t.length-1],n=e.inputs[0].dims[e.inputs[0].dims.length-1];r<8&&n<8?e.compute(Wr(e.inputs,{activation:""},t)):e.compute(Yt(e.inputs,{activation:""},t))}});var Nd,Gr,Wd,Hr,qr,es,Ld,Gd,Fr,ts=A(()=>{"use strict";q();Hi();Zi();mt();Yi();Re();Lr();De();Nd=(e,t,r,n,o,s)=>{let i=e[0],a=e.slice(s?1:2,s?3:4),u=a.length,d=t[0],c=t.slice(2).map((m,f)=>m+(m-1)*(r[f]-1)),h=a.map((m,f)=>m+n[f]+n[f+u]).map((m,f)=>Math.floor((m-c[f]+o[f])/o[f]));return h.splice(0,0,i),h.splice(s?3:1,0,d),h},Gr=[2,3,1,0],Wd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length>5)throw new Error("greater than 5D is not supported");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[1]*t.group;if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");if(e.length===3&&(e[2].dims.length!==1||e[1].dims[0]!==e[2].dims[0]))throw new Error("invalid bias");let o=e[0].dims.length-2;if(t.dilations.length!==o)throw new Error(`dilations should be ${o}D`);if(t.strides.length!==o)throw new Error(`strides should be ${o}D`);if(t.pads.length!==o*2)throw new Error(`pads should be ${o*2}D`);if(t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape")},Hr=(e,t)=>{let r=e.kernelShape.slice();r.length<t[1].dims.length-2&&r.push(...Array(t[1].dims.length-2-r.length).fill(0));for(let s=2;s<t[1].dims.length;++s)r[s-2]===0&&(r[s-2]=t[1].dims[s]);let n=e.pads.slice();qe.adjustPadsBasedOnAutoPad(t[0].dims,e.strides,e.dilations,r,n,e.format==="NHWC",e.autoPad);let o=Object.assign({},e);return Object.assign(o,{kernelShape:r,pads:n}),o},qr=e=>{let t=Zt(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],o=e.dilations,s=e.group,i=e.kernel_shape,a=e.pads,u=e.strides,d=e.w_is_const();return{autoPad:n,format:r,dilations:o,group:s,kernelShape:i,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},es=(e,t,r,n)=>{let o=r.format==="NHWC",s=Nd(t[0].dims,t[1].dims,r.dilations,r.pads,r.strides,o);if(r.group!==1){let v=[t[0]];if(o){let I=e.kernelCustomData.wT??e.compute(pe(t[1],Gr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=I),v.push(I)}else v.push(t[1]);t.length===3&&v.push(t[2]),!e.adapterInfo.isArchitecture("ampere")&&o&&t[1].dims[0]===r.group&&t[1].dims[1]===1&&r.dilations[0]===1&&r.dilations[1]===1?e.compute(Qi(v,r,s,n),{inputs:v}):e.compute(Xi(v,r,s,n),{inputs:v});return}let i=t.length===3,a=t[0].dims[o?1:2],u=t[0].dims[o?2:3],d=t[0].dims[o?3:1],l=t[1].dims[2],c=t[1].dims[3],p=s[o?1:2],h=s[o?2:3],m=s[o?3:1],f=o&&l===a&&c===u&&r.pads[0]===0&&r.pads[1]===0;if(f||l===1&&c===1&&r.dilations[0]===1&&r.dilations[1]===1&&r.strides[0]===1&&r.strides[1]===1&&r.pads[0]===0&&r.pads[1]===0){let v=s[0],T,I,P,B=[];if(o){let z=e.kernelCustomData.wT??e.compute(pe(t[1],Gr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];if(r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=z),f){let N=a*u*d;T=t[0].reshape([1,v,N]),I=z.reshape([1,N,m]),P=[1,v,m]}else T=t[0].reshape([v,a*u,d]),I=z.reshape([1,d,m]),P=[v,p*h,m];B.push(T),B.push(I)}else T=t[0].reshape([v,d,a*u]),I=t[1].reshape([1,m,d]),P=[v,m,p*h],B.push(I),B.push(T);i&&B.push(t[2]);let D=P[2],L=B[0].dims[B[0].dims.length-1];D<8&&L<8?e.compute(Wr(B,r,s,P,o,n),{inputs:B}):e.compute(Yt(B,r,s,P,o,n),{inputs:B});return}let y=!0,b=e.kernelCustomData.wT??e.compute(pe(t[1],Gr),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=b);let g=[t[0],b];i&&g.push(t[2]);let w=o?p*h:m,_=o?m:p*h,$=l*c*d;e.compute(Gi(g,r,s,w,_,$,i,y,n),{inputs:g})},Ld=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=[0,t.pads[0],0,t.pads[1]],s=[1].concat(t.strides),i=[1].concat(t.dilations),a=[1].concat(t.kernelShape),u=Hr({...t,pads:o,strides:s,dilations:i,kernelShape:a},n);es(e,n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]])},Gd=(e,t,r)=>{let n=r.format==="NHWC"?"channelsLast":"channelsFirst",o=Hr(r,t),s=r.autoPad==="NOTSET"?r.pads:r.autoPad,i=Ki(t[0].dims,t[1].dims,r.strides,r.dilations,s,!1,n);e.compute(ji(t,o,i.outShape,[i.filterDepth,i.filterHeight,i.filterWidth],[i.padInfo.front,i.padInfo.top,i.padInfo.left],n))},Fr=(e,t)=>{if(Wd(e.inputs,t),e.inputs[0].dims.length===3)Ld(e,t);else if(e.inputs[0].dims.length===5)Gd(e,e.inputs,t);else{let r=Hr(t,e.inputs);es(e,e.inputs,r)}}});var Hd,rs,ns=A(()=>{"use strict";M();Ce();F();Re();lt();Nr();mt();Hd=(e,t=!1,r,n,o=4)=>{let s=b=>{switch(b){case 1:return"return w[getIndexFromCoords4D(coord, vec4<i32>(uniforms.w_shape))];";case 4:return`
  ...
  ${s?w:_}}`},Kr=(e,t,r)=>{let n=e.length>2,o=t.outputShape,s=x.size(o),i=[Math.ceil(s/64),1,1];j("verbose",()=>`[conv2d_backprop_webgpu] dispatch = ${i}`);let a=t.format==="NHWC",u=["rank","rank"],d=[t.strides[0],t.strides[1]],l=[t.kernelShape[a?1:2],t.kernelShape[a?2:3]],c=[t.dilations[0],t.dilations[1]],p=[l[0]+(t.dilations[0]<=1?0:(t.kernelShape[a?1:2]-1)*(t.dilations[0]-1)),l[1]+(t.dilations[1]<=1?0:(t.kernelShape[a?2:3]-1)*(t.dilations[1]-1))],h=[p[0]-1-Math.floor((t.pads[0]+t.pads[2])/2),p[1]-1-Math.floor(t.pads[1]+t.pads[3])/2],m=!1,f=t.group,y=e[1].dims,b=y[0]/f,g=y[1],w=[{type:12,data:s},{type:12,data:d},{type:12,data:l},{type:12,data:c},{type:12,data:p},{type:6,data:h},{type:12,data:b},{type:12,data:g},...k(e[0].dims,e[1].dims)];n&&(w.push(...k(e[2].dims)),u.push("rank")),w.push(...k(o));let _=i[1]===1&&i[2]===1,$=v=>{let T=[{name:"output_size",type:"u32"},{name:"strides",type:"u32",length:d.length},{name:"filter_dims",type:"u32",length:l.length},{name:"dilations",type:"u32",length:l.length},{name:"effective_filter_dims",type:"u32",length:p.length},{name:"pads",type:"i32",length:h.length},{name:"input_channels_per_group",type:"u32"},{name:"output_channels_per_group",type:"u32"}],I=ee(e[0].dataType);return`${qd(v,e,o,n,_,m,I,T,a)}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};`,inputDependencies:u},getRunData:()=>({dispatchGroup:{x:i[0],y:i[1],z:i[2]},outputs:[{dims:r?r(o):o,dataType:e[0].dataType}],programUniforms:w}),getShaderSource:$}}});var Fd,Kd,jd,is,ss,Zd,Xd,Qd,Yd,as,us=A(()=>{"use strict";ns();os();Re();De();Fd=(e,t,r,n,o,s)=>(e-1)*t+r+(n-1)*o+1-s,Kd=(e,t,r,n,o)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=s,r[o]=e-s):t==="SAME_LOWER"&&(r[n]=e-s,r[o]=s)},jd=(e,t,r,n,o,s,i,a,u,d)=>{let l=e.length-2,c=d.length===0;u.length<l&&u.push(...Array(l-u.length).fill(0));let p=e[0],h=t[a?3:1]*o;for(let m=0,f=e.length-l-(a?1:0);m<l;++m,++f){let y=e[f],b=c?y*i[m]:d[m],g=Fd(y,i[m],s[m],t[f],r[m],b);Kd(g,n,s,m,m+l),c&&d.push(i[m]*(y-1)+u[m]+(t[f]-1)*r[m]+1-s[m]-s[m+l])}d.splice(0,0,p),d.splice(a?3:1,0,h)},is=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){r.length=0;for(let c=2;c<t[1].dims.length;++c)r.push(t[1].dims[c])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let o=e.pads.slice(),s=e.outputShape.slice(),i=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let d=e.strides.slice();if(d.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;d=new Array(c).fill(1)}jd(a,r,u,e.autoPad,e.group,o,d,n,i,s);let l=Object.assign({},e);return Object.assign(l,{kernelShape:r,pads:o,outputPadding:i,outputShape:s,dilations:u,strides:d}),l},ss=e=>{let t=Zt(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,s=e.group,i=e.kernelShape,a=e.pads,u=e.strides,d=e.wIsConst(),l=e.outputPadding,c=e.outputShape;return{autoPad:n,format:r,dilations:o,group:s,kernelShape:i,outputPadding:l,outputShape:c,pads:a,strides:u,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},Zd=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((l,c)=>l+c,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((l,c)=>l+c,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((l,c)=>l+c,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((l,c)=>l+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Xd=[2,3,1,0],Qd=(e,t,r)=>{let n=is(r,t),o=r.format==="NHWC",s=n.outputShape,i=s[o?3:1],a=t[0].dims[o?3:1];if(n.group!==1||i===1&&a===1){e.compute(Kr(t,n));return}let u=s[o?1:2],d=s[o?2:3],l=t[1].dims[2],c=t[1].dims[3],p=o?u*d:i,h=o?i:u*d,m=l*c*a,f=!0,y=e.kernelCustomData.wT??e.compute(pe(t[1],Xd),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=y);let b=[t[0],y],g=t.length===3;g&&(!o&&t[2].dims.length===1?b.push(t[2].reshape([t[2].dims[0],1,1])):b.push(t[2])),e.compute(rs(b,n,s,p,h,m,g,f),{inputs:b})},Yd=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let i=t.strides;(i.length===0||i[0]===0)&&(i=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],i=[1].concat(i),s=[1].concat(s),o=[1].concat(o);let u=is({...t,pads:a,strides:i,dilations:s,kernelShape:o},n);e.compute(Kr(n,u,d=>r?[d[0],d[2],d[3]]:[d[0],d[1],d[3]]))},as=(e,t)=>{Zd(e.inputs,t),e.inputs[0].dims.length===3?Yd(e,t):Qd(e,e.inputs,t)}});var Jd,ds,ls,cs=A(()=>{"use strict";M();q();ue();F();Jd=(e,t,r,n)=>{let o=x.size(t),s=t.length,i=S("input",e,s),a=C("output",e,s),u=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=x.normalizeAxis(u,s),l=c=>{let p=` i32(${i.indicesGet("inputIndices","uniforms.axis")}) `,h=O("uniforms.input_shape","uniforms.axis",s),m=n.reverse?p+(n.exclusive?" + 1":""):"0",f=n.reverse?h:p+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:d},...k(t,t)]}),getShaderSource:l}},ds=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,o=e.inputs[1];e.compute(Jd(n,r,o,t),{inputs:[0]})},ls=e=>{let t=e.exclusive===1,r=e.reverse===1;return U({exclusive:t,reverse:r})}});var el,tl,rl,ps,ms,fs=A(()=>{"use strict";M();q();ue();F();el=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},tl=(e,t,r,n)=>{let o=[];o.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
...
`)},rl=(e,t)=>{let r,n,o,s,i,a,u=t.format==="NHWC",d=t.blocksize,l=t.mode==="DCR";u?([r,n,o,s]=e.dims,i=l?[r,n,o,d,d,s/d**2]:[r,n,o,s/d**2,d,d],a=l?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,o,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],i=l?[r,d,d,s/d**2,n,o]:[r,s/d**2,d,d,n,o],a=l?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let c=e.reshape(i),p=c.dims.length,h=e.dataType,m=S("a",h,p),f=C("output",h,p),y=b=>`
  ...
  }`;return{name:"DepthToSpace",shaderCache:{hint:`${e.dims};${t.blocksize};${t.mode}`,inputDependencies:["rank"]},getRunData:b=>{let g=u?[r,n*d,o*d,s/d**2]:[r,s/d**2,n*d,o*d],w=x.size(g),_=c.dims,$=x.sortBasedOnPerm(_,a);return{outputs:[{dims:g,dataType:b[0].dataType}],dispatchGroup:{x:Math.ceil(w/64)},programUniforms:[{type:12,data:w},...k(_,$)]}},getShaderSource:y}},ps=(e,t)=>{el(e.inputs),e.compute(rl(e.inputs[0],t))},ms=e=>U({blocksize:e.blocksize,mode:e.mode,format:e.format})});var jr,er,hs,nl,ol,Zr,Xr,gs,il,ys,bs,ws=A(()=>{"use strict";M();q();ue();F();jr="[a-zA-Z]|\\.\\.\\.",er="("+jr+")+",hs="^"+er+"$",nl="("+er+",)*"+er,ol="^"+nl+"$",Zr=class{constructor(t=-1){this.symbolToIndices=new Map,this.inputIndex=t}addSymbol(t,r){let n=this.symbolToIndices.get(t);n===void 0?n=[r]:n.push(r),this.symbolToIndices.set(t,n)}},Xr=class{constructor(t,r){this.equation=r;this.hasEllipsis=!1,this.symbolToInfo=new Map,this.lhs=new Array,this.outputDims=[];let[n,o]=r.includes("->")?r.split("->",2):[r,""];if(!n.match(RegExp(ol)))throw new Error("Invalid LHS term");if(n.split(",").forEach((a,u)=>{let d=t[u].dims.slice();if(!a.match(RegExp(hs)))throw new Error("Invalid LHS term");let l=this.processTerm(a,!0,d,u);this.lhs.push(l)}),o==="")o+=[...this.symbolToInfo.entries()].filter(([a,u])=>u.count===1||a==="...").map(([a])=>a).join("");else if(!o.match(RegExp(er)))throw new Error("Invalid RHS");o.match(RegExp(jr,"g"))?.forEach(a=>{if(a==="...")this.outputDims=this.outputDims.concat(this.ellipsisDims);else{let u=this.symbolToInfo.get(a);if(u===void 0)throw new Error("Invalid RHS symbol");this.outputDims.push(u.dimValue)}}),this.rhs=this.processTerm(o,!1,this.outputDims)}addSymbol(t,r,n){let o=this.symbolToInfo.get(t);if(o!==void 0){if(o.dimValue!==r&&o.count!==1)throw new Error("Dimension mismatch");o.count++,o.inputIndices.push(n)}else o={count:1,dimValue:r,inputIndices:[n]};this.symbolToInfo.set(t,o)}processTerm(t,r,n,o=-1){let s=n.length,i=!1,a=[],u=0;if(!t.match(RegExp(hs))&&!r&&t!=="")throw new Error("Invalid LHS term");let d=t.match(RegExp(jr,"g")),l=new Zr(o);return d?.forEach((c,p)=>{if(c==="..."){if(i)throw new Error("Only one ellipsis is allowed per input term");i=!0;let h=s-d.length+1;if(h<0)throw new Error("Ellipsis out of bounds");if(a=n.slice(u,u+h),this.hasEllipsis){if(this.ellipsisDims.length!==a.length||this.ellipsisDims.toString()!==a.toString())throw new Error("Ellipsis dimensions mismatch")}else if(r)this.hasEllipsis=!0,this.ellipsisDims=a;else throw new Error("Ellipsis must be specified in the LHS");for(let m=0;m<a.length;m++){let f=String.fromCharCode("0".charCodeAt(0)+m);l.addSymbol(f,p+m),this.addSymbol(f,n[u++],o)}}else l.addSymbol(c,p+(this.hasEllipsis?this.ellipsisDims.length-1:0)),this.addSymbol(c,n[u++],o)}),l}},gs=e=>e+"_max",il=(e,t,r,n)=>{let s=e.map(l=>l.length).map((l,c)=>S(`input${c}`,t,l)),i=x.size(n),a=C("output",t,n.length),u=[...r.symbolToInfo.keys()].filter(l=>!r.rhs.symbolToIndices.has(l)),d=l=>{let c=[],p="var prod = 1.0;",h="var sum = 0.0;",m="sum += prod;",f=[],y=[],b=[],g=[],w=r.symbolToInfo.size===r.rhs.symbolToIndices.size;r.symbolToInfo.forEach(($,v)=>{if(r.rhs.symbolToIndices.has(v)){let T=r.rhs.symbolToIndices.get(v)?.[0];T!==void 0&&r.lhs.forEach((I,P)=>{if($.inputIndices.includes(P)){let B=I.symbolToIndices.get(v);if(B===void 0)throw new Error("Invalid symbol error");B.forEach(D=>{c.push(`${s[P].indicesSet(`input${P}Indices`,D,a.indicesGet("outputIndices",T))}`)})}})}else r.lhs.forEach((T,I)=>{if($.inputIndices.includes(I)){let P=T.symbolToIndices.get(v);if(P===void 0)throw new Error("Invalid symbol error");P.forEach(B=>{f.push(`${s[I].indicesSet(`input${I}Indices`,B,`${v}`)}`)}),g.push(`prod *= ${s[I].getByIndices(`input${I}Indices`)};`)}}),y.push(`for(var ${v}: u32 = 0; ${v} < uniforms.${gs(v)}; ${v}++) {`),b.push("}")});let _=w?[...c,`let sum = ${s.map(($,v)=>$.getByIndices(`input${v}Indices`)).join(" * ")};`]:[...c,h,...y,...f,p,...g,m,...b];return`
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let l=u.filter(p=>r.symbolToInfo.has(p)).map(p=>({type:12,data:r.symbolToInfo.get(p)?.dimValue||0}));l.push({type:12,data:i});let c=e.map((p,h)=>[...k(p)]).reduce((p,h)=>p.concat(h),l);return c.push(...k(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:c}},getShaderSource:d}},ys=(e,t)=>{let r=new Xr(e.inputs,t.equation),n=r.outputDims,o=e.inputs.map((s,i)=>s.dims);e.compute(il(o,e.inputs[0].dataType,r,n))},bs=e=>{let t=e.equation.replace(/\s+/g,"");return U({equation:t})}});var sl,_s,al,ul,$s,vs=A(()=>{"use strict";M();q();F();sl=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,o=t.length<r.length?0:t.length-r.length;for(;n<r.length&&o<t.length;++n,++o)if(r[n]!==t[o]&&r[n]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},_s=(e,t)=>{let r=e.length-t.length,n=[];for(let o=0;o<r;++o)n.push(e[o]);for(let o=0;o<t.length;++o)n.push(t[o]===1?e[o+r]:t[o]);return n},al=(e,t)=>e.length>t.length?_s(e,t):_s(t,e),ul=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=al(t,r),o=e[0].dataType,s=o===9?4:1,i=Math.ceil(x.size(n)/s),a=d=>{let l=S("input",o,t.length,s),c=C("output",o,n.length,s),p;if(o===9){let h=(m,f,y="")=>`
    ...
    ${p}`},u=[{type:12,data:i},...k(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:a,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:u})}},$s=e=>{sl(e.inputs),e.compute(ul(e.inputs),{inputs:[0]})}});var dl,xs,Ss=A(()=>{"use strict";M();q();F();jt();dl=e=>{let t=e[0].dataType,r=x.size(e[0].dims),n=x.size(e[1].dims),o=n%4===0,s=i=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),d=C("y",t,[1],4),l=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=h=>`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,f)=>f!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,f)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:d}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:h}},As=(e,t)=>{let r=e.inputs;pl(r,t),e.compute(ml(e.inputs,t))},ks=e=>U({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var fl,hl,Ps,zs,Bs=A(()=>{"use strict";M();q();ue();F();fl=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d}),getShaderSource:l},{inputs:[t,r],outputs:[-1]})[0]},ft=(e,t,r,n,o,s,i,a)=>{let u=s;if(i&&x.size(i.dims)>0){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=$l(e,s,i,t,n,r*o,a),u=u.reshape([t,n,r,o]),r===1||n===1?u:e.compute(pe(u,Ms.perm),{inputs:[u],outputs:[-1]})[0]}else return s.dims.length===3&&(u=s.reshape([t,n,r,o])),r===1||n===1?u:e.compute(pe(u,Ms.perm),{inputs:[u],outputs:[-1]})[0]},Us=(e,t)=>{let r=_l(e.inputs,t),n=e.inputs[0],o=we(e.inputs,1),s=we(e.inputs,2),i=we(e.inputs,3),a=we(e.inputs,4),u=we(e.inputs,5),d=we(e.inputs,6),l=we(e.inputs,7);if(n.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let c=o&&s&&o.dims.length===4&&s.dims.length===4,p=ft(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,n,i,0);if(c)return Qe(e,p,o,s,a,void 0,d,l,u,r);if(!o||!s)throw new Error("key and value must be provided");let h=ft(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,o,i,r.hiddenSize),m=ft(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,i,2*r.hiddenSize);Qe(e,p,h,m,a,void 0,d,l,u,r)}});var vl,xl,Sl,Tl,Yr,Ns,Ws,Jr=A(()=>{"use strict";M();q();ue();F();vl=e=>{if(!e||e.length<1)throw new Error("too few inputs")},xl=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>r.push(Number(o))),n=r.length),U({numOutputs:n,axis:t.axis,splitSizes:r})},Sl=e=>`
...
`)}
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:c},getRunData:()=>({outputs:[{dims:o,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:l}),getShaderSource:f},{inputs:[t[0],m]})},Fs=(e,t)=>{t.format==="NHWC"?kl(e,e.inputs,t):Al(e,e.inputs,t)}});var El,Pl,js,Zs=A(()=>{"use strict";M();q();F();El=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},Pl=(e,t,r)=>{let n=t.simplified,o=e[0].dims,s=e[1],i=!n&&e[2],a=o,u=x.normalizeAxis(t.axis,o.length),d=x.sizeToDimension(o,u),l=x.sizeFromDimension(o,u),c=x.size(s.dims),p=i?x.size(i.dims):0;if(c!==l||i&&p!==l)throw new Error(`Size of X.shape()[axis:] == ${l}.
       Size of scale and bias (if provided) must match this.
       Got scale size of ${c} and bias size of ${p}`);let h=[];for(let $=0;$<o.length;++$)$<u?h.push(o[$]):h.push(1);let m=re(l),f=["type","type"],y=[{type:12,data:d},{type:1,data:l},{type:12,data:Math.floor(l/m)},{type:1,data:t.epsilon}];i&&f.push("type");let b=r>1,g=r>2,w=$=>{let v=ee(e[0].dataType),T=[S("x",e[0].dataType,e[0].dims,m),S("scale",s.dataType,s.dims,m)];i&&T.push(S("bias",i.dataType,i.dims,m)),T.push(C("output",e[0].dataType,a,m)),b&&T.push(C("mean_data_output",1,h)),g&&T.push(C("inv_std_output",1,h));let I=[{name:"norm_count",type:"u32"},{name:"norm_size",type:"f32"},{name:"norm_size_vectorized",type:"u32"},{name:"epsilon",type:"f32"}];return`
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${h};${m};${y};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:f,dataType:c}],dispatchGroup:{x:b},programUniforms:w}),getShaderSource:T}},Ol=(e,t)=>{let r=e[0].dims,n=r.length,o=r[n-2],s=t.k,i=t.n,a=r.slice(0,n-2),u=x.size(a),l=e[1].dims[2]/4,c=e[0].dataType,p=re(t.k),h=re(l),m=a.concat([o,i]),f=128,y=i%8===0?8:i%4===0?4:1,b=f/y,g=b*h*8,w=g/p,_=g/t.blockSize,$=x.size(m)/y,v=[],T=[u,o,s/p],I=x.convertShape(e[1].dims).slice();I.splice(-1,1,l/h),v.push(...k(T)),v.push(...k(I)),v.push(...k(e[2].dims)),e.length===4&&v.push(...k(x.convertShape(e[3].dims)));let P=[u,o,i];v.push(...k(P));let B=D=>{let L=T.length,z=S("a",e[0].dataType,L,p),N=S("b",12,I.length,h),se=S("scales",e[2].dataType,e[2].dims.length),W=[z,N,se],Z=e.length===4?S("zero_points",12,e[3].dims.length):void 0;Z&&W.push(Z);let K=P.length,V=C("output",e[0].dataType,K),ne=ee(e[0].dataType),oe=()=>{switch(p){case 1:return`
      ...
      `},Ml=(e,t,r)=>{let n="";for(let o=t-1;o>=0;--o)n+=`
          ...
          `},Nl=(e,t,r)=>{switch(r.mode){case 0:return Rl(e,t,r.pads.length);case 1:return Ml(e,t,r.pads.length);case 2:return Vl(e,t,r.pads.length);case 3:return Ul(e,t,r.pads.length);default:throw new Error("Invalid mode")}},Wl=(e,t)=>{let r=x.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,o=x.size(r),s=[{type:12,data:o},{type:6,data:t.pads}],i=e.length>=3&&e[2].data;t.mode===0&&s.push({type:i?e[2].dataType:1,data:t.value}),s.push(...k(e[0].dims,r));let a=["rank"],u=d=>{let l=C("output",e[0].dataType,r.length),c=S("x",e[0].dataType,n.length),p=c.type.value,h=Nl(l,n.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:i?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},oa=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,Gl=e=>`${oa(e)};${e.countIncludePad}`,Hl=e=>`${oa(e)};${e.storageOrder};${e.dilations}`,ia=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),sa=(e,t,r,n)=>{let[o,s]=ta(t,n,r),i=S("x",t.dataType,t.dims.length),a=i.type.value,u="value += x_val;",d="";o.countIncludePad?d+=`value /= ${a}(uniforms.kernelSize);`:d+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[l,c,p,h,m]=ra(s,o);l.push(...k(t.dims,s));let f=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${p};${h};${m}`,inputDependencies:f},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:l}),getShaderSource:y=>na(y,i,t.dims.length,s.length,o,u,d,0,c,p,h,m)}},aa=e=>{let t=e.count_include_pad!==0,r=ia(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:Gl(n)}},ua=(e,t)=>{tr(e.inputs),e.compute(sa("AveragePool",e.inputs[0],!1,t))},da={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},la=e=>{let t=e.format;return{format:t,...da,cacheKey:t}},ca=(e,t)=>{tr(e.inputs),e.compute(sa("GlobalAveragePool",e.inputs[0],!0,t))},pa=(e,t,r,n)=>{let[o,s]=ta(t,n,r),i=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),d=["rank"],[l,c,p,h,m]=ra(s,o);return l.push(...k(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${p};${h};${m}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(s)/64)},programUniforms:l}),getShaderSource:f=>na(f,u,t.dims.length,s.length,o,i,a,t.dataType===10?-65504:-1e5,c,p,h,m)}},ma=(e,t)=>{tr(e.inputs),e.compute(pa("MaxPool",e.inputs[0],!1,t))},fa=e=>{let t=e.storage_order,r=e.dilations,n=ia(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:r,...n,cacheKey:""};return{...o,cacheKey:Hl(o)}},ha=e=>{let t=e.format;return{format:t,...da,cacheKey:t}},ga=(e,t)=>{tr(e.inputs),e.compute(pa("GlobalMaxPool",e.inputs[0],!0,t))}});var Fl,Kl,ba,wa,_a=A(()=>{"use strict";M();q();ue();F();Fl=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,n)=>r===e[2].dims[n]).reduce((r,n)=>r&&n,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,s)=>s===t.axis||o===e[0].dims[s]).reduce((o,s)=>o&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],n=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/n)||t.blockSize>Math.ceil(r/(n-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Kl=(e,t)=>{let r=x.normalizeAxis(t.axis,e[0].dims.length),n=e[0].dataType,o=n===3,s=e[0].dims,i=e[1].dataType,a=x.size(s),u=n===3||n===2,d=u?[Math.ceil(x.size(e[0].dims)/4)]:e[0].dims,l=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil(x.size(c.dims)/4)]:c.dims:void 0,h=l.length===0||l.length===1&&l[0]===1,m=h===!1&&l.length===1,f=re(a),y=h&&(!u||f===4),b=y?f:1,g=y&&!u?f:1,w=S("input",u?12:n,d.length,g),_=S("scale",i,l.length),$=c?S("zero_point",u?12:n,p.length):void 0,v=C("output",i,s.length,b),T=[w,_];$&&T.push($);let I=[d,l];c&&I.push(p);let P=[{type:12,data:a/b},{type:12,data:r},{type:12,data:t.blockSize},...k(...I,s)],B=D=>{let L=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:Math.ceil(a/b/64),y:1,z:1},programUniforms:P})}},ba=(e,t)=>{Fl(e.inputs,t),e.compute(Kl(e.inputs,t))},wa=e=>U({axis:e.axis,blockSize:e.blockSize})});var jl,Zl,$a,va=A(()=>{"use strict";Se();M();F();jl=(e,t,r)=>{let n=e===t,o=e<t&&r<0,s=e>t&&r>0;if(n||o||s)throw new Error("Range these inputs' contents are invalid.")},Zl=(e,t,r,n)=>{let o=Math.abs(Math.ceil((t-e)/r)),s=[o],i=o,a=[{type:12,data:i},{type:n,data:e},{type:n,data:r},...k(s)],u=d=>{let l=C("output",n,s.length),c=l.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${d.registerUniforms(p).declareVariables(l)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:a})}},$a=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),J.webgpu.validateInputContent&&jl(t,r,n),e.compute(Zl(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var Xl,Ql,Yl,Jl,ec,tc,rc,nc,oc,ic,sc,xa,ac,uc,dc,lc,cc,Sa,Ta,Ia=A(()=>{"use strict";M();q();ue();F();Xl=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:U({interleaved:r}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:f,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(x.size(p)/Fe)},programUniforms:m})}},Ca=(e,t)=>{pc(e.inputs,t),e.compute(mc(e.inputs,t))}});var fc,hc,ka,Ea=A(()=>{"use strict";M();q();F();fc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],r=e[1],n=e[2];if(t.dataType!==r.dataType||t.dataType!==n.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(r.dims.length!==3&&r.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=t.dims[t.dims.length-1],s=t.dims[t.dims.length-2];if(r.dims[r.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(r.dims[r.dims.length-2]!==s)throw new Error("Skip must have the same sequence length as input");if(n.dims.length!==1)throw new Error("Gamma must be 1D");if(n.dims[n.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let i=e[3];if(i.dims.length!==1)throw new Error("Beta must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let i=e[4];if(i.dims.length!==1)throw new Error("Bias must be 1D");if(i.dims[i.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},hc=(e,t,r,n)=>{let o=t.simplified,s=e[0].dims,i=x.size(s),a=s,u=i,d=s.slice(-1)[0],l=n?s.slice(0,-1).concat(1):[],c=!o&&e.length>3,p=e.length>4,h=n&&r>1,m=n&&r>2,f=r>3,y=64,b=re(d),g=[{type:12,data:u},{type:12,data:b},{type:12,data:d},{type:1,data:t.epsilon}],w=$=>{let v=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],T=[S("x",e[0].dataType,e[0].dims,b),S("skip",e[1].dataType,e[1].dims,b),S("gamma",e[2].dataType,e[2].dims,b)];c&&T.push(S("beta",e[3].dataType,e[3].dims,b)),p&&T.push(S("bias",e[4].dataType,e[4].dims,b)),T.push(C("output",e[0].dataType,a,b)),h&&T.push(C("mean_output",1,l)),m&&T.push(C("inv_std_output",1,l)),f&&T.push(C("input_skip_bias_sum",e[0].dataType,a,b));let I=ee(e[0].dataType),P=ee(1,b);return`
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${i.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:y,getRunData:()=>({outputs:[l],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:f})}},za=(e,t)=>{gc(e.inputs,t);let r=yc(e.inputs,t);e.compute(wc(e.inputs,r),{inputs:[0]})},Ba=e=>{let t=e.starts,r=e.ends,n=e.axes;return U({starts:t,ends:r,axes:n})}});var _c,$c,Da,Ra,Ma=A(()=>{"use strict";M();q();ue();De();F();_c=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},$c=(e,t)=>{let r=e.inputs[0],n=r.dims,o=x.size(n),s=64,i=n.length,a=x.normalizeAxis(t.axis,i),u=a<n.length-1,d,l=[];u?(l=Array.from({length:i},(T,I)=>I),l[a]=i-1,l[i-1]=a,d=e.compute(pe(r,l),{inputs:[r],outputs:[-1]})[0]):d=r;let c=d.dims,p=c[i-1],h=o/p,m=re(p),f=p/m,y=(T,I)=>I===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:I===2?`max(${T}.x, ${T}.y)`:I===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,b=S("x",d.dataType,d.dims,m),g=C("result",d.dataType,d.dims,m),w=b.type.value,_=ee(d.dataType)==="f32"?`var threadMax = ${w}(-3.402823e+38f);`:`var threadMax = ${w}(-65504.0h);`,$=T=>`
