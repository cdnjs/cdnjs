...
`}var Zc,Yc,is,ss=x(()=>{"use strict";U();X();R();me();Zc=i=>({name:"Reshape (packed)",inputTypes:[2],inputNames:["A"],cacheHint:`${i}`}),Yc=(i,e,o,t)=>{let r=e.dims,n=t,s="";for(let l=0;l<4;l++){let f="";switch(l){case 0:f="outputCoords = rc;";break;case 1:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z);";break;case 2:f="outputCoords = ivec3(rc.x, rc.y, rc.z+1);";break;case 3:f="outputCoords = ivec3(rc.x, rc.y+1, rc.z+1);";break;default:throw new Error}s+=`
  ...
  `,name:i,type:0}}function yp(){let i="xor_";return{body:`
  float ${i}(float a, float b) {
    return float( bool(a) ^^ bool(b) );
  }
  vec4 ${i}(vec4 v1, vec4 v2) {
  ...
  `,name:i,type:0}}function gp(){return Tp("pow")}function xp(){let i="prelu_";return{body:`
  float ${i}(float a, float b) {
    return a < 0.0 ? a * b: a;
  }
  vec4 ${i}(vec4 v1, vec4 v2) {
  ...
  `,name:e,type:0}}var At,wp,Ts,ws,vs,Is,_s,Ss,Os,As,Ps,Es,Ds,Ls,$s=x(()=>{"use strict";U();Xt();X();R();At=(i,e,o,t=e[0].type,r)=>{let n=i.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>wp(i,e,o,t)}},wp=(i,e,o,t=e[0].type)=>{let r=i.session.pack?2:0,n=!A.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=i.session.pack;if(n){let f=ct.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let c=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,m=e[1].dims.length!==0?e[1].dims.length:1,y=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",g=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",T=D(i.session.backend.glContext.version),_=a?`
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:e[0].dims,type:t,textureType:r},shaderSource:l,hasMain:!0}},Ts=(i,e)=>[i.run(At(i,e,up()),e)],ws=(i,e)=>[i.run(At(i,e,mp(),"bool"),e)],vs=(i,e)=>[i.run(At(i,e,lp()),e)],Is=(i,e)=>[i.run(At(i,e,pp(),"bool"),e)],_s=(i,e)=>[i.run(At(i,e,dp(),"bool"),e)],Ss=(i,e)=>[i.run(At(i,e,hp(),"bool"),e)],Os=(i,e)=>[i.run(At(i,e,fp()),e)],As=(i,e)=>[i.run(At(i,e,bp(),"bool"),e)],Ps=(i,e)=>[i.run(At(i,e,gp()),e)],Es=(i,e)=>[i.run(At(i,e,xp()),e)],Ds=(i,e)=>[i.run(At(i,e,cp()),e)],Ls=(i,e)=>[i.run(At(i,e,yp(),"bool"),e)]});var ks,Bs,Ip,Fs=x(()=>{"use strict";U();ks=(i,e,o)=>(Ip(e),[i.cast(e[0],o)]),Bs=i=>st.tensorDataTypeFromProto(i.attributes.getInt("to")),Ip=i=>{if(!i||i.length!==1)throw new Error("Cast requires 1 input.");if(i[0].type==="string")throw new Error("Invalid input type.")}});var _p,Sp,Cs,Mr,Ns=x(()=>{"use strict";X();R();Mt();me();_p=(i,e)=>({name:"Concat (packed)",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(2),cacheHint:e}),Sp=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let B=1;B<o.length;B++){let Q=o[B].dims.slice();for(let lt=0;lt<r.length;lt++)if(lt===t)n[t]+=Q[lt];else if(r[lt]!==Q[lt])throw new Error("non concat dimensions must match")}let s=n.length,a=Le("coords",s),u=pt(s),l=Vt(),f=o.map(B=>B.dims),c=Rt(s),d=new Array(f.length-1);d[0]=f[0][t];for(let B=1;B<d.length;B++)d[B]=d[B-1]+f[B][t];let m=c[t],y=c.slice(-2),g=c.join(),T=`if (${m} < ${d[0]}) {
        return getChannel(
            ...
            return getChannel(
              getX${_}(${Mr(c,m,w)}),
              vec2(${Mr(y,m,w)}));`;let v=D(i.session.backend.glContext.version),L=`
          ${l}
        ...
        `;return{...e,output:{dims:n,type:o[0].type,textureType:2},shaderSource:L,hasMain:!0}},Cs=(i,e,o)=>{let t=_p(e.length,o.cacheKey);return{...t,get:()=>Sp(i,t,e,o.axis)}},Mr=(i,e,o)=>{let t=i.indexOf(e);return i.map((n,s)=>s===t?`${n} - ${o}`:n).join()}});var Rs,Op,Ap,Pp,Gs,Ep,Dp,Lp,Ms,$p,Vs=x(()=>{"use strict";at();R();Ns();Rs=(i,e,o)=>($p(e),i.session.pack&&e[0].dims.length>1?[i.run(Cs(i,e,o),e)]:[i.run(Pp(i,e,o),e)]),Op=(i,e)=>({name:"Concat",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(0),cacheHint:e}),Ap=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let m=1;m<o.length;m++){let y=o[m].dims.slice();for(let g=0;g<r.length;g++)if(g===t)n[t]+=y[g];else if(r[g]!==y[g])throw new Error("non concat dimensions must match")}let s=n.length,a=new Array(o.length),u=0;for(let m=0;m<a.length;++m)u+=o[m].dims[t],a[m]=u;let l="";o.length<5?l=Gs(a):l=Ep(a);let f=Dp(o.length,s),c=Lp(a),d=`
        ${f}
        ${c}
        ${l}
...
`)},Ms=i=>F({axis:i.attributes.getInt("axis")}),$p=i=>{if(!i||i.length<1)throw new Error("too few inputs");let e=i[0].type,o=i[0].dims.length;if(e==="string")throw new Error("string tensor is not supported yet");for(let t of i){if(t.type!==e)throw new Error("input tensors should be one type");if(t.dims.length!==o)throw new Error("input tensors should have the same shape")}}});function kp(){return Pt("abs")}function Bp(){return Pt("acos")}function Fp(){return Pt("asin")}function Cp(){return Pt("atan")}function Np(){return Pt("ceil")}function Rp(){return Pt("cos")}function Gp(i){let e="elu";return{body:`
...
}`}var mu,bu,od,ad,Ur=x(()=>{"use strict";U();R();Mt();be();yo();mu=(i,e,o)=>(ad(e),i.session.pack?[i.run(zr(i,e,o),e)]:[i.run(mo(e,o),e)]),bu=i=>$e(i.attributes),od=(i,e)=>({name:"MatMul",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[0,0,0]:[0,0],cacheHint:e});ad=i=>{if(!i||i.length!==2)throw new Error("MatMul requires 2 inputs.");if(i[0].dims[i[0].dims.length-1]!==i[1].dims[i[1].dims.length-2])throw new Error("shared dimension does not match.");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64")throw new Error("inputs should be float type");if(i[0].type!==i[1].type)throw new Error("inputs types should match")}});function ld(i,e,o,t){let r=[],n=[],s=o[0].dims,a=o[1].dims,u=s.length,l=a.length,f=t.length,c=f-u,d=f-l;r=s.map((v,L)=>`coords.${e[L+c]}`),r[u-1]="i*2",r.join(", "),n=a.map((v,L)=>`coords.${e[L+d]}`),n[l-2]="i*2",n.join(", ");let m=ct.getBroadcastDims(s,t),y=ct.getBroadcastDims(a,t),g=m.map(v=>`coords.${e[v+c]} = 0;`).join(`
...
vec4 getBAtOutCoordsMatmul(int i) {
  ...
  return outputValue;
}`}function fd(i,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${i[t]}, `;return o+=`rc.${i[e-2]}, i*2`,o}function cd(i,e){let o="";for(let t=0;t<e-2;t++)o+=`rc.${i[t]}, `;return o+=`i*2, rc.${i[e-1]}`,o}var sd,ud,zr,yo=x(()=>{"use strict";U();X();R();Mt();be();Ur();sd=(i,e)=>({name:"MatMul (packed)",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[2,2,2]:[2,2],cacheHint:e}),ud=(i,e,o,t)=>{let r=o.length>2,n=r?"value += getBiasForMatmul();":"",s=o[0].dims,a=o[1].dims,u=ct.calcShape(s,a,!0),l=!A.areEqual(o[0].dims,o[1].dims);if(!u)throw new Error("Can't use matmul on the given tensors");let f=s[s.length-1],c=Math.ceil(f/2),d=s.length,m=a.length,y=D(i.session.backend.glContext.version),g=pt(u.length),T=u.length,_=Rt(),{activationFunction:w,applyActivation:v}=Ut(t),L=r?`${bo(g,_,o[2].dims,u,!0)}`:"",B=l?`${ld(g,_,o,u)}`:"",Q=l?"getAAtOutCoordsMatmul(i)":`getA(${fd(_,d)})`,lt=l?"getBAtOutCoordsMatmul(i)":`getB(${cd(_,m)})`,Wt=l?"":`${g} rc =
      ...
      `,Tt=`
            ...
            void main() {
              ...
              ${v}
              ${y.output} = value;
            }`;return{...e,output:{dims:u,type:o[0].type,textureType:2},shaderSource:Tt,hasMain:!0}},zr=(i,e,o)=>{let t=sd(e.length>2,o.activationCacheKey);return{...t,get:()=>ud(i,t,e,o)}}});var yu,gu=x(()=>{"use strict";Vr();hu();yo();yu=(i,e,o)=>{let t=e[0].dims,r=e[1].dims,n=ke(t,r,o.dilations,o.pads,o.strides),s=i.run(du(i,e[0],e[1],n,o),[e[0]]),a=i.reshapePacked(e[1],[r[0],r[1]*r[2]*r[3]]),u=e.length===3?[a,s,e[2]]:[a,s],l=i.run(zr(i,u,o),u);return i.reshapePacked(l,n)}});var pd,dd,xu,go,xo=x(()=>{"use strict";R();pd=i=>({name:"Im2Col",inputNames:["X"],inputTypes:[0],cacheHint:i}),dd=(i,e,o,t,r,n)=>{let s=o.dims,a=t.dims,u=r.length,l=go(s,a,r,4),f=`
        const int XC = ${s[1]};
        const int XH = ${s[2]};
        const int XW = ${s[3]};
        ...
        `;return{...e,output:{dims:l,type:o.type,textureType:4},shaderSource:f}},xu=(i,e,o,t,r)=>{let n=pd(r.cacheKey);return{...n,get:()=>dd(i,n,e,o,t,r)}},go=(i,e,o,t=4)=>[o[0],o[2],o[3],Math.ceil(i[1]*e[2]*e[3]/t)]});var hd,md,Tu,wu=x(()=>{"use strict";U();X();R();be();xo();hd=(i,e)=>({name:"ConvDotProduct",inputNames:i?["Im2Col","K","B"]:["Im2Col","K"],inputTypes:i?[0,4,0]:[0,4],cacheKey:e.activationCacheKey}),md=(i,e,o,t,r)=>{let n=o[0].dims,s=o[1].dims,a=[s[0],Math.ceil(n[1]*s[2]*s[3]/4)],u=go(n,s,t),[l,f]=i.calculateTextureWidthAndHeight(a,4),c=A.computeStrides(u),[d,m]=i.calculateTextureWidthAndHeight(u,4),y=t.length,g=o.length<3?"0.0":"_B(b)",T=Math.ceil(n[1]*s[2]*s[3]/4),{activationFunction:_,applyActivation:w}=Ut(r),v=D(i.session.backend.glContext.version),L=`
${_}
...
`)},Bd=i=>{if(!i||i.length!==1)throw new Error("Transpose requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("input should be float tensor")}});var Pu,Eu,Fd,Du=x(()=>{"use strict";Wr();Pu=(i,e,o)=>{Fd(e);let t=o.blocksize,r=t*t,n=o.mode==="DCR"?[0,3,4,1,5,2]:[0,1,4,2,5,3],s=o.mode==="DCR"?[e[0].dims[0],t,t,e[0].dims[1]/r,e[0].dims[2],e[0].dims[3]]:[e[0].dims[0],e[0].dims[1]/r,t,t,e[0].dims[2],e[0].dims[3]],a=i.reshapeUnpacked(e[0],s),u={perm:n,cacheKey:`${n}`},[l]=ye(i,[a],u),f=[e[0].dims[0],e[0].dims[1]/r,e[0].dims[2]*t,e[0].dims[3]*t];return[i.reshapeUnpacked(l,f)]},Eu=i=>{let e=i.attributes.getInt("blocksize");if(e<1)throw new Error(`blocksize must be >= 1, but got : ${e} for DepthToSpace`);let o=i.attributes.getString("mode","DCR");if(o!=="DCR"&&o!=="CRD")throw new Error(`unrecognized mode: ${o} for DepthToSpace`);return{mode:o,blocksize:e}},Fd=i=>{if(i.length!==1)throw new Error(`DepthToSpace expect 1 inputs, but got ${i.length}`);if(i[0].type==="string"||i[0].dims.length!==4)throw new TypeError("DepthToSpace input should be a 4-D numeric tensor")}});var Lu,$u,Cd,ku=x(()=>{"use strict";U();Lu=(i,e,o)=>{Cd(e,o);let t=A.flattenShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},$u=i=>i.attributes.getInt("axis",1),Cd=(i,e)=>{if(!i||i.length!==1)throw new Error("Flatten requires 1 input.");let o=i[0].dims.length;if(o===0)throw new Error("scalar tensor is not supported.");if(e<-o||e>o)throw new Error("Invalid axis");if(i[0].type==="string")throw new Error("string tensor is not supported.")}});var ee,rr=x(()=>{"use strict";ee=["float32","float64","int32","int16","int8","uint16","uint32","uint8"]});var Bu,Fu,Nd,Rd,Gd,Md,Cu=x(()=>{"use strict";at();rr();U();R();Bu=(i,e,o)=>(Md(e,o.axis),[i.run(Gd(i,e,o),e)]),Fu=i=>F({axis:i.attributes.getInt("axis",0)}),Nd={name:"Gather",inputNames:["A","B"],inputTypes:[0,0]},Rd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=o[1].dims.slice(),s=new Array(r.length+n.length-1);t=A.normalizeAxis(t,r.length);let a=[];for(let d=0;d<s.length;d++)d<t?(s[d]=r[d],a.push(`inputIdx[${d}] = outputIdx[${d}];`)):d<t+n.length?(s[d]=n[d-t],a.push(`indexDataIdx[${d-t}] = outputIdx[${d}];`)):(s[d]=r[d-n.length+1],a.push(`inputIdx[${d-n.length+1}] = outputIdx[${d}];`));let u=s.length||1,l=r.length,f=n.length||1,c=`
      ...
      float process(int indices[${f}]) {
          ...
          ${m}
          return value;
      }`;return{...i,output:{dims:a,type:e[0].type,textureType:0},variables:[{name:"alpha",type:"float",data:o.alpha},{name:"beta",type:"float",data:o.beta}],shaderSource:y}},zd=(i,e)=>{if(!i)throw new Error("Input is missing");if(e.isOptionalC&&(i.length<2||i.length>3))throw new Error("Invaid input shape.");if(!e.isOptionalC&&i.length!==3)throw new Error("Gemm requires 3 inputs");if(i.length===3&&i[2].dims.length!==1&&i[2].dims.length!==2)throw new Error("Invalid input shape of C");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64"||i.length===3&&i[2].type!=="float32"&&i[2].type!=="float64")throw new Error("Invalid input type.");if(i[0].type!==i[1].type||i.length===3&&i[0].type!==i[2].type)throw new Error("Input types are mismatched")}});var Vu,Uu,Wd,Hd,qd,jd,Xd,zu=x(()=>{"use strict";at();R();Vu=(i,e,o)=>(Xd(e),[i.run(qd(i,e,o),e)]),Uu=i=>{let e=i.attributes.getFloat("scale"),o=i.attributes.getFloats("bias");return F({scale:e,bias:o})},Wd={name:"ImageScaler",inputNames:["X"],inputTypes:[0]},Hd=(i,e,o,t)=>{let r=o[0].dims.slice(),n=r.length,a=`
      ${jd(t.bias.length)}
      float process(int indices[${n}]) {
...
`)},Xd=i=>{if(!i||i.length!==1)throw new Error("ImageScaler requires 1 input.");if(i[0].dims.length!==4)throw new Error("Invalid input shape.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")}});var Hu,qu,Wu,Kd,Jd,Zd,Yd,Qd,th,ju=x(()=>{"use strict";X();R();Hu=(i,e,o)=>{th(e);let t=i.run(Jd(e[0]),e);return[i.run(Qd(i,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},qu=i=>i.attributes.getFloat("epsilon",1e-5),Wu={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},Kd=(i,e)=>{let o=e.dims.slice(),t=o[1],r=o[2]*o[3],n=[o[0],t],s=`
    ...
    `;return{...e,output:{dims:n,type:i[0].type,textureType:0},shaderSource:l}},cl=(i,e,o)=>{let t=i[0].dims.slice(),r=Object.hasOwnProperty.call(e,"dilations"),n=e.kernelShape.slice(),s=e.strides.slice(),a=r?e.dilations.slice():[],u=e.pads.slice();ce.adjustPoolAttributes(o,t,n,s,a,u);let l=ce.computePoolOutputShape(o,t,s,a,n,u,e.autoPad),f=Object.assign({},e);return r?Object.assign(f,{kernelShape:n,strides:s,pads:u,dilations:a,cacheKey:e.cacheKey}):Object.assign(f,{kernelShape:n,strides:s,pads:u,cacheKey:e.cacheKey}),[f,l]},dh={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},rl={name:"GlobalMaxPool",inputNames:["X"],inputTypes:[0]},pl=(i,e)=>(qr(e),[i.run({...rl,get:()=>fl(e,rl,!0,dh)},e)]),qr=i=>{if(!i||i.length!==1)throw new Error("Pool ops requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")},dl=(i,e,o,t,r)=>{let n=i.length;if(e.kernelShape.length<=2){let s=e.kernelShape[e.kernelShape.length-1],a=e.strides[e.strides.length-1],u=e.pads[e.pads.length/2-1],l=e.pads[e.pads.length-1],f=i[n-1],c="",d="",m="";if(u+l!==0?c=`
      ...
      `}else{let s=A.size(e.kernelShape),a=A.computeStrides(e.kernelShape),u=a.length,l=e.pads.length,f=hh(u),c=Hr(i,"inputDims"),d=Hr(e.pads,"pads"),m=Hr(a,"kernelStrides"),y=Hr(e.strides,"strides"),g=e.pads.reduce((w,v)=>w+v),T="";return g?T=`
  ...
  void offsetToIndices(int offset, int[${i}] strides, out int[${i}] indices) {
    ...
    indices[${i} - 1] = offset;
  }`});var ge,re,mh,bh,ml,bl,yl,gl,xl,Tl,wl,vl=x(()=>{"use strict";at();rr();U();R();ge=(i,e,o,t,r)=>{bh(e);let n={name:t,inputNames:["A"],inputTypes:[0]};return[i.run({...n,cacheHint:o.cacheKey,get:()=>mh(i,e,o,t,r,n)},e)]},re=i=>{let e=i.attributes.getInts("axes",[]),o=i.attributes.getInt("keepdims",1)===1;return F({axes:e,keepDims:o})},mh=(i,e,o,t,r,n)=>{let s=[],a=e[0].dims.length||1,u=[],l=A.normalizeAxes(o.axes,e[0].dims.length),f=r(e,l),c=f[1];for(let y=0;y<e[0].dims.length;y++)l.indexOf(y)>=0||l.length===0?(o.keepDims&&s.push(1),c=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),xl=(i,e,o)=>ge(i,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),Tl=(i,e,o)=>ge(i,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),wl=(i,e,o)=>ge(i,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var Il,_l=x(()=>{"use strict";U();Il=(i,e)=>{let o=A.calculateReshapedDims(e[0].dims,e[1].integerData);return i.session.pack?[i.reshapePacked(e[0],o)]:[i.reshapeUnpacked(e[0],o)]}});var Sl,_o,Ol,Al,nr,yh,So,jr,Oo=x(()=>{"use strict";at();X();R();Sl={name:"Upsample",inputNames:["X"],inputTypes:[0]},_o=(i,e,o)=>(So(e,o),[i.run({...Sl,cacheHint:o.cacheKey,get:()=>yh(i,e,o)},e)]),Ol=i=>nr(i,7),Al=i=>nr(i,9),nr=(i,e)=>{let o=e>=10,t=i.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let r=[];e<9&&(r=i.attributes.getFloats("scales"),jr(r,t,o));let n=i.attributes.getFloat("extrapolation_value",0),s=e>10?i.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?i.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=i.attributes.getFloat("cubic_coeff_a",-.75),c=i.attributes.getInt("exclude_outside",0)!==0;if(c&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",m=0,y=0,g=0;return e>10?i.inputs.length>2?(m=1,y=2,g=3):(y=1,g=2):e===9&&(y=1),F({opset:e,isResize:o,mode:t,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:f,excludeOutside:c,useNearest2xOptimization:d,roiInputIdx:m,scalesInputIdx:y,sizesInputIdx:g})},yh=(i,e,o)=>{let t=D(i.session.backend.glContext.version),[r,n]=i.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((g,T)=>Math.floor(g*o.scales[T])),[a,u]=i.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),c=new Array(l),d=`
    ...
    }`;return{...Sl,output:{dims:s,type:e[0].type,textureType:0},shaderSource:y,variables:[{name:"scales",type:"int",arrayLength:o.scales.length,data:o.scales.map(g=>Math.ceil(g))}]}},So=(i,e)=>{if(!i||e.opset<9&&i.length!==1||e.opset>=9&&e.opset<11&&i.length!==2||e.opset>=11&&i.length<2)throw new Error("invalid inputs.");if(e.scales.length>0&&i[0].dims.length!==e.scales.length)throw new Error("Invalid input shape.");if(i[0].type==="string")throw new Error("Invalid input tensor types.")},jr=(i,e,o)=>{if(o){for(let t of i)if(t<=0)throw new Error("Scale value should be greater than 0.")}else for(let t of i)if(t<1)throw new Error("Scale value should be greater than or equal to 1.");if((e==="linear"||e==="cubic")&&i.length!==2&&(i.length!==4||i[0]!==1||i[1]!==1))throw new Error(`'Linear' mode and 'Cubic' mode only support 2-D inputs ('Bilinear', 'Bicubic')         or 4-D inputs with the corresponding outermost 2 scale values being 1         in the ${o?"Resize":"Upsample"} opeartor.`)}});var Ao,Po,Pl,El,gh,xh,Th,wh,Dl=x(()=>{"use strict";X();R();Mt();me();Oo();Ao={name:"Resize",inputNames:["A"],inputTypes:[2]},Po=(i,e,o)=>(So(e,o),[i.run({...Ao,cacheHint:o.cacheKey,get:()=>gh(i,e,o)},e)]),Pl=i=>nr(i,10),El=i=>nr(i,11),gh=(i,e,o)=>{let t=D(i.session.backend.glContext.version),[r,n]=xh(e,o);if(r.every(v=>v===1)&&o.coordinateTransformMode!=="tf_crop_and_resize")return{...Ao,output:{dims:n,type:e[0].type,textureType:2},hasMain:!0,shaderSource:`void main() {
    ...
    `;return{...o,output:{dims:r,type:e[0].type,textureType:0},hasMain:!0,shaderSource:s}},Fh=i=>{if(!i||i.length===0)throw new Error("Sum requires inputs.");let e=i[0].dims.length;for(let o=1;o<i.length;o++){if(e!==i[o].dims.length)throw new Error("Input shapes are mismatched.");for(let t=0;t<e;t++)if(i[0].dims[t]!==i[o].dims[t])throw new Error("Input shapes are not matched.")}if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.");for(let o=1;o<i.length;o++)if(i[0].type!==i[o].type)throw new Error("Input types are not matched.")}});var nf,Ch,Nh,of=x(()=>{"use strict";rr();R();nf=(i,e)=>{Nh(e);let o={name:"Tile",inputNames:["A"],inputTypes:[0]};return[i.run({...o,get:()=>Ch(i,e,o)},e)]},Ch=(i,e,o)=>{let t=e[0].dims.slice(),r=new Array(t.length),n=[];for(let u=0;u<t.length;u++)r[u]=t[u]*e[1].numberData[u],n.push(`inputIdx[${u}] = int(mod(float(outputIdx[${u}]), ${t[u]}.));`);let s=r.length,a=`
...
`)}
    ...
    `;return{...o,output:{dims:r,type:e[0].type,textureType:0},shaderSource:a}},Nh=i=>{if(!i||i.length!==2)throw new Error("Tile requires 2 input.");if(i[1].dims.length!==1)throw new Error("The second input shape must 1 dimension.");if(i[1].dims[0]!==i[0].dims.length)throw new Error("Invalid input shape.");if(ee.indexOf(i[0].type)===-1)throw new Error("Invalid input type.");if(i[1].type!=="int32"&&i[1].type!=="int16")throw new Error("Invalid repeat type.")}});var Lo,af,sf,Rh,Gh,uf=x(()=>{"use strict";U();Lo=(i,e,o)=>{Rh(e);let t=A.unsqueezeShape(e[0].dims,o);return[i.reshapeUnpacked(e[0],t)]},af=(i,e)=>(Gh(e),Lo(i,[e[0]],Array.from(e[1].integerData))),sf=i=>i.attributes.getInts("axes"),Rh=i=>{if(!i||i.length!==1)throw new Error("Unsqueeze requires 1 input.");if(i[0].type==="string")throw new Error("invalid input tensor types.")},Gh=i=>{if(!i||i.length!==2)throw new Error("Unsqueeze requires 2 inputs.");if(i[1].type!=="int32")throw new Error("Invalid input type.")}});var lf,ff=x(()=>{"use strict";xs();$s();Fs();Vs();Vr();_u();Du();ku();Cu();Mu();zu();ju();Zu();Ur();el();hl();vl();_l();Dl();$l();Nl();jl();Zl();tf();rf();of();Wr();ho();uf();Oo();lf=[["Abs","","6+",Us],["Acos","","7+",zs],["Add","","7+",Ts],["And","","7+",ws],["Asin","","7+",Ws],["Atan","","7+",Hs],["AveragePool","","7+",nl,ol],["BatchNormalization","","7+",ys,gs],["Cast","","6+",ks,Bs],["Ceil","","6+",Xs],["Clip","","6-10",co,qs],["Clip","","11+",js],["Concat","","4+",Rs,Ms],["Conv","","1+",To,wo],["ConvTranspose","","1+",vu,Iu],["Cos","","7+",Ks],["Div","","7+",vs],["Dropout","","7+",po],["DepthToSpace","","1+",Pu,Eu],["Equal","","7+",Is],["Elu","","6+",Js,Zs],["Exp","","6+",Ys],["Flatten","","1+",Lu,$u],["Floor","","6+",Qs],["FusedConv","com.microsoft","1+",To,wo],["Gather","","1+",Bu,Fu],["Gemm","","7-10",vo,Ru],["Gemm","","11+",vo,Gu],["GlobalAveragePool","","1+",al,sl],["GlobalMaxPool","","1+",pl],["Greater","","7+",_s],["Identity","","1+",po],["ImageScaler","","1+",Vu,Uu],["InstanceNormalization","","6+",Hu,qu],["LeakyRelu","","6+",tu,eu],["Less","","7+",Ss],["LRN","","1+",Xu,Ku],["Log","","6+",ru],["MatMul","","1+",mu,bu],["MaxPool","","1+",ul,ll],["Mul","","7+",Os],["Neg","","6+",nu],["Not","","1+",ou],["Or","","7+",As],["Pad","","2-10",Io,Yu],["Pad","","11+",Qu,tl],["Pow","","7+",Ps],["PRelu","","7+",Es],["ReduceLogSum","","1+",Tl,re],["ReduceMax","","1+",yl,re],["ReduceMean","","1+",bl,re],["ReduceMin","","1+",gl,re],["ReduceProd","","1+",xl,re],["ReduceSum","","1-12",ml,re],["ReduceSumSquare","","1+",wl,re],["Relu","","6+",iu],["Reshape","","5+",Il],["Resize","","10",Po,Pl],["Resize","","11+",Po,El],["Shape","","1+",Ll],["Sigmoid","","6+",au],["Sin","","7+",su],["Slice","","10+",Cl],["Slice","","1-9",kl,Bl],["Softmax","","1-12",Vl,Ul],["Softmax","","13+",Wl,zl],["Split","","2-12",Kl,Jl],["Sqrt","","6+",uu],["Squeeze","","1-12",Do,Ql],["Squeeze","","13+",Yl],["Sub","","7+",Ds],["Sum","","6+",ef],["Tan","","7+",lu],["Tanh","","6+",fu],["Tile","","6+",nf],["Transpose","","1+",ye,Ou],["Upsample","","7-8",_o,Ol],["Upsample","","9",_o,Al],["Unsqueeze","","1-12",Lo,sf],["Unsqueeze","","13+",af],["Xor","","7+",Ls]]});function pf(i){let e={},o;for(;(o=cf.exec(i))!==null;){let t=o[3].split(",").map(r=>{let n=r.trim().split(" ");return n&&n.length===2?{type:n[0],name:n[1]}:null}).filter(r=>r!==null);e[o[2]]={params:t,body:o[4]}}for(let t in e){let r=Mh.replace("__FUNC__",t),n=new RegExp(r,"gm");for(;(o=n.exec(i))!==null;){let s=o[1],a=o[2],u=o[3].split(","),l=s?`${s} ${a};`:"",f=e[t].body,c="";e[t].params.forEach((m,y)=>{m&&(c+=`${m.type} ${m.name} = ${u[y]};
`)}),f=`${c}
 ${f}`,f=f.replace("return",`${a} = `);let d=`
    ...
    `),t="packedUVfrom1D",o[t]=new O(`
      ...
      `),t="sampleTexture";let r=D(this.context.glContext.version);return o[t]=new O(`
        ...
        }`),o}getInputsSamplingSnippets(){let o={},t=this.context.outputTextureLayout;return this.context.programInfo.inputNames.forEach((r,n)=>{let s=this.context.inputTextureLayouts[n],a=Br(r);s.isPacked?o[a]=this.getPackedSamplerFromInput(a,r,s):o[a]=this.getUnpackedSamplerFromInput(a,r,s);let u=es(r);s.unpackedShape.length<=t.unpackedShape.length&&(s.isPacked?o[u]=this.getPackedSamplerAtOutputCoords(u,s,t,r):o[u]=this.getUnpackedSamplerAtOutputCoords(u,s,t,r))}),o}getPackedSamplerAtOutputCoords(o,t,r,n){let s=t.unpackedShape,a=r.unpackedShape,l=Br(n),f=s.length,c=a.length,d=ct.getBroadcastDims(s,a),m=pt(c),y=c-f,g,T=Rt();f===0?g="":c<2&&d.length>=1?g="coords = 0;":g=d.map(Tt=>`coords.${T[Tt+y]} = 0;`).join(`
`);let _="";c<2&&f>0?_="coords":_=s.map((Tt,dt)=>`coords.${T[dt+y]}`).join(", ");let w="return outputValue;",L=A.size(s)===1,Q=A.size(a)===1;if(f===1&&!L&&!Q)w=`
    ...
    `;return new O(Wt,["coordinates.getOutputCoords"])}getUnpackedSamplerAtOutputCoords(o,t,r,n){let s=[r.width,r.height],a=[t.width,t.height],u=t.unpackedShape.length,l=r.unpackedShape.length,f=t.unpackedShape,c=r.unpackedShape,d=Br(n);if(u===l&&fe.arraysEqual(a,s)){let L=`
        ...
        `;return new O(L,["coordinates.sampleTexture"])}let m=pt(l),y=ct.getBroadcastDims(f,c),g=l-u,T,_=Rt();u===0?T="":l<2&&y.length>=1?T="coords = 0;":T=y.map(L=>`coords.${_[L+g]} = 0;`).join(`
`);let w="";l<2&&u>0?w="coords":w=t.unpackedShape.map((L,B)=>`coords.${_[B+g]}`).join(", ");let v=`
    ...
    }`;return new O(l,["coordinates.packedUVfrom1D"])}getPackedSampler2D(o,t,r){let n=r.unpackedShape,s=[r.width,r.height],a=D(this.context.glContext.version),u=s[0],l=s[1];if(s!=null&&fe.arraysEqual(n,s)){let y=`vec4 ${o}(int row, int col) {
        vec2 uv = (vec2(col, row) + halfCR) / vec2(${l}.0, ${u}.0);
        return ${a.texture2D}(${t}, uv);
      }`;return new O(y)}let f=s,c=Math.ceil(n[1]/2),m=`vec4 ${o}(int row, int col) {
      vec2 uv = packedUVfrom2D(${f[1]}, ${f[0]}, ${c}, row, col);
      return ${a.texture2D}(${t}, uv);
    }`;return new O(m,["coordinates.packedUVfrom2D"])}getPackedSampler3D(o,t,r){let n=r.unpackedShape,s=[r.width,r.height],a=[s[0],s[1]],u=D(this.context.glContext.version);if(n[0]===1){let g=n.slice(1),T=[1,2],_=Ee(n,g),w=["b","row","col"],v=JSON.parse(JSON.stringify(r));v.unpackedShape=_;let L=this.getPackedSamplerFromInput(o,t,v),Q=`${L.routineBody}
      ...
      `;return new O(a,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler2D(o,t,r){let n=r.unpackedShape,s=[r.height,r.width];if(s!=null&&fe.arraysEqual(n,s)){let m=s[1],y=s[0],g=`
          float ${o}(int row, int col) {
            vec2 uv = (vec2(row, col) + halfCR) / vec2(${m}.0, ${y}.0);
            return sampleTexture(${t}, uv);
          }
        `;return new O(g,["coordinates.sampleTexture"])}let{newShape:a,keptDims:u}=Be(n),l=a;if(l.length<n.length){let m=Ee(n,l),y=JSON.parse(JSON.stringify(r));y.unpackedShape=m;let g=["col","row"],T=`
      ...
      `;return new O(d,["coordinates.uvFromFlat","coordinates.sampleTexture","coordinates.coordsToOffset"])}getUnpackedSampler3D(o,t,r){let n=r.unpackedShape,s=n[1]*n[2],a=n[2],{newShape:u,keptDims:l}=Be(n),f=u;if(f.length<n.length){let y=Ee(n,f),g=["batch","col","row"],T=JSON.parse(JSON.stringify(r));T.unpackedShape=y;let _=this.getUnpackedSamplerFromInput(o,t,T),w=l.reverse(),v=`
          ${_.routineBody}
      ...
      `;return new O(c,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler5D(o,t,r){let n=r.unpackedShape,s=n[4],a=n[3]*s,u=n[2]*a,l=n[1]*u,{newShape:f,keptDims:c}=Be(n);if(f.length<n.length){let g=Ee(n,f),T=["row","col","depth","depth2","depth3"],_=JSON.parse(JSON.stringify(r));_.unpackedShape=g;let w=`
    ...
    `;return{getVecItem:new O(r)}}}});var ko,Tf=x(()=>{"use strict";mf();bf();yf();gf();xf();ko={encoding:Jr,fragcolor:Zr,vec:Qr,shapeUtils:Yr,coordinates:Kr}});var tn,wf=x(()=>{"use strict";Xt();df();Tf();X();tn=class{constructor(e,o,t,r){this.libs={};this.glslLibRoutineDependencyGraph={};this.context=new Rr(e,o,t,r),Object.keys(ko).forEach(s=>{let a=new ko[s](this.context);this.libs[s]=a});let n=this.glslLibRoutineDependencyGraph;for(let s in this.libs){let u=this.libs[s].getFunctions();for(let l in u){let f=s+"."+l,c;n[f]?(c=n[f],c.routineBody=u[l].routineBody):(c=new er(f,u[l].routineBody),n[f]=c);let d=u[l].dependencies;if(d)for(let m=0;m<d.length;++m)if(n[d[m]])c.addDependency(n[d[m]]);else{let y=new er(d[m]);n[d[m]]=y,c.addDependency(y)}}}}preprocess(){let e=this.context.programInfo,o=e.shaderSource;return this.context.programInfo.hasMain||(o=`${o}
