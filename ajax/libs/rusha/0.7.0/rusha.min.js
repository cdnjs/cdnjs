...
var view=new Int32Array(self.heap,0,padlen(len)>>2);padZeroes(view,len);conv(str,view,len);padData(view,len);coreCall(view.length);return hex(new Int32Array(self.heap,0,5));};};function RushaCore(stdlib,foreign,heap){"use asm";var H=new stdlib.Int32Array(heap);function hash(k){k=k|0;var i=0,j=0,y0=0,z0=0,y1=0,z1=0,y2=0,z2=0,y3=0,z3=0,y4=0,z4=0,t0=0;y0=H[k+0<<2>>2]|0;y1=H[k+1<<2>>2]|0;y2=H[k+2<<2>>2]|0;y3=H[k+3<<2>>2]|0;y4=H[k+4<<2>>2]|0;for(i=0;(i|0)<(k|0);i=i+16|0){z0=y0;z1=y1;z2=y2;z3=y3;z4=y4;for(j=0;(j|0)<16;j=j+1|0){H[k+j<<2>>2]=H[i+j<<2>>2];t0=(((y0)<<5|(y0)>>>27)+(y1&y2|~y1&y3)|0)+((y4+(H[k+j<<2>>2]|0)|0)+1518500249|0)|0;y4=y3;y3=y2;y2=((y1)<<30|(y1)>>>2);y1=y0;y0=t0;}
