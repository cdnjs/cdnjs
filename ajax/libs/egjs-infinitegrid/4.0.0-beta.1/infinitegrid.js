    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      __proto._calculateColumnSize = function (items) {
        ...
        if (align === "stretch") {
          ...
          var inlineSize = checkedItem.inlineSize;
    ...
    function (_super) {
      ...
      __proto._requestVirtualItems = function () {
        ...
        var items = this.items;
        var visibleItemsWithVirtuals = this.getVisibleItems();
        var visibleItems = visibleItemsWithVirtuals.filter(function (item) {
        ...
        if (visibleLength) {
          ...
          var lastItem = visibleItemsWithVirtuals[visibleItemsWithVirtuals.length - 1];
    ...
    function (_super) {
      ...
      __proto._wait = function (direction, e) {
        this._isWait = true;

        this._checkStartLoading(direction, e);
      };

      __proto._ready = function () {
        this._isWait = false;
      };

      __proto._checkStartLoading = function (direction, e) {
        var groupManager = this.groupManager;
