...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function () {
      ...
      __proto.updateItemsWithEqualSize = function (items, totalItems) {
        ...
        if (this.options.isEqualSize || hasSizeGroup) {
          ...
          if (updatedItem) {
            this.updateItems(totalItems.filter(function (item) {
      ...
      __proto.updateItems = function (items, checkEqualSize) {
        var _this = this;

        items.forEach(function (item) {
          _this._updateItem(item, checkEqualSize);
        });
      };
      ...
      __proto._updateItem = function (item, checkEqualSize) {
        var _a = this.options,
        ...
        } else if (isEqualSize && !sizeGroup && initialRects[""]) {
          rect = initialRects[""];
        } else if (isConstantSize && hasOrgSize && !isLoading) {
          rect = orgRect;
        } else if (checkEqualSize || !element) {
          return;
        } else {
          rect = {
        ...
        if (!checkEqualSize) {
          ...
          if (!isLoading && !initialRects[sizeGroup]) {
    ...
    function (_super) {
      ...
      __proto._updateItems = function (items) {
        this.itemRenderer.updateItemsWithEqualSize(items, this.getItems());
      };
    ...
    */
    ...
    var GroupManager = /*#__PURE__*/function (_super) {
      ...
      __proto._updateItems = function (items) {
        this.itemRenderer.updateItemsWithEqualSize(items, this.groupItems);
      };
