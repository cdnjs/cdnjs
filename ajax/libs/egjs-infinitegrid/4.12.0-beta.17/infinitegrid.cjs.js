...
var Infinite = /*#__PURE__*/function (_super) {
   ...
   * @param scrollPos
   */
  __proto.getVisibleArea = function (scrollPos) {
    var prevStartCursor = this.startCursor;
    var prevEndCursor = this.endCursor;
    var items = this.items;
    var length = items.length;
   ...
   * @returns
   */
  __proto.getRenderedVisibleItems = function (scrollPos) {
    var items = this.getVisibleItems();
    if (!this.options.useRecycle && scrollPos != null) {
      var area = this.getVisibleArea(scrollPos);
      if (area.start > -1) {
...
var InfiniteGrid = /*#__PURE__*/function (_super) {
  ...
  function InfiniteGrid(wrapper, options) {
    ...
    _this._onRenderComplete = function (_a) {
      ...
      var prevRenderedGroups = infinite.getRenderedVisibleItems(_this.scrollManager.getScrollPos());
