...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function getExpectedItemInlineSize(item, rowSize) {
      ...
      var contentMargin = item.gridData.contentMargin || 0;
    ...
    function (_super) {
      ...
      __proto.applyGrid = function (items, direction, outline) {
        ...
        items.forEach(function (item) {
          ...
          var contentMargin = parseFloat(attributes.contentMargin);
          ...
          if (isNaN(contentMargin)) {
            contentMargin = _this.contentMargin || gridData.contentMargin | 0;
          }
      ...
      __proto._getStretchItemInfos = function (items, rowSize) {
        var gap = this.options.gap;
        var itemsLength = items.length;
        var containerInlineSize = this.getContainerInlineSize() - gap * (Math.max(1, itemsLength) - 1);
      ...
      __proto._setStyle = function (items, path, outline, isEndDirection) {
        ...
        groups.forEach(function (groupItems, rowIndex) {
          ...
          var allGap = gap * (groupItemslength - 1);
