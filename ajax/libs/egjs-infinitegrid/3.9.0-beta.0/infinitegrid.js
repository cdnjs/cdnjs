...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function (_super) {
       ...
       * @param {boolean} [options.useOffset=false] Whether to get the size as offsetWidth, offsetHeight. Set to true if scale is applied to the container. If false, get the size through getBoundingClientRect. <ko>사이즈를 offsetWidth, offsetHeight로 가져올지 여부.
      container에 scale이 적용되어 있다면  true로 설정해라. false면 getBoundingClientRect를 통해 사이즈를 가져온다.</ko>
      ...
      */
      ...
      InfiniteGrid.VERSION = "3.9.0-beta.0";
      return InfiniteGrid;
    }(Component);
