    ...
    */
    ...
    var Infinite = /*#__PURE__*/function (_super) {
      ...
      __proto.getVisibleArea = function (scrollPos, direction) {
        ...
        var pos = isDirectionEnd ? Math.min.apply(Math, visibleItem.startOutline) : Math.max.apply(Math, visibleItem.endOutline);
        var itemPart;
        if (isDirectionEnd) {
    ...
    var InfiniteGrid = /*#__PURE__*/function (_super) {
      ...
      function InfiniteGrid(wrapper, options) {
        ...
        _this._onRenderComplete = function (_a) {
          ...
          var prevVisibleArea = infinite.getVisibleArea(_this.scrollManager.getScrollPos(), direction);
          var isDirectionEnd = direction === DIRECTION.END;
          _this._syncInfinite();
          if (prevVisibleArea) {
            var nextPart = void 0;
            ...
            if (nextPart || nextItem) {
              ...
              if (nextPart) {
                ...
                nextPos = isDirectionEnd ? Math.min.apply(Math, nextItem.startOutline) : Math.max.apply(Math, nextItem.endOutline);
              }
              var offset = nextPos - prevVisibleArea.pos;
