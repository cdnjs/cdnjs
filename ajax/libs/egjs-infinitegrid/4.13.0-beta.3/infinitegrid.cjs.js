...
var FrameworkRenderer = /*#__PURE__*/function (_super) {
  __extends(FrameworkRenderer, _super);
  function FrameworkRenderer() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  var __proto = FrameworkRenderer.prototype;
  __proto.onUpdated = function () {
    var diffResult = this.diffResult;
    var removed = diffResult.removed,
      prevList = diffResult.prevList,
...
var modules = {
    ...
    Renderer: Renderer,
    FrameworkRenderer: FrameworkRenderer,
    IS_IOS: IS_IOS,
...
exports.FrameworkRenderer = FrameworkRenderer;
