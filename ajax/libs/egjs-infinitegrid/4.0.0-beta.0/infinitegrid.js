    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      __proto.applyGrid = function (items, direction, outline) {
        ...
        if (outlineLength === column) {
          ...
          var point_1 = outlineLength ? Math[nearestCalculationName].apply(Math, outline) : 0;
    ...
    function (_super) {
      ...
      __proto.readyItems = function (mounted, updated, options) {
        ...
        updated.forEach(function (item) {
          ...
          var inlineOffset = parseFloat(attributes.inlineOffset) || 0;
          var contentOffset = parseFloat(attributes.contentOffset) || 0;
    ...
    function (_super) {
      ...
      __proto._getVirtualGroups = function (direction, nextGroups) {
        ...
        virtualGroups = diff(virtualGroups, nextGroups, function (_a) {
          var groupKey = _a.groupKey;
          return groupKey;
    ...
    function (_super) {
      ...
      InfiniteGrid.propertyTypes = GRID_PROPERTY_TYPES;
