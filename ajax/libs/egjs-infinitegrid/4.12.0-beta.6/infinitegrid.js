    ...
    function (_super) {
        ...
        if (ratioSum) {
          ...
          if (this.stretch) {
            ...
            var minInlineSize = inlineSizes.reduce(function (prev, itemInlineSize, i) {
              return prev + parseStretchSize(itemInlineSize, items[i].gridData.minStretch || stretchRange_1[0]);
            }, 0);
            var maxInlineSize = inlineSizes.reduce(function (prev, itemInlineSize, i) {
              return prev + parseStretchSize(itemInlineSize, items[i].gridData.maxStretch || stretchRange_1[1]);
            }, 0); // for stretch
      ...
      __proto._getExpectedInlineSizes = function (items, rowSize) {
        ...
        return items.map(function (item) {
          var minInlineSize = stretch ? parseStretchSize(item.orgInlineSize, item.gridData.minStretch || stretchRange[0]) : -Infinity;
          var maxInlineSize = stretch ? parseStretchSize(item.orgInlineSize, item.gridData.maxStretch || stretchRange[1]) : Infinity;
          ...
          var ratio = itemInlineSize / rowSize;
          var maxRatio = maxInlineSize / rowSize;
          var minRatio = minInlineSize / rowSize;
          return {
            minSize: minInlineSize,
            maxSize: maxInlineSize,
            size: between(itemInlineSize, minInlineSize, maxInlineSize),
            ratio: between(ratio, minRatio, maxRatio),
      ...
      __proto._getStretchItemInfos = function (items, rowSize, isCon) {
        var gap = this.options.gap;
        var itemsLength = items.length;
      ...
      __proto._getCost = function (items, i, j, isEndDirection) {
        ...
        if (this.stretch) {
          ...
          if (!this.passUnstretchRow || (isEndDirection ? j !== items.length : i !== 0) || expectedInlineSize >= containerInlineSize) {
            var res = this._getStretchItemInfos(lineItems, rowSize, i === 0);
      ...
      __proto._setStyle = function (items, path, outline, isEndDirection) {
        ...
        groups.forEach(function (groupItems, rowIndex) {
          ...
          itemInfos.forEach(function (_a, i) {
            var item = _a.item,
                inlineSize = _a.inlineSize;
