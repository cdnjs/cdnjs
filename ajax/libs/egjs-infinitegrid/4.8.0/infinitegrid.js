    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      __proto.readyItems = function (mounted, updated, options) {
        ...
        var requestedUpdateItems = this._requestedUpdateItems;

        if (requestedUpdateItems.length) {
          this.updateItems(requestedUpdateItems);
          this._requestedUpdateItems = [];
        }
      };

      __proto._requestUpdateSize = function (item) {
        this._requestedUpdateItems.push(item);
      };
    ...
    function (_super) {
      ...
      __proto.applyGrid = function (items, direction, outline) {
        ...
        var _a = this.options,
            ...
            useResizeObserver = _a.useResizeObserver;
        ...
        var _loop_1 = function (i) {
          ...
          if (columnAttribute > 0 && columnCount > 1 || isStretch) {
            ...
            if (!useResizeObserver && item.cssInlineSize !== nextInlineSize) {
              this_1._requestUpdateSize(item);
            }
