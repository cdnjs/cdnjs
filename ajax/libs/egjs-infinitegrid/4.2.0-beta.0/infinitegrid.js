...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      /**
       * Returns the scroll position based on the container element corresponding to the scroll area.
       * @ko 스크롤 영역에 해당하는 컨테이너 엘리먼트 기준 스크롤 포지션을 반환한다.
       */


      __proto.getScrollPos = function () {
        return this.scrollManager.getScrollPos();
      };
      /**
       * Returns the scroll position based on the container element containing item elements.
       * @ko 아이템 엘리먼트들을 담긴 컨테이너 엘리먼트 기준 스크롤 포지션을 반환한다.
       */


      __proto.getRelativeScrollPos = function () {
        return this.scrollManager.getRelativeScrollPos();
      };
      /**
       * Scrolls to the corresponding position based on the container element corresponding to the scroll area.
       * @ko 스크롤 영역에 해당하는 컨테이너 엘리먼트 기준 해당 포지션으로 스크롤한다.
       */


      __proto.scrollTo = function (pos) {
        return this.scrollManager.scrollTo(pos);
      };
      /**
       * Scrolls by the corresponding position based on the container element corresponding to the scroll area.
       * @ko 아이템 엘리먼트들을 담긴 컨테이너 엘리먼트 기준 해당 스크롤 포지션만큼 이동한다.
       */


      __proto.scrollBy = function (pos) {
        return this.scrollManager.scrollBy(pos);
      };
      /**
