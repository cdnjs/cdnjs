...
var GroupManager = /*#__PURE__*/function (_super) {
  ...
  __proto.checkReady = function (options) {
    ...
    var updated = items.filter(function (item) {
      var _a;
      return ((_a = item.element) === null || _a === void 0 ? void 0 : _a.parentNode) && item.updateState !== Grid.UPDATE_STATE.UPDATED;
    });
    var mounted = items.filter(function (item) {
      var _a;
      return ((_a = item.element) === null || _a === void 0 ? void 0 : _a.parentNode) && item.mountState !== Grid.MOUNT_STATE.MOUNTED;
    });
    if (updated.length && updated.every(function (item) {
      return item.type != exports.ITEM_TYPE.NORMAL;
    })) {
      this._updateItems(updated);
      this.readyItems(mounted, updated, options);
    } else {
      _super.prototype.checkReady.call(this, options);
    }
  };
