    ...
    function (_super) {
      ...
      __proto._init = function () {
        ...
        this._watcher = new ResizeWatcher(container, {
          ...
          watchChangedRect: options.useResizeObserver ? this._names.inlineSize : false
    ...
    function () {
      function ResizeWatcher(container, options) {
        ...
        this._onResize = function () {
          ...
          var watchChangedRect = _this.options.watchChangedRect;
          var prevRect = _this.rect;

          _this.resize();

          var rect = _this.rect;
          var isWatchedWidth = watchChangedRect === "box" || watchChangedRect === "width";
          var isWatchedHeight = watchChangedRect === "box" || watchChangedRect === "height";
          var isResize = !watchChangedRect || isWatchedWidth && prevRect.width !== rect.width || isWatchedHeight && prevRect.height !== rect.height;
