    ...
    */
    ...
    var Infinite = /*#__PURE__*/function (_super) {
      ...
      __proto.getVisibleArea = function (scrollPos, direction) {
        ...
        var centerScrollPos = scrollPos + this.size / 2;
        ...
        var minDist = Math.abs(centerScrollPos - itemPos);
        var itemPart;
        visibleItems.forEach(function (item) {
          var _a;
          (_a = item.parts) === null || _a === void 0 ? void 0 : _a.forEach(function (part) {
            var centerPos = part.pos + part.size / 2;
            var nextMinDist = Math.abs(centerScrollPos - centerPos);
            if (minDist > nextMinDist) {
              visibleItem = item;
              itemPart = part;
              minDist = nextMinDist;
            }
        ...
        _this._onRenderComplete = function (_a) {
          ...
          if (prevVisibleArea) {
            ...
            if (nextPart || nextItem) {
              ...
              var nextPos = 0;
              if (nextPart) {
                nextPos = nextPart.pos + nextPart.size / 2;
                prevPos = prevPart.pos + prevPart.size / 2;
              } else {
