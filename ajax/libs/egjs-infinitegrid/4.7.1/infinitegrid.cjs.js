...
function (_super) {
  ...
  function InfiniteGrid(wrapper, options) {
    ...
    var _a = _this.options,
        ...
        gridOptions = __rest(_a, ["gridConstructor", "containerTag", "container", "renderer", "threshold", "useRecycle", "scrollContainer"]); // options.container === false, wrapper = container, scrollContainer = document.body
