...
declare class ComponentDataVariable extends Component {
	...
	getDataValue(): any;
	getInnerHTML(opts: ToHTMLOptions): any;
...
declare class DataVariableListenerManager {
	private dataListeners;
	private em;
	private model;
	private dataVariable;
	private updateValueFromDataVariable;
	constructor(options: DataVariableListenerManagerOptions);
	private onChange;
	listenToDataVariable(): void;
...
declare class StyleableModel<T extends ObjectHash = any> extends Model<T> {
	 ...
	 */
	manageDataVariableListener(dataVar: StyleDataVariable, styleProp: string): void;
