...
declare class ModelDataResolverWatchers {
	private model;
	private propertyWatcher;
	private attributeWatcher;
	private styleWatcher;
	constructor(model: StyleableModel | undefined, options: ModelResolverWatcherOptions);
	private onPropertyUpdate;
	private onAttributeUpdate;
	private onStyleUpdate;
	bindModel(model: StyleableModel): void;
	...
	getDynamicStylesDefs(): ObjectAny;
...
declare class StyleableModel<T extends ObjectHash = any> extends Model<T, UpdateStyleOptions> {
	em?: EditorModel;
	views: StyleableView[];
