...
function translate$(rule1, context, precedence, conditions, important) {
    ...
    if (typeof resolved == 'string') {
        ...
        return merge(translate(parse$1(resolved), context, precedence, conditions, rule1.i), rule1.n);
    }
...
function serialize$(style, { n: name , p: precedence , r: conditions = [] , i: important  }, context) {
    ...
    for(let key in style || {}){
        ...
        if (key[0] == '@') {
            ...
            // @apply ...;
            if (key[1] == 'a') {
                rules.push(...translateWith(name, precedence, parse$1('' + value1), context, precedence, conditions, important, true));
                continue;
            }
            // @layer <layer>
            if (key[1] == 'l') {
...
function colorFromTheme(options1 = {}, resolve) {
    return (match, context)=>{
        ...
        let properties1 = create(match, context);
...
function normalize(value) {
    ...
    value = value.replace(/(^|[^\\])_+/g, (fullMatch, characterBefore)=>characterBefore + ' '.repeat(fullMatch.length - characterBefore.length)
    ).replace(/\\_/g, '_');
 ...
 */ function consume(markup, tw$1 = tw) {
    ...
    parse(markup, (startIndex, endIndex, quote)=>{
        ...
        const token = (quote == `"` ? value.replace(/(=|\[)(?:&#39;|&apos;|&#x27;)|(?:&#39;|&apos;|&#x27;)(])/g, `$1'$2`) : quote == `'` ? value.replace(/(=|\[)(?:&#34;|&quot;|&#x22;)|(?:&#34;|&quot;|&#x22;)(])/g, `$1"$2`) : value).replace(/&amp;/g, '&');
...
export { animation, apply, arbitrary, asArray, auto, autoDarkColor, colorFromTheme, consume, css, cssom, cx, defineConfig, dom, escape, extract, fromTheme, getSheet, hash, identity, injectGlobal, inline, install, keyframes, mql, noop, observe, setup, shortcut, stringify, style, toCSS, toColorValue, tw, twind, tx, virtual };
