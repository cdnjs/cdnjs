...
function compareTwindRules(a, b) {
    ...
    return a.p - b.p || a.o - b.o || // XXX: should we compare the conditions as welll — already included in precedence
    // collator.compare(a.r as unknown as string, b.r as unknown as string) ||
    collator.compare(a.n, b.n);
}
...
function createResolve(patterns, resolve) {
    return createRegExpExecutor(patterns, (value, condition, context)=>exec(value, condition, resolve, context)
    );
}
