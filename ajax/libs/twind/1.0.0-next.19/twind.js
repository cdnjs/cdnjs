...
function stringify(target) {
    ...
    return (target.cssRules ? Array.from(target.cssRules, (rule)=>rule.cssText
    ) : asArray(target)).join('');
}
 ...
 */ function inject(markup, tw$1 = tw) {
...
export { arbitrary, asArray, auto, colorFromTheme, consume, css, cssom, cx, defineConfig, escape, extract, fromTheme, hash, inject, mql, observe, setup, shortcut, stringify, style, toColorValue, tw, twind, virtual };
