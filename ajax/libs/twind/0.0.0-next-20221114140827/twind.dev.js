 ...
 */ function twind(userConfig, sheet) {
    let config = defineConfig(userConfig), context = function({ theme , darkMode , darkColor , variants , rules , hash: hash$1 , stringify , ignorelist  }) {
        ...
        ruleResolvers = new Map(), ignored = createRegExpExecutor(ignorelist, (value, condition)=>condition.test(value)), reportedUnknownClasses = new Set();
        ...
        return {
            ...
            r (className, isDark) {
                ...
                if (!ruleCache.has(key)) {
                    ruleCache.set(key, !ignored(className, this) && find(className, rules, ruleResolvers, getRuleResolver, this, isDark));
                    {
...
//# sourceMappingURL=twind.dev.js.map
