  ...
  return function() {
    ...
    class TextDrawer {
      ...
      async init(container) {
        const options = container.actualOptions;
        if (validTypes.find((t => Utils_isInArray(t, options.particles.shape.type)))) {
      ...
      draw(context, particle, radius, opacity) {
        ...
        if (textParticle.text === undefined) {
          textParticle.text = textData instanceof Array ? Utils_itemFromArray(textData, particle.randomIndexData) : textData;
        }
