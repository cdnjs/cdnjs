...
async function loadFull(engine, refresh = true) {
  await (0,tsparticles_updater_destroy__WEBPACK_IMPORTED_MODULE_1__.loadDestroyUpdater)(engine, false);
  await (0,tsparticles_updater_roll__WEBPACK_IMPORTED_MODULE_4__.loadRollUpdater)(engine, false);
  await (0,tsparticles_updater_tilt__WEBPACK_IMPORTED_MODULE_6__.loadTiltUpdater)(engine, false);
  await (0,tsparticles_updater_twinkle__WEBPACK_IMPORTED_MODULE_7__.loadTwinkleUpdater)(engine, false);
  await (0,tsparticles_updater_wobble__WEBPACK_IMPORTED_MODULE_8__.loadWobbleUpdater)(engine, false);
  await (0,tsparticles_interaction_external_trail__WEBPACK_IMPORTED_MODULE_3__.loadExternalTrailInteraction)(engine, false);
  await (0,tsparticles_plugin_absorbers__WEBPACK_IMPORTED_MODULE_0__.loadAbsorbersPlugin)(engine, false);
  await (0,tsparticles_plugin_emitters__WEBPACK_IMPORTED_MODULE_2__.loadEmittersPlugin)(engine, false);
  await (0,tsparticles_slim__WEBPACK_IMPORTED_MODULE_5__.loadSlim)(engine, refresh);
}
})();
