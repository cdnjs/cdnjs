...
class Attractor extends ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      const options = Attractor_classPrivateFieldGet(this, _Attractor_container, "f").actualOptions,
...
class Bouncer extends ExternalInteractorBase {
  ...
  init() {
    const container = Bouncer_classPrivateFieldGet(this, _Bouncer_container, "f"),
...
class Bubbler extends ExternalInteractorBase {
  ...
  init() {
    const container = Bubbler_classPrivateFieldGet(this, _Bubbler_container, "f"),
...
class Grabber extends ExternalInteractorBase {
  ...
  init() {
    const container = Grabber_classPrivateFieldGet(this, _Grabber_container, "f"),
...
class Pusher extends ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      ...
      const container = Pusher_classPrivateFieldGet(this, _Pusher_container, "f"),
            options = container.actualOptions,
...
class Remover extends ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      const container = Remover_classPrivateFieldGet(this, _Remover_container, "f"),
            options = container.actualOptions;
...
class Repulser extends ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      const options = Repulser_classPrivateFieldGet(this, _Repulser_container, "f").actualOptions,
  ...
  init() {
    const container = Repulser_classPrivateFieldGet(this, _Repulser_container, "f"),
