(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return function() {
    ...
    __webpack_require__.d(__webpack_exports__, {
      loadWobbleUpdater: function() {
        return loadWobbleUpdater;
      }
    });
      ...
      init(particle) {
        ...
        if (wobbleOpt.enable) {
          particle.wobble = {
            ...
            speed: NumberUtils_getRangeValue(wobbleOpt.speed) / 360
          };
        } else {
          particle.wobble = {
            angle: 0,
        ...
        particle.retina.wobbleDistance = NumberUtils_getRangeValue(wobbleOpt.distance) * this.container.retina.pixelRatio;
      }
      isEnabled(particle) {
