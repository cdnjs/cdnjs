(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return function() {
    ...
    function updateColorValue(delta, value, valueAnimation, max, decrease) {
      ...
      const offset = NumberUtils_randomInRange(valueAnimation.offset);
    ...
    class ColorUpdater {
      ...
      init(particle) {
        const hslColor = ColorUtils_colorToHsl(particle.options.color, particle.id, particle.options.reduceDuplicates);
        if (hslColor) {
