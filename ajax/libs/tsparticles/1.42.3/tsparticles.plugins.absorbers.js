  ...
  return function() {
    ...
    class AbsorberInstance {
      ...
      attract(particle) {
        ...
        if (options.draggable) {
          ...
          if (mouse.clicking && mouse.downPosition) {
            const mouseDist = NumberUtils_getDistance(this.position, mouse.downPosition);
        ...
        const pos = particle.getPosition();
        const {dx: dx, dy: dy, distance: distance} = NumberUtils_getDistances(this.position, pos);
        const v = Vector_Vector.create(dx, dy);
      ...
      draw(context) {
        ...
        context.closePath();
        context.fillStyle = ColorUtils_getStyleFromRgb(this.color, this.opacity);
        context.fill();
      }
      calcPosition() {
        var _a, _b;
      ...
      updateParticlePosition(particle, v) {
        ...
        if (this.options.orbits) {
          if (particle.absorberOrbit === undefined) {
            ...
            particle.absorberOrbit.length = NumberUtils_getDistance(particle.getPosition(), this.position);
        ...
        if (mode === "absorber") {
          ...
          if (modeAbsorbers instanceof Array) {
            if (modeAbsorbers.length > 0) {
              absorbersModeOptions = Utils_itemFromArray(modeAbsorbers);
            }
          } else {
            absorbersModeOptions = modeAbsorbers;
          }
          const absorbersOptions = absorbersModeOptions !== null && absorbersModeOptions !== void 0 ? absorbersModeOptions : absorberOptions instanceof Array ? Utils_itemFromArray(absorberOptions) : absorberOptions;
    ...
    class AbsorbersPlugin {
      ...
      needsPlugin(options) {
        ...
        if (absorbers instanceof Array) {
          ...
          loadAbsorbers = true;
        } else if (((_c = (_b = (_a = options.interactivity) === null || _a === void 0 ? void 0 : _a.events) === null || _b === void 0 ? void 0 : _b.onClick) === null || _c === void 0 ? void 0 : _c.mode) && Utils_isInArray("absorber", options.interactivity.events.onClick.mode)) {
          loadAbsorbers = true;
        }
