/*! @sentry/tracing & @sentry/browser 6.17.8-beta.0 (07f9257) | https://github.com/getsentry/sentry-javascript */
var Sentry = (function (exports) {
    ...
    ***************************************************************************** */
        ...
        try {
            for (var lines_1 = __values(lines), lines_1_1 = lines_1.next(); !lines_1_1.done; lines_1_1 = lines_1.next()) {
                ...
                if ((parts = opera10Regex.exec(line))) {
                    ...
                    var _c = __read(extractSafariExtensionDetails(parts[1] || UNKNOWN_FUNCTION, parts[2]), 2), func = _c[0], filename = _c[1];
                    element = {
                        filename: filename,
                        function: func,
                    ...
                    _b = __read(extractSafariExtensionDetails(func, filename), 2), func = _b[0], filename = _b[1];
                    element = {
                        filename: filename,
                        function: func,
    ...
    var IdleTransaction = /** @class */ (function (_super) {
        ...
        IdleTransaction.prototype._cancelIdleTimeout = function () {
            if (this._idleTimeoutID) {
                global$7.clearTimeout(this._idleTimeoutID);
        ...
        IdleTransaction.prototype._startIdleTimeout = function (end) {
            ...
            this._idleTimeoutID = global$7.setTimeout(function () {
    ...
    function registerBackgroundTabDetection() {
        if (global$8 && global$8.document) {
            global$8.document.addEventListener('visibilitychange', function () {
                var activeTransaction = getActiveTransaction();
                if (global$8.document.hidden && activeTransaction) {
    ...
    var MetricsInstrumentation = /** @class */ (function () {
        function MetricsInstrumentation(_reportAllChanges) {
            ...
            if (!isNodeEnv() && global$9 && global$9.performance && global$9.document) {
                if (global$9.performance.mark) {
                    global$9.performance.mark('sentry-tracing-init');
                }
                this._trackCLS();
                this._trackLCP();
                this._trackFID();
        ...
        MetricsInstrumentation.prototype.addPerformanceEntries = function (transaction) {
            var _this = this;
            if (!global$9 || !global$9.performance || !global$9.performance.getEntries || !browserPerformanceTimeOrigin) {
            ...
            global$9.performance
                ...
                switch (entry.entryType) {
                    ...
                    case 'resource': {
                        var resourceName = entry.name.replace(global$9.location.origin, '');
        ...
        MetricsInstrumentation.prototype._trackNavigator = function (transaction) {
            var navigator = global$9.navigator;
            if (!navigator) {
                return;
            }
    ...
    function instrumentRoutingWithDefaults(customStartTransaction, startTransactionOnPageLoad, startTransactionOnLocationChange) {
        ...
        if (!global$a || !global$a.location) {
            logger.warn('Could not initialize routing instrumentation due to invalid location');
            return;
        }
        var startingUrl = global$a.location.href;
        var activeTransaction;
        if (startTransactionOnPageLoad) {
            activeTransaction = customStartTransaction({ name: global$a.location.pathname, op: 'pageload' });
        }
        if (startTransactionOnLocationChange) {
            addInstrumentationHandler('history', function (_a) {
                ...
                if (from !== to) {
                    ...
                    activeTransaction = customStartTransaction({ name: global$a.location.pathname, op: 'navigation' });
                }
            });
        }
    }
