/*! @sentry/tracing & @sentry/browser 6.18.1-beta.0 (8443996) | https://github.com/getsentry/sentry-javascript */
    ...
    var IdleTransaction = /** @class */ (function (_super) {
        ...
        IdleTransaction.prototype._cancelIdleTimeout = function () {
            if (this._idleTimeoutID) {
                global$4.clearTimeout(this._idleTimeoutID);
        ...
        IdleTransaction.prototype._startIdleTimeout = function (endTimestamp) {
            ...
            this._idleTimeoutID = global$4.setTimeout(function () {
