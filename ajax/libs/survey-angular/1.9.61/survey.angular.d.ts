/*
* Type definition for Survey JavaScript library for Angular v1.9.61
...
export declare class PopupSurveyNG {
...
export declare class SurveyWindowNG extends PopupSurveyNG {
}
/*
...
export declare class QuestionText extends QuestionTextModel {
  constructor(name: string);
  _implementor: QuestionTextImplementor;
  protected onBaseCreating(): void;
  dispose(): void;
}
