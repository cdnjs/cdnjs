/*Type definitions for Survey JavaScript library v1.8.27
...
export declare class AdaptiveActionBarItemWrapper implements IActionBarItem {
        ...
        showTitle: ko.Computed<any>;
        action(): void;
        readonly css: any;
        readonly innerCss: any;
        readonly data: any;
        readonly popupModel: any;
        readonly isActive: any;
        readonly needSeparator: any;
...
export { compareVersions, confirmAction, detectIEOrEdge, detectIEBrowser, loadFileFromBase64, isMobile, isElementVisible, findScrollableParent, };
