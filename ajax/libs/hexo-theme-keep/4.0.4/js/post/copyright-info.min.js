function initCopyrightInfoHelper(){KEEP.utils.copyrightInfoHelper={initSetPostLink(){const e=document.querySelector(".copyright-info-content .post-link");e&&(e.innerHTML=decodeURI(window.location.href))},copyCopyrightInfo(){const t=document.querySelector(".copyright-info-content");if(t){const r=document.querySelector(".copy-copyright-info"),p=r.querySelector("i"),n=KEEP.language_copy_copyright,i="en"===KEEP.hexo_config?.language?": ":"：";let c=!1;const l=(e,o,t,n)=>{p&&(p.classList.remove(e),p.classList.add(o));const i=r.querySelector(".tooltip-content");i&&(i.innerHTML=t),c=n};r.addEventListener("click",()=>{var e,o;c||(o=t.querySelector(".post-author .content").innerHTML,e=t.querySelector(".post-link").innerHTML,o=""+n.author+i+o+`
