...
import { defined, distanceBetweenPoints, callback, isFinite, valueOrDefault, isObject, toFont, isArray, addRoundedRectPath, toTRBLCorners, toPadding, PI, toRadians, color, drawPoint, RAD_PER_DEG, clipArea, unclipArea } from 'chart.js/helpers';
