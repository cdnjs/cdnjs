...
import { distanceBetweenPoints, callback, isFinite as isFinite$1, toFontString, toRadians, isArray, isObject, merge, valueOrDefault, clipArea, unclipArea } from 'chart.js/helpers';
...
function updateElements(chart, state, options, mode) {
  ...
  for (let i = 0; i < annotations.length; i++) {
    ...
    const display = typeof annotation.display === 'function' ? callback(annotation.display, [{chart, element: el}]) : valueOrDefault(annotation.display, true);
    el._display = !!display;
...
export { annotation as Annotation, BoxAnnotation, EllipseAnnotation, LineAnnotation, PointAnnotation };
