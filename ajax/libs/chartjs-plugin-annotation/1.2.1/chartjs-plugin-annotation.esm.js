...
import { distanceBetweenPoints, callback, defined, isObject, valueOrDefault, toFont, isArray, drawPoint as drawPoint$1, addRoundedRectPath, toTRBLCorners, isFinite, toPadding, toRadians, color, isNumber, RAD_PER_DEG, PI as PI$1, clipArea, unclipArea } from 'chart.js/helpers';
...
function drawPoint(ctx, point, options) {
  ...
  drawPoint$1(ctx, options, point.x, point.y);
  ctx.restore();
}
