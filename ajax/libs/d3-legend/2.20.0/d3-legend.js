...
},{"./legend":13,"d3-dispatch":4,"d3-format":5,"d3-scale":7}],12:[function(require,module,exports){
'use strict';
...
function symbol() {
  ...
  function legend(svg) {
    ...
    _legend2.default.d3_addText(svg, cellEnter, type.labels, classPrefix, labelWidth);
