...
;(function() {
  ...
  SVG.ViewBox = function(element) {
    var x, y
      , width   = new SVG.Number(element.attr('width'))
      , height  = new SVG.Number(element.attr('height'))
      , bbox    = element.bbox()
      , rbox    = element.rbox()
    ...
    /* get size */
    this.width  = element.node.clientWidth  || width.unit  != '%' ? width.value  : rbox.width
    this.height = element.node.clientHeight || height.unit != '%' ? height.value : rbox.height
