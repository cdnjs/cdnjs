    ...
    var GlamorousComponent = function (_Component) {
      ...
      createClass(GlamorousComponent, [{
        ...
        value: function render() {
          ...
          var mappedArgs = GlamorousComponent.styles.slice();
          ...
          var fullClassName = (glamorlessClassName + ' ' + glamorClassName).trim();
...
function splitProps(_ref4, _ref5) {
  ...
  var _ref4$css = _ref4.css,
      ...
      rest = objectWithoutProperties(_ref4, ['css', 'className', 'innerRef']);
