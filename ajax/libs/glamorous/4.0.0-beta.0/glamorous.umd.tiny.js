...
function getGlamorClassName$1(_ref) {
  ...
  var _handleStyles = handleStyles([].concat(toConsumableArray(styles), [parentGlamorStyles, cssOverrides, cssProp]), props, context),
  ...
  */
  function glamorous(comp) {
    ...
    function glamorousComponentFactory() {
      ...
      }), { withComponent: withComponent, isGlamorousComponent: true, previous: null });
