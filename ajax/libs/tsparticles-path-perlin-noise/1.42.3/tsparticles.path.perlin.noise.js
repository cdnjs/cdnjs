...
__webpack_require__.d(__webpack_exports__, {
  "loadPerlinNoisePath": function() { return /* binding */ loadPerlinNoisePath; },
  "perlinNoisePathName": function() { return /* binding */ perlinNoisePathName; }
});
...
;// CONCATENATED MODULE: ./dist/Grad.js
class Grad {
  constructor(x, y, z) {
    this.x = x;
    this.y = y;
...
;// CONCATENATED MODULE: ./dist/PerlinNoise.js
...
;// CONCATENATED MODULE: ./dist/PerlinNoiseGenerator.js
...
class PerlinNoiseGenerator {
  ...
  generate(p) {
    ...
    const v = external_commonjs_tsparticles_commonjs2_tsparticles_amd_tsparticles_root_window_.Vector.origin;
  ...
  reset(container) {
    ...
    this.noiseGen.seed((_a = sourceOptions.seed) !== null && _a !== void 0 ? _a : Math.random());
