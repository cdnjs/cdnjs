...
const Grad_1 = __webpack_require__(920);

const grad3 = [new Grad_1.Grad(1, 1, 0), new Grad_1.Grad(-1, 1, 0), new Grad_1.Grad(1, -1, 0), new Grad_1.Grad(-1, -1, 0), new Grad_1.Grad(1, 0, 1), new Grad_1.Grad(-1, 0, 1), new Grad_1.Grad(1, 0, -1), new Grad_1.Grad(-1, 0, -1), new Grad_1.Grad(0, 1, 1), new Grad_1.Grad(0, -1, 1), new Grad_1.Grad(0, 1, -1), new Grad_1.Grad(0, -1, -1)];
...
const PerlinNoise_1 = __webpack_require__(126);
...
const PerlinNoiseGenerator_1 = __webpack_require__(170);
