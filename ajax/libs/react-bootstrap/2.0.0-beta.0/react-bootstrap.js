...
function ThemeProvider({
  ...
  const copiedPrefixes = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(() => ({ ...prefixes
  }), [prefixes]);
...
const SafeAnchor = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'a',
  disabled,
  onKeyDown,
...
const Button = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  ...
  const classes = classnames_default()(className, prefix, active && 'active', variant && `${prefix}-${variant}`, size && `${prefix}-${size}`);

  if (props.href) {
    return /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(src_SafeAnchor, { ...props,
      as: as,
      ref: ref,
  ...
  return /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(Component, {
    ...
    children: [indicators && /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)("div", {
      ...
      children: [(wrap || activeIndex !== 0) && /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(src_SafeAnchor, {
        ...
        lineNumber: 597,
        columnNumber: 15
      }, undefined), (wrap || activeIndex !== numChildren - 1) && /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(src_SafeAnchor, {
...
const DropdownItem = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled,
  ...
  return (
    ...
    // @ts-ignore
    (0,jsx_dev_runtime.jsxDEV)(Component, { ...props,
      ref: ref,
      href: href,
      disabled: disabled,
...
const Image = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  bsPrefix,
  className,
  fluid,
  rounded,
...
const AbstractNav = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = 'ul',
  onSelect,
  activeKey,
...
const AbstractNavItem = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  active,
  className,
  eventKey,
  onSelect,
...
const Modal_Modal = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  ...
  const removeStaticModalAnimationRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null); // TODO: what's this type
...
const NavLink = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  ...
  return /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(src_AbstractNavItem, { ...props,
    ref: ref,
    as: as,
    disabled: disabled,
...
const Nav = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef((uncontrolledProps, ref) => {
  const {
    as = 'div',
    bsPrefix: initialBsPrefix,
    variant,
...
const Offcanvas = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  ...
  esm_useRootClose(dialogElement, handleHide, {
    disabled: backdrop
  });
  const modalContext = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(() => ({
    onHide: handleHide
  ...
  function getModalManager() {
    if (propsManager) return propsManager;
    if (!modalManager.current) modalManager.current = new esm_ModalManager({
  ...
  const renderBackdrop = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useCallback)(backdropProps => /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)("div", { ...backdropProps,
    className: classnames_default()(`${modalBsPrefix}-backdrop`, backdropClassName)
  }, void 0, false, {
    fileName: Offcanvas_jsxFileName,
    lineNumber: 262,
    columnNumber: 11
  }, undefined), [backdropClassName, modalBsPrefix]);
...
const Overlay_Overlay = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef(({
  ...
  return /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(esm_Overlay, { ...outerProps,
    ...
    children: ({
      ...
      return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.cloneElement(overlay, { ...props,
        ...overlayProps,
        placement,
        arrowProps,
        popper,
...
const TabPane = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef((props, ref) => {
  const {
    bsPrefix,
    className,
    active,
  ...
  let pane = /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(Component, { ...rest,
    ref: ref,
    role: "tabpanel",
    "aria-hidden": !active,
    className: classnames_default()(className, prefix, {
  ...
  if (Transition) pane = /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(Transition, {
    ...
    lineNumber: 167,
    columnNumber: 9
  }, undefined); // We provide an empty the TabContext so `<Nav>`s in `<TabPane>`s don't
...
function renderTab(child) {
  ...
  return /*#__PURE__*/(0,jsx_dev_runtime.jsxDEV)(NavItem, {
    as: "li",
    role: "presentation",
