...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  if ($configHeaders_handleComplete_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$config$values$$["experimental-request-headers"]) {
...
function $spf$nav$navigate_$$($url$$76$$, $options$$13_xhr$$inline_156$$, $info$$3$$) {
  ...
  if ($spf$nav$isNavigable_$$($url$$76$$, $info$$3$$.current)) {
    if ($spf$nav$dispatchRequest_$$($url$$76$$, $info$$3$$.$referer$, $info$$3$$.current, $options$$13_xhr$$inline_156$$)) {
      ...
      $info$$3$$.type = "navigate", $info$$3$$.history && ($info$$3$$.type += $info$$3$$.reverse ? "-back" : "-forward"), $options$$13_xhr$$inline_156$$ = $spf$nav$request$send$$($url$$76$$, {method:$options$$13_xhr$$inline_156$$.method, headers:$options$$13_xhr$$inline_156$$.experimental_headers, $onPart$:$handlePart$$inline_154_opt_skipKey$$inline_139_promoteKey$$inline_148$$, $onError$:$absoluteUrl$$2_handleError$$inline_153_prefetchXhr_preprocessKey$$inline_147$$, $onSuccess$:$handleSuccess$$inline_155_key$$inline_142$$, 
...
function $spf$nav$load_$$($url$$86$$, $options$$21$$, $info$$10$$) {
  ...
  if ($spf$nav$dispatchRequest_$$($url$$86$$, void 0, void 0, $options$$21$$, !0)) {
    ...
    $info$$10$$.type = "load";
    $spf$nav$request$send$$($url$$86$$, {method:$options$$21$$.method, headers:$options$$21$$.experimental_headers, $onPart$:$handlePart$$1$$, $onError$:$handleError$$4$$, $onSuccess$:$handleSuccess$$1$$, $postData$:$options$$21$$.postData, type:$info$$10$$.type});
  }
}
...
function $spf$nav$prefetch_$$($absoluteUrl$$inline_174_url$$88$$, $options$$23_xhr$$inline_173$$, $info$$12$$) {
  ...
  if ($spf$nav$dispatchRequest_$$($absoluteUrl$$inline_174_url$$88$$, void 0, void 0, $options$$23_xhr$$inline_173$$, !0)) {
    ...
    $options$$23_xhr$$inline_173$$ = $spf$nav$request$send$$($absoluteUrl$$inline_174_url$$88$$, {method:$options$$23_xhr$$inline_173$$.method, headers:$options$$23_xhr$$inline_173$$.experimental_headers, $onPart$:$handlePart$$2$$, $onError$:$handleError$$5$$, $onSuccess$:$handleSuccess$$2$$, $postData$:$options$$23_xhr$$inline_173$$.postData, type:$info$$12$$.type, current:$info$$12$$.current});
