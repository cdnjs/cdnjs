...
function $spf$string$partition$$($str$$12$$, $sep$$) {
  var $arr$$19$$ = $str$$12$$.split($sep$$), $nosep$$ = 1 == $arr$$19$$.length;
  return[$arr$$19$$[0], $nosep$$ ? "" : $sep$$, $nosep$$ ? "" : $arr$$19$$.slice(1).join($sep$$)];
}
...
function $spf$url$removeParameters$$($url$$18$$, $parameters$$1$$) {
  var $result$$2$$ = $spf$string$partition$$($url$$18$$, "#");
  $url$$18$$ = $result$$2$$[0];
  ...
  return $url$$18$$ + $result$$2$$[1] + $result$$2$$[2];
}
function $spf$url$appendPersistentParameters$$($url$$19$$) {
  var $parameterConfig$$ = $spf$config$values$$["advanced-persistent-parameters"] || "", $result$$3$$ = $spf$string$partition$$($url$$19$$, "#");
  $url$$19$$ = $result$$3$$[0];
  var $delim$$2$$ = -1 != $url$$19$$.indexOf("?") ? "&" : "?";
  return $url$$19$$ + ($parameterConfig$$ ? $delim$$2$$ + $parameterConfig$$ : "") + $result$$3$$[1] + $result$$3$$[2];
}
...
function $spf$nav$response$extract_$$($html$$) {
  ...
  $html$$ = $html$$.replace($spf$nav$response$ElementRegEx$SCRIPT_STYLE$$, function($full_name$$76$$, $tag$$1_url$$55$$, $async_attr$$, $text$$17$$) {
    return "script" == $tag$$1_url$$55$$ ? ($full_name$$76$$ = ($full_name$$76$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$NAME$$)) ? $full_name$$76$$[1] : "", $tag$$1_url$$55$$ = ($tag$$1_url$$55$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$SRC$$)) ? $tag$$1_url$$55$$[1] : "", $async_attr$$ = $spf$nav$response$AttributeRegEx$ASYNC$$.test($async_attr$$), $result$$4$$.scripts.push({url:$tag$$1_url$$55$$, text:$text$$17$$, name:$full_name$$76$$, async:$async_attr$$}), "") : 
    "style" == $tag$$1_url$$55$$ ? ($full_name$$76$$ = ($full_name$$76$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$NAME$$)) ? $full_name$$76$$[1] : "", $result$$4$$.$styles$.push({url:"", text:$text$$17$$, name:$full_name$$76$$}), "") : $full_name$$76$$;
  });
  $html$$ = $html$$.replace($spf$nav$response$ElementRegEx$LINK$$, function($full$$1$$, $attr$$1$$) {
    ...
    if ("stylesheet" == $name$$77_rel$$) {
      ...
      $result$$4$$.$styles$.push({url:$url$$56$$, text:"", name:$name$$77_rel$$});
      return "";
    }
    return "spf-preconnect" == $name$$77_rel$$ && $spf$config$values$$["experimental-preconnect"] ? ($url$$56$$ = ($url$$56$$ = $attr$$1$$.match($spf$nav$response$AttributeRegEx$HREF$$)) ? $url$$56$$[1] : "", $result$$4$$.links.push({url:$url$$56$$, rel:$name$$77_rel$$}), "") : $full$$1$$;
  });
  $result$$4$$.$html$ = $html$$;
  return $result$$4$$;
}
...
function $spf$nav$request$send$$($url$$60$$, $opt_options$$17$$) {
  ...
  var $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = $url$$60$$, $ident$$inline_102_requestUrl$$ = $spf$config$values$$["url-identifier"] || "";
  if ($ident$$inline_102_requestUrl$$) {
    var $ident$$inline_102_requestUrl$$ = $ident$$inline_102_requestUrl$$.replace("__type__", $options$$4$$.type || ""), $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ = $spf$string$partition$$($handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, "#"), $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = $spf$string$partition$$($cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$[0], 
    "?"), $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$[0], $cached_headers_keys$$inline_114_querySep$$inline_106$$ = $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$[1], $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$[2], 
    $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$ = $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$[1], $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ = $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$[2];
    if (0 == $ident$$inline_102_requestUrl$$.lastIndexOf("?", 0)) {
      $cached_headers_keys$$inline_114_querySep$$inline_106$$ && ($ident$$inline_102_requestUrl$$ = $ident$$inline_102_requestUrl$$.replace("?", "&")), $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ += $ident$$inline_102_requestUrl$$;
    } else {
      if (0 == $ident$$inline_102_requestUrl$$.lastIndexOf(".", 0)) {
        if ($spf$string$endsWith$$($handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, "/")) {
          $ident$$inline_102_requestUrl$$ = "index" + $ident$$inline_102_requestUrl$$;
        } else {
          var $ext$$inline_110_storage$$inline_192_unit$$inline_193$$ = $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.lastIndexOf(".");
          -1 < $ext$$inline_110_storage$$inline_192_unit$$inline_193$$ && ($handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.substring(0, $ext$$inline_110_storage$$inline_192_unit$$inline_193$$));
        }
      } else {
        $spf$string$endsWith$$($handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, "/") && 0 == $ident$$inline_102_requestUrl$$.lastIndexOf("/", 0) && ($ident$$inline_102_requestUrl$$ = $ident$$inline_102_requestUrl$$.substring(1));
      }
      $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ += $ident$$inline_102_requestUrl$$;
    }
    $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ + $cached_headers_keys$$inline_114_querySep$$inline_106$$ + $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ + $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$ + $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$;
  }
  $ident$$inline_102_requestUrl$$ = $spf$url$absolute$$($handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$);
  $spf$debug$debug$$("    request url ", $ident$$inline_102_requestUrl$$);
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = {};
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.spfUrl = $ident$$inline_102_requestUrl$$;
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.startTime = $spf$now$$();
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.fetchStart = $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.startTime;
  a: {
    $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = $spf$nav$request$getCacheKey_$$($url$$60$$, $options$$4$$.current, null, $options$$4$$.type, !1);
    $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$ = $options$$4$$.current;
    $cached_headers_keys$$inline_114_querySep$$inline_106$$ = [];
    $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$ && ($cached_headers_keys$$inline_114_querySep$$inline_106$$.push($cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ + " previous " + $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$), $cached_headers_keys$$inline_114_querySep$$inline_106$$.push($cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ + " previous " + $spf$url$utils$$($hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$).pathname));
    $cached_headers_keys$$inline_114_querySep$$inline_106$$.push($cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$);
    $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = 0;
    for ($hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$ = $cached_headers_keys$$inline_114_querySep$$inline_106$$.length;$cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ < $hashSep$$inline_108_l$$inline_116_opt_current$$inline_113$$;$cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$++) {
      b: {
        $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ = $cached_headers_keys$$inline_114_querySep$$inline_106$$[$cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$];
        $ext$$inline_110_storage$$inline_192_unit$$inline_193$$ = $spf$cache$storage_$$();
        if ($cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ in $ext$$inline_110_storage$$inline_192_unit$$inline_193$$) {
          $ext$$inline_110_storage$$inline_192_unit$$inline_193$$ = $ext$$inline_110_storage$$inline_192_unit$$inline_193$$[$cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$];
          if ($spf$cache$valid_$$($ext$$inline_110_storage$$inline_192_unit$$inline_193$$)) {
            $spf$cache$updateCount_$$($ext$$inline_110_storage$$inline_192_unit$$inline_193$$);
            $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ = $ext$$inline_110_storage$$inline_192_unit$$inline_193$$.data;
            break b;
          }
          $spf$cache$remove$$($cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$);
        }
        $cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$ = void 0;
      }
      if ($cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$) {
        $cached_headers_keys$$inline_114_querySep$$inline_106$$ = {key:$cached_headers_keys$$inline_114_querySep$$inline_106$$[$cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$], response:$cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$.response, type:$cached$$inline_117_hashParts$$inline_103_hashVal$$inline_109_key$$inline_191$$.type};
        break a;
      }
    }
    $cached_headers_keys$$inline_114_querySep$$inline_106$$ = null;
  }
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.spfPrefetched = !!$cached_headers_keys$$inline_114_querySep$$inline_106$$ && "prefetch" == $cached_headers_keys$$inline_114_querySep$$inline_106$$.type;
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$.spfCached = !!$cached_headers_keys$$inline_114_querySep$$inline_106$$;
  if ($cached_headers_keys$$inline_114_querySep$$inline_106$$) {
    return setTimeout($spf$bind$$($spf$nav$request$handleResponseFromCache_$$, null, $url$$60$$, $options$$4$$, $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, $cached_headers_keys$$inline_114_querySep$$inline_106$$.key, $cached_headers_keys$$inline_114_querySep$$inline_106$$.response), 0), null;
  }
  $spf$debug$debug$$("    sending XHR");
  $cached_headers_keys$$inline_114_querySep$$inline_106$$ = {};
  void 0 != $options$$4$$.$referer$ && ($cached_headers_keys$$inline_114_querySep$$inline_106$$["X-SPF-Referer"] = $options$$4$$.$referer$);
  $options$$4$$.current && ($cached_headers_keys$$inline_114_querySep$$inline_106$$["X-SPF-Previous"] = $options$$4$$.current);
  if ($cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = $spf$config$values$$["advanced-header-identifier"]) {
    $cached_headers_keys$$inline_114_querySep$$inline_106$$["X-SPF-Request"] = $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$.replace("__type__", $options$$4$$.type), $cached_headers_keys$$inline_114_querySep$$inline_106$$.Accept = "application/json";
  }
  $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$ = {$multipart$:!1, $extra$:"", complete:[]};
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = $spf$bind$$($spf$nav$request$handleCompleteFromXHR_$$, null, $url$$60$$, $options$$4$$, $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$);
  $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$ = {headers:$cached_headers_keys$$inline_114_querySep$$inline_106$$, $timeoutMs$:$spf$config$values$$["request-timeout"], $onHeaders$:$spf$bind$$($spf$nav$request$handleHeadersFromXHR_$$, null, $url$$60$$, $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$), $onChunk$:$spf$bind$$($spf$nav$request$handleChunkFromXHR_$$, null, $url$$60$$, $options$$4$$, $cacheKey$$inline_112_chunking_headerId_i$$inline_115_queryParts$$inline_104_queryVal$$inline_107$$), 
  $onDone$:$handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$, $onTimeout$:$handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$};
  return "POST" == $options$$4$$.method ? $spf$net$xhr$send$$("POST", $ident$$inline_102_requestUrl$$, $options$$4$$.$postData$, $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$) : $spf$net$xhr$send$$("GET", $ident$$inline_102_requestUrl$$, null, $handleComplete_path$$inline_105_timing$$6_url$$inline_100_xhrOpts$$);
}
...
function $spf$nav$request$done_$$($url$$65$$, $options$$8$$, $timing$$9$$, $response$$6$$, $cache_cacheKey$$2$$) {
  ...
  if ($cache_cacheKey$$2$$ && "POST" != $options$$8$$.method && ($cache_cacheKey$$2$$ = $spf$nav$request$getCacheKey_$$($url$$65$$, $options$$8$$.current, $response$$6$$.cacheType, $options$$8$$.type, !0))) {
    ...
    var $data$$inline_196_unit$$inline_200$$ = {response:$response$$6$$, type:$options$$8$$.type || ""}, $lifetime$$inline_197$$ = parseInt($spf$config$values$$["cache-lifetime"], 10), $JSCompiler_temp_const$$inline_199_max$$inline_198$$ = parseInt($spf$config$values$$["cache-max"], 10);
    0 >= $lifetime$$inline_197$$ || 0 >= $JSCompiler_temp_const$$inline_199_max$$inline_198$$ || ($JSCompiler_temp_const$$inline_199_max$$inline_198$$ = $spf$cache$storage_$$(), $data$$inline_196_unit$$inline_200$$ = {data:$data$$inline_196_unit$$inline_200$$, life:$lifetime$$inline_197$$, time:$spf$now$$(), count:0}, $spf$cache$updateCount_$$($data$$inline_196_unit$$inline_200$$), $JSCompiler_temp_const$$inline_199_max$$inline_198$$[$cache_cacheKey$$2$$] = $data$$inline_196_unit$$inline_200$$, setTimeout($spf$cache$collect$$, 
    1E3));
  }
...
function $spf$nav$navigate_$$($url$$74$$, $opt_options$$19_options$$9_xhr$$inline_148$$, $current$$4_history$$inline_135_opt_current$$3$$, $opt_referer_referer$$1$$, $history$$inline_143_opt_history_promoteKey$$inline_137$$, $handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$) {
  $spf$debug$info$$("nav.navigate_ ", $url$$74$$, $opt_options$$19_options$$9_xhr$$inline_148$$, $current$$4_history$$inline_135_opt_current$$3$$, $opt_referer_referer$$1$$, $history$$inline_143_opt_history_promoteKey$$inline_137$$, $handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$);
  $spf$nav$cancel$$();
  $opt_options$$19_options$$9_xhr$$inline_148$$ = $opt_options$$19_options$$9_xhr$$inline_148$$ || {};
  $opt_referer_referer$$1$$ = void 0 == $opt_referer_referer$$1$$ ? window.location.href : $opt_referer_referer$$1$$;
  $current$$4_history$$inline_135_opt_current$$3$$ = $history$$inline_143_opt_history_promoteKey$$inline_137$$ ? $current$$4_history$$inline_135_opt_current$$3$$ : window.location.href;
  var $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$;
  a: {
    if (-1 != $url$$74$$.indexOf("#") && ($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$ = $spf$url$absolute$$($url$$74$$), $spf$string$partition$$($current$$4_history$$inline_135_opt_current$$3$$ || window.location.href, "#")[0] == $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$)) {
      $spf$debug$debug$$("    not handling hash-only URL");
      $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$ = !1;
      break a;
    }
    $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$ = !0;
  }
  if ($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$) {
    if ($spf$nav$dispatchRequest_$$($url$$74$$, $opt_referer_referer$$1$$, $current$$4_history$$inline_135_opt_current$$3$$, $opt_options$$19_options$$9_xhr$$inline_148$$)) {
      $spf$state$set$$("nav-counter", (parseInt($spf$state$values_$$["nav-counter"], 10) || 0) + 1);
      $spf$nav$cancelAllPrefetchesExcept$$($url$$74$$);
      $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$ = $spf$url$absolute$$($url$$74$$);
      var $handleSuccess$$inline_147_opt_skipKey$$inline_127$$ = "preprocess " + $spf$url$absolute$$($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$), $key$$inline_130_prefetchXhr_reverse$$inline_144$$;
      for ($key$$inline_130_prefetchXhr_reverse$$inline_144$$ in $spf$tasks$queues_$$) {
        $handleSuccess$$inline_147_opt_skipKey$$inline_127$$ != $key$$inline_130_prefetchXhr_reverse$$inline_144$$ && 0 == $key$$inline_130_prefetchXhr_reverse$$inline_144$$.lastIndexOf("preprocess", 0) && $spf$tasks$cancel$$($key$$inline_130_prefetchXhr_reverse$$inline_144$$);
      }
      $key$$inline_130_prefetchXhr_reverse$$inline_144$$ = $spf$nav$prefetches_$$()[$JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$];
      $spf$state$set$$("nav-request", $key$$inline_130_prefetchXhr_reverse$$inline_144$$);
      $spf$state$set$$("nav-promote", null);
      $spf$state$set$$("nav-promote-time", null);
      $key$$inline_130_prefetchXhr_reverse$$inline_144$$ && 4 != $key$$inline_130_prefetchXhr_reverse$$inline_144$$.readyState ? ($current$$4_history$$inline_135_opt_current$$3$$ = !!$history$$inline_143_opt_history_promoteKey$$inline_137$$, $spf$debug$debug$$("nav.navigatePromotePrefetch_ ", $url$$74$$), $handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$ = "preprocess " + $spf$url$absolute$$($url$$74$$), $history$$inline_143_opt_history_promoteKey$$inline_137$$ = "promote " + $spf$url$absolute$$($url$$74$$), 
      $spf$state$set$$("nav-promote", $url$$74$$), $spf$state$set$$("nav-promote-time", $spf$now$$()), $spf$tasks$cancel$$($handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$), $spf$tasks$run$$($history$$inline_143_opt_history_promoteKey$$inline_137$$, !0), $current$$4_history$$inline_135_opt_current$$3$$ || $spf$nav$navigateAddHistory_$$($url$$74$$, $opt_referer_referer$$1$$, $spf$bind$$($spf$nav$handleNavigateError_$$, null, $opt_options$$19_options$$9_xhr$$inline_148$$))) : ($history$$inline_143_opt_history_promoteKey$$inline_137$$ = 
      !!$history$$inline_143_opt_history_promoteKey$$inline_137$$, $key$$inline_130_prefetchXhr_reverse$$inline_144$$ = !!$handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$, $handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$ = $spf$bind$$($spf$nav$handleNavigateError_$$, null, $opt_options$$19_options$$9_xhr$$inline_148$$), $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$ = $spf$bind$$($spf$nav$handleNavigatePart_$$, null, 
      $opt_options$$19_options$$9_xhr$$inline_148$$, $key$$inline_130_prefetchXhr_reverse$$inline_144$$), $handleSuccess$$inline_147_opt_skipKey$$inline_127$$ = $spf$bind$$($spf$nav$handleNavigateSuccess_$$, null, $opt_options$$19_options$$9_xhr$$inline_148$$, $key$$inline_130_prefetchXhr_reverse$$inline_144$$, ""), $spf$config$values$$["advanced-navigate-persist-timing"] || $spf$nav$clearResourceTimings_$$(), $opt_options$$19_options$$9_xhr$$inline_148$$ = $spf$nav$request$send$$($url$$74$$, {method:$opt_options$$19_options$$9_xhr$$inline_148$$.method, 
      $onPart$:$JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_125_handlePart$$inline_146$$, $onError$:$handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$, $onSuccess$:$handleSuccess$$inline_147_opt_skipKey$$inline_127$$, $postData$:$opt_options$$19_options$$9_xhr$$inline_148$$.postData, type:"navigate" + ($history$$inline_143_opt_history_promoteKey$$inline_137$$ ? $key$$inline_130_prefetchXhr_reverse$$inline_144$$ ? "-back" : "-forward" : ""), current:$current$$4_history$$inline_135_opt_current$$3$$, 
      $referer$:$opt_referer_referer$$1$$}), $spf$state$set$$("nav-request", $opt_options$$19_options$$9_xhr$$inline_148$$), $history$$inline_143_opt_history_promoteKey$$inline_137$$ || $spf$nav$navigateAddHistory_$$($url$$74$$, $opt_referer_referer$$1$$, $handleError$$inline_145_opt_reverse$$1_preprocessKey$$inline_136$$));
    } else {
      $spf$nav$reload$$($url$$74$$, $spf$nav$ReloadReason$REQUEST_CANCELED$$);
    }
  } else {
    $spf$nav$navigateScroll_$$($url$$74$$), $history$$inline_143_opt_history_promoteKey$$inline_137$$ || $spf$nav$navigateAddHistory_$$($url$$74$$, $opt_referer_referer$$1$$, $spf$bind$$($spf$nav$handleNavigateError_$$, null, $opt_options$$19_options$$9_xhr$$inline_148$$));
  }
}
function $spf$nav$navigateScroll_$$($result$$11_url$$77$$) {
  $result$$11_url$$77$$ = $spf$string$partition$$($result$$11_url$$77$$, "#");
  if ($result$$11_url$$77$$[1]) {
    if ($result$$11_url$$77$$[2]) {
      var $el$$14$$ = document.getElementById($result$$11_url$$77$$[2]);
      $el$$14$$ && ($spf$debug$debug$$("    scrolling into view", $result$$11_url$$77$$[2]), $el$$14$$.scrollIntoView());
    } else {
...
function $spf$nav$reload$$($url$$82$$, $reason$$, $err$$9_opt_err$$) {
  ...
  setTimeout(function() {
    var $reloadId$$1_url$$inline_158$$ = $spf$config$values$$["reload-identifier"];
    if ($reloadId$$1_url$$inline_158$$) {
      var $params$$ = {};
      $params$$[$reloadId$$1_url$$inline_158$$] = encodeURIComponent($reason$$);
      var $reloadId$$1_url$$inline_158$$ = $url$$82$$, $result$$inline_160$$ = $spf$string$partition$$($reloadId$$1_url$$inline_158$$, "#"), $reloadId$$1_url$$inline_158$$ = $result$$inline_160$$[0], $delim$$inline_161$$ = -1 != $reloadId$$1_url$$inline_158$$.indexOf("?") ? "&" : "?", $key$$inline_162$$;
      for ($key$$inline_162$$ in $params$$) {
        $reloadId$$1_url$$inline_158$$ += $delim$$inline_161$$ + $key$$inline_162$$, $params$$[$key$$inline_162$$] && ($reloadId$$1_url$$inline_158$$ += "=" + $params$$[$key$$inline_162$$]), $delim$$inline_161$$ = "&";
      }
      $url$$82$$ = $reloadId$$1_url$$inline_158$$ + $result$$inline_160$$[1] + $result$$inline_160$$[2];
    }
...
function $spf$nav$prefetch_$$($absoluteUrl$$inline_166_url$$86$$, $opt_options$$23_options$$17_xhr$$inline_165$$, $opt_original$$1_original$$2$$) {
  $spf$debug$info$$("nav.prefetch ", $absoluteUrl$$inline_166_url$$86$$, $opt_options$$23_options$$17_xhr$$inline_165$$, $opt_original$$1_original$$2$$);
  $opt_options$$23_options$$17_xhr$$inline_165$$ = $opt_options$$23_options$$17_xhr$$inline_165$$ || {};
  $opt_original$$1_original$$2$$ = $opt_original$$1_original$$2$$ || $absoluteUrl$$inline_166_url$$86$$;
  var $current$$6$$ = window.location.href;
  $spf$nav$dispatchRequest_$$($absoluteUrl$$inline_166_url$$86$$, void 0, void 0, $opt_options$$23_options$$17_xhr$$inline_165$$, !0) && ($opt_options$$23_options$$17_xhr$$inline_165$$ = $spf$nav$request$send$$($absoluteUrl$$inline_166_url$$86$$, {method:$opt_options$$23_options$$17_xhr$$inline_165$$.method, $onPart$:$spf$bind$$($spf$nav$handleLoadPart_$$, null, !0, $opt_options$$23_options$$17_xhr$$inline_165$$, $opt_original$$1_original$$2$$), $onError$:$spf$bind$$($spf$nav$handleLoadError_$$, 
  null, !0, $opt_options$$23_options$$17_xhr$$inline_165$$, $opt_original$$1_original$$2$$), $onSuccess$:$spf$bind$$($spf$nav$handleLoadSuccess_$$, null, !0, $opt_options$$23_options$$17_xhr$$inline_165$$, $opt_original$$1_original$$2$$), $postData$:$opt_options$$23_options$$17_xhr$$inline_165$$.postData, type:"prefetch", current:$current$$6$$}), $spf$debug$debug$$("nav.addPrefetch ", $absoluteUrl$$inline_166_url$$86$$, $opt_options$$23_options$$17_xhr$$inline_165$$), $absoluteUrl$$inline_166_url$$86$$ = 
  $spf$url$absolute$$($absoluteUrl$$inline_166_url$$86$$), $spf$nav$prefetches_$$()[$absoluteUrl$$inline_166_url$$86$$] = $opt_options$$23_options$$17_xhr$$inline_165$$);
}
...
var $spf$nav$clearResourceTimings_$$, $clearResourceTimings$$inline_168$$ = window.performance && (window.performance.clearResourceTimings || window.performance.webkitClearResourceTimings || window.performance.mozClearResourceTimings || window.performance.msClearResourceTimings || window.performance.oClearResourceTimings);
$spf$nav$clearResourceTimings_$$ = $clearResourceTimings$$inline_168$$ ? $spf$bind$$($clearResourceTimings$$inline_168$$, window.performance) : $spf$nullFunction$$;
...
$spf$main$discover_$$();
var $spf$main$api_$$ = {init:function($config$$inline_173_opt_config$$1_url$$inline_210$$) {
  ...
  $config$$inline_173_opt_config$$1_url$$inline_210$$ = $config$$inline_173_opt_config$$1_url$$inline_210$$ || {};
  for (var $errorCallback$$inline_209_key$$inline_174$$ in $spf$config$defaults$$) {
    $spf$config$values$$[$errorCallback$$inline_209_key$$inline_174$$] = $errorCallback$$inline_209_key$$inline_174$$ in $config$$inline_173_opt_config$$1_url$$inline_210$$ ? $config$$inline_173_opt_config$$1_url$$inline_210$$[$errorCallback$$inline_209_key$$inline_174$$] : $spf$config$defaults$$[$errorCallback$$inline_209_key$$inline_174$$];
  }
  for ($errorCallback$$inline_209_key$$inline_174$$ in $config$$inline_173_opt_config$$1_url$$inline_210$$) {
    $errorCallback$$inline_209_key$$inline_174$$ in $spf$config$defaults$$ || ($spf$config$values$$[$errorCallback$$inline_209_key$$inline_174$$] = $config$$inline_173_opt_config$$1_url$$inline_210$$[$errorCallback$$inline_209_key$$inline_174$$]);
  }
  if ($enable$$) {
    $errorCallback$$inline_209_key$$inline_174$$ = $spf$nav$dispatchError_$$;
    if (!$spf$state$values_$$["history-init"] && window.addEventListener) {
      $config$$inline_173_opt_config$$1_url$$inline_210$$ = window.location.href;
      ...
      $spf$state$set$$("history-error-callback", $errorCallback$$inline_209_key$$inline_174$$);
      $spf$state$set$$("history-listener", $spf$history$pop_$$);
      $spf$state$set$$("history-url", $config$$inline_173_opt_config$$1_url$$inline_210$$);
      $spf$state$set$$("history-timestamp", $spf$now$$());
      var $historyState$$inline_211$$ = {"spf-referer":document.referrer};
      try {
        $spf$history$replace$$($config$$inline_173_opt_config$$1_url$$inline_210$$, $historyState$$inline_211$$);
      } catch ($err$$inline_212$$) {
        $errorCallback$$inline_209_key$$inline_174$$ && $errorCallback$$inline_209_key$$inline_174$$($config$$inline_173_opt_config$$1_url$$inline_210$$, $err$$inline_212$$);
      }
    }
  ...
  for (var $key$$inline_178$$ in $spf$config$values$$) {
    delete $spf$config$values$$[$key$$inline_178$$];
  }
