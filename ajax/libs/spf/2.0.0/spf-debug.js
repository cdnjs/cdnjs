...
function $spf$net$resource$create$$($type$$78$$, $url$$28$$, $opt_callback$$7$$, $opt_document$$2_prevEl$$, $opt_statusGroup$$, $opt_prevUrl$$) {
  ...
  $isJS$$2$$ ? ($el$$2$$.async = !0, $el$$2$$.src = $url$$28$$, $doc$$2_head$$.insertBefore($el$$2$$, $doc$$2_head$$.firstChild)) : ($el$$2$$.rel = "stylesheet", $el$$2$$.href = $url$$28$$, $opt_document$$2_prevEl$$ = $opt_prevUrl$$ && $spf$net$resource$find$$($type$$78$$, $opt_prevUrl$$, $opt_document$$2_prevEl$$), $doc$$2_head$$.insertBefore($el$$2$$, $opt_document$$2_prevEl$$));
  return $el$$2$$;
}
