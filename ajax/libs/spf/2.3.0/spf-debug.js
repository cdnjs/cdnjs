...
function $spf$history$push_$$($pushState$$inline_21_replace$$, $opt_url$$5_url$$12$$, $opt_state$$2_state$$2$$, $callback$$32_opt_doCallback$$2$$) {
  if ($opt_url$$5_url$$12$$ || $opt_state$$2_state$$2$$) {
    ...
    if ($pushState$$inline_21_replace$$) {
      ...
      if ("function" == typeof $pushState$$inline_21_replace$$) {
        $pushState$$inline_21_replace$$.call(window.history, $opt_state$$2_state$$2$$, "", $opt_url$$5_url$$12$$);
      } else {
...
function $spf$net$resource$prefetch_$$($doc$$3_el$$6$$, $type$$88$$, $url$$32$$, $id$$6$$, $group$$) {
  ...
  var $fetchEl$$ = $doc$$3_el$$6$$.getElementById($id$$6$$);
  $fetchEl$$ && $fetchEl$$.parentNode.removeChild($fetchEl$$);
  $isJS$$4$$ ? ($fetchEl$$ = $doc$$3_el$$6$$.createElement("object"), $spf$net$resource$IS_IE$$ ? $doc$$3_el$$6$$.createElement("script").src = $url$$32$$ : $fetchEl$$.data = $url$$32$$, $fetchEl$$.id = $id$$6$$, $doc$$3_el$$6$$.body.appendChild($fetchEl$$)) : $isCSS$$ ? ($fetchEl$$ = $spf$net$resource$create$$($type$$88$$, $url$$32$$, null, $doc$$3_el$$6$$, $group$$), $fetchEl$$.id = $id$$6$$) : ($fetchEl$$ = $doc$$3_el$$6$$.createElement("img"), $spf$net$resource$IS_IE$$ && ($url$$32$$ = $url$$32$$ + 
  "#" + $spf$now$$()), $fetchEl$$.src = $url$$32$$, $fetchEl$$.id = $id$$6$$, $doc$$3_el$$6$$.body.appendChild($fetchEl$$));
}
...
function $spf$nav$response$extract_$$($frag$$) {
  ...
  $frag$$ = $frag$$.replace($spf$nav$response$ElementRegEx$SCRIPT_STYLE$$, function($full_name$$77$$, $tag$$1_url$$57$$, $async_attr$$, $text$$17$$) {
    return "script" == $tag$$1_url$$57$$ ? ($full_name$$77$$ = ($full_name$$77$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$NAME$$)) ? $full_name$$77$$[1] : "", $tag$$1_url$$57$$ = ($tag$$1_url$$57$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$SRC$$)) ? $tag$$1_url$$57$$[1] : "", $async_attr$$ = $spf$nav$response$AttributeRegEx$ASYNC$$.test($async_attr$$), $result$$4$$.scripts.push({url:$tag$$1_url$$57$$, text:$text$$17$$, name:$full_name$$77$$, async:$async_attr$$}), "") : 
    "style" == $tag$$1_url$$57$$ ? ($full_name$$77$$ = ($full_name$$77$$ = $async_attr$$.match($spf$nav$response$AttributeRegEx$NAME$$)) ? $full_name$$77$$[1] : "", $result$$4$$.styles.push({url:"", text:$text$$17$$, name:$full_name$$77$$}), "") : $full_name$$77$$;
  });
...
function $spf$net$xhr$send$$($addContentTypeFormUrlEncoded_method$$2$$, $url$$61$$, $data$$34$$, $opt_options$$17$$) {
  ...
  $xhr$$.onreadystatechange = function $$xhr$$$onreadystatechange$() {
    var $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$ = $xhr$$.timing;
    if ($xhr$$.readyState == $spf$net$xhr$State$HEADERS_RECEIVED$$) {
      $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$.responseStart = $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$.responseStart || $spf$now$$();
      if ("json" == $xhr$$.responseType) {
        ...
        if (-1 < ($xhr$$.getResponseHeader("Transfer-Encoding") || "").toLowerCase().indexOf("chunked")) {
          ...
          var $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$ = $xhr$$.getResponseHeader("X-Firefox-Spdy"), $chromeSpdy$$inline_110_loadTimes$$inline_109$$ = window.chrome && chrome.loadTimes && chrome.loadTimes(), $chromeSpdy$$inline_110_loadTimes$$inline_109$$ = $chromeSpdy$$inline_110_loadTimes$$inline_109$$ && $chromeSpdy$$inline_110_loadTimes$$inline_109$$.wasFetchedViaSpdy;
          $chunked$$ = !(!$chunk$$1_firefoxSpdy$$inline_108_timing$$5$$ && !$chromeSpdy$$inline_110_loadTimes$$inline_109$$);
        }
      }
      $options$$4$$.$onHeaders$ && $options$$4$$.$onHeaders$($xhr$$);
    } else {
      $xhr$$.readyState == $spf$net$xhr$State$LOADING$$ ? $chunked$$ && $options$$4$$.$onChunk$ && ($chunk$$1_firefoxSpdy$$inline_108_timing$$5$$ = $xhr$$.responseText.substring($offset$$14$$), $offset$$14$$ = $xhr$$.responseText.length, $options$$4$$.$onChunk$($xhr$$, $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$)) : $xhr$$.readyState == $spf$net$xhr$State$DONE$$ && ($chunk$$1_firefoxSpdy$$inline_108_timing$$5$$.responseEnd = $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$.responseEnd || $spf$now$$(), 
      window.performance && window.performance.getEntriesByName && ($xhr$$.resourceTiming = window.performance.getEntriesByName($url$$61$$).pop()), $chunked$$ && $options$$4$$.$onChunk$ && $xhr$$.responseText.length > $offset$$14$$ && ($chunk$$1_firefoxSpdy$$inline_108_timing$$5$$ = $xhr$$.responseText.substring($offset$$14$$), $offset$$14$$ = $xhr$$.responseText.length, $options$$4$$.$onChunk$($xhr$$, $chunk$$1_firefoxSpdy$$inline_108_timing$$5$$)), clearTimeout($timer$$), $options$$4$$.$onDone$ && 
...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  var $fn$$inline_124_options$$5$$ = $opt_options$$18$$ || {};
  $fn$$inline_124_options$$5$$.method = (($fn$$inline_124_options$$5$$.method || "GET") + "").toUpperCase();
  $fn$$inline_124_options$$5$$.type = $fn$$inline_124_options$$5$$.type || "request";
  var $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = $url$$62$$, $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $spf$config$values$$["url-identifier"] || "";
  if ($ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$) {
    var $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.replace("__type__", $fn$$inline_124_options$$5$$.type || ""), $hashParts$$inline_115_hashVal$$inline_121$$ = $spf$string$partition$$($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, "#"), $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ = $spf$string$partition$$($hashParts$$inline_115_hashVal$$inline_121$$[0], "?"), $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = 
    $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$[0], $cacheKey_cached_headers_querySep$$inline_118$$ = $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$[1], $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ = $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$[2], $handleComplete_hashSep$$inline_120$$ = $hashParts$$inline_115_hashVal$$inline_121$$[1], $hashParts$$inline_115_hashVal$$inline_121$$ = $hashParts$$inline_115_hashVal$$inline_121$$[2];
    if (0 == $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.lastIndexOf("?", 0)) {
      $cacheKey_cached_headers_querySep$$inline_118$$ && ($ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.replace("?", "&")), $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ += $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$;
    } else {
      if (0 == $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.lastIndexOf(".", 0)) {
        if ($spf$string$endsWith$$($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, "/")) {
          $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = "index" + $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$;
        } else {
          var $ext$$inline_122$$ = $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.lastIndexOf(".");
          -1 < $ext$$inline_122$$ && ($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.substring(0, $ext$$inline_122$$));
        }
      } else {
        $spf$string$endsWith$$($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, "/") && 0 == $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.lastIndexOf("/", 0) && ($ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.substring(1));
      }
      $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ += $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$;
    }
    $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ + $cacheKey_cached_headers_querySep$$inline_118$$ + $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ + $handleComplete_hashSep$$inline_120$$ + $hashParts$$inline_115_hashVal$$inline_121$$;
  }
  $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $spf$url$absolute$$($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$);
  $spf$debug$debug$$("    request url ", $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$);
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = {};
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.spfUrl = $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$;
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.startTime = $spf$now$$();
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.fetchStart = $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.startTime;
  $cacheKey_cached_headers_querySep$$inline_118$$ = $spf$nav$request$getCacheKey_$$($url$$62$$, $fn$$inline_124_options$$5$$.current, null, $fn$$inline_124_options$$5$$.type, !1);
  $cacheKey_cached_headers_querySep$$inline_118$$ = $spf$nav$request$getCacheObject_$$($cacheKey_cached_headers_querySep$$inline_118$$, $fn$$inline_124_options$$5$$.current);
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.spfPrefetched = !!$cacheKey_cached_headers_querySep$$inline_118$$ && "prefetch" == $cacheKey_cached_headers_querySep$$inline_118$$.type;
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.spfCached = !!$cacheKey_cached_headers_querySep$$inline_118$$;
  if ($cacheKey_cached_headers_querySep$$inline_118$$) {
    return $fn$$inline_124_options$$5$$ = $spf$bind$$($spf$nav$request$handleResponseFromCache_$$, null, $url$$62$$, $fn$$inline_124_options$$5$$, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, $cacheKey_cached_headers_querySep$$inline_118$$.key, $cacheKey_cached_headers_querySep$$inline_118$$.response), $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = window._spf_state = window._spf_state || {}, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = 
    parseInt($ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.uid, 10) || 0, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$++, $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$ = $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$.uid = $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, $spf$async$defers_$$[$ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$] = $fn$$inline_124_options$$5$$, $spf$async$POSTMESSAGE_SUPPORTED_$$ ? 
    window.postMessage($spf$async$PREFIX_$$ + $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$, "*") : window.setTimeout($spf$bind$$($spf$async$run_$$, null, $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$), 0), null;
  }
  $spf$debug$debug$$("    sending XHR");
  $cacheKey_cached_headers_querySep$$inline_118$$ = {};
  void 0 != $fn$$inline_124_options$$5$$.$referer$ && ($cacheKey_cached_headers_querySep$$inline_118$$["X-SPF-Referer"] = $fn$$inline_124_options$$5$$.$referer$);
  $fn$$inline_124_options$$5$$.current && ($cacheKey_cached_headers_querySep$$inline_118$$["X-SPF-Previous"] = $fn$$inline_124_options$$5$$.current);
  if ($chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ = $spf$config$values$$["advanced-header-identifier"]) {
    $cacheKey_cached_headers_querySep$$inline_118$$["X-SPF-Request"] = $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$.replace("__type__", $fn$$inline_124_options$$5$$.type), $cacheKey_cached_headers_querySep$$inline_118$$.Accept = "application/json";
  }
  $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$ = new $spf$nav$request$Chunking_$$;
  $handleComplete_hashSep$$inline_120$$ = $spf$bind$$($spf$nav$request$handleCompleteFromXHR_$$, null, $url$$62$$, $fn$$inline_124_options$$5$$, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$);
  $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$ = {headers:$cacheKey_cached_headers_querySep$$inline_118$$, $timeoutMs$:$spf$config$values$$["request-timeout"], $onHeaders$:$spf$bind$$($spf$nav$request$handleHeadersFromXHR_$$, null, $url$$62$$, $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$), $onChunk$:$spf$bind$$($spf$nav$request$handleChunkFromXHR_$$, null, $url$$62$$, $fn$$inline_124_options$$5$$, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$, 
  $chunking_headerId_queryParts$$inline_116_queryVal$$inline_119$$), $onDone$:$handleComplete_hashSep$$inline_120$$, $onTimeout$:$handleComplete_hashSep$$inline_120$$};
  $spf$config$values$$["advanced-response-type-json"] && ($path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$.responseType = "json");
  return "POST" == $fn$$inline_124_options$$5$$.method ? $spf$net$xhr$send$$("POST", $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$, $fn$$inline_124_options$$5$$.$postData$, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$) : $spf$net$xhr$send$$("GET", $ident$$inline_114_requestUrl_state$$inline_206_uid$$inline_125$$, null, $path$$inline_117_timing$$6_uid$$inline_207_url$$inline_112_xhrOpts$$);
}
...
function $spf$nav$request$handleChunkFromXHR_$$($url$$65$$, $options$$7$$, $timing$$8$$, $chunking$$2$$, $xhr$$4$$, $chunk$$2_text$$18$$, $opt_lastDitch$$1$$) {
  ...
  if ($chunking$$2$$.$multipart$) {
    ...
    try {
      ...
      $xhr$$4$$.abort();
      $options$$7$$.$onError$ && $options$$7$$.$onError$($url$$65$$, $err$$2$$);
      return;
    }
...
function $spf$nav$request$handleCompleteFromXHR_$$($url$$66$$, $options$$8$$, $timing$$9$$, $chunking$$3_i$$13$$, $part$$3_xhr$$5$$) {
  ...
  if ($part$$3_xhr$$5$$.resourceTiming) {
    if ("load" == $options$$8$$.type) {
      for (var $key$$51_value$$56$$ in $part$$3_xhr$$5$$.resourceTiming) {
        $timing$$9$$[$key$$51_value$$56$$] = $part$$3_xhr$$5$$.resourceTiming[$key$$51_value$$56$$];
      }
    } else {
      if (window.performance && window.performance.timing && ($navigationStart_t$$ = window.performance.timing.navigationStart, $navigationStart_t$$ + $part$$3_xhr$$5$$.resourceTiming.startTime >= $timing$$9$$.startTime)) {
        for (var $metric$$ in $part$$3_xhr$$5$$.resourceTiming) {
          $key$$51_value$$56$$ = $part$$3_xhr$$5$$.resourceTiming[$metric$$], void 0 !== $key$$51_value$$56$$ && ($spf$string$endsWith$$($metric$$, "Start") || $spf$string$endsWith$$($metric$$, "End") || "startTime" == $metric$$) && ($timing$$9$$[$metric$$] = $navigationStart_t$$ + Math.round($key$$51_value$$56$$));
        }
      }
    }
  }
  ...
  if ("json" == $part$$3_xhr$$5$$.responseType) {
    if (!$part$$3_xhr$$5$$.response) {
      ...
      $options$$8$$.$onError$ && $options$$8$$.$onError$($url$$66$$, Error("JSON response parsing failed"));
      return;
    }
    ...
    try {
      ...
      $spf$debug$debug$$("    JSON parse failed");
      $options$$8$$.$onError$ && $options$$8$$.$onError$($url$$66$$, $err$$3$$);
      return;
    }
  }
...
function $spf$nav$request$getCacheObject_$$($cacheKey$$4$$, $opt_current$$1$$) {
  ...
  var $cacheValue$$ = null;
  $spf$array$some$$($keys$$, function($key$$52$$) {
    var $obj$$21_storage$$inline_132_unit$$inline_133$$;
    a: {
      $obj$$21_storage$$inline_132_unit$$inline_133$$ = $spf$cache$storage_$$();
      if ($key$$52$$ in $obj$$21_storage$$inline_132_unit$$inline_133$$) {
        $obj$$21_storage$$inline_132_unit$$inline_133$$ = $obj$$21_storage$$inline_132_unit$$inline_133$$[$key$$52$$];
        if ($spf$cache$valid_$$($obj$$21_storage$$inline_132_unit$$inline_133$$)) {
          $spf$cache$updateCount_$$($obj$$21_storage$$inline_132_unit$$inline_133$$);
          $obj$$21_storage$$inline_132_unit$$inline_133$$ = $obj$$21_storage$$inline_132_unit$$inline_133$$.data;
          break a;
        }
        $spf$cache$remove$$($key$$52$$);
      }
      $obj$$21_storage$$inline_132_unit$$inline_133$$ = void 0;
    }
    $obj$$21_storage$$inline_132_unit$$inline_133$$ && ($cacheValue$$ = {key:$key$$52$$, response:$obj$$21_storage$$inline_132_unit$$inline_133$$.response, type:$obj$$21_storage$$inline_132_unit$$inline_133$$.type});
    return!!$obj$$21_storage$$inline_132_unit$$inline_133$$;
  });
  return $cacheValue$$;
}
...
function $spf$nav$handleScroll_$$() {
  var $position_position$$inline_135$$;
  $position_position$$inline_135$$ = $spf$state$values_$$["nav-scroll-position"] || null;
  var $url$$inline_136$$ = $spf$state$values_$$["nav-scroll-url"] || "";
  $position_position$$inline_135$$ = $position_position$$inline_135$$ && $url$$inline_136$$ == window.location.href ? $position_position$$inline_135$$ : null;
  $spf$nav$clearScrollTempPosition_$$();
  $position_position$$inline_135$$ && ($spf$debug$debug$$("    returning to saved scroll temp position", $position_position$$inline_135$$), window.scroll.apply(null, $position_position$$inline_135$$));
}
function $spf$nav$handleHistory_$$($url$$74$$, $opt_state$$3$$) {
  $spf$debug$debug$$("nav.handleHistory ", "(url=", $url$$74$$, "state=", $opt_state$$3$$, ")");
  var $info$$1$$ = new $spf$nav$Info$$({current:$opt_state$$3$$ && $opt_state$$3$$["spf-current"], history:!0, position:$opt_state$$3$$ && $opt_state$$3$$["spf-position"], $referer$:$opt_state$$3$$ && $opt_state$$3$$["spf-referer"], reverse:!(!$opt_state$$3$$ || !$opt_state$$3$$["spf-back"])}), $position$$inline_138_reloadId$$ = $spf$config$values$$["reload-identifier"];
  $position$$inline_138_reloadId$$ && ($url$$74$$ = $spf$url$removeParameters$$($url$$74$$, [$position$$inline_138_reloadId$$]));
  $spf$nav$isAllowed_$$($url$$74$$) ? $spf$nav$isEligible_$$() ? $spf$dispatch$$("spfhistory", {url:$url$$74$$, referer:$info$$1$$.$referer$, previous:$info$$1$$.current}) && ($info$$1$$.position && ($position$$inline_138_reloadId$$ = [window.pageXOffset, window.pageYOffset], $spf$debug$debug$$("    saving scroll temp position", $position$$inline_138_reloadId$$), $spf$state$set$$("nav-scroll-position", $position$$inline_138_reloadId$$), $spf$state$set$$("nav-scroll-url", window.location.href)), $spf$nav$navigate_$$($url$$74$$, 
  {}, $info$$1$$)) : $spf$nav$reload$$($url$$74$$, $spf$nav$ReloadReason$INELIGIBLE$$) : $spf$nav$reload$$($url$$74$$, $spf$nav$ReloadReason$FORBIDDEN$$);
}
function $spf$nav$navigate_$$($url$$76$$, $options$$13_xhr$$inline_163$$, $info$$3$$) {
  $spf$debug$info$$("nav.navigate_ ", $url$$76$$, $options$$13_xhr$$inline_163$$, $info$$3$$);
  $spf$nav$cancel$$();
  var $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$;
  a: {
    var $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$ = $info$$3$$.current || window.location.href;
    if (-1 != $url$$76$$.indexOf("#") || -1 != $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$.indexOf("#")) {
      if ($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = $spf$url$absolute$$($url$$76$$), $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$ = $spf$url$absolute$$($absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$), $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ == 
      $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$) {
        $spf$debug$debug$$("    not handling hash-based navigation");
        $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = !1;
        break a;
      }
    }
    $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = !0;
  }
  if ($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$) {
    if ($spf$nav$dispatchRequest_$$($url$$76$$, $info$$3$$.$referer$, $info$$3$$.current, $options$$13_xhr$$inline_163$$)) {
      $spf$state$set$$("nav-counter", (parseInt($spf$state$values_$$["nav-counter"], 10) || 0) + 1);
      $spf$nav$cancelAllPrefetchesExcept$$($url$$76$$);
      $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = $spf$url$absolute$$($url$$76$$);
      var $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$ = "preprocess " + $spf$url$absolute$$($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$), $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$;
      for ($handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ in $spf$tasks$queues_$$) {
        $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$ != $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ && 0 == $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$.lastIndexOf("preprocess", 0) && $spf$tasks$cancel$$($handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$);
      }
      $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ = $spf$nav$prefetches_$$()[$JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$];
      $spf$state$set$$("nav-request", $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$);
      $spf$state$set$$("nav-promote", null);
      $spf$state$set$$("nav-promote-time", null);
      $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ && 4 != $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$.readyState ? ($spf$debug$debug$$("nav.navigatePromotePrefetch_ ", $url$$76$$), $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ = "preprocess " + $spf$url$absolute$$($url$$76$$), $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = 
      "promote " + $spf$url$absolute$$($url$$76$$), $spf$state$set$$("nav-promote", $url$$76$$), $spf$state$set$$("nav-promote-time", $spf$now$$()), $spf$tasks$cancel$$($handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$), $spf$tasks$run$$($JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$, !0), $info$$3$$.history || $spf$nav$navigateAddHistory_$$($url$$76$$, $info$$3$$.$referer$, $spf$bind$$($spf$nav$handleNavigateError_$$, 
      null, $options$$13_xhr$$inline_163$$))) : ($handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$ = $spf$bind$$($spf$nav$handleNavigateError_$$, null, $options$$13_xhr$$inline_163$$), $JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$ = $spf$bind$$($spf$nav$handleNavigatePart_$$, null, $options$$13_xhr$$inline_163$$, $info$$3$$), $absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$ = 
      $spf$bind$$($spf$nav$handleNavigateSuccess_$$, null, $options$$13_xhr$$inline_163$$, $info$$3$$), $spf$config$values$$["advanced-navigate-persist-timing"] || $spf$nav$clearResourceTimings_$$(), $info$$3$$.type = "navigate", $info$$3$$.history && ($info$$3$$.type += $info$$3$$.reverse ? "-back" : "-forward"), $options$$13_xhr$$inline_163$$ = $spf$nav$request$send$$($url$$76$$, {method:$options$$13_xhr$$inline_163$$.method, $onPart$:$JSCompiler_inline_result$$15_absoluteUrl$$2_absoluteUrl$$inline_143_handlePart$$inline_161_promoteKey$$inline_155$$, 
      $onError$:$handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$, $onSuccess$:$absoluteCurrent$$inline_144_current$$inline_142_handleSuccess$$inline_162_opt_skipKey$$inline_146$$, $postData$:$options$$13_xhr$$inline_163$$.postData, type:$info$$3$$.type, current:$info$$3$$.current, $referer$:$info$$3$$.$referer$}), $spf$state$set$$("nav-request", $options$$13_xhr$$inline_163$$), $info$$3$$.history || $spf$nav$navigateAddHistory_$$($url$$76$$, $info$$3$$.$referer$, $handleError$$inline_160_key$$inline_149_prefetchXhr_preprocessKey$$inline_154$$));
    } else {
      $spf$nav$reload$$($url$$76$$, $spf$nav$ReloadReason$REQUEST_CANCELED$$);
    }
  } else {
    $spf$debug$debug$$("non-navigable, just scroll"), $info$$3$$.history || $spf$nav$navigateAddHistory_$$($url$$76$$, $info$$3$$.$referer$, $spf$bind$$($spf$nav$handleNavigateError_$$, null, $options$$13_xhr$$inline_163$$)), $spf$nav$navigateScroll_$$($url$$76$$, $info$$3$$);
  }
}
...
function $spf$nav$navigateAddHistory_$$($url$$80$$, $opt_state$$inline_166_referer$$, $handleError$$3$$) {
  try {
    ...
    $spf$url$absolute$$($url$$80$$, !0) != window.location.href && ($opt_state$$inline_166_referer$$ = {"spf-referer":$opt_state$$inline_166_referer$$}, $spf$debug$info$$("history.add ", $url$$80$$), $spf$history$push_$$(!1, $url$$80$$, $opt_state$$inline_166_referer$$, void 0));
  } catch ($err$$4$$) {
    $spf$nav$cancel$$(), $spf$debug$error$$("error caught, redirecting ", "(url=", $url$$80$$, "err=", $err$$4$$, ")"), $handleError$$3$$($url$$80$$, $err$$4$$);
  }
}
function $spf$nav$handleNavigateError_$$($options$$16$$, $url$$81$$, $err$$5$$) {
  $spf$debug$warn$$("navigate error", "(url=", $url$$81$$, ")");
  $spf$state$set$$("nav-request", null);
  $spf$nav$dispatchError_$$($url$$81$$, $err$$5$$, $options$$16$$) && $spf$nav$reload$$($url$$81$$, $spf$nav$ReloadReason$ERROR$$, $err$$5$$);
}
...
function $spf$nav$reload$$($url$$84$$, $reason$$, $err$$9_opt_err$$) {
  ...
  $spf$config$values$$["experimental-remove-history"] && window.location.href == $url$$84$$ && ($spf$state$set$$("history-ignore-pop", !0), window.history.back());
  setTimeout(function() {
    var $reloadId$$1_url$$inline_173$$ = $spf$config$values$$["reload-identifier"];
    if ($reloadId$$1_url$$inline_173$$) {
      var $params$$ = {};
      $params$$[$reloadId$$1_url$$inline_173$$] = encodeURIComponent($reason$$);
      var $reloadId$$1_url$$inline_173$$ = $url$$84$$, $result$$inline_175$$ = $spf$string$partition$$($reloadId$$1_url$$inline_173$$, "#"), $reloadId$$1_url$$inline_173$$ = $result$$inline_175$$[0], $delim$$inline_176$$ = -1 != $reloadId$$1_url$$inline_173$$.indexOf("?") ? "&" : "?", $key$$inline_177$$;
      for ($key$$inline_177$$ in $params$$) {
        $reloadId$$1_url$$inline_173$$ += $delim$$inline_176$$ + $key$$inline_177$$, $params$$[$key$$inline_177$$] && ($reloadId$$1_url$$inline_173$$ += "=" + $params$$[$key$$inline_177$$]), $delim$$inline_176$$ = "&";
      }
      $url$$84$$ = $reloadId$$1_url$$inline_173$$ + $result$$inline_175$$[1] + $result$$inline_175$$[2];
    }
...
function $spf$nav$load_$$($url$$86$$, $options$$21$$, $info$$10$$) {
  ...
  if ($spf$nav$dispatchRequest_$$($url$$86$$, void 0, void 0, $options$$21$$, !0)) {
    ...
    $info$$10$$.type = "load";
    $spf$nav$request$send$$($url$$86$$, {method:$options$$21$$.method, $onPart$:$handlePart$$1$$, $onError$:$handleError$$4$$, $onSuccess$:$handleSuccess$$1$$, $postData$:$options$$21$$.postData, type:$info$$10$$.type});
  }
}
...
function $spf$nav$prefetch_$$($absoluteUrl$$inline_181_url$$88$$, $options$$23_xhr$$inline_180$$, $info$$12$$) {
  $spf$debug$info$$("nav.prefetch ", $absoluteUrl$$inline_181_url$$88$$, $options$$23_xhr$$inline_180$$, $info$$12$$);
  $info$$12$$.$original$ = $info$$12$$.$original$ || $absoluteUrl$$inline_181_url$$88$$;
  if ($spf$nav$dispatchRequest_$$($absoluteUrl$$inline_181_url$$88$$, void 0, void 0, $options$$23_xhr$$inline_180$$, !0)) {
    var $handleError$$5$$ = $spf$bind$$($spf$nav$handleLoadError_$$, null, !0, $options$$23_xhr$$inline_180$$, $info$$12$$), $handlePart$$2$$ = $spf$bind$$($spf$nav$handleLoadPart_$$, null, !0, $options$$23_xhr$$inline_180$$, $info$$12$$), $handleSuccess$$2$$ = $spf$bind$$($spf$nav$handleLoadSuccess_$$, null, !0, $options$$23_xhr$$inline_180$$, $info$$12$$);
    $info$$12$$.type = "prefetch";
    $options$$23_xhr$$inline_180$$ = $spf$nav$request$send$$($absoluteUrl$$inline_181_url$$88$$, {method:$options$$23_xhr$$inline_180$$.method, $onPart$:$handlePart$$2$$, $onError$:$handleError$$5$$, $onSuccess$:$handleSuccess$$2$$, $postData$:$options$$23_xhr$$inline_180$$.postData, type:$info$$12$$.type, current:$info$$12$$.current});
    $spf$debug$debug$$("nav.addPrefetch ", $absoluteUrl$$inline_181_url$$88$$, $options$$23_xhr$$inline_180$$);
    $absoluteUrl$$inline_181_url$$88$$ = $spf$url$absolute$$($absoluteUrl$$inline_181_url$$88$$);
    $spf$nav$prefetches_$$()[$absoluteUrl$$inline_181_url$$88$$] = $options$$23_xhr$$inline_180$$;
  }
}
...
function $spf$nav$handleLoadRedirect_$$($isPrefetch$$3_redirectFn$$, $options$$27$$, $info$$16$$, $redirectUrl$$1$$) {
  ...
  var $redirectOpts$$ = {};
  $spf$array$each$$([$spf$nav$Callback$ERROR$$, $spf$nav$Callback$REQUEST$$, $spf$nav$Callback$PART_PROCESS$$, $spf$nav$Callback$PART_DONE$$, $spf$nav$Callback$PROCESS$$, $spf$nav$Callback$DONE$$], function($key$$53$$) {
    $redirectOpts$$[$key$$53$$] = $options$$27$$[$key$$53$$];
  });
  $isPrefetch$$3_redirectFn$$($redirectUrl$$1$$, $redirectOpts$$, $info$$16$$);
}
function $spf$nav$dispatchError_$$($detail$$3_url$$93$$, $err$$12$$, $opt_options$$22_proceed$$, $opt_noEvents$$) {
  $detail$$3_url$$93$$ = {url:$detail$$3_url$$93$$, err:$err$$12$$};
...
function $spf$nav$cancelAllPrefetchesExcept$$($absoluteUrl$$5_opt_skipUrl$$) {
  ...
  for (var $key$$54$$ in $prefetches$$3$$) {
    $absoluteUrl$$5_opt_skipUrl$$ != $key$$54$$ && $spf$nav$removePrefetch$$($key$$54$$);
  }
}
var $spf$nav$clearResourceTimings_$$, $clearResourceTimings$$inline_183$$ = window.performance && (window.performance.clearResourceTimings || window.performance.webkitClearResourceTimings || window.performance.mozClearResourceTimings || window.performance.msClearResourceTimings || window.performance.oClearResourceTimings);
$spf$nav$clearResourceTimings_$$ = $clearResourceTimings$$inline_183$$ ? $spf$bind$$($clearResourceTimings$$inline_183$$, window.performance) : $spf$nullFunction$$;
...
$spf$main$discover_$$();
var $spf$main$api_$$ = {init:function($config$$inline_188_opt_config$$1_url$$inline_222$$) {
  ...
  $config$$inline_188_opt_config$$1_url$$inline_222$$ = $config$$inline_188_opt_config$$1_url$$inline_222$$ || {};
  for (var $errorCallback$$inline_221_key$$inline_189$$ in $spf$config$defaults$$) {
    $spf$config$values$$[$errorCallback$$inline_221_key$$inline_189$$] = $errorCallback$$inline_221_key$$inline_189$$ in $config$$inline_188_opt_config$$1_url$$inline_222$$ ? $config$$inline_188_opt_config$$1_url$$inline_222$$[$errorCallback$$inline_221_key$$inline_189$$] : $spf$config$defaults$$[$errorCallback$$inline_221_key$$inline_189$$];
  }
  for ($errorCallback$$inline_221_key$$inline_189$$ in $config$$inline_188_opt_config$$1_url$$inline_222$$) {
    $errorCallback$$inline_221_key$$inline_189$$ in $spf$config$defaults$$ || ($spf$config$values$$[$errorCallback$$inline_221_key$$inline_189$$] = $config$$inline_188_opt_config$$1_url$$inline_222$$[$errorCallback$$inline_221_key$$inline_189$$]);
  }
  if ($enable$$) {
    $errorCallback$$inline_221_key$$inline_189$$ = $spf$nav$dispatchError_$$;
    if (!$spf$state$values_$$["history-init"] && window.addEventListener) {
      $config$$inline_188_opt_config$$1_url$$inline_222$$ = window.location.href;
      ...
      $spf$state$set$$("history-error-callback", $errorCallback$$inline_221_key$$inline_189$$);
      $spf$state$set$$("history-listener", $spf$history$pop_$$);
      $spf$state$set$$("history-url", $config$$inline_188_opt_config$$1_url$$inline_222$$);
      $spf$state$set$$("history-timestamp", $spf$now$$());
      var $historyState$$inline_223$$ = {"spf-referer":document.referrer};
      try {
        $spf$history$replace$$($config$$inline_188_opt_config$$1_url$$inline_222$$, $historyState$$inline_223$$);
      } catch ($err$$inline_224$$) {
        $errorCallback$$inline_221_key$$inline_189$$ && $errorCallback$$inline_221_key$$inline_189$$($config$$inline_188_opt_config$$1_url$$inline_222$$, $err$$inline_224$$);
      }
    }
  ...
  for (var $key$$inline_193$$ in $spf$config$values$$) {
    delete $spf$config$values$$[$key$$inline_193$$];
  }
