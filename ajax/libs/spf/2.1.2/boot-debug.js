...
;function $spf$net$resource$load$$($el$$1_url$$19$$, $name$$52$$, $check_opt_fn$$) {
  var $type$$73$$ = $spf$net$resource$Type$JS$$;
  $spf$debug$debug$$("resource.load", $type$$73$$, $el$$1_url$$19$$, $name$$52$$);
  var $isJS_key$$inline_57_prevName$$ = $type$$73$$ == $spf$net$resource$Type$JS$$;
  $el$$1_url$$19$$ = $spf$net$resource$canonicalize$$($type$$73$$, $el$$1_url$$19$$);
  var $pseudonym$$ = $name$$52$$ || "^" + $el$$1_url$$19$$, $topic$$6$$ = $spf$net$resource$key$$($type$$73$$, $pseudonym$$), $prevUrl$$;
  $name$$52$$ && ($prevUrl$$ = $spf$net$resource$url$get$$($type$$73$$, $name$$52$$)) && $el$$1_url$$19$$ != $prevUrl$$ && ($spf$dispatch$$($isJS_key$$inline_57_prevName$$ ? "spfjsbeforeunload" : "spfcssbeforeunload", {name:$name$$52$$, url:$prevUrl$$}), $spf$net$resource$unloadPrepare_$$($type$$73$$, $name$$52$$, $prevUrl$$), $spf$pubsub$subscribe$$($topic$$6$$, $spf$bind$$($spf$net$resource$unloadComplete_$$, null, $type$$73$$, $name$$52$$, $prevUrl$$)));
  $isJS_key$$inline_57_prevName$$ = $spf$net$resource$key$$($type$$73$$, $el$$1_url$$19$$);
  if (($isJS_key$$inline_57_prevName$$ = $spf$net$resource$name_$$[$isJS_key$$inline_57_prevName$$]) && $pseudonym$$ != $isJS_key$$inline_57_prevName$$) {
    ...
    $key$$inline_61_key$$inline_65_key$$inline_73_oldTopic$$inline_67_url$$inline_77$$ = $spf$net$resource$key$$($type$$73$$, $el$$1_url$$19$$);
  ...
  var $key$$inline_61_key$$inline_65_key$$inline_73_oldTopic$$inline_67_url$$inline_77$$ = $el$$1_url$$19$$, $key$$inline_78$$ = $spf$net$resource$key$$($type$$73$$, $pseudonym$$);
  ...
  $spf$net$resource$status$get$$($type$$73$$, $el$$1_url$$19$$) ? ($isJS_key$$inline_57_prevName$$ && $pseudonym$$ != $isJS_key$$inline_57_prevName$$ && ($el$$1_url$$19$$ = $spf$net$resource$find$$($type$$73$$, $el$$1_url$$19$$)) && $el$$1_url$$19$$.setAttribute("name", $name$$52$$ || ""), $check_opt_fn$$()) : ($el$$1_url$$19$$ = $spf$net$resource$create$$($type$$73$$, $el$$1_url$$19$$, $check_opt_fn$$, void 0, void 0, $prevUrl$$)) && $name$$52$$ && $el$$1_url$$19$$.setAttribute("name", $name$$52$$);
}
function $spf$net$resource$unload$$($name$$53$$) {
  ...
  var $url$$20$$ = $spf$net$resource$url$get$$($type$$74$$, $name$$53$$);
  $spf$net$resource$unloadPrepare_$$($type$$74$$, $name$$53$$, $url$$20$$);
  $spf$net$resource$unloadComplete_$$($type$$74$$, $name$$53$$, $url$$20$$);
}
function $spf$net$resource$unloadPrepare_$$($topic$$7_type$$75$$, $name$$54$$, $key$$inline_86_url$$21$$) {
  $spf$debug$debug$$("  > resource.unloadPrepare_", $topic$$7_type$$75$$, $key$$inline_86_url$$21$$);
  var $key$$inline_82$$ = $spf$net$resource$key$$($topic$$7_type$$75$$, $name$$54$$);
  delete $spf$net$resource$url_$$[$key$$inline_82$$];
  $key$$inline_86_url$$21$$ && ($key$$inline_86_url$$21$$ = $spf$net$resource$key$$($topic$$7_type$$75$$, $key$$inline_86_url$$21$$), delete $spf$net$resource$name_$$[$key$$inline_86_url$$21$$]);
...
function $spf$net$resource$unloadComplete_$$($key$$inline_90_type$$76$$, $name$$55_url$$inline_8$$, $el$$inline_10_url$$22$$) {
  var $isJS$$1$$ = $key$$inline_90_type$$76$$ == $spf$net$resource$Type$JS$$;
  $el$$inline_10_url$$22$$ && ($spf$debug$debug$$("  > resource.unloadComplete_", $key$$inline_90_type$$76$$, $el$$inline_10_url$$22$$), $spf$dispatch$$($isJS$$1$$ ? "spfjsunload" : "spfcssunload", {name:$name$$55_url$$inline_8$$, url:$el$$inline_10_url$$22$$}), $name$$55_url$$inline_8$$ = $spf$net$resource$canonicalize$$($key$$inline_90_type$$76$$, $el$$inline_10_url$$22$$), ($el$$inline_10_url$$22$$ = $spf$net$resource$find$$($key$$inline_90_type$$76$$, $name$$55_url$$inline_8$$, void 0)) && $el$$inline_10_url$$22$$.parentNode && 
  $el$$inline_10_url$$22$$.parentNode.removeChild($el$$inline_10_url$$22$$), $key$$inline_90_type$$76$$ = $spf$net$resource$key$$($key$$inline_90_type$$76$$, $name$$55_url$$inline_8$$), delete $spf$net$resource$status_$$[$key$$inline_90_type$$76$$]);
}
...
function $spf$net$resource$create$$($type$$78$$, $url$$23$$, $opt_callback$$7$$, $opt_document$$2_prevEl$$, $opt_statusGroup$$, $opt_prevUrl$$) {
  function $next$$1$$() {
    $spf$debug$debug$$("resource.create", $type$$78$$, $url$$23$$, "done");
    $spf$net$resource$status$get$$($type$$78$$, $url$$23$$, $opt_statusGroup$$) && ($spf$debug$debug$$("resource.create", $type$$78$$, $url$$23$$, "loaded"), $spf$net$resource$status$set$$($spf$net$resource$State$LOADED$$, $type$$78$$, $url$$23$$, $opt_statusGroup$$));
    $opt_callback$$7$$ && setTimeout($opt_callback$$7$$, 0);
    return null;
  }
  $spf$debug$debug$$("resource.create", $type$$78$$, $url$$23$$, "loading");
  var $isJS$$2$$ = $type$$78$$ == $spf$net$resource$Type$JS$$;
  $url$$23$$ = $spf$net$resource$canonicalize$$($type$$78$$, $url$$23$$);
  $spf$net$resource$status$set$$($spf$net$resource$State$LOADING$$, $type$$78$$, $url$$23$$, $opt_statusGroup$$);
  var $doc$$2_head$$ = $opt_document$$2_prevEl$$ || document, $el$$2$$ = $doc$$2_head$$.createElement($isJS$$2$$ ? "script" : "link");
  if (!$url$$23$$) {
    return $next$$1$$();
  }
  var $label$$4$$ = $url$$23$$ ? String($url$$23$$).replace(/[^\w]/g, "") : "";
  ...
  $isJS$$2$$ ? ($el$$2$$.async = !0, $el$$2$$.src = $url$$23$$, $doc$$2_head$$.insertBefore($el$$2$$, $doc$$2_head$$.firstChild)) : ($el$$2$$.rel = "stylesheet", $el$$2$$.href = $url$$23$$, ($opt_document$$2_prevEl$$ = $opt_prevUrl$$ && $spf$net$resource$find$$($type$$78$$, $opt_prevUrl$$, $opt_document$$2_prevEl$$)) ? $doc$$2_head$$.insertBefore($el$$2$$, $opt_document$$2_prevEl$$) : $doc$$2_head$$.appendChild($el$$2$$));
  return $el$$2$$;
}
function $spf$net$resource$find$$($cls$$3_type$$80$$, $label$$5_url$$25$$, $doc$$inline_16_opt_document$$4$$) {
  $label$$5_url$$25$$ = $label$$5_url$$25$$ ? String($label$$5_url$$25$$).replace(/[^\w]/g, "") : "";
  $cls$$3_type$$80$$ = $spf$net$resource$key$$($cls$$3_type$$80$$, $label$$5_url$$25$$);
...
function $spf$net$resource$canonicalize$$($type$$87$$, $url$$29$$) {
  var $key$$29_paths$$1$$ = "rsrc-p-" + $type$$87$$;
  if ($url$$29$$) {
    var $index$$45$$ = $url$$29$$.indexOf("//");
    if (0 > $index$$45$$) {
      if (0 == $url$$29$$.lastIndexOf("hash-", 0)) {
        return $url$$29$$;
      }
      $key$$29_paths$$1$$ = $spf$state$values_$$[$key$$29_paths$$1$$] || "";
      if ("[object String]" == Object.prototype.toString.call($key$$29_paths$$1$$)) {
        $url$$29$$ = $key$$29_paths$$1$$ + $url$$29$$;
      } else {
        for (var $p$$ in $key$$29_paths$$1$$) {
          $url$$29$$ = $url$$29$$.replace($p$$, $key$$29_paths$$1$$[$p$$]);
        }
      }
      $url$$29$$ = 0 > $url$$29$$.indexOf("." + $type$$87$$) ? $url$$29$$ + "." + $type$$87$$ : $url$$29$$;
      $url$$29$$ = $spf$url$absolute$$($url$$29$$);
    } else {
      0 == $index$$45$$ && ($url$$29$$ = $spf$url$absolute$$($url$$29$$));
    }
  }
  return $url$$29$$;
}
...
function $spf$net$resource$status$set$$($status$$, $key$$30_type$$89$$, $url$$31$$, $opt_group$$1$$) {
  $key$$30_type$$89$$ = $spf$net$resource$key$$($key$$30_type$$89$$, $url$$31$$, $opt_group$$1$$);
  $spf$net$resource$status_$$[$key$$30_type$$89$$] = $status$$;
}
function $spf$net$resource$status$get$$($key$$31_type$$90$$, $url$$32$$, $opt_group$$2$$) {
  $key$$31_type$$90$$ = $spf$net$resource$key$$($key$$31_type$$90$$, $url$$32$$, $opt_group$$2$$);
...
function $spf$net$resource$url$loaded$$($type$$99$$, $name$$62$$) {
  var $url$$40$$ = $spf$net$resource$url$get$$($type$$99$$, $name$$62$$), $JSCompiler_temp$$2_status$$inline_25$$;
  if ($JSCompiler_temp$$2_status$$inline_25$$ = void 0 != $url$$40$$) {
    $JSCompiler_temp$$2_status$$inline_25$$ = $spf$net$resource$status$get$$($type$$99$$, $url$$40$$), $JSCompiler_temp$$2_status$$inline_25$$ = "" == $url$$40$$ || $JSCompiler_temp$$2_status$$inline_25$$ == $spf$net$resource$State$LOADED$$;
  }
...
function $spf$net$script$require$$($names$$3$$, $opt_fn$$4$$) {
  ...
  $spf$array$each$$($names$$3$$, function($name$$68$$) {
    if ($name$$68$$) {
      var $url$$44$$ = $spf$net$script$url_$$[$name$$68$$] || $name$$68$$, $url$$44$$ = $spf$net$resource$canonicalize$$($spf$net$resource$Type$JS$$, $url$$44$$), $previous$$1$$ = $spf$net$resource$url$get$$($spf$net$resource$Type$JS$$, $name$$68$$);
      $previous$$1$$ && $url$$44$$ != $previous$$1$$ && $spf$net$script$unrequire$$($name$$68$$);
    }
  });
...
function $spf$net$script$require_$$($names$$4$$) {
  $spf$array$each$$($names$$4$$, function($name$$69$$) {
    function $next$$3$$() {
      $spf$net$resource$load$$($url$$45$$, $name$$69$$, void 0);
    }
    var $deps$$ = $spf$net$script$deps_$$[$name$$69$$], $url$$45$$ = $spf$net$script$url_$$[$name$$69$$] || $name$$69$$;
...
var $spf$bootloader$api_$$ = {script:{load:function($url$$41$$, $name$$63$$, $opt_fn$$1$$) {
  $spf$net$resource$load$$($url$$41$$, $name$$63$$, $opt_fn$$1$$);
}, get:function($url$$42$$, $opt_fn$$2$$) {
  $spf$net$resource$create$$($spf$net$resource$Type$JS$$, $url$$42$$, $opt_fn$$2$$);
