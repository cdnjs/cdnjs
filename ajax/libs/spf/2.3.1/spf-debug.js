/* SPF 23 (v2.3.1) | (c) 2012-2016 Google Inc. | License: MIT */
...
function $spf$nav$request$send$$($url$$62$$, $opt_options$$18$$) {
  ...
  var $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = $url$$62$$, $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $spf$config$values$$["url-identifier"] || "";
  if ($ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$) {
    var $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.replace("__type__", $fn$$inline_123_options$$5$$.type || ""), $hashParts$$inline_114_hashVal$$inline_120$$ = $spf$string$partition$$($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, "#"), $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$string$partition$$($hashParts$$inline_114_hashVal$$inline_120$$[0], "?"), $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = 
    $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$[0], $cacheKey_cached_headers_querySep$$inline_117$$ = $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$[1], $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ = $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$[2], $handleComplete_hashSep$$inline_119$$ = $hashParts$$inline_114_hashVal$$inline_120$$[1], $hashParts$$inline_114_hashVal$$inline_120$$ = $hashParts$$inline_114_hashVal$$inline_120$$[2];
    if (0 == $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.lastIndexOf("?", 0)) {
      $cacheKey_cached_headers_querySep$$inline_117$$ && ($ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.replace("?", "&")), $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ += $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$;
    } else {
      if (0 == $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.lastIndexOf(".", 0)) {
        if ($spf$string$endsWith$$($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, "/")) {
          $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = "index" + $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$;
        } else {
          var $ext$$inline_121$$ = $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.lastIndexOf(".");
          -1 < $ext$$inline_121$$ && ($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.substring(0, $ext$$inline_121$$));
        }
      } else {
        $spf$string$endsWith$$($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, "/") && 0 == $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.lastIndexOf("/", 0) && ($ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.substring(1));
      }
      $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ += $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$;
    }
    $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ + $cacheKey_cached_headers_querySep$$inline_117$$ + $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ + $handleComplete_hashSep$$inline_119$$ + $hashParts$$inline_114_hashVal$$inline_120$$;
  }
  $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $spf$url$absolute$$($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$);
  $spf$debug$debug$$("    request url ", $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$);
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = {};
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.spfUrl = $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$;
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.startTime = $spf$now$$();
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.fetchStart = $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.startTime;
  ...
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.spfPrefetched = !!$cacheKey_cached_headers_querySep$$inline_117$$ && "prefetch" == $cacheKey_cached_headers_querySep$$inline_117$$.type;
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.spfCached = !!$cacheKey_cached_headers_querySep$$inline_117$$;
  if ($cacheKey_cached_headers_querySep$$inline_117$$) {
    return $fn$$inline_123_options$$5$$ = $spf$bind$$($spf$nav$request$handleResponseFromCache_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, $cacheKey_cached_headers_querySep$$inline_117$$.key, $cacheKey_cached_headers_querySep$$inline_117$$.response), $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = window._spf_state = window._spf_state || {}, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = 
    parseInt($ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.uid, 10) || 0, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$++, $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$ = $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$.uid = $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, $spf$async$defers_$$[$ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$] = $fn$$inline_123_options$$5$$, $spf$async$POSTMESSAGE_SUPPORTED_$$ ? 
    window.postMessage($spf$async$PREFIX_$$ + $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$, "*") : window.setTimeout($spf$bind$$($spf$async$run_$$, null, $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$), 0), null;
  }
  $spf$debug$debug$$("    sending XHR");
  $cacheKey_cached_headers_querySep$$inline_117$$ = {};
  void 0 != $fn$$inline_123_options$$5$$.$referer$ && ($cacheKey_cached_headers_querySep$$inline_117$$["X-SPF-Referer"] = $fn$$inline_123_options$$5$$.$referer$);
  $fn$$inline_123_options$$5$$.current && ($cacheKey_cached_headers_querySep$$inline_117$$["X-SPF-Previous"] = $fn$$inline_123_options$$5$$.current);
  if ($chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ = $spf$config$values$$["advanced-header-identifier"]) {
    $cacheKey_cached_headers_querySep$$inline_117$$["X-SPF-Request"] = $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$.replace("__type__", $fn$$inline_123_options$$5$$.type), $cacheKey_cached_headers_querySep$$inline_117$$.Accept = "application/json";
  }
  $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$ = new $spf$nav$request$Chunking_$$;
  $handleComplete_hashSep$$inline_119$$ = $spf$bind$$($spf$nav$request$handleCompleteFromXHR_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$);
  $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$ = {headers:$cacheKey_cached_headers_querySep$$inline_117$$, $timeoutMs$:$spf$config$values$$["request-timeout"], $onHeaders$:$spf$bind$$($spf$nav$request$handleHeadersFromXHR_$$, null, $url$$62$$, $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$), $onChunk$:$spf$bind$$($spf$nav$request$handleChunkFromXHR_$$, null, $url$$62$$, $fn$$inline_123_options$$5$$, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$, 
  $chunking_headerId_queryParts$$inline_115_queryVal$$inline_118$$), $onDone$:$handleComplete_hashSep$$inline_119$$, $onTimeout$:$handleComplete_hashSep$$inline_119$$};
  $spf$config$values$$["advanced-response-type-json"] && ($path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$.responseType = "json");
  return "POST" == $fn$$inline_123_options$$5$$.method ? $spf$net$xhr$send$$("POST", $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$, $fn$$inline_123_options$$5$$.$postData$, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$) : $spf$net$xhr$send$$("GET", $ident$$inline_113_requestUrl_state$$inline_199_uid$$inline_124$$, null, $path$$inline_116_timing$$6_uid$$inline_200_url$$inline_111_xhrOpts$$);
}
...
function $spf$nav$request$getCacheObject_$$($cacheKey$$4$$, $opt_current$$1$$) {
  ...
  $spf$array$some$$($keys$$, function($key$$52$$) {
    ...
    a: {
      ...
      if ($key$$52$$ in $obj$$21_storage$$inline_131_unit$$inline_132$$) {
        $obj$$21_storage$$inline_131_unit$$inline_132$$ = $obj$$21_storage$$inline_131_unit$$inline_132$$[$key$$52$$];
    ...
    $obj$$21_storage$$inline_131_unit$$inline_132$$ && ($cacheValue$$ = {key:$key$$52$$, response:$obj$$21_storage$$inline_131_unit$$inline_132$$.response, type:$obj$$21_storage$$inline_131_unit$$inline_132$$.type});
...
function $spf$nav$navigate_$$($url$$76$$, $options$$13_xhr$$inline_156$$, $info$$3$$) {
  ...
  if ($spf$nav$isNavigable_$$($url$$76$$, $info$$3$$.current)) {
    if ($spf$nav$dispatchRequest_$$($url$$76$$, $info$$3$$.$referer$, $info$$3$$.current, $options$$13_xhr$$inline_156$$)) {
      ...
      $info$$3$$.type = "navigate", $info$$3$$.history && ($info$$3$$.type += $info$$3$$.reverse ? "-back" : "-forward"), $options$$13_xhr$$inline_156$$ = $spf$nav$request$send$$($url$$76$$, {method:$options$$13_xhr$$inline_156$$.method, $onPart$:$handlePart$$inline_154_opt_skipKey$$inline_139_promoteKey$$inline_148$$, $onError$:$absoluteUrl$$2_handleError$$inline_153_prefetchXhr_preprocessKey$$inline_147$$, $onSuccess$:$handleSuccess$$inline_155_key$$inline_142$$, $postData$:$options$$13_xhr$$inline_156$$.postData, 
      type:$info$$3$$.type, current:$info$$3$$.current, $referer$:$info$$3$$.$referer$}), $spf$state$set$$("nav-request", $options$$13_xhr$$inline_156$$), $info$$3$$.history || $spf$nav$navigateAddHistory_$$($url$$76$$, $info$$3$$.$referer$, $absoluteUrl$$2_handleError$$inline_153_prefetchXhr_preprocessKey$$inline_147$$));
    } else {
...
function $spf$nav$prefetch_$$($absoluteUrl$$inline_174_url$$88$$, $options$$23_xhr$$inline_173$$, $info$$12$$) {
  ...
  if ($spf$nav$dispatchRequest_$$($absoluteUrl$$inline_174_url$$88$$, void 0, void 0, $options$$23_xhr$$inline_173$$, !0)) {
    ...
    $options$$23_xhr$$inline_173$$ = $spf$nav$request$send$$($absoluteUrl$$inline_174_url$$88$$, {method:$options$$23_xhr$$inline_173$$.method, $onPart$:$handlePart$$2$$, $onError$:$handleError$$5$$, $onSuccess$:$handleSuccess$$2$$, $postData$:$options$$23_xhr$$inline_173$$.postData, type:$info$$12$$.type, current:$info$$12$$.current});
