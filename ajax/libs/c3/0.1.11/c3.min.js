(function(O){function vd(){function t(e,g){e.attr("transform",function(e){return"translate("+(g(e)+fa)+", 0)"})}function y(e,g){e.attr("transform",function(e){return"translate(0,"+g(e)+")"})}function O(e){var g=e[0];e=e[e.length-1];return g<e?[g,e]:[e,g]}function Ga(e){for(var g=[],q=Math.ceil(e[0]);q<e[1];q++)g.push(q);0<g.length&&0<g[0]&&g.unshift(g[0]-(g[1]-g[0]));return g}function Ha(e){e=e<W.length?W[e]:e;return Q?Q(e):e}function p(p){p.each(function(){var p=e.select(this),na=Ga(q.domain()),
X=p.selectAll(".tick.major").data(na,String),Y=X.enter().insert("g","path").attr("class","tick major").style("opacity",1E-6),ga=e.transition(X.exit()).style("opacity",1E-6).remove(),ha=e.transition(X).style("opacity",1),I,v=q.rangeExtent?q.rangeExtent():O(q.range()),p=p.selectAll(".domain").data([0]);p.enter().append("path").attr("class","domain");var p=e.transition(p),B=q.copy(),W=this.__chart__||B;this.__chart__=B;Y.append("line");Y.append("text");var R=Y.select("line"),Q=ha.select("line"),Z=X.select("text"),
...
O.c3={},e=O.d3;zb.generate=function(ea){var nc,oc,Ga,Ha,p,q,C,M,$;function g(a,b){for(var c=ea,d=0;d<a.length;d++){if(!(a[d]in c))return b;c=c[a[d]]}return c}function ua(){Ab=Ja?Ja:Q();va=fa();q=0;C=(h?Bb+rc:0)+(bb?bb:cb?1:40);M=20+(h?0:Bb)+oa;$=db?db:Cb?eb||h?1:40:1;r=Ab-C-$;s=va-q-M;Ga=h?q:va-Bb-oa;Ha=h?sc:C;p=20+oa;Db=h?C-sc-rc:r;fb=h?s:va-Ga-p;nc=va-oa;oc=C;S()}function S(){Eb=s/2;Ka=0.95*Eb;Fb=ia(k.data.targets,"donut")?0.6*Ka:0}function fa(){var a=Gb?Gb:+e.select(wa).style("height").replace("px",
...
function(a){return 0===a%1?hb.tickOffset():0});ib=I(Lb,Mb);jb=I(Lb,Mb);J=pc(m,yd);ya=e.svg.axis().scale(z).orient(zd);kb=e.svg.axis().scale(aa).orient(Ad);hb=pc(U,Bd);ga()}function ga(){lb=ab();tc=Ia();uc=Ia(0.98)}function ha(a,b,c,d){var f=(D?e.time.scale():e.scale.linear()).range([a,b]);f.orgDomain=function(){return f.domain()};t(c)&&f.domain(c);y(d)&&(d=function(){return 0});if(ja){var H=f,u,f=function(a){return H(a)+d(a)};for(u in H)f[u]=H[u];f.orgDomain=function(){return H.domain()};f.domain=
function(a){if(!arguments.length)return a=H.domain(),[a[0],a[1]+1];H.domain(a);return f}}return f}function I(a,b){return e.scale.linear().range([a,b])}function v(a){return"y2"===R(a)?aa:z}function B(a){return"y2"===R(a)?jb:ib}function pc(a,b){var c=(ja?vd():e.svg.axis()).scale(a).orient(b);c.tickFormat(qc());ja?c.categories(La).tickCentered(Cd):c.tickOffset=function(){return 0};return c}function R(a){return a in vc?vc[a]:"y"}function qc(){var a=D?Dd:ja?Ed:function(a){return a};mb&&(a="function"===
...
lb.centroid(a),a=b[0],b=b[1],c=Math.sqrt(a*a+b*b),b="translate("+0.8*(a/c)*Ka+","+0.8*(b/c)*Ka+")");return b}function xd(a){return Fd(a,(a.endAngle-a.startAngle)/(2*Math.PI))}function wc(a,b){var c=n.selectAll(".chart-arc.target"+(a?"-"+a:"")),d=n.selectAll(".-arc").filter(function(b){return b.data.id!==a});c.selectAll("path").transition().duration(50).attr("d",tc).transition().duration(100).attr("d",uc).each(function(a){Ob(a.data)});b||d.style("opacity",0.3)}function Pb(a){n.selectAll(".chart-arc.target"+
(a?"-"+a:"")).selectAll("path").transition().duration(50).attr("d",lb);n.selectAll(".-arc").style("opacity",1)}function Gd(a){var b=xc(a),c,d,f,H;if(0<w.length)for(H=yc(a),a=0;a<w.length;a++)for(d=w[a][0],H&&b[d]&&b[d].forEach(function(a,c){b[d][c]=0>a?a:0}),c=1;c<w[a].length;c++)f=w[a][c],b[f]&&b[f].forEach(function(a,c){R(f)!==R(d)||!b[d]||H&&0<+a||(b[d][c]+=+a)});return e.min(Object.keys(b).map(function(a){return e.min(b[a])}))}function Hd(a){var b=xc(a),c,d,f,H;if(0<w.length)for(H=Id(a),a=0;a<
...
g=Ma.bottom?Ma.bottom:f);"y2"===a&&Na&&(e=Na.top?Na.top:f,g=Na.bottom?Na.bottom:f);ia(b,"bar")&&!yc(b)&&(g=c);return[c-g,d+e]}function Pd(a){return e.min(a,function(a){return e.min(a.values,function(a){return a.x})})}function Qd(a){return e.max(a,function(a){return e.max(a.values,function(a){return a.x})})}function pb(a){var b=[Pd(a),Qd(a)];a=b[0];var b=b[1],c=ja?0:0.01*Math.abs(a-b);a=D?new Date(a.getTime()-c):a-c;b=D?new Date(b.getTime()+c):b+c;return[a,b]}function xa(a){return a[1]-a[0]}function Rd(a){for(var b=
0;b<a.length;b++)if(!(a[b]in qb))return!1;return!0}function Sd(a){for(var b=[],c=0;c<a.length;c++)a[c]in qb&&b.push(zc(qb[a[c]]));return b}function Qb(a){return"start"in a?m(D?pa(a.start):a.start):0}function Ac(a){var b=Qb(a);a=("end"in a?m(D?pa(a.end):a.end):r)-b;return 0>a?0:a}function Bc(a){return qa&&a===qa||ba&&Td(ba,a)}function Ud(a){return!Bc(a)}function Vd(a){Object.keys(a).forEach(function(b){ba[b]=a[b]})}function rb(a){var b;a&&(b=Oa[a.id],a.name=b?b:a.id);return a}function Cc(a){var b=
a[0],c={},d=[],f,e;for(f=1;f<a.length;f++){c={};for(e=0;e<a[f].length;e++)c[b[e]]=a[f][e];d.push(c)}return d}function Dc(a){var b=[],c,d,f;for(c=0;c<a.length;c++)for(f=a[c][0],d=1;d<a[c].length;d++)y(b[d-1])&&(b[d-1]={}),b[d-1][f]=a[c][d];return b}function Pa(a){var b=e.keys(a[0]).filter(Ud),c=e.keys(a[0]).filter(Bc);if(D&&0===c.length)return O.alert('data.x or data.xs must be specified when axis.x.type == "timeseries"'),[];Rb&&b.forEach(function(b){var f=qa?qa:ba?ba[b]:null;0<=c.indexOf(f)?k.data.x[b]=
a.map(function(a){return a[f]}):k.data.x[b]=k.data.x[Object.keys(k.data.x)[0]]});b=b.map(function(b){var c=Wd(b);return{id:c,id_org:b,values:a.map(function(a,e){var g;g=qa?qa:ba?ba[b]:null;g=D?pa(a[g]):Rb?a[g]?a[g]:b in k.data.x&&k.data.x[b]&&k.data.x[b][e]?k.data.x[b][e]:e:e;a.x=g;return{x:g,value:null===a[b]||isNaN(a[b])?null:+a[b],id:c}})}});b.forEach(function(a){var b;a.values=a.values.sort(function(a,b){return(a.x||0===a.x?a.x:Infinity)-(b.x||0===b.x?b.x:Infinity)});b=0;a.values.forEach(function(a){a.index=
b++})});Ec&&ca(Qa(b).filter(function(a){return!(a in A)}),Ec);b.forEach(function(a){qb[a.id_org]=zc(a)});return b}function zc(a){return{id:a.id,id_org:a.id_org,values:a.values.map(function(a){return{x:a.x,value:a.value,id:a.id}})}}function Fc(a){return 0<a&&k.data.targets[0].values[a-1]?k.data.targets[0].values[a-1].x:void 0}function gb(){return e.max(k.data.targets,function(a){return a.values.length})}function Xd(){var a=k.data.targets.length,b=0,c;1<a?k.data.targets.forEach(function(a){a.values.length>
b&&(c=a,b=a.values.length)}):c=a?k.data.targets[0]:null;return c}function Qa(a){a=y(a)?k.data.targets:a;return a.map(function(a){return a.id})}function Gc(a){var b=Qa(),c;for(c=0;c<b.length;c++)if(b[c]===a)return!0;return!1}function ob(a){return t(a)?k.data.targets.filter(a):k.data.targets}function xc(a){var b={};a.forEach(function(a){b[a.id]=[];a.values.forEach(function(d){b[a.id].push(d.value)})});return b}function Hc(a,b){var c=Object.keys(a),d,f,e;for(d=0;d<c.length;d++)for(e=a[c[d]].values,f=
0;f<e.length;f++)if(b(e[f].value))return!0;return!1}function yc(a){return Hc(a,function(a){return 0>a})}function Id(a){return Hc(a,function(a){return 0<a})}function Ed(a){return a<La.length?La[a]:a}function Ra(a){return"-shapes -shapes-"+a.id}function Ic(a){return Ra(a)+" -line -line-"+a.id}function Yd(a){return Ra(a)+" -circles -circles-"+a.id}function Jc(a){return Ra(a)+" -bars -bars-"+a.id}function Zd(a){return Ra(a.data)+" -arc -arc-"+a.data.id}function $d(a){return Ra(a)+" -area -area-"+a.id}
function ae(a,b){return"-shape -shape-"+b+" -circle -circle-"+b}function Kc(a,b){return"-shape -shape-"+b+" -bar -bar-"+b}function be(a,b){return"region region-"+b+" "+("classes"in a?[].concat(a.classes).join(" "):"")}function Lc(a,b){return"event-rect event-rect-"+b}function ce(a){return a.value||0===a.value?Mc(a)?0.5:1:0}function za(a){return m(a.x)}function Sa(a){return m(D?pa(a.value):a.value)}function Ta(a){return z(a.value)}function Nc(a){return U(a.x)}function Oc(a,b){var c,d=a[b].x,f=[];for(c=
b-1;0<=c&&d===a[c].x;c--)f.push(a[c]);for(c=b;c<a.length&&d===a[c].x;c++)f.push(a[c]);return f}function Pc(a,b,c,d){c=c?c:0;d=d?d:a.length-1;var f=Math.floor((d-c)/2)+c;0<m(a[f].x)-b[0]?d=f:c=f;return 1===d-c?(f=[],a[c].x&&(f=f.concat(Oc(a,c))),a[d].x&&(f=f.concat(Oc(a,d))),Qc(f,b)):Pc(a,b,c,d)}function Rc(a,b){var c;c=a.map(function(a){return Pc(a.values,b)});return Qc(c,b)}function Qc(a,b){var c,d;a.forEach(function(a){var e=Sb(a,b);if(e<c||!c)c=e,d=a});return d}function Sc(a,b){var c,d,f,e,g;Tc&&
0!==a.filter(function(a){return a&&(a.value||0===a.value)}).length&&(V.html(Uc(a)).style("visibility","hidden").style("display","block"),c=V.property("offsetWidth"),d=V.property("offsetHeight"),h?e=b[0]:(f=n.property("offsetLeft"),e=f+(bb?bb:cb?1:40)+m(a[0].x)+20,g=e+c,f=f+(Ja?Ja:Q())-(db?db:Cb?eb||h?1:40:1),g>f&&(e-=c+30)),c=b[1]+15+d<fa()?b[1]+15:b[1]-d,V.style("top",c+"px").style("left",e+"px").style("visibility","visible"))}function Vc(a){Tc&&(ia(k.data.targets,"scatter")||E(k.data.targets)||
...
(c=[c]);for(var d=0;d<c.length;d++)Tb[c[d]]=b===A[c[d]],A[c[d]]=b}function ia(a,b){var c=!1;a.forEach(function(a){A[a.id]===b&&(c=!0);a.id in A||"line"!==b||(c=!0)});return c}function Ua(a){return Tb[a.id]?1:0}function E(a){return ia(a,"pie")||ia(a,"donut")}function Ub(a){a="string"===typeof a?a:a.id;return!(a in A)||"line"===A[a]||"spline"===A[a]||"area"===A[a]||"area-spline"===A[a]}function Xc(a){a="string"===typeof a?a:a.id;return"spline"===A[a]||"area-spline"===A[a]}function sb(a){return"bar"===
A["string"===typeof a?a:a.id]}function Mc(a){return"scatter"===A["string"===typeof a?a:a.id]}function Yc(a){return"pie"===A["string"===typeof a?a:a.id]}function Ob(a){return"donut"===A["string"===typeof a?a:a.id]}function Zc(a){return sb(a)?a.values:[]}function he(a){return Ub(a)||Mc(a)?a.values:[]}function pa(a){var b;if(!a)throw Error(a+" can not be parsed as d3.time with format "+Vb+". Maybe 'x' of this data is not defined. See data.x or data.xs option.");b=e.time.format(Vb).parse(a);if(!b)throw Error("Failed to parse '"+
...
b){return Math.pow(m(a.x)-b[0],2)+Math.pow(z(a.value)-b[1],2)}function bd(a,b,c){je(a,b);l.select(".selected-circles-"+b.id).selectAll(".selected-circle-"+c).data([b]).enter().append("circle").attr("class",function(){return"selected-circle selected-circle-"+c}).attr("cx",h?Ba:Aa).attr("cy",h?Aa:Ba).attr("stroke",function(){return N(b.id)}).attr("r",1.4*Va).transition().duration(100).attr("r",Va)}function Wb(a,b,c){ke(a,b);l.select(".selected-circles-"+b.id).selectAll(".selected-circle-"+c).transition().duration(100).attr("r",
0).remove()}function cd(a,b,c,d){a?bd(b,c,d):Wb(b,c,d)}function le(){}function dd(){}function ed(a,b,c,d){}function Xb(a){return a.filter(function(a){return a.value||0===a.value})}function Yb(a,b){return(b?l.selectAll(".-circles-"+b):l).selectAll(".-circle"+(a||0===a?"-"+a:""))}function Zb(a){Yb(a).filter(function(){return e.select(this).classed(da)}).classed(da,!1).attr("r",$b)}function fd(a){return l.selectAll(".-bar"+(a||0===a?"-"+a:""))}function me(a,b,c,d){var f,e,g="M",k,l,m,gd,n,ra=[];if(t(d))for(f=
0;f<d.length;f++)ra[f]={},y(d[f].start)?ra[f].start=a[0].x:ra[f].start=D?pa(d[f].start):d[f].start,y(d[f].end)?ra[f].end=a[a.length-1].x:ra[f].end=D?pa(d[f].end):d[f].end;gd=h?function(a){return c(a.value)}:function(a){return b(a.x)};n=h?function(a){return b(a.x)}:function(a){return c(a.value)};d=D?function(a,d,f,e){var g=a.x.getTime();a=d.x-a.x;d=new Date(g+a*(f+e));return"M"+b(new Date(g+a*f))+" "+c(l(f))+" "+b(d)+" "+c(l(f+e))}:function(a,d,f,e){return"M"+b(k(f))+" "+c(l(f))+" "+b(k(f+e))+" "+
c(l(f+e))};for(f=0;f<a.length;f++)if(y(ra)||!ie(a[f].x,ra))g+=" "+gd(a[f])+" "+n(a[f]);else{k=ha(a[f-1].x,a[f].x);l=I(a[f-1].value,a[f].value);e=b(a[f].x)-b(a[f-1].x);m=c(a[f].value)-c(a[f-1].value);e=Math.sqrt(Math.pow(e,2)+Math.pow(m,2));m=2/e;var p=2*m;for(e=m;1>=e;e+=p)g+=d(a[f-1],a[f],e,m)}return g}function ac(a){var b;tb=e.select(wa);if(tb.empty())O.alert('No bind element found. Check the selector specified by "bindto" and existance of that element. Default "bindto" is "#chart".');else{tb.html("");
...
bc).append("rect").attr("y",q).attr("width",r).attr("height",s-q);ub.append("clipPath").attr("id","xaxis-clip").append("rect").attr("x",-1-C).attr("y",-20).attr("width",W).attr("height",na);ub.append("clipPath").attr("id","yaxis-clip").append("rect").attr("x",-C+1).attr("y",q-1).attr("width",zb).attr("height",wd);l=n.append("g").attr("transform",L.main);G=Ca?n.append("g").attr("transform",L.context):null;Da=Ea?n.append("g").attr("transform",L.legend):null;V=e.select(wa).style("position","relative").append("div").style("position",
...
l.append("g").attr("class","y2 axis").attr("transform",L.y2).call(kb);a=l.append("g").attr("clip-path",Wa).attr("class","grid");id&&a.append("g").attr("class","xgrids");cc&&(b=a.append("g").attr("class","xgrid-lines").selectAll(".xgrid-line").data(cc).enter().append("g").attr("class","xgrid-line"),b.append("line").attr("class",function(a){return""+a["class"]}),b.append("text").attr("class",function(a){return""+a["class"]}).attr("text-anchor","end").attr("transform",h?"":"rotate(-90)").attr("dx",h?
0:-q).attr("dy",-5).text(function(a){return a.text}));ue&&a.append("g").attr("class","xgrid-focus").append("line").attr("class","xgrid-focus").attr("x1",h?0:-10).attr("x2",h?r:-10).attr("y1",h?-10:q).attr("y2",h?-10:s);jd&&a.append("g").attr("class","ygrids");dc&&(a=a.append("g").attr("class","ygrid-lines").selectAll("ygrid-line").data(dc).enter().append("g").attr("class","ygrid-line"),a.append("line").attr("class",function(a){return""+a["class"]}),a.append("text").attr("class",function(a){return""+
...
Fa;a++);Fa=a}V.html(Uc(k.data.targets.map(function(a){return rb(a.values[Fa])})));V.style("top",ld.top).style("left",ld.left).style("display","block")}null==O.onresize&&(O.onresize=ye());O.onresize.add&&O.onresize.add(md)}}function ze(a){a.append("rect").attr("class",Lc).style("cursor",ka&&ta?"pointer":null).on("mouseover",function(a,c){if(!Xa&&!E(k.data.targets)){var d=k.data.targets.map(function(a){return rb(a.values[c])}),f,e;if(0<Object.keys(Oa).length){e=[];for(var g in Oa)for(f=0;f<d.length;f++)if(d[f].id===
g){e.push(d[f]);d.shift(f);break}d=e.concat(d)}ec&&Yb(c,void 0).classed(da,!0).attr("r",fc);fd(c).classed(da,!1);Vc(d[0])}}).on("mouseout",function(a,c){E(k.data.targets)||(Wc(),V.style("display","none"),Zb(c),fd(void 0).classed(da,!1))}).on("mousemove",function(a,c){var d;Xa||E(k.data.targets)||(d=k.data.targets.map(function(a){return rb(a.values[c])}),Sc(d,e.mouse(this)),ka&&(ta||l.selectAll(".-shape-"+c).filter(function(a){return la(a)}).each(function(){var a=e.select(this).classed(da,!0);"circle"===
this.nodeName&&a.attr("r",fc);n.select(".event-rect-"+c).style("cursor",null)}).filter(function(){var a=e.select(this);if("circle"===this.nodeName)return $c(this,Va);if("rect"===this.nodeName)return ad(this,a.attr("x"),a.attr("y"))}).each(function(){var a=e.select(this);a.classed(da)||(a.classed(da,!0),"circle"===this.nodeName&&a.attr("r",Va));n.select(".event-rect-"+c).style("cursor","pointer")})))}).on("click",function(a,c){E(k.data.targets)||(gc?gc=!1:l.selectAll(".-shape-"+c).each(function(a){nd(this,
a,c)}))}).call(e.behavior.drag().origin(Object).on("drag",function(){od(e.mouse(this))}).on("dragstart",function(){pd(e.mouse(this))}).on("dragend",function(){qd()})).call(F).on("dblclick.zoom",null)}function Ae(a){a.append("rect").attr("x",0).attr("y",0).attr("width",r).attr("height",s).attr("class","event-rect").on("mouseout",function(){E(k.data.targets)||(Wc(),V.style("display","none"),Zb())}).on("mousemove",function(){var a,c,d;Xa||E(k.data.targets)||(a=e.mouse(this),c=Rc(k.data.targets,a),d=
[rb(c)],Sc(d,a),ec&&(Zb(),Yb(c.index,c.id).classed(da,!0).attr("r",fc)),Vc(d[0]),100>Sb(c,a)?n.select(".event-rect").style("cursor","pointer"):n.select(".event-rect").style("cursor",null))}).on("click",function(){var a,c;E(k.data.targets)||(a=e.mouse(this),c=Rc(k.data.targets,a),100>Sb(c,a)&&l.select(".-circles-"+c.id).select(".-circle-"+c.index).each(function(){nd(this,c,c.index)}))}).call(e.behavior.drag().origin(Object).on("drag",function(){od(e.mouse(this))}).on("dragstart",function(){pd(e.mouse(this))}).on("dragend",
function(){qd()})).call(F).on("dblclick.zoom",null)}function nd(a,b,c){var d=e.select(a),f=d.classed(ma),g=!1,h;"circle"===a.nodeName?(g=$c(a,1.5*Va),h=cd):"rect"===a.nodeName&&(g=ad(a),h=ed);if(ta||g)ka&&la(b)&&(d.classed(ma,!f),h(!f,d,b,c)),Be(b,d)}function od(a){var b,c,d,f,g,h,m;E(k.data.targets)||!ka||sa&&!F.altDomain||(b=hc[0],c=hc[1],d=a[0],a=a[1],f=Math.min(b,d),g=Math.max(b,d),h=ta?q:Math.min(c,a),m=ta?s:Math.max(c,a),l.select(".dragarea").attr("x",f).attr("y",h).attr("width",g-f).attr("height",
m-h),l.selectAll(".-shapes").selectAll(".-shape").filter(function(a){return la(a)}).each(function(a,b){var c=e.select(this),d=c.classed(ma),k=c.classed(ic),l,n,p,q;l=!1;"circle"===this.nodeName?(l=1*c.attr("cx"),n=1*c.attr("cy"),q=cd,l=f<l&&l<g&&h<n&&n<m):"rect"===this.nodeName&&(l=1*c.attr("x"),n=1*c.attr("y"),p=1*c.attr("width"),q=ed,l=f<l+p&&l<g&&n<m);l^k&&(c.classed(ic,!k),c.classed(ma,!d),q(!d,c,a,b))}))}function pd(a){!E(k.data.targets)&&ka&&(hc=a,l.select(".chart").append("rect").attr("class",
"dragarea").style("opacity",0.1),Xa=!0)}function qd(){!E(k.data.targets)&&ka&&(l.select(".dragarea").transition().duration(100).style("opacity",0).remove(),l.selectAll(".-shape").classed(ic,!1),Xa=!1)}function x(a){var b,c,d,f;d=de();var g,u,n,p=E(k.data.targets);a=t(a)?a:{};c=t(a.withY)?a.withY:!0;f=t(a.withSubchart)?a.withSubchart:!0;u=t(a.withTransition)?a.withTransition:!0;n=t(a.withTransform)?a.withTransform:!1;b=t(a.withUpdateXDomain)?a.withUpdateXDomain:!1;a=t(a.withUpdateOrgXDomain)?a.withUpdateOrgXDomain:
...
h?function(a){return m(a)-J.tickOffset()}:q).attr("y2",h?function(a){return m(a)-J.tickOffset()}:s).style("opacity",function(){return+e.select(this).attr(h?"y1":"x1")===(h?s:0)?0:1});b.exit().remove()}cc&&(b=l.selectAll(".xgrid-lines"),b.selectAll("line").transition().duration(u).attr("x1",h?0:Sa).attr("x2",h?r:Sa).attr("y1",h?Sa:q).attr("y2",h?Sa:s),b.selectAll("text").attr("x",h?r:0).attr("y",Sa));c&&jd&&(b=l.select(".ygrids").selectAll(".ygrid").data(z.ticks(10)),b.enter().append("line").attr("class",
"ygrid"),b.attr("x1",h?z:0).attr("x2",h?z:r).attr("y1",h?0:z).attr("y2",h?s:z),b.exit().remove());c&&dc&&(c=l.select(".ygrid-lines"),c.selectAll("line").transition().duration(u).attr("x1",h?Ta:0).attr("x2",h?Ta:r).attr("y1",h?0:Ta).attr("y2",h?s:Ta),c.selectAll("text").attr("x",h?0:r).attr("y",Ta));c=l.selectAll(".-bars").selectAll(".-bar").data(Zc);c.enter().append("path").attr("d",xb(d,!1)).style("stroke","none").style("opacity",0).style("fill",function(a){return N(a.id)}).attr("class",Kc);c.style("opacity",
...
ce).attr("cx",h?Ba:Aa).attr("cy",h?Aa:Ba);c.exit().remove();l.selectAll(".chart-arc").select(".-arc").attr("transform",n?"scale(0)":"").style("opacity",function(a){return a===this._current?0:1}).transition().duration(u).attrTween("d",function(a){a=Z(a);if(!a)return function(){return"M 0 0"};var b=e.interpolate(this._current,a);this._current=b(0);return function(a){a=b(a);return Yc(a.data)||Ob(a.data)?lb(a,!0):"M 0 0"}}).attr("transform",n?"scale(1)":"").style("opacity",1);l.selectAll(".chart-arc").select("text").attr("transform",
yb).style("opacity",0).transition().duration(u).text(xd).style("opacity",function(a){return Yc(a.data)||Ob(a.data)?1:0});l.select(".chart-arcs-title").style("opacity",ia(k.data.targets,"donut")?1:0);Ca&&(null!==e.event&&"zoom"===e.event.type&&K.extent(m.orgDomain()).update(),f&&(G.select(".x.axis").style("opacity",p?0:1).transition().duration(h?u:0).call(hb),K.empty()||K.extent(m.orgDomain()).update(),f=G.selectAll(".-bars").selectAll(".-bar").data(Zc),f.enter().append("path").attr("d",xb(d)).style("stroke",
"none").style("fill",function(a){return N(a.id)}).attr("class",Kc),f.style("opacity",Ua).transition().duration(u).attr("d",xb(d)).style("opacity",1),f.exit().transition().duration(u).style("opacity",0).remove(),G.selectAll(".-line").style("opacity",Ua).transition().duration(u).attr("d",Ge).style("opacity",1)));l.selectAll(".selected-circles").filter(function(a){return sb(a)}).selectAll("circle").remove();l.selectAll(".selected-circle").transition().duration(u).attr("cx",h?Ba:Aa).attr("cy",h?Aa:Ba);
ba?(f=l.select(".event-rects").selectAll(".event-rect").data([0]),Ae(f.enter()),f.attr("x",0).attr("y",0).attr("width",r).attr("height",s)):(Rb?(g=function(a,b){var c=Fc(b),d=b<gb()-1?k.data.targets[0].values[b+1].x:void 0;return(m(d?d:a.x+50)-m(c?c:a.x-50))/2},d=function(a,b){var c=Fc(b);return(m(a.x)+m(c?c:a.x-50))/2}):(g=X(),d=function(a){return m(a.x)-g/2}),f=Xd(),l.select(".event-rects").datum(f?f.values:[]),f=l.select(".event-rects").selectAll(".event-rect").data(function(a){return a}),ze(f.enter()),
f.attr("class",Lc).attr("x",h?0:d).attr("y",h?d:0).attr("width",h?r:g).attr("height",h?g:s),f.exit().remove());d=l.select(".regions").selectAll("rect.region").data(P);d.enter().append("rect");d.attr("class",be).attr("x",h?0:Qb).attr("y",h?Qb:q).attr("width",h?r:Ac).attr("height",h?Ac:s).style("fill-opacity",function(a){return t(a.opacity)?a.opacity:0.1});d.exit().transition().duration(u).style("fill-opacity",0).remove();Qa().forEach(function(a){Tb[a]=!0})}function He(){"mousemove"===e.event.sourceEvent.type&&
F.altDomain?(m.domain(F.altDomain),F.scale(m).updateScaleExtent()):(ja&&m.orgDomain()[0]===T[0]&&m.domain([T[0]-1E-10,m.orgDomain()[1]]),x({withTransition:!1,withY:!1,withSubchart:!1}),"mousemove"===e.event.sourceEvent.type&&(gc=!0))}function ye(){function a(){b.forEach(function(a){a()})}var b=[];a.add=function(a){b.push(a)};return a}function md(){ua();Y();K.scale(U);sa&&F.scale(m);n.attr("width",Ab).attr("height",va);n.select("#"+bc).select("rect").attr("width",r).attr("height",s);n.select("#xaxis-clip").select("rect").attr("width",
...
a.interpolate("cardinal"):a.interpolate("linear"),td[b.id]?me(c,m,v(b.id),td[b.id]):a(c);d=m(c[0].x);b=v(b.id)(c[0].value);return h?"M "+b+" "+d:"M "+d+" "+b}}(),Fe=function(){var a;a=h?e.svg.area().x0(function(a){return v(a.id)(0)}).x1(function(a){return v(a.id)(a.value)}).y(za):e.svg.area().x(za).y0(function(a){return v(a.id)(0)}).y1(function(a){return v(a.id)(a.value)});return function(b){var c=Xb(b.values),d;if(ia([b],"area")||ia([b],"area-spline"))return Xc(b)?a.interpolate("cardinal"):a.interpolate("linear"),
a(c);d=m(c[0].x);b=v(b.id)(c[0].value);return h?"M "+b+" "+d:"M "+d+" "+b}}(),xb=function(a,b){var c=a.__max__+1,d=1<arguments.length?b:!0,e=ja?c?1.2*J.tickOffset()/c:0:0.6*((h?s:r)*(d?1:xa(T)/xa(m.domain()))/(gb()-1)),g=ee(e,c,a,!!d),k=fe(!!d),l=ge(a,!!d),n=d?B:v;return function(a,b){var c=n(a.id)(0),d=l(a,b)||c,c=[[g(a),d],[g(a),k(a)-(c-d)],[g(a)+e,k(a)-(c-d)],[g(a)+e,d]],d=h?1:0,m=h?0:1;return"M "+c[0][d]+","+c[0][m]+" L"+c[1][d]+","+c[1][m]+" L"+c[2][d]+","+c[2][m]+" L"+c[3][d]+","+c[3][m]+" z"}},
Ge=function(){var a=e.svg.line().x(h?function(a){return B(a.id)(a.value)}:Nc).y(h?Nc:function(a){return B(a.id)(a.value)});return function(b){var c=Xb(b.values);return Ub(b)?a(c):"M "+U(c[0].x)+" "+B(b.id)(c[0].value)}}(),K=e.svg.brush().on("brush",function(){x({withTransition:!1,withY:!1,withSubchart:!1,withUpdateXDomain:!0})}),F=e.behavior.zoom().on("zoomstart",function(){F.altDomain=e.event.sourceEvent.altKey?m.orgDomain():null}).on("zoom",sa?He:null);K.update=function(){G&&G.select(".x.brush").call(this);
return this};K.scale=function(a){return h?this.y(a):this.x(a)};F.scale=function(a){return h?this.y(a):this.x(a)};F.orgScaleExtent=function(){var a=sd?sd:[1,10];return[a[0],Math.max(gb()/a[1],a[1])]};F.updateScaleExtent=function(){var a=xa(m.orgDomain())/xa(T),b=this.orgScaleExtent();this.scaleExtent([b[0]*a,b[1]*a]);return this};var n,ub,l,G,Da,V,tb,T,rd,Tb={};k.focus=function(a){var b=n.selectAll($a(a)),c=b.filter(lc),b=b.filter(mc);k.revert();k.defocus();c.classed("focused",!0).transition().duration(100).style("opacity",
1);b.transition().duration(100).style("opacity",1);E(k.data.targets)&&wc(a,!0);jc(a)};k.defocus=function(a){var b=n.selectAll($a(a)),c=b.filter(lc),b=b.filter(mc);k.revert();c.classed("focused",!1).transition().duration(100).style("opacity",0.3);b.transition().duration(100).style("opacity",0.3);E(k.data.targets)&&Pb(a);Ie(a)};k.revert=function(a){var b=n.selectAll($a(a)),c=b.filter(lc),b=b.filter(mc);c.classed("focused",!1).transition().duration(100).style("opacity",1);b.transition().duration(100).style("opacity",
1);E(k.data.targets)&&Pb(a);kc()};k.show=function(a){n.selectAll($a(a)).transition().style("opacity",1)};k.hide=function(a){n.selectAll($a(a)).transition().style("opacity",0)};k.unzoom=function(){K.clear().update();x({withUpdateXDomain:!0})};k.load=function(a){"function"!==typeof a.done&&(a.done=function(){});a.xs&&Vd(a.xs);"categories"in a&&ja&&(La=a.categories,J.categories(La));if("cacheIds"in a&&Rd(a.cacheIds))Ya(Sd(a.cacheIds),a.done);else if("data"in a)Ya(Pa(a.data),a.done);else if("url"in a)e.csv(a.url,
function(b,c){Ya(Pa(c),a.done)});else if("rows"in a)Ya(Pa(Cc(a.rows)),a.done);else if("columns"in a)Ya(Pa(Dc(a.columns)),a.done);else throw Error("url or rows or columns is required.");};k.unload=function(a){k.data.targets=k.data.targets.filter(function(b){return b.id!==a});n.selectAll(".target-"+a).transition().style("opacity",0).remove();Ea&&(n.selectAll(".legend-item-"+a).remove(),wb(k.data.targets));0<k.data.targets.length&&x({withUpdateOrgXDomain:!0,withUpdateXDomain:!0})};k.selected=function(a){a=
t(a)?"-"+a:"";return e.merge(l.selectAll(".-shapes"+a).selectAll(".-shape").filter(function(){return e.select(this).classed(ma)}).map(function(a){return a.map(function(a){return a.__data__})}))};k.select=function(a,b,c){ka&&l.selectAll(".-shapes").selectAll(".-shape").each(function(d,f){var g="circle"===this.nodeName?bd:le,h="circle"===this.nodeName?Wb:dd;0<=b.indexOf(f)?la(d)&&(ta||y(a)||0<=a.indexOf(d.id))&&g(e.select(this).classed(ma,!0),d,f):t(c)&&c&&h(e.select(this).classed(ma,!1),d,f)})};k.unselect=
function(a,b){ka&&l.selectAll(".-shapes").selectAll(".-shape").each(function(c,d){var f="circle"===this.nodeName?Wb:dd;(y(b)||0<=b.indexOf(d))&&la(c)&&(ta||y(a)||0<=a.indexOf(c.id))&&f(e.select(this).classed(ma,!1),c,d)})};k.toLine=function(a){ca(a,"line");x()};k.toSpline=function(a){ca(a,"spline");x()};k.toBar=function(a){ca(a,"bar");x()};k.toScatter=function(a){ca(a,"scatter");x()};k.toArea=function(a){ca(a,"area");x()};k.toAreaSpline=function(a){ca(a,"area-spline");x()};k.toPie=function(a){ca(a,
...
b.classes.indexOf(a)})});return P};k.data.get=function(a){a=k.data.getAsTarget(a);return t(a)?a.values.map(function(a){return a.value}):void 0};k.data.getAsTarget=function(a){var b=ob(function(b){return b.id===a});return 0<b.length?b[0]:void 0};k.resize=function(a){Ja=a?a.width:null;Gb=a?a.height:null;md()};k.destroy=function(){k.data.targets=void 0;k.data.x={};tb.html("");O.onresize=null};if("url"in ea.data)e.csv(ea.data.url,function(a,b){ac(b)});else if("rows"in ea.data)ac(Cc(ea.data.rows));else if("columns"in
ea.data)ac(Dc(ea.data.columns));else throw Error("url or rows or columns is required.");return k}})(window);
