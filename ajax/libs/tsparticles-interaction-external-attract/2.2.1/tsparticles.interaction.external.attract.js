...
class Attractor extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      const options = __classPrivateFieldGet(this, _Attractor_container, "f").actualOptions,
  ...
  async interact() {
    ...
    if (mouseMoveStatus && hoverEnabled && (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("attract"
    /* HoverMode.attract */
    , hoverMode)) {
      this.hoverAttract();
    } else if (clickEnabled && (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("attract"
    /* ClickMode.attract */
    , clickMode)) {
      this.clickAttract();
    }
  ...
  isEnabled(particle) {
    ...
    const hoverMode = events.onHover.mode,
          clickMode = events.onClick.mode;
    return (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("attract"
    /* HoverMode.attract */
    , hoverMode) || (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("attract"
    /* ClickMode.attract */
    , clickMode);
  }
