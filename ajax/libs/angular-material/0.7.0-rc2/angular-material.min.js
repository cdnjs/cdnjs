 ...
 * v0.7.0-rc2
 */
function(){function e(e,t){function n(){return[].concat(E)}function r(){return E.length}function o(e){return E.length&&e>-1&&e<E.length}function a(e){return e?o(u(e)+1):!1}function i(e){return e?o(u(e)-1):!1}function c(e){return o(e)?E[e]:null}function d(e,t){return E.filter(function(n){return n[e]===t})}function l(e,t){return e?(angular.isNumber(t)||(t=E.length),E.splice(t,0,e),u(e)):-1}function m(e){s(e)&&E.splice(u(e),1)}function u(e){return E.indexOf(e)}function s(e){return e&&u(e)>-1}function p(){return E.length?E[0]:null}function f(){return E.length?E[E.length-1]:null}function h(e,n,r,a){r=r||g;var i=u(n);if(!o(i))return null;var c=i+(e?-1:1),d=null;return o(c)?d=E[c]:t&&(d=e?f():p(),c=u(d)),null===d||c===a?null:(angular.isUndefined(a)&&(a=c),r(d)?d:h(e,d,r,a))}var g=function(){return!0};t=!!t;var E=e||[];return{items:n,count:r,inRange:o,contains:s,indexOf:u,itemAt:c,findBy:d,add:l,remove:m,first:p,last:f,next:angular.bind(null,h,!1),previous:angular.bind(null,h,!0),hasPrevious:i,hasNext:a}}angular.module("material.core").config(["$provide",function(t){t.decorator("$mdUtil",["$delegate",function(t){return t.iterator=e,t}])}])}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2
 ...
 * v0.7.0-rc2
 */
function(){"use strict";function e(){return{restrict:"E"}}function t(e){function t(e,t,n,r,o,a,i,c){function d(r,d,l){u=o('<md-backdrop class="md-opaque md-bottom-sheet-backdrop">')(r),u.on("click touchstart",function(){n(i.cancel)}),a.inherit(u,l.parent),e.enter(u,l.parent,null);var s=new m(d);return l.bottomSheet=s,l.targetEvent&&angular.element(l.targetEvent.target).blur(),a.inherit(s.element,l.parent),e.enter(s.element,l.parent).then(function(){var e=angular.element(d[0].querySelector("button")||d[0].querySelector("a")||d[0].querySelector("[ng-click]"));e.focus(),l.escapeToClose&&(l.rootElementKeyupCallback=function(e){e.keyCode===t.KEY_CODE.ESCAPE&&n(i.cancel)},c.on("keyup",l.rootElementKeyupCallback))})}function l(t,n,r){var o=r.bottomSheet;return e.leave(u),e.leave(o.element).then(function(){o.cleanup(),r.targetEvent&&angular.element(r.targetEvent.target).focus()})}function m(e){function r(n){n.preventDefault(),f=n.target,m=c(n),p=e.css(t.CSS.TRANSITION_DURATION),e.css(t.CSS.TRANSITION_DURATION,"0s")}function o(r){e.css(t.CSS.TRANSITION_DURATION,p);var o=c(r);Math.abs(o-m)<5&&r.target==f?angular.element(r.target).triggerHandler("click"):s>E?n(i.cancel):d(void 0)}function a(e){var t=c(e),n=t-m;s=t-u,u=t,n=l(n),d(n+h)}function c(e){var t=e.touches&&e.touches.length?e.touches[0]:e.changedTouches[0];return t.clientY}function d(n){null===n||void 0===n?e.css(t.CSS.TRANSFORM,""):e.css(t.CSS.TRANSFORM,"translate3d(0, "+n+"px, 0)")}function l(e){if(0>e&&-h+g>e){e=-e;var t=h-g;e=Math.max(-h,-Math.min(h-5,t+g*(e-t)/h)-e/50)}return e}var m,u,s,p,f,h=80,g=20,E=10;return e=e.eq(0),e.on("touchstart",r).on("touchmove",a).on("touchend",o),{element:e,cleanup:function(){e.off("touchstart",r).off("touchmove",a).off("touchend",o)}}}var u;return{themable:!0,targetEvent:null,onShow:d,onRemove:l,escapeToClose:!0}}return t.$inject=["$animate","$mdConstant","$timeout","$$rAF","$compile","$mdTheming","$mdBottomSheet","$rootElement"],e("$mdBottomSheet").setDefaults({options:t})}angular.module("material.components.bottomSheet",["material.core","material.components.backdrop"]).directive("mdBottomSheet",e).provider("$mdBottomSheet",t),t.$inject=["$$interimElementProvider"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2
 */
function(){"use strict";function e(e,t,n){function r(e){return angular.isDefined(e.href)||angular.isDefined(e.ngHref)}function o(e,t){return r(t)?'<a class="md-button" ng-transclude></a>':'<button class="md-button" ng-transclude></button>'}function a(o,a,i){var c=a[0];t(a),e.attachButtonBehavior(o,a);var d=c.textContent.trim();d||n.expect(a,"aria-label"),r(i)&&o.$watch(function(){return i.ngDisabled},function(e){a.attr("tabindex",e?-1:0)})}return{restrict:"E",replace:!0,transclude:!0,template:o,link:a}}angular.module("material.components.button",["material.core"]).directive("mdButton",e),e.$inject=["$mdInkRipple","$mdTheming","$mdAria"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2
 ...
 * v0.7.0-rc2
 */
function(){function e(e){function t(t,n){e(n)}function n(e,t){var n=this;n.setFocused=function(e){t.toggleClass("md-input-focused",!!e)},n.setHasValue=function(e){t.toggleClass("md-input-has-value",!!e)},e.$watch(function(){return n.label&&n.input},function(e){e&&!n.label.attr("for")&&n.label.attr("for",n.input.attr("id"))})}return n.$inject=["$scope","$element","$mdUtil"],{restrict:"E",link:t,controller:n}}function t(){return{restrict:"E",require:"^?mdInputContainer",link:function(e,t,n,r){r&&(r.label=t,e.$on("$destroy",function(){r.label=null}))}}}function n(e,t){function n(e){return e.addClass("md-input"),r}function r(n,r,o,a){function i(e){return d.setHasValue(!l.$isEmpty(e)),e}function c(){function e(e){a.style.height="auto";var t=a.scrollHeight-a.offsetHeight;return a.scrollTop=0,height=a.offsetHeight+(t>0?t:0),a.style.height=height+"px",e}function o(){a.scrollTop=0;var e=a.scrollHeight-a.offsetHeight;height=a.offsetHeight+e,a.style.height=height+"px"}var a=r[0];l?(l.$formatters.push(e),l.$parsers.push(e)):(r.on("input",e),e()),r.on("keyup",e),r.on("scroll",o),angular.element(t).on("resize",e),n.$on("$destroy",function(){angular.element(t).off("resize",e)})}var d=a[0],l=a[1];if(d){if("textarea"===r[0].tagName.toLowerCase()&&c(),d.input)throw new Error("<md-input-container> can only have *one* <input> or <textarea> child element!");r.attr("id")||r.attr("id","input_"+e.nextUid()),d.input=r,l?(l.$formatters.push(i),l.$parsers.push(i)):(r.on("input",function(){d.setHasValue((""+r.val()).length>0)}),d.setHasValue((""+r.val()).length>0)),r.on("focus",function(){d.setFocused(!0)}).on("blur",function(){d.setFocused(!1)}),n.$on("$destroy",function(){d.setFocused(!1),d.setHasValue(!1),d.input=null})}}return{restrict:"E",require:["^?mdInputContainer","?ngModel"],compile:n}}angular.module("material.components.input",["material.core"]).directive("mdInputContainer",e).directive("label",t).directive("input",n).directive("textarea",n),e.$inject=["$mdTheming"],n.$inject=["$mdUtil","$window"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2
 ...
 * v0.7.0-rc2
 */
function(){"use strict";function e(e,t,n,r,o,a,i){function c(c,m,u){function s(t){s.value=!!t,s.queued||(t?(s.queued=!0,e(function(){c.visible=s.value,s.queued=!1},d)):e(function(){c.visible=!1}))}function p(){m.removeClass("md-hide"),g.attr("aria-describedby",m.attr("id")),b.append(m),h(),n(function(){n(function(){h(),c.visible&&m.addClass("md-show")})})}function f(){m.removeClass("md-show").addClass("md-hide"),g.removeAttr("aria-describedby"),e(function(){c.visible||m.detach()},200,!1)}function h(){var e=o.elementRect(m,b),t=o.elementRect(g,b),n="bottom",r={left:t.left+t.width/2-e.width/2,top:t.top+t.height};r.left=Math.min(r.left,b.prop("scrollWidth")-e.width-l),r.left=Math.max(r.left,l),r.top+e.height>b.prop("scrollHeight")&&(r.top=t.top-e.height,n="top"),m.css({top:r.top+"px",left:r.left+"px"}),m.attr("width-32",Math.ceil(e.width/32)),m.attr("md-direction",n)}a(m);for(var g=m.parent(),E=m.parent()[0];E&&E!==i[0]&&E!==document.body&&(!E.tagName||"md-content"!=E.tagName.toLowerCase());)E=E.parentNode;var b=angular.element(E||document.body);m.detach(),m.attr("role","tooltip"),m.attr("id",u.id||"tooltip_"+o.nextUid()),g.on("focus mouseenter touchstart",function(){s(!0)}),g.on("blur mouseleave touchend touchcancel",function(){r[0].activeElement!==g[0]&&s(!1)}),c.$watch("visible",function(e){e?p():f()});var v=n.debounce(function(){c.visible&&h()});angular.element(t).on("resize",v),c.$on("$destroy",function(){c.visible=!1,m.remove(),angular.element(t).off("resize",v)})}var d=400,l=8;return{restrict:"E",transclude:!0,template:'<div class="md-background"></div><div class="md-content" ng-transclude></div>',scope:{visible:"=?mdVisible"},link:c}}angular.module("material.components.tooltip",["material.core"]).directive("mdTooltip",e),e.$inject=["$timeout","$window","$$rAF","$document","$mdUtil","$mdTheming","$rootElement"]}(),/*!
 * Angular Material Design
 * https://github.com/angular/material
 * @license MIT
 * v0.7.0-rc2
