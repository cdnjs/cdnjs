...
var useStrictRE = new RegExp(("^(" + (skipWhiteSpace.source) + "('([^']|\\.)*'|\"([^\"]|\\.)*\"|;))*" + (skipWhiteSpace.source) + "('use strict'|\"use strict\")"))
...
pp$3.parseFunctionBody = function(node, isArrowFunction) {
  var isExpression = isArrowFunction && this.type !== tt.braceL, strict = this.strict
  ...
  if (isExpression) {
    ...
    var oldLabels = this.labels, oldStrict = this.strict
  ...
  if (this.strict || strict) {
    var oldStrict$1 = this.strict
    this.strict = true
    if (node.id)
      this.checkLVal(node.id, true)
    this.checkParams(node)
    this.strict = oldStrict$1
