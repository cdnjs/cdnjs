...
pp.checkPatternErrors = function(refDestructuringErrors) {
  var trailing = refDestructuringErrors ? refDestructuringErrors.trailingComma : -1
  var parens = refDestructuringErrors ? refDestructuringErrors.parenthesized : -1
  ...
  for (;;) {
    if (this$1.eat(tt.dot)) {
      ...
      if (maybeAsyncArrow && !this$1.canInsertSemicolon() && this$1.eat(tt.arrow)) {
        this$1.checkPatternErrors(refDestructuringErrors)
