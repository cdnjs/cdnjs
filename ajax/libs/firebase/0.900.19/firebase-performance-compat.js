...
/**
     ...
     * limitations under the License.
     */
var Pe,Ce=function(){function t(t,e){this.app=t,this._performance=e}return Object.defineProperty(t.prototype,"instrumentationEnabled",{get:function(){return this._performance.instrumentationEnabled},set:function(t){this._performance.instrumentationEnabled=t},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"dataCollectionEnabled",{get:function(){return this._performance.dataCollectionEnabled},set:function(t){this._performance.dataCollectionEnabled=t},enumerable:!1,configurable:!0}),t.prototype.trace=function(t){return function(t,e){return new Te(t,e)}(this._performance,t)},t}();function Re(t){var e=t.getProvider("app-compat").getImmediate(),n=t.getProvider("performance-exp").getImmediate();return new Ce(e,n)}(Pe=r.default).INTERNAL.registerComponent(new m("performance-compat",Re,"PUBLIC")),Pe.registerVersion("@firebase/performance-compat","0.0.900")}).apply(this,arguments)}catch(t){throw console.error(t),new Error("Cannot instantiate firebase-performance-compat.js - be sure to load firebase-app.js first.")}}));
