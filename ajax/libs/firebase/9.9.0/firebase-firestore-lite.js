 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.9.0/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.9.0/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
...
registerVersion("firestore-lite", "3.4.12", ""), registerVersion("firestore-lite", "3.4.12", "esm2017");
