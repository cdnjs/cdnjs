...
/**
     ...
     * limitations under the License.
     */
class l{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise(((e,t)=>{this.resolve=e,this.reject=t}))}wrapCallback(e){return(t,n)=>{t?this.reject(t):this.resolve(n),"function"==typeof e&&(this.promise.catch((()=>{})),1===e.length?e(t):e(t,n))}}}function u(){return"undefined"!=typeof WorkerGlobalScope&&"undefined"!=typeof self&&self instanceof WorkerGlobalScope}function f(){try{return"object"==typeof indexedDB}catch(e){return!1}}function d(){return new Promise(((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var e;t((null===(e=i.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}}))}class p extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name="FirebaseError",Object.setPrototypeOf(this,p.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,h.prototype.create)}}class h{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},r=`${this.service}/${e}`,i=this.errors[e],a=i?function(e,t){return e.replace(g,((e,n)=>{const r=t[n];return null!=r?String(r):`<${n}?>`}))}(i,n):"Error",o=`${this.serviceName}: ${a} (${r}).`;return new p(r,o,n)}}const g=/\{\$([^}]+)}/g;
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){je("@firebase/app-compat","0.2.53-ssl-check.4f23f3343",e)}("lite");
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */}async function Rn({appConfig:e,heartbeatServiceProvider:t},n){const r=function(e,{fid:t}){return`${fn(e)}/${t}/authTokens:generate`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var dr;!function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.VISIBLE=1]="VISIBLE",e[e.HIDDEN=2]="HIDDEN"}(dr||(dr={}));const pr=["firebase_","google_","ga_"],hr=new RegExp("^[a-zA-Z]\\w*$");function gr(){const e=cr.getInstance().navigator;return(null==e?void 0:e.serviceWorker)?e.serviceWorker.controller?2:3:1}function mr(){switch(cr.getInstance().document.visibilityState){case"visible":return dr.VISIBLE;case"hidden":return dr.HIDDEN;default:return dr.UNKNOWN}}function vr(){const e=cr.getInstance().navigator.connection;switch(e&&e.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Or,Nr=3,Mr=[],Lr=!1;function Pr(e){setTimeout((()=>{Nr<=0||(Mr.length>0&&Rr(),Pr(1e4))}),e)}function Rr(){const e=Mr.splice(0,1e3),t=e.map((e=>({source_extension_json_proto3:e.message,event_time_ms:String(e.eventTime)})));(function(e){const t=fr.getInstance().getFlTransportFullUrl(),n=JSON.stringify(e);return navigator.sendBeacon&&navigator.sendBeacon(t,n)?Promise.resolve():fetch(t,{method:"POST",body:n,keepalive:!0}).then()})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:fr.getInstance().logSource,log_event:t}).then((()=>{Nr=3})).catch((()=>{Mr=[...e,...Mr],Nr--,rr.info(`Tries left: ${Nr}.`),Pr(1e4)}))}function Br(e){return(...t)=>{!function(e){if(!e.eventTime||!e.message)throw nr.create("invalid cc log");Mr=[...Mr,e]}({message:e(...t),eventTime:Date.now()})}}function Fr(){for(;Mr.length>0;)Rr()}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var ti;(ti=nt).INTERNAL.registerComponent(new y("performance-compat",ei,"PUBLIC")),ti.registerVersion("@firebase/performance-compat","0.2.15-ssl-check.4f23f3343");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return nt.registerVersion("firebase","11.6.0-ssl-check.4f23f3343","compat-lite"),nt}));
