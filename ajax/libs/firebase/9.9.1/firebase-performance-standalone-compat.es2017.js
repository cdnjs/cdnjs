...
/**
     ...
     * limitations under the License.
     */
class H{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const V="@firebase/app",z="0.7.29",q=new I("@firebase/app"),x="[DEFAULT]",W={[V]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},K=new Map,J=new Map;function G(e,t){try{e.container.addComponent(t)}catch(n){q.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Y(e){const t=e.name;if(J.has(t))return q.debug(`There were multiple attempts to register component ${t}.`),!1;J.set(t,e);for(const t of K.values())G(t,e);return!0}function X(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const oe="firebase-heartbeat-store";let se=null;function ce(){return se||(se=B("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(oe)}}).catch((e=>{throw Z.create("storage-open",{originalErrorMessage:e.message})}))),se}async function le(e,t){var n;try{const n=(await ce()).transaction(oe,"readwrite"),r=n.objectStore(oe);return await r.put(t,ue(e)),n.done}catch(e){throw Z.create("storage-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message})}}function ue(e){return`${e.name}!${e.options.appId}`}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function _e(e){const t={},n={__esModule:!0,initializeApp:function(r,i={}){const a=te(r,i);if(u(t,a.name))return t[a.name];const o=new e(a,n);return t[a.name]=o,o},app:i,registerVersion:re,setLogLevel:ae,onLog:ie,apps:null,SDK_VERSION:ee,INTERNAL:{registerComponent:function(t){const a=t.name,o=a.replace("-compat","");if(Y(t)&&"PUBLIC"===t.type){const s=(e=i())=>{if("function"!=typeof e[o])throw ve.create("invalid-app-argument",{appName:a});return e[o]()};void 0!==t.serviceProps&&r(s,t.serviceProps),n[o]=s,e.prototype[o]=function(...e){return this._getService.bind(this,a).apply(this,t.multipleInstances?e:[])}}return"PUBLIC"===t.type?n[o]:null},removeApp:function(e){delete t[e]},useAsService:function(e,t){if("serverAuth"===t)return null;return t},modularAPIs:me}};function i(e){if(!u(t,e=e||x))throw ve.create("no-app",{appName:e});return t[e]}return n.default=n,Object.defineProperty(n,"apps",{get:function(){return Object.keys(t).map((e=>t[e]))}}),i.App=e,n}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const we=function(){const e=_e(be);e.SDK_VERSION=`${e.SDK_VERSION}_LITE`;const t=e.INTERNAL.registerComponent;return e.INTERNAL.registerComponent=function(e){if("PUBLIC"===e.type&&!e.name.includes("performance")&&!e.name.includes("installations"))throw Error(`${name} cannot register with the standalone perf instance`);return t(e)},e}();!
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
function(e){re("@firebase/app-compat","0.1.30",e)}("lite");
/**
     * @license
...
/**
     ...
     * limitations under the License.
     */
const Be=/^[cdef][\w-]{21}$/;function $e(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const t=function(e){return(t=e,btoa(String.fromCharCode(...t)).replace(/\+/g,"-").replace(/\//g,"_")).substr(0,22);var t}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e);return Be.test(t)?t:""}catch(e){return""}}function je(e){return`${e.appName}!${e.appId}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const ze="firebase-installations-store";let qe=null;function xe(){return qe||(qe=B("firebase-installations-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(ze)}})),qe}async function We(e,t){const n=je(e),r=(await xe()).transaction(ze,"readwrite"),i=r.objectStore(ze),a=await i.get(n);return await i.put(t,n),await r.done,a&&a.fid===t.fid||Ue(e,t.fid),t}async function Ke(e){const t=je(e),n=(await xe()).transaction(ze,"readwrite");await n.objectStore(ze).delete(t),await n.done}async function Je(e,t){const n=je(e),r=(await xe()).transaction(ze,"readwrite"),i=r.objectStore(ze),a=await i.get(n),o=t(a);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||a&&a.fid===o.fid||Ue(e,o.fid),o}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const Mt="0.0.1",Rt={loggingEnabled:!0},Bt="FIREBASE_INSTALLATIONS_AUTH";function $t(e,t){const n=function(){const e=It.getInstance().localStorage;if(!e)return;const t=e.getItem(gt);if(!(t&&(n=t,Number(n)>Date.now())))return;var n;const r=e.getItem(dt);if(!r)return;try{return JSON.parse(r)}catch(e){return}}();return n?(Ft(n),Promise.resolve()):function(e,t){return function(e){const t=e.getToken();return t.then((e=>{})),t}(e.installations).then((n=>{const r=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.projectId;if(!n)throw bt.create("no project id");return n}(e.app),i=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.apiKey;if(!n)throw bt.create("no api key");return n}(e.app),a=new Request(`https://firebaseremoteconfig.googleapis.com/v1/projects/${r}/namespaces/fireperf:fetch?key=${i}`,{method:"POST",headers:{Authorization:`${Bt} ${n}`},body:JSON.stringify({app_instance_id:t,app_instance_id_token:n,app_id:Lt(e.app),app_version:lt,sdk_version:Mt})});return fetch(a).then((e=>{if(e.ok)return e.json();throw bt.create("RC response not ok")}))})).catch((()=>{vt.info(jt)}))}(e,t).then(Ft).then((e=>function(e){const t=It.getInstance().localStorage;if(!e||!t)return;t.setItem(dt,JSON.stringify(e)),t.setItem(gt,String(Date.now()+60*Ct.getInstance().configTimeToLive*60*1e3))}(e)),(()=>{}))}const jt="Could not fetch config, will use default configs";function Ft(e){if(!e)return e;const t=Ct.getInstance(),n=e.entries||{};return void 0!==n.fpr_enabled?t.loggingEnabled="true"===String(n.fpr_enabled):t.loggingEnabled=Rt.loggingEnabled,n.fpr_log_source?t.logSource=Number(n.fpr_log_source):Rt.logSource&&(t.logSource=Rt.logSource),n.fpr_log_endpoint_url?t.logEndPointUrl=n.fpr_log_endpoint_url:Rt.logEndPointUrl&&(t.logEndPointUrl=Rt.logEndPointUrl),n.fpr_log_transport_key?t.transportKey=n.fpr_log_transport_key:Rt.transportKey&&(t.transportKey=Rt.transportKey),void 0!==n.fpr_vc_network_request_sampling_rate?t.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate):void 0!==Rt.networkRequestsSamplingRate&&(t.networkRequestsSamplingRate=Rt.networkRequestsSamplingRate),void 0!==n.fpr_vc_trace_sampling_rate?t.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate):void 0!==Rt.tracesSamplingRate&&(t.tracesSamplingRate=Rt.tracesSamplingRate),t.logTraceAfterSampling=Ut(t.tracesSamplingRate),t.logNetworkAfterSampling=Ut(t.networkRequestsSamplingRate),e}function Ut(e){return Math.random()<=e}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Ht,Vt=1;function zt(e){return Vt=2,Ht=Ht||function(e){return function(){const e=It.getInstance().document;return new Promise((t=>{if(e&&"complete"!==e.readyState){const n=()=>{"complete"===e.readyState&&(e.removeEventListener("readystatechange",n),t())};e.addEventListener("readystatechange",n)}else t()}))}().then((()=>function(e){const t=e.getId();return t.then((e=>{yt=e})),t}(e.installations))).then((t=>$t(e,t))).then((()=>qt()),(()=>qt()))}(e),Ht}function qt(){Vt=3}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const xt=1e4;let Wt,Kt=3,Jt=[],Gt=!1;function Yt(e){setTimeout((()=>{if(0!==Kt)return Jt.length?void function(){const e=Jt.splice(0,1e3),t=e.map((e=>({source_extension_json_proto3:e.message,event_time_ms:String(e.eventTime)})));(function(e,t){return function(e){const t=Ct.getInstance().getFlTransportFullUrl();return fetch(t,{method:"POST",body:JSON.stringify(e)})}(e).then((e=>(e.ok||vt.info("Call to Firebase backend failed."),e.json()))).then((e=>{const n=Number(e.nextRequestWaitMillis);let r=xt;isNaN(n)||(r=Math.max(n,r));const i=e.logResponseDetails;Array.isArray(i)&&i.length>0&&"RETRY_REQUEST_LATER"===i[0].responseAction&&(Jt=[...t,...Jt],vt.info("Retry transport request later.")),Kt=3,Yt(r)}))})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:Ct.getInstance().logSource,log_event:t},e).catch((()=>{Jt=[...e,...Jt],Kt--,vt.info(`Tries left: ${Kt}.`),Yt(xt)}))}():Yt(xt)}),e)}function Xt(e){return(...t)=>{!function(e){if(!e.eventTime||!e.message)throw bt.create("invalid cc log");Jt=[...Jt,e]}({message:e(...t),eventTime:Date.now()})}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var hn;(hn=we).INTERNAL.registerComponent(new f("performance-compat",pn,"PUBLIC")),hn.registerVersion("@firebase/performance-compat","0.1.12");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return we.registerVersion("firebase","9.9.1","compat-lite"),we}));
