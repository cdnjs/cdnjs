(function (global, factory) {
    ...
    */
     ...
     */ class $ {
        ...
        getToken() {
            return Promise.resolve(new L$1(this.V, this.g));
        }
        T(t) {
    ...
    function je(t, e) {
        return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.Wt.isEqual(e.Wt) && (!!function(t, e) {
            return void 0 === t && void 0 === e || !(!t || !e) && j(t, e, ((t, e) => Le(t, e)));
     ...
     */ class bn {
        ...
        static Fe(t, e) {
            const n = new Map;
            return n.set(t, vn.Le(t, e)), new bn(H$1.min(), n, Vn(), dn(), Rn());
        }
    }
     ...
     */ class vn {
         ...
         */
        i) {
            this.resumeToken = t, this.$e = e, this.Be = n, this.qe = s, this.Ue = i;
        }
        /**
    ...
    class xn {
         ...
         */    gn(t) {
            ...
            return this.hn = dn(), this.ln = On(), this._n = new ln(W$1), s;
        }
        /**
     ...
     */
    function Bn(t, e) {
        return t.$t ? e.toBase64() : e.toUint8Array();
    }
    ...
    function ts(t, e) {
        ...
        if ("targetChange" in e) {
            ...
            const s = function(t) {
                ...
                return t.$t ? (C(void 0 === e || "string" == typeof e), rt.fromBase64String(e || "")) : (C(void 0 === e || e instanceof Uint8Array), 
     ...
     */ (o);
            ...
            s.document;
            const i = jn(t, s.document), r = s.readTime ? Un(s.readTime) : H$1.min(), o = new Ot(i, r), c = s.removedTargetIds || [];
            n = new Sn([], c, o.key, o);
     ...
     */ class As {
        ...
        next(t, e) {
            return this.Nn && D$1(), this.Nn = !0, this.Cn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new As(((n, s) => {
                this.Sn = e => {
    ...
    class Rs {
        constructor(t, e) {
             ...
             */
            this.$n = new ms, this.transaction.oncomplete = () => {
                this.$n.resolve();
            }, this.transaction.onabort = () => {
                e.error ? this.$n.reject(new gs(t, e.error)) : this.$n.resolve();
            }, this.transaction.onerror = e => {
                const n = Ss(e.target.error);
                this.$n.reject(new gs(t, n));
            };
        }
        static open(t, e, n, s) {
            try {
        ...
        abort(t) {
            t && this.$n.reject(t), this.aborted || (p$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
     ...
     */ class Ps {
        ...
        /** Deletes the specified database. */    static delete(t) {
            return p$1("SimpleDb", "Removing database:", t), bs(window.indexedDB.deleteDatabase(t)).kn();
        }
         ...
         */    async zn(t) {
            return this.db || (p$1("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
                ...
                s.onsuccess = t => {
                    ...
                    "VersionError" === s.name ? n(new O$1(x$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
                }, s.onupgradeneeded = t => {
    ...
    /** An error that wraps exceptions that thrown during IndexedDB execution. */ class gs extends O$1 {
        constructor(t, e) {
     ...
     */ function Cs(t, e) {
        if (b("AsyncQueue", `${e}: ${t}`), ys(t)) return new O$1(x$1.UNAVAILABLE, `${e}: ${t}`);
        throw t;
    }
    ...
    /** Decodes a remote document from storage locally to a Document. */ function oi(t, e) {
        if (e.document) return Xn(t.Os, e.document, !!e.hasCommittedMutations);
        if (e.noDocument) {
    ...
    function _i(t, e) {
        ...
        const s = e.mutations.map((e => ns(t.Os, e))), i = z$1.fromMillis(e.localWriteTimeMs);
    ...
    /** Encodes TargetData into a DbTarget for storage locally. */ function di(t, e) {
        ...
        let i;
        i = qt(e.target) ? is(t.Os, e.target) : rs(t.Os, e.target);
     ...
     */ class mi {
        ...
        Bs(t, e) {
            return this.$s.add(e), As.resolve();
        }
        qs(t, e) {
            return As.resolve(this.$s.getEntries(e));
        }
    }
     ...
     */ class Mi {
        ...
        Ui(t) {
            return this.Bi(t).next((t => H$1.L(new z$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
        }
        Ki(t) {
        ...
        Hi(t, e) {
            return this.Ji(t, e.targetId).next((() => Fi(t).delete(e.targetId))).next((() => this.Bi(t))).next((e => (C(e.targetCount > 0), 
        ...
        Bi(t) {
            return Li(t).get(Hs.key).next((t => (C(null !== t), t)));
        }
        qi(t, e) {
        ...
        ir(t, e) {
            ...
            return s.us({
                ...
                const s = Fs(t[1]), r = new tt(s);
                i = i.add(r);
            })).next((() => i));
        }
        Oi(t, e) {
            const n = Os(e.path), s = IDBKeyRange.bound([ n ], [ G$1(n) ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            let i = 0;
            return $i(t).us({
    ...
    /** Implements the steps for LRU garbage collection. */ class Ki {
        ...
        Rr(t, e) {
            if (0 === e) return As.resolve(U$1.k);
            const n = new qi(e);
            ...
            return this.Sr(t, ((r, o) => {
                if (o <= e) {
                    const e = this.Dr(t, r).next((e => {
                        ...
                        // removing them.
                        return i++, n.li(t, r).next((() => (n.hi(r), $i(t).delete([ 0, Os(r.path) ]))));
                    }));
                    s.push(e);
                }
    ...
    class Gi extends bi {
        ...
        di(t) {
            ...
            return this.ii.forEach(((i, r) => {
                ...
                if (r.ui) {
                    ...
                    const n = ci(this.Wr.Ut, new Ot(i, H$1.min()), this.oi(i));
        ...
        _i(t, e) {
            ...
            return this.Wr.Lr(t, e).next((t => null === t ? (this.jr.set(e, 0), null) : (this.jr.set(e, t.size), 
            t.ui)));
        }
        fi(t, e) {
    ...
    class tr {
        ...
        u) {
            ...
            this.ao = t => Promise.resolve(), !tr.Kn()) throw new O$1(x$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
     ...
     */
         ...
         */    start() {
            ...
            return this.Eo().then((() => {
                ...
                throw new O$1(x$1.FAILED_PRECONDITION, Zi);
        ...
        Vo(t) {
            return er(t).get($s.key).next((t => As.resolve(this.So(t))));
        }
        Do(t) {
        ...
        async Mo() {
            ...
            this.so = !1, this.Fo(), this.oo && (this.oo.cancel(), this.oo = null), this.Lo(), 
            this.$o(), 
            // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
            // has obtained the primary lease.
            await this.ho.runTransaction("shutdown", "readwrite", [ $s.store, Ys.store ], (t => {
                const e = new ei(t, U$1.k);
        ...
        runTransaction(t, e, n) {
            ...
            // are the only reader/writer.
                    return this.ho.runTransaction(t, s, ti, (s => (i = new ei(s, this.no ? this.no.next() : U$1.k), 
            "readwrite-primary" === e ? this.Vo(i).next((t => !!t || this.po(i))).next((e => {
                ...
                this.Xr.yo((() => this.ao(!1))), new O$1(x$1.FAILED_PRECONDITION, Ns);
                return n(i);
        ...
        Wo(t) {
            return er(t).get($s.key).next((t => {
                if (null !== t && this.No(t.leaseTimestampMs, 5e3) && !this.ko(t.ownerId) && !this.So(t) && !(this.eo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new O$1(x$1.FAILED_PRECONDITION, Zi);
            }));
        }
        /**
        ...
        /** Checks the primary lease and removes it if we are the current primary. */    bo(t) {
            const e = er(t);
            return e.get($s.key).next((t => this.So(t) ? (p$1("IndexedDbPersistence", "Releasing primary lease."), 
     ...
     */ class cr {
         ...
         */    hc(t, e, n, s) {
            ...
            return !!i && (i.hasPendingWrites || i.version.$(s) > 0);
        }
        ac(t, e) {
            ...
            return function(t, e, n, s) {
                ...
                return r.forEach((t => {
                    o = o.next((() => s.li(e, t))).next((e => {
                        let r = e;
                        const o = n.xs.get(t);
                        C(null !== o), (!r || r.version.$(o) < 0) && (r = i.vs(t, r, n), r && 
     ...
     */ (c, u, e) && o.push(n.lo.zi(t, u));
            ...
            o.push(dr(t, r, e.ke, s, void 0).next((t => {
                c = t;
            }))), !s.isEqual(H$1.min())) {
                const e = n.lo.Ui(t).next((e => n.lo.Qi(t, t.ps, s)));
                o.push(e);
            }
            return As.Fn(o).next((() => r.apply(t))).next((() => n.Ec.Xo(t, c)));
        })).then((t => (n._c = i, t)));
    }
    ...
    i) {
        ...
        return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
            ...
            return n.forEach(((n, o) => {
                ...
                // access.
                e.hi(n, a), r = r.Gt(n, o)) : null == c || o.version.$(c.version) > 0 || 0 === o.version.$(c.version) && c.hasPendingWrites ? (e.ci(o, a), 
    ...
    function Er(t, e) {
        ...
        return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
            ...
            s = i, As.resolve(s)) : n.lo.$i(t).next((i => (s = new Re(e, i, 0 /* Listen */ , t.ps), 
            n.lo.Wi(t, s).next((() => s)))))));
        })).then((t => {
            // If Multi-Tab is enabled, the existing target data may be newer than
            // the in-memory data
            const s = n._c.get(t.targetId);
            return (null === s || t.kt.$(s.kt) > 0) && (n._c = n._c.Gt(t.targetId, t), n.fc.set(e, t.targetId)), 
            t;
        }));
    }
    ...
    async function Vr(t, e, n = Rn()) {
        ...
        return i.persistence.runTransaction("Save named query", "readwrite", (t => {
            ...
            // has.
                    if (s.kt.$(r) >= 0) return i.fo.Ls(t, e);
            // Update existing target data because the query from the bundle is newer.
                    const o = s.Ft(rt.Et, r);
            return i._c = i._c.Gt(o.targetId, o), i.lo.zi(t, o).next((() => i.lo.Ji(t, s.targetId))).next((() => i.lo.tr(t, n, s.targetId))).next((() => i.fo.Ls(t, e)));
        }));
    }
    ...
    class pr {
        constructor(t, e) {
            this.key = t, this.Fc = e;
        }
        /** Compare by key then by ID */    static vc(t, e) {
            return tt.K(t.key, e.key) || W$1(t.Fc, e.Fc);
        }
        /** Compare by ID then by key */    static Dc(t, e) {
            return W$1(t.Fc, e.Fc) || tt.K(t.key, e.key);
        }
    }
     ...
     */ class br {
        ...
        Ai(t, e, n, s) {
            const i = this.Lc;
            if (this.Lc++, this.Go.length > 0) {
                this.Go[this.Go.length - 1];
            }
            const r = new si(i, e, n, s);
            this.Go.push(r);
            // Track references by document key and index collection parents.
            for (const e of s) this.$c = this.$c.add(new pr(e.key, i)), this.wi.Bs(t, e.key.path.G());
            return As.resolve(r);
        }
        Ri(t, e) {
        ...
        gi() {
            return As.resolve(0 === this.Go.length ? -1 : this.Lc - 1);
        }
        yi(t) {
        ...
        pi(t, e) {
            ...
            return this.$c.Ie([ n, s ], (t => {
                const e = this.Bc(t.Fc);
                i.push(e);
            })), As.resolve(i);
        }
        bi(t, e) {
        ...
        Oi(t, e) {
            const n = new pr(e, 0), s = this.$c.Ae(n);
    ...
    class vr {
        ...
        Kr(t, e, n) {
            ...
            for (;r.oe(); ) {
                ...
                o.$(n) <= 0 || i instanceof xt && Ie(e, i) && (s = s.Gt(i.key, i));
            }
            return As.resolve(s);
        }
        Wc(t, e) {
     ...
     */ class Dr {
        constructor(t) {
             ...
             * IDs.
             */
            this.zc = new yr, this.targetCount = 0, this.Hc = ki.Fi();
        }
        Tn(t, e) {
        ...
        ji(t) {
            ...
            const e = t.targetId;
            e > this.highestTargetId && (this.Hc = new ki(e), this.highestTargetId = e), t.sequenceNumber > this.Gc && (this.Gc = t.sequenceNumber);
        }
        Wi(t, e) {
        ...
        Hi(t, e) {
            return this.jc.delete(e.target), this.zc.Oc(e.targetId), this.targetCount -= 1, 
            As.resolve();
        }
        Yi(t, e, n) {
            let s = 0;
        ...
        Ji(t, e) {
            return this.zc.Oc(e), As.resolve();
        }
        ir(t, e) {
            const n = this.zc.Mc(e);
            return As.resolve(n);
        }
        Oi(t, e) {
            return As.resolve(this.zc.Oi(e));
        }
    }
    ...
    class Cr {
        ...
        runTransaction(t, e, n) {
            ...
            return this.Ei.Xc(), n(s).next((t => this.Ei.Zc(s).next((() => t)))).kn().then((t => (s.gs(), 
            t)));
        }
        ta(t, e) {
            return As.Ln(Object.values(this.Jc).map((n => () => n.Oi(t, e))));
        }
    }
    ...
    class xr {
        ...
        removeTarget(t, e) {
            this.ea.Oc(e.targetId).forEach((t => this.ia.add(t.toString())));
        ...
        ra(t, e) {
            return As.Ln([ () => As.resolve(this.ea.Oi(e)), () => this.persistence.vr().Oi(t, e), () => this.persistence.ta(t, e) ]);
        }
    }
    ...
    class Fr {
         ...
         */    static oa(t, e, n) {
            ...
            i && (r = new O$1(s.error.code, s.error.message))), i ? new Fr(t, e, s.state, r) : (b("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
            null);
        }
        ca() {
            const t = {
    ...
    class Lr {
         ...
         */    static oa(t, e) {
            ...
            s && (i = new O$1(n.error.code, n.error.message))), s ? new Lr(t, n.state, i) : (b("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
            null);
        }
        ca() {
            const t = {
     ...
     */ class $r {
         ...
         */    static oa(t, e) {
            ...
            return s ? new $r(t, i) : (b("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
            null);
        }
    }
     ...
     */ class Ur {
        constructor(t, e, n, s, i) {
            ...
            const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            this.storage = this.window.localStorage, this.currentUser = i, this.Ta = Or(this.persistenceKey, this.ha), 
            this.Ia = 
     ...
     */ (this.persistenceKey), this.wa = this.wa.Gt(this.ha, new qr), this.ma = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        ...
        Oa(t) {
            ...
            return this.ka.aa(t), this.ga(), e;
        }
        Ma(t) {
            this.ka.ua(t), this.ga();
        }
        Fa(t) {
     ...
     */ (e.newValue);
        ...
        ga() {
            this.setItem(this.Ta, this.ka.ca());
        }
        Ca(t, e, n) {
            const s = new Fr(this.currentUser, t, e, n), i = kr(this.persistenceKey, this.currentUser, t);
            this.setItem(i, s.ca());
        }
        xa(t) {
        ...
        Ba(t, e, n) {
            const s = Mr(this.persistenceKey, t), i = new Lr(t, e, n);
            this.setItem(s, i.ca());
        }
        Wa() {
    ...
    class {
        ...
        Du(t, e) {
            ...
            // enough the code is exception free.
                ...
                w || (w = !0, v$1("Connection", "WebChannel transport errored:", t), E.Au(new O$1(x$1.UNAVAILABLE, "The operation could not be completed")));
    ...
    class Xr {
         ...
         */ , i = 6e4) {
            this.Xr = t, this._s = e, this.Cu = n, this.Nu = s, this.xu = i, this.Ou = 0, this.ku = null, 
         ...
         */    Lu(t) {
            ...
            // honored as such).
            const e = Math.floor(this.Ou + this.$u()), n = Math.max(0, Date.now() - this.Mu), s = Math.max(0, e - n);
            // Guard against lastAttemptTime being in the future due to a clock change.
                    s > 0 && p$1("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Ou} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
            this.ku = this.Xr.Er(this._s, s, (() => (this.Mu = Date.now(), t()))), 
            // Apply backoff factor to determine next delay and ensure it is within
            // bounds.
            this.Ou *= this.Nu, this.Ou < this.Cu && (this.Ou = this.Cu), this.Ou > this.xu && (this.Ou = this.xu);
        }
        Bu() {
            null !== this.ku && (this.ku.As(), this.ku = null);
        }
        cancel() {
            null !== this.ku && (this.ku.cancel(), this.ku = null);
        }
        /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */    $u() {
    ...
    class Zr {
         ...
         */    async close(t, e) {
            ...
            this.ju.Fu()) : e && e.code === x$1.UNAUTHENTICATED && 
        ...
        Hu() {
            this.state = 4 /* Backoff */ , this.ju.Lu((async () => {
         ...
         */    ah(t) {
            ...
            e.database = Hn(this.Ut), e.addTarget = function(t, e) {
                ...
                return n = qt(s) ? {
                    ...
                    query: rs(t, s)
                }, n.targetId = e.targetId, e.resumeToken.wt() > 0 ? n.resumeToken = Bn(t, e.resumeToken) : e.kt.$(H$1.min()) > 0 && (
    ...
    class no extends class {} {
        ...
        Th() {
            if (this.Eh) throw new O$1(x$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
     ...
     */ class io {
        ...
        e, n, s, i) {
             ...
             */
            this.xh = [], this.Oh = i, this.Oh.ru((t => {
                n.Rs((async () => {
                    ...
                    await async function(t) {
                        const e = N$1(t);
                        e.Nh.add(4 /* ConnectivityChange */), await oo(e), e.kh.set("Unknown" /* Unknown */), 
    ...
    async function To(t, e) {
        ...
        t.kh.set("Unknown" /* Unknown */);
    }

    async function Io(t, e, n) {
        if (
        // Mark the client as online since we got a message from the server
        t.kh.set("Online" /* Online */), e instanceof Cn && 2 /* Removed */ === e.state && e.cause) 
        ...
        try {
            ...
            async function(t, e) {
                ...
                t.Ch.has(s) && (await t.Sh.Fh(s, n), t.Ch.delete(s), t.Mh.removeTarget(s));
            }
            /**
     ...
     */ (t, e);
            ...
            await mo(t, n);
        } else if (e instanceof Sn ? t.Mh.fn(e) : e instanceof Dn ? t.Mh.Rn(e) : t.Mh.En(e), 
            ...
            function(t, e) {
                ...
                // persistent view of these when applying the completed RemoteEvent.
                    ...
                    if (n.resumeToken.wt() > 0) {
                        const i = t.Ch.get(s);
                        // A watched target might have been removed already.
                                            i && t.Ch.set(s, i.Ft(n.resumeToken, e));
                    }
                })), 
     ...
     */ async function mo(t, e, n) {
        ...
        await oo(t), t.kh.set("Offline" /* Offline */), n || (
    ...
    async function Do(t, e) {
        ...
        await oo(n), n.kh.set("Unknown" /* Unknown */));
    }
     ...
     */ (t.bh, t.ls, {
            ...
            e ? (t.qh.Ju(), _o(t) ? lo(t) : t.kh.set("Unknown" /* Unknown */)) : (await t.qh.stop(), 
            wo(t));
        }))), t.qh;
    }
     ...
     */ class Uo {
         ...
         */    Pc(t) {
            return t.metadata.exists ? Xn(this.Ut, t.document, !1) : new Ot(this.Rc(t.metadata.name), this.Vc(t.metadata.readTime));
        }
        Vc(t) {
            return Un(t);
        }
     ...
     */ (t.type, e.type) || this.ul(t.doc, e.doc))), this.wl(n);
            const r = e ? this.El() : [], o = 0 === this.al.size && this.$e ? 1 /* Synced */ : 0 /* Local */ , c = o !== this.cl;
         ...
         */    jh(t) {
            return this.$e && "Offline" /* Offline */ === t ? (
     ...
     */ class Jo {
        ...
        s, i, r) {
            ...
            this.Ol = new Map, this.kl = ki.Li(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async function Yo(t, e) {
        ...
        s = r.targetId, n.gl.Oa(s), i = r.view.Al(); else {
            const t = await Er(n.ph, fe(e)), r = n.gl.Oa(t.targetId);
            s = t.targetId, i = await Xo(n, e, s, "current" === r), n.Fl && co(n.Pl, t);
        }
        return i;
    }
     ...
     */ async function Xo(t, e, n, s) {
        ...
        /* usePreviousResults= */ !0), r = new Go(e, i.Ac), o = r._l(i.documents), c = vn.Le(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.di(o, 
        /* updateLimboDocuments= */ t.Fl, c);
        lc$1(t, n, a.Tl);
    ...
    /** Stops listening to the query. */ async function Zo(t, e) {
        ...
        // No other queries are mapped to the target, clean up the query and the target.
            ...
            /*keepPersistedTargetData=*/ !1).then((() => {
                n.gl.La(s.targetId), ao(n.Pl, s.targetId), uc$1(n, s.targetId);
            })).catch(yi);
     ...
     */ function nc$1(t, e, n) {
        ...
        // SharedClientState.
            ...
            }(s.Vl, e), t.length && s.pl.oh(t), s.onlineState = e, s.Fl && s.gl.Ua(e);
        }
    }
    ...
    function uc$1(t, e, n = null) {
        t.gl.Ma(e);
        for (const s of t.vl.get(e)) t.bl.delete(s), n && t.pl.$l(s, n);
        if (t.vl.delete(e), t.Fl) {
            t.Nl.Oc(e).forEach((e => {
                t.Nl.Oi(e) || 
    ...
    function _c(t, e) {
        const n = e.key;
        t.Dl.get(n) || (p$1("SyncEngine", "New document in limbo: " + n), t.Sl.push(n), fc$1(t));
    }
     ...
     */ function fc$1(t) {
        for (;t.Sl.length > 0 && t.Dl.size < t.yl; ) {
            const e = t.Sl.shift(), n = t.kl.next();
            t.Cl.set(n, new Ho(e)), t.Dl = t.Dl.Gt(e, n), co(t.Pl, new Re(fe(oe(e.path)), n, 2 /* LimboResolution */ , U$1.k));
        }
    }
    ...
    async function dc$1(t, e, n) {
        ...
        s.bl.Y() || (s.bl.forEach(((t, c) => {
            o.push(s.Ll(c, e, n).then((t => {
                if (t) {
                    s.Fl && s.gl.$a(c.targetId, t.fromCache ? "not-current" : "current"), i.push(t);
            ...
            for (const t of e) {
                const e = t.targetId;
                if (!t.fromCache) {
                    const t = n._c.get(e), s = t.kt, i = t.Lt(s);
     ...
     */ async function Tc$1(t, e) {
        ...
        return n.Fl && lc$1(n, e.targetId, i.Tl), i;
    }
    ...
    async function Ac$1(t, e) {
        ...
        if (pc$1(n), bc$1(n), !0 === e && !0 !== n.Ml) {
            ...
            n.Ml = !0, await Do(n.Pl, !0);
            for (const t of e) co(n.Pl, t);
        } else if (!1 === e && !1 !== n.Ml) {
            const t = [];
            let e = Promise.resolve();
            n.vl.forEach(((s, i) => {
                n.gl.Fa(i) ? t.push(i) : e = e.then((() => (uc$1(n, i), Tr(n.ph, i, 
            ...
            function(t) {
                ...
                e.Cl.forEach(((t, n) => {
                    ao(e.Pl, n);
                })), e.Nl.kc(), e.Cl = new Map, e.Dl = new an(tt.K);
            }
            /**
    ...
    async function gc$1(t, e, n, s) {
        ...
        p$1("SyncEngine", "Ignoring unexpected query state notification."); else if (i.vl.has(e)) switch (n) {
          ...
          case "not-current":
            {
                const t = await Ar(i.ph), s = bn.Fe(e, "current" === n);
                await dc$1(i, t, s);
                break;
            }
    ...
    function pc$1(t) {
        const e = N$1(t);
        return e.Pl.Sh.Lh = ec$1.bind(null, e), e.Pl.Sh.bn = Ec$1.bind(null, e), e.Pl.Sh.Fh = sc$1.bind(null, e), 
        e.pl.oh = Fo.bind(null, e.Vl), e.pl.$l = Lo.bind(null, e.Vl), e;
    }

    function bc$1(t) {
        const e = N$1(t);
        return e.Pl.Sh.$h = ic$1.bind(null, e), e.Pl.Sh.Bh = rc$1.bind(null, e), e;
    }
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
            ...
            try {
                ...
                if (await function(t, e) {
                    ...
                    return n.persistence.runTransaction("hasNewerBundle", "readonly", (t => n.fo.ks(t, e.id))).then((t => !!t && t.createTime.$(s) >= 0));
                }
                /**
     ...
     */ (t.ph, s)) return await e.close(), void n.Bl(function(t) {
                ...
                await function(t, e) {
                    const n = N$1(t);
                    return n.persistence.runTransaction("Save bundle", "readwrite", (t => n.fo.Ms(t, e)));
                }
                /**
    ...
    class Sc$1 {
        ...
        async terminate() {
            this.jl && this.jl.stop(), await this.gl.Mo(), await this.persistence.Mo();
        }
    }
     ...
     */ class Cc$1 extends Dc$1 {
        ...
        Ql(t) {
            const e = Hr();
            if (!Ur.Kn(e)) throw new O$1(x$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
     ...
     */ class Nc$1 {
        async initialize(t, e) {
            ...
            this.Pl.Sh.e_ = wc$1.bind(null, this.la), await Do(this.Pl, this.la.Fl));
        }
        Zl(t) {
            return new Oo;
        }
    ...
    class Mc$1 {
         ...
         */    static fromBase64String(t) {
            try {
                return new Mc$1(rt.fromBase64String(t));
            } catch (t) {
         ...
         */    static fromUint8Array(t) {
            return new Mc$1(rt.fromUint8Array(t));
        }
        /**
    ...
    class Hc$1 {
        ...
        constructor(t, e) {
            ...
            this.m_ = new M$1) : (this.A_ = t, this.I_ = function(t) {
     ...
     */ (t), this.m_ = new F$1(e));
         ...
         * instance.
         */    get app() {
            if (!this.A_) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.A_;
        }
        get R_() {
            return this.T_;
        ...
        g_(t) {
            if (this.T_) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
    ...
    function ta$1(t, e, ...n) {
        ...
        {
            if (!(t instanceof Yc$1 || t instanceof Zc$1)) throw new O$1(x$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
     ...
     */ function ea$1(t, e) {
        if (t = Wc$1(t, Hc$1), qc$1("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
        return new Xc$1(t, 
        /* converter= */ null, 
        /**
    ...
    function na$1(t, e, ...n) {
        ...
        // 'undefined' and 'null'.
        1 === arguments.length && (e = Q$1.M()), qc$1("doc", "path", e), t instanceof Hc$1) {
            const s = Y$1.nt(e, ...n);
    ...
    class ma$1 extends $c$1 {
        constructor(t, e) {
            super(t), this.J_ = e;
        }
        z_(t) {
            const e = new Oe(t.Ut, ge(t.Ut, this.J_));
    ...
    function ya(t) {
        return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof z$1 || t instanceof ra$1 || t instanceof Mc$1 || t instanceof Yc$1 || t instanceof $c$1);
    }
     ...
     */ function ba$1(t, e, n) {
        ...
        // FieldPath.
        e instanceof Bc$1 && (e = e.d_), e instanceof Fc$1) return e.f_;
    ...
    function Da$1(t, e, n, s, i) {
        ...
        a += ")"), new O$1(x$1.INVALID_ARGUMENT, c + t + a);
    }
     ...
     */ class Na$1 {
        ...
        async ef(t) {
            if (this.nf(), this.mutations.length > 0) throw new O$1(x$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
            ...
            return e.forEach((t => {
                t instanceof Ot || t instanceof xt ? this.sf(t) : D$1();
            })), e;
        }
        set(t, e) {
    ...
    class Oa$1 {
         ...
         */
        e, n) {
            this.credentials = t, this.ls = e, this.Pu = n, this.user = P$1.UNAUTHENTICATED, this.clientId = Q$1.M(), 
         ...
         */    df() {
            if (this.ls.wf) throw new O$1(x$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        terminate() {
            this.ls.Ef();
            const t = new ms;
    ...
    async function Ma$1(t, e) {
        t.ls.Af();
        const n = await Fa$1(t);
        ...
        t.ff((n => t.ls.yo((() => async function(t, e) {
            ...
            n.kh.set("Unknown" /* Unknown */), await n.Sh.e_(e), n.Nh.delete(3 /* CredentialChange */), 
            await ro(n);
        }(e.Pl, n))))), t.If = e;
    }
    ...
    async function Fa$1(t) {
        ...
        await ka$1(t, new Sc$1)), t.mf;
    }

    async function La$1(t) {
        return t.If || (p$1("FirestoreClient", "Using default OnlineComponentProvider"), await Ma$1(t, new Nc$1)), 
        t.If;
    }

    function $a$1(t) {
        return Fa$1(t).then((t => t.persistence));
    }

    function Ba$1(t) {
        return Fa$1(t).then((t => t.ph));
    }

    function qa$1(t) {
        return La$1(t).then((t => t.Pl));
    }

    function Ua$1(t) {
        return La$1(t).then((t => t.la));
    }

    async function Ka$1(t) {
        const e = await La$1(t), n = e.Vl;
    ...
    /** Enables the network connection and re-enqueues all pending operations. */ function Qa$1(t) {
        return t.ls.enqueue((async () => {
            const e = await $a$1(t), n = await qa$1(t);
        ...
        return t.ls.Rs((async () => function(t, e, n, s, i) {
            const r = new Oc$1({
                next: n => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    e.Rs((() => Mo(t, o))), n.fromCache && "server" === s.source ? i.reject(new O$1(x$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                },
                error: t => i.reject(t)
            }), o = new Bo(n, r, {
                includeMetadataChanges: !0,
    ...
    function Za$1(t, e) {
        return t.ls.enqueue((async () => function(t, e) {
            const n = N$1(t);
            return n.persistence.runTransaction("Get named query", "readonly", (t => n.fo.Fs(t, e)));
        }(await Ba$1(t), e)));
    }
    ...
    class nu {
         ...
         * @private
         */    Bl(t) {
            this.ql(t), this.Ff.complete && this.Ff.complete(), this.Lf.resolve(t);
        }
        /**
         ...
         * @private
         */    Kl(t) {
            this.$f.taskState = "Error", this.Ff.next && this.Ff.next(this.$f), this.Ff.error && this.Ff.error(t), 
            this.Lf.reject(t);
        }
        /**
         ...
         * @private
         */    ql(t) {
            this.$f = t, this.Ff.next && this.Ff.next(t);
        }
    }
     ...
     */ function lu(t, e, n) {
        ...
        return t.ls.enqueue((async () => {
            try {
                await ka$1(t, n), await Ma$1(t, e), s.resolve();
            } catch (t) {
                if (!
                /**
    ...
    function _u(t) {
        if (t.R_ && !t.P_) throw new O$1(x$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const e = new ms;
    ...
    function mu(t) {
        if (t.R_ || t.P_) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
    }
     ...
     */ class bu {
         ...
         */    docChanges(t = {}) {
            ...
            if (e && this.ed.Ce) throw new O$1(x$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
     ...
     * limitations under the License.
     */ function Du(t) {
        if (ae(t) && 0 === t.Ct.length) throw new O$1(x$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
     ...
     * @returns The created `Query`.
     */ function Lu(t) {
        return jc$1("limit", t), new Fu("limit", t, "F" /* First */);
    }
     ...
     * @returns The created `Query`.
     */ function $u(t) {
        return jc$1("limitToLast", t), new Fu("limitToLast", t, "L" /* Last */);
    }
     ...
     */ (t.C_, t.firestore.I_, e, n[0].Zf, s);
        {
            ...
            return function(t, e, n, s, i, r) {
                ...
                for (let r = 0; r < i.length; r++) {
                    const a = i[r];
                    if (o[r].field.rt()) {
                        if ("string" != typeof a) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof a}`);
                        if (!le(t) && -1 !== a.indexOf("/")) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
    ...
    function Gu(t, e, n) {
        ...
        throw new O$1(x$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Qc$1(n) + ".");
    }
     ...
     */ class Xu {
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let r;
            return e instanceof Bc$1 && (e = e.d_), r = "string" == typeof e || e instanceof Fc$1 ? Ra$1(this.Id, "WriteBatch.update", i.S_, e, n, s) : Aa$1(this.Id, "WriteBatch.update", i.S_, e), 
        ...
        md() {
            if (this.Td) throw new O$1(x$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
        }
    }

    function Zu(t, e) {
        if (t instanceof Bc$1 && (t = t.d_), t.firestore !== e) throw new O$1(x$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return t;
    }
    ...
    function ah(t, e, n, ...s) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        e instanceof Bc$1 && (e = e.d_), o = "string" == typeof e || e instanceof Fc$1 ? Ra$1(r, "updateDoc", t.S_, e, n, s) : Aa$1(r, "updateDoc", t.S_, e);
    ...
    function lh(t, ...e) {
        ...
        return function(t, e, n, s) {
            const i = new Oc$1(s), r = new Bo(e, i, n);
            return t.ls.Rs((async () => ko(await Ka$1(t), r))), () => {
                i.s_(), t.ls.Rs((async () => Mo(await Ka$1(t), r)));
            };
        }(cu(u), h, c, a);
    }
     ...
     */ class wh extends class {
         ...
         */    get(t) {
            ...
            return this.Ad.ef([ e.S_ ]).then((t => {
                ...
                const s = t[0];
                if (s instanceof Ot) return new Ru(this.Yf, n, e.S_, null, e.v_);
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let r;
            return e instanceof Bc$1 && (e = e.d_), r = "string" == typeof e || e instanceof Fc$1 ? Ra$1(this.Id, "Transaction.update", i.S_, e, n, s) : Aa$1(this.Id, "Transaction.update", i.S_, e), 
    ...
    exports.FieldPath = Fc$1;
    exports.FieldValue = $c$1;
