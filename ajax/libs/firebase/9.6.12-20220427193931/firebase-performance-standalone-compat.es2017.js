...
/**
     ...
     * limitations under the License.
     */
function(e){W("@firebase/app-compat","0.1.22",e)}("lite");
/**
     * @license
     ...
     * limitations under the License.
     */
le.registerVersion("firebase","9.6.12-20220427193931","app-compat");const ue="@firebase/installations",he="0.5.8",pe=1e4,fe="w:0.5.8",de="FIS_v2",ge=36e5,me=new c("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function be(e){return e instanceof s&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function _e({projectId:e}){return`https://firebaseinstallations.googleapis.com/v1/projects/${e}/installations`}function ve(e){return{token:e.token,requestStatus:2,expiresIn:(t=e.expiresIn,Number(t.replace("s","000"))),creationTime:Date.now()};var t}async function we(e,t){const n=(await t.json()).error;return me.create("request-failed",{requestName:e,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function ye({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Ee(e,{refreshToken:t}){const n=ye(e);return n.append("Authorization",function(e){return`FIS_v2 ${e}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var mt;!function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.VISIBLE=1]="VISIBLE",e[e.HIDDEN=2]="HIDDEN"}(mt||(mt={}));const bt=["firebase_","google_","ga_"],_t=new RegExp("^[a-zA-Z]\\w*$");function vt(){const e=pt.getInstance().navigator;return"serviceWorker"in e?e.serviceWorker.controller?2:3:1}function wt(){switch(pt.getInstance().document.visibilityState){case"visible":return mt.VISIBLE;case"hidden":return mt.HIDDEN;default:return mt.UNKNOWN}}function yt(){const e=pt.getInstance().navigator.connection;switch(e&&e.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * limitations under the License.
     */
function Et(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.appId;if(!n)throw ot.create("no app id");return n}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var en;(en=le).INTERNAL.registerComponent(new v("performance-compat",Qt,"PUBLIC")),en.registerVersion("@firebase/performance-compat","0.1.8");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return le.registerVersion("firebase","9.6.12-20220427193931","compat-lite"),le}));
