...
/**
     ...
     * limitations under the License.
     */
!function(){const t={Functions:A};r.default.INTERNAL.registerComponent(new l("functions-compat",O,"PUBLIC").setServiceProps(t).setMultipleInstances(!0))}(),r.default.registerVersion("@firebase/functions-compat","0.0.900-exp.f41d11b71")}).apply(this,arguments)}catch(t){throw console.error(t),new Error("Cannot instantiate firebase-functions-compat.js - be sure to load firebase-app.js first.")}}));
