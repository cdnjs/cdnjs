...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */async function De(e,t){const n={method:"DELETE",headers:await Pe(e)};try{const i=await fetch(`${Oe(e.appConfig)}/${t}`,n),o=await i.json();if(o.error){const e=o.error.message;throw ge.create("token-unsubscribe-failed",{errorInfo:e})}}catch(e){throw ge.create("token-unsubscribe-failed",{errorInfo:e})}}function Oe({projectId:e}){return`https://fcmregistrations.googleapis.com/v1/projects/${e}/registrations`}async function Pe({appConfig:e,installations:t}){const n=await t.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e.apiKey,"x-goog-firebase-installations-auth":`FIS ${n}`})}function xe({p256dh:e,auth:t,endpoint:n,vapidKey:i}){const o={web:{endpoint:n,auth:t,p256dh:e}};return i!==he&&(o.web.applicationPubKey=i),o}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const vt=e=>navigator?new mt(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-exp").getImmediate()):new mt(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-sw-exp").getImmediate());i.default.INTERNAL.registerComponent(new d("messaging-compat",vt,"PUBLIC")),i.default.registerVersion("@firebase/messaging-compat","0.0.900-exp.f41d11b71")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-messaging-compat.js - be sure to load firebase-app.js first.")}}));
