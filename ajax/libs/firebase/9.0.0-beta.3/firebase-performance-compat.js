...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const gt="installations-exp",mt=t=>{const n=t.getProvider("app-exp").getImmediate();return{app:n,appConfig:function(t){if(!t||!t.options)throw ht("App Configuration");if(!t.name)throw ht("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw ht(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}(n),platformLoggerProvider:e._getProvider(n,"platform-logger"),_delete:()=>Promise.resolve()}},yt=t=>{const n=t.getProvider("app-exp").getImmediate(),r=e._getProvider(n,gt).getImmediate();return{getId:()=>async function(t){const e=t,{installationEntry:n,registrationPromise:r}=await it(e.appConfig);return r?r.catch(console.error):lt(e).catch(console.error),n.fid}(r),getToken:t=>dt(r,t)}};e._registerComponent(new f(gt,mt,"PUBLIC")),e._registerComponent(new f("installations-exp-internal",yt,"PRIVATE")),e.registerVersion("@firebase/installations-exp",R);const bt="0.0.900-exp.f41d11b71",vt=bt,_t="FB-PERF-TRACE-MEASURE",wt="_wt_",Et="_fcp",It="_fid",Tt="@firebase/performance/config",St="@firebase/performance/configexpire",Nt="Performance",Ot=new s("performance",Nt,{"trace started":"Trace {$traceName} was started before.","trace stopped":"Trace {$traceName} is not running.","nonpositive trace startTime":"Trace {$traceName} startTime should be positive.","nonpositive trace duration":"Trace {$traceName} duration should be positive.","no window":"Window is not available.","no app id":"App id is not available.","no project id":"Project id is not available.","no api key":"Api key is not available.","invalid cc log":"Attempted to queue invalid cc event","FB not default":"Performance can only start when Firebase app instance is the default one.","RC response not ok":"RC response is not ok","invalid attribute name":"Attribute name {$attributeName} is invalid.","invalid attribute value":"Attribute value {$attributeValue} is invalid.","invalid custom metric name":"Custom metric name {$customMetricName} is invalid","invalid String merger input":"Input for String merger is invalid, contact support team to resolve.","already initialized":"Performance can only be initialized once."}),At=new y(Nt);
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var Ee;(Ee=r.default).INTERNAL.registerComponent(new f("performance-compat",we,"PUBLIC")),Ee.registerVersion("@firebase/performance-compat","0.0.900-exp.f41d11b71")}).apply(this,arguments)}catch(t){throw console.error(t),new Error("Cannot instantiate firebase-performance-compat.js - be sure to load firebase-app.js first.")}}));
