...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const He=e=>new Fe(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-exp").getImmediate());r.default.INTERNAL.registerComponent(new p("messaging-compat",He,"PUBLIC")),r.default.registerVersion("@firebase/messaging-compat","0.0.900-exp.f6733b13b")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-messaging-compat.js - be sure to load firebase-app.js first.")}}));
