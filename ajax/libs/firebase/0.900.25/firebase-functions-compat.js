...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,t,r,n||{})}async function I(e,t,n,r){let i;n["Content-Type"]="application/json";try{i=await r(e,{method:"POST",body:JSON.stringify(t),headers:n})}catch(e){return{status:0,json:null}}let o=null;try{o=await i.json()}catch(e){}return{status:i.status,json:o}}function N(e,t,n){!function(e,t,n){e.emulatorOrigin=`http://${t}:${n}`}(c(e),t,n)}var T;T=fetch.bind(self),t._registerComponent(new l(h,((e,{instanceIdentifier:t})=>{const n=e.getProvider("app-exp").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("messaging");return new E(n,r,i,t,T)}),"PUBLIC").setMultipleInstances(!0)),t.registerVersion("@firebase/functions-exp","0.0.900-exp.f6733b13b");
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
!function(){const e={Functions:A};r.default.INTERNAL.registerComponent(new l("functions-compat",O,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))}(),r.default.registerVersion("@firebase/functions-compat","0.0.900-exp.f6733b13b")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-functions-compat.js - be sure to load firebase-app.js first.")}}));
