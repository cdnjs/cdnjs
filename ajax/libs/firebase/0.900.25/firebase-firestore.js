(function (global, factory) {
    ...
    */
     ...
     */ function k$1(t = "Unexpected state") {
        // Log the failure in addition to throw an exception, just in case the
        // exception is swallowed.
        const e = "FIRESTORE (8.4.1) INTERNAL ASSERTION FAILED: " + t;
    ...
    class U$1 {
         ...
         */
        e) {
            if (this.seconds = t, this.nanoseconds = e, e < 0) throw new b(P$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (e >= 1e9) throw new b(P$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (t < -62135596800) throw new b(P$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
            // This will break in the year 10,000.
                    if (t >= 253402300800) throw new b(P$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        }
        /**
         ...
         */    static now() {
            return U$1.fromMillis(Date.now());
        }
        /**
         ...
         *     date.
         */    static fromDate(t) {
            return U$1.fromMillis(t.getTime());
        }
        /**
    ...
    class G$1 {
        constructor(t, e, n) {
            void 0 === e ? e = 0 : e > t.length && k$1(), void 0 === n ? n = t.length - e : n > t.length - e && k$1(), 
        ...
        isEqual(t) {
            return 0 === G$1.comparator(this, t);
        }
        child(t) {
     ...
     */ class z$1 extends G$1 {
         ...
         */    static fromString(...t) {
            ...
            const e = [];
            for (const n of t) {
                if (n.indexOf("//") >= 0) throw new b(P$1.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
    ...
    /** A dot-separated path for navigating sub-objects within a document. */ class J$1 extends G$1 {
        ...
        canonicalString() {
            ...
            J$1.isValidIdentifier(t) || (t = "`" + t + "`"), t))).join(".");
        }
        toString() {
            return this.canonicalString();
        }
         ...
         */    static fromServerFormat(t) {
            ...
            let n = "", s = 0;
            const i = () => {
                if (0 === n.length) throw new b(P$1.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
                e.push(n), n = "";
            };
            let r = !1;
            for (;s < t.length; ) {
                const e = t[s];
                if ("\\" === e) {
                    if (s + 1 === t.length) throw new b(P$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                    const e = t[s + 1];
                    if ("\\" !== e && "." !== e && "`" !== e) throw new b(P$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                    n += e, s += 2;
                } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
            }
            if (i(), r) throw new b(P$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
            return new J$1(e);
        }
        static emptyPath() {
            return new J$1([]);
     ...
     */
        ...
        compareTo(t) {
            return L$1(this.binaryString, t.binaryString);
        }
        isEqual(t) {
    ...
    X$1.EMPTY_BYTE_STRING = new X$1("");

    const Z$1 = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
    ...
    /** Converts the possible Proto types for Blobs into a ByteString. */ function nt(t) {
        return "string" == typeof t ? X$1.fromBase64String(t) : X$1.fromUint8Array(t);
    }
     ...
     */ function rt(t) {
        ...
        return new U$1(e.seconds, e.nanos);
    }
     ...
     */ class at {
        ...
        static fromPath(t) {
            return new at(z$1.fromString(t));
        }
        static fromName(t) {
            return new at(z$1.fromString(t).popFirst(5));
        }
        /** Returns true if the document is in the specified collectionId. */    hasCollectionId(t) {
            return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
        }
        isEqual(t) {
            return null !== t && 0 === z$1.comparator(this.path, t.path);
        }
        toString() {
            return this.path.toString();
        }
        static comparator(t, e) {
            return z$1.comparator(t.path, e.path);
        }
    ...
    /** Extracts the backend's type order for the provided value. */ function ht(t) {
        return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? st(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : k$1();
    }
          ...
          case 2 /* NumberValue */ :
            return function(t, e) {
                ...
                if ("doubleValue" in t && "doubleValue" in e) {
                    ...
                    return n === s ? ct(n) === ct(s) : isNaN(n) && isNaN(s);
                }
                return !1;
            }(t, e);
        ...
        switch (n) {
          ...
          case 7 /* RefValue */ :
            return function(t, e) {
                ...
                return L$1(n.length, s.length);
            }(t.referenceValue, e.referenceValue);

          case 8 /* GeoPointValue */ :
            return function(t, e) {
                const n = L$1(et(t.latitude), et(e.latitude));
                if (0 !== n) return n;
                return L$1(et(t.longitude), et(e.longitude));
    ...
    function wt(t, e) {
        ...
        const n = tt(t), s = tt(e), i = L$1(n.seconds, s.seconds);
        return 0 !== i ? i : L$1(n.nanos, s.nanos);
    }
     ...
     */ class At {
         ...
         */    field(t) {
            return At.extractNestedValue(this.buildProto(), t);
        }
        /** Returns the full protobuf representation. */    toProto() {
            return this.field(J$1.emptyPath());
        }
        /**
        ...
        isEqual(t) {
            return lt(this.buildProto(), t.buildProto());
        }
        /**
         ...
         */    applyOverlay(t, e) {
            let n = !1;
            const s = At.extractNestedValue(this.partialValue, t), i = It(s) ? // If there is already data at the current path, base our
         ...
         */    buildProto() {
            const t = this.applyOverlay(J$1.emptyPath(), this.overlayMap);
        ...
        static extractNestedValue(t, e) {
            if (e.isEmpty()) return t;
            {
                ...
                for (let t = 0; t < e.length - 1; ++t) {
                    ...
                    if (n = n.mapValue.fields[e.get(t)], !It(n)) return null;
                }
     ...
     */ class Pt {
         ...
         */    static newInvalidDocument(t) {
            return new Pt(t, 0 /* INVALID */ , K$1.min(), At.empty(), 0 /* SYNCED */);
        }
        /**
        ...
        /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
            return new Pt(t, 2 /* NO_DOCUMENT */ , e, At.empty(), 0 /* SYNCED */);
        }
        /**
         ...
         */    static newUnknownDocument(t, e) {
            return new Pt(t, 3 /* UNKNOWN_DOCUMENT */ , e, At.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
        }
        /**
         ...
         */    convertToNoDocument(t) {
            return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = At.empty(), 
            this.documentState = 0 /* SYNCED */ , this;
        }
        /**
         ...
         */    convertToUnknownDocument(t) {
            return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = At.empty(), 
    ...
    function Vt(t) {
        ...
        if (null === e.h) {
            ...
            t += Kt(e.startAt)), e.endAt && (t += "|ub:", t += Kt(e.endAt)), e.h = t;
        }
        return e.h;
    }
    ...
    function St(t) {
        ...
        return `${(e = t).field.canonicalString()} ${e.op} ${_t(e.value)}`;
        /** Returns a debug description for `filter`. */
        var e;
        /** Filter that matches on key fields (i.e. '__name__'). */    })).join(", ")}]`), 
        ot(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
    }(t))).join(", ")}]`), t.startAt && (e += ", startAt: " + Kt(t.startAt)), t.endAt && (e += ", endAt: " + Kt(t.endAt)), 
        `Target(${e})`;
    }
    ...
    class Nt extends class {} {
         ...
         */    static create(t, e, n) {
            return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new kt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Ft(t, n) : "in" /* IN */ === e ? new Lt(t, n) : "not-in" /* NOT_IN */ === e ? new Bt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new qt(t, n) : new Nt(t, e, n);
        }
        static l(t, e, n) {
            return "in" /* IN */ === e ? new Ot(t, n) : new $t(t, n);
        }
        matches(t) {
    ...
    function xt(t) {
        ...
        return t.field.canonicalString() + t.op.toString() + _t(t.value);
    }
    ...
    /** Filter that matches on key fields within an array. */ class Ot extends Nt {
        constructor(t, e) {
            super(t, "in" /* IN */ , e), this.keys = Mt("in" /* IN */ , e);
        }
        matches(t) {
    ...
    /** Filter that matches on key fields not present within an array. */ class $t extends Nt {
        constructor(t, e) {
            super(t, "not-in" /* NOT_IN */ , e), this.keys = Mt("not-in" /* NOT_IN */ , e);
        }
        matches(t) {
            return !this.keys.some((e => e.isEqual(t.key)));
        }
    ...
    /** A Filter that implements the array-contains operator. */ class Ft extends Nt {
        constructor(t, e) {
    ...
    /** A Filter that implements the not-in operator. */ class Bt extends Nt {
        constructor(t, e) {
    ...
    /** A Filter that implements the array-contains-any operator. */ class qt extends Nt {
        constructor(t, e) {
            super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
        }
        matches(t) {
            const e = t.data.field(this.field);
            return !(!pt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => ft(this.value.arrayValue, t)));
        }
    }
    ...
    function Kt(t) {
        // TODO(b/29183165): Make this collision robust.
        return `${t.before ? "b" : "a"}:${t.position.map((t => _t(t))).join(",")}`;
    }
    ...
    /** Creates a new Query instance with the options provided. */ function Ht(t, e, n, s, i, r, o, c) {
     ...
     */ function ne(t) {
        ...
        if (null === e.p) {
            ...
            t.isKeyField() || e.p.push(new Qt(t)), e.p.push(new Qt(J$1.keyField(), "asc" /* ASCENDING */)); else {
                let t = !1;
                ...
                if (!t) {
                    ...
                    e.p.push(new Qt(J$1.keyField(), t));
                }
            }
        }
        return e.p;
     ...
     */ function se(t) {
        const e = $(t);
        if (!e.T) if ("F" /* First */ === e.limitType) e.T = vt(e.path, e.collectionGroup, ne(e), e.filters, e.limit, e.startAt, e.endAt); else {
            ...
            // We need to swap the cursors to match the now-flipped query ordering.
                    const n = e.endAt ? new Ut(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new Ut(e.startAt.position, !e.startAt.before) : null;
    ...
    function re(t, e) {
        return Dt(se(t), se(e)) && t.limitType === e.limitType;
    }
    ...
    function oe(t) {
        return `${Vt(se(t))}|lt:${t.limitType}`;
    }

    function ce(t) {
        return `Query(target=${St(se(t))}; limitType=${t.limitType})`;
    }
     ...
     */ (t, e) && function(t, e) {
        ...
        /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
            if (t.startAt && !Wt(t.startAt, ne(t), e)) return !1;
            if (t.endAt && Wt(t.endAt, ne(t), e)) return !1;
            return !0;
        }
        /**
    ...
    function he(t, e, n) {
        const s = t.field.isKeyField() ? at.comparator(e.key, n.key) : function(t, e, n) {
            ...
            return null !== s && null !== i ? dt(s, i) : k$1();
        }(t.field, e, n);
        switch (t.dir) {
          case "asc" /* ASCENDING */ :
            return s;
     ...
     */ function _e(t, e, n) {
        ...
        }(n, e) : t instanceof pe ? Ee(t, e) : t instanceof Te ? Ie(t, e) : function(t, e) {
            // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
            // precision and resolves overflows by reducing precision, we do not
            // manually cap overflows at 2^63.
            const n = ge(t, e), s = Re(n) + Re(t.A);
            return yt(n) && yt(t.A) ? fe(s) : le(t.R, s);
        }(t, e);
    }
     ...
     */ function me(t, e, n) {
        ...
        // applications.
        return t instanceof pe ? Ee(t, e) : t instanceof Te ? Ie(t, e) : n;
    }
     ...
     */ function ge(t, e) {
        return t instanceof Ae ? yt(n = e) || function(t) {
    ...
    /** Transforms an array value via a remove operation. */ class Te extends we {
        constructor(t) {
            super(), this.elements = t;
        }
    }
    ...
    function ve(t, e) {
        return t.field.isEqual(e.field) && function(t, e) {
            return t instanceof pe && e instanceof pe || t instanceof Te && e instanceof Te ? B(t.elements, e.elements, lt) : t instanceof Ae && e instanceof Ae ? lt(t.A, e.A) : t instanceof ye && e instanceof ye;
     ...
     */ function Ne(t, e, n) {
        t instanceof Me ? function(t, e, n) {
            // Unlike applySetMutationToLocalView, if we're applying a mutation to a
            // remote document the server has accepted the mutation so the precondition
            // must have held.
            const s = t.value.clone(), i = Be(t.fieldTransforms, e, n.transformResults);
            ...
            const s = Be(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(Le(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
     ...
     */ function xe(t, e, n) {
        t instanceof Me ? function(t, e, n) {
            ...
            s.setAll(i), e.convertToFoundDocument($e(e), s).setHasLocalMutations();
        }
        /**
     ...
     *    ignored.
     */ (t, e, n) : t instanceof Fe ? function(t, e, n) {
            if (!De(t.precondition, e)) return;
            const s = qe(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Le(t)), i.setAll(s), e.convertToFoundDocument($e(e), i).setHasLocalMutations();
        }
        /**
     ...
     */ function ke(t, e) {
        ...
        for (const s of t.fieldTransforms) {
            ...
            null != i && (null == n && (n = At.empty()), n.set(s.field, i));
        }
        return n || null;
    }
    ...
    function Ge(t) {
        switch (t) {
          ...
          case P$1.CANCELLED:
          case P$1.UNKNOWN:
          case P$1.DEADLINE_EXCEEDED:
          case P$1.RESOURCE_EXHAUSTED:
          case P$1.INTERNAL:
          case P$1.UNAVAILABLE:
     // Unauthenticated means something went wrong with our token and we need
            // to retry with new credentials which will happen automatically.
                  case P$1.UNAUTHENTICATED:
            return !1;

          case P$1.INVALID_ARGUMENT:
          case P$1.NOT_FOUND:
          case P$1.ALREADY_EXISTS:
          case P$1.PERMISSION_DENIED:
          case P$1.FAILED_PRECONDITION:
     // Aborted might be retried in some scenarios, but that is dependant on
            // the context and should handled individually by the calling code.
            // See https://cloud.google.com/apis/design/errors.
                  case P$1.ABORTED:
          case P$1.OUT_OF_RANGE:
          case P$1.UNIMPLEMENTED:
          case P$1.DATA_LOSS:
            return !0;
    ...
    function ze(t) {
        ...
        return C("GRPC error has no .code"), P$1.UNKNOWN;
        switch (t) {
          case je.OK:
            return P$1.OK;

          case je.CANCELLED:
            return P$1.CANCELLED;

          case je.UNKNOWN:
            return P$1.UNKNOWN;

          case je.DEADLINE_EXCEEDED:
            return P$1.DEADLINE_EXCEEDED;

          case je.RESOURCE_EXHAUSTED:
            return P$1.RESOURCE_EXHAUSTED;

          case je.INTERNAL:
            return P$1.INTERNAL;

          case je.UNAVAILABLE:
            return P$1.UNAVAILABLE;

          case je.UNAUTHENTICATED:
            return P$1.UNAUTHENTICATED;

          case je.INVALID_ARGUMENT:
            return P$1.INVALID_ARGUMENT;

          case je.NOT_FOUND:
            return P$1.NOT_FOUND;

          case je.ALREADY_EXISTS:
            return P$1.ALREADY_EXISTS;

          case je.PERMISSION_DENIED:
            return P$1.PERMISSION_DENIED;

          case je.FAILED_PRECONDITION:
            return P$1.FAILED_PRECONDITION;

          case je.ABORTED:
            return P$1.ABORTED;

          case je.OUT_OF_RANGE:
            return P$1.OUT_OF_RANGE;

          case je.UNIMPLEMENTED:
            return P$1.UNIMPLEMENTED;

          case je.DATA_LOSS:
            return P$1.DATA_LOSS;
     ...
     *     Code.UNKNOWN.
     */ (We = je || (je = {}))[We.OK = 0] = "OK", We[We.CANCELLED = 1] = "CANCELLED", 
    ...
    class He {
        ...
        insert(t, e) {
            return new He(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, Ye.BLACK, null, null));
        }
        // Returns a copy of the map, with the specified key removed.
        remove(t) {
            return new He(this.comparator, this.root.remove(t, this.comparator).copy(null, null, Ye.BLACK, null, null));
        }
    ...
    class Ye {
        constructor(t, e, n, s, i) {
            this.key = t, this.value = e, this.color = null != n ? n : Ye.RED, this.left = null != s ? s : Ye.EMPTY, 
            this.right = null != i ? i : Ye.EMPTY, this.size = this.left.size + 1 + this.right.size;
        }
        // Returns a copy of the current node, optionally replacing pieces of it.
        copy(t, e, n, s, i) {
            return new Ye(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
        }
        isEmpty() {
            return !1;
        }
        ...
        remove(t, e) {
            ...
            s = s.copy(null, null, null, s.left.remove(t, e), null); else {
                ...
                0 === e(t, s.key)) {
                    if (s.right.isEmpty()) return Ye.EMPTY;
        ...
        rotateLeft() {
            const t = this.copy(null, null, Ye.RED, null, this.right.left);
            return this.right.copy(null, null, this.color, t, null);
        }
        rotateRight() {
            const t = this.copy(null, null, Ye.RED, this.left.right, null);
        ...
        check() {
            if (this.isRed() && this.left.isRed()) throw k$1();
            if (this.right.isRed()) throw k$1();
            const t = this.left.check();
            if (t !== this.right.check()) throw k$1();
     ...
     */ class ln {
        ...
        static createSynthesizedRemoteEventForCurrentChange(t, e) {
            const n = new Map;
            return n.set(t, fn.createSynthesizedTargetChangeForCurrentChange(t, e)), new ln(K$1.min(), n, hn(), en(), un());
        }
    }
     ...
     */ class fn {
         ...
         */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
            return new fn(X$1.EMPTY_BYTE_STRING, e, un(), un(), un());
        }
    }
    ...
    /** Tracks the internal state of a Watch target. */ class mn {
        constructor() {
            ...
            this.C = X$1.EMPTY_BYTE_STRING, this.N = !1, 
            /**
    ...
    class gn {
         ...
         */    rt(t) {
            ...
            if (s) {
                ...
                if (Ct(t)) if (0 === n) {
                    ...
                    this.tt(e, n, Pt.newNoDocument(n, K$1.min()));
                } else O$1(1 === n); else {
                    this.ct(e) !== n && (
         ...
         */    ut(t) {
            ...
            const s = new ln(t, e, this.Y, this.H, n);
            return this.H = en(), this.J = yn(), this.Y = new Xe(L$1), s;
        }
        /**
        ...
        nt(t) {
            let e = this.G.get(t);
            return e || (e = new mn, this.G.set(t, e)), e;
        }
        ht(t) {
            let e = this.J.get(t);
            return e || (e = new Xe(L$1), this.J = this.J.insert(t, e)), e;
        }
        /**
         ...
         */    st(t) {
            ...
            return e || D$1("WatchChangeAggregator", "Detected inactive target", t), e;
        }
        /**
     ...
     */ function Pn(t, e) {
        return An(t, e.toTimestamp());
    }

    function bn(t) {
        return O$1(!!t), K$1.fromTimestamp(function(t) {
            const e = tt(t);
            return new U$1(e.seconds, e.nanos);
        }(t));
    }
    ...
    function Dn(t, e) {
        const n = Vn(e);
        if (n.get(1) !== t.databaseId.projectId) throw new b(P$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
        if (n.get(3) !== t.databaseId.database) throw new b(P$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
        return new at(kn(n));
    }
    ...
    function Nn(t) {
        ...
        // in the local target cache.
            return 4 === e.length ? z$1.emptyPath() : kn(e);
    }

    function xn(t) {
        return new z$1([ "projects", t.databaseId.projectId, "databases", t.databaseId.database ]).canonicalString();
    }

    function kn(t) {
        return O$1(t.length > 4 && "documents" === t.get(4)), t.popFirst(5);
    }

    /** Creates a Document proto from key and fields (but no create/update time) */ function On(t, e, n) {
        return {
            name: Sn(t, e),
    ...
    function $n(t, e, n) {
        const s = Dn(t, e.name), i = bn(e.updateTime), r = new At({
            mapValue: {
                fields: e.fields
            }
    ...
    function Mn(t, e) {
        return "found" in e ? function(t, e) {
            O$1(!!e.found), e.found.name, e.found.updateTime;
            const n = Dn(t, e.found.name), s = bn(e.found.updateTime), i = new At({
                mapValue: {
            ...
            O$1(!!e.missing), O$1(!!e.readTime);
            const n = Dn(t, e.missing), s = bn(e.readTime);
    ...
    function Fn(t, e) {
        ...
        if ("targetChange" in e) {
            ...
            // if unset
            const s = function(t) {
                return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : k$1();
            }(e.targetChange.targetChangeType || "NO_CHANGE"), i = e.targetChange.targetIds || [], r = function(t, e) {
                return t.I ? (O$1(void 0 === e || "string" == typeof e), X$1.fromBase64String(e || "")) : (O$1(void 0 === e || e instanceof Uint8Array), 
                X$1.fromUint8Array(e || new Uint8Array));
            }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
                const e = void 0 === t.code ? P$1.UNKNOWN : ze(t.code);
     ...
     */ (o);
            n = new _n(s, i, r, c || null);
        } else if ("documentChange" in e) {
            e.documentChange;
            const s = e.documentChange;
            s.document, s.document.name, s.document.updateTime;
            const i = Dn(t, s.document.name), r = bn(s.document.updateTime), o = new At({
                mapValue: {
                    fields: s.document.fields
                }
            }), c = Pt.newFoundDocument(i, r, o), u = s.targetIds || [], a = s.removedTargetIds || [];
            n = new dn(u, a, c.key, c);
        } else if ("documentDelete" in e) {
            e.documentDelete;
            const s = e.documentDelete;
            s.document;
            const i = Dn(t, s.document), r = s.readTime ? bn(s.readTime) : K$1.min(), o = Pt.newNoDocument(i, r), c = s.removedTargetIds || [];
            n = new dn([], c, o.key, o);
        } else if ("documentRemove" in e) {
            e.documentRemove;
            const s = e.documentRemove;
            s.document;
            const i = Dn(t, s.document), r = s.removedTargetIds || [];
            n = new dn([], r, i, null);
        } else {
            if (!("filter" in e)) return k$1();
            {
                e.filter;
                const t = e.filter;
                t.targetId;
    ...
    function Bn(t, e) {
        const n = e.currentDocument ? function(t) {
            return void 0 !== t.updateTime ? Se.updateTime(bn(t.updateTime)) : void 0 !== t.exists ? Se.exists(t.exists) : Se.none();
        }(e.currentDocument) : Se.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
            let n = null;
            if ("setToServerValue" in e) O$1("REQUEST_TIME" === e.setToServerValue), n = new ye; else if ("appendMissingElements" in e) {
                const t = e.appendMissingElements.values || [];
                n = new pe(t);
            } else if ("removeAllFromArray" in e) {
                const t = e.removeAllFromArray.values || [];
                n = new Te(t);
            } else "increment" in e ? n = new Ae(t, e.increment) : k$1();
            const s = J$1.fromServerFormat(e.fieldPath);
            return new be(s, n);
        }(t, e))) : [];
        if (e.update) {
            e.update.name;
            const i = Dn(t, e.update.name), r = new At({
                mapValue: {
            ...
            if (e.updateMask) {
                const t = function(t) {
                    ...
                    return new Y$1(e.map((t => J$1.fromServerFormat(t))));
                }(e.updateMask);
                return new Fe(i, r, t, n, s);
            }
            return new Me(i, r, n, s);
        }
        if (e.delete) {
            const s = Dn(t, e.delete);
            return new Ue(s, n);
        }
        if (e.verify) {
            const s = Dn(t, e.verify);
            return new Ke(s, n);
        }
        return k$1();
    }
    ...
    function qn(t, e) {
        return t && t.length > 0 ? (O$1(void 0 !== e), t.map((t => function(t, e) {
            ...
            n = bn(e)), new Ve(n, t.transformResults || []);
        }(t, e)))) : [];
    }
    ...
    function Kn(t, e) {
        ...
        null !== e.collectionGroup ? (n.parent = Cn(t, s), n.structuredQuery.from = [ {
            collectionId: e.collectionGroup,
            allDescendants: !0
        } ]) : (n.parent = Cn(t, s.popLast()), n.structuredQuery.from = [ {
     ...
     */ (t, e.limit);
        return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = Gn(e.startAt)), 
        e.endAt && (n.structuredQuery.endAt = Gn(e.endAt)), n;
    }
    ...
    function Qn(t) {
        ...
        let r = [];
        n.where && (r = Wn(n.where));
        let o = [];
        n.orderBy && (o = n.orderBy.map((t => function(t) {
            return new Qt(Xn(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
        ...
        let a = null;
        return n.endAt && (a = zn(n.endAt)), Ht(e, i, o, r, c, "F" /* First */ , u, a);
    }
    ...
    function Wn(t) {
        return t ? void 0 !== t.unaryFilter ? [ ts(t) ] : void 0 !== t.fieldFilter ? [ Zn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Wn(t))).reduce(((t, e) => t.concat(e))) : k$1() : [];
    }
    ...
    function Xn(t) {
        return J$1.fromServerFormat(t.fieldPath);
    }

    function Zn(t) {
        return Nt.create(Xn(t.fieldFilter.field), function(t) {
            switch (t) {
              case "EQUAL":
                return "==" /* EQUAL */;
    ...
    function ts(t) {
        switch (t.unaryFilter.op) {
          case "IS_NAN":
            const e = Xn(t.unaryFilter.field);
            return Nt.create(e, "==" /* EQUAL */ , {
                doubleValue: NaN
            });

          case "IS_NULL":
            const n = Xn(t.unaryFilter.field);
            return Nt.create(n, "==" /* EQUAL */ , {
                nullValue: "NULL_VALUE"
            });

          case "IS_NOT_NAN":
            const s = Xn(t.unaryFilter.field);
            return Nt.create(s, "!=" /* NOT_EQUAL */ , {
                doubleValue: NaN
            });

          case "IS_NOT_NULL":
            const i = Xn(t.unaryFilter.field);
    ...
    function ss(t) {
        let e = "";
        for (let n = 0; n < t.length; n++) e.length > 0 && (e = rs(e)), e = is(t.get(n), e);
        return rs(e);
    }
    ...
    /** Encodes a path separator into the given result */ function rs(t) {
        return t + "";
    }
     ...
     */ function os(t) {
        ...
        const e = t.length;
        if (O$1(e >= 2), 2 === e) return O$1("" === t.charAt(0) && "" === t.charAt(1)), z$1.emptyPath();
    ...
    /** Name of the IndexedDb object store.  */ as.store = "mutationQueues", 
    ...
    /** Name of the IndexedDb object store.  */ hs.store = "mutations", 
    /** Keys are automatically assigned via the userId, batchId properties. */
    hs.keyPath = "batchId", 
    /** The index name for lookup of mutations by user. */
    hs.userMutationsIndex = "userMutationsIndex", 
    /** The user mutations index is keyed by [userId, batchId] pairs. */
    hs.userMutationsKeyPath = [ "userId", "batchId" ];
    ...
    /** Name of the IndexedDb object store. */ Es.store = "clientMetadata", 
    ...
    /** Name of the IndexedDb object store. */ Ts.store = "bundles", Ts.keyPath = "bundleId";
    ...
    /** Name of the IndexedDb object store. */ Is.store = "namedQueries", Is.keyPath = "name";
     ...
     */ class vs {
        ...
        next(t, e) {
            return this.callbackAttached && k$1(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new vs(((n, s) => {
                this.nextCallback = e => {
    ...
    class Vs {
        constructor(t, e) {
            ...
            this.ft = new bs, this.transaction.oncomplete = () => {
                ...
                e.error ? this.ft.reject(new Cs(t, e.error)) : this.ft.resolve();
            }, this.transaction.onerror = e => {
                const n = $s(e.target.error);
                this.ft.reject(new Cs(t, n));
            };
        }
        static open(t, e, n, s) {
            try {
        ...
        abort(t) {
            t && this.ft.reject(t), this.aborted || (D$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
     ...
     */ class Ss {
        ...
        constructor(t, e, n) {
            ...
            // log on 12.2.
            12.2 === Ss._t(getUA()) && C("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
        }
        /** Deletes the specified database. */    static delete(t) {
            return D$1("SimpleDb", "Removing database:", t), ks(window.indexedDB.deleteDatabase(t)).toPromise();
        }
        /** Returns true if IndexedDB is available in the current environment. */    static gt() {
            ...
            // Check the UA string to find out the browser.
                    const t = getUA(), e = Ss._t(t), n = 0 < e && e < 10, s = Ss.Et(t), i = 0 < s && s < 4.5;
            // IE 10
         ...
         */    async At(t) {
            return this.db || (D$1("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
                ...
                s.onsuccess = t => {
                    ...
                    n(new Cs(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                }, s.onerror = e => {
                    const s = e.target.error;
                    "VersionError" === s.name ? n(new b(P$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Cs(t, s));
                }, s.onupgradeneeded = t => {
                    D$1("SimpleDb", 'Database "' + this.name + '" requires upgrade from version:', t.oldVersion);
                    const e = t.target.result;
                    this.wt.Rt(e, s.transaction, t.oldVersion, this.version).next((() => {
                        D$1("SimpleDb", "Database upgrade to version " + this.version + " complete");
                    }));
                };
        ...
        async runTransaction(t, e, n, s) {
            ...
            for (;;) {
                ...
                try {
                    ...
                    if (D$1("SimpleDb", "Transaction failed with error:", t.message, "Retrying:", e), 
    ...
    /** An error that wraps exceptions that thrown during IndexedDB execution. */ class Cs extends b {
        constructor(t, e) {
            super(P$1.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
        }
    }

    /** Verifies whether `e` is an IndexedDbTransactionError. */ function Ns(t) {
     ...
     */ class xs {
        ...
        put(t, e) {
            let n;
            return void 0 !== e ? (D$1("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (D$1("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
            n = this.store.put(t)), ks(n);
        }
        /**
         ...
         */    add(t) {
            D$1("SimpleDb", "ADD", this.store.name, t, t);
            return ks(this.store.add(t));
        }
        /**
         ...
         */    get(t) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            return ks(this.store.get(t)).next((e => (
            // Normalize nonexistence to null.
            void 0 === e && (e = null), D$1("SimpleDb", "GET", this.store.name, t, e), e)));
        }
        delete(t) {
            D$1("SimpleDb", "DELETE", this.store.name, t);
            return ks(this.store.delete(t));
        }
        /**
         ...
         */    count() {
            D$1("SimpleDb", "COUNT", this.store.name);
        ...
        kt(t, e) {
            D$1("SimpleDb", "DELETE ALL", this.store.name);
        ...
        xt(t, e) {
            ...
            return new vs(((s, i) => {
                t.onerror = t => {
                    ...
                    if (!i) return void s();
                    const r = new Ds(i), o = e(i.primaryKey, i.value, r);
                    if (o instanceof vs) {
     ...
     */ class Ls {
         ...
         */    applyToLocalView(t) {
            ...
            for (const e of this.baseMutations) e.key.isEqual(t.key) && xe(e, t, this.localWriteTime);
            // Second, apply all user-provided mutations.
                    for (const e of this.mutations) e.key.isEqual(t.key) && xe(e, t, this.localWriteTime);
        }
        /**
         ...
         */    applyToLocalDocumentSet(t) {
            ...
            this.mutations.forEach((e => {
                ...
                // and we should remove this cast.
                            this.applyToLocalView(s), n.isValidDocument() || s.convertToNoDocument(K$1.min());
            }));
        }
        keys() {
            return this.mutations.reduce(((t, e) => t.add(e.key)), un());
        }
        isEqual(t) {
            return this.batchId === t.batchId && B(this.mutations, t.mutations, ((t, e) => Oe(t, e))) && B(this.baseMutations, t.baseMutations, ((t, e) => Oe(t, e)));
        }
    }

    /** The result of applying a mutation batch to the backend. */ class Bs {
        constructor(t, e, n, 
        /**
         ...
         */    static from(t, e, n) {
            O$1(t.mutations.length === n.length);
            let s = on();
            const i = t.mutations;
            for (let t = 0; t < i.length; t++) s = s.insert(i[t].key, n[t].version);
            return new Bs(t, e, n, s);
        }
    }
     ...
     * limitations under the License.
     */
    /** Serializer for values stored in the LocalStore. */ class Us {
        constructor(t) {
            this.Lt = t;
        }
    }

    /** Decodes a remote document from storage locally to a Document. */ function Ks(t, e) {
        if (e.document) return $n(t.Lt, e.document, !!e.hasCommittedMutations);
        if (e.noDocument) {
            const t = at.fromSegments(e.noDocument.path), n = zs(e.noDocument.readTime), s = Pt.newNoDocument(t, n);
            return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
        }
        if (e.unknownDocument) {
            const t = at.fromSegments(e.unknownDocument.path), n = zs(e.unknownDocument.version);
    ...
    /** Encodes a document for storage locally. */ function Qs(t, e, n) {
        ...
        if (e.isFoundDocument()) {
            const n = function(t, e) {
                return {
                    ...
                    updateTime: An(t, e.version.toTimestamp())
                };
        ...
        if (e.isNoDocument()) {
            const t = e.key.path.toArray(), n = Gs(e.version), r = e.hasCommittedMutations;
            return new ws(
            /* unknownDocument= */ null, new fs(t, n), 
            /* document= */ null, r, s, i);
        }
        if (e.isUnknownDocument()) {
            const t = e.key.path.toArray(), n = Gs(e.version);
            return new ws(new ds(t, n), 
            /* noDocument= */ null, 
            /* document= */ null, 
    ...
    function zs(t) {
        const e = new U$1(t.seconds, t.nanoseconds);
        return K$1.fromTimestamp(e);
    }
    ...
    function Hs(t, e) {
        const n = (e.baseMutations || []).map((e => Bn(t.Lt, e)));
        ...
        const s = e.mutations.map((e => Bn(t.Lt, e))), i = U$1.fromMillis(e.localWriteTimeMs);
        return new Ls(e.batchId, i, n, s);
    }

    /** Decodes a DbTarget into TargetData */ function Js(t) {
        const e = zs(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? zs(t.lastLimboFreeSnapshotVersion) : K$1.min();
        let s;
        var i;
        return void 0 !== t.query.documents ? (O$1(1 === (i = t.query).documents.length), 
        s = se(Jt(Nn(i.documents[0])))) : s = function(t) {
            return se(Qn(t));
        }(t.query), new qs(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, X$1.fromBase64String(t.resumeToken));
    }

    /** Encodes TargetData into a DbTarget for storage locally. */ function Ys(t, e) {
        const n = Gs(e.snapshotVersion), s = Gs(e.lastLimboFreeSnapshotVersion);
        let i;
        i = Ct(e.target) ? Un(t.Lt, e.target) : Kn(t.Lt, e.target);
        // We can't store the resumeToken as a ByteString in IndexedDb, so we
        // convert it to a base64 string for storage.
            const r = e.resumeToken.toBase64();
        // lastListenSequenceNumber is always 0 until we do real GC.
            return new ms(e.targetId, Vt(e.target), n, r, e.sequenceNumber, s, i);
    }
     ...
     */ class si {
        ...
        add(t) {
            const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Xe(z$1.comparator), i = !s.has(n);
        ...
        getEntries(t) {
            return (this.index[t] || new Xe(z$1.comparator)).toArray();
        }
    }
    ...
    class ci {
        ...
        static withCacheSize(t) {
            return new ci(t, ci.DEFAULT_COLLECTION_PERCENTILE, ci.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
        }
    }
     ...
     */
    function ui(t, e, n) {
        const s = t.store(hs.store), i = t.store(ls.store), r = [], o = IDBKeyRange.only(n.batchId);
        let c = 0;
        const u = s.$t({
            range: o
        }, ((t, e, n) => (c++, n.delete())));
    ...
    class hi {
        ...
        addMutationBatch(t, e, n, s) {
            ...
            return r.add({}).next((o => {
                ...
                const c = new Ls(o, e, n, s), u = function(t, e, n) {
                    const s = n.baseMutations.map((e => Ln(t.Lt, e))), i = n.mutations.map((e => Ln(t.Lt, e)));
                    return new hs(e, n.batchId, n.localWriteTime.toMillis(), s, i);
                }(this.R, this.userId, c), a = [];
                let h = new Xe(((t, e) => L$1(t.canonicalString(), e.canonicalString())));
                for (const t of s) {
                    const e = ls.key(this.userId, t.key.path, o);
                    h = h.add(t.key.path.popLast()), a.push(r.put(u)), a.push(i.put(e, ls.PLACEHOLDER));
                }
                return h.forEach((e => {
        ...
        lookupMutationBatch(t, e) {
            return fi(t).get(e).next((t => t ? (O$1(t.userId === this.userId), Hs(this.R, t)) : null));
        }
        /**
        ...
        getNextMutationBatchAfterBatchId(t, e) {
            ...
            return fi(t).$t({
                ...
                e.userId === this.userId && (O$1(e.batchId >= n), i = Hs(this.R, e)), s.done();
            })).next((() => i));
        }
        ...
        getAllMutationBatches(t) {
            ...
            return fi(t).Nt(hs.userMutationsIndex, e).next((t => t.map((t => Hs(this.R, t)))));
        }
        getAllMutationBatchesAffectingDocumentKey(t, e) {
            ...
            return di(t).$t({
                ...
                return fi(t).get(u).next((t => {
                    if (!t) throw k$1();
                    O$1(t.userId === this.userId), i.push(Hs(this.R, t));
                }));
                r.done();
            })).next((() => i));
        }
        getAllMutationBatchesAffectingDocumentKeys(t, e) {
            ...
            const s = [];
            return e.forEach((e => {
                const i = ls.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = di(t).$t({
                    range: r
                }, ((t, s, i) => {
        ...
        Wt(t, e) {
            ...
            return e.forEach((e => {
                s.push(fi(t).get(e).next((t => {
                    if (null === t) throw k$1();
                    O$1(t.userId === this.userId), n.push(Hs(this.R, t));
                })));
            })), vs.waitFor(s).next((() => n));
        }
        removeMutationBatch(t, e) {
            return ui(t.Ft, this.userId, e).next((n => (t.addOnCommittedListener((() => {
                this.Gt(e.batchId);
        ...
        zt(t) {
            return wi(t).get(this.userId).next((t => t || new as(this.userId, -1, 
            /*lastStreamToken=*/ "")));
        }
    }
     ...
     */ class mi {
        ...
        allocateTargetId(t) {
            return this.Xt(t).next((e => {
                const n = new _i(e.highestTargetId);
                return e.highestTargetId = n.next(), this.Zt(t, e).next((() => e.highestTargetId));
            }));
        }
        getLastRemoteSnapshotVersion(t) {
            return this.Xt(t).next((t => K$1.fromTimestamp(new U$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
        }
        ...
        removeTargetData(t, e) {
            return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => gi(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (O$1(e.targetCount > 0), 
        ...
        Xt(t) {
            return yi(t).get(ys.key).next((t => (O$1(null !== t), t)));
        }
        Zt(t, e) {
            return yi(t).put(ys.key, e);
        }
        te(t, e) {
            return gi(t).put(Ys(this.R, e));
        }
        /**
        ...
        addMatchingKeys(t, e, n) {
            ...
            return e.forEach((e => {
                const r = ss(e.path);
                s.push(i.put(new gs(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
            })), vs.waitFor(s);
        }
        ...
        getMatchingKeysForTargetId(t, e) {
            ...
            return s.$t({
                ...
                const s = os(t[1]), r = new at(s);
                i = i.add(r);
            })).next((() => i));
        }
        containsKey(t, e) {
            const n = ss(e.path), s = IDBKeyRange.bound([ n ], [ q$1(n) ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            let i = 0;
            return pi(t).$t({
        ...
        // PORTING NOTE: Multi-tab only.
        lt(t, e) {
            return gi(t).get(e).next((t => t ? Js(t) : null));
        }
    }
     ...
     */ async function Ei(t) {
        if (t.code !== P$1.FAILED_PRECONDITION || t.message !== Rs) throw t;
        D$1("LocalStore", "Unexpectedly lost primary lease");
    }
     ...
     */ class Ii {
        constructor(t) {
            this.ne = t, this.buffer = new Xe(Ti), this.se = 0;
        }
        ie() {
            return ++this.se;
        }
     ...
     */ class Ai {
        ...
        ue(t) {
            ...
            D$1("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
                this.ce = null, this.oe = !0;
                try {
                    await t.collectGarbage(this.garbageCollector);
                } catch (t) {
                    Ns(t) ? D$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Ei(t);
                }
                await this.ue(t);
            }));
        }
    ...
    /** Implements the steps for LRU garbage collection. */ class Ri {
        ...
        nthSequenceNumber(t, e) {
            if (0 === e) return vs.resolve(R$1.o);
            const n = new Ii(e);
        ...
        collect(t, e) {
            return -1 === this.params.cacheSizeCollectionThreshold ? (D$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
            vs.resolve(oi)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (D$1("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
            oi) : this.fe(t, e)));
        }
        getCacheSize(t) {
        ...
        fe(t, e) {
            ...
            e > this.params.maximumSequenceNumbersToCollect ? (D$1("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`), 
            s = this.params.maximumSequenceNumbersToCollect) : s = e, r = Date.now(), this.nthSequenceNumber(t, s)))).next((s => (n = s, 
            o = Date.now(), this.removeTargets(t, n, e)))).next((e => (i = e, u = Date.now(), 
            this.removeOrphanedDocuments(t, n)))).next((t => {
                if (a = Date.now(), V$1() <= LogLevel.DEBUG) {
                    D$1("LruGarbageCollector", `LRU Garbage Collection\n\tCounted targets in ${r - h}ms\n\tDetermined least recently used ${s} in ` + (o - r) + "ms\n" + `\tRemoved ${i} targets in ` + (u - o) + "ms\n" + `\tRemoved ${t} documents in ` + (a - u) + "ms\n" + `Total Duration: ${a - h}ms`);
                }
                return vs.resolve({
                    didRun: !0,
    ...
    class Pi {
         ...
         */    _e(t, e) {
            return function(t, e) {
                let n = !1;
                return wi(t).Mt((s => li(t, s, e).next((t => (t && (n = !0), vs.resolve(!t)))))).next((() => n));
            }(t, e);
        }
        removeOrphanedDocuments(t, e) {
            ...
            return this.we(t, ((r, o) => {
                if (o <= e) {
                    const e = this._e(t, r).next((e => {
                        ...
                        // removing them.
                        return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), pi(t).delete([ 0, ss(r.path) ]))));
                    }));
                    s.push(e);
                }
     ...
     */ class Si {
        ...
        getEntry(t, e) {
            return Ni(t).get(xi(e)).next((t => this.ge(e, t)));
        }
        /**
         ...
         */    Ee(t, e) {
            let n = en(), s = new He(at.comparator);
            return this.pe(t, e, ((t, e) => {
                const i = this.ge(t, e);
                n = n.insert(t, i), s = s.insert(t, ai(e));
            })).next((() => ({
                documents: n,
                Te: s
            })));
        ...
        pe(t, e, n) {
            ...
            return Ni(t).$t({
                ...
                const o = at.fromSegments(t);
                // Go through keys not found in cache.
                            for (;r && at.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
                r && r.isEqual(o) && (
                // Key found in cache.
        ...
        getDocumentsMatchingQuery(t, e, n) {
            ...
            return Ni(t).$t(r, ((t, n, r) => {
                ...
                const o = Ks(this.R, n);
                e.path.isPrefixOf(o.key.path) ? ue(e, o) && (s = s.insert(o.key, o)) : r.done();
            })).next((() => s));
        }
        newChangeBuffer(t) {
            return new Di(this, !!t && t.trackRemovals);
        }
        getSize(t) {
            return this.getMetadata(t).next((t => t.byteSize));
        }
        getMetadata(t) {
            return Ci(t).get(_s.key).next((t => (O$1(!!t), t)));
        }
        me(t, e) {
            return Ci(t).put(_s.key, e);
        }
        /**
         ...
         */    ge(t, e) {
            if (e) {
                ...
                // `getNewDocumentChanges()`
                            if (!(t.isNoDocument() && t.version.isEqual(K$1.min()))) return t;
            }
    ...
    class Di extends Vi {
        ...
        applyChanges(t) {
            const e = [];
            let n = 0, s = new Xe(((t, e) => L$1(t.canonicalString(), e.canonicalString())));
            return this.changes.forEach(((i, r) => {
                ...
                if (r.document.isValidDocument()) {
                    ...
                    const n = Qs(this.Ie.R, Pt.newNoDocument(i, K$1.min()), this.getReadTime(i));
     ...
     * limitations under the License.
     */
    /** Performs database creation and schema upgrades. */ class ki {
        constructor(t) {
            this.R = t;
        }
        /**
     ...
     */ (t), Oi(t), function(t) {
            ...
            0 !== n && (!function(t) {
                t.deleteObjectStore(gs.store), t.deleteObjectStore(ms.store), t.deleteObjectStore(ys.store);
            }(t), Oi(t)), r = r.next((() => 
            /**
     ...
     */ (i)))), n < 4 && s >= 4 && (0 !== n && (
            ...
            r = r.next((() => function(t, e) {
                return e.store(hs.store).Nt().next((n => {
                    t.deleteObjectStore(hs.store);
                    t.createObjectStore(hs.store, {
                        keyPath: hs.keyPath,
                        autoIncrement: !0
                    }).createIndex(hs.userMutationsIndex, hs.userMutationsKeyPath, {
                    ...
                    const s = e.store(hs.store), i = n.map((t => s.put(t)));
                    return vs.waitFor(i);
                }));
            }(t, i)))), r = r.next((() => {
                !function(t) {
     ...
     */ (t);
        ...
        Re(t) {
            const e = t.store(as.store), n = t.store(hs.store);
            return e.Nt().next((e => vs.forEach(e, (e => {
                const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
                return n.Nt(hs.userMutationsIndex, s).next((n => vs.forEach(n, (n => {
                    O$1(n.userId === e.userId);
                    const s = Hs(this.R, n);
         ...
         */    be(t) {
            const e = t.store(gs.store), n = t.store(ws.store);
            return t.store(ys.store).get(ys.key).next((t => {
                ...
                return n.$t(((n, i) => {
                    ...
                    s.push(e.get(o).next((n => n ? vs.resolve() : (n => e.put(new gs(0, ss(n), t.highestListenSequenceNumber)))(r))));
                })).next((() => vs.waitFor(s)));
            }));
        }
        ve(t, e) {
            ...
            const n = e.store(ps.store), s = new si, i = t => {
                if (s.add(t)) {
    ...
    class Mi {
        ...
        a) {
            ...
            this.Fe = t => Promise.resolve(), !Mi.gt()) throw new b(P$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
            this.referenceDelegate = new Pi(this, s), this.Le = e + "main", this.R = new Us(c), 
            this.Be = new Ss(this.Le, 11, new ki(this.R)), this.qe = new mi(this.referenceDelegate, this.R), 
            this.Ut = new ii, this.Ue = function(t, e) {
                return new Si(t, e);
            }
            /**
     ...
     */
            ...
            (this.R, this.Ut), this.Ke = new Zs, this.window && this.window.localStorage ? this.Qe = this.window.localStorage : (this.Qe = null, 
         ...
         */    start() {
            ...
            return this.je().then((() => {
                ...
                throw new b(P$1.FAILED_PRECONDITION, $i);
         ...
         * primary lease.
         */    je() {
            return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Li(t).put(new Es(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
                ...
                return D$1("IndexedDbPersistence", "Failed to extend owner lease: ", t), this.isPrimary;
                if (!this.allowTabSynchronization) throw t;
                return D$1("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", t), 
                /* isPrimary= */ !1;
            })).then((t => {
        ...
        Je(t) {
            return Fi(t).get(us.key).next((t => vs.resolve(this.tn(t))));
        }
        en(t) {
         ...
         */    Ye(t) {
            ...
            return Fi(t).get(us.key).next((e => {
                ...
                return !(!this.networkEnabled || !this.inForeground) || Li(t).Nt().next((t => void 0 === this.rn(t, 5e3).find((t => {
            ...
            })).next((t => (this.isPrimary !== t && D$1("IndexedDbPersistence", `Client ${t ? "is" : "is not"} eligible for a primary lease.`), 
            t)));
        }
        async shutdown() {
            ...
            await this.Be.runTransaction("shutdown", "readwrite", [ us.store, Es.store ], (t => {
                const e = new Ms(t, R$1.o);
         ...
         * PORTING NOTE: This is only used for Web multi-tab.
         */    fn() {
            return this.runTransaction("getActiveClients", "readonly", (t => Li(t).Nt().next((t => this.rn(t, 18e5).map((t => t.clientId))))));
        }
        get started() {
            return this.xe;
        }
        getMutationQueue(t) {
            return hi.Qt(t, this.R, this.Ut, this.referenceDelegate);
        }
        getTargetCache() {
            return this.qe;
        }
        ...
        runTransaction(t, e, n) {
            D$1("IndexedDbPersistence", "Starting transaction:", t);
            const s = "readonly" === e ? "readonly" : "readwrite";
            let i;
            // Do all transactions as readwrite against all object stores, since we
            // are the only reader/writer.
                    return this.Be.runTransaction(t, s, As, (s => (i = new Ms(s, this.Ne ? this.Ne.next() : R$1.o), 
            "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
                ...
                this.Se.enqueueRetryable((() => this.Fe(!1))), new b(P$1.FAILED_PRECONDITION, Rs);
                return n(i);
        ...
        // be turned off.
        dn(t) {
            return Fi(t).get(us.key).next((t => {
                if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new b(P$1.FAILED_PRECONDITION, $i);
            }));
        }
        /**
        ...
        /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
            const e = Fi(t);
            return e.get(us.key).next((t => this.tn(t) ? (D$1("IndexedDbPersistence", "Releasing primary lease."), 
            e.delete(us.key)) : vs.resolve()));
        }
         ...
         */    cn(t) {
            ...
            try {
                ...
                return D$1("IndexedDbPersistence", `Client '${t}' ${n ? "is" : "is not"} zombied in LocalStorage`), 
                n;
            } catch (t) {
     ...
     */ function Fi(t) {
        return Fs(t, us.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the client metadata object store.
     */ function Li(t) {
        return Fs(t, Es.store);
    }
     ...
     */
            return function(t) {
                return at.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
            }(e) ? this.Tn(t, e.path) : ee(e) ? this.In(t, e, n) : this.An(t, e, n);
        }
        Tn(t, e) {
            // Just do a simple document lookup.
            return this.mn(t, new at(e)).next((t => {
                let e = sn();
        ...
        An(t, e, n) {
            ...
            this.Rn(t, i, s).next((t => {
                ...
                for (const t of i) for (const e of t.mutations) {
                    ...
                    i = Pt.newInvalidDocument(n), s = s.insert(n, i)), xe(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
                }
            }))))).next((() => (
     ...
     */ class Ki {
     ...
     // do nothing
            ...
            return new Ki(t, e.fromCache, n, s);
        }
    }
     ...
     */ class Qi {
        ...
        /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
            ...
            }(e) || n.isEqual(K$1.min()) ? this.Dn(t, e) : this.Sn.pn(t, s).next((i => {
                const r = this.Cn(e, i);
                return (Yt(e) || Xt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (V$1() <= LogLevel.DEBUG && D$1("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ce(e)), 
        ...
        Dn(t, e) {
            return V$1() <= LogLevel.DEBUG && D$1("QueryEngine", "Using full collection scan to execute query:", ce(e)), 
    ...
    class ji {
        ...
        t, e, n, s) {
            ...
            this.On = new vi((t => Vt(t)), Dt), 
            /**
             * The read time of the last entry processed by `getNewDocumentChanges()`.
             *
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
            this.$n = K$1.min(), this._n = t.getMutationQueue(n), this.Mn = t.getRemoteDocumentCache(), 
            this.qe = t.getTargetCache(), this.Fn = new Ui(this.Mn, this._n, this.persistence.getIndexManager()), 
    ...
    async function Gi(t, e) {
        ...
        const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
            ...
            // MutationQueue.
            i = new Ui(n.Mn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
                const n = [], s = [];
            ...
            return function(t, e, n, s) {
                ...
                return r.forEach((t => {
                    o = o.next((() => s.getEntry(e, t))).next((e => {
                        ...
                        O$1(null !== r), e.version.compareTo(r) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
     ...
     */
                    function(t, e, n) {
                        ...
                        if (O$1(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize()) return !0;
     ...
     */ (c, a, e) && o.push(n.qe.updateTargetData(t, a));
            ...
            o.push(Yi(t, r, e.documentUpdates, s, void 0).next((t => {
                c = t;
            }))), !s.isEqual(K$1.min())) {
    ...
    i) {
        ...
        return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
            ...
            return n.forEach(((n, o) => {
                ...
                // cache.
                o.isNoDocument() && o.version.isEqual(K$1.min()) ? (
                ...
                r = r.insert(n, o)) : D$1("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
            })), r;
        }));
    }
    ...
    function Zi(t, e) {
        ...
        return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
            ...
            s = i, vs.resolve(s)) : n.qe.allocateTargetId(t).next((i => (s = new qs(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
    ...
    async function tr(t, e, n) {
        ...
        try {
            ...
            D$1("LocalStore", `Failed to update sequence numbers for target ${e}: ${t}`);
        }
     ...
     */ function er(t, e, n) {
        ...
        })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : K$1.min(), n ? r : un()))).next((t => ({
            documents: t,
            Bn: r
        })))));
    }
    ...
    function sr(t) {
        ...
        return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
            const s = $(t);
            let i = en(), r = js(n);
            const o = Ni(e), c = IDBKeyRange.lowerBound(r, !0);
            return o.$t({
    ...
    async function ir(t) {
        ...
        return e.persistence.runTransaction("Synchronize last document change read time", "readonly", (t => function(t) {
            ...
            return e.$t({
                ...
                e.readTime && (n = Ws(e.readTime)), s.done();
            })).next((() => n));
        }(t))).then((t => {
            e.$n = t;
        }));
    ...
    async function rr(t, e, n, s) {
        ...
        const u = i.Mn.newChangeBuffer({
            ...
            return se(Jt(z$1.fromString(`__bundle__/docs/${t}`)));
        }(s));
        // Allocates a target to hold all document keys from the bundle, such that
        // they will not get garbage collected right away.
            return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => Yi(t, u, o, K$1.min(), c).next((e => (u.apply(t), 
     ...
     */
    async function or(t, e, n = un()) {
        // Allocate a target for the named query such that it can be resumed
        // from associated read time if users use it to listen.
        // NOTE: this also means if no corresponding target exists, the new target
        // will remain active and will not get collected, unless users happen to
        // unlisten the query somehow.
        const s = await Zi(t, se(Xs(e.bundledQuery))), i = $(t);
        return i.persistence.runTransaction("Save named query", "readwrite", (t => {
            ...
            // Update existing target data because the query from the bundle is newer.
                    const o = s.withResumeToken(X$1.EMPTY_BYTE_STRING, r);
     ...
     */ class ur {
        constructor() {
            ...
            this.Wn = new Xe(ar.Gn), 
            // A set of outstanding references to a document sorted by target id.
            this.zn = new Xe(ar.Hn);
        }
         ...
         * removed.
         */    Zn(t) {
            const e = new at(new z$1([])), n = new ar(e, t), s = new ar(e, t + 1), i = [];
        ...
        es(t) {
            const e = new at(new z$1([])), n = new ar(e, t), s = new ar(e, t + 1);
            let i = un();
            return this.zn.forEachInRange([ n, s ], (t => {
                i = i.add(t.key);
            })), i;
        ...
        containsKey(t) {
            const e = new ar(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    class ar {
        ...
        /** Compare by key then by ID */    static Gn(t, e) {
            return at.comparator(t.key, e.key) || L$1(t.ns, e.ns);
        }
        /** Compare by ID then by key */    static Hn(t, e) {
            return L$1(t.ns, e.ns) || at.comparator(t.key, e.key);
        }
    }
     ...
     */ class hr {
        ...
        addMutationBatch(t, e, n, s) {
            ...
            for (const e of s) this.rs = this.rs.add(new ar(e.key, i)), this.Ut.addToCollectionParentIndex(t, e.key.path.popLast());
            return vs.resolve(r);
        }
        lookupMutationBatch(t, e) {
        ...
        removeMutationBatch(t, e) {
            O$1(0 === this.hs(e.batchId, "removed")), this._n.shift();
            let n = this.rs;
        ...
        containsKey(t, e) {
            const n = new ar(e, 0), s = this.rs.firstAfterOrEqual(n);
    ...
    class lr {
        ...
        constructor(t, e) {
            ...
            this.docs = new He(at.comparator), 
        ...
        getEntry(t, e) {
            ...
            return vs.resolve(n ? n.document.clone() : Pt.newInvalidDocument(e));
        }
        getEntries(t, e) {
            let n = en();
            return e.forEach((t => {
        ...
        getDocumentsMatchingQuery(t, e, n) {
            ...
            // the documents we need to match the query against.
                    const i = new at(e.path.child("")), r = this.docs.getIteratorFrom(i);
            for (;r.hasNext(); ) {
                const {key: t, value: {document: i, readTime: o}} = r.getNext();
                if (!e.path.isPrefixOf(t.path)) break;
                o.compareTo(n) <= 0 || ue(e, i) && (s = s.insert(i.key, i.clone()));
            }
            return vs.resolve(s);
        }
        fs(t, e) {
     ...
     */ class dr {
        constructor(t) {
             ...
             * IDs.
             */
            this._s = new ur, this.targetCount = 0, this.gs = _i.Jt();
        }
        forEachTarget(t, e) {
        ...
        te(t) {
            ...
            const e = t.targetId;
            e > this.highestTargetId && (this.gs = new _i(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
        }
        addTargetData(t, e) {
    ...
    class wr {
         ...
         */
        constructor(t, e) {
            this.ys = {}, this.Ne = new R$1(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
            this.qe = new dr(this);
            this.Ut = new ni, this.Ue = function(t, e) {
                return new lr(t, e);
            }(this.Ut, (t => this.referenceDelegate.ps(t))), this.R = new Us(e), this.Ke = new cr(this.R);
        }
        start() {
        ...
        getMutationQueue(t) {
            ...
            return e || (e = new hr(this.Ut, this.referenceDelegate), this.ys[t.toKey()] = e), 
            e;
        }
        getTargetCache() {
            return this.qe;
        ...
        runTransaction(t, e, n) {
            D$1("MemoryPersistence", "Starting transaction:", t);
    ...
    gr.GOOGLE_CREDENTIALS = new gr("google-credentials-uid"), gr.FIRST_PARTY = new gr("first-party-uid");
    ...
    class Tr {
         ...
         */    static Vs(t, e, n) {
            ...
            r && (i = new b(s.error.code, s.error.message))), r ? new Tr(t, e, s.state, i) : (C("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
            null);
        }
        Ss() {
            const t = {
    ...
    class Ir {
         ...
         */    static Vs(t, e) {
            ...
            i && (s = new b(n.error.code, n.error.message))), i ? new Ir(t, n.state, s) : (C("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
            null);
        }
        Ss() {
            const t = {
     ...
     */ class Ar {
         ...
         */    static Vs(t, e) {
            const n = JSON.parse(e);
            let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = hn();
            for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = ut(n.activeTargetIds[t]), 
            i = i.add(n.activeTargetIds[t]);
            return s ? new Ar(t, i) : (C("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
            null);
        }
    }
     ...
     */ class Rr {
         ...
         */    static Vs(t) {
            ...
            return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Rr(e.clientId, e.onlineState) : (C("SharedClientState", `Failed to parse online state: ${t}`), 
            null);
        }
    }
     ...
     */ class br {
        constructor(t, e, n, s, i) {
            ...
            this.Os = new He(L$1), this.started = !1, 
            /**
            ...
            const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            this.storage = this.window.localStorage, this.currentUser = i, this.Ms = yr(this.persistenceKey, this.Ns), 
            this.Fs = 
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ (this.persistenceKey), this.Os = this.Os.insert(this.Ns, new Pr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        ...
        async start() {
            ...
            for (const e of t) {
                ...
                const t = this.getItem(yr(this.persistenceKey, e));
                if (t) {
                    const n = Ar.Vs(e, t);
        ...
        addLocalQueryTarget(t) {
            ...
            // by another tab
                ...
                const n = this.storage.getItem(Er(this.persistenceKey, t));
                if (n) {
                    const s = Ir.Vs(t, n);
                    s && (e = s.state);
                }
        ...
        clearQueryState(t) {
            this.removeItem(Er(this.persistenceKey, t));
        }
        ...
        getItem(t) {
            ...
            return D$1("SharedClientState", "READ", t, e), e;
        }
        setItem(t, e) {
            D$1("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
        }
        removeItem(t) {
            D$1("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
        }
        ks(t) {
            ...
            if (e.storageArea === this.storage) {
                if (D$1("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Ms) return void C("Received WebStorage notification for local change. Another client might have garbage-collected our state");
     ...
     */ (e.newValue);
                            t !== R$1.o && this.sequenceNumberHandler(t);
        ...
        zs(t, e, n) {
            const s = new Tr(this.currentUser, t, e, n), i = pr(this.persistenceKey, this.currentUser, t);
            this.setItem(i, s.Ss());
        }
        Hs(t) {
        ...
        Ys(t, e, n) {
            const s = Er(this.persistenceKey, t), i = new Ir(t, e, n);
            this.setItem(s, i.Ss());
        }
        Zs() {
        ...
        async ii(t) {
            ...
            D$1("SharedClientState", `Ignoring mutation for non-active user ${t.user.uid}`);
        }
        oi(t) {
    ...
    class Sr {
        ...
        _i() {
            D$1("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
            for (const t of this.yi) t(0 /* AVAILABLE */);
        }
        gi() {
            D$1("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
    ...
    class {
        ...
        Ni(t, e, n, s) {
            const i = this.xi(t, e);
            D$1("RestConnection", "Sending: ", i, n);
            const r = {};
            return this.ki(r, s), this.Oi(t, i, r, n).then((t => (D$1("RestConnection", "Received: ", t), 
            t)), (e => {
                    ...
                    try {
                        switch (o.getLastErrorCode()) {
                          case ErrorCode.NO_ERROR:
                            ...
                            D$1("Connection", "XHR received:", JSON.stringify(e)), i(e);
                            break;

                          case ErrorCode.TIMEOUT:
                            D$1("Connection", 'RPC "' + t + '" timed out'), r(new b(P$1.DEADLINE_EXCEEDED, "Request time out"));
                            break;

                          case ErrorCode.HTTP_ERROR:
                            const n = o.getStatus();
                            if (D$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", o.getResponseText()), 
                            n > 0) {
                                const t = o.getResponseJson().error;
                                if (t && t.status && t.message) {
                                    const e = function(t) {
                                        const e = t.toLowerCase().replace(/_/g, "-");
                                        return Object.values(P$1).indexOf(e) >= 0 ? e : P$1.UNKNOWN;
                                    }(t.status);
                                    r(new b(e, t.message));
                                } else r(new b(P$1.UNKNOWN, "Server responded with status " + o.getStatus()));
                            } else 
                            // If we received an HTTP_ERROR but there's no status code,
                            // it's most probably a connection issue
                            r(new b(P$1.UNAVAILABLE, "Connection failed."));
                            break;
                        ...
                        D$1("Connection", 'RPC "' + t + '" completed.');
                    }
                }));
        ...
        Mi(t, e) {
            ...
            const o = n.join("");
            D$1("Connection", "Creating WebChannel: " + o, r);
            ...
            // on a closed stream
                    const m = new Cr({
                Ei: t => {
                    _ ? D$1("Connection", "Not sending because WebChannel is closed:", t) : (u || (D$1("Connection", "Opening WebChannel transport."), 
                    c.open(), u = !0), D$1("Connection", "WebChannel sending:", t), c.send(t));
                },
                Ti: () => c.close()
            }), g = (t, e, n) => {
            ...
            // enough the code is exception free.
                ...
                _ || D$1("Connection", "WebChannel transport opened.");
            })), g(c, WebChannel.EventType.CLOSE, (() => {
                _ || (_ = !0, D$1("Connection", "WebChannel transport closed"), m.Vi());
            })), g(c, WebChannel.EventType.ERROR, (t => {
                _ || (_ = !0, N$1("Connection", "WebChannel transport errored:", t), m.Vi(new b(P$1.UNAVAILABLE, "The operation could not be completed")));
                ...
                if (!_) {
                    ...
                    if (i) {
                        D$1("Connection", "WebChannel received error:", i);
     ...
     */
                        ...
                        void 0 === e && (e = P$1.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                        // Mark closed so no further events are propagated
                        _ = !0, m.Vi(new b(e, n)), c.close();
                    } else D$1("Connection", "WebChannel received:", n), m.Si(n);
                }
            })), g(i, Event.STAT_EVENT, (t => {
                t.stat === Stat.PROXY ? D$1("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && D$1("Connection", "Detected no buffering proxy");
            })), setTimeout((() => {
    ...
    class $r {
         ...
         */    ji(t) {
            ...
            // Guard against lastAttemptTime being in the future due to a clock change.
                    s > 0 && D$1("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.qi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
    ...
    class Mr {
        constructor(t, e, n, s, i, r) {
             ...
             * close.
             */
            this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new $r(t, e);
        }
        /**
        ...
        auth() {
            ...
            // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                ...
                t((() => {
                    const t = new b(P$1.UNKNOWN, "Fetching auth token failed: " + e.message);
                    return this.dr(t);
                }));
            }));
        }
        ...
        dr(t) {
            ...
            return D$1("PersistentStream", `close with error: ${t}`), this.stream = null, this.close(3 /* Error */ , t);
        }
        /**
         ...
         */    hr(t) {
            return e => {
                this.Se.enqueueAndForget((() => this.Yi === t ? e() : (D$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve())));
            };
        }
    }
     ...
     */ class Fr extends Mr {
        ...
        onMessage(t) {
            ...
            const e = Fn(this.R, t), n = function(t) {
                ...
                return e.targetIds && e.targetIds.length ? K$1.min() : e.readTime ? bn(e.readTime) : K$1.min();
            }(t);
         ...
         */    mr(t) {
            ...
            e.database = xn(this.R), e.addTarget = function(t, e) {
                ...
                return n = Ct(s) ? {
                    ...
                    query: Kn(t, s)
                }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Rn(t, e.resumeToken) : e.snapshotVersion.compareTo(K$1.min()) > 0 && (
                // TODO(wuandy): Consider removing above check because it is most likely true.
                // Right now, many tests depend on this behaviour though (leaving min() out
                // of serialization).
                n.readTime = An(t, e.snapshotVersion.toTimestamp())), n;
            }(this.R, t);
            const n = jn(this.R, t);
     ...
     */ class Lr extends Mr {
        ...
        onMessage(t) {
            ...
            O$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
                // A successful first write response means the stream is healthy,
                // Note, that we could consider a successful handshake healthy, however,
                // the write itself might be causing an error we want to back off from.
                this.Zi.reset();
                const e = qn(t.writeResults, t.commitTime), n = bn(t.commitTime);
                return this.listener.Tr(n, e);
            }
            // The first response is always the handshake response
            return O$1(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, this.listener.Ir();
        }
        /**
    ...
    class Br extends class {} {
        ...
        Pr() {
            if (this.Rr) throw new b(P$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        /** Gets an auth token and invokes the provided RPC. */    Ni(t, e, n) {
            return this.Pr(), this.credentials.getToken().then((s => this.Hi.Ni(t, e, n, s))).catch((t => {
                throw t.code === P$1.UNAUTHENTICATED && this.credentials.invalidateToken(), t;
            }));
        }
    ...
    class qr {
        ...
        Cr(t) {
            ...
            this.Vr ? (C(e), this.Vr = !1) : D$1("OnlineStateTracker", e);
        }
        kr() {
        ...
        e, n, s, i) {
            ...
            this.Fr = [], this.Lr = i, this.Lr.di((t => {
                n.enqueueAndForget((async () => {
                    ...
                    // down our streams.
                    Yr(this) && (D$1("RemoteStore", "Restarting streams for network reachability change."), 
                    await async function(t) {
                        const e = $(t);
                        e.Mr.add(4 /* ConnectivityChange */), await Qr(e), e.Br.set("Unknown" /* Unknown */), 
                        e.Mr.delete(4 /* ConnectivityChange */), await Kr(e);
                    }(this));
                }));
            })), this.Br = new qr(n, s);
        }
    ...
    async function Kr(t) {
        if (Yr(t)) for (const e of t.Fr) await e(/* enabled= */ !0);
    }
     ...
     */ function Wr(t, e) {
        const n = $(t), s = _o(n);
        n.$r.delete(e), s.er() && zr(n, e), 0 === n.$r.size && (s.er() ? s.ir() : Yr(n) && 
     ...
     */ function Jr(t) {
        return Yr(t) && !_o(t).tr() && t.$r.size > 0;
    }
    ...
    async function eo(t, e, n) {
        ...
        t.Br.set("Online" /* Online */), e instanceof _n && 2 /* Removed */ === e.state && e.cause) 
     ...
     */ (t, e);
            ...
            D$1("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), 
            await no(t, n);
        } else if (e instanceof dn ? t.qr.X(e) : e instanceof wn ? t.qr.rt(e) : t.qr.et(e), 
        !n.isEqual(K$1.min())) try {
            const e = await Hi(t.localStore);
            n.compareTo(e) >= 0 && 
     ...
     */
            function(t, e) {
                ...
                n.targetMismatches.forEach((e => {
                    ...
                    // state.
                                    t.$r.set(e, n.withResumeToken(X$1.EMPTY_BYTE_STRING, n.snapshotVersion)), 
            ...
            D$1("RemoteStore", "Failed to raise snapshot:", e), await no(t, e);
        }
    }
     ...
     */ async function no(t, e, n) {
        ...
        t.asyncQueue.enqueueRetryable((async () => {
            D$1("RemoteStore", "Retrying IndexedDB access"), await n(), t.Mr.delete(1 /* IndexedDbFailed */), 
            await Kr(t);
        }));
    }
    ...
    async function io(t) {
        ...
        for (;ro(e); ) try {
            const t = await Xi(e.localStore, s);
            if (null === t) {
                0 === e.Or.length && n.ir();
                break;
            }
    ...
    function co(t) {
        return Yr(t) && !mo(t).tr() && t.Or.length > 0;
    }
    ...
    async function lo(t, e, n) {
        const s = t.Or.shift(), i = Bs.from(s, e, n);
        await so(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
    ...
    async function fo(t, e) {
        ...
        await async function(t, e) {
            ...
            // logic kick in.
            if (n = e.code, Ge(n) && n !== P$1.ABORTED) {
                ...
                // restart.
                            mo(t).sr(), await so(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
    ...
    async function wo(t, e) {
        const n = $(t);
        e ? (n.Mr.delete(2 /* IsSecondary */), await Kr(n)) : e || (n.Mr.add(2 /* IsSecondary */), 
     ...
     */ (t.datastore, t.asyncQueue, {
            ...
            e ? (t.Ur.sr(), Jr(t) ? Hr(t) : t.Br.set("Unknown" /* Unknown */)) : (await t.Ur.stop(), 
            Xr(t));
        }))), t.Ur;
    }
     ...
     */ function mo(t) {
        ...
        t.Kr = function(t, e, n) {
            ...
            await io(t)) : (await t.Kr.stop(), t.Or.length > 0 && (D$1("RemoteStore", `Stopping write stream with ${t.Or.length} pending writes`), 
            t.Or = []));
        }))), t.Kr;
    }
    ...
    class go {
         ...
         */    static createAndSchedule(t, e, n, s, i) {
            const r = Date.now() + n, o = new go(t, e, r, s, i);
            return o.start(n), o;
        }
        /**
         ...
         */    cancel(t) {
            null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new b(P$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
        }
        handleDelayElapsed() {
     ...
     */ function yo(t, e) {
        if (C("AsyncQueue", `${e}: ${t}`), Ns(t)) return new b(P$1.UNAVAILABLE, `${e}: ${t}`);
        throw t;
    }
     ...
     */ class po {
        ...
        constructor(t) {
            ...
            this.keyedMap = sn(), this.sortedSet = new He(this.comparator);
        }
        /**
     ...
     */ class Eo {
        ...
        track(t) {
            ...
            // Metadata->Added
            // Removed->Metadata
            k$1() : this.Qr = this.Qr.insert(e, t);
        }
        jr() {
            const t = [];
    ...
    class To {
        ...
        /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
            ...
            })), new To(t, e, po.emptySet(e), i, n, s, 
            /* syncStateChanged= */ !0, 
    ...
    class Ao {
        constructor() {
            this.queries = new vi((t => oe(t)), re), this.onlineState = "Unknown" /* Unknown */ , 
            this.Gr = new Set;
        }
    }
    ...
    async function Ro(t, e) {
        ...
        if (r || (i = !0, r = new Io), i) try {
            r.Wr = await n.onListen(s);
        } catch (t) {
            const n = yo(t, `Initialization of query '${ce(e.query)}' failed`);
     ...
     */ class So {
         ...
         */    Hr(t) {
            if (!this.options.includeMetadataChanges) {
                ...
                t = new To(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
        ...
        no(t) {
            t = To.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
            this.Jr.next(t);
        }
    }
     ...
     */ class Co {
         ...
         */    Un(t) {
            return t.metadata.exists ? $n(this.R, t.document, !1) : Pt.newNoDocument(this.qn(t.metadata.name), this.Kn(t.metadata.readTime));
        }
        Kn(t) {
            return bn(t);
        }
     ...
     */ class No {
        ...
        co(t) {
            const e = new Map, n = new Co(this.R);
            for (const s of t) if (s.metadata.queries) {
                const t = n.qn(s.metadata.name);
                for (const n of s.metadata.queries) {
                    const s = (e.get(n) || un()).add(t);
                    e.set(n, s);
                }
            }
            return e;
         ...
         */    async complete() {
            const t = await rr(this.localStore, new Co(this.R), this.documents, this.ro.id), e = this.co(this.documents);
            for (const t of this.queries) await or(this.localStore, t, e.get(t.name));
     ...
     */ class $o {
        ...
        e) {
            ...
            this.mutatedKeys = un(), this.lo = ae(t), this.fo = new po(this.lo);
        }
        /**
         ...
         */    _o(t, e) {
            const n = e ? e.mo : new Eo, s = e ? e.fo : this.fo;
            ...
            if (t.inorderTraversal(((t, e) => {
                const a = s.get(t), h = ue(this.query, e) ? e : null, l = !!a && this.mutatedKeys.has(a.key), f = !!h && (h.hasLocalMutations || 
            ...
            })), Yt(this.query) || Xt(this.query)) for (;r.size > this.query.limit; ) {
                const t = Yt(this.query) ? r.last() : r.first();
     ...
     */ (t.type, e.type) || this.lo(t.doc, e.doc))), this.po(n);
            ...
            if (this.ao = o, 0 !== i.length || c) {
                return {
                    snapshot: new To(this.query, t.fo, s, i, t.mutatedKeys, 0 /* Local */ === o, c, 
                    /* excludesMetadataChanges= */ !1),
                    To: r
                };
            }
        ...
        Eo() {
            ...
            // updating many documents.
                    const t = this.ho;
            this.ho = un(), this.fo.forEach((t => {
                this.Io(t.key) && (this.ho = this.ho.add(t.key));
            }));
            // Diff the new limbo docs with the old limbo docs.
            const e = [];
            return t.forEach((t => {
                this.ho.has(t) || e.push(new Oo(t));
            })), this.ho.forEach((n => {
        ...
        // PORTING NOTE: Multi-tab only.
        Ro() {
            return To.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.ao);
        }
    }
     ...
     */ class Lo {
        ...
        s, i, r) {
            ...
            this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.bo = {}, this.vo = new vi((t => oe(t)), re), 
            this.Vo = new Map, 
            /**
             ...
             * active target.
             */
            this.Do = new He(at.comparator), 
            /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
            this.Co = new Map, this.No = new ur, 
            /** Stores user completion handlers, indexed by User and BatchId. */
            this.xo = {}, 
            /** Stores user callbacks waiting for all pending writes to be acknowledged. */
            this.ko = new Map, this.Oo = _i.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async function Bo(t, e) {
        ...
        s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Ro(); else {
            const t = await Zi(n.localStore, se(e)), r = n.sharedClientState.addLocalQueryTarget(t.targetId);
            s = t.targetId, i = await qo(n, e, s, "current" === r), n.isPrimaryClient && jr(n.remoteStore, t);
        }
        return i;
    }
     ...
     */ async function qo(t, e, n, s) {
        ...
        t.Mo = (e, n, s) => async function(t, e, n, s) {
            ...
            return tc(t, e.targetId, o.To), o.snapshot;
        }(t, e, n, s);
        const i = await er(t.localStore, e, 
        /* usePreviousResults= */ !0), r = new $o(e, i.Bn), o = r._o(i.documents), c = fn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.applyChanges(o, 
        /* updateLimboDocuments= */ t.isPrimaryClient, c);
        tc(t, n, u.To);
        const a = new Mo(e, n, r);
        return t.vo.set(e, a), t.Vo.has(n) ? t.Vo.get(n).push(e) : t.Vo.set(n, [ e ]), u.snapshot;
    }

    /** Stops listening to the query. */ async function Uo(t, e) {
        const n = $(t), s = n.vo.get(e), i = n.Vo.get(s.targetId);
        if (i.length > 1) return n.Vo.set(s.targetId, i.filter((t => !re(t, e)))), void n.vo.delete(e);
        // No other queries are mapped to the target, clean up the query and the target.
            ...
            /*keepPersistedTargetData=*/ !1).then((() => {
                n.sharedClientState.clearQueryState(s.targetId), Wr(n.remoteStore, s.targetId), 
                Xo(n, s.targetId);
            })).catch(Ei);
        } else Xo(n, s.targetId), await tr(n.localStore, s.targetId, 
     ...
     */ async function Ko(t, e, n) {
        ...
        try {
            const t = await function(t, e) {
                const n = $(t), s = U$1.now(), i = e.reduce(((t, e) => t.add(e.key)), un());
                let r;
                return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Fn.pn(t, i).next((i => {
                    ...
                    for (const t of e) {
                        ...
                        // exists=true
                        o.push(new Fe(t.key, e, Rt(e.toProto().mapValue), Se.exists(!0)));
                    }
     ...
     * it.
     */ (s, t.batchId, n), await sc$1(s, t.changes), await io(s.remoteStore);
        } catch (t) {
            // If we can't persist the mutation, we reject the user callback and
            // don't send the mutation. The user can then retry the write.
            const e = yo(t, "Failed to persist write");
            n.reject(e);
        }
    }
     ...
     */ async function Qo(t, e) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                O$1(t.addedDocuments.size + t.modifiedDocuments.size + t.removedDocuments.size <= 1), 
                t.addedDocuments.size > 0 ? s.Po = !0 : t.modifiedDocuments.size > 0 ? O$1(s.Po) : t.removedDocuments.size > 0 && (O$1(s.Po), 
                s.Po = !1));
            })), await sc$1(n, t, e);
        } catch (t) {
            await Ei(t);
     ...
     */ async function Wo(t, e, n) {
        ...
        if (r) {
            ...
            let t = new He(at.comparator);
            t = t.insert(r, Pt.newNoDocument(r, K$1.min()));
            const n = un().add(r), i = new ln(K$1.min(), 
            /* targetChanges= */ new Map, 
            /* targetMismatches= */ new Xe(L$1), t, n);
            await Qo(s, i), 
            ...
            s.Do = s.Do.remove(r), s.Co.delete(e), nc$1(s);
        } else await tr(s.localStore, e, 
        /* keepPersistedTargetData */ !1).then((() => Xo(s, e, n))).catch(Ei);
    }
    ...
    async function Go(t, e) {
        ...
        try {
            ...
            // before listen events.
                    Yo(n, s, /*error=*/ null), Jo(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
            await sc$1(n, t);
        } catch (t) {
            await Ei(t);
        }
        ...
        try {
            const t = await function(t, e) {
                ...
                return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                    let s;
                    return n._n.lookupMutationBatch(t, e).next((e => (O$1(null !== e), s = e.keys(), n._n.removeMutationBatch(t, e)))).next((() => n._n.performConsistencyCheck(t))).next((() => n.Fn.pn(t, s)));
                }));
            }
            /**
     ...
     */ (s.localStore, e);
            ...
            // listen events.
                    Yo(s, e, n), Jo(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
            await sc$1(s, t);
        } catch (n) {
            await Ei(n);
        }
     ...
     */ async function Ho(t, e) {
        const n = $(t);
        Yr(n.remoteStore) || D$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
            ...
            const n = yo(t, "Initialization of waitForPendingWrites() operation failed");
            e.reject(n);
        }
    }
    ...
    function Zo(t, e) {
        ...
        const n = t.Do.get(e);
        null !== n && (Wr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), nc$1(t));
    }

    function tc(t, e, n) {
        for (const s of n) if (s instanceof ko) t.No.addReference(s.key, e), ec$1(t, s); else if (s instanceof Oo) {
            D$1("SyncEngine", "Document no longer in limbo: " + s.key), t.No.removeReference(s.key, e);
    ...
    function ec$1(t, e) {
        ...
        t.Do.get(n) || t.So.has(s) || (D$1("SyncEngine", "New document in limbo: " + n), t.So.add(s), 
        nc$1(t));
    }
     ...
     */ function nc$1(t) {
        for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
            ...
            t.So.delete(e);
            const n = new at(z$1.fromString(e)), s = t.Oo.next();
            t.Co.set(s, new Fo(n)), t.Do = t.Do.insert(n, s), jr(t.remoteStore, new qs(se(Jt(n.path)), s, 2 /* LimboResolution */ , R$1.o));
        }
    }
    ...
    async function sc$1(t, e, n) {
        ...
        s.vo.isEmpty() || (s.vo.forEach(((t, c) => {
            ...
            try {
                ...
                D$1("LocalStore", "Failed to update sequence numbers: " + t);
            }
            for (const t of e) {
                const e = t.targetId;
                if (!t.fromCache) {
    ...
    async function ic$1(t, e) {
        ...
        if (!n.currentUser.isEqual(e)) {
            D$1("SyncEngine", "User change. New user:", e.toKey());
            ...
            function(t, e) {
                t.ko.forEach((t => {
                    t.forEach((t => {
                        t.reject(new b(P$1.CANCELLED, e));
                    }));
                })), t.ko.clear();
            }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await sc$1(n, t.Ln);
        }
    }

    function rc$1(t, e) {
        const n = $(t), s = n.Co.get(e);
        if (s && s.Po) return un().add(s.key);
        {
            let t = un();
            const s = n.Vo.get(e);
            if (!s) return t;
     ...
     */ async function oc$1(t, e) {
        const n = $(t), s = await er(n.localStore, e.query, 
        /* usePreviousResults= */ !0), i = e.view.Ao(s);
        return n.isPrimaryClient && tc(n, e.targetId, i.To), i;
    }
     ...
     */
    // PORTING NOTE: Multi-Tab only.
    async function cc$1(t) {
        const e = $(t);
        return sr(e.localStore).then((t => sc$1(e, t)));
    }

    /** Applies a mutation state to an existing batch.  */
    // PORTING NOTE: Multi-Tab only.
    async function uc$1(t, e, n, s) {
        ...
        await io(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
        // NOTE: Both these methods are no-ops for batches that originated from
        // other clients.
        Yo(i, e, s || null), Jo(i, e), function(t, e) {
            $($(t)._n).Gt(e);
        }
        // PORTING NOTE: Multi-Tab only.
        (i.localStore, e)) : k$1(), await sc$1(i, r)) : 
        ...
        // as applicable.
        D$1("SyncEngine", "Cannot apply mutation batch with id: " + e);
    }
    ...
    async function ac$1(t, e) {
        ...
        if (_c(n), mc$1(n), !0 === e && !0 !== n.$o) {
            ...
            const t = n.sharedClientState.getAllActiveQueryTargets(), e = await hc$1(n, t.toArray());
            n.$o = !0, await wo(n.remoteStore, !0);
            for (const t of e) jr(n.remoteStore, t);
        } else if (!1 === e && !1 !== n.$o) {
            const t = [];
            let e = Promise.resolve();
            n.Vo.forEach(((s, i) => {
                n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (Xo(n, i), 
                tr(n.localStore, i, 
                /*keepPersistedTargetData=*/ !0)))), Wr(n.remoteStore, i);
            })), await e, await hc$1(n, t), 
            // PORTING NOTE: Multi-Tab only.
            function(t) {
                const e = $(t);
                e.Co.forEach(((t, n) => {
                    Wr(e.remoteStore, n);
                })), e.No.ts(), e.Co = new Map, e.Do = new He(at.comparator);
            }
            /**
     ...
     */
            // PORTING NOTE: Multi-Tab only.
            (n), n.$o = !1, await wo(n.remoteStore, !1);
        }
    }
    ...
    async function hc$1(t, e, n) {
        ...
        for (const t of e) {
            ...
            if (n && 0 !== n.length) {
                ...
                e = await Zi(s.localStore, se(n[0]));
                for (const t of n) {
                    const e = s.vo.get(t), n = await oc$1(s, e);
                    n.snapshot && r.push(n.snapshot);
                }
            } else {
                // For queries that never executed on this client, we need to
                // allocate the target in LocalStore and initialize a new View.
                const n = await nr(s.localStore, t);
                e = await Zi(s.localStore, n), await qo(s, lc$1(n), t, 
                /*current=*/ !1);
            }
            i.push(e);
        }
    ...
    async function dc$1(t, e, n, s) {
        ...
        D$1("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
          case "current":
          case "not-current":
            {
                const t = await sr(i.localStore), s = ln.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
                await sc$1(i, t, s);
                break;
            }
          ...
          case "rejected":
            ...
            /* keepPersistedTargetData */ !0), Xo(i, e, s);
            break;
        ...
        if (s.$o) {
            for (const t of e) {
                if (s.Vo.has(t)) {
                    ...
                    D$1("SyncEngine", "Adding an already active target " + t);
                    continue;
                }
                const e = await nr(s.localStore, t), n = await Zi(s.localStore, e);
                await qo(s, lc$1(e), n.targetId, 
    ...
    function _c(t) {
        const e = $(t);
        return e.remoteStore.remoteSyncer.applyRemoteEvent = Qo.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = rc$1.bind(null, e), 
        e.remoteStore.remoteSyncer.rejectListen = Wo.bind(null, e), e.bo._r = bo.bind(null, e.eventManager), 
        e.bo.Fo = vo.bind(null, e.eventManager), e;
    }

    function mc$1(t) {
        const e = $(t);
        return e.remoteStore.remoteSyncer.applySuccessfulWrite = Go.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = zo.bind(null, e), 
        e;
    }
     ...
     */ (t.localStore, s)) return await e.close(), void n._completeWith(function(t) {
                ...
                const i = new No(s, t.localStore, e.R);
                let r = await e.Lo();
                for (;r; ) {
     ...
     */ (t.localStore, s), n._completeWith(o.progress);
                ...
                N$1("SyncEngine", `Loading bundle failed with ${t}`), n._failWith(t);
            }
        }
        /**
     * @license
    ...
    class yc$1 {
        ...
        async initialize(t) {
            this.R = Or(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), this.persistence = this.qo(t), 
        ...
        Ko(t) {
            return Wi(this.persistence, new Qi, t.initialUser, this.R);
        }
        qo(t) {
     ...
     */ class pc$1 extends yc$1 {
        ...
        async initialize(t) {
            await super.initialize(t), await ir(this.localStore), await this.Qo.initialize(this, t), 
            // Enqueue writes from a previous session
            await mc$1(this.Qo.syncEngine), await io(this.Qo.remoteStore);
        }
        Ko(t) {
            return Wi(this.persistence, new Qi, t.initialUser, this.R);
        }
        Uo(t) {
            ...
            return new Ai(e, t.asyncQueue);
        }
        qo(t) {
            const e = Bi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? ci.withCacheSize(this.cacheSizeBytes) : ci.DEFAULT;
            return new Mi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, xr(), kr(), this.R, this.sharedClientState, !!this.forceOwnership);
        }
        Bo(t) {
            return new vr;
        }
     ...
     */ class Ec$1 extends pc$1 {
        ...
        async initialize(t) {
            ...
            await this.persistence.He((async t => {
                await ac$1(this.Qo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
            }));
        }
        Bo(t) {
            const e = xr();
            if (!br.gt(e)) throw new b(P$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const n = Bi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
     ...
     */ class Tc$1 {
        async initialize(t, e) {
            ...
            this.remoteStore.remoteSyncer.handleCredentialChange = ic$1.bind(null, this.syncEngine), 
            await wo(this.remoteStore, this.syncEngine.isPrimaryClient));
        }
        createEventManager(t) {
            return new Ao;
        }
        createDatastore(t) {
            const e = Or(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Nr(s));
            var s;
        ...
        createRemoteStore(t) {
            ...
            r = Sr.gt() ? new Sr : new Vr, new Ur(e, n, s, i, r);
            var e, n, s, i, r;
        ...
        terminate() {
            return async function(t) {
                const e = $(t);
                D$1("RemoteStore", "RemoteStore shutting down."), e.Mr.add(5 /* Shutdown */), await Qr(e), 
                e.Lr.shutdown(), 
     ...
     */ class Rc$1 {
         ...
         */    async Ho() {
            ...
            return new Do(JSON.parse(s), t.length + n);
        }
    ...
    class Pc$1 {
        ...
        async lookup(t) {
            if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new b(P$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
            const e = await async function(t, e) {
                const n = $(t), s = xn(n.R) + "/documents", i = {
                    documents: e.map((t => Sn(n.R, t)))
        ...
        recordVersion(t) {
            ...
            if (n) {
                ...
                throw new b(P$1.ABORTED, "Document version changed between two reads.");
         ...
         */    precondition(t) {
            ...
            return !this.writtenDocs.has(t.toString()) && e ? Se.updateTime(e) : Se.none();
        }
        /**
         ...
         */    preconditionForUpdate(t) {
            ...
            // read time and existence
                ...
                // transaction.
                throw new b(P$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    class bc$1 {
        constructor(t, e, n, s) {
            ...
            this.ec = 5, this.Zi = new $r(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
        }
        ...
        nc() {
            this.Zi.ji((async () => {
                const t = new Pc$1(this.datastore), e = this.sc(t);
                e && e.then((e => {
    ...
    class vc$1 {
         ...
         */
        e, n) {
            this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = gr.UNAUTHENTICATED, 
            this.clientId = F$1.u(), this.credentialListener = () => {}, this.receivedInitialUser = new bs, 
            this.credentials.setChangeListener((t => {
                D$1("FirestoreClient", "Received user=", t.uid), this.user = t, this.credentialListener(t), 
         ...
         */    verifyNotTerminated() {
            if (this.asyncQueue.isShuttingDown) throw new b(P$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        terminate() {
            ...
            return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async () => {
                try {
                    ...
                    const n = yo(e, "Failed to shutdown persistence");
                    t.reject(n);
                }
            })), t.promise;
        }
    ...
    async function Vc$1(t, e) {
        t.asyncQueue.verifyOperationInProgress(), D$1("FirestoreClient", "Initializing OfflineComponentProvider");
        const n = await t.getConfiguration();
        await e.initialize(n);
        let s = n.initialUser;
        t.setCredentialChangeListener((n => {
            s.isEqual(n) || (s = n, t.asyncQueue.enqueueRetryable((async () => {
                await Gi(e.localStore, n);
            })));
        })), 
    ...
    async function Sc$1(t, e) {
        ...
        const n = await Dc$1(t);
        D$1("FirestoreClient", "Initializing OnlineComponentProvider");
        ...
        t.setCredentialChangeListener((n => t.asyncQueue.enqueueRetryable((() => async function(t, e) {
            const n = $(t);
            n.asyncQueue.verifyOperationInProgress(), D$1("RemoteStore", "RemoteStore received new credentials");
            const s = Yr(n);
            // Tear down and re-create our network streams. This will ensure we get a
            // fresh auth token for the new user and re-fill the write pipeline with
            // new mutations from the LocalStore (since mutations are per-user).
                    n.Mr.add(3 /* CredentialChange */), await Qr(n), s && 
            // Don't set the network status to Unknown if we are offline.
            n.Br.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
            n.Mr.delete(3 /* CredentialChange */), await Kr(n);
        }(e.remoteStore, n))))), t.onlineComponents = e;
    }

    async function Dc$1(t) {
        return t.offlineComponents || (D$1("FirestoreClient", "Using default OfflineComponentProvider"), 
        await Vc$1(t, new yc$1)), t.offlineComponents;
    }

    async function Cc$1(t) {
        return t.onlineComponents || (D$1("FirestoreClient", "Using default OnlineComponentProvider"), 
        await Sc$1(t, new Tc$1)), t.onlineComponents;
    }

    function Nc$1(t) {
        return Dc$1(t).then((t => t.persistence));
    }

    function xc(t) {
        return Dc$1(t).then((t => t.localStore));
    }

    function kc$1(t) {
        return Cc$1(t).then((t => t.remoteStore));
    }

    function Oc$1(t) {
        return Cc$1(t).then((t => t.syncEngine));
    }

    async function $c$1(t) {
        const e = await Cc$1(t), n = e.eventManager;
        return n.onListen = Bo.bind(null, e.syncEngine), n.onUnlisten = Uo.bind(null, e.syncEngine), 
        n;
    }

    /** Enables the network connection and re-enqueues all pending operations. */ function Mc$1(t) {
        return t.asyncQueue.enqueue((async () => {
            const e = await Nc$1(t), n = await kc$1(t);
            return e.setNetworkEnabled(!0), function(t) {
                const e = $(t);
                return e.Mr.delete(0 /* UserDisabled */), Kr(e);
            }(n);
        }));
    }

    /** Disables the network connection. Pending operations will not complete. */ function Fc$1(t) {
        return t.asyncQueue.enqueue((async () => {
            const e = await Nc$1(t), n = await kc$1(t);
            return e.setNetworkEnabled(!1), async function(t) {
                const e = $(t);
                e.Mr.add(0 /* UserDisabled */), await Qr(e), 
     ...
     */ function Lc$1(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
            try {
                ...
                s.isFoundDocument() ? n.resolve(s) : s.isNoDocument() ? n.resolve(null) : n.reject(new b(P$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (t) {
                const s = yo(t, `Failed to get document '${e} from cache`);
                n.reject(s);
            }
        }
        /**
        ...
        return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
            const r = new Ac$1({
                next: r => {
                    ...
                    i.reject(new b(P$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : c && r.fromCache && s && "server" === s.source ? i.reject(new b(P$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
                },
                error: t => i.reject(t)
            }), o = new So(Jt(n.path), r, {
                includeMetadataChanges: !0,
                so: !0
            });
            return Ro(t, o);
        }(await $c$1(t), t.asyncQueue, e, n, s))), s.promise;
    }
    ...
    function qc$1(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
            try {
                ...
                /* usePreviousResults= */ !0), i = new $o(e, s.Bn), r = i._o(s.documents), o = i.applyChanges(r, 
                /* updateLimboDocuments= */ !1);
                n.resolve(o.snapshot);
            } catch (t) {
                const s = yo(t, `Failed to execute query '${e} against cache`);
                n.reject(s);
            }
        }
        /**
        ...
        return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
            const r = new Ac$1({
                next: n => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    e.enqueueAndForget((() => Po(t, o))), n.fromCache && "server" === s.source ? i.reject(new b(P$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                },
                error: t => i.reject(t)
            }), o = new So(n, r, {
                includeMetadataChanges: !0,
     ...
     */ function Qc$1(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => {
            const s = await function(t) {
                return Cc$1(t).then((t => t.datastore));
            }(t);
            new bc$1(t.asyncQueue, s, e, n).run();
        })), n.promise;
    }

    function jc$1(t, e, n, s) {
        const i = function(t, e) {
            ...
            return function(t, e) {
                ...
                if (t instanceof Uint8Array) return Ic$1(t, e);
                if (t instanceof ArrayBuffer) return Ic$1(new Uint8Array(t), e);
    ...
    class zc$1 {
        ...
        isEqual(t) {
            return t instanceof zc$1 && t.projectId === this.projectId && t.database === this.database;
        }
    }
    ...
    /** A CredentialsProvider that always yields an empty token. */ class Yc$1 {
        constructor() {
            /**
    ...
    class Xc$1 {
        constructor(t) {
            ...
            this.currentUser = gr.UNAUTHENTICATED, this.receivedInitialUser = !1, 
            /**
        ...
        getToken() {
            ...
            this.cc !== t ? (D$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            this.getToken()) : e ? (O$1("string" == typeof e.accessToken), new Jc$1(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
        }
        invalidateToken() {
            this.forceRefresh = !0;
        }
        ...
        uc() {
            ...
            return O$1(null === t || "string" == typeof t), new gr(t);
        }
    }
     ...
     */ class Zc$1 {
        constructor(t, e, n) {
            this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = gr.FIRST_PARTY;
        }
        get authHeaders() {
            const t = {
     ...
     */ class tu {
        ...
        getToken() {
            return Promise.resolve(new Zc$1(this.ac, this.hc, this.lc));
        }
        setChangeListener(t) {
     ...
     */
    function eu(t, e, n) {
        if (!n) throw new b(P$1.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
    }
     ...
     */
    function nu(t) {
        if (!at.isDocumentKey(t)) throw new b(P$1.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
    }
     ...
     */ function su(t) {
        if (at.isDocumentKey(t)) throw new b(P$1.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
    }
     ...
     */ (t);
        ...
        return "function" == typeof t ? "a function" : k$1();
    }
    ...
    e) {
        ...
        t = t._delegate), !(t instanceof e)) {
            if (e.name === t.constructor.name) throw new b(P$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
            {
                const n = iu(t);
                throw new b(P$1.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
            }
        }
        return t;
    }
    ...
    function ou(t, e) {
        if (e <= 0) throw new b(P$1.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
    }
    ...
    class cu {
        constructor(t) {
            var e;
            if (void 0 === t.host) {
                if (void 0 !== t.ssl) throw new b(P$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
                this.host = "firestore.googleapis.com", this.ssl = true;
            } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
            if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
            void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
                if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new b(P$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
                this.cacheSizeBytes = t.cacheSizeBytes;
            }
            this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
            function(t, e, n, s) {
                if (!0 === e && !0 === s) throw new b(P$1.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
     ...
     */ class uu {
        /** @hideconstructor */
        constructor(t, e) {
            this._persistenceKey = "(lite)", this._settings = new cu({}), this._settingsFrozen = !1, 
            t instanceof zc$1 ? (this._databaseId = t, this._credentials = new Yc$1) : (this._app = t, 
            this._databaseId = function(t) {
                if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new b(P$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
                return new zc$1(t.options.projectId);
            }
            /**
     ...
     */ (t), this._credentials = new Xc$1(e));
        }
        /**
         * The {@link @firebase/app#FirebaseApp} associated with this `Firestore` service
         * instance.
         */    get app() {
            if (!this._app) throw new b(P$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        }
        get _initialized() {
        ...
        _setSettings(t) {
            if (this._settingsFrozen) throw new b(P$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
            this._settings = new cu(t), void 0 !== t.credentials && (this._credentials = function(t) {
                if (!t) return new Yc$1;
                switch (t.type) {
                  case "gapi":
                    const e = t.client;
                    // Make sure this really is a Gapi client.
                                    return O$1(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                  ...
                  default:
                    throw new b(P$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
                }
            }(t.credentials));
        }
        _getSettings() {
     ...
     */
            return function(t) {
                const e = Hc$1.get(t);
                e && (D$1("ComponentProvider", "Removing Datastore"), Hc$1.delete(t), e.terminate());
            }(this), Promise.resolve();
        }
    }

    function au(t, e, n) {
        const s = (t = ru(t, uu))._getSettings();
        "firestore.googleapis.com" !== s.host && s.host !== e && N$1("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
    ...
    function du(t, e, ...n) {
        if (t = getModularInstance(t), eu("collection", "path", e), t instanceof uu) {
            const s = z$1.fromString(e, ...n);
            return su(s), new fu(t, /* converter= */ null, s);
        }
        {
            if (!(t instanceof hu || t instanceof fu)) throw new b(P$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = z$1.fromString(t.path, ...n).child(z$1.fromString(e));
            return su(s), new fu(t.firestore, 
            /* converter= */ null, s);
        }
    }
     ...
     */ function wu(t, e) {
        if (t = ru(t, uu), eu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new b(P$1.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
        return new lu(t, 
        /* converter= */ null, 
        /**
    ...
    function _u(t, e, ...n) {
        ...
        // 'undefined' and 'null'.
        1 === arguments.length && (e = F$1.u()), eu("doc", "path", e), t instanceof uu) {
            const s = z$1.fromString(e, ...n);
            return nu(s), new hu(t, 
            /* converter= */ null, new at(s));
        }
        {
            if (!(t instanceof hu || t instanceof fu)) throw new b(P$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = t._path.child(z$1.fromString(e, ...n));
            return nu(s), new hu(t.firestore, t instanceof fu ? t._converter : null, new at(s));
        }
    }
     ...
     * Firestore database.
     */ function mu(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), (t instanceof hu || t instanceof fu) && (e instanceof hu || e instanceof fu) && (t.firestore === e.firestore && t.path === e.path && t._converter === e._converter);
    }
     ...
     * Firestore database.
     */ function gu(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), t instanceof lu && e instanceof lu && (t.firestore === e.firestore && re(t._query, e._query) && t._converter === e._converter);
    }
     ...
     */ class yu {
        constructor() {
            ...
            this.Zi = new $r(this, "async_queue_retry" /* AsyncQueueRetry */), 
            // Visibility handler that triggers an immediate retry of all retryable
            // operations. Meant to speed up recovery when we regain file system access
            // after page comes into foreground.
            this.Ec = () => {
                const t = kr();
                t && D$1("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.Zi.Gi();
            };
            const t = kr();
     ...
     // Failure will be handled by AsyncQueue
                                    D$1("AsyncQueue", "Operation failed with retryable error: " + t);
                }
                this.dc.length > 0 && 
     ...
     */ (t)), t;
        ...
        enqueueAfterDelay(t, e, n) {
            ...
            const s = go.createAndSchedule(this, t, e, n, (t => this.Rc(t)));
    ...
    class Iu extends uu {
        /** @hideconstructor */
        constructor(t, e) {
            super(t, e), this._queue = new yu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
        }
        _terminate() {
     ...
     */ function Au(e, n) {
        ...
        if (s.isInitialized()) throw new b(P$1.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
        if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new b(P$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
        return s.initialize({
            options: n
        });
    }
    ...
    function bu(t) {
        ...
        const n = t._freezeSettings(), s = function(t, e, n, s) {
            return new Gc$1(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling);
        }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
        t._firestoreClient = new vc$1(t._credentials, t._queue, s);
    }
     ...
     */ function vu(t, e) {
        Mu(t = ru(t, Iu));
        const n = Pu(t), s = t._freezeSettings(), i = new Tc$1;
        return Su(n, i, new pc$1(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
    }
     ...
     */ function Vu(t) {
        Mu(t = ru(t, Iu));
        const e = Pu(t), n = t._freezeSettings(), s = new Tc$1;
        return Su(e, s, new Ec$1(s, n.cacheSizeBytes));
    }
     ...
     */ function Su(t, e, n) {
        ...
        return t.asyncQueue.enqueue((async () => {
            try {
                await Vc$1(t, n), await Sc$1(t, e), s.resolve();
            } catch (t) {
                if (!
                /**
     ...
     */
                function(t) {
                    if ("FirebaseError" === t.name) return t.code === P$1.FAILED_PRECONDITION || t.code === P$1.UNIMPLEMENTED;
    ...
    function Du(t) {
        if (t._initialized && !t._terminated) throw new b(P$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const e = new bs;
        return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
            try {
                await async function(t) {
                    if (!Ss.gt()) return Promise.resolve();
                    const e = t + "main";
                    await Ss.delete(e);
                }(Bi(t._databaseId, t._persistenceKey)), e.resolve();
            } catch (t) {
                e.reject(t);
            }
        })), e.promise;
     ...
     */ function Cu(t) {
        return function(t) {
            const e = new bs;
            return t.asyncQueue.enqueueAndForget((async () => Ho(await Oc$1(t), e))), e.promise;
        }(Pu(t = ru(t, Iu)));
    }
     ...
     */ function Ou(t, e) {
        const n = Pu(t = ru(t, Iu)), s = new Eu;
        return jc$1(n, t._databaseId, e, s), s;
    }
     ...
     */ function $u(t, e) {
        return Wc$1(Pu(t = ru(t, Iu)), e).then((e => e ? new lu(t, null, e.query) : null));
    }

    function Mu(t) {
        if (t._initialized || t._terminated) throw new b(P$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
    }
    ...
    class Fu {
         ...
         */
        constructor(...t) {
            for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new b(P$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
            this._internalPath = new J$1(t);
        }
        /**
     ...
     */ class Bu {
         ...
         */    static fromBase64String(t) {
            try {
                return new Bu(X$1.fromBase64String(t));
            } catch (t) {
                throw new b(P$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
            }
        }
        /**
         ...
         */    static fromUint8Array(t) {
            return new Bu(X$1.fromUint8Array(t));
        }
        /**
     ...
     */ class Uu {
         ...
         */
        constructor(t, e) {
            if (!isFinite(t) || t < -90 || t > 90) throw new b(P$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
            if (!isFinite(e) || e < -180 || e > 180) throw new b(P$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
         ...
         * with an underscore.
         */    _compareTo(t) {
            return L$1(this._lat, t._lat) || L$1(this._long, t._long);
        }
    }
    ...
    /** The result of parsing document data (e.g. for a setData call). */ class Qu {
        constructor(t, e, n) {
            this.data = t, this.fieldMask = e, this.fieldTransforms = n;
        }
        toMutation(t, e) {
            return null !== this.fieldMask ? new Fe(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Me(t, this.data, e, this.fieldTransforms);
        }
    }

    /** The result of parsing "update" data (i.e. for an updateData call). */ class ju {
        constructor(t, 
    ...
    /** A "context" object passed around while parsing user data. */ class Gu {
        /**
        ...
        /** Returns a new context with the specified settings overwritten. */    Cc(t) {
            return new Gu(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
        }
        Nc(t) {
            var e;
        ...
        Mc(t) {
            return da$1(t, this.settings.methodName, this.settings.Fc || !1, this.path, this.settings.Lc);
        }
        ...
        kc(t) {
            ...
            if (Wu(this.Dc) && Ku.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
        }
    }
     ...
     */ class zu {
        constructor(t, e, n) {
            this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || Or(t);
        }
    ...
    function Hu(t) {
        const e = t._freezeSettings(), n = Or(t._databaseId);
        return new zu(t._databaseId, !!e.ignoreUndefinedProperties, n);
    }

    /** Parse document data from a set() call. */ function Ju(t, e, n, s, i, r = {}) {
        const o = t.Bc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
        aa$1("Data must be an object, but it was:", o, s);
        const c = ca$1(s, o);
        let u, a;
        if (r.merge) u = new Y$1(o.fieldMask), a = o.fieldTransforms; else if (r.mergeFields) {
            const t = [];
            for (const s of r.mergeFields) {
                const i = ha$1(e, s, n);
                if (!o.contains(i)) throw new b(P$1.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
                wa$1(t, i) || t.push(i);
            }
            u = new Y$1(t), a = o.fieldTransforms.filter((t => u.covers(t.field)));
    ...
    class ta$1 extends qu {
        constructor(t, e) {
            super(t), this.qc = e;
        }
        _toFieldTransform(t) {
            const e = Xu(this, t, 
            /*array=*/ !0), n = this.qc.map((t => oa$1(t, e))), s = new pe(n);
    ...
    class ea$1 extends qu {
        constructor(t, e) {
            super(t), this.qc = e;
        }
        _toFieldTransform(t) {
            const e = Xu(this, t, 
            /*array=*/ !0), n = this.qc.map((t => oa$1(t, e))), s = new Te(n);
            return new be(t.path, s);
        }
        isEqual(t) {
            // TODO(mrschmidt): Implement isEquals
    ...
    class na$1 extends qu {
        constructor(t, e) {
            super(t), this.Uc = e;
        }
        _toFieldTransform(t) {
            const e = new Ae(t.R, de(t.R, this.Uc));
    ...
    /** Parse update data from an update() call. */ function sa$1(t, e, n, s) {
        const i = t.Bc(1 /* Update */ , e, n);
        aa$1("Data must be an object, but it was:", i, s);
        const r = [], o = At.empty();
        j(s, ((t, s) => {
            const c = fa$1(e, t, n);
    ...
    /** Parse update data from a list of field/value arguments. */ function ia(t, e, n, s, i, r) {
        const o = t.Bc(1 /* Update */ , e, n), c = [ ha$1(e, s, n) ], u = [ i ];
        if (r.length % 2 != 0) throw new b(P$1.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
        for (let t = 0; t < r.length; t += 2) c.push(ha$1(e, r[t])), u.push(r[t + 1]);
        const a = [], h = At.empty();
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (let t = c.length - 1; t >= 0; --t) if (!wa$1(a, c[t])) {
            const e = c[t];
            let n = u[t];
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
        ...
        const l = new Y$1(a);
        return new ju(h, l, o.fieldTransforms);
    }
     ...
     */ function ra$1(t, e, n, s = !1) {
        return oa$1(n, t.Bc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
    }
     ...
     */ function oa$1(t, e) {
        ...
        // from firestore-exp.
        t = getModularInstance(t))) return aa$1("Unsupported field value:", e, t), ca$1(t, e);
        if (t instanceof qu) 
     ...
     */
        return function(t, e) {
            ...
            if (!Wu(e.Dc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
     ...
     */ (t, e), null;
        ...
        return function(t, e) {
            ...
            if ("number" == typeof t) return de(e.R, t);
            ...
            if (t instanceof Date) {
                const n = U$1.fromDate(t);
                return {
                    timestampValue: An(e.R, n)
                };
            }
            if (t instanceof U$1) {
                ...
                const n = new U$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
                return {
                    timestampValue: An(e.R, n)
                };
            }
            if (t instanceof Uu) return {
                geoPointValue: {
                    latitude: t.latitude,
            ...
            if (t instanceof Bu) return {
                bytesValue: Rn(e.R, t._byteString)
            };
            if (t instanceof hu) {
            ...
            throw e.Mc(`Unsupported field value: ${iu(t)}`);
        }
        /**
    ...
    function ua$1(t) {
        return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof U$1 || t instanceof Uu || t instanceof Bu || t instanceof hu || t instanceof qu);
    }
     ...
     */ function ha$1(t, e, n) {
        ...
        // FieldPath.
        e = getModularInstance(e)) instanceof Fu) return e._internalPath;
     ...
     * evaluated.
     */ function fa$1(t, e, n) {
        if (e.search(la) >= 0) throw da$1(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
        try {
    ...
    function da$1(t, e, n, s, i) {
        ...
        u += ")"), new b(P$1.INVALID_ARGUMENT, c + t + u);
    }

    /** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function wa$1(t, e) {
     ...
     */ class _a$1 {
         ...
         */    data() {
            if (this._document) {
                if (this._converter) {
                    ...
                    const t = new ma$1(this._firestore, this._userDataWriter, this._key, this._document, 
                    /* converter= */ null);
        ...
        get(t) {
            if (this._document) {
                const e = this._document.data.field(ga("DocumentSnapshot.get", t));
     ...
     * Helper that calls fromDotSeparatedString() but wraps any error thrown.
     */ function ga(t, e) {
        return "string" == typeof e ? fa$1(t, e) : e instanceof Fu ? e._internalPath : e._delegate._internalPath;
    }
     ...
     */ class pa$1 extends _a$1 {
         ...
         */    data(t = {}) {
            if (this._document) {
                if (this._converter) {
                    // We only want to use the converter and create a new DocumentSnapshot
                    // if a converter has been provided.
                    const e = new Ea$1(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                    /* converter= */ null);
        ...
        get(t, e = {}) {
            if (this._document) {
                const n = this._document.data.field(ga("DocumentSnapshot.get", t));
     ...
     */ class Ta$1 {
        /** @hideconstructor */
        constructor(t, e, n, s) {
            this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new ya(s.hasPendingWrites, s.fromCache), 
            this.query = n;
        }
         ...
         */    forEach(t, e) {
            this._snapshot.docs.forEach((n => {
                t.call(e, new Ea$1(this._firestore, this._userDataWriter, n.key, n, new ya(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query._converter));
            }));
        }
        /**
         ...
         */    docChanges(t = {}) {
            ...
            if (e && this._snapshot.excludesMetadataChanges) throw new b(P$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
            ...
            function(t, e) {
                if (t._snapshot.oldDocs.isEmpty()) {
                    ...
                    return t._snapshot.docChanges.map((s => {
                        const i = new Ea$1(t._firestore, t._userDataWriter, s.doc.key, s.doc, new ya(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query._converter);
                        return e = s.doc, {
                            type: "added",
                            doc: i,
                            oldIndex: -1,
                ...
                }
                {
                    ...
                    return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                        const s = new Ea$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ya(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                        let i = -1, r = -1;
     ...
     */ function Aa$1(t, e) {
        return t instanceof pa$1 && e instanceof pa$1 ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Ta$1 && e instanceof Ta$1 && (t._firestore === e._firestore && gu(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot));
    }
     ...
     * limitations under the License.
     */ function Ra$1(t) {
        if (Xt(t) && 0 === t.explicitOrderBy.length) throw new b(P$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
    ...
    class va$1 extends Pa$1 {
        ...
        _apply(t) {
            const e = Hu(t.firestore), n = function(t, e, n, s, i, r, o) {
                let c;
                if (i.isKeyField()) {
                    if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new b(P$1.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
                    if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                        Ua$1(o, r);
                        const e = [];
                        for (const n of o) e.push(qa$1(s, t, n));
                        c = {
                            arrayValue: {
                                values: e
                            }
                ...
                } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Ua$1(o, r), 
                c = ra$1(n, e, o, 
                /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
                const u = Nt.create(i, r, c);
                return function(t, e) {
                    if (e.g()) {
                        const n = te(t);
                        if (null !== n && !n.isEqual(e.field)) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                        const s = Zt(t);
                        null !== s && Ka$1(t, e.field, s);
                    }
                    const n = function(t, e) {
     ...
     */
                    ...
                    throw n === e.op ? new b(P$1.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new b(P$1.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
                }(t, u), u;
            }(t._query, "where", e, t.firestore._databaseId, this.Kc, this.Qc, this.jc);
            return new lu(t.firestore, t._converter, function(t, e) {
     ...
     * @returns The created `Query`.
     */ function Va$1(t, e, n) {
        const s = e, i = ga("where", t);
        return new va$1(i, s, n);
    }

    class Sa$1 extends Pa$1 {
        constructor(t, e) {
            super(), this.Kc = t, this.Wc = e, this.type = "orderBy";
        }
        _apply(t) {
            const e = function(t, e, n) {
                if (null !== t.startAt) throw new b(P$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
                if (null !== t.endAt) throw new b(P$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
                const s = new Qt(e, n);
                return function(t, e) {
                    if (null === Zt(t)) {
                        // This is the first order by. It must match any inequality.
                        const n = te(t);
                        null !== n && Ka$1(t, n, e.field);
                    }
                }(t, s), s;
            }
            /**
     ...
     * @returns The created `Query`.
     */ function Da$1(t, e = "asc") {
        const n = e, s = ga("orderBy", t);
        return new Sa$1(s, n);
    }

    class Ca$1 extends Pa$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Gc = e, this.zc = n;
        }
        _apply(t) {
            return new lu(t.firestore, t._converter, ie(t._query, this.Gc, this.zc));
        }
    }
     ...
     * @returns The created `Query`.
     */ function Na$1(t) {
        return ou("limit", t), new Ca$1("limit", t, "F" /* First */);
    }
     ...
     * @returns The created `Query`.
     */ function xa(t) {
        return ou("limitToLast", t), new Ca$1("limitToLast", t, "L" /* Last */);
    }

    class ka$1 extends Pa$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Hc = e, this.Jc = n;
        }
        _apply(t) {
            const e = Ba$1(t, this.type, this.Hc, this.Jc);
            return new lu(t.firestore, t._converter, function(t, e) {
    ...
    function Oa$1(...t) {
        return new ka$1("startAt", t, /*before=*/ !0);
    }

    function $a$1(...t) {
        return new ka$1("startAfter", t, 
        /*before=*/ !1);
    }

    class Ma$1 extends Pa$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Hc = e, this.Jc = n;
        }
        _apply(t) {
    ...
    function Fa$1(...t) {
        return new Ma$1("endBefore", t, /*before=*/ !0);
    }

    function La$1(...t) {
        return new Ma$1("endAt", t, /*before=*/ !1);
    }

    /** Helper function to create a bound from a document or fields */ function Ba$1(t, e, n, s) {
        if (n[0] = getModularInstance(n[0]), n[0] instanceof _a$1) return function(t, e, n, s, i) {
            if (!s) throw new b(P$1.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
            const r = [];
            ...
            // results.
                    for (const n of ne(t)) if (n.field.isKeyField()) r.push(gt(e, s.key)); else {
                const t = s.data.field(n.field);
                if (st(t)) throw new b(P$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === t) {
                    const t = n.field.canonicalString();
                    throw new b(P$1.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
                }
                r.push(t);
            }
            return new Ut(r, i);
     ...
     */ (t._query, t.firestore._databaseId, e, n[0]._document, s);
        {
            ...
            return function(t, e, n, s, i, r) {
                ...
                if (i.length > o.length) throw new b(P$1.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
                const c = [];
                for (let r = 0; r < i.length; r++) {
                    const u = i[r];
                    if (o[r].field.isKeyField()) {
                        if ("string" != typeof u) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof u}`);
                        if (!ee(t) && -1 !== u.indexOf("/")) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                        const n = t.path.child(z$1.fromString(u));
                        if (!at.isDocumentKey(n)) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                        const i = new at(n);
                        c.push(gt(e, i));
                    } else {
                        const t = ra$1(n, s, u);
    ...
    function qa$1(t, e, n) {
        if ("string" == typeof (n = getModularInstance(n))) {
            if ("" === n) throw new b(P$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!ee(e) && -1 !== n.indexOf("/")) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
            const s = e.path.child(z$1.fromString(n));
            if (!at.isDocumentKey(s)) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
            return gt(t, new at(s));
        }
        if (n instanceof hu) return gt(t, n._key);
        throw new b(P$1.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${iu(n)}.`);
    }
     ...
     * array requirements.
     */ function Ua$1(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new b(P$1.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
        if (t.length > 10) throw new b(P$1.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
    }

    function Ka$1(t, e, n) {
        if (!n.isEqual(e)) throw new b(P$1.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
    }
     ...
     */ class Qa$1 {
        ...
        convertGeoPoint(t) {
            return new Uu(et(t.latitude), et(t.longitude));
        }
        convertArray(t, e) {
        ...
        convertDocumentKey(t, e) {
            const n = z$1.fromString(t);
            O$1(ns(n));
            const s = new zc$1(n.get(1), n.get(3)), i = new at(n.popFirst(5));
            return s.isEqual(e) || 
     ...
     */ class Ga$1 {
        ...
        set(t, e, n) {
            ...
            const s = za$1(t, this._firestore), i = ja$1(s._converter, e, n), r = Ju(this._dataReader, "WriteBatch.set", s._key, i, null !== s._converter, n);
            return this._mutations.push(r.toMutation(s._key, Se.none())), this;
        }
        update(t, e, n, ...s) {
            this._verifyNotCommitted();
            const i = za$1(t, this._firestore);
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    let r;
            return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Fu ? ia(this._dataReader, "WriteBatch.update", i._key, e, n, s) : sa$1(this._dataReader, "WriteBatch.update", i._key, e), 
            this._mutations.push(r.toMutation(i._key, Se.exists(!0))), this;
        }
        /**
         ...
         */    delete(t) {
            this._verifyNotCommitted();
            const e = za$1(t, this._firestore);
        ...
        _verifyNotCommitted() {
            if (this._committed) throw new b(P$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
        }
    }

    function za$1(t, e) {
        if ((t = getModularInstance(t)).firestore !== e) throw new b(P$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return t;
    }
    ...
    function Ha$1(t) {
        t = ru(t, hu);
        const e = ru(t.firestore, Iu);
        return Bc$1(Pu(e), t._key).then((n => ah(e, t, n)));
    }

    class Ja$1 extends Qa$1 {
        constructor(t) {
            super(), this.firestore = t;
        }
        convertBytes(t) {
     ...
     */ function Ya$1(t) {
        t = ru(t, hu);
        const e = ru(t.firestore, Iu), n = Pu(e), s = new Ja$1(e);
        return Lc$1(n, t._key).then((n => new pa$1(e, s, t._key, n, new ya(null !== n && n.hasLocalMutations, 
     ...
     */ function Za$1(t) {
        t = ru(t, lu);
        const e = ru(t.firestore, Iu), n = Pu(e), s = new Ja$1(e);
        return Ra$1(t._query), Uc$1(n, t._query).then((n => new Ta$1(e, s, t, n)));
    }
     ...
     */ function th(t) {
        t = ru(t, lu);
        const e = ru(t.firestore, Iu), n = Pu(e), s = new Ja$1(e);
        return qc$1(n, t._query).then((n => new Ta$1(e, s, t, n)));
    }
     ...
     */ function eh(t) {
        t = ru(t, lu);
        const e = ru(t.firestore, Iu), n = Pu(e), s = new Ja$1(e);
        return Uc$1(n, t._query, {
            source: "server"
        }).then((n => new Ta$1(e, s, t, n)));
    }

    function nh(t, e, n) {
        t = ru(t, hu);
        const s = ru(t.firestore, Iu), i = ja$1(t._converter, e, n);
        return uh(s, [ Ju(Hu(s), "setDoc", t._key, i, null !== t._converter, n).toMutation(t._key, Se.none()) ]);
    }

    function sh(t, e, n, ...s) {
        t = ru(t, hu);
        const i = ru(t.firestore, Iu), r = Hu(i);
        let o;
        o = "string" == typeof (
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        e = getModularInstance(e)) || e instanceof Fu ? ia(r, "updateDoc", t._key, e, n, s) : sa$1(r, "updateDoc", t._key, e);
        return uh(i, [ o.toMutation(t._key, Se.exists(!0)) ]);
    }
     ...
     */ function ih(t) {
        return uh(ru(t.firestore, Iu), [ new Ue(t._key, Se.none()) ]);
    }
     ...
     */ function rh(t, e) {
        const n = ru(t.firestore, Iu), s = _u(t), i = ja$1(t._converter, e);
        return uh(n, [ Ju(Hu(t.firestore), "addDoc", s._key, i, null !== t._converter, {}).toMutation(s._key, Se.exists(!1)) ]).then((() => s));
    }
    ...
    function oh(t, ...e) {
        ...
        let u, a, h;
        if (t instanceof hu) a = ru(t.firestore, Iu), h = Jt(t._key.path), u = {
            next: n => {
                e[o] && e[o](ah(a, t, n));
            },
            error: e[o + 1],
            ...
            const n = ru(t, lu);
            a = ru(n.firestore, Iu), h = n._query;
            const s = new Ja$1(a);
            u = {
                next: t => {
                    e[o] && e[o](new Ta$1(a, s, n, t));
                },
                error: e[o + 1],
                complete: e[o + 2]
            }, Ra$1(t._query);
        ...
        return function(t, e, n, s) {
            const i = new Ac$1(s), r = new So(e, i, n);
            return t.asyncQueue.enqueueAndForget((async () => Ro(await $c$1(t), r))), () => {
                i.Wo(), t.asyncQueue.enqueueAndForget((async () => Po(await $c$1(t), r)));
            };
        }(Pu(a), h, c, u);
    }

    function ch(t, e) {
        return Kc$1(Pu(t = ru(t, Iu)), pu(e) ? e : {
            next: e
        });
    }
     ...
     */ function uh(t, e) {
        return function(t, e) {
            const n = new bs;
            return t.asyncQueue.enqueueAndForget((async () => Ko(await Oc$1(t), e, n))), n.promise;
        }(Pu(t), e);
    }
     ...
     */ function ah(t, e, n) {
        const s = n.docs.get(e._key), i = new Ja$1(t);
        return new pa$1(t, i, e._key, s, new ya(n.hasPendingWrites, n.fromCache), e._converter);
    }
     ...
     */ class hh extends class {
         ...
         */    get(t) {
            const e = za$1(t, this._firestore), n = new Wa$1(this._firestore);
            return this._transaction.lookup([ e._key ]).then((t => {
                if (!t || 1 !== t.length) return k$1();
                const s = t[0];
                if (s.isFoundDocument()) return new _a$1(this._firestore, n, s.key, s, e._converter);
                if (s.isNoDocument()) return new _a$1(this._firestore, n, e._key, null, e._converter);
                throw k$1();
            }));
        }
        set(t, e, n) {
            const s = za$1(t, this._firestore), i = ja$1(s._converter, e, n), r = Ju(this._dataReader, "Transaction.set", s._key, i, null !== s._converter, n);
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let r;
            return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Fu ? ia(this._dataReader, "Transaction.update", i._key, e, n, s) : sa$1(this._dataReader, "Transaction.update", i._key, e), 
         ...
         * @returns A `DocumentSnapshot` with the read data.
         */    get(t) {
            const e = za$1(t, this._firestore), n = new Ja$1(this._firestore);
            return super.get(t).then((t => new pa$1(this._firestore, n, e._key, t._document, new ya(
            /* hasPendingWrites= */ !1, 
     ...
     */ function lh(t, e) {
        return Qc$1(Pu(t), (n => e(new hh(t, n))));
    }
     ...
     * writes.
     */ function gh(t) {
        return Pu(t = ru(t, Iu)), new Ga$1(t, (e => uh(t, e)));
    }
    ...
    app._registerComponent(new Component("firestore-exp", ((t, {options: e}) => {
        const n = t.getProvider("app-exp").getImmediate(), s = new Iu(n, t.getProvider("auth-internal"));
        return e && s._setSettings(e), s;
    }), "PUBLIC" /* PUBLIC */)), app.registerVersion("@firebase/firestore", "0.0.900-exp.f6733b13b", yh);

    exports.AbstractUserDataWriter = Qa$1;
    exports.Bytes = Bu;
    exports.CACHE_SIZE_UNLIMITED = Tu;
    exports.CollectionReference = fu;
    exports.DocumentReference = hu;
    exports.DocumentSnapshot = pa$1;
    exports.FieldPath = Fu;
    exports.FieldValue = qu;
    exports.FirebaseFirestore = Iu;
    exports.FirestoreError = b;
    exports.GeoPoint = Uu;
    exports.LoadBundleTask = Eu;
    exports.Query = lu;
    exports.QueryConstraint = Pa$1;
    exports.QueryDocumentSnapshot = Ea$1;
    exports.QuerySnapshot = Ta$1;
    exports.SnapshotMetadata = ya;
    exports.Timestamp = U$1;
    exports.Transaction = hh;
    exports.WriteBatch = Ga$1;
    exports.addDoc = rh;
    exports.arrayRemove = _h;
    exports.arrayUnion = wh;
    exports.clearIndexedDbPersistence = Du;
    exports.collection = du;
    exports.collectionGroup = wu;
    exports.deleteDoc = ih;
    exports.deleteField = fh;
    exports.disableNetwork = xu;
    exports.doc = _u;
    exports.documentId = Lu;
    exports.enableIndexedDbPersistence = vu;
    exports.enableMultiTabIndexedDbPersistence = Vu;
    exports.enableNetwork = Nu;
    exports.endAt = La$1;
    exports.endBefore = Fa$1;
    exports.ensureFirestoreConfigured = Pu;
    exports.executeWrite = uh;
    exports.getDoc = Ha$1;
    exports.getDocFromCache = Ya$1;
    exports.getDocFromServer = Xa$1;
    exports.getDocs = Za$1;
    exports.getDocsFromCache = th;
    exports.getDocsFromServer = eh;
    exports.getFirestore = Ru;
    exports.increment = mh;
    exports.initializeFirestore = Au;
    exports.limit = Na$1;
    exports.limitToLast = xa;
    exports.loadBundle = Ou;
    exports.namedQuery = $u;
    exports.onSnapshot = oh;
    exports.onSnapshotsInSync = ch;
    exports.orderBy = Da$1;
    exports.query = ba$1;
    exports.queryEqual = gu;
    exports.refEqual = mu;
    exports.runTransaction = lh;
    exports.serverTimestamp = dh;
    exports.setDoc = nh;
    exports.setLogLevel = S$1;
    exports.snapshotEqual = Aa$1;
    exports.startAfter = $a$1;
    exports.startAt = Oa$1;
    exports.terminate = ku;
    exports.updateDoc = sh;
    exports.useFirestoreEmulator = au;
    exports.waitForPendingWrites = Cu;
    exports.where = Va$1;
    exports.writeBatch = gh;
