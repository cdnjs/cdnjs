...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */e._registerComponent(new m("firestore-exp",((t,{options:e})=>{const n=t.getProvider("app-exp").getImmediate(),r=new Jl(n,t.getProvider("auth-internal"));return e&&r._setSettings(e),r}),"PUBLIC")),e.registerVersion("@firebase/firestore","0.0.900-exp.f6733b13b",undefined);
/**
     * @license
     * Copyright 2017 Google LLC
     *
