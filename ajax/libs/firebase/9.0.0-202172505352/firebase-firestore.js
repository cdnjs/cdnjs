import { _getProvider, getApp, _removeServiceInstance, SDK_VERSION, _registerComponent, registerVersion } from 'https://www.gstatic.com/firebasejs/9.0.0-202172505352/firebase-app.js';
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0-202172505352/firebase-app.js#FirebaseApp} with which the {@link Firestore} instance will
 * be associated.
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0-202172505352/firebase-app.js#FirebaseApp} instance that the returned {@link Firestore}
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("@firebase/firestore", "3.0.0-202172505352", Sh);
