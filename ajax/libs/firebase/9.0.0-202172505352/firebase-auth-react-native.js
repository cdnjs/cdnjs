...
import app from 'https://www.gstatic.com/firebasejs/9.0.0-202172505352/firebase-app.js';
                    ...
                    return tslib.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, storage.setItem(enum_maps79d8e7e8.STORAGE_AVAILABLE_KEY, '1')];
                            case 1:
                                _b.sent();
                                return [4 /*yield*/, storage.removeItem(enum_maps79d8e7e8.STORAGE_AVAILABLE_KEY)];
                            case 2:
                                _b.sent();
                                return [2 /*return*/, true];
                            case 3:
...
function getAuth(app$1) {
    ...
    return enum_maps79d8e7e8.initializeAuth(app$1, {
        persistence: reactNativeLocalPersistence
    });
}
enum_maps79d8e7e8.registerAuth("ReactNative" /* REACT_NATIVE */);

var ActionCodeOperation = enum_maps79d8e7e8.ActionCodeOperation;
var ActionCodeURL = enum_maps79d8e7e8.ActionCodeURL;
var AuthCredential = enum_maps79d8e7e8.AuthCredential;
var AuthErrorCodes = enum_maps79d8e7e8.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
var EmailAuthCredential = enum_maps79d8e7e8.EmailAuthCredential;
var EmailAuthProvider = enum_maps79d8e7e8.EmailAuthProvider;
var FacebookAuthProvider = enum_maps79d8e7e8.FacebookAuthProvider;
var FactorId = enum_maps79d8e7e8.FactorId;
var GithubAuthProvider = enum_maps79d8e7e8.GithubAuthProvider;
var GoogleAuthProvider = enum_maps79d8e7e8.GoogleAuthProvider;
var OAuthCredential = enum_maps79d8e7e8.OAuthCredential;
var OAuthProvider = enum_maps79d8e7e8.OAuthProvider;
var OperationType = enum_maps79d8e7e8.OperationType;
var PhoneAuthCredential = enum_maps79d8e7e8.PhoneAuthCredential;
var ProviderId = enum_maps79d8e7e8.ProviderId;
var SAMLAuthProvider = enum_maps79d8e7e8.SAMLAuthProvider;
var SignInMethod = enum_maps79d8e7e8.SignInMethod;
var TwitterAuthProvider = enum_maps79d8e7e8.TwitterAuthProvider;
var applyActionCode = enum_maps79d8e7e8.applyActionCode;
var checkActionCode = enum_maps79d8e7e8.checkActionCode;
var confirmPasswordReset = enum_maps79d8e7e8.confirmPasswordReset;
var connectAuthEmulator = enum_maps79d8e7e8.connectAuthEmulator;
var createUserWithEmailAndPassword = enum_maps79d8e7e8.createUserWithEmailAndPassword;
var debugErrorMap = enum_maps79d8e7e8.debugErrorMap;
var deleteUser = enum_maps79d8e7e8.deleteUser;
var fetchSignInMethodsForEmail = enum_maps79d8e7e8.fetchSignInMethodsForEmail;
var getAdditionalUserInfo = enum_maps79d8e7e8.getAdditionalUserInfo;
var getIdToken = enum_maps79d8e7e8.getIdToken;
var getIdTokenResult = enum_maps79d8e7e8.getIdTokenResult;
var getMultiFactorResolver = enum_maps79d8e7e8.getMultiFactorResolver;
var inMemoryPersistence = enum_maps79d8e7e8.inMemoryPersistence;
var initializeAuth = enum_maps79d8e7e8.initializeAuth;
var isSignInWithEmailLink = enum_maps79d8e7e8.isSignInWithEmailLink;
var linkWithCredential = enum_maps79d8e7e8.linkWithCredential;
var multiFactor = enum_maps79d8e7e8.multiFactor;
var onAuthStateChanged = enum_maps79d8e7e8.onAuthStateChanged;
var onIdTokenChanged = enum_maps79d8e7e8.onIdTokenChanged;
var parseActionCodeURL = enum_maps79d8e7e8.parseActionCodeURL;
var prodErrorMap = enum_maps79d8e7e8.prodErrorMap;
var reauthenticateWithCredential = enum_maps79d8e7e8.reauthenticateWithCredential;
var reload = enum_maps79d8e7e8.reload;
var sendEmailVerification = enum_maps79d8e7e8.sendEmailVerification;
var sendPasswordResetEmail = enum_maps79d8e7e8.sendPasswordResetEmail;
var sendSignInLinkToEmail = enum_maps79d8e7e8.sendSignInLinkToEmail;
var setPersistence = enum_maps79d8e7e8.setPersistence;
var signInAnonymously = enum_maps79d8e7e8.signInAnonymously;
var signInWithCredential = enum_maps79d8e7e8.signInWithCredential;
var signInWithCustomToken = enum_maps79d8e7e8.signInWithCustomToken;
var signInWithEmailAndPassword = enum_maps79d8e7e8.signInWithEmailAndPassword;
var signInWithEmailLink = enum_maps79d8e7e8.signInWithEmailLink;
var signOut = enum_maps79d8e7e8.signOut;
var unlink = enum_maps79d8e7e8.unlink;
var updateCurrentUser = enum_maps79d8e7e8.updateCurrentUser;
var updateEmail = enum_maps79d8e7e8.updateEmail;
var updatePassword = enum_maps79d8e7e8.updatePassword;
var updateProfile = enum_maps79d8e7e8.updateProfile;
var useDeviceLanguage = enum_maps79d8e7e8.useDeviceLanguage;
var verifyBeforeUpdateEmail = enum_maps79d8e7e8.verifyBeforeUpdateEmail;
var verifyPasswordResetCode = enum_maps79d8e7e8.verifyPasswordResetCode;
