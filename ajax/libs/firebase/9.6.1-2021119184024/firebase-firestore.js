import { _registerComponent, registerVersion, _getProvider, getApp, _removeServiceInstance, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.6.1-2021119184024/firebase-app.js';
 ...
 */ (t));
    ...
    /**
     * The {@link https://www.gstatic.com/firebasejs/9.6.1-2021119184024/firebase-app.js#FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.6.1-2021119184024/firebase-app.js#FirebaseApp} with which the {@link Firestore} instance will
 * be associated.
 ...
 * provided {@link https://www.gstatic.com/firebasejs/9.6.1-2021119184024/firebase-app.js#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.6.1-2021119184024/firebase-app.js#FirebaseApp} instance that the returned {@link Firestore}
 ...
 */ !function(t, e = !0) {
    ...
    }), "PUBLIC")), registerVersion(S, "3.4.1-2021119184024", t), 
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(S, "3.4.1-2021119184024", "esm2017");
}();
