import { _registerComponent, registerVersion, _getProvider, getApp, _removeServiceInstance, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.1.3-pr5646.2abc5e854/firebase-app.js';
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.1.3-pr5646.2abc5e854/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 */ (t));
    ...
    /**
     * The {@link https://www.gstatic.com/firebasejs/9.1.3-pr5646.2abc5e854/firebase-app.js#FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
 ...
 * provided {@link https://www.gstatic.com/firebasejs/9.1.3-pr5646.2abc5e854/firebase-app.js#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.1.3-pr5646.2abc5e854/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
...
registerVersion("firestore-lite", "3.1.1-pr5646.2abc5e854", ""), registerVersion("firestore-lite", "3.1.1-pr5646.2abc5e854", "esm2017");
