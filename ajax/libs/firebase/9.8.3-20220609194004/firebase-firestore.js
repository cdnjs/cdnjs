import { _registerComponent, registerVersion, _getProvider, getApp, _removeServiceInstance, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.8.3-20220609194004/firebase-app.js';
 ...
 */ (t));
    ...
    /**
     * The {@link https://www.gstatic.com/firebasejs/9.8.3-20220609194004/firebase-app.js#FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.8.3-20220609194004/firebase-app.js#FirebaseApp} with which the {@link Firestore} instance will
 * be associated.
 ...
 * provided {@link https://www.gstatic.com/firebasejs/9.8.3-20220609194004/firebase-app.js#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.8.3-20220609194004/firebase-app.js#FirebaseApp} instance that the returned {@link Firestore}
 ...
 */ !function(t, e = !0) {
    ...
    }), "PUBLIC")), registerVersion(D, "3.4.10-20220609194004", t), 
    // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
    registerVersion(D, "3.4.10-20220609194004", "esm2017");
}();
