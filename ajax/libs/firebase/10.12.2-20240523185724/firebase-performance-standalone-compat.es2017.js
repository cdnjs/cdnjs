...
/**
     ...
     * limitations under the License.
     */
De.registerVersion("firebase","10.12.2-20240523185724","app-compat");const Oe="@firebase/installations",Ne="0.6.7",ke=1e4,Le="w:0.6.7",Me="FIS_v2",Re=36e5,Pe=new f("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function Be(e){return e instanceof h&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return De.registerVersion("firebase","10.12.2-20240523185724","compat-lite"),De}));
