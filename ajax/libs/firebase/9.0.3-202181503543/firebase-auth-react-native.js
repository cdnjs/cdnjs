...
import require$$2 from 'https://www.gstatic.com/firebasejs/9.0.3-202181503543/firebase-app.js';
...
function startEnrollPhoneMfa(auth, request) {
    return _performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaEnrollment:start" /* START_PHONE_MFA_ENROLLMENT */, tslib$1.__assign({ tenantId: auth.tenantId }, request));
}
function finalizeEnrollPhoneMfa(auth, request) {
    return _performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaEnrollment:finalize" /* FINALIZE_PHONE_MFA_ENROLLMENT */, tslib$1.__assign({ tenantId: auth.tenantId }, request));
}
function withdrawMfa(auth, request) {
    return _performApiRequest(auth, "POST" /* POST */, "/v2/accounts/mfaEnrollment:withdraw" /* WITHDRAW_MFA */, tslib$1.__assign({ tenantId: auth.tenantId }, request));
}
...
enum_maps0151f4a9.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
enum_maps0151f4a9.ActionCodeOperation = ActionCodeOperation$1;
enum_maps0151f4a9.ActionCodeURL = ActionCodeURL$1;
enum_maps0151f4a9.AuthCredential = AuthCredential$1;
enum_maps0151f4a9.AuthImpl = AuthImpl;
enum_maps0151f4a9.BaseOAuthProvider = BaseOAuthProvider;
enum_maps0151f4a9.Delay = Delay;
enum_maps0151f4a9.EmailAuthCredential = EmailAuthCredential$1;
enum_maps0151f4a9.EmailAuthProvider = EmailAuthProvider$1;
enum_maps0151f4a9.FacebookAuthProvider = FacebookAuthProvider$1;
enum_maps0151f4a9.FactorId = FactorId$1;
enum_maps0151f4a9.FederatedAuthProvider = FederatedAuthProvider;
enum_maps0151f4a9.FetchProvider = FetchProvider;
enum_maps0151f4a9.GithubAuthProvider = GithubAuthProvider$1;
enum_maps0151f4a9.GoogleAuthProvider = GoogleAuthProvider$1;
enum_maps0151f4a9.OAuthCredential = OAuthCredential$1;
enum_maps0151f4a9.OAuthProvider = OAuthProvider$1;
enum_maps0151f4a9.OperationType = OperationType$1;
enum_maps0151f4a9.PhoneAuthCredential = PhoneAuthCredential$1;
enum_maps0151f4a9.ProviderId = ProviderId$1;
enum_maps0151f4a9.SAMLAuthCredential = SAMLAuthCredential;
enum_maps0151f4a9.SAMLAuthProvider = SAMLAuthProvider$1;
enum_maps0151f4a9.STORAGE_AVAILABLE_KEY = STORAGE_AVAILABLE_KEY;
enum_maps0151f4a9.SignInMethod = SignInMethod$1;
enum_maps0151f4a9.TwitterAuthProvider = TwitterAuthProvider$1;
enum_maps0151f4a9.UserImpl = UserImpl;
enum_maps0151f4a9._assert = _assert;
enum_maps0151f4a9._assertInstanceOf = _assertInstanceOf;
enum_maps0151f4a9._assertLinkedStatus = _assertLinkedStatus;
enum_maps0151f4a9._castAuth = _castAuth;
enum_maps0151f4a9._createError = _createError;
enum_maps0151f4a9._emulatorUrl = _emulatorUrl;
enum_maps0151f4a9._fail = _fail;
enum_maps0151f4a9._getClientVersion = _getClientVersion;
enum_maps0151f4a9._getCurrentUrl = _getCurrentUrl;
enum_maps0151f4a9._getInstance = _getInstance;
enum_maps0151f4a9._isAndroid = _isAndroid;
enum_maps0151f4a9._isChromeIOS = _isChromeIOS;
enum_maps0151f4a9._isFirefox = _isFirefox;
enum_maps0151f4a9._isHttpOrHttps = _isHttpOrHttps;
enum_maps0151f4a9._isIE10 = _isIE10;
enum_maps0151f4a9._isIOS = _isIOS;
enum_maps0151f4a9._isIOS7Or8 = _isIOS7Or8;
enum_maps0151f4a9._isIOSStandalone = _isIOSStandalone;
enum_maps0151f4a9._isIframe = _isIframe;
enum_maps0151f4a9._isMobileBrowser = _isMobileBrowser;
enum_maps0151f4a9._isSafari = _isSafari;
enum_maps0151f4a9._link = _link;
enum_maps0151f4a9._performApiRequest = _performApiRequest;
enum_maps0151f4a9._persistenceKeyName = _persistenceKeyName;
enum_maps0151f4a9._reauthenticate = _reauthenticate;
enum_maps0151f4a9._signInWithCredential = _signInWithCredential;
enum_maps0151f4a9.applyActionCode = applyActionCode$2;
enum_maps0151f4a9.checkActionCode = checkActionCode$1;
enum_maps0151f4a9.confirmPasswordReset = confirmPasswordReset$1;
enum_maps0151f4a9.connectAuthEmulator = connectAuthEmulator$1;
enum_maps0151f4a9.createUserWithEmailAndPassword = createUserWithEmailAndPassword$1;
enum_maps0151f4a9.debugAssert = debugAssert;
enum_maps0151f4a9.debugErrorMap = debugErrorMap$1;
enum_maps0151f4a9.debugFail = debugFail;
enum_maps0151f4a9.deleteUser = deleteUser$1;
enum_maps0151f4a9.fetchSignInMethodsForEmail = fetchSignInMethodsForEmail$1;
enum_maps0151f4a9.finalizeEnrollPhoneMfa = finalizeEnrollPhoneMfa;
enum_maps0151f4a9.getAdditionalUserInfo = getAdditionalUserInfo$1;
enum_maps0151f4a9.getIdToken = getIdToken$1;
enum_maps0151f4a9.getIdTokenResult = getIdTokenResult$1;
enum_maps0151f4a9.getMultiFactorResolver = getMultiFactorResolver$1;
enum_maps0151f4a9.inMemoryPersistence = inMemoryPersistence$1;
enum_maps0151f4a9.initializeAuth = initializeAuth$1;
enum_maps0151f4a9.isSignInWithEmailLink = isSignInWithEmailLink$1;
enum_maps0151f4a9.linkWithCredential = linkWithCredential$1;
enum_maps0151f4a9.multiFactor = multiFactor$1;
enum_maps0151f4a9.onAuthStateChanged = onAuthStateChanged$1;
enum_maps0151f4a9.onIdTokenChanged = onIdTokenChanged$1;
enum_maps0151f4a9.parseActionCodeURL = parseActionCodeURL$1;
enum_maps0151f4a9.prodErrorMap = prodErrorMap$1;
enum_maps0151f4a9.reauthenticateWithCredential = reauthenticateWithCredential$1;
enum_maps0151f4a9.registerAuth = registerAuth;
enum_maps0151f4a9.reload = reload$1;
enum_maps0151f4a9.sendEmailVerification = sendEmailVerification$2;
enum_maps0151f4a9.sendPasswordResetEmail = sendPasswordResetEmail$2;
enum_maps0151f4a9.sendPhoneVerificationCode = sendPhoneVerificationCode;
enum_maps0151f4a9.sendSignInLinkToEmail = sendSignInLinkToEmail$2;
enum_maps0151f4a9.setPersistence = setPersistence$1;
enum_maps0151f4a9.signInAnonymously = signInAnonymously$1;
enum_maps0151f4a9.signInWithCredential = signInWithCredential$1;
enum_maps0151f4a9.signInWithCustomToken = signInWithCustomToken$2;
enum_maps0151f4a9.signInWithEmailAndPassword = signInWithEmailAndPassword$1;
enum_maps0151f4a9.signInWithEmailLink = signInWithEmailLink$2;
enum_maps0151f4a9.signInWithIdp = signInWithIdp;
enum_maps0151f4a9.signOut = signOut$1;
enum_maps0151f4a9.startEnrollPhoneMfa = startEnrollPhoneMfa;
enum_maps0151f4a9.unlink = unlink$1;
enum_maps0151f4a9.updateCurrentUser = updateCurrentUser$1;
enum_maps0151f4a9.updateEmail = updateEmail$1;
enum_maps0151f4a9.updatePassword = updatePassword$1;
enum_maps0151f4a9.updateProfile = updateProfile$2;
enum_maps0151f4a9.useDeviceLanguage = useDeviceLanguage$1;
enum_maps0151f4a9.verifyBeforeUpdateEmail = verifyBeforeUpdateEmail$1;
enum_maps0151f4a9.verifyPasswordResetCode = verifyPasswordResetCode$1;

Object.defineProperty(rn, '__esModule', { value: true });

var reactNative = require$$0;
var app = require$$2;
var enum_maps = enum_maps0151f4a9;
