...
/**
     ...
     * limitations under the License.
     */
class z{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const q="@firebase/app",W="0.8.1",K=new C("@firebase/app"),J="[DEFAULT]",G={[q]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Y=new Map,X=new Map;function Z(e,t){try{e.container.addComponent(t)}catch(n){K.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Q(e){const t=e.name;if(X.has(t))return K.debug(`There were multiple attempts to register component ${t}.`),!1;X.set(t,e);for(const t of Y.values())Z(t,e);return!0}function ee(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){oe("@firebase/app-compat","0.1.36",e)}("lite");
/**
     * @license
...
/**
     ...
     * limitations under the License.
     */
const jt="0.0.1",$t={loggingEnabled:!0},Ft="FIREBASE_INSTALLATIONS_AUTH";function Ut(e,t){const n=function(){const e=Ct.getInstance().localStorage;if(!e)return;const t=e.getItem(vt);if(!(t&&(n=t,Number(n)>Date.now())))return;var n;const r=e.getItem(bt);if(!r)return;try{return JSON.parse(r)}catch(e){return}}();return n?(Vt(n),Promise.resolve()):function(e,t){return function(e){const t=e.getToken();return t.then((e=>{})),t}(e.installations).then((n=>{const r=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.projectId;if(!n)throw wt.create("no project id");return n}(e.app),i=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.apiKey;if(!n)throw wt.create("no api key");return n}(e.app),a=new Request(`https://firebaseremoteconfig.googleapis.com/v1/projects/${r}/namespaces/fireperf:fetch?key=${i}`,{method:"POST",headers:{Authorization:`${Ft} ${n}`},body:JSON.stringify({app_instance_id:t,app_instance_id_token:n,app_id:Rt(e.app),app_version:ht,sdk_version:jt})});return fetch(a).then((e=>{if(e.ok)return e.json();throw wt.create("RC response not ok")}))})).catch((()=>{yt.info(Ht)}))}(e,t).then(Vt).then((e=>function(e){const t=Ct.getInstance().localStorage;if(!e||!t)return;t.setItem(bt,JSON.stringify(e)),t.setItem(vt,String(Date.now()+60*Nt.getInstance().configTimeToLive*60*1e3))}(e)),(()=>{}))}const Ht="Could not fetch config, will use default configs";function Vt(e){if(!e)return e;const t=Nt.getInstance(),n=e.entries||{};return void 0!==n.fpr_enabled?t.loggingEnabled="true"===String(n.fpr_enabled):t.loggingEnabled=$t.loggingEnabled,n.fpr_log_source?t.logSource=Number(n.fpr_log_source):$t.logSource&&(t.logSource=$t.logSource),n.fpr_log_endpoint_url?t.logEndPointUrl=n.fpr_log_endpoint_url:$t.logEndPointUrl&&(t.logEndPointUrl=$t.logEndPointUrl),n.fpr_log_transport_key?t.transportKey=n.fpr_log_transport_key:$t.transportKey&&(t.transportKey=$t.transportKey),void 0!==n.fpr_vc_network_request_sampling_rate?t.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate):void 0!==$t.networkRequestsSamplingRate&&(t.networkRequestsSamplingRate=$t.networkRequestsSamplingRate),void 0!==n.fpr_vc_trace_sampling_rate?t.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate):void 0!==$t.tracesSamplingRate&&(t.tracesSamplingRate=$t.tracesSamplingRate),t.logTraceAfterSampling=xt(t.tracesSamplingRate),t.logNetworkAfterSampling=xt(t.networkRequestsSamplingRate),e}function xt(e){return Math.random()<=e}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var gn;(gn=Ie).INTERNAL.registerComponent(new m("performance-compat",dn,"PUBLIC")),gn.registerVersion("@firebase/performance-compat","0.1.14");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return Ie.registerVersion("firebase","9.12.0","compat-lite"),Ie}));
