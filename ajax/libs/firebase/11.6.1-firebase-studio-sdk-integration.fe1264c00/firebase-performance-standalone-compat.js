...
/**
     ...
     * limitations under the License.
     */
class K{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const J="@firebase/app",G="0.11.5-firebase-studio-sdk-integration.fe1264c00",X=new k("@firebase/app"),Y="@firebase/app-compat",Z="@firebase/analytics-compat",Q="@firebase/analytics",ee="@firebase/app-check-compat",te="@firebase/app-check",ne="@firebase/auth",re="@firebase/auth-compat",ie="@firebase/database",ae="@firebase/data-connect",oe="@firebase/database-compat",se="@firebase/functions",ce="@firebase/functions-compat",le="@firebase/installations",ue="@firebase/installations-compat",de="@firebase/messaging",fe="@firebase/messaging-compat",pe="@firebase/performance",he="@firebase/performance-compat",ge="@firebase/remote-config",me="@firebase/remote-config-compat",ve="@firebase/storage",be="@firebase/storage-compat",ye="@firebase/firestore",_e="@firebase/vertexai",we="@firebase/firestore-compat",Ee="firebase",Se="[DEFAULT]",Ie={[J]:"fire-core",[Y]:"fire-core-compat",[Q]:"fire-analytics",[Z]:"fire-analytics-compat",[te]:"fire-app-check",[ee]:"fire-app-check-compat",[ne]:"fire-auth",[re]:"fire-auth-compat",[ie]:"fire-rtdb",[ae]:"fire-data-connect",[oe]:"fire-rtdb-compat",[se]:"fire-fn",[ce]:"fire-fn-compat",[le]:"fire-iid",[ue]:"fire-iid-compat",[de]:"fire-fcm",[fe]:"fire-fcm-compat",[pe]:"fire-perf",[he]:"fire-perf-compat",[ge]:"fire-rc",[me]:"fire-rc-compat",[ve]:"fire-gcs",[be]:"fire-gcs-compat",[ye]:"fire-fst",[we]:"fire-fst-compat",[_e]:"fire-vertex","fire-js":"fire-js",[Ee]:"fire-js-all"},Te=new Map,Ce=new Map,Ae=new Map;function De(e,t){try{e.container.addComponent(t)}catch(n){X.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function ke(e){const t=e.name;if(Ae.has(t))return X.debug(`There were multiple attempts to register component ${t}.`),!1;Ae.set(t,e);for(const t of Te.values())De(t,e);for(const t of Ce.values())De(t,e);return!0}function Oe(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function Ne(e){return void 0!==e.options}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function tt(e){const t={},n={__esModule:!0,initializeApp:function(r,i={}){const a=Fe(r,i);if(m(t,a.name))return t[a.name];const o=new e(a,n);return t[a.name]=o,o},app:r,registerVersion:je,setLogLevel:xe,onLog:Ue,apps:null,SDK_VERSION:Be,INTERNAL:{registerComponent:function(t){const i=t.name,o=i.replace("-compat","");if(ke(t)&&"PUBLIC"===t.type){const s=(e=r())=>{if("function"!=typeof e[o])throw et.create("invalid-app-argument",{appName:i});return e[o]()};void 0!==t.serviceProps&&a(s,t.serviceProps),n[o]=s,e.prototype[o]=function(...e){return this._getService.bind(this,i).apply(this,t.multipleInstances?e:[])}}return"PUBLIC"===t.type?n[o]:null},removeApp:function(e){delete t[e]},useAsService:function(e,t){if("serverAuth"===t)return null;return t},modularAPIs:Ze}};function r(e){if(!m(t,e=e||Se))throw et.create("no-app",{appName:e});return t[e]}return n.default=n,Object.defineProperty(n,"apps",{get:function(){return Object.keys(t).map((e=>t[e]))}}),r.App=e,n}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){je("@firebase/app-compat","0.2.54-firebase-studio-sdk-integration.fe1264c00",e)}("lite");
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e,n),i=gn(e,n),a=t.getImmediate({optional:!0});if(a){const e=await a.getHeartbeatsHeader();e&&i.append("x-firebase-client",e)}const o={installation:{sdkVersion:on,appId:e.appId}},s={method:"POST",headers:i,body:JSON.stringify(o)},c=await mn((()=>fetch(r,s)));if(c.ok){return fn(await c.json())}throw await pn("Generate Auth Token",c)}async function Bn(e,t=!1){let n;const r=await On(e.appConfig,(r=>{if(!$n(r))throw ln.create("not-registered");const i=r.authToken;if(!t&&function(e){return 2===e.requestStatus&&!function(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+cn}(e)}(i))return r;if(1===i.requestStatus)return n=async function(e,t){let n=await Fn(e.appConfig);for(;1===n.authToken.requestStatus;)await vn(100),n=await Fn(e.appConfig);const r=n.authToken;return 0===r.requestStatus?Bn(e,t):r}(e,t),r;{if(!navigator.onLine)throw ln.create("app-offline");const t=function(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}(r);return n=async function(e,t){try{const n=await Rn(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await Dn(e.appConfig,r),n}catch(n){if(!un(n)||401!==n.customData.serverCode&&404!==n.customData.serverCode){const n=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await Dn(e.appConfig,n)}else await kn(e.appConfig);throw n}}(e,t),t}}));return n?await n:r.authToken}function Fn(e){return On(e,(e=>{if(!$n(e))throw ln.create("not-registered");const t=e.authToken;return 1===(n=t).requestStatus&&n.requestTime+an<Date.now()?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e;var n;
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const xn="installations",Vn=e=>{const t=Oe(e.getProvider("app").getImmediate(),xn).getImmediate();return{getId:()=>async function(e){const t=e,{installationEntry:n,registrationPromise:r}=await Nn(t);return r?r.catch(console.error):Bn(t).catch(console.error),n.fid}(t),getToken:e=>jn(t,e)}};ke(new y(xn,(e=>{const t=e.getProvider("app").getImmediate(),n=function(e){if(!e||!e.options)throw Un("App Configuration");if(!e.name)throw Un("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw Un(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t);return{app:t,appConfig:n,heartbeatServiceProvider:Oe(t,"heartbeat"),_delete:()=>Promise.resolve()}}),"PUBLIC")),ke(new y("installations-internal",Vn,"PRIVATE")),je(nn,rn),je(nn,rn,"esm2017");const Hn="@firebase/performance",zn="0.7.2-firebase-studio-sdk-integration.fe1264c00",Wn=zn,qn="FB-PERF-TRACE-MEASURE",Kn="_wt_",Jn="_fcp",Gn="_fid",Xn="_lcp",Yn="_inp",Zn="_cls",Qn="@firebase/performance/config",er="@firebase/performance/configexpire",tr="Performance",nr=new h("performance",tr,{"trace started":"Trace {$traceName} was started before.","trace stopped":"Trace {$traceName} is not running.","nonpositive trace startTime":"Trace {$traceName} startTime should be positive.","nonpositive trace duration":"Trace {$traceName} duration should be positive.","no window":"Window is not available.","no app id":"App id is not available.","no project id":"Project id is not available.","no api key":"Api key is not available.","invalid cc log":"Attempted to queue invalid cc event","FB not default":"Performance can only start when Firebase app instance is the default one.","RC response not ok":"RC response is not ok","invalid attribute name":"Attribute name {$attributeName} is invalid.","invalid attribute value":"Attribute value {$attributeValue} is invalid.","invalid custom metric name":"Custom metric name {$customMetricName} is invalid","invalid String merger input":"Input for String merger is invalid, contact support team to resolve.","already initialized":"initializePerformance() has already been called with different options. To avoid this error, call initializePerformance() with the same options as when it was originally called, or call getPerformance() to return the already initialized instance."}),rr=new k(tr);
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Cr,Ar=1;function Dr(e){return Ar=2,Cr=Cr||function(e){return function(){const e=cr.getInstance().document;return new Promise((t=>{if(e&&"complete"!==e.readyState){const n=()=>{"complete"===e.readyState&&(e.removeEventListener("readystatechange",n),t())};e.addEventListener("readystatechange",n)}else t()}))}().then((()=>function(e){const t=e.getId();return t.then((e=>{or=e})),t}(e.installations))).then((t=>Er(e,t))).then((()=>kr()),(()=>kr()))}(e),Cr}function kr(){Ar=3}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Or,Nr=3,Mr=[],Lr=!1;function Pr(e){setTimeout((()=>{Nr<=0||(Mr.length>0&&Rr(),Pr(1e4))}),e)}function Rr(){const e=Mr.splice(0,1e3),t=e.map((e=>({source_extension_json_proto3:e.message,event_time_ms:String(e.eventTime)})));(function(e){const t=dr.getInstance().getFlTransportFullUrl(),n=JSON.stringify(e);return navigator.sendBeacon&&navigator.sendBeacon(t,n)?Promise.resolve():fetch(t,{method:"POST",body:n,keepalive:!0}).then()})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:dr.getInstance().logSource,log_event:t}).then((()=>{Nr=3})).catch((()=>{Mr=[...e,...Mr],Nr--,rr.info(`Tries left: ${Nr}.`),Pr(1e4)}))}function Br(e){return(...t)=>{!function(e){if(!e.eventTime||!e.message)throw nr.create("invalid cc log");Mr=[...Mr,e]}({message:e(...t),eventTime:Date.now()})}}function Fr(){for(;Mr.length>0;)Rr()}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var ti;(ti=nt).INTERNAL.registerComponent(new y("performance-compat",ei,"PUBLIC")),ti.registerVersion("@firebase/performance-compat","0.2.15-firebase-studio-sdk-integration.fe1264c00");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return nt.registerVersion("firebase","11.6.1-firebase-studio-sdk-integration.fe1264c00","compat-lite"),nt}));
