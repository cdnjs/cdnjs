            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _assert(actionCodeSettings === null || actionCodeSettings === void 0 ? void 0 : actionCodeSettings.handleCodeInApp, authModular, "argument-error" /* ARGUMENT_ERROR */);
                        if (actionCodeSettings) {
                            _setActionCodeSettingsOnRequest(authModular, request, actionCodeSettings);
                        }
    ...
    function signInWithEmailLink$1(auth, email, emailLink) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                // instance.
                _assert(credential.tenantId === (authModular.tenantId || null), authModular, "tenant-id-mismatch" /* TENANT_ID_MISMATCH */);
