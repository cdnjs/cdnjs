...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function l(t){return t&&t._delegate?t._delegate:t}var d,f,m=function(){function t(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY"}return t.prototype.setInstantiationMode=function(t){return this.instantiationMode=t,this},t.prototype.setMultipleInstances=function(t){return this.multipleInstances=t,this},t.prototype.setServiceProps=function(t){return this.serviceProps=t,this},t}();
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const Cr=new v("@firebase/firestore");function Rr(){return Cr.logLevel}function kr(t,...e){if(Cr.logLevel<=f.DEBUG){const n=e.map(Mr);Cr.debug(`Firestore (8.3.2): ${t}`,...n)}}function Lr(t,...e){if(Cr.logLevel<=f.ERROR){const n=e.map(Mr);Cr.error(`Firestore (8.3.2): ${t}`,...n)}}function Or(t,...e){if(Cr.logLevel<=f.WARN){const n=e.map(Mr);Cr.warn(`Firestore (8.3.2): ${t}`,...n)}}function Mr(t){if("string"==typeof t)return t;try{return e=t,JSON.stringify(e)}catch(e){return t}
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Pr(t="Unexpected state"){const e="FIRESTORE (8.3.2) INTERNAL ASSERTION FAILED: "+t;throw Lr(e),new Error(e)}function Fr(t,e){t||Pr()}function Vr(t,e){return t}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
e._registerComponent(new m("firestore-exp",((t,{options:e})=>{const n=t.getProvider("app-exp").getImmediate(),r=new Jl(n,t.getProvider("auth-internal"));return e&&r._setSettings(e),r}),"PUBLIC")),e.registerVersion("firestore-exp","0.0.900","node");const bf="(default)";class If{constructor(t,e){this.projectId=t,this.database=e||bf}get isDefaultDatabase(){return this.database===bf}isEqual(t){return t instanceof If&&t.projectId===this.projectId&&t.database===this.database}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Tf(t="Unexpected state"){const e="FIRESTORE (8.3.2) INTERNAL ASSERTION FAILED: "+t;throw function(t,...e){if(Ef.logLevel<=f.ERROR){const n=e.map(_f);Ef.error(`Firestore (8.3.2): ${t}`,...n)}}(e),new Error(e)}
/**
     * @license
     * Copyright 2017 Google LLC
     *
