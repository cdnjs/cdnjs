...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function p(e){return e&&e._delegate?e._delegate:e}var h=function(){function e(e,t,n){this.name=e,this.instanceFactory=t,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY"}return e.prototype.setInstantiationMode=function(e){return this.instantiationMode=e,this},e.prototype.setMultipleInstances=function(e){return this.multipleInstances=e,this},e.prototype.setServiceProps=function(e){return this.serviceProps=e,this},e}();
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
O=fetch.bind(self),t._registerComponent(new h(v,(function(e,t){var n=t.instanceIdentifier,r=e.getProvider("app-exp").getImmediate(),i=e.getProvider("auth-internal"),o=e.getProvider("messaging");return new I(r,i,o,n,O)}),"PUBLIC").setMultipleInstances(!0)),t.registerVersion("@firebase/functions-exp","0.0.900");var D,P=function(){function e(e,t){this.app=e,this._delegate=t,this._region=this._delegate.region,this._customDomain=this._delegate.customDomain}return e.prototype.httpsCallable=function(e,t){return function(e,t,n){return T(p(e),t,n)}(this._delegate,e,t)},e.prototype.useFunctionsEmulator=function(e){var t=e.match("[a-zA-Z]+://([a-zA-Z0-9.-]+)(?::([0-9]+))?");if(null==t)throw new u("functions","No origin provided to useFunctionsEmulator()");if(null==t[2])throw new u("functions","Port missing in origin provided to useFunctionsEmulator()");return _(this._delegate,t[1],Number(t[2]))},e.prototype.useEmulator=function(e,t){return _(this._delegate,e,t)},e}(),S=function(e,t){var n=t.instanceIdentifier,r=e.getProvider("app-compat").getImmediate(),i=e.getProvider("functions-exp").getImmediate({identifier:null!=n?n:"us-central1"});return new P(r,i)};
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * limitations under the License.
     */
D={Functions:P},r.default.INTERNAL.registerComponent(new h("functions-compat",S,"PUBLIC").setServiceProps(D).setMultipleInstances(!0)),r.default.registerVersion("@firebase/functions-compat","0.0.900")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-functions-compat.js - be sure to load firebase-app.js first.")}}));
