...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Oe(e){return J.create("missing-app-config-values",{valueName:e})}
/**
     * @license
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var xe="installations-exp",De=function(e){var n=e.getProvider("app-exp").getImmediate();return{app:n,appConfig:function(e){var t,n;if(!e||!e.options)throw Oe("App Configuration");if(!e.name)throw Oe("App Name");try{for(var r=l(["projectId","apiKey","appId"]),i=r.next();!i.done;i=r.next()){var o=i.value;if(!e.options[o])throw Oe(o)}}catch(e){t={error:e}}finally{try{i&&!i.done&&(n=r.return)&&n.call(r)}finally{if(t)throw t.error}}return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(n),platformLoggerProvider:t._getProvider(n,"platform-logger"),_delete:function(){return Promise.resolve()}}},Ae=function(e){var n=e.getProvider("app-exp").getImmediate(),r=t._getProvider(n,xe).getImmediate();return{getId:function(){
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var ht,vt=function(e){var t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("analytics-exp").getImmediate();return new dt(t,n)};ht={Analytics:dt,settings:it,isSupported:at,EventName:pt},r.default.INTERNAL.registerComponent(new P("analytics-compat",vt,"PUBLIC").setServiceProps(ht).setMultipleInstances(!0)),r.default.registerVersion("@firebase/analytics-compat","0.0.900")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")}}));
