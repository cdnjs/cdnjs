(function (global, factory) {
    ...
    */
    ...
    /** An error returned by a Firestore operation. */ class P$1 extends Error {
        /** @hideconstructor */
        constructor(t, e) {
     ...
     */ function x$1(t = "Unexpected state") {
        // Log the failure in addition to throw an exception, just in case the
        // exception is swallowed.
        const e = "FIRESTORE (8.3.2) INTERNAL ASSERTION FAILED: " + t;
        // NOTE: We don't use FirestoreError here because these are internal failures
        // that cannot be handled by the user. (Also it would create a circular
        // dependency between the error and assert modules which doesn't work.)
        throw D$1(e), new Error(e);
    }
    ...
    class q$1 {
         ...
         */
        constructor(t, e) {
            if (this.seconds = t, this.nanoseconds = e, e < 0) throw new P$1(R$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (e >= 1e9) throw new P$1(R$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (t < -62135596800) throw new P$1(R$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
            // This will break in the year 10,000.
                    if (t >= 253402300800) throw new P$1(R$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        }
        /**
         ...
         */    static now() {
            return q$1.fromMillis(Date.now());
        }
        /**
         ...
         *     date.
         */    static fromDate(t) {
            return q$1.fromMillis(t.getTime());
        }
        /**
    ...
    class W$1 {
        ...
        isEqual(t) {
            return 0 === W$1.comparator(this, t);
        }
        child(t) {
            const e = this.segments.slice(this.offset, this.limit());
            return t instanceof W$1 ? t.forEach((t => {
                e.push(t);
     ...
     * within Firestore.
     */ class G$1 extends W$1 {
        construct(t, e, n) {
            return new G$1(t, e, n);
        }
        canonicalString() {
         ...
         */    static fromString(...t) {
            ...
            const e = [];
            for (const n of t) {
                if (n.indexOf("//") >= 0) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
    ...
    const z$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/;

    /** A dot-separated path for navigating sub-objects within a document. */ class H$1 extends W$1 {
        construct(t, e, n) {
            return new H$1(t, e, n);
        }
        /**
        ...
        canonicalString() {
            ...
            H$1.isValidIdentifier(t) || (t = "`" + t + "`"), t))).join(".");
        }
        toString() {
            return this.canonicalString();
        }
         ...
         */    static fromServerFormat(t) {
            ...
            let n = "", s = 0;
            const i = () => {
                if (0 === n.length) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
                e.push(n), n = "";
            };
            let r = !1;
            for (;s < t.length; ) {
                const e = t[s];
                if ("\\" === e) {
                    if (s + 1 === t.length) throw new P$1(R$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                    const e = t[s + 1];
                    if ("\\" !== e && "." !== e && "`" !== e) throw new P$1(R$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                    n += e, s += 2;
                } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
            }
            if (i(), r) throw new P$1(R$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
            return new H$1(e);
        }
        static emptyPath() {
            return new H$1([]);
     ...
     */ class J$1 {
        ...
        isEqual(t) {
            return L$1(this.fields, t.fields, ((t, e) => t.isEqual(e)));
        }
    }
     ...
     */
        ...
        compareTo(t) {
            return F$1(this.binaryString, t.binaryString);
        }
        isEqual(t) {
    ...
    Y$1.EMPTY_BYTE_STRING = new Y$1("");

    const X$1 = new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
    ...
    /** Converts the possible Proto types for Blobs into a ByteString. */ function et(t) {
        return "string" == typeof t ? Y$1.fromBase64String(t) : Y$1.fromUint8Array(t);
    }
     ...
     */ function it(t) {
        const e = Z$1(t.mapValue.fields.__local_write_time__.timestampValue);
     ...
     */ class ut {
        ...
        static fromPath(t) {
            return new ut(G$1.fromString(t));
        }
        static fromName(t) {
            return new ut(G$1.fromString(t).popFirst(5));
        }
        /** Returns true if the document is in the specified collectionId. */    hasCollectionId(t) {
            return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
        }
        isEqual(t) {
            return null !== t && 0 === G$1.comparator(this.path, t.path);
        }
        toString() {
            return this.path.toString();
        }
        static comparator(t, e) {
            return G$1.comparator(t.path, e.path);
        }
    ...
    /** Extracts the backend's type order for the provided value. */ function at(t) {
        return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? nt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : x$1();
    }
        ...
        switch (n) {
          ...
          case 3 /* TimestampValue */ :
            return function(t, e) {
                ...
                const n = Z$1(t.timestampValue), s = Z$1(e.timestampValue);
          ...
          case 2 /* NumberValue */ :
            return function(t, e) {
                ...
                if ("doubleValue" in t && "doubleValue" in e) {
                    ...
                    return n === s ? ot(n) === ot(s) : isNaN(n) && isNaN(s);
                }
                return !1;
            }(t, e);

          case 9 /* ArrayValue */ :
            return L$1(t.arrayValue.values || [], e.arrayValue.values || [], ht);

          case 10 /* ObjectValue */ :
            return function(t, e) {
                const n = t.mapValue.fields || {}, s = e.mapValue.fields || {};
                if (K$1(n) !== K$1(s)) return !1;
                for (const t in n) if (n.hasOwnProperty(t) && (void 0 === s[t] || !ht(n[t], s[t]))) return !1;
                return !0;
            }
    ...
    function lt(t, e) {
        return void 0 !== (t.values || []).find((t => ht(t, e)));
    }
    ...
    function ft(t, e) {
        ...
        switch (n) {
          ...
          case 8 /* GeoPointValue */ :
            return function(t, e) {
                const n = F$1(tt(t.latitude), tt(e.latitude));
                if (0 !== n) return n;
                return F$1(tt(t.longitude), tt(e.longitude));
    ...
    function dt(t, e) {
        ...
        const n = Z$1(t), s = Z$1(e), i = F$1(n.seconds, s.seconds);
    ...
    function _t(t) {
        ...
        ut.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
            let e = "[", n = !0;
            for (const s of t.values || []) n ? n = !1 : e += ",", e += _t(s);
            return e + "]";
        }
        /** Returns a reference value for the provided database and key. */ (t.arrayValue) : "mapValue" in t ? function(t) {
            ...
            let n = "{", s = !0;
            for (const i of e) s ? s = !1 : n += ",", n += `${i}:${_t(t.fields[i])}`;
            return n + "}";
        }(t.mapValue) : x$1();
        var e, n;
    }
    ...
    /** Returns true if `value` is NaN. */ function Et(t) {
     ...
     */ class It {
         ...
         */    field(t) {
            return It.extractNestedValue(this.buildProto(), t);
        }
        /** Returns the full protobuf representation. */    toProto() {
            return this.field(H$1.emptyPath());
        }
        /**
        ...
        isEqual(t) {
            return ht(this.buildProto(), t.buildProto());
        }
        /**
         ...
         */    applyOverlay(t, e) {
            let n = !1;
            const s = It.extractNestedValue(this.partialValue, t), i = Tt(s) ? // If there is already data at the current path, base our
         ...
         */    buildProto() {
            const t = this.applyOverlay(H$1.emptyPath(), this.overlayMap);
        ...
        static extractNestedValue(t, e) {
            if (e.isEmpty()) return t;
            {
                ...
                for (let t = 0; t < e.length - 1; ++t) {
                    ...
                    if (n = n.mapValue.fields[e.get(t)], !Tt(n)) return null;
                }
                return n = (n.mapValue.fields || {})[e.lastSegment()], n || null;
            }
        }
        clone() {
            return new It(this.buildProto());
        }
    }
     ...
     */ class Rt {
         ...
         */    static newInvalidDocument(t) {
            return new Rt(t, 0 /* INVALID */ , U$1.min(), It.empty(), 0 /* SYNCED */);
        }
        /**
     ...
     * property.
     */ function bt(t, e = null, n = [], s = [], i = null, r = null, o = null) {
    ...
    function vt(t) {
        ...
        if (null === e.h) {
            ...
            }(t))).join(","), rt(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
    ...
    function Vt(t) {
        ...
        return `${(e = t).field.canonicalString()} ${e.op} ${wt(e.value)}`;
        /** Returns a debug description for `filter`. */
        var e;
        /** Filter that matches on key fields (i.e. '__name__'). */    })).join(", ")}]`), 
        rt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
    ...
    function St(t, e) {
        ...
        n.op !== s.op || !n.field.isEqual(s.field) || !ht(n.value, s.value)) return !1;
        var n, s;
    ...
    class Ct extends class {} {
         ...
         */    static create(t, e, n) {
            return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new xt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Mt(t, n) : "in" /* IN */ === e ? new Ft(t, n) : "not-in" /* NOT_IN */ === e ? new Lt(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Bt(t, n) : new Ct(t, e, n);
        }
        static l(t, e, n) {
            return "in" /* IN */ === e ? new kt(t, n) : new Ot(t, n);
        }
        matches(t) {
    ...
    function Nt(t) {
        ...
        return t.field.canonicalString() + t.op.toString() + wt(t.value);
    }
    ...
    /** Filter that matches on key fields within an array. */ class kt extends Ct {
        constructor(t, e) {
    ...
    /** Filter that matches on key fields not present within an array. */ class Ot extends Ct {
        constructor(t, e) {
    ...
    /** A Filter that implements the array-contains operator. */ class Mt extends Ct {
        constructor(t, e) {
            super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
        }
        matches(t) {
            const e = t.data.field(this.field);
            return yt(e) && lt(e.arrayValue, this.value);
        }
    }

    /** A Filter that implements the IN operator. */ class Ft extends Ct {
        constructor(t, e) {
            super(t, "in" /* IN */ , e);
        }
        matches(t) {
    ...
    /** A Filter that implements the array-contains-any operator. */ class Bt extends Ct {
        ...
        matches(t) {
            const e = t.data.field(this.field);
            return !(!yt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => lt(this.value.arrayValue, t)));
        }
    }
    ...
    function Wt(t, e) {
        ...
        for (let n = 0; n < t.position.length; n++) {
            if (!ht(t.position[n], e.position[n])) return !1;
        }
        return !0;
    }
     ...
     */ function ee(t) {
        ...
        if (null === e.p) {
            ...
            t.isKeyField() || e.p.push(new Kt(t)), e.p.push(new Kt(H$1.keyField(), "asc" /* ASCENDING */)); else {
                let t = !1;
                ...
                if (!t) {
                    ...
                    e.p.push(new Kt(H$1.keyField(), t));
                }
            }
        }
        return e.p;
     ...
     */ function ne(t) {
        const e = O$1(t);
        if (!e.T) if ("F" /* First */ === e.limitType) e.T = bt(e.path, e.collectionGroup, ee(e), e.filters, e.limit, e.startAt, e.endAt); else {
            ...
            e.T = bt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
        }
        return e.T;
    }
    ...
    function ae(t, e, n) {
        const s = t.field.isKeyField() ? ut.comparator(e.key, n.key) : function(t, e, n) {
            ...
            return null !== s && null !== i ? ft(s, i) : x$1();
        }(t.field, e, n);
        switch (t.dir) {
          case "asc" /* ASCENDING */ :
            return s;
     ...
     */ function we(t, e, n) {
        return t instanceof ge ? function(t, e) {
            ...
            return gt(n) && gt(t.A) ? le(s) : he(t.R, s);
        }(t, e);
    }
     ...
     */ function me(t, e) {
        return t instanceof Ie ? gt(n = e) || function(t) {
    ...
    function pe(t, e) {
        const n = Re(e);
        for (const e of t.elements) n.some((t => ht(t, e))) || n.push(e);
        return {
            arrayValue: {
                values: n
            }
    ...
    function Te(t, e) {
        let n = Re(e);
        for (const e of t.elements) n = n.filter((t => !ht(t, e)));
        return {
            arrayValue: {
                values: n
            }
    ...
    function be(t, e) {
        return t.field.isEqual(e.field) && function(t, e) {
            return t instanceof ye && e instanceof ye || t instanceof Ee && e instanceof Ee ? L$1(t.elements, e.elements, ht) : t instanceof Ie && e instanceof Ie ? ht(t.A, e.A) : t instanceof ge && e instanceof ge;
     ...
     */ function Ce(t, e, n) {
        ...
        }(t, e, n) : t instanceof Me ? function(t, e, n) {
     ...
     */ function Ne(t, e, n) {
        t instanceof $e ? function(t, e, n) {
            ...
            s.setAll(i), e.convertToFoundDocument(Oe(e), s).setHasLocalMutations();
        }
        /**
     ...
     */ (t, e, n) : t instanceof Me ? function(t, e, n) {
            ...
            i.setAll(Fe(t)), i.setAll(s), e.convertToFoundDocument(Oe(e), i).setHasLocalMutations();
        }
        /**
    ...
    function ke(t, e) {
        return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
            return void 0 === t && void 0 === e || !(!t || !e) && L$1(t, e, ((t, e) => be(t, e)));
     ...
     */ function Oe(t) {
        return t.isFoundDocument() ? t.version : U$1.min();
    }
    ...
    function We(t) {
        switch (t) {
          ...
          case R$1.CANCELLED:
          case R$1.UNKNOWN:
          case R$1.DEADLINE_EXCEEDED:
          case R$1.RESOURCE_EXHAUSTED:
          case R$1.INTERNAL:
          case R$1.UNAVAILABLE:
     // Unauthenticated means something went wrong with our token and we need
            // to retry with new credentials which will happen automatically.
                  case R$1.UNAUTHENTICATED:
            return !1;

          case R$1.INVALID_ARGUMENT:
          case R$1.NOT_FOUND:
          case R$1.ALREADY_EXISTS:
          case R$1.PERMISSION_DENIED:
          case R$1.FAILED_PRECONDITION:
     // Aborted might be retried in some scenarios, but that is dependant on
            // the context and should handled individually by the calling code.
            // See https://cloud.google.com/apis/design/errors.
                  case R$1.ABORTED:
          case R$1.OUT_OF_RANGE:
          case R$1.UNIMPLEMENTED:
          case R$1.DATA_LOSS:
            return !0;
    ...
    function Ge(t) {
        ...
        return D$1("GRPC error has no .code"), R$1.UNKNOWN;
        switch (t) {
          case Qe.OK:
            return R$1.OK;

          case Qe.CANCELLED:
            return R$1.CANCELLED;

          case Qe.UNKNOWN:
            return R$1.UNKNOWN;

          case Qe.DEADLINE_EXCEEDED:
            return R$1.DEADLINE_EXCEEDED;

          case Qe.RESOURCE_EXHAUSTED:
            return R$1.RESOURCE_EXHAUSTED;

          case Qe.INTERNAL:
            return R$1.INTERNAL;

          case Qe.UNAVAILABLE:
            return R$1.UNAVAILABLE;

          case Qe.UNAUTHENTICATED:
            return R$1.UNAUTHENTICATED;

          case Qe.INVALID_ARGUMENT:
            return R$1.INVALID_ARGUMENT;

          case Qe.NOT_FOUND:
            return R$1.NOT_FOUND;

          case Qe.ALREADY_EXISTS:
            return R$1.ALREADY_EXISTS;

          case Qe.PERMISSION_DENIED:
            return R$1.PERMISSION_DENIED;

          case Qe.FAILED_PRECONDITION:
            return R$1.FAILED_PRECONDITION;

          case Qe.ABORTED:
            return R$1.ABORTED;

          case Qe.OUT_OF_RANGE:
            return R$1.OUT_OF_RANGE;

          case Qe.UNIMPLEMENTED:
            return R$1.UNIMPLEMENTED;

          case Qe.DATA_LOSS:
            return R$1.DATA_LOSS;
    ...
    class Je {
        ...
        check() {
            if (this.isRed() && this.left.isRed()) throw x$1();
            if (this.right.isRed()) throw x$1();
            const t = this.left.check();
            if (t !== this.right.check()) throw x$1();
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ const Ze = new ze(ut.comparator);

    function tn() {
        return Ze;
    }

    const en = new ze(ut.comparator);

    function nn() {
        return en;
    }

    const sn = new ze(ut.comparator);

    function rn() {
        return sn;
    }

    const on = new Ye(ut.comparator);
     ...
     */ class hn {
        ...
        static createSynthesizedRemoteEventForCurrentChange(t, e) {
            const n = new Map;
            return n.set(t, ln.createSynthesizedTargetChangeForCurrentChange(t, e)), new hn(U$1.min(), n, an(), tn(), cn());
        }
    }
     ...
     */ class ln {
         ...
         */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
            return new ln(Y$1.EMPTY_BYTE_STRING, e, cn(), cn(), cn());
        }
    }
    ...
    /** Tracks the internal state of a Watch target. */ class _n {
        constructor() {
            ...
            this.C = Y$1.EMPTY_BYTE_STRING, this.N = !1, 
            /**
        ...
        /** Whether this target has pending target adds or target removes. */    get O() {
            return 0 !== this.S;
        }
    ...
    class mn {
            ...
            this.forEachTarget(t, (e => {
                ...
                switch (t.state) {
                  ...
                  case 2 /* Removed */ :
                    ...
                    // We need to decrement the number of pending acks needed from watch
                    // for this targetId.
                    n.K(), n.O || this.removeTarget(e);
                    break;

                  case 3 /* Current */ :
                    this.st(e) && (n.j(), n.M(t.resumeToken));
                    break;
         ...
         */    rt(t) {
            ...
            if (s) {
                ...
                if (Dt(t)) if (0 === n) {
                    ...
                    this.tt(e, n, Rt.newNoDocument(n, U$1.min()));
                } else k$1(1 === n); else {
                    this.ct(e) !== n && (
         ...
         */    ut(t) {
            ...
            return this.H = tn(), this.J = gn(), this.Y = new Ye(F$1), s;
        }
        /**
        ...
        ht(t) {
            let e = this.J.get(t);
            return e || (e = new Ye(F$1), this.J = this.J.insert(t, e)), e;
        }
        /**
         ...
         */    st(t) {
            ...
            return e || S$1("WatchChangeAggregator", "Detected inactive target", t), e;
        }
        /**
    ...
    function Pn(t) {
        return k$1(!!t), U$1.fromTimestamp(function(t) {
            const e = Z$1(t);
            return new q$1(e.seconds, e.nanos);
        }(t));
    }
    ...
    function bn(t, e) {
        return function(t) {
            return new G$1([ "projects", t.projectId, "databases", t.database ]);
        }(t).child("documents").child(e).canonicalString();
    }

    function vn(t) {
        const e = G$1.fromString(t);
        return k$1(es(e)), e;
    }
    ...
    function Sn(t, e) {
        const n = vn(e);
        if (n.get(1) !== t.databaseId.projectId) throw new P$1(R$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
        if (n.get(3) !== t.databaseId.database) throw new P$1(R$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
        return new ut(xn(n));
    }
    ...
    function Cn(t) {
        ...
        // in the local target cache.
            return 4 === e.length ? G$1.emptyPath() : xn(e);
    }

    function Nn(t) {
        return new G$1([ "projects", t.databaseId.projectId, "databases", t.databaseId.database ]).canonicalString();
    }

    function xn(t) {
        return k$1(t.length > 4 && "documents" === t.get(4)), t.popFirst(5);
    }
    ...
    function On(t, e, n) {
        const s = Sn(t, e.name), i = Pn(e.updateTime), r = new It({
            mapValue: {
                fields: e.fields
            }
    ...
    function $n(t, e) {
        return "found" in e ? function(t, e) {
            ...
            const n = Sn(t, e.found.name), s = Pn(e.found.updateTime), i = new It({
                mapValue: {
            ...
            const n = Sn(t, e.missing), s = Pn(e.readTime);
    ...
    function Mn(t, e) {
        ...
        if ("targetChange" in e) {
            ...
            const s = function(t) {
                ...
                return t.I ? (k$1(void 0 === e || "string" == typeof e), Y$1.fromBase64String(e || "")) : (k$1(void 0 === e || e instanceof Uint8Array), 
                Y$1.fromUint8Array(e || new Uint8Array));
            }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
                const e = void 0 === t.code ? R$1.UNKNOWN : Ge(t.code);
                return new P$1(e, t.message || "");
            }
            /**
     ...
     */ (o);
            ...
            const i = Sn(t, s.document.name), r = Pn(s.document.updateTime), o = new It({
                mapValue: {
            ...
            s.document;
            const i = Sn(t, s.document), r = s.readTime ? Pn(s.readTime) : U$1.min(), o = Rt.newNoDocument(i, r), c = s.removedTargetIds || [];
            n = new fn([], c, o.key, o);
    ...
    function Ln(t, e) {
        const n = e.currentDocument ? function(t) {
            return void 0 !== t.updateTime ? Ve.updateTime(Pn(t.updateTime)) : void 0 !== t.exists ? Ve.exists(t.exists) : Ve.none();
        }(e.currentDocument) : Ve.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
            let n = null;
            if ("setToServerValue" in e) k$1("REQUEST_TIME" === e.setToServerValue), n = new ge; else if ("appendMissingElements" in e) {
                const t = e.appendMissingElements.values || [];
                n = new ye(t);
            } else if ("removeAllFromArray" in e) {
                const t = e.removeAllFromArray.values || [];
                n = new Ee(t);
            } else "increment" in e ? n = new Ie(t, e.increment) : x$1();
            const s = H$1.fromServerFormat(e.fieldPath);
            return new Pe(s, n);
        }(t, e))) : [];
        if (e.update) {
            e.update.name;
            ...
            if (e.updateMask) {
                const t = function(t) {
                    ...
                    return new J$1(e.map((t => H$1.fromServerFormat(t))));
                }(e.updateMask);
                return new Me(i, r, t, n, s);
            }
    ...
    function Bn(t, e) {
        return t && t.length > 0 ? (k$1(void 0 !== e), t.map((t => function(t, e) {
            // NOTE: Deletes don't have an updateTime.
            let n = t.updateTime ? Pn(t.updateTime) : Pn(e);
            return n.isEqual(U$1.min()) && (
            // The Firestore Emulator currently returns an update time of 0 for
            // deletes of non-existing documents (rather than null). This breaks the
            // test "get deleted doc while offline with source=cache" as NoDocuments
            // with version 0 are filtered by IndexedDb's RemoteDocumentCache.
            // TODO(#2149): Remove this when Emulator is fixed
            n = Pn(e)), new ve(n, t.transformResults || []);
        }(t, e)))) : [];
    }
    ...
    function Kn(t) {
        ...
        n.limit && (c = function(t) {
            let e;
            return e = "object" == typeof t ? t.value : t, rt(e) ? null : e;
        }(n.limit));
        let u = null;
    ...
    function jn(t) {
        return t ? void 0 !== t.unaryFilter ? [ Zn(t) ] : void 0 !== t.fieldFilter ? [ Xn(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => jn(t))).reduce(((t, e) => t.concat(e))) : x$1() : [];
    }
    ...
    function Yn(t) {
        return H$1.fromServerFormat(t.fieldPath);
    }
     ...
     */ function rs(t) {
        ...
        const e = t.length;
        if (k$1(e >= 2), 2 === e) return k$1("" === t.charAt(0) && "" === t.charAt(1)), G$1.emptyPath();
     ...
     */ class bs {
        ...
        next(t, e) {
            return this.callbackAttached && x$1(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new bs(((n, s) => {
                this.nextCallback = e => {
        ...
        wrapSuccess(t, e) {
            return t ? this.wrapUserFunction((() => t(e))) : bs.resolve(e);
        }
        wrapFailure(t, e) {
            return t ? this.wrapUserFunction((() => t(e))) : bs.reject(e);
        }
        static resolve(t) {
            return new bs(((e, n) => {
                e(t);
    ...
    class vs {
        constructor(t, e) {
            ...
            this.ft = new Ps, this.transaction.oncomplete = () => {
                ...
                const n = Os(e.target.error);
                this.ft.reject(new Ds(t, n));
            };
        }
        static open(t, e, n, s) {
            try {
                return new vs(e, t.transaction(s, n));
            } catch (t) {
                throw new Ds(e, t);
            }
        }
        ...
        abort(t) {
            t && this.ft.reject(t), this.aborted || (S$1("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
     ...
     */ class Vs {
        ...
        constructor(t, e, n) {
            ...
            // log on 12.2.
            12.2 === Vs._t(getUA()) && D$1("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
        }
        /** Deletes the specified database. */    static delete(t) {
            return S$1("SimpleDb", "Removing database:", t), xs(window.indexedDB.deleteDatabase(t)).toPromise();
        }
        /** Returns true if IndexedDB is available in the current environment. */    static gt() {
            ...
            // Check the UA string to find out the browser.
                    const t = getUA(), e = Vs._t(t), n = 0 < e && e < 10, s = Vs.Et(t), i = 0 < s && s < 4.5;
            // IE 10
         ...
         */    async At(t) {
            return this.db || (S$1("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
                ...
                s.onsuccess = t => {
                    ...
                    "VersionError" === s.name ? n(new P$1(R$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ds(t, s));
                }, s.onupgradeneeded = t => {
                    S$1("SimpleDb", 'Database "' + this.name + '" requires upgrade from version:', t.oldVersion);
                    const e = t.target.result;
                    this.wt.Rt(e, s.transaction, t.oldVersion, this.version).next((() => {
                        S$1("SimpleDb", "Database upgrade to version " + this.version + " complete");
                    }));
                };
        ...
        async runTransaction(t, e, n, s) {
            ...
            for (;;) {
                ...
                try {
                    ...
                    const e = vs.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
                    // Abort the transaction if there was an error.
                    e.abort(t), bs.reject(t)))).toPromise();
                    ...
                    if (S$1("SimpleDb", "Transaction failed with error:", t.message, "Retrying:", e), 
     ...
     */ class Ss {
         ...
         */    delete() {
            return xs(this.vt.delete());
        }
    }

    /** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ds extends P$1 {
        constructor(t, e) {
            super(R$1.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
        }
    }
     ...
     */ class Ns {
        ...
        put(t, e) {
            let n;
            return void 0 !== e ? (S$1("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (S$1("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
         ...
         */    add(t) {
            S$1("SimpleDb", "ADD", this.store.name, t, t);
         ...
         */    get(t) {
            ...
            void 0 === e && (e = null), S$1("SimpleDb", "GET", this.store.name, t, e), e)));
        }
        delete(t) {
            S$1("SimpleDb", "DELETE", this.store.name, t);
         ...
         */    count() {
            S$1("SimpleDb", "COUNT", this.store.name);
        ...
        kt(t, e) {
            S$1("SimpleDb", "DELETE ALL", this.store.name);
        ...
        xt(t, e) {
            ...
            return new bs(((s, i) => {
                t.onerror = t => {
                    ...
                    if (o instanceof bs) {
                        const t = o.catch((t => (r.done(), bs.reject(t))));
                        n.push(t);
                    }
        ...
        cursor(t) {
            ...
            if (t.reverse && (e = "prev"), t.index) {
                ...
                return t.Ot ? n.openKeyCursor(t.range, e) : n.openCursor(t.range, e);
            }
    ...
    function Os(t) {
        ...
        if (e >= 12.2 && e < 13) {
            ...
            if (t.message.indexOf(e) >= 0) {
                ...
                const t = new P$1("internal", `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${e}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);
                return ks || (ks = !0, 
     ...
     */ class $s extends Rs {
        constructor(t, e) {
            super(), this.Ft = t, this.currentSequenceNumber = e;
        }
    }
     ...
     */ class Fs {
         ...
         */    applyToLocalDocumentSet(t) {
            ...
            this.mutations.forEach((e => {
                ...
                // and we should remove this cast.
                            this.applyToLocalView(s), n.isValidDocument() || s.convertToNoDocument(U$1.min());
            }));
        }
        keys() {
        ...
        isEqual(t) {
            return this.batchId === t.batchId && L$1(this.mutations, t.mutations, ((t, e) => ke(t, e))) && L$1(this.baseMutations, t.baseMutations, ((t, e) => ke(t, e)));
        }
    }
    ...
    /** The result of applying a mutation batch to the backend. */ class Ls {
         ...
         */    static from(t, e, n) {
            k$1(t.mutations.length === n.length);
            let s = rn();
            const i = t.mutations;
    ...
    /** Decodes a remote document from storage locally to a Document. */ function Us(t, e) {
        ...
        if (e.noDocument) {
            const t = ut.fromSegments(e.noDocument.path), n = Gs(e.noDocument.readTime), s = Rt.newNoDocument(t, n);
            return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
        }
        if (e.unknownDocument) {
            const t = ut.fromSegments(e.unknownDocument.path), n = Gs(e.unknownDocument.version);
    ...
    function js(t) {
        const e = new q$1(t[0], t[1]);
        return U$1.fromTimestamp(e);
    }
    ...
    function Gs(t) {
        const e = new q$1(t.seconds, t.nanoseconds);
        return U$1.fromTimestamp(e);
    }
    ...
    function zs(t, e) {
        ...
        const s = e.mutations.map((e => Ln(t.Lt, e))), i = q$1.fromMillis(e.localWriteTimeMs);
        return new Fs(e.batchId, i, n, s);
    }

    /** Decodes a DbTarget into TargetData */ function Hs(t) {
        const e = Gs(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? Gs(t.lastLimboFreeSnapshotVersion) : U$1.min();
        let s;
        var i;
        return void 0 !== t.query.documents ? (k$1(1 === (i = t.query).documents.length), 
        s = ne(Ht(Cn(i.documents[0])))) : s = function(t) {
            return ne(Kn(t));
        }(t.query), new Bs(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Y$1.fromBase64String(t.resumeToken));
    }
    ...
    /** Encodes TargetData into a DbTarget for storage locally. */ function Js(t, e) {
        ...
        // lastListenSequenceNumber is always 0 until we do real GC.
            return new _s(e.targetId, vt(e.target), n, r, e.sequenceNumber, s, i);
    }
     ...
     */ function Zs(t) {
        return Ms(t, Es.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the namedQueries object store.
     */ function ti(t) {
        return Ms(t, Ts.store);
    }
     ...
     */ class ei {
        ...
        addToCollectionParentIndex(t, e) {
            return this.Bt.add(e), bs.resolve();
        }
        getCollectionParents(t, e) {
            return bs.resolve(this.Bt.getEntries(e));
        }
    }
     ...
     */ class ni {
        ...
        add(t) {
            const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new Ye(G$1.comparator), i = !s.has(n);
        ...
        getEntries(t) {
            return (this.index[t] || new Ye(G$1.comparator)).toArray();
        }
    }
     ...
     */ class si {
        ...
        getCollectionParents(t, e) {
            const n = [], s = IDBKeyRange.bound([ e, "" ], [ B(e), "" ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
    ...
    class ai {
        ...
        addMutationBatch(t, e, n, s) {
            ...
            return r.add({}).next((o => {
                ...
                let h = new Ye(((t, e) => F$1(t.canonicalString(), e.canonicalString())));
                for (const t of s) {
        ...
        lookupMutationBatch(t, e) {
            return li(t).get(e).next((t => t ? (k$1(t.userId === this.userId), zs(this.R, t)) : null));
        }
        /**
        ...
        // PORTING NOTE: Multi-tab only.
        jt(t, e) {
            return this.Kt[e] ? bs.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((t => {
                if (t) {
                    const n = t.keys();
        ...
        getNextMutationBatchAfterBatchId(t, e) {
            ...
            return li(t).$t({
                ...
                e.userId === this.userId && (k$1(e.batchId >= n), i = zs(this.R, e)), s.done();
            })).next((() => i));
        }
        ...
        getAllMutationBatchesAffectingDocumentKey(t, e) {
            ...
            return fi(t).$t({
                ...
                return li(t).get(u).next((t => {
                    if (!t) throw x$1();
                    k$1(t.userId === this.userId), i.push(zs(this.R, t));
                }));
                r.done();
            })).next((() => i));
        }
        ...
        Wt(t, e) {
            ...
            return e.forEach((e => {
                s.push(li(t).get(e).next((t => {
                    if (null === t) throw x$1();
                    k$1(t.userId === this.userId), n.push(zs(this.R, t));
                })));
            })), bs.waitFor(s).next((() => n));
        }
        removeMutationBatch(t, e) {
            return ci(t.Ft, this.userId, e).next((n => (t.addOnCommittedListener((() => {
                this.Gt(e.batchId);
            })), bs.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
        }
        /**
     ...
     */
    function li(t) {
        return Ms(t, as.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the mutationQueues object store.
     */ function fi(t) {
        return Ms(t, hs.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the mutationQueues object store.
     */ function di(t) {
        return Ms(t, us.store);
    }
     ...
     */ class _i {
        ...
        getLastRemoteSnapshotVersion(t) {
            return this.Xt(t).next((t => U$1.fromTimestamp(new q$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
        }
        ...
        removeTargetData(t, e) {
            return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => mi(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (k$1(e.targetCount > 0), 
        ...
        Xt(t) {
            return gi(t).get(gs.key).next((t => (k$1(null !== t), t)));
        }
        Zt(t, e) {
        ...
        getTargetData(t, e) {
            ...
            const n = vt(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
            let i = null;
            return mi(t).$t({
                range: s,
        ...
        removeMatchingKeys(t, e, n) {
            ...
            // IndexedDb.
            const s = yi(t);
            return bs.forEach(e, (e => {
                const i = ns(e.path);
                return bs.waitFor([ s.delete([ n, i ]), this.referenceDelegate.removeReference(t, n, e) ]);
            }));
        }
        ...
        getMatchingKeysForTargetId(t, e) {
            ...
            return s.$t({
                ...
                const s = rs(t[1]), r = new ut(s);
                i = i.add(r);
            })).next((() => i));
        }
        containsKey(t, e) {
            const n = ns(e.path), s = IDBKeyRange.bound([ n ], [ B(n) ], 
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            let i = 0;
            return yi(t).$t({
     ...
     */ function mi(t) {
        return Ms(t, _s.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the target globals object store.
     */ function gi(t) {
        return Ms(t, gs.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the document target object store.
     */ function yi(t) {
        return Ms(t, ms.store);
    }
     ...
     */ async function pi(t) {
        if (t.code !== R$1.FAILED_PRECONDITION || t.message !== As) throw t;
        S$1("LocalStore", "Unexpectedly lost primary lease");
    }
     ...
     */ class Ii {
        ...
        ue(t) {
            ...
            S$1("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ce = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
                this.ce = null, this.oe = !0;
                try {
                    await t.collectGarbage(this.garbageCollector);
                } catch (t) {
                    Cs(t) ? S$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await pi(t);
                }
                await this.ue(t);
            }));
        }
    ...
    /** Implements the steps for LRU garbage collection. */ class Ai {
        ...
        nthSequenceNumber(t, e) {
            if (0 === e) return bs.resolve(A$1.o);
            const n = new Ti(e);
        ...
        collect(t, e) {
            return -1 === this.params.cacheSizeCollectionThreshold ? (S$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
            bs.resolve(ri)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (S$1("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
            ri) : this.fe(t, e)));
        }
        getCacheSize(t) {
        ...
        fe(t, e) {
            ...
            e > this.params.maximumSequenceNumbersToCollect ? (S$1("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${e}`), 
            s = this.params.maximumSequenceNumbersToCollect) : s = e, r = Date.now(), this.nthSequenceNumber(t, s)))).next((s => (n = s, 
            c = Date.now(), this.removeTargets(t, n, e)))).next((e => (i = e, u = Date.now(), 
            this.removeOrphanedDocuments(t, n)))).next((t => {
                if (a = Date.now(), v$1() <= LogLevel.DEBUG) {
                    S$1("LruGarbageCollector", `LRU Garbage Collection\n\tCounted targets in ${r - h}ms\n\tDetermined least recently used ${s} in ` + (c - r) + "ms\n" + `\tRemoved ${i} targets in ` + (u - c) + "ms\n" + `\tRemoved ${t} documents in ` + (a - u) + "ms\n" + `Total Duration: ${a - h}ms`);
                }
                return bs.resolve({
                    didRun: !0,
    ...
    class Ri {
         ...
         */    _e(t, e) {
            return function(t, e) {
                let n = !1;
                return di(t).Mt((s => hi(t, s, e).next((t => (t && (n = !0), bs.resolve(!t)))))).next((() => n));
            }(t, e);
        }
        removeOrphanedDocuments(t, e) {
            ...
            })).next((() => bs.waitFor(s))).next((() => n.apply(t))).next((() => i));
        }
        removeTarget(t, e) {
     ...
     */ class vi {
        constructor() {
            ...
            this.changes = new bi((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
        }
        getReadTime(t) {
            const e = this.changes.get(t);
            return e ? e.readTime : U$1.min();
        }
        /**
         ...
         */    getEntry(t, e) {
            ...
            return void 0 !== n ? bs.resolve(n.document) : this.getFromCache(t, e);
        }
        /**
     ...
     */ class Vi {
         ...
         */    Ee(t, e) {
            let n = tn(), s = new ze(ut.comparator);
            return this.pe(t, e, ((t, e) => {
                const i = this.ge(t, e);
        ...
        pe(t, e, n) {
            if (e.isEmpty()) return bs.resolve();
            const s = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator();
            let r = i.getNext();
            return Ci(t).$t({
                range: s
            }, ((t, e, s) => {
                const o = ut.fromSegments(t);
                // Go through keys not found in cache.
                            for (;r && ut.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
                r && r.isEqual(o) && (
                // Key found in cache.
        ...
        getMetadata(t) {
            return Di(t).get(ws.key).next((t => (k$1(!!t), t)));
        }
        me(t, e) {
         ...
         */    ge(t, e) {
            if (e) {
                ...
                // `getNewDocumentChanges()`
                            if (!(t.isNoDocument() && t.version.isEqual(U$1.min()))) return t;
            }
    ...
    class Si extends vi {
        ...
        constructor(t, e) {
            ...
            this.Ae = new bi((t => t.toString()), ((t, e) => t.isEqual(e)));
        }
        applyChanges(t) {
            const e = [];
            let n = 0, s = new Ye(((t, e) => F$1(t.canonicalString(), e.canonicalString())));
            return this.changes.forEach(((i, r) => {
                ...
                if (r.document.isValidDocument()) {
                    ...
                    const n = Ks(this.Ie.R, Rt.newNoDocument(i, U$1.min()), this.getReadTime(i));
                    e.push(this.Ie.addEntry(t, i, n));
                } else e.push(this.Ie.removeEntry(t, i));
            })), s.forEach((n => {
                e.push(this.Ie.Ut.addToCollectionParentIndex(t, n));
            })), e.push(this.Ie.updateMetadata(t, n)), bs.waitFor(e);
        }
        getFromCache(t, e) {
    ...
    function Di(t) {
        return Ms(t, ws.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
     */ function Ci(t) {
        return Ms(t, ds.store);
    }
     ...
     */
            function(t) {
                ...
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, U$1.min().toTimestamp(), 
                /*targetCount=*/ 0);
     ...
     */ (t);
        ...
        Re(t) {
            ...
            return e.Nt().next((e => bs.forEach(e, (e => {
                const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
                return n.Nt(as.userMutationsIndex, s).next((n => bs.forEach(n, (n => {
                    k$1(n.userId === e.userId);
                    const s = zs(this.R, n);
         ...
         */    be(t) {
            ...
            return t.store(gs.store).get(gs.key).next((t => {
                const s = [];
                return n.$t(((n, i) => {
                    const r = new G$1(n), o = function(t) {
                        return [ 0, ns(t) ];
                    }(r);
                    s.push(e.get(o).next((n => n ? bs.resolve() : (n => e.put(new ms(0, ns(n), t.highestListenSequenceNumber)))(r))));
                })).next((() => bs.waitFor(s)));
            }));
        }
        ve(t, e) {
    ...
    const Oi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
    ...
    class $i {
        ...
        a) {
            ...
            this.Me = Number.NEGATIVE_INFINITY, 
            /** A listener to notify on primary state changes. */
            this.Fe = t => Promise.resolve(), !$i.gt()) throw new P$1(R$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
     ...
     */
            ...
            !1 === a && D$1("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
        }
        /**
         ...
         */    start() {
            ...
            return this.je().then((() => {
                ...
                throw new P$1(R$1.FAILED_PRECONDITION, Oi);
         ...
         * primary lease.
         */    je() {
            return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Fi(t).put(new ps(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
                if (this.isPrimary) return this.Je(t).next((t => {
                    t || (this.isPrimary = !1, this.Se.enqueueRetryable((() => this.Fe(!1))));
                }));
            })).next((() => this.Ye(t))).next((e => this.isPrimary && !e ? this.Xe(t).next((() => !1)) : !!e && this.Ze(t).next((() => !0)))))).catch((t => {
                if (Cs(t)) 
                // Proceed with the existing state. Any subsequent access to
                // IndexedDB will verify the lease.
                return S$1("IndexedDbPersistence", "Failed to extend owner lease: ", t), this.isPrimary;
                if (!this.allowTabSynchronization) throw t;
                return S$1("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", t), 
                /* isPrimary= */ !1;
            })).then((t => {
                this.isPrimary !== t && this.Se.enqueueRetryable((() => this.Fe(t))), this.isPrimary = t;
            }));
        }
        Je(t) {
            return Mi(t).get(cs.key).next((t => bs.resolve(this.tn(t))));
        }
        en(t) {
         ...
         */    async nn() {
            if (this.isPrimary && !this.sn(this.Me, 18e5)) {
                ...
                const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t => {
                    const e = Ms(t, ps.store);
                    return e.Nt().next((t => {
                        const n = this.rn(t, 18e5), s = t.filter((t => -1 === n.indexOf(t)));
                        // Delete metadata for clients that are no longer considered active.
                        return bs.forEach(s, (t => e.delete(t.clientId))).next((() => s));
                    }));
                })).catch((() => []));
         ...
         */    Ye(t) {
            if (this.Ce) return bs.resolve(!0);
            return Mi(t).get(cs.key).next((e => {
            ...
            })).next((t => (this.isPrimary !== t && S$1("IndexedDbPersistence", `Client ${t ? "is" : "is not"} eligible for a primary lease.`), 
            t)));
        }
        async shutdown() {
        ...
        runTransaction(t, e, n) {
            S$1("IndexedDbPersistence", "Starting transaction:", t);
            const s = "readonly" === e ? "readonly" : "readwrite";
            let i;
            // Do all transactions as readwrite against all object stores, since we
            // are the only reader/writer.
                    return this.Be.runTransaction(t, s, Is, (s => (i = new $s(s, this.Ne ? this.Ne.next() : A$1.o), 
            "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
                if (!e) throw D$1(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
                this.Se.enqueueRetryable((() => this.Fe(!1))), new P$1(R$1.FAILED_PRECONDITION, As);
                return n(i);
        ...
        // be turned off.
        dn(t) {
            return Mi(t).get(cs.key).next((t => {
                if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.cn(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new P$1(R$1.FAILED_PRECONDITION, Oi);
            }));
        }
        /**
        ...
        /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
            const e = Mi(t);
            return e.get(cs.key).next((t => this.tn(t) ? (S$1("IndexedDbPersistence", "Releasing primary lease."), 
            e.delete(cs.key)) : bs.resolve()));
        }
        /** Verifies that `updateTimeMs` is within `maxAgeMs`. */    sn(t, e) {
            const n = Date.now();
            return !(t < n - e) && (!(t > n) || (D$1(`Detected an update time that is in the future: ${t} > ${n}`), 
            !1));
        }
        We() {
            null !== this.document && "function" == typeof this.document.addEventListener && (this.Oe = () => {
                this.Se.enqueueAndForget((() => (this.inForeground = "visible" === this.document.visibilityState, 
                this.je())));
            }, this.document.addEventListener("visibilitychange", this.Oe), this.inForeground = "visible" === this.document.visibilityState);
        }
        an() {
         ...
         */    cn(t) {
            ...
            try {
                ...
                return S$1("IndexedDbPersistence", `Client '${t}' ${n ? "is" : "is not"} zombied in LocalStorage`), 
                n;
            } catch (t) {
     ...
     */ function Mi(t) {
        return Ms(t, cs.store);
    }

    /**
     * Helper to get a typed SimpleDbStore for the client metadata object store.
     */ function Fi(t) {
        return Ms(t, ps.store);
    }
     ...
     */
        ...
        Tn(t, e) {
            ...
            return this.mn(t, new ut(e)).next((t => {
                let e = nn();
        ...
        In(t, e, n) {
            ...
            let i = nn();
            return this.Ut.getCollectionParents(t, s).next((r => bs.forEach(r, (r => {
                const o = function(t, e) {
                    return new Gt(e, 
     ...
     */ (e, r.child(s));
        ...
        Rn(t, e, n) {
            let s = cn();
            for (const t of e) for (const e of t.mutations) e instanceof Me && null === n.get(e.key) && (s = s.add(e.key));
            let i = n;
     ...
     */ class Ki {
        ...
        /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
            ...
            }(e) || n.isEqual(U$1.min()) ? this.Dn(t, e) : this.Sn.pn(t, s).next((i => {
                const r = this.Cn(e, i);
                return (Jt(e) || Yt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (v$1() <= LogLevel.DEBUG && S$1("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), oe(e)), 
        ...
        Dn(t, e) {
            return v$1() <= LogLevel.DEBUG && S$1("QueryEngine", "Using full collection scan to execute query:", oe(e)), 
            this.Sn.getDocumentsMatchingQuery(t, e, U$1.min());
        }
    }
    ...
    class Qi {
        ...
        t, e, n, s) {
            ...
            this.On = new bi((t => vt(t)), St), 
            /**
             * The read time of the last entry processed by `getNewDocumentChanges()`.
             *
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
            this.$n = U$1.min(), this._n = t.getMutationQueue(n), this.Mn = t.getRemoteDocumentCache(), 
            this.qe = t.getTargetCache(), this.Fn = new qi(this.Mn, this._n, this.persistence.getIndexManager()), 
            this.Ke = t.getBundleCache(), this.xn.Vn(this.Fn);
        }
        collectGarbage(t) {
    ...
    async function Wi(t, e) {
        ...
        const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
            ...
            // MutationQueue.
            i = new qi(n.Mn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
                const n = [], s = [];
        ...
        return n._n = s, n.Fn = i, n.xn.Vn(n.Fn), r;
    }
    ...
    function Gi(t, e) {
        ...
        return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (t => {
            const s = e.batch.keys(), i = n.Mn.newChangeBuffer({
                trackRemovals: !0
            });
            return function(t, e, n, s) {
                ...
                return r.forEach((t => {
                    o = o.next((() => s.getEntry(e, t))).next((e => {
                        ...
                        k$1(null !== r), e.version.compareTo(r) < 0 && (i.applyToRemoteDocument(e, n), e.isValidDocument() && 
            ...
            // PORTING NOTE: Multi-Tab only.
            (n, t, e, i).next((() => i.apply(t))).next((() => n._n.performConsistencyCheck(t))).next((() => n.Fn.pn(t, s)));
        }));
    }
     ...
     * queue.
     */ function Hi(t, e) {
        const n = O$1(t), s = e.snapshotVersion;
        let i = n.kn;
        return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (t => {
            const r = n.Mn.newChangeBuffer({
                trackRemovals: !0
            });
     ...
     */
                    function(t, e, n) {
                        ...
                        if (k$1(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize()) return !0;
     ...
     */ (c, a, e) && o.push(n.qe.updateTargetData(t, a));
            ...
            return bs.waitFor(o).next((() => r.apply(t))).next((() => n.Fn.En(t, c))).next((() => c));
        })).then((t => (n.kn = i, t)));
    }
    ...
    i) {
        ...
        return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
            ...
            return n.forEach(((n, o) => {
                ...
                // cache.
                o.isNoDocument() && o.version.isEqual(U$1.min()) ? (
                ...
                r = r.insert(n, o)) : S$1("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", c.version, " Watch version:", o.version);
            })), r;
        }));
    }
    ...
    function Xi(t, e) {
        ...
        return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
            ...
            s = i, bs.resolve(s)) : n.qe.allocateTargetId(t).next((i => (s = new Bs(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
    ...
    async function Zi(t, e, n) {
        const s = O$1(t), i = s.kn.get(e), r = n ? "readwrite" : "readwrite-primary";
        try {
            ...
            S$1("LocalStore", `Failed to update sequence numbers for target ${e}: ${t}`);
        }
     ...
     */ function tr(t, e, n) {
        ...
        return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
            const s = O$1(t), i = s.On.get(n);
            return void 0 !== i ? bs.resolve(s.kn.get(i)) : s.qe.getTargetData(e, n);
        }(s, t, ne(e)).next((e => {
            if (e) return i = e.lastLimboFreeSnapshotVersion, s.qe.getMatchingKeysForTargetId(t, e.targetId).next((t => {
                r = t;
            }));
        })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : U$1.min(), n ? r : cn()))).next((t => ({
            documents: t,
            Bn: r
        })))));
    }
    ...
    // PORTING NOTE: Multi-Tab only.
    function er(t, e) {
        const n = O$1(t), s = O$1(n.qe), i = n.kn.get(e);
     ...
     */
        // PORTING NOTE: This is only used for multi-tab synchronization.
        (e.Mn, t, e.$n))).then((({wn: t, readTime: n}) => (e.$n = n, t)));
    }
    ...
    async function ir(t, e, n, s) {
        ...
        const u = i.Mn.newChangeBuffer({
            ...
            return ne(Ht(G$1.fromString(`__bundle__/docs/${t}`)));
        }(s));
        // Allocates a target to hold all document keys from the bundle, such that
        // they will not get garbage collected right away.
            return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => Ji(t, u, o, U$1.min(), c).next((e => (u.apply(t), 
        e))).next((e => i.qe.removeMatchingKeysForTargetId(t, a.targetId).next((() => i.qe.addMatchingKeys(t, r, a.targetId))).next((() => i.Fn.En(t, e))).next((() => e))))));
    }
    ...
    async function rr(t, e, n = cn()) {
        ...
        const s = await Xi(t, ne(Ys(e.bundledQuery))), i = O$1(t);
        return i.persistence.runTransaction("Save named query", "readwrite", (t => {
            ...
            // Update existing target data because the query from the bundle is newer.
                    const o = s.withResumeToken(Y$1.EMPTY_BYTE_STRING, r);
     ...
     */ class or {
        ...
        getBundleMetadata(t, e) {
            return bs.resolve(this.Qn.get(e));
        }
        saveBundleMetadata(t, e) {
        ...
        getNamedQuery(t, e) {
            return bs.resolve(this.jn.get(e));
        }
        saveNamedQuery(t, e) {
     ...
     */ class cr {
         ...
         * removed.
         */    Zn(t) {
            const e = new ut(new G$1([])), n = new ur(e, t), s = new ur(e, t + 1), i = [];
        ...
        es(t) {
            const e = new ut(new G$1([])), n = new ur(e, t), s = new ur(e, t + 1);
            let i = cn();
            return this.zn.forEachInRange([ n, s ], (t => {
                i = i.add(t.key);
            })), i;
    ...
    class ur {
        ...
        /** Compare by key then by ID */    static Gn(t, e) {
            return ut.comparator(t.key, e.key) || F$1(t.ns, e.ns);
        }
        /** Compare by ID then by key */    static Hn(t, e) {
            return F$1(t.ns, e.ns) || ut.comparator(t.key, e.key);
        }
    }
     ...
     */ class ar {
        ...
        checkEmpty(t) {
            return bs.resolve(0 === this._n.length);
        }
        addMutationBatch(t, e, n, s) {
            const i = this.ss;
        ...
        lookupMutationBatch(t, e) {
            return bs.resolve(this.os(e));
        }
        getNextMutationBatchAfterBatchId(t, e) {
            const n = e + 1, s = this.cs(n), i = s < 0 ? 0 : s;
            // The requested batchId may still be out of range so normalize it to the
            // start of the queue.
                    return bs.resolve(this._n.length > i ? this._n[i] : null);
        }
        getHighestUnacknowledgedBatchId() {
            return bs.resolve(0 === this._n.length ? -1 : this.ss - 1);
        }
        getAllMutationBatches(t) {
            return bs.resolve(this._n.slice());
        }
        getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        removeMutationBatch(t, e) {
            k$1(0 === this.hs(e.batchId, "removed")), this._n.shift();
            let n = this.rs;
        ...
        performConsistencyCheck(t) {
            return this._n.length, bs.resolve();
        }
        /**
    ...
    class hr {
        ...
        constructor(t, e) {
            ...
            this.docs = new ze(ut.comparator), 
        ...
        getEntry(t, e) {
            ...
            return bs.resolve(n ? n.document.clone() : Rt.newInvalidDocument(e));
        }
        getEntries(t, e) {
            let n = tn();
            return e.forEach((t => {
        ...
        getDocumentsMatchingQuery(t, e, n) {
            ...
            // the documents we need to match the query against.
                    const i = new ut(e.path.child("")), r = this.docs.getIteratorFrom(i);
            for (;r.hasNext(); ) {
     ...
     */ class fr {
        constructor(t) {
             ...
             */
            this.ds = new bi((t => vt(t)), St), 
            /** The last received snapshot version. */
            this.lastRemoteSnapshotVersion = U$1.min(), 
        ...
        forEachTarget(t, e) {
            return this.ds.forEach(((t, n) => e(n))), bs.resolve();
        }
        getLastRemoteSnapshotVersion(t) {
            return bs.resolve(this.lastRemoteSnapshotVersion);
        }
        getHighestSequenceNumber(t) {
            return bs.resolve(this.ws);
        }
        allocateTargetId(t) {
            return this.highestTargetId = this.gs.next(), bs.resolve(this.highestTargetId);
        }
        setTargetsMetadata(t, e, n) {
        ...
        addTargetData(t, e) {
            return this.te(e), this.targetCount += 1, bs.resolve();
        }
        updateTargetData(t, e) {
            return this.te(e), bs.resolve();
        }
        removeTargetData(t, e) {
        ...
        addMatchingKeys(t, e, n) {
            return this._s.Jn(e, n), bs.resolve();
        }
        removeMatchingKeys(t, e, n) {
            this._s.Xn(e, n);
        ...
        removeMatchingKeysForTargetId(t, e) {
            return this._s.Zn(e), bs.resolve();
        }
        getMatchingKeysForTargetId(t, e) {
        ...
        containsKey(t, e) {
            return bs.resolve(this._s.containsKey(e));
        }
    }
    ...
    class dr {
         ...
         */
        constructor(t, e) {
            this.ys = {}, this.Ne = new A$1(0), this.xe = !1, this.xe = !0, this.referenceDelegate = t(this), 
            this.qe = new fr(this);
        ...
        runTransaction(t, e, n) {
            S$1("MemoryPersistence", "Starting transaction:", t);
        ...
        Is(t, e) {
            return bs.or(Object.values(this.ys).map((n => () => n.containsKey(t, e))));
        }
    }
    ...
    class _r {
        ...
        addReference(t, e, n) {
            return this.As.addReference(n, e), this.bs.delete(n.toString()), bs.resolve();
        }
        removeReference(t, e, n) {
            return this.As.removeReference(n, e), this.bs.add(n.toString()), bs.resolve();
        }
        markPotentiallyOrphaned(t, e) {
            return this.bs.add(e.toString()), bs.resolve();
        }
        removeTarget(t, e) {
        ...
        vs(t, e) {
            return bs.or([ () => bs.resolve(this.As.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Is(t, e) ]);
        }
    }
    ...
    class Er {
         ...
         */    static Vs(t, e, n) {
            ...
            r && (i = new P$1(s.error.code, s.error.message))), r ? new Er(t, e, s.state, i) : (D$1("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
            null);
        }
        Ss() {
            const t = {
    ...
    class Tr {
         ...
         */    static Vs(t, e) {
            ...
            i && (s = new P$1(n.error.code, n.error.message))), i ? new Tr(t, n.state, s) : (D$1("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
            null);
        }
        Ss() {
            const t = {
     ...
     */ class Ir {
         ...
         */    static Vs(t, e) {
            ...
            return s ? new Ir(t, i) : (D$1("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
            null);
        }
    }
     ...
     */ class Ar {
         ...
         */    static Vs(t) {
            ...
            return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Ar(e.clientId, e.onlineState) : (D$1("SharedClientState", `Failed to parse online state: ${t}`), 
            null);
        }
    }
     ...
     */ class Pr {
        constructor(t, e, n, s, i) {
            ...
            this.Os = new ze(F$1), this.started = !1, 
            /**
            ...
            const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            this.storage = this.window.localStorage, this.currentUser = i, this.Ms = gr(this.persistenceKey, this.Ns), 
            this.Fs = 
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ (this.persistenceKey), this.Os = this.Os.insert(this.Ns, new Rr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        ...
        async start() {
            ...
            for (const e of t) {
                ...
                if (t) {
                    const n = Ir.Vs(e, t);
                    n && (this.Os = this.Os.insert(n.clientId, n));
                }
            }
            this.Qs();
            ...
            for (const t of this.$s) this.ks(t);
            this.$s = [], 
        ...
        writeSequenceNumber(t) {
            this.setItem(this.Fs, JSON.stringify(t));
        }
        ...
        shutdown() {
            this.started && (this.window.removeEventListener("storage", this.xs), this.removeItem(this.Ms), 
            this.started = !1);
        }
        getItem(t) {
            const e = this.storage.getItem(t);
            return S$1("SharedClientState", "READ", t, e), e;
        }
        setItem(t, e) {
            S$1("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
        }
        removeItem(t) {
            S$1("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
        }
        ks(t) {
            ...
            if (e.storageArea === this.storage) {
                if (S$1("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Ms) return void D$1("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                        ...
                        if (null !== e.key) if (this.Ls.test(e.key)) {
                            ...
                            const t = function(t) {
                                ...
                                if (null != t) try {
                                    ...
                                    D$1("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }
                            /**
     ...
     */ (e.newValue);
                            t !== A$1.o && this.sequenceNumberHandler(t);
        ...
        async ii(t) {
            ...
            S$1("SharedClientState", `Ignoring mutation for non-active user ${t.user.uid}`);
        }
        oi(t) {
            return this.syncEngine.ai(t.targetId, t.state, t.error);
        }
        ei(t, e) {
            const n = e ? this.Os.insert(t, e) : this.Os.remove(t), s = this.Gs(this.Os), i = this.Gs(n), r = [], o = [];
            return i.forEach((t => {
                s.has(t) || r.push(t);
            })), s.forEach((t => {
                i.has(t) || o.push(t);
        ...
        Ws(t) {
            ...
            // state event.
            this.Os.get(t.clientId) && this.onlineStateHandler(t.onlineState);
        }
        Gs(t) {
            let e = an();
    ...
    class Vr {
        ...
        _i() {
            S$1("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
            for (const t of this.yi) t(0 /* AVAILABLE */);
        }
        gi() {
            S$1("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
    ...
    class {
        ...
        Ni(t, e, n, s) {
            const i = this.xi(t, e);
            S$1("RestConnection", "Sending: ", i, n);
            const r = {};
            return this.ki(r, s), this.Oi(t, i, r, n).then((t => (S$1("RestConnection", "Received: ", t), 
            t)), (e => {
                    ...
                    try {
                        switch (o.getLastErrorCode()) {
                          case ErrorCode.NO_ERROR:
                            ...
                            S$1("Connection", "XHR received:", JSON.stringify(e)), i(e);
                            break;

                          case ErrorCode.TIMEOUT:
                            S$1("Connection", 'RPC "' + t + '" timed out'), r(new P$1(R$1.DEADLINE_EXCEEDED, "Request time out"));
                            break;

                          case ErrorCode.HTTP_ERROR:
                            const n = o.getStatus();
                            if (S$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", o.getResponseText()), 
                            n > 0) {
                                const t = o.getResponseJson().error;
                                if (t && t.status && t.message) {
                                    const e = function(t) {
                                        const e = t.toLowerCase().replace(/_/g, "-");
                                        return Object.values(R$1).indexOf(e) >= 0 ? e : R$1.UNKNOWN;
                                    }(t.status);
                                    r(new P$1(e, t.message));
                                } else r(new P$1(R$1.UNKNOWN, "Server responded with status " + o.getStatus()));
                            } else 
                            // If we received an HTTP_ERROR but there's no status code,
                            // it's most probably a connection issue
                            r(new P$1(R$1.UNAVAILABLE, "Connection failed."));
                            break;
                        ...
                        S$1("Connection", 'RPC "' + t + '" completed.');
                    }
                }));
        ...
        Mi(t, e) {
            ...
            this.ki(r.initMessageHeaders, e), 
            ...
            const o = n.join("");
            S$1("Connection", "Creating WebChannel: " + o, r);
            ...
            // on a closed stream
                    const m = new Dr({
                Ei: t => {
                    _ ? S$1("Connection", "Not sending because WebChannel is closed:", t) : (w || (S$1("Connection", "Opening WebChannel transport."), 
                    c.open(), w = !0), S$1("Connection", "WebChannel sending:", t), c.send(t));
                },
                Ti: () => c.close()
            }), g = (t, e, n) => {
            ...
            // enough the code is exception free.
                ...
                _ || S$1("Connection", "WebChannel transport opened.");
            })), g(c, WebChannel.EventType.CLOSE, (() => {
                _ || (_ = !0, S$1("Connection", "WebChannel transport closed"), m.Vi());
            })), g(c, WebChannel.EventType.ERROR, (t => {
                _ || (_ = !0, C("Connection", "WebChannel transport errored:", t), m.Vi(new P$1(R$1.UNAVAILABLE, "The operation could not be completed")));
                ...
                if (!_) {
                    ...
                    if (i) {
                        S$1("Connection", "WebChannel received error:", i);
     ...
     */
                        ...
                        void 0 === e && (e = R$1.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                        // Mark closed so no further events are propagated
                        _ = !0, m.Vi(new P$1(e, n)), c.close();
                    } else S$1("Connection", "WebChannel received:", n), m.Si(n);
                }
            })), g(i, Event.STAT_EVENT, (t => {
                t.stat === Stat.PROXY ? S$1("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && S$1("Connection", "Detected no buffering proxy");
            })), setTimeout((() => {
    ...
    class Or {
         ...
         */ , i = 6e4) {
            this.Se = t, this.timerId = e, this.Fi = n, this.Li = s, this.Bi = i, this.qi = 0, 
            this.Ui = null, 
         ...
         */    ji(t) {
            ...
            // Guard against lastAttemptTime being in the future due to a clock change.
                    s > 0 && S$1("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.qi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
            this.Ui = this.Se.enqueueAfterDelay(this.timerId, s, (() => (this.Ki = Date.now(), 
            t()))), 
            // Apply backoff factor to determine next delay and ensure it is within
            // bounds.
            this.qi *= this.Li, this.qi < this.Fi && (this.qi = this.Fi), this.qi > this.Bi && (this.qi = this.Bi);
        }
        Gi() {
    ...
    class $r {
        constructor(t, e, n, s, i, r) {
             ...
             * close.
             */
            this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new Or(t, e);
        }
        /**
         ...
         */    async close(t, e) {
            ...
            this.Zi.reset() : e && e.code === R$1.RESOURCE_EXHAUSTED ? (
            // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
            D$1(e.toString()), D$1("Using maximum backoff delay to prevent overloading the backend."), 
            this.Zi.Qi()) : e && e.code === R$1.UNAUTHENTICATED && 
        ...
        auth() {
            ...
            // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                ...
                t((() => {
                    const t = new P$1(R$1.UNKNOWN, "Fetching auth token failed: " + e.message);
                    return this.dr(t);
                }));
            }));
        }
        ...
        dr(t) {
            ...
            return S$1("PersistentStream", `close with error: ${t}`), this.stream = null, this.close(3 /* Error */ , t);
        }
        /**
         ...
         */    hr(t) {
            return e => {
                this.Se.enqueueAndForget((() => this.Yi === t ? e() : (S$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve())));
            };
        }
    }
     ...
     */ class Mr extends $r {
        ...
        wr(t) {
            return this.Hi.Mi("Listen", t);
        }
        onMessage(t) {
            // A successful response means the stream is healthy
            this.Zi.reset();
            const e = Mn(this.R, t), n = function(t) {
                // We have only reached a consistent snapshot for the entire stream if there
                // is a read_time set and it applies to all targets (i.e. the list of
                // targets is empty). The backend is guaranteed to send such responses.
                if (!("targetChange" in t)) return U$1.min();
                const e = t.targetChange;
                return e.targetIds && e.targetIds.length ? U$1.min() : e.readTime ? Pn(e.readTime) : U$1.min();
            }(t);
         ...
         */    mr(t) {
            ...
            e.database = Nn(this.R), e.addTarget = function(t, e) {
                ...
                return n = Dt(s) ? {
                    ...
                    query: Un(t, s)
                }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = An(t, e.resumeToken) : e.snapshotVersion.compareTo(U$1.min()) > 0 && (
     ...
     */ class Fr extends $r {
        ...
        wr(t) {
            return this.Hi.Mi("Write", t);
        }
        onMessage(t) {
            if (
            // Always capture the last stream token.
            k$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
                // A successful first write response means the stream is healthy,
                // Note, that we could consider a successful handshake healthy, however,
                // the write itself might be causing an error we want to back off from.
                this.Zi.reset();
                const e = Bn(t.writeResults, t.commitTime), n = Pn(t.commitTime);
                return this.listener.Tr(n, e);
            }
            // The first response is always the handshake response
            return k$1(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, this.listener.Ir();
        }
        /**
    ...
    class Lr extends class {} {
        ...
        Pr() {
            if (this.Rr) throw new P$1(R$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        /** Gets an auth token and invokes the provided RPC. */    Ni(t, e, n) {
            return this.Pr(), this.credentials.getToken().then((s => this.Hi.Ni(t, e, n, s))).catch((t => {
                throw t.code === R$1.UNAUTHENTICATED && this.credentials.invalidateToken(), t;
            }));
        }
        /** Gets an auth token and invokes the provided RPC with streamed results. */    $i(t, e, n) {
            return this.Pr(), this.credentials.getToken().then((s => this.Hi.$i(t, e, n, s))).catch((t => {
                throw t.code === R$1.UNAUTHENTICATED && this.credentials.invalidateToken(), t;
            }));
        }
        terminate() {
    ...
    class Br {
        ...
        Cr(t) {
            ...
            this.Vr ? (D$1(e), this.Vr = !1) : S$1("OnlineStateTracker", e);
        }
        kr() {
     ...
     */ class qr {
        ...
        e, n, s, i) {
             ...
             */
            this.Fr = [], this.Lr = i, this.Lr.di((t => {
                n.enqueueAndForget((async () => {
                    // Porting Note: Unlike iOS, `restartNetwork()` is called even when the
                    // network becomes unreachable as we don't have any other way to tear
                    // down our streams.
                    Jr(this) && (S$1("RemoteStore", "Restarting streams for network reachability change."), 
                    await async function(t) {
                        const e = O$1(t);
                        e.Mr.add(4 /* ConnectivityChange */), await Kr(e), e.Br.set("Unknown" /* Unknown */), 
                        e.Mr.delete(4 /* ConnectivityChange */), await Ur(e);
                    }(this));
                }));
            })), this.Br = new Br(n, s);
        }
    ...
    async function Ur(t) {
        if (Jr(t)) for (const e of t.Fr) await e(/* enabled= */ !0);
    }
     ...
     * enableNetwork().
     */ async function Kr(t) {
        for (const e of t.Fr) await e(/* enabled= */ !1);
    }
     ...
     */ (t, e);
            ...
            S$1("RemoteStore", "Failed to remove targets %s: %s ", e.targetIds.join(","), n), 
            await eo(t, n);
        } else if (e instanceof fn ? t.qr.X(e) : e instanceof dn ? t.qr.rt(e) : t.qr.et(e), 
        !n.isEqual(U$1.min())) try {
     ...
     */
            function(t, e) {
                ...
                n.targetMismatches.forEach((e => {
                    ...
                    // state.
                                    t.$r.set(e, n.withResumeToken(Y$1.EMPTY_BYTE_STRING, n.snapshotVersion)), 
            ...
            S$1("RemoteStore", "Failed to raise snapshot:", e), await eo(t, e);
        }
    }
     ...
     */ async function eo(t, e, n) {
        ...
        t.asyncQueue.enqueueRetryable((async () => {
            S$1("RemoteStore", "Retrying IndexedDB access"), await n(), t.Mr.delete(1 /* IndexedDbFailed */), 
            await Ur(t);
        }));
    }
    ...
    function oo(t) {
        return Jr(t) && !_o(t).tr() && t.Or.length > 0;
    }
    ...
    async function ao(t) {
        ...
        // Send the write pipeline now that the stream is established.
            for (const n of t.Or) e.Er(n.mutations);
    }

    async function ho(t, e, n) {
        const s = t.Or.shift(), i = Ls.from(s, e, n);
    ...
    async function lo(t, e) {
        ...
        await async function(t, e) {
            ...
            // logic kick in.
            if (n = e.code, We(n) && n !== R$1.ABORTED) {
    ...
    async function fo(t, e) {
        const n = O$1(t);
        e ? (n.Mr.delete(2 /* IsSecondary */), await Ur(n)) : e || (n.Mr.add(2 /* IsSecondary */), 
     ...
     */ function wo(t) {
        ...
        t.Ur = function(t, e, n) {
            const s = O$1(t);
            return s.Pr(), new Mr(e, s.Hi, s.credentials, s.R, n);
        }
        /**
     * @license
     * Copyright 2018 Google LLC
     ...
     */ function _o(t) {
        ...
        t.Kr = function(t, e, n) {
            const s = O$1(t);
            return s.Pr(), new Fr(e, s.Hi, s.credentials, s.R, n);
        }(t.datastore, t.asyncQueue, {
            Ii: uo.bind(null, t),
            Ri: lo.bind(null, t),
            Ir: ao.bind(null, t),
            ...
            await so(t)) : (await t.Kr.stop(), t.Or.length > 0 && (S$1("RemoteStore", `Stopping write stream with ${t.Or.length} pending writes`), 
            t.Or = []));
        }))), t.Kr;
    }
    ...
    class mo {
         ...
         */    cancel(t) {
            null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new P$1(R$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
        }
        handleDelayElapsed() {
     ...
     */ function go(t, e) {
        if (D$1("AsyncQueue", `${e}: ${t}`), Cs(t)) return new P$1(R$1.UNAVAILABLE, `${e}: ${t}`);
        throw t;
    }
     ...
     */ class po {
        ...
        track(t) {
            ...
            // Metadata->Added
            // Removed->Metadata
            x$1() : this.Qr = this.Qr.insert(e, t);
        }
        jr() {
            const t = [];
    ...
    class Io {
        constructor() {
            this.queries = new bi((t => re(t)), ie), this.onlineState = "Unknown" /* Unknown */ , 
            this.Gr = new Set;
        }
    }

    async function Ao(t, e) {
        const n = O$1(t), s = e.query;
    ...
    function bo(t, e, n) {
        const s = O$1(t), i = s.queries.get(e);
     ...
     */ class Do {
         ...
         */    Un(t) {
            return t.metadata.exists ? On(this.R, t.document, !1) : Rt.newNoDocument(this.qn(t.metadata.name), this.Kn(t.metadata.readTime));
        }
        Kn(t) {
            return Pn(t);
        }
    ...
    /** Tracks a limbo resolution. */ class Mo {
        constructor(t) {
            this.key = t, 
            /**
     ...
     */ class Fo {
        ...
        s, i, r) {
            ...
            this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.bo = {}, this.vo = new bi((t => re(t)), ie), 
            this.Vo = new Map, 
            /**
            ...
            this.ko = new Map, this.Oo = wi.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
     ...
     */ async function Bo(t, e, n, s) {
        ...
        t.Mo = (e, n, s) => async function(t, e, n, s) {
            let i = e.view._o(n);
            i.Nn && (
        ...
        /* usePreviousResults= */ !0), r = new Oo(e, i.Bn), o = r._o(i.documents), c = ln.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.applyChanges(o, 
    ...
    /** Stops listening to the query. */ async function qo(t, e) {
        const n = O$1(t), s = n.vo.get(e), i = n.Vo.get(s.targetId);
        if (i.length > 1) return n.Vo.set(s.targetId, i.filter((t => !ie(t, e)))), void n.vo.delete(e);
     ...
     */ async function Uo(t, e, n) {
        ...
        try {
            const t = await function(t, e) {
                const n = O$1(t), s = q$1.now(), i = e.reduce(((t, e) => t.add(e.key)), cn());
                let r;
                return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Fn.pn(t, i).next((i => {
                    r = i;
                    ...
                    for (const t of e) {
                        ...
                        // exists=true
                        o.push(new Me(t.key, e, At(e.toProto().mapValue), Ve.exists(!0)));
                    }
     ...
     * it.
     */ (s, t.batchId, n), await nc$1(s, t.changes), await so(s.remoteStore);
        } catch (t) {
     ...
     */ async function Ko(t, e) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                k$1(t.addedDocuments.size + t.modifiedDocuments.size + t.removedDocuments.size <= 1), 
                t.addedDocuments.size > 0 ? s.Po = !0 : t.modifiedDocuments.size > 0 ? k$1(s.Po) : t.removedDocuments.size > 0 && (k$1(s.Po), 
                s.Po = !1));
            })), await nc$1(n, t, e);
        } catch (t) {
            await pi(t);
     ...
     */ async function jo(t, e, n) {
        ...
        if (r) {
            ...
            let t = new ze(ut.comparator);
            t = t.insert(r, Rt.newNoDocument(r, U$1.min()));
            const n = cn().add(r), i = new hn(U$1.min(), 
            /* targetChanges= */ new Map, 
            /* targetMismatches= */ new Ye(F$1), t, n);
            await Ko(s, i), 
        ...
        try {
            const t = await function(t, e) {
                ...
                return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                    let s;
                    return n._n.lookupMutationBatch(t, e).next((e => (k$1(null !== e), s = e.keys(), n._n.removeMutationBatch(t, e)))).next((() => n._n.performConsistencyCheck(t))).next((() => n.Fn.pn(t, s)));
                }));
            }
            /**
     ...
     */ async function zo(t, e) {
        const n = O$1(t);
        Jr(n.remoteStore) || S$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
    ...
    function Yo(t, e, n = null) {
        ...
        for (const s of t.Vo.get(e)) t.vo.delete(s), n && t.bo.Fo(s, n);
    ...
    function Xo(t, e) {
        ...
        const n = t.Do.get(e);
        null !== n && (jr(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), ec$1(t));
    }

    function Zo(t, e, n) {
        for (const s of n) if (s instanceof xo) t.No.addReference(s.key, e), tc(t, s); else if (s instanceof ko) {
            S$1("SyncEngine", "Document no longer in limbo: " + s.key), t.No.removeReference(s.key, e);
    ...
    function tc(t, e) {
        ...
        t.Do.get(n) || t.So.has(s) || (S$1("SyncEngine", "New document in limbo: " + n), t.So.add(s), 
        ec$1(t));
    }
     ...
     */ function ec$1(t) {
        for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
            ...
            t.So.delete(e);
            const n = new ut(G$1.fromString(e)), s = t.Oo.next();
            t.Co.set(s, new Mo(n)), t.Do = t.Do.insert(n, s), Qr(t.remoteStore, new Bs(ne(Ht(n.path)), s, 2 /* LimboResolution */ , A$1.o));
        }
    }

    async function nc$1(t, e, n) {
        const s = O$1(t), i = [], r = [], o = [];
        s.vo.isEmpty() || (s.vo.forEach(((t, c) => {
            o.push(s.Mo(c, e, n).then((t => {
                if (t) {
                    s.isPrimaryClient && s.sharedClientState.updateQueryState(c.targetId, t.fromCache ? "not-current" : "current"), 
                    i.push(t);
                    const e = Ui.vn(c.targetId, t);
                    r.push(e);
                }
            })));
            ...
            const n = O$1(t);
            try {
                await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => bs.forEach(e, (e => bs.forEach(e.Pn, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => bs.forEach(e.bn, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
            } catch (t) {
                if (!Cs(t)) throw t;
                ...
                S$1("LocalStore", "Failed to update sequence numbers: " + t);
            }
            for (const t of e) {
                const e = t.targetId;
                if (!t.fromCache) {
    ...
    async function sc$1(t, e) {
        const n = O$1(t);
        if (!n.currentUser.isEqual(e)) {
            S$1("SyncEngine", "User change. New user:", e.toKey());
            ...
            function(t, e) {
                t.ko.forEach((t => {
                    t.forEach((t => {
                        t.reject(new P$1(R$1.CANCELLED, e));
                    }));
                })), t.ko.clear();
            }(n, "'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await nc$1(n, t.Ln);
        }
    }

    function ic$1(t, e) {
        const n = O$1(t), s = n.Co.get(e);
        if (s && s.Po) return cn().add(s.key);
        {
            let t = cn();
            const s = n.Vo.get(e);
            if (!s) return t;
     ...
     */ async function rc$1(t, e) {
        const n = O$1(t), s = await tr(n.localStore, e.query, 
     ...
     */
    // PORTING NOTE: Multi-Tab only.
    async function oc$1(t) {
        const e = O$1(t);
        return nr(e.localStore).then((t => nc$1(e, t)));
    }

    /** Applies a mutation state to an existing batch.  */
    // PORTING NOTE: Multi-Tab only.
    async function cc$1(t, e, n, s) {
        const i = O$1(t), r = await function(t, e) {
            const n = O$1(t), s = O$1(n._n);
            return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.jt(t, e).next((e => e ? n.Fn.pn(t, e) : bs.resolve(null)))));
        }
        // PORTING NOTE: Multi-Tab only.
        (i.localStore, e);
        null !== r ? ("pending" === n ? 
        ...
        // PORTING NOTE: Multi-Tab only.
        (i.localStore, e)) : x$1(), await nc$1(i, r)) : 
        ...
        // as applicable.
        S$1("SyncEngine", "Cannot apply mutation batch with id: " + e);
    }
    ...
    async function uc$1(t, e) {
        ...
        if (wc$1(n), _c(n), !0 === e && !0 !== n.$o) {
            ...
            const t = n.sharedClientState.getAllActiveQueryTargets(), e = await ac$1(n, t.toArray());
            ...
            })), await e, await ac$1(n, t), 
            // PORTING NOTE: Multi-Tab only.
            function(t) {
                const e = O$1(t);
                e.Co.forEach(((t, n) => {
                    jr(e.remoteStore, n);
                })), e.No.ts(), e.Co = new Map, e.Do = new ze(ut.comparator);
            }
            /**
    ...
    async function ac$1(t, e, n) {
        ...
        for (const t of e) {
            ...
            if (n && 0 !== n.length) {
                ...
                for (const t of n) {
                    const e = s.vo.get(t), n = await rc$1(s, e);
                ...
                e = await Xi(s.localStore, n), await Bo(s, hc$1(n), t, 
                /*current=*/ !1);
            }
            i.push(e);
        }
    ...
    function lc$1(t) {
        const e = O$1(t);
        return O$1(O$1(e.localStore).persistence).fn();
    }

    /** Applies a query target change from a different tab. */
    // PORTING NOTE: Multi-Tab only.
    async function fc$1(t, e, n, s) {
        const i = O$1(t);
        if (i.$o) 
        // If we receive a target state notification via WebStorage, we are
        // either already secondary or another tab has taken the primary lease.
        S$1("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
          case "current":
          case "not-current":
            {
    ...
    /** Adds or removes Watch targets for queries from different tabs. */ async function dc$1(t, e, n) {
        const s = wc$1(t);
        if (s.$o) {
            for (const t of e) {
                if (s.Vo.has(t)) {
                    // A target might have been added in a previous attempt
                    S$1("SyncEngine", "Adding an already active target " + t);
                    continue;
                }
                const e = await er(s.localStore, t), n = await Xi(s.localStore, e);
                await Bo(s, hc$1(e), n.targetId, 
    ...
    function wc$1(t) {
        const e = O$1(t);
        return e.remoteStore.remoteSyncer.applyRemoteEvent = Ko.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ic$1.bind(null, e), 
        e.remoteStore.remoteSyncer.rejectListen = jo.bind(null, e), e.bo._r = Po.bind(null, e.eventManager), 
        e.bo.Fo = bo.bind(null, e.eventManager), e;
    }
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
            ...
            try {
                ...
                if (await function(t, e) {
                    const n = O$1(t), s = Pn(e.createTime);
     ...
     */ (t.localStore, s), n._completeWith(o.progress);
                ...
                C("SyncEngine", `Loading bundle failed with ${t}`), n._failWith(t);
            }
        }
        /**
     * @license
    ...
    class gc$1 {
        ...
        async initialize(t) {
            this.R = kr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), this.persistence = this.qo(t), 
     ...
     */ class pc$1 extends yc$1 {
        ...
        async initialize(t) {
            ...
            await this.persistence.He((async t => {
                await uc$1(this.Qo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
            }));
        }
        Bo(t) {
            const e = Nr();
            if (!Pr.gt(e)) throw new P$1(R$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
     ...
     */ class Ec$1 {
        async initialize(t, e) {
            ...
            this.remoteStore.remoteSyncer.handleCredentialChange = sc$1.bind(null, this.syncEngine), 
        ...
        createDatastore(t) {
            const e = kr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Cr(s));
            var s;
        ...
        createRemoteStore(t) {
            ...
            r = Vr.gt() ? new Vr : new vr, new qr(e, n, s, i, r);
            var e, n, s, i, r;
        ...
        terminate() {
            return async function(t) {
                const e = O$1(t);
                S$1("RemoteStore", "RemoteStore shutting down."), e.Mr.add(5 /* Shutdown */), await Kr(e), 
                e.Lr.shutdown(), 
    ...
    class Rc$1 {
        ...
        async lookup(t) {
            if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new P$1(R$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
            const e = await async function(t, e) {
                const n = O$1(t), s = Nn(n.R) + "/documents", i = {
        ...
        recordVersion(t) {
            ...
            if (n) {
                ...
                throw new P$1(R$1.ABORTED, "Document version changed between two reads.");
         ...
         */    preconditionForUpdate(t) {
            ...
            // read time and existence
                ...
                // transaction.
                throw new P$1(R$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    class Pc$1 {
        constructor(t, e, n, s) {
            ...
            this.ec = 5, this.Zi = new Or(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
        }
        ...
        nc() {
            this.Zi.ji((async () => {
                const t = new Rc$1(this.datastore), e = this.sc(t);
                e && e.then((e => {
    ...
    class bc$1 {
        ...
        e, n) {
            ...
            this.clientId = M$1.u(), this.credentialListener = () => {}, this.receivedInitialUser = new Ps, 
            this.credentials.setChangeListener((t => {
                S$1("FirestoreClient", "Received user=", t.uid), this.user = t, this.credentialListener(t), 
         ...
         */    verifyNotTerminated() {
            if (this.asyncQueue.isShuttingDown) throw new P$1(R$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        terminate() {
    ...
    async function vc$1(t, e) {
        t.asyncQueue.verifyOperationInProgress(), S$1("FirestoreClient", "Initializing OfflineComponentProvider");
        const n = await t.getConfiguration();
        await e.initialize(n);
        let s = n.initialUser;
        t.setCredentialChangeListener((n => {
            s.isEqual(n) || (s = n, t.asyncQueue.enqueueRetryable((async () => {
                await Wi(e.localStore, n);
            })));
        })), 
    ...
    async function Vc$1(t, e) {
        ...
        const n = await Sc$1(t);
        S$1("FirestoreClient", "Initializing OnlineComponentProvider");
        ...
        t.setCredentialChangeListener((n => t.asyncQueue.enqueueRetryable((() => async function(t, e) {
            const n = O$1(t);
            n.asyncQueue.verifyOperationInProgress(), S$1("RemoteStore", "RemoteStore received new credentials");
            const s = Jr(n);
            // Tear down and re-create our network streams. This will ensure we get a
            // fresh auth token for the new user and re-fill the write pipeline with
            // new mutations from the LocalStore (since mutations are per-user).
                    n.Mr.add(3 /* CredentialChange */), await Kr(n), s && 
            // Don't set the network status to Unknown if we are offline.
            n.Br.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
            n.Mr.delete(3 /* CredentialChange */), await Ur(n);
        }(e.remoteStore, n))))), t.onlineComponents = e;
    }

    async function Sc$1(t) {
        return t.offlineComponents || (S$1("FirestoreClient", "Using default OfflineComponentProvider"), 
        await vc$1(t, new gc$1)), t.offlineComponents;
    }

    async function Dc$1(t) {
        return t.onlineComponents || (S$1("FirestoreClient", "Using default OnlineComponentProvider"), 
        await Vc$1(t, new Ec$1)), t.onlineComponents;
    }

    function Cc$1(t) {
        return Sc$1(t).then((t => t.persistence));
    }

    function Nc$1(t) {
        return Sc$1(t).then((t => t.localStore));
    }

    function xc(t) {
        return Dc$1(t).then((t => t.remoteStore));
    }

    function kc$1(t) {
        return Dc$1(t).then((t => t.syncEngine));
    }

    async function Oc$1(t) {
        const e = await Dc$1(t), n = e.eventManager;
        return n.onListen = Lo.bind(null, e.syncEngine), n.onUnlisten = qo.bind(null, e.syncEngine), 
        n;
    }

    /** Enables the network connection and re-enqueues all pending operations. */ function $c$1(t) {
        return t.asyncQueue.enqueue((async () => {
            const e = await Cc$1(t), n = await xc(t);
            return e.setNetworkEnabled(!0), function(t) {
                const e = O$1(t);
                return e.Mr.delete(0 /* UserDisabled */), Ur(e);
            }(n);
        }));
    }

    /** Disables the network connection. Pending operations will not complete. */ function Mc$1(t) {
        return t.asyncQueue.enqueue((async () => {
            const e = await Cc$1(t), n = await xc(t);
            return e.setNetworkEnabled(!1), async function(t) {
                const e = O$1(t);
                e.Mr.add(0 /* UserDisabled */), await Kr(e), 
        ...
        return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
            try {
                const s = await function(t, e) {
                    const n = O$1(t);
                    return n.persistence.runTransaction("read document", "readonly", (t => n.Fn.mn(t, e)));
                }(t, e);
                s.isFoundDocument() ? n.resolve(s) : s.isNoDocument() ? n.resolve(null) : n.reject(new P$1(R$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (t) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
            const r = new Ic$1({
                next: r => {
                    ...
                    i.reject(new P$1(R$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : c && r.fromCache && s && "server" === s.source ? i.reject(new P$1(R$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
                },
                error: t => i.reject(t)
            ...
            return Ao(t, o);
        }(await Oc$1(t), t.asyncQueue, e, n, s))), s.promise;
    }
    ...
    function Bc$1(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
            try {
                ...
                /* usePreviousResults= */ !0), i = new Oo(e, s.Bn), r = i._o(s.documents), o = i.applyChanges(r, 
                /* updateLimboDocuments= */ !1);
        ...
        return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
            const r = new Ic$1({
                next: n => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    e.enqueueAndForget((() => Ro(t, o))), n.fromCache && "server" === s.source ? i.reject(new P$1(R$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                },
                error: t => i.reject(t)
            }), o = new Vo(n, r, {
                includeMetadataChanges: !0,
     ...
     */ function Kc$1(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((async () => {
            const s = await function(t) {
                return Dc$1(t).then((t => t.datastore));
            }(t);
            new Pc$1(t.asyncQueue, s, e, n).run();
        })), n.promise;
    }

    function Qc$1(t, e, n, s) {
        const i = function(t, e) {
            ...
            return function(t, e) {
                ...
                if (t instanceof Uint8Array) return Tc$1(t, e);
                if (t instanceof ArrayBuffer) return Tc$1(new Uint8Array(t), e);
    ...
    class Gc$1 {
        ...
        isEqual(t) {
            return t instanceof Gc$1 && t.projectId === this.projectId && t.database === this.database;
        }
    }
    ...
    /** A CredentialsProvider that always yields an empty token. */ class Jc$1 {
        constructor() {
            /**
    ...
    class Yc$1 {
        constructor(t) {
            ...
            this.currentUser = mr.UNAUTHENTICATED, this.receivedInitialUser = !1, 
            /**
        ...
        getToken() {
            ...
            this.cc !== t ? (S$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            this.getToken()) : e ? (k$1("string" == typeof e.accessToken), new Hc$1(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
        }
        invalidateToken() {
            this.forceRefresh = !0;
        }
        ...
        uc() {
            ...
            return k$1(null === t || "string" == typeof t), new mr(t);
        }
    }
     ...
     */ class Xc$1 {
        constructor(t, e, n) {
            this.ac = t, this.hc = e, this.lc = n, this.type = "FirstParty", this.user = mr.FIRST_PARTY;
        }
        get authHeaders() {
            const t = {
     ...
     */ class Zc$1 {
        ...
        getToken() {
            return Promise.resolve(new Xc$1(this.ac, this.hc, this.lc));
        }
        setChangeListener(t) {
     ...
     */
    function tu(t, e, n) {
        if (!n) throw new P$1(R$1.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
    }
     ...
     */
    function eu(t) {
        if (!ut.isDocumentKey(t)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
    }
     ...
     */ function nu(t) {
        if (ut.isDocumentKey(t)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
    }
    ...
    e) {
        ...
        t = t._delegate), !(t instanceof e)) {
            if (e.name === t.constructor.name) throw new P$1(R$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
            {
                const n = su(t);
                throw new P$1(R$1.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
            }
        }
        return t;
    }
    ...
    function ru(t, e) {
        if (e <= 0) throw new P$1(R$1.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
    }
    ...
    class ou {
        constructor(t) {
            var e;
            if (void 0 === t.host) {
                if (void 0 !== t.ssl) throw new P$1(R$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
                this.host = "firestore.googleapis.com", this.ssl = true;
            } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
            if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
            void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
                if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new P$1(R$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
                this.cacheSizeBytes = t.cacheSizeBytes;
            }
            this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
            function(t, e, n, s) {
                if (!0 === e && !0 === s) throw new P$1(R$1.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
     ...
     */ class cu {
        /** @hideconstructor */
        constructor(t, e) {
            this._persistenceKey = "(lite)", this._settings = new ou({}), this._settingsFrozen = !1, 
            t instanceof Gc$1 ? (this._databaseId = t, this._credentials = new Jc$1) : (this._app = t, 
            this._databaseId = function(t) {
                if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new P$1(R$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
                return new Gc$1(t.options.projectId);
            }
            /**
     ...
     */ (t), this._credentials = new Yc$1(e));
        }
        /**
         * The {@link FirebaseApp} associated with this `Firestore` service
         * instance.
         */    get app() {
            if (!this._app) throw new P$1(R$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        }
        get _initialized() {
        ...
        _setSettings(t) {
            if (this._settingsFrozen) throw new P$1(R$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
            this._settings = new ou(t), void 0 !== t.credentials && (this._credentials = function(t) {
                if (!t) return new Jc$1;
                switch (t.type) {
                  case "gapi":
                    const e = t.client;
                    // Make sure this really is a Gapi client.
                                    return k$1(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                    new Zc$1(e, t.sessionIndex || "0", t.iamToken || null);

                  case "provider":
                    return t.client;

                  default:
                    throw new P$1(R$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
                }
            }(t.credentials));
        }
        _getSettings() {
     ...
     */
            return function(t) {
                const e = zc$1.get(t);
                e && (S$1("ComponentProvider", "Removing Datastore"), zc$1.delete(t), e.terminate());
            }(this), Promise.resolve();
        }
    }

    function uu(t, e, n) {
        const s = (t = iu(t, cu))._getSettings();
        "firestore.googleapis.com" !== s.host && s.host !== e && C("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
     ...
     */ class au {
         ...
         */    get parent() {
            return new lu(this.firestore, this._converter, this._key.path.popLast());
        }
        withConverter(t) {
     ...
     */ class lu extends hu {
        /** @hideconstructor */
        constructor(t, e, n) {
            super(t, e, Ht(n)), this.firestore = t, this._path = n, this.type = "collection";
        }
    ...
    function fu(t, e, ...n) {
        if (t = getModularInstance(t), tu("collection", "path", e), t instanceof cu) {
            const s = G$1.fromString(e, ...n);
            return nu(s), new lu(t, /* converter= */ null, s);
        }
        {
            if (!(t instanceof au || t instanceof lu)) throw new P$1(R$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = G$1.fromString(t.path, ...n).child(G$1.fromString(e));
            return nu(s), new lu(t.firestore, 
            /* converter= */ null, s);
        }
    }
     ...
     */ function du(t, e) {
        if (t = iu(t, cu), tu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
        return new hu(t, 
        /* converter= */ null, 
        /**
    ...
    function wu(t, e, ...n) {
        ...
        // 'undefined' and 'null'.
        1 === arguments.length && (e = M$1.u()), tu("doc", "path", e), t instanceof cu) {
            const s = G$1.fromString(e, ...n);
            return eu(s), new au(t, 
            /* converter= */ null, new ut(s));
        }
        {
            if (!(t instanceof au || t instanceof lu)) throw new P$1(R$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = t._path.child(G$1.fromString(e, ...n));
            return eu(s), new au(t.firestore, t instanceof lu ? t._converter : null, new ut(s));
        }
    }
     ...
     * Firestore database.
     */ function _u(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), (t instanceof au || t instanceof lu) && (e instanceof au || e instanceof lu) && (t.firestore === e.firestore && t.path === e.path && t._converter === e._converter);
    }
     ...
     * Firestore database.
     */ function mu(t, e) {
        return t = getModularInstance(t), e = getModularInstance(e), t instanceof hu && e instanceof hu && (t.firestore === e.firestore && ie(t._query, e._query) && t._converter === e._converter);
    }
     ...
     */ class gu {
        constructor() {
            ...
            this.Zi = new Or(this, "async_queue_retry" /* AsyncQueueRetry */), 
            // Visibility handler that triggers an immediate retry of all retryable
            // operations. Meant to speed up recovery when we regain file system access
            // after page comes into foreground.
            this.Ec = () => {
                const t = xr();
                t && S$1("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.Zi.Gi();
            };
            const t = xr();
     ...
     // Failure will be handled by AsyncQueue
                                    S$1("AsyncQueue", "Operation failed with retryable error: " + t);
                }
                this.dc.length > 0 && 
        ...
        Ic(t) {
            const e = this.fc.then((() => (this.gc = !0, t().catch((t => {
                ...
                throw D$1("INTERNAL UNHANDLED ERROR: ", 
                /**
     ...
     */ (t)), t;
        ...
        enqueueAfterDelay(t, e, n) {
            ...
            const s = mo.createAndSchedule(this, t, e, n, (t => this.Rc(t)));
    ...
    class Tu extends cu {
        /** @hideconstructor */
        constructor(t, e) {
            super(t, e), this._queue = new gu, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
        }
        _terminate() {
            return this._firestoreClient || 
            // The client must be initialized to ensure that all subsequent API
            // usage throws an exception.
            Pu(this), this._firestoreClient.terminate();
        }
    }
     ...
     */ function Iu(e, n) {
        ...
        if (s.isInitialized()) throw new P$1(R$1.FAILED_PRECONDITION, "Firestore can only be initialized once per app.");
        if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new P$1(R$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
        return s.initialize({
            options: n
        });
    }
     ...
     * @internal
     */ function Ru(t) {
        return t._firestoreClient || Pu(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
    }

    function Pu(t) {
        var e;
        const n = t._freezeSettings(), s = function(t, e, n, s) {
            return new Wc$1(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling);
        }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
        t._firestoreClient = new bc$1(t._credentials, t._queue, s);
    }
     ...
     */ function bu(t, e) {
        $u(t = iu(t, Tu));
        const n = Ru(t), s = t._freezeSettings(), i = new Ec$1;
        return Vu(n, i, new yc$1(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
    }
     ...
     */ function vu(t) {
        $u(t = iu(t, Tu));
        const e = Ru(t), n = t._freezeSettings(), s = new Ec$1;
        return Vu(e, s, new pc$1(s, n.cacheSizeBytes));
    }
     ...
     */ function Vu(t, e, n) {
        ...
        return t.asyncQueue.enqueue((async () => {
            try {
                await vc$1(t, n), await Vc$1(t, e), s.resolve();
            } catch (t) {
                if (!
                /**
     ...
     */
                function(t) {
                    if ("FirebaseError" === t.name) return t.code === R$1.FAILED_PRECONDITION || t.code === R$1.UNIMPLEMENTED;
    ...
    function Su(t) {
        if (t._initialized && !t._terminated) throw new P$1(R$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const e = new Ps;
     ...
     */ function Du(t) {
        return function(t) {
            const e = new Ps;
            return t.asyncQueue.enqueueAndForget((async () => zo(await kc$1(t), e))), e.promise;
        }(Ru(t = iu(t, Tu)));
    }
     ...
     */ function ku(t, e) {
        const n = Ru(t = iu(t, Tu)), s = new pu;
        return Qc$1(n, t._databaseId, e, s), s;
    }
     ...
     */ function Ou(t, e) {
        return jc$1(Ru(t = iu(t, Tu)), e).then((e => e ? new hu(t, null, e.query) : null));
    }

    function $u(t) {
        if (t._initialized || t._terminated) throw new P$1(R$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
    }
    ...
    class Mu {
         ...
         */
        constructor(...t) {
            for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new P$1(R$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
            this._internalPath = new H$1(t);
        }
        /**
     ...
     */ class Lu {
         ...
         */    static fromBase64String(t) {
            try {
                return new Lu(Y$1.fromBase64String(t));
            } catch (t) {
                throw new P$1(R$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
            }
        }
        /**
         ...
         */    static fromUint8Array(t) {
            return new Lu(Y$1.fromUint8Array(t));
        }
        /**
     ...
     */ class qu {
         ...
         */
        constructor(t, e) {
            if (!isFinite(t) || t < -90 || t > 90) throw new P$1(R$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
            if (!isFinite(e) || e < -180 || e > 180) throw new P$1(R$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
         ...
         * with an underscore.
         */    _compareTo(t) {
            return F$1(this._lat, t._lat) || F$1(this._long, t._long);
        }
    }
    ...
    /** The result of parsing document data (e.g. for a setData call). */ class Ku {
        ...
        toMutation(t, e) {
            return null !== this.fieldMask ? new Me(t, this.data, this.fieldMask, e, this.fieldTransforms) : new $e(t, this.data, e, this.fieldTransforms);
        }
    }

    /** The result of parsing "update" data (i.e. for an updateData call). */ class Qu {
        constructor(t, 
    ...
    /** A "context" object passed around while parsing user data. */ class Wu {
        /**
        ...
        /** Returns a new context with the specified settings overwritten. */    Cc(t) {
            return new Wu(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
        }
        Nc(t) {
            var e;
        ...
        Mc(t) {
            return fa$1(t, this.settings.methodName, this.settings.Fc || !1, this.path, this.settings.Lc);
        }
        ...
        kc(t) {
            ...
            if (ju(this.Dc) && Uu.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
        }
    }
    ...
    /** Parse document data from a set() call. */ function Hu(t, e, n, s, i, r = {}) {
        ...
        ua$1("Data must be an object, but it was:", o, s);
        const c = oa$1(s, o);
        let u, a;
        if (r.merge) u = new J$1(o.fieldMask), a = o.fieldTransforms; else if (r.mergeFields) {
            const t = [];
            for (const s of r.mergeFields) {
                const i = aa$1(e, s, n);
                if (!o.contains(i)) throw new P$1(R$1.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
                da$1(t, i) || t.push(i);
            }
            u = new J$1(t), a = o.fieldTransforms.filter((t => u.covers(t.field)));
    ...
    class Ju extends Bu {
        _toFieldTransform(t) {
            if (2 /* MergeSet */ !== t.Dc) throw 1 /* Update */ === t.Dc ? t.Mc(`${this._methodName}() can only appear at the top level of your update data`) : t.Mc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
    ...
    class Zu extends Bu {
        ...
        _toFieldTransform(t) {
            const e = Yu(this, t, 
            /*array=*/ !0), n = this.qc.map((t => ra$1(t, e))), s = new ye(n);
    ...
    class ta$1 extends Bu {
        constructor(t, e) {
            super(t), this.qc = e;
        }
        _toFieldTransform(t) {
            const e = Yu(this, t, 
            /*array=*/ !0), n = this.qc.map((t => ra$1(t, e))), s = new Ee(n);
            return new Pe(t.path, s);
        }
        isEqual(t) {
            // TODO(mrschmidt): Implement isEquals
    ...
    class ea$1 extends Bu {
        constructor(t, e) {
            super(t), this.Uc = e;
        }
        _toFieldTransform(t) {
            const e = new Ie(t.R, fe(t.R, this.Uc));
    ...
    /** Parse update data from an update() call. */ function na$1(t, e, n, s) {
        const i = t.Bc(1 /* Update */ , e, n);
        ua$1("Data must be an object, but it was:", i, s);
        const r = [], o = It.empty();
        Q$1(s, ((t, s) => {
            const c = la(e, t, n);
        ...
        const c = new J$1(r);
        return new Qu(o, c, i.fieldTransforms);
    }

    /** Parse update data from a list of field/value arguments. */ function sa$1(t, e, n, s, i, r) {
        const o = t.Bc(1 /* Update */ , e, n), c = [ aa$1(e, s, n) ], u = [ i ];
        if (r.length % 2 != 0) throw new P$1(R$1.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
        for (let t = 0; t < r.length; t += 2) c.push(aa$1(e, r[t])), u.push(r[t + 1]);
        const a = [], h = It.empty();
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (let t = c.length - 1; t >= 0; --t) if (!da$1(a, c[t])) {
            const e = c[t];
            let n = u[t];
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
        ...
        const l = new J$1(a);
        return new Qu(h, l, o.fieldTransforms);
    }
     ...
     */ function ia(t, e, n, s = !1) {
        return ra$1(n, t.Bc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
    }
     ...
     */ function ra$1(t, e) {
        ...
        // from firestore-exp.
        t = getModularInstance(t))) return ua$1("Unsupported field value:", e, t), oa$1(t, e);
        if (t instanceof Bu) 
     ...
     */
        return function(t, e) {
            ...
            if (!ju(e.Dc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
     ...
     */ (t, e), null;
        ...
        e.path && e.fieldMask.push(e.path), t instanceof Array) {
            ...
            if (e.settings.xc && 4 /* ArrayArgument */ !== e.Dc) throw e.Mc("Nested arrays are not supported");
            return function(t, e) {
                const n = [];
                let s = 0;
                for (const i of t) {
        ...
        return function(t, e) {
            ...
            if (t instanceof q$1) {
                ...
                const n = new q$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
                return {
                    timestampValue: In(e.R, n)
                };
            }
            ...
            throw e.Mc(`Unsupported field value: ${su(t)}`);
        }
        /**
    ...
    function oa$1(t, e) {
        ...
        e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Q$1(t, ((t, s) => {
            const i = ra$1(s, e.Nc(t));
            null != i && (n[t] = i);
        })), {
            mapValue: {
                fields: n
    ...
    function ca$1(t) {
        return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof q$1 || t instanceof qu || t instanceof Lu || t instanceof au || t instanceof Bu);
    }

    function ua$1(t, e, n) {
        if (!ca$1(n) || !function(t) {
     ...
     */ function aa$1(t, e, n) {
        ...
        // FieldPath.
        e = getModularInstance(e)) instanceof Mu) return e._internalPath;
        if ("string" == typeof e) return la(t, e);
        throw fa$1("Field path arguments must be of type string or FieldPath.", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
     ...
     * evaluated.
     */ function la(t, e, n) {
        if (e.search(ha$1) >= 0) throw fa$1(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
        try {
            return new Mu(...e.split("."))._internalPath;
        } catch (s) {
            throw fa$1(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
            /* hasConverter= */ !1, 
            /* path= */ void 0, n);
        }
    }

    function fa$1(t, e, n, s, i) {
        const r = s && !s.isEmpty(), o = void 0 !== i;
        let c = `Function ${e}() called with invalid data`;
        n && (c += " (via `toFirestore()`)"), c += ". ";
        let u = "";
        return (r || o) && (u += " (found", r && (u += ` in field ${s}`), o && (u += ` in document ${i}`), 
        u += ")"), new P$1(R$1.INVALID_ARGUMENT, c + t + u);
    }

    /** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function da$1(t, e) {
     ...
     */ class wa$1 {
         ...
         */    data() {
            if (this._document) {
                if (this._converter) {
                    ...
                    const t = new _a$1(this._firestore, this._userDataWriter, this._key, this._document, 
                    /* converter= */ null);
        ...
        get(t) {
            if (this._document) {
                const e = this._document.data.field(ma$1("DocumentSnapshot.get", t));
     ...
     * Helper that calls fromDotSeparatedString() but wraps any error thrown.
     */ function ma$1(t, e) {
        return "string" == typeof e ? la(t, e) : e instanceof Mu ? e._internalPath : e._delegate._internalPath;
    }
     ...
     */ class ya extends wa$1 {
         ...
         */    data(t = {}) {
            if (this._document) {
                if (this._converter) {
                    // We only want to use the converter and create a new DocumentSnapshot
                    // if a converter has been provided.
                    const e = new pa$1(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                    /* converter= */ null);
        ...
        get(t, e = {}) {
            if (this._document) {
                const n = this._document.data.field(ma$1("DocumentSnapshot.get", t));
     ...
     */ class Ea$1 {
        /** @hideconstructor */
        constructor(t, e, n, s) {
            this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new ga(s.hasPendingWrites, s.fromCache), 
            this.query = n;
        }
         ...
         */    forEach(t, e) {
            this._snapshot.docs.forEach((n => {
                t.call(e, new pa$1(this._firestore, this._userDataWriter, n.key, n, new ga(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query._converter));
            }));
        }
        /**
         ...
         */    docChanges(t = {}) {
            ...
            if (e && this._snapshot.excludesMetadataChanges) throw new P$1(R$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
            ...
            function(t, e) {
                if (t._snapshot.oldDocs.isEmpty()) {
                    ...
                    return t._snapshot.docChanges.map((s => {
                        const i = new pa$1(t._firestore, t._userDataWriter, s.doc.key, s.doc, new ga(t._snapshot.mutatedKeys.has(s.doc.key), t._snapshot.fromCache), t.query._converter);
                        return e = s.doc, {
                            type: "added",
                            doc: i,
                            oldIndex: -1,
                ...
                }
                {
                    ...
                    return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                        const s = new pa$1(t._firestore, t._userDataWriter, e.doc.key, e.doc, new ga(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query._converter);
                        let i = -1, r = -1;
     ...
     */ function Ia$1(t, e) {
        return t instanceof ya && e instanceof ya ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Ea$1 && e instanceof Ea$1 && (t._firestore === e._firestore && mu(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot));
    }
     ...
     * limitations under the License.
     */ function Aa$1(t) {
        if (Yt(t) && 0 === t.explicitOrderBy.length) throw new P$1(R$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
    ...
    class ba$1 extends Ra$1 {
        constructor(t, e, n) {
            super(), this.Kc = t, this.Qc = e, this.jc = n, this.type = "where";
        }
        _apply(t) {
            const e = zu(t.firestore), n = function(t, e, n, s, i, r, o) {
                let c;
                if (i.isKeyField()) {
                    if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
                    if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                        qa$1(o, r);
                        const e = [];
                        for (const n of o) e.push(Ba$1(s, t, n));
                        c = {
                            arrayValue: {
                                values: e
                            }
                ...
                } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || qa$1(o, r), 
                c = ia(n, e, o, 
                ...
                return function(t, e) {
                    if (e.g()) {
                        const n = Zt(t);
                        if (null !== n && !n.isEqual(e.field)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                        const s = Xt(t);
                        null !== s && Ua$1(t, e.field, s);
                    }
                    const n = function(t, e) {
     ...
     */
                    ...
                    throw n === e.op ? new P$1(R$1.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new P$1(R$1.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
                }(t, u), u;
            }(t._query, "where", e, t.firestore._databaseId, this.Kc, this.Qc, this.jc);
            return new hu(t.firestore, t._converter, function(t, e) {
     ...
     * @returns The created `Query`.
     */ function va$1(t, e, n) {
        const s = e, i = ma$1("where", t);
        return new ba$1(i, s, n);
    }

    class Va$1 extends Ra$1 {
        constructor(t, e) {
            super(), this.Kc = t, this.Wc = e, this.type = "orderBy";
        }
        _apply(t) {
            const e = function(t, e, n) {
                if (null !== t.startAt) throw new P$1(R$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
                if (null !== t.endAt) throw new P$1(R$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
                const s = new Kt(e, n);
                return function(t, e) {
                    if (null === Xt(t)) {
                        // This is the first order by. It must match any inequality.
                        const n = Zt(t);
                        null !== n && Ua$1(t, n, e.field);
                    }
                }(t, s), s;
            }
            /**
     ...
     * @returns The created `Query`.
     */ function Sa$1(t, e = "asc") {
        const n = e, s = ma$1("orderBy", t);
        return new Va$1(s, n);
    }

    class Da$1 extends Ra$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Gc = e, this.zc = n;
        }
        _apply(t) {
            return new hu(t.firestore, t._converter, se(t._query, this.Gc, this.zc));
        }
    }
     ...
     * @returns The created `Query`.
     */ function Ca$1(t) {
        return ru("limit", t), new Da$1("limit", t, "F" /* First */);
    }
     ...
     * @returns The created `Query`.
     */ function Na$1(t) {
        return ru("limitToLast", t), new Da$1("limitToLast", t, "L" /* Last */);
    }

    class xa extends Ra$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Hc = e, this.Jc = n;
        }
        _apply(t) {
            const e = La$1(t, this.type, this.Hc, this.Jc);
            return new hu(t.firestore, t._converter, function(t, e) {
    ...
    function ka$1(...t) {
        return new xa("startAt", t, /*before=*/ !0);
    }

    function Oa$1(...t) {
        return new xa("startAfter", t, 
        /*before=*/ !1);
    }

    class $a$1 extends Ra$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Hc = e, this.Jc = n;
        }
        _apply(t) {
    ...
    function Ma$1(...t) {
        return new $a$1("endBefore", t, /*before=*/ !0);
    }

    function Fa$1(...t) {
        return new $a$1("endAt", t, /*before=*/ !1);
    }

    /** Helper function to create a bound from a document or fields */ function La$1(t, e, n, s) {
        if (n[0] = getModularInstance(n[0]), n[0] instanceof wa$1) return function(t, e, n, s, i) {
            if (!s) throw new P$1(R$1.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n}().`);
            const r = [];
            ...
            // results.
                    for (const n of ee(t)) if (n.field.isKeyField()) r.push(mt(e, s.key)); else {
                const t = s.data.field(n.field);
                if (nt(t)) throw new P$1(R$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === t) {
                    const t = n.field.canonicalString();
                    throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
                }
                r.push(t);
            }
            return new qt(r, i);
     ...
     */ (t._query, t.firestore._databaseId, e, n[0]._document, s);
        {
            const i = zu(t.firestore);
            return function(t, e, n, s, i, r) {
                // Use explicit order by's because it has to match the query the user made
                const o = t.explicitOrderBy;
                if (i.length > o.length) throw new P$1(R$1.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
                const c = [];
                for (let r = 0; r < i.length; r++) {
                    const u = i[r];
                    if (o[r].field.isKeyField()) {
                        if ("string" != typeof u) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof u}`);
                        if (!te(t) && -1 !== u.indexOf("/")) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                        const n = t.path.child(G$1.fromString(u));
                        if (!ut.isDocumentKey(n)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                        const i = new ut(n);
                        c.push(mt(e, i));
                    } else {
                        const t = ia(n, s, u);
    ...
    function Ba$1(t, e, n) {
        if ("string" == typeof (n = getModularInstance(n))) {
            if ("" === n) throw new P$1(R$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!te(e) && -1 !== n.indexOf("/")) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
            const s = e.path.child(G$1.fromString(n));
            if (!ut.isDocumentKey(s)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
            return mt(t, new ut(s));
        }
        if (n instanceof au) return mt(t, n._key);
        throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${su(n)}.`);
    }
     ...
     * array requirements.
     */ function qa$1(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
        if (t.length > 10) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
    }

    function Ua$1(t, e, n) {
        if (!n.isEqual(e)) throw new P$1(R$1.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
    }
     ...
     */ class Ka$1 {
        ...
        convertObject(t, e) {
            const n = {};
            return Q$1(t.fields || {}, ((t, s) => {
                n[t] = this.convertValue(s, e);
            })), n;
        }
        convertGeoPoint(t) {
            return new qu(tt(t.latitude), tt(t.longitude));
        }
        convertArray(t, e) {
        ...
        convertDocumentKey(t, e) {
            const n = G$1.fromString(t);
            k$1(es(n));
            const s = new Gc$1(n.get(1), n.get(3)), i = new ut(n.popFirst(5));
            return s.isEqual(e) || 
            // TODO(b/64130202): Somehow support foreign references.
            D$1(`Document ${i} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`), 
            i;
        }
    }
     ...
     */ class Wa$1 {
        ...
        constructor(t, e) {
            ...
            this._dataReader = zu(t);
        }
        set(t, e, n) {
            this._verifyNotCommitted();
            const s = Ga$1(t, this._firestore), i = Qa$1(s._converter, e, n), r = Hu(this._dataReader, "WriteBatch.set", s._key, i, null !== s._converter, n);
            return this._mutations.push(r.toMutation(s._key, Ve.none())), this;
        }
        update(t, e, n, ...s) {
            this._verifyNotCommitted();
            const i = Ga$1(t, this._firestore);
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    let r;
            return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Mu ? sa$1(this._dataReader, "WriteBatch.update", i._key, e, n, s) : na$1(this._dataReader, "WriteBatch.update", i._key, e), 
         ...
         */    delete(t) {
            this._verifyNotCommitted();
            const e = Ga$1(t, this._firestore);
        ...
        _verifyNotCommitted() {
            if (this._committed) throw new P$1(R$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
        }
    }

    function Ga$1(t, e) {
        if ((t = getModularInstance(t)).firestore !== e) throw new P$1(R$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return t;
    }
    ...
    function za$1(t) {
        t = iu(t, au);
        const e = iu(t.firestore, Tu);
        return Lc$1(Ru(e), t._key).then((n => uh(e, t, n)));
    }
     ...
     */ function Ja$1(t) {
        t = iu(t, au);
        const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha$1(e);
        return Fc$1(n, t._key).then((n => new ya(e, s, t._key, n, new ga(null !== n && n.hasLocalMutations, 
     ...
     */ function Xa$1(t) {
        t = iu(t, hu);
        const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha$1(e);
        return Aa$1(t._query), qc$1(n, t._query).then((n => new Ea$1(e, s, t, n)));
    }
     ...
     */ function Za$1(t) {
        t = iu(t, hu);
        const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha$1(e);
        return Bc$1(n, t._query).then((n => new Ea$1(e, s, t, n)));
    }
     ...
     */ function th(t) {
        t = iu(t, hu);
        const e = iu(t.firestore, Tu), n = Ru(e), s = new Ha$1(e);
        return qc$1(n, t._query, {
            source: "server"
        }).then((n => new Ea$1(e, s, t, n)));
    }

    function eh(t, e, n) {
        t = iu(t, au);
        const s = iu(t.firestore, Tu), i = Qa$1(t._converter, e, n);
        return ch(s, [ Hu(zu(s), "setDoc", t._key, i, null !== t._converter, n).toMutation(t._key, Ve.none()) ]);
    }

    function nh(t, e, n, ...s) {
        t = iu(t, au);
        const i = iu(t.firestore, Tu), r = zu(i);
        let o;
        o = "string" == typeof (
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        e = getModularInstance(e)) || e instanceof Mu ? sa$1(r, "updateDoc", t._key, e, n, s) : na$1(r, "updateDoc", t._key, e);
        return ch(i, [ o.toMutation(t._key, Ve.exists(!0)) ]);
    }
     ...
     */ function sh(t) {
        return ch(iu(t.firestore, Tu), [ new qe(t._key, Ve.none()) ]);
    }
     ...
     */ function ih(t, e) {
        const n = iu(t.firestore, Tu), s = wu(t), i = Qa$1(t._converter, e);
        return ch(n, [ Hu(zu(t.firestore), "addDoc", s._key, i, null !== t._converter, {}).toMutation(s._key, Ve.exists(!1)) ]).then((() => s));
    }
    ...
    function rh(t, ...e) {
        ...
        let u, a, h;
        if (t instanceof au) a = iu(t.firestore, Tu), h = Ht(t._key.path), u = {
            next: n => {
                e[o] && e[o](uh(a, t, n));
            },
            error: e[o + 1],
            ...
            const n = iu(t, hu);
            a = iu(n.firestore, Tu), h = n._query;
            const s = new Ha$1(a);
            u = {
                next: t => {
                    e[o] && e[o](new Ea$1(a, s, n, t));
                },
                error: e[o + 1],
                complete: e[o + 2]
            }, Aa$1(t._query);
        ...
        return function(t, e, n, s) {
            const i = new Ic$1(s), r = new Vo(e, i, n);
            return t.asyncQueue.enqueueAndForget((async () => Ao(await Oc$1(t), r))), () => {
                i.Wo(), t.asyncQueue.enqueueAndForget((async () => Ro(await Oc$1(t), r)));
            };
        }(Ru(a), h, c, u);
    }

    function oh(t, e) {
        return Uc$1(Ru(t = iu(t, Tu)), yu(e) ? e : {
            next: e
        });
    }
     ...
     */ function ch(t, e) {
        return function(t, e) {
            const n = new Ps;
            return t.asyncQueue.enqueueAndForget((async () => Uo(await kc$1(t), e, n))), n.promise;
        }(Ru(t), e);
    }
     ...
     */ function uh(t, e, n) {
        const s = n.docs.get(e._key), i = new Ha$1(t);
        return new ya(t, i, e._key, s, new ga(n.hasPendingWrites, n.fromCache), e._converter);
    }
     ...
     */ class ah extends class {
        /** @hideconstructor */
        constructor(t, e) {
            this._firestore = t, this._transaction = e, this._dataReader = zu(t);
        }
        /**
         ...
         */    get(t) {
            const e = Ga$1(t, this._firestore), n = new ja$1(this._firestore);
            return this._transaction.lookup([ e._key ]).then((t => {
                if (!t || 1 !== t.length) return x$1();
                const s = t[0];
                if (s.isFoundDocument()) return new wa$1(this._firestore, n, s.key, s, e._converter);
                if (s.isNoDocument()) return new wa$1(this._firestore, n, e._key, null, e._converter);
                throw x$1();
            }));
        }
        set(t, e, n) {
            const s = Ga$1(t, this._firestore), i = Qa$1(s._converter, e, n), r = Hu(this._dataReader, "Transaction.set", s._key, i, null !== s._converter, n);
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let r;
            return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Mu ? sa$1(this._dataReader, "Transaction.update", i._key, e, n, s) : na$1(this._dataReader, "Transaction.update", i._key, e), 
         ...
         * @returns A `DocumentSnapshot` with the read data.
         */    get(t) {
            const e = Ga$1(t, this._firestore), n = new Ha$1(this._firestore);
            return super.get(t).then((t => new ya(this._firestore, n, e._key, t._document, new ga(
            /* hasPendingWrites= */ !1, 
     ...
     */ function hh(t, e) {
        return Kc$1(Ru(t), (n => e(new ah(t, n))));
    }
     ...
     * writes.
     */ function mh(t) {
        return Ru(t = iu(t, Tu)), new Wa$1(t, (e => ch(t, e)));
    }
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ app._registerComponent(new Component("firestore-exp", ((t, {options: e}) => {
        const n = t.getProvider("app-exp").getImmediate(), s = new Tu(n, t.getProvider("auth-internal"));
        return e && s._setSettings(e), s;
    }), "PUBLIC" /* PUBLIC */)), app.registerVersion("firestore-exp", "0.0.900", "node");

    exports.AbstractUserDataWriter = Ka$1;
    exports.Bytes = Lu;
    exports.CACHE_SIZE_UNLIMITED = Eu;
    exports.CollectionReference = lu;
    exports.DocumentReference = au;
    exports.DocumentSnapshot = ya;
    exports.FieldPath = Mu;
    exports.FieldValue = Bu;
    exports.FirebaseFirestore = Tu;
    exports.FirestoreError = P$1;
    exports.GeoPoint = qu;
    exports.LoadBundleTask = pu;
    exports.Query = hu;
    exports.QueryConstraint = Ra$1;
    exports.QueryDocumentSnapshot = pa$1;
    exports.QuerySnapshot = Ea$1;
    exports.SnapshotMetadata = ga;
    exports.Timestamp = q$1;
    exports.Transaction = ah;
    exports.WriteBatch = Wa$1;
    exports.addDoc = ih;
    exports.arrayRemove = wh;
    exports.arrayUnion = dh;
    exports.clearIndexedDbPersistence = Su;
    exports.collection = fu;
    exports.collectionGroup = du;
    exports.deleteDoc = sh;
    exports.deleteField = lh;
    exports.disableNetwork = Nu;
    exports.doc = wu;
    exports.documentId = Fu;
    exports.enableIndexedDbPersistence = bu;
    exports.enableMultiTabIndexedDbPersistence = vu;
    exports.enableNetwork = Cu;
    exports.endAt = Fa$1;
    exports.endBefore = Ma$1;
    exports.ensureFirestoreConfigured = Ru;
    exports.executeWrite = ch;
    exports.getDoc = za$1;
    exports.getDocFromCache = Ja$1;
    exports.getDocFromServer = Ya$1;
    exports.getDocs = Xa$1;
    exports.getDocsFromCache = Za$1;
    exports.getDocsFromServer = th;
    exports.getFirestore = Au;
    exports.increment = _h;
    exports.initializeFirestore = Iu;
    exports.limit = Ca$1;
    exports.limitToLast = Na$1;
    exports.loadBundle = ku;
    exports.namedQuery = Ou;
    exports.onSnapshot = rh;
    exports.onSnapshotsInSync = oh;
    exports.orderBy = Sa$1;
    exports.query = Pa$1;
    exports.queryEqual = mu;
    exports.refEqual = _u;
    exports.runTransaction = hh;
    exports.serverTimestamp = fh;
    exports.setDoc = eh;
    exports.setLogLevel = V$1;
    exports.snapshotEqual = Ia$1;
    exports.startAfter = Oa$1;
    exports.startAt = ka$1;
    exports.terminate = xu;
    exports.updateDoc = nh;
    exports.useFirestoreEmulator = uu;
    exports.waitForPendingWrites = Du;
    exports.where = va$1;
    exports.writeBatch = mh;
