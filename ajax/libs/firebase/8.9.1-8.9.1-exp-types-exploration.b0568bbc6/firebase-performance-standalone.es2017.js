...
/**
     ...
     * limitations under the License.
     */
function S(e){const n={},r=new Map,i={__esModule:!0,initializeApp:function(t,r={}){if("object"!=typeof r||null===r){r={name:r}}const s=r;void 0===s.name&&(s.name=I);const{name:a}=s;if("string"!=typeof a||!a)throw v.create("bad-app-name",{appName:String(a)});if(o(n,a))throw v.create("duplicate-app",{appName:a});const c=new e(t,s,i);return n[a]=c,c},app:a,registerVersion:function(t,e,n){var r;let i=null!==(r=w[t])&&void 0!==r?r:t;n&&(i+=`-${n}`);const o=i.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const t=[`Unable to register library "${i}" with version "${e}":`];return o&&t.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&a&&t.push("and"),a&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void E.warn(t.join(" "))}c(new s(`${i}-version`,(()=>({library:i,version:e})),"VERSION"))},setLogLevel:b,onLog:function(t,e){if(null!==t&&"function"!=typeof t)throw v.create("invalid-log-argument");!function(t,e){for(const n of l){let r=null;e&&e.level&&(r=f[e.level]),n.userLogHandler=null===t?null:(e,n,...i)=>{const o=i.map((t=>{if(null==t)return null;if("string"==typeof t)return t;if("number"==typeof t||"boolean"==typeof t)return t.toString();if(t instanceof Error)return t.message;try{return JSON.stringify(t)}catch(t){return null}})).filter((t=>t)).join(" ");n>=(null!=r?r:e.logLevel)&&t({level:p[n].toLowerCase(),message:o,args:i,type:e.name})}}}(t,e)},apps:null,SDK_VERSION:"8.9.1-8.9.1-exp-types-exploration.b0568bbc6",INTERNAL:{registerComponent:c,removeApp:function(t){delete n[t]},components:r,useAsService:function(t,e){if("serverAuth"===e)return null;return e}}};function a(t){if(!o(n,t=t||I))throw v.create("no-app",{appName:t});return n[t]}function c(o){const s=o.name;if(r.has(s))return E.debug(`There were multiple attempts to register component ${s}.`),"PUBLIC"===o.type?i[s]:null;if(r.set(s,o),"PUBLIC"===o.type){const n=(t=a())=>{if("function"!=typeof t[s])throw v.create("invalid-app-argument",{appName:s});return t[s]()};void 0!==o.serviceProps&&t(n,o.serviceProps),i[s]=n,e.prototype[s]=function(...t){return this._getService.bind(this,s).apply(this,o.multipleInstances?t:[])}}for(const t of Object.keys(n))n[t]._addComponent(o);return"PUBLIC"===o.type?i[s]:null}return i.default=i,Object.defineProperty(i,"apps",{get:function(){return Object.keys(n).map((t=>n[t]))}}),a.App=e,i}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return A.registerVersion("firebase","8.9.1-8.9.1-exp-types-exploration.b0568bbc6","lite"),A}));
