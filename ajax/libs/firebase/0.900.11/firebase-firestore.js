(function (global, factory) {
    ...
    */
     ...
     */ function D$1(t = "Unexpected state") {
        ...
        const e = "FIRESTORE (8.2.4) INTERNAL ASSERTION FAILED: " + t;
    ...
    /** An error returned by a Firestore operation. */ class O$1 extends Error {
        /** @hideconstructor */
        constructor(t, e) {
     ...
     */ class U$1 {
        constructor(t, e) {
            this.previousValue = t, e && (e.D = t => this.C(t), this.N = t => e.O(t));
        }
        C(t) {
    ...
    class z$1 {
         ...
         */
        constructor(t, e) {
            if (this.seconds = t, this.nanoseconds = e, e < 0) throw new O$1(x$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (e >= 1e9) throw new O$1(x$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
            if (t < -62135596800) throw new O$1(x$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
            // This will break in the year 10,000.
                    if (t >= 253402300800) throw new O$1(x$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        }
        /**
     ...
     */ class Y$1 extends J$1 {
         ...
         */    static nt(...t) {
            ...
            const e = [];
            for (const n of t) {
                if (n.indexOf("//") >= 0) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
    ...
    /** A dot-separated path for navigating sub-objects within a document. */ class Z$1 extends J$1 {
         ...
         */    static ct(t) {
            ...
            let n = "", s = 0;
            const i = () => {
                if (0 === n.length) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
                e.push(n), n = "";
            };
            let r = !1;
            for (;s < t.length; ) {
                const e = t[s];
                if ("\\" === e) {
                    if (s + 1 === t.length) throw new O$1(x$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                    const e = t[s + 1];
                    if ("\\" !== e && "." !== e && "`" !== e) throw new O$1(x$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                    n += e, s += 2;
                } else "`" === e ? (r = !r, s++) : "." !== e || r ? (n += e, s++) : (i(), s++);
            }
            if (i(), r) throw new O$1(x$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
            return new Z$1(e);
        }
        static st() {
            return new Z$1([]);
    ...
    class Ot extends Nt {
        ...
        isEqual(t) {
            return t instanceof Ot && t.hasCommittedMutations === this.hasCommittedMutations && t.version.isEqual(this.version) && t.key.isEqual(this.key);
        }
    }
     ...
     */ class kt extends Nt {
        ...
        isEqual(t) {
            return t instanceof kt && t.version.isEqual(this.version) && t.key.isEqual(this.key);
        }
    }
     ...
     */ class Re {
         ...
         */ , o = rt.Et) {
            this.target = t, this.targetId = e, this.Ot = n, this.sequenceNumber = s, this.kt = i, 
            this.lastLimboFreeSnapshotVersion = r, this.resumeToken = o;
        }
        /** Creates a new target data instance with an updated sequence number. */    Mt(t) {
            return new Re(this.target, this.targetId, this.Ot, t, this.kt, this.lastLimboFreeSnapshotVersion, this.resumeToken);
        }
        /**
         * Creates a new target data instance with an updated resume token and
         * snapshot version.
         */    Ft(t, e) {
            return new Re(this.target, this.targetId, this.Ot, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
        }
        /**
         * Creates a new target data instance with an updated last limbo free
         * snapshot version number.
         */    $t(t) {
            return new Re(this.target, this.targetId, this.Ot, this.sequenceNumber, this.kt, t, this.resumeToken);
        }
    }
     ...
     */ function ve(t, e) {
        return t instanceof Oe ? gt(n = e) || function(t) {
    ...
    function $e(t, e) {
        return t.field.isEqual(e.field) && function(t, e) {
            return t instanceof De && e instanceof De || t instanceof Ne && e instanceof Ne ? j(t.elements, e.elements, Tt) : t instanceof Oe && e instanceof Oe ? Tt(t.qt, e.qt) : t instanceof Se && e instanceof Se;
     ...
     */ function Qe(t, e, n, s) {
        return t instanceof ze ? function(t, e, n, s) {
            ...
            let i = t.value;
            const r = Xe(t.fieldTransforms, n, e);
     ...
     *    ignored.
     */ (t, e, s) : t instanceof He ? function(t, e, n, s) {
            if (!qe(t.Wt, e)) return e;
            const i = Ge(e), r = Xe(t.fieldTransforms, n, e), o = Je(t, e, r);
     ...
     */ function Xe(t, e, n, s) {
        ...
        for (const s of t) {
            const t = s.transform;
            let r = null;
            n instanceof xt && (r = n.field(s.field)), i.push(pe(t, r, e));
        }
        return i;
    }
     ...
     */ class pn {
         ...
         */
        i) {
            this.kt = t, this.xe = e, this.Oe = n, this.ke = s, this.Me = i;
        }
        /**
        ...
        static Fe(t, e) {
            const n = new Map;
            return n.set(t, bn.$e(t, e)), new pn(H$1.min(), n, Pn(), dn(), An());
        }
    }
     ...
     */ class bn {
         ...
         */    static $e(t, e) {
            return new bn(rt.Et, e, An(), An(), An());
        }
    }
    ...
    class Nn {
         ...
         */    fn(t) {
            for (const e of t.Ke) t.Qe instanceof xt ? this.dn(e, t.Qe) : t.Qe instanceof Ot && this.wn(e, t.key, t.Qe);
         ...
         */    gn(t) {
            ...
            this.an.forEach(((n, s) => {
                ...
                if (i) {
                    if (n.Le && qt(i.target)) {
                        ...
                        null !== this.hn.get(e) || this.yn(s, e) || this.wn(s, e, new Ot(e, t));
                    }
            ...
            // client.
                ...
                e.me((t => {
                    const e = this.Pn(t);
                    return !e || 2 /* LimboResolution */ === e.Ot || (s = !1, !1);
                })), s && (n = n.add(t));
            }));
         ...
         */    Vn(t) {
            ...
            return this.un.bn(t).size + e.Be.size - e.Ue.size;
        }
        /**
         ...
         */    Pn(t) {
            ...
            return e && e.Ye ? null : this.un.vn(t);
        }
        /**
    ...
    function Wn(t, e) {
        const n = Kn(e);
        if (n.get(1) !== t.p.projectId) throw new O$1(x$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.p.projectId);
        if (n.get(3) !== t.p.database) throw new O$1(x$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.p.database);
        return new tt(Hn(n));
    }
     ...
     */ (o);
            ...
            n = new vn(u, a, c.key, c);
        } else if ("documentDelete" in e) {
            e.documentDelete;
            const s = e.documentDelete;
            s.document;
            const i = Wn(t, s.document), r = s.readTime ? qn(s.readTime) : H$1.min(), o = new Ot(i, r), c = s.removedTargetIds || [];
            n = new vn([], c, o.key, o);
    ...
    function ts(t, e) {
        const n = e.currentDocument ? function(t) {
            ...
            if ("setToServerValue" in e) C("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
                ...
                n = new Ne(t);
            } else "increment" in e ? n = new Oe(t, e.increment) : D$1();
     ...
     */ class Is {
        ...
        next(t, e) {
            return this.Nn && D$1(), this.Nn = !0, this.Cn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new Is(((n, s) => {
                this.Sn = e => {
     ...
     */ class As {
        ...
        constructor(t, e, n) {
            ...
            // log on 12.2.
            12.2 === As.Un(getUA()) && b("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
        }
        /** Deletes the specified database. */    static delete(t) {
            return p$1("SimpleDb", "Removing database:", t), ys(window.indexedDB.deleteDatabase(t)).kn();
        }
        /** Returns true if IndexedDB is available in the current environment. */    static Kn() {
            ...
            // Check the UA string to find out the browser.
                    const t = getUA(), e = As.Un(t), n = 0 < e && e < 10, s = As.Wn(t), i = 0 < s && s < 4.5;
            // IE 10
         ...
         */    async zn(t) {
            return this.db || (p$1("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
                ...
                s.onsuccess = t => {
                    ...
                    "VersionError" === s.name ? n(new O$1(x$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Ps(t, s));
                }, s.onupgradeneeded = t => {
    ...
    /** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ps extends O$1 {
        constructor(t, e) {
    ...
    function bs(t) {
        ...
        if (e >= 12.2 && e < 13) {
            ...
            if (t.message.indexOf(e) >= 0) {
                ...
                const t = new O$1("internal", `IOS_INDEXEDDB_BUG1: IndexedDb has thrown '${e}'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.`);
                return ps || (ps = !0, 
    ...
    class vs {
         ...
         */    cancel(t) {
            null !== this.Ts && (this.clearTimeout(), this.ws.reject(new O$1(x$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
        }
        Is() {
     ...
     */ function Ss(t, e) {
        if (b("AsyncQueue", `${e}: ${t}`), Vs(t)) return new O$1(x$1.UNAVAILABLE, `${e}: ${t}`);
        throw t;
    }
    ...
    function Ns(t) {
        let e = "";
        for (let n = 0; n < t.length; n++) e.length > 0 && (e = Os(e)), e = xs(t.get(n), e);
        return Os(e);
    }
     ...
     */ class ei {
         ...
         */    Ds(t, e) {
            ...
            for (const n of this.baseMutations) n.key.isEqual(t) && (e = Qe(n, e, 0, this.bs));
            // Second, apply all user-provided mutations.
            for (const n of this.mutations) n.key.isEqual(t) && (e = Qe(n, e, 0, this.bs));
            return e;
        }
        /**
    ...
    /** Decodes a remote document from storage locally to a Document. */ function ii(t, e) {
        ...
        }(t.Os, e.document, !!e.hasCommittedMutations);
        if (e.noDocument) {
    ...
    /** Encodes a document for storage locally. */ function ri(t, e, n) {
        ...
        if (e instanceof xt) {
            ...
            }(t.Os, e), r = e.hasCommittedMutations;
            return new Ks(
    ...
    function hi(t, e) {
        const n = (e.baseMutations || []).map((e => ts(t.Os, e)));
        ...
        const s = e.mutations.map((e => ts(t.Os, e))), i = z$1.fromMillis(e.localWriteTimeMs);
    ...
    /** Encodes TargetData into a DbTarget for storage locally. */ function _i(t, e) {
        const n = ui(e.kt), s = ui(e.lastLimboFreeSnapshotVersion);
        let i;
        i = qt(e.target) ? ns(t.Os, e.target) : ss(t.Os, e.target);
     ...
     * limitations under the License.
     */
    /** A mutation queue for a specific user, backed by IndexedDB. */ class vi {
        constructor(
        /**
        ...
        Ai(t, e, n, s) {
            ...
            return r.add({}).next((o => {
                ...
                const c = new ei(o, e, n, s), u = function(t, e, n) {
                    const s = n.baseMutations.map((e => Zn(t.Os, e))), i = n.mutations.map((e => Zn(t.Os, e)));
                    return new Ls(e, n.batchId, n.bs.toMillis(), s, i);
     ...
     */ class Oi {
        ...
        Hi(t, e) {
            return this.Ji(t, e.targetId).next((() => ki(t).delete(e.targetId))).next((() => this.Bi(t))).next((e => (C(e.targetCount > 0), 
        ...
        // PORTING NOTE: Multi-tab only.
        vn(t, e) {
            return ki(t).get(e).next((t => t ? li(t) : null));
        }
    }
    ...
    /** Implements the steps for LRU garbage collection. */ class qi {
        ...
        Rr(t, e) {
            if (0 === e) return Is.resolve(U$1.k);
            const n = new Li(e);
     ...
     */ class Qi {
         ...
         */    Br(t, e) {
            ...
            return this.Lr(t, e, ((t, e) => {
                const i = this.Fr(e);
                i ? (n = n.Gt(t, i), s = s.Gt(t, bi(e))) : (n = n.Gt(t, null), s = s.Gt(t, 0));
            })).next((() => ({
                qr: n,
                Ur: s
            })));
         ...
         */    Fr(t) {
            if (t) {
                ...
                return e instanceof Ot && e.version.isEqual(H$1.min()) ? null : e;
            }
            return null;
        }
    }
        ...
        di(t) {
            ...
            return this.ii.forEach(((i, r) => {
                ...
                if (r.ai) {
                    ...
                    const n = ri(this.Wr.Ut, new Ot(i, H$1.min()), this.oi(i));
    ...
    class Xi {
        ...
        a) {
            ...
            this.uo = t => Promise.resolve(), !Xi.Kn()) throw new O$1(x$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
            this.Ei = new Ui(this, s), this.ao = e + "main", this.Ut = new si(c), this.ho = new As(this.ao, 11, new Hi(this.Ut)), 
            this.lo = new Oi(this.Ei, this.Ut), this.wi = new mi, this._o = function(t, e) {
                return new Qi(t, e);
            }
            /**
     ...
     */
         ...
         */    start() {
            ...
            return this.Eo().then((() => {
                ...
                throw new O$1(x$1.FAILED_PRECONDITION, Yi);
         ...
         */    async Co() {
            if (this.isPrimary && !this.No(this.co, 18e5)) {
                ...
                // entries first to avoid potentially reviving a zombied client.
                            if (this.wo) for (const e of t) this.wo.removeItem(this.Oo(e.clientId));
            }
        }
        /**
         ...
         */    po(t) {
            ...
            return Zi(t).get(Fs.key).next((e => {
                ...
                if (null !== e && this.No(e.leaseTimestampMs, 5e3) && !this.ko(e.ownerId)) {
         ...
         * provided threshold.
         */    xo(t, e) {
            return t.filter((t => this.No(t.updateTimeMs, e) && !this.ko(t.clientId)));
        }
        /**
        ...
        Uo(t) {
            return vi.Ii(t, this.Ut, this.wi, this.Ei);
        }
        vr() {
            return this.lo;
        }
        ...
        runTransaction(t, e, n) {
            ...
            // are the only reader/writer.
                    return this.ho.runTransaction(t, s, Xs, (s => (i = new Zs(s, this.no ? this.no.next() : U$1.k), 
            "readwrite-primary" === e ? this.Vo(i).next((t => !!t || this.po(i))).next((e => {
                ...
                this.Xr.yo((() => this.uo(!1))), new O$1(x$1.FAILED_PRECONDITION, Ds);
                return n(i);
        ...
        Wo(t) {
            return Zi(t).get(Fs.key).next((t => {
                if (null !== t && this.No(t.leaseTimestampMs, 5e3) && !this.ko(t.ownerId) && !this.So(t) && !(this.eo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new O$1(x$1.FAILED_PRECONDITION, Yi);
            }));
        }
        /**
         ...
         */    ko(t) {
            var e;
            try {
                const n = null !== (null === (e = this.wo) || void 0 === e ? void 0 : e.getItem(this.Oo(t)));
         ...
         */    Fo() {
            if (this.wo) try {
                this.wo.setItem(this.Oo(this.clientId), String(Date.now()));
            } catch (t) {
        ...
        /** Removes the zombied client entry if it exists. */    Bo() {
            if (this.wo) try {
                this.wo.removeItem(this.Oo(this.clientId));
            } catch (t) {
                // Ignore
            }
        }
    ...
    class nr {
         ...
         */    Yo(t, e) {
            return this.jo.bi(t, e).next((n => {
                const s = this.Ho(t, e, n);
                let i = dn();
                return s.forEach(((t, e) => {
                    // TODO(http://b/32275378): Don't conflate missing / deleted.
                    e || (e = new Ot(t, H$1.min())), i = i.Gt(t, e);
                })), i;
            }));
        }
        /**
        ...
        tc(t, e, n) {
            ...
            this.ec(t, i, s).next((t => {
                ...
                for (const t of i) for (const e of t.mutations) {
                    const n = e.key, i = s.get(n), r = Qe(e, i, 0, t.bs);
    ...
    class rr {
        ...
        t, e, n, s) {
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
            this.fc = H$1.min(), this.jo = t.Uo(n), this.dc = t.Nr(), this.lo = t.vr(), this.wc = new nr(this.dc, this.jo, this.persistence.Ko()), 
     ...
     */ (c, a, e) && o.push(n.lo.zi(t, a));
            ...
            // limbo.
            if (e.ke.forEach(((s, i) => {
                e.Me.has(s) && o.push(n.persistence.Ei.Or(t, s));
            })), 
            ...
            i) {
                ...
                return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
                    ...
                    return n.forEach(((n, o) => {
                        ...
                        // cache.
                        o instanceof Ot && o.version.isEqual(H$1.min()) ? (
    ...
    function _r(t, e) {
        ...
        return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
            ...
            return (null === s || t.kt.L(s.kt) > 0) && (n.lc = n.lc.Gt(t.targetId, t), n._c.set(e, t.targetId)), 
            t;
        }));
    }
     ...
     */ function dr(t, e, n) {
        ...
        })).next((() => s.hc.Kr(t, e, n ? i : H$1.min(), n ? r : An()))).next((t => ({
            documents: t,
            mc: r
        })))));
    }
     ...
     */
        // PORTING NOTE: This is only used for multi-tab synchronization.
        (e.dc, t, e.fc))).then((({Ac: t, readTime: n}) => (e.fc = n, t)));
    }
     ...
     */ class mr {
        constructor() {
            ...
            this.Vc = new ln(Ar.gc), 
            // A set of outstanding references to a document sorted by target id.
            this.yc = new ln(Ar.bc);
        }
        ...
        /** Add references to the given document keys for the given ID. */    vc(t, e) {
         ...
         * removed.
         */    Cc(t) {
            const e = new tt(new Y$1([])), n = new Ar(e, t), s = new Ar(e, t + 1), i = [];
        ...
        xc(t) {
            const e = new tt(new Y$1([])), n = new Ar(e, t), s = new Ar(e, t + 1);
            let i = An();
            return this.yc.Ie([ n, s ], (t => {
                i = i.add(t.key);
            })), i;
        ...
        Oi(t) {
            const e = new Ar(t, 0), n = this.Vc.Ae(e);
    ...
    class Ar {
        ...
        /** Compare by key then by ID */    static gc(t, e) {
            return tt.K(t.key, e.key) || W$1(t.Oc, e.Oc);
        }
        /** Compare by ID then by key */    static bc(t, e) {
            return W$1(t.Oc, e.Oc) || tt.K(t.key, e.key);
        }
    }
     ...
     */ class Rr {
        ...
        Ai(t, e, n, s) {
            const i = this.kc;
            if (this.kc++, this.jo.length > 0) {
                this.jo[this.jo.length - 1];
            }
            const r = new ei(i, e, n, s);
            this.jo.push(r);
            // Track references by document key and index collection parents.
            for (const e of s) this.Mc = this.Mc.add(new Ar(e.key, i)), this.wi.Bs(t, e.key.path.G());
            return Is.resolve(r);
        }
        Ri(t, e) {
        ...
        gi() {
            return Is.resolve(0 === this.jo.length ? -1 : this.kc - 1);
        }
        yi(t) {
            return Is.resolve(this.jo.slice());
        }
        pi(t, e) {
            const n = new Ar(e, 0), s = new Ar(e, Number.POSITIVE_INFINITY), i = [];
            return this.Mc.Ie([ n, s ], (t => {
                const e = this.Fc(t.Oc);
                i.push(e);
            })), Is.resolve(i);
        }
        bi(t, e) {
            let n = new ln(W$1);
            return e.forEach((t => {
                const e = new Ar(t, 0), s = new Ar(t, Number.POSITIVE_INFINITY);
                this.Mc.Ie([ e, s ], (t => {
                    n = n.add(t.Oc);
                }));
        ...
        Oi(t, e) {
            const n = new Ar(e, 0), s = this.Mc.Ae(n);
     ...
     */ class gr {
        constructor(t) {
             ...
             * IDs.
             */
            this.Wc = new mr, this.targetCount = 0, this.jc = xi.Fi();
        }
        Tn(t, e) {
        ...
        tr(t, e, n) {
            return this.Wc.vc(e, n), Is.resolve();
        }
        nr(t, e, n) {
            this.Wc.Dc(e, n);
        ...
        Oi(t, e) {
            return Is.resolve(this.Wc.Oi(e));
        }
    }
    ...
    class yr {
        ...
        runTransaction(t, e, n) {
            ...
            return this.Ei.Hc(), n(s).next((t => this.Ei.Jc(s).next((() => t)))).kn().then((t => (s.gs(), 
            t)));
        }
        Yc(t, e) {
            return Is.$n(Object.values(this.Gc).map((n => () => n.Oi(t, e))));
        }
    }
    ...
    class br {
        ...
        nu(t, e) {
            return Is.$n([ () => Is.resolve(this.Xc.Oi(e)), () => this.persistence.vr().Oi(t, e), () => this.persistence.Yc(t, e) ]);
        }
    }
    ...
    class Cr {
         ...
         */    static su(t, e, n) {
            ...
            i && (r = new O$1(s.error.code, s.error.message))), i ? new Cr(t, e, s.state, r) : (b("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
            null);
        }
        iu() {
            const t = {
    ...
    class Nr {
         ...
         */    static su(t, e) {
            ...
            s && (i = new O$1(n.error.code, n.error.message))), s ? new Nr(t, n.state, i) : (b("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
            null);
        }
        iu() {
            const t = {
     ...
     */ class xr {
         ...
         */    static su(t, e) {
            ...
            return s ? new xr(t, i) : (b("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
            null);
        }
    }
     ...
     */ class Or {
         ...
         */    static su(t) {
            ...
            return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Or(e.clientId, e.onlineState) : (b("SharedClientState", "Failed to parse online state: " + t), 
            null);
        }
    }
     ...
     */ class Mr {
        constructor(t, e, n, s, i) {
            ...
            const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
            this.storage = this.window.localStorage, this.currentUser = i, this.du = vr(this.persistenceKey, this.cu), 
            this.wu = 
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ (this.persistenceKey), this._u = this._u.Gt(this.cu, new kr), this.Eu = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
            ...
            (this.persistenceKey), this.Au = function(t) {
        ...
        async start() {
            ...
            for (const e of t) {
                ...
                const t = this.getItem(vr(this.persistenceKey, e));
                if (t) {
                    const n = xr.su(e, t);
            ...
            // if applicable.
            const e = this.storage.getItem(this.mu);
            if (e) {
                const t = this.Pu(e);
                t && this.Vu(t);
            }
        ...
        lu(t) {
            ...
            if (e.storageArea === this.storage) {
                if (p$1("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.du) return void b("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                this.Xr.yo((async () => {
                    if (this.wr) {
     ...
     */ (e.newValue);
                            t !== U$1.k && this.D(t);
                        } else if (e.key === this.Au) return this.uu.Ju();
                    } else this.fu.push(e);
                }));
            }
        }
        ...
        Bu(t) {
            ...
            this.storage.setItem(this.mu, JSON.stringify(e));
        }
        Fu(t, e, n) {
        ...
        Uu() {
            this.setItem(this.Au, "value-not-used");
        }
        /**
    ...
    class Fr {
        constructor() {
            this.ta = new kr, this.ea = {}, this.au = null, this.D = null;
        }
        bu(t) {
            // No op.
        }
        ...
        start() {
            return this.ta = new kr, Promise.resolve();
        }
        $u(t, e, n) {
            // No op.
        }
    ...
    class {
        constructor(t) {
            this.ma = t, this.p = t.p;
            const e = t.ssl ? "https" : "http";
            this.Aa = e + "://" + t.host, this.Ra = "projects/" + this.p.projectId + "/databases/" + this.p.database + "/documents";
        }
        Pa(t, e, n, s) {
            const i = this.Va(t, e);
                    ...
                    try {
                        switch (o.getLastErrorCode()) {
                          ...
                          case ErrorCode.TIMEOUT:
                            p$1("Connection", 'RPC "' + t + '" timed out'), r(new O$1(x$1.DEADLINE_EXCEEDED, "Request time out"));
                            break;
                          ...
                          case ErrorCode.HTTP_ERROR:
                            ...
                            n > 0) {
                                ...
                                if (t && t.status && t.message) {
                                    ...
                                    r(new O$1(e, t.message));
                                } else r(new O$1(x$1.UNKNOWN, "Server responded with status " + o.getStatus()));
                            } else 
                            // If we received an HTTP_ERROR but there's no status code,
                            // it's most probably a connection issue
                            r(new O$1(x$1.UNAVAILABLE, "Connection failed."));
                            break;
        ...
        ba(t, e) {
            const n = [ this.Aa, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = createWebChannelTransport(), i = getStatEventTarget(), r = {
            ...
            // enough the code is exception free.
                ...
                w || (w = !0, v$1("Connection", "WebChannel transport errored:", t), E.Ta(new O$1(x$1.UNAVAILABLE, "The operation could not be completed")));
    ...
    class jr {
         ...
         */ , i = 6e4) {
            this.Xr = t, this._s = e, this.va = n, this.Sa = s, this.Da = i, this.Ca = 0, this.Na = null, 
         ...
         */    ka(t) {
            ...
            // bounds.
            this.Ca *= this.Sa, this.Ca < this.va && (this.Ca = this.va), this.Ca > this.Da && (this.Ca = this.Da);
        }
        Fa() {
    ...
    class Gr {
         ...
         */    async close(t, e) {
            ...
            this.Ka.Oa()) : e && e.code === x$1.UNAUTHENTICATED && 
        ...
        auth() {
            ...
            // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                ...
                t((() => {
                    const t = new O$1(x$1.UNKNOWN, "Fetching auth token failed: " + e.message);
                    return this.eh(t);
                }));
            }));
        }
        ...
        ja() {
            this.state = 4 /* Backoff */ , this.Ka.ka((async () => {
         ...
         */    ih(t) {
            ...
            e.database = zn(this.Ut), e.addTarget = function(t, e) {
                ...
                return n = qt(s) ? {
                    ...
                    query: ss(t, s)
                }, n.targetId = e.targetId, e.resumeToken.wt() > 0 ? n.resumeToken = Ln(t, e.resumeToken) : e.kt.L(H$1.min()) > 0 && (
                // TODO(wuandy): Consider removing above check because it is most likely true.
                // Right now, many tests depend on this behaviour though (leaving min() out
                // of serialization).
                n.readTime = $n(t, e.kt.q())), n;
            }(this.Ut, t);
    ...
    class Jr extends class {} {
        ...
        dh() {
            if (this.fh) throw new O$1(x$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
    ...
    class Yr {
         ...
         */    Ih() {
            0 === this.wh && (this.mh("Unknown" /* Unknown */), this.Eh = this.ls.Er("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (() => (this.Eh = null, 
            this.Ah("Backend didn't respond within 10 seconds."), this.mh("Offline" /* Offline */), 
            Promise.resolve()))));
        }
        /**
         ...
         */    Rh(t) {
            "Online" /* Online */ === this.state ? this.mh("Unknown" /* Unknown */) : (this.wh++, 
            this.wh >= 1 && (this.Ph(), this.Ah("Connection failed 1 times. Most recent error: " + t.toString()), 
            this.mh("Offline" /* Offline */)));
        }
        /**
        ...
        Ah(t) {
            ...
            this.Th ? (b(e), this.Th = !1) : p$1("OnlineStateTracker", e);
        }
        Ph() {
    ...
    async function lo(t, e, n) {
        ...
        try {
            ...
            async function(t, e) {
                ...
                t.bh.has(s) && (await t.yh.Oh(s, n), t.bh.delete(s), t.xh.removeTarget(s));
            }
            /**
     ...
     */ (t, e);
            ...
            await _o(t, n);
        } else if (e instanceof vn ? t.xh.fn(e) : e instanceof Sn ? t.xh.Rn(e) : t.xh.En(e), 
     ...
     */ class Oo {
         ...
         */    Qh(t) {
            if (!this.options.includeMetadataChanges) {
                ...
                t = new yn(t.query, t.docs, t.ve, e, t.Se, t.fromCache, t.De, 
     ...
     */ class Fo {
        ...
        e) {
            ...
            this.Se = An(), this.nl = me(t), this.sl = new Vn(this.nl);
        }
        /**
     ...
     */ class Bo {
        ...
        s, i, r) {
            ...
            this.ml = {}, this.Al = new gi((t => Ee(t)), we), this.Rl = new Map, 
            /**
             ...
             */
            this.gl = new Map, this.yl = new mr, 
            /** Stores user completion handlers, indexed by User and BatchId. */
            this.pl = {}, 
            /** Stores user callbacks waiting for all pending writes to be acknowledged. */
            this.bl = new Map, this.vl = xi.$i(), this.onlineState = "Unknown" /* Unknown */ , 
     ...
     */ async function Uo(t, e, n, s) {
        ...
        /* usePreviousResults= */ !0), r = new Fo(e, i.mc), o = r.rl(i.documents), c = bn.$e(n, s && "Offline" /* Offline */ !== t.onlineState), u = r.di(o, 
        /* updateLimboDocuments= */ t.Dl, c);
        ec$1(t, n, u.hl);
        const a = new $o(e, n, r);
        return t.Al.set(e, a), t.Rl.has(n) ? t.Rl.get(n).push(e) : t.Rl.set(n, [ e ]), u.snapshot;
    }

    /** Stops listening to the query. */ async function Ko(t, e) {
        const n = N$1(t), s = n.Al.get(e), i = n.Rl.get(s.targetId);
        if (i.length > 1) return n.Rl.set(s.targetId, i.filter((t => !we(t, e)))), void n.Al.delete(e);
        // No other queries are mapped to the target, clean up the query and the target.
            ...
            /*keepPersistedTargetData=*/ !1).then((() => {
                n.Tl.ku(s.targetId), no(n.wl, s.targetId), Zo(n, s.targetId);
            })).catch(Vi);
     ...
     */ async function Qo(t, e, n) {
        ...
        try {
            const t = await function(t, e) {
                const n = N$1(t), s = z$1.now(), i = e.reduce(((t, e) => t.add(e.key)), An());
                let r;
            ...
            s.Tl.bu(t.batchId), function(t, e, n) {
     ...
     */ function jo(t, e, n) {
        ...
        // SharedClientState.
            ...
            }(s.El, e), t.length && s.ml.sh(t), s.onlineState = e, s.Dl && s.Tl.Lu(e);
        }
    }
     ...
     */ async function Go(t, e, n) {
        ...
        if (r) {
            ...
            let t = new un(tt.K);
            t = t.Gt(r, new Ot(r, H$1.min()));
            const n = An().add(r), i = new pn(H$1.min(), 
    ...
    function Zo(t, e, n = null) {
        t.Tl.xu(e);
        for (const s of t.Rl.get(e)) t.Al.delete(s), n && t.ml.Nl(s, n);
    ...
    function ec$1(t, e, n) {
        for (const s of n) if (s instanceof ko) t.yl.er(s.key, e), nc$1(t, s); else if (s instanceof Mo) {
     ...
     */ function sc$1(t) {
        for (;t.Pl.length > 0 && t.Vl.size < t.Il; ) {
            const e = t.Pl.shift(), n = t.vl.next();
            t.gl.set(n, new Lo(e)), t.Vl = t.Vl.Gt(e, n), eo(t.wl, new Re(fe(oe(e.path)), n, 2 /* LimboResolution */ , U$1.k));
        }
    }

    async function ic$1(t, e, n) {
        const s = N$1(t), i = [], r = [], o = [];
        s.Al.Y() || (s.Al.forEach(((t, c) => {
        ...
        })), await Promise.all(o), s.ml.sh(i), await async function(t, e) {
            const n = N$1(t);
            try {
            ...
            for (const t of e) {
                const e = t.targetId;
                if (!t.fromCache) {
                    const t = n.lc.get(e), s = t.kt, i = t.$t(s);
    ...
    async function rc$1(t, e) {
        ...
        if (!n.currentUser.isEqual(e)) {
            ...
            function(t, e) {
                t.bl.forEach((t => {
                    t.forEach((t => {
                        t.reject(new O$1(x$1.CANCELLED, e));
                    }));
                })), t.bl.clear();
    ...
    async function hc$1(t, e) {
        ...
        if (Ec$1(n), Tc$1(n), !0 === e && !0 !== n.Sl) {
            ...
            n.Rl.forEach(((s, i) => {
                n.Tl.Ou(i) ? t.push(i) : e = e.then((() => (Zo(n, i), fr(n.Vh, i, 
    ...
    async function lc$1(t, e, n) {
        ...
        for (const t of e) {
            ...
            if (n && 0 !== n.length) {
                ...
                for (const t of n) {
                    const e = s.Al.get(t), n = await cc$1(s, e);
    ...
    function Ec$1(t) {
        const e = N$1(t);
        return e.wl.yh.kh = Wo.bind(null, e), e.wl.yh.bn = oc$1.bind(null, e), e.wl.yh.Oh = Go.bind(null, e), 
        e.ml.sh = Co.bind(null, e.El), e.ml.Nl = No.bind(null, e.El), e;
    }
     ...
     */ class Ic$1 {
        ...
        async initialize(t) {
            this.Ut = Wr(t.ma.p), this.Tl = this.xl(t), this.persistence = this.Ol(t), await this.persistence.start(), 
            this.kl = this.Ml(t), this.Vh = this.Fl(t);
        }
        Ml(t) {
            return null;
        }
        ...
        Ol(t) {
            return new yr(br.tu, this.Ut);
        }
        xl(t) {
            return new Fr;
        }
        async terminate() {
            this.kl && this.kl.stop(), await this.Tl.Mo(), await this.persistence.Mo();
        }
    }

    /**
     * Provides all components needed for Firestore with IndexedDB persistence.
     */ class mc$1 extends Ic$1 {
        constructor(t, e, n) {
        ...
        Ol(t) {
            const e = er(t.ma.p, t.ma.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Pi.Js(this.cacheSizeBytes) : Pi.Zs;
     ...
     */ class Ac$1 extends mc$1 {
        ...
        async initialize(t) {
            ...
            await this.persistence.Ao((async t => {
                await hc$1(this.Ll.uu, t), this.kl && (t && !this.kl.wr ? this.kl.start(this.Vh) : t || this.kl.stop());
            }));
        }
        xl(t) {
            const e = Kr();
            if (!Mr.Kn(e)) throw new O$1(x$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const n = er(t.ma.p, t.ma.persistenceKey);
     ...
     */ class Rc$1 {
        ...
        Bl(t) {
            const e = Wr(t.ma.p), n = (s = t.ma, new Ur(s));
            var s;
     ...
     */ class Vc$1 {
         ...
         */    static fromBase64String(t) {
            try {
                ...
                throw new O$1(x$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
            }
        }
        /**
     ...
     */ class gc$1 {
         ...
         */
        constructor(...t) {
            for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new O$1(x$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
            this.zl = new Z$1(t);
        }
        /**
     ...
     * limitations under the License.
     */ function vc$1(t, e, n) {
        if (!n) throw new O$1(x$1.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
    }
     ...
     */
    function Sc$1(t) {
        if (!tt.lt(t)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
    }
     ...
     */ function Dc$1(t) {
        if (tt.lt(t)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
    }
    ...
    e) {
        ...
        t = t.Hl), !(t instanceof e)) {
            if (e.name === t.constructor.name) throw new O$1(x$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
            {
                const n = Cc$1(t);
                throw new O$1(x$1.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
            }
        }
        return t;
    }
    ...
    function xc(t, e) {
        if (e <= 0) throw new O$1(x$1.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
    }
    ...
    class Oc$1 {
        constructor(t) {
            var e;
            if (void 0 === t.host) {
                if (void 0 !== t.ssl) throw new O$1(x$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
                this.host = "firestore.googleapis.com", this.ssl = true;
            } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
            if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
            void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
                if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new O$1(x$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
                this.cacheSizeBytes = t.cacheSizeBytes;
            }
            this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
            function(t, e, n, s) {
                if (!0 === e && !0 === s) throw new O$1(x$1.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
    ...
    class Mc$1 {
        /** @hideconstructor */
        constructor(t, e) {
            this.Jl = "(lite)", this.Yl = new Oc$1({}), this.Xl = !1, t instanceof q$1 ? (this.Zl = t, 
            this.t_ = new M$1) : (this.e_ = t, this.Zl = function(t) {
                if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new O$1(x$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
     ...
     */ (t), this.t_ = new F$1(e));
         ...
         * instance.
         */    get app() {
            if (!this.e_) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.e_;
        }
        get n_() {
            return this.Xl;
        ...
        r_(t) {
            if (this.Xl) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
            this.Yl = new Oc$1(t), void 0 !== t.credentials && (this.t_ = function(t) {
                if (!t) return new M$1;
                switch (t.type) {
                  case "gapi":
                    const e = t.client;
                  ...
                  default:
                    throw new O$1(x$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
                }
            }(t.credentials));
        }
        o_() {
     ...
     */
            return function(t) {
                const e = kc$1.get(t);
                e && (p$1("ComponentProvider", "Removing Datastore"), kc$1.delete(t), e.terminate());
            }(this), Promise.resolve();
        }
    }

    function Fc$1(t, e, n) {
        const s = (t = Nc$1(t, Mc$1)).o_();
        ...
        t.r_(Object.assign(Object.assign({}, s), {
            host: `${e}:${n}`,
            ssl: !1
        }));
    }
     ...
     */ class $c$1 {
         ...
         */    get parent() {
            return new Bc$1(this.firestore, this.a_, this.h_.path.G());
        }
        /**
         ...
         */    withConverter(t) {
            return new $c$1(this.firestore, t, this.h_);
        }
    }
     ...
     */ class Lc$1 {
         ...
         */    withConverter(t) {
            return new Lc$1(this.firestore, t, this.__);
        }
    }
     ...
     */ class Bc$1 extends Lc$1 {
         ...
         */    get parent() {
            const t = this.l_.G();
            return t.Y() ? null : new $c$1(this.firestore, 
         ...
         */    withConverter(t) {
            return new Bc$1(this.firestore, t, this.l_);
        }
    }

    function qc$1(t, e, ...n) {
        if (t instanceof bc$1 && (t = t.Hl), vc$1("collection", "path", e), t instanceof Mc$1) {
            const s = Y$1.nt(e, ...n);
            return Dc$1(s), new Bc$1(t, /* converter= */ null, s);
        }
        {
            if (!(t instanceof $c$1 || t instanceof Bc$1)) throw new O$1(x$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = Y$1.nt(t.path, ...n).child(Y$1.nt(e));
            return Dc$1(s), new Bc$1(t.firestore, 
            /* converter= */ null, s);
        }
    }
     ...
     */ function Uc$1(t, e) {
        if (t = Nc$1(t, Mc$1), vc$1("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
        return new Lc$1(t, 
        /* converter= */ null, 
        /**
    ...
    function Kc$1(t, e, ...n) {
        if (t instanceof bc$1 && (t = t.Hl), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        1 === arguments.length && (e = Q$1.M()), vc$1("doc", "path", e), t instanceof Mc$1) {
            const s = Y$1.nt(e, ...n);
            return Sc$1(s), new $c$1(t, 
            /* converter= */ null, new tt(s));
        }
        {
            if (!(t instanceof $c$1 || t instanceof Bc$1)) throw new O$1(x$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
            const s = t.l_.child(Y$1.nt(e, ...n));
            return Sc$1(s), new $c$1(t.firestore, t instanceof Bc$1 ? t.a_ : null, new tt(s));
        }
    }
     ...
     * Firestore database.
     */ function Qc$1(t, e) {
        return t instanceof bc$1 && (t = t.Hl), e instanceof bc$1 && (e = e.Hl), (t instanceof $c$1 || t instanceof Bc$1) && (e instanceof $c$1 || e instanceof Bc$1) && (t.firestore === e.firestore && t.path === e.path && t.a_ === e.a_);
    }
     ...
     * Firestore database.
     */ function Wc$1(t, e) {
        return t instanceof bc$1 && (t = t.Hl), e instanceof bc$1 && (e = e.Hl), t instanceof Lc$1 && e instanceof Lc$1 && (t.firestore === e.firestore && we(t.__, e.__) && t.a_ === e.a_);
    }
     ...
     */ class jc$1 {
         ...
         */
        constructor(t, e) {
            if (!isFinite(t) || t < -90 || t > 90) throw new O$1(x$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
            if (!isFinite(e) || e < -180 || e > 180) throw new O$1(x$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
            this.f_ = t, this.d_ = e;
        }
        /**
    ...
    /** The result of parsing document data (e.g. for a setData call). */ class zc$1 {
        constructor(t, e, n) {
    ...
    /** The result of parsing "update" data (i.e. for an updateData call). */ class Hc$1 {
        constructor(t, 
    ...
    /** A "context" object passed around while parsing user data. */ class Yc$1 {
        /**
        ...
        /** Returns a new context with the specified settings overwritten. */    I_(t) {
            return new Yc$1(Object.assign(Object.assign({}, this.settings), t), this.p, this.Ut, this.ignoreUndefinedProperties, this.fieldTransforms, this.jt);
        }
        m_(t) {
            var e;
        ...
        g_(t) {
            return Tu(t, this.settings.methodName, this.settings.y_ || !1, this.path, this.settings.p_);
        }
        ...
        R_(t) {
            ...
            if (Jc$1(this.T_) && Gc$1.test(t)) throw this.g_('Document fields cannot begin and end with "__"');
        }
    }
     ...
     */ class Xc$1 {
        ...
        /** Creates a new top-level parse context. */    b_(t, e, n, s = !1) {
            return new Yc$1({
                T_: t,
                methodName: e,
                p_: n,
    ...
    function Zc$1(t) {
        ...
        return new Xc$1(t.Zl, !!e.ignoreUndefinedProperties, n);
    }

    /** Parse document data from a set() call. */ function tu(t, e, n, s, i, r = {}) {
        const o = t.b_(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
        fu("Data must be an object, but it was:", o, s);
        const c = lu(s, o);
        let u, a;
        if (r.merge) u = new it(o.jt), a = o.fieldTransforms; else if (r.mergeFields) {
            ...
            for (const s of r.mergeFields) {
                const i = du(e, s, n);
                if (!o.contains(i)) throw new O$1(x$1.INVALID_ARGUMENT, `Field '${i}' is specified in your field mask but missing from your input data.`);
                Iu(t, i) || t.push(i);
            }
            u = new it(t), a = o.fieldTransforms.filter((t => u.ft(t.field)));
        } else u = null, a = o.fieldTransforms;
        return new zc$1(new St(c), u, a);
    }

    class eu extends pc$1 {
        v_(t) {
    ...
    class iu extends pc$1 {
        ...
        v_(t) {
            const e = nu(this, t, 
            /*array=*/ !0), n = this.S_.map((t => hu(t, e))), s = new De(n);
    ...
    class ru extends pc$1 {
        ...
        v_(t) {
            const e = nu(this, t, 
            /*array=*/ !0), n = this.S_.map((t => hu(t, e))), s = new Ne(n);
            return new Fe(t.path, s);
        }
        isEqual(t) {
            // TODO(mrschmidt): Implement isEquals
    ...
    class ou extends pc$1 {
        constructor(t, e) {
            super(t), this.D_ = e;
        }
        v_(t) {
            const e = new Oe(t.Ut, ge(t.Ut, this.D_));
    ...
    /** Parse update data from an update() call. */ function cu(t, e, n, s) {
        const i = t.b_(1 /* Update */ , e, n);
        fu("Data must be an object, but it was:", i, s);
        const r = [], o = new Dt;
        nt(s, ((t, s) => {
            const c = Eu(e, t, n);
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    s instanceof bc$1 && (s = s.Hl);
            const u = i.P_(c);
            if (s instanceof eu) 
        ...
        const c = new it(r);
        return new Hc$1(o.Rt(), c, i.fieldTransforms);
    }

    /** Parse update data from a list of field/value arguments. */ function uu(t, e, n, s, i, r) {
        const o = t.b_(1 /* Update */ , e, n), c = [ du(e, s, n) ], u = [ i ];
        if (r.length % 2 != 0) throw new O$1(x$1.INVALID_ARGUMENT, `Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);
        for (let t = 0; t < r.length; t += 2) c.push(du(e, r[t])), u.push(r[t + 1]);
        const a = [], h = new Dt;
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (let t = c.length - 1; t >= 0; --t) if (!Iu(a, c[t])) {
            const e = c[t];
            let n = u[t];
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    n instanceof bc$1 && (n = n.Hl);
            const s = o.P_(e);
            if (n instanceof eu) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(e); else {
        ...
        const l = new it(a);
        return new Hc$1(h.Rt(), l, o.fieldTransforms);
    }
     ...
     */ function au(t, e, n, s = !1) {
        return hu(n, t.b_(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
    }
     ...
     */ function hu(t, e) {
        ...
        // from firestore-exp.
        t instanceof bc$1 && (t = t.Hl), _u(t)) return fu("Unsupported field value:", e, t), 
        lu(t, e);
     ...
     */
        return function(t, e) {
            ...
            if (!Jc$1(e.T_)) throw e.g_(t._methodName + "() can only be used with update() and set()");
     ...
     */ (t, e), null;
        ...
        e.path && e.jt.push(e.path), t instanceof Array) {
            ...
            if (e.settings.A_ && 4 /* ArrayArgument */ !== e.T_) throw e.g_("Nested arrays are not supported");
            return function(t, e) {
                const n = [];
                let s = 0;
                for (const i of t) {
    ...
    function _u(t) {
        return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof z$1 || t instanceof jc$1 || t instanceof Vc$1 || t instanceof $c$1 || t instanceof pc$1);
    }
     ...
     */ function du(t, e, n) {
        ...
        // FieldPath.
        e instanceof bc$1 && (e = e.Hl), e instanceof gc$1) return e.zl;
        if ("string" == typeof e) return Eu(t, e);
        throw Tu("Field path arguments must be of type string or FieldPath.", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
     ...
     * evaluated.
     */ function Eu(t, e, n) {
        if (e.search(wu) >= 0) throw Tu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
        try {
            return new gc$1(...e.split(".")).zl;
        } catch (s) {
            throw Tu(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, t, 
            /* hasConverter= */ !1, 
            /* path= */ void 0, n);
        }
    }
    ...
    function Tu(t, e, n, s, i) {
        ...
        u += ")"), new O$1(x$1.INVALID_ARGUMENT, c + t + u);
    }

    /** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Iu(t, e) {
     ...
     */ class mu {
        ...
        async k_(t) {
            if (this.M_(), this.mutations.length > 0) throw new O$1(x$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
            ...
            return e.forEach((t => {
                t instanceof Ot || t instanceof xt ? this.F_(t) : D$1();
            })), e;
        }
        set(t, e) {
            this.write(e.w_(t, this.Wt(t))), this.O_.add(t.toString());
        }
        update(t, e) {
            try {
            ...
            this.O_.add(t.toString());
        }
        delete(t) {
            this.write(new tn(t, this.Wt(t))), this.O_.add(t.toString());
        }
        async commit() {
        ...
        F_(t) {
            ...
            if (n) {
                ...
                throw new O$1(x$1.ABORTED, "Document version changed between two reads.");
         ...
         */    Wt(t) {
            ...
            return !this.O_.has(t.toString()) && e ? Be.updateTime(e) : Be.Kt();
        }
        /**
         ...
         */    L_(t) {
            ...
            // read time and existence
                ...
                // transaction.
                throw new O$1(x$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    class Au {
        ...
        q_() {
            this.Ka.ka((async () => {
                const t = new mu(this.gh), e = this.U_(t);
                e && e.then((e => {
    ...
    class Ru {
         ...
         */
        e, n) {
            this.credentials = t, this.ls = e, this.ma = n, this.user = P$1.UNAUTHENTICATED, this.clientId = Q$1.M(), 
            this.W_ = () => {}, this.A = new Ts, this.credentials.T((t => {
                p$1("FirestoreClient", "Received user=", t.uid), this.user = t, this.W_(t), this.A.resolve();
            }));
        }
        ...
        j_(t) {
            ...
            this.A.promise.then((() => this.W_(this.user)));
        }
        /**
         * Checks that the client has not been terminated. Ensures that other methods on
         * this class cannot be called after the client is terminated.
         */    G_() {
            if (this.ls.z_) throw new O$1(x$1.FAILED_PRECONDITION, "The client has already been terminated.");
        }
        terminate() {
            this.ls.H_();
            const t = new Ts;
    ...
    async function gu(t) {
        ...
        await Pu(t, new Ic$1)), t.X_;
    }

    async function yu(t) {
        return t.Y_ || (p$1("FirestoreClient", "Using default OnlineComponentProvider"), await Vu(t, new Rc$1)), 
        t.Y_;
    }

    function pu(t) {
        return gu(t).then((t => t.persistence));
    }

    function bu(t) {
        return gu(t).then((t => t.Vh));
    }

    function vu(t) {
        return yu(t).then((t => t.wl));
    }

    function Su(t) {
        return yu(t).then((t => t.uu));
    }

    async function Du(t) {
        const e = await yu(t), n = e.El;
        return n.Uh = qo.bind(null, e.uu), n.Wh = Ko.bind(null, e.uu), n;
    }

    /** Enables the network connection and re-enqueues all pending operations. */ function Cu(t) {
        return t.ls.enqueue((async () => {
            const e = await pu(t), n = await vu(t);
    ...
    /** Disables the network connection. Pending operations will not complete. */ function Nu(t) {
        return t.ls.enqueue((async () => {
            const e = await pu(t), n = await vu(t);
     ...
     */ function xu(t, e) {
        ...
        return t.ls.Rs((async () => async function(t, e, n) {
            try {
                ...
                s instanceof xt ? n.resolve(s) : s instanceof Ot ? n.resolve(null) : n.reject(new O$1(x$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (t) {
        ...
        return t.ls.Rs((async () => function(t, e, n, s, i) {
            const r = new Pc$1({
                next: r => {
                    ...
                    i.reject(new O$1(x$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : c && r.fromCache && s && "server" === s.source ? i.reject(new O$1(x$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(r);
                },
                error: t => i.reject(t)
            }), o = new Oo(oe(n.path), r, {
                includeMetadataChanges: !0,
                Xh: !0
            });
            return So(t, o);
        }(await Du(t), t.ls, e, n, s))), s.promise;
    }
    ...
    function ku(t, e) {
        ...
        return t.ls.Rs((async () => async function(t, e, n) {
            try {
                ...
                /* usePreviousResults= */ !0), i = new Fo(e, s.mc), r = i.rl(s.documents), o = i.di(r, 
                /* updateLimboDocuments= */ !1);
        ...
        return t.ls.Rs((async () => function(t, e, n, s, i) {
            const r = new Pc$1({
                next: n => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    e.Rs((() => Do(t, o))), n.fromCache && "server" === s.source ? i.reject(new O$1(x$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                },
                error: t => i.reject(t)
            }), o = new Oo(n, r, {
                includeMetadataChanges: !0,
     ...
     */
        ...
        Er(t, e, n) {
            ...
            const s = vs.Es(this, t, e, n, (t => this.ff(t)));
     ...
     * Do not call this constructor directly. Instead, use {@link getFirestore}.
     */
    class qu extends Mc$1 {
        /** @hideconstructor */
        constructor(t, e) {
            super(t, e), this.If = new Lu, this.Jl = "name" in t ? t.name : "[DEFAULT]";
        }
        u_() {
            return this.mf || 
            // The client must be initialized to ensure that all subsequent API
            // usage throws an exception.
            Wu(this), this.mf.terminate();
        }
    }
     ...
     */ function Uu(e, n) {
        ...
        if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new O$1(x$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
        return s.r_(n), s;
    }
     ...
     */ function ju(t, e) {
        ta$1(t = Nc$1(t, qu));
        const n = Qu(t), s = t.c_(), i = new Rc$1;
        return zu(n, i, new mc$1(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
    }
     ...
     */ function Gu(t) {
        ta$1(t = Nc$1(t, qu));
        const e = Qu(t), n = t.c_(), s = new Rc$1;
        return zu(e, s, new Ac$1(s, n.cacheSizeBytes));
    }
     ...
     */ function zu(t, e, n) {
        ...
        return t.ls.enqueue((async () => {
            try {
                await Pu(t, n), await Vu(t, e), s.resolve();
            } catch (t) {
                if (!
                /**
    ...
    function Hu(t) {
        if (t.n_ && !t.s_) throw new O$1(x$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const e = new Ts;
        return t.If.J_((async () => {
            try {
                await async function(t) {
                    if (!As.Kn()) return Promise.resolve();
                    const e = t + "main";
                    await As.delete(e);
     ...
     */ function Ju(t) {
        return function(t) {
            const e = new Ts;
            return t.ls.Rs((async () => Jo(await Su(t), e))), e.promise;
        }(Qu(t = Nc$1(t, qu)));
    }
    ...
    function ta$1(t) {
        if (t.n_ || t.s_) throw new O$1(x$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
    }
    ...
    class ea$1 {
        ...
        yf(t) {
            return new jc$1(ut(t.latitude), ut(t.longitude));
        }
        pf(t, e) {
            return (t.values || []).map((t => this.Af(t, e)));
        }
        Pf(t, e) {
            switch (e) {
              case "previous":
                const n = lt(t);
                return null == n ? null : this.Af(n, e);
     ...
     */ class na$1 {
         ...
         */    get ref() {
            return new $c$1(this.Sf, this.a_, this.h_);
        }
        /**
         ...
         */    data() {
            if (this.Cf) {
                if (this.a_) {
                    ...
                    const t = new sa$1(this.Sf, this.Df, this.h_, this.Cf, 
                    /* converter= */ null);
                    return this.a_.fromFirestore(t);
                }
                return this.Df.Af(this.Cf.yt());
            }
        }
        /**
        ...
        get(t) {
            if (this.Cf) {
                const e = this.Cf.data().field(ia("DocumentSnapshot.get", t));
                if (null !== e) return this.Df.Af(e);
            }
        }
    }
     ...
     * Helper that calls fromDotSeparatedString() but wraps any error thrown.
     */ function ia(t, e) {
        return "string" == typeof e ? Eu(t, e) : e instanceof bc$1 ? e.Hl.zl : e.zl;
    }
     ...
     */ class oa$1 extends na$1 {
         ...
         */    data(t = {}) {
            if (this.Cf) {
                if (this.a_) {
                    // We only want to use the converter and create a new DocumentSnapshot
                    // if a converter has been provided.
                    const e = new ca$1(this.Sf, this.Df, this.h_, this.Cf, this.metadata, 
                    /* converter= */ null);
                    return this.a_.fromFirestore(e, t);
                }
                return this.Df.Af(this.Cf.yt(), t.serverTimestamps);
            }
        }
        /**
         * Retrieves the field specified by `fieldPath`. Returns `undefined` if the
        ...
        get(t, e = {}) {
            if (this.Cf) {
                const n = this.Cf.data().field(ia("DocumentSnapshot.get", t));
                if (null !== n) return this.Df.Af(n, e.serverTimestamps);
            }
        }
    }
     ...
     */ class ua$1 {
        /** @hideconstructor */
        constructor(t, e, n, s) {
            this.Sf = t, this.Df = e, this.xf = s, this.metadata = new ra$1(s.hasPendingWrites, s.fromCache), 
            this.query = n;
        }
         ...
         */    forEach(t, e) {
            this.xf.docs.forEach((n => {
                t.call(e, new ca$1(this.Sf, this.Df, n.key, n, new ra$1(this.xf.Se.has(n.key), this.xf.fromCache), this.query.a_));
            }));
        }
        /**
         ...
         */    docChanges(t = {}) {
            ...
            if (e && this.xf.Ce) throw new O$1(x$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
            return this.Of && this.kf === e || (this.Of = 
            ...
            function(t, e) {
                if (t.xf.ve.Y()) {
                    ...
                    return t.xf.docChanges.map((s => {
                        const i = new ca$1(t.Sf, t.Df, s.doc.key, s.doc, new ra$1(t.xf.Se.has(s.doc.key), t.xf.fromCache), t.query.a_);
                        return e = s.doc, {
                            type: "added",
                            doc: i,
                            oldIndex: -1,
                ...
                }
                {
                    ...
                    return t.xf.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                        const s = new ca$1(t.Sf, t.Df, e.doc.key, e.doc, new ra$1(t.xf.Se.has(e.doc.key), t.xf.fromCache), t.query.a_);
                        let i = -1, r = -1;
     ...
     */ function ha$1(t, e) {
        return t instanceof oa$1 && e instanceof oa$1 ? t.Sf === e.Sf && t.h_.isEqual(e.h_) && (null === t.Cf ? null === e.Cf : t.Cf.isEqual(e.Cf)) && t.a_ === e.a_ : t instanceof ua$1 && e instanceof ua$1 && (t.Sf === e.Sf && Wc$1(t.query, e.query) && t.metadata.isEqual(e.metadata) && t.xf.isEqual(e.xf));
    }
     ...
     * limitations under the License.
     */ function la(t) {
        if (ue(t) && 0 === t.Ct.length) throw new O$1(x$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }
    ...
    class da$1 extends _a$1 {
        constructor(t, e, n) {
            super(), this.Ff = t, this.$f = e, this.Lf = n, this.type = "where";
        }
        Mf(t) {
            const e = Zc$1(t.firestore), n = function(t, e, n, s, i, r, o) {
                let c;
                if (i.rt()) {
                    if ("array-contains" /* ARRAY_CONTAINS */ === r || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === r) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid Query. You can't perform '${r}' queries on FieldPath.documentId().`);
                ...
                } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Sa$1(o, r), 
                c = au(n, e, o, 
                ...
                return function(t, e) {
                    if (e.Dt()) {
                        const n = he(t);
                        if (null !== n && !n.isEqual(e.field)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                        const s = ae(t);
                        null !== s && Da$1(t, e.field, s);
                    }
                    const n = function(t, e) {
     ...
     */
                    ...
                    throw n === e.op ? new O$1(x$1.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new O$1(x$1.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
                }(t, u), u;
            }(t.__, "where", e, t.firestore.Zl, this.Ff, this.$f, this.Lf);
            return new Lc$1(t.firestore, t.a_, function(t, e) {
     ...
     * @returns The created `Query`.
     */ function wa$1(t, e, n) {
        const s = e, i = ia("where", t);
        return new da$1(i, s, n);
    }

    class Ea$1 extends _a$1 {
        constructor(t, e) {
            super(), this.Ff = t, this.Bf = e, this.type = "orderBy";
        }
        Mf(t) {
            const e = function(t, e, n) {
                if (null !== t.startAt) throw new O$1(x$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
                if (null !== t.endAt) throw new O$1(x$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
                const s = new te(e, n);
                return function(t, e) {
                    if (null === ae(t)) {
                        // This is the first order by. It must match any inequality.
                        const n = he(t);
                        null !== n && Da$1(t, n, e.field);
                    }
                }(t, s), s;
            }
            /**
     ...
     * @returns The created `Query`.
     */ function Ta$1(t, e = "asc") {
        const n = e, s = ia("orderBy", t);
        return new Ea$1(s, n);
    }

    class Ia$1 extends _a$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.qf = e, this.Uf = n;
        }
        Mf(t) {
            return new Lc$1(t.firestore, t.a_, de(t.__, this.qf, this.Uf));
        }
    }
     ...
     * @returns The created `Query`.
     */ function ma$1(t) {
        return xc("limit", t), new Ia$1("limit", t, "F" /* First */);
    }
     ...
     * @returns The created `Query`.
     */ function Aa$1(t) {
        return xc("limitToLast", t), new Ia$1("limitToLast", t, "L" /* Last */);
    }

    class Ra$1 extends _a$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Kf = e, this.Qf = n;
        }
        Mf(t) {
            const e = ba$1(t, this.type, this.Kf, this.Qf);
            return new Lc$1(t.firestore, t.a_, function(t, e) {
    ...
    function Pa$1(...t) {
        return new Ra$1("startAt", t, /*before=*/ !0);
    }

    function Va$1(...t) {
        return new Ra$1("startAfter", t, 
        /*before=*/ !1);
    }

    class ga extends _a$1 {
        constructor(t, e, n) {
            super(), this.type = t, this.Kf = e, this.Qf = n;
        }
        Mf(t) {
    ...
    function ya(...t) {
        return new ga("endBefore", t, /*before=*/ !0);
    }

    function pa$1(...t) {
        return new ga("endAt", t, /*before=*/ !1);
    }

    /** Helper function to create a bound from a document or fields */ function ba$1(t, e, n, s) {
        if (n[0] instanceof bc$1 && (n[0] = n[0].Hl), n[0] instanceof na$1) return function(t, e, n, s, i) {
            if (!s) throw new O$1(x$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            const r = [];
            ...
            // results.
                ...
                if (ht(t)) throw new O$1(x$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === t) {
                    const t = n.field.et();
                    throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${t}' (used as the orderBy) does not exist.`);
                }
                r.push(t);
            }
            return new Xt(r, i);
     ...
     */ (t.__, t.firestore.Zl, e, n[0].Cf, s);
        {
            const i = Zc$1(t.firestore);
            return function(t, e, n, s, i, r) {
                // Use explicit order by's because it has to match the query the user made
                const o = t.Ct;
                if (i.length > o.length) throw new O$1(x$1.INVALID_ARGUMENT, `Too many arguments provided to ${s}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
                const c = [];
                for (let r = 0; r < i.length; r++) {
                    const u = i[r];
                    if (o[r].field.rt()) {
                        if ("string" != typeof u) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof u}`);
                        if (!le(t) && -1 !== u.indexOf("/")) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${u}' contains a slash.`);
                        const n = t.path.child(Y$1.nt(u));
                        if (!tt.lt(n)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                        const i = new tt(n);
                        c.push(Vt(e, i));
                    } else {
                        const t = au(n, s, u);
    ...
    function va$1(t, e, n) {
        if (n instanceof bc$1 && (n = n.Hl), "string" == typeof n) {
            if ("" === n) throw new O$1(x$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!le(e) && -1 !== n.indexOf("/")) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
            const s = e.path.child(Y$1.nt(n));
            if (!tt.lt(s)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
            return Vt(t, new tt(s));
        }
        if (n instanceof $c$1) return Vt(t, n.h_);
        throw new O$1(x$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Cc$1(n) + ".");
    }
     ...
     * array requirements.
     */ function Sa$1(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid Query. A non-empty array is required for '${e.toString()}' filters.`);
        if (t.length > 10) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid Query. '${e.toString()}' filters support a maximum of 10 elements in the value array.`);
    }

    function Da$1(t, e, n) {
        if (!n.isEqual(e)) throw new O$1(x$1.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
    }
    ...
    class Na$1 extends ea$1 {
        ...
        gf(t) {
            const e = this.vf(t, this.firestore.Zl);
            return new $c$1(this.firestore, /* converter= */ null, e);
        }
    }
     ...
     */ class xa {
        /** @hideconstructor */
        constructor(t, e) {
            this.Sf = t, this.Wf = e, this.jf = [], this.Gf = !1, this.zf = Zc$1(t);
        }
        set(t, e, n) {
            this.Hf();
            const s = Oa$1(t, this.Sf), i = Ca$1(s.a_, e, n), r = tu(this.zf, "WriteBatch.set", s.h_, i, null !== s.a_, n);
            return this.jf.push(r.w_(s.h_, Be.Kt())), this;
        }
        update(t, e, n, ...s) {
            this.Hf();
            const i = Oa$1(t, this.Sf);
            // For Compat types, we have to "extract" the underlying types before
            // performing validation.
                    let r;
            return e instanceof bc$1 && (e = e.Hl), r = "string" == typeof e || e instanceof gc$1 ? uu(this.zf, "WriteBatch.update", i.h_, e, n, s) : cu(this.zf, "WriteBatch.update", i.h_, e), 
        ...
        Hf() {
            if (this.Gf) throw new O$1(x$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
        }
    }

    function Oa$1(t, e) {
        if (t instanceof bc$1 && (t = t.Hl), t.firestore !== e) throw new O$1(x$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return t;
    }
    ...
    function Ma$1(t) {
        t = Nc$1(t, $c$1);
        const e = Nc$1(t.firestore, qu);
        return Ou(Qu(e), t.h_).then((n => Ja$1(e, t, n)));
    }

    class Fa$1 extends ea$1 {
        constructor(t) {
            super(), this.firestore = t;
        }
        Vf(t) {
     ...
     */ function $a$1(t) {
        t = Nc$1(t, $c$1);
        const e = Nc$1(t.firestore, qu), n = Qu(e), s = new Fa$1(e);
        return xu(n, t.h_).then((n => new oa$1(e, s, t.h_, n, new ra$1(n instanceof xt && n.gt, 
        /* fromCache= */ !0), t.a_)));
    }
     ...
     */ function Ba$1(t) {
        t = Nc$1(t, Lc$1);
        const e = Nc$1(t.firestore, qu), n = Qu(e), s = new Fa$1(e);
        return la(t.__), Mu(n, t.__).then((n => new ua$1(e, s, t, n)));
    }
     ...
     */ function qa$1(t) {
        t = Nc$1(t, Lc$1);
        const e = Nc$1(t.firestore, qu), n = Qu(e), s = new Fa$1(e);
        return ku(n, t.__).then((n => new ua$1(e, s, t, n)));
    }
     ...
     */ function Ua$1(t) {
        ...
        return Mu(n, t.__, {
            source: "server"
        }).then((n => new ua$1(e, s, t, n)));
    }

    function Ka$1(t, e, n) {
        t = Nc$1(t, $c$1);
        const s = Nc$1(t.firestore, qu), i = Ca$1(t.a_, e, n);
        return Ha$1(s, [ tu(Zc$1(s), "setDoc", t.h_, i, null !== t.a_, n).w_(t.h_, Be.Kt()) ]);
    }

    function Qa$1(t, e, n, ...s) {
        t = Nc$1(t, $c$1);
        const i = Nc$1(t.firestore, qu), r = Zc$1(i);
        let o;
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        e instanceof bc$1 && (e = e.Hl), o = "string" == typeof e || e instanceof gc$1 ? uu(r, "updateDoc", t.h_, e, n, s) : cu(r, "updateDoc", t.h_, e);
        return Ha$1(i, [ o.w_(t.h_, Be.exists(!0)) ]);
    }
     ...
     */ function Wa$1(t) {
        return Ha$1(Nc$1(t.firestore, qu), [ new tn(t.h_, Be.Kt()) ]);
    }
     ...
     */ function ja$1(t, e) {
        const n = Nc$1(t.firestore, qu), s = Kc$1(t), i = Ca$1(t.a_, e);
        return Ha$1(n, [ tu(Zc$1(t.firestore), "addDoc", s.h_, i, null !== t.a_, {}).w_(s.h_, Be.exists(!1)) ]).then((() => s));
    }
    ...
    function Ga$1(t, ...e) {
        ...
        let u, a, h;
        if (t instanceof $c$1) a = Nc$1(t.firestore, qu), h = oe(t.h_.path), u = {
            next: n => {
                e[o] && e[o](Ja$1(a, t, n));
            },
            error: e[o + 1],
            ...
            const n = Nc$1(t, Lc$1);
            a = Nc$1(n.firestore, qu), h = n.__;
            const s = new Fa$1(a);
            u = {
                next: t => {
                    e[o] && e[o](new ua$1(a, s, n, t));
                },
                error: e[o + 1],
                complete: e[o + 2]
            }, la(t.__);
        ...
        return function(t, e, n, s) {
            const i = new Pc$1(s), r = new Oo(e, i, n);
            return t.ls.Rs((async () => So(await Du(t), r))), () => {
                i.jl(), t.ls.Rs((async () => Do(await Du(t), r)));
            };
        }(Qu(a), h, c, u);
    }

    function za$1(t, e) {
        return Fu(Qu(t = Nc$1(t, qu)), ka$1(e) ? e : {
            next: e
        });
    }

    /** Locally writes `mutations` on the async queue. */ function Ha$1(t, e) {
        return function(t, e) {
            const n = new Ts;
            return t.ls.Rs((async () => Qo(await Su(t), e, n))), n.promise;
        }(Qu(t), e);
    }
     ...
     */ function Ja$1(t, e, n) {
        const s = n.docs.get(e.h_), i = new Fa$1(t);
        return new oa$1(t, i, e.h_, s, new ra$1(n.hasPendingWrites, n.fromCache), e.a_);
    }
     ...
     * the methods to read and write data within the transaction context. See
     * {@link runTransaction}.
     */ class Ya$1 extends class {
        /** @hideconstructor */
        constructor(t, e) {
            this.Sf = t, this.Jf = e, this.zf = Zc$1(t);
        }
        /**
         ...
         */    get(t) {
            const e = Oa$1(t, this.Sf), n = new Na$1(this.Sf);
            return this.Jf.k_([ e.h_ ]).then((t => {
                if (!t || 1 !== t.length) return D$1();
                const s = t[0];
                if (s instanceof Ot) return new na$1(this.Sf, n, e.h_, null, e.a_);
                if (s instanceof xt) return new na$1(this.Sf, n, s.key, s, e.a_);
                throw D$1();
            }));
        }
        set(t, e, n) {
            const s = Oa$1(t, this.Sf), i = Ca$1(s.a_, e, n), r = tu(this.zf, "Transaction.set", s.h_, i, null !== s.a_, n);
        ...
        update(t, e, n, ...s) {
            ...
            // performing validation.
                    let r;
            return e instanceof bc$1 && (e = e.Hl), r = "string" == typeof e || e instanceof gc$1 ? uu(this.zf, "Transaction.update", i.h_, e, n, s) : cu(this.zf, "Transaction.update", i.h_, e), 
         ...
         * @returns A `DocumentSnapshot` with the read data.
         */    get(t) {
            const e = Oa$1(t, this.Sf), n = new Fa$1(this.Sf);
            return super.get(t).then((t => new oa$1(this.Sf, n, e.h_, t.Cf, new ra$1(
            /* hasPendingWrites= */ !1, 
            /* fromCache= */ !1), e.a_)));
        }
    }
     ...
     */ function Xa$1(t, e) {
        return $u(Qu(t), (n => e(new Ya$1(t, n))));
    }
     ...
     * writes.
     */ function ih(t) {
        return Qu(t = Nc$1(t, qu)), new xa(t, (e => Ha$1(t, e)));
    }
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */ app._registerComponent(new Component("firestore-exp", (t => ((t, e) => new qu(t, e))(t.getProvider("app-exp").getImmediate(), t.getProvider("auth-internal"))), "PUBLIC" /* PUBLIC */)), 
    app.registerVersion("firestore-exp", "0.0.900", "node");

    exports.Bytes = Vc$1;
    exports.CACHE_SIZE_UNLIMITED = Bu;
    exports.CollectionReference = Bc$1;
    exports.DocumentReference = $c$1;
    exports.DocumentSnapshot = oa$1;
    exports.FieldPath = gc$1;
    exports.FieldValue = pc$1;
    exports.FirebaseFirestore = qu;
    exports.FirestoreError = O$1;
    exports.GeoPoint = jc$1;
    exports.Query = Lc$1;
    exports.QueryConstraint = _a$1;
    exports.QueryDocumentSnapshot = ca$1;
    exports.QuerySnapshot = ua$1;
    exports.SnapshotMetadata = ra$1;
    exports.Timestamp = z$1;
    exports.Transaction = Ya$1;
    exports.WriteBatch = xa;
    exports.addDoc = ja$1;
    exports.arrayRemove = nh;
    exports.arrayUnion = eh;
    exports.clearIndexedDbPersistence = Hu;
    exports.collection = qc$1;
    exports.collectionGroup = Uc$1;
    exports.deleteDoc = Wa$1;
    exports.deleteField = Za$1;
    exports.disableNetwork = Xu;
    exports.doc = Kc$1;
    exports.documentId = yc$1;
    exports.enableIndexedDbPersistence = ju;
    exports.enableMultiTabIndexedDbPersistence = Gu;
    exports.enableNetwork = Yu;
    exports.endAt = pa$1;
    exports.endBefore = ya;
    exports.getDoc = Ma$1;
    exports.getDocFromCache = $a$1;
    exports.getDocFromServer = La$1;
    exports.getDocs = Ba$1;
    exports.getDocsFromCache = qa$1;
    exports.getDocsFromServer = Ua$1;
    exports.getFirestore = Ku;
    exports.increment = sh;
    exports.initializeFirestore = Uu;
    exports.limit = ma$1;
    exports.limitToLast = Aa$1;
    exports.onSnapshot = Ga$1;
    exports.onSnapshotsInSync = za$1;
    exports.orderBy = Ta$1;
    exports.query = fa$1;
    exports.queryEqual = Wc$1;
    exports.refEqual = Qc$1;
    exports.runTransaction = Xa$1;
    exports.serverTimestamp = th;
    exports.setDoc = Ka$1;
    exports.setLogLevel = y$1;
    exports.snapshotEqual = ha$1;
    exports.startAfter = Va$1;
    exports.startAt = Pa$1;
    exports.terminate = Zu;
    exports.updateDoc = Qa$1;
    exports.useFirestoreEmulator = Fc$1;
    exports.waitForPendingWrites = Ju;
    exports.where = wa$1;
    exports.writeBatch = ih;
