...
const name = "firebase";
const version = "9.0.0-2021719172025";
...
function rn(e, n) {
    const r = _getProvider(e, "firestore/lite");
 ...
 * terminated.
 */ function un(t) {
    return t = st(t, nn), _removeServiceInstance(t.app, "firestore/lite"), t._delete();
}
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("firestore-lite", "3.0.0-2021719172025", "node");
