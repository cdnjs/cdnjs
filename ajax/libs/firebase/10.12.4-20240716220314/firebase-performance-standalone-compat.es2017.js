...
/**
     ...
     * limitations under the License.
     */
Oe.registerVersion("firebase","10.12.4-20240716220314","app-compat");const Ne="@firebase/installations",ke="0.6.8",Re=1e4,Le="w:0.6.8",Me="FIS_v2",Pe=36e5,Be=new d("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function Fe(e){return e instanceof h&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return Oe.registerVersion("firebase","10.12.4-20240716220314","compat-lite"),Oe}));
