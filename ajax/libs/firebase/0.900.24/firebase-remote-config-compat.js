...
/**
     ...
     * limitations under the License.
     */
var $;($=i.default).INTERNAL.registerComponent(new p("remoteConfig-compat",x,"PUBLIC").setMultipleInstances(!0)),$.registerVersion("@firebase/remote-config-compat","0.0.900-exp.22d84906a")}).apply(this,arguments)}catch(t){throw console.error(t),new Error("Cannot instantiate firebase-remote-config-compat.js - be sure to load firebase-app.js first.")}}));
