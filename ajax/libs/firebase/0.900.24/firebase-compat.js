...
/**
   ...
   * limitations under the License.
   */
var is;e.registerVersion("@firebase/app-compat","0.0.900-exp.22d84906a",is);
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * limitations under the License.
   */
!function(){const e={Functions:xs};os.INTERNAL.registerComponent(new Ka("functions-compat",Ms,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))}(),os.registerVersion("@firebase/functions-compat","0.0.900-exp.22d84906a");
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * See the License for the specific language governing permissions and
   * limitations under the License.
   */const Us=e=>new Ds(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-exp").getImmediate());os.INTERNAL.registerComponent(new Ka("messaging-compat",Us,"PUBLIC")),os.registerVersion("@firebase/messaging-compat","0.0.900-exp.22d84906a");
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * limitations under the License.
   */
var Ws;(Ws=os).INTERNAL.registerComponent(new Ka("performance-compat",Bs,"PUBLIC")),Ws.registerVersion("@firebase/performance-compat","0.0.900-exp.22d84906a");
/**
   * @license
   * Copyright 2020 Google LLC
   *
...
/**
   ...
   * limitations under the License.
   */
return function(e){e.INTERNAL.registerComponent(new Ka("remoteConfig-compat",qs,"PUBLIC").setMultipleInstances(!0)),e.registerVersion("@firebase/remote-config-compat","0.0.900-exp.22d84906a")}(os),
/**
   * @license
   * Copyright 2017 Google LLC
   *
