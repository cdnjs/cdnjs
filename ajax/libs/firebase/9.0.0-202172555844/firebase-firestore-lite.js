import { _getProvider, getApp, _removeServiceInstance, _registerComponent, registerVersion, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.0.0-202172555844/firebase-app.js';
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0-202172555844/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 */ (t));
    ...
    /**
     * The {@link https://www.gstatic.com/firebasejs/9.0.0-202172555844/firebase-app.js#FirebaseApp} associated with this `Firestore` service
     * instance.
     */    get app() {
...
function se(n, e) {
    const r = _getProvider(n, "firestore/lite");
 ...
 * provided {@link https://www.gstatic.com/firebasejs/9.0.0-202172555844/firebase-app.js#FirebaseApp}. If no instance exists, initializes a new
 * instance with default settings.
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.0-202172555844/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
 ...
 * terminated.
 */ function ue(t) {
    return t = st(t, re), _removeServiceInstance(t.app, "firestore/lite"), t._delete();
}
...
function le(t, n, ...e) {
    if (t = getModularInstance(t), tt("collection", "path", n), t instanceof re) {
 ...
 * Firestore database.
 */ function we(t, n) {
    return t = getModularInstance(t), n = getModularInstance(n), (t instanceof ce || t instanceof he) && (n instanceof ce || n instanceof he) && (t.firestore === n.firestore && t.path === n.path && t.converter === n.converter);
}
 ...
 * Firestore database.
 */ function me(t, n) {
    return t = getModularInstance(t), n = getModularInstance(n), t instanceof ae && n instanceof ae && (t.firestore === n.firestore && fn(t._query, n._query) && t.converter === n.converter);
}
 ...
 */ function Ke(t, n) {
    return t = getModularInstance(t), n = getModularInstance(n), t instanceof Ge && n instanceof Ge ? t._firestore === n._firestore && t._key.isEqual(n._key) && (null === t._document ? null === n._document : t._document.isEqual(n._document)) && t._converter === n._converter : t instanceof Ye && n instanceof Ye && (me(t.query, n.query) && pt(t.docs, n.docs, Ke));
}
...
function Er(t, n, e, ...r) {
    ...
    // performing validation.
        let i;
    i = "string" == typeof (n = getModularInstance(n)) || n instanceof pe ? Oe(s, "updateDoc", t._key, n, e, r) : xe(s, "updateDoc", t._key, n);
 ...
 */ class Dr {
    ...
    update(t, n, e, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (n = getModularInstance(n)) || n instanceof pe ? Oe(this._dataReader, "WriteBatch.update", s._key, n, e, r) : xe(this._dataReader, "WriteBatch.update", s._key, n), 
...
class Lr {
    ...
    update(t, n, e, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (n = getModularInstance(n)) || n instanceof pe ? Oe(this._dataReader, "Transaction.update", s._key, n, e, r) : xe(this._dataReader, "Transaction.update", s._key, n), 
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("firestore-lite", "3.0.0-202172555844", "node");
