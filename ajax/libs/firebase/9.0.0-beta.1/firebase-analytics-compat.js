...
/**
     ...
     * limitations under the License.
     */
async function Ie(e,t=!1){const n=e;await async function(e){const{registrationPromise:t}=await pe(e);t&&await t}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(n.appConfig);return(await me(n,t)).token}function ve(e){return V.create("missing-app-config-values",{valueName:e})}
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */async function Re(e,t,n,r,i,o){const a=xe(e);a.then((t=>{n[t.measurementId]=t.appId,e.options.measurementId&&t.measurementId!==e.options.measurementId&&Ce.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${t.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)})).catch((e=>Ce.error(e))),t.push(a);const s=async function(){if(!h())return Ce.warn(De.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;try{await g()}catch(e){return Ce.warn(De.create("indexeddb-unavailable",{errorInfo:e}).message),!1}return!0}().then((e=>e?r.getId():void 0)),[c,u]=await Promise.all([a,s]);(function(){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(Se))return t;return null})()||function(e,t){const n=document.createElement("script");n.src=`${Se}?l=${e}&id=${t}`,n.async=!0,document.head.appendChild(n)}(o,c.measurementId),i("js",new Date);const l={origin:"firebase",update:!0};return null!=u&&(l.firebase_id=u),i("config",c.measurementId,l),c.measurementId}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Le{constructor(e){this.app=e}_delete(){return delete Me[this.app.options.appId],Promise.resolve()}}let Me={},Fe=[];const Be={};let $e,He,qe="dataLayer",Ve="gtag",Ke=!1;function Ue(e){if(Ke)throw De.create("already-initialized");e.dataLayerName&&(qe=e.dataLayerName),e.gtagName&&(Ve=e.gtagName)}function Ge(e,t){!function(){const e=[];if(d()&&e.push("This is a browser extension environment."),m()||e.push("Cookies are not available."),e.length>0){const t=e.map(((e,t)=>`(${t+1}) ${e}`)).join(" "),n=De.create("invalid-analytics-context",{errorInfo:t});Ce.warn(n.message)}}();const n=e.options.appId;if(!n)throw De.create("no-app-id");if(!e.options.apiKey){if(!e.options.measurementId)throw De.create("no-api-key");Ce.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`)}if(null!=Me[n])throw De.create("already-exists",{id:n});if(!Ke){!function(e){let t=[];Array.isArray(window[e])?t=window[e]:window[e]=t}(qe);const{wrappedGtag:e,gtagCore:t}=function(e,t,n,r,i){let o=function(...e){window[r].push(arguments)};return window[i]&&"function"==typeof window[i]&&(o=window[i]),window[i]=Pe(o,e,t,n),{gtagCore:o,wrappedGtag:window[i]}}(Me,Fe,Be,qe,Ve);He=e,$e=t,Ke=!0}Me[n]=Re(e,Fe,Be,t,$e,qe);return new Le(e)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const tt=e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("analytics-exp").getImmediate();return new Qe(t,n)};!function(){const e={Analytics:Qe,settings:Ue,isSupported:We,EventName:et};o.default.INTERNAL.registerComponent(new E("analytics-compat",tt,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))}(),o.default.registerVersion("@firebase/analytics-compat","0.0.900-exp.894b5da5a")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")}}));
