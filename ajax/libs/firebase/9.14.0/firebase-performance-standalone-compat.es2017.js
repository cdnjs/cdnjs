...
/**
     ...
     * limitations under the License.
     */
function(e){oe("@firebase/app-compat","0.1.39",e)}("lite");
/**
     * @license
...
/**
     ...
     * limitations under the License.
     */
var gn;(gn=Ie).INTERNAL.registerComponent(new m("performance-compat",dn,"PUBLIC")),gn.registerVersion("@firebase/performance-compat","0.1.17");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return Ie.registerVersion("firebase","9.14.0","compat-lite"),Ie}));
