(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ERROR_MAP = (_a$1 = {},
        ...
        _a$1["indexed-db-unsupported" /* INDEXED_DB_UNSUPPORTED */] = "This browser doesn't support indexedDb.open() (ex. Safari iFrame, Firefox Private Browsing, etc)",
    ...
    function isWindowSupported() {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, validateIndexedDBOpenable()];
                    case 1: 
    ...
    function registerMessagingInWindow() {
        app._registerComponent(new Component('messaging-exp', WindowMessagingFactory, "PUBLIC" /* PUBLIC */));
    }
    ...
    var SwController = /** @class */ (function () {
        function SwController(messaging) {
            var _this = this;
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, deleteTokenInternal(this.messaging)];
                        case 1:
                            // Subscription revoked, delete token
                            _c.sent();
                            return [2 /*return*/];
                        case 2: return [4 /*yield*/, dbGet(this.messaging.firebaseDependencies)];
                        case 3:
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, getTokenInternal(this.messaging)];
                        case 5:
                            _c.sent();
                            return [2 /*return*/];
                    }
    ...
    function onBackgroundMessage(messaging, nextOrObserver) {
        if (self.document !== undefined) {
            throw ERROR_FACTORY$1.create("only-available-in-sw" /* AVAILABLE_IN_SW */);
        }
    ...
    exports.onBackgroundMessage = onBackgroundMessage$1;
