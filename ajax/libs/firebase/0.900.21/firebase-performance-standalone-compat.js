...
/**
     ...
     * limitations under the License.
     */
var b,g=function(){var e=h(l);e.SDK_VERSION=e.SDK_VERSION+"_LITE";var t=e.INTERNAL.registerComponent;return e.INTERNAL.registerComponent=function(e){if("PUBLIC"===e.type&&"performance"!==e.name&&"installations"!==e.name)throw Error(name+" cannot register with the standalone perf instance");return t(e)},e}();b="lite",e.registerVersion("@firebase/app-compat","0.0.900-exp.8294e6082",b);
/**
     * @license
     ...
     * limitations under the License.
     */
g.registerVersion("firebase-exp","0.900.21","app-compat");
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return g.registerVersion("firebase-exp","0.900.21","compat-lite"),g}));
