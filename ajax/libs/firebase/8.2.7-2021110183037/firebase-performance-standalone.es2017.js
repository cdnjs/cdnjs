...
/**
     ...
     * limitations under the License.
     */
const A=function(){const t=S(I);t.SDK_VERSION=`${t.SDK_VERSION}_LITE`;const e=t.INTERNAL.registerComponent;return t.INTERNAL.registerComponent=function(t){if("PUBLIC"===t.type&&"performance"!==t.name&&"installations"!==t.name)throw Error(`${name} cannot register with the standalone perf instance`);return e(t)},t}();function N(t){return Array.prototype.slice.call(t)}function O(t){return new Promise((function(e,n){t.onsuccess=function(){e(t.result)},t.onerror=function(){n(t.error)}}))}function C(t,e,n){var r,i=new Promise((function(i,o){O(r=t[e].apply(t,n)).then(i,o)}));return i.request=r,i}function k(t,e,n){var r=C(t,e,n);return r.then((function(t){if(t)return new M(t,r.request)}))}function D(t,e,n){n.forEach((function(n){Object.defineProperty(t.prototype,n,{get:function(){return this[e][n]},set:function(t){this[e][n]=t}})}))}function R(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return C(this[e],r,arguments)})}))}function L(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return this[e][r].apply(this[e],arguments)})}))}function P(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return k(this[e],r,arguments)})}))}function j(t){this._index=t}function M(t,e){this._cursor=t,this._request=e}function $(t){this._store=t}function B(t){this._tx=t,this.complete=new Promise((function(e,n){t.oncomplete=function(){e()},t.onerror=function(){n(t.error)},t.onabort=function(){n(t.error)}}))}function U(t,e,n){this._db=t,this.oldVersion=e,this.transaction=new B(n)}function F(t){this._db=t}!function(t,e){t.INTERNAL.registerComponent(new s("platform-logger",(t=>new T(t)),"PRIVATE")),t.registerVersion(w,"0.6.14",e),t.registerVersion("fire-js","")}(A,"lite"),D(j,"_index",["name","keyPath","multiEntry","unique"]),R(j,"_index",IDBIndex,["get","getKey","getAll","getAllKeys","count"]),P(j,"_index",IDBIndex,["openCursor","openKeyCursor"]),D(M,"_cursor",["direction","key","primaryKey","value"]),R(M,"_cursor",IDBCursor,["update","delete"]),["advance","continue","continuePrimaryKey"].forEach((function(t){t in IDBCursor.prototype&&(M.prototype[t]=function(){var e=this,n=arguments;return Promise.resolve().then((function(){return e._cursor[t].apply(e._cursor,n),O(e._request).then((function(t){if(t)return new M(t,e._request)}))}))})})),$.prototype.createIndex=function(){return new j(this._store.createIndex.apply(this._store,arguments))},$.prototype.index=function(){return new j(this._store.index.apply(this._store,arguments))},D($,"_store",["name","keyPath","indexNames","autoIncrement"]),R($,"_store",IDBObjectStore,["put","add","delete","clear","get","getAll","getKey","getAllKeys","count"]),P($,"_store",IDBObjectStore,["openCursor","openKeyCursor"]),L($,"_store",IDBObjectStore,["deleteIndex"]),B.prototype.objectStore=function(){return new $(this._tx.objectStore.apply(this._tx,arguments))},D(B,"_tx",["objectStoreNames","mode"]),L(B,"_tx",IDBTransaction,["abort"]),U.prototype.createObjectStore=function(){return new $(this._db.createObjectStore.apply(this._db,arguments))},D(U,"_db",["name","version","objectStoreNames"]),L(U,"_db",IDBDatabase,["deleteObjectStore","close"]),F.prototype.transaction=function(){return new B(this._db.transaction.apply(this._db,arguments))},D(F,"_db",["name","version","objectStoreNames"]),L(F,"_db",IDBDatabase,["close"]),["openCursor","openKeyCursor"].forEach((function(t){[$,j].forEach((function(e){t in e.prototype&&(e.prototype[t.replace("open","iterate")]=function(){var e=N(arguments),n=e[e.length-1],r=this._store||this._index,i=r[t].apply(r,e.slice(0,-1));i.onsuccess=function(){n(i.result)}})}))})),[j,$].forEach((function(t){t.prototype.getAll||(t.prototype.getAll=function(t,e){var n=this,r=[];return new Promise((function(i){n.iterateCursor(t,(function(t){t?(r.push(t.value),void 0===e||r.length!=e?t.continue():i(r)):i(r)}))}))})}));const x="0.4.19",q=1e4,V="w:0.4.19",H="FIS_v2",K=36e5,z=new r("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function W(t){return t instanceof n&&t.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return A.registerVersion("firebase","8.2.7-2021110183037","lite"),A}));
