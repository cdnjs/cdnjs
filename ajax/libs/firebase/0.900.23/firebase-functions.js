(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    var FUNCTIONS_TYPE = 'functions-exp';
    ...
    function getFunctions(app$1, regionOrCustomDomain) {
        ...
        if (regionOrCustomDomain === void 0) { regionOrCustomDomain = DEFAULT_REGION; }
        // Dependencies
        var functionsProvider = app._getProvider(getModularInstance(app$1), FUNCTIONS_TYPE);
    ...
    function useFunctionsEmulator$1(functionsInstance, host, port) {
        useFunctionsEmulator(getModularInstance(functionsInstance), host, port);
    }
    /**
     * Returns a reference to the callable https trigger with the given name.
     * @param name - The name of the trigger.
    ...
    function httpsCallable$1(functionsInstance, name, options) {
        return httpsCallable(getModularInstance(functionsInstance), name, options);
    }
