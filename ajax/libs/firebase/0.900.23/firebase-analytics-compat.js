...
/**
     ...
     * limitations under the License.
     */
var ht,vt=function(e){var t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("analytics-exp").getImmediate();return new dt(t,n)};ht={Analytics:dt,settings:it,isSupported:at,EventName:pt},r.default.INTERNAL.registerComponent(new P("analytics-compat",vt,"PUBLIC").setServiceProps(ht).setMultipleInstances(!0)),r.default.registerVersion("@firebase/analytics-compat","0.0.900-exp.b0c8425bc")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")}}));
