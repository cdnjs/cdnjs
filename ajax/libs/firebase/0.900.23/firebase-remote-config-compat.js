...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function g(t){return t&&t._delegate?t._delegate:t}var d,m,v=function(){function t(t,e,r){this.name=t,this.instanceFactory=e,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}return t.prototype.setInstantiationMode=function(t){return this.instantiationMode=t,this},t.prototype.setMultipleInstances=function(t){return this.multipleInstances=t,this},t.prototype.setServiceProps=function(t){return this.serviceProps=t,this},t.prototype.setInstanceCreatedCallback=function(t){return this.onInstanceCreated=t,this},t}();
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */e._registerComponent(new v("remote-config-exp",(function(t,r){var n=r.instanceIdentifier,i=t.getProvider("app-exp").getImmediate(),o=t.getProvider("installations-exp-internal").getImmediate();if("undefined"==typeof window)throw I.create("registration-window");var s=i.options,a=s.projectId,c=s.apiKey,u=s.appId;if(!a)throw I.create("registration-project-id");if(!c)throw I.create("registration-api-key");if(!u)throw I.create("registration-app-id");n=n||"firebase";var l=new K(u,i.name,n),f=new V(l),h=new C(S);h.logLevel=m.ERROR;var p=new k(o,e.SDK_VERSION,n,a,c,u),g=new H(p,l),d=new j(g,l,f,h),v=new x(i,d,f,l,h);return P(v),v}),"PUBLIC").setMultipleInstances(!0)),e.registerVersion(S,"0.0.900-exp.b0c8425bc");
/**
     * @license
