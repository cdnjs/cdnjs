...
/**
     ...
     * limitations under the License.
     */
D={Functions:P},r.default.INTERNAL.registerComponent(new h("functions-compat",k,"PUBLIC").setServiceProps(D).setMultipleInstances(!0)),r.default.registerVersion("@firebase/functions-compat","0.0.900-exp.b0c8425bc")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-functions-compat.js - be sure to load firebase-app.js first.")}}));
