...
/**
     ...
     */
var a=function(e){function t(r,n,o){var i=e.call(this,n)||this;return i.code=r,i.customData=o,i.name="FirebaseError",Object.setPrototypeOf(i,t.prototype),Error.captureStackTrace&&Error.captureStackTrace(i,c.prototype.create),i}return function(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");function r(){this.constructor=e}o(e,t),e.prototype=null===t?Object.create(t):(r.prototype=t.prototype,new r)}(t,e),t}(Error),c=function(){function e(e,t,r){this.service=e,this.serviceName=t,this.errors=r}return e.prototype.create=function(e){for(var t=[],r=1;r<arguments.length;r++)t[r-1]=arguments[r];var n=t[0]||{},o=this.service+"/"+e,i=this.errors[e],c=i?p(i,n):"Error",s=this.serviceName+": "+c+" ("+o+").",u=new a(o,s,n);return u},e}();function p(e,t){return e.replace(s,(function(e,r){var n=t[r];return null!=n?String(n):"<"+r+"?>"}))}var s=/\{\$([^}]+)}/g;
/**
     * @license
     * Copyright 2017 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var u,f=function(){function e(e,t,r){this.name=e,this.instanceFactory=t,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}return e.prototype.setInstantiationMode=function(e){return this.instantiationMode=e,this},e.prototype.setMultipleInstances=function(e){return this.multipleInstances=e,this},e.prototype.setServiceProps=function(e){return this.serviceProps=e,this},e.prototype.setInstanceCreatedCallback=function(e){return this.onInstanceCreated=e,this},e}(),l=function(){function t(t,r){var n=this;this._delegate=t,this.firebase=r,e._addComponent(t,new f("app-compat",(function(){return n}),"PUBLIC"))}return Object.defineProperty(t.prototype,"automaticDataCollectionEnabled",{get:function(){return this._delegate.automaticDataCollectionEnabled},set:function(e){this.automaticDataCollectionEnabled=e},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"name",{get:function(){return this._delegate.name},enumerable:!1,configurable:!0}),Object.defineProperty(t.prototype,"options",{get:function(){return this._delegate.options},enumerable:!1,configurable:!0}),t.prototype.delete=function(){return this.firebase.INTERNAL.removeApp(this.name),e.deleteApp(this._delegate)},t.prototype._getService=function(t,r){return void 0===r&&(r=e._DEFAULT_ENTRY_NAME),this._delegate.checkDestroyed(),this._delegate.container.getProvider(t).getImmediate({identifier:r})},t}(),d=((u={})["no-app"]="No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",u["invalid-app-argument"]="firebase.{$appName}() takes either no argument or a Firebase App instance.",u),m=new c("app-compat","Firebase",d);
/**
     * @license
...
/**
     ...
     * limitations under the License.
     */
function b(t){var r={},o={__esModule:!0,initializeApp:function(n,i){void 0===i&&(i={});var a=e.initializeApp(n,i),c=new t(a,o);return r[a.name]=c,c},app:a,registerVersion:e.registerVersion,setLogLevel:e.setLogLevel,onLog:e.onLog,apps:null,SDK_VERSION:e.SDK_VERSION,INTERNAL:{registerComponent:function(r){var n=r.name,c=n.replace("-compat","");if(e._registerComponent(r)&&"PUBLIC"===r.type){var p=function(e){if(void 0===e&&(e=a()),"function"!=typeof e[c])throw m.create("invalid-app-argument",{appName:n});return e[c]()};void 0!==r.serviceProps&&i(p,r.serviceProps),o[c]=p,t.prototype[c]=function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];var o=this._getService.bind(this,n);return o.apply(this,r.multipleInstances?e:[])}}return"PUBLIC"===r.type?o[c]:null},removeApp:function(e){delete r[e]},useAsService:function(e,t){if("serverAuth"===t)return null;return t},modularAPIs:n}};function a(t){if(t=t||e._DEFAULT_ENTRY_NAME,n=r,o=t,!Object.prototype.hasOwnProperty.call(n,o))throw m.create("no-app",{appName:t});var n,o;return r[t]}return o.default=o,Object.defineProperty(o,"apps",{get:function(){return Object.keys(r).map((function(e){return r[e]}))}}),a.App=t,o}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
g.registerVersion("firebase-exp","0.900.23","app-compat");
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return g.registerVersion("firebase-exp","0.900.23","compat-lite"),g}));
