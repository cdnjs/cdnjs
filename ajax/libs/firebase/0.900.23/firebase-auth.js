    ...
    ***************************************************************************** */
    ...
    function _logError(msg) {
        ...
        if (logClient.logLevel <= LogLevel.ERROR) {
            logClient.error.apply(logClient, __spreadArray(["Auth (" + app.SDK_VERSION + "): " + msg], args));
        }
    }
    ...
    function registerAuth(clientPlatform) {
        app._registerComponent(new Component("auth-exp" /* AUTH */, function (container, _a) {
            var deps = _a.options;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authInternal = _castAuth(auth);
                        return [4 /*yield*/, _verifyPhoneNumber(authInternal, phoneNumber, appVerifier)];
                    case 1:
