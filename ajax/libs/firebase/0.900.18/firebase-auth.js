    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (response.mfaInfo) {
                            multiFactorInfo = MultiFactorInfoImpl._fromServerResponse(_castAuth(auth), response.mfaInfo);
                        }
                        return [2 /*return*/, {
                                data: {
    ...
    function multiFactor(user) {
        if (!multiFactorUserCache.has(user)) {
            multiFactorUserCache.set(user, MultiFactorUserImpl._fromUser(user));
        }
