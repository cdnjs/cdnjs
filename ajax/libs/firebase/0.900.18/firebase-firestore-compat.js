...
/**
     ...
     * limitations under the License.
     */
const Ar=new w("@firebase/firestore");function Nr(){return Ar.logLevel}function xr(t,...e){if(Ar.logLevel<=l.DEBUG){const n=e.map(Rr);Ar.debug(`Firestore (8.3.0): ${t}`,...n)}}function Cr(t,...e){if(Ar.logLevel<=l.ERROR){const n=e.map(Rr);Ar.error(`Firestore (8.3.0): ${t}`,...n)}}function kr(t,...e){if(Ar.logLevel<=l.WARN){const n=e.map(Rr);Ar.warn(`Firestore (8.3.0): ${t}`,...n)}}function Rr(t){if("string"==typeof t)return t;try{return e=t,JSON.stringify(e)}catch(e){return t}
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Lr(t="Unexpected state"){const e="FIRESTORE (8.3.0) INTERNAL ASSERTION FAILED: "+t;throw Cr(e),new Error(e)}function Or(t,e){t||Lr()}function Mr(t,e){return t}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function _f(t="Unexpected state"){const e="FIRESTORE (8.3.0) INTERNAL ASSERTION FAILED: "+t;throw function(t,...e){if(If.logLevel<=l.ERROR){const n=e.map(Tf);If.error(`Firestore (8.3.0): ${t}`,...n)}}(e),new Error(e)}
/**
     * @license
     * Copyright 2017 Google LLC
     *
