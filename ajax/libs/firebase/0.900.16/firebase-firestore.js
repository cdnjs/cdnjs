    ...
    */
    ...
    function p$1(t, ...e) {
        if (V$1.logLevel <= LogLevel.DEBUG) {
            const n = e.map(S$1);
            V$1.debug(`Firestore (8.2.10): ${t}`, ...n);
        }
    }
    ...
    function b(t, ...e) {
        if (V$1.logLevel <= LogLevel.ERROR) {
            const n = e.map(S$1);
            V$1.error(`Firestore (8.2.10): ${t}`, ...n);
        }
    }
     ...
     */ function D$1(t = "Unexpected state") {
        ...
        const e = "FIRESTORE (8.2.10) INTERNAL ASSERTION FAILED: " + t;
     ...
     */ function Ke(t, e, n) {
        return t instanceof ze ? function(t, e, n) {
            ...
            return s = Ze(t.fieldTransforms, s, i), new xt(t.key, n.version, s, {
            ...
            const s = Ye(t.fieldTransforms, e, n.transformResults), i = Je(t, e, s);
    ...
    function ss(t, e) {
        return t && t.length > 0 ? (C(void 0 !== e), t.map((t => function(t, e) {
            ...
            return n.isEqual(H$1.min()) && (
            // The Firestore Emulator currently returns an update time of 0 for
            // deletes of non-existing documents (rather than null). This breaks the
            // test "get deleted doc while offline with source=cache" as NoDocuments
            // with version 0 are filtered by IndexedDb's RemoteDocumentCache.
            // TODO(#2149): Remove this when Emulator is fixed
            n = Un(e)), new Le(n, t.transformResults || []);
        }(t, e)))) : [];
    }
