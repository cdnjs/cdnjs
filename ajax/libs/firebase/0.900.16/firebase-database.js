(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function syncTreeAckUserWrite(syncTree, writeId, revert) {
        ...
        var write = syncTree.pendingWriteTree_.getWrite(writeId);
        var needToReevaluate = syncTree.pendingWriteTree_.removeWrite(writeId);
        if (!needToReevaluate) {
            return [];
        }
        else {
    ...
    function syncTreeAddEventRegistration(syncTree, query, eventRegistration) {
        ...
        var writesCache = syncTree.pendingWriteTree_.childWrites(path);
    ...
    function syncTreeGetServerValue(syncTree, query) {
        ...
        var serverCacheNode = serverCacheComplete
            ...
            : null;
        var writesCache = syncTree.pendingWriteTree_.childWrites(query.path);
    ...
    function syncTreeApplyOperationToSyncPoints_(syncTree, operation) {
        ...
        /*serverCache=*/ null, syncTree.pendingWriteTree_.childWrites(newEmptyPath()));
    }
    /**
    ...
    function syncTreeApplyTaggedOperation_(syncTree, queryPath, operation) {
        ...
        var writesCache = syncTree.pendingWriteTree_.childWrites(queryPath);
