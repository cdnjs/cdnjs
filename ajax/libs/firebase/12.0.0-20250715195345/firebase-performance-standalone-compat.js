...
/**
     ...
     * limitations under the License.
     */
function(e){je("@firebase/app-compat","0.5.0-20250715195345",e)}("lite");
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var pr;!function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.VISIBLE=1]="VISIBLE",e[e.HIDDEN=2]="HIDDEN"}(pr||(pr={}));const hr=["firebase_","google_","ga_"],gr=new RegExp("^[a-zA-Z]\\w*$");function mr(){const e=lr.getInstance().navigator;return e?.serviceWorker?e.serviceWorker.controller?2:3:1}function vr(){switch(lr.getInstance().document.visibilityState){case"visible":return pr.VISIBLE;case"hidden":return pr.HIDDEN;default:return pr.UNKNOWN}}function br(){const e=lr.getInstance().navigator.connection;switch(e&&e.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var ii;(ii=rt).INTERNAL.registerComponent(new y("performance-compat",ri,"PUBLIC")),ii.registerVersion("@firebase/performance-compat","0.2.21-20250715195345");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return rt.registerVersion("firebase","12.0.0-20250715195345","compat-lite"),rt}));
