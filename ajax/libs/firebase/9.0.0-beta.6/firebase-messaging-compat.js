...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const vt=e=>navigator?new mt(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-exp").getImmediate()):new mt(e.getProvider("app-compat").getImmediate(),e.getProvider("messaging-sw-exp").getImmediate());i.default.INTERNAL.registerComponent(new d("messaging-compat",vt,"PUBLIC")),i.default.registerVersion("@firebase/messaging-compat","0.0.900-exp.f43d0c698")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-messaging-compat.js - be sure to load firebase-app.js first.")}}));
