...
/**
     ...
     * limitations under the License.
     */
const tt=e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("analytics-exp").getImmediate();return new Qe(t,n)};!function(){const e={Analytics:Qe,settings:Ue,isSupported:We,EventName:et};o.default.INTERNAL.registerComponent(new E("analytics-compat",tt,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))}(),o.default.registerVersion("@firebase/analytics-compat","0.0.900-exp.725ab4684")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")}}));
