...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const Cr=new v("@firebase/firestore");function Rr(){return Cr.logLevel}function kr(t,...e){if(Cr.logLevel<=f.DEBUG){const n=e.map(Mr);Cr.debug(`Firestore (8.3.3): ${t}`,...n)}}function Lr(t,...e){if(Cr.logLevel<=f.ERROR){const n=e.map(Mr);Cr.error(`Firestore (8.3.3): ${t}`,...n)}}function Or(t,...e){if(Cr.logLevel<=f.WARN){const n=e.map(Mr);Cr.warn(`Firestore (8.3.3): ${t}`,...n)}}function Mr(t){if("string"==typeof t)return t;try{return e=t,JSON.stringify(e)}catch(e){return t}
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Pr(t="Unexpected state"){const e="FIRESTORE (8.3.3) INTERNAL ASSERTION FAILED: "+t;throw Lr(e),new Error(e)}function Fr(t,e){t||Pr()}function Vr(t,e){return t}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */e._registerComponent(new m("firestore-exp",((t,{options:e})=>{const n=t.getProvider("app-exp").getImmediate(),r=new Jl(n,t.getProvider("auth-internal"));return e&&r._setSettings(e),r}),"PUBLIC")),e.registerVersion("@firebase/firestore","0.0.900-exp.520ca39d0",undefined);
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Tf(t="Unexpected state"){const e="FIRESTORE (8.3.3) INTERNAL ASSERTION FAILED: "+t;throw function(t,...e){if(Ef.logLevel<=f.ERROR){const n=e.map(_f);Ef.error(`Firestore (8.3.3): ${t}`,...n)}}(e),new Error(e)}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t);return e._methodName="FieldValue.increment",new am(e)}isEqual(t){return this._delegate.isEqual(t._delegate)}}
/**
     * @license
     * Copyright 2021 Google LLC
     *
