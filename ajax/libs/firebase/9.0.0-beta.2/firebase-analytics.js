(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const publicFactory = (container) => {
        ...
        const platformLoggerProvider = app._getProvider(app$1, 'platform-logger');
    ...
    function getAnalytics(app$1 = app.getApp()) {
        app$1 = getModularInstance(app$1);
        // Dependencies
    ...
    function registerAnalytics() {
        app._registerComponent(new Component(ANALYTICS_TYPE, container => {
