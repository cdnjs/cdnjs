...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function _(e,t,n){void 0===t&&(t=1e3),void 0===n&&(n=2);var r=t*Math.pow(n,e),i=Math.round(.5*r*(Math.random()-.5)*2);return Math.min(144e5,r+i)}
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const _e="installations-exp",be=e=>{const n=e.getProvider("app-exp").getImmediate();return{app:n,appConfig:function(e){if(!e||!e.options)throw ve("App Configuration");if(!e.name)throw ve("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw ve(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(n),platformLoggerProvider:t._getProvider(n,"platform-logger"),_delete:()=>Promise.resolve()}},Ee=e=>{const n=e.getProvider("app-exp").getImmediate(),r=t._getProvider(n,_e).getImmediate();return{getId:()=>async function(e){const t=e,{installationEntry:n,registrationPromise:r}=await pe(t.appConfig);return r?r.catch(console.error):me(t).catch(console.error),n.fid}(r),getToken:e=>Ie(r,e)}};t._registerComponent(new E(_e,be,"PUBLIC")),t._registerComponent(new E("installations-exp-internal",Ee,"PRIVATE")),t.registerVersion("@firebase/installations-exp",F);
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */async function We(){if(d())return!1;if(!m())return!1;if(!h())return!1;try{return await g()}catch(e){return!1}}function ze(e,t,n){e=b(e),async function(e,t,n,r){if(r&&r.global)return e("set",{screen_name:n}),Promise.resolve();e("config",await t,{update:!0,screen_name:n})}(He,Me[e.app.options.appId],t,n).catch((e=>Ce.error(e)))}function Je(e,t,n){e=b(e),async function(e,t,n,r){if(r&&r.global)return e("set",{user_id:n}),Promise.resolve();e("config",await t,{update:!0,user_id:n})}(He,Me[e.app.options.appId],t,n).catch((e=>Ce.error(e)))}function Ye(e,t,n){e=b(e),async function(e,t,n,r){if(r&&r.global){const t={};for(const e of Object.keys(n))t[`user_properties.${e}`]=n[e];return e("set",t),Promise.resolve()}e("config",await t,{update:!0,user_properties:n})}(He,Me[e.app.options.appId],t,n).catch((e=>Ce.error(e)))}function Xe(e,t){e=b(e),async function(e,t){const n=await e;window[`ga-disable-${n}`]=!t}(Me[e.app.options.appId],t).catch((e=>Ce.error(e)))}function Ze(e,t,n,r){e=b(e),async function(e,t,n,r,i){if(i&&i.global)e("event",n,r);else{const i=await t;e("event",n,Object.assign(Object.assign({},r),{send_to:i}))}}(He,Me[e.app.options.appId],t,n,r).catch((e=>Ce.error(e)))}t._registerComponent(new E(Te,(e=>Ge(e.getProvider("app-exp").getImmediate(),e.getProvider("installations-exp-internal").getImmediate())),"PUBLIC")),t._registerComponent(new E("analytics-internal",(function(e){try{const t=e.getProvider(Te).getImmediate();return{logEvent:(e,n,r)=>Ze(t,e,n,r)}}catch(e){throw De.create("interop-component-reg-failed",{reason:e})}}),"PRIVATE")),t.registerVersion("@firebase/analytics-exp","0.0.900-exp.d92a36260");
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const tt=e=>{const t=e.getProvider("app-compat").getImmediate(),n=e.getProvider("analytics-exp").getImmediate();return new Qe(t,n)};!function(){const e={Analytics:Qe,settings:Ue,isSupported:We,EventName:et};o.default.INTERNAL.registerComponent(new E("analytics-compat",tt,"PUBLIC").setServiceProps(e).setMultipleInstances(!0))}(),o.default.registerVersion("@firebase/analytics-compat","0.0.900-exp.d92a36260")}).apply(this,arguments)}catch(e){throw console.error(e),new Error("Cannot instantiate firebase-analytics-compat.js - be sure to load firebase-app.js first.")}}));
