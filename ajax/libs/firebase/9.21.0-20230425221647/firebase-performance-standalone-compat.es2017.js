...
/**
     ...
     * limitations under the License.
     */
Se.registerVersion("firebase","9.21.0-20230425221647","app-compat");const Te="@firebase/installations",Ce="0.6.4",Ae=1e4,De="w:0.6.4",Ne="FIS_v2",Oe=36e5,ke=new h("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function Le(e){return e instanceof p&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
return Se.registerVersion("firebase","9.21.0-20230425221647","compat-lite"),Se}));
