...
/**
     ...
     * limitations under the License.
     */
function ye(e){const t={},n={__esModule:!0,initializeApp:function(r,i={}){const a=ie(r,i);if(f(t,a.name))return t[a.name];const o=new e(a,n);return t[a.name]=o,o},app:i,registerVersion:oe,setLogLevel:ce,onLog:se,apps:null,SDK_VERSION:re,INTERNAL:{registerComponent:function(t){const a=t.name,o=a.replace("-compat","");if(Q(t)&&"PUBLIC"===t.type){const s=(e=i())=>{if("function"!=typeof e[o])throw Ee.create("invalid-app-argument",{appName:a});return e[o]()};void 0!==t.serviceProps&&r(s,t.serviceProps),n[o]=s,e.prototype[o]=function(...e){return this._getService.bind(this,a).apply(this,t.multipleInstances?e:[])}}return"PUBLIC"===t.type?n[o]:null},removeApp:function(e){delete t[e]},useAsService:function(e,t){if("serverAuth"===t)return null;return t},modularAPIs:_e}};function i(e){if(!f(t,e=e||J))throw Ee.create("no-app",{appName:e});return t[e]}return n.default=n,Object.defineProperty(n,"apps",{get:function(){return Object.keys(t).map((e=>t[e]))}}),i.App=e,n}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
Ie.registerVersion("firebase","9.13.1-20221108184443","app-compat");const Se="@firebase/installations",Te="0.5.16",Ce=1e4,Ae="w:0.5.16",De="FIS_v2",Ne=36e5,Oe=new p("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function ke(e){return e instanceof u&&e.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var gn;(gn=Ie).INTERNAL.registerComponent(new m("performance-compat",dn,"PUBLIC")),gn.registerVersion("@firebase/performance-compat","0.1.17-20221108184443");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return Ie.registerVersion("firebase","9.13.1-20221108184443","compat-lite"),Ie}));
