...
/**
     ...
     * limitations under the License.
     */
const F=new u("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function."});
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var H;L(new m("platform-logger",(t=>new A(t)),"PRIVATE")),q(O,"0.7.1-2021823172527",H),q("fire-js","");var K=Object.freeze({__proto__:null,SDK_VERSION:U,_DEFAULT_ENTRY_NAME:k,_addComponent:j,_addOrOverwriteComponent:function(t,e){t.container.addOrOverwriteComponent(e)},_apps:D,_clearComponents:function(){R.clear()},_components:R,_getProvider:M,_registerComponent:L,_removeServiceInstance:function(t,e,n="[DEFAULT]"){M(t,e).clearInstance(n)},deleteApp:$,getApp:function(t="[DEFAULT]"){const e=D.get(t);if(!e)throw F.create("no-app",{appName:t});return e},getApps:function(){return Array.from(D.values())},initializeApp:x,onLog:z,registerVersion:q,setLogLevel:V,FirebaseError:c});
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
async function Kt(t,e=!1){const n=t;await async function(t){const{registrationPromise:e}=await Bt(t);e&&await e}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
let se,ce,ue,le;ae.logLevel=b.INFO;class pe{constructor(t){if(this.window=t,!t)throw oe.create("no window");this.performance=t.performance,this.PerformanceObserver=t.PerformanceObserver,this.windowLocation=t.location,this.navigator=t.navigator,this.document=t.document,this.navigator&&this.navigator.cookieEnabled&&(this.localStorage=t.localStorage),t.perfMetrics&&t.perfMetrics.onFirstInputDelay&&(this.onFirstInputDelay=t.perfMetrics.onFirstInputDelay)}getUrl(){return this.windowLocation.href.split("?")[0]}mark(t){this.performance&&this.performance.mark&&this.performance.mark(t)}measure(t,e,n){this.performance&&this.performance.measure&&this.performance.measure(t,e,n)}getEntriesByType(t){return this.performance&&this.performance.getEntriesByType?this.performance.getEntriesByType(t):[]}getEntriesByName(t){return this.performance&&this.performance.getEntriesByName?this.performance.getEntriesByName(t):[]}getTimeOrigin(){return this.performance&&(this.performance.timeOrigin||this.performance.timing.navigationStart)}requiredApisAvailable(){return fetch&&Promise&&"undefined"!=typeof navigator&&navigator.cookieEnabled?"object"==typeof indexedDB||(ae.info("IndexedDB is not supported by current browswer"),!1):(ae.info("Firebase Performance cannot start if browser does not support fetch and Promise or cookie is disabled."),!1)}setupObserver(t,e){if(!this.PerformanceObserver)return;new this.PerformanceObserver((t=>{for(const n of t.getEntries())e(n)})).observe({entryTypes:[t]})}static getInstance(){return void 0===se&&(se=new pe(ce)),se}}function fe(){return ue}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const Re=1e4;let je,Le=3,Me=[],Fe=!1;function Be(t){setTimeout((()=>{if(0!==Le)return Me.length?void function(){const t=Me.splice(0,1e3),e=t.map((t=>({source_extension_json_proto3:t.message,event_time_ms:String(t.eventTime)})));(function(t,e){return function(t){const e=he.getInstance().getFlTransportFullUrl();return fetch(e,{method:"POST",body:JSON.stringify(t)})}(t).then((t=>(t.ok||ae.info("Call to Firebase backend failed."),t.json()))).then((t=>{const n=Number(t.nextRequestWaitMillis);let r=Re;isNaN(n)||(r=Math.max(n,r));const i=t.logResponseDetails;Array.isArray(i)&&i.length>0&&"RETRY_REQUEST_LATER"===i[0].responseAction&&(Me=[...e,...Me],ae.info("Retry transport request later.")),Le=3,Be(r)}))})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:he.getInstance().logSource,log_event:e},t).catch((()=>{Me=[...t,...Me],Le--,ae.info(`Tries left: ${Le}.`),Be(Re)}))}():Be(Re)}),t)}function Ue(t){return(...e)=>{!function(t){if(!t.eventTime||!t.message)throw oe.create("invalid cc log");Me=[...Me,t]}({message:t(...e),eventTime:Date.now()})}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var Qe;(Qe=Y).INTERNAL.registerComponent(new m("performance-compat",Ze,"PUBLIC")),Qe.registerVersion("@firebase/performance-compat","0.1.1-2021823172527");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return Y.registerVersion("firebase","9.1.0-2021823172527","compat-lite"),Y}));
