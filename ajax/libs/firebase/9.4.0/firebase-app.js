...
const name$o = "https://www.gstatic.com/firebasejs/9.4.0/firebase-app.js";
 ...
 * limitations under the License.
 */
const logger = new Logger('https://www.gstatic.com/firebasejs/9.4.0/firebase-app.js');

const name$n = "https://www.gstatic.com/firebasejs/9.4.0/firebase-app.js-compat";

const name$m = "@firebase/analytics-compat";

const name$l = "@firebase/analytics";

const name$k = "https://www.gstatic.com/firebasejs/9.4.0/firebase-app.js-check-compat";

const name$j = "https://www.gstatic.com/firebasejs/9.4.0/firebase-app.js-check";
