...
const name$n = "@firebase/app";
const version$1 = "0.7.0-202172325639";
...
const name$m = "@firebase/app-compat";

const name$l = "@firebase/analytics-compat";

const name$k = "@firebase/analytics";

const name$j = "@firebase/app-check-compat";

const name$i = "@firebase/app-check";

const name$h = "@firebase/auth";

const name$g = "@firebase/auth-compat";

const name$f = "@firebase/database";

const name$e = "@firebase/database-compat";

const name$d = "@firebase/functions";

const name$c = "@firebase/functions-compat";

const name$b = "@firebase/installations";

const name$a = "@firebase/installations-compat";

const name$9 = "@firebase/messaging";

const name$8 = "@firebase/messaging-compat";

const name$7 = "@firebase/performance";

const name$6 = "@firebase/performance-compat";

const name$5 = "@firebase/remote-config";

const name$4 = "@firebase/remote-config-compat";

const name$3 = "@firebase/storage";

const name$2 = "@firebase/storage-compat";

const name$1 = "@firebase/firestore";

const name$o = "firebase";
const version$2 = "9.0.0-202172325639";
...
const PLATFORM_LOG_STRING = {
    [name$n]: 'fire-core',
    [name$m]: 'fire-core-compat',
    [name$k]: 'fire-analytics',
    [name$l]: 'fire-analytics-compat',
    [name$i]: 'fire-app-check',
    [name$j]: 'fire-app-check-compat',
    [name$h]: 'fire-auth',
    [name$g]: 'fire-auth-compat',
    [name$f]: 'fire-rtdb',
    [name$e]: 'fire-rtdb-compat',
    [name$d]: 'fire-fn',
    [name$c]: 'fire-fn-compat',
    [name$b]: 'fire-iid',
    [name$a]: 'fire-iid-compat',
    [name$9]: 'fire-fcm',
    [name$8]: 'fire-fcm-compat',
    [name$7]: 'fire-perf',
    [name$6]: 'fire-perf-compat',
    [name$5]: 'fire-rc',
    [name$4]: 'fire-rc-compat',
    [name$3]: 'fire-gcs',
    [name$2]: 'fire-gcs-compat',
    [name$1]: 'fire-fst',
...
function registerCoreComponents(variant) {
    ...
    registerVersion(name$n, version$1, variant);
...
const version = "0.12.0-202172325639";
