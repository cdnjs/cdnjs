 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.1.0-2021824202338/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.1.0-2021824202338/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
 ...
 */ function Yn(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof Wn && e instanceof Wn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Hn && e instanceof Hn && (wn(t.query, e.query) && mt(t.docs, e.docs, Yn));
}
...
function Dr(t, e) {
    if ((t = getModularInstance(t)).firestore !== e) throw new L(T, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("firestore-lite", "3.1.0-2021824202338", "node");
