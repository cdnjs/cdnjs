...
/**
     ...
     * limitations under the License.
     */
var $t;($t=r.default).INTERNAL.registerComponent(new p("remoteConfig-compat",qt,"PUBLIC").setMultipleInstances(!0)),$t.registerVersion("@firebase/remote-config-compat","0.0.900-exp.57f19127c")}).apply(this,arguments)}catch(t){throw console.error(t),new Error("Cannot instantiate firebase-remote-config-compat.js - be sure to load firebase-app.js first.")}}));
