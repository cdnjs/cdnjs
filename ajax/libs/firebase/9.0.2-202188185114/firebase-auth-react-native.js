...
import app from 'https://www.gstatic.com/firebasejs/9.0.2-202188185114/firebase-app.js';
                    ...
                    return tslib.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, storage.setItem(enum_mapsBe2311cd.STORAGE_AVAILABLE_KEY, '1')];
                            case 1:
                                _b.sent();
                                return [4 /*yield*/, storage.removeItem(enum_mapsBe2311cd.STORAGE_AVAILABLE_KEY)];
                            case 2:
                                _b.sent();
                                return [2 /*return*/, true];
                            case 3:
...
function getAuth(app$1) {
    ...
    return enum_mapsBe2311cd.initializeAuth(app$1, {
        persistence: reactNativeLocalPersistence
    });
}
enum_mapsBe2311cd.registerAuth("ReactNative" /* REACT_NATIVE */);

var ActionCodeOperation = enum_mapsBe2311cd.ActionCodeOperation;
var ActionCodeURL = enum_mapsBe2311cd.ActionCodeURL;
var AuthCredential = enum_mapsBe2311cd.AuthCredential;
var AuthErrorCodes = enum_mapsBe2311cd.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
var EmailAuthCredential = enum_mapsBe2311cd.EmailAuthCredential;
var EmailAuthProvider = enum_mapsBe2311cd.EmailAuthProvider;
var FacebookAuthProvider = enum_mapsBe2311cd.FacebookAuthProvider;
var FactorId = enum_mapsBe2311cd.FactorId;
var GithubAuthProvider = enum_mapsBe2311cd.GithubAuthProvider;
var GoogleAuthProvider = enum_mapsBe2311cd.GoogleAuthProvider;
var OAuthCredential = enum_mapsBe2311cd.OAuthCredential;
var OAuthProvider = enum_mapsBe2311cd.OAuthProvider;
var OperationType = enum_mapsBe2311cd.OperationType;
var PhoneAuthCredential = enum_mapsBe2311cd.PhoneAuthCredential;
var ProviderId = enum_mapsBe2311cd.ProviderId;
var SAMLAuthProvider = enum_mapsBe2311cd.SAMLAuthProvider;
var SignInMethod = enum_mapsBe2311cd.SignInMethod;
var TwitterAuthProvider = enum_mapsBe2311cd.TwitterAuthProvider;
var applyActionCode = enum_mapsBe2311cd.applyActionCode;
var checkActionCode = enum_mapsBe2311cd.checkActionCode;
var confirmPasswordReset = enum_mapsBe2311cd.confirmPasswordReset;
var connectAuthEmulator = enum_mapsBe2311cd.connectAuthEmulator;
var createUserWithEmailAndPassword = enum_mapsBe2311cd.createUserWithEmailAndPassword;
var debugErrorMap = enum_mapsBe2311cd.debugErrorMap;
var deleteUser = enum_mapsBe2311cd.deleteUser;
var fetchSignInMethodsForEmail = enum_mapsBe2311cd.fetchSignInMethodsForEmail;
var getAdditionalUserInfo = enum_mapsBe2311cd.getAdditionalUserInfo;
var getIdToken = enum_mapsBe2311cd.getIdToken;
var getIdTokenResult = enum_mapsBe2311cd.getIdTokenResult;
var getMultiFactorResolver = enum_mapsBe2311cd.getMultiFactorResolver;
var inMemoryPersistence = enum_mapsBe2311cd.inMemoryPersistence;
var initializeAuth = enum_mapsBe2311cd.initializeAuth;
var isSignInWithEmailLink = enum_mapsBe2311cd.isSignInWithEmailLink;
var linkWithCredential = enum_mapsBe2311cd.linkWithCredential;
var multiFactor = enum_mapsBe2311cd.multiFactor;
var onAuthStateChanged = enum_mapsBe2311cd.onAuthStateChanged;
var onIdTokenChanged = enum_mapsBe2311cd.onIdTokenChanged;
var parseActionCodeURL = enum_mapsBe2311cd.parseActionCodeURL;
var prodErrorMap = enum_mapsBe2311cd.prodErrorMap;
var reauthenticateWithCredential = enum_mapsBe2311cd.reauthenticateWithCredential;
var reload = enum_mapsBe2311cd.reload;
var sendEmailVerification = enum_mapsBe2311cd.sendEmailVerification;
var sendPasswordResetEmail = enum_mapsBe2311cd.sendPasswordResetEmail;
var sendSignInLinkToEmail = enum_mapsBe2311cd.sendSignInLinkToEmail;
var setPersistence = enum_mapsBe2311cd.setPersistence;
var signInAnonymously = enum_mapsBe2311cd.signInAnonymously;
var signInWithCredential = enum_mapsBe2311cd.signInWithCredential;
var signInWithCustomToken = enum_mapsBe2311cd.signInWithCustomToken;
var signInWithEmailAndPassword = enum_mapsBe2311cd.signInWithEmailAndPassword;
var signInWithEmailLink = enum_mapsBe2311cd.signInWithEmailLink;
var signOut = enum_mapsBe2311cd.signOut;
var unlink = enum_mapsBe2311cd.unlink;
var updateCurrentUser = enum_mapsBe2311cd.updateCurrentUser;
var updateEmail = enum_mapsBe2311cd.updateEmail;
var updatePassword = enum_mapsBe2311cd.updatePassword;
var updateProfile = enum_mapsBe2311cd.updateProfile;
var useDeviceLanguage = enum_mapsBe2311cd.useDeviceLanguage;
var verifyBeforeUpdateEmail = enum_mapsBe2311cd.verifyBeforeUpdateEmail;
var verifyPasswordResetCode = enum_mapsBe2311cd.verifyPasswordResetCode;
