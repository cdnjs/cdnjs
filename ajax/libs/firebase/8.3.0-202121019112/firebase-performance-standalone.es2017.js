...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class c{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map}get(t="[DEFAULT]"){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const t=new e;this.instancesDeferred.set(n,t);try{const e=this.getOrInitializeService(n);e&&t.resolve(e)}catch(t){}}return this.instancesDeferred.get(n).promise}getImmediate(t){const{identifier:e,optional:n}=Object.assign({identifier:a,optional:!1},t),r=this.normalizeInstanceIdentifier(e);try{const t=this.getOrInitializeService(r);if(!t){if(n)return null;throw Error(`Service ${this.name} is not available`)}return t}catch(t){if(n)return null;throw t}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,function(t){return"EAGER"===t.instantiationMode}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t))try{this.getOrInitializeService(a)}catch(t){}for(const[t,e]of this.instancesDeferred.entries()){const n=this.normalizeInstanceIdentifier(t);try{const t=this.getOrInitializeService(n);e.resolve(t)}catch(t){}}}clearInstance(t="[DEFAULT]"){this.instancesDeferred.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter((t=>"INTERNAL"in t)).map((t=>t.INTERNAL.delete())),...t.filter((t=>"_delete"in t)).map((t=>t._delete()))])}isComponentSet(){return null!=this.component}isInitialized(t="[DEFAULT]"){return this.instances.has(t)}getOrInitializeService(t){let e=this.instances.get(t);return!e&&this.component&&(e=this.component.instanceFactory(this.container,function(t){return t===a?void 0:t}(t)),this.instances.set(t,e)),e||null}normalizeInstanceIdentifier(t){return this.component?this.component.multipleInstances?t:a:t}}class u{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const e=this.getProvider(t.name);if(e.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);e.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const e=new c(t,this);return this.providers.set(t,e),e}getProviders(){return Array.from(this.providers.values())}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const A=function(){const t=S(I);t.SDK_VERSION=`${t.SDK_VERSION}_LITE`;const e=t.INTERNAL.registerComponent;return t.INTERNAL.registerComponent=function(t){if("PUBLIC"===t.type&&"performance"!==t.name&&"installations"!==t.name)throw Error(`${t.name} cannot register with the standalone perf instance`);return e(t)},t}();function N(t){return Array.prototype.slice.call(t)}function O(t){return new Promise((function(e,n){t.onsuccess=function(){e(t.result)},t.onerror=function(){n(t.error)}}))}function C(t,e,n){var r,i=new Promise((function(i,o){O(r=t[e].apply(t,n)).then(i,o)}));return i.request=r,i}function D(t,e,n){var r=C(t,e,n);return r.then((function(t){if(t)return new M(t,r.request)}))}function k(t,e,n){n.forEach((function(n){Object.defineProperty(t.prototype,n,{get:function(){return this[e][n]},set:function(t){this[e][n]=t}})}))}function R(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return C(this[e],r,arguments)})}))}function L(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return this[e][r].apply(this[e],arguments)})}))}function P(t,e,n,r){r.forEach((function(r){r in n.prototype&&(t.prototype[r]=function(){return D(this[e],r,arguments)})}))}function j(t){this._index=t}function M(t,e){this._cursor=t,this._request=e}function $(t){this._store=t}function B(t){this._tx=t,this.complete=new Promise((function(e,n){t.oncomplete=function(){e()},t.onerror=function(){n(t.error)},t.onabort=function(){n(t.error)}}))}function U(t,e,n){this._db=t,this.oldVersion=e,this.transaction=new B(n)}function F(t){this._db=t}!function(t,e){t.INTERNAL.registerComponent(new s("platform-logger",(t=>new T(t)),"PRIVATE")),t.registerVersion(w,"0.6.16-202121019112",e),t.registerVersion("fire-js","")}(A,"lite"),k(j,"_index",["name","keyPath","multiEntry","unique"]),R(j,"_index",IDBIndex,["get","getKey","getAll","getAllKeys","count"]),P(j,"_index",IDBIndex,["openCursor","openKeyCursor"]),k(M,"_cursor",["direction","key","primaryKey","value"]),R(M,"_cursor",IDBCursor,["update","delete"]),["advance","continue","continuePrimaryKey"].forEach((function(t){t in IDBCursor.prototype&&(M.prototype[t]=function(){var e=this,n=arguments;return Promise.resolve().then((function(){return e._cursor[t].apply(e._cursor,n),O(e._request).then((function(t){if(t)return new M(t,e._request)}))}))})})),$.prototype.createIndex=function(){return new j(this._store.createIndex.apply(this._store,arguments))},$.prototype.index=function(){return new j(this._store.index.apply(this._store,arguments))},k($,"_store",["name","keyPath","indexNames","autoIncrement"]),R($,"_store",IDBObjectStore,["put","add","delete","clear","get","getAll","getKey","getAllKeys","count"]),P($,"_store",IDBObjectStore,["openCursor","openKeyCursor"]),L($,"_store",IDBObjectStore,["deleteIndex"]),B.prototype.objectStore=function(){return new $(this._tx.objectStore.apply(this._tx,arguments))},k(B,"_tx",["objectStoreNames","mode"]),L(B,"_tx",IDBTransaction,["abort"]),U.prototype.createObjectStore=function(){return new $(this._db.createObjectStore.apply(this._db,arguments))},k(U,"_db",["name","version","objectStoreNames"]),L(U,"_db",IDBDatabase,["deleteObjectStore","close"]),F.prototype.transaction=function(){return new B(this._db.transaction.apply(this._db,arguments))},k(F,"_db",["name","version","objectStoreNames"]),L(F,"_db",IDBDatabase,["close"]),["openCursor","openKeyCursor"].forEach((function(t){[$,j].forEach((function(e){t in e.prototype&&(e.prototype[t.replace("open","iterate")]=function(){var e=N(arguments),n=e[e.length-1],r=this._store||this._index,i=r[t].apply(r,e.slice(0,-1));i.onsuccess=function(){n(i.result)}})}))})),[j,$].forEach((function(t){t.prototype.getAll||(t.prototype.getAll=function(t,e){var n=this,r=[];return new Promise((function(i){n.iterateCursor(t,(function(t){t?(r.push(t.value),void 0===e||r.length!=e?t.continue():i(r)):i(r)}))}))})}));const x="0.4.21-202121019112",q=1e4,V=`w:${x}`,H="FIS_v2",K=36e5,z=new r("installations","Installations",{"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."});function W(t){return t instanceof n&&t.code.includes("request-failed")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function J({projectId:t}){return`https://firebaseinstallations.googleapis.com/v1/projects/${t}/installations`}function G(t){return{token:t.token,requestStatus:2,expiresIn:(e=t.expiresIn,Number(e.replace("s","000"))),creationTime:Date.now()};var e}async function Y(t,e){const n=(await e.json()).error;return z.create("request-failed",{requestName:t,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function Z({apiKey:t}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":t})}function Q(t,{refreshToken:e}){const n=Z(t);return n.append("Authorization",function(t){return`FIS_v2 ${t}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(e)),n}async function X(t){const e=await t();return e.status>=500&&e.status<600?t():e}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */async function mt(t){let e;const n=await gt(t,(n=>{const r=function(t){return wt(t||{fid:nt(),registrationStatus:0})}(n),i=function(t,e){if(0===e.registrationStatus){if(!navigator.onLine){return{installationEntry:e,registrationPromise:Promise.reject(z.create("app-offline"))}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()};return{installationEntry:n,registrationPromise:async function(t,e){try{return ht(t,await async function(t,{fid:e}){const n=J(t),r=Z(t),i={fid:e,authVersion:H,appId:t.appId,sdkVersion:V},o={method:"POST",headers:r,body:JSON.stringify(i)},s=await X((()=>fetch(n,o)));if(s.ok){const t=await s.json();return{fid:t.fid||e,registrationStatus:2,refreshToken:t.refreshToken,authToken:G(t.authToken)}}throw await Y("Create Installation",s)}(t,e))}catch(n){throw W(n)&&409===n.customData.serverCode?await dt(t):await ht(t,{fid:e.fid,registrationStatus:0}),n}}(t,n)}}return 1===e.registrationStatus?{installationEntry:e,registrationPromise:vt(t)}:{installationEntry:e}}(t,r);return e=i.registrationPromise,i.installationEntry}));return""===n.fid?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}async function vt(t){let e=await bt(t);for(;1===e.registrationStatus;)await tt(100),e=await bt(t);if(0===e.registrationStatus){const{installationEntry:e,registrationPromise:n}=await mt(t);return n||e}return e}function bt(t){return gt(t,(t=>{if(!t)throw z.create("installation-not-found");return wt(t)}))}function wt(t){return 1===(e=t).registrationStatus&&e.registrationTime+q<Date.now()?{fid:t.fid,registrationStatus:0}:t;var e;
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */}async function yt({appConfig:t,platformLoggerProvider:e},n){const r=function(t,{fid:e}){return`${J(t)}/${e}/authTokens:generate`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t,n),i=Q(t,n),o=e.getImmediate({optional:!0});o&&i.append("x-firebase-client",o.getPlatformInfoString());const s={installation:{sdkVersion:V}},a={method:"POST",headers:i,body:JSON.stringify(s)},c=await X((()=>fetch(r,a)));if(c.ok){return G(await c.json())}throw await Y("Generate Auth Token",c)}async function _t(t,e=!1){let n;const r=await gt(t.appConfig,(r=>{if(!Et(r))throw z.create("not-registered");const i=r.authToken;if(!e&&function(t){return 2===t.requestStatus&&!function(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+K}(t)}(i))return r;if(1===i.requestStatus)return n=async function(t,e){let n=await It(t.appConfig);for(;1===n.authToken.requestStatus;)await tt(100),n=await It(t.appConfig);const r=n.authToken;return 0===r.requestStatus?_t(t,e):r}(t,e),r;{if(!navigator.onLine)throw z.create("app-offline");const e=function(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}(r);return n=async function(t,e){try{const n=await yt(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await ht(t.appConfig,r),n}catch(n){if(!W(n)||401!==n.customData.serverCode&&404!==n.customData.serverCode){const n=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await ht(t.appConfig,n)}else await dt(t.appConfig);throw n}}(t,e),e}}));return n?await n:r.authToken}function It(t){return gt(t,(t=>{if(!Et(t))throw z.create("not-registered");const e=t.authToken;return 1===(n=e).requestStatus&&n.requestTime+q<Date.now()?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t;var n;
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t.appConfig);return(await _t(t,e)).token}async function Tt(t,e){const n=function(t,{fid:e}){return`${J(t)}/${e}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */(t,e),r={method:"DELETE",headers:Q(t,e)},i=await X((()=>fetch(n,r)));if(!i.ok)throw await Y("Delete Installation",i)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Nt(t){return z.create("missing-app-config-values",{valueName:t})}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var Ot;(Ot=A).INTERNAL.registerComponent(new s("installations",(t=>{const e=t.getProvider("app").getImmediate(),n={appConfig:function(t){if(!t||!t.options)throw Nt("App Configuration");if(!t.name)throw Nt("App Name");const e=["projectId","apiKey","appId"];for(const n of e)if(!t.options[n])throw Nt(n);return{appName:t.name,projectId:t.options.projectId,apiKey:t.options.apiKey,appId:t.options.appId}}(e),platformLoggerProvider:t.getProvider("platform-logger")};return{app:e,getId:()=>async function(t){const{installationEntry:e,registrationPromise:n}=await mt(t.appConfig);return n?n.catch(console.error):_t(t).catch(console.error),e.fid}(n),getToken:t=>St(n,t),delete:()=>async function(t){const{appConfig:e}=t,n=await gt(e,(t=>{if(!t||0!==t.registrationStatus)return t}));if(n){if(1===n.registrationStatus)throw z.create("delete-pending-registration");if(2===n.registrationStatus){if(!navigator.onLine)throw z.create("app-offline");await Tt(e,n),await dt(e)}}}(n),onIdChange:t=>At(n,t)}}),"PUBLIC")),Ot.registerVersion("@firebase/installations",x);const Ct="0.4.7-202121019112",Dt=Ct,kt="FB-PERF-TRACE-MEASURE",Rt="_wt_",Lt="_fcp",Pt="_fid",jt="@firebase/performance/config",Mt="@firebase/performance/configexpire",$t="Performance",Bt=new r("performance",$t,{"trace started":"Trace {$traceName} was started before.","trace stopped":"Trace {$traceName} is not running.","nonpositive trace startTime":"Trace {$traceName} startTime should be positive.","nonpositive trace duration":"Trace {$traceName} duration should be positive.","no window":"Window is not available.","no app id":"App id is not available.","no project id":"Project id is not available.","no api key":"Api key is not available.","invalid cc log":"Attempted to queue invalid cc event","FB not default":"Performance can only start when Firebase app instance is the default one.","RC response not ok":"RC response is not ok","invalid attribute name":"Attribute name {$attributeName} is invalid.","invalid attribute value":"Attribute value {$attributeValue} is invalid.","invalid custom metric name":"Custom metric name {$customMetricName} is invalid","invalid String merger input":"Input for String merger is invalid, contact support team to resolve."}),Ut=new m($t);
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function Kt(t,e){const n=t.length-e.length;if(n<0||n>1)throw Bt.create("invalid String merger input");const r=[];for(let n=0;n<t.length;n++)r.push(t.charAt(n)),e.length>n&&r.push(e.charAt(n));return r.join("")}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class zt{constructor(){this.instrumentationEnabled=!0,this.dataCollectionEnabled=!0,this.loggingEnabled=!1,this.tracesSamplingRate=1,this.networkRequestsSamplingRate=1,this.logEndPointUrl="https://firebaselogging.googleapis.com/v0cc/log?format=json_proto",this.flTransportEndpointUrl=Kt("hts/frbslgigp.ogepscmv/ieo/eaylg","tp:/ieaeogn-agolai.o/1frlglgc/o"),this.transportKey=Kt("AzSC8r6ReiGqFMyfvgow","Iayx0u-XT3vksVM-pIV"),this.logSource=462,this.logTraceAfterSampling=!1,this.logNetworkAfterSampling=!1,this.configTimeToLive=12}getAppId(){const t=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.appId;if(!t)throw Bt.create("no app id");return t}getProjectId(){const t=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.projectId;if(!t)throw Bt.create("no project id");return t}getApiKey(){const t=this.firebaseAppInstance&&this.firebaseAppInstance.options&&this.firebaseAppInstance.options.apiKey;if(!t)throw Bt.create("no api key");return t}getFlTransportFullUrl(){return this.flTransportEndpointUrl.concat("?key=",this.transportKey)}static getInstance(){return void 0===qt&&(qt=new zt),qt}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var Jt;!function(t){t[t.UNKNOWN=0]="UNKNOWN",t[t.VISIBLE=1]="VISIBLE",t[t.HIDDEN=2]="HIDDEN"}(Jt||(Jt={}));const Gt=["firebase_","google_","ga_"],Yt=new RegExp("^[a-zA-Z]\\w*$");function Zt(){const t=Ht.getInstance().navigator;return"serviceWorker"in t?t.serviceWorker.controller?2:3:1}function Qt(){switch(Ht.getInstance().document.visibilityState){case"visible":return Jt.VISIBLE;case"hidden":return Jt.HIDDEN;default:return Jt.UNKNOWN}}function Xt(){const t=Ht.getInstance().navigator.connection;switch(t&&t.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function be(t,e){fe||(fe=ve(_e)),fe(t,e)}function we(t){const e=zt.getInstance();!e.instrumentationEnabled&&t.isAuto||(e.dataCollectionEnabled||t.isAuto)&&Ht.getInstance().requiredApisAvailable()&&(t.isAuto&&Qt()!==Jt.VISIBLE||(3===ce?ye(t):ue().then((()=>ye(t)),(()=>ye(t)))))}function ye(t){if(!Wt())return;const e=zt.getInstance();e.loggingEnabled&&e.logTraceAfterSampling&&setTimeout((()=>be(t,1)),0)}function _e(t,e){return 0===e?function(t){const e={url:t.url,http_method:t.httpMethod||0,http_response_code:200,response_payload_bytes:t.responsePayloadBytes,client_start_time_us:t.startTimeUs,time_to_response_initiated_us:t.timeToResponseInitiatedUs,time_to_response_completed_us:t.timeToResponseCompletedUs},n={application_info:Ie(),network_request_metric:e};return JSON.stringify(n)}(t):function(t){const e={name:t.name,is_auto:t.isAuto,client_start_time_us:t.startTimeUs,duration_us:t.durationUs};0!==Object.keys(t.counters).length&&(e.counters=t.counters);const n=t.getAttributes();0!==Object.keys(n).length&&(e.custom_attributes=n);const r={application_info:Ie(),trace_metric:e};return JSON.stringify(r)}(t)}function Ie(){return{google_app_id:zt.getInstance().getAppId(),app_instance_id:Wt(),web_app_info:{sdk_version:Dt,page_url:Ht.getInstance().getUrl(),service_worker_status:Zt(),visibility_state:Qt(),effective_connection_type:Xt()},application_process_state:0}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */class Oe{constructor(t){this.app=t,Ht.getInstance().requiredApisAvailable()&&new Promise(((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=window.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||window.indexedDB.deleteDatabase(r),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var t;e((null===(t=i.error)||void 0===t?void 0:t.message)||"")}}catch(t){e(t)}})).then((t=>{t&&(ge||(me(5500),ge=!0),ue().then(Ae,Ae))})).catch((t=>{Ut.info(`Environment doesn't support IndexedDB: ${t}`)}))}trace(t){return new Se(t)}set instrumentationEnabled(t){zt.getInstance().instrumentationEnabled=t}get instrumentationEnabled(){return zt.getInstance().instrumentationEnabled}set dataCollectionEnabled(t){zt.getInstance().dataCollectionEnabled=t}get dataCollectionEnabled(){return zt.getInstance().dataCollectionEnabled}}
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */!function(t){const e=(t,e)=>{if("[DEFAULT]"!==t.name)throw Bt.create("FB not default");if("undefined"==typeof window)throw Bt.create("no window");return function(t){xt=t}(window),zt.getInstance().firebaseAppInstance=t,zt.getInstance().installationsService=e,new Oe(t)};t.INTERNAL.registerComponent(new s("performance",(t=>{const n=t.getProvider("app").getImmediate(),r=t.getProvider("installations").getImmediate();return e(n,r)}),"PUBLIC")),t.registerVersion("@firebase/performance",Ct)}(A);
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return A.registerVersion("firebase","8.3.0-202121019112","lite"),A}));
