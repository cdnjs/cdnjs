import { _getProvider, getApp, _removeServiceInstance, _registerComponent, registerVersion, SDK_VERSION } from 'https://www.gstatic.com/firebasejs/9.0.2-2021891633/firebase-app.js';
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.2-2021891633/firebase-app.js#FirebaseApp} with which the `Firestore` instance will
 * be associated.
 ...
 *
 * @param app - The {@link https://www.gstatic.com/firebasejs/9.0.2-2021891633/firebase-app.js#FirebaseApp} instance that the returned `Firestore`
...
}), "PUBLIC" /* PUBLIC */)), registerVersion("firestore-lite", "3.0.2-2021891633", "node");
