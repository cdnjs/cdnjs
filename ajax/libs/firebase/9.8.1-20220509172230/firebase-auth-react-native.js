...
import require$$2 from 'https://www.gstatic.com/firebasejs/9.8.1-20220509172230/firebase-app.js';
...
var version = "0.20.1-20220509172230";
...
phone06ac76b0.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY;
phone06ac76b0.ActionCodeOperation = ActionCodeOperation$1;
phone06ac76b0.ActionCodeURL = ActionCodeURL$1;
phone06ac76b0.AuthCredential = AuthCredential$1;
phone06ac76b0.AuthImpl = AuthImpl;
phone06ac76b0.BaseOAuthProvider = BaseOAuthProvider;
phone06ac76b0.Delay = Delay;
phone06ac76b0.EmailAuthCredential = EmailAuthCredential$1;
phone06ac76b0.EmailAuthProvider = EmailAuthProvider$1;
phone06ac76b0.FacebookAuthProvider = FacebookAuthProvider$1;
phone06ac76b0.FactorId = FactorId$1;
phone06ac76b0.FederatedAuthProvider = FederatedAuthProvider;
phone06ac76b0.FetchProvider = FetchProvider;
phone06ac76b0.GithubAuthProvider = GithubAuthProvider$1;
phone06ac76b0.GoogleAuthProvider = GoogleAuthProvider$1;
phone06ac76b0.OAuthCredential = OAuthCredential$1;
phone06ac76b0.OAuthProvider = OAuthProvider$1;
phone06ac76b0.OperationType = OperationType$1;
phone06ac76b0.PhoneAuthCredential = PhoneAuthCredential$1;
phone06ac76b0.PhoneAuthProvider = PhoneAuthProvider$1;
phone06ac76b0.PhoneMultiFactorGenerator = PhoneMultiFactorGenerator$1;
phone06ac76b0.ProviderId = ProviderId$1;
phone06ac76b0.RecaptchaVerifier = RecaptchaVerifier;
phone06ac76b0.SAMLAuthCredential = SAMLAuthCredential;
phone06ac76b0.SAMLAuthProvider = SAMLAuthProvider$1;
phone06ac76b0.STORAGE_AVAILABLE_KEY = STORAGE_AVAILABLE_KEY;
phone06ac76b0.SignInMethod = SignInMethod$1;
phone06ac76b0.TwitterAuthProvider = TwitterAuthProvider$1;
phone06ac76b0.UserImpl = UserImpl;
phone06ac76b0._assert = _assert;
phone06ac76b0._assertInstanceOf = _assertInstanceOf;
phone06ac76b0._assertLinkedStatus = _assertLinkedStatus;
phone06ac76b0._castAuth = _castAuth;
phone06ac76b0._createError = _createError;
phone06ac76b0._emulatorUrl = _emulatorUrl;
phone06ac76b0._fail = _fail;
phone06ac76b0._generateCallbackName = _generateCallbackName;
phone06ac76b0._getActiveServiceWorker = _getActiveServiceWorker;
phone06ac76b0._getClientVersion = _getClientVersion;
phone06ac76b0._getCurrentUrl = _getCurrentUrl;
phone06ac76b0._getInstance = _getInstance;
phone06ac76b0._getServiceWorkerController = _getServiceWorkerController;
phone06ac76b0._getWorkerGlobalScope = _getWorkerGlobalScope;
phone06ac76b0._isAndroid = _isAndroid;
phone06ac76b0._isChromeIOS = _isChromeIOS;
phone06ac76b0._isFirefox = _isFirefox;
phone06ac76b0._isIE10 = _isIE10;
phone06ac76b0._isIOS = _isIOS;
phone06ac76b0._isIOS7Or8 = _isIOS7Or8;
phone06ac76b0._isIOSStandalone = _isIOSStandalone;
phone06ac76b0._isIframe = _isIframe;
phone06ac76b0._isMobileBrowser = _isMobileBrowser;
phone06ac76b0._isSafari = _isSafari;
phone06ac76b0._isWorker = _isWorker;
phone06ac76b0._link = _link;
phone06ac76b0._loadJS = _loadJS;
phone06ac76b0._performApiRequest = _performApiRequest;
phone06ac76b0._persistenceKeyName = _persistenceKeyName;
phone06ac76b0._reauthenticate = _reauthenticate;
phone06ac76b0._setWindowLocation = _setWindowLocation;
phone06ac76b0._signInWithCredential = _signInWithCredential;
phone06ac76b0._window = _window;
phone06ac76b0.applyActionCode = applyActionCode$2;
phone06ac76b0.beforeAuthStateChanged = beforeAuthStateChanged$1;
phone06ac76b0.checkActionCode = checkActionCode$1;
phone06ac76b0.confirmPasswordReset = confirmPasswordReset$1;
phone06ac76b0.connectAuthEmulator = connectAuthEmulator$1;
phone06ac76b0.createUserWithEmailAndPassword = createUserWithEmailAndPassword$1;
phone06ac76b0.debugAssert = debugAssert;
phone06ac76b0.debugErrorMap = debugErrorMap$1;
phone06ac76b0.deleteUser = deleteUser$1;
phone06ac76b0.fetchSignInMethodsForEmail = fetchSignInMethodsForEmail$1;
phone06ac76b0.getAdditionalUserInfo = getAdditionalUserInfo$1;
phone06ac76b0.getIdToken = getIdToken$1;
phone06ac76b0.getIdTokenResult = getIdTokenResult$1;
phone06ac76b0.getMultiFactorResolver = getMultiFactorResolver$1;
phone06ac76b0.inMemoryPersistence = inMemoryPersistence$1;
phone06ac76b0.initializeAuth = initializeAuth$1;
phone06ac76b0.isSignInWithEmailLink = isSignInWithEmailLink$1;
phone06ac76b0.linkWithCredential = linkWithCredential$1;
phone06ac76b0.linkWithPhoneNumber = linkWithPhoneNumber$2;
phone06ac76b0.multiFactor = multiFactor$1;
phone06ac76b0.onAuthStateChanged = onAuthStateChanged$1;
phone06ac76b0.onIdTokenChanged = onIdTokenChanged$1;
phone06ac76b0.parseActionCodeURL = parseActionCodeURL$1;
phone06ac76b0.prodErrorMap = prodErrorMap$1;
phone06ac76b0.reauthenticateWithCredential = reauthenticateWithCredential$1;
phone06ac76b0.reauthenticateWithPhoneNumber = reauthenticateWithPhoneNumber$1;
phone06ac76b0.registerAuth = registerAuth;
phone06ac76b0.reload = reload$1;
phone06ac76b0.sendEmailVerification = sendEmailVerification$2;
phone06ac76b0.sendPasswordResetEmail = sendPasswordResetEmail$2;
phone06ac76b0.sendSignInLinkToEmail = sendSignInLinkToEmail$2;
phone06ac76b0.setPersistence = setPersistence$1;
phone06ac76b0.signInAnonymously = signInAnonymously$1;
phone06ac76b0.signInWithCredential = signInWithCredential$1;
phone06ac76b0.signInWithCustomToken = signInWithCustomToken$2;
phone06ac76b0.signInWithEmailAndPassword = signInWithEmailAndPassword$1;
phone06ac76b0.signInWithEmailLink = signInWithEmailLink$2;
phone06ac76b0.signInWithIdp = signInWithIdp;
phone06ac76b0.signInWithPhoneNumber = signInWithPhoneNumber$2;
phone06ac76b0.signOut = signOut$1;
phone06ac76b0.unlink = unlink$1;
phone06ac76b0.updateCurrentUser = updateCurrentUser$1;
phone06ac76b0.updateEmail = updateEmail$1;
phone06ac76b0.updatePassword = updatePassword$1;
phone06ac76b0.updatePhoneNumber = updatePhoneNumber$1;
phone06ac76b0.updateProfile = updateProfile$2;
phone06ac76b0.useDeviceLanguage = useDeviceLanguage$1;
phone06ac76b0.verifyBeforeUpdateEmail = verifyBeforeUpdateEmail$1;
phone06ac76b0.verifyPasswordResetCode = verifyPasswordResetCode$1;

Object.defineProperty(rn, '__esModule', { value: true });

var ReactNative = require$$0;
var app = require$$2;
var phone = phone06ac76b0;
var tslib = require$$3;
