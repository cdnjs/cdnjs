...
/**
     ...
     * limitations under the License.
     */
class H{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}}const V="@firebase/app",z="0.7.23",x=new I("@firebase/app"),q="[DEFAULT]",W={[V]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},K=new Map,J=new Map;function G(e,t){try{e.container.addComponent(t)}catch(n){x.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Y(e){const t=e.name;if(J.has(t))return x.debug(`There were multiple attempts to register component ${t}.`),!1;J.set(t,e);for(const t of K.values())G(t,e);return!0}function X(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */const oe="firebase-heartbeat-store";let se=null;function ce(){return se||(se=R("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(oe)}}).catch((e=>{throw Z.create("storage-open",{originalErrorMessage:e.message})}))),se}async function le(e,t){try{const n=(await ce()).transaction(oe,"readwrite"),r=n.objectStore(oe);return await r.put(t,ue(e)),n.done}catch(e){throw Z.create("storage-set",{originalErrorMessage:e.message})}}function ue(e){return`${e.name}!${e.options.appId}`}
/**
     * @license
     * Copyright 2021 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
function(e){re("@firebase/app-compat","0.1.24",e)}("lite");
/**
     * @license
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Ne({projectId:e}){return`https://firebaseinstallations.googleapis.com/v1/projects/${e}/installations`}function Oe(e){return{token:e.token,requestStatus:2,expiresIn:(t=e.expiresIn,Number(t.replace("s","000"))),creationTime:Date.now()};var t}async function ke(e,t){const n=(await t.json()).error;return Ae.create("request-failed",{requestName:e,serverCode:n.code,serverMessage:n.message,serverStatus:n.status})}function Le({apiKey:e}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":e})}function Me(e,{refreshToken:t}){const n=Le(e);return n.append("Authorization",function(e){return`FIS_v2 ${e}`}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
const ze="firebase-installations-store";let xe=null;function qe(){return xe||(xe=R("firebase-installations-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(ze)}})),xe}async function We(e,t){const n=je(e),r=(await qe()).transaction(ze,"readwrite"),i=r.objectStore(ze),a=await i.get(n);return await i.put(t,n),await r.done,a&&a.fid===t.fid||Ue(e,t.fid),t}async function Ke(e){const t=je(e),n=(await qe()).transaction(ze,"readwrite");await n.objectStore(ze).delete(t),await n.done}async function Je(e,t){const n=je(e),r=(await qe()).transaction(ze,"readwrite"),i=r.objectStore(ze),a=await i.get(n),o=t(a);return void 0===o?await i.delete(n):await i.put(o,n),await r.done,!o||a&&a.fid===o.fid||Ue(e,o.fid),o}
/**
     * @license
     * Copyright 2019 Google LLC
     *
...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */var At;!function(e){e[e.UNKNOWN=0]="UNKNOWN",e[e.VISIBLE=1]="VISIBLE",e[e.HIDDEN=2]="HIDDEN"}(At||(At={}));const Dt=["firebase_","google_","ga_"],Nt=new RegExp("^[a-zA-Z]\\w*$");function Ot(){const e=It.getInstance().navigator;return"serviceWorker"in e?e.serviceWorker.controller?2:3:1}function kt(){switch(It.getInstance().document.visibilityState){case"visible":return At.VISIBLE;case"hidden":return At.HIDDEN;default:return At.UNKNOWN}}function Lt(){const e=It.getInstance().navigator.connection;switch(e&&e.effectiveType){case"slow-2g":return 1;case"2g":return 2;case"3g":return 3;case"4g":return 4;default:return 0}}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * limitations under the License.
     */
function Mt(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.appId;if(!n)throw bt.create("no app id");return n}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * limitations under the License.
     */
const Pt="0.0.1",Bt=!0,Rt="FIREBASE_INSTALLATIONS_AUTH";function $t(e,t){const n=function(){const e=It.getInstance().localStorage;if(!e)return;const t=e.getItem(gt);if(!(t&&(n=t,Number(n)>Date.now())))return;var n;const r=e.getItem(dt);if(!r)return;try{return JSON.parse(r)}catch(e){return}}();return n?(Ft(n),Promise.resolve()):function(e,t){return function(e){const t=e.getToken();return t.then((e=>{})),t}(e.installations).then((n=>{const r=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.projectId;if(!n)throw bt.create("no project id");return n}(e.app),i=function(e){var t;const n=null===(t=e.options)||void 0===t?void 0:t.apiKey;if(!n)throw bt.create("no api key");return n}(e.app),a=new Request(`https://firebaseremoteconfig.googleapis.com/v1/projects/${r}/namespaces/fireperf:fetch?key=${i}`,{method:"POST",headers:{Authorization:`${Rt} ${n}`},body:JSON.stringify({app_instance_id:t,app_instance_id_token:n,app_id:Mt(e.app),app_version:lt,sdk_version:Pt})});return fetch(a).then((e=>{if(e.ok)return e.json();throw bt.create("RC response not ok")}))})).catch((()=>{vt.info(jt)}))}(e,t).then(Ft).then((e=>function(e){const t=It.getInstance().localStorage;if(!e||!t)return;t.setItem(dt,JSON.stringify(e)),t.setItem(gt,String(Date.now()+60*Ct.getInstance().configTimeToLive*60*1e3))}(e)),(()=>{}))}const jt="Could not fetch config, will use default configs";function Ft(e){if(!e)return e;const t=Ct.getInstance(),n=e.entries||{};return void 0!==n.fpr_enabled?t.loggingEnabled="true"===String(n.fpr_enabled):t.loggingEnabled=Bt,n.fpr_log_source&&(t.logSource=Number(n.fpr_log_source)),n.fpr_log_endpoint_url&&(t.logEndPointUrl=n.fpr_log_endpoint_url),n.fpr_log_transport_key&&(t.transportKey=n.fpr_log_transport_key),void 0!==n.fpr_vc_network_request_sampling_rate&&(t.networkRequestsSamplingRate=Number(n.fpr_vc_network_request_sampling_rate)),void 0!==n.fpr_vc_trace_sampling_rate&&(t.tracesSamplingRate=Number(n.fpr_vc_trace_sampling_rate)),t.logTraceAfterSampling=Ut(t.tracesSamplingRate),t.logNetworkAfterSampling=Ut(t.networkRequestsSamplingRate),e}function Ut(e){return Math.random()<=e}
/**
     * @license
     * Copyright 2020 Google LLC
     *
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */let Ht,Vt=1;function zt(e){return Vt=2,Ht=Ht||function(e){return function(){const e=It.getInstance().document;return new Promise((t=>{if(e&&"complete"!==e.readyState){const n=()=>{"complete"===e.readyState&&(e.removeEventListener("readystatechange",n),t())};e.addEventListener("readystatechange",n)}else t()}))}().then((()=>function(e){const t=e.getId();return t.then((e=>{yt=e})),t}(e.installations))).then((t=>$t(e,t))).then((()=>xt()),(()=>xt()))}(e),Ht}function xt(){Vt=3}
/**
     * @license
     * Copyright 2020 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
var pn;(pn=we).INTERNAL.registerComponent(new f("performance-compat",hn,"PUBLIC")),pn.registerVersion("@firebase/performance-compat","0.1.9");
/**
     * @license
     * Copyright 2019 Google LLC
     *
     ...
     * limitations under the License.
     */
return we.registerVersion("firebase","9.8.1-20220509172230","compat-lite"),we}));
