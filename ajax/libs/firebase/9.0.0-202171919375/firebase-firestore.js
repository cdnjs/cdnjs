...
const name = "firebase";
const version = "9.0.0-202171919375";
 ...
 */ class gt {
    ...
    static fromPath(t) {
        return new gt(et.fromString(t));
    }
    static fromName(t) {
        return new gt(et.fromString(t).popFirst(5));
    }
...
/** Extracts the backend's type order for the provided value. */ function yt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? lt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : B();
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === s ? _t(n) === _t(s) : isNaN(n) && isNaN(s);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return G(t.arrayValue.values || [], e.arrayValue.values || [], pt);
...
function Tt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = W(ut(t.latitude), ut(e.latitude));
            if (0 !== n) return n;
            return W(ut(t.longitude), ut(e.longitude));
...
/** Creates a deep copy of `source`. */ function Ct(t) {
    ...
    if (t.mapValue) {
        ...
        return X(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Ct(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
        ...
        for (let n = 0; n < (t.arrayValue.values || []).length; ++n) e.arrayValue.values[n] = Ct(t.arrayValue.values[n]);
        return e;
    }
 ...
 */ class Nt {
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = Ct(t) : s.push(i.lastSegment());
        }));
     ...
     */    delete(t) {
        ...
        Dt(e) && e.mapValue.fields && delete e.mapValue.fields[t.lastSegment()];
    }
    isEqual(t) {
 ...
 */ class kt {
     ...
     */    static newInvalidDocument(t) {
        return new kt(t, 0 /* INVALID */ , J.min(), Nt.empty(), 0 /* SYNCED */);
    }
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new kt(t, 2 /* NO_DOCUMENT */ , e, Nt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new kt(t, 3 /* UNKNOWN_DOCUMENT */ , e, Nt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
     ...
     */    convertToNoDocument(t) {
        return this.version = t, this.documentType = 2 /* NO_DOCUMENT */ , this.data = Nt.empty(), 
        this.documentState = 0 /* SYNCED */ , this;
    }
    /**
     ...
     */    convertToUnknownDocument(t) {
        return this.version = t, this.documentType = 3 /* UNKNOWN_DOCUMENT */ , this.data = Nt.empty(), 
 ...
 * property.
 */ function Ot(t, e = null, n = [], s = [], i = null, r = null, o = null) {
    return new $t(t, e, n, s, i, r, o);
}
...
function Ft(t) {
    ...
    if (null === e.h) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => qt(t))).join(","), 
        t += "|ob:", t += e.orderBy.map((t => function(t) {
            // TODO(b/29183165): Make this collision robust.
            return t.field.canonicalString() + t.dir;
        }(t))).join(","), wt(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
        t += Xt(e.startAt)), e.endAt && (t += "|ub:", t += Xt(e.endAt)), e.h = t;
    }
    return e.h;
}
...
class Ut extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, n) : new Kt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Gt(t, n) : "in" /* IN */ === e ? new zt(t, n) : "not-in" /* NOT_IN */ === e ? new Ht(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Jt(t, n) : new Ut(t, e, n);
    }
    static l(t, e, n) {
        return "in" /* IN */ === e ? new jt(t, n) : new Qt(t, n);
    }
    matches(t) {
        const e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(Tt(e, this.value)) : null !== e && yt(this.value) === yt(e) && this.m(Tt(e, this.value));
...
class Kt extends Ut {
    constructor(t, e, n) {
        super(t, e, n), this.key = gt.fromName(n.referenceValue);
    }
    matches(t) {
        const e = gt.comparator(t.key, this.key);
        return this.m(e);
    }
}

/** Filter that matches on key fields within an array. */ class jt extends Ut {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class Qt extends Ut {
    constructor(t, e) {
...
function Wt(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t => gt.fromName(t.referenceValue)));
}

/** A Filter that implements the array-contains operator. */ class Gt extends Ut {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return vt(e) && Et(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the IN operator. */ class zt extends Ut {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return null !== e && Et(this.value.arrayValue, e);
    }
}

/** A Filter that implements the not-in operator. */ class Ht extends Ut {
    constructor(t, e) {
        super(t, "not-in" /* NOT_IN */ , e);
    }
    matches(t) {
        if (Et(this.value.arrayValue, {
...
/** A Filter that implements the array-contains-any operator. */ class Jt extends Ut {
    constructor(t, e) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.data.field(this.field);
        return !(!vt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Et(this.value.arrayValue, t)));
    }
}
 ...
 */ function ee(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.isKeyField()) s = gt.comparator(gt.fromName(o.referenceValue), n.key); else {
            s = Tt(o, n.data.field(r.field));
        }
 ...
 */ class se {
    ...
    constructor(t, e = null, n = [], s = [], i = null, r = "F" /* First */ , o = null, a = null) {
        ...
        this.limit = i, this.limitType = r, this.startAt = o, this.endAt = a, this.p = null, 
        // The corresponding `Target` of this `Query` instance.
        this.T = null, this.startAt, this.endAt;
    }
}

/** Creates a new Query instance with the options provided. */ function ie(t, e, n, s, i, r, o, a) {
    return new se(t, e, n, s, i, r, o, a);
}
 ...
 */ function le(t) {
    ...
    if (null === e.p) {
        ...
        t.isKeyField() || e.p.push(new Zt(t)), e.p.push(new Zt(st.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function fe(t) {
    const e = K(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Ot(e.path, e.collectionGroup, le(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.T = Ot(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.T;
}
...
function we(t, e) {
    return Lt(fe(t), fe(e)) && t.limitType === e.limitType;
}
...
function me(t) {
    return `Query(target=${Mt(fe(t))}; limitType=${t.limitType})`;
}

/** Returns whether `doc` matches the constraints of `query`. */ function ge(t, e) {
...
function pe(t, e, n) {
    const s = t.field.isKeyField() ? gt.comparator(e.key, n.key) : function(t, e, n) {
        const s = e.data.field(t), i = n.data.field(t);
        return null !== s && null !== i ? Tt(s, i) : B();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return s;
 ...
 */ function Re(t, e, n) {
    ...
    }(n, e) : t instanceof Ve ? Se(t, e) : t instanceof De ? Ce(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = be(t, e), s = xe(n) + xe(t.A);
        return bt(n) && bt(t.A) ? Te(s) : Ee(t.R, s);
    }(t, e);
}
 ...
 */ function Pe(t, e, n) {
    ...
    // applications.
    return t instanceof Ve ? Se(t, e) : t instanceof De ? Ce(t, e) : n;
}
 ...
 */ function be(t, e) {
    return t instanceof Ne ? bt(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ class De extends Ae {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Oe(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Ve && e instanceof Ve || t instanceof De && e instanceof De ? G(t.elements, e.elements, pt) : t instanceof Ne && e instanceof Ne ? pt(t.A, e.A) : t instanceof ve && e instanceof ve;
 ...
 */ function Ue(t, e, n) {
    t instanceof We ? function(t, e, n) {
        // Unlike applySetMutationToLocalView, if we're applying a mutation to a
        // remote document the server has accepted the mutation so the precondition
        // must have held.
        const s = t.value.clone(), i = He(t.fieldTransforms, e, n.transformResults);
        ...
        const s = He(t.fieldTransforms, e, n.transformResults), i = e.data;
        i.setAll(ze(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function qe(t, e, n) {
    t instanceof We ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = Je(t.fieldTransforms, n, e);
 ...
 *    ignored.
 */ (t, e, n) : t instanceof Ge ? function(t, e, n) {
        if (!Le(t.precondition, e)) return;
        const s = Je(t.fieldTransforms, n, e), i = e.data;
        i.setAll(ze(t)), i.setAll(s), e.convertToFoundDocument(Qe(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function Ke(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        ...
        null != i && (null == n && (n = Nt.empty()), n.set(s.field, i));
    }
    return n || null;
}
...
function je(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && G(t, e, ((t, e) => Oe(t, e)));
 ...
 */ function Je(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, Re(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class Ye extends Be {
    constructor(t, e) {
...
class rn {
    constructor(t, e) {
        this.comparator = t, this.root = e || an.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
    insert(t, e) {
        return new rn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, an.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new rn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, an.BLACK, null, null));
    }
...
class an {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : an.RED, this.left = null != s ? s : an.EMPTY, 
        this.right = null != i ? i : an.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new an(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
...
class cn {
    constructor(t) {
        this.comparator = t, this.data = new rn(this.comparator);
    }
    has(t) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const hn = new rn(gt.comparator);

function ln() {
    return hn;
}

const fn = new rn(gt.comparator);

function dn() {
    return fn;
}

const wn = new rn(gt.comparator);

function _n() {
    return wn;
}

const mn = new cn(gt.comparator);
 ...
 */ class En {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, Tn.createSynthesizedTargetChangeForCurrentChange(t, e)), new En(J.min(), n, pn(), ln(), gn());
    }
}
 ...
 */ class Tn {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new Tn(ot.EMPTY_BYTE_STRING, e, gn(), gn(), gn());
    }
}
...
class bn {
     ...
     */    rt(t) {
        ...
        if (s) {
            ...
            if (Bt(t)) if (0 === n) {
                ...
                // queries.
                const n = new gt(t.path);
                this.tt(e, n, kt.newNoDocument(n, J.min()));
            } else U(1 === n); else {
                this.at(e) !== n && (
     ...
     */    ct(t) {
        ...
        this.G.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Bt(i.target)) {
                    ...
                    const e = new gt(i.target.path);
                    null !== this.H.get(e) || this.ut(s, e) || this.tt(s, e, kt.newNoDocument(e, t));
                }
                n.O && (e.set(s, n.M()), n.L());
            }
        }));
        ...
        const s = new En(t, e, this.Y, this.H, n);
        return this.H = ln(), this.J = vn(), this.Y = new cn(W), s;
    }
    /**
    ...
    ht(t) {
        let e = this.J.get(t);
        return e || (e = new cn(W), this.J = this.J.insert(t, e)), e;
    }
    /**
 ...
 */ function kn(t, e) {
    return Nn(t, e.toTimestamp());
}

function $n(t) {
    return U(!!t), J.fromTimestamp(function(t) {
        const e = ct(t);
        return new H(e.seconds, e.nanos);
    }(t));
}
...
function Un(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? et.emptyPath() : Kn(e);
}
...
function Qn(t, e, n) {
    const s = Ln(t, e.name), i = $n(e.updateTime), r = new Nt({
        mapValue: {
            fields: e.fields
        }
...
function Wn(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Ln(t, e.found.name), s = $n(e.found.updateTime), i = new Nt({
            mapValue: {
        ...
        const n = Ln(t, e.missing), s = $n(e.readTime);
...
function Gn(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.I ? (U(void 0 === e || "string" == typeof e), ot.fromBase64String(e || "")) : (U(void 0 === e || e instanceof Uint8Array), 
            ot.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, a = o && function(t) {
            const e = void 0 === t.code ? C.UNKNOWN : sn(t.code);
 ...
 */ (o);
        n = new Rn(s, i, r, a || null);
    } else if ("documentChange" in e) {
        e.documentChange;
        const s = e.documentChange;
        s.document, s.document.name, s.document.updateTime;
        const i = Ln(t, s.document.name), r = $n(s.document.updateTime), o = new Nt({
            mapValue: {
                fields: s.document.fields
            }
        }), a = kt.newFoundDocument(i, r, o), c = s.targetIds || [], u = s.removedTargetIds || [];
        n = new In(c, u, a.key, a);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Ln(t, s.document), r = s.readTime ? $n(s.readTime) : J.min(), o = kt.newNoDocument(i, r), a = s.removedTargetIds || [];
        n = new In([], a, o.key, o);
    } else if ("documentRemove" in e) {
        e.documentRemove;
        const s = e.documentRemove;
        s.document;
        const i = Ln(t, s.document), r = s.removedTargetIds || [];
        n = new In([], r, i, null);
    } else {
...
function Hn(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Me.updateTime($n(t.updateTime)) : void 0 !== t.exists ? Me.exists(t.exists) : Me.none();
    }(e.currentDocument) : Me.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) U("REQUEST_TIME" === e.setToServerValue), n = new ve; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Ve(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new De(t);
        } else "increment" in e ? n = new Ne(t, e.increment) : B();
        const s = st.fromServerFormat(e.fieldPath);
        return new $e(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Ln(t, e.update.name), r = new Nt({
            mapValue: {
        ...
        if (e.updateMask) {
            const t = function(t) {
                ...
                return new it(e.map((t => st.fromServerFormat(t))));
            }(e.updateMask);
            return new Ge(i, r, t, n, s);
        }
        return new We(i, r, n, s);
    }
    if (e.delete) {
        const s = Ln(t, e.delete);
        return new Ye(s, n);
    }
    if (e.verify) {
        const s = Ln(t, e.verify);
        return new Xe(s, n);
    }
    return B();
}
...
function Jn(t, e) {
    return t && t.length > 0 ? (U(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? $n(t.updateTime) : $n(e);
        ...
        n = $n(e)), new Fe(n, t.transformResults || []);
    }(t, e)))) : [];
}
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = ns(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ns(e.endAt)), n;
}
...
function Zn(t) {
    ...
    let r = [];
    n.where && (r = es(n.where));
    let o = [];
    n.orderBy && (o = n.orderBy.map((t => function(t) {
        return new Zt(as(t.field), 
        // visible for testing
        function(t) {
            switch (t) {
              case "ASCENDING":
    ...
    let c = null;
    n.startAt && (c = ss(n.startAt));
    let u = null;
    return n.endAt && (u = ss(n.endAt)), ie(e, i, o, r, a, "F" /* First */ , c, u);
}
...
function es(t) {
    return t ? void 0 !== t.unaryFilter ? [ us(t) ] : void 0 !== t.fieldFilter ? [ cs(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => es(t))).reduce(((t, e) => t.concat(e))) : B() : [];
}
...
function cs(t) {
    return Ut.create(as(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function fs(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = ws(e)), e = ds(t.get(n), e);
    return ws(e);
}
 ...
 */ function _s(t) {
    ...
    const e = t.length;
    if (U(e >= 2), 2 === e) return U("" === t.charAt(0) && "" === t.charAt(1)), et.emptyPath();
...
/** Name of the IndexedDb object store.  */ ys.store = "mutationQueues", 
...
Rs.store = "remoteDocumentGlobal", Rs.key = "remoteDocumentGlobalKey";
 ...
 */ vs.key = "targetGlobalKey", vs.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ Ss.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Ds.store = "bundles", Ds.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Cs.store = "namedQueries", Cs.keyPath = "name";

// Visible for testing
const Ns = [ ...[ ...[ ...[ ...[ ys.store, ps.store, Es.store, As.store, Ps.store, gs.store, vs.store, bs.store ], Ss.store ], Rs.store ], Vs.store ], Ds.store, Cs.store ], xs = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Os {
    ...
    next(t, e) {
        return this.callbackAttached && B(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Os(((n, s) => {
            this.nextCallback = e => {
    ...
    wrapUserFunction(t) {
        try {
            const e = t();
            return e instanceof Os ? e : Os.resolve(e);
        } catch (t) {
            return Os.reject(t);
        }
    }
    wrapSuccess(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Os.resolve(e);
    }
    wrapFailure(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Os.reject(e);
    }
    static resolve(t) {
        return new Os(((e, n) => {
            e(t);
     ...
     */    static or(t) {
        let e = Os.resolve(!1);
        for (const n of t) e = e.next((t => t ? Os.resolve(t) : n()));
        return e;
    }
    static forEach(t, e) {
        const n = [];
...
class Fs {
    constructor(t, e) {
         ...
         */
        this.ft = new $s, this.transaction.oncomplete = () => {
            this.ft.resolve();
    ...
    static open(t, e, n, s) {
        try {
            return new Fs(e, t.transaction(s, n));
        } catch (t) {
            throw new Bs(e, t);
        }
    }
 ...
 */ class Ms {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ms._t(getUA()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return O("SimpleDb", "Removing database:", t), Ks(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = getUA(), e = Ms._t(t), n = 0 < e && e < 10, s = Ms.Et(t), i = 0 < s && s < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Fs.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
                // Abort the transaction if there was an error.
                e.abort(t), Os.reject(t)))).toPromise();
...
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Us(t) {
    ...
    xt(t, e) {
        ...
        return new Os(((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new Ls(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof Os) {
                    const t = o.catch((t => (r.done(), Os.reject(t))));
                    n.push(t);
                }
 ...
 */ class zs {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && qe(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && qe(e, t, this.localWriteTime);
    }
    /**
     ...
     */    applyToLocalDocumentSet(t) {
        ...
        this.mutations.forEach((e => {
            ...
            // and we should remove this cast.
                        this.applyToLocalView(s), n.isValidDocument() || s.convertToNoDocument(J.min());
        }));
    }
    keys() {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && G(this.mutations, t.mutations, ((t, e) => je(t, e))) && G(this.baseMutations, t.baseMutations, ((t, e) => je(t, e)));
    }
}
 ...
 */ class Js {
     ...
     * matches the target. The resume token essentially identifies a point in
     * time from which the server should resume sending results.
     */ , o = ot.EMPTY_BYTE_STRING) {
        this.target = t, this.targetId = e, this.purpose = n, this.sequenceNumber = s, this.snapshotVersion = i, 
        this.lastLimboFreeSnapshotVersion = r, this.resumeToken = o;
    }
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new Js(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new Js(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new Js(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function Xs(t, e) {
    ...
    if (e.noDocument) {
        const t = gt.fromSegments(e.noDocument.path), n = si(e.noDocument.readTime), s = kt.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = gt.fromSegments(e.unknownDocument.path), n = si(e.unknownDocument.version);
...
/** Encodes a document for storage locally. */ function Zs(t, e, n) {
    const s = ti(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        const n = function(t, e) {
            return {
                name: Mn(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: Nn(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = ni(e.version), r = e.hasCommittedMutations;
        return new As(
        /* unknownDocument= */ null, new Ts(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = ni(e.version);
        return new As(new Is(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function ii(t, e) {
    const n = (e.baseMutations || []).map((e => Hn(t.Lt, e)));
    ...
    const s = e.mutations.map((e => Hn(t.Lt, e))), i = H.fromMillis(e.localWriteTimeMs);
    return new zs(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function ri(t) {
    const e = si(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? si(t.lastLimboFreeSnapshotVersion) : J.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (U(1 === (i = t.query).documents.length), 
    s = fe(re(Un(i.documents[0])))) : s = function(t) {
        return fe(Zn(t));
    }(t.query), new Js(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, ot.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function oi(t, e) {
    const n = ni(e.snapshotVersion), s = ni(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Bt(e.target) ? Yn(t.Lt, e.target) : Xn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Ps(e.targetId, Ft(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ function ui(t) {
    return Gs(t, Ds.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function hi(t) {
    return Gs(t, Cs.store);
}
 ...
 */ class li {
    ...
    addToCollectionParentIndex(t, e) {
        return this.Bt.add(e), Os.resolve();
    }
    getCollectionParents(t, e) {
        return Os.resolve(this.Bt.getEntries(e));
    }
}
 ...
 */ class fi {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new cn(et.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new cn(et.comparator)).toArray();
    }
}
...
class mi {
    ...
    static withCacheSize(t) {
        return new mi(t, mi.DEFAULT_COLLECTION_PERCENTILE, mi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
 ...
 */
function gi(t, e, n) {
    const s = t.store(ps.store), i = t.store(Es.store), r = [], o = IDBKeyRange.only(n.batchId);
    let a = 0;
    const c = s.Ot({
        range: o
    }, ((t, e, n) => (a++, n.delete())));
    ...
    for (const t of n.mutations) {
        const s = Es.key(e, t.key.path, n.batchId);
        r.push(i.delete(s)), u.push(t.key);
    }
    return Os.waitFor(r).next((() => u));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ mi.DEFAULT_COLLECTION_PERCENTILE = 10, 
mi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, mi.DEFAULT = new mi(41943040, mi.DEFAULT_COLLECTION_PERCENTILE, mi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
mi.DISABLED = new mi(-1, 0, 0);
...
class pi {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            U("number" == typeof o);
            const a = new zs(o, e, n, s), c = function(t, e, n) {
                const s = n.baseMutations.map((e => zn(t.Lt, e))), i = n.mutations.map((e => zn(t.Lt, e)));
                return new ps(e, n.batchId, n.localWriteTime.toMillis(), s, i);
            }(this.R, this.userId, a), u = [];
            let h = new cn(((t, e) => W(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = Es.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), u.push(r.put(c)), u.push(i.put(e, Es.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return Ti(t).get(e).next((t => t ? (U(t.userId === this.userId), ii(this.R, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Qt(t, e) {
        return this.Kt[e] ? Os.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Ti(t).Ot({
            ...
            e.userId === this.userId && (U(e.batchId >= n), i = ii(this.R, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Ti(t).Nt(ps.userMutationsIndex, e).next((t => t.map((t => ii(this.R, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = Es.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Ii(t).Ot({
            range: s
        }, ((n, s, r) => {
            const [o, a, c] = n, u = _s(a);
            ...
            return Ti(t).get(c).next((t => {
                if (!t) throw B();
                U(t.userId === this.userId), i.push(ii(this.R, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = Es.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ii(t).Ot({
                range: r
            }, ((t, s, i) => {
                const [r, o, a] = t, c = _s(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            s.push(o);
        })), Os.waitFor(s).next((() => this.Wt(t, n)));
    }
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = Es.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    Wt(t, e) {
        ...
        return e.forEach((e => {
            s.push(Ti(t).get(e).next((t => {
                if (null === t) throw B();
                U(t.userId === this.userId), n.push(ii(this.R, t));
            })));
        })), Os.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return gi(t.Mt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.Gt(e.batchId);
        })), Os.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
    }
    /**
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            if (!e) return Os.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(Es.prefixForUser(this.userId)), s = [];
            return Ii(t).Ot({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    zt(t) {
        return Ai(t).get(this.userId).next((t => t || new ys(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function Ei(t, e, n) {
    const s = Es.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Ii(t).Ot({
        range: r,
        $t: !0
 ...
 */
function Ti(t) {
    return Gs(t, ps.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ii(t) {
    return Gs(t, Es.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ai(t) {
    return Gs(t, ys.store);
}
 ...
 */ class Pi {
    ...
    allocateTargetId(t) {
        return this.Xt(t).next((e => {
            const n = new Ri(e.highestTargetId);
            return e.highestTargetId = n.next(), this.Zt(t, e).next((() => e.highestTargetId));
        }));
    }
    getLastRemoteSnapshotVersion(t) {
        return this.Xt(t).next((t => J.fromTimestamp(new H(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => bi(t).delete(e.targetId))).next((() => this.Xt(t))).next((e => (U(e.targetCount > 0), 
    ...
    Xt(t) {
        return vi(t).get(vs.key).next((t => (U(null !== t), t)));
    }
    Zt(t, e) {
        return vi(t).put(vs.key, e);
    }
    te(t, e) {
        return bi(t).put(oi(this.R, e));
    }
    /**
    ...
    removeMatchingKeys(t, e, n) {
        ...
        // IndexedDb.
        const s = Vi(t);
        return Os.forEach(e, (e => {
            const i = fs(e.path);
            return Os.waitFor([ s.delete([ n, i ]), this.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Ot({
            ...
            const s = _s(t[1]), r = new gt(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = fs(e.path), s = IDBKeyRange.bound([ n ], [ z(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Vi(t).Ot({
    ...
    // PORTING NOTE: Multi-tab only.
    lt(t, e) {
        return bi(t).get(e).next((t => t ? ri(t) : null));
    }
}
 ...
 */ async function Si(t) {
    if (t.code !== C.FAILED_PRECONDITION || t.message !== xs) throw t;
 ...
 */ class Ci {
    constructor(t) {
        this.ne = t, this.buffer = new cn(Di), this.se = 0;
    }
    ie() {
        return ++this.se;
    }
    re(t) {
        ...
        if (this.buffer.size < this.ne) this.buffer = this.buffer.add(e); else {
            ...
            Di(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
 ...
 */ class Ni {
    constructor(t, e) {
        this.garbageCollector = t, this.asyncQueue = e, this.oe = !1, this.ae = null;
    }
    start(t) {
        -1 !== this.garbageCollector.params.cacheSizeCollectionThreshold && this.ce(t);
    }
    stop() {
        this.ae && (this.ae.cancel(), this.ae = null);
    }
    get started() {
        return null !== this.ae;
    }
    ce(t) {
        ...
        O("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.ae = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this.ae = null, this.oe = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                Us(t) ? O("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Si(t);
            }
            await this.ce(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class xi {
    constructor(t, e) {
    ...
    collect(t, e) {
        ...
        Os.resolve(_i)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (O("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        _i) : this.fe(t, e)));
    }
    getCacheSize(t) {
...
class ki {
     ...
     */    _e(t, e) {
        return function(t, e) {
            let n = !1;
            return Ai(t).Ft((s => Ei(t, s, e).next((t => (t && (n = !0), Os.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.we(t, ((r, o) => {
            if (o <= e) {
                const e = this._e(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), Vi(t).delete([ 0, fs(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => Os.waitFor(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
 ...
 */ class Fi {
    constructor() {
        ...
        this.changes = new Oi((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
    }
    getReadTime(t) {
     ...
     */    getEntry(t, e) {
        ...
        return void 0 !== n ? Os.resolve(n.document) : this.getFromCache(t, e);
    }
    /**
 ...
 */ class Mi {
    ...
    getEntry(t, e) {
        return Ui(t).get(qi(e)).next((t => this.ge(e, t)));
    }
    /**
     ...
     */    Ee(t, e) {
        let n = ln(), s = new rn(gt.comparator);
        return this.pe(t, e, ((t, e) => {
            const i = this.ge(t, e);
            n = n.insert(t, i), s = s.insert(t, yi(e));
        })).next((() => ({
            documents: n,
            Te: s
        })));
    ...
    pe(t, e, n) {
        if (e.isEmpty()) return Os.resolve();
        const s = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator();
        let r = i.getNext();
        return Ui(t).Ot({
            range: s
        }, ((t, e, s) => {
            const o = gt.fromSegments(t);
            // Go through keys not found in cache.
                        for (;r && gt.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
            r && r.isEqual(o) && (
            // Key found in cache.
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        return Ui(t).Ot(r, ((t, n, r) => {
            ...
            const o = Xs(this.R, n);
            e.path.isPrefixOf(o.key.path) ? ge(e, o) && (s = s.insert(o.key, o)) : r.done();
        })).next((() => s));
    }
    newChangeBuffer(t) {
    ...
    getMetadata(t) {
        return Bi(t).get(Rs.key).next((t => (U(!!t), t)));
    }
    me(t, e) {
        return Bi(t).put(Rs.key, e);
    }
    /**
     ...
     */    ge(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!(t.isNoDocument() && t.version.isEqual(J.min()))) return t;
        }
...
class Li extends Fi {
    ...
    constructor(t, e) {
        ...
        this.Ae = new Oi((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new cn(((t, e) => W(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Ae.get(i);
            if (r.document.isValidDocument()) {
                const a = Zs(this.Ie.R, r.document, this.getReadTime(i));
                s = s.add(i.path.popLast());
                const c = yi(a);
                n += c - o, e.push(this.Ie.addEntry(t, i, a));
            } else if (n -= o, this.trackRemovals) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                const n = Zs(this.Ie.R, kt.newNoDocument(i, J.min()), this.getReadTime(i));
                e.push(this.Ie.addEntry(t, i, n));
            } else e.push(this.Ie.removeEntry(t, i));
        })), s.forEach((n => {
            e.push(this.Ie.qt.addToCollectionParentIndex(t, n));
        })), e.push(this.Ie.updateMetadata(t, n)), Os.waitFor(e);
    }
    getFromCache(t, e) {
...
function Bi(t) {
    return Gs(t, Rs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Ui(t) {
    return Gs(t, As.store);
}
...
/** Performs database creation and schema upgrades. */ class Ki {
     ...
     */    Rt(t, e, n, s) {
        U(n < s && n >= 0 && s <= 11);
        const i = new Fs("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
 ...
 */ (t), ji(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(bs.store), t.deleteObjectStore(Ps.store), t.deleteObjectStore(vs.store);
        }(t), ji(t)), r = r.next((() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(vs.store), n = new vs(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, J.min().toTimestamp(), 
            /*targetCount=*/ 0);
            return e.put(vs.key, n);
        }
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(ps.store).Nt().next((n => {
 ...
 */ (t);
    ...
    Pe(t) {
        ...
        return t.store(As.store).Ot(((t, n) => {
            ...
            const n = new Rs(e);
            return t.store(Rs.store).put(Rs.key, n);
        }));
    }
    Re(t) {
        const e = t.store(ys.store), n = t.store(ps.store);
        return e.Nt().next((e => Os.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Nt(ps.userMutationsIndex, s).next((n => Os.forEach(n, (n => {
                U(n.userId === e.userId);
                const s = ii(this.R, n);
                return gi(t, e.userId, s).next((() => {}));
            }))));
        }))));
    }
    /**
     ...
     */    be(t) {
        const e = t.store(bs.store), n = t.store(As.store);
        return t.store(vs.store).get(vs.key).next((t => {
            const s = [];
            return n.Ot(((n, i) => {
                const r = new et(n), o = function(t) {
                    return [ 0, fs(t) ];
                }(r);
                s.push(e.get(o).next((n => n ? Os.resolve() : (n => e.put(new bs(0, fs(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => Os.waitFor(s)));
        }));
    }
    ve(t, e) {
        ...
        const n = e.store(Vs.store), s = new fi, i = t => {
            if (s.add(t)) {
...
class Wi {
    ...
    u) {
        ...
        this.Se = i, this.window = r, this.document = o, this.De = c, this.Ce = u, this.Ne = null, 
        ...
        this.Me = t => Promise.resolve(), !Wi.gt()) throw new N(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new ki(this, s), this.Le = e + "main", this.R = new Ys(a), 
        this.Be = new Ms(this.Le, 11, new Ki(this.R)), this.Ue = new Pi(this.referenceDelegate, this.R), 
        this.qt = new di, this.qe = function(t, e) {
            return new Mi(t, e);
        }
        /**
 ...
 */
     ...
     */    start() {
        ...
        return this.Qe().then((() => {
            ...
            throw new N(C.FAILED_PRECONDITION, Qi);
     ...
     * primary lease.
     */    Qe() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => zi(t).put(new Ss(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    Je(t) {
        return Gi(t).get(gs.key).next((t => Os.resolve(this.tn(t))));
    }
    en(t) {
     ...
     */    async nn() {
        if (this.isPrimary && !this.sn(this.Fe, 18e5)) {
            ...
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t => {
                const e = Gs(t, Ss.store);
                return e.Nt().next((t => {
                    const n = this.rn(t, 18e5), s = t.filter((t => -1 === n.indexOf(t)));
                    // Delete metadata for clients that are no longer considered active.
                    return Os.forEach(s, (t => e.delete(t.clientId))).next((() => s));
                }));
            })).catch((() => []));
     ...
     */    Ye(t) {
        if (this.Ce) return Os.resolve(!0);
        return Gi(t).get(gs.key).next((e => {
            ...
            if (null !== e && this.sn(e.leaseTimestampMs, 5e3) && !this.an(e.ownerId)) {
            ...
            return !(!this.networkEnabled || !this.inForeground) || zi(t).Nt().next((t => void 0 === this.rn(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        this.xe = !1, this.cn(), this.Oe && (this.Oe.cancel(), this.Oe = null), this.un(), 
        this.hn(), 
        // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
        // has obtained the primary lease.
        await this.Be.runTransaction("shutdown", "readwrite", [ gs.store, Ss.store ], (t => {
            const e = new Ws(t, D.o);
     ...
     * provided threshold.
     */    rn(t, e) {
        return t.filter((t => this.sn(t.updateTimeMs, e) && !this.an(t.clientId)));
    }
    /**
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    fn() {
        return this.runTransaction("getActiveClients", "readonly", (t => zi(t).Nt().next((t => this.rn(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.xe;
    }
    getMutationQueue(t) {
        return pi.jt(t, this.R, this.qt, this.referenceDelegate);
    }
    getTargetCache() {
        return this.Ue;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Be.runTransaction(t, s, Ns, (s => (i = new Ws(s, this.Ne ? this.Ne.next() : D.o), 
        "readwrite-primary" === e ? this.Je(i).next((t => !!t || this.Ye(i))).next((e => {
            ...
            this.Se.enqueueRetryable((() => this.Me(!1))), new N(C.FAILED_PRECONDITION, xs);
            return n(i);
    ...
    // be turned off.
    dn(t) {
        return Gi(t).get(gs.key).next((t => {
            if (null !== t && this.sn(t.leaseTimestampMs, 5e3) && !this.an(t.ownerId) && !this.tn(t) && !(this.Ce || this.allowTabSynchronization && t.allowTabSynchronization)) throw new N(C.FAILED_PRECONDITION, Qi);
        }));
    }
    /**
     ...
     */    Ze(t) {
        const e = new gs(this.clientId, this.allowTabSynchronization, Date.now());
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    Xe(t) {
        const e = Gi(t);
        return e.get(gs.key).next((t => this.tn(t) ? (O("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(gs.key)) : Os.resolve()));
    }
     ...
     */    Ge() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ke = () => {
            ...
            this.cn(), isSafari() && navigator.appVersion.match("Version/14") && 
 ...
 */ function Gi(t) {
    return Gs(t, gs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function zi(t) {
    return Gs(t, Ss.store);
}
 ...
 */
        return function(t) {
            return gt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Tn(t, e.path) : he(e) ? this.In(t, e, n) : this.An(t, e, n);
    }
    Tn(t, e) {
        // Just do a simple document lookup.
        return this.mn(t, new gt(e)).next((t => {
            let e = dn();
    ...
    In(t, e, n) {
        ...
        let i = dn();
        return this.qt.getCollectionParents(t, s).next((r => Os.forEach(r, (r => {
            const o = function(t, e) {
                return new se(e, 
 ...
 */ (e, r.child(s));
    ...
    An(t, e, n) {
        ...
        this.Rn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = kt.newInvalidDocument(n), s = s.insert(n, i)), qe(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
    ...
    Rn(t, e, n) {
        let s = gn();
        for (const t of e) for (const e of t.mutations) e instanceof Ge && null === n.get(e.key) && (s = s.add(e.key));
        let i = n;
 ...
 */ class Xi {
 ...
 // do nothing
        ...
        return new Xi(t, e.fromCache, n, s);
    }
}
 ...
 */ class Zi {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        }(e) || n.isEqual(J.min()) ? this.Dn(t, e) : this.Sn.pn(t, s).next((i => {
            const r = this.Cn(e, i);
            return (oe(e) || ae(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (k() <= LogLevel.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), me(e)), 
    ...
    Dn(t, e) {
        return k() <= LogLevel.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", me(e)), 
...
class tr {
    ...
    t, e, n, s) {
        ...
        this.Ue = t.getTargetCache(), this.Mn = new Yi(this.Fn, this._n, this.persistence.getIndexManager()), 
...
async function nr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new Yi(n.Fn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (a, u, e) && o.push(n.Ue.updateTargetData(t, u));
            }
        }));
        let a = ln();
        ...
        o.push(or(t, r, e.documentUpdates, s, void 0).next((t => {
            a = t;
        }))), !s.isEqual(J.min())) {
            const e = n.Ue.getLastRemoteSnapshotVersion(t).next((e => n.Ue.setTargetsMetadata(t, t.currentSequenceNumber, s)));
            o.push(e);
        }
        return Os.waitFor(o).next((() => r.apply(t))).next((() => n.Mn.En(t, a))).next((() => a));
    })).then((t => (n.kn = i, t)));
}
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o.isNoDocument() && o.version.isEqual(J.min()) ? (
...
function cr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Os.resolve(s)) : n.Ue.allocateTargetId(t).next((i => (s = new Js(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
...
async function ur(t, e, n) {
    const s = K(t), i = s.kn.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function hr(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = K(t), i = s.$n.get(n);
        return void 0 !== i ? Os.resolve(s.kn.get(i)) : s.Ue.getTargetData(e, n);
    }(s, t, fe(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.Ue.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.xn.getDocumentsMatchingQuery(t, e, n ? i : J.min(), n ? r : gn()))).next((t => ({
        documents: t,
        Bn: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function lr(t, e) {
    const n = K(t), s = K(n.Ue), i = n.kn.get(e);
...
function fr(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
        const s = K(t);
        let i = ln(), r = ti(n);
        const o = Ui(e), a = IDBKeyRange.lowerBound(r, !0);
        return o.Ot({
...
async function wr(t, e, n, s) {
    ...
    for (const t of n) {
        ...
        t.document && (r = r.add(n)), o = o.insert(n, e.qn(t)), a = a.insert(n, e.Kn(t.metadata.readTime));
    }
    const c = i.Fn.newChangeBuffer({
        trackRemovals: !0
    }), u = await cr(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return fe(re(et.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => or(t, c, o, J.min(), a).next((e => (c.apply(t), 
    e))).next((e => i.Ue.removeMatchingKeysForTargetId(t, u.targetId).next((() => i.Ue.addMatchingKeys(t, r, u.targetId))).next((() => i.Mn.En(t, e))).next((() => e))))));
}
 ...
 */ class mr {
    ...
    getBundleMetadata(t, e) {
        return Os.resolve(this.jn.get(e));
    }
    saveBundleMetadata(t, e) {
    ...
    getNamedQuery(t, e) {
        return Os.resolve(this.Qn.get(e));
    }
    saveNamedQuery(t, e) {
        return this.Qn.set(e.name, function(t) {
            return {
                name: t.name,
                query: ai(t.bundledQuery),
                readTime: $n(t.readTime)
            };
        }(e)), Os.resolve();
    }
}
 ...
 */ class gr {
    constructor() {
        ...
        this.Wn = new cn(yr.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new cn(yr.Hn);
    }
     ...
     * removed.
     */    Zn(t) {
        const e = new gt(new et([])), n = new yr(e, t), s = new yr(e, t + 1), i = [];
    ...
    es(t) {
        const e = new gt(new et([])), n = new yr(e, t), s = new yr(e, t + 1);
        let i = gn();
        return this.zn.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new yr(t, 0), n = this.Wn.firstAfterOrEqual(e);
...
class yr {
    ...
    /** Compare by key then by ID */    static Gn(t, e) {
        return gt.comparator(t.key, e.key) || W(t.ns, e.ns);
    }
    /** Compare by ID then by key */    static Hn(t, e) {
        return W(t.ns, e.ns) || gt.comparator(t.key, e.key);
    }
}
 ...
 */ class pr {
    constructor(t, e) {
        ...
        this.rs = new cn(yr.Gn);
    }
    checkEmpty(t) {
        return Os.resolve(0 === this._n.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.ss;
        ...
        for (const e of s) this.rs = this.rs.add(new yr(e.key, i)), this.qt.addToCollectionParentIndex(t, e.key.path.popLast());
        return Os.resolve(r);
    }
    lookupMutationBatch(t, e) {
        return Os.resolve(this.os(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.cs(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Os.resolve(this._n.length > i ? this._n[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return Os.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }
    getAllMutationBatches(t) {
        return Os.resolve(this._n.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    removeMutationBatch(t, e) {
        ...
        let n = this.rs;
        return Os.forEach(e.mutations, (s => {
    ...
    containsKey(t, e) {
        const n = new yr(e, 0), s = this.rs.firstAfterOrEqual(n);
        return Os.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this._n.length, Os.resolve();
    }
    /**
...
class Er {
    ...
    constructor(t, e) {
        ...
        this.docs = new rn(gt.comparator), 
    ...
    getEntry(t, e) {
        ...
        return Os.resolve(n ? n.document.clone() : kt.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = ln();
        return e.forEach((t => {
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        // the documents we need to match the query against.
                const i = new gt(e.path.child("")), r = this.docs.getIteratorFrom(i);
        for (;r.hasNext(); ) {
            const {key: t, value: {document: i, readTime: o}} = r.getNext();
            if (!e.path.isPrefixOf(t.path)) break;
            o.compareTo(n) <= 0 || ge(e, i) && (s = s.insert(i.key, i.clone()));
        }
        return Os.resolve(s);
    }
    fs(t, e) {
        return Os.forEach(this.docs, (t => e(t)));
    }
    newChangeBuffer(t) {
 ...
 */ class Ir {
    constructor(t) {
         ...
         * IDs.
         */
        this._s = new gr, this.targetCount = 0, this.gs = Ri.Jt();
    }
    forEachTarget(t, e) {
        return this.ds.forEach(((t, n) => e(n))), Os.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return Os.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return Os.resolve(this.ws);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.gs.next(), Os.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    te(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.gs = new Ri(e), this.highestTargetId = e), t.sequenceNumber > this.ws && (this.ws = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.te(e), this.targetCount += 1, Os.resolve();
    }
    updateTargetData(t, e) {
        return this.te(e), Os.resolve();
    }
    removeTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this._s.Jn(e, n), Os.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this._s.Xn(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this._s.Zn(e), Os.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return Os.resolve(this._s.containsKey(e));
    }
}
...
class Ar {
    ...
    constructor(t, e) {
        ...
        this.qt = new li, this.qe = function(t, e) {
            return new Er(t, e);
        }(this.qt, (t => this.referenceDelegate.ps(t))), this.R = new Ys(e), this.Ke = new mr(this.R);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new pr(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.Ue;
...
class Pr {
    ...
    addReference(t, e, n) {
        return this.As.addReference(n, e), this.bs.delete(n.toString()), Os.resolve();
    }
    removeReference(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), Os.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.bs.add(e.toString()), Os.resolve();
    }
    removeTarget(t, e) {
    ...
    Ts(t) {
        ...
        return Os.forEach(this.bs, (n => {
            const s = gt.fromPath(n);
    ...
    vs(t, e) {
        return Os.or([ () => Os.resolve(this.As.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Is(t, e) ]);
    }
}
...
br.GOOGLE_CREDENTIALS = new br("google-credentials-uid"), br.FIRST_PARTY = new br("first-party-uid"), 
br.MOCK_USER = new br("mock-user");
...
class Dr {
     ...
     */    static Vs(t, e, n) {
        ...
        r && (i = new N(s.error.code, s.error.message))), r ? new Dr(t, e, s.state, i) : (F("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Ss() {
        const t = {
...
class Cr {
     ...
     */    static Vs(t, e) {
        ...
        i && (s = new N(n.error.code, n.error.message))), i ? new Cr(t, n.state, s) : (F("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Ss() {
        const t = {
 ...
 */ class Nr {
     ...
     */    static Vs(t, e) {
        ...
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = mt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Nr(t, i) : (F("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class xr {
     ...
     */    static Vs(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new xr(e.clientId, e.onlineState) : (F("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class $r {
    constructor(t, e, n, s, i) {
        ...
        this.$s = new rn(W), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = vr(this.persistenceKey, this.Ns), 
        this.Ms = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.$s = this.$s.insert(this.Ns, new kr), this.Ls = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(Sr(this.persistenceKey, t));
            if (n) {
                const s = Cr.Vs(t, n);
                s && (e = s.state);
            }
    ...
    clearQueryState(t) {
        this.removeItem(Sr(this.persistenceKey, t));
    }
 ...
 */ (e.newValue);
                    ...
                    } else if (e.key === this.Ks) return this.syncEngine.ai();
                } else this.Os.push(e);
            }));
        }
    }
    ...
    zs(t, e, n) {
        const s = new Dr(this.currentUser, t, e, n), i = Vr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Ss());
    }
    Hs(t) {
    ...
    Ys(t, e, n) {
        const s = Sr(this.persistenceKey, t), i = new Cr(t, e, n);
        this.setItem(s, i.Ss());
    }
    Zs() {
    ...
    async ii(t) {
        if (t.user.uid === this.currentUser.uid) return this.syncEngine.ci(t.batchId, t.state, t.error);
...
class {
    ...
    Fi(t, e) {
        ...
        // on a closed stream
                const m = new Br({
            Ei: t => {
                _ ? O("Connection", "Not sending because WebChannel is closed:", t) : (c || (O("Connection", "Opening WebChannel transport."), 
        ...
        // enough the code is exception free.
            ...
            _ || O("Connection", "WebChannel transport opened.");
        })), g(a, WebChannel.EventType.CLOSE, (() => {
            _ || (_ = !0, O("Connection", "WebChannel transport closed"), m.Vi());
        })), g(a, WebChannel.EventType.ERROR, (t => {
            _ || (_ = !0, M("Connection", "WebChannel transport errored:", t), m.Vi(new N(C.UNAVAILABLE, "The operation could not be completed")));
...
class Wr {
    ...
    /** Sends a message to the underlying stream. */    ar(t) {
        this.cr(), this.stream.send(t);
    }
    ...
    /** Marks the stream as active again. */    cr() {
 ...
 */ class Gr extends Wr {
    ...
    onMessage(t) {
        ...
        this.Zi.reset();
        const e = Gn(this.R, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return J.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? J.min() : e.readTime ? $n(e.readTime) : J.min();
        }(t);
     ...
     */    mr(t) {
        ...
        e.database = qn(this.R), e.addTarget = function(t, e) {
            ...
            return n = Bt(s) ? {
                ...
                query: Xn(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = xn(t, e.resumeToken) : e.snapshotVersion.compareTo(J.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = Nn(t, e.snapshotVersion.toTimestamp())), n;
        }(this.R, t);
        const n = ts(this.R, t);
        n && (e.labels = n), this.ar(e);
    }
    /**
     ...
     */    gr(t) {
        const e = {};
        e.database = qn(this.R), e.removeTarget = t, this.ar(e);
    }
}
 ...
 */ class zr extends Wr {
    ...
    onMessage(t) {
        ...
        U(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
            ...
            this.Zi.reset();
            const e = Jn(t.writeResults, t.commitTime), n = $n(t.commitTime);
    ...
    e, n, s, i) {
        ...
        this.Mr = [], this.Lr = i, this.Lr.di((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                oo(this) && (O("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = K(t);
                    e.Fr.add(4 /* ConnectivityChange */), await Zr(e), e.Br.set("Unknown" /* Unknown */), 
                    e.Fr.delete(4 /* ConnectivityChange */), await Xr(e);
                }(this));
            }));
        })), this.Br = new Jr(n, s);
    }
...
async function Xr(t) {
    if (oo(t)) for (const e of t.Mr) await e(/* enabled= */ !0);
}
 ...
 */ function eo(t, e) {
    const n = K(t), s = Ro(n);
    n.Or.delete(e), s.er() && so(n, e), 0 === n.Or.size && (s.er() ? s.ir() : oo(n) && 
 ...
 */ function ro(t) {
    return oo(t) && !Ro(t).tr() && t.Or.size > 0;
}

function oo(t) {
    return 0 === K(t).Fr.size;
}
...
async function ho(t, e, n) {
    ...
    t.Br.set("Online" /* Online */), e instanceof Rn && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await lo(t, n);
    } else if (e instanceof In ? t.Ur.X(e) : e instanceof An ? t.Ur.rt(e) : t.Ur.et(e), 
    !n.isEqual(J.min())) try {
        const e = await ir(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new Js(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                no(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        O("RemoteStore", "Failed to raise snapshot:", e), await lo(t, e);
    }
}
 ...
 */ async function lo(t, e, n) {
    ...
    await Zr(t), t.Br.set("Offline" /* Offline */), n || (
...
async function wo(t) {
    ...
    for (;_o(e); ) try {
        const t = await ar(e.localStore, s);
        if (null === t) {
            0 === e.$r.length && n.ir();
            break;
        }
...
function go(t) {
    return oo(t) && !Po(t).tr() && t.$r.length > 0;
}
...
async function To(t, e, n) {
    const s = t.$r.shift(), i = Hs.from(s, e, n);
    await fo(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
...
async function Io(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, nn(n) && n !== C.ABORTED) {
            ...
            // restart.
                        Po(t).sr(), await fo(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function Ao(t, e) {
    const n = K(t);
    e ? (n.Fr.delete(2 /* IsSecondary */), await Xr(n)) : e || (n.Fr.add(2 /* IsSecondary */), 
    await Zr(n), n.Br.set("Unknown" /* Unknown */));
}
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.qr.sr(), ro(t) ? io(t) : t.Br.set("Unknown" /* Unknown */)) : (await t.qr.stop(), 
        ao(t));
    }))), t.qr;
}
 ...
 */ function Po(t) {
    ...
    t.Kr = function(t, e, n) {
        const s = K(t);
        return s.Pr(), new zr(e, s.Hi, s.credentials, s.R, n);
    }(t.datastore, t.asyncQueue, {
        Ii: po.bind(null, t),
        Ri: Io.bind(null, t),
        Ir: Eo.bind(null, t),
        ...
        await wo(t)) : (await t.Kr.stop(), t.$r.length > 0 && (O("RemoteStore", `Stopping write stream with ${t.$r.length} pending writes`), 
        t.$r = []));
    }))), t.Kr;
}
...
class bo {
    constructor(t, e, n, s, i) {
        ...
        this.deferred = new $s, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
 ...
 */ function vo(t, e) {
    if (F("AsyncQueue", `${e}: ${t}`), Us(t)) return new N(C.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Vo {
    ...
    constructor(t) {
        ...
        this.comparator = t ? (e, n) => t(e, n) || gt.comparator(e.key, n.key) : (t, e) => gt.comparator(t.key, e.key), 
        this.keyedMap = dn(), this.sortedSet = new rn(this.comparator);
    }
    /**
...
class Do {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Do(t, e, Vo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.syncStateChanged === t.syncStateChanged && this.mutatedKeys.isEqual(t.mutatedKeys) && we(this.query, t.query) && this.docs.isEqual(t.docs) && this.oldDocs.isEqual(t.oldDocs))) return !1;
...
class No {
    constructor() {
        this.queries = new Oi((t => _e(t)), we), this.onlineState = "Unknown" /* Unknown */ , 
        this.Gr = new Set;
    }
}
...
async function xo(t, e) {
    ...
    if (r || (i = !0, r = new Co), i) try {
        r.Wr = await n.onListen(s);
    } catch (t) {
        const n = vo(t, `Initialization of query '${me(e.query)}' failed`);
 ...
 */ class Mo {
     ...
     */    Hr(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Do(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    no(t) {
        t = Do.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }
}
 ...
 */ class Bo {
     ...
     */    qn(t) {
        return t.metadata.exists ? Qn(this.R, t.document, !1) : kt.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    }
    Kn(t) {
        return $n(t);
    }
 ...
 */ class Uo {
     ...
     */    async complete() {
        const t = await wr(this.localStore, new Bo(this.R), this.documents, this.ro.id), e = this.ao(this.documents);
        for (const t of this.queries) await _r(this.localStore, t, e.get(t.name));
        return this.progress.taskState = "Success", new Ji(Object.assign({}, this.progress), t);
    }
}
 ...
 */ class Qo {
    ...
    e) {
        this.query = t, this.co = e, this.uo = null, 
        /**
        ...
        this.mutatedKeys = gn(), this.lo = ye(t), this.fo = new Vo(this.lo);
    }
    /**
     ...
     */    _o(t, e) {
        const n = e ? e.mo : new So, s = e ? e.fo : this.fo;
        ...
        const a = oe(this.query) && s.size === this.query.limit ? s.last() : null, c = ae(this.query) && s.size === this.query.limit ? s.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal(((t, e) => {
            const u = s.get(t), h = ge(this.query, e) ? e : null, l = !!u && this.mutatedKeys.has(u.key), f = !!h && (h.hasLocalMutations || 
            ...
            // Calculate change
                ...
                u.data.isEqual(h.data) ? l !== f && (n.track({
                    ...
                    type: 2 /* Modified */ ,
                    doc: h
                }), d = !0, (a && this.lo(h, a) > 0 || c && this.lo(h, c) < 0) && (
        ...
        })), oe(this.query) || ae(this.query)) for (;r.size > this.query.limit; ) {
 ...
 */ (t.type, e.type) || this.lo(t.doc, e.doc))), this.po(n);
        const r = e ? this.Eo() : [], o = 0 === this.ho.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = o !== this.uo;
        if (this.uo = o, 0 !== i.length || a) {
            return {
                snapshot: new Do(this.query, t.fo, s, i, t.mutatedKeys, 0 /* Local */ === o, a, 
                /* excludesMetadataChanges= */ !1),
                To: r
            };
        }
     ...
     */    po(t) {
        t && (t.addedDocuments.forEach((t => this.co = this.co.add(t))), t.modifiedDocuments.forEach((t => {})), 
        t.removedDocuments.forEach((t => this.co = this.co.delete(t))), this.current = t.current);
    }
    Eo() {
        ...
        // updating many documents.
                const t = this.ho;
        this.ho = gn(), this.fo.forEach((t => {
            this.Io(t.key) && (this.ho = this.ho.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.ho.has(t) || e.push(new jo(t));
        })), this.ho.forEach((n => {
    ...
    // PORTING NOTE: Multi-tab only.
    Ro() {
        return Do.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }
}
 ...
 */ class zo {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.bo = {}, this.vo = new Oi((t => _e(t)), we), 
        this.Vo = new Map, 
        /**
        ...
        this.ko = new Map, this.$o = Ri.Yt(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Ho(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Ro(); else {
        const t = await cr(n.localStore, fe(e)), r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await Jo(n, e, s, "current" === r), n.isPrimaryClient && to(n.remoteStore, t);
    }
    return i;
}
 ...
 */ async function Jo(t, e, n, s) {
    ...
    t.Fo = (e, n, s) => async function(t, e, n, s) {
        ...
        return ua(t, e.targetId, o.To), o.snapshot;
    }(t, e, n, s);
    const i = await hr(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new Qo(e, i.Bn), o = r._o(i.documents), a = Tn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), c = r.applyChanges(o, 
    /* updateLimboDocuments= */ t.isPrimaryClient, a);
    ua(t, n, c.To);
    const u = new Wo(e, n, r);
    return t.vo.set(e, u), t.Vo.has(n) ? t.Vo.get(n).push(e) : t.Vo.set(n, [ e ]), c.snapshot;
}

/** Stops listening to the query. */ async function Yo(t, e) {
    const n = K(t), s = n.vo.get(e), i = n.Vo.get(s.targetId);
    if (i.length > 1) return n.Vo.set(s.targetId, i.filter((t => !we(t, e)))), void n.vo.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        ...
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), eo(n.remoteStore, s.targetId), 
            aa(n, s.targetId);
        })).catch(Si);
    } else aa(n, s.targetId), await ur(n.localStore, s.targetId, 
 ...
 */ async function Xo(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = K(t), s = H.now(), i = e.reduce(((t, e) => t.add(e.key)), gn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Mn.pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new Ge(t.key, e, xt(e.value.mapValue), Me.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await fa(s, t.changes), await wo(s.remoteStore);
    } catch (t) {
        // If we can't persist the mutation, we reject the user callback and
        // don't send the mutation. The user can then retry the write.
        const e = vo(t, "Failed to persist write");
        n.reject(e);
    }
}
 ...
 */ async function Zo(t, e) {
    const n = K(t);
    try {
        const t = await rr(n.localStore, e);
 ...
 */ async function ea(t, e, n) {
    ...
    if (r) {
        ...
        let t = new rn(gt.comparator);
        t = t.insert(r, kt.newNoDocument(r, J.min()));
        const n = gn().add(r), i = new En(J.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new cn(W), t, n);
        await Zo(s, i), 
        ...
        s.Do = s.Do.remove(r), s.Co.delete(e), la(s);
    } else await ur(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => aa(s, e, n))).catch(Si);
}
...
async function na(t, e) {
    ...
    try {
        ...
        // before listen events.
                oa(n, s, /*error=*/ null), ra(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await fa(n, t);
    } catch (t) {
        await Si(t);
    }
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                oa(s, e, n), ra(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await fa(s, t);
    } catch (n) {
        await Si(n);
    }
 ...
 */ async function ia(t, e) {
    const n = K(t);
    oo(n.remoteStore) || O("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
        ...
        const n = vo(t, "Initialization of waitForPendingWrites() operation failed");
        e.reject(n);
    }
}
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function oa(t, e, n) {
    const s = K(t);
...
function ca(t, e) {
    ...
    const n = t.Do.get(e);
    null !== n && (eo(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), la(t));
}

function ua(t, e, n) {
    for (const s of n) if (s instanceof Ko) t.No.addReference(s.key, e), ha(t, s); else if (s instanceof jo) {
 ...
 */ function la(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        const n = new gt(et.fromString(e)), s = t.$o.next();
        t.Co.set(s, new Go(n)), t.Do = t.Do.insert(n, s), to(t.remoteStore, new Js(fe(re(n.path)), s, 2 /* LimboResolution */ , D.o));
    }
}

async function fa(t, e, n) {
    const s = K(t), i = [], r = [], o = [];
    s.vo.isEmpty() || (s.vo.forEach(((t, a) => {
        o.push(s.Fo(a, e, n).then((t => {
            if (t) {
                s.isPrimaryClient && s.sharedClientState.updateQueryState(a.targetId, t.fromCache ? "not-current" : "current"), 
                i.push(t);
                const e = Xi.vn(a.targetId, t);
                r.push(e);
            }
        })));
        ...
        const n = K(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => Os.forEach(e, (e => Os.forEach(e.Pn, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => Os.forEach(e.bn, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Us(t)) throw t;
...
async function da(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await fa(n, t.Ln);
    }
}

function wa(t, e) {
    const n = K(t), s = n.Co.get(e);
    if (s && s.Po) return gn().add(s.key);
    {
        let t = gn();
        const s = n.Vo.get(e);
        if (!s) return t;
 ...
 */ async function _a(t, e) {
    ...
    return n.isPrimaryClient && ua(n, e.targetId, i.To), i;
}
...
async function ma(t) {
    const e = K(t);
    return fr(e.localStore).then((t => fa(e, t)));
}
...
async function ga(t, e, n, s) {
    const i = K(t), r = await function(t, e) {
        const n = K(t), s = K(n._n);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Qt(t, e).next((e => e ? n.Mn.pn(t, e) : Os.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await wo(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    oa(i, e, s || null), ra(i, e), function(t, e) {
        K(K(t)._n).Gt(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : B(), await fa(i, r)) : 
...
async function ya(t, e) {
    ...
    if (Ra(n), Pa(n), !0 === e && !0 !== n.Oo) {
        ...
        for (const t of e) to(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.Oo) {
        const t = [];
        let e = Promise.resolve();
        n.Vo.forEach(((s, i) => {
            n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (aa(n, i), 
            ur(n.localStore, i, 
            /*keepPersistedTargetData=*/ !0)))), eo(n.remoteStore, i);
        ...
        function(t) {
            ...
            e.Co.forEach(((t, n) => {
                eo(e.remoteStore, n);
            })), e.No.ts(), e.Co = new Map, e.Do = new rn(gt.comparator);
        }
        /**
...
async function pa(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await cr(s.localStore, fe(n[0]));
            for (const t of n) {
                const e = s.vo.get(t), n = await _a(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await lr(s.localStore, t);
            e = await cr(s.localStore, n), await Jo(s, Ea(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function Ta(t) {
    const e = K(t);
    return K(K(e.localStore).persistence).fn();
}
...
async function Ia(t, e, n, s) {
    ...
    O("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Vo.has(e)) switch (n) {
      ...
      case "not-current":
        {
            const t = await fr(i.localStore), s = En.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await fa(i, t, s);
            break;
        }
      ...
      case "rejected":
        ...
        /* keepPersistedTargetData */ !0), aa(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Aa(t, e, n) {
    ...
    if (s.Oo) {
        for (const t of e) {
            ...
            const e = await lr(s.localStore, t), n = await cr(s.localStore, e);
            await Jo(s, Ea(e), n.targetId, 
            /*current=*/ !1), to(s.remoteStore, n);
        }
        for (const t of n) 
...
function Ra(t) {
    const e = K(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Zo.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = wa.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ea.bind(null, e), e.bo._r = $o.bind(null, e.eventManager), 
    e.bo.Mo = Oo.bind(null, e.eventManager), e;
}

function Pa(t) {
    const e = K(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = na.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = sa.bind(null, e), 
    e;
}
 ...
 */ (t.localStore, s)) return await e.close(), void n._completeWith(function(t) {
            ...
            n._updateProgress(qo(s));
            const i = new Uo(s, t.localStore, e.R);
            let r = await e.Lo();
            for (;r; ) {
...
class va {
    ...
    async initialize(t) {
        this.R = jr(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), this.persistence = this.Uo(t), 
    ...
    Ko(t) {
        return er(this.persistence, new Zi, t.initialUser, this.R);
    }
    Uo(t) {
        return new Ar(Pr.Ps, this.R);
    }
    Bo(t) {
        return new Or;
    }
 ...
 */ class Va extends va {
    ...
    async initialize(t) {
        await super.initialize(t), await dr(this.localStore), await this.jo.initialize(this, t), 
        // Enqueue writes from a previous session
        await Pa(this.jo.syncEngine), await wo(this.jo.remoteStore), 
        // NOTE: This will immediately call the listener, so we make sure to
        // set it after localStore / remoteStore are started.
        await this.persistence.He((() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(this.localStore), 
        Promise.resolve())));
    }
    Ko(t) {
        return er(this.persistence, new Zi, t.initialUser, this.R);
    ...
    Uo(t) {
        const e = Hi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? mi.withCacheSize(this.cacheSizeBytes) : mi.DEFAULT;
        return new Wi(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, qr(), Kr(), this.R, this.sharedClientState, !!this.forceOwnership);
    }
    Bo(t) {
        return new Or;
    }
 ...
 */ class Sa extends Va {
    ...
    async initialize(t) {
        ...
        this.sharedClientState instanceof $r && (this.sharedClientState.syncEngine = {
            ci: ga.bind(null, e),
            ui: Ia.bind(null, e),
            hi: Aa.bind(null, e),
            fn: Ta.bind(null, e),
        ...
        await this.persistence.He((async t => {
            await ya(this.jo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Bo(t) {
        const e = qr();
        if (!$r.gt(e)) throw new N(C.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = Hi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new $r(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class Da {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => ta(this.syncEngine, t, 1 /* SharedClientState */), 
    ...
    createDatastore(t) {
        const e = jr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Ur(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => ta(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Mr.gt() ? new Mr : new Fr, new Yr(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = K(t);
            O("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), await Zr(e), 
            e.Lr.shutdown(), 
 ...
 */ class xa {
     ...
     */    async Ho() {
        ...
        return new Lo(JSON.parse(s), t.length + n);
    }
     ...
     */    async Xo(t) {
        for (;this.buffer.length < t; ) {
            await this.ta() && this.Yo("Reached the end of bundle when more is expected.");
        }
...
class ka {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = K(t), s = qn(n.R) + "/documents", i = {
                documents: e.map((t => Mn(n.R, t)))
    ...
    delete(t) {
        this.write(new Ye(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
        ...
        // a `verify` operation.
        t.forEach(((t, e) => {
            const n = gt.fromPath(e);
            this.mutations.push(new Xe(n, this.precondition(n)));
        })), await async function(t, e) {
            const n = K(t), s = qn(n.R) + "/documents", i = {
                writes: e.map((t => zn(n.R, t)))
            };
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Me.updateTime(e) : Me.none();
    }
    /**
...
class $a {
    constructor(t, e, n, s) {
        ...
        this.ea = 5, this.Zi = new Qr(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    na() {
        this.Zi.Qi((async () => {
            const t = new ka(this.datastore), e = this.sa(t);
            e && e.then((e => {
    ...
    ia(t) {
        this.ea > 0 && this.ra(t) ? (this.ea -= 1, this.asyncQueue.enqueueAndForget((() => (this.na(), 
...
class Oa {
     ...
     */
    e, n) {
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = br.UNAUTHENTICATED, 
    ...
    terminate() {
        ...
        return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async () => {
            try {
                ...
                const n = vo(e, "Failed to shutdown persistence");
                t.reject(n);
            }
        })), t.promise;
    }
...
async function Fa(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await nr(e.localStore, t), s = t);
    })), 
...
function qa(t) {
    return La(t).then((t => t.localStore));
}
...
async function Qa(t) {
    ...
    return n.onListen = Ho.bind(null, e.syncEngine), n.onUnlisten = Yo.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function Wa(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Ua(t), n = await Ka(t);
        return e.setNetworkEnabled(!0), function(t) {
            const e = K(t);
            return e.Fr.delete(0 /* UserDisabled */), Xr(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function Ga(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = K(t);
            e.Fr.add(0 /* UserDisabled */), await Zr(e), 
 ...
 */ function za(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            const s = vo(t, `Failed to get document '${e} from cache`);
            n.reject(s);
        }
    }
    /**
...
function Ha(t, e, n = {}) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Na({
            ...
            error: t => i.reject(t)
        }), o = new Mo(re(n.path), r, {
            includeMetadataChanges: !0,
            so: !0
        });
        return xo(t, o);
    }(await Qa(t), t.asyncQueue, e, n, s))), s.promise;
}
...
function Ja(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            const s = vo(t, `Failed to execute query '${e} against cache`);
            n.reject(s);
        }
    }
    /**
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Na({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => ko(t, o))), n.fromCache && "server" === s.source ? i.reject(new N(C.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Mo(n, r, {
            includeMetadataChanges: !0,
...
class sc {
    ...
    isEqual(t) {
        return t instanceof sc && t.projectId === this.projectId && t.database === this.database;
    }
}
...
/** A CredentialsProvider that always yields an empty token. */ class oc {
    constructor() {
        /**
    ...
    setChangeListener(t, e) {
        ...
        t.enqueueRetryable((() => e(br.UNAUTHENTICATED)));
    }
...
class cc {
    constructor(t) {
        ...
        this.currentUser = br.UNAUTHENTICATED, 
         ...
         * outstanding.
         */
        this.aa = 0, this.forceRefresh = !1, this.auth = null, this.asyncQueue = null, this.ca = () => {
            this.aa++, this.currentUser = this.ua(), this.oa.resolve(), this.changeListener && this.asyncQueue.enqueueRetryable((() => this.changeListener(this.currentUser)));
        };
        const e = t => {
            O("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.auth.addAuthTokenListener(this.ca);
        };
        t.onInit((t => e(t))), 
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                O("FirebaseCredentialsProvider", "Auth not yet detected"), this.oa.resolve());
            }
        }), 0);
    }
    getToken() {
        ...
        const t = this.aa, e = this.forceRefresh;
        return this.forceRefresh = !1, this.auth ? this.auth.getToken(e).then((e => 
        // Cancel the request since the token changed while the request was
        // outstanding so the response is potentially for a previous user (which
        // user, we can't be sure).
        this.aa !== t ? (O("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (U("string" == typeof e.accessToken), new rc(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    invalidateToken() {
        this.forceRefresh = !0;
    }
    setChangeListener(t, e) {
        ...
        this.asyncQueue.enqueueRetryable((async () => {
            await this.oa.promise, await e(this.currentUser), this.changeListener = e;
        }));
    }
    removeChangeListener() {
        this.auth && this.auth.removeAuthTokenListener(this.ca), this.changeListener = () => Promise.resolve();
    }
    ...
    ua() {
        ...
        return U(null === t || "string" == typeof t), new br(t);
    }
}
 ...
 */ class uc {
    constructor(t, e, n) {
        this.ha = t, this.la = e, this.fa = n, this.type = "FirstParty", this.user = br.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
            "X-Goog-AuthUser": this.la
        }, e = this.ha.auth.getAuthHeaderValueForFirstParty([]);
        // Use array notation to prevent minification
                return e && (t.Authorization = e), this.fa && (t["X-Goog-Iam-Authorization-Token"] = this.fa), 
        t;
    }
}
 ...
 */ class hc {
    constructor(t, e, n) {
        this.ha = t, this.la = e, this.fa = n;
    }
    getToken() {
        return Promise.resolve(new uc(this.ha, this.la, this.fa));
    }
    setChangeListener(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((() => e(br.FIRST_PARTY)));
    }
    removeChangeListener() {}
    invalidateToken() {}
}
 ...
 */ function dc(t) {
    if (!gt.isDocumentKey(t)) throw new N(C.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function wc(t) {
    if (gt.isDocumentKey(t)) throw new N(C.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ class pc {
    ...
    constructor(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof sc ? (this._databaseId = t, this._credentials = new oc) : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new sc(t.options.projectId);
        }
        /**
...
function Ec(t, e, n, s = {}) {
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        let e, n;
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = br.MOCK_USER; else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            e = createMockUserToken(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            const r = s.mockUserToken.sub || s.mockUserToken.user_id;
            if (!r) throw new N(C.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            n = new br(r);
        }
        t._credentials = new ac(new rc(e, n));
    }
}
...
function Rc(t, e, ...n) {
    if (t = getModularInstance(t), lc("collection", "path", e), t instanceof pc) {
        const s = et.fromString(e, ...n);
        return wc(s), new Ac(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Tc || t instanceof Ac)) throw new N(C.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = et.fromString(t.path, ...n).child(et.fromString(e));
 ...
 */ function Pc(t, e) {
    if (t = mc(t, pc), lc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new N(C.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Ic(t, 
    /* converter= */ null, 
    /**
...
function bc(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Q.u()), lc("doc", "path", e), t instanceof pc) {
        const s = et.fromString(e, ...n);
        return dc(s), new Tc(t, 
        /* converter= */ null, new gt(s));
    }
    {
        if (!(t instanceof Tc || t instanceof Ac)) throw new N(C.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(et.fromString(e, ...n));
        return dc(s), new Tc(t.firestore, t instanceof Ac ? t.converter : null, new gt(s));
    }
}
 ...
 * Firestore database.
 */ function Vc(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof Ic && e instanceof Ic && (t.firestore === e.firestore && we(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Sc {
    ...
    enqueue(t) {
        ...
        // advance the queue even when the operation is not run.
                const e = new $s;
        return this.Aa((() => this._a && this.pa ? Promise.resolve() : (t().then(e.resolve, e.reject), 
        e.promise))).then((() => e.promise));
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.wa.push(t), this.Ra())));
    }
    /**
     ...
     */    async Ra() {
        if (0 !== this.wa.length) {
            try {
                await this.wa[0](), this.wa.shift(), this.Zi.reset();
            } catch (t) {
                if (!Us(t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    Aa(t) {
        const e = this.da.then((() => (this.ya = !0, t().catch((t => {
            this.ga = t, this.ya = !1;
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        this.Ea.indexOf(t) > -1 && (e = 0);
        const s = bo.createAndSchedule(this, t, e, n, (t => this.Pa(t)));
        return this.ma.push(s), s;
    }
    Ia() {
        this.ga && B();
    }
     ...
     * exists.
     */    va(t) {
        for (const e of this.ma) if (e.timerId === t) return !0;
        return !1;
    }
    /**
     ...
     */    Va(t) {
        ...
        return this.ba().then((() => {
            ...
            this.ma.sort(((t, e) => t.targetTimeMs - e.targetTimeMs));
            for (const e of this.ma) if (e.skipDelay(), "all" /* All */ !== t && e.timerId === t) break;
            return this.ba();
        }));
    }
    /**
    ...
    /** Called once a DelayedOperation is run or canceled. */    Pa(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        const e = this.ma.indexOf(t);
        this.ma.splice(e, 1);
    }
}
...
class Cc {
    constructor() {
        this._progressObserver = {}, this._taskCompletionResolver = new $s, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
 ...
 */ function kc(e, n) {
    ...
    if (s.isInitialized()) {
        ...
        throw new N(C.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
...
function Fc(t) {
    ...
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new nc(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Oa(t._credentials, t._queue, s);
}
 ...
 */ function Mc(t, e) {
    zc(t = mc(t, xc));
    const n = Oc(t), s = t._freezeSettings(), i = new Da;
    return Bc(n, i, new Va(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Lc(t) {
    zc(t = mc(t, xc));
    const e = Oc(t), n = t._freezeSettings(), s = new Da;
    return Bc(e, s, new Sa(s, n.cacheSizeBytes));
}
 ...
 */ function Bc(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await Fa(t, n), await Ma(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function Uc(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Ms.gt()) return Promise.resolve();
                const e = t + "main";
                await Ms.delete(e);
            }(Hi(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function qc(t) {
    return function(t) {
        const e = new $s;
        return t.asyncQueue.enqueueAndForget((async () => ia(await ja(t), e))), e.promise;
    }(Oc(t = mc(t, xc)));
}
 ...
 */ function Wc(t, e) {
    ...
    return tc(n, t._databaseId, e, s), s;
}
 ...
 */ function Gc(t, e) {
    return ec(Oc(t = mc(t, xc)), e).then((e => e ? new Ic(t, null, e.query) : null));
}
 ...
 */ class Yc {
     ...
     */    static fromBase64String(t) {
        try {
            return new Yc(ot.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Yc(ot.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class eu {
    ...
    toMutation(t, e) {
        return null !== this.fieldMask ? new Ge(t, this.data, this.fieldMask, e, this.fieldTransforms) : new We(t, this.data, e, this.fieldTransforms);
    }
}
...
/** A "context" object passed around while parsing user data. */ class iu {
    ...
    constructor(t, e, n, s, i, r) {
        ...
        void 0 === i && this.Da(), this.fieldTransforms = i || [], this.fieldMask = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Na(t) {
        return new iu(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.R, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    xa(t) {
        var e;
        const n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), s = this.Na({
            path: n,
            ka: !1
        });
        return s.$a(t), s;
    ...
    Ma(t) {
        return Ru(t, this.settings.methodName, this.settings.La || !1, this.path, this.settings.Ba);
    }
    ...
    Da() {
        ...
        // within arrays.
        if (this.path) for (let t = 0; t < this.path.length; t++) this.$a(this.path.get(t));
    }
    $a(t) {
        if (0 === t.length) throw this.Ma("Document fields must not be empty");
        if (su(this.Ca) && tu.test(t)) throw this.Ma('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class ru {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || jr(t);
    }
...
/** Parse document data from a set() call. */ function au(t, e, n, s, i, r = {}) {
    const o = t.Ua(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Eu("Data must be an object, but it was:", o, s);
    const a = yu(s, o);
    let c, u;
    if (r.merge) c = new it(o.fieldMask), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        ...
        c = new it(t), u = o.fieldTransforms.filter((t => c.covers(t.field)));
    } else c = null, u = o.fieldTransforms;
    return new eu(new Nt(a), c, u);
}

class cu extends Xc {
    _toFieldTransform(t) {
        if (2 /* MergeSet */ !== t.Ca) throw 1 /* Update */ === t.Ca ? t.Ma(`${this._methodName}() can only appear at the top level of your update data`) : t.Ma(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
class lu extends Xc {
    ...
    _toFieldTransform(t) {
        const e = uu(this, t, 
        /*array=*/ !0), n = this.qa.map((t => gu(t, e))), s = new Ve(n);
...
class fu extends Xc {
    ...
    _toFieldTransform(t) {
        const e = uu(this, t, 
        /*array=*/ !0), n = this.qa.map((t => gu(t, e))), s = new De(n);
        return new $e(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class du extends Xc {
    ...
    _toFieldTransform(t) {
        const e = new Ne(t.R, Ie(t.R, this.Ka));
...
/** Parse update data from a list of field/value arguments. */ function _u(t, e, n, s, i, r) {
    const o = t.Ua(1 /* Update */ , e, n), a = [ Tu(e, s, n) ], c = [ i ];
 ...
 */ function mu(t, e, n, s = !1) {
    return gu(n, t.Ua(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */
    return function(t, e) {
        ...
        if (!su(e.Ca)) throw e.Ma(`${t._methodName}() can only be used with update() and set()`);
        if (!e.path) throw e.Ma(`${t._methodName}() is not currently supported inside arrays`);
 ...
 */ (t, e), null;
    ...
    e.path && e.fieldMask.push(e.path), t instanceof Array) {
        ...
        if (e.settings.ka && 4 /* ArrayArgument */ !== e.Ca) throw e.Ma("Nested arrays are not supported");
        return function(t, e) {
            const n = [];
            let s = 0;
            for (const i of t) {
    ...
    return function(t, e) {
        ...
        if (t instanceof Tc) {
            ...
            if (!s.isEqual(n)) throw e.Ma(`Document reference is for database ${s.projectId}/${s.database} but should be for database ${n.projectId}/${n.database}`);
            return {
                referenceValue: On(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Ma(`Unsupported field value: ${_c(t)}`);
    }
    /**
...
function yu(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : X(t, ((t, s) => {
        const i = gu(s, e.xa(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function pu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof H || t instanceof Zc || t instanceof Yc || t instanceof Tc || t instanceof Xc);
}
...
function Eu(t, e, n) {
    if (!pu(n) || !function(t) {
        ...
        const s = _c(n);
        throw "an object" === s ? e.Ma(t + " a custom object") : e.Ma(t + " " + s);
    }
}
...
function Ru(t, e, n, s, i) {
    ...
    c += ")"), new N(C.INVALID_ARGUMENT, a + t + c);
}
 ...
 * limitations under the License.
 */ function $u(t) {
    if (ae(t) && 0 === t.explicitOrderBy.length) throw new N(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Mu extends Ou {
    constructor(t, e, n) {
        super(), this.ja = t, this.Qa = e, this.Wa = n, this.type = "where";
    }
    _apply(t) {
 ...
 */
        ...
        }(t._query, "where", e, t.firestore._databaseId, this.ja, this.Qa, this.Wa);
...
class Bu extends Ou {
    constructor(t, e) {
        super(), this.ja = t, this.Ga = e, this.type = "orderBy";
    }
    _apply(t) {
...
class qu extends Ou {
    constructor(t, e, n) {
        super(), this.type = t, this.za = e, this.Ha = n;
    }
    _apply(t) {
        return new Ic(t.firestore, t.converter, de(t._query, this.za, this.Ha));
    }
}
...
class Qu extends Ou {
    ...
    _apply(t) {
        const e = Yu(t, this.type, this.Ja, this.Ya);
        return new Ic(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function Yu(t, e, n, s) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof bu) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of le(t)) if (n.field.isKeyField()) r.push(Pt(e, s.key)); else {
            const t = s.data.field(n.field);
            if (lt(t)) throw new N(C.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    if ("string" != typeof c) throw new N(C.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${s}(), but got a ${typeof c}`);
                    if (!he(t) && -1 !== c.indexOf("/")) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${c}' contains a slash.`);
                    const n = t.path.child(et.fromString(c));
                    if (!gt.isDocumentKey(n)) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new gt(n);
                    a.push(Pt(e, i));
                } else {
                    const t = mu(n, s, c);
...
function Xu(t, e, n) {
    if ("string" == typeof (n = getModularInstance(n))) {
        ...
        if (!he(e) && -1 !== n.indexOf("/")) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(et.fromString(n));
        if (!gt.isDocumentKey(s)) throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return Pt(t, new gt(s));
    }
    if (n instanceof Tc) return Pt(t, n._key);
    throw new N(C.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${_c(n)}.`);
}
 ...
 */ class eh {
    ...
    convertGeoPoint(t) {
        return new Zc(ut(t.latitude), ut(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        U(ls(n));
        const s = new sc(n.get(1), n.get(3)), i = new gt(n.popFirst(5));
        return s.isEqual(e) || 
 ...
 */ class ih {
    ...
    set(t, e, n) {
        ...
        return this._mutations.push(r.toMutation(s._key, Me.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        ...
        this._mutations.push(r.toMutation(i._key, Me.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new Ye(e._key, Me.none())), this;
    }
    /**
...
function rh(t, e) {
    if ((t = getModularInstance(t)).firestore !== e) throw new N(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function oh(t) {
    ...
    return Ha(Oc(e), t._key).then((n => Eh(e, t, n)));
}
 ...
 */ function ch(t) {
    ...
    return za(n, t._key).then((n => new Du(e, s, t._key, n, new Su(null !== n && n.hasLocalMutations, 
 ...
 */ function hh(t) {
    t = mc(t, Ic);
    const e = mc(t.firestore, xc), n = Oc(e), s = new ah(e);
    return $u(t._query), Ya(n, t._query).then((n => new Nu(e, s, t, n)));
}
 ...
 */ function lh(t) {
    t = mc(t, Ic);
    const e = mc(t.firestore, xc), n = Oc(e), s = new ah(e);
    return Ja(n, t._query).then((n => new Nu(e, s, t, n)));
}
...
function dh(t, e, n) {
    ...
    return ph(s, [ au(ou(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Me.none()) ]);
}
...
function wh(t, e, n, ...s) {
    ...
    return ph(i, [ o.toMutation(t._key, Me.exists(!0)) ]);
}
 ...
 */ function _h(t) {
    return ph(mc(t.firestore, xc), [ new Ye(t._key, Me.none()) ]);
}
 ...
 */ function mh(t, e) {
    ...
    return ph(n, [ au(ou(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Me.exists(!1)) ]).then((() => s));
}
...
function gh(t, ...e) {
    ...
    let c, u, h;
    if (t instanceof Tc) u = mc(t.firestore, xc), h = re(t._key.path), c = {
        next: n => {
            e[o] && e[o](Eh(u, t, n));
        },
        error: e[o + 1],
    ...
    return function(t, e, n, s) {
        const i = new Na(s), r = new Mo(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => xo(await Qa(t), r))), () => {
            i.Wo(), t.asyncQueue.enqueueAndForget((async () => ko(await Qa(t), r)));
        };
    }(Oc(u), h, a, c);
}

function yh(t, e) {
    return Xa(Oc(t = mc(t, xc)), Dc(e) ? e : {
        next: e
    });
}
 ...
 */ function ph(t, e) {
    return function(t, e) {
        const n = new $s;
        return t.asyncQueue.enqueueAndForget((async () => Xo(await ja(t), e, n))), n.promise;
    }(Oc(t), e);
}
...
!function(t) {
    ...
    const n = t.getProvider("app").getImmediate(), s = new xc(n, t.getProvider("auth-internal"));
    return e = Object.assign({
        useFetchStreams: !0
    }, e), s._setSettings(e), s;
}), "PUBLIC" /* PUBLIC */)), registerVersion("@firebase/firestore", "3.0.0-202171919375", Sh);
