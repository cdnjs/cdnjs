...
d;this.sliderHeight=g;this.slider.height(g);this.events.scroll();this.pane.show();this.paneOuterHeight>=a.scrollHeight&&"scroll"!==i?this.pane.hide():this.el.height()===a.scrollHeight&&"scroll"===i?this.slider.hide():this.slider.show();return this};c.prototype.scroll=function(){this.sliderY=Math.max(0,this.sliderY);this.sliderY=Math.min(this.maxSliderTop,this.sliderY);this.content.scrollTop(-1*((this.paneHeight-this.contentHeight+f)*this.sliderY/this.maxSliderTop));this.slider.css({top:this.sliderY});
...
this.pane.hide();return this};c.prototype.flash=function(){var a=this;this.pane.addClass("flashed");setTimeout(function(){a.pane.removeClass("flashed")},this.options.flashDelay);return this};return c}();e.fn.nanoScroller=function(c){var a,b,f,i,d,j,g;null!=c&&(i=c.scrollBottom,j=c.scrollTop,d=c.scrollTo,f=c.scroll,g=c.stop,a=c.flash);b=e.extend({},o,c);this.each(function(){var h;if(h=e.data(this,"scrollbar"))e.extend(h.options,c);else{h=new n(this,b);e.data(this,"scrollbar",h)}return i?h.scrollBottom(i):
j?h.scrollTop(j):d?h.scrollTo(d):f==="bottom"?h.scrollBottom(0):f==="top"?h.scrollTop(0):f instanceof e?h.scrollTo(f):g?h.stop():a?h.flash():h.reset()})}})(jQuery,window,document);