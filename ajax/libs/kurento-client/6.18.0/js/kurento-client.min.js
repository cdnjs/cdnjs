...
"toJSON"in Error.prototype||Object.defineProperty(Error.prototype,"toJSON",{value:function(){var r={};return Object.getOwnPropertyNames(this).forEach(function(t){r[t]=this[t]},this),r},configurable:!0,writable:!0});
...
},{"events":21,"util":154}],12:[function(require,module,exports){
...
},{"./backoff":11,"./strategy/fibonacci":14,"events":21,"util":154}],13:[function(require,module,exports){
...
},{"./strategy":15,"util":154}],14:[function(require,module,exports){
...
},{"./strategy":15,"util":154}],15:[function(require,module,exports){
...
},{"events":21,"util":154}],16:[function(require,module,exports){
...
function checkDSCPValue(O,A){if("string"!=typeof A)throw SyntaxError(O+" param should be a String, not "+typeof A);if(!A.match("NO_DSCP|NO_VALUE|AUDIO_VERYLOW|AUDIO_LOW|AUDIO_MEDIUM|AUDIO_HIGH|VIDEO_VERYLOW|VIDEO_LOW|VIDEO_MEDIUM|VIDEO_MEDIUM_THROUGHPUT|VIDEO_HIGH|VIDEO_HIGH_THROUGHPUT|DATA_VERYLOW|DATA_LOW|DATA_MEDIUM|DATA_HIGH|CHROME_HIGH|CHROME_MEDIUM|CHROME_LOW|CHROME_VERYLOW|CS0|CS1|CS2|CS3|CS4|CS5|CS6|CS7|AF11|AF12|AF13|AF21|AF22|AF23|AF31|AF32|AF33|AF41|AF42|AF43|EF|VOICEADMIT|LE"))throw SyntaxError(O+" param is not one of [NO_DSCP|NO_VALUE|AUDIO_VERYLOW|AUDIO_LOW|AUDIO_MEDIUM|AUDIO_HIGH|VIDEO_VERYLOW|VIDEO_LOW|VIDEO_MEDIUM|VIDEO_MEDIUM_THROUGHPUT|VIDEO_HIGH|VIDEO_HIGH_THROUGHPUT|DATA_VERYLOW|DATA_LOW|DATA_MEDIUM|DATA_HIGH|CHROME_HIGH|CHROME_MEDIUM|CHROME_LOW|CHROME_VERYLOW|CS0|CS1|CS2|CS3|CS4|CS5|CS6|CS7|AF11|AF12|AF13|AF21|AF22|AF23|AF31|AF32|AF33|AF41|AF42|AF43|EF|VOICEADMIT|LE] ("+A+")")}var kurentoClient=require("kurento-client");module.exports=checkDSCPValue;
},{"kurento-client":"kurento-client"}],100:[function(require,module,exports){
function checkGapsFixMethod(t,o){if("string"!=typeof o)throw SyntaxError(t+" param should be a String, not "+typeof o);if(!o.match("NONE|GENPTS|FILL_IF_TRANSCODING"))throw SyntaxError(t+" param is not one of [NONE|GENPTS|FILL_IF_TRANSCODING] ("+o+")")}var kurentoClient=require("kurento-client");module.exports=checkGapsFixMethod;
...
function checkMediaProfileSpecType(O,_){if("string"!=typeof _)throw SyntaxError(O+" param should be a String, not "+typeof _);if(!_.match("WEBM|MKV|MP4|WEBM_VIDEO_ONLY|WEBM_AUDIO_ONLY|MKV_VIDEO_ONLY|MKV_AUDIO_ONLY|MP4_VIDEO_ONLY|MP4_AUDIO_ONLY|JPEG_VIDEO_ONLY|KURENTO_SPLIT_RECORDER|FLV"))throw SyntaxError(O+" param is not one of [WEBM|MKV|MP4|WEBM_VIDEO_ONLY|WEBM_AUDIO_ONLY|MKV_VIDEO_ONLY|MKV_AUDIO_ONLY|MP4_VIDEO_ONLY|MP4_AUDIO_ONLY|JPEG_VIDEO_ONLY|KURENTO_SPLIT_RECORDER|FLV] ("+_+")")}var kurentoClient=require("kurento-client");module.exports=checkMediaProfileSpecType;
...
var CertificateKeyType=require("./CertificateKeyType"),CryptoSuite=require("./CryptoSuite"),DSCPValue=require("./DSCPValue"),GapsFixMethod=require("./GapsFixMethod"),IceCandidate=require("./IceCandidate"),IceCandidatePair=require("./IceCandidatePair"),IceComponentState=require("./IceComponentState"),IceConnection=require("./IceConnection"),MediaProfileSpecType=require("./MediaProfileSpecType"),SDES=require("./SDES"),VideoInfo=require("./VideoInfo");exports.CertificateKeyType=CertificateKeyType,exports.CryptoSuite=CryptoSuite,exports.DSCPValue=DSCPValue,exports.GapsFixMethod=GapsFixMethod,exports.IceCandidate=IceCandidate,exports.IceCandidatePair=IceCandidatePair,exports.IceComponentState=IceComponentState,exports.IceConnection=IceConnection,exports.MediaProfileSpecType=MediaProfileSpecType,exports.SDES=SDES,exports.VideoInfo=VideoInfo;
},{"./CertificateKeyType":97,"./CryptoSuite":98,"./DSCPValue":99,"./GapsFixMethod":100,"./IceCandidate":101,"./IceCandidatePair":102,"./IceComponentState":103,"./IceConnection":104,"./MediaProfileSpecType":105,"./SDES":106,"./VideoInfo":107}],109:[function(require,module,exports){
...
},{"ws":157}],120:[function(require,module,exports){
...
},{"./Mapper":115,"./clients":116,"./clients/transports":118,"./packers":123,"events":21,"inherits":"inherits"}],121:[function(require,module,exports){
...
},{"./_stream_readable":133,"./_stream_writable":135,"core-util-is":19,"inherits":"inherits","process-nextick-args":124}],132:[function(require,module,exports){
...
},{"./_stream_duplex":131,"./internal/streams/BufferList":136,"./internal/streams/destroy":137,"./internal/streams/stream":138,"_process":125,"buffer":18,"core-util-is":19,"events":21,"inherits":"inherits","isarray":25,"process-nextick-args":124,"safe-buffer":139,"string_decoder/":140,"util":17}],134:[function(require,module,exports){
...
},{"./_stream_duplex":131,"./internal/streams/destroy":137,"./internal/streams/stream":138,"_process":125,"buffer":18,"core-util-is":19,"inherits":"inherits","process-nextick-args":124,"safe-buffer":139,"timers":149,"util-deprecate":152}],136:[function(require,module,exports){
...
},{"safe-buffer":139,"util":17}],137:[function(require,module,exports){
...
},{"process-nextick-args":124}],138:[function(require,module,exports){
module.exports=require("events").EventEmitter;
},{"events":21}],139:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":18}],140:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":18,"safe-buffer":139}],141:[function(require,module,exports){
...
},{"backoff":10,"events":21}],146:[function(require,module,exports){
...
},{"reconnect-core":145,"websocket-stream":155}],147:[function(require,module,exports){
...
},{"events":21,"inherits":"inherits","readable-stream/duplex.js":130,"readable-stream/passthrough.js":141,"readable-stream/readable.js":142,"readable-stream/transform.js":143,"readable-stream/writable.js":144}],148:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":125,"stream":147}],149:[function(require,module,exports){
...
},{"process/browser.js":125,"timers":149}],150:[function(require,module,exports){
...
},{"./util":151,"punycode":126,"querystring":129}],151:[function(require,module,exports){
...
},{"./support/isBuffer":153,"_process":125,"inherits":"inherits"}],155:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":125,"isbuffer":26,"through":148,"ws":156}],156:[function(require,module,exports){
