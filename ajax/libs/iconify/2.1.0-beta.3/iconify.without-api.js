...
var Iconify = (function (exports) {
  ...
  function parseIconSet(data, callback, list) {
    ...
    Object.keys(icons).forEach(function (name) {
      ...
      callback(name, Object.freeze(Object.assign({}, iconDefaults, defaults, icon)));
      added.push(name);
    });
    if (typeof data.aliases === "object") {
      var aliases = data.aliases;
      Object.keys(aliases).forEach(function (name) {
        var icon = resolveAlias(aliases[name], icons, aliases, 1);
        if (icon) {
          callback(name, Object.freeze(Object.assign({}, iconDefaults, defaults, icon)));
          added.push(name);
        }
  ...
  function addIconSet(storage2, data, list) {
    if ( list === void 0 ) list = "none";
        ...
        params.forEach(function (item) {
          sendAPIQuery(provider, item, function (data, error) {
            ...
            if (typeof data !== "object") {
              ...
              try {
                var added = addIconSet(storage, data, "all");
