...
var Iconify = (function () {
	...
	function initRedundancy(cfg) {
	    ...
	    function query(payload, queryCallback, doneCallback) {
	        var query = query$1.sendQuery(config, payload, queryCallback, function (data, error) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.getAPIConfig = exports.setAPIConfig = exports.createAPIConfig = void 0;
	/**
	...
	function getRedundancyCache(provider) {
	    if (redundancyCache[provider] === void 0) {
	        var config = config_2.getAPIConfig(provider);
	        if (!config) {
	...
	function sendAPIQuery(target, query, callback) {
	    ...
	    if (typeof target === 'string') {
	        // Get API module
	        var api = modules.getAPIModule(target);
	        if (!api) {
	            // No API module
	        ...
	        if (cached) {
	            redundancy$1 = cached.redundancy;
	        }
	    }
	    else {
	        var config$1 = config.createAPIConfig(target);
	        if (config$1) {
	            redundancy$1 = redundancy.initRedundancy(config$1);
	            // Use default API provider
	            var api$1 = modules.getAPIModule('');
	            if (api$1) {
	                send = api$1.send;
	            }
	        }
	    }
	    if (!redundancy$1 || !send) {
	        // No way to load icons because configuration is not set!
	        callback(void 0, 424);
	        return emptyCallback;
	    }
	    // Send API query, return function to abort query
	    return redundancy$1.query(query, send, callback)()
	        .abort;
	}
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.loadIcons = exports.isPending = void 0;
	    ...
	    if (!providerQueueFlags[prefix]) {
	        ...
	        setTimeout(function () {
	            ...
	            params.forEach(function (item) {
	                query.sendAPIQuery(provider, item, function (data, error) {
	                    var storage = storage_1.getStorage(provider, prefix);
	                    // Check for error
	                    if (typeof data !== 'object') {
	                        if (error !== 404) {
	                        ...
	                        try {
	                            ...
	                            if (cache.cache.store) {
	                                cache.cache.store(provider, data);
	                            }
	                        }
	                        catch (err) {
	                            console.error(err);
	...
	var loadIcons = function (icons, callback) {
	    ...
	    var cleanedIcons = list.listToIcons(icons, true, functions$1.allowSimpleNames());
	...
	function scanDOM(node, addTempNode) {
	    ...
	    (node ? [node] : listRootNodes()).forEach(function (node) {
	        ...
	        findPlaceholders(root).forEach(function (item) {
	            ...
	            if (!icons.isPending({ provider: provider, prefix: prefix, name: name })) {
	    ...
	    Object.keys(iconsToLoad).forEach(function (provider) {
	        ...
	        Object.keys(providerIconsToLoad).forEach(function (prefix) {
	            icons.loadIcons(Object.keys(providerIconsToLoad[prefix]).map(function (name) {
	                var icon = {
	                    provider: provider,
	                    prefix: prefix,
	                    name: name,
	...
	var commonFunctions = {
	    // Version
	    getVersion: function () { return '2.1.0-beta.1'; },
	    // Render SVG
