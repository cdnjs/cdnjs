...
var Iconify = (function () {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.getAPIModule = exports.getFetch = void 0;
	/**
	 * Endpoint
	 */
	 ...
	 */
	function getFetch() {
	    var fetchModule = typeof fetch === 'function' ? fetch : void 0;
	    try {
	 ...
	 */
	// Check for Fetch API
	var fetchModule = fetch_1.getFetch();
	// Set API
