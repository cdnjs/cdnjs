...
var Iconify = (function (exports) {
  ...
  function listIcons(provider, prefix) {
    ...
    providers.forEach(function (provider2) {
      ...
      prefixes.forEach(function (prefix2) {
        ...
        allIcons = allIcons.concat(Object.keys(storage.icons).map(function (name) { return (provider2 !== "" ? "@" + provider2 + ":" : "") + prefix2 + ":" + name; }));
      });
    });
    return allIcons;
  }
  ...
  function listToIcons(list, validate, simpleNames) {
    ...
    list.forEach(function (item) {
      var icon = typeof item === "string" ? stringToIcon(item, validate, simpleNames) : Object.assign({}, item);
      if (icon) {
        result.push(icon);
      }
    });
