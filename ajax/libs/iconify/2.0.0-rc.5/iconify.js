...
var Iconify = (function () {
	 ...
	 */
	var stringToIcon = function (value, validate) {
	    var provider = '';
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.storageFunctions = exports.addCollection = exports.getIconData = void 0;
	...
	function getIconData(name$1) {
	    var icon = typeof name$1 === 'string' ? name.stringToIcon(name$1, true) : name$1;
	    return icon
	...
	exports.storageFunctions = {
	    ...
	    // Add icon
	    addIcon: function (name$1, data) {
	        var icon = name.stringToIcon(name$1, true);
	        if (!icon) {
	            return false;
	        }
