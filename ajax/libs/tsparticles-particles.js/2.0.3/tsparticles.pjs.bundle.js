...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Background/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/BackgroundMask/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/FullScreen/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Interactivity/Events/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Interactivity/Modes/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Interactivity/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Motion/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Theme/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Life/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Move/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Orbit/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Roll/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Rotate/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Size/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Tilt/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Wobble/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/ZIndex/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Particles/Links/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/index.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/index.js
...
var EventDispatcher_classPrivateFieldGet = undefined && undefined.__classPrivateFieldGet || function (receiver, state, kind, f) {
  if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
...
class EventDispatcher {
  constructor() {
    ...
    EventDispatcher_classPrivateFieldSet(this, _EventDispatcher_listeners, new Map(), "f");
  }
  ...
  addEventListener(type, listener) {
    ...
    if (!EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").get(type)) {
      EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").set(type, []);
    }

    (_a = EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").get(type)) === null || _a === void 0 ? void 0 : _a.push(listener);
  }

  removeEventListener(type, listener) {
    const arr = EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").get(type);
    ...
    if (length === 1) {
      EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").delete(type);
    } else {
      arr.splice(idx, 1);
    }
  }
  ...
  dispatchEvent(type, args) {
    ...
    (_a = EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").get(type)) === null || _a === void 0 ? void 0 : _a.forEach(handler => handler(args));
  }

  hasEventListener(type) {
    return !!EventDispatcher_classPrivateFieldGet(this, _EventDispatcher_listeners, "f").get(type);
  }
