...
const fixOptions = options => {
  ...
  if (particlesOptions) {
    particlesOptions.links = (0,dist.deepExtend)(particlesOptions.links, particlesOptions.line_linked);
    ...
    if (opacityOptions) {
      if (opacityOptions.random) {
        opacityOptions.value = (0,dist.setRangeValue)((_c = opacityOptions.value) !== null && _c !== void 0 ? _c : 1, 0);
      }

      if (opacityOptions.anim) {
        opacityOptions.animation = (0,dist.deepExtend)(opacityOptions.animation, opacityOptions.anim);

        if (opacityOptions.anim.enable && opacityOptions.anim.opacity_min !== undefined) {
          opacityOptions.value = (0,dist.setRangeValue)((_d = opacityOptions.value) !== null && _d !== void 0 ? _d : opacityOptions.anim.opacity_min, opacityOptions.anim.opacity_min);
        }
      }
    }

    if ((_e = particlesOptions.shape) === null || _e === void 0 ? void 0 : _e.stroke) {
      particlesOptions.stroke = (0,dist.deepExtend)(particlesOptions.stroke, particlesOptions.shape.stroke);
    }
    ...
    if ((_f = particlesOptions.shape) === null || _f === void 0 ? void 0 : _f.polygon) {
      ...
      particlesOptions.shape.options.polygon = (0,dist.deepExtend)(particlesOptions.shape.options.polygon, particlesOptions.shape.polygon);
    }
    ...
    if ((_g = particlesOptions.shape) === null || _g === void 0 ? void 0 : _g.image) {
      ...
      particlesOptions.shape.options.image = (0,dist.deepExtend)(particlesOptions.shape.options.image, particlesOptions.shape.image);
    }
    ...
    if (sizeOptions) {
      if (sizeOptions.random) {
        sizeOptions.value = (0,dist.setRangeValue)((_h = sizeOptions.value) !== null && _h !== void 0 ? _h : 1, 0);
      }

      if (sizeOptions.anim) {
        sizeOptions.animation = (0,dist.deepExtend)(sizeOptions.animation, sizeOptions.anim);

        if (sizeOptions.anim.enable && sizeOptions.anim.size_min !== undefined) {
          sizeOptions.value = (0,dist.setRangeValue)((_j = sizeOptions.value) !== null && _j !== void 0 ? _j : sizeOptions.anim.size_min, sizeOptions.anim.size_min);
        }
      }
    }
  }
  ...
  if (interactivityOptions) {
    ...
    if (eventsOptions) {
      if (eventsOptions.onclick) {
        eventsOptions.onClick = (0,dist.deepExtend)(eventsOptions.onClick, eventsOptions.onclick);
      }

      if (eventsOptions.onhover) {
        eventsOptions.onHover = (0,dist.deepExtend)(eventsOptions.onHover, eventsOptions.onhover);
      }
    }
    ...
    if (modesOptions) {
      if ((_k = modesOptions.grab) === null || _k === void 0 ? void 0 : _k.line_linked) {
        modesOptions.grab.links = (0,dist.deepExtend)(modesOptions.grab.links, modesOptions.grab.line_linked);
      }
...
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8538);
...
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in tsparticles_engine__WEBPACK_IMPORTED_MODULE_1__) if(["default","particlesJS","pJSDom"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => tsparticles_engine__WEBPACK_IMPORTED_MODULE_1__[__WEBPACK_IMPORT_KEY__]
...
const {
  particlesJS,
  pJSDom
} = (0,___WEBPACK_IMPORTED_MODULE_0__/* .initPjs */ .g)(tsparticles_engine__WEBPACK_IMPORTED_MODULE_1__.tsParticles);
