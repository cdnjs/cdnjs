...
const fixOptions = options => {
  ...
  if (particlesOptions) {
    particlesOptions.links = deepExtend(particlesOptions.links, particlesOptions.line_linked);
    ...
    if (opacityOptions) {
      if (opacityOptions.random) {
        opacityOptions.value = setRangeValue((_c = opacityOptions.value) !== null && _c !== void 0 ? _c : 1, 0);
      }

      if (opacityOptions.anim) {
        opacityOptions.animation = deepExtend(opacityOptions.animation, opacityOptions.anim);

        if (opacityOptions.anim.enable && opacityOptions.anim.opacity_min !== undefined) {
          opacityOptions.value = setRangeValue((_d = opacityOptions.value) !== null && _d !== void 0 ? _d : opacityOptions.anim.opacity_min, opacityOptions.anim.opacity_min);
        }
      }
    }

    if ((_e = particlesOptions.shape) === null || _e === void 0 ? void 0 : _e.stroke) {
      particlesOptions.stroke = deepExtend(particlesOptions.stroke, particlesOptions.shape.stroke);
    }
    ...
    if ((_f = particlesOptions.shape) === null || _f === void 0 ? void 0 : _f.polygon) {
      ...
      particlesOptions.shape.options.polygon = deepExtend(particlesOptions.shape.options.polygon, particlesOptions.shape.polygon);
    }
    ...
    if ((_g = particlesOptions.shape) === null || _g === void 0 ? void 0 : _g.image) {
      ...
      particlesOptions.shape.options.image = deepExtend(particlesOptions.shape.options.image, particlesOptions.shape.image);
    }
    ...
    if (sizeOptions) {
      if (sizeOptions.random) {
        sizeOptions.value = setRangeValue((_h = sizeOptions.value) !== null && _h !== void 0 ? _h : 1, 0);
      }

      if (sizeOptions.anim) {
        sizeOptions.animation = deepExtend(sizeOptions.animation, sizeOptions.anim);

        if (sizeOptions.anim.enable && sizeOptions.anim.size_min !== undefined) {
          sizeOptions.value = setRangeValue((_j = sizeOptions.value) !== null && _j !== void 0 ? _j : sizeOptions.anim.size_min, sizeOptions.anim.size_min);
        }
      }
    }
  }
  ...
  if (interactivityOptions) {
    ...
    if (eventsOptions) {
      if (eventsOptions.onclick) {
        eventsOptions.onClick = deepExtend(eventsOptions.onClick, eventsOptions.onclick);
      }

      if (eventsOptions.onhover) {
        eventsOptions.onHover = deepExtend(eventsOptions.onHover, eventsOptions.onhover);
      }
    }
    ...
    if (modesOptions) {
      if ((_k = modesOptions.grab) === null || _k === void 0 ? void 0 : _k.line_linked) {
        modesOptions.grab.links = deepExtend(modesOptions.grab.links, modesOptions.grab.line_linked);
      }
