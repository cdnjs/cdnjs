...
class VenlyProvider {
    ...
    checkAuthenticated() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._provider)
                throw new Error('Please initialise provider first (Venly.createProvider)');
            return yield this.venlyController.checkAuthenticated();
        });
    }
    authenticate(authenticationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._provider)
                throw new Error('Please initialise provider first (Venly.createProvider)');
            return this.venlyController.authResult = yield this.venlyController.startGetAccountFlow(authenticationOptions);
        });
    }
    logout() {
        return __awaiter(this, void 0, void 0, function* () {
