...
exports.VenlyProvider = exports.CHAIN_CONFIGS = exports.WindowMode = exports.SecretType = void 0;
...
Object.defineProperty(exports, "CHAIN_CONFIGS", { enumerable: true, get: function () { return types_2.CHAIN_CONFIGS; } });
class VenlyProvider {
    constructor() {
    ...
    changeSecretType(secretType = connect_1.SecretType.ETHEREUM, chainId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = Object.assign(Object.assign(Object.assign({}, this.venlyController.options), { secretType: secretType }), chainId && { environment: types_1.CHAIN_CONFIGS[Number(chainId)].env });
            ...
            this._provider.emit('chainChanged', chainId !== null && chainId !== void 0 ? chainId : types_1.CHAIN_IDS[secretType][this.venlyController.options.environment]);
...
_VenlyProvider_instances = new WeakSet(), _VenlyProvider_getRpcUrl = function _VenlyProvider_getRpcUrl(options) {
    ...
    const chainId = (_a = types_1.CHAIN_IDS[options.secretType][options.environment]) !== null && _a !== void 0 ? _a : types_1.CHAIN_IDS[options.secretType]['production'];
    if (!chainId)
