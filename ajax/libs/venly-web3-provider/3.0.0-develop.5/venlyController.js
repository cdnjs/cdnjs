...
class VenlyController {
    ...
    authenticate() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            let authResult = yield this.venlyConnect.checkAuthenticated();
            if (!authResult.isAuthenticated)
                authResult = yield this.venlyConnect.flows.authenticate({
    ...
    getAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authResult = yield this.venlyConnect.checkAuthenticated();
            if (!authResult.isAuthenticated)
