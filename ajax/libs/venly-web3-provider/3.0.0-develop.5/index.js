    ...
    createProviderEngine(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.windowMode == null)
                options.windowMode = connect_1.WindowMode.POPUP;
            if (options.secretType == null)
                options.secretType = connect_1.SecretType.ETHEREUM;
            ...
            if (!options.skipAuthentication)
                yield this.venlyController.authenticate();
            return this._provider;
        });
    }
    getRpcUrl(options) {
