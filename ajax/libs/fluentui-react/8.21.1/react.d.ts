 ...
 * {@docCategory Pickers}
 */
export declare class BasePicker<T, P extends IBasePickerProps<T>> extends React_2.Component<P, IBasePickerState> implements IBasePicker<T> {
    protected root: React_2.RefObject<HTMLDivElement>;
 ...
 * {@docCategory Announced}
 */
export declare interface IAnnouncedProps extends React_2.Props<AnnouncedBase>, React_2.HTMLAttributes<HTMLDivElement> {
    /**
 ...
 * {@docCategory Pickers}
 */
export declare interface IBasePickerProps<T> extends React_2.Props<any> {
    /**
 ...
 * {@docCategory Dialog}
 */
export declare interface IDialogFooterProps extends React_2.Props<DialogFooterBase> {
    /**
     * Gets the component ref.
     */
...
export declare interface IStickyProps extends React_2.Props<Sticky> {
    /**
 ...
 * {@docCategory Pickers}
 */
export declare interface ISuggestionsProps<T> extends React_2.Props<any> {
    /**
...
export declare interface ITimePickerProps extends Omit<IComboBoxProps, 'options' | 'selectedKey' | 'defaultSelectedKey' | 'multiSelect' | 'text'> {
    /**
