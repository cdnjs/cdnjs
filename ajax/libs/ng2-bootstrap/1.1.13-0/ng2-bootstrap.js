...
System.registerDynamic("ng2-bootstrap/components/typeahead/typeahead-match.class", [], true, function ($__require, exports, module) {
    "use strict";
...
System.registerDynamic('ng2-bootstrap/components/typeahead/typeahead.directive', ['@angular/core', '@angular/forms', './typeahead-container.component', './typeahead-options.class', './typeahead-utils', 'rxjs/Observable', 'rxjs/add/observable/from', 'rxjs/add/operator/debounceTime', 'rxjs/add/operator/filter', 'rxjs/add/operator/map', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/toArray', '../utils/components-helper.service', './typeahead-match.class'], true, function ($__require, exports, module) {
    "use strict";
    ...
    var components_helper_service_1 = $__require('../utils/components-helper.service');
    var typeahead_match_class_1 = $__require('./typeahead-match.class');
    /* tslint:disable-next-line */
    var KeyboardEvent = global.KeyboardEvent;
