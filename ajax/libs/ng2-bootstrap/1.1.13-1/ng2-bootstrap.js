...
System.registerDynamic('ng2-bootstrap/components/datepicker', ['./datepicker/datepicker.component', './datepicker/datepicker.module', './datepicker/daypicker.component', './datepicker/monthpicker.component', './datepicker/yearpicker.component', './datepicker/date-formatter'], true, function ($__require, exports, module) {
  "use strict";
  /*
   todo: general:
   1. Popup
  ...
  var daypicker_component_1 = $__require('./datepicker/daypicker.component');
  exports.DayPickerComponent = daypicker_component_1.DayPickerComponent;
  var monthpicker_component_1 = $__require('./datepicker/monthpicker.component');
  exports.MonthPickerComponent = monthpicker_component_1.MonthPickerComponent;
  var yearpicker_component_1 = $__require('./datepicker/yearpicker.component');
  exports.YearPickerComponent = yearpicker_component_1.YearPickerComponent;
  var date_formatter_1 = $__require('./datepicker/date-formatter');
...
System.registerDynamic('ng2-bootstrap/components/dropdown', ['./dropdown/dropdown-menu.directive', './dropdown/dropdown-toggle.directive', './dropdown/dropdown.directive', './dropdown/dropdown.service', './dropdown/dropdown.module'], true, function ($__require, exports, module) {
  "use strict";
...
System.registerDynamic('ng2-bootstrap/components/typeahead', ['./typeahead/typeahead-match.class', './typeahead/typeahead-options.class', './typeahead/typeahead-utils', './typeahead/typeahead-container.component', './typeahead/typeahead.directive', './typeahead/typeahead.module'], true, function ($__require, exports, module) {
  "use strict";

  var define,
      global = this || self,
      GLOBAL = global;
  var typeahead_match_class_1 = $__require('./typeahead/typeahead-match.class');
  ...
  var typeahead_utils_1 = $__require('./typeahead/typeahead-utils');
