...
var DatePickerBase = (function () {
    function DatePickerBase(datePickerState, options) {
        ...
        options.onUpdate.subscribe(function () {
            _this.refresh(datePickerState.viewDate);
        });
        datePickerState.viewDateChange.subscribe(function (v) {
            _this.refresh(datePickerState.viewDate);
        });
        datePickerState.activeDateChange.subscribe(function (v) {
            _this.markActive();
        });
        datePickerState.selectedDateChange.subscribe(function (v) {
            _this.markSelected();
        });
        datePickerState.selectedEndDateChange.subscribe(function (v) {
            _this.markSelected();
            _this.markActive();
        });
    }
...
var BsDatePickerViewComponent = (function () {
    function BsDatePickerViewComponent(datePickerState, datePickerOptions, cOptions) {
        ...
        datePickerState.showCalendarsChange.subscribe(function (v) { return _this.isShown = v; });
    }
...
var BsCurrentDateComponent = (function (_super) {
    ...
    function BsCurrentDateComponent(datePickerState, options, cOptions) {
        ...
        this.isShown = true;
        this.cOptions = cOptions;
        datePickerState.selectedDateChange.subscribe(function () { return _this.refresh(); });
        datePickerState.activeDateChange.subscribe(function () { return _this.refresh(); });
        options.onUpdate.subscribe(function () { return _this.refresh(); });
    }
...
var BsDatePickerPopupDirective = (function () {
    function BsDatePickerPopupDirective(_elementRef, _renderer, _viewContainerRef, datePickerOptions, _state, cis) {
        ...
        _state.selectedDateChange.subscribe(function (v) {
            _this.bsValue = v && v.toDate && v.toDate() || v;
            if (v) {
                _this.hide();
            }
        });
        this.configChange.subscribe(function (v) {
...
var BsDateTimePickerComponent = (function (_super) {
    ...
    function BsDateTimePickerComponent(datePickerService, options) {
        ...
        this.showAmPm = true;
        this.dateChange.subscribe(function (date) {
...
var BsYearPickerComponent = (function (_super) {
    ...
    function BsYearPickerComponent(datePickerService, options) {
        var _this = this;
        _super.call(this, datePickerService, options);
        datePickerService.selectedDateChange.subscribe(function () {
