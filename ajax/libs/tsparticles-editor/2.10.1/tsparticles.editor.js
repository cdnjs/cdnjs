...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/AbsorberSizeLimit.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/AbsorberSize.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/Options/Classes/Absorber.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/AbsorberInstance.js
...
class AbsorberInstance {
    constructor(absorbers, container, options, position) {
        ...
        this._updateParticlePosition = (particle, v) => {
            ...
            if (particle.needsNewPosition) {
                const newPosition = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.calcPositionOrRandomFromSize)({ size: canvasSize });
    ...
    attract(particle) {
        ...
        const pos = particle.getPosition(), { dx, dy, distance } = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getDistances)(this.position, pos), v = external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.Vector.create(dx, dy);
    ...
    resize() {
        ...
        this.position =
            initialPosition && (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isPointInside)(initialPosition, this.container.canvas.size, external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.Vector.origin)
                ? initialPosition
                : this._calcPosition();
    }
}

;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/Absorbers.js
...
class Absorbers {
    ...
    handleClickMode(mode) {
        ...
        if (mode === "absorber") {
            const absorbersModeOptions = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.itemFromSingleOrMultiple)(modeAbsorbers), absorbersOptions = absorbersModeOptions ?? (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.itemFromSingleOrMultiple)(absorberOptions), aPosition = this.container.interactivity.mouse.clickPosition;
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tsparticles-plugin-absorbers@2.10.1/node_modules/tsparticles-plugin-absorbers/esm/index.js
...
class AbsorbersPlugin {
    ...
    needsPlugin(options) {
        ...
        if (absorbers instanceof Array) {
            ...
            (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("absorber", options.interactivity.events.onClick.mode)) {
            return true;
        }
        return false;
    }
...
class CircleShape {
    randomPosition(position, size, fill) {
        const generateTheta = (x, y) => {
            const u = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRandom)() / 4.0, theta = Math.atan((y / x) * Math.tan(2 * Math.PI * u)), v = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRandom)();
            if (v < 0.25) {
                return theta;
            }
            else if (v < 0.5) {
        ...
        }, radius = (x, y, theta) => (x * y) / Math.sqrt((y * Math.cos(theta)) ** 2 + (x * Math.sin(theta)) ** 2), [a, b] = [size.width / 2, size.height / 2], randomTheta = generateTheta(a, b), maxRadius = radius(a, b, randomTheta), randomRadius = fill ? maxRadius * Math.sqrt((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRandom)()) : maxRadius;
        return {
...
class EmitterInstance {
    constructor(engine, emitters, container, options, position) {
        ...
        this._emitParticles = (quantity) => {
            const position = this.getPosition(), size = this.getSize(), singleParticlesOptions = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.itemFromSingleOrMultiple)(this._particlesOptions);
        ...
        this._setColorAnimation = (animation, initValue, maxValue) => {
            ...
            const colorOffset = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.randomInRange)(animation.offset), delay = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(this.options.rate.delay), emitFactor = (1000 * delay) / container.retina.reduceFactor, colorSpeed = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(animation.speed ?? 0);
...
class SquareShape {
    randomPosition(position, size, fill) {
        if (fill) {
            ...
            const halfW = size.width / 2, halfH = size.height / 2, side = Math.floor((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRandom)() * 4), v = ((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRandom)() - 0.5) * 2;
            switch (side) {
                case 0:
                    return {
    ...
    needsPlugin(options) {
        ...
        return ((emitters instanceof Array && !!emitters.length) ||
            ...
            (!!options.interactivity?.events?.onClick?.mode &&
                (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("emitter", options.interactivity.events.onClick.mode)));
    }
}
...
class RollOptionsEditor extends EditorBase {
  ...
  addProperties() {
    const optionsFunc = this.options,
      options = optionsFunc(),
      color = typeof options.backColor === "string" ? options.backColor : options.backColor instanceof Array ? options.backColor[0] : options.backColor?.value;
...
class ModesOptionsEditor extends EditorBase {
  ...
  addBubble() {
    ...
    const color = typeof options?.color === "string" ? options?.color : options?.color instanceof Array ? undefined : options?.color?.value;
    group.addProperty("color", "Color", external_commonjs_object_gui_commonjs2_object_gui_amd_object_gui_root_window_.EditorType.color, color, false).change(async value => {
      const options = optionsFunc();
      if (!options) {
        return;
  ...
  addLight() {
    ...
    const startColor = typeof options?.area.gradient.start === "string" ? options?.area.gradient.start : options?.area.gradient.start?.value;
    ...
    const stopColor = typeof options?.area.gradient.stop === "string" ? options?.area.gradient.stop : options?.area.gradient.stop?.value;
