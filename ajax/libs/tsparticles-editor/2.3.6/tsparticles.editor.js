...
class AbsorbersPlugin {
  ...
  loadOptions(options, source) {
    ...
    if (source === null || source === void 0 ? void 0 : source.absorbers) {
      optionsCast.absorbers = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.executeOnSingleOrMultiple)(source.absorbers, absorber => {
        const tmp = new Absorber();
        tmp.load(absorber);
        return tmp;
      });
...
class EmittersPlugin {
  ...
  loadOptions(options, source) {
    ...
    if (source === null || source === void 0 ? void 0 : source.emitters) {
      optionsCast.emitters = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.executeOnSingleOrMultiple)(source.emitters, emitter => {
        const tmp = new Emitter();
        tmp.load(emitter);
        return tmp;
      });
