...
return b};c.prototype.getKeywordRegexp=function(a){var b="string"!==typeof a?this.keyword:a;if("string"!==typeof b||""==b)return b;a=b;if(this.options.diacritics)for(var b=b.split(""),l=[],d=0,e=b.length;d<e;d++)for(var f=b[d],c=0,g=this.diacritics.length;c<g;c++){var k=this.diacritics[c];-1==k.indexOf(f)||-1<l.indexOf(k)||(a=a.replace(new RegExp("["+k+"]","gmi"),"["+k+"]"),l.push(k))}return a};c.prototype.highlight=function(a){var b="string"!==typeof a?this.keyword:a;if(0==this.$elements.length||
""==b)return!1;this.$elements=this.$elements.filter("*:not([data-jmHighlight])");a=this.options.separateWordSearch;if("boolean"===typeof a&&a&&(a=b.split(" "),1<a.length)){this.options.debug&&console.log("Highlighting keywords separately");for(var b=0,d=a.length;b<d;b++)if(!this.highlight(a[b]))return!1;return!0}this.options.debug&&(console.log("Highlighting keyword '"+b+"' in elements:"),console.log(this.$elements));a=this.getKeywordRegexp(b);for(var b=new RegExp(a,"gmi"),d=this.getTextNodes(this.$elements),
c=0,e=d.length;c<e;c++){var f=d[c];if("object"===typeof f&&"string"===typeof f.nodeValue&&""!=f.nodeValue.trim()&&b.test(f.nodeValue)){this.options.debug&&console.log(a,f.nodeValue);var g="<"+this.options.element+" class='"+this.options.className+"' data-jmHighlight='true'>",m="</"+this.options.element+">";null!=f.parentNode&&(f.parentNode.innerHTML=f.parentNode.innerHTML.replace(new RegExp("((?![^<]*>)"+a+")","gim"),g+"$1"+m))}}return!0};c.prototype.removeHighlight=function(){if(0==this.$elements.length)return!1;
this.options.debug&&("string"===typeof this.keyword&&""!=this.keyword?console.log("Removing highlighting with keyword: '"+this.keyword+"'"):console.log("Removing highlighting"));var a=new RegExp(this.getKeywordRegexp(),"gmi"),b=this.options.element+"[data-jmHighlight]."+this.options.className,c=this,h=this.$elements.filter(b);this.options.debug&&(console.log(b),console.log(h));h.each(function(){var b=d(this);if(a.test(b.text()))c.appendTextNodes(b,h);else return!0});return!0};c.prototype.appendTextNodes=
function(a,b){if(0==a instanceof d||0==a.length)return!1;var c=a.first()[0],h=c.previousSibling,c=c.nextSibling,e=d(h),f=d(c),g=!1;0<e.length&&(3==h.nodeType?(h.nodeValue+=a.text(),a.remove()):b instanceof d&&0<b.length&&b.is(e)?(e.replaceWith(a.text()+e.text()),a.remove()):a.replaceWith(a.text()),g=!0);0<f.length&&(3==c.nodeType?0==e.length?(c.nodeValue=a.text()+c.nodeValue,a.remove()):(c.nodeValue=e.text()+c.nodeValue,e.remove()):b instanceof d&&0<b.length&&b.is(f)?0==e.length?(f.replaceWith(f.text()+
a.text()),a.remove()):(f.replaceWith(e.text()+f.text()),e.remove()):0==e.length&&a.replaceWith(a.text()),g=!0);0==g&&a.replaceWith(a.text());return!0};d.fn.jmHighlight=function(a,b){return(new c(d(this),a,b)).highlight()};d.fn.jmRemoveHighlight=function(a,b){return(new c(d(this),b,a)).removeHighlight()}});
