...
var mqtt = (() => {
  ...
  function dew$1() {
    ...
    exports$2.read = function(buffer, offset, isLE, mLen, nBytes) {
      ...
      var d5 = isLE ? -1 : 1;
      var s6 = buffer[offset + i7];
      i7 += d5;
      e8 = s6 & (1 << -nBits) - 1;
      s6 >>= -nBits;
      nBits += eLen;
      for (; nBits > 0; e8 = e8 * 256 + buffer[offset + i7], i7 += d5, nBits -= 8) {
      }
      m5 = e8 & (1 << -nBits) - 1;
      e8 >>= -nBits;
      nBits += mLen;
      for (; nBits > 0; m5 = m5 * 256 + buffer[offset + i7], i7 += d5, nBits -= 8) {
      }
      if (e8 === 0) {
        e8 = 1 - eBias;
      } else if (e8 === eMax) {
    ...
    exports$2.write = function(buffer, value, offset, isLE, mLen, nBytes) {
      ...
      for (; mLen >= 8; buffer[offset + i7] = m5 & 255, i7 += d5, m5 /= 256, mLen -= 8) {
      }
      e8 = e8 << mLen | m5;
      eLen += mLen;
      for (; eLen > 0; buffer[offset + i7] = e8 & 255, i7 += d5, e8 /= 256, eLen -= 8) {
      }
      buffer[offset + i7 - d5] |= s6 * 128;
    };
    return exports$2;
  }
  function dew() {
    ...
    Buffer3.compare = function compare(a7, b4) {
      ...
      if (!Buffer3.isBuffer(a7) || !Buffer3.isBuffer(b4)) {
  ...
  var require_util = __commonJS({
    "node_modules/readable-stream/lib/ours/util.js"(exports5, module) {
      ...
      var isBlob = typeof Blob !== "undefined" ? function isBlob2(b4) {
        return b4 instanceof Blob;
      } : function isBlob2(b4) {
        return false;
      };
      var AggregateError = class extends Error {
        constructor(errors) {
          ...
          let message = "";
          for (let i7 = 0; i7 < errors.length; i7++) {
            message += `    ${errors[i7].stack}
`;
          }
          super(message);
  ...
  var require_errors = __commonJS({
    "node_modules/readable-stream/lib/ours/errors.js"(exports5, module) {
      ...
      init_buffer2();
      init_process2();
      var { format: format4, inspect: inspect3, AggregateError: CustomAggregateError } = require_util();
      ...
      E3(
        ...
        (...args) => {
          ...
          args = (Array.isArray(args) ? args : [args]).map((a7) => `"${a7}"`).join(" or ");
          switch (len) {
            case 1:
    ...
    "node_modules/readable-stream/lib/internal/validators.js"(exports5, module) {
      ...
      function validateStringArray(value, name2) {
        ...
        for (let i7 = 0; i7 < value.length; i7++) {
          validateString(value[i7], `${name2}[${i7}]`);
        }
      }
      function validateBooleanArray(value, name2) {
        validateArray(value, name2);
        for (let i7 = 0; i7 < value.length; i7++) {
          validateBoolean(value[i7], `${name2}[${i7}]`);
        }
      }
      ...
      function validateLinkHeaderValue(hints) {
        if (typeof hints === "string") {
          ...
          for (let i7 = 0; i7 < hintsLength; i7++) {
            const link = hints[i7];
  ...
  var require_destroy = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/destroy.js"(exports5, module) {
      ...
      function destroy(err, cb) {
        const r8 = this._readableState;
        const w3 = this._writableState;
        const s6 = w3 || r8;
        if (w3 !== null && w3 !== void 0 && w3.destroyed || r8 !== null && r8 !== void 0 && r8.destroyed) {
          if (typeof cb === "function") {
            cb();
          }
          return this;
        }
        checkError(err, w3, r8);
        if (w3) {
          w3.destroyed = true;
        }
        if (r8) {
      ...
      function _destroy(self2, err, cb) {
        ...
        function onDestroy(err2) {
          ...
          called = true;
          const r8 = self2._readableState;
          const w3 = self2._writableState;
          checkError(err2, w3, r8);
          if (w3) {
            w3.closed = true;
          }
          if (r8) {
      ...
      function emitCloseNT(self2) {
        ...
        if (w3 !== null && w3 !== void 0 && w3.emitClose || r8 !== null && r8 !== void 0 && r8.emitClose) {
          self2.emit("close");
        }
      }
      function emitErrorNT(self2, err) {
        const r8 = self2._readableState;
        const w3 = self2._writableState;
        if (w3 !== null && w3 !== void 0 && w3.errorEmitted || r8 !== null && r8 !== void 0 && r8.errorEmitted) {
          return;
        }
        if (w3) {
      ...
      function undestroy() {
        ...
        if (r8) {
          r8.constructed = true;
          r8.closed = false;
          r8.closeEmitted = false;
          r8.destroyed = false;
          r8.errored = null;
          r8.errorEmitted = false;
          r8.reading = false;
          r8.ended = r8.readable === false;
          r8.endEmitted = r8.readable === false;
        }
        if (w3) {
          w3.constructed = true;
          w3.destroyed = false;
      ...
      function errorOrDestroy(stream, err, sync) {
        const r8 = stream._readableState;
        const w3 = stream._writableState;
        if (w3 !== null && w3 !== void 0 && w3.destroyed || r8 !== null && r8 !== void 0 && r8.destroyed) {
          return this;
        }
        if (r8 !== null && r8 !== void 0 && r8.autoDestroy || w3 !== null && w3 !== void 0 && w3.autoDestroy)
          stream.destroy(err);
        else if (err) {
          err.stack;
          if (w3 && !w3.errored) {
  ...
  var init_chunk_4bd36a8f = __esm({
    "node_modules/@jspm/core/nodelibs/browser/chunk-4bd36a8f.js"() {
      ...
      r = n && "function" == typeof n.apply ? n.apply : function(e8, t7, n8) {
    ...
    "node_modules/readable-stream/lib/internal/streams/buffer_list.js"(exports5, module) {
      ...
      module.exports = class BufferList {
        ...
        concat(n8) {
          if (this.length === 0)
            return Buffer3.alloc(0);
          const ret = Buffer3.allocUnsafe(n8 >>> 0);
          let p7 = this.head;
          let i7 = 0;
          while (p7) {
            TypedArrayPrototypeSet(ret, p7.data, i7);
            i7 += p7.data.length;
            p7 = p7.next;
          }
          return ret;
        ...
        *[SymbolIterator]() {
          ...
          do {
            ...
            if (n8 > str.length) {
              ...
              if (n8 === str.length) {
                ...
                ret += StringPrototypeSlice(str, 0, n8);
                this.head = p7;
                p7.data = StringPrototypeSlice(str, n8);
              }
              break;
            }
            ++c7;
        ...
        _getBuffer(n8) {
          const ret = Buffer3.allocUnsafe(n8);
          const retLen = n8;
          let p7 = this.head;
          let c7 = 0;
          do {
            const buf = p7.data;
            if (n8 > buf.length) {
              TypedArrayPrototypeSet(ret, buf, retLen - n8);
              n8 -= buf.length;
            } else {
              if (n8 === buf.length) {
                TypedArrayPrototypeSet(ret, buf, retLen - n8);
                ...
                TypedArrayPrototypeSet(ret, new Uint8Array2(buf.buffer, buf.byteOffset, n8), retLen - n8);
                this.head = p7;
                p7.data = buf.slice(n8);
              }
              break;
            }
            ++c7;
  ...
  function s$1(t7, r8, e8) {
    if ("string" == typeof t7)
      return function(t8, r9) {
        ...
        var e9 = 0 | y2(t8, r9), n9 = f$2(e9), i8 = n9.write(t8, r9);
    ...
    if (F(t7, ArrayBuffer) || t7 && F(t7.buffer, ArrayBuffer))
      return c$1$1(t7, r8, e8);
    if ("undefined" != typeof SharedArrayBuffer && (F(t7, SharedArrayBuffer) || t7 && F(t7.buffer, SharedArrayBuffer)))
      return c$1$1(t7, r8, e8);
    if ("number" == typeof t7)
      throw new TypeError('The "value" argument must not be of type number. Received type number');
    ...
    var i7 = function(t8) {
      if (u$1$1.isBuffer(t8)) {
        var r9 = 0 | l$1(t8.length), e9 = f$2(r9);
        return 0 === e9.length || t8.copy(e9, 0, 0, r9), e9;
      }
      if (void 0 !== t8.length)
        return "number" != typeof t8.length || N(t8.length) ? f$2(0) : p2(t8);
  ...
  function a$2(t7) {
    return h$1$1(t7), f$2(t7 < 0 ? 0 : 0 | l$1(t7));
  }
  function p2(t7) {
    for (var r8 = t7.length < 0 ? 0 : 0 | l$1(t7.length), e8 = f$2(r8), n8 = 0; n8 < r8; n8 += 1)
      e8[n8] = 255 & t7[n8];
    return e8;
  }
  ...
  function y2(t7, r8) {
    if (u$1$1.isBuffer(t7))
      return t7.length;
    if (ArrayBuffer.isView(t7) || F(t7, ArrayBuffer))
  ...
  function d(t7, r8, e8, n8, i7) {
    if (0 === t7.length)
      return -1;
    if ("string" == typeof e8 ? (n8 = e8, e8 = 0) : e8 > 2147483647 ? e8 = 2147483647 : e8 < -2147483648 && (e8 = -2147483648), N(e8 = +e8) && (e8 = i7 ? 0 : t7.length - 1), e8 < 0 && (e8 = t7.length + e8), e8 >= t7.length) {
      if (i7)
        return -1;
      e8 = t7.length - 1;
    } else if (e8 < 0) {
    ...
    if ("string" == typeof r8 && (r8 = u$1$1.from(r8, n8)), u$1$1.isBuffer(r8))
      return 0 === r8.length ? -1 : v2(t7, r8, e8, n8, i7);
    if ("number" == typeof r8)
      return r8 &= 255, "function" == typeof Uint8Array.prototype.indexOf ? i7 ? Uint8Array.prototype.indexOf.call(t7, r8, e8) : Uint8Array.prototype.lastIndexOf.call(t7, r8, e8) : v2(t7, [r8], e8, n8, i7);
    throw new TypeError("val must be string, number or Buffer");
  }
  function v2(t7, r8, e8, n8, i7) {
  ...
  function m(t7, r8, e8, n8) {
    return D(_(r8, t7.length - e8), t7, e8, n8);
  }
  function E(t7, r8, e8, n8) {
    return D(function(t8) {
  ...
  function B(t7, r8, e8, n8) {
    return E(t7, r8, e8, n8);
  }
  function A(t7, r8, e8, n8) {
    return D(z(r8), t7, e8, n8);
  }
  function U(t7, r8, e8, n8) {
    return D(function(t8, r9) {
  ...
  function P(t7, r8, e8, n8, i7, o8) {
    if (e8 + n8 > t7.length)
      throw new RangeError("Index out of range");
    if (e8 < 0)
      throw new RangeError("Index out of range");
  }
  function k(t7, r8, e8, n8, o8) {
    return r8 = +r8, e8 >>>= 0, o8 || P(t7, 0, e8, 4), i$1.write(t7, r8, e8, n8, 23, 4), e8 + 4;
  }
  function M(t7, r8, e8, n8, o8) {
    return r8 = +r8, e8 >>>= 0, o8 || P(t7, 0, e8, 8), i$1.write(t7, r8, e8, n8, 52, 8), e8 + 8;
  }
  function _(t7, r8) {
    var e8;
    r8 = r8 || 1 / 0;
  ...
  function z(t7) {
    return n$1$1.toByteArray(function(t8) {
      if ((t8 = (t8 = t8.split("=")[0]).trim().replace(j, "")).length < 2)
        return "";
      for (; t8.length % 4 != 0; )
        t8 += "=";
      return t8;
  ...
  function a2(t7) {
    ...
    switch (this.encoding = function(t8) {
      ...
      if ("string" != typeof e9 && (s2.isEncoding === i2 || !i2(t8)))
        throw new Error("Unknown encoding: " + t8);
      return e9 || t8;
    }(t7), this.encoding) {
      case "utf16le":
        this.text = h2, this.end = l2, e8 = 4;
        break;
      case "utf8":
        this.fillLast = n$1, e8 = 4;
        break;
      case "base64":
        this.text = u$1, this.end = o$1, e8 = 3;
        break;
      default:
        return this.write = f$1, this.end = c2, void 0;
    }
    this.lastNeed = 0, this.lastTotal = 0, this.lastChar = s2.allocUnsafe(e8);
  }
  function r2(t7) {
  ...
  var r$12, t$12, e$2, n$2, o$22, a$1, h$1, a$1$1, e$1$1, n$1$1, i$1, o$1$1, j, Y, e2, n2, o2, u2, e$1, s2, i2;
    ...
    "node_modules/@jspm/core/nodelibs/browser/chunk-4ccc3a29.js"() {
      ...
      for (r$12 = { byteLength: function(r8) {
        ...
        for (var e8, n8 = r8.length, o8 = n8 % 3, a7 = [], h7 = 0, u7 = n8 - o8; h7 < u7; h7 += 16383)
          a7.push(c$1(r8, h7, h7 + 16383 > u7 ? u7 : h7 + 16383));
      ...
      a$1$1 = { read: function(a7, t7, o8, r8, h7) {
      ...
      e$1$1.kMaxLength = 2147483647, u$1$1.TYPED_ARRAY_SUPPORT = function() {
        ...
        if (F(t7, Uint8Array) && (t7 = u$1$1.from(t7, t7.offset, t7.byteLength)), F(r8, Uint8Array) && (r8 = u$1$1.from(r8, r8.offset, r8.byteLength)), !u$1$1.isBuffer(t7) || !u$1$1.isBuffer(r8))
          throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');
        if (t7 === r8)
          return 0;
        ...
        for (e8 = 0; e8 < t7.length; ++e8) {
          var o8 = t7[e8];
          if (F(o8, Uint8Array) && (o8 = u$1$1.from(o8)), !u$1$1.isBuffer(o8))
            throw new TypeError('"list" argument must be an Array of Buffers');
        ...
        for (var r8 = 0; r8 < t7; r8 += 4)
          w(this, r8, r8 + 3), w(this, r8 + 1, r8 + 2);
        return this;
        ...
        for (var r8 = 0; r8 < t7; r8 += 8)
          w(this, r8, r8 + 7), w(this, r8 + 1, r8 + 6), w(this, r8 + 2, r8 + 5), w(this, r8 + 3, r8 + 4);
        return this;
      }, u$1$1.prototype.toString = function() {
        var t7 = this.length;
        return 0 === t7 ? "" : 0 === arguments.length ? I(this, 0, t7) : g.apply(this, arguments);
        ...
        if (F(t7, Uint8Array) && (t7 = u$1$1.from(t7, t7.offset, t7.byteLength)), !u$1$1.isBuffer(t7))
        ...
        return d(this, t7, r8, e8, true);
      }, u$1$1.prototype.lastIndexOf = function(t7, r8, e8) {
        return d(this, t7, r8, e8, false);
        ...
        for (var o8 = false; ; )
          switch (n8) {
            case "hex":
              return b(this, t7, r8, e8);
            case "utf8":
            case "utf-8":
              return m(this, t7, r8, e8);
            case "ascii":
              return E(this, t7, r8, e8);
            case "latin1":
            case "binary":
              return B(this, t7, r8, e8);
            case "base64":
              return A(this, t7, r8, e8);
            case "ucs2":
            case "ucs-2":
            case "utf16le":
            case "utf-16le":
              return U(this, t7, r8, e8);
            default:
              if (o8)
      ...
      u$1$1.prototype.slice = function(t7, r8) {
        ...
        t7 >>>= 0, r8 >>>= 0, e8 || x(t7, r8, this.length);
        ...
        return t7 >>>= 0, r8 || x(t7, 1, this.length), this[t7];
      }, u$1$1.prototype.readUInt16LE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 2, this.length), this[t7] | this[t7 + 1] << 8;
      }, u$1$1.prototype.readUInt16BE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 2, this.length), this[t7] << 8 | this[t7 + 1];
      }, u$1$1.prototype.readUInt32LE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 4, this.length), (this[t7] | this[t7 + 1] << 8 | this[t7 + 2] << 16) + 16777216 * this[t7 + 3];
      }, u$1$1.prototype.readUInt32BE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 4, this.length), 16777216 * this[t7] + (this[t7 + 1] << 16 | this[t7 + 2] << 8 | this[t7 + 3]);
        ...
        return t7 >>>= 0, r8 || x(t7, 1, this.length), 128 & this[t7] ? -1 * (255 - this[t7] + 1) : this[t7];
      }, u$1$1.prototype.readInt16LE = function(t7, r8) {
        t7 >>>= 0, r8 || x(t7, 2, this.length);
        ...
        return t7 >>>= 0, r8 || x(t7, 4, this.length), this[t7] | this[t7 + 1] << 8 | this[t7 + 2] << 16 | this[t7 + 3] << 24;
      }, u$1$1.prototype.readInt32BE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 4, this.length), this[t7] << 24 | this[t7 + 1] << 16 | this[t7 + 2] << 8 | this[t7 + 3];
      }, u$1$1.prototype.readFloatLE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 4, this.length), i$1.read(this, t7, true, 23, 4);
      }, u$1$1.prototype.readFloatBE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 4, this.length), i$1.read(this, t7, false, 23, 4);
      }, u$1$1.prototype.readDoubleLE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 8, this.length), i$1.read(this, t7, true, 52, 8);
      }, u$1$1.prototype.readDoubleBE = function(t7, r8) {
        return t7 >>>= 0, r8 || x(t7, 8, this.length), i$1.read(this, t7, false, 52, 8);
      }, u$1$1.prototype.writeUIntLE = function(t7, r8, e8, n8) {
        (t7 = +t7, r8 >>>= 0, e8 >>>= 0, n8) || C(this, t7, r8, e8, Math.pow(2, 8 * e8) - 1, 0);
        var i7 = 1, o8 = 0;
        ...
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 1, 255, 0), this[r8] = 255 & t7, r8 + 1;
      }, u$1$1.prototype.writeUInt16LE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 2, 65535, 0), this[r8] = 255 & t7, this[r8 + 1] = t7 >>> 8, r8 + 2;
      }, u$1$1.prototype.writeUInt16BE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 2, 65535, 0), this[r8] = t7 >>> 8, this[r8 + 1] = 255 & t7, r8 + 2;
      }, u$1$1.prototype.writeUInt32LE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 4, 4294967295, 0), this[r8 + 3] = t7 >>> 24, this[r8 + 2] = t7 >>> 16, this[r8 + 1] = t7 >>> 8, this[r8] = 255 & t7, r8 + 4;
      }, u$1$1.prototype.writeUInt32BE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 4, 4294967295, 0), this[r8] = t7 >>> 24, this[r8 + 1] = t7 >>> 16, this[r8 + 2] = t7 >>> 8, this[r8 + 3] = 255 & t7, r8 + 4;
      }, u$1$1.prototype.writeIntLE = function(t7, r8, e8, n8) {
        if (t7 = +t7, r8 >>>= 0, !n8) {
          var i7 = Math.pow(2, 8 * e8 - 1);
          C(this, t7, r8, e8, i7 - 1, -i7);
        }
        var o8 = 0, f7 = 1, u7 = 0;
        ...
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 1, 127, -128), t7 < 0 && (t7 = 255 + t7 + 1), this[r8] = 255 & t7, r8 + 1;
      }, u$1$1.prototype.writeInt16LE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 2, 32767, -32768), this[r8] = 255 & t7, this[r8 + 1] = t7 >>> 8, r8 + 2;
      }, u$1$1.prototype.writeInt16BE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 2, 32767, -32768), this[r8] = t7 >>> 8, this[r8 + 1] = 255 & t7, r8 + 2;
      }, u$1$1.prototype.writeInt32LE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 4, 2147483647, -2147483648), this[r8] = 255 & t7, this[r8 + 1] = t7 >>> 8, this[r8 + 2] = t7 >>> 16, this[r8 + 3] = t7 >>> 24, r8 + 4;
      }, u$1$1.prototype.writeInt32BE = function(t7, r8, e8) {
        return t7 = +t7, r8 >>>= 0, e8 || C(this, t7, r8, 4, 2147483647, -2147483648), t7 < 0 && (t7 = 4294967295 + t7 + 1), this[r8] = t7 >>> 24, this[r8 + 1] = t7 >>> 16, this[r8 + 2] = t7 >>> 8, this[r8 + 3] = 255 & t7, r8 + 4;
      }, u$1$1.prototype.writeFloatLE = function(t7, r8, e8) {
        return k(this, t7, r8, true, e8);
      }, u$1$1.prototype.writeFloatBE = function(t7, r8, e8) {
        return k(this, t7, r8, false, e8);
      }, u$1$1.prototype.writeDoubleLE = function(t7, r8, e8) {
        return M(this, t7, r8, true, e8);
      }, u$1$1.prototype.writeDoubleBE = function(t7, r8, e8) {
        return M(this, t7, r8, false, e8);
      ...
      n2 = e$1$1;
      o2 = n2.Buffer;
      o2.from && o2.alloc && o2.allocUnsafe && o2.allocUnsafeSlow ? e2 = n2 : (t2(n2, e2), e2.Buffer = f2), f2.prototype = Object.create(o2.prototype), t2(o2, f2), f2.from = function(r8, e8, n8) {
        if ("number" == typeof r8)
          throw new TypeError("Argument must not be a number");
        return o2(r8, e8, n8);
      }, f2.alloc = function(r8, e8, n8) {
        if ("number" != typeof r8)
          throw new TypeError("Argument must be a number");
        var t7 = o2(r8);
        return void 0 !== e8 ? "string" == typeof n8 ? t7.fill(e8, n8) : t7.fill(e8) : t7.fill(0), t7;
      }, f2.allocUnsafe = function(r8) {
        if ("number" != typeof r8)
          throw new TypeError("Argument must be a number");
        return o2(r8);
      }, f2.allocUnsafeSlow = function(r8) {
        if ("number" != typeof r8)
          throw new TypeError("Argument must be a number");
        return n2.SlowBuffer(r8);
      };
      u2 = e2;
      e$1 = {};
      s2 = u2.Buffer;
      i2 = s2.isEncoding || function(t7) {
      ...
      e$1.StringDecoder = a2, a2.prototype.write = function(t7) {
        if (0 === t7.length)
          return "";
        var e8, s6;
        if (this.lastNeed) {
      ...
      }, a2.prototype.end = function(t7) {
        var e8 = t7 && t7.length ? this.write(t7) : "";
        return this.lastNeed ? e8 + "\uFFFD" : e8;
      }, a2.prototype.text = function(t7, e8) {
      ...
      }, a2.prototype.fillLast = function(t7) {
      ...
      function from(Readable, iterable, opts) {
        ...
        readable._destroy = function(error, cb) {
          PromisePrototypeThen(
            ...
            (e8) => process3.nextTick(cb, e8 || error)
          );
        };
  ...
  var require_readable = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/readable.js"(exports5, module) {
      ...
      function computeNewHighWaterMark(n8) {
        if (n8 > MAX_HWM) {
          throw new ERR_OUT_OF_RANGE("size", "<= 1GiB", n8);
        } else {
          n8--;
          n8 |= n8 >>> 1;
          n8 |= n8 >>> 2;
      ...
      Readable.prototype.read = function(n8) {
        ...
        if (n8 === void 0) {
          n8 = NaN;
        } else if (!NumberIsInteger(n8)) {
          n8 = NumberParseInt(n8, 10);
        }
        const state = this._readableState;
        const nOrig = n8;
      ...
      Readable.prototype.unpipe = function(dest) {
        ...
        if (!dest) {
          ...
          state.pipes = [];
          this.pause();
          for (let i7 = 0; i7 < dests.length; i7++)
      ...
      Readable.prototype.wrap = function(stream) {
        ...
        for (let j3 = 1; j3 < streamKeys.length; j3++) {
          const i7 = streamKeys[j3];
          if (this[i7] === void 0 && typeof stream[i7] === "function") {
            this[i7] = stream[i7].bind(stream);
          }
        }
        return this;
      };
      ...
      ObjectDefineProperties(Readable.prototype, {
        readable: {
          ...
          get() {
            const r8 = this._readableState;
            return !!r8 && r8.readable !== false && !r8.destroyed && !r8.errorEmitted && !r8.endEmitted;
          },
          set(val) {
  ...
  var require_writable = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/writable.js"(exports5, module) {
      ...
      function errorBuffer(state) {
        ...
        for (let i7 = 0; i7 < onfinishCallbacks.length; i7++) {
          var _state$errored2;
          onfinishCallbacks[i7](
      ...
      function clearBuffer(stream, state) {
        ...
        let i7 = bufferedIndex;
        state.bufferProcessing = true;
        if (bufferedLength > 1 && stream._writev) {
          state.pendingcb -= bufferedLength - 1;
          const callback = state.allNoop ? nop : (err) => {
            for (let n8 = i7; n8 < buffered.length; ++n8) {
              buffered[n8].callback(err);
            }
          };
          const chunks = state.allNoop && i7 === 0 ? buffered : ArrayPrototypeSlice(buffered, i7);
          chunks.allBuffers = state.allBuffers;
          doWrite(stream, state, true, state.length, chunks, "", callback);
          resetBuffer(state);
        } else {
          do {
            const { chunk, encoding, callback } = buffered[i7];
            buffered[i7++] = null;
            const len = objectMode ? 1 : chunk.length;
            doWrite(stream, state, false, len, chunk, encoding, callback);
          } while (i7 < buffered.length && !state.writing);
          if (i7 === buffered.length) {
            resetBuffer(state);
          } else if (i7 > 256) {
            buffered.splice(0, i7);
            state.bufferedIndex = 0;
          } else {
            state.bufferedIndex = i7;
          }
        }
  ...
  var require_duplexify = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/duplexify.js"(exports5, module) {
      ...
      function _duplexify(pair) {
        const r8 = pair.readable && typeof pair.readable.read !== "function" ? Readable.wrap(pair.readable) : pair.readable;
        const w3 = pair.writable;
        let readable = !!isReadable(r8);
        ...
        d5 = new Duplexify({
          // TODO (ronag): highWaterMark?
          readableObjectMode: !!(r8 !== null && r8 !== void 0 && r8.readableObjectMode),
        ...
        d5._destroy = function(err, callback) {
          if (!err && onclose !== null) {
            err = new AbortError();
          }
          onreadable = null;
  ...
  var require_pipeline = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports5, module) {
      ...
      function pipelineImpl(streams, callback, opts) {
        ...
        let ret;
        for (let i7 = 0; i7 < streams.length; i7++) {
          const stream = streams[i7];
          const reading = i7 < streams.length - 1;
          const writing = i7 > 0;
          const end = reading || (opts === null || opts === void 0 ? void 0 : opts.end) !== false;
          const isLastStream = i7 === streams.length - 1;
          if (isNodeStream(stream)) {
          ...
          if (i7 === 0) {
            ...
            if (reading) {
              if (!isIterable(ret, true)) {
                throw new ERR_INVALID_RETURN_VALUE("AsyncIterable", `transform[${i7 - 1}]`, ret);
              }
            } else {
              var _ret2;
              if (!PassThrough) {
    ...
    "node_modules/readable-stream/lib/internal/streams/compose.js"(exports5, module) {
      ...
      module.exports = function compose(...streams) {
        ...
        for (let n8 = 0; n8 < streams.length; ++n8) {
          if (!isNodeStream(streams[n8]) && !isWebStream(streams[n8])) {
            continue;
          }
          if (n8 < streams.length - 1 && !(isReadable(streams[n8]) || isReadableStream(streams[n8]) || isTransformStream(streams[n8]))) {
            throw new ERR_INVALID_ARG_VALUE(`streams[${n8}]`, orgStreams[n8], "must be readable");
          }
          if (n8 > 0 && !(isWritable(streams[n8]) || isWritableStream(streams[n8]) || isTransformStream(streams[n8]))) {
            throw new ERR_INVALID_ARG_VALUE(`streams[${n8}]`, orgStreams[n8], "must be writable");
          }
        }
        let ondrain;
        let onfinish;
        ...
        if (writable) {
          if (isNodeStream(head)) {
            ...
            d5._write = async function(chunk, encoding, callback) {
              try {
                await writer.ready;
                writer.write(chunk).catch(() => {
                });
            ...
            d5._final = async function(callback) {
              try {
                await writer.ready;
                writer.close().catch(() => {
                });
  ...
  var require_BufferList = __commonJS({
    "node_modules/mqtt-packet/node_modules/bl/BufferList.js"(exports5, module) {
      ...
      BufferList.prototype._offset = function _offset(offset) {
        ...
        let tot = 0;
        for (let i7 = 0; i7 < this._bufs.length; i7++) {
          const _t = tot + this._bufs[i7].length;
          if (offset < _t || i7 === this._bufs.length - 1) {
            return [i7, offset - tot];
          }
          tot = _t;
        }
      };
      BufferList.prototype._reverseOffset = function(blOffset) {
        ...
        for (let i7 = 0; i7 < bufferId; i7++) {
          offset += this._bufs[i7].length;
        }
        return offset;
      };
      ...
      BufferList.prototype.copy = function copy(dst, dstStart, srcStart, srcEnd) {
        ...
        if (srcStart === 0 && srcEnd === this.length) {
          ...
          for (let i7 = 0; i7 < this._bufs.length; i7++) {
            this._bufs[i7].copy(dst, bufoff);
            bufoff += this._bufs[i7].length;
          }
          return dst;
        }
        ...
        for (let i7 = off2[0]; i7 < this._bufs.length; i7++) {
          const l7 = this._bufs[i7].length - start;
          if (bytes > l7) {
      ...
      BufferList.prototype.append = function append(buf) {
        ...
        if (buf.buffer) {
          ...
          for (let i7 = 0; i7 < buf._bufs.length; i7++) {
            this.append(buf._bufs[i7]);
          }
        } else {
  ...
  var require_bl = __commonJS({
    "node_modules/mqtt-packet/node_modules/bl/bl.js"(exports5, module) {
      ...
      BufferListStream.prototype._isBufferList = function _isBufferList(b4) {
        return b4 instanceof BufferListStream || b4 instanceof BufferList || BufferListStream.isBufferList(b4);
      };
  ...
  var require_constants = __commonJS({
    "node_modules/mqtt-packet/constants.js"(exports5, module) {
      ...
      for (const k3 in protocol.requiredHeaderFlags) {
        const v5 = protocol.requiredHeaderFlags[k3];
        protocol.requiredHeaderFlagsErrors[k3] = "Invalid header flag bits, must be 0x" + v5.toString(16) + " for " + protocol.types[k3] + " packet";
      }
      protocol.codes = {};
      for (const k3 in protocol.types) {
        const v5 = protocol.types[k3];
        protocol.codes[v5] = k3;
      }
  ...
  var require_browser4 = __commonJS({
    "node_modules/debug/src/browser.js"(exports5, module) {
      ...
      function load() {
        let r8;
        try {
          r8 = exports5.storage.getItem("debug");
        } catch (error) {
        }
        if (!r8 && typeof process_exports !== "undefined" && "env" in process_exports) {
          r8 = process_exports.env.DEBUG;
        }
        return r8;
      }
  ...
  var require_numbers = __commonJS({
    "node_modules/mqtt-packet/numbers.js"(exports5, module) {
      ...
      function generateBuffer(i7) {
        const buffer = Buffer3.allocUnsafe(2);
        buffer.writeUInt8(i7 >> 8, 0);
        buffer.writeUInt8(i7 & 255, 0 + 1);
        return buffer;
      }
      function generateCache() {
        for (let i7 = 0; i7 < max; i7++) {
          cache[i7] = generateBuffer(i7);
        }
      }
    ...
    "node_modules/mqtt-packet/writeToStream.js"(exports5, module) {
      ...
      function subscribe(packet, stream, opts) {
        ...
        if (typeof subs === "object" && subs.length) {
          for (let i7 = 0; i7 < subs.length; i7 += 1) {
            const itopic = subs[i7].topic;
            const iqos = subs[i7].qos;
      ...
      function suback(packet, stream, opts) {
        ...
        if (typeof granted === "object" && granted.length) {
          for (let i7 = 0; i7 < granted.length; i7 += 1) {
            if (typeof granted[i7] !== "number") {
      ...
      function unsubscribe(packet, stream, opts) {
        ...
        if (typeof unsubs === "object" && unsubs.length) {
          for (let i7 = 0; i7 < unsubs.length; i7 += 1) {
            if (typeof unsubs[i7] !== "string") {
              stream.destroy(new Error("Invalid unsubscriptions"));
              return false;
            }
            length += Buffer3.byteLength(unsubs[i7]) + 2;
          }
        } else {
          stream.destroy(new Error("Invalid unsubscriptions"));
          return false;
        ...
        let result = true;
        for (let j3 = 0; j3 < unsubs.length; j3++) {
          result = writeString(stream, unsubs[j3]);
        }
        return result;
      }
    ...
    "node_modules/mqtt-packet/generate.js"(exports5, module) {
      ...
      var Accumulator = class extends EventEmitter2 {
        ...
        concat() {
          ...
          let pos = 0;
          let i7;
          for (i7 = 0; i7 < list.length && list[i7] !== void 0; i7++) {
            if (typeof list[i7] !== "string")
              lengths[i7] = list[i7].length;
            else
              lengths[i7] = Buffer3.byteLength(list[i7]);
            length += lengths[i7];
          }
          const result = Buffer3.allocUnsafe(length);
          for (i7 = 0; i7 < list.length && list[i7] !== void 0; i7++) {
            if (typeof list[i7] !== "string") {
              list[i7].copy(result, pos);
              pos += lengths[i7];
            } else {
              result.write(list[i7], pos);
              pos += lengths[i7];
            }
          }
          return result;
  ...
  var require_reinterval = __commonJS({
    "node_modules/reinterval/index.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_rfdc = __commonJS({
    "node_modules/rfdc/index.js"(exports5, module) {
      ...
      function rfdc(opts) {
        ...
        function cloneArray(a7, fn) {
          var keys = Object.keys(a7);
        ...
        function clone(o8) {
          if (typeof o8 !== "object" || o8 === null)
            return o8;
          if (o8 instanceof Date)
            return new Date(o8);
          if (Array.isArray(o8))
            return cloneArray(o8, clone);
          if (o8 instanceof Map)
            return new Map(cloneArray(Array.from(o8), clone));
          if (o8 instanceof Set)
            return new Set(cloneArray(Array.from(o8), clone));
          var o22 = {};
          for (var k3 in o8) {
            if (Object.hasOwnProperty.call(o8, k3) === false)
              continue;
            var cur = o8[k3];
            if (typeof cur !== "object" || cur === null) {
              o22[k3] = cur;
              ...
              o22[k3] = new Map(cloneArray(Array.from(cur), clone));
            } else if (cur instanceof Set) {
              o22[k3] = new Set(cloneArray(Array.from(cur), clone));
            } else if (ArrayBuffer.isView(cur)) {
        ...
        function cloneProto(o8) {
          if (typeof o8 !== "object" || o8 === null)
            return o8;
          if (o8 instanceof Date)
            return new Date(o8);
          if (Array.isArray(o8))
            return cloneArray(o8, cloneProto);
          if (o8 instanceof Map)
            return new Map(cloneArray(Array.from(o8), cloneProto));
          if (o8 instanceof Set)
            return new Set(cloneArray(Array.from(o8), cloneProto));
          var o22 = {};
          for (var k3 in o8) {
            var cur = o8[k3];
            if (typeof cur !== "object" || cur === null) {
              ...
              o22[k3] = new Map(cloneArray(Array.from(cur), cloneProto));
            } else if (cur instanceof Set) {
              o22[k3] = new Set(cloneArray(Array.from(cur), cloneProto));
            } else if (ArrayBuffer.isView(cur)) {
              o22[k3] = copyBuffer(cur);
            } else {
    ...
    "build/lib/validations.js"(exports5) {
      ...
      function validateTopic(topic) {
        ...
        for (let i7 = 0; i7 < parts.length; i7++) {
          ...
          if (parts[i7] === "#") {
            return i7 === parts.length - 1;
          }
          if (parts[i7].indexOf("+") !== -1 || parts[i7].indexOf("#") !== -1) {
            return false;
          }
        }
        return true;
      ...
      function validateTopics(topics) {
        ...
        for (let i7 = 0; i7 < topics.length; i7++) {
          if (!validateTopic(topics[i7])) {
            return topics[i7];
          }
        }
        return null;
    ...
    "build/lib/store.js"(exports5) {
      ...
      var Store = class {
        ...
        createStream() {
          ...
          stream._read = () => {
            if (!destroyed && i7 < values.length) {
              stream.push(values[i7++]);
            } else {
              stream.push(null);
            }
          };
  ...
  var require_shared = __commonJS({
    "build/lib/shared.js"(exports5) {
      ...
      init_process2();
      Object.defineProperty(exports5, "__esModule", { value: true });
      exports5.applyMixin = exports5.ErrorWithReasonCode = void 0;
      ...
      var LRUCache = class _LRUCache {
        ...
        static unsafeExposeInternals(c7) {
          return {
            ...
            free: c7.#free,
            // methods
            isBackgroundFetch: (p7) => c7.#isBackgroundFetch(p7),
            backgroundFetch: (k3, index, options, context) => c7.#backgroundFetch(k3, index, options, context),
            moveToTail: (index) => c7.#moveToTail(index),
            indexes: (options) => c7.#indexes(options),
            rindexes: (options) => c7.#rindexes(options),
            isStale: (index) => c7.#isStale(index)
          };
        }
        ...
        #initializeSizeTracking() {
          ...
          this.#requireSize = (k3, v5, size, sizeCalculation) => {
        ...
        *#indexes({ allowStale = this.allowStale } = {}) {
          if (this.#size) {
            for (let i7 = this.#tail; true; ) {
              if (!this.#isValidIndex(i7)) {
                break;
              }
              if (allowStale || !this.#isStale(i7)) {
                yield i7;
              }
              if (i7 === this.#head) {
                break;
        ...
        *#rindexes({ allowStale = this.allowStale } = {}) {
         ...
         */
        *entries() {
          for (const i7 of this.#indexes()) {
            if (this.#valList[i7] !== void 0 && this.#keyList[i7] !== void 0 && !this.#isBackgroundFetch(this.#valList[i7])) {
              yield [this.#keyList[i7], this.#valList[i7]];
            }
          }
        }
        /**
        ...
        *keys() {
          for (const i7 of this.#indexes()) {
            const k3 = this.#keyList[i7];
            if (k3 !== void 0 && !this.#isBackgroundFetch(this.#valList[i7])) {
              yield k3;
            }
          }
        }
        ...
        *values() {
          for (const i7 of this.#indexes()) {
            const v5 = this.#valList[i7];
            if (v5 !== void 0 && !this.#isBackgroundFetch(this.#valList[i7])) {
              yield this.#valList[i7];
            }
          }
        }
        /**
        ...
        *rvalues() {
        ...
        find(fn, getOptions = {}) {
          for (const i7 of this.#indexes()) {
            const v5 = this.#valList[i7];
            const value = this.#isBackgroundFetch(v5) ? v5.__staleWhileFetching : v5;
            if (value === void 0)
              continue;
            if (fn(value, this.#keyList[i7], this)) {
              return this.get(this.#keyList[i7], getOptions);
            }
          }
        }
        /**
        ...
        forEach(fn, thisp = this) {
          for (const i7 of this.#indexes()) {
            ...
            if (value === void 0)
              continue;
            fn.call(thisp, value, this.#keyList[i7], this);
          }
        }
        /**
        ...
        purgeStale() {
          let deleted = false;
          for (const i7 of this.#rindexes({ allowStale: true })) {
            if (this.#isStale(i7)) {
              this.delete(this.#keyList[i7]);
              deleted = true;
            }
          }
          return deleted;
        ...
        dump() {
          const arr = [];
          for (const i7 of this.#indexes({ allowStale: true })) {
            const key = this.#keyList[i7];
            const v5 = this.#valList[i7];
            const value = this.#isBackgroundFetch(v5) ? v5.__staleWhileFetching : v5;
            ...
            if (this.#ttls && this.#starts) {
              entry.ttl = this.#ttls[i7];
              const age = perf.now() - this.#starts[i7];
              entry.start = Math.floor(Date.now() - age);
            }
            if (this.#sizes) {
              entry.size = this.#sizes[i7];
            }
        ...
        set(k3, v5, setOptions = {}) {
          ...
          const size = this.#requireSize(k3, v5, setOptions.size || 0, sizeCalculation);
          ...
          if (index === void 0) {
            ...
            if (v5 !== oldVal) {
              if (this.#hasFetchMethod && this.#isBackgroundFetch(oldVal)) {
                ...
                const { __staleWhileFetching: s6 } = oldVal;
                if (s6 !== void 0 && !noDisposeOnSet) {
                  if (this.#hasDispose) {
                    this.#dispose?.(s6, k3, "set");
                  }
                  if (this.#hasDisposeAfter) {
                    this.#disposed?.push([s6, k3, "set"]);
                  }
                }
        ...
        #evict(free) {
          ...
          if (this.#hasFetchMethod && this.#isBackgroundFetch(v5)) {
            v5.__abortController.abort(new Error("evicted"));
          } else if (this.#hasDispose || this.#hasDisposeAfter) {
            if (this.#hasDispose) {
              this.#dispose?.(v5, k3, "evict");
            }
            if (this.#hasDisposeAfter) {
              this.#disposed?.push([v5, k3, "evict"]);
            }
          }
        ...
        has(k3, hasOptions = {}) {
          ...
          if (index !== void 0) {
            const v5 = this.#valList[index];
            if (this.#isBackgroundFetch(v5) && v5.__staleWhileFetching === void 0) {
              return false;
            }
            if (!this.#isStale(index)) {
              if (updateAgeOnHas) {
        ...
        #backgroundFetch(k3, index, options, context) {
          const v5 = index === void 0 ? void 0 : this.#valList[index];
          if (this.#isBackgroundFetch(v5)) {
            return v5;
          }
          const ac = new AC();
          ...
          const cb = (v6, updateCache = false) => {
            ...
            if (this.#valList[index] === p7) {
              if (v6 === void 0) {
                ...
                this.set(k3, v6, fetchOpts.options);
              }
            }
            return v6;
          };
          ...
          const pcall = (res, rej) => {
            const fmp = this.#fetchMethod?.(k3, v5, fetchOpts);
            if (fmp && fmp instanceof Promise) {
              fmp.then((v6) => res(v6 === void 0 ? void 0 : v6), rej);
            }
        ...
        async fetch(k3, fetchOptions = {}) {
          ...
          if (index === void 0) {
            if (status)
              status.fetch = "miss";
            const p7 = this.#backgroundFetch(k3, index, options, context);
            ...
            if (index !== void 0) {
              ...
              if (this.#size === 1) {
                ...
                if (this.#isBackgroundFetch(v5)) {
                  ...
                  if (this.#hasDispose) {
                    this.#dispose?.(v5, k3, "delete");
                  }
                  if (this.#hasDisposeAfter) {
                    this.#disposed?.push([v5, k3, "delete"]);
                  }
                }
                this.#keyMap.delete(k3);
  ...
  var require_Queue = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/OtherContainer/Queue.js"(exports5) {
      ...
      var Queue = class extends _ContainerBase.Base {
        ...
        push(t7) {
          const s6 = this.q.length;
          if (this.j / s6 > 0.5 && this.j + this.i >= s6 && s6 > 4096) {
            const s7 = this.i;
            for (let t8 = 0; t8 < s7; ++t8) {
              this.q[t8] = this.q[this.j + t8];
            }
            this.j = 0;
            this.q[this.i] = t7;
          } else
            this.q[this.j + this.i] = t7;
          return ++this.i;
        }
        pop() {
          if (this.i === 0)
            return;
          const t7 = this.q[this.j++];
          this.i -= 1;
          return t7;
        }
        front() {
  ...
  var require_PriorityQueue = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/OtherContainer/PriorityQueue.js"(exports5) {
      ...
      var PriorityQueue = class extends _ContainerBase.Base {
        constructor(t7 = [], s6 = function(t8, s7) {
          if (t8 > s7)
            return -1;
          if (t8 < s7)
            return 1;
        ...
        k(t7, s6) {
          ...
          while (t7 < s6) {
            ...
            const e8 = s7 + 1;
            let h7 = this.C[s7];
            if (e8 < this.i && this.v(h7, this.C[e8]) > 0) {
              s7 = e8;
              h7 = this.C[e8];
            }
            if (this.v(h7, i7) >= 0)
        ...
        find(t7) {
          return this.C.indexOf(t7) >= 0;
        }
        remove(t7) {
          const s6 = this.C.indexOf(t7);
          if (s6 < 0)
            return false;
          if (s6 === 0) {
            this.pop();
  ...
  var require_RandomIterator = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/SequentialContainer/Base/RandomIterator.js"(exports5) {
      ...
      var RandomIterator = class extends _ContainerBase.ContainerIterator {
        ...
        set pointer(t7) {
          this.container.setElementByPos(this.o, t7);
        }
      };
  ...
  var require_Vector = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/SequentialContainer/Vector.js"(exports5) {
      ...
      var Vector = class extends _Base.default {
        ...
        eraseElementByValue(t7) {
          let r8 = 0;
          for (let e8 = 0; e8 < this.i; ++e8) {
            if (this.J[e8] !== t7) {
              this.J[r8++] = this.J[e8];
            }
          }
          this.i = this.J.length = r8;
          return this.i;
        }
        eraseElementByIterator(t7) {
          const r8 = t7.o;
          t7 = t7.next();
          this.eraseElementByPos(r8);
          return t7;
        }
        pushBack(t7) {
          this.J.push(t7);
        ...
        insert(t7, r8, e8 = 1) {
          ...
          this.J.splice(t7, 0, ...new Array(e8).fill(r8));
          this.i += e8;
          return this.i;
        }
        find(t7) {
          for (let r8 = 0; r8 < this.i; ++r8) {
            if (this.J[r8] === t7) {
              return new VectorIterator(r8, this);
            }
          }
          return this.end();
        }
        ...
        unique() {
          let t7 = 1;
          for (let r8 = 1; r8 < this.i; ++r8) {
            if (this.J[r8] !== this.J[r8 - 1]) {
              this.J[t7++] = this.J[r8];
            }
          }
          this.i = this.J.length = t7;
          return this.i;
        }
        sort(t7) {
          this.J.sort(t7);
    ...
    "node_modules/js-sdsl/dist/cjs/container/SequentialContainer/LinkList.js"(exports5) {
      ...
      var LinkList = class extends _Base.default {
        ...
        find(t7) {
          ...
          while (i7 !== this.h) {
            if (i7.l === t7) {
              return new LinkListIterator(i7, this.h, this);
            }
            i7 = i7.B;
          }
          return this.end();
        ...
        sort(t7) {
          if (this.i <= 1)
            return;
          const i7 = [];
          this.forEach(function(t8) {
            i7.push(t8);
          });
          i7.sort(t7);
          let s6 = this.p;
          i7.forEach(function(t8) {
            s6.l = t8;
            s6 = s6.B;
          });
        }
    ...
    "node_modules/js-sdsl/dist/cjs/container/SequentialContainer/Deque.js"(exports5) {
      ...
      var Deque = class extends _Base.default {
        constructor(t7 = [], i7 = 1 << 12) {
          ...
          this.A = [];
          const s6 = (() => {
            if (typeof t7.length === "number")
              return t7.length;
            if (typeof t7.size === "number")
              return t7.size;
            if (typeof t7.size === "function")
              return t7.size();
            throw new TypeError("Cannot get the length or size of the container");
          })();
          this.F = i7;
          this.P = Math.max(Math.ceil(s6 / this.F), 1);
          for (let t8 = 0; t8 < this.P; ++t8) {
            this.A.push(new Array(this.F));
          }
          const h7 = Math.ceil(s6 / this.F);
          this.j = this.R = (this.P >> 1) - (h7 >> 1);
          this.D = this.N = this.F - s6 % this.F >> 1;
          const e8 = this;
          t7.forEach(function(t8) {
            e8.pushBack(t8);
          });
        ...
        T() {
          const t7 = [];
          const i7 = Math.max(this.P >> 1, 1);
          for (let s6 = 0; s6 < i7; ++s6) {
            t7[s6] = new Array(this.F);
          }
          for (let i8 = this.j; i8 < this.P; ++i8) {
            t7[t7.length] = this.A[i8];
          }
          for (let i8 = 0; i8 < this.R; ++i8) {
            t7[t7.length] = this.A[i8];
          }
          t7[t7.length] = [...this.A[this.R]];
          this.j = i7;
          this.R = t7.length - 1;
          for (let s6 = 0; s6 < i7; ++s6) {
            t7[t7.length] = new Array(this.F);
          }
          this.A = t7;
          this.P = t7.length;
        }
        O(t7) {
          const i7 = this.D + t7 + 1;
          const s6 = i7 % this.F;
          let h7 = s6 - 1;
          let e8 = this.j + (i7 - s6) / this.F;
          if (s6 === 0)
            e8 -= 1;
          e8 %= this.P;
          if (h7 < 0)
            h7 += this.F;
          return {
            curNodeBucketIndex: e8,
            curNodePointerIndex: h7
          };
        }
        clear() {
        ...
        pushBack(t7) {
          ...
          this.i += 1;
          this.A[this.R][this.N] = t7;
          return this.i;
        }
        popBack() {
          if (this.i === 0)
            return;
          const t7 = this.A[this.R][this.N];
          if (this.i !== 1) {
            if (this.N > 0) {
              this.N -= 1;
            } else if (this.R > 0) {
        ...
        pushFront(t7) {
          ...
          this.i += 1;
          this.A[this.j][this.D] = t7;
          return this.i;
        }
        popFront() {
          if (this.i === 0)
            return;
          const t7 = this.A[this.j][this.D];
          if (this.i !== 1) {
            if (this.D < this.F - 1) {
              this.D += 1;
        ...
        getElementByPos(t7) {
          ...
          const { curNodeBucketIndex: i7, curNodePointerIndex: s6 } = this.O(t7);
          return this.A[i7][s6];
        }
        setElementByPos(t7, i7) {
          if (t7 < 0 || t7 > this.i - 1) {
          ...
          const { curNodeBucketIndex: s6, curNodePointerIndex: h7 } = this.O(t7);
          this.A[s6][h7] = i7;
        }
        insert(t7, i7, s6 = 1) {
          if (t7 < 0 || t7 > this.i) {
          ...
          if (t7 === 0) {
            ...
            const h7 = [];
            for (let i8 = t7; i8 < this.i; ++i8) {
              h7.push(this.getElementByPos(i8));
            }
            this.cut(t7 - 1);
            for (let t8 = 0; t8 < s6; ++t8)
              this.pushBack(i7);
        ...
        eraseElementByPos(t7) {
          ...
          if (t7 === 0)
            ...
            const i7 = [];
            for (let s7 = t7 + 1; s7 < this.i; ++s7) {
              i7.push(this.getElementByPos(s7));
            }
            this.cut(t7);
            this.popBack();
            const s6 = this;
        ...
        eraseElementByValue(t7) {
          if (this.i === 0)
            return 0;
          const i7 = [];
          for (let s7 = 0; s7 < this.i; ++s7) {
            const h7 = this.getElementByPos(s7);
            if (h7 !== t7)
              i7.push(h7);
          }
          const s6 = i7.length;
          for (let t8 = 0; t8 < s6; ++t8)
            this.setElementByPos(t8, i7[t8]);
          return this.cut(s6 - 1);
        }
        eraseElementByIterator(t7) {
          const i7 = t7.o;
          this.eraseElementByPos(i7);
          t7 = t7.next();
          return t7;
        }
        find(t7) {
          for (let i7 = 0; i7 < this.i; ++i7) {
            if (this.getElementByPos(i7) === t7) {
              return new DequeIterator(i7, this);
            }
          }
          return this.end();
        }
        reverse() {
          ...
          let i7 = this.i - 1;
          while (t7 < i7) {
            const s6 = this.getElementByPos(t7);
            this.setElementByPos(t7, this.getElementByPos(i7));
            this.setElementByPos(i7, s6);
            t7 += 1;
            i7 -= 1;
          }
        }
        unique() {
          ...
          let t7 = 1;
          let i7 = this.getElementByPos(0);
          for (let s6 = 1; s6 < this.i; ++s6) {
            const h7 = this.getElementByPos(s6);
            if (h7 !== i7) {
              i7 = h7;
              this.setElementByPos(t7++, h7);
            }
          }
          while (this.i > t7)
            this.popBack();
        ...
        sort(t7) {
          const i7 = [];
          for (let t8 = 0; t8 < this.i; ++t8) {
            i7.push(this.getElementByPos(t8));
          }
          i7.sort(t7);
          for (let t8 = 0; t8 < this.i; ++t8)
            this.setElementByPos(t8, i7[t8]);
        ...
        forEach(t7) {
          for (let i7 = 0; i7 < this.i; ++i7) {
            t7(this.getElementByPos(i7), i7, this);
          }
        }
        [Symbol.iterator]() {
          return function* () {
            for (let t7 = 0; t7 < this.i; ++t7) {
              yield this.getElementByPos(t7);
            }
          }.bind(this)();
        }
      };
      ...
      var TreeContainer = class extends _ContainerBase.Container {
        constructor(e8 = function(e9, t8) {
          ...
          if (t7) {
            ...
            this.M = function(e9, t8, i7) {
              const s6 = this.ne(e9, t8, i7);
              if (s6) {
                let e10 = s6.tt;
                while (e10 !== this.h) {
                  e10.rt += 1;
                ...
                const t9 = this.he(s6);
                if (t9) {
                  const { parentNode: e11, grandParent: i8, curNode: s7 } = t9;
                  e11.ie();
                  i8.ie();
                  s7.ie();
                }
        ...
        oe(e8, t7) {
          if (e8 === void 0)
            return false;
          const i7 = this.oe(e8.U, t7);
          if (i7)
            return true;
          if (t7(e8))
            return true;
          return this.oe(e8.W, t7);
        }
        he(e8) {
          while (true) {
            const t7 = e8.tt;
        ...
        ne(e8, t7, i7) {
          ...
          let s6;
          const r8 = this.h.U;
          const n8 = this.v(r8.u, e8);
          if (n8 === 0) {
            r8.l = t7;
            return;
          } else if (n8 > 0) {
            r8.U = new this.re(e8, t7);
            r8.U.tt = r8;
            s6 = r8.U;
            this.h.U = s6;
          } else {
            const r9 = this.h.W;
            const n9 = this.v(r9.u, e8);
            if (n9 === 0) {
              r9.l = t7;
              return;
            } else if (n9 < 0) {
              r9.W = new this.re(e8, t7);
              r9.W.tt = r9;
              s6 = r9.W;
              this.h.W = s6;
            } else {
              if (i7 !== void 0) {
                const r10 = i7.o;
                if (r10 !== this.h) {
                  const i8 = this.v(r10.u, e8);
                  if (i8 === 0) {
                    r10.l = t7;
                    return;
                  } else if (i8 > 0) {
                    const i9 = r10.L();
                    const n10 = this.v(i9.u, e8);
                    if (n10 === 0) {
                      i9.l = t7;
                      return;
                    } else if (n10 < 0) {
                      s6 = new this.re(e8, t7);
                      if (i9.W === void 0) {
                        i9.W = s6;
                        s6.tt = i9;
                      } else {
              ...
              if (s6 === void 0) {
                s6 = this.Y;
                while (true) {
                  const i8 = this.v(s6.u, e8);
                  if (i8 > 0) {
                    if (s6.U === void 0) {
                      s6.U = new this.re(e8, t7);
                      s6.U.tt = s6;
                      s6 = s6.U;
                      break;
                    }
        ...
        eraseElementByIterator(e8) {
          ...
          const i7 = t7.W === void 0;
          const s6 = e8.iteratorType === 0;
          if (s6) {
            if (i7)
              e8.next();
          } else {
        ...
        getHeight() {
          if (this.i === 0)
            return 0;
          const traversal = function(e8) {
            if (!e8)
              return 0;
            return Math.max(traversal(e8.U), traversal(e8.W)) + 1;
          };
    ...
    "node_modules/js-sdsl/dist/cjs/container/TreeContainer/OrderedSet.js"(exports5) {
      ...
      var OrderedSet = class extends _Base.default {
        ...
        *K(e8) {
        ...
        insert(e8, t7) {
          return this.M(e8, void 0, t7);
        }
        find(e8) {
          const t7 = this.I(this.Y, e8);
          return new OrderedSetIterator(t7, this.h, this);
        }
        lowerBound(e8) {
          const t7 = this.X(this.Y, e8);
          return new OrderedSetIterator(t7, this.h, this);
        }
        upperBound(e8) {
          const t7 = this.Z(this.Y, e8);
          return new OrderedSetIterator(t7, this.h, this);
        }
        reverseLowerBound(e8) {
          const t7 = this.$(this.Y, e8);
          return new OrderedSetIterator(t7, this.h, this);
        }
        reverseUpperBound(e8) {
          const t7 = this.rr(this.Y, e8);
          return new OrderedSetIterator(t7, this.h, this);
        }
        union(e8) {
          const t7 = this;
  ...
  var require_OrderedMap = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/TreeContainer/OrderedMap.js"(exports5) {
      ...
      var OrderedMap = class extends _Base.default {
        constructor(r8 = [], t7, e8) {
          super(t7, e8);
          const s6 = this;
          r8.forEach(function(r9) {
            s6.setElement(r9[0], r9[1]);
          });
        }
        *K(r8) {
          if (r8 === void 0)
        ...
        lowerBound(r8) {
          const t7 = this.X(this.Y, r8);
          return new OrderedMapIterator(t7, this.h, this);
        }
        upperBound(r8) {
          const t7 = this.Z(this.Y, r8);
          return new OrderedMapIterator(t7, this.h, this);
        }
        reverseLowerBound(r8) {
          const t7 = this.$(this.Y, r8);
          return new OrderedMapIterator(t7, this.h, this);
        }
        reverseUpperBound(r8) {
          const t7 = this.rr(this.Y, r8);
          return new OrderedMapIterator(t7, this.h, this);
        }
        setElement(r8, t7, e8) {
          return this.M(r8, t7, e8);
        }
        find(r8) {
          const t7 = this.I(this.Y, r8);
          return new OrderedMapIterator(t7, this.h, this);
        }
        getElementByKey(r8) {
          const t7 = this.I(this.Y, r8);
  ...
  var require_checkObject = __commonJS({
    "node_modules/js-sdsl/dist/cjs/utils/checkObject.js"(exports5) {
      ...
      function checkObject(e8) {
        const t7 = typeof e8;
        return t7 === "object" && e8 !== null || t7 === "function";
      }
    }
  });
  ...
  var require_Base3 = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/HashContainer/Base/index.js"(exports5) {
      ...
      var HashContainer = class extends _ContainerBase.Container {
        ...
        M(t7, e8, i7) {
          if (i7 === void 0)
            i7 = (0, _checkObject.default)(t7);
          let s6;
          if (i7) {
            const i8 = t7[this.HASH_TAG];
            if (i8 !== void 0) {
              this.H[i8].l = e8;
              return this.i;
            }
            Object.defineProperty(t7, this.HASH_TAG, {
              value: this.H.length,
              configurable: true
            });
            s6 = {
        ...
        I(t7, e8) {
          if (e8 === void 0)
            e8 = (0, _checkObject.default)(t7);
          if (e8) {
            const e9 = t7[this.HASH_TAG];
            if (e9 === void 0)
              return this.h;
            return this.H[e9];
          } else {
            return this.g[t7] || this.h;
          }
        }
        clear() {
          const t7 = this.HASH_TAG;
          this.H.forEach(function(e8) {
            delete e8.u[t7];
          });
          this.H = [];
          this.g = {};
  ...
  var require_HashSet = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/HashContainer/HashSet.js"(exports5) {
      ...
      var HashSet = class extends _Base.HashContainer {
        ...
        find(t7, e8) {
          const r8 = this.I(t7, e8);
          return new HashSetIterator(r8, this.h, this);
        }
        forEach(t7) {
          let e8 = 0;
          let r8 = this.p;
  ...
  var require_HashMap = __commonJS({
    "node_modules/js-sdsl/dist/cjs/container/HashContainer/HashMap.js"(exports5) {
      ...
      var HashMap = class extends _Base.HashContainer {
        ...
        setElement(t7, e8, r8) {
          return this.M(t7, e8, r8);
        }
        getElementByKey(t7, e8) {
          if (e8 === void 0)
            e8 = (0, _checkObject.default)(t7);
          if (e8) {
            const e9 = t7[this.HASH_TAG];
            return e9 !== void 0 ? this.H[e9].l : void 0;
          }
          const r8 = this.g[t7];
          return r8 ? r8.l : void 0;
        }
        getElementByPos(t7) {
          if (t7 < 0 || t7 > this.i - 1) {
            throw new RangeError();
        ...
        find(t7, e8) {
          const r8 = this.I(t7, e8);
          return new HashMapIterator(r8, this.h, this);
        }
        forEach(t7) {
          let e8 = 0;
          let r8 = this.p;
          while (r8 !== this.h) {
            t7([r8.u, r8.l], e8++, this);
            r8 = r8.B;
          }
        }
        [Symbol.iterator]() {
  ...
  var require_client = __commonJS({
    "build/lib/client.js"(exports5) {
      ...
      init_buffer2();
      init_process2();
      var __createBinding = exports5 && exports5.__createBinding || (Object.create ? function(o8, m5, k3, k22) {
        if (k22 === void 0)
          k22 = k3;
      ...
      } : function(o8, m5, k3, k22) {
        if (k22 === void 0)
          k22 = k3;
        o8[k22] = m5[k3];
      });
      var __setModuleDefault = exports5 && exports5.__setModuleDefault || (Object.create ? function(o8, v5) {
        Object.defineProperty(o8, "default", { enumerable: true, value: v5 });
      } : function(o8, v5) {
        o8["default"] = v5;
      });
      ...
      var readable_stream_1 = require_browser3();
      var reinterval_1 = __importDefault(require_reinterval());
      ...
      var nextTick2 = process_exports ? process_exports.nextTick : (callback) => {
        setTimeout(callback, 0);
      };
      var setImmediate = window.setImmediate || ((...args) => {
      ...
      var MqttClient = class _MqttClient extends TypedEmitter_1.TypedEventEmitter {
        ...
        constructor(streamBuilder, options) {
          super();
          this.options = options || {};
          for (const k3 in defaultConnectOptions) {
            if (typeof this.options[k3] === "undefined") {
              this.options[k3] = defaultConnectOptions[k3];
            } else {
              this.options[k3] = options[k3];
            }
          }
        ...
        _invokeStoreProcessingQueue() {
          if (!this._storeProcessing && this._storeProcessingQueue.length > 0) {
            const f7 = this._storeProcessingQueue[0];
            if (f7 && f7.invoke()) {
        ...
        _flushStoreProcessingQueue() {
          for (const f7 of this._storeProcessingQueue) {
            if (f7.cbStorePut)
              f7.cbStorePut(new Error("Connection closed"));
            if (f7.callback)
              f7.callback(new Error("Connection closed"));
          }
  ...
  function f3(t7, o8) {
    ...
    const c7 = function(t8, o9) {
      ...
      for (; e8--; )
        n9[e8] = o9(t8[e8]);
      return n9;
    }((t7 = t7.replace(e3, ".")).split("."), o8).join(".");
    return r8 + c7;
  }
  function l3(t7) {
    const o8 = [];
  ...
  var init_chunk_924bb2e1 = __esm({
    "node_modules/@jspm/core/nodelibs/browser/chunk-924bb2e1.js"() {
      ...
      a3 = function(t7, o8, n8) {
        let e8 = 0;
        for (t7 = n8 ? c3(t7 / 700) : t7 >> 1, t7 += c3(t7 / o8); t7 > 455; e8 += 36)
          t7 = c3(t7 / 35);
        return c3(e8 + 36 * t7 / (t7 + 38));
      };
      d2 = function(o8) {
        ...
        for (let t7 = 0; t7 < l7; ++t7)
          o8.charCodeAt(t7) >= 128 && i3("not-basic"), n8.push(o8.charCodeAt(t7));
        for (let d5 = l7 > 0 ? l7 + 1 : 0; d5 < e8; ) {
          let l8 = r8;
          for (let n9 = 1, s7 = 36; ; s7 += 36) {
            d5 >= e8 && i3("invalid-input");
            const l9 = (u7 = o8.charCodeAt(d5++)) - 48 < 10 ? u7 - 22 : u7 - 65 < 26 ? u7 - 65 : u7 - 97 < 26 ? u7 - 97 : 36;
            (l9 >= 36 || l9 > c3((t3 - r8) / n9)) && i3("overflow"), r8 += l9 * n9;
            const a7 = s7 <= f7 ? 1 : s7 >= f7 + 26 ? 26 : s7 - f7;
            if (l9 < a7)
              break;
            const h8 = 36 - a7;
            n9 > c3(t3 / h8) && i3("overflow"), n9 *= h8;
          }
          const h7 = n8.length + 1;
          f7 = a3(r8 - l8, h7, 0 == l8), c3(r8 / h7) > t3 - s6 && i3("overflow"), s6 += c3(r8 / h7), r8 %= h7, n8.splice(r8++, 0, s6);
        }
        var u7;
      ...
      h3 = function(o8) {
        const n8 = [];
        let e8 = (o8 = l3(o8)).length, r8 = 128, f7 = 0, d5 = 72;
        for (const t7 of o8)
          t7 < 128 && n8.push(s3(t7));
        ...
        for (h7 && n8.push("-"); p7 < e8; ) {
          ...
          for (const t7 of o8)
            t7 >= r8 && t7 < e9 && (e9 = t7);
          const l7 = p7 + 1;
          e9 - r8 > c3((t3 - f7) / l7) && i3("overflow"), f7 += (e9 - r8) * l7, r8 = e9;
          for (const e10 of o8)
            if (e10 < r8 && ++f7 > t3 && i3("overflow"), e10 == r8) {
              let t7 = f7;
              for (let o9 = 36; ; o9 += 36) {
                ...
                n8.push(s3(u3(e11 + r9 % i7, 0))), t7 = c3(r9 / i7);
              }
              n8.push(s3(u3(t7, 0))), d5 = a3(f7, l7, p7 == h7), f7 = 0, ++p7;
            }
          ++f7, ++r8;
        }
        return n8.join("");
      };
      p3 = { version: "2.1.0", ucs2: { decode: l3, encode: (t7) => String.fromCodePoint(...t7) }, decode: d2, encode: h3, toASCII: function(t7) {
        return f3(t7, function(t8) {
          return n3.test(t8) ? "xn--" + h3(t8) : t8;
        });
      }, toUnicode: function(t7) {
        return f3(t7, function(t8) {
          return o3.test(t8) ? d2(t8.slice(4).toLowerCase()) : t8;
        });
      } };
      p3.decode;
      p3.encode;
    ...
    "node_modules/@jspm/core/nodelibs/browser/chunk-b04e620d.js"() {
      ...
      n4 = function(n8, r8, t7, o8) {
        ...
        for (var s6 = 0; s6 < i7; ++s6) {
          ...
          l7 >= 0 ? (p7 = m5.substr(0, l7), f7 = m5.substr(l7 + 1)) : (p7 = m5, f7 = ""), d5 = decodeURIComponent(p7), y5 = decodeURIComponent(f7), e4(a7, d5) ? Array.isArray(a7[d5]) ? a7[d5].push(y5) : a7[d5] = [a7[d5], y5] : a7[d5] = y5;
        }
        return a7;
      };
      r4 = function(e8) {
      ...
      t4 = function(e8, n8, t7, o8) {
        return n8 = n8 || "&", t7 = t7 || "=", null === e8 && (e8 = void 0), "object" == typeof e8 ? Object.keys(e8).map(function(o9) {
          var a7 = encodeURIComponent(r4(o9)) + t7;
          return Array.isArray(e8[o9]) ? e8[o9].map(function(e9) {
            return a7 + encodeURIComponent(r4(e9));
          }).join(n8) : a7 + encodeURIComponent(r4(e8[o9]));
        }).join(n8) : o8 ? encodeURIComponent(r4(o8)) + t7 + encodeURIComponent(r4(e8)) : "";
      };
      o4 = {};
  ...
  function c4(e8) {
    ...
    if ((t5 === i4 || !t5) && setTimeout)
      return t5 = setTimeout, setTimeout(e8, 0);
    try {
      return t5(e8, 0);
    } catch (n8) {
      try {
        return t5.call(null, e8, 0);
      } catch (n9) {
        return t5.call(this || r5, e8, 0);
      }
    }
  }
  function h4() {
  ...
  function d3() {
    if (!f4) {
      var e8 = c4(h4);
      f4 = true;
      for (var t7 = s4.length; t7; ) {
        for (l4 = s4, s4 = []; ++a4 < t7; )
          l4 && l4[a4].run();
        a4 = -1, t7 = s4.length;
      }
      l4 = null, f4 = false, function(e9) {
        if (n5 === clearTimeout)
          return clearTimeout(e9);
        if ((n5 === u4 || !n5) && clearTimeout)
          return n5 = clearTimeout, clearTimeout(e9);
        try {
          n5(e9);
        } catch (t8) {
          try {
            return n5.call(null, e9);
          } catch (t9) {
            return n5.call(this || r5, e9);
          }
        }
      }(e8);
    }
  ...
  function m2(e8, t7) {
    (this || r5).fun = e8, (this || r5).array = t7;
  }
  function p4() {
  }
  ...
  var init_chunk_5decc758 = __esm({
    "node_modules/@jspm/core/nodelibs/browser/chunk-5decc758.js"() {
      ...
      init_buffer2();
      init_process2();
      r5 = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : window;
      o5 = e5 = {};
      !function() {
        try {
      ...
      f4 = false;
      a4 = -1;
      o5.nextTick = function(e8) {
        var t7 = new Array(arguments.length - 1);
        if (arguments.length > 1)
          for (var n8 = 1; n8 < arguments.length; n8++)
            t7[n8 - 1] = arguments[n8];
        s4.push(new m2(e8, t7)), 1 !== s4.length || f4 || c4(d3);
      }, m2.prototype.run = function() {
        (this || r5).fun.apply(null, (this || r5).array);
      }, o5.title = "browser", o5.browser = true, o5.env = {}, o5.argv = [], o5.version = "", o5.versions = {}, o5.on = p4, o5.addListener = p4, o5.once = p4, o5.off = p4, o5.removeListener = p4, o5.removeAllListeners = p4, o5.emit = p4, o5.prependListener = p4, o5.prependOnceListener = p4, o5.listeners = function(e8) {
        return [];
      }, o5.binding = function(e8) {
        throw new Error("process.binding is not supported");
      }, o5.cwd = function() {
        return "/";
      }, o5.chdir = function(e8) {
        throw new Error("process.chdir is not supported");
      }, o5.umask = function() {
        return 0;
      };
  ...
  var init_chunk_2eac56ff = __esm({
    "node_modules/@jspm/core/nodelibs/browser/chunk-2eac56ff.js"() {
      ...
      exports2 = {};
      _dewExec2 = false;
      _global = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : window;
      process2 = dew2();
  ...
  function O2(t7, s6, h7) {
    if (t7 && a5.isObject(t7) && t7 instanceof r6)
      return t7;
    var e8 = new r6();
  ...
  var init_url = __esm({
    "node_modules/@jspm/core/nodelibs/browser/url.js"() {
      ...
      h5.parse = O2, h5.resolve = function(t7, s6) {
        return O2(t7, false, true).resolve(s6);
      }, h5.resolveObject = function(t7, s6) {
        return t7 ? O2(t7, false, true).resolveObject(s6) : s6;
      }, h5.format = function(t7) {
        a5.isString(t7) && (t7 = O2(t7));
        return t7 instanceof r6 ? t7.format() : r6.prototype.format.call(t7);
      }, h5.Url = r6;
      o6 = /^([a-z0-9.+-]+:)/i;
      n6 = /:[0-9]*$/;
      i5 = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/;
      ...
      b2 = o4;
      r6.prototype.parse = function(t7, s6, h7) {
        if (!a5.isString(t7))
        ...
        if (O4 = O4.trim(), !h7 && 1 === t7.split("#").length) {
          var d5 = i5.exec(O4);
          if (d5)
            return this.path = O4, this.href = O4, this.pathname = d5[1], d5[2] ? (this.search = d5[2], this.query = s6 ? b2.parse(this.search.substr(1)) : this.search.substr(1)) : s6 && (this.search = "", this.query = {}), this;
        }
        var j3 = o6.exec(O4);
        if (j3) {
        ...
        if (!g2[j3] && (x3 || j3 && !y3[j3])) {
          for (var A3, C3, I3 = -1, w3 = 0; w3 < u5.length; w3++) {
            -1 !== (N3 = O4.indexOf(u5[w3])) && (-1 === I3 || N3 < I3) && (I3 = N3);
          }
          -1 !== (C3 = -1 === I3 ? O4.lastIndexOf("@") : O4.lastIndexOf("@", I3)) && (A3 = O4.slice(0, C3), O4 = O4.slice(C3 + 1), this.auth = decodeURIComponent(A3)), I3 = -1;
          for (w3 = 0; w3 < c5.length; w3++) {
            var N3;
            -1 !== (N3 = O4.indexOf(c5[w3])) && (-1 === I3 || N3 < I3) && (I3 = N3);
          }
          ...
          if (!U3)
            for (var k3 = this.hostname.split(/\./), S3 = (w3 = 0, k3.length); w3 < S3; w3++) {
              ...
              if (R3 && !R3.match(f5)) {
                ...
                if (!$2.match(f5)) {
                  var L3 = k3.slice(0, w3), Z2 = k3.slice(w3 + 1), _3 = R3.match(m3);
                  _3 && (L3.push(_3[1]), Z2.unshift(_3[2])), Z2.length && (O4 = "/" + Z2.join(".") + O4), this.hostname = L3.join(".");
                  break;
                }
              }
            }
          this.hostname.length > 255 ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), U3 || (this.hostname = e6.toASCII(this.hostname));
        ...
        if (!v3[q2])
          for (w3 = 0, S3 = p5.length; w3 < S3; w3++) {
            var T4 = p5[w3];
            if (-1 !== O4.indexOf(T4)) {
        ...
        var F3 = O4.indexOf("?");
        if (-1 !== F3 ? (this.search = O4.substr(F3), this.query = O4.substr(F3 + 1), s6 && (this.query = b2.parse(this.query)), O4 = O4.slice(0, F3)) : s6 && (this.search = "", this.query = {}), O4 && (this.pathname = O4), y3[q2] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
          E3 = this.pathname || "";
          var G2 = this.search || "";
          this.path = E3 + G2;
        }
        ...
        this.host ? r8 = t7 + this.host : this.hostname && (r8 = t7 + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (r8 += ":" + this.port)), this.query && a5.isObject(this.query) && Object.keys(this.query).length && (o8 = b2.stringify(this.query));
        var n8 = this.search || o8 && "?" + o8 || "";
        return s6 && ":" !== s6.substr(-1) && (s6 += ":"), this.slashes || (!s6 || y3[s6]) && false !== r8 ? (r8 = "//" + (r8 || ""), h7 && "/" !== h7.charAt(0) && (h7 = "/" + h7)) : r8 || (r8 = ""), e8 && "#" !== e8.charAt(0) && (e8 = "#" + e8), n8 && "?" !== n8.charAt(0) && (n8 = "?" + n8), s6 + r8 + (h7 = h7.replace(/[?#]/g, function(t8) {
          return encodeURIComponent(t8);
        })) + (n8 = n8.replace("#", "%23")) + e8;
      }, r6.prototype.resolve = function(t7) {
        return this.resolveObject(O2(t7, false, true)).format();
      }, r6.prototype.resolveObject = function(t7) {
        if (a5.isString(t7)) {
          var s6 = new r6();
          s6.parse(t7, false, true), t7 = s6;
        }
        for (var h7 = new r6(), e8 = Object.keys(this), o8 = 0; o8 < e8.length; o8++) {
          var n8 = e8[o8];
          h7[n8] = this[n8];
        }
        ...
        if (t7.slashes && !t7.protocol) {
          ...
          return y3[h7.protocol] && h7.hostname && !h7.pathname && (h7.path = h7.pathname = "/"), h7.href = h7.format(), h7;
        }
        if (t7.protocol && t7.protocol !== h7.protocol) {
          ...
          if (h7.protocol = t7.protocol, t7.host || g2[t7.protocol])
        ...
        var O4 = h7.pathname && "/" === h7.pathname.charAt(0), d5 = t7.host || t7.pathname && "/" === t7.pathname.charAt(0), j3 = d5 || O4 || h7.host && t7.pathname, q2 = j3, x3 = h7.pathname && h7.pathname.split("/") || [], A3 = (m5 = t7.pathname && t7.pathname.split("/") || [], h7.protocol && !y3[h7.protocol]);
        ...
        else if (!a5.isNullOrUndefined(t7.search)) {
          if (A3)
            h7.hostname = h7.host = x3.shift(), (U3 = !!(h7.host && h7.host.indexOf("@") > 0) && h7.host.split("@")) && (h7.auth = U3.shift(), h7.host = h7.hostname = U3.shift());
          return h7.search = t7.search, h7.query = t7.query, a5.isNull(h7.pathname) && a5.isNull(h7.search) || (h7.path = (h7.pathname ? h7.pathname : "") + (h7.search ? h7.search : "")), h7.href = h7.format(), h7;
        }
        if (!x3.length)
        ...
        return (j3 = j3 || h7.host && x3.length) && !k3 && x3.unshift(""), x3.length ? h7.pathname = x3.join("/") : (h7.pathname = null, h7.path = null), a5.isNull(h7.pathname) && a5.isNull(h7.search) || (h7.path = (h7.pathname ? h7.pathname : "") + (h7.search ? h7.search : "")), h7.auth = t7.auth || h7.auth, h7.slashes = h7.slashes || t7.slashes, h7.href = h7.format(), h7;
      }, r6.prototype.parseHost = function() {
        var t7 = this.host, s6 = n6.exec(t7);
  ...
  var require_is_browser = __commonJS({
    "build/lib/is-browser.js"(exports5) {
      ...
      init_process2();
      Object.defineProperty(exports5, "__esModule", { value: true });
      var isBrowser = typeof window !== "undefined" && typeof window.document !== "undefined" || typeof self === "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope" || typeof navigator !== "undefined" && navigator.product === "ReactNative";
  ...
  var require_stream_browser = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/stream-browser.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  function S2(e8) {
    return l$12 && y4 ? void 0 !== b3(e8) : B2(e8) || k2(e8) || E2(e8) || D2(e8) || U2(e8) || P2(e8) || x2(e8) || I2(e8) || M2(e8) || z2(e8) || F2(e8);
  }
  function B2(e8) {
    return l$12 && y4 ? "Uint8Array" === b3(e8) : "[object Uint8Array]" === m4(e8) || u$12(e8) && void 0 !== e8.buffer;
  }
  function k2(e8) {
    return l$12 && y4 ? "Uint8ClampedArray" === b3(e8) : "[object Uint8ClampedArray]" === m4(e8);
  }
  function E2(e8) {
    return l$12 && y4 ? "Uint16Array" === b3(e8) : "[object Uint16Array]" === m4(e8);
  }
  function D2(e8) {
    return l$12 && y4 ? "Uint32Array" === b3(e8) : "[object Uint32Array]" === m4(e8);
  }
  function U2(e8) {
    return l$12 && y4 ? "Int8Array" === b3(e8) : "[object Int8Array]" === m4(e8);
  }
  function P2(e8) {
    return l$12 && y4 ? "Int16Array" === b3(e8) : "[object Int16Array]" === m4(e8);
  }
  function x2(e8) {
    return l$12 && y4 ? "Int32Array" === b3(e8) : "[object Int32Array]" === m4(e8);
  }
  function I2(e8) {
    return l$12 && y4 ? "Float32Array" === b3(e8) : "[object Float32Array]" === m4(e8);
  }
  function M2(e8) {
    return l$12 && y4 ? "Float64Array" === b3(e8) : "[object Float64Array]" === m4(e8);
  }
  function z2(e8) {
    return l$12 && y4 ? "BigInt64Array" === b3(e8) : "[object BigInt64Array]" === m4(e8);
  }
  function F2(e8) {
    return l$12 && y4 ? "BigUint64Array" === b3(e8) : "[object BigUint64Array]" === m4(e8);
  }
  function T3(e8) {
    return "[object Map]" === m4(e8);
  }
  function N2(e8) {
    return "[object Set]" === m4(e8);
  }
  function W(e8) {
    return "[object WeakMap]" === m4(e8);
  }
  function $(e8) {
    return "[object WeakSet]" === m4(e8);
  }
  function C2(e8) {
    return "[object ArrayBuffer]" === m4(e8);
  }
  function V(e8) {
    return "undefined" != typeof ArrayBuffer && (C2.working ? C2(e8) : e8 instanceof ArrayBuffer);
  }
  function G(e8) {
    return "[object DataView]" === m4(e8);
  }
  function R2(e8) {
    return "undefined" != typeof DataView && (G.working ? G(e8) : e8 instanceof DataView);
  }
  function J(e8) {
    return "[object SharedArrayBuffer]" === m4(e8);
  }
  function _2(e8) {
  ...
  var t6, e7, o7, n7, r7, l6, t$1, o$12, n$12, e$12, r$1, c6, u6, i6, t$2, i$12, o$2, u$12, f6, a6, s5, p6, y4, l$12, d4, m4, h6, j2, A2, Q, X, Y2, ee, te, re, ne, ie, Se, Ee;
  var init_chunk_b4205b57 = __esm({
    "node_modules/@jspm/core/nodelibs/browser/chunk-b4205b57.js"() {
      ...
      init_process2();
      init_chunk_5decc758();
      t6 = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag;
      e7 = Object.prototype.toString;
      o7 = function(o8) {
        return !(t6 && o8 && "object" == typeof o8 && Symbol.toStringTag in o8) && "[object Arguments]" === e7.call(o8);
      };
      n7 = function(t7) {
        return !!o7(t7) || null !== t7 && "object" == typeof t7 && "number" == typeof t7.length && t7.length >= 0 && "[object Array]" !== e7.call(t7) && "[object Function]" === e7.call(t7.callee);
      };
      r7 = function() {
        return o7(arguments);
      }();
      o7.isLegacyArguments = n7;
      l6 = r7 ? o7 : n7;
      t$1 = Object.prototype.toString;
      o$12 = Function.prototype.toString;
      n$12 = /^\s*(?:function)?\*/;
      e$12 = "function" == typeof Symbol && "symbol" == typeof Symbol.toStringTag;
      ...
      u6 = c6 ? r$1(c6) : {};
      i6 = function(c7) {
        return "function" == typeof c7 && (!!n$12.test(o$12.call(c7)) || (e$12 ? r$1(c7) === u6 : "[object GeneratorFunction]" === t$1.call(c7)));
      };
      t$2 = "function" == typeof Object.create ? function(t7, e8) {
      ...
      f6 = l6;
      a6 = i6;
      s5 = "undefined" != typeof BigInt;
      p6 = "undefined" != typeof Symbol;
      y4 = p6 && void 0 !== Symbol.toStringTag;
      l$12 = "undefined" != typeof Uint8Array;
      d4 = "undefined" != typeof ArrayBuffer;
      if (l$12 && y4)
        var g3 = Object.getPrototypeOf(Uint8Array.prototype), b3 = c$12(Object.getOwnPropertyDescriptor(g3, Symbol.toStringTag).get);
      m4 = c$12(Object.prototype.toString);
      h6 = c$12(Number.prototype.valueOf);
      j2 = c$12(String.prototype.valueOf);
      A2 = c$12(Boolean.prototype.valueOf);
      if (s5)
        var w2 = c$12(BigInt.prototype.valueOf);
      if (p6)
        var v4 = c$12(Symbol.prototype.valueOf);
      o$2.isArgumentsObject = f6, o$2.isGeneratorFunction = a6, o$2.isPromise = function(e8) {
        ...
        return d4 && ArrayBuffer.isView ? ArrayBuffer.isView(e8) : S2(e8) || R2(e8);
      }, o$2.isTypedArray = S2, o$2.isUint8Array = B2, o$2.isUint8ClampedArray = k2, o$2.isUint16Array = E2, o$2.isUint32Array = D2, o$2.isInt8Array = U2, o$2.isInt16Array = P2, o$2.isInt32Array = x2, o$2.isFloat32Array = I2, o$2.isFloat64Array = M2, o$2.isBigInt64Array = z2, o$2.isBigUint64Array = F2, T3.working = "undefined" != typeof Map && T3(/* @__PURE__ */ new Map()), o$2.isMap = function(e8) {
        return "undefined" != typeof Map && (T3.working ? T3(e8) : e8 instanceof Map);
      }, N2.working = "undefined" != typeof Set && N2(/* @__PURE__ */ new Set()), o$2.isSet = function(e8) {
        return "undefined" != typeof Set && (N2.working ? N2(e8) : e8 instanceof Set);
        ...
        return $(e8);
      }, C2.working = "undefined" != typeof ArrayBuffer && C2(new ArrayBuffer()), o$2.isArrayBuffer = V, G.working = "undefined" != typeof ArrayBuffer && "undefined" != typeof DataView && G(new DataView(new ArrayBuffer(1), 0, 1)), o$2.isDataView = R2, J.working = "undefined" != typeof SharedArrayBuffer && J(new SharedArrayBuffer()), o$2.isSharedArrayBuffer = _2, o$2.isAsyncFunction = function(e8) {
        return "[object AsyncFunction]" === m4(e8);
      }, o$2.isMapIterator = function(e8) {
        return "[object Map Iterator]" === m4(e8);
      }, o$2.isSetIterator = function(e8) {
        return "[object Set Iterator]" === m4(e8);
      }, o$2.isGeneratorObject = function(e8) {
        return "[object Generator]" === m4(e8);
      }, o$2.isWebAssemblyCompiledModule = function(e8) {
        return "[object WebAssembly.Module]" === m4(e8);
      }, o$2.isNumberObject = H, o$2.isStringObject = Z, o$2.isBooleanObject = q, o$2.isBigIntObject = K, o$2.isSymbolObject = L2, o$2.isBoxedPrimitive = function(e8) {
        return H(e8) || Z(e8) || q(e8) || K(e8) || L2(e8);
      }, o$2.isAnyArrayBuffer = function(e8) {
        return l$12 && (V(e8) || _2(e8));
      ...
      Q = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : window;
      X = {};
      Y2 = T2;
      ee = Object.getOwnPropertyDescriptors || function(e8) {
        ...
        return function() {
          if (!r8) {
            if (Y2.throwDeprecation)
              throw new Error(t7);
            Y2.traceDeprecation ? console.trace(t7) : console.error(t7), r8 = true;
          }
      ...
      X.promisify = function(e8) {
        ...
        function t7() {
          ...
          e8.apply(this || Q, t8).then(function(e9) {
            Y2.nextTick(o8.bind(null, null, e9));
          }, function(e9) {
            Y2.nextTick(De.bind(null, e9, o8));
          });
        }
  ...
  var _extend, callbackify, debuglog, deprecate, format2, inherits, inspect, isArray, isBoolean, isBuffer, isDate, isError, isFunction, isNull, isNullOrUndefined, isNumber, isObject, isPrimitive, isRegExp, isString, isSymbol, isUndefined, log, promisify, types, TextEncoder, TextDecoder;
  ...
  var _extend2, callbackify2, debuglog2, deprecate2, format3, inherits2, inspect2, isArray2, isBoolean2, isBuffer2, isDate2, isError2, isFunction2, isNull2, isNullOrUndefined2, isNumber2, isObject2, isPrimitive2, isRegExp2, isString2, isSymbol2, isUndefined2, log2, promisify2, types2, TextEncoder2, TextDecoder2;
  var init_util = __esm({
    "node_modules/@jspm/core/nodelibs/browser/util.js"() {
      init_dirname();
      init_buffer2();
  ...
  var require_buffer_list2 = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/buffer_list.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_destroy2 = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/destroy.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_errors_browser = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/errors-browser.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_state2 = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/state.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_stream_writable = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_writable.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_stream_duplex = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_duplex.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_string_decoder = __commonJS({
    "node_modules/string_decoder/lib/string_decoder.js"(exports5) {
      ...
      exports5.StringDecoder = StringDecoder2;
      ...
      StringDecoder2.prototype.write = function(buf) {
        ...
        if (i7 < buf.length)
          return r8 ? r8 + this.text(buf, i7) : this.text(buf, i7);
        return r8 || "";
      };
      ...
      function utf8CheckIncomplete(self2, buf, i7) {
        var j3 = buf.length - 1;
        if (j3 < i7)
          return 0;
      ...
      function utf8FillLast(buf) {
        ...
        var r8 = utf8CheckExtraBytes(this, buf, p7);
        if (r8 !== void 0)
          return r8;
        if (this.lastNeed <= buf.length) {
      ...
      function utf8Text(buf, i7) {
        var total = utf8CheckIncomplete(this, buf, i7);
        if (!this.lastNeed)
          return buf.toString("utf8", i7);
      ...
      function utf16Text(buf, i7) {
        if ((buf.length - i7) % 2 === 0) {
          var r8 = buf.toString("utf16le", i7);
          if (r8) {
            var c7 = r8.charCodeAt(r8.length - 1);
        ...
        return buf.toString("utf16le", i7, buf.length - 1);
      }
      ...
      function base64Text(buf, i7) {
        var n8 = (buf.length - i7) % 3;
        if (n8 === 0)
          return buf.toString("base64", i7);
        this.lastNeed = 3 - n8;
        this.lastTotal = 3;
        if (n8 === 1) {
          this.lastChar[0] = buf[buf.length - 1];
        ...
        return buf.toString("base64", i7, buf.length - n8);
      }
  ...
  var require_end_of_stream2 = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/end-of-stream.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_async_iterator = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/async_iterator.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_from_browser = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/from-browser.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_stream_readable = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_readable.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_stream_transform = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_transform.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_stream_passthrough = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_passthrough.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_pipeline2 = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports5, module) {
      "use strict";
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_readable_browser = __commonJS({
    "node_modules/duplexify/node_modules/readable-stream/readable-browser.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
      ...
      exports5.finished = require_end_of_stream2();
      exports5.pipeline = require_pipeline2();
    }
  });

  // node_modules/wrappy/wrappy.js
  var require_wrappy = __commonJS({
    "node_modules/wrappy/wrappy.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_once = __commonJS({
    "node_modules/once/once.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
      ...
      function onceStrict(fn) {
        ...
        f7.onceError = name2 + " shouldn't be called more than once";
        f7.called = false;
        return f7;
      }
    }
  ...
  var require_end_of_stream3 = __commonJS({
    "node_modules/end-of-stream/index.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
      ...
      var eos = function(stream, opts, callback) {
        ...
        var onclose = function() {
          process_exports.nextTick(onclosenexttick);
        };
  ...
  var require_stream_shift = __commonJS({
    "node_modules/stream-shift/index.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
  ...
  var require_duplexify2 = __commonJS({
    "node_modules/duplexify/index.js"(exports5, module) {
      init_dirname();
      init_buffer2();
      init_process2();
      ...
      inherits3(Duplexify, stream.Duplex);
      ...
      Duplexify.prototype.setWritable = function(writable) {
        ...
        if (this._unwrite)
          process_exports.nextTick(ondrain);
  ...
  var require_wx = __commonJS({
    "build/lib/connect/wx.js"(exports5) {
      ...
      var readable_stream_1 = require_browser3();
      var duplexify_1 = __importDefault(require_duplexify2());
      var socketTask;
      var proxy;
      var stream;
      function buildProxy() {
    ...
    "build/lib/connect/ws.js"(exports5) {
      ...
      var browserStreamBuilder = (client, opts) => {
        ...
        if (socket.readyState === socket.OPEN) {
          ...
          stream = (0, duplexify_1.default)(void 0, void 0, opts);
          if (!opts.objectMode) {
        ...
        function writev(chunks, cb) {
          ...
          for (let i7 = 0; i7 < chunks.length; i7++) {
            if (typeof chunks[i7].chunk === "string") {
              buffers[i7] = buffer_1.Buffer.from(chunks[i7], "utf8");
            } else {
              buffers[i7] = chunks[i7].chunk;
            }
          }
  ...
  var require_mqtt2 = __commonJS({
    "build/mqtt.js"(exports5) {
      ...
      var __exportStar = exports5 && exports5.__exportStar || function(m5, exports6) {
        for (var p7 in m5)
          if (p7 !== "default" && !Object.prototype.hasOwnProperty.call(exports6, p7))
            __createBinding(exports6, m5, p7);
      };
      var __importDefault = exports5 && exports5.__importDefault || function(mod) {
        return mod && mod.__esModule ? mod : { "default": mod };
      };
