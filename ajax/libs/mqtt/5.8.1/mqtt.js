...
`;
  ...
  var require_is_browser = __commonJS({
    "build/lib/is-browser.js"(exports5) {
      ...
      var isTxikijsEnv = () => typeof navigator !== "undefined" && navigator.userAgent === "txiki.js";
      var isWebWorkerEnv = () => {
        var _a, _b;
      ...
      var isBrowser = isStandardBrowserEnv() || isWebWorkerEnv() || isReactNativeEnv() || isTxikijsEnv();
