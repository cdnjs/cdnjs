    ...
    ***************************************************************************** */
    ...
    var getOptions$1 = function (obj) {
        ...
        var options = Array.prototype.reduce.call(obj, function (acc, attribute) {
            ...
            if (option) {
                var key = option[1].replace(/\W+(.)/g, function (x, chr) { return chr.toUpperCase(); });
    ...
    var SimpleBarCore = /** @class */ (function () {
        function SimpleBarCore(element, options) {
            ...
            this.drag = function (e) {
                ...
                if (_this.draggedAxis === 'x') {
                    scrollPos =
                        _this.isRtl && ((_j = SimpleBarCore.getRtlHelpers()) === null || _j === void 0 ? void 0 : _j.isScrollOriginAtZero)
        ...
        SimpleBarCore.prototype.positionScrollbar = function (axis) {
            ...
            handleOffset =
                axis === 'x' &&
                    this.isRtl &&
                    ((_c = SimpleBarCore.getRtlHelpers()) === null || _c === void 0 ? void 0 : _c.isScrollingToNegative)
        ...
        SimpleBarCore.prototype.onMouseMoveForAxis = function (axis) {
            ...
            var isWithinScrollbarBoundsX = this.isWithinBounds(currentAxis.scrollbar.rect);
