    ...
    var SimpleBarCore = /** @class */ (function () {
        ...
        SimpleBarCore.prototype.initDOM = function () {
            ...
            if (!this.options.autoHide) {
                (_a = this.axis.x.scrollbar.el) === null || _a === void 0 ? void 0 : _a.classList.add(this.classNames.visible);
                (_b = this.axis.y.scrollbar.el) === null || _b === void 0 ? void 0 : _b.classList.add(this.classNames.visible);
            }
