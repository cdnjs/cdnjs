...
}};if(typeof Object.create!=="function"){Object.create=function(o){function F(){}F.prototype=o;return new F}}$.dynatableSetup=function(options){defaults=mergeSettings(options)};$.dynatable=function(object){$.fn["dynatable"]=function(options){return this.each(function(){if(!$.data(this,"dynatable")){$.data(this,"dynatable",Object.create(object).init(this,options))}})}};$.dynatable(dt)})(jQuery);
