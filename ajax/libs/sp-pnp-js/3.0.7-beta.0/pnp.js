/**
 * sp-pnp-js v3.0.7-beta.0 - A JavaScript library for SharePoint development.
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.fetch = function (url, options) {
        ...
        if (!headers.has("X-ClientService-ClientTag")) {
            headers.append("X-ClientService-ClientTag", "PnPCoreJS:3.0.7-beta.0");
        }
        if (!headers.has("User-Agent")) {
            // this marks the requests for understanding by the service
            headers.append("User-Agent", "NONISV|SharePointPnP|PnPCoreJS/3.0.7-beta.0");
        }
