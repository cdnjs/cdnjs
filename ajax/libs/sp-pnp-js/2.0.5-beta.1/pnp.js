/**
 * sp-pnp-js v2.0.5-beta.1 - A JavaScript library for SharePoint development.
...
var util_1 = __webpack_require__(0);
var exceptions_1 = __webpack_require__(3);
var webparts_1 = __webpack_require__(51);
...
var HttpClient = (function () {
    ...
    HttpClient.prototype.fetch = function (url, options) {
        ...
        if (!headers.has("X-ClientService-ClientTag")) {
            headers.append("X-ClientService-ClientTag", "PnPCoreJS:2.0.5-beta.1");
        }
...
var SearchResults = (function () {
     ...
     *
     */
    function SearchResults(rawResponse, _raw, _primary) {
...
var UtilityMethod = (function (_super) {
    ...
    UtilityMethod.prototype.getLocalizedString = function (source, defaultResourceFile, lang) {
        var params = {
            defaultResourceFile: defaultResourceFile,
            language: lang,
            source: source,
        };
        return this.create("GetLocalizedString", true).excute(params);
    };
