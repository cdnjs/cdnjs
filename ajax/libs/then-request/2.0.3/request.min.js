...
"use strict";function doRequest(e,t,o,n){var r=new Promise(function(r){var s=new window.XMLHttpRequest;if("string"!=typeof e)throw new TypeError("The method must be a string.");if("string"!=typeof t)throw new TypeError("The URL/path must be a string.");if("function"==typeof o&&(n=o,o={}),(null===o||void 0===o)&&(o={}),"object"!=typeof o)throw new TypeError("Options must be an object (or null).");"function"!=typeof n&&(n=void 0),e=e.toUpperCase(),o.headers=o.headers||{};var i,a=!(!(i=/^([\w-]+:)?\/\/([^\/]+)/.exec(o.uri))||i[2]==window.location.host);a||(o.headers["X-Requested-With"]="XMLHttpRequest"),o.qs&&(t=handleQs(t,o.qs)),o.json&&(o.body=JSON.stringify(o.json),o.headers["content-type"]="application/json"),s.onreadystatechange=function(){if(4===s.readyState){var e={};s.getAllResponseHeaders().split("\r\n").forEach(function(t){var o=t.split(":");o.length>1&&(e[o[0].toLowerCase()]=o.slice(1).join(":").trim())}),r(new Response(s.status,e,s.responseText))}},s.open(e,t,!0);for(var u in o.headers)s.setRequestHeader(u.toLowerCase(),o.headers[u]);s.send(o.body?o.body:null)});return r.getBody=function(){return r.then(function(e){return e.getBody()})},r.nodeify(n)}var Promise=require("promise"),Response=require("http-response-object"),handleQs=require("./lib/handle-qs.js");module.exports=doRequest;
