...
var MapComponent = function (_Component) {
  ...
  MapComponent.prototype.componentWillUnmount = function componentWillUnmount() {
    ...
    forEach$1(this._leafletEvents, function (cb, ev) {
      el.off(ev, cb);
    });
  };
  ...
  MapComponent.prototype.bindLeafletEvents = function bindLeafletEvents() {
    ...
    var diff = clone$1(prev);
    forEach$1(prev, function (cb, ev) {
...
var Path = function (_MapLayer) {
  ...
  Path.prototype.setStyleIfChanged = function setStyleIfChanged(fromProps, toProps) {
    ...
    if (!isEqual$1(nextStyle, this.getPathOptions(fromProps))) {
...
function isPlainObject(value) {
  if (!isObjectLike(value) || baseGetTag$1(value) != objectTag$4) {
    return false;
  }
...
var Map$3 = function (_MapComponent) {
  ...
  Map$$1.prototype.componentDidMount = function componentDidMount() {
    var props = omit$1(this.props, OTHER_PROPS);
    this.leafletElement = this.createLeafletElement(props);

    this.leafletElement.on('move', this.onViewportChange);
    this.leafletElement.on('moveend', this.onViewportChanged);

    if (!isUndefined$1(props.bounds)) {
...
var Pane = function (_Component) {
  ...
  Pane.prototype.createPane = function createPane(props) {
    ...
    var name = props.name || 'pane-' + uniqueId$1();
  ...
  Pane.prototype.removePane = function removePane() {
    ...
    if (name) {
      ...
      if (_map && _map._panes) {
        _map._panes = omit$1(_map._panes, name);
        _map._paneRenderers = omit$1(_map._paneRenderers, name);
      }
...
var WMSTileLayer = function (_GridLayer) {
  ...
  WMSTileLayer.prototype.createLeafletElement = function createLeafletElement(props) {
    var url = props.url,
        _o = props.opacity,
        _z = props.zIndex,
        params = objectWithoutProperties(props, ['url', 'opacity', 'zIndex']);
  ...
  WMSTileLayer.prototype.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    ...
    if (!isEqual$1(params, prevParams)) {
