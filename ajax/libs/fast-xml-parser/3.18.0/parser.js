...
var result=closingIndexForOpeningTag(xmlData,i+1);var _tagExp2=result.data;var _closeIndex3=result.index;var separatorIndex=_tagExp2.indexOf(" ");var _tagName=_tagExp2;if(separatorIndex!==-1){_tagName=_tagExp2.substr(0,separatorIndex).replace(/\s\s*$/,'');_tagExp2=_tagExp2.substr(separatorIndex+1);}if(options.ignoreNameSpace){var _colonIndex=_tagName.indexOf(":");if(_colonIndex!==-1){_tagName=_tagName.substr(_colonIndex+1);}}//save text to parent node
