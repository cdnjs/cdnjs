...
str+=chars.arrStart;var itemSchema=e_schema[0];//const itemSchemaType = itemSchema;
...
if(!options.alwaysCreateTextNode&&(!node.child||util.isEmptyObject(node.child))&&(!node.attrsMap||util.isEmptyObject(node.attrsMap))){return util.isExist(node.val)?node.val:'';}// otherwise create a textnode if node has some text
...
"use strict";
var nodeToJson=__webpack_require__(/*! ./node2json */ "./src/node2json.js");var xmlToNodeobj=__webpack_require__(/*! ./xmlstr2xmlnode */ "./src/xmlstr2xmlnode.js");var x2xmlnode=__webpack_require__(/*! ./xmlstr2xmlnode */ "./src/xmlstr2xmlnode.js");var buildOptions=__webpack_require__(/*! ./util */ "./src/util.js").buildOptions;var validator=__webpack_require__(/*! ./validator */ "./src/validator.js");exports.parse=function(xmlData,givenOptions,validationOption){if(givenOptions===void 0){givenOptions={};}if(validationOption){if(validationOption===true)validationOption={};var result=validator.validate(xmlData,validationOption);if(result!==true){throw Error(result.err.msg);}}if(givenOptions.parseTrueNumberOnly&&givenOptions.parseNodeValue!==false&&!givenOptions.numParseOptions){givenOptions.numParseOptions={leadingZeros:false};}var options=buildOptions(givenOptions,x2xmlnode.defaultOptions,x2xmlnode.props);var traversableObj=xmlToNodeobj.getTraversalObj(xmlData,options);//print(traversableObj, "  ");
...
"use strict";
var util=__webpack_require__(/*! ./util */ "./src/util.js");var buildOptions=__webpack_require__(/*! ./util */ "./src/util.js").buildOptions;var xmlNode=__webpack_require__(/*! ./xmlNode */ "./src/xmlNode.js");var toNumber=__webpack_require__(/*! strnum */ "./node_modules/strnum/strnum.js");var regx='<((!\\[CDATA\\[([\\s\\S]*?)(]]>))|((NAME:)?(NAME))([^>]*)>|((\\/)(NAME)\\s*>))([^<]*)'.replace(/NAME/g,util.nameRegexp);//const tagsRegx = new RegExp("<(\\/?[\\w:\\-\._]+)([^>]*)>(\\s*"+cdataRegx+")*([^<]+)?","g");
...
cdataTagName:false,cdataPositionChar:'\\c',numParseOptions:{hex:true,leadingZeros:true},tagValueProcessor:function tagValueProcessor(a,tagName){return a;},attrValueProcessor:function attrValueProcessor(a,attrName){return a;},stopNodes:[],alwaysCreateTextNode:false//decodeStrict: false,
