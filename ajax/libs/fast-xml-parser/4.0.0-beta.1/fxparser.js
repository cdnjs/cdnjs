...
var buildOptions=__webpack_require__(/*! ../util */ "./src/util.js").buildOptions;var buildFromOrderedJs=__webpack_require__(/*! ./orderedJs2Xml */ "./src/xmlbuilder/orderedJs2Xml.js");var defaultOptions={attributeNamePrefix:'@_',attributesGroupName:false,textNodeName:'#text',ignoreAttributes:true,cdataPropName:false,format:false,indentBy:'  ',suppressEmptyNode:false,tagValueProcessor:function tagValueProcessor(key,a){return a;},attributeValueProcessor:function attributeValueProcessor(attrName,a){return a;},preserveOrder:false,commentPropName:false};var props=['attributeNamePrefix','attributesGroupName','textNodeName','ignoreAttributes','cdataPropName','format','indentBy','suppressEmptyNode','tagValueProcessor','attributeValueProcessor','arrayNodeName',//when array as root
'preserveOrder',"commentPropName"// 'rootNodeName', //when jsObject have multiple properties on root level
...
if(_tagName!==_tagExp2&&shouldBuildAttributesMap){_childNode.attrsMap=buildAttributesMap(_tagExp2,jPath,options);}currentNode.addChild(_childNode);currentNode=_childNode;}textData="";i=_closeIndex3;}}else{textData+=xmlData[i];}}return xmlObj.child;};//TODO: use jPath to simplify the logic
/**
 * 
