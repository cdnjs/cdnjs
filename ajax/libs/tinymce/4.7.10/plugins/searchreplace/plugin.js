...
var searchreplace = (function () {
  ...
  var $_1mtj27j2jfjm4l81 = { findAndReplaceDOMText: findAndReplaceDOMText };
  ...
  var markAllMatches = function (editor, currentIndexState, regex) {
    ...
    return $_1mtj27j2jfjm4l81.findAndReplaceDOMText(regex, node, marker, false, editor.schema);
  };
  ...
  var get = function (editor, currentIndexState) {
    var done = function (keepEditorSelection) {
      return $_4eco4xj0jfjm4l7u.done(editor, currentIndexState, keepEditorSelection);
    };
    var find = function (text, matchCase, wholeWord) {
      return $_4eco4xj0jfjm4l7u.find(editor, currentIndexState, text, matchCase, wholeWord);
    };
    var next = function () {
      return $_4eco4xj0jfjm4l7u.next(editor, currentIndexState);
    };
    var prev = function () {
      return $_4eco4xj0jfjm4l7u.prev(editor, currentIndexState);
    };
    var replace = function (text, forward, all) {
      return $_4eco4xj0jfjm4l7u.replace(editor, currentIndexState, text, forward, all);
    };
    return {
      done: done,
      find: find,
  ...
  var open = function (editor, currentIndexState) {
    ...
    function updateButtonStates() {
      win.statusbar.find('#next').disabled($_4eco4xj0jfjm4l7u.hasNext(editor, currentIndexState) === false);
      win.statusbar.find('#prev').disabled($_4eco4xj0jfjm4l7u.hasPrev(editor, currentIndexState) === false);
    }
    ...
    var win = editor.windowManager.open({
      ...
      onClose: function () {
        editor.focus();
        $_4eco4xj0jfjm4l7u.done(editor, currentIndexState);
        editor.undoManager.add();
      },
      onSubmit: function (e) {
        ...
        if (!text.length) {
          $_4eco4xj0jfjm4l7u.done(editor, currentIndexState, false);
          win.statusbar.items().slice(1).disabled(true);
          return;
        }
        if (last.text === text && last.caseState === caseState && last.wholeWord === wholeWord) {
          if (!$_4eco4xj0jfjm4l7u.hasNext(editor, currentIndexState)) {
            notFoundAlert();
            return;
          }
          $_4eco4xj0jfjm4l7u.next(editor, currentIndexState);
          updateButtonStates();
          return;
        }
        count = $_4eco4xj0jfjm4l7u.find(editor, currentIndexState, text, caseState, wholeWord);
        if (!count) {
          notFoundAlert();
        }
      ...
      buttons: [
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            if (!$_4eco4xj0jfjm4l7u.replace(editor, currentIndexState, win.find('#replace').value())) {
              win.statusbar.items().slice(1).disabled(true);
              currentIndexState.set(-1);
              last = {};
            }
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_4eco4xj0jfjm4l7u.replace(editor, currentIndexState, win.find('#replace').value(), true, true);
            win.statusbar.items().slice(1).disabled(true);
            last = {};
          }
        },
        ...
        },
        {
          ...
          disabled: true,
          onclick: function () {
            $_4eco4xj0jfjm4l7u.prev(editor, currentIndexState);
            updateButtonStates();
          }
        },
        {
  ...
  var $_day8uij4jfjm4l87 = { open: open };

  var register = function (editor, currentIndexState) {
    editor.addCommand('SearchReplace', function () {
      $_day8uij4jfjm4l87.open(editor, currentIndexState);
    });
  };
  var $_7qiqgbj3jfjm4l85 = { register: register };
  ...
  var $_eknydej5jfjm4l8a = { register: register$1 };

  global.add('searchreplace', function (editor) {
    var currentIndexState = Cell(-1);
    $_7qiqgbj3jfjm4l85.register(editor, currentIndexState);
    $_eknydej5jfjm4l8a.register(editor, currentIndexState);
    return $_g6jzs4izjfjm4l7s.get(editor, currentIndexState);
  });
  function Plugin () {
  }
