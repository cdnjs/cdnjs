...
export declare type ManagerCallbacks = {
    onCancel?: () => unknown;
    onDone?: (result: {
...
declare type MediaManagerFile = UppyFile<{
    cloudflareResourceId?: string;
}>;

declare type OverwriteTypes<Input, Overwrite> = {
    [Key in keyof Input as Key extends keyof Overwrite ? never : Key]: Input[Key];
} & Overwrite;

declare type Prettyfy<T> = {
    [K in keyof T]: T[K];
} & {};
...
declare const UserOptions: z.ZodObject<{
    ...
    onUpload: z.ZodOptional<z.ZodFunction<z.ZodTuple<[], z.ZodUnknown>, z.ZodUnknown>>;
    ...
    onUpload?: ((...args: unknown[]) => unknown) | undefined;
...
declare type UserOptions = Prettyfy<OverwriteTypes<OverwriteTypes<z.infer<typeof UserOptions>, ManagerCallbacks>, {
