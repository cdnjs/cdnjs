...
export type MeanagerCallbacks = {
    ...
    onUpload?: (file: MediaManagerFile) => unknown;
    onUploadError?: (error: UploadError, file: UploadError) => unknown;
};
/**
...
type UserOptions = OverwriteTypes<OverwriteTypes<z.infer<typeof UserOptions>, MeanagerCallbacks>, {
