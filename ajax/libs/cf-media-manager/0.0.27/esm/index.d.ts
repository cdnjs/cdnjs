...
import { type Prettyfy } from "./utils/types";
import "./index.css";
...
declare const UserOptions: z.ZodObject<{
    ...
    auth: z.ZodObject<{
        authUrl: z.ZodString;
        numberOfRetriesOnError: z.ZodDefault<z.ZodOptional<z.ZodNumber>>;
...
type UserOptionsInput = Prettyfy<z.input<typeof UserOptions>>;
