...
/* Generated by Opal 0.8.0 */
Opal.modules["asciidoctor/opal_ext/comparable"] = function(Opal) {
  Opal.dynamic_require_severity = "ignore";
...
/* Generated by Opal 0.8.0 */
Opal.modules["asciidoctor/opal_ext/error"] = function(Opal) {
  Opal.dynamic_require_severity = "ignore";
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
...
Opal.modules["asciidoctor/opal_ext"] = function(Opal) {
  ...
  self.$require("asciidoctor/opal_ext/comparable");
  self.$require("asciidoctor/opal_ext/dir");
  self.$require("asciidoctor/opal_ext/error");
  self.$require("asciidoctor/opal_ext/file");
  return self.$require("asciidoctor/opal_ext/match_data");
};
/* Generated by Opal 0.8.0 */
...
Opal.modules["asciidoctor/version"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.cdecl($scope, 'VERSION', "1.5.3")
  })(self)
};
/* Generated by Opal 0.8.0 */
...
if (type == null) type = nil;
      ...
      Opal.defn(self, '$extract_passthroughs', function(text) {
        ...
        if ((($a = ((($c = (text['$include?'](pass_inline_char1))) !== false && $c !== nil) ? $c : ((($d = pass_inline_char2 !== false && pass_inline_char2 !== nil) ? (text['$include?'](pass_inline_char2)) : $d)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            if (compat_mode !== false && compat_mode !== nil) {
              old_behavior = true
            } else if ((($a = (old_behavior = ((($b = attributes !== false && attributes !== nil) ? (attributes['$end_with?']("x-")) : $b)))) !== nil && (!$a.$$is_boolean || $a == true))) {
              attributes = attributes['$[]']($range(0, -2, true))};
            if (attributes !== false && attributes !== nil) {
              if ((($a = (($b = format_mark['$==']("`")) ? old_behavior['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$sub_specialcharacters', def.$sub_specialchars);
...
if (extension == null) extension = nil;
        ...
        if ((($a = (($h = found_colon !== false && found_colon !== nil) ? (result['$include?']("://")) : $h)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            if ((($a = Opal.get('RUBY_ENGINE_OPAL')) !== nil && (!$a.$$is_boolean || $a == true))) {
              if (m['$[]'](3)['$==']("")) {
                m['$[]='](3, nil)}};
            if ((($a = (($b = m['$[]'](1)['$==']("link:")) ? m['$[]'](3)['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              return m['$[]'](0);};
        ...
        if ((($a = ((($i = ($j = found['$[]']("macroish"), $j !== false && $j !== nil ?(result['$include?']("link:")) : $j)) !== false && $i !== nil) ? $i : (result['$include?']("mailto:")))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            link_opts = $hash2(["type", "target"], {"type": "link", "target": target});
            attrs = nil;
            text = (function() {if ((($a = (($b = use_link_attrs !== false && use_link_attrs !== nil) ? (((($c = m['$[]'](2)['$start_with?']("\"")) !== false && $c !== nil) ? $c : m['$[]'](2)['$include?'](","))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        modifier_operation = nil;
          if (modifiers_present !== false && modifiers_present !== nil) {
            if (((first = key.$chr()))['$==']("+")) {
              ...
              key = key.$chop();}};
          key = key.$to_sym();
          if ((($a = (($b = type['$==']("inline")) ? (((($c = key['$==']("verbatim")) !== false && $c !== nil) ? $c : key['$==']("v"))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          } else if ((($a = ($b = (($c = type['$==']("inline")) ? key.$length()['$=='](1) : $c), $b !== false && $b !== nil ?($scope.get('SUB_SYMBOLS')['$key?'](key)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (line == null) line = nil;
          if (reached_code !== false && reached_code !== nil) {
            ...
            if ((($a = (conums = callout_marks.$delete(lineno))) !== nil && (!$a.$$is_boolean || $a == true))) {
              tail = nil;
              if ((($a = (($b = callout_on_last !== false && callout_on_last !== nil) ? callout_marks['$empty?']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$image_uri = function(target_image, asset_dir_key) {
        ...
        if ((($a = (($b = $rb_lt(((doc = self.document)).$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE')))) ? doc['$attr?']("data-uri") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (file == null) file = nil;
      ...
      def.$read_contents = function(target, opts) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        (function(self) {
          ...
          self.$$proto.$default = function(initialize_singleton) {
            var $a, $b, self = this;
          ...
          self.$$proto.$resolve = function(backend) {
            var self = this;

            return self.$default().$resolve(backend);
          };
          self.$$proto.$create = function(backend, opts) {
            var self = this;
          ...
          self.$$proto.$converters = function() {
            var self = this;
  ...
  (function($base) {
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        Opal.defn(self, '$register_for', function(backends) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$document = function(node) {
        var $a, $b, $c, TMP_1, TMP_2, self = this, result = nil, slash = nil, br = nil, asset_uri_scheme = nil, cdn_base = nil, linkcss = nil, lang_attribute = nil, webfonts = nil, iconfont_stylesheet = nil, $case = nil, highlighter = nil, pygments_style = nil, docinfo_content = nil, body_attrs = nil, details = nil, authorcount = nil, highlightjs_path = nil, prettify_path = nil, eqnums_val = nil, eqnums_opt = nil;
...
if (idx == null) idx = nil;
            ...
            if ((($a = ($c = (node['$attr?']("toc")), $c !== false && $c !== nil ?(node['$attr?']("toc-placement", "auto")) : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
              result['$<<']("<div id=\"toc\" class=\"" + (node.$attr("toc-class", "toc")) + "\">\n<div id=\"toctitle\">" + (node.$attr("toc-title")) + "</div>\n" + (self.$outline(node)) + "\n</div>")};
          };
          result['$<<']("</div>");
        };
...
if (footnote == null) footnote = nil;
        ...
        if ((($a = node.$nofooter()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = node['$attr?']("last-update-label")) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      def.$embedded = function(node) {
        ...
        if ((($a = ($b = (node['$attr?']("toc")), $b !== false && $b !== nil ?["macro", "preamble"]['$include?'](node.$attr("toc-placement"))['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (footnote == null) footnote = nil;
      ...
      def.$outline = function(node, opts) {
        ...
        if ((($a = ((sections = node.$sections()))['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        ...
        if ((($a = (($b = slevel['$=='](0)) ? first_section.$special() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          slevel = 1};
...
if (section == null) section = nil;
      ...
      def.$section = function(node) {
        ...
        slevel = node.$level();
        if ((($a = (($b = slevel['$=='](0)) ? node.$special() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          slevel = 1};
...
if (submenu == null) submenu = nil;
      ...
      def.$append_boolean_attribute = function(name, xml) {
        var self = this;
...
Opal.modules["asciidoctor/document"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_9, TMP_14;
      ...
      def.$initialize = TMP_1 = function(data, options) {
        var $a, $b, $c, TMP_2, TMP_3, $e, $f, TMP_4, $g, TMP_5, $h, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, parent_doc = nil, attr_overrides = nil, initialize_extensions = nil, safe_mode = nil, header_footer = nil, attrs = nil, safe_mode_name = nil, backend_val = nil, doctype_val = nil, now = nil, localdate = nil, localtime = nil, registry = nil, ext_block = nil;
...
if (key == null) key = nil;if (value == null) value = nil;
          if ((($a = key['$start_with?']("!")) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              key = key.$chop();
              value = nil;};
            return attr_overrides['$[]='](key.$downcase(), value);}, TMP_3.$$s = self, TMP_3), $a).call($c);
          self.attribute_overrides = attr_overrides;
...
if (l == null) l = nil;
        ...
        if ($rb_ge(self.safe, (($scope.get('SafeMode')).$$scope.get('SERVER')))) {
          ...
          ($a = "backend", $f = attr_overrides, ((($g = $f['$[]']($a)) !== false && $g !== nil) ? $g : $f['$[]=']($a, $scope.get('DEFAULT_BACKEND'))));
          if ((($a = ($f = parent_doc['$!'](), $f !== false && $f !== nil ?attr_overrides['$key?']("docfile") : $f)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;if (val == null) val = nil;
        verdict = false;
          ...
          return verdict;}, TMP_5.$$s = self, TMP_5), $a).call($f);
        ...
        if (parent_doc !== false && parent_doc !== nil) {
          ...
          ($a = "iconsdir", $g = attrs, ((($h = $g['$[]']($a)) !== false && $h !== nil) ? $h : $g['$[]=']($a, Opal.get('File').$join(attrs.$fetch("imagesdir", "./images"), "icons"))));
...
if (ext == null) ext = nil;
      ...
      def.$register = function(type, value, force) {
...
if (entry == null) entry = nil;
      ...
      def.$update_backend_attributes = function(new_backend, force) {
        ...
        if ((($a = ((($b = force) !== false && $b !== nil) ? $b : ((($c = new_backend !== false && new_backend !== nil) ? new_backend['$=='](self.attributes['$[]']("backend"))['$!']() : $c)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          attrs = self.attributes;
      ...
      def.$update_doctype_attributes = function(new_doctype) {
        ...
        if ((($a = (($b = new_doctype !== false && new_doctype !== nil) ? new_doctype['$=='](self.attributes['$[]']("doctype"))['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          attrs = self.attributes;
          current_doctype = attrs['$[]']("doctype");
          current_backend = attrs['$[]']("backend");
          current_basebackend = attrs['$[]']("basebackend");
...
if (f == null) f = nil;
      ...
      def.$docinfo = function(location, ext) {
        var $a, $b, $c, TMP_15, self = this, qualifier = nil, docinfodir = nil, content = nil, docinfo = nil, docinfo_filename = nil, docinfo_path = nil, docinfosubs = nil, content2 = nil, contentx = nil;
...
if (candidate == null) candidate = nil;
      ...
      def.$resolve_docinfo_subs = function() {
...
Opal.modules["asciidoctor/list"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$content', def.$blocks);
    ...
    (function($base, $super) {
      ...
      def['$simple?'] = function() {
        ...
        return ((($a = self.blocks['$empty?']()) !== false && $a !== nil) ? $a : (($b = (($c = self.blocks.$size()['$=='](1)) ? $scope.get('List')['$===']((blk = self.blocks['$[]'](0))) : $c), $b !== false && $b !== nil ?blk['$outline?']() : $b)));
      };

      def['$compound?'] = function() {
        var self = this;
...
if (l == null) l = nil;
      ...
      Opal.defs(self, '$parse_document_header', function(reader, document) {
        var $a, $b, self = this, block_attributes = nil, assigned_doctitle = nil, val = nil, section_title = nil, source_location = nil, _ = nil, doctitle = nil, single_line = nil, separator = nil;

        block_attributes = self.$parse_block_metadata_lines(reader, document);
        if ((($a = block_attributes['$has_key?']("title")) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        section_title = nil;
        if ((($a = self['$is_next_line_document_title?'](reader, block_attributes)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        if ((($a = ($b = ((val = document.$attributes()['$[]']("doctitle")))['$nil_or_empty?']()['$!'](), $b !== false && $b !== nil ?val['$=='](section_title)['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          (($a = [val]), $b = document, $b['$title='].apply($b, $a), $a[$a.length-1]);
          assigned_doctitle = val;};
        if (assigned_doctitle !== false && assigned_doctitle !== nil) {
      ...
      Opal.defs(self, '$next_section', function(reader, parent, attributes) {
        ...
        part = false;
        intro = false;
        if ((($a = ($b = (($c = parent.$context()['$==']("document")) ? parent.$blocks()['$empty?']() : $c), $b !== false && $b !== nil ?(((($c = ((($d = (has_header = parent['$has_header?']())) !== false && $d !== nil) ? $d : attributes.$delete("invalid-header"))) !== false && $c !== nil) ? $c : self['$is_next_line_section?'](reader, attributes)['$!']())) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          doctype = parent.$doctype();
          if ((($a = ((($b = has_header) !== false && $b !== nil) ? $b : ((($c = doctype['$==']("book")) ? attributes['$[]'](1)['$==']("abstract")['$!']() : $c)))) !== nil && (!$a.$$is_boolean || $a == true))) {
            preamble = intro = $scope.get('Block').$new(parent, "preamble", $hash2(["content_model"], {"content_model": "compound"}));
            if ((($a = (($b = doctype['$==']("book")) ? (parent['$attr?']("preface-title")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = (($b = current_level['$=='](0)) ? doctype['$==']("book") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      Opal.defs(self, '$blockquote?', function(lines, first_line) {
        ...
        return ($a = ($b = (($c = $rb_gt(lines.$size(), 1)) ? ((((($d = first_line) !== false && $d !== nil) ? $d : lines['$[]'](0)))['$start_with?']("\"")) : $c), $b !== false && $b !== nil ?(lines['$[]'](-1)['$start_with?']("-- ")) : $b), $a !== false && $a !== nil ?(lines['$[]'](-2)['$end_with?']("\"")) : $a);
      });
      ...
      Opal.defs(self, '$is_delimited_block?', function(line, return_match_data) {
        ...
        if (line_len['$=='](2)) {
          ...
          if ((($a = $scope.get('Compliance').$markdown_syntax()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if (tip_3['$==']("```")) {
              if ((($a = (($b = tl['$=='](4)) ? tip['$end_with?']("`") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
                return nil};
              tip = tip_3;
              tl = 3;
              fenced_code = true;};};
          if ((($a = (($b = tl['$=='](3)) ? fenced_code['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return nil};
        };
      ...
      Opal.defs(self, '$initialize_section', function(reader, parent, attributes) {
        ...
        if ((($a = attributes['$[]'](1)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if (style !== false && style !== nil) {
            ...
            if ((($a = (($b = section.$sectname()['$==']("abstract")) ? document.$doctype()['$==']("book") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;
      ...
      Opal.defs(self, '$parse_block_metadata_line', function(reader, parent, attributes, options) {
        ...
        } else if ((($a = (($b = commentish !== false && commentish !== nil) ? $scope.get('CommentLineRx')['$=~'](next_line) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        } else if ((($a = (($b = in_square_brackets !== false && in_square_brackets !== nil) ? (match = $scope.get('BlockAttributeListRx').$match(next_line)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defs(self, '$resolve_list_marker', function(list_type, marker, ordinal, validate, reader) {
        ...
        if ((($a = (($b = list_type['$==']("olist")) ? marker['$start_with?'](".")['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (s == null) s = nil;
      ...
      Opal.defs(self, '$next_table', function(table_reader, parent, attributes) {
        var $a, $b, $c, $d, $e, $f, TMP_23, self = this, table = nil, explicit_col_specs = nil, skipped = nil, parser_ctx = nil, loop_idx = nil, line = nil, next_line = nil, next_cell_spec = nil, seen = nil, m = nil, cell_text = nil, even_width = nil;
...
if (c == null) c = nil;
      ...
      Opal.defs(self, '$parse_col_specs', function(records) {
        var $a, $b, TMP_24, $c, TMP_25, self = this, specs = nil;
...
if (record == null) record = nil;
      ...
      Opal.defs(self, '$parse_style_attribute', function(attributes, reader) {
        var $a, $b, $c, TMP_27, TMP_28, $d, TMP_29, self = this, original_style = nil, raw_style = nil, type = nil, collector = nil, parsed = nil, save_current = nil, parsed_style = nil, options = nil, existing_opts = nil;
        ...
        if ((($a = ($b = (($c = raw_style !== false && raw_style !== nil) ? raw_style['$include?'](" ")['$!']() : $c), $b !== false && $b !== nil ?$scope.get('Compliance').$shorthand_property_syntax() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          type = "style";
          collector = [];
          parsed = $hash2([], {});
...
if (option == null) option = nil;
      ...
      Opal.defs(self, '$adjust_indentation!', function(lines, indent, tab_size) {
        var $a, $b, TMP_30, $c, TMP_33, $d, TMP_34, $e, TMP_35, $f, TMP_36, self = this, full_tab_space = nil, gutter_width = nil, padding = nil;
...
if (line == null) line = nil;
    ...
    (function($base, $super) {
      ...
      def.$preprocess_conditional_inclusion = function(directive, target, delimiter, text) {
        ...
        if ((($a = ((($b = (($c = (((($d = directive['$==']("ifdef")) !== false && $d !== nil) ? $d : directive['$==']("ifndef"))), $c !== false && $c !== nil ?target['$empty?']() : $c))) !== false && $b !== nil) ? $b : ((($c = directive['$==']("endif")) ? text : $c)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return false};
...
if (candidate == null) candidate = nil;
        return candidate.$instance()['$handles?'](target)}, TMP_12.$$s = self, TMP_12), $c).call($d)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return true;
        } else if ((($a = (($b = $rb_gt((abs_maxdepth = self.maxdepth['$[]']("abs")), 0)) ? $rb_ge(self.include_stack.$size(), abs_maxdepth) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (f == null) f = nil;
      ...
      def.$resolve_expr_val = function(val) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(parent, level, numbered, opts) {
        ...
        self.numbered = (($a = numbered !== false && numbered !== nil) ? $rb_gt(self.level, 0) : $a);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(parent, attributes) {
        ...
        if ((($a = ((($b = (($c = pcwidth_intval['$=='](0)) ? pcwidth['$==']("0")['$!']() : $c)) !== false && $b !== nil) ? $b : $rb_gt(pcwidth_intval, 100))) !== nil && (!$a.$$is_boolean || $a == true))) {
          pcwidth_intval = 100};
...
if (c == null) c = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_5 = function(table, index, attributes) {
        var $a, $b, $c, self = this, $iter = TMP_5.$$p, $yield = $iter || nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_6 = function(column, text, attributes, cursor) {
        var $a, $b, self = this, $iter = TMP_6.$$p, $yield = $iter || nil, parent_doctitle = nil, inner_document_lines = nil, unprocessed_lines = nil, processed_lines = nil;
        ...
        if ((($a = (($b = self.style['$==']("asciidoc")) ? column.$table()['$header_row?']()['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (p == null) p = nil;
    ...
    (function($base, $super) {
      ...
      def.$close_cell = function(eol) {try {
        ...
        ($a = ($b = (1)).$upto, $a.$$p = (TMP_9 = function(i){var self = TMP_9.$$s || this, $a, $b, $c, TMP_10, $d, $e, column = nil, extra_cols = nil, offset = nil, cell = nil;
  ...
  (function($base) {
    ...
    (function($base) {
      ...
      Opal.defs(self, '$define', function(key, value) {
        ...
        if ((($a = ((($b = key['$==']("keys")) !== false && $b !== nil) ? $b : (self['$respond_to?'](key)))) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$raise(Opal.get('ArgumentError'), "illegal key name: " + (key))};
...
if (key == null) key = nil;
    ...
    (function(self) {
      ...
      self.$$proto.$load = function(input, options) {
...
if (key == null) key = nil;
      ...
      self.$$proto.$convert = function(input, options) {
...
if (f == null) f = nil;
      ...
      self.$$proto.$render = self.$$proto.$convert;
      self.$$proto.$convert_file = function(filename, options) {
        var $a, self = this;
      ...
      return self.$$proto.$render_file = self.$$proto.$convert_file;
    })(self.$singleton_class());
