module.exports=function(C){C=C||require("opal-npm-wrapper").Opal;C.modules["asciidoctor/extensions"]=function(a){function C(c,a){return"number"===typeof c&&"number"===typeof a?c+a:c["$+"](a)}function D(c,a){return"number"===typeof c&&"number"===typeof a?c<a:c["$<"](a)}function H(c,a){return"number"===typeof c&&"number"===typeof a?c-a:c["$-"](a)}a.dynamic_require_severity="ignore";var c=a.nil,I=a.breaker,L=a.slice,r=a.module,p=a.klass,w=a.hash2,J=a.range,M=a.hash;return function(K){(function(B){B=
r(B,"Extensions");var f=B.$$scope;(function(e,$super){function d(){}var b=d=p(e,$super,"Processor",d),g=b.$$scope,z,q,m;b.$$proto.config=c;(function(b){a.defn(b,"$config",function(){var a;null==this.config&&(this.config=c);return!1!==(a=this.config)&&a!==c?a:this.config=w([],{})});a.defn(b,"$option",function(c,a){return this.$config()["$[]="](c,a)});a.defn(b,"$use_dsl",function(){var a;return(a=this.$name()["$nil_or_empty?"]())===c||a.$$is_boolean&&1!=a?(a=this.$constants().$grep("DSL"))===c||a.$$is_boolean&&
1!=a?c:this.$extend(this.$const_get("DSL")):(a=this.$constants().$grep("DSL"))===c||a.$$is_boolean&&1!=a?c:this.$include(this.$const_get("DSL"))});a.alias(b,"extend_dsl","use_dsl");return a.alias(b,"include_dsl","use_dsl")})(a.get_singleton_class(b));b.$attr_reader("config");a.defn(b,"$initialize",function(a){null==a&&(a=w([],{}));return this.config=this.$class().$config().$merge(a)});a.defn(b,"$update_config",function(a){return this.config.$update(a)});a.defn(b,"$process",function(){var c=arguments.length-
0;0>c&&(c=0);for(var b=Array(c),g=0;g<c;g++)b[g]=arguments[g+0];return this.$raise(a.get("NotImplementedError"))});a.defn(b,"$create_block",function(a,c,b,e,d){null==d&&(d=w([],{}));return g.get("Block").$new(a,c,w(["source","attributes"],{source:b,attributes:e}).$merge(d))});a.defn(b,"$create_image_block",function(a,b,g){null==g&&(g=w([],{}));return this.$create_block(a,"image",c,b,g)});a.defn(b,"$create_inline",function(a,c,b,e){null==e&&(e=w([],{}));return g.get("Inline").$new(a,c,b,e)});a.defn(b,
"$parse_content",function(a,b,e){var d,z,q=c,m=c;null==e&&(e=w([],{}));for(q=(d=b["$is_a?"](g.get("Reader")))===c||d.$$is_boolean&&1!=d?g.get("Reader").$new(b):b;(z=q["$has_more_lines?"]())!==c&&(!z.$$is_boolean||1==z);)if(m=g.get("Parser").$next_block(q,a,e),!1!==m&&m!==c)a["$<<"](m);return c});return(z=(q=[["create_paragraph","create_block","paragraph"],["create_open_block","create_block","open"],["create_example_block","create_block","example"],["create_pass_block","create_block","pass"],["create_listing_block",
"create_block","listing"],["create_literal_block","create_block","literal"],["create_anchor","create_inline","anchor"]]).$each,z.$$p=(m=function(b,g,e){var d=m.$$s||this,z,q;null==b&&(b=c);null==g&&(g=c);null==e&&(e=c);return(z=d.$define_method,z.$$p=(q=function(c){var b=q.$$s||this,d;c=L.call(arguments,0);return(d=b).$send.apply(d,[g].concat(a.to_a(c.$dup().$insert(1,e))))},q.$$s=d,q),z).call(d,b)},m.$$s=b,m),z).call(q)})(f.base,null);(function(e){e=r(e,"ProcessorDsl");var f;a.defn(e,"$option",function(a,
c){return this.$config()["$[]="](a,c)});a.defn(e,"$process",f=function(){var e,b=f.$$p||c;null==this.process_block&&(this.process_block=c);var g=arguments.length-0;0>g&&(g=0);for(var z=Array(g),q=0;q<g;q++)z[q]=arguments[q+0];f.$$p=null;return b!==c?this.process_block=b:(e=this.process_block)===c||e.$$is_boolean&&1!=e?this.$raise(a.get("NotImplementedError")):(e=this.process_block).$call.apply(e,a.to_a(z))});a.defn(e,"$process_block_given?",function(){var a;return(a=this.process_block,null!=a&&a!==
c)?"instance-variable":c})})(f.base);(function(e,$super){function d(){}var b=d=p(e,$super,"Preprocessor",d);return(a.defn(b,"$process",function(c,b){return this.$raise(a.get("NotImplementedError"))}),c)&&"process"})(f.base,f.get("Processor"));a.casgn(f.get("Preprocessor"),"DSL",f.get("ProcessorDsl"));(function(e,$super){function d(){}var b=d=p(e,$super,"Treeprocessor",d);return(a.defn(b,"$process",function(c){return this.$raise(a.get("NotImplementedError"))}),c)&&"process"})(f.base,f.get("Processor"));
a.casgn(f.get("Treeprocessor"),"DSL",f.get("ProcessorDsl"));(function(e,$super){function d(){}var b=d=p(e,$super,"Postprocessor",d);return(a.defn(b,"$process",function(c,b){return this.$raise(a.get("NotImplementedError"))}),c)&&"process"})(f.base,f.get("Processor"));a.casgn(f.get("Postprocessor"),"DSL",f.get("ProcessorDsl"));(function(e,$super){function d(){}var b=d=p(e,$super,"IncludeProcessor",d);a.defn(b,"$process",function(c,b,e,d){return this.$raise(a.get("NotImplementedError"))});return(a.defn(b,
...
return(a.defn(b,"$process",function(c){return this.$raise(a.get("NotImplementedError"))}),c)&&"process"})(f.base,f.get("Processor"));(function(c){c=r(c,"DocinfoProcessorDsl");c.$include(c.$$scope.get("ProcessorDsl"));a.defn(c,"$at_location",function(a){return this.$option("location",a)})})(f.base);a.casgn(f.get("DocinfoProcessor"),"DSL",f.get("DocinfoProcessorDsl"));(function(e,$super){function d(){}var b=d=p(e,$super,"BlockProcessor",d),g;b.$$proto.config=c;b.$attr_accessor("name");a.defn(b,"$initialize",
g=function(b,e){var d,f,h,p=c;null==b&&(b=c);null==e&&(e=w([],{}));g.$$p=null;a.find_super_dispatcher(this,"initialize",g,null).apply(this,[e]);this.name=!1!==(d=b)&&d!==c?d:this.config["$[]"]("name");p=this.config["$[]"]("contexts");if(a.get("NilClass")["$==="](p))d="contexts",f=this.config,!1!==(h=f["$[]"](d))&&h!==c?h:f["$[]="](d,["open","paragraph"].$to_set());else if(a.get("Symbol")["$==="](p))this.config["$[]="]("contexts",[this.config["$[]"]("contexts")].$to_set());else this.config["$[]="]("contexts",
...
this,e;null==a&&(a=c);return(e=a["$empty?"]())===c||e.$$is_boolean&&1!=e?(e=k["$const_defined?"](a))===c||e.$$is_boolean&&1!=e?d.$raise("Could not resolve class for name: "+b):k=k.$const_get(a):c},f.$$s=this,f),d).call(e);return k}),c)&&"class_for_name"})(a.get_singleton_class(B))})(r(K,"Asciidoctor").$$scope.base)}(a.base)};("undefined"===typeof AsciidoctorConfiguration||"undefined"===typeof AsciidoctorConfiguration.autoRequireModule||Boolean(AsciidoctorConfiguration.autoRequireModule))&&C.require("asciidoctor/extensions")};
