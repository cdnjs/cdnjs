...
this._key[2*r+1]=o(Math.pow(i,1/3))<<24|this._keyr[r],r++)}},_block:function(t){var e,r,i,n,o=this._h,a=this._key,s=o[0],l=o[1],h=o[2],u=o[3],c=o[4],f=o[5],d=o[6],g=o[7],p=o[8],y=o[9],b=o[10],v=o[11],m=o[12],_=o[13],w=o[14],A=o[15];if("undefined"!=typeof Uint32Array){n=Array(160);for(var j=0;j<32;j++)n[j]=t[j]}else n=t;var k=s,T=l,U=h,S=u,E=c,B=f,I=d,C=g,R=p,O=y,P=b,L=v,M=m,x=_,H=w,G=A;for(e=0;e<80;e++){if(e<16)r=n[2*e],i=n[2*e+1];else{var z=n[2*(e-15)],N=n[2*(e-15)+1],D=(N<<31|z>>>1)^(N<<24|z>>>8)^z>>>7,V=(z<<31|N>>>1)^(z<<24|N>>>8)^(z<<25|N>>>7),q=n[2*(e-2)],X=n[2*(e-2)+1],$=(X<<13|q>>>19)^(q<<3|X>>>29)^q>>>6,F=(q<<13|X>>>19)^(X<<3|q>>>29)^(q<<26|X>>>6),Z=n[2*(e-7)],Y=n[2*(e-7)+1],J=n[2*(e-16)],K=n[2*(e-16)+1];r=D+Z+((i=V+Y)>>>0<V>>>0?1:0),r+=$+((i+=F)>>>0<F>>>0?1:0),r+=J+((i+=K)>>>0<K>>>0?1:0)}n[2*e]=r|=0,n[2*e+1]=i|=0
;var Q=R&P^~R&M,W=O&L^~O&x,tt=k&U^k&E^U&E,et=T&S^T&B^S&B,rt=(T<<4|k>>>28)^(k<<30|T>>>2)^(k<<25|T>>>7),it=(k<<4|T>>>28)^(T<<30|k>>>2)^(T<<25|k>>>7),nt=(O<<18|R>>>14)^(O<<14|R>>>18)^(R<<23|O>>>9),ot=(R<<18|O>>>14)^(R<<14|O>>>18)^(O<<23|R>>>9),at=a[2*e],st=a[2*e+1],lt=G+ot,ht=H+nt+(lt>>>0<G>>>0?1:0);ht+=Q+((lt+=W)>>>0<W>>>0?1:0),ht+=at+((lt+=st)>>>0<st>>>0?1:0);var ut=it+et;H=M,G=x,M=P,x=L,P=R,L=O,R=I+(ht+=r+((lt=lt+i|0)>>>0<i>>>0?1:0))+((O=C+lt|0)>>>0<C>>>0?1:0)|0,I=E,C=B,E=U,B=S,U=k,S=T,k=ht+(rt+tt+(ut>>>0<it>>>0?1:0))+((T=lt+ut|0)>>>0<lt>>>0?1:0)|0}l=o[1]=l+T|0,o[0]=s+k+(l>>>0<T>>>0?1:0)|0,u=o[3]=u+S|0,o[2]=h+U+(u>>>0<S>>>0?1:0)|0,f=o[5]=f+B|0,o[4]=c+E+(f>>>0<B>>>0?1:0)|0,g=o[7]=g+C|0,o[6]=d+I+(g>>>0<C>>>0?1:0)|0,y=o[9]=y+O|0,o[8]=p+R+(y>>>0<O>>>0?1:0)|0,v=o[11]=v+L|0,o[10]=b+P+(v>>>0<L>>>0?1:0)|0,_=o[13]=_+x|0,o[12]=m+M+(_>>>0<x>>>0?1:0)|0,A=o[15]=A+G|0,o[14]=w+H+(A>>>0<G>>>0?1:0)|0}},sjcl.misc.hmac=function(t,e){this._hash=e=e||sjcl.hash.sha256;var r,i=[[],[]],n=e.prototype.blockSize/32
