...
;a.digits=parseInt(o.digits,10)}return new r(a)}},{key:"stringify",value:function(t){if(t instanceof HOTP||t instanceof TOTP)return t.toString();throw new TypeError("Invalid 'HOTP/TOTP' object")}}]),t}(),version="6.2.3";export{HOTP,Secret,TOTP,URI,Utils,version};
