...
this._key[2*r+1]=o(Math.pow(i,1/3))<<24|this._keyr[r],r++)}},_block:function(t){var e,r,i,n,o=this._h,s=this._key,a=o[0],l=o[1],h=o[2],u=o[3],c=o[4],f=o[5],d=o[6],g=o[7],p=o[8],y=o[9],b=o[10],v=o[11],m=o[12],_=o[13],w=o[14],A=o[15];if("undefined"!=typeof Uint32Array){n=Array(160);for(var j=0;j<32;j++)n[j]=t[j]}else n=t;var k=a,T=l,U=h,S=u,E=c,I=f,B=d,R=g,C=p,O=y,P=b,L=v,M=m,x=_,H=w,G=A;for(e=0;e<80;e++){if(e<16)r=n[2*e],i=n[2*e+1];else{var z=n[2*(e-15)],N=n[2*(e-15)+1],D=(N<<31|z>>>1)^(N<<24|z>>>8)^z>>>7,V=(z<<31|N>>>1)^(z<<24|N>>>8)^(z<<25|N>>>7),q=n[2*(e-2)],X=n[2*(e-2)+1],$=(X<<13|q>>>19)^(q<<3|X>>>29)^q>>>6,F=(q<<13|X>>>19)^(X<<3|q>>>29)^(q<<26|X>>>6),Y=n[2*(e-7)],Z=n[2*(e-7)+1],J=n[2*(e-16)],K=n[2*(e-16)+1];r=D+Y+((i=V+Z)>>>0<V>>>0?1:0),r+=$+((i+=F)>>>0<F>>>0?1:0),r+=J+((i+=K)>>>0<K>>>0?1:0)}n[2*e]=r|=0,n[2*e+1]=i|=0
;var Q=C&P^~C&M,W=O&L^~O&x,tt=k&U^k&E^U&E,et=T&S^T&I^S&I,rt=(T<<4|k>>>28)^(k<<30|T>>>2)^(k<<25|T>>>7),it=(k<<4|T>>>28)^(T<<30|k>>>2)^(T<<25|k>>>7),nt=(O<<18|C>>>14)^(O<<14|C>>>18)^(C<<23|O>>>9),ot=(C<<18|O>>>14)^(C<<14|O>>>18)^(O<<23|C>>>9),st=s[2*e],at=s[2*e+1],lt=G+ot,ht=H+nt+(lt>>>0<G>>>0?1:0);ht+=Q+((lt+=W)>>>0<W>>>0?1:0),ht+=st+((lt+=at)>>>0<at>>>0?1:0);var ut=it+et;H=M,G=x,M=P,x=L,P=C,L=O,C=B+(ht+=r+((lt=lt+i|0)>>>0<i>>>0?1:0))+((O=R+lt|0)>>>0<R>>>0?1:0)|0,B=E,R=I,E=U,I=S,U=k,S=T,k=ht+(rt+tt+(ut>>>0<it>>>0?1:0))+((T=lt+ut|0)>>>0<lt>>>0?1:0)|0}l=o[1]=l+T|0,o[0]=a+k+(l>>>0<T>>>0?1:0)|0,u=o[3]=u+S|0,o[2]=h+U+(u>>>0<S>>>0?1:0)|0,f=o[5]=f+I|0,o[4]=c+E+(f>>>0<I>>>0?1:0)|0,g=o[7]=g+R|0,o[6]=d+B+(g>>>0<R>>>0?1:0)|0,y=o[9]=y+O|0,o[8]=p+C+(y>>>0<O>>>0?1:0)|0,v=o[11]=v+L|0,o[10]=b+P+(v>>>0<L>>>0?1:0)|0,_=o[13]=_+x|0,o[12]=m+M+(_>>>0<x>>>0?1:0)|0,A=o[15]=A+G|0,o[14]=w+H+(A>>>0<G>>>0?1:0)|0}},sjcl.misc.hmac=function(t,e){this._hash=e=e||sjcl.hash.sha256;var r,i=[[],[]],n=e.prototype.blockSize/32
...
;s.digits=parseInt(o.digits,10)}return new r(s)}},{key:"stringify",value:function(t){if(t instanceof HOTP||t instanceof TOTP)return t.toString();throw new TypeError("Invalid 'HOTP/TOTP' object")}}]),t}(),version="6.2.3";exports.HOTP=HOTP,exports.Secret=Secret,exports.TOTP=TOTP,exports.URI=URI,exports.Utils=Utils,exports.version=version;
