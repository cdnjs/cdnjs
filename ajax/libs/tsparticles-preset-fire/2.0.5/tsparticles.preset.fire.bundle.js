...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadExternalPushInteraction": function() { return /* binding */ loadExternalPushInteraction; }
});

// EXTERNAL MODULE: ../../engine/dist/esm/index.js + 119 modules
var esm = __webpack_require__(609);
...
class Pusher extends esm.ExternalInteractorBase {
  constructor(container) {
    super(container);
    ...
    this.handleClickMode = mode => {
      ...
      const group = (0,esm.itemFromArray)([undefined, ...pushOptions.groups]);
...
const tsparticles_move_base_1 = __webpack_require__(830);

const tsparticles_shape_circle_1 = __webpack_require__(631);

const tsparticles_updater_color_1 = __webpack_require__(847);

const tsparticles_interaction_external_push_1 = __webpack_require__(913);

const tsparticles_updater_opacity_1 = __webpack_require__(922);

const tsparticles_updater_out_modes_1 = __webpack_require__(52);

const tsparticles_updater_size_1 = __webpack_require__(127);
...
function loadFirePreset(engine) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield engine.addPreset("fire", options_1.options);
  });
}
...
exports.tsParticles = exports.loadFirePreset = void 0;

const _1 = __webpack_require__(153);

Object.defineProperty(exports, "loadFirePreset", ({
  enumerable: true,
  get: function () {
    return _1.loadFirePreset;
  }
}));

const tsparticles_engine_1 = __webpack_require__(609);
...
(0, _1.loadFirePreset)(tsparticles_engine_1.tsParticles);
}();
