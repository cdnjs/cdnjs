...
async function fireworks(idOrOptions, sourceOptions) {
  ...
  const particlesOptions = {
    ...
    emitters: {
      ...
      rate: {
        delay: (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isNumber)(options.rate) ? 1 / options.rate : {
  ...
  const container = await external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.tsParticles.load({
    id,
