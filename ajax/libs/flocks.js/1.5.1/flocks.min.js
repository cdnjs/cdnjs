...
function J(a){return e[a]}function E(a,c){var b;if(!h(a))throw"path must be an array!";if(0===a.length)return c;if(1===a.length)return c[a[0]];if(-1!==["string","number"].indexOf(typeof a[0]))return b=a.splice(1,Number.MAX_VALUE),E(b,c[a[0]])}function t(a){return E(a,e)}function F(a){b(3," - Flocks2 multi-get");if("string"===typeof a)return e[a];if(h(a))return t(a);throw"Flocks2 get/1 key must be a string or an array";}function G(a){console.log("ERROR: stub called!");B(a,"Flocks2 update/1 must take a plain object")}
...
childContextTypes:k,componentWillMount:function(){b(1," - Flocks2 component will mount: "+this.constructor.displayName);b(3,l(this.props.flocks2context)?"   - No F2 Context Prop":"   - F2 Context Prop found");b(3,l(this.context.flocks2context)?"   - No F2 Context":"   - F2 Context found");this.props.flocks2context&&(this.context.flocks2context=this.props.flocks2context);this.fupdate=function(a){return G(a)};this.fget=function(a){return F(a)};this.fgetkey=function(a){return e[a]};this.fgetpath=function(a){return t(a)};
this.fset=function(a,b){return r(a,b)};this.fsetpath=function(a,b){return r(a,b)};this.flock=function(){++n};this.funlock=function(){return H()};this.fctx=this.context.flocks2context},getChildContext:function(){return this.context}};k={version:"1.5.0",createClass:function(a){a.mixins=I(a.mixins);return React.createClass(a)},mount:function(a,c){var g=a||{},e=c||{},f=function(){console.log("ERROR: stub called!");m()},f={override:f,clear:f,get:F,get_key:J,get_path:t,set:r,set_path:D,update:G,lock:K,
