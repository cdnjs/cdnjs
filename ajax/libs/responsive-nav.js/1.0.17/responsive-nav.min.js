/*! responsive-nav.js v1.0.17 by @viljamis, http://responsive-nav.com, MIT license */
var responsiveNav=function(g,h){var u=!!g.getComputedStyle;g.getComputedStyle||(g.getComputedStyle=function(a){this.el=a;this.getPropertyValue=function(b){var c=/(\-([a-z]){1})/g;"float"===b&&(b="styleFloat");c.test(b)&&(b=b.replace(c,function(a,b,c){return c.toUpperCase()}));return a.currentStyle[b]?a.currentStyle[b]:null};return this});var d,f,e,n=h.createElement("style"),p,l=function(a,b,c,d){if("addEventListener"in a)try{a.addEventListener(b,c,d)}catch(e){if("object"===typeof c&&c.handleEvent)a.addEventListener(b,
...
this._init(this)};t.prototype={destroy:function(){this._removeStyles();r(d,"closed");r(d,"opened");d.removeAttribute("style");d.removeAttribute("aria-hidden");s=d=null;k(g,"load",this,!1);k(g,"resize",this,!1);k(h.body,"touchmove",this,!1);k(e,"touchstart",this,!1);k(e,"touchend",this,!1);k(e,"keyup",this,!1);k(e,"click",this,!1);k(e,"mouseup",this,!1);f.customToggle?e.removeAttribute("aria-hidden"):e.parentNode.removeChild(e)},toggle:function(){p?(r(d,"opened"),q(d,"closed"),m(d,{"aria-hidden":"true"}),
f.animate?setTimeout(function(){d.style.position="absolute"},f.transition+10):d.style.position="absolute",p=!1,f.close()):(r(d,"closed"),q(d,"opened"),d.style.position=f.openPos,m(d,{"aria-hidden":"false"}),p=!0,f.open())},handleEvent:function(a){a=a||g.event;switch(a.type){case "touchstart":this._onTouchStart(a);break;case "touchmove":this._onTouchMove(a);break;case "touchend":case "mouseup":this._onTouchEnd(a);break;case "click":this._preventDefault(a);break;case "keyup":this._onKeyUp(a);break;
case "load":this._transitions(a);this._resize(a);break;case "resize":this._resize(a)}},_init:function(){q(d,"closed");p=!1;this._createToggle();l(g,"load",this,!1);l(g,"resize",this,!1);l(h.body,"touchmove",this,!1);l(e,"touchstart",this,!1);l(e,"touchend",this,!1);l(e,"mouseup",this,!1);l(e,"keyup",this,!1);l(e,"click",this,!1)},_createStyles:function(){n.parentNode||h.getElementsByTagName("head")[0].appendChild(n)},_removeStyles:function(){n.parentNode&&n.parentNode.removeChild(n)},_createToggle:function(){if(f.customToggle){var a=
