...
/* harmony export */ });
/* harmony import */ var js_yaml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(272);
/* harmony import */ var _chenyfan_cache_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(385);
/* harmony import */ var _utils_engine_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(671);
    ...
    switch (pathname.split('/')[2]) {
        ...
        case 'info':
            return new Response(JSON.stringify({
                version: _package_json__WEBPACK_IMPORTED_MODULE_3__/* .version */ .i8
            }),{
                headers:{
            ...
            switch (q('type')) {
                case 'config':
                    return fetch('/config.yaml')
                        .then(res => res.text())
                        .then(text => js_yaml__WEBPACK_IMPORTED_MODULE_0__/* ["default"].load */ .ZP.load(text))
                        .then(async config => {
                ...
                case 'hotpatch':
                    ...
                    await _utils_engine_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].parallel */ .Z.parallel(hotpatch)
                    .then(t=>t.text())
                    .then(async script=>{
                ...
                case 'hotconfig':
                    ...
                    const nConfig =  await _utils_engine_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].parallel */ .Z.parallel(hotconfig).then(t=>t.text()).then(t=>js_yaml__WEBPACK_IMPORTED_MODULE_0__/* ["default"].load */ .ZP.load(t)).then(t=>JSON.stringify(t)).catch(t=>{return ''})
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router_cgi);
...
"use strict";
/* harmony import */ var _cgi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(710);
/* harmony import */ var _chenyfan_cache_db__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(385);
...
self.clientworkerhandle = async (request) => {
        ...
        for (let transform_rule of catch_rule.transform_rules) {
            ...
            switch (transform_rule.searchin || "url") {
                ...
                case 'statusText':
                    ...
                    break
                case 'body':
                    if (!tFetched) { _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].w */ .Z.w(`${tReq.url} is not fetched yet,the body rule are ignored`); break }
            ...
            switch (transform_rule.replacein || 'url') {
                case 'url':
                    ...
                    if (typeof transform_rule.replace !== 'undefined' && tSearched) {
                        if (typeof transform_rule.replace === 'string') {
                            ...
                            tReq = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].request */ .Z.request(tReq, { url: tReq.url.replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), transform_rule.replace) })
                            EngineFetch = false
                        } else {
                            ...
                            transform_rule.replace.forEach(replacement => {
                                ...
                                EngineFetchList.push(
                                    _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].request */ .Z.request(tReq, { url: tReq.url.replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), replacement) })
                                )
                            });
                ...
                case 'body':
                    if (tSearched) {
                        if (tFetched) {
                            tRes = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].response */ .Z.response(tRes, { body: (await tRes.clone().text()).replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), transform_rule.replace) })

                        } else {
                            tReq = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].request */ .Z.request(tReq, { body: (await tReq.clone().text()).replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), transform_rule.replace) })
                        }
                    }
                    break;

                case 'status':
                    if (typeof transform_rule.replace === 'string' && tSearched) tRes = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].response */ .Z.response(tRes, { status: tRes.status.replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), transform_rule.replace) })
                    break;
                case 'statusText':
                    if (typeof transform_rule.replace === 'string' && tSearched) tRes = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].response */ .Z.response(tRes, { statusText: tRes.statusText.replace(new RegExp(transform_rule.replacekey || transform_rule.search, transform_rule.replaceflags), transform_rule.replace) })
                    break;
                default:
                    _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].e */ .Z.e(`${tReq.url} the ${transform_rule.replacein} replace rule are not supported`);
            }
                ...
                switch (transform_rule.action) {
                            ...
                            const EngineFetcher = async () => {
                                ...
                                return new Promise(async (resolve, reject) => {
                                    if (!EngineFetch) {
                                        switch (transform_rule.fetch.engine || 'fetch') {
                                            case 'fetch':
                                                ...
                                                break
                                            case 'crazy':
                                                cRes = await _utils_engine_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"].crazy */ .Z.crazy(tReq, fetchConfig)
                                                break
                                            default:
                                                _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].e */ .Z.e(`${tReq.url} the ${transform_rule.fetch.engine} engine are not supported`);
                                                break
                                        }
                                    } else {
                                        switch (transform_rule.fetch.engine || 'parallel') {
                                            ...
                                            case 'KFCThursdayVW50':
                                                if (new Date().getDay() === 4) _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].e */ .Z.e(`VW50! The Best Fetch Engine in the World Said!`)
                                                cRes = await _utils_engine_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"].KFCThursdayVW50 */ .Z.KFCThursdayVW50(EngineFetchList, fetchConfig)
                                                break;
                                            default:
                                    ...
                                    if (typeof transform_rule.fetch.cache === "object" && cRes.status === (transform_rule.fetch.status || 200)) {
                                        cRes = _utils_rebuild_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"].response */ .Z.response(cRes, { headers: { "ClientWorker_ExpireTime": new Date().getTime() + Number(eval(transform_rule.fetch.cache.expire || '0')) } })
                                    ...
                                    cache.match(tReq).then(cRes => {
                                        if (!!cRes) {
                                            if (Number(cRes.headers.get('ClientWorker_ExpireTime')) > new Date().getTime()) {
                                                _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s(`${tReq.url} is fetched from cache`)
                                                res(cRes)
                                                return
                                            } else {
                                                _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].w */ .Z.w(`${tReq.url} is expired.`)
                                                res(Promise.any([
                                                    EngineFetcher(),
                    ...
                    case 'redirect':
                        if (typeof transform_rule.redirect === 'undefined') {
                            _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].e */ .Z.e(`Redirect Config is not defined for ${tReq.url}`);
                            break;
                        }
                    ...
                    case 'script':
                        if (typeof transform_rule.script === 'undefined') {
                            _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].e */ .Z.e(`Script Config is not defined for ${tReq.url}`);
                            break;
                        }
    ...
    if (!tFetched) {
        ...
        if (EngineFetch) {
            tRes = await _utils_engine_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"].parallel */ .Z.parallel(EngineFetchList, fetchConfig || {})
        } else {
...
/* harmony import */ var _rebuild_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(431);
...
const FetchEngine = {
    ...
    crazy: async (req, config) => {
        ...
        const reqtype = Object.prototype.toString.call(req)
        if (reqtype !== '[object String]' && reqtype !== '[object Request]') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.fetch: req must be a string or Request object,but got ${reqtype}`)
            return;
        }
        ...
        if (!AllSize || AllSize < config.threads) {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.crazy: The Origin is not support Crazy Mode,or the size of the file is less than ${config.threads} bytes,downgrade to normal fetch`)
                ...
                chunks.push(
                    new Promise(async (res, rej) => {
                        ...
                        const instance = async () => {
                            trycount += 1
                            const nReq = _rebuild_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"].request */ .Z.request(req, {
                                headers: {
    ...
    KFCThursdayVW50: async (reqs, config) => {
        ...
        if (reqtype === '[object String]' || reqtype === '[object Request]') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].w */ .Z.w(`FetchEngine.KFCThursdayVW50: reqs is a string or Request object,downgrade to crazy`)
            return FetchEngine.crazy(reqs, config)
        } else if (reqtype !== '[object Array]') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.KFCThursdayVW50: reqs must be a string or Request object or an array,but got ${reqtype}`)
            return Promise.reject(`FetchEngine.KFCThursdayVW50: reqs must be a string or Request object or an array,but got ${reqtype}`)
        } else if (reqtype === '[object Array]') {
            if (reqs.length === 0) {
                _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.KFCThursdayVW50: reqs array is empty`)
                reject()
            }
            if (reqs.length === 1) {
                _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].w */ .Z.w(`FetchEngine.KFCThursdayVW50: reqs array is only one,downgrade to crazy`)
        ...
        controller.abort();
        if (!AllSize || AllSize < config.threads) {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.KFCThursdayVW50: The Origin is not support KFCThursdayVW50 Mode,or the size of the file is less than ${config.threads} bytes,downgrade to normal fetch`)
                ...
                chunks.push(
                    new Promise(async (res, rej) => {
                        ...
                        const instance = async () => {
                            ...
                            const nReqs = []
                            reqs.forEach(req => {
                                nReqs.push(_rebuild_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"].request */ .Z.request(req, {
                                    headers: {
                                        Range: `bytes=${i * chunkSize}-${(i + 1) * chunkSize - 1}`
                                    },
                                    url: req.url
                            ...
                            return FetchEngine.parallel(nReqs, {
                                ...
                                .then(res => res.arrayBuffer())
                                .catch(async err => {
                                    _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.KFCThursdayVW50: ${await err.text()}`)
                                    if (trycount >= config.trylimit) {
                                        reject()
                                        return;
                                    }
    ...
    classic: async (reqs, config) => {
        return new Promise((resolve, reject) => {
            ...
            if (reqtype === '[object String]' || reqtype === '[object Request]') {
                ...
                _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.classic: reqs must be a string , Request or Array object,but got ${reqtype}`)
                reject()
            } else if (reqtype === '[object Array]') {
                if (reqtype.length === 0) {
                    _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.classic: reqs array is empty`)
                    reject()
                }
                if (reqtype.length === 1) {
    ...
    parallel: async (reqs, config) => {
        return new Promise((resolve, reject) => {
            ...
            if (reqtype === '[object String]' || reqtype === '[object Request]') {
                ...
                _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.parallel: reqs must be a string , Request or Array object,but got ${reqtype}`)
                reject()
            } else if (reqtype === '[object Array]') {
                if (reqtype.length === 0) {
                    _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`FetchEngine.parallel: reqs array is empty`)
                    reject()
                }
                if (reqtype.length === 1) {
            ...
            Promise.any(reqs.map(async req => {
                ...
                fetch(req, {
                    ...
                    if (res.status == (config.status || 200)) {
                        ...
                        resolve(_rebuild_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"].response */ .Z.response(res,{}))
                    }
                }).catch(err => {
                    if (err == 'DOMException: The user aborted a request.') console.log()//To disable the warning:DOMException: The user aborted a request.
                })
...
const rebuild = {
    request:(req, init) => {
        ...
        if (req.mode === 'navigate') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].w */ .Z.w(`You can't rebuild a POST method with body when it is a navigate request.ClientWorker will ignore it's body`)
        }
    ...
    response:(res, init) => {
        if(res.type === 'opaque') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`You can't rebuild a opaque response.ClientWorker will ignore this build`)
            return res
        }
...
"use strict";
module.exports = JSON.parse('{"i8":"2.7.0-beta-1"}');
...
/* harmony import */ var _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(70);
/* harmony import */ var _chenyfan_cache_db__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(385);





_utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s(`ClientWorker${_package_json__WEBPACK_IMPORTED_MODULE_1__/* .version */ .i8} Started!`)
const db = new _chenyfan_cache_db__WEBPACK_IMPORTED_MODULE_3__()
db.read('hotpatch').then(script => {
    if (!!script) {
        _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s('Hotpatch Loaded!')
        eval(script)
    } else {
        _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].w */ .Z.w('Hotpatch Not Found!')
    }
})
db.read('config').then(config => {
    config = JSON.parse(config) || {}
    setInterval(() => {
        _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s(`ClientWorker@${_package_json__WEBPACK_IMPORTED_MODULE_1__/* .version */ .i8} Start to Clean Expired Cache!`)
        caches.open("ClientWorker_ResponseCache").then(cache => {
...
addEventListener('install', function () {
    _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s(`ClientWorker@${_package_json__WEBPACK_IMPORTED_MODULE_1__/* .version */ .i8} Installed!`)
    self.skipWaiting();
});
addEventListener('activate', function () {
    _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].s */ .Z.s(`ClientWorker@${_package_json__WEBPACK_IMPORTED_MODULE_1__/* .version */ .i8} Activated!`)
    self.clients.claim();
})
