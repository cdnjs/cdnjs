...
mota.isArrayLike = function ( obj ) {
  ...
  var type = mota.type( obj ), length;

  if ( type === "array" ) {
    return true;
  }

  if ( type !== "object" || mota.isWindow( obj ) ) {
    return false;
  }
...
mota.isPlainObject = function ( obj ) {
  ...
  if ( !obj || typeof obj !== "object" || toString.call( obj ) !== "[object Object]" || mota.has( obj , "constructor" ) ) {
    return false;
  }
  ...
  return mota.isFunction( ctor ) && ctor instanceof ctor;
...
motaViewMap.prototype = {
  ...
  getNewIndex: function(){
    ...
    for ( i in this.deletedIdx ) {
      delete this.deletedIdx[ i ];
      break;
    }

    return i === false ? this.list.length : i - 0;

  },
  removeIndex: function ( i ) {

    this.deletedIdx[ i ] = null;
  ...
  add: function ( component ) {
    ...
    var el = component.el, i;

    if ( this.get( el ) ) {
      return true;
    }

    i = component.mapIndex = this.getNewIndex();
  ...
  remove: function ( component ) {
    ...
    var el = component.el, i = this.removeIndex( component.mapIndex );
...
var motaViewComponent = mota.view.Component = function ( el ) {
  this.setEl( el );
};
