...
MotaViewUpdater.prototype = {
  ...
  flushUpdates: function() {
    ...
    this.dirtyComponents.resetAndTraverse( iteratee );
  ...
  error: function( msg ) {
    ...
    err( "mota.view.Component.update", msg );
  }
...
var setStyle = function( style, _key, _value ) {
...
var traverse = function(
  ...
  for ( ; i < len ; i++ ) {
    ...
    if ( !placeholder.type ) {
      updater.error( "Please provide a valid placeholder." );
    }
...
var updateComponent = function(
  component, action, owner, currElInIdx, renderToString, depth
) {
...
var parse = function( url, parseQuery ) {
  ...
  this.pathname = ( match[ 5 ] || "" ).replace( _rhash, function( h ) {
...
var forEach = function( obj, func, context ) {
  ...
  var iteratorFn, iterator, iteratee;

  if ( !obj || typeof obj !== "object" ) {
    return;
  }

  iteratee = createIteratee( func, context );

  if ( isArray( obj ) || isArrayLike( obj ) ) {
    return forEachArrayLike( obj, iteratee );
  }
  ...
  return forEachObj( obj, iteratee );
...
var isMap = MotaMap.isMap = function( obj ) {
  return !!( obj && obj[ MAP_SENTINEL ] );
};
var makeMap = function( mutable, size, root ) {
...
var MotaMapProto = extend( MotaMap.prototype, events, {
...
var EMPTY_MAP = MotaMap.EMPTY_MAP = makeMap( false );
...
defineProp( mota, "VERSION", "0.9.2", true );
