...
function pendingElemInsertionsMovesIteratee( compInternal ) {
  ...
  var el = compInternal.el;
  var parent = compInternal.parentInternal;
  var parentNode = parent.el;
  var previous = parent.array[ compInternal.index - 1 ];
...
function elOpen( type, _key, props, isConst ) {
  ...
  if ( currCompInternal && currCompInternal.key === key ) {
    if ( parent.didSomeMove ) {
      updaterQueueElemMove( currCompInternal );
    }
