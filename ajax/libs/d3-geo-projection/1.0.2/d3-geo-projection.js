...
(function (global, factory) {
  ...
  function quincuncialRaw(project) {
    var dx = project(halfPi, 0)[0] - project(-halfPi, 0)[0];
  ...
  function gringortenQuincuncial() {
    return d3Geo.geoProjection(quincuncialRaw(gringortenRaw))
        .scale(176.423)
        .rotate([-90, -90, 45])
        .clipAngle(180 - 1e-3);
  }
  ...
  function interruptedHomolosine() {
  ...
  function interruptedMollweideHemispheres() {
  ...
  function interruptedSinuMollweide() {
...
var   miller$1 = [[0.9245, 0], [0, 0], [0.01943, 0]];
  ...
  exports.geoGringortenQuincuncial = gringortenQuincuncial;
  ...
  exports.geoInterruptedBoggs = interruptedBoggs;
  exports.geoInterruptedHomolosine = interruptedHomolosine;
  exports.geoInterruptedMollweide = interruptedMollweide;
  exports.geoInterruptedMollweideHemispheres = interruptedMollweideHemispheres;
  exports.geoInterruptedSinuMollweide = interruptedSinuMollweide;
  exports.geoInterruptedSinusoidal = interruptedSinusoidal;
