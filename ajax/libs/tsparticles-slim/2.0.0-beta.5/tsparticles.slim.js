...
function loadSlim(engine) {
  return dist_awaiter(this, void 0, void 0, function* () {
    ...
    yield (0,external_commonjs_tsparticles_move_parallax_commonjs2_tsparticles_move_parallax_amd_tsparticles_move_parallax_root_window_.loadParallaxMover)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_attract_commonjs2_tsparticles_interaction_external_attract_amd_tsparticles_interaction_external_attract_root_window_.loadExternalAttractInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_bounce_commonjs2_tsparticles_interaction_external_bounce_amd_tsparticles_interaction_external_bounce_root_window_.loadExternalBounceInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_bubble_commonjs2_tsparticles_interaction_external_bubble_amd_tsparticles_interaction_external_bubble_root_window_.loadExternalBubbleInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_connect_commonjs2_tsparticles_interaction_external_connect_amd_tsparticles_interaction_external_connect_root_window_.loadExternalConnectInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_grab_commonjs2_tsparticles_interaction_external_grab_amd_tsparticles_interaction_external_grab_root_window_.loadExternalGrabInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_pause_commonjs2_tsparticles_interaction_external_pause_amd_tsparticles_interaction_external_pause_root_window_.loadExternalPauseInteraction)(engine);
    ...
    yield (0,external_commonjs_tsparticles_interaction_external_remove_commonjs2_tsparticles_interaction_external_remove_amd_tsparticles_interaction_external_remove_root_window_.loadExternalRemoveInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_external_repulse_commonjs2_tsparticles_interaction_external_repulse_amd_tsparticles_interaction_external_repulse_root_window_.loadExternalRepulseInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_particles_attract_commonjs2_tsparticles_interaction_particles_attract_amd_tsparticles_interaction_particles_attract_root_window_.loadParticlesAttractInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_particles_collisions_commonjs2_tsparticles_interaction_particles_collisions_amd_tsparticles_interaction_particles_collisions_root_window_.loadParticlesCollisionsInteraction)(engine);
    yield (0,external_commonjs_tsparticles_interaction_particles_links_commonjs2_tsparticles_interaction_particles_links_amd_tsparticles_interaction_particles_links_root_window_.loadParticlesLinksInteraction)(engine);
    ...
    yield (0,external_commonjs_tsparticles_shape_image_commonjs2_tsparticles_shape_image_amd_tsparticles_shape_image_root_window_.loadImageShape)(engine);
    ...
    yield (0,external_commonjs_tsparticles_shape_polygon_commonjs2_tsparticles_shape_polygon_amd_tsparticles_shape_polygon_root_window_.loadPolygonShape)(engine);
    yield (0,external_commonjs_tsparticles_shape_square_commonjs2_tsparticles_shape_square_amd_tsparticles_shape_square_root_window_.loadSquareShape)(engine);
    yield (0,external_commonjs_tsparticles_shape_star_commonjs2_tsparticles_shape_star_amd_tsparticles_shape_star_root_window_.loadStarShape)(engine);
    yield (0,external_commonjs_tsparticles_shape_text_commonjs2_tsparticles_shape_text_amd_tsparticles_shape_text_root_window_.loadTextShape)(engine);
