...
var external_commonjs_tsparticles_interaction_external_bounce_commonjs2_tsparticles_interaction_external_bounce_amd_tsparticles_interaction_external_bounce_root_window_ = __webpack_require__(428);
...
async function loadSlim(engine) {
  ...
  await (0,external_commonjs_tsparticles_move_parallax_commonjs2_tsparticles_move_parallax_amd_tsparticles_move_parallax_root_window_.loadParallaxMover)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_attract_commonjs2_tsparticles_interaction_external_attract_amd_tsparticles_interaction_external_attract_root_window_.loadExternalAttractInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_bounce_commonjs2_tsparticles_interaction_external_bounce_amd_tsparticles_interaction_external_bounce_root_window_.loadExternalBounceInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_bubble_commonjs2_tsparticles_interaction_external_bubble_amd_tsparticles_interaction_external_bubble_root_window_.loadExternalBubbleInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_connect_commonjs2_tsparticles_interaction_external_connect_amd_tsparticles_interaction_external_connect_root_window_.loadExternalConnectInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_grab_commonjs2_tsparticles_interaction_external_grab_amd_tsparticles_interaction_external_grab_root_window_.loadExternalGrabInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_pause_commonjs2_tsparticles_interaction_external_pause_amd_tsparticles_interaction_external_pause_root_window_.loadExternalPauseInteraction)(engine);
  ...
  await (0,external_commonjs_tsparticles_interaction_external_remove_commonjs2_tsparticles_interaction_external_remove_amd_tsparticles_interaction_external_remove_root_window_.loadExternalRemoveInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_repulse_commonjs2_tsparticles_interaction_external_repulse_amd_tsparticles_interaction_external_repulse_root_window_.loadExternalRepulseInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_external_slow_commonjs2_tsparticles_interaction_external_slow_amd_tsparticles_interaction_external_slow_root_window_.loadExternalSlowInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_particles_attract_commonjs2_tsparticles_interaction_particles_attract_amd_tsparticles_interaction_particles_attract_root_window_.loadParticlesAttractInteraction)(engine);
  await (0,external_commonjs_tsparticles_interaction_particles_collisions_commonjs2_tsparticles_interaction_particles_collisions_amd_tsparticles_interaction_particles_collisions_root_window_.loadParticlesCollisionsInteraction)(engine);
  ...
  await (0,external_commonjs_tsparticles_particles_js_commonjs2_tsparticles_particles_js_amd_tsparticles_particles_js_root_window_.initPjs)(engine);
}
})();
