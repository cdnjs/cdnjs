...
})(window, function (t, e, n, r, o, a, i, c) {
    return (function (t) {
        var e = {};
        function n(r) {
        ...
        function (t, e, n) {
            ...
            function h(t, e) {
                if (t) {
                    ...
                    var n = s.a.initializeSerializer()(t.node());
                    return (
                        (n = (function (t) {
        ...
        function (t, e, n) {
            ...
            n.r(e),
                ...
                n.d(e, 'barLoadingMarkup', function () {
                    return o;
                }),
                n.d(e, 'donutLoadingMarkup', function () {
                    return a;
                }),
                n.d(e, 'lineLoadingMarkup', function () {
                    return i;
                }),
                n.d(e, 'stackedAreaLoadingMarkup', function () {
                    return c;
                }),
                n.d(e, 'sparkLineLoadingMarkup', function () {
                    return l;
                }),
                n.d(e, 'brushLoadingMarkup', function () {
                    return s;
                });
            var r =
            ...
            e.default = {
                linearGradient: r,
                barLoadingMarkup: o,
                donutLoadingMarkup: a,
                lineLoadingMarkup: i,
                brushLoadingMarkup: s,
                sparkLineLoadingMarkup: l,
                stackedAreaLoadingMarkup: c,
            };
        },
        function (t, e, n) {
            var r = n(12);
        ...
        function (t, e, n) {
            ...
            function t() {
                    ...
                    s.each(function (s) {
                        ...
                        (function (t) {
                            w ||
                                ...
                                (function () {
                                    ...
                                    w
                                        .append('g')
                                        .classed('loading-state-group', !0),
                                        t
                                            .append('g')
                                            .classed('grid-lines-group', !0),
                                        t
                                            .append('g')
                                        ...
                                        t
                                            .append('g')
                                            .classed('metadata-group', !0);
                                })());
                            w.attr('viewBox', [0, 0, L, E])
                                .attr(
                                    'style',
                        ...
                        S)
                            ? w
                                  ...
                                  .html(h.barLoadingMarkup)
                            : (w.select('.loading-state-group svg').remove(),
                              (r = Object(d.scaleBand)()
                                  .domain(t.map(I))
                                  .rangeRound([0, e])
                                  .paddingInner(0)),
                              (o = Object(d.scaleLinear)()
                                  .domain([0, Object(c.max)(t, j)])
                                  .rangeRound([n, 0])),
                              (a = Object(l.axisBottom)(r)),
                              (C = Object(l.axisLeft)(o)
                                  .ticks(k)
                                  .tickPadding(8)
                                  .tickFormat(R)),
                              (function () {
                                  A &&
                                      w
                                          ...
                                          .remove();
                                  O && w.selectAll('.extended-x-line').remove();
                                  (A = w
                                  ...
                                  w
                                      ...
                                      y &&
                                          ...
                                          (b = w
                                              ...
                                              .attr('x', e / 2)
                                              .text(y)));
                                  w.select('.y-axis-group.axis').call(C),
                                      m &&
                                          (v &&
                                              w
                                                  .selectAll(
                ...
                return (
                    (G.exportChart = function (t) {
                        return g.a.call(G, w, t);
                    }),
                    (G.margin = function (t) {
                    ...
                    (G.xAxisLabel = function (t) {
                        return arguments.length ? ((y = t), this) : y;
                    }),
                    (G.xAxisLabelOffset = function (t) {
                        return arguments.length ? ((P = t), this) : P;
                    }),
                    (G.yAxisLabel = function (t) {
                        return arguments.length ? ((m = t), this) : m;
                    }),
                    (G.yAxisLabelOffset = function (t) {
