!(function (t, e) {
    'object' == typeof exports && 'object' == typeof module
        ...
        : ((t.britecharts = t.britecharts || {}),
          (t.britecharts.groupedBar = e(
              t['d3-time'],
              t['d3-shape'],
              t['d3-selection'],
              t['d3-format'],
...
})(window, function (t, e, n, r, o, a, i, c, u, l, s, f, d) {
    return (function (t) {
        var e = {};
        function n(r) {
        ...
        function (t, e, n) {
            ...
            var r = n(1),
                ...
                u = { duration: 1200 },
                l = {
                    linear: r.curveLinear,
                    basis: r.curveBasis,
                    cardinal: r.curveCardinal,
                    catmullRom: r.curveCatmullRom,
                    monotoneX: r.curveMonotoneX,
                    monotoneY: r.curveMonotoneY,
                    natural: r.curveNatural,
                    step: r.curveStep,
                    stepAfter: r.curveStepAfter,
                    stepBefore: r.curveStepBefore,
                },
                s = [{ quantity: 1, percentage: 100 }],
                f = {
                    timeMillisecond: o.timeMillisecond,
                    utcMillisecond: o.utcMillisecond,
                    timeSecond: o.timeSecond,
                    utcSecond: o.utcSecond,
                    timeMinute: o.timeMinute,
                    utcMinute: o.utcMinute,
                    timeHour: o.timeHour,
                    utcHour: o.utcHour,
                    timeDay: o.timeDay,
                    utcDay: o.utcDay,
                    timeWeek: o.timeWeek,
                    utcWeek: o.utcWeek,
                    timeSunday: o.timeSunday,
                    utcSunday: o.utcSunday,
                    timeMonday: o.timeMonday,
                    utcMonday: o.utcMonday,
                    timeTuesday: o.timeTuesday,
                    utcTuesday: o.utcTuesday,
                    timeWednesday: o.timeWednesday,
                    utcWednesday: o.utcWednesday,
                    timeThursday: o.timeThursday,
                    utcThursday: o.utcThursday,
                    timeFriday: o.timeFriday,
                    utcFriday: o.utcFriday,
                    timeSaturday: o.timeSaturday,
                    utcSaturday: o.utcSaturday,
                    timeMonth: o.timeMonth,
                    utcMonth: o.utcMonth,
                    timeYear: o.timeYear,
                    utcYear: o.utcYear,
                };
        ...
        function (t, e, n) {
            'use strict';
            n.r(e),
                n.d(e, 'colorGradients', function () {
                    return r;
                }),
                n.d(e, 'colorGradientsHuman', function () {
                    return o;
                }),
                n.d(e, 'britecharts', function () {
                    return a;
                }),
                n.d(e, 'grey', function () {
                    return i;
                ...
                n.d(e, 'colorSchemas', function () {
                    return g;
                }),
                n.d(e, 'colorSchemasHuman', function () {
                    return m;
                }),
                n.d(e, 'aloeGreen', function () {
                    return y;
                }),
                n.d(e, 'greenColor', function () {
                    return b;
                }),
                n.d(e, 'blueColor', function () {
                    return x;
                }),
                n.d(e, 'yellowColor', function () {
                    return v;
                }),
                n.d(e, 'orangeColor', function () {
                    return O;
                });
            var r = {
        ...
        function (t, e, n) {
            ...
            var r = function (t) {
                console.warn(
                    'This method is being deprecated! Please modify your data to use "'.concat(
                        t,
                        '" as the key.'
                    )
                );
        ...
        function (t, e, n) {
            ...
            var p = {
                ...
                get styleBackgroundString() {
                    return '<style>svg{background:'.concat(
            ...
            function g(t, e) {
                if (t) {
                    ...
                    var n = l.a.initializeSerializer()(t.node());
                    return (
                        (n = (function (t) {
                        ...
                        (n = (function (t) {
                            return t.replace(
                                '>',
                                '>'.concat(p.styleBackgroundString)
                            );
                        })(
                            (n = O.call(
                                this,
            ...
            function y(t, e) {
                ...
                if (e) {
                    if ('function' != typeof e)
                        throw new Error(
                            'The callback provided should be a function, we got a '.concat(
                                o()(e),
                                ' instead.'
                            )
                        );
                ...
                return (
                    (n.src = ''.concat(p.imageSourceBase).concat(
                        d(
            ...
            function O(t, e, n) {
                if (!e || !n) return t;
                var r = c.colorSchemas.grey;
                return (t = t.replace(
                    /<g/,
                    '<text x="'
                        .concat(this.margin().left, '" y="')
                        .concat(p.titleTopOffset, '" font-family="')
                        .concat(p.titleFontFamily, '" font-size="')
                        .concat(p.titleFontSize, '" fill="')
                        .concat(r[6], '"> ')
                        .concat(e, ' </text><g ')
                ));
            }
        ...
        function (t, e, n) {
            (function (t, r) {
                ...
                /*! http://mths.be/base64 v0.1.0 by @mathias | MIT license */ !(function (
                    ...
                    var i = e,
                        c = (t && t.exports, 'object' == typeof r && r);
                    c.global !== c && c.window;
                    var u = function (t) {
                        this.message = t;
                    };
                    ...
                    var l = function (t) {
                        ...
                        d = {
                            ...
                            decode: function (t) {
                                ...
                                e % 4 == 0 &&
                                    (e = (t = t.replace(/==?$/, '')).length),
                                    (e % 4 == 1 || /[^+a-zA-Z0-9/]/.test(t)) &&
                                        l(
                                            'Invalid character: the string to be decoded is not correctly encoded.'
                                        );
                                for (var n, r, o = 0, a = '', i = -1; ++i < e; )
                                    (r = s.indexOf(t.charAt(i))),
                                        (n = o % 4 ? 64 * n + r : r),
                                        o++ % 4 &&
                            ...
                            function (e) {
                                ...
                                if (e && e.nodeType === Node.ELEMENT_NODE)
                                    return (
                                        ...
                                        (c = e.outerHTML),
                                        (o = [].map.call(o, function (t, e) {
                                            return (t.style.cssText = u[e]), t;
                                        })),
                                        c
                                    );
                            }
        ...
        function (t, e, n) {
            ...
            n.r(e),
                ...
                n.d(e, 'donut', function () {
                    return a;
                }),
                n.d(e, 'line', function () {
                    return i;
                }),
                n.d(e, 'stackedArea', function () {
                    return c;
                });
            var r =
        ...
        function (t, e, n) {
            ...
            var r = n(9),
                o = n.n(r),
                a = n(3),
                i = ['decimal', 'thousands', 'grouping', 'currency'],
                c = function (t) {
                    if (u(t)) return a.formatDefaultLocale(t);
                    throw new Error(
        ...
        function (t, e, n) {
            ...
            function t() {
                var t,
                    ...
                    F,
                    P,
                    _ = { top: 40, right: 30, bottom: 60, left: 70 },
                    I = 960,
                    N = 500,
                    H = A.bar,
                    q = { y: -8, x: -20 },
                    G = 5,
                    U = 5,
                    Y = O.default.colorSchemas.britecharts,
                    z = null,
                    W = null,
                    V = h,
                    K = g.easeQuadInOut,
                            ...
                            (T = I - _.left - _.right),
                                ...
                                (function () {
                                    var n =
                                        ...
                                        1 === o.size && o.has(0)
                                            ? 1
                                            : Object(l.max)(k.map(lt)));
                                    var o;
                                    Q
                                        ? ((t = Object(y.scaleLinear)()
                                              .domain([0, n])
                                              .rangeRound([0, T - 1])),
                                          (r = Object(y.scaleBand)()
                                              .domain(k.map(ut))
                                              .rangeRound([j, 0])
                                              .padding(ct)),
                                          (a = Object(y.scaleBand)()
                                              .domain(k.map(st))
                                              .rangeRound([r.bandwidth(), 0])
                                              .padding(it)))
                                        : ((t = Object(y.scaleBand)()
                                              .domain(k.map(ut))
                                              .rangeRound([0, T])
                                              .padding(ct)),
                                          (e = Object(y.scaleBand)()
                                              .domain(k.map(st))
                                              .rangeRound([0, t.bandwidth()])
                                              .padding(ct)),
                                          (r = Object(y.scaleLinear)()
                                              .domain([0, n])
                                              .rangeRound([j, 0])
                                              .nice()));
                                    (M = Object(y.scaleOrdinal)()
                                        .range(Y)
                                        .domain(k.map(st))),
                                        (z =
                                            z ||
                                ...
                                (function (t) {
                                    ...
                                    E.attr('width', I).attr('height', N);
                                })(this),
                                (function () {
                                    var e = Q ? t : r;
                                    E.select('.grid-lines-group')
                                        .selectAll('line')
                                        .remove(),
                                        ('horizontal' === et ||
                                            'full' === et) &&
                                ...
                                (function (e) {
                                    Q
                                        ? ((n = Object(s.axisBottom)(t).ticks(
                                              U,
                                              e.format(at)
                                          )),
                                          (c = Object(s.axisLeft)(r)))
                                        : ((n = Object(s.axisBottom)(t)),
                                          (c = Object(s.axisLeft)(r).ticks(
                                              G,
                                              e.format(at)
                                          )));
                                })(V),
                                ...
                                (function () {
                                    D && E.selectAll('.layer').remove();
                                    var n = E.select('.chart-group').selectAll(
                                        '.layer'
                                    );
                                    (P = Object(l.range)(
                                        20,
                                ...
                                (function () {
                                    ...
                                    E.selectAll('.bar')
                                        .on('mouseover', function (t) {
                                            !(function (t, e) {
                                                Object(b.select)(t).attr(
                                                    'fill',
                                                    function () {
                                                        return Object(f.color)(
                                                            z[e.group]
                                                        ).darker();
                                                    }
                                                );
                ...
                function ht(t) {
                    t.selectAll('.tick text').attr(
                        'transform',
                        'translate('.concat(q.x, ', ').concat(q.y, ')')
                    );
                }
                function gt(t) {
                    return Object(b.mouse)(t);
                }
                function mt(n) {
                    var r = n - _.left,
                        o = e.bandwidth(),
                    ...
                    return (
                        S.forEach(function (n) {
                            var i = n.values.find(function (n) {
                                return (
                                    Math.abs(r >= t(n[nt]) + e(n[ot])) &&
                                    Math.abs(r - e(n[ot]) - t(n[nt]) <= o)
                                );
                            });
                            i &&
                                ((i.values = n.values),
                ...
                function yt(t) {
                    ...
                    return (
                        S.map(function (t) {
                            var a = t.values.find(function (t) {
                                return (
                                    Math.abs(e >= r(t[nt])) &&
                                    Math.abs(e - r(t[nt]) <= 2 * n)
                                );
                            });
                            a &&
                                ((a.values = t.values),
                ...
                function bt(e) {
                    var n = Object(b.select)(this),
                        r = Object(m.interpolateRound)(0, t(lt(e))),
                        o = Object(m.interpolateNumber)(0, 1);
                    return function (t) {
                        n.attr('width', r(t)).style('opacity', o(t));
                    };
                }
                function xt(t) {
                    var e = Object(b.select)(this),
                        n = Object(m.interpolateRound)(0, j - r(lt(t))),
                        o = Object(m.interpolateRound)(j, r(lt(t))),
                        a = Object(m.interpolateNumber)(0, 1);
                    return function (t) {
                        e.attr('y', o(t))
                            .attr('height', n(t))
                            .style('opacity', a(t));
                ...
                return (
                    (pt.animationDuration = function (t) {
                        return arguments.length ? ((tt = t), this) : tt;
                    }),
                    (pt.betweenBarsPadding = function (t) {
                        return arguments.length ? ((it = t), this) : it;
                    }),
                    (pt.betweenGroupsPadding = function (t) {
                        return arguments.length ? ((ct = t), this) : ct;
                    }),
                    (pt.colorMap = function (t) {
                        return arguments.length ? ((z = t), this) : z;
                    }),
                    (pt.colorSchema = function (t) {
                        return arguments.length ? ((Y = t), this) : Y;
                    }),
                    (pt.exportChart = function (t, e) {
                        return x.a.call(pt, E, t, e);
                    }),
                    (pt.groupLabel = function (t) {
                        return arguments.length
                            ? ((ot = t), Object(v.a)('group'), this)
                            : ot;
                    }),
                    (pt.grid = function (t) {
                        return arguments.length ? ((et = t), this) : et;
                    }),
                    (pt.height = function (t) {
                        return arguments.length ? ((N = t), this) : N;
                    }),
                    (pt.isHorizontal = function (t) {
                        return arguments.length ? ((Q = t), this) : Q;
                    }),
                    (pt.isAnimated = function (t) {
                        return arguments.length ? ((ft = t), this) : ft;
                    }),
                    (pt.loadingState = function (t) {
                        return arguments.length ? ((H = t), this) : H;
                    }),
                    (pt.margin = function (t) {
                        return arguments.length
                            ? ((_ = o()({}, _, t)), this)
                            : _;
                    }),
                    (pt.nameLabel = function (t) {
                        return arguments.length
                            ? ((nt = t), Object(v.a)('name'), this)
                            : nt;
                    }),
                    (pt.numberFormat = function (t) {
                        return arguments.length ? ((at = t), this) : at;
                    }),
                    (pt.on = function () {
                        var t = dt.on.apply(dt, arguments);
                        return t === dt ? pt : t;
                    }),
                    (pt.tooltipThreshold = function (t) {
                        return arguments.length ? ((X = t), this) : X;
                    }),
                    (pt.valueLabel = function (t) {
                        return arguments.length
                            ? ((rt = t), Object(v.a)('value'), this)
                            : rt;
                    }),
                    (pt.valueLocale = function (t) {
                        return arguments.length ? ((W = t), this) : W;
                    }),
                    (pt.width = function (t) {
                        return arguments.length ? ((I = t), this) : I;
                    }),
                    (pt.xTicks = function (t) {
                        return arguments.length ? ((U = t), this) : U;
                    }),
                    (pt.yAxisLabel = function (t) {
                        return arguments.length ? ((L = t), this) : L;
                    }),
                    (pt.yAxisLabelOffset = function (t) {
                        return arguments.length ? (($ = t), this) : $;
                    }),
                    (pt.yTicks = function (t) {
                        return arguments.length ? ((G = t), this) : G;
                    }),
                    (pt.yTickTextOffset = function (t) {
                        return arguments.length ? ((q = t), this) : q;
                    }),
                    pt
                );
...
//# sourceMappingURL=groupedBar.min.js.map
