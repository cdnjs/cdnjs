!(function (e, t) {
    'object' == typeof exports && 'object' == typeof module
        ...
        : ((e.britecharts = e.britecharts || {}),
          (e.britecharts.bullet = t(
              e['d3-selection'],
              e['d3-format'],
              e['d3-scale'],
              e['d3-axis'],
    ...
    return (function (e) {
        ...
        function (e, t, r) {
            'use strict';
            r.r(t),
                r.d(t, 'colorGradients', function () {
                    return n;
                }),
                r.d(t, 'colorGradientsHuman', function () {
                    return o;
                }),
                r.d(t, 'britecharts', function () {
                    return a;
                }),
                r.d(t, 'grey', function () {
                    return c;
                ...
                r.d(t, 'colorSchemas', function () {
                    return g;
                }),
                r.d(t, 'colorSchemasHuman', function () {
                    return b;
                }),
                r.d(t, 'aloeGreen', function () {
                    return m;
                }),
                r.d(t, 'greenColor', function () {
                    return x;
                }),
                r.d(t, 'blueColor', function () {
                    return y;
                }),
                r.d(t, 'yellowColor', function () {
                    return v;
                }),
                r.d(t, 'orangeColor', function () {
                    return A;
                });
            var n = {
        ...
        function (e, t, r) {
            ...
            function g(e, t) {
                if (e) {
                    e.attr('version', 1.1).attr(
                        'xmlns',
                        'http://www.w3.org/2000/svg'
                    );
                    var r = l.a.initializeSerializer()(e.node());
                    return (
                        (r = (function (e) {
            ...
            function m(e, t) {
                ...
                return (
                    (r.src = ''.concat(p.imageSourceBase).concat(
                        d(
        ...
        function (e, t, r) {
            (function (e, n) {
                ...
                /*! http://mths.be/base64 v0.1.0 by @mathias | MIT license */ !(function (
                    ...
                    var c = t,
                        i = (e && e.exports, 'object' == typeof n && n);
                    i.global !== i && i.window;
                    var u = function (e) {
                        this.message = e;
                    };
                    ...
                    var l = function (e) {
                        ...
                        d = {
                            ...
                            decode: function (e) {
                                ...
                                for (var r, n, o = 0, a = '', c = -1; ++c < t; )
                                    (n = f.indexOf(e.charAt(c))),
                                        (r = o % 4 ? 64 * r + n : n),
                                        o++ % 4 &&
                            ...
                            function (t) {
                                ...
                                if (t && t.nodeType === Node.ELEMENT_NODE)
                                    return (
                                        ...
                                        (i = t.outerHTML),
                                        (o = [].map.call(o, function (e, t) {
                                            return (e.style.cssText = u[t]), e;
                                        })),
                                        i
                                    );
                            }
        ...
        function (e, t, r) {
            ...
            function e() {
                var e,
                    ...
                    P,
                    B,
                    R = { top: 20, right: 20, bottom: 30, left: 20 },
                    I = 960,
                    D = 150,
                    F = h.default.colorSchemas.britecharts,
                    _ = '',
                    k = 6,
                    L = 5,
                    j = 0.5,
                ...
                function Y(o) {
                    o.each(function (o) {
                        (e = I - R.left - R.right), (t = D - R.top - R.bottom);
                        var p,
                            h,
                            Y =
                                ((p = o),
                                {
                                    ranges: u()(p.ranges).sort().reverse(),
                                    measures: u()(p.measures).sort().reverse(),
                                    markers: p.markers.length
                                        ? u()(p.markers).sort().reverse()
                                        : [],
                                    subtitle: p.subtitle,
                                    title: p.title,
                                });
                        (T = Y.title),
                            ...
                            (function () {
                                ...
                                (r = Object(s.scaleLinear)()
                                    ...
                                    (l = o(0)),
                                    (y = function (e) {
                                        return Math.abs(o(e) - l);
                                    }),
                                    (n = G.map(function (e, t) {
                                        return j - 0.2 * t;
                                    }).reverse()),
                                    (a = G.map(function (e, t) {
                                        return 0.9 - 0.3 * t;
                                    }).reverse());
                                var o, l;
                                var f = F,
                            ...
                            (function (e) {
                                ...
                                B.attr('width', I).attr('height', D);
                            })(this),
                            (x = Object(l.axisBottom)(r)
                                .ticks(k)
                                .tickPadding(5)
                                .tickFormat(Object(f.format)(_))),
                            (function () {
                                E && E.remove();
                                O && O.remove();
                                C && C.remove();
                                (E = B.select('.chart-group')
                                    ...
                                    .attr('class', function (e, t) {
                                        return 'range r'.concat(t);
                                    })
                                    .attr('width', y)
                                    .attr('height', t)
                                    .attr('x', N ? r : 0)),
                                    (O = B.select('.chart-group')
                                        .selectAll('rect.measure')
                                        .data(U)
                                        .enter()
                                        .append('rect')
                                        .attr('fill', g)
                                        .attr('fill-opacity', function (e, t) {
                                            return a[t];
                                        })
                                        .attr('class', function (e, t) {
                                            return 'measure m'.concat(t);
                                        })
                                        .attr('width', y)
                                        .attr('height', z)
                                        .attr('x', N ? r : 0)
                            ...
                            q() &&
                                (v && v.remove(),
                                (v = B.select('.metadata-group')
                                    .append('g')
                                    .classed('legend-group', !0)
                                    .attr(
                                        'transform',
                                        'translate(0, '.concat(t / 2, ')')
                                    )),
                                w && (T = w),
                                A && A.remove(),
                                (A = v
                ...
                return (
                    (Y.colorSchema = function (e) {
                        return arguments.length ? ((F = e), this) : F;
                    }),
                    (Y.customTitle = function (e) {
                        return arguments.length ? ((w = e), this) : w;
                    }),
                    (Y.customSubtitle = function (e) {
                        return arguments.length ? ((P = e), this) : P;
                    }),
                    (Y.exportChart = function (e, t) {
                        return p.a.call(Y, B, e, t);
                    }),
                    (Y.height = function (e) {
                        return arguments.length ? ((D = e), this) : D;
                    }),
                    (Y.isReverse = function (e) {
                    ...
                    (Y.numberFormat = function (e) {
                        return arguments.length ? ((_ = e), this) : _;
                    }),
                    (Y.paddingBetweenAxisAndChart = function (e) {
                        return arguments.length ? ((L = e), this) : L;
                    }),
                    (Y.startMaxRangeOpacity = function (e) {
