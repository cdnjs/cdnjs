        ...
        function (t, e, n) {
            ...
            function t() {
                var t,
                    ...
                    R,
                    F,
                    P = { top: 40, right: 30, bottom: 60, left: 70 },
                    _ = 960,
                    I = 500,
                    N = C.bar,
                    H = 0.1,
                    ...
                    Y = 5,
                    z = 1,
                    W = A.default.colorSchemas.britecharts,
                    V = null,
                    K = g.easeQuadInOut,
                    Q = !1,
                    X = !1,
                        ...
                        o.each(function (o) {
                            ...
                            (E = _ - P.left - P.right),
                                ...
                                (function () {
                                    ...
                                    var r;
                                    Q
                                        ? ((t = Object(m.scaleLinear)()
                                              .domain([0, e])
                                              .rangeRound([0, E - 1])),
                                          (n = Object(m.scaleBand)()
                                              .domain(k.map(ct))
                                              .rangeRound([T, 0])
                                              .padding(H)))
                                        : ((t = Object(m.scaleBand)()
                                              .domain(k.map(ct))
                                              .rangeRound([0, E])
                                              .padding(H)),
                                          (n = Object(m.scaleLinear)()
                                              .domain([0, e])
                                              .rangeRound([T, 0])
                                              .nice()));
                                    (a = Object(m.scaleOrdinal)()
                                        .range(W)
                                        .domain(k.map(ut))),
                                        (V =
                                            V ||
                                ...
                                (function (t) {
                                    ...
                                    M.attr('width', _).attr('height', I);
                                })(this),
                                (function () {
                                    var e = Q ? t : n;
                                    M.select('.grid-lines-group')
                                        .selectAll('line')
                                        .remove(),
                                        ('horizontal' === nt ||
                                            'full' === nt) &&
                                ...
                                (function (o) {
                                    Q
                                        ? ((e = Object(s.axisBottom)(t).ticks(
                                              Y,
                                              o.format(it)
                                          )),
                                          (r = Object(s.axisLeft)(n)))
                                        : ((e = Object(s.axisBottom)(t)),
                                          (r = Object(s.axisLeft)(n).ticks(
                                              U,
                                              o.format(it)
                                          )));
                                })(G),
                                ...
                                (function () {
                                    B && M.selectAll('.layer').remove();
                                    var e = M.select('.chart-group').selectAll(
                                        '.layer'
                                    );
                                    (F = Object(l.range)(
                                        20,
                ...
                function pt(t) {
                    t.selectAll('.tick text').attr(
                        'transform',
                        'translate('.concat(-20, ', ').concat(-8, ')')
                    );
                }
                function ht(t) {
                    return t.map(function (t) {
                        for (var e = 0; e < t.length; e++) t[e] = lt(t[e]);
                        return t;
                    });
                }
                function gt(t) {
                    return Object(x.mouse)(t);
                }
                function yt(e) {
                    var n = e - P.left;
                ...
                function bt() {
                    var t = this;
                    Object(x.select)(this).attr('fill', function () {
                        return Object(f.color)(
                            Object(x.select)(t.parentNode).attr('fill')
                        ).darker();
                    });
                }
                function xt() {
                    var t = this;
                    Object(x.select)(this).attr('fill', function () {
                        return Object(x.select)(t.parentNode).attr('fill');
                    });
                }
                function vt(e) {
                    var n = Object(x.select)(this),
                        r = Object(y.interpolateRound)(0, t(e[1] - e[0])),
                        o = Object(y.interpolateNumber)(0, 1);
                    return function (t) {
                ...
                function Ot(t) {
                    var e = n(t[0]) - n(t[1]),
                        r = Object(x.select)(this),
                        o = Object(y.interpolateRound)(0, lt(e)),
                        a = Object(y.interpolateNumber)(0, 1);
                    return function (t) {
                        r.attr('height', o(t)).style('opacity', a(t));
                    };
                }
                return (
                    (dt.animationDuration = function (t) {
                        return arguments.length ? ((et = t), this) : et;
                    }),
                    (dt.betweenBarsPadding = function (t) {
                        return arguments.length ? ((H = t), this) : H;
                    }),
                    (dt.colorMap = function (t) {
                        return arguments.length ? ((V = t), this) : V;
                    }),
                    (dt.colorSchema = function (t) {
                        return arguments.length ? ((W = t), this) : W;
                    }),
                    (dt.exportChart = function (t, e) {
                        return v.a.call(dt, M, t, e);
                    }),
                    (dt.grid = function (t) {
                    ...
                    (dt.valueLabel = function (t) {
                        return arguments.length
                            ? ((ot = t), Object(O.a)('value'), this)
                            : ot;
                    }),
                    (dt.valueLocale = function (t) {
                        return arguments.length ? ((q = t), this) : q;
                    }),
                    (dt.width = function (t) {
