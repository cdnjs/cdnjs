    ...
    return function module() {
        ...
        */
        ...
        function drawVerticalGridLines() {
            maskGridLines = svg.select('.grid-lines-group').selectAll('line.vertical-grid-line').data(yScale.ticks(xTicks)).enter().append('line').attr('class', 'vertical-grid-line').attr('y1', xAxisPadding.left).attr('y2', chartHeight).attr('x1', function (d) {
                return xScale(d);
            }).attr('x2', function (d) {
                return xScale(d);
            });
        ...
        function buildScales() {
            var _ref2 = [d3Array.min(dataPoints, function (_ref3) {
                var x = _ref3.x;
                return x;
            }), d3Array.min(dataPoints, function (_ref4) {
                var y = _ref4.y;
                return y;
            })],
                minX = _ref2[0],
                minY = _ref2[1];
            var _ref5 = [d3Array.max(dataPoints, function (_ref6) {
                var x = _ref6.x;
                return x;
            }), d3Array.max(dataPoints, function (_ref7) {
                var y = _ref7.y;
                return y;
            })],
                maxX = _ref5[0],
        ...
        */
        function drawDataPoints() {
            var circles = svg.select('.chart-group').selectAll('circle').data(dataPoints).enter();

            if (isAnimated) {
                circles.append('circle').on('click', function (d) {
                    handleClick(this, d, chartWidth, chartHeight);
                }).transition().delay(delay).duration(duration).ease(ease).attr('class', 'point').attr('class', 'data-point-highlighter').style('stroke', function (d) {
