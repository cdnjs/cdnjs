...
!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
    ...
    return function module() {
        ...
        */
        function buildAxis() {
            xAxis = d3Axis.axisBottom(xScale).ticks(xTicks).tickPadding(tickPadding);

            yAxis = d3Axis.axisLeft(yScale).ticks(yTicks).tickPadding(tickPadding);
        }
        ...
        */
        function drawDataPoints() {
            ...
            if (isAnimated) {
                ...
                }).transition().delay(delay).duration(duration).ease(ease).attr('class', 'point').attr('r', function (d) {
