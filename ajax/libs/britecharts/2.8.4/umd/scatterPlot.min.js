    ...
    return function module() {
        ...
        */
        function drawDataPoints() {
            ...
            if (isAnimated) {
                circles.append('circle').attr('class', 'data-point data-point-highlighter').on('click', function (d) {
                    handleClick(this, d, chartWidth, chartHeight);
                }).transition().delay(delay).duration(duration).ease(ease).style('stroke', function (d) {
                ...
                circles.append('circle').on('click', function (d) {
                    handleClick(this, d, chartWidth, chartHeight);
                }).attr('class', 'point').attr('class', 'data-point-highlighter').style('stroke', function (d) {
                    return nameColorMap[d.name];
                }).attr('fill', function (d) {
                    return hasHollowCircles ? hollowColor : nameColorMap[d.name];
                }).attr('fill-opacity', circleOpacity).attr('r', function (d) {
