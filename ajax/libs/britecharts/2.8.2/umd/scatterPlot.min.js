    ...
    return function module() {
        ...
        */
        function drawDataPointsValueHighlights(data) {
            ...
            highlightContainer = svg.select('.chart-group').append('g').classed('data-point-value-highlight', true);

            // the crosshair labels needs to be placed outside of
            // chart group, hence, metadata-group is used
            highlightCrossHairContainer = svg.select('.metadata-group').append('g').attr('class', 'crosshair-labels');

            // Draw line perpendicular to y-axis
            highlightContainer.selectAll('line.highlight-y-line').data([data]).enter().append('line').attr('stroke', function (_ref9) {
                var name = _ref9.name;
                return nameColorMap[name];
            }).attr('class', 'highlight-y-line').attr('x1', function (d) {
                return xScale(d.x) - areaScale(d.y);
            }).attr('x2', 0).attr('y1', function (d) {
                return yScale(d.y);
            }).attr('y2', function (d) {
                return yScale(d.y);
            });
            ...
            highlightContainer.selectAll('line.highlight-x-line').data([data]).enter().append('line').attr('stroke', function (_ref10) {
                var name = _ref10.name;
                return nameColorMap[name];
            }).attr('class', 'highlight-x-line').attr('x1', function (d) {
                return xScale(d.x);
            }).attr('x2', function (d) {
                return xScale(d.x);
            }).attr('y1', function (d) {
                return yScale(d.y) + areaScale(d.y);
            }).attr('y2', chartHeight);

            // Draw data label for y value
            highlightCrossHairContainer.selectAll('text.highlight-y-legend').data([data]).enter().append('text').attr('text-anchor', 'middle').attr('fill', function (_ref11) {
            ...
            highlightCrossHairContainer.selectAll('text.highlight-x-legend').data([data]).enter().append('text').attr('text-anchor', 'middle').attr('fill', function (_ref12) {
