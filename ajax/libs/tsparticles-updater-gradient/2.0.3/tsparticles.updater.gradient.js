  ...
  init(particle) {
    ...
    if (gradient) {
      ...
      for (const grColor of gradient.colors) {
        const grHslColor = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToHsl)(grColor.value, particle.id, reduceDuplicates);
