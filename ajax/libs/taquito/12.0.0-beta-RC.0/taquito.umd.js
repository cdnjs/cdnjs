(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const protocols = {
        ...
        '012': [exports.Protocols.PsiThaCa],
        '013': [exports.Protocols.Psithaca2],
    ...
    class Operation {
        ...
        constructor(hash, raw, results, context) {
            ...
            if (utils.validateOperation(this.hash) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidOperationHashError(`Invalid Operation Hash: ${this.hash}`);
            }
            this.confirmed$
    ...
    class OperationBatch extends OperationEmitter {
        ...
        withTransfer(params) {
            if (utils.validateAddress(params.to) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidAddressError(`Invalid 'to' address: ${params.to}`);
            }
        ...
        withDelegation(params) {
            if (params.source && utils.validateAddress(params.source) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidAddressError(`Invalid source address: ${params.source}`);
            }
            if (params.delegate && utils.validateAddress(params.delegate) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidAddressError(`Invalid delegate address: ${params.delegate}`);
            }
        ...
        withActivation({ pkh, secret }) {
            if (utils.validateKeyHash(pkh) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidKeyHashError(`Invalid Key Hash: ${pkh}`);
            }
    ...
    class WalletOperation {
        ...
        constructor(opHash, context, _newHead$) {
            ...
            if (utils.validateOperation(this.opHash) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidOperationHashError(`Invalid operation hash: ${this.opHash}`);
            }
            this.confirmed$
    ...
    class RpcTzProvider extends OperationEmitter {
        ...
        activate(pkh, secret) {
            return __awaiter(this, void 0, void 0, function* () {
                if (utils.validateKeyHash(pkh) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidKeyHashError(`Invalid Public Key Hash: ${pkh}`);
                }
                const operation = {
        ...
        transfer(_a) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                if (utils.validateAddress(rest.to) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidAddressError(`Invalid 'to' address: ${rest.to}`);
                }
                if (rest.source && utils.validateAddress(rest.source) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidAddressError(`Invalid 'source' address: ${rest.source}`);
                }
        ...
        setDelegate(_a) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (rest.delegate && utils.validateAddress(rest.delegate) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidAddressError(`Invalid delegate address: ${rest.delegate}`);
                }
                const pkh = (yield this.getKeys()).publicKeyHash;
    ...
    class Wallet {
        ...
        setDelegate(params) {
            if (params.delegate && utils.validateAddress(params.delegate) !== utils.ValidationResult.VALID) {
                throw new utils.InvalidAddressError(`Invalid address error: ${params.delegate}`);
            }
            return this.walletCommand(() => __awaiter(this, void 0, void 0, function* () {
    ...
    class ContractView {
        ...
        read(chainId) {
            return __awaiter(this, void 0, void 0, function* () {
                if (utils.validateContractAddress(chainId) == utils.ValidationResult.VALID) {
    ...
    class RpcContractProvider extends OperationEmitter {
        ...
        getStorage(contract, schema) {
            return __awaiter(this, void 0, void 0, function* () {
                if (utils.validateContractAddress(contract) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidContractAddressError(`Invalid contract address: ${contract}`);
                }
        ...
        transfer(params) {
            return __awaiter(this, void 0, void 0, function* () {
                if (utils.validateAddress(params.to) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidAddressError(`Invalid address passed in 'to' parameter: ${params.to}`);
                }
                if (params.source && utils.validateAddress(params.source) !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidAddressError(`Invalid address passed in 'source' parameter: ${params.source}`);
                }
