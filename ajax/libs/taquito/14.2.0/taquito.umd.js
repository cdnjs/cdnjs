(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const protocols = {
        ...
        '015': [exports.Protocols.ProtoALpha],
    };
    ...
    class OnChainView {
        ...
        executeView(executionContext) {
            return __awaiter(this, void 0, void 0, function* () {
                const protocol = (yield this._rpc.getProtocols()).protocol;
                // TODO: remove if/else when support for Jakartanet is removed
                if (protocol === exports.Protocols.PtJakart2) {
        ...
        executeViewAndDecodeResult(viewScript, protocol) {
            return __awaiter(this, void 0, void 0, function* () {
                // TODO: remove if/else when support for Jakartanet is removed
                if (protocol === exports.Protocols.PtJakart2) {
                    let storage;
                    try {
                        storage = (yield this._rpc.runCode(viewScript))
                            .storage;
                    }
                    catch (error) {
