(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var createRegisterGlobalConstantOperation = function (_a) {
        var value = _a.value, source = _a.source, fee = _a.fee, gasLimit = _a.gasLimit, storageLimit = _a.storageLimit;
        return __awaiter(void 0, void 0, void 0, function () {
    ...
    var OperationBatch = /** @class */ (function (_super) {
        ...
        OperationBatch.prototype.withRegisterGlobalConstant = function (params) {
            this.operations.push(__assign({ kind: rpc.OpKind.REGISTER_GLOBAL_CONSTANT }, params));
            return this;
        };
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            switch (_a) {
                                ...
                                case rpc.OpKind.REGISTER_GLOBAL_CONSTANT: return [3 /*break*/, 6];
                            }
                            return [3 /*break*/, 7];
                        ...
                        case 6: return [2 /*return*/, createRegisterGlobalConstantOperation(__assign({}, param))];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            _c.apply(_b, [_d.sent()]);
                            return [2 /*return*/, rxjs.concat.apply(void 0, __spread(observableSequence))];
                    }
                });
            });
        };
    ...
    var RPCEstimateProvider = /** @class */ (function (_super) {
        ...
        RPCEstimateProvider.prototype.batch = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var pkh, operations, protocolConstants, DEFAULT_PARAMS, params_1, params_1_1, param, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, e_1_1, isRevealNeeded, _l, estimateProperties;
                var e_1, _m;
                    ...
                    switch (_o.label) {
                        ...
                        case 5:
                            ...
                            switch (_a) {
                                ...
                                case rpc.OpKind.REGISTER_GLOBAL_CONSTANT: return [3 /*break*/, 14];
                            }
                            return [3 /*break*/, 16];
                        case 6:
                        ...
                        case 9: return [4 /*yield*/, _f.apply(void 0, [_o.sent()])];
                        case 10:
                            _e.apply(_d, [_o.sent()]);
                            return [3 /*break*/, 17];
                        case 11:
                        ...
                        case 13:
                            ...
                            return [3 /*break*/, 17];
                        case 14:
                            _k = (_j = operations).push;
                            return [4 /*yield*/, createRegisterGlobalConstantOperation(__assign(__assign({}, param), mergeLimits(param, DEFAULT_PARAMS)))];
                        case 15:
                            _k.apply(_j, [_o.sent()]);
                            return [3 /*break*/, 17];
                        case 16: throw new Error("Unsupported operation kind: " + param.kind);
                        case 17:
                        ...
                        case 20:
                            try {
                                if (params_1_1 && !params_1_1.done && (_m = params_1.return)) _m.call(params_1);
                            }
                            finally { if (e_1) throw e_1.error; }
                            return [7 /*endfinally*/];
                        case 21: return [4 /*yield*/, this.isRevealOpNeeded(operations, pkh)];
                        case 22:
                            isRevealNeeded = _o.sent();
                            if (!isRevealNeeded) return [3 /*break*/, 24];
         ...
         * @param params registerGlobalConstant operation parameter
         */
        RPCEstimateProvider.prototype.registerGlobalConstant = function (_a) {
            var fee = _a.fee, storageLimit = _a.storageLimit, gasLimit = _a.gasLimit, rest = __rest(_a, ["fee", "storageLimit", "gasLimit"]);
            return __awaiter(this, void 0, void 0, function () {
                var pkh, protocolConstants, DEFAULT_PARAMS, op, isRevealNeeded, ops, _b, estimateProperties;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 3:
                            DEFAULT_PARAMS = _c.sent();
                            return [4 /*yield*/, createRegisterGlobalConstantOperation(__assign(__assign({}, rest), mergeLimits({ fee: fee, storageLimit: storageLimit, gasLimit: gasLimit }, DEFAULT_PARAMS)))];
                        case 4:
                            op = _c.sent();
                            return [4 /*yield*/, this.isRevealOpNeeded([op], pkh)];
                        case 5:
     ...
     */
    var RegisterGlobalConstantOperation = /** @class */ (function (_super) {
        __extends(RegisterGlobalConstantOperation, _super);
        function RegisterGlobalConstantOperation(hash, params, source, raw, results, context) {
            var _this = _super.call(this, hash, raw, results, context) || this;
            _this.params = params;
            _this.source = source;
            _this.globalConstantHash = _this.operationResults && _this.operationResults.global_address;
            return _this;
        }
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "operationResults", {
            get: function () {
                var registerGlobalConstantOp = Array.isArray(this.results) &&
                    this.results.find(function (op) { return op.kind === 'register_global_constant'; });
                var result = registerGlobalConstantOp && registerGlobalConstantOp.metadata && registerGlobalConstantOp.metadata.operation_result;
                return result ? result : undefined;
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "status", {
            get: function () {
                var operationResults = this.operationResults;
                if (operationResults) {
                    return operationResults.status;
        ...
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "registeredExpression", {
            get: function () {
        ...
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "fee", {
            get: function () {
                return this.params.fee;
            },
            enumerable: false,
        ...
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "gasLimit", {
            get: function () {
                return this.params.gas_limit;
            },
            enumerable: false,
        ...
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "storageLimit", {
            get: function () {
                return this.params.storage_limit;
            },
            enumerable: false,
        ...
        Object.defineProperty(RegisterGlobalConstantOperation.prototype, "errors", {
            get: function () {
                return this.operationResults && this.operationResults.errors;
            },
            enumerable: false,
        ...
        return RegisterGlobalConstantOperation;
    }(Operation));
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, rpc.getNormalizedScript(address)];
                        case 1:
                            script = _a.sent();
    ...
    var RpcContractProvider = /** @class */ (function (_super) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.rpc.getNormalizedScript(contract)];
                        case 1:
                            schema = _a.sent();
                            _a.label = 2;
                        case 2:
         ...
         * @param params registerGlobalConstant operation parameter
         */
        RpcContractProvider.prototype.registerGlobalConstant = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var publickKeyHash, estimate, operation, ops, prepared, opBytes, _a, hash, context, forgedBytes, opResponse;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.signer.publicKeyHash()];
                        case 1:
                            publickKeyHash = _b.sent();
                            return [4 /*yield*/, this.estimate(params, this.estimator.registerGlobalConstant.bind(this.estimator))];
                        case 2:
                            estimate = _b.sent();
                            return [4 /*yield*/, createRegisterGlobalConstantOperation(__assign(__assign({}, params), estimate))];
                        case 3:
                            operation = _b.sent();
                            return [4 /*yield*/, this.addRevealOperationIfNeeded(operation, publickKeyHash)];
                        case 4:
                        ...
                        case 7:
                            _a = _b.sent(), hash = _a.hash, context = _a.context, forgedBytes = _a.forgedBytes, opResponse = _a.opResponse;
                            return [2 /*return*/, new RegisterGlobalConstantOperation(hash, operation, publickKeyHash, forgedBytes, opResponse, context)];
                    }
                });
            });
        };
    ...
    /* tslint:disable */
    var VERSION = {
        "commitHash": "dad0486b4fbb5c5f3c6ee1a95f0896167b71bff9",
