...
import { validateAddress, ValidationResult, encodeExpr } from '@taquito/utils';
...
var ViewSimulationError = /** @class */ (function () {
    function ViewSimulationError(details, originalError) {
        this.originalError = originalError;
        this.name = 'ViewSimulationError';
        this.message = details;
        if (originalError instanceof HttpResponseError) {
            var failedWith = extractFailedWithDetails(originalError);
...
var extractFailedWithDetails = function (error) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new ViewSimulationError('Failed to execute the contract view.', error_1);
                    case 3:
                        if (!storage.args) {
                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (Object.keys(globalconstantsHashAndValue).length !== 0) {
                            p = new Parser({ expandGlobalConstant: globalconstantsHashAndValue });
                            storageTypeNoGlobalConst = p.parseJSON(storageType.args[0]);
                            schemaNoGlobalConst = new Schema(storageTypeNoGlobalConst);
