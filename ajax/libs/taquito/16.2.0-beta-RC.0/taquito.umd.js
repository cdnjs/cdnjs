        ...
        read(chainId) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (utils.validateContractAddress(chainId !== null && chainId !== void 0 ? chainId : '') == utils.ValidationResult.VALID) {
                    ...
                    throw new core.InvalidChainIdError(chainId, utils.invalidErrorDetail(chainIdValidation));
                }
    ...
    class RPCEstimateProvider extends Provider {
        ...
        transfer(_a) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (toValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(rest.to, utils.invalidErrorDetail(toValidation));
                }
                ...
                if (rest.source && srouceValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(rest.source, utils.invalidErrorDetail(srouceValidation));
                }
        ...
        transferTicket(_a) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (destinationValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(rest.destination, utils.invalidErrorDetail(destinationValidation));
                }
                ...
                if (rest.source && sourceValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(rest.source, utils.invalidErrorDetail(sourceValidation));
                }
                const protocolConstants = yield this.context.readProvider.getProtocolConstants('head');
        ...
        setDelegate(_a) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (rest.delegate && delegateValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(rest.delegate, utils.invalidErrorDetail(delegateValidation));
                }
    ...
    class OperationBatch extends Provider {
        ...
        withDelegation(params) {
            ...
            if (params.source && sourceValidation !== utils.ValidationResult.VALID) {
                throw new core.InvalidAddressError(params.source, utils.invalidErrorDetail(sourceValidation));
            }
            const delegateValidation = utils.validateAddress((_a = params.delegate) !== null && _a !== void 0 ? _a : '');
            if (params.delegate && delegateValidation !== utils.ValidationResult.VALID) {
                throw new core.InvalidAddressError(params.delegate, utils.invalidErrorDetail(delegateValidation));
        ...
        withActivation({ pkh, secret }) {
            ...
            if (pkhValidation !== utils.ValidationResult.VALID) {
                throw new core.InvalidKeyHashError(pkh, utils.invalidErrorDetail(pkhValidation));
            }
    ...
    class RpcTzProvider extends Provider {
        ...
        activate(pkh, secret) {
            return __awaiter(this, void 0, void 0, function* () {
                const pkhValidation = utils.validateKeyHash(pkh);
                if (pkhValidation !== utils.ValidationResult.VALID) {
                    throw new utils.InvalidKeyHashError(pkh, utils.invalidErrorDetail(pkhValidation));
                }
    ...
    class RpcContractProvider extends Provider {
        ...
        getStorage(contract, schema) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (contractValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidContractAddressError(contract, utils.invalidErrorDetail(contractValidation));
                }
        ...
        transferTicket(params) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const srouceValidation = utils.validateAddress((_a = params.source) !== null && _a !== void 0 ? _a : '');
                if (params.source && srouceValidation !== utils.ValidationResult.VALID) {
                    throw new core.InvalidAddressError(params.source, utils.invalidErrorDetail(srouceValidation));
                }
                const publicKeyHash = yield this.signer.publicKeyHash();
