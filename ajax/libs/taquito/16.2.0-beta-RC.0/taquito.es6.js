...
import { format, validateOperation, ValidationResult, InvalidOperationKindError, validateAddress, invalidErrorDetail, validateContractAddress, validateChain, DeprecationError as DeprecationError$1, validateKeyHash, InvalidKeyHashError as InvalidKeyHashError$1, encodeExpr } from '@taquito/utils';
import BigNumber, { BigNumber as BigNumber$1 } from 'bignumber.js';
import { InvalidOperationHashError, InvalidAddressError, InvalidOperationKindError as InvalidOperationKindError$1, InvalidContractAddressError, InvalidViewParameterError, DeprecationError, InvalidChainIdError, InvalidKeyHashError } from '@taquito/core';
            ...
            switch (op.kind) {
                ...
                case OpKind.TRANSACTION: {
                    ...
                    if (cops.source.toLowerCase().startsWith('kt1')) {
                        throw new DeprecationError$1(`KT1 addresses are not supported as source since ${Protocols.PsBabyM1}`);
                    }
                    return cops;
                }
                case OpKind.REVEAL:
...
class RpcTzProvider extends Provider {
    ...
    activate(pkh, secret) {
        return __awaiter(this, void 0, void 0, function* () {
            const pkhValidation = validateKeyHash(pkh);
            if (pkhValidation !== ValidationResult.VALID) {
                throw new InvalidKeyHashError$1(pkh, invalidErrorDetail(pkhValidation));
            }
...
class RpcContractProvider extends Provider {
    ...
    transferTicket(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const srouceValidation = validateAddress((_a = params.source) !== null && _a !== void 0 ? _a : '');
