(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('rxjs'), require('rxjs/operators'), require('@taquito/michelson-encoder'), require('bignumber.js'), require('@taquito/utils'), require('@taquito/http-utils'), require('@taquito/michel-codec')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', 'rxjs', 'rxjs/operators', '@taquito/michelson-encoder', 'bignumber.js', '@taquito/utils', '@taquito/http-utils', '@taquito/michel-codec'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.taquito = {}, global.rpc, global.rxjs, global.operators, global.michelsonEncoder, global.BigNumber, global.utils, global.httpUtils, global.michelCodec));
})(this, (function (exports, rpc, rxjs, operators, michelsonEncoder, BigNumber, utils, httpUtils, michelCodec) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    class Operation {
        ...
        constructor(hash, raw, results, context) {
            ...
            this.currentHead$ = rxjs.defer(() => {
                ...
                return rxjs.from(this._currentHeadPromise);
            });
            // Polling observable that emit until timeout is reached
            this.polling$ = rxjs.defer(() => this._pollingConfig$.pipe(operators.tap(({ timeout, interval }) => {
                if (timeout <= 0) {
            ...
            }), operators.map((config) => (Object.assign(Object.assign({}, config), { timeoutAt: Math.ceil(config.timeout / config.interval) + 1, count: 0 }))), operators.switchMap((config) => rxjs.timer(0, config.interval * 1000).pipe(operators.mapTo(config))), operators.tap((config) => {
                config.count++;
            ...
            this.confirmed$ = this.polling$.pipe(operators.switchMapTo(this.currentHead$), operators.map((head) => {
                for (let i = 3; i >= 0; i--) {
            ...
            this.confirmed$.pipe(operators.first(), operators.catchError(() => {
        ...
        confirmation(confirmations, interval, timeout) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve, reject) => {
                    this.confirmed$
                        .pipe(operators.switchMap(() => this.polling$), operators.switchMap(() => this.currentHead$), operators.filter((head) => head.header.level - this._foundAt >= conf - 1), operators.first())
                        .subscribe((_) => {
    ...
    class WalletOperation {
        ...
        getCurrentConfirmation() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return rxjs.combineLatest([this._includedInBlock, rxjs.from(this.context.rpc.getBlock())])
    ...
    const cacheUntil = (cacheUntilObs) => (source) => {
        ...
        return rxjs.defer(() => {
            if (!subject) {
                ...
                cacheUntilObs.pipe(operators.first()).subscribe(() => {
                    subject = null;
                });
            }
            return subject;
    ...
    const createNewPollingBasedHeadObservable = (pollingTimer, sharedHeadOb, context, scheduler) => {
        return pollingTimer.pipe(operators.switchMap(() => sharedHeadOb), operators.distinctUntilKeyChanged('hash'), operators.timeoutWith(context.config.confirmationPollingTimeoutSecond * 1000, rxjs.throwError(new Error('Confirmation polling timed out')), scheduler), operators.shareReplay({
            refCount: true,
            scheduler,
        }));
    };
    class OperationFactory {
        constructor(context) {
            ...
            this.sharedHeadObs = rxjs.defer(() => rxjs.from(this.context.rpc.getBlock())).pipe(cacheUntil(rxjs.timer(0, 1000)));
        }
        createNewHeadObservable() {
            return __awaiter(this, void 0, void 0, function* () {
                const confirmationPollingIntervalSecond = this.context.config.confirmationPollingIntervalSecond !== undefined
                    ? this.context.config.confirmationPollingIntervalSecond
                    : yield this.context.getConfirmationPollingInterval();
                return createNewPollingBasedHeadObservable(rxjs.timer(0, confirmationPollingIntervalSecond * 1000), this.sharedHeadObs, this.context);
            });
        }
        createPastBlockWalker(startBlock, count = 1) {
            return rxjs.from(this.context.rpc.getBlock({ block: startBlock })).pipe(operators.switchMap((block) => {
                if (count === 1) {
    ...
    class ContractView {
        ...
        read(customLambdaAddress) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                else if (this.chainId === exports.ChainIds.ITHACANET) {
                    lambdaAddress = exports.DefaultLambdaAddresses.ITHACANET;
                }
                else if (this.chainId === exports.ChainIds.ITHACANET2) {
                    lambdaAddress = exports.DefaultLambdaAddresses.ITHACANET2;
                }
     ...
     */
    class Context {
        constructor(_rpc, _signer = new NoopSigner(), _proto, _config = new rxjs.BehaviorSubject(Object.assign(Object.assign({}, defaultConfigStreamer), defaultConfigConfirmation)), forger, injector, packer, wallet, parser, globalConstantsProvider) {
            this._rpc = _rpc;
        ...
        getConfirmationPollingInterval() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    let confirmationPollingInterval = BigNumber__default["default"].sum(blockTime, 
                    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                    new BigNumber__default["default"](constants.delay_per_missing_endorsement).multipliedBy(
                    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...
    class PollingSubscribeProvider {
        constructor(context) {
            ...
            this.timer$ = this.context._config.pipe(operators.switchMap((val) => rxjs.timer(0, val.streamerPollingIntervalMilliseconds)));
            this.newBlock$ = this.timer$.pipe(operators.map(() => this.context), operators.switchMap(getLastBlock), operators.distinctUntilKeyChanged('hash'), operators.publish(), operators.refCount());
        }
        subscribe(_filter) {
