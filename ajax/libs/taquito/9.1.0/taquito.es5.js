        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _c.apply(_b, [_d.sent()]);
                        return [2 /*return*/, concat.apply(void 0, __spread(observableSequence))];
                }
            });
        });
    };
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = [__assign({ fee: DEFAULT_FEE.REVEAL, gasLimit: DEFAULT_GAS_LIMIT.REVEAL, storageLimit: DEFAULT_STORAGE_LIMIT.REVEAL }), pkh];
                        return [4 /*yield*/, this.signer.publicKey()];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        constants = _a.sent();
                        confirmationPollingInterval = BigNumber.sum(constants.time_between_blocks[0], new BigNumber(constants.delay_per_missing_endorsement)
