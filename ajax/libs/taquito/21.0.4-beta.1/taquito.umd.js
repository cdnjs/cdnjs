(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('@taquito/http-utils'), require('@taquito/core'), require('rxjs'), require('rxjs/operators'), require('@taquito/michelson-encoder'), require('@taquito/utils'), require('bignumber.js'), require('@taquito/michel-codec'), require('@taquito/local-forging')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', '@taquito/http-utils', '@taquito/core', 'rxjs', 'rxjs/operators', '@taquito/michelson-encoder', '@taquito/utils', 'bignumber.js', '@taquito/michel-codec', '@taquito/local-forging'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.taquito = {}, global.rpc, global.httpUtils, global.core, global.rxjs, global.operators, global.michelsonEncoder, global.utils, global.BigNumber, global.michelCodec, global.localForging));
})(this, (function (exports, rpc, httpUtils, core, rxjs, operators, michelsonEncoder, utils, BigNumber, michelCodec, localForging) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    class UnconfiguredSignerError extends core.TezosToolkitConfigError {
        constructor() {
            super();
    ...
    const protocols = {
        ...
        '008': [exports.Protocols.PtEdo2Zk], // edonet v2
        '009': [exports.Protocols.PsFLorena],
        '010': [exports.Protocols.PtGRANADs],
        '011': [exports.Protocols.PtHangz2], // hangzhou v2,
        ...
        '016': [exports.Protocols.PtMumbai2], // mumbai v2
     ...
     */
    class InvalidParameterError extends core.ParameterValidationError {
     ...
     */
    class InvalidDelegationSource extends core.ParameterValidationError {
        constructor(source) {
            super();
            this.source = source;
     ...
     */
    class InvalidCodeParameter extends core.ParameterValidationError {
     ...
     */
    class InvalidInitParameter extends core.ParameterValidationError {
        constructor(message, data) {
            super();
            this.message = message;
            this.data = data;
     ...
     */
    class ViewSimulationError extends core.RpcError {
     ...
     */
    class InvalidViewSimulationContext extends core.ParameterValidationError {
        constructor(info) {
            super();
            this.info = info;
     ...
     */
    class RevealOperationError extends core.RpcError {
        constructor(message) {
            super();
            this.message = message;
     ...
     */
    class OriginationParameterError extends core.ParameterValidationError {
        constructor(message) {
            super();
            this.message = message;
            this.name;
     ...
     */
    class InvalidBalanceError extends core.ParameterValidationError {
        constructor(message) {
            super();
            this.message = message;
    ...
    const createSmartRollupExecuteOutboxMessageOperation = (_a) => __awaiter(void 0, [_a], void 0, function* ({ source, fee, gasLimit, storageLimit, rollup, cementedCommitment, outputProof, }) {
        return {
            kind: rpc.OpKind.SMART_ROLLUP_EXECUTE_OUTBOX_MESSAGE,
            source,
            fee,
            gas_limit: gasLimit,
            storage_limit: storageLimit,
     ...
     */
    class TezosOperationError extends core.RpcError {
     ...
     */
    class OriginationOperationError extends core.TaquitoError {
        constructor(message) {
            super();
            this.message = message;
     ...
     */
    class InvalidEstimateValueError extends core.ParameterValidationError {
        constructor(message) {
            super();
            this.message = message;
     ...
     */
    class InvalidConfirmationCountError extends core.ParameterValidationError {
     ...
     */
    class ConfirmationTimeoutError extends core.NetworkError {
        constructor(message) {
            super();
            this.message = message;
     ...
     */
    class RPCResponseError extends core.RpcError {
        ...
        constructor(hash, raw, results, context) {
            ...
            this.currentHead$ = this._pollingConfig$.pipe(operators.switchMap((config) => {
                return new rxjs.BehaviorSubject(config).pipe(operators.timeout({
                    ...
                    with: () => rxjs.throwError(() => new ConfirmationTimeoutError(`Confirmation polling timed out`)),
                }));
            }), operators.switchMap(() => {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                switch (param.kind) {
                    ...
                    case rpc.OpKind.SMART_ROLLUP_EXECUTE_OUTBOX_MESSAGE:
                        return createSmartRollupExecuteOutboxMessageOperation(Object.assign({}, param));
                    default:
     ...
     */
    class ConfirmationUndefinedError extends core.TezosToolkitConfigError {
        constructor() {
            super();
     ...
     */
    class ObservableError extends core.NetworkError {
        constructor(message) {
            super();
            this.message = message;
    ...
    class WalletOperation {
        ...
        constructor(opHash, context, _newHead$) {
            ...
            this.newHead$ = this._newHead$.pipe(operators.switchMap((newHead) => {
                ...
                const prevHead = (_b = (_a = this.lastHead) === null || _a === void 0 ? void 0 : _a.header.level) !== null && _b !== void 0 ? _b : newHead.header.level - 1;
                return rxjs.range(prevHead + 1, newHead.header.level - prevHead - 1).pipe(operators.concatMap((level) => this.context.readProvider.getBlock(level)), operators.endWith(newHead));
            }), operators.tap((newHead) => (this.lastHead = newHead)), operators.share({
            ...
            }), operators.first(), operators.share({
                connector: () => new rxjs.ReplaySubject(1),
                resetOnError: false,
                resetOnComplete: false,
                resetOnRefCountZero: false,
    ...
    class TransferTicketWalletOperation extends WalletOperation {
        ...
        transferTicketOperation() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return operationResult.find((x) => x.kind === rpc.OpKind.TRANSFER_TICKET);
            });
        }
        status() {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    class LegacyWalletProvider {
        ...
        mapTransferTicketParamsToWalletParams(params) {
            return __awaiter(this, void 0, void 0, function* () {
                return attachKind(yield params(), rpc.OpKind.TRANSFER_TICKET);
            });
        }
    ...
    class PrepareProvider extends Provider {
                ...
                switch (op.kind) {
                    ...
                    case rpc.OpKind.TRANSACTION: {
                        ...
                        if (cops.source.toLowerCase().startsWith('kt1')) {
                            throw new core.DeprecationError(`KT1 addresses are not supported as source since ${exports.Protocols.PsBabyM1}`);
                        }
                        return cops;
                    }
                    ...
                    case rpc.OpKind.PROPOSALS:
                        ...
                        return Object.assign(Object.assign({}, op), { period: currentVotingPeriod === null || currentVotingPeriod === void 0 ? void 0 : currentVotingPeriod.voting_period.index });
                    default:
                        throw new core.InvalidOperationKindError(op.kind);
                }
            });
        }
        /**
        ...
        smartRollupExecuteOutboxMessage(_a) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const protocolConstants = yield this.context.readProvider.getProtocolConstants('head');
                const DEFAULT_PARAMS = yield this.getOperationLimits(protocolConstants);
                const op = yield createSmartRollupExecuteOutboxMessageOperation(Object.assign(Object.assign({}, rest), mergeLimits({ fee, storageLimit, gasLimit }, DEFAULT_PARAMS)));
                const operation = yield this.addRevealOperationIfNeeded(op, pkh);
                const ops = this.convertIntoArray(operation);
                const hash = yield this.getBlockHash();
                const protocol = yield this.getProtocolHash();
    ...
    class OperationBatch extends Provider {
        ...
        withSmartRollupExecuteOutboxMessage(params) {
            this.operations.push(Object.assign({ kind: rpc.OpKind.SMART_ROLLUP_EXECUTE_OUTBOX_MESSAGE }, params));
            return this;
        }
        getRPCOp(param) {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    function timeoutAfter(timeoutMillisec) {
        return function inner(source) {
            return new rxjs.BehaviorSubject(null).pipe(operators.timeout({
                each: timeoutMillisec,
                with: () => rxjs.throwError(() => new ConfirmationTimeoutError(`Confirmation polling timed out`)),
            }), operators.mergeMap(() => source));
        };
    }
    const createNewPollingBasedHeadObservable = (sharedHeadOb, context, _scheduler) => {
        return sharedHeadOb.pipe(timeoutAfter(context.config.confirmationPollingTimeoutSecond * 1000), operators.share({
            connector: () => new rxjs.ReplaySubject(1),
            resetOnError: false,
            resetOnComplete: false,
            resetOnRefCountZero: false,
     ...
     */
    class RevealEstimateError extends core.TaquitoError {
        constructor() {
            super();
     ...
     *
     */
    class SmartRollupExecuteOutboxMessageOperation extends Operation {
        constructor(hash, params, source, raw, results, context) {
            super(hash, raw, results, context);
            this.params = params;
            this.source = source;
        ...
        get operationResults() {
            const smartRollupExecuteOutboxMessageOp = Array.isArray(this.results) &&
                this.results.find((op) => op.kind === rpc.OpKind.SMART_ROLLUP_EXECUTE_OUTBOX_MESSAGE);
    ...
    class RpcContractProvider extends Provider {
        ...
        smartRollupExecuteOutboxMessage(params) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const content = prepared.opOb.contents.find((op) => op.kind === rpc.OpKind.SMART_ROLLUP_EXECUTE_OUTBOX_MESSAGE);
                const opBytes = yield this.forge(prepared);
                const { hash, context, forgedBytes, opResponse } = yield this.signAndInject(opBytes);
                return new SmartRollupExecuteOutboxMessageOperation(hash, content, publicKeyHash, forgedBytes, opResponse, context);
            });
        }
        /**
         *
     ...
     */
    class GlobalConstantNotFound extends core.TaquitoError {
        constructor(hash) {
            super();
            this.hash = hash;
     ...
     */
    class UnconfiguredGlobalConstantsProviderError extends core.TezosToolkitConfigError {
        constructor() {
            super();
     ...
     */
    class UnsupportedEventError extends core.ParameterValidationError {
        constructor(type) {
            super();
            this.type = type;
     ...
     */
    class InvalidFilterExpressionError extends core.ParameterValidationError {
     ...
     */
    class ForgingMismatchError extends core.TaquitoError {
        constructor(results) {
            super();
            this.results = results;
     ...
     */
    class UnspecifiedForgerError extends core.TezosToolkitConfigError {
        constructor() {
            super();
    ...
    exports.ORIGINATION_SIZE = ORIGINATION_SIZE;
    ...
    exports.REVEAL_STORAGE_LIMIT = REVEAL_STORAGE_LIMIT;
