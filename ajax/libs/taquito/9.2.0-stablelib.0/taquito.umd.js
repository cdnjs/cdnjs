(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@taquito/rpc'), require('rxjs'), require('rxjs/operators'), require('bignumber.js'), require('@taquito/michelson-encoder'), require('@taquito/http-utils'), require('@taquito/utils'), require('@taquito/michel-codec')) :
    typeof define === 'function' && define.amd ? define(['exports', '@taquito/rpc', 'rxjs', 'rxjs/operators', 'bignumber.js', '@taquito/michelson-encoder', '@taquito/http-utils', '@taquito/utils', '@taquito/michel-codec'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.taquito = {}, global.rpc, global.rxjs, global.operators, global.BigNumber, global.michelsonEncoder, global.httpUtils, global.utils, global.michelCodec));
}(this, (function (exports, rpc, rxjs, operators, BigNumber, michelsonEncoder, httpUtils, utils, michelCodec) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var OperationEmitter = /** @class */ (function () {
        function OperationEmitter(context) {
                ...
                return cOps.map(function (op) {
                    switch (op.kind) {
                        ...
                        case rpc.OpKind.ORIGINATION:
                            return __assign(__assign(__assign(__assign(__assign({}, op), { balance: typeof op.balance !== 'undefined' ? "" + op.balance : '0' }), _this.getSource(op, publicKeyHash, source)), counterFunction(publicKeyHash, headCounter, counters)), _this.getFee(op));
                        case rpc.OpKind.TRANSACTION:
                            var cops = __assign(__assign(__assign(__assign(__assign({}, op), { amount: typeof op.amount !== 'undefined' ? "" + op.amount : '0' }), _this.getSource(op, publicKeyHash, source)), counterFunction(publicKeyHash, headCounter, counters)), _this.getFee(op));
            ...
            this.getContextCounter = function (publicKeyHash, headCounter) {
                if (!_this.context.counters[publicKeyHash] ||
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1: return [2 /*return*/, !(_a.sent()) || !this.isRevealRequiredForOpType(op)
                                ? false
                                : true];
                    }
                });
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.getCounterHashAndProtocol(ops, publicKeyHash)];
                        case 2:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _b.label = 1;
                        case 1:
                            if (!(i < ops.length)) return [3 /*break*/, 4];
                            if (!(isOpRequireReveal(ops[i]) || ops[i].kind === 'reveal')) return [3 /*break*/, 3];
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            _b = source;
                            return [3 /*break*/, 3];
                        case 1: return [4 /*yield*/, this.signer.publicKeyHash()];
                        case 2:
                            _b = _d.sent();
                            _d.label = 3;
                        case 3:
        ...
        OperationEmitter.prototype.preValidate = function (prepared, forgedOperation) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            if (!prepared.preparedOpSimulation) return [3 /*break*/, 2];
                            ...
                            _c = {
                                operation: __assign({ signature: SIGNATURE_STUB }, prepared.preparedOpSimulation.opOb)
                            };
        ...
        OperationEmitter.prototype.forgeOperation = function (_a) {
            var _b = _a.opOb, branch = _b.branch, contents = _b.contents;
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_c) {
                    return [2 /*return*/, this.context.forger.forge({ branch: branch, contents: contents })];
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            opResponse = [];
                            return [4 /*yield*/, this.rpc.preapplyOperations([opOb])];
                        case 1:
                            results = _a.sent();
        ...
        OperationEmitter.prototype.injectOperation = function (signedOperationBytes) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.context.injector.inject(signedOperationBytes)];
                });
            });
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.prepareOpAndSimulation({
                                    operation: [operation],
                                    source: pkh
                                })];
                        case 1:
                            prepared = _b.sent();
                            return [4 /*yield*/, this.forge(prepared.preparedOp)];
                        case 2:
                            forgedBytes = _b.sent();
    ...
    var RPCEstimateProvider = /** @class */ (function (_super) {
        ...
        RPCEstimateProvider.prototype.prepareEstimate = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.prepareOperationEstimation(params)];
                        case 1:
                            preparedSimulation = _b.sent();
                            return [4 /*yield*/, this.forgeOperation(preparedSimulation)];
                        case 2:
                            opbytes = _b.sent();
                            _a = {
                                operation: {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 8:
                            ops = _c;
                            return [4 /*yield*/, this.prepareEstimate({
                                    operation: ops,
                                    source: pkh,
                                })];
                        case 9:
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        ...
                        case 20:
                            forgedBytes = _h.sent();
                            return [4 /*yield*/, this.signOperation(forgedBytes)];
                        case 21:
                            signedOperation = _h.sent();
                            return [4 /*yield*/, this.preValidate(prepared, signedOperation)];
                        case 22:
                            opResponse = _h.sent();
                            return [4 /*yield*/, this.injectOperation(signedOperation.opbytes)];
                        case 23:
                            hash = _h.sent();
                            return [2 /*return*/, new BatchOperation(hash, ops, source, forgedBytes, opResponse, this.context.clone())];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 6:
                            ...
                            return [4 /*yield*/, this.forge(preparedOrigination.preparedOp)];
                        case 7:
                            forgedOrigination = _b.sent();
                            return [4 /*yield*/, this.signOperation(forgedOrigination)];
                        case 8:
                            signedOperation = _b.sent();
                            return [4 /*yield*/, this.preValidate(preparedOrigination, signedOperation)];
                        case 9:
                            opResponse = _b.sent();
                            return [4 /*yield*/, this.injectOperation(signedOperation.opbytes)];
                        case 10:
                            hash = _b.sent();
                            return [2 /*return*/, new OriginationOperation(hash, operation, signedOperation, opResponse, this.context.clone(), this)];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 6:
                            opBytes = _a.sent();
                            return [4 /*yield*/, this.signOperation(opBytes)];
                        case 7:
                        ...
                        case 9:
                            hash = _a.sent();
                            return [2 /*return*/, new DelegateOperation(hash, operation, sourceOrDefault, signedOperation, opResponse, this.context.clone())];
                    }
                });
            });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            ops = _a.sent();
                            return [4 /*yield*/, this.prepareOpAndSimulation({ operation: ops, source: source })];
                        case 5:
                            prepared = _a.sent();
                            return [4 /*yield*/, this.forge(prepared.preparedOp)];
                        case 6:
                        ...
                        case 9:
                            hash = _a.sent();
                            return [2 /*return*/, new DelegateOperation(hash, operation, source, signedOperation, opResponse, this.context.clone())];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 6:
                            ...
                            return [4 /*yield*/, this.signOperation(forgedOperation)];
                        case 7:
                            signedOperation = _a.sent();
                            return [4 /*yield*/, this.preValidate(prepared, signedOperation)];
                        case 8:
                        ...
                        case 9:
                            hash = _a.sent();
                            return [2 /*return*/, new TransactionOperation(hash, operation, source, signedOperation, opResponse, this.context.clone())];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            ...
                            if (!estimateReveal) return [3 /*break*/, 11];
                        ...
                        case 5:
                            operation = _c.sent();
                            return [4 /*yield*/, this.prepareOpAndSimulation({ operation: operation, source: publicKeyHash })];
                        case 6:
                            prepared = _c.sent();
                            return [4 /*yield*/, this.forge(prepared.preparedOp)];
                        case 7:
                        ...
                        case 10:
                            hash = _c.sent();
                            return [2 /*return*/, new RevealOperation(hash, operation, publicKeyHash, signedOperation, opResponse, this.context.clone())];
                        case 11: throw new Error('The current address is already revealed.');
                    }
                });
            });
        };
    ...
    /* tslint:disable */
    var VERSION = {
        "commitHash": "88089857fb6e5f9a7ebcec072cd4dbea9b3e4572",
        "version": "9.2.0-stablelib.0"
    };
    /* tslint:enable */
