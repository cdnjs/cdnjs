(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var protocols = {
        ...
        '012': [exports.Protocols.ProtoALpha]
    };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            abs = new ContractAbstraction(address, script, this, this.context.contract, entrypoints, chainId, rpc);
    ...
    var OnChainView = /** @class */ (function () {
        ...
        OnChainView.prototype.verifyContextExecution = function (executionContext) {
            if (executionContext.source && (utils.validateAddress(executionContext.source) !== utils.ValidationResult.VALID)) {
            ...
            if (!executionContext.viewCaller || (utils.validateAddress(executionContext.viewCaller) !== utils.ValidationResult.VALID)) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            failWith = validateAndExtractFailwith(error_1);
                            throw failWith ? new ViewSimulationError("The simulation of the on-chain view named " + this._smartContractViewSchema.viewName + " failed with: " + JSON.stringify(failWith), error_1) : error_1;
                        case 3:
                            if (!storage.args) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            else if (this.chainId === exports.ChainIds.IDIAZABALNET) {
                                lambdaAddress = exports.DefaultLambdaAddresses.IDIAZABALNET;
                            }
        ...
        ContractAbstraction.prototype._initializeMethods = function (currentContract, provider, entrypoints, chainId) {
            ...
            if (parameterSchema.isMultipleEntryPoint) {
                ...
                this.methods[DEFAULT_SMART_CONTRACT_METHOD_NAME] = function () {
                    ...
                    return currentContract.contractMethodFactory.createContractMethodFlatParams(smartContractMethodSchema_1, DEFAULT_SMART_CONTRACT_METHOD_NAME, args, false);
                };
                this.methodsObject[DEFAULT_SMART_CONTRACT_METHOD_NAME] = function (args) {
                    return currentContract.contractMethodFactory.createContractMethodObjectParam(smartContractMethodSchema_1, DEFAULT_SMART_CONTRACT_METHOD_NAME, args, false);
                };
            }
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            blockHeader = _a.sent();
                            chainId = blockHeader.chain_id;
                            abs = new ContractAbstraction(address, script, this, this, entrypoints, chainId, rpc);
                            return [2 /*return*/, contractAbstractionComposer(abs, this.context)];
                    }
                });
            });
    ...
    var MichelCodecParser = /** @class */ (function () {
        ...
        MichelCodecParser.prototype.prepareCodeOrigination = function (params) {
            return __awaiter(this, void 0, void 0, function () {
                var parsedParams, _a, _b, storageType, schema, globalconstantsHashAndValue, p, storageTypeNoGlobalConst, schemaNoGlobalConst;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            parsedParams = params;
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 5];
                        case 3:
                            if (!params.storage) return [3 /*break*/, 5];
                            storageType = parsedParams.code.find(function (p) { return ('prim' in p) && p.prim === 'storage'; });
                            ...
                            schema = new michelsonEncoder.Schema(storageType.args[0]);
                            return [4 /*yield*/, this.findGlobalConstantsHashAndValue(schema)];
                        case 4:
                            globalconstantsHashAndValue = _c.sent();
                            if (Object.keys(globalconstantsHashAndValue).length !== 0) {
                                p = new michelCodec.Parser({ expandGlobalConstant: globalconstantsHashAndValue });
                                storageTypeNoGlobalConst = p.parseJSON(storageType.args[0]);
                                schemaNoGlobalConst = new michelsonEncoder.Schema(storageTypeNoGlobalConst);
                            ...
                            _c.label = 5;
                        case 5: return [2 /*return*/, parsedParams];
                    }
                });
            });
        };
        ...
        MichelCodecParser.prototype.findGlobalConstantsHashAndValue = function (schema) {
            return __awaiter(this, void 0, void 0, function () {
                var globalConstantTokens, globalConstantsHashAndValue, globalConstantTokens_1, globalConstantTokens_1_1, token, tokenArgs, hash, michelineValue, e_1_1;
                var e_1, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            globalConstantTokens = schema.findToken('constant');
                            globalConstantsHashAndValue = {};
                            if (!(globalConstantTokens.length !== 0)) return [3 /*break*/, 8];
                            _c.label = 1;
                        case 1:
                            _c.trys.push([1, 6, 7, 8]);
                            globalConstantTokens_1 = __values(globalConstantTokens), globalConstantTokens_1_1 = globalConstantTokens_1.next();
                            _c.label = 2;
                        case 2:
                            if (!!globalConstantTokens_1_1.done) return [3 /*break*/, 5];
                            token = globalConstantTokens_1_1.value;
                            tokenArgs = token.tokenVal.args;
                            if (!tokenArgs) return [3 /*break*/, 4];
                            hash = tokenArgs[0]['string'];
                            return [4 /*yield*/, this.context.globalConstantsProvider.getGlobalConstantByHash(hash)];
                        case 3:
                            michelineValue = _c.sent();
                            Object.assign(globalConstantsHashAndValue, (_b = {},
                                _b[hash] = michelineValue,
                                _b));
                            _c.label = 4;
                        case 4:
                            globalConstantTokens_1_1 = globalConstantTokens_1.next();
                            return [3 /*break*/, 2];
                        case 5: return [3 /*break*/, 8];
                        case 6:
                            e_1_1 = _c.sent();
                        ...
                        case 7:
                            try {
                                if (globalConstantTokens_1_1 && !globalConstantTokens_1_1.done && (_a = globalConstantTokens_1.return)) _a.call(globalConstantTokens_1);
                            }
                            finally { if (e_1) throw e_1.error; }
                            return [7 /*endfinally*/];
                        case 8: return [2 /*return*/, globalConstantsHashAndValue];
                    }
                });
            });
        };
    ...
    var GlobalConstantNotFound = /** @class */ (function () {
        function GlobalConstantNotFound(hash) {
            this.hash = hash;
        ...
        return GlobalConstantNotFound;
    }());
    var UnconfiguredGlobalConstantsProviderError = /** @class */ (function () {
        function UnconfiguredGlobalConstantsProviderError() {
        ...
        return UnconfiguredGlobalConstantsProviderError;
    }());

    var NoopGlobalConstantsProvider = /** @class */ (function () {
        function NoopGlobalConstantsProvider() {
        }
        NoopGlobalConstantsProvider.prototype.getGlobalConstantByHash = function (_hash) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        return NoopGlobalConstantsProvider;
    }());
    ...
    var DefaultGlobalConstantsProvider = /** @class */ (function () {
        function DefaultGlobalConstantsProvider() {
         ...
         */
        DefaultGlobalConstantsProvider.prototype.loadGlobalConstant = function (globalConstant) {
            var _a;
            for (var hash in globalConstant) {
                Object.assign(this._globalConstantsLibrary, (_a = {},
                    _a[hash] = globalConstant[hash],
                    _a));
            }
        };
        /**
         ...
         */
        DefaultGlobalConstantsProvider.prototype.getGlobalConstantByHash = function (hash) {
            return __awaiter(this, void 0, void 0, function () {
                var value;
                return __generator(this, function (_a) {
                    value = this._globalConstantsLibrary[hash];
                    if (!value) {
        ...
        return DefaultGlobalConstantsProvider;
    }());
    ...
    var TezosToolkit = /** @class */ (function () {
        ...
        TezosToolkit.prototype.setProvider = function (_a) {
            var rpc = _a.rpc, stream = _a.stream, signer = _a.signer, protocol = _a.protocol, config = _a.config, forger = _a.forger, wallet = _a.wallet, packer = _a.packer, globalConstantsProvider = _a.globalConstantsProvider;
         ...
         *
         */
        TezosToolkit.prototype.setGlobalConstantsProvider = function (globalConstantsProvider) {
            var g = typeof globalConstantsProvider === 'undefined' ? new NoopGlobalConstantsProvider() : globalConstantsProvider;
        ...
        Object.defineProperty(TezosToolkit.prototype, "globalConstants", {
            /**
