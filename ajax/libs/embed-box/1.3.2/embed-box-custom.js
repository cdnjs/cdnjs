...
var EmbedBoxBase = (_class = (_temp = _class2 = function () {
  ...
  function EmbedBoxBase() {
    ...
    this.iframe.element.onload = function () {
      ...
      iframe.document.body.setAttribute(MODE_ATTRIBUTE, _this.mode);
  ...
  return EmbedBoxBase;
}(), _class2.stylesheet = __WEBPACK_IMPORTED_MODULE_1__embed_box_styl___default.a, _class2.iframeStylesheet = __WEBPACK_IMPORTED_MODULE_2__iframe_styl___default.a, _class2.fetchedTargets = [], _class2.version = "1.3.2", _class2.iframeAttributes = (_class2$iframeAttribu = {
  allowTransparency: ""
