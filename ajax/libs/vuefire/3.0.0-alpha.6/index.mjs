...
import { getCurrentInstance, inject, toRef, effectScope, shallowRef as shallowRef$1 } from 'vue';
...
export { VueFire, VueFireAuth, databasePlugin, firestoreDefaultConverter, firestorePlugin, useCollection, useCurrentUser, useDatabase, useDocument, useFirebaseApp, useFirebaseAuth, useFirestore, useList, useObject, usePendingPromises };
