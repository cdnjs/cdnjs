...
import { getCurrentInstance, inject, effectScope, toRef, shallowRef as shallowRef$1, ref as ref$1, isRef as isRef$1, watch as watch$1, onServerPrefetch as onServerPrefetch$1, computed, unref as unref$1, getCurrentScope as getCurrentScope$1, onScopeDispose as onScopeDispose$1 } from 'vue';
...
export { VueFire, VueFireAppCheck, VueFireAuth, VueFireDatabaseOptionsAPI, VueFireFirestoreOptionsAPI, databasePlugin, firestoreDefaultConverter, firestorePlugin, databasePlugin as rtdbPlugin, useAppCheckToken, useCollection, useCurrentUser, useDatabase, useDocument, useFirebaseApp, useFirebaseAuth, useFirestore, useList, useObject, usePendingPromises, useSSRInitialState, useStorage, useStorageMetadata, useStorageObject, useStorageUrl };
