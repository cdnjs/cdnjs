import { i as isFirestoreDataReference, a as isFirestoreQuery, b as isDatabaseReference, c as isStorageReference, u as useFirebaseApp, n as noop, d as isObject, e as checkWrittenTarget, f as isSSR, g as getGlobalScope, h as isPOJO, j as isDocumentRef, w as walkGet, k as callOnceWithArg, l as walkSet, m as authUserMap, s as setupOnAuthStateChanged, o as isClient, _ as _FirebaseAppInjectionKey } from './shared/vuefire.168e85f4.mjs';
export { V as VueFireAppCheck, q as getCurrentUser, r as updateCurrentUserProfile, v as useAppCheck, t as useAppCheckToken, p as useCurrentUser, u as useFirebaseApp } from './shared/vuefire.168e85f4.mjs';
...
function extractRefs(doc, oldDoc, subs) {
  ...
  function recursiveExtract(doc2, oldDoc2, path, result) {
    ...
    for (const key in doc2) {
      const ref = doc2[key];
      if (ref == null || ref instanceof Date || ref instanceof Timestamp || ref instanceof GeoPoint) {
        data[key] = ref;
