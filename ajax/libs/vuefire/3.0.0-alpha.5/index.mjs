import { isVue3, ref, unref, shallowRef, getCurrentScope as getCurrentScope$1, isRef, watch, onScopeDispose } from 'vue-demi';
import { onValue, onChildAdded, onChildRemoved, onChildChanged, onChildMoved } from 'firebase/database';
import { getApp } from 'firebase/app';
import { toRef, getCurrentScope, inject } from 'vue';
...
function useFirebaseApp(name) {
  const firebaseApp = getCurrentScope() && inject(
...
function _useDatabaseRef(reference, localOptions = {}) {
  ...
  const hasCurrentScope = getCurrentScope$1();
...
export { databasePlugin, firestorePlugin, useCollection, useDocument, useFirebaseApp, useList, useObject, usePendingPromises };
