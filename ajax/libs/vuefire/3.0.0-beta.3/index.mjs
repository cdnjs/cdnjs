import { u as useFirebaseApp, g as getGlobalScope, a as authUserMap, s as setupOnAuthStateChanged, _ as _FirebaseAppInjectionKey } from './shared/vuefire.20dd1d6e.mjs';
export { c as getCurrentUser, d as updateCurrentUserProfile, b as useCurrentUser, u as useFirebaseApp } from './shared/vuefire.20dd1d6e.mjs';
import { getCurrentInstance, inject, ssrContextKey, unref, ref, shallowRef, getCurrentScope, isRef, watch, onScopeDispose, onServerPrefetch, isVue3, toRef, effectScope, computed } from 'vue-demi';
...
export { VueFire, VueFireAppCheck, VueFireAuth, VueFireDatabaseOptionsAPI, VueFireFirestoreOptionsAPI, databasePlugin, firestoreDefaultConverter, firestorePlugin, DEFAULT_OPTIONS$1 as globalDatabaseOptions, DEFAULT_OPTIONS as globalFirestoreOptions, databasePlugin as rtdbPlugin, useAppCheck, useAppCheckToken, useCollection, useDatabase, useDatabaseList, useDatabaseObject, useDocument, useFirebaseAuth, useFirebaseStorage, useFirestore, useList, useObject, usePendingPromises, useSSRInitialState, useStorage, useStorageFile, useStorageFileMetadata, useStorageFileUrl, useStorageMetadata, useStorageObject, useStorageUrl };
