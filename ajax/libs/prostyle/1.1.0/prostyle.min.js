...
e.PropertyReader=d;var h=f.Models.Properties,d=function(){function b(){}b.read=function(a,c,d,m,k,C){void 0===m&&(m=void 0);void 0===k&&(k=void 0);void 0===C&&(C=[]);c=c||{};var D=f.Util.lowercaseProperties(c),r=[];m&&(r=m.split(","));void 0!==c["class"]&&r.push.apply(r,c["class"].split(","));var l=void 0;void 0!==k&&(l=b.read(a,k||{},d));r.forEach(function(c){if((c=c.trim().toLowerCase())&&-1===C.indexOf(c)){var e=C.slice();e.push(c);if(c=(a.classes||{})[c]||void 0)e=b.read(a,c,d,void 0,void 0,e),
...
a))});return k};b.readJson=function(a,d,h,m,k){h=f.Util.lowercaseProperties(h);for(var C=new c.ScriptSet(a,d,k),D=0;D<m.length;D++){var r=m[D];if(h[r+"scripts"]instanceof Array)return b.read(a,d,h[r+"scripts"],k);if(void 0!==h[r+"script"])C.scripts.push(e.ScriptReader.read(C,h[r+"script"]));else{var l=new c.StepEvent(C,0);if(h[r+"actions"]instanceof Array)l.actions=e.ActionReader.readArray(l,h[r+"actions"]);else if(void 0!==h[r+"action"])l.actions=e.ActionReader.readArray(l,[h[r+"action"]]);else continue;
C.scripts.push(l)}return C}C=new c.ScriptSet(a,d,k);if(!(h instanceof Array))return C;h.forEach(function(a){C.scripts.push(e.ScriptReader.read(C,a))});return C};return b}();e.ScriptSetReader=d})(f.Serialization||(f.Serialization={}));(function(e){(function(d){(function(d){var c=f.Util;d.deserialize=function(b,a){var e=(c.getSetup(a,"src")||c.getSetup(a,"img")||c.getSetup(a,"url")||"https://prostyle.io/pro.svg").trim(),x=c.getSetup(a,"width"),m=c.getSetup(a,"height"),x=isNaN(x)?void 0:Number(x),m=
isNaN(m)?void 0:Number(m),k=d.ImagePropertyTypes.get(),C=f.Serialization.PropertyListReader.read(b.story,a.init,k,"image"),k=f.Serialization.ScriptSetReader.readJson(b,"Image",a,[""],k);return new d.ImageItemModel(b,e,x,m,C,k)}})(d.Image||(d.Image={}))})(e.Items||(e.Items={}))})(f.Extensions||(f.Extensions={}));(function(e){var d=function(){function c(){}c.writeSet=function(b,a){a.forEach(function(a){b[a.type.jsonNames[a.type.jsonNames.length-1]]=c.write(a)})};c.write=function(b){var a={};b.type.variableTypes.forEach(function(c){c=
...
"none";TweenMax.defaultEase=h.Eaze.DEFAULT.ease;void 0!==this.timeline&&this.timeline.kill();this.timeline=new TimelineMax({autoRemoveChildren:!1,onUpdate:a});this.timeline.addLabel("initialize",0);var d=b.story,e=b.canvas,f=e.size,C=b.size,D=b.camera,r=D.size,l={fontFamily:"arial"};e.fullScreen||(l.height=f.height);e.initializeProperties(d,[e.div],r,this.timeline,d.canvas.init,!1,l);l={width:C.width,height:C.height};b.initializeProperties(d,[b.div],r,this.timeline,d.frame.init,!1,l);D.flows.forEach(function(a){var e=
r.getContainedSize(a.pageAspectRatio());a.pages.forEach(function(a){a.initializeProperties(d,[a.div],e,c.timeline,a.model.init,!1);a.items.forEach(function(a){a.initializeItem(c.timeline,b.camera.size)})});a.initializePlacement(c.timeline)});var n=void 0;D.flows.forEach(function(a){n=a.generateStepsActions(c.timeline,n)});return this.timeline};return c}();e.Timeline=d})(f.Views||(f.Views={}));f.reload=G;f.bootstrap=z;z()})(ProStyle||(ProStyle={}));
