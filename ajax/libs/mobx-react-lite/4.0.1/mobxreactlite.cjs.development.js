...
var mobxGlobalState = /*#__PURE__*/mobx._getGlobalState();
// BC
...
function createReaction(adm) {
  adm.reaction = new mobx.Reaction("observer" + adm.name, function () {
    ...
    adm.forceUpdate == null ? void 0 : adm.forceUpdate();
  });
}
  ...
  if (!admRef.current) {
    ...
    var _adm = {
      ...
      subscribe: function subscribe(onStoreChange) {
        ...
        _adm.forceUpdate = onStoreChange;
        if (!_adm.reaction) {
      ...
      getSnapshot: function getSnapshot() {
        // Do NOT access admRef here!
        return globalStateVersionIsAvailable ? mobxGlobalState.stateVersion : _adm.stateVersion;
      }
    };
    admRef.current = _adm;
  }
