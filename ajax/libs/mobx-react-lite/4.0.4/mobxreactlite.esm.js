import { makeObservable, configure, getDependencyTree, _getGlobalState, Reaction, observable, runInAction } from 'mobx';
...
// BC
var globalStateVersionIsAvailable = typeof /*#__PURE__*/_getGlobalState().stateVersion !== "undefined";
  ...
  if (!admRef.current) {
    ...
    var _adm = {
      ...
      getSnapshot: function getSnapshot() {
        // Do NOT access admRef here!
        return globalStateVersionIsAvailable ? _getGlobalState().stateVersion : _adm.stateVersion;
      }
    };
    admRef.current = _adm;
  }
