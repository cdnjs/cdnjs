...
"function"==typeof define&&define.amd&&define("jsnlog",[],function(){return JL});"function"==typeof __jsnlog_configure&&__jsnlog_configure(JL);window&&!window.onerror&&(window.onerror=function(b,d,k,f,g){JL("onerrorLogger").fatalException({msg:"Uncaught Exception",errorMsg:b,url:d,"line number":k,column:f},g);return!1});
