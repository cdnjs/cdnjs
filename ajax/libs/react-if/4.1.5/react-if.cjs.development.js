...
function IfAsync(_ref) {
  ...
  if (isResolved === null) {
    ...
    return React.createElement(React.Fragment, null, hasFallback || null);
  }
  if (!isResolved) {
    ...
    if (!hasElse) return React.createElement(React.Fragment, null, null);
    // Inject caught error
    ...
    return React.createElement(React.Fragment, null, elseElement);
  }
  // Promise is fulfilled and resolved
  var hasThen = React.Children.toArray(children).find(function (c) {
    return c.type === Then;
  });
  if (!hasThen) return React.createElement(React.Fragment, null, null);
  ...
  return React.createElement(React.Fragment, null, thenElement);
}
