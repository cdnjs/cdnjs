(function(d){d.sceditor=function(b,c){var a=this,f=d(b),e=null,h=null,g=null,i=null,j=null,m=null,p=!1,l=[],k=null,n=null,s=[],q,t,B,C,w,x,D,E,F,G,H,y,z,I,o,A,u,v,J,r;a.commands=d.sceditor.commands;E=function(){var b=d('<div contenteditable="true">')[0].contentEditable,b="undefined"!==typeof b&&"inherit"!==b;j=d("<textarea></textarea>").hide();g=d('<iframe frameborder="0"></iframe>');"https:"===window.location.protocol&&g.attr("src","javascript:false");e.append(g).append(j);i=g[0];v(f.width());u(f.height());
b||(o().designMode="On");o().open();o().write('<html><head><\!--[if gte IE 9]><style>* {min-height: auto !important}</style><![endif]--\><meta http-equiv="Content-Type" content="text/html;charset='+a.options.charset+'" /><link rel="stylesheet" type="text/css" href="'+a.options.style+'" /></head><body contenteditable="true"></body></html>');o().close();b||(o().designMode="On");d(o()).find("body").keypress(x);d(o()).keypress(x);d(o()).mousedown(D);d(o()).bind("beforedeactivate keyup",w);d(o()).focus(function(){k=
...
function(b){var c,e,f=/\[([^\[\s=]*?)(?:([^\[]*?))?\]((?:[\s\S(?!=\[\\\1)](?!\[\1))*?)\[\/(\1)\]/g,g=/(\S+)=((?:(?:(["'])(?:\\\3|[^\3])*?\3))|(?:[^'"\s]+))/g;e=function(b,c,e,f){var k={},l;if(e)if(e=d.trim(e),"="===e.charAt(0)&&1>=e.split("=").length-1||"url"===c)k.defaultAttr=a.stripQuotes(e.substr(1));else for("="===e.charAt(0)&&(e="defaultAttr"+e);l=g.exec(e);)k[l[1].toLowerCase()]=a.stripQuotes(l[2]);return!a.bbcodes[c]?b:d.isFunction(a.bbcodes[c].html)?a.bbcodes[c].html.call(a,c,k,f):h(a.bbcodes[c].html,
f)};for(b=b.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\r/g,"").replace(/(\[\/?(?:left|center|right|justify)\])\n/g,"$1").replace(/\n/g,"<br />");b!==c;)c=b,b=b.replace(f,e);b=b.replace(/\[hr\]/gi,"<hr>");b=b.replace(/ {2}(?=([^<\>]*?<|[^<\>]*?$))/g," &nbsp;");return i(b)};i=function(a){var b=document,c=b.createDocumentFragment(),e=b.createElement("div"),f=b.createElement("div"),g,h;d(f).hide().appendTo(b.body);f.innerHTML=a;for(f=f.firstChild;f;){g=f.nextSibling;h=f.nodeName.toLowerCase();
if(1===f.nodeType&&!d.sceditor.dom.isInline(f)||"br"===h){if(0<c.childNodes.length||"br"===h)a=b.createElement("div"),a.appendChild(c),e.appendChild(a),c=b.createDocumentFragment();"br"!==h&&e.appendChild(f)}else c.appendChild(f);f=g}0<c.childNodes.length&&(a=b.createElement("div"),a.appendChild(c),e.appendChild(a));return e.innerHTML};d.data(b,"sceditorbbcode",a);a.options=d.extend({},d.sceditor.defaultOptions,c);(function(){d.each(a.bbcodes,function(b){"undefined"!==typeof a.bbcodes[b].tags&&d.each(a.bbcodes[b].tags,
function(c,d){var e=!!a.bbcodes[b].isBlock;j[c]=j[c]||{};j[c][e]=j[c][e]||{};j[c][e][b]=d});"undefined"!==typeof a.bbcodes[b].styles&&d.each(a.bbcodes[b].styles,function(c,d){var e=!!a.bbcodes[b].isBlock;m[e]=m[e]||{};m[e][c]=m[e][c]||{};m[e][c][b]=d})})})();new d.sceditor(b,d.extend({},a.options,{getHtmlHandler:a.getHtmlHandler,getTextHandler:a.getTextHandler}))};d.sceditorBBCodePlugin.bbcodes={b:{tags:{b:null,strong:null},styles:{"font-weight":"bold,bolder,401,700,800,900".split(",")},format:"[b]{0}[/b]",
html:"<strong>{0}</strong>"},i:{tags:{i:null,em:null},styles:{"font-style":["italic","oblique"]},format:"[i]{0}[/i]",html:"<em>{0}</em>"},u:{tags:{u:null},styles:{"text-decoration":["underline"]},format:"[u]{0}[/u]",html:"<u>{0}</u>"},s:{tags:{s:null,strike:null},styles:{"text-decoration":["line-through"]},format:"[s]{0}[/s]",html:"<s>{0}</s>"},sub:{tags:{sub:null},format:"[sub]{0}[/sub]",html:"<sub>{0}</sub>"},sup:{tags:{sup:null},format:"[sup]{0}[/sup]",html:"<sup>{0}</sup>"},font:{tags:{font:{face:null}},
styles:{"font-family":null},format:function(b,c){return"font"===b[0].nodeName.toLowerCase()&&b.attr("face")?"[font="+this.stripQuotes(b.attr("face"))+"]"+c+"[/font]":"[font="+this.stripQuotes(b.css("font-family"))+"]"+c+"[/font]"},html:function(b,c,a){return'<font face="'+c.defaultAttr+'">'+a+"</font>"}},size:{tags:{font:{size:null}},styles:{"font-size":null},format:function(b,c){var a=b.css("fontSize"),d=1;-1<a.indexOf("px")?(a=a.replace("px","")-0,12<a&&(d=2),15<a&&(d=3),17<a&&(d=4),23<a&&(d=5),
31<a&&(d=6),47<a&&(d=7)):d=a;return"[size="+d+"]"+c+"[/size]"},html:function(b,c,a){return'<font size="'+c.defaultAttr+'">'+a+"</font>"}},color:{tags:{font:{color:null}},styles:{color:null},format:function(b,c){var a=b.css("color");"font"===b[0].nodeName.toLowerCase()&&b.attr("color")&&(a=b.attr("color"));a=function(a){function b(a){a=parseInt(a,10);if(isNaN(a))return"00";a=Math.max(0,Math.min(a,255)).toString(16);return 2>a.length?"0"+a:a}var c;return(c=a.match(/rgb\((\d+),\s*?(\d+),\s*?(\d+)\)/i))?
