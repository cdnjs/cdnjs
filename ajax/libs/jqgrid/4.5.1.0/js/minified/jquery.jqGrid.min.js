/*
 ...
 Date: 2013-05-21
*/
(function(a){a.jgrid=a.jgrid||{};a.extend(a.jgrid,{version:"4.5.1",htmlDecode:function(a){return a&&("&nbsp;"===a||"&#160;"===a||1===a.length&&160===a.charCodeAt(0))?"":!a?a:(""+a).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&")},htmlEncode:function(a){return!a?a:(""+a).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},format:function(c){var e=a.makeArray(arguments).slice(1);null==c&&(c="");return c.replace(/\{(\d+)\}/g,
...
"aria-labelledby":"gbox_"+this.id});var n=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},o=function(d,c,f,g,i,j){var l=b.p.colModel[d],m=l.align,k='style="',n=l.classes,o=l.name,q=[];m&&(k=k+("text-align:"+m+";"));l.hidden===true&&(k=k+"display:none;");if(c===0)k=k+("width: "+e.headers[d].width+"px;");else if(l.cellattr&&a.isFunction(l.cellattr))if((d=l.cellattr.call(b,i,f,g,l,j))&&typeof d==="string"){d=d.replace(/style/i,"style").replace(/title/i,"title");if(d.indexOf("title")>-1)l.title=
false;d.indexOf("class")>-1&&(n=void 0);q=d.split(/[^-]style/);if(q.length===2){q[1]=a.trim(q[1].replace("=",""));if(q[1].indexOf("'")===0||q[1].indexOf('"')===0)q[1]=q[1].substring(1);k=k+q[1].replace(/'/gi,'"')}else k=k+'"'}if(!q.length){q[0]="";k=k+'"'}k=k+((n!==void 0?' class="'+n+'"':"")+(l.title&&f?' title="'+a.jgrid.stripHtml(f)+'"':""));k=k+(' aria-describedby="'+b.p.id+"_"+o+'"');return k+q[0]},l=function(d){return d==null||d===""?"&#160;":b.p.autoencode?a.jgrid.htmlEncode(d):""+d},p=function(d,
...
"="+i[l]))}return'<tr role="row" id="'+d+'" tabindex="'+h+'" class="'+e+'"'+(c===""?"":' style="'+c+'"')+j+">"},x=function(d,c,e,f,g){var i=new Date,h=b.p.datatype!=="local"&&b.p.loadonce||b.p.datatype==="xmlstring",j=b.p.xmlReader,l=b.p.datatype==="local"?"local":"xml";if(h){b.p.data=[];b.p._index={};b.p.localReader.id="_id_"}b.p.reccount=0;if(a.isXMLDoc(d)){if(b.p.treeANode===-1&&!b.p.scroll){w.call(b,false,true);e=1}else e=e>1?e:1;var m=a(b),k,n,o=0,p,x=b.p.multiselect===true?1:0,C=0,z,H=b.p.rownumbers===
...
c).append(M.join(""));m.triggerHandler("jqGridAfterInsertRow",[E,A,G]);g&&b.p.afterInsertRow.call(b,E,A,G);M=[]}A={};o++;y++;if(o===P)break}}if(b.p.gridview===true){n=b.p.treeANode>-1?b.p.treeANode:0;if(b.p.grouping){m.jqGrid("groupingRender",N,b.p.colModel.length);N=null}else b.p.treeGrid===true&&n>0?a(b.rows[n]).after(M.join("")):a("tbody:first",c).append(M.join(""))}if(b.p.subGrid===true)try{m.jqGrid("addSubGrid",x+H)}catch(T){}b.p.totaltime=new Date-i;if(o>0&&b.p.records===0)b.p.records=F;M=null;
if(b.p.treeGrid===true)try{m.jqGrid("setTreeNode",n+1,o+n+1)}catch(V){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=o;b.p.treeANode=-1;b.p.userDataOnFooter&&m.jqGrid("footerData","set",b.p.userData,true);if(h){b.p.records=F;b.p.lastpage=Math.ceil(F/P)}f||b.updatepager(false,true);if(h)for(;o<F;){G=d[o];E=l(G,o+L);E=b.p.idPrefix+E;if(j.repeatitems){I||(I=v(x+C+H));var $=a.jgrid.getXmlData(G,j.cell,true);a.each(I,function(a){var d=$[this];if(!d)return false;p=d.textContent||d.text;
...
"local"){c=b.p.localReader;h="local"}else{c=b.p.jsonReader;h="json"}var l=a(b),m=0,k,n,o,p=[],x=b.p.multiselect?1:0,C=b.p.subGrid===true?1:0,z,H=b.p.rownumbers===true?1:0,u=v(x+C+H);h=t(h);var B,A,E,G={},I,y,F=[],D=b.p.altRows===true?b.p.altclass:"",Q;b.p.page=a.jgrid.getAccessor(d,c.page)||b.p.page||0;A=a.jgrid.getAccessor(d,c.total);C&&(z=a.jgrid.getMethod("addSubGridCell"));b.p.lastpage=A===void 0?1:A;b.p.records=a.jgrid.getAccessor(d,c.records)||0;b.p.userData=a.jgrid.getAccessor(d,c.userdata)||
{};E=b.p.keyIndex===false?a.isFunction(c.id)?c.id.call(b,d):c.id:b.p.keyIndex;if(!c.repeatitems){p=h;if(p.length>0&&!isNaN(E)){b.p.remapColumns&&b.p.remapColumns.length&&(E=a.inArray(E,b.p.remapColumns));E=p[E]}}A=a.jgrid.getAccessor(d,c.root);A==null&&a.isArray(d)&&(A=d);A||(A=[]);d=A.length;n=0;if(d>0&&b.p.page<=0)b.p.page=1;var N=parseInt(b.p.rowNum,10),P=b.p.scroll?a.jgrid.randId():1,L=false,S;g&&(N=N*(g+1));b.p.datatype==="local"&&!b.p.deselectAfterSort&&(L=true);var X=a.isFunction(b.p.afterInsertRow),
K=[],O=false,T;if(b.p.grouping){O=b.p.groupingView.groupCollapse===true;T=a.jgrid.getMethod("groupingPrepare")}for(;n<d;){g=A[n];y=a.jgrid.getAccessor(g,E);if(y===void 0){typeof E==="number"&&b.p.colModel[E+x+C+H]!=null&&(y=a.jgrid.getAccessor(g,b.p.colModel[E+x+C+H].name));if(y===void 0){y=P+n;if(p.length===0&&c.cell){k=a.jgrid.getAccessor(g,c.cell)||g;y=k!=null&&k[E]!==void 0?k[E]:y}}}y=b.p.idPrefix+y;k=e===1?0:e;Q=(k+n)%2===1?D:"";L&&(S=b.p.multiselect?a.inArray(y,b.p.selarrrow)!==-1:y===b.p.selrow);
var $=F.length;F.push("");H&&F.push(r(0,n,b.p.page,b.p.rowNum));x&&F.push(s(y,H,n,S));C&&F.push(z.call(l,x+H,n+e));B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=u)}for(o=0;o<B.length;o++){k=a.jgrid.getAccessor(g,B[o]);G[b.p.colModel[o+x+C+H].name]=k;F.push(q(y,k,o+x+C+H,n+e,g,G))}F[$]=J(y,O,Q,G,g,S);F.push("</tr>");if(b.p.grouping){K=T.call(l,F,K,G,n);F=[]}if(j||b.p.treeGrid===true){G._id_=a.jgrid.stripPref(b.p.idPrefix,y);b.p.data.push(G);b.p._index[G._id_]=
b.p.data.length-1}if(b.p.gridview===false){a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(F.join(""));l.triggerHandler("jqGridAfterInsertRow",[y,G,g]);X&&b.p.afterInsertRow.call(b,y,G,g);F=[]}G={};m++;n++;if(m===N)break}if(b.p.gridview===true){I=b.p.treeANode>-1?b.p.treeANode:0;b.p.grouping?l.jqGrid("groupingRender",K,b.p.colModel.length):b.p.treeGrid===true&&I>0?a(b.rows[I]).after(F.join("")):a("#"+a.jgrid.jqID(b.p.id)+" tbody:first").append(F.join(""))}if(b.p.subGrid===true)try{l.jqGrid("addSubGrid",
x+H)}catch(V){}b.p.totaltime=new Date-i;if(m>0&&b.p.records===0)b.p.records=d;if(b.p.treeGrid===true)try{l.jqGrid("setTreeNode",I+1,m+I+1)}catch(R){}if(!b.p.treeGrid&&!b.p.scroll)b.grid.bDiv.scrollTop=0;b.p.reccount=m;b.p.treeANode=-1;b.p.userDataOnFooter&&l.jqGrid("footerData","set",b.p.userData,true);if(j){b.p.records=d;b.p.lastpage=Math.ceil(d/N)}f||b.updatepager(false,true);if(j)for(;m<d&&A[m];){g=A[m];y=a.jgrid.getAccessor(g,E);if(y===void 0){typeof E==="number"&&b.p.colModel[E+x+C+H]!=null&&
(y=a.jgrid.getAccessor(g,b.p.colModel[E+x+C+H].name));if(y===void 0){y=P+m;if(p.length===0&&c.cell){e=a.jgrid.getAccessor(g,c.cell)||g;y=e!=null&&e[E]!==void 0?e[E]:y}}}if(g){y=b.p.idPrefix+y;B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=u)}for(o=0;o<B.length;o++)G[b.p.colModel[o+x+C+H].name]=a.jgrid.getAccessor(g,B[o]);G._id_=a.jgrid.stripPref(b.p.idPrefix,y);b.p.data.push(G);b.p._index[G._id_]=b.p.data.length-1;G={}}m++}}},F=function(){function d(a){var b=0,
...
var c=b.p.multiSort?[]:"",e=[],f=false,g={},i=[],h=[],j,l,m;if(a.isArray(b.p.data)){var k=b.p.grouping?b.p.groupingView:false,n,o;a.each(b.p.colModel,function(){l=this.sorttype||"text";if(l==="date"||l==="datetime"){if(this.formatter&&typeof this.formatter==="string"&&this.formatter==="date"){j=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:a.jgrid.formatter.date.srcformat;m=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:a.jgrid.formatter.date.newformat}else j=
m=this.datefmt||"Y-m-d";g[this.name]={stype:l,srcfmt:j,newfmt:m}}else g[this.name]={stype:l,srcfmt:"",newfmt:""};if(b.p.grouping){o=0;for(n=k.groupField.length;o<n;o++)if(this.name===k.groupField[o]){var d=this.name;if(this.index)d=this.index;i[o]=g[d];h[o]=d}}if(b.p.multiSort){if(this.lso){c.push(this.name);d=this.lso.split("-");e.push(d[d.length-1])}}else if(!f&&(this.index===b.p.sortname||this.name===b.p.sortname)){c=this.name;f=true}});if(b.p.treeGrid)a(b).jqGrid("SortTree",c,b.p.sortorder,g[c].stype,
...
w.call(b,true,false);b.grid.hDiv.scrollLeft=g}b.p.subGrid&&b.p.datatype==="local"&&a("td.sgexpanded","#"+a.jgrid.jqID(b.p.id)).each(function(){a(this).trigger("click")});D();b.p.lastsort=c;if(b.p.sortname!==d&&c)b.p.lastsort=c}}}},ca=function(d){d=a(b.grid.headers[d].el);d=[d.position().left+d.outerWidth()];b.p.direction==="rtl"&&(d[0]=b.p.width-d[0]);d[0]=d[0]-b.grid.bDiv.scrollLeft;d.push(a(b.grid.hDiv).position().top);d.push(a(b.grid.bDiv).offset().top-a(b.grid.hDiv).offset().top+a(b.grid.bDiv).height());
...
H,I,E,S,N,A,y,Q,$=Q="",P=[],ha=[];I=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(g=b.p.colModel.length-1;0<=g;g--)if(!b.p.colModel[g].hidden){b.p.colModel[g].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(Q=" ui-i-asc",$=" ui-i-desc");H=k?"class='ui-th-div-ie'":"";Q="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+Q+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+i+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+
$+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+i+"'></span></span>");if(b.p.multiSort){P=b.p.sortname.split(",");for(g=0;g<P.length;g++)I=a.trim(P[g]).split(" "),P[g]=a.trim(I[0]),ha[g]=I[1]?a.trim(I[1]):b.p.sortorder||"asc"}for(g=0;g<this.p.colNames.length;g++)I=b.p.headertitles?' title="'+a.jgrid.stripHtml(b.p.colNames[g])+'"':"",C+="<th id='"+b.p.id+"_"+b.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+i+"'"+I+">",I=b.p.colModel[g].index||b.p.colModel[g].name,
...
if(this.p.multiselect){var X=[],aa;a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){b.p.selarrrow=[];var d=b.p.frozenColumns===true?b.p.id+"_frozen":"";if(this.checked){a(b.rows).each(function(c){if(c>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("jqgroup")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",true);a(this).addClass("ui-state-highlight").attr("aria-selected","true");b.p.selarrrow.push(this.id);
b.p.selrow=this.id;if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",true);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).addClass("ui-state-highlight")}}});aa=true;X=[]}else{a(b.rows).each(function(c){if(c>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",false);a(this).removeClass("ui-state-highlight").attr("aria-selected",
"false");X.push(this.id);if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).removeClass("ui-state-highlight")}}});b.p.selrow=null;aa=false}a(b).triggerHandler("jqGridSelectAll",[aa?b.p.selarrrow:X,aa]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,aa?b.p.selarrrow:X,aa)})}!0===b.p.autowidth&&(C=a(m).innerWidth(),b.p.width=0<C?C:"nw");(function(){var d=0,c=a.jgrid.cell_width?0:n(b.p.cellLayout,
0),f=0,g,i=n(b.p.scrollOffset,0),j,l=false,m,k=0,o=0,q;a.each(b.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(b.p.grouping&&b.p.autowidth){var e=a.inArray(this.name,b.p.groupingView.groupField);if(e>=0&&b.p.groupingView.groupColumnShow.length>e)this.hidden=!b.p.groupingView.groupColumnShow[e]}this.widthOrg=j=n(this.width,0);if(this.hidden===false){d=d+(j+c);this.fixed?k=k+(j+c):f++;o++}});if(isNaN(b.p.width))b.p.width=d+(b.p.shrinkToFit===false&&!isNaN(b.p.height)?i:0);e.width=
b.p.width;b.p.tblwidth=d;if(b.p.shrinkToFit===false&&b.p.forceFit===true)b.p.forceFit=false;if(b.p.shrinkToFit===true&&f>0){m=e.width-c*f-k;if(!isNaN(b.p.height)){m=m-i;l=true}d=0;a.each(b.p.colModel,function(a){if(this.hidden===false&&!this.fixed){this.width=j=Math.round(m*this.width/(b.p.tblwidth-c*f-k));d=d+j;g=a}});q=0;l?e.width-k-(d+c*f)!==i&&(q=e.width-k-(d+c*f)-i):!l&&Math.abs(e.width-k-(d+c*f))!==1&&(q=e.width-k-(d+c*f));b.p.colModel[g].width=b.p.colModel[g].width+q;b.p.tblwidth=d+q+c*f+k;
if(b.p.tblwidth>b.p.width){b.p.colModel[g].width=b.p.colModel[g].width-(b.p.tblwidth-parseInt(b.p.width,10));b.p.tblwidth=b.p.width}}})();a(m).css("width",e.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+b.p.id+"'>&#160;</div>");a(j).css("width",e.width+"px");var C=a("thead:first",b).get(0),T="";b.p.footerrow&&(T+="<table role='grid' style='width:"+b.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
i+"'>");var j=a("tr:first",C),ba="<tr class='jqgfirstrow' role='row' style='height:auto'>";b.p.disableClick=!1;a("th",j).each(function(d){E=b.p.colModel[d].width;if(b.p.colModel[d].resizable===void 0)b.p.colModel[d].resizable=true;if(b.p.colModel[d].resizable){S=document.createElement("span");a(S).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else S="";a(this).css("width",E+"px").prepend(S);var c="";if(b.p.colModel[d].hidden){a(this).css("display",
"none");c="display:none;"}ba=ba+("<td role='gridcell' style='height:0px;width:"+E+"px;"+c+"'></td>");e.headers[d]={width:E,el:this};N=b.p.colModel[d].sortable;if(typeof N!=="boolean")N=b.p.colModel[d].sortable=true;c=b.p.colModel[d].name;c==="cb"||c==="subgrid"||c==="rn"||b.p.viewsortcols[2]&&a(">div",this).addClass("ui-jqgrid-sortable");if(N)if(b.p.multiSort)if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();b.p.colModel[d].lso&&a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}else{if(b.p.colModel[d].lso){a("div span.s-ico",
this).show();a("div span.ui-icon-"+b.p.colModel[d].lso,this).removeClass("ui-state-disabled")}}else if(b.p.viewsortcols[0]){a("div span.s-ico",this).show();d===b.p.lastsort&&a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}else if(d===b.p.lastsort){a("div span.s-ico",this).show();a("div span.ui-icon-"+b.p.sortorder,this).removeClass("ui-state-disabled")}b.p.footerrow&&(T=T+("<td role='gridcell' "+o(d,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(d){if(a(d.target).closest("th>span.ui-jqgrid-resize").length===
...
a(e).triggerHandler("jqGridToolbarSelectOper",[f,i,b]);a("#sopt_menu").hide();a(b).text(i).attr("soper",f);if(c.autosearch===true){i=a(b).parent().next().children()[0];(a(i).val()||f==="nu"||f==="nn")&&d()}})},b=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),h;a.each(e.p.colModel,function(){var f=this,i,j;j="";var k="=",m=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+e.p.direction+"'></th>"),n=a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
o=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");!0===this.hidden&&a(m).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");i=a.extend({},this.searchoptions||{});if(this.search){if(c.searchOperators){j=i.sopt?i.sopt[0]:"select"===f.stype?"eq":c.defaultSearch;for(var l=0;l<c.odata.length;l++)if(c.odata[l].oper===j){k=c.operands[j]||"";break}j="<a title='"+(null!=i.searchtitle?
i.searchtitle:c.operandTitle)+"' style='padding-right: 0.5em;' soper='"+j+"' class='soptclass' colname='"+this.name+"'>"+k+"</a>"}a("td:eq(0)",o).append(j);switch(this.stype){case "select":if(j=this.surl||i.dataUrl)a.ajax(a.extend({url:j,dataType:"html",success:function(b){if(i.buildSelect!==void 0){if(b=i.buildSelect(b)){a("td:eq(1)",o).append(b);a(n).append(o)}}else{a("td:eq(1)",o).append(b);a(n).append(o)}i.defaultValue!==void 0&&a("select",n).val(i.defaultValue);a("select",n).attr({name:f.index||
f.name,id:"gs_"+f.name});i.attr&&a("select",n).attr(i.attr);a("select",n).css({width:"100%"});a.jgrid.bindEv.call(e,a("select",n)[0],i);c.autosearch===true&&a("select",n).change(function(){d();return false});b=null}},a.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));else{var p,q,s;f.searchoptions?(p=void 0===f.searchoptions.value?"":f.searchoptions.value,q=void 0===f.searchoptions.separator?":":f.searchoptions.separator,s=void 0===f.searchoptions.delimiter?";":f.searchoptions.delimiter):f.editoptions&&
...
(s=document.createElement("option"),s.value=r,s.innerHTML=p[r],k.appendChild(s));void 0!==i.defaultValue&&a(k).val(i.defaultValue);i.attr&&a(k).attr(i.attr);a.jgrid.bindEv.call(e,k,i);a("td:eq(1)",o).append(k);a(n).append(o);!0===c.autosearch&&a(k).change(function(){d();return false})}}break;case "text":q=void 0!==i.defaultValue?i.defaultValue:"";a("td:eq(1)",o).append("<input type='text' style='width:100%;padding:0px;' name='"+(f.index||f.name)+"' id='gs_"+f.name+"' value='"+q+"'/>");a(n).append(o);
i.attr&&a("input",n).attr(i.attr);a.jgrid.bindEv.call(e,a("input",n)[0],i);!0===c.autosearch&&(c.searchOnEnter?a("input",n).keypress(function(a){if((a.charCode||a.keyCode||0)===13){d();return false}return this}):a("input",n).keydown(function(a){switch(a.which){case 13:return false;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:h&&clearTimeout(h);h=setTimeout(function(){d()},500)}}));break;case "custom":a("td:eq(1)",o).append("<span style='width:95%;padding:0px;' name='"+(f.index||
f.name)+"' id='gs_"+f.name+"'/>");a(n).append(o);try{if(a.isFunction(i.custom_element)){var t=i.custom_element.call(e,void 0!==i.defaultValue?i.defaultValue:"",i);if(t)t=a(t).addClass("customelement"),a(n).find(">span").append(t);else throw"e2";}else throw"e1";}catch(v){"e1"===v&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===v?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof v?v:v.message,a.jgrid.edit.bClose)}}}a(m).append(n);a(b).append(m);c.searchOperators||a("td:eq(0)",o).hide()});a("table thead",e.grid.hDiv).append(b);c.searchOperators&&(a(".soptclass").click(function(b){var d=a(this).offset();f(this,d.left,d.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));this.ftoolbar=!0;this.triggerToolbar=d;this.clearToolbar=
...
e),"set",i);else throw"e1";}catch(m){"e1"==m?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,m.message,a.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",r).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&u.hasOwnProperty(b.name)&&""===u[b.name]&&(u[b.name]="null")})}function i(){var b,e=[!0,"",""],f={},i=l.p.prmNames,j,k,n,m,o,s=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",
[a("#"+q),D]);s&&"object"===typeof s&&(u=s);a.isFunction(c[l.p.id].beforeCheckValues)&&(s=c[l.p.id].beforeCheckValues.call(l,u,a("#"+q),D))&&"object"===typeof s&&(u=s);for(n in u)if(u.hasOwnProperty(n)&&(e=a.jgrid.checkValues.call(l,u[n],n),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[c[l.p.id],u,D]),void 0===f&&a.isFunction(c[l.p.id].onclickSubmit)&&(f=c[l.p.id].onclickSubmit.call(l,c[l.p.id],u,D)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",[u,a("#"+q),
...
"selrow"),u["adjacency"==l.p.treeGridModel?l.p.treeReader.parent_id_field:"parent_id"]=m),l.p.treeReader)l.p.treeReader.hasOwnProperty(o)&&(f=l.p.treeReader[o],u.hasOwnProperty(f)&&!(u[k]==i.addoper&&"parent_id_field"===o)&&delete u[f]);u[j]=a.jgrid.stripPref(l.p.idPrefix,u[j]);o=a.extend({url:c[l.p.id].url||a(l).jqGrid("getGridParam","editurl"),type:c[l.p.id].mtype,data:a.isFunction(c[l.p.id].serializeEditData)?c[l.p.id].serializeEditData.call(l,u):u,complete:function(f,g){var n;u[j]=l.p.idPrefix+
u[j];if(f.status>=300&&f.status!==304){e[0]=false;e[1]=a(l).triggerHandler("jqGridAddEditErrorTextFormat",[f,D]);e[1]=a.isFunction(c[l.p.id].errorTextFormat)?c[l.p.id].errorTextFormat.call(l,f,D):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,D]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(c[l.p.id].afterSubmit)&&(e=c[l.p.id].afterSubmit.call(l,f,u,D))}if(e[0]===false){a("#FormError>td",r).html(e[1]);a("#FormError",r).show()}else{l.p.autoencode&&
a.each(u,function(b,d){u[b]=a.jgrid.htmlDecode(d)});if(u[k]===i.addoper){e[2]||(e[2]=a.jgrid.randId());u[j]=e[2];c[l.p.id].reloadAfterSubmit?a(l).trigger("reloadGrid"):l.p.treeGrid===true?a(l).jqGrid("addChildNode",e[2],m,u):a(l).jqGrid("addRowData",e[2],u,d.addedrow);if(c[l.p.id].closeAfterAdd){l.p.treeGrid!==true&&a(l).jqGrid("setSelection",e[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}else c[l.p.id].clearAfterAdd&&h("_empty",
l,q)}else{if(c[l.p.id].reloadAfterSubmit){a(l).trigger("reloadGrid");c[l.p.id].closeAfterEdit||setTimeout(function(){a(l).jqGrid("setSelection",u[j])},1E3)}else l.p.treeGrid===true?a(l).jqGrid("setTreeRow",u[j],u):a(l).jqGrid("setRowData",u[j],u);c[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose})}if(a.isFunction(c[l.p.id].afterComplete)){b=f;setTimeout(function(){a(l).triggerHandler("jqGridAddEditAfterComplete",
[b,u,a("#"+q),D]);c[l.p.id].afterComplete.call(l,b,u,a("#"+q),D);b=null},500)}if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate){a("#"+q).data("disabled",false);if(c[l.p.id]._savedData[l.p.id+"_id"]!=="_empty")for(n in c[l.p.id]._savedData)c[l.p.id]._savedData.hasOwnProperty(n)&&u[n]&&(c[l.p.id]._savedData[n]=u[n])}}c[l.p.id].processing=false;a("#sData",r+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+q)[0].focus()}catch(o){}}},a.jgrid.ajaxOptions,c[l.p.id].ajaxEditOptions);!o.url&&
...
(z?W+x:x+W)+"</td><td class='EditButton'>"+ca+Z+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+c[l.p.id].bottominfo+"</td></tr>"),s=s+"</tbody></table>";if(0<F){var da=[];a.each(a(Y)[0].rows,function(a,b){da[a]=b});da.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each(da,function(b,d){a("tbody",Y).append(d)})}d.gbox="#gbox_"+a.jgrid.jqID(p);var ea=!1;!0===d.closeOnEscape&&(d.closeOnEscape=!1,ea=!0);s=a("<div></div>").append(V).append(s);a.jgrid.createModal(t,
...
d.saveicon[2]+"'></span>");!0===d.closeicon[0]&&a("#cData",r+"_2").addClass("right"==d.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+d.closeicon[2]+"'></span>");if(c[l.p.id].checkOnSubmit||c[l.p.id].checkOnUpdate)ca="<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bYes+"</a>",W="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bNo+
"</a>",Z="<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+d.bExit+"</a>",s=d.zIndex||999,s++,a("<div class='"+d.overlayClass+" jqgrid-overlay confirm' style='z-index:"+s+";display:none;'>&#160;</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:"+(s+1)+"'>"+d.saveData+"<br/><br/>"+ca+W+Z+"</div>").insertAfter("#"+q),a("#sNew","#"+a.jgrid.jqID(t.themodal)).click(function(){i();a("#"+q).data("disabled",false);a(".confirm",
...
return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+q),D]);J&&J.call(l,a("#"+q),D);"_empty"==e||!c[l.p.id].viewPagerButtons?a("#pData,#nData",r+"_2").hide():a("#pData,#nData",r+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+q),D]);v&&v.call(l,a("#"+q),D);a("#"+a.jgrid.jqID(t.themodal)).data("onClose",c[l.p.id].onClose);a.jgrid.viewModal("#"+a.jgrid.jqID(t.themodal),{gbox:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,overlay:d.overlay,modal:d.modal,overlayClass:d.overlayClass});
O||a("."+a.jgrid.jqID(d.overlayClass)).click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditAfterShowForm",[a("#"+q),D]);w&&w.call(l,a("#"+q),D);a(".fm-button","#"+a.jgrid.jqID(t.themodal)).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});a("#sData",r+"_2").click(function(){u={};a("#FormError",
r).hide();f();if(u[l.p.id+"_id"]=="_empty")i();else if(d.checkOnSubmit===true)if(L=j(u,c[l.p.id]._savedData)){a("#"+q).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i();else i();return false});a("#cData",r+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(p),jqm:d.jqModal,onClose:c[l.p.id].onClose});return false});a("#nData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var b=
...
d.afterclickPgButtons.call(l,"next",a("#"+q),b[1][b[0]+1]);n(b[0]+1,b)}return false});a("#pData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var b=o();if(b[0]!==-1&&b[1][b[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+q),b[1][b[0]]]);var c;if(a.isFunction(d.onclickPgButtons)){c=d.onclickPgButtons.call(l,"prev",a("#"+q),b[1][b[0]]);if(c!==void 0&&c===false)return false}if(a("#"+a.jgrid.jqID(b[1][b[0]-1])).hasClass("ui-state-disabled"))return false;
...
38,40],onClose:null,beforeShowForm:null,beforeInitData:null,viewPagerButtons:!0,recreateForm:!1},a.jgrid.view,d||{});c[a(this)[0].p.id]=d;return this.each(function(){function f(){(!0===c[j.p.id].closeOnEscape||!0===c[j.p.id].navkeys[0])&&setTimeout(function(){a(".ui-jqdialog-titlebar-close","#"+a.jgrid.jqID(p.modalhead)).focus()},0)}function b(b,c,e,f){var g,i,h,j=0,k,l,n=[],m=!1,o,q="<td class='CaptionTD form-view-label ui-widget-content' width='"+d.labelswidth+"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",
p="",r=["integer","number","currency"],t=0,s=0,v,w,z;for(o=1;o<=f;o++)p+=1==o?q:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(c.p.colModel).each(function(){i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!i&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,r)?t=Math.max(t,parseInt(this.width,10)):s=Math.max(s,parseInt(this.width,10)))});v=0!==t?t:0!==s?s:0;m=a(c).jqGrid("getInd",
b);a(c.p.colModel).each(function(b){g=this.name;w=!1;l=(i=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";z="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&z){k=!1===m?"":g==c.p.ExpandColumn&&!0===c.p.treeGrid?a("td:eq("+b+")",c.rows[m]).text():a("td:eq("+b+")",c.rows[m]).html();w="right"===this.align&&0!==v?!0:!1;var d=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),o=parseInt(d.rowpos,10)||
j+1,q=parseInt(2*(parseInt(d.colpos,10)||1),10);if(d.rowabove){var r=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+d.rowcontent+"</td></tr>");a(e).append(r);r[0].rp=o}h=a(e).find("tr[rowpos="+o+"]");0===h.length&&(h=a("<tr "+l+" rowpos='"+o+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(p),a(e).append(h),h[0].rp=o);a("td:eq("+(q-2)+")",h[0]).html("<b>"+(void 0===d.label?c.p.colNames[b]:d.label)+"</b>");a("td:eq("+(q-1)+")",h[0]).append("<span>"+k+"</span>").attr("id","v_"+g);
w&&a("td:eq("+(q-1)+") span",h[0]).css({"text-align":"right",width:v+"px"});n[j]=b;j++}});0<j&&(b=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+b+"'/></td></tr>"),b[0].rp=j+99,a(e).append(b));return n}function h(b,d){var c,e,f=0,g,i;if(i=a(d).jqGrid("getInd",b,!0))a("td",i).each(function(b){c=d.p.colModel[b].name;e=d.p.colModel[b].editrules&&!0===d.p.colModel[b].editrules.edithidden?
...
n="ViewTbl_"+a.jgrid.jqID(k),o="ViewGrid_"+k,l="ViewTbl_"+k,p={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},q=a.isFunction(c[j.p.id].beforeInitData)?c[j.p.id].beforeInitData:!1,s=!0,r=1,t=0;!0===d.recreateForm&&void 0!==a("#"+a.jgrid.jqID(p.themodal))[0]&&a("#"+a.jgrid.jqID(p.themodal)).remove();if(void 0!==a("#"+a.jgrid.jqID(p.themodal))[0]){q&&(s=q.call(j,a("#"+m)),void 0===s&&(s=!0));if(!1===s)return;a(".ui-jqdialog-title","#"+a.jgrid.jqID(p.modalhead)).html(d.caption);
