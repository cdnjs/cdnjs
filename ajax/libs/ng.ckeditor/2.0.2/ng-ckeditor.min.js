...
g=void 0,l=function(a,b){g&&clearTimeout(g);g=setTimeout(function(){a&&b?b.setData(a):b&&b.setData("")},1E3)};k(e);a.$watch("ngModel",function(a){a!==e.getData()&&l(a,e)});a.$watch("ngDisabled",function(b){d.readOnly=b?!0:!1;e.destroy();e=CKEDITOR.appendTo(h[0],a.ngConfig?a.ngConfig:d,"");k(e);e.setData(a.ngModel)})}}})})(window,document);
