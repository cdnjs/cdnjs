/*
 *  custombox v3.0.2 - 2016-12-29
 *  Modal dialog effects with transitions CSS3
 *  http://dixso.github.io/custombox/
 *  (c) 2016 Julio de la Calle - @dixso9
 *
 *  Under MIT License - http://opensource.org/licenses/MIT
 */
"use strict";function _possibleConstructorReturn(a,b){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!b||"object"!=typeof b&&"function"!=typeof b?a:b}function _inherits(a,b){if("function"!=typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}}),b&&(Object.setPrototypeOf?Object.setPrototypeOf(a,b):a.__proto__=b)}function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),Custombox;!function(a){var b="custombox",c=b+"-open",d=b+"-close",e="animateFrom",f=["top","right","bottom","left"],g=["slide","blur","flip","rotate","letmein","makeway","slip","corner","slidetogether","push","contentscale"],h=["blur","makeway","slip","push","contentscale"],i=["letmein","makeway","slip","corner","slidetogether","door","push","contentscale"],j=["corner","slidetogether","scale","door","push","contentscale"],k=["fall","sidefall","flip","sign","slit","letmein","makeway","slip"],l=function(){function a(){_classCallCheck(this,a)}return _createClass(a,null,[{key:"check",value:function(a,b){return a.indexOf(b)>-1}}]),a}(),m=function(){function a(){_classCallCheck(this,a),this.position=document.documentElement&&document.documentElement.scrollTop||document.body&&document.body.scrollTop||0,document.documentElement.classList.add(b+"-perspective")}return _createClass(a,[{key:"remove",value:function(){document.documentElement.classList.remove(b+"-perspective"),window.scrollTo(0,this.position)}}]),a}(),n=function a(){_classCallCheck(this,a),this.overlay={color:"#000",opacity:.48,close:!0,escKey:!0,speedIn:300,speedOut:300,onOpen:null,onComplete:null,onClose:null,active:!0},this.content={id:null,target:null,animateFrom:"top",animateTo:"top",positionX:"center",positionY:"center",width:null,effect:"fadein",speedIn:300,speedOut:300,delay:150,fullscreen:!1,onOpen:null,onComplete:null,onClose:null},this.container={target:null},this.loader={active:!0,color:"#000"}},o=function(a){function b(a){_classCallCheck(this,b);var c=_possibleConstructorReturn(this,(b.__proto__||Object.getPrototypeOf(b)).call(this));return Object.keys(c).forEach(function(b){a[b]&&Object.assign(c[b],a[b])}),c}return _inherits(b,a),b}(n),p=function(){function a(c){_classCallCheck(this,a),this.options=c,this.element=document.createElement("div"),this.element.classList.add(b+"-loader"),this.element.style.borderTopColor=this.options.loader.color,document.body.appendChild(this.element)}return _createClass(a,[{key:"destroy",value:function(){this.element.parentElement.removeChild(this.element)}}]),a}(),q=function(){function a(c){if(_classCallCheck(this,a),this.options=c,"loading"===document.readyState)throw new Error("You need to instantiate Custombox when the document is fully loaded.");var d=document.querySelector(this.options.container.target);if(d)this.element=d,this.addSimpleClass();else if(!document.querySelector(b+"-container")){for(this.element=document.createElement("div"),this.addSimpleClass();document.body.firstChild;)this.element.appendChild(document.body.firstChild);document.body.appendChild(this.element)}this.element.style.animationDuration=this.options.content.speedIn+"ms",l.check(g,this.options.content.effect)&&this.setAnimation()}return _createClass(a,[{key:"bind",value:function(a){var b=this;return"close"===a&&(l.check(g,this.options.content.effect)&&this.setAnimation("animateTo"),this.element.classList.remove(c)),this.element.classList.add(a),new Promise(function(a){return b.listener().then(function(){return a()})})}},{key:"remove",value:function(){this.element.classList.remove(d,b+"-"+this.options.content.effect),this.element.style.removeProperty("animation-duration")}},{key:"listener",value:function(){var a=this;return new Promise(function(b){return a.element.addEventListener("animationend",function(){return b()},!0)})}},{key:"addSimpleClass",value:function(){this.element.classList.add(b+"-container",b+"-"+this.options.content.effect)}},{key:"setAnimation",value:function(){for(var a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:e,c=0,d=f.length;c<d;c++)this.element.classList.contains(b+"-"+f[c])&&this.element.classList.remove(b+"-"+f[c]);this.element.classList.add(b+"-"+this.options.content[a])}}]),a}(),r=function(){function a(c){_classCallCheck(this,a),this.options=c,this.element=document.createElement("div"),this.element.style.backgroundColor=this.options.overlay.color,this.element.classList.add(b+"-overlay"),this.setAnimation()}return _createClass(a,[{key:"bind",value:function(a){var e=this;switch(a){case d:l.check(i,this.options.content.effect)&&this.toggleAnimation("animateTo"),this.element.classList.add(d),this.element.classList.remove(c);break;default:document.body.appendChild(this.element),this.element.classList.add(b+"-"+this.options.content.effect,c)}return new Promise(function(a){return e.listener().then(function(){return a()})})}},{key:"remove",value:function(){try{this.element.parentNode.removeChild(this.element),this.style.parentNode.removeChild(this.style)}catch(a){}}},{key:"createSheet",value:function(){return this.style=document.createElement("style"),this.style.setAttribute("id",b+"-overlay-"+Date.now()),document.head.appendChild(this.style),this.style.sheet}},{key:"listener",value:function(){var a=this;return new Promise(function(b){return a.element.addEventListener("animationend",function(){return b()},!0)})}},{key:"setAnimation",value:function(){var a=this.createSheet();if(l.check(i,this.options.content.effect)?(this.element.style.opacity=this.options.overlay.opacity.toString(),this.element.style.animationDuration=this.options.overlay.speedIn+"ms",this.toggleAnimation()):(a.insertRule("."+b+"-overlay { animation: CloseFade "+this.options.overlay.speedOut+"ms; }",0),a.insertRule("."+c+"."+b+"-overlay { animation: OpenFade "+this.options.overlay.speedIn+"ms; opacity: "+this.options.overlay.opacity+" }",0),a.insertRule("@keyframes OpenFade { from {opacity: 0} to {opacity: "+this.options.overlay.opacity+"} }",0),a.insertRule("@keyframes CloseFade { from {opacity: "+this.options.overlay.opacity+"} to {opacity: 0} }",0)),l.check(j,this.options.content.effect)){var d=this.options.overlay.speedIn;l.check(j,this.options.content.effect)&&(d=this.options.content.speedIn),this.element.style.animationDuration=d+"ms"}}},{key:"toggleAnimation",value:function(){for(var a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:e,c=0,d=f.length;c<d;c++)this.element.classList.contains(b+"-"+f[c])&&this.element.classList.remove(b+"-"+f[c]);this.element.classList.add(b+"-"+this.options.content[a])}}]),a}(),s=function(){function a(c){_classCallCheck(this,a),this.options=c,this.element=document.createElement("div"),this.element.style.animationDuration=this.options.content.speedIn+"ms",this.options.content.id&&this.element.setAttribute("id",b+"-"+this.options.content.id),l.check(j,this.options.content.effect)||(this.element.style.animationDelay=this.options.content.delay+"ms"),this.element.classList.add(b+"-content"),this.options.content.fullscreen?this.element.classList.add(b+"-fullscreen"):this.element.classList.add(b+"-x-"+this.options.content.positionX,b+"-y-"+this.options.content.positionY),l.check(g,this.options.content.effect)&&this.setAnimation()}return _createClass(a,[{key:"fetch",value:function(a,b){var c=this;return new Promise(function(d,e){var f=/^.*(youtu\.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/,g=a.match(f);if(g&&11==g[2].length){var h=document.createElement("iframe");h.setAttribute("src","https://www.youtube.com/embed/"+g[2]),h.setAttribute("frameborder","0"),h.setAttribute("allowfullscreen",""),c.element.appendChild(h),d()}else if("#"!==a.charAt(0)&&"."!==a.charAt(0))!function(){var f=new XMLHttpRequest;f.open("GET",a),f.onload=function(){if(200===f.status){if(c.element.insertAdjacentHTML("beforeend",f.response),b){var a=c.element.firstChild;a.style.flexBasis=b}d()}else e(new Error(f.statusText))},f.onerror=function(){return e(new Error("Network error"))},f.send()}();else{var i=document.querySelector(a);if(i){var j=i.cloneNode(!0);j.removeAttribute("id"),b&&(j.style.flexBasis=b),c.element.appendChild(j),d()}else e(new Error("The element doesn't exist"))}})}},{key:"bind",value:function(a){var e=this;switch(a){case d:this.element.style.animationDelay="0ms",this.element.style.animationDuration=this.options.content.speedOut+"ms",this.element.classList.remove(c),this.element.classList.add(d),this.setAnimation("animateTo");break;default:document.body.appendChild(this.element),this.element.classList.add(b+"-"+this.options.content.effect,c)}return new Promise(function(a){return e.listener().then(function(){return a()})})}},{key:"remove",value:function(){try{this.element.parentNode.removeChild(this.element)}catch(a){}}},{key:"listener",value:function(){var a=this;return new Promise(function(b){return a.element.addEventListener("animationend",function(){return b()},!0)})}},{key:"setAnimation",value:function(){for(var a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:e,c=0,d=f.length;c<d;c++)this.element.classList.contains(b+"-"+f[c])&&this.element.classList.remove(b+"-"+f[c]);this.element.classList.add(b+"-"+this.options.content[a])}}]),a}(),t=function(){function a(b){var c=this;_classCallCheck(this,a),this.action=function(a){27===a.keyCode&&c._close()},this.options=new o(b),this.options.loader.active&&(this.loader=new p(this.options)),l.check(h,this.options.content.effect)&&(this.container=new q(this.options)),this.options.overlay.active&&(this.overlay=new r(this.options)),this.content=new s(this.options)}return _createClass(a,[{key:"open",value:function(){var a=this;this.content.fetch(this.options.content.target,this.options.content.width).then(function(){l.check(k,a.options.content.effect)&&(a.scroll=new m),a.options.overlay.active?(a.dispatchEvent("overlay.onOpen"),a.overlay.bind(c).then(function(){a.dispatchEvent("overlay.onComplete"),a.options.loader.active&&a.loader.destroy()})):a.options.loader.active&&a.loader.destroy(),a.container&&a.container.bind(c),a.content.bind(c).then(function(){return a.dispatchEvent("content.onComplete")}),a.dispatchEvent("content.onOpen"),a.listeners()}).catch(function(a){throw a})}},{key:"_close",value:function(){var a=this,b=[this.content.bind(d).then(function(){return a.content.remove()})];this.options.overlay.active&&b.push(this.overlay.bind(d).then(function(){a.scroll&&a.scroll.remove(),a.overlay.remove(),a.dispatchEvent("overlay.onClose")})),this.container&&b.push(this.container.bind(d).then(function(){return a.container.remove()})),Promise.all(b).then(function(){a.options.overlay.escKey&&document.removeEventListener("keydown",a.action,!0),a.dispatchEvent("content.onClose")})}},{key:"dispatchEvent",value:function(a){var c=new Event(b+":"+a),d=Object.create(this.options);document.dispatchEvent(c);try{a.split(".").reduce(function(a,b){return a[b]},d).call()}catch(a){}}},{key:"listeners",value:function(){var a=this;this.options.overlay.escKey&&document.addEventListener("keydown",this.action,!0),this.content.element.addEventListener("click",function(b){b.target===a.content.element&&a._close()},!0),this.content.element.addEventListener(b+":close",function(){a._close()},!0)}}],[{key:"close",value:function(a){var c=new Event(b+":close"),d=document.querySelectorAll("."+b+"-content");a&&(d=document.querySelectorAll("#"+b+"-"+a)),d[d.length-1].dispatchEvent(c)}},{key:"closeAll",value:function(){for(var a=new Event(b+":close"),c=document.querySelectorAll("."+b+"-content"),d=c.length,e=0;e<d;e++)c[e].dispatchEvent(a)}}]),a}();a.modal=t}(Custombox||(Custombox={}));
