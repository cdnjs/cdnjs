...
!function(e){function t(e){e&&"meta"in e&&"error_type"in e.meta&&(e.error={code:e.meta.error_type,message:e.meta.error_message})}function n(e){t(e),o(e);var n,r;if(e.query&&e.query.results&&e.query.results.contact){e.data=e.query.results.contact,delete e.query,e.data instanceof Array||(e.data=[e.data]);for(var i=0;i<e.data.length;i++){n=e.data[i],n.id=null;for(var a=0;a<n.fields.length;a++)r=n.fields[a],"email"===r.type&&(n.email=r.value),"name"===r.type&&(n.first_name=r.value.givenName,n.last_name=r.value.familyName,n.name=r.value.givenName+" "+r.value.familyName),"yahooid"===r.type&&(n.id=r.value)}}return e}function o(e){e.query&&e.query.count&&(e.paging={next:"?start="+e.query.count})}var r=function(e){return"https://query.yahooapis.com/v1/yql?q="+(e+" limit @{limit|100} offset @{start|0}").replace(/\s/g,"%20")+"&format=json"};e.init({yahoo:{oauth:{version:"1.0a",auth:"https://api.login.yahoo.com/oauth/v2/request_auth",request:"https://api.login.yahoo.com/oauth/v2/get_request_token",token:"https://api.login.yahoo.com/oauth/v2/get_token"},autorefresh:!1,base:"https://social.yahooapis.com/v1/",get:{me:r("select * from social.profile(0) where guid=me"),"me/friends":r("select * from social.contacts(0) where guid=me"),"me/following":r("select * from social.contacts(0) where guid=me")},wrap:{me:function(e){return t(e),e.query&&e.query.results&&e.query.results.profile&&(e=e.query.results.profile,e.id=e.guid,e.name=e.givenName+" "+e.familyName,e.last_name=e.familyName,e.first_name=e.givenName,e.email=e.emails?e.emails.handle:null,e.thumbnail=e.image?e.image.imageUrl:null),e},"me/friends":n,"me/following":n,"default":function(e){return o(e),e}},xhr:!1}})}(hello);