    ...
    if (route.InitialFallback) {
      {
        if (route.initialFallbackElement) {
          router.UNSAFE_warning(false, "You should not include both `InitialFallback` and `initialFallbackElement` on your route - " + "`InitialFallback` will be used.") ;
        }
      }
      Object.assign(updates, {
        initialFallbackElement: /*#__PURE__*/React__namespace.createElement(route.InitialFallback),
