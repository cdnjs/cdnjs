...
(function (global, factory) {
  ...
  function createRouter(init) {
    ...
    async function handleLoaders(request, location, matches, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace, initialHydration, flushSync, pendingActionResult) {
      ...
      let routesToUse = inFlightDataRoutes || dataRoutes;
      let [matchesToLoad, revalidatingFetchers] = getMatchesToLoad(init.history, state, matches, activeSubmission, location, initialHydration === true, future.unstable_skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, deletedFetchers, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult);
  ...
  */
  ...
  function Scripts(props) {
    ...
    let nextMatches = React__namespace.useMemo(() => {
      if (navigation.location) {
        ...
        !matches ? invariant$1(false, "No routes match path \"" + navigation.location.pathname + "\"")  : void 0;
        return matches;
      }
      return [];
  ...
  const _excluded$1 = ["onClick", "prefetch", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"],
  ...
  */
  ...
  function createClientRoutesWithHMRRevalidationOptOut(needsRevalidation, manifest, routeModulesCache, initialState, future, isSpaMode) {
    return createClientRoutes(manifest, routeModulesCache, initialState, future, isSpaMode, "", groupRoutesByParentId$1(manifest), needsRevalidation);
  }
