...
(function (global, factory) {
  ...
  class DeferredData {
    constructor(data, responseInit) {
      ...
      this.deferredKeys = [];
      !(data && typeof data === "object" && !Array.isArray(data)) ? invariant$2(false, "defer() only accepts plain objects")  : void 0;
    ...
    get unwrappedData() {
      !(this.data !== null && this.done) ? invariant$2(false, "Can only unwrap data on initialized and settled deferreds")  : void 0;
  ...
  function createRouter(init) {
    ...
    async function handleLoaders(request, location, matches, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace, initialHydration, flushSync, pendingActionResult) {
      ...
      let routesToUse = inFlightDataRoutes || dataRoutes;
      let [matchesToLoad, revalidatingFetchers] = getMatchesToLoad(init.history, state, matches, activeSubmission, location, initialHydration === true, future.unstable_skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult);
    ...
    async function handleFetcherAction(key, routeId, path, match, requestMatches, isFogOfWar, flushSync, submission) {
      ...
      let [matchesToLoad, revalidatingFetchers] = getMatchesToLoad(init.history, state, matches, submission, nextLocation, false, future.unstable_skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, [match.route.id, actionResult]);
    ...
    async function handleFetcherLoader(key, routeId, path, match, matches, isFogOfWar, flushSync, submission) {
      ...
      !!isDeferredResult(result) ? invariant$2(false, "Unhandled fetcher deferred data")  : void 0;
  ...
  function createStaticHandler$1(routes, opts) {
    ...
    // Config driven behavior flags
    _extends({}, opts == null ? void 0 : opts.future);
  ...
  function getMatchesToLoad(history, state, matches, submission, location, isInitialLoad, skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult) {
  ...
  async function resolveDeferredResults(currentMatches, matchesToLoad, results, signals, isFetcher, currentLoaderData) {
    for (let index = 0; index < results.length; index++) {
      ...
      if (isDeferredResult(result) && (isFetcher || isRevalidatingLoader)) {
        ...
        !signal ? invariant$2(false, "Expected an AbortSignal for revalidating fetcher deferred result")  : void 0;
  ...
  */
  ...
  function unwrapSingleFetchResult(result, routeId) {
    if ("error" in result) {
      ...
      return redirect$1(result.redirect, {
  ...
  */
  ...
  function createHydratedRouter() {
    ...
    if (!ssrInfo.stateDecodingPromise) {
      ...
      !stream ? invariant$1(false, "No stream found for single fetch decoding")  : void 0;
  ...
  function HydratedRouter() {
    ...
    !ssrInfo ? invariant$1(false, "ssrInfo unavailable for HydratedRouter")  : void 0;
  ...
  async function handleResourceRequest(serverMode, build, staticHandler, routeId, request, loadContext, handleError) {
    try {
      ...
      if (typeof response === "object" && response !== null) {
        !!(UNSAFE_DEFERRED_SYMBOL in response) ? "development" !== "production" ? invariant(false, "You cannot return a `defer()` response from a Resource Route.  Did you " + ("forget to export a default UI component from the \"" + routeId + "\" route?")) : invariant(false) : void 0;
      }
