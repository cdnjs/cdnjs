/**
 * React Router v0.0.0-experimental-e53172d16
 *
...
(function (global, factory) {
  ...
  */
  ...
  function isDeferredResponse(response) {
    ...
    return !!((_response$headers$get = response.headers.get("Content-Type")) != null && _response$headers$get.match(/text\/remix-deferred/));
  }
  ...
  async function fetchData(request, routeId, retry) {
    if (retry === void 0) {
      retry = 0;
    }
    let url = new URL(request.url);
    ...
    try {
      ...
      if (typeof criticalData === "object" && criticalData !== null) {
        for (let [eventKey, value] of Object.entries(criticalData)) {
          ...
          deferredData[eventKey] = new Promise((_resolve, _reject) => {
      ...
      void (async () => {
        try {
          ...
          var _iteratorError;
          try {
            for (var _iterator = _asyncIterator(sectionReader), _step; _iteratorAbruptCompletion = !(_step = await _iterator.next()).done; _iteratorAbruptCompletion = false) {
              let section = _step.value;
              {
      ...
      return new DeferredData(_extends({}, criticalData, deferredData));
    } catch (error) {
      for (let resolver of Object.values(deferredResolvers)) {
        resolver.reject(error);
      }
  ...
  function readStreamSections(_x) {
  ...
  function _readStreamSections() {
    _readStreamSections = _wrapAsyncGenerator(function* (stream) {
      ...
      let section = yield _awaitAsyncGenerator(readStreamSection());
      while (section) {
        yield section;
        section = yield _awaitAsyncGenerator(readStreamSection());
      }
    });
    return _readStreamSections.apply(this, arguments);
  }
  ...
  async function fetchAndDecode(url, init) {
    ...
    if ((_res$headers$get = res.headers.get("Content-Type")) != null && _res$headers$get.includes("text/x-turbo")) {
  ...
  function PrefetchPageLinksImpl(_ref3) {
    ...
    let dataHrefs = React__namespace.useMemo(() => getDataLinkHrefs(page, newMatchesForData, manifest), [newMatchesForData, page, manifest]);
    ...
    if (!future.unstable_singleFetch) {
      ...
      linksToRender = dataHrefs.map(href => /*#__PURE__*/React__namespace.createElement("link", _extends({
        key: href,
        rel: "prefetch",
        as: "fetch",
        href: href
  ...
  function Scripts(props) {
    ...
    let initialScripts = React__namespace.useMemo(() => {
      ...
      let activeDeferreds = future.unstable_singleFetch ? undefined : staticContext == null ? void 0 : staticContext.activeDeferreds;
  ...
  function DeferredHydrationScript(_ref6) {
    let {
      dataKey,
      deferredData,
      routeId,
    ...
    if (typeof document === "undefined" && deferredData && dataKey && routeId) {
      !deferredData.pendingKeys.includes(dataKey) ? invariant(false, "Deferred data for route " + routeId + " with key " + dataKey + " was not pending but tried to render a script for it.")  : void 0;
    }
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Suspense, {
      ...
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : /*#__PURE__*/React__namespace.createElement("script", _extends({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
      ...
      children: data => {
        return /*#__PURE__*/React__namespace.createElement("script", _extends({}, scriptProps, {
          async: true,
          suppressHydrationWarning: true,
          dangerouslySetInnerHTML: {
    ...
    }) : /*#__PURE__*/React__namespace.createElement("script", _extends({}, scriptProps, {
      async: true,
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: {
        __html: " "
  ...
  function ErrorDeferredHydrationScript(_ref7) {
    let {
      dataKey,
      routeId,
      scriptProps,
  ...
  */
  ...
  function createHydratedRouter() {
    ...
    let router = createRouter({
      ...
      future: {
        ...
        unstable_skipActionErrorRevalidation: ssrInfo.context.future.unstable_singleFetch === true
      },
      hydrationData,
      mapRouteProperties,
      unstable_dataStrategy: ssrInfo.context.future.unstable_singleFetch ? getSingleFetchDataStrategy(ssrInfo.manifest, ssrInfo.routeModules) : undefined
    });
  ...
  function HydratedRouter() {
    ...
    return (
      ...
      React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(RemixContext.Provider, {
        ...
        router: router
      }))), ssrInfo.context.future.unstable_singleFetch ? /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null) : null)
    );
  }
  ...
  function RemixServer(_ref) {
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(RemixContext.Provider, {
      ...
      hydrate: false
    }))), context.future.unstable_singleFetch && context.serverHandoffStream ? /*#__PURE__*/React__namespace.createElement(React__namespace.Suspense, null, /*#__PURE__*/React__namespace.createElement(StreamTransfer, {
      context: context,
      identifier: 0,
      ...
      if (routerRef.current == null) {
        remixContextRef.current = {
          future: {
            ...
            unstable_singleFetch: (future == null ? void 0 : future.unstable_singleFetch) === true
          },
          manifest: {
            routes: {},
            entry: {
