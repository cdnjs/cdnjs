...
(function (global, factory) {
  ...
  function useNavigate() {
    let isDataRouter = React__namespace.useContext(DataRouterContext) != null; // Conditional usage is OK here because the usage of a data router is static
    // eslint-disable-next-line react-hooks/rules-of-hooks
  ...
  function useNavigateUnstable() {
    ...
    let navigate = React__namespace.useCallback(function (to, options) {
      ...
      router.UNSAFE_warning(activeRef.current, navigateEffectWarning) ; // Short circuit here since if this happens on first render the navigate
  ...
  function RouterProvider(_ref) {
    ...
    let [state, setState] = React__namespace.useState(router.state); // Need to use a layout effect here so we are subscribed early enough to
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(DataRouterContext.Provider, {
      ...
      navigator: navigator
    }, router.state.initialized ? /*#__PURE__*/React__namespace.createElement(DataRoutes, {
