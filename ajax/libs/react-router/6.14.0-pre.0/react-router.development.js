...
(function (global, factory) {
  ...
  function useBlocker(shouldBlock) {
    ...
    let [blocker, setBlocker] = React__namespace.useState(router.IDLE_BLOCKER);
    ...
    React__namespace.useEffect(() => {
      ...
      setBlocker(router$1.getBlocker(key, blockerFunction));
      setBlockerKey(key);
      return () => router$1.deleteBlocker(key);
    }, [router$1, setBlocker, setBlockerKey, blockerFunction]);
