...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom'), require('turbo-stream')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom', 'turbo-stream'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReactRouter = {}, global.React, global.ReactDOM, global.turboStream));
})(this, (function (exports, React, ReactDOM, turboStream) { 'use strict';
  ...
  class DeferredData {
    constructor(data, responseInit) {
      ...
      this.deferredKeys = [];
      !(data && typeof data === "object" && !Array.isArray(data)) ? invariant$1(false, "defer() only accepts plain objects")  : void 0;
    ...
    get unwrappedData() {
      !(this.data !== null && this.done) ? invariant$1(false, "Can only unwrap data on initialized and settled deferreds")  : void 0;
  ...
  function createRouter(init) {
    ...
    async function handleFetcherLoader(key, routeId, path, match, matches, flushSync, submission) {
      ...
      !!isDeferredResult(result) ? invariant$1(false, "Unhandled fetcher deferred data")  : void 0;
  ...
  async function callLoaderOrAction(type, request, match, manifest, mapRouteProperties, handlerOverride, staticContext) {
    ...
    try {
      ...
      !(result.result !== undefined) ? "development" !== "production" ? invariant$1(false, "You defined " + (type === "action" ? "an action" : "a loader") + " for route " + ("\"" + match.route.id + "\" but didn't return anything from your `" + type + "` ") + "function. Please return a value or `null`.") : invariant$1(false) : void 0;
    } catch (e) {
  ...
  async function resolveDeferredResults(currentMatches, matchesToLoad, results, signals, isFetcher, currentLoaderData) {
    for (let index = 0; index < results.length; index++) {
      ...
      if (isDeferredResult(result) && (isFetcher || isRevalidatingLoader)) {
        ...
        !signal ? invariant$1(false, "Expected an AbortSignal for revalidating fetcher deferred result")  : void 0;
  ...
  */
  ...
  const startTransitionImpl$1 = React__namespace[START_TRANSITION$1];
  ...
  function RouterProvider$1(_ref) {
    ...
    }, state.initialized || router.future.v7_partialHydration ? /*#__PURE__*/React__namespace.createElement(DataRoutes$2, {
      routes: router.routes,
      future: router.future,
      state: state
    }) : fallbackElement))), null);
  }
  function DataRoutes$2(_ref2) {
    let {
      routes,
      future,
      state
  ...
  */
  ...
  function useRemixContext() {
    ...
    !context ? invariant(false, "You must render this element inside a <Remix> element")  : void 0;
    return context;
  }
  ...
  function usePrefetchBehavior(prefetch, theirElementProps) {
    let remixContext = React__namespace.useContext(RemixContext);
  ...
  function PrefetchPageLinks(_ref2) {
    let {
      ...
      dataLinkProps = _objectWithoutPropertiesLoose(_ref2, _excluded$1);
    let {
      router
  ...
  function Scripts(props) {
    ...
    let nextMatches = React__namespace.useMemo(() => {
      if (navigation.location) {
        ...
        !matches ? invariant(false, "No routes match path \"" + navigation.location.pathname + "\"")  : void 0;
        return matches;
      }
      return [];
  ...
  const _excluded = ["onClick", "prefetch", "relative", "reloadDocument", "replace", "state", "target", "to", "preventScrollReset", "unstable_viewTransition"],
  ...
  */
  ...
  function RouterProvider(_ref) {
    ...
    }, state.initialized || router.future.v7_partialHydration ? /*#__PURE__*/React__namespace.createElement(DataRoutes$1, {
      routes: router.routes,
      future: router.future,
      state: state
    }) : fallbackElement))))), null);
  ...
  */
    ...
    return {
      ...
      get future() {
        ...
        return {
          v7_fetcherPersist: false,
          v7_normalizeFormMethod: false,
          v7_partialHydration: ((_opts$future = opts.future) == null ? void 0 : _opts$future.v7_partialHydration) === true,
          v7_prependBasename: false,
          v7_relativeSplatPath: ((_opts$future2 = opts.future) == null ? void 0 : _opts$future2.v7_relativeSplatPath) === true,
          unstable_skipActionErrorRevalidation: false
        };
      },
      get state() {
  ...
  function BoundaryShell(_ref2) {
    ...
    if ((_routeModules$root = routeModules.root) != null && _routeModules$root.Layout) {
      return children;
    }
  ...
  function createClientRoutes(manifest, routeModulesCache, initialState, future, isSpaMode, parentId, routesByParentId, needsRevalidation) {
    if (parentId === void 0) {
      parentId = "";
    }
    if (routesByParentId === void 0) {
  ...
  let hmrInfo = null;
  if (({ url: (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('react-router.development.js', document.baseURI).href)) }) &&
  // @ts-expect-error
  undefined && window.__remixManifest) {
    let resolve;
    ...
    // @ts-expect-error
    undefined.accept("remix:manifest", async _ref => {
      ...
      let newRouteModules = Object.assign({}, ssrInfo.routeModules, Object.fromEntries((await Promise.all(routeIds.map(async id => {
        ...
        !ssrInfo ? invariant(false, "ssrInfo unavailable for HMR update")  : void 0;
  ...
  function createHydratedRouter() {
    ...
    let routes = createClientRoutes(ssrInfo.manifest.routes, ssrInfo.routeModules, ssrInfo.context.state, ssrInfo.context.future, ssrInfo.context.isSpaMode);
    ...
    let router = createRouter({
      ...
      hydrationData,
      mapRouteProperties,
      unstable_dataStrategy: getSingleFetchDataStrategy(ssrInfo.manifest, ssrInfo.routeModules)
    });
  ...
  function HydratedRouter() {
    ...
    return (
      ...
      React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(RemixContext.Provider, {
        value: {
  ...
  function RemixServer(_ref) {
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement(RemixContext.Provider, {
      value: {
        manifest,
        routeModules,
        criticalCss,
  ...
  function createRemixStub(routes, context) {
    ...
    return function RemixStub(_ref) {
      let {
        initialEntries,
        initialIndex,
        hydrationData,
      ...
      return /*#__PURE__*/React__namespace.createElement(RemixContext.Provider, {
  ...
  exports.RouterProvider = RouterProvider$1;
  ...
  exports.UNSAFE_RemixContext = RemixContext;
