	...
	function createTransitionManager(history, routes) {
	  ...
	  function isActive(location) {
	    ...
	    if (indexOnlyOrDeprecatedQuery && indexOnlyOrDeprecatedQuery !== true || deprecatedIndexOnly !== null) {
	       false ? _warning2['default'](false, '`isActive(pathname, query, indexOnly) is deprecated; use `isActive(location, indexOnly)` with a location descriptor instead') : undefined;
	...
	var Link = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var props = _objectWithoutProperties(_props2, ['to', 'query', 'hash', 'state', 'activeClassName', 'activeStyle', 'onlyActiveOnIndex']);
	     ...
	     false ? _warning2['default'](!(query || hash || state), 'the `query`, `hash`, and `state` props on `<Link>` are deprecated; use a location descriptor instead') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouterContext = _react2['default'].createClass({
	  ...
	  getChildContext: function getChildContext() {
	    ...
	    if (false) {
	      location = _deprecateObjectProperties2['default'](location, '`context.location` is deprecated, please use a route component\'s `props.location` instead. If this is a deeply nested component, please refer to the strategies described in https://github.com/rackt/react-router/blob/v1.1.0/CHANGES.md#v110');
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createRoutingHistory(history, transitionManager) {
	  ...
	  if (false) {
	    history = _deprecateObjectProperties2['default'](history, '`props.history` and `context.history` are deprecated; use `props.router` on route components and `context.router` on deeper components.');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createRouterHistory(createHistory) {
	  var history = _historyLibUseBasename2['default'](_historyLibUseQueries2['default'](createHistory))();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _warning2['default'](false, 'the `History` mixin is deprecated, please access `context.router` with your own `contextTypes` or see https://github.com/rackt/react-router/blob/v1.1.0/CHANGES.md#v110 for more options') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lifecycle = {
	  ...
	  componentDidMount: function componentDidMount() {
	     false ? _warning2['default'](false, 'the `Lifecycle` mixin is deprecated, please use `this.props.router.setRouteLeaveHook(this.props.route, hook)` from a route component, see https://github.com/rackt/react-router/blob/v1.1.0/CHANGES.md#v110 for more details.') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouteContext = {
	  ...
	  componentWillMount: function componentWillMount() {
	     false ? _warning2['default'](false, 'the `RouteContext` mixin is deprecated, please export `this.props.route` from a route component yourself. See https://github.com/rackt/react-router/blob/v1.1.0/CHANGES.md#v110 for more details.') : undefined;
	  }
	...
	var Router = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    var stringifyQuery = _props2.stringifyQuery;
	     ...
	     false ? _warning2['default'](!(parseQueryString || stringifyQuery), '`parseQueryString` and `stringifyQuery` are deprecated, please create a custom `history` as described in https://github.com/rackt/react-router/blob/v1.1.0/CHANGES.md#v110') : undefined;
	  ...
	  wrapDeprecatedHistory: function wrapDeprecatedHistory(history) {
	    ...
	    if (history) {
	      ...
	      createHistory = function () {
	       ...
	       false ? _warning2['default'](false, 'the default hash history is deprecated; use the `hashHistory` singleton instead') : undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createRouterHistory = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function useRoutes(createHistory) {
	   false ? _warning2['default'](false, '`useRoutes` is deprecated; use `createTransitionManager` instead') : undefined;
