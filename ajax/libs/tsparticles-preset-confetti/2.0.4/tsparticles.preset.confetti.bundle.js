...
var esm = __webpack_require__(862);
...
const tsparticles_engine_1 = __webpack_require__(862);

const tsparticles_updater_angle_1 = __webpack_require__(43);

const tsparticles_move_base_1 = __webpack_require__(78);

const tsparticles_shape_circle_1 = __webpack_require__(523);

const tsparticles_updater_color_1 = __webpack_require__(227);

const tsparticles_plugin_emitters_1 = __webpack_require__(167);

const tsparticles_updater_life_1 = __webpack_require__(824);

const tsparticles_updater_opacity_1 = __webpack_require__(834);

const options_1 = __webpack_require__(689);

const tsparticles_updater_out_modes_1 = __webpack_require__(585);

const tsparticles_updater_roll_1 = __webpack_require__(162);

const tsparticles_updater_size_1 = __webpack_require__(204);

const tsparticles_shape_square_1 = __webpack_require__(233);

const tsparticles_updater_tilt_1 = __webpack_require__(459);

const tsparticles_updater_wobble_1 = __webpack_require__(582);
...
function confetti(idOrOptions, confettiOptions) {
  ...
  loadPreset(tsparticles_engine_1.tsParticles, options, true);
  tsparticles_engine_1.tsParticles.load(id, {
    preset: "confetti"
  });
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadSquareShape": function() { return /* binding */ loadSquareShape; }
});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadRollUpdater": function() { return /* binding */ loadRollUpdater; }
});
  ...
  init(particle) {
    ...
    if (rollOpt.enable) {
      particle.roll = {
        ...
        speed: (0,esm.getRangeValue)(rollOpt.speed) / 360
      };

      if (rollOpt.backColor) {
        particle.backColor = (0,esm.colorToHsl)(rollOpt.backColor);
      } else if (rollOpt.darken.enable && rollOpt.enlighten.enable) {
        const alterType = Math.random() >= 0.5 ? "darken" : "enlighten";
        particle.roll.alter = {
          type: alterType,
          value: (0,esm.getRangeValue)(alterType === "darken" ? rollOpt.darken.value : rollOpt.enlighten.value)
        };
      } else if (rollOpt.darken.enable) {
        particle.roll.alter = {
          type: "darken",
          value: (0,esm.getRangeValue)(rollOpt.darken.value)
        };
      } else if (rollOpt.enlighten.enable) {
        particle.roll.alter = {
          type: "enlighten",
          value: (0,esm.getRangeValue)(rollOpt.enlighten.value)
        };
      }
    } else {
      particle.roll = {
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadTiltUpdater": function() { return /* binding */ loadTiltUpdater; }
});
...
class TiltUpdater {
  ...
  init(particle) {
    ...
    particle.tilt = {
      ...
      value: (0,esm.getRangeValue)(tiltOptions.value) * Math.PI / 180,
    ...
    if (tiltAnimation.enable) {
      particle.tilt.velocity = (0,esm.getRangeValue)(tiltAnimation.speed) / 360 * this.container.retina.reduceFactor;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadWobbleUpdater": function() { return /* binding */ loadWobbleUpdater; }
});
...
class WobbleUpdater {
  ...
  init(particle) {
    ...
    if (wobbleOpt.enable) {
      particle.wobble = {
        angle: Math.random() * Math.PI * 2,
        speed: (0,esm.getRangeValue)(wobbleOpt.speed) / 360
      };
    } else {
      particle.wobble = {
        angle: 0,
    ...
    particle.retina.wobbleDistance = (0,esm.getRangeValue)(wobbleOpt.distance) * this.container.retina.pixelRatio;
  }
...
const preset_1 = __webpack_require__(695);

Object.defineProperty(exports, "confetti", ({
  enumerable: true,
  get: function () {
    return preset_1.confetti;
  }
}));
Object.defineProperty(exports, "loadConfettiPreset", ({
  enumerable: true,
  get: function () {
    return preset_1.loadConfettiPreset;
  }
}));
...
(0, preset_1.loadConfettiPreset)(tsparticles_engine_1.tsParticles);
}();
