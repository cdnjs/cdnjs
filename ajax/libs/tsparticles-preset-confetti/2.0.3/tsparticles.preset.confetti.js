...
function loadPreset(engine, confettiOptions, override = false) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield engine.addPreset("confetti", loadOptions(confettiOptions), override);
  });
}
...
function confetti(idOrOptions, confettiOptions) {
  ...
  loadPreset(external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.tsParticles, options, true);
  external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.tsParticles.load(id, {
    preset: "confetti"
  });
}
