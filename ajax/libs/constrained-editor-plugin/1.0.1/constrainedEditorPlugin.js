...
__webpack_require__("./src/utils sync recursive").config({ paths: { vs: '../node_modules/monaco-editor/dev/vs' } });
Promise.resolve(/*! AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [Object(function webpackMissingModule() { var e = new Error("Cannot find module 'vs/editor/editor.main'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())]; (function () {
