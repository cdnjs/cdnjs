...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (constrainModel);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ constrainedEditor)
/* harmony export */ });
...
/* harmony import */ var _constrainModel_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constrainModel.js */ "./src/constrainModel.js");
  ...
  const addRestrictionsTo = function (model, ranges) {
    if (isModelValid(model)) {
      if (isRangesValid(ranges)) {
        const constrainedModel = (0,_constrainModel_js__WEBPACK_IMPORTED_MODULE_2__.default)(model, ranges, monaco, manipulator._editorInstance);
