...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function HalResourceClientFactory(e,r,n){function t(t,u){function i(r,i,a,l,o){var d;if(r=r||"GET",i=i||n.selfLink,a=a||{},l=l||null,o=o||{},"GET"===r&&i===n.selfLink)return e.resolve(t);if(t.$hasEmbedded(i)&&Array.isArray(u[i])){d=[];for(var f=0;f<u[i].length;f++)d.push(u[i][f].$request().$request(r,"self",a,l,o));return e.all(d)}if(t.$hasEmbedded(i))return u[i].$request().$request(r,"self",a,l,o);if(t.$hasLink(i)){var s=t.$href(i,a);if(angular.extend(o,{method:r,data:l}),Array.isArray(s)){d=[];for(var c=0;c<s.length;c++)d.push(v(angular.extend({},o,{url:s[c]})));return e.all(d)}return g(i,a,o)}return e.reject(new Error('link "'+i+'" is undefined'))}function a(e,r,n){return i("GET",e,r,void 0,n)}function l(e,r,n){return a(e,r,n).then(function(r){return r.$has(e)?r.$request().$get(e):[]})}function o(e,r,n,t){return i("POST",e,r,n,t)}function d(e,r,n,t){return i("PUT",e,r,n,t)}function f(e,r,n,t){return i("PATCH",e,r,n,t)}function s(e,r,n){return i("DELETE",e,r,void 0,n)}function c(e,r,n,t){return t=t||{},t.headers=t.headers||{},t.headers.Link=n.map(h),i("LINK",e,r,void 0,t)}function $(e,r,n,t){return t=t||{},t.headers=t.headers||{},t.headers.Link=n.map(h),i("UNLINK",e,r,void 0,t)}function h(e){return e.toString()}function y(e){var r=angular.extend({},e,{method:"GET"});return g(n.selfLink,{},r)}function g(e,r,n){return v(angular.extend({},n,{url:t.$href(e,r)}))}var p=this,v=r.get("$http");!function(){(0,_extendReadOnly2["default"])(p,{$request:i,$get:a,$getCollection:l,$post:o,$put:d,$patch:f,$delete:s,$del:s,$link:c,$unlink:$,$getSelf:y})}()}return t}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=HalResourceClientFactory;var _extendReadOnly=require("../utility/extend-read-only"),_extendReadOnly2=_interopRequireDefault(_extendReadOnly);HalResourceClientFactory.$inject=["$q","$injector","$halConfiguration"];
