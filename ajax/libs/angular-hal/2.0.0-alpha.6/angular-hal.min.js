...
!function(a){"use strict";a.module("angular-hal.http-interception",["angular-hal.resource","angular-hal.configuration","angular-hal.content-type"])}(angular);
...
!function(n){"use strict";function t(n){function t(){if("undefined"!=typeof n.contentType)return n.contentType;if("undefined"!=typeof require)return require("content-type");throw new Error("Could not find content-type library.")}function e(n,t){return"string"!=typeof n?!1:r.parse(n).type===t}var r,o=this;!function(){r=t(),o.match=e}()}n.service("$contentType",t),t.$inject=["$window"]}(angular.module("angular-hal.content-type"));
