...
(function (global, factory) {
    ...
    CropperElement.$version = '2.0.0-rc';
    ...
    CropperCanvas.$version = '2.0.0-rc';
    ...
    CropperHandle.$version = '2.0.0-rc';
        ...
        $handleAction(event) {
            ...
            if (currentTarget && detail) {
                ...
                switch (action) {
                    ...
                    case ACTION_MOVE:
                        if (this.movable && (this.linked
                            || (this.$actionStartTarget && this.contains(this.$actionStartTarget)))) {
                            this.$move(moveX, moveY);
                        }
                        break;
                    case ACTION_SCALE:
                        if (relatedEvent && this.zoomable && (this.linked
    ...
    CropperSelection.$version = '2.0.0-rc';
    ...
    CropperCrosshair.$version = '2.0.0-rc';
    ...
    CropperViewer.$version = '2.0.0-rc';
