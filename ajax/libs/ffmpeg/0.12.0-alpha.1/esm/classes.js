...
export class FFmpeg extends EventEmitter {
    /** @event */ static DOWNLOAD = "download";
    /** @event */ static LOG = "log";
    /** @event */ static PROGRESS = "progress";
    #worker = null;
    /**
            ...
            this.#worker.onmessage = ({ data: { id, type, data }, }) => {
                switch (type) {
                    ...
                    case FFMessageType.DOWNLOAD:
                        this.emit(FFmpeg.DOWNLOAD, data);
                        break;
                    case FFMessageType.LOG:
                        this.emit(FFmpeg.LOG, data);
                        break;
                    case FFMessageType.PROGRESS:
                        this.emit(FFmpeg.PROGRESS, data);
                        break;
