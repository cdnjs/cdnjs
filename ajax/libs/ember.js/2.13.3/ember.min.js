...
var un=r.Ops,ln=function(){function e(e,t,n){this.env=e,this.table=t,this.statements=n}return e.prototype.scan=function(){var e=[]
return this.specializeStatements(this.statements,e),new on(e,this.table)},e.prototype.specializeStatements=function(e,t){for(var n=0;n<e.length;n++){var r=e[n]
...
return s.push([un.OpenElement,n,[]]),this.specializeStatements(r.attrs,s),s.push([un.FlushElement]),this.specializeStatements(r.statements,s),s.push([un.CloseElement]),s},e.prototype.child=function(t){if(!t)return null
...
var p=t.dictionary(null),h=(""+Math.random()+Date.now()).replace(".","")}),s("dag-map",["exports"],function(e){"use strict"
...
var i=["router:main",o.privatize(u),"-view-registry:main","renderer:-"+(r.isInteractive?"dom":"inert"),"service:-document"]
...
e._registerMacros=g.registerMacros
e._experimentalMacros=g.experimentalMacros})
...
f(e,o)}return{blocks:e,inlines:o}}e.registerMacros=f,e.populateMacros=d
var m=[]
