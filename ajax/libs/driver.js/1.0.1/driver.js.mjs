...
function he(e, t) {
  ...
  const P = () => {
    ...
    t.popover && y && !v && u && (X(e, t), v = !0), a("animate") && S < 400 ? ae(S, 400, r, e) : (Q(e), l && l(w ? void 0 : e, t, {
      config: a(),
      state: d()
...
function X(e, t) {
  ...
  const P = ((S = t.popover) == null ? void 0 : S.popoverClass) || a("popoverClass") || "";
  ...
  ), b("popover", o), te(e, t), j(u);
  const k = ((C = t.popover) == null ? void 0 : C.onPopoverRendered) || a("onPopoverRendered");
  k && k(o, {
    config: a(),
    state: d()
  });
...
function te(e, t) {
  ...
  const S = !c && !g && !v && !k;
  let C = f;
  if (f === "top" && c ? k = v = g = !1 : f === "bottom" && g ? k = v = c = !1 : f === "left" && v ? k = c = g = !1 : f === "right" && k && (v = c = g = !1), f === "over") {
  ...
  S ? o.arrow.classList.add("driver-popover-arrow-none") : ye(r, C, e);
}
function ye(e, t, o) {
  const n = d("popover");
  if (!n)
...
function be(e = {}) {
  ...
  function i(s = 0) {
    ...
    b("activeIndex", s);
    const c = l[s], m = l[s + 1], g = l[s - 1], u = ((H = c.popover) == null ? void 0 : H.doneBtnText) || a("doneBtnText") || "Done", v = a("allowClose"), P = typeof ((E = c.popover) == null ? void 0 : E.showProgress) < "u" ? (B = c.popover) == null ? void 0 : B.showProgress : a("showProgress"), S = (((A = c.popover) == null ? void 0 : A.progressText) || a("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${s + 1}`).replace("{{total}}", `${l.length}`), C = ((O = c.popover) == null ? void 0 : O.showButtons) || a("showButtons"), y = [
      "next",
      "previous",
      ...v ? ["close"] : []
