...
function ae(e) {
  const t = le(e);
  document.body.appendChild(t), G(t, (o) => {
...
function Z(e) {
  const t = window.innerWidth, o = window.innerHeight, n = l("stagePadding") || 0, p = l("stageRadius") || 0, r = e.width + n * 2, v = e.height + n * 2, f = Math.min(p, r / 2, v / 2), i = Math.floor(Math.max(f, 0)), c = e.x - n + i, a = e.y - n, s = r - i * 2, w = v - i * 2;
  return `M${t},0L0,0L0,${o}L${t},${o}L${t},0Z
    M${c},${a} h${s} a${i},${i} 0 0 1 ${i},${i} v${w} a${i},${i} 0 0 1 -${i},${i} h-${s} a${i},${i} 0 0 1 -${i},-${i} v-${w} a${i},${i} 0 0 1 ${i},-${i} z`;
}
function ce() {
...
function ue(e, t) {
  const n = Date.now(), p = d("activeStep"), r = d("activeElement") || e, v = !r || r === e, f = e.id === "driver-dummy-element", i = r.id === "driver-dummy-element", c = l("animate"), a = t.onHighlightStarted || l("onHighlightStarted"), s = (t == null ? void 0 : t.onHighlighted) || l("onHighlighted"), w = (p == null ? void 0 : p.onDeselected) || l("onDeselected"), m = l(), h = d();
  !v && w && w(i ? void 0 : r, p, {
    config: m,
    state: h
  }), a && a(f ? void 0 : e, t, {
  ...
  const L = () => {
    ...
    t.popover && y && !g && u && (V(e, t), g = !0), l("animate") && C < 400 ? re(C, 400, r, e) : (j(e), s && s(f ? void 0 : e, t, {
      config: l(),
      state: d()
...
function M() {
  ...
  e && window.cancelAnimationFrame(e), b("__resizeTimeout", window.requestAnimationFrame(pe));
}
function he(e) {
...
function fe() {
  window.addEventListener("keyup", he, !1), window.addEventListener("resize", M), window.addEventListener("scroll", M);
}
function ge() {
...
function V(e, t) {
  ...
  const s = r || l("showButtons"), w = f || l("showProgress") || !1, m = (s == null ? void 0 : s.includes("next")) || (s == null ? void 0 : s.includes("previous")) || w;
  o.closeButton.style.display = s.includes("close") ? "block" : "none", m ? (o.footer.style.display = "flex", o.progress.style.display = w ? "block" : "none", o.nextButton.style.display = s.includes("next") ? "block" : "none", o.previousButton.style.display = s.includes("previous") ? "block" : "none") : o.footer.style.display = "none";
  ...
  u.className = `driver-popover ${L}`.trim(), G(
    o.wrapper,
    (y) => {
      var E, B, A;
...
function U(e, t) {
  ...
  if (!o)
    return;
  const { align: n = "start", side: p = "left" } = (t == null ? void 0 : t.popover) || {}, r = n, v = e.id === "driver-dummy-element" ? "over" : p, f = l("stagePadding") || 0, i = J(), c = o.arrow.getBoundingClientRect(), a = e.getBoundingClientRect(), s = a.top - i.height;
  let w = s >= 0;
...
function me(e, t, o) {
  ...
  if (!n)
    return;
  const p = o.getBoundingClientRect(), r = J(), v = n.arrow, f = r.width, i = window.innerWidth, c = p.width, a = p.left, s = r.height, w = window.innerHeight, m = p.top, h = p.height;
  v.className = "driver-popover-arrow";
  let u = t, g = e;
  t === "top" ? (a + c <= 0 ? (u = "right", g = "end") : a + c - f <= 0 && (u = "top", g = "start"), a >= i ? (u = "left", g = "end") : a + f >= i && (u = "top", g = "end")) : t === "bottom" ? (a + c <= 0 ? (u = "right", g = "start") : a + c - f <= 0 && (u = "bottom", g = "start"), a >= i ? (u = "left", g = "start") : a + f >= i && (u = "bottom", g = "end")) : t === "left" ? (m + h <= 0 ? (u = "bottom", g = "end") : m + h - s <= 0 && (u = "left", g = "start"), m >= w ? (u = "top", g = "end") : m + s >= w && (u = "left", g = "end")) : t === "right" && (m + h <= 0 ? (u = "bottom", g = "start") : m + h - s <= 0 && (u = "right", g = "start"), m >= w ? (u = "top", g = "start") : m + s >= w && (u = "right", g = "end")), u ? (v.classList.add(`driver-popover-arrow-side-${u}`), v.classList.add(`driver-popover-arrow-align-${g}`)) : v.classList.add("driver-popover-arrow-none");
}
function ye() {
...
function Ce(e = {}) {
  ...
  function p() {
    ...
    if (d("__transitionCallback"))
      return;
    const a = d("activeIndex"), s = d("activeStep"), w = d("activeElement");
  ...
  function f(c = 0) {
    ...
    b("activeIndex", c);
    const s = a[c], w = a[c + 1], m = a[c - 1], h = (($ = s.popover) == null ? void 0 : $.doneBtnText) || l("doneBtnText") || "Done", u = l("allowClose"), g = typeof ((H = s.popover) == null ? void 0 : H.showProgress) < "u" ? (E = s.popover) == null ? void 0 : E.showProgress : l("showProgress"), P = (((B = s.popover) == null ? void 0 : B.progressText) || l("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${c + 1}`).replace("{{total}}", `${a.length}`), C = ((A = s.popover) == null ? void 0 : A.showButtons) || l("showButtons"), k = [
      "next",
      "previous",
      ...u ? ["close"] : []
    ].filter((ee) => !(C != null && C.length) || C.includes(ee)), y = ((O = s.popover) == null ? void 0 : O.onNextClick) || l("onNextClick"), x = ((z = s.popover) == null ? void 0 : z.onPrevClick) || l("onPrevClick"), T = ((D = s.popover) == null ? void 0 : D.onCloseClick) || l("onCloseClick");
    q({
      ...s,
      popover: {
        showButtons: k,
  ...
  function i(c = !0) {
    const a = d("activeElement"), s = d("activeStep"), w = l("onDestroyStarted");
    if (c && w) {
    ...
    if (document.body.classList.remove("driver-active", "driver-fade", "driver-simple"), ge(), xe(), ve(), ce(), ie(), ne(), a && s) {
