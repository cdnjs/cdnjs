...
function ge(e, o) {
  const i = Date.now(), p = l("activeStep"), n = l("activeElement") || e, f = !n || n === e, w = e.id === "driver-dummy-element", r = n.id === "driver-dummy-element", v = a("animate"), s = o.onHighlightStarted || a("onHighlightStarted"), c = (o == null ? void 0 : o.onHighlighted) || a("onHighlighted"), d = (p == null ? void 0 : p.onDeselected) || a("onDeselected"), m = a(), g = l();
  !f && d && d(r ? void 0 : n, p, {
    config: m,
    state: g
  }), s && s(w ? void 0 : e, o, {
...
function M() {
  ...
  e && window.cancelAnimationFrame(e), P("__resizeTimeout", window.requestAnimationFrame(he));
}
function me(e) {
  var r;
...
function ee(e) {
  (a("allowKeyboardControl") ?? !0) && (e.key === "Escape" ? T("escapePress") : e.key === "ArrowRight" ? T("arrowRightPress") : e.key === "ArrowLeft" && T("arrowLeftPress"));
}
function te(e, o, t) {
  const i = (n, f) => {
    const w = n.target;
...
function ye() {
  window.addEventListener("keyup", ee, !1), window.addEventListener("keydown", me, !1), window.addEventListener("resize", M), window.addEventListener("scroll", M);
}
function be() {
  window.removeEventListener("keyup", ee), window.removeEventListener("resize", M), window.removeEventListener("scroll", M);
}
function xe() {
  const e = l("popover");
...
function X(e, o) {
  ...
  const C = ((x = o.popover) == null ? void 0 : x.popoverClass) || a("popoverClass") || "";
  u.className = `driver-popover ${C}`.trim(), te(
    t.wrapper,
    (S) => {
      var B, _, R;
      const A = S.target, E = ((B = o.popover) == null ? void 0 : B.onNextClick) || a("onNextClick"), H = ((_ = o.popover) == null ? void 0 : _.onPrevClick) || a("onPrevClick"), $ = ((R = o.popover) == null ? void 0 : R.onCloseClick) || a("onCloseClick");
    ...
    (S) => !(t != null && t.description.contains(S)) && !(t != null && t.title.contains(S)) && S.className.includes("driver-popover")
  ), P("popover", t);
  ...
  const L = e.classList.contains("driver-dummy-element"), b = Q([u, ...L ? [] : [e]]);
...
function ie(e, o) {
  ...
  const L = !d && !g && !h && !k;
  let b = f;
  if (f === "top" && d ? k = h = g = !1 : f === "bottom" && g ? k = h = d = !1 : f === "left" && h ? k = d = g = !1 : f === "right" && k && (h = d = g = !1), f === "over") {
    const x = window.innerWidth / 2 - r.realWidth / 2, y = window.innerHeight / 2 - r.realHeight / 2;
    t.wrapper.style.left = `${x}px`, t.wrapper.style.right = "auto", t.wrapper.style.top = `${y}px`, t.wrapper.style.bottom = "auto";
  } else if (L) {
    const x = window.innerWidth / 2 - (r == null ? void 0 : r.realWidth) / 2, y = 10;
    t.wrapper.style.left = `${x}px`, t.wrapper.style.right = "auto", t.wrapper.style.bottom = `${y}px`, t.wrapper.style.top = "auto";
  } else if (h) {
    const x = Math.min(
      u,
    ...
    t.wrapper.style.left = `${x}px`, t.wrapper.style.top = `${y}px`, t.wrapper.style.bottom = "auto", t.wrapper.style.right = "auto", b = "left";
  } else if (k) {
    const x = Math.min(
      C,
      window.innerWidth - (r == null ? void 0 : r.realWidth) - v.width
    ...
    t.wrapper.style.right = `${x}px`, t.wrapper.style.top = `${y}px`, t.wrapper.style.bottom = "auto", t.wrapper.style.left = "auto", b = "right";
  } else if (d) {
    const x = Math.min(
      c,
    ...
    t.wrapper.style.top = `${x}px`, t.wrapper.style.left = `${y}px`, t.wrapper.style.bottom = "auto", t.wrapper.style.right = "auto", b = "top";
  } else if (g) {
    const x = Math.min(
      m,
    ...
    t.wrapper.style.left = `${y}px`, t.wrapper.style.bottom = `${x}px`, t.wrapper.style.top = "auto", t.wrapper.style.right = "auto", b = "bottom";
  }
  L ? t.arrow.classList.add("driver-popover-arrow-none") : Ce(n, b, e);
}
function Ce(e, o, t) {
  const i = l("popover");
  if (!i)
...
function Se(e = {}) {
  ...
  function w() {
    l("isInitialized") || (P("isInitialized", !0), document.body.classList.add("driver-active", a("animate") ? "driver-fade" : "driver-simple"), ye(), N("overlayClick", o), N("escapePress", o), N("arrowLeftPress", n), N("arrowRightPress", f));
  }
  function r(s = 0) {
    var E, H, $, B, _, R, z, q;
    const c = a("steps");
    ...
    const d = c[s], m = c[s + 1], g = c[s - 1], u = ((E = d.popover) == null ? void 0 : E.doneBtnText) || a("doneBtnText") || "Done", h = a("allowClose"), C = typeof ((H = d.popover) == null ? void 0 : H.showProgress) < "u" ? ($ = d.popover) == null ? void 0 : $.showProgress : a("showProgress"), L = (((B = d.popover) == null ? void 0 : B.progressText) || a("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${s + 1}`).replace("{{total}}", `${c.length}`), b = ((_ = d.popover) == null ? void 0 : _.showButtons) || a("showButtons"), x = [
      "next",
      "previous",
      ...h ? ["close"] : []
    ].filter((ne) => !(b != null && b.length) || b.includes(ne)), y = ((R = d.popover) == null ? void 0 : R.onNextClick) || a("onNextClick"), S = ((z = d.popover) == null ? void 0 : z.onPrevClick) || a("onPrevClick"), A = ((q = d.popover) == null ? void 0 : q.onCloseClick) || a("onCloseClick");
    K({
      ...d,
      popover: {
        showButtons: x,
  ...
  function v(s = !0) {
    ...
    if (s && g) {
      const C = !c || (c == null ? void 0 : c.id) === "driver-dummy-element";
      g(C ? void 0 : c, d, {
        config: a(),
        state: l()
      });
    ...
    if (document.body.classList.remove("driver-active", "driver-fade", "driver-simple"), be(), ke(), we(), ve(), ce(), V(), c && d) {
      const C = c.id === "driver-dummy-element";
      u && u(C ? void 0 : c, d, {
        config: a(),
        state: l()
      }), h && h(C ? void 0 : c, d, {
