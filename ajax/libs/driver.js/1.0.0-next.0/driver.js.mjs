...
function te(e, o, t, n) {
  let d = h("__activeStagePosition");
  const r = d || t.getBoundingClientRect(), u = n.getBoundingClientRect(), v = H(e, r.x, u.x - r.x, o), i = H(e, r.y, u.y - r.y, o), s = H(e, r.width, u.width - r.width, o), a = H(e, r.height, u.height - r.height, o);
  d = {
    x: v,
    y: i,
    width: s,
...
function oe() {
  const e = h("__activeStagePosition"), o = h("__stageSvg");
  if (!e)
    return;
  if (!o) {
...
function ie(e) {
  ...
  return d.setAttribute("d", Y(e)), d.style.fill = c("backdropColor") || "rgb(0,0,0)", d.style.opacity = `${c("opacity")}`, d.style.pointerEvents = "auto", d.style.cursor = "auto", n.appendChild(d), n;
}
function Y(e) {
  const o = window.innerWidth, t = window.innerHeight, n = c("stagePadding") || 0, d = c("stageRadius") || 0, r = e.width + n * 2, u = e.height + n * 2, v = Math.min(d, r / 2, u / 2), i = Math.floor(Math.max(v, 0)), s = e.x - n + i, a = e.y - n, l = r - i * 2, g = u - i * 2;
  return `M${o},0L0,0L0,${t}L${o},${t}L${o},0Z
    M${s},${a} h${l} a${i},${i} 0 0 1 ${i},${i} v${g} a${i},${i} 0 0 1 -${i},${i} h-${l} a${i},${i} 0 0 1 -${i},-${i} v-${g} a${i},${i} 0 0 1 ${i},-${i} z`;
}
function re() {
  const e = h("__stageSvg");
  e && e.remove();
}
function se() {
...
function ae() {
  const e = h("activeElement"), o = h("activeStep");
  e && (V(e), oe(), Q(e, o));
}
function le(e, o) {
  const n = Date.now(), d = h("activeStep"), r = h("activeElement") || e, u = !r || r === e, v = e.id === "driver-dummy-element", i = r.id === "driver-dummy-element", s = c("animate"), a = c("onHighlightStarted"), l = c("onHighlighted"), g = (d == null ? void 0 : d.onDeselected) || c("onDeselected"), m = c(), w = h();
  !u && g && g(i ? void 0 : r, d, {
    config: m,
    state: w
  }), a && a(v ? void 0 : e, o, {
  ...
  he();
  const L = () => {
    if (h("__transitionCallback") !== L)
      return;
    const S = Date.now() - n, y = 400 - S <= 400 / 2;
    o.popover && y && !f && p && (D(e, o), f = !0), c("animate") && S < 400 ? te(S, 400, r, e) : (V(e), l && l(v ? void 0 : e, o, {
      config: c(),
      state: h()
  ...
  b("__transitionCallback", L), window.requestAnimationFrame(L), q(e), !p && o.popover && D(e, o), r.classList.remove("driver-active-element"), e.classList.add("driver-active-element");
}
function ce() {
  var e;
...
function K(e, o, t) {
  const n = (r, u) => {
    const v = r.target;
    e.contains(v) && ((!t || t(v)) && r.preventDefault(), r.stopPropagation(), r.stopImmediatePropagation(), u == null || u(r));
  };
...
function D(e, o) {
  ...
  const {
    ...
    prevBtnText: s = c("prevBtnText") || "&larr; Previous",
    progressText: a = c("progressText") || "{current} of {total}"
  } = o.popover || {};
  ...
  const l = r || c("showButtons"), g = v || c("showProgress") || !1, m = (l == null ? void 0 : l.includes("next")) || (l == null ? void 0 : l.includes("previous")) || (l == null ? void 0 : l.includes("close")) || g;
  t.closeButton.style.display = l.includes("close") ? "block" : "none", m ? (t.footer.style.display = "flex", t.progress.style.display = g ? "block" : "none", t.nextButton.style.display = l.includes("next") ? "block" : "none", t.previousButton.style.display = l.includes("previous") ? "block" : "none") : t.footer.style.display = "none";
  const w = u || c("disableButtons") || [];
  ...
  const p = t.wrapper;
  p.style.display = "block", p.style.left = "", p.style.top = "", p.style.bottom = "", p.style.right = "";
  const f = t.arrow;
  f.className = "driver-popover-arrow";
  const L = ((S = o.popover) == null ? void 0 : S.popoverClass) || c("popoverClass") || "";
  p.className = `driver-popover ${L}`.trim(), K(
    t.wrapper,
    (y) => {
      var _, N, I;
      const x = y.target, A = ((_ = o.popover) == null ? void 0 : _.onNextClick) || c("onNextClick"), M = ((N = o.popover) == null ? void 0 : N.onPrevClick) || c("onPrevClick"), W = ((I = o.popover) == null ? void 0 : I.onCloseClick) || c("onCloseClick");
      if (x.classList.contains("driver-popover-next-btn"))
        return A ? A(e, o) : $("nextClick");
      if (x.classList.contains("driver-popover-prev-btn"))
        return M ? M(e, o) : $("prevClick");
      if (x.classList.contains("driver-popover-close-btn"))
        return W ? W(e, o) : $("closeClick");
    },
    (y) => !(t != null && t.description.contains(y)) && !(t != null && t.title.contains(y))
  ), b("popover", t), Q(e, o), q(p);
  const C = ((P = o.popover) == null ? void 0 : P.onPopoverRendered) || c("onPopoverRendered");
  C && C(t);
}
function j() {
  const e = h("popover");
  if (!(e != null && e.wrapper))
    return;
  const o = e.wrapper.getBoundingClientRect(), t = c("stagePadding") || 0, n = c("popoverOffset") || 0;
  return {
    width: o.width + t + n,
    height: o.height + t + n,
    realWidth: o.width,
...
function Q(e, o) {
  ...
  if (!t)
    return;
  const { align: n = "start", side: d = "left" } = (o == null ? void 0 : o.popover) || {}, r = n, u = e.id === "driver-dummy-element" ? "over" : d, v = c("stagePadding") || 0, i = j(), s = t.arrow.getBoundingClientRect(), a = e.getBoundingClientRect(), l = a.top - i.height;
  let g = l >= 0;
  const m = window.innerHeight - (a.bottom + i.height);
  let w = m >= 0;
  const p = a.left - i.width;
  let f = p >= 0;
  const L = window.innerWidth - (a.right + i.width);
  let C = L >= 0;
  const S = !g && !w && !f && !C;
  let P = u;
  if (u === "top" && g ? C = f = w = !1 : u === "bottom" && w ? C = f = g = !1 : u === "left" && f ? C = g = w = !1 : u === "right" && C && (f = g = w = !1), u === "over") {
...
function ve(e, o, t) {
  ...
  if (!n)
    return;
  const d = t.getBoundingClientRect(), r = j(), u = n.arrow, v = r.width, i = window.innerWidth, s = d.width, a = d.left, l = r.height, g = window.innerHeight, m = d.top, w = d.height;
  u.className = "driver-popover-arrow";
  let p = o, f = e;
  o === "top" ? (a + s <= 0 ? (p = "right", f = "end") : a + s - v <= 0 && (p = "top", f = "start"), a >= i ? (p = "left", f = "end") : a + v >= i && (p = "top", f = "end")) : o === "bottom" ? (a + s <= 0 ? (p = "right", f = "start") : a + s - v <= 0 && (p = "bottom", f = "start"), a >= i ? (p = "left", f = "start") : a + v >= i && (p = "bottom", f = "end")) : o === "left" ? (m + w <= 0 ? (p = "bottom", f = "end") : m + w - l <= 0 && (p = "left", f = "start"), m >= g ? (p = "top", f = "end") : m + l >= g && (p = "left", f = "end")) : o === "right" && (m + w <= 0 ? (p = "bottom", f = "start") : m + w - l <= 0 && (p = "right", f = "start"), m >= g ? (p = "top", f = "start") : m + l >= g && (p = "right", f = "end")), p ? (u.classList.add(`driver-popover-arrow-side-${p}`), u.classList.add(`driver-popover-arrow-align-${f}`)) : u.classList.add("driver-popover-arrow-none");
}
function fe() {
  ...
  return s.classList.add("driver-popover-next-btn"), s.innerHTML = "Next &rarr;", v.appendChild(i), v.appendChild(s), r.appendChild(u), r.appendChild(v), e.appendChild(d), e.appendChild(o), e.appendChild(t), e.appendChild(n), e.appendChild(r), {
    wrapper: e,
    arrow: o,
    title: t,
    description: n,
...
function we(e = {}) {
  ...
  function t() {
    const s = h("activeIndex"), a = c("steps") || [];
    if (typeof s > "u")
      return;
    const l = s + 1;
    a[l] ? v(l) : i();
  ...
  function d() {
    const s = c("steps") || [], a = h("activeIndex");
    if (typeof a > "u")
      return;
    const l = a - 1;
    s[l] && v(l);
  ...
  function r() {
    var m;
    const s = h("activeIndex"), a = h("activeStep"), l = h("activeElement");
    if (typeof s > "u" || typeof a > "u")
      return;
    const g = ((m = a.popover) == null ? void 0 : m.onNextClick) || c("onNextClick");
    if (g)
      return g(l, a, {
        config: c(),
        state: h()
  ...
  function u() {
    h("isInitialized") || (b("isInitialized", !0), document.body.classList.add("driver-active", c("animate") ? "driver-fade" : "driver-simple"), pe(), E("overlayClick", o), E("escapePress", o), E("arrowLeftPress", d), E("arrowRightPress", r));
  }
  function v(s = 0) {
    var S, P, y, x;
    const a = c("steps");
    ...
    const l = a[s], g = a[s + 1], m = a[s - 1], w = ((S = l.popover) == null ? void 0 : S.doneBtnText) || c("doneBtnText") || "Done", p = c("allowClose"), f = typeof ((P = l.popover) == null ? void 0 : P.showProgress) < "u" ? (y = l.popover) == null ? void 0 : y.showProgress : c("showProgress"), C = (((x = l.popover) == null ? void 0 : x.progressText) || c("progressText") || "{{current}} of {{total}}").replace("{{current}}", `${s + 1}`).replace("{{total}}", `${a.length}`);
    console.log(f), z({
      ...l,
      popover: {
        showButtons: ["next", "previous", ...p ? ["close"] : []],
  ...
  function i(s = !0) {
    const a = h("activeElement"), l = h("activeStep"), g = c("onDestroyStarted");
    if (s && g) {
      g(a, l, {
        config: c(),
        state: h()
    ...
    const m = (l == null ? void 0 : l.onDeselected) || c("onDeselected"), w = c("onDestroyed");
    if (document.body.classList.remove("driver-active", "driver-fade", "driver-simple"), ue(), ge(), ce(), re(), ee(), U(), a && l) {
      const p = a.id === "driver-dummy-element";
      m && m(p ? void 0 : a, l, {
        config: c(),
        state: h()
      }), w && w(p ? void 0 : a, l, {
