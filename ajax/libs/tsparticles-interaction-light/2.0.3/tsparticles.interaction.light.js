...
function drawLight(container, context, mousePos) {
  ...
  const gradientRgb = {
    start: (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToRgb)(lightGradient.start),
    stop: (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToRgb)(lightGradient.stop)
  };
...
function drawParticleShadow(container, context, particle, mousePos) {
  ...
  const shadowRgb = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToRgb)(shadowOptions.color);
...
class ExternalLighter extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ExternalInteractorBase {
  ...
  isEnabled() {
    ...
    return (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("light", events.onHover.mode);
  }
