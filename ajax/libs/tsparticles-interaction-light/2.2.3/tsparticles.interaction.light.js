...
class ExternalLighter extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ExternalInteractorBase {
  ...
  isEnabled(particle) {
    ...
    const res = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isInArray)("light"
    /* HoverMode.light */
    , events.onHover.mode);
...
var _ParticlesLighter_container;
...
class ParticlesLighter extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ParticlesInteractorBase {
  constructor(container) {
    ...
    _ParticlesLighter_container.set(this, void 0);

    __classPrivateFieldSet(this, _ParticlesLighter_container, container, "f");
  }
  ...
  async interact(particle) {
    const container = __classPrivateFieldGet(this, _ParticlesLighter_container, "f"),
          options = container.actualOptions;
...
_ParticlesLighter_container = new WeakMap();
