...
System.register("just-animate/index", ["just-animate/JustAnimate", "just-animate/plugins/waapi/KeyframePlugin", "just-animate/animations"], function (exports_99, context_99) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_99("JustAnimate", JustAnimate_1.JustAnimate);
            exports_99("animations", animations);
            just = new JustAnimate_1.JustAnimate();
            exports_99("just", just);
            just.inject(animations_3.ANIMATE_CSS);
            just.plugins.push(new KeyframePlugin_1.KeyframePlugin());
        }
    };
});
System.register("just-animate/just-animate-all", ["just-animate/JustAnimate", "just-animate/plugins/waapi/KeyframePlugin", "just-animate/animations"], function (exports_100, context_100) {
    "use strict";
