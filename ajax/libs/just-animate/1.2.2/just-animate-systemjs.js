...
System.register("just-animate/plugins/core/Animator", ["just-animate/common/lists", "just-animate/common/objects", "just-animate/common/type", "just-animate/common/math", "just-animate/common/errors", "just-animate/plugins/core/Dispatcher", "just-animate/plugins/core/easings", "just-animate/common/units", "just-animate/common/elements"], function (exports_93, context_93) {
    ...
    var lists_3, objects_1, type_7, math_1, errors_3, Dispatcher_1, easings_1, units_1, elements_2, noop, animationPadding, Animator;
    return {
        setters: [
            function (lists_3_1) {
                lists_3 = lists_3_1;
        ...
        execute: function () {
            ...
            Animator = (function () {
                ...
                Animator.prototype._addEvent = function (options) {
                    ...
                    var targets = elements_2.getTargets(event.targets);
...
System.register("just-animate/JustAnimate", ["just-animate/common/random", "just-animate/common/elements", "just-animate/plugins/core/Animator", "just-animate/plugins/core/TimeLoop", "just-animate/plugins/core/MixinService"], function (exports_94, context_94) {
    "use strict";
    var __moduleName = context_94 && context_94.id;
    var random_2, elements_3, Animator_1, TimeLoop_1, MixinService_1, JustAnimate;
    return {
        setters: [
            function (random_2_1) {
                random_2 = random_2_1;
        ...
        execute: function () {
            JustAnimate = (function () {
                ...
                JustAnimate.prototype.splitText = function (target) {
                    return elements_3.splitText(target);
                };
                /**
...
System.register("just-animate/plugins/waapi/waapi", [], function (exports_95, context_95) {
    "use strict";
...
System.register("just-animate/plugins/waapi/animator/KeyframeAnimator", [], function (exports_96, context_96) {
    "use strict";
...
System.register("just-animate/plugins/waapi/transform/keyframeOffsetComparer", [], function (exports_97, context_97) {
    "use strict";
...
System.register("just-animate/plugins/waapi/transform/expandOffsets", ["just-animate/common/type", "just-animate/common/objects", "just-animate/plugins/waapi/transform/keyframeOffsetComparer"], function (exports_98, context_98) {
    "use strict";
    ...
    exports_98("expandOffsets", expandOffsets);
    var type_8, objects_2, keyframeOffsetComparer_1;
    return {
        setters: [
            function (type_8_1) {
                type_8 = type_8_1;
...
System.register("just-animate/plugins/waapi/transform/resources", [], function (exports_99, context_99) {
    "use strict";
    ...
    return {
        setters: [],
        execute: function () {
            exports_99("propertyAliases", propertyAliases = {
                x: 'translateX',
                y: 'translateY',
                z: 'translateZ'
            });
            exports_99("transforms", transforms = [
                'perspective',
                'matrix',
                'translateX',
                'translateY',
...
System.register("just-animate/plugins/waapi/transform/propsToKeyframes", ["just-animate/common/units", "just-animate/common/errors", "just-animate/common/objects", "just-animate/plugins/waapi/transform/resources", "just-animate/common/type", "just-animate/plugins/waapi/transform/keyframeOffsetComparer"], function (exports_100, context_100) {
    "use strict";
    ...
    function propsToKeyframes(css, keyframes, ctx) {
        ...
        for (var prop in cssProps) {
            ...
            var val = objects_3.resolve(cssProps[prop], ctx);
            if (type_9.isArray(val)) {
        ...
        var includedTransforms = Object
            .keys(cssProps)
            .filter(function (c) { return resources_3.transforms.indexOf(c) !== -1; });
        var offsets = Object
        ...
        for (var i = offsets.length - 2; i > -1; --i) {
            ...
            for (var _i = 0, includedTransforms_1 = includedTransforms; _i < includedTransforms_1.length; _i++) {
                ...
                if (type_9.isDefined(keyframe[transform])) {
                    continue;
                }
                ...
                for (var j = i - 1; j > -1; --j) {
                    ...
                    if (type_9.isDefined(keyframe1[transform])) {
                ...
                if (startValue !== 0 && type_9.isDefined(startUnit) && type_9.isDefined(endUnitType) && startUnit !== endUnitType) {
                ...
                for (var j = startIndex; j < i + 1; j++) {
                    ...
                    var currentValueWithUnit = type_9.isDefined(endUnitType)
                        ? currentValue + endUnitType
                        : type_9.isDefined(startUnit)
    ...
    exports_100("propsToKeyframes", propsToKeyframes);
    var units_2, errors_4, objects_3, resources_3, type_9, keyframeOffsetComparer_2;
    return {
        setters: [
            function (units_2_1) {
                units_2 = units_2_1;
...
System.register("just-animate/plugins/waapi/transform/spaceKeyframes", [], function (exports_101, context_101) {
    "use strict";
    ...
    exports_101("spaceKeyframes", spaceKeyframes);
    return {
        setters: [],
        execute: function () {
        }
...
System.register("just-animate/plugins/waapi/transform/arrangeKeyframes", ["just-animate/common/lists"], function (exports_102, context_102) {
    "use strict";
...
System.register("just-animate/plugins/waapi/transform/fixPartialKeyframes", ["just-animate/common/lists", "just-animate/common/type"], function (exports_103, context_103) {
    "use strict";
    ...
    function fixPartialKeyframes(keyframes) {
        ...
        for (var i = 1; i < len; i++) {
            ...
            for (var prop in keyframe) {
                if (prop !== 'offset' && !type_10.isDefined(first[prop])) {
        ...
        for (var i = len - 2; i > -1; i--) {
            var keyframe = keyframes[i];
            for (var prop in keyframe) {
                if (prop !== 'offset' && !type_10.isDefined(last[prop])) {
                    last[prop] = keyframe[prop];
                }
            }
        }
    }
    exports_103("fixPartialKeyframes", fixPartialKeyframes);
    var lists_5, type_10;
    return {
        setters: [
            function (lists_5_1) {
...
System.register("just-animate/plugins/waapi/transform/resolvePropertiesInKeyframes", ["just-animate/plugins/waapi/transform/resources", "just-animate/common/strings", "just-animate/common/type", "just-animate/plugins/core/easings", "just-animate/common/objects"], function (exports_104, context_104) {
    "use strict";
    ...
    function resolvePropertiesInKeyframes(source, target, ctx) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            for (var propertyName in sourceKeyframe) {
                ...
                if (!type_11.isDefined(sourceValue)) {
                    continue;
                }
                targetKeyframe[propertyName] = objects_4.resolve(sourceValue, ctx);
            }
            normalizeProperties(targetKeyframe);
            target.push(targetKeyframe);
        }
    }
    exports_104("resolvePropertiesInKeyframes", resolvePropertiesInKeyframes);
    function transformPropertyComparer(a, b) {
        return resources_4.transforms.indexOf(a[0]) - resources_4.transforms.indexOf(b[0]);
    }
    /**
    ...
    function normalizeProperties(keyframe) {
        ...
        for (var prop in keyframe) {
            ...
            var propAlias = resources_4.propertyAliases[prop] || prop;
            // find out if the property needs to end up on transform
            var transformIndex = resources_4.transforms.indexOf(propAlias);
            if (transformIndex !== -1) {
                // handle transforms
    ...
    var resources_4, strings_2, type_11, easings_2, objects_4;
    return {
        setters: [
...
System.register("just-animate/plugins/waapi/transform/addTransition", ["just-animate/common/type", "just-animate/common/objects", "just-animate/plugins/waapi/transform/resources"], function (exports_105, context_105) {
    "use strict";
    var __moduleName = context_105 && context_105.id;
    function addTransition(keyframes, target) {
        // detect properties to transition
        var properties = objects_5.listProps(keyframes);
        ...
        properties.forEach(function (property) {
            ...
            var alias = resources_5.transforms.indexOf(property) !== -1 ? 'transform' : property;
            var val = style[alias];
            if (type_12.isDefined(val)) {
                firstFrame[alias] = val;
            }
        });
    }
    exports_105("addTransition", addTransition);
    var type_12, objects_5, resources_5;
    return {
        setters: [
            function (type_12_1) {
                type_12 = type_12_1;
...
System.register("just-animate/plugins/waapi/transform/index", ["just-animate/plugins/waapi/transform/expandOffsets", "just-animate/plugins/waapi/transform/propsToKeyframes", "just-animate/plugins/waapi/transform/spaceKeyframes", "just-animate/plugins/waapi/transform/arrangeKeyframes", "just-animate/plugins/waapi/transform/fixPartialKeyframes", "just-animate/plugins/waapi/transform/keyframeOffsetComparer", "just-animate/plugins/waapi/transform/resolvePropertiesInKeyframes", "just-animate/plugins/waapi/transform/addTransition"], function (exports_106, context_106) {
    "use strict";
    ...
    return {
        setters: [
            function (expandOffsets_1_1) {
                exportStar_1(expandOffsets_1_1);
            },
            function (propsToKeyframes_1_1) {
                exportStar_1(propsToKeyframes_1_1);
            },
            function (spaceKeyframes_1_1) {
                exportStar_1(spaceKeyframes_1_1);
            },
            function (arrangeKeyframes_1_1) {
                exportStar_1(arrangeKeyframes_1_1);
            },
            function (fixPartialKeyframes_1_1) {
                exportStar_1(fixPartialKeyframes_1_1);
            },
            function (keyframeOffsetComparer_3_1) {
                exportStar_1(keyframeOffsetComparer_3_1);
            },
            function (resolvePropertiesInKeyframes_1_1) {
                exportStar_1(resolvePropertiesInKeyframes_1_1);
            },
            function (addTransition_1_1) {
                exportStar_1(addTransition_1_1);
            }
        ],
        execute: function () {
        }
...
System.register("just-animate/plugins/waapi/KeyframePlugin", ["just-animate/plugins/waapi/animator/KeyframeAnimator", "just-animate/common/type", "just-animate/plugins/waapi/transform/index"], function (exports_107, context_107) {
    "use strict";
    ...
    function initAnimator(timings, ctx) {
        ...
        if (type_13.isArray(css)) {
            ...
            sourceKeyframes = [];
            transform.propsToKeyframes(css, sourceKeyframes, ctx);
        }
        var targetKeyframes = [];
    ...
    exports_107("initAnimator", initAnimator);
    var KeyframeAnimator_1, type_13, transform, KeyframePlugin;
    return {
        setters: [
        ...
        execute: function () {
            KeyframePlugin = (function () {
                ...
                KeyframePlugin.prototype.canHandle = function (ctx) {
                    return !!(ctx.options.css) && type_13.isElement(ctx.target);
                };
                KeyframePlugin.prototype.handle = function (timings, ctx) {
                    var animator = new KeyframeAnimator_1.KeyframeAnimator(function () { return initAnimator(timings, ctx); });
                    animator.totalDuration = timings.totalTime;
                    return animator;
                };
                return KeyframePlugin;
            }());
            exports_107("KeyframePlugin", KeyframePlugin);
        }
    };
});
System.register("just-animate/index", ["just-animate/JustAnimate", "just-animate/plugins/waapi/KeyframePlugin", "just-animate/animations"], function (exports_108, context_108) {
    "use strict";
    ...
    return {
        ...
        execute: function () {
            exports_108("JustAnimate", JustAnimate_1.JustAnimate);
            exports_108("animations", animations);
            just = new JustAnimate_1.JustAnimate();
            exports_108("just", just);
            just.inject(animations_3.ANIMATE_CSS);
            just.plugins.push(new KeyframePlugin_1.KeyframePlugin());
        }
    };
});
System.register("just-animate/just-animate-all", ["just-animate/JustAnimate", "just-animate/plugins/waapi/KeyframePlugin", "just-animate/animations"], function (exports_109, context_109) {
    "use strict";
    var __moduleName = context_109 && context_109.id;
    var JustAnimate_2, KeyframePlugin_2, animations_4, just;
    return {
        setters: [
            function (JustAnimate_2_1) {
                JustAnimate_2 = JustAnimate_2_1;
            },
            function (KeyframePlugin_2_1) {
                KeyframePlugin_2 = KeyframePlugin_2_1;
            },
            function (animations_4_1) {
                animations_4 = animations_4_1;
            }
        ],
        execute: function () {
            ...
            just.inject(animations_4.ANIMATE_CSS);
            just.plugins.push(new KeyframePlugin_2.KeyframePlugin());
            window.just = just;
        }
    };
});
System.register("just-animate/just-animate-vue", ["just-animate/common/objects"], function (exports_110, context_110) {
    "use strict";
    var __moduleName = context_110 && context_110.id;
    var objects_6, animateVue;
    return {
        setters: [
                        ...
                        bind: function (el, binding) {
                            ...
                            var _loop_1 = function (e) {
                                ...
                                var eventListener = function (event) {
                                    ...
                                    var animationOptions = objects_6.deepCopyObject(options);
