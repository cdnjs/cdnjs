...
var createAnimation = function (ctx, timings) {
...
var Animator = (function () {
    function Animator(options) {
        var self = this;
        var delay = options.delay, easing = options.easing, endDelay = options.endDelay, from = options.from, index = options.index, target = options.target, targets = options.targets;
        var ctx = {
            index: index,
            target: target,
            targets: targets
    ...
    Object.defineProperty(Animator.prototype, "animator", {
        get: function () {
            ...
            var ctx = self.ctx, timing = self.timing;
...
var Timeline$$1 = (function () {
    function Timeline$$1() {
        ...
        this._tick = function (delta) {
            ...
            if (self.playState === PENDING) {
                var currentTime2 = self.currentTime;
    ...
    Timeline$$1.prototype._insert = function (from, to, opts) {
        ...
        var delay = opts.delay, direction = opts.direction, endDelay = opts.endDelay, fill = opts.fill, iterationStart = opts.iterationStart, iterations = opts.iterations;
        var easingFn = cssFunction$1$$1(opts.easing || ease);
        var easing = css[toCamelCase(opts.easing)] || opts.easing || ease;
