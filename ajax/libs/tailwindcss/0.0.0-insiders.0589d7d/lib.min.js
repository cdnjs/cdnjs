...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);return e}),e[t.property]=1===i.length?i[0]:i)}return s.push([{id:o,base:n.base,reference:!!n.reference},0<Object.keys(e).length?e:null]),a([]),void(l|=4)}if("@config"===r.name){if(0<r.nodes.length)throw new Error("`@config` cannot have a body.");if(null!==t)throw new Error("`@config` cannot be nested.");e.push({id:r.params.slice(1,-1),base:n.base,reference:!!n.reference}),a([]),l|=4}}}),Kr(t),t.resolveThemeValue);if(t.resolveThemeValue=function(e){return e.startsWith("--")?o(e):(l|=Dr({designSystem:t,base:r,ast:a,globs:i,configs:[],pluginDetails:[]}),t.resolveThemeValue(e))},!s.length&&!e.length)return 0;var[u,c]=await Promise.all([Promise.all(e.map(async({id:e,base:t,reference:r})=>{t=await n(e,t,"config");return{path:e,base:t.base,config:t.module,reference:r}})),Promise.all(s.map(async([{id:e,base:t,reference:r},a])=>{t=await n(e,t,"plugin");return{path:e,base:t.base,plugin:t.module,options:a,reference:r}}))]);return l|=Dr({designSystem:t,base:r,ast:a,globs:i,configs:u,pluginDetails:c})}function Dr({designSystem:e,base:t,ast:r,globs:a,configs:n,pluginDetails:i}){let o=0,l=[...i.map(e=>{if(!e.options)return{config:{plugins:[e.plugin]},base:e.base,reference:e.reference};if("__isOptionsFunction"in e.plugin)return{config:{plugins:[e.plugin(e.options)]},base:e.base,reference:e.reference};throw new Error(`The plugin "${e.path}" does not accept options`)}),...n],s=vt(e,[{config:Er(e.theme),base:t,reference:!0},...l,{config:{plugins:[Or]},base:t,reference:!0}])["resolvedConfig"],{resolvedConfig:u,replacedThemeKeys:c}=vt(e,l),d=(e.resolveThemeValue=function(e,t){let r=f.theme(e,t);return Array.isArray(r)&&2===r.length?r[0]:Array.isArray(r)?r.join(", "):"string"==typeof r?r:void 0},{designSystem:e,ast:r,resolvedConfig:s,featuresRef:{set current(e){o|=e}}}),f=mt({...d,referenceMode:!1}),p;for(var{handler:h,reference:m}of s.plugins)m?(p||=mt({...d,referenceMode:!0}),h(p)):h(f);if(ur(e,u,c),Nr(e,u,c),_r(u,e),Pr(u,e),Rr(u,e),!e.theme.prefix&&s.prefix){if(s.prefix.endsWith("-")&&(s.prefix=s.prefix.slice(0,-1),console.warn(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)),!di.test(s.prefix))throw new Error(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);e.theme.prefix=s.prefix}if(e.important||!0!==s.important||(e.important=!0),"string"==typeof s.important){let a=s.important;D(r,(e,{replaceWith:t,parent:r})=>{if("at-rule"===e.kind&&"@tailwind"===e.name&&"utilities"===e.params)return"rule"===r?.kind&&r.selector===a||t(U(a,[e])),2})}for(var v of s.blocklist)e.invalidCandidates.add(v);for(var g of s.content.files){if("raw"in g)throw new Error(`Error in the config file/plugin/preset. The \`content\` key contains a \`raw\` entry:

${JSON.stringify(g,null,2)}

This feature is not currently supported.`);a.push(g)}return o}var pi=/^[a-z]+$/;function gi(){throw new Error("No `loadModule` function provided to `compile`")}function mi(){throw new Error("No `loadStylesheet` function provided to `compile`")}function hi(e){let t=0,r=null;for(var a of P(e," "))"reference"===a?t|=2:"inline"===a?t|=1:"default"===a?t|=4:a.startsWith("prefix(")&&a.endsWith(")")&&(r=a.slice(7,-1));return[t,r]}var pe=(e=>(e[e.None=0]="None",e[e.AtApply=1]="AtApply",e[e.AtImport=2]="AtImport",e[e.JsPluginCompat=4]="JsPluginCompat",e[e.ThemeFunction=8]="ThemeFunction",e[e.Utilities=16]="Utilities",e[e.Variants=32]="Variants",e))(pe||{});async function Ur(e,{base:t="",loadModule:r=gi,loadStylesheet:n=mi}={}){let u=0,c=(e=[ie({base:t},e)],u|=await pt(e,t,n),null),d=new ze,f=[],p=[],h=null,m=null,v=[],g=[],w=null,i=(D(e,(a,{parent:n,replaceWith:i,context:o})=>{if("at-rule"===a.kind){if("@tailwind"===a.name&&("utilities"===a.params||a.params.startsWith("utilities"))){if(null!==m)return void i([]);var t;for(t of P(a.params," "))if(t.startsWith("source(")){let e=t.slice(7,-1);if("none"===e){w=e;continue}if('"'===e[0]&&'"'!==e[e.length-1]||"'"===e[0]&&"'"!==e[e.length-1]||"'"!==e[0]&&'"'!==e[0])throw new Error("`source(…)` paths must be quoted.");w={base:o.sourceBase??o.base,pattern:e.slice(1,-1)}}m=a,u|=16}if("@utility"===a.name){if(null!==n)throw new Error("`@utility` cannot be nested.");if(0===a.nodes.length)throw new Error(`\`@utility ${a.params}\` is empty. Utilities should include at least one property.`);var e=Bt(a);if(null===e)throw new Error(`\`@utility ${a.params}\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`);p.push(e)}if("@source"===a.name){if(0<a.nodes.length)throw new Error("`@source` cannot have a body.");if(null!==n)throw new Error("`@source` cannot be nested.");let e=a.params;if('"'===e[0]&&'"'!==e[e.length-1]||"'"===e[0]&&"'"!==e[e.length-1]||"'"!==e[0]&&'"'!==e[0])throw new Error("`@source` paths must be quoted.");return g.push({base:o.base,pattern:e.slice(1,-1)}),void i([])}if("@variant"===a.name&&(null===n?0===a.nodes.length?a.name="@custom-variant":D(a.nodes,e=>{if("at-rule"===e.kind&&"@slot"===e.name)return a.name="@custom-variant",2}):v.push(a)),"@custom-variant"===a.name){if(null!==n)throw new Error("`@custom-variant` cannot be nested.");i([]);let[t,r]=P(a.params," ");if(!Ie.test(t))throw new Error(`\`@custom-variant ${t}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);if(0<a.nodes.length&&r)throw new Error(`\`@custom-variant ${t}\` cannot have both a selector and a body.`);if(0!==a.nodes.length)return void f.push(e=>{e.variants.fromAst(t,a.nodes)});{if(!r)throw new Error(`\`@custom-variant ${t}\` has no selector or body.`);let e=P(r.slice(1,-1),",");if(0===e.length||e.some(e=>""===e.trim()))throw new Error(`\`@custom-variant ${t} (${e.join(",")})\` selector is invalid.`);let a=[],n=[];for(var l of e)l=l.trim(),("@"===l[0]?a:n).push(l);void f.push(e=>{e.variants.static(t,e=>{let t=[];0<n.length&&t.push(U(n.join(", "),e.nodes));for(var r of a)t.push(L(r,e.nodes));e.nodes=t},{compounds:se([...n,...a])})})}}else{if("@media"===a.name){let e=P(a.params," "),t=[];for(var s of e)if(s.startsWith("source(")){let r=s.slice(7,-1);D(a.nodes,(e,{replaceWith:t})=>{if("at-rule"===e.kind&&"@tailwind"===e.name&&"utilities"===e.params)return e.params+=` source(${r})`,t([ie({sourceBase:o.base},[e])]),2})}else if(s.startsWith("theme(")){let t=s.slice(6,-1);D(a.nodes,e=>{if("at-rule"!==e.kind)throw new Error('Files imported with `@import "…" theme(…)` must only contain `@theme` blocks.');if("@theme"===e.name)return e.params+=" "+t,1})}else if(s.startsWith("prefix(")){let t=s.slice(7,-1);D(a.nodes,e=>{if("at-rule"===e.kind&&"@theme"===e.name)return e.params+=` prefix(${t})`,1})}else"important"===s?c=!0:"reference"===s?a.nodes=[ie({reference:!0},a.nodes)]:t.push(s);return 0<t.length?a.params=t.join(" "):0<e.length&&i(a.nodes),1}if("@theme"===a.name){let[r,e]=hi(a.params);if(o.reference&&(r|=2),e){if(!pi.test(e))throw new Error(`The prefix "${e}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);d.prefix=e}return D(a.nodes,(e,{replaceWith:t})=>{if("at-rule"===e.kind&&"@keyframes"===e.name)return d.addKeyframes(e),t([]),1;if("comment"!==e.kind){if("declaration"!==e.kind||!e.property.startsWith("--"))throw t=G([_(a.name,a.params,[e])]).split(`
`).map((e,t,r)=>`${0===t||t>=r.length-2?" ":">"} `+e).join(`
`),new Error("`@theme` blocks must only contain custom properties or `@keyframes`.\n\n"+t);d.add(e.property,e.value??"",r)}}),h||2&r?i([]):i([h=U(":root, :host",a.nodes)]),1}}}}),er(d));c&&(i.important=c),u|=await jr({designSystem:i,base:t,ast:e,loadModule:r,globs:g});for(var o of f)o(i);for(var l of p)l(i);if(h){let t=[];for(var[s,b]of d.entries())2&b.options||t.push(a(s,b.value));n=d.getKeyframes();if(0<n.length){let e=[...d.namespace("--animate").values()].flatMap(e=>e.split(" "));for(var y of n){var k=y.params;e.includes(k)&&t.push(j([y]))}}h.nodes=t}if(m){let e=m;e.kind="context",e.context={}}if(0<v.length){for(var x of v){var $=U("&",x.nodes),A=x.params,z=i.parseVariant(A);if(null===z)throw new Error("Cannot use `@variant` with unknown variant: "+A);if(null===ge($,z,i.variants))throw new Error("Cannot use `@variant` with variant: "+A);Object.assign(x,$)}u|=32}return u=(u|=de(e,i))|Ce(e,i),D(e,(e,{replaceWith:t})=>{if("at-rule"===e.kind)return"@utility"===e.name&&t([]),1}),{designSystem:i,ast:e,globs:g,root:w,utilitiesNode:m,features:u}}async function Fr(n,e={}){let{designSystem:i,ast:o,globs:t,root:r,utilitiesNode:l,features:s}=await Ur(n,e);function u(e){i.invalidCandidates.add(e)}o.unshift(Ke(`! tailwindcss v${yt} | MIT License | https://tailwindcss.com `));let c=new Set,d=null,f=0;return{globs:t,root:r,features:s,build(e){if(0===s)return n;if(!l)return d??=oe(o);let t=!1,r=c.size;for(var a of e)i.invalidCandidates.has(a)||(c.add(a),t||=c.size!==r);if(!t)return d??=oe(o);e=ee(c,i,{onInvalidCandidate:u}).astNodes;return f===e.length?d??=oe(o):(f=e.length,l.nodes=e,d=oe(o)),d}}}async function vi(e,t={}){let r=ne(e),a=await Fr(r,t),n=r,i=e;return{...a,build(e){e=a.build(e);return e!==n&&(i=G(e),n=e),i}}}async function yi(e,t={}){return(await Ur(ne(e),t)).designSystem}function Te(){throw new Error("It looks like you're trying to use `tailwindcss` directly as a PostCSS plugin. The PostCSS plugin has moved to a separate package, so to continue using Tailwind CSS with PostCSS you'll need to install `@tailwindcss/postcss` and update your PostCSS configuration.")}for(let e in Je)"default"!==e&&(Te[e]=Je[e]);module.exports=Te;