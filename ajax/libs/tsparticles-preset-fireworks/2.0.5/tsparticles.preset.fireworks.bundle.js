...
var esm = __webpack_require__(874);
...
const tsparticles_updater_angle_1 = __webpack_require__(667);

const tsparticles_move_base_1 = __webpack_require__(430);

const tsparticles_shape_circle_1 = __webpack_require__(762);

const tsparticles_updater_color_1 = __webpack_require__(999);

const tsparticles_plugin_emitters_1 = __webpack_require__(842);

const tsparticles_updater_life_1 = __webpack_require__(83);

const tsparticles_shape_line_1 = __webpack_require__(493);

const tsparticles_updater_opacity_1 = __webpack_require__(564);

const tsparticles_updater_out_modes_1 = __webpack_require__(750);

const tsparticles_updater_size_1 = __webpack_require__(253);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadLineShape": function() { return /* binding */ loadLineShape; }
});
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadAngleUpdater": function() { return /* binding */ loadAngleUpdater; }
});
...
class AngleUpdater {
  ...
  init(particle) {
    ...
    particle.rotate = {
      ...
      value: (0,esm.getRangeValue)(rotateOptions.value) * Math.PI / 180
    };
    ...
    if (rotateAnimation.enable) {
      particle.rotate.velocity = (0,esm.getRangeValue)(rotateAnimation.speed) / 360 * this.container.retina.reduceFactor;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadLifeUpdater": function() { return /* binding */ loadLifeUpdater; }
});
...
class LifeUpdater {
  ...
  update(particle, delta) {
    ...
    const canvasSize = this.container.canvas.size,
          widthRange = (0,esm.setRangeValue)(0, canvasSize.width),
          heightRange = (0,esm.setRangeValue)(0, canvasSize.width);
    particle.position.x = (0,esm.randomInRange)(widthRange);
    particle.position.y = (0,esm.randomInRange)(heightRange);
    particle.spawning = true;
    life.delayTime = 0;
    life.time = 0;
    particle.reset();
    const lifeOptions = particle.options.life;
    life.delay = (0,esm.getRangeValue)(lifeOptions.delay.value) * 1000;
    life.duration = (0,esm.getRangeValue)(lifeOptions.duration.value) * 1000;
  }
...
class StrokeColorUpdater {
  ...
  init(particle) {
    ...
    const container = this.container;
    particle.stroke = particle.options.stroke instanceof Array ? (0,esm.itemFromArray)(particle.options.stroke, particle.id, particle.options.reduceDuplicates) : particle.options.stroke;
    particle.strokeWidth = particle.stroke.width * container.retina.pixelRatio;
    const strokeHslColor = (_a = (0,esm.colorToHsl)(particle.stroke.color)) !== null && _a !== void 0 ? _a : particle.getFillColor();

    if (strokeHslColor) {
      particle.strokeColor = (0,esm.getHslAnimationFromHsl)(strokeHslColor, (_b = particle.stroke.color) === null || _b === void 0 ? void 0 : _b.animation, container.retina.reduceFactor);
    }
  }
...
Object.defineProperty(exports, "loadFireworksPreset", ({
  enumerable: true,
  get: function () {
    return _1.loadFireworksPreset;
  }
}));

const tsparticles_engine_1 = __webpack_require__(874);
