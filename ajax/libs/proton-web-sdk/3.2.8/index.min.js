import ProtonLinkBrowserTransport from"@proton/browser-transport";import ProtonLink from"@proton/link";import{AxiosProvider}from"@proton/provider-axios";import{APIClient}from"@greymass/eosio";var getStyleText=e=>{var{modalBackgroundColor:t,logoBackgroundColor:o,isLogoRound:r,optionBackgroundColor:a,optionFontColor:l,primaryFontColor:i,secondaryFontColor:s,linkColor:e}=Object.assign({modalBackgroundColor:"#ffffff",logoBackgroundColor:"transparent",isLogoRound:!1,optionBackgroundColor:"transparent",optionFontColor:"#000531",primaryFontColor:"black",secondaryFontColor:"#a1a5b0",linkColor:"#00AAEF"},e);return`
    .wallet-selector * {
    ...
    `};class WalletTypeSelector{constructor(e,t,o){this.name=e,this.appLogo=t,this.appName=e||"app",this.customStyleOptions=o}hideSelector(){this.selectorContainerEl&&this.selectorContainerEl.classList.remove("wallet-selector-active")}showSelector(){this.selectorContainerEl&&this.selectorContainerEl.classList.add("wallet-selector-active")}setUpSelectorContainer(o){this.font=document.createElement("link"),this.font.href="https://fonts.cdnfonts.com/css/circular-std-book",this.font.rel="stylesheet",this.styleEl=document.createElement("style"),this.styleEl.type="text/css";var e=getStyleText(this.customStyleOptions);if(this.styleEl.appendChild(document.createTextNode(e)),this.styleEl.appendChild(this.font),document.head.appendChild(this.styleEl),this.selectorContainerEl||(this.clearDuplicateContainers(),this.selectorContainerEl=this.createEl(),this.selectorContainerEl.className="wallet-selector",this.selectorContainerEl.onclick=e=>{e.target===this.selectorContainerEl&&(e.stopPropagation(),this.hideSelector(),o("no wallet selected"))},document.body.appendChild(this.selectorContainerEl)),!this.selectorEl){let e=this.createEl({class:"inner"}),t=this.createEl({class:"close"});t.onclick=e=>{e.stopPropagation(),this.hideSelector(),o("no wallet selected")},this.selectorEl=this.createEl({class:"connect"}),e.appendChild(this.selectorEl),e.appendChild(t),this.selectorContainerEl.appendChild(e)}}clearDuplicateContainers(){const e=document.getElementsByClassName("wallet-selector");for(;0<e.length;)e[0].remove()}createEl(e){e=e||{};const t=document.createElement(e.tag||"div");if(e)for(const r of Object.keys(e)){var o=e[r];switch(r){case"src":t.setAttribute(r,o);break;case"tag":break;case"text":t.appendChild(document.createTextNode(o));break;case"class":t.className=`wallet-selector-${o}`;break;default:t.setAttribute(r,o)}}return t}displayWalletSelector(u){return new Promise((o,e)=>{this.setUpSelectorContainer(e);const t=this.createEl({class:"connect-header"}),r=this.createEl({class:"connect-body"});this.appLogo&&(l=this.createEl({class:"logo",tag:"img",src:this.appLogo,alt:"app-logo"}),t.appendChild(l));var a=`To start using ${this.appName}`,e=this.createEl({class:"title",tag:"span",text:"Connect Wallet"}),l=this.createEl({class:"subtitle",tag:"span",text:a});const i=this.createEl({class:"wallet-list",tag:"ul"});var s,n,c=t=>e=>{e.stopPropagation(),this.hideSelector(),o(t)};for({key:s,value:n}of u){const w=this.createEl({class:`${s}-wallet`,tag:"li"});w.onclick=c(s);var C=this.createEl({class:`${s}-logo`}),d=this.createEl({class:"wallet-name",tag:"span",text:n}),g=this.createEl({class:"right-arrow"});w.appendChild(C),w.appendChild(d),w.appendChild(g),i.appendChild(w)}a=this.createEl({class:"tos-link",tag:"a",text:"Terms of Service",href:"https://protonchain.com/terms",target:"_blank"});const h=this.createEl({class:"tos-agreement",tag:"p",text:"By connecting, I accept Proton's "});h.appendChild(a),t.appendChild(e),t.appendChild(l),r.appendChild(i),r.appendChild(h);const p=this.createEl({class:"footnote",text:"Don't have a wallet? "});l=this.createEl({tag:"a",target:"_blank",href:"https://protonchain.com/wallet",text:"Download it here"});p.appendChild(l),emptyElement(this.selectorEl),this.selectorEl.appendChild(t),this.selectorEl.appendChild(r),this.selectorContainerEl.appendChild(p),this.showSelector()})}}function emptyElement(e){for(;e.firstChild;)e.removeChild(e.firstChild)}const OPEN_SETTINGS="menubar=1,resizable=1,width=400,height=600";class Deferred{constructor(){this.promise=new Promise((e,t)=>{this.reject=t,this.resolve=e})}}class ProtonWebLink{constructor(e){this.childWindow=null,this.scheme=e.scheme,this.storage=e.storage,this.testUrl=e.testUrl,setInterval(()=>this.closeChild(),500),window.addEventListener("message",e=>this.onEvent(e),!1)}childUrl(e){return`${this.testUrl||("proton"===this.scheme?"https://webauth.com":"https://testnet.webauth.com")}${e}`}closeChild(e=!1){this.childWindow&&(e&&this.childWindow.close(),(e||this.childWindow.closed)&&(this.childWindow=null))}createSession(e){return{auth:e,transact:(e,t)=>{this.deferredLogin&&(this.closeChild(!0),this.deferredLogin.reject("Trying to login"),this.deferredLogin=void 0),this.deferredTransact={deferral:new Deferred,transaction:e.transaction||{actions:e.actions},params:t,waitingForOpen:!0},this.childWindow=window.open(this.childUrl("/auth"),"_blank",OPEN_SETTINGS);try{return this.deferredTransact.deferral.promise}catch(e){throw console.error(e),e}},link:{walletType:"webauth"}}}async login(){this.deferredTransact&&(this.closeChild(!0),this.deferredTransact.deferral.reject("Trying to login"),this.deferredTransact=void 0),this.childWindow=window.open(this.childUrl("/login"),"_blank",OPEN_SETTINGS),this.deferredLogin=new Deferred;try{this.storage.write("wallet-type","webauth");var e=await this.deferredLogin.promise;return{session:this.createSession(e)}}catch(e){throw console.error(e),e}}async restoreSession(e,t){return this.createSession(t)}async removeSession(e,t,o){if(!this.storage)throw new Error("Unable to remove session: No storage adapter configured");return await this.storage.read("wallet-type")&&this.storage.remove("wallet-type"),await this.storage.read("user-auth")&&this.storage.remove("user-auth"),{appIdentifier:e,auth:t,chainId:o}}async onEvent(t){if(-1===t.origin.indexOf("https://webauth.com")||-1===t.origin.indexOf("https://testnet.webauth.com")){let e;try{e=JSON.parse(t.data)}catch(t){return}try{var{type:o,data:r,error:a}=e;if(!o)return;"isReady"===o?this.deferredTransact&&this.deferredTransact.waitingForOpen&&(this.deferredTransact.waitingForOpen=!1,this.childWindow.postMessage(JSON.stringify({type:"transaction",data:{transaction:this.deferredTransact.transaction,params:this.deferredTransact.params}}),"*")):"close"===o?(this.closeChild(!0),this.deferredTransact?this.deferredTransact.deferral.reject("Closed"):this.deferredLogin&&this.deferredLogin.reject("Closed")):"transactionSuccess"===o?(this.closeChild(!0),this.deferredTransact&&(a?this.deferredTransact.deferral.reject(a&&a.json?a.json:a):this.deferredTransact.deferral.resolve(r),this.deferredTransact=void 0)):"loginSuccess"===o&&(this.closeChild(!0),this.deferredLogin&&(this.deferredLogin.resolve(r),this.deferredLogin=void 0))}catch(t){console.error(t)}}}}class Storage{constructor(e){this.keyPrefix=e}async write(e,t){localStorage.setItem(this.storageKey(e),t)}async read(e){return localStorage.getItem(this.storageKey(e))}async remove(e){localStorage.removeItem(this.storageKey(e))}storageKey(e){return`${this.keyPrefix}-${e}`}}const WALLET_TYPES=[{key:"proton",value:"Mobile Wallet"},{key:"webauth",value:"Web Wallet"},{key:"anchor",value:"Anchor"}],ConnectWallet=async({linkOptions:e,transportOptions:t={},selectorOptions:o={}})=>{var r;return e.client=new APIClient({provider:new AxiosProvider(e.endpoints)}),e.chainId||(r=await e.client.v1.chain.get_info(),e.chainId=r.chain_id),e.storage||(e.storage=new Storage(e.storagePrefix||"proton-storage")),login(o,e,t)},login=async(o,r,a)=>{let e,l,i;const t=new WalletTypeSelector(o.appName,o.appLogo,o.customStyleOptions);let s=o.walletType;if(!s)if(r.restoreSession)s=await r.storage.read("wallet-type");else{var n=o.enabledWalletTypes?WALLET_TYPES.filter(e=>o.enabledWalletTypes?.includes(e.key)):WALLET_TYPES;try{s=await t.displayWalletSelector(n)}catch(e){return{error:e}}}if(!s)return{error:new Error("Wallet Type Unavailable: No wallet provided")};let c="proton";"71ee83bcf52142d61019d95f9cc5427ba6a0d7ff8accd9e2088ae2abeaf3d3dd"===r.chainId&&(c="proton-test");let C="proton";"proton-test"===c?C="proton-dev":"anchor"===s&&(C="esr");n={...r,scheme:C,transport:new ProtonLinkBrowserTransport({...a,walletType:s}),walletType:s,chains:[]};if(l=new("webauth"===s?ProtonWebLink:ProtonLink)(n),r.restoreSession){n=await r.storage.read("user-auth"),n=n?JSON.parse(n):{},n=0<Object.keys(n).length?n:null;if(n&&(e=await l.restoreSession(a.requestAccount||"",n),!e))return r.storage.remove("wallet-type"),r.storage.remove("user-auth"),{link:void 0,session:void 0,loginResult:void 0}}else{let t=!1;document.addEventListener("backToSelector",()=>{t=!0});try{i=await l.login(a.requestAccount||""),e=i.session;var d=JSON.stringify({actor:i.session.auth.actor.toString(),permission:i.session.auth.permission.toString()});r.storage.write("user-auth",d)}catch(e){return console.error("restoreSession Error:"),console.error(e),t?(document.removeEventListener("backToSelector",()=>{t=!0}),login(o,r,a)):{error:e}}}return e&&e.auth&&(e.auth={actor:e.auth.actor.toString(),permission:e.auth.permission.toString()},e.publicKey=e.publicKey?e.publicKey.toString():void 0),{session:e,link:l,loginResult:i}};export{ConnectWallet,ProtonWebLink};