...
import type { ActionShape, Ctx, Game, LogEntry, State, Store, TransientMetadata, TransientState } from '../types';
/**
...
export declare function CreateGameReducer({ game, isClient, }: {
    game: Game;
    isClient?: boolean;
}): (stateWithTransients: TransientState<any, Ctx>, action: ActionShape.Any) => TransientState<any, Ctx>;
