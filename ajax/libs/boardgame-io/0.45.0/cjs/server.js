 ...
 */
function Server({ games, db, transport, https, uuid, origins, generateCredentials = uuid, authenticateCredentials, }) {
    const app = new Koa();
...
const Origins = {
    ...
    LOCALHOST_IN_DEVELOPMENT: process.env.NODE_ENV === 'production' ? '' : LOCALHOST,
};
