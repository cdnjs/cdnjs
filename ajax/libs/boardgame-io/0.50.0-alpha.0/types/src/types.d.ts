...
export interface Plugin<API extends any = any, Data extends any = any, G extends any = any> {
    ...
    fnWrap?: (moveOrHook: (context: FnContext<G>, ...args: SerializableAny[]) => any, methodType: GameMethod) => (context: FnContext<G>, ...args: SerializableAny[]) => any;
    playerView?: (context: {
        G: G;
        ctx: Ctx;
        game: Game<G>;
...
declare type SerializableAny = Misc.JSON.Value;
export declare type MoveFn<G extends any = any, PluginAPIs extends Record<string, unknown> = Record<string, unknown>> = (context: FnContext<G, PluginAPIs> & {
    playerID: PlayerID;
}, ...args: SerializableAny[]) => void | G | typeof INVALID_MOVE;
