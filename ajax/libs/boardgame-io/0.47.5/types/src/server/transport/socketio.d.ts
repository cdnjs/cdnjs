 ...
 */
export declare const TransportAPI: (matchID: string, socket: IOTypes.Socket<import("socket.io/dist/typed-events").DefaultEventsMap, import("socket.io/dist/typed-events").DefaultEventsMap, import("socket.io/dist/typed-events").DefaultEventsMap>, filterPlayerView: any, pubSub: GenericPubSub<IntermediateTransportData>) => MasterTransport;
...
export declare class SocketIO {
    ...
    init(app: Server.App & {
        _io?: IOTypes.Server;
    }, games: Game[], origins?: IOTypes.ServerOptions['cors']['origin']): void;
    /**
