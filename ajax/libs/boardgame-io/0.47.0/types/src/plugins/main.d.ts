 ...
 */
export declare const FnWrap: (functionToWrap: AnyFn, plugins: Plugin<any, any, any>[]) => (G: any, ctx: Ctx, ...args: any[]) => any;
/**
 ...
 */
export declare const FlushAndValidate: (state: State<any, Ctx>, opts: PluginOpts) => readonly [State<any, Ctx>] | readonly [State<any, Ctx>, {
    plugin: string;
    message: string;
}];
/**
