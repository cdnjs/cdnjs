 ...
 */
export declare function TransportAPI(matchID: string, socket: IOTypes.Socket, clientInfo: SocketIO['clientInfo'], roomInfo: SocketIO['roomInfo'], filterPlayerView: (string: any, IntermediateTransportData: any) => TransportData, provisionalClient?: Client): MasterTransport;
