import type { ActivePlayersArg, State, Ctx, Game, Move } from '../types';
/**
 * Flow
 *
...
export declare function Flow({ moves, phases, endIf, onEnd, turn, events, plugins, }: Game): {
    ...
    eventHandlers: {
        ...
        setActivePlayers: (state: State<any, Ctx>, _playerID: string, arg: string[] | ActivePlayersArg) => State<any, Ctx>;
    };
    eventNames: string[];
