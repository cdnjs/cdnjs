/*
	...
	Tue Nov 08 2016 22:47:39 GMT-0500 (EST) - commit ef4e1581677380ef0ce0886156b47caf3acf50d7
...
(function (global, factory) {
	...
	if ( hasConsole ) {
		var welcomeIntro = [
			("%cRactive.js %c0.9.0-edge-ef4e1581677380ef0ce0886156b47caf3acf50d7 %cin debug mode, %cmore..."),
			'color: rgb(114, 157, 52); font-weight: normal;',
			'color: rgb(85, 85, 85); font-weight: normal;',
			'color: rgb(85, 85, 85); font-weight: normal;',
			'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
		];
		var welcomeMessage = "You're running Ractive 0.9.0-edge-ef4e1581677380ef0ce0886156b47caf3acf50d7 in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://docs.ractivejs.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
	...
	function gather ( ractive, keypath, base ) {
		...
		if ( star.test( keypath ) ) {
			return model.findMatches( splitKeypathI( keypath ) );
		} else {
			return [ model.joinAll( splitKeypathI( keypath ) ) ];
		}
	}
	...
	function resolveReference ( fragment, ref ) {
		...
		if ( ref[0] === '.' || ref[0] === '^' ) {
			...
			return context$1.joinAll( splitKeypathI( ref ) );
		}
	...
	function Ractive$teardown () {
		...
		return teardown$1( this, function () { return this$1.fragment.rendered ? this$1.unrender() : Promise$1.resolve(); } );
	}
	...
	function addOtherOptions ( Child, options ) {
		Object.keys( Child.prototype ).forEach( function ( key ) {
			...
			// is it a wrapped function?
				...
				var result = wrap$1( options[ key ]._method, value );
	...
	defineProperties( Ractive, {
		...
		// version
		VERSION:        { value: '0.9.0-edge-ef4e1581677380ef0ce0886156b47caf3acf50d7' },
