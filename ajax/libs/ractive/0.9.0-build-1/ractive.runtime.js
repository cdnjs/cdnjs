/*
	...
	Wed Oct 26 2016 01:31:57 GMT-0400 (EDT) - commit 183974c0c59a1a773a6505dfa7dd2d57d6d5edfa
...
(function (global, factory) {
  ...
  if ( hasConsole ) {
  	var welcomeIntro = [
  		("%cRactive.js %c0.9.0-edge-183974c0c59a1a773a6505dfa7dd2d57d6d5edfa %cin debug mode, %cmore..."),
  		'color: rgb(114, 157, 52); font-weight: normal;',
  		'color: rgb(85, 85, 85); font-weight: normal;',
  		'color: rgb(85, 85, 85); font-weight: normal;',
  		'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
  	];
  	var welcomeMessage = "You're running Ractive 0.9.0-edge-183974c0c59a1a773a6505dfa7dd2d57d6d5edfa in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://docs.ractivejs.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
  ...
  function flushChanges () {
  	...
  	while ( i-- ) {
  		...
  		removeFromArray$1( ractives, ractive );
  ...
  ModelBase.prototype.removeUnresolved = function removeUnresolved ( key, resolver ) {
  	...
  	if ( resolvers ) {
  		removeFromArray$1( resolvers, resolver );
  	}
  };
  ...
  ReferenceResolver.prototype.unbind = function unbind () {
  	var this$1 = this;
  		...
  		if ( this.fragment ) removeFromArray$1( this.fragment.unresolved, this );
  	...
  	return {
  		cancel: function () {
  			observers.forEach( function ( observer ) {
  				removeFromArray$1 ( this$1._observers, observer );
  				observer.cancel();
  			} );
  		}
  	};
  ...
  function createResolver ( proxy, ref, index ) {
  	var resolver = proxy.fragment.resolve( ref, function ( model ) {
  		removeFromArray$1( proxy.resolvers, resolver );
  	...
  	function ReferenceExpressionProxy ( fragment, template ) {
  		...
  		if ( !this.base ) {
  			baseResolver = fragment.resolve( template.r, function ( model ) {
  				...
  				removeFromArray$1( this$1.resolvers, baseResolver );
  			});
  			...
  			if ( template.t === REFERENCE ) {
  				...
  				if ( model ) {
  					...
  					resolver = fragment.resolve( template.n, function ( model ) {
  						...
  						removeFromArray$1( this$1.resolvers, resolver );
  					});
  ...
  var CheckboxNameBinding = (function (Binding) {
  	...
  	CheckboxNameBinding.prototype.handleChange = function handleChange () {
  		...
  		if ( this.isChecked && !arrayContains( this.group.value, value ) ) {
  			...
  			removeFromArray$1( this.group.value, value );
  		}
  ...
  defineProperties( Ractive, {
  	...
  	// version
  	VERSION:        { value: '0.9.0-edge-183974c0c59a1a773a6505dfa7dd2d57d6d5edfa' },
