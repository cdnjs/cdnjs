/*
	...
	Mon Jan 30 2017 05:01:23 GMT+0000 (UTC) - commit cb07302d73a9479b70159a42a3d15f7ecc74e648
...
if ( hasConsole ) {
	var welcomeIntro = [
		"%cRactive.js %c0.9.0-edge-cb07302d73a9479b70159a42a3d15f7ecc74e648 %cin debug mode, %cmore...",
		'color: rgb(114, 157, 52); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
	];
	var welcomeMessage = "You're running Ractive 0.9.0-edge-cb07302d73a9479b70159a42a3d15f7ecc74e648 in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://docs.ractivejs.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
...
function getQuery ( ractive, selector, options, component ) {
	var liveQueries = ractive[("_live" + (component ? 'Component' : '') + "Queries")];
	var query;

	// Shortcut: if we're maintaining a live query with this
	// selector, we don't need to traverse the parallel DOM
	query = liveQueries.find( function (q) { return q.selector === selector && q.remote === options.remote; } );
	if ( query ) {
...
var cleanCss = function ( css, callback ) {
	var values = [];
...
function transformSelector ( selector, parent ) {
	...
	cleanCss( selector, function ( selector, reconstruct ) {
...
var prefixPattern = /^(?:\@\.|\@|~\/|(?:\^\^\/(?:\^\^\/)*(?:\.\.\/)*)|(?:\.\.\/)+|\.\/(?:\.\.\/)*|\.)/;
var specials = /^(key|index|keypath|rootpath|this|global|shared)/;
...
function readReference ( parser ) {
	...
	if ( prefix === '@' && !specials.test( name$$1 ) ) {
...
proto$1.rebind = mustache.rebind;
...
var proto$2 = Text.prototype;
proto$2.bind = proto$2.unbind = proto$2.update = noop;
...
var proto$3 = Transition.prototype;
proto$3.destroyed = proto$3.render = proto$3.unrender = proto$3.update = noop;
...
function extendOne ( Parent, options ) {
	...
	Object.defineProperties( Child, {
		...
		// extendable
		extend: { value: extend$2, writable: true, configurable: true },
...
Object.defineProperties( Ractive, {
	...
	// version
	VERSION:        { value: '0.9.0-edge-cb07302d73a9479b70159a42a3d15f7ecc74e648' },
