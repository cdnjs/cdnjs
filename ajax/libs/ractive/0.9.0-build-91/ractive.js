/*
	...
	Wed Feb 15 2017 03:12:23 GMT+0000 (UTC) - commit 2cdc234a7d29105b12f91a350f20ea1ba7c3d7eb
...
if ( hasConsole ) {
	var welcomeIntro = [
		"%cRactive.js %c0.9.0-edge-2cdc234a7d29105b12f91a350f20ea1ba7c3d7eb %cin debug mode, %cmore...",
		'color: rgb(114, 157, 52); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(85, 85, 85); font-weight: normal;',
		'color: rgb(82, 140, 224); font-weight: normal; text-decoration: underline;'
	];
	var welcomeMessage = "You're running Ractive 0.9.0-edge-2cdc234a7d29105b12f91a350f20ea1ba7c3d7eb in debug mode - messages will be printed to the console to help you fix problems and optimise your application.\n\nTo disable debug mode, add this line at the start of your app:\n  Ractive.DEBUG = false;\n\nTo disable debug mode when your app is minified, add this snippet:\n  Ractive.DEBUG = /unminified/.test(function(){/*unminified*/});\n\nGet help and support:\n  http://docs.ractivejs.org\n  http://stackoverflow.com/questions/tagged/ractivejs\n  http://groups.google.com/forum/#!forum/ractive-js\n  http://twitter.com/ractivejs\n\nFound a bug? Raise an issue:\n  https://github.com/ractivejs/ractive/issues\n\n";
...
function Ractive$add ( keypath, d, options ) {
	...
	return add$1( this, keypath, num, opts );
}
...
function update$2 ( ractive, model, options ) {
...
function Ractive$update ( keypath, options ) {
	...
	return update$2( this, keypath ? this.viewmodel.joinAll( keypath ) : this.viewmodel, options );
}
...
Context.prototype.add = function add ( keypath, d, options ) {
	var num = typeof d === 'number' ? +d : 1;
	var opts = typeof d === 'object' ? d : options;
	return set$1( this.ractive, build$1( this, keypath, num ).map( function (pair) {
		var model = pair[0];
			var val = pair[1];
		var value = model.get();
...
Context.prototype.toggle = function toggle ( keypath, options ) {
	var ref = findModel( this, keypath );
		var model = ref.model;
	return set$1( this.ractive, [ [ model, !model.get() ] ], options );
};
...
Context.prototype.update = function update ( keypath, options ) {
	return update$2( this.ractive, findModel( this, keypath ).model, options );
};
...
function attach$1 ( section, fragment ) {
...
function Ractive$toggle ( keypath, options ) {
	...
	return set$1( this, gather( this, keypath ).map( function (m) { return [ m, !m.get() ]; } ), options );
}
...
Object.defineProperties( Ractive, {
	...
	// version
	VERSION:        { value: '0.9.0-edge-2cdc234a7d29105b12f91a350f20ea1ba7c3d7eb' },
