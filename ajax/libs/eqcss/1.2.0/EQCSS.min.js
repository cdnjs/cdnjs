...
"");a=a.replace(/@element/g,"\n@element");a=a.replace(/(@element.*?\{([^}]*?\{[^}]*?\}[^}]*?)*\}).*/g,"$1");a.replace(/(@element.*(?!@element))/g,function(a,c){dataEntry={};c.replace(/@element ?["']([^"']*)["']/g,function(a,c){dataEntry.i=c});dataEntry.a=[];c.replace(/and ?\( ?([^:]*) ?: ?([^)]*) ?\)/g,function(a,c,b){a=b.replace(/^\d+(\D+)$/,"$1");a==b&&(a=null);b=b.replace(/^(\d+)\D+$/,"$1");dataEntry.a.push({measure:c,value:b,b:a})});c.replace(/{(.*)}/g,function(a,b){dataEntry.style=b});EQCSS.data.push(dataEntry)})},
apply:function(){var a,b,c,f,n,l,p,d,e,h,k;for(a=0;a<EQCSS.data.length;a++)for(f=document.querySelectorAll(EQCSS.data[a].i),b=0;b<f.length;b++){n="data-eqcss-"+a+"-"+b;f[b].setAttribute(n,"");p="data-eqcss-"+a+"-"+b+"-parent";f[b]!=document.documentElement&&f[b].parentNode.setAttribute(p,"");element_guid_prev="data-eqcss-"+a+"-"+b+"-prev";f[b].previousElementSibling&&f[b].previousElementSibling.setAttribute(element_guid_prev,"");element_guid_next="data-eqcss-"+a+"-"+b+"-next";f[b].nextElementSibling&&
f[b].nextElementSibling.setAttribute(element_guid_next,"");l=document.querySelector("#"+n);l||(l=document.createElement("STYLE"),l.id=n,l.setAttribute("data-eqcss-read","true"),document.querySelector("head").appendChild(l));l=document.querySelector("#"+n);h=!0;c=0;a:for(;c<EQCSS.data[a].a.length;c++){e=window.getComputedStyle(f[b],null);k=null;f[b]!=document.documentElement&&(k=window.getComputedStyle(f[b].parentNode,null));d=!1;if("vw"===EQCSS.data[a].a[c].b){d=!0;var g=parseInt(EQCSS.data[a].a[c].value);
EQCSS.data[a].a[c].g=g*window.innerWidth/100}else if("vh"===EQCSS.data[a].a[c].b)d=!0,g=parseInt(EQCSS.data[a].a[c].value),EQCSS.data[a].a[c].g=g*window.innerHeight/100;else if("vmin"===EQCSS.data[a].a[c].b)d=!0,g=parseInt(EQCSS.data[a].a[c].value),EQCSS.data[a].a[c].g=g*Math.min(window.innerWidth,window.innerHeight)/100;else if("vmax"===EQCSS.data[a].a[c].b)d=!0,g=parseInt(EQCSS.data[a].a[c].value),EQCSS.data[a].a[c].g=g*Math.max(window.innerWidth,window.innerHeight)/100;else if(null!=EQCSS.data[a].a[c].b&&
"px"!=EQCSS.data[a].a[c].b&&"%"!=EQCSS.data[a].a[c].b){g=document.createElement("DIV");g.style.visibility="hidden";g.style.border="1px solid red";g.style.width=EQCSS.data[a].a[c].value+EQCSS.data[a].a[c].b;var q=f[b];f[b]!=document.documentElement&&(q=f[b].parentNode);q.appendChild(g);EQCSS.data[a].a[c].value=parseInt(window.getComputedStyle(g,null).getPropertyValue("width"));EQCSS.data[a].a[c].b="px";q.removeChild(g)}g=d?EQCSS.data[a].a[c].g:parseInt(EQCSS.data[a].a[c].value);switch(EQCSS.data[a].a[c].measure){case "min-width":if(1==
d||"px"==EQCSS.data[a].a[c].b)if(d=parseInt(e.getPropertyValue("width")),!(d>=g)){h=!1;break a}if("%"==EQCSS.data[a].a[c].b&&(d=parseInt(e.getPropertyValue("width")),e=parseInt(k.getPropertyValue("width")),!(e/d<=100/g))){h=!1;break a}break;case "max-width":if(1==d||"px"==EQCSS.data[a].a[c].b)if(d=parseInt(e.getPropertyValue("width")),!(d<=g)){h=!1;break a}if("%"==EQCSS.data[a].a[c].b&&(d=parseInt(e.getPropertyValue("width")),e=parseInt(k.getPropertyValue("width")),!(e/d>=100/g))){h=!1;break a}break;
case "min-height":if(1==d||"px"==EQCSS.data[a].a[c].b)if(d=parseInt(e.getPropertyValue("height")),!(d>=g)){h=!1;break a}if("%"==EQCSS.data[a].a[c].b&&(d=parseInt(e.getPropertyValue("height")),e=parseInt(k.getPropertyValue("height")),!(e/d<=100/g))){h=!1;break a}break;case "max-height":if(1==d||"px"==EQCSS.data[a].a[c].b)if(d=parseInt(e.getPropertyValue("height")),!(d<=g)){h=!1;break a}if("%"==EQCSS.data[a].a[c].b&&(d=parseInt(e.getPropertyValue("height")),e=parseInt(k.getPropertyValue("height")),
!(e/d>=100/g))){h=!1;break a}break;case "min-scroll-x":var m=f[b];k=m.scrollLeft;m.f||m.addEventListener("scroll",function(){EQCSS.c();m.f=!0});if(1==d||"px"==EQCSS.data[a].a[c].b){if(!(k>=g)){h=!1;break a}}else if("%"==EQCSS.data[a].a[c].b&&(d=f[b].scrollWidth,e=f[b]==document.documentElement||f[b]==document.body?window.innerWidth:parseInt(e.getPropertyValue("width")),!(k/(d-e)*100>=g))){h=!1;break a}break;case "min-scroll-y":m=f[b];k=f[b].scrollTop;m.f||m.addEventListener("scroll",function(){EQCSS.c();
...
!window.frameElement}catch(g){}n&&b()}l[e](k+"DOMContentLoaded",c,!1);l[e](k+"readystatechange",c,!1);window[e](k+"load",c,!1)}}};EQCSS.h(function(){EQCSS.load()});var r=!0,t=!1,u=!1;EQCSS.c=function(){r?(EQCSS.apply(),r=!1,setTimeout(function(){r=!0;t&&(t=!1,EQCSS.apply())},200)):t=!0};window.addEventListener("resize",EQCSS.c);window.addEventListener("input",EQCSS.c);window.addEventListener("click",EQCSS.c);window.addEventListener("mousedown",function(){u=!0});
window.addEventListener("mouseup",function(){u=!1;EQCSS.c()});window.addEventListener("mousemove",function(){u&&EQCSS.c()});