...
/*can@2.3.4#util/object/isplain/isplain*/
...
/*can@2.3.4#util/inserted/inserted*/
...
/*can@2.3.4#view/callbacks/callbacks*/
...
/*can@2.3.4#compute/get_value_and_bind*/
...
/*can@2.3.4#compute/proto_compute*/
...
/*can@2.3.4#view/scope/compute_data*/
...
/*can@2.3.4#view/stache/expression*/
...
define("can/view/bindings/bindings",["can/util/util","can/view/stache/expression","can/view/callbacks/callbacks","can/control/control","can/view/scope/scope","can/view/href/href"],function(e,t,n){var i={viewModel:function(t,n,i,a){a=a||{};var r,o={},l=[],u={},d={},s=e.extend({},a);e.each(e.makeArray(t.attributes),function(e){var i=c(e,t,{templateType:n.templateType,scope:n.scope,semaphore:o,getViewModel:function(){return r},attributeViewModelBindings:s});i&&(i.onCompleteBinding&&(i.bindingInfo.parentToChild&&void 0!==i.value&&(a[i.bindingInfo.childName]=i.value),l.push(i.onCompleteBinding)),u[e.name]=i.onTeardown)}),r=i(a);for(var p=0,v=l.length;v>p;p++)l[p]();return e.bind.call(t,"attributes",function(e){var i=e.attributeName,a=t.getAttribute(i);u[i]&&u[i]();var o=d[i]&&"attribute"===d[i].parent;if(null!==a||o){var l=c({name:i,value:a},t,{templateType:n.templateType,scope:n.scope,semaphore:{},getViewModel:function(){return r},attributeViewModelBindings:s,initializeValues:!0});l&&(l.onCompleteBinding&&l.onCompleteBinding(),d[i]=l.bindingInfo,u[i]=l.onTeardown)}}),function(){for(var e in u)u[e]()}},data:function(t,n){if(!e.data(e.$(t),"preventDataBindings")){var i,a=e.viewModel(t),r={},o=c({name:n.attributeName,value:t.getAttribute(n.attributeName)},t,{templateType:n.templateType,scope:n.scope,semaphore:r,getViewModel:function(){return a}});o.onCompleteBinding&&o.onCompleteBinding(),i=o.onTeardown,e.one.call(t,"removed",function(){i()}),e.bind.call(t,"attributes",function(e){var o=e.attributeName,l=t.getAttribute(o);if(o===n.attributeName&&(i&&i(),null!==l)){var u=c({name:o,value:l},t,{templateType:n.templateType,scope:n.scope,semaphore:r,getViewModel:function(){return a},initializeValues:!0});u&&(u.onCompleteBinding&&u.onCompleteBinding(),i=u.onTeardown)}})}},reference:function(t,n){t.getAttribute(n.attributeName)&&console.warn("*reference attributes can only export the view model.");var i=e.camelize(n.attributeName.substr(1).toLowerCase()),a=e.viewModel(t),r=n.scope.getRefs();r._context.attr("*"+i,a)},event:function(n,i){var a=i.attributeName,r=0===a.indexOf("can-"),o=0===a.indexOf("can-")?a.substr("can-".length):p(a,"(",")"),l=r;"$"===o.charAt(0)&&(o=o.substr(1),l=!0);var u=function(r){var o=n.getAttribute(a);if(o){var l=e.$(n),u=e.viewModel(l[0]),c=t.parse(p(o),{lookupRule:"method",methodRule:"call"});if(!(c instanceof t.Call||c instanceof t.Helper)){var d=e.map([i.scope._context,l].concat(e.makeArray(arguments)),function(e){return new t.Literal(e)});c=new t.Call(c,d,{})}var s=i.scope.read(c.methodExpr.key,{isArgument:!0});if(!s.value)return s=i.scope.read(c.methodExpr.key,{isArgument:!0}),null;var v=i.scope.add({"@element":l,"@event":r,"@viewModel":u,"@scope":i.scope,"@context":i.scope._context,"%element":this,$element:l,"%event":r,"%viewModel":u,"%scope":i.scope,"%context":i.scope._context},{notContext:!0}),f=c.args(v,null)(),m=c.hash(v,null)();return e.isEmptyObject(m)||f.push(m),s.value.apply(s.parent,f)}};if(m[o]){var c=m[o](i,n,u);u=c.handler,o=c.event}e.bind.call(l?n:e.viewModel(n),o,u);var d=function(t){t.attributeName!==a||this.getAttribute(a)||(e.unbind.call(l?n:e.viewModel(n),o,u),e.unbind.call(n,"attributes",d))};e.bind.call(n,"attributes",d)},value:function(t,n){var i,r="$value",o=e.trim(p(t.getAttribute("can-value")));if("input"!==t.nodeName.toLowerCase()||"checkbox"!==t.type&&"radio"!==t.type)s(t)&&(r="$innerHTML");else{var l=a.scope(t,n.scope,o,{});if("checkbox"===t.type){var u=e.attr.has(t,"can-true-value")?t.getAttribute("can-true-value"):!0,d=e.attr.has(t,"can-false-value")?t.getAttribute("can-false-value"):!1;i=e.compute(function(e){return arguments.length?void l(e?u:d):l()==u})}else"radio"===t.type&&(i=e.compute(function(e){return arguments.length?void(e&&l(t.value)):l()==t.value}));r="$checked",o="getterSetter",n.scope=new e.view.Scope({getterSetter:i})}c({name:"{("+r+"})",value:o},t,{templateType:n.templateType,scope:n.scope,semaphore:{},initializeValues:!0,legacyBindings:!0,syncChildWithParent:!0})}};e.view.attr(/^\{[^\}]+\}$/,i.data),e.view.attr(/\*[\w\.\-_]+/,i.reference),e.view.attr(/^\([\$?\w\.]+\)$/,i.event),e.view.attr(/can-[\w\.]+/,i.event),e.view.attr("can-value",i.value);var a={scope:function(n,i,a,r){if(a){var o=t.parse(a,{baseMethodType:"Call"});return o.value(i,new e.view.Options({}))}return e.compute()},viewModel:function(t,n,i,a){return e.compute(function(t){var n=a.getViewModel();return arguments.length?void n.attr(i,t):"."===i?n:e.compute.read(n,e.compute.read.reads(i),{}).value})},attribute:function(t,n,i,a,r){r||(r="innerHTML"===i?["blur","change"]:"change"),e.isArray(r)||(r=[r]);var o,l,u="select"===t.nodeName.toLowerCase(),c="value"===i&&u&&t.multiple,d=!1,s=function(n){if(u&&!d&&(d=!0,setTimeout(function(){s(n)},1)),l=n,c){n&&"string"==typeof n?(n=n.split(";"),o=!0):n=n?e.makeArray(n):[];var r={};e.each(n,function(e){r[e]=!0}),e.each(t.childNodes,function(e){e.value&&(e.selected=!!r[e.value])})}else!a.legacyBindings&&u&&"selectedIndex"in t&&(t.selectedIndex=-1),e.attr.setAttrOrProp(t,i,null==n?"":n);return n},p=function(){if(c){var n=[],a=t.childNodes;return e.each(a,function(e){e.selected&&e.value&&n.push(e.value)}),o?n.join(";"):n}return e.attr.get(t,i)};return u&&setTimeout(function(){d=!0},1),e.compute(p(),{on:function(n){e.each(r,function(i){e.bind.call(t,i,n)})},off:function(n){e.each(r,function(i){e.unbind.call(t,i,n)})},get:p,set:s})}},r={childToParent:function(t,n,i,a,r,o){var l="function"==typeof n,u=function(t,u){a[r]||(l?(n(u),o&&n()!==i()&&(a[r]=(a[r]||0)+1,i(n()),e.batch.after(function(){--a[r]}))):n instanceof e.Map&&n.attr(u,!0))};return i&&i.isComputed&&i.bind("change",u),u},parentToChild:function(t,n,i,a,r){var o=function(t,n){a[r]=(a[r]||0)+1,i(n),e.batch.after(function(){--a[r]})};return n&&n.isComputed&&n.bind("change",o),o}},o=function(t,i,a){var r=t.name,o=t.value||"",c=r.match(l);if(!c){var d=u.test(r),s=e.camelize(r);if(d||n.attr(r))return;var p="{"===o[0]&&"}"===e.last(o),v="legacy"===a?i[s]:!p,f=p?o.substr(1,o.length-2):o;return v?{bindingAttributeName:r,parent:"attribute",parentName:r,child:"viewModel",childName:s,parentToChild:!0,childToParent:!0}:{bindingAttributeName:r,parent:"scope",parentName:f,child:"viewModel",childName:s,parentToChild:!0,childToParent:!0}}var m=!!c[1],h=m||!!c[2],b=m||!h,g=c[3],w="$"===g.charAt(0);return w?{parent:"scope",child:"attribute",childToParent:h,parentToChild:b,bindingAttributeName:r,childName:g.substr(1),parentName:o,initializeValues:!0}:{parent:"scope",child:"viewModel",childToParent:h,parentToChild:b,bindingAttributeName:r,childName:e.camelize(g),parentName:o,initializeValues:!0}},l=/\{(\()?(\^)?([^\}\)]+)\)?\}/,u=/^(data-view-id|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,c=function(e,t,n){var i=o(e,n.attributeViewModelBindings,n.templateType);if(i){var l,u=a[i.parent](t,n.scope,i.parentName,n),c=a[i.child](t,n.scope,i.childName,n);if(i.parentToChild)var s=r.parentToChild(t,u,c,n.semaphore,i.bindingAttributeName);var p=function(){i.childToParent&&(l=r.childToParent(t,u,c,n.semaphore,i.bindingAttributeName,n.syncChildWithParent)),(n.initializeValues||i.initializeValues)&&d(i,c,u,s,l)},m=function(){f(u,s),f(c,l)};return"viewModel"===i.child?{value:v(u),onCompleteBinding:p,bindingInfo:i,onTeardown:m}:(p(),{bindingInfo:i,onTeardown:m})}},d=function(e,t,n,i,a){e.parentToChild&&!e.childToParent?i({},v(n)):!e.parentToChild&&e.childToParent?a({},v(t)):void 0===v(t)?i({},v(n)):void 0===v(n)?a({},v(t)):i({},v(n))},s=function(){var e={"":!0,"true":!0,"false":!1},t=function(t){if(t&&t.getAttribute){var n=t.getAttribute("contenteditable");return e[n]}};return function(e){var n=t(e);return"boolean"==typeof n?n:!!t(e.parentNode)}}(),p=function(e,t,n){return t=t||"{",n=n||"}",e[0]===t&&e[e.length-1]===n?e.substr(1,e.length-2):e},v=function(e){return e&&e.isComputed?e():e},f=function(e,t){e&&e.isComputed&&"function"==typeof t&&e.unbind("change",t)},m={enter:function(e,t,n){return{event:"keyup",handler:function(e){return 13===e.keyCode?n.call(this,e):void 0}}}};return e.bindings={behaviors:i,getBindingInfo:o,special:m},e.bindings});
...
/*can@2.3.4#view/mustache/mustache*/
...
/*can@2.3.4#util/string/deparam/deparam*/
