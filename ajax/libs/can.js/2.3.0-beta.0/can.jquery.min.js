...
/*can@2.3.0-beta.0#util/array/each*/
...
/*can@2.3.0-beta.0#util/inserted/inserted*/
...
/*can@2.3.0-beta.0#util/jquery/jquery*/
...
/*can@2.3.0-beta.0#util/util*/
define("can/util/util",["can/util/jquery/jquery"],function(u){return u});
/*can@2.3.0-beta.0#view/view*/
...
/*can@2.3.0-beta.0#view/callbacks/callbacks*/
...
/*can@2.3.0-beta.0#view/elements*/
...
/*can@2.3.0-beta.0#util/bind/bind*/
...
/*can@2.3.0-beta.0#util/batch/batch*/
...
/*can@2.3.0-beta.0#compute/proto_compute*/
...
/*can@2.3.0-beta.0#compute/compute*/
...
/*can@2.3.0-beta.0#view/scope/compute_data*/
...
/*can@2.3.0-beta.0#util/string/string*/
...
/*can@2.3.0-beta.0#construct/construct*/
...
/*can@2.3.0-beta.0#map/map_helpers*/
...
/*can@2.3.0-beta.0#view/scope/scope*/
...
/*can@2.3.0-beta.0#view/stache/utils*/
...
/*can@2.3.0-beta.0#view/node_lists/node_lists*/
...
/*can@2.3.0-beta.0#view/parser/parser*/
define("can/view/parser/parser",[],function(){function t(t,e){for(var a=0;a<t.length;a++)e(t[a],a)}function e(e){var a={},r=e.split(",");return t(r,function(t){a[t]=!0}),a}function a(t,e){for(var a=0,r=t.length;r>a;a++){var n=t[a];e[n.tokenType].apply(e,n.args)}return t}var r="-:A-Za-z0-9_",n="[^=>\\s\\/]+",i="\\s*=\\s*",o="(?:"+i+"(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>\\s]+))?",s="\\{\\{[^\\}]*\\}\\}\\}?",l="\\{\\{([^\\}]*)\\}\\}\\}?",u=new RegExp("^<(["+r+"]+)((?:\\s*(?:(?:(?:"+n+")?"+o+")|(?:"+s+")+))*)\\s*(\\/?)>"),c=new RegExp("^<\\/(["+r+"]+)[^>]*>"),f=new RegExp(l,"g"),p=/<|\{\{/,g=/\s/,d=e("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),m=e("a,address,article,applet,aside,audio,blockquote,button,canvas,center,dd,del,dir,div,dl,dt,fieldset,figcaption,figure,footer,form,frameset,h1,h2,h3,h4,h5,h6,header,hgroup,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,output,p,pre,section,script,table,tbody,td,tfoot,th,thead,tr,ul,video"),h=e("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),b=e("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr"),v=e("script,style"),S="start,end,close,attrStart,attrEnd,attrValue,chars,comment,special,done".split(","),k=function(){},y=function(e,r,n){function i(t,e,a,n){if(e=e.toLowerCase(),m[e])for(;F.last()&&h[F.last()];)o("",F.last());b[e]&&F.last()===e&&o("",e),n=d[e]||!!n,r.start(e,n),n||F.push(e),y.parseAttrs(a,r),r.end(e,n)}function o(t,e){var a;if(e)for(a=F.length-1;a>=0&&F[a]!==e;a--);else a=0;if(a>=0){for(var n=F.length-1;n>=a;n--)r.close&&r.close(F[n]);F.length=a}}function s(t,e){r.special&&r.special(e)}if("object"==typeof e)return a(e,r);var l=[];r=r||{},n&&t(S,function(t){var e=r[t]||k;r[t]=function(){e.apply(this,arguments)!==!1&&l.push({tokenType:t,args:[].slice.call(arguments,0)})}});var g,V,N,x=function(){A&&r.chars&&r.chars(A),A=""},F=[],E=e,A="";for(F.last=function(){return this[this.length-1]};e;){if(V=!0,F.last()&&v[F.last()])e=e.replace(new RegExp("([\\s\\S]*?)</"+F.last()+"[^>]*>"),function(t,e){return e=e.replace(/<!--([\s\S]*?)-->|<!\[CDATA\[([\s\S]*?)]]>/g,"$1$2"),r.chars&&r.chars(e),""}),o("",F.last());else if(0===e.indexOf("<!--")?(g=e.indexOf("-->"),g>=0&&(x(),r.comment&&r.comment(e.substring(4,g)),e=e.substring(g+3),V=!1)):0===e.indexOf("</")?(N=e.match(c),N&&(x(),e=e.substring(N[0].length),N[0].replace(c,o),V=!1)):0===e.indexOf("<")?(N=e.match(u),N&&(x(),e=e.substring(N[0].length),N[0].replace(u,i),V=!1)):0===e.indexOf("{{")&&(N=e.match(f),N&&(x(),e=e.substring(N[0].length),N[0].replace(f,s))),V){g=e.search(p),0===g&&e===E&&(A+=e.charAt(0),e=e.substr(1),g=e.search(p));var w=0>g?e:e.substring(0,g);e=0>g?"":e.substring(g),w&&(A+=w)}if(e===E)throw new Error("Parse Error: "+e);E=e}return x(),o(),r.done(),l},V=function(t,e,a,r){t.attrStart=r.substring("number"==typeof t.nameStart?t.nameStart:e,e),a.attrStart(t.attrStart),t.inName=!1},N=function(t,e,a,r){void 0!==t.valueStart&&t.valueStart<e?a.attrValue(r.substring(t.valueStart,e)):!t.inValue,a.attrEnd(t.attrStart),t.attrStart=void 0,t.valueStart=void 0,t.inValue=!1,t.inName=!1,t.inQuote=!1,t.lookingForName=!0};return y.parseAttrs=function(t,e){if(t){for(var a,r=0,n={inDoubleCurly:!1,inName:!1,nameStart:void 0,inValue:!1,valueStart:void 0,inQuote:!1,attrStart:void 0,lookingForName:!0,lookingForValue:!1,lookingForEq:!1};r<t.length;){a=r;var i=t.charAt(r),o=t.charAt(r+1),s=t.charAt(r+2);if(r++,"{"===i&&"{"===o)n.inValue&&a>n.valueStart?e.attrValue(t.substring(n.valueStart,a)):n.inName&&n.nameStart<a&&(V(n,a,e,t),N(n,a,e,t)),n.inDoubleCurly=!0,n.doubleCurlyStart=a+2,r++;else if(n.inDoubleCurly){if("}"===i&&"}"===o){var l="}"===s?1:0;e.special(t.substring(n.doubleCurlyStart,a)),n.inDoubleCurly=!1,n.inValue&&(n.valueStart=a+2+l),r+=1+l}}else n.inValue?n.inQuote?i===n.inQuote&&N(n,a,e,t):g.test(i)&&N(n,a,e,t):"="===i&&(n.lookingForEq||n.lookingForName||n.inName)?(n.attrStart||V(n,a,e,t),n.lookingForValue=!0,n.lookingForName=!1):n.inName?g.test(i)&&(V(n,a,e,t),n.lookingForEq=!0):n.lookingForName?g.test(i)||(n.attrStart&&N(n,a,e,t),n.nameStart=a,n.inName=!0):n.lookingForValue&&(g.test(i)||(n.lookingForValue=!1,n.inValue=!0,"'"===i||'"'===i?(n.inQuote=i,n.valueStart=a+1):n.valueStart=a))}n.inName&&(V(n,a+1,e,t),N(n,a+1,e,t))}},y});
/*can@2.3.0-beta.0#util/array/diff*/
...
/*can@2.3.0-beta.0#view/live/live*/
...
/*can@2.3.0-beta.0#view/stache/mustache_helpers*/
...
/*can@2.3.0-beta.0#view/stache/expression*/
define("can/view/stache/expression",["can/util/util","can/view/stache/utils","can/view/stache/mustache_helpers","can/view/scope/scope"],function(t,e,r,o){var n=function(e,r,o){var n=r.computeData(e,o);return t.compute.temporarilyBind(n.compute),n},s=function(t,e,r,o){var s=n(t,e,o);return s.compute.computeInstance.hasDependencies?{value:s.compute,computeData:s}:{value:s.initialValue,computeData:s}},p=function(t,e,o,n){var p=s(t,e,o,n);if(void 0===p.computeData.initialValue){"@"===t.charAt(0)&&"@index"!==t&&(t=t.substr(1));var i=r.getHelper(t,o);p.helper=i&&i.fn}return p},i=function(t){return t instanceof l||t instanceof a?t:new l(t)},a=function(t){this._value=t};a.prototype.value=function(){return this._value};var u=function(t,e){this.key=t,this.rootExpr=e};u.prototype.value=function(t,e){var r=p(this.key,t,e);return this.isHelper=r.helper,r.helper||r.value};var h=function(t,e){u.apply(this,arguments)};h.prototype.value=function(t,e){return s(this.key,t,e).value};var l=function(t,e){this.expr=t,this.modifiers=e||{},this.isCompute=!1};l.prototype.value=function(){return this._value||(this._value=this.expr.value.apply(this.expr,arguments),this.isCompute=this._value&&this._value.isComputed),!this.isCompute||this.modifiers.compute?this._value:this._value()};var c=function(){},f=function(e,r,o){this.methodExpr=e,this.argExprs=t.map(r,i);var n=this.hashExprs={};t.each(o,function(t,e){n[e]=i(t)})};f.prototype.args=function(t,e){for(var r=[],o=0,n=this.argExprs.length;n>o;o++){var s=this.argExprs[o];r.push(s.value.apply(s,arguments))}return r},f.prototype.hash=function(t,e){var r={};for(var o in this.hashExprs){var n=this.hashExprs[o];r[o]=n.value.apply(n,arguments)}return r},f.prototype.value=function(e,r,o){var n=this.methodExpr.value(e,r);this.isHelper=this.methodExpr.isHelper;var s=this,p=!t.isEmptyObject(this.hashExprs);return t.compute(function(){var t=n;if(t&&t.isComputed&&(t=t()),"function"==typeof t){var i=s.args(e,r),a=s.hash(e,r);return p&&i.push(a),o&&i.push(o),t.apply(null,i)}})};var d=function(){u.apply(this,arguments)};d.prototype.value=function(t,e){var r=p(this.key,t,e,{isArgument:!0,args:[t.attr("."),t]});return r.helper||r.value};var v=function(){u.apply(this,arguments)};v.prototype.value=function(t,e){return s(this.key,t,e,{isArgument:!0,args:[t.attr("."),t]}).value};var y=function(t,e,r){this.methodExpr=t,this.argExprs=e,this.hashExprs=r,this.mode=null};y.prototype.args=function(t,e){for(var r=[],o=0,n=this.argExprs.length;n>o;o++){var s=this.argExprs[o];r.push(s.value.apply(s,arguments))}return r},y.prototype.hash=function(t,e){var r={};for(var o in this.hashExprs){var n=this.hashExprs[o];r[o]=n.value.apply(n,arguments)}return r},y.prototype.helperAndValue=function(e,o){var s,p,i,u,h=this.argExprs.length||!t.isEmptyObject(this.hashExprs),l=this.methodExpr instanceof a?""+this.methodExpr._value:this.methodExpr.key;if(h){s=r.getHelper(l,o);var c=e.attr(".");s||"function"!=typeof c[l]||(s={fn:c[l]})}if(!s){u=this.args(e,o);var f=n(l,e,{isArgument:!1,args:u&&u.length?u:[e.attr("."),e]}),d=f.compute;i=f.initialValue,p=f.compute.computeInstance.hasDependencies?d:i,h||void 0!==i||(s=r.getHelper(l,o))}return{value:p,args:u,helper:s&&s.fn}},y.prototype.evaluator=function(r,o,n,s,p,i,a,u){var h={fn:function(){},inverse:function(){}},l=o.attr("."),c=this.args(o,n,p,i,a,u),f=this.hash(o,n,p,i,a,u);return e.convertToScopes(h,o,n,p,i,a),t.simpleExtend(h,{context:l,scope:o,contexts:o,hash:f,nodeList:p,exprData:this,helperOptions:n,helpers:n}),c.push(h),function(){return r.apply(l,c)||""}},y.prototype.value=function(e,r,o,n,s,p){var i=this.helperAndValue(e,r),a=i.helper;if(!a)return i.value;var u=this.evaluator(a,e,r,o,n,s,p),h=t.compute(u);return t.compute.temporarilyBind(h),h.computeInstance.hasDependencies?h:h()};var m=/[\w\.\\\-_@\/\&%]+/,k=/('.*?'|".*?"|=|[\w\.\\\-_@\/*%]+|[\(\)]|,|\~)/g,g=/^('.*?'|".*?"|[0-9]+\.?[0-9]*|true|false|null|undefined)$/,x=function(t){return m.test(t)},A=/^[\.@]\w/,E=function(t){return x(t)&&A.test(t)},H=function(t){return t.children||(t.children=[]),t},C=function(){this.root={children:[],type:"Root"},this.current=this.root,this.stack=[this.root]};t.simpleExtend(C.prototype,{top:function(){return t.last(this.stack)},isRootTop:function(){return this.top()===this.root},popTo:function(t){this.popUntil(t),this.isRootTop()||this.stack.pop()},firstParent:function(e){for(var r=this.stack.length-2;r>0&&-1===t.inArray(this.stack[r].type,e);)r--;return this.stack[r]},popUntil:function(e){for(;-1===t.inArray(this.top().type,e)&&!this.isRootTop();)this.stack.pop();return this.top()},addTo:function(t,e){var r=this.popUntil(t);H(r).children.push(e)},addToAndPush:function(t,e){this.addTo(t,e),this.stack.push(e)},topLastChild:function(){return t.last(this.top().children)},replaceTopLastChild:function(t){var e=H(this.top()).children;return e.pop(),e.push(t),t},replaceTopLastChildAndPush:function(t){this.replaceTopLastChild(t),this.stack.push(t)},replaceTopAndPush:function(t){var e;return this.top()===this.root?e=H(this.top()).children:(this.stack.pop(),e=H(this.top()).children),e.pop(),e.push(t),this.stack.push(t),t}});var L=function(t){if("Lookup"===t.type){var e=t.key,r=e.lastIndexOf("./"),o=-1===r?0:r+2,n=e.charAt(o);e="."===n||"@"===n?e.substr(0,o)+"@"+e.substr(o+1):e.substr(0,o)+"@"+e.substr(o),t.key=e}return t},R=function(t){var e=t.top();if(e&&"Lookup"===e.type){var r=t.stack[t.stack.length-2];"Helper"!==r.type&&r&&t.replaceTopAndPush({type:"Helper",method:e})}},T={Literal:a,Lookup:u,ScopeLookup:h,Arg:l,Hash:c,Call:f,Helper:y,HelperLookup:d,HelperScopeLookup:v,tokenize:function(e){var r=[];return(t.trim(e)+" ").replace(k,function(t,e){r.push(e)}),r},lookupRules:{"default":function(t,e,r){var o=("Helper"!==e||t.root?"":"Helper")+(r?"Scope":"")+"Lookup";return T[o]},method:function(t,e,r){return h}},methodRules:{"default":function(t){return"Call"===t.type?f:y},call:function(t){return f}},parse:function(t,e){e=e||{};var r=this.ast(t);e.lookupRule||(e.lookupRule="default"),"string"==typeof e.lookupRule&&(e.lookupRule=T.lookupRules[e.lookupRule]),e.methodRule||(e.methodRule="default"),"string"==typeof e.methodRule&&(e.methodRule=T.methodRules[e.methodRule]);var o=this.hydrateAst(r,e,e.baseMethodType||"Helper");return o},hydrateAst:function(t,e,r,o){if("Lookup"===t.type)return new(e.lookupRule(t,r,o))(t.key,t.root&&this.hydrateAst(t.root,e,r));if("Literal"===t.type)return new a(t.value);if("Arg"===t.type)return new l(this.hydrateAst(t.children[0],e,r,o),{compute:!0});if("Hash"===t.type)throw new Error("");if("Call"===t.type||"Helper"===t.type){var n={},s=[],p=t.children;if(p)for(var i=0;i<p.length;i++){var u=p[i];"Hash"===u.type?n[u.prop]=this.hydrateAst(u.children[0],e,t.type,!0):s.push(this.hydrateAst(u,e,t.type,!0))}return new(e.methodRule(t))(this.hydrateAst(t.method,e,t.type),s,n)}},ast:function(t){var e=this.tokenize(t);return this.parseAst(e,{index:0})},parseAst:function(r,o){for(var n,s=new C;o.index<r.length;){var p=r[o.index],i=r[o.index+1];if(o.index++,g.test(p))R(s),s.addTo(["Helper","Call","Hash"],{type:"Literal",value:e.jsonParse(p)});else if("="===i){if(n=s.top(),n&&"Lookup"===n.type){var a=s.firstParent(["Call","Helper","Hash"]);("Call"===a.type||"Root"===a.type)&&(s.popUntil(["Call"]),n=s.top(),s.replaceTopAndPush({type:"Helper",method:"Root"===n.type?t.last(n.children):n}))}s.addToAndPush(["Helper","Call"],{type:"Hash",prop:p}),o.index++}else if(m.test(p)){var u=s.topLastChild();u&&"Call"===u.type&&E(p)?s.replaceTopLastChildAndPush({type:"Lookup",root:u,key:p}):(R(s),s.addToAndPush(["Helper","Call","Hash","Arg"],{type:"Lookup",key:p}))}else if("~"===p)R(s),s.addToAndPush(["Helper","Call","Hash"],{type:"Arg",key:p});else if("("===p){if(n=s.top(),"Lookup"!==n.type)throw new Error("Unable to understand expression "+r.join(""));s.replaceTopAndPush({type:"Call",method:L(n)})}else")"===p?s.popTo(["Call"]):","===p&&s.popUntil(["Call"])}return s.root.children[0]}};return t.expression=T,T});
/*can@2.3.0-beta.0#control/control*/
...
/*can@2.3.0-beta.0#view/href/href*/
define("can/view/href/href",["can/util/util","can/view/stache/expression","can/view/callbacks/callbacks","can/view/scope/scope"],function(e,n){var t=function(e){return"{"===e[0]&&"}"===e[e.length-1]?e.substr(1,e.length-2):e};e.view.attr("can-href",function(c,a){var r=n.parse("tmp("+t(c.getAttribute("can-href"))+")",{baseMethodType:"Call"}),i=e.compute(function(){return e.route.url(r.hash(a.scope,null))});c.setAttribute("href",i());var u=function(e,n){c.setAttribute("href",n)};i.bind("change",u),e.bind.call(c,"removed",function(){i.unbind("change",u)})})});
/*can@2.3.0-beta.0#view/bindings/bindings*/
define("can/view/bindings/bindings",["can/util/util","can/view/stache/expression","can/view/callbacks/callbacks","can/control/control","can/view/scope/scope","can/view/href/href"],function(e,t){var n=function(){var e={"":!0,"true":!0,"false":!1},t=function(t){if(t&&t.getAttribute){var n=t.getAttribute("contenteditable");return e[n]}};return function(e){var n=t(e);return"boolean"==typeof n?n:!!t(e.parentNode)}}(),i=function(e,t,n){return t=t||"{",n=n||"}",e[0]===t&&e[e.length-1]===n?e.substr(1,e.length-2):e};e.view.attr("can-value",function(t,a){var o,l,h=e.trim(i(t.getAttribute("can-value"))),v=a.scope.computeData(h,{args:[]}).compute;return"input"===t.nodeName.toLowerCase()&&("checkbox"===t.type&&(o=e.attr.has(t,"can-true-value")?t.getAttribute("can-true-value"):!0,l=e.attr.has(t,"can-false-value")?t.getAttribute("can-false-value"):!1),"checkbox"===t.type||"radio"===t.type)?void new u(t,{value:v,trueValue:o,falseValue:l}):"select"===t.nodeName.toLowerCase()&&t.multiple?void new s(t,{value:v}):n(t)?void new c(t,{value:v}):void new r(t,{value:v})});var a={enter:function(e,t,n){return{event:"keyup",handler:function(e){return 13===e.keyCode?n.call(this,e):void 0}}}},o=function(n,o){var r=o.attributeName,u=0===r.indexOf("can-"),s=0===r.indexOf("can-")?r.substr("can-".length):i(r,"(",")"),c=!u;"$"===s.charAt(0)&&(s=s.substr(1),c=!0);var l=function(a){var u=n.getAttribute(r);if(u){var s=e.$(this),c=e.viewModel(s[0]),l=t.parse(i(u),{lookupRule:"method",methodRule:"call"});if(!(l instanceof t.Call||l instanceof t.Helper)){var h=e.map([o.scope._context,s].concat(e.makeArray(arguments)),function(e){return new t.Literal(e)});l=new t.Call(l,h,{})}var v=o.scope.read(l.methodExpr.key,{isArgument:!0}),p=o.scope.add({"@element":s,"@event":a,"@viewModel":c,"@scope":o.scope,"@context":o.scope._context,"%element":this,$element:s,"%event":a,"%viewModel":c,"%scope":o.scope,"%context":o.scope._context},{notContext:!0}),d=l.args(p,null),f=l.hash(p,null);return e.isEmptyObject(f)||d.push(f),v.value.apply(v.parent,d)}};if(a[s]){var h=a[s](o,n,l);l=h.handler,s=h.event}e.bind.call(n,s,l);var v=function(t){t.attributeName!==r||this.getAttribute(r)||(e.unbind.call(n,s,l),e.unbind.call(n,"attributes",v))};e.bind.call(n,"attributes",v)};e.view.attr(/can-[\w\.]+/,o),e.view.attr(/^\([\$?\w\.]+\)$/,o);var r=e.Control.extend({init:function(){"SELECT"===this.element[0].nodeName.toUpperCase()?setTimeout(e.proxy(this.set,this),1):this.set()},"{value} change":"set",set:function(){if(this.element){var e=this.options.value();null==e&&"SELECT"!==this.element[0].nodeName.toUpperCase()&&(e=""),null!=e&&(this.element[0].value=e)}},change:function(){if(this.element){var e=this.element[0];this.options.value(e.value);var t=this.options.value();e.value!==t&&(e.value=t)}}}),u=e.Control.extend({init:function(){this.isCheckbox="checkbox"===this.element[0].type.toLowerCase(),this.check()},"{value} change":"check",check:function(){if(this.isCheckbox){var t=this.options.value(),n=this.options.trueValue||!0;this.element[0].checked=t==n}else{var i=this.options.value()==this.element[0].value?"set":"remove";e.attr[i](this.element[0],"checked",!0)}},change:function(){this.isCheckbox?this.options.value(this.element[0].checked?this.options.trueValue:this.options.falseValue):this.element[0].checked&&this.options.value(this.element[0].value)}}),s=r.extend({init:function(){this.delimiter=";",setTimeout(e.proxy(this.set,this),1)},set:function(){var t=this.options.value();"string"==typeof t?(t=t.split(this.delimiter),this.isString=!0):t&&(t=e.makeArray(t));var n={};e.each(t,function(e){n[e]=!0}),e.each(this.element[0].childNodes,function(e){e.value&&(e.selected=!!n[e.value])})},get:function(){var t=[],n=this.element[0].childNodes;return e.each(n,function(e){e.selected&&e.value&&t.push(e.value)}),t},change:function(){var t=this.get(),n=this.options.value();this.isString||"string"==typeof n?(this.isString=!0,this.options.value(t.join(this.delimiter))):n instanceof e.List?n.attr(t,!0):this.options.value(t)}}),c=e.Control.extend({init:function(){this.set(),this.on("blur","setValue")},"{value} change":"set",set:function(){var e=this.options.value();this.element[0].innerHTML="undefined"==typeof e?"":e},setValue:function(){this.options.value(this.element[0].innerHTML)}}),l=function(t,n,i){if("input"===t.nodeName.toLowerCase()&&"checkbox"===t.type){var a=!0;t.checked=i==a}else e.attr.set(t,n,null==i?"":i)},h=function(t,n,i){return e.compute(t[n],{on:function(n){e.bind.call(t,i,n)},off:function(n){e.unbind.call(t,i,n)},get:function(){return e.attr.get(t,n)},set:function(e){l(t,n,e)}})},v=function(e){return e&&e.isComputed?e():e},p=/\{(\()?(\^)?([^\}\)]+)\)?\}/,d=function(e){var t=e.match(p),n=!!t[1],i=n||!!t[2],a=n||!i;return{childToParent:i,parentToChild:a,propName:t[3]}},f=function(n,i,a,o){var r=t.parse(a,{baseMethodType:"Call"});return r.value(i,new e.view.Scope)},m=function(n,i,a){var o,r=e.camelize(a.propName||i.substr(1)),u=r.charAt(0),s="$"===u;if(s)o=h(n,r.substr(1),"change");else{var c=t.parse(r,{baseMethodType:"Call"}),l=e.viewModel(n),v=new e.view.Scope(l);o=c.value(v,new e.view.Scope,{})}return o},b=function(t,n,i,a,o){var r=function(t,n){a[o]=(a[o]||0)+1,i(n),e.batch.after(function(){--a[o]})};return n&&n.isComputed&&(n.bind("change",r),e.one.call(t,"removed",function(){n.unbind("change",r)})),r},g=function(t,n,i,a,o){var r=function(e,t){a[o]||n(t)};return i&&i.isComputed&&(i.bind("change",r),e.one.call(t,"removed",function(){i.unbind("change",r)})),r},w=function(e,t,n){var i,a,o=t.attributeName,r=f(e,t.scope,e.getAttribute(o)||".",n),u=m(e,n.propName||o.replace(/^\{/,"").replace(/\}$/,""),n),s={};return n.parentToChild&&(i=b(e,r,u,s,o)),n.childToParent&&(a=g(e,r,u,s,o)),n.initializeValues&&(n.parentToChild&&!n.childToParent?i({},v(r)):!n.parentToChild&&n.childToParent?a({},v(u)):void 0===u()?i({},v(r)):void 0===r()?a({},v(u)):i({},v(r))),{parentCompute:r,childCompute:u}};return e.view.attr(/^\{[^\}]+\}$/,function(e,t){var n=d(t.attributeName);n.initializeValues=!0,w(e,t,n)}),e.view.attr(/\*[\w\.\-_]+/,function(t,n){t.getAttribute(n.attributeName)&&console.warn("&reference attributes can only export the view model.");var i=e.camelize(n.attributeName.substr(1).toLowerCase()),a=e.viewModel(t),o=n.scope.getRefs();o._context.attr("*"+i,a)}),{getParentCompute:f,bindParentToChild:b,bindChildToParent:g,setupDataBinding:w}});
/*can@2.3.0-beta.0#observe/observe*/
...
/*can@2.3.0-beta.0#view/mustache/mustache*/
...
/*can@2.3.0-beta.0#component/component*/
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/view/bindings/bindings","can/control/control","can/observe/observe","can/view/mustache/mustache"],function(e,t,o,n){var s=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,i=/\{([^\}]+)\}/g,p=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=a.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(i,p){var a,r,c={"@root":p.scope.attr("@root")},u=this,l=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,d={},h=this.scope||this.viewModel,f={},m=[],v=function(){for(var e=0,t=m.length;t>e;e++)m[e]()};if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=i.getAttribute(e.hyphenate(t))}),e.each(e.makeArray(i.attributes),function(o,r){var l=e.camelize(o.name.toLowerCase()),h=o.value;if(!(u.constructor.attributeScopeMappings[l]||s.test(l)||t.attr(o.nodeName))){if("{"===h[0]&&"}"===h[h.length-1])h=h.substr(1,h.length-2);else if("legacy"!==p.templateType)return void(c[l]=h);var m=n.getParentCompute(i,p.scope,h,{});m&&m.isComputed?(n.bindParentToChild(i,m,function(e){a.attr(l,e)},f,l),c[l]=m(),d[l]=m):c[l]=m}}),this.constructor.Map)a=new this.constructor.Map(c);else if(h instanceof e.Map)a=h;else if(e.isFunction(h)){var g=h.call(this,c,p.scope,i);a=g instanceof e.Map?g:g.prototype instanceof e.Map?new g(c):new(e.Map.extend(g))(c)}var y={};e.each(d,function(e,t){y[t]=function(o,n){f[t]||e(n)},a.bind(t,y[t])}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===p.templateType||e.bind.call(i,"attributes",function(t){var o=e.camelize(t.attributeName);d[o]||s.test(o)||a.attr(o,i.getAttribute(t.attributeName))}),this.scope=this.viewModel=a,e.data(e.$(i),"scope",this.scope),e.data(e.$(i),"viewModel",this.scope);var b=(l?e.view.Scope.refsScope():p.scope.add(new e.view.Scope.Refs)).add(this.scope,{viewModel:!0}),w={helpers:{}},M=function(e,t){w.helpers[e]=function(){return t.apply(a,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&M(o,t)}),e.each(this.simpleHelpers||{},function(t,o){M(o,e.view.simpleHelper(t))}),m.push(function(){e.each(y,function(e,t){a.unbind(t,y[t])})}),this._control=new this.constructor.Control(i,{scope:this.scope,viewModel:this.scope,destroy:v});var C=e.view.nodeLists.register([],void 0,!0);m.push(function(){e.view.nodeLists.unregister(C)}),this.constructor.renderer?(w.tags||(w.tags={}),w.tags.content=function S(t,n){var s=p.subtemplate||n.subtemplate,i=s===p.subtemplate;if(s){delete w.tags.content;var r;if(r=i?l?p:{scope:n.scope.cloneFromRef(),options:n.options}:n,r.scope=r.scope.add(a,{"protected":!0,viewModel:!0}),n.parentNodeList){var c=s(r.scope,r.options,n.parentNodeList);o.replace([t],c)}else e.view.live.replace([t],s(r.scope,r.options));w.tags.content=S}},r=this.constructor.renderer(b,p.options.add(w),C)):r="legacy"===p.templateType?e.view.frag(p.subtemplate?p.subtemplate(b,p.options.add(w)):""):p.subtemplate?p.subtemplate(b,p.options.add(w),C):document.createDocumentFragment(),e.appendChild(i,r,e.document),e.view.nodeLists.update(C,e.childNodes(i))}}),a=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var s,p;if(i.lastIndex=0,s=i.test(t),n||!s){if(s){p=e.compute(function(){var n,s=t.replace(i,function(t,s){var i;return"scope"===s||"viewModel"===s?(n=o.scope,""):(s=s.replace(/^(scope|^viewModel)\./,""),i=e.compute.read(o.scope,e.compute.read.reads(s),{isArgument:!0}).value,void 0===i&&(i=e.getObject(s)),"string"==typeof i?i:(n=i,""))}),p=s.split(/\s+/g),a=p.pop();return{processor:this.processors[a]||this.processors.click,parts:[s,p.join(" "),a],delegate:n||void 0}},this);var a=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return p.bind("change",a),n._bindings.readyComputes[t]={compute:p,handler:a},p()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){e.Control.prototype.destroy.apply(this,arguments),"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),r=e.$;return r.fn&&(r.fn.scope=r.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),p});
/*can@2.3.0-beta.0#model/model*/
...
/*can@2.3.0-beta.0#util/string/deparam/deparam*/
...
/*can@2.3.0-beta.0#control/route/route*/
