...
define("can/util/util",function(t,e,n){"format cjs";function r(t,e){var n=t[h],r=n&&p[n];return void 0===e?r||i(t):r&&r[e]}function i(t,e,n){var r=t[h]||(t[h]=++g),i=p[r]||(p[r]={});return void 0!==e&&(i[e]=n),i}var a=t("can/util/can"),o=t("can/util/attr/attr"),s=t("can/dojo/dojo");t("can/event/event"),t("can/util/fragment"),t("can/util/array/each"),t("can/util/object/isplain/isplain"),t("can/util/deferred"),t("can/util/hashchange"),t("can/util/inserted/inserted");var u=s||window.dojo;define("plugd/trigger",["dojo/main"],function(){var t,e=u,n=e.isFunction,r=/mouse(enter|leave)/,i=function(t,e){return"mouse"+("enter"===e?"over":"out")},a=e._mixin;return t=e.doc.createEvent?function(t,n,o){var s=e.doc.createEvent("HTMLEvents");n=n.replace(r,i),s.initEvent(n,"removed"===n||"inserted"===n?!1:!0,!0),o&&a(s,o),t.dispatchEvent(s)}:function(t,r,i){var o="on"+r,s=!1;try{var u=document.createEventObject();("inserted"===r||"removed"===r)&&(u.cancelBubble=!0),a(u,i),t.fireEvent(o,u)}catch(d){var c=a({type:r,target:t,faux:!0,_stopper:function(){s=this.cancelBubble}},i);if(n(t[o])&&t[o](c),"inserted"===r||"removed"===r)return;for(;!s&&t!==e.doc&&t.parentNode;)t=t.parentNode,n(t[o])&&t[o](c)}},e._trigger=function(n,r,i){"string"!=typeof r&&(i=r,r=i.type,delete i.type);var a=e.byId(n),o=r&&"on"===r.slice(0,2)?r.slice(2):r;t(a,o,i)},e.trigger=function(t,r,i){return n(t)||n(r)||n(t[r])?e.hitch.apply(e,arguments)():e._trigger.apply(e,arguments)},e.NodeList.prototype.trigger=e.NodeList._adaptAsForEach(e._trigger),e._Node&&!e._Node.prototype.trigger&&e.extend(e._Node,{trigger:function(t,n){return e._trigger(this,t,n),this}}),e.trigger}),t(["dojo/main","dojo/query","plugd/trigger","dojo/NodeList-dom"]),a.trim=function(t){return t&&u.trim(t)},a.makeArray=function(t){var e=[];return u.forEach(t,function(t){e.push(t)}),e},a.isArray=u.isArray,a.inArray=function(t,e,n){return u.indexOf(e,t,n)},a.map=function(t,e){return u.map(a.makeArray(t||[]),e)},a.extend=function(t){if(t===!0){var e=a.makeArray(arguments);return e.shift(),u.mixin.apply(u,e)}return u.mixin.apply(u,arguments)},a.isEmptyObject=function(t){var e;for(e in t)break;return void 0===e},a.param=function(t){var e=[],n=function(t,n){e.push(encodeURIComponent(t)+"="+encodeURIComponent(n))};for(var r in t)a.buildParam(r,t[r],n);return e.join("&").replace(/%20/g,"+")},a.buildParam=function(t,e,n){if(a.isArray(e))for(var r=0,i=e.length;i>r;++r)n(t+"[]",e[r]);else if(u.isObject(e))for(var o in e)a.buildParam(t+"["+o+"]",e[o],n);else n(t,e)},a.proxy=function(t,e){return u.hitch(e,t)},a.isFunction=function(t){return u.isFunction(t)};var d=0,c=function(t,e,n){t.forEach(function(t){t=new u.NodeList("SELECT"===t.nodeName?[t]:t);var r=a.data(t,"events");r||a.data(t,"events",r={}),r[e]||(r[e]={}),void 0===n.__bindingsIds&&(n.__bindingsIds=d++),r[e][n.__bindingsIds]=t.on(e,n)[0]})},f=function(t,e,n){t.forEach(function(t){var r=new u.NodeList(t),i=a.data(r,"events");if(i){var o=i[e];if(o){var s=o[n.__bindingsIds];u.disconnect(s),delete o[n.__bindingsIds],a.isEmptyObject(o)&&delete i[e]}}})};a.bind=function(t,e){return this.bind&&this.bind!==a.bind?this.bind(t,e):this.on||this.nodeType?c(new u.NodeList("SELECT"===this.nodeName?[this]:this),t,e):this.addEvent?this.addEvent(t,e):a.addEvent.call(this,t,e),this},a.unbind=function(t,e){return this.unbind&&this.unbind!==a.unbind?this.unbind(t,e):this.on||this.nodeType?f(new u.NodeList(this),t,e):a.removeEvent.call(this,t,e),this},a.on=a.bind,a.off=a.unbind,a.trigger=function(t,e,n,r){if(t instanceof u.NodeList||!t.nodeName&&t!==window||(t=a.$(t)),t.trigger)if(r===!1){if(!t[0]||3===t[0].nodeType)return;var i=t.on(e,function(t){t.stopPropagation&&t.stopPropagation(),t.cancelBubble=!0,t._stopper&&t._stopper(),u.disconnect(i)});t.trigger(e,n)}else t.trigger(e,n);else"string"==typeof e&&(e={type:e}),e.target=e.target||t,a.dispatch.call(t,e,a.makeArray(n))},a.delegate=function(t,e,n){return t?this.on||this.nodeType?c(new u.NodeList(this),t+":"+e,n):this.delegate?this.delegate(t,e,n):a.bind.call(this,e,n):a.bind.call(this,e,n),this},a.undelegate=function(t,e,n){return t?this.on||this.nodeType?f(new u.NodeList(this),t+":"+e,n):this.undelegate?this.undelegate(t,e,n):a.unbind.call(this,e,n):a.unbind.call(this,e,n),this};var l=function(t,e){for(var n in t)"function"==typeof e[n]?e[n]=function(){t[n].apply(t,arguments)}:e[n]=n[t]};a.ajax=function(t){var e=a.capitalize((t.type||"get").toLowerCase()),n=u["xhr"+e],r=t.success,i=t.error,o=new a.Deferred,s=n({url:t.url,handleAs:t.dataType,sync:!t.async,headers:t.headers,content:t.data});s.then(function(t,e){l(d,o),o.resolve(t,"success",d),r&&r(t,"success",d)},function(t,e){l(d,o),o.reject(d,"error"),i(d,"error")});var d=s.ioArgs.xhr;return l(d,o),o},a.$=function(t){return t===window?window:"string"==typeof t?u.query(t):new u.NodeList(t&&t.nodeName?[t]:t)},a.append=function(t,e){return t.forEach(function(t){u.place(e,t)})};var p={},g=a.uuid=+new Date,h=a.expando="can"+g,v=function(t){for(var e=[],n=0,r=t.length;r>n;n++)1===t[n].nodeType&&e.push(t[n]);a.trigger(new u.NodeList(e),"removed",[],!1),n=0;for(var i;void 0!==(i=t[n]);n++){var o=i[h];delete p[o]}};a.data=function(t,e,n){return void 0===n?0===t.length?void 0:r(t[0],e):t.forEach(function(t){i(t,e,n)})},a.cleanData=function(t,e){var n=t[h];delete p[n][e]},u.empty=function(t){for(var e;e=t.lastChild;)u.destroy(e)};var m=u.destroy;u.destroy=function(t){t=u.byId(t);var e=[t];return t.getElementsByTagName&&e.concat(a.makeArray(t.getElementsByTagName("*"))),v(e),m.apply(u,arguments)};var y=u.place;u.place=function(t,e,n){"string"==typeof t&&/^\s*</.test(t)&&(t=a.buildFragment(t));var r;r=11===t.nodeType?a.makeArray(t.childNodes):[t];var i=y.call(this,t,e,n);return a.inserted(r),i},a.addClass=function(t,e){return t.addClass(e)},a.remove=function(t){var e=[];return t.forEach(function(t){e.push(t),t.getElementsByTagName&&e.push.apply(e,a.makeArray(t.getElementsByTagName("*")))}),v(e),t.forEach(m),t},a.get=function(t,e){return t[e]},a.has=function(t,e){return u.isDescendant(e,t[0])?t:[]},a.extend(u.Deferred.prototype,{pipe:function(t,e){var n=new u.Deferred;return this.addCallback(function(){n.resolve(t.apply(this,arguments))}),this.addErrback(function(){e?n.reject(e.apply(this,arguments)):n.reject.apply(n,arguments)}),n}}),a.attr=o,delete o.MutationObserver;var b=u.NodeList.prototype.on;u.NodeList.prototype.on=function(t){"attributes"===t&&this.forEach(function(t){var e=a.$(t);a.data(e,"canHasAttributesBindings",(a.data(e,"canHasAttributesBindings")||0)+1)});var e=b.apply(this,arguments);if("attributes"===t){var n=this;a.each(e,function(t,e){var r=t.remove;t.remove=function(){var t=a.$(n[e]),i=a.data(t,"canHasAttributesBindings")||0;return 0>=i?a.cleanData(n[e],"canHasAttributesBindings"):a.data(t,"canHasAttributesBindings",i-1),r.call(this,arguments)}})}return e};var E=u.setAttr;u.setAttr=function(t,e,n){var r=u.getAttr(t,e),i=E.apply(this,arguments),o=u.getAttr(t,e);return o!==r&&a.attr.trigger(t,e,r),i};var N=u.removeAttr;u.removeAttr=function(t,e){var n=u.getAttr(t,e),r=N.apply(this,arguments);return null!=n&&a.attr.trigger(t,e,n),r},n.exports=a});
