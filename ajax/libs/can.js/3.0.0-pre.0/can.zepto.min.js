...
define("can/util/util",function(t,n,e){"format cjs";function a(t,n){var e=t[h],a=e&&l[e];return void 0===n?a||i(t):a&&a[n]||d.call(o(t),n)}function i(t,n,e){var a=t[h]||(t[h]=++f),i=l[a]||(l[a]={});return void 0!==n&&(i[n]=e),i}function r(t){return"number"==typeof t.length}var s=t("can/util/can"),u=t("can/util/attr/attr"),c=t("can/event/event");t("can/zepto/zepto"),t("can/util/fragment"),t("can/util/array/each"),t("can/util/object/isplain/isplain"),t("can/util/deferred"),t("can/util/inserted/inserted");var o=Zepto,l={},d=o.fn.data,f=o.uuid=+new Date,h=o.expando="Zepto"+f;o.fn.data=function(t,n){return void 0===n?0===this.length?void 0:a(this[0],t):this.each(function(e){i(this,t,o.isFunction(n)?n.call(this,e,a(this,t)):n)})},o.cleanData=function(t){for(var n,e=0;void 0!==(n=t[e]);e++)s.trigger(n,"removed",[],!1);for(e=0;void 0!==(n=t[e]);e++){var a=n[h];delete l[a]}};var v=s.each,p=s.isPlainObject;o.extend(s,Zepto),s.inArray=function(t,n){return n?o.inArray.apply(o,arguments):-1},s.isPlainObject=p,s.each=v,s.attr=u,s.event=c,s.map=function(t,n){var e,a,i,s=[];if(r(t))for(a=0;a<t.length;a++)e=n(t[a],a),null!=e&&s.push(e);else for(i in t)e=n(t[i],i),null!=e&&s.push(e);return s};var g=function(t,n){return t[0]&&t[0][n]||t[n]};s.trigger=function(t,n,e,a){t.trigger?t.trigger(n,e):g(t,"dispatchEvent")?a===!1?o([t]).triggerHandler(n,e):o([t]).trigger(n,e):("string"==typeof n&&(n={type:n}),n.target=n.target||t,s.dispatch.call(t,n,s.makeArray(e)))},s.$=Zepto,s.bind=function(t,n){return this.bind&&this.bind!==s.bind?this.bind(t,n):g(this,"addEventListener")?o([this]).bind(t,n):s.addEvent.call(this,t,n),this},s.unbind=function(t,n){return this.unbind&&this.unbind!==s.unbind?this.unbind(t,n):g(this,"addEventListener")?o([this]).unbind(t,n):s.removeEvent.call(this,t,n),this},s.on=s.bind,s.off=s.unbind,s.delegate=function(t,n,e){t?this.delegate?this.delegate(t,n,e):g(this,"addEventListener")?o([this]).delegate(t,n,e):s.addEvent.call(this,n,e):s.bind.call(this,n,e)},s.undelegate=function(t,n,e){t?this.undelegate?this.undelegate(t,n,e):g(this,"addEventListener")?o([this]).undelegate(t,n,e):s.removeEvent.call(this,n,e):s.unbind.call(this,n,e)},o.each(["append","filter","addClass","remove","data","has"],function(t,n){s[n]=function(t){return t[n].apply(t,s.makeArray(arguments).slice(1))}}),s.makeArray=function(t){var n=[];return null==t?[]:void 0===t.length||"string"==typeof t?[t]:(s.each(t,function(t,e){n[e]=t}),n)};var m=o.ajaxSettings.xhr;o.ajaxSettings.xhr=function(){var t=m(),n=t.open;return t.open=function(t,e,a){n.call(this,t,e,void 0===y?!0:y)},t};var y,b=o.ajax,A=function(t,n){for(var e in t)"function"==typeof n[e]?n[e]=function(){t[e].apply(t,arguments)}:n[e]=e[t]};s.ajax=function(t){var n=t.success,e=t.error,a=s.Deferred();t.success=function(t){A(i,a),a.resolve.call(a,t),n&&n.apply(this,arguments)},t.error=function(){A(i,a),a.reject.apply(a,arguments),e&&e.apply(this,arguments)},t.async===!1&&(y=!1);var i=b(t);return y=void 0,A(i,a),a};var E=o.fn.empty;o.fn.empty=function(){return this.each(function(){o.cleanData(this.getElementsByTagName("*")),this.innerHTML=""}),E.call(this)};var x=o.fn.remove;o.fn.remove=function(){return this.each(function(){this.getElementsByTagName&&o.cleanData([this].concat(s.makeArray(this.getElementsByTagName("*"))))}),x.call(this)},s.trim=function(t){return t.trim()},s.isEmptyObject=function(t){var n;for(n in t);return void 0===n},s.extend=function(t){if(t===!0){var n=s.makeArray(arguments);return n.shift(),o.extend.apply(o,n)}return o.extend.apply(o,arguments)},s.get=function(t,n){return t[n]},s.each(["after","prepend","before","append"],function(t){var n=Zepto.fn[t];Zepto.fn[t]=function(){var t,e=s.makeArray(arguments);null!=e[0]&&("string"==typeof e[0]&&(e[0]=o.zepto.fragment(e[0])),t=11===e[0].nodeType?s.makeArray(e[0].childNodes):e[0]instanceof Zepto.fn.constructor?s.makeArray(e[0]):[e[0]]);var a=n.apply(this,e);return s.inserted(t),a}}),delete u.MutationObserver;var j=o.fn.attr;o.fn.attr=function(t,n){var e,a,i="string"==typeof t;void 0!==n&&i&&(e=j.call(this,t));var r=j.apply(this,arguments);return void 0!==n&&i&&(a=j.call(this,t)),a!==e&&s.attr.trigger(this[0],t,e),r};var k=o.fn.removeAttr;o.fn.removeAttr=function(t){var n=j.call(this,t),e=k.apply(this,arguments);return null!=n&&s.attr.trigger(this[0],t,n),e};var B=o.fn.bind,H=o.fn.unbind;o.fn.bind=function(t){return"attributes"===t&&this.each(function(){var t=s.$(this);s.data(t,"canHasAttributesBindings",(s.data(t,"canHasAttributesBindings")||0)+1)}),B.apply(this,arguments)},o.fn.unbind=function(t){return"attributes"===t&&this.each(function(){var t=s.$(this),n=s.data(t,"canHasAttributesBindings")||0;0>=n?s.data(t,"canHasAttributesBindings",0):s.data(t,"canHasAttributesBindings",n-1)}),H.apply(this,arguments)},e.exports=s});
