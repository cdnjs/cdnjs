...
define("can/util/util",function(n,t,e){"format cjs";var r=n("can/util/attr/attr");n("can/mootools/mootools"),n("can/event/event"),n("can/util/fragment"),n("can/util/array/each"),n("can/util/object/isplain/isplain"),n("can/util/deferred"),n("can/util/inserted/inserted"),can.trim=function(n){return n?n.trim():n};var a=function(){var n,t,e,r,a,i,c=arguments[0]||{},o=1,s=arguments.length,u=!1;for("boolean"==typeof c&&(u=c,c=arguments[1]||{},o=2),"object"==typeof c||can.isFunction(c)||(c={}),s===o&&(c=this,--o);s>o;o++)if(null!==(n=arguments[o]))for(t in n)e=c[t],r=n[t],c!==r&&(u&&r&&(can.isPlainObject(r)||(a=can.isArray(r)))?(a?(a=!1,i=e&&can.isArray(e)?e:[]):i=e&&can.isPlainObject(e)?e:{},c[t]=can.extend(u,i,r)):void 0!==r&&(c[t]=r));return c};can.extend=a,can.makeArray=function(n){if(null===n)return[];try{return Type.isEnumerable(n)&&"string"!=typeof n?Array.prototype.slice.call(n):[n]}catch(t){var e,r=[];for(e=0;e<n.length;++e)r.push(n[e]);return r}},can.isArray=function(n){return"array"===typeOf(n)},can.inArray=function(n,t,e){return t?Array.prototype.indexOf.call(t,n,e):-1},can.map=function(n,t){return Array.from(n||[]).map(t)},can.param=function(n){return Object.toQueryString(n)},can.isEmptyObject=function(n){return 0===Object.keys(n).length},can.isFunction=function(n){return"function"===typeOf(n)},can.bind=function(n,t){return this.bind&&this.bind!==can.bind?this.bind(n,t):this.nodeName&&this.nodeType&&11!==this.nodeType?can.$(this).addEvent(n,t):this.addEvent?this.addEvent(n,t):can.addEvent.call(this,n,t),this},can.unbind=function(n,t){return this.unbind&&this.unbind!==can.unbind?this.unbind(n,t):this.nodeName&&this.nodeType&&11!==this.nodeType?can.$(this).removeEvent(n,t):this.removeEvent?this.removeEvent(n,t):can.removeEvent.call(this,n,t),this},can.on=can.bind,can.off=can.unbind,can.trigger=function(n,t,e,r){r=void 0===r?!0:r,e=e||[];var a=!0;if(n.fireEvent)for(n=n[0]||n;n&&a;){t.type||(t={type:t,target:n,stopPropagation:function(){a=!1}});var i=n!==window?can.$(n).retrieve("events")[0]:n.retrieve("events");i&&i[t.type]&&i[t.type].keys.each(function(r){r.apply(n,[t].concat(e))},this),n=r&&n.parentNode&&11!==n.parentNode.nodeType?n.parentNode:null}else"string"==typeof t&&(t={type:t}),t.target=t.target||n,can.dispatch.call(n,t,can.makeArray(e))},can.delegate=function(n,t,e){return this.delegate?this.delegate(n,t,e):this.addEvent?this.addEvent(t+":relay("+n+")",e):can.bind.call(this,t,e),this},can.undelegate=function(n,t,e){return this.undelegate?this.undelegate(n,t,e):this.removeEvent?this.removeEvent(t+":relay("+n+")",e):can.unbind.call(this,t,e),this};var i={type:"method",success:void 0,error:void 0},c=function(n,t){for(var e in n)"function"==typeof t[e]?t[e]=function(){n[e].apply(n,arguments)}:t[e]=e[n]};can.ajax=function(n){var t,e=can.Deferred(),r=can.extend({},n);for(var a in i)void 0!==r[a]&&(r[i[a]]=r[a],delete r[a]);r.method=r.method||"get",r.url=r.url.toString();var o=n.onSuccess||n.success,s=n.onFailure||n.error;return r.onSuccess=function(n,r){var a=n;c(t.xhr,e),e.resolve(a,"success",t.xhr),o&&o(a,"success",t.xhr)},r.onFailure=function(){c(t.xhr,e),e.reject(t.xhr,"error"),s&&s(t.xhr,"error")},t="json"===n.dataType?new Request.JSON(r):new Request(r),t.send(),c(t.xhr,e),e},can.$=function(n){return n===window?window:$$(n&&n.nodeName?[n]:n)};var o=document.id;document.id=function(n){return n&&11===n.nodeType?n:o.apply(document,arguments)},can.append=function(n,t){return"string"==typeof t&&(t=can.buildFragment(t)),n.grab(t)},can.filter=function(n,t){return n.filter(t)},can.data=function(n,t,e){return void 0===e?n[0].retrieve(t):n.store(t,e)},can.addClass=function(n,t){return n.addClass(t)},can.remove=function(n){var t=n.filter(function(n){return 1===n.nodeType?!0:void n.parentNode.removeChild(n)});return t.destroy(),t},can.has=function(n,t){return Slick.contains(n[0],t)?n:[]};var s=Element.prototype.destroy,u=Element.prototype.grab,d=Element.prototype.set;Element.implement({destroy:function(){can.trigger(this,"removed",[],!1);for(var n,t=this.getElementsByTagName("*"),e=0;void 0!==(n=t[e]);e++)can.trigger(n,"removed",[],!1);s.apply(this,arguments)},grab:function(n){var t;t=n&&11===n.nodeType?can.makeArray(n.childNodes):[n];var e=u.apply(this,arguments);return can.inserted(t),e},set:function(n,t){var e,r,a=-1===can.inArray(n,["events","html","load","morph","send","tag","tween"]);a&&(r=this.get(n));var i=d.apply(this,arguments);return a&&(e=this.get(n)),e!==r&&can.attr.trigger(this,n,r),i}.overloadSetter()}),can.get=function(n,t){return n[t]};var l=Slick.uidOf;Slick.uidOf=function(n){return 1===n.nodeType||n===window||n.document===document?l(n):Math.random()},Element.NativeEvents.hashchange=2,can.attr=r,delete r.MutationObserver,Element.Events.attributes={onAdd:function(){var n=can.$(this);can.data(n,"canHasAttributesBindings",(can.data(n,"canHasAttributesBindings")||0)+1)},onRemove:function(){var n=can.$(this),t=can.data(n,"canHasAttributesBindings")||0;0>=t?can.cleanData(n,"canHasAttributesBindings"):can.data(n,"canHasAttributesBindings",t-1)}},e.exports=can});
