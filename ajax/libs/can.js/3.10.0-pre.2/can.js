...
)({"jquery":"jQuery","can-util/namespace":"can","kefir":"Kefir","validate.js":"validate","react":"React"},window,function(__$source__, __$global__) { // jshint ignore:line
...
/*can-util@3.9.7#js/assign/assign*/
...
/*can-util@3.9.7#js/is-array/is-array*/
...
/*can-util@3.9.7#js/is-function/is-function*/
...
/*can-util@3.9.7#js/is-plain-object/is-plain-object*/
...
/*can-util@3.9.7#js/deep-assign/deep-assign*/
...
/*can-util@3.9.7#js/is-array-like/is-array-like*/
...
/*can-util@3.9.7#js/is-iterable/is-iterable*/
...
/*can-util@3.9.7#js/make-array/make-array*/
...
/*can-util@3.9.7#js/is-container/is-container*/
...
/*can-util@3.9.7#js/string/string*/
...
/*can-util@3.9.7#js/is-empty-object/is-empty-object*/
...
/*can-util@3.9.7#js/global/global*/
...
/*can-util@3.9.7#dom/document/document*/
...
/*can-util@3.9.7#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.9.7#js/cid-set/cid-set*/
...
/*can-util@3.9.7#dom/mutation-observer/document/document*/
...
/*can-util@3.9.7#dom/class-name/class-name*/
...
/*can-util@3.9.7#js/is-browser-window/is-browser-window*/
...
/*can-util@3.9.7#dom/events/events*/
    ...
    module.exports = {
        ...
        dispatch: function (event, args, bubbles) {
            ...
            if (this.disabled === true && ev.type !== 'fix_synthetic_events_on_disabled_test') {
                dev.warn('can-util/dom/events::dispatch: Dispatching a synthetic event on a disabled is ' + 'problematic in FireFox and Internet Exprorer. We recommend avoiding this if at ' + 'all possible. see https://github.com/canjs/can-util/issues/294');
            }
            ev.args = args;
...
/*can-util@3.9.7#dom/dispatch/dispatch*/
...
/*can-util@3.9.7#dom/matches/matches*/
...
/*can-util@3.9.7#dom/events/delegate/delegate*/
...
/*can-util@3.9.7#js/single-reference/single-reference*/
...
/*can-util@3.9.7#dom/events/delegate/enter-leave*/
...
/*can-util@3.9.7#js/cid-map/cid-map*/
...
/*can-util@3.9.7#js/is-promise-like/is-promise-like*/
...
/*can-util@3.9.7#js/set-immediate/set-immediate*/
...
/*can-util@3.9.7#dom/child-nodes/child-nodes*/
...
/*can-util@3.9.7#dom/contains/contains*/
...
/*can-util@3.9.7#dom/mutate/mutate*/
...
/*can-util@3.9.7#dom/fragment/fragment*/
...
/*can-util@3.9.7#dom/events/make-mutation-event/make-mutation-event*/
...
/*can-util@3.9.7#dom/events/removed/removed*/
...
/*can-util@3.9.7#dom/events/attributes/attributes*/
...
/*can-util@3.9.7#dom/events/inserted/inserted*/
...
/*can-util@3.9.7#js/base-url/base-url*/
...
/*can-util@3.9.7#js/parse-uri/parse-uri*/
...
/*can-util@3.9.7#js/join-uris/join-uris*/
...
/*can-stache@3.3.3#src/expression*/
...
/*can-connect@1.5.5#helpers/get-items*/
...
/*can-connect@1.5.5#cache-requests/cache-requests*/
...
/*can-connect@1.5.5#data/callbacks-cache/callbacks-cache*/
...
/*can-connect@1.5.5#helpers/deferred*/
...
/*can-connect@1.5.5#data/combine-requests/combine-requests*/
...
/*can-connect@1.5.5#data/localstorage-cache/localstorage-cache*/
...
/*can-connect@1.5.5#helpers/clone-data*/
...
/*can-connect@1.5.5#data/memory-cache/memory-cache*/
...
/*can-util@3.9.7#js/is-promise/is-promise*/
...
/*can-util@3.9.7#js/make-promise/make-promise*/
...
/*can-connect@1.5.5#data/url/url*/
...
/*can-connect@1.5.5#fall-through-cache/fall-through-cache*/
...
/*can-util@3.9.7#js/defaults/defaults*/
...
/*can-util@3.9.7#js/string-to-any/string-to-any*/
...
/*can-connect@1.5.5#can/super-map/super-map*/
...
/*can-connect@1.5.5#can/base-map/base-map*/
...
/*can-util@3.9.7#js/is-web-worker/is-web-worker*/
...
/*can-util@3.9.7#js/diff-object/diff-object*/
...
/*can-stache@3.3.3#src/mustache_core*/
...
/*can-stache@3.3.3#src/html_section*/
...
/*can-stache@3.3.3#helpers/converter*/
...
/*can-stache@3.3.3#src/intermediate_and_imports*/
...
/*can-util@3.9.7#js/import/import*/
...
/*can-stache@3.3.3#helpers/route*/
...
/*can-stache-bindings@3.5.0-pre.1#can-stache-bindings*/
define('can-stache-bindings', [
    'require',
    'exports',
    'module',
