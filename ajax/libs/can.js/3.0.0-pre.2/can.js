...
define('can/util/can', function (require, exports, module) {
...
/*can-util@3.0.0-pre.15#js/assign/assign*/
...
/*can-util@3.0.0-pre.15#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.15#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.15#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.15#js/deep-extend/deep-extend*/
...
/*can-util@3.0.0-pre.15#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.15#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.15#js/each/each*/
...
/*can-util@3.0.0-pre.15#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.15#js/is-promise/is-promise*/
...
/*can-util@3.0.0-pre.15#js/types/types*/
...
define('can/construct/construct', function (require, exports, module) {
    var can = require('can/util/can');
    module.exports = can.Construct = require('can-construct');
});
/*can@3.0.0-pre.1#can*/
