...
/*can@2.3.18#util/inserted/inserted*/
...
/*can@2.3.18#view/callbacks/callbacks*/
...
/*can@2.3.18#compute/get_value_and_bind*/
...
/*can@2.3.18#compute/proto_compute*/
...
/*can@2.3.18#view/scope/compute_data*/
...
/*can@2.3.18#construct/construct*/
...
/*can@2.3.18#view/node_lists/node_lists*/
...
/*can@2.3.18#view/stache/mustache_helpers*/
...
define("can/view/stache/expression",["can/util/util","can/view/stache/utils","can/view/stache/mustache_helpers","can/view/scope/scope"],function(t,e,r,n){var o=function(e,r,n){var o=r.computeData(e,n);return t.compute.temporarilyBind(o.compute),o},s=function(t,e,r,n){var s=o(t,e,n);return s.compute.computeInstance.hasDependencies?{value:s.compute,computeData:s}:{value:s.initialValue,computeData:s}},a=function(t,e,n,o){var a=s(t,e,n,o);if(void 0===a.computeData.initialValue){"@"===t.charAt(0)&&"@index"!==t&&(t=t.substr(1));var p=r.getHelper(t,n);a.helper=p&&p.fn}return a},p=function(t){return t instanceof l||t instanceof i?t:new l(t)},i=function(t){this._value=t};i.prototype.value=function(){return this._value};var u=function(t,e){this.key=t,this.rootExpr=e};u.prototype.value=function(t,e){var r=a(this.key,t,e);return this.isHelper=r.helper&&!r.helper.callAsMethod,r.helper||r.value};var h=function(t,e){u.apply(this,arguments)};h.prototype.value=function(t,e){return s(this.key,t,e).value};var l=function(t,e){this.expr=t,this.modifiers=e||{},this.isCompute=!1};l.prototype.value=function(){return this.expr.value.apply(this.expr,arguments)};var c=function(){},f=function(e,r,n){this.methodExpr=e,this.argExprs=t.map(r,p);var o=this.hashExprs={};t.each(n,function(t,e){o[e]=p(t)})};f.prototype.args=function(t,e){for(var r=[],n=0,o=this.argExprs.length;o>n;n++){var s=this.argExprs[n],a=s.value.apply(s,arguments);r.push({call:a&&a.isComputed&&!s.modifiers.compute,value:a})}return function(){for(var t=[],e=0,n=r.length;n>e;e++)t[e]=r[e].call?r[e].value():r[e].value;return t}},f.prototype.hash=function(t,e){var r={};for(var n in this.hashExprs){var o=this.hashExprs[n],s=o.value.apply(o,arguments);r[n]={call:s&&s.isComputed&&!o.modifiers.compute,value:s}}return function(){var t={};for(var e in r)t[e]=r[e].call?r[e].value():r[e].value;return t}},f.prototype.value=function(e,r,n){var o=this.methodExpr.value(e,r);this.isHelper=this.methodExpr.isHelper;var s=!t.isEmptyObject(this.hashExprs),a=this.args(e,r),p=this.hash(e,r);return t.compute(function(t){var e=o;if(e&&e.isComputed&&(e=e()),"function"==typeof e){var r=a();return s&&r.push(p()),n&&r.push(n),arguments.length&&r.unshift(new w.SetIdentifier(t)),e.apply(null,r)}})};var d=function(){u.apply(this,arguments)};d.prototype.value=function(t,e){var r=a(this.key,t,e,{isArgument:!0,args:[t.attr("."),t]});return r.helper||r.value};var v=function(){u.apply(this,arguments)};v.prototype.value=function(t,e){return s(this.key,t,e,{callMethodsOnObservables:!0,isArgument:!0,args:[t.attr("."),t]}).value};var y=function(t,e,r){this.methodExpr=t,this.argExprs=e,this.hashExprs=r,this.mode=null};y.prototype.args=function(t,e){for(var r=[],n=0,o=this.argExprs.length;o>n;n++){var s=this.argExprs[n];r.push(s.value.apply(s,arguments))}return r},y.prototype.hash=function(t,e){var r={};for(var n in this.hashExprs){var o=this.hashExprs[n];r[n]=o.value.apply(o,arguments)}return r},y.prototype.helperAndValue=function(e,n){var s,a,p,u,h=this.argExprs.length||!t.isEmptyObject(this.hashExprs),l=this.methodExpr instanceof i?""+this.methodExpr._value:this.methodExpr.key;if(h){s=r.getHelper(l,n);var c=e.attr(".");s||"function"!=typeof c[l]||(s={fn:c[l]})}if(!s){u=this.args(e,n);var f=o(l,e,{isArgument:!1,args:u&&u.length?u:[e.attr("."),e]}),d=f.compute;p=f.initialValue,a=f.compute.computeInstance.hasDependencies?d:p,h||void 0!==p||(s=r.getHelper(l,n))}return{value:a,args:u,helper:s&&s.fn}},y.prototype.evaluator=function(r,n,o,s,a,p,i,u){var h={fn:function(){},inverse:function(){}},l=n.attr("."),c=this.args(n,o,a,p,i,u),f=this.hash(n,o,a,p,i,u);return e.convertToScopes(h,n,o,a,p,i),t.simpleExtend(h,{context:l,scope:n,contexts:n,hash:f,nodeList:a,exprData:this,helperOptions:o,helpers:o}),c.push(h),function(){return r.apply(l,c)}},y.prototype.value=function(e,r,n,o,s,a){var p=this.helperAndValue(e,r),i=p.helper;if(!i)return p.value;var u=this.evaluator(i,e,r,n,o,s,a),h=t.compute(u);return t.compute.temporarilyBind(h),h.computeInstance.hasDependencies?h:h()};var m=/[\w\.\\\-_@\/\&%]+/,g=/('.*?'|".*?"|=|[\w\.\\\-_@\/*%\$]+|[\(\)]|,|\~)/g,k=/^('.*?'|".*?"|[0-9]+\.?[0-9]*|true|false|null|undefined)$/,x=function(t){return m.test(t)},A=/^[\.@]\w/,E=function(t){return x(t)&&A.test(t)},H=function(t){return t.children||(t.children=[]),t},C=function(){this.root={children:[],type:"Root"},this.current=this.root,this.stack=[this.root]};t.simpleExtend(C.prototype,{top:function(){return t.last(this.stack)},isRootTop:function(){return this.top()===this.root},popTo:function(t){this.popUntil(t),this.isRootTop()||this.stack.pop()},firstParent:function(e){for(var r=this.stack.length-2;r>0&&-1===t.inArray(this.stack[r].type,e);)r--;return this.stack[r]},popUntil:function(e){for(;-1===t.inArray(this.top().type,e)&&!this.isRootTop();)this.stack.pop();return this.top()},addTo:function(t,e){var r=this.popUntil(t);H(r).children.push(e)},addToAndPush:function(t,e){this.addTo(t,e),this.stack.push(e)},topLastChild:function(){return t.last(this.top().children)},replaceTopLastChild:function(t){var e=H(this.top()).children;return e.pop(),e.push(t),t},replaceTopLastChildAndPush:function(t){this.replaceTopLastChild(t),this.stack.push(t)},replaceTopAndPush:function(t){var e;return this.top()===this.root?e=H(this.top()).children:(this.stack.pop(),e=H(this.top()).children),e.pop(),e.push(t),this.stack.push(t),t}});var L=function(t){var e=t.lastIndexOf("./"),r=t.lastIndexOf(".");if(r>e)return t.substr(0,r)+"@"+t.substr(r+1);var n=-1===e?0:e+2,o=t.charAt(n);return"."===o||"@"===o?t.substr(0,n)+"@"+t.substr(n+1):t.substr(0,n)+"@"+t.substr(n)},T=function(t){return"Lookup"===t.type&&(t.key=L(t.key)),t},R=function(t){var e=t.top();if(e&&"Lookup"===e.type){var r=t.stack[t.stack.length-2];"Helper"!==r.type&&r&&t.replaceTopAndPush({type:"Helper",method:e})}},w={convertKeyToLookup:L,Literal:i,Lookup:u,ScopeLookup:h,Arg:l,Hash:c,Call:f,Helper:y,HelperLookup:d,HelperScopeLookup:v,SetIdentifier:function(t){this.value=t},tokenize:function(e){var r=[];return(t.trim(e)+" ").replace(g,function(t,e){r.push(e)}),r},lookupRules:{"default":function(t,e,r){var n=("Helper"!==e||t.root?"":"Helper")+(r?"Scope":"")+"Lookup";return w[n]},method:function(t,e,r){return h}},methodRules:{"default":function(t){return"Call"===t.type?f:y},call:function(t){return f}},parse:function(t,e){e=e||{};var r=this.ast(t);e.lookupRule||(e.lookupRule="default"),"string"==typeof e.lookupRule&&(e.lookupRule=w.lookupRules[e.lookupRule]),e.methodRule||(e.methodRule="default"),"string"==typeof e.methodRule&&(e.methodRule=w.methodRules[e.methodRule]);var n=this.hydrateAst(r,e,e.baseMethodType||"Helper");return n},hydrateAst:function(t,e,r,n){if("Lookup"===t.type)return new(e.lookupRule(t,r,n))(t.key,t.root&&this.hydrateAst(t.root,e,r));if("Literal"===t.type)return new i(t.value);if("Arg"===t.type)return new l(this.hydrateAst(t.children[0],e,r,n),{compute:!0});if("Hash"===t.type)throw new Error("");if("Call"===t.type||"Helper"===t.type){var o={},s=[],a=t.children;if(a)for(var p=0;p<a.length;p++){var u=a[p];"Hash"===u.type?o[u.prop]=this.hydrateAst(u.children[0],e,t.type,!0):s.push(this.hydrateAst(u,e,t.type,!0))}return new(e.methodRule(t))(this.hydrateAst(t.method,e,t.type),s,o)}},ast:function(t){var e=this.tokenize(t);return this.parseAst(e,{index:0})},parseAst:function(r,n){for(var o,s=new C;n.index<r.length;){var a=r[n.index],p=r[n.index+1];if(n.index++,k.test(a))R(s),s.addTo(["Helper","Call","Hash"],{type:"Literal",value:e.jsonParse(a)});else if("="===p){if(o=s.top(),o&&"Lookup"===o.type){var i=s.firstParent(["Call","Helper","Hash"]);("Call"===i.type||"Root"===i.type)&&(s.popUntil(["Call"]),o=s.top(),s.replaceTopAndPush({type:"Helper",method:"Root"===o.type?t.last(o.children):o}))}s.addToAndPush(["Helper","Call"],{type:"Hash",prop:a}),n.index++}else if(m.test(a)){var u=s.topLastChild();u&&"Call"===u.type&&E(a)?s.replaceTopLastChildAndPush({type:"Lookup",root:u,key:a}):(R(s),s.addToAndPush(["Helper","Call","Hash","Arg"],{type:"Lookup",key:a}))}else if("~"===a)R(s),s.addToAndPush(["Helper","Call","Hash"],{type:"Arg",key:a});else if("("===a){if(o=s.top(),"Lookup"!==o.type)throw new Error("Unable to understand expression "+r.join(""));s.replaceTopAndPush({type:"Call",method:T(o)})}else")"===a?s.popTo(["Call"]):","===a&&s.popUntil(["Call"])}return s.root.children[0]}};return t.expression=w,w});
...
/*can@2.3.18#view/mustache/mustache*/
...
/*can@2.3.18#util/string/deparam/deparam*/
...
/*can@2.3.18#control/route/route*/
