...
/*can@2.3.0-beta.1#util/fragment*/
...
/*can@2.3.0-beta.1#util/array/each*/
...
/*can@2.3.0-beta.1#util/object/isplain/isplain*/
...
/*can@2.3.0-beta.1#util/deferred*/
...
/*can@2.3.0-beta.1#util/hashchange*/
...
/*can@2.3.0-beta.1#util/inserted/inserted*/
...
/*can@2.3.0-beta.1#view/callbacks/callbacks*/
...
/*can@2.3.0-beta.1#view/elements*/
...
/*can@2.3.0-beta.1#util/bind/bind*/
...
/*can@2.3.0-beta.1#util/batch/batch*/
...
/*can@2.3.0-beta.1#compute/get_value_and_bind*/
...
/*can@2.3.0-beta.1#compute/proto_compute*/
...
/*can@2.3.0-beta.1#compute/compute*/
...
/*can@2.3.0-beta.1#view/scope/compute_data*/
...
/*can@2.3.0-beta.1#util/string/string*/
...
/*can@2.3.0-beta.1#construct/construct*/
...
/*can@2.3.0-beta.1#map/map_helpers*/
...
/*can@2.3.0-beta.1#view/scope/scope*/
...
/*can@2.3.0-beta.1#view/stache/utils*/
...
/*can@2.3.0-beta.1#view/node_lists/node_lists*/
...
/*can@2.3.0-beta.1#view/parser/parser*/
...
/*can@2.3.0-beta.1#util/array/diff*/
...
/*can@2.3.0-beta.1#view/live/live*/
...
/*can@2.3.0-beta.1#view/stache/mustache_helpers*/
...
/*can@2.3.0-beta.1#view/stache/expression*/
...
/*can@2.3.0-beta.1#control/control*/
...
/*can@2.3.0-beta.1#view/href/href*/
...
/*can@2.3.0-beta.1#view/bindings/bindings*/
...
/*can@2.3.0-beta.1#observe/observe*/
...
/*can@2.3.0-beta.1#view/mustache/mustache*/
...
/*can@2.3.0-beta.1#util/view_model/view_model*/
...
/*can@2.3.0-beta.1#component/component*/
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/view/bindings/bindings","can/control/control","can/observe/observe","can/view/mustache/mustache","can/util/view_model/view_model"],function(e,t,o,n){var i=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,s=/\{([^\}]+)\}/g,a=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=p.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(s,a){var p,r,c={"@root":a.scope.attr("@root")},u=this,l=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,d={},h=this.scope||this.viewModel,f={},m=[],v=function(){for(var e=0,t=m.length;t>e;e++)m[e]()};if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=s.getAttribute(e.hyphenate(t))}),e.each(e.makeArray(s.attributes),function(o,r){var l=e.camelize(o.name.toLowerCase()),h=o.value;if(!(u.constructor.attributeScopeMappings[l]||i.test(l)||t.attr(o.nodeName))){if("{"===h[0]&&"}"===h[h.length-1])h=h.substr(1,h.length-2);else if("legacy"!==a.templateType)return void(c[l]=h);var m=n.getParentCompute(s,a.scope,h,{});m&&m.isComputed?(n.bindParentToChild(s,m,function(e){p.attr(l,e)},f,l),c[l]=m(),d[l]=m):c[l]=m}}),this.constructor.Map)p=new this.constructor.Map(c);else if(h instanceof e.Map)p=h;else if(e.isFunction(h)){var g=h.call(this,c,a.scope,s);p=g instanceof e.Map?g:g.prototype instanceof e.Map?new g(c):new(e.Map.extend(g))(c)}var y={};e.each(d,function(e,t){y[t]=function(o,n){f[t]||e(n)},p.bind(t,y[t])}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===a.templateType||e.bind.call(s,"attributes",function(t){var o=e.camelize(t.attributeName);d[o]||i.test(o)||p.attr(o,s.getAttribute(t.attributeName))}),this.scope=this.viewModel=p,e.data(e.$(s),"scope",this.scope),e.data(e.$(s),"viewModel",this.scope);var w=(l?e.view.Scope.refsScope():a.scope.add(new e.view.Scope.Refs)).add(this.scope,{viewModel:!0}),b={helpers:{}},M=function(e,t){b.helpers[e]=function(){return t.apply(p,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&M(o,t)}),e.each(this.simpleHelpers||{},function(t,o){M(o,e.view.simpleHelper(t))}),m.push(function(){e.each(y,function(e,t){p.unbind(t,y[t])})}),this._control=new this.constructor.Control(s,{scope:this.scope,viewModel:this.scope,destroy:v});var C=e.view.nodeLists.register([],void 0,!0);m.push(function(){e.view.nodeLists.unregister(C)}),this.constructor.renderer?(b.tags||(b.tags={}),b.tags.content=function _(t,n){var i=a.subtemplate||n.subtemplate,s=i===a.subtemplate;if(i){delete b.tags.content;var r;if(r=s?l?a:{scope:n.scope.cloneFromRef(),options:n.options}:n,r.scope=r.scope.add(p,{"protected":!0,viewModel:!0}),n.parentNodeList){var c=i(r.scope,r.options,n.parentNodeList);o.replace([t],c)}else e.view.live.replace([t],i(r.scope,r.options));b.tags.content=_}},r=this.constructor.renderer(w,a.options.add(b),C)):r="legacy"===a.templateType?e.view.frag(a.subtemplate?a.subtemplate(w,a.options.add(b)):""):a.subtemplate?a.subtemplate(w,a.options.add(b),C):document.createDocumentFragment(),e.appendChild(s,r,e.document),e.view.nodeLists.update(C,e.childNodes(s))}}),p=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var i,a;if(s.lastIndex=0,i=s.test(t),n||!i){if(i){a=e.compute(function(){var n,i=t.replace(s,function(t,i){var s;return"scope"===i||"viewModel"===i?(n=o.scope,""):(i=i.replace(/^(scope|^viewModel)\./,""),s=e.compute.read(o.scope,e.compute.read.reads(i),{isArgument:!0}).value,void 0===s&&(s=e.getObject(i)),"string"==typeof s?s:(n=s,""))}),a=i.split(/\s+/g),p=a.pop();return{processor:this.processors[p]||this.processors.click,parts:[i,a.join(" "),p],delegate:n||void 0}},this);var p=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return a.bind("change",p),n._bindings.readyComputes[t]={compute:a,handler:p},a()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){e.Control.prototype.destroy.apply(this,arguments),"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),r=e.$;return r.fn&&(r.fn.scope=r.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),a});
/*can@2.3.0-beta.1#model/model*/
...
/*can@2.3.0-beta.1#util/string/deparam/deparam*/
...
/*can@2.3.0-beta.1#control/route/route*/
