...
define("can/util/fragment",["can/util/can"],function(e){var t=/^\s*<(\w+)[^>]*>/,i={}.toString,l=function(e,l){void 0===l&&(l=t.test(e)&&RegExp.$1),e&&"[object Function]"===i.call(e.replace)&&(e=e.replace(/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,"<$1></$2>"));var n=document.createElement("div"),r=document.createElement("div");"tbody"===l||"tfoot"===l||"thead"===l||"colgroup"===l?(r.innerHTML="<table>"+e+"</table>",n=3===r.firstChild.nodeType?r.lastChild:r.firstChild):"col"===l?(r.innerHTML="<table><colgroup>"+e+"</colgroup></table>",n=3===r.firstChild.nodeType?r.lastChild:r.firstChild.firstChild):"tr"===l?(r.innerHTML="<table><tbody>"+e+"</tbody></table>",n=3===r.firstChild.nodeType?r.lastChild:r.firstChild.firstChild):"td"===l||"th"===l?(r.innerHTML="<table><tbody><tr>"+e+"</tr></tbody></table>",n=3===r.firstChild.nodeType?r.lastChild:r.firstChild.firstChild.firstChild):"option"===l?(r.innerHTML="<select>"+e+"</select>",n=3===r.firstChild.nodeType?r.lastChild:r.firstChild):n.innerHTML=""+e;var d={},o=n.childNodes;d.length=o.length;for(var a=0;a<o.length;a++)d[a]=o[a];return[].slice.call(d)};return e.buildFragment=function(e,t){if(e&&11===e.nodeType)return e;for(var i=l(e),n=document.createDocumentFragment(),r=0,d=i.length;d>r;r++)n.appendChild(i[r]);return n},function(){var t="<-\n>",i=e.buildFragment(t,document);if(t!==i.childNodes[0].nodeValue){var l=e.buildFragment;e.buildFragment=function(e,t){var i=l(e,t);return 1===i.childNodes.length&&3===i.childNodes[0].nodeType&&(i.childNodes[0].nodeValue=e),i}}}(),e});
/*can@2.3.6#util/array/each*/
...
/*can@2.3.6#util/object/isplain/isplain*/
...
/*can@2.3.6#util/inserted/inserted*/
...
/*can@2.3.6#view/callbacks/callbacks*/
...
/*can@2.3.6#view/scope/compute_data*/
...
/*can@2.3.6#view/stache/mustache_helpers*/
...
/*can@2.3.6#view/mustache/mustache*/
...
/*can@2.3.6#util/string/deparam/deparam*/
