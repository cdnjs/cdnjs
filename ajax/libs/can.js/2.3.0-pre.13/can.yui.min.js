...
/*can@2.3.0-pre.13#util/fragment*/
...
/*can@2.3.0-pre.13#util/array/each*/
...
/*can@2.3.0-pre.13#util/object/isplain/isplain*/
...
/*can@2.3.0-pre.13#util/deferred*/
...
/*can@2.3.0-pre.13#util/hashchange*/
...
/*can@2.3.0-pre.13#util/inserted/inserted*/
...
/*can@2.3.0-pre.13#view/callbacks/callbacks*/
...
/*can@2.3.0-pre.13#view/elements*/
...
/*can@2.3.0-pre.13#util/string/string*/
...
/*can@2.3.0-pre.13#construct/construct*/
...
/*can@2.3.0-pre.13#control/control*/
...
/*can@2.3.0-pre.13#util/bind/bind*/
...
/*can@2.3.0-pre.13#map/map_helpers*/
...
/*can@2.3.0-pre.13#util/batch/batch*/
...
/*can@2.3.0-pre.13#compute/proto_compute*/
...
/*can@2.3.0-pre.13#compute/compute*/
...
/*can@2.3.0-pre.13#observe/observe*/
...
/*can@2.3.0-pre.13#view/scope/compute_data*/
...
/*can@2.3.0-pre.13#view/node_lists/node_lists*/
...
/*can@2.3.0-pre.13#view/live/live*/
...
/*can@2.3.0-pre.13#view/stache/utils*/
...
/*can@2.3.0-pre.13#component/component*/
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/control/control","can/observe/observe","can/view/mustache/mustache","can/view/bindings/bindings"],function(e,t,o){var n=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,s=/\{([^\}]+)\}/g,i=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=a.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(s,i){var a,p,c={"@root":i.scope.attr("@root")},r=this,u=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,l={},d=this.scope||this.viewModel,h={},f=[],m=function(){for(var e=0,t=f.length;t>e;e++)f[e]()};if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=s.getAttribute(e.hyphenate(t))}),e.each(e.makeArray(s.attributes),function(o,s){var p=e.camelize(o.name.toLowerCase()),u=o.value;if(!(r.constructor.attributeScopeMappings[p]||n.test(p)||t.attr(o.nodeName))){if("{"===u[0]&&"}"===u[u.length-1])u=u.substr(1,u.length-2);else if("legacy"!==i.templateType)return void(c[p]=u);var d=i.scope.computeData(u,{args:[]}),m=d.compute,v=function(t,o){h[p]=(h[p]||0)+1,a.attr(p,o),e.batch.afterPreviousEvents(function(){--h[p]})};m.bind("change",v),c[p]=m(),m.computeInstance.hasDependencies?(f.push(function(){m.unbind("change",v)}),l[p]=d):m.unbind("change",v)}}),this.constructor.Map)a=new this.constructor.Map(c);else if(d instanceof e.Map)a=d;else if(e.isFunction(d)){var v=d.call(this,c,i.scope,s);a=v instanceof e.Map?v:v.prototype instanceof e.Map?new v(c):new(e.Map.extend(v))(c)}var g={};e.each(l,function(e,t){g[t]=function(o,n){h[t]||e.compute(n)},a.bind(t,g[t])}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===i.templateType||e.bind.call(s,"attributes",function(t){var o=e.camelize(t.attributeName);l[o]||n.test(o)||a.attr(o,s.getAttribute(t.attributeName))}),this.scope=this.viewModel=a,e.data(e.$(s),"scope",this.scope),e.data(e.$(s),"viewModel",this.scope);var y=(u?e.view.Scope.refsScope():i.scope.add(new e.view.Scope.Refs)).add(this.scope,{viewModel:!0}),b={helpers:{}},w=function(e,t){b.helpers[e]=function(){return t.apply(a,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&w(o,t)}),e.each(this.simpleHelpers||{},function(t,o){w(o,e.view.simpleHelper(t))}),f.push(function(){e.each(g,function(e,t){a.unbind(t,g[t])})}),this._control=new this.constructor.Control(s,{scope:this.scope,viewModel:this.scope,destroy:m});var M=e.view.nodeLists.register([],void 0,!0);f.push(function(){e.view.nodeLists.unregister(M)}),this.constructor.renderer?(b.tags||(b.tags={}),b.tags.content=function C(t,n){var s=i.subtemplate||n.subtemplate,p=s===i.subtemplate;if(s){delete b.tags.content;var c;if(c=p?u?i:{scope:n.scope.cloneFromRef(),options:n.options}:n,c.scope=c.scope.add(a,{"protected":!0,viewModel:!0}),n.parentNodeList){var r=s(c.scope,c.options,n.parentNodeList);o.replace([t],r)}else e.view.live.replace([t],s(c.scope,c.options));b.tags.content=C}},p=this.constructor.renderer(y,i.options.add(b),M)):p="legacy"===i.templateType?e.view.frag(i.subtemplate?i.subtemplate(y,i.options.add(b)):""):i.subtemplate?i.subtemplate(y,i.options.add(b),M):document.createDocumentFragment(),e.appendChild(s,p,e.document),e.view.nodeLists.update(M,e.childNodes(s))}}),a=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var i,a;if(s.lastIndex=0,i=s.test(t),n||!i){if(i){a=e.compute(function(){var n,i=t.replace(s,function(t,s){var i;return"scope"===s||"viewModel"===s?(n=o.scope,""):(s=s.replace(/^(scope|^viewModel)\./,""),i=e.compute.read(o.scope,s.split("."),{isArgument:!0}).value,void 0===i&&(i=e.getObject(s)),"string"==typeof i?i:(n=i,""))}),a=i.split(/\s+/g),p=a.pop();return{processor:this.processors[p]||this.processors.click,parts:[i,a.join(" "),p],delegate:n||void 0}},this);var p=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return a.bind("change",p),n._bindings.readyComputes[t]={compute:a,handler:p},a()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){e.Control.prototype.destroy.apply(this,arguments),"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),p=e.$;return p.fn&&(p.fn.scope=p.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),i});
/*can@2.3.0-pre.13#model/model*/
...
/*can@2.3.0-pre.13#util/string/deparam/deparam*/
...
/*can@2.3.0-pre.13#control/route/route*/
