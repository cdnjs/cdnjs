...
/*can@2.3.0-pre.9#util/object/isplain/isplain*/
...
/*can@2.3.0-pre.9#util/array/each*/
...
/*can@2.3.0-pre.9#util/inserted/inserted*/
...
/*can@2.3.0-pre.9#util/util*/
define("can/util/util",["can/util/can","can/util/attr/attr","can/event/event","can/zepto/zepto","can/util/object/isplain/isplain","can/util/fragment","can/util/deferred","can/util/array/each","can/util/inserted/inserted"],function(t,n,e){function i(t,n){var e=t[l],i=e&&u[e];return void 0===n?i||a(t):i&&i[n]||c.call(s(t),n)}function a(t,n,e){var i=t[l]||(t[l]=++o),a=u[i]||(u[i]={});return void 0!==n&&(a[n]=e),a}function r(t){return"number"==typeof t.length}var s=Zepto,u={},c=s.fn.data,o=s.uuid=+new Date,l=s.expando="Zepto"+o;s.fn.data=function(t,n){return void 0===n?0===this.length?void 0:i(this[0],t):this.each(function(e){a(this,t,s.isFunction(n)?n.call(this,e,i(this,t)):n)})},s.cleanData=function(n){for(var e,i=0;void 0!==(e=n[i]);i++)t.trigger(e,"removed",[],!1);for(i=0;void 0!==(e=n[i]);i++){var a=e[l];delete u[a]}};var d=t.each,f=t.isPlainObject;s.extend(t,Zepto),t.inArray=function(t,n){return n?s.inArray.apply(s,arguments):-1},t.isPlainObject=f,t.each=d,t.attr=n,t.event=e,t.map=function(t,n){var e,i,a,s=[];if(r(t))for(i=0;i<t.length;i++)e=n(t[i],i),null!=e&&s.push(e);else for(a in t)e=n(t[a],a),null!=e&&s.push(e);return s};var h=function(t,n){return t[0]&&t[0][n]||t[n]};t.trigger=function(n,e,i,a){n.trigger?n.trigger(e,i):h(n,"dispatchEvent")?a===!1?s([n]).triggerHandler(e,i):s([n]).trigger(e,i):("string"==typeof e&&(e={type:e}),e.target=e.target||n,t.dispatch.call(n,e,t.makeArray(i)))},t.$=Zepto,t.bind=function(n,e){return this.bind&&this.bind!==t.bind?this.bind(n,e):h(this,"addEventListener")?s([this]).bind(n,e):t.addEvent.call(this,n,e),this},t.unbind=function(n,e){return this.unbind&&this.unbind!==t.unbind?this.unbind(n,e):h(this,"addEventListener")?s([this]).unbind(n,e):t.removeEvent.call(this,n,e),this},t.on=t.bind,t.off=t.unbind,t.delegate=function(n,e,i){n?this.delegate?this.delegate(n,e,i):h(this,"addEventListener")?s([this]).delegate(n,e,i):t.addEvent.call(this,e,i):t.bind.call(this,e,i)},t.undelegate=function(n,e,i){n?this.undelegate?this.undelegate(n,e,i):h(this,"addEventListener")?s([this]).undelegate(n,e,i):t.removeEvent.call(this,e,i):t.unbind.call(this,e,i)},s.each(["append","filter","addClass","remove","data","has"],function(n,e){t[e]=function(n){return n[e].apply(n,t.makeArray(arguments).slice(1))}}),t.makeArray=function(n){var e=[];return null==n?[]:void 0===n.length||"string"==typeof n?[n]:(t.each(n,function(t,n){e[n]=t}),e)};var v=s.ajaxSettings.xhr;s.ajaxSettings.xhr=function(){var t=v(),n=t.open;return t.open=function(t,e,i){n.call(this,t,e,void 0===g?!0:g)},t};var g,p=s.ajax,m=function(t,n){for(var e in t)"function"==typeof n[e]?n[e]=function(){t[e].apply(t,arguments)}:n[e]=e[t]};t.ajax=function(n){var e=n.success,i=n.error,a=t.Deferred();n.success=function(t){m(r,a),a.resolve.call(a,t),e&&e.apply(this,arguments)},n.error=function(){m(r,a),a.reject.apply(a,arguments),i&&i.apply(this,arguments)},n.async===!1&&(g=!1);var r=p(n);return g=void 0,m(r,a),a};var y=s.fn.empty;s.fn.empty=function(){return this.each(function(){s.cleanData(this.getElementsByTagName("*")),this.innerHTML=""}),y.call(this)};var b=s.fn.remove;s.fn.remove=function(){return this.each(function(){this.getElementsByTagName&&s.cleanData([this].concat(t.makeArray(this.getElementsByTagName("*"))))}),b.call(this)},t.trim=function(t){return t.trim()},t.isEmptyObject=function(t){var n;for(n in t);return void 0===n},t.extend=function(n){if(n===!0){var e=t.makeArray(arguments);return e.shift(),s.extend.apply(s,e)}return s.extend.apply(s,arguments)},t.get=function(t,n){return t[n]},t.each(["after","prepend","before","append"],function(n){var e=Zepto.fn[n];Zepto.fn[n]=function(){var n,i=t.makeArray(arguments);null!=i[0]&&("string"==typeof i[0]&&(i[0]=s.zepto.fragment(i[0])),n=11===i[0].nodeType?t.makeArray(i[0].childNodes):i[0]instanceof Zepto.fn.constructor?t.makeArray(i[0]):[i[0]]);var a=e.apply(this,i);return t.inserted(n),a}}),delete n.MutationObserver;var A=s.fn.attr;s.fn.attr=function(n,e){var i,a,r="string"==typeof n;void 0!==e&&r&&(i=A.call(this,n));var s=A.apply(this,arguments);return void 0!==e&&r&&(a=A.call(this,n)),a!==i&&t.attr.trigger(this[0],n,i),s};var E=s.fn.removeAttr;s.fn.removeAttr=function(n){var e=A.call(this,n),i=E.apply(this,arguments);return null!=e&&t.attr.trigger(this[0],n,e),i};var x=s.fn.bind,j=s.fn.unbind;return s.fn.bind=function(n){return"attributes"===n&&this.each(function(){var n=t.$(this);t.data(n,"canHasAttributesBindings",(t.data(n,"canHasAttributesBindings")||0)+1)}),x.apply(this,arguments)},s.fn.unbind=function(n){return"attributes"===n&&this.each(function(){var n=t.$(this),e=t.data(n,"canHasAttributesBindings")||0;0>=e?t.data(n,"canHasAttributesBindings",0):t.data(n,"canHasAttributesBindings",e-1)}),j.apply(this,arguments)},t});
/*can@2.3.0-pre.9#view/view*/
...
/*can@2.3.0-pre.9#view/callbacks/callbacks*/
...
/*can@2.3.0-pre.9#util/string/string*/
...
/*can@2.3.0-pre.9#construct/construct*/
...
/*can@2.3.0-pre.9#control/control*/
...
/*can@2.3.0-pre.9#util/bind/bind*/
define("can/util/bind/bind",["can/util/util"],function(i){return i.bindAndSetup=function(){return i.addEvent.apply(this,arguments),this._initializing||(this._bindings?this._bindings++:(this._bindings=1,this._bindsetup&&this._bindsetup())),this},i.unbindAndTeardown=function(n,t){var s=this.__bindEvents||{},d=s[n]||[],e=d.length;return i.removeEvent.apply(this,arguments),null===this._bindings?this._bindings=0:this._bindings=this._bindings-(e-d.length),!this._bindings&&this._bindteardown&&this._bindteardown(),this},i});
/*can@2.3.0-pre.9#map/bubble*/
...
/*can@2.3.0-pre.9#map/map_helpers*/
...
/*can@2.3.0-pre.9#compute/proto_compute*/
...
/*can@2.3.0-pre.9#compute/compute*/
...
/*can@2.3.0-pre.9#observe/observe*/
...
/*can@2.3.0-pre.9#view/scope/compute_data*/
...
/*can@2.3.0-pre.9#view/scope/scope*/
define("can/view/scope/scope",["can/util/util","can/view/scope/compute_data","can/construct/construct","can/map/map","can/list/list","can/view/view","can/compute/compute"],function(t,e){var n=/(\\)?\./g,r=/\\\./g,i=function(t){var e=[],i=0;return t.replace(n,function(n,o,s){o||(e.push(t.slice(i,s).replace(r,".")),i=s+n.length)}),e.push(t.slice(i).replace(r,".")),e},o=t.Construct.extend({read:t.compute.read,Refs:t.Map.extend({}),Break:function(){},refsScope:function(){return new t.view.Scope(new this.Refs)}},{init:function(t,e,n){this._context=t,this._parent=e,this.__cache={},this._meta=n||{}},attr:t.__notObserve(function(e,n,r){if(r=t.simpleExtend({isArgument:!0,returnObserveMethods:!0,proxyMethods:!1},r),2!==arguments.length){var i=this.read(e,r);return i.value}var o=e.lastIndexOf("."),s=-1!==o?e.substring(0,o):".",u=this.read(s,r).value;-1!==o&&(e=e.substring(o+1,e.length)),t.compute.set(u,e,n,r)}),add:function(t,e){return t!==this._context?new this.constructor(t,this,e):this},computeData:function(t,n){return e(this,t,n)},compute:function(t,e){return this.computeData(t,e).compute},getRefs:function(){return this.getContext(function(t){return t._context instanceof o.Refs})},getViewModel:function(){return this.getContext(function(t){return t._meta.viewModel})},getContext:function(t){for(var e=this;e;){if(t(e))return e._context;e=e._parent}},getRoot:function(){for(var t=this,e=this;t._parent;)e=t,t=t._parent;return t._context instanceof o.Refs&&(t=e),t._context},cloneFromRef:function(){for(var e,n,r=[],i=this;i;){if(e=i._context,e instanceof o.Refs){n=i._parent;break}r.push(e),i=i._parent}return n?(t.each(r,function(t){n=n.add(t)}),n):this},read:function(e,n){if(this._meta["protected"])return this._parent.read(e,n);var r="./"===e.substr(0,2),s="../"===e.substr(0,3),u="."===e||"this"===e,a=".."===e,c=r||s||u||a;if(c&&this._meta.notContext)return this._parent.read(e,n);var f;if(r)f=!0,e=e.substr(2);else{if(s)return this._parent.read(e.substr(3),n);if(u)return{value:this._context};if(a)return{value:this._parent._context};if("@root"===e)return{value:this.getRoot()}}for(var p,h,l,v,d,_,m=-1===e.indexOf("\\.")?e.split("."):i(e),x=this,g=[],b=-1,w=!1,R=t.simpleExtend({foundObservable:function(t,e){h=t,l=m.slice(e)},earlyExit:function(t,e){e>b&&(d=h,v=l,b=e)},executeAnonymousFunctions:!0},n);x;){if(p=x._context,_=p instanceof o.Refs,!(null===p||"object"!=typeof p&&"function"!=typeof p||w&&_||x._meta["protected"])){_&&(w=!0);var O=t.compute.read(p,m,R);if(void 0!==O.value)return{scope:x,rootObserve:h,value:O.value,reads:l};g.push(t.__clearObserved())}x=f?null:x._parent}var y=g.length;if(y)for(var C=0;y>C;C++)t.__addObserved(g[C]);return{setRoot:d,reads:v,value:void 0}}});return t.view.Scope=o,o});
/*can@2.3.0-pre.9#view/scanner*/
...
/*can@2.3.0-pre.9#view/node_lists/node_lists*/
...
/*can@2.3.0-pre.9#util/array/diff*/
...
/*can@2.3.0-pre.9#view/stache/utils*/
...
/*can@2.3.0-pre.9#view/stache/mustache_helpers*/
define("can/view/stache/mustache_helpers",["can/util/util","can/view/stache/utils","can/view/live/live"],function(e,n,t){t=t||e.view.live;var i=function(t){return n.isObserveLike(t)&&n.isArrayLike(t)&&t.attr("length")?t:e.isFunction(t)?t():t},r={each:function(r,s){var o,u,a,c=i(r),f=[];if(c instanceof e.List)return function(n){var i=[n];i.expression="live.list",e.view.nodeLists.register(i,null,s.nodeList),e.view.nodeLists.update(s.nodeList,[n]);var o=function(e,n,t){return s.fn(s.scope.add({"@index":n}).add(e),s.options,t)};t.list(n,r,o,s.context,n.parentNode,i)};var l=c;if(l&&n.isArrayLike(l))for(a=0;a<l.length;a++)f.push(s.fn(s.scope.add({"@index":a}).add(l[a])));else if(n.isObserveLike(l))for(o=e.Map.keys(l),a=0;a<o.length;a++)u=o[a],f.push(s.fn(s.scope.add({"@key":u}).add(l[u])));else if(l instanceof Object)for(u in l)f.push(s.fn(s.scope.add({"@key":u}).add(l[u])));return f},"@index":function(n,t){t||(t=n,n=0);var i=t.scope.attr("@index");return""+((e.isFunction(i)?i():i)+n)},"if":function(n,t){var r;return r=e.isFunction(n)?e.compute.truthy(n)():!!i(n),r?t.fn(t.scope||this):t.inverse(t.scope||this)},is:function(){var n,t,r=arguments[arguments.length-1];if(arguments.length-2<=0)return r.inverse();for(var s=0;s<arguments.length-1;s++){if(t=i(arguments[s]),t=e.isFunction(t)?t():t,s>0&&t!==n)return r.inverse();n=t}return r.fn()},eq:function(){return r.is.apply(this,arguments)},unless:function(n,t){return r["if"].apply(this,[e.isFunction(n)?e.compute(function(){return!n()}):!n,t])},"with":function(e,n){var t=e;return e=i(e),e?n.fn(t):void 0},log:function(e,n){"undefined"!=typeof console&&console.log&&(n?console.log(e,n.context):console.log(e.context))},data:function(n){var t=2===arguments.length?this:arguments[1];return function(i){e.data(e.$(i),n,t||this.context)}},"switch":function(e,n){var t=!1,r=n.helpers.add({"case":function(n,r){return i(e)===i(n)?(t=!0,r.fn(r.scope||this)):void 0},"default":function(e){return t?void 0:e.fn(e.scope||this)}});return n.fn(n.scope,r)},"~":function(n){var t=[].slice.call(arguments),r=t.pop(),s=e.map(t,function(n){var t=i(n);return e.isFunction(t)?t():t}).join(""),o=r.helpers.attr("helpers.module"),u=o?o.uri:void 0,a="."===s[0];if(a&&u)return e.joinURIs(u,s);var c=e.baseURL||"undefined"!=typeof System&&(System.renderingLoader&&System.renderingLoader.baseURL||System.baseURL)||location.pathname;return"/"!==s[0]&&"/"!==c[c.length-1]&&(c+="/"),e.joinURIs(c,s)}},s=function(e,n){r[e]=n};return{registerHelper:s,registerSimpleHelper:function(n,t){s(n,e.view.simpleHelper(t))},getHelper:function(e,n){var t=n.attr("helpers."+e);return t||(t=r[e]),t?{fn:t}:void 0}}});
/*can@2.3.0-pre.9#view/stache/mustache_core*/
define("can/view/stache/mustache_core",["can/util/util","can/view/stache/utils","can/view/stache/mustache_helpers","can/view/live/live","can/view/elements","can/view/scope/scope","can/view/node_lists/node_lists"],function(e,t,n,r,i,a,s){r=r||e.view.live,i=i||e.view.elements,a=a||e.view.Scope,s=s||e.view.nodeLists;var o=/('.*?'|".*?"|=|[\w\.\\\-_@\/~]+|[\(\)])/g,u=/^('.*?'|".*?"|[0-9]+\.?[0-9]*|true|false|null|undefined)$/,c=/(?:(?:^|(\r?)\n)(\s*)(\{\{([^\}]*)\}\}\}?)([^\S\n\r]*)($|\r?\n))|(\{\{([^\}]*)\}\}\}?)/g,p=function(t,n,r,i){for(var a=(e.document||e.global.document).createDocumentFragment(),s=0,o=t.length;o>s;s++)h(a,r.fn(n?t.attr(""+s):t[s],i));return a},h=function(e,t){t&&e.appendChild("string"==typeof t?e.ownerDocument.createTextNode(t):t)},l=function(e,t,n,r){for(var i="",a=0,s=e.length;s>a;a++)i+=n.fn(t?e.attr(""+a):e[a],r);return i},v=function(t,n,r){var i=n.computeData(t,r);return e.compute.temporarilyBind(i.compute),i},f=function(e,t,n,r,i,a){i&&(e.fn=d(i,t,n,r)),a&&(e.inverse=d(a,t,n,r))},d=function(t,n,r,i){var a=function(e,r,i){return t(e||n,r,i)};return e.__notObserve(function(t,s,o){void 0===t||t instanceof e.view.Scope||(t=n.add(t)),void 0===s||s instanceof y.Options||(s=r.add(s));var u=a(t,s||r,o||i);return u})},m=function(e){this._value=e};m.prototype.value=function(){return this._value};var g=function(e){this.key=e};g.prototype=new m,g.prototype.value=function(e,t,n){if(n.asCompute){var r=v(this.key,e,n);return r.compute.computeInstance.hasDependencies?r.compute:r.initialValue}return e.read(this.key,n).value};var x=function(e,t,n){this.name=e,this._args=t,this._hash=n};x.prototype=new m,x.prototype.args=function(e,t,n){for(var r=[],i=0,a=this._args.length;a>i;i++){var s=this._args[i];r.push(s.value.apply(s,arguments))}return r},x.prototype.hash=function(e,t,n){var r={};for(var i in this._hash){var a=this._hash[i];r[i]=a.value.apply(a,arguments)}return r},x.prototype.helperAndValue=function(t,r,i){var a,s,o,u,c=this._args.length||!e.isEmptyObject(this._hash),p=this.name.key;if(c){a=n.getHelper(p,r);var h=t.attr(".");a||"function"!=typeof h[p]||(a={fn:h[p]})}if(!a){u=this.args(t,r,i);var l=v(p,t,{isArgument:!1,args:u&&u.length?u:[t.attr("."),t]}),f=l.compute;o=l.initialValue,s=l.compute.computeInstance.hasDependencies?f:o,c||void 0!==o||(a=n.getHelper(p,r))}return{name:s,args:u,helper:a&&a.fn}},x.prototype.evaluator=function(t,n,r,i,a,s,o,u){var c={fn:function(){},inverse:function(){}},p=n.attr("."),h=this.args(n,r,i,a,s,o,u),l=this.hash(n,r,i,a,s,o,u);return f(c,n,r,a,s,o),e.simpleExtend(c,{context:p,scope:n,contexts:n,hash:l,nodeList:a,exprData:this,helperOptions:r,helpers:r}),h.push(c),function(){return t.apply(p,h)||""}},x.prototype.value=function(t,n,r,i,a,s,o){var u=this.helperAndValue(t,n,r).helper,c=this.evaluator(u,t,n,r,i,a,s,o),p=e.compute(c);return e.compute.temporarilyBind(p),p.computeInstance.hasDependencies?p:p()};var y={Expression:m,ScopeExpression:g,MethodExpression:x,expressionData:function(e){var t=this.expressionDataTokenize(e);return this._expressionData(t,{index:0})},_expressionData:function(e,n){for(var r,i=[],a={};n.index<e.length;){var s=e[n.index],o=e[n.index+1],c=e[n.index+2];if("("===s)n.index++,i.push(this._expressionData(e,n));else{if(")"===s)return n.index++,new x(r,i,a);"="===o?(n.index++,n.index++,n.index++,"("===c?a[s]=this._expressionData(e,n):a[s]=u.test(c)?new m(t.jsonParse(c)):new g(c)):(n.index++,void 0===r?r=new g(s):i.push(u.test(s)?new m(t.jsonParse(s)):new g(s)))}}return new x(r,i,a)},expressionDataTokenize:function(t){var n=[];return(e.trim(t)+" ").replace(o,function(e,t){n.push(t)}),n},makeEvaluator:function(n,r,i,a,s,o,u,c){if("^"===a){var h=o;o=u,u=h}var v={isArgument:!0,args:[n.attr("."),n],asCompute:!0},d=s.helperAndValue(n,r,v,i,o,u,c),m=d.helper,g=d.name;if(m)return s.evaluator(m,n,r,v,i,o,u,c);if(!a)return g&&g.isComputed?g:function(){return""+(null!=g?g:"")};if("#"===a||"^"===a){var x={fn:function(){},inverse:function(){}};return f(x,n,r,i,o,u),function(){var i;if(i=e.isFunction(g)&&g.isComputed?g():g,t.isArrayLike(i)){var a=t.isObserveLike(i);return(a?i.attr("length"):i.length)?(c?l:p)(i,a,x,r):x.inverse(n,r)}return i?x.fn(i||n,r):x.inverse(n,r)}}},makeLiveBindingPartialRenderer:function(t,n){return t=e.trim(t),function(i,a,o){var u=[this];u.expression=">"+t,s.register(u,null,n.directlyNested?o||!0:!0);var c=e.compute(function(){var n,r=t,s=a.attr("partials."+r);if(s)n=s.render?s.render(i,a):s(i,a);else{var o=i.read(r,{isArgument:!0,returnObserveMethods:!0,proxyMethods:!1}).value;if(null===o)return e.frag("");o&&(r=o),n=e.isFunction(r)?r(i,a):e.view.render(r,i,a)}return e.frag(n)});r.html(this,c,this.parentNode,u)}},makeStringBranchRenderer:function(e,t){var n=y.expressionData(t),r=e+t;return function(t,i,a,s){var o=t.__cache[r];(e||!o)&&(o=_(t,i,null,e,n,a,s,!0),e||(t.__cache[r]=o));var u=o();return null==u?"":""+u}},makeLiveBindingBranchRenderer:function(t,n,a){var o=y.expressionData(n);return function(u,c,p,h,l){var v=[this];v.expression=n,s.register(v,null,a.directlyNested?p||!0:!0);var f=_(u,c,v,t,o,h,l,a.tag),d=e.compute(f,null,!1);d.bind("change",e.k);var m=d();if("function"==typeof m){var g=e.__clearObserved();m(this),e.__setObserved(g)}else d.computeInstance.hasDependencies?a.attr?r.simpleAttribute(this,a.attr,d):a.tag?r.attributes(this,d):a.text&&"object"!=typeof m?r.text(this,d,this.parentNode,v):r.html(this,d,this.parentNode,v):a.attr?e.attr.set(this,a.attr,m):a.tag?r.setAttributes(this,m):a.text&&"string"==typeof m?this.nodeValue=m:m&&i.replace([this],e.frag(m,this.ownerDocument));d.unbind("change",e.k)}},splitModeFromExpression:function(t,n){t=e.trim(t);var r=t.charAt(0);return"#/{&^>!".indexOf(r)>=0?t=e.trim(t.substr(1)):r=null,"{"===r&&n.node&&(r=null),{mode:r,expression:t}},cleanLineEndings:function(e){return e.replace(c,function(e,t,n,r,i,a,s,o,u,c){a=a||"",t=t||"",n=n||"";var p=w(i||u,{});return o||">{".indexOf(p.mode)>=0?e:"^#!/".indexOf(p.mode)>=0?r+(0!==c&&s.length?t+"\n":""):n+r+a+(n.length||0!==c?t+"\n":"")})},Options:e.view.Scope.extend({init:function(t,n){t.helpers||t.partials||t.tags||(t={helpers:t}),e.view.Scope.prototype.init.apply(this,arguments)}})},_=y.makeEvaluator,w=y.splitModeFromExpression;return e.view.mustacheCore=y,y});
/*can@2.3.0-pre.9#view/bindings/bindings*/
define("can/view/bindings/bindings",["can/util/util","can/view/stache/mustache_core","can/view/callbacks/callbacks","can/control/control","can/view/scope/scope"],function(e,t){var n=function(){var e={"":!0,"true":!0,"false":!1},t=function(t){if(t&&t.getAttribute){var n=t.getAttribute("contenteditable");return e[n]}};return function(e){var n=t(e);return"boolean"==typeof n?n:!!t(e.parentNode)}}(),i=function(e,t,n){return t=t||"{",n=n||"}",e[0]===t&&e[e.length-1]===n?e.substr(1,e.length-2):e};e.view.attr("can-value",function(t,a){var s,l,h=e.trim(i(t.getAttribute("can-value"))),v=a.scope.computeData(h,{args:[]}).compute;return"input"===t.nodeName.toLowerCase()&&("checkbox"===t.type&&(s=e.attr.has(t,"can-true-value")?t.getAttribute("can-true-value"):!0,l=e.attr.has(t,"can-false-value")?t.getAttribute("can-false-value"):!1),"checkbox"===t.type||"radio"===t.type)?void new u(t,{value:v,trueValue:s,falseValue:l}):"select"===t.nodeName.toLowerCase()&&t.multiple?void new c(t,{value:v}):n(t)?void new r(t,{value:v}):void new o(t,{value:v})});var a={enter:function(e,t,n){return{event:"keyup",handler:function(e){return 13===e.keyCode?n.call(this,e):void 0}}}},s=function(n,s){var o=s.attributeName,u=0===o.indexOf("can-")?o.substr("can-".length):i(o,"(",")"),c=function(a){var u=n.getAttribute(o);if(u){var c=t.expressionData(i(u)),r=s.scope.read(c.name.key,{returnObserveMethods:!0,isArgument:!0,executeAnonymousFunctions:!0}),l=e.$(this),h=e.viewModel(l[0]),v=s.scope.add({"@element":l,"@event":a,"@viewModel":h,"@scope":s.scope,"@context":s.scope._context},{notContext:!0}),p=c.args(v,null,{}),d=c.hash(v,null,{});return e.isEmptyObject(d)||p.push(d),p.length||(p=[s.scope._context,l].concat(e.makeArray(arguments))),r.value.apply(r.parent,p)}};if(a[u]){var r=a[u](s,n,c);c=r.handler,u=r.event}e.bind.call(n,u,c);var l=function(t){t.attributeName!==o||this.getAttribute(o)||(e.unbind.call(n,u,c),e.unbind.call(n,"attributes",l))};e.bind.call(n,"attributes",l)};e.view.attr(/can-[\w\.]+/,s),e.view.attr(/\([\w\.]+\)/,s);var o=e.Control.extend({init:function(){"SELECT"===this.element[0].nodeName.toUpperCase()?setTimeout(e.proxy(this.set,this),1):this.set()},"{value} change":"set",set:function(){if(this.element){var e=this.options.value();null==e&&"SELECT"!==this.element[0].nodeName.toUpperCase()&&(e=""),null!=e&&(this.element[0].value=e)}},change:function(){if(this.element){var e=this.element[0];this.options.value(e.value);var t=this.options.value();e.value!==t&&(e.value=t)}}}),u=e.Control.extend({init:function(){this.isCheckbox="checkbox"===this.element[0].type.toLowerCase(),this.check()},"{value} change":"check",check:function(){if(this.isCheckbox){var t=this.options.value(),n=this.options.trueValue||!0;this.element[0].checked=t==n}else{var i=this.options.value()==this.element[0].value?"set":"remove";e.attr[i](this.element[0],"checked",!0)}},change:function(){this.isCheckbox?this.options.value(this.element[0].checked?this.options.trueValue:this.options.falseValue):this.element[0].checked&&this.options.value(this.element[0].value)}}),c=o.extend({init:function(){this.delimiter=";",setTimeout(e.proxy(this.set,this),1)},set:function(){var t=this.options.value();"string"==typeof t?(t=t.split(this.delimiter),this.isString=!0):t&&(t=e.makeArray(t));var n={};e.each(t,function(e){n[e]=!0}),e.each(this.element[0].childNodes,function(e){e.value&&(e.selected=!!n[e.value])})},get:function(){var t=[],n=this.element[0].childNodes;return e.each(n,function(e){e.selected&&e.value&&t.push(e.value)}),t},change:function(){var t=this.get(),n=this.options.value();this.isString||"string"==typeof n?(this.isString=!0,this.options.value(t.join(this.delimiter))):n instanceof e.List?n.attr(t,!0):this.options.value(t)}}),r=e.Control.extend({init:function(){this.set(),this.on("blur","setValue")},"{value} change":"set",set:function(){var e=this.options.value();this.element[0].innerHTML="undefined"==typeof e?"":e},setValue:function(){this.options.value(this.element[0].innerHTML)}});e.view.attr(/#[\w\.\-_]+/,function(t,n){var a=i(t.getAttribute(n.attributeName))||".",s=e.camelize(n.attributeName.substr(1).toLowerCase()),o=!0;"{"===a.charAt(0)&&(o=!1,a=i(a));var u=e.viewModel(t),c=new e.view.Scope(u),r=n.scope.getRefs(),l=c.computeData(a,{args:[],isArgument:!0}),h=l.compute,v=function(e,t){r.attr(s,t)};h.bind("change",v);var p=h();if(r.attr(s,void 0===p?null:p),o){var d=function(e,t){h(t)};r.bind(s,d)}e.one.call(t,"removed",function(){h.unbind("change",v),o&&r.unbind(s,d)})})});
/*can@2.3.0-pre.9#view/mustache/mustache*/
...
/*can@2.3.0-pre.9#component/component*/
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/control/control","can/observe/observe","can/view/mustache/mustache","can/view/bindings/bindings"],function(e,t,o){var n=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,i=/\{([^\}]+)\}/g,s=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=a.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(i,s){var a,p,c={"@root":s.scope.attr("@root")},r=this,u=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,l={},d=this.scope||this.viewModel,h={},f=[],m=function(){for(var e=0,t=f.length;t>e;e++)f[e]()};if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=i.getAttribute(e.hyphenate(t))}),e.each(e.makeArray(i.attributes),function(o,i){var p=e.camelize(o.name.toLowerCase()),u=o.value;if(!(r.constructor.attributeScopeMappings[p]||n.test(p)||t.attr(o.nodeName))){if("{"===u[0]&&"}"===u[u.length-1])u=u.substr(1,u.length-2);else if("legacy"!==s.templateType)return void(c[p]=u);var d=s.scope.computeData(u,{args:[]}),m=d.compute,v=function(t,o){h[p]=(h[p]||0)+1,a.attr(p,o),e.batch.afterPreviousEvents(function(){--h[p]})};m.bind("change",v),c[p]=m(),m.computeInstance.hasDependencies?(f.push(function(){m.unbind("change",v)}),l[p]=d):m.unbind("change",v)}}),this.constructor.Map)a=new this.constructor.Map(c);else if(d instanceof e.Map)a=d;else if(e.isFunction(d)){var v=d.call(this,c,s.scope,i);a=v instanceof e.Map?v:v.prototype instanceof e.Map?new v(c):new(e.Map.extend(v))(c)}var g={};e.each(l,function(e,t){g[t]=function(o,n){h[t]||e.compute(n)},a.bind(t,g[t])}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===s.templateType||e.bind.call(i,"attributes",function(t){var o=e.camelize(t.attributeName);l[o]||n.test(o)||a.attr(o,i.getAttribute(t.attributeName))}),this.scope=this.viewModel=a,e.data(e.$(i),"scope",this.scope),e.data(e.$(i),"viewModel",this.scope);var b=(u?e.view.Scope.refsScope():s.scope.add(new e.view.Scope.Refs)).add(this.scope,{viewModel:!0}),y={helpers:{}},w=function(e,t){y.helpers[e]=function(){return t.apply(a,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&w(o,t)}),e.each(this.simpleHelpers||{},function(t,o){w(o,e.view.simpleHelper(t))}),f.push(function(){e.each(g,function(e,t){a.unbind(t,g[t])})}),this._control=new this.constructor.Control(i,{scope:this.scope,viewModel:this.scope,destroy:m});var M=e.view.nodeLists.register([],void 0,!0);f.push(function(){e.view.nodeLists.unregister(M)}),this.constructor.renderer?(y.tags||(y.tags={}),y.tags.content=function C(t,n){var i=s.subtemplate||n.subtemplate,p=i===s.subtemplate;if(i){delete y.tags.content;var c;if(c=p?u?s:{scope:n.scope.cloneFromRef(),options:n.options}:n,c.scope=c.scope.add(a,{"protected":!0,viewModel:!0}),n.parentNodeList){var r=i(c.scope,c.options,n.parentNodeList);o.replace([t],r)}else e.view.live.replace([t],i(c.scope,c.options));y.tags.content=C}},p=this.constructor.renderer(b,s.options.add(y),M)):p="legacy"===s.templateType?e.view.frag(s.subtemplate?s.subtemplate(b,s.options.add(y)):""):s.subtemplate?s.subtemplate(b,s.options.add(y),M):document.createDocumentFragment(),e.appendChild(i,p,e.document),e.view.nodeLists.update(M,e.childNodes(i))}}),a=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var s,a;if(i.lastIndex=0,s=i.test(t),n||!s){if(s){a=e.compute(function(){var n,s=t.replace(i,function(t,i){var s;return"scope"===i||"viewModel"===i?(n=o.scope,""):(i=i.replace(/^(scope|^viewModel)\./,""),s=e.compute.read(o.scope,i.split("."),{isArgument:!0}).value,void 0===s&&(s=e.getObject(i)),"string"==typeof s?s:(n=s,""))}),a=s.split(/\s+/g),p=a.pop();return{processor:this.processors[p]||this.processors.click,parts:[s,a.join(" "),p],delegate:n||void 0}},this);var p=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return a.bind("change",p),n._bindings.readyComputes[t]={compute:a,handler:p},a()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),p=e.$;return p.fn&&(p.fn.scope=p.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),s});
/*can@2.3.0-pre.9#model/model*/
...
/*can@2.3.0-pre.9#util/string/deparam/deparam*/
