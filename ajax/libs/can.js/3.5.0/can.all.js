...
/*can-connect-feathers@3.5.2#service/service*/
...
/*debug@2.6.3#src/debug*/
define('debug/src/debug', function (require, exports, module) {
...
define('feathers-authentication-popups', function (require, exports, module) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: true });
...
define('jwt-decode/lib/atob', function (require, exports, module) {
...
define('jwt-decode/lib/base64_url_decode', function (require, exports, module) {
    var atob = require('jwt-decode/lib/atob');
...
define('jwt-decode', function (require, exports, module) {
    'use strict';
    var base64_url_decode = require('jwt-decode/lib/base64_url_decode');
...
/*can-connect-feathers@3.5.2#utils/utils*/
...
/*can-connect-feathers@3.5.2#session/storage*/
...
/*can-connect-feathers@3.5.2#session/session*/
...
/*can-connect-feathers@3.5.2#can-connect-feathers*/
...
/*can-connect-signalr@0.1.0#can-connect-signalr*/
define('can-connect-signalr', function (require, exports, module) {
    var connect = require('can-connect');
    var $ = require('jquery');
...
/*can-zone@0.6.6#lib/zones/globals*/
...
/*can-stream-kefir@0.1.2#can-stream-kefir*/
...
/*can-define-stream@0.0.7#can-define-stream*/
...
/*can-validate-validatejs@0.0.4#can-validate-validatejs*/
define('can-validate-validatejs', function (require, exports, module) {
    var each = require('can-util/js/each/each');
...
/*can-define-validate-validatejs@0.0.3#can-define-validate-validatejs*/
