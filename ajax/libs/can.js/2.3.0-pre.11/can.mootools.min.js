...
/*can@2.3.0-pre.11#util/fragment*/
...
/*can@2.3.0-pre.11#util/deferred*/
...
/*can@2.3.0-pre.11#util/array/each*/
...
/*can@2.3.0-pre.11#util/object/isplain/isplain*/
...
/*can@2.3.0-pre.11#util/inserted/inserted*/
...
/*can@2.3.0-pre.11#view/callbacks/callbacks*/
...
/*can@2.3.0-pre.11#view/elements*/
...
/*can@2.3.0-pre.11#util/string/string*/
...
/*can@2.3.0-pre.11#construct/construct*/
...
/*can@2.3.0-pre.11#control/control*/
...
/*can@2.3.0-pre.11#util/bind/bind*/
...
/*can@2.3.0-pre.11#map/map_helpers*/
...
/*can@2.3.0-pre.11#util/batch/batch*/
define("can/util/batch/batch",["can/util/can"],function(t){var a=1,i=0,n=[],c=[],e=null;t.batch={start:function(t){i++,t&&c.push(t)},stop:function(u,h){if(u?i=0:i--,0===i){if(null!==e)return;e=n.slice(0);var l,r,f=c.slice(0);for(n=[],c=[],t.batch.batchNum=a,a++,h&&t.batch.start(),l=0;l<e.length;l++)t.dispatch.apply(e[l][0],e[l][1]);for(e=null,l=0,r=f.length;l<f.length;l++)f[l]();t.batch.batchNum=void 0}},trigger:function(c,u,h){if(!c._initializing)if(u="string"==typeof u?{type:u,batchNum:t.batch.batchNum}:u,e)e.push([c,[u,h]]);else{if(0===i)return t.dispatch.call(c,u,h);u.batchNum=a,n.push([c,[u,h]])}},afterPreviousEvents:function(a){if(e){var i={};t.bind.call(i,"ready",a),e.push([i,[{type:"ready"},[]]])}else a()}}});
/*can@2.3.0-pre.11#map/map*/
...
/*can@2.3.0-pre.11#compute/get_value_and_bind*/
...
/*can@2.3.0-pre.11#compute/proto_compute*/
...
/*can@2.3.0-pre.11#compute/compute*/
...
/*can@2.3.0-pre.11#observe/observe*/
...
/*can@2.3.0-pre.11#view/scope/compute_data*/
...
/*can@2.3.0-pre.11#view/scope/scope*/
...
/*can@2.3.0-pre.11#view/node_lists/node_lists*/
...
/*can@2.3.0-pre.11#view/parser/parser*/
...
/*can@2.3.0-pre.11#util/array/diff*/
...
/*can@2.3.0-pre.11#view/live/live*/
...
/*can@2.3.0-pre.11#view/stache/utils*/
...
/*can@2.3.0-pre.11#view/bindings/bindings*/
...
/*can@2.3.0-pre.11#view/mustache/mustache*/
...
/*can@2.3.0-pre.11#component/component*/
...
/*can@2.3.0-pre.11#util/string/deparam/deparam*/
...
/*can@2.3.0-pre.11#control/route/route*/
