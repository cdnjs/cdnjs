...
/*util/util*/
define("util/util",["util/can","util/attr/attr","event/event","zepto/zepto","util/object/isplain/isplain","util/fragment","util/deferred","util/array/each","util/inserted/inserted"],function(t,n,e){function i(t,n){var e=t[c],i=e&&s[e];return void 0===n?i||r(t):i&&i[n]||u.call(a(t),n)}function r(t,n,e){var i=t[c]||(t[c]=++o),r=s[i]||(s[i]={});return void 0!==n&&(r[n]=e),r}var a=Zepto,s={},u=a.fn.data,o=a.uuid=+new Date,c=a.expando="Zepto"+o;a.fn.data=function(t,n){return void 0===n?0===this.length?void 0:i(this[0],t):this.each(function(e){r(this,t,a.isFunction(n)?n.call(this,e,i(this,t)):n)})},a.cleanData=function(n){for(var e,i=0;void 0!==(e=n[i]);i++)t.trigger(e,"removed",[],!1);for(i=0;void 0!==(e=n[i]);i++){var r=e[c];delete s[r]}};var d=t.each;a.extend(t,Zepto),t.each=d,t.attr=n,t.event=e;var l=function(t,n){return t[0]&&t[0][n]||t[n]};t.trigger=function(n,e,i,r){n.trigger?n.trigger(e,i):l(n,"dispatchEvent")?r===!1?a([n]).triggerHandler(e,i):a([n]).trigger(e,i):("string"==typeof e&&(e={type:e}),e.target=e.target||n,t.dispatch.call(n,e,t.makeArray(i)))},t.$=Zepto,t.bind=function(n,e){return this.bind&&this.bind!==t.bind?this.bind(n,e):l(this,"addEventListener")?a([this]).bind(n,e):t.addEvent.call(this,n,e),this},t.unbind=function(n,e){return this.unbind&&this.unbind!==t.unbind?this.unbind(n,e):l(this,"addEventListener")?a([this]).unbind(n,e):t.removeEvent.call(this,n,e),this},t.on=t.bind,t.off=t.unbind,t.delegate=function(n,e,i){n?this.delegate?this.delegate(n,e,i):l(this,"addEventListener")?a([this]).delegate(n,e,i):t.addEvent.call(this,e,i):t.bind.call(this,e,i)},t.undelegate=function(n,e,i){n?this.undelegate?this.undelegate(n,e,i):l(this,"addEventListener")?a([this]).undelegate(n,e,i):t.removeEvent.call(this,e,i):t.unbind.call(this,e,i)},a.each(["append","filter","addClass","remove","data","has"],function(n,e){t[e]=function(n){return n[e].apply(n,t.makeArray(arguments).slice(1))}}),t.makeArray=function(n){var e=[];return null==n?[]:void 0===n.length||"string"==typeof n?[n]:(t.each(n,function(t,n){e[n]=t}),e)},t.proxy=function(t,n){return function(){return t.apply(n,arguments)}};var f=a.ajaxSettings.xhr;a.ajaxSettings.xhr=function(){var t=f(),n=t.open;return t.open=function(t,e){n.call(this,t,e,void 0===h?!0:h)},t};var h,v=a.ajax,g=function(t,n){for(var e in t)n[e]="function"==typeof n[e]?function(){t[e].apply(t,arguments)}:e[t]};t.ajax=function(n){var e=n.success,i=n.error,r=t.Deferred();n.success=function(t){g(a,r),r.resolve.call(r,t),e&&e.apply(this,arguments)},n.error=function(){g(a,r),r.reject.apply(r,arguments),i&&i.apply(this,arguments)},n.async===!1&&(h=!1);var a=v(n);return h=void 0,g(a,r),r};var p=a.fn.empty;a.fn.empty=function(){return this.each(function(){a.cleanData(this.getElementsByTagName("*")),this.innerHTML=""}),p.call(this)};var m=a.fn.remove;a.fn.remove=function(){return this.each(function(){this.getElementsByTagName&&a.cleanData([this].concat(t.makeArray(this.getElementsByTagName("*"))))}),m.call(this)},t.trim=function(t){return t.trim()},t.isEmptyObject=function(t){var n;for(n in t);return void 0===n},t.extend=function(n){if(n===!0){var e=t.makeArray(arguments);return e.shift(),a.extend.apply(a,e)}return a.extend.apply(a,arguments)},t.get=function(t,n){return t[n]},t.each(["after","prepend","before","append","html"],function(n){var e=Zepto.fn[n];Zepto.fn[n]=function(){var n,i=t.makeArray(arguments);null!=i[0]&&("string"==typeof i[0]&&(i[0]=a.zepto.fragment(i[0])),n=11===i[0].nodeType?t.makeArray(i[0].childNodes):[i[0]]);var r=e.apply(this,i);return t.inserted(n),r}}),delete n.MutationObserver;var y=a.fn.attr;a.fn.attr=function(n,e){var i,r,a="string"==typeof n;void 0!==e&&a&&(i=y.call(this,n));var s=y.apply(this,arguments);return void 0!==e&&a&&(r=y.call(this,n)),r!==i&&t.attr.trigger(this[0],n,i),s};var b=a.fn.removeAttr;a.fn.removeAttr=function(n){var e=y.call(this,n),i=b.apply(this,arguments);return null!=e&&t.attr.trigger(this[0],n,e),i};var A=a.fn.bind,E=a.fn.unbind;return a.fn.bind=function(n){return"attributes"===n&&this.each(function(){var n=t.$(this);t.data(n,"canHasAttributesBindings",(t.data(n,"canHasAttributesBindings")||0)+1)}),A.apply(this,arguments)},a.fn.unbind=function(n){return"attributes"===n&&this.each(function(){var n=t.$(this),e=t.data(n,"canHasAttributesBindings")||0;0>=e?t.data(n,"canHasAttributesBindings",0):t.data(n,"canHasAttributesBindings",e-1)}),E.apply(this,arguments)},t});
/*view/view*/
