...
/*can@2.3.0-beta.2#util/fragment*/
define("can/util/fragment",["can/util/can"],function(e){var t=/^\s*<(\w+)[^>]*>/,n={}.toString,i=function(e,i){void 0===i&&(i=t.test(e)&&RegExp.$1),e&&"[object Function]"===n.call(e.replace)&&(e=e.replace(/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,"<$1></$2>"));var l=document.createElement("div"),d=document.createElement("div");"tbody"===i||"tfoot"===i||"thead"===i?(d.innerHTML="<table>"+e+"</table>",l=3===d.firstChild.nodeType?d.lastChild:d.firstChild):"tr"===i?(d.innerHTML="<table><tbody>"+e+"</tbody></table>",l=3===d.firstChild.nodeType?d.lastChild:d.firstChild.firstChild):"td"===i||"th"===i?(d.innerHTML="<table><tbody><tr>"+e+"</tr></tbody></table>",l=3===d.firstChild.nodeType?d.lastChild:d.firstChild.firstChild.firstChild):"option"===i?(d.innerHTML="<select>"+e+"</select>",l=3===d.firstChild.nodeType?d.lastChild:d.firstChild):l.innerHTML=""+e;var r={},a=l.childNodes;r.length=a.length;for(var o=0;o<a.length;o++)r[o]=a[o];return[].slice.call(r)};return e.buildFragment=function(e,t){if(e&&11===e.nodeType)return e;for(var n=i(e),l=document.createDocumentFragment(),d=0,r=n.length;r>d;d++)l.appendChild(n[d]);return l},function(){var t="<-\n>",n=e.buildFragment(t,document);if(t!==n.childNodes[0].nodeValue){var i=e.buildFragment;e.buildFragment=function(e,t){var n=i(e,t);return 1===n.childNodes.length&&3===n.childNodes[0].nodeType&&(n.childNodes[0].nodeValue=e),n}}}(),e});
/*can@2.3.0-beta.2#util/deferred*/
...
/*can@2.3.0-beta.2#util/array/each*/
...
/*can@2.3.0-beta.2#util/object/isplain/isplain*/
...
/*can@2.3.0-beta.2#util/inserted/inserted*/
...
/*can@2.3.0-beta.2#view/callbacks/callbacks*/
define("can/view/callbacks/callbacks",["can/util/util","can/view/view"],function(t){var e=t.view.attr=function(t,e){if(!e){var i=a[t];if(!i)for(var l=0,n=r.length;n>l;l++){var s=r[l];if(s.match.test(t)){i=s.handler;break}}return i}"string"==typeof t?a[t]=e:r.push({match:t,handler:e})},a={},r=[],i=/[-\:]/,l=t.view.tag=function(e,a){if(!a){var r=n[e.toLowerCase()];return!r&&i.test(e)&&(r=function(){}),r}t.global.html5&&(t.global.html5.elements+=" "+e,t.global.html5.shivDocument()),n[e.toLowerCase()]=a},n={};return t.view.callbacks={_tags:n,_attributes:a,_regExpAttributes:r,tag:l,attr:e,tagHandler:function(e,a,r){var i,l=r.options.get("tags."+a,{proxyMethods:!1}),s=l||n[a],o=r.scope;if(s){var c=t.__clearObserved();i=s(e,r),t.__setObserved(c)}else i=o;if(i&&r.subtemplate){o!==i&&(o=o.add(i));var v=r.subtemplate(o,r.options),f="string"==typeof v?t.view.frag(v):v;t.appendChild(e,f)}}},t.view.callbacks});
/*can@2.3.0-beta.2#view/elements*/
define("can/view/elements",["can/util/util","can/view/view"],function(t){var e="undefined"!=typeof document?document:null,n=e&&function(){return 1===t.$(document.createComment("~")).length}(),o={tagToContentPropMap:{option:e&&"textContent"in document.createElement("option")?"textContent":"innerText",textarea:"value"},attrMap:t.attr.map,attrReg:/([^\s=]+)[\s]*=[\s]*/,defaultValue:t.attr.defaultValue,tagMap:{"":"span",colgroup:"col",table:"tbody",tr:"td",ol:"li",ul:"li",tbody:"tr",thead:"tr",tfoot:"tr",select:"option",optgroup:"option"},reverseTagMap:{col:"colgroup",tr:"tbody",option:"select",td:"tr",th:"tr",li:"ul"},getParentNode:function(t,e){return e&&11===t.parentNode.nodeType?e:t.parentNode},setAttr:t.attr.set,getAttr:t.attr.get,removeAttr:t.attr.remove,contentText:function(t){return"string"==typeof t?t:t||0===t?""+t:""},after:function(e,n){var o=e[e.length-1];o.nextSibling?t.insertBefore(o.parentNode,n,o.nextSibling,t.document):t.appendChild(o.parentNode,n,t.document)},replace:function(e,r){var a,l=e[0].parentNode;"SELECT"===l.nodeName.toUpperCase()&&l.selectedIndex>=0&&(a=l.value),o.after(e,r),t.remove(t.$(e)).length<e.length&&!n&&t.each(e,function(t){8===t.nodeType&&t.parentNode.removeChild(t)}),void 0!==a&&(l.value=a)}};return t.view.elements=o,o});
/*can@2.3.0-beta.2#util/bind/bind*/
define("can/util/bind/bind",["can/util/util"],function(i){return i.bindAndSetup=function(){return i.addEvent.apply(this,arguments),this._initializing||(this._bindings?this._bindings++:(this._bindings=1,this._bindsetup&&this._bindsetup())),this},i.unbindAndTeardown=function(n,t){if(!this.__bindEvents)return this;var s=this.__bindEvents[n]||[],d=s.length;return i.removeEvent.apply(this,arguments),null===this._bindings?this._bindings=0:this._bindings=this._bindings-(d-s.length),!this._bindings&&this._bindteardown&&this._bindteardown(),this},i});
/*can@2.3.0-beta.2#util/batch/batch*/
define("can/util/batch/batch",["can/util/can"],function(t){var n=1,a=0,i=[],c=[],u=null,l=null;t.batch={start:function(t){a++,t&&c.push(t)},stop:function(e,h){if(e?a=0:a--,0===a){if(null!==u)return;u=i.slice(0),l=c.slice(0);var r,f;for(i=[],c=[],t.batch.batchNum=n,n++,h&&t.batch.start(),r=0;r<u.length;r++)u[r][1][0].orderNum=r,t.dispatch.apply(u[r][0],u[r][1]);for(u=null,r=0,f=l.length;r<l.length;r++)l[r]();l=null,t.batch.batchNum=void 0}},trigger:function(c,l,e){if(!c._initializing)if(l="string"==typeof l?{type:l,batchNum:t.batch.batchNum}:l,u)u.push([c,[l,e]]);else{if(0===a)return t.dispatch.call(c,l,e);l.batchNum=n,i.push([c,[l,e]])}},afterPreviousEvents:function(n){if(u){var a={};t.bind.call(a,"ready",n),u.push([a,[{type:"ready"},[]]])}else n({})},after:function(t){u?l.push(t):t({})}}});
/*can@2.3.0-beta.2#compute/read*/
define("can/compute/read",["can/util/util"],function(e){var t=function(e,n,a){a=a||{};for(var o,u,i={foundObservable:!1},s=r(e,0,n,a,i),d=n.length,v=0;d>v;){u=s;for(var l=0,f=t.propertyReaders.length;f>l;l++){var c=t.propertyReaders[l];if(c.test(s)){s=c.read(s,n[v],v,a,i);break}}if(v+=1,s=r(s,v,n,a,i,u),o=typeof s,v<n.length&&(null===s||"function"!==o&&"object"!==o))return a.earlyExit&&a.earlyExit(u,v-1,s),{value:void 0,parent:u}}return void 0===s&&a.earlyExit&&a.earlyExit(u,v-1),{value:s,parent:u}},n=function(e,t){var n=t[e-1];return n&&n.at},r=function(e,n,r,a,o,u){var i;do{i=!1;for(var s=0,d=t.valueReaders.length;d>s;s++)t.valueReaders[s].test(e,n,r,a)&&(e=t.valueReaders[s].read(e,n,r,a,o,u))}while(i);return e};t.valueReaders=[{name:"compute",test:function(e,t,r,a){return e&&e.isComputed&&!n(t,r)},read:function(t,n,r,a,o){return a.isArgument&&n===r.length?t:(!o.foundObservable&&a.foundObservable&&(a.foundObservable(t,n),o.foundObservable=!0),t instanceof e.Compute?t.get():t())}},{name:"function",test:function(t,n,r,a){var o=typeof t;return!("function"!==o||t.isComputed||e.Construct&&t.prototype instanceof e.Construct||e.route&&t===e.route)},read:function(t,r,a,o,u,i){return n(r,a)?r===a.length?e.proxy(t,i):t:o.isArgument&&r===a.length?o.proxyMethods!==!1?e.proxy(t,i):t:t.apply(i,o.args||[])}}],t.propertyReaders=[{name:"map",test:e.isMapLike,read:function(e,t,n,r,a){return!a.foundObservable&&r.foundObservable&&(r.foundObservable(e,n),a.foundObservable=!0),"function"==typeof e[t.key]&&e.constructor.prototype[t.key]===e[t.key]?e[t.key]:e.attr(t.key)}},{name:"promise",test:function(t){return e.isPromise(t)},read:function(t,n,r,a,o){!o.foundObservable&&a.foundObservable&&(a.foundObservable(t,r),o.foundObservable=!0);var u=t.__observeData;return t.__observeData||(u=t.__observeData={isPending:!0,state:"pending",isResolved:!1,isRejected:!1,value:void 0,reason:void 0},e.cid(u),e.simpleExtend(u,e.event),t.then(function(e){u.isPending=!1,u.isResolved=!0,u.value=e,u.state="resolved",u.dispatch("state",["resolved","pending"])},function(e){u.isPending=!1,u.isRejected=!0,u.reason=e,u.state="rejected",u.dispatch("state",["rejected","pending"])})),e.__observe(u,"state"),n.key in u?u[n.key]:t[n.key]}},{name:"object",test:function(){return!0},read:function(e,t){return null==e?void 0:t.key in e?e[t.key]:t.at&&a[t.key]&&"@"+t.key in e?e["@"+t.key]:void 0}}];var a={index:!0,key:!0,event:!0,element:!0,viewModel:!0};return t.write=function(t,n,r,a){return a=a||{},e.isMapLike(t)?!a.isArgument&&t._data&&t._data[n]&&t._data[n].isComputed?t._data[n](r):t.attr(n,r):t[n]&&t[n].isComputed?t[n](r):void("object"==typeof t&&(t[n]=r))},t.reads=function(e){var t=[],n=0,r=!1;"@"===e.charAt(0)&&(n=1,r=!0);for(var a="",o=n;o<e.length;o++){var u=e.charAt(o);"."===u||"@"===u?"\\"!==e.charAt(o-1)?(t.push({key:a,at:r}),r="@"===u,a=""):a=a.substr(0,a.length-1)+".":a+=u}return t.push({key:a,at:r}),t},t});
/*can@2.3.0-beta.2#compute/get_value_and_bind*/
define("can/compute/get_value_and_bind",["can/util/util"],function(e){function n(n,a,s,v){var o=r(n,a),d=o.observed,u=s.observed;return o.names!==s.names&&(t(u,d,v),i(u,v)),e.batch.afterPreviousEvents(function(){o.ready=!0}),o}var r=function(e,n){s.push({names:"",observed:{}});var r=e.call(n),t=s.pop();return t.value=r,t},t=function(e,n,r){for(var t in n)a(e,n,t,r)},a=function(e,n,r,t){if(e[r])delete e[r];else{var a=n[r];a.obj.bind(a.event,t)}},i=function(e,n){for(var r in e){var t=e[r];t.obj.unbind(t.event,n)}},s=[];return e.__observe=e.__reading=function(e,n){if(s.length){var r=e._cid+"|"+n,t=s[s.length-1];t.observed[r]||(t.names+=r,t.observed[r]={obj:e,event:n+""})}},e.__isRecordingObserves=function(){return s.length},e.__notObserve=function(n){return function(){var r=e.__clearObserved(),t=n.apply(this,arguments);return e.__setObserved(r),t}},e.__clearObserved=e.__clearReading=function(){if(s.length){var e=s[s.length-1];return s[s.length-1]={names:"",observed:{}},e}},e.__setObserved=e.__setReading=function(e){s.length&&(s[s.length-1]=e)},e.__addObserved=e.__addReading=function(n){if(s.length){var r=s[s.length-1];e.simpleExtend(r.observed,n.observed),r.names+=n.names}},n});
/*can@2.3.0-beta.2#compute/proto_compute*/
define("can/compute/proto_compute",["can/util/util","can/util/bind/bind","can/compute/read","can/compute/get_value_and_bind","can/util/batch/batch"],function(t,e,n,i){t.Compute=function(e,n,i,s){for(var u=[],o=0,a=arguments.length;a>o;o++)u[o]=arguments[o];var r=typeof u[1];"function"==typeof u[0]?this._setupGetterSetterFn(u[0],u[1],u[2],u[3]):u[1]?"string"===r?this._setupProperty(u[0],u[1],u[2]):"function"===r?this._setupSetter(u[0],u[1],u[2]):u[1]&&u[1].fn?this._setupAsyncCompute(u[0],u[1]):this._setupSettings(u[0],u[1]):this._setupSimpleValue(u[0]),this._args=u,this.isComputed=!0,t.cid(this,"compute")},t.simpleExtend(t.Compute.prototype,{_setupGetterSetterFn:function(e,n,i){this._set=t.proxy(e,n),this._get=t.proxy(e,n),this._canObserve=i===!1?!1:!0;var s=u(this,e,n||this);this._on=s.on,this._off=s.off},_setupProperty:function(e,n,i){var s,u=t.isMapLike(e),o=this;u?(s=function(t,e,n){o.updater(e,n,t.batchNum)},this.hasDependencies=!0,this._get=function(){return e.attr(n)},this._set=function(t){e.attr(n,t)}):(s=function(){o.updater(o._get(),o.value)},this._get=function(){return t.getObject(n,[e])},this._set=function(i){var s=n.split("."),u=s.pop(),o=t.getObject(s.join("."),[e]);o[u]=i}),this._on=function(u){t.bind.call(e,i||n,s),this.value=this._get()},this._off=function(){return t.unbind.call(e,i||n,s)}},_setupSetter:function(e,n,i){this.value=e,this._set=n,t.simpleExtend(this,i)},_setupSettings:function(e,n){if(this.value=e,this._set=n.set?t.proxy(n.set,n):this._set,this._get=n.get?t.proxy(n.get,n):this._get,!n.__selfUpdater){var i=this,s=this.updater;this.updater=function(){s.call(i,i._get(),i.value)}}this._on=n.on?n.on:this._on,this._off=n.off?n.off:this._off},_setupAsyncCompute:function(e,n){var i=this;this.value=e,this._setUpdates=!0,this.lastSetValue=new t.Compute(e),this._set=function(t){return t===i.lastSetValue.get()?this.value:i.lastSetValue.set(t)},this._get=function(){return o.call(n.context,i.lastSetValue.get())};var s,o=n.fn;if(0===o.length)s=u(this,o,n.context);else if(1===o.length)s=u(this,function(){return o.call(n.context,i.lastSetValue.get())},n);else{var a=this.updater,r=function(t){a.call(i,t,i.value)};this.updater=function(t){a.call(i,t,i.value)},s=u(this,function(){var t=o.call(n.context,i.lastSetValue.get(),r);return void 0!==t?t:this.value},this)}this._on=s.on,this._off=s.off},_setupSimpleValue:function(t){this.value=t},_bindsetup:t.__notObserve(function(){this.bound=!0,this._on(this.updater)}),_bindteardown:function(){this._off(this.updater),this.bound=!1},bind:t.bindAndSetup,unbind:t.unbindAndTeardown,clone:function(e){return e&&"function"==typeof this._args[0]?this._args[1]=e:e&&(this._args[2]=e),new t.Compute(this._args[0],this._args[1],this._args[2],this._args[3])},_on:t.k,_off:t.k,get:function(){return t.__isRecordingObserves()&&this._canObserve!==!1&&(t.__observe(this,"change"),this.bound||t.Compute.temporarilyBind(this)),this.bound?this.value:this._get()},_get:function(){return this.value},set:function(t){var e=this.value,n=this._set(t,e);return this._setUpdates?this.value:this.hasDependencies?this._get():(void 0===n?this.value=this._get():this.value=n,s(this,this.value,e),this.value)},_set:function(t){return this.value=t},updater:function(t,e,n){this.value=t,s(this,t,e,n)},toFunction:function(){return t.proxy(this._computeFn,this)},_computeFn:function(t){return arguments.length?this.set(t):this.get()}});var s=function(e,n,i,s){n!==i&&t.batch.trigger(e,s?{type:"change",batchNum:s}:"change",[n,i])},u=function(e,n,s){var u,o,a=function(t){if(u.ready&&e.bound&&(void 0===t.batchNum||t.batchNum!==o)){var r=u.value;u=i(n,s,u,a),e.updater(u.value,r,t.batchNum),o=t.batchNum}};return{on:function(){u=i(n,s,{observed:{}},a),e.value=u.value,e.hasDependencies=!t.isEmptyObject(u.observed)},off:function(){for(var t in u.observed){var e=u.observed[t];e.obj.unbind(e.event,a)}}}};t.Compute.temporarilyBind=function(e){e.bind("change",t.k),o||(o=[],setTimeout(a,10)),o.push(e)};var o,a=function(){for(var e=0,n=o.length;n>e;e++)o[e].unbind("change",t.k);o=null};return t.Compute.async=function(e,n,i){return new t.Compute(e,{fn:n,context:i})},t.Compute.truthy=function(e){return new t.Compute(function(){var t=e.get();return"function"==typeof t&&(t=t.get()),!!t})},t.Compute.read=n,t.Compute.set=n.write,t.Compute});
/*can@2.3.0-beta.2#compute/compute*/
...
/*can@2.3.0-beta.2#view/scope/compute_data*/
define("can/view/scope/compute_data",["can/util/util","can/compute/compute","can/compute/get_value_and_bind"],function(e,t,n){var o=function(t){return t.reads&&1===t.reads.length&&t.root instanceof e.Map&&!e.isFunction(t.root[t.reads[0].key])},a=function(e,t){return n(e,null,{observed:{}},t)},u=function(e,t){for(var n in e.observed){var o=e.observed[n];o.obj.unbind(o.event,t)}},r=function(e,t){var n=e.root,o=e.reads[0].key;return n.bind(o,t),{value:e.initialValue,observed:{something:!0}}},c=function(e,t){e.root.unbind(e.reads[0].key,t)},s=function(t,n,o,a,u){if(!(arguments.length>4)){if(a.root)return e.compute.read(a.root,a.reads,o).value;var r=t.read(n,o);return a.scope=r.scope,a.initialValue=r.value,a.reads=r.reads,a.root=r.rootObserve,a.setRoot=r.setRoot,r.value}var c=a.root||a.setRoot;if(c.isComputed)c(u);else if(a.reads.length){var s=a.reads.length-1,i=a.reads.length?e.compute.read(c,a.reads.slice(0,s)).value:c;e.compute.set(i,a.reads[s].key,u,o)}};return function(t,i,d){d=d||{args:[]};var v,l,f={},p=function(e){return arguments.length?s(t,i,d,f,e):s(t,i,d,f)},m=function(e){if(l.ready&&g.computeInstance.bound&&(void 0===e.batchNum||e.batchNum!==v)){var t,o=l.value;l=n(p,null,l,m),t=l.value,g.computeInstance.updater(t,o,e.batchNum),v=v=e.batchNum}},b=function(e,t,n){"function"!=typeof t?g.computeInstance.updater(t,n,e.batchNum):(c(f,b),l=a(p,m),h=!1,g.computeInstance.updater(l.value,n,e.batchNum))},h=!1,g=e.compute(void 0,{on:function(){if(l=a(p,m),o(f)){var t=l;l=r(f,b),u(t,m),h=!0}g.computeInstance.value=l.value,g.computeInstance.hasDependencies=!e.isEmptyObject(l.observed)},off:function(){h?c(f,b):u(l,m)},set:p,get:p,__selfUpdater:!0});return f.compute=g,f}});
/*can@2.3.0-beta.2#util/string/string*/
...
/*can@2.3.0-beta.2#construct/construct*/
define("can/construct/construct",["can/util/string/string"],function(t){var n,e=0;try{Object.getOwnPropertyDescriptor({}),n=!0}catch(r){n=!1}var o=function(t,n){var e=Object.getOwnPropertyDescriptor(t,n);return e&&(e.get||e.set)?e:null},i=function(n,e,r){r=r||n;var i;for(var s in n)(i=o(n,s))?this._defineProperty(r,e,s,i):t.Construct._overwrite(r,e,s,n[s])},s=function(n,e,r){r=r||n;for(var o in n)t.Construct._overwrite(r,e,o,n[o])};return t.Construct=function(){return arguments.length?t.Construct.extend.apply(t.Construct,arguments):void 0},t.extend(t.Construct,{constructorExtends:!0,newInstance:function(){var t,n=this.instance();return n._initializing=!0,n.setup&&(t=n.setup.apply(n,arguments)),n.init&&n.init.apply(n,t||arguments),delete n._initializing,n},_inherit:n?i:s,_defineProperty:function(t,n,e,r){Object.defineProperty(t,e,r)},_overwrite:function(t,n,e,r){t[e]=r},setup:function(n,e){this.defaults=t.extend(!0,{},n.defaults,this.defaults)},instance:function(){e=1;var t=new this;return e=0,t},extend:function(n,r,o){function i(){return e?void 0:this.constructor!==a&&arguments.length&&a.constructorExtends?a.extend.apply(a,arguments):a.newInstance.apply(a,arguments)}var s=n,u=r,c=o;"string"!=typeof s&&(c=u,u=s,s=null),c||(c=u,u=null),c=c||{};var a,p,f,l,h,d,y,g,m,v=this,_=this.prototype;m=this.instance(),t.Construct._inherit(c,_,m),s?(p=s.split("."),y=p.pop()):u&&u.shortName?y=u.shortName:this.shortName&&(y=this.shortName),"undefined"==typeof constructorName&&(a=function(){return i.apply(this,arguments)});for(d in v)v.hasOwnProperty(d)&&(a[d]=v[d]);t.Construct._inherit(u,v,a),s&&(f=t.getObject(p.join("."),window,!0),g=f,l=t.underscore(s.replace(/\./g,"_")),h=t.underscore(y),f[y]=a),t.extend(a,{constructor:a,prototype:m,namespace:g,_shortName:h,fullName:s,_fullName:l}),void 0!==y&&(a.shortName=y),a.prototype.constructor=a;var w=[v].concat(t.makeArray(arguments)),C=a.setup.apply(a,w);return a.init&&a.init.apply(a,C||w),a}}),t.Construct.prototype.setup=function(){},t.Construct.prototype.init=function(){},t.Construct});
/*can@2.3.0-beta.2#map/bubble*/
define("can/map/bubble",["can/util/util"],function(n){var i=n.bubble={bind:function(n,e){if(!n._initializing){var b,t=i.events(n,e),r=t.length;n._bubbleBindings||(n._bubbleBindings={});for(var d=0;r>d;d++)b=t[d],n._bubbleBindings[b]?n._bubbleBindings[b]++:(n._bubbleBindings[b]=1,i.childrenOf(n,b))}},unbind:function(e,b){for(var t,r=i.events(e,b),d=r.length,u=0;d>u;u++)t=r[u],e._bubbleBindings&&e._bubbleBindings[t]--,e._bubbleBindings&&!e._bubbleBindings[t]&&(delete e._bubbleBindings[t],i.teardownChildrenFrom(e,t),n.isEmptyObject(e._bubbleBindings)&&delete e._bubbleBindings)},add:function(e,b,t){if(b instanceof n.Map&&e._bubbleBindings)for(var r in e._bubbleBindings)e._bubbleBindings[r]&&(i.teardownFromParent(e,b,r),i.toParent(b,e,t,r))},addMany:function(n,e){for(var b=0,t=e.length;t>b;b++)i.add(n,e[b],b)},remove:function(e,b){if(b instanceof n.Map&&e._bubbleBindings)for(var t in e._bubbleBindings)e._bubbleBindings[t]&&i.teardownFromParent(e,b,t)},removeMany:function(n,e){for(var b=0,t=e.length;t>b;b++)i.remove(n,e[b])},set:function(e,b,t,r){return n.isMapLike(t)&&i.add(e,t,b),n.isMapLike(r)&&i.remove(e,r),t},events:function(n,i){return n.constructor._bubbleRule(i,n)},toParent:function(i,e,b,t){n.listenTo.call(e,i,t,function(){var r=n.makeArray(arguments),d=r.shift();r[0]=(n.List&&e instanceof n.List?e.indexOf(i):b)+(r[0]?"."+r[0]:""),d.triggeredNS=d.triggeredNS||{},d.triggeredNS[e._cid]||(d.triggeredNS[e._cid]=!0,n.trigger(e,d,r),"change"===t&&n.trigger(e,r[0],[r[2],r[3]]))})},childrenOf:function(n,e){n._each(function(b,t){b&&b.bind&&i.toParent(b,n,t,e)})},teardownFromParent:function(i,e,b){e&&e.unbind&&n.stopListening.call(i,e,b)},teardownChildrenFrom:function(n,e){n._each(function(b){i.teardownFromParent(n,b,e)})},isBubbling:function(n,i){return n._bubbleBindings&&n._bubbleBindings[i]}};return i});
/*can@2.3.0-beta.2#map/map_helpers*/
define("can/map/map_helpers",["can/util/util"],function(){var n={attrParts:function(n,t){return t?[n]:"object"==typeof n?n:(""+n).split(".")},canMakeObserve:function(n){return n&&!can.isDeferred(n)&&(can.isArray(n)||can.isPlainObject(n))},serialize:function(){var t=null;return function(e,a,c){var r=can.cid(e),i=!1;return t||(i=!0,t={attr:{},serialize:{}}),t[a][r]=c,e.each(function(r,i){var u,d=can.isMapLike(r),o=d&&t[a][can.cid(r)];u=o?o:e["___"+a]?e["___"+a](i,r):n.getValue(e,i,r,a),void 0!==u&&(c[i]=u)}),i&&(t=null),c}}(),getValue:function(n,t,e,a){return can.isMapLike(e)?e[a]():e},define:null,addComputedAttr:function(n,t,e){n._computedAttrs[t]={compute:e,count:0,handler:function(e,a,c){can.batch.trigger(n,{type:t,batchNum:e.batchNum,target:n},[a,c])}}},addToMap:function(n,a){var c;t||(c=e,t={});var r=n._cid,i=can.cid(n);return t[i]||(t[i]={obj:n,instance:a,added:!r}),c},getMapFromObject:function(n){return t&&t[n._cid]&&t[n._cid].instance}},t=null,e=function(){for(var n in t)t[n].added&&delete t[n].obj._cid;t=null};return n});
/*can@2.3.0-beta.2#map/map*/
define("can/map/map",["can/util/util","can/util/bind/bind","can/map/bubble","can/map/map_helpers","can/construct/construct","can/util/batch/batch"],function(t,e,i,n){var r=t.Map=t.Construct.extend({setup:function(){if(t.Construct.setup.apply(this,arguments),this._computedPropertyNames=[],t.Map){this.defaults||(this.defaults={});for(var e in this.prototype)"define"!==e&&"constructor"!==e&&("function"!=typeof this.prototype[e]||this.prototype[e].prototype instanceof t.Construct)?this.defaults[e]=this.prototype[e]:this.prototype[e].isComputed&&this._computedPropertyNames.push(e);n.define&&n.define(this)}!t.List||this.prototype instanceof t.List||(this.List=r.List.extend({Map:this},{}))},shortName:"Map",_bubbleRule:function(t){return"change"===t||t.indexOf(".")>=0?["change"]:[]},bind:t.bindAndSetup,unbind:t.unbindAndTeardown,id:"id",keys:function(e){var i=[];t.__observe(e,"__keys");for(var n in e._data)i.push(n);return i}},{setup:function(e){e instanceof t.Map&&(e=e.serialize()),this._data={},t.cid(this,".map"),this._setupComputedProperties();var i=e&&n.addToMap(e,this),r=this._setupDefaults(e),s=t.extend(t.extend(!0,{},r),e);this.attr(s),i&&i()},_setupComputedProperties:function(){this._computedAttrs={};for(var t=this.constructor._computedPropertyNames,e=0,i=t.length;i>e;e++){var r=t[e];n.addComputedAttr(this,r,this[r].clone(this))}},_setupDefaults:function(){return this.constructor.defaults||{}},attr:function(t,e){var i=typeof t;return void 0===t?this._getAttrs():"string"!==i&&"number"!==i?this._setAttrs(t,e):1===arguments.length?this._get(t):(this._set(t,e),this)},_get:function(e){e=""+e;var i=e.indexOf(".");if(i>=0){var n=this.___get(e);if(void 0!==n)return t.__observe(this,e),n;var r=e.substr(0,i),s=e.substr(i+1),o=this.__get(r);return o&&o._get?o._get(s):void 0}return this.__get(e)},__get:function(e){return t.__observe(this,e),this.___get(e)},___get:function(t){if(t){var e=this._computedAttrs[t];return e?e.compute():this._data[t]}return this._data},_set:function(e,i,n){e=""+e;var r,s=e.indexOf(".");if(!n&&s>=0){var o=e.substr(0,s),a=e.substr(s+1);if(r=this._initializing?void 0:this.___get(o),!t.isMapLike(r))throw new Error("can.Map: Object does not exist");r._set(a,i)}else r=this._initializing?void 0:this.___get(e),this.__convert&&(i=this.__convert(e,i)),this.__set(e,this.__type(i,e),r)},__type:function(e,i){if(!(e instanceof t.Map)&&n.canMakeObserve(e)){var r=n.getMapFromObject(e);if(r)return r;if(t.isArray(e)){var s=t.List;return new s(e)}var o=this.constructor.Map||t.Map;return new o(e)}return e},__set:function(t,e,n){if(e!==n){var r=void 0!==n||this.___get().hasOwnProperty(t)?"set":"add";this.___set(t,i.set(this,t,e,n)),this._computedAttrs[t]||this._triggerChange(t,r,e,n),n&&i.teardownFromParent(this,n)}},___set:function(t,e){var i=this._computedAttrs[t];i?i.compute(e):this._data[t]=e,"function"==typeof this.constructor.prototype[t]||i||(this[t]=e)},removeAttr:function(t){return this._remove(t)},_remove:function(t){var e=n.attrParts(t),i=e.shift(),r=this.___get(i);return e.length&&r?r.removeAttr(e):("string"==typeof t&&~t.indexOf(".")&&(i=t),this.__remove(i,r),r)},__remove:function(t,e){t in this._data&&(this.___remove(t),this._triggerChange(t,"remove",void 0,e))},___remove:function(t){delete this._data[t],t in this.constructor.prototype||delete this[t]},___serialize:function(t,e){return n.getValue(this,t,e,"serialize")},_getAttrs:function(){return n.serialize(this,"attr",{})},_setAttrs:function(e,i){e=t.simpleExtend({},e);var r,s,o=this;t.batch.start(),this.each(function(r,a){if("_cid"!==a){if(s=e[a],void 0===s)return void(i&&o.removeAttr(a));o.__convert&&(s=o.__convert(a,s)),t.isMapLike(r)&&n.canMakeObserve(s)?r.attr(s,i):r!==s&&o.__set(a,o.__type(s,a),r),delete e[a]}});for(r in e)"_cid"!==r&&(s=e[r],this._set(r,s,!0));return t.batch.stop(),this},serialize:function(){return n.serialize(this,"serialize",{})},_triggerChange:function(e,n,r,s){i.isBubbling(this,"change")&&t.batch.trigger(this,{type:"change",target:this},[e,n,r,s]),t.batch.trigger(this,{type:e,target:this},[r,s]),("remove"===n||"add"===n)&&t.batch.trigger(this,{type:"__keys",target:this})},_bindsetup:function(){},_bindteardown:function(){},one:t.one,bind:function(e,n){var r=this._computedAttrs&&this._computedAttrs[e];return r&&(r.count?r.count++:(r.count=1,r.compute.bind("change",r.handler))),i.bind(this,e),t.bindAndSetup.apply(this,arguments)},unbind:function(e,n){var r=this._computedAttrs&&this._computedAttrs[e];return r&&(1===r.count?(r.count=0,r.compute.unbind("change",r.handler)):r.count--),i.unbind(this,e),t.unbindAndTeardown.apply(this,arguments)},compute:function(e){if(t.isFunction(this.constructor.prototype[e]))return t.compute(this[e],this);var i=t.compute.read.reads(e),n=i.length-1;return t.compute(function(e){return arguments.length?void t.compute.read(this,i.slice(0,n)).value.attr(i[n].key,e):t.compute.read(this,i,{args:[]}).value},this)},each:function(){return t.each.apply(void 0,[this].concat(t.makeArray(arguments)))},_each:function(t){var e=this.___get();for(var i in e)e.hasOwnProperty(i)&&t(e[i],i)},dispatch:t.dispatch});return r.prototype.on=r.prototype.bind,r.prototype.off=r.prototype.unbind,r.on=r.bind,r.off=r.unbind,r});
/*can@2.3.0-beta.2#list/list*/
define("can/list/list",["can/util/util","can/map/map","can/map/bubble","can/map/map_helpers"],function(t,e,i,r){var n=[].splice,h=function(){var t={0:"a",length:1};return n.call(t,0,1),!t[0]}(),s=e.extend({Map:e},{setup:function(e,i){this.length=0,t.cid(this,".map"),this._setupComputedProperties(),e=e||[];var n;t.isDeferred(e)?this.replace(e):(n=e.length&&r.addToMap(e,this),this.push.apply(this,t.makeArray(e||[]))),n&&n(),t.simpleExtend(this,i)},_triggerChange:function(i,r,n,h){e.prototype._triggerChange.apply(this,arguments);var s=+i;~(""+i).indexOf(".")||isNaN(s)||("add"===r?(t.batch.trigger(this,r,[n,s]),t.batch.trigger(this,"length",[this.length])):"remove"===r?(t.batch.trigger(this,r,[h,s]),t.batch.trigger(this,"length",[this.length])):t.batch.trigger(this,r,[n,s]))},___get:function(e){return e?this[e]&&this[e].isComputed&&t.isFunction(this.constructor.prototype[e])?this[e]():this[e]:this},__set:function(e,i,r){if(e=isNaN(+e)||e%1?e:+e,"number"==typeof e&&e>this.length-1){var n=new Array(e+1-this.length);return n[n.length-1]=i,this.push.apply(this,n),n}return t.Map.prototype.__set.call(this,""+e,i,r)},___set:function(t,e){this[t]=e,+t>=this.length&&(this.length=+t+1)},__remove:function(t,e){isNaN(+t)?(delete this[t],this._triggerChange(t,"remove",void 0,e)):this.splice(t,1)},_each:function(t){for(var e=this.___get(),i=0;i<e.length;i++)t(e[i],i)},serialize:function(){return r.serialize(this,"serialize",[])},splice:function(e,r){var s,a,o,l=t.makeArray(arguments),c=[],u=l.length>2;for(e=e||0,s=0,a=l.length-2;a>s;s++)o=s+2,l[o]=this.__type(l[o],o),c.push(l[o]),this[s+e]!==l[o]&&(u=!1);if(u&&this.length<=c.length)return c;void 0===r&&(r=l[1]=this.length-e);var g=n.apply(this,l);if(!h)for(s=this.length;s<g.length+this.length;s++)delete this[s];return t.batch.start(),r>0&&(i.removeMany(this,g),this._triggerChange(""+e,"remove",void 0,g)),l.length>2&&(i.addMany(this,c),this._triggerChange(""+e,"add",c,g)),t.batch.stop(),g},_getAttrs:function(){return r.serialize(this,"attr",[])},_setAttrs:function(e,i){e=t.makeArray(e),t.batch.start(),this._updateAttrs(e,i),t.batch.stop()},_updateAttrs:function(e,i){for(var n=Math.min(e.length,this.length),h=0;n>h;h++){var s=this[h],a=e[h];t.isMapLike(s)&&r.canMakeObserve(a)?s.attr(a,i):s!==a&&this._set(h,a)}e.length>this.length?this.push.apply(this,e.slice(this.length)):e.length<this.length&&i&&this.splice(e.length)}}),a=function(e){return e[0]&&t.isArray(e[0])?e[0]:t.makeArray(e)};return t.each({push:"length",unshift:0},function(t,e){var r=[][e];s.prototype[e]=function(){for(var e,n,h=[],s=t?this.length:0,a=arguments.length;a--;)n=arguments[a],h[a]=i.set(this,a,this.__type(n,a));return e=r.apply(this,h),(!this.comparator||h.length)&&this._triggerChange(""+s,"add",h,void 0),e}}),t.each({pop:"length",shift:0},function(t,e){s.prototype[e]=function(){if(!this.length)return void 0;var r=a(arguments),n=t&&this.length?this.length-1:0,h=[][e].apply(this,r);return this._triggerChange(""+n,"remove",void 0,[h]),h&&h.unbind&&i.remove(this,h),h}}),t.extend(s.prototype,{indexOf:function(e,i){return t.__observe(this,"length"),t.inArray(e,this,i)},join:function(){return t.__observe(this,"length"),[].join.apply(this,arguments)},reverse:function(){var e=[].reverse.call(t.makeArray(this));return this.replace(e)},slice:function(){t.__observe(this,"length");var e=Array.prototype.slice.apply(this,arguments);return new this.constructor(e)},concat:function(){var e=[];return t.each(t.makeArray(arguments),function(i,r){e[r]=i instanceof t.List?i.serialize():i}),new this.constructor(Array.prototype.concat.apply(this.serialize(),e))},forEach:function(e,i){return t.each(this,e,i||this)},replace:function(e){return t.isDeferred(e)?e.then(t.proxy(this.replace,this)):this.splice.apply(this,[0,this.length].concat(t.makeArray(e||[]))),this},filter:function(t,e){var i,r=new this.constructor,n=this;return this.each(function(h,s,a){i=t.call(e|n,h,s,n),i&&r.push(h)}),r},map:function(e,i){var r=new t.List,n=this;return this.each(function(t,h,s){var a=e.call(i|n,t,h,n);r.push(a)}),r}}),t.List=e.List=s,t.List});
/*can@2.3.0-beta.2#view/scope/scope*/
define("can/view/scope/scope",["can/util/util","can/view/scope/compute_data","can/construct/construct","can/map/map","can/list/list","can/view/view","can/compute/compute"],function(t,e){var n=t.Construct.extend({read:t.compute.read,Refs:t.Map.extend({}),Break:function(){},refsScope:function(){return new t.view.Scope(new this.Refs)}},{init:function(t,e,n){this._context=t,this._parent=e,this.__cache={},this._meta=n||{}},get:t.__notObserve(function(e,n){n=t.simpleExtend({isArgument:!0},n);var r=this.read(e,n);return r.value}),attr:t.__notObserve(function(e,n,r){if(r=t.simpleExtend({isArgument:!0},r),2!==arguments.length)return this.get(e,r);var i=e.lastIndexOf("."),o=-1!==i?e.substring(0,i):".",s=this.read(o,r).value;-1!==i&&(e=e.substring(i+1,e.length)),t.compute.set(s,e,n,r)}),add:function(t,e){return t!==this._context?new this.constructor(t,this,e):this},computeData:function(t,n){return e(this,t,n)},compute:function(t,e){return this.computeData(t,e).compute},getRefs:function(){return this.getScope(function(t){return t._context instanceof n.Refs})},getViewModel:function(){return this.getContext(function(t){return t._meta.viewModel})},getContext:function(t){var e=this.getScope(t);return e&&e._context},getScope:function(t){for(var e=this;e;){if(t(e))return e;e=e._parent}},getRoot:function(){for(var t=this,e=this;t._parent;)e=t,t=t._parent;return t._context instanceof n.Refs&&(t=e),t._context},cloneFromRef:function(){for(var e,r,i=[],o=this;o;){if(e=o._context,e instanceof n.Refs){r=o._parent;break}i.push(e),o=o._parent}return r?(t.each(i,function(t){r=r.add(t)}),r):this},read:function(e,r){if(this._meta["protected"])return this._parent.read(e,r);var i="./"===e.substr(0,2),o="../"===e.substr(0,3),s="."===e||"this"===e,a=".."===e,u=i||o||s||a;if(u&&this._meta.notContext)return this._parent.read(e,r);var c;if(i)c=!0,e=e.substr(2);else{if(o)return this._parent.read(e.substr(3),r);if(s)return{value:this._context};if(a)return{value:this._parent._context};if("@root"===e)return{value:this.getRoot()}}for(var f,p,h,v,_,d,l=t.compute.read.reads(e),m="*"===e.charAt(0)?this.getRefs():this,g=[],x=-1,b=!1,R=t.simpleExtend({foundObservable:function(t,e){p=t,h=l.slice(e)},earlyExit:function(t,e){e>x&&(_=p,v=h,x=e)}},r);m;){if(f=m._context,d=f instanceof n.Refs,!(null===f||"object"!=typeof f&&"function"!=typeof f||b&&d||m._meta["protected"])){d&&(b=!0);var w=t.compute.read(f,l,R);if(void 0!==w.value)return{scope:m,rootObserve:p,value:w.value,reads:h};g.push(t.__clearObserved())}m=c?null:m._parent}var O=g.length;if(O)for(var S=0;O>S;S++)t.__addObserved(g[S]);return{setRoot:_,reads:v,value:void 0}}});return t.view.Scope=n,n});
/*can@2.3.0-beta.2#view/stache/utils*/
define("can/view/stache/utils",["can/util/util","can/view/scope/scope"],function(can){var Options=can.view.Scope.extend({init:function(n,e){n.helpers||n.partials||n.tags||(n={helpers:n}),can.view.Scope.prototype.init.apply(this,arguments)}});return{isArrayLike:function(n){return n&&n.splice&&"number"==typeof n.length},isObserveLike:function(n){return n instanceof can.Map||n&&!!n._get},emptyHandler:function(){},jsonParse:function(str){return"'"===str[0]?str.substr(1,str.length-2):"undefined"===str?void 0:can.global.JSON?JSON.parse(str):eval("("+str+")")},mixins:{last:function(){return this.stack[this.stack.length-1]},add:function(n){this.last().add(n)},subSectionDepth:function(){return this.stack.length-1}},convertToScopes:function(n,e,t,i,r,s){r&&(n.fn=this.makeRendererConvertScopes(r,e,t,i)),s&&(n.inverse=this.makeRendererConvertScopes(s,e,t,i))},makeRendererConvertScopes:function(n,e,t,i){var r=function(t,i,r){return n(t||e,i,r)};return can.__notObserve(function(n,s,o){void 0===n||n instanceof can.view.Scope||(n=e.add(n)),void 0===s||s instanceof Options||(s=t.add(s));var c=r(n,s||t,o||i);return c})},Options:Options}});
/*can@2.3.0-beta.2#view/node_lists/node_lists*/
...
/*can@2.3.0-beta.2#view/parser/parser*/
define("can/view/parser/parser",[],function(){function t(t,e){for(var a=0;a<t.length;a++)e(t[a],a)}function e(e){var a={},r=e.split(",");return t(r,function(t){a[t]=!0}),a}function a(t,e){for(var a=0,r=t.length;r>a;a++){var n=t[a];e[n.tokenType].apply(e,n.args)}return t}var r="-:A-Za-z0-9_",n="[^=>\\s\\/]+",o="\\s*=\\s*",i="(?:"+o+"(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>\\s]+))?",s="\\{\\{[^\\}]*\\}\\}\\}?",l="\\{\\{([^\\}]*)\\}\\}\\}?",u=new RegExp("^<(["+r+"]+)((?:\\s*(?:(?:(?:"+n+")?"+i+")|(?:"+s+")+))*)\\s*(\\/?)>"),c=new RegExp("^<\\/(["+r+"]+)[^>]*>"),f=new RegExp(l,"g"),g=/<|\{\{/,p=/\s/,d=e("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"),m=e("a,address,article,applet,aside,audio,blockquote,button,canvas,center,dd,del,dir,div,dl,dt,fieldset,figcaption,figure,footer,form,frameset,h1,h2,h3,h4,h5,h6,header,hgroup,hr,iframe,ins,isindex,li,map,menu,noframes,noscript,object,ol,output,p,pre,section,script,table,tbody,td,tfoot,th,thead,tr,ul,video"),h=e("abbr,acronym,applet,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,iframe,img,input,ins,kbd,label,map,object,q,s,samp,script,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"),b=e("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr"),v=e("script,style"),S="start,end,close,attrStart,attrEnd,attrValue,chars,comment,special,done".split(","),k=function(){},y=function(e,r,n){function o(t,e,a,n){if(e=e.toLowerCase(),m[e])for(;N.last()&&h[N.last()];)i("",N.last());b[e]&&N.last()===e&&i("",e),n=d[e]||!!n,r.start(e,n),n||N.push(e),y.parseAttrs(a,r),r.end(e,n)}function i(t,e){var a;if(e)for(a=N.length-1;a>=0&&N[a]!==e;a--);else a=0;if(a>=0){for(var n=N.length-1;n>=a;n--)r.close&&r.close(N[n]);N.length=a}}function s(t,e){r.special&&r.special(e)}if("object"==typeof e)return a(e,r);var l=[];r=r||{},n&&t(S,function(t){var e=r[t]||k;r[t]=function(){e.apply(this,arguments)!==!1&&l.push({tokenType:t,args:[].slice.call(arguments,0)})}});var p,F,V,E=function(){A&&r.chars&&r.chars(A),A=""},N=[],x=e,A="";for(N.last=function(){return this[this.length-1]};e;){if(F=!0,N.last()&&v[N.last()])e=e.replace(new RegExp("([\\s\\S]*?)</"+N.last()+"[^>]*>"),function(t,e){return e=e.replace(/<!--([\s\S]*?)-->|<!\[CDATA\[([\s\S]*?)]]>/g,"$1$2"),r.chars&&r.chars(e),""}),i("",N.last());else if(0===e.indexOf("<!--")?(p=e.indexOf("-->"),p>=0&&(E(),r.comment&&r.comment(e.substring(4,p)),e=e.substring(p+3),F=!1)):0===e.indexOf("</")?(V=e.match(c),V&&(E(),e=e.substring(V[0].length),V[0].replace(c,i),F=!1)):0===e.indexOf("<")?(V=e.match(u),V&&(E(),e=e.substring(V[0].length),V[0].replace(u,o),F=!1)):0===e.indexOf("{{")&&(V=e.match(f),V&&(E(),e=e.substring(V[0].length),V[0].replace(f,s))),F){p=e.search(g),0===p&&e===x&&(A+=e.charAt(0),e=e.substr(1),p=e.search(g));var w=0>p?e:e.substring(0,p);e=0>p?"":e.substring(p),w&&(A+=w)}if(e===x)throw new Error("Parse Error: "+e);x=e}return E(),i(),r.done(),l},F=function(t,e,a,r){t.attrStart=r.substring("number"==typeof t.nameStart?t.nameStart:e,e),a.attrStart(t.attrStart),t.inName=!1},V=function(t,e,a,r){void 0!==t.valueStart&&t.valueStart<e?a.attrValue(r.substring(t.valueStart,e)):!t.inValue,a.attrEnd(t.attrStart),t.attrStart=void 0,t.valueStart=void 0,t.inValue=!1,t.inName=!1,t.inQuote=!1,t.lookingForName=!0};return y.parseAttrs=function(t,e){if(t){for(var a,r=0,n={inDoubleCurly:!1,inName:!1,nameStart:void 0,inValue:!1,valueStart:void 0,inQuote:!1,attrStart:void 0,lookingForName:!0,lookingForValue:!1,lookingForEq:!1};r<t.length;){a=r;var o=t.charAt(r),i=t.charAt(r+1),s=t.charAt(r+2);if(r++,"{"===o&&"{"===i)n.inValue&&a>n.valueStart?e.attrValue(t.substring(n.valueStart,a)):n.inName&&n.nameStart<a&&(F(n,a,e,t),V(n,a,e,t)),n.inDoubleCurly=!0,n.doubleCurlyStart=a+2,r++;else if(n.inDoubleCurly){if("}"===o&&"}"===i){var l="}"===s?1:0;e.special(t.substring(n.doubleCurlyStart,a)),n.inDoubleCurly=!1,n.inValue&&(n.valueStart=a+2+l),r+=1+l}}else n.inValue?n.inQuote?o===n.inQuote&&V(n,a,e,t):p.test(o)&&V(n,a,e,t):"="===o&&(n.lookingForEq||n.lookingForName||n.inName)?(n.attrStart||F(n,a,e,t),n.lookingForValue=!0,n.lookingForEq=!1,n.lookingForName=!1):n.inName?p.test(o)&&(F(n,a,e,t),n.lookingForEq=!0):n.lookingForName?p.test(o)||(n.attrStart&&V(n,a,e,t),n.nameStart=a,n.inName=!0):n.lookingForValue&&(p.test(o)||(n.lookingForValue=!1,n.inValue=!0,"'"===o||'"'===o?(n.inQuote=o,n.valueStart=a+1):n.valueStart=a))}n.inName?(F(n,a+1,e,t),V(n,a+1,e,t)):n.lookingForEq&&V(n,a+1,e,t)}},y});
/*can@2.3.0-beta.2#util/array/diff*/
...
/*can@2.3.0-beta.2#view/live/live*/
define("can/view/live/live",["can/util/util","can/view/elements","can/view/view","can/view/node_lists/node_lists","can/view/parser/parser","can/util/array/diff"],function(e,t,n,r,i,a){t=t||e.view.elements,r=r||e.view.NodeLists,i=i||e.view.parser;var o=function(t,n,r){var i=!1,a=function(){return i||(i=!0,r(o),e.unbind.call(t,"removed",a)),!0},o={teardownCheck:function(e){return e?!1:a()}};return e.bind.call(t,"removed",a),n(o),o},u=function(e){var t=e.childNodes;if("length"in t)return t;for(var n=e.firstChild,r=[];n;)r.push(n),n=n.nextSibling;return r},c=function(e,t,n){return o(e,function(){t.bind("change",n)},function(e){t.unbind("change",n),e.nodeList&&r.unregister(e.nodeList)})},s=function(e){var t,n={};return i.parseAttrs(e,{attrStart:function(e){n[e]="",t=e},attrValue:function(e){n[t]+=e},attrEnd:function(){}}),n},d=[].splice,l=function(e){return e&&e.nodeType},f=function(e){e.firstChild||e.appendChild(e.ownerDocument.createTextNode(""))},p={list:function(n,i,c,s,l,f){var v,h=f||[n],g=[],b=!1,m=!1,w=function(n,i,a){if(b){var o=A.ownerDocument.createDocumentFragment(),l=[],p=[];e.each(i,function(t,n){var i=[];f&&r.register(i,null,!0);var d=e.compute(n+a),v=c.call(s,t,d,i),h="string"==typeof v,g=e.frag(v);g=h?e.view.hookup(g):g;var b=e.makeArray(u(g));f?(r.update(i,b),l.push(i)):l.push(r.register(b)),o.appendChild(g),p.push(d)});var v=a+1;if(h[v]){var m=r.first(h[v]);e.insertBefore(m.parentNode,o,m)}else t.after(1===v?[A]:[r.last(h[v-1])],o);d.apply(h,[v,0].concat(l)),d.apply(g,[a,0].concat(p));for(var w=a+p.length,k=g.length;k>w;w++)g[w](w)}},k=function(t,n,i,a,o){if(b&&(a||!x.teardownCheck(A.parentNode))){0>i&&(i=g.length+i);var u=h.splice(i+1,n.length),c=[];e.each(u,function(e){var t=r.unregister(e);[].push.apply(c,t)}),g.splice(i,n.length);for(var s=i,d=g.length;d>s;s++)g[s](s);o?r.unregister(h):e.remove(e.$(c))}},C=function(t,n,i,a){if(b){i+=1,a+=1;var o,u=h[i],c=e.frag(r.flatten(h[a]));o=i>a?r.last(u).nextSibling:r.first(u);var s=h[0].parentNode;s.insertBefore(c,o);var d=h[a];[].splice.apply(h,[a,1]),[].splice.apply(h,[i,0,d])}},A=n.ownerDocument.createTextNode(""),N=function(e){v&&v.unbind&&v.unbind("add",w).unbind("remove",k).unbind("move",C),k({},{length:h.length-1},0,!0,e)},y=function(t,n,r){if(!m){if(b=!0,n&&r){v=n||[];var i=a(r,n);r.unbind&&r.unbind("add",w).unbind("remove",k).unbind("move",C);for(var o=0,u=i.length;u>o;o++){var c=i[o];c.deleteCount&&k({},{length:c.deleteCount},c.index,!0),c.insert.length&&w({},c.insert,c.index)}}else N(),v=n||[],w({},v,0);b=!1,v.bind&&v.bind("add",w).bind("remove",k).bind("move",C),e.batch.afterPreviousEvents(function(){b=!0})}};l=t.getParentNode(n,l);var x=o(l,function(){e.isFunction(i)&&i.bind("change",y)},function(){e.isFunction(i)&&i.unbind("change",y),N(!0)});f?(t.replace(h,A),r.update(h,[A]),f.unregistered=function(){x.teardownCheck(),m=!0}):p.replace(h,A,x.teardownCheck),y({},e.isFunction(i)?i():i)},html:function(n,i,a,o){var s;a=t.getParentNode(n,a),s=c(a,i,function(e,t,n){var i=r.first(d).parentNode;i&&p(t),s.teardownCheck(r.first(d).parentNode)});var d=o||[n],p=function(n){var i="function"==typeof n,o=l(n),c=e.frag(i?"":n),s=e.makeArray(d);f(c),o||i||(c=e.view.hookup(c,a)),s=r.update(d,u(c)),i&&n(c.firstChild),t.replace(s,c)};s.nodeList=d,o?o.unregistered=s.teardownCheck:r.register(d,s.teardownCheck),p(i())},replace:function(n,i,a){var o=n.slice(0),c=e.frag(i);return r.register(n,a),"string"==typeof i&&(c=e.view.hookup(c,n[0].parentNode)),r.update(n,u(c)),t.replace(o,c),n},text:function(n,i,a,o){var u=t.getParentNode(n,a),s=c(u,i,function(t,n,r){"unknown"!=typeof d.nodeValue&&(d.nodeValue=e.view.toStr(n)),s.teardownCheck(d.parentNode)}),d=n.ownerDocument.createTextNode(e.view.toStr(i()));o?(o.unregistered=s.teardownCheck,s.nodeList=o,r.update(o,[d]),t.replace([n],d)):s.nodeList=p.replace([n],d,s.teardownCheck)},setAttributes:function(t,n){var r=s(n);for(var i in r)e.attr.set(t,i,r[i])},attributes:function(n,r,i){var a={},o=function(r){var i,o=s(r);for(i in o){var u=o[i],c=a[i];u!==c&&e.attr.set(n,i,u),delete a[i]}for(i in a)t.removeAttr(n,i);a=o};c(n,r,function(e,t){o(t)}),arguments.length>=3?a=s(i):o(r())},attributePlaceholder:"__!!__",attributeReplace:/__!!__/g,attribute:function(n,r,i){c(n,i,function(e,i){t.setAttr(n,r,u.render())});var a,o=e.$(n);a=e.data(o,"hooks"),a||e.data(o,"hooks",a={});var u,s=String(t.getAttr(n,r)),d=s.split(p.attributePlaceholder),l=[];l.push(d.shift(),d.join(p.attributePlaceholder)),a[r]?a[r].computes.push(i):a[r]={render:function(){var e=0,n=s?s.replace(p.attributeReplace,function(){return t.contentText(u.computes[e++]())}):t.contentText(u.computes[e++]());return n},computes:[i],batchNum:void 0},u=a[r],l.splice(1,0,i()),t.setAttr(n,r,l.join(""))},specialAttribute:function(e,n,r){c(e,r,function(r,i){t.setAttr(e,n,h(i))}),t.setAttr(e,n,h(r()))},simpleAttribute:function(e,n,r){c(e,r,function(r,i){t.setAttr(e,n,i)}),t.setAttr(e,n,r())}};p.attr=p.simpleAttribute,p.attrs=p.attributes,p.getAttributeParts=s;var v=/(\r|\n)+/g,h=function(e){var n=/^["'].*["']$/;return e=e.replace(t.attrReg,"").replace(v,""),n.test(e)?e.substr(1,e.length-2):e};return e.view.live=p,p});
/*can@2.3.0-beta.2#view/stache/mustache_helpers*/
define("can/view/stache/mustache_helpers",["can/util/util","can/view/stache/utils","can/view/live/live"],function(e,n,t){t=t||e.view.live;var i=function(t){return n.isObserveLike(t)&&n.isArrayLike(t)&&t.attr("length")?t:e.isFunction(t)?t():t},r={each:function(r,s){var o,u,a,c=i(r),f=[];if(c instanceof e.List)return function(n){var i=[n];i.expression="live.list",e.view.nodeLists.register(i,null,s.nodeList),e.view.nodeLists.update(s.nodeList,[n]);var o=function(e,n,t){return s.fn(s.scope.add({"@index":n}).add(e),s.options,t)};t.list(n,r,o,s.context,n.parentNode,i)};var l=c;if(l&&n.isArrayLike(l))for(a=0;a<l.length;a++)f.push(s.fn(s.scope.add({"@index":a}).add(l[a])));else if(n.isObserveLike(l))for(o=e.Map.keys(l),a=0;a<o.length;a++)u=o[a],f.push(s.fn(s.scope.add({"@key":u}).add(l[u])));else if(l instanceof Object)for(u in l)f.push(s.fn(s.scope.add({"@key":u}).add(l[u])));return f},"@index":function(n,t){t||(t=n,n=0);var i=t.scope.attr("@index");return""+((e.isFunction(i)?i():i)+n)},"if":function(n,t){var r;return r=e.isFunction(n)?e.compute.truthy(n)():!!i(n),r?t.fn(t.scope||this):t.inverse(t.scope||this)},is:function(){var n,t,r=arguments[arguments.length-1];if(arguments.length-2<=0)return r.inverse();for(var s=0;s<arguments.length-1;s++){if(t=i(arguments[s]),t=e.isFunction(t)?t():t,s>0&&t!==n)return r.inverse();n=t}return r.fn()},eq:function(){return r.is.apply(this,arguments)},unless:function(n,t){return r["if"].apply(this,[e.isFunction(n)?e.compute(function(){return!n()}):!n,t])},"with":function(e,n){var t=e;return e=i(e),e?n.fn(t):void 0},log:function(e,n){"undefined"!=typeof console&&console.log&&(n?console.log(e,n.context):console.log(e.context))},data:function(n){var t=2===arguments.length?this:arguments[1];return function(i){e.data(e.$(i),n,t||this.context)}},"switch":function(e,n){var t=i(e),r=!1,s=n.helpers.add({"case":function(e,n){return r||t!==i(e)?void 0:(r=!0,n.fn(n.scope||this))},"default":function(e){return r?void 0:e.fn(e.scope||this)}});return n.fn(n.scope,s)},joinBase:function(n){var t=[].slice.call(arguments),r=t.pop(),s=e.map(t,function(n){var t=i(n);return e.isFunction(t)?t():t}).join(""),o=r.helpers.attr("helpers.module"),u=o?o.uri:void 0,a="."===s[0];if(a&&u)return e.joinURIs(u,s);var c=e.baseURL||"undefined"!=typeof System&&(System.renderingLoader&&System.renderingLoader.baseURL||System.baseURL)||location.pathname;return"/"!==s[0]&&"/"!==c[c.length-1]&&(c+="/"),e.joinURIs(c,s)}};r.eachOf=r.each;var s=function(e,n){r[e]=n};return{registerHelper:s,registerSimpleHelper:function(n,t){s(n,e.view.simpleHelper(t))},getHelper:function(e,n){var t=n&&n.get("helpers."+e,{proxyMethods:!1});return t||(t=r[e]),t?{fn:t}:void 0}}});
/*can@2.3.0-beta.2#view/stache/expression*/
define("can/view/stache/expression",["can/util/util","can/view/stache/utils","can/view/stache/mustache_helpers","can/view/scope/scope"],function(t,e,r,o){var n=function(e,r,o){var n=r.computeData(e,o);return t.compute.temporarilyBind(n.compute),n},p=function(t,e,r,o){var p=n(t,e,o);return p.compute.computeInstance.hasDependencies?{value:p.compute,computeData:p}:{value:p.initialValue,computeData:p}},s=function(t,e,o,n){var s=p(t,e,o,n);if(void 0===s.computeData.initialValue){"@"===t.charAt(0)&&"@index"!==t&&(t=t.substr(1));var a=r.getHelper(t,o);s.helper=a&&a.fn}return s},a=function(t){return t instanceof l||t instanceof i?t:new l(t)},i=function(t){this._value=t};i.prototype.value=function(){return this._value};var u=function(t,e){this.key=t,this.rootExpr=e};u.prototype.value=function(t,e){var r=s(this.key,t,e);return this.isHelper=r.helper,r.helper||r.value};var h=function(t,e){u.apply(this,arguments)};h.prototype.value=function(t,e){return p(this.key,t,e).value};var l=function(t,e){this.expr=t,this.modifiers=e||{},this.isCompute=!1};l.prototype.value=function(){return this.expr.value.apply(this.expr,arguments)};var c=function(){},f=function(e,r,o){this.methodExpr=e,this.argExprs=t.map(r,a);var n=this.hashExprs={};t.each(o,function(t,e){n[e]=a(t)})};f.prototype.args=function(t,e){for(var r=[],o=0,n=this.argExprs.length;n>o;o++){var p=this.argExprs[o],s=p.value.apply(p,arguments);r.push({call:s&&s.isComputed&&!p.modifiers.compute,value:s})}return function(){for(var t=[],e=0,o=r.length;o>e;e++)t[e]=r[e].call?r[e].value():r[e].value;return t}},f.prototype.hash=function(t,e){var r={};for(var o in this.hashExprs){var n=this.hashExprs[o],p=n.value.apply(n,arguments);r[o]={call:p&&p.isComputed&&!n.modifiers.compute,value:p}}return function(){var t={};for(var e in r)t[e]=r[e].call?r[e].value():r[e].value;return t}},f.prototype.value=function(e,r,o){var n=this.methodExpr.value(e,r);this.isHelper=this.methodExpr.isHelper;var p=!t.isEmptyObject(this.hashExprs),s=this.args(e,r),a=this.hash(e,r);return t.compute(function(){var t=n;if(t&&t.isComputed&&(t=t()),"function"==typeof t){var e=s();return p&&e.push(a()),o&&e.push(o),t.apply(null,e)}})};var d=function(){u.apply(this,arguments)};d.prototype.value=function(t,e){var r=s(this.key,t,e,{isArgument:!0,args:[t.attr("."),t]});return r.helper||r.value};var v=function(){u.apply(this,arguments)};v.prototype.value=function(t,e){return p(this.key,t,e,{isArgument:!0,args:[t.attr("."),t]}).value};var y=function(t,e,r){this.methodExpr=t,this.argExprs=e,this.hashExprs=r,this.mode=null};y.prototype.args=function(t,e){for(var r=[],o=0,n=this.argExprs.length;n>o;o++){var p=this.argExprs[o];r.push(p.value.apply(p,arguments))}return r},y.prototype.hash=function(t,e){var r={};for(var o in this.hashExprs){var n=this.hashExprs[o];r[o]=n.value.apply(n,arguments)}return r},y.prototype.helperAndValue=function(e,o){var p,s,a,u,h=this.argExprs.length||!t.isEmptyObject(this.hashExprs),l=this.methodExpr instanceof i?""+this.methodExpr._value:this.methodExpr.key;if(h){p=r.getHelper(l,o);var c=e.attr(".");p||"function"!=typeof c[l]||(p={fn:c[l]})}if(!p){u=this.args(e,o);var f=n(l,e,{isArgument:!1,args:u&&u.length?u:[e.attr("."),e]}),d=f.compute;a=f.initialValue,s=f.compute.computeInstance.hasDependencies?d:a,h||void 0!==a||(p=r.getHelper(l,o))}return{value:s,args:u,helper:p&&p.fn}},y.prototype.evaluator=function(r,o,n,p,s,a,i,u){var h={fn:function(){},inverse:function(){}},l=o.attr("."),c=this.args(o,n,s,a,i,u),f=this.hash(o,n,s,a,i,u);return e.convertToScopes(h,o,n,s,a,i),t.simpleExtend(h,{context:l,scope:o,contexts:o,hash:f,nodeList:s,exprData:this,helperOptions:n,helpers:n}),c.push(h),function(){return r.apply(l,c)||""}},y.prototype.value=function(e,r,o,n,p,s){var a=this.helperAndValue(e,r),i=a.helper;if(!i)return a.value;var u=this.evaluator(i,e,r,o,n,p,s),h=t.compute(u);return t.compute.temporarilyBind(h),h.computeInstance.hasDependencies?h:h()};var m=/[\w\.\\\-_@\/\&%]+/,k=/('.*?'|".*?"|=|[\w\.\\\-_@\/*%]+|[\(\)]|,|\~)/g,g=/^('.*?'|".*?"|[0-9]+\.?[0-9]*|true|false|null|undefined)$/,x=function(t){return m.test(t)},A=/^[\.@]\w/,E=function(t){return x(t)&&A.test(t)},H=function(t){return t.children||(t.children=[]),t},C=function(){this.root={children:[],type:"Root"},this.current=this.root,this.stack=[this.root]};t.simpleExtend(C.prototype,{top:function(){return t.last(this.stack)},isRootTop:function(){return this.top()===this.root},popTo:function(t){this.popUntil(t),this.isRootTop()||this.stack.pop()},firstParent:function(e){for(var r=this.stack.length-2;r>0&&-1===t.inArray(this.stack[r].type,e);)r--;return this.stack[r]},popUntil:function(e){for(;-1===t.inArray(this.top().type,e)&&!this.isRootTop();)this.stack.pop();return this.top()},addTo:function(t,e){var r=this.popUntil(t);H(r).children.push(e)},addToAndPush:function(t,e){this.addTo(t,e),this.stack.push(e)},topLastChild:function(){return t.last(this.top().children)},replaceTopLastChild:function(t){var e=H(this.top()).children;return e.pop(),e.push(t),t},replaceTopLastChildAndPush:function(t){this.replaceTopLastChild(t),this.stack.push(t)},replaceTopAndPush:function(t){var e;return this.top()===this.root?e=H(this.top()).children:(this.stack.pop(),e=H(this.top()).children),e.pop(),e.push(t),this.stack.push(t),t}});var L=function(t){if("Lookup"===t.type){var e=t.key,r=e.lastIndexOf("./"),o=-1===r?0:r+2,n=e.charAt(o);e="."===n||"@"===n?e.substr(0,o)+"@"+e.substr(o+1):e.substr(0,o)+"@"+e.substr(o),t.key=e}return t},R=function(t){var e=t.top();if(e&&"Lookup"===e.type){var r=t.stack[t.stack.length-2];"Helper"!==r.type&&r&&t.replaceTopAndPush({type:"Helper",method:e})}},T={Literal:i,Lookup:u,ScopeLookup:h,Arg:l,Hash:c,Call:f,Helper:y,HelperLookup:d,HelperScopeLookup:v,tokenize:function(e){var r=[];return(t.trim(e)+" ").replace(k,function(t,e){r.push(e)}),r},lookupRules:{"default":function(t,e,r){var o=("Helper"!==e||t.root?"":"Helper")+(r?"Scope":"")+"Lookup";return T[o]},method:function(t,e,r){return h}},methodRules:{"default":function(t){return"Call"===t.type?f:y},call:function(t){return f}},parse:function(t,e){e=e||{};var r=this.ast(t);e.lookupRule||(e.lookupRule="default"),"string"==typeof e.lookupRule&&(e.lookupRule=T.lookupRules[e.lookupRule]),e.methodRule||(e.methodRule="default"),"string"==typeof e.methodRule&&(e.methodRule=T.methodRules[e.methodRule]);var o=this.hydrateAst(r,e,e.baseMethodType||"Helper");return o},hydrateAst:function(t,e,r,o){if("Lookup"===t.type)return new(e.lookupRule(t,r,o))(t.key,t.root&&this.hydrateAst(t.root,e,r));if("Literal"===t.type)return new i(t.value);if("Arg"===t.type)return new l(this.hydrateAst(t.children[0],e,r,o),{compute:!0});if("Hash"===t.type)throw new Error("");if("Call"===t.type||"Helper"===t.type){var n={},p=[],s=t.children;if(s)for(var a=0;a<s.length;a++){var u=s[a];"Hash"===u.type?n[u.prop]=this.hydrateAst(u.children[0],e,t.type,!0):p.push(this.hydrateAst(u,e,t.type,!0))}return new(e.methodRule(t))(this.hydrateAst(t.method,e,t.type),p,n)}},ast:function(t){var e=this.tokenize(t);return this.parseAst(e,{index:0})},parseAst:function(r,o){for(var n,p=new C;o.index<r.length;){var s=r[o.index],a=r[o.index+1];if(o.index++,g.test(s))R(p),p.addTo(["Helper","Call","Hash"],{type:"Literal",value:e.jsonParse(s)});else if("="===a){if(n=p.top(),n&&"Lookup"===n.type){var i=p.firstParent(["Call","Helper","Hash"]);("Call"===i.type||"Root"===i.type)&&(p.popUntil(["Call"]),n=p.top(),p.replaceTopAndPush({type:"Helper",method:"Root"===n.type?t.last(n.children):n}))}p.addToAndPush(["Helper","Call"],{type:"Hash",prop:s}),o.index++}else if(m.test(s)){var u=p.topLastChild();u&&"Call"===u.type&&E(s)?p.replaceTopLastChildAndPush({type:"Lookup",root:u,key:s}):(R(p),p.addToAndPush(["Helper","Call","Hash","Arg"],{type:"Lookup",key:s}))}else if("~"===s)R(p),p.addToAndPush(["Helper","Call","Hash"],{type:"Arg",key:s});else if("("===s){if(n=p.top(),"Lookup"!==n.type)throw new Error("Unable to understand expression "+r.join(""));p.replaceTopAndPush({type:"Call",method:L(n)})}else")"===s?p.popTo(["Call"]):","===s&&p.popUntil(["Call"])}return p.root.children[0]}};return t.expression=T,T});
/*can@2.3.0-beta.2#control/control*/
...
/*can@2.3.0-beta.2#view/href/href*/
...
/*can@2.3.0-beta.2#view/bindings/bindings*/
define("can/view/bindings/bindings",["can/util/util","can/view/stache/expression","can/view/callbacks/callbacks","can/control/control","can/view/scope/scope","can/view/href/href"],function(e,t){var n=function(){var e={"":!0,"true":!0,"false":!1},t=function(t){if(t&&t.getAttribute){var n=t.getAttribute("contenteditable");return e[n]}};return function(e){var n=t(e);return"boolean"==typeof n?n:!!t(e.parentNode)}}(),i=function(e,t,n){return t=t||"{",n=n||"}",e[0]===t&&e[e.length-1]===n?e.substr(1,e.length-2):e};e.view.attr("can-value",function(t,a){var o,c,h=e.trim(i(t.getAttribute("can-value"))),v=a.scope.computeData(h,{args:[]}).compute;return"input"===t.nodeName.toLowerCase()&&("checkbox"===t.type&&(o=e.attr.has(t,"can-true-value")?t.getAttribute("can-true-value"):!0,c=e.attr.has(t,"can-false-value")?t.getAttribute("can-false-value"):!1),"checkbox"===t.type||"radio"===t.type)?void new u(t,{value:v,trueValue:o,falseValue:c}):"select"===t.nodeName.toLowerCase()&&t.multiple?void new l(t,{value:v}):n(t)?void new s(t,{value:v}):void new r(t,{value:v})});var a={enter:function(e,t,n){return{event:"keyup",handler:function(e){return 13===e.keyCode?n.call(this,e):void 0}}}},o=function(n,o){var r=o.attributeName,u=0===r.indexOf("can-"),l=0===r.indexOf("can-")?r.substr("can-".length):i(r,"(",")"),s=u;"$"===l.charAt(0)&&(l=l.substr(1),s=!0);var c=function(a){var u=n.getAttribute(r);if(u){var l=e.$(n),s=e.viewModel(l[0]),c=t.parse(i(u),{lookupRule:"method",methodRule:"call"});if(!(c instanceof t.Call||c instanceof t.Helper)){var h=e.map([o.scope._context,l].concat(e.makeArray(arguments)),function(e){return new t.Literal(e)});c=new t.Call(c,h,{})}var v=o.scope.read(c.methodExpr.key,{isArgument:!0}),p=o.scope.add({"@element":l,"@event":a,"@viewModel":s,"@scope":o.scope,"@context":o.scope._context,"%element":this,$element:l,"%event":a,"%viewModel":s,"%scope":o.scope,"%context":o.scope._context},{notContext:!0}),d=c.args(p,null)(),f=c.hash(p,null)();return e.isEmptyObject(f)||d.push(f),v.value.apply(v.parent,d)}};if(a[l]){var h=a[l](o,n,c);c=h.handler,l=h.event}e.bind.call(s?n:e.viewModel(n),l,c);var v=function(t){t.attributeName!==r||this.getAttribute(r)||(e.unbind.call(s?n:e.viewModel(n),l,c),e.unbind.call(n,"attributes",v))};e.bind.call(n,"attributes",v)};e.view.attr(/can-[\w\.]+/,o),e.view.attr(/^\([\$?\w\.]+\)$/,o);var r=e.Control.extend({init:function(){"SELECT"===this.element[0].nodeName.toUpperCase()?setTimeout(e.proxy(this.set,this),1):this.set()},"{value} change":"set",set:function(){if(this.element){var e=this.options.value();null==e&&"SELECT"!==this.element[0].nodeName.toUpperCase()&&(e=""),null!=e&&(this.element[0].value=e)}},change:function(){if(this.element){var e=this.element[0];this.options.value(e.value);var t=this.options.value();e.value!==t&&(e.value=t)}}}),u=e.Control.extend({init:function(){this.isCheckbox="checkbox"===this.element[0].type.toLowerCase(),this.check()},"{value} change":"check",check:function(){if(this.isCheckbox){var t=this.options.value(),n=this.options.trueValue||!0;this.element[0].checked=t==n}else{var i=this.options.value()==this.element[0].value?"set":"remove";e.attr[i](this.element[0],"checked",!0)}},change:function(){this.isCheckbox?this.options.value(this.element[0].checked?this.options.trueValue:this.options.falseValue):this.element[0].checked&&this.options.value(this.element[0].value)}}),l=r.extend({init:function(){this.delimiter=";",setTimeout(e.proxy(this.set,this),1)},set:function(){var t=this.options.value();"string"==typeof t?(t=t.split(this.delimiter),this.isString=!0):t&&(t=e.makeArray(t));var n={};e.each(t,function(e){n[e]=!0}),e.each(this.element[0].childNodes,function(e){e.value&&(e.selected=!!n[e.value])})},get:function(){var t=[],n=this.element[0].childNodes;return e.each(n,function(e){e.selected&&e.value&&t.push(e.value)}),t},change:function(){var t=this.get(),n=this.options.value();this.isString||"string"==typeof n?(this.isString=!0,this.options.value(t.join(this.delimiter))):n instanceof e.List?n.attr(t,!0):this.options.value(t)}}),s=e.Control.extend({init:function(){this.set(),this.on("blur","setValue")},"{value} change":"set",set:function(){var e=this.options.value();this.element[0].innerHTML="undefined"==typeof e?"":e},setValue:function(){this.options.value(this.element[0].innerHTML)}}),c=function(t,n,i){if("input"===t.nodeName.toLowerCase()&&"checkbox"===t.type){var a=!0;t.checked=i==a}else e.attr.set(t,n,null==i?"":i)},h=function(t,n,i){return e.compute(t[n],{on:function(n){e.bind.call(t,i,n)},off:function(n){e.unbind.call(t,i,n)},get:function(){return e.attr.get(t,n)},set:function(e){c(t,n,e)}})},v=function(e){return e&&e.isComputed?e():e},p=/\{(\()?(\^)?([^\}\)]+)\)?\}/,d=function(e){var t=e.match(p);if(!t)return{childToParent:!0,parentToChild:!0,propName:e};var n=!!t[1],i=n||!!t[2],a=n||!i;return{childToParent:i,parentToChild:a,propName:t[3]}},f=function(n,i,a,o){var r=t.parse(a,{baseMethodType:"Call"});return r.value(i,new e.view.Scope)},m=function(n,i,a){var o,r=e.camelize(a.propName||i.substr(1)),u=r.charAt(0),l="$"===u;if(l)o=h(n,r.substr(1),"change");else{var s=t.parse(r,{baseMethodType:"Call"}),c=e.viewModel(n),v=new e.view.Scope(c);o=s.value(v,new e.view.Scope,{})}return o},b=function(t,n,i,a,o){var r=function(t,n){a[o]=(a[o]||0)+1,i(n),e.batch.after(function(){--a[o]})};return n&&n.isComputed&&(n.bind("change",r),e.one.call(t,"removed",function(){n.unbind("change",r)})),r},g=function(t,n,i,a,o){var r=function(e,t){a[o]||n(t)};return i&&i.isComputed&&(i.bind("change",r),e.one.call(t,"removed",function(){i.unbind("change",r)})),r},w=function(e,t,n){var i,a,o=t.attributeName,r=f(e,t.scope,e.getAttribute(o)||".",n),u=m(e,n.propName||o.replace(/^\{/,"").replace(/\}$/,""),n),l={};return n.parentToChild&&(i=b(e,r,u,l,o)),n.childToParent&&(a=g(e,r,u,l,o)),n.initializeValues&&C(n,u,r,i,a),{parentCompute:r,childCompute:u}},C=function(e,t,n,i,a){e.parentToChild&&!e.childToParent?i({},v(n)):!e.parentToChild&&e.childToParent?a({},v(t)):void 0===v(t)?i({},v(n)):void 0===n()?a({},v(t)):i({},v(n))},x=/^\{[^\}]+\}$/;return e.view.attr(x,function(t,n){if(!e.data(e.$(t),"preventDataBindings")){var i=d(n.attributeName);i.initializeValues=!0,w(t,n,i)}}),e.view.attr(/\*[\w\.\-_]+/,function(t,n){t.getAttribute(n.attributeName)&&console.warn("&reference attributes can only export the view model.");var i=e.camelize(n.attributeName.substr(1).toLowerCase()),a=e.viewModel(t),o=n.scope.getRefs();o._context.attr("*"+i,a)}),{getParentCompute:f,bindParentToChild:b,bindChildToParent:g,setupDataBinding:w,dataBindingsRegExp:x,attributeNameInfo:d,initializeValues:C}});
/*can@2.3.0-beta.2#observe/observe*/
...
/*can@2.3.0-beta.2#component/component*/
define("can/component/component",["can/util/util","can/view/callbacks/callbacks","can/view/elements","can/view/bindings/bindings","can/control/control","can/observe/observe","can/view/mustache/mustache","can/util/view_model/view_model"],function(e,t,o,n){var i=/^(dataViewId|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,s=/\{([^\}]+)\}/g,p=e.Component=e.Construct.extend({setup:function(){if(e.Construct.setup.apply(this,arguments),e.Component){var t=this,o=this.prototype.scope||this.prototype.viewModel;if(this.Control=a.extend(this.prototype.events),o&&("object"!=typeof o||o instanceof e.Map)?o.prototype instanceof e.Map&&(this.Map=o):this.Map=e.Map.extend(o||{}),this.attributeScopeMappings={},e.each(this.Map?this.Map.defaults:{},function(e,o){"@"===e&&(t.attributeScopeMappings[o]=o)}),this.prototype.template)if("function"==typeof this.prototype.template){var n=this.prototype.template;this.renderer=function(){return e.view.frag(n.apply(null,arguments))}}else this.renderer=e.view.mustache(this.prototype.template);e.view.tag(this.prototype.tag,function(e,o){new t(e,o)})}}},{setup:function(s,p){var a,r,c={"@root":p.scope.attr("@root")},u=this,l=("undefined"==typeof this.leakScope?!1:!this.leakScope)&&!!this.template,d={},h=this.scope||this.viewModel,f={},m=[],v=function(){for(var e=0,t=m.length;t>e;e++)m[e]()},g=e.$(s);if(e.each(this.constructor.attributeScopeMappings,function(t,o){c[o]=s.getAttribute(e.hyphenate(t))}),e.each(e.makeArray(s.attributes),function(o,r){var l=o.name,h=e.camelize(l.toLowerCase()),m=o.value,v=n.dataBindingsRegExp.test(l);if(!(u.constructor.attributeScopeMappings[h]||i.test(h)||t.attr(l)&&!v)){if("{"===m[0]&&"}"===m[m.length-1])m=m.substr(1,m.length-2);else if(!v&&"legacy"!==p.templateType)return void(c[h]=m);var g=n.attributeNameInfo(l);g.propName=e.camelize(g.propName),d[g.propName]=g;var y=n.getParentCompute(s,p.scope,m,{});if(y&&y.isComputed){if(g.parentToChild){n.bindParentToChild(s,y,function(e){a.attr(g.propName,e)},f,g.propName);var w=y();void 0!==w&&(c[g.propName]=w)}d[g.propName].parentCompute=y}else c[g.propName]=y}}),this.constructor.Map)a=new this.constructor.Map(c);else if(h instanceof e.Map)a=h;else if(e.isFunction(h)){var y=h.call(this,c,p.scope,s);a=y instanceof e.Map?y:y.prototype instanceof e.Map?new y(c):new(e.Map.extend(y))(c)}var w={};e.each(d,function(e,t){e.childToParent&&(w[t]=function(o,n){f[t]||e.parentCompute(n)},a.bind(t,w[t]),e.parentCompute&&n.initializeValues(e,"."===t?a:a.attr(t),e.parentCompute,function(){},function(t,o){e.parentCompute(o)}))}),e.isEmptyObject(this.constructor.attributeScopeMappings)&&"legacy"===p.templateType||e.bind.call(s,"attributes",function(t){var o=e.camelize(t.attributeName);d[o]||i.test(o)||a.attr(o,s.getAttribute(t.attributeName))}),this.scope=this.viewModel=a,e.data(g,"scope",this.scope),e.data(g,"viewModel",this.scope),e.data(g,"preventDataBindings",!0);var b=(l?e.view.Scope.refsScope():p.scope.add(new e.view.Scope.Refs)).add(this.scope,{viewModel:!0}),M={helpers:{}},C=function(e,t){M.helpers[e]=function(){return t.apply(a,arguments)}};e.each(this.helpers||{},function(t,o){e.isFunction(t)&&C(o,t)}),e.each(this.simpleHelpers||{},function(t,o){C(o,e.view.simpleHelper(t))}),m.push(function(){e.each(w,function(e,t){a.unbind(t,w[t])})}),this._control=new this.constructor.Control(s,{scope:this.scope,viewModel:this.scope,destroy:v});var N=e.view.nodeLists.register([],void 0,!0);m.push(function(){e.view.nodeLists.unregister(N)}),this.constructor.renderer?(M.tags||(M.tags={}),M.tags.content=function _(t,n){var i=p.subtemplate||n.subtemplate,s=i===p.subtemplate;if(i){delete M.tags.content;var r;if(r=s?l?p:{scope:n.scope.cloneFromRef(),options:n.options}:n,r.scope=r.scope.add(a,{"protected":!0,viewModel:!0}),n.parentNodeList){var c=i(r.scope,r.options,n.parentNodeList);o.replace([t],c)}else e.view.live.replace([t],i(r.scope,r.options));M.tags.content=_}},r=this.constructor.renderer(b,p.options.add(M),N)):r="legacy"===p.templateType?e.view.frag(p.subtemplate?p.subtemplate(b,p.options.add(M)):""):p.subtemplate?p.subtemplate(b,p.options.add(M),N):document.createDocumentFragment(),e.appendChild(s,r,e.document),e.view.nodeLists.update(N,e.childNodes(s))}}),a=e.Control.extend({_lookup:function(e){return[e.scope,e,window]},_action:function(t,o,n){var i,p;if(s.lastIndex=0,i=s.test(t),n||!i){if(i){p=e.compute(function(){var n,i=t.replace(s,function(t,i){var s;return"scope"===i||"viewModel"===i?(n=o.scope,""):(i=i.replace(/^(scope|^viewModel)\./,""),s=e.compute.read(o.scope,e.compute.read.reads(i),{isArgument:!0}).value,void 0===s&&(s=e.getObject(i)),"string"==typeof s?s:(n=s,""))}),p=i.split(/\s+/g),a=p.pop();return{processor:this.processors[a]||this.processors.click,parts:[i,p.join(" "),a],delegate:n||void 0}},this);var a=function(e,o){n._bindings.control[t](n.element),n._bindings.control[t]=o.processor(o.delegate||n.element,o.parts[2],o.parts[1],t,n)};return p.bind("change",a),n._bindings.readyComputes[t]={compute:p,handler:a},p()}return e.Control._action.apply(this,arguments)}}},{setup:function(t,o){return this.scope=o.scope,this.viewModel=o.viewModel,e.Control.prototype.setup.call(this,t,o)},off:function(){this._bindings&&e.each(this._bindings.readyComputes||{},function(e){e.compute.unbind("change",e.handler)}),e.Control.prototype.off.apply(this,arguments),this._bindings.readyComputes={}},destroy:function(){e.Control.prototype.destroy.apply(this,arguments),"function"==typeof this.options.destroy&&this.options.destroy.apply(this,arguments)}}),r=e.$;return r.fn&&(r.fn.scope=r.fn.viewModel=function(){return e.viewModel.apply(e,[this].concat(e.makeArray(arguments)))}),p});
/*can@2.3.0-beta.2#model/model*/
...
/*can@2.3.0-beta.2#util/string/deparam/deparam*/
