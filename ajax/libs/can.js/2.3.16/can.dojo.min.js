...
/*can@2.3.16#util/object/isplain/isplain*/
...
/*can@2.3.16#util/inserted/inserted*/
...
/*can@2.3.16#view/callbacks/callbacks*/
...
/*can@2.3.16#compute/get_value_and_bind*/
...
define("can/view/scope/compute_data",["can/util/util","can/compute/compute","can/compute/get_value_and_bind"],function(e,t,n){var o=function(t){return t.reads&&1===t.reads.length&&t.root instanceof e.Map&&!e.isFunction(t.root[t.reads[0].key])},a=function(t,n,o,a,r){if(!(arguments.length>4)){if(a.root)return e.compute.read(a.root,a.reads,o).value;var u=t.read(n,o);return a.scope=u.scope,a.initialValue=u.value,a.reads=u.reads,a.root=u.rootObserve,a.setRoot=u.setRoot,u.value}var c=a.root||a.setRoot;if(c)if(c.isComputed)c(r);else if(a.reads.length){var d=a.reads.length-1,s=a.reads.length?e.compute.read(c,a.reads.slice(0,d)).value:c;e.compute.set(s,a.reads[d].key,r,o)}};return function(t,r,u){u=u||{args:[]};var c={},d=function(e){return arguments.length?a(t,r,u,c,e):a(t,r,u,c)},s=e.compute(void 0,{on:function(){i.getValueAndBind(),o(c)&&(i.dependencyChange=function(e,t){return"function"!=typeof t?this.newVal=t:(i.dependencyChange=n.prototype.dependencyChange,i.getValueAndBind=n.prototype.getValueAndBind),n.prototype.dependencyChange.call(this,e)},i.getValueAndBind=function(){this.value=this.newVal}),s.computeInstance.value=i.value,s.computeInstance.hasDependencies=!e.isEmptyObject(i.newObserved)},off:function(){i.teardown()},set:d,get:d,__selfUpdater:!0}),i=new n(d,null,s.computeInstance);return c.compute=s,c}});
/*can@2.3.16#util/string/string*/
...
/*can@2.3.16#construct/construct*/
...
/*can@2.3.16#view/node_lists/node_lists*/
...
/*can@2.3.16#view/stache/mustache_helpers*/
...
/*can@2.3.16#view/stache/expression*/
...
define("can/view/bindings/bindings",["can/util/util","can/view/stache/expression","can/view/callbacks/callbacks","can/view/live/live","can/view/scope/scope","can/view/href/href"],function(e,t,n,i){var a={viewModel:function(t,n,i,a){a=a||{};var r,o={},l=[],u={},c={},s=e.extend({},a);e.each(e.makeArray(t.attributes),function(e){var i=d(e,t,{templateType:n.templateType,scope:n.scope,semaphore:o,getViewModel:function(){return r},attributeViewModelBindings:s,alreadyUpdatedChild:!0,nodeList:n.parentNodeList});i&&(i.onCompleteBinding&&(i.bindingInfo.parentToChild&&void 0!==i.value&&(a[b(i.bindingInfo.childName)]=i.value),l.push(i.onCompleteBinding)),u[e.name]=i.onTeardown)}),r=i(a);for(var p=0,v=l.length;v>p;p++)l[p]();return e.bind.call(t,"attributes",function(e){var i=e.attributeName,a=t.getAttribute(i);u[i]&&u[i]();var o=c[i]&&"attribute"===c[i].parent;if(null!==a||o){var l=d({name:i,value:a},t,{templateType:n.templateType,scope:n.scope,semaphore:{},getViewModel:function(){return r},attributeViewModelBindings:s,initializeValues:!0,nodeList:n.parentNodeList});l&&(l.onCompleteBinding&&l.onCompleteBinding(),c[i]=l.bindingInfo,u[i]=l.onTeardown)}}),function(){for(var e in u)u[e]()}},data:function(t,n){if(!e.data(e.$(t),"preventDataBindings")){var i,a=e.viewModel(t),r={},o=d({name:n.attributeName,value:t.getAttribute(n.attributeName),nodeList:n.nodeList},t,{templateType:n.templateType,scope:n.scope,semaphore:r,getViewModel:function(){return a}});o.onCompleteBinding&&o.onCompleteBinding(),i=o.onTeardown,e.one.call(t,"removed",function(){i()}),e.bind.call(t,"attributes",function(e){var o=e.attributeName,l=t.getAttribute(o);if(o===n.attributeName&&(i&&i(),null!==l)){var u=d({name:o,value:l},t,{templateType:n.templateType,scope:n.scope,semaphore:r,getViewModel:function(){return a},initializeValues:!0,nodeList:n.nodeList});u&&(u.onCompleteBinding&&u.onCompleteBinding(),i=u.onTeardown)}})}},reference:function(t,n){t.getAttribute(n.attributeName)&&console.warn("*reference attributes can only export the view model.");var i=e.camelize(n.attributeName.substr(1).toLowerCase()),a=e.viewModel(t),r=n.scope.getRefs();r._context.attr("*"+i,a)},event:function(n,i){var a=i.attributeName,r=0===a.indexOf("can-"),o=0===a.indexOf("can-")?a.substr("can-".length):f(a,"(",")"),l=r;"$"===o.charAt(0)&&(o=o.substr(1),l=!0);var u=function(r){var o=n.getAttribute(a);if(o){var l=e.$(n),u=e.viewModel(l[0]),c=t.parse(f(o),{lookupRule:"method",methodRule:"call"});if(!(c instanceof t.Call||c instanceof t.Helper)){var d=e.map([i.scope._context,l].concat(e.makeArray(arguments)),function(e){return new t.Literal(e)});c=new t.Call(c,d,{})}var s=i.scope.read(c.methodExpr.key,{isArgument:!0});if(!s.value)return s=i.scope.read(c.methodExpr.key,{isArgument:!0}),null;var p=i.scope.add({"@element":l,"@event":r,"@viewModel":u,"@scope":i.scope,"@context":i.scope._context,"%element":this,$element:l,"%event":r,"%viewModel":u,"%scope":i.scope,"%context":i.scope._context},{notContext:!0}),v=c.args(p,null)(),h=c.hash(p,null)();return e.isEmptyObject(h)||v.push(h),s.value.apply(s.parent,v)}};if(g[o]){var c=g[o](i,n,u);u=c.handler,o=c.event}e.bind.call(l?n:e.viewModel(n),o,u);var d=function(t){t.attributeName!==a||this.getAttribute(a)||(e.unbind.call(l?n:e.viewModel(n),o,u),e.unbind.call(n,"attributes",d))};e.bind.call(n,"attributes",d)},value:function(t,n){var i,a="$value",o=e.trim(f(t.getAttribute("can-value")));if("input"!==t.nodeName.toLowerCase()||"checkbox"!==t.type&&"radio"!==t.type)v(t)&&(a="$innerHTML");else{var l=r.scope(t,n.scope,o,{},!0);if("checkbox"===t.type){var u=e.attr.has(t,"can-true-value")?t.getAttribute("can-true-value"):!0,c=e.attr.has(t,"can-false-value")?t.getAttribute("can-false-value"):!1;i=e.compute(function(e){return arguments.length?void l(e?u:c):l()==u})}else"radio"===t.type&&(i=e.compute(function(e){return arguments.length?void(e&&l(t.value)):l()==t.value}));a="$checked",o="getterSetter",n.scope=new e.view.Scope({getterSetter:i})}d({name:"{("+a+"})",value:o},t,{templateType:n.templateType,scope:n.scope,semaphore:{},initializeValues:!0,legacyBindings:!0,syncChildWithParent:!0})}};e.view.attr(/^\{[^\}]+\}$/,a.data),e.view.attr(/\*[\w\.\-_]+/,a.reference),e.view.attr(/^\([\$?\w\.]+\)$/,a.event),e.view.attr(/can-[\w\.]+/,a.event),e.view.attr("can-value",a.value);var r={scope:function(n,i,a,r,o,l){if(a){if(o){var u=t.parse(a,{baseMethodType:"Call"});return u.value(i,new e.view.Options({}))}return function(e){i.attr(b(a),e)}}return e.compute()},viewModel:function(t,n,i,a,r,o){var l=b(i);return r?e.compute(function(t){var n=a.getViewModel();return arguments.length?void n.attr(l,t):"."===i?n:e.compute.read(n,e.compute.read.reads(i),{}).value}):function(e){a.getViewModel().attr(l,e)}},attribute:function(t,n,i,a,r,o,l){l||(l="innerHTML"===i?["blur","change"]:"change"),e.isArray(l)||(l=[l]);var u,c,d,s="select"===t.nodeName.toLowerCase(),p="value"===i&&s&&t.multiple,v=!1,f=function(n){if(s&&!v&&(clearTimeout(d),d=setTimeout(function(){f(n)},1)),c=n,p){n&&"string"==typeof n?(n=n.split(";"),u=!0):n=n?e.makeArray(n):[];var r={};e.each(n,function(e){r[e]=!0}),e.each(t.childNodes,function(e){e.value&&(e.selected=!!r[e.value])})}else!a.legacyBindings&&s&&"selectedIndex"in t&&"value"===i?e.attr.setSelectValue(t,n):e.attr.setAttrOrProp(t,i,null==n?"":n);return n},h=function(){if(p){var n=[],a=t.childNodes;return e.each(a,function(e){e.selected&&e.value&&n.push(e.value)}),u?n.join(";"):n}return s&&"selectedIndex"in t&&-1===t.selectedIndex?void 0:e.attr.get(t,i)};s&&setTimeout(function(){v=!0},1);var m;return e.compute(h(),{on:function(n){if(e.each(l,function(i){e.bind.call(t,i,n)}),s){var i=function(e){o&&f(o()),n()};e.attr.MutationObserver?(m=new e.attr.MutationObserver(i),m.observe(t,{childList:!0,subtree:!0})):e.data(e.$(t),"canBindingCallback",{onMutation:i})}},off:function(n){e.each(l,function(i){e.unbind.call(t,i,n)}),s&&(e.attr.MutationObserver?m.disconnect():e.data(e.$(t),"canBindingCallback",null))},get:h,set:f})}},o={childToParent:function(t,n,i,a,r,o){var l="function"==typeof n,u=function(t,u){a[r]||(l?(n(u),o&&n()!==i()&&(a[r]=(a[r]||0)+1,i(n()),e.batch.after(function(){--a[r]}))):n instanceof e.Map&&n.attr(u,!0))};return i&&i.isComputed&&i.bind("change",u),u},parentToChild:function(t,n,i,a,r){var o=function(t,n){a[r]=(a[r]||0)+1,i(n),e.batch.after(function(){--a[r]})};return n&&n.isComputed&&n.bind("change",o),o}},l=function(t,i,a,r){var o=t.name,l=t.value||"",d=o.match(u);if(!d){var s=c.test(o),p=e.camelize(o);if(s||n.attr(o))return;var v="{"===l[0]&&"}"===e.last(l),f="legacy"===a?i[p]:!v,h=v?l.substr(1,l.length-2):l;return f?{bindingAttributeName:o,parent:"attribute",parentName:o,child:"viewModel",childName:p,parentToChild:!0,childToParent:!0}:{bindingAttributeName:o,parent:"scope",parentName:h,child:"viewModel",childName:p,parentToChild:!0,childToParent:!0}}var m=!!d[1],b=m||!!d[2],g=m||!b,w=d[3],C="$"===w.charAt(0);if(C){var T={parent:"scope",child:"attribute",childToParent:b,parentToChild:g,bindingAttributeName:o,childName:w.substr(1),parentName:l,initializeValues:!0};return"select"===r&&(T.stickyParentToChild=!0),T}return{parent:"scope",child:"viewModel",childToParent:b,parentToChild:g,bindingAttributeName:o,childName:e.camelize(w),parentName:l,initializeValues:!0}},u=/\{(\()?(\^)?([^\}\)]+)\)?\}/,c=/^(data-view-id|class|id|\[[\w\.-]+\]|#[\w\.-])$/i,d=function(t,n,i){var a=l(t,i.attributeViewModelBindings,i.templateType,n.nodeName.toLowerCase());if(a){a.alreadyUpdatedChild=i.alreadyUpdatedChild,i.initializeValues&&(a.initializeValues=!0);var u,c,d,p=r[a.parent](n,i.scope,a.parentName,i,a.parentToChild),v=r[a.child](n,i.scope,a.childName,i,a.childToParent,a.stickyParentToChild&&p);i.nodeList&&(p&&p.isComputed&&p.computeInstance.setPrimaryDepth(i.nodeList.nesting+1),v&&v.isComputed&&v.computeInstance.setPrimaryDepth(i.nodeList.nesting+1)),a.parentToChild&&(c=o.parentToChild(n,p,v,i.semaphore,a.bindingAttributeName));var f=function(){a.childToParent?u=o.childToParent(n,p,v,i.semaphore,a.bindingAttributeName,i.syncChildWithParent):a.stickyParentToChild&&v.bind("change",d=e.k),a.initializeValues&&s(a,v,p,c,u)},b=function(){m(p,c),m(v,u),m(v,d)};return"viewModel"===a.child?{value:h(p),onCompleteBinding:f,bindingInfo:a,onTeardown:b}:(f(),{bindingInfo:a,onTeardown:b})}},s=function(e,t,n,i,a){var r=!1;e.parentToChild&&!e.childToParent||(!e.parentToChild&&e.childToParent?r=!0:void 0===h(t)||void 0===h(n)&&(r=!0)),r?a({},h(t)):e.alreadyUpdatedChild||i({},h(n))};if(!e.attr.MutationObserver){var p=function(t){var n=e.data(e.$(t),"canBindingCallback");n&&n.onMutation(t)};i.registerChildMutationCallback("select",p),i.registerChildMutationCallback("optgroup",function(e){p(e.parentNode)})}var v=function(){var e={"":!0,"true":!0,"false":!1},t=function(t){if(t&&t.getAttribute){var n=t.getAttribute("contenteditable");return e[n]}};return function(e){var n=t(e);return"boolean"==typeof n?n:!!t(e.parentNode)}}(),f=function(e,t,n){return t=t||"{",n=n||"}",e[0]===t&&e[e.length-1]===n?e.substr(1,e.length-2):e},h=function(e){return e&&e.isComputed?e():e},m=function(e,t){e&&e.isComputed&&"function"==typeof t&&e.unbind("change",t)},b=function(e){return e.replace(/@/g,"")},g={enter:function(e,t,n){return{event:"keyup",handler:function(e){return 13===e.keyCode?n.call(this,e):void 0}}}};return e.bindings={behaviors:a,getBindingInfo:l,special:g},e.bindings});
...
/*can@2.3.16#view/mustache/mustache*/
...
/*can@2.3.16#component/component*/
