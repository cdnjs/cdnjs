...
singleton.addPlugin(angular).addPlugin(console$3).addPlugin(ember).addPlugin(require_1);
var angular_console_ember_require = {};

return angular_console_ember_require;
