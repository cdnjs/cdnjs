...
singleton.addPlugin(angular).addPlugin(console$3).addPlugin(ember).addPlugin(require_1).addPlugin(vue);
var angular_console_ember_require_vue = {};

return angular_console_ember_require_vue;
