...
var wrapConsoleMethod$1 = console$1.wrapMethod;
...
function consolePlugin(Raven, console, pluginOptions) {
  ...
  while (level) {
    wrapConsoleMethod$1(console, level, callback);
    level = logLevels.pop();
  }
}

var console$3 = consolePlugin;
...
singleton.addPlugin(console$3).addPlugin(require_1).addPlugin(vue);
var console_require_vue = {};

return console_require_vue;
