 ...
 * Assert interface
 */
;var e=h("./chai/interface/assert");j.use(e)},{"./chai/assertion":3,"./chai/config":4,"./chai/core/assertions":5,"./chai/interface/assert":6,"./chai/interface/expect":7,"./chai/interface/should":8,"./chai/utils":21,"assertion-error":29}],3:[function(g,h,e){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
...
/*!
   ...
   * @api private
   */
;Object.defineProperty(i.prototype,"_obj",{get:function(){return k(this,"object")},set:function(n){k(this,"object",n)}})}},{"./config":4}],4:[function(f,g,e){g.exports={includeStack:false,showDiff:true,truncateThreshold:40}},{}],5:[function(f,g,e){
/*!
 * chai
 * http://chaijs.com
 * Copyright(c) 2011-2014 Jake Luer <jake@alogicalparadox.com>
 ...
 * Module dependancies
 */
;var f=h("./flag"),j=h("./getActual"),k=h("./inspect"),e=h("./objDisplay");i.exports=function(o,l){var n=f(o,"negate"),r=f(o,"object"),m=l[3],s=j(o,l),q=n?l[2]:l[1],p=f(o,"message");if(typeof q==="function"){q=q()}q=q||"";q=q.replace(/#{this}/g,e(r)).replace(/#{act}/g,e(s)).replace(/#{exp}/g,e(m));return p?p+": "+q:q}},{"./flag":12,"./getActual":13,"./inspect":22,"./objDisplay":23}],16:[function(f,g,e){
/*!
 * Chai - getName utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function(i){if(i.name){return i.name}var h=/^\s?function ([^(]*)\(/.exec(i);return h&&h[1]?h[1]:""}},{}],17:[function(h,j,g){
/*!
 ...
 * @api private
 */
;function e(n,t,p){var s=t,r;p=(p===undefined?n.length:p);for(var q=0,m=p;q<m;q++){var o=n[q];if(s){if("undefined"!==typeof o.p){s=s[o.p]}else{if("undefined"!==typeof o.i){s=s[o.i]}}if(q==(m-1)){r=s}}else{r=undefined}}return r}},{"./hasProperty":20}],18:[function(f,g,e){
/*!
 ...
 * MIT Licensed
 */
;var h=f("./getPathInfo");g.exports=function(k,j){var i=h(k,j);return i.value}},{"./getPathInfo":17}],19:[function(f,g,e){
/*!
 * Chai - getProperties utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function h(j){var i=Object.getOwnPropertyNames(subject);function k(m){if(i.indexOf(m)===-1){i.push(m)}}var l=Object.getPrototypeOf(subject);while(l!==null){Object.getOwnPropertyNames(l).forEach(k);l=Object.getPrototypeOf(l)}return i}},{}],20:[function(g,h,f){
/*!
 * Chai - hasProperty utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;var i=g("type-detect");var j={number:Number,string:String};h.exports=function e(k,m){var l=i(m);if(l==="null"||l==="undefined"){return false}if(j[l]&&typeof m!=="object"){m=new j[l](m)}return k in m}},{"type-detect":34}],21:[function(f,g,e){
/*!
 * chai
 ...
 * Module dependancies
 */
;var i=g("./inspect");var f=g("../config");h.exports=function(m){var n=i(m),j=Object.prototype.toString.call(m);if(f.truncateThreshold&&n.length>=f.truncateThreshold){if(j==="[object Function]"){return !m.name||m.name===""?"[Function]":"[Function: "+m.name+"]"}else{if(j==="[object Array]"){return"[ Array("+m.length+") ]"}else{if(j==="[object Object]"){var k=Object.keys(m),l=k.length>2?k.splice(0,2).join(", ")+", ...":k.join(", ");return"{ Object ("+l+") }"}else{return n}}}}else{return n}}},{"../config":4,"./inspect":22}],24:[function(f,g,e){
/*!
 * Chai - overwriteChainableMethod utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function(i,l,n,k){var m=i.__methods[l];var h=m.chainingBehavior;m.chainingBehavior=function(){var o=k(h).call(this);return o===undefined?this:o};var j=m.method;m.method=function(){var o=n(j).apply(this,arguments);return o===undefined?this:o}}},{}],25:[function(f,g,e){
/*!
 * Chai - overwriteMethod utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function(h,j,l){var i=h[j],k=function(){return this};if(i&&"function"===typeof i){k=i}h[j]=function(){var m=l(k).apply(this,arguments);return m===undefined?this:m}}},{}],26:[function(f,g,e){
/*!
 * Chai - overwriteProperty utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function(i,j,h){var k=Object.getOwnPropertyDescriptor(i,j),l=function(){};if(k&&"function"===typeof k.get){l=k.get}Object.defineProperty(i,j,{get:function(){var m=h(l).call(this);return m===undefined?this:m},configurable:true})}},{}],27:[function(g,h,f){
/*!
 * Chai - test utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 ...
 * Module dependancies
 */
;var e=g("./flag");h.exports=function(l,i){var k=e(l,"negate"),j=i[0];return k?!j:j}},{"./flag":12}],28:[function(f,g,e){
/*!
 * Chai - transferFlags utility
 * Copyright(c) 2012-2014 Jake Luer <jake@alogicalparadox.com>
 * MIT Licensed
 */
;g.exports=function(i,l,h){var k=i.__flags||(i.__flags=Object.create(null));if(!l.__flags){l.__flags=Object.create(null)}h=arguments.length===3?h:true;for(var j in k){if(h||(j!=="object"&&j!=="ssfi"&&j!="message")){l.__flags[j]=k[j]}}}},{}],29:[function(h,i,f){
/*!
 * assertion-error
 ...
 */
;g.prototype.constructor=g;g.prototype.toJSON=function(j){var l=e("constructor","toJSON","stack"),k=l({name:this.name},this);if(false!==j&&this.stack){k.stack=this.stack}return k}},{}],30:[function(f,g,e){g.exports=f("./lib/eql")},{"./lib/eql":31}],31:[function(h,g,l){
/*!
 * deep-eql
 ...
 * @return {Boolean} result
 */
;function q(x,w,v){if(!p(x)||!p(w)){return false}if(x.prototype!==w.prototype){return false}var A;if(v){for(A=0;A<v.length;A++){if((v[A][0]===x&&v[A][1]===w)||(v[A][0]===w&&v[A][1]===x)){return true}}}else{v=[]}try{var C=i(x);var B=i(w)}catch(z){return false}C.sort();B.sort();if(!t(C,B)){return false}v.push([x,w]);var y;for(A=C.length-1;A>=0;A--){y=C[A];if(!s(x[y],w[y],v)){return false}}return true}},{buffer:undefined,"type-detect":32}],32:[function(f,g,e){g.exports=f("./lib/type")},{"./lib/type":33}],33:[function(g,h,f){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
