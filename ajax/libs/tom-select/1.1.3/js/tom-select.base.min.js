...
function p(e){return null==e?null:"boolean"==typeof e?e?"1":"0":e+""}function d(e){return(e+"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function c(e,t,i){var s,n=e.trigger,r={}
for(s in e.trigger=function(){var i=arguments[0]
if(-1===t.indexOf(i))return n.apply(e,arguments)
r[i]=arguments},i.apply(e,[]),e.trigger=n,r)n.apply(e,r[s])}function u(e,t=!1){e&&(e.preventDefault(),t&&e.stopPropagation())}function h(e,t,i,s){e.addEventListener(t,i,s)}function g(e,t){return!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0))}function v(e){if(e.jquery)return e[0]
if(e instanceof HTMLElement)return e
if(e.indexOf("<")>-1){let t=document.createElement("div")
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)}function f(e,t){var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function m(e,t){Object.assign(e.style,t)}function y(e,...t){var i=b(t);(e=w(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function O(e,...t){var i=b(t);(e=w(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function b(e){var t=[]
for(let i=0;i<e.length;i++){let s=e[i]
"string"==typeof s&&(s=s.trim().split(/[\11\12\14\15\40]/)),Array.isArray(s)&&(t=t.concat(s))}return t.filter(Boolean)}function w(e){return Array.isArray(e)||(e=[e]),e}function C(e,t,i){if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}}function I(e,t){return t>0?e[e.length-1]:e[0]}function A(e,t){if(!e)return-1
t=t||e.nodeName
...
if(super(),(e=v(e)).tomselect)throw new Error("Tom Select already initialized on this element")
...
"function"!=typeof l&&("string"==typeof l&&(l=new RegExp(l)),l instanceof RegExp?this.settings.createFilter=e=>l.test(e):this.settings.createFilter=()=>!0),this.initializePlugins(this.settings.plugins),this.setupCallbacks(),this.setupTemplates(),this.setup()}setup(){var e,t,i,s,n,r,o,l,a,p=this,d=p.settings,c=p.input
const g={passive:!0}
if(r=p.settings.mode,o=c.getAttribute("class")||"",y(e=v("<div>"),d.wrapperClass,o,r),y(t=v('<div class="items">'),d.inputClass),e.append(t),y(s=p.render("dropdown"),d.dropdownClass,r),y(n=v('<div style="scroll-behavior: smooth;">'),d.dropdownContentClass),s.append(n),v(d.dropdownParent||e).appendChild(s),d.controlInput)i=v(d.controlInput)
else{i=v('<input type="text" autocomplete="off" />')
var f=["autocorrect","autocapitalize","autocomplete"]
for(let e=0;e<f.length;e++){let t=f[e]
...
t&&t.setAttribute("for",a+"-tomselected")}if(p.settings.copyClassesToDropdown&&y(s,o),e.style.width=c.style.width,p.plugins.names.length&&(l="plugin-"+p.plugins.names.join(" plugin-"),y([e,s],l)),(null===d.maxItems||d.maxItems>1)&&p.is_select_tag&&c.setAttribute("multiple","multiple"),p.settings.placeholder&&i.setAttribute("placeholder",d.placeholder),!p.settings.splitOn&&p.settings.delimiter){var m=p.settings.delimiter.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")
p.settings.splitOn=new RegExp("\\s*"+m+"+\\s*")}p.control=t,p.control_input=i,p.wrapper=e,p.dropdown=s,p.dropdown_content=n,p.control_input.type=c.type,h(s,"mouseenter",(e=>{var t=C(e.target,"[data-selectable]",s)
if(t)return p.onOptionHover(e,t)}),{capture:!0}),h(t,"mousedown",(e=>{var i=C(e.target,"."+p.settings.itemClass,t)
return i?p.onItemSelect(e,i):p.onMouseDown(e)})),h(t,"click",(e=>p.onClick(e))),h(i,"mousedown",(e=>e.stopPropagation())),h(i,"keydown",(e=>p.onKeyDown(e))),h(i,"keyup",(e=>p.onKeyUp(e))),h(i,"keypress",(e=>p.onKeyPress(e))),h(i,"resize",(()=>p.positionDropdown()),g),h(i,"blur",(e=>p.onBlur(e))),h(i,"focus",(e=>{p.ignoreBlur=!1,p.onFocus(e)})),h(i,"paste",(e=>p.onPaste(e)))
var O=e=>{var t=C(e.target,"[data-selectable]",p.dropdown)
t||p.wrapper.contains(e.target)?(u(e,!0),t&&p.onOptionSelect(e,t)):p.isFocused&&p.blur(e.target)},b=()=>{p.isOpen&&p.positionDropdown()},w=()=>{p.ignoreHover=!1}
h(document,"mousedown",O),h(window,"sroll",b,g),h(window,"resize",b,g),h(window,"mousemove",w,g),p._destroy=()=>{document.removeEventListener("mousedown",O),window.removeEventListener("mousemove",w),window.removeEventListener("sroll",b),window.removeEventListener("resize",b)}
for(var I=[];c.children.length>0;)I.push(c.children[0]),c.children[0].remove()
this.revertSettings={children:I,tabindex:c.getAttribute("tabindex")},c.tabIndex=-1,c.setAttribute("hidden","hidden"),c.insertAdjacentElement("afterend",p.wrapper),p.setValue(d.items),delete d.items,h(c,"invalid",(e=>{u(e),p.isInvalid||(p.isInvalid=!0,p.refreshState())})),p.updateOriginalInput(),p.refreshItems(),p.refreshState(),p.isSetup=!0,c.disabled&&p.disable(),p.on("change",this.onChange),y(c,"tomselected"),p.trigger("initialize"),!0===d.preload&&p.load("")}setupOptions(e,t){var i,s
...
if(t.isFocused){if(e.target!==t.control_input)return"single"===t.settings.mode?t.isOpen?t.close():t.open():t.setActiveItem(),!1}else setTimeout((()=>t.focus()),0)}onChange(){f(this.input,"input"),f(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,f(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){c(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,r,o,a,p=this
if("single"!==p.settings.mode){if(!e)return O(p.activeItems,"active"),p.activeItems=[],void(p.isFocused&&p.showInput())
if("mousedown"===(i=t&&t.type.toLowerCase())&&g("shiftKey",t)&&p.activeItems.length){for(a=p.getLastActive(),(n=Array.prototype.indexOf.call(p.control.children,a))>(r=Array.prototype.indexOf.call(p.control.children,e))&&(o=n,n=r,r=o),s=n;s<=r;s++)e=p.control.children[s],-1===p.activeItems.indexOf(e)&&p.setActiveItemClass(e)
u(t)}else"mousedown"===i&&g(l,t)||"keydown"===i&&g("shiftKey",t)?e.classList.contains("active")?p.removeActiveItem(e):p.setActiveItemClass(e):(O(p.activeItems,"active"),p.activeItems=[],p.setActiveItemClass(e))
...
return i}refreshOptions(e=!0){var t,i,s,n,r,l,a,d,c,u,h,g,v,f=this,m=f.inputValue(),b=f.search(m),w=f.activeOption&&p(f.activeOption.dataset.value),C=!1
for(n=b.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(C=!0),r={},l=[],t=0;t<n;t++){let e=f.options[b.items[t].id],n=p(e[f.settings.valueField]),o=f.getOption(n)
for(o||(o=f.render("option",e)),a=e[f.settings.optgroupField]||"",i=0,s=(d=Array.isArray(a)?a:[a])&&d.length;i<s;i++)a=d[i],f.optgroups.hasOwnProperty(a)||(a=""),r.hasOwnProperty(a)||(r[a]=document.createDocumentFragment(),l.push(a)),i>0&&(o=o.cloneNode(!0),O(o,"active")),r[a].appendChild(o)}for(this.settings.lockOptgroupOrder&&l.sort(((e,t)=>(f.optgroups[e].$order||0)-(f.optgroups[t].$order||0))),c=document.createDocumentFragment(),t=0,n=l.length;t<n;t++)if(a=l[t],f.optgroups.hasOwnProperty(a)&&r[a].children.length){let e=document.createDocumentFragment()
...
i.replaceChild(e.firstChild,e),i.normalize()})),b.query.length&&b.tokens.length))for(t=0,n=b.tokens.length;t<n;t++)o(f.dropdown_content,b.tokens[t].regex)
if(!f.settings.hideSelected)for(t=0,n=f.items.length;t<n;t++){let e=f.getOption(f.items[t])
e&&y(e,"selected")}var I=e=>{let t=f.render(e,{input:m})
return t&&(C=!0,f.dropdown_content.insertBefore(t,f.dropdown_content.firstChild)),t}
if(f.loading?I("loading"):0===b.items.length&&f.settings.render.no_results&&m.length&&I("no_results"),(u=f.canCreate(m))&&(g=I("option_create")),f.hasOptions=b.items.length>0||u,C){if(b.items.length>0){if(!(h=w&&f.getOption(w))||!f.dropdown_content.contains(h)){let e=0
...
a=d.options[e].$order,n!==e&&(delete d.options[e],-1!==(r=d.items.indexOf(e))&&d.items.splice(r,1,n)),t.$order=t.$order||a,d.options[n]=t,o=d.renderCache.item,l=d.renderCache.option,o&&(delete o[e],delete o[n]),l&&(delete l[e],delete l[n]),-1!==d.items.indexOf(n)&&(i=d.getItem(e),s=d.render("item",t),i.classList.contains("active")&&y(s,"active"),i.parentNode.insertBefore(s,i),i.remove()),d.lastQuery=null,d.isOpen&&d.refreshOptions(!1)}}removeOption(e,t){var i=this
e=p(e)
...
if(e=p(e),(-1===n.items.indexOf(e)||("single"===r&&n.close(),"single"!==r&&n.settings.duplicates))&&n.options.hasOwnProperty(e)&&("single"===r&&n.clear(t),"multi"!==r||!n.isFull())){if(i=n.render("item",n.options[e]),n.control.contains(i)&&(i=i.cloneNode(!0)),s=n.isFull(),n.items.splice(n.caretPos,0,e),n.insertAtCaret(i),n.isSetup){let s=n.selectable()
...
r&&(e=p(r.dataset.value),-1!==(i=n.items.indexOf(e))&&(r.remove(),r.classList.contains("active")&&(s=n.activeItems.indexOf(r),n.activeItems.splice(s,1),O(r,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,r)))}createItem(e,t=!0,i){var s,n=this,r=n.caretPos
...
if(s=e&&8===e.keyCode?-1:1,n={start:(l=a.control_input).selectionStart,length:l.selectionEnd-l.selectionStart},r=[],a.activeItems.length){for(o=A(I(a.activeItems,s)),s>0&&o++,t=0,i=a.activeItems.length;t<i;t++)r.push(a.activeItems[t].dataset.value)
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML="",t.tabindex?e.input.setAttribute("tabindex",t.tabindex):e.input.removeAttribute("tabindex"),O(e.input,"tomselected"),e.input.removeAttribute("hidden"),e.input.required=this.isRequired
...
return"option"!==e&&"item"!==e||(i=p(t[r.settings.valueField]),!r.renderCache[e].hasOwnProperty(i))?(n=r.settings.render[e].call(this,t,d))?(n=v(n),"option"===e||"option_create"===e?t[r.settings.disabledField]||n.setAttribute("data-selectable",""):"optgroup"===e&&(s=t.group[r.settings.optgroupValueField],n.setAttribute("data-group",s),t.group[r.settings.disabledField]&&n.setAttribute("data-disabled","")),"option"!==e&&"item"!==e||(n.setAttribute("data-value",i),y(n,"item"===e?r.settings.itemClass:r.settings.optionClass),r.renderCache[e][i]=n),n):n:r.renderCache[e][i]}clearCache(e){void 0===e?this.renderCache={item:{},option:{}}:this.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
