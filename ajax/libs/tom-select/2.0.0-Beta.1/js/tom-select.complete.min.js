...
e=e.parentNode}},_=(e,t=0)=>t>0?e[e.length-1]:e[0],C=(e,t)=>{if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i},I=(e,t)=>{for(const i in t){let s=t[i]
...
o[i]=arguments},i.apply(e,[]),e.trigger=n,o)n.apply(e,o[s])},V=(e,t=!1)=>{e&&(e.preventDefault(),t&&e.stopPropagation())},q=(e,t,i,s)=>{e.addEventListener(t,i,s)},j=(e,t)=>!!t&&(!!t[e]&&1===(t.altKey?1:0)+(t.ctrlKey?1:0)+(t.shiftKey?1:0)+(t.metaKey?1:0)),D=(e,t)=>{const i=e.getAttribute("id")
...
for(const i of e.children)"optgroup"===(t=i.tagName.toLowerCase())?v(i):"option"===t&&f(i)})():(()=>{const t=e.getAttribute(s)
...
t[n]=e,t[o]=e,u.options.push(t)}u.items=t}})(),Object.assign({},F,u,t)}var B=0
class H extends(function(e){return e.plugins={},class extends e{constructor(...e){super(...e),this.plugins={names:[],settings:{},requested:{},loaded:{}}}static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i
const s=this,n=[]
...
var p
if(m(o,t.wrapperClass,c,d),m(r,t.inputClass),z(o,r),m(l,t.dropdownClass,d),t.copyClassesToDropdown&&m(l,c),m(a,t.dropdownContentClass),z(l,a),g(t.dropdownParent||o).appendChild(l),t.hasOwnProperty("controlInput"))t.controlInput?(p=g(t.controlInput),this.focus_node=p):(p=g("<input/>"),this.focus_node=r)
else{p=g('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&I(p,{[e]:s.getAttribute(e)})
...
I(n,{id:p}),I(a,{role:"combobox","aria-haspopup":"listbox","aria-expanded":"false","aria-controls":p})
const u=D(a,e.inputId+"-ts-control"),h="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(e.inputId)+"']",g=document.querySelector(h),f=e.focus.bind(e)
if(g){q(g,"click",f),I(g,{for:u})
const t=D(g,e.inputId+"-ts-label")
I(a,{"aria-labelledby":t}),I(n,{"aria-labelledby":t})}if(o.style.width=l.style.width,e.plugins.names.length){const t="plugin-"+e.plugins.names.join(" plugin-")
m([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&I(l,{multiple:"multiple"}),e.settings.placeholder&&I(i,{placeholder:t.placeholder}),!e.settings.splitOn&&e.settings.delimiter&&(e.settings.splitOn=new RegExp("\\s*"+c(e.settings.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=E(t.load,t.loadThrottle)),e.control_input.type=l.type,q(s,"click",(t=>{const i=w(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),V(t,!0))})),q(r,"click",(t=>{var s=w(t.target,"."+e.settings.itemClass,r)
s&&e.onItemSelect(t,s)?V(t,!0):""==i.value&&(e.onClick(),V(t,!0))})),q(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),q(a,"keydown",(t=>e.onKeyDown(t))),q(i,"keyup",(t=>e.onKeyUp(t))),q(i,"keypress",(t=>e.onKeyPress(t))),q(a,"resize",(()=>e.positionDropdown()),d),q(a,"blur",(t=>e.onBlur(t))),q(a,"focus",(t=>e.onFocus(t))),q(a,"paste",(t=>e.onPaste(t)))
...
q(document,"mousedown",v),q(window,"scroll",y,d),q(window,"resize",y,d),this._destroy=()=>{document.removeEventListener("mousedown",v),window.removeEventListener("sroll",y),window.removeEventListener("resize",y),g&&g.removeEventListener("click",f)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,q(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),m(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.load("")}setupOptions(e=[],t=[]){this.addOptions(e)
...
for(e in i)(t=this.settings[i[e]])&&this.on(e,t)}sync(e=!0){const t=this,i=e?R(t.input,{delimiter:t.settings.delimiter}):t.settings
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!j(x,e)&&V(e)}}onKeyUp(e){var t=this
if(t.isLocked)V(e)
...
V(t)}else"click"===i&&j(x,t)||"keydown"===i&&j("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
this.activeItems.splice(t,1),y(e,"active")}clearActiveItems(){y(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,I(this.focus_node,{"aria-activedescendant":e.getAttribute("id")}),I(e,{"aria-selected":"true"}),m(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(y(this.activeOption,"active"),I(this.activeOption,{"aria-selected":null})),this.activeOption=null,I(this.focus_node,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(m(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.control.contains(e.control_input)&&(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,m(e.wrapper,"input-hidden")):(e.isInputHidden=!1,y(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
if(f.settings.shouldLoad.call(f,v)?f.loading?_("loading"):0===m.items.length&&_("no_results"):_("not_loading"),(a=f.canCreate(v))&&(p=_("option_create")),f.hasOptions=m.items.length>0||a,b){if(m.items.length>0){if(!w.contains(O)&&"single"===f.settings.mode&&f.items.length&&(O=f.getOption(f.items[0])),!w.contains(O)){let e=0
...
function r(i,s,n){return i||(i=g('<option value="'+P(s)+'">'+P(n)+"</option>")),t.input.prepend(i),e.push(i),I(i,{selected:"true"}),i.selected=!0,i}if(t.input.querySelectorAll("option[selected]").forEach((e=>{I(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=t.items.length-1;i>=0;i--)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.includes(n.$option)){r(t.input.querySelector(`option[value="${N(s)}"]:not([selected])`),s,o)}else n.$option=r(n.$option,s,o)
else r(t.input.querySelector('option[value=""]'),"","")}else t.input.value=t.getValue()
t.isSetup&&(e.silent||t.trigger("change",t.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,I(e.focus_node,{"aria-expanded":"true"}),e.refreshState(),v(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),v(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&t.hideInput()),t.isOpen=!1,I(t.focus_node,{"aria-expanded":"false"}),v(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
const l=[]
if(r.activeItems.length){n=_(r.activeItems,t),s=C(n),t>0&&s++
...
n.rtl&&(e*=-1),n.inputValue().length||(j(x,t)||j("shiftKey",t)?(s=(i=n.getLastActive(e))?i.classList.contains("active")?n.getAdjacent(i,e,"item"):i:e>0?n.control_input.nextElementSibling:n.control_input.previousElementSibling)&&(s.classList.contains("active")&&n.removeActiveItem(i),n.setActiveItemClass(s)):n.moveCaret(e))}moveCaret(e){}getLastActive(e){let t=this.control.querySelector(".last-active")
if(t)return t
var i=this.control.querySelectorAll(".active")
return i?_(i,e):void 0}setCaret(e){this.caretPos=this.items.length}controlChildren(){return Array.from(this.control.getElementsByClassName(this.settings.itemClass))}lock(){this.close(),this.isLocked=!0,this.refreshState()}unlock(){this.isLocked=!1,this.refreshState()}disable(){var e=this
...
const o=this
return("option"===e||"item"===e)&&(n=L(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,P))||(s=g(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?I(s,{"aria-disabled":"true"}):I(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],I(s,{"data-group":i}),t.group[o.settings.disabledField]&&I(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(I(s,{"data-value":n}),"item"===e?m(s,o.settings.itemClass):(m(s,o.settings.optionClass),I(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return H.define("change_listener",(function(){q(this.input,"change",(()=>{this.sync()}))})),H.define("checkbox_options",(function(){var e=this,t=e.onOptionSelect
e.settings.hideSelected=!1
var i=function(e){setTimeout((()=>{var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}),1)}
e.hook("after","setupTemplates",(()=>{var t=e.settings.render.option
e.settings.render.option=(i,s)=>{var n=g(t.call(e,i,s)),o=document.createElement("input")
o.addEventListener("click",(function(e){V(e)})),o.type="checkbox"
const r=k(i[e.settings.valueField])
return r&&e.items.indexOf(r)>-1&&(o.checked=!0),n.prepend(o),n}})),e.on("item_remove",(t=>{var s=e.getOption(t)
s&&(s.classList.remove("selected"),i(s))})),e.hook("instead","onOptionSelect",((s,n)=>{if(n.classList.contains("selected"))return n.classList.remove("selected"),e.removeItem(n.dataset.value),e.refreshOptions(),void V(s,!0)
t.call(e,s,n),i(n)}))})),H.define("clear_button",(function(e){const t=this,i=Object.assign({className:"clear-button",title:"Clear All",html:e=>`<div class="${e.className}" title="${e.title}">&times;</div>`},e)
t.on("initialize",(()=>{var e=g(i.html(i))
e.addEventListener("click",(e=>{t.clear(),e.preventDefault(),e.stopPropagation()})),t.control.appendChild(e)}))})),H.define("drag_drop",(function(){var e=this
...
s&&s.addEventListener("click",(e=>{V(e,!0),t.close()})),t.dropdown.insertBefore(e,t.dropdown.firstChild)}))})),H.define("caret_position",(function(){var e=this
e.hook("instead","setCaret",(t=>{"single"!==e.settings.mode&&e.control.contains(e.control_input)?(t=Math.max(0,Math.min(e.items.length,t)))==e.caretPos||e.isPending||e.controlChildren().forEach(((i,s)=>{s<t?e.control_input.insertAdjacentElement("beforebegin",i):e.control.appendChild(i)})):t=e.items.length,e.caretPos=t})),e.hook("instead","moveCaret",(t=>{if(!e.isFocused)return
const i=e.getLastActive(t)
if(i){const s=C(i)
e.setCaret(t>0?s+1:s),e.setActiveItem()}else e.setCaret(e.caretPos+t)}))})),H.define("dropdown_input",(function(){var e=this
e.settings.shouldOpen=!0,e.hook("before","setup",(()=>{e.focus_node=e.control,m(e.control_input,"dropdown-input")
...
const t=e.onBlur
e.hook("instead","onBlur",(i=>{if(!i||i.relatedTarget!=e.control_input)return t.call(e)})),q(e.control_input,"blur",(()=>e.onBlur())),e.hook("before","close",(()=>{e.focus_node.focus()}))}))})),H.define("input_autogrow",(function(){var e=this
e.on("initialize",(()=>{var t=document.createElement("span"),i=e.control_input
t.style.cssText="position:absolute; top:-99999px; left:-99999px; width:auto; padding:0; white-space:pre; ",e.wrapper.appendChild(t)
for(const e of["letterSpacing","fontSize","fontFamily","fontWeight","textTransform"])t.style[e]=i.style[e]
var s=()=>{e.items.length>0?(t.textContent=i.value,i.style.width=t.clientWidth+"px"):i.style.width=""}
s(),e.on("update item_add item_remove",s),q(i,"input",s),q(i,"keyup",s),q(i,"blur",s),q(i,"update",s)}))})),H.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(i=>!!e.activeItems.length&&t.call(e,i)))})),H.define("no_active_items",(function(){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),H.define("optgroup_columns",(function(){var e=this,t=e.onKeyDown
e.hook("instead","onKeyDown",(i=>{var s,n,o,r
if(!e.isOpen||37!==i.keyCode&&39!==i.keyCode)return t.call(e,i)
r=w(e.activeOption,"[data-group]"),s=C(e.activeOption,"[data-selectable]"),r&&(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),H.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
...
return o.appendChild(r),q(r,"mousedown",(e=>{V(e,!0)})),q(r,"click",(e=>{if(V(e,!0),!i.isLocked){var t=o.dataset.value
i.removeItem(t),i.refreshOptions(!1)}})),o}}))}})),H.define("restore_on_backspace",(function(e){const t=this,i=Object.assign({text:e=>e[t.settings.labelField]},e)
t.on("item_remove",(function(e){if(""===t.control_input.value.trim()){var s=t.options[e]
s&&t.setTextboxValue(i.text.call(t,s))}}))})),H.define("virtual_scroll",(function(){const e=this,t=e.canLoad,i=e.clearActiveOption,s=e.loadCallback
var n,o={},r=!1
