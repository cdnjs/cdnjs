...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},m=e=>(e+"").replace(/([\$\(-\+\.\?\[-\^\{-\}])/g,"\\$1"),v=(e,t)=>{var i=e[t]
...
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},f=(e,t)=>{var s=V(e.value)
...
const f={passive:!0},v=n.inputId+"-ts-dropdown"
if(p=n.settings.mode,u=s.getAttribute("class")||"",r=w("<div>"),_(r,t.wrapperClass,u,p),l=w('<div class="items">'),_(l,t.inputClass),Q(r,l),c=n._render("dropdown"),_(c,t.dropdownClass,p),d=w(`<div role="listbox" id="${v}" tabindex="-1">`),_(d,t.dropdownContentClass),Q(c,d),w(t.dropdownParent||r).appendChild(c),t.controlInput)a=w(t.controlInput)
else{a=w('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&L(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),L(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":v}),g=K(a,n.inputId+"-tomselected")
let y="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",O=document.querySelector(y)
if(O){L(O,{for:g})
let e=K(O,n.inputId+"-ts-label")
L(d,{"aria-labelledby":e})}n.settings.copyClassesToDropdown&&_(c,u),r.style.width=s.style.width,n.plugins.names.length&&(h="plugin-"+n.plugins.names.join(" plugin-"),_([r,c],h)),(null===t.maxItems||t.maxItems>1)&&n.is_select_tag&&L(s,{multiple:"multiple"}),n.settings.placeholder&&L(a,{placeholder:t.placeholder}),!n.settings.splitOn&&n.settings.delimiter&&(n.settings.splitOn=new RegExp("\\s*"+m(n.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=D(this.settings.load,this.settings.loadThrottle)),this.control=l,this.control_input=a,this.wrapper=r,this.dropdown=c,this.dropdown_content=d,n.control_input.type=s.type,H(c,"click",(e=>{const t=F(e.target,"[data-selectable]")
t&&(n.onOptionSelect(e,t),z(e,!0))})),H(l,"click",(e=>{var t=F(e.target,"."+n.settings.itemClass,l)
t&&n.onItemSelect(e,t)?z(e,!0):""==a.value&&(n.onClick(),z(e,!0))})),H(a,"mousedown",(e=>{""!==a.value&&e.stopPropagation()})),H(a,"keydown",(e=>n.onKeyDown(e))),H(a,"keyup",(e=>n.onKeyUp(e))),H(a,"keypress",(e=>n.onKeyPress(e))),H(a,"resize",(()=>n.positionDropdown()),f),H(a,"blur",(()=>n.onBlur())),H(a,"focus",(e=>n.onFocus(e))),H(a,"paste",(e=>n.onPaste(e)))
...
const u={},h=[]
var g,f=this,m=f.inputValue(),v=f.search(m),y=f.activeOption,O=f.settings.shouldOpen||!1,b=f.dropdown_content
for(y&&(c=y.dataset.value,d=y.closest("[data-group]")),n=v.items.length,"number"==typeof f.settings.maxOptions&&(n=Math.min(n,f.settings.maxOptions)),n>0&&(O=!0),t=0;t<n;t++){let e=v.items[t].id,n=f.options[e],l=f.getOption(e,!0)
for(f.settings.hideSelected||l.classList.toggle("selected",f.items.includes(e)),o=n[f.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],f.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),L(l,{id:n.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),A(l,"active")),c==e&&d&&d.dataset.group===o&&(y=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(f.optgroups[e]&&f.optgroups[e].$order||0)-(f.optgroups[t]&&f.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(f.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment(),t=f.render("optgroup_header",f.optgroups[o])
Q(e,t),Q(e,u[o])
let i=f.render("optgroup",{group:f.optgroups[o],options:e})
Q(l,i)}else Q(l,u[o])
if(b.innerHTML="",Q(b,l),f.settings.highlight&&(g=b.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),v.query.length&&v.tokens.length))for(const e of v.tokens)T(b,e.regex)
var w=e=>{let t=f.render(e,{input:m})
return t&&(O=!0,b.insertBefore(t,b.firstChild)),t}
if(f.settings.shouldLoad.call(f,m)?f.loading?w("loading"):0===v.items.length&&w("no_results"):w("not_loading"),(a=f.canCreate(m))&&(p=w("option_create")),f.hasOptions=v.items.length>0||a,O){if(v.items.length>0){if(!b.contains(y)&&"single"===f.settings.mode&&f.items.length&&(y=f.getOption(f.items[0])),!b.contains(y)){let e=0
p&&!f.settings.addPrecedence&&(e=1),y=f.selectable()[e]}}else p&&(y=p)
e&&!f.isOpen&&(f.open(),f.scrollToOption(y,"auto")),f.setActiveOption(y)}else f.clearActiveOption(),e&&f.isOpen&&f.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
const o=this
return("option"===e||"item"===e)&&(n=$(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,N))||(s=w(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?L(s,{"aria-disabled":"true"}):L(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],L(s,{"data-group":i}),t.group[o.settings.disabledField]&&L(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(L(s,{"data-value":n}),"item"===e?_(s,o.settings.itemClass):(_(s,o.settings.optionClass),L(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
...
t=w(t),e.settings.placeholder&&L(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.on("initialize",(()=>{H(e.wrapper,"focus",(t=>{e.onFocus(t)}))
