...
var a=l.cloneNode(!0)
r.appendChild(a),l.parentNode.replaceChild(r,l),s=1}}else if(1===i.nodeType&&i.childNodes&&!/(script|style)/i.test(i.tagName)&&("highlight"!==i.className||"SPAN"!==i.tagName))for(var d=0;d<i.childNodes.length;++d)d+=e(i.childNodes[d])
...
return i||(e.setAttribute("id",t),t)}function _(e,t){var i=Object.assign({},v,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,d=i.optgroupValueField,c=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
if(s||i.allowEmptyOption)if(p.hasOwnProperty(s)){if(t){var a=p[s][l]
...
u.items=t}})(),Object.assign({},v,u,t)}function A(e){if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)}function x(e,t){Object.assign(e.style,t)}function k(e,...t){var i=L(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))}function F(e,...t){var i=L(t);(e=P(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))}function L(e){var t=[]
...
return i}function V(e,t){for(const i in t)e.setAttribute(i,t[i])}var j=0
class N extends(function(e){return e.plugins={},class extends e{static define(t,i){e.plugins[t]={name:t,fn:i}}initializePlugins(e){var t,i,s,n=this,o=[]
...
super(),this.control_input=void 0,this.wrapper=void 0,this.dropdown=void 0,this.control=void 0,this.dropdown_content=void 0,this.order=0,this.settings=void 0,this.input=void 0,this.tabIndex=void 0,this.is_select_tag=void 0,this.rtl=void 0,this.inputId=void 0,this._destroy=void 0,this.sifter=void 0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isRequired=void 0,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.currentResults=null,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},j++
var s=A(e)
if(s.tomselect)throw new Error("Tom Select already initialized on this element")
s.tomselect=this,i=(window.getComputedStyle&&window.getComputedStyle(s,null)).getPropertyValue("direction"),this.settings=_(s,t),this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=C(s,"tomselect-"+j),this.isRequired=s.required,this.sifter=new h(this.options,{diacritics:this.settings.diacritics}),this.setupOptions(this.settings.options,this.settings.optgroups),delete this.settings.optgroups,delete this.settings.options,this.settings.mode=this.settings.mode||(1===this.settings.maxItems?"single":"multi"),"boolean"!=typeof this.settings.hideSelected&&(this.settings.hideSelected="multi"===this.settings.mode),"boolean"!=typeof this.settings.hidePlaceholder&&(this.settings.hidePlaceholder="multi"!==this.settings.mode)
...
const h={passive:!0},g=c.inputId+"-ts-dropdown"
if(o=c.settings.mode,r=u.getAttribute("class")||"",k(e=A("<div>"),p.wrapperClass,r,o),k(t=A('<div class="items">'),p.inputClass),e.append(t),k(s=c.render("dropdown"),p.dropdownClass,o),k(n=A(`<div role="listbox" id="${g}" tabindex="-1">`),p.dropdownContentClass),s.append(n),A(p.dropdownParent||e).appendChild(s),p.controlInput)i=A(p.controlInput)
else{i=A('<input type="text" autocomplete="off" size="1" />')
for(const e of["autocorrect","autocapitalize","autocomplete"])u.getAttribute(e)&&V(i,{[e]:u.getAttribute(e)})}p.controlInput||(i.tabIndex=u.disabled?-1:c.tabIndex,t.appendChild(i)),V(i,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":g}),a=C(i,c.inputId+"-tomselected")
let f="label[for='"+function(e){return e.replace(/['"\\]/g,"\\$&")}(c.inputId)+"']",v=document.querySelector(f)
if(v){V(v,{for:a}),V(n,{"aria-labelledby":C(v,c.inputId+"-ts-label")})}var m,y,O
c.settings.copyClassesToDropdown&&k(s,r),e.style.width=u.style.width,c.plugins.names.length&&(l="plugin-"+c.plugins.names.join(" plugin-"),k([e,s],l)),(null===p.maxItems||p.maxItems>1)&&c.is_select_tag&&V(u,{multiple:"multiple"}),c.settings.placeholder&&V(i,{placeholder:p.placeholder}),!c.settings.splitOn&&c.settings.delimiter&&(c.settings.splitOn=new RegExp("\\s*"+d(c.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=(m=this.settings.load,y=this.settings.loadThrottle,function(e,t){var i=this
O&&(i.loading=Math.max(i.loading-1,0)),clearTimeout(O),O=setTimeout((function(){O=null,i.loadedSearches[e]=!0,m.call(i,e,t)}),y)})),c.control=t,c.control_input=i,c.wrapper=e,c.dropdown=s,c.dropdown_content=n,c.control_input.type=u.type,w(s,"click",(e=>{const t=E(e.target,"[data-selectable]")
t&&c.onOptionSelect(e,t)})),w(t,"click",(e=>{var s=E(e.target,"."+c.settings.itemClass,t)
s&&c.onItemSelect(e,s)||""==i.value&&c.onClick(e)})),w(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),w(i,"keydown",(e=>c.onKeyDown(e))),w(i,"keyup",(e=>c.onKeyUp(e))),w(i,"keypress",(e=>c.onKeyPress(e))),w(i,"resize",(()=>c.positionDropdown()),h),w(i,"blur",(e=>c.onBlur(e))),w(i,"focus",(e=>c.onFocus(e))),w(i,"paste",(e=>c.onPaste(e)))
const I=t=>{if(!e.contains(t.target)&&!s.contains(t.target))return c.isFocused&&c.blur(),void c.inputState()
b(t,!0)}
var _=()=>{c.isOpen&&c.positionDropdown()}
w(document,"mousedown",I),w(window,"sroll",_,h),w(window,"resize",_,h),c._destroy=()=>{document.removeEventListener("mousedown",I),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:u.innerHTML,tabIndex:u.tabIndex},u.tabIndex=-1,V(u,{hidden:"hidden"}),u.insertAdjacentElement("afterend",c.wrapper),c.setValue(p.items),delete p.items,w(u,"invalid",(e=>{b(e),c.isInvalid||(c.isInvalid=!0,c.refreshState())})),c.updateOriginalInput(),c.refreshItems(),c.refreshState(),c.inputState(),c.isSetup=!0,u.disabled&&c.disable(),c.on("change",this.onChange),k(u,"tomselected"),c.trigger("initialize"),!0===p.preload&&c.load("")}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.isFocused&&t.isOpen?t.blur():t.focus()}onMouseDown(e){}onChange(){S(this.input,"input"),S(this.input,"change")}onPaste(e){var t=this
...
s.loading=Math.max(s.loading-1,0),s.lastQuery=null,s.clearActiveOption(),s.setupOptions(t,i),s.refreshOptions(s.isFocused&&!s.isInputHidden),s.loading||F(s.wrapper,s.settings.loadingClass),s.trigger("load",t,i)}setTextboxValue(e=""){var t=this.control_input
t.value!==e&&(t.value=e,S(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){O(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
if("single"!==a.settings.mode){if(!e)return a.clearActiveItems(),void(a.isFocused&&a.showInput())
if("click"===(i=t&&t.type.toLowerCase())&&I("shiftKey",t)&&a.activeItems.length){for(l=a.getLastActive(),(n=Array.prototype.indexOf.call(a.control.children,l))>(o=Array.prototype.indexOf.call(a.control.children,e))&&(r=n,n=o,o=r),s=n;s<=o;s++)e=a.control.children[s],-1===a.activeItems.indexOf(e)&&a.setActiveItemClass(e)
b(t)}else"click"===i&&I(f,t)||"keydown"===i&&I("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
a.hideInput(),a.isFocused||a.focus()}}setActiveItemClass(e){var t=this.control.querySelector(".last-active")
t&&F(t,"last-active"),k(e,"active last-active"),-1==this.activeItems.indexOf(e)&&this.activeItems.push(e)}removeActiveItem(e){var t=this.activeItems.indexOf(e)
this.activeItems.splice(t,1),F(e,"active")}clearActiveItems(){F(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,V(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),V(e,{"aria-selected":"true"}),k(e,"active"),this.scrollToOption(e)))}scrollToOption(e){var t,i,s
t=this.dropdown_content.clientHeight
let n=this.dropdown_content.scrollTop||0
i=e.offsetHeight,(s=e.getBoundingClientRect().top-this.dropdown_content.getBoundingClientRect().top+n)+i>t+n?this.dropdown_content.scrollTop=s-t+i:s<n&&(this.dropdown_content.scrollTop=s)}clearActiveOption(){this.activeOption&&(F(this.activeOption,"active"),this.activeOption.removeAttribute("aria-selected")),this.activeOption=null,this.control_input.removeAttribute("aria-activedescendant")}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(k(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,k(e.wrapper,"input-hidden")):(e.isInputHidden=!1,F(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
e.isDisabled||(e.ignoreFocus=!0,e.control_input.focus(),setTimeout((()=>{e.ignoreFocus=!1,e.onFocus()}),0))}blur(){this.control_input.blur(),this.onBlur(null)}getScoreFunction(e){return this.sifter.getScoreFunction(e,this.getSearchOptions())}getSearchOptions(){var e=this.settings,t=e.sortField
return"string"==typeof e.sortField&&(t=[{field:e.sortField}]),{fields:e.searchField,conjunction:e.searchConjunction,sort:t,nesting:e.nesting}}search(e){var t,i,s,n=this,o=n.settings,r=this.getSearchOptions()
...
return i}refreshOptions(e=!0){var t,i,s,n,o,r,l,a,d,c,p
const u={},h=[]
var f,v=this,y=v.inputValue(),O=v.search(y),b=v.activeOption,w=v.settings.shouldOpen||!1,I=v.dropdown_content
for(b&&(d=b.dataset.value,c=b.closest("[data-group]")),n=O.items.length,"number"==typeof v.settings.maxOptions&&(n=Math.min(n,v.settings.maxOptions)),n>0&&(w=!0),t=0;t<n;t++){let e=v.options[O.items[t].id],n=m(e[v.settings.valueField]),l=v.getOption(n)
for(l||(l=v.render("option",e)),v.settings.hideSelected||l.classList.toggle("selected",v.items.includes(n)),o=e[v.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],v.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),V(l,{id:e.$id+"-clone-"+i}),l.classList.add("ts-cloned"),F(l,"active"),l.removeAttribute("aria-selected")),d==n&&c&&c.dataset.group===o&&(b=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(v.optgroups[e]&&v.optgroups[e].$order||0)-(v.optgroups[t]&&v.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(v.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment()
e.append(v.render("optgroup_header",v.optgroups[o])),e.append(u[o])
let t=v.render("optgroup",{group:v.optgroups[o],options:e})
l.append(t)}else l.append(u[o])
if(I.innerHTML="",I.append(l),v.settings.highlight&&(f=document.querySelectorAll("span.highlight"),Array.prototype.forEach.call(f,(function(e,t){var i=e.parentNode
i.replaceChild(e.firstChild,e),i.normalize()})),O.query.length&&O.tokens.length))for(const e of O.tokens)g(I,e.regex)
var C=e=>{let t=v.render(e,{input:y})
return t&&(w=!0,I.insertBefore(t,I.firstChild)),t}
if(v.settings.shouldLoad.call(v,y)?v.loading?C("loading"):0===O.items.length&&C("no_results"):C("not_loading"),(a=v.canCreate(y))&&(p=C("option_create")),v.hasOptions=O.items.length>0||a,w){if(O.items.length>0){if(!I.contains(b)&&"single"===v.settings.mode&&v.items.length&&(b=v.getOption(v.items[0])),!I.contains(b)){let e=0
p&&!v.settings.addPrecedence&&(e=1),b=v.selectable()[e]}}else b=p
e&&!v.isOpen&&v.open(),v.setActiveOption(b)}else v.clearActiveOption(),e&&v.isOpen&&v.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
var s,n
e=m(e)
const o=m(t[i.settings.valueField]),r=i.getOption(e),l=i.getItem(e)
if(null!==e&&i.options.hasOwnProperty(e)){if("string"!=typeof o)throw new Error("Value must be set in option data")
if(t.$order=t.$order||i.options[e].$order,delete i.options[e],i.uncacheValue(o),i.uncacheValue(e,!1),i.options[o]=t,r){if(i.dropdown_content.contains(r)){const e=i.render("option",t)
r.parentNode.replaceChild(e,r),i.activeOption===r&&i.setActiveOption(e)}r.remove()}l&&(-1!==(n=i.items.indexOf(e))&&i.items.splice(n,1,o),s=i.render("item",t),l.classList.contains("active")&&k(s,"active"),l.parentNode.replaceChild(s,l)),i.lastQuery=null}}removeOption(e,t){var i=this
e=m(e),i.uncacheValue(e),delete i.userOptions[e],delete i.options[e],i.lastQuery=null,i.trigger("option_remove",e),i.removeItem(e,t)}clearOptions(){this.loadedSearches={},this.userOptions={},this.clearCache()
var e={}
...
t&&t.remove()}}getOption(e){return e=m(e),this.rendered("option",e)}getAdjacent(e,t,i="option"){var s
if(e){s="item"==i?this.controlChildren():this.dropdown_content.querySelectorAll("[data-selectable]")
for(let i=0;i<s.length;i++)if(s[i]==e)return t>0?s[i+1]:s[i-1]}}getItem(e){e=m(e)
var t=this.rendered("item",e)
if(t&&this.control.contains(t))return t}addItems(e,t){var i=this
...
o&&(e=m(o.dataset.value),-1!==(i=n.items.indexOf(e))&&(o.remove(),o.classList.contains("active")&&(s=n.activeItems.indexOf(o),n.activeItems.splice(s,1),F(o,"active")),n.items.splice(i,1),n.lastQuery=null,!n.settings.persist&&n.userOptions.hasOwnProperty(e)&&n.removeOption(e,t),i<n.caretPos&&n.setCaret(n.caretPos-1),n.updateOriginalInput({silent:t}),n.refreshState(),n.positionDropdown(),n.trigger("item_remove",e,o)))}createItem(e,t=!0,i){var s,n=this,o=n.caretPos
...
n=A('<option value="'+y(i)+'">'+y(e)+"</option>"),s.options[i].$option=n}n.selected=!0,V(n,{selected:"true"}),s.input.prepend(n)}else s.input.value=s.getValue()
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,F(e.input,"tomselected"),e.input.removeAttribute("hidden"),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){var i,s,n=this
if(("option"===e||"item"===e)&&(i=m(t[n.settings.valueField]),s=n.rendered(e,i)))return s
var o=n.settings.render[e]
return"function"!=typeof o?null:(s=o.call(this,t,y))?(s=A(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?V(s,{"aria-disabled":"true"}):V(s,{"data-selectable":""}):"optgroup"===e&&(V(s,{"data-group":t.group[n.settings.optgroupValueField]}),t.group[n.settings.disabledField]&&V(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(V(s,{"data-value":i}),"item"===e?k(s,n.settings.itemClass):(k(s,n.settings.optionClass),V(s,{role:"option",id:t.$id})),n.renderCache[e][i]=s),s):s}rendered(e,t){if(this.renderCache[e].hasOwnProperty(t))return this.renderCache[e][t]}clearCache(e){var t=this
for(let e in t.options){const i=t.getOption(e)
i&&i.remove()}void 0===e?t.renderCache={item:{},option:{}}:t.renderCache[e]={}}canCreate(e){return this.settings.create&&e.length&&this.settings.createFilter.call(this,e)}hook(e,t,i){var s=this,n=s[t]
s[t]=function(){var t,o
return"after"===e&&(t=n.apply(s,arguments)),o=i.apply(s,arguments),"instead"===e?o:("before"===e&&(t=n.apply(s,arguments)),t)}}}return N.define("change_listener",(function(e){var t=this,i=!1
w(t.input,"change",(()=>{if(i)i=!1
else{i=!0
var e=_(t.input,{})
t.setupOptions(e.options,e.optgroups),t.setValue(e.items)}}))})),N.define("checkbox_options",(function(e){var t=this,i=t.onOptionSelect
t.settings.hideSelected=!1
var s=function(e){setTimeout((()=>{var t=e.querySelector("input")
e.classList.contains("selected")?t.checked=!0:t.checked=!1}),1)}
t.hook("after","setupTemplates",(()=>{var e=t.settings.render.option
t.settings.render.option=function(i){var s=A(e.apply(t,arguments)),n=document.createElement("input")
...
i&&(i.classList.remove("selected"),s(i))})),t.hook("instead","onOptionSelect",(function(e,n){if(n.classList.contains("selected"))return n.classList.remove("selected"),t.removeItem(n.dataset.value),t.refreshOptions(),void b(e,!0)
i.apply(t,arguments),s(n)}))})),N.define("clear_button",(function(e){var t=this
e=Object.assign({className:"clear-button",title:"Clear All",html:e=>`<div class="${e.className}" title="${e.title}">&times;</div>`},e),t.hook("after","setup",(()=>{var i=A(e.html(e))
i.addEventListener("click",(e=>{for(;t.items.length>0;)t.removeItem(t.items[0],!0)
t.updateOriginalInput(),e.preventDefault(),e.stopPropagation()})),t.control.appendChild(i)}))})),N.define("drag_drop",(function(e){var t=this
...
var i=[]
e.children("[data-value]").each((function(){i.push($(this).attr("data-value"))})),t.setValue(i)}})}))}})),N.define("dropdown_header",(function(e){var t=this
e=Object.assign({title:"Untitled",headerClass:"dropdown-header",titleRowClass:"dropdown-header-title",labelClass:"dropdown-header-label",closeClass:"dropdown-header-close",html:e=>'<div class="'+e.headerClass+'"><div class="'+e.titleRowClass+'"><span class="'+e.labelClass+'">'+e.title+'</span><a class="'+e.closeClass+'">&times;</a></div></div>'},e),t.hook("after","setup",(()=>{var i=A(e.html(e)),s=i.querySelector("."+e.closeClass)
s&&s.addEventListener("click",(e=>{b(e,!0),t.close()})),t.dropdown.insertBefore(i,t.dropdown.firstChild)}))})),N.define("dropdown_input",(function(){var e=this,t=e.settings.controlInput||'<input type="text" autocomplete="off" class="dropdown-input" />'
t=A(t),e.settings.placeholder&&V(t,{placeholder:e.settings.placeholder}),e.settings.controlInput=t,e.settings.shouldOpen=!0,e.hook("after","setup",(()=>{V(e.wrapper,{tabindex:e.input.disabled?"-1":e.tabIndex}),w(e.wrapper,"keypress",(t=>{if(!e.control.contains(t.target)&&!e.dropdown.contains(t.target))switch(t.keyCode){case 13:return void e.onClick(t)}}))
let i=A('<div class="dropdown-input-wrap">')
i.appendChild(t),e.dropdown.insertBefore(i,e.dropdown.firstChild)}))})),N.define("input_autogrow",(function(){var e=this
...
s(),e.on("update item_add item_remove",s),w(i,"input",s),w(i,"keyup",s),w(i,"blur",s),w(i,"update",s)}))})),N.define("no_backspace_delete",(function(){var e=this,t=e.deleteSelection
this.hook("instead","deleteSelection",(function(){return!!e.activeItems.length&&t.apply(e,arguments)}))})),N.define("no_active_items",(function(e){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),N.define("optgroup_columns",(function(){var e=this,t=e.onKeyDown
e.hook("instead","onKeyDown",(function(i){var s,n,o,r
if(!e.isOpen||37!==i.keyCode&&39!==i.keyCode)return t.apply(e,arguments)
r=E(e.activeOption,"[data-group]"),s=q(e.activeOption,"[data-selectable]"),(r=37===i.keyCode?r.previousSibling:r.nextSibling)&&(n=(o=r.querySelectorAll("[data-selectable]"))[Math.min(o.length-1,s)])&&e.setActiveOption(n)}))})),N.define("remove_button",(function(e){e=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var t=this
...
s&&t.setTextboxValue(e.text.call(t,s))}}))})),N.define("virtual_scroll",(function(e){const t=this,i=t.canLoad,s=t.clearActiveOption,n=t.loadCallback
var o,r={},l=!1
if(!t.settings.firstUrl)throw"virtual_scroll plugin requires a firstUrl() method"
function a(e){if(!("number"==typeof t.settings.maxOptions&&o.children.length>=t.settings.maxOptions))return!(!(e in r)||!r[e])}t.settings.sortField=[{field:"$order"},{field:"$score"}],t.setNextUrl=function(e,t){r[e]=t},t.getUrl=function(e){if(e in r){const t=r[e]
return r[e]=!1,t}return r={},t.settings.firstUrl(e)},t.hook("instead","clearActiveOption",(()=>{if(!l)return s.call(t)})),t.hook("instead","canLoad",(e=>e in r?a(e):i.call(this,e))),t.hook("instead","loadCallback",((e,i,s)=>{l||t.clearOptions(),n.call(t,e,i,s),l=!1})),t.hook("after","refreshOptions",(()=>{const e=t.lastValue
var i
a(e)?(i=t.render("loading_more",{query:e}))&&i.setAttribute("data-selectable",""):e in r&&!o.querySelector(".no-results")&&(i=t.render("no_more_results",{query:e})),i&&(k(i,t.settings.optionClass),o.append(i))})),t.hook("after","setup",(()=>{o=t.dropdown_content,t.settings.render=Object.assign({},{loading_more:function(e,t){return'<div class="loading-more-results">Loading more results ... </div>'},no_more_results:function(e,t){return'<div class="no-more-results">No more results</div>'}},t.settings.render),o.addEventListener("scroll",(function(){o.clientHeight/(o.scrollHeight-o.scrollTop)<.95||a(t.lastValue)&&(l||(l=!0,t.load.call(t,t.lastValue)))}))}))})),N}))
