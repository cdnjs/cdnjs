...
return e?-1===(n=(e+="").search(t.regex))?0:(s=t.string.length/e.length,0===n&&(s+=.5),s*i):0},v=e=>(e+"").replace(/([\$\(-\+\.\?\[-\^\{-\}])/g,"\\$1"),f=(e,t)=>{var i=e[t]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},_=(e,t)=>{Object.assign(e.style,t)},S=(e,...t)=>{var i=C(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},A=(e,...t)=>{var i=C(t);(e=F(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},C=e=>{var t=[]
return y(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\11\12\14\15\40]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},F=e=>(Array.isArray(e)||(e=[e]),e),x=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
...
function G(e,t){var i=Object.assign({},$,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=e.tagName.toLowerCase(),p=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
if(!p&&!i.allowEmptyOption){let t=e.querySelector('option[value=""]')
t&&(p=t.textContent)}var u,h,g,m,v,f,O={placeholder:p,options:[],optgroups:[],items:[],maxItems:null}
return"select"===d?(h=O.options,g={},m=1,v=e=>{var t=Object.assign({},e.dataset),i=s&&t[s]
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},f=(e,t)=>{var s=j(e.value)
...
"optgroup"===(u=e.tagName.toLowerCase())?((s=v(t=e))[a]=s[a]||t.getAttribute("label")||"",s[c]=s[c]||m++,s[r]=s[r]||t.disabled,O.optgroups.push(s),i=s[c],y(t.children,(e=>{f(e,i)}))):"option"===u&&f(e)}))):(()=>{const t=e.getAttribute(s)
if(t)O.options=JSON.parse(t),y(O.options,(e=>{O.items.push(e[o])}))
else{var r=e.value.trim()||""
if(!i.allowEmptyOption&&!r.length)return
const t=r.split(i.delimiter)
y(t,(e=>{const t={}
t[n]=e,t[o]=e,O.options.push(t)})),O.items=t}})(),Object.assign({},$,O,t)}var J=0
...
const n=G(s,t)
this.settings=n,this.input=s,this.tabIndex=s.tabIndex||0,this.is_select_tag="select"===s.tagName.toLowerCase(),this.rtl=/rtl/i.test(i),this.inputId=M(s,"tomselect-"+J),this.isRequired=s.required,this.sifter=new w(this.options,{diacritics:n.diacritics}),n.mode=n.mode||(1===n.maxItems?"single":"multi"),"boolean"!=typeof n.hideSelected&&(n.hideSelected="multi"===n.mode),"boolean"!=typeof n.hidePlaceholder&&(n.hidePlaceholder="multi"!==n.mode)
...
var u
if(S(r,n.wrapperClass,d,p),S(l,n.controlClass),Q(r,l),S(a,n.dropdownClass,p),n.copyClassesToDropdown&&S(a,d),S(c,n.dropdownContentClass),Q(a,c),b(n.dropdownParent||r).appendChild(a),n.hasOwnProperty("controlInput"))n.controlInput?(u=b(n.controlInput),this.focus_node=u):(u=b("<input/>"),this.focus_node=l)
else{u=b('<input type="text" autocomplete="off" size="1" />')
...
S([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&P(l,{multiple:"multiple"}),e.settings.placeholder&&P(i,{placeholder:t.placeholder}),!e.settings.splitOn&&e.settings.delimiter&&(e.settings.splitOn=new RegExp("\\s*"+v(e.settings.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=N(t.load,t.loadThrottle)),e.control_input.type=l.type,z(s,"click",(t=>{const i=x(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),H(t,!0))})),z(r,"click",(t=>{var s=x(t.target,"[data-ts-item]",r)
s&&e.onItemSelect(t,s)?H(t,!0):""==i.value&&(e.onClick(),H(t,!0))})),z(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),z(a,"keydown",(t=>e.onKeyDown(t))),z(i,"keypress",(t=>e.onKeyPress(t))),z(i,"input",(t=>e.onInput(t))),z(a,"resize",(()=>e.positionDropdown()),c),z(a,"blur",(t=>e.onBlur(t))),z(a,"focus",(t=>e.onFocus(t))),z(a,"paste",(t=>e.onPaste(t)))
...
z(document,"mousedown",m),z(window,"scroll",f,c),z(window,"resize",f,c),this._destroy=()=>{document.removeEventListener("mousedown",m),window.removeEventListener("sroll",f),window.removeEventListener("resize",f),h&&h.removeEventListener("click",g)},this.revertSettings={innerHTML:l.innerHTML,tabIndex:l.tabIndex},l.tabIndex=-1,l.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,z(l,"invalid",(t=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,l.disabled?e.disable():e.enable(),e.on("change",this.onChange),S(l,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),y(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
const u={},h=[]
var g,m=this,v=m.inputValue(),f=m.search(v),O=m.activeOption,w=m.settings.shouldOpen||!1,b=m.dropdown_content
for(O&&(c=O.dataset.value,d=O.closest("[data-group]")),n=f.items.length,"number"==typeof m.settings.maxOptions&&(n=Math.min(n,m.settings.maxOptions)),n>0&&(w=!0),t=0;t<n;t++){let e=f.items[t].id,n=m.options[e],l=m.getOption(e,!0)
for(m.settings.hideSelected||l.classList.toggle("selected",m.items.includes(e)),o=n[m.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],m.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),P(l,{id:n.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),A(l,"active")),c==e&&d&&d.dataset.group===o&&(O=l),u[o].appendChild(l)}this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(m.optgroups[e]&&m.optgroups[e].$order||0)-(m.optgroups[t]&&m.optgroups[t].$order||0))),l=document.createDocumentFragment(),y(h,(e=>{if(m.optgroups.hasOwnProperty(e)&&u[e].children.length){let t=document.createDocumentFragment(),i=m.render("optgroup_header",m.optgroups[e])
Q(t,i),Q(t,u[e])
let s=m.render("optgroup",{group:m.optgroups[e],options:t})
Q(l,s)}else Q(l,u[e])})),b.innerHTML="",Q(b,l),m.settings.highlight&&(g=b.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),f.query.length&&f.tokens.length&&y(f.tokens,(e=>{T(b,e.regex)})))
var I=e=>{let t=m.render(e,{input:v})
return t&&(w=!0,b.insertBefore(t,b.firstChild)),t}
if(m.loading?I("loading"):m.settings.shouldLoad.call(m,v)?0===f.items.length&&I("no_results"):I("not_loading"),(a=m.canCreate(v))&&(p=I("option_create")),m.hasOptions=f.items.length>0||a,w){if(f.items.length>0){if(!b.contains(O)&&"single"===m.settings.mode&&m.items.length&&(O=m.getOption(m.items[0])),!b.contains(O)){let e=0
p&&!m.settings.addPrecedence&&(e=1),O=m.selectable()[e]}}else p&&(O=p)
e&&!m.isOpen&&(m.open(),m.scrollToOption(O,"auto")),m.setActiveOption(O)}else m.clearActiveOption(),e&&m.isOpen&&m.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e,t=!1){const i=this
if(Array.isArray(e))return i.addOptions(e,t),!1
const s=j(e[i.settings.valueField])
...
var s,n
const o=j(e),r=j(t[i.settings.valueField])
if(null===o)return
if(!i.options.hasOwnProperty(o))return
if("string"!=typeof r)throw new Error("Value must be set in option data")
const l=i.getOption(o),a=i.getItem(o)
if(t.$order=t.$order||i.options[o].$order,delete i.options[o],i.uncacheValue(r),i.options[r]=t,l){if(i.dropdown_content.contains(l)){const e=i._render("option",t)
E(l,e),i.activeOption===l&&i.setActiveOption(e)}l.remove()}a&&(-1!==(n=i.items.indexOf(o))&&i.items.splice(n,1,r),s=i._render("item",t),a.classList.contains("active")&&S(s,"active"),E(a,s)),i.lastQuery=null}removeOption(e,t){const i=this
...
var e={}
y(this.options,((t,i)=>{this.items.indexOf(i)>=0&&(e[i]=this.options[i])})),this.options=this.sifter.items=e,this.lastQuery=null,this.trigger("option_clear")}getOption(e,t=!1){const i=j(e)
...
function o(i,s,o){return i||(i=b('<option value="'+D(s)+'">'+D(o)+"</option>")),i!=n&&t.input.append(i),e.push(i),i.selected=!0,i}t.input.querySelectorAll("option:checked").forEach((e=>{e.selected=!1})),0==t.items.length&&"single"==t.settings.mode?o(n,"",""):t.items.forEach((n=>{if(i=t.options[n],s=i[t.settings.labelField]||"",e.includes(i.$option)){o(t.input.querySelector(`option[value="${B(n)}"]:not(:checked)`),n,s)}else i.$option=o(i.$option,n,s)}))}else t.input.value=t.getValue()
...
const o=this
return"option"!==e&&"item"!=e||(n=q(t[o.settings.valueField])),null==(s=o.settings.render[e].call(this,t,D))||(s=b(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?P(s,{"aria-disabled":"true"}):P(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],P(s,{"data-group":i}),t.group[o.settings.disabledField]&&P(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(P(s,{"data-value":n}),"item"===e?(S(s,o.settings.itemClass),P(s,{"data-ts-item":""})):(S(s,o.settings.optionClass),P(s,{role:"option",id:t.$id}),o.options[n].$div=s))),s}clearCache(){y(this.options,((e,t)=>{e.$div&&(e.$div.remove(),delete e.$div)}))}uncacheValue(e){const t=this.getOption(e)
