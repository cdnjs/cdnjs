...
return t.innerHTML=e.trim(),t.firstChild}return document.querySelector(e)},m=(e,t)=>{var i=document.createEvent("HTMLEvents")
i.initEvent(t,!0,!1),e.dispatchEvent(i)},f=(e,t)=>{Object.assign(e.style,t)},v=(e,...t)=>{var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},y=(e,...t)=>{var i=O(t);(e=b(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},O=e=>{var t=[]
...
super(),this.order=0,this.tab_key=!1,this.isOpen=!1,this.isDisabled=!1,this.isInvalid=!1,this.isLocked=!1,this.isFocused=!1,this.isInputHidden=!1,this.isSetup=!1,this.ignoreFocus=!1,this.hasOptions=!1,this.lastValue="",this.caretPos=0,this.loading=0,this.loadedSearches={},this.activeOption=null,this.activeItems=[],this.optgroups={},this.options={},this.userOptions={},this.items=[],this.renderCache={item:{},option:{}},R++
var s=g(e),n=this
...
return"string"==typeof i&&i.length&&(t=Object.assign(t,JSON.parse(i))),t},m=(e,t)=>{var s=k(e.value)
...
var r,l,a,d,p,u,m,f,y
t=n.settings,s=n.input
const O={passive:!0},b=n.inputId+"-ts-dropdown"
if(u=n.settings.mode,m=s.getAttribute("class")||"",r=g("<div>"),v(r,t.wrapperClass,m,u),l=g('<div class="items">'),v(l,t.inputClass),N(r,l),d=n._render("dropdown"),v(d,t.dropdownClass,u),p=g(`<div role="listbox" id="${b}" tabindex="-1">`),v(p,t.dropdownContentClass),N(d,p),g(t.dropdownParent||r).appendChild(d),t.controlInput)a=g(t.controlInput)
...
e.isFocused&&e.isOpen?e.blur():e.focus()}onMouseDown(){}onChange(){m(this.input,"input"),m(this.input,"change")}onPaste(e){var t=this
...
t.value!==e&&(t.value=e,m(t,"update"),this.lastValue=e)}getValue(){return this.is_select_tag&&this.input.hasAttribute("multiple")?this.items:this.items.join(this.settings.delimiter)}setValue(e,t){T(this,t?[]:["change"],(()=>{this.clear(t),this.addItems(e,t)}))}setMaxItems(e){0===e&&(e=null),this.settings.maxItems=e,this.refreshState()}setActiveItem(e,t){var i,s,n,o,r,l,a=this
...
this.activeItems.splice(t,1),y(e,"active")}clearActiveItems(){y(this.activeItems,"active"),this.activeItems=[]}setActiveOption(e){e!==this.activeOption&&(this.clearActiveOption(),e&&(this.activeOption=e,_(this.control_input,{"aria-activedescendant":e.getAttribute("id")}),_(e,{"aria-selected":"true"}),v(e,"active"),this.scrollToOption(e)))}scrollToOption(e,t){if(!e)return
const i=this.dropdown_content,s=i.clientHeight,n=i.scrollTop||0,o=e.offsetHeight,r=e.getBoundingClientRect().top-i.getBoundingClientRect().top+n
r+o>s+n?this.scroll(r-s+o,t):r<n&&this.scroll(r,t)}scroll(e,t){const i=this.dropdown_content
t&&(i.style.scrollBehavior=t),i.scrollTop=e,i.style.scrollBehavior=""}clearActiveOption(){this.activeOption&&(y(this.activeOption,"active"),_(this.activeOption,{"aria-selected":null})),this.activeOption=null,_(this.control_input,{"aria-activedescendant":null})}selectAll(){"single"!==this.settings.mode&&(this.activeItems=this.controlChildren(),this.activeItems.length&&(v(this.activeItems,"active"),this.hideInput(),this.close()),this.focus())}inputState(){var e=this
e.settings.controlInput||(e.activeItems.length>0||!e.isFocused&&this.settings.hidePlaceholder&&e.items.length>0?(e.setTextboxValue(),e.isInputHidden=!0,v(e.wrapper,"input-hidden")):(e.isInputHidden=!1,y(e.wrapper,"input-hidden")))}hideInput(){this.inputState()}showInput(){this.inputState()}inputValue(){return this.control_input.value.trim()}focus(){var e=this
...
const u={},h=[]
var g,m=this,f=m.inputValue(),v=m.search(f),O=m.activeOption,b=m.settings.shouldOpen||!1,w=m.dropdown_content
for(O&&(c=O.dataset.value,d=O.closest("[data-group]")),n=v.items.length,"number"==typeof m.settings.maxOptions&&(n=Math.min(n,m.settings.maxOptions)),n>0&&(b=!0),t=0;t<n;t++){let e=m.options[v.items[t].id],n=P(e[m.settings.valueField]),l=m.getOption(n)
for(l||(l=m._render("option",e)),m.settings.hideSelected||l.classList.toggle("selected",m.items.includes(n)),o=e[m.settings.optgroupField]||"",i=0,s=(r=Array.isArray(o)?o:[o])&&r.length;i<s;i++)o=r[i],m.optgroups.hasOwnProperty(o)||(o=""),u.hasOwnProperty(o)||(u[o]=document.createDocumentFragment(),h.push(o)),i>0&&(l=l.cloneNode(!0),_(l,{id:e.$id+"-clone-"+i,"aria-selected":null}),l.classList.add("ts-cloned"),y(l,"active")),c==n&&d&&d.dataset.group===o&&(O=l),u[o].appendChild(l)}for(o of(this.settings.lockOptgroupOrder&&h.sort(((e,t)=>(m.optgroups[e]&&m.optgroups[e].$order||0)-(m.optgroups[t]&&m.optgroups[t].$order||0))),l=document.createDocumentFragment(),h))if(m.optgroups.hasOwnProperty(o)&&u[o].children.length){let e=document.createDocumentFragment(),t=m.render("optgroup_header",m.optgroups[o])
N(e,t),N(e,u[o])
let i=m.render("optgroup",{group:m.optgroups[o],options:e})
N(l,i)}else N(l,u[o])
if(w.innerHTML="",N(w,l),m.settings.highlight&&(g=w.querySelectorAll("span.highlight"),Array.prototype.forEach.call(g,(function(e){var t=e.parentNode
t.replaceChild(e.firstChild,e),t.normalize()})),v.query.length&&v.tokens.length))for(const e of v.tokens)A(w,e.regex)
var I=e=>{let t=m.render(e,{input:f})
return t&&(b=!0,w.insertBefore(t,w.firstChild)),t}
if(m.settings.shouldLoad.call(m,f)?m.loading?I("loading"):0===v.items.length&&I("no_results"):I("not_loading"),(a=m.canCreate(f))&&(p=I("option_create")),m.hasOptions=v.items.length>0||a,b){if(v.items.length>0){if(!w.contains(O)&&"single"===m.settings.mode&&m.items.length&&(O=m.getOption(m.items[0])),!w.contains(O)){let e=0
p&&!m.settings.addPrecedence&&(e=1),O=m.selectable()[e]}}else p&&(O=p)
e&&!m.isOpen&&(m.open(),m.scrollToOption(O,"auto")),m.setActiveOption(O)}else m.clearActiveOption(),e&&m.isOpen&&m.close(!1)}selectable(){return this.dropdown_content.querySelectorAll("[data-selectable]")}addOption(e){var t,i=this
...
const o=this
return("option"===e||"item"===e)&&(n=P(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,L))||(s=g(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?_(s,{"aria-disabled":"true"}):_(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],_(s,{"data-group":i}),t.group[o.settings.disabledField]&&_(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(_(s,{"data-value":n}),"item"===e?v(s,o.settings.itemClass):(v(s,o.settings.optionClass),_(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
