...
return i},A=(e,t)=>{for(const i in t){let s=t[i]
null==s?e.removeAttribute(i):e.setAttribute(i,s)}},S=(e,t)=>{e.parentNode&&e.parentNode.replaceChild(t,e)},_=(e,t)=>{if(null===t)return
...
for(const e of["autocorrect","autocapitalize","autocomplete"])s.getAttribute(e)&&A(a,{[e]:s.getAttribute(e)})}t.controlInput||(a.tabIndex=s.disabled?-1:n.tabIndex,l.appendChild(a)),A(a,{role:"combobox",haspopup:"listbox","aria-expanded":"false","aria-controls":b}),y=$(a,n.inputId+"-tomselected")
let I="label[for='"+(e=>e.replace(/['"\\]/g,"\\$&"))(n.inputId)+"']",C=document.querySelector(I)
if(C){A(C,{for:y})
let e=$(C,n.inputId+"-ts-label")
A(p,{"aria-labelledby":e})}n.settings.copyClassesToDropdown&&v(d,m),r.style.width=s.style.width,n.plugins.names.length&&(f="plugin-"+n.plugins.names.join(" plugin-"),v([r,d],f)),(null===t.maxItems||t.maxItems>1)&&n.is_select_tag&&A(s,{multiple:"multiple"}),n.settings.placeholder&&A(a,{placeholder:t.placeholder}),!n.settings.splitOn&&n.settings.delimiter&&(n.settings.splitOn=new RegExp("\\s*"+c(n.settings.delimiter)+"+\\s*")),this.settings.load&&this.settings.loadThrottle&&(this.settings.load=E(this.settings.load,this.settings.loadThrottle)),this.control=l,this.control_input=a,this.wrapper=r,this.dropdown=d,this.dropdown_content=p,n.control_input.type=s.type,V(d,"click",(e=>{const t=w(e.target,"[data-selectable]")
...
q(e,!0)}
var _=()=>{n.isOpen&&n.positionDropdown()}
V(document,"mousedown",S),V(window,"sroll",_,O),V(window,"resize",_,O),this._destroy=()=>{document.removeEventListener("mousedown",S),window.removeEventListener("sroll",_),window.removeEventListener("resize",_)},this.revertSettings={innerHTML:s.innerHTML,tabIndex:s.tabIndex},s.tabIndex=-1,A(s,{hidden:"hidden"}),s.insertAdjacentElement("afterend",n.wrapper),n.setValue(t.items),t.items=[],V(s,"invalid",(e=>{q(e),n.isInvalid||(n.isInvalid=!0,n.refreshState())})),n.updateOriginalInput(),n.refreshItems(),n.close(!1),n.inputState(),n.isSetup=!0,s.disabled&&n.disable(),n.on("change",this.onChange),v(s,"tomselected"),n.trigger("initialize"),!0===t.preload&&n.load(""),n.setup()}setup(){}setupOptions(e=[],t=[]){for(const t of e)this.registerOption(t)
...
t.replaceChild(e.firstChild,e),t.normalize()})),v.query.length&&v.tokens.length))for(const e of v.tokens)_(w,e.regex)
...
function r(t,i,s){return t||(t=g('<option value="'+L(i)+'">'+L(s)+"</option>")),t.selected=!0,A(t,{selected:"true"}),N(e,t),t}if(t.input.querySelectorAll("option[selected]").forEach((e=>{A(e,{selected:null}),e.selected=!1})),0!=t.items.length||"single"!=t.settings.mode||t.isRequired)for(i=0;i<t.items.length;i++)if(s=t.items[i],o=(n=t.options[s])[t.settings.labelField]||"",e.contains(n.$option)){r(t.input.querySelector(`option[value="${j(s)}"]`),s,o)}else n.$option=r(n.$option,s,o)
else r(t.input.querySelector('option[value=""]'),"","")
t.input.prepend(e)}else t.input.value=t.getValue()
t.isSetup&&(e.silent||t.trigger("change",t.getValue()))}open(){var e=this
e.isLocked||e.isOpen||"multi"===e.settings.mode&&e.isFull()||(e.isOpen=!0,A(e.control_input,{"aria-expanded":"true"}),e.refreshState(),f(e.dropdown,{visibility:"hidden",display:"block"}),e.positionDropdown(),f(e.dropdown,{visibility:"visible",display:"block"}),e.focus(),e.trigger("dropdown_open",e.dropdown))}close(e=!0){var t=this,i=t.isOpen
e&&(t.setTextboxValue(),"single"===t.settings.mode&&t.items.length&&(t.hideInput(),t.tab_key||t.blur())),t.isOpen=!1,A(t.control_input,{"aria-expanded":"false"}),f(t.dropdown,{display:"none"}),t.settings.hideSelected&&t.clearActiveOption(),t.refreshState(),i&&t.trigger("dropdown_close",t.dropdown)}positionDropdown(){if("body"===this.settings.dropdownParent){var e=this.control,t=e.getBoundingClientRect(),i=e.offsetHeight+t.top+window.scrollY,s=t.left+window.scrollX
...
e.trigger("destroy"),e.off(),e.wrapper.remove(),e.dropdown.remove(),e.input.innerHTML=t.innerHTML,e.input.tabIndex=t.tabIndex,y(e.input,"tomselected"),A(e.input,{hidden:null}),e.input.required=this.isRequired,e._destroy(),delete e.input.tomselect}render(e,t){return"function"!=typeof this.settings.render[e]?null:this._render(e,t)}_render(e,t){var i,s,n=""
const o=this
return("option"===e||"item"===e)&&(n=P(t[o.settings.valueField]),s=o.rendered(e,n))||null==(s=o.settings.render[e].call(this,t,L))||(s=g(s),"option"===e||"option_create"===e?t[o.settings.disabledField]?A(s,{"aria-disabled":"true"}):A(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[o.settings.optgroupValueField],A(s,{"data-group":i}),t.group[o.settings.disabledField]&&A(s,{"data-disabled":""})),"option"!==e&&"item"!==e||(A(s,{"data-value":n}),"item"===e?v(s,o.settings.itemClass):(v(s,o.settings.optionClass),A(s,{role:"option",id:t.$id})),o.renderCache[e][n]=s)),s}rendered(e,t){return null!==t&&this.renderCache[e].hasOwnProperty(t)?this.renderCache[e][t]:null}clearCache(e){var t=this
