...
var p
if(m(o,t.wrapperClass,c,d),m(r,t.controlClass),z(o,r),m(l,t.dropdownClass,d),t.copyClassesToDropdown&&m(l,c),m(a,t.dropdownContentClass),z(l,a),g(t.dropdownParent||o).appendChild(l),t.hasOwnProperty("controlInput"))t.controlInput?(p=g(t.controlInput),this.focus_node=p):(p=g("<input/>"),this.focus_node=r)
...
s&&e.onItemSelect(t,s)?V(t,!0):""==i.value&&(e.onClick(),V(t,!0))})),q(i,"mousedown",(e=>{""!==i.value&&e.stopPropagation()})),q(a,"keydown",(t=>e.onKeyDown(t))),q(i,"keypress",(t=>e.onKeyPress(t))),q(i,"input",(t=>e.onInput(t))),q(a,"resize",(()=>e.positionDropdown()),d),q(a,"blur",(t=>e.onBlur(t))),q(a,"focus",(t=>e.onFocus(t))),q(a,"paste",(t=>e.onPaste(t)))
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!j(x,e)&&V(e)}}onInput(e){var t=this
