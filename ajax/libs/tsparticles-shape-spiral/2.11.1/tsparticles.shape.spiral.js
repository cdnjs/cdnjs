...
class SpiralDrawer {
  ...
  particleInit(container, particle) {
    ...
    particle.spiralInnerRadius = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(shapeData.innerRadius ?? 1) * pixelRatio;
    particle.spiralLineSpacing = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(shapeData.lineSpacing ?? 1) * pixelRatio;
    particle.spiralWidthFactor = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(shapeData.widthFactor ?? 10);
  }
}
