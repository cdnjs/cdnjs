...
a(56);f.merge=b.mergeStatic},function(b,f,a){function m(a,c){return a.reduce(function(a,d){return a.concat((c||Y).map(function(a){return a+d}))},[])}function h(a,c){return c.filter(function(c){var d;d=document.createElement(a.tagName);c="on"+c;c in d?d=!0:(d.setAttribute(c,"return;"),d="function"==typeof d[c]);return d})[0]}function k(c,d){var e=void 0;c=m(c,d);return function(d){return d instanceof ca?("undefined"==typeof e&&(e=h(d,c)||null),e?aa(d,e):L()):a.i(z.a)(d,c)}}function g(a){return!!W&&
W.isTypeSupported(a)}function e(){return G}function d(a){return"open"==a.readyState?C.Observable.of(null):ma(a).take(1)}function c(a){return a.readyState>=X?C.Observable.of(null):Z(a).take(1)}function l(c){return c.readyState>=O?C.Observable.of(null):a.i(z.a)(c,"canplay").take(1)}function n(c,d){function e(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};a.errorCode&&(a={systemCode:a.systemCode,code:a.errorCode.code});this.name="KeySessionError";this.mediaKeyError=a;this.message=
"MediaKeyError code:"+a.code+" and systemCode:"+a.systemCode}e.prototype=Error();return function(l,g){var k="function"==typeof d?d.call(this):this,b=ga(k),n=ea(k).map(function(a){throw new e(k.error||a);});try{return c.call(this,l,g),a.i(D.merge)(b,n).take(1)}catch(na){return C.Observable["throw"](na)}}}function q(a,c){if(c instanceof R)return c._setVideo(a);if(a.setMediaKeys)return a.setMediaKeys(c);if(null!==c){if(a.WebkitSetMediaKeys)return a.WebkitSetMediaKeys(c);if(a.mozSetMediaKeys)return a.mozSetMediaKeys(c);
if(a.msSetMediaKeys)return a.msSetMediaKeys(c)}}function t(a){v()||(a.requestFullscreen?a.requestFullscreen():a.msRequestFullscreen?a.msRequestFullscreen():a.mozRequestFullScreen?a.mozRequestFullScreen():a.webkitRequestFullscreen&&a.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT))}function p(){v()&&(E.exitFullscreen?E.exitFullscreen():E.msExitFullscreen?E.msExitFullscreen():E.mozCancelFullScreen?E.mozCancelFullScreen():E.webkitExitFullscreen&&E.webkitExitFullscreen())}function v(){return!!(E.fullscreenElement||
E.mozFullScreenElement||E.webkitFullscreenElement||E.msFullscreenElement)}function u(){var c=void 0;null!=E.hidden?c="":null!=E.mozHidden?c="moz":null!=E.msHidden?c="ms":null!=E.webkitHidden&&(c="webkit");var d=c?c+"Hidden":"hidden",c=c+"visibilitychange";return a.i(z.a)(E,c).map(function(){return E[d]})}function r(){return a.i(z.a)(K,"resize")}function w(a,c){var d,e=void 0;G?(d=a.textTracks.length,d=0<d?a.textTracks[d-1]:a.addTextTrack("subtitles"),d.mode=c?d.HIDDEN:d.SHOWING):(e=document.createElement("track"),
a.appendChild(e),d=e.track,e.kind="subtitles",d.mode=c?"hidden":"showing");return{track:d,trackElement:e}}function y(){return!G}function x(a){return ba&&"timeupdate"===a.name&&a.range&&10<a.range.end-a.ts}function A(a){a.src="";a.removeAttribute("src")}a.d(f,"a",function(){return S});a.d(f,"m",function(){return W});a.d(f,"k",function(){return g});a.d(f,"n",function(){return d});a.d(f,"o",function(){return c});a.d(f,"p",function(){return l});a.d(f,"h",function(){return V});a.d(f,"i",function(){return P});
a.d(f,"j",function(){return oa});a.d(f,"f",function(){return B});a.d(f,"g",function(){return e});a.d(f,"c",function(){return v});a.d(f,"b",function(){return fa});a.d(f,"e",function(){return t});a.d(f,"d",function(){return p});a.d(f,"v",function(){return r});a.d(f,"u",function(){return u});a.d(f,"r",function(){return w});a.d(f,"l",function(){return A});a.d(f,"s",function(){return y});a.d(f,"q",function(){return x});a.d(f,"t",function(){return G});b=a(7);b=a.n(b);var C=a(0);a.n(C);var D=a(10);a.n(D);
f=a(52);a.n(f);var H=a(145);a.n(H);var I=a(51);a.n(I);a(3);var T=a(30),F=a(12),M=a(1),z=a(13),U=a(6),Q=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(c,d,e){d&&a(c.prototype,d);e&&a(c,e);return c}}(),aa=f.FromEventObservable.create,L=H.NeverObservable.create,J=I.DeferObservable.create,E=document,K=window,Y=["","webkit","moz","ms"],ca=K.HTMLElement,S=K.HTMLVideoElement,
W=K.MediaSource||K.MozMediaSource||K.WebKitMediaSource||K.MSMediaSource,N=K.MediaKeys||K.MozMediaKeys||K.WebKitMediaKeys||K.MSMediaKeys,G="Microsoft Internet Explorer"==navigator.appName||"Netscape"==navigator.appName&&/(Trident|Edge)\//.test(navigator.userAgent),ba=-1!==navigator.userAgent.toLowerCase().indexOf("firefox"),X=1,O=4,R=function(){},P=void 0;navigator.requestMediaKeySystemAccess&&(P=function(c,d){return a.i(z.b)(navigator.requestMediaKeySystemAccess(c,d))});var V=function(){function a(c,
d,e){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this._keyType=c;this._mediaKeys=d;this._configuration=e}a.prototype.createMediaKeys=function(){return C.Observable.of(this._mediaKeys)};a.prototype.getConfiguration=function(){return this._configuration};Q(a,[{key:"keySystem",get:function(){return this._keyType}}]);return a}(),Z=k(["loadedmetadata"]),ma=k(["sourceopen","webkitsourceopen"]);f=k(["encrypted","needkey"]);var ha=k(["keymessage","message"]),ga=k(["keyadded",
"ready"]),ea=k(["keyerror","error"]),H=k(["keystatuseschange"]),B={onEncrypted:f,onKeyMessage:ha,onKeyStatusesChange:H,onKeyError:ea};if(!P&&S.prototype.webkitGenerateKeyRequest){var ia=function(c,d){var e=this;T.a.call(this);this.sessionId="";this._vid=c;this._key=d;this._con=a.i(D.merge)(ha(c),ga(c),ea(c)).subscribe(function(a){return e.trigger(a.type,a)})};ia.prototype=b()({generateRequest:function(a,c){this._vid.webkitGenerateKeyRequest(this._key,c)},update:n(function(c,d){if(0<=this._key.indexOf("clearkey")){var e=
JSON.parse(a.i(F.a)(c)),l=a.i(F.b)(atob(e.keys[0].k)),e=a.i(F.b)(atob(e.keys[0].kid));this._vid.webkitAddKey(this._key,l,e,d)}else this._vid.webkitAddKey(this._key,c,null,d);this.sessionId=d}),close:function(){this._con&&this._con.unsubscribe();this._vid=this._con=null}},T.a.prototype);R=function(a){this.ks_=a};R.prototype={_setVideo:function(a){this._vid=a},createSession:function(){return new ia(this._vid,this.ks_)}};var pa=function(a){var c=E.querySelector("video")||E.createElement("video");return c&&
c.canPlayType?!!c.canPlayType("video/mp4",a):!1},P=function(a,c){if(!pa(a))return C.Observable["throw"]();for(var d=0;d<c.length;d++){var e=c[d],l=e.videoCapabilities,g=e.audioCapabilities,k=e.initDataTypes,b=e.sessionTypes,n=e.distinctiveIdentifier,e=e.persistentState,h=!0;if(h=(h=(h=(h=h&&(!k||!!k.filter(function(a){return"cenc"===a})[0]))&&(!b||b.filter(function(a){return"temporary"===a}).length===b.length))&&"required"!==n)&&"required"!==e)return d={videoCapabilities:l,audioCapabilities:g,initDataTypes:["cenc"],
distinctiveIdentifier:"not-allowed",persistentState:"not-allowed",sessionTypes:["temporary"]},C.Observable.of(new V(a,new R(a),d))}return C.Observable["throw"]()}}else if(N&&!P){var ja=function(a){T.a.call(this);this.sessionId="";this._mk=a};ja.prototype=b()({generateRequest:function(c,d){var e=this;this._ss=this._mk.memCreateSession("video/mp4",d);this._con=a.i(D.merge)(ha(this._ss),ga(this._ss),ea(this._ss)).subscribe(function(a){return e.trigger(a.type,a)})},update:n(function(c,d){a.i(M.a)(this._ss);
this._ss.update(c,d);this.sessionId=d},function(){return this._ss}),close:function(){this._ss&&(this._ss.close(),this._ss=null);this._con&&(this._con.unsubscribe(),this._con=null)}},T.a.prototype);N.prototype.alwaysRenew=!0;N.prototype.memCreateSession=N.prototype.createSession;N.prototype.createSession=function(){return new ja(this)};P=function(a,c){if(!N.isTypeSupported(a))return C.Observable["throw"]();for(var d=0;d<c.length;d++){var e=c[d],l=e.videoCapabilities,g=e.audioCapabilities,k=e.initDataTypes,
e=e.distinctiveIdentifier,b=!0;if(b=(b=b&&(!k||!!k.filter(function(a){return"cenc"===a})[0]))&&"required"!==e)return d={videoCapabilities:l,audioCapabilities:g,initDataTypes:["cenc"],distinctiveIdentifier:"not-allowed",persistentState:"required",sessionTypes:["temporary","persistent-license"]},C.Observable.of(new V(a,new N(a),d))}return C.Observable["throw"]()}}N||(b=function(){throw new U.d("MEDIA_KEYS_NOT_SUPPORTED",null,!0);},N={create:b,isTypeSupported:b});var oa=function(c,d){return J(function(){return a.i(z.b)(q(c,
d))})};if(K.WebKitSourceBuffer&&!K.WebKitSourceBuffer.prototype.addEventListener){b=K.WebKitSourceBuffer.prototype;for(var ka in T.a.prototype)b[ka]=T.a.prototype[ka];b.__listeners=[];b.appendBuffer=function(a){if(this.updating)throw Error("updating");this.trigger("updatestart");this.updating=!0;try{this.append(a)}catch(la){this.__emitUpdate("error",la);return}this.__emitUpdate("update")};b.__emitUpdate=function(a,c){var d=this;setTimeout(function(){d.trigger(a,c);d.updating=!1;d.trigger("updateend")},
0)}}var fa=k(["fullscreenchange","FullscreenChange"],Y.concat("MS"))},function(b,f,a){function m(a){for(var c=a.length,d=new Uint8Array(c),e=0;e<c;e++)d[e]=a.charCodeAt(e)&255;return d}function h(a){return String.fromCharCode.apply(null,a)}function k(a){for(var c="",d=a.length,e=0;e<d;e+=2)c+=String.fromCharCode(a[e]);return c}function g(a){for(var c=a.length,d=new Uint8Array(c/2),e=0,l=0;e<c;e+=2,l++)d[l]=parseInt(a.substr(e,2),16)&255;return d}function e(a,c){c||(c="");for(var d="",e=0;e<a.byteLength;e++)d+=
...
typeof c);a.prototype=Object.create(c&&c.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});c&&(Object.setPrototypeOf?Object.setPrototypeOf(a,c):a.__proto__=c)}function k(a,c){if(!(a instanceof c))throw new TypeError("Cannot call a class as a function");}function g(a){if("number"==typeof a)return a;for(var c=0,d,e=0;e<a.length;e++)d=a[e],c=(c<<5)-c+d,c&=c;return c}function e(a,c,d){return{type:"eme",value:H()({name:a,session:c},d)}}function d(c){if(!V||!R||a.i(L.g)())return null;
var d=P;return(c=c.filter(function(a){return a.type!==V.type||a.persistentLicense&&"required"!=d.persistentState||a.distinctiveIdentifierRequired&&"required"!=d.distinctiveIdentifier?!1:!0})[0])?{keySystem:c,keySystemAccess:new L.h(V,R,P)}:null}function c(a){var c=["temporary"],d="optional",e="optional";a.persistentLicense&&(d="required",c.push("persistent-license"));a.persistentStateRequired&&(d="required");a.distinctiveIdentifierRequired&&(e="required");var b=a.audioRobustnesses||G;a=(a.videoRobustnesses||
G).map(function(a){return{contentType:'video/mp4;codecs="avc1.4d401e"',robustness:a}});b=b.map(function(a){return{contentType:'audio/mp4;codecs="mp4a.40.2"',robustness:a}});return[{initDataTypes:["cenc"],videoCapabilities:a,audioCapabilities:b,distinctiveIdentifier:e,persistentState:d,sessionTypes:c},{initDataTypes:["cenc"],videoCapabilities:void 0,audioCapabilities:void 0,distinctiveIdentifier:e,persistentState:d,sessionTypes:c}]}function l(e){var b=d(e);if(b)return z.a.debug("eme: found compatible keySystem quickly",
b),I.Observable.of(b);var l=e.reduce(function(a,c){return a.concat((N[c.type]||[]).map(function(a){return{keyType:a,keySystem:c}}))},[]);return I.Observable.create(function(d){function e(k){if(!b)if(k>=l.length)d.error(new J.c("INCOMPATIBLE_KEYSYSTEMS",null,!0));else{var n=l[k],h=n.keyType,f=n.keySystem,m=c(f);z.a.debug("eme: request keysystem access "+h+","+(k+1+" of "+l.length),m);g=a.i(L.i)(h,m).subscribe(function(a){z.a.info("eme: found compatible keysystem",h,m);d.next({keySystem:f,keySystemAccess:a});
d.complete()},function(){z.a.debug("eme: rejected access to keysystem",h,m);g=null;e(k+1)})}}var b=!1,g=null;e(0);return function(){b=!0;g&&g.unsubscribe()}})}function n(c){return a.i(Q.b)(c.createMediaKeys())}function q(c,d,e,b){var l=Z,g=R;R=c;P=d;V=b;Z=e;if(e.mediaKeys===c)return I.Observable.of(c);g&&g!==R&&O.dispose();l&&l!==Z?(z.a.debug("eme: unlink old video element and set mediakeys"),d=a.i(L.j)(l,null).concat(a.i(L.j)(Z,c))):(z.a.debug("eme: set mediakeys"),d=a.i(L.j)(Z,c));return d.mapTo(c)}
function t(a,c,d,e,b){z.a.debug("eme: create a new "+c+" session");var l=a.createSession(c);a=w(l,d,b)["finally"](function(){O.deleteAndClose(l);X["delete"](e)}).publish();return{session:l,sessionEvents:a}}function p(c,d,b,l,g,k){c=t(c,b,d,g,k);var n=c.session;c=c.sessionEvents;O.add(g,n,c);z.a.debug("eme: generate request",l,g);l=a.i(Q.b)(n.generateRequest(l,g))["catch"](function(a){throw new J.c("KEY_GENERATE_REQUEST_ERROR",a,!1);})["do"](function(){"persistent-license"==b&&X.add(g,n)}).mapTo(e("generated-request",
n,{initData:g,initDataType:l}));return a.i(F.merge)(c,l)}function v(a,c,d,e,b,l){return p(a,c,d,e,b,l)["catch"](function(g){if(g.code!==J.b.KEY_GENERATE_REQUEST_ERROR)throw g;var k=O.getFirst();if(!k)throw g;z.a.warn("eme: could not create a new session, retry after closing a currently loaded session",g);return O.deleteAndClose(k).mergeMap(function(){return p(a,c,d,e,b,l)})})}function u(c,d,b,l,g,k){z.a.debug("eme: load persisted session",b);var n=t(c,"persistent-license",d,g,k),h=n.session,f=n.sessionEvents;
return a.i(Q.b)(h.load(b))["catch"](function(){return I.Observable.of(!1)}).mergeMap(function(a){if(a)return O.add(g,h,f),X.add(g,h),f.startWith(e("loaded-session",h,{storedSessionId:b}));z.a.warn("eme: no data stored for the loaded session, do fallback",b);O.deleteById(b);X["delete"](g);h.sessionId&&h.remove();return v(c,d,"persistent-license",l,g,k).startWith(e("loaded-session-failed",h,{storedSessionId:b}))})}function r(a,c,d,b,l,g){var k=O.get(l);if(k&&k.sessionId)return z.a.debug("eme: reuse loaded session",
k.sessionId),I.Observable.of(e("reuse-session",k));c=(k=(c=c.sessionTypes)&&0<=c.indexOf("persistent-license"))&&d.persistentLicense?"persistent-license":"temporary";return k&&d.persistentLicense&&(k=X.get(l))?u(a,d,k.sessionId,b,l,g):v(a,d,c,b,l,g)}function w(c,d,b){function l(a,c){return a.type===J.a.ENCRYPTED_MEDIA_ERROR?(a.fatal=c,a):new J.c("KEY_LOAD_ERROR",a,c)}z.a.debug("eme: handle message events",c);var g=void 0,k={totalRetry:2,retryDelay:200,errorSelector:function(a){return l(a,!0)},onRetry:function(a){return b.next(l(a,
!1))}},n=Y(c).map(function(a){throw new J.c("KEY_ERROR",a,!0);}),h=ca(c).mergeMap(function(e){g=e.sessionId;z.a.debug("eme: keystatuseschange event",g,c,e);c.keyStatuses.forEach(function(a,c){if(ba[c]||ba[a])throw new J.c("KEY_STATUS_CHANGE_ERROR",c,!0);});return d.onKeyStatusesChange?a.i(Q.c)(function(){return a.i(Q.b)(d.onKeyStatusesChange(e,c))})["catch"](function(a){throw new J.c("KEY_STATUS_CHANGE_ERROR",a,!0);}):(z.a.info("eme: keystatuseschange event not handled"),S())}),f=K(c).mergeMap(function(e){g=
e.sessionId;var b=new Uint8Array(e.message),l=e.messageType||"license-request";z.a.debug("eme: event message type "+l,c,e);e=W(function(){return a.i(Q.b)(d.getLicense(b,l)).timeout(1E4)["catch"](function(a){if(a instanceof M.TimeoutError)throw new J.c("KEY_LOAD_TIMEOUT",null,!1);throw a;})});return a.i(aa.a)(e,k)}),h=a.i(F.merge)(f,h).concatMap(function(d){z.a.debug("eme: update session",g,d);return a.i(Q.b)(c.update(d,g))["catch"](function(a){throw new J.c("KEY_UPDATE_ERROR",a,!0);}).mapTo(e("session-update",
c,{updatedWith:d}))}),n=a.i(F.merge)(h,n);return c.closed?n.takeUntil(a.i(Q.b)(c.closed)):n}function y(c,d){return a.i(Q.b)(c.setServerCertificate(d)).ignoreElements()["catch"](function(a){throw new J.c("LICENSE_SERVER_CERTIFICATE_ERROR",a,!0);})}function x(a,c,d){return y(a,c)["catch"](function(a){a.fatal=!1;d.next(a);return I.Observable.empty()})}function A(c,d,e){function b(a,d){var b=d.keySystem,l=d.keySystemAccess;b.persistentLicense&&X.setStorage(b.licenseStorage);z.a.info("eme: encrypted event",
a);return n(l).mergeMap(function(d){var g=b.serverCertificate,g=g&&"function"===typeof d.setServerCertificate?x(d,g,e):I.Observable.empty(),k=l.getConfiguration();return g.concat(q(d,k,c,b)).concat(r(d,k,b,a.initDataType,new Uint8Array(a.initData),e))})}return a.i(T.combineLatest)(E(c),l(d)).take(1).mergeMap(function(a){return b(a[0],a[1])})}function C(){return V&&V.type}function D(){Z&&a.i(L.j)(Z,null).subscribe(function(){});Z=V=R=null;O.dispose()}a.d(f,"c",function(){return A});a.d(f,"b",function(){return C});
a.d(f,"d",function(){return E});a.d(f,"a",function(){return D});b=a(7);var H=a.n(b),I=a(0);a.n(I);b=a(9);a.n(b);f=a(51);a.n(f);var T=a(23);a.n(T);var F=a(10);a.n(F);var M=a(61);a.n(M);var z=a(3),U=a(1),Q=a(13),aa=a(32),L=a(11),J=a(6),E=L.f.onEncrypted,K=L.f.onKeyMessage,Y=L.f.onKeyError,ca=L.f.onKeyStatusesChange,S=b.EmptyObservable.create,W=f.DeferObservable.create,N={clearkey:["webkit-org.w3.clearkey","org.w3.clearkey"],widevine:["com.widevine.alpha"],playready:["com.microsoft.playready","com.chromecast.playready",
"com.youtube.playready"]},G=["HW_SECURE_ALL","HW_SECURE_DECODE","HW_SECURE_CRYPTO","SW_SECURE_DECODE","SW_SECURE_CRYPTO"],ba={expired:!0,"internal-error":!0};b=function(){function a(){k(this,a);this._entries=[]}a.prototype.find=function(a){for(var c=0;c<this._entries.length;c++)if(!0===a(this._entries[c]))return this._entries[c];return null};return a}();f=function(c){function d(){k(this,d);return m(this,c.apply(this,arguments))}h(d,c);d.prototype.getFirst=function(){if(0<this._entries.length)return this._entries[0].session};
d.prototype.find=function(a){for(var c=0;c<this._entries.length;c++)if(!0===a(this._entries[c]))return this._entries[c];return null};d.prototype.get=function(a){a=g(a);var c=this.find(function(c){return c.initData===a});return c?c.session:null};d.prototype.add=function(a,c,d){a=g(a);var e=this.get(a);e&&this.deleteAndClose(e);d=d.connect();a={session:c,initData:a,eventSubscription:d};z.a.debug("eme-mem-store: add session",a);this._entries.push(a)};d.prototype.deleteById=function(a){var c=this.find(function(c){return c.session.sessionId===
a});return c?this["delete"](c.session):null};d.prototype["delete"]=function(a){var c=this.find(function(c){return c.session===a});if(!c)return null;var d=c.session,e=c.eventSubscription;z.a.debug("eme-mem-store: delete session",c);c=this._entries.indexOf(c);this._entries.splice(c,1);e.unsubscribe();return d};d.prototype.deleteAndClose=function(c){return(c=this["delete"](c))?(z.a.debug("eme-mem-store: close session",c),a.i(Q.b)(c.close())["catch"](function(){return I.Observable.of(null)})):I.Observable.of(null)};
d.prototype.dispose=function(){var a=this,c=this._entries.map(function(c){return a.deleteAndClose(c.session)});this._entries=[];return F.merge.apply(null,c)};return d}(b);var X=new (function(c){function d(a){k(this,d);var e=m(this,c.call(this));e.setStorage(a);return e}h(d,c);d.prototype.setStorage=function(c){if(this._storage!==c){a.i(U.a)(c,"no licenseStorage given for keySystem with persistentLicense");U.a.iface(c,"licenseStorage",{save:"function",load:"function"});this._storage=c;try{this._entries=
this._storage.load(),a.i(U.a)(Array.isArray(this._entries))}catch(ea){z.a.warn("eme-persitent-store: could not get entries from license storage",ea),this.dispose()}}};d.prototype.get=function(a){a=g(a);return this.find(function(c){return c.initData===a})||null};d.prototype.add=function(a,c){var d=c&&c.sessionId;if(d){a=g(a);var e=this.get(a);e&&e.sessionId===d||(e&&this["delete"](a),z.a.info("eme-persitent-store: add new session",d,c),this._entries.push({sessionId:d,initData:a}),this._save())}};d.prototype["delete"]=
function(a){a=g(a);var c=this.find(function(c){return c.initData===a});c&&(z.a.warn("eme-persitent-store: delete session from store",c),c=this._entries.indexOf(c),this._entries.splice(c,1),this._save())};d.prototype.dispose=function(){this._entries=[];this._save()};d.prototype._save=function(){try{this._storage.save(this._entries)}catch(ga){z.a.warn("eme-persitent-store: could not save licenses in localStorage")}};return d}(b))({load:function(){return[]},save:function(){}}),O=new f,R=void 0,P=void 0,
V=void 0,Z=void 0},function(b,f,a){function m(c){var d=a.i(r.a)(c.locations[0]);(c=c.periods[0])&&c.baseURL&&(d+=""+c.baseURL);return d}function h(a,b,l,g){if(!b.transportType)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);b.id=b.id||H++;b.type=b.type||"static";var n=b.locations;n&&n.length||(b.locations=[a]);b.isLive="dynamic"==b.type;var h={rootURL:m(b),baseURL:b.baseURL,isLive:b.isLive};l&&(l=e(l));g&&(g=d(g));a=b.periods.map(function(a){return k(a,h,l,g)});b=c(b,a[0]);b.periods=null;b.duration||
(b.duration=Infinity);b.isLive&&(b.suggestedPresentationDelay=b.suggestedPresentationDelay||T,b.availabilityStartTime=b.availabilityStartTime||0);return new A.a(b)}function k(a,c,d,e){a.id=a.id||H++;var b=a.adaptations,b=b.concat(d||[]),b=b.concat(e||[]),b=b.map(function(a){return g(a,c)}),b=b.filter(function(a){return 0>I.indexOf(a.type)?(u.a.info("not supported adaptation type",a.type),!1):!0});if(0===b.length)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);d={};for(e=0;e<b.length;e++){var l=b[e],
k=l.type,n=l.representations;d[k]=d[k]||[];0<n.length&&d[k].push(l)}for(var h in d)if(0===d[h].length)throw new y.d("MANIFEST_INCOMPATIBLE_CODECS_ERROR",null,!0);a.adaptations=d;return a}function g(d,e){if("undefined"==typeof d.id)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);var b=c(e,d),l={};D.forEach(function(a){a in b&&(l[a]=b[a])});var g=b.representations.map(function(d){var e=b.rootURL,g=b.baseURL;if("undefined"==typeof d.id)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);d=c(l,d);d.index=d.index||
...
b.closedCaption=k);b.representations=g;b.bitrates=g.map(function(a){return a.bitrate});return b}function e(a){Array.isArray(a)||(a=[a]);return a.reduce(function(a,c){var d=c.mimeType,e=c.url,b=c.language,l=c.languages,g=c.closedCaption;b&&(l=[b]);return a.concat(l.map(function(a){return{id:H++,type:"text",language:a,closedCaption:!!g,baseURL:e,representations:[{id:H++,mimeType:d,index:{indexType:"template",duration:Number.MAX_VALUE,timescale:1,startNumber:0}}]}}))},[])}function d(a){Array.isArray(a)||
(a=[a]);return a.map(function(a){var c=a.mimeType;a=a.url;return{id:H++,type:"image",baseURL:a,representations:[{id:H++,mimeType:c,index:{indexType:"template",duration:Number.MAX_VALUE,timescale:1,startNumber:0}}]}})}function c(){for(var a={},d=arguments.length,e=Array(d),b=0;b<d;b++)e[b]=arguments[b];for(d=e.length-1;0<=d;d--){var b=e[d],l;for(l in b)if(!a.hasOwnProperty(l)){var g=b[l];g&&"object"===("undefined"===typeof g?"undefined":C(g))?g instanceof Date?a[l]=new Date(g.getTime()):Array.isArray(g)?
...
a(21),u=a(3),r=a(26),w=a(11),y=a(6),x=a(22),A=a(88),C="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},D="audioSamplingRate codecs codingDependency frameRate height index maxPlayoutRate maximumSAPPeriod mimeType profiles segmentProfiles width".split(" "),H=0,I=["audio","video","text","image"],T=15},function(b,f,a){function m(a,c){if("function"!==
...
c(d,a.nodeName,a),a=a.nextElementSibling;return d}function t(a){return a?"urn:tva:metadata:cs:AudioPurposeCS:2007"===a.schemeIdUri&&1===a.value:!1}function p(c){var d=c.mimeType,d=void 0===d?"":d,e=d.split("/")[0];if(a.i(u.a)(A,e))return e;if("application/bif"===d)return"image";if("application/ttml+xml"===d)return"text";if("application/mp4"===d)return(c=c.role)&&"urn:mpeg:dash:role:2011"===c.schemeIdUri&&"subtitle"===c.value?"text":"metadata";c=c.representations;c=void 0===c?[]:c;return c.length&&
(c=c[0].mimeType.split("/")[0],a.i(u.a)(A,c))?c:"unknown"}function v(a){return a?"urn:tva:metadata:cs:AudioPurposeCS:2007"===a.schemeIdUri&&2===a.value:!1}a.d(f,"g",function(){return h});a.d(f,"h",function(){return c});a.d(f,"f",function(){return n});a.d(f,"i",function(){return k});a.d(f,"m",function(){return e});a.d(f,"j",function(){return d});a.d(f,"l",function(){return g});a.d(f,"k",function(){return l});a.d(f,"a",function(){return q});a.d(f,"b",function(){return C});a.d(f,"d",function(){return v});
a.d(f,"e",function(){return t});a.d(f,"c",function(){return p});var u=a(21),r=a(1),w=/^P(([\d.]*)Y)?(([\d.]*)M)?(([\d.]*)D)?T?(([\d.]*)H)?(([\d.]*)M)?(([\d.]*)S)?/,y=/([0-9]+)-([0-9]+)/,x=/([0-9]+)(\/([0-9]+))?/,A=["audio","video","text","image"],C=function(a){if(a){var c=a.representations||[],d=c.filter(function(a){return a&&a.index});if(!c.length)return m(a.index);var e=Math.min.apply(Math,d.map(function(a){return m(a.index)}));if(!isNaN(e)){if(c.length===d.length)return e;if(a.index)return a=m(a.index),
Math.min(e,a)}}}},function(b,f,a){function m(b){var g=0,e=b.length,d=a.i(h.a)(b.subarray(g,g+8)),g=g+8,c=b[g],g=g+1,l=b[g],g=g+1,k=b[g],g=g+1,f=b[g],g=g+1,c=[c,l,k,f].join("."),l=b[g]+a.i(h.c)(b,g+1),g=g+4,k=a.i(h.c)(b,g),g=g+4,f=a.i(h.a)(b.subarray(g,g+4)),g=g+4,m=a.i(h.d)(b,g),g=g+2,p=a.i(h.d)(b,g),g=g+2,v=[b[g],b[g+1]].join(":"),u=1===b[g+2],g=64,r=[],w=void 0,y=0;if(!l)throw Error("bif: no images to parse");for(;g<e;){var x=a.i(h.c)(b,g),g=g+4,A=a.i(h.c)(b,g),g=g+4;if(w){var C=w.index,D=k,H=y,
w=b.subarray(w.offset,A);r.push({index:C,duration:D,ts:H,data:w});y+=k}if(4294967295===x)break;w={index:x,offset:A}}return{fileFormat:d,version:c,imageCount:l,timescale:k,format:f,width:m,height:p,aspectRatio:v,isVod:u,thumbs:r}}a.d(f,"a",function(){return m});var h=a(12)},function(b,f,a){function m(a,c,d){a="string"==typeof a?(new DOMParser).parseFromString(a,"text/xml"):a;if(!(a instanceof window.Document||a instanceof window.HTMLElement))throw Error("ttml needs a Document to parse");a=a.querySelector("tt");
...
e.resultSelector;b.send();return b}h(d,a);d.prototype.next=function(){this.done=!0;var a=this.resultSelector,d=this.xhr,e=this.request,b=this.destination,g=d.status,k=this.responseType,n=this.totalSize,h=this.sentTime,f=this.receivedTime,m=d.responseURL||e.url,q=void 0;if("json"==e.responseType)if("string"!=typeof d.response)q=d.response;else try{q=JSON.parse(d.responseText)}catch(F){q=null}else q=d.response;null==q?b.error(new c.h(this,e,c.i.PARSE_ERROR)):(d=new l(g,m,k,h,f,n,q),a?b.next(a(d)):b.next(d))};
d.prototype.setHeaders=function(a,c){for(var d in c)a.setRequestHeader(d,c[d])};d.prototype.setupEvents=function(a,d){a.ontimeout=function y(){y.subscriber.error(new c.h(this,y.request,c.i.TIMEOUT))};a.ontimeout.request=d;a.ontimeout.subscriber=this;a.onerror=function x(){x.subscriber.error(new c.h(this,x.request,c.i.ERROR_EVENT))};a.onerror.request=d;a.onerror.subscriber=this;a.onload=function A(a){if(4===this.readyState){var d=A.subscriber,e=A.request;d.receivedTime=Date.now();d.totalSize=a.total;
...
c})}b=a(7);var n=a.n(b);b=a(18);var q=a.n(b),t=a(4);a.n(t);var p=a(33);a.n(p);var v=a(23);a.n(v);var u=a(13),r=a(22),w=a(69),y={defaultAudioTrack:{language:"fra",audioDescription:!1},defaultTextTrack:null,defaultWantedBufferAhead:30,defaultMaxBufferBehind:Infinity,defaultMaxBufferAhead:Infinity,defaultBufferThreshold:.3,initialVideoBitrate:0,initialAudioBitrate:0,maxVideoBitrate:Infinity,maxAudioBitrate:Infinity};f.a=function(b,e){function f(a){return S.distinctUntilChanged().map(function(c){return d(a,
c.language,c.audioDescription)||a[0]})}function q(a){return W.distinctUntilChanged().map(function(d){return d?c(a,d.language,d.closedCaption):null})}var r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};Object.keys(r).forEach(function(a){return void 0===r[a]&&delete r[a]});var x=n()({},y,r),A=x.defaultTextTrack,F=x.defaultWantedBufferAhead,M=x.defaultMaxBufferBehind,z=x.defaultMaxBufferAhead,U=x.defaultBufferThreshold,Q=x.initialVideoBitrate,aa=x.initialAudioBitrate,L=x.maxVideoBitrate,
J=x.maxAudioBitrate,E=x.limitVideoWidth,K=x.throttleWhenHidden,Y=e.videoWidth,ca=e.inBackground,S=new p.BehaviorSubject(x.defaultAudioTrack),W=new p.BehaviorSubject(A),N={audio:new p.BehaviorSubject(aa),video:new p.BehaviorSubject(Q)},x=[a.i(w.a)(l(b,"audio"),{alpha:.6}).multicast(N.audio),a.i(w.a)(l(b,"video"),{alpha:.6}).multicast(N.video)],G=new t.Subscription;x.forEach(function(a){return G.add(a.connect())});var ba={audio:new p.BehaviorSubject(Infinity),video:new p.BehaviorSubject(Infinity)},
X={audio:new p.BehaviorSubject(J),video:new p.BehaviorSubject(L)},O={audio:new p.BehaviorSubject(F),video:new p.BehaviorSubject(F),text:new p.BehaviorSubject(F)},R={audio:new p.BehaviorSubject(M),video:new p.BehaviorSubject(M),text:new p.BehaviorSubject(M)},P={audio:new p.BehaviorSubject(z),video:new p.BehaviorSubject(z),text:new p.BehaviorSubject(z)};return{setAudioTrack:function(a){S.next(a)},setTextTrack:function(a){W.next(a)},getAudioTrack:function(){return S.getValue()},getTextTrack:function(){return W.getValue()},
getAverageBitrates:function(){return N},getAudioMaxBitrate:function(){return X.audio.getValue()},getVideoMaxBitrate:function(){return X.video.getValue()},getAudioBufferSize:function(){return O.audio.getValue()},getVideoBufferSize:function(){return O.video.getValue()},setAudioBitrate:function(a){ba.audio.next(h(a,Infinity))},setVideoBitrate:function(a){ba.video.next(h(a,Infinity))},setAudioMaxBitrate:function(a){X.audio.next(h(a,Infinity))},setVideoMaxBitrate:function(a){X.video.next(h(a,Infinity))},
setAudioBufferSize:function(a){O.audio.next(h(a,F))},setVideoBufferSize:function(a){O.video.next(h(a,F))},setMaxBufferBehind:function(a){R.audio.next(h(a,M));R.video.next(h(a,M));R.text.next(h(a,M))},setMaxBufferAhead:function(a){P.audio.next(h(a,z));P.video.next(h(a,z));P.text.next(h(a,z))},setWantedBufferAhead:function(a){O.audio.next(h(a,M));O.video.next(h(a,M));O.text.next(h(a,M))},getMaxBufferBehind:function(){return Math.min(R.audio.getValue(),R.video.getValue(),R.text.getValue())},getMaxBufferAhead:function(){return Math.min(P.audio.getValue(),
P.video.getValue(),P.text.getValue())},getWantedBufferAhead:function(){return Math.min(O.audio.getValue(),O.video.getValue(),O.text.getValue())},getBufferAdapters:function(c){var d=c.type,b=c.representations,e=c.getAvailableBitrates();c=void 0;if(1<b.length){c=ba[d];var l=X[d],h=N[d].map(function(a,c){return k(e,a,0===c?0:U)}).distinctUntilChanged().debounceTime(2E3).startWith(k(e,N[d].getValue(),0));"video"==d&&(l=a.i(v.combineLatest)([l,Y,ca]).map(function(a){var c=a[0],d=a[1];a=a[2];if(K&&a)return e[0];
d=E?g(b,d):e[e.length-1];return Math.min(d,c)}));c=a.i(v.combineLatest)(c,l,h,function(a,c,d){var g=void 0,g=Infinity>a?a:Infinity>c?Math.min(c,d):d;return m(b,function(a){return a.bitrate===k(e,g)})}).distinctUntilChanged(function(a,c){return a.id===c.id})}else c=a.i(u.e)(b[0]);return{representations:c,wantedBufferAhead:O[d]||new p.BehaviorSubject(F),maxBufferBehind:R[d]||new p.BehaviorSubject(M),maxBufferAhead:P[d]||new p.BehaviorSubject(z)}},getAdaptationsChoice:function(c,d){return"audio"==c?
f(d):"text"==c?q(d):a.i(u.e)(d[0])},unsubscribe:function(){G&&(G.unsubscribe(),G=null)}}}},function(b,f,a){function m(b){function l(a,c){for(var d=a.ts,b=a.buffered,e=b.getRange(d),b=b.getOuterRanges(d),g=[],l=0;l<b.length;l++){var k=b[l];d-c<k.end?g.push(k):d+c>k.start&&g.push(k)}e&&(n.a.debug("buffer: gc removing part of inner range",g),d-c>e.start&&g.push({start:e.start,end:d-c}),d+c<e.end&&g.push({start:d+c,end:e.end}));return g}function h(){n.a.warn("buffer: running garbage collector");return Q.take(1).mergeMap(function(a){var c=
l(a,x);0===c.length&&(c=l(a,A));n.a.debug("buffer: gc cleaning",c);return r(c.map(function(a){return N.removeBuffer(a)})).concatAll()})}function f(b){function e(a){return q.test(a.id)?!1:a.isInit||0>a.time?!0:(a=W.getSegmentRange(a.time/a.timescale,a.duration/a.timescale))?a.bitrate*y<b.bitrate:!0}function l(a,c,d){var l=new t.a(C.buffered);W.equals(l)||W.intersect(l);if(a.stalled&&L){var k=b.index.checkDiscontinuity(a.ts);0<k&&J.next({type:"index-discontinuity",value:{ts:k+1}})}k=void 0;try{var h=
null;0===d&&(n.a.debug("add init segment",m),h=b.index.getInitSegment());if(0===a.readyState)k=h?[h]:[];else{var f=a.ts,r=Math.max(0,Math.min(c,a.liveGap,(a.duration||Infinity)-f));a=void 0;var p=l.getGap(f);a=p>E&&Infinity>p?Math.min(p,K):0;var S=W.getRange(f);if(S&&S.bitrate===b.bitrate){var w=Math.floor(S.end-f);w>a&&(a=w)}l=f+a;p=f+r-l;if(b.index.shouldRefresh(f,l,f+r))throw new v.g("OUT_OF_INDEX_ERROR",b.index.getType(),!1);var x=b.index.getSegments(l,p);h&&x.unshift(h);k=x}k=k.filter(e)}catch(da){if(da.type===
v.a.INDEX_ERROR&&da.code===v.b.OUT_OF_INDEX_ERROR)return J.next({type:"out-of-index",value:da}),u();throw da;}for(f=0;f<k.length;f++)q.add(k[f].id);return g.Observable.of.apply(g.Observable,k)}n.a.info("bitrate",m,b.bitrate);var q=new p.a,x=function(a,c,d){if(!isFinite(c)&&!isFinite(d))return g.Observable.empty();var b=new t.a(C.buffered),e=[],l=b.getRange(a),k=b.getOuterRanges(a);(function(){if(isFinite(c)){for(var d=0;d<k.length;d++){var b=k[d];a-c>=b.end?e.push(b):a>=b.end&&a-c>b.start&&a-c<b.end&&
e.push({start:b.start,end:a-c})}l&&a-c>l.start&&e.push({start:l.start,end:a-c})}})();(function(){if(isFinite(d)){for(var c=0;c<k.length;c++){var b=k[c];a+d<=b.start?e.push(b):a<=b.start&&a+d<b.end&&a+d>b.start&&e.push({start:a+d,end:b.end})}l&&a+d<l.end&&e.push({start:a+d,end:l.end})}})();return r(e.map(function(a){return N.removeBuffer(a)})).concatAll().ignoreElements()},D=function(a){return z({segment:a,representation:b}).map(function(c){return k()({segment:a},c)})},A=a.i(d.combineLatest)(Q,Y,ca,
S).mergeMap(function(a,c){var d=a[0],b=a[2],e=a[3];return g.Observable.merge(l(d,Math.min(a[1],e),c).concatMap(D),x(d.ts,b,e))}).concatMap(function(a){var c=a.segment,d=a.parsed,e=d.segmentData,g=d.nextSegments,l=d.currentSegment;(d=d.timescale)&&b.index.setTimescale(d);var f=g?b.index._addSegments(g,l):[],n=function(){q.remove(c.id);l&&W.insert(b.bitrate,l.ts/c.timescale,(l.ts+l.d)/c.timescale)},u=function(){return N.appendBuffer(e)["do"](n)};return u()["catch"](function(a){if("QuotaExceededError"!=
a.name)throw q.remove(c.id),new v.d("BUFFER_APPEND_ERROR",a,!0);return h().mergeMap(u)["catch"](function(a){q.remove(c.id);throw new v.d("BUFFER_FULL_ERROR",a,!0);})}).map(function(){return{type:"pipeline",value:k()({bufferType:m,addedSegments:f},a)}})});return a.i(c.merge)(A,J)["catch"](function(a){if(!L||a.type!=v.a.NETWORK_ERROR||!a.isHttpError(412))throw a;return g.Observable.of({type:"precondition-failed",value:a}).concat(w(2E3)).concat(f(b))}).startWith({type:"buffer",value:{bufferType:m,adaptation:M,
representation:b}})}var m=b.bufferType,C=b.sourceBuffer,M=b.adaptation,z=b.pipeline,U=b.adapters,Q=b.timings,aa=b.seekings,L=b.isLive,J=new e.Subject,E="video"==m?4:1,K="video"==m?6:1;b=U.representations;var Y=U.wantedBufferAhead,ca=U.maxBufferBehind,S=U.maxBufferAhead,W=new t.a,N=new q.a(C);return a.i(d.combineLatest)(b,aa,function(a){return a}).switchMap(f)["finally"](function(){return N.dispose()})}function h(a){return g.Observable.of({type:"buffer",value:{bufferType:a,adaptation:null,representation:null}})}
a.d(f,"b",function(){return m});a.d(f,"a",function(){return h});b=a(7);var k=a.n(b),g=a(0);a.n(g);var e=a(8);a.n(e);var d=a(23);a.n(d);var c=a(10);a.n(c);b=a(9);a.n(b);f=a(142);a.n(f);var l=a(54);a.n(l);var n=a(3),q=a(72),t=a(19),p=a(104),v=a(6),u=b.EmptyObservable.create,r=f.FromObservable.create,w=l.TimerObservable.create,y=1.5,x=240,A=30},function(b,f,a){a.d(f,"a",function(){return h});var m=a(8);a.n(m);var h=function(){function a(b){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");
...
this._flush);this.buffer=null;this.queue.length=0;this.flushing=null};a.prototype.onUpdate=function(a){this.flushing&&(this.flushing.next(a),this.flushing.complete(),this.flushing=null)};a.prototype.onError=function(a){this.flushing&&(this.flushing.error(a),this.flushing=null)};a.prototype.queueAction=function(a,b){var d=new m.Subject;1===this.queue.unshift({type:a,args:b,subj:d})&&this.flush();return d};a.prototype.appendBuffer=function(a){return this.queueAction("append",a)};a.prototype.removeBuffer=
function(a){return this.queueAction("remove",{start:a.start,end:a.end})};a.prototype.appendStream=function(a){return this.queueAction("stream",a)};a.prototype.flush=function(){if(!this.flushing&&0!==this.queue.length&&!this.buffer.updating){var a=this.queue.pop(),b=a.type,d=a.args;this.flushing=a.subj;try{switch(b){case "append":this.buffer.appendBuffer(d);break;case "stream":this.buffer.appendStream(d);break;case "remove":this.buffer.remove(d.start,d.end)}}catch(c){this.onError(c)}}};return a}()},
function(b,f,a){a.d(f,"a",function(){return m});var m=function(){function a(){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");this.cache={}}a.prototype.add=function(a,b){var e=a.segment;e.isInit&&(this.cache[e.id]=b)};a.prototype.get=function(a){a=a.segment;return a.isInit&&(a=this.cache[a.id],null!=a)?a:null};return a}()},function(b,f,a){var m=a(10);a.n(m);b=a(143);a.n(b);var h=a(11),k=b.IntervalObservable.create,g=window.devicePixelRatio||1;f.a=function(b){var d=
a.i(h.u)().filter(function(a){return!1===a}),c=a.i(h.u)().debounceTime(6E4).filter(function(a){return!0===a}),d=a.i(m.merge)(d,c).startWith(!1);return{videoWidth:a.i(m.merge)(k(2E4),a.i(h.v)().debounceTime(500)).startWith("init").map(function(){return b.clientWidth*g}).distinctUntilChanged(),inBackground:d}}},function(b,f,a){function m(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function, not "+typeof b);a.prototype=Object.create(b&&b.prototype,
...
return b}(a(44).a);f.a=b},function(b,f,a){function m(c,d,b){var e=3<arguments.length&&void 0!==arguments[3]?arguments[3]:!0;a.i(n.e)(b)||(b=new (b instanceof n.h?n.j:n.f)(c,b,e));b.pipelineType=d;return b}function h(a){return a instanceof n.h?a.type===n.i.ERROR_HTTP_CODE?500<=a.status||404==a.status:a.type===n.i.TIMEOUT||a.type===n.i.ERROR_EVENT:!1}function k(b,e,k,f){function n(a){throw m("PIPELINE_RESOLVE_ERROR",b,a);}function u(a){throw m("PIPELINE_PARSING_ERROR",b,a);}function t(a){k.next(a)}
function p(d){return a.i(c.a)(a.i(l.c)(T,d),Q)}function A(c){var d=U?U.get(c):null;return null===d?p(c):a.i(l.b)(d)["catch"](function(){return p(c)})}function C(c){return a.i(l.c)(F,c)["catch"](u)}function D(a,c){var d=g()({response:c},a);U&&U.add(a,c);q.schedule(t,0,{type:b,value:d});return d}function v(a,c){return g()({parsed:c},a)}var I=e.resolver,T=e.loader,F=e.parser,M=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{};I||(I=d.Observable.of);T||(T=d.Observable.of);F||(F=d.Observable.of);
var z=M.maxRetry,U=M.cache,M="number"===typeof z?z:4,Q={retryDelay:200,errorSelector:function(a){throw m("PIPELINE_LOAD_ERROR",b,a);},totalRetry:M,shouldRetry:M&&h,onRetry:function(a){q.schedule(t,0,{type:b,value:a.xhr});f.next(m("PIPELINE_LOAD_ERROR",b,a,!1))}};return function(c){return a.i(l.c)(I,c)["catch"](n).mergeMap(A,D).mergeMap(C,v)}}b=a(7);var g=a.n(b),e=a(8);a.n(e);b=a(174);a.n(b);var d=a(0);a.n(d);var c=a(32),l=a(13),n=a(6),q=b.asap;f.a=function(){var a=new e.Subject;return{createPipelines:function(c){var d=
1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},b={requiresMediaSource:function(){return!0!==c.directFile}},e;for(e in c)b[e]=k(e,c[e],a,d.errorStream,d[e]);return b},metrics:a}}},function(b,f,a){function m(a,c){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!c||"object"!==typeof c&&"function"!==typeof c?a:c}function h(a,c){if("function"!==typeof c&&null!==c)throw new TypeError("Super expression must either be null or a function, not "+
typeof c);a.prototype=Object.create(c&&c.prototype,{constructor:{value:a,enumerable:!1,writable:!0,configurable:!0}});c&&(Object.setPrototypeOf?Object.setPrototypeOf(a,c):a.__proto__=c)}function k(a,c){if(a===c)return!0;if("object"===("undefined"===typeof a?"undefined":K(a))&&"object"===("undefined"===typeof c?"undefined":K(c))){if(null===a||null===c)return!1;var d=Object.keys(a);if(d.length!==Object.keys(c).length)return!1;for(var b=Array.isArray(d),e=0,d=b?d:d[Symbol.iterator]();;){var l;if(b){if(e>=
d.length)break;l=d[e++]}else{e=d.next();if(e.done)break;l=e.value}if(!c.hasOwnProperty(l)||!k(a[l],c[l]))return!1}return!0}return!1}function g(a,c){return c?"seeking"==c.name?"SEEKING":"BUFFERING":a?"PLAYING":"PAUSED"}function e(){}function d(c){a.i(A.a)(c._manifest,"player: no manifest loaded")}function c(a,c){return a.filter(function(a){return a.type==c}).map(function(a){return a.value})}b=a(7);var l=a.n(b);b=a(18);var n=a.n(b),q=a(4);a.n(q);var t=a(8);a.n(t);var p=a(33);a.n(p);var v=a(23);a.n(v);
var u=a(3),r=a(106),w=a(13),y=a(22);b=a(30);var x=a(105),A=a(1),C=a(11),D=a(45),H=a(6),I=a(73),T=a(19),F=a(80),M=a(74),z=a(43),U=a(98),Q=a(76),aa=a(70),L=a(78),J=a(42),E=function(){function a(a,c){for(var d=0;d<c.length;d++){var b=c[d];b.enumerable=b.enumerable||!1;b.configurable=!0;"value"in b&&(b.writable=!0);Object.defineProperty(a,b.key,b)}}return function(c,d,b){d&&a(c.prototype,d);b&&a(c,b);return c}}(),K="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:
function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};b=function(b){function f(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");var d=c.videoElement,e=c.transport,l=c.transportOptions,g=c.defaultLanguage,k=c.defaultAudioTrack,h=c.defaultSubtitle,n=c.defaultTextTrack,q=c.initVideoBitrate,w=c.initialVideoBitrate,x=c.initAudioBitrate,D=c.initialAudioBitrate,
E=c.maxVideoBitrate,v=c.maxAudioBitrate,H=c.limitVideoWidth,H=void 0===H?!0:H,c=c.throttleWhenHidden,c=void 0===c?!0:c,B=m(this,b.call(this)),Y=w,K=D,I=k,z=n;null!=q&&null==w&&(a.i(r.a)("initVideoBitrate is deprecated. Use initialVideoBitrate instead"),Y=q);null!=x&&null==D&&(a.i(r.a)("initAudioBitrate is deprecated. Use initialAudioBitrate instead"),K=x);null!=g&&null==k&&(a.i(r.a)("defaultLanguage is deprecated. Use defaultAudioTrack instead"),I=g);null!=h&&null==n&&(a.i(r.a)("defaultSubtitle is deprecated. Use defaultTextTrack instead"),
z=h);B._playPauseNext$=B._playPauseNext.bind(B);B._textTrackChanges$=B._textTrackChanges.bind(B);B._setPlayerState$=B._setPlayerState.bind(B);B._triggerTimeChange$=B._triggerTimeChange.bind(B);B._streamNext$=B._streamNext.bind(B);B._streamError$=B._streamError.bind(B);B._streamFatalError$=B._streamFatalError.bind(B);B._streamComplete$=B._streamComplete.bind(B);B.defaultTransport=e;B.defaultTransportOptions=l||{};d||(d=document.createElement("video"));a.i(A.a)(d instanceof C.a,"requires an actual HTMLVideoElement");
d.preload="auto";B.version="2.3.2";B.video=d;B.fullscreen=a.i(C.b)(d).subscribe(function(){return B.trigger("fullscreenChange",B.isFullscreen())});B.playing=new p.BehaviorSubject;B.stream=new t.Subject;B.images=new t.Subject;B.errorStream=new t.Subject;l=a.i(Q.a)();e=l.createPipelines;l=l.metrics;d=a.i(M.a)(d);B.createPipelines=e;B.metrics=l;B.adaptive=a.i(aa.a)(l,d,{initialVideoBitrate:Y,initialAudioBitrate:K,maxVideoBitrate:E,maxAudioBitrate:v,defaultAudioTrack:a.i(y.a)(I),defaultTextTrack:a.i(y.b)(z),
limitVideoWidth:H,throttleWhenHidden:c});B.muted=.1;B._setPlayerState("STOPPED");B._resetStates();B.log=u.a;return B}h(f,b);f.getErrorTypes=function(){a.i(r.a)("getErrorTypes is deprecated. Use the ErrorTypes property instead");return H.a};f.getErrorCodes=function(){a.i(r.a)("getErrorCodes is deprecated. Use the ErrorCodes property instead");return H.b};E(f,null,[{key:"ErrorTypes",get:function(){return H.a}},{key:"ErrorCodes",get:function(){return H.b}}]);f.prototype._resetStates=function(){this._manifest=
null;this.reps={video:null,audio:null,text:null,images:null};this.adas={video:null,audio:null,text:null,images:null};this.evts={};this.frag={start:null,end:null};this.error=null;this.images.next(null);this._currentImagePlaylist=null};f.prototype._unsubscribe=function(){if(this.subscriptions){var a=this.subscriptions;this.subscriptions=null;a.unsubscribe()}};f.prototype.stop=function(){"STOPPED"!==this.state&&(this._resetStates(),this._unsubscribe(),this._setPlayerState("STOPPED"))};f.prototype.dispose=
function(){this.stop();this.metrics.unsubscribe();this.adaptive.unsubscribe();this.fullscreen.unsubscribe();this.stream.unsubscribe();a.i(J.a)();this.video=this.createPipelines=this.stream=this.fullscreen=this.adaptive=this.metrics=null};f.prototype._recordState=function(a,c){k(this.evts[a],c)||(this.evts[a]=c,this.trigger(a+"Change",c))};f.prototype._parseOptions=function(c){var d=c=l()({transport:this.defaultTransport,transportOptions:{},keySystems:[],timeFragment:{},textTracks:[],imageTracks:[],
autoPlay:!1,hideNativeSubtitle:!1,directFile:!1},c),b=d.transport,e=d.url,g=d.keySystems,f=d.timeFragment,k=d.supplementaryTextTracks,h=d.supplementaryImageTracks,n=c,m=n.subtitles,q=n.images,d=n.transportOptions,u=n.manifests,t=n.autoPlay,p=n.directFile,w=n.defaultLanguage,x=n.defaultAudioTrack,S=n.defaultSubtitle,C=n.hideNativeSubtitle,D=n.startAt,y=x,n=n.defaultTextTrack;null!=w&&null==x&&(a.i(r.a)("defaultLanguage is deprecated. Use defaultAudioTrack instead"),y=w);c.hasOwnProperty("defaultSubtitle")&&
!c.hasOwnProperty("defaultTextTrack")&&(a.i(r.a)("defaultSubtitle is deprecated. Use defaultTextTrack instead"),n=S);void 0!==m&&void 0===k&&(a.i(r.a)("the subtitles option is deprecated. Use supplementaryTextTracks instead"),k=m);void 0!==q&&void 0===h&&(a.i(r.a)("the images option is deprecated. Use supplementaryImageTracks instead"),h=q);f=a.i(F.a)(f);p&&(b="directfile");a.i(A.a)(!!u^!!e,"player: you have to pass either a url or a list of manifests");u&&(a.i(r.a)("the manifests options is deprecated, use url instead"),
g=u[0],e=g.url,k=g.subtitles||[],h=g.images||[],g=u.map(function(a){return a.keySystem}).filter(Boolean));"string"==typeof b&&(b=U.a[b]);"function"==typeof b&&(b=b(l()({},this.defaultTransportOptions,d)));a.i(A.a)(b,"player: transport "+c.transport+" is not supported");return{url:e,keySystems:g,supplementaryTextTracks:k,hideNativeSubtitle:C,supplementaryImageTracks:h,timeFragment:f,autoPlay:t,defaultAudioTrack:y,defaultTextTrack:n,transport:b,startAt:D}};f.prototype.loadVideo=function(){var d=0<arguments.length&&
...
{errorStream:d,audio:{cache:new I.a},video:{cache:new I.a},image:{maxRetry:0}}),t=a.i(D.a)(p,{requiresMediaSource:C.requiresMediaSource()}),l=a.i(L.a)({url:l,errorStream:d,keySystems:f,supplementaryTextTracks:k,hideNativeSubtitle:h,timings:t,supplementaryImageTracks:n,timeFragment:m,adaptive:x,pipelines:C,videoElement:p,autoPlay:r,startAt:b}).publish(),k=c(l,"stalled").startWith(null),f=c(l,"loaded").take(1).share(),k=f.mapTo("LOADED").concat(a.i(v.combineLatest)(this.playing,k,g)).distinctUntilChanged().startWith("LOADING"),
...
d.language}):!1:!1};f.prototype.isSubtitleAvailable=function(c){a.i(r.a)("isSubtitleAvailable is deprecated and won't be available in the next major version.");var d=a.i(y.b)(c);return d?(c=this.getAvailableTextTracks())?!!n()(c,function(a){return a.language===d.language}):!1:!1};f.prototype.setLanguage=function(c){a.i(r.a)("setLanguage is deprecated and won't be available in the next major version. Use setAudioTrack instead.");d(this);c=a.i(y.a)(c);a.i(A.a)(this.isLanguageAvailable(c),"player: unknown language");
this.adaptive.setAudioTrack(c)};f.prototype.setSubtitle=function(c){a.i(r.a)("setSubtitle is deprecated and won't be available in the next major version. Use setTextTrack instead.");d(this);null==c?(this.adaptive.setTextTrack(null),this._recordState("subtitle",null)):(c=a.i(y.b)(c),a.i(A.a)(this.isSubtitleAvailable(c),"player: unknown subtitle"),this.adaptive.setTextTrack(c))};f.prototype.setVideoBitrate=function(c){d(this);a.i(A.a)(0===c||0<=this.getAvailableVideoBitrates().indexOf(c),"player: video bitrate unavailable");
this.adaptive.setVideoBitrate(c)};f.prototype.setAudioBitrate=function(c){d(this);a.i(A.a)(0===c||0<=this.getAvailableAudioBitrates().indexOf(c),"player: audio bitrate unavailable");this.adaptive.setAudioBitrate(c)};f.prototype.setVideoMaxBitrate=function(c){a.i(r.a)("setVideoMaxBitrate is deprecated. Use setMaxVideoBitrate instead");return this.setMaxVideoBitrate(c)};f.prototype.setMaxVideoBitrate=function(a){this.adaptive.setVideoMaxBitrate(a)};f.prototype.setAudioMaxBitrate=function(c){a.i(r.a)("setAudioMaxBitrate is deprecated. Use setMaxAudioBitrate instead");
...
function(){x.a.toggleDebug(this,this.video)};f.prototype.getCurrentKeySystem=function(){return a.i(J.b)()};f.prototype.getAvailableAudioTracks=function(){var c=this.getAudioTrack();return this._manifest?a.i(z.a)(this._manifest).map(function(a){return l()({},a,{active:c.id===a.id})}):null};f.prototype.getAvailableTextTracks=function(){var c=this.getTextTrack();return this._manifest?a.i(z.b)(this._manifest).map(function(a){return l()({},a,{active:!!c&&c.id===a.id})}):null};f.prototype.getAudioTrack=
function(){return this.evts.audioTrack};f.prototype.getTextTrack=function(){return this.evts.textTrack};f.prototype.setAudioTrack=function(c){var d=n()(this.getAvailableAudioTracks(),function(a){return a.id===c});a.i(A.a)(d,"player: unknown audio track");this.adaptive.setAudioTrack(d)};f.prototype.setTextTrack=function(c){var d=n()(this.getAvailableTextTracks(),function(a){return a.id===c});a.i(A.a)(d,"player: unknown text track");this.adaptive.setTextTrack(d)};f.prototype.disableTextTrack=function(){this.adaptive.setTextTrack(null);
this._recordState("subtitle",null)};f.prototype.getImageTrackData=function(){return this._manifest?this._currentImagePlaylist:null};f.prototype.getMinimumPosition=function(){return this._manifest?a.i(D.g)(this._manifest):null};f.prototype.getMaximumPosition=function(){return this._manifest?a.i(D.d)(this._manifest):null};return f}(b.a);f.a=b},function(b,f,a){function m(a){return"audio"==a||"video"==a}function h(c,d,b){var l=c.getDuration(),f=b.start,k=b.end,n=/^\d*(\.\d+)? ?%$/;if(d){l=a.i(e.h)(c);
...
k)k=l;if(c.isLive){if(f)return a.i(e.f)(f,c);d=c.suggestedPresentationDelay;return a.i(e.d)(c)-(null==d?15:d)}a.i(g.a)(f<l&&k<=l,"stream: bad startTime and endTime");return f}return 0}var k=a(3),g=a(1),e=a(45),d=a(32),c=a(0);a.n(c);var l=a(13),n=a(10);a.n(n);var q=a(23);a.n(q);var t=a(11),p=a(79),v=a(75),u=a(71),r=a(42),w=a(6),y=a(43);f.a=function(b){function g(a,c,d){P[c]||(k.a.info("add sourcebuffer",d),P[c]=a.addSourceBuffer(d));return P[c]}function f(a,c,d,b){if(m(d))a=g(c,d,b);else{if(c=V[d])try{c.abort()}catch(B){k.a.warn(B)}finally{delete V[d]}if("text"==
d)k.a.info("add text sourcebuffer",b),a=new p.a(a,b,K);else if("image"==d)k.a.info("add image sourcebuffer",b),a=new v.a(b);else throw k.a.error("unknown buffer type "+d),new w.d("BUFFER_TYPE_UNKNOWN",null,!0);V[d]=a}return a}function x(a,c,d){var b=m(d);b?(a=P[d],delete P[d]):(a=V[d],delete V[d]);if(a)try{a.abort(),b&&c.removeSourceBuffer(a)}catch(B){k.a.warn(B)}}function H(c){var d=ca.map(function(d){var b;O?(b=d.clone(),b.ts=Math.min(d.ts,S.end),b.duration=Math.min(d.duration,S.end)):b=d;b.liveGap=
c.isLive?a.i(e.e)(c)-d.ts:Infinity;return b}),b=a.i(e.i)(d);return{timings:d,seekings:b}}function I(d,b,e,l,g,n,h){return W.getAdaptationsChoice(b,l).switchMap(function(l){if(!l)return x(G,d,b),a.i(u.a)(b);var q=f(G,d,b,e),r=W.getBufferAdapters(l);return a.i(u.b)({bufferType:b,sourceBuffer:q,adaptation:l,timings:g,seekings:n,adapters:r,pipeline:function(a){return N[b]({segment:a.segment,representation:a.representation,adaptation:l,manifest:h})},isLive:h.isLive})["catch"](function(a){k.a.error("buffer",
b,"has crashed",a);if(!m(b))return L.next(a),c.Observable.empty();throw a;})})}function T(c){var d=a.i(t.o)(G)["do"](function(){var a=h(c,X,S);k.a.info("set initial time",a);G.playbackRate=1;G.currentTime=a}),b=a.i(t.p)(G)["do"](function(){k.a.info("canplay event");ba&&G.play();ba=!0});return a.i(q.combineLatest)(d,b).take(1).mapTo({type:"loaded",value:!0})}function F(){return J&&J.length?a.i(r.c)(G,J,L):a.i(r.d)(G).map(function(){k.a.error("eme: ciphered media and no keySystem passed");throw new w.c("MEDIA_IS_ENCRYPTED_ERROR",
null,!0);})}function M(c,d){var b=d.changePlaybackRate,e=void 0===b?!0:b;return c.distinctUntilChanged(function(c,d){var b=d.stalled,l=c.stalled,g;g=l||b?l&&b?l.name==b.name:!1:!0;!g&&e&&(l?(k.a.info("resume playback",d.ts,d.name),G.playbackRate=l.playback):(k.a.info("stop playback",d.ts,d.name),G.playbackRate=0));b&&(b=d.buffered.getNextRangeGap(d.ts),a.i(t.q)(d)?(G.currentTime=d.ts,k.a.warn("after freeze seek",d.ts,d.range)):1>b&&(l=d.ts+b+1/60,G.currentTime=l,k.a.warn("discontinuity seek",d.ts,
b,l)));return g}).map(function(a){return{type:"stalled",value:a.stalled}})}function z(c){return R({url:c.getUrl()}).map(function(d){d=d.parsed;return{type:"manifest",value:a.i(y.d)(c,a.i(y.c)(d.url,d.manifest,E,Y))}})}function U(d,b,e,l){var f=Object.keys(b.adaptations).map(function(c){var f=b.adaptations[c],k=a.i(y.e)(f[0].representations[0]);m(c)&&g(d,c,k);return I(d,c,k,f,e,l,b)}),f=n.merge.apply(void 0,f);return b.isLive?f.concatMap(function(a){a:{switch(a.type){case "index-discontinuity":k.a.warn("explicit discontinuity seek",
a.value.ts);G.currentTime=a.value.ts;break;case "precondition-failed":b.updateLiveGap(1);k.a.warn("precondition failed",b.presentationLiveGap);break;case "out-of-index":k.a.info("out of index");a=z(b);break a}a=c.Observable.of(a)}return a}):f}function Q(){return a.i(l.a)(G,"error").mergeMap(function(){var a=void 0;switch(G.error.code){case 1:a="MEDIA_ERR_ABORTED";break;case 2:a="MEDIA_ERR_NETWORK";break;case 3:a="MEDIA_ERR_DECODE";break;case 4:a="MEDIA_ERR_SRC_NOT_SUPPORTED"}k.a.error("stream: video element MEDIA_ERR("+
a+")");throw new w.d(a,null,!0);})}var aa=b.url,L=b.errorStream,J=b.keySystems,E=b.supplementaryTextTracks,K=b.hideNativeSubtitle,Y=b.supplementaryImageTracks,ca=b.timings,S=b.timeFragment,W=b.adaptive,N=b.pipelines,G=b.videoElement,ba=b.autoPlay,X=b.startAt,O=Infinity>S.end,R=a.i(l.d)(N.manifest),P={},V={};b=ca.filter(function(a){var c=a.ts;a=a.duration;return 0<a&&.5>Math.min(a,S.end)-c});var Z=a.i(d.b)(function(d){var b=d.url,e=d.mediaSource;d=e?a.i(t.n)(e):c.Observable.of(null);return a.i(q.combineLatest)(R({url:b}),
d).mergeMap(function(d){d=d[0].parsed;d=a.i(y.c)(d.url,d.manifest,E,Y);if(e){var b=d.getDuration(),b=Infinity===b?Number.MAX_VALUE:b;e.duration!==b&&(e.duration=b,k.a.info("set duration",e.duration))}var b=H(d),l=b.timings,g=b.seekings,b=c.Observable.of({type:"manifest",value:d}),f=F(),h=M(l,{changePlaybackRate:N.requiresMediaSource()}),m=T(d);d=U(e,d,l,g);l=Q();return a.i(n.merge)(b,m,h,f,d,l)})},{totalRetry:3,retryDelay:250,resetDelay:6E4,shouldRetry:function(a){return!0!==a.fatal},errorSelector:function(c){a.i(w.e)(c)||
(c=new w.f("NONE",c,!0));c.fatal=!0;return c},onRetry:function(a,c){k.a.warn("stream retry",a,c);L.next(a)}});return function(d,b){return c.Observable.create(function(c){function e(){if(l&&"closed"!=l.readyState)for(var c=l,d=c.readyState,c=c.sourceBuffers,e=0;e<c.length;e++){var f=c[e];try{"open"==d&&f.abort(),l.removeSourceBuffer(f)}catch(fa){k.a.warn("error while disposing souceBuffer",fa)}}Object.keys(V).forEach(function(a){a=V[a];try{a.abort()}catch(da){k.a.warn("error while disposing souceBuffer",
da)}});a.i(t.l)(b);if(g)try{URL.revokeObjectURL(g)}catch(fa){k.a.warn("error while revoking ObjectURL",fa)}P={};V={};g=l=null}var l=void 0,g=void 0;e();if(N.requiresMediaSource()){if(!t.m)throw new w.d("MEDIA_SOURCE_NOT_SUPPORTED",null,!0);l=new t.m;g=URL.createObjectURL(l)}else l=null,g=d;b.src=g;c.next({url:d,mediaSource:l});k.a.info("create mediasource object",g);return e})}(aa,G).mergeMap(Z).takeUntil(b)}},function(b,f,a){function m(a,d){if("function"!==typeof d&&null!==d)throw new TypeError("Super expression must either be null or a function, not "+
...
for(var A;0<=--y;)if(A=w[y].match(c)){var C=A[2];n===A[1]&&("&nbsp;"===C?q[q.length-1].end=x:q.push({text:m(C),start:x}))}}return h}a.d(f,"a",function(){return h});var k=a(1),g=/&#([0-9]+);/g,e=/<br>/gi,d=/<style[^>]*>([\s\S]*?)<\/style[^>]*>/i,c=/\s*<p class=([^>]+)>(.*)/i,l=/<sync[^>]+?start="?([0-9]*)"?[^0-9]/i},function(b,f,a){function m(a){return a.responseData.getElementsByTagName("media")[0].getAttribute("src")}function h(a){return(a=a.match(F))&&a[1]||""}function k(a,c){return c?a.replace(F,
"?token="+c):a.replace(F,"")}function g(a,c,b){return a.replace(/\{bitrate\}/g,c.bitrate).replace(/\{start time\}/g,b.time)}var e=a(0);a.n(e);var d=a(12),c=a(3),l=a(26),n=a(49),q=a(102);b=a(101);var t=a(47),p=a(99),v=a(48),u=b.a.patchSegment,r=b.a.createVideoInitSegment,w=b.a.createAudioInitSegment,y=b.a.getMdat,x=b.a.getTraf,A=b.a.parseTfrf,C=b.a.parseTfxd,D={"application/x-sami":p.a,"application/smil":p.a,"application/ttml+xml":v.a,"application/ttml+xml+mp4":v.a,"text/vtt":function(a){return a}},
H=n.a.RequestResponse,I=/\.(isml?)(\?token=\S+)?$/,T=/\.wsx?(\?token=\S+)?/,F=/\?token=(\S+)/;f.a=function(){function b(a,b,d){var e=void 0,f=void 0;d?(a=x(a))?(e=A(a),f=C(a)):c.a.warn("smooth: could not find traf atom"):e=null;f||(f={d:b.duration,ts:b.time});return{nextSegments:e,currentSegment:f}}var f=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},p=a.i(q.a)(f),v=f.createXHR,F=function(c){var b=c.segment,d=c.representation,k=c.adaptation;c=c.manifest;if(b.isInit){c={};var h=k._smoothProtection||
{};switch(k.type){case "video":c=r(b.timescale,d.width,d.height,72,72,4,d._codecPrivateData,h.keyId,h.keySystems);break;case "audio":c=w(b.timescale,d._channels,d._bitsPerSample,d._packetSize,d._samplingRate,d._codecPrivateData,h.keyId,h.keySystems)}return e.Observable.of(new H(200,"","arraybuffer",Date.now()-100,Date.now(),c.length,c))}var n=f.segmentLoader,h=g(a.i(l.b)(d.baseURL),d,b),m={adaptation:k,representation:d,segment:b,transport:"smooth",url:h,manifest:c};return n?e.Observable.create(function(a){var c=
!1,b=!1,d=n(m,{reject:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};b||(c=!0,a.error(d))},resolve:function(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};b||(c=!0,a.next({responseData:d.data,size:d.size||0,duration:d.duration||0}),a.complete())},fallback:function(){b=!0;L(m).subscribe(a)}});return function(){c||b||"function"!==typeof d||d()}}):L(m)},L=function(c){var b=c.url,d=void 0;if(c=c.segment.range)d=c[0],d=(c=c[1])&&Infinity!==c?"bytes="+ +d+
"-"+ +c:"bytes="+ +d+"-",d={Range:d};return a.i(n.a)({url:b,responseType:"arraybuffer",headers:d,createXHR:v})},J={loader:function(a){return F({segment:a.segment,representation:a.representation,adaptation:a.adaptation,manifest:a.manifest})},parser:function(a){var c=a.segment,d=a.manifest;a=a.response.responseData;if(c.isInit)return e.Observable.of({segmentData:a,timings:null});a=new Uint8Array(a);d=b(a,c,d.isLive);c=d.nextSegments;d=d.currentSegment;a=u(a,d.ts);return e.Observable.of({segmentData:a,
nextSegments:c,currentSegment:d})}};return{directFile:!1,manifest:{resolver:function(c){c=c.url;var b=void 0,d=h(c),b=T.test(c)?a.i(n.a)({url:k(c,""),responseType:"document",resultSelector:m,createXHR:v}):e.Observable.of(c);return b.map(function(a){var c=a.match(I);a=c?a.replace(c[1],c[1]+"/manifest"):a;return{url:k(a,d)}})},loader:function(c){c=c.url;return a.i(n.a)({url:c,responseType:"document",createXHR:v})},parser:function(a){a=a.response;return e.Observable.of({manifest:p(a.responseData),url:a.url})}},
audio:J,video:J,text:{loader:function(c){var b=c.segment,d=c.representation;if(b.isInit)return e.Observable.empty();c=d.mimeType;var f=a.i(l.b)(d.baseURL),b=g(f,d,b);return 0<=c.indexOf("mp4")?a.i(n.a)({url:b,responseType:"arraybuffer",createXHR:v}):a.i(n.a)({url:b,responseType:"text",createXHR:v})},parser:function(c){var f=c.response,g=c.segment,l=c.manifest,k=c.adaptation.language,h=c.representation.mimeType;c=D[h];if(!c)throw Error("could not find a text-track parser for the type "+h);var n=f.responseData;
...
c);this.project=b;this.resultSelector=d;this.index=0}m(b,a);b.prototype._next=function(a){var b,c=this.index++;try{b=this.project(a,c)}catch(q){this.destination.error(q);return}this._innerSub(b,a,c)};b.prototype._innerSub=function(a,b,d){var c=this.innerSubscription;c&&c.unsubscribe();this.add(this.innerSubscription=h.subscribeToResult(this,a,b,d))};b.prototype._complete=function(){var b=this.innerSubscription;b&&!b.closed||a.prototype._complete.call(this)};b.prototype._unsubscribe=function(){this.innerSubscription=
null};b.prototype.notifyComplete=function(b){this.remove(b);this.innerSubscription=null;this.isStopped&&a.prototype._complete.call(this)};b.prototype.notifyNext=function(a,b,d,e,f){this.resultSelector?this._tryNotifyNext(a,b,d,e):this.destination.next(b)};b.prototype._tryNotifyNext=function(a,b,d,e){var c;try{c=this.resultSelector(a,b,d,e)}catch(p){this.destination.error(p);return}this.destination.next(c)};return b}(b.OuterSubscriber)},function(b,f,a){var m=this&&this.__extends||function(a,b){function c(){this.constructor=
