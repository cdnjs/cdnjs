...
w:[]))},avcc:function(a,b,c){return p("avcC",k([1,a[1],a[2],a[3],252|(2===c?1:4===c?3:0),225],d(a.length),a,[1],d(b.length),b))},dref:function(a){return p("dref",k(7,[1],a))},esds:function(a,b){return p("esds",k(4,[3,25],d(a),[0,4,17,64,21],11,[5,2],w(b),[6,1,2]))},frma:function(a){return p("frma",u(a))},free:function(a){return p("free",new Uint8Array(a-8))},ftyp:function(a,b){return p("ftyp",k.apply(null,[u(a),[0,0,0,1]].concat(b.map(u))))},hdlr:function(a){return p("hdlr",k(8,u("audio"===a?"soun":
"vide"),12,u("Media Handler")))},mdhd:function(a){return p("mdhd",k(12,x(a),8))},moof:function(a,b){return y.mult("moof",[a,b])},mp4aenca:function(a,b,c,e,f,h,l,m){return p(a,k(6,d(b),8,d(c),d(e),2,d(f),d(h),2,l,"enca"===a?m:[]))},mvhd:function(a,b){return p("mvhd",k(12,x(a),4,[0,1],2,[1,0],10,[0,1],14,[0,1],14,[64,0,0,0],26,d(b+1)))},pssh:function(a){var b=1>=arguments.length||void 0===arguments[1]?[]:arguments[1],c=2>=arguments.length||void 0===arguments[2]?[]:arguments[2];a=a.replace(/-/g,"");
v(32===a.length,"wrong system id length");var d,e=c.length;0<e?(d=1,c=k.apply(null,[x(e)].concat(c))):(d=0,c=[]);return p("pssh",k([d,0,0,0],w(a),c,x(b.length),b))},saio:function(a,b,c,d){return p("saio",k(4,[0,0,0,1],x(a.length+b.length+c.length+d.length+8+8+8+8)))},saiz:function(a){if(0===a.length)return p("saiz",new Uint8Array);var b=e(a,0),c=e(a,4),d=new Uint8Array(9+c);d.set(x(c),5);for(var c=9,f=8,h,k;f<a.length;)f+=8,2===(b&2)?(k=2,h=C(a,f),f+=2+6*h):k=h=0,d[c]=6*h+8+k,c++;return p("saiz",
d)},schm:function(a,b){return p("schm",k(4,u(a),x(b)))},senc:function(a){return p("senc",a)},smhd:function(){return p("smhd",new Uint8Array(8))},stsd:function(a){return p("stsd",k.apply(null,[7,[a.length]].concat(a)))},tkhd:function(a,b,c){return p("tkhd",k(x(7),8,x(c),20,[1,0,0,0],[0,1,0,0],12,[0,1,0,0],12,[64,0,0,0],d(a),2,d(b),2))},trex:function(a){return p("trex",k(4,x(a),[0,0,0,1],12))},tfdt:function(a){return p("tfdt",k([1,0,0,0],F(a)))},tenc:function(a,b,c){return p("tenc",k(6,[a,b],w(c)))},
traf:function(a,b,c,d,e){var f=[a,b,c];d&&f.push(y.senc(d),y.saiz(d),y.saio(e,a,b,c));return y.mult("traf",f)},trun:function(a){if(a[11]&1)return a;var b=new Uint8Array(a.length+4);b.set(x(a.length+4),0);b.set(a.slice(4,16),4);b[11]|=1;b.set([0,0,0,0],16);b.set(a.slice(16,a.length),20);return b},vmhd:function(){var a=new Uint8Array(12);a[3]=1;return p("vmhd",a)}},I={traf:function(a){return(a=l(a,1836019558))?l(a,1953653094):null},senc:function(a){return q(a,2721664850,1520127764,2722393154,2086964724)},
tfxd:function(a){return q(a,1830656773,1121273062,2162299933,2952222642)},tfrf:function(a){return q(a,3565190898,3392751253,2387879627,2655430559)},mdat:function(a){return l(a,1835295092)}};r.exports={getMdat:I.mdat,getTraf:I.traf,parseTfrf:function(a){a=I.tfrf(a);if(!a)return[];for(var b=[],c=a[0],d=a[4],f=0;f<d;f++){var h,k;1==c?(k=J(a,16*f+5),h=J(a,16*f+13)):(k=e(a,8*f+5),h=e(a,8*f+9));b.push({ts:k,d:h})}return b},parseTfxd:function(a){if(a=I.tfxd(a))return{d:J(a,12),ts:J(a,4)}},createVideoInitSegment:function(a,
c,d,e,f,h,k,l,m){m||(m=[]);var p=k.split("00000001");k=p[2];p=w(p[1]);k=w(k);h=y.avcc(p,k,h);m.length?(l=y.tenc(1,8,l),l=y.mult("schi",[l]),k=y.schm("cenc",65536),p=y.frma("avc1"),l=y.mult("sinf",[p,k,l]),e=y.avc1encv("encv",1,c,d,e,f,"AVC Coding",24,h,l)):e=y.avc1encv("avc1",1,c,d,e,f,"AVC Coding",24,h);e=y.stsd([e]);return b(a,"video",e,y.vmhd(),c,d,m)},createAudioInitSegment:function(a,c,e,f,h,k,l,p){p||(p=[]);k||(k=H.indexOf(h),k=((32|k&31)<<4|c&31)<<3,k=m(d(k)));k=y.esds(1,k);if(p.length){l=
y.tenc(1,8,l);l=y.mult("schi",[l]);var q=y.schm("cenc",65536),u=y.frma("mp4a");l=y.mult("sinf",[u,q,l]);c=y.mp4aenca("enca",1,c,e,f,h,k,l)}else c=y.mp4aenca("mp4a",1,c,e,f,h,k);c=y.stsd([c]);return b(a,"audio",c,y.smhd(),0,0,p)},patchSegment:function(a,b){var c=a.subarray(0,e(a,0)),d=y.tfdt(b),f=d.length,h=e(c,8),k=e(c,8+h),l=e(c,8+h+8),m=e(c,8+h+8+l),p=c.subarray(8,8+h),q=c.subarray(8+h+8,8+h+8+k-8),k=q.subarray(0,l),m=q.subarray(l,l+m);k.set([0,0,0,1],12);q=I.senc(q);m=y.trun(m);d=y.traf(k,d,m,
q,p);p=y.moof(p,d);f=8+h+8+l+f;l=a.length;h=p.length;d=c.length;c=a.subarray(d,l);l=new Uint8Array(h+(l-d));l.set(p,0);l.set(c,h);l.set(x(p.length+8),f+16);return l}}},function(r,h,c){function p(a){return"boolean"==typeof a?a:"string"==typeof a?"TRUE"===a.toUpperCase():!1}function q(b){var c=a.last(b.timeline);return(c.ts+(c.r+1)*c.d)/b.timescale}function l(a){return[{systemId:"edef8ba9-79d6-4ace-a3c8-27dcd51d21ed",privateData:f.concat([8,1,18,16],a)}]}var a=c(1),b=c(2),f=c(7),v={audio:"audio/mp4",
video:"video/mp4",text:"application/ttml+xml"},k={audio:"mp4a.40.2",video:"avc1.4D401E"};h={AACL:"audio/mp4",AVC1:"video/mp4",H264:"video/mp4",TTML:"application/ttml+xml+mp4"};c={AACL:"mp4a.40.5",AACH:"mp4a.40.5",AVC1:"avc1.4D401E",H264:"avc1.4D401E"};var u={audio:[["Bitrate","bitrate",parseInt],["AudioTag","audiotag",parseInt],["FourCC","mimeType",h],["FourCC","codecs",c],["Channels","channels",parseInt],["SamplingRate","samplingRate",parseInt],["BitsPerSample","bitsPerSample",parseInt],["PacketSize",
"packetSize",parseInt],["CodecPrivateData","codecPrivateData",String]],video:[["Bitrate","bitrate",parseInt],["FourCC","mimeType",h],["FourCC","codecs",c],["MaxWidth","width",parseInt],["MaxHeight","height",parseInt],["CodecPrivateData","codecPrivateData",String]],text:[["Bitrate","bitrate",parseInt],["FourCC","mimeType",h]]};r.exports=function(){function c(a,b,d){for(a=a.firstElementChild;a;)d=b(d,a.nodeName,a),a=a.nextElementSibling;return d}function h(b,c){return a.reduce(c,function(c,d){var e=
d[0],f=d[2];c[d[1]]=a.isFunction(f)?f(b.getAttribute(e)):f[b.getAttribute(e)];return c},{})}function r(d,e){d.hasAttribute("Timescale")&&(e=+d.getAttribute("Timescale"));var f=d.getAttribute("Type"),l=d.getAttribute("Subtype"),p=u[f];b(p,"parser: unrecognized QualityLevel type "+f);var q=0,x=c(d,function(a,b,c){switch(b){case "QualityLevel":c=h(c,p);if("video"!=f||c.bitrate>N)c.id=q++,a.representations.push(c);break;case "c":b=a.index;var d=a.index.timeline,e=d.length,k=0<e?d[e-1]:{d:0,ts:0,r:0},
l=+c.getAttribute("d"),t=c.getAttribute("t");(c=+c.getAttribute("r"))&&c--;0<e&&!k.d&&(k.d=t-k.ts,d[e-1]=k);0<e&&l==k.d&&null==t?k.r+=(c||0)+1:d.push({d:l,ts:null==t?k.ts+k.d*(k.r+1):+t,r:c});b.timeline=d}return a},{representations:[],index:{timeline:[],indexType:"timeline",timescale:e,initialization:{}}}),C=x.representations,x=x.index;b(C.length,"parser: adaptation should have at least one representation");var y=C[0].codecs;y||(y=k[f],a.each(C,function(a){return a.codecs=y}));var J=C[0].mimeType;
J||(J=v[f],a.each(C,function(a){return a.mimeType=J}));return"ADVT"==l?null:{type:f,index:x,representations:C,name:d.getAttribute("Name"),lang:d.getAttribute("Language"),baseURL:d.getAttribute("Url")}}function d(a){return e((new DOMParser).parseFromString(a,"application/xml"))}function e(d){d=d.documentElement;b.equal(d.nodeName,"SmoothStreamingMedia","parser: document root should be SmoothStreamingMedia");b(/^[2]-[0-2]$/.test(d.getAttribute("MajorVersion")+"-"+d.getAttribute("MinorVersion")),"Version should be 2.0, 2.1 or 2.2");
var e=+d.getAttribute("Timescale")||1E7,h=0,k=c(d,function(a,c,d){switch(c){case "Protection":d=d.firstElementChild;b.equal(d.nodeName,"ProtectionHeader","parser: Protection should have ProtectionHeader child");c=f.strToBytes(atob(d.textContent));var k;k=f.le2toi(c,8);k=f.bytesToUTF16Str(c.subarray(10,10+k));k=(new DOMParser).parseFromString(k,"application/xml").querySelector("KID").textContent;k=f.guidToUuid(atob(k)).toLowerCase();var l=f.hexToBytes(k);d=d.getAttribute("SystemID").toLowerCase().replace(/\{|\}/g,
"");c={keyId:k,keySystems:[{systemId:d,privateData:c}].concat(y(l))};a.protection=c;break;case "StreamIndex":if(c=r(d,e))c.id=h++,a.adaptations.push(c)}return a},{protection:null,adaptations:[]}),l=k.protection,k=k.adaptations;a.each(k,function(a){return a.smoothProtection=l});var m,u,x,v,J=p(d.getAttribute("IsLive"));if(J){m=F;x=+d.getAttribute("DVRWindowLength")/e;v=H;u=a.find(k,function(a){return"video"==a.type});var N=a.find(k,function(a){return"audio"==a.type});u=Math.min(q(u.index),q(N.index));
u=Date.now()/1E3-(u+v)}return{transportType:"smoothstreaming",profiles:"",type:J?"dynamic":"static",suggestedPresentationDelay:m,timeShiftBufferDepth:x,presentationLiveGap:u,availabilityStartTime:v,periods:[{duration:(+d.getAttribute("Duration")||Infinity)/e,adaptations:k,laFragCount:+d.getAttribute("LookAheadFragmentCount")}]}}function x(b){if(a.isString(b))return d(b);if(b instanceof window.Document)return e(b);throw Error("parser: unsupported type to parse");}var J=0>=arguments.length||void 0===
arguments[0]?{}:arguments[0],F=J.suggestedPresentationDelay||20,H=J.referenceDateTime||Date.UTC(1970,0,1,0,0,0,0)/1E3,N=J.minRepresentationBitrate||19E4,y=J.keySystems||l;x.parseFromString=d;x.parseFromDocument=e;return x}},function(r,h,c){function p(c){return c.replace(b,"\n").replace(a,function(a,b){return String.fromCharCode(b)})}var q=c(1),l=c(2),a=/&#([0-9]+);/g,b=/<br>/gi,f=/<style[^>]*>([\s\S]*?)<\/style[^>]*>/i,v=/\s*<p class=([^>]+)>(.*)/i,k=/<sync[^>]+?start="?([0-9]*)"?[^0-9]/i;r.exports=
{parseSami:function(a,b){var c=/<sync[ >]/ig,h=/<sync[ >]|<\/body>/ig,d=[],e=a.match(f)[1],x,r=h.exec(a),r=/\.(\S+)\s*{([^}]*)}/gi,F;for(x={};F=r.exec(e);){var H=F[1];F=F[2].match(/\s*lang:\s*(\S+);/i)[1];H&&F&&(x[F]=H)}e=x[b];for(l(e,"sami: could not find lang "+b+" in CSS");;){x=c.exec(a);r=h.exec(a);if(!x&&!r)break;if(!x||!r||x.index>=r.index)throw Error("parse error");x=a.slice(x.index,r.index);r=x.match(k);if(!r)throw Error("parse error: sync time attribute");H=+r[1];if(isNaN(H))throw Error("parse error: sync time attribute NaN");
r=d;x=x.split("\n");H/=1E3;F=x.length;for(var N=void 0;0<=--F;)if(N=x[F].match(v)){var y=N[2];e===N[1]&&("&nbsp;"===y?q.last(r).end=H:r.push({text:p(y),start:H}))}}return d}}},function(r,h,c){function p(b,c){var f=0;b=b.firstChild;for(var h=[],d;b;){if(1===b.nodeType)switch(b.tagName.toUpperCase()){case "P":d=b;var e=c,k=q(d.getAttribute("begin"),e),r=q(d.getAttribute("end"),e),F=q(d.getAttribute("dur"),0);if(!l.isNumber(k)&&!l.isNumber(r)&&!l.isNumber(F))throw Error("ttml: unsupported timestamp format");
0<F?(null==k&&(k=f||e),null==r&&(r=k+F)):null==r&&(r=q(d.getAttribute("duration"),0),r=0<=r?r+k:Number.MAX_VALUE);d={id:d.getAttribute("xml:id")||d.getAttribute("id"),text:decodeURIComponent(v(d.innerHTML.replace(a,"\n"))),start:k,end:r};f=d.end;h.push(d);break;case "DIV":d=q(b.getAttribute("begin"),0),null==d&&(d=c),h.push.apply(h,p(b,d))}b=b.nextSibling}return h}function q(a,c){if(a){var h;if(h=a.match(b)){var l=h[3],d=h[4],e=h[6];return 3600*parseInt(h[2]||0,10)+60*parseInt(l,10)+parseInt(d,10)+
parseFloat("0."+e)}if(h=a.match(f))return l=h[4],parseFloat(h[1])*k[l]+c}}var l=c(1),a=/<br[^>]+>/gm,b=/^(([0-9]+):)?([0-9]+):([0-9]+)(\.([0-9]+))?$/,f=/(([0-9]+)(\.[0-9]+)?)(ms|h|m|s)/,v=window.escape,k={h:3600,m:60,s:1,ms:.001};r.exports={parseTTML:function(a,b,c){a=l.isString(a)?(new DOMParser).parseFromString(a,"text/xml"):a;if(!(a instanceof window.Document||a instanceof window.HTMLElement))throw Error("ttml: needs a Document to parse");a=a.querySelector("tt");if(!a)throw Error("ttml: could not find <tt> tag");
a=p(a.querySelector("body"),0);l.each(a,function(a){a.start+=c;a.end+=c});return a}}},function(r,h){function c(){this.arr=[]}c.prototype.add=function(c){this.arr.push(c)};c.prototype.remove=function(c){c=this.arr.indexOf(c);0<=c&&this.arr.splice(c,1)};c.prototype.test=function(c){return 0<=this.arr.indexOf(c)};c.prototype.size=function(){return this.arr.length};r.exports={ArraySet:c}},function(r,h,c){function p(a){return null==a?"":String(a).replace(u,function(a){return w[a]})}function q(a){var b=
a.getAverageBitrates(),c,e;b.video.subscribe(function(a){return e=a|0}).dispose();b.audio.subscribe(function(a){return c=a|0}).dispose();return{manifest:a.man,version:a.version,timeFragment:a.frag,currentTime:a.getCurrentTime(),state:a.getPlayerState(),buffer:f(a.video.buffered),volume:a.getVolume(),video:{adaptation:a.adas.video,representation:a.reps.video,maxBitrate:a.getVideoMaxBitrate(),bufferSize:a.getVideoBufferSize(),avrBitrate:e},audio:{adaptation:a.adas.audio,representation:a.reps.audio,
