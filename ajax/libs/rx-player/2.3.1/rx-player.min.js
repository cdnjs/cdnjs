...
f=a(52);a.n(f);var D=a(145);a.n(D);var T=a(51);a.n(T);a(3);var K=a(30),L=a(12),A=a(1),G=a(13),M=a(6),aa=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(c,d,e){d&&a(c.prototype,d);e&&a(c,e);return c}}(),R=f.FromEventObservable.create,O=D.NeverObservable.create,U=T.DeferObservable.create,F=document,J=window,Z=["","webkit","moz","ms"],ba=J.HTMLElement,Q=J.HTMLVideoElement,
X=J.MediaSource||J.MozMediaSource||J.WebKitMediaSource||J.MSMediaSource,N=J.MediaKeys||J.MozMediaKeys||J.WebKitMediaKeys||J.MSMediaKeys,H="Microsoft Internet Explorer"==navigator.appName||"Netscape"==navigator.appName&&/(Trident|Edge)\//.test(navigator.userAgent),Y=-1!==navigator.userAgent.toLowerCase().indexOf("firefox"),V=1,P=4,W=function(){},I=void 0;navigator.requestMediaKeySystemAccess&&(I=function(c,d){return a.i(G.b)(navigator.requestMediaKeySystemAccess(c,d))});var S=function(){function a(c,
...
"ready"]),fa=k(["keyerror","error"]),D=k(["keystatuseschange"]),B={onEncrypted:f,onKeyMessage:ga,onKeyStatusesChange:D,onKeyError:fa};if(!I&&Q.prototype.webkitGenerateKeyRequest){var ia=function(c,d){var e=this;K.a.call(this);this.sessionId="";this._vid=c;this._key=d;this._con=a.i(E.merge)(ga(c),da(c),fa(c)).subscribe(function(a){return e.trigger(a.type,a)})};ia.prototype=b()({generateRequest:function(a,c){this._vid.webkitGenerateKeyRequest(this._key,c)},update:n(function(c,d){if(0<=this._key.indexOf("clearkey")){var e=
JSON.parse(a.i(L.a)(c)),l=a.i(L.b)(atob(e.keys[0].k)),e=a.i(L.b)(atob(e.keys[0].kid));this._vid.webkitAddKey(this._key,l,e,d)}else this._vid.webkitAddKey(this._key,c,null,d);this.sessionId=d}),close:function(){this._con&&this._con.unsubscribe();this._vid=this._con=null}},K.a.prototype);W=function(a){this.ks_=a};W.prototype={_setVideo:function(a){this._vid=a},createSession:function(){return new ia(this._vid,this.ks_)}};var pa=function(a){var c=F.querySelector("video")||F.createElement("video");return c&&
...
distinctiveIdentifier:"not-allowed",persistentState:"not-allowed",sessionTypes:["temporary"]},C.Observable.of(new S(a,new W(a),d))}return C.Observable["throw"]()}}else if(N&&!I){var ja=function(a){K.a.call(this);this.sessionId="";this._mk=a};ja.prototype=b()({generateRequest:function(c,d){var e=this;this._ss=this._mk.memCreateSession("video/mp4",d);this._con=a.i(E.merge)(ga(this._ss),da(this._ss),fa(this._ss)).subscribe(function(a){return e.trigger(a.type,a)})},update:n(function(c,d){a.i(A.a)(this._ss);
this._ss.update(c,d);this.sessionId=d},function(){return this._ss}),close:function(){this._ss&&(this._ss.close(),this._ss=null);this._con&&(this._con.unsubscribe(),this._con=null)}},K.a.prototype);N.prototype.alwaysRenew=!0;N.prototype.memCreateSession=N.prototype.createSession;N.prototype.createSession=function(){return new ja(this)};I=function(a,c){if(!N.isTypeSupported(a))return C.Observable["throw"]();for(var d=0;d<c.length;d++){var e=c[d],l=e.videoCapabilities,g=e.audioCapabilities,k=e.initDataTypes,
e=e.distinctiveIdentifier,b=!0;if(b=(b=b&&(!k||!!k.filter(function(a){return"cenc"===a})[0]))&&"required"!==e)return d={videoCapabilities:l,audioCapabilities:g,initDataTypes:["cenc"],distinctiveIdentifier:"not-allowed",persistentState:"required",sessionTypes:["temporary","persistent-license"]},C.Observable.of(new S(a,new N(a),d))}return C.Observable["throw"]()}}N||(b=function(){throw new M.d("MEDIA_KEYS_NOT_SUPPORTED",null,!0);},N={create:b,isTypeSupported:b});var oa=function(c,d){return U(function(){return a.i(G.b)(q(c,
d))})};if(J.WebKitSourceBuffer&&!J.WebKitSourceBuffer.prototype.addEventListener){b=J.WebKitSourceBuffer.prototype;for(var ka in K.a.prototype)b[ka]=K.a.prototype[ka];b.__listeners=[];b.appendBuffer=function(a){if(this.updating)throw Error("updating");this.trigger("updatestart");this.updating=!0;try{this.append(a)}catch(la){this.__emitUpdate("error",la);return}this.__emitUpdate("update")};b.__emitUpdate=function(a,c){var d=this;setTimeout(function(){d.trigger(a,c);d.updating=!1;d.trigger("updateend")},
...
d.complete()},function(){A.a.debug("eme: rejected access to keysystem",h,m);g=null;e(k+1)})}}var b=!1,g=null;e(0);return function(){b=!0;g&&g.unsubscribe()}})}function n(c,d,e){var b=S,l=P;return a.i(M.b)(e.createMediaKeys()).mergeMap(function(g){P=g;W=e.getConfiguration();I=d;S=c;if(c.mediaKeys===g)return D.Observable.of(g);l&&l!==P&&V.dispose();var k;b&&b!==S?(A.a.debug("eme: unlink old video element and set mediakeys"),k=a.i(R.j)(b,null).concat(a.i(R.j)(S,g))):(A.a.debug("eme: set mediakeys"),
k=a.i(R.j)(S,g));return k.mapTo(g)})}function q(a,c,d,e,b){A.a.debug("eme: create a new "+c+" session");var l=a.createSession(c);a=r(l,d,b)["finally"](function(){V.deleteAndClose(l);Y["delete"](e)}).publish();return{session:l,sessionEvents:a}}function t(c,d,b,l,g,k){c=q(c,b,d,g,k);var n=c.session;c=c.sessionEvents;V.add(g,n,c);A.a.debug("eme: generate request",l,g);l=a.i(M.b)(n.generateRequest(l,g))["catch"](function(a){throw new O.c("KEY_GENERATE_REQUEST_ERROR",a,!1);})["do"](function(){"persistent-license"==
b&&Y.add(g,n)}).mapTo(e("generated-request",n,{initData:g,initDataType:l}));return a.i(K.merge)(c,l)}function p(a,c,d,e,b,l){return t(a,c,d,e,b,l)["catch"](function(g){if(g.code!==O.b.KEY_GENERATE_REQUEST_ERROR)throw g;var k=V.getFirst();if(!k)throw g;A.a.warn("eme: could not create a new session, retry after closing a currently loaded session",g);return V.deleteAndClose(k).mergeMap(function(){return t(a,c,d,e,b,l)})})}function v(c,d,b,l,g,k){A.a.debug("eme: load persisted session",b);var n=q(c,"persistent-license",
d,g,k),h=n.session,f=n.sessionEvents;return a.i(M.b)(h.load(b))["catch"](function(){return D.Observable.of(!1)}).mergeMap(function(a){if(a)return V.add(g,h,f),Y.add(g,h),f.startWith(e("loaded-session",h,{storedSessionId:b}));A.a.warn("eme: no data stored for the loaded session, do fallback",b);V.deleteById(b);Y["delete"](g);h.sessionId&&h.remove();return p(c,d,"persistent-license",l,g,k).startWith(e("loaded-session-failed",h,{storedSessionId:b}))})}function u(a,c,d,b,g,l){var k=V.get(g);if(k&&k.sessionId)return A.a.debug("eme: reuse loaded session",
k.sessionId),D.Observable.of(e("reuse-session",k));c=(k=(c=c.sessionTypes)&&0<=c.indexOf("persistent-license"))&&d.persistentLicense?"persistent-license":"temporary";return k&&d.persistentLicense&&(k=Y.get(g))?v(a,d,k.sessionId,b,g,l):p(a,d,c,b,g,l)}function r(c,d,b){function g(a,c){return a.type===O.a.ENCRYPTED_MEDIA_ERROR?(a.fatal=c,a):new O.c("KEY_LOAD_ERROR",a,c)}A.a.debug("eme: handle message events",c);var l=void 0,k={totalRetry:2,retryDelay:200,errorSelector:function(a){return g(a,!0)},onRetry:function(a){return b.next(g(a,
!1))}},n=J(c).map(function(a){throw new O.c("KEY_ERROR",a,!0);}),h=Z(c).mergeMap(function(e){l=e.sessionId;A.a.debug("eme: keystatuseschange event",l,c,e);c.keyStatuses.forEach(function(a,c){if(H[c]||H[a])throw new O.c("KEY_STATUS_CHANGE_ERROR",c,!0);});return d.onKeyStatusesChange?a.i(M.c)(function(){return a.i(M.b)(d.onKeyStatusesChange(e,c))})["catch"](function(a){throw new O.c("KEY_STATUS_CHANGE_ERROR",a,!0);}):(A.a.info("eme: keystatuseschange event not handled"),ba())}),f=F(c).mergeMap(function(e){l=
e.sessionId;var b=new Uint8Array(e.message),g=e.messageType||"license-request";A.a.debug("eme: event message type "+g,c,e);e=Q(function(){return a.i(M.b)(d.getLicense(b,g)).timeout(1E4)["catch"](function(a){if(a instanceof L.TimeoutError)throw new O.c("KEY_LOAD_TIMEOUT",null,!1);throw a;})});return a.i(aa.a)(e,k)}),h=a.i(K.merge)(f,h).concatMap(function(d){A.a.debug("eme: update session",l,d);return a.i(M.b)(c.update(d,l))["catch"](function(a){throw new O.c("KEY_UPDATE_ERROR",a,!0);}).mapTo(e("session-update",
c,{updatedWith:d}))}),n=a.i(K.merge)(h,n);return c.closed?n.takeUntil(a.i(M.b)(c.closed)):n}function w(c,d){return a.i(M.b)(c.setServerCertificate(d)).ignoreElements()["catch"](function(a){throw new O.c("LICENSE_SERVER_CERTIFICATE_ERROR",a,!0);})}function y(a,c,d){return w(a,c)["catch"](function(a){a.fatal=!1;d.next(a);return D.Observable.empty()})}function x(c,d,e){function b(a,d){var b=d.keySystem,g=d.keySystemAccess;b.persistentLicense&&Y.setStorage(b.licenseStorage);A.a.info("eme: encrypted event",
a);return n(c,b,g).mergeMap(function(c){var d=b.serverCertificate;return(d&&"function"===typeof c.setServerCertificate?y(c,d,e):D.Observable.empty()).concat(u(c,g.getConfiguration(),b,a.initDataType,new Uint8Array(a.initData),e))})}return a.i(T.combineLatest)(U(c),l(d)).take(1).mergeMap(function(a){return b(a[0],a[1])})}function z(){return I&&I.type}function C(){S&&a.i(R.j)(S,null).subscribe(function(){});S=I=P=null;V.dispose()}a.d(f,"c",function(){return x});a.d(f,"b",function(){return z});a.d(f,
"d",function(){return U});a.d(f,"a",function(){return C});b=a(7);var E=a.n(b),D=a(0);a.n(D);b=a(9);a.n(b);f=a(51);a.n(f);var T=a(23);a.n(T);var K=a(10);a.n(K);var L=a(61);a.n(L);var A=a(3),G=a(1),M=a(13),aa=a(32),R=a(11),O=a(6),U=R.f.onEncrypted,F=R.f.onKeyMessage,J=R.f.onKeyError,Z=R.f.onKeyStatusesChange,ba=b.EmptyObservable.create,Q=f.DeferObservable.create,X={clearkey:["webkit-org.w3.clearkey","org.w3.clearkey"],widevine:["com.widevine.alpha"],playready:["com.microsoft.playready","com.chromecast.playready",
"com.youtube.playready"]},N=["HW_SECURE_ALL","HW_SECURE_DECODE","HW_SECURE_CRYPTO","SW_SECURE_DECODE","SW_SECURE_CRYPTO"],H={expired:!0,"internal-error":!0};b=function(){function a(){k(this,a);this._entries=[]}a.prototype.find=function(a){for(var c=0;c<this._entries.length;c++)if(!0===a(this._entries[c]))return this._entries[c];return null};return a}();f=function(c){function d(){k(this,d);return m(this,c.apply(this,arguments))}h(d,c);d.prototype.getFirst=function(){if(0<this._entries.length)return this._entries[0].session};
...
a});return c?this["delete"](c.session):null};d.prototype["delete"]=function(a){var c=this.find(function(c){return c.session===a});if(!c)return null;var d=c.session,e=c.eventSubscription;A.a.debug("eme-mem-store: delete session",c);c=this._entries.indexOf(c);this._entries.splice(c,1);e.unsubscribe();return d};d.prototype.deleteAndClose=function(c){return(c=this["delete"](c))?(A.a.debug("eme-mem-store: close session",c),a.i(M.b)(c.close())["catch"](function(){return D.Observable.of(null)})):D.Observable.of(null)};
d.prototype.dispose=function(){var a=this,c=this._entries.map(function(c){return a.deleteAndClose(c.session)});this._entries=[];return K.merge.apply(null,c)};return d}(b);var Y=new (function(c){function d(a){k(this,d);var e=m(this,c.call(this));e.setStorage(a);return e}h(d,c);d.prototype.setStorage=function(c){if(this._storage!==c){a.i(G.a)(c,"no licenseStorage given for keySystem with persistentLicense");G.a.iface(c,"licenseStorage",{save:"function",load:"function"});this._storage=c;try{this._entries=
...
I=void 0,S=void 0},function(b,f,a){function m(c){var d=a.i(r.a)(c.locations[0]);(c=c.periods[0])&&c.baseURL&&(d+=""+c.baseURL);return d}function h(a,b,g,l){if(!b.transportType)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);b.id=b.id||D++;b.type=b.type||"static";var n=b.locations;n&&n.length||(b.locations=[a]);b.isLive="dynamic"==b.type;var h={rootURL:m(b),baseURL:b.baseURL,isLive:b.isLive};g&&(g=e(g));l&&(l=d(l));a=b.periods.map(function(a){return k(a,h,g,l)});b=c(b,a[0]);b.periods=null;b.duration||
(b.duration=Infinity);b.isLive&&(b.suggestedPresentationDelay=b.suggestedPresentationDelay||K,b.availabilityStartTime=b.availabilityStartTime||0);return new z.a(b)}function k(a,c,d,e){a.id=a.id||D++;var b=a.adaptations,b=b.concat(d||[]),b=b.concat(e||[]),b=b.map(function(a){return g(a,c)}),b=b.filter(function(a){return 0>T.indexOf(a.type)?(u.a.info("not supported adaptation type",a.type),!1):!0});if(0===b.length)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);d={};for(e=0;e<b.length;e++){var l=b[e],
k=l.type,n=l.representations;d[k]=d[k]||[];0<n.length&&d[k].push(l)}for(var h in d)if(0===d[h].length)throw new y.d("MANIFEST_INCOMPATIBLE_CODECS_ERROR",null,!0);a.adaptations=d;return a}function g(d,e){if("undefined"==typeof d.id)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);var b=c(e,d),g={};E.forEach(function(a){a in b&&(g[a]=b[a])});var l=b.representations.map(function(d){var e=b.rootURL,l=b.baseURL;if("undefined"==typeof d.id)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);d=c(g,d);d.index=d.index||
{};d.index.timescale||(d.index.timescale=1);d.bitrate||(d.bitrate=1);"mp4a.40.02"==d.codecs&&(d.codecs="mp4a.40.2");d.baseURL=a.i(r.b)(e,l,d.baseURL);d.codec=d.codecs;return d}).sort(function(a,c){return a.bitrate-c.bitrate}),k=b.type,h=b.accessibility,h=void 0===h?[]:h;if(!k)throw new y.d("MANIFEST_PARSE_ERROR",null,!0);"video"==k||"audio"==k?(l=l.filter(function(c){return a.i(w.k)(n(c))}),"audio"===k&&(k=a.i(v.a)(h,"visuallyImpaired"),b.audioDescription=k)):"text"===k&&(k=a.i(v.a)(h,"hardOfHearing"),
b.closedCaption=k);b.representations=l;b.bitrates=l.map(function(a){return a.bitrate});return b}function e(a){Array.isArray(a)||(a=[a]);return a.reduce(function(a,c){var d=c.mimeType,e=c.url,b=c.language,l=c.languages,g=c.closedCaption;b&&(l=[b]);return a.concat(l.map(function(a){return{id:D++,type:"text",language:a,closedCaption:!!g,baseURL:e,representations:[{id:D++,mimeType:d,index:{indexType:"template",duration:Number.MAX_VALUE,timescale:1,startNumber:0}}]}}))},[])}function d(a){Array.isArray(a)||
...
a[l]=g.slice(0):a[l]=c(g):a[l]=g}}return a}function l(a,c){for(var d=function(a,c){return p()(c,function(c){return c.id===a})},e=a.getAdaptations(),b=c.getAdaptations(),g=0;g<e.length;g++){var l=d(e[g].id,b);l||console.warn('manifest: adaptation "'+e[g].id+'" not found when merging.');for(var k=e[g].representations,l=l.representations,n=0;n<k.length;n++){var h=d(k[n].id,l);h||console.warn('manifest: representation "'+k[n].id+'" not found when merging.');k[n].index.update(h.index)}}return a}function n(a){return a.mimeType+
...
g),h=function(){return a.off(b,g)};else if(a&&"function"===typeof a.addListener&&"function"===typeof a.removeListener)a.addListener(b,g),h=function(){return a.removeListener(b,g)};else throw new TypeError("Invalid event target");l.add(new e.Subscription(h))};c.prototype._subscribe=function(a){var d=this.selector;c.setupSubscription(this.sourceObj,this.eventName,d?function(){for(var c=[],e=0;e<arguments.length;e++)c[e-0]=arguments[e];c=h.tryCatch(d).apply(void 0,c);c===g.errorObject?a.error(g.errorObject.e):
...
c.language,c.audioDescription)||a[0]})}function q(a){return X.distinctUntilChanged().map(function(d){return d?c(a,d.language,d.closedCaption):null})}var r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};Object.keys(r).forEach(function(a){return void 0===r[a]&&delete r[a]});var x=n()({},y,r),z=x.defaultTextTrack,L=x.defaultWantedBufferAhead,A=x.defaultMaxBufferBehind,G=x.defaultMaxBufferAhead,M=x.defaultBufferThreshold,aa=x.initialVideoBitrate,R=x.initialAudioBitrate,O=x.maxVideoBitrate,
U=x.maxAudioBitrate,F=x.limitVideoWidth,J=x.throttleWhenHidden,Z=e.videoWidth,ba=e.inBackground,Q=new p.BehaviorSubject(x.defaultAudioTrack),X=new p.BehaviorSubject(z),N={audio:new p.BehaviorSubject(R),video:new p.BehaviorSubject(aa)},x=[a.i(w.a)(l(b,"audio"),{alpha:.6}).multicast(N.audio),a.i(w.a)(l(b,"video"),{alpha:.6}).multicast(N.video)],H=new t.Subscription;x.forEach(function(a){return H.add(a.connect())});var Y={audio:new p.BehaviorSubject(Infinity),video:new p.BehaviorSubject(Infinity)},V=
{audio:new p.BehaviorSubject(U),video:new p.BehaviorSubject(O)},P={audio:new p.BehaviorSubject(L),video:new p.BehaviorSubject(L),text:new p.BehaviorSubject(L)},W={audio:new p.BehaviorSubject(A),video:new p.BehaviorSubject(A),text:new p.BehaviorSubject(A)},I={audio:new p.BehaviorSubject(G),video:new p.BehaviorSubject(G),text:new p.BehaviorSubject(G)};return{setAudioTrack:function(a){Q.next(a)},setTextTrack:function(a){X.next(a)},getAudioTrack:function(){return Q.getValue()},getTextTrack:function(){return X.getValue()},
getAverageBitrates:function(){return N},getAudioMaxBitrate:function(){return V.audio.getValue()},getVideoMaxBitrate:function(){return V.video.getValue()},getAudioBufferSize:function(){return P.audio.getValue()},getVideoBufferSize:function(){return P.video.getValue()},setAudioBitrate:function(a){Y.audio.next(h(a,Infinity))},setVideoBitrate:function(a){Y.video.next(h(a,Infinity))},setAudioMaxBitrate:function(a){V.audio.next(h(a,Infinity))},setVideoMaxBitrate:function(a){V.video.next(h(a,Infinity))},
setAudioBufferSize:function(a){P.audio.next(h(a,L))},setVideoBufferSize:function(a){P.video.next(h(a,L))},setMaxBufferBehind:function(a){W.audio.next(h(a,A));W.video.next(h(a,A));W.text.next(h(a,A))},setMaxBufferAhead:function(a){I.audio.next(h(a,G));I.video.next(h(a,G));I.text.next(h(a,G))},setWantedBufferAhead:function(a){P.audio.next(h(a,A));P.video.next(h(a,A));P.text.next(h(a,A))},getMaxBufferBehind:function(){return Math.min(W.audio.getValue(),W.video.getValue(),W.text.getValue())},getMaxBufferAhead:function(){return Math.min(I.audio.getValue(),
I.video.getValue(),I.text.getValue())},getWantedBufferAhead:function(){return Math.min(P.audio.getValue(),P.video.getValue(),P.text.getValue())},getBufferAdapters:function(c){var d=c.type,b=c.representations,e=c.getAvailableBitrates();c=void 0;if(1<b.length){c=Y[d];var l=V[d],h=N[d].map(function(a,c){return k(e,a,0===c?0:M)}).distinctUntilChanged().debounceTime(2E3).startWith(k(e,N[d].getValue(),0));"video"==d&&(l=a.i(v.combineLatest)([l,Z,ba]).map(function(a){var c=a[0],d=a[1];a=a[2];if(J&&a)return e[0];
d=F?g(b,d):e[e.length-1];return Math.min(d,c)}));c=a.i(v.combineLatest)(c,l,h,function(a,c,d){var g=void 0,g=Infinity>a?a:Infinity>c?Math.min(c,d):d;return m(b,function(a){return a.bitrate===k(e,g)})}).distinctUntilChanged(function(a,c){return a.id===c.id})}else c=a.i(u.e)(b[0]);return{representations:c,wantedBufferAhead:P[d]||new p.BehaviorSubject(L),maxBufferBehind:W[d]||new p.BehaviorSubject(A),maxBufferAhead:I[d]||new p.BehaviorSubject(G)}},getAdaptationsChoice:function(c,d){return"audio"==c?
...
l(a,x);0===c.length&&(c=l(a,z));n.a.debug("buffer: gc cleaning",c);return r(c.map(function(a){return N.removeBuffer(a)})).concatAll()})}function f(b){function e(a){return q.test(a.id)?!1:a.isInit||0>a.time?!0:(a=X.getSegmentRange(a.time/a.timescale,a.duration/a.timescale))?a.bitrate*y<b.bitrate:!0}function l(a,c,d){var l=new t.a(C.buffered);X.equals(l)||X.intersect(l);if(a.stalled&&O){var k=b.index.checkDiscontinuity(a.ts);0<k&&U.next({type:"index-discontinuity",value:{ts:k+1}})}k=void 0;try{var h=
null;0===d&&(n.a.debug("add init segment",m),h=b.index.getInitSegment());if(0===a.readyState)k=h?[h]:[];else{var f=a.ts,r=Math.max(0,Math.min(c,a.liveGap,(a.duration||Infinity)-f));a=void 0;var p=l.getGap(f);a=p>F&&Infinity>p?Math.min(p,J):0;var Q=X.getRange(f);if(Q&&Q.bitrate===b.bitrate){var w=Math.floor(Q.end-f);w>a&&(a=w)}l=f+a;p=f+r-l;if(b.index.shouldRefresh(f,l,f+r))throw new v.g("OUT_OF_INDEX_ERROR",b.index.getType(),!1);var x=b.index.getSegments(l,p);h&&x.unshift(h);k=x}k=k.filter(e)}catch(ca){if(ca.type===
...
e.push({start:b.start,end:a-c})}l&&a-c>l.start&&e.push({start:l.start,end:a-c})}})();(function(){if(isFinite(d)){for(var c=0;c<k.length;c++){var b=k[c];a+d<=b.start?e.push(b):a<=b.start&&a+d<b.end&&a+d>b.start&&e.push({start:a+d,end:b.end})}l&&a+d<l.end&&e.push({start:a+d,end:l.end})}})();return r(e.map(function(a){return N.removeBuffer(a)})).concatAll().ignoreElements()},E=function(a){return G({segment:a,representation:b}).map(function(c){return k()({segment:a},c)})},z=a.i(d.combineLatest)(aa,Z,
ba,Q).mergeMap(function(a,c){var d=a[0],b=a[2],e=a[3];return g.Observable.merge(l(d,Math.min(a[1],e),c).concatMap(E),x(d.ts,b,e))}).concatMap(function(a){var c=a.segment,d=a.parsed,e=d.segmentData,g=d.nextSegments,l=d.currentSegment;(d=d.timescale)&&b.index.setTimescale(d);var f=g?b.index._addSegments(g,l):[],n=function(){q.remove(c.id);l&&X.insert(b.bitrate,l.ts/c.timescale,(l.ts+l.d)/c.timescale)},u=function(){return N.appendBuffer(e)["do"](n)};return u()["catch"](function(a){if("QuotaExceededError"!=
a.name)throw q.remove(c.id),new v.d("BUFFER_APPEND_ERROR",a,!0);return h().mergeMap(u)["catch"](function(a){q.remove(c.id);throw new v.d("BUFFER_FULL_ERROR",a,!0);})}).map(function(){return{type:"pipeline",value:k()({bufferType:m,addedSegments:f},a)}})});return a.i(c.merge)(z,U)["catch"](function(a){if(!O||a.type!=v.a.NETWORK_ERROR||!a.isHttpError(412))throw a;return g.Observable.of({type:"precondition-failed",value:a}).concat(w(2E3)).concat(f(b))}).startWith({type:"buffer",value:{bufferType:m,adaptation:A,
representation:b}})}var m=b.bufferType,C=b.sourceBuffer,A=b.adaptation,G=b.pipeline,M=b.adapters,aa=b.timings,R=b.seekings,O=b.isLive,U=new e.Subject,F="video"==m?4:1,J="video"==m?6:1;b=M.representations;var Z=M.wantedBufferAhead,ba=M.maxBufferBehind,Q=M.maxBufferAhead,X=new t.a,N=new q.a(C);return a.i(d.combineLatest)(b,R,function(a){return a}).switchMap(f)["finally"](function(){return N.dispose()})}function h(a){return g.Observable.of({type:"buffer",value:{bufferType:a,adaptation:null,representation:null}})}
a.d(f,"b",function(){return m});a.d(f,"a",function(){return h});b=a(7);var k=a.n(b),g=a(0);a.n(g);var e=a(8);a.n(e);var d=a(23);a.n(d);var c=a(10);a.n(c);b=a(9);a.n(b);f=a(142);a.n(f);var l=a(54);a.n(l);var n=a(3),q=a(72),t=a(19),p=a(104),v=a(6),u=b.EmptyObservable.create,r=f.FromObservable.create,w=l.TimerObservable.create,y=1.5,x=240,z=30},function(b,f,a){a.d(f,"a",function(){return h});var m=a(8);a.n(m);var h=function(){function a(b){if(!(this instanceof a))throw new TypeError("Cannot call a class as a function");
...
function p(d){return a.i(c.a)(a.i(l.c)(K,d),aa)}function z(c){var d=M?M.get(c):null;return null===d?p(c):a.i(l.b)(d)["catch"](function(){return p(c)})}function C(c){return a.i(l.c)(L,c)["catch"](u)}function E(a,c){var d=g()({response:c},a);M&&M.add(a,c);q.schedule(t,0,{type:b,value:d});return d}function v(a,c){return g()({parsed:c},a)}var T=e.resolver,K=e.loader,L=e.parser,A=4<arguments.length&&void 0!==arguments[4]?arguments[4]:{};T||(T=d.Observable.of);K||(K=d.Observable.of);L||(L=d.Observable.of);
var G=A.maxRetry,M=A.cache,A="number"===typeof G?G:4,aa={retryDelay:200,errorSelector:function(a){throw m("PIPELINE_LOAD_ERROR",b,a);},totalRetry:A,shouldRetry:A&&h,onRetry:function(a){q.schedule(t,0,{type:b,value:a.xhr});f.next(m("PIPELINE_LOAD_ERROR",b,a,!1))}};return function(c){return a.i(l.c)(T,c)["catch"](n).mergeMap(z,E).mergeMap(C,v)}}b=a(7);var g=a.n(b),e=a(8);a.n(e);b=a(174);a.n(b);var d=a(0);a.n(d);var c=a(32),l=a(13),n=a(6),q=b.asap;f.a=function(){var a=new e.Subject;return{createPipelines:function(c){var d=
...
var u=a(3),r=a(106),w=a(13),y=a(22);b=a(30);var x=a(105),z=a(1),C=a(11),E=a(45),D=a(6),T=a(73),K=a(19),L=a(80),A=a(74),G=a(43),M=a(98),aa=a(76),R=a(70),O=a(78),U=a(42),F=function(){function a(a,c){for(var d=0;d<c.length;d++){var b=c[d];b.enumerable=b.enumerable||!1;b.configurable=!0;"value"in b&&(b.writable=!0);Object.defineProperty(a,b.key,b)}}return function(c,d,b){d&&a(c.prototype,d);b&&a(c,b);return c}}(),J="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:
function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};b=function(b){function f(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};if(!(this instanceof f))throw new TypeError("Cannot call a class as a function");var d=c.videoElement,e=c.transport,l=c.transportOptions,g=c.defaultLanguage,k=c.defaultAudioTrack,h=c.defaultSubtitle,n=c.defaultTextTrack,q=c.initVideoBitrate,w=c.initialVideoBitrate,x=c.initAudioBitrate,E=c.initialAudioBitrate,
F=c.maxVideoBitrate,v=c.maxAudioBitrate,D=c.limitVideoWidth,D=void 0===D?!0:D,c=c.throttleWhenHidden,c=void 0===c?!0:c,B=m(this,b.call(this)),Z=w,J=E,T=k,K=n;null!=q&&null==w&&(a.i(r.a)("initVideoBitrate is deprecated. Use initialVideoBitrate instead"),Z=q);null!=x&&null==E&&(a.i(r.a)("initAudioBitrate is deprecated. Use initialAudioBitrate instead"),J=x);null!=g&&null==k&&(a.i(r.a)("defaultLanguage is deprecated. Use defaultAudioTrack instead"),T=g);null!=h&&null==n&&(a.i(r.a)("defaultSubtitle is deprecated. Use defaultTextTrack instead"),
K=h);B._playPauseNext$=B._playPauseNext.bind(B);B._textTrackChanges$=B._textTrackChanges.bind(B);B._setPlayerState$=B._setPlayerState.bind(B);B._triggerTimeChange$=B._triggerTimeChange.bind(B);B._streamNext$=B._streamNext.bind(B);B._streamError$=B._streamError.bind(B);B._streamFatalError$=B._streamFatalError.bind(B);B._streamComplete$=B._streamComplete.bind(B);B.defaultTransport=e;B.defaultTransportOptions=l||{};d||(d=document.createElement("video"));a.i(z.a)(d instanceof C.a,"requires an actual HTMLVideoElement");
d.preload="auto";B.version="2.3.1";B.video=d;B.fullscreen=a.i(C.b)(d).subscribe(function(){return B.trigger("fullscreenChange",B.isFullscreen())});B.playing=new p.BehaviorSubject;B.stream=new t.Subject;B.images=new t.Subject;B.errorStream=new t.Subject;l=a.i(aa.a)();e=l.createPipelines;l=l.metrics;d=a.i(A.a)(d);B.createPipelines=e;B.metrics=l;B.adaptive=a.i(R.a)(l,d,{initialVideoBitrate:Z,initialAudioBitrate:J,maxVideoBitrate:F,maxAudioBitrate:v,defaultAudioTrack:a.i(y.a)(T),defaultTextTrack:a.i(y.b)(K),
limitVideoWidth:D,throttleWhenHidden:c});B.muted=.1;B._setPlayerState("STOPPED");B._resetStates();B.log=u.a;return B}h(f,b);f.getErrorTypes=function(){a.i(r.a)("getErrorTypes is deprecated. Use the ErrorTypes property instead");return D.a};f.getErrorCodes=function(){a.i(r.a)("getErrorCodes is deprecated. Use the ErrorCodes property instead");return D.b};F(f,null,[{key:"ErrorTypes",get:function(){return D.a}},{key:"ErrorCodes",get:function(){return D.b}}]);f.prototype._resetStates=function(){this._manifest=
...
function(){this.stop();this.metrics.unsubscribe();this.adaptive.unsubscribe();this.fullscreen.unsubscribe();this.stream.unsubscribe();a.i(U.a)();this.video=this.createPipelines=this.stream=this.fullscreen=this.adaptive=this.metrics=null};f.prototype._recordState=function(a,c){k(this.evts[a],c)||(this.evts[a]=c,this.trigger(a+"Change",c))};f.prototype._parseOptions=function(c){var d=c=l()({transport:this.defaultTransport,transportOptions:{},keySystems:[],timeFragment:{},textTracks:[],imageTracks:[],
autoPlay:!1,hideNativeSubtitle:!1,directFile:!1},c),b=d.transport,e=d.url,g=d.keySystems,f=d.timeFragment,k=d.supplementaryTextTracks,h=d.supplementaryImageTracks,n=c,m=n.subtitles,q=n.images,d=n.transportOptions,u=n.manifests,t=n.autoPlay,p=n.directFile,w=n.defaultLanguage,x=n.defaultAudioTrack,Q=n.defaultSubtitle,C=n.hideNativeSubtitle,E=n.startAt,y=x,n=n.defaultTextTrack;null!=w&&null==x&&(a.i(r.a)("defaultLanguage is deprecated. Use defaultAudioTrack instead"),y=w);c.hasOwnProperty("defaultSubtitle")&&
!c.hasOwnProperty("defaultTextTrack")&&(a.i(r.a)("defaultSubtitle is deprecated. Use defaultTextTrack instead"),n=Q);void 0!==m&&void 0===k&&(a.i(r.a)("the subtitles option is deprecated. Use supplementaryTextTracks instead"),k=m);void 0!==q&&void 0===h&&(a.i(r.a)("the images option is deprecated. Use supplementaryImageTracks instead"),h=q);f=a.i(L.a)(f);p&&(b="directfile");a.i(z.a)(!!u^!!e,"player: you have to pass either a url or a list of manifests");u&&(a.i(r.a)("the manifests options is deprecated, use url instead"),
g=u[0],e=g.url,k=g.subtitles||[],h=g.images||[],g=u.map(function(a){return a.keySystem}).filter(Boolean));"string"==typeof b&&(b=M.a[b]);"function"==typeof b&&(b=b(l()({},this.defaultTransportOptions,d)));a.i(z.a)(b,"player: transport "+c.transport+" is not supported");return{url:e,keySystems:g,supplementaryTextTracks:k,hideNativeSubtitle:C,supplementaryImageTracks:h,timeFragment:f,autoPlay:t,defaultAudioTrack:y,defaultTextTrack:n,transport:b,startAt:E}};f.prototype.loadVideo=function(){var d=0<arguments.length&&
...
a+")");throw new w.d(a,null,!0);})}var R=b.url,O=b.errorStream,U=b.keySystems,F=b.supplementaryTextTracks,J=b.hideNativeSubtitle,Z=b.supplementaryImageTracks,ba=b.timings,Q=b.timeFragment,X=b.adaptive,N=b.pipelines,H=b.videoElement,Y=b.autoPlay,V=b.startAt,P=Infinity>Q.end,W=a.i(l.d)(N.manifest),I={},S={};b=ba.filter(function(a){var c=a.ts;a=a.duration;return 0<a&&.5>Math.min(a,Q.end)-c});var ha=a.i(d.b)(function(d){var b=d.url,e=d.mediaSource;d=e?a.i(t.n)(e):c.Observable.of(null);return a.i(q.combineLatest)(W({url:b}),
d).mergeMap(function(d){d=d[0].parsed;d=a.i(y.c)(d.url,d.manifest,F,Z);if(e){var b=d.getDuration(),b=Infinity===b?Number.MAX_VALUE:b;e.duration!==b&&(e.duration=b,k.a.info("set duration",e.duration))}var b=D(d),l=b.timings,g=b.seekings,b=c.Observable.of({type:"manifest",value:d}),f=L(),h=A(l,{changePlaybackRate:N.requiresMediaSource()}),m=K(d);d=M(e,d,l,g);l=aa();return a.i(n.merge)(b,m,h,f,d,l)})},{totalRetry:3,retryDelay:250,resetDelay:6E4,shouldRetry:function(a){return!0!==a.fatal},errorSelector:function(c){a.i(w.e)(c)||
