...
Object.assign(m.prototype, n.Control.prototype);
Object.assign(m.prototype, n.Evented.prototype);
class L extends m {
  options = {
    showUniqueResult: !0,
    showResultIcons: !1,
  ...
  onAdd(t) {
    ...
    return a.type = "search", a.value = this.options.query, a.placeholder = this.options.placeholder, n.DomEvent.disableClickPropagation(a), this._errorElement = n.DomUtil.create("div", e + "-form-no-error", s), this._errorElement.innerHTML = this.options.errorMessage, this._alts = n.DomUtil.create(
      ...
      s
    ), n.DomEvent.disableClickPropagation(this._alts), n.DomEvent.addListener(a, "keydown", this._keydown, this), this.options.geocoder?.suggest && n.DomEvent.addListener(a, "input", this._change, this), n.DomEvent.addListener(a, "blur", () => {
      this.options.collapsed && !this._preventBlurCollapse && this._collapse(), this._preventBlurCollapse = !1;
    }), this.options.collapsed ? this.options.expand === "click" ? n.DomEvent.addListener(s, "click", (d) => {
  ...
  _createAlt(t, e) {
    const s = n.DomUtil.create("li", ""), o = n.DomUtil.create("a", "", s), r = this.options.showResultIcons && t.icon ? n.DomUtil.create("img", "", o) : null, a = t.html ? void 0 : document.createTextNode(t.name), d = (P) => {
      this._preventBlurCollapse = !0, n.DomEvent.stop(P), this._geocodeResultSelected(t), n.DomEvent.on(s, "click touchend", () => {
        this.options.collapsed ? this._collapse() : this._clearResults();
      });
    };
    return r && (r.src = t.icon), s.setAttribute("data-result-index", String(e)), t.html ? o.innerHTML = o.innerHTML + t.html : a && o.appendChild(a), n.DomEvent.addListener(s, "mousedown touchstart", d, this), s;
  }
  _keydown(t) {
    const e = (s) => {
