...
a=a.filter,g=b.width(),l=b.height();b.parent().css("padding-left");if(d){var h=parseFloat(k(b[0].parentNode,"padding-left")),m=parseFloat(k(b[0],"margin-left")),n=parseFloat(k(b[0],"padding-left"));isNaN(h)&&(h=0);isNaN(m)&&(m=0);isNaN(n)&&(n=0);d.css({width:g+"px",height:l+"px",left:h+m+n+"px"})}b.data("loadgo",{overlay:d,width:g,height:l,progress:e,direction:f});a&&b.data("loadgo",{filter:a});c.loadgo("setprogress",e)})},setprogress:function(a){if(0>a||100<a)console.warn("LoadGo expects progress number between 0 (0%) and 100 (100%).");
else{var c=d(this).data("loadgo"),b=c.overlay,e=c.width,f=c.height,g=c.direction;if(b)switch(g){case "lr":b.css("width",e*(1-a/100)+"px");b.css("right","0px");break;case "rl":b.css("width",e*(1-a/100)+"px");break;case "bt":b.css("height",f*(1-a/100)+"px");break;case "tb":e=f*(1-a/100);b.css("height",e+"px");b.css("top",f-e+"px");break;default:b.css("width",e*(1-a/100)+"px"),b.css("right","0px")}else switch(b=c.filter,b){case "blur":f=(100-a)/10;d(this).css({"-webkit-filter":b+"("+f+"px)"});break;
case "hue-rotate":f=360*a/100;d(this).css({"-webkit-filter":b+"("+f+"deg)"});break;case "opacity":f=a/100;d(this).css({"-webkit-filter":b+"("+f+")"});break;default:f=1-a/100,d(this).css({"-webkit-filter":b+"("+f+")"})}d(this).data("loadgo",d.extend({},c,{progress:a}))}},getprogress:function(){var a=d(this).data("loadgo");return a.progress?a.progress:0},resetprogress:function(){d(this).loadgo("setprogress",0)},loop:function(a){var c=d(this).data("loadgo"),b=!0,e=this;if(c.interval)return console.warn("LoadGo requires you to stop the current loop before modifying it."),
