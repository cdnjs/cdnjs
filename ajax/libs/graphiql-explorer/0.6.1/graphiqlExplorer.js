...
var FieldView = function (_React$PureComponent7) {
  ...
  _createClass(FieldView, [{
    ...
    value: function render() {
      ...
      var applicableFragments = (0, _graphql.isObjectType)(type) || (0, _graphql.isInterfaceType)(type) || (0, _graphql.isUnionType)(type) ? this.props.availableFragments[type.name] : null;
