...
var FieldView = function (_React$PureComponent6) {
  ...
  _createClass(FieldView, [{
    ...
    value: function render() {
      ...
      var className = 'graphiql-explorer-node';
...
var RootView = function (_React$PureComponent7) {
  ...
  function RootView() {
    ...
    return _ret8 = (_temp6 = (_this11 = _possibleConstructorReturn(this, (_ref7 = RootView.__proto__ || Object.getPrototypeOf(RootView)).call.apply(_ref7, [this].concat(args))), _this11), _this11.state = { newOperationType: 'query' }, _this11._modifySelections = function (selections) {
...
var Explorer = function (_React$PureComponent8) {
  ...
  function Explorer() {
    ...
    return _ret9 = (_temp7 = (_this13 = _possibleConstructorReturn(this, (_ref8 = Explorer.__proto__ || Object.getPrototypeOf(Explorer)).call.apply(_ref8, [this].concat(args))), _this13), _this13.state = {
      newOperationType: 'query',
      operation: null,
      operationToScrollTo: null
    }, _this13._resetScroll = function () {
    ...
    }, _this13._setAddOperationType = function (value) {
      _this13.setState({ newOperationType: value });
    }, _this13._handleRootViewMount = function (rootViewElId) {
      if (!!_this13.state.operationToScrollTo && _this13.state.operationToScrollTo === rootViewElId) {
  ...
  _createClass(Explorer, [{
    ...
    value: function render() {
      ...
      var addOperation = function addOperation(kind) {
        ...
        _this14.setState({ operationToScrollTo: kind + '-' + newOperationName });
          ...
          React.createElement(
            'select',
            {
              onChange: function onChange(event) {
                return _this14._setAddOperationType(event.target.value);
              },
          ...
          React.createElement(
            'button',
            {
              ...
              onClick: function onClick() {
                return _this14.state.newOperationType ? addOperation(_this14.state.newOperationType) : null;
              },
        ...
        React.createElement(
          ...
          relevantOperations.map(function (operation, index) {
            ...
            return React.createElement(RootView, {
              ...
              onMount: _this14._handleRootViewMount,
