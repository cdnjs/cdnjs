...
(function ($, skate) {
    ...
    var ATTRIBUTE_RESERVED_ARGUMENTS = ['displayfield', 'watch', 'when', 'novalidate', 'state'];
    ...
    function bindValidationEvent($field) {
        ...
        var watch = getValidationOption($field, 'watch');

        var watchElements = watch ? $field.add('#' + watch) : $field;
...
(function ($) {
     ...
     * @returns string
     */
    Sidebar.prototype.collapsedTriggersSelector = function () {
        return [
    ...
    $(function ($) {
        ...
        sidebar.$el.on('mouseenter focus', '.aui-sidebar-footer > .aui-sidebar-toggle', function () {
            var $trigger = $(this);
            if(sidebar.isCollapsed()) {
        ...
        sidebar.$el.on('click blur mouseleave', '.aui-sidebar-footer > .aui-sidebar-toggle', function () {
            hideTipsy($(this));
        });
        ...
        sidebar.$el.find('.aui-sidebar-body').on('mouseenter mouseover mouseleave',function(e) {
            sidebar.$el.toggleClass('aui-is-hover',
                ...
                && !$(e.srcElement).parentsUntil(sidebar.$el).filter('.aui-page-header, .aui-navgroup').length);
        })
    });
