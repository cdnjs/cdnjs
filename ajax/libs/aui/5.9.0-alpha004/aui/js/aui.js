...
__bf7a81eee47585d485a1b8800ef3bc47 = (function () {
  var module = {
    exports: {}
  };
  var exports = module.exports;
  ...
  function setBooleanAttribute(el, attribute, value) {
      value ? el.setAttribute(attribute, '') : el.removeAttribute(attribute);
      return !!value;
  }
  
  exports['default'] = setBooleanAttribute;
  module.exports = exports['default'];
...
__741ea5411c959080c2b42c1585082da1 = (function () {
  ...
  function handleMessage(element, message) {
      ...
      var respondsTo = element.getAttribute('responds-to') || element.getAttribute('data-aui-responds-to') || 'toggle';
  ...
  var InlineDialog2 = (0, _skatejs2['default'])('aui-inline-dialog', {
      prototype: Object.defineProperties({
          ...
          open: {
              ...
              set: function set(value) {
                  if (!!value) {
                      (0, _internalState2['default'])(this).set('is-processing-show', true);
                      showInlineDialog(this);
                      (0, _internalState2['default'])(this).set('is-processing-show', false);
                  } else {
                      hideInlineDialog(this);
                  }
                  return (0, _internalAttributes2['default'])(this, 'open', this.open);
              },
              configurable: true,
              enumerable: true
          }
      ...
      attributes: {
          ...
          'responds-to': function respondsTo(element) {
              ...
              var respondsTo = element.getAttribute('responds-to');
              if (respondsTo === 'hover') {
                  element.mouseInside = false;
