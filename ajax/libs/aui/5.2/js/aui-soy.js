...
if(typeof aui=="undefined"){var aui={}}aui.renderExtraAttributes=function(a,h,g){var d=h||new soy.StringBuilder();if(a!=null&&a.extraAttributes){if(Object.prototype.toString.call(a.extraAttributes)==="[object Object]"){var f=soy.$$getMapKeys(a.extraAttributes);var c=f.length;for(var b=0;b<c;b++){var e=f[b];d.append(" ",soy.$$escapeHtml(e),'="',soy.$$escapeHtml(a.extraAttributes[e]),'"')}}else{d.append(" ",a.extraAttributes)}}return h?"":d.toString()};aui.renderExtraClasses=function(g,d,h){var c=d||new soy.StringBuilder();if(g!=null&&g.extraClasses){if(g.isFullAttr){c.append(' class="');if((g.extraClasses) instanceof Array){var e=g.extraClasses;var i=e.length;for(var j=0;j<i;j++){var f=e[j];c.append((!(j==0))?" ":"",soy.$$escapeHtml(f))}}else{c.append(soy.$$escapeHtml(g.extraClasses))}c.append('"')}else{if((g.extraClasses) instanceof Array){var l=g.extraClasses;var a=l.length;for(var b=0;b<a;b++){var k=l[b];c.append(" ",soy.$$escapeHtml(k))}}else{c.append(" ",soy.$$escapeHtml(g.extraClasses))}}}return d?"":c.toString()};
...
if(typeof aui=="undefined"){var aui={}}if(typeof aui.progressTracker=="undefined"){aui.progressTracker={}}aui.progressTracker.progressTracker=function(h,g,k){var e=g||new soy.StringBuilder();e.append("<ol",(h.id)?' id="'+soy.$$escapeHtml(h.id)+'"':"",' class="aui-progress-tracker',(h.isInverted)?" aui-progress-tracker-inverted":"");aui.renderExtraClasses(h,e,k);e.append('"');aui.renderExtraAttributes(h,e,k);e.append(">");var d=new soy.StringBuilder();var a=h.steps;var m=a.length;for(var c=0;c<m;c++){var l=a[c];if(l.isCurrent){var j=h.steps;var b=j.length;for(var i=0;i<b;i++){var f=j[i];aui.progressTracker.step(soy.$$augmentData(f,{width:Math.round(100/h.steps.length*10000)/10000,href:i<c?f.href:null}),d,k)}}}aui.progressTracker.content({steps:h.steps,content:d.toString()},e,k);e.append("</ol>");return g?"":e.toString()};aui.progressTracker.content=function(a,h,f){var e=h||new soy.StringBuilder();if(a.content!=""){e.append(a.content)}else{var g=a.steps;var d=g.length;for(var c=0;c<d;c++){var b=g[c];aui.progressTracker.step(soy.$$augmentData(b,{isCurrent:c==0,width:Math.round(100/a.steps.length*10000)/10000,href:null}),e,f)}}return h?"":e.toString()};aui.progressTracker.step=function(a,d,c){var b=d||new soy.StringBuilder();b.append("<li",(a.id)?' id="'+soy.$$escapeHtml(a.id)+'"':"",' class="aui-progress-tracker-step',(a.isCurrent)?" aui-progress-tracker-step-current":"");aui.renderExtraClasses(a,b,c);b.append('" style="width: ',soy.$$escapeHtml(a.width),'%;"');aui.renderExtraAttributes(a,b,c);b.append("><",soy.$$escapeHtml(a.href?"a":"span"),(a.href)?' href="'+soy.$$escapeHtml(a.href)+'"':"",">",soy.$$escapeHtml(a.text),"</",soy.$$escapeHtml(a.href?"a":"span"),"></li>");return d?"":b.toString()};
