...
aui.dropdown2.trigger = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param466 = new soy.StringBuilder();
  aui.renderExtraClasses(opt_data, param466, opt_ijData);
  param466.append(' aui-dropdown2-trigger');
  var param469 = new soy.StringBuilder();
  aui.renderExtraAttributes(opt_data, param469, opt_ijData);
  param469.append(' data-aui-trigger ');
  aui.trigger.trigger(soy.$$augmentData(opt_data, {extraClasses: param466.toString(), extraAttributes: param469.toString()}), output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.expander.revealText = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param569 = new soy.StringBuilder(soy.$$escapeHtml(opt_data.contentContent));
  aui.expander.trigger({id: opt_data.triggerId, contentId: opt_data.contentId, tag: 'a', content: '<span class=\'reveal-text-trigger-text\'>Show more</span>', replaceSelector: '.reveal-text-trigger-text', replaceText: 'Show less', extraAttributes: opt_data.triggerExtraAttributes, extraClasses: ((opt_data.triggerExtraClasses) ? soy.$$escapeHtml(opt_data.triggerExtraClasses) + '  ' : '') + ' aui-expander-reveal-text'}, param569, opt_ijData);
  aui.expander.content({id: opt_data.contentId, content: param569.toString(), extraAttributes: opt_data.contentExtraAttributes, extraClasses: opt_data.contentExtraClasses}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.fieldset = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var hasClass__soy639 = opt_data.isInline || opt_data.isDateSelect || opt_data.isGroup || opt_data.extraClasses;
...
aui.form.renderValidationArguments = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.validationArguments) {
    var argumentList777 = soy.$$getMapKeys(opt_data.validationArguments);
    var argumentListLen777 = argumentList777.length;
    for (var argumentIndex777 = 0; argumentIndex777 < argumentListLen777; argumentIndex777++) {
      var argumentData777 = argumentList777[argumentIndex777];
      output.append(' ', soy.$$escapeHtml('data-aui-validate-' + argumentData777), '="', soy.$$escapeHtml(opt_data.validationArguments[argumentData777]), '"');
    }
...
aui.form.renderTooltipArguments = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.tooltipArguments) {
    var argumentList789 = soy.$$getMapKeys(opt_data.tooltipArguments);
    var argumentListLen789 = argumentList789.length;
    for (var argumentIndex789 = 0; argumentIndex789 < argumentListLen789; argumentIndex789++) {
      var argumentData789 = argumentList789[argumentIndex789];
      output.append(' ', soy.$$escapeHtml('data-aui-form-notification-' + argumentData789), '="', soy.$$escapeHtml(opt_data.tooltipArguments[argumentData789]), '"');
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.form.submit = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param811 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param811, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: 'input', inputType: 'submit', text: opt_data.text, type: opt_data.type, href: opt_data.href, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: opt_data.extraClasses, extraAttributes: param811.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.button = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param835 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param835, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: opt_data.tagName, inputType: opt_data.inputType, text: opt_data.text, type: opt_data.type, href: opt_data.href, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: opt_data.extraClasses, extraAttributes: param835.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.linkButton = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param858 = new soy.StringBuilder('cancel');
  aui.renderExtraClasses(opt_data, param858, opt_ijData);
  var param862 = new soy.StringBuilder((opt_data.name) ? 'name="' + soy.$$escapeHtml(opt_data.name) + '"' : '');
  aui.renderExtraAttributes(opt_data, param862, opt_ijData);
  aui.buttons.button({id: opt_data.id, tagName: 'a', inputType: opt_data.inputType, text: opt_data.text, type: 'link', href: opt_data.href ? opt_data.href : opt_data.url, isDisabled: opt_data.isDisabled, isPressed: opt_data.isPressed, iconType: opt_data.iconType, iconText: opt_data.iconText, iconClass: opt_data.iconClass, dropdown2Target: opt_data.dropdown2Target, splitButtonType: opt_data.splitButtonType, extraClasses: param858.toString(), extraAttributes: param862.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.select = function(opt_data, opt_sb, opt_ijData) {
  ...
  aui.form.renderTooltipArguments(opt_data, output, opt_ijData);
  output.append('>');
  var optionList961 = opt_data.options;
  var optionListLen961 = optionList961.length;
  for (var optionIndex961 = 0; optionIndex961 < optionListLen961; optionIndex961++) {
    var optionData961 = optionList961[optionIndex961];
    aui.form.optionOrOptgroup(soy.$$augmentData(optionData961, {defaultValue: opt_data.value}), output, opt_ijData);
  }
...
aui.form.optionOrOptgroup = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.options) {
    ...
    var optionList976 = opt_data.options;
    var optionListLen976 = optionList976.length;
    for (var optionIndex976 = 0; optionIndex976 < optionListLen976; optionIndex976++) {
      var optionData976 = optionList976[optionIndex976];
      aui.form.optionOrOptgroup(soy.$$augmentData(optionData976, {defaultValue: opt_data.defaultValue}), output, opt_ijData);
    }
...
aui.form.field = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var isCheckboxOrRadio__soy1010 = opt_data.type == 'checkbox' || opt_data.type == 'radio';
  var fieldWidthClass__soy1011 = opt_data.fieldWidth ? opt_data.fieldWidth + '-field' : '';
  output.append('<div class="', (isCheckboxOrRadio__soy1010) ? soy.$$escapeHtml(opt_data.type) : 'field-group');
  aui.renderExtraClasses(opt_data, output, opt_ijData);
  output.append('"');
  aui.renderExtraAttributes(opt_data, output, opt_ijData);
  output.append('>');
  if (opt_data.labelContent && ! isCheckboxOrRadio__soy1010) {
    aui.form.label({forField: opt_data.id, isRequired: opt_data.isRequired, content: opt_data.labelContent}, output, opt_ijData);
  }
  switch (opt_data.type) {
    case 'textarea':
      aui.form.textarea({id: opt_data.id, name: opt_data.name, value: opt_data.value, rows: opt_data.rows, cols: opt_data.cols, autocomplete: opt_data.autocomplete, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1011, icon: opt_data.icon, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
    case 'select':
      aui.form.select({id: opt_data.id, name: opt_data.name, value: opt_data.value, options: opt_data.options, isMultiple: opt_data.isMultiple, size: opt_data.size, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1011, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
    case 'value':
    ...
    case 'submit':
    case 'reset':
      aui.form.input({id: opt_data.id, name: opt_data.name, type: opt_data.type, value: opt_data.value, maxLength: opt_data.maxLength, size: opt_data.size, autocomplete: opt_data.autocomplete, isChecked: opt_data.isChecked, isDisabled: opt_data.isDisabled ? true : false, isAutofocus: opt_data.isAutofocus, extraClasses: fieldWidthClass__soy1011, icon: opt_data.icon, validationArguments: opt_data.validationArguments, tooltipArguments: opt_data.tooltipArguments}, output, opt_ijData);
      break;
  }
  if (opt_data.labelContent && isCheckboxOrRadio__soy1010) {
    aui.form.label({forField: opt_data.id, isRequired: opt_data.isRequired, content: opt_data.labelContent}, output, opt_ijData);
...
aui.form.checkboxField = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param1220 = new soy.StringBuilder((opt_data.isMatrix) ? '<div class="matrix">' : '');
  var fieldList1224 = opt_data.fields;
  var fieldListLen1224 = fieldList1224.length;
  for (var fieldIndex1224 = 0; fieldIndex1224 < fieldListLen1224; fieldIndex1224++) {
    var fieldData1224 = fieldList1224[fieldIndex1224];
    aui.form.field(soy.$$augmentData(fieldData1224, {type: 'checkbox', labelContent: soy.$$escapeHtml(fieldData1224.labelText)}), param1220, opt_ijData);
  }
  param1220.append((opt_data.isMatrix) ? '</div>' : '');
  if (opt_data.descriptionText || opt_data.descriptionContent || opt_data.errorTexts && opt_data.errorTexts.length) {
    aui.form.field({descriptionText: opt_data.descriptionText, descriptionContent: opt_data.descriptionContent, errorTexts: opt_data.errorTexts, isDisabled: false}, param1220, opt_ijData);
  }
  aui.form.fieldset({legendContent: opt_data.legendContent + (opt_data.isRequired ? '<span class="aui-icon icon-required"></span>' : ''), isGroup: true, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param1220.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.form.radioField = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param1247 = new soy.StringBuilder((opt_data.isMatrix) ? '<div class="matrix">' : '');
  var fieldList1251 = opt_data.fields;
  var fieldListLen1251 = fieldList1251.length;
  for (var fieldIndex1251 = 0; fieldIndex1251 < fieldListLen1251; fieldIndex1251++) {
    var fieldData1251 = fieldList1251[fieldIndex1251];
    aui.form.field(soy.$$augmentData(fieldData1251, {type: 'radio', name: opt_data.name ? opt_data.name : opt_data.id, labelContent: soy.$$escapeHtml(fieldData1251.labelText)}), param1247, opt_ijData);
  }
  param1247.append((opt_data.isMatrix) ? '</div>' : '');
  if (opt_data.descriptionText || opt_data.descriptionContent || opt_data.errorTexts && opt_data.errorTexts.length) {
    aui.form.field({descriptionText: opt_data.descriptionText, descriptionContent: opt_data.descriptionContent, errorTexts: opt_data.errorTexts, isDisabled: false}, param1247, opt_ijData);
  }
  aui.form.fieldset({legendContent: opt_data.legendContent + (opt_data.isRequired ? '<span class="aui-icon icon-required"></span>' : ''), isGroup: true, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param1247.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.inlineDialog2.inlineDialog2 = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  output.append('<div ', (opt_data.id) ? ' id="' + soy.$$escapeHtml(opt_data.id) + '"' : '', '  class="aui-layer aui-inline-dialog aui-inline-dialog2');
  aui.renderExtraClasses(opt_data, output, opt_ijData);
...
aui.inlineDialog2.trigger = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param1379 = new soy.StringBuilder();
  aui.renderExtraAttributes(opt_data, param1379, opt_ijData);
  param1379.append(' data-aui-trigger ');
  aui.trigger.trigger(soy.$$augmentData(opt_data, {showIcon: opt_data.showIcon ? opt_data.showIcon : false, extraAttributes: param1379.toString()}), output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.progressTracker.progressTracker = function(opt_data, opt_sb, opt_ijData) {
  ...
  aui.renderExtraAttributes(opt_data, output, opt_ijData);
  output.append('>');
  var param1840 = new soy.StringBuilder();
  var currentStepList1841 = opt_data.steps;
  var currentStepListLen1841 = currentStepList1841.length;
  for (var currentStepIndex1841 = 0; currentStepIndex1841 < currentStepListLen1841; currentStepIndex1841++) {
    var currentStepData1841 = currentStepList1841[currentStepIndex1841];
    if (currentStepData1841['isCurrent']) {
      var stepList1844 = opt_data.steps;
      var stepListLen1844 = stepList1844.length;
      for (var stepIndex1844 = 0; stepIndex1844 < stepListLen1844; stepIndex1844++) {
        var stepData1844 = stepList1844[stepIndex1844];
        aui.progressTracker.step(soy.$$augmentData(stepData1844, {width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: stepIndex1844 < currentStepIndex1841 ? stepData1844['href'] : null}), param1840, opt_ijData);
      }
    }
  }
  aui.progressTracker.content({steps: opt_data.steps, content: param1840.toString()}, output, opt_ijData);
  output.append('</ol>');
  return opt_sb ? '' : output.toString();
};
...
aui.progressTracker.content = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.content != '') {
    ...
    var stepList1858 = opt_data.steps;
    var stepListLen1858 = stepList1858.length;
    for (var stepIndex1858 = 0; stepIndex1858 < stepListLen1858; stepIndex1858++) {
      var stepData1858 = stepList1858[stepIndex1858];
      aui.progressTracker.step(soy.$$augmentData(stepData1858, {isCurrent: stepIndex1858 == 0, width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: null}), output, opt_ijData);
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.tabs = function(opt_data, opt_sb, opt_ijData) {
  ...
  var itemList2013 = opt_data.menuItems;
  var itemListLen2013 = itemList2013.length;
  for (var itemIndex2013 = 0; itemIndex2013 < itemListLen2013; itemIndex2013++) {
    var itemData2013 = itemList2013[itemIndex2013];
    aui.tabMenuItem(itemData2013, output, opt_ijData);
  }
...
aui.toolbar.button = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (! (opt_data != null)) {
    ...
    var param2168 = new soy.StringBuilder();
    aui.toolbar.trigger({url: opt_data.url, title: opt_data.title, content: ((opt_data.iconClass) ? '<span class="icon ' + soy.$$escapeHtml(opt_data.iconClass) + '"></span>' : '') + ((opt_data.text) ? '<span class="trigger-text">' + soy.$$escapeHtml(opt_data.text) + '</span>' : '')}, param2168, opt_ijData);
    aui.toolbar.item({isActive: opt_data.isActive, isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param2168.toString()}, output, opt_ijData);
  }
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.link = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2186 = new soy.StringBuilder('toolbar-item-link');
  aui.renderExtraClasses(opt_data, param2186, opt_ijData);
  var param2190 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2190, opt_ijData);
  aui.toolbar.item({id: opt_data.id, extraClasses: param2186.toString(), extraAttributes: opt_data.extraAttributes, content: param2190.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.dropdownInternal = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2199 = new soy.StringBuilder(opt_data.itemClass);
  aui.renderExtraClasses(opt_data, param2199, opt_ijData);
  var param2204 = new soy.StringBuilder((opt_data.splitButtonContent) ? opt_data.splitButtonContent : '');
  var param2209 = new soy.StringBuilder();
  aui.dropdown.trigger({extraClasses: 'toolbar-trigger', accessibilityText: opt_data.text}, param2209, opt_ijData);
  aui.dropdown.menu({content: opt_data.dropdownItemsContent}, param2209, opt_ijData);
  aui.dropdown.parent({content: param2209.toString()}, param2204, opt_ijData);
  aui.toolbar.item({isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: param2199.toString(), extraAttributes: opt_data.extraAttributes, content: param2204.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.splitButton = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2233 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2233, opt_ijData);
  aui.toolbar.dropdownInternal({isPrimary: opt_data.isPrimary, id: opt_data.id, itemClass: 'toolbar-splitbutton', extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, dropdownItemsContent: opt_data.dropdownItemsContent, splitButtonContent: param2233.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
