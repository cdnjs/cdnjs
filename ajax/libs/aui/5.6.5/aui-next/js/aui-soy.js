...
aui.progressTracker.progressTracker = function(opt_data, opt_sb, opt_ijData) {
  ...
  aui.renderExtraAttributes(opt_data, output, opt_ijData);
  output.append('>');
  var param1842 = new soy.StringBuilder();
  var currentStepList1843 = opt_data.steps;
  var currentStepListLen1843 = currentStepList1843.length;
  for (var currentStepIndex1843 = 0; currentStepIndex1843 < currentStepListLen1843; currentStepIndex1843++) {
    var currentStepData1843 = currentStepList1843[currentStepIndex1843];
    if (currentStepData1843['isCurrent']) {
      var stepList1846 = opt_data.steps;
      var stepListLen1846 = stepList1846.length;
      for (var stepIndex1846 = 0; stepIndex1846 < stepListLen1846; stepIndex1846++) {
        var stepData1846 = stepList1846[stepIndex1846];
        aui.progressTracker.step(soy.$$augmentData(stepData1846, {width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: stepIndex1846 < currentStepIndex1843 ? stepData1846['href'] : null}), param1842, opt_ijData);
      }
    }
  }
  aui.progressTracker.content({steps: opt_data.steps, content: param1842.toString()}, output, opt_ijData);
  output.append('</ol>');
  return opt_sb ? '' : output.toString();
};
...
aui.progressTracker.content = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (opt_data.content != '') {
    ...
    var stepList1860 = opt_data.steps;
    var stepListLen1860 = stepList1860.length;
    for (var stepIndex1860 = 0; stepIndex1860 < stepListLen1860; stepIndex1860++) {
      var stepData1860 = stepList1860[stepIndex1860];
      aui.progressTracker.step(soy.$$augmentData(stepData1860, {isCurrent: stepIndex1860 == 0, width: Math.round(100 / opt_data.steps.length * 10000) / 10000, href: null}), output, opt_ijData);
    }
  }
  return opt_sb ? '' : output.toString();
};
...
aui.tabs = function(opt_data, opt_sb, opt_ijData) {
  ...
  var itemList2011 = opt_data.menuItems;
  var itemListLen2011 = itemList2011.length;
  for (var itemIndex2011 = 0; itemIndex2011 < itemListLen2011; itemIndex2011++) {
    var itemData2011 = itemList2011[itemIndex2011];
    aui.tabMenuItem(itemData2011, output, opt_ijData);
  }
...
aui.toolbar.button = function(opt_data, opt_sb, opt_ijData) {
  ...
  if (! (opt_data != null)) {
    ...
    var param2166 = new soy.StringBuilder();
    aui.toolbar.trigger({url: opt_data.url, title: opt_data.title, content: ((opt_data.iconClass) ? '<span class="icon ' + soy.$$escapeHtml(opt_data.iconClass) + '"></span>' : '') + ((opt_data.text) ? '<span class="trigger-text">' + soy.$$escapeHtml(opt_data.text) + '</span>' : '')}, param2166, opt_ijData);
    aui.toolbar.item({isActive: opt_data.isActive, isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, content: param2166.toString()}, output, opt_ijData);
  }
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.link = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2184 = new soy.StringBuilder('toolbar-item-link');
  aui.renderExtraClasses(opt_data, param2184, opt_ijData);
  var param2188 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2188, opt_ijData);
  aui.toolbar.item({id: opt_data.id, extraClasses: param2184.toString(), extraAttributes: opt_data.extraAttributes, content: param2188.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.dropdownInternal = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2197 = new soy.StringBuilder(opt_data.itemClass);
  aui.renderExtraClasses(opt_data, param2197, opt_ijData);
  var param2202 = new soy.StringBuilder((opt_data.splitButtonContent) ? opt_data.splitButtonContent : '');
  var param2207 = new soy.StringBuilder();
  aui.dropdown.trigger({extraClasses: 'toolbar-trigger', accessibilityText: opt_data.text}, param2207, opt_ijData);
  aui.dropdown.menu({content: opt_data.dropdownItemsContent}, param2207, opt_ijData);
  aui.dropdown.parent({content: param2207.toString()}, param2202, opt_ijData);
  aui.toolbar.item({isPrimary: opt_data.isPrimary, id: opt_data.id, extraClasses: param2197.toString(), extraAttributes: opt_data.extraAttributes, content: param2202.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
...
aui.toolbar.splitButton = function(opt_data, opt_sb, opt_ijData) {
  var output = opt_sb || new soy.StringBuilder();
  var param2231 = new soy.StringBuilder();
  aui.toolbar.trigger({url: opt_data.url, content: soy.$$escapeHtml(opt_data.text)}, param2231, opt_ijData);
  aui.toolbar.dropdownInternal({isPrimary: opt_data.isPrimary, id: opt_data.id, itemClass: 'toolbar-splitbutton', extraClasses: opt_data.extraClasses, extraAttributes: opt_data.extraAttributes, dropdownItemsContent: opt_data.dropdownItemsContent, splitButtonContent: param2231.toString()}, output, opt_ijData);
  return opt_sb ? '' : output.toString();
};
