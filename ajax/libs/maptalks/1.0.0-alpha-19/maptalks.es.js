...
var SpatialReference = function () {
  ...
  _proto._initSpatialRef = function _initSpatialRef() {
    ...
    this._pyramid = projection['code'] && projection['code'].toLowerCase() !== 'baidu';
...
var TileLayer = function (_Layer) {
  ...
  _proto2._getRootNode = function _getRootNode() {
    ...
    this._rootNode = {
      ...
      idx: 0,
      idy: 0,
      extent2d: this._getTileConfig().getTilePrjExtent(0, 0, sr.getResolution(0)).convertTo(function (c) {
  ...
  _proto2._splitNode = function _splitNode(node, projectionView, queue, tiles, gridExtent, maxZoom, offset, parentRenderer) {
    ...
    var children = [];
    var glScale = sr.getResolution(z) / map.getResolution(map.getGLZoom());
