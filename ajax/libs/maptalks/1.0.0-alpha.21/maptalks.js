...
(function (global, factory) {
      ...
      if (geometry.getShell && this.geometry.getHoles && !smoothness) {
        if (!Array.isArray(points[0])) {
          ...
          for (var _i = 0; _i < points.length; _i++) {
            var part = clipPolygon(points[_i], TEMP_CLIP_EXTENT0);
        ...
        if (!Array.isArray(points[0])) {
          ...
          for (var _i2 = 0; _i2 < points.length; _i2++) {
            pushIn(clipPoints, clipLine(points[_i2], TEMP_CLIP_EXTENT0, false, !!smoothness));
          }
        }
  ...
  var HIDEDOMEVENTS = 'remove hide shapechange positionchange symbolchange dragend animatestart';
  var options$m = {
    'width': 0,
    'height': 0,
    'animation': 'fade',
  ...
  typeof console !== 'undefined' && console.log && console.log('maptalks v1.0.0-alpha.21');
