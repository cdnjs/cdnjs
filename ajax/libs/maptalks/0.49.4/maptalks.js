...
(function (global, factory) {
  ...
  var TileLayerCanvasRenderer = function (_CanvasRenderer) {
    ...
    _proto._findChildTilesAt = function _findChildTilesAt(children, pmin, pmax, layer, childZoom, offset) {
      ...
      var dmin = layer._getTileConfig().getTileIndex(pmin, res, offset),
  ...
  typeof console !== 'undefined' && console.log && console.log('maptalks v0.49.4');
