...
declare namespace renderer {
	export { CanvasLayerRenderer, CanvasRenderer, CanvasRenderer$1 as CanvasTileLayerCanvasRenderer, GLRenderer as CanvasTileLayerGLRenderer, ImageGLRenderable, ImageLayerCanvasRenderer, ImageLayerGLRenderer, LayerAbstractRenderer, MapAbstractRenderer, MapCanvasRenderer, MapRenderer, OverlayLayerCanvasRenderer, OverlayLayerGLRenderer, QuadStencil, ResourceCache, TileLayerCanvasRenderer, TileLayerGLRenderer, TileLayerRenderable as TileLayerRendererable, VectorLayerRenderer as VectorLayerCanvasRenderer, _default$9 as Renderable };
}
