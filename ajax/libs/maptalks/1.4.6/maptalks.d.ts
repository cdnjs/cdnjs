...
declare const Animation$1: {
	 ...
	 */
	animate(styles: any, options: AnimationOptionsType, step: AnimationCallback, target?: any): Player;
	_frameFn: () => void;
};
export declare const animate: (styles: any, options: AnimationOptionsType, step: AnimationCallback, target?: any) => Player;
/**
...
declare class MapAbstractRenderer extends MapRenderer {
	...
	constructor(map: Map$1);
	load(): void;
	_updateMapCurrentViewGLInfo(): this;
	/**
