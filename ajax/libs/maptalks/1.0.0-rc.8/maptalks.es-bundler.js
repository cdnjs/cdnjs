  ...
  _proto._renderLayers = function _renderLayers(map, elm) {
    ...
    if (len) {
      ...
      input.onchange = function (e) {
        ...
        for (var _i2 = 0, _len2 = _ul.childNodes.length; _i2 < _len2; _i2++) {
          var childNode = _ul.childNodes[_i2];
          var _layer2 = childNode._layer,
              checkbox = childNode.childNodes[0];
...
var TileLayerCanvasRenderer = function (_CanvasRenderer) {
  ...
  _proto2.draw = function draw(timestamp, context) {
    ...
    var frameTileGrids = this._frameTileGrids;
    ...
    var _tileGrids = tileGrids,
        tiles = _tileGrids.tiles,
        childTiles = _tileGrids.childTiles,
        parentTiles = _tileGrids.parentTiles,
        placeholders = _tileGrids.placeholders,
        loading = _tileGrids.loading,
        loadingCount = _tileGrids.loadingCount;
...
var MapCanvasRenderer = function (_MapRenderer) {
  ...
  _proto._containerIsHide = function _containerIsHide() {
    var map = this.map;
