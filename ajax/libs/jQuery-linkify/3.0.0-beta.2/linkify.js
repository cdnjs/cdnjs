...
香港'.split(' ');
	...
	*/
	...
	function init$2() {
	  ...
	  makeT(S_MAILTO, ':', S_FULL_MAILTO); // Localhost
	...
	*/
	...
	function init$1() {
	  ...
	  makeT(S_START, SLASH, S_PROTOCOL_SLASH);
	...
	function registerPlugin(name, plugin) {
	  ...
	  if (INIT.initialized) {
	    warn("linkifyjs: already initialized - will not register plugin \"".concat(name, "\" until you manually call linkify.init()"));
	  }
	}
	/**
