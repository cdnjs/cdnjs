...
한국'.split(' ');
	...
	*/
	...
	function registerCustomProtocol(protocol) {
	  ...
	  if (INIT.initialized) {
	    warn("linkifyjs: already initialized - will not register custom protocol \"".concat(protocol, "\" until you manually call linkify.init(). To avoid this warning, please register all custom schemes before invoking linkify the first time."));
	  }
