...
한국'.split(' ');
	...
	*/
	...
	function init$1() {
	  ...
	  makeT(SlashSchemeColonSlash, SLASH, UriPrefix); // Scheme followed by dot can be the start of a URL:

	  makeT(Scheme, DOT, DomainDot);
	  makeT(SlashScheme, DOT, DomainDot); // The very first potential domain name + full URL
