...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grid = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  adjustColumnWidths:function(columnMetrics                   ){
	    var index = {};
	    this.state.columnMetrics.columns.forEach(function(c)  {
	      index[c.key] = {width: c.width, left: c.left};
	    });
	    var nextColumns = Object.assign(this.state.columnMetrics, {
	      columns: columnMetrics.columns.map(function(c)  {return Object.assign(c, index[c.key]);})
	    });
	    return nextColumns;
	  },

	  getColumnMetricsType:function(metrics                   , initial         )                                                    {
