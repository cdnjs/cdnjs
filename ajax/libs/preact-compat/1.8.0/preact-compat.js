(function (global, factory) {
...
}(this, function (PropTypes,SVG,preact) { 'use strict';
  ...
  function cloneElement$1(element, props) {
  	...
  	return createElement.apply(undefined, [node.nodeName, extend({}, node.attributes || {}, props)].concat(children.length && children || node.children || []));
  }
  ...
  var Component$1 = function (_PreactComponent) {
  	inherits(Component, _PreactComponent);

  	function Component(props, context, opts) {
  		classCallCheck(this, Component);

  		var _this = possibleConstructorReturn(this, _PreactComponent.call(this, props, context));
