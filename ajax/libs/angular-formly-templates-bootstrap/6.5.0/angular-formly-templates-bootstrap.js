//! angular-formly-templates-bootstrap version 6.5.0 built with ♥ by Astrism <astrisms@gmail.com>, Kent C. Dodds <kent@doddsfamily.us> (ó ì_í)=óò=(ì_í ò)
...
/***/ function(module, exports, __webpack_require__) {
	...
	ngModule.constant('formlyBootstrapVersion', ("6.5.0"));
...
/***/ function(module, exports) {
	...
	exports['default'] = function (ngModule) {
	  ...
	  var template = '<select class="form-control" ng-model="model[options.key]">\n      <option ng-hide="to.notNull" value="">{{to.nullDisplay}}</option>\n  </select>';
