...
/*! *****************************************************************************
  ...
  ***************************************************************************** */
function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var i=0;for(n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]])}return r}(i,["title","image"]);o&&(n+=`<h2>${t(o)}</h2>`),s&&(n+=`<img src="${t(s)}">`);const l=Object.keys(a);if(l.length>0){n+="<table>";for(const e of l){let i=a[e];void 0!==i&&(Wn(i)&&(i=Hn(i,r)),n+=`<tr><td class="key">${t(e)}:</td><td class="value">${t(i)}</td></tr>`)}n+="</table>"}return n||"{}"}return t(e)}};class Qn{constructor(e){this.options=Object.assign(Object.assign({},Jn),e);const t=this.options.id;if(this.el=null,this.call=this.tooltipHandler.bind(this),!this.options.disableDefaultStyle&&!document.getElementById(this.options.styleId)){const e=document.createElement("style");e.setAttribute("id",this.options.styleId),e.innerHTML=function(e){if(!/^[A-Za-z]+[-:.\w]*$/.test(e))throw new Error("Invalid HTML ID");return qn.toString().replace(Yn,e)}(t);const r=document.head;r.childNodes.length>0?r.insertBefore(e,r.childNodes[0]):r.appendChild(e)}}tooltipHandler(e,t,r,n){var i;this.el=document.getElementById(this.options.id),this.el||(this.el=document.createElement("div"),this.el.setAttribute("id",this.options.id),this.el.classList.add("vg-tooltip"),document.body.appendChild(this.el));if((null!==(i=document.fullscreenElement)&&void 0!==i?i:document.body).appendChild(this.el),null==n||""===n)return void this.el.classList.remove("visible",`${this.options.theme}-theme`);this.el.innerHTML=this.options.formatTooltip(n,this.options.sanitize,this.options.maxDepth),this.el.classList.add("visible",`${this.options.theme}-theme`);const{x:o,y:s}=function(e,t,r,n){let i=e.clientX+r;i+t.width>window.innerWidth&&(i=+e.clientX-r-t.width);let o=e.clientY+n;return o+t.height>window.innerHeight&&(o=+e.clientY-n-t.height),{x:i,y:o}}(t,this.el.getBoundingClientRect(),this.options.offsetX,this.options.offsetY);this.el.setAttribute("style",`top: ${s}px; left: ${o}px`)}}var Zn,Kn='.vega-embed {\n  position: relative;\n  display: inline-block;\n  box-sizing: border-box; }\n  .vega-embed.has-actions {\n    padding-right: 38px; }\n  .vega-embed details:not([open]) > :not(summary) {\n    display: none !important; }\n  .vega-embed summary {\n    list-style: none;\n    position: absolute;\n    top: 0;\n    right: 0;\n    padding: 6px;\n    z-index: 1000;\n    background: white;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.1);\n    color: #1b1e23;\n    border: 1px solid #aaa;\n    border-radius: 999px;\n    opacity: 0.2;\n    transition: opacity 0.4s ease-in;\n    outline: none;\n    cursor: pointer;\n    line-height: 0px; }\n    .vega-embed summary::-webkit-details-marker {\n      display: none; }\n    .vega-embed summary:active {\n      box-shadow: #aaa 0px 0px 0px 1px inset; }\n    .vega-embed summary svg {\n      width: 14px;\n      height: 14px; }\n  .vega-embed details[open] summary {\n    opacity: 0.7; }\n  .vega-embed:hover summary,\n  .vega-embed:focus summary {\n    opacity: 1 !important;\n    transition: opacity 0.2s ease; }\n  .vega-embed .vega-actions {\n    position: absolute;\n    z-index: 1001;\n    top: 35px;\n    right: -9px;\n    display: flex;\n    flex-direction: column;\n    padding-bottom: 8px;\n    padding-top: 8px;\n    border-radius: 4px;\n    box-shadow: 0 2px 8px 0 rgba(0, 0, 0, 0.2);\n    border: 1px solid #d9d9d9;\n    background: white;\n    animation-duration: 0.15s;\n    animation-name: scale-in;\n    animation-timing-function: cubic-bezier(0.2, 0, 0.13, 1.5);\n    text-align: left; }\n    .vega-embed .vega-actions a {\n      padding: 8px 16px;\n      font-family: sans-serif;\n      font-size: 14px;\n      font-weight: 600;\n      white-space: nowrap;\n      color: #434a56;\n      text-decoration: none; }\n      .vega-embed .vega-actions a:hover {\n        background-color: #f7f7f9;\n        color: black; }\n    .vega-embed .vega-actions::before, .vega-embed .vega-actions::after {\n      content: "";\n      display: inline-block;\n      position: absolute; }\n    .vega-embed .vega-actions::before {\n      left: auto;\n      right: 14px;\n      top: -16px;\n      border: 8px solid #0000;\n      border-bottom-color: #d9d9d9; }\n    .vega-embed .vega-actions::after {\n      left: auto;\n      right: 15px;\n      top: -14px;\n      border: 7px solid #0000;\n      border-bottom-color: #fff; }\n  .vega-embed .chart-wrapper.fit-x {\n    width: 100%; }\n  .vega-embed .chart-wrapper.fit-y {\n    height: 100%; }\n\n.vega-embed-wrapper {\n  max-width: 100%;\n  overflow: auto;\n  padding-right: 14px; }\n\n@keyframes scale-in {\n  from {\n    opacity: 0;\n    transform: scale(0.6); }\n  to {\n    opacity: 1;\n    transform: scale(1); } }\n';function ei(e,...t){for(const r of t)ti(e,r);return e}function ti(t,r){for(const n of Object.keys(r))e.writeConfig(t,n,r[n],!0)}String.prototype.startsWith||(String.prototype.startsWith=function(e,t){return this.substr(!t||t<0?0:+t,e.length)===e});const ri=i;let ni=o;const ii="undefined"!=typeof window?window:void 0;void 0===ni&&null!=ii&&null!==(Zn=ii.vl)&&void 0!==Zn&&Zn.compile&&(ni=ii.vl);const oi={export:{svg:!0,png:!0},source:!0,compiled:!0,editor:!0},si={CLICK_TO_VIEW_ACTIONS:"Click to view actions",COMPILED_ACTION:"View Compiled Vega",EDITOR_ACTION:"Open in Vega Editor",PNG_ACTION:"Save as PNG",SOURCE_ACTION:"View Source",SVG_ACTION:"Save as SVG"},ai={vega:"Vega","vega-lite":"Vega-Lite"},li={vega:ri.version,"vega-lite":ni?ni.version:"not available"},ci={vega:e=>e,"vega-lite":(e,t)=>ni.compile(e,{config:t}).spec},hi='\n<svg viewBox="0 0 16 16" fill="currentColor" stroke="none" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">\n  <circle r="2" cy="8" cx="2"></circle>\n  <circle r="2" cy="8" cx="8"></circle>\n  <circle r="2" cy="8" cx="14"></circle>\n</svg>',pi="chart-wrapper";function ui(e,t,r,n){const i=`<html><head>${t}</head><body><pre><code class="json">`,o=`</code></pre>${r}</body></html>`,s=window.open("");s.document.write(i+e+o),s.document.title=`${ai[n]} JSON Source`}function fi(e){return(t=e)&&"load"in t?e:ri.loader(e);var t}function di(e){var t;return null!==(t=e.usermeta&&e.usermeta.embedOptions)&&void 0!==t?t:{}}async function vi(t,r,n={}){var i,o;let s,a;e.isString(r)?(a=fi(n.loader),s=JSON.parse(await a.load(r))):s=r;const l=di(s).loader;var c;a&&!l||(a=fi(null!==(c=n.loader)&&void 0!==c?c:l));const h=await gi(di(s),a),p=await gi(n,a),u={...ei(p,h),config:e.mergeConfig(null!==(i=p.config)&&void 0!==i?i:{},null!==(o=h.config)&&void 0!==o?o:{})};return await async function(t,r,n={},i){var o,s,a,l,c;const h=n.theme?e.mergeConfig(zn[n.theme],null!==(o=n.config)&&void 0!==o?o:{}):n.config,p=e.isBoolean(n.actions)?n.actions:ei({},oi,null!==(s=n.actions)&&void 0!==s?s:{}),u={...si,...n.i18n},f=null!==(a=n.renderer)&&void 0!==a?a:"canvas",d=null!==(l=n.logLevel)&&void 0!==l?l:ri.Warn,v=null!==(c=n.downloadFileName)&&void 0!==c?c:"visualization",g="string"==typeof t?document.querySelector(t):t;if(!g)throw new Error(`${t} does not exist`);if(!1!==n.defaultStyle){const e="vega-embed-style",{root:t,rootContainer:r}=function(e){const t=e.getRootNode?e.getRootNode():document;var r;return t instanceof ShadowRoot?{root:t,rootContainer:t}:{root:document,rootContainer:null!==(r=document.head)&&void 0!==r?r:document.body}}(g);if(!t.getElementById(e)){const t=document.createElement("style");t.id=e,t.innerText=void 0===n.defaultStyle||!0===n.defaultStyle?Kn.toString():n.defaultStyle,r.appendChild(t)}}const m=function(e,t){if(e.$schema){const n=on(e.$schema);var r;t&&t!==n.library&&console.warn(`The given visualization spec is written in ${ai[n.library]}, but mode argument sets ${null!==(r=ai[t])&&void 0!==r?r:t}.`);const i=n.library;return nn.satisfies(li[i],`^${n.version.slice(1)}`)||console.warn(`The input spec uses ${ai[i]} ${n.version}, but the current version of ${ai[i]} is v${li[i]}.`),i}return"mark"in e||"encoding"in e||"layer"in e||"hconcat"in e||"vconcat"in e||"facet"in e||"repeat"in e?"vega-lite":"marks"in e||"signals"in e||"scales"in e||"axes"in e?"vega":null!=t?t:"vega"}(r,n.mode);let E=ci[m](r,h);if("vega-lite"===m&&E.$schema){const e=on(E.$schema);nn.satisfies(li.vega,`^${e.version.slice(1)}`)||console.warn(`The compiled spec uses Vega ${e.version}, but current version is v${li.vega}.`)}g.classList.add("vega-embed"),p&&g.classList.add("has-actions");g.innerHTML="";let b=g;if(p){const e=document.createElement("div");e.classList.add(pi),g.appendChild(e),b=e}const y=n.patch;y&&(E=y instanceof Function?y(E):I(E,y,!0,!1).newDocument);n.formatLocale&&ri.formatLocale(n.formatLocale);n.timeFormatLocale&&ri.timeFormatLocale(n.timeFormatLocale);const{ast:w}=n,O=ri.parse(E,"vega-lite"===m?{}:h,{ast:w}),A=new(n.viewClass||ri.View)(O,{loader:i,logLevel:d,renderer:f,...w?{expr:ri.expressionInterpreter}:{}});if(A.addSignalListener("autosize",((e,t)=>{const{type:r}=t;"fit-x"==r?(b.classList.add("fit-x"),b.classList.remove("fit-y")):"fit-y"==r?(b.classList.remove("fit-x"),b.classList.add("fit-y")):"fit"==r?b.classList.add("fit-x","fit-y"):b.classList.remove("fit-x","fit-y")})),!1!==n.tooltip){let e;e="function"==typeof n.tooltip?n.tooltip:new Qn(!0===n.tooltip?{}:n.tooltip).call,A.tooltip(e)}let R,{hover:$}=n;void 0===$&&($="vega"===m);if($){const{hoverSet:e,updateSet:t}="boolean"==typeof $?{}:$;A.hover(e,t)}n&&(null!=n.width&&A.width(n.width),null!=n.height&&A.height(n.height),null!=n.padding&&A.padding(n.padding));if(await A.initialize(b,n.bind).runAsync(),!1!==p){let e=g;if(!1!==n.defaultStyle){const t=document.createElement("details");t.title=u.CLICK_TO_VIEW_ACTIONS,g.append(t),e=t;const r=document.createElement("summary");r.innerHTML=hi,t.append(r),R=e=>{t.contains(e.target)||t.removeAttribute("open")},document.addEventListener("click",R)}const t=document.createElement("div");if(e.append(t),t.classList.add("vega-actions"),!0===p||!1!==p.export)for(const e of["svg","png"])if(!0===p||!0===p.export||p.export[e]){const r=u[`${e.toUpperCase()}_ACTION`],i=document.createElement("a");i.text=r,i.href="#",i.target="_blank",i.download=`${v}.${e}`,i.addEventListener("mousedown",(async function(t){t.preventDefault();const r=await A.toImageURL(e,n.scaleFactor);this.href=r})),t.append(i)}if(!0===p||!1!==p.source){const e=document.createElement("a");e.text=u.SOURCE_ACTION,e.href="#",e.addEventListener("click",(function(e){var t,i;ui(P(r),null!==(t=n.sourceHeader)&&void 0!==t?t:"",null!==(i=n.sourceFooter)&&void 0!==i?i:"",m),e.preventDefault()})),t.append(e)}if("vega-lite"===m&&(!0===p||!1!==p.compiled)){const e=document.createElement("a");e.text=u.COMPILED_ACTION,e.href="#",e.addEventListener("click",(function(e){var t,r;ui(P(E),null!==(t=n.sourceHeader)&&void 0!==t?t:"",null!==(r=n.sourceFooter)&&void 0!==r?r:"","vega"),e.preventDefault()})),t.append(e)}if(!0===p||!1!==p.editor){var N;const e=null!==(N=n.editorUrl)&&void 0!==N?N:"https://vega.github.io/editor/",i=document.createElement("a");i.text=u.EDITOR_ACTION,i.href="#",i.addEventListener("click",(function(t){!function(e,t,r){const n=e.open(t),{origin:i}=new URL(t);let o=40;e.addEventListener("message",(function t(r){r.source===n&&(o=0,e.removeEventListener("message",t,!1))}),!1),setTimeout((function e(){o<=0||(n.postMessage(r,i),setTimeout(e,250),o-=1)}),250)}(window,e,{config:h,mode:m,renderer:f,spec:P(r)}),t.preventDefault()})),t.append(i)}}function x(){R&&document.removeEventListener("click",R),A.finalize()}return{view:A,spec:r,vgSpec:E,finalize:x}}(t,s,u,a)}async function gi(t,r){var n;const i=e.isString(t.config)?JSON.parse(await r.load(t.config)):null!==(n=t.config)&&void 0!==n?n:{},o=e.isString(t.patch)?JSON.parse(await r.load(t.patch)):t.patch;return{...t,...o?{patch:o}:{},...i?{config:i}:{}}}async function mi(e,t={}){var r;const n=document.createElement("div");n.classList.add("vega-embed-wrapper");const i=document.createElement("div");n.appendChild(i);const o=!0===t.actions||!1===t.actions?t.actions:{export:!0,source:!1,compiled:!0,editor:!0,...null!==(r=t.actions)&&void 0!==r?r:{}},s=await vi(i,e,{actions:o,...null!=t?t:{}});return n.value=s.view,n}const Ei=(...t)=>{return t.length>1&&(e.isString(t[0])&&!((r=t[0]).startsWith("http://")||r.startsWith("https://")||r.startsWith("//"))||t[0]instanceof HTMLElement||3===t.length)?vi(t[0],t[1],t[2]):mi(t[0],t[1]);var r};return Ei.vegaLite=ni,Ei.vl=ni,Ei.container=mi,Ei.embed=vi,Ei.vega=ri,Ei.default=vi,Ei.version=s,Ei}));
