...
import { writeConfig, mergeConfig, isString, isObject, isBoolean } from 'vega';
                ...
                try {
                  _loop = function _loop() {
                    ...
                    if (actions === true || actions.export === true || actions.export[ext]) {
                      ...
                      var scaleFactor = isObject(opts.scaleFactor) ? opts.scaleFactor[ext] : opts.scaleFactor;
