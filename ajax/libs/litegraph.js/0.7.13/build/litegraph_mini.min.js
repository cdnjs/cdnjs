...
e||!(6>g||g>l-12||k<q.last_y||k>q.last_y+y||void 0===q.last_y)){e=q.value;switch(q.type){case "button":c.type===f.pointerevents_method+"down"&&(q.callback&&setTimeout(function(){q.callback(q,h,a,b,c)},20),this.dirty_canvas=q.clicked=!0);break;case "slider":r=Math.clamp((g-15)/(l-30),0,1);if(q.options.read_only)break;q.value=q.options.min+(q.options.max-q.options.min)*r;q.callback&&setTimeout(function(){d(q,q.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":e=q.value;if(c.type==f.pointerevents_method+
"move"&&"number"==q.type)c.deltaX&&(q.value+=.1*c.deltaX*(q.options.step||1)),null!=q.options.min&&q.value<q.options.min&&(q.value=q.options.min),null!=q.options.max&&q.value>q.options.max&&(q.value=q.options.max);else if(c.type==f.pointerevents_method+"down"){var v=q.options.values;v&&v.constructor===Function&&(v=q.options.values(q,a));var m=null;"number"!=q.type&&(m=v.constructor===Array?v:Object.keys(v));g=40>g?-1:g>l-40?1:0;if("number"==q.type)q.value+=.1*g*(q.options.step||1),null!=q.options.min&&
q.value<q.options.min&&(q.value=q.options.min),null!=q.options.max&&q.value>q.options.max&&(q.value=q.options.max);else if(g)r=-1,this.last_mouseclick=0,r=v.constructor===Object?m.indexOf(String(q.value))+g:m.indexOf(q.value)+g,r>=m.length&&(r=m.length-1),0>r&&(r=0),q.value=v.constructor===Array?v[r]:r;else{var w=v!=m?Object.values(v):v;new f.ContextMenu(w,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){v!=m&&(a=w.indexOf(a));this.value=a;d(this,a);h.dirty_canvas=
!0;return!1}.bind(q)},r)}}else c.type==f.pointerevents_method+"up"&&"number"==q.type&&(g=40>g?-1:g>l-40?1:0,200>c.click_time&&0==g&&this.prompt("Value",q.value,function(a){if(/^[0-9+\-*/()\s]+$/.test(a))try{a=eval(a)}catch(O){}this.value=Number(a);d(this,this.value)}.bind(q),c));e!=q.value&&setTimeout(function(){d(this,this.value)}.bind(q),20);this.dirty_canvas=!0;break;case "toggle":c.type==f.pointerevents_method+"down"&&(q.value=!q.value,setTimeout(function(){d(q,q.value)},20));break;case "string":case "text":c.type==
f.pointerevents_method+"down"&&this.prompt("Value",q.value,function(a){d(this,a)}.bind(q),c,q.options?q.options.multiline:!1);break;default:q.mouse&&(this.dirty_canvas=q.mouse(c,[g,k],a))}if(e!=q.value){if(a.onWidgetChanged)a.onWidgetChanged(q.name,q.value,e,q);a.graph._version++}return q}}}return null};h.prototype.drawGroups=function(a,b){if(this.graph){a=this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var e=a[c];if(B(this.visible_area,e._bounding)){b.fillStyle=
