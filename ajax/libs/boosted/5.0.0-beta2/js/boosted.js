/*!
  ...
  * Bootstrap v5.0.0-beta2 (https://boosted.orange.com/)
...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@popperjs/core'), require('focus-visible')) :
  typeof define === 'function' && define.amd ? define(['@popperjs/core', 'focus-visible'], factory) :
  ...
  var Carousel = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._updateInterval = function _updateInterval() {
      ...
      if (this._indicatorsElement && this._config.interval !== Default.interval) {
        ...
        var currentIndicator = SelectorEngine.findOne(":nth-child(" + (currentIndex + 1) + ")", this._indicatorsElement);
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      if (!this._config.wrap) {
        var prevControl = SelectorEngine.findOne(SELECTOR_CONTROL_PREV, this._element);
        var nextControl = SelectorEngine.findOne(SELECTOR_CONTROL_NEXT, this._element);
