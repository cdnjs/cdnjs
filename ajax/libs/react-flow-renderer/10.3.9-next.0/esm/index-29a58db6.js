...
function getTranslateValues(domNode) {
  if (typeof window === 'undefined' || !window.DOMMatrixReadOnly) {
    return [0, 0];
  }

  var style = window.getComputedStyle(domNode);

  var _window$DOMMatrixRead = new window.DOMMatrixReadOnly(style.transform),
      m41 = _window$DOMMatrixRead.m41,
      m42 = _window$DOMMatrixRead.m42;

  return [m41, m42];
}

var getHandleBounds = function getHandleBounds(selector, nodeElement) {
  ...
  return handlesArray.map(function (handle) {
    ...
    var _getTranslateValues = getTranslateValues(handle),
        _getTranslateValues2 = _slicedToArray(_getTranslateValues, 2),
        translateX = _getTranslateValues2[0],
        translateY = _getTranslateValues2[1];
...
var initialState = {
  ...
  reactFlowVersion: "10.3.9-next.0" ,
...
//# sourceMappingURL=index-29a58db6.js.map
