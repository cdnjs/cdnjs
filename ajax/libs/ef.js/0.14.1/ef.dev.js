(function (global, factory) {
	...
	var getDbg = function () {
		if (typeof console === 'undefined') {
			...
			return {
				log: function (args) { return print(assemblePrintContent('LOG ', args)); },
				info: function (args) { return print(assemblePrintContent('INFO', args)); },
				warn: function (args) { return print(assemblePrintContent('WARN', args)); },
				error: function (args) { return print(assemblePrintContent('ERROR', args)); }
			}
		}
