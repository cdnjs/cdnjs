 ...
 * @public
 */
export declare type ExtraSigninRequestArgs = Pick<CreateSigninRequestArgs, "nonce" | "extraQueryParams" | "extraTokenParams" | "state" | "redirect_uri" | "prompt" | "acr_values">;
...
declare class TokenClient {
    ...
    exchangeCredentials({ grant_type, client_id, client_secret, scope, username, password, }: ExchangeCredentialsArgs): Promise<Record<string, unknown>>;
