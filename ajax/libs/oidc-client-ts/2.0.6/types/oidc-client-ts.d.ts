...
declare class TokenClient {
    ...
    exchangeRefreshToken({ grant_type, client_id, client_secret, timeoutInSeconds, refreshTokenCredentials, ...args }: ExchangeRefreshTokenArgs): Promise<Record<string, unknown>>;
    /**
