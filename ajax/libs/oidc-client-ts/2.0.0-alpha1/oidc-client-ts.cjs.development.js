...
var Timer = /*#__PURE__*/function (_Event) {
  ...
  _proto.init = function init(duration) {
    ...
    var expiration = Timer.getEpochTime() + duration;
...
var CordovaPopupWindow = /*#__PURE__*/function () {
  function CordovaPopupWindow(params) {
    ...
    this._popup = void 0;
    this._exitCallbackEvent = void 0;
    this._loadStartCallbackEvent = void 0;
...
var IFrameWindow = /*#__PURE__*/function () {
  ...
  _proto.navigate = function navigate(params) {
    if (!params || !params.url) {
      ...
      this._timer = window.setTimeout(this._timeout.bind(this), timeout); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  ...
  _proto._cleanup = function _cleanup() {
    if (this._frame) {
      Log.debug("IFrameWindow: cleanup"); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion

      window.removeEventListener("message", this._boundMessageEvent, false); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
...
var DefaultPopupFeatures$1 = "location=no,toolbar=no,width=500,height=500,left=100,top=100;"; //const DefaultPopupFeatures = 'location=no,toolbar=no,width=500,height=500,left=100,top=100;resizable=yes';
...
var PopupWindow = /*#__PURE__*/function () {
  function PopupWindow(params) {
    ...
    var target = params.popupWindowTarget || DefaultPopupTarget$1;
    var features = params.popupWindowFeatures || DefaultPopupFeatures$1;
...
function OidcClientSettingsStore(_ref) {
  ...
  this.staleStateAge = void 0;
  this.clockSkew = void 0;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 38:
              ...
              Log.error("JsonService.getJson: Error parsing JSON response", _context.t1.message);
              throw _context.t1;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 32:
              ...
              Log.error("JsonService.postForm: Error parsing JSON response", _context2.t1.message);
              throw _context2.t1;
            ...
            case 54:
              ...
              Log.error("JsonService.postForm: Error parsing JSON response", _context2.t2.message);
              throw _context2.t2;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 38:
              ...
              clockSkewInSeconds = this._settings.clockSkew;
              Log.debug("UserInfoService._getClaimsFromJwt: Validaing JWT; using clock skew (in seconds) of: ", clockSkewInSeconds);
              _context2.next = 43;
              return JoseUtil.validateJwt(responseText, key, issuer, audience, clockSkewInSeconds, undefined, true);
            ...
            case 47:
              ...
              Log.error("UserInfoService._getClaimsFromJwt: Error parsing JWT response", _context2.t1.message);
              throw _context2.t1;
...
var TokenClient = /*#__PURE__*/function () {
  ...
  _proto.exchangeCode = /*#__PURE__*/function () {
    var _exchangeCode = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(args) {
      var basicAuth, client_authentication, url, response;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              basicAuth = undefined;
              client_authentication = args._client_authentication || this._settings.client_authentication;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 21:
              ...
              _context8.next = 26;
              return JoseUtil.validateJwt(id_token, key, issuer, audience, clockSkewInSeconds);
...
var OidcClient = /*#__PURE__*/function () {
  ...
  _proto.createSigninRequest = /*#__PURE__*/function () {
    var _createSigninRequest = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(_temp) {
      var _ref, response_type, scope, redirect_uri, data, state, prompt, display, max_age, ui_locales, id_token_hint, login_hint, acr_values, resource, request, request_uri, response_mode, extraQueryParams, extraTokenParams, request_type, skipUserInfo, url, signinRequest, signinState;

      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _ref = _temp === void 0 ? {} : _temp, response_type = _ref.response_type, scope = _ref.scope, redirect_uri = _ref.redirect_uri, data = _ref.data, state = _ref.state, prompt = _ref.prompt, display = _ref.display, max_age = _ref.max_age, ui_locales = _ref.ui_locales, id_token_hint = _ref.id_token_hint, login_hint = _ref.login_hint, acr_values = _ref.acr_values, resource = _ref.resource, request = _ref.request, request_uri = _ref.request_uri, response_mode = _ref.response_mode, extraQueryParams = _ref.extraQueryParams, extraTokenParams = _ref.extraTokenParams, request_type = _ref.request_type, skipUserInfo = _ref.skipUserInfo;
  ...
  _proto.createSignoutRequest = /*#__PURE__*/function () {
    var _createSignoutRequest = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(_temp2) {
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _ref2 = _temp2 === void 0 ? {} : _temp2, id_token_hint = _ref2.id_token_hint, data = _ref2.data, state = _ref2.state, post_logout_redirect_uri = _ref2.post_logout_redirect_uri, extraQueryParams = _ref2.extraQueryParams, request_type = _ref2.request_type;
...
var UserManagerSettingsStore = /*#__PURE__*/function (_OidcClientSettingsSt) {
  ...
  function UserManagerSettingsStore(args) {
    ...
    var popup_redirect_uri = args.popup_redirect_uri,
        ...
        silentRequestTimeout = args.silentRequestTimeout,
        _args$automaticSilent = args.automaticSilentRenew,
        automaticSilentRenew = _args$automaticSilent === void 0 ? false : _args$automaticSilent,
        _args$validateSubOnSi = args.validateSubOnSilentRenew,
        validateSubOnSilentRenew = _args$validateSubOnSi === void 0 ? false : _args$validateSubOnSi,
        _args$includeIdTokenI = args.includeIdTokenInSilentRenew,
        includeIdTokenInSilentRenew = _args$includeIdTokenI === void 0 ? true : _args$includeIdTokenI,
        _args$monitorSession = args.monitorSession,
        monitorSession = _args$monitorSession === void 0 ? true : _args$monitorSession,
        ...
        _args$checkSessionInt = args.checkSessionInterval,
        checkSessionInterval = _args$checkSessionInt === void 0 ? DefaultCheckSessionInterval : _args$checkSessionInt,
        ...
        _args$accessTokenExpi = args.accessTokenExpiringNotificationTime,
        accessTokenExpiringNotificationTime = _args$accessTokenExpi === void 0 ? DefaultAccessTokenExpiringNotificationTime : _args$accessTokenExpi,
    ...
    _this.silentRequestTimeout = void 0;
    ...
    _this.silentRequestTimeout = silentRequestTimeout;
    ...
    _this.checkSessionInterval = checkSessionInterval;
    ...
    _this.accessTokenExpiringNotificationTime = accessTokenExpiringNotificationTime;
...
var AccessTokenEvents = /*#__PURE__*/function () {
  function AccessTokenEvents(_ref) {
    ...
    this._accessTokenExpiringNotificationTime = void 0;
    this._accessTokenExpiring = void 0;
    this._accessTokenExpired = void 0;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              Log.error("SilentRenewService.start: Error from getUser:", _context.t0.message);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              Log.error("SilentRenewService._tokenExpiring: Error from signinSilent:", _context2.t0.message);

              this._userManager.events._raiseSilentRenewError(_context2.t0);
...
var SessionMonitor = /*#__PURE__*/function () {
  ...
  _proto._start = /*#__PURE__*/function () {
    var _start2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(user) {
      var session_state, url, client_id, interval, stopOnError;
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 7:
              ...
              interval = this._userManager.settings.checkSessionInterval;
              ...
              _context2.next = 16;
              return this._checkSessionIFrame.load();

            case 16:
              this._checkSessionIFrame && this._checkSessionIFrame.start(session_state);
              _context2.next = 20;
              break;
            ...
            case 22:
              ...
              Log.error("SessionMonitor._start: Error from getCheckSessionIframe:", _context2.t0.message);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 9:
                ...
                Log.error("SessionMonitor: error from querySessionStatus:", _context3.t0.message);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 9:
              ...
              if (this._sub) {
                Log.debug("SessionMonitor._callback: Error calling queryCurrentSigninSession; raising signed out event", _context4.t0.message);
...
var UserManager = /*#__PURE__*/function (_OidcClient) {
  ...
  function UserManager(settings) {
    ...
    _this._redirectNavigator = void 0;
    _this._popupNavigator = void 0;
    _this._iframeNavigator = void 0;
    _this._events = void 0;
    _this._silentRenewService = void 0;
    _this._sessionMonitor = void 0;
    _this._tokenRevocationClient = void 0;
    _this._tokenClient = void 0;
    _this.settings = new UserManagerSettingsStore(settings);
    _this._redirectNavigator = new RedirectNavigator();
    _this._popupNavigator = new PopupNavigator();
    _this._iframeNavigator = new IFrameNavigator();
    _this._events = new UserManagerEvents(_this.settings);
    _this._silentRenewService = new SilentRenewService(_assertThisInitialized(_this)); // order is important for the following properties; these services depend upon the events.
    ...
    if (_this.settings.monitorSession) {
      ...
      _this._sessionMonitor = new SessionMonitor(_assertThisInitialized(_this));
    }

    _this._tokenRevocationClient = new TokenRevocationClient(_this.settings, _this.metadataService);
    _this._tokenClient = new TokenClient(_this.settings, _this.metadataService);
    return _this;
  }
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 6:
              ...
              Log.error("UserManager.signinPopupCallback error: " + (typeof (_context6.t0 == null ? void 0 : _context6.t0.message) === "string" ? _context6.t0 == null ? void 0 : _context6.t0.message : "undefined"));
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              now = Timer.getEpochTime();
              _context9.next = 6;
              return JoseUtil.validateJwtAttributes(id_token, issuer, this.settings.client_id, this.settings.clockSkew, now);
  ...
  _proto.signinCallback = /*#__PURE__*/function () {
    var _signinCallback2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee12(url) {
      var _yield$this$readSigni, state;
      ...
      return runtime_1.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 2:
              _yield$this$readSigni = _context12.sent;
              state = _yield$this$readSigni.state;
  ...
  _proto.signoutCallback = /*#__PURE__*/function () {
    var _signoutCallback = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee13(url, keepOpen) {
      var _yield$this$readSigno, state;
      ...
      return runtime_1.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 3:
              _yield$this$readSigno = _context13.sent;
              state = _yield$this$readSigno.state;
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 22:
              ...
              if (!(_context14.t0.session_state && this.settings.monitorAnonymousSession)) {
                _context14.next = 28;
                break;
              }
