...
var UserManager = class {
   ...
   */
  async dpopProof(url, user, httpMethod) {
    var _a, _b;
    const dpopKey = await ((_b = (_a = this.settings.dpop) == null ? void 0 : _a.store) == null ? void 0 : _b.get(this.settings.client_id));
    if (dpopKey) {
      return await CryptoUtils.generateDPoPProof({
        url,
