...
declare interface CreateSigninRequestArgs {
    redirect_uri?: string;
...
declare type CreateSignoutRequestArgs = Omit<SignoutRequestArgs, "url"> & {
    state?: any;
};
...
declare class ResponseValidator {
    ...
    protected _getSigningKeyForJwt(jwt: ParsedJwt): Promise<Record<string, string> | null>;
    protected _getSigningKeyForJwtWithSingleRetry(jwt: ParsedJwt): Promise<Record<string, string> | null>;
...
declare class UserManagerEvents extends AccessTokenEvents {
    private _userLoaded;
