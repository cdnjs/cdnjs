/**
 * react.development.js v16.0.0-alpha.7
 */
  ...
  var boundMethod = method.bind(component);
  {
    ...
    boundMethod.bind = function (newThis) {
      ...
      if (newThis !== component && newThis !== null) {
        warning_1(false, 'bind(): React component methods may only be bound to the ' + 'component instance.\n\nSee %s', componentName);
      } else if (!args.length) {
        warning_1(false, 'bind(): You are binding a component method to the component. ' + 'React does this for you automatically in a high-performance ' + 'way, so you can safely remove this call.\n\nSee %s', componentName);
        return boundMethod;
      }
...
index(ReactClassComponent.prototype, ReactComponent$1.prototype, ReactClassMixin);
    ...
    for (var typeSpecName in typeSpecs) {
      if (typeSpecs.hasOwnProperty(typeSpecName)) {
        ...
        try {
          ...
          !(typeof typeSpecs[typeSpecName] === 'function') ? invariant_1(false, '%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.', componentName || 'React class', location, typeSpecName) : void 0;
...
{
  index(ReactUMDEntry.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, {
