...
b,c)};f.useRef=function(a){return m.current.useRef(a)};f.useState=function(a){return m.current.useState(a)};f.useSyncExternalStore=function(a,b,c){return m.current.useSyncExternalStore(a,b,c)};f.useTransition=function(){return m.current.useTransition()};f.version="18.3.0-canary-59831c98c-20240218"})})();
