...
exports.startTransition=function(a){var b=Q.transition,c=new Set;Q.transition={_callbacks:c};var e=Q.transition;try{var d=a();"object"===typeof d&&null!==d&&"function"===typeof d.then&&(c.forEach(function(f){return f(e,d)}),d.then(X,Y))}catch(f){Y(f)}finally{Q.transition=b}};exports.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.");};exports.unstable_useCacheRefresh=function(){return P.current.useCacheRefresh()};exports.use=function(a){return P.current.use(a)};
...
exports.useSyncExternalStore=function(a,b,c){return P.current.useSyncExternalStore(a,b,c)};exports.useTransition=function(){return P.current.useTransition()};exports.version="18.3.0-canary-1219d57fc-20240201";
