...
typeof MessageChannel){v=new MessageChannel;var La=v.port2;v.port1.onmessage=Z;L=function(){La.postMessage(null)}}else L=function(){oa(Z,0)};v={ReactCurrentDispatcher:m,ReactCurrentCache:ra,ReactCurrentOwner:P,ReactCurrentBatchConfig:M,Scheduler:{__proto__:null,unstable_IdlePriority:5,unstable_ImmediatePriority:1,unstable_LowPriority:4,unstable_NormalPriority:3,unstable_Profiling:null,unstable_UserBlockingPriority:2,unstable_cancelCallback:function(a){a.callback=null},unstable_continueExecution:function(){w||
I||(w=!0,V(W))},unstable_forceFrameRate:function(a){0>a||125<a?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):na=0<a?Math.floor(1E3/a):5},unstable_getCurrentPriorityLevel:function(){return p},unstable_getFirstCallbackNode:function(){return r(t)},unstable_next:function(a){switch(p){case 1:case 2:case 3:var b=3;break;default:b=p}var c=p;p=b;try{return a()}finally{p=c}},get unstable_now(){return x},unstable_pauseExecution:function(){},
...
c>d?(a.sortIndex=c,T(u,a),null===r(t)&&a===r(u)&&(B?(ka(C),C=-1):B=!0,X(U,c-d))):(a.sortIndex=e,T(t,a),w||I||(w=!0,V(W)));return a},unstable_shouldYield:la,unstable_wrapCallback:function(a){var b=p;return function(){var c=p;p=b;try{return a.apply(this,arguments)}finally{p=c}}}},ContextRegistry:N};f.Children={map:E,forEach:function(a,b,c){E(a,function(){b.apply(this,arguments)},c)},count:function(a){var b=0;E(a,function(){b++});return b},toArray:function(a){return E(a,function(b){return b})||[]},only:function(a){if(!Q(a))throw Error("React.Children.only expected to receive a single React element child.");
...
f.version="18.3.0-next-b14f8da15-20230403"});
})();
