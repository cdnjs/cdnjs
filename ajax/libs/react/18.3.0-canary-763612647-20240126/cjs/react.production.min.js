...
exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=R;exports.cache=function(a){return function(){return a.apply(null,arguments)}};
...
exports.forwardRef=function(a){return{$$typeof:v,render:a}};exports.isValidElement=O;exports.lazy=function(a){return{$$typeof:y,_payload:{_status:-1,_result:a},_init:W}};exports.memo=function(a,b){return{$$typeof:x,type:a,compare:void 0===b?null:b}};exports.startTransition=function(a){var b=Q.transition,c=new Set;Q.transition={_callbacks:c};var e=Q.transition;try{var d=a();c.forEach(function(f){return f(e,d)})}finally{Q.transition=b}};
exports.unstable_act=function(){throw Error("act(...) is not supported in production builds of React.");};exports.unstable_useCacheRefresh=function(){return P.current.useCacheRefresh()};exports.use=function(a){return P.current.use(a)};exports.useCallback=function(a,b){return P.current.useCallback(a,b)};exports.useContext=function(a){return P.current.useContext(a)};exports.useDebugValue=function(){};exports.useDeferredValue=function(a,b){return P.current.useDeferredValue(a,b)};
exports.useEffect=function(a,b){return P.current.useEffect(a,b)};exports.useId=function(){return P.current.useId()};exports.useImperativeHandle=function(a,b,c){return P.current.useImperativeHandle(a,b,c)};exports.useInsertionEffect=function(a,b){return P.current.useInsertionEffect(a,b)};exports.useLayoutEffect=function(a,b){return P.current.useLayoutEffect(a,b)};exports.useMemo=function(a,b){return P.current.useMemo(a,b)};exports.useOptimistic=function(a,b){return P.current.useOptimistic(a,b)};
exports.useReducer=function(a,b,c){return P.current.useReducer(a,b,c)};exports.useRef=function(a){return P.current.useRef(a)};exports.useState=function(a){return P.current.useState(a)};exports.useSyncExternalStore=function(a,b,c){return P.current.useSyncExternalStore(a,b,c)};exports.useTransition=function(){return P.current.useTransition()};exports.version="18.3.0-canary-763612647-20240126";
