...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$264;
  if (canUseDOM) {
    var isSupported$jscomp$inline_397 = "oninput" in document;
    if (!isSupported$jscomp$inline_397) {
      var element$jscomp$inline_398 = document.createElement("div");
      element$jscomp$inline_398.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_397 =
        "function" === typeof element$jscomp$inline_398.oninput;
    }
    JSCompiler_inline_result$jscomp$264 = isSupported$jscomp$inline_397;
  } else JSCompiler_inline_result$jscomp$264 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$264 &&
...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_438 = 0;
  i$jscomp$inline_438 < simpleEventPluginEvents.length;
  i$jscomp$inline_438++
) {
  var eventName$jscomp$inline_439 =
      simpleEventPluginEvents[i$jscomp$inline_438],
    domEventName$jscomp$inline_440 = eventName$jscomp$inline_439.toLowerCase(),
    capitalizedEvent$jscomp$inline_441 =
      eventName$jscomp$inline_439[0].toUpperCase() +
      eventName$jscomp$inline_439.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_440,
    "on" + capitalizedEvent$jscomp$inline_441
  );
}
...
function updateProperties(domElement, tag, lastProps, nextProps) {
  switch (tag) {
    ...
    case "input":
      ...
      for (var propKey$43 in nextProps) {
        var propKey = nextProps[propKey$43];
        lastProp = lastProps[propKey$43];
        if (
          nextProps.hasOwnProperty(propKey$43) &&
      ...
      return;
    case "select":
      propKey = value = defaultValue = propKey$43 = null;
      ...
      nextProps = propKey;
      null != propKey$43
        ? updateOptions(domElement, !!lastProps, propKey$43, !1)
        : !!nextProps !== !!lastProps &&
          (null != tag
    ...
    case "textarea":
      ...
      updateTextarea(domElement, propKey$43, propKey);
      return;
    case "option":
      for (var propKey$59 in lastProps)
        if (
          ((propKey$43 = lastProps[propKey$59]),
          lastProps.hasOwnProperty(propKey$59) &&
            null != propKey$43 &&
            !nextProps.hasOwnProperty(propKey$59))
        )
          switch (propKey$59) {
            case "selected":
              ...
              break;
            default:
              setProp(domElement, tag, propKey$59, null, nextProps, propKey$43);
          }
      for (lastDefaultValue in nextProps)
        if (
          ((propKey$43 = nextProps[lastDefaultValue]),
          (propKey = lastProps[lastDefaultValue]),
          nextProps.hasOwnProperty(lastDefaultValue) &&
            propKey$43 !== propKey &&
            (null != propKey$43 || null != propKey))
        )
          switch (lastDefaultValue) {
            case "selected":
              domElement.selected =
                propKey$43 &&
                "function" !== typeof propKey$43 &&
                "symbol" !== typeof propKey$43;
              break;
            default:
              setProp(
                domElement,
    ...
    case "wbr":
    case "menuitem":
      for (var propKey$64 in lastProps)
        (propKey$43 = lastProps[propKey$64]),
          lastProps.hasOwnProperty(propKey$64) &&
            null != propKey$43 &&
            !nextProps.hasOwnProperty(propKey$64) &&
            setProp(domElement, tag, propKey$64, null, nextProps, propKey$43);
      for (checked in nextProps)
        if (
          ((propKey$43 = nextProps[checked]),
          ...
          switch (checked) {
            ...
            case "dangerouslySetInnerHTML":
              ...
              break;
            default:
              setProp(domElement, tag, checked, propKey$43, nextProps, propKey);
          }
      return;
    default:
      if (isCustomElement(tag)) {
        for (var propKey$69 in lastProps)
          (propKey$43 = lastProps[propKey$69]),
            lastProps.hasOwnProperty(propKey$69) &&
              void 0 !== propKey$43 &&
              !nextProps.hasOwnProperty(propKey$69) &&
              setPropOnCustomElement(
                domElement,
                tag,
                propKey$69,
        ...
        for (defaultChecked in nextProps)
          (propKey$43 = nextProps[defaultChecked]),
            (propKey = lastProps[defaultChecked]),
            !nextProps.hasOwnProperty(defaultChecked) ||
              propKey$43 === propKey ||
              (void 0 === propKey$43 && void 0 === propKey) ||
              setPropOnCustomElement(
                domElement,
                tag,
                defaultChecked,
  ...
  for (var propKey$74 in lastProps)
    (propKey$43 = lastProps[propKey$74]),
      lastProps.hasOwnProperty(propKey$74) &&
        null != propKey$43 &&
        !nextProps.hasOwnProperty(propKey$74) &&
        setProp(domElement, tag, propKey$74, null, nextProps, propKey$43);
  for (lastProp in nextProps)
    (propKey$43 = nextProps[lastProp]),
      (propKey = lastProps[lastProp]),
      !nextProps.hasOwnProperty(lastProp) ||
        propKey$43 === propKey ||
        (null == propKey$43 && null == propKey) ||
        setProp(domElement, tag, lastProp, propKey$43, nextProps, propKey);
}
...
function flushSyncWorkAcrossRoots_impl(onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$100 = firstScheduledRoot; null !== root$100; ) {
        if (!onlyLegacy) {
          var workInProgressRootRenderLanes$102 = workInProgressRootRenderLanes;
          workInProgressRootRenderLanes$102 = getNextLanes(
            root$100,
            root$100 === workInProgressRoot
              ? workInProgressRootRenderLanes$102
              : 0
          );
          0 !== (workInProgressRootRenderLanes$102 & 3) &&
            ((didPerformSomeWork = !0),
            performSyncWorkOnRoot(root$100, workInProgressRootRenderLanes$102));
        }
        root$100 = root$100.next;
      }
...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$103 = !1;
    do {
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$103 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$103 &&
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$111 = enqueueUpdate(provider, fiber, lane);
        null !== root$111 &&
          (scheduleUpdateOnFiber(root$111, provider, lane),
          entangleTransitions(root$111, provider, lane));
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$156 in Component)
      void 0 === newProps[propName$156] &&
        (newProps[propName$156] = Component[propName$156]);
  }
  return newProps;
}
  ...
  if (null !== ref)
    if ("function" === typeof refCleanup)
      ...
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$157);
      }
    ...
    case 5:
      ...
      if (flags & 4 && ((root = finishedWork.stateNode), null != root)) {
        ...
        try {
          ...
          captureCommitPhaseError(finishedWork, finishedWork.return, error$175);
        }
      }
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$187 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$187 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$187
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$187.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$188 = completedWork.child; null !== child$188; )
      (newChildLanes |= child$188.lanes | child$188.childLanes),
        (subtreeFlags |= child$188.subtreeFlags & 31457280),
        (subtreeFlags |= child$188.flags & 31457280),
        (child$188.return = completedWork),
        (child$188 = child$188.sibling);
  else
    for (child$188 = completedWork.child; null !== child$188; )
      (newChildLanes |= child$188.lanes | child$188.childLanes),
        (subtreeFlags |= child$188.subtreeFlags),
        (subtreeFlags |= child$188.flags),
        (child$188.return = completedWork),
        (child$188 = child$188.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$200 = newProps.memoizedState.cachePool.pool);
        cache$200 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      cache$200 = currentResource.rendering;
      if (null === cache$200)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$200 = findFirstSuspended(current);
              if (null !== cache$200) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$200.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$200)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$200.sibling = workInProgress.child),
            (workInProgress.child = cache$200))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$200)
              : (workInProgress.child = cache$200),
            (currentResource.last = cache$200));
      }
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    ...
    try {
      ...
      (ReactDOMSharedInternals.p = previousPriority),
        (ReactSharedInternals.T = prevTransition),
        releaseRootPooledCache(root$221, remainingLanes);
    }
  }
  return !1;
}
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$226 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$227 = styles$226.get(type);
        resource$227 ||
          ...
          styles$226.set(type, resource$227),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$231 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$231)
          return (
            (resource.state.loading |= 4),
            (resource.instance = instance$231),
            markNodeAsHoistable(instance$231),
            instance$231
          );
        ...
        markNodeAsHoistable(instance$231);
        var linkInstance = instance$231;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$231, "link", instance);
        resource.state.loading |= 4;
        insertStylesheet(instance$231, props.precedence, hoistableRoot);
        return (resource.instance = instance$231);
      case "script":
        instance$231 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$231)
          ))
        )
          return (
        ...
        instance = props;
        if ((styleProps = preloadPropsMap.get(instance$231)))
...
var internals$jscomp$inline_2019 = {
  bundleType: devToolsConfig$jscomp$inline_1641.bundleType,
  version: devToolsConfig$jscomp$inline_1641.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1641.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1641.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1641.findFiberByHostInstance ||
  ...
  reconcilerVersion: "19.0.0-beta-5d29478716-20240506"
};
...
exports.version = "19.0.0-beta-5d29478716-20240506";
