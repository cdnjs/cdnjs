...
var g={usingClientEntryPoint:!1,Events:null,Dispatcher:{current:null}},f=g.Dispatcher;a.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=g;a.createPortal=function(){throw Error(e(448));};a.flushSync=function(){throw Error(e(449));};a.preconnect=function(d,c){var b=f.current;b&&b.preconnect(d,c)};a.prefetchDNS=function(d){var c=f.current;c&&c.prefetchDNS(d)};a.preinit=function(d,c){var b=f.current;b&&b.preinit(d,c)};a.preload=function(d,c){var b=f.current;b&&b.preload(d,c)};a.version="18.3.0-next-491aec5d6-20230501"});
})();
