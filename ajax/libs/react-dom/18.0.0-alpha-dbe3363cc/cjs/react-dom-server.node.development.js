...
function createRootFormatContext(namespaceURI) {
  var insertionMode = namespaceURI === 'http://www.w3.org/2000/svg' ? SVG_MODE : namespaceURI === 'http://www.w3.org/1998/Math/MathML' ? MATHML_MODE : HTML_MODE;
...
function createRequest(children, destination, responseState, rootFormatContext) {
  var progressiveChunkSize = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : DEFAULT_PROGRESSIVE_CHUNK_SIZE;
  var onError = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : defaultErrorHandler;
  var onCompleteAll = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : noop$1;
  var onReadyToStream = arguments.length > 7 && arguments[7] !== undefined ? arguments[7] : noop$1;
  var pingedTasks = [];
...
function renderToStringImpl(children, options, generateStaticMarkup) {
  ...
  var request = createRequest(children, destination, createResponseState$1(generateStaticMarkup, options ? options.identifierPrefix : undefined), createRootFormatContext(undefined), Infinity, onError, undefined, onReadyToStream);
...
function renderToNodeStreamImpl(children, options, generateStaticMarkup) {
  ...
  var request = createRequest(children, destination, createResponseState$1(false, options ? options.identifierPrefix : undefined), createRootFormatContext(undefined), Infinity, onError$1, onCompleteAll, undefined);
