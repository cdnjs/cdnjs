...
default:C(a,d,h,l)}null===e&&null!==g&&(e=g);a.push(D);if(null!=n){if(null!=e)throw Error("If you supply `defaultValue` on a <textarea>, do not pass children.");if(oa(n)&&1<n.length)throw Error("<textarea> can only have at most one child.");e=""+n}"string"===typeof e&&"\n"===e[0]&&a.push(Ga);return e;case "input":a.push(F("input"));l=n=h=e=null;for(g in c)if(p.call(c,g)&&(m=c[g],null!=m))switch(g){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");
...
return[!1,rc]},useId:function(){var a=jc.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-K(a)-1)).toString(32)+b;var c=V;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=Q++;a=c.idPrefix+a;0<b&&(a+=":"+b.toString(32));return a},useMutableSource:function(a,b){T();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");
...
"B:",idPrefix:c+"R:",nextSuspenseID:0,sentCompleteSegmentFunction:!1,sentCompleteBoundaryFunction:!1,sentClientRenderFunction:!1};e=b?b.namespaceURI:void 0;e=v("http://www.w3.org/2000/svg"===e?2:"http://www.w3.org/1998/Math/MathML"===e?3:0,null);f=b?b.progressiveChunkSize:void 0;d=b?b.onError:void 0;h=b?b.onCompleteAll:void 0;var l=b?b.onCompleteShell:void 0,m=b?b.onErrorShell:void 0;b=[];c=new Set;g={destination:null,responseState:g,progressiveChunkSize:void 0===f?12800:f,status:0,fatalError:null,
