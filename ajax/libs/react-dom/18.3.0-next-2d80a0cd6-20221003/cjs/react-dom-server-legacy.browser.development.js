...
var ReactVersion = '18.3.0-next-2d80a0cd6-20221003';
        ...
        default:
          {
            ...
            error('ReactDOM.preload() expected a valid "as" type in the options (second) argument but found %s instead.' + ' Please use one of the following valid values instead: %s. The href for the preload call where this' + ' warning originated is "%s".', typeOfAs, '"style" and "font"', href);
          }
      }
    }
  }
...
function preload(href, options) {
  ...
  if (typeof href === 'string' && href && typeof options === 'object' && options !== null) {
    ...
    if (resource) {
      ...
      resource = createPreloadResource(currentResources, href, as, preloadPropsFromPreloadOptions(href, as, options));
    }
      ...
      case 'style':
        {
          ...
          if (resource) {
            ...
            resource = createStyleResource(currentResources, href, precedence, resourceProps);
