...
exports.renderToPipeableStream=function(a,b){var c=Sc(a,b),d=!1;Nc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Oc(c,a);a.on("drain",Qc(a,c));a.on("close",Rc(c));return a},abort:function(){Pc(c)}}};exports.version="18.0.0-rc.1-a59f53a60-20220308";
