...
case Ja:a:{c=b.blockedBoundary;f=b.blockedSegment;e=d.fallback;d=d.children;g=new Set;var h={id:null,rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:g},l=U(a,f.chunks.length,h,f.formatContext);f.children.push(l);var p=U(a,0,null,f.formatContext);p.parentFlushed=!0;b.blockedBoundary=h;b.blockedSegment=p;try{if(Ab(a,b,d),p.status=1,h.completedSegments.push(p),0===h.pendingTasks)break a}catch(n){p.status=4,V(a,n),h.forceClientRender=
...
context:c,parentValue:e,value:d};b.context=d;X(a,b,f);a=E;if(null===a)throw Error(k(403));d=a.parentValue;a.context._currentValue2=d===Qa?a.context._defaultValue:d;a=E=a.parent;b.context=a;return;case Ha:d=d.children;d=d(c._currentValue2);X(a,b,d);return;case Ma:f=c._init;c=f(c._payload);d=yb(c,d);zb(a,b,c,d,void 0);return}throw Error(k(130,null==c?c:typeof c,""));}}
...
function Db(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(k(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=T,b=a.onShellReady,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Cb,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=
...
function Ib(a,b,c,d){if(2===d.status)return!0;var f=d.id;if(-1===f){if(-1===(d.id=c.rootSegmentID))throw Error(k(392));return Gb(a,b,d)}Gb(a,b,d);a=a.responseState;m(b,a.startInlineScript);a.sentCompleteSegmentFunction?m(b,'$RS("'):(a.sentCompleteSegmentFunction=!0,m(b,'function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'));m(b,a.segmentPrefix);f=f.toString(16);
m(b,f);m(b,'","');m(b,a.placeholderPrefix);m(b,f);return m(b,'")\x3c/script>')}
function Fb(a,b){try{var c=a.completedRootSegment;if(null!==c&&0===a.pendingRootTasks){Z(a,b,c);a.completedRootSegment=null;var d=a.responseState.bootstrapChunks;for(c=0;c<d.length-1;c++)m(b,d[c]);c<d.length&&m(b,d[c])}var f=a.clientRenderedBoundaries,e;for(e=0;e<f.length;e++){d=b;var g=a.responseState,h=f[e].id;m(d,g.startInlineScript);g.sentClientRenderFunction?m(d,'$RX("'):(g.sentClientRenderFunction=!0,m(d,'function $RX(a){if(a=document.getElementById(a))a=a.previousSibling,a.data="$!",a._reactRetry&&a._reactRetry()};$RX("'));if(null===
h)throw Error(k(395));m(d,h);if(!m(d,'")\x3c/script>')){a.destination=null;e++;f.splice(0,e);return}}f.splice(0,e);var l=a.completedBoundaries;for(e=0;e<l.length;e++)if(!Hb(a,b,l[e])){a.destination=null;e++;l.splice(0,e);return}l.splice(0,e);var p=a.partialBoundaries;for(e=0;e<p.length;e++){var n=p[e];a:{f=a;g=b;var z=n.completedSegments;for(h=0;h<z.length;h++)if(!Ib(f,g,n,z[h])){h++;z.splice(0,h);var C=!1;break a}z.splice(0,h);C=!0}if(!C){a.destination=null;e++;p.splice(0,e);return}}p.splice(0,e);
var x=a.completedBoundaries;for(e=0;e<x.length;e++)if(!Hb(a,b,x[e])){a.destination=null;e++;x.splice(0,e);return}x.splice(0,e)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.push(null)}}function Jb(a){try{var b=a.abortableTasks;b.forEach(Eb,a);b.clear();null!==a.destination&&Fb(a,a.destination)}catch(c){V(a,c),W(a,c)}}function Kb(){}
function Lb(a,b,c){var d=!1,f=null,e="",g={push:function(a){null!==a&&(e+=a);return!0},destroy:function(a){d=!0;f=a}},h=!1;a=tb(a,Aa(c,b?b.identifierPrefix:void 0),{insertionMode:1,selectedValue:null},Infinity,Kb,void 0,function(){h=!0},void 0,void 0);vb(a);Jb(a);if(1===a.status)a.status=2,g.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=g;try{Fb(a,g)}catch(l){V(a,l),W(a,l)}}if(d)throw f;if(!h)throw Error(k(426));return e}
exports.renderToNodeStream=function(){throw Error(k(207));};exports.renderToStaticMarkup=function(a,b){return Lb(a,b,!0)};exports.renderToStaticNodeStream=function(){throw Error(k(208));};exports.renderToString=function(a,b){return Lb(a,b,!1)};exports.version="18.0.0-rc.1-a59f53a60-20220308";
