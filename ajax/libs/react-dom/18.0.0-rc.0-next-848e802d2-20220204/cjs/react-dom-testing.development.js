...
function queueRecoverableErrors(errors) {
  if (workInProgressRootConcurrentErrors === null) {
    ...
    workInProgressRootConcurrentErrors = workInProgressRootConcurrentErrors.push.apply(null, errors);
  }
}
...
function createContainer(containerInfo, tag, hydrate, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError) {
...
function hydrateRoot(container, initialChildren, options) {
  ...
  hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onRecoverableError);
