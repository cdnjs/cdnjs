...
var ia=null,va=null,wa=null,Na=null,xa=null,Oa=null,oa=null,wc=null,xc=null,bb;for(bb in c)if(D.call(c,bb)){var ba=c[bb];if(null!=ba)switch(bb){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");case "name":ia=ba;break;case "formAction":va=ba;break;case "formEncType":wa=ba;break;case "formMethod":Na=ba;break;case "formTarget":xa=ba;break;case "defaultChecked":xc=ba;break;case "defaultValue":oa=
ba;break;case "checked":wc=ba;break;case "value":Oa=ba;break;default:P(a,bb,ba)}}var Od=Mc(a,d,e,va,wa,Na,xa,ia);null!==wc?tc(a,"checked",wc):null!==xc&&tc(a,"checked",xc);null!==Oa?P(a,"value",Oa):null!==oa&&P(a,"value",oa);a.push(Kc);null!=Od&&Od.forEach(Jc,a);return null;case "button":a.push(U("button"));var cb=null,Pd=null,Qd=null,Rd=null,Sd=null,Td=null,Ud=null,db;for(db in c)if(D.call(c,db)){var ja=c[db];if(null!=ja)switch(db){case "children":cb=ja;break;case "dangerouslySetInnerHTML":Pd=ja;
...
case "dangerouslySetInnerHTML":Xd=pa;break;case "action":ya=pa;break;case "encType":fb=pa;break;case "method":gb=pa;break;case "target":hb=pa;break;default:P(a,ib,pa)}}var yc=null,zc=null;if("function"===typeof ya){var za=Lc(d,ya);null!==za?(ya=za.action||"",fb=za.encType,gb=za.method,hb=za.target,yc=za.data,zc=za.name):(a.push(N,"action",rc,uc,L),hb=gb=fb=ya=null,Nc(d,e))}null!=ya&&P(a,"action",ya);null!=fb&&P(a,"encType",fb);null!=gb&&P(a,"method",gb);null!=hb&&P(a,"target",hb);a.push(R);null!==
zc&&(a.push(vc),O(a,"name",zc),a.push(Kc),null!=yc&&yc.forEach(Jc,a));Oc(a,Xd,eb);if("string"===typeof eb){a.push(E(eb));var Yd=null}else Yd=eb;return Yd;case "menuitem":a.push(U("menuitem"));for(var Hb in c)if(D.call(c,Hb)){var Zd=c[Hb];if(null!=Zd)switch(Hb){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:P(a,Hb,Zd)}}a.push(R);return null;case "title":if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp)var Ac=
Vc(a,c);else l?Ac=null:(Vc(e.hoistableChunks,c),Ac=void 0);return Ac;case "link":var Pf=c.rel,qa=c.href,Ib=c.precedence;if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp||"string"!==typeof Pf||"string"!==typeof qa||""===qa){S(a,c);var jb=null}else if("stylesheet"===c.rel)if("string"!==typeof Ib||null!=c.disabled||c.onLoad||c.onError)jb=S(a,c);else{var Pa=e.styles.get(Ib),Jb=d.styleResources.hasOwnProperty(qa)?d.styleResources[qa]:void 0;if(null!==Jb){d.styleResources[qa]=null;Pa||(Pa={precedence:E(Ib),
...
J[4]||"d"!==J[0]&&"D"!==J[0]||"a"!==J[1]&&"A"!==J[1]||"t"!==J[2]&&"T"!==J[2]||"a"!==J[3]&&"A"!==J[3])){var je="string"===typeof c.sizes?c.sizes:void 0,Sa=J?J+"\n"+(je||""):M,Fc=e.preloads.images,Da=Fc.get(Sa);if(Da){if("high"===c.fetchPriority||10>e.highImagePreloads.size)Fc.delete(Sa),e.highImagePreloads.add(Da)}else if(!d.imageResources.hasOwnProperty(Sa)){d.imageResources[Sa]=F;var Gc=c.crossOrigin;var ke="string"===typeof Gc?"use-credentials"===Gc?Gc:"":void 0;var ea=e.headers,Hc;ea&&0<ea.remainingCapacity&&
("high"===c.fetchPriority||500>ea.highImagePreloads.length)&&(Hc=ed(M,"image",{imageSrcSet:c.srcSet,imageSizes:c.sizes,crossOrigin:ke,integrity:c.integrity,nonce:c.nonce,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.refererPolicy}),2<=(ea.remainingCapacity-=Hc.length))?(e.resets.image[Sa]=F,ea.highImagePreloads&&(ea.highImagePreloads+=", "),ea.highImagePreloads+=Hc):(Da=[],S(Da,{rel:"preload",as:"image",href:J?void 0:M,imageSrcSet:J,imageSizes:je,crossOrigin:ke,integrity:c.integrity,
...
case "head":if(2>g.insertionMode&&null===e.headChunks){e.headChunks=[];var le=Yc(e.headChunks,c,"head")}else le=Yc(a,c,"head");return le;case "html":if(0===g.insertionMode&&null===e.htmlChunks){e.htmlChunks=[bd];var me=Yc(e.htmlChunks,c,"html")}else me=Yc(a,c,"html");return me;default:if(-1!==b.indexOf("-")){a.push(U(b));var Ic=null,ne=null,Ta;for(Ta in c)if(D.call(c,Ta)){var Ea=c[Ta];if(null!=Ea){var Qf=Ta;switch(Ta){case "children":Ic=Ea;break;case "dangerouslySetInnerHTML":ne=Ea;break;case "style":qc(a,
...
function Rf(a,b){var c=b.parent;if(null===c)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===c.depth?Lf(a,c):Rf(a,c);b.context._currentValue=b.value}function Sf(a){var b=Kf;b!==a&&(null===b?Nf(a):null===a?Mf(b):b.depth===a.depth?Lf(b,a):b.depth>a.depth?Of(b,a):Rf(b,a),Kf=a)}
...
function Gg(a,b,c){if(void 0!==a)return"p"+a;a=JSON.stringify([b,null,c]);b=ca.createHash("md5");b.update(a);return"k"+b.digest("hex")}
function Hg(a,b,c){vg();var d=pg++,e=jg;if("function"===typeof a.$$FORM_ACTION){var f=null,g=kg;e=e.formState;var h=a.$$IS_SIGNATURE_EQUAL;if(null!==e&&"function"===typeof h){var l=e[1];h.call(a,e[2],e[3])&&(f=Gg(c,g,d),l===f&&(qg=d,b=e[0]))}var p=a.bind(null,b);a=function(m){p(m)};"function"===typeof p.$$FORM_ACTION&&(a.$$FORM_ACTION=function(m){m=p.$$FORM_ACTION(m);void 0!==c&&(c+="",m.action=c);var v=m.data;v&&(null===f&&(f=Gg(c,g,d)),v.append("$ACTION_KEY",f));return m});return[b,a,!1]}var q=
a.bind(null,b);return[b,function(m){q(m)},!1]}function Ig(a){var b=rg;rg+=1;null===sg&&(sg=[]);return cg(sg,a,b)}function Jg(){throw Error("Cache cannot be refreshed during server rendering.");}function Kg(){}
var Mg={readContext:function(a){return a._currentValue},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return Ig(a);if(a.$$typeof===Fa)return a._currentValue}throw Error("An unsupported type was passed to use(): "+String(a));},useContext:function(a){vg();return a._currentValue},useMemo:Dg,useReducer:Bg,useRef:function(a){hg=vg();W=xg();var b=W.memoizedState;return null===b?(a={current:a},W.memoizedState=a):b},useState:function(a){return Bg(Ag,a)},useInsertionEffect:Kg,
useLayoutEffect:Kg,useCallback:function(a,b){return Dg(function(){return a},b)},useImperativeHandle:Kg,useEffect:Kg,useDebugValue:Kg,useDeferredValue:function(a){vg();return a},useTransition:function(){vg();return[!1,Eg]},useId:function(){var a=ig.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Xf(a)-1)).toString(32)+b;var c=Lg;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=og++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));
return a+":"},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");return c()},useCacheRefresh:function(){return Jg},useHostTransitionStatus:function(){vg();return Cb},useOptimistic:function(a){vg();return[a,Fg]}};Mg.useFormState=Hg;Mg.useActionState=Hg;
...
function hh(a,b,c,d,e,f,g){var h=!1;if(0!==f&&null!==a.formState){var l=b.blockedSegment;if(null!==l){h=!0;l=l.chunks;for(var p=0;p<f;p++)p===g?l.push(Sc):l.push(Tc)}}f=b.keyPath;b.keyPath=c;e?(c=b.treeContext,b.treeContext=Wf(c,1,0),ih(a,b,d,-1),b.treeContext=c):h?ih(a,b,d,-1):Y(a,b,d,-1);b.keyPath=f}function jh(a,b){if(a&&a.defaultProps){b=C({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
...
typeof h.render&&void 0===h.$$typeof?(Uf(h,d,e,f),gh(a,b,c,h,d)):hh(a,b,c,h,l,p,q);b.componentStack=g}else if("string"===typeof d){f=b.componentStack;b.componentStack=ch(b,d);g=b.blockedSegment;if(null===g)g=e.children,h=b.formatContext,l=b.keyPath,b.formatContext=jc(h,d,e),b.keyPath=c,ih(a,b,g,-1),b.formatContext=h,b.keyPath=l;else{l=cd(g.chunks,d,e,a.resumableState,a.renderState,b.hoistableState,b.formatContext,g.lastPushedText,b.isFallback);g.lastPushedText=!1;h=b.formatContext;p=b.keyPath;b.formatContext=
...
f}else{switch(d){case Va:case Ma:case ra:case sa:case ma:d=b.keyPath;b.keyPath=c;Y(a,b,e.children,-1);b.keyPath=d;return;case Ua:"hidden"!==e.mode&&(d=b.keyPath,b.keyPath=c,Y(a,b,e.children,-1),b.keyPath=d);return;case Ia:d=b.componentStack;b.componentStack=ch(b,"SuspenseList");f=b.keyPath;b.keyPath=c;Y(a,b,e.children,-1);b.keyPath=f;b.componentStack=d;return;case La:throw Error("ReactDOMServer does not yet support scope components.");case Ha:a:if(null!==b.replay){d=b.keyPath;b.keyPath=c;c=e.children;
...
d._currentValue=e;l=Kf;Kf=e={parent:l,depth:null===l?0:l.depth+1,context:d,parentValue:h,value:e};b.context=e;b.keyPath=c;Y(a,b,g,-1);a=Kf;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");a.context._currentValue=a.parentValue;a=Kf=a.parent;b.context=a;b.keyPath=f;return;case Fa:e=e.children;e=e(d._currentValue);d=b.keyPath;b.keyPath=c;Y(a,b,e,-1);b.keyPath=d;return;case ua:case Ka:f=b.componentStack;b.componentStack=ch(b,"Lazy");g=d._init;d=g(d._payload);
...
l+">. The tree doesn't match so React will fallback to client rendering.");var v=m[2];l=m[3];p=b.node;b.replay={nodes:v,slots:l,pendingTasks:1};try{kh(a,b,f,e,g,h);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(A){if("object"===typeof A&&null!==A&&(A===ag||"function"===typeof A.then))throw b.node===p&&(b.replay=q),A;
b.replay.pendingTasks--;g=dh(a,b.componentStack);f=a;a=b.blockedBoundary;e=A;g=X(f,e,g);oh(f,a,v,l,e,g)}b.replay=q}else{if(e!==Ha)throw Error("Expected the resume to render <Suspense> in this slot but instead it rendered <"+(Hf(e)||"Unknown")+">. The tree doesn't match so React will fallback to client rendering.");b:{q=void 0;e=m[5];h=m[2];l=m[3];p=null===m[4]?[]:m[4][2];m=null===m[4]?null:m[4][3];var r=b.componentStack,x=b.componentStack=ch(b,"Suspense"),w=b.keyPath,t=b.replay,T=b.blockedBoundary,
...
null!==m&&(m===ag||"function"===typeof m.then))throw m;b.replay.pendingTasks--;c=dh(a,b.componentStack);var p=b.blockedBoundary,q=m;c=X(a,q,c);oh(a,p,d,l,q,c)}b.replay=f;g.splice(h,1);break}}b.keyPath=e;return}f=b.treeContext;g=c.length;if(null!==b.replay&&(h=b.replay.slots,null!==h&&"object"===typeof h)){for(d=0;d<g;d++)l=c[d],b.treeContext=Wf(f,g,d),p=h[d],"number"===typeof p?(nh(a,b,p,l,d),delete h[d]):ih(a,b,l,d);b.treeContext=f;b.keyPath=e;return}for(h=0;h<g;h++)d=c[h],b.treeContext=Wf(f,g,h),
...
e)}}};exports.version="18.3.0-canary-e373190fa-20240325";
