...
Lb=Symbol.for("react.suspense_list"),Mb=Symbol.for("react.memo"),Nb=Symbol.for("react.lazy"),Ob=Symbol.for("react.scope"),Pb=Symbol.for("react.debug_trace_mode"),Qb=Symbol.for("react.legacy_hidden"),Rb=Symbol.for("react.cache"),Sb=Symbol.for("react.tracing_marker"),Tb=Symbol.iterator;
function Ub(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;switch(a){case Eb:return"Fragment";case Db:return"Portal";case Gb:return"Profiler";case Fb:return"StrictMode";case Kb:return"Suspense";case Lb:return"SuspenseList";case Rb:return"Cache";case Sb:return"TracingMarker"}if("object"===typeof a)switch(a.$$typeof){case Ib:return(a.displayName||"Context")+".Consumer";case Hb:return(a._context.displayName||"Context")+".Provider";
case Jb:var b=a.render;a=a.displayName;a||(a=b.displayName||b.name||"",a=""!==a?"ForwardRef("+a+")":"ForwardRef");return a;case Mb:return b=a.displayName||null,null!==b?b:Ub(a.type)||"Memo";case Nb:b=a._payload;a=a._init;try{return Ub(a(b))}catch(c){}}return null}var Vb={};function Wb(a,b){a=a.contextTypes;if(!a)return Vb;var c={},d;for(d in a)c[d]=b[d];return c}var H=null;
function I(a,b){if(a!==b){a.context._currentValue=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Error("The stacks must reach the root at the same time. This is a bug in React.");}else{if(null===c)throw Error("The stacks must reach the root at the same time. This is a bug in React.");I(a,c)}b.context._currentValue=b.value}}function Xb(a){a.context._currentValue=a.parentValue;a=a.parent;null!==a&&Xb(a)}
function Yb(a){var b=a.parent;null!==b&&Yb(b);a.context._currentValue=a.value}function Zb(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?I(a,b):Zb(a,b)}
function $b(a,b){var c=b.parent;if(null===c)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===c.depth?I(a,c):$b(a,c);b.context._currentValue=b.value}function J(a){var b=H;b!==a&&(null===b?Yb(a):null===a?Xb(b):b.depth===a.depth?I(b,a):b.depth>a.depth?Zb(b,a):$b(b,a),H=a)}
...
var cc={id:1,overflow:""};function dc(a,b,c){var d=a.id;a=a.overflow;var f=32-K(d)-1;d&=~(1<<f);c+=1;var e=32-K(b)+f;if(30<e){var g=f-f%5;e=(d&(1<<g)-1).toString(32);d>>=g;f-=g;return{id:1<<32-K(b)+f|c<<f|d,overflow:e+a}}return{id:1<<e|c<<f|d,overflow:a}}var K=Math.clz32?Math.clz32:ec,fc=Math.log,gc=Math.LN2;function ec(a){a>>>=0;return 0===a?32:31-(fc(a)/gc|0)|0}function hc(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}
var ic="function"===typeof Object.is?Object.is:hc,L=null,jc=null,M=null,N=null,O=!1,P=!1,Q=0,R=null,S=0;
...
function kc(){if(0<S)throw Error("Rendered more hooks than during the previous render");return{memoizedState:null,queue:null,next:null}}function lc(){null===N?null===M?(O=!1,M=N=kc()):(O=!0,N=M):null===N.next?(O=!1,N=N.next=kc()):(O=!0,N=N.next);return N}function mc(){jc=L=null;P=!1;M=null;S=0;N=R=null}function nc(a,b){return"function"===typeof b?b(a):b}
function oc(a,b,c){L=T();N=lc();if(O){var d=N.queue;b=d.dispatch;if(null!==R&&(c=R.get(d),void 0!==c)){R.delete(d);d=N.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);N.memoizedState=d;return[d,b]}return[N.memoizedState,b]}a=a===nc?"function"===typeof b?b():b:void 0!==c?c(b):b;N.memoizedState=a;a=N.queue={last:null,dispatch:null};a=a.dispatch=pc.bind(null,L,a);return[N.memoizedState,a]}
function qc(a,b){L=T();N=lc();b=void 0===b?null:b;if(null!==N){var c=N.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var f=0;f<d.length&&f<b.length;f++)if(!ic(b[f],d[f])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();N.memoizedState=[a,b];return a}
function pc(a,b,c){if(25<=S)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===L)if(P=!0,a={action:c,next:null},null===R&&(R=new Map),c=R.get(b),void 0===c)R.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function rc(){throw Error("startTransition cannot be called during server rendering.");}function U(){}
var sc={readContext:function(a){return a._currentValue},useContext:function(a){T();return a._currentValue},useMemo:qc,useReducer:oc,useRef:function(a){L=T();N=lc();var b=N.memoizedState;return null===b?(a={current:a},N.memoizedState=a):b},useState:function(a){return oc(nc,a)},useInsertionEffect:U,useLayoutEffect:function(){},useCallback:function(a,b){return qc(function(){return a},b)},useImperativeHandle:U,useEffect:U,useDebugValue:U,useDeferredValue:function(a){T();return a},useTransition:function(){T();
return[!1,rc]},useId:function(){var a=jc.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-K(a)-1)).toString(32)+b;var c=V;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=Q++;a=":"+c.idPrefix+"R"+a+":";0<b&&(a+=b.toString(32)+":");return a},useMutableSource:function(a,b){T();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");
return c()}},V=null,tc=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function uc(a){console.error(a)}function W(){}function vc(a,b){var c=a.pingedTasks;c.push(b);1===c.length&&setImmediate(function(){return wc(a)})}function xc(a,b,c,d,f,e,g,h){a.allPendingTasks++;null===c?a.pendingRootTasks++:c.pendingTasks++;var l={node:b,ping:function(){return vc(a,l)},blockedBoundary:c,blockedSegment:d,abortSet:f,legacyContext:e,context:g,treeContext:h};f.add(l);return l}
function X(a,b,c,d){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c}}function Y(a,b){a=a.onError;a(b)}function yc(a,b){var c=a.onErrorShell;c(b);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}function zc(a,b,c,d,f){L={};jc=b;Q=0;for(a=c(d,f);P;)P=!1,Q=0,S+=1,N=null,a=c(d,f);mc();return a}
function Ac(a,b,c,d){var f=c.render(),e=d.childContextTypes;if(null!==e&&void 0!==e){var g=b.legacyContext;if("function"!==typeof c.getChildContext)d=g;else{c=c.getChildContext();for(var h in c)if(!(h in e))throw Error((Ub(d)||"Unknown")+'.getChildContext(): key "'+h+'" is not defined in childContextTypes.');d=G({},g,c)}b.legacyContext=d;Z(a,b,f);b.legacyContext=g}else Z(a,b,f)}
function Bc(a,b){if(a&&a.defaultProps){b=G({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function Cc(a,b,c,d,f){if("function"===typeof c)if(c.prototype&&c.prototype.isReactComponent){f=Wb(c,b.legacyContext);var e=c.contextType;e=new c(d,"object"===typeof e&&null!==e?e._currentValue:f);bc(e,c,d,f);Ac(a,b,e,c)}else{e=Wb(c,b.legacyContext);f=zc(a,b,c,d,e);var g=0!==Q;if("object"===typeof f&&null!==f&&"function"===typeof f.render&&void 0===f.$$typeof)bc(f,c,d,e),Ac(a,b,f,c);else if(g){d=b.treeContext;b.treeContext=dc(d,1,0);try{Z(a,b,f)}finally{b.treeContext=d}}else Z(a,b,f)}else if("string"===
...
function Ec(a,b,c){for(var d=c.length,f=0;f<d;f++){var e=b.treeContext;b.treeContext=dc(e,d,f);try{Dc(a,b,c[f])}finally{b.treeContext=e}}}
function Dc(a,b,c){var d=b.blockedSegment.formatContext,f=b.legacyContext,e=b.context;try{return Z(a,b,c)}catch(l){if(mc(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var g=b.blockedSegment,h=X(a,g.chunks.length,null,g.formatContext);g.children.push(h);a=xc(a,b.node,b.blockedBoundary,h,b.abortSet,b.legacyContext,b.context,b.treeContext).ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=f;b.context=e;J(e)}else throw b.blockedSegment.formatContext=d,b.legacyContext=
...
function Gc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onErrorShell=W,b=a.onCompleteShell,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Fc,a),b.fallbackAbortableTasks.clear();
...
function wc(a){if(2!==a.status){var b=H,c=tc.current;tc.current=sc;var d=V;V=a.responseState;try{var f=a.pingedTasks,e;for(e=0;e<f.length;e++){var g=f[e];var h=a,l=g.blockedSegment;if(0===l.status){J(g.context);try{Z(h,g,g.node),g.abortSet.delete(g),l.status=1,Gc(h,g.blockedBoundary,l)}catch(w){if(mc(),"object"===typeof w&&null!==w&&"function"===typeof w.then){var m=g.ping;w.then(m,m)}else{g.abortSet.delete(g);l.status=4;var n=g.blockedBoundary,y=w;Y(h,y);null===n?yc(h,y):(n.pendingTasks--,n.forceClientRender||
(n.forceClientRender=!0,n.parentFlushed&&h.clientRenderedBoundaries.push(n)));h.allPendingTasks--;if(0===h.allPendingTasks){var B=h.onCompleteAll;B()}}}finally{}}}f.splice(0,e);null!==a.destination&&Ic(a,a.destination)}catch(w){Y(a,w),yc(a,w)}finally{V=d,tc.current=c,c===sc&&J(b)}}}
...
for(e=0;e<w.length;e++)if(!Mc(a,b,w[e])){a.destination=null;e++;w.splice(0,e);return}w.splice(0,e)}finally{ca(b),"function"===typeof b.flush&&b.flush(),0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.end()}}function Oc(a){setImmediate(function(){return wc(a)})}
function Pc(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{Ic(a,b)}catch(c){Y(a,c),yc(a,c)}}}function Qc(a,b){return function(){return Pc(b,a)}}
...
"B:",idPrefix:c,nextSuspenseID:0,sentCompleteSegmentFunction:!1,sentCompleteBoundaryFunction:!1,sentClientRenderFunction:!1};e=b?b.namespaceURI:void 0;e=v("http://www.w3.org/2000/svg"===e?2:"http://www.w3.org/1998/Math/MathML"===e?3:0,null);f=b?b.progressiveChunkSize:void 0;d=b?b.onError:void 0;h=b?b.onCompleteAll:void 0;var l=b?b.onCompleteShell:void 0,m=b?b.onErrorShell:void 0;b=[];c=new Set;g={destination:null,responseState:g,progressiveChunkSize:void 0===f?12800:f,status:0,fatalError:null,nextSegmentId:0,
allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:c,pingedTasks:b,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===d?uc:d,onCompleteAll:void 0===h?W:h,onCompleteShell:void 0===l?W:l,onErrorShell:void 0===m?W:m};e=X(g,0,null,e);e.parentFlushed=!0;a=xc(g,a,null,e,c,Vb,null,cc);b.push(a);return g}
exports.renderToPipeableStream=function(a,b){var c=Rc(a,b),d=!1;Oc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Pc(c,a);a.on("drain",Qc(a,c));return a},abort:function(){try{var a=c.abortableTasks;a.forEach(Hc,c);a.clear();null!==c.destination&&Ic(c,c.destination)}catch(e){Y(c,e),yc(c,e)}}}};exports.version="18.0.0-rc.1-629036a9c-20220224";
