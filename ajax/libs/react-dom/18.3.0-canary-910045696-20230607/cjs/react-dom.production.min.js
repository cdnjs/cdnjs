...
function Bn(a,b){var c=document;if("string"===typeof a&&a&&"object"===typeof b&&null!==b&&c){var d=b.as,e=jc(a),f=e='link[rel="preload"][as="'+d+'"][href="'+e+'"]';switch(d){case "style":f=Fn(a);break;case "script":f=Gn(a)}xn.has(f)||(a={href:a,rel:"preload",as:d,crossOrigin:"font"===d?"":b.crossOrigin,integrity:b.integrity,type:b.type,fetchPriority:b.fetchPriority},xn.set(f,a),null!==c.querySelector(e)||"style"===d&&c.querySelector(Hn(f))||"script"===d&&c.querySelector("script[async]"+f)||(d=c.createElement("link"),
ai(d,"link",a),Jb(d),c.head.appendChild(d)))}}
...
function Zn(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var l=Fk(g);h.call(l)}}Ek(b,g,a,e)}else g=Yn(c,b,a,e,d);return Fk(g)}var $n=da.Dispatcher;da.Events=[Fb,Gb,Hb,Fc,Gc,Zj];var ao={findFiberByHostInstance:Db,bundleType:0,version:"18.3.0-canary-910045696-20230607",rendererPackageName:"react-dom"};
