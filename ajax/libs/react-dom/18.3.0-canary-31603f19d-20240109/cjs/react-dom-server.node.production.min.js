...
sf=Symbol.for("react.offscreen"),tf=Symbol.for("react.legacy_hidden"),uf=Symbol.for("react.cache"),vf=Symbol.for("react.default_value"),wf=Symbol.iterator;
...
function Ug(a,b){if(b&&null!==a.trackedPostpones){try{a="";do{switch(b.tag){case 0:a+=Bf(b.type,null,null);break;case 1:a+=Df(b.type,!1);break;case 2:a+=Df(b.type,!0)}b=b.parent}while(b);var c=a}catch(d){c="\nError generating stack: "+d.message+"\n"+d.stack}c={componentStack:c}}else c={};return c}function Y(a,b,c){a=a.onError(b,c);if(null==a||"string"===typeof a)return a}
function Vg(a,b){var c=a.onShellError;c(b);c=a.onFatalError;c(b);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}
...
m.resources;b.keyPath=c;try{if(Yg(a,b,A,-1),F.lastPushedText&&F.textEmbedded&&F.chunks.push(Nb),F.status=1,ah(m,F),0===m.pendingTasks&&0===m.status){m.status=1;b.componentStack=p;break a}}catch(u){F.status=4,m.status=4,h=Ug(a,b.componentStack),l=Y(a,u,h),m.errorDigest=l,bh(a,m)}finally{a.renderState.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=t,b.keyPath=r,b.componentStack=p}h=[c[0],"Suspense Fallback",c[2]];l=a.trackedPostpones;null!==l&&(p=[h[1],h[2],[],null],l.workingMap.set(h,
...
function ch(a,b,c,d,e){var f=b.replay,g=b.blockedBoundary,h=Sg(a,0,null,b.formatContext,!1,!1);h.id=c;h.parentFlushed=!0;try{b.replay=null,b.blockedSegment=h,Yg(a,b,d,e),h.status=1,null===g?a.completedRootSegment=h:(ah(g,h),g.parentFlushed&&a.partialBoundaries.push(g))}finally{b.replay=f,b.blockedSegment=null}}
function Z(a,b,c,d,e){if(null!==b.replay&&"number"===typeof b.replay.slots)ch(a,b,b.replay.slots,d,e);else{b.node=d;b.childIndex=e;if("object"===typeof d&&null!==d){switch(d.$$typeof){case cf:var f=d.type,g=d.key,h=d.props,l=d.ref,m=zf(f),q=null==g?-1===e?0:e:g;g=[b.keyPath,m,q];if(null!==b.replay)a:{var p=b.replay;e=p.nodes;for(d=0;d<e.length;d++){var r=e[d];if(q===r[1]){if(4===r.length){if(null!==m&&m!==r[0])throw Error("Expected the resume to render <"+r[0]+"> in this slot but instead it rendered <"+
...
G;b.replay.pendingTasks--;h=Ug(a,b.componentStack);g=a;a=b.blockedBoundary;c=G;h=Y(g,c,h);dh(g,a,t,m,c,h)}b.replay=p}else{if(f!==mf)throw Error("Expected the resume to render <Suspense> in this slot but instead it rendered <"+(zf(f)||"Unknown")+">. The tree doesn't match so React will fallback to client rendering.");b:{p=void 0;c=r[5];f=r[2];l=r[3];m=null===r[4]?[]:r[4][2];r=null===r[4]?null:r[4][3];q=b.componentStack;var A=b.componentStack=Tg(b,"Suspense"),F=b.keyPath,u=b.replay,x=b.blockedBoundary,
...
break b}}catch(G){w.status=4,t=Ug(a,b.componentStack),p=Y(a,G,t),w.errorDigest=p,b.replay.pendingTasks--,a.clientRenderedBoundaries.push(w)}finally{a.renderState.boundaryResources=x?x.resources:null,b.blockedBoundary=x,b.replay=u,b.keyPath=F,b.componentStack=q}b=Rg(a,null,{nodes:m,slots:r,pendingTasks:0},h,-1,x,U,[g[0],"Suspense Fallback",g[2]],b.formatContext,b.legacyContext,b.context,b.treeContext,A);a.pingedTasks.push(b)}}e.splice(d,1);break a}}}else $g(a,b,g,c,f,h,l);return;case df:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");
case pf:h=b.componentStack;b.componentStack=Tg(b,"Lazy");g=d._init;d=g(d._payload);b.componentStack=h;Z(a,b,null,d,e);return}if(Ta(d)){eh(a,b,d,e);return}null===d||"object"!==typeof d?h=null:(h=wf&&d[wf]||d["@@iterator"],h="function"===typeof h?h:null);if(h&&(h=h.call(d))){d=h.next();if(!d.done){g=[];do g.push(d.value),d=h.next();while(!d.done);eh(a,b,g,e)}return}if("function"===typeof d.then)return Z(a,b,null,Cg(d),e);if(d.$$typeof===jf||d.$$typeof===kf)return Z(a,b,null,d._currentValue,e);e=Object.prototype.toString.call(d);
...
function eh(a,b,c,d){var e=b.keyPath;if(-1!==d&&(b.keyPath=[b.keyPath,"Fragment",d],null!==b.replay)){for(var f=b.replay,g=f.nodes,h=0;h<g.length;h++){var l=g[h];if(l[1]===d){d=l[2];l=l[3];b.replay={nodes:d,slots:l,pendingTasks:1};try{eh(a,b,c,-1);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(p){if("object"===typeof p&&
null!==p&&(p===Vf||"function"===typeof p.then))throw p;b.replay.pendingTasks--;c=Ug(a,b.componentStack);var m=b.blockedBoundary,q=p;c=Y(a,q,c);dh(a,m,d,l,q,c)}b.replay=f;g.splice(h,1);break}}b.keyPath=e;return}f=b.treeContext;g=c.length;if(null!==b.replay&&(h=b.replay.slots,null!==h&&"object"===typeof h)){for(d=0;d<g;d++)l=c[d],b.treeContext=Qf(f,g,d),m=h[d],"number"===typeof m?(ch(a,b,m,l,d),delete h[d]):Yg(a,b,l,d);b.treeContext=f;b.keyPath=e;return}for(h=0;h<g;h++)d=c[h],b.treeContext=Qf(f,g,h),
Yg(a,b,d,h);b.treeContext=f;b.keyPath=e}function bh(a,b){a=a.trackedPostpones;null!==a&&(b=b.trackedContentKeyPath,null!==b&&(b=a.workingMap.get(b),void 0!==b&&(b.length=4,b[2]=[],b[3]=null)))}
...
l.replay.pendingTasks--;l.abortSet.delete(l);gh(r,l.blockedBoundary,null)}catch(M){tg();var A=M===Vf?Zf():M;if("object"===typeof A&&null!==A&&"function"===typeof A.then){var F=l.ping;A.then(F,F);l.thenableState=ug()}else{l.replay.pendingTasks--;l.abortSet.delete(l);var u=Ug(r,l.componentStack);m=void 0;var x=r,da=l.blockedBoundary,U=A,w=l.replay.nodes,G=l.replay.slots;m=Y(x,U,u);dh(x,da,w,G,U,m);r.pendingRootTasks--;0===r.pendingRootTasks&&ih(r);r.allPendingTasks--;0===r.allPendingTasks&&jh(r)}}finally{r.renderState.boundaryResources=
null}}}else if(r=void 0,x=p,0===x.status){Mf(l.context);var H=x.children.length,ea=x.chunks.length;try{var na=l.thenableState;l.thenableState=null;Z(m,l,na,l.node,l.childIndex);x.lastPushedText&&x.textEmbedded&&x.chunks.push(Nb);l.abortSet.delete(l);x.status=1;gh(m,l.blockedBoundary,x)}catch(M){tg();x.children.length=H;x.chunks.length=ea;var V=M===Vf?Zf():M;if("object"===typeof V&&null!==V&&"function"===typeof V.then){var fa=l.ping;V.then(fa,fa);l.thenableState=ug()}else{var ha=Ug(m,l.componentStack);
l.abortSet.delete(l);x.status=4;var J=l.blockedBoundary;r=Y(m,V,ha);null===J?Vg(m,V):(J.pendingTasks--,4!==J.status&&(J.status=4,J.errorDigest=r,bh(m,J),J.parentFlushed&&m.clientRenderedBoundaries.push(J)));m.allPendingTasks--;0===m.allPendingTasks&&jh(m)}}finally{m.renderState.boundaryResources=null}}}g.splice(0,h);null!==a.destination&&lh(a,a.destination)}catch(M){Y(a,M,{}),Vg(a,M)}finally{Fg=f,Ig.current=c,Jg.current=d,c===Gg&&Mf(b),Mg=e}}}
function mh(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:c.id=a.nextSegmentId++;case 5:var d=c.id;c.lastPushedText=!1;c.textEmbedded=!1;a=a.renderState;v(b,Gc);v(b,a.placeholderPrefix);a=d.toString(16);v(b,a);return y(b,Hc);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)v(b,d[f]);e=nh(a,b,e)}for(;f<d.length-1;f++)v(b,d[f]);f<d.length&&(e=y(b,d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function nh(a,b,c){var d=c.boundary;if(null===d)return mh(a,b,c);d.parentFlushed=!0;if(4===d.status)d=d.errorDigest,y(b,Lc),v(b,Nc),d&&(v(b,Pc),v(b,D(d)),v(b,Oc)),y(b,Qc),mh(a,b,c);else if(1!==d.status)0===d.status&&(d.rootSegmentID=a.nextSegmentId++),0<d.completedSegments.length&&a.partialBoundaries.push(d),Rc(b,a.renderState,d.rootSegmentID),mh(a,b,c);else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Rc(b,a.renderState,d.rootSegmentID),mh(a,b,
c);else{c=d.resources;var e=a.renderState.boundaryResources;e&&(c.styles.forEach($e,e),c.stylesheets.forEach(af,e));y(b,Ic);d=d.completedSegments;if(1!==d.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");nh(a,b,d[0])}return y(b,Mc)}function oh(a,b,c){md(b,a.renderState,c.parentFormatContext,c.id);nh(a,b,c);return nd(b,c.parentFormatContext)}
...
b);e.scripts.clear();e.bulkPreloads.forEach(Ee,b);e.bulkPreloads.clear();var A=e.preloadChunks;for(f=0;f<A.length;f++)v(b,A[f]);A.length=0;var F=e.hoistableChunks;for(f=0;f<F.length;f++)v(b,F[f]);F.length=0;m&&null===q&&v(b,mc("head"));nh(a,b,d);a.completedRootSegment=null;Fc(b,a.renderState)}else return;var u=a.renderState;d=0;u.preconnects.forEach(Ee,b);u.preconnects.clear();var x=u.preconnectChunks;for(d=0;d<x.length;d++)v(b,x[d]);x.length=0;u.fontPreloads.forEach(Ee,b);u.fontPreloads.clear();
...
e)}}};exports.version="18.3.0-canary-31603f19d-20240109";
