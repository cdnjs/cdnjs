...
function X(a,b,c,d){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c}}function Y(a,b){a=a.onError;a(b)}function yc(a,b){var c=a.onShellError;c(b);c=a.onFatalError;c(b);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}function zc(a,b,c,d,f){L={};jc=b;Q=0;for(a=c(d,f);P;)P=!1,Q=0,S+=1,N=null,a=c(d,f);mc();return a}
...
function Gc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=W,b=a.onShellReady,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Fc,a),b.fallbackAbortableTasks.clear();
else if(c.parentFlushed&&1===c.status){var d=b.completedSegments;d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onAllReady,a())}
...
(n.forceClientRender=!0,n.parentFlushed&&h.clientRenderedBoundaries.push(n)));h.allPendingTasks--;if(0===h.allPendingTasks){var B=h.onAllReady;B()}}}finally{}}}f.splice(0,e);null!==a.destination&&Ic(a,a.destination)}catch(w){Y(a,w),yc(a,w)}finally{V=d,tc.current=c,c===sc&&J(b)}}}
...
allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:c,pingedTasks:b,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===d?uc:d,onAllReady:void 0===h?W:h,onShellReady:void 0===l?W:l,onShellError:void 0===m?W:m,onFatalError:W};e=X(g,0,null,e);e.parentFlushed=!0;a=xc(g,a,null,e,c,Vb,null,cc);b.push(a);return g}
exports.renderToPipeableStream=function(a,b){var c=Tc(a,b),d=!1;Oc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Pc(c,a);a.on("drain",Rc(a,c));a.on("close",Sc(c));return a},abort:function(){Qc(c)}}};exports.version="18.0.0-rc.1-14c2be8da-20220304";
