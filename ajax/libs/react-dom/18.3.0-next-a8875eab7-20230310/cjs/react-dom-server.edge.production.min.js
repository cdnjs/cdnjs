...
a=null}return a;case "style":q=c.precedence;p=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof q||"string"!==typeof p||""===p){a.push(P("style"));d=g=null;for(r in c)if(y.call(c,r)&&(k=c[r],null!=k))switch(r){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,r,k)}a.push(M);c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(v(D(""+c)));N(a,d,g);a.push(Q,v("style"),R);
...
function ve(a,b){var c=a.pingedTasks;c.push(b);1===c.length&&setTimeout(function(){return we(a)},0)}function ue(a,b,c,d,e,f,g,m,k){a.allPendingTasks++;null===d?a.pendingRootTasks++:d.pendingTasks++;var p={node:c,ping:function(){return ve(a,p)},blockedBoundary:d,blockedSegment:e,abortSet:f,legacyContext:g,context:m,treeContext:k,thenableState:b};f.add(p);return p}
...
function ye(a,b){var c=a.onShellError;c(b);c=a.onFatalError;c(b);null!==a.destination?(a.status=2,ea(a.destination,b)):(a.status=1,a.fatalError=b)}
...
parentFlushed:!1,pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:g,errorDigest:null,resources:new Set},k=te(a,c.chunks.length,m,c.formatContext,!1,!1);c.children.push(k);c.lastPushedText=!1;var p=te(a,0,null,c.formatContext,!1,!1);p.parentFlushed=!0;b.blockedBoundary=m;b.blockedSegment=p;a.resources.boundaryResources=m.resources;try{if(Ce(a,b,e),p.lastPushedText&&p.textEmbedded&&p.chunks.push(G),p.status=1,De(m,p),0===m.pendingTasks)break a}catch(r){p.status=
4,m.forceClientRender=!0,m.errorDigest=xe(a,r)}finally{a.resources.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=c}b=ue(a,null,f,d,k,g,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof d&&null!==d)switch(d.$$typeof){case hd:d=d.render;V={};Sd=b;Xd=Wd=0;X=c;c=d(e,f);e=be(d,e,c,f);if(0!==Wd){d=b.treeContext;b.treeContext=Gd(d,1,0);try{Z(a,b,null,e)}finally{b.treeContext=d}}else Z(a,b,null,e);return;case kd:d=d.type;e=Ae(d,e);Be(a,
...
""+d,a.responseState,c.lastPushedText))}function Ee(a,b,c){for(var d=c.length,e=0;e<d;e++){var f=b.treeContext;b.treeContext=Gd(f,d,e);try{Ce(a,b,c[e])}finally{b.treeContext=f}}}
...
function Ge(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=re,b=a.onShellReady,b())}else b.pendingTasks--,b.forceClientRender||(0===b.pendingTasks?(c.parentFlushed&&1===c.status&&De(b,c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Fe,a),b.fallbackAbortableTasks.clear()):c.parentFlushed&&
...
function we(a){if(2!==a.status){var b=U,c=oe.current;oe.current=me;var d=pe.current;pe.current=ne;var e=a.resources;Ba.push(E);E=e;e=va.current;va.current=Aa;var f=le;le=a.responseState;try{var g=a.pingedTasks,m;for(m=0;m<g.length;m++){var k=g[m];var p=a,r=k.blockedBoundary;p.resources.boundaryResources=r?r.resources:null;var q=k.blockedSegment;if(0===q.status){Cd(k.context);try{var u=k.thenableState;k.thenableState=null;Z(p,k,u,k.node);q.lastPushedText&&q.textEmbedded&&q.chunks.push(G);k.abortSet.delete(k);
q.status=1;Ge(p,k.blockedBoundary,q)}catch(oa){ce();var C=oa===Ld?Pd():oa;if("object"===typeof C&&null!==C&&"function"===typeof C.then){var J=k.ping;C.then(J,J);k.thenableState=de()}else{k.abortSet.delete(k);q.status=4;var z=p,K=k.blockedBoundary,pa=C,ia=xe(z,pa);null===K?ye(z,pa):(K.pendingTasks--,K.forceClientRender||(K.forceClientRender=!0,K.errorDigest=ia,K.parentFlushed&&z.clientRenderedBoundaries.push(K)));z.allPendingTasks--;if(0===z.allPendingTasks){var Pe=z.onAllReady;Pe()}}}finally{p.resources.boundaryResources=
null}}}g.splice(0,m);null!==a.destination&&Ie(a,a.destination)}catch(oa){xe(a,oa),ye(a,oa)}finally{le=f,oe.current=c,pe.current=d,E=Ba.pop(),va.current=e,c===me&&Cd(b)}}}
function Je(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;n(b,jb);n(b,a.placeholderPrefix);a=v(d.toString(16));n(b,a);return t(b,kb);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)n(b,d[f]);e=Ke(a,b,e)}for(;f<d.length-1;f++)n(b,d[f]);f<d.length&&(e=t(b,d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function Ke(a,b,c){var d=c.boundary;if(null===d)return Je(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,t(b,ob),n(b,qb),d&&(n(b,sb),n(b,v(D(d))),n(b,rb)),t(b,tb),Je(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=w(e.boundaryPrefix+f.toString(16));d=d.id=e;ub(b,a.responseState,d);Je(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),
ub(b,a.responseState,d.id),Je(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(Zc,c);t(b,lb);c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");Ke(a,b,c[0])}return t(b,pb)}function Le(a,b,c){Qb(b,a.responseState,c.formatContext,c.id);Ke(a,b,c);return Rb(b,c.formatContext)}
...
function Ne(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return Le(a,b,d)}Le(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(n(b,a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,n(b,Sb)):n(b,Tb)):n(b,Wb);n(b,a.segmentPrefix);e=v(e.toString(16));n(b,e);c?n(b,Ub):n(b,Xb);n(b,a.placeholderPrefix);n(b,e);b=c?t(b,Vb):t(b,Ca);return b}
function Ie(a,b){h=new Uint8Array(512);l=0;try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){Qc(b,a.resources,a.responseState,0===a.allPendingTasks);Ke(a,b,d);a.completedRootSegment=null;var e=a.responseState.bootstrapChunks;for(d=0;d<e.length-1;d++)n(b,e[d]);d<e.length&&t(b,e[d])}else return;else Sc(b,a.resources,a.responseState);var f=a.clientRenderedBoundaries;for(c=0;c<f.length;c++){var g=f[c];e=b;var m=a.responseState,k=g.id,p=g.errorDigest,r=g.errorMessage,q=g.errorComponentStack,
...
var C=a.completedBoundaries;for(c=0;c<C.length;c++)if(!Me(a,b,C[c])){a.destination=null;c++;C.splice(0,c);return}C.splice(0,c);ca(b);h=new Uint8Array(512);l=0;var J=a.partialBoundaries;for(c=0;c<J.length;c++){var z=J[c];a:{f=a;g=b;f.resources.boundaryResources=z.resources;var K=z.completedSegments;for(m=0;m<K.length;m++)if(!Ne(f,g,z,K[m])){m++;K.splice(0,m);var pa=!1;break a}K.splice(0,m);pa=Fc(g,z.resources,f.responseState)}if(!pa){a.destination=null;c++;J.splice(0,c);return}}J.splice(0,c);var ia=
a.completedBoundaries;for(c=0;c<ia.length;c++)if(!Me(a,b,ia[c])){a.destination=null;c++;ia.splice(0,c);return}ia.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length?(a=a.responseState,a.hasBody&&(n(b,Q),n(b,v("body")),n(b,R)),a.htmlChunks&&(n(b,Q),n(b,v("html")),n(b,R)),ca(b),b.close()):ca(b)}}function Oe(a){setTimeout(function(){return we(a)},0)}
function Qe(a,b){try{var c=a.abortableTasks;if(0<c.size){var d=void 0===b?Error("The render was aborted by the server without a reason."):b;c.forEach(function(e){return He(e,a,d)});c.clear()}null!==a.destination&&Ie(a,a.destination)}catch(e){xe(a,e),ye(a,e)}}
...
else if(2!==m.status&&null===m.destination){m.destination=q;try{Ie(m,q)}catch(u){xe(m,u),ye(m,u)}}},cancel:function(){Qe(m)}},{highWaterMark:0});r.allReady=g;c(r)},function(r){g.catch(function(){});d(r)},e);if(b&&b.signal){var k=b.signal;if(k.aborted)Qe(m,k.reason);else{var p=function(){Qe(m,k.reason);k.removeEventListener("abort",p)};k.addEventListener("abort",p)}}Oe(m)})};exports.version="18.3.0-next-a8875eab7-20230310";
