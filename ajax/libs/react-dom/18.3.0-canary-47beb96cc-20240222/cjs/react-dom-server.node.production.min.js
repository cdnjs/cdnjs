...
E((""+e).trim());c?(c=!1,a.push(nc,f,oc,e)):a.push(pc,f,oc,e)}}c||a.push(L)}var N=B(" "),rc=B('="'),L=B('"'),sc=B('=""');function tc(a,b,c){c&&"function"!==typeof c&&"symbol"!==typeof c&&a.push(N,b,sc)}function O(a,b,c){"function"!==typeof c&&"symbol"!==typeof c&&"boolean"!==typeof c&&a.push(N,b,rc,E(c),L)}function Hc(a){var b=a.nextFormID++;return a.idPrefix+b}var Ic=B(E("javascript:throw new Error('A React form was unexpectedly submitted.')")),Jc=B('<input type="hidden"');
...
ba;break;case "checked":uc=ba;break;case "value":Ma=ba;break;default:P(a,ab,ba)}}var Md=Mc(a,d,e,va,wa,La,xa,ia);null!==uc?tc(a,"checked",uc):null!==vc&&tc(a,"checked",vc);null!==Ma?P(a,"value",Ma):null!==oa&&P(a,"value",oa);a.push(Lc);null!==Md&&Md.forEach(Kc,a);return null;case "button":a.push(U("button"));var bb=null,Nd=null,Od=null,Pd=null,Qd=null,Rd=null,Sd=null,cb;for(cb in c)if(D.call(c,cb)){var ja=c[cb];if(null!=ja)switch(cb){case "children":bb=ja;break;case "dangerouslySetInnerHTML":Nd=ja;
break;case "name":Od=ja;break;case "formAction":Pd=ja;break;case "formEncType":Qd=ja;break;case "formMethod":Rd=ja;break;case "formTarget":Sd=ja;break;default:P(a,cb,ja)}}var Td=Mc(a,d,e,Pd,Qd,Rd,Sd,Od);a.push(R);null!==Td&&Td.forEach(Kc,a);Oc(a,Nd,bb);if("string"===typeof bb){a.push(E(bb));var Ud=null}else Ud=bb;return Ud;case "form":a.push(U("form"));var db=null,Vd=null,pa=null,eb=null,fb=null,gb=null,hb;for(hb in c)if(D.call(c,hb)){var qa=c[hb];if(null!=qa)switch(hb){case "children":db=qa;break;
case "dangerouslySetInnerHTML":Vd=qa;break;case "action":pa=qa;break;case "encType":eb=qa;break;case "method":fb=qa;break;case "target":gb=qa;break;default:P(a,hb,qa)}}var wc=null,xc=null;if("function"===typeof pa)if("function"===typeof pa.$$FORM_ACTION){var Pf=Hc(d),Na=pa.$$FORM_ACTION(Pf);pa=Na.action||"";eb=Na.encType;fb=Na.method;gb=Na.target;wc=Na.data;xc=Na.name}else a.push(N,"action",rc,Ic,L),gb=fb=eb=pa=null,Nc(d,e);null!=pa&&P(a,"action",pa);null!=eb&&P(a,"encType",eb);null!=fb&&P(a,"method",
fb);null!=gb&&P(a,"target",gb);a.push(R);null!==xc&&(a.push(Jc),O(a,"name",xc),a.push(Lc),null!==wc&&wc.forEach(Kc,a));Oc(a,Vd,db);if("string"===typeof db){a.push(E(db));var Wd=null}else Wd=db;return Wd;case "menuitem":a.push(U("menuitem"));for(var Gb in c)if(D.call(c,Gb)){var Xd=c[Gb];if(null!=Xd)switch(Gb){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:P(a,Gb,Xd)}}a.push(R);return null;case "title":if(3===g.insertionMode||
g.tagScope&1||null!=c.itemProp)var yc=Vc(a,c);else l?yc=null:(Vc(e.hoistableChunks,c),yc=void 0);return yc;case "link":var Qf=c.rel,ra=c.href,Hb=c.precedence;if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp||"string"!==typeof Qf||"string"!==typeof ra||""===ra){S(a,c);var ib=null}else if("stylesheet"===c.rel)if("string"!==typeof Hb||null!=c.disabled||c.onLoad||c.onError)ib=S(a,c);else{var Oa=e.styles.get(Hb),Ib=d.styleResources.hasOwnProperty(ra)?d.styleResources[ra]:void 0;if(null!==Ib){d.styleResources[ra]=
null;Oa||(Oa={precedence:E(Hb),rules:[],hrefs:[],sheets:new Map},e.styles.set(Hb,Oa));var Jb={state:0,props:C({},c,{"data-precedence":c.precedence,precedence:null})};if(Ib){2===Ib.length&&dd(Jb.props,Ib);var zc=e.preloads.stylesheets.get(ra);zc&&0<zc.length?zc.length=0:Jb.state=1}Oa.sheets.set(ra,Jb);f&&f.stylesheets.add(Jb)}else if(Oa){var Yd=Oa.sheets.get(ra);Yd&&f&&f.stylesheets.add(Yd)}h&&a.push(kc);ib=null}else c.onLoad||c.onError?ib=S(a,c):(h&&a.push(kc),ib=l?null:S(e.hoistableChunks,c));return ib;
case "script":var Ac=c.async;if("string"!==typeof c.src||!c.src||!Ac||"function"===typeof Ac||"symbol"===typeof Ac||c.onLoad||c.onError||3===g.insertionMode||g.tagScope&1||null!=c.itemProp)var Zd=Xc(a,c);else{var Kb=c.src;if("module"===c.type){var Lb=d.moduleScriptResources;var $d=e.preloads.moduleScripts}else Lb=d.scriptResources,$d=e.preloads.scripts;var Mb=Lb.hasOwnProperty(Kb)?Lb[Kb]:void 0;if(null!==Mb){Lb[Kb]=null;var Bc=c;if(Mb){2===Mb.length&&(Bc=C({},c),dd(Bc,Mb));var ae=$d.get(Kb);ae&&(ae.length=
0)}var be=[];e.scripts.add(be);Xc(be,Bc)}h&&a.push(kc);Zd=null}return Zd;case "style":var Nb=c.precedence,ya=c.href;if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp||"string"!==typeof Nb||"string"!==typeof ya||""===ya){a.push(U("style"));var Pa=null,ce=null,kb;for(kb in c)if(D.call(c,kb)){var Ob=c[kb];if(null!=Ob)switch(kb){case "children":Pa=Ob;break;case "dangerouslySetInnerHTML":ce=Ob;break;default:P(a,kb,Ob)}}a.push(R);var lb=Array.isArray(Pa)?2>Pa.length?Pa[0]:null:Pa;"function"!==typeof lb&&
"symbol"!==typeof lb&&null!==lb&&void 0!==lb&&a.push(E(""+lb));Oc(a,ce,Pa);a.push(Wc("style"));var de=null}else{var za=e.styles.get(Nb);if(null!==(d.styleResources.hasOwnProperty(ya)?d.styleResources[ya]:void 0)){d.styleResources[ya]=null;za?za.hrefs.push(E(ya)):(za={precedence:E(Nb),rules:[],hrefs:[E(ya)],sheets:new Map},e.styles.set(Nb,za));var ee=za.rules,Qa=null,fe=null,Pb;for(Pb in c)if(D.call(c,Pb)){var Cc=c[Pb];if(null!=Cc)switch(Pb){case "children":Qa=Cc;break;case "dangerouslySetInnerHTML":fe=
Cc}}var mb=Array.isArray(Qa)?2>Qa.length?Qa[0]:null:Qa;"function"!==typeof mb&&"symbol"!==typeof mb&&null!==mb&&void 0!==mb&&ee.push(E(""+mb));Oc(ee,fe,Qa)}za&&f&&f.styles.add(za);h&&a.push(kc);de=void 0}return de;case "meta":if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp)var ge=Uc(a,c,"meta");else h&&a.push(kc),ge=l?null:"string"===typeof c.charSet?Uc(e.charsetChunks,c,"meta"):"viewport"===c.name?Uc(e.viewportChunks,c,"meta"):Uc(e.hoistableChunks,c,"meta");return ge;case "listing":case "pre":a.push(U(b));
...
":"!==J[4]||"d"!==J[0]&&"D"!==J[0]||"a"!==J[1]&&"A"!==J[1]||"t"!==J[2]&&"T"!==J[2]||"a"!==J[3]&&"A"!==J[3])){var he="string"===typeof c.sizes?c.sizes:void 0,Ra=J?J+"\n"+(he||""):M,Dc=e.preloads.images,Ba=Dc.get(Ra);if(Ba){if("high"===c.fetchPriority||10>e.highImagePreloads.size)Dc.delete(Ra),e.highImagePreloads.add(Ba)}else if(!d.imageResources.hasOwnProperty(Ra)){d.imageResources[Ra]=F;var Ec=c.crossOrigin;var ie="string"===typeof Ec?"use-credentials"===Ec?Ec:"":void 0;var ea=e.headers,Fc;ea&&0<
ea.remainingCapacity&&("high"===c.fetchPriority||500>ea.highImagePreloads.length)&&(Fc=ed(M,"image",{imageSrcSet:c.srcSet,imageSizes:c.sizes,crossOrigin:ie,integrity:c.integrity,nonce:c.nonce,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.refererPolicy}),2<=(ea.remainingCapacity-=Fc.length))?(e.resets.image[Ra]=F,ea.highImagePreloads&&(ea.highImagePreloads+=", "),ea.highImagePreloads+=Fc):(Ba=[],S(Ba,{rel:"preload",as:"image",href:J?void 0:M,imageSrcSet:J,imageSizes:he,crossOrigin:ie,
...
case "head":if(2>g.insertionMode&&null===e.headChunks){e.headChunks=[];var je=Yc(e.headChunks,c,"head")}else je=Yc(a,c,"head");return je;case "html":if(0===g.insertionMode&&null===e.htmlChunks){e.htmlChunks=[bd];var ke=Yc(e.htmlChunks,c,"html")}else ke=Yc(a,c,"html");return ke;default:if(-1!==b.indexOf("-")){a.push(U(b));var Gc=null,le=null,Sa;for(Sa in c)if(D.call(c,Sa)){var Ca=c[Sa];if(null!=Ca){var Rf=Sa;switch(Sa){case "children":Gc=Ca;break;case "dangerouslySetInnerHTML":le=Ca;break;case "style":qc(a,
Ca);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":case "ref":break;default:vb(Sa)&&"function"!==typeof Ca&&"symbol"!==typeof Ca&&a.push(N,Rf,rc,E(Ca),L)}}}a.push(R);Oc(a,le,Gc);return Gc}}return Yc(a,c,b)}var fd=new Map;function Wc(a){var b=fd.get(a);void 0===b&&(b=B("</"+a+">"),fd.set(a,b));return b}function gd(a,b){b=b.bootstrapChunks;for(var c=0;c<b.length-1;c++)u(a,b[c]);return c<b.length?(c=b[c],b.length=0,z(a,c)):!0}
...
var td=B('<div hidden id="'),ud=B('">'),vd=B("</div>"),wd=B('<svg aria-hidden="true" style="display:none" id="'),xd=B('">'),yd=B("</svg>"),zd=B('<math aria-hidden="true" style="display:none" id="'),Ad=B('">'),Bd=B("</math>"),Cd=B('<table hidden id="'),Dd=B('">'),Ed=B("</table>"),Fd=B('<table hidden><tbody id="'),Gd=B('">'),Hd=B("</tbody></table>"),Id=B('<table hidden><tr id="'),Jd=B('">'),Kd=B("</tr></table>"),Ld=B('<table hidden><colgroup id="'),me=B('">'),ne=B("</colgroup></table>");
...
function Nf(a){var b=a.parent;null!==b&&Nf(b);a.context._currentValue=a.value}function Of(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?Lf(a,b):Of(a,b)}
function Sf(a,b){var c=b.parent;if(null===c)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===c.depth?Lf(a,c):Sf(a,c);b.context._currentValue=b.value}function Tf(a){var b=Kf;b!==a&&(null===b?Nf(a):null===a?Mf(b):b.depth===a.depth?Lf(b,a):b.depth>a.depth?Of(b,a):Sf(b,a),Kf=a)}
...
function Ah(a,b,c){for(var d=c.completedSegments,e=0;e<d.length;e++)Bh(a,b,c,d[e]);d.length=0;ef(b,c.contentState,a.renderState);d=a.resumableState;a=a.renderState;e=c.rootSegmentID;c=c.contentState;var f=a.stylesToHoist;a.stylesToHoist=!1;var g=0===d.streamingFormat;g?(u(b,a.startInlineScript),f?0===(d.instructions&2)?(d.instructions|=10,u(b,2048<ye.length?ye.slice():ye)):0===(d.instructions&8)?(d.instructions|=8,u(b,ze)):u(b,Ae):0===(d.instructions&2)?(d.instructions|=2,u(b,we)):u(b,xe)):f?u(b,
Ge):u(b,Fe);d=e.toString(16);u(b,a.boundaryPrefix);u(b,d);g?u(b,Be):u(b,He);u(b,a.segmentPrefix);u(b,d);f?g?(u(b,Ce),uf(b,c)):(u(b,Ie),vf(b,c)):g&&u(b,De);d=g?z(b,Ee):z(b,Xb);return gd(b,a)&&d}
...
e)}}};exports.version="18.3.0-canary-47beb96cc-20240222";
