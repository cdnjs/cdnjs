...
aa;break;case "defaultValue":sa=aa;break;case "checked":ta=aa;break;case "value":ra=aa;break;default:R(a,ia,aa)}}var sd=ac(a,d,e,fa,ha,J,M,V);null!==ta?Vb(a,"checked",ta):null!==Na&&Vb(a,"checked",Na);null!==ra?R(a,"value",ra):null!==sa&&R(a,"value",sa);a.push($b);null!==sd&&sd.forEach(Zb,a);return null;case "button":a.push(W("button"));var db=null,td=null,ud=null,vd=null,wd=null,xd=null,yd=null,eb;for(eb in c)if(C.call(c,eb)){var oa=c[eb];if(null!=oa)switch(eb){case "children":db=oa;break;case "dangerouslySetInnerHTML":td=
oa;break;case "name":ud=oa;break;case "formAction":vd=oa;break;case "formEncType":wd=oa;break;case "formMethod":xd=oa;break;case "formTarget":yd=oa;break;default:R(a,eb,oa)}}var zd=ac(a,d,e,vd,wd,xd,yd,ud);a.push(S);null!==zd&&zd.forEach(Zb,a);cc(a,td,db);if("string"===typeof db){a.push(D(db));var Ad=null}else Ad=db;return Ad;case "form":a.push(W("form"));var fb=null,Bd=null,ua=null,gb=null,hb=null,ib=null,jb;for(jb in c)if(C.call(c,jb)){var va=c[jb];if(null!=va)switch(jb){case "children":fb=va;break;
case "dangerouslySetInnerHTML":Bd=va;break;case "action":ua=va;break;case "encType":gb=va;break;case "method":hb=va;break;case "target":ib=va;break;default:R(a,jb,va)}}var pc=null,qc=null;if("function"===typeof ua)if("function"===typeof ua.$$FORM_ACTION){var wf=Wb(d),Oa=ua.$$FORM_ACTION(wf);ua=Oa.action||"";gb=Oa.encType;hb=Oa.method;ib=Oa.target;pc=Oa.data;qc=Oa.name}else a.push(O,"action",P,Xb,L),ib=hb=gb=ua=null,bc(d,e);null!=ua&&R(a,"action",ua);null!=gb&&R(a,"encType",gb);null!=hb&&R(a,"method",
hb);null!=ib&&R(a,"target",ib);a.push(S);null!==qc&&(a.push(Yb),Q(a,"name",qc),a.push($b),null!==pc&&pc.forEach(Zb,a));cc(a,Bd,fb);if("string"===typeof fb){a.push(D(fb));var Cd=null}else Cd=fb;return Cd;case "menuitem":a.push(W("menuitem"));for(var Db in c)if(C.call(c,Db)){var Dd=c[Db];if(null!=Dd)switch(Db){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:R(a,Db,Dd)}}a.push(S);return null;case "title":if(3===f.insertionMode||
f.tagScope&1||null!=c.itemProp)var Ed=lc(a,c);else lc(e.hoistableChunks,c),Ed=null;return Ed;case "link":return ic(a,c,d,e,g,f.insertionMode,!!(f.tagScope&1));case "script":var rc=c.async;if("string"!==typeof c.src||!c.src||!rc||"function"===typeof rc||"symbol"===typeof rc||c.onLoad||c.onError||3===f.insertionMode||f.tagScope&1||null!=c.itemProp)var Fd=nc(a,c);else{var Eb=c.src;if("module"===c.type){var Fb=d.moduleScriptResources;var Gd=e.preloads.moduleScripts}else Fb=d.scriptResources,Gd=e.preloads.scripts;
var Gb=Fb.hasOwnProperty(Eb)?Fb[Eb]:void 0;if(null!==Gb){Fb[Eb]=null;var sc=c;if(Gb){2===Gb.length&&(sc=B({},c),jc(sc,Gb));var Hd=Gd.get(Eb);Hd&&(Hd.length=0)}var Id=[];e.scripts.add(Id);nc(Id,sc)}g&&a.push(Nb);Fd=null}return Fd;case "style":var Hb=c.precedence,za=c.href;if(3===f.insertionMode||f.tagScope&1||null!=c.itemProp||"string"!==typeof Hb||"string"!==typeof za||""===za){a.push(W("style"));var Pa=null,Jd=null,kb;for(kb in c)if(C.call(c,kb)){var Ib=c[kb];if(null!=Ib)switch(kb){case "children":Pa=
Ib;break;case "dangerouslySetInnerHTML":Jd=Ib;break;default:R(a,kb,Ib)}}a.push(S);var lb=Array.isArray(Pa)?2>Pa.length?Pa[0]:null:Pa;"function"!==typeof lb&&"symbol"!==typeof lb&&null!==lb&&void 0!==lb&&a.push(D(""+lb));cc(a,Jd,Pa);a.push(mc("style"));var Kd=null}else{var Aa=e.styles.get(Hb);if(null!==(d.styleResources.hasOwnProperty(za)?d.styleResources[za]:void 0)){d.styleResources[za]=null;Aa?Aa.hrefs.push(D(za)):(Aa={precedence:D(Hb),rules:[],hrefs:[D(za)],sheets:new Map},e.styles.set(Hb,Aa));
var Ld=Aa.rules,Qa=null,Md=null,Jb;for(Jb in c)if(C.call(c,Jb)){var tc=c[Jb];if(null!=tc)switch(Jb){case "children":Qa=tc;break;case "dangerouslySetInnerHTML":Md=tc}}var mb=Array.isArray(Qa)?2>Qa.length?Qa[0]:null:Qa;"function"!==typeof mb&&"symbol"!==typeof mb&&null!==mb&&void 0!==mb&&Ld.push(D(""+mb));cc(Ld,Md,Qa)}Aa&&e.boundaryResources&&e.boundaryResources.styles.add(Aa);g&&a.push(Nb);Kd=void 0}return Kd;case "meta":if(3===f.insertionMode||f.tagScope&1||null!=c.itemProp)var Nd=kc(a,c,"meta");
else g&&a.push(Nb),Nd="string"===typeof c.charSet?kc(e.charsetChunks,c,"meta"):"viewport"===c.name?kc(e.preconnectChunks,c,"meta"):kc(e.hoistableChunks,c,"meta");return Nd;case "listing":case "pre":a.push(W(b));var nb=null,ob=null,pb;for(pb in c)if(C.call(c,pb)){var Kb=c[pb];if(null!=Kb)switch(pb){case "children":nb=Kb;break;case "dangerouslySetInnerHTML":ob=Kb;break;default:R(a,pb,Kb)}}a.push(S);if(null!=ob){if(null!=nb)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");
...
null!=K)&&"low"!==c.fetchPriority&&!1===!!(f.tagScope&2)&&("string"!==typeof N||":"!==N[4]||"d"!==N[0]&&"D"!==N[0]||"a"!==N[1]&&"A"!==N[1]||"t"!==N[2]&&"T"!==N[2]||"a"!==N[3]&&"A"!==N[3])&&("string"!==typeof K||":"!==K[4]||"d"!==K[0]&&"D"!==K[0]||"a"!==K[1]&&"A"!==K[1]||"t"!==K[2]&&"T"!==K[2]||"a"!==K[3]&&"A"!==K[3])){var Od="string"===typeof c.sizes?c.sizes:void 0,Ra=K?K+"\n"+(Od||""):N,uc=e.preloads.images,Ca=uc.get(Ra);if(Ca){if("high"===c.fetchPriority||10>e.highImagePreloads.size)uc.delete(Ra),
e.highImagePreloads.add(Ca)}else if(!d.imageResources.hasOwnProperty(Ra)){d.imageResources[Ra]=E;var vc=c.crossOrigin;var Pd="string"===typeof vc?"use-credentials"===vc?vc:"":void 0;var ja=e.headers,wc;ja&&0<ja.remainingCapacity&&("high"===c.fetchPriority||500>ja.highImagePreloads.length)&&(wc=Dc(N,"image",{imageSrcSet:c.srcSet,imageSizes:c.sizes,crossOrigin:Pd,integrity:c.integrity,nonce:c.nonce,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.refererPolicy}),2<=(ja.remainingCapacity-=
wc.length))?(e.resets.image[Ra]=E,ja.highImagePreloads&&(ja.highImagePreloads+=", "),ja.highImagePreloads+=wc):(Ca=[],T(Ca,{rel:"preload",as:"image",href:K?void 0:N,imageSrcSet:K,imageSizes:Od,crossOrigin:Pd,integrity:c.integrity,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.referrerPolicy}),"high"===c.fetchPriority||10>e.highImagePreloads.size?e.highImagePreloads.add(Ca):(e.bulkPreloads.add(Ca),uc.set(Ra,Ca)))}}return kc(a,c,"img");case "base":case "area":case "br":case "col":case "embed":case "hr":case "keygen":case "param":case "source":case "track":case "wbr":return kc(a,
c,b);case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":break;case "head":if(2>f.insertionMode&&null===e.headChunks){e.headChunks=[];var Qd=oc(e.headChunks,c,"head")}else Qd=oc(a,c,"head");return Qd;case "html":if(0===f.insertionMode&&null===e.htmlChunks){e.htmlChunks=[Bc];var Rd=oc(e.htmlChunks,c,"html")}else Rd=oc(a,c,"html");return Rd;default:if(-1!==b.indexOf("-")){a.push(W(b));
var xc=null,Sd=null,Sa;for(Sa in c)if(C.call(c,Sa)){var Da=c[Sa];if(null!=Da){var xf=Sa;switch(Sa){case "children":xc=Da;break;case "dangerouslySetInnerHTML":Sd=Da;break;case "style":Tb(a,Da);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:Ha(Sa)&&"function"!==typeof Da&&"symbol"!==typeof Da&&a.push(O,xf,P,D(Da),L)}}}a.push(S);cc(a,Sd,xc);return xc}}return oc(a,c,b)}var Ec=new Map;
...
sf=Symbol.for("react.offscreen"),tf=Symbol.for("react.legacy_hidden"),uf=Symbol.for("react.cache"),vf=Symbol.for("react.default_value"),yf=Symbol.iterator;
...
for(;e<m.length&&!m[e].includes("DetermineComponentFrameRoot");)e++;if(d===l.length||e===m.length)for(d=l.length-1,e=m.length-1;1<=d&&0<=e&&l[d]!==m[e];)e--;for(;1<=d&&0<=e;d--,e--)if(l[d]!==m[e]){if(1!==d||1!==e){do if(d--,e--,0>e||l[d]!==m[e]){var q="\n"+l[d].replace(" at new "," at ");a.displayName&&q.includes("<anonymous>")&&(q=q.replace("<anonymous>",a.displayName));return q}while(1<=d&&0<=e)}break}}}finally{Cf=!1,Error.prepareStackTrace=c}return(c=a?a.displayName||a.name:"")?Bf(c):""}
var Ef={};function Ff(a,b){a=a.contextTypes;if(!a)return Ef;var c={},d;for(d in a)c[d]=b[d];return c}var Gf=null;function Hf(a,b){if(a!==b){a.context._currentValue=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Error("The stacks must reach the root at the same time. This is a bug in React.");}else{if(null===c)throw Error("The stacks must reach the root at the same time. This is a bug in React.");Hf(a,c)}b.context._currentValue=b.value}}
function If(a){a.context._currentValue=a.parentValue;a=a.parent;null!==a&&If(a)}function Jf(a){var b=a.parent;null!==b&&Jf(b);a.context._currentValue=a.value}function Kf(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?Hf(a,b):Kf(a,b)}
function Lf(a,b){var c=b.parent;if(null===c)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===c.depth?Hf(a,c):Lf(a,c);b.context._currentValue=b.value}function Mf(a){var b=Gf;b!==a&&(null===b?Jf(a):null===a?If(b):b.depth===a.depth?Hf(b,a):b.depth>a.depth?Kf(b,a):Lf(b,a),Gf=a)}
...
function Zf(){if(null===Yf)throw Error("Expected a suspended thenable. This is a bug in React. Please file an issue.");var a=Yf;Yf=null;return a}function $f(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var ag="function"===typeof Object.is?Object.is:$f,bg=null,cg=null,dg=null,eg=null,fg=null,X=null,gg=!1,hg=!1,ig=0,jg=0,kg=-1,lg=0,mg=null,ng=null,og=0;
function pg(){if(null===bg)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:\n1. You might have mismatching versions of React and the renderer (such as React DOM)\n2. You might be breaking the Rules of Hooks\n3. You might have more than one copy of React in the same app\nSee https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.");return bg}
function qg(){if(0<og)throw Error("Rendered more hooks than during the previous render");return{memoizedState:null,queue:null,next:null}}function rg(){null===X?null===fg?(gg=!1,fg=X=qg()):(gg=!0,X=fg):null===X.next?(gg=!1,X=X.next=qg()):(gg=!0,X=X.next);return X}function sg(a,b,c,d){for(;hg;)hg=!1,jg=ig=0,kg=-1,lg=0,og+=1,X=null,c=a(b,d);tg();return c}function ug(){var a=mg;mg=null;return a}function tg(){eg=dg=cg=bg=null;hg=!1;fg=null;og=0;X=ng=null}
function vg(a,b){return"function"===typeof b?b(a):b}function wg(a,b,c){bg=pg();X=rg();if(gg){var d=X.queue;b=d.dispatch;if(null!==ng&&(c=ng.get(d),void 0!==c)){ng.delete(d);d=X.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);X.memoizedState=d;return[d,b]}return[X.memoizedState,b]}a=a===vg?"function"===typeof b?b():b:void 0!==c?c(b):b;X.memoizedState=a;a=X.queue={last:null,dispatch:null};a=a.dispatch=xg.bind(null,bg,a);return[X.memoizedState,a]}
function yg(a,b){bg=pg();X=rg();b=void 0===b?null:b;if(null!==X){var c=X.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var e=0;e<d.length&&e<b.length;e++)if(!ag(b[e],d[e])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();X.memoizedState=[a,b];return a}
function xg(a,b,c){if(25<=og)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===bg)if(hg=!0,a={action:c,next:null},null===ng&&(ng=new Map),c=ng.get(b),void 0===c)ng.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function zg(){throw Error("startTransition cannot be called during server rendering.");}function Ag(){throw Error("Cannot update optimistic state while rendering.");}
function Bg(a,b,c){if(void 0!==a)return"p"+a;a=JSON.stringify([b,null,c]);b=ca.createHash("md5");b.update(a);return"k"+b.digest("hex")}function Cg(a){var b=lg;lg+=1;null===mg&&(mg=[]);return Xf(mg,a,b)}function Dg(){throw Error("Cache cannot be refreshed during server rendering.");}function Eg(){}
var Gg={readContext:function(a){return a._currentValue},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return Cg(a);if(a.$$typeof===jf||a.$$typeof===kf)return a._currentValue}throw Error("An unsupported type was passed to use(): "+String(a));},useContext:function(a){pg();return a._currentValue},useMemo:yg,useReducer:wg,useRef:function(a){bg=pg();X=rg();var b=X.memoizedState;return null===b?(a={current:a},X.memoizedState=a):b},useState:function(a){return wg(vg,a)},
useInsertionEffect:Eg,useLayoutEffect:Eg,useCallback:function(a,b){return yg(function(){return a},b)},useImperativeHandle:Eg,useEffect:Eg,useDebugValue:Eg,useDeferredValue:function(a){pg();return a},useTransition:function(){pg();return[!1,zg]},useId:function(){var a=cg.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Rf(a)-1)).toString(32)+b;var c=Fg;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=ig++;a=":"+c.idPrefix+"R"+a;0<b&&
(a+="H"+b.toString(32));return a+":"},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");return c()},useCacheRefresh:function(){return Dg},useHostTransitionStatus:function(){pg();return Va},useOptimistic:function(a){pg();return[a,Ag]},useFormState:function(a,b,c){pg();var d=jg++,e=dg;if("function"===typeof a.$$FORM_ACTION){var f=null,g=eg;e=e.formState;var h=a.$$IS_SIGNATURE_EQUAL;
if(null!==e&&"function"===typeof h){var l=e[1];h.call(a,e[2],e[3])&&(f=Bg(c,g,d),l===f&&(kg=d,b=e[0]))}var m=a.bind(null,b);a=function(p){m(p)};"function"===typeof m.$$FORM_ACTION&&(a.$$FORM_ACTION=function(p){p=m.$$FORM_ACTION(p);void 0!==c&&(c+="",p.action=c);var r=p.data;r&&(null===f&&(f=Bg(c,g,d)),r.append("$ACTION_KEY",f));return p});return[b,a]}var q=a.bind(null,b);return[b,function(p){q(p)}]}},Fg=null,Hg={getCacheSignal:function(){throw Error("Not implemented.");},getCacheForType:function(){throw Error("Not implemented.");
...
function Qg(a,b,c,d,e,f,g,h,l,m,q,p,r){a.allPendingTasks++;null===e?a.pendingRootTasks++:e.pendingTasks++;var t={replay:null,node:c,childIndex:d,ping:function(){return Ng(a,t)},blockedBoundary:e,blockedSegment:f,abortSet:g,keyPath:h,formatContext:l,legacyContext:m,context:q,treeContext:p,componentStack:r,thenableState:b};g.add(t);return t}
function Rg(a,b,c,d,e,f,g,h,l,m,q,p,r){a.allPendingTasks++;null===f?a.pendingRootTasks++:f.pendingTasks++;c.pendingTasks++;var t={replay:c,node:d,childIndex:e,ping:function(){return Ng(a,t)},blockedBoundary:f,blockedSegment:null,abortSet:g,keyPath:h,formatContext:l,legacyContext:m,context:q,treeContext:p,componentStack:r,thenableState:b};g.add(t);return t}
function Sg(a,b,c,d,e,f){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],parentFormatContext:d,boundary:c,lastPushedText:e,textEmbedded:f}}function Tg(a,b){return{tag:0,parent:a.componentStack,type:b}}function Ug(a){if(a){try{var b="";do{switch(a.tag){case 0:b+=Bf(a.type,null,null);break;case 1:b+=Df(a.type,!1);break;case 2:b+=Df(a.type,!0)}a=a.parent}while(a);var c=b}catch(d){c="\nError generating stack: "+d.message+"\n"+d.stack}c={componentStack:c}}else c={};return c}
function Y(a,b,c){a=a.onError(b,c);if(null==a||"string"===typeof a)return a}function Vg(a,b){var c=a.onShellError;c(b);c=a.onFatalError;c(b);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}
...
function Xg(a,b,c,d,e,f,g){var h=!1;if(0!==f&&null!==a.formState){var l=b.blockedSegment;if(null!==l){h=!0;l=l.chunks;for(var m=0;m<f;m++)m===g?l.push(gc):l.push(hc)}}f=b.keyPath;b.keyPath=c;e?(c=b.treeContext,b.treeContext=Qf(c,1,0),Yg(a,b,d,-1),b.treeContext=c):h?Yg(a,b,d,-1):Z(a,b,null,d,-1);b.keyPath=f}function Zg(a,b){if(a&&a.defaultProps){b=B({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function $g(a,b,c,d,e,f,g){if("function"===typeof e)if(e.prototype&&e.prototype.isReactComponent){d=b.componentStack;b.componentStack={tag:2,parent:b.componentStack,type:e};g=Ff(e,b.legacyContext);var h=e.contextType;h=new e(f,"object"===typeof h&&null!==h?h._currentValue:g);Of(h,e,f,g);Wg(a,b,c,h,e);b.componentStack=d}else{g=Ff(e,b.legacyContext);h=b.componentStack;b.componentStack={tag:1,parent:b.componentStack,type:e};bg={};cg=b;dg=a;eg=c;jg=ig=0;kg=-1;lg=0;mg=d;d=e(f,g);d=sg(e,f,d,g);var l=0!==
ig,m=jg,q=kg;"object"===typeof d&&null!==d&&"function"===typeof d.render&&void 0===d.$$typeof?(Of(d,e,f,g),Wg(a,b,c,d,e)):Xg(a,b,c,d,l,m,q);b.componentStack=h}else if("string"===typeof e){d=b.componentStack;b.componentStack=Tg(b,e);g=b.blockedSegment;if(null===g)g=f.children,h=b.formatContext,l=b.keyPath,b.formatContext=Mb(h,e,f),b.keyPath=c,Yg(a,b,g,-1),b.formatContext=h,b.keyPath=l;else{l=Cc(g.chunks,e,f,a.resumableState,a.renderState,b.formatContext,g.lastPushedText);g.lastPushedText=!1;h=b.formatContext;
m=b.keyPath;b.formatContext=Mb(h,e,f);b.keyPath=c;Yg(a,b,l,-1);b.formatContext=h;b.keyPath=m;a:{c=g.chunks;a=a.resumableState;switch(e){case "title":case "style":case "script":case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "input":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":break a;case "body":if(1>=h.insertionMode){a.hasBody=!0;break a}break;case "html":if(0===h.insertionMode){a.hasHtml=!0;break a}}c.push(mc(e))}g.lastPushedText=
!1}b.componentStack=d}else{switch(e){case tf:case rf:case ff:case gf:case ef:e=b.keyPath;b.keyPath=c;Z(a,b,null,f.children,-1);b.keyPath=e;return;case sf:"hidden"!==f.mode&&(e=b.keyPath,b.keyPath=c,Z(a,b,null,f.children,-1),b.keyPath=e);return;case nf:e=b.componentStack;b.componentStack=Tg(b,"SuspenseList");d=b.keyPath;b.keyPath=c;Z(a,b,null,f.children,-1);b.keyPath=d;b.componentStack=e;return;case qf:throw Error("ReactDOMServer does not yet support scope components.");case mf:a:if(null!==b.replay){e=
b.keyPath;b.keyPath=c;c=f.children;try{Yg(a,b,c,-1)}finally{b.keyPath=e}}else{var p=b.componentStack;e=b.componentStack=Tg(b,"Suspense");var r=b.keyPath;d=b.blockedBoundary;var t=b.blockedSegment;g=f.fallback;var A=f.children;f=new Set;m=Pg(a,f);null!==a.trackedPostpones&&(m.trackedContentKeyPath=c);q=Sg(a,t.chunks.length,m,b.formatContext,!1,!1);t.children.push(q);t.lastPushedText=!1;var F=Sg(a,0,null,b.formatContext,!1,!1);F.parentFlushed=!0;b.blockedBoundary=m;b.blockedSegment=F;a.renderState.boundaryResources=
m.resources;b.keyPath=c;try{if(Yg(a,b,A,-1),F.lastPushedText&&F.textEmbedded&&F.chunks.push(Nb),F.status=1,ah(m,F),0===m.pendingTasks&&0===m.status){m.status=1;b.componentStack=p;break a}}catch(u){F.status=4,m.status=4,h=Ug(b.componentStack),l=Y(a,u,h),m.errorDigest=l}finally{a.renderState.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=t,b.keyPath=r,b.componentStack=p}h=[c[0],"Suspense Fallback",c[2]];l=a.trackedPostpones;null!==l&&(p=[h[1],h[2],[],null],l.workingMap.set(h,
p),5===m.status?l.workingMap.get(c)[4]=p:m.trackedFallbackNode=p);b=Qg(a,null,g,-1,d,q,f,h,b.formatContext,b.legacyContext,b.context,b.treeContext,e);a.pingedTasks.push(b)}return}if("object"===typeof e&&null!==e)switch(e.$$typeof){case lf:h=b.componentStack;b.componentStack={tag:1,parent:b.componentStack,type:e.render};e=e.render;bg={};cg=b;dg=a;eg=c;jg=ig=0;kg=-1;lg=0;mg=d;d=e(f,g);f=sg(e,f,d,g);Xg(a,b,c,f,0!==ig,jg,kg);b.componentStack=h;return;case of:e=e.type;f=Zg(e,f);$g(a,b,c,d,e,f,g);return;
case hf:g=f.children;d=b.keyPath;e=e._context;f=f.value;h=e._currentValue;e._currentValue=f;l=Gf;Gf=f={parent:l,depth:null===l?0:l.depth+1,context:e,parentValue:h,value:f};b.context=f;b.keyPath=c;Z(a,b,null,g,-1);a=Gf;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");c=a.parentValue;a.context._currentValue=c===vf?a.context._defaultValue:c;a=Gf=a.parent;b.context=a;b.keyPath=d;return;case jf:f=f.children;f=f(e._currentValue);e=b.keyPath;b.keyPath=c;Z(a,
b,null,f,-1);b.keyPath=e;return;case pf:g=b.componentStack;b.componentStack=Tg(b,"Lazy");h=e._init;e=h(e._payload);f=Zg(e,f);$g(a,b,c,d,e,f,void 0);b.componentStack=g;return}throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: "+((null==e?e:typeof e)+"."));}}
function bh(a,b,c,d,e){var f=b.replay,g=b.blockedBoundary,h=Sg(a,0,null,b.formatContext,!1,!1);h.id=c;h.parentFlushed=!0;try{b.replay=null,b.blockedSegment=h,Yg(a,b,d,e),h.status=1,null===g?a.completedRootSegment=h:(ah(g,h),g.parentFlushed&&a.partialBoundaries.push(g))}finally{b.replay=f,b.blockedSegment=null}}
function Z(a,b,c,d,e){if(null!==b.replay&&"number"===typeof b.replay.slots)bh(a,b,b.replay.slots,d,e);else{b.node=d;b.childIndex=e;if("object"===typeof d&&null!==d){switch(d.$$typeof){case cf:var f=d.type,g=d.key,h=d.props,l=d.ref,m=zf(f),q=null==g?-1===e?0:e:g;g=[b.keyPath,m,q];if(null!==b.replay)a:{var p=b.replay;e=p.nodes;for(d=0;d<e.length;d++){var r=e[d];if(q===r[1]){if(4===r.length){if(null!==m&&m!==r[0])throw Error("Expected the resume to render <"+r[0]+"> in this slot but instead it rendered <"+
m+">. The tree doesn't match so React will fallback to client rendering.");var t=r[2];m=r[3];r=b.node;b.replay={nodes:t,slots:m,pendingTasks:1};try{$g(a,b,g,c,f,h,l);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(G){if("object"===typeof G&&null!==G&&(G===Vf||"function"===typeof G.then))throw b.node===r&&(b.replay=p),
G;b.replay.pendingTasks--;h=Ug(b.componentStack);g=a;a=b.blockedBoundary;c=G;h=Y(g,c,h);ch(g,a,t,m,c,h)}b.replay=p}else{if(f!==mf)throw Error("Expected the resume to render <Suspense> in this slot but instead it rendered <"+(zf(f)||"Unknown")+">. The tree doesn't match so React will fallback to client rendering.");b:{p=void 0;c=r[5];f=r[2];l=r[3];m=null===r[4]?[]:r[4][2];r=null===r[4]?null:r[4][3];q=b.componentStack;var A=b.componentStack=Tg(b,"Suspense"),F=b.keyPath,u=b.replay,x=b.blockedBoundary,
da=h.children;h=h.fallback;var U=new Set,w=Pg(a,U);w.parentFlushed=!0;w.rootSegmentID=c;b.blockedBoundary=w;b.replay={nodes:f,slots:l,pendingTasks:1};a.renderState.boundaryResources=w.resources;try{Yg(a,b,da,-1);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--;if(0===w.pendingTasks&&0===w.status){w.status=1;a.completedBoundaries.push(w);
break b}}catch(G){w.status=4,t=Ug(b.componentStack),p=Y(a,G,t),w.errorDigest=p,b.replay.pendingTasks--,a.clientRenderedBoundaries.push(w)}finally{a.renderState.boundaryResources=x?x.resources:null,b.blockedBoundary=x,b.replay=u,b.keyPath=F,b.componentStack=q}b=Rg(a,null,{nodes:m,slots:r,pendingTasks:0},h,-1,x,U,[g[0],"Suspense Fallback",g[2]],b.formatContext,b.legacyContext,b.context,b.treeContext,A);a.pingedTasks.push(b)}}e.splice(d,1);break a}}}else $g(a,b,g,c,f,h,l);return;case df:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");
case pf:h=b.componentStack;b.componentStack=Tg(b,"Lazy");g=d._init;d=g(d._payload);b.componentStack=h;Z(a,b,null,d,e);return}if(Ta(d)){dh(a,b,d,e);return}null===d||"object"!==typeof d?h=null:(h=yf&&d[yf]||d["@@iterator"],h="function"===typeof h?h:null);if(h&&(h=h.call(d))){d=h.next();if(!d.done){g=[];do g.push(d.value),d=h.next();while(!d.done);dh(a,b,g,e)}return}if("function"===typeof d.then)return Z(a,b,null,Cg(d),e);if(d.$$typeof===jf||d.$$typeof===kf)return Z(a,b,null,d._currentValue,e);e=Object.prototype.toString.call(d);
...
function dh(a,b,c,d){var e=b.keyPath;if(-1!==d&&(b.keyPath=[b.keyPath,"Fragment",d],null!==b.replay)){for(var f=b.replay,g=f.nodes,h=0;h<g.length;h++){var l=g[h];if(l[1]===d){d=l[2];l=l[3];b.replay={nodes:d,slots:l,pendingTasks:1};try{dh(a,b,c,-1);if(1===b.replay.pendingTasks&&0<b.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");b.replay.pendingTasks--}catch(p){if("object"===typeof p&&
null!==p&&(p===Vf||"function"===typeof p.then))throw p;b.replay.pendingTasks--;c=Ug(b.componentStack);var m=b.blockedBoundary,q=p;c=Y(a,q,c);ch(a,m,d,l,q,c)}b.replay=f;g.splice(h,1);break}}b.keyPath=e;return}f=b.treeContext;g=c.length;if(null!==b.replay&&(h=b.replay.slots,null!==h&&"object"===typeof h)){for(d=0;d<g;d++)l=c[d],b.treeContext=Qf(f,g,d),m=h[d],"number"===typeof m?(bh(a,b,m,l,d),delete h[d]):Yg(a,b,l,d);b.treeContext=f;b.keyPath=e;return}for(h=0;h<g;h++)d=c[h],b.treeContext=Qf(f,g,h),
Yg(a,b,d,h);b.treeContext=f;b.keyPath=e}
function Yg(a,b,c,d){var e=b.formatContext,f=b.legacyContext,g=b.context,h=b.keyPath,l=b.treeContext,m=b.componentStack,q=b.blockedSegment;if(null===q)try{return Z(a,b,null,c,d)}catch(t){if(tg(),c=t===Vf?Zf():t,"object"===typeof c&&null!==c&&"function"===typeof c.then){d=ug();a=Rg(a,d,b.replay,b.node,b.childIndex,b.blockedBoundary,b.abortSet,b.keyPath,b.formatContext,b.legacyContext,b.context,b.treeContext,null!==b.componentStack?b.componentStack.parent:null).ping;c.then(a,a);b.formatContext=e;b.legacyContext=
f;b.context=g;b.keyPath=h;b.treeContext=l;b.componentStack=m;Mf(g);return}}else{var p=q.children.length,r=q.chunks.length;try{return Z(a,b,null,c,d)}catch(t){if(tg(),q.children.length=p,q.chunks.length=r,c=t===Vf?Zf():t,"object"===typeof c&&null!==c&&"function"===typeof c.then){d=ug();q=b.blockedSegment;p=Sg(a,q.chunks.length,null,b.formatContext,q.lastPushedText,!0);q.children.push(p);q.lastPushedText=!1;a=Qg(a,d,b.node,b.childIndex,b.blockedBoundary,p,b.abortSet,b.keyPath,b.formatContext,b.legacyContext,
b.context,b.treeContext,null!==b.componentStack?b.componentStack.parent:null).ping;c.then(a,a);b.formatContext=e;b.legacyContext=f;b.context=g;b.keyPath=h;b.treeContext=l;b.componentStack=m;Mf(g);return}}}b.formatContext=e;b.legacyContext=f;b.context=g;b.keyPath=h;b.treeContext=l;Mf(g);throw c;}function eh(a){var b=a.blockedBoundary;a=a.blockedSegment;null!==a&&(a.status=3,fh(this,b,a))}
function ch(a,b,c,d,e,f){for(var g=0;g<c.length;g++){var h=c[g];if(4===h.length)ch(a,b,h[2],h[3],e,f);else{h=h[5];var l=a,m=f,q=Pg(l,new Set);q.parentFlushed=!0;q.rootSegmentID=h;q.status=4;q.errorDigest=m;q.parentFlushed&&l.clientRenderedBoundaries.push(q)}}c.length=0;if(null!==d){if(null===b)throw Error("We should not have any resumable nodes in the shell. This is a bug in React.");4!==b.status&&(b.status=4,b.errorDigest=f,b.parentFlushed&&a.clientRenderedBoundaries.push(b));if("object"===typeof d)for(var p in d)delete d[p]}}
function gh(a,b,c){var d=a.blockedBoundary,e=a.blockedSegment;null!==e&&(e.status=3);if(null===d){if(d={},1!==b.status&&2!==b.status){a=a.replay;if(null===a){Y(b,c,d);Vg(b,c);return}a.pendingTasks--;0===a.pendingTasks&&0<a.nodes.length&&(d=Y(b,c,d),ch(b,null,a.nodes,a.slots,c,d));b.pendingRootTasks--;0===b.pendingRootTasks&&hh(b)}}else d.pendingTasks--,4!==d.status&&(d.status=4,a=Ug(a.componentStack),a=Y(b,c,a),d.errorDigest=a,d.parentFlushed&&b.clientRenderedBoundaries.push(d)),d.fallbackAbortableTasks.forEach(function(f){return gh(f,
...
nonce:t.nonce,type:t.type,fetchPriority:t.fetchPriority,referrerPolicy:t.referrerPolicy,media:t.media});if(2<=(e.remainingCapacity-=A.length))c.resets.style[r]=E,f&&(f+=", "),f+=A,c.resets.style[r]="string"===typeof p.crossOrigin||"string"===typeof p.integrity?[p.crossOrigin,p.integrity]:E;else break b}}f?d({Link:f}):d({})}}}catch(F){Y(a,F,{})}}function hh(a){null===a.trackedPostpones&&jh(a,!0);a.onShellError=Lg;a=a.onShellReady;a()}
function ih(a){jh(a,null===a.trackedPostpones?!0:null===a.completedRootSegment||5!==a.completedRootSegment.status);a=a.onAllReady;a()}function ah(a,b){if(0===b.chunks.length&&1===b.children.length&&null===b.children[0].boundary&&-1===b.children[0].id){var c=b.children[0];c.id=b.id;c.parentFlushed=!0;1===c.status&&ah(a,c)}else a.completedSegments.push(b)}
function fh(a,b,c){if(null===b){if(null!==c&&c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&hh(a)}else b.pendingTasks--,4!==b.status&&(0===b.pendingTasks?(0===b.status&&(b.status=1),null!==c&&c.parentFlushed&&1===c.status&&ah(b,c),b.parentFlushed&&a.completedBoundaries.push(b),1===b.status&&(b.fallbackAbortableTasks.forEach(eh,a),b.fallbackAbortableTasks.clear())):
null!==c&&c.parentFlushed&&1===c.status&&(ah(b,c),1===b.completedSegments.length&&b.parentFlushed&&a.partialBoundaries.push(b)));a.allPendingTasks--;0===a.allPendingTasks&&ih(a)}
function Og(a){if(2!==a.status){var b=Gf,c=Ig.current;Ig.current=Gg;var d=Jg.current;Jg.current=Hg;var e=Mg;Mg=a;var f=Fg;Fg=a.resumableState;try{var g=a.pingedTasks,h;for(h=0;h<g.length;h++){var l=g[h],m=a,q=l.blockedBoundary;m.renderState.boundaryResources=q?q.resources:null;var p=l.blockedSegment;if(null===p){var r=m;if(0!==l.replay.pendingTasks){Mf(l.context);try{var t=l.thenableState;l.thenableState=null;Z(r,l,t,l.node,l.childIndex);if(1===l.replay.pendingTasks&&0<l.replay.nodes.length)throw Error("Couldn't find all resumable slots by key/index during replaying. The tree doesn't match so React will fallback to client rendering.");
l.replay.pendingTasks--;l.abortSet.delete(l);fh(r,l.blockedBoundary,null)}catch(M){tg();var A=M===Vf?Zf():M;if("object"===typeof A&&null!==A&&"function"===typeof A.then){var F=l.ping;A.then(F,F);l.thenableState=ug()}else{l.replay.pendingTasks--;l.abortSet.delete(l);var u=Ug(l.componentStack);m=void 0;var x=r,da=l.blockedBoundary,U=A,w=l.replay.nodes,G=l.replay.slots;m=Y(x,U,u);ch(x,da,w,G,U,m);r.pendingRootTasks--;0===r.pendingRootTasks&&hh(r);r.allPendingTasks--;0===r.allPendingTasks&&ih(r)}}finally{r.renderState.boundaryResources=
null}}}else if(r=void 0,x=p,0===x.status){Mf(l.context);var H=x.children.length,ea=x.chunks.length;try{var na=l.thenableState;l.thenableState=null;Z(m,l,na,l.node,l.childIndex);x.lastPushedText&&x.textEmbedded&&x.chunks.push(Nb);l.abortSet.delete(l);x.status=1;fh(m,l.blockedBoundary,x)}catch(M){tg();x.children.length=H;x.chunks.length=ea;var V=M===Vf?Zf():M;if("object"===typeof V&&null!==V&&"function"===typeof V.then){var fa=l.ping;V.then(fa,fa);l.thenableState=ug()}else{var ha=Ug(l.componentStack);
l.abortSet.delete(l);x.status=4;var J=l.blockedBoundary;r=Y(m,V,ha);null===J?Vg(m,V):(J.pendingTasks--,4!==J.status&&(J.status=4,J.errorDigest=r,J.parentFlushed&&m.clientRenderedBoundaries.push(J)));m.allPendingTasks--;0===m.allPendingTasks&&ih(m)}}finally{m.renderState.boundaryResources=null}}}g.splice(0,h);null!==a.destination&&kh(a,a.destination)}catch(M){Y(a,M,{}),Vg(a,M)}finally{Fg=f,Ig.current=c,Jg.current=d,c===Gg&&Mf(b),Mg=e}}}
function lh(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:c.id=a.nextSegmentId++;case 5:var d=c.id;c.lastPushedText=!1;c.textEmbedded=!1;a=a.renderState;v(b,Gc);v(b,a.placeholderPrefix);a=d.toString(16);v(b,a);return y(b,Hc);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)v(b,d[f]);e=mh(a,b,e)}for(;f<d.length-1;f++)v(b,d[f]);f<d.length&&(e=y(b,d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function mh(a,b,c){var d=c.boundary;if(null===d)return lh(a,b,c);d.parentFlushed=!0;if(4===d.status)d=d.errorDigest,y(b,Lc),v(b,Nc),d&&(v(b,Pc),v(b,D(d)),v(b,Oc)),y(b,Qc),lh(a,b,c);else if(1!==d.status)0===d.status&&(d.rootSegmentID=a.nextSegmentId++),0<d.completedSegments.length&&a.partialBoundaries.push(d),Rc(b,a.renderState,d.rootSegmentID),lh(a,b,c);else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Rc(b,a.renderState,d.rootSegmentID),lh(a,b,
c);else{c=d.resources;var e=a.renderState.boundaryResources;e&&(c.styles.forEach($e,e),c.stylesheets.forEach(af,e));y(b,Ic);d=d.completedSegments;if(1!==d.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");mh(a,b,d[0])}return y(b,Mc)}function nh(a,b,c){md(b,a.renderState,c.parentFormatContext,c.id);mh(a,b,c);return nd(b,c.parentFormatContext)}
...
b);e.scripts.clear();e.bulkPreloads.forEach(Ee,b);e.bulkPreloads.clear();var A=e.preloadChunks;for(f=0;f<A.length;f++)v(b,A[f]);A.length=0;var F=e.hoistableChunks;for(f=0;f<F.length;f++)v(b,F[f]);F.length=0;m&&null===q&&v(b,mc("head"));mh(a,b,d);a.completedRootSegment=null;Fc(b,a.renderState)}else return;var u=a.renderState;d=0;u.preconnects.forEach(Ee,b);u.preconnects.clear();var x=u.preconnectChunks;for(d=0;d<x.length;d++)v(b,x[d]);x.length=0;u.fontPreloads.forEach(Ee,b);u.fontPreloads.clear();
...
allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:q,pingedTasks:b,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],trackedPostpones:null,onError:void 0===t?Kg:t,onPostpone:void 0===g?Lg:g,onAllReady:void 0===l?Lg:l,onShellReady:void 0===m?Lg:m,onShellError:void 0===p?Lg:p,onFatalError:Lg,formState:void 0===h?null:h};d=Sg(c,0,null,e,!1,!1);d.parentFlushed=!0;a=Qg(c,null,a,-1,null,d,q,null,e,Ef,null,Pf,null);b.push(a);return c}
exports.renderToPipeableStream=function(a,b){var c=wh(a,b),d=!1;qh(c);return{pipe:function(e){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;jh(c,null===c.trackedPostpones?0===c.pendingRootTasks:null===c.completedRootSegment?0===c.pendingRootTasks:5!==c.completedRootSegment.status);sh(c,e);e.on("drain",uh(e,c));e.on("error",vh(c,"The destination stream errored while writing data."));e.on("close",vh(c,"The destination stream closed early."));return e},abort:function(e){th(c,
e)}}};exports.version="18.3.0-canary-cb2439624-20231219";
