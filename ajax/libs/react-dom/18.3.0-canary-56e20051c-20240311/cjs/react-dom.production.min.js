...
function Xo(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var k=sl(g);h.call(k)}}rl(b,g,a,e)}else g=Wo(c,b,a,e,d);return sl(g)}function Yo(a,b){if("font"===a)return"";if("string"===typeof b)return"use-credentials"===b?b:""}var Zo=da.ReactDOMCurrentDispatcher;da.Events=[Nb,Ob,Pb,Qc,Rc,Ok];var $o={findFiberByHostInstance:Lb,bundleType:0,version:"18.3.0-canary-56e20051c-20240311",rendererPackageName:"react-dom"};
...
exports.useFormStatus=function(){return fa.current.useHostTransitionStatus()};exports.version="18.3.0-canary-56e20051c-20240311";
