...
null===e.htmlChunks?(e.htmlChunks=["<!DOCTYPE html>"],a=E(e.htmlChunks,c,"html")):a=E(a,c,"html"),a;default:if(-1===b.indexOf("-"))return E(a,c,b);a.push(D(b));d=g=null;for(var z in c)if(r.call(c,z)&&(h=c[z],null!=h))switch(z){case "children":g=h;break;case "dangerouslySetInnerHTML":d=h;break;case "style":Ca(a,h);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:ia(z)&&"function"!==typeof h&&"symbol"!==typeof h&&a.push(" ",z,'="',v(h),'"')}a.push(">");A(a,d,
g);return g}}function Na(a,b,c){a.push('\x3c!--$?--\x3e<template id="');if(null===c)throw Error("An ID must have been assigned before we can complete the boundary.");a.push(c);return a.push('"></template>')}
...
exports.version="18.3.0-next-8310854ce-20230331";
