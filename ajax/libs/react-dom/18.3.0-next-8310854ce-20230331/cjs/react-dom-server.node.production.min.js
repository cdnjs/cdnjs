...
function ue(a){if(2!==a.status){var b=U,c=pe.current;pe.current=ne;var d=qe.current;qe.current=oe;var e=a.resources;Ca.push(E);E=e;e=wa.current;wa.current=Ba;var f=me;me=a.responseState;try{var g=a.pingedTasks,m;for(m=0;m<g.length;m++){var k=g[m];var n=a,r=k.blockedBoundary;n.resources.boundaryResources=r?r.resources:null;var p=k.blockedSegment;if(0===p.status){Cd(k.context);try{var t=k.thenableState;k.thenableState=null;Z(n,k,t,k.node);p.lastPushedText&&p.textEmbedded&&p.chunks.push(G);k.abortSet.delete(k);
p.status=1;Ge(n,k.blockedBoundary,p)}catch(qa){ce();var C=qa===Ld?Pd():qa;if("object"===typeof C&&null!==C&&"function"===typeof C.then){var I=k.ping;C.then(I,I);k.thenableState=de()}else{k.abortSet.delete(k);p.status=4;var z=n,J=k.blockedBoundary,ra=C,ja=xe(z,ra);null===J?ye(z,ra):(J.pendingTasks--,J.forceClientRender||(J.forceClientRender=!0,J.errorDigest=ja,J.parentFlushed&&z.clientRenderedBoundaries.push(J)));z.allPendingTasks--;if(0===z.allPendingTasks){var Re=z.onAllReady;Re()}}}finally{n.resources.boundaryResources=
null}}}g.splice(0,m);null!==a.destination&&Ie(a,a.destination)}catch(qa){xe(a,qa),ye(a,qa)}finally{me=f,pe.current=c,qe.current=d,E=Ca.pop(),wa.current=e,c===ne&&Cd(b)}}}
function Je(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;q(b,jb);q(b,a.placeholderPrefix);a=d.toString(16);q(b,a);return v(b,kb);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)q(b,d[f]);e=Ke(a,b,e)}for(;f<d.length-1;f++)q(b,d[f]);f<d.length&&(e=v(b,d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function Ke(a,b,c){var d=c.boundary;if(null===d)return Je(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,v(b,ob),q(b,qb),d&&(q(b,sb),q(b,D(d)),q(b,rb)),v(b,tb),Je(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=w(e.boundaryPrefix+f.toString(16));d=d.id=e;ub(b,a.responseState,d);Je(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),
ub(b,a.responseState,d.id),Je(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(Zc,c);v(b,lb);c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");Ke(a,b,c[0])}return v(b,pb)}function Le(a,b,c){Qb(b,a.responseState,c.formatContext,c.id);Ke(a,b,c);return Rb(b,c.formatContext)}
...
for(c=0;c<C.length;c++)if(!Me(a,b,C[c])){a.destination=null;c++;C.splice(0,c);return}C.splice(0,c);ia(b);h=new Uint8Array(2048);l=0;fa=!0;var I=a.partialBoundaries;for(c=0;c<I.length;c++){var z=I[c];a:{f=a;g=b;f.resources.boundaryResources=z.resources;var J=z.completedSegments;for(m=0;m<J.length;m++)if(!Ne(f,g,z,J[m])){m++;J.splice(0,m);var ra=!1;break a}J.splice(0,m);ra=Fc(g,z.resources,f.responseState)}if(!ra){a.destination=null;c++;I.splice(0,c);return}}I.splice(0,c);var ja=a.completedBoundaries;
...
onShellReady:void 0===f?se:f,onShellError:void 0===e?se:e,onFatalError:se};c=we(g,0,null,c,!1,!1);c.parentFlushed=!0;a=ve(g,null,a,null,c,d,vd,null,Fd);b.push(a);return g}
