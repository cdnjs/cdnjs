...
sf=Symbol.for("react.offscreen"),tf=Symbol.for("react.legacy_hidden"),uf=Symbol.for("react.cache"),vf=Symbol.for("react.default_value"),yf=Symbol.iterator,zf=Symbol.for("react.client.reference");
...
case pf:h=b.componentStack;b.componentStack=Ug(b,"Lazy");g=d._init;d=g(d._payload);b.componentStack=h;Z(a,b,null,d,e);return}if(Ta(d)){fh(a,b,d,e);return}null===d||"object"!==typeof d?h=null:(h=yf&&d[yf]||d["@@iterator"],h="function"===typeof h?h:null);if(h&&(h=h.call(d))){d=h.next();if(!d.done){g=[];do g.push(d.value),d=h.next();while(!d.done);fh(a,b,g,e)}return}if("function"===typeof d.then)return Z(a,b,null,Dg(d),e);if(d.$$typeof===jf||d.$$typeof===kf)return Z(a,b,null,d._currentValue,e);e=Object.prototype.toString.call(d);
...
Wd)):f?v(b,ee):v(b,de);d=e.toString(16);v(b,a.boundaryPrefix);v(b,d);g?v(b,$d):v(b,fe);v(b,a.segmentPrefix);v(b,d);f?g?(v(b,ae),Se(b,c)):(v(b,ge),Te(b,c)):g&&v(b,be);d=g?y(b,ce):y(b,rb);return Fc(b,a)&&d}
function rh(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return ph(a,b,d)}if(e===c.rootSegmentID)return ph(a,b,d);ph(a,b,d);c=a.resumableState;a=a.renderState;(d=0===c.streamingFormat)?(v(b,a.startInlineScript),0===(c.instructions&1)?(c.instructions|=1,v(b,od)):v(b,pd)):v(b,Td);v(b,a.segmentPrefix);e=e.toString(16);v(b,e);d?v(b,qd):v(b,Ud);v(b,a.placeholderPrefix);v(b,
...
e)}}};exports.version="18.3.0-canary-4b84f1161-20240318";
