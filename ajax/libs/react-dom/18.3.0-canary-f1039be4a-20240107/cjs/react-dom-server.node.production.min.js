...
m.resources;b.keyPath=c;try{if(Yg(a,b,A,-1),F.lastPushedText&&F.textEmbedded&&F.chunks.push(Nb),F.status=1,ah(m,F),0===m.pendingTasks&&0===m.status){m.status=1;b.componentStack=p;break a}}catch(u){F.status=4,m.status=4,h=Ug(a,b.componentStack),l=Y(a,u,h),m.errorDigest=l}finally{a.renderState.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=t,b.keyPath=r,b.componentStack=p}h=[c[0],"Suspense Fallback",c[2]];l=a.trackedPostpones;null!==l&&(p=[h[1],h[2],[],null],l.workingMap.set(h,
...
G;b.replay.pendingTasks--;h=Ug(a,b.componentStack);g=a;a=b.blockedBoundary;c=G;h=Y(g,c,h);ch(g,a,t,m,c,h)}b.replay=p}else{if(f!==mf)throw Error("Expected the resume to render <Suspense> in this slot but instead it rendered <"+(zf(f)||"Unknown")+">. The tree doesn't match so React will fallback to client rendering.");b:{p=void 0;c=r[5];f=r[2];l=r[3];m=null===r[4]?[]:r[4][2];r=null===r[4]?null:r[4][3];q=b.componentStack;var A=b.componentStack=Tg(b,"Suspense"),F=b.keyPath,u=b.replay,x=b.blockedBoundary,
...
null!==p&&(p===Vf||"function"===typeof p.then))throw p;b.replay.pendingTasks--;c=Ug(a,b.componentStack);var m=b.blockedBoundary,q=p;c=Y(a,q,c);ch(a,m,d,l,q,c)}b.replay=f;g.splice(h,1);break}}b.keyPath=e;return}f=b.treeContext;g=c.length;if(null!==b.replay&&(h=b.replay.slots,null!==h&&"object"===typeof h)){for(d=0;d<g;d++)l=c[d],b.treeContext=Qf(f,g,d),m=h[d],"number"===typeof m?(bh(a,b,m,l,d),delete h[d]):Yg(a,b,l,d);b.treeContext=f;b.keyPath=e;return}for(h=0;h<g;h++)d=c[h],b.treeContext=Qf(f,g,h),
...
e)}}};exports.version="18.3.0-canary-f1039be4a-20240107";
