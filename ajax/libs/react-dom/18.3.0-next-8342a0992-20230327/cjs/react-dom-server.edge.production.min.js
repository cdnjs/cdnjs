...
["cols","rows","size","span"].forEach(function(a){B[a]=new A(a,6,!1,a,null,!1,!1)});["rowSpan","start"].forEach(function(a){B[a]=new A(a,5,!1,a.toLowerCase(),null,!1,!1)});var la=/[\-:]([a-z])/g;function ma(a){return a[1].toUpperCase()}
...
B.xlinkHref=new A("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);B.formAction=new A("formAction",1,!1,"formaction",null,!0,!1);["src","href","action"].forEach(function(a){B[a]=new A(a,1,!1,a.toLowerCase(),null,!0,!0)});
...
function La(a,b,c,d,e,f){a=void 0===a?"":a;b=void 0===b?Da:w('<script nonce="'+C(b)+'">');var g=[],m=null,k=0;void 0!==c&&g.push(b,v((""+c).replace(Ja,Ka)),Ea);void 0!==f&&(k=1,m="string"===typeof f?{src:f,integrity:void 0}:f);if(void 0!==d)for(c=0;c<d.length;c++){f=d[c];var p="string"===typeof f?void 0:f.integrity;g.push(Fa,v(C("string"===typeof f?f:f.src)));p&&g.push(Ha,v(C(p)));g.push(Ia)}if(void 0!==e)for(d=0;d<e.length;d++)c=e[d],f="string"===typeof c?void 0:c.integrity,g.push(Ga,v(C("string"===
typeof c?c:c.src))),f&&g.push(Ha,v(C(f))),g.push(Ia);return{bootstrapChunks:g,placeholderPrefix:w(a+"P:"),segmentPrefix:w(a+"S:"),boundaryPrefix:a+"B:",idPrefix:a,nextSuspenseID:0,streamingFormat:k,startInlineScript:b,instructions:0,externalRuntimeConfig:m,htmlChunks:null,headChunks:null,hasBody:!1,charsetChunks:[],preconnectChunks:[],preloadChunks:[],hoistableChunks:[],stylesToHoist:!1}}function F(a,b,c){return{insertionMode:a,selectedValue:b,noscriptTagInScope:c}}
...
null,a.noscriptTagInScope)}return 5<=a.insertionMode?F(2,null,a.noscriptTagInScope):0===a.insertionMode?"html"===b?F(1,null,!1):F(2,null,!1):1===a.insertionMode?F(2,null,!1):a}var G=w("\x3c!-- --\x3e");function Oa(a,b,c,d){if(""===b)return d;d&&a.push(G);a.push(v(C(b)));return!0}var Pa=new Map,Qa=w(' style="'),Ra=w(":"),Sa=w(";");
function Ta(a,b){if("object"!==typeof b)throw Error("The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + 'em'}} when using JSX.");var c=!0,d;for(d in b)if(y.call(b,d)){var e=b[d];if(null!=e&&"boolean"!==typeof e&&""!==e){if(0===d.indexOf("--")){var f=v(C(d));e=v(C((""+e).trim()))}else f=Pa.get(d),void 0===f&&(f=w(C(d.replace(sa,"-$1").toLowerCase().replace(ta,"-ms-"))),Pa.set(d,f)),e="number"===typeof e?0===e||y.call(na,d)?
v(""+e):v(e+"px"):v(C((""+e).trim()));c?(c=!1,a.push(Qa,f,Ra,e)):a.push(Sa,f,Ra,e)}}c||a.push(H)}var I=w(" "),Ua=w('="'),H=w('"'),Va=w('=""');
...
!1!==c&&a.push(I,b,Ua,v(C(c)),H);break;case 5:isNaN(c)||a.push(I,b,Ua,v(C(c)),H);break;case 6:!isNaN(c)&&1<=c&&a.push(I,b,Ua,v(C(c)),H);break;default:d.sanitizeURL&&(c=""+c),a.push(I,b,Ua,v(C(c)),H)}}else if(ka(b)){switch(typeof c){case "function":case "symbol":return;case "boolean":if(d=b.toLowerCase().slice(0,5),"data-"!==d&&"aria-"!==d)return}a.push(I,v(b),Ua,v(C(c)),H)}}}var M=w(">"),Wa=w("/>");
...
function bb(a,b){a.push(P("title"));var c=null,d=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:L(a,e,f)}}a.push(M);b=Array.isArray(c)?2>c.length?c[0]:null:c;"function"!==typeof b&&"symbol"!==typeof b&&null!==b&&void 0!==b&&a.push(v(C(""+b)));N(a,d,c);a.push(Q,v("title"),R);return null}
function cb(a,b){a.push(P("script"));var c=null,d=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:L(a,e,f)}}a.push(M);N(a,d,c);"string"===typeof c&&a.push(v(C(c)));a.push(Q,v("script"),R);return null}
function db(a,b,c){a.push(P(c));var d=c=null,e;for(e in b)if(y.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:L(a,e,f)}}a.push(M);N(a,d,c);return"string"===typeof c?(a.push(v(C(c))),null):c}var eb=w("\n"),fb=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,gb=new Map;function P(a){var b=gb.get(a);if(void 0===b){if(!fb.test(a))throw Error("Invalid tag: "+a);b=w("<"+a);gb.set(a,b)}return b}var hb=w("<!DOCTYPE html>");
...
default:L(a,u,q)}null===g&&null!==d&&(g=d);a.push(M);if(null!=k){if(null!=g)throw Error("If you supply `defaultValue` on a <textarea>, do not pass children.");if(ua(k)&&1<k.length)throw Error("<textarea> can only have at most one child.");g=""+k}"string"===typeof g&&"\n"===g[0]&&a.push(eb);null!==g&&a.push(v(C(""+g)));return null;case "input":a.push(P("input"));q=k=d=g=null;for(p in c)if(y.call(c,p)&&(r=c[p],null!=r))switch(p){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");
case "defaultChecked":q=r;break;case "defaultValue":d=r;break;case "checked":k=r;break;case "value":g=r;break;default:L(a,p,r)}null!==k?L(a,"checked",k):null!==q&&L(a,"checked",q);null!==g?L(a,"value",g):null!==d&&L(a,"value",d);a.push(Wa);return null;case "menuitem":a.push(P("menuitem"));for(var D in c)if(y.call(c,D)&&(g=c[D],null!=g))switch(D){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:L(a,D,g)}a.push(M);
return null;case "title":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=bb(a,c):(bb(e.hoistableChunks,c),a=null),a;case "link":return Za(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":a:if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof c.src||!c.src)a=cb(a,c);else{p="[script]"+c.src;if(!0!==c.async||c.onLoad||c.onError){if(!0!==c.noModule&&(k=d.preloadsMap.get(p),k||(k={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"script",
href:c.src,crossOrigin:c.crossOrigin,integrity:c.integrity,referrerPolicy:c.referrerPolicy}},d.preloadsMap.set(p,k),d.usedScripts.add(k),O(k.chunks,k.props))),!0!==c.async){cb(a,c);a=null;break a}}else if(k=d.scriptsMap.get(p),!k){k={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(p,k);d.scripts.add(k);q=c;if(d=d.preloadsMap.get(p))d.state|=4,c=q=x({},c),d=d.props,null==c.crossOrigin&&(c.crossOrigin=d.crossOrigin),null==c.integrity&&(c.integrity=d.integrity);cb(k.chunks,q)}g&&a.push(G);
a=null}return a;case "style":q=c.precedence;p=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof q||"string"!==typeof p||""===p){a.push(P("style"));d=g=null;for(r in c)if(y.call(c,r)&&(k=c[r],null!=k))switch(r){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,r,k)}a.push(M);c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(v(C(""+c)));N(a,d,g);a.push(Q,v("style"),R);
a=null}else{r="[style]"+p;u=d.stylesMap.get(r);if(!u){(u=d.stylePrecedences.get(q))?u.props.hrefs.push(p):(u={type:"style",chunks:[],state:0,props:{precedence:q,hrefs:[p]}},d.stylePrecedences.set(q,u),p=new Set,p.add(u),d.precedences.set(q,p));d.stylesMap.set(r,u);d.boundaryResources&&d.boundaryResources.add(u);d=u.chunks;p=q=null;for(k in c)if(y.call(c,k)&&(r=c[k],null!=r))switch(k){case "children":q=r;break;case "dangerouslySetInnerHTML":p=r}c=Array.isArray(q)?2>q.length?q[0]:null:q;"function"!==
typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&d.push(v(C(""+c)));N(d,p,q)}g&&a.push(G);a=void 0}return a;case "meta":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=ab(a,c,"meta"):(g&&a.push(G),a="string"===typeof c.charSet?ab(e.charsetChunks,c,"meta"):ab(e.hoistableChunks,c,"meta")),a;case "listing":case "pre":a.push(P(b));d=g=null;for(var J in c)if(y.call(c,J)&&(k=c[J],null!=k))switch(J){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,J,
k)}a.push(M);if(null!=d){if(null!=g)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");if("object"!==typeof d||!("__html"in d))throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");c=d.__html;null!==c&&void 0!==c&&("string"===typeof c&&0<c.length&&"\n"===c[0]?a.push(eb,v(c)):a.push(v(""+c)))}"string"===typeof g&&"\n"===g[0]&&a.push(eb);return g;case "base":case "area":case "br":case "col":case "embed":case "hr":case "img":case "keygen":case "param":case "source":case "track":case "wbr":return ab(a,
...
var xc=w('<style media="not all" data-precedence="'),yc=w('" data-href="'),zc=w('">'),Ac=w("</style>"),Bc=!1,Cc=!0;function Dc(a){if("stylesheet"===a.type&&0===(a.state&1))Bc=!0;else if("style"===a.type){var b=a.chunks,c=a.props.hrefs,d=0;if(b.length){n(this,xc);n(this,v(C(a.props.precedence)));if(c.length){for(n(this,yc);d<c.length-1;d++)n(this,v(C(c[d]))),n(this,Ec);n(this,v(C(c[d])))}n(this,zc);for(d=0;d<b.length;d++)n(this,b[d]);Cc=t(this,Ac);Bc=!0;b.length=0;c.length=0}}}
...
var Jc=w('<style data-precedence="'),Kc=w('" data-href="'),Ec=w(" "),Lc=w('">'),Mc=w("</style>");function Nc(a,b){Hc=!1;a.forEach(Ic,this);a.clear();a=Gc.chunks;var c=Gc.props.hrefs;if(!1===Hc||a.length){n(this,Jc);n(this,v(C(b)));b=0;if(c.length){for(n(this,Kc);b<c.length-1;b++)n(this,v(C(c[b]))),n(this,Ec);n(this,v(C(c[b])))}n(this,Lc);for(b=0;b<a.length;b++)n(this,a[b]);n(this,Mc);a.length=0;c.length=0}}
...
2}});n(a,Wc)}
function Yc(a,b){n(a,Tc);var c=Tc;b.forEach(function(d){if("style"!==d.type&&!(d.state&1))if(d.state&3)n(a,c),n(a,v(C(JSON.stringify(""+d.props.href)))),n(a,Wc),c=Uc;else if("stylesheet"===d.type){n(a,c);var e=d.props["data-precedence"],f=d.props;n(a,v(C(JSON.stringify(""+d.props.href))));e=""+e;n(a,Vc);n(a,v(C(JSON.stringify(e))));for(var g in f)if(y.call(f,g)){var m=f[g];if(null!=m)switch(g){case "href":case "rel":case "precedence":case "data-precedence":break;case "children":case "dangerouslySetInnerHTML":throw Error("link is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");default:a:{e=
a;var k=g.toLowerCase();switch(typeof m){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":k="class";break;case "hidden":if(!1===m)break a;break;case "src":case "href":break;default:if(!ka(g))break a}if(!(2<g.length)||"o"!==g[0]&&"O"!==g[0]||"n"!==g[1]&&"N"!==g[1])m=""+m,n(e,Vc),n(e,v(C(JSON.stringify(k)))),n(e,Vc),n(e,v(C(JSON.stringify(m))))}}}n(a,
...
function ge(a,b,c){if(25<=Yd)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===V)if(Vd=!0,a={action:c,next:null},null===Y&&(Y=new Map),c=Y.get(b),void 0===c)Y.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function ie(){throw Error("startTransition cannot be called during server rendering.");}function je(a){var b=Xd;Xd+=1;null===X&&(X=[]);return Nd(X,a,b)}
function ke(){throw Error("Cache cannot be refreshed during server rendering.");}function le(){}
var ne={readContext:function(a){return a._currentValue},useContext:function(a){Zd();return a._currentValue},useMemo:he,useReducer:fe,useRef:function(a){V=Zd();W=ae();var b=W.memoizedState;return null===b?(a={current:a},W.memoizedState=a):b},useState:function(a){return fe(ee,a)},useInsertionEffect:le,useLayoutEffect:le,useCallback:function(a,b){return he(function(){return a},b)},useImperativeHandle:le,useEffect:le,useDebugValue:le,useDeferredValue:function(a){Zd();return a},useTransition:function(){Zd();
return[!1,ie]},useId:function(){var a=Sd.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Hd(a)-1)).toString(32)+b;var c=me;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=Wd++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b){Zd();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");
return c()},useCacheRefresh:function(){return ke},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return je(a);if(a.$$typeof===fd||a.$$typeof===gd)return a._currentValue}throw Error("An unsupported type was passed to use(): "+String(a));}},me=null,oe={getCacheSignal:function(){throw Error("Not implemented.");},getCacheForType:function(){throw Error("Not implemented.");}},pe=ud.ReactCurrentDispatcher,qe=ud.ReactCurrentCache;
function re(a){console.error(a);return null}function se(){}
...
function Z(a,b,c,d){b.node=d;if("object"===typeof d&&null!==d){switch(d.$$typeof){case $c:Ce(a,b,c,d.type,d.props,d.ref);return;case ad:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");case ld:c=d._init;d=c(d._payload);Z(a,b,null,d);return}if(ua(d)){Fe(a,b,d);return}null===d||"object"!==typeof d?c=null:(c=sd&&d[sd]||d["@@iterator"],c="function"===typeof c?c:null);if(c&&(c=c.call(d))){d=c.next();if(!d.done){var e=
[];do e.push(d.value),d=c.next();while(!d.done);Fe(a,b,e)}return}if("function"===typeof d.then)return Z(a,b,null,je(d));if(d.$$typeof===fd||d.$$typeof===gd)return Z(a,b,null,d._currentValue);a=Object.prototype.toString.call(d);throw Error("Objects are not valid as a React child (found: "+("[object Object]"===a?"object with keys {"+Object.keys(d).join(", ")+"}":a)+"). If you meant to render a collection of children, use an array instead.");}"string"===typeof d?(c=b.blockedSegment,c.lastPushedText=
Oa(b.blockedSegment.chunks,d,a.responseState,c.lastPushedText)):"number"===typeof d&&(c=b.blockedSegment,c.lastPushedText=Oa(b.blockedSegment.chunks,""+d,a.responseState,c.lastPushedText))}function Fe(a,b,c){for(var d=c.length,e=0;e<d;e++){var f=b.treeContext;b.treeContext=Gd(f,d,e);try{De(a,b,c[e])}finally{b.treeContext=f}}}
function De(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,f=b.context;try{return Z(a,b,null,c)}catch(p){if(ce(),c=p===Ld?Pd():p,"object"===typeof c&&null!==c&&"function"===typeof c.then){var g=de(),m=b.blockedSegment,k=ue(a,m.chunks.length,null,m.formatContext,m.lastPushedText,!0);m.children.push(k);m.lastPushedText=!1;a=ve(a,g,b.node,b.blockedBoundary,k,b.abortSet,b.legacyContext,b.context,b.treeContext).ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=
...
function xe(a){if(2!==a.status){var b=U,c=pe.current;pe.current=ne;var d=qe.current;qe.current=oe;var e=a.resources;Ba.push(E);E=e;e=va.current;va.current=Aa;var f=me;me=a.responseState;try{var g=a.pingedTasks,m;for(m=0;m<g.length;m++){var k=g[m];var p=a,r=k.blockedBoundary;p.resources.boundaryResources=r?r.resources:null;var q=k.blockedSegment;if(0===q.status){Cd(k.context);try{var u=k.thenableState;k.thenableState=null;Z(p,k,u,k.node);q.lastPushedText&&q.textEmbedded&&q.chunks.push(G);k.abortSet.delete(k);
q.status=1;He(p,k.blockedBoundary,q)}catch(pa){ce();var D=pa===Ld?Pd():pa;if("object"===typeof D&&null!==D&&"function"===typeof D.then){var J=k.ping;D.then(J,J);k.thenableState=de()}else{k.abortSet.delete(k);q.status=4;var z=p,K=k.blockedBoundary,qa=D,ia=ye(z,qa);null===K?ze(z,qa):(K.pendingTasks--,K.forceClientRender||(K.forceClientRender=!0,K.errorDigest=ia,K.parentFlushed&&z.clientRenderedBoundaries.push(K)));z.allPendingTasks--;if(0===z.allPendingTasks){var Qe=z.onAllReady;Qe()}}}finally{p.resources.boundaryResources=
null}}}g.splice(0,m);null!==a.destination&&Je(a,a.destination)}catch(pa){ye(a,pa),ze(a,pa)}finally{me=f,pe.current=c,qe.current=d,E=Ba.pop(),va.current=e,c===ne&&Cd(b)}}}
function Ke(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;n(b,jb);n(b,a.placeholderPrefix);a=v(d.toString(16));n(b,a);return t(b,kb);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)n(b,d[f]);e=Le(a,b,e)}for(;f<d.length-1;f++)n(b,d[f]);f<d.length&&(e=t(b,d[f]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function Le(a,b,c){var d=c.boundary;if(null===d)return Ke(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,t(b,ob),n(b,qb),d&&(n(b,sb),n(b,v(C(d))),n(b,rb)),t(b,tb),Ke(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=w(e.boundaryPrefix+f.toString(16));d=d.id=e;ub(b,a.responseState,d);Ke(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),
ub(b,a.responseState,d.id),Ke(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(Zc,c);t(b,lb);c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");Le(a,b,c[0])}return t(b,pb)}function Me(a,b,c){Qb(b,a.responseState,c.formatContext,c.id);Le(a,b,c);return Rb(b,c.formatContext)}
...
function Oe(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return Me(a,b,d)}Me(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(n(b,a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,n(b,Sb)):n(b,Tb)):n(b,Wb);n(b,a.segmentPrefix);e=v(e.toString(16));n(b,e);c?n(b,Ub):n(b,Xb);n(b,a.placeholderPrefix);n(b,e);b=c?t(b,Vb):t(b,Ca);return b}
function Je(a,b){h=new Uint8Array(512);l=0;try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){Qc(b,a.resources,a.responseState,0===a.allPendingTasks);Le(a,b,d);a.completedRootSegment=null;var e=a.responseState.bootstrapChunks;for(d=0;d<e.length-1;d++)n(b,e[d]);d<e.length&&t(b,e[d])}else return;else Sc(b,a.resources,a.responseState);var f=a.clientRenderedBoundaries;for(c=0;c<f.length;c++){var g=f[c];e=b;var m=a.responseState,k=g.id,p=g.errorDigest,r=g.errorMessage,q=g.errorComponentStack,
u=0===m.streamingFormat;u?(n(e,m.startInlineScript),0===(m.instructions&4)?(m.instructions|=4,n(e,kc)):n(e,lc)):n(e,pc);if(null===k)throw Error("An ID must have been assigned before we can complete the boundary.");n(e,k);u&&n(e,mc);if(p||r||q)u?(n(e,nc),n(e,v(uc(p||"")))):(n(e,qc),n(e,v(C(p||""))));if(r||q)u?(n(e,nc),n(e,v(uc(r||"")))):(n(e,rc),n(e,v(C(r||""))));q&&(u?(n(e,nc),n(e,v(uc(q)))):(n(e,sc),n(e,v(C(q)))));if(u?!t(e,oc):!t(e,Ca)){a.destination=null;c++;f.splice(0,c);return}}f.splice(0,c);
var D=a.completedBoundaries;for(c=0;c<D.length;c++)if(!Ne(a,b,D[c])){a.destination=null;c++;D.splice(0,c);return}D.splice(0,c);ca(b);h=new Uint8Array(512);l=0;var J=a.partialBoundaries;for(c=0;c<J.length;c++){var z=J[c];a:{f=a;g=b;f.resources.boundaryResources=z.resources;var K=z.completedSegments;for(m=0;m<K.length;m++)if(!Oe(f,g,z,K[m])){m++;K.splice(0,m);var qa=!1;break a}K.splice(0,m);qa=Fc(g,z.resources,f.responseState)}if(!qa){a.destination=null;c++;J.splice(0,c);return}}J.splice(0,c);var ia=
a.completedBoundaries;for(c=0;c<ia.length;c++)if(!Ne(a,b,ia[c])){a.destination=null;c++;ia.splice(0,c);return}ia.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length?(a=a.responseState,a.hasBody&&(n(b,Q),n(b,v("body")),n(b,R)),a.htmlChunks&&(n(b,Q),n(b,v("html")),n(b,R)),ca(b),b.close()):ca(b)}}function Pe(a){setTimeout(function(){return xe(a)},0)}
...
exports.renderToReadableStream=function(a,b){return new Promise(function(c,d){var e,f,g=new Promise(function(r,q){f=r;e=q}),m=te(a,La(b?b.identifierPrefix:void 0,b?b.nonce:void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0,b?b.unstable_externalRuntimeSrc:void 0),Ma(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:void 0,b?b.onError:void 0,f,function(){var r=new ReadableStream({type:"bytes",pull:function(q){if(1===m.status)m.status=2,ea(q,m.fatalError);
else if(2!==m.status&&null===m.destination){m.destination=q;try{Je(m,q)}catch(u){ye(m,u),ze(m,u)}}},cancel:function(){Re(m)}},{highWaterMark:0});r.allReady=g;c(r)},function(r){g.catch(function(){});d(r)},e);if(b&&b.signal){var k=b.signal;if(k.aborted)Re(m,k.reason);else{var p=function(){Re(m,k.reason);k.removeEventListener("abort",p)};k.addEventListener("abort",p)}}Pe(m)})};exports.version="18.3.0-next-8342a0992-20230327";
