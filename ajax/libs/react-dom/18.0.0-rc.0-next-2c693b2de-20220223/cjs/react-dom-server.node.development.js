...
var ReactVersion = '18.0.0-rc.0-2c693b2de-20220223';
...
function makeId(responseState, treeId, localId) {
  ...
  var id = idPrefix + treeId; // Unless this is the first id at this level, append a number at the end
...
function writeCompletedRoot(destination, responseState) {
  ...
  for (var i = 0; i < bootstrapChunks.length; i++) {
...
function createRequest(children, responseState, rootFormatContext, progressiveChunkSize, onError, onCompleteAll, onCompleteShell, onErrorShell) {
  var pingedTasks = [];
  ...
  var request = {
    ...
    onErrorShell: onErrorShell === undefined ? noop$1 : onErrorShell
...
function createRequestImpl(children, options) {
  return createRequest(children, createResponseState(options ? options.identifierPrefix : undefined, options ? options.nonce : undefined, options ? options.bootstrapScriptContent : undefined, options ? options.bootstrapScripts : undefined, options ? options.bootstrapModules : undefined), createRootFormatContext(options ? options.namespaceURI : undefined), options ? options.progressiveChunkSize : undefined, options ? options.onError : undefined, options ? options.onCompleteAll : undefined, options ? options.onCompleteShell : undefined, options ? options.onErrorShell : undefined);
}
