...
b);e&&a.push("\x3c!-- --\x3e");switch(b.rel){case "preconnect":case "dns-prefetch":return D(c.preconnectChunks,b);case "preload":return D(c.preloadChunks,b);default:return D(c.hoistableChunks,b)}}function D(a,b){a.push(E("link"));for(var c in b)if(r.call(b,c)){var d=b[c];if(null!=d)switch(c){case "children":case "dangerouslySetInnerHTML":throw Error("link is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");default:A(a,c,d)}}a.push("/>");return null}
...
a=null}return a;case "style":m=c.precedence;l=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof m||"string"!==typeof l||""===l){a.push(E("style"));d=g=null;for(n in c)if(r.call(c,n)&&(h=c[n],null!=h))switch(n){case "children":g=h;break;case "dangerouslySetInnerHTML":d=h;break;default:A(a,n,h)}a.push(">");c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(w(""+c));B(a,d,g);a.push("</","style",">");
...
null===e.htmlChunks?(e.htmlChunks=["<!DOCTYPE html>"],a=I(e.htmlChunks,c,"html")):a=I(a,c,"html"),a;default:if(-1===b.indexOf("-")&&"string"!==typeof c.is)return I(a,c,b);a.push(E(b));d=g=null;for(var z in c)if(r.call(c,z)&&(h=c[z],null!=h))switch(z){case "children":g=h;break;case "dangerouslySetInnerHTML":d=h;break;case "style":Da(a,h);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:t(z)&&"function"!==typeof h&&"symbol"!==typeof h&&a.push(" ",z,'="',w(h),
'"')}a.push(">");B(a,d,g);return g}}function Na(a,b,c){a.push('\x3c!--$?--\x3e<template id="');if(null===c)throw Error("An ID must have been assigned before we can complete the boundary.");a.push(c);return a.push('"></template>')}
...
e.push(g)}}a.push("]");c=",[";d.state|=2}});a.push("]")}function ra(a){if(x){var b=x;if("string"===typeof a&&a){var c="[prefetchDNS]"+a,d=b.preconnectsMap.get(c);d||(d={type:"preconnect",chunks:[],state:0,props:null},b.preconnectsMap.set(c,d),D(d.chunks,{href:a,rel:"dns-prefetch"}));b.preconnects.add(d)}}}
...
function qc(a,b,c){if(25<=ic)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===N)if(hc=!0,a={action:c,next:null},null===U&&(U=new Map),c=U.get(b),void 0===c)U.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function sc(){throw Error("startTransition cannot be called during server rendering.");}function tc(a){var b=R;R+=1;null===S&&(S=[]);return ac(S,a,b)}
function uc(){throw Error("Cache cannot be refreshed during server rendering.");}function vc(){}
var xc={readContext:function(a){return a._currentValue2},useContext:function(a){V();return a._currentValue2},useMemo:rc,useReducer:pc,useRef:function(a){N=V();O=kc();var b=O.memoizedState;return null===b?(a={current:a},O.memoizedState=a):b},useState:function(a){return pc(oc,a)},useInsertionEffect:vc,useLayoutEffect:function(){},useCallback:function(a,b){return rc(function(){return a},b)},useImperativeHandle:vc,useEffect:vc,useDebugValue:vc,useDeferredValue:function(a){V();return a},useTransition:function(){V();
return[!1,sc]},useId:function(){var a=fc.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Ub(a)-1)).toString(32)+b;var c=wc;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=Q++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b){V();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");
return c()},useCacheRefresh:function(){return uc},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return tc(a);if(a.$$typeof===sb||a.$$typeof===tb)return a._currentValue2}throw Error("An unsupported type was passed to use(): "+String(a));}},wc=null,yc={getCacheSignal:function(){throw Error("Not implemented.");},getCacheForType:function(){throw Error("Not implemented.");}},zc=Hb.ReactCurrentDispatcher,Ac=Hb.ReactCurrentCache;
...
b,null,e);return;case xb:d=d.type;e=Hc(d,e);Ic(a,b,c,d,e,f);return;case rb:c=e.children;d=d._context;e=e.value;f=d._currentValue2;d._currentValue2=e;g=M;M=e={parent:g,depth:null===g?0:g.depth+1,context:d,parentValue:f,value:e};b.context=e;Z(a,b,null,c);a=M;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");e=a.parentValue;a.context._currentValue2=e===Eb?a.context._defaultValue:e;a=M=a.parent;b.context=a;return;case sb:e=e.children;e=e(d._currentValue2);
Z(a,b,null,e);return;case yb:f=d._init;d=f(d._payload);e=Hc(d,e);Ic(a,b,c,d,e,void 0);return}throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: "+((null==d?d:typeof d)+"."));}}
function Z(a,b,c,d){b.node=d;if("object"===typeof d&&null!==d){switch(d.$$typeof){case mb:Ic(a,b,c,d.type,d.props,d.ref);return;case nb:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");case yb:c=d._init;d=c(d._payload);Z(a,b,null,d);return}if(pa(d)){Lc(a,b,d);return}null===d||"object"!==typeof d?c=null:(c=Fb&&d[Fb]||d["@@iterator"],c="function"===typeof c?c:null);if(c&&(c=c.call(d))){d=c.next();if(!d.done){var e=
[];do e.push(d.value),d=c.next();while(!d.done);Lc(a,b,e)}return}if("function"===typeof d.then)return Z(a,b,null,tc(d));if(d.$$typeof===sb||d.$$typeof===tb)return Z(a,b,null,d._currentValue2);a=Object.prototype.toString.call(d);throw Error("Objects are not valid as a React child (found: "+("[object Object]"===a?"object with keys {"+Object.keys(d).join(", ")+"}":a)+"). If you meant to render a collection of children, use an array instead.");}"string"===typeof d?(c=b.blockedSegment,c.lastPushedText=
lb(b.blockedSegment.chunks,d,a.responseState,c.lastPushedText)):"number"===typeof d&&(c=b.blockedSegment,c.lastPushedText=lb(b.blockedSegment.chunks,""+d,a.responseState,c.lastPushedText))}function Lc(a,b,c){for(var d=c.length,e=0;e<d;e++){var f=b.treeContext;b.treeContext=Tb(f,d,e);try{Jc(a,b,c[e])}finally{b.treeContext=f}}}
...
z.onAllReady;T()}}}finally{l.resources.boundaryResources=null}}}g.splice(0,k);null!==a.destination&&Pc(a,a.destination)}catch(F){X(a,F),Y(a,F)}finally{wc=f,zc.current=c,Ac.current=d,x=Aa.pop(),qa.current=e,c===xc&&Pb(b)}}}
...
function Rc(a,b,c){var d=c.boundary;if(null===d)return Qc(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||(d=d.errorDigest,b.push("\x3c!--$!--\x3e"),b.push("<template"),d&&(b.push(' data-dgst="'),d=w(d),b.push(d),b.push('"')),b.push("></template>")),Qc(a,b,c),a=a.responseState.generateStaticMarkup?!0:b.push("\x3c!--/$--\x3e"),a;if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=
e.nextSuspenseID++;e=e.boundaryPrefix+f.toString(16);d=d.id=e;Na(b,a.responseState,d);Qc(a,b,c);return b.push("\x3c!--/$--\x3e")}if(d.byteSize>a.progressiveChunkSize)return d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Na(b,a.responseState,d.id),Qc(a,b,c),b.push("\x3c!--/$--\x3e");(c=a.resources.boundaryResources)&&d.resources.forEach(ib,c);a.responseState.generateStaticMarkup||b.push("\x3c!--$--\x3e");c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");
Rc(a,b,c[0]);a=a.responseState.generateStaticMarkup?!0:b.push("\x3c!--/$--\x3e");return a}function Sc(a,b,c){Oa(b,a.responseState,c.formatContext,c.id);Rc(a,b,c);return Pa(b,c.formatContext)}
...
function Pc(a,b){try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){db(b,a.resources,a.responseState,0===a.allPendingTasks);Rc(a,b,d);a.completedRootSegment=null;var e=a.responseState.bootstrapChunks;for(d=0;d<e.length-1;d++)b.push(e[d]);d<e.length&&b.push(e[d])}else return;else fb(b,a.resources,a.responseState);var f=a.clientRenderedBoundaries;for(c=0;c<f.length;c++){var g=f[c];e=b;var k=a.responseState,h=g.id,l=g.errorDigest,n=g.errorMessage,m=g.errorComponentStack,q=0===
...
function bd(a,b){var c=new $c,d=Cc(a,jb(!1,b?b.identifierPrefix:void 0),kb(),Infinity,ad,function(){c.startedFlowing=!0;Vc(d,c)},void 0,void 0);c.request=d;Fc(d);return c}exports.renderToNodeStream=function(a,b){return bd(a,b)};exports.renderToStaticMarkup=function(a,b){return Yc(a,b,!0,'The server used "renderToStaticMarkup" which does not support Suspense. If you intended to have the server wait for the suspended component please switch to "renderToPipeableStream" which supports Suspense on the server')};
