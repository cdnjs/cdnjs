...
*/
'use strict';var aa=require("scheduler"),ca=require("react"),da={usingClientEntryPoint:!1,Events:null,Dispatcher:{current:null}};function q(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
var Un={findFiberByHostInstance:pa,bundleType:0,version:"18.3.0-next-9fb2469a6-20230308",rendererPackageName:"react-dom"};
