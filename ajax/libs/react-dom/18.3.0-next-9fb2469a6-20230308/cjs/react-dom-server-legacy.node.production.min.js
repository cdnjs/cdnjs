...
null===e.htmlChunks?(e.htmlChunks=["<!DOCTYPE html>"],a=I(e.htmlChunks,c,"html")):a=I(a,c,"html"),a;default:if(-1===b.indexOf("-")&&"string"!==typeof c.is)return I(a,c,b);a.push(E(b));d=g=null;for(var y in c)if(r.call(c,y)&&(h=c[y],null!=h))switch(y){case "children":g=h;break;case "dangerouslySetInnerHTML":d=h;break;case "style":Da(a,h);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:t(y)&&"function"!==typeof h&&"symbol"!==typeof h&&a.push(" ",y,'="',w(h),
