...
return null;case "title":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=cb(a,c):(cb(e.hoistableChunks,c),a=null),a;case "link":return $a(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":a:if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof c.src||!c.src)a=db(a,c);else{n="[script]"+c.src;if(!0!==c.async||c.onLoad||c.onError){if(k=d.preloadsMap.get(n),k||(k={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"script",href:c.src,
crossOrigin:c.crossOrigin,integrity:c.integrity,referrerPolicy:c.referrerPolicy}},d.preloadsMap.set(n,k),d.usedScripts.add(k),O(k.chunks,k.props)),!0!==c.async){db(a,c);a=null;break a}}else if(k=d.scriptsMap.get(n),!k){k={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(n,k);d.scripts.add(k);p=c;if(d=d.preloadsMap.get(n))d.state|=4,c=p=x({},c),d=d.props,null==c.crossOrigin&&(c.crossOrigin=d.crossOrigin),null==c.integrity&&(c.integrity=d.integrity);db(k.chunks,p)}g&&a.push(G);a=null}return a;
case "style":p=c.precedence;n=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof p||"string"!==typeof n||""===n){a.push(P("style"));d=g=null;for(r in c)if(y.call(c,r)&&(k=c[r],null!=k))switch(r){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,r,k)}a.push(M);c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(C(""+c));N(a,d,g);a.push(Q,"style",R);a=null}else{r="[style]"+
n;t=d.stylesMap.get(r);if(!t){(t=d.stylePrecedences.get(p))?t.props.hrefs.push(n):(t={type:"style",chunks:[],state:0,props:{precedence:p,hrefs:[n]}},d.stylePrecedences.set(p,t),n=new Set,n.add(t),d.precedences.set(p,n));d.stylesMap.set(r,t);d.boundaryResources&&d.boundaryResources.add(t);d=t.chunks;n=p=null;for(k in c)if(y.call(c,k)&&(r=c[k],null!=r))switch(k){case "children":p=r;break;case "dangerouslySetInnerHTML":n=r}c=Array.isArray(p)?2>p.length?p[0]:null:p;"function"!==typeof c&&"symbol"!==typeof c&&
