...
var nb=null,ob=null,pb;for(pb in c)if(D.call(c,pb)){var Qb=c[pb];if(null!=Qb)switch(pb){case "children":nb=Qb;break;case "dangerouslySetInnerHTML":ob=Qb;break;default:P(a,pb,Qb)}}a.push(R);if(null!=ob){if(null!=nb)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");if("object"!==typeof ob||!("__html"in ob))throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://react.dev/link/dangerously-set-inner-html for more information.");
...
e)}}};exports.version="18.3.0-canary-034130c02-20240303";
