...
exports.renderToPipeableStream=function(a,b){var c=Tc(a,b),d=!1;Oc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Pc(c,a);a.on("drain",Rc(a,c));a.on("close",Sc(c));return a},abort:function(){Qc(c)}}};exports.version="18.0.0-rc.3-de516ca5a-20220321";
