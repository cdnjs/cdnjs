...
function lb(){throw Error(n(394));}function T(){}
var mb={readContext:function(a){return a._currentValue2},useContext:function(a){S();return a._currentValue2},useMemo:kb,useReducer:ib,useRef:function(a){L=S();N=fb();var b=N.memoizedState;return null===b?(a={current:a},N.memoizedState=a):b},useState:function(a){return ib(hb,a)},useInsertionEffect:T,useLayoutEffect:function(){},useCallback:function(a,b){return kb(function(){return a},b)},useImperativeHandle:T,useEffect:T,useDebugValue:T,useDeferredValue:function(a){S();return a},useTransition:function(){S();
return[!1,lb]},useOpaqueIdentifier:function(){var a=U;if(null===a)throw Error(n(404));return a.opaqueIdentifierPrefix+(a.nextOpaqueID++).toString(36)},useMutableSource:function(a,b){S();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error(n(407));return c()}},U=null,nb=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function ob(a){console.error(a)}function pb(){}
function qb(a,b,c,d,e,g,f,k){var l=[],m=new Set;b={destination:b,responseState:c,progressiveChunkSize:void 0===e?12800:e,status:0,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:m,pingedTasks:l,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===g?ob:g,onCompleteAll:void 0===f?pb:f,onReadyToStream:void 0===k?pb:k};d=V(b,0,null,d);d.parentFlushed=!0;a=rb(b,a,null,d,m,Va,null,null);l.push(a);return b}
...
function Z(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,g=b.context;try{return Y(a,b,c)}catch(l){if(gb(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var f=b.blockedSegment,k=V(a,f.chunks.length,null,f.formatContext);f.children.push(k);a=rb(a,b.node,b.blockedBoundary,k,b.abortSet,b.legacyContext,b.context,b.assignID);b.assignID=null;a=a.ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=g;K(g)}else throw b.blockedSegment.formatContext=
d,b.legacyContext=e,b.context=g,K(g),l;}}function xb(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;yb(this,b,a)}
function zb(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,this.destination.push(null))):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(zb,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onCompleteAll,a()))}
function yb(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(b=a.onReadyToStream,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(xb,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=b.completedSegments;
d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function sb(a){if(2!==a.status){var b=I,c=nb.current;nb.current=mb;var d=U;U=a.responseState;try{var e=a.pingedTasks,g;for(g=0;g<e.length;g++){var f=e[g];var k=a,l=f.blockedSegment;if(0===l.status){K(f.context);try{Y(k,f,f.node),f.abortSet.delete(f),l.status=1,yb(k,f.blockedBoundary,l)}catch(t){if(gb(),"object"===typeof t&&null!==t&&"function"===typeof t.then){var m=f.ping;t.then(m,m)}else{f.abortSet.delete(f);l.status=4;var p=f.blockedBoundary,r=t;W(k,r);null===p?X(k,r):(p.pendingTasks--,p.forceClientRender||
(p.forceClientRender=!0,p.parentFlushed&&k.clientRenderedBoundaries.push(p)));k.allPendingTasks--;if(0===k.allPendingTasks){var E=k.onCompleteAll;E()}}}finally{}}}e.splice(0,g);1===a.status&&Ab(a)}catch(t){W(a,t),X(a,t)}finally{U=d,nb.current=c,c===mb&&K(b)}}}
function Bb(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;q(b,'<template id="');q(b,a.placeholderPrefix);a=d.toString(16);q(b,a);return q(b,'"></template>');case 1:c.status=2;var e=!0;d=c.chunks;var g=0;c=c.children;for(var f=0;f<c.length;f++){for(e=c[f];g<e.index;g++)q(b,d[g]);e=Cb(a,b,e)}for(;g<d.length;g++)e=q(b,d[g]);return e;default:throw Error(n(390));}}
function Cb(a,b,c){var d=c.boundary;if(null===d)return Bb(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||q(b,"\x3c!--$!--\x3e"),Bb(a,b,c),a=a.responseState.generateStaticMarkup?!0:q(b,"\x3c!--/$--\x3e"),a;if(0<d.pendingTasks)return d.rootSegmentID=a.nextSegmentId++,0<d.completedSegments.length&&a.partialBoundaries.push(d),q(b,"\x3c!--$?--\x3e"),Bb(a,b,c),q(b,"\x3c!--/$--\x3e");if(d.byteSize>a.progressiveChunkSize)return d.rootSegmentID=a.nextSegmentId++,
a.completedBoundaries.push(d),q(b,"\x3c!--$?--\x3e"),Bb(a,b,c),q(b,"\x3c!--/$--\x3e");a.responseState.generateStaticMarkup||q(b,"\x3c!--$--\x3e");c=d.completedSegments;if(1!==c.length)throw Error(n(391));Cb(a,b,c[0]);a=a.responseState.generateStaticMarkup?!0:q(b,"\x3c!--/$--\x3e");return a}function Db(a,b,c){Aa(b,a.responseState,c.formatContext,c.id);Cb(a,b,c);return Ba(b,c.formatContext)}
...
a.completedBoundaries;for(e=0;e<t.length;e++)if(!Eb(a,b,t[e])){a.status=0;e++;t.splice(0,e);return}t.splice(0,e)}finally{Gb=!1,0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.push(null)}}}function Hb(a){if(2!==a.status){a.status=1;try{Ab(a)}catch(b){W(a,b),X(a,b)}}}function Ib(a){try{var b=a.abortableTasks;b.forEach(zb,a);b.clear();1===a.status&&Ab(a)}catch(c){W(a,c),X(a,c)}}function Jb(){}
function Kb(a,b,c){var d=!1,e=null,g="",f=!1;a=qb(a,{push:function(a){null!==a&&(g+=a);return!0},destroy:function(a){d=!0;e=a}},Ca(c,b?b.identifierPrefix:void 0),Da(),Infinity,Jb,void 0,function(){f=!0});sb(a);Ib(a);Hb(a);if(d)throw e;if(!f)throw Error(n(342));return g}
var Lb=function(a){function b(){var b=a.call(this,{})||this;b.request=null;b.startedFlowing=!1;return b}ca(b,a);var c=b.prototype;c._destroy=function(a,b){Ib(this.request);b(a)};c._read=function(){this.startedFlowing&&Hb(this.request)};return b}(ba.Readable);function Mb(){}function Nb(a,b){var c=new Lb,d=qb(a,c,Ca(!1,b?b.identifierPrefix:void 0),Da(),Infinity,Mb,function(){c.startedFlowing=!0;Hb(d)},void 0);c.request=d;sb(d);return c}exports.renderToNodeStream=function(a,b){return Nb(a,b)};
exports.renderToStaticMarkup=function(a,b){return Kb(a,b,!0)};exports.renderToStaticNodeStream=function(a,b){return Nb(a,b)};exports.renderToString=function(a,b){return Kb(a,b,!1)};exports.version="18.0.0-d174d063d-20210922";
