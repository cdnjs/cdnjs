...
(function (global, factory) {
  ...
  function renderHostElement(request, task, type, props) {
    ...
    var children = pushStartInstance(segment.chunks, type, props, request.resumableState, request.renderState, segment.formatContext, segment.lastPushedText);
  ...
  function flushSegment(request, destination, segment) {
    ...
    if (boundary.forceClientRender) {
      ...
      var id = boundary.id = assignSuspenseBoundaryID(request.renderState, request.resumableState);
  ...
  function flushSegmentContainer(request, destination, segment) {
    writeStartSegment(destination, request.renderState, segment.formatContext, segment.id);
