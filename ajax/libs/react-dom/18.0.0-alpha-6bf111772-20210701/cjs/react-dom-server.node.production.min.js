...
function N(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;switch(a){case Db:return"Fragment";case Cb:return"Portal";case Fb:return"Profiler";case Eb:return"StrictMode";case Jb:return"Suspense";case Kb:return"SuspenseList";case Pb:return"Cache"}if("object"===typeof a)switch(a.$$typeof){case Hb:return(a.displayName||"Context")+".Consumer";case Gb:return(a._context.displayName||"Context")+".Provider";case Ib:var b=a.render;a=a.displayName;
a||(a=b.displayName||b.name||"",a=""!==a?"ForwardRef("+a+")":"ForwardRef");return a;case Lb:return b=a.displayName||null,null!==b?b:N(a.type)||"Memo";case L:b=a._payload;a=a._init;try{return N(a(b))}catch(c){}}return null}var Rb={};function Sb(a,b){a=a.contextTypes;if(!a)return Rb;var c={},d;for(d in a)c[d]=b[d];return c}var O=null;
function P(a,b){if(a!==b){a.context._currentValue=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Error(n(401));}else{if(null===c)throw Error(n(401));P(a,c);b.context._currentValue=b.value}}}function Tb(a){a.context._currentValue=a.parentValue;a=a.parent;null!==a&&Tb(a)}function Ub(a){var b=a.parent;null!==b&&Ub(b);a.context._currentValue=a.value}
function Vb(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error(n(402));a.depth===b.depth?P(a,b):Vb(a,b)}function Wb(a,b){var c=b.parent;if(null===c)throw Error(n(402));a.depth===c.depth?P(a,c):Wb(a,c);b.context._currentValue=b.value}function Q(a){var b=O;b!==a&&(null===b?Ub(a):null===a?Tb(b):b.depth===a.depth?P(b,a):b.depth>a.depth?Vb(b,a):Wb(b,a),O=a)}
var Xb={isMounted:function(){return!1},enqueueSetState:function(a,b){a=a._reactInternals;null!==a.queue&&a.queue.push(b)},enqueueReplaceState:function(a,b){a=a._reactInternals;a.replace=!0;a.queue=[b]},enqueueForceUpdate:function(){}};
function Yb(a,b,c,d){var e=void 0!==a.state?a.state:null;a.updater=Xb;a.props=c;a.state=e;var g={queue:[],replace:!1};a._reactInternals=g;var f=b.contextType;a.context="object"===typeof f&&null!==f?f._currentValue:d;f=b.getDerivedStateFromProps;"function"===typeof f&&(f=f(c,e),e=null===f||void 0===f?e:k({},e,f),a.state=e);if("function"!==typeof b.getDerivedStateFromProps&&"function"!==typeof a.getSnapshotBeforeUpdate&&("function"===typeof a.UNSAFE_componentWillMount||"function"===typeof a.componentWillMount))if(b=
a.state,"function"===typeof a.componentWillMount&&a.componentWillMount(),"function"===typeof a.UNSAFE_componentWillMount&&a.UNSAFE_componentWillMount(),b!==a.state&&Xb.enqueueReplaceState(a,a.state,null),null!==g.queue&&0<g.queue.length)if(b=g.queue,f=g.replace,g.queue=null,g.replace=!1,f&&1===b.length)a.state=b[0];else{g=f?b[0]:a.state;e=!0;for(f=f?1:0;f<b.length;f++){var h=b[f];h="function"===typeof h?h.call(a,g,c,d):h;null!=h&&(e?(e=!1,g=k({},g,h)):k(g,h))}a.state=g}else g.queue=null}
function Zb(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var $b="function"===typeof Object.is?Object.is:Zb,R=null,S=null,T=null,U=!1,ac=!1,V=null,bc=0;function W(){if(null===R)throw Error(n(321));return R}function cc(){if(0<bc)throw Error(n(312));return{memoizedState:null,queue:null,next:null}}function dc(){null===T?null===S?(U=!1,S=T=cc()):(U=!0,T=S):null===T.next?(U=!1,T=T.next=cc()):(U=!0,T=T.next);return T}function ec(){R=null;ac=!1;S=null;bc=0;T=V=null}
function fc(a,b){return"function"===typeof b?b(a):b}function gc(a,b,c){R=W();T=dc();if(U){var d=T.queue;b=d.dispatch;if(null!==V&&(c=V.get(d),void 0!==c)){V.delete(d);d=T.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);T.memoizedState=d;return[d,b]}return[T.memoizedState,b]}a=a===fc?"function"===typeof b?b():b:void 0!==c?c(b):b;T.memoizedState=a;a=T.queue={last:null,dispatch:null};a=a.dispatch=hc.bind(null,R,a);return[T.memoizedState,a]}
function ic(a,b){R=W();T=dc();b=void 0===b?null:b;if(null!==T){var c=T.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var e=0;e<d.length&&e<b.length;e++)if(!$b(b[e],d[e])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();T.memoizedState=[a,b];return a}function hc(a,b,c){if(!(25>bc))throw Error(n(301));if(a===R)if(ac=!0,a={action:c,next:null},null===V&&(V=new Map),c=V.get(b),void 0===c)V.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}
function jc(){throw Error(n(394));}function kc(){}
var mc={readContext:function(a){return a._currentValue},useContext:function(a){W();return a._currentValue},useMemo:ic,useReducer:gc,useRef:function(a){R=W();T=dc();var b=T.memoizedState;return null===b?(a={current:a},T.memoizedState=a):b},useState:function(a){return gc(fc,a)},useLayoutEffect:function(){},useCallback:function(a,b){return ic(function(){return a},b)},useImperativeHandle:kc,useEffect:kc,useDebugValue:kc,useDeferredValue:function(a){W();return a},useTransition:function(){W();return[!1,
...
d,b.legacyContext=e,b.context=g,Q(g),l;}}function Ac(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Bc(this,b,a)}
function Cc(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,this.destination.end())):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(Cc,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onCompleteAll,a()))}
function Bc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(b=a.onReadyToStream,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Ac,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed){var d=b.completedSegments;d.push(c);1===d.length&&
b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function rc(a){if(2!==a.status){var b=O,c=nc.current;nc.current=mc;var d=lc;lc=a.responseState;try{var e=a.pingedTasks,g;for(g=0;g<e.length;g++){var f=e[g];var h=a,l=f.blockedSegment;if(0===l.status){Q(f.context);try{Z(h,f,f.node),f.abortSet.delete(f),l.status=1,Bc(h,f.blockedBoundary,l)}catch(t){if(ec(),"object"===typeof t&&null!==t&&"function"===typeof t.then){var m=f.ping;t.then(m,m)}else{f.abortSet.delete(f);l.status=4;var p=f.blockedBoundary,r=t;Y(h,r);null===p?tc(h,r):(p.pendingTasks--,p.forceClientRender||
(p.forceClientRender=!0,p.parentFlushed&&h.clientRenderedBoundaries.push(p)));h.allPendingTasks--;if(0===h.allPendingTasks){var E=h.onCompleteAll;E()}}}finally{}}}e.splice(0,g);1===a.status&&Dc(a)}catch(t){Y(a,t),tc(a,t)}finally{lc=d,nc.current=c,c===mc&&Q(b)}}}
function Ec(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;b.write(Oa);b.write(a.placeholderPrefix);a=d.toString(16);b.write(a);return b.write(Pa);case 1:c.status=2;var e=!0;d=c.chunks;var g=0;c=c.children;for(var f=0;f<c.length;f++){for(e=c[f];g<e.index;g++)b.write(d[g]);e=Fc(a,b,e)}for(;g<d.length;g++)e=b.write(d[g]);return e;default:throw Error(n(390));}}
function Fc(a,b,c){var d=c.boundary;if(null===d)return Ec(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)b.write(Sa),Ec(a,b,c);else if(0<d.pendingTasks)d.rootSegmentID=a.nextSegmentId++,0<d.completedSegments.length&&a.partialBoundaries.push(d),b.write(Ra),Ec(a,b,c);else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),b.write(Ra),Ec(a,b,c);else{b.write(Qa);c=d.completedSegments;if(1!==c.length)throw Error(n(391));Fc(a,b,c[0])}return b.write(Ta)}
function Gc(a,b,c){ob(b,a.responseState,c.formatContext,c.id);Fc(a,b,c);return pb(b,c.formatContext)}function Hc(a,b,c){for(var d=c.completedSegments,e=0;e<d.length;e++)Ic(a,b,c,d[e]);d.length=0;a=a.responseState;d=c.id;c=c.rootSegmentID;a.sentCompleteBoundaryFunction?b.write(vb):(a.sentCompleteBoundaryFunction=!0,b.write(ub));d=d.formattedID;if(null===d)throw Error(n(395));c=c.toString(16);b.write(d);b.write(wb);b.write(a.segmentPrefix);b.write(c);return b.write(xb)}
function Ic(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error(n(392));return Gc(a,b,d)}Gc(a,b,d);a=a.responseState;a.sentCompleteSegmentFunction?b.write(rb):(a.sentCompleteSegmentFunction=!0,b.write(qb));b.write(a.segmentPrefix);e=e.toString(16);b.write(e);b.write(sb);b.write(a.placeholderPrefix);b.write(e);return b.write(tb)}var Jc=!1;
function Dc(a){if(!Jc){Jc=!0;var b=a.destination;ba(b);try{var c=a.completedRootSegment;null!==c&&0===a.pendingRootTasks&&(Fc(a,b,c),a.completedRootSegment=null);var d=a.clientRenderedBoundaries,e;for(e=0;e<d.length;e++){var g=a.responseState,f=d[e].id;g.sentClientRenderFunction?b.write(zb):(g.sentClientRenderFunction=!0,b.write(yb));var h=f.formattedID;if(null===h)throw Error(n(395));b.write(h);if(!b.write(Ab)){a.status=0;e++;d.splice(0,e);return}}d.splice(0,e);var l=a.completedBoundaries;for(e=
0;e<l.length;e++)if(!Hc(a,b,l[e])){a.status=0;e++;l.splice(0,e);return}l.splice(0,e);ca(b);ba(b);var m=a.partialBoundaries;for(e=0;e<m.length;e++){var p=m[e];a:{c=a;var r=p.completedSegments;for(d=0;d<r.length;d++)if(!Ic(c,b,p,r[d])){d++;r.splice(0,d);var E=!1;break a}r.splice(0,d);E=!0}if(!E){a.status=0;e++;m.splice(0,e);return}}m.splice(0,e);var t=a.completedBoundaries;for(e=0;e<t.length;e++)if(!Hc(a,b,t[e])){a.status=0;e++;t.splice(0,e);return}t.splice(0,e)}finally{Jc=!1,ca(b),"function"===typeof b.flush&&
b.flush(),0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.end()}}}function Kc(a){setImmediate(function(){return rc(a)})}function Lc(a){if(2!==a.status){a.status=1;try{Dc(a)}catch(b){Y(a,b),tc(a,b)}}}function Mc(a,b){return function(){return Lc(b)}}
function Nc(a,b,c){var d=c?c.identifierPrefix:void 0;d=void 0===d?"":d;d={placeholderPrefix:u(d+"P:"),segmentPrefix:u(d+"S:"),boundaryPrefix:d+"B:",opaqueIdentifierPrefix:d+"R:",nextSuspenseID:0,nextOpaqueID:0,sentCompleteSegmentFunction:!1,sentCompleteBoundaryFunction:!1,sentClientRenderFunction:!1};var e=c?c.namespaceURI:void 0;e=A("http://www.w3.org/2000/svg"===e?2:"http://www.w3.org/1998/Math/MathML"===e?3:0,null);var g=c?c.progressiveChunkSize:void 0,f=c?c.onError:void 0,h=c?c.onCompleteAll:
void 0,l=c?c.onReadyToStream:void 0;c=[];var m=new Set;b={destination:b,responseState:d,progressiveChunkSize:void 0===g?12800:g,status:0,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:m,pingedTasks:c,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===f?oc:f,onCompleteAll:void 0===h?pc:h,onReadyToStream:void 0===l?pc:l};d=X(b,0,null,e);d.parentFlushed=!0;a=sc(b,a,null,d,m,Rb,null,null);c.push(a);return b}
exports.pipeToNodeWritable=function(a,b,c){var d=Nc(a,b,c),e=!1;Kc(d);return{startWriting:function(){e||(e=!0,Lc(d),b.on("drain",Mc(b,d)))},abort:function(){try{var a=d.abortableTasks;a.forEach(Cc,d);a.clear();1===d.status&&Dc(d)}catch(f){Y(d,f),tc(d,f)}}}};exports.version="18.0.0-6bf111772-20210701";
