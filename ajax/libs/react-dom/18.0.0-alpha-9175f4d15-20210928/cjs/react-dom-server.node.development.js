...
var ReactVersion = '18.0.0-9175f4d15-20210928';
...
function createRequest(children, destination, responseState, rootFormatContext, progressiveChunkSize, onError, onCompleteAll, onCompleteShell) {
  var pingedTasks = [];
...
function createRequestImpl(children, destination, options) {
  return createRequest(children, destination, createResponseState(options ? options.identifierPrefix : undefined), createRootFormatContext(options ? options.namespaceURI : undefined), options ? options.progressiveChunkSize : undefined, options ? options.onError : undefined, options ? options.onCompleteAll : undefined, options ? options.onCompleteShell : undefined);
}
