...
function Wo(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var k=sl(g);h.call(k)}}rl(b,g,a,e)}else g=Vo(c,b,a,e,d);return sl(g)}function Xo(a,b){if("font"===a)return"";if("string"===typeof b)return"use-credentials"===b?b:""}var Yo=ca.Dispatcher;ca.Events=[Mb,Nb,Ob,Pc,Qc,Ok];var Zo={findFiberByHostInstance:Kb,bundleType:0,version:"18.3.0-canary-3bcd2de01-20240227",rendererPackageName:"react-dom"};
...
exports.useFormStatus=function(){return ea.current.useHostTransitionStatus()};exports.version="18.3.0-canary-3bcd2de01-20240227";
