...
return[!1,jc]},useOpaqueIdentifier:function(){var a=lc;if(null===a)throw Error(n(404));return a.opaqueIdentifierPrefix+(a.nextOpaqueID++).toString(36)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error(n(407));return c()}},lc=null,nc=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function oc(a){console.error(a)}function pc(){}function qc(a,b){var c=a.pingedTasks;c.push(b);1===c.length&&setImmediate(function(){return rc(a)})}
...
exports.pipeToNodeWritable=function(a,b,c){var d=Mc(a,b,c),e=!1;Jc(d);return{startWriting:function(){e||(e=!0,Kc(d),b.on("drain",Lc(b,d)))},abort:function(){try{var a=d.abortableTasks;a.forEach(Bc,d);a.clear();1===d.status&&Cc(d)}catch(f){Y(d,f),tc(d,f)}}}};exports.version="18.0.0-5b57bc6e3-20210921";
