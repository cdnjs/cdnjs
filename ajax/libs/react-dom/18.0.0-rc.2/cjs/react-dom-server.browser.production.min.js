...
f,b.context=e,P(e),m;}}function Nc(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Oc(this,b,a)}
function Pc(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,null!==this.destination&&this.destination.close())):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(Pc,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onAllReady,a()))}
function Oc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(k(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=X,b=a.onShellReady,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Nc,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=
b.completedSegments;d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onAllReady,a())}
function Fc(a){if(2!==a.status){var b=N,c=Ac.current;Ac.current=zc;var d=yc;yc=a.responseState;try{var f=a.pingedTasks,e;for(e=0;e<f.length;e++){var g=f[e];var h=a,m=g.blockedSegment;if(0===m.status){P(g.context);try{Z(h,g,g.node),g.abortSet.delete(g),m.status=1,Oc(h,g.blockedBoundary,m)}catch(C){if(rc(),"object"===typeof C&&null!==C&&"function"===typeof C.then){var q=g.ping;C.then(q,q)}else{g.abortSet.delete(g);m.status=4;var r=g.blockedBoundary,E=C;Y(h,E);null===r?Gc(h,E):(r.pendingTasks--,r.forceClientRender||
(r.forceClientRender=!0,r.parentFlushed&&h.clientRenderedBoundaries.push(r)));h.allPendingTasks--;if(0===h.allPendingTasks){var F=h.onAllReady;F()}}}finally{}}}f.splice(0,e);null!==a.destination&&Qc(a,a.destination)}catch(C){Y(a,C),Gc(a,C)}finally{yc=d,Ac.current=c,c===zc&&P(b)}}}
function Rc(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;p(b,Qa);p(b,a.placeholderPrefix);a=u(d.toString(16));p(b,a);return t(b,Ra);case 1:c.status=2;var f=!0;d=c.chunks;var e=0;c=c.children;for(var g=0;g<c.length;g++){for(f=c[g];e<f.index;e++)p(b,d[e]);f=Sc(a,b,f)}for(;e<d.length-1;e++)p(b,d[e]);e<d.length&&(f=t(b,d[e]));return f;default:throw Error(k(390));}}
function Sc(a,b,c){var d=c.boundary;if(null===d)return Rc(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)t(b,Va),Rc(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var f=a.responseState;var e=f.nextSuspenseID++;f=v(f.boundaryPrefix+e.toString(16));d=d.id=f;Xa(b,a.responseState,d);Rc(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Xa(b,a.responseState,d.id),
Rc(a,b,c);else{t(b,Sa);c=d.completedSegments;if(1!==c.length)throw Error(k(391));Sc(a,b,c[0])}return t(b,Wa)}function Tc(a,b,c){sb(b,a.responseState,c.formatContext,c.id);Sc(a,b,c);return tb(b,c.formatContext)}
function Uc(a,b,c){for(var d=c.completedSegments,f=0;f<d.length;f++)Vc(a,b,c,d[f]);d.length=0;a=a.responseState;d=c.id;c=c.rootSegmentID;p(b,a.startInlineScript);a.sentCompleteBoundaryFunction?p(b,zb):(a.sentCompleteBoundaryFunction=!0,p(b,yb));if(null===d)throw Error(k(395));c=u(c.toString(16));p(b,d);p(b,Ab);p(b,a.segmentPrefix);p(b,c);return t(b,Bb)}
function Vc(a,b,c,d){if(2===d.status)return!0;var f=d.id;if(-1===f){if(-1===(d.id=c.rootSegmentID))throw Error(k(392));return Tc(a,b,d)}Tc(a,b,d);a=a.responseState;p(b,a.startInlineScript);a.sentCompleteSegmentFunction?p(b,vb):(a.sentCompleteSegmentFunction=!0,p(b,ub));p(b,a.segmentPrefix);f=u(f.toString(16));p(b,f);p(b,wb);p(b,a.placeholderPrefix);p(b,f);return t(b,xb)}
function Qc(a,b){l=new Uint8Array(512);n=0;try{var c=a.completedRootSegment;if(null!==c&&0===a.pendingRootTasks){Sc(a,b,c);a.completedRootSegment=null;var d=a.responseState.bootstrapChunks;for(c=0;c<d.length-1;c++)p(b,d[c]);c<d.length&&t(b,d[c])}var f=a.clientRenderedBoundaries,e;for(e=0;e<f.length;e++){d=b;var g=a.responseState,h=f[e].id;p(d,g.startInlineScript);g.sentClientRenderFunction?p(d,Db):(g.sentClientRenderFunction=!0,p(d,Cb));if(null===h)throw Error(k(395));p(d,h);if(!t(d,Eb)){a.destination=
null;e++;f.splice(0,e);return}}f.splice(0,e);var m=a.completedBoundaries;for(e=0;e<m.length;e++)if(!Uc(a,b,m[e])){a.destination=null;e++;m.splice(0,e);return}m.splice(0,e);ba(b);l=new Uint8Array(512);n=0;var q=a.partialBoundaries;for(e=0;e<q.length;e++){var r=q[e];a:{f=a;g=b;var E=r.completedSegments;for(h=0;h<E.length;h++)if(!Vc(f,g,r,E[h])){h++;E.splice(0,h);var F=!1;break a}E.splice(0,h);F=!0}if(!F){a.destination=null;e++;q.splice(0,e);return}}q.splice(0,e);var C=a.completedBoundaries;for(e=0;e<
C.length;e++)if(!Uc(a,b,C[e])){a.destination=null;e++;C.splice(0,e);return}C.splice(0,e)}finally{ba(b),0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.close()}}function Wc(a){try{var b=a.abortableTasks;b.forEach(Pc,a);b.clear();null!==a.destination&&Qc(a,a.destination)}catch(c){Y(a,c),Gc(a,c)}}
...
a;try{Qc(h,a)}catch(F){Y(h,F),Gc(h,F)}}},cancel:function(){Wc(h)}});a.allReady=g;c(a)},function(a){g.catch(function(){});d(a)},f);if(b&&b.signal){var m=b.signal,q=function(){Wc(h);m.removeEventListener("abort",q)};m.addEventListener("abort",q)}Fc(h)})};exports.version="18.0.0-rc.2-11c5bb6e1-20220308";
