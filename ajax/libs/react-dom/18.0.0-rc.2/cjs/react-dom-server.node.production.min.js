...
f,b.context=e,J(e),l;}}function Ec(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Fc(this,b,a)}
function Gc(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,null!==this.destination&&this.destination.end())):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(Gc,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onAllReady,a()))}
function Fc(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=W,b=a.onShellReady,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Ec,a),b.fallbackAbortableTasks.clear();
...
function vc(a){if(2!==a.status){var b=H,c=sc.current;sc.current=rc;var d=V;V=a.responseState;try{var f=a.pingedTasks,e;for(e=0;e<f.length;e++){var g=f[e];var h=a,l=g.blockedSegment;if(0===l.status){J(g.context);try{Z(h,g,g.node),g.abortSet.delete(g),l.status=1,Fc(h,g.blockedBoundary,l)}catch(w){if(lc(),"object"===typeof w&&null!==w&&"function"===typeof w.then){var m=g.ping;w.then(m,m)}else{g.abortSet.delete(g);l.status=4;var n=g.blockedBoundary,y=w;Y(h,y);null===n?xc(h,y):(n.pendingTasks--,n.forceClientRender||
(n.forceClientRender=!0,n.parentFlushed&&h.clientRenderedBoundaries.push(n)));h.allPendingTasks--;if(0===h.allPendingTasks){var B=h.onAllReady;B()}}}finally{}}}f.splice(0,e);null!==a.destination&&Hc(a,a.destination)}catch(w){Y(a,w),xc(a,w)}finally{V=d,sc.current=c,c===rc&&J(b)}}}
function Ic(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;b.write(Na);b.write(a.placeholderPrefix);a=d.toString(16);b.write(a);return b.write(Oa);case 1:c.status=2;var f=!0;d=c.chunks;var e=0;c=c.children;for(var g=0;g<c.length;g++){for(f=c[g];e<f.index;e++)b.write(d[e]);f=Jc(a,b,f)}for(;e<d.length-1;e++)b.write(d[e]);e<d.length&&(f=b.write(d[e]));return f;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function Jc(a,b,c){var d=c.boundary;if(null===d)return Ic(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)b.write(Sa),Ic(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var f=a.responseState;var e=f.nextSuspenseID++;f=k(f.boundaryPrefix+e.toString(16));d=d.id=f;Ua(b,a.responseState,d);Ic(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),Ua(b,a.responseState,d.id),
Ic(a,b,c);else{b.write(Pa);c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");Jc(a,b,c[0])}return b.write(Ta)}function Kc(a,b,c){pb(b,a.responseState,c.formatContext,c.id);Jc(a,b,c);return qb(b,c.formatContext)}
function Lc(a,b,c){for(var d=c.completedSegments,f=0;f<d.length;f++)Mc(a,b,c,d[f]);d.length=0;a=a.responseState;d=c.id;c=c.rootSegmentID;b.write(a.startInlineScript);a.sentCompleteBoundaryFunction?b.write(wb):(a.sentCompleteBoundaryFunction=!0,b.write(vb));if(null===d)throw Error("An ID must have been assigned before we can complete the boundary.");c=c.toString(16);b.write(d);b.write(xb);b.write(a.segmentPrefix);b.write(c);return b.write(yb)}
function Mc(a,b,c,d){if(2===d.status)return!0;var f=d.id;if(-1===f){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return Kc(a,b,d)}Kc(a,b,d);a=a.responseState;b.write(a.startInlineScript);a.sentCompleteSegmentFunction?b.write(sb):(a.sentCompleteSegmentFunction=!0,b.write(rb));b.write(a.segmentPrefix);f=f.toString(16);b.write(f);b.write(tb);b.write(a.placeholderPrefix);b.write(f);return b.write(ub)}
function Hc(a,b){ba(b);try{var c=a.completedRootSegment;if(null!==c&&0===a.pendingRootTasks){Jc(a,b,c);a.completedRootSegment=null;var d=a.responseState.bootstrapChunks;for(c=0;c<d.length-1;c++)b.write(d[c]);c<d.length&&b.write(d[c])}var f=a.clientRenderedBoundaries,e;for(e=0;e<f.length;e++){d=b;var g=a.responseState,h=f[e].id;d.write(g.startInlineScript);g.sentClientRenderFunction?d.write(Ab):(g.sentClientRenderFunction=!0,d.write(zb));if(null===h)throw Error("An ID must have been assigned before we can complete the boundary.");
d.write(h);if(!d.write(Bb)){a.destination=null;e++;f.splice(0,e);return}}f.splice(0,e);var l=a.completedBoundaries;for(e=0;e<l.length;e++)if(!Lc(a,b,l[e])){a.destination=null;e++;l.splice(0,e);return}l.splice(0,e);ca(b);ba(b);var m=a.partialBoundaries;for(e=0;e<m.length;e++){var n=m[e];a:{f=a;g=b;var y=n.completedSegments;for(h=0;h<y.length;h++)if(!Mc(f,g,n,y[h])){h++;y.splice(0,h);var B=!1;break a}y.splice(0,h);B=!0}if(!B){a.destination=null;e++;m.splice(0,e);return}}m.splice(0,e);var w=a.completedBoundaries;
for(e=0;e<w.length;e++)if(!Lc(a,b,w[e])){a.destination=null;e++;w.splice(0,e);return}w.splice(0,e)}finally{ca(b),"function"===typeof b.flush&&b.flush(),0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.end()}}function Nc(a){setImmediate(function(){return vc(a)})}
function Oc(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{Hc(a,b)}catch(c){Y(a,c),xc(a,c)}}}function Pc(a){try{var b=a.abortableTasks;b.forEach(Gc,a);b.clear();null!==a.destination&&Hc(a,a.destination)}catch(c){Y(a,c),xc(a,c)}}function Qc(a,b){return function(){return Oc(b,a)}}function Rc(a){return function(){return Pc(a)}}
...
exports.renderToPipeableStream=function(a,b){var c=Sc(a,b),d=!1;Nc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Oc(c,a);a.on("drain",Qc(a,c));a.on("close",Rc(c));return a},abort:function(){Pc(c)}}};exports.version="18.0.0-rc.2-11c5bb6e1-20220308";
