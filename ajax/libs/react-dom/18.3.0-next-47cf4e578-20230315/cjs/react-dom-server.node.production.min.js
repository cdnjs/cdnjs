...
p.status=1;He(n,k.blockedBoundary,p)}catch(pa){de();var E=pa===Md?Qd():pa;if("object"===typeof E&&null!==E&&"function"===typeof E.then){var I=k.ping;E.then(I,I);k.thenableState=ee()}else{k.abortSet.delete(k);p.status=4;var A=n,J=k.blockedBoundary,qa=E,ja=ye(A,qa);null===J?ze(A,qa):(J.pendingTasks--,J.forceClientRender||(J.forceClientRender=!0,J.errorDigest=ja,J.parentFlushed&&A.clientRenderedBoundaries.push(J)));A.allPendingTasks--;if(0===A.allPendingTasks){var Se=A.onAllReady;Se()}}}finally{n.resources.boundaryResources=
null}}}g.splice(0,m);null!==a.destination&&Je(a,a.destination)}catch(pa){ye(a,pa),ze(a,pa)}finally{ne=f,qe.current=c,re.current=d,D=Ea.pop(),ya.current=e,c===oe&&Dd(b)}}}
...
for(c=0;c<E.length;c++)if(!Ne(a,b,E[c])){a.destination=null;c++;E.splice(0,c);return}E.splice(0,c);ia(b);h=new Uint8Array(2048);l=0;fa=!0;var I=a.partialBoundaries;for(c=0;c<I.length;c++){var A=I[c];a:{f=a;g=b;f.resources.boundaryResources=A.resources;var J=A.completedSegments;for(m=0;m<J.length;m++)if(!Oe(f,g,A,J[m])){m++;J.splice(0,m);var qa=!1;break a}J.splice(0,m);qa=Gc(g,A.resources,f.responseState)}if(!qa){a.destination=null;c++;I.splice(0,c);return}}I.splice(0,c);var ja=a.completedBoundaries;
