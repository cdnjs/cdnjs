...
C.xlinkHref=new B("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);C.formAction=new B("formAction",1,!1,"formaction",null,!0,!1);["src","href","action"].forEach(function(a){C[a]=new B(a,1,!1,a.toLowerCase(),null,!0,!0)});
...
function La(a,b,c,d,e,f){a=void 0===a?"":a;b=void 0===b?Da:x('<script nonce="'+D(b)+'">');var g=[],m=null,k=0;void 0!==c&&g.push(b,w((""+c).replace(Ja,Ka)),Ea);void 0!==f&&(k=1,m="string"===typeof f?{src:f,integrity:void 0}:f);if(void 0!==d)for(c=0;c<d.length;c++){f=d[c];var p="string"===typeof f?void 0:f.integrity;g.push(Fa,w(D("string"===typeof f?f:f.src)));p&&g.push(Ha,w(D(p)));g.push(Ia)}if(void 0!==e)for(d=0;d<e.length;d++)c=e[d],f="string"===typeof c?void 0:c.integrity,g.push(Ga,w(D("string"===
typeof c?c:c.src))),f&&g.push(Ha,w(D(f))),g.push(Ia);return{bootstrapChunks:g,placeholderPrefix:x(a+"P:"),segmentPrefix:x(a+"S:"),boundaryPrefix:a+"B:",idPrefix:a,nextSuspenseID:0,streamingFormat:k,startInlineScript:b,instructions:0,externalRuntimeConfig:m,htmlChunks:null,headChunks:null,hasBody:!1,charsetChunks:[],preconnectChunks:[],preloadChunks:[],hoistableChunks:[],stylesToHoist:!1}}function G(a,b,c){return{insertionMode:a,selectedValue:b,noscriptTagInScope:c}}
...
null,a.noscriptTagInScope)}return 5<=a.insertionMode?G(2,null,a.noscriptTagInScope):0===a.insertionMode?"html"===b?G(1,null,!1):G(2,null,!1):1===a.insertionMode?G(2,null,!1):a}var H=x("\x3c!-- --\x3e");function Oa(a,b,c,d){if(""===b)return d;d&&a.push(H);a.push(w(D(b)));return!0}var Pa=new Map,Qa=x(' style="'),Ra=x(":"),Sa=x(";");
function Ta(a,b){if("object"!==typeof b)throw Error(h(62));var c=!0,d;for(d in b)if(z.call(b,d)){var e=b[d];if(null!=e&&"boolean"!==typeof e&&""!==e){if(0===d.indexOf("--")){var f=w(D(d));e=w(D((""+e).trim()))}else f=Pa.get(d),void 0===f&&(f=x(D(d.replace(sa,"-$1").toLowerCase().replace(ta,"-ms-"))),Pa.set(d,f)),e="number"===typeof e?0===e||z.call(na,d)?w(""+e):w(e+"px"):w(D((""+e).trim()));c?(c=!1,a.push(Qa,f,Ra,e)):a.push(Sa,f,Ra,e)}}c||a.push(I)}var J=x(" "),Ua=x('="'),I=x('"'),Va=x('=""');
...
!1!==c&&a.push(J,b,Ua,w(D(c)),I);break;case 5:isNaN(c)||a.push(J,b,Ua,w(D(c)),I);break;case 6:!isNaN(c)&&1<=c&&a.push(J,b,Ua,w(D(c)),I);break;default:d.sanitizeURL&&(c=""+c),a.push(J,b,Ua,w(D(c)),I)}}else if(ka(b)){switch(typeof c){case "function":case "symbol":return;case "boolean":if(d=b.toLowerCase().slice(0,5),"data-"!==d&&"aria-"!==d)return}a.push(J,w(b),Ua,w(D(c)),I)}}}var N=x(">"),Wa=x("/>");
...
switch(b.rel){case "preconnect":case "dns-prefetch":return P(c.preconnectChunks,b);case "preload":return P(c.preloadChunks,b);default:return P(c.hoistableChunks,b)}}function P(a,b){a.push(Q("link"));for(var c in b)if(z.call(b,c)){var d=b[c];if(null!=d)switch(c){case "children":case "dangerouslySetInnerHTML":throw Error(h(399,"link"));default:M(a,c,d)}}a.push(Wa);return null}
...
function bb(a,b){a.push(Q("title"));var c=null,d=null,e;for(e in b)if(z.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:M(a,e,f)}}a.push(N);b=Array.isArray(c)?2>c.length?c[0]:null:c;"function"!==typeof b&&"symbol"!==typeof b&&null!==b&&void 0!==b&&a.push(w(D(""+b)));O(a,d,c);a.push(R,w("title"),S);return null}
function cb(a,b){a.push(Q("script"));var c=null,d=null,e;for(e in b)if(z.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:M(a,e,f)}}a.push(N);O(a,d,c);"string"===typeof c&&a.push(w(D(c)));a.push(R,w("script"),S);return null}
function db(a,b,c){a.push(Q(c));var d=c=null,e;for(e in b)if(z.call(b,e)){var f=b[e];if(null!=f)switch(e){case "children":c=f;break;case "dangerouslySetInnerHTML":d=f;break;default:M(a,e,f)}}a.push(N);O(a,d,c);return"string"===typeof c?(a.push(w(D(c))),null):c}var eb=x("\n"),fb=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,gb=new Map;function Q(a){var b=gb.get(a);if(void 0===b){if(!fb.test(a))throw Error(h(65,a));b=x("<"+a);gb.set(a,b)}return b}var hb=x("<!DOCTYPE html>");
...
k){if(null!=g)throw Error(h(92));if(ua(k)&&1<k.length)throw Error(h(93));g=""+k}"string"===typeof g&&"\n"===g[0]&&a.push(eb);null!==g&&a.push(w(D(""+g)));return null;case "input":a.push(Q("input"));q=k=d=g=null;for(p in c)if(z.call(c,p)&&(t=c[p],null!=t))switch(p){case "children":case "dangerouslySetInnerHTML":throw Error(h(399,"input"));case "defaultChecked":q=t;break;case "defaultValue":d=t;break;case "checked":k=t;break;case "value":g=t;break;default:M(a,p,t)}null!==k?M(a,"checked",k):null!==q&&
M(a,"checked",q);null!==g?M(a,"value",g):null!==d&&M(a,"value",d);a.push(Wa);return null;case "menuitem":a.push(Q("menuitem"));for(var E in c)if(z.call(c,E)&&(g=c[E],null!=g))switch(E){case "children":case "dangerouslySetInnerHTML":throw Error(h(400));default:M(a,E,g)}a.push(N);return null;case "title":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=bb(a,c):(bb(e.hoistableChunks,c),a=null),a;case "link":return Za(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":a:if(3===
f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof c.src||!c.src)a=cb(a,c);else{p="[script]"+c.src;if(!0!==c.async||c.onLoad||c.onError){if(!0!==c.noModule&&(k=d.preloadsMap.get(p),k||(k={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"script",href:c.src,crossOrigin:c.crossOrigin,integrity:c.integrity,referrerPolicy:c.referrerPolicy}},d.preloadsMap.set(p,k),d.usedScripts.add(k),P(k.chunks,k.props))),!0!==c.async){cb(a,c);a=null;break a}}else if(k=d.scriptsMap.get(p),
!k){k={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(p,k);d.scripts.add(k);q=c;if(d=d.preloadsMap.get(p))d.state|=4,c=q=y({},c),d=d.props,null==c.crossOrigin&&(c.crossOrigin=d.crossOrigin),null==c.integrity&&(c.integrity=d.integrity);cb(k.chunks,q)}g&&a.push(H);a=null}return a;case "style":q=c.precedence;p=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof q||"string"!==typeof p||""===p){a.push(Q("style"));d=g=null;for(t in c)if(z.call(c,t)&&(k=
c[t],null!=k))switch(t){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:M(a,t,k)}a.push(N);c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(w(D(""+c)));O(a,d,g);a.push(R,w("style"),S);a=null}else{t="[style]"+p;v=d.stylesMap.get(t);if(!v){(v=d.stylePrecedences.get(q))?v.props.hrefs.push(p):(v={type:"style",chunks:[],state:0,props:{precedence:q,hrefs:[p]}},d.stylePrecedences.set(q,v),p=new Set,p.add(v),d.precedences.set(q,
p));d.stylesMap.set(t,v);d.boundaryResources&&d.boundaryResources.add(v);d=v.chunks;p=q=null;for(k in c)if(z.call(c,k)&&(t=c[k],null!=t))switch(k){case "children":q=t;break;case "dangerouslySetInnerHTML":p=t}c=Array.isArray(q)?2>q.length?q[0]:null:q;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&d.push(w(D(""+c)));O(d,p,q)}g&&a.push(H);a=void 0}return a;case "meta":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=ab(a,c,"meta"):(g&&a.push(H),a="string"===typeof c.charSet?
ab(e.charsetChunks,c,"meta"):ab(e.hoistableChunks,c,"meta")),a;case "listing":case "pre":a.push(Q(b));d=g=null;for(var K in c)if(z.call(c,K)&&(k=c[K],null!=k))switch(K){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:M(a,K,k)}a.push(N);if(null!=d){if(null!=g)throw Error(h(60));if("object"!==typeof d||!("__html"in d))throw Error(h(61));c=d.__html;null!==c&&void 0!==c&&("string"===typeof c&&0<c.length&&"\n"===c[0]?a.push(eb,w(c)):a.push(w(""+c)))}"string"===typeof g&&"\n"===
...
f.insertionMode&&null===e.htmlChunks?(e.htmlChunks=[hb],a=db(e.htmlChunks,c,"html")):a=db(a,c,"html"),a;default:if(-1===b.indexOf("-")&&"string"!==typeof c.is)return db(a,c,b);a.push(Q(b));d=g=null;for(var A in c)if(z.call(c,A)&&(k=c[A],null!=k))switch(A){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;case "style":Ta(a,k);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:ka(A)&&"function"!==typeof k&&"symbol"!==typeof k&&a.push(J,w(A),Ua,
w(D(k)),I)}a.push(N);O(a,d,g);return g}}var R=x("</"),S=x(">"),jb=x('<template id="'),kb=x('"></template>'),lb=x("\x3c!--$--\x3e"),mb=x('\x3c!--$?--\x3e<template id="'),nb=x('"></template>'),ob=x("\x3c!--$!--\x3e"),pb=x("\x3c!--/$--\x3e"),qb=x("<template"),rb=x('"'),sb=x(' data-dgst="');x(' data-msg="');x(' data-stck="');var tb=x("></template>");function ub(a,b,c){r(a,mb);if(null===c)throw Error(h(395));r(a,c);return u(a,nb)}
...
var xc=x('<style media="not all" data-precedence="'),yc=x('" data-href="'),zc=x('">'),Ac=x("</style>"),Bc=!1,Cc=!0;function Dc(a){if("stylesheet"===a.type&&0===(a.state&1))Bc=!0;else if("style"===a.type){var b=a.chunks,c=a.props.hrefs,d=0;if(b.length){r(this,xc);r(this,w(D(a.props.precedence)));if(c.length){for(r(this,yc);d<c.length-1;d++)r(this,w(D(c[d]))),r(this,Ec);r(this,w(D(c[d])))}r(this,zc);for(d=0;d<b.length;d++)r(this,b[d]);Cc=u(this,Ac);Bc=!0;b.length=0;c.length=0}}}
...
var Jc=x('<style data-precedence="'),Kc=x('" data-href="'),Ec=x(" "),Lc=x('">'),Mc=x("</style>");function Nc(a,b){Hc=!1;a.forEach(Ic,this);a.clear();a=Gc.chunks;var c=Gc.props.hrefs;if(!1===Hc||a.length){r(this,Jc);r(this,w(D(b)));b=0;if(c.length){for(r(this,Kc);b<c.length-1;b++)r(this,w(D(c[b]))),r(this,Ec);r(this,w(D(c[b])))}r(this,Lc);for(b=0;b<a.length;b++)r(this,a[b]);r(this,Mc);a.length=0;c.length=0}}
...
Wc)}
function Yc(a,b){r(a,Tc);var c=Tc;b.forEach(function(d){if("style"!==d.type&&!(d.state&1))if(d.state&3)r(a,c),r(a,w(D(JSON.stringify(""+d.props.href)))),r(a,Wc),c=Uc;else if("stylesheet"===d.type){r(a,c);var e=d.props["data-precedence"],f=d.props;r(a,w(D(JSON.stringify(""+d.props.href))));e=""+e;r(a,Vc);r(a,w(D(JSON.stringify(e))));for(var g in f)if(z.call(f,g)){var m=f[g];if(null!=m)switch(g){case "href":case "rel":case "precedence":case "data-precedence":break;case "children":case "dangerouslySetInnerHTML":throw Error(h(399,"link"));
default:a:{e=a;var k=g.toLowerCase();switch(typeof m){case "function":case "symbol":break a}switch(g){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":k="class";break;case "hidden":if(!1===m)break a;break;case "src":case "href":break;default:if(!ka(g))break a}if(!(2<g.length)||"o"!==g[0]&&"O"!==g[0]||"n"!==g[1]&&"N"!==g[1])m=""+m,r(e,Vc),r(e,w(D(JSON.stringify(k)))),r(e,Vc),r(e,w(D(JSON.stringify(m))))}}}r(a,
...
function je(){throw Error(h(394));}function ke(a){var b=Xd;Xd+=1;null===Yd&&(Yd=[]);return Nd(Yd,a,b)}function le(){throw Error(h(393));}function me(){}
var oe={readContext:function(a){return a._currentValue},useContext:function(a){$d();return a._currentValue},useMemo:ie,useReducer:ge,useRef:function(a){W=$d();X=be();var b=X.memoizedState;return null===b?(a={current:a},X.memoizedState=a):b},useState:function(a){return ge(fe,a)},useInsertionEffect:me,useLayoutEffect:function(){},useCallback:function(a,b){return ie(function(){return a},b)},useImperativeHandle:me,useEffect:me,useDebugValue:me,useDeferredValue:function(a){$d();return a},useTransition:function(){$d();
return[!1,je]},useId:function(){var a=Sd.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-Hd(a)-1)).toString(32)+b;var c=ne;if(null===c)throw Error(h(404));b=Wd++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b){$d();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error(h(407));return c()},useCacheRefresh:function(){return le},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return ke(a);if(a.$$typeof===
fd||a.$$typeof===gd)return a._currentValue}throw Error(h(438,String(a)));}},ne=null,pe={getCacheSignal:function(){throw Error(h(248));},getCacheForType:function(){throw Error(h(248));}},qe=ud.ReactCurrentDispatcher,re=ud.ReactCurrentCache;function se(a){console.error(a);return null}function te(){}
...
completedSegments:[],byteSize:0,fallbackAbortableTasks:g,errorDigest:null,resources:new Set},k=ve(a,c.chunks.length,m,c.formatContext,!1,!1);c.children.push(k);c.lastPushedText=!1;var p=ve(a,0,null,c.formatContext,!1,!1);p.parentFlushed=!0;b.blockedBoundary=m;b.blockedSegment=p;a.resources.boundaryResources=m.resources;try{if(De(a,b,e),p.lastPushedText&&p.textEmbedded&&p.chunks.push(H),p.status=1,Ee(m,p),0===m.pendingTasks)break a}catch(t){p.status=4,m.forceClientRender=!0,m.errorDigest=ye(a,t)}finally{a.resources.boundaryResources=
d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=c}b=we(a,null,f,d,k,g,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof d&&null!==d)switch(d.$$typeof){case hd:d=d.render;W={};Sd=b;Xd=Wd=0;Yd=c;c=d(e,f);e=ce(d,e,c,f);if(0!==Wd){d=b.treeContext;b.treeContext=Gd(d,1,0);try{Z(a,b,null,e)}finally{b.treeContext=d}}else Z(a,b,null,e);return;case kd:d=d.type;e=Be(d,e);Ce(a,b,c,d,e,f);return;case ed:c=e.children;d=d._context;e=e.value;f=d._currentValue;d._currentValue=
e;g=V;V=e={parent:g,depth:null===g?0:g.depth+1,context:d,parentValue:f,value:e};b.context=e;Z(a,b,null,c);a=V;if(null===a)throw Error(h(403));e=a.parentValue;a.context._currentValue=e===rd?a.context._defaultValue:e;a=V=a.parent;b.context=a;return;case fd:e=e.children;e=e(d._currentValue);Z(a,b,null,e);return;case ld:f=d._init;d=f(d._payload);e=Be(d,e);Ce(a,b,c,d,e,void 0);return}throw Error(h(130,null==d?d:typeof d,""));}}
function Z(a,b,c,d){b.node=d;if("object"===typeof d&&null!==d){switch(d.$$typeof){case $c:Ce(a,b,c,d.type,d.props,d.ref);return;case ad:throw Error(h(257));case ld:c=d._init;d=c(d._payload);Z(a,b,null,d);return}if(ua(d)){Fe(a,b,d);return}null===d||"object"!==typeof d?c=null:(c=sd&&d[sd]||d["@@iterator"],c="function"===typeof c?c:null);if(c&&(c=c.call(d))){d=c.next();if(!d.done){var e=[];do e.push(d.value),d=c.next();while(!d.done);Fe(a,b,e)}return}if("function"===typeof d.then)return Z(a,b,null,ke(d));
if(d.$$typeof===fd||d.$$typeof===gd)return Z(a,b,null,d._currentValue);a=Object.prototype.toString.call(d);throw Error(h(31,"[object Object]"===a?"object with keys {"+Object.keys(d).join(", ")+"}":a));}"string"===typeof d?(c=b.blockedSegment,c.lastPushedText=Oa(b.blockedSegment.chunks,d,a.responseState,c.lastPushedText)):"number"===typeof d&&(c=b.blockedSegment,c.lastPushedText=Oa(b.blockedSegment.chunks,""+d,a.responseState,c.lastPushedText))}
function Fe(a,b,c){for(var d=c.length,e=0;e<d;e++){var f=b.treeContext;b.treeContext=Gd(f,d,e);try{De(a,b,c[e])}finally{b.treeContext=f}}}
function De(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,f=b.context;try{return Z(a,b,null,c)}catch(p){if(de(),c=p===Ld?Pd():p,"object"===typeof c&&null!==c&&"function"===typeof c.then){var g=ee(),m=b.blockedSegment,k=ve(a,m.chunks.length,null,m.formatContext,m.lastPushedText,!0);m.children.push(k);m.lastPushedText=!1;a=we(a,g,b.node,b.blockedBoundary,k,b.abortSet,b.legacyContext,b.context,b.treeContext).ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=
...
function xe(a){if(2!==a.status){var b=V,c=qe.current;qe.current=oe;var d=re.current;re.current=pe;var e=a.resources;Ba.push(F);F=e;e=va.current;va.current=Aa;var f=ne;ne=a.responseState;try{var g=a.pingedTasks,m;for(m=0;m<g.length;m++){var k=g[m];var p=a,t=k.blockedBoundary;p.resources.boundaryResources=t?t.resources:null;var q=k.blockedSegment;if(0===q.status){Cd(k.context);try{var v=k.thenableState;k.thenableState=null;Z(p,k,v,k.node);q.lastPushedText&&q.textEmbedded&&q.chunks.push(H);k.abortSet.delete(k);
q.status=1;He(p,k.blockedBoundary,q)}catch(pa){de();var E=pa===Ld?Pd():pa;if("object"===typeof E&&null!==E&&"function"===typeof E.then){var K=k.ping;E.then(K,K);k.thenableState=ee()}else{k.abortSet.delete(k);q.status=4;var A=p,L=k.blockedBoundary,qa=E,ja=ye(A,qa);null===L?ze(A,qa):(L.pendingTasks--,L.forceClientRender||(L.forceClientRender=!0,L.errorDigest=ja,L.parentFlushed&&A.clientRenderedBoundaries.push(L)));A.allPendingTasks--;if(0===A.allPendingTasks){var Qe=A.onAllReady;Qe()}}}finally{p.resources.boundaryResources=
null}}}g.splice(0,m);null!==a.destination&&Je(a,a.destination)}catch(pa){ye(a,pa),ze(a,pa)}finally{ne=f,qe.current=c,re.current=d,F=Ba.pop(),va.current=e,c===oe&&Cd(b)}}}
function Ke(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;r(b,jb);r(b,a.placeholderPrefix);a=w(d.toString(16));r(b,a);return u(b,kb);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var g=0;g<c.length;g++){for(e=c[g];f<e.index;f++)r(b,d[f]);e=Le(a,b,e)}for(;f<d.length-1;f++)r(b,d[f]);f<d.length&&(e=u(b,d[f]));return e;default:throw Error(h(390));}}
function Le(a,b,c){var d=c.boundary;if(null===d)return Ke(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,u(b,ob),r(b,qb),d&&(r(b,sb),r(b,w(D(d))),r(b,rb)),u(b,tb),Ke(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=x(e.boundaryPrefix+f.toString(16));d=d.id=e;ub(b,a.responseState,d);Ke(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,
a.completedBoundaries.push(d),ub(b,a.responseState,d.id),Ke(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(Zc,c);u(b,lb);c=d.completedSegments;if(1!==c.length)throw Error(h(391));Le(a,b,c[0])}return u(b,pb)}function Me(a,b,c){Qb(b,a.responseState,c.formatContext,c.id);Le(a,b,c);return Rb(b,c.formatContext)}
...
function Oe(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error(h(392));return Me(a,b,d)}Me(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(r(b,a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,r(b,Sb)):r(b,Tb)):r(b,Wb);r(b,a.segmentPrefix);e=w(e.toString(16));r(b,e);c?r(b,Ub):r(b,Xb);r(b,a.placeholderPrefix);r(b,e);b=c?u(b,Vb):u(b,Ca);return b}
function Je(a,b){l=new Uint8Array(512);n=0;try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){Qc(b,a.resources,a.responseState,0===a.allPendingTasks);Le(a,b,d);a.completedRootSegment=null;var e=a.responseState.bootstrapChunks;for(d=0;d<e.length-1;d++)r(b,e[d]);d<e.length&&u(b,e[d])}else return;else Sc(b,a.resources,a.responseState);var f=a.clientRenderedBoundaries;for(c=0;c<f.length;c++){var g=f[c];e=b;var m=a.responseState,k=g.id,p=g.errorDigest,t=g.errorMessage,q=g.errorComponentStack,
v=0===m.streamingFormat;v?(r(e,m.startInlineScript),0===(m.instructions&4)?(m.instructions|=4,r(e,kc)):r(e,lc)):r(e,pc);if(null===k)throw Error(h(395));r(e,k);v&&r(e,mc);if(p||t||q)v?(r(e,nc),r(e,w(uc(p||"")))):(r(e,qc),r(e,w(D(p||""))));if(t||q)v?(r(e,nc),r(e,w(uc(t||"")))):(r(e,rc),r(e,w(D(t||""))));q&&(v?(r(e,nc),r(e,w(uc(q)))):(r(e,sc),r(e,w(D(q)))));if(v?!u(e,oc):!u(e,Ca)){a.destination=null;c++;f.splice(0,c);return}}f.splice(0,c);var E=a.completedBoundaries;for(c=0;c<E.length;c++)if(!Ne(a,b,
E[c])){a.destination=null;c++;E.splice(0,c);return}E.splice(0,c);ca(b);l=new Uint8Array(512);n=0;var K=a.partialBoundaries;for(c=0;c<K.length;c++){var A=K[c];a:{f=a;g=b;f.resources.boundaryResources=A.resources;var L=A.completedSegments;for(m=0;m<L.length;m++)if(!Oe(f,g,A,L[m])){m++;L.splice(0,m);var qa=!1;break a}L.splice(0,m);qa=Fc(g,A.resources,f.responseState)}if(!qa){a.destination=null;c++;K.splice(0,c);return}}K.splice(0,c);var ja=a.completedBoundaries;for(c=0;c<ja.length;c++)if(!Ne(a,b,ja[c])){a.destination=
...
exports.renderToReadableStream=function(a,b){return new Promise(function(c,d){var e,f,g=new Promise(function(t,q){f=t;e=q}),m=ue(a,La(b?b.identifierPrefix:void 0,b?b.nonce:void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0,b?b.unstable_externalRuntimeSrc:void 0),Ma(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:void 0,b?b.onError:void 0,f,function(){var t=new ReadableStream({type:"bytes",pull:function(q){if(1===m.status)m.status=2,ea(q,m.fatalError);
else if(2!==m.status&&null===m.destination){m.destination=q;try{Je(m,q)}catch(v){ye(m,v),ze(m,v)}}},cancel:function(){Pe(m)}},{highWaterMark:0});t.allReady=g;c(t)},function(t){g.catch(function(){});d(t)},e);if(b&&b.signal){var k=b.signal;if(k.aborted)Pe(m,k.reason);else{var p=function(){Pe(m,k.reason);k.removeEventListener("abort",p)};k.addEventListener("abort",p)}}xe(m)})};exports.version="18.3.0-next-47cf4e578-20230315";
