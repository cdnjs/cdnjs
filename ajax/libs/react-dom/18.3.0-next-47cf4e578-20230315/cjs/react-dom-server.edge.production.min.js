...
else if(2!==m.status&&null===m.destination){m.destination=q;try{Je(m,q)}catch(u){ye(m,u),ze(m,u)}}},cancel:function(){Re(m)}},{highWaterMark:0});r.allReady=g;c(r)},function(r){g.catch(function(){});d(r)},e);if(b&&b.signal){var k=b.signal;if(k.aborted)Re(m,k.reason);else{var p=function(){Re(m,k.reason);k.removeEventListener("abort",p)};k.addEventListener("abort",p)}}Pe(m)})};exports.version="18.3.0-next-47cf4e578-20230315";
