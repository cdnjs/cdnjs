...
var A=Object.assign,B=Object.prototype.hasOwnProperty,la=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),ma={},na={};
function oa(a){if(B.call(na,a))return!0;if(B.call(ma,a))return!1;if(la.test(a))return na[a]=!0;ma[a]=!0;return!1}
...
function sb(a,b,c,d,e,g,f){switch(b){case "div":case "span":case "svg":case "path":case "a":case "g":case "p":case "li":break;case "select":a.push(T("select"));f=e=null;for(var m in c)if(B.call(c,m)){var k=c[m];if(null!=k)switch(m){case "children":e=k;break;case "dangerouslySetInnerHTML":f=k;break;case "defaultValue":case "value":break;default:M(a,m,k)}}a.push(P);Q(a,f,e);return e;case "option":e=g.selectedValue;a.push(T("option"));var n=d=f=null;k=null;for(var r in c)if(B.call(c,r)){var p=c[r];if(null!=
p)switch(r){case "children":f=p;break;case "selected":n=p;break;case "dangerouslySetInnerHTML":k=p;break;case "value":d=p;default:M(a,r,p)}}if(null!=e)if(c=null!==d?""+d:hb(f),ua(e))for(d=0;d<e.length;d++){if(""+e[d]===c){a.push(ib);break}}else""+e===c&&a.push(ib);else n&&a.push(ib);a.push(P);Q(a,k,f);return f;case "textarea":a.push(T("textarea"));k=f=e=null;for(var x in c)if(B.call(c,x)&&(d=c[x],null!=d))switch(x){case "children":k=d;break;case "value":e=d;break;case "defaultValue":f=d;break;case "dangerouslySetInnerHTML":throw Error("`dangerouslySetInnerHTML` does not make sense on <textarea>.");
default:M(a,x,d)}null===e&&null!==f&&(e=f);a.push(P);if(null!=k){if(null!=e)throw Error("If you supply `defaultValue` on a <textarea>, do not pass children.");if(ua(k)&&1<k.length)throw Error("<textarea> can only have at most one child.");e=""+k}"string"===typeof e&&"\n"===e[0]&&a.push(ob);null!==e&&a.push(C(""+e));return null;case "input":a.push(T("input"));var t=null,v=r=null;p=n=d=f=g=x=null;for(k in c)if(B.call(c,k)&&(m=c[k],null!=m))switch(k){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");
case "name":t=m;break;case "formAction":r=m;break;case "formEncType":v=m;break;case "formMethod":x=m;break;case "formTarget":g=m;break;case "defaultChecked":p=m;break;case "defaultValue":d=m;break;case "checked":n=m;break;case "value":f=m;break;default:M(a,k,m)}c=gb(a,e,r,v,x,g,t);null!==n?cb(a,"checked",n):null!==p&&cb(a,"checked",p);null!==f?M(a,"value",f):null!==d&&M(a,"value",d);a.push(fb);null!==c&&c.forEach(eb,a);return null;case "button":a.push(T("button"));v=r=t=n=d=k=f=null;for(p in c)if(B.call(c,
p)&&(x=c[p],null!=x))switch(p){case "children":f=x;break;case "dangerouslySetInnerHTML":k=x;break;case "name":d=x;break;case "formAction":n=x;break;case "formEncType":t=x;break;case "formMethod":r=x;break;case "formTarget":v=x;break;default:M(a,p,x)}c=gb(a,e,n,t,r,v,d);a.push(P);null!==c&&c.forEach(eb,a);Q(a,k,f);"string"===typeof f?(a.push(C(f)),a=null):a=f;return a;case "form":a.push(T("form"));p=n=d=k=f=e=null;for(t in c)if(B.call(c,t)&&(r=c[t],null!=r))switch(t){case "children":e=r;break;case "dangerouslySetInnerHTML":f=
r;break;case "action":k=r;break;case "encType":d=r;break;case "method":n=r;break;case "target":p=r;break;default:M(a,t,r)}null!=k&&M(a,"action",k);null!=d&&M(a,"encType",d);null!=n&&M(a,"method",n);null!=p&&M(a,"target",p);a.push(P);Q(a,f,e);"string"===typeof e?(a.push(C(e)),a=null):a=e;return a;case "menuitem":a.push(T("menuitem"));for(var D in c)if(B.call(c,D)&&(e=c[D],null!=e))switch(D){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");
...
k;break;case "dangerouslySetInnerHTML":f=k;break;default:M(a,v,k)}a.push(P);c=Array.isArray(e)?2>e.length?e[0]:null:e;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(C(""+c));Q(a,f,e);a.push(U,"style",V);a=null}else{p="[style]"+k;t=d.stylesMap.get(p);if(!t){(t=d.stylePrecedences.get(e))?t.props.hrefs.push(k):(t={type:"style",chunks:[],state:0,props:{precedence:e,hrefs:[k]}},d.stylePrecedences.set(e,t),k=new Set,k.add(t),d.precedences.set(e,k));d.stylesMap.set(p,t);d.boundaryResources&&
d.boundaryResources.add(t);e=t.chunks;d=k=null;for(n in c)if(B.call(c,n)&&(p=c[n],null!=p))switch(n){case "children":k=p;break;case "dangerouslySetInnerHTML":d=p}c=Array.isArray(k)?2>k.length?k[0]:null:k;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&e.push(C(""+c));Q(e,d,k)}f&&a.push(G);a=void 0}return a;case "meta":return 3===g.insertionMode||g.noscriptTagInScope||null!=c.itemProp?a=kb(a,c,"meta"):(f&&a.push(G),a="string"===typeof c.charSet?kb(e.charsetChunks,c,"meta"):"viewport"===
c.name?kb(e.preconnectChunks,c,"meta"):kb(e.hoistableChunks,c,"meta")),a;case "listing":case "pre":a.push(T(b));f=e=null;for(var u in c)if(B.call(c,u)&&(k=c[u],null!=k))switch(u){case "children":e=k;break;case "dangerouslySetInnerHTML":f=k;break;default:M(a,u,k)}a.push(P);if(null!=f){if(null!=e)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");if("object"!==typeof f||!("__html"in f))throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");
...
integrity:b.integrity,type:b.type,nonce:b.nonce,fetchPriority:b.fetchPriority,imageSrcSet:b.imageSrcSet,imageSizes:b.imageSizes,referrerPolicy:b.referrerPolicy}},d.preloadsMap.set(g,f),R(f.chunks,f.props));"font"===e?d.fontPreloads.add(f):d.explicitPreloads.add(f);md(c)}}}
...
function Me(a){if(2!==a.status){var b=Md,c=Ge.current;Ge.current=Ee;var d=He.current;He.current=Fe;var e=Ke;Ke=a;var g=De;De=a.responseState;try{var f=a.pingedTasks,m;for(m=0;m<f.length;m++){var k=f[m];var n=a,r=k.blockedBoundary;n.resources.boundaryResources=r?r.resources:null;var p=k.blockedSegment;if(0===p.status){Sd(k.context);var x=p.children.length,t=p.chunks.length;try{var v=k.thenableState;k.thenableState=null;Z(n,k,v,k.node);p.lastPushedText&&p.textEmbedded&&p.chunks.push(G);k.abortSet.delete(k);
p.status=1;Ye(n,k.blockedBoundary,p)}catch(L){te();p.children.length=x;p.chunks.length=t;var D=L===ae?ee():L;if("object"===typeof D&&null!==D&&"function"===typeof D.then){var u=k.ping;D.then(u,u);k.thenableState=ue()}else{k.abortSet.delete(k);p.status=4;var F=n,O=k.blockedBoundary,ja=D,xa=Pe(F,ja);null===O?Qe(F,ja):(O.pendingTasks--,O.forceClientRender||(O.forceClientRender=!0,O.errorDigest=xa,O.parentFlushed&&F.clientRenderedBoundaries.push(O)));F.allPendingTasks--;if(0===F.allPendingTasks){var S=
...
T("head")),q(b,P)}else if(p)for(f=0;f<p.length;f++)q(b,p[f]);var x=g.charsetChunks;for(f=0;f<x.length;f++)q(b,x[f]);x.length=0;e.preconnects.forEach(Uc,b);e.preconnects.clear();var t=g.preconnectChunks;for(f=0;f<t.length;f++)q(b,t[f]);t.length=0;e.fontPreloads.forEach(Uc,b);e.fontPreloads.clear();e.precedences.forEach(cd,b);e.bootstrapScripts.forEach(Uc,b);e.scripts.forEach(Uc,b);e.scripts.clear();e.explicitPreloads.forEach(Uc,b);e.explicitPreloads.clear();var v=g.preloadChunks;for(f=0;f<v.length;f++)q(b,
v[f]);v.length=0;var D=g.hoistableChunks;for(f=0;f<D.length;f++)q(b,D[f]);D.length=0;r&&null===p&&(q(b,U),q(b,"head"),q(b,V));bf(a,b,d);a.completedRootSegment=null;tb(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var u=a.resources,F=a.responseState;d=0;u.preconnects.forEach(Vc,b);u.preconnects.clear();var O=F.preconnectChunks;for(d=0;d<O.length;d++)q(b,O[d]);O.length=0;u.fontPreloads.forEach(Vc,b);u.fontPreloads.clear();u.precedences.forEach(ed,b);u.scripts.forEach(Vc,b);u.scripts.clear();
u.explicitPreloads.forEach(Vc,b);u.explicitPreloads.clear();var ja=F.preloadChunks;for(d=0;d<ja.length;d++)q(b,ja[d]);ja.length=0;var xa=F.hoistableChunks;for(d=0;d<xa.length;d++)q(b,xa[d]);xa.length=0;var S=a.clientRenderedBoundaries;for(c=0;c<S.length;c++){var L=S[c];u=b;var N=a.responseState,Hc=L.id,Ab=L.errorDigest,Wa=L.errorMessage,ya=L.errorComponentStack,ka=0===N.streamingFormat;ka?(q(u,N.startInlineScript),0===(N.instructions&4)?(N.instructions|=4,q(u,wc)):q(u,xc)):q(u,Bc);if(null===Hc)throw Error("An ID must have been assigned before we can complete the boundary.");
q(u,Hc);ka&&q(u,yc);if(Ab||Wa||ya)ka?(q(u,zc),q(u,Gc(Ab||""))):(q(u,Cc),q(u,C(Ab||"")));if(Wa||ya)ka?(q(u,zc),q(u,Gc(Wa||""))):(q(u,Dc),q(u,C(Wa||"")));ya&&(ka?(q(u,zc),q(u,Gc(ya))):(q(u,Ec),q(u,C(ya))));if(ka?!y(u,Ac):!y(u,Ea)){a.destination=null;c++;S.splice(0,c);return}}S.splice(0,c);var Xa=a.completedBoundaries;for(c=0;c<Xa.length;c++)if(!df(a,b,Xa[c])){a.destination=null;c++;Xa.splice(0,c);return}Xa.splice(0,c);ia(b);h=new Uint8Array(2048);l=0;fa=!0;var Ya=a.partialBoundaries;for(c=0;c<Ya.length;c++){var Za=
Ya[c];a:{S=a;L=b;S.resources.boundaryResources=Za.resources;var $a=Za.completedSegments;for(N=0;N<$a.length;N++)if(!ef(S,L,Za,$a[N])){N++;$a.splice(0,N);var Ic=!1;break a}$a.splice(0,N);Ic=Tc(L,Za.resources,S.responseState)}if(!Ic){a.destination=null;c++;Ya.splice(0,c);return}}Ya.splice(0,c);var ab=a.completedBoundaries;for(c=0;c<ab.length;c++)if(!df(a,b,ab[c])){a.destination=null;c++;ab.splice(0,c);return}ab.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&
0===a.completedBoundaries.length?(a.flushScheduled=!1,a=a.responseState,a.hasBody&&(q(b,U),q(b,"body"),q(b,V)),a.htmlChunks&&(q(b,U),q(b,"html"),q(b,V)),ia(b),ea(b),b.end()):(ia(b),ea(b))}}function ff(a){a.flushScheduled=null!==a.destination;setImmediate(function(){return od.run(a,Me,a)})}function md(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setImmediate(function(){return $e(a,b)})}}
...
function lf(a,b){var c={preloadsMap:new Map,preconnectsMap:new Map,stylesMap:new Map,scriptsMap:new Map,preconnects:new Set,fontPreloads:new Set,precedences:new Map,stylePrecedences:new Map,bootstrapScripts:new Set,scripts:new Set,explicitPreloads:new Set,boundaryResources:null},d=b?b.identifierPrefix:void 0;var e=b?b.nonce:void 0;var g=b?b.bootstrapScriptContent:void 0,f=b?b.bootstrapScripts:void 0,m=b?b.bootstrapModules:void 0,k=b?b.unstable_externalRuntimeSrc:void 0;d=void 0===d?"":d;var n=void 0===
e?Fa:z('<script nonce="'+C(e)+'">'),r=[],p=null,x=0;void 0!==g&&r.push(n,(""+g).replace(Na,Oa),Ga);void 0!==k&&(x=1,"string"===typeof k?(p={src:k,chunks:[]},mb(p.chunks,{src:k,async:!0,integrity:void 0,nonce:e})):(p={src:k.src,chunks:[]},mb(p.chunks,{src:k.src,async:!0,integrity:k.integrity,nonce:e})));if(void 0!==f)for(g=0;g<f.length;g++){var t=f[g];k="string"===typeof t?t:t.src;var v="string"===typeof t?void 0:t.integrity;t="string"===typeof t||null==t.crossOrigin?void 0:"use-credentials"===t.crossOrigin?
"use-credentials":"";var D={rel:"preload",href:k,as:"script",fetchPriority:"low",nonce:e,integrity:v,crossOrigin:t},u={type:"preload",chunks:[],state:0,props:D};c.preloadsMap.set("[script]"+k,u);c.bootstrapScripts.add(u);R(u.chunks,D);r.push(Ha,C(k));e&&r.push(Ja,C(e));v&&r.push(Ka,C(v));"string"===typeof t&&r.push(La,C(t));r.push(Ma)}if(void 0!==m)for(f=0;f<m.length;f++)v=m[f],g="string"===typeof v?v:v.src,k="string"===typeof v?void 0:v.integrity,v="string"===typeof v||null==v.crossOrigin?void 0:
"use-credentials"===v.crossOrigin?"use-credentials":"",t={rel:"modulepreload",href:g,fetchPriority:"low",nonce:e,integrity:k,crossOrigin:v},D={type:"preload",chunks:[],state:0,props:t},c.preloadsMap.set("[script]"+g,D),c.bootstrapScripts.add(D),R(D.chunks,t),r.push(Ia,C(g)),e&&r.push(Ja,C(e)),k&&r.push(Ka,C(k)),"string"===typeof v&&r.push(La,C(v)),r.push(Ma);e={bootstrapChunks:r,placeholderPrefix:z(d+"P:"),segmentPrefix:z(d+"S:"),boundaryPrefix:d+"B:",idPrefix:d,nextSuspenseID:0,streamingFormat:x,
startInlineScript:n,instructions:0,externalRuntimeScript:p,htmlChunks:null,headChunks:null,hasBody:!1,charsetChunks:[],preconnectChunks:[],preloadChunks:[],hoistableChunks:[],stylesToHoist:!1,nonce:e};m=b?b.namespaceURI:void 0;m=E("http://www.w3.org/2000/svg"===m?3:"http://www.w3.org/1998/Math/MathML"===m?4:0,null,!1);n=b?b.progressiveChunkSize:void 0;r=b?b.onError:void 0;p=b?b.onAllReady:void 0;x=b?b.onShellReady:void 0;f=b?b.onShellError:void 0;wa.current=Da;b=[];d=new Set;c={destination:null,flushScheduled:!1,
responseState:e,progressiveChunkSize:void 0===n?12800:n,status:0,fatalError:null,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,resources:c,completedRootSegment:null,abortableTasks:d,pingedTasks:b,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===r?Ie:r,onAllReady:void 0===p?Je:p,onShellReady:void 0===x?Je:x,onShellError:void 0===f?Je:f,onFatalError:Je};e=Oe(c,0,null,m,!1,!1);e.parentFlushed=!0;a=Ne(c,null,a,null,e,d,Kd,null,Vd);b.push(a);return c}
exports.renderToPipeableStream=function(a,b){var c=lf(a,b),d=!1;ff(c);return{pipe:function(e){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;gf(c,e);e.on("drain",jf(e,c));e.on("error",kf(c,"The destination stream errored while writing data."));e.on("close",kf(c,"The destination stream closed early."));return e},abort:function(e){hf(c,e)}}};exports.version="18.3.0-canary-cb3404a0c-20230807";
