...
if (canUseDOM) {
  var JSCompiler_inline_result$jscomp$265;
  if (canUseDOM) {
    var isSupported$jscomp$inline_398 = "oninput" in document;
    if (!isSupported$jscomp$inline_398) {
      var element$jscomp$inline_399 = document.createElement("div");
      element$jscomp$inline_399.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_398 =
        "function" === typeof element$jscomp$inline_399.oninput;
    }
    JSCompiler_inline_result$jscomp$265 = isSupported$jscomp$inline_398;
  } else JSCompiler_inline_result$jscomp$265 = !1;
  isInputEventSupported =
    JSCompiler_inline_result$jscomp$265 &&
...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_439 = 0;
  i$jscomp$inline_439 < simpleEventPluginEvents.length;
  i$jscomp$inline_439++
) {
  var eventName$jscomp$inline_440 =
      simpleEventPluginEvents[i$jscomp$inline_439],
    domEventName$jscomp$inline_441 = eventName$jscomp$inline_440.toLowerCase(),
    capitalizedEvent$jscomp$inline_442 =
      eventName$jscomp$inline_440[0].toUpperCase() +
      eventName$jscomp$inline_440.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_441,
    "on" + capitalizedEvent$jscomp$inline_442
  );
}
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$188 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$188 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$188
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$188.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$189 = completedWork.child; null !== child$189; )
      (newChildLanes |= child$189.lanes | child$189.childLanes),
        (subtreeFlags |= child$189.subtreeFlags & 31457280),
        (subtreeFlags |= child$189.flags & 31457280),
        (child$189.return = completedWork),
        (child$189 = child$189.sibling);
  else
    for (child$189 = completedWork.child; null !== child$189; )
      (newChildLanes |= child$189.lanes | child$189.childLanes),
        (subtreeFlags |= child$189.subtreeFlags),
        (subtreeFlags |= child$189.flags),
        (child$189.return = completedWork),
        (child$189 = child$189.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$201 = newProps.memoizedState.cachePool.pool);
        cache$201 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      cache$201 = currentResource.rendering;
      if (null === cache$201)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$201 = findFirstSuspended(current);
              if (null !== cache$201) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$201.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$201)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$201.sibling = workInProgress.child),
            (workInProgress.child = cache$201))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$201)
              : (workInProgress.child = cache$201),
            (currentResource.last = cache$201));
      }
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$227 = getResourcesFromRoot(currentProps).hoistableStyles,
          resource$228 = styles$227.get(type);
        resource$228 ||
          ...
          styles$227.set(type, resource$228),
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        var instance$232 = hoistableRoot.querySelector(
          getStylesheetSelectorFromKey(styleProps)
        );
        if (instance$232)
          return (
            (resource.state.loading |= 4),
            (resource.instance = instance$232),
            markNodeAsHoistable(instance$232),
            instance$232
          );
        ...
        markNodeAsHoistable(instance$232);
        var linkInstance = instance$232;
        linkInstance._p = new Promise(function (resolve, reject) {
          linkInstance.onload = resolve;
          linkInstance.onerror = reject;
        });
        setInitialProperties(instance$232, "link", instance);
        resource.state.loading |= 4;
        insertStylesheet(instance$232, props.precedence, hoistableRoot);
        return (resource.instance = instance$232);
      case "script":
        instance$232 = getScriptKey(props.src);
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$232)
          ))
        )
          return (
        ...
        instance = props;
        if ((styleProps = preloadPropsMap.get(instance$232)))
...
var devToolsConfig$jscomp$inline_1632 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "19.0.0-canary-db913d8e17-20240422",
  rendererPackageName: "react-dom"
};
var internals$jscomp$inline_2011 = {
  bundleType: devToolsConfig$jscomp$inline_1632.bundleType,
  version: devToolsConfig$jscomp$inline_1632.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1632.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1632.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1632.findFiberByHostInstance ||
  ...
  reconcilerVersion: "19.0.0-canary-db913d8e17-20240422"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2012 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2012.isDisabled &&
    hook$jscomp$inline_2012.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2012.inject(
        internals$jscomp$inline_2011
      )),
        (injectedHook = hook$jscomp$inline_2012);
    } catch (err) {}
}
