...
exports.renderToPipeableStream=function(a,b){var c=bd(a,b),d=!1;Xc(c);return{pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Yc(c,a);a.on("drain",$c(a,c));a.on("close",ad(c));return a},abort:function(){Zc(c)}}};exports.version="18.2.0-next-c7e494b55-20220503";
