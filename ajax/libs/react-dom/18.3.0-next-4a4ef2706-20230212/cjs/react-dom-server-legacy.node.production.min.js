...
var p=Object.assign,q=Object.prototype.hasOwnProperty,ea=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,fa={},ha={};
...
function za(a,b){if("object"!==typeof b)throw Error("The `style` prop expects a mapping from style properties to values, not a string. For example, style={{marginRight: spacing + 'em'}} when using JSX.");var c=!0,d;for(d in b)if(q.call(b,d)){var e=b[d];if(null!=e&&"boolean"!==typeof e&&""!==e){if(0===d.indexOf("--")){var f=v(d);e=v((""+e).trim())}else{f=d;var g=ya.get(f);void 0!==g?f=g:(g=v(f.replace(na,"-$1").toLowerCase().replace(oa,"-ms-")),ya.set(f,g),f=g);e="number"===typeof e?0===e||q.call(u,
...
function Oa(a){return JSON.stringify(a).replace(Na,function(a){switch(a){case "<":return"\\u003c";case "\u2028":return"\\u2028";case "\u2029":return"\\u2029";default:throw Error("escapeJSStringsForInstructionScripts encountered a match it does not know how to replace. this means the match regex and the replacement characters are no longer in sync. This is a bug in React");}})}var Pa=/[&><\u2028\u2029]/g;
function I(a){return JSON.stringify(a).replace(Pa,function(a){switch(a){case "&":return"\\u0026";case ">":return"\\u003e";case "<":return"\\u003c";case "\u2028":return"\\u2028";case "\u2029":return"\\u2029";default:throw Error("escapeJSObjectForInstructionScripts encountered a match it does not know how to replace. this means the match regex and the replacement characters are no longer in sync. This is a bug in React");}})}var Qa=!1;
...
default:a:{d=a;var l=k;g=l.toLowerCase();switch(typeof h){case "function":case "symbol":break a}switch(l){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;case "className":g="class";break;case "hidden":if(!1===h)break a;break;case "src":case "href":break;default:if(!ia(l))break a}if(!(2<l.length)||"o"!==l[0]&&"O"!==l[0]||"n"!==l[1]&&"N"!==l[1])h=""+h,d.push(","),g=I(g),d.push(g),d.push(","),g=I(h),d.push(g)}}}a.push("]");
c=",[";b.state|=2}});a.push("]")}
...
function Sc(a,b,c,d){var e=!1,f=null,g="",k=!1;a=vc(a,eb(c,b?b.identifierPrefix:void 0),fb(),Infinity,Rc,void 0,function(){k=!0},void 0,void 0);yc(a);Qc(a,d);Pc(a,{push:function(a){null!==a&&(g+=a);return!0},destroy:function(a){e=!0;f=a}});if(e&&f!==d)throw f;if(!k)throw Error("A component suspended while responding to synchronous input. This will cause the UI to be replaced with a loading indicator. To fix, updates that suspend should be wrapped with startTransition.");return g}
function Tc(a,b){a.prototype=Object.create(b.prototype);a.prototype.constructor=a;a.__proto__=b}var Uc=function(a){function b(){var b=a.call(this,{})||this;b.request=null;b.startedFlowing=!1;return b}Tc(b,a);var c=b.prototype;c._destroy=function(a,b){Qc(this.request);b(a)};c._read=function(){this.startedFlowing&&Pc(this.request,this)};return b}(ca.Readable);function Vc(){}
...
exports.version="18.3.0-next-4a4ef2706-20230212";
