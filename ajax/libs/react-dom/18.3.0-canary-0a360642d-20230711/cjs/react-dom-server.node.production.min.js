...
integrity:b.integrity,type:b.type,nonce:b.nonce,fetchPriority:b.fetchPriority,imageSrcSet:b.imageSrcSet,imageSizes:b.imageSizes}},d.preloadsMap.set(g,f),R(f.chunks,f.props));switch(e){case "font":d.fontPreloads.add(f);break;case "style":d.explicitStylesheetPreloads.add(f);break;case "script":d.explicitScriptPreloads.add(f);break;default:d.explicitOtherPreloads.add(f)}md(c)}}}
...
function Z(a,b,c,d){b.node=d;if("object"===typeof d&&null!==d){switch(d.$$typeof){case pd:Te(a,b,c,d.type,d.props,d.ref);return;case qd:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");case Bd:c=d._init;d=c(d._payload);Z(a,b,null,d);return}if(ua(d)){We(a,b,d);return}null===d||"object"!==typeof d?c=null:(c=Id&&d[Id]||d["@@iterator"],c="function"===typeof c?c:null);if(c&&(c=c.call(d))){d=c.next();if(!d.done){var e=
[];do e.push(d.value),d=c.next();while(!d.done);We(a,b,e)}return}if("function"===typeof d.then)return Z(a,b,null,Ae(d));if(d.$$typeof===vd||d.$$typeof===wd)return Z(a,b,null,d._currentValue);a=Object.prototype.toString.call(d);throw Error("Objects are not valid as a React child (found: "+("[object Object]"===a?"object with keys {"+Object.keys(d).join(", ")+"}":a)+"). If you meant to render a collection of children, use an array instead.");}"string"===typeof d?(c=b.blockedSegment,c.lastPushedText=
Qa(b.blockedSegment.chunks,d,a.responseState,c.lastPushedText)):"number"===typeof d&&(c=b.blockedSegment,c.lastPushedText=Qa(b.blockedSegment.chunks,""+d,a.responseState,c.lastPushedText))}function We(a,b,c){for(var d=c.length,e=0;e<d;e++){var g=b.treeContext;b.treeContext=Wd(g,d,e);try{Ue(a,b,c[e])}finally{b.treeContext=g}}}
function Ue(a,b,c){var d=b.blockedSegment,e=d.children.length,g=d.chunks.length,f=b.blockedSegment.formatContext,m=b.legacyContext,k=b.context;try{return Z(a,b,null,c)}catch(n){if(te(),d.children.length=e,d.chunks.length=g,c=n===ae?ee():n,"object"===typeof c&&null!==c&&"function"===typeof c.then)d=ue(),e=b.blockedSegment,g=Oe(a,e.chunks.length,null,e.formatContext,e.lastPushedText,!0),e.children.push(g),e.lastPushedText=!1,a=Ne(a,d,b.node,b.blockedBoundary,g,b.abortSet,b.legacyContext,b.context,b.treeContext).ping,
c.then(a,a),b.blockedSegment.formatContext=f,b.legacyContext=m,b.context=k,Sd(k);else throw b.blockedSegment.formatContext=f,b.legacyContext=m,b.context=k,Sd(k),c;}}function Xe(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Ye(this,b,a)}
function Ze(a,b,c){var d=a.blockedBoundary;a.blockedSegment.status=3;null===d?(b.allPendingTasks--,1!==b.status&&2!==b.status&&(Pe(b,c),Qe(b,c))):(d.pendingTasks--,d.forceClientRender||(d.forceClientRender=!0,d.errorDigest=b.onError(c),d.parentFlushed&&b.clientRenderedBoundaries.push(d)),d.fallbackAbortableTasks.forEach(function(e){return Ze(e,b,c)}),d.fallbackAbortableTasks.clear(),b.allPendingTasks--,0===b.allPendingTasks&&(a=b.onAllReady,a()))}
function Ve(a,b){if(0===b.chunks.length&&1===b.children.length&&null===b.children[0].boundary){var c=b.children[0];c.id=b.id;c.parentFlushed=!0;1===c.status&&Ve(a,c)}else a.completedSegments.push(b)}
function Ye(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error("There can only be one root segment. This is a bug in React.");a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onShellError=Je,b=a.onShellReady,b())}else b.pendingTasks--,b.forceClientRender||(0===b.pendingTasks?(c.parentFlushed&&1===c.status&&Ve(b,c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Xe,a),b.fallbackAbortableTasks.clear()):c.parentFlushed&&
1===c.status&&(Ve(b,c),1===b.completedSegments.length&&b.parentFlushed&&a.partialBoundaries.push(b)));a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onAllReady,a())}
function Me(a){if(2!==a.status){var b=Md,c=Ge.current;Ge.current=Ee;var d=He.current;He.current=Fe;var e=Ke;Ke=a;var g=De;De=a.responseState;try{var f=a.pingedTasks,m;for(m=0;m<f.length;m++){var k=f[m];var n=a,t=k.blockedBoundary;n.resources.boundaryResources=t?t.resources:null;var p=k.blockedSegment;if(0===p.status){Sd(k.context);var x=p.children.length,u=p.chunks.length;try{var v=k.thenableState;k.thenableState=null;Z(n,k,v,k.node);p.lastPushedText&&p.textEmbedded&&p.chunks.push(G);k.abortSet.delete(k);
p.status=1;Ye(n,k.blockedBoundary,p)}catch(L){te();p.children.length=x;p.chunks.length=u;var D=L===ae?ee():L;if("object"===typeof D&&null!==D&&"function"===typeof D.then){var r=k.ping;D.then(r,r);k.thenableState=ue()}else{k.abortSet.delete(k);p.status=4;var F=n,O=k.blockedBoundary,la=D,xa=Pe(F,la);null===O?Qe(F,la):(O.pendingTasks--,O.forceClientRender||(O.forceClientRender=!0,O.errorDigest=xa,O.parentFlushed&&F.clientRenderedBoundaries.push(O)));F.allPendingTasks--;if(0===F.allPendingTasks){var S=
F.onAllReady;S()}}}finally{n.resources.boundaryResources=null}}}f.splice(0,m);null!==a.destination&&$e(a,a.destination)}catch(L){Pe(a,L),Qe(a,L)}finally{De=g,Ge.current=c,He.current=d,c===Ee&&Sd(b),Ke=e}}}
function af(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;q(b,ub);q(b,a.placeholderPrefix);a=d.toString(16);q(b,a);return y(b,vb);case 1:c.status=2;var e=!0;d=c.chunks;var g=0;c=c.children;for(var f=0;f<c.length;f++){for(e=c[f];g<e.index;g++)q(b,d[g]);e=bf(a,b,e)}for(;g<d.length-1;g++)q(b,d[g]);g<d.length&&(e=y(b,d[g]));return e;default:throw Error("Aborted, errored or already flushed boundaries should not be flushed again. This is a bug in React.");
}}
function bf(a,b,c){var d=c.boundary;if(null===d)return af(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,y(b,zb),q(b,Cb),d&&(q(b,Eb),q(b,C(d)),q(b,Db)),y(b,Fb),af(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var g=e.nextSuspenseID++;e=z(e.boundaryPrefix+g.toString(16));d=d.id=e;Gb(b,a.responseState,d);af(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),
Gb(b,a.responseState,d.id),af(a,b,c);else{(c=a.resources.boundaryResources)&&d.resources.forEach(nd,c);y(b,wb);c=d.completedSegments;if(1!==c.length)throw Error("A previously unvisited boundary must have exactly one root segment. This is a bug in React.");bf(a,b,c[0])}return y(b,Bb)}function cf(a,b,c){bc(b,a.responseState,c.formatContext,c.id);bf(a,b,c);return cc(b,c.formatContext)}
function df(a,b,c){a.resources.boundaryResources=c.resources;for(var d=c.completedSegments,e=0;e<d.length;e++)ef(a,b,c,d[e]);d.length=0;Tc(b,c.resources,a.responseState);a=a.responseState;d=c.id;e=c.rootSegmentID;c=c.resources;var g=a.stylesToHoist;a.stylesToHoist=!1;var f=0===a.streamingFormat;f?(q(b,a.startInlineScript),g?0===(a.instructions&2)?(a.instructions|=10,q(b,2048<lc.length?lc.slice():lc)):0===(a.instructions&8)?(a.instructions|=8,q(b,mc)):q(b,nc):0===(a.instructions&2)?(a.instructions|=
2,q(b,jc)):q(b,kc)):g?q(b,tc):q(b,sc);if(null===d)throw Error("An ID must have been assigned before we can complete the boundary.");e=e.toString(16);q(b,d);f?q(b,oc):q(b,uc);q(b,a.segmentPrefix);q(b,e);g?f?(q(b,pc),jd(b,c)):(q(b,vc),kd(b,c)):f&&q(b,qc);d=f?y(b,rc):y(b,Ea);return tb(b,a)&&d}
function ef(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error("A root segment ID must have been assigned by now. This is a bug in React.");return cf(a,b,d)}cf(a,b,d);a=a.responseState;(c=0===a.streamingFormat)?(q(b,a.startInlineScript),0===(a.instructions&1)?(a.instructions|=1,q(b,dc)):q(b,ec)):q(b,hc);q(b,a.segmentPrefix);e=e.toString(16);q(b,e);c?q(b,fc):q(b,ic);q(b,a.placeholderPrefix);q(b,e);b=c?y(b,gc):y(b,Ea);return b}
function $e(a,b){h=new Uint8Array(2048);l=0;fa=!0;try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){var e=a.resources,g=a.responseState;if(0!==a.allPendingTasks&&g.externalRuntimeScript){var f=g.externalRuntimeScript,m=f.chunks,k="[script]"+f.src,n=e.scriptsMap.get(k);n||(n={type:"script",chunks:m,state:0,props:null},e.scriptsMap.set(k,n),e.scripts.add(n))}var t=g.htmlChunks,p=g.headChunks;f=0;if(t){for(f=0;f<t.length;f++)q(b,t[f]);if(p)for(f=0;f<p.length;f++)q(b,p[f]);else q(b,
T("head")),q(b,P)}else if(p)for(f=0;f<p.length;f++)q(b,p[f]);var x=g.charsetChunks;for(f=0;f<x.length;f++)q(b,x[f]);x.length=0;e.preconnects.forEach(Uc,b);e.preconnects.clear();var u=g.preconnectChunks;for(f=0;f<u.length;f++)q(b,u[f]);u.length=0;e.fontPreloads.forEach(Uc,b);e.fontPreloads.clear();e.precedences.forEach(cd,b);e.scripts.forEach(Uc,b);e.scripts.clear();e.explicitStylesheetPreloads.forEach(Uc,b);e.explicitStylesheetPreloads.clear();e.explicitScriptPreloads.forEach(Uc,b);e.explicitScriptPreloads.clear();
e.explicitOtherPreloads.forEach(Uc,b);e.explicitOtherPreloads.clear();var v=g.preloadChunks;for(f=0;f<v.length;f++)q(b,v[f]);v.length=0;var D=g.hoistableChunks;for(f=0;f<D.length;f++)q(b,D[f]);D.length=0;t&&null===p&&(q(b,U),q(b,"head"),q(b,V));bf(a,b,d);a.completedRootSegment=null;tb(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var r=a.resources,F=a.responseState;d=0;r.preconnects.forEach(Vc,b);r.preconnects.clear();var O=F.preconnectChunks;for(d=0;d<O.length;d++)q(b,O[d]);
O.length=0;r.fontPreloads.forEach(Vc,b);r.fontPreloads.clear();r.precedences.forEach(ed,b);r.scripts.forEach(Vc,b);r.scripts.clear();r.explicitStylesheetPreloads.forEach(Vc,b);r.explicitStylesheetPreloads.clear();r.explicitScriptPreloads.forEach(Vc,b);r.explicitScriptPreloads.clear();r.explicitOtherPreloads.forEach(Vc,b);r.explicitOtherPreloads.clear();var la=F.preloadChunks;for(d=0;d<la.length;d++)q(b,la[d]);la.length=0;var xa=F.hoistableChunks;for(d=0;d<xa.length;d++)q(b,xa[d]);xa.length=0;var S=
a.clientRenderedBoundaries;for(c=0;c<S.length;c++){var L=S[c];r=b;var N=a.responseState,Hc=L.id,Ab=L.errorDigest,Wa=L.errorMessage,ya=L.errorComponentStack,ma=0===N.streamingFormat;ma?(q(r,N.startInlineScript),0===(N.instructions&4)?(N.instructions|=4,q(r,wc)):q(r,xc)):q(r,Bc);if(null===Hc)throw Error("An ID must have been assigned before we can complete the boundary.");q(r,Hc);ma&&q(r,yc);if(Ab||Wa||ya)ma?(q(r,zc),q(r,Gc(Ab||""))):(q(r,Cc),q(r,C(Ab||"")));if(Wa||ya)ma?(q(r,zc),q(r,Gc(Wa||""))):(q(r,
Dc),q(r,C(Wa||"")));ya&&(ma?(q(r,zc),q(r,Gc(ya))):(q(r,Ec),q(r,C(ya))));if(ma?!y(r,Ac):!y(r,Ea)){a.destination=null;c++;S.splice(0,c);return}}S.splice(0,c);var Xa=a.completedBoundaries;for(c=0;c<Xa.length;c++)if(!df(a,b,Xa[c])){a.destination=null;c++;Xa.splice(0,c);return}Xa.splice(0,c);ia(b);h=new Uint8Array(2048);l=0;fa=!0;var Ya=a.partialBoundaries;for(c=0;c<Ya.length;c++){var Za=Ya[c];a:{S=a;L=b;S.resources.boundaryResources=Za.resources;var $a=Za.completedSegments;for(N=0;N<$a.length;N++)if(!ef(S,
L,Za,$a[N])){N++;$a.splice(0,N);var Ic=!1;break a}$a.splice(0,N);Ic=Tc(L,Za.resources,S.responseState)}if(!Ic){a.destination=null;c++;Ya.splice(0,c);return}}Ya.splice(0,c);var ab=a.completedBoundaries;for(c=0;c<ab.length;c++)if(!df(a,b,ab[c])){a.destination=null;c++;ab.splice(0,c);return}ab.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length?(a.flushScheduled=!1,a=a.responseState,a.hasBody&&(q(b,U),q(b,"body"),
q(b,V)),a.htmlChunks&&(q(b,U),q(b,"html"),q(b,V)),ia(b),ea(b),b.end()):(ia(b),ea(b))}}function ff(a){a.flushScheduled=null!==a.destination;setImmediate(function(){return od.run(a,Me,a)})}function md(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setImmediate(function(){return $e(a,b)})}}
function gf(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{$e(a,b)}catch(c){Pe(a,c),Qe(a,c)}}}function hf(a,b){try{var c=a.abortableTasks;if(0<c.size){var d=void 0===b?Error("The render was aborted by the server without a reason."):b;c.forEach(function(e){return Ze(e,a,d)});c.clear()}null!==a.destination&&$e(a,a.destination)}catch(e){Pe(a,e),Qe(a,e)}}function jf(a,b){return function(){return gf(b,a)}}
function kf(a,b){return function(){return hf(a,Error(b))}}
function lf(a,b){var c={preloadsMap:new Map,preconnectsMap:new Map,stylesMap:new Map,scriptsMap:new Map,preconnects:new Set,fontPreloads:new Set,precedences:new Map,stylePrecedences:new Map,scripts:new Set,explicitStylesheetPreloads:new Set,explicitScriptPreloads:new Set,explicitOtherPreloads:new Set,boundaryResources:null},d=b?b.identifierPrefix:void 0;var e=b?b.nonce:void 0;var g=b?b.bootstrapScriptContent:void 0,f=b?b.bootstrapScripts:void 0,m=b?b.bootstrapModules:void 0,k=b?b.unstable_externalRuntimeSrc:
void 0;d=void 0===d?"":d;var n=void 0===e?Fa:z('<script nonce="'+C(e)+'">'),t=[],p=null,x=0;void 0!==g&&t.push(n,(""+g).replace(Na,Oa),Ga);void 0!==k&&(x=1,"string"===typeof k?(p={src:k,chunks:[]},mb(p.chunks,{src:k,async:!0,integrity:void 0,nonce:e})):(p={src:k.src,chunks:[]},mb(p.chunks,{src:k.src,async:!0,integrity:k.integrity,nonce:e})));if(void 0!==f)for(g=0;g<f.length;g++){var u=f[g];k="string"===typeof u?u:u.src;var v="string"===typeof u?void 0:u.integrity;u="string"===typeof u||null==u.crossOrigin?
void 0:"use-credentials"===u.crossOrigin?"use-credentials":"";var D={rel:"preload",href:k,as:"script",nonce:e,integrity:v,crossOrigin:u},r={type:"preload",chunks:[],state:0,props:D};c.preloadsMap.set("[script]"+k,r);c.explicitScriptPreloads.add(r);R(r.chunks,D);t.push(Ha,C(k));e&&t.push(Ja,C(e));v&&t.push(Ka,C(v));"string"===typeof u&&t.push(La,C(u));t.push(Ma)}if(void 0!==m)for(f=0;f<m.length;f++)v=m[f],g="string"===typeof v?v:v.src,k="string"===typeof v?void 0:v.integrity,v="string"===typeof v||
null==v.crossOrigin?void 0:"use-credentials"===v.crossOrigin?"use-credentials":"",u={rel:"modulepreload",href:g,nonce:e,integrity:k,crossOrigin:v},D={type:"preload",chunks:[],state:0,props:u},c.preloadsMap.set("[script]"+g,D),c.explicitScriptPreloads.add(D),R(D.chunks,u),t.push(Ia,C(g)),e&&t.push(Ja,C(e)),k&&t.push(Ka,C(k)),"string"===typeof v&&t.push(La,C(v)),t.push(Ma);e={bootstrapChunks:t,placeholderPrefix:z(d+"P:"),segmentPrefix:z(d+"S:"),boundaryPrefix:d+"B:",idPrefix:d,nextSuspenseID:0,streamingFormat:x,
startInlineScript:n,instructions:0,externalRuntimeScript:p,htmlChunks:null,headChunks:null,hasBody:!1,charsetChunks:[],preconnectChunks:[],preloadChunks:[],hoistableChunks:[],stylesToHoist:!1,nonce:e};m=b?b.namespaceURI:void 0;m=E("http://www.w3.org/2000/svg"===m?3:"http://www.w3.org/1998/Math/MathML"===m?4:0,null,!1);n=b?b.progressiveChunkSize:void 0;t=b?b.onError:void 0;p=b?b.onAllReady:void 0;x=b?b.onShellReady:void 0;f=b?b.onShellError:void 0;wa.current=Da;b=[];d=new Set;c={destination:null,flushScheduled:!1,
responseState:e,progressiveChunkSize:void 0===n?12800:n,status:0,fatalError:null,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,resources:c,completedRootSegment:null,abortableTasks:d,pingedTasks:b,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===t?Ie:t,onAllReady:void 0===p?Je:p,onShellReady:void 0===x?Je:x,onShellError:void 0===f?Je:f,onFatalError:Je};e=Oe(c,0,null,m,!1,!1);e.parentFlushed=!0;a=Ne(c,null,a,null,e,d,Kd,null,Vd);b.push(a);return c}
exports.renderToPipeableStream=function(a,b){var c=lf(a,b),d=!1;ff(c);return{pipe:function(e){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;gf(c,e);e.on("drain",jf(e,c));e.on("error",kf(c,"The destination stream errored while writing data."));e.on("close",kf(c,"The destination stream closed early."));return e},abort:function(e){hf(c,e)}}};exports.version="18.3.0-canary-0a360642d-20230711";
