...
function markComponentSuspended(fiber, wakeable, lanes) {
  {
    if (supportsUserTimingV3) {
      ...
      var componentName = getComponentNameFromFiber(fiber) || 'Unknown';
      var phase = fiber.alternate === null ? 'mount' : 'update'; // TODO (scheduling profiler) Add component stack id if we re-add component stack info.

      markAndClear("--suspense-" + eventType + "-" + id + "-" + componentName + "-" + phase + "-" + formatLanes(lanes));
