...
function Wf(a,b,c){var d=Q,e=Mf(),f=K;if(f){if(void 0===c)throw Error(r(407));c=c()}else c=b();var g=!Zc((S||e).memoizedState,c);g&&(e.memoizedState=c,Tf=!0);e=e.queue;Xf(Yf.bind(null,d,e,a),[a]);if(e.getSnapshot!==b||g||null!==T&&T.memoizedState.tag&1){d.flags|=2048;Zf(9,$f.bind(null,d,e,c,b),{destroy:void 0},null);if(null===O)throw Error(r(349));f||0!==(rf&60)||ag(d,b,c)}return c}
function ag(a,b,c){a.flags|=16384;a={getSnapshot:b,value:c};b=Q.updateQueue;null===b?(b=Nf(),Q.updateQueue=b,b.stores=[a]):(c=b.stores,null===c?b.stores=[a]:c.push(a))}function $f(a,b,c,d){b.value=c;b.getSnapshot=d;bg(b)&&cg(a)}function Yf(a,b,c){return c(function(){bg(b)&&cg(a)})}function bg(a){var b=a.getSnapshot;a=a.value;try{var c=b();return!Zc(a,c)}catch(d){return!0}}function cg(a){var b=Pd(a,2);null!==b&&dg(b,a,2)}
function eg(a){var b=Lf();"function"===typeof a&&(a=a());b.memoizedState=b.baseState=a;b.queue={pending:null,lanes:0,dispatch:null,lastRenderedReducer:Rf,lastRenderedState:a};return b}function Zf(a,b,c,d){a={tag:a,create:b,inst:c,deps:d,next:null};b=Q.updateQueue;null===b?(b=Nf(),Q.updateQueue=b,b.lastEffect=a.next=a):(c=b.lastEffect,null===c?b.lastEffect=a.next=a:(d=c.next,c.next=a,a.next=d,b.lastEffect=a));return a}function fg(){return Mf().memoizedState}
function gg(a,b,c,d){var e=Lf();Q.flags|=a;e.memoizedState=Zf(1|b,c,{destroy:void 0},void 0===d?null:d)}function hg(a,b,c,d){var e=Mf();d=void 0===d?null:d;var f=e.memoizedState.inst;null!==S&&null!==d&&Af(d,S.memoizedState.deps)?e.memoizedState=Zf(b,c,f,d):(Q.flags|=a,e.memoizedState=Zf(1|b,c,f,d))}function ig(a,b){gg(8390656,8,a,b)}function Xf(a,b){hg(2048,8,a,b)}function jg(a,b){return hg(4,2,a,b)}function kg(a,b){return hg(4,4,a,b)}
function lg(a,b){if("function"===typeof b)return a=a(),b(a),function(){b(null)};if(null!==b&&void 0!==b)return a=a(),b.current=a,function(){b.current=null}}function mg(a,b,c){c=null!==c&&void 0!==c?c.concat([a]):null;hg(4,4,lg.bind(null,b,a),c)}function ng(){}function og(a,b){var c=Mf();b=void 0===b?null:b;var d=c.memoizedState;if(null!==b&&Af(b,d[1]))return d[0];c.memoizedState=[a,b];return a}
function pg(a,b){var c=Mf();b=void 0===b?null:b;var d=c.memoizedState;if(null!==b&&Af(b,d[1]))return d[0];uf&&a();a=a();c.memoizedState=[a,b];return a}function qg(a,b,c){if(0===(rf&42))return a.baseState&&(a.baseState=!1,Tf=!0),a.memoizedState=c;Zc(c,b)||(c=jb(),Q.lanes|=c,ae|=c,a.baseState=!0);return b}function rg(a,b,c,d,e){var f=H;H=0!==f&&8>f?f:8;var g=qf.transition;qf.transition=null;sg(a,b,c);qf.transition={};try{sg(a,b,d),e()}catch(h){throw h;}finally{H=f,qf.transition=g}}
function tg(){return Mf().memoizedState}function ug(){return Mf().memoizedState}function vg(a){for(var b=a.return;null!==b;){switch(b.tag){case 24:case 3:var c=wg(b);a=Wd(c);var d=Xd(b,a,c);null!==d&&(dg(d,b,c),Yd(d,b,c));b={cache:xg()};a.payload=b;return}b=b.return}}function yg(a,b,c){var d=wg(a);c={lane:d,revertLane:0,action:c,hasEagerState:!1,eagerState:null,next:null};zg(a)?Ag(b,c):(Od(a,b,c,d),c=Qd(a),null!==c&&(dg(c,a,d),Bg(c,b,d)))}
...
function nk(a,b,c){var d=a.pingCache;if(null===d){d=a.pingCache=new Cj;var e=new Set;d.set(b,e)}else e=d.get(b),void 0===e&&(e=new Set,d.set(b,e));e.has(c)||(Ij=!0,e.add(c),a=tk.bind(null,a,b,c),b.then(a,a))}function tk(a,b,c){var d=a.pingCache;null!==d&&d.delete(b);a.pingedLanes|=a.suspendedLanes&c;O===a&&(N&c)===c&&(4===ci||3===ci&&(N&125829120)===N&&300>Qa()-jj?0===(M&2)&&ef(a,0):Kj|=c);Xe(a)}function uk(a,b){0===b&&(b=0===(a.mode&1)?2:kb());a=Pd(a,b);null!==a&&(mb(a,b),Xe(a))}
...
function Zn(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var l=Fk(g);h.call(l)}}Ek(b,g,a,e)}else g=Yn(c,b,a,e,d);return Fk(g)}var $n=da.Dispatcher;da.Events=[Fb,Gb,Hb,Fc,Gc,Zj];var ao={findFiberByHostInstance:Db,bundleType:0,version:"18.3.0-canary-0210f0b08-20230525",rendererPackageName:"react-dom"};
