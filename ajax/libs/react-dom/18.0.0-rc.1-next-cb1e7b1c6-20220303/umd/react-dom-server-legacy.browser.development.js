...
(function (global, factory) {
  ...
  function renderToStringImpl(children, options, generateStaticMarkup) {
    ...
    var request = createRequest(children, createResponseState$1(generateStaticMarkup, options ? options.identifierPrefix : undefined), createRootFormatContext(), Infinity, onError, undefined, onCompleteShell, undefined, undefined);
