 ...
 */
'use strict';var aa=require("react");function k(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var ba=!1;function m(a,b){ba&&(ba=!1,"<"!==b[0]&&a.push("\x3c!-- --\x3e"));return"\x3c!-- --\x3e"===b?ba=!0:a.push(b)}
...
Qa=Symbol.for("react.cache"),Ra=Symbol.for("react.tracing_marker"),Sa=Symbol.iterator;
function Ta(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;switch(a){case Da:return"Fragment";case Ca:return"Portal";case Fa:return"Profiler";case Ea:return"StrictMode";case Ja:return"Suspense";case Ka:return"SuspenseList";case Qa:return"Cache";case Ra:return"TracingMarker"}if("object"===typeof a)switch(a.$$typeof){case Ha:return(a.displayName||"Context")+".Consumer";case Ga:return(a._context.displayName||"Context")+".Provider";
case Ia:var b=a.render;a=a.displayName;a||(a=b.displayName||b.name||"",a=""!==a?"ForwardRef("+a+")":"ForwardRef");return a;case La:return b=a.displayName||null,null!==b?b:Ta(a.type)||"Memo";case Ma:b=a._payload;a=a._init;try{return Ta(a(b))}catch(c){}}return null}var Ua={};function Va(a,b){a=a.contextTypes;if(!a)return Ua;var c={},d;for(d in a)c[d]=b[d];return c}var E=null;
function F(a,b){if(a!==b){a.context._currentValue2=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Error(k(401));}else{if(null===c)throw Error(k(401));F(a,c)}b.context._currentValue2=b.value}}function Wa(a){a.context._currentValue2=a.parentValue;a=a.parent;null!==a&&Wa(a)}function Xa(a){var b=a.parent;null!==b&&Xa(b);a.context._currentValue2=a.value}
function Ya(a,b){a.context._currentValue2=a.parentValue;a=a.parent;if(null===a)throw Error(k(402));a.depth===b.depth?F(a,b):Ya(a,b)}function Za(a,b){var c=b.parent;if(null===c)throw Error(k(402));a.depth===c.depth?F(a,c):Za(a,c);b.context._currentValue2=b.value}function G(a){var b=E;b!==a&&(null===b?Xa(a):null===a?Wa(b):b.depth===a.depth?F(b,a):b.depth>a.depth?Ya(b,a):Za(b,a),E=a)}
...
function ab(a,b,c,d){var f=void 0!==a.state?a.state:null;a.updater=$a;a.props=c;a.state=f;var e={queue:[],replace:!1};a._reactInternals=e;var g=b.contextType;a.context="object"===typeof g&&null!==g?g._currentValue2:d;g=b.getDerivedStateFromProps;"function"===typeof g&&(g=g(c,f),f=null===g||void 0===g?f:D({},f,g),a.state=f);if("function"!==typeof b.getDerivedStateFromProps&&"function"!==typeof a.getSnapshotBeforeUpdate&&("function"===typeof a.UNSAFE_componentWillMount||"function"===typeof a.componentWillMount))if(b=
a.state,"function"===typeof a.componentWillMount&&a.componentWillMount(),"function"===typeof a.UNSAFE_componentWillMount&&a.UNSAFE_componentWillMount(),b!==a.state&&$a.enqueueReplaceState(a,a.state,null),null!==e.queue&&0<e.queue.length)if(b=e.queue,g=e.replace,e.queue=null,e.replace=!1,g&&1===b.length)a.state=b[0];else{e=g?b[0]:a.state;f=!0;for(g=g?1:0;g<b.length;g++){var h=b[g];h="function"===typeof h?h.call(a,e,c,d):h;null!=h&&(f?(f=!1,e=D({},e,h)):D(e,h))}a.state=e}else e.queue=null}
var bb={id:1,overflow:""};function cb(a,b,c){var d=a.id;a=a.overflow;var f=32-H(d)-1;d&=~(1<<f);c+=1;var e=32-H(b)+f;if(30<e){var g=f-f%5;e=(d&(1<<g)-1).toString(32);d>>=g;f-=g;return{id:1<<32-H(b)+f|c<<f|d,overflow:e+a}}return{id:1<<e|c<<f|d,overflow:a}}var H=Math.clz32?Math.clz32:db,eb=Math.log,fb=Math.LN2;function db(a){a>>>=0;return 0===a?32:31-(eb(a)/fb|0)|0}function gb(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}
var hb="function"===typeof Object.is?Object.is:gb,I=null,ib=null,J=null,K=null,L=!1,M=!1,N=0,O=null,P=0;function Q(){if(null===I)throw Error(k(321));return I}function jb(){if(0<P)throw Error(k(312));return{memoizedState:null,queue:null,next:null}}function kb(){null===K?null===J?(L=!1,J=K=jb()):(L=!0,K=J):null===K.next?(L=!1,K=K.next=jb()):(L=!0,K=K.next);return K}function lb(){ib=I=null;M=!1;J=null;P=0;K=O=null}function mb(a,b){return"function"===typeof b?b(a):b}
function nb(a,b,c){I=Q();K=kb();if(L){var d=K.queue;b=d.dispatch;if(null!==O&&(c=O.get(d),void 0!==c)){O.delete(d);d=K.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);K.memoizedState=d;return[d,b]}return[K.memoizedState,b]}a=a===mb?"function"===typeof b?b():b:void 0!==c?c(b):b;K.memoizedState=a;a=K.queue={last:null,dispatch:null};a=a.dispatch=ob.bind(null,I,a);return[K.memoizedState,a]}
function pb(a,b){I=Q();K=kb();b=void 0===b?null:b;if(null!==K){var c=K.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var f=0;f<d.length&&f<b.length;f++)if(!hb(b[f],d[f])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();K.memoizedState=[a,b];return a}function ob(a,b,c){if(25<=P)throw Error(k(301));if(a===I)if(M=!0,a={action:c,next:null},null===O&&(O=new Map),c=O.get(b),void 0===c)O.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function qb(){throw Error(k(394));}
function R(){}
var rb={readContext:function(a){return a._currentValue2},useContext:function(a){Q();return a._currentValue2},useMemo:pb,useReducer:nb,useRef:function(a){I=Q();K=kb();var b=K.memoizedState;return null===b?(a={current:a},K.memoizedState=a):b},useState:function(a){return nb(mb,a)},useInsertionEffect:R,useLayoutEffect:function(){},useCallback:function(a,b){return pb(function(){return a},b)},useImperativeHandle:R,useEffect:R,useDebugValue:R,useDeferredValue:function(a){Q();return a},useTransition:function(){Q();return[!1,
qb]},useId:function(){var a=ib.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-H(a)-1)).toString(32)+b;var c=S;if(null===c)throw Error(k(404));b=N++;a=":"+c.idPrefix+"R"+a;0<b&&(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b){Q();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error(k(407));return c()}},S=null,sb=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function tb(a){console.error(a)}function T(){}
function ub(a,b,c,d,f,e,g,h,l){var p=[],n=new Set;b={destination:null,responseState:b,progressiveChunkSize:void 0===d?12800:d,status:0,fatalError:null,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:n,pingedTasks:p,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===f?tb:f,onCompleteAll:void 0===e?T:e,onCompleteShell:void 0===g?T:g,onErrorShell:void 0===h?T:h,onFatalError:void 0===l?T:l};c=U(b,0,null,c);c.parentFlushed=
!0;a=vb(b,a,null,c,n,Ua,null,bb);p.push(a);return b}function vb(a,b,c,d,f,e,g,h){a.allPendingTasks++;null===c?a.pendingRootTasks++:c.pendingTasks++;var l={node:b,ping:function(){var b=a.pingedTasks;b.push(l);1===b.length&&wb(a)},blockedBoundary:c,blockedSegment:d,abortSet:f,legacyContext:e,context:g,treeContext:h};f.add(l);return l}function U(a,b,c,d){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c}}function V(a,b){a=a.onError;a(b)}
function W(a,b){var c=a.onErrorShell;c(b);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}function xb(a,b,c,d,f){I={};ib=b;N=0;for(a=c(d,f);M;)M=!1,N=0,P+=1,K=null,a=c(d,f);lb();return a}
function yb(a,b,c,d){var f=c.render(),e=d.childContextTypes;if(null!==e&&void 0!==e){var g=b.legacyContext;if("function"!==typeof c.getChildContext)d=g;else{c=c.getChildContext();for(var h in c)if(!(h in e))throw Error(k(108,Ta(d)||"Unknown",h));d=D({},g,c)}b.legacyContext=d;X(a,b,f);b.legacyContext=g}else X(a,b,f)}function zb(a,b){if(a&&a.defaultProps){b=D({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function Ab(a,b,c,d,f){if("function"===typeof c)if(c.prototype&&c.prototype.isReactComponent){f=Va(c,b.legacyContext);var e=c.contextType;e=new c(d,"object"===typeof e&&null!==e?e._currentValue2:f);ab(e,c,d,f);yb(a,b,e,c)}else{e=Va(c,b.legacyContext);f=xb(a,b,c,d,e);var g=0!==N;if("object"===typeof f&&null!==f&&"function"===typeof f.render&&void 0===f.$$typeof)ab(f,c,d,e),yb(a,b,f,c);else if(g){d=b.treeContext;b.treeContext=cb(d,1,0);try{X(a,b,f)}finally{b.treeContext=d}}else X(a,b,f)}else if("string"===
typeof c)switch(f=b.blockedSegment,e=wa(f.chunks,c,d,a.responseState,f.formatContext),g=f.formatContext,f.formatContext=oa(g,c,d),Bb(a,b,e),f.formatContext=g,c){case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "input":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":break;default:f.chunks.push("</",c,">")}else{switch(c){case Pa:case Oa:case Ea:case Fa:case Da:X(a,b,d.children);return;case Ka:X(a,b,d.children);return;case Na:throw Error(k(343));
case Ja:a:{c=b.blockedBoundary;f=b.blockedSegment;e=d.fallback;d=d.children;g=new Set;var h={id:null,rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:g},l=U(a,f.chunks.length,h,f.formatContext);f.children.push(l);var p=U(a,0,null,f.formatContext);p.parentFlushed=!0;b.blockedBoundary=h;b.blockedSegment=p;try{if(Bb(a,b,d),p.status=1,h.completedSegments.push(p),0===h.pendingTasks)break a}catch(n){p.status=4,V(a,n),h.forceClientRender=
!0}finally{b.blockedBoundary=c,b.blockedSegment=f}b=vb(a,e,c,l,g,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof c&&null!==c)switch(c.$$typeof){case Ia:d=xb(a,b,c.render,d,f);if(0!==N){c=b.treeContext;b.treeContext=cb(c,1,0);try{X(a,b,d)}finally{b.treeContext=c}}else X(a,b,d);return;case La:c=c.type;d=zb(c,d);Ab(a,b,c,d,f);return;case Ga:f=d.children;c=c._context;d=d.value;e=c._currentValue2;c._currentValue2=d;g=E;E=d={parent:g,depth:null===g?0:g.depth+1,
context:c,parentValue:e,value:d};b.context=d;X(a,b,f);a=E;if(null===a)throw Error(k(403));a.context._currentValue2=a.parentValue;a=E=a.parent;b.context=a;return;case Ha:d=d.children;d=d(c._currentValue2);X(a,b,d);return;case Ma:f=c._init;c=f(c._payload);d=zb(c,d);Ab(a,b,c,d,void 0);return}throw Error(k(130,null==c?c:typeof c,""));}}
function X(a,b,c){b.node=c;if("object"===typeof c&&null!==c){switch(c.$$typeof){case Ba:Ab(a,b,c.type,c.props,c.ref);return;case Ca:throw Error(k(257));case Ma:var d=c._init;c=d(c._payload);X(a,b,c);return}if(na(c)){Cb(a,b,c);return}null===c||"object"!==typeof c?d=null:(d=Sa&&c[Sa]||c["@@iterator"],d="function"===typeof d?d:null);if(d&&(d=d.call(c))){c=d.next();if(!c.done){var f=[];do f.push(c.value),c=d.next();while(!c.done);Cb(a,b,f)}return}a=Object.prototype.toString.call(c);throw Error(k(31,"[object Object]"===
a?"object with keys {"+Object.keys(c).join(", ")+"}":a));}"string"===typeof c?(b=b.blockedSegment.chunks,a.responseState.generateStaticMarkup?b.push(v(c)):pa(b,c)):"number"===typeof c&&(b=b.blockedSegment.chunks,c=""+c,a.responseState.generateStaticMarkup?b.push(v(c)):pa(b,c))}function Cb(a,b,c){for(var d=c.length,f=0;f<d;f++){var e=b.treeContext;b.treeContext=cb(e,d,f);try{Bb(a,b,c[f])}finally{b.treeContext=e}}}
function Bb(a,b,c){var d=b.blockedSegment.formatContext,f=b.legacyContext,e=b.context;try{return X(a,b,c)}catch(l){if(lb(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var g=b.blockedSegment,h=U(a,g.chunks.length,null,g.formatContext);g.children.push(h);a=vb(a,b.node,b.blockedBoundary,h,b.abortSet,b.legacyContext,b.context,b.treeContext).ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=f;b.context=e;G(e)}else throw b.blockedSegment.formatContext=d,b.legacyContext=
f,b.context=e,G(e),l;}}function Db(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;Eb(this,b,a)}
function Fb(a){var b=a.blockedBoundary;a.blockedSegment.status=3;null===b?(this.allPendingTasks--,2!==this.status&&(this.status=2,null!==this.destination&&this.destination.push(null))):(b.pendingTasks--,b.forceClientRender||(b.forceClientRender=!0,b.parentFlushed&&this.clientRenderedBoundaries.push(b)),b.fallbackAbortableTasks.forEach(Fb,this),b.fallbackAbortableTasks.clear(),this.allPendingTasks--,0===this.allPendingTasks&&(a=this.onCompleteAll,a()))}
function Eb(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(k(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(a.onErrorShell=T,b=a.onCompleteShell,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&1===c.status&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(Db,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed&&1===c.status){var d=
b.completedSegments;d.push(c);1===d.length&&b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function wb(a){if(2!==a.status){var b=E,c=sb.current;sb.current=rb;var d=S;S=a.responseState;try{var f=a.pingedTasks,e;for(e=0;e<f.length;e++){var g=f[e];var h=a,l=g.blockedSegment;if(0===l.status){G(g.context);try{X(h,g,g.node),g.abortSet.delete(g),l.status=1,Eb(h,g.blockedBoundary,l)}catch(x){if(lb(),"object"===typeof x&&null!==x&&"function"===typeof x.then){var p=g.ping;x.then(p,p)}else{g.abortSet.delete(g);l.status=4;var n=g.blockedBoundary,z=x;V(h,z);null===n?W(h,z):(n.pendingTasks--,n.forceClientRender||
(n.forceClientRender=!0,n.parentFlushed&&h.clientRenderedBoundaries.push(n)));h.allPendingTasks--;if(0===h.allPendingTasks){var C=h.onCompleteAll;C()}}}finally{}}}f.splice(0,e);null!==a.destination&&Gb(a,a.destination)}catch(x){V(a,x),W(a,x)}finally{S=d,sb.current=c,c===rb&&G(b)}}}
function Y(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;m(b,'<template id="');m(b,a.placeholderPrefix);a=d.toString(16);m(b,a);return m(b,'"></template>');case 1:c.status=2;var f=!0;d=c.chunks;var e=0;c=c.children;for(var g=0;g<c.length;g++){for(f=c[g];e<f.index;e++)m(b,d[e]);f=Z(a,b,f)}for(;e<d.length-1;e++)m(b,d[e]);e<d.length&&(f=m(b,d[e]));return f;default:throw Error(k(390));}}
function Z(a,b,c){var d=c.boundary;if(null===d)return Y(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||m(b,"\x3c!--$!--\x3e"),Y(a,b,c),a=a.responseState.generateStaticMarkup?!0:m(b,"\x3c!--/$--\x3e"),a;if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var f=a.responseState;var e=f.nextSuspenseID++;f=f.boundaryPrefix+e.toString(16);d=d.id=f;xa(b,a.responseState,d);Y(a,b,c);return m(b,"\x3c!--/$--\x3e")}if(d.byteSize>
a.progressiveChunkSize)return d.rootSegmentID=a.nextSegmentId++,a.completedBoundaries.push(d),xa(b,a.responseState,d.id),Y(a,b,c),m(b,"\x3c!--/$--\x3e");a.responseState.generateStaticMarkup||m(b,"\x3c!--$--\x3e");c=d.completedSegments;if(1!==c.length)throw Error(k(391));Z(a,b,c[0]);a=a.responseState.generateStaticMarkup?!0:m(b,"\x3c!--/$--\x3e");return a}function Hb(a,b,c){ya(b,a.responseState,c.formatContext,c.id);Z(a,b,c);return za(b,c.formatContext)}
...
var x=a.completedBoundaries;for(e=0;e<x.length;e++)if(!Ib(a,b,x[e])){a.destination=null;e++;x.splice(0,e);return}x.splice(0,e)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.push(null)}}function Kb(a){try{var b=a.abortableTasks;b.forEach(Fb,a);b.clear();null!==a.destination&&Gb(a,a.destination)}catch(c){V(a,c),W(a,c)}}function Lb(){}
function Mb(a,b,c){var d=!1,f=null,e="",g={push:function(a){null!==a&&(e+=a);return!0},destroy:function(a){d=!0;f=a}},h=!1;a=ub(a,Aa(c,b?b.identifierPrefix:void 0),{insertionMode:1,selectedValue:null},Infinity,Lb,void 0,function(){h=!0},void 0,void 0);wb(a);Kb(a);if(1===a.status)a.status=2,g.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=g;try{Gb(a,g)}catch(l){V(a,l),W(a,l)}}if(d)throw f;if(!h)throw Error(k(425));return e}
exports.renderToNodeStream=function(){throw Error(k(207));};exports.renderToStaticMarkup=function(a,b){return Mb(a,b,!0)};exports.renderToStaticNodeStream=function(){throw Error(k(208));};exports.renderToString=function(a,b){return Mb(a,b,!1)};exports.version="18.0.0-rc.1-cb1e7b1c6-20220303";
