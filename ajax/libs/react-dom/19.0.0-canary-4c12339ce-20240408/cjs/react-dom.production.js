...
function resolveUpdatePriority() {
  const updatePriority = Internals.up;
...
const ReactCurrentBatchConfig$4 = ReactSharedInternals.ReactCurrentBatchConfig;
function requestCurrentTransition() {
  const transition = ReactCurrentBatchConfig$4.transition;
...
const ReactDOMCurrentDispatcher$2 = Internals.ReactDOMCurrentDispatcher; // Unused
...
const previousDispatcher = ReactDOMCurrentDispatcher$2.current;
...
const ReactCurrentBatchConfig$1 = ReactSharedInternals.ReactCurrentBatchConfig; // TODO: can we stop exporting these?
...
const ReactDOMCurrentDispatcher$1 = Internals.ReactDOMCurrentDispatcher;

function flushSyncImpl(fn) {
  const previousTransition = ReactCurrentBatchConfig.transition;
  const previousUpdatePriority = Internals.up;
