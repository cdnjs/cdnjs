...
var ReactVersion = '18.0.0-9b76d2d7b-20210719';
      ...
      case SuspenseComponent:
        {
          ...
          var offscreenBoundary = finishedWork.child;
      ...
      case LegacyHiddenComponent:
        {
          ...
          var _offscreenBoundary = finishedWork;

          {
            // TODO: This needs to run whenever there's an insertion or update
            // inside a hidden Offscreen tree.
            hideOrUnhideAllChildren(_offscreenBoundary, _isHidden);
          }

          if (_isHidden) {
            if (!_wasHidden) {
              if ( (_offscreenBoundary.mode & ConcurrentMode) !== NoMode) {
                nextEffect = _offscreenBoundary;
                var _offscreenChild = _offscreenBoundary.child;

                while (_offscreenChild !== null) {
                  nextEffect = _offscreenChild;
                  disappearLayoutEffects_begin(_offscreenChild);
                  _offscreenChild = _offscreenChild.sibling;
                }
              }
            }
          }
