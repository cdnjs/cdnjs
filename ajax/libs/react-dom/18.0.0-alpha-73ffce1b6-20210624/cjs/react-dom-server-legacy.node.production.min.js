 ...
 */
'use strict';var h=require("object-assign"),aa=require("react"),ba=require("stream");function ca(a,b){a.prototype=Object.create(b.prototype);a.prototype.constructor=a;a.__proto__=b}function n(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
function I(a){if(null==a)return null;if("function"===typeof a)return a.displayName||a.name||null;if("string"===typeof a)return a;switch(a){case Ga:return"Fragment";case Fa:return"Portal";case Ia:return"Profiler";case Ha:return"StrictMode";case Ma:return"Suspense";case Na:return"SuspenseList";case Sa:return"Cache"}if("object"===typeof a)switch(a.$$typeof){case Ka:return(a.displayName||"Context")+".Consumer";case Ja:return(a._context.displayName||"Context")+".Provider";case La:var b=a.render;a=a.displayName;
a||(a=b.displayName||b.name||"",a=""!==a?"ForwardRef("+a+")":"ForwardRef");return a;case Oa:return b=a.displayName||null,null!==b?b:I(a.type)||"Memo";case G:b=a._payload;a=a._init;try{return I(a(b))}catch(c){}}return null}var Ua={};function Va(a,b){a=a.contextTypes;if(!a)return Ua;var c={},d;for(d in a)c[d]=b[d];return c}var J=null;
function K(a,b){if(a!==b){a.context._currentValue2=a.parentValue;a=a.parent;var c=b.parent;if(null===a){if(null!==c)throw Error(n(401));}else{if(null===c)throw Error(n(401));K(a,c);b.context._currentValue2=b.value}}}function Wa(a){a.context._currentValue2=a.parentValue;a=a.parent;null!==a&&Wa(a)}function Xa(a){var b=a.parent;null!==b&&Xa(b);a.context._currentValue2=a.value}
function Ya(a,b){a.context._currentValue2=a.parentValue;a=a.parent;if(null===a)throw Error(n(402));a.depth===b.depth?K(a,b):Ya(a,b)}function Za(a,b){var c=b.parent;if(null===c)throw Error(n(402));a.depth===c.depth?K(a,c):Za(a,c);b.context._currentValue2=b.value}function L(a){var b=J;b!==a&&(null===b?Xa(a):null===a?Wa(b):b.depth===a.depth?K(b,a):b.depth>a.depth?Ya(b,a):Za(b,a),J=a)}
var $a={isMounted:function(){return!1},enqueueSetState:function(a,b){a=a._reactInternals;null!==a.queue&&a.queue.push(b)},enqueueReplaceState:function(a,b){a=a._reactInternals;a.replace=!0;a.queue=[b]},enqueueForceUpdate:function(){}};
function ab(a,b,c,d){var e=void 0!==a.state?a.state:null;a.updater=$a;a.props=c;a.state=e;var g={queue:[],replace:!1};a._reactInternals=g;var f=b.contextType;a.context="object"===typeof f&&null!==f?f._currentValue2:d;f=b.getDerivedStateFromProps;"function"===typeof f&&(f=f(c,e),e=null===f||void 0===f?e:h({},e,f),a.state=e);if("function"!==typeof b.getDerivedStateFromProps&&"function"!==typeof a.getSnapshotBeforeUpdate&&("function"===typeof a.UNSAFE_componentWillMount||"function"===typeof a.componentWillMount))if(b=
a.state,"function"===typeof a.componentWillMount&&a.componentWillMount(),"function"===typeof a.UNSAFE_componentWillMount&&a.UNSAFE_componentWillMount(),b!==a.state&&$a.enqueueReplaceState(a,a.state,null),null!==g.queue&&0<g.queue.length)if(b=g.queue,f=g.replace,g.queue=null,g.replace=!1,f&&1===b.length)a.state=b[0];else{g=f?b[0]:a.state;e=!0;for(f=f?1:0;f<b.length;f++){var k=b[f];k="function"===typeof k?k.call(a,g,c,d):k;null!=k&&(e?(e=!1,g=h({},g,k)):h(g,k))}a.state=g}else g.queue=null}
function bb(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var cb="function"===typeof Object.is?Object.is:bb,M=null,N=null,O=null,P=!1,Q=!1,R=null,S=0;function T(){if(null===M)throw Error(n(321));return M}function db(){if(0<S)throw Error(n(312));return{memoizedState:null,queue:null,next:null}}function eb(){null===O?null===N?(P=!1,N=O=db()):(P=!0,O=N):null===O.next?(P=!1,O=O.next=db()):(P=!0,O=O.next);return O}function fb(){M=null;Q=!1;N=null;S=0;O=R=null}
function gb(a,b){return"function"===typeof b?b(a):b}function hb(a,b,c){M=T();O=eb();if(P){var d=O.queue;b=d.dispatch;if(null!==R&&(c=R.get(d),void 0!==c)){R.delete(d);d=O.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);O.memoizedState=d;return[d,b]}return[O.memoizedState,b]}a=a===gb?"function"===typeof b?b():b:void 0!==c?c(b):b;O.memoizedState=a;a=O.queue={last:null,dispatch:null};a=a.dispatch=ib.bind(null,M,a);return[O.memoizedState,a]}
function jb(a,b){M=T();O=eb();b=void 0===b?null:b;if(null!==O){var c=O.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var e=0;e<d.length&&e<b.length;e++)if(!cb(b[e],d[e])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();O.memoizedState=[a,b];return a}function ib(a,b,c){if(!(25>S))throw Error(n(301));if(a===M)if(Q=!0,a={action:c,next:null},null===R&&(R=new Map),c=R.get(b),void 0===c)R.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}
function kb(){throw Error(n(394));}function lb(){}
var mb={readContext:function(a){return a._currentValue2},useContext:function(a){T();return a._currentValue2},useMemo:jb,useReducer:hb,useRef:function(a){M=T();O=eb();var b=O.memoizedState;return null===b?(a={current:a},O.memoizedState=a):b},useState:function(a){return hb(gb,a)},useLayoutEffect:function(){},useCallback:function(a,b){return jb(function(){return a},b)},useImperativeHandle:lb,useEffect:lb,useDebugValue:lb,useDeferredValue:function(a){T();return a},useTransition:function(){T();return[!1,
kb]},useOpaqueIdentifier:function(){var a=U;if(null===a)throw Error(n(404));return a.opaqueIdentifierPrefix+(a.nextOpaqueID++).toString(36)},useMutableSource:function(a,b){T();return b(a._source)}},U=null,nb=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;function ob(a){console.error(a)}function pb(){}
function qb(a,b,c,d,e,g,f,k){var l=[],m=new Set;b={destination:b,responseState:c,progressiveChunkSize:void 0===e?12800:e,status:0,nextSegmentId:0,allPendingTasks:0,pendingRootTasks:0,completedRootSegment:null,abortableTasks:m,pingedTasks:l,clientRenderedBoundaries:[],completedBoundaries:[],partialBoundaries:[],onError:void 0===g?ob:g,onCompleteAll:void 0===f?pb:f,onReadyToStream:void 0===k?pb:k};d=V(b,0,null,d);d.parentFlushed=!0;a=rb(b,a,null,d,m,Ua,null,null);l.push(a);return b}
function rb(a,b,c,d,e,g,f,k){a.allPendingTasks++;null===c?a.pendingRootTasks++:c.pendingTasks++;var l={node:b,ping:function(){var b=a.pingedTasks;b.push(l);1===b.length&&sb(a)},blockedBoundary:c,blockedSegment:d,abortSet:e,legacyContext:g,context:f,assignID:k};e.add(l);return l}function V(a,b,c,d){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c}}function W(a,b){a=a.onError;a(b)}function X(a,b){a.status=2;a.destination.destroy(b)}
function tb(a){throw Error(n(152,I(a)||"Component"));}function ub(a,b,c,d,e){M={};for(a=c(d,e);Q;)Q=!1,S+=1,O=null,a=c(d,e);fb();d=a;void 0===d&&tb(c);return d}function vb(a,b,c,d){var e=c.render();void 0===e&&tb(d);var g=d.childContextTypes;if(null!==g&&void 0!==g){var f=b.legacyContext;if("function"!==typeof c.getChildContext)d=f;else{c=c.getChildContext();for(var k in c)if(!(k in g))throw Error(n(108,I(d)||"Unknown",k));d=h({},f,c)}b.legacyContext=d;Y(a,b,e);b.legacyContext=f}else Y(a,b,e)}
function wb(a,b){if(a&&a.defaultProps){b=h({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function xb(a,b,c,d,e){if("function"===typeof c)if(c.prototype&&c.prototype.isReactComponent){e=Va(c,b.legacyContext);var g=c.contextType;g=new c(d,"object"===typeof g&&null!==g?g._currentValue2:e);ab(g,c,d,e);vb(a,b,g,c)}else e=Va(c,b.legacyContext),g=ub(a,b,c,d,e),"object"===typeof g&&null!==g&&"function"===typeof g.render&&void 0===g.$$typeof?(ab(g,c,d,e),vb(a,b,g,c)):Y(a,b,g);else if("string"===typeof c){e=b.blockedSegment;g=za(e.chunks,c,d,a.responseState,e.formatContext,b.assignID);b.assignID=
null;var f=e.formatContext;e.formatContext=qa(f,c,d);Z(a,b,g);e.formatContext=f;switch(c){case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "input":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":break;default:e.chunks.push("</",c,">")}}else{switch(c){case Ra:case Qa:case Ha:case Ia:case Ga:Y(a,b,d.children);return;case Na:Y(a,b,d.children);return;case Pa:throw Error(n(343));case Ma:a:{c=b.blockedBoundary;g=b.blockedSegment;
e=b.assignID;null!==e&&A(g.chunks,a.responseState,e);b.assignID=null;e=d.fallback;var k=d.children;d=new Set;var l={id:{formattedID:null},rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:d};f=V(a,g.chunks.length,l,g.formatContext);g.children.push(f);var m=V(a,0,null,g.formatContext);m.parentFlushed=!0;b.blockedBoundary=l;b.blockedSegment=m;try{if(Z(a,b,k),m.status=1,l.completedSegments.push(m),0===l.pendingTasks)break a}catch(p){m.status=
4,W(a,p),l.forceClientRender=!0}finally{b.blockedBoundary=c,b.blockedSegment=g}g=l.id;null!==g&&A(f.chunks,a.responseState,g);g=V(a,f.chunks.length,null,f.formatContext);f.status=1;f.children.push(g);b=rb(a,e,c,g,d,b.legacyContext,b.context,null);a.pingedTasks.push(b)}return}if("object"===typeof c&&null!==c)switch(c.$$typeof){case La:d=ub(a,b,c.render,d,e);Y(a,b,d);return;case Oa:c=c.type;d=wb(c,d);xb(a,b,c,d,e);return;case Ja:e=d.children;c=c._context;d=d.value;g=c._currentValue2;c._currentValue2=
d;f=J;J=d={parent:f,depth:null===f?0:f.depth+1,context:c,parentValue:g,value:d};b.context=d;Y(a,b,e);a=J;if(null===a)throw Error(n(403));a.context._currentValue2=a.parentValue;a=J=a.parent;b.context=a;return;case Ka:d=d.children;d=d(c._currentValue2);Y(a,b,d);return;case G:e=c._init;c=e(c._payload);d=wb(c,d);xb(a,b,c,d,void 0);return}throw Error(n(130,null==c?c:typeof c,""));}}
function Y(a,b,c){b.node=c;if("object"===typeof c&&null!==c){switch(c.$$typeof){case Ea:xb(a,b,c.type,c.props,c.ref);return;case Fa:throw Error(n(257));case G:var d=c._init;c=d(c._payload);Y(a,b,c);return}if(pa(c)){if(0<c.length)for(d=0;d<c.length;d++)Z(a,b,c[d]);else c=b.assignID,null!==c&&A(b.blockedSegment.chunks,a.responseState,c),b.assignID=null;return}null===c||"object"!==typeof c?d=null:(d=Ta&&c[Ta]||c["@@iterator"],d="function"===typeof d?d:null);if(d){if(d=d.call(c)){var e=d.next();if(!e.done){do Z(a,
...
function Z(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,g=b.context;try{return Y(a,b,c)}catch(l){if(fb(),"object"===typeof l&&null!==l&&"function"===typeof l.then){c=l;var f=b.blockedSegment,k=V(a,f.chunks.length,null,f.formatContext);f.children.push(k);a=rb(a,b.node,b.blockedBoundary,k,b.abortSet,b.legacyContext,b.context,b.assignID);b.assignID=null;a=a.ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=g;L(g)}else throw b.blockedSegment.formatContext=
d,b.legacyContext=e,b.context=g,L(g),l;}}function yb(a){var b=a.blockedBoundary;a=a.blockedSegment;a.status=3;zb(this,b,a)}
...
function zb(a,b,c){if(null===b){if(c.parentFlushed){if(null!==a.completedRootSegment)throw Error(n(389));a.completedRootSegment=c}a.pendingRootTasks--;0===a.pendingRootTasks&&(b=a.onReadyToStream,b())}else if(b.pendingTasks--,!b.forceClientRender)if(0===b.pendingTasks)c.parentFlushed&&b.completedSegments.push(c),b.parentFlushed&&a.completedBoundaries.push(b),b.fallbackAbortableTasks.forEach(yb,a),b.fallbackAbortableTasks.clear();else if(c.parentFlushed){var d=b.completedSegments;d.push(c);1===d.length&&
b.parentFlushed&&a.partialBoundaries.push(b)}a.allPendingTasks--;0===a.allPendingTasks&&(a=a.onCompleteAll,a())}
function sb(a){if(2!==a.status){var b=J,c=nb.current;nb.current=mb;var d=U;U=a.responseState;try{var e=a.pingedTasks,g;for(g=0;g<e.length;g++){var f=e[g];var k=a,l=f.blockedSegment;if(0===l.status){L(f.context);try{Y(k,f,f.node),f.abortSet.delete(f),l.status=1,zb(k,f.blockedBoundary,l)}catch(t){if(fb(),"object"===typeof t&&null!==t&&"function"===typeof t.then){var m=f.ping;t.then(m,m)}else{f.abortSet.delete(f);l.status=4;var p=f.blockedBoundary,r=t;W(k,r);null===p?X(k,r):(p.pendingTasks--,p.forceClientRender||
(p.forceClientRender=!0,p.parentFlushed&&k.clientRenderedBoundaries.push(p)));k.allPendingTasks--;if(0===k.allPendingTasks){var E=k.onCompleteAll;E()}}}finally{}}}e.splice(0,g);1===a.status&&Bb(a)}catch(t){W(a,t),X(a,t)}finally{U=d,nb.current=c,c===mb&&L(b)}}}
function Cb(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;a=a.responseState;q(b,'<template id="');q(b,a.placeholderPrefix);a=d.toString(16);q(b,a);return q(b,'"></template>');case 1:c.status=2;var e=!0;d=c.chunks;var g=0;c=c.children;for(var f=0;f<c.length;f++){for(e=c[f];g<e.index;g++)q(b,d[g]);e=Db(a,b,e)}for(;g<d.length;g++)e=q(b,d[g]);return e;default:throw Error(n(390));}}
function Db(a,b,c){var d=c.boundary;if(null===d)return Cb(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)return a.responseState.generateStaticMarkup||q(b,"\x3c!--$!--\x3e"),Cb(a,b,c),a=a.responseState.generateStaticMarkup?!0:q(b,"\x3c!--/$--\x3e"),a;if(0<d.pendingTasks)return d.rootSegmentID=a.nextSegmentId++,0<d.completedSegments.length&&a.partialBoundaries.push(d),q(b,"\x3c!--$?--\x3e"),Cb(a,b,c),q(b,"\x3c!--/$--\x3e");if(d.byteSize>a.progressiveChunkSize)return d.rootSegmentID=a.nextSegmentId++,
a.completedBoundaries.push(d),q(b,"\x3c!--$?--\x3e"),Cb(a,b,c),q(b,"\x3c!--/$--\x3e");a.responseState.generateStaticMarkup||q(b,"\x3c!--$--\x3e");c=d.completedSegments;if(1!==c.length)throw Error(n(391));Db(a,b,c[0]);a=a.responseState.generateStaticMarkup?!0:q(b,"\x3c!--/$--\x3e");return a}function Eb(a,b,c){Aa(b,a.responseState,c.formatContext,c.id);Db(a,b,c);return Ba(b,c.formatContext)}
function Fb(a,b,c){for(var d=c.completedSegments,e=0;e<d.length;e++)Gb(a,b,c,d[e]);d.length=0;a=a.responseState;d=c.id;c=c.rootSegmentID;a.sentCompleteBoundaryFunction?q(b,'<script>$RC("'):(a.sentCompleteBoundaryFunction=!0,q(b,'<script>function $RC(b,f){var a=document.getElementById(b),c=document.getElementById(f);c.parentNode.removeChild(c);if(a){do a=a.previousSibling;while(8!==a.nodeType||"$?"!==a.data);var h=a.parentNode,d=a.nextSibling,g=0;do{if(d&&8===d.nodeType){var e=d.data;if("/$"===e)if(0===g)break;else g--;else"$"!==e&&"$?"!==e&&"$!"!==e||g++}e=d.nextSibling;h.removeChild(d);d=e}while(d);for(;c.firstChild;)h.insertBefore(c.firstChild,d);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("'));
d=d.formattedID;if(null===d)throw Error(n(395));c=c.toString(16);q(b,d);q(b,'","');q(b,a.segmentPrefix);q(b,c);return q(b,'")\x3c/script>')}
function Gb(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error(n(392));return Eb(a,b,d)}Eb(a,b,d);a=a.responseState;a.sentCompleteSegmentFunction?q(b,'<script>$RS("'):(a.sentCompleteSegmentFunction=!0,q(b,'<script>function $RS(b,f){var a=document.getElementById(b),c=document.getElementById(f);for(a.parentNode.removeChild(a);a.firstChild;)c.parentNode.insertBefore(a.firstChild,c);c.parentNode.removeChild(c)};$RS("'));q(b,a.segmentPrefix);e=e.toString(16);
q(b,e);q(b,'","');q(b,a.placeholderPrefix);q(b,e);return q(b,'")\x3c/script>')}var Hb=!1;
function Bb(a){if(!Hb){Hb=!0;var b=a.destination;try{var c=a.completedRootSegment;null!==c&&0===a.pendingRootTasks&&(Db(a,b,c),a.completedRootSegment=null);var d=a.clientRenderedBoundaries,e;for(e=0;e<d.length;e++){var g=a.responseState,f=d[e].id;g.sentClientRenderFunction?q(b,'<script>$RX("'):(g.sentClientRenderFunction=!0,q(b,'<script>function $RX(b){if(b=document.getElementById(b)){do b=b.previousSibling;while(8!==b.nodeType||"$?"!==b.data);b.data="$!";b._reactRetry&&b._reactRetry()}};$RX("'));var k=
f.formattedID;if(null===k)throw Error(n(395));q(b,k);if(!q(b,'")\x3c/script>')){a.status=0;e++;d.splice(0,e);return}}d.splice(0,e);var l=a.completedBoundaries;for(e=0;e<l.length;e++)if(!Fb(a,b,l[e])){a.status=0;e++;l.splice(0,e);return}l.splice(0,e);var m=a.partialBoundaries;for(e=0;e<m.length;e++){var p=m[e];a:{c=a;var r=p.completedSegments;for(d=0;d<r.length;d++)if(!Gb(c,b,p,r[d])){d++;r.splice(0,d);var E=!1;break a}r.splice(0,d);E=!0}if(!E){a.status=0;e++;m.splice(0,e);return}}m.splice(0,e);var t=
a.completedBoundaries;for(e=0;e<t.length;e++)if(!Fb(a,b,t[e])){a.status=0;e++;t.splice(0,e);return}t.splice(0,e)}finally{Hb=!1,0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&b.push(null)}}}function Ib(a){if(2!==a.status){a.status=1;try{Bb(a)}catch(b){W(a,b),X(a,b)}}}function Jb(a){try{var b=a.abortableTasks;b.forEach(Ab,a);b.clear();1===a.status&&Bb(a)}catch(c){W(a,c),X(a,c)}}function Kb(){}
function Lb(a,b,c){var d=!1,e=null,g="",f=!1;a=qb(a,{push:function(a){null!==a&&(g+=a);return!0},destroy:function(a){d=!0;e=a}},Ca(c,b?b.identifierPrefix:void 0),Da(),Infinity,Kb,void 0,function(){f=!0});sb(a);Jb(a);Ib(a);if(d)throw e;if(!f)throw Error(n(342));return g}
var Mb=function(a){function b(){var b=a.call(this,{})||this;b.request=null;b.startedFlowing=!1;return b}ca(b,a);var c=b.prototype;c._destroy=function(a,b){Jb(this.request);b(a)};c._read=function(){this.startedFlowing&&Ib(this.request)};return b}(ba.Readable);function Nb(){}function Ob(a,b){var c=new Mb,d=qb(a,c,Ca(!1,b?b.identifierPrefix:void 0),Da(),Infinity,Nb,function(){c.startedFlowing=!0;Ib(d)},void 0);c.request=d;sb(d);return c}exports.renderToNodeStream=function(a,b){return Ob(a,b)};
exports.renderToStaticMarkup=function(a,b){return Lb(a,b,!0)};exports.renderToStaticNodeStream=function(a,b){return Ob(a,b)};exports.renderToString=function(a,b){return Lb(a,b,!1)};exports.version="18.0.0-73ffce1b6-20210624";
