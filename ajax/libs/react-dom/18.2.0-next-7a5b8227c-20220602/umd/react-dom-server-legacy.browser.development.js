...
(function (global, factory) {
  ...
  var ReactVersion = '18.2.0-next-7a5b8227c-20220602';
  ...
  errorHash, errorMessage, errorComponentStack) {
    if (responseState.generateStaticMarkup) {
  ...
  function flushSegment(request, destination, segment) {
    ...
    if (boundary.forceClientRender) {
      ...
      writeStartClientRenderedSuspenseBoundary$1(destination, request.responseState, boundary.errorHash, boundary.errorMessage, boundary.errorComponentStack); // Flush the fallback.
