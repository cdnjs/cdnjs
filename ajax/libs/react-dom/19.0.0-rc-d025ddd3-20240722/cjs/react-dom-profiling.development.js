...
"production" !== process.env.NODE_ENV &&
  (function () {
        ...
        if (didSuspend)
          workInProgress.flags & 256
            ...
            : (reuseSuspenseHandlerOnStack(workInProgress),
              ...
              (workInProgress.memoizedState = SUSPENDED_MARKER),
              (workInProgress = JSCompiler_object_inline_componentStack_2312));
        else if (
          (pushPrimaryTreeSuspenseHandler(workInProgress),
          isHydrating &&
            console.error(
          ...
          JSCompiler_object_inline_componentStack_2312 = componentStack;
          JSCompiler_object_inline_message_2309 =
            JSCompiler_object_inline_message_2309
          ...
          JSCompiler_object_inline_message_2309.stack =
            JSCompiler_object_inline_stack_2311 || "";
          JSCompiler_object_inline_message_2309.digest =
            JSCompiler_object_inline_digest_2310;
          JSCompiler_object_inline_digest_2310 =
            void 0 === JSCompiler_object_inline_componentStack_2312
              ? null
              : JSCompiler_object_inline_componentStack_2312;
          ...
          queueHydrationError({
            value: JSCompiler_object_inline_message_2309,
            source: null,
          ...
          if (null !== JSCompiler_object_inline_digest_2310) {
            ...
            if (0 !== (JSCompiler_object_inline_stack_2311 & SyncUpdateLanes))
              JSCompiler_object_inline_stack_2311 = SyncHydrationLane;
            else
              switch (JSCompiler_object_inline_stack_2311) {
                ...
                case InputContinuousLane:
                  ...
                  break;
                case DefaultLane:
                  JSCompiler_object_inline_stack_2311 = DefaultHydrationLane;
                  break;
                case 128:
                case 256:
                case 512:
                ...
                case 16777216:
                case 33554432:
                  JSCompiler_object_inline_stack_2311 = TransitionHydrationLane;
                  break;
                case IdleLane:
                  JSCompiler_object_inline_stack_2311 = IdleHydrationLane;
                  break;
                default:
    ...
    (function () {
      ...
      if ("19.0.0-rc-d025ddd3-20240722" !== isomorphicReactPackageVersion)
        throw Error(
    ...
    if (
      !(function (devToolsConfig) {
        return injectInternals({
          ...
          reconcilerVersion: "19.0.0-rc-d025ddd3-20240722"
        });
      })({
