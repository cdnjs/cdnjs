 ...
 */
Ext.define('KitchenSink.view.charts.pie.PieExploded3D', {
    extend: 'Ext.Panel',
    xtype: 'pie-exploded-3d',
    ...
    initComponent: function() {
        ...
        me.dockedItems = [{
            ...
            items: [{
                ...
                text: 'Reload Data',
                handler: function() {
                    me.down('polar').getStore().loadData(me.generateData());
                }
            }]
        }];
        //</example>
...
//                },
        ...
        this.callParent();
        this.down('polar').getStore().loadData(this.generateData());
    },
