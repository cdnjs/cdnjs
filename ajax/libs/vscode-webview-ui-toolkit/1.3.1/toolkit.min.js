...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */const yo=ge` ${ui("inline-flex")} :host{outline: none;font-family: ${ws};font-size: ${Is};line-height: ${Os};color: ${qs};background: ${_s};border-radius: calc(${vs} * 1px);fill: currentColor;cursor: pointer}.control{background: transparent;height: inherit;flex-grow: 1;box-sizing: border-box;display: inline-flex;justify-content: center;align-items: center;padding: ${Ys} ${Qs};white-space: wrap;outline: none;text-decoration: none;border: calc(${bs} * 1px) solid ${Vs};color: inherit;border-radius: inherit;fill: inherit;cursor: inherit;font-family: inherit}:host(:hover){background: ${Us}}:host(:active){background: ${_s}}.control:${pi}{outline: calc(${bs} * 1px) solid ${Cs};outline-offset: calc(${bs} * 2px)}.control::-moz-focus-inner{border: 0}:host([disabled]){opacity: ${xs};background: ${_s};cursor: ${"not-allowed"}}.content{display: flex}.start{display: flex}::slotted(svg),	::slotted(span){width: calc(${ys} * 4px);height: calc(${ys} * 4px)}.start{margin-inline-end: 8px}`,xo=ge`	:host([appearance='primary']){background: ${_s};color: ${qs}}:host([appearance='primary']:hover){background: ${Us}}:host([appearance='primary']:active) .control:active{background: ${_s}}:host([appearance='primary']) .control:${pi}{outline: calc(${bs} * 1px) solid ${Cs};outline-offset: calc(${bs} * 2px)}:host([appearance='primary'][disabled]){background: ${_s}}`,Co=ge`	:host([appearance='secondary']){background: ${Ks};color: ${Gs}}:host([appearance='secondary']:hover){background: ${Ws}}:host([appearance='secondary']:active) .control:active{background: ${Ks}}:host([appearance='secondary']) .control:${pi}{outline: calc(${bs} * 1px) solid ${Cs};outline-offset: calc(${bs} * 2px)}:host([appearance='secondary'][disabled]){background: ${Ks}}`,wo=ge`	:host([appearance='icon']){background: ${Hs};border-radius: ${Ms};color: ${$s}}:host([appearance='icon']:hover){background: ${zs};outline: 1px dotted ${gs};outline-offset: -1px}:host([appearance='icon']) .control{padding: ${js};border: none}:host([appearance='icon']:active) .control:active{background: ${zs}}:host([appearance='icon']) .control:${pi}{outline: calc(${bs} * 1px) solid ${Cs};outline-offset: ${Ns}}:host([appearance='icon'][disabled]){background: ${Hs}}`;class $o extends Kt{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,i){if("appearance"===e&&"icon"===i){this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")}"aria-label"===e&&(this.ariaLabel=i),"disabled"===e&&(this.disabled=null!==i)}}!function(e,t,i,s){var o,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(r=(n<3?o(r):n>3?o(t,i,r):o(t,i))||r);n>3&&r&&Object.defineProperty(t,i,r)}([oe],$o.prototype,"appearance",void 0);const ko=$o.compose({baseName:"button",template:(e,t)=>W`<button class="control" part="control" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" form="${e=>e.formId}" formaction="${e=>e.formaction}" formenctype="${e=>e.formenctype}" formmethod="${e=>e.formmethod}" formnovalidate="${e=>e.formnovalidate}" formtarget="${e=>e.formtarget}" name="${e=>e.name}" type="${e=>e.type}" value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-pressed="${e=>e.ariaPressed}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ie("control")}>${Ne(0,t)}<span class="content" part="content"><slot ${Fe("defaultSlottedContent")}></slot></span>${Me(0,t)}</button>`,styles:(e,t)=>ge` ${yo} ${xo} ${Co} ${wo}`,shadowOptions:{delegatesFocus:!0}});class To extends oi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Io=To.compose({baseName:"checkbox",template:(e,t)=>W`<template role="checkbox" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" tabindex="${e=>e.disabled?null:0}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}" class="${e=>e.readOnly?"readonly":""} ${e=>e.checked?"checked":""} ${e=>e.indeterminate?"indeterminate":""}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot><slot name="indeterminate-indicator">${t.indeterminateIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Fe("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{align-items: center;outline: none;margin: calc(${ys} * 1px) 0;user-select: none;font-size: ${Is};line-height: ${Os}}.control{position: relative;width: calc(${ys} * 4px + 2px);height: calc(${ys} * 4px + 2px);box-sizing: border-box;border-radius: calc(${Zs} * 1px);border: calc(${bs} * 1px) solid ${Js};background: ${Xs};outline: none;cursor: pointer}.label{font-family: ${ws};color: ${$s};padding-inline-start: calc(${ys} * 2px + 2px);margin-inline-end: calc(${ys} * 2px + 2px);cursor: pointer}.label__hidden{display: none;visibility: hidden}.checked-indicator{width: 100%;height: 100%;display: block;fill: ${$s};opacity: 0;pointer-events: none}.indeterminate-indicator{border-radius: 2px;background: ${$s};position: absolute;top: 50%;left: 50%;width: 50%;height: 50%;transform: translate(-50%, -50%);opacity: 0}:host(:enabled) .control:hover{background: ${Xs};border-color: ${Js}}:host(:enabled) .control:active{background: ${Xs};border-color: ${Cs}}:host(:${pi}) .control{border: calc(${bs} * 1px) solid ${Cs}}:host(.disabled) .label,	:host(.readonly) .label,	:host(.readonly) .control,	:host(.disabled) .control{cursor: ${"not-allowed"}}:host(.checked:not(.indeterminate)) .checked-indicator,	:host(.indeterminate) .indeterminate-indicator{opacity: 1}:host(.disabled){opacity: ${xs}}`,checkedIndicator:'\n\t\t<svg \n\t\t\tpart="checked-indicator"\n\t\t\tclass="checked-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M14.431 3.323l-8.47 10-.79-.036-3.35-4.77.818-.574 2.978 4.24 8.051-9.506.764.646z"\n\t\t\t/>\n\t\t</svg>\n\t',indeterminateIndicator:'\n\t\t<div part="indeterminate-indicator" class="indeterminate-indicator"></div>\n\t'});class Oo extends Jt{connectedCallback(){super.connectedCallback();this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const Ro=Oo.compose({baseName:"data-grid",baseClass:Jt,template:(e,t)=>{const i=function(e){const t=e.tagFor(Xt);return W`<${t} :rowData="${e=>e}" :cellItemTemplate="${(e,t)=>t.parent.cellItemTemplate}" :headerCellItemTemplate="${(e,t)=>t.parent.headerCellItemTemplate}"></${t}>`}(e),s=e.tagFor(Xt);return W`<template role="grid" tabindex="0" :rowElementTag="${()=>s}" :defaultRowItemTemplate="${i}" ${Ve({property:"rowElements",filter:Ee("[role=row]")})}><slot></slot></template>`},styles:(e,t)=>ge`	:host{display: flex;position: relative;flex-direction: column;width: 100%}`});class Ao extends Xt{}const So=Ao.compose({baseName:"data-grid-row",baseClass:Xt,template:(e,t)=>{const i=function(e){const t=e.tagFor(ti);return W`<${t} cell-type="${e=>e.isRowHeader?"rowheader":void 0}" grid-column="${(e,t)=>t.index+1}" :rowData="${(e,t)=>t.parent.rowData}" :columnDefinition="${e=>e}"></${t}>`}(e),s=function(e){const t=e.tagFor(ti);return W`<${t} cell-type="columnheader" grid-column="${(e,t)=>t.index+1}" :columnDefinition="${e=>e}"></${t}>`}(e);return W`<template role="row" class="${e=>"default"!==e.rowType?e.rowType:""}" :defaultCellItemTemplate="${i}" :defaultHeaderCellItemTemplate="${s}" ${Ve({property:"cellElements",filter:Ee('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}><slot ${Fe("slottedCellElements")}></slot></template>`},styles:(e,t)=>ge`	:host{display: grid;padding: calc((${ys} / 4) * 1px) 0;box-sizing: border-box;width: 100%;background: transparent}:host(.header){}:host(.sticky-header){background: ${fs};position: sticky;top: 0}:host(:hover){background: ${io};outline: 1px dotted ${gs};outline-offset: -1px}`});class Do extends ti{}const Eo=Do.compose({baseName:"data-grid-cell",baseClass:ti,template:(e,t)=>W`<template tabindex="-1" role="${e=>e.cellType&&"default"!==e.cellType?e.cellType:"gridcell"}" class=" ${e=>"columnheader"===e.cellType?"column-header":"rowheader"===e.cellType?"row-header":""} "><slot></slot></template>`,styles:(e,t)=>ge`	:host{padding: calc(${ys} * 1px) calc(${ys} * 3px);color: ${$s};opacity: 1;box-sizing: border-box;font-family: ${ws};font-size: ${Is};line-height: ${Os};font-weight: 400;border: solid calc(${bs} * 1px) transparent;border-radius: calc(${ms} * 1px);white-space: wrap;overflow-wrap: anywhere}:host(.column-header){font-weight: 600}:host(:${pi}),	:host(:focus),	:host(:active){background: ${eo};border: solid calc(${bs} * 1px) ${Cs};color: ${to};outline: none}:host(:${pi}) ::slotted(*),	:host(:focus) ::slotted(*),	:host(:active) ::slotted(*){color: ${to} !important}`});class Po extends zi{}const Bo=Po.compose({baseName:"divider",template:(e,t)=>W`<template role="${e=>e.role}" aria-orientation="${e=>e.orientation}"></template>`,styles:(e,t)=>ge` ${ui("block")} :host{border: none;border-top: calc(${bs} * 1px) solid ${so};box-sizing: content-box;height: 0;margin: calc(${ys} * 1px) 0;width: 100%}`});class Fo extends es{}const Lo=Fo.compose({baseName:"dropdown",template:(e,t)=>W`<template class="${e=>e.open?"open":""} ${e=>e.disabled?"disabled":""} ${e=>e.position}" aria-activedescendant="${e=>e.ariaActiveDescendant}" aria-controls="${e=>e.ariaControls}" aria-disabled="${e=>e.ariaDisabled}" aria-expanded="${e=>e.ariaExpanded}" aria-haspopup="listbox" ?open="${e=>e.open}" role="combobox" tabindex="${e=>e.disabled?null:"0"}" @click="${(e,t)=>e.clickHandler(t.event)}" @focusout="${(e,t)=>e.focusoutHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}"><div class="control" part="control" ?disabled="${e=>e.disabled}">${Ne(0,t)}<slot name="button-container"><div class="selected-value" part="selected-value"><slot name="selected-value">${e=>e.displayValue}</slot></div><div aria-hidden="true" class="indicator" part="indicator"><slot name="indicator">${t.indicator||""}</slot></div></slot>${Me(0,t)}</div><div class="listbox" id="${e=>e.listboxId}" part="listbox" role="listbox" ?disabled="${e=>e.disabled}" ?hidden="${e=>!e.open}" ${Ie("listbox")}><slot ${Fe({filter:li.slottedOptionFilter,flatten:!0,property:"slottedOptions"})}></slot></div></template>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{background: ${oo};box-sizing: border-box;color: ${$s};contain: contents;font-family: ${ws};height: calc(${ks} * 1px);position: relative;user-select: none;min-width: ${Ts};outline: none;vertical-align: top}.control{align-items: center;box-sizing: border-box;border: calc(${bs} * 1px) solid ${no};border-radius: calc(${ms} * 1px);cursor: pointer;display: flex;font-family: inherit;font-size: ${Is};line-height: ${Os};min-height: 100%;padding: 2px 6px 2px 8px;width: 100%}.listbox{background: ${oo};border: calc(${bs} * 1px) solid ${Cs};border-radius: calc(${ms} * 1px);box-sizing: border-box;display: inline-flex;flex-direction: column;left: 0;max-height: ${ro};padding: 0 0 calc(${ys} * 1px) 0;overflow-y: auto;position: absolute;width: 100%;z-index: 1}.listbox[hidden]{display: none}:host(:${pi}) .control{border-color: ${Cs}}:host(:not([disabled]):hover){background: ${oo};border-color: ${no}}:host(:${pi}) ::slotted([aria-selected="true"][role="option"]:not([disabled])){background: ${eo};border: calc(${bs} * 1px) solid ${Cs};color: ${to}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${xs}}:host([disabled]) .control{cursor: ${"not-allowed"};user-select: none}:host([disabled]:hover){background: ${oo};color: ${$s};fill: currentcolor}:host(:not([disabled])) .control:active{border-color: ${Cs}}:host(:empty) .listbox{display: none}:host([open]) .control{border-color: ${Cs}}:host([open][position='above']) .listbox,	:host([open][position='below']) .control{border-bottom-left-radius: 0;border-bottom-right-radius: 0}:host([open][position='above']) .control,	:host([open][position='below']) .listbox{border-top-left-radius: 0;border-top-right-radius: 0}:host([open][position='above']) .listbox{bottom: calc(${ks} * 1px)}:host([open][position='below']) .listbox{top: calc(${ks} * 1px)}.selected-value{flex: 1 1 auto;font-family: inherit;overflow: hidden;text-align: start;text-overflow: ellipsis;white-space: nowrap}.indicator{flex: 0 0 auto;margin-inline-start: 1em}slot[name='listbox']{display: none;width: 100%}:host([open]) slot[name='listbox']{display: flex;position: absolute}.end{margin-inline-start: auto}.start,	.end,	.indicator,	.select-indicator,	::slotted(svg),	::slotted(span){fill: currentcolor;height: 1em;min-height: calc(${ys} * 4px);min-width: calc(${ys} * 4px);width: 1em}::slotted([role='option']),	::slotted(option){flex: 0 0 auto}`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class Vo extends Lt{}const Ho=Vo.compose({baseName:"link",template:(e,t)=>W`<a class="control" part="control" download="${e=>e.download}" href="${e=>e.href}" hreflang="${e=>e.hreflang}" ping="${e=>e.ping}" referrerpolicy="${e=>e.referrerpolicy}" rel="${e=>e.rel}" target="${e=>e.target}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ie("control")}>${Ne(0,t)}<span class="content" part="content"><slot ${Fe("defaultSlottedContent")}></slot></span>${Me(0,t)}</a>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{background: transparent;box-sizing: border-box;color: ${ho};cursor: pointer;fill: currentcolor;font-family: ${ws};font-size: ${Is};line-height: ${Os};outline: none}.control{background: transparent;border: calc(${bs} * 1px) solid transparent;border-radius: calc(${ms} * 1px);box-sizing: border-box;color: inherit;cursor: inherit;fill: inherit;font-family: inherit;height: inherit;padding: 0;outline: none;text-decoration: none;word-break: break-word}.control::-moz-focus-inner{border: 0}:host(:hover){color: ${co}}:host(:hover) .content{text-decoration: underline}:host(:active){background: transparent;color: ${co}}:host(:${pi}) .control,	:host(:focus) .control{border: calc(${bs} * 1px) solid ${Cs}}`,shadowOptions:{delegatesFocus:!0}});class Mo extends ri{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const No=Mo.compose({baseName:"option",template:(e,t)=>W`<template aria-checked="${e=>e.ariaChecked}" aria-disabled="${e=>e.ariaDisabled}" aria-posinset="${e=>e.ariaPosInSet}" aria-selected="${e=>e.ariaSelected}" aria-setsize="${e=>e.ariaSetSize}" class="${e=>[e.checked&&"checked",e.selected&&"selected",e.disabled&&"disabled"].filter(Boolean).join(" ")}" role="option">${Ne(0,t)}<span class="content" part="content"><slot></slot></span>${Me(0,t)}</template>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{font-family: var(--body-font);border-radius: ${ms};border: calc(${bs} * 1px) solid transparent;box-sizing: border-box;color: ${$s};cursor: pointer;fill: currentcolor;font-size: ${Is};line-height: ${Os};margin: 0;outline: none;overflow: hidden;padding: 0 calc((${ys} / 2) * 1px) calc((${ys} / 4) * 1px);user-select: none;white-space: nowrap}:host(:${pi}){border-color: ${Cs};background: ${eo};color: ${$s}}:host([aria-selected='true']){background: ${eo};border: calc(${bs} * 1px) solid ${Cs};color: ${to}}:host(:active){background: ${eo};color: ${to}}:host(:not([aria-selected='true']):hover){background: ${eo};border: calc(${bs} * 1px) solid ${Cs};color: ${to}}:host(:not([aria-selected='true']):active){background: ${eo};color: ${$s}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${xs}}:host([disabled]:hover){background-color: inherit}.content{grid-column-start: 2;justify-self: start;overflow: hidden;text-overflow: ellipsis}`});class zo extends rs{connectedCallback(){super.connectedCallback(),this.orientation&&(this.orientation=os.horizontal);this.getAttribute("aria-label")||this.setAttribute("aria-label","Panels")}}const jo=zo.compose({baseName:"panels",template:(e,t)=>W`<template class="${e=>e.orientation}">${Ne(0,t)}<div class="tablist" part="tablist" role="tablist"><slot class="tab" name="tab" part="tab" ${Fe("tabs")}></slot>${Oe((e=>e.showActiveIndicator),W`<div ${Ie("activeIndicatorRef")} class="activeIndicator" part="activeIndicator"></div>`)}</div>${Me(0,t)}<div class="tabpanel"><slot name="tabpanel" part="tabpanel" ${Fe("tabpanels")}></slot></div></template>`,styles:(e,t)=>ge` ${ui("grid")} :host{box-sizing: border-box;font-family: ${ws};font-size: ${Is};line-height: ${Os};color: ${$s};grid-template-columns: auto 1fr auto;grid-template-rows: auto 1fr;overflow-x: auto}.tablist{display: grid;grid-template-rows: auto auto;grid-template-columns: auto;column-gap: calc(${ys} * 8px);position: relative;width: max-content;align-self: end;padding: calc(${ys} * 1px) calc(${ys} * 1px) 0;box-sizing: border-box}.start,	.end{align-self: center}.activeIndicator{grid-row: 2;grid-column: 1;width: 100%;height: calc((${ys} / 4) * 1px);justify-self: center;background: ${fo};margin: 0;border-radius: calc(${ms} * 1px)}.activeIndicatorTransition{transition: transform 0.01s linear}.tabpanel{grid-row: 2;grid-column-start: 1;grid-column-end: 4;position: relative}`});class _o extends ss{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const qo=_o.compose({baseName:"panel-tab",template:(e,t)=>W`<template slot="tab" role="tab" aria-disabled="${e=>e.disabled}"><slot></slot></template>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{box-sizing: border-box;font-family: ${ws};font-size: ${Is};line-height: ${Os};height: calc(${ys} * 7px);padding: calc(${ys} * 1px) 0;color: ${bo};fill: currentcolor;border-radius: calc(${ms} * 1px);border: solid calc(${bs} * 1px) transparent;align-items: center;justify-content: center;grid-row: 1;cursor: pointer}:host(:hover){color: ${fo};fill: currentcolor}:host(:active){color: ${fo};fill: currentcolor}:host([aria-selected='true']){background: transparent;color: ${fo};fill: currentcolor}:host([aria-selected='true']:hover){background: transparent;color: ${fo};fill: currentcolor}:host([aria-selected='true']:active){background: transparent;color: ${fo};fill: currentcolor}:host(:${pi}){outline: none;border: solid calc(${bs} * 1px) ${po}}:host(:focus){outline: none}::slotted(vscode-badge){margin-inline-start: calc(${ys} * 2px)}`});class Uo extends is{}const Ko=Uo.compose({baseName:"panel-view",template:(e,t)=>W`<template slot="tabpanel" role="tabpanel"><slot></slot></template>`,styles:(e,t)=>ge` ${ui("flex")} :host{color: inherit;background-color: transparent;border: solid calc(${bs} * 1px) transparent;box-sizing: border-box;font-size: ${Is};line-height: ${Os};padding: 10px calc((${ys} + 2) * 1px)}`});class Go extends Gi{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const Wo=Go.compose({baseName:"progress-ring",template:(e,t)=>W`<template role="progressbar" aria-valuenow="${e=>e.value}" aria-valuemin="${e=>e.min}" aria-valuemax="${e=>e.max}" class="${e=>e.paused?"paused":""}">${Oe((e=>"number"==typeof e.value),W`<svg class="progress" part="progress" viewBox="0 0 16 16" slot="determinate"><circle class="background" part="background" cx="8px" cy="8px" r="7px"></circle><circle class="determinate" part="determinate" style="stroke-dasharray: ${e=>44*e.percentComplete/100}px ${44}px" cx="8px" cy="8px" r="7px"></circle></svg>`)} ${Oe((e=>"number"!=typeof e.value),W`<slot name="indeterminate" slot="indeterminate">${t.indeterminateIndicator||""}</slot>`)}</template>`,styles:(e,t)=>ge` ${ui("flex")} :host{align-items: center;outline: none;height: calc(${ys} * 7px);width: calc(${ys} * 7px);margin: 0}.progress{height: 100%;width: 100%}.background{fill: none;stroke: transparent;stroke-width: calc(${ys} / 2 * 1px)}.indeterminate-indicator-1{fill: none;stroke: ${uo};stroke-width: calc(${ys} / 2 * 1px);stroke-linecap: square;transform-origin: 50% 50%;transform: rotate(-90deg);transition: all 0.2s ease-in-out;animation: spin-infinite 2s linear infinite}@keyframes spin-infinite{0%{stroke-dasharray: 0.01px 43.97px;transform: rotate(0deg)}50%{stroke-dasharray: 21.99px 21.99px;transform: rotate(450deg)}100%{stroke-dasharray: 0.01px 43.97px;transform: rotate(1080deg)}}`,indeterminateIndicator:'\n\t\t<svg class="progress" part="progress" viewBox="0 0 16 16">\n\t\t\t<circle\n\t\t\t\tclass="background"\n\t\t\t\tpart="background"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t\t<circle\n\t\t\t\tclass="indeterminate-indicator-1"\n\t\t\t\tpart="indeterminate-indicator-1"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t</svg>\n\t'});class Qo extends Wi{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const t="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",t),this.setAttribute("aria-labelledby",t)}}}const Yo=Qo.compose({baseName:"radio-group",template:(e,t)=>W`<template role="radiogroup" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @click="${(e,t)=>e.clickHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}" @focusout="${(e,t)=>e.focusOutHandler(t.event)}"><slot name="label"></slot><div class="positioning-region ${e=>e.orientation===Rt.horizontal?"horizontal":"vertical"}" part="positioning-region"><slot ${Fe({property:"slottedRadioButtons",filter:Ee("[role=radio]")})}></slot></div></template>`,styles:(e,t)=>ge` ${ui("flex")} :host{align-items: flex-start;margin: calc(${ys} * 1px) 0;flex-direction: column}.positioning-region{display: flex;flex-wrap: wrap}:host([orientation='vertical']) .positioning-region{flex-direction: column}:host([orientation='horizontal']) .positioning-region{flex-direction: row}::slotted([slot='label']){color: ${$s};font-size: ${Is};margin: calc(${ys} * 1px) 0}`});class Xo extends Xi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Radio")}}const Jo=Xo.compose({baseName:"radio",template:(e,t)=>W`<template role="radio" class="${e=>e.checked?"checked":""} ${e=>e.readOnly?"readonly":""}" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Fe("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>ge` ${ui("inline-flex")} :host{align-items: center;flex-direction: row;font-size: ${Is};line-height: ${Os};margin: calc(${ys} * 1px) 0;outline: none;position: relative;transition: all 0.2s ease-in-out;user-select: none}.control{background: ${Xs};border-radius: 999px;border: calc(${bs} * 1px) solid ${Js};box-sizing: border-box;cursor: pointer;height: calc(${ys} * 4px);position: relative;outline: none;width: calc(${ys} * 4px)}.label{color: ${$s};cursor: pointer;font-family: ${ws};margin-inline-end: calc(${ys} * 2px + 2px);padding-inline-start: calc(${ys} * 2px + 2px)}.label__hidden{display: none;visibility: hidden}.control,	.checked-indicator{flex-shrink: 0}.checked-indicator{background: ${$s};border-radius: 999px;display: inline-block;inset: calc(${ys} * 1px);opacity: 0;pointer-events: none;position: absolute}:host(:not([disabled])) .control:hover{background: ${Xs};border-color: ${Js}}:host(:not([disabled])) .control:active{background: ${Xs};border-color: ${Cs}}:host(:${pi}) .control{border: calc(${bs} * 1px) solid ${Cs}}:host([aria-checked='true']) .control{background: ${Xs};border: calc(${bs} * 1px) solid ${Js}}:host([aria-checked='true']:not([disabled])) .control:hover{background: ${Xs};border: calc(${bs} * 1px) solid ${Js}}:host([aria-checked='true']:not([disabled])) .control:active{background: ${Xs};border: calc(${bs} * 1px) solid ${Cs}}:host([aria-checked="true"]:${pi}:not([disabled])) .control{border: calc(${bs} * 1px) solid ${Cs}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([aria-checked='true']) .checked-indicator{opacity: 1}:host([disabled]){opacity: ${xs}}`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class Zo extends Mt{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const en=Zo.compose({baseName:"tag",template:Ht,styles:(e,t)=>ge` ${ui("inline-block")} :host{box-sizing: border-box;font-family: ${ws};font-size: ${Rs};line-height: ${As}}.control{background-color: ${Fs};border: calc(${bs} * 1px) solid ${Vs};border-radius: ${go};color: ${Ls};padding: calc(${ys} * 0.5px) calc(${ys} * 1px);text-transform: uppercase}`});class tn extends ds{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const sn=tn.compose({baseName:"text-area",template:(e,t)=>W`<template class=" ${e=>e.readOnly?"readonly":""} ${e=>e.resize!==ns.none?`resize-${e.resize}`:""}"><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Fe("defaultSlottedNodes")}></slot></label><textarea part="control" class="control" id="control" ?autofocus="${e=>e.autofocus}" cols="${e=>e.cols}" ?disabled="${e=>e.disabled}" form="${e=>e.form}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" name="${e=>e.name}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" rows="${e=>e.rows}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" @input="${(e,t)=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ${Ie("control")}></textarea></template>`,styles:(e,t)=>ge` ${ui("inline-block")} :host{font-family: ${ws};outline: none;user-select: none}.control{box-sizing: border-box;position: relative;color: ${lo};background: ${ao};border-radius: calc(${vs} * 1px);border: calc(${bs} * 1px) solid ${no};font: inherit;font-size: ${Is};line-height: ${Os};padding: calc(${ys} * 2px + 1px);width: 100%;min-width: ${Ts};resize: none}.control:hover:enabled{background: ${ao};border-color: ${no}}.control:active:enabled{background: ${ao};border-color: ${Cs}}.control:hover,	.control:${pi},	.control:disabled,	.control:active{outline: none}.control::-webkit-scrollbar{width: ${Ss};height: ${Ds}}.control::-webkit-scrollbar-corner{background: ${ao}}.control::-webkit-scrollbar-thumb{background: ${Es}}.control::-webkit-scrollbar-thumb:hover{background: ${Ps}}.control::-webkit-scrollbar-thumb:active{background: ${Bs}}:host(:focus-within:not([disabled])) .control{border-color: ${Cs}}:host([resize='both']) .control{resize: both}:host([resize='horizontal']) .control{resize: horizontal}:host([resize='vertical']) .control{resize: vertical}.label{display: block;color: ${$s};cursor: pointer;font-size: ${Is};line-height: ${Os};margin-bottom: 2px}.label__hidden{display: none;visibility: hidden}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${xs}}:host([disabled]) .control{border-color: ${no}}`,shadowOptions:{delegatesFocus:!0}});class on extends Ui{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const nn=on.compose({baseName:"text-field",template:(e,t)=>W`<template class=" ${e=>e.readOnly?"readonly":""} "><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Fe({property:"defaultSlottedNodes",filter:fi})}></slot></label><div class="root" part="root">${Ne(0,t)}<input class="control" part="control" id="control" @input="${e=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" pattern="${e=>e.pattern}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" size="${e=>e.size}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ie("control")} />${Me(0,t)}</div></template>`,styles:(e,t)=>ge` ${ui("inline-block")} :host{font-family: ${ws};outline: none;user-select: none}.root{box-sizing: border-box;position: relative;display: flex;flex-direction: row;color: ${lo};background: ${ao};border-radius: calc(${vs} * 1px);border: calc(${bs} * 1px) solid ${no};height: calc(${ks} * 1px);min-width: ${Ts}}.control{-webkit-appearance: none;font: inherit;background: transparent;border: 0;color: inherit;height: calc(100% - (${ys} * 1px));width: 100%;margin-top: auto;margin-bottom: auto;border: none;padding: 0 calc(${ys} * 2px + 1px);font-size: ${Is};line-height: ${Os}}.control:hover,	.control:${pi},	.control:disabled,	.control:active{outline: none}.label{display: block;color: ${$s};cursor: pointer;font-size: ${Is};line-height: ${Os};margin-bottom: 2px}.label__hidden{display: none;visibility: hidden}.start,	.end{display: flex;margin: auto;fill: currentcolor}::slotted(svg),	::slotted(span){width: calc(${ys} * 4px);height: calc(${ys} * 4px)}.start{margin-inline-start: calc(${ys} * 2px)}.end{margin-inline-end: calc(${ys} * 2px)}:host(:hover:not([disabled])) .root{background: ${ao};border-color: ${no}}:host(:active:not([disabled])) .root{background: ${ao};border-color: ${Cs}}:host(:focus-within:not([disabled])) .root{border-color: ${Cs}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${xs}}:host([disabled]) .control{border-color: ${no}}`,shadowOptions:{delegatesFocus:!0}}),rn={vsCodeBadge:vo,vsCodeButton:ko,vsCodeCheckbox:Io,vsCodeDataGrid:Ro,vsCodeDataGridCell:Eo,vsCodeDataGridRow:So,vsCodeDivider:Bo,vsCodeDropdown:Lo,vsCodeLink:Ho,vsCodeOption:No,vsCodePanels:jo,vsCodePanelTab:qo,vsCodePanelView:Ko,vsCodeProgressRing:Wo,vsCodeRadioGroup:Yo,vsCodeRadio:Jo,vsCodeTag:en,vsCodeTextArea:sn,vsCodeTextField:nn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}};function an(e){return Vi.getOrCreate(e).withPrefix("vscode")}const ln=an().register(rn);export{mo as Badge,$o as Button,To as Checkbox,Oo as DataGrid,Do as DataGridCell,Qt as DataGridCellTypes,Ao as DataGridRow,Yt as DataGridRowTypes,Po as Divider,Ni as DividerRole,Fo as Dropdown,ci as DropdownPosition,Wt as GenerateHeaderOptions,Vo as Link,Mo as Option,_o as PanelTab,Uo as PanelView,zo as Panels,Go as ProgressRing,Xo as Radio,Qo as RadioGroup,Rt as RadioGroupOrientation,Zo as Tag,tn as TextArea,ns as TextAreaResize,on as TextField,qi as TextFieldType,ln as VSCodeDesignSystem,rn as allComponents,an as provideVSCodeDesignSystem,vo as vsCodeBadge,ko as vsCodeButton,Io as vsCodeCheckbox,Ro as vsCodeDataGrid,Eo as vsCodeDataGridCell,So as vsCodeDataGridRow,Bo as vsCodeDivider,Lo as vsCodeDropdown,Ho as vsCodeLink,No as vsCodeOption,qo as vsCodePanelTab,Ko as vsCodePanelView,jo as vsCodePanels,Wo as vsCodeProgressRing,Jo as vsCodeRadio,Yo as vsCodeRadioGroup,en as vsCodeTag,sn as vsCodeTextArea,nn as vsCodeTextField};
