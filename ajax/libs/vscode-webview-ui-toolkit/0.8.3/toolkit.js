...
const FASTDesignSystem = provideVSCodeDesignSystem().register(allComponents);

export { Badge, Button, Checkbox, DataGrid, DataGridCell, DataGridRow, Divider, Dropdown, FASTDesignSystem, Link, Option$1 as Option, PanelTab, PanelView, Panels, ProgressRing, Radio, RadioGroup, Tag, TextArea, TextField, vsCodeBadge, vsCodeButton, vsCodeCheckbox, vsCodeDataGrid, vsCodeDataGridCell, vsCodeDataGridRow, vsCodeDivider, vsCodeDropdown, vsCodeLink, vsCodeOption, vsCodePanelTab, vsCodePanelView, vsCodePanels, vsCodeProgressRing, vsCodeRadio, vsCodeRadioGroup, vsCodeTag, vsCodeTextArea, vsCodeTextField };
