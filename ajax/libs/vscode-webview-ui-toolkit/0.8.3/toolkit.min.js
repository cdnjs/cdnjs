...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */const Oo=Oe` ${wi("inline-flex")} :host{outline: none;font-family: ${As};font-size: ${Ps};line-height: ${Fs};color: ${Ms};background: ${Ns};border-radius: calc(${Ts} * 1px);fill: currentColor;cursor: pointer}.control{background: transparent;height: inherit;flex-grow: 1;box-sizing: border-box;display: inline-flex;justify-content: center;align-items: center;padding: ${Ks} ${Us};white-space: nowrap;outline: none;text-decoration: none;border: calc(${ws} * 1px) solid ${Zs};color: inherit;border-radius: inherit;fill: inherit;cursor: inherit;font-family: inherit}:host(:hover){background: ${zs}}:host(:active){background: ${Ns}}.control: ${$i}{outline: calc(${ws} * 1px) solid ${Os};outline-offset: calc(${ws} * 2px)}.control::-moz-focus-inner{border: 0}:host([disabled]){opacity: ${Is};background: ${Ns};cursor: ${"not-allowed"}}.content{display: flex}.start{display: flex}::slotted(svg),	::slotted(span){width: calc(${Cs} * 4px);height: calc(${Cs} * 4px)}.start{margin-inline-end: 8px}`,Ro=Oe`	:host([appearance='primary']){background: ${Ns};color: ${Ms}}:host([appearance='primary']:hover){background: ${zs}}:host([appearance='primary']:active) .control:active{background: ${Ns}}:host([appearance='primary']) .control:${$i}{outline: calc(${ws} * 1px) solid ${Os};outline-offset: calc(${ws} * 2px)}:host([appearance='primary'][disabled]){background: ${Ns}}`,Ao=Oe`	:host([appearance='secondary']){background: ${js};color: ${_s}}:host([appearance='secondary']:hover){background: ${qs}}:host([appearance='secondary']:active) .control:active{background: ${js}}:host([appearance='secondary']) .control:${$i}{outline: calc(${ws} * 1px) solid ${Os};outline-offset: calc(${ws} * 2px)}:host([appearance='secondary'][disabled]){background: ${js}}`,Do=Oe`	:host([appearance='icon']){background: ${Ws};border-radius: ${Ys};color: ${Rs}}:host([appearance='icon']:hover){background: ${Gs}}:host([appearance='icon']) .control{padding: ${Qs}}:host([appearance='icon']:active) .control:active{background: ${Gs}}:host([appearance='icon']) .control:${$i}{outline: calc(${ws} * 1px) solid ${Os};outline-offset: ${Xs}}:host([appearance='icon'][disabled]){background: ${Ws}}`;class So extends ti{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,i){if("appearance"===e&&"icon"===i){this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")}"aria-label"===e&&(this.ariaLabel=i),"disabled"===e&&(this.disabled=!0)}}!function(e,t,i,s){var o,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(r=(n<3?o(r):n>3?o(t,i,r):o(t,i))||r);n>3&&r&&Object.defineProperty(t,i,r)}([be],So.prototype,"appearance",void 0);const Eo=So.compose({baseName:"button",template:(e,t)=>ne`<button class="control" part="control" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" form="${e=>e.formId}" formaction="${e=>e.formaction}" formenctype="${e=>e.formenctype}" formmethod="${e=>e.formmethod}" formnovalidate="${e=>e.formnovalidate}" formtarget="${e=>e.formtarget}" name="${e=>e.name}" type="${e=>e.type}" value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-pressed="${e=>e.ariaPressed}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ve("control")}>${Xe(0,t)}<span class="content" part="content"><slot ${Ke("defaultSlottedContent")}></slot></span>${Ye(0,t)}</button>`,styles:(e,t)=>Oe` ${Oo} ${Ro} ${Ao} ${Do}`,shadowOptions:{delegatesFocus:!0}});class Po extends pi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Fo=Po.compose({baseName:"checkbox",template:(e,t)=>ne`<template role="checkbox" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" tabindex="${e=>e.disabled?null:0}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}" class="${e=>e.readOnly?"readonly":""} ${e=>e.checked?"checked":""} ${e=>e.indeterminate?"indeterminate":""}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot><slot name="indeterminate-indicator">${t.indeterminateIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{align-items: center;outline: none;margin: calc(${Cs} * 1px) 0;user-select: none;font-size: ${Ps};line-height: ${Fs}}.control{position: relative;width: calc(${Cs} * 4px);height: calc(${Cs} * 4px);box-sizing: border-box;border-radius: calc(${io} * 1px);border: calc(${ws} * 1px) solid ${to};background: ${Js};outline: none;cursor: pointer}.label{font-family: ${As};color: ${Rs};padding-inline-start: calc(${Cs} * 2px + 2px);margin-inline-end: calc(${Cs} * 2px + 2px);cursor: pointer}.label__hidden{display: none;visibility: hidden}.checked-indicator{width: 100%;height: 100%;display: block;fill: ${Rs};opacity: 0;pointer-events: none}.indeterminate-indicator{border-radius: 2px;background: ${Rs};position: absolute;top: 50%;left: 50%;width: 50%;height: 50%;transform: translate(-50%, -50%);opacity: 0}:host(:enabled) .control:hover{background: ${Js};border-color: ${to}}:host(:enabled) .control:active{background: ${Js};border-color: ${Os}}:host(:${$i}) .control{border: calc(${ws} * 1px) solid ${Os};border-radius: ${Ts}}:host(.disabled) .label,	:host(.readonly) .label,	:host(.readonly) .control,	:host(.disabled) .control{cursor: ${"not-allowed"}}:host(.checked:not(.indeterminate)) .checked-indicator,	:host(.indeterminate) .indeterminate-indicator{opacity: 1}:host(.disabled){opacity: ${Is}}`,checkedIndicator:'\n\t\t<svg\n\t\t\tpart="checked-indicator"\n\t\t\tclass="checked-indicator"\n\t\t\tviewBox="0 0 20 20"\n\t\t\txmlns="http://www.w3.org/2000/svg"\n\t\t>\n\t\t\t<path\n\t\t\t\tfill-rule="evenodd"\n\t\t\t\tclip-rule="evenodd"\n\t\t\t\td="M8.143 12.6697L15.235 4.5L16.8 5.90363L8.23812 15.7667L3.80005 11.2556L5.27591 9.7555L8.143 12.6697Z"\n\t\t\t/>\n\t\t</svg>\n\t',indeterminateIndicator:'\n\t\t<div part="indeterminate-indicator" class="indeterminate-indicator"></div>\n\t'});class Bo extends ai{connectedCallback(){super.connectedCallback();this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const Lo=Bo.compose({baseName:"data-grid",baseClass:ai,template:(e,t)=>{const i=function(e){const t=e.tagFor(ri);return ne`<${t} :rowData="${e=>e}" :cellItemTemplate="${(e,t)=>t.parent.cellItemTemplate}" :headerCellItemTemplate="${(e,t)=>t.parent.headerCellItemTemplate}"></${t}>`}(e),s=e.tagFor(ri);return ne`<template role="grid" tabindex="0" :rowElementTag="${()=>s}" :defaultRowItemTemplate="${i}" ${Ge({property:"rowElements",filter:je("[role=row]")})}><slot></slot></template>`},styles:(e,t)=>Oe`	:host{display: flex;position: relative;flex-direction: column;width: 100%}`});class Vo extends ri{}const Ho=Vo.compose({baseName:"data-grid-row",baseClass:ri,template:(e,t)=>{const i=function(e){const t=e.tagFor(ci);return ne`<${t} cell-type="${e=>e.isRowHeader?"rowheader":void 0}" grid-column="${(e,t)=>t.index+1}" :rowData="${(e,t)=>t.parent.rowData}" :columnDefinition="${e=>e}"></${t}>`}(e),s=function(e){const t=e.tagFor(ci);return ne`<${t} cell-type="columnheader" grid-column="${(e,t)=>t.index+1}" :columnDefinition="${e=>e}"></${t}>`}(e);return ne`<template role="row" class="${e=>"default"!==e.rowType?e.rowType:""}" :defaultCellItemTemplate="${i}" :defaultHeaderCellItemTemplate="${s}" ${Ge({property:"cellElements",filter:je('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}><slot ${Ke("slottedCellElements")}></slot></template>`},styles:(e,t)=>Oe`	:host{display: grid;padding: calc((${Cs} / 4) * 1px) 0;box-sizing: border-box;width: 100%;background: transparent}:host(.header){}:host(.sticky-header){background: ${ro};position: sticky;top: 0}:host(:hover){background: ${no}}`});class Mo extends ci{}const No=Mo.compose({baseName:"data-grid-cell",baseClass:ci,template:(e,t)=>ne`<template tabindex="-1" role="${e=>{var t;return null!==(t=e.cellType)&&void 0!==t?t:"gridcell"}}" class=" ${e=>"columnheader"===e.cellType?"column-header":"rowheader"===e.cellType?"row-header":""} "><slot></slot></template>`,styles:(e,t)=>Oe`	:host{padding: calc(${Cs} * 1px) calc(${Cs} * 3px);color: ${Rs};opacity: 1;box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};font-weight: 400;border: solid calc(${ws} * 1px) transparent;border-radius: calc(${Ts} * 1px);min-width: 96px;white-space: wrap;overflow-wrap: break-word}:host(.column-header){font-weight: 600}:host(:${$i}),	:host(:focus),	:host(:active){background: ${so};border: solid calc(${ws} * 1px) ${Os};color: ${oo};outline: none}`});class zo extends Xi{}const _o=zo.compose({baseName:"divider",template:(e,t)=>ne`<template role="${e=>e.role}"></template>`,styles:(e,t)=>Oe` ${wi("block")} :host{border: none;border-top: calc(${ws} * 1px) solid ${ao};box-sizing: content-box;height: 0;margin: calc(${Cs} * 1px) 0;width: 100%}`});class jo extends cs{}const qo=jo.compose({baseName:"dropdown",template:(e,t)=>ne`<template class="${e=>e.open?"open":""} ${e=>e.disabled?"disabled":""} ${e=>e.position}" role="${e=>e.role}" tabindex="${e=>e.disabled?null:"0"}" aria-disabled="${e=>e.ariaDisabled}" aria-expanded="${e=>e.ariaExpanded}" @click="${(e,t)=>e.clickHandler(t.event)}" @focusout="${(e,t)=>e.focusoutHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}"><div aria-activedescendant="${e=>e.open?e.ariaActiveDescendant:null}" aria-controls="listbox" aria-expanded="${e=>e.ariaExpanded}" aria-haspopup="listbox" class="control" part="control" role="button" ?disabled="${e=>e.disabled}">${Xe(0,t)}<slot name="button-container"><div class="selected-value" part="selected-value"><slot name="selected-value">${e=>e.displayValue}</slot></div><div class="indicator" part="indicator"><slot name="indicator">${t.indicator||""}</slot></div></slot>${Ye(0,t)}</div><div aria-disabled="${e=>e.disabled}" class="listbox" id="listbox" part="listbox" role="listbox" ?disabled="${e=>e.disabled}" ?hidden="${e=>!e.open}" ${Ve("listbox")}><slot ${Ke({filter:yi.slottedOptionFilter,flatten:!0,property:"slottedOptions"})}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{background: ${lo};box-sizing: border-box;color: ${co};contain: contents;font-family: ${As};height: calc(${Ss} * 1px);position: relative;user-select: none;min-width: ${Es};outline: none;vertical-align: top}.control{align-items: center;box-sizing: border-box;border: calc(${ws} * 1px) solid ${ho};border-radius: calc(${Ts} * 1px);cursor: pointer;display: flex;font-family: inherit;font-size: ${Ps};line-height: ${Fs};min-height: 100%;padding: 0 calc(${Cs} * 2px);width: 100%}.listbox{background: ${lo};border: calc(${ws} * 1px) solid ${Os};border-radius: calc(${Ts} * 1px);box-sizing: border-box;display: inline-flex;flex-direction: column;left: 0;max-height: ${uo};padding: 0 0 calc(${Cs} * 1px) 0;overflow-y: auto;position: absolute;width: 100%;z-index: 1}.listbox[hidden]{display: none}:host(:${$i}) .control{border-color: ${Os}}:host(:not([disabled]):hover){background: ${lo};border-color: ${ho}}:host(:${$i}) ::slotted([aria-selected="true"][role="option"]:not([disabled])){background: ${so};border: calc(${ws} * 1px) solid ${Os};color: ${oo}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${Is}}:host([disabled]) .control{cursor: ${"not-allowed"};user-select: none}:host([disabled]:hover){background: ${lo};color: ${co};fill: currentcolor}:host(:not([disabled])) .control:active{border-color: ${Os}}:host(:empty) .listbox{display: none}:host([open]) .control{border-color: ${Os}}:host([open][position='above']) .listbox,	:host([open][position='below']) .control{border-bottom-left-radius: 0;border-bottom-right-radius: 0}:host([open][position='above']) .control,	:host([open][position='below']) .listbox{border-top-left-radius: 0;border-top-right-radius: 0}:host([open][position='above']) .listbox{bottom: calc(${Ss} * 1px)}:host([open][position='below']) .listbox{top: calc(${Ss} * 1px)}.selected-value{flex: 1 1 auto;font-family: inherit;overflow: hidden;text-align: start;text-overflow: ellipsis;white-space: nowrap}.indicator{flex: 0 0 auto;margin-inline-start: 1em}slot[name='listbox']{display: none;width: 100%}:host([open]) slot[name='listbox']{display: flex;position: absolute}.end{margin-inline-start: auto}.start,	.end,	.indicator,	.select-indicator,	::slotted(svg),	::slotted(span){fill: currentcolor;height: 1em;min-height: calc(${Cs} * 4px);min-width: calc(${Cs} * 4px);width: 1em}::slotted([role='option']),	::slotted(option){flex: 0 0 auto}`,indicator:'\n\t\t<svg\n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\tviewBox="0 0 12 7"\n\t\t\txmlns="http://www.w3.org/2000/svg"\n\t\t>\n\t\t\t<path\n\t\t\t\td="M11.85.65c.2.2.2.5 0 .7L6.4 6.84a.55.55 0 01-.78 0L.14 1.35a.5.5 0 11.71-.7L6 5.8 11.15.65c.2-.2.5-.2.7 0z"\n\t\t\t/>\n\t\t</svg>\n\t'});class Uo extends Kt{}const Ko=Uo.compose({baseName:"link",template:(e,t)=>ne`<a class="control" part="control" download="${e=>e.download}" href="${e=>e.href}" hreflang="${e=>e.hreflang}" ping="${e=>e.ping}" referrerpolicy="${e=>e.referrerpolicy}" rel="${e=>e.rel}" target="${e=>e.target}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ve("control")}>${Xe(0,t)}<span class="content" part="content"><slot ${Ke("defaultSlottedContent")}></slot></span>${Ye(0,t)}</a>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{background: transparent;box-sizing: border-box;color: ${go};cursor: pointer;fill: currentcolor;font-family: ${As};font-size: ${Ps};line-height: ${Fs};outline: none}.control{align-items: center;background: transparent;border: calc(${ws} * 1px) solid transparent;border-radius: calc(${Ts} * 1px);box-sizing: border-box;color: inherit;cursor: inherit;display: inline-flex;fill: inherit;font-family: inherit;flex-grow: 1;height: inherit;justify-content: center;padding: 0;outline: none;text-decoration: none;white-space: nowrap}.control::-moz-focus-inner{border: 0}:host(:hover){color: ${mo}}:host(:hover) .content{text-decoration: underline}:host(:active){background: transparent;color: ${mo}}:host(:${$i}) .control{border: calc(${ws} * 1px) solid ${Os}}`,shadowOptions:{delegatesFocus:!0}});class Wo extends vi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Go=Wo.compose({baseName:"option",template:(e,t)=>ne`<template aria-selected="${e=>e.selected}" class="${e=>e.selected?"selected":""} ${e=>e.disabled?"disabled":""}" role="option">${Xe(0,t)}<span class="content" part="content"><slot></slot></span>${Ye(0,t)}</template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{font-family: var(--body-font);border-radius: ${Ts};border: calc(${ws} * 1px) solid transparent;box-sizing: border-box;color: ${Rs};cursor: pointer;fill: currentcolor;font-size: ${Ps};line-height: ${Fs};margin: 0;outline: none;overflow: hidden;padding: 0 calc((${Cs} / 2) * 1px) calc((${Cs} / 4) * 1px);user-select: none;white-space: nowrap}:host(:${$i}){border-color: ${Os};background: ${so};color: ${Rs}}:host([aria-selected='true']){background: ${so};border: calc(${ws} * 1px) solid ${Os};color: ${oo}}:host(:active){background: ${so};color: ${oo}}:host(:not([aria-selected='true']):hover){background: ${so};border: calc(${ws} * 1px) solid ${Os};color: ${oo}}:host(:not([aria-selected='true']):active){background: ${so};color: ${Rs}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${Is}}:host([disabled]:hover){background-color: inherit}.content{grid-column-start: 2;justify-self: start;overflow: hidden;text-overflow: ellipsis}`});class Qo extends gs{connectedCallback(){super.connectedCallback(),this.orientation&&(this.orientation=fs.horizontal);this.getAttribute("aria-label")||this.setAttribute("aria-label","Panels")}}const Yo=Qo.compose({baseName:"panels",template:(e,t)=>ne`<template class="${e=>e.orientation}">${Xe(0,t)}<div class="tablist" part="tablist" role="tablist"><slot class="tab" name="tab" part="tab" ${Ke("tabs")}></slot>${He((e=>e.showActiveIndicator),ne`<div ${Ve("activeIndicatorRef")} class="activeIndicator" part="activeIndicator"></div>`)}</div>${Ye(0,t)}<div class="tabpanel"><slot name="tabpanel" part="tabpanel" ${Ke("tabpanels")}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("grid")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};color: ${Rs};grid-template-columns: auto 1fr auto;grid-template-rows: auto 1fr;overflow-x: auto}.tablist{display: grid;grid-template-rows: auto auto;grid-template-columns: auto;column-gap: calc(${Cs} * 8px);position: relative;width: max-content;align-self: end;padding: calc(${Cs} * 1px) calc(${Cs} * 1px) 0;box-sizing: border-box}.start,	.end{align-self: center}.activeIndicator{grid-row: 2;grid-column: 1;width: 100%;height: calc((${Cs} / 4) * 1px);justify-self: center;background: ${wo};margin: 0;border-radius: calc(${Ts} * 1px)}.activeIndicatorTransition{transition: transform 0.01s linear}.tabpanel{grid-row: 2;grid-column-start: 1;grid-column-end: 4;position: relative}`});class Xo extends ps{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const Zo=Xo.compose({baseName:"panel-tab",template:(e,t)=>ne`<template slot="tab" role="tab" aria-disabled="${e=>e.disabled}"><slot></slot></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};height: calc(${Cs} * 7px);padding: calc(${Cs} * 1px) 0;color: ${Co};fill: currentcolor;border-radius: calc(${Ts} * 1px);border: solid calc(${ws} * 1px) transparent;align-items: center;justify-content: center;grid-row: 1;cursor: pointer}:host(:hover){color: ${wo};fill: currentcolor}:host(:active){color: ${wo};fill: currentcolor}:host([aria-selected='true']){background: transparent;color: ${wo};fill: currentcolor}:host([aria-selected='true']:hover){background: transparent;color: ${wo};fill: currentcolor}:host([aria-selected='true']:active){background: transparent;color: ${wo};fill: currentcolor}:host(:${$i}){outline: none;border: solid calc(${ws} * 1px) ${$o}}:host(:focus){outline: none}::slotted(vscode-badge){margin-inline-start: calc(${Cs} * 2px)}`});class Jo extends us{}const en=Jo.compose({baseName:"panel-view",template:(e,t)=>ne`<template slot="tabpanel" role="tabpanel"><slot></slot></template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{color: inherit;background-color: transparent;border: solid calc(${ws} * 1px) transparent;box-sizing: border-box;font-size: ${Ps};line-height: ${Fs};padding: 10px calc((${Cs} + 2) * 1px)}`});class tn extends ss{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const sn=tn.compose({baseName:"progress-ring",template:(e,t)=>ne`<template role="progressbar" aria-valuenow="${e=>e.value}" aria-valuemin="${e=>e.min}" aria-valuemax="${e=>e.max}" class="${e=>e.paused?"paused":""}">${He((e=>"number"==typeof e.value),ne`<svg class="progress" part="progress" viewBox="0 0 16 16" slot="determinate"><circle class="background" part="background" cx="8px" cy="8px" r="7px"></circle><circle class="determinate" part="determinate" style="stroke-dasharray: ${e=>44*e.percentComplete/100}px ${44}px" cx="8px" cy="8px" r="7px"></circle></svg>`)} ${He((e=>"number"!=typeof e.value),ne`<slot name="indeterminate" slot="indeterminate">${t.indeterminateIndicator||""}</slot>`)}</template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{align-items: center;outline: none;height: calc(${Cs} * 7px);width: calc(${Cs} * 7px);margin: 0}.progress{height: 100%;width: 100%}.background{fill: none;stroke: transparent;stroke-width: calc(${Cs} / 2 * 1px)}.indeterminate-indicator-1{fill: none;stroke: ${vo};stroke-width: calc(${Cs} / 2 * 1px);stroke-linecap: square;transform-origin: 50% 50%;transform: rotate(-90deg);transition: all 0.2s ease-in-out;animation: spin-infinite 2s linear infinite}@keyframes spin-infinite{0%{stroke-dasharray: 0.01px 43.97px;transform: rotate(0deg)}50%{stroke-dasharray: 21.99px 21.99px;transform: rotate(450deg)}100%{stroke-dasharray: 0.01px 43.97px;transform: rotate(1080deg)}}`,indeterminateIndicator:'\n\t\t<svg class="progress" part="progress" viewBox="0 0 16 16">\n\t\t\t<circle\n\t\t\t\tclass="background"\n\t\t\t\tpart="background"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t\t<circle\n\t\t\t\tclass="indeterminate-indicator-1"\n\t\t\t\tpart="indeterminate-indicator-1"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t</svg>\n\t'});class on extends os{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const t="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",t),this.setAttribute("aria-labelledby",t)}}}const nn=on.compose({baseName:"radio-group",template:(e,t)=>ne`<template role="radiogroup" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @click="${(e,t)=>e.clickHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}" @focusout="${(e,t)=>e.focusOutHandler(t.event)}"><slot name="label"></slot><div class="positioning-region ${e=>e.orientation===Mt.horizontal?"horizontal":"vertical"}" part="positioning-region"><slot ${Ke({property:"slottedRadioButtons",filter:je("[role=radio]")})}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{align-items: flex-start;margin: calc(${Cs} * 1px) 0;flex-direction: column}.positioning-region{display: flex;flex-wrap: wrap}:host([orientation='vertical']) .positioning-region{flex-direction: column}:host([orientation='horizontal']) .positioning-region{flex-direction: row}::slotted([slot='label']){color: ${eo};font-size: ${Ps};margin: calc(${Cs} * 1px) 0}`});class rn extends as{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Radio")}}const an=rn.compose({baseName:"radio",template:(e,t)=>ne`<template role="radio" class="${e=>e.checked?"checked":""} ${e=>e.readOnly?"readonly":""}" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{align-items: center;flex-direction: row;font-size: ${Ps};line-height: ${Fs};margin: calc(${Cs} * 1px) 0;outline: none;position: relative;transition: all 0.2s ease-in-out;user-select: none}.control{background: ${Js};border-radius: 999px;border: calc(${ws} * 1px) solid ${to};box-sizing: border-box;cursor: pointer;height: calc(${Cs} * 4px);position: relative;outline: none;width: calc(${Cs} * 4px)}.label{color: ${Rs};cursor: pointer;font-family: ${As};margin-inline-end: calc(${Cs} * 2px + 2px);padding-inline-start: calc(${Cs} * 2px + 2px)}.label__hidden{display: none;visibility: hidden}.control,	.checked-indicator{flex-shrink: 0}.checked-indicator{background: ${Rs};border-radius: 999px;display: inline-block;inset: calc(${Cs} * 1px);opacity: 0;pointer-events: none;position: absolute}:host(:not([disabled])) .control:hover{background: ${Js};border-color: ${to}}:host(:not([disabled])) .control:active{background: ${Js};border-color: ${Os}}:host(:${$i}) .control{border: calc(${ws} * 1px) solid ${Os}}:host([aria-checked='true']) .control{background: ${Js};border: calc(${ws} * 1px) solid ${to}}:host([aria-checked='true']:not([disabled])) .control:hover{background: ${Js};border: calc(${ws} * 1px) solid ${to}}:host([aria-checked='true']:not([disabled])) .control:active{background: ${Js};border: calc(${ws} * 1px) solid ${Os}}:host([aria-checked="true"]:${$i}:not([disabled])) .control{border: calc(${ws} * 1px) solid ${Os}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([aria-checked='true']) .checked-indicator{opacity: 1}:host([disabled]){opacity: ${Is}}`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class ln extends Qt{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const dn=ln.compose({baseName:"tag",template:Gt,styles:(e,t)=>Oe` ${wi("inline-block")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Bs};line-height: ${Ls}}.control{background-color: ${Hs};border: calc(${ws} * 1px) solid ${Zs};border-radius: ${ko};color: ${Vs};padding: calc(${Cs} * 0.5px) calc(${Cs} * 1px);text-transform: uppercase}`});class cn extends ys{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const hn=cn.compose({baseName:"text-area",template:(e,t)=>ne`<template class=" ${e=>e.readOnly?"readonly":""} ${e=>e.resize!==bs.none?`resize-${e.resize}`:""}"><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label><textarea part="control" class="control" id="control" ?autofocus="${e=>e.autofocus}" cols="${e=>e.cols}" ?disabled="${e=>e.disabled}" form="${e=>e.form}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" name="${e=>e.name}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" rows="${e=>e.rows}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" @input="${(e,t)=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ${Ve("control")}></textarea></template>`,styles:(e,t)=>Oe` ${wi("inline-block")} :host{font-family: ${As};outline: none;user-select: none}.control{box-sizing: border-box;position: relative;color: ${fo};background: ${po};border-radius: calc(${Ts} * 1px);border: calc(${ws} * 1px) solid ${ho};font: inherit;font-size: ${Ps};line-height: ${Fs};padding: calc(${Cs} * 2px + 1px);width: 100%;min-width: ${Es};resize: none}.control:hover:enabled{background: ${po};border-color: ${ho}}.control:active:enabled{background: ${po};border-color: ${Os}}.control:hover,	.control:${$i},	.control:disabled,	.control:active{outline: none}:host(:focus-within:not([disabled])) .control{border-color: ${Os}}:host([resize='both']) .control{resize: both}:host([resize='horizontal']) .control{resize: horizontal}:host([resize='vertical']) .control{resize: vertical}.label{display: block;color: ${bo};cursor: pointer;font-size: ${Ps};line-height: ${Fs};margin-bottom: calc(${Cs} * 1px)}.label__hidden{display: none;visibility: hidden}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${Is}}:host([disabled]) .control{border-color: ${ho}}`,shadowOptions:{delegatesFocus:!0}});class un extends ts{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const pn=un.compose({baseName:"text-field",template:(e,t)=>ne`<template class=" ${e=>e.readOnly?"readonly":""} "><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke({property:"defaultSlottedNodes",filter:ki})}></slot></label><div class="root" part="root">${Xe(0,t)}<input class="control" part="control" id="control" @input="${e=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" pattern="${e=>e.pattern}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" size="${e=>e.size}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Ve("control")} />${Ye(0,t)}</div></template>`,styles:(e,t)=>Oe` ${wi("inline-block")} :host{font-family: ${As};outline: none;user-select: none}.root{box-sizing: border-box;position: relative;display: flex;flex-direction: row;color: ${fo};background: ${po};border-radius: calc(${Ts} * 1px);border: calc(${ws} * 1px) solid ${ho};height: calc(${Ss} * 1px);min-width: ${Es}}.control{-webkit-appearance: none;font: inherit;background: transparent;border: 0;color: inherit;height: calc(100% - (${Cs} * 1px));width: 100%;margin-top: auto;margin-bottom: auto;border: none;padding: 0 calc(${Cs} * 2px + 1px);font-size: ${Ps};line-height: ${Fs}}.control:hover,	.control:${$i},	.control:disabled,	.control:active{outline: none}.label{display: block;color: ${bo};cursor: pointer;font-size: ${Ps};line-height: ${Fs};margin-bottom: calc(${Cs} * 1px)}.label__hidden{display: none;visibility: hidden}.start,	.end{display: flex;margin: auto;fill: currentcolor}::slotted(svg),	::slotted(span){width: calc(${Cs} * 4px);height: calc(${Cs} * 4px)}.start{margin-inline-start: 11px}.end{margin-inline-end: 11px}:host(:hover:not([disabled])) .root{background: ${po};border-color: ${ho}}:host(:active:not([disabled])) .root{background: ${po};border-color: ${Os}}:host(:focus-within:not([disabled])) .root{border-color: ${Os}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${Is}}:host([disabled]) .control{border-color: ${ho}}`,shadowOptions:{delegatesFocus:!0}}),fn={vsCodeBadge:Io,vsCodeButton:Eo,vsCodeCheckbox:Fo,vsCodeDataGrid:Lo,vsCodeDataGridCell:No,vsCodeDataGridRow:Ho,vsCodeDivider:_o,vsCodeDropdown:qo,vsCodeLink:Ko,vsCodeOption:Go,vsCodePanels:Yo,vsCodePanelTab:Zo,vsCodePanelView:en,vsCodeProgressRing:sn,vsCodeRadioGroup:nn,vsCodeRadio:an,vsCodeTag:dn,vsCodeTextArea:hn,vsCodeTextField:pn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}};const bn={"--vscode-badge-background":Hs,"--vscode-badge-foreground":Vs,"--vscode-button-border":Zs,"--vscode-button-background":Ns,"--vscode-button-foreground":Ms,"--vscode-button-hoverBackground":zs,"--vscode-button-secondaryBackground":js,"--vscode-button-secondaryForeground":_s,"--vscode-button-secondaryHoverBackground":qs,"--vscode-checkbox-background":Js,"--vscode-checkbox-border":to,"--vscode-checkbox-foreground":eo,"--vscode-contrastActiveBorder":$s,"--vscode-contrastBorder":ks,"--vscode-dropdown-background":lo,"--vscode-dropdown-border":ho,"--vscode-dropdown-foreground":co,"--vscode-focusBorder":Os,"--vscode-font-family":As,"--vscode-font-size":Ps,"--vscode-font-weight":Ds,"--vscode-foreground":Rs,"--vscode-input-background":po,"--vscode-input-foreground":fo,"--vscode-input-placeholderForeground":bo,"--vscode-list-activeSelectionBackground":so,"--vscode-list-activeSelectionForeground":oo,"--vscode-list-hoverBackground":no,"--vscode-panel-background":yo,"--vscode-panel-border":xo,"--vscode-panelTitle-activeBorder":$o,"--vscode-panelTitle-activeForeground":wo,"--vscode-panelTitle-inactiveForeground":Co,"--vscode-progressBar-background":vo,"--vscode-quickInput-background":ro,"--vscode-settings-dropdownListBorder":ao,"--vscode-textLink-activeForeground":mo,"--vscode-textLink-foreground":go};function gn(){const e=getComputedStyle(document.body);for(const t in bn){const i=bn[t],s=document.querySelector("body"),o=e.getPropertyValue(t).toString();s&&i.setValueFor(s,o)}}window.addEventListener("load",(()=>{new MutationObserver(gn).observe(document.body,{attributes:!0,attributeFilter:["class"]}),gn()}));const mn=Wi.getOrCreate(vn).withPrefix("vscode").register(fn);var vn;export{To as Badge,So as Button,Po as Checkbox,Bo as DataGrid,Mo as DataGridCell,Vo as DataGridRow,zo as Divider,jo as Dropdown,mn as FASTDesignSystem,Uo as Link,Wo as Option,Xo as PanelTab,Jo as PanelView,Qo as Panels,tn as ProgressRing,rn as Radio,on as RadioGroup,ln as Tag,cn as TextArea,un as TextField,Io as vsCodeBadge,Eo as vsCodeButton,Fo as vsCodeCheckbox,Lo as vsCodeDataGrid,No as vsCodeDataGridCell,Ho as vsCodeDataGridRow,_o as vsCodeDivider,qo as vsCodeDropdown,Ko as vsCodeLink,Go as vsCodeOption,Zo as vsCodePanelTab,en as vsCodePanelView,Yo as vsCodePanels,sn as vsCodeProgressRing,an as vsCodeRadio,nn as vsCodeRadioGroup,dn as vsCodeTag,hn as vsCodeTextArea,pn as vsCodeTextField};
