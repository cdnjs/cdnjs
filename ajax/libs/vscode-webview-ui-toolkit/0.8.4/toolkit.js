...
__decorate$1([attr({
  attribute: "checked",
  mode: "boolean"
})], Checkbox$1.prototype, "checkedAttribute", void 0);

__decorate$1([observable], Checkbox$1.prototype, "defaultSlottedNodes", void 0);

__decorate$1([observable], Checkbox$1.prototype, "defaultChecked", void 0);

__decorate$1([observable], Checkbox$1.prototype, "checked", void 0);
...
__decorate$1([attr({
  attribute: "checked",
  mode: "boolean"
})], Radio$1.prototype, "checkedAttribute", void 0);

__decorate$1([observable], Radio$1.prototype, "defaultSlottedNodes", void 0);

__decorate$1([observable], Radio$1.prototype, "defaultChecked", void 0);

__decorate$1([observable], Radio$1.prototype, "checked", void 0);
...
create('contrast-active-border', '--vscode-contrastActiveBorder').withDefault('#f38518');
...
const checkboxForeground = create('checkbox-foreground', '--vscode-checkbox-foreground').withDefault('#f0f0f0');
/**
...
const quickInputBackground = create('quick-input-background', '--vscode-quickInput-background').withDefault('#252526');
/**
...
const dropdownForeground = create('dropdown-foreground', '--vscode-dropdown-foreground').withDefault('#f0f0f0');
...
const inputPlaceholderForeground = create('input-placeholder-foreground', '--vscode-input-placeholderForeground').withDefault('#cccccc');
/**
 * Link design tokens.
 */

const linkActiveForeground = create('link-foreground', '--vscode-textLink-activeForeground').withDefault('#3794ff');
const linkForeground = create('link-active-foreground', '--vscode-textLink-foreground').withDefault('#3794ff');
/**
...
// Copyright (c) Microsoft Corporation.
const dataGridRowStyles = (context, definition) => css`	:host{display: grid;padding: calc((${designUnit} / 4) * 1px) 0;box-sizing: border-box;width: 100%;background: transparent}:host(.header){}:host(.sticky-header){background: ${quickInputBackground};position: sticky;top: 0}:host(:hover){background: ${listHoverBackground}}`;
