...
OTHER TORTIOUS ACTION, ARISING OUT OF OR IN CONNECTION WITH THE USE OR
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */const wo=Oe` ${wi("inline-flex")} :host{outline: none;font-family: ${As};font-size: ${Ps};line-height: ${Fs};color: ${Ks};background: ${Us};border-radius: calc(${Ts} * 1px);fill: currentColor;cursor: pointer}.control{background: transparent;height: inherit;flex-grow: 1;box-sizing: border-box;display: inline-flex;justify-content: center;align-items: center;padding: ${Js} ${Xs};white-space: wrap;outline: none;text-decoration: none;border: calc(${ks} * 1px) solid ${Ms};color: inherit;border-radius: inherit;fill: inherit;cursor: inherit;font-family: inherit;max-width: 300px}:host(:hover){background: ${Gs}}:host(:active){background: ${Us}}.control: ${$i}{outline: calc(${ks} * 1px) solid ${Rs};outline-offset: calc(${ks} * 2px)}.control::-moz-focus-inner{border: 0}:host([disabled]){opacity: ${Os};background: ${Us};cursor: ${"not-allowed"}}.content{display: flex}.start{display: flex}::slotted(svg),	::slotted(span){width: calc(${Is} * 4px);height: calc(${Is} * 4px)}.start{margin-inline-end: 8px}`,$o=Oe`	:host([appearance='primary']){background: ${Us};color: ${Ks}}:host([appearance='primary']:hover){background: ${Gs}}:host([appearance='primary']:active) .control:active{background: ${Us}}:host([appearance='primary']) .control:${$i}{outline: calc(${ks} * 1px) solid ${Rs};outline-offset: calc(${ks} * 2px)}:host([appearance='primary'][disabled]){background: ${Us}}`,ko=Oe`	:host([appearance='secondary']){background: ${Ws};color: ${Qs}}:host([appearance='secondary']:hover){background: ${Ys}}:host([appearance='secondary']:active) .control:active{background: ${Ws}}:host([appearance='secondary']) .control:${$i}{outline: calc(${ks} * 1px) solid ${Rs};outline-offset: calc(${ks} * 2px)}:host([appearance='secondary'][disabled]){background: ${Ws}}`,To=Oe`	:host([appearance='icon']){background: ${Ns};border-radius: ${zs};color: ${Ds}}:host([appearance='icon']:hover){background: ${js}}:host([appearance='icon']) .control{padding: ${qs}}:host([appearance='icon']:active) .control:active{background: ${js}}:host([appearance='icon']) .control:${$i}{outline: calc(${ks} * 1px) solid ${Rs};outline-offset: ${_s}}:host([appearance='icon'][disabled]){background: ${Ns}}`;class Io extends ti{connectedCallback(){if(super.connectedCallback(),!this.appearance){const e=this.getAttribute("appearance");this.appearance=e}}attributeChangedCallback(e,t,i){if("appearance"===e&&"icon"===i){this.getAttribute("aria-label")||(this.ariaLabel="Icon Button")}"aria-label"===e&&(this.ariaLabel=i),"disabled"===e&&(this.disabled=!0)}}!function(e,t,i,s){var o,n=arguments.length,r=n<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(r=(n<3?o(r):n>3?o(t,i,r):o(t,i))||r);n>3&&r&&Object.defineProperty(t,i,r)}([be],Io.prototype,"appearance",void 0);const Oo=Io.compose({baseName:"button",template:(e,t)=>ne`<button class="control" part="control" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" form="${e=>e.formId}" formaction="${e=>e.formaction}" formenctype="${e=>e.formenctype}" formmethod="${e=>e.formmethod}" formnovalidate="${e=>e.formnovalidate}" formtarget="${e=>e.formtarget}" name="${e=>e.name}" type="${e=>e.type}" value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-pressed="${e=>e.ariaPressed}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Le("control")}>${Xe(0,t)}<span class="content" part="content"><slot ${Ke("defaultSlottedContent")}></slot></span>${Ye(0,t)}</button>`,styles:(e,t)=>Oe` ${wo} ${$o} ${ko} ${To}`,shadowOptions:{delegatesFocus:!0}});class Ro extends pi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Ao=Ro.compose({baseName:"checkbox",template:(e,t)=>ne`<template role="checkbox" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" tabindex="${e=>e.disabled?null:0}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}" class="${e=>e.readOnly?"readonly":""} ${e=>e.checked?"checked":""} ${e=>e.indeterminate?"indeterminate":""}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot><slot name="indeterminate-indicator">${t.indeterminateIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{align-items: center;outline: none;margin: calc(${Is} * 1px) 0;user-select: none;font-size: ${Ps};line-height: ${Fs}}.control{position: relative;width: calc(${Is} * 4px);height: calc(${Is} * 4px);box-sizing: border-box;border-radius: calc(${to} * 1px);border: calc(${ks} * 1px) solid ${eo};background: ${Zs};outline: none;cursor: pointer}.label{font-family: ${As};color: ${Ds};padding-inline-start: calc(${Is} * 2px + 2px);margin-inline-end: calc(${Is} * 2px + 2px);cursor: pointer}.label__hidden{display: none;visibility: hidden}.checked-indicator{width: 100%;height: 100%;display: block;fill: ${Ds};opacity: 0;pointer-events: none}.indeterminate-indicator{border-radius: 2px;background: ${Ds};position: absolute;top: 50%;left: 50%;width: 50%;height: 50%;transform: translate(-50%, -50%);opacity: 0}:host(:enabled) .control:hover{background: ${Zs};border-color: ${eo}}:host(:enabled) .control:active{background: ${Zs};border-color: ${Rs}}:host(:${$i}) .control{border: calc(${ks} * 1px) solid ${Rs};border-radius: ${Ts}}:host(.disabled) .label,	:host(.readonly) .label,	:host(.readonly) .control,	:host(.disabled) .control{cursor: ${"not-allowed"}}:host(.checked:not(.indeterminate)) .checked-indicator,	:host(.indeterminate) .indeterminate-indicator{opacity: 1}:host(.disabled){opacity: ${Os}}`,checkedIndicator:'\n\t\t<svg \n\t\t\tpart="checked-indicator"\n\t\t\tclass="checked-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M14.431 3.323l-8.47 10-.79-.036-3.35-4.77.818-.574 2.978 4.24 8.051-9.506.764.646z"\n\t\t\t/>\n\t\t</svg>\n\t',indeterminateIndicator:'\n\t\t<div part="indeterminate-indicator" class="indeterminate-indicator"></div>\n\t'});class Do extends ai{connectedCallback(){super.connectedCallback();this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const So=Do.compose({baseName:"data-grid",baseClass:ai,template:(e,t)=>{const i=function(e){const t=e.tagFor(ri);return ne`<${t} :rowData="${e=>e}" :cellItemTemplate="${(e,t)=>t.parent.cellItemTemplate}" :headerCellItemTemplate="${(e,t)=>t.parent.headerCellItemTemplate}"></${t}>`}(e),s=e.tagFor(ri);return ne`<template role="grid" tabindex="0" :rowElementTag="${()=>s}" :defaultRowItemTemplate="${i}" ${We({property:"rowElements",filter:je("[role=row]")})}><slot></slot></template>`},styles:(e,t)=>Oe`	:host{display: flex;position: relative;flex-direction: column;width: 100%}`});class Eo extends ri{}const Po=Eo.compose({baseName:"data-grid-row",baseClass:ri,template:(e,t)=>{const i=function(e){const t=e.tagFor(ci);return ne`<${t} cell-type="${e=>e.isRowHeader?"rowheader":void 0}" grid-column="${(e,t)=>t.index+1}" :rowData="${(e,t)=>t.parent.rowData}" :columnDefinition="${e=>e}"></${t}>`}(e),s=function(e){const t=e.tagFor(ci);return ne`<${t} cell-type="columnheader" grid-column="${(e,t)=>t.index+1}" :columnDefinition="${e=>e}"></${t}>`}(e);return ne`<template role="row" class="${e=>"default"!==e.rowType?e.rowType:""}" :defaultCellItemTemplate="${i}" :defaultHeaderCellItemTemplate="${s}" ${We({property:"cellElements",filter:je('[role="cell"],[role="gridcell"],[role="columnheader"],[role="rowheader"]')})}><slot ${Ke("slottedCellElements")}></slot></template>`},styles:(e,t)=>Oe`	:host{display: grid;padding: calc((${Is} / 4) * 1px) 0;box-sizing: border-box;width: 100%;background: transparent}:host(.header){}:host(.sticky-header){background: ${no};position: sticky;top: 0}:host(:hover){background: ${oo}}`});class Fo extends ci{}const Bo=Fo.compose({baseName:"data-grid-cell",baseClass:ci,template:(e,t)=>ne`<template tabindex="-1" role="${e=>{var t;return null!==(t=e.cellType)&&void 0!==t?t:"gridcell"}}" class=" ${e=>"columnheader"===e.cellType?"column-header":"rowheader"===e.cellType?"row-header":""} "><slot></slot></template>`,styles:(e,t)=>Oe`	:host{padding: calc(${Is} * 1px) calc(${Is} * 3px);color: ${Ds};opacity: 1;box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};font-weight: 400;border: solid calc(${ks} * 1px) transparent;border-radius: calc(${Ts} * 1px);min-width: 96px;white-space: wrap;overflow-wrap: break-word}:host(.column-header){font-weight: 600}:host(:${$i}),	:host(:focus),	:host(:active){background: ${io};border: solid calc(${ks} * 1px) ${Rs};color: ${so};outline: none}`});class Vo extends Xi{}const Lo=Vo.compose({baseName:"divider",template:(e,t)=>ne`<template role="${e=>e.role}"></template>`,styles:(e,t)=>Oe` ${wi("block")} :host{border: none;border-top: calc(${ks} * 1px) solid ${ro};box-sizing: content-box;height: 0;margin: calc(${Is} * 1px) 0;width: 100%}`});class Ho extends cs{}const Mo=Ho.compose({baseName:"dropdown",template:(e,t)=>ne`<template class="${e=>e.open?"open":""} ${e=>e.disabled?"disabled":""} ${e=>e.position}" role="${e=>e.role}" tabindex="${e=>e.disabled?null:"0"}" aria-disabled="${e=>e.ariaDisabled}" aria-expanded="${e=>e.ariaExpanded}" @click="${(e,t)=>e.clickHandler(t.event)}" @focusout="${(e,t)=>e.focusoutHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}"><div aria-activedescendant="${e=>e.open?e.ariaActiveDescendant:null}" aria-controls="listbox" aria-expanded="${e=>e.ariaExpanded}" aria-haspopup="listbox" class="control" part="control" role="button" ?disabled="${e=>e.disabled}">${Xe(0,t)}<slot name="button-container"><div class="selected-value" part="selected-value"><slot name="selected-value">${e=>e.displayValue}</slot></div><div class="indicator" part="indicator"><slot name="indicator">${t.indicator||""}</slot></div></slot>${Ye(0,t)}</div><div aria-disabled="${e=>e.disabled}" class="listbox" id="listbox" part="listbox" role="listbox" ?disabled="${e=>e.disabled}" ?hidden="${e=>!e.open}" ${Le("listbox")}><slot ${Ke({filter:yi.slottedOptionFilter,flatten:!0,property:"slottedOptions"})}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{background: ${ao};box-sizing: border-box;color: ${Ds};contain: contents;font-family: ${As};height: calc(${Ss} * 1px);position: relative;user-select: none;min-width: ${Es};outline: none;vertical-align: top}.control{align-items: center;box-sizing: border-box;border: calc(${ks} * 1px) solid ${lo};border-radius: calc(${Ts} * 1px);cursor: pointer;display: flex;font-family: inherit;font-size: ${Ps};line-height: ${Fs};min-height: 100%;padding: 0 calc(${Is} * 2px);width: 100%}.listbox{background: ${ao};border: calc(${ks} * 1px) solid ${Rs};border-radius: calc(${Ts} * 1px);box-sizing: border-box;display: inline-flex;flex-direction: column;left: 0;max-height: ${co};padding: 0 0 calc(${Is} * 1px) 0;overflow-y: auto;position: absolute;width: 100%;z-index: 1}.listbox[hidden]{display: none}:host(:${$i}) .control{border-color: ${Rs}}:host(:not([disabled]):hover){background: ${ao};border-color: ${lo}}:host(:${$i}) ::slotted([aria-selected="true"][role="option"]:not([disabled])){background: ${io};border: calc(${ks} * 1px) solid ${Rs};color: ${so}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${Os}}:host([disabled]) .control{cursor: ${"not-allowed"};user-select: none}:host([disabled]:hover){background: ${ao};color: ${Ds};fill: currentcolor}:host(:not([disabled])) .control:active{border-color: ${Rs}}:host(:empty) .listbox{display: none}:host([open]) .control{border-color: ${Rs}}:host([open][position='above']) .listbox,	:host([open][position='below']) .control{border-bottom-left-radius: 0;border-bottom-right-radius: 0}:host([open][position='above']) .control,	:host([open][position='below']) .listbox{border-top-left-radius: 0;border-top-right-radius: 0}:host([open][position='above']) .listbox{bottom: calc(${Ss} * 1px)}:host([open][position='below']) .listbox{top: calc(${Ss} * 1px)}.selected-value{flex: 1 1 auto;font-family: inherit;overflow: hidden;text-align: start;text-overflow: ellipsis;white-space: nowrap}.indicator{flex: 0 0 auto;margin-inline-start: 1em}slot[name='listbox']{display: none;width: 100%}:host([open]) slot[name='listbox']{display: flex;position: absolute}.end{margin-inline-start: auto}.start,	.end,	.indicator,	.select-indicator,	::slotted(svg),	::slotted(span){fill: currentcolor;height: 1em;min-height: calc(${Is} * 4px);min-width: calc(${Is} * 4px);width: 1em}::slotted([role='option']),	::slotted(option){flex: 0 0 auto}`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class No extends Kt{}const zo=No.compose({baseName:"link",template:(e,t)=>ne`<a class="control" part="control" download="${e=>e.download}" href="${e=>e.href}" hreflang="${e=>e.hreflang}" ping="${e=>e.ping}" referrerpolicy="${e=>e.referrerpolicy}" rel="${e=>e.rel}" target="${e=>e.target}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-expanded="${e=>e.ariaExpanded}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Le("control")}>${Xe(0,t)}<span class="content" part="content"><slot ${Ke("defaultSlottedContent")}></slot></span>${Ye(0,t)}</a>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{background: transparent;box-sizing: border-box;color: ${fo};cursor: pointer;fill: currentcolor;font-family: ${As};font-size: ${Ps};line-height: ${Fs};outline: none}.control{align-items: center;background: transparent;border: calc(${ks} * 1px) solid transparent;border-radius: calc(${Ts} * 1px);box-sizing: border-box;color: inherit;cursor: inherit;display: inline-flex;fill: inherit;font-family: inherit;flex-grow: 1;height: inherit;justify-content: center;padding: 0;outline: none;text-decoration: none;white-space: nowrap}.control::-moz-focus-inner{border: 0}:host(:hover){color: ${po}}:host(:hover) .content{text-decoration: underline}:host(:active){background: transparent;color: ${po}}:host(:${$i}) .control{border: calc(${ks} * 1px) solid ${Rs}}`,shadowOptions:{delegatesFocus:!0}});class _o extends vi{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const jo=_o.compose({baseName:"option",template:(e,t)=>ne`<template aria-selected="${e=>e.selected}" class="${e=>e.selected?"selected":""} ${e=>e.disabled?"disabled":""}" role="option">${Xe(0,t)}<span class="content" part="content"><slot></slot></span>${Ye(0,t)}</template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{font-family: var(--body-font);border-radius: ${Ts};border: calc(${ks} * 1px) solid transparent;box-sizing: border-box;color: ${Ds};cursor: pointer;fill: currentcolor;font-size: ${Ps};line-height: ${Fs};margin: 0;outline: none;overflow: hidden;padding: 0 calc((${Is} / 2) * 1px) calc((${Is} / 4) * 1px);user-select: none;white-space: nowrap}:host(:${$i}){border-color: ${Rs};background: ${io};color: ${Ds}}:host([aria-selected='true']){background: ${io};border: calc(${ks} * 1px) solid ${Rs};color: ${so}}:host(:active){background: ${io};color: ${so}}:host(:not([aria-selected='true']):hover){background: ${io};border: calc(${ks} * 1px) solid ${Rs};color: ${so}}:host(:not([aria-selected='true']):active){background: ${io};color: ${Ds}}:host([disabled]){cursor: ${"not-allowed"};opacity: ${Os}}:host([disabled]:hover){background-color: inherit}.content{grid-column-start: 2;justify-self: start;overflow: hidden;text-overflow: ellipsis}`});class qo extends gs{connectedCallback(){super.connectedCallback(),this.orientation&&(this.orientation=fs.horizontal);this.getAttribute("aria-label")||this.setAttribute("aria-label","Panels")}}const Uo=qo.compose({baseName:"panels",template:(e,t)=>ne`<template class="${e=>e.orientation}">${Xe(0,t)}<div class="tablist" part="tablist" role="tablist"><slot class="tab" name="tab" part="tab" ${Ke("tabs")}></slot>${He((e=>e.showActiveIndicator),ne`<div ${Le("activeIndicatorRef")} class="activeIndicator" part="activeIndicator"></div>`)}</div>${Ye(0,t)}<div class="tabpanel"><slot name="tabpanel" part="tabpanel" ${Ke("tabpanels")}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("grid")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};color: ${Ds};grid-template-columns: auto 1fr auto;grid-template-rows: auto 1fr;overflow-x: auto}.tablist{display: grid;grid-template-rows: auto auto;grid-template-columns: auto;column-gap: calc(${Is} * 8px);position: relative;width: max-content;align-self: end;padding: calc(${Is} * 1px) calc(${Is} * 1px) 0;box-sizing: border-box}.start,	.end{align-self: center}.activeIndicator{grid-row: 2;grid-column: 1;width: 100%;height: calc((${Is} / 4) * 1px);justify-self: center;background: ${mo};margin: 0;border-radius: calc(${Ts} * 1px)}.activeIndicatorTransition{transition: transform 0.01s linear}.tabpanel{grid-row: 2;grid-column-start: 1;grid-column-end: 4;position: relative}`});class Ko extends ps{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const Go=Ko.compose({baseName:"panel-tab",template:(e,t)=>ne`<template slot="tab" role="tab" aria-disabled="${e=>e.disabled}"><slot></slot></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Ps};line-height: ${Fs};height: calc(${Is} * 7px);padding: calc(${Is} * 1px) 0;color: ${vo};fill: currentcolor;border-radius: calc(${Ts} * 1px);border: solid calc(${ks} * 1px) transparent;align-items: center;justify-content: center;grid-row: 1;cursor: pointer}:host(:hover){color: ${mo};fill: currentcolor}:host(:active){color: ${mo};fill: currentcolor}:host([aria-selected='true']){background: transparent;color: ${mo};fill: currentcolor}:host([aria-selected='true']:hover){background: transparent;color: ${mo};fill: currentcolor}:host([aria-selected='true']:active){background: transparent;color: ${mo};fill: currentcolor}:host(:${$i}){outline: none;border: solid calc(${ks} * 1px) ${go}}:host(:focus){outline: none}::slotted(vscode-badge){margin-inline-start: calc(${Is} * 2px)}`});class Wo extends us{}const Qo=Wo.compose({baseName:"panel-view",template:(e,t)=>ne`<template slot="tabpanel" role="tabpanel"><slot></slot></template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{color: inherit;background-color: transparent;border: solid calc(${ks} * 1px) transparent;box-sizing: border-box;font-size: ${Ps};line-height: ${Fs};padding: 10px calc((${Is} + 2) * 1px)}`});class Yo extends ss{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const Xo=Yo.compose({baseName:"progress-ring",template:(e,t)=>ne`<template role="progressbar" aria-valuenow="${e=>e.value}" aria-valuemin="${e=>e.min}" aria-valuemax="${e=>e.max}" class="${e=>e.paused?"paused":""}">${He((e=>"number"==typeof e.value),ne`<svg class="progress" part="progress" viewBox="0 0 16 16" slot="determinate"><circle class="background" part="background" cx="8px" cy="8px" r="7px"></circle><circle class="determinate" part="determinate" style="stroke-dasharray: ${e=>44*e.percentComplete/100}px ${44}px" cx="8px" cy="8px" r="7px"></circle></svg>`)} ${He((e=>"number"!=typeof e.value),ne`<slot name="indeterminate" slot="indeterminate">${t.indeterminateIndicator||""}</slot>`)}</template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{align-items: center;outline: none;height: calc(${Is} * 7px);width: calc(${Is} * 7px);margin: 0}.progress{height: 100%;width: 100%}.background{fill: none;stroke: transparent;stroke-width: calc(${Is} / 2 * 1px)}.indeterminate-indicator-1{fill: none;stroke: ${bo};stroke-width: calc(${Is} / 2 * 1px);stroke-linecap: square;transform-origin: 50% 50%;transform: rotate(-90deg);transition: all 0.2s ease-in-out;animation: spin-infinite 2s linear infinite}@keyframes spin-infinite{0%{stroke-dasharray: 0.01px 43.97px;transform: rotate(0deg)}50%{stroke-dasharray: 21.99px 21.99px;transform: rotate(450deg)}100%{stroke-dasharray: 0.01px 43.97px;transform: rotate(1080deg)}}`,indeterminateIndicator:'\n\t\t<svg class="progress" part="progress" viewBox="0 0 16 16">\n\t\t\t<circle\n\t\t\t\tclass="background"\n\t\t\t\tpart="background"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t\t<circle\n\t\t\t\tclass="indeterminate-indicator-1"\n\t\t\t\tpart="indeterminate-indicator-1"\n\t\t\t\tcx="8px"\n\t\t\t\tcy="8px"\n\t\t\t\tr="7px"\n\t\t\t></circle>\n\t\t</svg>\n\t'});class Jo extends os{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const t="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",t),this.setAttribute("aria-labelledby",t)}}}const Zo=Jo.compose({baseName:"radio-group",template:(e,t)=>ne`<template role="radiogroup" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @click="${(e,t)=>e.clickHandler(t.event)}" @keydown="${(e,t)=>e.keydownHandler(t.event)}" @focusout="${(e,t)=>e.focusOutHandler(t.event)}"><slot name="label"></slot><div class="positioning-region ${e=>e.orientation===Mt.horizontal?"horizontal":"vertical"}" part="positioning-region"><slot ${Ke({property:"slottedRadioButtons",filter:je("[role=radio]")})}></slot></div></template>`,styles:(e,t)=>Oe` ${wi("flex")} :host{align-items: flex-start;margin: calc(${Is} * 1px) 0;flex-direction: column}.positioning-region{display: flex;flex-wrap: wrap}:host([orientation='vertical']) .positioning-region{flex-direction: column}:host([orientation='horizontal']) .positioning-region{flex-direction: row}::slotted([slot='label']){color: ${Ds};font-size: ${Ps};margin: calc(${Is} * 1px) 0}`});class en extends as{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Radio")}}const tn=en.compose({baseName:"radio",template:(e,t)=>ne`<template role="radio" class="${e=>e.checked?"checked":""} ${e=>e.readOnly?"readonly":""}" aria-checked="${e=>e.checked}" aria-required="${e=>e.required}" aria-disabled="${e=>e.disabled}" aria-readonly="${e=>e.readOnly}" @keypress="${(e,t)=>e.keypressHandler(t.event)}" @click="${(e,t)=>e.clickHandler(t.event)}"><div part="control" class="control"><slot name="checked-indicator">${t.checkedIndicator||""}</slot></div><label part="label" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label></template>`,styles:(e,t)=>Oe` ${wi("inline-flex")} :host{align-items: center;flex-direction: row;font-size: ${Ps};line-height: ${Fs};margin: calc(${Is} * 1px) 0;outline: none;position: relative;transition: all 0.2s ease-in-out;user-select: none}.control{background: ${Zs};border-radius: 999px;border: calc(${ks} * 1px) solid ${eo};box-sizing: border-box;cursor: pointer;height: calc(${Is} * 4px);position: relative;outline: none;width: calc(${Is} * 4px)}.label{color: ${Ds};cursor: pointer;font-family: ${As};margin-inline-end: calc(${Is} * 2px + 2px);padding-inline-start: calc(${Is} * 2px + 2px)}.label__hidden{display: none;visibility: hidden}.control,	.checked-indicator{flex-shrink: 0}.checked-indicator{background: ${Ds};border-radius: 999px;display: inline-block;inset: calc(${Is} * 1px);opacity: 0;pointer-events: none;position: absolute}:host(:not([disabled])) .control:hover{background: ${Zs};border-color: ${eo}}:host(:not([disabled])) .control:active{background: ${Zs};border-color: ${Rs}}:host(:${$i}) .control{border: calc(${ks} * 1px) solid ${Rs}}:host([aria-checked='true']) .control{background: ${Zs};border: calc(${ks} * 1px) solid ${eo}}:host([aria-checked='true']:not([disabled])) .control:hover{background: ${Zs};border: calc(${ks} * 1px) solid ${eo}}:host([aria-checked='true']:not([disabled])) .control:active{background: ${Zs};border: calc(${ks} * 1px) solid ${Rs}}:host([aria-checked="true"]:${$i}:not([disabled])) .control{border: calc(${ks} * 1px) solid ${Rs}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([aria-checked='true']) .checked-indicator{opacity: 1}:host([disabled]){opacity: ${Os}}`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class sn extends Qt{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const on=sn.compose({baseName:"tag",template:Wt,styles:(e,t)=>Oe` ${wi("inline-block")} :host{box-sizing: border-box;font-family: ${As};font-size: ${Bs};line-height: ${Vs}}.control{background-color: ${Ls};border: calc(${ks} * 1px) solid ${Ms};border-radius: ${yo};color: ${Hs};padding: calc(${Is} * 0.5px) calc(${Is} * 1px);text-transform: uppercase}`});class nn extends ys{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const rn=nn.compose({baseName:"text-area",template:(e,t)=>ne`<template class=" ${e=>e.readOnly?"readonly":""} ${e=>e.resize!==bs.none?`resize-${e.resize}`:""}"><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke("defaultSlottedNodes")}></slot></label><textarea part="control" class="control" id="control" ?autofocus="${e=>e.autofocus}" cols="${e=>e.cols}" ?disabled="${e=>e.disabled}" form="${e=>e.form}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" name="${e=>e.name}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" rows="${e=>e.rows}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" @input="${(e,t)=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ${Le("control")}></textarea></template>`,styles:(e,t)=>Oe` ${wi("inline-block")} :host{font-family: ${As};outline: none;user-select: none}.control{box-sizing: border-box;position: relative;color: ${uo};background: ${ho};border-radius: calc(${Ts} * 1px);border: calc(${ks} * 1px) solid ${lo};font: inherit;font-size: ${Ps};line-height: ${Fs};padding: calc(${Is} * 2px + 1px);width: 100%;min-width: ${Es};resize: none}.control:hover:enabled{background: ${ho};border-color: ${lo}}.control:active:enabled{background: ${ho};border-color: ${Rs}}.control:hover,	.control:${$i},	.control:disabled,	.control:active{outline: none}:host(:focus-within:not([disabled])) .control{border-color: ${Rs}}:host([resize='both']) .control{resize: both}:host([resize='horizontal']) .control{resize: horizontal}:host([resize='vertical']) .control{resize: vertical}.label{display: block;color: ${Ds};cursor: pointer;font-size: ${Ps};line-height: ${Fs};margin-bottom: calc(${Is} * 1px)}.label__hidden{display: none;visibility: hidden}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${Os}}:host([disabled]) .control{border-color: ${lo}}`,shadowOptions:{delegatesFocus:!0}});class an extends ts{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const ln=an.compose({baseName:"text-field",template:(e,t)=>ne`<template class=" ${e=>e.readOnly?"readonly":""} "><label part="label" for="control" class="${e=>e.defaultSlottedNodes&&e.defaultSlottedNodes.length?"label":"label label__hidden"}"><slot ${Ke({property:"defaultSlottedNodes",filter:ki})}></slot></label><div class="root" part="root">${Xe(0,t)}<input class="control" part="control" id="control" @input="${e=>e.handleTextInput()}" @change="${e=>e.handleChange()}" ?autofocus="${e=>e.autofocus}" ?disabled="${e=>e.disabled}" list="${e=>e.list}" maxlength="${e=>e.maxlength}" minlength="${e=>e.minlength}" pattern="${e=>e.pattern}" placeholder="${e=>e.placeholder}" ?readonly="${e=>e.readOnly}" ?required="${e=>e.required}" size="${e=>e.size}" ?spellcheck="${e=>e.spellcheck}" :value="${e=>e.value}" type="${e=>e.type}" aria-atomic="${e=>e.ariaAtomic}" aria-busy="${e=>e.ariaBusy}" aria-controls="${e=>e.ariaControls}" aria-current="${e=>e.ariaCurrent}" aria-describedby="${e=>e.ariaDescribedby}" aria-details="${e=>e.ariaDetails}" aria-disabled="${e=>e.ariaDisabled}" aria-errormessage="${e=>e.ariaErrormessage}" aria-flowto="${e=>e.ariaFlowto}" aria-haspopup="${e=>e.ariaHaspopup}" aria-hidden="${e=>e.ariaHidden}" aria-invalid="${e=>e.ariaInvalid}" aria-keyshortcuts="${e=>e.ariaKeyshortcuts}" aria-label="${e=>e.ariaLabel}" aria-labelledby="${e=>e.ariaLabelledby}" aria-live="${e=>e.ariaLive}" aria-owns="${e=>e.ariaOwns}" aria-relevant="${e=>e.ariaRelevant}" aria-roledescription="${e=>e.ariaRoledescription}" ${Le("control")} />${Ye(0,t)}</div></template>`,styles:(e,t)=>Oe` ${wi("inline-block")} :host{font-family: ${As};outline: none;user-select: none}.root{box-sizing: border-box;position: relative;display: flex;flex-direction: row;color: ${uo};background: ${ho};border-radius: calc(${Ts} * 1px);border: calc(${ks} * 1px) solid ${lo};height: calc(${Ss} * 1px);min-width: ${Es}}.control{-webkit-appearance: none;font: inherit;background: transparent;border: 0;color: inherit;height: calc(100% - (${Is} * 1px));width: 100%;margin-top: auto;margin-bottom: auto;border: none;padding: 0 calc(${Is} * 2px + 1px);font-size: ${Ps};line-height: ${Fs}}.control:hover,	.control:${$i},	.control:disabled,	.control:active{outline: none}.label{display: block;color: ${Ds};cursor: pointer;font-size: ${Ps};line-height: ${Fs};margin-bottom: calc(${Is} * 1px)}.label__hidden{display: none;visibility: hidden}.start,	.end{display: flex;margin: auto;fill: currentcolor}::slotted(svg),	::slotted(span){width: calc(${Is} * 4px);height: calc(${Is} * 4px)}.start{margin-inline-start: 11px}.end{margin-inline-end: 11px}:host(:hover:not([disabled])) .root{background: ${ho};border-color: ${lo}}:host(:active:not([disabled])) .root{background: ${ho};border-color: ${Rs}}:host(:focus-within:not([disabled])) .root{border-color: ${Rs}}:host([disabled]) .label,	:host([readonly]) .label,	:host([readonly]) .control,	:host([disabled]) .control{cursor: ${"not-allowed"}}:host([disabled]){opacity: ${Os}}:host([disabled]) .control{border-color: ${lo}}`,shadowOptions:{delegatesFocus:!0}}),dn={vsCodeBadge:Co,vsCodeButton:Oo,vsCodeCheckbox:Ao,vsCodeDataGrid:So,vsCodeDataGridCell:Bo,vsCodeDataGridRow:Po,vsCodeDivider:Lo,vsCodeDropdown:Mo,vsCodeLink:zo,vsCodeOption:jo,vsCodePanels:Uo,vsCodePanelTab:Go,vsCodePanelView:Qo,vsCodeProgressRing:Xo,vsCodeRadioGroup:Zo,vsCodeRadio:tn,vsCodeTag:on,vsCodeTextArea:rn,vsCodeTextField:ln,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}};function cn(e){return Gi.getOrCreate(e).withPrefix("vscode")}const hn=cn().register(dn);export{xo as Badge,Io as Button,Ro as Checkbox,Do as DataGrid,Fo as DataGridCell,oi as DataGridCellTypes,Eo as DataGridRow,ni as DataGridRowTypes,Vo as Divider,Yi as DividerRole,Ho as Dropdown,fi as DropdownPosition,si as GenerateHeaderOptions,No as Link,_o as Option,Ko as PanelTab,Wo as PanelView,qo as Panels,Yo as ProgressRing,en as Radio,Jo as RadioGroup,Mt as RadioGroupOrientation,sn as Tag,nn as TextArea,bs as TextAreaResize,an as TextField,es as TextFieldType,hn as VSCodeDesignSystem,dn as allComponents,cn as provideVSCodeDesignSystem,Co as vsCodeBadge,Oo as vsCodeButton,Ao as vsCodeCheckbox,So as vsCodeDataGrid,Bo as vsCodeDataGridCell,Po as vsCodeDataGridRow,Lo as vsCodeDivider,Mo as vsCodeDropdown,zo as vsCodeLink,jo as vsCodeOption,Go as vsCodePanelTab,Qo as vsCodePanelView,Uo as vsCodePanels,Xo as vsCodeProgressRing,tn as vsCodeRadio,Zo as vsCodeRadioGroup,on as vsCodeTag,rn as vsCodeTextArea,ln as vsCodeTextField};
