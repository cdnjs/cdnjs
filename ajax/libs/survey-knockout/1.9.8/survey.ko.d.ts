/*
* Type definition for Survey JavaScript library for Knockout v1.9.8
...
export declare class SurveyWindow extends SurveyWindowModel {
  ...
  protected set template(val: string);
...
export declare class Survey extends SurveyModel {
  ...
  protected onBeforeCreating(): void;
  protected currentPageChanged(newValue: any, oldValue: any): void;
  pageVisibilityChanged(page: any, newValue: boolean): void;
  protected onLoadSurveyFromService(): void;
  protected onLoadingSurveyFromService(): void;
  protected setCompletedState(value: string, text: string): void;
  protected doTimer(): void;
