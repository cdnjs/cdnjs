/*Type definitions for Survey JavaScript library v1.8.62
...
export { compareVersions, confirmAction, detectIEOrEdge, detectIEBrowser, loadFileFromBase64, isMobile, isElementVisible, findScrollableParent, scrollElementByChildId, createSvg, doKey2ClickUp, doKey2ClickDown, getIconNameFromProxy };
...
export declare class PopupModel<T = any> extends Base {
    ...
    onShow: () => void;
    cssClass: string;
    constructor(contentComponentName: string, contentComponentData: T, verticalPosition?: VerticalPosition, horizontalPosition?: HorizontalPosition, showPointer?: boolean, isModal?: boolean, onCancel?: () => void, onApply?: () => boolean, onHide?: () => void, onShow?: () => void, cssClass?: string);
    get isVisible(): boolean;
...
export declare class DragDropSurveyElements extends DragDropCore {
...
export declare class DragDropChoices extends DragDropCore {
    protected get draggedElementType(): string;
    protected getShortcutText(draggedElement: any): any;
    protected getDropTargetByDataAttributeValue(dataAttributeValue: string): any;
...
export declare class DragDropMatrixRows extends DragDropCore {
    protected get draggedElementType(): string;
    protected getShortcutText(draggedElement: any): any;
    protected getDropTargetByDataAttributeValue(dataAttributeValue: any): MatrixRowModel;
    protected isDropTargetValid(dropTarget: any): boolean;
    protected calculateIsBottom(clientY: number): boolean;
    protected doDrop: () => QuestionMatrixModel;
}
...
export declare abstract class DragDropCore extends Base {
    isBottom: boolean;
    onBeforeDrop: EventBase<DragDropCore>;
    onAfterDrop: EventBase<DragDropCore>;
    ...
    startDrag(event: PointerEvent, draggedElement: any, parentElement?: any): void;
    getGhostPosition(item: any): "top" | "bottom";
    protected isDropTargetDoesntChanged(newIsBottom: boolean): boolean;
    protected doStartDrag(): void;
    protected abstract getShortcutText(draggedElement: any): string;
    protected doDragOver(): void;
    protected abstract isDropTargetValid(dropTarget: any, isBottom: boolean): boolean;
    protected banDropHere: () => void;
    protected doBanDropHere: () => void;
    protected getDropTargetByNode(dropTargetNode: HTMLElement, event: PointerEvent): any;
    protected abstract getDropTargetByDataAttributeValue(dataAttributeValue: any, dropTargetNode?: HTMLElement, event?: PointerEvent): any;
