/*Type definitions for Survey JavaScript library v1.8.55
...
export declare class ActionBarViewModel extends ActionBar {
    ...
    constructor(_items: Array<IActionBarItem>, handleClick?: boolean);
    dispose(): void;
}
...
export declare class AdaptiveElement extends Base {
        ...
        get visibleItems(): Array<AdaptiveActionBarItemWrapper>;
        constructor();
