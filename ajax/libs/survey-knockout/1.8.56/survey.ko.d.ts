/*Type definitions for Survey JavaScript library v1.8.56
...
export declare class ResponsivityManager {
    ...
    constructor(container: HTMLDivElement, model: AdaptiveElement | AdaptiveActionContainer, itemsSelector: string, dotsItemSize?: number);
...
export { compareVersions, confirmAction, detectIEOrEdge, detectIEBrowser, loadFileFromBase64, isMobile, isElementVisible, findScrollableParent, createSvg, doKey2Click, };
...
export declare class AdaptiveActionContainer extends ActionContainer<Action> {
    protected dotsItem: Action;
    dotsItemPopupModel: PopupModel;
    get visibleItems(): Array<Action>;
    setItems(items: Array<Action>): void;
    constructor();
    get hasItems(): boolean;
    invisibleItemSelected(item: Action): void;
