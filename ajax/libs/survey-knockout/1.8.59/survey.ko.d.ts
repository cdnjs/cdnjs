/*Type definitions for Survey JavaScript library v1.8.59
...
export { compareVersions, confirmAction, detectIEOrEdge, detectIEBrowser, loadFileFromBase64, isMobile, isElementVisible, findScrollableParent, scrollElementByChildId, createSvg, doKey2Click, getIconNameFromProxy, };
...
export declare function createKey2click(element: HTMLElement): (ev: KeyboardEvent) => void;
...
export declare function showModal(componentName: string, data: any, onApply: () => boolean, onCancel?: () => void, cssClass?: string): void;
...
export declare var settings: {
        ...
        /**
            ...
            */
        maxDate: string;
        showModal: (componentName: string, data: any, onApply: () => boolean, onCancel?: () => void, cssClass?: string) => void;
...
export declare function createPopupModalViewModel(componentName: string, data: any, onApply: () => boolean, onCancel?: () => void, onHide?: () => void, onShow?: () => void, cssClass?: string): PopupBaseViewModel;
