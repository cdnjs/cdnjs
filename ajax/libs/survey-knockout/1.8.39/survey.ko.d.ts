/*Type definitions for Survey JavaScript library v1.8.39
...
export declare var SurveyRowComponent: any;
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ISurveyErrorOwner, ILocalizableOwner {
        ...
        getSurveyRowComponentName(row: QuestionRow): string;
        getSurveyRowComponentData(row: QuestionRow): any;
        /**
