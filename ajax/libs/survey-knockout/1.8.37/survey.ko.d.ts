/*Type definitions for Survey JavaScript library v1.8.37
...
export declare class QuestionRow extends QuestionRowModel {
    ...
    getElementWrapperComponentName(el: SurveyElement): string;
    getElementWrapperComponentData(el: SurveyElement): any;
...
export declare var SurveyElementComponent: any;
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ISurveyErrorOwner, ILocalizableOwner {
        ...
        /**
            ...
            * @see PageModel
            */
        onGetPageTitleActions: Event<(sender: SurveyModel, options: any) => any, any>;
        /**
            ...
            */
        onGetMatrixRowActions: Event<(sender: SurveyModel, options: any) => any, any>;
        /**
...
export declare class PopupViewModel extends Base {
    model: PopupModel;
    targetElement?: HTMLElement;
    top: string | number;
    left: string | number;
