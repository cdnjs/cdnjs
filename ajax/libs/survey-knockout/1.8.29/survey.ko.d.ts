...
export declare class PopupViewModel {
    ...
    protected showSubscription: any;
    ...
    static showDropDownMenu(items: any[], target: HTMLElement): void;
}
...
export declare class ListViewModel {
    ...
    isExpanded: any;
    selectedItem: any;
    constructor(_items: any, // ko.MaybeObservableArray<ListItem>,
    onItemSelect: (item: ListItem) => void, allowSelection: any, // ko.MaybeObservable<boolean>,
    selectedItem?: any);
