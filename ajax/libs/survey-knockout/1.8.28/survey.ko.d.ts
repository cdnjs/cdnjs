/*Type definitions for Survey JavaScript library v1.8.28
...
export declare class AdaptiveActionBarItemWrapper implements IActionBarItem {
    ...
    readonly needSeparator: boolean;
...
export declare class PopupViewModel {
    ...
    readonly verticalPosition: "top" | "bottom" | "middle";
    ...
    dispose(): void;
    static showModal(componentName: string, data: any, onApply: () => void, onCancel?: () => void): void;
}
