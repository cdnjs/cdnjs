...
function setupTooltip(step) {
    ...
    const shouldCenter = utils_general.shouldCenterStep(attachToOptions);
    if (shouldCenter) {
...
function placeArrow(el, middlewareData) {
    ...
    if (utils_typeCheck.isHTMLElement(arrowEl) && middlewareData.arrow) {
...
exports.getFloatingUIOptions = getFloatingUIOptions;
exports.mergeTooltipConfig = mergeTooltipConfig;
exports.setupTooltip = setupTooltip;
//# sourceMappingURL=floating-ui-CNgtHW-1.js.map
