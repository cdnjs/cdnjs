...
var utils_floatingUi = require('./floating-ui-DpLkHwv0.js');
...
var utils_bind = require('./utils/bind.js');
...
function instance$7($$self, $$props, $$invalidate) {
  ...
  function getConfigOption(option) {
    if (utils_typeCheck.isFunction(option)) {
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  afterUpdate(() => {
    if (utils_typeCheck.isFunction(title)) {
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  afterUpdate(() => {
    ...
    if (utils_typeCheck.isFunction(text)) {
      text = text.call(step);
    }
    if (utils_typeCheck.isHTMLElement(text)) {
...
function create_fragment$1(ctx) {
  let div;
  let show_if_2 = !utils_typeCheck.isUndefined( /*step*/ctx[2].options.title) || /*step*/ctx[2].options.cancelIcon && /*step*/ctx[2].options.cancelIcon.enabled;
  let t0;
  let show_if_1 = !utils_typeCheck.isUndefined( /*step*/ctx[2].options.text);
  let t1;
  ...
  return {
    ...
    p(ctx, [dirty]) {
      if (dirty & /*step*/4) show_if_2 = !utils_typeCheck.isUndefined( /*step*/ctx[2].options.title) || /*step*/ctx[2].options.cancelIcon && /*step*/ctx[2].options.cancelIcon.enabled;
      if (show_if_2) {
        if (if_block0) {
          if_block0.p(ctx, dirty);
          if (dirty & /*step*/4) {
      ...
      if (dirty & /*step*/4) show_if_1 = !utils_typeCheck.isUndefined( /*step*/ctx[2].options.text);
      if (show_if_1) {
        if (if_block1) {
          if_block1.p(ctx, dirty);
          if (dirty & /*step*/4) {
...
function create_fragment(ctx) {
  ...
  let div_levels = [{
    "aria-describedby": div_aria_describedby_value = !utils_typeCheck.isUndefined( /*step*/ctx[4].options.text) ? /*descriptionId*/ctx[2] : null
  }, {
  ...
  return {
    ...
    p(ctx, [dirty]) {
      ...
      set_attributes(div, div_data = get_spread_update(div_levels, [(!current || dirty & /*step, descriptionId*/20 && div_aria_describedby_value !== (div_aria_describedby_value = !utils_typeCheck.isUndefined( /*step*/ctx[4].options.text) ? /*descriptionId*/ctx[2] : null)) && {
...
function instance($$self, $$props, $$invalidate) {
  ...
  function removeClasses(classes) {
    if (utils_typeCheck.isString(classes)) {
 ...
 * @extends {Evented}
 */
class Step extends evented.Evented {
    constructor(tour, options = {}) {
        super();
        this.tour = tour;
        this.classPrefix = this.tour.options
            ? utils_general.normalizePrefix(this.tour.options.classPrefix)
            : '';
     ...
     */
    destroy() {
        utils_floatingUi.destroyTooltip(this);
        if (utils_typeCheck.isHTMLElement(this.el)) {
            this.el.remove();
            this.el = null;
        }
    ...
    _resolveAttachToOptions() {
        this._resolvedAttachTo = utils_general.parseAttachTo(this);
     ...
     */
    show() {
        if (utils_typeCheck.isFunction(this.options.beforeShowPromise)) {
    ...
    _scrollTo(scrollToOptions) {
        ...
        if (utils_typeCheck.isFunction(this.options.scrollToHandler)) {
            this.options.scrollToHandler(element);
        }
        else if (utils_typeCheck.isElement(element) &&
    ...
    _setOptions(options = {}) {
        ...
        tourOptions = utils_floatingUi.deepmerge({}, tourOptions || {});
        this.options = Object.assign({
            arrow: true
        }, tourOptions, options, utils_floatingUi.mergeTooltipConfig(tourOptions, options));
        const { when } = this.options;
        this.options.classes = this._getClassOptions(options);
        this.destroy();
        this.id = this.options.id || `step-${utils_general.uuid()}`;
        if (when) {
     ...
     */
    _setupElements() {
        if (!utils_typeCheck.isUndefined(this.el)) {
            this.destroy();
        }
        this.el = this._createTooltipContent();
        if (this.options.advanceOn) {
            utils_bind.bindAdvance(this);
        }
        // The tooltip implementation details are handled outside of the Step
        // object.
        utils_floatingUi.setupTooltip(this);
    }
    /**
...
//# sourceMappingURL=step-CRAnUe50.js.map
