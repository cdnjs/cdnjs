...
function normalizePrefix(prefix) {
    if (!utils_typeCheck.isString(prefix) || prefix === '') {
        return '';
    }
...
function parseAttachTo(step) {
    ...
    if (utils_typeCheck.isFunction(returnOpts.element)) {
        // Bind the callback to step so that it has access to the object, to enable running additional logic
        returnOpts.element = returnOpts.element.call(step);
    }
    if (utils_typeCheck.isString(returnOpts.element)) {
...
exports.StepNoOp = StepNoOp;
exports.TourNoOp = TourNoOp;
exports.normalizePrefix = normalizePrefix;
exports.parseAttachTo = parseAttachTo;
exports.shouldCenterStep = shouldCenterStep;
exports.uuid = uuid;
