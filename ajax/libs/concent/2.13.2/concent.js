(function (global, factory) {
  ...
  */
  ...
  function beforeMount (ref, setup, bindCtxToMethod, cuSpec) {
    var ctx = ref.ctx;
    ...
    if (cuSpec) ctx.computed(cuSpec); // !!! 把拦截了setter getter的计算结果容器赋值给refComputed
  ...
  function register(_temp, ccClassKey) {
    var _ref = _temp === void 0 ? {} : _temp,
        ...
        _ref$cuSpec = _ref.cuSpec,
        cuSpec = _ref$cuSpec === void 0 ? null : _ref$cuSpec,
          ...
          function CcClass(props, context) {
            ...
            try {
              ...
              if (!isPropsProxy) {
                ...
                beforeMount(_assertThisInitialized(_this), setup || _this.$$setup || staticSetup, false, cuSpec);
  ...
  function initCcFrag (ref, props) {
    ...
    var module = registerOptions.module,
        ...
        _registerOptions$cuSp = registerOptions.cuSpec,
        cuSpec = _registerOptions$cuSp === void 0 ? null : _registerOptions$cuSp;
  ...
  function buildRef(ref, insType, hookCtx, rState, iState, regOpt, hookState, hookSetter, props, extra, ccClassKey) {
    ...
    beforeMount(hookRef, setup, bindCtxToMethod, cuSpec); // cursor_refKey_[cursor] = hookRef.ctx.ccUniqueKey;
