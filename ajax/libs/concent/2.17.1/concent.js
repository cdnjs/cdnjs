(function (global, factory) {
  ...
  */
  ...
  function changeRefState(state, _temp, targetRef) {
    ...
    triggerReactSetState(targetRef, callInfo, targetRenderKey, calledBy, state, stateFor, ignoreRender, reactCallback, getCallerForce(force), function (renderType, committedState, updater) {
  ...
  var bindToContainer$1 = bindToContainer,
      safeGet$3 = safeGet,
      isOnlineEditor$1 = isOnlineEditor; // for ssr
