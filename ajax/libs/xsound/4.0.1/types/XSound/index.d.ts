 ...
 */
export declare function computeHz(frequency: number, detune: number): number;
/**
 ...
 */
export declare function computePlaybackRate(playbackRate: number, detune: number): number;
 ...
 */
export declare function decode(context: AudioContext, arraybuffer: ArrayBuffer, successCallback?: (buffer: AudioBuffer) => void, errorCallback?: (error: Error) => void): Promise<AudioBuffer>;
/**
