export declare type FrozenArray<T> = Array<T>;
export declare type Inputs = FrozenArray<FrozenArray<Float32Array>>;
export declare type Outputs = FrozenArray<FrozenArray<Float32Array>>;
