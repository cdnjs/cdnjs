...
export declare abstract class SoundModule implements Connectable {
     ...
     * @return {SoundModule} Return value is for method chain.
     */
    setSinkId(sinkId: string, successCallback?: () => void, errorCallback?: (error: Error) => void): this;
    /**
