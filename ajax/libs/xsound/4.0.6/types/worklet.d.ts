 ...
 */
export declare abstract class OverlapAddProcessor extends AudioWorkletProcessor {
    private static readonly RENDER_QUANTUM_SIZE;
    protected numberOfInputs: number;
    protected numberOfOutputs: number;
    ...
    /** @override */
    protected process(inputs: Inputs, outputs: Outputs, parameters: Parameters): boolean;
 ...
 */
export declare function createModule(processor: new (options: AudioWorkletNodeOptions) => AudioWorkletProcessor): string;
/**
 ...
 */
export declare function addAudioWorklet(context: AudioContext, processor: new (options: AudioWorkletNodeOptions) => AudioWorkletProcessor, options?: WorkletOptions): Promise<void>;
