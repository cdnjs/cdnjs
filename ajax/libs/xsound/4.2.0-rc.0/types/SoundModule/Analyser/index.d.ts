...
export type { Visualizer, VisualizerParams, Color, GraphicsApi, Gradient, Gradients, Shape, Font, GraphicsStyles, SpectrumScale, TimeOverview, TimeOverviewParams, CurrentTimeStyles, MouseEventTypes, DragMode, DragCallbackFunction, Time, TimeParams, FFT, FFTParams, Spectrogram, SpectrogramParams };
...
export declare class Analyser implements Connectable {
    ...
    domain(domain: 'spectrogram', channel?: ChannelNumber): Spectrogram;
    /**
