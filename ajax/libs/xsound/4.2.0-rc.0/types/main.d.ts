...
import type { AnalyserParams, Domain, DataType, FFTSize, Visualizer, VisualizerParams, Color, GraphicsApi, Gradient, Gradients, Shape, Font, GraphicsStyles, SpectrumScale, TimeOverview, TimeOverviewParams, MouseEventTypes, DragMode, DragCallbackFunction, CurrentTimeStyles, Time, TimeParams, FFT, FFTParams, Spectrogram, SpectrogramParams } from './SoundModule/Analyser';
...
declare namespace XSound {
    ...
    var permission: typeof import("./XSound").permission;
