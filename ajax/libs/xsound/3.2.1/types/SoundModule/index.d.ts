...
export declare type Module = Analyser | Recorder | Session | Autopanner | BitCrusher | Chorus | Compressor | Delay | EnvelopeGenerator | Equalizer | Filter | Flanger | Fuzz | Listener | NoiseGate | NoiseSuppressor | OverDrive | Panner | Phaser | PitchShifter | Preamp | Reverb | Ringmodulator | Stereo | Tremolo | VocalCanceler | Wah;
export declare type ModuleName = 'analyser' | 'recorder' | 'session' | 'autopanner' | 'bitcrusher' | 'chorus' | 'compressor' | 'delay' | 'envelopegenerator' | 'equalizer' | 'filter' | 'flanger' | 'fuzz' | 'listener' | 'noisegate' | 'noisesuppressor' | 'overdrive' | 'panner' | 'phaser' | 'pitchshifter' | 'preamp' | 'reverb' | 'ringmodulator' | 'stereo' | 'tremolo' | 'vocalcanceler' | 'wah';
