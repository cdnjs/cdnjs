  ...
  _createClass(FileUploadWithPreview, [{
    ...
    value: function bindClickEvents() {
      ...
      this.clearButton.addEventListener('click', function () {
        ...
        var clearButtonClickedEvent = new CustomEvent(Events.CLEAR_BUTTON_CLICKED, eventPayload);
      ...
      this.imagePreview.addEventListener('click', function (e) {
        ...
        if (target.matches('.custom-file-container .image-preview-item')) {
          ...
          var imageClickedEvent = new CustomEvent(Events.IMAGE_MULTI_ITEM_CLICKED, eventPayload);
    ...
    value: function addFiles(files) {
      ...
      var imagesAddedEvent = new CustomEvent(Events.IMAGE_ADDED, eventPayload);
    ...
    value: function deleteFileAtIndex(index) {
      ...
      var imageDeletedEvent = new CustomEvent(Events.IMAGE_DELETED, eventPayload);
...
export { DEFAULT_BACKGROUND_IMAGE, DEFAULT_BASE_IMAGE, DEFAULT_SUCCESS_FILE_ALT_IMAGE, DEFAULT_SUCCESS_PDF_IMAGE, DEFAULT_SUCCESS_VIDEO_IMAGE, Events, FileUploadWithPreview };
