/*!
FullCalendar Standard Bundle v7.0.0-beta.3
...
var FullCalendar = (function (exports) {
  ...
  class StandardEvent extends BaseComponent {
      render() {
          ...
          return (_(EventContainer, Object.assign({}, props /* includes elRef */, { tag: anchorAttrs ? 'a' : 'div', style: {
              ...
              }, attrs: anchorAttrs, defaultGenerator: renderInnerContent$1$1, timeText: timeText }), (InnerContent, eventContentArg) => (_(k$1, null,
  ...
  */
  ...
  class DayGridListEvent extends BaseComponent {
      render() {
          ...
          return (_(EventContainer, Object.assign({}, props, { tag: anchorAttrs ? 'a' : 'div', attrs: anchorAttrs, className: 'fc-daygrid-dot-event fc-daygrid-event', defaultGenerator: renderInnerContent$2, timeText: timeText, isResizing: false, isDateSelecting: false })));
      }
  }
  ...
  class DayGridCell extends DateComponent {
      ...
      render() {
          ...
          return (_(DayCellContainer, { tag: "div", className: joinClassNames(props.className, 'fc-daygrid-day fc-flex-col', props.borderStart && 'fc-border-s', props.width != null ? '' : 'fc-liquid'), attrs: Object.assign(Object.assign({}, props.attrs), { role: 'gridcell' }), style: {
                  width: props.width
              }, elRef: this.rootElRef, renderProps: props.renderProps, defaultGenerator: renderTopInner, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, isMonthStart: isMonthStart }, (InnerContent, renderProps) => (_(k$1, null,
              !renderProps.isDisabled && (props.showDayNumber || hasCustomDayCellContent(options)) && (_("div", { className: "fc-daygrid-day-header" },
                  _(InnerContent, { tag: "a", attrs: buildNavLinkAttrs(context, props.date), className: joinClassNames('fc-daygrid-day-number', isMonthStart && 'fc-daygrid-month-start') }))),
              _("div", { className: joinClassNames('fc-daygrid-day-body', props.isTall && 'fc-daygrid-day-body-tall', props.fgLiquidHeight ? 'fc-liquid' : 'fc-grow'), ref: this.bodyElRef },
  ...
  */
      ...
      render() {
          ...
          const forcedInvisibleMap = // TODO: more convenient/DRY
           (props.eventDrag && props.eventDrag.affectedInstances) ||
              ...
              {};
          return (_("div", { role: 'row' // TODO: audit this for all scenarios
              ...
              props.showWeekNumbers && (_(WeekNumberContainer, { tag: "a", attrs: buildNavLinkAttrs(context, weekDate, 'week'), className: 'fc-daygrid-week-number', date: weekDate, defaultFormat: DEFAULT_WEEK_NUM_FORMAT$1 })),
  ...
  class DayGridRows extends DateComponent {
      ...
      render() {
          ...
          return (_("div", { className: joinClassNames(
  ...
  class DayGridHeaderCell extends BaseComponent {
      ...
      render() {
          ...
          return (_(ContentContainer, { tag: 'div', attrs: dataConfig.attrs, className: joinClassNames(dataConfig.className, 'fc-header-cell fc-cell fc-flex-col fc-align-center', props.borderStart && 'fc-border-s', !props.isSticky && 'fc-crop', props.colWidth == null && 'fc-liquid'), style: {
  ...
  class DayGridHeaderRow extends BaseComponent {
      ...
      render() {
          const { props } = this;
          return (_("div", { role: 'row', className: joinClassNames('fc-flex-row fc-content-box', props.className), style: { height: props.height } }, props.dataConfigs.map((dataConfig, cellI) => (_(DayGridHeaderCell, { key: dataConfig.key, renderConfig: props.renderConfig, dataConfig: dataConfig, isSticky: props.isSticky, borderStart: Boolean(cellI), colWidth: props.colWidth, innerHeightRef: props.innerHeightRef })))));
      }
  }
  ...
  */
  class DayGridHeader extends BaseComponent {
      render() {
          const { props } = this;
          return (_("div", { className: joinClassNames(props.className, 'fc-flex-col', props.width == null && 'fc-liquid'), style: {
                  width: props.width
              } }, props.headerTiers.map((rowConfig, tierNum) => (_(DayGridHeaderRow, Object.assign({}, rowConfig, { key: tierNum, className: tierNum ? 'fc-border-t' : '', colWidth: props.colWidth }))))));
      }
  }
  ...
  class DayGridLayout extends BaseComponent {
      ...
      render() {
          ...
          return (_(ViewContainer, { viewSpec: context.viewSpec, className: joinClassNames(props.className, 'fc-print-root fc-border') }, options.dayMinWidth ? (_(DayGridLayoutPannable, Object.assign({}, commonLayoutProps, { dayMinWidth: options.dayMinWidth }))) : (_(DayGridLayoutNormal, Object.assign({}, commonLayoutProps)))));
      }
      // Lifecycle
      // -----------------------------------------------------------------------------------------------
      componentDidMount() {
  ...
  class DayGridView extends BaseComponent {
      ...
      render() {
          ...
          return (_(NowTimer, { unit: "day" }, (nowDate, todayRange) => {
              ...
              return (_(DayGridLayout, { dateProfile: props.dateProfile, todayRange: todayRange, cellRows: dayTableModel.cellRows, forPrint: props.forPrint, className: 'fc-daygrid', 
                  // header content
  ...
  */
  ...
  class TimeGridAllDayLabel extends BaseComponent {
      ...
      render() {
          ...
          return (_(ContentContainer, { tag: "div", className: 'fc-timegrid-allday-label fc-timegrid-axis fc-cell fc-content-box', style: {
                  width: props.width,
  ...
  */
  ...
  const simplifiedTimeGridPrint = /* true || */ navigator.userAgent.toLowerCase().includes('firefox');
  class TimeGridCol extends BaseComponent {
      ...
      render() {
          ...
          return (_(DayCellContainer, { tag: "div", attrs: Object.assign({ role: 'gridcell' }, props.attrs), className: joinClassNames(props.className, 'fc-timegrid-day fc-flex-col fc-rel', props.borderStart && 'fc-border-s', props.width == null && 'fc-liquid'), style: {
                  width: props.width
              }, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, renderProps: props.renderProps }, (InnerContent) => (_(k$1, null,
              this.renderFillSegs(props.businessHourSegs, 'non-business'),
              this.renderFillSegs(props.bgEventSegs, 'bg-event'),
  ...
  class TimeGridWeekNumber extends BaseComponent {
      ...
      render() {
          ...
          let navLinkAttrs = (dayCnt === 1)
              ...
              : {};
          return (_(WeekNumberContainer, { tag: 'div', className: joinClassNames('fc-timegrid-weeknumber fc-timegrid-axis fc-cell', props.isLiquid ? 'fc-liquid' : 'fc-content-box'), style: { width: props.width }, date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, (InnerContent) => (_(InnerContent, { tag: "a", attrs: navLinkAttrs, className: 'fc-timegrid-axis-inner fc-cell-inner fc-padding-sm', elRef: this.innerElRef }))));
      }
      componentDidMount() {
          const { props } = this;
          const innerEl = this.innerElRef.current; // TODO: make dynamic with useEffect
  ...
  function TimeGridAxisEmpty(props) {
      return (_("div", { className: joinClassNames('fc-timegrid-axis', props.isLiquid ? 'fc-liquid' : 'fc-content-box'), style: { width: props.width } }));
  }
      ...
      render() {
          ...
          return (_(k$1, null,
              options.dayHeaders && (_("div", { className: joinClassNames(
                  ...
                  _("div", { className: 'fc-content-box', style: { width: axisWidth } }, headerTiers.map((models, tierNum) => (_("div", { key: tierNum, className: joinClassNames('fc-flex-row fc-content-box', tierNum && 'fc-border-t'), style: { height: state.headerTierHeights[tierNum] } }, tierNum === headerTiers.length - 1 ? ( // last row?
                  ...
                  _(Scroller, { horizontal: true, hideScrollbars: true, className: 'fc-flex-row fc-border-s fc-liquid', ref: this.headerScrollerRef },
                      _("div", { className: canvasWidth == null ? 'fc-liquid' : '', style: { width: canvasWidth } }, props.headerTiers.map((rowConfig, tierNum) => (_(DayGridHeaderRow, Object.assign({}, rowConfig, { key: tierNum, className: tierNum ? 'fc-border-t' : '', height: state.headerTierHeights[tierNum], colWidth: colWidth, innerHeightRef: headerMainInnerHeightRefMap.createRef(tierNum) }))))),
                      Boolean(state.endScrollbarWidth) && (_("div", { className: 'fc-border-s fc-filler', style: { minWidth: state.endScrollbarWidth } }))))),
              options.allDaySlot && (_(k$1, null,
                  _("div", { className: 'fc-timegrid-allday fc-flex-row' },
              ...
              _("div", { className: joinClassNames('fc-timegrid-body fc-flex-row', verticalScrolling && 'fc-liquid') },
                  _(Scroller, { vertical: verticalScrolling, hideScrollbars: true, className: 'fc-flex-col fc-content-box', style: {
                      ...
                      _("div", { className: joinClassNames('fc-flex-col fc-grow', absPrint && 'fc-rel'), style: {
                              height: forcedBodyHeight,
                          } },
                          _("div", { className: joinClassNames('fc-timegrid-slots-axis fc-flex-col', (verticalScrolling && options.expandRows) && 'fc-grow', absPrint && 'fc-fill-x') }, props.slatMetas.map((slatMeta, slatI) => (_("div", { key: slatMeta.key, className: joinClassNames(...getSlatRowClassNames(slatMeta), slatI && 'fc-border-t', slatLiquid && 'fc-liquid'), style: {
                      ...
                      _(Scroller, { vertical: verticalScrolling, horizontal: true, hideScrollbars: stickyFooterScrollbar || // also means height:auto, so won't need vertical scrollbars anyway
                          ...
                          _("div", { className: 'fc-flex-col fc-grow fc-rel', style: {
                              ...
                              !simplePrint && (_(k$1, null,
                                  _("div", { className: joinClassNames('fc-timegrid-slots fc-flex-col', (verticalScrolling && options.expandRows) && 'fc-grow', absPrint ? 'fc-fill-x' : 'fc-rel') }, props.slatMetas.map((slatMeta, slatI) => (_("div", { key: slatMeta.key, className: joinClassNames(...getSlatRowClassNames(slatMeta), slatI && 'fc-border-t', slatLiquid && 'fc-liquid'), style: {
                                          height: slatLiquid ? '' : slatHeight
                                      } },
  ...
  class TimeGridLayoutNormal extends BaseComponent {
      ...
      render() {
          ...
          return (_(k$1, null,
              options.dayHeaders && (_("div", { className: joinClassNames(
                  // see note in TimeGridLayout about why we don't do fc-print-header
                  'fc-timegrid-header fc-flex-col fc-border-b', stickyHeaderDates && 'fc-table-header-sticky') }, props.headerTiers.map((rowConfig, tierNum) => (_("div", { key: tierNum, className: joinClassNames('fc-flex-row', tierNum && 'fc-border-t') },
              ...
              _(Scroller, { vertical: verticalScrolling, className: joinClassNames('fc-timegrid-body fc-flex-col', verticalScrolling && 'fc-liquid'), ref: props.timeScrollerRef, clientWidthRef: this.handleClientWidth, clientHeightRef: this.handleClientHeight, endScrollbarWidthRef: this.handleEndScrollbarWidth },
                  _("div", { className: 'fc-flex-col fc-grow fc-rel', style: {
                      ...
                      _(TimeGridCols, { dateProfile: props.dateProfile, nowDate: props.nowDate, todayRange: props.todayRange, cells: props.cells, slatCnt: slatCnt, forPrint: forPrint, isHitComboAllowed: props.isHitComboAllowed, className: joinClassNames('fc-border-s', !simplePrint && 'fc-fill'), style: axisStartCss, 
                          // content
                          fgEventSegsByCol: props.fgEventSegsByCol, bgEventSegsByCol: props.bgEventSegsByCol, businessHourSegsByCol: props.businessHourSegsByCol, nowIndicatorSegsByCol: props.nowIndicatorSegsByCol, dateSelectionSegsByCol: props.dateSelectionSegsByCol, eventDragByCol: props.eventDragByCol, eventResizeByCol: props.eventResizeByCol, eventSelection: props.eventSelection, 
                          // dimensions
                          slatHeight: slatHeight }),
                      !simplePrint && (_(k$1, null,
                          _("div", { className: joinClassNames('fc-timegrid-slots fc-flex-col', (verticalScrolling && options.expandRows) && 'fc-grow', absPrint
  ...
  class TimeGridLayout extends BaseComponent {
      ...
      render() {
          ...
          return (_(ViewContainer, { className: joinClassNames(props.className, 'fc-border', !props.forPrint && 'fc-flex-col'), viewSpec: context.viewSpec }, dayMinWidth ? (_(TimeGridLayoutPannable, Object.assign({}, commonLayoutProps, { dayMinWidth: dayMinWidth, dayScrollerRef: this.dayScrollerRef }))) : (_(TimeGridLayoutNormal, Object.assign({}, commonLayoutProps)))));
      }
      // Lifecycle
      // -----------------------------------------------------------------------------------------------
      componentDidMount() {
  ...
  class TimeGridView extends DateComponent {
      ...
      render() {
          ...
          return (_(NowTimer, { unit: options.nowIndicator ? 'minute' : 'day' /* hacky */ }, (nowDate, todayRange) => {
              ...
              return (_(TimeGridLayout, { dateProfile: dateProfile, nowDate: nowDate, todayRange: todayRange, cells: dayTableModel.cellRows[0], forPrint: props.forPrint, className: 'fc-timegrid', 
                  // header content
                  headerTiers: headerTiers, 
                  // all-day content
  ...
  class ListDayHeader extends BaseComponent {
      render() {
          ...
          return (_("div", { className: joinClassNames('fc-list-day-outer', stickyHeaderDates && 'fc-list-day-outer-sticky') },
              _(ContentContainer, { tag: "div", className: joinClassNames('fc-list-day', getDayClassName(dayMeta)), attrs: {
  ...
  function renderInnerContent(props) {
      return (_(k$1, null,
          ...
          props.sideText && ( /* not keyboard tabbable */_("a", Object.assign({ className: "fc-list-day-side-text" }, props.sideNavLinkAttrs), props.sideText))));
  }
  ...
  class ListEvent extends BaseComponent {
      ...
      render() {
          ...
          let anchorAttrs = getEventRangeAnchorAttrs(eventRange, context);
          return (_(EventContainer, Object.assign({}, props, { tag: anchorAttrs ? 'a' : 'div', attrs: anchorAttrs, className: 'fc-list-event', defaultGenerator: renderEventTitleOnly, eventRange: eventRange, timeText: "", disableDragging: true, disableResizing: true }), (InnerContent, eventContentArg) => (_(k$1, null,
  ...
  class ListDay extends BaseComponent {
      ...
      render() {
          ...
          return (_("div", { className: 'fc-list-day-and-events' },
  ...
  */
  class ListView extends DateComponent {
      ...
      render() {
          ...
          return (_(ViewContainer, { elRef: this.setRootEl, className: 'fc-list fc-flex-col fc-border', viewSpec: context.viewSpec },
  ...
  class SingleMonth extends DateComponent {
      ...
      render() {
          ...
          return (_("div", { "data-date": props.isoDateStr, className: joinClassNames('fc-multimonth-month', props.hasLateralSiblings && 'fc-break-inside-avoid'), 
              ...
              _("div", { className: "fc-multimonth-header", style: {
                  ...
                  _(DayGridHeaderRow, Object.assign({}, rowConfig, { className: 'fc-multimonth-header-row' }))),
  ...
  class MultiMonthView extends DateComponent {
      ...
      render() {
          ...
          return (_(NowTimer, { unit: "day" }, (nowDate, todayRange) => (_(ViewContainer, { className: joinClassNames('fc-multimonth fc-border', (cols === 1) ?
              ...
              _(Scroller, { vertical: verticalScrolling, className: verticalScrolling ? 'fc-liquid' : '', ref: this.scrollerRef },
                  _("div", { ref: this.innerElRef, className: 'fc-multimonth-inner' }, monthDateProfiles.map((monthDateProfile) => {
