(function (global, factory) {
    ...
    function connectAdvanced(selectorFactory, _ref) {
      var _ref$getDisplayName = _ref.getDisplayName,
        getDisplayName = _ref$getDisplayName === undefined ? getDefaultName : _ref$getDisplayName,
        _ref$methodName = _ref.methodName,
        methodName = _ref$methodName === undefined ? 'connectAdvanced' : _ref$methodName,
        _ref$renderCountProp = _ref.renderCountProp,
        renderCountProp = _ref$renderCountProp === undefined ? null : _ref$renderCountProp,
      ...
      var wrapWithConnect = function wrapWithConnect(WrappedComponent) {
        ...
        var Connect = /*#__PURE__*/function (_Component) {
          function Connect(props, context) {
            ...
            _this.renderCount = undefined;
            _this.propsMode = undefined;
            _this.store = undefined;
            _this.notifyNestedSubs = undefined;
            _this.subscription = undefined;
            _this.wrappedInstance = undefined;
          ...
          _proto.isSubscribed = function isSubscribed() {
            ...
            return Boolean((_this$subscription = this.subscription) == null ? undefined : _this$subscription.isSubscribed());
          };
