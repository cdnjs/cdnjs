...
__webpack_require__.d(__webpack_exports__, {
  loadRoundedPolygonShape: () => (/* binding */ loadRoundedPolygonShape)
});
...
class RoundedPolygonDrawer {
  ...
  getSidesCount(particle) {
    ...
    return Math.round((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(roundedPolygon?.sides ?? 5));
  }
  particleInit(container, particle) {
    const shapeData = particle.shapeData;
    particle.borderRadius = Math.round((0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(shapeData?.radius ?? 5)) * container.retina.pixelRatio;
  }
}
