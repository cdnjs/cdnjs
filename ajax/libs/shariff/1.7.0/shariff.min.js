...
"use strict";module.exports=function(e){var t=encodeURIComponent(e.getURL());return{popup:!0,shareText:"tweet",name:"twitter",faName:"fa-twitter",title:{de:"Bei Twitter teilen",en:"Share on Twitter",es:"Compartir en Twitter"},shareUrl:"https://twitter.com/intent/tweet?text="+t+"&url="+e.getURL()+e.getReferrerTrack()}};
