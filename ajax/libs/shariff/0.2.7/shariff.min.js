...
"use strict";module.exports=function(e){var r={referrerTrack:""},o=encodeURIComponent(e.getURI());return{popup:!0,shareText:"teilen",name:"facebook",shareUrl:"https://www.facebook.com/sharer/sharer.php?u="+o+r.referrerTrack}};
},{}],3:[function(require,module,exports){
"use strict";module.exports=function(r){var e={referrerTrack:""};return{popup:!0,shareText:"+1",name:"gplus",shareUrl:"https://plus.google.com/share?url="+r.getURI()+e.referrerTrack}};
...
"use strict";module.exports=function(e){return{popup:!1,shareText:"mail",name:"per_email",shareUrl:e.getURI()+"?view=mail"}};
},{}],6:[function(require,module,exports){
"use strict";var $=require("jquery");module.exports=function(e){var t={handle:"heiseonline",referrerTrack:""},r=function(e,t){var r=decodeURIComponent(e);if(r.length<=t)return e;var n=r.substring(0,t-1).lastIndexOf(" ");return r=encodeURIComponent(r.substring(0,n))+"…"},n=function(){var t=e.getMeta("DC.title"),n=e.getMeta("DC.creator");return t.length>0&&n.length>0?t+=" - "+n:t=$("title").text(),encodeURIComponent(r(t,120))};return{popup:!0,shareText:"tweet",name:"twitter",shareUrl:"https://twitter.com/intent/tweet?text="+n()+"&url="+e.getURI()+t.referrerTrack+"&via="+t.handle}};
},{"jquery":1}],7:[function(require,module,exports){
(function (global){
"use strict";var $=require("jquery"),services=[require("./modules/twitter"),require("./modules/facebook"),require("./modules/gplus"),require("./modules/mail"),require("./modules/info")],_Shariff=function(t,e){var n=this;this.element=t,this.options=$.extend({},this.defaults,e,$(t).data()),this.services=$.map(services,function(t){return t(n)}),this._addButtonList(),null!==this.options.backendUrl&&this.getShares().then($.proxy(this._updateCounts,this))};_Shariff.prototype={defaults:{theme:"color",backendUrl:null,orientation:"horizontal",url:function(){var t=global.document.location.href,e=$("link[rel=canonical]").attr("href");return e&&e.length>0&&(e.indexOf("http")<0&&(e=global.document.location.protocol+"//"+global.document.location.host+e),t=e),t}},$socialshareElement:function(){return $(this.element)},getMeta:function(t){var e=$('meta[name="'+t+'"]').attr("content");return e||""},getURL:function(){var t=this.options.url;return"function"==typeof t?t():t},getShares:function(){return $.getJSON(this.options.backendUrl+"?url="+encodeURIComponent(this.getURL()))},_updateCounts:function(t){var e=this;$.each(t,function(t,n){$(e.element).find("."+t+" a").append('<span class="share_count">'+n)})},_addButtonList:function(){var t='<ul class="social_share_area clearfix"></ul>',e=this.$socialshareElement();e.prepend(t);var n=e.find(".social_share_area");n.addClass("theme-"+this.options.theme),n.addClass("orientation-"+this.options.orientation),this.services.forEach(function(t){var e=$('<li class="button">').addClass(t.name),a='<span class="share_text">'+t.shareText,r=$("<a>").attr("href",t.shareUrl).append(a);t.popup?r.attr("rel","popup").attr("title",t.name+"-share-dialog"):r.attr("title",t.shareText),e.append(r),n.append(e)}),n.on("click",'[rel="popup"]',function(t){t.preventDefault();var e=$(this).attr("href"),n=$(this).attr("title"),a="600",r="460",i="width="+a+",height="+r;global.window.open(e,n,i)})}},module.exports=_Shariff,$.fn.shariff=function(t){return this.each(function(){this.shariff=new _Shariff(this,t)})},$(".shariff").shariff({debug:"undefined"!=typeof DEBUG});
