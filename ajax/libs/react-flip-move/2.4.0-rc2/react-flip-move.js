...
/***/ function(module, exports) {
	...
	exports.fetchTransformFromNode = fetchTransformFromNode;
	/**
	 * React Flip Move
	 * (c) 2016-present Joshua Comeau
	 */
	...
	function fetchTransformFromNode(node) {
	  ...
	  _createClass(FlipMove, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      ...
	      var newBoundingBoxes = this.props.children.reduce(function (boxes, child) {
	        ...
	        var relativeBox = {
	          'top': childBox['top'] - _this2.parentBox['top'],
	          'left': childBox['left'] - _this2.parentBox['left'],
	          'right': _this2.parentBox['right'] - childBox['right'],
	          'bottom': _this2.parentBox['bottom'] - childBox['bottom']
	        };
	    ...
	    value: function prepareNextChildren(nextChildren) {
	      ...
	      var updatedChildren = nextChildren.map(function (nextChild) {
	        ...
	        var isBeingReintroduced = child && child.leaving;
	      ...
	      this.state.children.forEach(function (child, index) {
	        ...
	        // animation.
	        var isMidTransition = !!child.leaving;
	    ...
	    value: function calculateAndAnimateChildren() {
	      ...
	      if (this.props.leaveAnimation) {
	        var leavingChildren = this.state.children.filter(function (child) {
	          return child.leaving && !child.transitioning;
	        });
	    ...
	    value: function computeInitialStyles(child) {
	      ...
	      if (child.transitioning) {
	        ...
	        var initialTransform = (0, _helpers.fetchTransformFromNode)(domNode);
	        ...
	        var newTransform = 'translate(' + dX + 'px, ' + dY + 'px)';
	        ...
	        // is valid :)
	        style.transform = initialTransform ? initialTransform + ' ' + newTransform : newTransform;
	      }
