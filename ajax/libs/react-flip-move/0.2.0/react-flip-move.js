...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlipMove = function (_Component) {
	  ...
	  _createClass(FlipMove, [{
	    ...
	    key: 'pickAndPrepAnimationProps',
	    value: function pickAndPrepAnimationProps(n) {
	      ...
	      var animationProps = _objectWithoutProperties(_props, ['children', 'onStart', 'onFinish', 'staggerDurationBy']);
	    ...
	    value: function animateTransform(child, n) {
	      ...
	      var animationProps = this.pickAndPrepAnimationProps(n);

	      var player = domNode.animate([{ transform: 'translate(' + deltaX + 'px, ' + deltaY + 'px)' }, { transform: 'translate(0,0)' }], animationProps);
	      ...
	      if (this.props.onFinish) {
	        player.addEventListener('finish', function () {
	          ...
	          _this3.props.onFinish(child, domNode);
	        });
	      }
	    }
	  }, {
