	...
	var FlipMove = (0, _propConverter2.default)(_class = function (_Component) {
	  ...
	  _createClass(FlipMove, [{
	    ...
	    value: function calculateAndAnimateChildren() {
	      ...
	      if (this.props.leaveAnimation) {
	        ...
	        if (this.props.maintainContainerHeight) {
	          ...
	          var collapsedHeight = this.props.getPosition(this.parentElement).height;

	          // Find the distance by which the container would be collapsed by elements
	          // leaving. We compare the temporarily available `collapsedHeight` with
	          // the previously cached container height.
	          var reductionInHeight = this.parentBox.height - collapsedHeight;
	    ...
	    value: function childrenWithRefs() {
	      ...
	      var childNodes = this.state.children.map(function (child) {
	      ...
	      if (this.props.leaveAnimation && this.props.maintainContainerHeight) {
	        ...
	        var placeholderType = this.props.typeName === 'ul' ? 'li' : 'div';

	        childNodes.push(_react2.default.createElement(placeholderType, {
	          key: 'height-placeholder',
	          ref: function ref(element) {
	            _this7.heightPlaceholder = element;
	          },
