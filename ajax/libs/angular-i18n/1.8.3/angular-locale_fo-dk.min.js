"use strict";angular.module("ngLocale",[],["$provide",function(e){var u="one",m="other";e.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:["sunnudagur","mánadagur","týsdagur","mikudagur","hósdagur","fríggjadagur","leygardagur"],ERANAMES:["fyri Krist","eftir Krist"],ERAS:["f.Kr.","e.Kr."],FIRSTDAYOFWEEK:0,MONTH:["januar","februar","mars","apríl","mai","juni","juli","august","september","oktober","november","desember"],SHORTDAY:["sun.","mán.","týs.","mik.","hós.","frí.","ley."],SHORTMONTH:["jan.","feb.","mar.","apr.","mai","jun.","jul.","aug.","sep.","okt.","nov.","des."],STANDALONEMONTH:["januar","februar","mars","apríl","mai","juni","juli","august","september","oktober","november","desember"],WEEKENDRANGE:[5,6],fullDate:"EEEE, d. MMMM y",longDate:"d. MMMM y",medium:"dd.MM.y HH:mm:ss",mediumDate:"dd.MM.y",mediumTime:"HH:mm:ss",short:"dd.MM.yy HH:mm",shortDate:"dd.MM.yy",shortTime:"HH:mm"},NUMBER_FORMATS:{CURRENCY_SYM:"kr.",DECIMAL_SEP:",",GROUP_SEP:".",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-",negSuf:" ¤",posPre:"",posSuf:" ¤"}]},id:"fo-dk",localeID:"fo_DK",pluralCat:function(e,r){var a=0|e,r=function(e,r){var a=r;void 0===a&&(a=Math.min((r=e,-1==(u=(r+="").indexOf("."))?0:r.length-u-1),3));var u=Math.pow(10,a);return{v:a,f:(e*u|0)%u}}(e,r);return 1==a&&0==r.v?u:m}})}]);