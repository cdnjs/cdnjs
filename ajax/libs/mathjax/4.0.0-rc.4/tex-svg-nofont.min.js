...
`,i.focus()}setCurrent(t,e=!1){this.speechType="",document.hasFocus()||(this.refocus=this.current),this.node.setAttribute("aria-busy","true"),this.current&&(this.current.classList.remove("mjx-selected"),this.pool.unhighlight(),"last"===this.document.options.a11y.tabSelects&&(this.refocus=this.current),this.current=null,t||this.removeSpeech()),this.current=t,this.current&&(this.current.classList.add("mjx-selected"),this.pool.highlight([this.current]),this.addSpeech(t,e)),this.node.removeAttribute("aria-busy")}addSpeech(t,e){var i;null!=(i=this.img)&&i.remove();let s=[t.getAttribute(ug.PREFIX),t.getAttribute(ug.SPEECH),t.getAttribute(ug.POSTFIX)].join(" ").trim();if(e){let t=this.description===this.none?"":", "+this.description;this.document.options.a11y.help&&(t+=", press h for help"),s+=t}this.speak(s,t.getAttribute(ug.BRAILLE),this.SsmlAttributes(t,ug.SPEECH_SSML)),this.node.setAttribute("tabindex","-1")}removeSpeech(){this.speech&&(this.speech.remove(),this.speech=null,this.img&&this.node.append(this.img),this.node.setAttribute("tabindex","0"))}speak(t,e="",i=null,s=this.none){t=t||"blank";const r=this.speech;this.speech=document.createElement("mjx-speech"),this.speech.setAttribute("role",this.role),this.speech.setAttribute("aria-label",t),this.speech.setAttribute(ug.SPEECH,t),i&&(this.speech.setAttribute(ug.PREFIX_SSML,i[0]||""),this.speech.setAttribute(ug.SPEECH_SSML,i[1]||""),this.speech.setAttribute(ug.POSTFIX_SSML,i[2]||"")),e&&this.speech.setAttribute("aria-braillelabel",e),this.speech.setAttribute("aria-roledescription",s),this.speech.setAttribute("tabindex","0"),this.node.append(this.speech),this.focusSpeech=!0,this.speech.focus(),this.focusSpeech=!1,this.Update(),r&&setTimeout(()=>r.remove(),100)}attachSpeech(){var t;const e=this.item,i=this.node;if(!i.hasAttribute("has-speech")){for(const t of Array.from(i.childNodes))t.setAttribute("aria-hidden","true");i.setAttribute("has-speech","true")}var s=e.roleDescription,s=(i.getAttribute(ug.SPEECH)||"")+(s?", "+s:"");null!=(t=this.img)&&t.remove(),this.img=this.document.adaptor.node("mjx-speech",{"aria-label":s,role:"img","aria-roledescription":e.none}),i.appendChild(this.img)}detachSpeech(){var t;const e=this.node;null!=(t=this.img)&&t.remove(),e.removeAttribute("has-speech");for(const t of Array.from(e.childNodes))t.removeAttribute("aria-hidden")}focus(){this.node.focus()}nextSibling(t){if(!this.current.getAttribute("data-semantic-parent"))return null;const e=t.nextElementSibling;if(e){if(e.matches(ob))return e;const t=e.querySelector(ob);return null!=t?t:this.nextSibling(e)}return lb(t)||t.parentElement.matches(ob)?null:this.nextSibling(t.parentElement)}prevSibling(t){if(!this.current.getAttribute("data-semantic-parent"))return null;const e=t.previousElementSibling;if(e){if(e.matches(ob))return e;const t=e.querySelector(ob);return null!=t?t:this.prevSibling(e)}return lb(t)||t.parentElement.matches(ob)?null:this.prevSibling(t.parentElement)}findClicked(t,e,i){const s=this.document.infoIcon;if(s===t||s.contains(t))return s;if("SVG"!==this.node.getAttribute("jax"))return t.closest(ob);let r=null,n=this.node;for(;n;){n.matches(ob)&&(r=n);const t=Array.from(n.childNodes);n=null;for(const s of t)if(s!==this.speech&&s!==this.img&&"rect"!==s.tagName.toLowerCase()){const{left:t,right:r,top:a,bottom:o}=s.getBoundingClientRect();if(t<=e&&e<=r&&a<=i&&i<=o){n=s;break}}}return r}focusTop(){this.focusSpeech=!0,this.node.focus(),this.focusSpeech=!1}SsmlAttributes(t,e){return[t.getAttribute(ug.PREFIX_SSML),t.getAttribute(e),t.getAttribute(ug.POSTFIX_SSML)]}restartAfter(e){return ab(this,void 0,void 0,function*(){yield e,this.attachSpeech();var t=this.current;this.current=null,this.pool.unhighlight(),this.setCurrent(t)})}constructor(t,e,i,s,r,n,a,o){super(t,e,null,s),this.document=t,this.pool=e,this.region=i,this.node=s,this.brailleRegion=r,this.magnifyRegion=n,this.item=o,this.sound=!1,this.current=null,this.clicked=null,this.refocus=null,this.focusSpeech=!1,this.restarted=null,this.speech=null,this.speechType="",this.img=null,this.attached=!1,this.eventsAttached=!1,this.events=super.Events().concat([["focusin",this.FocusIn.bind(this)],["focusout",this.FocusOut.bind(this)],["keydown",this.KeyDown.bind(this)],["mousedown",this.MouseDown.bind(this)],["click",this.Click.bind(this)],["dblclick",this.DblClick.bind(this)]])}findStartNode(){let t=this.refocus||this.current;return!t&&this.restarted&&(t=this.node.querySelector(this.restarted)),this.refocus=this.restarted=null,t}Start(){const i=Object.create(null,{Start:{get:()=>super.Start}});return ab(this,void 0,void 0,function*(){var t,e;this.attached&&!this.active&&(this.document.activeItem=this.item,this.item.state()<u.ATTACHSPEECH&&(this.item.attachSpeech(this.document),yield this.generators.promise),this.focusSpeech||(this.node.classList.add("mjx-explorer-active"),this.node.append(this.document.infoIcon),t=this.findStartNode(),this.setCurrent(t||this.node.querySelector(ob),!t),i.Start.call(this),(e=(t=this.document.options).a11y).subtitles&&e.speech&&t.enableSpeech&&this.region.Show(this.node,this.highlighter),e.viewBraille&&e.braille&&t.enableBraille&&this.brailleRegion.Show(this.node,this.highlighter),e.keyMagnifier&&this.magnifyRegion.Show(this.current,this.highlighter),this.Update()))})}Stop(){var t;this.active&&(t=this.description,this.node.getAttribute("aria-roledescription")!==t&&this.node.setAttribute("aria-roledescription",t),this.node.classList.remove("mjx-explorer-active"),this.document.infoIcon.remove(),this.pool.unhighlight(),this.magnifyRegion.Hide(),this.region.Hide(),this.brailleRegion.Hide()),super.Stop()}Update(){this.active&&(this.region.node=this.node,this.generators.updateRegions(this.speech||this.node,this.region,this.brailleRegion),this.magnifyRegion.Update(this.current))}Attach(){this.attached||(super.Attach(),this.node.setAttribute("tabindex","0"),this.attached=!0)}Detach(){var t;super.RemoveEvents(),this.node.removeAttribute("role"),this.node.removeAttribute("aria-roledescription"),this.node.removeAttribute("aria-label"),null!=(t=this.img)&&t.remove(),this.active&&this.node.setAttribute("tabindex","0"),this.attached=!1}NoMove(){kg()}AddEvents(){this.eventsAttached||(super.AddEvents(),this.eventsAttached=!0)}actionable(t){t=null==t?void 0:t.parentNode;return t&&this.highlighter.isMactionNode(t)?t:null}triggerLinkKeyboard(t){return this.current?this.triggerLink(this.current):t.target instanceof HTMLAnchorElement&&(t.target.dispatchEvent(new MouseEvent("click")),!0)}triggerLink(t){var e;return!(null==(e=null==t?void 0:t.getAttribute("data-semantic-postfix"))||!e.match(/(^| )link($| )/)||(t.parentNode.dispatchEvent(new MouseEvent("click")),setTimeout(()=>this.FocusOut(null),50),0))}triggerLinkMouse(){let t=this.refocus;for(;t&&t!==this.node;){if(this.triggerLink(t))return!0;t=t.parentNode}return!1}semanticFocus(){const t=[];let e="data-semantic-id",i=this.current||this.refocus||this.node;const s=this.actionable(i);s&&(e=s.hasAttribute("data-maction-id")?"data-maction-id":"id",i=s,t.push(ob));var r=i.getAttribute(e);return r&&t.unshift(`[${e}="${r}"]`),t.join(" ")}}db.keyMap=new Map([["Tab",()=>!0],["Control",t=>t.controlKey()],["Escape",t=>t.escapeKey()],["Enter",(t,e)=>t.enterKey(e)],["ArrowDown",t=>!t.active||t.moveDown()],["ArrowUp",t=>!t.active||t.moveUp()],["ArrowLeft",t=>!t.active||t.moveLeft()],["ArrowRight",t=>!t.active||t.moveRight()],[" ",t=>t.spaceKey()],["h",t=>t.hKey()],["H",t=>t.hKey()],[">",t=>!!t.active&&t.nextRules()],["<",t=>!!t.active&&t.nextStyle()],["x",t=>!!t.active&&t.summary()],["X",t=>!!t.active&&t.summary()],["d",t=>!!t.active&&t.depth()],["D",t=>!!t.active&&t.depth()]]);class ub extends nb{constructor(){super(...arguments),this.events=super.Events().concat([["mouseover",this.MouseOver.bind(this)],["mouseout",this.MouseOut.bind(this)]])}MouseOver(t){this.Start()}MouseOut(t){this.Stop()}}class pb extends ub{constructor(t,e,i,s,r,n){super(t,e,i,s),this.document=t,this.pool=e,this.region=i,this.node=s,this.nodeQuery=r,this.nodeAccess=n}MouseOut(t){this.highlighter.unhighlight(),this.region.Hide(),super.MouseOut(t)}MouseOver(t){super.MouseOver(t);var t=t.target,[t,e]=this.getNode(t);t&&(this.highlighter.unhighlight(),this.highlighter.highlight([t]),this.region.Update(e),this.region.Show(t,this.highlighter))}getNode(t){const e=t;for(;t&&t!==this.node;){if(this.nodeQuery(t))return[t,this.nodeAccess(t)];t=t.parentNode}for(t=e;t;){if(this.nodeQuery(t))return[t,this.nodeAccess(t)];const e=t.childNodes[0];t=e&&"defs"===e.tagName?t.childNodes[1]:e}return[null,null]}}class mb extends pb{}class fb extends pb{}class gb extends pb{constructor(t,e,i,s){super(t,e,new Zg(t),s,t=>this.highlighter.isMactionNode(t),()=>{}),this.document=t,this.pool=e,this.node=s}}class bb extends nb{constructor(t,e,i,s,r){super(t,e,null,s),this.document=t,this.pool=e,this.region=i,this.node=s,this.mml=r,this.stoppable=!1}Attach(){super.Attach(),this.Start()}Detach(){this.Stop(),super.Detach()}}class Eb extends bb{Start(){this.active||(this.active=!0,this.highlighter.highlightAll(this.node))}Stop(){this.active&&this.highlighter.unhighlightAll(),this.active=!1}}class Nb extends bb{constructor(){super(...arguments),this.contrast=new yb,this.leaves=[],this.modality="data-semantic-foreground"}Start(){this.active||(this.active=!0,this.node.hasAttribute("hasforegroundcolor")||(this.colorLeaves(),this.node.setAttribute("hasforegroundcolor","true")),this.leaves.forEach(t=>this.colorize(t)))}Stop(){this.active&&this.leaves.forEach(t=>this.uncolorize(t)),this.active=!1}colorLeaves(){this.leaves=Array.from(this.node.querySelectorAll("[data-semantic-id]:not([data-semantic-children])"));for(const t of this.leaves)t.setAttribute(this.modality,this.contrast.generate()),this.contrast.increment()}colorize(t){t.hasAttribute(this.modality)&&(t.setAttribute(this.modality+"-old",t.style.color),t.style.color=t.getAttribute(this.modality))}uncolorize(t){var e=this.modality+"-old";t.hasAttribute(e)&&(t.style.color=t.getAttribute(e))}}class yb{constructor(){this.hue=10,this.sat=100,this.light=50,this.incr=53}generate(){return yb.hsl2rgb(this.hue,this.sat,this.light)}increment(){this.hue=(this.hue+this.incr)%360}static hsl2rgb(t,e,i){e=1<e?e/100:e,i=1<i?i/100:i;var e=(1-Math.abs(2*i-1))*e,s=e*(1-Math.abs(t/60%2-1)),i=i-e/2;let r=0,n=0,a=0;return 0<=t&&t<60?[r,n,a]=[e,s,0]:60<=t&&t<120?[r,n,a]=[s,e,0]:120<=t&&t<180?[r,n,a]=[0,e,s]:180<=t&&t<240?[r,n,a]=[0,s,e]:240<=t&&t<300?[r,n,a]=[s,0,e]:300<=t&&t<360&&([r,n,a]=[e,0,s]),`rgb(${255*(r+i)}, ${255*(n+i)}, ${255*(a+i)})`}}class xb{constructor(t){this.document=t,this.speechRegion=new sb(this.document),this.brailleRegion=new ib(this.document),this.magnifier=new rb(this.document),this.tooltip1=new eb(this.document),this.tooltip2=new eb(this.document),this.tooltip3=new eb(this.document)}}const Ab={speech:(t,e,i,...s)=>{const r=db.create(t,e,t.explorerRegions.speechRegion,i,t.explorerRegions.brailleRegion,t.explorerRegions.magnifier,s[0],s[1]);return r.sound=!0,r},mouseMagnifier:(t,e,i)=>fb.create(t,e,t.explorerRegions.magnifier,i,t=>t.hasAttribute("data-semantic-type"),t=>t),hover:(t,e,i)=>gb.create(t,e,null,i),infoType:(t,e,i)=>mb.create(t,e,t.explorerRegions.tooltip1,i,t=>t.hasAttribute("data-semantic-type"),t=>t.getAttribute("data-semantic-type")),infoRole:(t,e,i)=>mb.create(t,e,t.explorerRegions.tooltip2,i,t=>t.hasAttribute("data-semantic-role"),t=>t.getAttribute("data-semantic-role")),infoPrefix:(t,e,i)=>mb.create(t,e,t.explorerRegions.tooltip3,i,t=>t.hasAttribute("data-semantic-prefix"),t=>t.getAttribute("data-semantic-prefix")),flame:(t,e,i)=>Eb.create(t,e,null,i),treeColoring:(t,e,i,...s)=>Nb.create(t,e,null,i,...s)};class vb{constructor(){this.explorers={},this.attached=[],this._restart=[],this.speechExplorerKeys=["speech","braille","keyMagnifier"]}get highlighter(){if(this._renderer!==this.document.outputJax.name)return this._renderer=this.document.outputJax.name,this.setPrimaryHighlighter(),this._highlighter;var[t,e]=this.colorOptions();return this._highlighter.setColor(e,t),this._highlighter}init(t,e,i,s){this.document=t,this.mml=i,this.node=e,this.setPrimaryHighlighter();for(const t of Object.keys(Ab))this.explorers[t]=Ab[t](this.document,this,this.node,this.mml,s);this.setSecondaryHighlighter(),this.attach()}attach(){this.attached=[];const t=[],e=this.document.options.a11y;for(var[i,s]of Object.entries(this.explorers))s instanceof db?(s.stoppable=!1,t.unshift(s),this.speechExplorerKeys.some(t=>this.document.options.a11y[t])?(s.Attach(),this.attached.push(i)):s.Detach()):e[i]||"speech"===i&&(e.braille||e.keyMagnifier)?(s.Attach(),this.attached.push(i)):s.Detach();for(const e of t)if(e.attached){e.stoppable=!0;break}}reattach(){for(const t of this.attached){const e=this.explorers[t];e.active&&(this._restart.push(t),e.Stop())}}restart(){this._restart.forEach(t=>{this.explorers[t].Start()}),this._restart=[]}setPrimaryHighlighter(){var[t,e]=this.colorOptions();this._highlighter=Yg(e,t,this.document.outputJax.name)}setSecondaryHighlighter(){this.secondaryHighlighter=Yg({color:"red"},{color:"black"},this.document.outputJax.name),this.speech.region.highlighter=this.secondaryHighlighter}highlight(t){this.highlighter.highlight(t)}unhighlight(){this.secondaryHighlighter.unhighlight(),this.highlighter.unhighlight()}get speech(){return this.explorers.speech}colorOptions(){const t=this.document.options.a11y;return[{color:t.foregroundColor.toLowerCase(),alpha:t.foregroundOpacity/100},{color:t.backgroundColor.toLowerCase(),alpha:t.backgroundOpacity/100}]}}const _b="Unix"===Ws.os;function Tb(t,s){t=class extends t{constructor(){super(...arguments),this.refocus=null}get ariaRole(){return this.constructor.ariaRole}get roleDescription(){var t=this.constructor;return"none"===t.roleDescription?t.none:t.roleDescription}get none(){return this.constructor.none}attachSpeech(t){super.attachSpeech(t),null!=(t=null==(t=this.outputData.speechPromise)?void 0:t.then(()=>this.explorers.speech.attachSpeech()))&&t.then(()=>{var t;null!=(t=this.explorers)&&t.speech&&(this.explorers.speech.restarted=this.refocus),this.refocus=null,this.explorers&&this.explorers.restart()})}detachSpeech(t){super.detachSpeech(t),this.explorers.speech.detachSpeech()}explorable(t,e=!1){if(!(this.state()>=u.EXPLORER)){if(!this.isEscaped&&(t.options.enableExplorer||e)){const e=this.typesetRoot,i=s(this.root);this.explorers||(this.explorers=new vb),this.explorers.init(t,e,i,this)}this.state(u.EXPLORER)}}state(t=null,e=!1){if(t<u.EXPLORER&&this.explorers)for(const t of Object.values(this.explorers.explorers))t.active&&t.Stop();return super.state(t,e)}rerender(t,e=u.RERENDER){var i=this.setTemporaryFocus(t);super.rerender(t,e),this.clearTemporaryFocus(i)}setTemporaryFocus(t){var e;let i=null;if(this.explorers){const s=this.explorers.speech;if(i=null!=s&&s.attached?t.tmpFocus:null){this.refocus=null!=(e=s.semanticFocus())?e:null;const r=t.adaptor;r.append(r.body(),i)}this.explorers.reattach(),null!=i&&i.focus()}return i}clearTemporaryFocus(t){var e;t&&(null!=(e=this.outputData.speechPromise)?e:Promise.resolve()).then(()=>setTimeout(()=>t.remove(),100))}};return t.ariaRole=_b?"tree":"application",t.roleDescription="math",t.none="",t}function wb(t){var e=class extends t{constructor(...t){super(...t),this.explorerRegions=null,this.activeItem=null;const e=this.constructor.ProcessBits,i=(e.has("explorer")||e.allocate("explorer"),new ya(this.mmlFactory)),s=this.options,r=(s.a11y.speechRules||(s.a11y.speechRules=s.sre.domain+"-"+s.sre.style),s.MathItem=Tb(s.MathItem,t=>i.visitTree(t))),n=(r.roleDescription=s.roleDescription,this.explorerRegions=new xb(this),"addStyles"in this&&this.addStyles(this.constructor.speechStyles),this.adaptor),a="http://www.w3.org/2000/svg";this.infoIcon=n.node("mjx-help",{},[n.node("svg",{viewBox:"0 0 18 18",xmlns:a,"aria-hidden":"true"},[n.node("circle",{stroke:"none"},[],a),n.node("circle",{},[],a),n.node("line",{x1:9,y1:9,x2:9,y2:13},[],a),n.node("line",{x1:9,y1:5.5,x2:9,y2:5.5},[],a)],a)]),this.tmpFocus=this.adaptor.node("mjx-focus",{tabIndex:0,style:{outline:"none",display:"block",position:"absolute",top:0,left:"-10px",width:"1px",height:"1px",overflow:"hidden"},role:r.ariaRole,"aria-label":r.none,"aria-roledescription":r.none})}explorable(){if(!this.processed.isSet("explorer")){if(this.options.enableExplorer)for(const t of this.math)t.explorable(this);this.processed.set("explorer")}return this}rerender(t){const e=this.activeItem,i=null==e?void 0:e.setTemporaryFocus(this);return super.rerender(t),null!=e&&e.clearTemporaryFocus(i),this}state(t,e=!1){return super.state(t,e),t<u.EXPLORER&&this.processed.clear("explorer"),this}};return e.OPTIONS=Object.assign(Object.assign({},t.OPTIONS),{enableExplorer:Vs,renderActions:lr(Object.assign(Object.assign({},t.OPTIONS.renderActions),{explorable:[u.EXPLORER]})),sre:lr(Object.assign(Object.assign({},t.OPTIONS.sre),{speech:"none"})),a11y:Object.assign(Object.assign({},t.OPTIONS.a11y),{align:"top",backgroundColor:"Blue",backgroundOpacity:20,flame:!1,foregroundColor:"Black",foregroundOpacity:100,highlight:"None",hover:!1,infoPrefix:!1,infoRole:!1,infoType:!1,keyMagnifier:!1,magnification:"None",magnify:"400%",mouseMagnifier:!1,subtitles:!1,treeColoring:!1,viewBraille:!1,voicing:!1,help:!0,roleDescription:"math",tabSelects:"all"})}),e.speechStyles={'mjx-container[has-speech="true"]':{position:"relative",cursor:"default"},"mjx-speech":{position:"absolute","z-index":-1,left:0,top:0,bottom:0,right:0},"mjx-speech:focus":{outline:"none"},"mjx-container .mjx-selected":{outline:"2px solid black"},"mjx-container > mjx-help":{display:"none",position:"absolute",top:"-.33em",right:"-.5em",width:".6em",height:".6em",cursor:"pointer"},'mjx-container[display="true"] > mjx-help':{right:0},"mjx-help > svg":{stroke:"black",width:"100%",height:"100%"},"mjx-help > svg > circle":{"stroke-width":"1.5px",cx:"9px",cy:"9px",r:"9px",fill:"white"},"mjx-help > svg > circle:nth-child(2)":{fill:"rgba(0, 0, 255, 0.2)",r:"7px"},"mjx-help > svg > line":{"stroke-width":"2.5px","stroke-linecap":"round"},"mjx-help:hover > svg > circle:nth-child(2)":{fill:"white"},"mjx-container.mjx-explorer-active > mjx-help":{display:"inline-flex","align-items":"center"},"mjx-help-sizer":{position:"fixed",width:"40%","max-width":"30em",top:"3em",left:"50%"},"mjx-help-dialog":{position:"absolute",width:"200%",left:"-100%",border:"3px outset","border-radius":"15px",color:"black","background-color":"#DDDDDD","z-index":"301","text-align":"right","font-style":"normal","text-indent":0,"text-transform":"none","line-height":"normal","letter-spacing":"normal","word-spacing":"normal","word-wrap":"normal",float:"none","box-shadow":"0px 10px 20px #808080",outline:"none"},"mjx-help-dialog > h1":{"font-size":"24px","text-align":"center",margin:".5em 0"},"mjx-help-dialog > div":{margin:"0 1em",padding:"3px",overflow:"auto",height:"20em",border:"2px inset black","background-color":"white","text-align":"left"},"mjx-help-dialog > input":{margin:".5em 2em"}},e}function Cb(t,e=null){return(t=t.documentClass.prototype.attachSpeech?t:Hg(t,e)).documentClass=wb(t.documentClass),t}function Ib(t,e,i){switch(e){case"speechRules":{const[e,s]=i.split("-");t.options.sre.domain=e,t.options.sre.style=s;break}case"magnification":switch(i){case"None":t.options.a11y.magnification=i,t.options.a11y.keyMagnifier=!1,t.options.a11y.mouseMagnifier=!1;break;case"Keyboard":t.options.a11y.magnification=i,t.options.a11y.keyMagnifier=!0,t.options.a11y.mouseMagnifier=!1;break;case"Mouse":t.options.a11y.magnification=i,t.options.a11y.keyMagnifier=!1,t.options.a11y.mouseMagnifier=!0}break;case"highlight":switch(i){case"None":t.options.a11y.highlight=i,t.options.a11y.hover=!1,t.options.a11y.flame=!1;break;case"Hover":t.options.a11y.highlight=i,t.options.a11y.hover=!0,t.options.a11y.flame=!1;break;case"Flame":t.options.a11y.highlight=i,t.options.a11y.hover=!1,t.options.a11y.flame=!0}break;case"locale":t.options.sre.locale=i;break;default:t.options.a11y[e]=i}}Dr("EXPLORER",u.INSERTED+30),MathJax.loader&&MathJax.loader.checkVersion("a11y/explorer",Bs,"a11y"),Hs({_:{a11y:{explorer_ts:Ps,explorer:{Explorer:Rs,ExplorerPool:Ds,Highlighter:Ls,KeyExplorer:ks,MouseExplorer:Os,Region:Ss,TreeExplorer:Ms}}}}),MathJax.startup&&Vs&&MathJax.startup.extendHandler(t=>Cb(t)),Zs.preLoaded("a11y/sre","a11y/semantic-enrich","a11y/speech","a11y/explorer"),Zs.preLoaded("core","input/tex","output/svg","ui/menu"),Zs.saveVersion("tex-svg-nofont"),Jd.loadFont(function(t){return Zs.load(...er.load).then(()=>(t||function(){})()).then(()=>er.ready()).catch(t=>er.failed(t))},"svg",Gd,void 0)})()})();