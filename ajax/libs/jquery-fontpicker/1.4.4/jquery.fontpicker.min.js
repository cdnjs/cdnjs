...
b[d]).text(b[d]).on("click",function(){c(this).toggleClass("checked");a.applyFilter()}).appendTo(this.$filter)},getFontsList:function(){function a(g,l){var k=b.allFonts[g][l],p="";if(k){if(k.category||k.variants)p=[],k.category&&p.push(k.category),b.options.variants&&k.variants&&(k=k.variants.split(",").length,1<k&&p.push(k+" "+b.dictionary.styles)),p=" <small>"+p.join(", ")+"</small>";f=c("<li>",{"data-font-type":g,"data-font-family":l}).html(l+p);d.append(f[0])}}var b=this,d=c(document.createDocumentFragment()),
