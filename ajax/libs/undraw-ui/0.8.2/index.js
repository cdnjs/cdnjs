...
function revDeepTree(e = [], { parentId: n = "parentId", children: t = "children" }) {
  const o = [], a = (r, _) => {
    r.forEach((s) => {
      s.id || (s.id = _++), s[n] = _, o.push(s), s[t] && isArray(s[t]) && a(s[t], s.id);
    });
  };
  return a(e || [], null), o;
}
...
function useBrowser() {
  ...
  const _ = n.indexOf("android") > 0 ? "android" : navigator.platform.toLowerCase();
  let s = "full";
  ...
  var _ = {
    ...
    _assignPluginFnProp: function(i, v) {
      ...
      this[v] = function() {
        ...
        function m() {
          if (!!l)
            return each$6(arguments, function(w, g) {
              u[g] = w;
            }), l.apply(d, u);
        }
        var p = [m].concat(u);
...
function toFormData(e) {
  ...
  return Object.keys(e).forEach((t) => {
    const o = e[t];
    Array.isArray(o) ? o.forEach((a, r) => n.append(t + `[${r}]`, a)) : n.append(t, e[t]);
  }), n;
}
...
const base = "", elAvatar = "", elButton = "", elImage = "", elImageViewer = "", elPopover = "", elPopper = "", elDialog = "", elOverlay = "", elTag = "", elCarousel = "", elScrollbar = "", elInput = "", elPagination = "", elOption = "", elOptionGroup = "", elSelect = "", _withScopeId$e = (e) => (pushScopeId("data-v-8d75907e"), e = e(), popScopeId(), e), _hoisted_1$l = { class: "comment-box" }, _hoisted_2$i = {
  ...
  setup(e, { expose: n, emit: t }) {
    const o = e, a = ref(""), r = ref(!1), _ = ref(!0), s = ref(), i = ref(), v = ref(), l = ref([]), c = ref([]), u = reactive({
      imgLength: 0
    }), d = (y) => {
      isEmpty(a.value.replace(/&nbsp;|<br>| /g, "")) ? _.value = !0 : _.value = !1;
    }, m = inject(InjectionCommentFun), p = inject(InjectionEmojiApi), w = () => {
      m({
    ...
    function x(y) {
      return window.URL ? window.URL.createObjectURL(y) : window.webkitURL ? window.webkitURL.createObjectURL(y) : "";
    }
    const E = (y) => {
      var C;
      ...
      if (u.imgLength = isNull($ == null ? void 0 : $.length, 0), $)
        for (let b = 0; b < $.length; b++) {
          let B = $[b].name, F = x($[b]);
          c.value.push($[b]), isImage(B) ? l.value.push(F) : UToast({ type: "warning", message: "\u8BF7\u9009\u62E9\u56FE\u7247\u7C7B\u578B\u6587\u4EF6!", duration: 2500 });
        }
    };
    return (y, $) => {
      const C = resolveComponent("u-editor"), b = resolveComponent("u-emoji");
          ...
          default: withCtx(() => [
            r.value ? (openBlock(), createElementBlock("div", _hoisted_2$i, [
              createVNode(b, {
                ...
                onAddEmoji: $[1] || ($[1] = (B) => {
                  var F;
                  return (F = s.value) == null ? void 0 : F.addText(B);
                })
              }, null, 8, ["emoji"]),
              createElementVNode("div", {
                ...
                onClick: $[2] || ($[2] = (...B) => {
                  var F, V;
                  return ((F = v.value) == null ? void 0 : F.click) && ((V = v.value) == null ? void 0 : V.click(...B));
                })
              }, [
                _hoisted_3$g,
                _hoisted_4$e,
  ...
  setup(e, { emit: n }) {
    ...
    ), (r, _) => (openBlock(), createBlock(unref(ElDialog), {
      modelValue: o.value,
...
const _hoisted_1$i = {
...
}), icon_vue_vue_type_style_index_0_scoped_b823a48c_lang = "", iconVue = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["__scopeId", "data-v-b823a48c"]]), UIcon = withInstall(iconVue), _hoisted_1$h = { class: "v-toast" }, _hoisted_2$f = { class: "inner" }, _hoisted_3$e = { class: "message" }, __default__$c = {
  name: "UToast"
  ...
  setup(e) {
    ...
    }), (a, r) => (openBlock(), createElementBlock("div", _hoisted_1$h, [
...
const _withScopeId$c = (e) => (pushScopeId("data-v-f23dcd5a"), e = e(), popScopeId(), e), _hoisted_1$g = ["placeholder", "onKeydown", "innerHTML"], _hoisted_2$e = ["src"], _hoisted_3$d = ["onClick"], _hoisted_4$c = /* @__PURE__ */ _withScopeId$c(() => /* @__PURE__ */ createElementVNode("svg", {
  ...
  setup(e, { expose: n, emit: t }) {
    ...
    const a = ref(), r = ref(), _ = ref(), s = ref(!1), i = ref(!1), v = ref(), { imgList: l } = toRefs(o), c = computed(() => o.minHeight + "px"), u = computed(() => o.minHeight == 30 ? "4px 10px" : "8px 12px");
    watch(
      () => o.modelValue,
      (y) => {
        s.value || (_.value = y);
    ...
    function m(y) {
      var $, C;
      a.value = ($ = window.getSelection()) == null ? void 0 : $.getRangeAt(0), t("blur", y), (C = r.value) != null && C.innerHTML || (i.value = !1), s.value = !1;
    }
    function p(y) {
    ...
    function w(y) {
      ...
      if ($) {
        $.removeAllRanges(), a.value || ((C = r.value) == null || C.focus(), a.value = $.getRangeAt(0)), a.value.deleteContents(), a.value.insertNode(a.value.createContextualFragment(y)), a.value.collapse(!1), $.addRange(a.value), t("update:modelValue", ((b = r.value) == null ? void 0 : b.innerHTML) || "");
        const B = r.value;
        t("input", B);
      }
    }
    ...
    return onMounted(() => {
      var y;
      (y = r.value) == null || y.addEventListener("keyup", ($) => {
        const C = $.target;
      ...
      focus: k,
      imageRef: v
    }), (y, $) => (openBlock(), createElementBlock("div", {
      ...
      createElementVNode("div", {
        ...
        (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(l), (C, b) => (openBlock(), createElementBlock("div", {
          key: b,
          class: "image-preview"
        }, [
  ...
  setup(e) {
    ...
    return onMounted(() => {
      ...
      _.disconnect();
    }), (s, i) => (openBlock(), createElementBlock("div", _hoisted_1$f, [
      createElementVNode("div", {
  ...
  setup(e, { expose: n, emit: t }) {
    const o = e, a = reactive({
      ...
      p ? p != a.password ? w("\u8F93\u5165\u5BC6\u7801\u4E0D\u4E00\u81F4") : w() : w("\u8BF7\u786E\u8BA4\u5BC6\u7801");
    ...
    function u() {
      a.type = o.modelValue, s.value.validate((m) => {
        m && t("submit", a);
      });
    }
    function d() {
      ...
      return openBlock(), createBlock(unref(ElForm), {
        ...
        default: withCtx(() => [
          createVNode(unref(ElFormItem), { prop: "email" }, {
            default: withCtx(() => [
              createVNode(unref(ElInput), {
                ...
                placeholder: "\u8BF7\u8F93\u5165\u90AE\u7BB1",
                onFocus: p[1] || (p[1] = (g) => m.$emit("toggle", 1)),
                onBlur: p[2] || (p[2] = (g) => m.$emit("toggle", 0))
              }, null, 8, ["modelValue"])
            ]),
            _: 1
          }),
          createVNode(unref(ElFormItem), { prop: "password" }, {
            default: withCtx(() => [
              createVNode(unref(ElInput), {
                ...
                placeholder: "\u8BF7\u8F93\u5165\u5BC6\u7801",
                onFocus: p[4] || (p[4] = (g) => m.$emit("toggle", 2)),
                onBlur: p[5] || (p[5] = (g) => m.$emit("toggle", 0))
              }, null, 8, ["modelValue"])
            ]),
            _: 1
          }),
          withDirectives(createVNode(unref(ElFormItem), { prop: "checkPass" }, {
            default: withCtx(() => [
              createVNode(unref(ElInput), {
                ...
                placeholder: "\u8BF7\u786E\u8BA4\u5BC6\u7801",
                onFocus: p[7] || (p[7] = (g) => m.$emit("toggle", 2)),
                onBlur: p[8] || (p[8] = (g) => m.$emit("toggle", 0))
              }, null, 8, ["modelValue"])
            ]),
            _: 1
          }, 512), [
          ...
          createVNode(unref(ElFormItem), null, {
            default: withCtx(() => [
              createElementVNode("div", {
                onClick: p[9] || (p[9] = (g) => m.$emit("update:modelValue", c.one.key))
              }, toDisplayString(c.one.value), 1),
              createElementVNode("div", {
                onClick: p[10] || (p[10] = (g) => m.$emit("update:modelValue", c.two.key))
  ...
  src: _imports_2,
  alt: ""
}, _hoisted_6$9 = /* @__PURE__ */ createTextVNode("\u5176\u4ED6\u65B9\u5F0F\u767B\u5F55"), _hoisted_7$8 = { class: "sign-oauth" }, __default__$9 = {
  name: "USign"
            ...
            createElementVNode("ul", _hoisted_1$d, [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(s), (u, d) => (openBlock(), createElementBlock(Fragment, { key: d }, [
                u.show ? (openBlock(), createElementBlock("li", {
                  ...
                  onClick: (m) => v.$emit("submit", d, unref(i))
                }, [
                  createVNode(c, {
                    innerHTML: u.icon
                  }, null, 8, ["innerHTML"]),
  ...
  setup(e, { emit: n }) {
    const t = e, o = ref(), a = ref(), r = toRef(t, "modelValue"), _ = ref(0), s = reactive({
      x: 0,
      y: 0
    });
    watch(
        ...
        if (d) {
          if (u.length > d.length) {
            ...
            r.value.forEach((p, w, g) => {
              g.findIndex((k) => k.meta.title == p.meta.title) != w && g.splice(w, 1);
            }), _.value = r.value.findIndex((p) => p.meta.title == (m == null ? void 0 : m.meta.title));
          }
        } else {
          let m = 1;
          r.value.forEach((p, w, g) => {
            g.findIndex((k) => k.meta.title == p.meta.title) != w && (g.splice(w, 1), _.value = g.findIndex((k) => k.meta.title == p.meta.title), m = 0);
        ...
        createVNode(unref(ElScrollbar), {
          ...
          default: withCtx(() => [
            createElementVNode("ul", {
              ...
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.modelValue, (p, w) => (openBlock(), createElementBlock("li", {
                key: w,
                class: normalizeClass([{ "is-active": _.value == w }, "u-tabs-ul-li"]),
                onClick: (g) => _.value = w,
                onContextmenu: withModifiers((g) => c(p, g), ["prevent"])
              }, [
                createElementVNode("span", _hoisted_3$a, toDisplayString(p.meta.title), 1),
                p.meta.isAffix ? createCommentVNode("", !0) : (openBlock(), createBlock(m, {
                  key: 0,
  ...
  setup(e) {
    const n = e, t = reactive({
      ...
      twoTime: 0,
      order: 1
    }), o = ref({}), a = ref({}), r = computed(() => n.delay > 2e3 ? n.delay : 2e3), _ = () => {
      nextTick(() => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        e.vertical ? (openBlock(), createElementBlock("div", _hoisted_1$b, [
          createVNode(unref(ElCarousel), {
            ...
            default: withCtx(() => [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (m) => (openBlock(), createBlock(u, { key: m }, {
                default: withCtx(() => [
  ...
  setup(e) {
    ...
    return onMounted(() => {
      var i;
      n.target ? a.value = document.querySelector(n.target) : a.value = window, o.value = (i = document.querySelector(n.container)) == null ? void 0 : i.querySelectorAll("h1, h2, h3, h4, h5, h6"), a.value.addEventListener("scroll", _);
    }), onUnmounted(() => {
    ...
    return (t, o) => {
      ...
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1$9, [
        e.data.historySearchList.length != 0 ? (openBlock(), createElementBlock("div", _hoisted_2$8, [
          ...
          (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data.historySearchList, (r, _) => (openBlock(), createBlock(unref(ElTag), {
            key: _,
            type: r.type,
            closable: "",
        ...
        createElementVNode("div", _hoisted_7$7, [
          ...
          createElementVNode("div", _hoisted_11$2, [
            (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data.hotSearchList, (r, _) => (openBlock(), createElementBlock("div", {
              key: _,
              class: "hot-item",
              onClick: (s) => t.$emit("submit", r)
            }, [
              createElementVNode("div", {
                class: normalizeClass(["trending-rank", { "trending-rank-top": _ < 3 }])
              }, toDisplayString(_ + 1), 3),
  ...
  emits: ["submit"],
  setup(e, { emit: n }) {
    const t = e, o = ref({}), a = toRef(t.config, "keywords"), r = ref(!1), _ = ref(0), s = ref(!0), i = ref(), v = reactive({
    ...
    const c = computed(() => {
      ...
      let x = typeof a.value[_.value + 1] > "u" ? a.value[0] : a.value[_.value + 1];
      return r.value || l.search ? "" : x;
    }), d = computed(() => {
      let x = a.value[_.value];
      return r.value ? x : "";
    }), m = computed(() => !r.value && !l.search && s.value), p = (x) => {
      let E = ($, C) => Math.round(Math.random() * (C - $)) + $, y = ($) => l.historySearchList.filter((C) => C.name == $).length != 0;
      if (x && l.historySearchList)
        y(x) || l.historySearchList.push({ name: x, type: v.types[E(0, 3)] });
      else {
        let $ = r.value ? d : c;
        x = $.value, y($.value) || l.historySearchList.push({ name: $.value, type: v.types[E(0, 3)] });
      }
  ...
  setup(e, { expose: n }) {
    ...
    }), (r, _) => (openBlock(), createElementBlock("div", _hoisted_1$7, [
      createVNode(unref(ElScrollbar), {
        ref_key: "scrollbarRef",
        ref: o
      }, {
  ...
  emits: ["submit"],
  setup(e, { emit: n }) {
    const t = e, o = ref(!1), a = ref(""), r = ref(), _ = (l) => {
      ...
      let c = document.getElementById("emojiInput"), u = c.selectionStart, d = c.selectionEnd, m = c.value;
      if (u === null || d === null)
        return;
  ...
  emits: ["addEmoji"],
  setup(e, { emit: n }) {
    const t = e, o = ref(0), a = ref(0), r = ref(new Array(2)), { emojiList: _, faceList: s } = t.emoji;
    function i(l) {
      switch (o.value = l, l) {
        case 0:
          a.value = 0;
                ...
                createVNode(unref(ElScrollbar), null, {
                  default: withCtx(() => [
                    createElementVNode("div", _hoisted_6$4, [
                      (openBlock(!0), createElementBlock(Fragment, null, renderList(u, (m, p) => (openBlock(), createElementBlock("span", {
                        key: p,
                        class: "emoji-item",
                        onClick: (w) => l.$emit("addEmoji", p)
                      }, [
  ...
  setup(e, { emit: n }) {
    const t = e, o = reactive({
      ...
      c += "";
      let u = c.split("."), d = u[0], m = u.length > 1 ? t.decimalSeparator + u[1] : "", p = !isNaN(parseFloat(t.separator));
      if (t.separator && !p)
        for (; l.test(d); )
    ...
    return (l, c) => (openBlock(), createElementBlock("span", null, toDisplayString(unref(_)), 1));
  }
  ...
  setup(e) {
    const n = e, { getUser: t } = inject(InjectionContentBox), o = () => {
      t(n.uid, () => {
      });
    };
    return (a, r) => (openBlock(), createElementBlock("div", null, [
  ...
  setup(e) {
    const n = e, t = ref(!1), o = ref(), { user: a, report: r, remove: _ } = inject(InjectionContentBox), s = () => {
      var l;
...
}), operation_vue_vue_type_style_index_0_lang = "", operation_vue_vue_type_style_index_1_scoped_24364064_lang = "", Operation = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-24364064"]]), _withScopeId$2 = (e) => (pushScopeId("data-v-23929f46"), e = e(), popScopeId(), e), _hoisted_1$3 = ["href"], _hoisted_2$2 = /* @__PURE__ */ _withScopeId$2(() => /* @__PURE__ */ createElementVNode("img", { src: "https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png" }, null, -1)), _hoisted_3$2 = { class: "comment-main" }, _hoisted_4$2 = { class: "user-box" }, _hoisted_5$2 = ["href"], _hoisted_6$2 = { class: "username" }, _hoisted_7$2 = {
  class: "name",
  ...
  setup(e) {
    ...
    }), { allEmoji: _ } = inject(InjectionEmojiApi), { like: s, user: i, isUserInfo: v } = inject(InjectionContentBox), l = (m) => {
      switch (m) {
        case 1:
          return '<svg viewBox="0 0 1682 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="831"><path d="M219.428571 73.142857h1243.428572a146.285714 146.285714 0 0 1 146.285714 146.285714v585.142858a146.285714 146.285714 0 0 1-146.285714 146.285714H219.428571a146.285714 146.285714 0 0 1-146.285714-146.285714V219.428571a146.285714 146.285714 0 0 1 146.285714-146.285714z" fill="#8CDBF4" p-id="832"></path><path d="M219.428571 292.571429h146.285715v512H219.428571z m365.714286 146.285714h146.285714l146.285715 365.714286h-146.285715z" fill="#FFFFFF" p-id="833"></path><path d="M1024 438.857143h-146.285714l-146.285715 365.714286h146.285715zM219.428571 658.285714h365.714286v146.285715H219.428571z m950.857143-365.714285l73.142857-73.142858v146.285715h-73.142857z m73.142857-73.142858h146.285715v146.285715h-146.285715z m0 146.285715h146.285715v438.857143h-146.285715z" fill="#FFFFFF"></path></svg>';
        case 2:
      ...
      createElementVNode("div", _hoisted_3$2, [
            ...
            default: withCtx(() => [
              createElementVNode("a", {
                ...
                createElementVNode("div", _hoisted_6$2, [
                  createElementVNode("span", _hoisted_7$2, toDisplayString(e.data.user.username), 1),
        ...
        createElementVNode("div", _hoisted_11, [
          createVNode(unref(UFold), { unfold: "" }, {
            default: withCtx(() => [
              createElementVNode("div", { innerHTML: unref(d) }, null, 8, _hoisted_12),
              createElementVNode("div", _hoisted_13, [
                (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(r), (w, g) => (openBlock(), createBlock(unref(ElImage), {
                  key: g,
                  src: w,
        ...
        createElementVNode("div", _hoisted_14, [
          createElementVNode("div", {
            class: "item",
            onClick: p[0] || (p[0] = (w) => unref(s)(unref(str)(e.data.id)))
          }, [
...
}), contentBox_vue_vue_type_style_index_0_scoped_23929f46_lang = "", ContentBox = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-23929f46"]]), _withScopeId$1 = (e) => (pushScopeId("data-v-8b5ba87b"), e = e(), popScopeId(), e), _hoisted_1$2 = {
  key: 0,
  class: "reply-box"
  ...
  setup(e) {
    const n = e, t = reactive({
      ...
      pageNum: 1,
      pageSize: 5
    }), { replyPage: o, showSize: a, page: r, comments: _ } = inject(InjectionReply), s = computed(() => {
      let u = {
        total: 0,
        length: 0,
        list: []
    ...
    return (u, d) => unref(s).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
      createElementVNode("div", _hoisted_2$1, [
        (openBlock(!0), createElementBlock(Fragment, null, renderList(unref(s).list, (m, p) => (openBlock(), createBlock(ContentBox, {
          key: p,
          "parent-id": e.parentId,
          data: m,
          small: ""
  ...
  setup(e, { emit: n }) {
    const t = e, o = useSlots(), { user: a, comments: r } = toRefs(t.config), _ = (l) => {
      ...
      n("submit", { content: c, parentId: u, files: d, finish: (p) => {
        if (l.finish(), l.parentId) {
          ...
          if (w) {
            let g = w.reply;
            g ? (g.list.unshift(p), g.total++) : w.reply = {
              total: 1,
              list: [p]
            };
          }
      ...
      const c = (m, p) => {
        ...
        r.value.forEach((g) => {
          var k;
          g.id != m ? w = (k = g.reply) == null ? void 0 : k.list.find((x) => x.id == m) : w = g, w && (w.likes += p);
        });
      ...
      remove: (l, c, u) => n("remove", l, () => {
        if (u(), c) {
          let d = r.value.find((p) => p.id == c), m = d == null ? void 0 : d.reply;
          if (m) {
    ...
    return provide(InjectionCommentFun, _), provide(InjectionEmojiApi, t.config.emoji), provide(InjectionReply, i), provide(InjectionContentBox, v), (l, c) => (openBlock(), createElementBlock("div", _hoisted_1, [
