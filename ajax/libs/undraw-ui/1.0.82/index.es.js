import { h as Ie, render as kt, reactive as ie, defineComponent as Z, ref as L, inject as re, withDirectives as _e, openBlock as v, createElementBlock as b, createVNode as S, unref as w, normalizeClass as G, createElementVNode as i, toDisplayString as j, createCommentVNode as P, createBlock as Q, withCtx as T, createTextVNode as fe, nextTick as ke, pushScopeId as de, popScopeId as pe, computed as ee, renderSlot as ve, resolveComponent as ue, watch as he, createSlots as Mt, useCssVars as Re, normalizeStyle as ze, onMounted as be, Transition as ot, vShow as Se, withKeys as Ce, withModifiers as Me, Fragment as se, renderList as ce, toRefs as We, onBeforeUnmount as St, onUnmounted as De, toRef as st, vModelText as Lt, provide as ge, useSlots as zt, mergeProps as Ft } from "vue";
import { ElButton as je, ClickOutside as at, ElLink as lt, ElInfiniteScroll as It, ElDialog as Tt, ElScrollbar as Ue, ElEmpty as Ht, ElForm as Bt, ElFormItem as Fe, ElInput as Ve, ElCarousel as At, ElTag as Et, ElAvatar as Ze, ElPopover as it, ElImage as rt, ElPagination as Vt } from "element-plus";
import { ElAvatar as h2, ElButton as m2, ElCarousel as _2, ElDialog as g2, ElDropdown as y2, ElDropdownItem as w2, ElDropdownMenu as $2, ElEmpty as b2, ElImage as x2, ElInput as C2, ElLink as k2, ElPagination as M2, ElPopover as S2, ElScrollbar as L2, ElTag as z2, ElInfiniteScroll as F2 } from "element-plus";
/*! UndrawUi v1.0.8 */
function ct(e) {
...
function we(e) {
  return ct(e) ? e.length === 0 : Dt(e) ? Object.keys(e).length === 0 : e === "" || e === void 0 || e === null;
}
...
function s2(e, o = { parentId: "parentId", children: "children" }) {
...
function a2(e = [], o = { parentId: "parentId", children: "children" }) {
  let n = $e(o.parentId, "parentId"), t = $e(o.children, "children");
  const a = [], s = (u, r) => {
    u.forEach((g) => {
      g.id || (g.id = r++), g[n] = r, a.push(g), g[t] && ct(g[t]) && s(g[t], g.id);
    });
  };
  return s(e || [], null), a;
}
const l2 = (e, o = 1 / 0) => e.flat(o), ae = (e, o) => {
  if (e.install = (n) => {
...
function i2() {
  ...
  const g = !!navigator.userAgent.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/), _ = (o.match(/[\s\S]+(?:rv|it|ra|ie)[\/: ]([\d.]+)/) || [])[1], m = t === "pc", l = !m, $ = r === "xs" || l, d = window.innerHeight + "px";
  return {
    version: _,
    type: n,
    plat: u,
...
function Ot(e, o) {
  ...
  return document.body.append(t), kt(n, t), { vnode: n, div: t };
}
function Rt(e) {
  try {
    e && e.remove();
...
const Pe = (e) => e ? "localStorage" : "sessionStorage", Ut = (e, o, n = !0) => {
  (o === "" || o === null || o === void 0) && (o = null), window[Pe(n)].setItem(e, JSON.stringify(o));
}, Pt = (e, o = !0) => {
  let n;
  const t = window[Pe(o)].getItem(e);
  return t && (n = JSON.parse(t)), n;
}, Yt = (e, o = !0) => {
  window[Pe(o)].removeItem(e);
}, Nt = (e = !0) => {
  window[Pe(e)].clear();
}, Ee = {
  set: Ut,
...
(function(e, o) {
  (function(n, t) {
    ...
    var n = 1e3, t = 6e4, a = 36e5, s = "millisecond", u = "second", r = "minute", g = "hour", _ = "day", m = "week", l = "month", $ = "quarter", d = "year", c = "date", p = "Invalid Date", V = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, H = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, Y = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(x) {
      var h = ["th", "st", "nd", "rd"], f = x % 100;
      return "[" + x + (h[(f - 20) % 10] || h[f] || h[0]) + "]";
    } }, ne = function(x, h, f) {
      var k = String(x);
      return !k || k.length >= h ? x : "" + Array(h + 1 - k.length).join(f) + x;
    }, B = { s: ne, z: function(x) {
      var h = -x.utcOffset(), f = Math.abs(h), k = Math.floor(f / 60), y = f % 60;
      return (h <= 0 ? "+" : "-") + ne(k, 2, "0") + ":" + ne(y, 2, "0");
    }, m: function x(h, f) {
      if (h.date() < f.date())
        return -x(f, h);
      var k = 12 * (f.year() - h.year()) + (f.month() - h.month()), y = h.clone().add(k, l), F = f - y < 0, I = h.clone().add(k + (F ? -1 : 1), l);
      return +(-(k + (f - y) / (F ? y - I : I - y)) || 0);
    }, a: function(x) {
      return x < 0 ? Math.ceil(x) || 0 : Math.floor(x);
    }, p: function(x) {
      return { M: l, y: d, w: m, d: _, D: c, h: g, m: r, s: u, ms: s, Q: $ }[x] || String(x || "").toLowerCase().replace(/s$/, "");
    }, u: function(x) {
      return x === void 0;
    } }, E = "en", M = {};
    M[E] = Y;
    ...
    U.l = N, U.i = A, U.w = function(x, h) {
      return W(x, { locale: h.$L, utc: h.$u, x: h.$x, $offset: h.$offset });
    };
    var me = function() {
      function x(f) {
      ...
      return h.parse = function(f) {
        this.$d = function(k) {
          ...
          if (typeof y == "string" && !/Z$/i.test(y)) {
            var I = y.match(V);
            if (I) {
              var R = I[2] - 1 || 0, C = (I[7] || "0").substring(0, 3);
              return F ? new Date(Date.UTC(I[1], R, I[3] || 1, I[4] || 0, I[5] || 0, I[6] || 0, C)) : new Date(I[1], R, I[3] || 1, I[4] || 0, I[5] || 0, I[6] || 0, C);
            }
          }
          return new Date(y);
        ...
        return U.u(f) ? this[k] : this.set(y, f);
      }, h.unix = function() {
        return Math.floor(this.valueOf() / 1e3);
      }, h.valueOf = function() {
        return this.$d.getTime();
      }, h.startOf = function(f, k) {
        var y = this, F = !!U.u(k) || k, I = U.p(f), R = function(te, oe) {
          var ye = U.w(y.$u ? Date.UTC(y.$y, oe, te) : new Date(y.$y, oe, te), y);
          return F ? ye : ye.endOf(_);
        }, C = function(te, oe) {
          return U.w(y.toDate()[te].apply(y.toDate("s"), (F ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(oe)), y);
        ...
        switch (I) {
          ...
          case m:
            var X = this.$locale().weekStart || 0, le = (z < X ? z + 7 : z) - X;
        ...
        var y, F = U.p(f), I = "set" + (this.$u ? "UTC" : ""), R = (y = {}, y[_] = I + "Date", y[c] = I + "Date", y[l] = I + "Month", y[d] = I + "FullYear", y[g] = I + "Hours", y[r] = I + "Minutes", y[u] = I + "Seconds", y[s] = I + "Milliseconds", y)[F], C = F === _ ? this.$D + (k - this.$W) : k;
        if (F === l || F === d) {
        ...
        if (I === m)
          return R(7);
        var C = (y = {}, y[r] = t, y[g] = a, y[u] = n, y)[I] || 1, z = this.$d.getTime() + f * C;
        return U.w(z, this);
        ...
        var F = f || "YYYY-MM-DDTHH:mm:ssZ", I = U.z(this), R = this.$H, C = this.$m, z = this.$M, O = y.weekdays, q = y.months, K = function(oe, ye, Be, Ae) {
          return oe && (oe[ye] || oe(k, F)) || Be[ye].slice(0, Ae);
        }, X = function(oe) {
          return U.s(R % 12 || 12, oe, "0");
        }, le = y.meridiem || function(oe, ye, Be) {
          var Ae = oe < 12 ? "AM" : "PM";
          return Be ? Ae.toLowerCase() : Ae;
        }, te = { YY: String(this.$y).slice(-2), YYYY: this.$y, M: z + 1, MM: U.s(z + 1, 2, "0"), MMM: K(y.monthsShort, z, q, 3), MMMM: K(q, z), D: this.$D, DD: U.s(this.$D, 2, "0"), d: String(this.$W), dd: K(y.weekdaysMin, this.$W, O, 2), ddd: K(y.weekdaysShort, this.$W, O, 3), dddd: O[this.$W], H: String(R), HH: U.s(R, 2, "0"), h: X(1), hh: X(2), a: le(R, C, !0), A: le(R, C, !1), m: String(C), mm: U.s(C, 2, "0"), s: String(this.$s), ss: U.s(this.$s, 2, "0"), SSS: U.s(this.$ms, 3, "0"), Z: I };
        return F.replace(H, function(oe, ye) {
          return ye || te[oe] || I.replace(":", "");
        });
      }, h.utcOffset = function() {
        return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
      }, h.diff = function(f, k, y) {
        var F, I = U.p(k), R = W(f), C = (R.utcOffset() - this.utcOffset()) * t, z = this - R, O = U.m(this, R);
        return O = (F = {}, F[d] = O / 12, F[l] = O, F[$] = O / 3, F[m] = (z - C) / 6048e5, F[_] = (z - C) / 864e5, F[g] = z / a, F[r] = z / t, F[u] = z / n, F)[I] || z, y ? O : U.a(O);
    ...
    }), W.extend = function(x, h) {
      return x.$i || (x(h, me, W), x.$i = !0), W;
...
(function(e, o) {
  (function(n, t) {
    ...
    return function(n, t, a) {
      ...
      function r(_, m, l, $) {
        return s.fromToBase(_, m, l, $);
      }
      a.en.relativeTime = u, s.fromToBase = function(_, m, l, $, d) {
        for (var c, p, V, H = l.$locale().relativeTime || u, Y = n.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], ne = Y.length, B = 0; B < ne; B += 1) {
          ...
          if (V = c > 0, M <= E.r || !E.r) {
            M <= 1 && B > 0 && (E = Y[B - 1]);
            var A = H[E.l];
            d && (M = d("" + M)), p = typeof A == "string" ? A.replace("%d", M) : A(M, m, E.l, V);
            break;
          }
        }
        if (m)
...
const Gt = {
  ...
  locale: "zh",
  messages: Gt
}), Xt = (e) => (e = tt.locale + "." + e, e.split(".").reduce((o, n) => o[n] || "", tt.messages));
const Ye = Symbol(), ht = Symbol(), Ge = Symbol(), qe = Symbol(), Qt = (e) => (de("data-v-4063c007"), e = e(), pe(), e), e1 = { class: "comment-box" }, t1 = {
  key: 0,
  class: "action-box"
}, n1 = /* @__PURE__ */ Qt(() => /* @__PURE__ */ i("svg", {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
...
], -1)), o1 = { class: "btn-box" }, s1 = /* @__PURE__ */ Z({
  __name: "input-box",
  props: {
    placeholder: {},
    contentBtn: {},
  ...
  setup(e, { expose: o, emit: n }) {
    const t = e, a = L(""), s = L(!1), u = L(!0), r = L(), g = L(), _ = L(), m = L([]), l = L([]), $ = ie({
      imgLength: 0
    }), d = (x) => {
      l.value = x;
    }, c = (x) => {
      we(a.value.replace(/&nbsp;|<br>| /g, "")) ? u.value = !0 : u.value = !1;
    }, { upload: p, submit: V, focus: H } = re(ht), Y = re(He), ne = () => {
      V({
      ...
      r.value.clear(), m.value.length = 0, l.value = [], u.value = !0;
    };
    function A(x) {
    ...
    o({
      ...
      changeMentionShow: (x) => {
        var h;
        return (h = r.value) == null ? void 0 : h.changeMentionShow(x);
      },
      AddMention: W
    });
    const U = (x, h) => {
      ...
      const f = h ? [h] : (k = _.value) == null ? void 0 : k.files;
      if ($.imgLength = $e(f == null ? void 0 : f.length, 0), f)
        for (let y = 0; y < f.length; y++) {
          let F = f[y].name, I = Wt(f[y]);
          l.value.push(f[y]), qt(F) ? m.value.push(I) : Xe({ type: "warn", message: "请选择图片类型文件!", duration: 2500 });
        }
    }, me = re(Ye), D = () => Ie("div", me.func());
    return (x, h) => _e((v(), b("div", e1, [
      S(w(yt), {
        ref_key: "editorRef",
        ref: r,
        modelValue: a.value,
        "onUpdate:modelValue": h[0] || (h[0] = (f) => a.value = f),
        class: G({ "input-active": s.value }),
        placeholder: t.placeholder,
        "min-height": 64,
        "img-list": m.value,
        onClick: h[1] || (h[1] = () => s.value = !0),
        onFocus: N,
        onInput: c,
        onSubmit: ne,
        onPaste: U,
      ...
      s.value ? (v(), b("div", t1, [
        ...
        w(p) ? (v(), b("div", {
          ...
          (...f) => {
            var k, y;
            return ((k = _.value) == null ? void 0 : k.click) && ((y = _.value) == null ? void 0 : y.click(...f));
          })
        }, [
          n1,
...
const J = (e, o) => {
  ...
  for (const [t, a] of o)
    n[t] = a;
  return n;
}, mt = /* @__PURE__ */ J(s1, [["__scopeId", "data-v-4063c007"]]), a1 = { class: "u-comment-scroll" }, l1 = ["infinite-scroll-disabled"], i1 = { class: "scroll-btn" }, r1 = { key: 1 }, c1 = { key: 2 }, u1 = /* @__PURE__ */ Z({
  name: "UCommentScroll",
  ...
  emits: ["more"],
  setup(e, { emit: o }) {
    const n = e, t = L(!1), a = L(!1), s = ee(() => a.value && n.disable), u = ee(() => !a.value || t.value || s.value), r = ut(() => {
      o("more"), t.value = !1;
    }, 500), g = () => {
      t.value = !0, r();
    };
    return (_, m) => (v(), b("div", a1, [
      _e((v(), b("div", {
        ...
        i("div", i1, [
          a.value ? P("", !0) : (v(), Q(w(lt), {
            ...
            default: T(() => [
              fe(j(_.$u("scroll.content")), 1)
            ]),
            _: 1
          })),
          t.value ? (v(), b("p", r1, j(_.$u("scroll.loading")), 1)) : P("", !0),
          s.value ? (v(), b("p", c1, j(_.$u("scroll.noMore")), 1)) : P("", !0)
        ])
      ], 8, l1)), [
        [w(It), g]
      ])
...
const d1 = /* @__PURE__ */ J(u1, [["__scopeId", "data-v-8a24b42e"]]), p1 = ae(d1), _t = (e) => (de("data-v-f99158ef"), e = e(), pe(), e), f1 = { class: "nav" }, v1 = { class: "nav__title" }, h1 = { class: "nav__sort" }, m1 = /* @__PURE__ */ _t(() => /* @__PURE__ */ i("svg", {
  width: "12",
  height: "12",
  viewBox: "0 0 12 12",
  fill: "none",
...
], -1)), _1 = /* @__PURE__ */ _t(() => /* @__PURE__ */ i("svg", {
  width: "12",
  height: "12",
  viewBox: "0 0 12 12",
  fill: "none",
...
const y1 = /* @__PURE__ */ J(g1, [["__scopeId", "data-v-f99158ef"]]), w1 = ae(y1), gt = (e) => (de("data-v-59596f14"), e = e(), pe(), e), $1 = {
  key: 0,
  width: "16",
  height: "16",
  viewBox: "0 0 1024 1024",
  xmlns: "http://www.w3.org/2000/svg"
}, b1 = /* @__PURE__ */ gt(() => /* @__PURE__ */ i("path", {
  fill: "currentColor",
  ...
  viewBox: "0 0 1024 1024",
  xmlns: "http://www.w3.org/2000/svg"
}, k1 = /* @__PURE__ */ gt(() => /* @__PURE__ */ i("path", {
  fill: "currentColor",
    ...
    return he(
      ...
      default: T(() => [
        i("div", {
          ...
          a.value ? (v(), b("svg", $1, x1)) : (v(), b("svg", C1, M1))
        ]),
...
const L1 = /* @__PURE__ */ J(S1, [["__scopeId", "data-v-59596f14"]]), z1 = ae(L1), F1 = { class: "field" }, I1 = /* @__PURE__ */ Z({
  name: "UDivider",
  __name: "divider",
  props: {
...
const T1 = /* @__PURE__ */ J(I1, [["__scopeId", "data-v-153d9bc7"]]), H1 = ae(T1), B1 = [
  {
    type: "success",
    options: {
      color: "#67c23a",
...
const D1 = {
  ...
  setup(e) {
    ...
    return (a, s) => (v(), b("i", {
      ...
      a.$slots.default ? ve(a.$slots, "default", { key: 0 }, void 0, !0) : (v(), b("svg", D1, [
        i("use", { "xlink:href": n.value }, null, 8, j1)
      ]))
    ], 4));
  }
});
const R1 = /* @__PURE__ */ J(O1, [["__scopeId", "data-v-dd34e834"]]), Le = ae(R1), U1 = { class: "v-toast" }, P1 = { class: "inner" }, Y1 = { class: "message" }, N1 = /* @__PURE__ */ Z({
  name: "UToast",
  __name: "index",
  props: {
    message: { default: "" },
...
const q1 = /* @__PURE__ */ J(N1, [["__scopeId", "data-v-7d3c50e0"]]);
function Xe(e) {
  let o = e.duration;
  if (!e.message)
    return;
...
const W1 = ["onKeydown"], Z1 = ["onClick"], K1 = { class: "userInfo" }, J1 = ["src"], G1 = { class: "username" }, X1 = { class: "empty" }, Q1 = /* @__PURE__ */ Z({
  __name: "mentionList",
  props: {
  ...
  setup(e, { expose: o, emit: n }) {
    ...
    return be(() => {
      ...
      S(w(Ue), {
        ...
        default: T(() => [
          (v(!0), b(se, null, ce(l.list, (d, c) => (v(), b("li", {
            key: c,
            class: G({ hover: c === s.value }),
            onClick: (p) => _(c)
          }, [
            ve(l.$slots, "user", {
              item: d,
              ...
              i("div", K1, [
                ...
                i("span", G1, j(d.userName), 1)
              ])
            ], !0)
          ], 10, Z1))), 128)),
          _e(i("div", X1, [
            S(w(Ht), { description: "暂无匹配数据" })
          ], 512), [
            [Se, !l.list.length]
          ])
        ]),
...
const en = /* @__PURE__ */ J(Q1, [["__scopeId", "data-v-14aad4a8"]]), tn = (e) => (de("data-v-06f46233"), e = e(), pe(), e), nn = ["placeholder", "onKeydown", "innerHTML"], on = ["src"], sn = ["onClick"], an = /* @__PURE__ */ tn(() => /* @__PURE__ */ i("svg", {
  "data-v-48a7e3c5": "",
  "data-v-7c7c7498": "",
  width: "12",
  height: "12",
  ...
  setup(e, { expose: o, emit: n }) {
    ...
    const l = re("mentionConfig"), $ = re("changeMetionList"), d = re("mentionSearch"), c = L(), p = L(), V = L(), H = L(!1), Y = L(!1), ne = L(), { imgList: B } = We(t), E = ee(() => t.minHeight + "px"), M = ee(() => t.minHeight == 30 ? "4px 10px" : "8px 12px"), A = L("");
    he(
      () => t.modelValue,
      (C, z) => {
        var q;
    ...
    function me(C) {
      ...
      n("update:modelValue", z), n("input", C), I();
    }
    function D(C, z) {
      var q, K;
    ...
    const y = (C) => {
      if (C.ctrlKey && C.key == "Enter")
        we(t.modelValue.replace(/&nbsp;|<br>| /g, "")) ? Xe({ message: "内容不能为空", type: "info" }) : n("submit");
      ...
      var z;
      (z = B == null ? void 0 : B.value) == null || z.splice(C, 1), n("changeImgListFn", Oe(B == null ? void 0 : B.value));
    }, I = (C) => {
      var z;
      p.value && (c.value = (z = p == null ? void 0 : p.value.ownerDocument.getSelection()) == null ? void 0 : z.getRangeAt(0));
    };
    be(() => {
      p != null && p.value && p.value.addEventListener("mousemove", I);
    }), St(() => {
      p != null && p.value && p.value.removeEventListener("mousemove", I);
    }), o({
      addText: D,
      clear: h,
      focus: f,
  ...
  `, X = document.createElement("div");
      X.style.visibility = "hidden", X.innerHTML = K, document.body.appendChild(X);
      const le = X.querySelector("text");
      let te = 200;
      le && (te = le.getComputedTextLength()), document.body.removeChild(X);
      const oe = `
    ...
    return (C, z) => {
      ...
      return v(), b("div", {
        ...
        i("div", {
          ...
          (v(!0), b(se, null, ce(w(B), (K, X) => (v(), b("div", {
            key: X,
            class: "image-preview"
          }, [
            i("img", {
        ...
        S(en, {
          ...
          "is-show": s.value,
          position: u.value,
          list: (O = w(l)) == null ? void 0 : O.userArr,
          "show-avatar": (q = w(l)) == null ? void 0 : q.showAvatar,
          onInsert: k,
          onChangeShow: r
...
const cn = /* @__PURE__ */ J(rn, [["__scopeId", "data-v-06f46233"]]), yt = ae(cn);
const un = { class: "u-fold" }, dn = { class: "action-box select-none" }, pn = /* @__PURE__ */ Z({
  name: "UFold",
  __name: "fold",
  props: {
    line: { default: 5 },
  ...
  setup(e) {
    ...
    return be(() => {
      ...
      i("div", dn, [
        a.value && g.unfold ? (v(), b("div", {
          key: 0,
          class: "expand-btn",
          onClick: _[0] || (_[0] = (m) => t.value = !t.value)
        }, j(t.value ? g.$u("fold.unfold") : g.$u("fold.fold")), 1)) : P("", !0)
      ])
    ]));
  }
});
const fn = /* @__PURE__ */ J(pn, [["__scopeId", "data-v-6812aafd"]]), wt = ae(fn), vn = /* @__PURE__ */ Z({
  __name: "form",
  props: {
    modelValue: {}
  },
      ...
      (c) => {
        switch (ke(() => d()), c) {
          ...
          case "register":
            ...
            break;
          case "forget":
            g.value = m, l.type = "修改密码", l.one = { key: "login", value: "邮箱登录" }, l.two = { key: "", value: "" };
            break;
        }
      },
      { immediate: !0 }
...
const hn = /* @__PURE__ */ J(vn, [["__scopeId", "data-v-525985f8"]]), mn = { class: "u-sign" }, _n = { class: "sign-oauth" }, gn = /* @__PURE__ */ Z({
  name: "USign",
  __name: "sign",
  emits: ["submit"],
  setup(e, { emit: o }) {
    ...
    return (u, r) => {
      const g = ue("u-divider"), _ = ue("u-icon"), m = ue("u-dialog");
      return v(), b("div", mn, [
        S(w(je), {
          link: "",
...
const yn = /* @__PURE__ */ J(gn, [["__scopeId", "data-v-8e737450"]]), wn = ae(yn), $n = (e) => (de("data-v-3a07e116"), e = e(), pe(), e), bn = { class: "custom-contextmenu__menu" }, xn = ["onClick"], Cn = /* @__PURE__ */ $n(() => /* @__PURE__ */ i("div", { class: "arrow" }, null, -1)), kn = /* @__PURE__ */ Z({
  __name: "context-menu",
  props: {
    dropdown: {}
  },
  ...
  setup(e, { expose: o, emit: n }) {
    ...
    const { isShow: u, dropdownList: r, tag: g } = We(t);
    return o({
      openContextmenu: a
    }), (_, m) => {
      const l = ue("u-icon");
      return v(), Q(ot, { name: "el-zoom-in-center" }, {
        default: T(() => [
          _e(i("div", {
            ...
            i("ul", bn, [
              (v(!0), b(se, null, ce(w(r), ($, d) => (v(), b(se, { key: d }, [
                $.show ? (v(), b("li", {
                  key: 0,
                  class: "item select-none",
                  onClick: (c) => _.$emit("submit", d, w(g))
                }, [
                  S(l, {
                    innerHTML: $.icon
                  }, null, 8, ["innerHTML"]),
...
const Mn = /* @__PURE__ */ J(kn, [["__scopeId", "data-v-3a07e116"]]), Sn = (e) => (de("data-v-f7d57bb4"), e = e(), pe(), e), Ln = { class: "u-tabs" }, zn = ["onClick", "onContextmenu"], Fn = { class: "select-none" }, In = /* @__PURE__ */ Sn(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  xmlns: "http://www.w3.org/2000/svg"
}, [
  /* @__PURE__ */ i("path", {
  ...
  setup(e, { emit: o }) {
    const n = e, t = L(), a = L(), s = st(n, "modelValue"), u = L(0), r = ie({
      x: 0,
      y: 0
    });
    he(
    ...
    return ($, d) => {
      ...
      return v(), b("div", Ln, [
        S(w(Ue), {
          ...
          default: T(() => [
            i("ul", {
              class: G([{ "classic-style": $.classic }, "u-tabs-ul"])
            }, [
              (v(!0), b(se, null, ce($.modelValue, (p, V) => (v(), b("li", {
                key: V,
                class: G([{ "is-active": u.value == V }, "u-tabs-ul-li"]),
                onClick: (H) => u.value = V,
                onContextmenu: Me((H) => l(p, H), ["prevent"])
              }, [
                i("span", Fn, j(p.meta.title), 1),
                p.meta.isAffix ? P("", !0) : (v(), Q(c, {
                  key: 0,
                  onClick: Me((H) => m(1, p), ["stop"])
                }, {
                  default: T(() => [
                    In
                  ]),
...
const Hn = /* @__PURE__ */ J(Tn, [["__scopeId", "data-v-f7d57bb4"]]), Bn = ae(Hn), An = { key: 0 }, En = /* @__PURE__ */ Z({
  name: "UNoticeBar",
  __name: "notice-bar",
  props: {
    data: {},
  ...
  setup(e) {
    ...
    return be(() => {
      ...
      const $ = ue("el-carousel-item"), d = ue("u-icon");
      return v(), b("div", {
        class: "u-notice-bar",
        style: ze({ background: m.background, height: `${m.height}px` })
      }, [
        m.vertical ? (v(), b("div", An, [
          S(w(At), {
            height: "40px",
            direction: "vertical",
            autoplay: !0,
            ...
            default: T(() => [
              (v(!0), b(se, null, ce(m.data, (c) => (v(), Q($, { key: c }, {
                default: T(() => [
                  fe(j(c), 1)
                ]),
                _: 2
...
const Vn = /* @__PURE__ */ J(En, [["__scopeId", "data-v-723bc558"]]), Dn = ae(Vn), jn = (e) => (de("data-v-11b4e56c"), e = e(), pe(), e), On = { class: "u-anchor" }, Rn = { class: "toc-content" }, Un = /* @__PURE__ */ jn(() => /* @__PURE__ */ i("h3", { class: "toc-content-heading" }, "目录", -1)), Pn = { class: "toc-items" }, Yn = ["onClick"], Nn = /* @__PURE__ */ Z({
  name: "UAnchor",
  __name: "anchor",
  props: {
    container: {},
  ...
  setup(e) {
    const o = e, n = L(0), t = L({}), a = L({}), s = (_) => {
      ...
      console.log(m), o.scroll ? a.value.scrollTo({
        top: m.offsetTop - o.targetOffset,
        behavior: "smooth"
    ...
    return be(() => {
      ...
      return v(), b("div", On, [
        i("nav", Rn, [
          ...
          S(l),
          i("ul", Pn, [
            (v(!0), b(se, null, ce(t.value, ($, d) => (v(), b("li", {
              key: d,
              class: G([{ active: n.value == d }, s($.nodeName)]),
              onClick: (c) => r(d)
            }, j($.innerText), 11, Yn))), 128))
          ])
        ])
      ]);
    };
...
const qn = /* @__PURE__ */ J(Nn, [["__scopeId", "data-v-11b4e56c"]]), Wn = ae(qn), Te = (e) => (de("data-v-c739035a"), e = e(), pe(), e), Zn = { class: "card-box u-scrollbar" }, Kn = {
  key: 0,
  class: "history"
...
], -1)), oo = { class: "hot-list" }, so = ["onClick"], ao = { class: "trending-text u-ellipsis" }, lo = /* @__PURE__ */ Te(() => /* @__PURE__ */ i("div", { class: "trending-mark" }, null, -1)), io = /* @__PURE__ */ Z({
  __name: "card-box",
  props: {
    data: {}
  },
  ...
  setup(e, { emit: o }) {
    ...
    return (a, s) => {
      const u = ue("u-icon");
      return _e((v(), b("div", Zn, [
        a.data.historySearchList.length != 0 ? (v(), b("div", Kn, [
          i("div", Jn, [
            Gn,
            S(w(lt), {
              underline: !1,
          ...
          (v(!0), b(se, null, ce(a.data.historySearchList, (r, g) => (v(), Q(w(Et), {
            key: g,
            type: r.type,
            closable: "",
        ...
        w(we)(a.data.hotSearchList) ? P("", !0) : (v(), b("div", Qn, [
          i("div", eo, [
            to,
          ...
          i("div", oo, [
            (v(!0), b(se, null, ce(a.data.hotSearchList, (r, g) => (v(), b("div", {
              key: g,
              class: "hot-item",
              onClick: (_) => a.$emit("submit", r)
            }, [
              i("div", {
                class: G(["trending-rank", { "trending-rank-top": g < 3 }])
              }, j(g + 1), 3),
              i("div", ao, j(r), 1),
              lo
            ], 8, so))), 128))
...
const ro = /* @__PURE__ */ J(io, [["__scopeId", "data-v-c739035a"]]), Qe = (e) => (de("data-v-df2be5d9"), e = e(), pe(), e), co = { class: "u-search" }, uo = { style: { display: "flex", "align-items": "center", "padding-left": "8px" } }, po = /* @__PURE__ */ Qe(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "p-id": "7187"
...
], -1)), fo = ["data-before", "data-after"], vo = ["placeholder"], ho = { class: "btn" }, mo = /* @__PURE__ */ Qe(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  xmlns: "http://www.w3.org/2000/svg",
  "data-v-78e17ca8": ""
}, [
...
], -1)), _o = /* @__PURE__ */ Qe(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "p-id": "738"
  ...
  emits: ["submit"],
  setup(e, { expose: o, emit: n }) {
    const t = e, a = L({}), s = st(t.config, "keywords"), u = L(!1), r = L(0), g = L(!0), _ = L(), m = ie({
      types: ["success", "info", "warning", "danger"]
      //搜索历史tag样式
    }), l = ie({
      search: t.config.search || "",
      visible: !1,
      historySearchList: Ee.get("searchHistory") || [],
      // 历史搜索数据
    ...
    const $ = ee(() => {
      ...
      if (B != null && B.trim() != "") {
        ...
        if (B && l.historySearchList)
          M(B) || l.historySearchList.unshift({ name: B, type: m.types[E(0, 3)] });
        else {
          let A = u.value ? c : $;
          B = A.value, M(A.value) || l.historySearchList.unshift({ name: A.value, type: m.types[E(0, 3)] });
        }
        Ee.set("searchHistory", l.historySearchList);
      }
      ...
      l.historySearchList.length = 0, Ee.remove("searchHistory");
    }, ne = (B) => {
    ...
    return o({
      ...
      return v(), b("div", co, [
        ...
        _e(S(ro, {
          ...
          [w(at), () => l.visible = !1, _.value]
        ])
      ]);
    };
  }
});
const yo = /* @__PURE__ */ J(go, [["__scopeId", "data-v-df2be5d9"]]), wo = ae(yo), $t = (e, o) => {
  const n = /\[.+?\]/g;
...
}, bt = (e) => (de("data-v-f75472b5"), e = e(), pe(), e), bo = { class: "message" }, xo = { class: "chat-list" }, Co = /* @__PURE__ */ bt(() => /* @__PURE__ */ i("img", { src: "https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png" }, null, -1)), ko = { class: "content" }, Mo = {
  key: 0,
  class: "username"
}, So = ["innerHTML"], Lo = /* @__PURE__ */ bt(() => /* @__PURE__ */ i("div", { class: "date" }, null, -1)), zo = /* @__PURE__ */ Z({
  __name: "message",
  props: {
    data: {},
    userId: {}
  ...
  setup(e, { expose: o }) {
    ...
    return o({
      ...
      S(w(Ue), {
        ...
        default: T(() => [
          i("div", xo, [
            (v(!0), b(se, null, ce(s.data, (r, g) => (v(), b("div", {
              key: g,
              class: G([{ self: s.userId == r.id }, "chat-item"])
            }, [
              i("div", null, [
                S(w(Ze), null, {
                  default: T(() => [
              ...
              i("div", ko, [
                s.userId != r.id ? (v(), b("div", Mo, j(r.username), 1)) : P("", !0),
                i("div", {
                  class: "card-box",
                  innerHTML: w($t)(w(n), r.content)
                }, null, 8, So)
              ]),
              Lo
            ], 2))), 128))
...
const Fo = /* @__PURE__ */ J(zo, [["__scopeId", "data-v-f75472b5"]]), Ne = (e) => (de("data-v-18726a6b"), e = e(), pe(), e), Io = { class: "u-chat" }, To = { class: "header" }, Ho = /* @__PURE__ */ Ne(() => /* @__PURE__ */ i("svg", {
...
], -1)), Vo = /* @__PURE__ */ Ne(() => /* @__PURE__ */ i("svg", {
  ...
  emits: ["submit"],
  setup(e, { emit: o }) {
    const n = e, t = L(!1), a = L(""), s = L(), u = (m) => {
      const { ctrlKey: l, key: $ } = m;
      l && $ == "Enter" && g();
    }, r = () => {
      a.value = "", s.value.scroll();
    }, g = () => {
      let m = a.value;
      m.trim() ? (m = m.replace(/\n/g, "<br/>"), o("submit", { clear: r, content: m })) : Xe({ type: "error", message: "内容不能为空" });
    }, _ = (m) => {
      let l = document.getElementById("emojiInput"), $ = l.selectionStart, d = l.selectionEnd, c = l.value;
      if ($ === null || d === null)
        return;
      let p = c.substring(0, $) + m + c.substring(d);
      l.value = p, l.focus(), l.selectionStart = $ + m.length, l.selectionEnd = $ + m.length, a.value = p;
    };
    return ge(He, n.emoji), (m, l) => {
      const $ = ue("u-icon"), d = ue("u-emoji");
      return v(), b("div", Io, [
        i("div", {
...
const jo = /* @__PURE__ */ J(Do, [["__scopeId", "data-v-18726a6b"]]), Oo = ae(jo), Ro = (e) => (de("data-v-146b85ab"), e = e(), pe(), e), Uo = { class: "u-emoji" }, Po = { class: "face-tooltip-head select-none" }, Yo = ["onClick"], No = ["src"], qo = { class: "emoji-body select-none" }, Wo = { style: { padding: "0 5px" } }, Zo = ["onClick"], Ko = { class: "emoji-btn select-none" }, Jo = { key: 0 }, Go = /* @__PURE__ */ Ro(() => /* @__PURE__ */ i("svg", {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
  ...
  setup(e, { emit: o }) {
    ...
    return (m, l) => (v(), b("div", Uo, [
      S(w(it), {
        ...
        reference: T(() => [
          i("div", Ko, [
            m.$slots.default ? ve(m.$slots, "default", { key: 1 }, void 0, !0) : (v(), b("div", Jo, [
              Go,
              i("span", null, j(m.$u("emoji.content")), 1)
            ]))
          ])
        ]),
        default: T(() => [
          i("div", Po, [
            (v(!0), b(se, null, ce(w(r), ($, d) => (v(), b("label", {
              key: d,
              class: G(t.value == d ? "active" : ""),
              onClick: (c) => g(d)
            }, [
              i("img", {
                src: $,
          ...
          i("div", qo, [
            i("div", {
              ...
              (v(!0), b(se, null, ce(s.value, ($, d) => (v(), b("div", {
                key: d,
                class: "emoji-wrapper"
              }, [
                S(w(Ue), null, {
                  default: T(() => [
                    i("div", Wo, [
                      (v(!0), b(se, null, ce($, (c, p) => (v(), b("span", {
                        key: p,
                        class: "emoji-item",
                        onClick: (V) => m.$emit("addEmoji", p)
                      }, [
                        S(w(rt), {
                          src: c,
                          title: String(p),
...
const Qo = /* @__PURE__ */ J(Xo, [["__scopeId", "data-v-146b85ab"]]), He = Symbol(), xt = ae(Qo), es = /* @__PURE__ */ Z({
  name: "UCounter",
  __name: "counter",
  props: {
  ...
  setup(e, { emit: o }) {
    ...
    return (m, l) => (v(), b("span", null, j(u.value), 1));
  }
}), ts = ae(es), nt = /* @__PURE__ */ Z({
  __name: "user-card",
  props: {
    uid: {}
  },
  setup(e) {
    const o = L({}), { showInfo: n } = re(Ge), t = re(Ye), a = () => Ie("div", t.card(o.value));
    return (s, u) => w(t).card ? (v(), Q(w(it), {
      key: 0,
      placement: "top",
      width: 300,
      "show-after": 300,
      onBeforeEnter: u[0] || (u[0] = () => w(n)(s.uid, (r) => o.value = r))
    }, {
      reference: T(() => [
        ve(s.$slots, "default")
      ]),
      ...
      _: 3
    })) : ve(s.$slots, "default", { key: 1 });
  }
}), et = (e) => (de("data-v-9c0cdb8d"), e = e(), pe(), e), ns = { class: "comment-sub" }, os = ["href", "target"], ss = { key: 0 }, as = {
  key: 1,
  src: "https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png"
}, ls = { class: "comment-primary" }, is = { class: "comment-main" }, rs = { class: "user-info" }, cs = ["href", "target"], us = { class: "username" }, ds = {
  class: "name",
  ...
  class: "imgbox",
  style: { display: "flex" }
}, gs = { class: "action-box select-none" }, ys = /* @__PURE__ */ et(() => /* @__PURE__ */ i("svg", {
  t: "1650360973068",
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
...
], -1)), ws = /* @__PURE__ */ et(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "p-id": "1534"
...
], -1)), $s = { key: 2 }, bs = /* @__PURE__ */ et(() => /* @__PURE__ */ i("svg", {
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
  "p-id": "1320",
  ...
  setup(e) {
    ...
    }), { allEmoji: u } = re(He), { like: r, user: g, relativeTime: _, aTarget: m, showLevel: l, showLikes: $, showAddress: d, showHomeLink: c, showReply: p } = re(
      Ge
    );
    function V() {
    ...
    const Y = re(Ye), ne = () => Ie("div", Y.info(o.data)), B = () => Ie("div", Y.operate(o.data)), E = ee(() => $t(u, o.data.content));
    return (M, A) => (v(), b("div", {
      class: G(["comment", { reply: o.reply }])
    }, [
      i("div", ns, [
        S(nt, {
          uid: w(xe)(M.data.uid)
          ...
          default: T(() => [
            i("a", {
              ...
              target: w(m),
              class: G([{ "pointer-events-none": !w(c) }, "no-underline"]),
              style: { display: "block" }
            }, [
              S(w(Ze), {
                ...
                default: T(() => [
                  M.data.user.avatar ? (v(), b("span", ss, j(M.data.user.username), 1)) : (v(), b("img", as))
                ]),
                _: 1
              }, 8, ["src"])
            ], 10, os)
      ...
      i("div", ls, [
        i("div", is, [
          i("div", rs, [
            S(nt, {
              ...
              default: T(() => [
                i("a", {
                  ...
                  i("div", us, [
                    i("span", ds, j(M.data.user.username), 1),
                    w(l) ? (v(), b("span", ps, [
                      S(w(Le), {
                        size: "24",
                        innerHTML: w($o)(M.data.user.level || 1)
                      }, null, 8, ["innerHTML"])
                    ])) : P("", !0)
                  ])
                ], 10, cs)
            ...
            w(d) ? (v(), b("span", fs, "   " + j(M.data.address), 1)) : P("", !0),
            w(Y).info ? (v(), Q(ne, { key: 1 })) : P("", !0),
            i("time", vs, j(w(_) ? w(Je)(M.data.createTime).fromNow() : M.data.createTime), 1)
          ]),
          i("div", hs, [
            S(w(wt), { unfold: "" }, {
              default: T(() => [
                i("div", { innerHTML: E.value }, null, 8, ms),
                i("div", _s, [
                  (v(!0), b(se, null, ce(s.value, (N, W) => (v(), Q(w(rt), {
                    key: W,
                    src: N,
          ...
          i("div", gs, [
            w($) ? (v(), b("div", {
              key: 0,
              class: "item",
              onClick: A[0] || (A[0] = (N) => w(r)(w(xe)(M.data.id)))
            }, [
              w(g).likeIds && w(g).likeIds.map(String).indexOf(w(xe)(M.data.id)) == -1 ? (v(), Q(w(Le), { key: 0 }, {
                default: T(() => [
                  ys
                ]),
                _: 1
              ...
              M.data.likes != 0 ? (v(), b("span", $s, j(M.data.likes), 1)) : P("", !0)
            ])) : P("", !0),
            w(p) ? (v(), b("div", {
              key: 1,
              ref_key: "btnRef",
...
const Ct = /* @__PURE__ */ J(Cs, [["__scopeId", "data-v-9c0cdb8d"]]), ks = (e) => (de("data-v-1368df76"), e = e(), pe(), e), Ms = {
  key: 0,
  class: "reply-box"
  ...
  setup(e) {
    const o = e, n = ie({
      ...
      currentPage: 1,
      pageSize: 5
    }), { replyPage: t, replyShowSize: a, comments: s } = re(qe), { page: u } = re(qe), r = ee(() => {
      let d = {
        total: 0,
        length: 0,
        list: []
    ...
    return (d, c) => r.value.length > 0 ? (v(), b("div", Ms, [
      i("div", Ss, [
        (v(!0), b(se, null, ce(r.value.list, (p, V) => (v(), Q(Ct, {
          id: d.id,
          key: V,
          data: p,
          reply: ""
        }, null, 8, ["id", "data"]))), 128)),
        r.value.length > w(a) ? (v(), b("div", Ls, [
          n.loading ? (v(), b("span", zs, j(d.$u("comment.more.loading")), 1)) : (v(), b("div", Fs, [
            n.over ? P("", !0) : (v(), b("div", Is, [
              i("span", {
                class: "fetch-more-comment select-none",
                onClick: g
              }, [
                fe(j(d.$u("comment.more.prefixTotal")) + j(r.value.total) + j(d.$u("comment.more.suffixTotal")) + " ", 1),
                Ts
              ])
            ]))
          ]))
        ])) : P("", !0),
        n.over && w(u) ? (v(), b("div", Hs, [
          S(w(Vt), {
            small: "",
            "hide-on-single-page": "",
...
const As = /* @__PURE__ */ J(Bs, [["__scopeId", "data-v-1368df76"]]), Es = {
  key: 0,
  class: "comment-list"
}, Vs = /* @__PURE__ */ Z({
  __name: "comment-list",
  ...
  setup(e) {
    return (o, n) => o.data ? (v(), b("div", Es, [
      (v(!0), b(se, null, ce(o.data, (t) => (v(), Q(Ct, {
        id: w(xe)(t.id),
        key: w(xe)(t.id),
        data: t
      }, {
...
const Ds = { class: "u-comment" }, js = {
  key: 0,
  class: "comment-form"
}, Os = { class: "header" }, Rs = { class: "header-title" }, Us = { class: "content" }, Ps = { class: "avatar-box" }, Ys = { key: 0 }, Ns = {
  key: 1,
  src: "https://cube.elemecdn.com/e/fd/0fc7d20532fdaf769a25683617711png.png"
}, qs = {
  key: 1,
  class: "comment-list-wrapper"
}, Ws = { class: "title" }, Zs = /* @__PURE__ */ Z({
  name: "UComment",
  __name: "comment",
  props: {
    config: {},
  ...
  setup(e, { expose: o, emit: n }) {
    const t = e, {
      ...
      showReply: c = !0,
      mentionConfig: p
    } = We(t.config), V = ({ content: D, parentId: x, reply: h, files: f, clear: k }) => {
      const y = (F) => {
        if (k(), F)
          if (x) {
            let I = s.value.find((R) => R.id == x);
            if (I) {
              let R = I.reply;
              R ? (R.list.unshift(F), R.total++) : I.reply = {
                total: 1,
                list: [F]
              };
            }
      ...
      n("submit", { content: D, parentId: x, reply: h, files: f, mentionList: N.value, finish: y });
    }, H = {
      upload: t.upload,
      submit: V,
      focus: () => n("focus")
    };
    ge(ht, H), ge("cancelFn", () => n("cancel"));
    const Y = (D, x) => {
      let h = null;
      s.value.forEach((f) => {
        var k;
        if (f.id == D)
          ...
          let y = (k = f.reply) == null ? void 0 : k.list.find((F) => F.id == D);
          y && (h = y);
        }
      }), h && !we(h.likes) && (h.likes += x);
    }, B = {
      user: a,
      like: (D) => {
        const x = t.config.user.likeIds;
        x && n("like", D, () => {
          if (x.findIndex((h) => h == D) == -1)
            x.push(D), Y(D, 1);
          else {
            let h = x.findIndex((f) => f == D);
            h != -1 && (x.splice(h, 1), Y(D, -1));
          }
        });
      },
    ...
    const E = {
      page: t.page,
      replyPage: (D, x, h, f) => {
        n("replyPage", { parentId: D, pageNum: x, pageSize: h, finish: f });
      },
    ...
    ge(qe, E);
    const M = (D) => {
      const { parentId: x, id: h } = D;
      if (x) {
        let f = s.value.find((y) => y.id == x), k = f == null ? void 0 : f.reply;
        if (k) {
          let y = k.list.findIndex((F) => F.id == h);
          y != -1 && (k.list.splice(y, 1), k.total--);
        }
      } else {
        let f = s.value.findIndex((k) => k.id == h);
    ...
    return ge(He, t.config.emoji), ge("mentionConfig", p), ge(Ye, zt()), ge("changeMetionList", W), ge("mentionSearch", me), o({
      remove: M,
      mentionList: N,
      getMentionList: U,
      setMentionShow: (D) => {
      ...
      w(g) ? (v(), b("div", js, [
        ve(D.$slots, "header", {}, () => [
          i("div", Os, [
            i("span", Rs, j(D.$u("comment.headerTitle")), 1)
          ])
        ], !0),
        i("div", Us, [
          i("div", Ps, [
            S(w(Ze), {
              ...
              default: T(() => [
                D.config.user.username ? (v(), b("span", Ys, j(D.config.user.username), 1)) : (v(), b("img", Ns))
              ]),
              _: 1
            }, 8, ["src"])
          ]),
      ...
      w(_) ? (v(), b("div", qs, [
        ve(D.$slots, "default", {}, () => [
          i("div", Ws, j(D.$u("comment.title")), 1)
        ], !0),
        S(Vs, { data: w(s) }, null, 8, ["data"])
      ])) : P("", !0)
    ]));
  }
});
const Ks = /* @__PURE__ */ J(Zs, [["__scopeId", "data-v-2e53a9cd"]]), Js = ae(Ks), Gs = [
  Js,
  p1,
  w1,
  z1,
...
const Xs = (e) => {
  Gs.forEach((o) => {
    e.use(o);
  }), e.config.globalProperties.$u = Xt;
}, p2 = {
  install: Xs
};
export {
