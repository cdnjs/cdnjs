...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".sakana-widget-canvas{pointer-events:none;position:absolute}.sakana-widget-box{pointer-events:none;position:absolute;left:0;right:0;top:0;bottom:0;display:flex;flex-direction:column;justify-content:space-between;align-items:center}.sakana-widget-main{pointer-events:auto;background:no-repeat 50% 50%;background-size:cover;cursor:pointer}.sakana-widget-main--chisato{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ")}.sakana-widget-main--takina{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")}.sakana-widget-ctrl{pointer-events:auto;height:24px;width:120px;cursor:pointer;display:flex;border-radius:4px;background-color:#ddd;box-shadow:0 8px 24px rgba(0,0,0,.1)}.sakana-widget-ctrl-item{height:24px;width:30px;display:flex;justify-content:center;align-items:center;color:#555;background-color:rgba(0,0,0,0)}.sakana-widget-ctrl-item:hover{color:#555;background-color:rgba(255,255,255,.25)}.sakana-widget-icon{height:18px;width:18px}.sakana-widget-icon--rotate{animation:sakana-widget-spin 2s linear infinite}@keyframes sakana-widget-spin{100%{transform:rotate(360deg)}}", ""]);
// Exports
...
function SakanaWidget(options = {}) {
  ...
  const appSize = options.appSize || 200;
  const mainSize = appSize / 1.25;
  const strokeColor = options.strokeColor || "#b4b4b4";
  const initialValues = {
  ...
  const node = container.cloneNode();
  ...
  main.style.transformOrigin = `50% ${appSize}px`;
  ...
  const draw = () => {
    ...
    ctx.save();
    ctx.translate(appSize / 2, appSize);
  ...
  const triggetMagic = () => {
    ...
    if (magicForceEnabled) {
      magicForceTimeout = setTimeout(magicForce, Math.random() * 1e3 + 500);
    }
  };
