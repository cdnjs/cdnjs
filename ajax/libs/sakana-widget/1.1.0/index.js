(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SakanaWidget", [], factory);
	else if(typeof exports === 'object')
		exports["SakanaWidget"] = factory();
	else
		root["SakanaWidget"] = factory();
})(self, () => {
...
/* harmony export */ });
/* harmony import */ var _node_modules_pnpm_css_loader_6_7_1_webpack_5_74_0_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(204);
...
/* harmony import */ var _node_modules_pnpm_css_loader_6_7_1_webpack_5_74_0_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(415);
...
/* harmony import */ var _node_modules_pnpm_css_loader_6_7_1_webpack_5_74_0_node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(902);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(524), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(8), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".sakana-widget-canvas{pointer-events:none;position:absolute}.sakana-widget-main{pointer-events:none;position:absolute;left:0;right:0;top:0;bottom:0;display:flex;flex-direction:column;justify-content:space-between;align-items:center}.sakana-widget-img{pointer-events:auto;cursor:pointer;background:no-repeat 50% 50%;background-size:cover}.sakana-widget-img--chisato{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ")}.sakana-widget-img--takina{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")}.sakana-widget-ctrl{pointer-events:auto;height:24px;width:120px;cursor:pointer;display:flex;border-radius:4px;background-color:#ddd;box-shadow:0 8px 24px rgba(0,0,0,.1)}.sakana-widget-ctrl-item{height:24px;width:30px;display:flex;justify-content:center;align-items:center;color:#555;background-color:rgba(0,0,0,0)}.sakana-widget-ctrl-item:hover{color:#555;background-color:rgba(255,255,255,.25)}.sakana-widget-icon{height:18px;width:18px}.sakana-widget-icon--rotate{animation:sakana-widget-spin 2s linear infinite}@keyframes sakana-widget-spin{100%{transform:rotate(360deg)}}", ""]);
// Exports
...
// EXTERNAL MODULE: ./node_modules/.pnpm/css-loader@6.7.1_webpack@5.74.0/node_modules/css-loader/dist/cjs.js!./node_modules/.pnpm/sass-loader@13.0.2_sass@1.54.5+webpack@5.74.0/node_modules/sass-loader/dist/cjs.js!./src/index.scss
var cjs_js_src = __webpack_require__(951);
...
function cloneDeepPolyfill(src) {
  const map = /* @__PURE__ */ new Map();
  function _cloneDeep(src2) {
    if (src2 && typeof src2 === "object") {
      if (map.has(src2)) {
        return map.get(src2);
      }
      const ret2 = Array.isArray(src2) ? [] : {};
      map.set(src2, ret2);
      for (const key of Object.keys(src2)) {
        ret2[key] = _cloneDeep(src2[key]);
      }
      return ret2;
    } else {
      return src2;
...
function SakanaWidget(options = {}) {
  ...
  let running = true;
  const values = cloneDeep(initialValues[character]);
  let maxR = size / 5;
  if (maxR < 30) {
    maxR = 30;
  } else if (maxR > 60) {
  ...
  img.style.transformOrigin = `50% ${size}px`;
  ...
  const calcCenterPoint = (degree, radius, x, y) => {
  ...
  const triggetMagic = () => {
    ...
    const icon = magic.querySelector("svg");
