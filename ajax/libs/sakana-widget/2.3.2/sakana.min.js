(function(J,A){typeof exports=="object"&&typeof module=="object"?module.exports=A():typeof define=="function"&&define.amd?define("SakanaWidget",[],A):typeof exports=="object"?exports.SakanaWidget=A():J.SakanaWidget=A()})(self,()=>(()=>{"use strict";var te={868:(p,d,h)=>{h.d(d,{Z:()=>y});var C=h(30),l=h.n(C),i=h(762),o=h.n(i),u=o()(l());u.push([p.id,".sakana-widget *,.sakana-widget *::before,.sakana-widget *::after{box-sizing:border-box}.sakana-widget-wrapper{pointer-events:none;position:relative;width:100%;height:100%}.sakana-widget-app{pointer-events:none;position:relative}.sakana-widget-canvas{z-index:10;pointer-events:none;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%)}.sakana-widget-main{z-index:20;pointer-events:none;position:absolute;display:flex;flex-direction:column;justify-content:space-between;align-items:center}.sakana-widget-img{z-index:40;cursor:move;pointer-events:auto;position:relative;background:no-repeat 50% 50%;background-size:cover}.sakana-widget-ctrl{z-index:30;cursor:pointer;pointer-events:auto;position:relative;height:24px;width:112px;display:flex;border-radius:4px;background-color:#ddd;box-shadow:0 8px 24px rgba(0,0,0,.1)}.sakana-widget-ctrl-item{height:24px;width:28px;display:flex;justify-content:center;align-items:center;color:#555;background-color:rgba(0,0,0,0)}.sakana-widget-ctrl-item:hover{color:#555;background-color:rgba(255,255,255,.25)}.sakana-widget-icon{height:18px;width:18px}.sakana-widget-icon--rotate{animation:sakana-widget-spin 2s linear infinite}@keyframes sakana-widget-spin{100%{transform:rotate(360deg)}}","",{version:3,sources:["webpack://./src/index.scss","webpack://./node_modules/.pnpm/dsr-design@3.5.1/node_modules/dsr-design/scss/variables.scss"],names:[],mappings:"AAQE,kEAGE,qBAAA,CAGF,uBACE,mBAAA,CACA,iBAAA,CACA,UAAA,CACA,WAAA,CAGF,mBACE,mBAAA,CACA,iBAAA,CAGF,sBACE,UAAA,CACA,mBAAA,CACA,iBAAA,CACA,OAAA,CACA,QAAA,CACA,+BAAA,CAGF,oBACE,UAAA,CACA,mBAAA,CACA,iBAAA,CACA,YAAA,CACA,qBAAA,CACA,6BAAA,CACA,kBAAA,CAGF,mBACE,UAAA,CACA,WAAA,CACA,mBAAA,CACA,iBAAA,CACA,4BAAA,CACA,qBAAA,CAGF,oBACE,UAAA,CACA,cAAA,CACA,mBAAA,CACA,iBAAA,CACA,WAAA,CACA,WAAA,CACA,YAAA,CACA,iBC9Ce,CD+Cf,qBA5Da,CA6Db,oCA3DkB,CA4DlB,yBACE,WAAA,CACA,UAAA,CACA,YAAA,CACA,sBAAA,CACA,kBAAA,CACA,UArEO,CAsEP,8BAAA,CACA,+BACE,UAxEK,CAyEL,sCAvEgB,CA4EtB,oBACE,WAAA,CACA,UAAA,CACA,4BACE,+CAAA,CAKN,8BACE,KACE,wBAAA,CAAA",sourcesContent:[`@import 'dsr-design/scss/variables';
