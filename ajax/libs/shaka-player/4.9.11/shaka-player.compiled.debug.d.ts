...
declare namespace mediaTailor {
  type Ad = { adId : string , adParameters : string , adSystem : string , adTitle : string , creativeId : string , creativeSequence : string , durationInSeconds : number , nonLinearAdList : mediaTailor.NonLinearAd [] , skipOffset : string | null , startTimeInSeconds : number , trackingEvents : mediaTailor.TrackingEvent [] } ;
}
// Generated from /home/runner/work/shaka-player/shaka-player/externs/mediatailor.js
declare namespace mediaTailor {
