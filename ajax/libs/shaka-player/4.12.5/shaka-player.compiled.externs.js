...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   * @param {string=} codec
   */
  selectAudioLanguage(language, role, channelsCount, safeMargin, codec) {}
  /**
...
shaka.ads.InterstitialAd = class {
   ...
   */
  constructor(video, isSkippable, skipOffset, skipFor, onSkip, sequenceLength, adPosition, isUsingAnotherMediaElement) {}
  /**
   * @override
   */
  needsSkipUI() {}
