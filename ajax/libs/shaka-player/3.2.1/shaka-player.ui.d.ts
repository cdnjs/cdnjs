...
declare namespace shaka.ui {
   ...
   */
  class Localization implements EventTarget {
...
// Generated from /usr/local/google/home/joeyparrish/hacking/shaka/clean/ui/externs/ui.js
declare namespace shaka.extern {
  type UIConfiguration = { addBigPlayButton : boolean , addSeekBar : boolean , castReceiverAppId : string , clearBufferOnQualityChange : boolean , controlPanelElements : string [] , doubleClickForFullscreen : boolean , enableFullscreenOnRotation : boolean , enableKeyboardPlaybackControls : boolean , fadeDelay : number , forceLandscapeOnFullscreen : boolean , overflowMenuButtons : string [] , seekBarColors : shaka.extern.UISeekBarColors , showUnbufferedStart : boolean , trackLabelFormat : shaka.ui.Overlay.TrackLabelFormat , volumeBarColors : shaka.extern.UIVolumeBarColors } ;
}
// Generated from /usr/local/google/home/joeyparrish/hacking/shaka/clean/ui/externs/ui.js
declare namespace shaka.extern {
