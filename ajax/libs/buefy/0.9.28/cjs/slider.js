...
var script = {
  name: 'BSlider',
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, SliderThumb.name, SliderThumb), SliderTick.name, SliderTick),
  props: {
    value: {
      type: [Number, Array],
      default: 0
