...
var TabbedMixin = (function (cmp) {
  return {
    ...
    components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, Icon.Icon.name, Icon.Icon), SlotComponent.SlotComponent.name, SlotComponent.SlotComponent),
    props: {
      value: {
        type: [String, Number],
        default: undefined
