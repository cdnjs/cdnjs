...
var script = {
  name: 'BPagination',
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, Icon.Icon.name, Icon.Icon), PaginationButton.name, PaginationButton),
