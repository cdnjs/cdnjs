...
function processArgs(bindingValue) {
  ...
  if (!isFunction && _rollupPluginBabelHelpers._typeof(bindingValue) !== 'object') {
    throw new Error("v-click-outside: Binding value should be a function or an object, ".concat(_rollupPluginBabelHelpers._typeof(bindingValue), " given"));
  }
  return {
...
var script$2 = {
  ...
  computed: {
    ...
    computedClasses: function computedClasses() {
      return [this.type, _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, FIXED_TOP_CLASS, this.fixedTop), FIXED_BOTTOM_CLASS, this.fixedBottom), BODY_CENTERED_CLASS, this.centered), 'is-spaced', this.spaced), 'has-shadow', this.shadow), 'is-transparent', this.transparent)];
    }
  },
  watch: {
    active: {
...
var Plugin = {
  install: function install(Vue) {
    plugins.registerComponent(Vue, Navbar);
    plugins.registerComponent(Vue, NavbarItem);
    plugins.registerComponent(Vue, NavbarDropdown);
  }
};
plugins.use(Plugin);
