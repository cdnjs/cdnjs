  ...
  props: {
    ...
    type: {
      ...
      default: function _default() {
        return config.config.defaultTooltipType;
      }
    },
    label: String,
    delay: {
      type: Number,
      default: function _default() {
        return config.config.defaultTooltipDelay;
      }
    },
    closeDelay: {
      type: Number,
      default: function _default() {
        return config.config.defaultTooltipCloseDelay;
      }
    },
    position: {
      type: String,
    ...
    updateAppendToBody: function updateAppendToBody() {
      ...
      if (tooltip && trigger) {
        ...
        this.rootClasses.forEach(function (item) {
          if (_rollupPluginBabelHelpers._typeof(item) === 'object') {
            for (var key in item) {
              if (item[key]) {
