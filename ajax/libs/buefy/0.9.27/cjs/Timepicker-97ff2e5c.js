...
var script = {
  name: 'BTimepicker',
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, Input.Input.name, Input.Input), Field.Field.name, Field.Field), Select.Select.name, Select.Select), Icon.Icon.name, Icon.Icon), DropdownItem.Dropdown.name, DropdownItem.Dropdown), DropdownItem.DropdownItem.name, DropdownItem.DropdownItem),
