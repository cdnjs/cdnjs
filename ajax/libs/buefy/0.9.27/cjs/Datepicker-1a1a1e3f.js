...
var script$2 = {
  ...
  components: _rollupPluginBabelHelpers._defineProperty({}, DatepickerTableRow.name, DatepickerTableRow),
  props: {
    value: {
      type: [Date, Array]
    },
...
var defaultDateParser = function defaultDateParser(date, vm) {
  if (vm.dtf.formatToParts && typeof vm.dtf.formatToParts === 'function') {
    ...
    var dateGroups = helpers.matchWithGroups(formatRegex, date);
...
var script = {
  name: 'BDatepicker',
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, DatepickerTable.name, DatepickerTable), DatepickerMonth.name, DatepickerMonth), Input.Input.name, Input.Input), Field.Field.name, Field.Field), Select.Select.name, Select.Select), Icon.Icon.name, Icon.Icon), DropdownItem.Dropdown.name, DropdownItem.Dropdown), DropdownItem.DropdownItem.name, DropdownItem.DropdownItem),
