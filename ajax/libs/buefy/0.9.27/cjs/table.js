...
var Pagination = require('./Pagination-24ef0ec2.js');
var config = require('./config-8cfb5a4a.js');
var Checkbox = require('./Checkbox-43f54cc7.js');
var Icon = require('./Icon-78961800.js');
var Input = require('./Input-b2ccdc17.js');
var Loading = require('./Loading-08f0610f.js');
var SlotComponent = require('./SlotComponent-4fb48389.js');
...
var script$3 = {
  ...
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, Select.Select.name, Select.Select), Icon.Icon.name, Icon.Icon),
  props: {
...
var script$1 = {
  ...
  components: _rollupPluginBabelHelpers._defineProperty({}, Pagination.Pagination.name, Pagination.Pagination),
  props: {
    paginated: Boolean,
    total: [Number, String],
...
var script = {
  name: 'BTable',
  components: _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._defineProperty({}, Checkbox.Checkbox.name, Checkbox.Checkbox), Icon.Icon.name, Icon.Icon), Input.Input.name, Input.Input), Loading.Loading.name, Loading.Loading), SlotComponent.SlotComponent.name, SlotComponent.SlotComponent), TableMobileSort.name, TableMobileSort), TableColumn.name, TableColumn), TablePagination.name, TablePagination),
  inheritAttrs: false,
    ...
    newColumns: function newColumns() {
      ...
      if (this.columns && this.columns.length) {
        return this.columns.map(function (column) {
          var TableColumnComponent = config.VueInstance.extend(TableColumn);
    ...
    sortBy: function sortBy(array, key, fn, isAsc) {
      ...
      if (fn && typeof fn === 'function') {
        ...
        sorted = _rollupPluginBabelHelpers._toConsumableArray(array).sort(function (a, b) {
          ...
          var newB = helpers.getValueByPath(b, key);
      ...
      if (target != null) {
        if (target !== this.touchDragoverTarget) {
          if (this.touchDragoverTarget != null) {
            this.touchDragoverTarget.dispatchEvent(helpers.translateTouchAsDragEvent(event, {
              type: 'dragleave',
