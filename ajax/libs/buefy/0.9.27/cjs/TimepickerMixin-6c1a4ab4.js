...
var defaultTimeParser = function defaultTimeParser(timeString, vm) {
  if (timeString) {
    ...
    if (vm.dtf.formatToParts && typeof vm.dtf.formatToParts === 'function') {
      ...
      var timeGroups = helpers.matchWithGroups(formatRegex, timeString);
  ...
  props: {
    ...
    mobileNative: {
      ...
      default: function _default() {
        return config.config.defaultTimepickerMobileNative;
      }
    },
    mobileModal: {
      type: Boolean,
      default: function _default() {
        return config.config.defaultTimepickerMobileModal;
      }
    },
    timeCreator: {
      type: Function,
