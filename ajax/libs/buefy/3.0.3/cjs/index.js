...
var colorpicker = require('./index-SLOXD6k3.js');
...
const Buefy = {
  install(Vue, options = {}) {
    ...
    plugins.registerComponentProgrammatic(Vue, "config", config.default, config.configInjectionKey);
    Vue.config.globalProperties.$buefy.globalNoticeInterval = void 0;
  }
};

exports.ConfigProgrammatic = config.default;
exports.useConfigComponent = config.useConfigComponent;
...
exports.useLoading = loading.useLoading;
...
exports.useSnackbar = snackbar.useSnackbar;
