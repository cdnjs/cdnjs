      ...
      var _loop = function _loop(key) {
        ...
        if (column && column.customSearch && typeof column.customSearch === 'function') {
          ...
          if (Number.isInteger(value)) {
            ...
            return {
              v: re.test(helpers.removeDiacriticsFromString(value)) || re.test(value)
            };
          }
        }
      };
