...
this.options.icons=[];return this};f.prototype.get$icons=function(){return this.get$modal().find(".ssi-topIcons")};f.prototype.get$buttons=function(a){a=a||"buttons";return this.get$modal().find("#ssi-"+a)};f.prototype.get$window=function(){return this.get$modal().find("#ssi-modalWindow")};f.prototype.get$wrapper=function(){return this.get$modal().find("#ssi-modalWrapper")};f.prototype.get$backdrop=function(){return this.$backdrop||e("#"+this.backdropId)};var D=null;f.prototype.changePreviewState=
function(){var a=this.get$modal();if("fullScreen"===this.options.preview.state)a.removeClass("ssi-fullScreen"),this.options.preview.state="normal",a.find("#ssi-modalContent").css("height",""),(this.options.fixedHeight||this.options.fitScreen)&&this.setModalHeight(),clearTimeout(D),a.off("mousemove.ssi-modal");else{if(this.options.preview.hideIcons){var b=a.find(".ssi-topIcons");if(this.options.buttons)var c=a.find("#ssi-buttons");a.on("mousemove.ssi-modal",function(){clearTimeout(D);b.fadeIn();c.slideDown();
D=setTimeout(function(){c.slideUp();b.fadeOut()},2E3)})}this.setModalHeight(40,"height");a.addClass("ssi-fullScreen");this.options.preview.state="fullScreen"}return this};f.prototype.setPluginName=function(a){this.pluginName=a;p[a]=0;return this};f.prototype.setContent=function(a,b){b=b||"html";var c;!0!==this.options.content?(c=e('<div id="ssi-modalContent" class="ssi-modalContent '+(this.options.fixedHeight?"ssi-overflow ":"")+'"></div>'),""===this.options.content&&(!0===this.options.title?this.get$title().after(c):
this.get$window().prepend(c),this.setModalHeight()),this.options.content=!0):c=this.get$content();var d=a;a instanceof e&&!0===this.options.bodyElement&&(!0===this.options.extendOriginalContent&&(this.options.beforeClose=function(b){var c;"function"===typeof beforeClose&&(c=beforeClose(b));if(!1!==c)a.eq(0).after(b.get$content().contents().unwrap().css("display","")).remove();else return c}),d=a.eq(0).clone(),d.is(":visible")||d.show());c[b](d);return c};f.prototype.setButtons=function(a,b){var c,
d=!1;a=x(a);!1!==b&&(b="undefined"!==typeof b?e(b):this.get$window(),c=b.find("#ssi-buttons"),c=c[0]);c||(c=e('<div id="ssi-buttons" class="ssi-buttons"><div  id="ssi-leftButtons" class="ssi-leftButtons"></div><div id="ssi-rightButtons" class="ssi-rightButtons"></div></div>'),b&&(d=!0,b.append(c)),this.options.buttons=!0);for(var h=a.length,g=c.find("#ssi-leftButtons"),f=c.find("#ssi-rightButtons"),v=[],t=[],l=0,k;l<h;l++)k=this.generateButton(a[l]),"left"===a[l].side?v.push(k):t.push(k);g.append(v);
f.append(t);d&&this.setModalHeight();return c};var A=function(a,b){switch(typeof a){case "boolean":a="show"===b?a?"anim ssi-fadeIn":"ssi-show":a?"anim ssi-fadeOut":"ssi-hidden";break;case "undefined":a="show"===b?"ssi-show":"ssi-hidden"}return a},G=function(a){var b=a.options.modalAnimation||a.options.animation||!1,c=a.options.backdropAnimation||a.options.animation||!1,d;d=A("undefined"!==typeof b.show?b.show:b,"show");b=A("undefined"!==typeof b.hide?b.hide:b,"hide");a.options.modalAnimation={show:d,
hide:b};d=A("undefined"!==typeof c.show?c.show:c,"show");b=A("undefined"!==typeof c.hide?c.hide:c,"hide");a.options.backdropAnimation={show:d,hide:b};!1===F&&(a.options.modalAnimation={show:"ssi-show"!==a.options.modalAnimation.show?"anim ssi-fadeIn":"ssi-show",hide:"ssi-hidden"!==a.options.modalAnimation.hide?"anim ssi-fadeOut":"ssi-hidden"},a.options.backdropAnimation={show:"ssi-show"!==a.options.backdropAnimation.show?"anim ssi-fadeIn":"ssi-show",hide:"ssi-hidden"!==a.options.backdropAnimation.hide?
"anim ssi-fadeOut":"ssi-hidden"})},H=function(a){var b=a.get$modal();a.time=setTimeout(function(){a.close()},1E3*a.options.closeAfter.time);if(a.options.closeAfter.displayTime&&a.options.title){var c=b.find("span.ssi-displayTime").html(a.options.closeAfter.time);E(a,c,function(){a.$displayTime.remove()})}a.options.closeAfter.resetOnHover&&(b.on("mouseenter.ssi-modal",function(){clearTimeout(a.time);c&&(c.html(a.options.closeAfter.time),clearInterval(a.countDown))}),b.on("mouseleave.ssi-modal",function(){a.time=
setTimeout(function(){a.close()},1E3*a.options.closeAfter.time);a.options.closeAfter.displayTime&&a.options.title&&E(a,c,function(){c.parent().remove()})}))};f.prototype.backdropInit=function(){var a;if("string"===typeof m)a=e("#"+m),this.backdropId=m,a=a.attr("class","ssi-backdrop "+this.pluginName+" "+this.options.backdropClassName),this.showbd=!1,m=!0;else{a=e('<div id="ssi-backdrop'+this.numberId+'" class="ssi-backdrop ssi-hidden '+this.options.backdropClassName+" "+this.pluginName+'"></div>');
if("shared"===this.options.backdrop||"byKindShared"===this.options.backdrop){var b;b="byKindShared"===this.options.backdrop?e(".ssi-backdrop.ssi-openedDialog."+this.pluginName):e(".ssi-backdrop.ssi-openedDialog");b[0]?(this.backdropId=b.attr("id"),this.showbd=!1,a=b):(e("body").append(a),this.backdropId="ssi-backdrop"+this.numberId,this.showbd=!0)}else!0===this.options.backdrop&&(e("body").append(a),this.backdropId="ssi-backdrop"+this.numberId,this.showbd=!0);this.$backdrop=a}if(this.options.outSideClose&&
this.options.position){var c=this;a.on("click.ssi-modal"+this.numberId,function(a){a.preventDefault();c.close()})}return a};f.prototype.setIcons=function(a){var b,c=[];!0!==this.options.iconButtons?(b=e('<div class="ssi-topIcons"></div>'),this.options.iconButtons=!0):b=this.get$icons();for(var d=this,h=a.length,g=0,f;g<h;g++)f=a[g],function(a){c.push(e('<a class="'+a.className+'"></a>').click(function(b){b.preventDefault();"function"===typeof a.method&&e.proxy(a.method,this)(b,d)}))}(f);b.append(c);
return b};var I=function(a){var b=e('<div id="ssi-modalWindow" class="ssi-modalWindow '+(a.options.center?a.options.sizeClass:"")+(a.options.stack?" "+a.options.sizeClass+" "+a.options.className+" ":"")+'"></div>'),c="",d=[];a.options.content&&(c=a.setContent(a.options.content,"html"));a.options.title&&d.push(a.setTitle(a.options.title));a.options.onClickClose&&b.addClass("ssi-hover").click(function(b){b=e(b.target);b.is("a")||b.is("button")||a.close()});0<a.options.iconButtons.length&&d.push(a.setIcons(a.options.iconButtons,
!0));d.push(c);"undefined"===typeof a.options.buttons||e.isEmptyObject(a.options.buttons)||d.push(a.setButtons(a.options.buttons,!1));b.append(d);return b};f.prototype.generateButton=function(a){a=e.extend({},{className:"",enableAfter:!1,method:function(){},type:"button",id:"",label:"",modalAnimation:"",backdropAnimation:""},a);var b="button",c="",d=this,h;"link"===a.type&&(b="a",c=' href="#"');var g=e("<"+b+c+(a.id?' id="'+a.id+'"':" ")+(a.enableAfter?"disabled ":"")+' class="ssi-modalBtn '+(a.className||
