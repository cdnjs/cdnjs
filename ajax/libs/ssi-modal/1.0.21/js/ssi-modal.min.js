(function(e,r){"object"===typeof module&&module.exports?module.exports=r(require("jquery")):e.ssi_modal=r(e.jQuery)})(this,function(e){function r(a,b){function c(){var b=e('a[data-ssi_imgGroup="'+k.attr("data-ssi_imgGroup")+'"]'),c=b.index(k),b=b.length,d=e('<div class="ssi-modalNavigation"></divid>').mouseover(function(){d.addClass("ssi-navFadeIn")}).mouseleave(function(){d.removeClass("ssi-navFadeIn")}),h=e('<div class="ssi-modalNext '+(c+1>=b?"ssi-hidden":"")+'"><span></span></div>'),g=e('<div class="ssi-modalPrev '+
(1>c?"ssi-hidden":"")+'"><span></span></div>');d.append(h,g);a.get$backdrop().one("backdropClose.ssi-modal",function(){q=w=""});a.get$modal().one("beforeClose.ssi-modal",function(){d.remove()}).one("onShow.ssi-modal",function(){h.one("click",function(b){b.preventDefault();a.navigate("next");e(this).off("click.ssi_modal")});g.one("click",function(b){b.preventDefault();a.navigate("prev");e(this).off("click.ssi_modal")})});return d}function d(b){p.find(".ssi-loader").remove();var c=[];if(!b&&""!==a.options.imgButtons&&
!e.isEmptyObject(a.options.imgButtons)){var d=a.setButtons(a.options.imgButtons,a.get$content()).addClass("ssi-imgButtons");!0===a.options.hideImgButtons&&(d.addClass("ssi-navFade ssi-navFadeOut"),a.get$wrapper().mouseover(function(){d.addClass("ssi-navFadeIn")}).mouseleave(function(){d.removeClass("ssi-navFadeIn")}));c.push(d)}c.push(n);p.append(c)}function h(b,c){clearInterval(f);var e=b||(t?n[0].naturalWidth:n.width()),h=c||(t?n[0].naturalHeight:n.height()),g=a.setModalHeight(120,!0);(h>l-g||e>
m)&&!0===a.options.fixedHeight&&(g=Math.min((m-100)/e,(l-g)/h),e*=g,h*=g,2<r&&u.addClass("ssi-overHeight"));p.css("height",h);a.options.center&&p.parent().css({width:e,height:h});u.css("width",e);d();u.addClass("ssi-imgBorder")}function g(){if(t){if(0<n[0].naturalWidth){h();return}}else if(clearInterval(f),50<n.width()){h();return}v=!0}var f,v,t="naturalWidth"in new Image,l=e(window).height(),m=e(window).width(),n=[""],u=a.get$wrapper(),p=u.find("#ssi-modalContent"),r=0;a.options.navigation&&k&&c(a).appendTo(p);
-1!==e.inArray(b.split(".").pop().toLowerCase(),["jpg","jpeg","png","gif","bmp"])?(n=e('<img src="'+b+'" class="ssi-modalImg"/>').on("load",function(){if(!t){var a=new Image;a.src=n.attr("src");h(a.width,a.height)}}).error(function(){var a=k?k.attr("data-alt"):"";n="<h3>Image not found</h3><br>"+("undefined"!==typeof a?"<h4>"+a+"</h4>":"");d(!0)}),g(),v&&(f=setInterval(function(){u.addClass("ssi-imgBorder");g();r++},50))):("boolean"!==typeof a.options.iframe.allowFullScreen&&(a.options.iframe.allowFullScreen=
!0),a.options.iframe.className=a.options.iframe.className||"",n=e('<iframe src="'+b+'" frameborder="0" '+(a.options.iframe.allowFullScreen?"allowfullscreen":"")+"></iframe>"),a.options.center?u.addClass("ssi-iframe ").find("#ssi-modalWindow"+a.numberId).addClass(a.options.iframe.className):u.addClass("ssi-iframe "+a.options.iframe.className),d())}function x(a){a instanceof Array||(a=[a]);return a}var F=function(){var a=!1,b=["Webkit","Moz","O","ms","Khtml"],c="",c=document.createElement("div");void 0!==
c.style.animationName&&(a=!0);if(!1===a)for(var d=0;d<b.length;d++)if(void 0!==c.style[b[d]+"AnimationName"]){c=b[d];c.toLowerCase();a=!0;break}return a}(),y=0,z=0,p={stackModal:0,normalModal:0},C=0,m=!1,f=function(a){this.numberId=C;this.pluginName=a.stack?"stackModal":"normalModal";this.backdropId="";this.showbd=!0;this.setOptions(a)};f.prototype.setOptions=function(a,b){if("object"===typeof a){var c=this;this.options=e.extend(!0,{content:"",bodyScroll:!1,keepContent:!1,position:"",backdrop:!0,
stack:!1,onClickClose:!1,bodyElement:!1,className:"",backdropClassName:"",preview:{icon:!1,hideIcons:!1,state:"normal"},closeAfter:!1,outSideClose:!0,onClose:"",onShow:"",beforeClose:"",beforeShow:"",iframe:{allowFullScreen:!0,className:""},center:!1,closeIcon:!0,navigation:!1,sizeClass:"medium",animation:!1,modalAnimation:void 0,backdropAnimation:void 0,animationSpeed:300,buttons:[],iconButtons:[],title:"",fixedHeight:!1,fitScreen:!1},a);this.options.iconButtons=x(this.options.iconButtons);this.options.preview.icon&&
this.options.iconButtons.push({className:"ssi-displayIcon",method:function(){c.changePreviewState()}});this.options.closeIcon&&this.options.iconButtons.push({className:"ssi-closeIcon",method:function(){c.close()}})}else this.options[a]=b;G(this);return this};f.prototype.init=function(){this.options.backdrop&&this.backdropInit();this.modalInit();C++;return this};f.prototype.get$content=function(){return this.get$modal().find("#ssi-modalContent")};f.prototype.get$modal=function(a){a=a||this.modalId;
return this.$modal||e("#"+a)};f.prototype.get$title=function(){return this.get$modal().find("#ssi-modalTitle")};f.prototype.destroyTitle=function(){this.get$title().remove();this.options.title="";return this};f.prototype.destroyContent=function(){this.get$content().remove();this.options.content="";return this};f.prototype.destroyButtons=function(a){this.get$buttons(a).remove();this.options.buttons=[];return this};f.prototype.destroyIcons=function(){this.get$icons().remove();this.options.icons=[];
return this};f.prototype.get$icons=function(){return this.get$modal().find(".ssi-topIcons")};f.prototype.get$buttons=function(a){a=a||"buttons";return this.get$modal().find("#ssi-"+a)};f.prototype.get$window=function(){return this.get$modal().find("#ssi-modalWindow")};f.prototype.get$wrapper=function(){return this.get$modal().find("#ssi-modalWrapper")};f.prototype.get$backdrop=function(){return this.$backdrop||e("#"+this.backdropId)};var D=null;f.prototype.changePreviewState=function(){var a=this.get$modal();
if("fullScreen"===this.options.preview.state)a.removeClass("ssi-fullScreen"),this.options.preview.state="normal",a.find("#ssi-modalContent").css("height",""),(this.options.fixedHeight||this.options.fitScreen)&&this.setModalHeight(),clearTimeout(D),a.off("mousemove.ssi-modal");else{if(this.options.preview.hideIcons){var b=a.find(".ssi-topIcons");if(this.options.buttons)var c=a.find("#ssi-buttons");a.on("mousemove.ssi-modal",function(){clearTimeout(D);b.fadeIn();c.slideDown();D=setTimeout(function(){c.slideUp();
b.fadeOut()},2E3)})}this.setModalHeight(40,"height");a.addClass("ssi-fullScreen");this.options.preview.state="fullScreen"}return this};f.prototype.setPluginName=function(a){this.pluginName=a;p[a]=0;return this};f.prototype.setContent=function(a,b){b=b||"html";var c;!0!==this.options.content?(c=e('<div id="ssi-modalContent" class="ssi-modalContent '+(this.options.fixedHeight?"ssi-overflow ":"")+'"></div>'),""===this.options.content&&(!0===this.options.title?this.get$title().after(c):this.get$window().prepend(c),
this.setModalHeight()),this.options.content=!0):c=this.get$content();var d=a;a instanceof e&&!0===this.options.bodyElement&&(!0===this.options.extendOriginalContent&&(this.options.beforeClose=function(b){var c;"function"===typeof beforeClose&&(c=beforeClose(b));if(!1!==c)a.eq(0).after(b.get$content().contents().unwrap().css("display","")).remove();else return c}),d=a.eq(0).clone(),d.is(":visible")||d.show());c[b](d);return c};f.prototype.setButtons=function(a,b){var c,d=!1;a=x(a);!1!==b&&(b="undefined"!==
typeof b?e(b):this.get$window(),c=b.find("#ssi-buttons"),c=c[0]);c||(c=e('<div id="ssi-buttons" class="ssi-buttons"><div  id="ssi-leftButtons" class="ssi-leftButtons"></div><div id="ssi-rightButtons" class="ssi-rightButtons"></div></div>'),b&&(d=!0,b.append(c)),this.options.buttons=!0);for(var h=a.length,g=c.find("#ssi-leftButtons"),f=c.find("#ssi-rightButtons"),v=[],t=[],l=0,k;l<h;l++)k=this.generateButton(a[l]),"left"===a[l].side?v.push(k):t.push(k);g.append(v);f.append(t);d&&this.setModalHeight();
return c};var A=function(a,b){switch(typeof a){case "boolean":a="show"===b?a?"anim ssi-fadeIn":"ssi-show":a?"anim ssi-fadeOut":"ssi-hidden";break;case "undefined":a="show"===b?"ssi-show":"ssi-hidden"}return a},G=function(a){var b=a.options.modalAnimation||a.options.animation||!1,c=a.options.backdropAnimation||a.options.animation||!1,d;d=A("undefined"!==typeof b.show?b.show:b,"show");b=A("undefined"!==typeof b.hide?b.hide:b,"hide");a.options.modalAnimation={show:d,hide:b};d=A("undefined"!==typeof c.show?
c.show:c,"show");b=A("undefined"!==typeof c.hide?c.hide:c,"hide");a.options.backdropAnimation={show:d,hide:b};!1===F&&(a.options.modalAnimation={show:"ssi-show"!==a.options.modalAnimation.show?"anim ssi-fadeIn":"ssi-show",hide:"ssi-hidden"!==a.options.modalAnimation.hide?"anim ssi-fadeOut":"ssi-hidden"},a.options.backdropAnimation={show:"ssi-show"!==a.options.backdropAnimation.show?"anim ssi-fadeIn":"ssi-show",hide:"ssi-hidden"!==a.options.backdropAnimation.hide?"anim ssi-fadeOut":"ssi-hidden"})},
H=function(a){var b=a.get$modal();a.time=setTimeout(function(){a.close()},1E3*a.options.closeAfter.time);if(a.options.closeAfter.displayTime&&a.options.title){var c=b.find("span.ssi-displayTime").html(a.options.closeAfter.time);E(a,c,function(){a.$displayTime.remove()})}a.options.closeAfter.resetOnHover&&(b.on("mouseenter.ssi-modal",function(){clearTimeout(a.time);c&&(c.html(a.options.closeAfter.time),clearInterval(a.countDown))}),b.on("mouseleave.ssi-modal",function(){a.time=setTimeout(function(){a.close()},
1E3*a.options.closeAfter.time);a.options.closeAfter.displayTime&&a.options.title&&E(a,c,function(){c.parent().remove()})}))};f.prototype.backdropInit=function(){var a;if("string"===typeof m)a=e("#"+m),this.backdropId=m,a=a.attr("class","ssi-backdrop "+this.pluginName+" "+this.options.backdropClassName),this.showbd=!1,m=!0;else{a=e('<div id="ssi-backdrop'+this.numberId+'" class="ssi-backdrop ssi-hidden '+this.options.backdropClassName+" "+this.pluginName+'"></div>');if("shared"===this.options.backdrop||
"byKindShared"===this.options.backdrop){var b;b="byKindShared"===this.options.backdrop?e(".ssi-backdrop.ssi-openedDialog."+this.pluginName):e(".ssi-backdrop.ssi-openedDialog");b[0]?(this.backdropId=b.attr("id"),this.showbd=!1,a=b):(e("body").append(a),this.backdropId="ssi-backdrop"+this.numberId,this.showbd=!0)}else!0===this.options.backdrop&&(e("body").append(a),this.backdropId="ssi-backdrop"+this.numberId,this.showbd=!0);this.$backdrop=a}if(this.options.outSideClose&&this.options.position){var c=
this;a.on("click.ssi-modal"+this.numberId,function(a){a.preventDefault();c.close()})}return a};f.prototype.setIcons=function(a){var b,c=[];!0!==this.options.iconButtons?(b=e('<div class="ssi-topIcons"></div>'),this.options.iconButtons=!0):b=this.get$icons();for(var d=this,h=a.length,g=0,f;g<h;g++)f=a[g],function(a){c.push(e('<a class="'+a.className+'"></a>').click(function(b){b.preventDefault();"function"===typeof a.method&&e.proxy(a.method,this)(b,d)}))}(f);b.append(c);return b};var I=function(a){var b=
e('<div id="ssi-modalWindow" class="ssi-modalWindow '+(a.options.center?a.options.sizeClass:"")+(a.options.stack?" "+a.options.sizeClass+" "+a.options.className+" ":"")+'"></div>'),c="",d=[];a.options.content&&(c=a.setContent(a.options.content,"html"));a.options.title&&d.push(a.setTitle(a.options.title));a.options.onClickClose&&b.addClass("ssi-hover").click(function(b){b=e(b.target);b.is("a")||b.is("button")||a.close()});0<a.options.iconButtons.length&&d.push(a.setIcons(a.options.iconButtons,!0));
d.push(c);"undefined"===typeof a.options.buttons||e.isEmptyObject(a.options.buttons)||d.push(a.setButtons(a.options.buttons,!1));b.append(d);return b};f.prototype.generateButton=function(a){a=e.extend({},{className:"",enableAfter:!1,method:function(){},type:"button",id:"",label:"",modalAnimation:"",backdropAnimation:""},a);var b="button",c="",d=this,h;"link"===a.type&&(b="a",c=' href="#"');var g=e("<"+b+c+(a.id?' id="'+a.id+'"':" ")+(a.enableAfter?"disabled ":"")+' class="ssi-modalBtn '+(a.className||
"")+'">'+a.label+"</"+b+">");if("number"===typeof a.enableAfter){var f=e('<span class="ssi-countDown">'+a.enableAfter+"</span>");E(d,f,function(){g.removeClass("disabled");g.removeAttr("disabled");f.remove()});g.append(f)}if(a.keyPress)e("body").on("keydown.ssi_modal",function(b){b.keyCode!=a.keyPress||g.is(":disabled")||g.trigger("click")});return g.click(function(b){b.preventDefault();a.clearTimeOut&&(clearTimeout(d.time),d.time=null,clearInterval(d.countDown));"function"===typeof a.method&&(h=
e.proxy(a.method,this)(b,d));!1!==h&&("boolean"===typeof a.keepContent&&a.keepContent!==d.options.keepContent&&(d.options.keepContent=a.keepContent),a.closeAfter&&d.close())})};f.prototype.modalInit=function(){var a=I(this),b=this;if(this.options.position&&this.options.stack){var c="append";-1<this.options.position.indexOf("bottom")&&(c="prepend");var d=this.options.position.replace(" ","."),d=e("div.ssi-modalOuter.ssi-stack."+d);if(d[0])d.find("#ssi-modalWrapper")[c](a);this.$modal=a}if(!this.options.stack||
!d[0]){var h=e('<div id="ssi-modalWrapper" class=" ssi-modalWrapper '+this.options.sizeClass+'"></div>'),g=e('<div class="ssi-modalOuter '+(this.options.stack?" ssi-stack":""+this.options.className)+(this.options.center?" ssi-center ":" ")+" "+(this.options.position?" ssi-modalPositioned "+this.options.position:"")+'"></div>').append(h.append(a)).appendTo(e("body"));this.options.stack||(this.$modal=g,g.one("onShow.ssi-modal",function(){!0===b.options.outSideClose&&(g.click(function(a){a.target===
this&&(a.preventDefault(),b.close())}),h.click(function(a){a.target===this&&(a.preventDefault(),b.close())}))}))}this.modalId="ssi-"+this.pluginName+this.numberId;this.$modal.attr("id","ssi-"+this.pluginName+this.numberId);this.$modal.addClass(this.pluginName+" ssi-modal");this.$modal.data("ssi-modal",this).addClass("ssi-hidden");"string"===typeof m&&this.backdropInit();return this.$modal};f.prototype.setTitle=function(a){var b,c=!1;!0!==this.options.title?(b=e('<div id="ssi-modalTitle" class="ssi-modalTitle '+
