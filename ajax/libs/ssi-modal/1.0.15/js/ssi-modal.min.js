...
else{if(this.options.preview.hideIcons){var b=a.find(".ssi-topIcons");if(this.options.buttons)var c=a.find("#ssi-buttons");a.on("mousemove.ssi-modal",function(){clearTimeout(E);b.fadeIn();c.slideDown();E=setTimeout(function(){c.slideUp();b.fadeOut()},2E3)})}this.setModalHeight(40,"height");a.addClass("ssi-fullScreen");this.options.preview.state="fullScreen"}return this};f.prototype.setPluginName=function(a){this.pluginName=a;r[a]=0;return this};f.prototype.setContent=function(a,b){b=b||"html";var c;
...
a.className+'"></a>').click(function(b){b.preventDefault();"function"===typeof a.method&&e.proxy(a.method,this)(b,d)}))}(u);b.append(c);return b};var K=function(a){var b=e('<div id="ssi-modalWindow" class="ssi-modalWindow '+(a.options.center?a.options.sizeClass:"")+(a.options.stack?" "+a.options.sizeClass+" "+a.options.className+" ":"")+'"></div>'),c="",d=[];a.options.content&&(c=a.setContent(a.options.content,"html"));a.options.title&&d.push(a.setTitle(a.options.title));a.options.onClickClose&&b.addClass("ssi-hover").click(function(b){b=
...
(c="a",d=' href="#"');var k=e("<"+c+d+(a.id?' id="'+a.id+'"':" ")+(a.enableAfter?"disabled ":"")+' class="ssi-modalBtn '+(a.className||"")+'">'+a.label+"</"+c+">"),f;if("number"===typeof a.enableAfter){var u=e('<span class="ssi-countDown">'+a.enableAfter+"</span>");F(b,u,function(){k.removeClass("disabled");k.removeAttr("disabled");u.remove()});k.append(u);f=a.enableAfter}else f=0;if(a.keyPress)if(c=function(){setTimeout(function(){e("body").on("keydown.ssi_modal",function(b){b.keyCode==a.keyPress&&
...
this.options.center&&a.css("display","");"fullScreen"===b.options.preview.state&&(b.options.preview.state="normal",b.changePreviewState());this.setModalHeight();"number"===typeof this.options.closeAfter.time&&J(this);delete this.$modal};f.prototype.showBackdrop=function(){this.get$backdrop().addClass("ssi-openedDialog").addAnimation(this.options.backdropAnimation.show).removeClass("ssi-hidden");delete this.$backdrop};f.prototype.show=function(){if("function"===typeof this.options.beforeShow&&!1===
...
(g=Math.abs(this.options.fixedHeight-a)),c.css("max-height",d-f-g)));return f};var F=function(a,b,c){a.countDown=setInterval(function(){var d=parseInt(b.html());0!==d-1?b.html(d-1):(c&&c(),clearInterval(a.countDown))},1E3)};e.fn.extend({hasClasses:function(a){for(var b in a)if(e(this).hasClass(a[b]))return!0;return!1}});var l={checkElement:function(a){a=e(a);if(a[0]){var b=a.data("ssi-modal");if(b&&!e("#"+b.modalId)[0])return a.data("ssi-modal",""),!1}return b?b:!1},createObject:function(a,b){var c,
...
d.data("ssi-modal").close()}}b=y(b);var d;d=typeof a;if("string"===d&&""!==a||"array"===d){a=y(a);for(var f=a.length,g=0;g<f;g++)d=e(".ssi-modal.ssi-openedDialog."+a[g]),c(d)}else d=e(".ssi-modal.ssi-openedDialog"),c(d)},removeAll:function(){e(".ssi-modalOuter").addClass("ssi-hidden").remove();e(".ssi-backdrop").addClass("ssi-hidden").remove();e("body").removeClass("ssi-modalOpen");A=z=0;r={stackModal:0,normalModal:0};D=0},dialog:function(a,b){var c={sizeClass:"dialog",okBtn:{className:"",label:"Ok"},
...
label:a.okBtn.label,closeAfter:!0,method:function(a,c){"function"===typeof b&&b(!0,a,c)}},{className:a.cancelBtn.className,label:a.cancelBtn.label,closeAfter:!0,method:function(a,c){"function"===typeof b&&b(!1,a,c)}}];return(new f(a)).init().show()}},C={"ssi-mainOption":{}};l.imgBox=function(a,b){C[b||"ssi-mainOption"]=e.extend({},C["ssi-mainOption"],a)};var v,p,q;l.proto.navigate=function(a){var b=v.length;if("next"===a&&p+1>=b||"prev"===a&&0>p)return this;this.destroyModal();"next"===a?p++:"prev"===
a&&p--;v.eq(p).trigger("click");return this};e("body").on("click.ssi-imgBox","a.ssi-imgBox",function(a){a.preventDefault();q=e(a.currentTarget);a=q.attr("data-ssi_imgGroup")||"ssi-mainOption";a=e.extend(!0,{backdrop:"byKindShared",fixedHeight:!0,navigation:!0,closeIcon:!0,title:!1,hideImgButtons:!0},C[a]||C["ssi-mainOption"]);if(""!==a.imgButtons&&!e.isEmptyObject(a.imgButtons))for(var b=0;b<a.imgButtons.length;b++)if(a.imgButtons[b].exclude)for(var c=a.imgButtons[b].exclude.split(","),d=0;d<c.length;d++)if(q.hasClass(c[d])){a.imgButtons.splice(b,
