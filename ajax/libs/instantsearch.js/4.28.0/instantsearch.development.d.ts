...
declare namespace connectors {
    export {
        ...
        connectRelevantSort,
        connectDynamicWidgets as EXPERIMENTAL_connectDynamicWidgets
    }
}
...
}, Omit<DynamicWidgetsConnectorParams, 'widgets'>, DynamicWidgetsWidgetParams>;
...
declare type PanelWidget = <TWidgetFactory extends AnyWidgetFactory>(panelWidgetParams?: PanelWidgetParams<TWidgetFactory>) => (widgetFactory: TWidgetFactory) => (widgetParams: Parameters<TWidgetFactory>[0]) => ReturnType<TWidgetFactory>;
...
declare namespace widgets {
    export {
        ...
        dynamicWidgets as EXPERIMENTAL_dynamicWidgets,
        geoSearch,
        hierarchicalMenu,
        hits,
        hitsPerPage,
