...
export declare function base64ToArray(base64: any): Uint8Array<ArrayBuffer>;
 ...
 */
export declare function download(query: any, viewer: GLViewer, options: any, callback?: any): any;
