...
declare class MapBrowserEvent<EVENT extends UIEvent> extends MapEvent {
     ...
     */
    constructor(type: string, map: import("./Map.js").default, originalEvent: EVENT, opt_dragging?: boolean | undefined, opt_frameState?: import("./Map.js").FrameState | undefined, opt_activePointers?: PointerEvent[] | undefined);
    /**
