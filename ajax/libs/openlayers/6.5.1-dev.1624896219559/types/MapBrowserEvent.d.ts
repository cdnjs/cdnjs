...
declare class MapBrowserEvent<EVENT extends UIEvent> extends MapEvent {
     ...
     */
    constructor(type: string, map: import("./PluggableMap.js").default, originalEvent: EVENT, opt_dragging?: boolean, opt_frameState?: import("./PluggableMap.js").FrameState | null);
    /**
