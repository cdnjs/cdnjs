...
declare class ExecutorGroup {
     ...
     */
    hasExecutors(executors: Array<any>): boolean;
    /**
     ...
     */
    execute(context: CanvasRenderingContext2D, contextScale: number, transform: import("../../transform.js").Transform, viewRotation: number, snapToPixel: boolean, opt_builderTypes?: any[] | undefined, opt_declutterTree?: any): void;
}
