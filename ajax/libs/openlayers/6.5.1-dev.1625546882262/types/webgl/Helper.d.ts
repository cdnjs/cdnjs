...
export type Options = {
     ...
     */
    postProcesses?: Array<PostProcessesOptions>;
};
...
declare class WebGLHelper extends Disposable {
     ...
     * @api
     */
    prepareDraw(frameState: import("../PluggableMap.js").FrameState): void;
    /**
     ...
     */
    prepareDrawToRenderTarget(frameState: import("../PluggableMap.js").FrameState, renderTarget: import("./RenderTarget.js").default, opt_disableAlphaBlend?: boolean): void;
    /**
     ...
     * @api
     */
    createTexture(size: Array<number>, opt_data?: ImageData | HTMLImageElement | HTMLCanvasElement, opt_texture?: WebGLTexture): WebGLTexture;
}
