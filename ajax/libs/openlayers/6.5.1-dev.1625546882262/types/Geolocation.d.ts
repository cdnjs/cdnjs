 ...
 * @api
 */
declare class Geolocation extends BaseObject<"change:position" | "change:accuracy" | "change:accuracyGeometry" | "change:altitude" | "change:altitudeAccuracy" | "change:heading" | "change:projection" | "change:speed" | "change:tracking" | "change:trackingOptions"> {
    /**
