...
export class CollectionEvent extends Event {
     ...
     */
    constructor(type: any, opt_element?: any, opt_index?: number);
    /**
 ...
 * @api
 */
declare class Collection<T> extends BaseObject<"add" | "remove" | "change:length"> {
    /**
     * @param {Array<T>} [opt_array] Array.
     * @param {Options} [opt_options] Collection options.
     */
    constructor(opt_array?: Array<T>, opt_options?: Options);
    /**
     * @private
     * @type {boolean}
     */
