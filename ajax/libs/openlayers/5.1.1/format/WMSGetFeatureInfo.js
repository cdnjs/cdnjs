...
var WMSGetFeatureInfo = (function (XMLFeature) {
   ...
   * @inheritDoc
   */
  WMSGetFeatureInfo.prototype.writeFeatureNode = function writeFeatureNode (feature, opt_options) {};

  /**
   * Not implemented.
   * @inheritDoc
   */
  WMSGetFeatureInfo.prototype.writeFeaturesNode = function writeFeaturesNode (features, opt_options) {};

  /**
   * Not implemented.
   * @inheritDoc
   */
  WMSGetFeatureInfo.prototype.writeGeometryNode = function writeGeometryNode (geometry, opt_options) {};
