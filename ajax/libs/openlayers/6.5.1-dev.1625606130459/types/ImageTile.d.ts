...
declare class ImageTile extends Tile {
     ...
     */
    constructor(tileCoord: import("./tilecoord.js").TileCoord, state: any, src: string, crossOrigin: string | null, tileLoadFunction: import("./Tile.js").LoadFunction, opt_options?: import("./Tile.js").Options);
    /**
     * @private
     * @type {?string}
     */
