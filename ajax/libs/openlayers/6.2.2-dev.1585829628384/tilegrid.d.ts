 ...
 */
export function createForExtent(extent: number[], opt_maxZoom?: number, opt_tileSize?: number | number[], opt_corner?: {
    BOTTOM_LEFT: string;
    BOTTOM_RIGHT: string;
    TOP_LEFT: string;
    TOP_RIGHT: string;
 ...
 * @return {!TileGrid} TileGrid instance.
 */
export function createForProjection(projection: string | import("./proj/Projection.js").default, opt_maxZoom?: number, opt_tileSize?: number | number[], opt_corner?: {
    BOTTOM_LEFT: string;
    BOTTOM_RIGHT: string;
    TOP_LEFT: string;
    TOP_RIGHT: string;
 ...
 */
export function extentFromProjection(projection: string | import("./proj/Projection.js").default): number[];
