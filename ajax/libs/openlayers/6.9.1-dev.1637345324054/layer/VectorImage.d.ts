 ...
 * @api
 */
declare class VectorImageLayer<VectorSourceType extends import("../source/Vector.js").default<any>> extends BaseVectorLayer<VectorSourceType, CanvasVectorImageLayerRenderer> {
    /**
