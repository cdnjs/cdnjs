...
var PolygonBatchRenderer = /** @class */ (function (_super) {
    __extends(PolygonBatchRenderer, _super);
    /**
     ...
     */
    function PolygonBatchRenderer(helper, worker, vertexShader, fragmentShader, customAttributes) {
     ...
     * @override
     */
    PolygonBatchRenderer.prototype.generateRenderInstructions = function (batch) {
    ...
    return PolygonBatchRenderer;
}(AbstractBatchRenderer));
export default PolygonBatchRenderer;
//# sourceMappingURL=PolygonBatchRenderer.js.map