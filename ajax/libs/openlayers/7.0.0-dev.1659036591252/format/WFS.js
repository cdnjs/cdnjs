...
var WFS = /** @class */ (function (_super) {
    ...
    WFS.prototype.readFeaturesFromNode = function (node, opt_options) {
        ...
        Object.assign(context, this.getReadOptions(node, opt_options ? opt_options : {}));
...
function createTransactionRequest(node, baseObj, version, options) {
    ...
    var obj = Object.assign({ node: node }, {
        version: version,
...
function writeQuery(node, featureType, objectStack) {
    ...
    var item = /** @type {import("../xml.js").NodeStackItem} */ (Object.assign({}, context));
    item.node = node;
...
function writeFilterCondition(node, filter, objectStack) {
    ...
    /** @type {import("../xml.js").NodeStackItem} */
    var item = { node: node };
    Object.assign(item, { context: context });
