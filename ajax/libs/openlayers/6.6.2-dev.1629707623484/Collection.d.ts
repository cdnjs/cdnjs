 ...
 * *
 */
export type CollectionOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => any) => Return) & ((type: "propertychange" | "change:length" | ("propertychange" | "change:length")[], listener: (event: import("./Object.js").ObjectEvent) => any) => Return) & ((type: "add" | "remove" | ("add" | "remove")[], listener: (event: CollectionEvent) => any) => Return) & ((type: ("add" | "error" | "change" | "propertychange" | "remove" | "change:length")[], listener: (event: globalThis.Event | Event) => any) => Return);
export type Options = {
    /**
...
declare class Collection<T> extends BaseObject {
     ...
     */
    on: CollectionOnSignature<import("./Observable.js").OnReturn>;
    /***
     * @type {CollectionOnSignature<import("./Observable.js").OnReturn>}
     */
    once: CollectionOnSignature<import("./Observable.js").OnReturn>;
    /***
