...
var IGC = (function (TextFeature) {
   ...
   * @inheritDoc
   */
  IGC.prototype.writeFeatureText = function writeFeatureText (feature, opt_options) {};

  /**
   * Not implemented.
   * @inheritDoc
   */
  IGC.prototype.writeFeaturesText = function writeFeaturesText (features, opt_options) {};

  /**
   * Not implemented.
   * @inheritDoc
   */
  IGC.prototype.writeGeometryText = function writeGeometryText (geometry, opt_options) {};

  /**
   * Not implemented.
   * @inheritDoc
   */
  IGC.prototype.readGeometryFromText = function readGeometryFromText (text, opt_options) {};
