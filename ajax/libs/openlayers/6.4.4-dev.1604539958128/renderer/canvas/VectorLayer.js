...
var CanvasVectorLayerRenderer = /** @class */ (function (_super) {
     ...
     * @template T
     */
    CanvasVectorLayerRenderer.prototype.forEachFeatureAtCoordinate = function (coordinate, frameState, hitTolerance, callback) {
        var _this = this;
        if (!this.replayGroup_) {
             ...
             */
            var featureCallback_1 = function (feature) {
            ...
            executorGroups.forEach(function (executorGroup) {
                result_1 =
                    result_1 ||
                        executorGroup.forEachFeatureAtCoordinate(coordinate, resolution_1, rotation_1, hitTolerance, featureCallback_1, executorGroup === _this.declutterExecutorGroup
