...
export type FrameState = {
    ...
    declutterItems: Array<DeclutterItems>;
    index: number;
...
export type AtPixelOptions = {
     ...
     */
    layerFilter?: undefined | ((arg0: import("./layer/Layer.js").default) => boolean);
    /**
...
export type MapOptions = {
     ...
     */
    controls?: Collection<import("./control/Control.js").default> | Array<import("./control/Control.js").default>;
    /**
     * The ratio between
     ...
     */
    interactions?: Collection<import("./interaction/Interaction.js").default> | Array<import("./interaction/Interaction.js").default>;
    /**
     * The element to
     ...
     * layer.
     */
    layers?: Array<import("./layer/Base.js").default> | Collection<import("./layer/Base.js").default> | LayerGroup;
    /**
...
declare class PluggableMap extends BaseObject {
     ...
     * @api
     */
    forEachFeatureAtPixel<S, T>(pixel: import("./pixel.js").Pixel, callback: (this: S, arg1: import("./Feature.js").FeatureLike, arg2: import("./layer/Layer.js").default) => T, opt_options?: AtPixelOptions | undefined): T;
    /**
     ...
     * @api
     */
    forEachLayerAtPixel<S_1, T_1>(pixel: import("./pixel.js").Pixel, callback: (this: S_1, arg1: import("./layer/Layer.js").default, arg2: (Uint8ClampedArray | Uint8Array)) => T_1, opt_options?: AtPixelOptions | undefined): T_1;
    /**
     ...
     * @api
     */
    getEventCoordinate(event: Event): import("./coordinate.js").Coordinate;
    /**
     * Returns the coordinate in view projection for a browser event.
     * @param {Event} event Event.
     * @return {import("./coordinate.js").Coordinate} Coordinate.
     */
    getEventCoordinateInternal(event: Event): import("./coordinate.js").Coordinate;
    /**
     ...
     * @api
     */
    getEventPixel(event: Event | TouchEvent): import("./pixel.js").Pixel;
    /**
     ...
     */
    handleBrowserEvent(browserEvent: Event, opt_type?: string | undefined): void;
    /**
