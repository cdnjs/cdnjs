...
declare class TextFeature extends FeatureFormat {
     ...
     */
    protected readFeaturesFromText(text: string, opt_options?: import("./Feature.js").ReadOptions): Array<import("../Feature.js").default<any>>;
    /**
     * @abstract
     * @param {string} text Text.
     * @param {import("./Feature.js").ReadOptions} [opt_options] Read options.
     ...
     * @return {string} Text.
     */
    protected writeFeaturesText(features: Array<import("../Feature.js").default<any>>, opt_options?: import("./Feature.js").WriteOptions): string;
    /**
     * @abstract
