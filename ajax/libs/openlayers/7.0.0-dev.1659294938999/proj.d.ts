 ...
 * @api
 */
export function getPointResolution(projection: ProjectionLike, resolution: number, point: import("./coordinate.js").Coordinate, opt_units?: import("./proj/Units.js").Units | undefined): number;
/**
