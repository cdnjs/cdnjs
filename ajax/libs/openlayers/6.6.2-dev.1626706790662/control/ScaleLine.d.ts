 ...
 * *
 */
export type ScaleLineOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("../events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:units" | ("propertychange" | "change:units")[], listener: (event: import("../Object.js").ObjectEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "change:units")[], listener: (event: Event | import("../events/Event.js").default) => any) => Return);
export type Options = {
    /**
     * CSS Class name.
     */
...
declare class ScaleLine extends Control {
     ...
     */
    on: ScaleLineOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {ScaleLineOnSignature<import("../Observable.js").OnReturn>}
     */
    once: ScaleLineOnSignature<import("../Observable.js").OnReturn>;
    /***
