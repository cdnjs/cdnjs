...
declare class Target extends Disposable {
     ...
     */
    addEventListener(type: string, listener: (arg0: globalThis.Event | Event) => boolean | void): void;
    /**
     ...
     */
    getListeners(type: string): ((arg0: globalThis.Event | Event) => boolean | void)[];
    /**
     ...
     * @param {import("../events.js").ListenerFunction} listener Listener.
     */
    removeEventListener(type: string, listener: (arg0: globalThis.Event | Event) => boolean | void): void;
}
