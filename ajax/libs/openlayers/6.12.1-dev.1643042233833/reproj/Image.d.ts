...
declare class ReprojImage extends ImageBase {
     ...
     */
    constructor(sourceProj: import("../proj/Projection.js").default, targetProj: import("../proj/Projection.js").default, targetExtent: number[], targetResolution: number, pixelRatio: number, getImageFunction: (arg0: number[], arg1: number, arg2: number) => ImageBase, interpolate: boolean);
    /**
     * @private
