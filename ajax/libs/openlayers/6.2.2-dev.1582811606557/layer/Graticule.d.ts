...
export type Options = {
     ...
     */
    lonLabelFormatter?: (arg0: number) => string;
    /**
     * Label formatter for
     ...
     * labels are formatted as degrees, minutes, seconds and hemisphere.
     */
    latLabelFormatter?: (arg0: number) => string;
    /**
...
declare class Graticule extends VectorLayer {
     ...
     * @type {?import("../extent.js").Extent}
     */
    renderedExtent_: import("../extent.js").Extent | null;
    /**
     ...
     */
    strategyFunction(extent: number[], resolution: number): number[][];
    /**
     ...
     */
    loaderFunction(extent: number[], resolution: number, projection: import("../proj/Projection.js").default): void;
    /**
