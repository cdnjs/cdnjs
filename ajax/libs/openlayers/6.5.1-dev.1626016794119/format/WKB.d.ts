...
declare class WKB extends FeatureFormat {
     ...
     * @api
     */
    readFeature(source: string | ArrayBuffer | ArrayBufferView, opt_options?: import("./Feature.js").ReadOptions): import("../render/Feature.js").default | Feature<any>;
    /**
     ...
     * @api
     */
    readFeatures(source: string | ArrayBuffer | ArrayBufferView, opt_options?: import("./Feature.js").ReadOptions): (import("../render/Feature.js").default | Feature<any>)[];
    /**
     ...
     * @api
     */
    readGeometry(source: string | ArrayBuffer | ArrayBufferView, opt_options?: import("./Feature.js").ReadOptions): import("../geom/Geometry.js").default;
    /**
     ...
     * @api
     */
    readProjection(source: string | ArrayBuffer | ArrayBufferView): import("../proj/Projection.js").default;
}
