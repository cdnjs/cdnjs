 ...
 * *
 */
export type SelectOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "select" | "select"[], listener: (event: SelectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "select" | "propertychange" | "change:active")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
