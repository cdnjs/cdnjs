 ...
 */
declare class CanvasLayerRenderer<LayerType extends import("../../layer/Layer.js").default<any, any>> extends LayerRenderer<any> {
    /**
     * @protected
     * @type {HTMLElement}
     */
     ...
     * @protected
     */
    protected clip(context: CanvasRenderingContext2D, frameState: import("../../PluggableMap.js").FrameState, extent: import("../../extent.js").Extent): void;
    /**
     * @param {CanvasRenderingContext2D} context Context.
     * @param {import("../../PluggableMap.js").FrameState} frameState Frame state.
     * @param {import("../../extent.js").Extent} extent Clip extent.
