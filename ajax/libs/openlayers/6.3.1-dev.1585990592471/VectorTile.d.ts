...
declare class VectorTile extends Tile {
     ...
     */
    constructor(tileCoord: import("./tilecoord.js").TileCoord, state: TileState, src: string, format: import("./format/Feature.js").default, tileLoadFunction: import("./Tile.js").LoadFunction, opt_options?: import("./Tile.js").Options | undefined);
    /**
