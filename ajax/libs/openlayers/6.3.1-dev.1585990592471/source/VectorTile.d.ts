...
declare class VectorTile extends UrlTile {
     ...
     */
    loadingTiles_: {
        [x: string]: import("./VectorTile").default;
    };
    /**
     * @private
     * @type {TileCache}
     ...
     * @inheritDoc
     */
    getTileGridForProjection(projection: any): import("../tilegrid/TileGrid.js").default;
    /**
     * @inheritDoc
     */
    getTilePixelRatio(pixelRatio: any): any;
    /**
     * @inheritDoc
     */
    getTilePixelSize(z: any, pixelRatio: any, projection: any): number[];
}
