...
declare class LineString extends SimpleGeometry {
     ...
     * @api
     */
    getCoordinateAtM(m: number, opt_extrapolate?: boolean | undefined): import("../coordinate.js").Coordinate;
    /**
     ...
     * @inheritDoc
     */
    getSimplifiedGeometryInternal(squaredTolerance: any): LineString;
    /**
     * @inheritDoc
     * @api
     */
