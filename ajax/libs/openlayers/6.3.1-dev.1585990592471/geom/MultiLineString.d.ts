...
declare class MultiLineString extends SimpleGeometry {
     ...
     */
    constructor(coordinates: Array<Array<import("../coordinate.js").Coordinate> | LineString> | Array<number>, opt_layout?: GeometryLayout | undefined, opt_ends?: Array<number> | undefined);
    /**
     * @type {Array<number>}
     * @private
     */
     ...
     * @inheritDoc
     */
    getSimplifiedGeometryInternal(squaredTolerance: any): MultiLineString;
    /**
     * @inheritDoc
     * @api
     */
