...
declare class CanvasVectorTileLayerRenderer extends CanvasTileLayerRenderer {
     ...
     */
    renderFeature(feature: import("../../Feature.js").FeatureLike, squaredTolerance: number, styles: import("../../style/Style.js").default | Array<import("../../style/Style.js").default>, executorGroup: import("../../render/canvas/BuilderGroup.js").default): boolean;
    /**
     * @param {import("../../VectorRenderTile.js").default} tile Tile.
     * @param {number} pixelRatio Pixel ratio.
     * @param {import("../../proj/Projection.js").default} projection Projection.
