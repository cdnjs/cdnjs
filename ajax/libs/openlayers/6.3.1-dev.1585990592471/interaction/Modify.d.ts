...
export class ModifyEvent extends Event {
     ...
     */
    constructor(type: ModifyEventType, features: Collection<Feature>, mapBrowserPointerEvent: import("../MapBrowserPointerEvent.js").default);
    /**
...
export type SegmentData = {
    ...
    index?: number;
    segment: Array<import("../extent.js").Extent>;
    featureSegments?: Array<SegmentData>;
};
export type Options = {
    /**
     * A function that
     ...
     * {@link module:ol/events/condition~altKeyOnly} results in a vertex deletion.
     */
    deleteCondition?: import("../events/condition.js").Condition;
    /**
     * A
     * function that takes an {@link module:ol/MapBrowserEvent~MapBrowserEvent} and
     * returns a boolean to indicate whether a new vertex should be added to the sketch
     * features. Default is {@link module:ol/events/condition~always}.
     */
    insertVertexCondition?: import("../events/condition.js").Condition;
    /**
...
declare namespace ModifyEventType {
    export const MODIFYSTART: string;
    export const MODIFYEND: string;
}
/**
 * @classdesc
