...
declare class WebGLHelper extends Disposable {
     ...
     */
    prepareDraw(frameState: import("../Map.js").FrameState, opt_disableAlphaBlend?: boolean | undefined): void;
    /**
     ...
     * @param {boolean} [opt_disableAlphaBlend] If true, no alpha blending will happen.
     */
    prepareDrawToRenderTarget(frameState: import("../Map.js").FrameState, renderTarget: import("./RenderTarget.js").default, opt_disableAlphaBlend?: boolean | undefined): void;
    /**
