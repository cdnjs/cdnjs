...
declare class Cluster extends VectorSource<any> {
     ...
     * @protected
     */
    protected features: Array<Feature<any>>;
    /**
     ...
     * @protected
     */
    protected source: VectorSource<any>;
    boundRefresh_: any;
    /**
     ...
     * @protected
     */
    protected createCluster(features: Array<Feature<any>>, extent: import("../extent.js").Extent): Feature<any>;
}
