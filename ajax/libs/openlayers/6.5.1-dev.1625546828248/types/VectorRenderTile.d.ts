...
declare class VectorRenderTile extends Tile {
     ...
     */
    getContext(layer: import("./layer/Layer.js").default<any, any>): CanvasRenderingContext2D;
    /**
     * @param {import("./layer/Layer.js").default} layer Layer.
     * @return {boolean} Tile has a rendering context for the given layer.
     */
    hasContext(layer: import("./layer/Layer.js").default<any, any>): boolean;
    /**
     * Get the Canvas for this tile.
     * @param {import("./layer/Layer.js").default} layer Layer.
     * @return {HTMLCanvasElement} Canvas.
     */
    getImage(layer: import("./layer/Layer.js").default<any, any>): HTMLCanvasElement;
    /**
     * @param {import("./layer/Layer.js").default} layer Layer.
     * @return {ReplayState} The replay state.
     */
    getReplayState(layer: import("./layer/Layer.js").default<any, any>): ReplayState;
}
