 ...
 * @api
 */
declare class BaseVectorLayer<VectorSourceType extends import("../source/Vector.js").default<any> | import("../source/VectorTile.js").default, EventTypes extends string> extends Layer<VectorSourceType, EventTypes> {
    /**
     ...
     *     order.
     */
    getRenderOrder(): (arg0: import("../Feature").default<any>, arg1: import("../Feature").default<any>) => number | null | undefined;
    /**
     ...
     * @api
     */
    setStyle(opt_style?: import("../style/Style.js").StyleLike | null): void;
}
