 ...
 *     values).
 */
export function cloneTransform(input: Array<number>, opt_output?: Array<number>, opt_dimension?: number): Array<number>;
/**
 * @param {Array<number>} input Input coordinate array.
 * @param {Array<number>} [opt_output] Output array of coordinate values.
 * @param {number} [opt_dimension] Dimension.
 ...
 */
export function identityTransform(input: Array<number>, opt_output?: Array<number>, opt_dimension?: number): Array<number>;
/**
 ...
 * @api
 */
export function getPointResolution(projection: ProjectionLike, resolution: number, point: import("./coordinate.js").Coordinate, opt_units?: import("./proj/Units.js").default): number;
/**
 ...
 * @api
 */
export function transformExtent(extent: import("./extent.js").Extent, source: ProjectionLike, destination: ProjectionLike, opt_stops?: number): import("./extent.js").Extent;
/**
