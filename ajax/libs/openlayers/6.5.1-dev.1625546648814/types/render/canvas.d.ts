 ...
 */
export function measureTextWidths(font: string, lines: Array<string>, widths: Array<number>): number;
/**
 ...
 * @type {BaseObject}
 */
export const checkedFonts: BaseObject<any>;
/**
...
export type FillStrokeState = {
     ...
     * Current FillStyle.
     */
    currentFillStyle?: import("../colorlike.js").ColorLike;
    /**
     * Current StrokeStyle.
     */
    currentStrokeStyle?: import("../colorlike.js").ColorLike;
    /**
     * Current LineCap.
     */
