...
declare class CanvasImmediateRenderer extends VectorContext {
     ...
     */
    constructor(context: CanvasRenderingContext2D, pixelRatio: number, extent: number[], transform: number[], viewRotation: number, opt_squaredTolerance?: number, opt_userTransform?: (arg0: number[], arg1?: number[], arg2?: number) => number[]);
    /**
     * @private
