 ...
 * @api
 */
export function toContext(context: CanvasRenderingContext2D, opt_options?: ToContextOptions | undefined): CanvasImmediateRenderer;
/**
 ...
 * @api
 */
export function getRenderPixel(event: import("./render/Event.js").default, pixel: number[]): number[];
export type State = {
    /**
 ...
 * {@link module:ol/render/Feature} and returns a `{number}`.
 */
export type OrderFunction = (arg0: import("./Feature.js").default<import("./geom/Geometry.js").default> | import("./render/Feature.js").default, arg1: import("./Feature.js").default<import("./geom/Geometry.js").default> | import("./render/Feature.js").default) => number;
