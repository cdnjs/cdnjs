 ...
 * *
 */
export type ViewOnSignature<Return> = ((type: "change" | "error", listener: (event: import("./events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:center" | "change:resolution" | "change:rotation", listener: (event: import("./Object.js").ObjectEvent) => any) => Return) & ((type: ("propertychange" | "change" | "error" | "change:center" | "change:resolution" | "change:rotation")[], listener: (event: import("./events/Event.js").default | Event) => any) => Return extends void | null ? void : Return[]);
/**
