 ...
 */
export function createCenterConstraint(options: ViewOptions): (arg0: number[], arg1: number, arg2: number[], arg3?: boolean, arg4?: number[]) => number[];
/**
 * @param {ViewOptions} options View options.
...
export type Constraints = {
     ...
     * Center.
     */
    center: (arg0: number[], arg1: number, arg2: number[], arg3?: boolean, arg4?: number[]) => number[];
    /**
     * Resolution.
     */
...
declare class View extends BaseObject {
     ...
     */
    calculateCenterShift(center: number[], resolution: number, rotation: number, size: number[]): number[];
    /**
