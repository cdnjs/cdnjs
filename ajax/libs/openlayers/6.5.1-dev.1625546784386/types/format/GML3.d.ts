...
declare class GML3 extends GMLBase {
     ...
     * @param {Array<*>} objectStack Node stack.
     */
    writeRing(node: Node, ring: import("../geom/LinearRing.js").default, objectStack: Array<any>): void;
    /**
     * @param {Node} node Node.
     ...
     * @param {Array<*>} objectStack Node stack.
     */
    writePointMember(node: Node, point: import("../geom/Point.js").default, objectStack: Array<any>): void;
    /**
     * @param {Node} node Node.
     ...
     * @param {Array<*>} objectStack Node stack.
     */
    writeFeatureElement(node: Element, feature: import("../Feature.js").default<any>, objectStack: Array<any>): void;
    /**
     * @param {Node} node Node.
