 ...
 * *
 */
export type TranslateOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "translatestart" | "translating" | "translateend" | ("translatestart" | "translating" | "translateend")[], listener: (event: TranslateEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "translatestart" | "translating" | "translateend")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
