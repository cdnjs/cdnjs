 ...
 * *
 */
export type DrawOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "drawstart" | "drawend" | "drawabort" | ("drawstart" | "drawend" | "drawabort")[], listener: (event: DrawEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "drawstart" | "drawend" | "drawabort")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
