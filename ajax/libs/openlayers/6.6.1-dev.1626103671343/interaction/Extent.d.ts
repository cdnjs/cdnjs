 ...
 * *
 */
export type ExtentOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "extentchanged" | "extentchanged"[], listener: (event: ExtentEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "extentchanged")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
...
declare class Extent extends PointerInteraction {
     ...
     */
    on: ExtentOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {ExtentOnSignature<import("../Observable.js").OnReturn>}
     */
    once: ExtentOnSignature<import("../Observable.js").OnReturn>;
    /***
