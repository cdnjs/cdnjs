 ...
 * *
 */
export type DragBoxOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "boxdrag" | "boxend" | "boxcancel" | ("boxdrag" | "boxend" | "boxcancel")[], listener: (event: DragBoxEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "boxdrag" | "boxend" | "boxcancel")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
...
declare class DragBox extends PointerInteraction {
     ...
     */
    on: DragBoxOnSignature<import("../Observable").OnReturn>;
    /***
     * @type {DragBoxOnSignature<import("../Observable").OnReturn>}
     */
    once: DragBoxOnSignature<import("../Observable").OnReturn>;
    /***
