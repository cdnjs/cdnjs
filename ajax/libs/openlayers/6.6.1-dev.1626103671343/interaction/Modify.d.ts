...
export class ModifyEvent extends Event {
     ...
     */
    constructor(type: string, features: Collection<import("../render/Feature.js").default | Feature<any>>, MapBrowserEvent: import("../MapBrowserEvent.js").default<any>);
    /**
...
export type SegmentData = {
     ...
     * Feature.
     */
    feature: import("../render/Feature.js").default | Feature<any>;
    /**
     * Geometry.
     */
 ...
 * *
 */
export type ModifyOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "modifystart" | "modifyend" | ("modifystart" | "modifyend")[], listener: (event: ModifyEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "modifystart" | "modifyend")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
...
declare class Modify extends PointerInteraction {
     ...
     */
    on: ModifyOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {ModifyOnSignature<import("../Observable.js").OnReturn>}
     */
    once: ModifyOnSignature<import("../Observable.js").OnReturn>;
    /***
