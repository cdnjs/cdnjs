 ...
 * *
 */
export type MousePositionOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("../events/Event.js").default) => boolean | void) => Return) & ((type: "propertychange" | "change:projection" | "change:coordinateFormat" | ("propertychange" | "change:projection" | "change:coordinateFormat")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:projection" | "change:coordinateFormat")[], listener: (event: Event | import("../events/Event.js").default) => boolean | void) => Return);
export type Options = {
    /**
     * CSS class name.
     */
