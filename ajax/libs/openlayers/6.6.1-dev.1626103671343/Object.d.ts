 ...
 * *
 */
export type ObjectOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: ObjectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
...
declare class BaseObject extends Observable {
     ...
     */
    on: ObjectOnSignature<import("./Observable.js").OnReturn>;
    /***
     * @type {ObjectOnSignature<import("./Observable.js").OnReturn>}
     */
    once: ObjectOnSignature<import("./Observable.js").OnReturn>;
    /***
