 ...
 * *
 */
export type GeolocationOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: BaseEvent) => boolean | void) => Return) & ((type: "propertychange" | "change:position" | "change:accuracy" | "change:accuracyGeometry" | "change:altitude" | "change:altitudeAccuracy" | "change:heading" | "change:projection" | "change:speed" | "change:tracking" | "change:trackingOptions" | ("propertychange" | "change:position" | "change:accuracy" | "change:accuracyGeometry" | "change:altitude" | "change:altitudeAccuracy" | "change:heading" | "change:projection" | "change:speed" | "change:tracking" | "change:trackingOptions")[], listener: (event: import("./Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "error" | "error"[], listener: (event: GeolocationError) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:position" | "change:accuracy" | "change:accuracyGeometry" | "change:altitude" | "change:altitudeAccuracy" | "change:heading" | "change:projection" | "change:speed" | "change:tracking" | "change:trackingOptions")[], listener: (event: Event | BaseEvent) => boolean | void) => Return);
/**
...
declare class Geolocation extends BaseObject {
     ...
     */
    on: GeolocationOnSignature<import("./Observable.js").OnReturn>;
    /***
     * @type {GeolocationOnSignature<import("./Observable.js").OnReturn>}
     */
    once: GeolocationOnSignature<import("./Observable.js").OnReturn>;
    /***
