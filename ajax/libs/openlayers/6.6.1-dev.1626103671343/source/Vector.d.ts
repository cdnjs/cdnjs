 ...
 * *
 */
export type VectorSourceOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "clear" | "addfeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror" | ("clear" | "addfeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror")[], listener: (event: VectorSourceEvent<any>) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "clear" | "addfeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
export type Options = {
    /**
     * Attributions.
     */
