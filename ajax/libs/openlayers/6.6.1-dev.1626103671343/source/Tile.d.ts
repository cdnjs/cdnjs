 ...
 * *
 */
export type TileSourceOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "tileloadstart" | "tileloadend" | "tileloaderror" | ("tileloadstart" | "tileloadend" | "tileloaderror")[], listener: (event: TileSourceEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "tileloadstart" | "tileloadend" | "tileloaderror")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
export type Options = {
    /**
     * Attributions.
     */
...
declare class TileSource extends Source {
     ...
     */
    on: TileSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {TileSourceOnSignature<import("../Observable.js").OnReturn>}
     */
    once: TileSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
