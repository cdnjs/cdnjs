...
function generateVersion1Options(iiifInfo) {
    ...
    return {
        ...
        formats: levelProfile.formats.concat([
            iiifInfo.imageInfo.formats === undefined
                ? []
                : iiifInfo.imageInfo.formats,
        ]),
        qualities: levelProfile.qualities.concat([
...
function generateVersion3Options(iiifInfo) {
    var levelProfile = iiifInfo.getComplianceLevelSupportedFeatures(), formats = iiifInfo.imageInfo.extraFormats === undefined
        ...
        : levelProfile.formats.concat(iiifInfo.imageInfo.extraFormats), preferredFormat = iiifInfo.imageInfo.preferredFormats !== undefined &&
    ...
    return {
        ...
        supports: iiifInfo.imageInfo.extraFeatures === undefined
            ...
            : levelProfile.supports.concat(iiifInfo.imageInfo.extraFeatures),
        formats: formats,
        qualities: iiifInfo.imageInfo.extraQualities === undefined
            ? levelProfile.qualities
            : levelProfile.qualities.concat(iiifInfo.imageInfo.extraQualities),
