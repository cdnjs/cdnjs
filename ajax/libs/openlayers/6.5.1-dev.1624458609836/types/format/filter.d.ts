 ...
 * @api
 */
export function bbox(geometryName: string, extent: import("../extent.js").Extent, opt_srsName?: string): Bbox;
/**
 ...
 * @api
 */
export function disjoint(geometryName: string, geometry: import("../geom/Geometry.js").default, opt_srsName?: string): Disjoint;
/**
 ...
 * @api
 */
export function dwithin(geometryName: string, geometry: import("../geom/Geometry.js").default, distance: number, unit: string, opt_srsName?: string): DWithin;
/**
