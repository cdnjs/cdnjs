...
declare class ExecutorGroup {
     ...
     * @template T
     */
    forEachFeatureAtCoordinate<T>(coordinate: number[], resolution: number, rotation: number, hitTolerance: number, callback: (arg0: import("../Feature.js").default | import("../../Feature.js").default<any>, arg1: import("../../geom/SimpleGeometry.js").default, arg2: number) => T, declutteredFeatures: (import("../Feature.js").default | import("../../Feature.js").default<any>)[]): T;
    /**
     * @param {import("../../transform.js").Transform} transform Transform.
     ...
     */
    execute(context: CanvasRenderingContext2D, contextScale: number, transform: number[], viewRotation: number, snapToPixel: boolean, opt_builderTypes?: any[], opt_declutterTree?: any): void;
}
