...
function renderPointGeometry(builderGroup, geometry, style, feature, opt_declutterBuilderGroup) {
    ...
    if (imageStyle) {
        ...
        if (opt_declutterBuilderGroup) {
            ...
            if (declutterMode !== 'none') {
                ...
                if (declutterMode === 'obstacle') {
                    ...
                    var imageReplay_1 = builderGroup.getBuilder(style.getZIndex(), BuilderType.IMAGE);
        ...
        var imageReplay = imageBuilderGroup.getBuilder(style.getZIndex(), BuilderType.IMAGE);
    ...
    if (textStyle && textStyle.getText()) {
        ...
        var textReplay = textBuilderGroup.getBuilder(style.getZIndex(), BuilderType.TEXT);
    ...
    if (imageStyle) {
        ...
        if (opt_declutterBuilderGroup) {
            ...
            if (declutterMode !== 'none') {
                ...
                if (declutterMode === 'obstacle') {
                    // draw in non-declutter group:
                    var imageReplay_2 = builderGroup.getBuilder(style.getZIndex(), BuilderType.IMAGE);
