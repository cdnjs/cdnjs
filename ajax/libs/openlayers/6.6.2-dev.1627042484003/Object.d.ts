 ...
 * *
 */
export type ObjectOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => any) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: ObjectEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange")[], listener: (event: globalThis.Event | Event) => any) => Return);
