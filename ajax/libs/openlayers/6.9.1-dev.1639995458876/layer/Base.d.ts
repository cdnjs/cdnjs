 ...
 * *
 */
export type BaseLayerOnSignature<Return> = ((type: "change" | "error", listener: (event: import("../events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:extent" | "change:maxResolution" | "change:maxZoom" | "change:minResolution" | "change:minZoom" | "change:opacity" | "change:visible" | "change:zIndex", listener: (event: import("../Object.js").ObjectEvent) => any) => Return) & ((type: ("propertychange" | "change" | "error" | "change:extent" | "change:maxResolution" | "change:maxZoom" | "change:minResolution" | "change:minZoom" | "change:opacity" | "change:visible" | "change:zIndex")[], listener: (event: import("../events/Event.js").default | Event) => any) => Return extends void | null ? void : Return[]);
export type Options = {
    /**
...
declare class BaseLayer extends BaseObject {
     ...
     */
    getBackground(): string | false | ((arg0: number) => string);
    /**
     ...
     */
    getLayersArray(opt_array?: import("./Layer.js").default<any, any>[] | undefined): import("./Layer.js").default<any, any>[];
    /**
     * @abstract
     ...
     */
    setBackground(opt_background?: string | ((arg0: number) => string) | undefined): void;
    /**
