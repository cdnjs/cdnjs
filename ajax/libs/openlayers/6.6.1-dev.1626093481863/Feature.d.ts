 ...
 * *
 */
export type FeatureOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("./events/Event.js").default) => boolean | void) => Return) & ((type: "propertychange" | "change:geometry" | ("propertychange" | "change:geometry")[], listener: (event: import("./Object.js").ObjectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:geometry")[], listener: (event: Event | import("./events/Event.js").default) => boolean | void) => Return);
/**
...
declare class Feature<Geometry extends import("./geom/Geometry.js").default> extends BaseObject {
     ...
     */
    setStyle(opt_style?: import("./style/Style.js").default | import("./style/Style.js").default[] | ((arg0: import("./render/Feature.js").default | Feature<any>, arg1: number) => void | import("./style/Style.js").default | import("./style/Style.js").default[])): void;
    /**
