...
export type Options<SourceType extends import("../source/Source.js").default<any>> = {
    /**
 ...
 * @api
 */
declare class Layer<SourceType extends import("../source/Source.js").default<any>, EventTypes extends string> extends BaseLayer<"prerender" | EventTypes | "postrender"> {
    /**
     ...
     */
    getFeatures(pixel: import("../pixel").Pixel): Promise<Array<import("../Feature").default<any>>>;
    /**
