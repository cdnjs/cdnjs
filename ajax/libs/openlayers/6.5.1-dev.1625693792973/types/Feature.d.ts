...
export type FeatureLike = Feature<any> | import("./render/Feature.js").default;
/**
 ...
 */
declare class Feature<Geometry extends import("./geom/Geometry.js").default> extends BaseObject<"change:geometry"> {
    /**
     ...
     */
    setStyle(opt_style?: import("./style/Style.js").StyleLike): void;
    /**
