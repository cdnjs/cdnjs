 ...
 * @api
 */
declare class View extends BaseObject<"change:center" | "change:resolution" | "change:rotation"> {
    /**
     ...
     */
    setViewportSize(opt_size?: import("./size.js").Size): void;
    /**
     * Get the view center.
     ...
     */
    getHints(opt_hints?: Array<number>): Array<number>;
    /**
     ...
     * @api
     */
    calculateExtent(opt_size?: import("./size.js").Size): import("./extent.js").Extent;
    /**
     * @param {import("./size.js").Size} [opt_size] Box pixel size. If not provided,
     * the map's last known viewport size will be used.
     * @return {import("./extent.js").Extent} Extent.
     */
    calculateExtentInternal(opt_size?: import("./size.js").Size): import("./extent.js").Extent;
    /**
     ...
     * @api
     */
    getResolutionForExtent(extent: import("./extent.js").Extent, opt_size?: import("./size.js").Size): number;
    /**
     * Get the resolution for a provided extent (in map units) and size (in pixels).
     * @param {import("./extent.js").Extent} extent Extent.
     * @param {import("./size.js").Size} [opt_size] Box pixel size.
     ...
     *     the given size.
     */
    getResolutionForExtentInternal(extent: import("./extent.js").Extent, opt_size?: import("./size.js").Size): number;
    /**
     ...
     * @api
     */
    fit(geometryOrExtent: import("./geom/SimpleGeometry.js").default | import("./extent.js").Extent, opt_options?: FitOptions): void;
    /**
     ...
     * @api
     */
    adjustResolution(ratio: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     * Multiply the view resolution by a ratio, optionally using an anchor. Any resolution
     * constraint will apply.
     * @param {number} ratio The ratio to apply on the view resolution.
     * @param {import("./coordinate.js").Coordinate} [opt_anchor] The origin of the transformation.
     */
    adjustResolutionInternal(ratio: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     ...
     * @api
     */
    adjustZoom(delta: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     ...
     * @api
     */
    adjustRotation(delta: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     * @param {number} delta Relative value to add to the zoom rotation, in radians.
     * @param {import("./coordinate.js").Coordinate} [opt_anchor] The rotation center.
     */
    adjustRotationInternal(delta: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     ...
     * @param {import("./coordinate.js").Coordinate} [opt_anchor] The origin of the transformation.
     */
    resolveConstraints(opt_duration?: number, opt_resolutionDirection?: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     ...
     * @api
     */
    endInteraction(opt_duration?: number, opt_resolutionDirection?: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     * Notify the View that an interaction has ended. The view state will be resolved
     * to a stable one if needed (depending on its constraints).
     * @param {number} [opt_duration] Animation duration in ms.
     ...
     * @param {import("./coordinate.js").Coordinate} [opt_anchor] The origin of the transformation.
     */
    endInteractionInternal(opt_duration?: number, opt_resolutionDirection?: number, opt_anchor?: import("./coordinate.js").Coordinate): void;
    /**
     ...
     */
    getConstrainedCenter(targetCenter: import("./coordinate.js").Coordinate | undefined, opt_targetResolution?: number): import("./coordinate.js").Coordinate | undefined;
    /**
