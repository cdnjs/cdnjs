...
declare class VectorSource<Geometry extends import("../geom/Geometry.js").default = import("../geom/Geometry.js").default> extends Source {
     ...
     */
    constructor(opt_options?: Options<Geometry> | undefined);
    /***
     ...
     * @api
     */
    getFeaturesInExtent(extent: import("../extent.js").Extent, opt_projection?: import("../proj/Projection.js").default | undefined): Array<import("../Feature.js").default<Geometry>>;
    /**
