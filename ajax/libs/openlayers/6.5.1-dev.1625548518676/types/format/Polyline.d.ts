 ...
 * @api
 */
export function encodeDeltas(numbers: Array<number>, stride: number, opt_factor?: number): string;
/**
 ...
 * @api
 */
export function decodeDeltas(encoded: string, stride: number, opt_factor?: number): Array<number>;
/**
 ...
 * @api
 */
export function encodeFloats(numbers: Array<number>, opt_factor?: number): string;
/**
 ...
 * @api
 */
export function decodeFloats(encoded: string, opt_factor?: number): Array<number>;
/**
