 ...
 */
export type Loader = (arg0: number, arg1: number, arg2: number) => DataView | Uint8Array | Uint8ClampedArray | Float32Array | Promise<DataView | Uint8Array | Uint8ClampedArray | Float32Array>;
export type Options = {
    /**
     * Data loader.  Called with z, x, and y tile coordinates.
     * Returns {@link import("../DataTile.js").Data data} for a tile or a promise for the same.
     */
    loader?: (arg0: number, arg1: number, arg2: number) => DataView | Uint8Array | Uint8ClampedArray | Float32Array | Promise<DataView | Uint8Array | Uint8ClampedArray | Float32Array>;
    /**
...
declare class DataTileSource extends TileSource {
     ...
     * @protected
     */
    protected setLoader(loader: (arg0: number, arg1: number, arg2: number) => DataView | Uint8Array | Uint8ClampedArray | Float32Array | Promise<DataView | Uint8Array | Uint8ClampedArray | Float32Array>): void;
    /**
     * @abstract
