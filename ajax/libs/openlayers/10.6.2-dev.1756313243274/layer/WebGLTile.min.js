import{ColorType,NumberType}from"../expr/expression.js";import{PALETTE_TEXTURE_ARRAY,getStringNumberEquivalent,newCompilationContext,uniformNameForVariable}from"../expr/gpu.js";import LayerProperty from"../layer/Property.js";import{expressionToGlsl}from"../render/webgl/compileUtil.js";import WebGLTileLayerRenderer,{Attributes,Uniforms}from"../renderer/webgl/TileLayer.js";import BaseTileLayer from"./BaseTile.js";function parseStyle(r,e){var t=`
  ...
  `;const o={...newCompilationContext(),bandCount:e},s=[],i=(void 0!==r.color&&(u=expressionToGlsl(o,r.color,ColorType),s.push(`color = ${u};`)),void 0!==r.contrast&&(u=expressionToGlsl(o,r.contrast,NumberType),s.push(`color.rgb = clamp((${u} + 1.0) * color.rgb - (${u} / 2.0), vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)),void 0!==r.exposure&&(u=expressionToGlsl(o,r.exposure,NumberType),s.push(`color.rgb = clamp((${u} + 1.0) * color.rgb, vec3(0.0, 0.0, 0.0), vec3(1.0, 1.0, 1.0));`)),void 0!==r.saturation&&(u=expressionToGlsl(o,r.saturation,NumberType),s.push(`
