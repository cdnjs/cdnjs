...
declare class LayerRenderer<LayerType extends import("../layer/Layer.js").default<any>> extends Observable {
     ...
     * @template T
     */
    forEachFeatureAtCoordinate<T>(coordinate: import("../coordinate.js").Coordinate, frameState: import("../PluggableMap.js").FrameState, hitTolerance: number, callback: (arg0: import("../Feature.js").FeatureLike, arg1: import("../layer/Layer.js").default) => T, declutteredFeatures: Array<import("../Feature.js").FeatureLike>): void | T;
    /**
     * @abstract
     * @param {import("../pixel.js").Pixel} pixel Pixel.
