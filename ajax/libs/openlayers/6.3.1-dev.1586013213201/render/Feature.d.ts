...
declare class RenderFeature {
     ...
     */
    constructor(type: GeometryType, flatCoordinates: Array<number>, ends: Array<number> | Array<Array<number>>, properties: {
        [x: string]: any;
     ...
     */
    transform(source: import("../proj.js").ProjectionLike, destination: import("../proj.js").ProjectionLike): void;
