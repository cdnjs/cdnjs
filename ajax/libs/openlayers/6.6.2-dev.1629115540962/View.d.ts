 ...
 * *
 */
export type ViewOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("./events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:center" | "change:resolution" | "change:rotation" | ("propertychange" | "change:center" | "change:resolution" | "change:rotation")[], listener: (event: import("./Object.js").ObjectEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "change:center" | "change:resolution" | "change:rotation")[], listener: (event: Event | import("./events/Event.js").default) => any) => Return);
/**
...
declare class View extends BaseObject {
     ...
     */
    on: ViewOnSignature<import("./Observable.js").OnReturn>;
    /***
     * @type {ViewOnSignature<import("./Observable.js").OnReturn>}
     */
    once: ViewOnSignature<import("./Observable.js").OnReturn>;
    /***
