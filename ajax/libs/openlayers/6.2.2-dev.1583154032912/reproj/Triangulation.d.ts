...
declare class Triangulation {
     ...
     */
    constructor(sourceProj: import("../proj/Projection.js").default, targetProj: import("../proj/Projection.js").default, targetExtent: number[], maxSourceExtent: number[], errorThreshold: number);
    /**
