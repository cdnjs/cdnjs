 ...
 */
declare class LayerRenderer<LayerType extends import("../layer/Layer.js").default<any, any>> extends Observable<any> {
    /**
     ...
     */
    getFeatures(pixel: import("../pixel.js").Pixel): Promise<Array<import("../Feature").default<any>>>;
    /**
     ...
     * @protected
     */
    protected createLoadedTileFinder(source: import("../source/Tile.js").default<any>, projection: import("../proj/Projection.js").default, tiles: {
        [x: number]: {
            [x: string]: import("../Tile.js").default;
        };
     ...
     * @template T
     */
    forEachFeatureAtCoordinate<T>(coordinate: import("../coordinate.js").Coordinate, frameState: import("../PluggableMap.js").FrameState, hitTolerance: number, callback: import("./vector.js").FeatureCallback<T>, matches: import("./Map.js").HitMatch<T>[]): T;
    /**
     * @abstract
     * @param {import("../pixel.js").Pixel} pixel Pixel.
