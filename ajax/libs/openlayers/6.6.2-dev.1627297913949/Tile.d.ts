 ...
 */
export type UrlFunction = (arg0: number[], arg1: number, arg2: import("./proj/Projection.js").default) => string;
export type Options = {
    /**
...
declare class Tile extends EventTarget {
     ...
     */
    constructor(tileCoord: number[], state: any, opt_options?: Options);
    /**
