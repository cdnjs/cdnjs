 ...
 * *
 */
export type TranslateOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => any) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => any) => Return) & ((type: "translatestart" | "translating" | "translateend" | ("translatestart" | "translating" | "translateend")[], listener: (event: TranslateEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "translatestart" | "translating" | "translateend")[], listener: (event: globalThis.Event | Event) => any) => Return);
...
declare class Translate extends PointerInteraction {
     ...
     */
    on: TranslateOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {TranslateOnSignature<import("../Observable.js").OnReturn>}
     */
    once: TranslateOnSignature<import("../Observable.js").OnReturn>;
    /***
