...
import { formatArray, formatColor, formatNumber, getSymbolFragmentShader, getSymbolVertexShader } from '../webgl/ShaderBuilder.js';
...
var WebGLPointsLayer = /** @class */ (function (_super) {
    ...
    WebGLPointsLayer.prototype.createRenderer = function () {
        var symbolStyle = this.style.symbol;
        var size = Array.isArray(symbolStyle.size) ?
            formatArray(symbolStyle.size) : formatNumber(symbolStyle.size);
        var color = symbolStyle.color !== undefined ?
            (typeof symbolStyle.color === 'string' ? asArray(symbolStyle.color) : symbolStyle.color) :
            [255, 255, 255, 1];
        var texCoord = symbolStyle.textureCoord || [0, 0, 1, 1];
        var offset = symbolStyle.offset || [0, 0];
        var opacity = symbolStyle.opacity !== undefined ? symbolStyle.opacity : 1;
