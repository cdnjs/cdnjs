...
}`}getStrokeVertexShader(){return`#ifdef GL_FRAGMENT_PRECISION_HIGH
...
void main(void) {
  ...
  v_hitColor = a_hitColor;
${this.varyings_.map(function(t){return"  "+t.name+" = "+t.expression+";"}).join("\n")}
}`}getStrokeFragmentShader(){return`#ifdef GL_FRAGMENT_PRECISION_HIGH
precision highp float;
#else
precision mediump float;
#endif
...
}`}getFillVertexShader(){return`#ifdef GL_FRAGMENT_PRECISION_HIGH
precision highp float;
#else
precision mediump float;
#endif
...
${this.varyings_.map(function(t){return"  "+t.name+" = "+t.expression+";"}).join("\n")}
}`}getFillFragmentShader(){return`#ifdef GL_FRAGMENT_PRECISION_HIGH
precision highp float;
#else
precision mediump float;
#endif
