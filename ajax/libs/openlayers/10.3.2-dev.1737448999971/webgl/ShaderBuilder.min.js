import{colorToGlsl,numberToGlsl,stringToGlsl}from"../expr/gpu.js";import{LINESTRING_ANGLE_COSINE_CUTOFF}from"../render/webgl/utils.js";import{createDefaultStyle}from"../style/flat.js";const COMMON_HEADER=`#ifdef GL_FRAGMENT_PRECISION_HIGH
