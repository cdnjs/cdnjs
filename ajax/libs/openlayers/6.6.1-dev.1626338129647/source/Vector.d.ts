...
export class VectorSourceEvent<Geometry extends import("../geom/Geometry.js").default> extends Event {
     ...
     */
    constructor(type: string, opt_feature?: import("../Feature.js").default<Geometry>, opt_features?: import("../Feature.js").default<Geometry>[]);
    /**
 ...
 * is one of the standard {@link module:ol/loadingstrategy} strategies.
 */
export type LoadingStrategy = (arg0: number[], arg1: number) => number[][];
/**
 * *
 */
export type VectorSourceOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => any) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: import("../Object.js").ObjectEvent) => any) => Return) & ((type: "clear" | "addfeature" | "changefeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror" | ("clear" | "addfeature" | "changefeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror")[], listener: (event: VectorSourceEvent<any>) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "clear" | "addfeature" | "changefeature" | "removefeature" | "featuresloadstart" | "featuresloadend" | "featuresloaderror")[], listener: (event: globalThis.Event | Event) => any) => Return);
export type Options = {
    /**
     * Attributions.
     */
     ...
     * ```
     */
    loader?: (this: import("../VectorTile.js").default | VectorSource<any>, arg1: number[], arg2: number, arg3: import("../proj/Projection.js").default, arg4?: (arg0: import("../Feature.js").default<any>[]) => void, arg5?: () => void) => void;
    /**
     ...
     */
    strategy?: (arg0: number[], arg1: number) => number[][];
    /**
...
declare class VectorSource<Geometry extends import("../geom/Geometry.js").default> extends Source {
     ...
     */
    on: VectorSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {VectorSourceOnSignature<import("../Observable.js").OnReturn>}
     */
    once: VectorSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
     ...
     * @template T
     */
    forEachFeatureAtCoordinateDirect<T_1>(coordinate: number[], callback: (arg0: import("../Feature.js").default<Geometry>) => T_1): T_1;
    /**
     ...
     * @api
     */
    forEachFeatureInExtent<T_2>(extent: number[], callback: (arg0: import("../Feature.js").default<Geometry>) => T_2): T_2;
    /**
     ...
     * @api
     */
    forEachFeatureIntersectingExtent<T_3>(extent: number[], callback: (arg0: import("../Feature.js").default<Geometry>) => T_3): T_3;
    /**
     ...
     * @api
     */
    getClosestFeatureToCoordinate(coordinate: number[], opt_filter?: (arg0: import("../Feature.js").default<Geometry>) => boolean): import("../Feature.js").default<Geometry>;
    /**
     ...
     * @api
     */
    getUrl(): string | ((arg0: number[], arg1: number, arg2: import("../proj/Projection.js").default) => string);
    /**
     ...
     * @api
     */
    setLoader(loader: (this: import("../VectorTile.js").default | VectorSource<any>, arg1: number[], arg2: number, arg3: import("../proj/Projection.js").default, arg4?: (arg0: import("../Feature.js").default<any>[]) => void, arg5?: () => void) => void): void;
    /**
