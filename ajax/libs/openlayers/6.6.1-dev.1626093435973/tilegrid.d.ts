 ...
 */
export function createForExtent(extent: number[], opt_maxZoom?: number, opt_tileSize?: number | number[], opt_corner?: any): TileGrid;
/**
 ...
 * @return {!TileGrid} TileGrid instance.
 */
export function createForProjection(projection: string | import("./proj/Projection.js").default, opt_maxZoom?: number, opt_tileSize?: number | number[], opt_corner?: any): TileGrid;
/**
