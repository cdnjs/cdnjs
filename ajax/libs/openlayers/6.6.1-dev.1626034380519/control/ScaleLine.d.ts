 ...
 * *
 */
export type ScaleLineOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("../events/Event.js").default) => boolean | void) => Return) & ((type: "propertychange" | "change:units" | ("propertychange" | "change:units")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:units")[], listener: (event: Event | import("../events/Event.js").default) => boolean | void) => Return);
export type Options = {
    /**
     * CSS Class name.
     */
