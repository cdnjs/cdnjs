 ...
 * *
 */
export type ViewOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("./events/Event.js").default) => boolean | void) => Return) & ((type: "propertychange" | "change:center" | "change:resolution" | "change:rotation" | ("propertychange" | "change:center" | "change:resolution" | "change:rotation")[], listener: (event: import("./Object.js").ObjectEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:center" | "change:resolution" | "change:rotation")[], listener: (event: Event | import("./events/Event.js").default) => boolean | void) => Return);
/**
