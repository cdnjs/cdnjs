...
var VectorTile = /** @class */ (function (_super) {
    ...
    VectorTile.prototype.getTile = function (z, x, y, pixelRatio, projection) {
        ...
        var newTile = new VectorRenderTile(tileCoord, urlTileCoord !== null ? TileState.IDLE : TileState.EMPTY, urlTileCoord, this.tileGrid, this.getSourceTiles.bind(this, pixelRatio, projection), this.removeSourceTiles.bind(this));
        newTile.key = key;
        if (tile) {
