 ...
 * *
 */
export type GroupOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("../events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:extent" | "change:maxResolution" | "change:maxZoom" | "change:minResolution" | "change:minZoom" | "change:opacity" | "change:visible" | "change:zIndex" | "change:layers" | ("propertychange" | "change:extent" | "change:maxResolution" | "change:maxZoom" | "change:minResolution" | "change:minZoom" | "change:opacity" | "change:visible" | "change:zIndex" | "change:layers")[], listener: (event: import("../Object.js").ObjectEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "change:extent" | "change:maxResolution" | "change:maxZoom" | "change:minResolution" | "change:minZoom" | "change:opacity" | "change:visible" | "change:zIndex" | "change:layers")[], listener: (event: Event | import("../events/Event.js").default) => any) => Return);
export type Options = {
    /**
     * Opacity (0, 1).
     */
...
declare class LayerGroup extends BaseLayer {
     ...
     */
    on: GroupOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {GroupOnSignature<import("../Observable.js").OnReturn>}
     */
    once: GroupOnSignature<import("../Observable.js").OnReturn>;
    /***
