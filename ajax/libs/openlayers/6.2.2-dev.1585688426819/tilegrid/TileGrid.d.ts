...
declare class TileGrid {
     ...
     */
    forEachTileCoordParentTileRange(tileCoord: number[], callback: (arg0: number, arg1: TileRange) => boolean, opt_tileRange?: TileRange, opt_extent?: number[]): boolean;
    /**
     ...
     */
    getTileCoordChildTileRange(tileCoord: number[], opt_tileRange?: TileRange, opt_extent?: number[]): TileRange;
    /**
     ...
     * @return {import("../extent.js").Extent} Extent.
     */
    getTileRangeExtent(z: number, tileRange: TileRange, opt_extent?: number[]): number[];
    /**
     ...
     * @return {import("../TileRange.js").default} Tile range.
     */
    getTileRangeForExtentAndZ(extent: number[], z: number, opt_tileRange?: TileRange): TileRange;
    /**
     * @param {import("../tilecoord.js").TileCoord} tileCoord Tile coordinate.
     ...
     * @api
     */
    getTileCoordExtent(tileCoord: number[], opt_extent?: number[]): number[];
    /**
     ...
     * @api
     */
    getTileCoordForCoordAndResolution(coordinate: number[], resolution: number, opt_tileCoord?: number[]): number[];
    /**
     ...
     * @api
     */
    getTileCoordForCoordAndZ(coordinate: number[], z: number, opt_tileCoord?: number[]): number[];
    /**
     * @param {import("../tilecoord.js").TileCoord} tileCoord Tile coordinate.
