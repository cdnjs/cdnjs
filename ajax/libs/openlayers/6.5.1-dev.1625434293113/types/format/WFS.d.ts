...
declare class WFS extends XMLFeature {
     ...
     */
    combineBboxAndFilter(geometryName: string, extent: import("../extent.js").Extent, opt_srsName?: string, opt_filter?: import("./filter/Filter.js").default): import("./filter/Filter.js").default;
    /**
     ...
     * @api
     */
    writeTransaction(inserts: Array<import("../Feature.js").default<any>>, updates: Array<import("../Feature.js").default<any>>, deletes: Array<import("../Feature.js").default<any>>, options: WriteTransactionOptions): Node;
}
