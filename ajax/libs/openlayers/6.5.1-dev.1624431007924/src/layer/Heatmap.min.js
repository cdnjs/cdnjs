import VectorLayer from"./Vector.js";import WebGLPointsLayerRenderer from"../renderer/webgl/PointsLayer.js";import{assign}from"../obj.js";import{clamp}from"../math.js";import{createCanvasContext2D}from"../dom.js";const Property={BLUR:"blur",GRADIENT:"gradient",RADIUS:"radius"},DEFAULT_GRADIENT=["#00f","#0ff","#0f0","#ff0","#f00"];class Heatmap extends VectorLayer{constructor(e){e=e||{};const t=assign({},e),r=(delete t.gradient,delete t.radius,delete t.blur,delete t.weight,super(t),this.gradient_=null,this.addChangeListener(Property.GRADIENT,this.handleGradientChanged_),this.setGradient(e.gradient||DEFAULT_GRADIENT),this.setBlur(void 0!==e.blur?e.blur:15),this.setRadius(void 0!==e.radius?e.radius:8),e.weight||"weight");"string"==typeof r?this.weightFunction_=function(e){return e.get(r)}:this.weightFunction_=r,this.setRenderOrder(null)}getBlur(){return this.get(Property.BLUR)}getGradient(){return this.get(Property.GRADIENT)}getRadius(){return this.get(Property.RADIUS)}handleGradientChanged_(){this.gradient_=createGradient(this.getGradient())}setBlur(e){this.set(Property.BLUR,e)}setGradient(e){this.set(Property.GRADIENT,e)}setRadius(e){this.set(Property.RADIUS,e)}createRenderer(){return new WebGLPointsLayerRenderer(this,{className:this.getClassName(),attributes:[{name:"weight",callback:function(e){e=this.weightFunction_(e);return void 0!==e?clamp(e,0,1):1}.bind(this)}],vertexShader:`
        ...
        void main(void) {
          ...
          gl_FragColor = v_hitColor;
            ...
            }`,uniforms:{u_gradientTexture:function(){return this.gradient_}.bind(this)}}]})}renderDeclutter(){}}function createGradient(r){const e=createCanvasContext2D(1,256),i=e.createLinearGradient(0,0,1,256);var o=1/(r.length-1);for(let e=0,t=r.length;e<t;++e)i.addColorStop(e*o,r[e]);return e.fillStyle=i,e.fillRect(0,0,1,256),e.canvas}export default Heatmap;