 ...
 * @api
 */
export function createStringXY(opt_fractionDigits?: number): (arg0: number[]) => string;
/**
 ...
 * @api
 */
export function format(coordinate: number[], template: string, opt_fractionDigits?: number): string;
/**
 ...
 * @api
 */
export function toStringHDMS(coordinate: number[], opt_fractionDigits?: number): string;
/**
 ...
 * @api
 */
export function toStringXY(coordinate: number[], opt_fractionDigits?: number): string;
/**
 ...
 */
export function getWorldsAway(coordinate: number[], projection: import("./proj/Projection.js").default, opt_sourceExtentWidth?: number): number;
/**
 * An array of numbers representing an xy coordinate. Example: `[16, 48]`.
 */
 ...
 * transforms it into a `{string}`.
 */
export type CoordinateFormat = (arg0: number[]) => string;
