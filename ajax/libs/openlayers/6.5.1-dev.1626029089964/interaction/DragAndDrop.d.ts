 ...
 * *
 */
export type DragAndDropOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "change:active" | ("propertychange" | "change:active")[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "addfeatures" | "addfeatures"[], listener: (event: DragAndDropEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "change:active" | "addfeatures")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
