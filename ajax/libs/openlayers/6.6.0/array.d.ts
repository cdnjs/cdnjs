 ...
 */
export function binarySearch(haystack: any[], needle: any, opt_comparator?: Function): number;
/**
 ...
 */
export function find<VALUE>(arr: VALUE[], func: (arg0: VALUE, arg1: number, arg2: any) => boolean): VALUE;
/**
 ...
 */
export function isSorted(arr: any[], opt_func?: Function, opt_strict?: boolean): boolean;
/**
 * {@link module:ol/tilegrid/TileGrid~TileGrid#getZForResolution} can use a function
 * of this type to determine which nearest resolution to use.
 *
