 ...
 * *
 */
export type FeatureOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: import("./events/Event.js").default) => any) => Return) & ((type: "propertychange" | "change:geometry" | ("propertychange" | "change:geometry")[], listener: (event: import("./Object.js").ObjectEvent) => any) => Return) & ((type: ("error" | "change" | "propertychange" | "change:geometry")[], listener: (event: Event | import("./events/Event.js").default) => any) => Return);
/**
 * *
 */
...
declare class Feature<Geometry extends import("./geom/Geometry.js").default> extends BaseObject {
     ...
     */
    on: FeatureOnSignature<import("./Observable.js").OnReturn>;
    /***
     * @type {FeatureOnSignature<import("./Observable.js").OnReturn>}
     */
    once: FeatureOnSignature<import("./Observable.js").OnReturn>;
    /***
