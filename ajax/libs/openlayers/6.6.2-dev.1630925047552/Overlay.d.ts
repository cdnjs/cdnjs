...
declare class Overlay extends BaseObject {
     ...
     */
    on: OverlayOnSignature<import("./Observable").OnReturn>;
    /***
     * @type {OverlayOnSignature<import("./Observable").OnReturn>}
     */
    once: OverlayOnSignature<import("./Observable").OnReturn>;
    /***
