 ...
 * @private
 */
export function normalizeSourceUrl(url: string, token: string, tokenParam: string): string;
...
export type Options = {
     ...
     */
    renderOrder?: (arg0: import("../Feature.js").default<import("../geom/Geometry.js").default> | RenderFeature, arg1: import("../Feature.js").default<import("../geom/Geometry.js").default> | RenderFeature) => number;
    /**
