...
export type Options = {
     ...
     */
    loader?: (arg0: number, arg1: number, arg2: number) => Promise<DataView | Uint8Array | Uint8ClampedArray>;
    /**
...
declare class DataTileSource extends TileSource {
     ...
     * @protected
     */
    protected setLoader(loader: (arg0: number, arg1: number, arg2: number) => Promise<DataView | Uint8Array | Uint8ClampedArray>): void;
    /**
     * @abstract
