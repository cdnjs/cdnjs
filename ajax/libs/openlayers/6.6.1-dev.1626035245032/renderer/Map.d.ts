...
export type HitMatch<T> = {
     ...
     * Callback.
     */
    callback: (arg0: import("../render/Feature.js").default | import("../Feature.js").default<any>, arg1: import("../layer/Layer.js").default<any>, arg2: import("../geom/SimpleGeometry.js").default) => T;
};
/**
 * @typedef HitMatch
...
declare class MapRenderer extends Disposable {
     ...
     * @template S,T,U
     */
    forEachFeatureAtCoordinate<S, T, U>(coordinate: number[], frameState: import("../PluggableMap.js").FrameState, hitTolerance: number, checkWrapped: boolean, callback: (arg0: import("../render/Feature.js").default | import("../Feature.js").default<any>, arg1: import("../layer/Layer.js").default<any>, arg2: import("../geom/SimpleGeometry.js").default) => T, thisArg: S, layerFilter: (this: U, arg1: import("../layer/Layer.js").default<any>) => boolean, thisArg2: U): T;
    /**
     * @abstract
     ...
     * @template T
     */
    forEachLayerAtPixel<T_1>(pixel: number[], frameState: import("../PluggableMap.js").FrameState, hitTolerance: number, callback: (arg0: import("../layer/Layer.js").default<any>, arg1: Uint8Array | Uint8ClampedArray) => T_1, layerFilter: (arg0: import("../layer/Layer.js").default<any>) => boolean): T_1;
    /**
     * @param {import("../coordinate.js").Coordinate} coordinate Coordinate.
     * @param {import("../PluggableMap.js").FrameState} frameState FrameState.
     * @param {number} hitTolerance Hit tolerance in pixels.
