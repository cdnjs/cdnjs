...
declare class ExecutorGroup {
     ...
     * @template T
     */
    forEachFeatureAtCoordinate<T>(coordinate: number[], resolution: number, rotation: number, hitTolerance: number, callback: (arg0: import("../../Feature.js").default<import("../../geom/Geometry.js").default> | import("../Feature.js").default, arg1: import("../../geom/SimpleGeometry.js").default, arg2: number) => T, declutteredFeatures: (import("../../Feature.js").default<import("../../geom/Geometry.js").default> | import("../Feature.js").default)[]): T | undefined;
    /**
     * @param {import("../../transform.js").Transform} transform Transform.
