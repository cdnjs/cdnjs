...
var CanvasVectorImageLayerRenderer = /** @class */ (function (_super) {
    ...
    CanvasVectorImageLayerRenderer.prototype.prepareFrame = function (frameState) {
        ...
        if (!hints[ViewHint.ANIMATING] &&
            ...
            var imageLayerState = Object.assign({}, layerState, { opacity: 1 });
            var imageFrameState_1 = 
            /** @type {import("../../PluggableMap.js").FrameState} */ (Object.assign({}, frameState, {
                declutterTree: new RBush(9),
                extent: renderedExtent,
                size: [width, height],
                viewState: /** @type {import("../../View.js").State} */ (Object.assign({}, frameState.viewState, {
                    rotation: 0,
                })),
