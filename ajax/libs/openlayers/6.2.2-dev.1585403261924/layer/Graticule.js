...
import { applyTransform, containsCoordinate, containsExtent, equals, getCenter, getHeight, getIntersection, getWidth, intersects, isEmpty } from '../extent.js';
...
var Graticule = /** @class */ (function (_super) {
    ...
    Graticule.prototype.createGraticule_ = function (extent, center, resolution, squaredTolerance) {
        ...
        var maxLat = clamp(validExtent[3], centerLat, this.maxLat_);
        var maxLon = clamp(validExtent[2], centerLon, this.maxLon_);
        var minLat = clamp(validExtent[1], this.minLat_, centerLat);
        var minLon = clamp(validExtent[0], this.minLon_, centerLon);
        // Create meridians
