 ...
 * @api
 */
export function circular(center: import("../coordinate.js").Coordinate, radius: number, opt_n?: number, opt_sphereRadius?: number): Polygon;
/**
 ...
 *     counter-clockwise radians. 0 means East. Default is 0.
 */
export function makeRegular(polygon: Polygon, center: import("../coordinate.js").Coordinate, radius: number, opt_angle?: number): void;
...
declare class Polygon extends SimpleGeometry {
     ...
     */
    constructor(coordinates: Array<Array<import("../coordinate.js").Coordinate>> | Array<number>, opt_layout?: any, opt_ends?: Array<number>);
    /**
     * @type {Array<number>}
     * @private
     */
