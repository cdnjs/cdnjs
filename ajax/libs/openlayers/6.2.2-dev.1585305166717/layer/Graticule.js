...
import { applyTransform, containsCoordinate, equals, getCenter, getHeight, getIntersection, getWidth, intersects, isEmpty } from '../extent.js';
...
var Graticule = /** @class */ (function (_super) {
    ...
    Graticule.prototype.drawLabels_ = function (event) {
        ...
        var rotationCenter, rotationExtent;
        if (rotation) {
