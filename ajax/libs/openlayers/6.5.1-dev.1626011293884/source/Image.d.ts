 ...
 * *
 */
export type ImageSourceOnSignature<Return> = ((type: "error" | "change" | ("error" | "change")[], listener: (event: Event) => boolean | void) => Return) & ((type: "propertychange" | "propertychange"[], listener: (event: import("../Object.js").ObjectEvent) => boolean | void) => Return) & ((type: "imageloadstart" | "imageloadend" | "imageloaderror" | ("imageloadstart" | "imageloadend" | "imageloaderror")[], listener: (event: ImageSourceEvent) => boolean | void) => Return) & ((type: ("error" | "change" | "propertychange" | "imageloadstart" | "imageloadend" | "imageloaderror")[], listener: (event: globalThis.Event | Event) => boolean | void) => Return);
export type Options = {
    /**
     * Attributions.
     */
...
declare class ImageSource extends Source {
     ...
     */
    on: ImageSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
     * @type {ImageSourceOnSignature<import("../Observable.js").OnReturn>}
     */
    once: ImageSourceOnSignature<import("../Observable.js").OnReturn>;
    /***
