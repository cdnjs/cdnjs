 ...
 */
export function expressionToGlsl(context: ParsingContext, value: string | number | boolean | any[] | number[], typeHint?: number): string;
/**
...
export type Operator = {
     ...
     * Note: takes in an optional type hint as 3rd parameter
     */
    toGlsl: (arg0: ParsingContext, arg1: (string | number | boolean | any[] | number[])[], arg2?: number) => string;
};
