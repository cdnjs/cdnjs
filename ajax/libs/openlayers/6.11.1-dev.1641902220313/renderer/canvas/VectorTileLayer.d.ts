...
declare class CanvasVectorTileLayerRenderer extends CanvasTileLayerRenderer {
     ...
     */
    renderFeature(feature: import("../../Feature.js").default<import("../../geom/Geometry.js").default> | import("../../render/Feature.js").default, squaredTolerance: number, styles: import("../../style/Style.js").default | import("../../style/Style.js").default[], builderGroup: CanvasBuilderGroup, opt_declutterBuilderGroup?: CanvasBuilderGroup | undefined): boolean;
    /**
     * @param {import("../../VectorRenderTile.js").default} tile Tile.
