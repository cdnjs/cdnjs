...
!function(e){"use strict";var t=new function(){function e(e){if("function"==typeof e){var t=e.toString().replace(/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,""),r=t.match(/^function\s*[^\(]*\s*\(\s*([^\)]*)\)/m);return e=null===r||r.length<2?[e]:r[1].replace(/\s/g,"").split(",").filter(function(e){return e.trim().length>0}).concat(e)}return e}function t(t){function i(t,o,c){var s,f,a=n[o].interfacesSupported,u=[];for(s=0;s<t.length;s++){var d=null;if(c&&"undefined"!=typeof c[t[s]])d=c[t[s]];else for(f=0;f<a.length;f++){if(!n[a[f]])throw new Error('DependencyInjection: "'+a[f]+'" interface is not registered.');if(d=n[a[f]].factories[t[s]]){d.interfaceName=a[f];break}}if(!d)throw new Error('DependencyInjection: "'+t[s]+'" is not registered or accessible in '+o+".");if(!d.instantiated){var l=e(d.result);d.result=l.pop();var p=i(l,d.interfaceName);d.result=d.result.apply(r,p),d.instantiated=!0}u.push(d.result)}return u}this.get=function(e){var r=i([e],t);return r[0]},this.invoke=function(r,n,o){var c=e(n);if(n=c.pop(),o){var s,f,a={};for(s in o)for(f in o[s])a[f]={interfaceName:s,instantiated:!1,result:o[s][f]};o=a}var u=i(c,t,o);return n.apply(r,u)}}var r=this,n={};this.injector={},this.registerInterface=function(e,i){if(r[e])throw new Error('DependencyInjection: "'+e+'" interface is already registered.');return n[e]={interfacesSupported:(i||[]).concat(e),factories:{}},r.injector[e]=new t(e),r[e]=function(t,i){if(n[e].factories[t])throw new Error('DependencyInjection: "'+t+'" is already registered in '+e+".");return n[e].factories[t]={instantiated:!1,result:i},r},r}};"undefined"!=typeof module&&"undefined"!=typeof module.exports?module.exports=t:e.DependencyInjection=t}(this),function(e){"use strict";var t="undefined"!=typeof module&&"undefined"!=typeof module.exports?module.exports:e.DependencyInjection;t.registerInterface("model",["viewmodel","factory","service"]),t.registerInterface("factory",["viewmodel","model","service"]),t.registerInterface("service",["viewmodel","model","factory"]),t.registerInterface("viewmodel",["model","factory","service","view","converter"]),t.registerInterface("view",["viewmodel","converter"]),t.registerInterface("converter",["viewmodel","view"])}(this);
