...
;// CONCATENATED MODULE: ./dist/WobbleUpdater.js
  ...
  init(particle) {
    ...
    if (wobbleOpt.enable) {
      particle.wobble = {
        ...
        speed: (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(wobbleOpt.speed) / 360
      };
    } else {
      particle.wobble = {
        angle: 0,
    ...
    particle.retina.wobbleDistance = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(wobbleOpt.distance) * this.container.retina.pixelRatio;
  }
