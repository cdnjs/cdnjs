    ...
    (function (Utils) {
        ...
        var FactoryManager = (function () {
            ...
            FactoryManager.prototype.turnFactoriesOff = function (keys) {
                var _this = this;
                keys.forEach(function (key) { _this.get(key).off(); });
            };
            FactoryManager.prototype.turnFactoriesOn = function (keys) {
                var _this = this;
                keys.forEach(function (key) { _this.get(key).on(); });
            };
        ...
        var SyncLayer = (function (_super) {
            ...
            SyncLayer.prototype.syncDrag = function () {
                ...
                if (callbacks.length > 0) {
                    this.unregisteringFunctions.push(this.scope.$root.$on(this.attributes.dragSyncKey, function (event, _a) {
                        var translate = _a.translate, isEndEvent = _a.isEndEvent;
                    ...
                    eventMgr.on('zoom.directive', function (event, bubble) {
                        if (bubble) {
                            callbacks.forEach(function (fn) { return fn({ translate: event.translate, isEndEvent: false }); });
                        }
                    });
                    eventMgr.on('zoomend.directive', function (event) {
                        callbacks.forEach(function (fn) { return fn({ translate: event.translate, isEndEvent: true }); });
                    });
                }
            };
