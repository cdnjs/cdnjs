        ...
        function LineChart($window, $parse, $timeout, $rootScope) {
            ...
            this.link = function (scope, element, attributes) {
                ...
                factoryMgr.registerMany([
                    ...
                    ['x2-axis', n3Charts.Factory.Axis, n3Charts.Utils.AxisOptions.SIDE.X2],
    ...
    (function (Utils) {
        ...
        var Options = (function () {
            function Options(js) {
                ...
                this.margin = Utils.Dimensions.getDefaultMargins();
                this.grid = {
                    x: false,
                    y: true
                };
            ...
            Options.prototype.getByAxisSide = function (side) {
                ...
                if (!this.axes[side]) {
                    if (side === Utils.AxisOptions.SIDE.Y2) {
                        return this.axes[Utils.AxisOptions.SIDE.Y];
                    }
                    else if (side === Utils.AxisOptions.SIDE.X2) {
                        return this.axes[Utils.AxisOptions.SIDE.X];
                    }
                }
    ...
    (function (Factory) {
        ...
        var Axis = (function (_super) {
            ...
            Axis.prototype.isAbscissas = function () {
                return [n3Charts.Utils.AxisOptions.SIDE.X, n3Charts.Utils.AxisOptions.SIDE.X2].indexOf(this.side) !== -1;
            };
            ...
            Axis.prototype.updateAxisOrientation = function (axis) {
                if (this.isAbscissas()) {
                    if (this.side === n3Charts.Utils.AxisOptions.SIDE.X) {
                        axis.orient('bottom');
                    }
                    else {
                        axis.orient('top');
