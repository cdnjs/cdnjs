...
/***/ function(module, exports, __webpack_require__) {
	...
	var n3Charts = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Series = __webpack_require__(28);
	var Symbols = __webpack_require__(34);
	var Options = __webpack_require__(15);
	var SyncLayer_1 = __webpack_require__(37);
	    ...
	    function LineChart($window, $parse, $timeout, $rootScope) {
	        ...
	        this.link = function (scope, element, attributes) {
	            ...
	            factoryMgr.registerMany([
	                ...
	                ['pan', Factory.Pan],
	                ['zoom', Factory.Zoom],
	                ['sync-layer', SyncLayer_1.AngularJSSyncLayer, scope, attributes, _this.$parse],
	            ...
	            var debouncedResizeEventEmitter = Utils.FunctionUtils.debounce(function () {
	                eventMgr.trigger('resize', element[0].parentElement);
	            }, 50);
	            scope.$watch(getDimensions, debouncedResizeEventEmitter, true);
	            var debouncedApplier = Utils.FunctionUtils.debounce(function () { return scope.$apply(); }, 50);
	            ng.element(_this.$window).on('resize', debouncedApplier);
	            scope.$on('$destroy', function () {
	                eventMgr.trigger('destroy');
	                ng.element(_this.$window).off('resize', debouncedApplier);
	            });
	        };
	    }
	    return LineChart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var d3 = __webpack_require__(5);
	var Dataset_1 = __webpack_require__(7);
	var Data = (function () {
	    function Data(js) {
	        if (js) {
	            this.fromJS(js);
	    ...
	    Data.prototype.fromJS = function (js) {
	        ...
	        for (var key in js) {
	            if (js.hasOwnProperty(key)) {
	                sets[key] = new Dataset_1.Dataset(js[key], key);
	            }
	        }
	        this.sets = sets;
	    };
	    ...
	    Data.getMinDistance = function (data, axis, key, range) {
	        if (key === void 0) { key = 'x'; }
	        return d3.min(data.map(function (series) {
	            return series
...
/***/ function(module, exports) {
	...
	var ObjectUtils = (function () {
	    ...
	    ObjectUtils.extend = function (target, source) {
	        ...
	        var result = ObjectUtils.copy(target);
	        if (!source) {
	            return result;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Interpolation = (function () {
	    ...
	    Interpolation.getInterpolation = function (id, tension) {
	        var interpolation = this.interpolations[id];
	        if (interpolation['tension'])
	            interpolation = interpolation['tension'](tension);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__(3);
	var Options = __webpack_require__(15);
	var BaseFactory_1 = __webpack_require__(13);
	var Container = (function (_super) {
	    __extends(Container, _super);
	    function Container(element) {
	        var _this = _super.call(this) || this;
	        _this.element = element;
	        _this.dim = new Options.Dimensions();
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SymbolOptions = (function () {
	    ...
	    SymbolOptions.prototype.parse = function (js) {
	        ...
	        this.type = Options_1.Options.getString(js.type);
	        this.value = Options_1.Options.getNumber(js.value, 0);
	        this.color = Options_1.Options.getString(js.color, 'lightgrey');
	        this.axis = Options_1.Options.getString(js.axis, 'y');
	        this.id = Options_1.Options.getString(js.id, Utils.UUID.generate());
	    };
	...
	//# sourceMappingURL=SymbolOptions.js.map
...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var Utils = __webpack_require__(3);
	var AxisOptions_1 = __webpack_require__(18);
	var Dimensions_1 = __webpack_require__(19);
	var SeriesOptions_1 = __webpack_require__(20);
	var SymbolOptions_1 = __webpack_require__(16);
	;
	var Options = (function () {
	    function Options(js) {
	        ...
	        this.margin = Dimensions_1.Dimensions.getDefaultMargins();
	        this.grid = {
	            x: false,
	            y: true
	        };
	    ...
	    Options.prototype.sanitizeSeries = function (series) {
	        return (series).map(function (s) { return new SeriesOptions_1.SeriesOptions(s); });
	    };
	    Options.prototype.sanitizeZoomOptions = function (object, def) {
	    ...
	    Options.prototype.sanitizeSymbols = function (symbols) {
	        return (symbols).map(function (s) { return new SymbolOptions_1.SymbolOptions(s); });
	    };
	    ...
	    Options.prototype.sanitizeAxes = function (axes) {
	        return Object.keys(axes).reduce(function (prev, key) {
	            prev[key] = new AxisOptions_1.AxisOptions(axes[key]);
	            return prev;
	        }, {});
	    };
	    Options.prototype.getAbsKey = function () {
	        if (!this.axes[AxisOptions_1.AxisOptions.SIDE.X]) {
	            throw new TypeError('Cannot find abs key : ' + AxisOptions_1.AxisOptions.SIDE.X);
	        }
	        return this.axes[AxisOptions_1.AxisOptions.SIDE.X].key;
	    };
	    ...
	    Options.prototype.getSeriesAndDatasetBySide = function (side) {
	        if (!AxisOptions_1.AxisOptions.isValidSide(side)) {
	            throw new TypeError('Cannot get axis side : ' + side);
	        }
	        if (side === AxisOptions_1.AxisOptions.SIDE.Y2 && !this.axes[side]) {
	            side = AxisOptions_1.AxisOptions.SIDE.Y;
	        }
	        var datasetsForSide = [];
	    ...
	    Options.prototype.getByAxisSide = function (side) {
	        ...
	        if (!this.axes[side]) {
	            if (side === AxisOptions_1.AxisOptions.SIDE.Y2) {
	                return this.axes[AxisOptions_1.AxisOptions.SIDE.Y];
	            }
	            else if (side === AxisOptions_1.AxisOptions.SIDE.X2) {
	                return this.axes[AxisOptions_1.AxisOptions.SIDE.X];
	            }
	        }
	        return this.axes[side];
	    };
	    Options.prototype.getSeriesByType = function (type) {
	        if (!SeriesOptions_1.SeriesOptions.isValidType(type)) {
	    ...
	    Options.prototype.getSymbolsByType = function (type) {
	        if (!SymbolOptions_1.SymbolOptions.isValidType(type)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AxisOptions = (function () {
	    ...
	    AxisOptions.prototype.parse = function (js) {
	        this.type = Options_1.Options.getString(js.type, 'linear');
	        this.key = js.key;
	        this.padding = Options_1.Options.getObject(js.padding || {}, this.padding);
	        this.includeZero = Options_1.Options.getBoolean(js.includeZero, false);
	        this.tickFormat = Options_1.Options.getFunction(js.tickFormat);
	        this.ticks = js.ticks;
	        if (js.ticksShift) {
	            this.ticksShift = {
	                x: Options_1.Options.getNumber(js.ticksShift.x, 0),
	                y: Options_1.Options.getNumber(js.ticksShift.y, 0)
	            };
	        }
	        if (this.type === AxisOptions.TYPE.LINEAR) {
	            this.min = Options_1.Options.getNumber(js.min, undefined);
	            this.max = Options_1.Options.getNumber(js.max, undefined);
	        }
	        else if (this.type === AxisOptions.TYPE.DATE) {
	            this.min = Options_1.Options.getDate(js.min, undefined);
	            this.max = Options_1.Options.getDate(js.max, undefined);
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dimensions = (function () {
	    ...
	    Dimensions.prototype.updateMargins = function (options) {
	        ...
	        var fn = function (prop) { return _this.margin[prop] = Options_1.Options.getNumber(options.margin[prop], _this.margin[prop]); };
	        fn('top');
	        fn('bottom');
	        fn('left');
	        fn('right');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SeriesOptions = (function () {
	    function SeriesOptions(js) {
	        ...
	        this.type = ['line'];
	        this.visible = true;
	        this.defined = function (point) { return true; };
	    ...
	    SeriesOptions.prototype.sanitizeOptions = function (js) {
	        ...
	        options.id = Options_1.Options.getString(options.id);
	        options.type = Options_1.Options.getArray(options.type);
	        options.dataset = Options_1.Options.getString(options.dataset);
	        options.key = this.sanitizeKeys(options.key);
	        options.color = Options_1.Options.getString(options.color);
	        options.label = Options_1.Options.getString(options.label);
	        options.visible = Options_1.Options.getBoolean(options.visible);
	        options.defined = Options_1.Options.getFunction(options.defined);
	        return options;
	    };
	    SeriesOptions.prototype.sanitizeInterpolation = function (js) {
	        ...
	        return {
	            mode: Options_1.Options.getString(js.mode, 'linear'),
	            tension: Options_1.Options.getNumber(js.tension, 0.7)
	        };
	    };
	    SeriesOptions.prototype.sanitizeKeys = function (js) {
	        ...
	        if (typeof js === 'string') {
	            return { y1: Options_1.Options.getString(js) };
	        }
	        return {
	            y0: Options_1.Options.getString(js.y0),
	            y1: Options_1.Options.getString(js.y1)
	        };
	    };
	...
	//# sourceMappingURL=SeriesOptions.js.map
	    ...
	    Tooltip.prototype.updateTooltipDots = function (rows) {
	        ...
	        var init = function (_dots) {
	            ...
	            _dots.append('circle')
	                ...
	                .style('display', function (d) { return d.series.hasTwoKeys() ? null : 'none'; })
	                .on('click', function (d, i) {
	                _this.eventMgr.trigger('click', d.row, i, d.series, _this.options);
	            });
	        };
	        var update = function (_dots) {
	            _dots.select('.tooltip-dot.y1')
	                .attr('r', function (d) { return radius; })
	                .attr('cx', function (d) { return xScale(d.row.x); })
	                .attr('cy', function (d) { return yScale(d.series.axis)(d.row.y1); })
	                .attr('stroke', function (d) { return d.series.color; });
	            _dots.select('.tooltip-dot.y0')
	                .attr('r', function (d) { return d.series.hasTwoKeys() ? radius : null; })
	                .attr('cx', function (d) { return d.series.hasTwoKeys() ? xScale(d.row.x) : null; })
	                .attr('cy', function (d) { return d.series.hasTwoKeys() ? yScale(d.series.axis)(d.row.y0) : null; })
	                .attr('stroke', function (d) { return d.series.hasTwoKeys() ? d.series.color : null; });
	        };
	...
	var Legend = (function (_super) {
	    ...
	    Legend.prototype.update = function (data, options) {
	        ...
	        var update = function (_items) {
	            ...
	            _items.select('.icon').style('background-color', function (d) { return d.color; });
	            _items.select('.legend-label').text(function (d) { return d.label; });
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Axis = (function (_super) {
	    ...
	    function Axis(side) {
	        ...
	        _this.scale = function (value) { return _this._scale.call(_this, value); };
	        return _this;
	    }
	    ...
	    Axis.prototype.getRegularAxis = function (scale) {
	        if (this.isAbscissas()) {
	            if (this.side === Options.AxisOptions.SIDE.X) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transition = (function (_super) {
	    ...
	    function Transition() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.duration = Transition.defaultDuration;
	        _this.ease = d3.easeCubicInOut;
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SeriesFactory = (function (_super) {
	    ...
	    SeriesFactory.prototype.updateSeriesContainer = function (series) {
	        var _this = this;
	        var self = this;
	        var select = function (that) { return d3.select(that); };
	        var update = function (_groups) {
	            _groups
	                .each(function (s, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dot = (function (_super) {
	    ...
	    function Dot() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = Options.SeriesOptions.TYPE.DOT;
	        return _this;
	    }
	    Dot.prototype.updateData = function (group, series, index, numSeries) {
	        ...
	        var dotsRadius = 2;
	        var initPoint = function (_dots) {
	            _dots
	                .attr('r', function (d) { return dotsRadius; })
	                .attr('cx', function (d) { return xAxis.scale(d.x); })
	                .attr('cy', function (d) { return yAxis.range()[0]; });
	        };
	        var updatePoint = function (_dots) {
	            _dots
	                .attr('r', function (d) { return dotsRadius; })
	                .attr('cx', function (d) { return xAxis.scale(d.x); })
	                .attr('cy', function (d) { return yAxis.scale(d.y1); })
	    ...
	    Dot.prototype.styleSeries = function (group) {
	        group.style('stroke', function (d) { return d.color; });
	    };
	    return Dot;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Line = (function (_super) {
	    ...
	    function Line() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = Options.SeriesOptions.TYPE.LINE;
	        return _this;
	    }
	    Line.prototype.updateData = function (group, series, index, numSeries) {
	        ...
	        var line = group.selectAll('.' + this.type)
	            .data([lineData]);
	        if (this.factoryMgr.get('transitions').isOn()) {
	            var init = function (_line) {
	                _line
	                    .attr('class', _this.type)
	                    .attr('d', function (d) { return initLine(d); });
	            };
	            var update = function (_line) {
	                _line
	                    .transition()
	                    .call(_this.factoryMgr.getBoundFunction('transitions', 'enter'))
	    ...
	    Line.prototype.styleSeries = function (group) {
	        group
	            ...
	            .style('stroke-dasharray', function (s) { return s.isDashed() ? '10,3' : undefined; });
	    };
	    return Line;
	}(Series.SeriesFactory));
	exports.Line = Line;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Options = __webpack_require__(15);
	var Utils = __webpack_require__(3);
	var SeriesFactory_1 = __webpack_require__(29);
	var Area = (function (_super) {
	    __extends(Area, _super);
	    function Area() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = Options.SeriesOptions.TYPE.AREA;
	        return _this;
	    }
	    Area.prototype.updateData = function (group, series, index, numSeries) {
	        ...
	        var isOkay = function (value) { return isFinite(value) && !isNaN(value); };
	        var initArea = d3.area()
	            ...
	            .y1(yAxis.range()[0])
	            .curve(Utils.Interpolation.getInterpolation(series.interpolation.mode, series.interpolation.tension));
	        var updateArea = d3.area()
	            .defined(series.defined)
	            .x(function (d) { return xAxis.scale(d.x); })
	            .y0(function (d) { return isOkay(yAxis.scale(d.y0)) ? yAxis.scale(d.y0) : yAxis.range()[0]; })
	            .y1(function (d) { return yAxis.scale(d.y1); })
	            .curve(Utils.Interpolation.getInterpolation(series.interpolation.mode, series.interpolation.tension));
	        var area = group.selectAll('.' + this.type)
	            .data([areaData]);
	        if (this.factoryMgr.get('transitions').isOn()) {
	            var init = function (_area) {
	                _area
	                    .attr('class', _this.type)
	                    .attr('d', function (d) { return initArea(d); });
	            };
	            var update = function (_area) {
	                _area
	                    .transition()
	                    .call(_this.factoryMgr.getBoundFunction('transitions', 'enter'))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Column = (function (_super) {
	    ...
	    function Column() {
	        var _this = _super !== null && _super.apply(this, arguments) || this;
	        _this.type = Options.SeriesOptions.TYPE.COLUMN;
	        _this.gapFactor = 0.2;
	        _this.outerPadding = (_this.gapFactor / 2) * 3;
	        _this.columnsWidth = 0;
	        return _this;
	    }
	    ...
	    Column.prototype.updateData = function (group, series, index, numSeries) {
	        ...
	        var initCol = function (_columns) {
	            _columns
	                .attr('x', xFn)
	                .attr('y', function (d) { return yAxis.scale(d.y0); })
	                .attr('width', _this.innerXScale.step())
	                .attr('height', 0);
	        };
	        var updateCol = function (_columns) {
	            _columns
	                .attr('x', xFn)
	                .attr('y', function (d) { return d.y1 > 0 ? yAxis.scale(d.y1) : yAxis.scale(d.y0); })
	                .attr('width', _this.innerXScale.step())
	                .attr('height', function (d) { return Math.abs(yAxis.scale(d.y0) - yAxis.scale(d.y1)); })
	                .style('opacity', series.visible ? 1 : 0);
	        };
	...
	var HLine = (function (_super) {
	    ...
	    HLine.prototype.softUpdate = function () {
	        ...
	        var hline = this.svg.selectAll('.hline')
	            .data(this.options.getSymbolsByType(Options.SymbolOptions.TYPE.HLINE), function (o) { return o.id; });
	        var init = function (selection) {
	            selection
	                .attr('class', 'hline')
	                .style('opacity', 0)
	                .style('stroke', function (o) { return o.color; });
	        };
	        var update = function (selection) {
	            selection
	                .attr('x1', xAxis.scale(xAxis.getDomain()[0]))
	                .attr('x2', xAxis.scale(xAxis.getDomain()[1]))
	                .attr('y1', function (o) { return yAxes[o.axis].scale(o.value); })
	                .attr('y2', function (o) { return yAxes[o.axis].scale(o.value); })
	                .style('opacity', 1);
	        };
	        if (this.factoryMgr.get('transitions').isOn()) {
	            hline.enter()
	...
	var VLine = (function (_super) {
	    ...
	    VLine.prototype.softUpdate = function () {
	        ...
	        var vline = this.svg.selectAll('.vline')
	            .data(this.options.getSymbolsByType(Options.SymbolOptions.TYPE.VLINE), function (o) { return o.id; });
	        var init = function (selection) {
	            selection
	                .attr('class', 'vline')
	                .style('opacity', 0)
	        ...
	        var update = function (selection) {
	            selection
	                .attr('x1', function (o) { return xAxis.scale(o.value); })
	                .attr('x2', function (o) { return xAxis.scale(o.value); })
...
/***/ function(module, exports, __webpack_require__) {
	...
	//# sourceMappingURL=SyncLayer.js.map
