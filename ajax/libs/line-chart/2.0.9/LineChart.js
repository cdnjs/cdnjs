    ...
    (function (Factory) {
        ...
        var Zoom = (function (_super) {
            ...
            Zoom.prototype.update = function (data, options) {
                ...
                this.xStartFn = options.zoom.x ? function (x) { return x; } : function (x) { return left; };
                this.xEndFn = options.zoom.x ? function (x) { return x; } : function (x) { return dimensions.innerWidth + left; };
                this.yStartFn = options.zoom.y ? function (y) { return y; } : function (y) { return top; };
                this.yEndFn = options.zoom.y ? function (y) { return y; } : function (y) { return dimensions.innerHeight + top; };
            };
    ...
    (function (Factory) {
        ...
        var Pan = (function (_super) {
            ...
            Pan.prototype.update = function (data, options) {
                var _this = this;
                this.xFn = options.pan.x ? function (x) { return x; } : function (x) { return 0; };
                this.yFn = options.pan.y ? function (y) { return y; } : function (y) { return 0; };
                var container = this.factoryMgr.get('container');
                var k = function (event) { return (event + "." + _this.key); };
                var xStart;
                var yStart;
                ...
                container.svg
                    ...
                    if (_this.isActive) {
                        ...
                        var deltaX = _this.xFn(xStart - xEnd);
                        var deltaY = _this.yFn(yStart - yEnd);
    ...
    (function (Factory) {
        ...
        var SyncLayer = (function (_super) {
            ...
            SyncLayer.prototype.syncDomainsChange = function () {
                ...
                var ping = function (args) { return callbacks.forEach(function (fn) { return fn(domains(), args); }); };
