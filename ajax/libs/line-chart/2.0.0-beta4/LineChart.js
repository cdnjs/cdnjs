        ...
        function LineChart() {
            ...
            this.link = function (scope, element, attributes) {
                ...
                factoryMgr.registerMany([
                    ...
                    ['x-axis', n3Charts.Factory.Axis, n3Charts.Factory.Axis.SIDE.X],
                    ['y-axis', n3Charts.Factory.Axis, n3Charts.Factory.Axis.SIDE.Y],
...
(function (n3Charts) {
    ...
    (function (Utils) {
        ...
        var SeriesOptions = (function () {
            ...
            SeriesOptions.prototype.parse = function (jsSeries) {
                this.id = jsSeries.id || Utils.Options.uuid();
            ...
            SeriesOptions.prototype.parseType = function (js) {
                if (!js) {
                    return ['line'];
                }
                if (typeof js === 'string') {
            ...
            SeriesOptions.prototype.getMainType = function () {
...
(function (n3Charts) {
    ...
    (function (Utils) {
        ...
        var Options = (function () {
            ...
            Options.prototype.parse = function (js) {
                var options = {};
            ...
            Options.prototype.parseMargin = function (jsMargin) {
            ...
            Options.prototype.parseSeries = function (jsSeries) {
                // Type check because of <any> type
            ...
            Options.prototype.parseAxes = function (jsAxes) {
                // Type check because of <any> type
            ...
            Options.prototype.isValidAxisSide = function (side) {
                return d3.values(n3Charts.Factory.Axis.SIDE).indexOf(side) === -1
                    ? false : true;
            };
            Options.prototype.isValidSeriesType = function (type) {
                return d3.values(Options.SERIES_TYPES).indexOf(type) === -1
                    ? false : true;
            };
            Options.prototype.getAbsKey = function () {
                if (!this.axes[n3Charts.Factory.Axis.SIDE.X]) {
                    throw new TypeError('Cannot find abs key : ' + n3Charts.Factory.Axis.SIDE.X);
                }
                return this.axes[n3Charts.Factory.Axis.SIDE.X].key;
            };
            ...
            Options.prototype.getSeriesByType = function (type) {
                ...
                return this.series.filter(function (series) { return series.type.indexOf(type) !== -1; });
            };
        ...
        var Legend = (function (_super) {
            ...
            Legend.prototype.update = function (data, options) {
                ...
                var update = function (series) {
                    series
                        .attr('class', function (d) { return 'item ' + d.getMainType(); })
    ...
    (function (Factory) {
        ...
        (function (Series) {
            ...
            var Dot = (function (_super) {
                ...
                function Dot() {
                    _super.apply(this, arguments);
                    this.type = n3Charts.Utils.Options.SERIES_TYPES.DOT;
                }
    ...
    (function (Factory) {
        ...
        (function (Series) {
            ...
            var Line = (function (_super) {
                ...
                function Line() {
                    _super.apply(this, arguments);
                    this.type = n3Charts.Utils.Options.SERIES_TYPES.LINE;
                }
    ...
    (function (Factory) {
        ...
        (function (Series) {
            ...
            var Area = (function (_super) {
                ...
                function Area() {
                    _super.apply(this, arguments);
                    this.type = n3Charts.Utils.Options.SERIES_TYPES.AREA;
                }
    ...
    (function (Factory) {
        ...
        (function (Series) {
            ...
            var Column = (function (_super) {
                ...
                function Column() {
                    _super.apply(this, arguments);
                    this.type = n3Charts.Utils.Options.SERIES_TYPES.COLUMN;
                    this.gapFactor = 0.2;
                    this.outerPadding = (this.gapFactor / 2) * 3;
                    this.columnsWidth = 0;
                }
                Column.prototype.update = function (data, options) {
                    _super.prototype.update.call(this, data, options);
                    var series = options.getSeriesByType(this.type).filter(function (s) { return s.visible; });
...
(function (n3Charts) {
    ...
    angular.module('n3-line-chart', [])
        .directive('linechart', function () { return new n3Charts.LineChart(); });
})(n3Charts || (n3Charts = {}));
