...
export default class SpectrogramPlugin {
    ...
    static create(params) {
        return new SpectrogramPlugin(params);
    }
    ...
    createWrapper() {
        ...
        const wsParams = this.wavesurfer.options;
    ...
    getFrequencies(callback) {
        ...
        const buffer = (this.buffer = this.wavesurfer.getDecodedData());
        const channels = this.channels;
        if (!buffer) {
            this.emit('error', 'Web Audio buffer is not available');
            return;
        }
    ...
    loadFrequenciesData(url) {
        ...
        request.on('error', e => this.emit('error', e));
        return request;
    }
    freqType(freq) {
