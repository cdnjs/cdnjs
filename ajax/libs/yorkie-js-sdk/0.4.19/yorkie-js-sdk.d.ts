...
declare class CRDTTree extends CRDTGCElement {
    ...
    style(range: [CRDTTreePos, CRDTTreePos], attributes: {
        [key: string]: string;
    } | undefined, editedAt: TimeTicket, maxCreatedAtMapByActor: Map<string, TimeTicket> | undefined): [Map<string, TimeTicket>, Array<TreeChange>];
    /**
     ...
     */
    edit(range: [CRDTTreePos, CRDTTreePos], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket, issueTimeTicket: (() => TimeTicket) | undefined, maxCreatedAtMapByActor?: Map<string, TimeTicket>): [Array<TreeChange>, Map<string, TimeTicket>];
    /**
...
declare class RGATreeSplit<T extends RGATreeSplitValue> {
     ...
     */
    edit(range: RGATreeSplitPosRange, editedAt: TimeTicket, value?: T, maxCreatedAtMapByActor?: Map<string, TimeTicket>): [RGATreeSplitPos, Map<string, TimeTicket>, Array<ValueChange<T>>];
    /**
...
declare class RHT {
     ...
     * `set` sets the value of the given key.
     */
    set(key: string, value: string, executedAt: TimeTicket): boolean;
    /**
