(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["yorkie-js-sdk"] = {}));
...
var __publicField = (obj, key, value) => {
        ...
        for (const [jsonKey, jsonValue] of Object.entries(json)) {
          ...
          if (field.repeated) {
            ...
            switch (field.kind) {
              ...
              case "scalar":
                try {
                  target[localName2] = readScalar(field.T, jsonValue, field.L);
                } catch (e) {
  ...
  function localName(desc) {
    switch (desc.kind) {
      ...
      case "message":
      case "service": {
        const pkg2 = desc.file.proto.package;
        const offset = pkg2 === void 0 ? 0 : pkg2.length + 1;
        const name2 = desc.typeName.substring(offset).replace(/\./g, "_");
        return safeObjectProperty(safeIdentifier(name2));
      }
      case "enum_value": {
        ...
        const name2 = desc.name.substring(sharedPrefix.length);
        return safeObjectProperty(name2);
      }
      case "rpc": {
        let name2 = desc.name;
        if (name2.length == 0) {
  ...
  const proto3$2 = makeProtoRuntime("proto3", makeJsonFormatProto3(), makeBinaryFormatProto3(), Object.assign(Object.assign({}, makeUtilCommon()), {
    newFieldList(fields) {
          ...
          switch (field.kind) {
            ...
            case "enum":
              ...
              if (repeated) {
                ...
                if (value !== void 0) {
                  writeScalar$1(writer, scalarType, field.no, value, true);
                }
              }
              break;
            case "message":
    ...
    return makeJsonFormatCommon((writeEnum2, writeScalar2) => {
      return function writeField(field, value, options) {
        if (field.kind == "map") {
          ...
          switch (field.kind) {
            case "scalar":
              return writeScalar2(field.T, value, true);
            case "enum":
  ...
  const proto2 = makeProtoRuntime("proto2", makeJsonFormatProto2(), makeBinaryFormatProto2(), Object.assign(Object.assign({}, makeUtilCommon()), {
    newFieldList(fields) {
  ...
  var __await$3 = globalThis && globalThis.__await || function(v) {
  ...
  const protoDelimited = {
    ...
    decStream(type, iterable) {
      return __asyncGenerator$3(this, arguments, function* decStream_1() {
        var _a, e_1, _b, _c;
        ...
        try {
          for (var _d = true, iterable_1 = __asyncValues$2(iterable), iterable_1_1; iterable_1_1 = yield __await$3(iterable_1.next()), _a = iterable_1_1.done, !_a; _d = true) {
            ...
            for (; ; ) {
              ...
              yield yield __await$3(protoDelimited.dec(type, buffer));
          ...
          try {
            if (!_d && !_a && (_b = iterable_1.return))
              yield __await$3(_b.call(iterable_1));
          } finally {
            if (e_1)
              throw e_1.error;
          }
  ...
  class FieldOptions_EditionDefault extends Message {
    constructor(data) {
      super();
      proto2.util.initPartial(data, this);
    }
  ...
  class FeatureSet extends Message {
    constructor(data) {
      super();
      proto2.util.initPartial(data, this);
    }
  ...
  class FeatureSetDefaults extends Message {
    constructor(data) {
      super();
      this.defaults = [];
      proto2.util.initPartial(data, this);
  ...
  class FeatureSetDefaults_FeatureSetEditionDefault extends Message {
    constructor(data) {
      super();
      proto2.util.initPartial(data, this);
    }
  ...
  const featureSetDefaults = FeatureSetDefaults.fromBinary(protoBase64.dec(
  ...
  function createFeatureResolver(compiledFeatureSetDefaults) {
    ...
    if (min === void 0 || max === void 0 || compiledFeatureSetDefaults.defaults.some((d) => d.edition === void 0)) {
      throw new Error("Invalid FeatureSetDefaults");
    }
    const defaultsBinByEdition = /* @__PURE__ */ new Map();
    return (edition, ...rest) => {
      var _a, _b;
      let defaultsBin = defaultsBinByEdition.get(edition);
      if (defaultsBin === void 0) {
        if (edition < min) {
  ...
  function createDescriptorSet(input, options) {
    ...
    const files2 = fileDescriptors.map((proto) => newFile(proto, cart));
    return Object.assign({ files: files2 }, cart);
  }
  function newFile(proto, cart) {
    ...
    const file = Object.assign(Object.assign({ kind: "file", proto, deprecated: (_b = (_a = proto.options) === null || _a === void 0 ? void 0 : _a.deprecated) !== null && _b !== void 0 ? _b : false }, parseFileSyntax(proto.syntax, proto.edition)), {
      ...
      getFeatures() {
        var _a2;
        return cart.resolveFeatures(this.edition, (_a2 = this.proto.options) === null || _a2 === void 0 ? void 0 : _a2.features);
      }
    });
  ...
  function addEnum(proto, file, parent, cart) {
    ...
    const desc = {
      ...
      getFeatures() {
        var _a2, _b2, _c2;
        const parentFeatures = (_b2 = (_a2 = this.parent) === null || _a2 === void 0 ? void 0 : _a2.getFeatures()) !== null && _b2 !== void 0 ? _b2 : this.file.getFeatures();
        return cart.resolveFeatures(this.file.edition, parentFeatures, (_c2 = this.proto.options) === null || _c2 === void 0 ? void 0 : _c2.features);
      }
    };
    ...
    proto.value.forEach((proto4) => {
      ...
      desc.values.push({
        ...
        getFeatures() {
          var _a3;
          return cart.resolveFeatures(this.parent.file.edition, this.parent.getFeatures(), (_a3 = this.proto.options) === null || _a3 === void 0 ? void 0 : _a3.features);
        }
      });
    });
  ...
  function addService(proto, file, cart) {
    ...
    const desc = {
      ...
      getFeatures() {
        var _a2;
        return cart.resolveFeatures(this.file.edition, this.file.getFeatures(), (_a2 = this.proto.options) === null || _a2 === void 0 ? void 0 : _a2.features);
      }
    };
  ...
  function newMethod(proto, parent, cart) {
    ...
    if (proto.clientStreaming === true && proto.serverStreaming === true) {
      methodKind = MethodKind$1.BiDiStreaming;
    } else if (proto.clientStreaming === true) {
      methodKind = MethodKind$1.ClientStreaming;
    } else if (proto.serverStreaming === true) {
      methodKind = MethodKind$1.ServerStreaming;
    } else {
      methodKind = MethodKind$1.Unary;
    }
    let idempotency;
    ...
    return {
      ...
      getFeatures() {
        var _a2;
        return cart.resolveFeatures(this.parent.file.edition, this.parent.getFeatures(), (_a2 = this.proto.options) === null || _a2 === void 0 ? void 0 : _a2.features);
      }
    };
  }
  ...
  function newField(proto, file, parent, oneof, cart) {
    ...
    const common = {
      ...
      getFeatures() {
        var _a2;
        return cart.resolveFeatures(file.edition, this.parent.getFeatures(), (_a2 = this.proto.options) === null || _a2 === void 0 ? void 0 : _a2.features);
      }
    };
  ...
  let Timestamp$1 = class Timestamp2 extends Message {
    constructor(data) {
      super();
      this.seconds = protoInt64.zero;
      this.nanos = 0;
      proto3$2.util.initPartial(data, this);
    }
    fromJson(json, options) {
      if (typeof json !== "string") {
        throw new Error(`cannot decode google.protobuf.Timestamp from JSON: ${proto3$2.json.debug(json)}`);
      }
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Timestamp2, a, b);
    }
  };
  Timestamp$1.runtime = proto3$2;
  Timestamp$1.typeName = "google.protobuf.Timestamp";
  Timestamp$1.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "seconds",
      kind: "scalar",
  ...
  class Duration extends Message {
    ...
    fromJson(json, options) {
      if (typeof json !== "string") {
        throw new Error(`cannot decode google.protobuf.Duration from JSON: ${proto3$2.json.debug(json)}`);
      }
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Duration, a, b);
    }
  }
  Duration.runtime = proto3$2;
  Duration.typeName = "google.protobuf.Duration";
  Duration.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "seconds",
      kind: "scalar",
  ...
  class Any extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Any, a, b);
    }
  }
  Any.runtime = proto3$2;
  Any.typeName = "google.protobuf.Any";
  Any.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "type_url",
      kind: "scalar",
  ...
  class Empty extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Empty, a, b);
    }
  }
  Empty.runtime = proto3$2;
  Empty.typeName = "google.protobuf.Empty";
  Empty.fields = proto3$2.util.newFieldList(() => []);
  class FieldMask extends Message {
    ...
    fromJson(json, options) {
      if (typeof json !== "string") {
        throw new Error("cannot decode google.protobuf.FieldMask from JSON: " + proto3$2.json.debug(json));
      }
      if (json === "") {
        return this;
      }
    ...
    static equals(a, b) {
      return proto3$2.util.equals(FieldMask, a, b);
    }
  }
  FieldMask.runtime = proto3$2;
  FieldMask.typeName = "google.protobuf.FieldMask";
  FieldMask.fields = proto3$2.util.newFieldList(() => [
  ...
  proto3$2.util.setEnumType(NullValue, "google.protobuf.NullValue", [
  ...
  class Struct extends Message {
    ...
    fromJson(json, options) {
      if (typeof json != "object" || json == null || Array.isArray(json)) {
        throw new Error("cannot decode google.protobuf.Struct from JSON " + proto3$2.json.debug(json));
      }
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Struct, a, b);
    }
  }
  Struct.runtime = proto3$2;
  Struct.typeName = "google.protobuf.Struct";
  Struct.fields = proto3$2.util.newFieldList(() => [
  ...
  class Value extends Message {
    ...
    fromJson(json, options) {
      switch (typeof json) {
        ...
        case "object":
          ...
          break;
        default:
          throw new Error("cannot decode google.protobuf.Value from JSON " + proto3$2.json.debug(json));
      }
      return this;
    }
    static fromBinary(bytes, options) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Value, a, b);
    }
  }
  Value.runtime = proto3$2;
  Value.typeName = "google.protobuf.Value";
  Value.fields = proto3$2.util.newFieldList(() => [
    { no: 1, name: "null_value", kind: "enum", T: proto3$2.getEnumType(NullValue), oneof: "kind" },
  ...
  class ListValue extends Message {
    ...
    fromJson(json, options) {
      if (!Array.isArray(json)) {
        throw new Error("cannot decode google.protobuf.ListValue from JSON " + proto3$2.json.debug(json));
      }
      for (let e of json) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(ListValue, a, b);
    }
  }
  ListValue.runtime = proto3$2;
  ListValue.typeName = "google.protobuf.ListValue";
  ListValue.fields = proto3$2.util.newFieldList(() => [
  ...
  class DoubleValue extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.DOUBLE, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.DOUBLE, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(DoubleValue, a, b);
    }
  }
  DoubleValue.runtime = proto3$2;
  DoubleValue.typeName = "google.protobuf.DoubleValue";
  DoubleValue.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class FloatValue extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.FLOAT, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.FLOAT, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(FloatValue, a, b);
    }
  }
  FloatValue.runtime = proto3$2;
  FloatValue.typeName = "google.protobuf.FloatValue";
  FloatValue.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class Int64Value extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.INT64, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.INT64, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Int64Value, a, b);
    }
  }
  Int64Value.runtime = proto3$2;
  Int64Value.typeName = "google.protobuf.Int64Value";
  Int64Value.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class UInt64Value extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.UINT64, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.UINT64, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(UInt64Value, a, b);
    }
  }
  UInt64Value.runtime = proto3$2;
  UInt64Value.typeName = "google.protobuf.UInt64Value";
  UInt64Value.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class Int32Value extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.INT32, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.INT32, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Int32Value, a, b);
    }
  }
  Int32Value.runtime = proto3$2;
  Int32Value.typeName = "google.protobuf.Int32Value";
  Int32Value.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class UInt32Value extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.UINT32, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.UINT32, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(UInt32Value, a, b);
    }
  }
  UInt32Value.runtime = proto3$2;
  UInt32Value.typeName = "google.protobuf.UInt32Value";
  UInt32Value.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class BoolValue extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.BOOL, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.BOOL, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(BoolValue, a, b);
    }
  }
  BoolValue.runtime = proto3$2;
  BoolValue.typeName = "google.protobuf.BoolValue";
  BoolValue.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  let StringValue$1 = class StringValue2 extends Message {
    constructor(data) {
      super();
      this.value = "";
      proto3$2.util.initPartial(data, this);
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.STRING, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.STRING, json);
      } catch (e) {
    ...
    static fromBinary(bytes, options) {
      return new StringValue2().fromBinary(bytes, options);
    }
    static fromJson(jsonValue, options) {
      return new StringValue2().fromJson(jsonValue, options);
    }
    static fromJsonString(jsonString, options) {
      return new StringValue2().fromJsonString(jsonString, options);
    }
    static equals(a, b) {
      return proto3$2.util.equals(StringValue2, a, b);
    }
  };
  StringValue$1.runtime = proto3$2;
  StringValue$1.typeName = "google.protobuf.StringValue";
  StringValue$1.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  class BytesValue extends Message {
    ...
    toJson(options) {
      return proto3$2.json.writeScalar(ScalarType.BYTES, this.value, true);
    }
    fromJson(json, options) {
      try {
        this.value = proto3$2.json.readScalar(ScalarType.BYTES, json);
      } catch (e) {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(BytesValue, a, b);
    }
  }
  BytesValue.runtime = proto3$2;
  BytesValue.typeName = "google.protobuf.BytesValue";
  BytesValue.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "value",
      kind: "scalar",
  ...
  function createRegistryFromDescriptors(input, replaceWkt = true) {
    ...
    return {
      ...
      findEnum(typeName) {
        ...
        const runtime = desc.file.syntax == "proto3" ? proto3$2 : proto2;
  ...
  function makeScalarFieldInfo(field) {
    const longType = field.longType == LongType.STRING ? { L: LongType.STRING } : {};
  ...
  class SourceContext extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(SourceContext, a, b);
    }
  }
  SourceContext.runtime = proto3$2;
  SourceContext.typeName = "google.protobuf.SourceContext";
  SourceContext.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "file_name",
      kind: "scalar",
  ...
  proto3$2.util.setEnumType(Syntax, "google.protobuf.Syntax", [
  ...
  class Type extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Type, a, b);
    }
  }
  Type.runtime = proto3$2;
  Type.typeName = "google.protobuf.Type";
  Type.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
    ...
    { no: 6, name: "syntax", kind: "enum", T: proto3$2.getEnumType(Syntax) },
    {
      no: 7,
      name: "edition",
      kind: "scalar",
  ...
  class Field extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Field, a, b);
    }
  }
  Field.runtime = proto3$2;
  Field.typeName = "google.protobuf.Field";
  Field.fields = proto3$2.util.newFieldList(() => [
    { no: 1, name: "kind", kind: "enum", T: proto3$2.getEnumType(Field_Kind) },
    { no: 2, name: "cardinality", kind: "enum", T: proto3$2.getEnumType(Field_Cardinality) },
    {
      no: 3,
      name: "number",
      kind: "scalar",
  ...
  proto3$2.util.setEnumType(Field_Kind, "google.protobuf.Field.Kind", [
  ...
  proto3$2.util.setEnumType(Field_Cardinality, "google.protobuf.Field.Cardinality", [
  ...
  class Enum extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Enum, a, b);
    }
  }
  Enum.runtime = proto3$2;
  Enum.typeName = "google.protobuf.Enum";
  Enum.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
    ...
    { no: 5, name: "syntax", kind: "enum", T: proto3$2.getEnumType(Syntax) },
    {
      no: 6,
      name: "edition",
      kind: "scalar",
  ...
  class EnumValue extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(EnumValue, a, b);
    }
  }
  EnumValue.runtime = proto3$2;
  EnumValue.typeName = "google.protobuf.EnumValue";
  EnumValue.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
  ...
  class Option extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Option, a, b);
    }
  }
  Option.runtime = proto3$2;
  Option.typeName = "google.protobuf.Option";
  Option.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
  ...
  class Api extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Api, a, b);
    }
  }
  Api.runtime = proto3$2;
  Api.typeName = "google.protobuf.Api";
  Api.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
    ...
    { no: 7, name: "syntax", kind: "enum", T: proto3$2.getEnumType(Syntax) }
  ]);
  class Method extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Method, a, b);
    }
  }
  Method.runtime = proto3$2;
  Method.typeName = "google.protobuf.Method";
  Method.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
  ...
  class Mixin extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Mixin, a, b);
    }
  }
  Mixin.runtime = proto3$2;
  Mixin.typeName = "google.protobuf.Mixin";
  Mixin.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "name",
      kind: "scalar",
  ...
  const __CJS__import__1__$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    ...
    get CodeGeneratorResponse_Feature() {
    ...
    FileDescriptorSet,
    FileOptions,
    get FileOptions_OptimizeMode() {
      return FileOptions_OptimizeMode;
    },
    FloatValue,
    GeneratedCodeInfo,
    GeneratedCodeInfo_Annotation,
    get GeneratedCodeInfo_Annotation_Semantic() {
      return GeneratedCodeInfo_Annotation_Semantic;
    },
    Int32Value,
    Int64Value,
    ListValue,
    ...
    get MethodIdempotency() {
      return MethodIdempotency;
    },
    get MethodKind() {
      return MethodKind$1;
    },
    MethodOptions,
    get MethodOptions_IdempotencyLevel() {
  ...
  function makeAnyClient(service, createMethod) {
    const client = {};
    for (const [localName2, methodInfo] of Object.entries(service.methods)) {
      const method = createMethod(Object.assign(Object.assign({}, methodInfo), {
        localName: localName2,
        service
      }));
      if (method != null) {
        client[localName2] = method;
      }
    }
    return client;
  }
  ...
  function createPromiseClient(service, transport) {
    return makeAnyClient(service, (method) => {
      switch (method.kind) {
        case MethodKind$1.Unary:
          return createUnaryFn(transport, service, method);
        case MethodKind$1.ServerStreaming:
          return createServerStreamingFn(transport, service, method);
        case MethodKind$1.ClientStreaming:
          return createClientStreamingFn(transport, service, method);
        case MethodKind$1.BiDiStreaming:
  ...
  class Status extends Message {
    ...
    static equals(a, b) {
      return proto3$2.util.equals(Status, a, b);
    }
  }
  Status.runtime = proto3$2;
  Status.typeName = "google.rpc.Status";
  Status.fields = proto3$2.util.newFieldList(() => [
    {
      no: 1,
      name: "code",
      kind: "scalar",
    ...
    return {
      ...
      async stream(service, method, signal, timeoutMs, header, input, contextValues) {
        ...
        async function createRequestBody(input2) {
          if (method.kind != MethodKind$1.ServerStreaming) {
  ...
  var exports$3 = module$2.exports;
  Object.defineProperty(exports$3, "__esModule", { value: true });
  const { proto3: proto3$1, StringValue, Timestamp } = __CJS__import__1__$1;
  const ValueType = proto3$1.makeEnum(
    "yorkie.v1.ValueType",
    [
  ...
  const DocEventType$1 = proto3$1.makeEnum(
  ...
  const Snapshot = proto3$1.makeMessageType(
    "yorkie.v1.Snapshot",
    () => [
  ...
  const ChangePack$2 = proto3$1.makeMessageType(
  ...
  const Change$1 = proto3$1.makeMessageType(
    "yorkie.v1.Change",
    () => [
  ...
  const ChangeID$1 = proto3$1.makeMessageType(
    "yorkie.v1.ChangeID",
    () => [
      {
        no: 1,
  ...
  const Operation$1 = proto3$1.makeMessageType(
    "yorkie.v1.Operation",
    () => [
  ...
  const Operation_Set = proto3$1.makeMessageType(
  ...
  const Operation_Add = proto3$1.makeMessageType(
  ...
  const Operation_Move = proto3$1.makeMessageType(
  ...
  const Operation_Remove = proto3$1.makeMessageType(
  ...
  const Operation_Edit = proto3$1.makeMessageType(
  ...
  const Operation_Select = proto3$1.makeMessageType(
  ...
  const Operation_Style = proto3$1.makeMessageType(
  ...
  const Operation_Increase = proto3$1.makeMessageType(
  ...
  const Operation_TreeEdit = proto3$1.makeMessageType(
  ...
  const Operation_TreeStyle = proto3$1.makeMessageType(
  ...
  const JSONElementSimple = proto3$1.makeMessageType(
    ...
    () => [
      ...
      { no: 4, name: "type", kind: "enum", T: proto3$1.getEnumType(ValueType) },
      {
        no: 5,
        name: "value",
        kind: "scalar",
  ...
  const JSONElement = proto3$1.makeMessageType(
  ...
  const JSONElement_JSONObject = proto3$1.makeMessageType(
  ...
  const JSONElement_JSONArray = proto3$1.makeMessageType(
  ...
  const JSONElement_Primitive = proto3$1.makeMessageType(
    "yorkie.v1.JSONElement.Primitive",
    () => [
      { no: 1, name: "type", kind: "enum", T: proto3$1.getEnumType(ValueType) },
      {
        no: 2,
        name: "value",
        kind: "scalar",
  ...
  const JSONElement_Text = proto3$1.makeMessageType(
  ...
  const JSONElement_Counter = proto3$1.makeMessageType(
  ...
  const JSONElement_Tree = proto3$1.makeMessageType(
  ...
  const RHTNode$1 = proto3$1.makeMessageType(
    "yorkie.v1.RHTNode",
    () => [
      {
        no: 1,
  ...
  const RGANode = proto3$1.makeMessageType(
    "yorkie.v1.RGANode",
    () => [
  ...
  const NodeAttr = proto3$1.makeMessageType(
    "yorkie.v1.NodeAttr",
    () => [
      {
        no: 1,
  ...
  const TextNode = proto3$1.makeMessageType(
    "yorkie.v1.TextNode",
    () => [
  ...
  const TextNodeID = proto3$1.makeMessageType(
  ...
  const TreeNode = proto3$1.makeMessageType(
    "yorkie.v1.TreeNode",
    () => [
  ...
  const TreeNodes = proto3$1.makeMessageType(
    "yorkie.v1.TreeNodes",
    () => [
      { no: 1, name: "content", kind: "message", T: TreeNode, repeated: true }
    ]
  );
  const TreeNodeID = proto3$1.makeMessageType(
  ...
  const TreePos = proto3$1.makeMessageType(
    "yorkie.v1.TreePos",
    () => [
  ...
  const User = proto3$1.makeMessageType(
    "yorkie.v1.User",
    () => [
      {
        no: 1,
  ...
  const Project = proto3$1.makeMessageType(
    "yorkie.v1.Project",
    () => [
      {
        no: 1,
  ...
  const UpdatableProjectFields = proto3$1.makeMessageType(
  ...
  const UpdatableProjectFields_AuthWebhookMethods = proto3$1.makeMessageType(
  ...
  const DocumentSummary = proto3$1.makeMessageType(
  ...
  const PresenceChange = proto3$1.makeMessageType(
    "yorkie.v1.PresenceChange",
    () => [
      { no: 1, name: "type", kind: "enum", T: proto3$1.getEnumType(PresenceChange_ChangeType) },
      { no: 2, name: "presence", kind: "message", T: Presence$1 }
    ]
  );
  const PresenceChange_ChangeType = proto3$1.makeEnum(
  ...
  const Presence$1 = proto3$1.makeMessageType(
    "yorkie.v1.Presence",
    () => [
  ...
  const Checkpoint$1 = proto3$1.makeMessageType(
  ...
  const TextNodePos = proto3$1.makeMessageType(
  ...
  const TimeTicket$1 = proto3$1.makeMessageType(
  ...
  const DocEventBody = proto3$1.makeMessageType(
  ...
  const DocEvent$1 = proto3$1.makeMessageType(
    "yorkie.v1.DocEvent",
    () => [
      { no: 1, name: "type", kind: "enum", T: proto3$1.getEnumType(DocEventType$1) },
      {
        no: 2,
        name: "publisher",
        kind: "scalar",
  ...
  exports$3.ValueType = ValueType;
  exports$3.DocEventType = DocEventType$1;
  exports$3.Snapshot = Snapshot;
  exports$3.ChangePack = ChangePack$2;
  exports$3.Change = Change$1;
  exports$3.ChangeID = ChangeID$1;
  exports$3.Operation = Operation$1;
  exports$3.Operation_Set = Operation_Set;
  exports$3.Operation_Add = Operation_Add;
  exports$3.Operation_Move = Operation_Move;
  exports$3.Operation_Remove = Operation_Remove;
  exports$3.Operation_Edit = Operation_Edit;
  exports$3.Operation_Select = Operation_Select;
  exports$3.Operation_Style = Operation_Style;
  exports$3.Operation_Increase = Operation_Increase;
  exports$3.Operation_TreeEdit = Operation_TreeEdit;
  exports$3.Operation_TreeStyle = Operation_TreeStyle;
  exports$3.JSONElementSimple = JSONElementSimple;
  exports$3.JSONElement = JSONElement;
  exports$3.JSONElement_JSONObject = JSONElement_JSONObject;
  exports$3.JSONElement_JSONArray = JSONElement_JSONArray;
  exports$3.JSONElement_Primitive = JSONElement_Primitive;
  exports$3.JSONElement_Text = JSONElement_Text;
  exports$3.JSONElement_Counter = JSONElement_Counter;
  exports$3.JSONElement_Tree = JSONElement_Tree;
  exports$3.RHTNode = RHTNode$1;
  exports$3.RGANode = RGANode;
  exports$3.NodeAttr = NodeAttr;
  exports$3.TextNode = TextNode;
  exports$3.TextNodeID = TextNodeID;
  exports$3.TreeNode = TreeNode;
  exports$3.TreeNodes = TreeNodes;
  exports$3.TreeNodeID = TreeNodeID;
  exports$3.TreePos = TreePos;
  exports$3.User = User;
  exports$3.Project = Project;
  exports$3.UpdatableProjectFields = UpdatableProjectFields;
  exports$3.UpdatableProjectFields_AuthWebhookMethods = UpdatableProjectFields_AuthWebhookMethods;
  exports$3.DocumentSummary = DocumentSummary;
  exports$3.PresenceChange = PresenceChange;
  exports$3.PresenceChange_ChangeType = PresenceChange_ChangeType;
  exports$3.Presence = Presence$1;
  exports$3.Checkpoint = Checkpoint$1;
  exports$3.TextNodePos = TextNodePos;
  exports$3.TimeTicket = TimeTicket$1;
  exports$3.DocEventBody = DocEventBody;
  exports$3.DocEvent = DocEvent$1;
  const __CJS__export_default__$1 = (module$2.exports == null ? {} : module$2.exports).default || module$2.exports;
  const __CJS__export_ValueType__ = (module$2.exports == null ? {} : module$2.exports).ValueType;
  const __CJS__export_DocEventType__ = (module$2.exports == null ? {} : module$2.exports).DocEventType;
  const __CJS__export_Snapshot__ = (module$2.exports == null ? {} : module$2.exports).Snapshot;
  const __CJS__export_ChangePack__ = (module$2.exports == null ? {} : module$2.exports).ChangePack;
  const __CJS__export_Change__ = (module$2.exports == null ? {} : module$2.exports).Change;
  const __CJS__export_ChangeID__ = (module$2.exports == null ? {} : module$2.exports).ChangeID;
  const __CJS__export_Operation__ = (module$2.exports == null ? {} : module$2.exports).Operation;
  const __CJS__export_Operation_Set__ = (module$2.exports == null ? {} : module$2.exports).Operation_Set;
  const __CJS__export_Operation_Add__ = (module$2.exports == null ? {} : module$2.exports).Operation_Add;
  const __CJS__export_Operation_Move__ = (module$2.exports == null ? {} : module$2.exports).Operation_Move;
  const __CJS__export_Operation_Remove__ = (module$2.exports == null ? {} : module$2.exports).Operation_Remove;
  const __CJS__export_Operation_Edit__ = (module$2.exports == null ? {} : module$2.exports).Operation_Edit;
  const __CJS__export_Operation_Select__ = (module$2.exports == null ? {} : module$2.exports).Operation_Select;
  const __CJS__export_Operation_Style__ = (module$2.exports == null ? {} : module$2.exports).Operation_Style;
  const __CJS__export_Operation_Increase__ = (module$2.exports == null ? {} : module$2.exports).Operation_Increase;
  const __CJS__export_Operation_TreeEdit__ = (module$2.exports == null ? {} : module$2.exports).Operation_TreeEdit;
  const __CJS__export_Operation_TreeStyle__ = (module$2.exports == null ? {} : module$2.exports).Operation_TreeStyle;
  const __CJS__export_JSONElementSimple__ = (module$2.exports == null ? {} : module$2.exports).JSONElementSimple;
  const __CJS__export_JSONElement__ = (module$2.exports == null ? {} : module$2.exports).JSONElement;
  const __CJS__export_JSONElement_JSONObject__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_JSONObject;
  const __CJS__export_JSONElement_JSONArray__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_JSONArray;
  const __CJS__export_JSONElement_Primitive__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_Primitive;
  const __CJS__export_JSONElement_Text__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_Text;
  const __CJS__export_JSONElement_Counter__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_Counter;
  const __CJS__export_JSONElement_Tree__ = (module$2.exports == null ? {} : module$2.exports).JSONElement_Tree;
  const __CJS__export_RHTNode__ = (module$2.exports == null ? {} : module$2.exports).RHTNode;
  const __CJS__export_RGANode__ = (module$2.exports == null ? {} : module$2.exports).RGANode;
  const __CJS__export_NodeAttr__ = (module$2.exports == null ? {} : module$2.exports).NodeAttr;
  const __CJS__export_TextNode__ = (module$2.exports == null ? {} : module$2.exports).TextNode;
  const __CJS__export_TextNodeID__ = (module$2.exports == null ? {} : module$2.exports).TextNodeID;
  const __CJS__export_TreeNode__ = (module$2.exports == null ? {} : module$2.exports).TreeNode;
  const __CJS__export_TreeNodes__ = (module$2.exports == null ? {} : module$2.exports).TreeNodes;
  const __CJS__export_TreeNodeID__ = (module$2.exports == null ? {} : module$2.exports).TreeNodeID;
  const __CJS__export_TreePos__ = (module$2.exports == null ? {} : module$2.exports).TreePos;
  const __CJS__export_User__ = (module$2.exports == null ? {} : module$2.exports).User;
  const __CJS__export_Project__ = (module$2.exports == null ? {} : module$2.exports).Project;
  const __CJS__export_UpdatableProjectFields__ = (module$2.exports == null ? {} : module$2.exports).UpdatableProjectFields;
  const __CJS__export_UpdatableProjectFields_AuthWebhookMethods__ = (module$2.exports == null ? {} : module$2.exports).UpdatableProjectFields_AuthWebhookMethods;
  const __CJS__export_DocumentSummary__ = (module$2.exports == null ? {} : module$2.exports).DocumentSummary;
  const __CJS__export_PresenceChange__ = (module$2.exports == null ? {} : module$2.exports).PresenceChange;
  const __CJS__export_PresenceChange_ChangeType__ = (module$2.exports == null ? {} : module$2.exports).PresenceChange_ChangeType;
  const __CJS__export_Presence__ = (module$2.exports == null ? {} : module$2.exports).Presence;
  const __CJS__export_Checkpoint__ = (module$2.exports == null ? {} : module$2.exports).Checkpoint;
  const __CJS__export_TextNodePos__ = (module$2.exports == null ? {} : module$2.exports).TextNodePos;
  const __CJS__export_TimeTicket__ = (module$2.exports == null ? {} : module$2.exports).TimeTicket;
  const __CJS__export_DocEventBody__ = (module$2.exports == null ? {} : module$2.exports).DocEventBody;
  const __CJS__export_DocEvent__ = (module$2.exports == null ? {} : module$2.exports).DocEvent;
  const __CJS__import__1__ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    Change: __CJS__export_Change__,
    ChangeID: __CJS__export_ChangeID__,
    ChangePack: __CJS__export_ChangePack__,
    Checkpoint: __CJS__export_Checkpoint__,
    DocEvent: __CJS__export_DocEvent__,
    DocEventBody: __CJS__export_DocEventBody__,
    DocEventType: __CJS__export_DocEventType__,
    DocumentSummary: __CJS__export_DocumentSummary__,
    JSONElement: __CJS__export_JSONElement__,
    JSONElementSimple: __CJS__export_JSONElementSimple__,
    JSONElement_Counter: __CJS__export_JSONElement_Counter__,
    JSONElement_JSONArray: __CJS__export_JSONElement_JSONArray__,
    JSONElement_JSONObject: __CJS__export_JSONElement_JSONObject__,
    JSONElement_Primitive: __CJS__export_JSONElement_Primitive__,
    JSONElement_Text: __CJS__export_JSONElement_Text__,
    JSONElement_Tree: __CJS__export_JSONElement_Tree__,
    NodeAttr: __CJS__export_NodeAttr__,
    Operation: __CJS__export_Operation__,
    Operation_Add: __CJS__export_Operation_Add__,
    Operation_Edit: __CJS__export_Operation_Edit__,
    Operation_Increase: __CJS__export_Operation_Increase__,
    Operation_Move: __CJS__export_Operation_Move__,
    Operation_Remove: __CJS__export_Operation_Remove__,
    Operation_Select: __CJS__export_Operation_Select__,
    Operation_Set: __CJS__export_Operation_Set__,
    Operation_Style: __CJS__export_Operation_Style__,
    Operation_TreeEdit: __CJS__export_Operation_TreeEdit__,
    Operation_TreeStyle: __CJS__export_Operation_TreeStyle__,
    Presence: __CJS__export_Presence__,
    PresenceChange: __CJS__export_PresenceChange__,
    PresenceChange_ChangeType: __CJS__export_PresenceChange_ChangeType__,
    Project: __CJS__export_Project__,
    RGANode: __CJS__export_RGANode__,
    RHTNode: __CJS__export_RHTNode__,
    Snapshot: __CJS__export_Snapshot__,
    TextNode: __CJS__export_TextNode__,
    TextNodeID: __CJS__export_TextNodeID__,
    TextNodePos: __CJS__export_TextNodePos__,
    TimeTicket: __CJS__export_TimeTicket__,
    TreeNode: __CJS__export_TreeNode__,
    TreeNodeID: __CJS__export_TreeNodeID__,
    TreeNodes: __CJS__export_TreeNodes__,
    TreePos: __CJS__export_TreePos__,
    UpdatableProjectFields: __CJS__export_UpdatableProjectFields__,
    UpdatableProjectFields_AuthWebhookMethods: __CJS__export_UpdatableProjectFields_AuthWebhookMethods__,
    User: __CJS__export_User__,
    ValueType: __CJS__export_ValueType__,
    default: __CJS__export_default__$1
  }, Symbol.toStringTag, { value: "Module" }));
  var module$1 = { exports: {} };
  var exports$2 = module$1.exports;
  Object.defineProperty(exports$2, "__esModule", { value: true });
  const { proto3 } = __CJS__import__1__$1;
  const { ChangePack: ChangePack$1, DocEvent } = __CJS__export_default__$1 || __CJS__import__1__;
  const ActivateClientRequest$1 = proto3.makeMessageType(
  ...
  const ActivateClientResponse$1 = proto3.makeMessageType(
  ...
  const DeactivateClientRequest$1 = proto3.makeMessageType(
  ...
  const DeactivateClientResponse$1 = proto3.makeMessageType(
    "yorkie.v1.DeactivateClientResponse",
    []
  );
  const AttachDocumentRequest$1 = proto3.makeMessageType(
  ...
  const AttachDocumentResponse$1 = proto3.makeMessageType(
  ...
  const DetachDocumentRequest$1 = proto3.makeMessageType(
  ...
  const DetachDocumentResponse$1 = proto3.makeMessageType(
    "yorkie.v1.DetachDocumentResponse",
    () => [
      { no: 2, name: "change_pack", kind: "message", T: ChangePack$1 }
    ]
  );
  const WatchDocumentRequest$1 = proto3.makeMessageType(
  ...
  const WatchDocumentResponse$1 = proto3.makeMessageType(
  ...
  const RemoveDocumentRequest$1 = proto3.makeMessageType(
  ...
  const RemoveDocumentResponse$1 = proto3.makeMessageType(
    "yorkie.v1.RemoveDocumentResponse",
    () => [
      { no: 1, name: "change_pack", kind: "message", T: ChangePack$1 }
    ]
  );
  const PushPullChangesRequest$1 = proto3.makeMessageType(
  ...
  const PushPullChangesResponse$1 = proto3.makeMessageType(
    "yorkie.v1.PushPullChangesResponse",
    () => [
      { no: 1, name: "change_pack", kind: "message", T: ChangePack$1 }
    ]
  );
  const BroadcastRequest$1 = proto3.makeMessageType(
  ...
  const BroadcastResponse$1 = proto3.makeMessageType(
    "yorkie.v1.BroadcastResponse",
    []
  );
  exports$2.ActivateClientRequest = ActivateClientRequest$1;
  exports$2.ActivateClientResponse = ActivateClientResponse$1;
  exports$2.DeactivateClientRequest = DeactivateClientRequest$1;
  exports$2.DeactivateClientResponse = DeactivateClientResponse$1;
  exports$2.AttachDocumentRequest = AttachDocumentRequest$1;
  exports$2.AttachDocumentResponse = AttachDocumentResponse$1;
  exports$2.DetachDocumentRequest = DetachDocumentRequest$1;
  exports$2.DetachDocumentResponse = DetachDocumentResponse$1;
  exports$2.WatchDocumentRequest = WatchDocumentRequest$1;
  exports$2.WatchDocumentResponse = WatchDocumentResponse$1;
  exports$2.WatchDocumentResponse_Initialization = WatchDocumentResponse_Initialization;
  exports$2.RemoveDocumentRequest = RemoveDocumentRequest$1;
  exports$2.RemoveDocumentResponse = RemoveDocumentResponse$1;
  exports$2.PushPullChangesRequest = PushPullChangesRequest$1;
  exports$2.PushPullChangesResponse = PushPullChangesResponse$1;
  exports$2.BroadcastRequest = BroadcastRequest$1;
  exports$2.BroadcastResponse = BroadcastResponse$1;
  const __CJS__export_default__ = (module$1.exports == null ? {} : module$1.exports).default || module$1.exports;
  const __CJS__export_ActivateClientRequest__ = (module$1.exports == null ? {} : module$1.exports).ActivateClientRequest;
  const __CJS__export_ActivateClientResponse__ = (module$1.exports == null ? {} : module$1.exports).ActivateClientResponse;
  const __CJS__export_DeactivateClientRequest__ = (module$1.exports == null ? {} : module$1.exports).DeactivateClientRequest;
  const __CJS__export_DeactivateClientResponse__ = (module$1.exports == null ? {} : module$1.exports).DeactivateClientResponse;
  const __CJS__export_AttachDocumentRequest__ = (module$1.exports == null ? {} : module$1.exports).AttachDocumentRequest;
  const __CJS__export_AttachDocumentResponse__ = (module$1.exports == null ? {} : module$1.exports).AttachDocumentResponse;
  const __CJS__export_DetachDocumentRequest__ = (module$1.exports == null ? {} : module$1.exports).DetachDocumentRequest;
  const __CJS__export_DetachDocumentResponse__ = (module$1.exports == null ? {} : module$1.exports).DetachDocumentResponse;
  const __CJS__export_WatchDocumentRequest__ = (module$1.exports == null ? {} : module$1.exports).WatchDocumentRequest;
  const __CJS__export_WatchDocumentResponse__ = (module$1.exports == null ? {} : module$1.exports).WatchDocumentResponse;
  const __CJS__export_WatchDocumentResponse_Initialization__ = (module$1.exports == null ? {} : module$1.exports).WatchDocumentResponse_Initialization;
  const __CJS__export_RemoveDocumentRequest__ = (module$1.exports == null ? {} : module$1.exports).RemoveDocumentRequest;
  const __CJS__export_RemoveDocumentResponse__ = (module$1.exports == null ? {} : module$1.exports).RemoveDocumentResponse;
  const __CJS__export_PushPullChangesRequest__ = (module$1.exports == null ? {} : module$1.exports).PushPullChangesRequest;
  const __CJS__export_PushPullChangesResponse__ = (module$1.exports == null ? {} : module$1.exports).PushPullChangesResponse;
  const __CJS__export_BroadcastRequest__ = (module$1.exports == null ? {} : module$1.exports).BroadcastRequest;
  const __CJS__export_BroadcastResponse__ = (module$1.exports == null ? {} : module$1.exports).BroadcastResponse;
  const __CJS__import__0__ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
    __proto__: null,
    ActivateClientRequest: __CJS__export_ActivateClientRequest__,
    ActivateClientResponse: __CJS__export_ActivateClientResponse__,
    AttachDocumentRequest: __CJS__export_AttachDocumentRequest__,
    AttachDocumentResponse: __CJS__export_AttachDocumentResponse__,
    BroadcastRequest: __CJS__export_BroadcastRequest__,
    BroadcastResponse: __CJS__export_BroadcastResponse__,
    DeactivateClientRequest: __CJS__export_DeactivateClientRequest__,
    DeactivateClientResponse: __CJS__export_DeactivateClientResponse__,
    DetachDocumentRequest: __CJS__export_DetachDocumentRequest__,
    DetachDocumentResponse: __CJS__export_DetachDocumentResponse__,
    PushPullChangesRequest: __CJS__export_PushPullChangesRequest__,
    PushPullChangesResponse: __CJS__export_PushPullChangesResponse__,
    RemoveDocumentRequest: __CJS__export_RemoveDocumentRequest__,
    RemoveDocumentResponse: __CJS__export_RemoveDocumentResponse__,
    WatchDocumentRequest: __CJS__export_WatchDocumentRequest__,
    WatchDocumentResponse: __CJS__export_WatchDocumentResponse__,
    WatchDocumentResponse_Initialization: __CJS__export_WatchDocumentResponse_Initialization__,
    default: __CJS__export_default__
  }, Symbol.toStringTag, { value: "Module" }));
  var module2 = { exports: {} };
  var exports$1 = module2.exports;
  Object.defineProperty(exports$1, "__esModule", { value: true });
  const { ActivateClientRequest, ActivateClientResponse, AttachDocumentRequest, AttachDocumentResponse, BroadcastRequest, BroadcastResponse, DeactivateClientRequest, DeactivateClientResponse, DetachDocumentRequest, DetachDocumentResponse, PushPullChangesRequest, PushPullChangesResponse, RemoveDocumentRequest, RemoveDocumentResponse, WatchDocumentRequest, WatchDocumentResponse } = __CJS__export_default__ || __CJS__import__0__;
  const { MethodKind } = __CJS__import__1__$1;
  const YorkieService = {
  ...
  exports$1.YorkieService = YorkieService;
  (module2.exports == null ? {} : module2.exports).default || module2.exports;
  const __CJS__export_YorkieService__ = (module2.exports == null ? {} : module2.exports).YorkieService;
  /**
   * @license
  ...
  class RHT {
    ...
    toXML() {
      ...
      const attrs = [...this.nodeMapByKey].filter(([, v]) => v instanceof RHTNode && !v.isRemoved()).sort((a, b) => a[0].localeCompare(b[0])).map(([k, v]) => `${k}="${JSON.parse(v.getValue())}"`);
      return ` ${attrs.join(" ")}`;
    }
    /**
  ...
  function toTreeNode(node) {
    ...
    return {
      ...
      attributes: node.attrs ? parseObjectValues((_a = node.attrs) == null ? void 0 : _a.toObject()) : void 0
    };
  }
  function toXML(node) {
    var _a;
    ...
    return `<${node.type}${((_a = node.attrs) == null ? void 0 : _a.toXML()) || ""}>${node.children.map((child) => toXML(child)).join("")}</${node.type}>`;
  }
  ...
  class CRDTTree extends CRDTGCElement {
    ...
    style(range, attributes, editedAt, maxCreatedAtMapByActor) {
      ...
      this.traverseInPosRange(
        ...
        ([node]) => {
          const actorID = node.getCreatedAt().getActorID();
          let maxCreatedAt = maxCreatedAtMapByActor ? maxCreatedAtMapByActor.has(actorID) ? maxCreatedAtMapByActor.get(actorID) : InitialTimeTicket : MaxTimeTicket;
          if (node.canStyle(editedAt, maxCreatedAt) && !node.isText && attributes) {
    ...
    removeStyle(range, attributesToRemove, editedAt) {
      ...
      const [toParent, toLeft] = this.findNodesAndSplitText(range[1], editedAt);
      const changes = [];
      const value = attributesToRemove ? attributesToRemove : void 0;
      this.traverseInPosRange(
        fromParent,
        fromLeft,
        toParent,
        ...
        ([node]) => {
          if (!node.isRemoved && !node.isText && attributesToRemove) {
            ...
            for (const value2 of attributesToRemove) {
              node.attrs.remove(value2, editedAt);
            }
            changes.push({
              type: "removeStyle",
              from: this.toIndex(fromParent, fromLeft),
    ...
    purgeRemovedNodesBefore(ticket) {
      var _a;
      const nodesToBeRemoved = /* @__PURE__ */ new Set();
      let count = 0;
    ...
    toJSInfoForTest() {
      ...
      const toTreeNodeInfo = (node, parentNode = void 0, leftChildNode = void 0, depth = 0) => {
        ...
        for (let i = 0; i < node.children.length; i++) {
          const leftChildNode2 = i === 0 ? node : node.children[i - 1];
          nodeInfo.children.push(
            toTreeNodeInfo(node.children[i], node, leftChildNode2, depth + 1)
          );
        }
        return nodeInfo;
      };
  ...
  class RGATreeSplit {
    ...
    edit(range, editedAt, value, maxCreatedAtMapByActor) {
      ...
      const [changes, maxCreatedAtMap, removedNodeMapByNodeKey] = this.deleteNodes(nodesToDelete, editedAt, maxCreatedAtMapByActor);
    ...
    *[Symbol.iterator]() {
    ...
    deleteNodes(candidates, editedAt, maxCreatedAtMapByActor) {
      ...
      const createdAtMapByActor = /* @__PURE__ */ new Map();
      const removedNodeMap = /* @__PURE__ */ new Map();
  ...
  function toPresence(presence) {
    const pbPresence = new __CJS__export_Presence__();
  ...
  function toTimeTicket(ticket) {
    ...
    return new __CJS__export_TimeTicket__({
  ...
  function toValueType(valueType) {
    switch (valueType) {
      case PrimitiveType.Null:
        return __CJS__export_ValueType__.NULL;
      case PrimitiveType.Boolean:
        return __CJS__export_ValueType__.BOOLEAN;
      case PrimitiveType.Integer:
        return __CJS__export_ValueType__.INTEGER;
      case PrimitiveType.Long:
        return __CJS__export_ValueType__.LONG;
      case PrimitiveType.Double:
        return __CJS__export_ValueType__.DOUBLE;
      case PrimitiveType.String:
        return __CJS__export_ValueType__.STRING;
      case PrimitiveType.Bytes:
        return __CJS__export_ValueType__.BYTES;
      case PrimitiveType.Date:
        return __CJS__export_ValueType__.DATE;
      default:
  ...
  function toCounterType(valueType) {
    switch (valueType) {
      case CounterType.IntegerCnt:
        return __CJS__export_ValueType__.INTEGER_CNT;
      case CounterType.LongCnt:
        return __CJS__export_ValueType__.LONG_CNT;
      default:
        throw new YorkieError(Code.Unsupported, `unsupported type: ${valueType}`);
    }
  }
  function toElementSimple(element) {
    if (element instanceof CRDTObject) {
      return new __CJS__export_JSONElementSimple__({
        type: __CJS__export_ValueType__.JSON_OBJECT,
    ...
    if (element instanceof CRDTArray) {
      return new __CJS__export_JSONElementSimple__({
        type: __CJS__export_ValueType__.JSON_ARRAY,
        createdAt: toTimeTicket(element.getCreatedAt()),
    ...
    if (element instanceof CRDTText) {
      return new __CJS__export_JSONElementSimple__({
        type: __CJS__export_ValueType__.TEXT,
        createdAt: toTimeTicket(element.getCreatedAt())
      });
    }
    ...
    if (element instanceof CRDTTree) {
      return new __CJS__export_JSONElementSimple__({
        type: __CJS__export_ValueType__.TREE,
        createdAt: toTimeTicket(element.getCreatedAt()),
  ...
  function toTextNodeID(id) {
    return new __CJS__export_TextNodeID__({
      createdAt: toTimeTicket(id.getCreatedAt()),
      offset: id.getOffset()
    });
  }
  function toTextNodePos(pos) {
    return new __CJS__export_TextNodePos__({
  ...
  function toOperation(operation) {
    ...
    if (operation instanceof SetOperation) {
      ...
      const pbAddOperation = new __CJS__export_Operation_Add__();
      ...
      const pbMoveOperation = new __CJS__export_Operation_Move__();
      ...
      const pbRemoveOperation = new __CJS__export_Operation_Remove__();
      ...
      const pbEditOperation = new __CJS__export_Operation_Edit__();
      ...
      const pbStyleOperation = new __CJS__export_Operation_Style__();
      ...
      const pbIncreaseOperation = new __CJS__export_Operation_Increase__();
      ...
      const pbTreeEditOperation = new __CJS__export_Operation_TreeEdit__();
      ...
      const pbTreeStyleOperation = new __CJS__export_Operation_TreeStyle__();
  ...
  function toChange(change) {
    const pbChange = new __CJS__export_Change__({
  ...
  function toTextNodes(rgaTreeSplit) {
    ...
    for (const textNode of rgaTreeSplit) {
      const pbTextNode = new __CJS__export_TextNode__();
      ...
      for (const attr of attrs) {
        const pbNodeAttr = new __CJS__export_NodeAttr__();
  ...
  function toTreeNodes(node) {
    ...
    traverse(node, (n, depth) => {
      const pbTreeNode = new __CJS__export_TreeNode__({
      ...
      if (n.attrs) {
        for (const attr of n.attrs) {
          pbTreeNode.attributes[attr.getKey()] = new __CJS__export_NodeAttr__({
            value: attr.getValue(),
  ...
  function toObject(obj) {
    const pbElement = new __CJS__export_JSONElement__();
    pbElement.body.case = "jsonObject";
    pbElement.body.value = new __CJS__export_JSONElement_JSONObject__({
  ...
  function toArray(arr) {
    ...
    pbElement.body.value = new __CJS__export_JSONElement_JSONArray__({
  ...
  function toPrimitive(primitive) {
    ...
    pbElement.body.value = new __CJS__export_JSONElement_Primitive__({
  ...
  function toText(text) {
    ...
    pbElement.body.value = new __CJS__export_JSONElement_Text__({
  ...
  function toCounter(counter) {
    ...
    pbElement.body.value = new __CJS__export_JSONElement_Counter__({
  ...
  function toTree(tree) {
    ...
    pbElement.body.value = new __CJS__export_JSONElement_Tree__({
  ...
  function toChangePack(pack) {
    return new __CJS__export_ChangePack__({
  ...
  function fromPresenceChange(pbPresenceChange) {
    ...
    if (type === __CJS__export_PresenceChange_ChangeType__.PUT) {
    ...
    if (type === __CJS__export_PresenceChange_ChangeType__.CLEAR) {
      return {
  ...
  function fromValueType(pbValueType) {
    switch (pbValueType) {
      case __CJS__export_ValueType__.NULL:
        return PrimitiveType.Null;
      case __CJS__export_ValueType__.BOOLEAN:
        return PrimitiveType.Boolean;
      case __CJS__export_ValueType__.INTEGER:
        return PrimitiveType.Integer;
      case __CJS__export_ValueType__.LONG:
        return PrimitiveType.Long;
      case __CJS__export_ValueType__.DOUBLE:
        return PrimitiveType.Double;
      case __CJS__export_ValueType__.STRING:
        return PrimitiveType.String;
      case __CJS__export_ValueType__.BYTES:
        return PrimitiveType.Bytes;
      case __CJS__export_ValueType__.DATE:
  ...
  function fromCounterType(pbValueType) {
    switch (pbValueType) {
      case __CJS__export_ValueType__.INTEGER_CNT:
        return CounterType.IntegerCnt;
      case __CJS__export_ValueType__.LONG_CNT:
  ...
  function fromElementSimple(pbElementSimple) {
    switch (pbElementSimple.type) {
      case __CJS__export_ValueType__.JSON_OBJECT:
  ...
  function bytesToSnapshot(bytes) {
    ...
    const snapshot = __CJS__export_Snapshot__.fromBinary(bytes);
    return {
  ...
  function bytesToObject(bytes) {
    ...
    const pbElement = __CJS__export_JSONElement__.fromBinary(bytes);
    return fromObject(pbElement.body.value);
  }
  ...
  function bytesToChangeID(bytes) {
    const pbChangeID = __CJS__export_ChangeID__.fromBinary(bytes);
    return fromChangeID(pbChangeID);
  }
  function bytesToOperation(bytes) {
    const pbOperation = __CJS__export_Operation__.fromBinary(bytes);
  ...
  const converter = {
    ...
    toOperation,
    toChangeID,
    PbChangeID: __CJS__export_ChangeID__,
    bytesToChangeID,
    bytesToOperation
  };
  function uuid() {
  ...
  class CRDTRoot {
    constructor(rootObject) {
       ...
       */
      __publicField(this, "removedElementSetByCreatedAt");
      /**
       ...
       */
      __publicField(this, "elementHasRemovedNodesSetByCreatedAt");
      this.rootObject = rootObject;
      this.elementPairMapByCreatedAt = /* @__PURE__ */ new Map();
      this.removedElementSetByCreatedAt = /* @__PURE__ */ new Set();
      this.elementHasRemovedNodesSetByCreatedAt = /* @__PURE__ */ new Set();
  ...
  class Document {
          ...
          return this.eventStream.subscribe(
            (event) => {
              for (const docEvent of event) {
                ...
                if (docEvent.type !== "initialized" && docEvent.value.clientID !== this.changeID.getActorID()) {
                  continue;
                }
                callback2(docEvent);
              }
    ...
    applyChanges(changes, source) {
      if (logger.isEnabled(LogLevel.Debug)) {
        logger.debug(
          `trying to apply ${changes.length} remote changes.elements:${this.root.getElementMapSize()}, removeds:${this.root.getRemovedElementSetSize()}`
        );
      }
      if (logger.isEnabled(LogLevel.Trivial)) {
        logger.trivial(
      ...
      if (logger.isEnabled(LogLevel.Debug)) {
        logger.debug(
          `after appling ${changes.length} remote changes.elements:${this.root.getElementMapSize()},  removeds:${this.root.getRemovedElementSetSize()}`
        );
      }
    }
    /**
    ...
    applyWatchStream(resp) {
      ...
      if (resp.body.case === "event") {
        ...
        const event = [];
        if (type === __CJS__export_DocEventType__.DOCUMENT_WATCHED) {
        ...
        } else if (type === __CJS__export_DocEventType__.DOCUMENT_UNWATCHED) {
  ...
  class Client {
    ...
    handleWatchDocumentsResponse(attachment, resp) {
      if (resp.body.case === "event" && resp.body.value.type === __CJS__export_DocEventType__.DOCUMENT_CHANGED) {
        attachment.remoteChangeEventReceived = true;
        return;
      }
    ...
    syncInternal(attachment, syncMode) {
      ...
      return this.rpcClient.pushPullChanges(
        ...
        if (respPack.hasChanges() && attachment.syncMode === "realtime-pushonly") {
          return doc;
        }
  ...
  exports2.DocumentSyncStatus = DocumentSyncStatus;
  exports2.EventSourceDevPanel = EventSourceDevPanel;
  exports2.EventSourceSDK = EventSourceSDK;
  exports2.OpSource = OpSource;
  exports2.Primitive = Primitive;
  exports2.StreamConnectionStatus = StreamConnectionStatus;
