...
import type { WatchDocumentResponse } from '../api/yorkie/v1/yorkie_pb';
 ...
 * @public
 */
export declare type DocEvent<P extends Indexable = Indexable, T = OperationInfo> = StatusChangedEvent_2 | SnapshotEvent | LocalChangeEvent<T, P> | RemoteChangeEvent<T, P> | InitializedEvent<P> | WatchedEvent<P> | UnwatchedEvent<P> | PresenceChangedEvent<P>;
 ...
 * @public
 */
declare interface StatusChangedEvent_2 extends BaseDocEvent {
    /**
