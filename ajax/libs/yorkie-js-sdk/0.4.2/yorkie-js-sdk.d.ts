 ...
 */
declare function bytesToTreePos(bytes: Uint8Array): CRDTTreePos;
/**
 ...
 */
declare type InternalOpInfo = ToInternalOpInfo<AddOpInfo> | ToInternalOpInfo<IncreaseOpInfo> | ToInternalOpInfo<RemoveOpInfo> | ToInternalOpInfo<SetOpInfo> | ToInternalOpInfo<MoveOpInfo> | ToInternalOpInfo<EditOpInfo> | ToInternalOpInfo<StyleOpInfo> | ToInternalOpInfo<SelectOpInfo> | ToInternalOpInfo<TreeEditOpInfo> | ToInternalOpInfo<TreeStyleOpInfo>;
/**
 ...
 */
declare function treePosToBytes(pos: CRDTTreePos): Uint8Array;
/**
 * `TreeRange` represents a pair of CRDTTreePos.
 */
declare type TreeRange = [
    CRDTTreePos,
    CRDTTreePos
];
...
declare const yorkie: {
    ...
    converter: {
        ...
        toClient: <M_1>(id: string, presence: PresenceInfo<M_1>) => Client_2;
        toChangePack: (pack: ChangePack) => ChangePack_2;
        fromChangePack: (pbPack: ChangePack_2) => ChangePack;
        fromChanges: (pbChanges: Change_2[]) => Change[];
