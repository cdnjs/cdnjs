...
declare class CRDTTree {
    onChangesHandler?: () => void;
    changeCollector?: (changes: Array<TreeChange>) => void;
    private dummyHead;
    private indexTree;
     ...
     */
    onChanges(handler: () => void): void;
    /**
     * `onChanges` registers a handler of onChanges event.
     */
    onChangeCollect(collector: (changes: Array<TreeChange>) => void): void;
    /**
...
declare type TreeChangeWithPath = Omit<TreeChange, 'from' | 'to'> & {
    from: Array<number>;
    to: Array<number>;
};
