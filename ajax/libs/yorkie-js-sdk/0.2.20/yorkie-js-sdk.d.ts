...
declare class CRDTRichText<A> {
     ...
     */
    static create<A>(rgaTreeSplit: RGATreeSplit<RichTextValue>, createdAt: TimeTicket): CRDTRichText<A>;
    /**
 ...
 */
export declare type JSONElement<T = unknown, A = unknown> = PrimitiveValue | JSONObject<T> | JSONArray<T> | Text_2 | RichText<A> | Counter;
...
declare class Operation_2 {
    ...
    getRichEdit(): Operation_2.RichEdit | undefined;
    setRichEdit(value?: Operation_2.RichEdit): Operation_2;
    hasRichEdit(): boolean;
    clearRichEdit(): Operation_2;
...
declare namespace Operation_2 {
    type AsObject = {
        ...
        richEdit?: Operation_2.RichEdit.AsObject;
    ...
    class RichEdit {
        getParentCreatedAt(): TimeTicket_2 | undefined;
        setParentCreatedAt(value?: TimeTicket_2): RichEdit;
        hasParentCreatedAt(): boolean;
        ...
        getExecutedAt(): TimeTicket_2 | undefined;
        setExecutedAt(value?: TimeTicket_2): RichEdit;
        hasExecutedAt(): boolean;
...
export declare class RichText<A = Indexable> {
     ...
     * @internal
     */
    initialize(context: ChangeContext, text: CRDTRichText<A>): void;
    /**
     * `getID` returns the ID of this text.
     */
    getID(): TimeTicket;
 ...
 */
declare type RichTextChange<A> = TextChange & {
    attributes?: A;
};
declare interface RichTextVal<A> {
    attributes: A;
    content: string;
}
/**
 ...
 */
export declare type WrappedElement<T = unknown, A = unknown> = Primitive | JSONObject<T> | JSONArray<T> | Text_2 | RichText<A> | Counter;
/**
