...
declare class ChangeID {
    ...
    private lamport;
    private actor;
    constructor(clientSeq: number, lamport: default_2, actor: ActorID);
    /**
     * `of` creates a new instance of ChangeID.
     */
    static of(clientSeq: number, lamport: default_2, actor: ActorID): ChangeID;
    /**
...
declare class CRDTTree extends CRDTGCElement {
     ...
     */
    findNodesAndSplitText(pos: CRDTTreePos, editedAt?: TimeTicket): [CRDTTreeNode, CRDTTreeNode];
    /**
     ...
     */
    removeStyle(range: [CRDTTreePos, CRDTTreePos], attributesToRemove: Array<string>, editedAt: TimeTicket): TreeChange[];
    /**
     * `edit` edits the tree with the given range and content.
     * If the content is undefined, the range will be removed.
     */
    edit(range: [CRDTTreePos, CRDTTreePos], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket, issueTimeTicket: (() => TimeTicket) | undefined, latestCreatedAtMapByActor?: Map<string, TimeTicket>): [Array<TreeChange>, Map<string, TimeTicket>];
    /**
...
declare class RHT {
     ...
     */
    remove(key: string, executedAt: TimeTicket): string;
    /**
     * `has` returns whether the element exists of the given key or not.
     */
    has(key: string): boolean;
