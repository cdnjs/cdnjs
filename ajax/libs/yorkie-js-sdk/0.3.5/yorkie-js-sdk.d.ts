 ...
 */
declare type InternalOpInfo = ToInternalOpInfo<AddOpInfo> | ToInternalOpInfo<IncreaseOpInfo> | ToInternalOpInfo<RemoveOpInfo> | ToInternalOpInfo<SetOpInfo> | ToInternalOpInfo<MoveOpInfo> | ToInternalOpInfo<EditOpInfo> | ToInternalOpInfo<StyleOpInfo> | ToInternalOpInfo<SelectOpInfo>;
/**
...
declare type SelectOpInfo = {
    type: 'select';
    from: number;
    to: number;
    path: string;
};
declare type SetOpInfo = {
    type: 'set';
    path: string;
    key: string;
};
