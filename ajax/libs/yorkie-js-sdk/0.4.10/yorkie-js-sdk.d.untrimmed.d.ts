...
declare class CRDTTree extends CRDTGCElement {
     ...
     */
    edit(range: [CRDTTreePos, CRDTTreePos], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket, latestCreatedAtMapByActor?: Map<string, TimeTicket>): [Array<TreeChange>, Map<string, TimeTicket>];
    /**
     * `editT` edits the given range with the given value.
     * This method uses indexes instead of a pair of TreePos for testing.
     */
    editT(range: [number, number], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket): void;
    /**
