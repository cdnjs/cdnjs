...
declare class CRDTTree {
    ...
    edit(range: [
        CRDTTreePos,
        CRDTTreePos
    ], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket, latestCreatedAtMapByActor?: Map<string, TimeTicket>): [
        Array<TreeChange>,
    ...
    editT(range: [
        number,
        number
    ], contents: Array<CRDTTreeNode> | undefined, splitLevel: number, editedAt: TimeTicket): void;
    /**
...
declare class CRDTTreeNode {
     ...
     */
    split(tree: CRDTTree, offset: number): CRDTTreeNode | undefined;
    /**
