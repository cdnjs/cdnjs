...
export declare class Client {
     ...
     */
    broadcast(docKey: DocKey, topic: string, payload: Json, options?: BroadcastOptions): Promise<void>;
    /**
 ...
 * @public
 */
export declare type DocEvent<P extends Indexable = Indexable, T = OperationInfo> = StatusChangedEvent | ConnectionChangedEvent | SyncStatusChangedEvent | SnapshotEvent | LocalChangeEvent<T, P> | RemoteChangeEvent<T, P> | InitializedEvent<P> | WatchedEvent<P> | UnwatchedEvent<P> | PresenceChangedEvent<P> | BroadcastEvent | LocalBroadcastEvent | AuthErrorEvent;
