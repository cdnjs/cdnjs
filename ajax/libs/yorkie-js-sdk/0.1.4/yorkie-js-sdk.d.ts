...
declare class ChangeContext {
     ...
     */
    registerElement(element: JSONElement, parent: JSONContainer): void;
    /**
     ...
     * garbage collection.
     */
    registerRemovedNodeTextElement(text: TextElement): void;
    /**
...
declare class Counter extends JSONElement {
     ...
     */
    static of(value: CounterValue, createdAt: TimeTicket): Counter;
    /**
     ...
     */
    increase(v: JSONPrimitive): Counter;
}
...
declare class CounterProxy {
     ...
     */
    static create(context: ChangeContext, target: Counter): Counter;
    /**
 ...
 * @public
 */
declare interface DocumentsChangedEvent extends BaseClientEvent {
 ...
 */
declare interface DocumentSyncedEvent extends BaseClientEvent {
    type: ClientEventType.DocumentSynced;
    value: DocumentSyncResultType;
}

declare enum DocumentSyncResultType {
    Synced = "synced",
...
declare abstract class JSONContainer extends JSONElement {
    ...
    abstract getDescendants(callback: (elem: JSONElement, parent: JSONContainer) => boolean): void;
}
...
declare class JSONPrimitive extends JSONElement {
     ...
     */
    static of(value: PrimitiveValue, createdAt: TimeTicket): JSONPrimitive;
    /**
     * `valueFromBytes` parses the given bytes into value.
     */
...
declare class JSONRoot {
     ...
     */
    registerTextWithGarbage(text: TextElement): void;
    /**
 ...
 * @public
 */
declare interface LocalChangeEvent extends BaseDocEvent {
 ...
 * @public
 */
declare interface PeersChangedEvent extends BaseClientEvent {
    type: ClientEventType.PeersChanged;
    value: {
        [docKey: string]: {
            [clientKey: string]: Metadata;
        };
    };
}
 ...
 * @public
 */
declare interface RemoteChangeEvent extends BaseDocEvent {
 ...
 */
declare class RGATreeListNode extends SplayNode<JSONElement> {
    private prev?;
    private next?;
...
declare class RGATreeSplitNodePos {
     ...
     */
    compare(other: RGATreeSplitNodePos): number;
}
 ...
 */
declare class RHTPQMapNode extends HeapNode<TimeTicket, JSONElement> {
    private strKey;
 ...
 * @public
 */
declare interface SnapshotEvent extends BaseDocEvent {
 ...
 * @public
 */
declare interface StatusChangedEvent extends BaseClientEvent {
    type: ClientEventType.StatusChanged;
    value: ClientStatus;
}

declare enum StreamConnectionStatus {
    Connected = "connected",
 ...
 * @public
 */
declare interface StreamConnectionStatusChangedEvent extends BaseClientEvent {
