...
declare class Document_2<T, P extends Indexable = Indexable> {
     ...
     */
    getUndoStackForTest(): Array<Array<string>>;
    /**
...
declare abstract class Operation {
     ...
     */
    abstract execute(root: CRDTRoot): ExecutionResult;
}
...
declare class TreeNode_3 {
    ...
    setId(value?: TreeNodeID): TreeNode_3;
    hasId(): boolean;
    clearId(): TreeNode_3;
    getType(): string;
    ...
    setInsPrevId(value?: TreeNodeID): TreeNode_3;
    hasInsPrevId(): boolean;
    clearInsPrevId(): TreeNode_3;
    getInsNextId(): TreeNodeID | undefined;
    setInsNextId(value?: TreeNodeID): TreeNode_3;
    hasInsNextId(): boolean;
    clearInsNextId(): TreeNode_3;
    getDepth(): number;
