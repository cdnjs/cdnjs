...
declare class CRDTObject extends CRDTContainer {
     ...
     */
    set(key: string, value: CRDTElement): CRDTElement | undefined;
    /**
...
declare class CRDTRoot {
     ...
     */
    deregisterElement(element: CRDTElement): void;
    /**
...
declare class CRDTTree extends CRDTGCElement {
     ...
     */
    editByIndex(range: [number, number], contents: Array<CRDTTreeNode> | undefined, editedAt: TimeTicket): void;
    /**
     ...
     */
    indexRangeToPosStructRange(range: [number, number]): TreeRangeStruct;
    /**
...
declare class TreeNode_3 extends jspb.Message {
 ...
 */
export declare type TreeRangeStruct = [CRDTTreePosStruct, CRDTTreePosStruct];
