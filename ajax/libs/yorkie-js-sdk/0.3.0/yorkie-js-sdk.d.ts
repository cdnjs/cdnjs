...
declare class CRDTText<A> {
     ...
     */
    static create<A>(rgaTreeSplit: RGATreeSplit<CRDTTextValue>, createdAt: TimeTicket): CRDTText<A>;
    /**
     * `edit` edits the given range with the given value and attributes.
     *
     * @internal
     */
    edit(range: RGATreeSplitNodeRange, value: string, editedAt: TimeTicket, attributes?: Record<string, string>, latestCreatedAtMapByActor?: Map<string, TimeTicket>): Map<string, TimeTicket>;
    /**
...
declare interface CRDTTextVal<A> {
    attributes: A;
    value: string;
}
/**
...
declare class CRDTTextValue {
     ...
     */
    static create(value: string): CRDTTextValue;
    /**
 ...
 */
export declare type JSONElement<T = unknown, A = unknown> = PrimitiveValue | JSONObject<T> | JSONArray<T> | Text_2<A> | Counter;
 ...
 */
declare class Text_2<A = Indexable> {
    private context?;
    private text?;
 ...
 */
export declare type WrappedElement<T = unknown, A = unknown> = Primitive | JSONObject<T> | JSONArray<T> | Text_2<A> | Counter;
/**
