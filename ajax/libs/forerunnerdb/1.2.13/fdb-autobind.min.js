...
"MODULE_NOT_FOUND",ea;}ea=L[g]={exports:{}};$[g][0].call(ea.exports,function(b){var v=$[g][1][b];return a(v?v:b)},ea,ea.exports,H,$,L,k)}return L[g].exports}for(var b="function"==typeof require&&require,g=0;g<k.length;g++)a(k[g]);return a}({1:[function(H,$,L){H=H("../lib/AutoBind");$.exports=H},{"../lib/AutoBind":2}],2:[function(H,$,L){L=ForerunnerDB.shared;var k={};L.addModule("AutoBind",k);k.extendCollection=function(b){var a=b.prototype.init,hb=b.prototype._dataReplace,v=b.prototype._dataInsertIndex,
ea=b.prototype._dataRemoveIndex,k=b.prototype._updateProperty,P=b.prototype._updateIncrement,S=b.prototype._updateSpliceMove,H=b.prototype._updateSplicePush,ja=b.prototype._updatePush,L=b.prototype._updatePull,qa=b.prototype._updateMultiply,oa=b.prototype._updateRename,$=b.prototype._updateUnset,aa=b.prototype._updatePop;b.prototype.init=function(){this._linked=0;a.apply(this,arguments)};b.prototype.isLinked=function(){return Boolean(this._linked)};b.prototype.link=function(b,a){if(window.jQuery){this._links=
this._links||{};var D,g;a&&"object"===typeof a?a.template&&"string"===typeof a.template&&(D=this.objectId(a.template),g=a.template):D=a;if(!this._links[D]){if(jQuery(b).length){if(!jQuery.templates[D]){if(!g)if(g=jQuery(a),g.length)g=jQuery(g[0]).html();else throw"Unable to bind collection to target because template does not exist: "+a;jQuery.views.templates(D,g)}jQuery.templates[D].link(b,this._data);this._links[D]=b;this._linked++;this.debug()&&console.log('ForerunnerDB.Collection: Added binding collection "'+
this.name()+'" to output target: '+b);return this}throw'Cannot bind view data to output target selector "'+b+'" because it does not exist in the DOM!';}throw"Cannot create a duplicate link to the target: "+b+" with the template: "+D;}throw"Cannot data-bind without jQuery, please add jQuery to your page!";};b.prototype.unlink=function(b,a){if(window.jQuery){this._links=this._links||{};var g;a&&"object"===typeof a?a.template&&"string"===typeof a.template&&(g=this.objectId(a.template)):g=a;if(this._links[g])return jQuery.templates[g].unlink(b),
delete this._links[g],this._linked--,this.debug()&&console.log('ForerunnerDB.Collection: Removed binding collection "'+this.name()+'" to output target: '+b),this;console.log("Cannot remove link, one does not exist to the target: "+b+" with the template: "+a)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";return this};b.prototype._dataReplace=function(b){this._linked?jQuery.observable(this._data).refresh(b):hb.apply(this,arguments)};b.prototype._dataInsertIndex=function(b,
a){this._linked?jQuery.observable(this._data).insert(b,a):v.apply(this,arguments)};b.prototype._dataRemoveIndex=function(b){this._linked?jQuery.observable(this._data).remove(b):ea.apply(this,arguments)};b.prototype._updateProperty=function(b,a,g){this._linked?(jQuery.observable(b).setProperty(a,g),this.debug()&&console.log('ForerunnerDB.Collection: Setting data-bound document property "'+a+'" for collection "'+this.name()+'"')):k.apply(this,arguments)};b.prototype._updateIncrement=function(b,a,g){this._linked?
jQuery.observable(b).setProperty(a,b[a]+g):P.apply(this,arguments)};b.prototype._updateSpliceMove=function(b,a,g){this._linked?(jQuery.observable(b).move(a,g),this.debug()&&console.log('ForerunnerDB.Collection: Moving data-bound document array index from "'+a+'" to "'+g+'" for collection "'+this.name()+'"')):S.apply(this,arguments)};b.prototype._updateSplicePush=function(b,a,g){this._linked?b.length>a?jQuery.observable(b).insert(a,g):jQuery.observable(b).insert(g):H.apply(this,arguments)};b.prototype._updatePush=
function(b,a){this._linked?jQuery.observable(b).insert(a):ja.apply(this,arguments)};b.prototype._updatePull=function(b,a){this._linked?jQuery.observable(b).remove(a):L.apply(this,arguments)};b.prototype._updateMultiply=function(b,a,g){this._linked?jQuery.observable(b).setProperty(a,b[a]*g):qa.apply(this,arguments)};b.prototype._updateRename=function(b,a,g){this._linked?(jQuery.observable(b).setProperty(g,b[a]),jQuery.observable(b).removeProperty(a)):oa.apply(this,arguments)};b.prototype._updateUnset=
function(b,a){this._linked?jQuery.observable(b).removeProperty(a):$.apply(this,arguments)};b.prototype._updatePop=function(b,a){var g,v=!1;this._linked?0<b.length&&(1===a?g=b.length-1:-1===a&&(g=0),-1<g&&(jQuery.observable(arr).remove(g),v=!0)):v=aa.apply(this,arguments);return v}};k.extendView=function(b){var a=b.prototype.init;b.prototype.init=function(){this._linked=0;a.apply(this,arguments)};b.prototype.isLinked=function(){return this.data().isLinked()};b.prototype.link=function(b,a){var g=this.publicData();
this.debug()&&console.log('ForerunnerDB.View: Setting up data binding on view "'+this.name()+'" in underlying (internal) view collection "'+g.name()+'" for output target: '+b);g.link(b,a);return this};b.prototype.unlink=function(b,a){var g=this.publicData();this.debug()&&console.log('ForerunnerDB.View: Removing data binding on view "'+this.name()+'" in underlying (internal) view collection "'+g.name()+'" for output target: '+b);g.unlink(b,a);return this}};k.extendOverview=function(b){b.prototype.isLinked=
function(){return this.data().isLinked()};b.prototype.link=function(b,a){this._data.link.apply(this._data,arguments);this._refresh()};b.prototype.unlink=function(b,a){this._data.unlink.apply(this._data,arguments);this._refresh()}};k.extendDocument=function(b){b.prototype.isLinked=function(){return Boolean(this._linked)};b.prototype.link=function(b,a){if(window.jQuery){this._links=this._links||{};this._linked||(this._linked=0);var v,k;a&&"object"===typeof a?a.template&&"string"===typeof a.template&&
(v=this.objectId(a.template),k=a.template):v=a;if(!this._links[v]){if(jQuery(b).length){if(!jQuery.templates[v]){if(!k)if(k=jQuery(a),k.length)k=jQuery(k[0]).html();else throw"Unable to bind document to target because template does not exist: "+a;jQuery.views.templates(v,k)}jQuery.templates[v].link(b,this._data);this._links[v]=b;this._linked++;this.debug()&&console.log('ForerunnerDB.Document: Added binding document "'+this.name()+'" to output target: '+b);return this}throw'Cannot bind view data to output target selector "'+
b+'" because it does not exist in the DOM!';}throw"Cannot create a duplicate link to the target: "+b+" with the template: "+v;}throw"Cannot data-bind without jQuery, please add jQuery to your page!";};b.prototype.unlink=function(b,a){if(window.jQuery){this._links=this._links||{};var v;a&&"object"===typeof a?a.template&&"string"===typeof a.template&&(v=this.objectId(a.template)):v=a;if(this._links[v])return jQuery.templates[v].unlink(b),delete this._links[v],this._linked--,this.debug()&&console.log('ForerunnerDB.Document: Removed binding document "'+
this.name()+'" to output target: '+b),this;console.log("Cannot remove link, one does not exist to the target: "+b+" with the template: "+a)}else throw"Cannot data-bind without jQuery, please add jQuery to your page!";}};if("undefined"!==typeof jQuery)if(H("../lib/vendor/jsviews"),"undefined"!==typeof jQuery.views){H=["Collection","View","Overview","Document"];var a;for(a=0;a<H.length;a++)L.moduleFinished(H[a],function(b,a){if(k["extend"+b])k["extend"+b](a)});L.finishModule("AutoBind")}else throw"AutoBind plugin cannot continue because jsViews is not loaded - check your error log for url errors.";
else throw"Cannot use AutoBind plugin without jQuery - please ensure jQuery is loaded first!";L.finishModule("AutoBind");$.exports=k},{"../lib/vendor/jsviews":3}],3:[function(H,$,L){window.jQuery&&(this.jQuery=window.jQuery,function(){(function(k,a,b){function g(b,p){for(var a in p.props)R.test(a)&&(b[a]=p.props[a])}function H(b){return b}function v(b){debugger;return b}function ea(b){M=(Ca._dbgMode=b)?"Unavailable (nested view): use #getIndex()":"";Da("dbg",Pa.dbg=pa.dbg=b?v:H)}function L(b){this.name=
(u.link?"JsViews":"JsRender")+" Error";this.message=b||this.name}function P(b,p){for(var a in p)b[a]=p[a];return b}function S(b){return"function"===typeof b}function $(b,p,a){if(!wa.rTag||b)J=b?b.charAt(0):J,z=b?b.charAt(1):z,t=p?p.charAt(0):t,U=p?p.charAt(1):U,W=a||W,b="\\"+J+"(\\"+W+")?\\"+z,p="\\"+t+"\\"+U,A="(?:(?:(\\w+(?=[\\/\\s\\"+t+"]))|(?:(\\w+)?(:)|(>)|!--((?:[^-]|-(?!-))*)--|(\\*)))\\s*((?:[^\\"+t+"]|\\"+t+"(?!\\"+U+"))*?)",wa.rTag=A+")",A=RegExp(b+A+"(\\/)?|(?:\\/(\\w+)))"+p,"g"),s=RegExp("<.*>|([^\\\\]|^)[{}]|"+
b+".*"+p);return[J,z,t,U,W]}function ja(ga,p){p||(p=ga,ga=b);var a,d,x,f;x=this;a=!p||"root"===p;if(ga){if(f=x.type===p?x:b,!f)if(a=x.views,x._.useKey)for(d in a){if(f=a[d].get(ga,p))break}else for(d=0,x=a.length;!f&&d<x;d++)f=a[d].get(ga,p)}else if(a)for(;x.parent.parent;)f=x=x.parent;else for(;x&&!f;)f=x.type===p?x:b,x=x.parent;return f}function Aa(){var ga=this.get("item");return ga?ga.index:b}function qa(){return this.index}function oa(ga){var p,a=this,d=a.linkCtx,x=(a.ctx||{})[ga];x===b&&d&&
d.ctx&&(x=d.ctx[ga]);x===b&&(x=Pa[ga]);x&&S(x)&&!x._wrp&&(p=function(){return x.apply(this&&this!==k?this:a,arguments)},p._wrp=!0,P(p,x));return p||x}function Ra(ga,p,a,d){var x,f,h=+a===a&&p.tmpl.bnds[a-1],e=p.linkCtx;a=(d=d!==b&&{props:{},args:[d]})||(h?h(p.data,p,K):a);f=a.args[0];if(ga||h)x=e&&e.tag,x||(x={_:{inline:!e,bnd:h},tagName:":",cvt:ga,flow:!0,tagCtx:a,_is:"tag"},e&&(e.tag=x,x.linkCtx=e,a.ctx=O(a.ctx,e.view.ctx)),wa._lnk(x)),x._er=d&&f,g(x,a),a.view=p,x.ctx=a.ctx||{},delete a.ctx,p._.tag=
x,f=aa(x,x.convert||"true"!==ga&&ga)[0],f=h&&p._.onRender?p._.onRender(f,p,h):f,p._.tag=b;return f!=b?f:""}function aa(b,p){var a=b.tagCtx,d=a.view,x=a.args;p=p&&(""+p===p?d.getRsc("converters",p)||ha("Unknown converter: '"+p+"'"):p);x=x.length||a.index?p?x.slice():x:[d.data];p&&(p.depends&&(b.depends=wa.getDeps(b.depends,b,p.depends,p)),x[0]=p.apply(b,x));return x}function La(a,p){for(var d,f=this;d===b&&f;)d=(d=f.tmpl[a])&&d[p],f=f.parent;return d||K[a][p]}function Ma(a,p,d,f,x,e){var h,c,m,u,l,
t,F,V,v,s="",k=p.linkCtx||0,z=p.ctx,A=d||p.tmpl,w=+f===f&&A.bnds[f-1];"tag"===a._is&&(h=a,a=h.tagName,f=h.tagCtxs);h=h||k.tag;f=(e=e!==b&&(s+=e,[{props:{},args:[]}]))||(w?w(p.data,p,K):f);t=f.length;for(l=0;l<t;l++){l||d&&h||(V=p.getRsc("tags",a)||ha("Unknown tag: {{"+a+"}}"));c=f[l];if(!k.tag||h._er)d=c.tmpl,d=c.content=d&&A.tmpls[d-1],P(c,{tmpl:(h?h:V).template||d,render:ta,index:l,view:p,ctx:O(c.ctx,z)});if(d=c.props.tmpl)d=""+d===d?p.getRsc("templates",d)||C(d):d,c.tmpl=d;h||(V._ctr?(h=new V._ctr,
v=!!h.init):wa._lnk(h={render:V.render}),h._={inline:!k},k&&(k.tag=h,h.linkCtx=k),(h._.bnd=w||k.fn)?h._.arrVws={}:h.dataBoundOnly&&ha("{^{"+a+"}} tag must be data-bound"),h.tagName=a,h.parent=u=z&&z.tag,h._is="tag",h._def=V,h.tagCtxs=f);c.tag=h;h.dataMap&&h.tagCtxs&&(c.map=h.tagCtxs[l].map);h.flow||(F=c.ctx=c.ctx||{},c=h.parents=F.parentTags=z&&O(F.parentTags,z.parentTags)||{},u&&(c[u.tagName]=u),c[h.tagName]=F.tag=h)}p._.tag=h;if(!(h._er=e)){g(h,f[0]);h.rendering={};for(l=0;l<t;l++){c=h.tagCtx=h.tagCtxs[l];
u=c.props;a=aa(h,h.convert);if(f=u.dataMap||h.dataMap)if(a.length||u.dataMap){e=c.map;if(!e||e.src!==a[0]||x)e&&e.src&&e.unmap(),e=c.map=f.map(a[0],u);a=[e.tgt]}h.ctx=c.ctx;!l&&v&&(f=h.template,h.init(c,k,h.ctx),v=b,h.template!==f&&(h._.tmpl=h.template),k&&(k.attr=h.attr=k.attr||h.attr));f=b;h.render&&(f=h.render.apply(h,a));a=a.length?a:[p];f=f!==b?f:c.render(a[0],!0)||(x?b:"");s=s?s+(f||""):f}delete h.rendering}h.tagCtx=h.tagCtxs[0];h.ctx=h.tagCtx.ctx;h._.inline&&(m=h.attr)&&m!==B&&(s="text"===
m?pa.html(s):"");return w&&p._.onRender?p._.onRender(s,p,w):s}function D(b,a,d,f,x,e,h,c){var g="array"===a,m={key:0,useKey:g?0:1,id:""+E++,onRender:c,bnds:{}};this.data=f;this.tmpl=x;this.content=h;this.views=g?[]:{};this.parent=d;this.type=a||"top";this._=m;this.linked=!!c;d?(a=d.views,f=d._,f.useKey?(a[m.key="_"+f.useKey++]=this,this.index=M,this.getIndex=Aa,e=f.tag,m.bnd=g&&(!e||!!e._.bnd&&e)):a.splice(m.key=this.index=e,0,this),this.ctx=b||d.ctx):this.ctx=b}function ba(b){var a,d,f,x,e,h;for(a in ma)if(x=
ma[a],(e=x.compile)&&(d=b[a+"s"]))for(f in d)(x=d[f]=e(f,d[f],b))&&(h=wa.onStore[a])&&h(f,x,e)}function Fa(a,d,f){S(d)?d={depends:d.depends,render:d}:(d.baseTag&&(d.flow=!!d.flow,d=P(P({},d.baseTag),d)),(a=d.template)!==b&&(d.template=""+a===a?C[a]||C(a):a),!1!==d.init&&(a=d._ctr=function(){},(a.prototype=d).constructor=a));f&&(d._parentTmpl=f);return d}function Ga(d,p,f,e){function x(p){if(""+p===p||0<p.nodeType){try{h=0<p.nodeType?p:!s.test(p)&&a&&a(k.document).find(p)[0]}catch(x){}h&&(p=C[d=d||
h.getAttribute(X)],p||(d=d||"_"+ia++,h.setAttribute(X,d),p=C[d]=Ga(d,h.innerHTML,f,e)),h=b);return p}}var c,h;p=p||"";c=x(p);e=e||(p.markup?p:{});e.tmplName=d;f&&(e._parentTmpl=f);!c&&p.markup&&(c=x(p.markup))&&c.fn&&(c.debug!==p.debug||c.allowCode!==p.allowCode)&&(c=c.markup);if(c!==b)return d&&!f&&(Sa[d]=function(){return p.render.apply(p,arguments)}),c.fn||p.fn?c.fn&&(p=d&&d!==c.tmplName?O(e,c):c):(p=ra(c,e),Ka(c.replace(w,"\\$&"),p)),ba(e),p}function Oa(b){function a(d,p){this.tgt=b.getTgt(d,
p)}S(b)&&(b={getTgt:b});b.baseMap&&(b=P(P({},b.baseMap),b));b.map=function(b,d){return new a(b,d)};return b}function ra(b,a){var d,f=Ca.wrapMap||{},e=P({markup:b,tmpls:[],links:{},tags:{},bnds:[],_is:"template",render:Y},a);a.htmlTag||(d=Qa.exec(b),e.htmlTag=d?d[1].toLowerCase():"");(d=f[e.htmlTag])&&d!==f.div&&(e.markup=u.trim(e.markup));return e}function sa(a,d){function f(c,g,h){var m,u,l;if(c&&"object"===typeof c&&!c.nodeType&&!c.markup&&!c.getTgt){for(u in c)f(u,c[u],g);return K}g===b&&(g=c,
c=b);c&&""+c!==c&&(h=g,g=c,c=b);l=h?h[e]=h[e]||{}:f;u=d.compile;null===g?c&&delete l[c]:(g=u?g=u(c,g,h):g,c&&(l[c]=g));u&&g&&(g._is=a);g&&(m=wa.onStore[a])&&m(c,g,u);return g}var e=a+"s";K[e]=f;ma[a]=d}function xa(b,a,d){var f=this.jquery&&(this[0]||ha('Unknown template: "'+this.selector+'"')),c=f.getAttribute(X);return Y.call(c?C[c]:C(f),b,a,d)}function Na(b,a,d){if(Ca._dbgMode)try{return b.fn(a,d,K)}catch(f){return ha(f,d)}return b.fn(a,d,K)}function Y(b,a,d,f,c,e){return f||!this.fn._nvw||u.isArray(b)?
ta.call(this,b,a,d,f,c,e):Na(this,b,{tmpl:this})}function ta(a,d,f,c,e,g){var h,m,l,k,s,t,F,V,v;l=this;var z="";!!d===d&&(f=d,d=b);!0===e&&(h=!0,e=0);l.tag?(t=l,l=l.tag,m=l._,s=l.tagName,V=m.tmpl||t.tmpl,v=l.attr&&l.attr!==B,d=O(d,l.ctx),F=t.content,!1===t.props.link&&(d=d||{},d.link=!1),c=c||t.view,a=arguments.length?a:c):V=l;if(V&&(!c&&a&&"view"===a._is&&(c=a),c&&(F=F||c.content,g=g||c._.onRender,a===c&&(a=c.data),d=O(d,c.ctx)),c&&"top"!==c.type||((d=d||{}).root=a),V.fn||(V=C[V]||C(V)),V)){t=g=
!1!==(d&&d.link)&&!v&&g;!0===g&&(t=b,g=c._.onRender);d=V.helpers?O(V.helpers,d):d;if(u.isArray(a)&&!f)for(k=h?c:e!==b&&c||new D(d,"array",c,a,V,e,F,g),h=0,m=a.length;h<m;h++)l=a[h],s=new D(d,"item",k,l,V,(e||0)+h,F,g),l=Na(V,l,s),z+=k._.onRender?k._.onRender(l,s):l;else{if(c||!V.fn._nvw)k=h?c:new D(d,s||"data",c,a,V,e,F,g),m&&!l.flow&&(k.tag=l);z+=Na(V,a,k)}return t?t(z,k):z}return""}function ha(b,d,a){a=Ca.onError(b,d,a);if(""+b===b)throw new wa.Err(a);return!d.linkCtx&&d.linked?pa.html(a):a}function ca(b){ha("Syntax error\n"+
b)}function Ka(b,a,f,g){function x(a){(a-=t)&&F.push(b.substr(t,a).replace(N,"\\n"))}function l(a){a&&ca('Unmatched or missing tag: "{{/'+a+'}}" in template:\n'+b)}var h,m,u,O=a&&a.allowCode,k=[],t=0,s=[],F=k,z=[,,k];f&&(b=J+b+U);l(s[0]&&s[0][2].pop()[0]);b.replace(A,function(d,c,h,k,v,w,A,D,E,Q,J,K){w&&(v=":",k=B);Q=Q||f;c=(c||f)&&[[]];var C="",r="",q="",n="",y="",ua="",na="",Ta="";A=!Q&&!v&&!A;h=h||(E=E||"#data",v);x(K);t=K+d.length;D?O&&F.push(["*","\n"+E.replace(G,"$1")+"\n"]):h?("else"===h&&
(T.test(E)&&ca('for "{{else if expr}}" use "{{else expr}}"'),c=z[7],z[8]=b.substring(z[8],K),z=s.pop(),F=z[2],A=!0),E&&(e(E.replace(N," "),c,a).replace(Ba,function(b,a,d,f,c,e,p,h){p?(r+=e+",",n+="'"+h+"',"):d?(q+=f+e+",",ua+=f+"'"+h+"',"):a?na+=e:("trigger"===c&&(Ta+=e),C+=f+e+",",y+=f+"'"+h+"',",u=u||R.test(c));return""}).slice(0,-1),c&&c[0]&&c.pop()),m=[h,k||!!g||u||"",A&&[],[n.slice(0,-1),y.slice(0,-1),ua.slice(0,-1)],[r.slice(0,-1),C.slice(0,-1),q.slice(0,-1)],na,Ta,c||0],F.push(m),A&&(s.push(z),
z=m,z[8]=t)):J&&(l(J!==z[0]&&"else"!==z[0]&&J),z[8]=b.substring(z[8],K),z=s.pop());l(!z&&J);F=z[2]});x(b.length);(t=k[k.length-1])&&l(""+t!==t&&+t[8]===t[8]&&t[0]);f?(h=c(k,b,f),d(h,k[0][7])):h=c(k,a);h._nvw&&(h._nvw=!/[~#]/.test(b));return h}function d(b,a){b.deps=[];for(var d in a)"_jsvto"!==d&&a[d].length&&(b.deps=b.deps.concat(a[d]));b.paths=a}function f(b,a){return"\n\t"+(a?a+":{":"")+"args:["+b[0]+"]"+(b[1]||!a?",\n\tprops:{"+b[1]+"}":"")+(b[2]?",\n\tctx:{"+b[2]+"}":"")}function e(b,a,d){var f,
c,e,h,g,l=a&&a[0],m=0,u=d?d.links:l&&(l.links=l.links||{}),k={},s={0:-1},O=0;return(b+(d?" ":"")).replace(/\)\^/g,").").replace(Ha,function(F,v,A,B,w,E,D,Q,J,K,N,C,G,M,r,q,n,y,ua,na){function Ta(r,q,b,n,d,y,ua,na){return b&&(l&&("linkTo"===f&&(c=a._jsvto=a._jsvto||[],c.push(w)),f&&!e||l.push(w.slice(q.length))),"."!==b)?(r=(n?'view.hlp("'+n+'")':d?"view":"data")+(na?(y?"."+y:n?"":d?"":"."+b)+(ua||""):(na=n?"":d?y||"":b,"")),r+=na?"."+na:"",q+("view.data"===r.slice(0,9)?r.slice(5):r)):r}E=E||"";A=
A||v||C;w=w||J;K=K||n||"";J=na.length-1;if(!D||g||h)return!l||!q||g||h||f&&!e&&!c||(q=s[O],J>ua-q&&(q=na.slice(q,ua+1),q=z+":"+q+" onerror=''"+t,D=u[q],D||(u[q]=!0,u[q]=D=Ka(q,d||l,!0),D.paths.push({_jsvOb:D})),!0!==D&&(c||l).push({_jsvOb:D}))),g?(g=!G,g?F:'"'):h?(h=!M,h?F:'"'):(A?(O++,s[O]=ua++,A):"")+(y?O?"":(m=na.slice(m,ua),f?(f=e=c=!1,"\b"):"\b,")+m+(m=ua+F.length,l&&a.push(l=[]),"\b"):Q?(O&&ca(b),l&&a.pop(),f=w,e=B,m=ua+F.length,B&&(l=a[f]=[]),w+":"):w?w.split("^").join(".").replace(la,Ta)+
(K?(k[++O]=!0,"."!==w.charAt(0)&&(s[O]=ua),K):E):E?E:r?(k[O--]=!1,r)+(K?(k[++O]=!0,K):""):N?(k[O]||ca(b),","):v?"":(g=G,h=M,'"'));ca(b)})}function c(a,e,g){var l,m,u,h,k,O,t,z,F,s,v,w,A,D,E,K,J,Q,C,G,M,ma,P,U,W,r,q=0,n="",y={},ua=a.length;""+e===e?(Q=g?'data-link="'+e.replace(N," ").slice(1,-1)+'"':e,e=0):(Q=e.tmplName||"unnamed",e.allowCode&&(y.allowCode=!0),e.debug&&(y.debug=!0),v=e.bnds,J=e.tmpls);for(l=0;l<ua;l++)if(m=a[l],""+m===m)n+='\n+"'+m+'"';else if(u=m[0],"*"===u)n+=";\n"+m[1]+"\nret=ret";
else{h=m[1];M=m[2];k=f(m[3],"params")+"},"+f(A=m[4]);U=m[5];r=m[6];E=m[8];(D="else"===u)||(q=0,v&&(w=m[7])&&(q=v.push(w)));(m=":"===u)?h&&(u=h===B?">":h+u):(M&&(C=ra(E,y),C.tmplName=Q+"/"+u,c(M,C),J.push(C)),D||(G=u,ma=n,n=""),C=(C=a[l+1])&&"else"===C[0]);W=U?";\ntry{\nret+=":"\n+";E=D="";if(m&&(w||r||h&&h!==B)){P="return {"+k+"};";K='c("'+h+'",view,';P=new Function("data,view,j,u"," // "+Q+" "+q+" "+u+"\n"+P);P._er=U;D=K+q+",";E=")";P._tag=u;if(g)return P;d(P,w);s=!0}n+=m?(g?(U?"\ntry{\n":"")+"return ":
W)+(s?(s=b,F=z=!0,K+(w?(v[q-1]=P,q):"{"+k+"}")+")"):">"===u?(t=!0,"h("+A[0]+")"):"((v="+A[0]+')!=null?v:"")'):(F=O=!0,"\n{view:view,tmpl:"+(M?J.length:"0")+","+k+"},");if(G&&!C){n="["+n.slice(0,-1)+"]";K='t("'+G+'",view,this,';if(g||w){n=new Function("data,view,j,u"," // "+Q+" "+q+" "+G+"\nreturn "+n+";");n._er=U;n._tag=u;w&&d(v[q-1]=n,w);if(g)return n;D=K+q+",undefined,";E=")"}n=ma+W+K+(q||n)+")";G=w=0}U&&(F=!0,n+=";\n}catch(e){ret"+(g?"urn ":"+=")+D+"j._err(e,view,"+U+")"+E+";}\n"+(g?"":"ret=ret"))}n=
"// "+Q+"\nvar v"+(O?",t=j._tag":"")+(z?",c=j._cnvt":"")+(t?",h=j.converters.html":"")+(g?";\n":',ret=""\n')+(y.debug?"debugger;":"")+n+(g?"\n":";\nreturn ret;");try{n=new Function("data,view,j,u",n)}catch(na){ca("Compiled template code:\n\n"+n+'\n: "'+na.message+'"')}e&&(e.fn=n);F||(n._nvw=!0);return n}function O(b,a){return b&&b!==a?a?P(P({},a),b):b:a&&P({},a)}function F(b){return fa[b]||(fa[b]="&#"+b.charCodeAt(0)+";")}function l(b){var a,d,f=[];if("object"===typeof b)for(a in b)(d=b[a])&&d.toJSON&&
!d.toJSON()||S(d)||f.push({key:a,prop:d});return f}function m(b){return null!=b?Za.test(b)&&(""+b).replace(Z,F)||b:""}if(!(a&&a.render||k.jsviews)){var u,Q,A,s,M,J="{",z="{",t="}",U="}",W="^",la=/^(!*?)(?:null|true|false|\d[\d.]*|([\w$]+|\.|~([\w$]+)|#(view|([\w$]+))?)([\w$.^]*?)(?:[.[^]([\w$]+)\]?)?)$/g,Ha=/(\()(?=\s*\()|(?:([([])\s*)?(?:(\^?)(!*?[#~]?[\w$.^]+)?\s*((\+\+|--)|\+|-|&&|\|\||===|!==|==|!=|<=|>=|[<>%*:?\/]|(=))\s*|(!*?[#~]?[\w$.^]+)([([])?)|(,\s*)|(\(?)\\?(?:(')|("))|(?:\s*(([)\]])(?=\s*\.|\s*\^|\s*$)|[)\]])([([]?))|(\s+)/g,
...
{},u.isArray=Array&&Array.isArray||function(b){return"[object Array]"===Object.prototype.toString.call(b)});u.render=Sa;u.views=K;u.templates=C=K.templates;Ca({debugMode:ea,delimiters:$,onError:function(a,d,f){d&&(a=f===b?"{Error: "+a+"}":S(f)?f(a,d):f);return a==b?"":a},_dbgMode:!0});Da({"else":function(){},"if":{render:function(b){return this.rendering.done||!b&&(arguments.length||!this.tagCtx.index)?"":(this.rendering.done=!0,this.selected=this.tagCtx.index,this.tagCtx.render(this.tagCtx.view,
!0))},onUpdate:function(b,a,d){var f;for(b=0;(f=this.tagCtxs[b])&&f.args.length;b++)if(f=f.args[0],a=!f!==!d[b].args[0],!this.convert&&f||a)return a;return!1},flow:!0},"for":{render:function(a){var d,f=this.tagCtx,c="",e=0;if(!this.rendering.done){if(d=!arguments.length)a=f.view.data;a!==b&&(c+=f.render(a,d),e+=u.isArray(a)?a.length:1);if(this.rendering.done=e)this.selected=f.index}return c},flow:!0},include:{flow:!0},"*":{render:H,flow:!0}});Da("props",{baseTag:Da["for"],dataMap:Oa(l)});pa({html:m,
attr:m,url:function(a){return a!=b?encodeURI(""+a):null===a?a:""}});$()}})(this,this.jQuery);(function(k,a,b){function g(b){return D(b)?new v(b):new H(b)}function H(b){this._data=b;return this}function v(b){this._data=b;return this}function ea(b,a){b=D(b)?b:[b];var e,c,g=a,k=g,l=b.length,m=[];for(e=0;e<l;e++)c=b[e],Y(c)?m=m.concat(ea(c.call(a,a),a)):""+c!==c?(a=k=c,k!==g&&m.push(g=k)):(k!==g&&m.push(g=k),m.push(c));return m}function L(b,a){var e,c;for(e in b){c=!0;break}c||delete xa[a]}function P(a,
f){if(!a.data||!a.data.off){var e,c,g,k,l,m=f.oldValue,u=f.value,v=a.data,A=v.observeAll,s=!v.cb.noArray,M=v.paths;if(a.type===sa)(v.cb.array||v.cb).call(v,a,f);else if(v.prop===f.path||"*"===v.prop)k=typeof m===Fa&&(M[0]||s&&D(m)),l=typeof u===Fa&&(M[0]||s&&D(u)),A?(e=A._path+"."+f.path,c=A.filter,g=[a.target].concat(A.parents()),k&&ja(s,A.ns,[m],M,v.cb,!0,c,[g],e),l&&ja(s,A.ns,[u],M,v.cb,b,c,[g],e)):(k&&ja(s,[m],M,v.cb,!0),l&&ja(s,[u],M,v.cb)),v.cb(a,f)}}function S(){function d(b,d,f,c){var e,g=
ca(B),l=D(B)?[B]:B;b=T?b+"."+T:b;if(A||c)g&&a(l).off(b,P);else{if(t=g&&a._data(B))for(J=(t=(t=t&&t.events)&&t[f?sa:ra])&&t.length;J--;)if((z=t[J].data)&&z.cb._cId===s._cId&&z.ns===T){if(f)return;("*"===d&&z.prop!==d||z.prop===m)&&a(B).off(b,P)}d=f?{}:{fullPath:u,paths:d?[d]:[],prop:m};d.ns=T;d.cb=s;w&&(d.observeAll={_path:w,path:function(){e=G.length;return w.replace(/[[.]/g,function(b){e--;return"["===b?"["+a.inArray(G[e-1],G[e]):"."})},parents:function(){return G},filter:aa,ns:T});a(l).on(b,null,
d,P);H&&((xa[s._cId]=H)[a.data(B,"obId")||a.data(B,"obId",ta++)]=B)}}function f(b,a){b._ob=U(b,fa);var d=fa;return function(f,c){var g=b._ob,l=a.length;typeof g===Fa&&(e(g,!0),(l||R&&D(g))&&ja(R,[g],a,s,U,!0));g=b._ob=U(b,d);typeof g===Fa&&(e(g),(l||R&&D(g))&&ja(R,[g],a,s,U,[d]));s(f,c)}}function e(a,f,c,e){if(R){var l=B,m=w;B=a;e&&(B=a[e],w+="."+e);aa&&B&&(B=g._fltr(w,B,e?[a].concat(G):G,aa));B&&(c||D(B))&&d(sa+".observe"+(s?".obs"+(M=s._cId=s._cId||ha++):""),b,!0,f);B=l;w=m}}var c,k,v,l,m,u,Q,A,
s,M,J,z,t,U,W,H,S,N,G,w,aa,T,ba,$,R=!1!=this,Z=!0,ia=Na,E=Array.apply(0,arguments);c=E.pop();var fa=E.shift(),B=N=fa,X=E.length;fa+""===fa&&R&&(T=fa,fa=B=N=E.shift(),X--);if(Y(c))s=c;else if(c+""===c&&(w=c,G=E.pop(),aa=E.pop(),c=E.pop(),X-=3),!0===c?A=c:c&&(fa=c,Z=b),c=E[X-1],X&&c===b||Y(c))s=E.pop(),X--;X&&Y(E[X-1])&&(U=s,s=E.pop(),X--);ia+=A?s?".obs"+s._cId:"":".obs"+(M=s._cId=s._cId||ha++);A||(H=xa[M]=xa[M]||{});ba=T&&T.match(Oa)||[""];for($=ba.length;$--;)for(T=ba[$],D(N)?e(N,A,!0):A&&0===X&&
N&&d(ia,""),c=S=0;c<X;c++)if(u=E[c],""!==u){B=N;if(""+u===u){l=u.split("^");l[1]&&(S=l[0].split(".").length,u=l.join("."),S=u.split(".").length-S);if(U&&(W=U(u,N))){X+=W.length-1;Ma.apply(E,[c--,1].concat(W));continue}l=u.split(".")}else Z&&!Y(u)&&(u&&u._jsvOb&&(N=f(u,E.slice(c+1)),N.noArray=!R,N._cId=s._cId,ja(R,[fa],E.slice(0,c),N,U),N=b,u=u._ob),B=u),N=u,l=[N];for(;B&&(m=l.shift())!==b;)if(typeof B===Fa){if(""+m===m){if(""===m)continue;if(l.length<S+1&&!B.nodeType){if(!A&&(t=ca(B)&&a._data(B))){J=
(t=(t=t.events)&&t[ra])&&t.length;for(v=0;J--;)!(z=t[J].data)||z.cb!==s||z.ns!==T||z.prop!==m&&"*"!==z.prop||((k=l.join("."))&&z.paths.push(k),v++);if(v){B=B[m];continue}}if("*"===m){!A&&t&&t.length&&d(ia,"",!1,!0);Y(B)?(Q=B.depends)&&ja(R,[Q],s,A||fa):d(ia,"");for(k in B)e(B,A,b,k);break}else m&&d(ia+"."+m,l.join("^"))}w&&(w+="."+m);m=B[m]}if(Y(m)){(Q=m.depends)&&ja(R,[B],ea(Q,B),s,U,A||[fa]);break}B=m}e(B,A)}M&&L(H,M);return{cbId:M,bnd:H}}function $(){[].push.call(arguments,!0);return S.apply(this,
arguments)}function ja(){var b=[].concat.apply([],arguments);return S.apply(b.shift(),b)}function Aa(b,a,e,c){b+""!==b&&(e=a,a=b,b="");oa(b,this._data,a,e,[],"root",c)}function qa(b,a,e){Aa.call(this,b,a,e,!0)}function oa(a,f,e,c,k,v,l){function m(b,a){A=b.length;J=[[b]].concat(J);for(M=v+"[]";A--;)u(b,A,a,1)}function u(f,l,m,k){var u;l!==ba&&(u=g._fltr(M,f[l],J,c))&&oa(a,u,e,c||(k?b:0),J.slice(),M,m)}function H(b,a){var d=k;v=b.data.observeAll._path;J=[b.target].concat(k);switch(a.change){case "insert":m(a.items);
break;case "remove":m(a.items,!0);break;case "refresh":m(a.oldItems,!0);m(b.target);break;case "set":M=v+"."+a.path,u(a,"oldValue",!0),u(a,"value")}e.apply(this,arguments);k=d}var A,s,M,J;if(typeof f===Fa){s=D(f)?"":"*";if(e){if(s||0!==c)H._cId=e._cId=e._cId||ha++,S(a,f,s,H,l,c,k,v)}else S(a,f,s,b,l,c,k,v);if(s)for(A in J=[f].concat(k),f)M=v+"."+A,u(f,A,l);else m(f,l)}}function Ra(b){return 0>b.indexOf(".")&&0>b.indexOf("[")}if(!a)throw"jsViews/jsObservable require jQuery";if(!a.observable){k=a.views=
a.views||{jsviews:"v1.0.0-alpha",sub:{}};var aa=k.sub,La=a.event.special,Ma=[].splice,D=a.isArray,ba=a.expando,Fa="object",Ga=parseInt,Oa=/\S+/g,ra=aa.propChng=aa.propChng||"propertyChange",sa=aa.arrChng=aa.arrChng||"arrayChange",xa=aa._cbBnds=aa._cbBnds||{},Na=ra+".observe",Y=a.isFunction,ta=1,ha=1,ca=a.hasData,Ka={};aa.getDeps=function(){var b=arguments;return function(){for(var a,e,c=[],g=b.length;g--;)a=b[g--],(e=b[g])&&(c=c.concat(Y(e)?e(a,a):e));return c}};a.observable=g;g._fltr=function(b,
a,e,c){if(c&&Y(c)?c(b,a,e):1)return a=Y(a)?a.set&&a.call(e[0]):a,typeof a===Fa&&a};g.Object=H;g.Array=v;a.observe=g.observe=S;a.unobserve=g.unobserve=$;g._apply=ja;H.prototype={_data:null,observeAll:Aa,unobserveAll:qa,data:function(){return this._data},setProperty:function(a,f,e){var c,g=this._data;a=a||"";if(g)if(D(a))for(c=a.length;c--;)f=a[c],this.setProperty(f.name,f.value,e===b||e);else if(""+a!==a)for(c in a)this.setProperty(c,a[c],f);else if(a!==ba){for(a=a.split(".");g&&1<a.length;)g=g[a.shift()];
g&&this._setProperty(g,a[0],f,e)}return this},removeProperty:function(a){this.setProperty(a,Ka);return this},_setProperty:function(a,f,e,c){var g,k,l,m=f?a[f]:a;Y(m)&&m.set&&(k=m,g=!0===m.set?m:m.set,m=m.call(a));if(m!==e||c&&m!=e)if(!(m instanceof Date)||m>e||m<e)g?(g.call(a,e),e=k.call(a)):(l=e===Ka)?(delete a[f],e=b):f&&(a[f]=e),this._trigger(a,{change:"set",path:f,value:e,oldValue:m,remove:l})},_trigger:function(b,f){a(b).triggerHandler(ra,f)}};v.prototype={_data:null,observeAll:Aa,unobserveAll:qa,
data:function(){return this._data},insert:function(a,b){var e=this._data;1===arguments.length&&(b=a,a=e.length);a=Ga(a);-1<a&&a<=e.length&&(b=D(b)?b:[b],b.length&&this._insert(a,b));return this},_insert:function(a,b){var e=this._data,c=e.length;Ma.apply(e,[a,0].concat(b));this._trigger({change:"insert",index:a,items:b},c)},remove:function(a,f){var e;e=this._data;a===b&&(a=e.length-1);a=Ga(a);f=f?Ga(f):0===f?0:1;-1<f&&-1<a&&(e=e.slice(a,a+f),(f=e.length)&&this._remove(a,f,e));return this},_remove:function(a,
b,e){var c=this._data,g=c.length;c.splice(a,b);this._trigger({change:"remove",index:a,items:e},g)},move:function(a,b,e){e=e?Ga(e):0===e?0:1;a=Ga(a);b=Ga(b);if(0<e&&-1<a&&-1<b&&a!==b){var c=this._data.slice(a,a+e);(e=c.length)&&this._move(a,b,e,c)}return this},_move:function(a,b,e,c){var g=this._data,k=g.length;g.splice(a,e);g.splice.apply(g,[b,0].concat(c));this._trigger({change:"move",oldIndex:a,index:b,items:c},k)},refresh:function(a){var b=this._data.slice();this._refresh(b,a);return this},_refresh:function(a,
b){var e=this._data,c=e.length;Ma.apply(e,[0,e.length].concat(b));this._trigger({change:"refresh",oldItems:a},c)},_trigger:function(b,f){var e=this._data,c=e.length,e=a([e]);e.triggerHandler(sa,b);c!==f&&e.triggerHandler(ra,{change:"set",path:"length",value:c,oldValue:f})}};La[ra]=La[sa]={remove:function(b){var f,e,c,g,k=b.data;if(k&&(k.off=!0,k=k.cb)&&(f=xa[k._cId])){b=a._data(this).events[b.type];for(c=b.length;c--&&!e;)e=(g=b[c].data)&&g.cb===k;e||(delete f[a.data(this,"obId")],L(f,k._cId))}}};
k.map=function(d){function f(a,c,f){var k,l=this;this.src&&this.unmap();"object"===typeof a&&(l.src=a,l.tgt=f||l.tgt||[],l.options=c||l.options,l.update(),d.obsSrc&&g(l.src).observeAll(l.obs=function(a,c){k||(k=!0,d.obsSrc(l,a,c),k=b)},l.srcFlt),d.obsTgt&&g(l.tgt).observeAll(l.obt=function(a,c){k||(k=!0,d.obsTgt(l,a,c),k=b)},l.tgtFlt))}Y(d)&&(d={getTgt:d});d.baseMap&&(d=a.extend({},d.baseMap,d));d.map=function(a,b,d){return new f(a,b,d)};(f.prototype={srcFlt:d.srcFlt||Ra,tgtFlt:d.tgtFlt||Ra,update:function(a){g(this.tgt).refresh(d.getTgt(this.src,
this.options=a||this.options))},unmap:function(){this.src&&(this.obs&&g(this.src).unobserveAll(this.obs,this.srcFlt),this.obt&&g(this.tgt).unobserveAll(this.obt,this.tgtFlt),this.src=b)},map:f,_def:d}).constructor=f;return d}}})(this,this.jQuery);(function(k,a,b){function g(r,q,n){var y,c,d,f,e,g,h,k,l,m=r.target,p=m._jsvBnd,u=/&(\d+)\+?/g;if(p)for(;d=u.exec(p);)if(d=Ea[d[1]])if(q=d.to){d=d.linkCtx;h=d.view;l=d.tag;g=a(m);e=h.hlp(Sa);k=h.hlp(ma);c=S(m);y=x[c];n===b&&(n=Qa(c)?c(m):y?g[y]():g.attr(c));
y=q[1];q=q[0];y&&(f=Qa(y)?y:h.getRsc("converters",y));f&&(n=f.call(l,n));y=h.linkCtx;h.linkCtx=d;c={change:"change",oldValue:d._val,value:n};if(!(e&&!1===e.call(d,r,c)||l&&l.onBeforeChange&&!1===l.onBeforeChange(r,c)||n===b)&&(e=q[0],n!==b&&e)){e=e._jsvOb?e._ob:e;l&&(l._.chging=!0);Z(e).setProperty(q[2]||q[1],n);k&&k.call(d,r,c);if(l){if(l.onAfterChange)l.onAfterChange(r,c);delete l._.chging}d._val=n}h.linkCtx=y}}function H(r,q,n){var y,c,d,e,f,g=this.tag,h=this.data,l=this.elem;d=this.convert;var g=
...
c=function(a,b){f.onArrayChange(a,b)}),g[b]=[e,c]);for(b=k+1;b<l;b++)if(d=g[b])ia(d[0],d[1],!0),delete g[b];f._ars=g},onDispose:function(){for(var a in this._ars)ia(this._ars[a][0],this._ars[a][1],!0)}}),T(R["for"],t),T(R["if"],t),T(R.include,t),R("props",{baseTag:R["for"],dataMap:G.map({getTgt:R.props.dataMap.getTgt,obsSrc:c,obsTgt:O,tgtFlt:F})}),T(a,{view:G.view=m=function(c,d,e){function f(a,b){if(a)for(h=ba(a,b,eb),k=0,l=h.length;k<l&&(!(g=Ha[h[k].id])||!(g=g&&e?g.get(!0,e):g));k++);}d!==!!d&&
