    ...
    ***************************************************************************** */
    ...
    var Component = /*#__PURE__*/function () {
      ...
      __proto.trigger = function (event) {
        ...
        var handlers = __spreadArray([], __read(this._eventHandler[eventName] || []), false);
        ...
        if (event instanceof ComponentEvent) {
          ...
          handlers.forEach(function (handler) {
            ...
            handler.apply(void 0, __spreadArray([], __read(params), false));
          });
        }
        return this;
      };
      ...
      __proto.once = function (eventName, handlerToAttach) {
        ...
        if (typeof eventName === "object" && isUndefined(handlerToAttach)) {
          ...
          var listener_1 = function () {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unsafe-call
            handlerToAttach.apply(void 0, __spreadArray([], __read(args), false));
     ...
     * egjs projects are licensed under the MIT license
     */
    Component.ComponentEvent = ComponentEvent$1;
