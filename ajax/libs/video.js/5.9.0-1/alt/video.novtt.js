  ...
  Tech.prototype.emulateTextTracks = function emulateTextTracks() {
    ...
    if (!_globalWindow2['default']['WebVTT'] && this.el().parentNode != null) {
      (function () {
        ...
        script.src = _this2.options_['vtt.js'] || 'https://cdn.rawgit.com/gkatsev/vtt.js/vjs-v0.12.1/dist/vtt.min.js';
        script.onload = function () {
          _this2.trigger('vttjsloaded');
        };
        script.onerror = function () {
          _this2.trigger('vttjserror');
        };
        ...
        _this2.el().parentNode.appendChild(script);
      })();
    }
...
},{"../utils/browser.js":135,"./track-list":131,"global/document":1}],121:[function(_dereq_,module,exports){
'use strict';
...
},{"../utils/browser.js":135,"./track-list":131,"global/document":1}],134:[function(_dereq_,module,exports){
'use strict';
