...
var BackgroundImpl = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(BackgroundImpl, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      var shallowPropsEqual = (0, _common.shallowEqual)(this.props, nextProps); // We also need to check the imgixParams.

      var shallowParamsEqual = (0, _common.shallowEqual)(this.props.imgixParams, nextProps.imgixParams);
