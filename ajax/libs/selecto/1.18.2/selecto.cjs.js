...
function (_super) {
  ...
  function Selecto(options) {
    ...
    _this._onDragStart = function (e, clickedTarget) {
      ...
      datas.boundsArea = _this.target.style.cssText += "position: ".concat(rootContainer ? "absolute" : "fixed", ";") + "left:0px;top:0px;" + "transform: translate(".concat(offsetPos[0], "px, ").concat(offsetPos[1], "px)");
