...
export declare interface _StoreOnActionListenerContext<Store, ActionName extends string, A> {
     ...
     */
    after: (callback: A extends Record<ActionName, _Method> ? (resolvedReturn: _Awaited<ReturnType<A[ActionName]>>) => void | ReturnType<A[ActionName]> | _Awaited<ReturnType<A[ActionName]>> : () => void) => void;
    /**
