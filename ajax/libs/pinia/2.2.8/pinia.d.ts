 ...
 */
export declare function mapWritableState<Id extends string, S extends StateTree, G extends _GettersTree<S>, A, KeyMapper extends Record<string, keyof UnwrapRef<S>>>(useStore: StoreDefinition<Id, S, G, A>, keyMapper: KeyMapper): _MapWritableStateObjectReturn<UnwrapRef<S>, KeyMapper>;
 ...
 */
export declare function mapWritableState<Id extends string, S extends StateTree, G extends _GettersTree<S>, A, Keys extends keyof UnwrapRef<S>>(useStore: StoreDefinition<Id, S, G, A>, keys: readonly Keys[]): Pick<_MapWritableStateReturn<UnwrapRef<S>>, Keys>;

/**
 * For internal use **only**
 */
export declare type _MapWritableStateObjectReturn<S, T extends Record<string, keyof S>> = {
    [key in keyof T]: {
        get: () => S[T[key]];
 ...
 * For internal use **only**
 */
export declare type _MapWritableStateReturn<S> = {
    [key in keyof S]: {
        get: () => S[key];
        set: (value: S[key]) => any;
    };
