...
class OrbitUpdater {
  ...
  init(particle) {
    ...
    if (orbitOptions.enable) {
      ...
      particle.orbitColor = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToHsl)(orbitOptions.color);
      particle.retina.orbitRadius = (orbitOptions === null || orbitOptions === void 0 ? void 0 : orbitOptions.radius) !== undefined ? (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.getRangeValue)(orbitOptions.radius) * container.retina.pixelRatio : undefined;
