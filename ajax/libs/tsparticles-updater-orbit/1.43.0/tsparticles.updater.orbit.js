...
class OrbitUpdater {
  ...
  init(particle) {
    ...
    if (orbitOptions.enable) {
      ...
      particle.retina.orbitRadius = (orbitOptions === null || orbitOptions === void 0 ? void 0 : orbitOptions.radius) !== undefined ? (0,external_commonjs_tsparticles_commonjs2_tsparticles_amd_tsparticles_root_window_.getRangeValue)(orbitOptions.radius) * container.retina.pixelRatio : undefined;
