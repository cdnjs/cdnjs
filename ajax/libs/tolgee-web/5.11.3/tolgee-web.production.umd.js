(function (global, factory) {
    ...
    const createFetchFunction = (fetchFn = fetch) => {
        return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ 'X-Tolgee-SDK-Type': 'JS', 'X-Tolgee-SDK-Version': "5.11.3"  }, init === null || init === void 0 ? void 0 : init.headers) }));
    };
    ...
    if (typeof window !== 'undefined' && typeof sessionStorage !== 'undefined') {
        exports.BrowserExtensionPlugin = () => (tolgee) => {
            ...
            const getTolgeePlugin = async () => {
                const InContextTools = await loadInContextLib("5.11.3" );
                return (tolgee) => {
