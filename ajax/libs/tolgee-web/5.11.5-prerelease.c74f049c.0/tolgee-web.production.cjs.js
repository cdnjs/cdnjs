...
const createFetchFunction = (fetchFn = defaultFetchFunction) => {
    return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ 'X-Tolgee-SDK-Type': 'JS', 'X-Tolgee-SDK-Version': "5.11.5-prerelease.c74f049c.0"  }, init === null || init === void 0 ? void 0 : init.headers) }));
};
...
if (typeof window !== 'undefined' && typeof sessionStorage !== 'undefined') {
    exports.BrowserExtensionPlugin = () => (tolgee) => {
        ...
        const getTolgeePlugin = async () => {
            const InContextTools = await loadInContextLib("5.11.5-prerelease.c74f049c.0" );
            return (tolgee) => {
