...
const createFetchFunction = (fetchFn = defaultFetchFunction) => {
    return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ 'X-Tolgee-SDK-Type': 'JS', 'X-Tolgee-SDK-Version': "5.14.1-prerelease.a2c80516.0"  }, init === null || init === void 0 ? void 0 : init.headers) }));
};
...
function GeneralObserver() {
    ...
    function createRunningInstance({ mouseHighlight, options, wrapper, onClick, }) {
        ...
        function handleKeyAttribute(node) {
...
if (sessionStorageAvailable()) {
    exports.BrowserExtensionPlugin = () => (tolgee) => {
        ...
        const getTolgeePlugin = async () => {
            const InContextTools = await loadInContextLib("5.14.1-prerelease.a2c80516.0" );
            return (tolgee) => {
...
//# sourceMappingURL=tolgee-web.production.cjs.js.map
