...
const createFetchFunction = (fetchFn = defaultFetchFunction) => {
  return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ "X-Tolgee-SDK-Type": "JS", "X-Tolgee-SDK-Version": "5.25.1-prerelease.d1c80a58.0" }, init === null || init === void 0 ? void 0 : init.headers) }));
};
