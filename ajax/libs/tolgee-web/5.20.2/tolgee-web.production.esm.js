...
const createFetchFunction = (fetchFn = defaultFetchFunction) => {
    return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ 'X-Tolgee-SDK-Type': 'JS', 'X-Tolgee-SDK-Version': "5.20.2"  }, init === null || init === void 0 ? void 0 : init.headers) }));
};
...
if (sessionStorageAvailable()) {
    BrowserExtensionPlugin = () => (tolgee) => {
        ...
        const getTolgeePlugin = async () => {
            const InContextTools = await loadInContextLib("5.20.2" );
            return (tolgee) => {
