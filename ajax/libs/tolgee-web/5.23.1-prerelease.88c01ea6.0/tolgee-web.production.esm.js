...
const createFetchFunction = (fetchFn = defaultFetchFunction) => {
  return (input, init) => fetchFn(input, Object.assign(Object.assign({}, init), { headers: Object.assign({ "X-Tolgee-SDK-Type": "JS", "X-Tolgee-SDK-Version": "5.23.1-prerelease.88c01ea6.0" }, init === null || init === void 0 ? void 0 : init.headers) }));
};
...
function Cache(events, backendGetRecord, backendGetDevRecord, withDefaultNs, isInitialLoading, fetchingObserver, loadingObserver) {
  ...
  function fetchData(keyObject, isDev) {
    ...
    let dataOrPromise = void 0;
    if (isDev) {
      dataOrPromise = (_a2 = backendGetDevRecord(keyObject)) === null || _a2 === void 0 ? void 0 : _a2.catch((e) => {
  ...
  const self2 = Object.freeze({
    ...
    getBackendRecord: ({ language, namespace }) => {
      for (const backend of instances.backends) {
        const data = backend.getRecord(Object.assign({
          language,
          namespace
        }, getCommonProps()));
        if (data !== void 0) {
