...
0;l<g.length;l+=1)this.vb(g[l],l+1);return!0};a.prototype.reset=function(){this.freemem();return 0===Dc(this.Ra)&&0===Cc(this.Ra)};a.prototype.freemem=function(){for(var g;void 0!==(g=this.lb.pop());)ma(g)};a.prototype.free=function(){this.freemem();var g=0===Ec(this.Ra);delete this.db.fb[this.Ra];this.Ra=0;return g};b.prototype.next=function(){if(null===this.eb)return{done:!0};null!==this.$a&&(this.$a.free(),this.$a=null);if(!this.db.db)throw this.nb(),Error("Database closed");var g=na(),l=y(4);
oa(d);oa(l);try{this.db.handleError(Z(this.db.db,this.jb,-1,d,l));this.jb=x(l,"i32");var q=x(d,"i32");if(0===q)return this.nb(),{done:!0};this.$a=new a(q,this.db);this.db.fb[q]=this.$a;return{value:this.$a,done:!1}}catch(p){throw this.pb=B(this.jb),this.nb(),p;}finally{pa(g)}};b.prototype.nb=function(){ma(this.eb);this.eb=null};b.prototype.getRemainingSQL=function(){return null!==this.pb?this.pb:B(this.jb)};"function"===typeof Symbol&&"symbol"===typeof Symbol.iterator&&(b.prototype[Symbol.iterator]=
function(){return this});c.prototype.run=function(g,l){if(!this.db)throw"Database closed";if(l){g=this.prepare(g,l);try{g.step()}finally{g.free()}}else this.handleError(t(this.db,g,0,0,d));return this};c.prototype.exec=function(g,l,q){if(!this.db)throw"Database closed";var p=na(),z=null;try{var M=ba(g)+1,G=y(M);k(g,A,G,M);var ja=G;var aa=y(4);for(g=[];0!==x(ja,"i8");){oa(d);oa(aa);this.handleError(Z(this.db,ja,-1,d,aa));var D=x(d,"i32");ja=x(aa,"i32");if(0!==D){M=null;z=new a(D,this);for(null!=l&&
...
new a(g,this);null!=l&&q.bind(l);return this.fb[g]=q};c.prototype.iterateStatements=function(g){return new b(g,this)};c.prototype["export"]=function(){Object.values(this.fb).forEach(function(l){l.free()});Object.values(this.Xa).forEach(qa);this.Xa={};this.handleError(n(this.db));var g=ra(this.filename);this.handleError(h(this.filename,d));this.db=x(d,"i32");return g};c.prototype.close=function(){null!==this.db&&(Object.values(this.fb).forEach(function(g){g.free()}),Object.values(this.Xa).forEach(qa),
this.Xa={},this.handleError(n(this.db)),sa("/"+this.filename),this.db=null)};c.prototype.handleError=function(g){if(0===g)return null;g=uc(this.db);throw Error(g);};c.prototype.getRowsModified=function(){return w(this.db)};c.prototype.create_function=function(g,l){Object.prototype.hasOwnProperty.call(this.Xa,g)&&(ta(this.Xa[g]),delete this.Xa[g]);var q=ua(function(p,z,M){for(var G,ja=[],aa=0;aa<z;aa+=1){var D=x(M+4*aa,"i32"),N=Gc(D);if(1===N||2===N)D=Kc(D);else if(3===N)D=Ic(D);else if(4===N){N=D;
D=Hc(N);N=Jc(N);for(var xb=new Uint8Array(D),Ea=0;Ea<D;Ea+=1)xb[Ea]=A[N+Ea];D=xb}else D=null;ja.push(D)}try{G=l.apply(null,ja)}catch(Rc){sb(p,Rc,-1);return}switch(typeof G){case "boolean":Oc(p,G?1:0);break;case "number":Lc(p,G);break;case "string":Mc(p,G,-1,-1);break;case "object":null===G?rb(p):null!=G.length?(z=la(G),Nc(p,z,G.length,-1),ma(z)):sb(p,"Wrong API use : tried to return a value of an unknown type ("+G+").",-1);break;default:rb(p)}});this.Xa[g]=q;this.handleError(Fc(this.db,g,l.length,
1,0,q,0,0,0));return this};e.Database=c};var va={},E;for(E in e)e.hasOwnProperty(E)&&(va[E]=e[E]);var wa="./this.program",xa=!1,ya=!1,za=!1,Aa=!1;xa="object"===typeof window;ya="function"===typeof importScripts;za="object"===typeof process&&"object"===typeof process.versions&&"string"===typeof process.versions.node;Aa=!xa&&!za&&!ya;var F="",Ba,Ca,Da,Fa;
