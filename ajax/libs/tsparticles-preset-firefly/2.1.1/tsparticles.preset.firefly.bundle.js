...
__webpack_require__.d(__webpack_exports__, {
  "loadFireflyPreset": function() { return /* reexport */ loadFireflyPreset; },
...
const Constants_randomColorValue = "random";
const Constants_midColorValue = "mid";
...
function colorToRgb(input, index, useIndex = true) {
  ...
  if (typeof color.value === "string") {
    return color.value === Constants_randomColorValue ? getRandomRgbColor() : stringToRgb(color.value);
  }
...
class Canvas {
  ...
  clear() {
    ...
    if (options.backgroundMask.enable) {
      ...
      this.paintBase(ColorUtils_getStyleFromRgb(this.trailFillColor, 1 / trail.length));
    } else {
      this.draw(ctx => {
        clear(ctx, this.size);
      });
  ...
  initBackground() {
    ...
    if (background.color) {
      ...
      elementStyle.backgroundColor = color ? ColorUtils_getStyleFromRgb(color, background.opacity) : "";
    } else {
  ...
  initCover() {
    ...
    if (coverRgb) {
      ...
      this.coverColorStyle = ColorUtils_getStyleFromRgb(coverColor, coverColor.a);
    }
  }
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/GradientColorOpacityAnimation.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/GradientColorOpacity.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/AnimatableGradientColor.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/GradientAngleAnimation.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/GradientAngle.js
...
;// CONCATENATED MODULE: ../../engine/dist/esm/Options/Classes/Gradients/AnimatableGradient.js
...
class Vector3d extends Vector_Vector {
...
class Particle {
  constructor(engine, id, container, position, overrideOptions, group) {
    ...
    this.pathDelay = NumberUtils_getValue(this.options.move.path.delay) * 1000;
