...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "loadExternalTrailInteraction": function() { return /* binding */ loadExternalTrailInteraction; }
});

// EXTERNAL MODULE: ../../engine/dist/esm/index.js + 119 modules
var esm = __webpack_require__(291);
...
class TrailMaker extends esm.ExternalInteractorBase {
  constructor(container) {
    super(container);
    this.delay = 0;
  }
  ...
  isEnabled() {
    ...
    return mouse.clicking && mouse.inside && !!mouse.position && (0,esm.isInArray)("trail", events.onClick.mode) || mouse.inside && !!mouse.position && (0,esm.isInArray)("trail", events.onHover.mode);
  }
...
const tsparticles_move_base_1 = __webpack_require__(587);

const tsparticles_shape_circle_1 = __webpack_require__(387);

const tsparticles_updater_color_1 = __webpack_require__(966);

const tsparticles_interaction_external_trail_1 = __webpack_require__(49);

const tsparticles_updater_life_1 = __webpack_require__(820);

const tsparticles_updater_opacity_1 = __webpack_require__(255);

const tsparticles_updater_size_1 = __webpack_require__(28);
...
Object.defineProperty(exports, "loadFireflyPreset", ({
  enumerable: true,
  get: function () {
    return _1.loadFireflyPreset;
  }
}));

const tsparticles_engine_1 = __webpack_require__(291);
...
(0, _1.loadFireflyPreset)(tsparticles_engine_1.tsParticles);
}();
