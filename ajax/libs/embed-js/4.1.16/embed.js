...
var fetch$1 = typeof fetch=='function' ? fetch : function(url, options) {
	options = options || {};
	return new Promise( function (resolve, reject) {
...
function fetchRepo (data) {
  ...
  return new Promise(function (resolve) { return fetch$1(api)
			.then(function (data) { return data.json(); })
			.then(function (json) { return resolve(json); }); }
	)
}
	...
	return new Promise(function (resolve) {
		...
		openGraphPromise.then(function (ref) {
			...
			if (ifEmbed(options, 'gist')) {
				var assign$17;
					(assign$17 = new Gist(input, output, options, embeds).process(), output = assign$17[0], embeds = assign$17[1]);
			}
