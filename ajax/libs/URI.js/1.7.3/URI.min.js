...
1);else break;d[i]=j.join("")}var j=-1,s=f=0,u=-1,g=!1;for(i=0;i<h;i++)g?"0"===d[i]?s+=1:(g=!1,s>f&&(j=u,f=s)):"0"==d[i]&&(g=!0,u=i,s=1);s>f&&(j=u,f=s);1<f&&d.splice(j,f,"");j=d.length;h="";""===d[0]&&(beststr=":");for(i=0;i<j;i++){h+=d[i];if(i===j-1)break;h+=":"}""===d[j-1]&&(h+=":");return h}}})();
(function(d){function j(a){throw RangeError(C[a]);}function h(a,b){for(var e=a.length;e--;)a[e]=b(a[e]);return a}function i(a){for(var b=[],e=0,c=a.length,k,d;e<c;)k=a.charCodeAt(e++),55296==(k&63488)&&(d=a.charCodeAt(e++),(55296!=(k&64512)||56320!=(d&64512))&&j("ucs2decode"),k=((k&1023)<<10)+(d&1023)+65536),b.push(k);return b}function f(a){return h(a,function(a){var b="";55296==(a&63488)&&j("ucs2encode");65535<a&&(a-=65536,b+=z(a>>>10&1023|55296),a=56320|a&1023);return b+=z(a)}).join("")}function s(e,
c,k){for(var d=0,e=k?w(e/b):e>>1,e=e+w(e/c);e>x*r>>1;d+=n)e=w(e/x);return w(d+(x+1)*e/(e+a))}function u(a){var b=[],c=a.length,d,g=0,t=k,i=e,m,h,l,q,v;m=a.lastIndexOf(B);0>m&&(m=0);for(h=0;h<m;++h)128<=a.charCodeAt(h)&&j("not-basic"),b.push(a.charCodeAt(h));for(m=0<m?m+1:0;m<c;){h=g;d=1;for(l=n;;l+=n){m>=c&&j("invalid-input");q=a.charCodeAt(m++);q=10>q-48?q-22:26>q-65?q-65:26>q-97?q-97:n;(q>=n||q>w((y-g)/d))&&j("overflow");g+=q*d;v=l<=i?p:l>=i+r?r:l-i;if(q<v)break;q=n-v;d>w(y/q)&&j("overflow");d*=
q}d=b.length+1;i=s(g-h,d,0==h);w(g/d)>y-t&&j("overflow");t+=w(g/d);g%=d;b.splice(g++,0,t)}return f(b)}function g(a){var b,c,d,g,f,t,m,h,l,q=[],v,u,x,a=i(a);v=a.length;b=k;c=0;f=e;for(t=0;t<v;++t)l=a[t],128>l&&q.push(z(l));for((d=g=q.length)&&q.push(B);d<v;){m=y;for(t=0;t<v;++t)l=a[t],l>=b&&l<m&&(m=l);u=d+1;m-b>w((y-c)/u)&&j("overflow");c+=(m-b)*u;b=m;for(t=0;t<v;++t)if(l=a[t],l<b&&++c>y&&j("overflow"),l==b){h=c;for(m=n;;m+=n){l=m<=f?p:m>=f+r?r:m-f;if(h<l)break;x=h-l;h=n-l;q.push(z(l+x%h+22+75*(26>
l+x%h)-0));h=w(x/h)}q.push(z(h+22+75*(26>h)-0));f=s(c,u,d==g);c=0;++d}++c;++b}return q.join("")}var c,m="function"==typeof define&&"object"==typeof define.amd&&define.amd&&define,l="object"==typeof exports&&exports,q="object"==typeof module&&module,y=2147483647,n=36,p=1,r=26,a=38,b=700,e=72,k=128,B="-",t=/[^ -~]/,v=/^xn--/,C={overflow:"Overflow: input needs wider integers to process.",ucs2decode:"UCS-2(decode): illegal sequence",ucs2encode:"UCS-2(encode): illegal value","not-basic":"Illegal input >= 0x80 (not a basic code point)",
"invalid-input":"Invalid input"},x=n-p,w=Math.floor,z=String.fromCharCode,A;c={version:"0.3.0",ucs2:{decode:i,encode:f},decode:u,encode:g,toASCII:function(a){return h(a.split("."),function(a){return t.test(a)?"xn--"+g(a):a}).join(".")},toUnicode:function(a){return h(a.split("."),function(a){return v.test(a)?u(a.slice(4).toLowerCase()):a}).join(".")}};if(l)if(q&&q.exports==l)q.exports=c;else for(A in c)c.hasOwnProperty(A)&&(l[A]=c[A]);else m?define("punycode",c):d.punycode=c})(this);
...
c.encodeQuery=function(a){return c.encode(a+"").replace(/%20/g,"+")};c.decodeQuery=function(a){return c.decode((a+"").replace(/\+/g,"%20"))};c.recodePath=function(a){for(var a=(a+"").split("/"),b=0,e=a.length;b<e;b++)a[b]=c.encodePathSegment(c.decode(a[b]));return a.join("/")};c.decodePath=function(a){for(var a=(a+"").split("/"),b=0,e=a.length;b<e;b++)a[b]=c.decodePathSegment(a[b]);return a.join("/")};var m={encode:"encode",decode:"decode"},l,q=function(a,b){return function(e){return c[b](e+"").replace(c.characters[a][b].expression,
function(e){return c.characters[a][b].map[e]})}};for(l in m)c[l+"PathSegment"]=q("pathname",m[l]);c.encodeReserved=q("reserved","encode");c.parse=function(a){var b,e={};b=a.indexOf("#");-1<b&&(e.fragment=a.substring(b+1)||null,a=a.substring(0,b));b=a.indexOf("?");-1<b&&(e.query=a.substring(b+1)||null,a=a.substring(0,b));"//"===a.substring(0,2)?(e.protocol="",a=a.substring(2),a=c.parseAuthority(a,e)):(b=a.indexOf(":"),-1<b&&(e.protocol=a.substring(0,b),"//"===a.substring(b+1,b+3)?(a=a.substring(b+
...
a+"' contains characters other than [A-Z0-9.-]");}};f.build=function(a){if(!0===a)this._deferred_build=!0;else if(a===d||this._deferred_build)this._string=c.build(this._parts),this._deferred_build=!1;return this};f.clone=function(){return new c(this)};f.toString=function(){return this.build(!1)._string};f.valueOf=function(){return this.toString()};m={protocol:"protocol",username:"username",password:"password",hostname:"hostname",port:"port"};q=function(a){return function(b,e){if(b===d)return this._parts[a]||
"";this._parts[a]=b;this.build(!e);return this}};for(l in m)f[l]=q(m[l]);m={query:"?",fragment:"#"};q=function(a,b){return function(e,c){if(e===d)return this._parts[a]||"";null!==e&&(e+="",e[0]===b&&(e=e.substring(1)));this._parts[a]=e;this.build(!c);return this}};for(l in m)f[l]=q(l,m[l]);m={search:["?","query"],hash:["#","fragment"]};q=function(a,b){return function(c,k){var d=this[a](c,k);return"string"===typeof d&&d.length?b+d:d}};for(l in m)f[l]=q(m[l][1],m[l][0]);f.pathname=function(a,b){if(a===
...
return y.call(this,a,b)};f.scheme=f.protocol;f.port=function(a,b){if(this._parts.urn)return a===d?"":this;if(a!==d&&(0===a&&(a=null),a&&(a+="",":"===a[0]&&(a=a.substring(1)),a.match(/[^0-9]/))))throw new TypeError("Port '"+a+"' contains characters other than [0-9]");return n.call(this,a,b)};f.hostname=function(a,b){if(this._parts.urn)return a===d?"":this;if(a!==d){var e={};c.parseHost(a,e);a=e.hostname}return p.call(this,a,b)};f.host=function(a,b){if(this._parts.urn)return a===d?"":this;if(a===d)return this._parts.hostname?
...
f.normalizeHostname=function(a){this._parts.hostname&&(this.is("IDN")&&s?this._parts.hostname=s.toASCII(this._parts.hostname):this.is("IPv6")&&u&&(this._parts.hostname=u.best(this._parts.hostname)),this._parts.hostname=this._parts.hostname.toLowerCase(),this.build(!a));return this};f.normalizePort=function(a){"string"===typeof this._parts.protocol&&this._parts.port===c.defaultPorts[this._parts.protocol]&&(this._parts.port=null,this.build(!a));return this};f.normalizePath=function(a){if(this._parts.urn||
...
f.unicode=function(){var a=c.encode,b=c.decode;c.encode=i;c.decode=unescape;this.normalize();c.encode=a;c.decode=b;return this};f.readable=function(){var a=this.clone();a.username("").password("").normalize();var b="";a._parts.protocol&&(b+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&s?(b+=s.toUnicode(a._parts.hostname),a._parts.port&&(b+=":"+a._parts.port)):b+=a.host());a._parts.hostname&&(a._parts.path&&"/"!==a._parts.path[0])&&(b+="/");b+=a.path(!0);if(a._parts.query){for(var e=
...
(function(d){var j=Object.prototype.hasOwnProperty,h="undefined"!==typeof module&&module.exports?require("./URI"):window.URI,i=function(d){if(i._cache[d])return i._cache[d];if(!(this instanceof i))return new i(d);this.expression=d;i._cache[d]=this;return this},f=function(d){this.data=d;this.cache={}},s=i.prototype,u={"":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encode"},"+":{prefix:"",separator:",",named:!1,empty_name_separator:!1,encode:"encodeReserved"},"#":{prefix:"#",separator:",",
...
i.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;i.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;i.expand=function(d,c){var f=u[d.operator],l=f.named?"Named":"Unnamed",h=d.variables,j=[],n,p,r;for(r=0;p=h[r];r++)n=c.get(p.name),n.val.length?j.push(i["expand"+l](n,f,p.explode,p.explode&&f.separator||",",p.maxlength,p.name)):n.type&&j.push("");return j.length?f.prefix+j.join(f.separator):""};i.expandNamed=function(g,c,f,l,i,j){var n="",p=c.encode,c=c.empty_name_separator,r=!g[p].length,a=2===g.type?"":h[p](j),
b,e,k;e=0;for(k=g.val.length;e<k;e++)i?(b=h[p](g.val[e][1].substring(0,i)),2===g.type&&(a=h[p](g.val[e][0].substring(0,i)))):r?(b=h[p](g.val[e][1]),2===g.type?(a=h[p](g.val[e][0]),g[p].push([a,b])):g[p].push([d,b])):(b=g[p][e][1],2===g.type&&(a=g[p][e][0])),n&&(n+=l),f?n+=a+(c||b?"=":"")+b:(e||(n+=h[p](j)+(c||b?"=":"")),2===g.type&&(n+=a+","),n+=b);return n};i.expandUnnamed=function(g,c,f,l,i){var j="",n=c.encode,c=c.empty_name_separator,p=!g[n].length,r,a,b,e;b=0;for(e=g.val.length;b<e;b++)i?a=h[n](g.val[b][1].substring(0,
i)):p?(a=h[n](g.val[b][1]),g[n].push([2===g.type?h[n](g.val[b][0]):d,a])):a=g[n][b][1],j&&(j+=l),2===g.type&&(r=i?h[n](g.val[b][0].substring(0,i)):g[n][b][0],j+=r,j=f?j+(c||a?"=":""):j+","),j+=a;return j};s.expand=function(d){var c="";(!this.parts||!this.parts.length)&&this.parse();d instanceof f||(d=new f(d));for(var j=0,l=this.parts.length;j<l;j++)c+="string"===typeof this.parts[j]?this.parts[j]:i.expand(this.parts[j],d);return c};s.parse=function(){var d=this.expression,c=i.EXPRESSION_PATTERN,
f=i.VARIABLE_PATTERN,j=i.VARIABLE_NAME_PATTERN,h=[],s=0,n,p,r;for(c.lastIndex=0;;){p=c.exec(d);if(null===p){h.push(d.substring(s));break}else h.push(d.substring(s,p.index)),s=p.index+p[0].length;if(u[p[1]]){if(!p[3])throw Error('Unclosed Expression "'+p[0]+'"');}else throw Error('Unknown Operator "'+p[1]+'" in "'+p[0]+'"');n=p[2].split(",");for(var a=0,b=n.length;a<b;a++){r=n[a].match(f);if(null===r)throw Error('Invalid Variable "'+n[a]+'" in "'+p[0]+'"');if(r[1].match(j))throw Error('Invalid Variable Name "'+
r[1]+'" in "'+p[0]+'"');n[a]={name:r[1],explode:!!r[3],maxlength:r[4]&&parseInt(r[4],10)}}if(!n.length)throw Error('Expression Missing Variable(s) "'+p[0]+'"');h.push({expression:p[0],operator:p[1],variables:n})}h.length||h.push(d);this.parts=h;return this};f.prototype.get=function(f){var c=this.data,h={type:0,val:[],encode:[],encodeReserved:[]},i;if(this.cache[f]!==d)return this.cache[f];this.cache[f]=h;c="[object Function]"===String(Object.prototype.toString.call(c))?c(f):"[object Function]"===
