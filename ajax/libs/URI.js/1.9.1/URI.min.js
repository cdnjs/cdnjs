...
(function(f){function g(a){throw RangeError(D[a]);}function j(a,b){for(var e=a.length;e--;)a[e]=b(a[e]);return a}function d(a){for(var b=[],e=0,d=a.length,s,c;e<d;)s=a.charCodeAt(e++),55296==(s&63488)&&e<d?(c=a.charCodeAt(e++),56320==(c&64512)?b.push(((s&1023)<<10)+(c&1023)+65536):b.push(s,c)):b.push(s);return b}function m(a){return j(a,function(a){var b="";65535<a&&(a-=65536,b+=A(a>>>10&1023|55296),a=56320|a&1023);return b+=A(a)}).join("")}function u(e,d,s){var c=0;e=s?x(e/b):e>>1;for(e+=x(e/d);e>
y*t>>1;c+=l)e=x(e/y);return x(c+(y+1)*e/(e+a))}function h(a){var b=[],d=a.length,c,h=0,f=s,w=e,n,j,p,k,r;n=a.lastIndexOf(C);0>n&&(n=0);for(j=0;j<n;++j)128<=a.charCodeAt(j)&&g("not-basic"),b.push(a.charCodeAt(j));for(n=0<n?n+1:0;n<d;){j=h;c=1;for(p=l;;p+=l){n>=d&&g("invalid-input");k=a.charCodeAt(n++);k=10>k-48?k-22:26>k-65?k-65:26>k-97?k-97:l;(k>=l||k>x((q-h)/c))&&g("overflow");h+=k*c;r=p<=w?v:p>=w+t?t:p-w;if(k<r)break;k=l-r;c>x(q/k)&&g("overflow");c*=k}c=b.length+1;w=u(h-j,c,0==j);x(h/c)>q-f&&g("overflow");
f+=x(h/c);h%=c;b.splice(h++,0,f)}return m(b)}function c(a){var b,c,h,f,w,n,k,j,p,r=[],m,z,y;a=d(a);m=a.length;b=s;c=0;w=e;for(n=0;n<m;++n)p=a[n],128>p&&r.push(A(p));for((h=f=r.length)&&r.push(C);h<m;){k=q;for(n=0;n<m;++n)p=a[n],p>=b&&p<k&&(k=p);z=h+1;k-b>x((q-c)/z)&&g("overflow");c+=(k-b)*z;b=k;for(n=0;n<m;++n)if(p=a[n],p<b&&++c>q&&g("overflow"),p==b){j=c;for(k=l;;k+=l){p=k<=w?v:k>=w+t?t:k-w;if(j<p)break;y=j-p;j=l-p;r.push(A(p+y%j+22+75*(26>p+y%j)-0));j=x(y/j)}r.push(A(j+22+75*(26>j)-0));w=u(c,z,
h==f);c=0;++h}++c;++b}return r.join("")}var n,p="function"==typeof define&&"object"==typeof define.amd&&define.amd&&define,k="object"==typeof exports&&exports,r="object"==typeof module&&module,q=2147483647,l=36,v=1,t=26,a=38,b=700,e=72,s=128,C="-",w=/[^ -~]/,z=/^xn--/,D={overflow:"Overflow: input needs wider integers to process.","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},y=l-v,x=Math.floor,A=String.fromCharCode,B;n={version:"1.1.1",ucs2:{decode:d,
encode:m},decode:h,encode:c,toASCII:function(a){return j(a.split("."),function(a){return w.test(a)?"xn--"+c(a):a}).join(".")},toUnicode:function(a){return j(a.split("."),function(a){return z.test(a)?h(a.slice(4).toLowerCase()):a}).join(".")}};if(k)if(r&&r.exports==k)r.exports=n;else for(B in n)n.hasOwnProperty(B)&&(k[B]=n[B]);else p?define("punycode",n):f.punycode=n})(this);
...
"%2C":",","%3B":";","%3D":"="}}}};d.encodeQuery=function(a){return d.encode(a+"").replace(/%20/g,"+")};d.decodeQuery=function(a){return d.decode((a+"").replace(/\+/g,"%20"))};d.recodePath=function(a){a=(a+"").split("/");for(var b=0,e=a.length;b<e;b++)a[b]=d.encodePathSegment(d.decode(a[b]));return a.join("/")};d.decodePath=function(a){a=(a+"").split("/");for(var b=0,e=a.length;b<e;b++)a[b]=d.decodePathSegment(a[b]);return a.join("/")};var p={encode:"encode",decode:"decode"},k,r=function(a,b){return function(e){return d[b](e+
"").replace(d.characters[a][b].expression,function(e){return d.characters[a][b].map[e]})}};for(k in p)d[k+"PathSegment"]=r("pathname",p[k]);d.encodeReserved=r("reserved","encode");d.parse=function(a,b){var e;b||(b={});e=a.indexOf("#");-1<e&&(b.fragment=a.substring(e+1)||null,a=a.substring(0,e));e=a.indexOf("?");-1<e&&(b.query=a.substring(e+1)||null,a=a.substring(0,e));"//"===a.substring(0,2)?(b.protocol="",a=a.substring(2),a=d.parseAuthority(a,b)):(e=a.indexOf(":"),-1<e&&(b.protocol=a.substring(0,
e),b.protocol&&!b.protocol.match(d.protocol_expression)?b.protocol=void 0:"file"===b.protocol?a=a.substring(e+3):"//"===a.substring(e+1,e+3)?(a=a.substring(e+3),a=d.parseAuthority(a,b)):(a=a.substring(e+1),b.urn=!0)));b.path=a;return b};d.parseHost=function(a,b){var e=a.indexOf("/"),d;-1===e&&(e=a.length);"["===a.charAt(0)?(d=a.indexOf("]"),b.hostname=a.substring(1,d)||null,b.port=a.substring(d+2,e)||null):a.indexOf(":")!==a.lastIndexOf(":")?(b.hostname=a.substring(0,e)||null,b.port=null):(d=a.substring(0,
e).split(":"),b.hostname=d[0]||null,b.port=d[1]||null);b.hostname&&"/"!==a.substring(e).charAt(0)&&(e++,a="/"+a);return a.substring(e)||"/"};d.parseAuthority=function(a,b){a=d.parseUserinfo(a,b);return d.parseHost(a,b)};d.parseUserinfo=function(a,b){var e=a.indexOf("@"),s=a.indexOf("/");-1<e&&(-1===s||e<s)?(s=a.substring(0,e).split(":"),b.username=s[0]?d.decode(s[0]):null,s.shift(),b.password=s[0]?d.decode(s.join(":")):null,a=a.substring(e+1)):(b.username=null,b.password=null);return a};d.parseQuery=
function(a){if(!a)return{};a=a.replace(/&+/g,"&").replace(/^\?*&*|&+$/g,"");if(!a)return{};var b={};a=a.split("&");for(var e=a.length,s,c,h=0;h<e;h++)s=a[h].split("="),c=d.decodeQuery(s.shift()),s=s.length?d.decodeQuery(s.join("=")):null,b[c]?("string"===typeof b[c]&&(b[c]=[b[c]]),b[c].push(s)):b[c]=s;return b};d.build=function(a){var b="";a.protocol&&(b+=a.protocol+":");if(!a.urn&&(b||a.hostname))b+="//";b+=d.buildAuthority(a)||"";"string"===typeof a.path&&("/"!==a.path.charAt(0)&&"string"===typeof a.hostname&&
...
":"+d.encode(a.password)),b+="@");return b};d.buildQuery=function(a,b){var e="",s,c,h,f;for(c in a)if(n.call(a,c)&&c)if(u(a[c])){s={};h=0;for(f=a[c].length;h<f;h++)void 0!==a[c][h]&&void 0===s[a[c][h]+""]&&(e+="&"+d.buildQueryParameter(c,a[c][h]),!0!==b&&(s[a[c][h]+""]=!0))}else void 0!==a[c]&&(e+="&"+d.buildQueryParameter(c,a[c]));return e.substring(1)};d.buildQueryParameter=function(a,b){return d.encodeQuery(a)+(null!==b?"="+d.encodeQuery(b):"")};d.addQuery=function(a,b,e){if("object"===typeof b)for(var c in b)n.call(b,
c)&&d.addQuery(a,c,b[c]);else if("string"===typeof b)void 0===a[b]?a[b]=e:("string"===typeof a[b]&&(a[b]=[a[b]]),u(e)||(e=[e]),a[b]=a[b].concat(e));else throw new TypeError("URI.addQuery() accepts an object, string as the name parameter");};d.removeQuery=function(a,b,e){var c;if(u(b)){e=0;for(c=b.length;e<c;e++)a[b[e]]=void 0}else if("object"===typeof b)for(c in b)n.call(b,c)&&d.removeQuery(a,c,b[c]);else if("string"===typeof b)if(void 0!==e)if(a[b]===e)a[b]=void 0;else{if(u(a[b])){c=a[b];var h={},
f,g;if(u(e)){f=0;for(g=e.length;f<g;f++)h[e[f]]=!0}else h[e]=!0;f=0;for(g=c.length;f<g;f++)void 0!==h[c[f]]&&(c.splice(f,1),g--,f--);a[b]=c}}else a[b]=void 0;else throw new TypeError("URI.addQuery() accepts an object, string as the first parameter");};d.commonPath=function(a,b){var e=Math.min(a.length,b.length),d;for(d=0;d<e;d++)if(a.charAt(d)!==b.charAt(d)){d--;break}if(1>d)return a.charAt(0)===b.charAt(0)&&"/"===a.charAt(0)?"/":"";"/"!==a.charAt(d)&&(d=a.substring(0,d).lastIndexOf("/"));return a.substring(0,
...
c.path=c.pathname;c.href=function(a,b){var e;if(void 0===a)return this.toString();this._string="";this._parts=d._parts();var c=a instanceof d,h="object"===typeof a&&(a.hostname||a.path);!c&&(h&&void 0!==a.pathname)&&(a=a.toString());if("string"===typeof a)this._parts=d.parse(a,this._parts);else if(c||h)for(e in c=c?a._parts:a,c)n.call(this._parts,e)&&(this._parts[e]=c[e]);else throw new TypeError("invalid input");this.build(!b);return this};c.is=function(a){var b=!1,e=!1,c=!1,h=!1,f=!1,g=!1,n=!1,
k=!this._parts.urn;this._parts.hostname&&(k=!1,e=d.ip4_expression.test(this._parts.hostname),c=d.ip6_expression.test(this._parts.hostname),b=e||c,f=(h=!b)&&j&&j.has(this._parts.hostname),g=h&&d.idn_expression.test(this._parts.hostname),n=h&&d.punycode_expression.test(this._parts.hostname));switch(a.toLowerCase()){case "relative":return k;case "absolute":return!k;case "domain":case "name":return h;case "sld":return f;case "ip":return b;case "ip4":case "ipv4":case "inet4":return e;case "ip6":case "ipv6":case "inet6":return c;
case "idn":return g;case "url":return!this._parts.urn;case "urn":return!!this._parts.urn;case "punycode":return n}return null};var q=c.protocol,l=c.port,v=c.hostname;c.protocol=function(a,b){if(void 0!==a&&a&&(a=a.replace(/:(\/\/)?$/,""),a.match(/[^a-zA-z0-9\.+-]/)))throw new TypeError("Protocol '"+a+"' contains characters other than [A-Z0-9.+-]");return q.call(this,a,b)};c.scheme=c.protocol;c.port=function(a,b){if(this._parts.urn)return void 0===a?"":this;if(void 0!==a&&(0===a&&(a=null),a&&(a+="",
...
a?c:c[a];if(null===a||void 0===c[a])if(u(b))c=b;else{if(b||"string"===typeof b&&b.length)""===c[c.length-1]?c[c.length-1]=b:c.push(b)}else b||"string"===typeof b&&b.length?c[a]=b:c.splice(a,1);h&&c.unshift("");return this.path(c.join(d),e)};var t=c.query;c.query=function(a,b){if(!0===a)return d.parseQuery(this._parts.query);if("function"===typeof a){var e=d.parseQuery(this._parts.query),c=a.call(this,e);this._parts.query=d.buildQuery(c||e,this._parts.duplicateQueryParameters);this.build(!b);return this}return void 0!==
...
(this.is("IDN")&&f?this._parts.hostname=f.toASCII(this._parts.hostname):this.is("IPv6")&&g&&(this._parts.hostname=g.best(this._parts.hostname)),this._parts.hostname=this._parts.hostname.toLowerCase(),this.build(!a));return this};c.normalizePort=function(a){"string"===typeof this._parts.protocol&&this._parts.port===d.defaultPorts[this._parts.protocol]&&(this._parts.port=null,this.build(!a));return this};c.normalizePath=function(a){if(this._parts.urn||!this._parts.path||"/"===this._parts.path)return this;
var b,e,c=this._parts.path,h,f;"/"!==c.charAt(0)&&("."===c.charAt(0)&&(e=c.substring(0,c.indexOf("/"))),b=!0,c="/"+c);for(c=c.replace(/(\/(\.\/)+)|\/{2,}/g,"/");;){h=c.indexOf("/../");if(-1===h)break;else if(0===h){c=c.substring(3);break}f=c.substring(0,h).lastIndexOf("/");-1===f&&(f=h);c=c.substring(0,f)+c.substring(h+3)}b&&this.is("relative")&&(c=e?e+c:c.substring(1));c=d.recodePath(c);this._parts.path=c;this.build(!a);return this};c.normalizePathname=c.normalizePath;c.normalizeQuery=function(a){"string"===
...
b=d.decode;d.encode=h;d.decode=unescape;this.normalize();d.encode=a;d.decode=b;return this};c.readable=function(){var a=this.clone();a.username("").password("").normalize();var b="";a._parts.protocol&&(b+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&f?(b+=f.toUnicode(a._parts.hostname),a._parts.port&&(b+=":"+a._parts.port)):b+=a.host());a._parts.hostname&&(a._parts.path&&"/"!==a._parts.path.charAt(0))&&(b+="/");b+=a.path(!0);if(a._parts.query){for(var c="",h=0,g=a._parts.query.split("&"),
n=g.length;h<n;h++){var k=(g[h]||"").split("="),c=c+("&"+d.decodeQuery(k[0]).replace(/&/g,"%26"));void 0!==k[1]&&(c+="="+d.decodeQuery(k[1]).replace(/&/g,"%26"))}b+="?"+c.substring(1)}return b+=a.hash()};c.absoluteTo=function(a){var b=this.clone(),c=["protocol","username","password","hostname","port"],h,f;if(this._parts.urn)throw Error("URNs do not have any generally defined hierachical components");if(this._parts.hostname)return b;a instanceof d||(a=new d(a));h=0;for(f;f=c[h];h++)b._parts[f]=a._parts[f];
c=["query","path"];h=0;for(f;f=c[h];h++)!b._parts[f]&&a._parts[f]&&(b._parts[f]=a._parts[f]);"/"!==b.path().charAt(0)&&(a=a.directory(),b._parts.path=(a?a+"/":"")+b._parts.path,b.normalizePath());b.build();return b};c.relativeTo=function(a){var b=this.clone(),c=["protocol","username","password","hostname","port"],h;if(this._parts.urn)throw Error("URNs do not have any generally defined hierachical components");a instanceof d||(a=new d(a));if("/"!==this.path().charAt(0)||"/"!==a.path().charAt(0))throw Error("Cannot calculate common path from non-relative URLs");
h=d.commonPath(b.path(),a.path());if(!h||"/"===h)return b;for(var f=0,g;g=c[f];f++)b._parts[g]=null;a=a.directory();c=this.directory();if(a===c)return b._parts.path="./"+b.filename(),b.build();a.substring(h.length);c=c.substring(h.length);if(a+"/"===h)return c&&(c+="/"),b._parts.path="./"+c+b.filename(),b.build();c="../";h=RegExp("^"+m(h));for(a=a.replace(h,"/").match(/\//g).length-1;a--;)c+="../";b._parts.path=b._parts.path.replace(h,c);return b.build()};c.equals=function(a){var b=this.clone(),c=
new d(a),h={},f={};a={};var g;b.normalize();c.normalize();if(b.toString()===c.toString())return!0;h=b.query();f=c.query();b.query("");c.query("");if(b.toString()!==c.toString()||h.length!==f.length)return!1;h=d.parseQuery(h);f=d.parseQuery(f);for(g in h)if(n.call(h,g)){if(u(h[g])){if(!u(f[g])||h[g].length!==f[g].length)return!1;h[g].sort();f[g].sort();b=0;for(c=h[g].length;b<c;b++)if(h[g][b]!==f[g][b])return!1}else if(h[g]!==f[g])return!1;a[g]=!0}for(g in f)if(n.call(f,g)&&!a[g])return!1;return!0};
...
empty_name_separator:!0,encode:"encode"}};g._cache={};g.EXPRESSION_PATTERN=/\{([^a-zA-Z0-9%_]?)([^\}]+)(\}|$)/g;g.VARIABLE_PATTERN=/^([^*:]+)((\*)|:(\d+))?$/;g.VARIABLE_NAME_PATTERN=/[^a-zA-Z0-9%_]/;g.expand=function(d,c){var f=u[d.operator],p=f.named?"Named":"Unnamed",k=d.variables,j=[],q,l,m;for(m=0;l=k[m];m++)q=c.get(l.name),q.val.length?j.push(g["expand"+p](q,f,l.explode,l.explode&&f.separator||",",l.maxlength,l.name)):q.type&&j.push("");return j.length?f.prefix+j.join(f.separator):""};g.expandNamed=
function(d,c,g,p,k,j){var q="",l=c.encode;c=c.empty_name_separator;var m=!d[l].length,t=2===d.type?"":f[l](j),a,b,e;b=0;for(e=d.val.length;b<e;b++)k?(a=f[l](d.val[b][1].substring(0,k)),2===d.type&&(t=f[l](d.val[b][0].substring(0,k)))):m?(a=f[l](d.val[b][1]),2===d.type?(t=f[l](d.val[b][0]),d[l].push([t,a])):d[l].push([void 0,a])):(a=d[l][b][1],2===d.type&&(t=d[l][b][0])),q&&(q+=p),g?q+=t+(c||a?"=":"")+a:(b||(q+=f[l](j)+(c||a?"=":"")),2===d.type&&(q+=t+","),q+=a);return q};g.expandUnnamed=function(d,
c,g,j,k){var r="",q=c.encode;c=c.empty_name_separator;var l=!d[q].length,m,t,a,b;a=0;for(b=d.val.length;a<b;a++)k?t=f[q](d.val[a][1].substring(0,k)):l?(t=f[q](d.val[a][1]),d[q].push([2===d.type?f[q](d.val[a][0]):void 0,t])):t=d[q][a][1],r&&(r+=j),2===d.type&&(m=k?f[q](d.val[a][0].substring(0,k)):d[q][a][0],r+=m,r=g?r+(c||t?"=":""):r+","),r+=t;return r};m.expand=function(d){var c="";(!this.parts||!this.parts.length)&&this.parse();d instanceof j||(d=new j(d));for(var f=0,p=this.parts.length;f<p;f++)c+=
"string"===typeof this.parts[f]?this.parts[f]:g.expand(this.parts[f],d);return c};m.parse=function(){var d=this.expression,c=g.EXPRESSION_PATTERN,f=g.VARIABLE_PATTERN,j=g.VARIABLE_NAME_PATTERN,k=[],m=0,q,l,v;for(c.lastIndex=0;;){l=c.exec(d);if(null===l){k.push(d.substring(m));break}else k.push(d.substring(m,l.index)),m=l.index+l[0].length;if(u[l[1]]){if(!l[3])throw Error('Unclosed Expression "'+l[0]+'"');}else throw Error('Unknown Operator "'+l[1]+'" in "'+l[0]+'"');q=l[2].split(",");for(var t=0,
a=q.length;t<a;t++){v=q[t].match(f);if(null===v)throw Error('Invalid Variable "'+q[t]+'" in "'+l[0]+'"');if(v[1].match(j))throw Error('Invalid Variable Name "'+v[1]+'" in "'+l[0]+'"');q[t]={name:v[1],explode:!!v[3],maxlength:v[4]&&parseInt(v[4],10)}}if(!q.length)throw Error('Expression Missing Variable(s) "'+l[0]+'"');k.push({expression:l[0],operator:l[1],variables:q})}k.length||k.push(d);this.parts=k;return this};j.prototype.get=function(f){var c=this.data,g={type:0,val:[],encode:[],encodeReserved:[]},
