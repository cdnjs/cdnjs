...
b+="@");return b};d.buildQuery=function(a,b){var e="",s,c,h,f;for(c in a)if(n.call(a,c)&&c)if(u(a[c])){s={};h=0;for(f=a[c].length;h<f;h++)void 0!==a[c][h]&&void 0===s[a[c][h]+""]&&(e+="&"+d.buildQueryParameter(c,a[c][h]),!0!==b&&(s[a[c][h]+""]=!0))}else void 0!==a[c]&&(e+="&"+d.buildQueryParameter(c,a[c]));return e.substring(1)};d.buildQueryParameter=function(a,b){return d.encodeQuery(a)+(null!==b?"="+d.encodeQuery(b):"")};d.addQuery=function(a,b,e){if("object"===typeof b)for(var c in b)n.call(b,
...
this._deferred_build=!1;return this};c.clone=function(){return new d(this)};c.valueOf=c.toString=function(){return this.build(!1)._string};p={protocol:"protocol",username:"username",password:"password",hostname:"hostname",port:"port"};r=function(a){return function(b,e){if(void 0===b)return this._parts[a]||"";this._parts[a]=b;this.build(!e);return this}};for(k in p)c[k]=r(p[k]);p={query:"?",fragment:"#"};r=function(a,b){return function(e,d){if(void 0===e)return this._parts[a]||"";null!==e&&(e+="",
e[0]===b&&(e=e.substring(1)));this._parts[a]=e;this.build(!d);return this}};for(k in p)c[k]=r(k,p[k]);p={search:["?","query"],hash:["#","fragment"]};r=function(a,b){return function(e,d){var c=this[a](e,d);return"string"===typeof c&&c.length?b+c:c}};for(k in p)c[k]=r(p[k][1],p[k][0]);c.pathname=function(a,b){if(void 0===a||!0===a){var e=this._parts.path||(this._parts.urn?"":"/");return a?d.decodePath(e):e}this._parts.path=a?d.recodePath(a):"/";this.build(!b);return this};c.path=c.pathname;c.href=function(a,
b){var e;if(void 0===a)return this.toString();this._string="";this._parts=d._parts();var c=a instanceof d,h="object"===typeof a&&(a.hostname||a.path);!c&&(h&&"[object Object]"!==Object.prototype.toString.call(a))&&(a=a.toString());if("string"===typeof a)this._parts=d.parse(a,this._parts);else if(c||h)for(e in c=c?a._parts:a,c)n.call(this._parts,e)&&(this._parts[e]=c[e]);else throw new TypeError("invalid input");this.build(!b);return this};c.is=function(a){var b=!1,e=!1,c=!1,h=!1,f=!1,g=!1,n=!1,k=
...
h;d.decode=unescape;this.normalize();d.encode=a;d.decode=b;return this};c.readable=function(){var a=this.clone();a.username("").password("").normalize();var b="";a._parts.protocol&&(b+=a._parts.protocol+"://");a._parts.hostname&&(a.is("punycode")&&f?(b+=f.toUnicode(a._parts.hostname),a._parts.port&&(b+=":"+a._parts.port)):b+=a.host());a._parts.hostname&&(a._parts.path&&"/"!==a._parts.path[0])&&(b+="/");b+=a.path(!0);if(a._parts.query){for(var c="",h=0,g=a._parts.query.split("&"),n=g.length;h<n;h++){var k=
