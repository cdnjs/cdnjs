  ...
  interact(p1) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (!p1.repulse) {
        ...
        p1.repulse = {
          distance: (0, tsparticles_engine_1.getRangeValue)(repulseOpt1.distance),
      ...
      for (const p2 of query) {
        ...
        const {
          ...
          dy,
          distance
        } = (0, tsparticles_engine_1.getDistances)(pos2, pos1);
...
const Repulser_1 = __webpack_require__(573);
