!function(a, b) {
    ...
    Jodit.prototype.setMode = function(b) {
        var d = {
            mode: b
        }, e = this, f = [ "jodit_wysiwyg_mode", "jodit_area_mode", "jodit_split_mode" ], g = e.mode;
        if (false === e.events.fire("beforeSetMode", [ d ])) return;
        e.syncCode();
        e.mode = a.inArray(d.mode, [ Jodit.MODE_TEXTAREA, Jodit.MODE_WYSIWYG, Jodit.MODE_SPLIT ]) !== -1 ? d.mode : Jodit.MODE_WYSIWYG;
        e.$toolbar.children().each(function(b, c) {
            var d, f = c.control;
            d = void 0 === f || void 0 === f.mode ? Jodit.MODE_WYSIWYG : f.mode;
            a(c).toggleClass("disabled", d !== Jodit.MODE_SPLIT && d !== e.mode);
        });
        e.$wysiwyg.removeClass(f).addClass(f[e.mode - 1]);
        c[c.length] = setTimeout(function() {
            if (e.getMode() === Jodit.MODE_WYSIWYG && (g === Jodit.MODE_TEXTAREA || e.options.autofocus)) {
                e.$editor.focus();
                if (e.$editor.find("p").length) e.selection.moveToCursorPosition(e.$editor.find("p")[0]); else e.selection.moveToCursorPosition(e.editor);
            } else if (e.getMode() === Jodit.MODE_TEXTAREA && (g === Jodit.MODE_WYSIWYG || e.options.autofocus)) e.$area[0].focus();
        }, 300);
        if (e.mode !== Jodit.MODE_TEXTAREA) {
            if (e.observer) e.observer.changed();
        } else if (e.observerarea) e.observerarea.changed();
        e.events.fire("afterSetMode");
    };
    ...
    Jodit.prototype.syncCode = function() {
        ...
        if (!a.val() || "" === a.helper.clear(a.$editor.text()) && !a.$editor.find("img,table,hr,button,input").length) a.placeholder.show(); else {
            a.placeholder.hide();
            this.observe();
        }
    ...
    Jodit.prototype.observe = function() {
        ...
        this.$editor.find("img, table").each(a.proxy(function(b, c) {
            ...
            if ("TABLE" === c.tagName) if (this.options.useTableProcessor && !a(c).data("table-processor") && void 0 !== Jodit.modules.TableProcessor) {
                d = new Jodit.modules.TableProcessor(this, c);
                this.tableprocessor.instances.push(d);
                a(c).data("table-processor", d);
            }
            if ("IMG" === c.tagName) if (this.options.useImageProcessor && !a(c).data("image-processor") && void 0 !== Jodit.modules.ImageProcessor) {
                d = new Jodit.modules.ImageProcessor(this, c);
                this.imageprocessor.instances.push(d);
                a(c).data("image-processor", d);
            }
        }, this));
    ...
    Jodit.prototype.setElementValue = function(a) {
        ...
        if (b !== c) {
            if (this.options.triggerChangeEvent) this.$element.trigger("change");
            this.events.fire("changeElementValue");
        }
        return c;
    };
    Jodit.prototype.closeToolbarPopap = function() {
        if (this.$toolbar_popap.is(":visible") || this.$toolbar.find(".jodit_dropdownlist").is(":visible")) {
    ...
    Jodit.prototype.loadModules = function(b) {
        ...
        if (d.length) {
            for (c = 0; c < d.length; c += 1) if (!this[d[c].toLowerCase()] && "Dom" !== d[c]) this[d[c].toLowerCase()] = new Jodit.modules[d[c]](this);
    ...
    Jodit.prototype.build = function() {
        ...
        b.$workflow.append(b.$wysiwyg_flow).append(b.$area_flow).append(b.$progress_bar);
        ...
        if (b.options.iframe) {
            ...
            f.write('<html class="jodit"><head></head><body class="jodit_editor" style="outline:none" contenteditable="true"></body></html>');
            f.close();
            b.$editor = a(f.body);
            if (b.options.iframeCSSLinks) b.options.iframeCSSLinks.forEach(function(b) {
                var c = a('<link rel="stylesheet" href="' + b + '">', f).get(0);
                f.head.appendChild(c);
            });
            if (b.options.iframeStyle) {
                e = f.createElement("style");
                e.innerHTML = b.options.iframeStyle;
                b.getDocument().head.appendChild(e);
            }
            b.$iframe.css({
        ...
        if (b.options.editorCssClass) b.$editor.addClass(b.options.editorCssClass);
        b.editor = b.$editor.get(0);
        b.buildToolbar();
        b.loadModules();
        b.val(b.$element.val());
        b.$element.hide();
        a(window).on("resize." + "jodit_" + b.id + " scroll." + "jodit_" + b.id, function(a) {
    ...
    Jodit.prototype.destroy = function() {
        ...
        this.destroyModules();
        a(window).off("." + "jodit_" + this.id).off(".jodit" + this.id);
        this.$wysiwyg.remove();
        delete this.$wysiwyg;
        this.$element.show();
        this.$element.removeData("jodit");
        delete Jodit.editors[this.id];
    };
    Jodit.editors = {};
    ...
    Jodit.prototype.i18n = function(a) {
        var b, c = Array.prototype.slice.call(arguments), d = function(a) {
        ...
        if (void 0 !== this.options && void 0 !== Jodit.lang[this.options.language]) b = Jodit.lang[this.options.language]; else if (void 0 !== Jodit.lang[Jodit.defaultOptions.language]) b = Jodit.lang[Jodit.defaultOptions.language]; else b = Jodit.lang.en;
        if (void 0 !== this.options && void 0 !== this.options.i18n[this.options.language] && this.options.i18n[this.options.language][a]) return d(this.options.i18n[this.options.language][a]);
        if (void 0 !== b[a]) return d(b[a]);
        if (void 0 !== Jodit.lang.en[a]) return d(Jodit.lang.en[a]);
        return d(a);
    };
...
!function() {
        ...
        var c, d = [], e = document, g = /[\s]+/, h = Array.prototype.slice, i = function(a) {
            ...
            var d = this, e, h, j, k, l = function() {
                var g = this, h = function(a, b) {
                    ...
                    var i = g, j = window.performance.now();
                    e.start = function() {
                        var a = window.performance.now() - j;
                        j = window.performance.now();
                        return a;
                    };
                    e = e || window.event;
                    e.originalEvent = e;
                    if (void 0 === e.which && void 0 !== e.keyCode) e.which = e.keyCode;
                    if (void 0 === e.target) e.target = e.srcElement;
                    if (b) {
                        i = false;
                    ...
                    e.jodit_events = a;
                    if (i && c && f.isFunction(c) && false === c.call(i, e)) {
                        e.preventDefault();
                        return false;
                    }
                };
            ...
            var b = false, c;
            if (":visible" === a) {
                for (c = 0; c < d.length; c += 1) if (d[c].offsetWidth || d[c].offsetHeight) return true;
                return false;
            }
            ...
            if (/^#/.test(f.trim(a)) || /^(script|link|img|div|h[1-6]|p|table|tr|tbody|thead|tfoot|td|th|span|strong|ul|li|ol|a|body|label|option|select|input|button|textarea|i|b|strike|font|hr)(\s|\t|\n|$|>|:|\.|\#|\[)/i.test(f.trim(a)) || /^\./.test(f.trim(a)) || /^\>/.test(f.trim(a))) {
    ...
    f.ajax = function(a) {
        ...
        if (a.headers) f.each(a.headers, function(a, c) {
            ...
            ul: {
                ...
                exec: function(b, c) {
                    ...
                    if (this.node.hasParent(e, "p")) {
                        ...
                        this.node.replace(g, f, true, true);
            ...
            table: {
                ...
                popap: function(b, c) {
                    ...
                    i.on("mousedown", "div", function(a) {
                        ...
                        d.selection.moveToCursorPosition(c);
                        d.closeToolbarPopap();
                        d.syncCode();
                    });
                    return i;
...
!function(a) {
    ...
    Jodit.modules.Selection = function(b) {
        var c = {}, d = b.getDocument(), e = b.getWindow(), f = b.$editor, g = function() {
            ...
            q(f[0]);
            b.events.fire("afterInsertImage", [ f[0] ]);
        }, t = function(a) {
            var b = d.createRange();
            b.selectNode(a);
            j();
            ...
            var e = f.find('.jodit_marker[data-start="1"]'), h, i, k, l, m, n, o, p, q, r, s, t = false, u;
            y = false;
...
!function(a) {
    ...
    Jodit.modules.Dialog = function(b, c) {
        var d, e = a.extend({}, Jodit.defaultOptions.dialog, b && b.options ? b.options.dialog : {}, c), f = a('<div style="z-index:' + e.zIndex + '" class="jodit jodit_dialog_box">' + '<div class="jodit_dialog_overlay"></div>' + '<div class="jodit_dialog">' + '<div class="jodit_dialog_header non-selected">' + '<h4></h4><a href="javascript:void(0)" title="Close" class="jodit_close">&times;</a>' + "</div>" + '<div class="jodit_dialog_content"></div>' + '<div class="jodit_dialog_footer"></div>' + (e.resizable ? '<div class="jodit_dialog_resizer"><i class="icon icon-resize"></i></div>' : "") + "</div>" + "</div>"), g, h, i = document.body, j = false, k = f.find(".jodit_dialog"), l = f.find(".jodit_dialog_resizer"), m = false, n = function() {
            ...
            a(".jodit_dialog_box").each(function() {
                ...
                d = parseInt(this.style.zIndex || 0, 10);
                if (c.isOpened() && d > b) {
                    e = c;
                    b = d;
                }
            ...
            if (b && b.events) if (false === b.events.fire(d, "beforeOpen")) return;
            j = true === e;
            if (void 0 !== c) r(c);
            if (a) s(a);
            f.addClass("active");
            ...
            q(g, h);
            v();
            if (b && b.events) b.events.fire(d, "afterOpen");
        }, x = function() {
            ...
            if (z || y) {
                z = false;
                y = false;
                if (b && b.events) b.events.fire(d, "endResize endMove");
            }
        }, E = function(a) {
            ...
            v();
            a.preventDefault();
            if (b && b.events) b.events.fire(d, "startMove");
        }, F = function(a) {
            if (z && e.draggable) {
                q(C.x + a.clientX - A, C.y + a.clientY - B);
                if (b && b.events) b.events.fire(d, "move", [ a.clientX - A, a.clientY - B ]);
                a.stopImmediatePropagation();
                a.preventDefault();
            }
            if (y && e.resizable) {
                p(C.w + a.clientX - A, C.h + a.clientY - B);
                if (b && b.events) b.events.fire(d, "resizeDialog", [ a.clientX - A, a.clientY - B ]);
                a.stopImmediatePropagation();
                a.preventDefault();
            }
        }, G, H, I = function() {
            ...
            if (b && b.events) b.events.fire(d, "beforeClose");
    ...
    Jodit.Promt = function(b, c, d, e) {
        var f = new Jodit.modules.Dialog(), g, h, i = a('<form class="jodit_promt"></form>'), j = a('<input autofocus="true" type="text"/>'), k = a("<label></label>");
        if (e) j.attr("placeholder", e);
        k.html(b);
        i.append(k);
        i.append(j);
        g = a('<a href="javascript:void(0)" style="float:right;" class="jodit_button"><i class="icon icon-cancel"></i>&nbsp;' + Jodit.prototype.i18n("Cancel") + "</a>").on("click", f.close);
        h = a('<a href="javascript:void(0)" style="float:left;" class="jodit_button"><i class="icon icon-check"></i>&nbsp;' + Jodit.prototype.i18n("Ok") + "</a>");
        h.on("click", function() {
            if (d) d(j.val());
            f.close();
        });
        ...
        f.setFooter([ h, g ]);
        f.open(i, c || "&nbsp;", true, true);
        g[0].focus();
    };
    Jodit.Confirm = function(b, c, d) {
        var e = new Jodit.modules.Dialog(), f, g, h = a('<form class="jodit_promt"></form>'), i = a("<label></label>");
        i.html(b);
        h.append(i);
        f = a('<a href="javascript:void(0)" style="float:right;" class="jodit_button"><i class="icon icon-cancel"></i>&nbsp;' + Jodit.prototype.i18n("Cancel") + "</a>").on("click", function() {
            if (d) d(false);
            e.close();
        });
        g = a('<a href="javascript:void(0)" style="float:left;" class="jodit_button"><i class="icon icon-check"></i>&nbsp;' + Jodit.prototype.i18n("Yes") + "</a>").on("click", function() {
            if (d) d(true);
            e.close();
        });
...
!function(a) {
    ...
    Jodit.modules.EnterKey = function(b) {
        var c, d = b.getDocument(), e = function() {
            ...
            if (b.$editor.find("img.jodit_focused_image").length) {
                b.$editor.find("img.jodit_focused_image").remove();
                return false;
            }
    ...
    Jodit.modules.Events = function(b) {
        var c = {}, d, e = [], f = function() {
            ...
            for (h = 0; h < f.length; h += 1) {
                if (void 0 === c.handlers[f[h]]) continue;
                e.push(f[h]);
                for (i = 0; i < c.handlers[f[h]].length; i += 1) {
                    d = f[h];
                    if (false === c.handlers[f[h]][i].apply(c, g || [])) j = false;
                }
                e.pop();
            }
            return j;
...
!function(a) {
    ...
    Jodit.modules.FileBrowser = function(b) {
        var c = {}, d = b.options.filebrowser, e = "", f = false, g = new Jodit.modules.Dialog(b), h = a('<div class="jodit_filebrowser_loader"><i class="icon-loader"></i></div>'), i = a('<div class="jodit_filebrowser non-selected">' + '<div class="jodit_filebrowser_tree"></div>' + '<div class="jodit_filebrowser_files"></div>' + '<div class="jodit_filebrowser_status"></div>' + "</div>"), j = i.find(".jodit_filebrowser_status"), k = {
            ...
            if (d.isSuccess(c)) s(b.i18n("Files [1$] was uploaded", a.files.join(",")), true); else s(d.getMsg(c));
            y();
        }, I = function() {
...
!function(a) {
    ...
    Jodit.modules.Form = function(b) {
        var c, d, e = function(c, d) {
            ...
            var g = {}, h, i;
            if (c.upload && b.options.uploader && b.options.uploader.url) {
...
!function(a) {
    ...
    Jodit.modules.ImageProcessor = function(b, c) {
        ...
        var d, e = b.id + "_image_" + Jodit.modules.TableProcessor.unique, f = false, g = function() {
            if (d.instances && d.instances.length) d.instances.forEach(function(a) {
                a.destroy();
            });
            a(b.getDocument()).off(".jodit" + e);
            a(b.getWindow()).off(".jodit" + e);
        }, h = function(c) {
            return {
...
!function(a) {
    ...
    Jodit.modules.Observer = function(b) {
        var c, d = new Undo.Stack(), e = false, f = b.editor, g, h, i, j, k, l, m = [], n, o = function(a) {
            if (true === a || false === a) e = a; else if (1 === a) {
                n = e;
                e = true;
            } else if (0 === a) e = void 0 !== n ? n : false;
...
!function(a) {
    ...
    Jodit.modules.ObserverArea = function(b) {
        var c = {}, d = new Undo.Stack(), e = false, f, g, h, i, j, k, l, m = b.area, n = function(a) {
            ...
            undo: function() {
                c.block(true);
                b.setAreaValue(this.oldValue);
                o(this.selectionStart.start, this.selectionStart.end);
                b.events.fire("updateStackEditor");
            },
            redo: function() {
                c.block(true);
                b.setAreaValue(this.newValue);
                o(this.selectionSecond.start, this.selectionSecond.end);
                b.events.fire("updateStackEditor");
            }
        }), q = function() {
            if (b.getRealMode() === Jodit.MODE_TEXTAREA) {
...
!function(a) {
    ...
    Jodit.modules.Placeholder = function(b) {
        var c, d, e = function() {
            ...
            var c = 0, e = 0, f = 0, g = 0;
            if (b.$editor[0].firstChild && b.$editor[0].firstChild.nodeType === Node.ELEMENT_NODE) {
                c = a(b.$editor[0].firstChild).css("margin-top");
                e = a(b.$editor[0].firstChild).css("margin-left");
                f = a(b.$editor[0].firstChild).css("padding-top");
                g = a(b.$editor[0].firstChild).css("padding-left");
                d.css({
            ...
            d = a('<span class="jodit_placeholder">' + b.i18n(b.options.placeholder) + "</span>");
            if (b.options.useInputsPlaceholder && b.element.hasAttribute("placeholder")) d.html(b.$element.attr("placeholder"));
            b.$workflow.append(d);
            f();
        };
        c = {
...
!function(a) {
    ...
    Jodit.modules.TableProcessor = function(b, c) {
        ...
        var d, e = b.id + "_" + Jodit.modules.TableProcessor.unique, f = b.options.tableprocessor.accuracy, g = a(c), h = function() {
            ...
            return h;
        }, j = false, k = false, l = false, m = function(a, b) {
            var c, d, e, f, m, n, o = l && j ? j : [], p = i(), q = h(), r = l && k ? k : g.find("td,th"), s = r.get(0), t = 0, u = function(b, c, d, g) {
                if (void 0 === o[b]) o[b] = [];
                o[b][c] = d;
                ...
                m = 0;
                e = 0;
                if (d.hasAttribute("colspan")) m = parseInt(d.getAttribute("colspan"), 10);
                if (d.hasAttribute("rowspan")) e = parseInt(d.getAttribute("rowspan"), 10);
                if (m > 1 || e > 1) {
                    f = b;
                    n = c;
                    while (f < b + e - 1 || n < c + m - 1) {
                        if (n < c + m - 1) n += 1; else {
                            n = c;
                            f += 1;
                        }
                        if (false === u(f, n, d, true)) return false;
                    }
                }
            };
            if (l && !k) k = r;
            for (c = 0; c < q; c += 1) for (d = 0; d < p; d += 1) if (void 0 === o[c] || void 0 === o[c][d]) {
                if (false === u(c, d, s)) return s;
                t += 1;
                s = r[t];
            } else if (a && false === a(c, d, o[c][d])) return o[c][d];
            j = o;
            return o;
        }, n = function(a, b) {
            var c, d, e = false;
            ...
            var a = p(), b = 0, c = 1e6, d, e, f = 0, g = 1e6;
            if (a.length) {
                a.each(function(a, h) {
                    var i = n(h);
                    d = 0;
                    ...
                    if (h.hasAttribute("colspan")) {
                        d = parseInt(h.getAttribute("colspan"), 10);
                        if (d) d -= 1;
                    }
                    if (h.hasAttribute("rowspan")) {
                        e = parseInt(h.getAttribute("rowspan"), 10);
                        if (e) e -= 1;
                    }
                    b = Math.max(i[1] + d, b);
                    c = Math.min(i[1], c);
            ...
            p().each(function(b, d) {
                var e = m(), f = n(d, 2), g;
                for (g = 0; g < e.length; g += 1) if (!c) if (f[1] + 1 >= e[g].length || e[g][f[1]] !== e[g][f[1] + 1]) a(e[g][f[1]]).after("<td><br/></td>"); else r(e[g][f[1]], "colspan", parseInt(e[g][f[1]].getAttribute("colspan"), 10) + 1); else if (f[1] - 1 < 0 || e[g][f[1]] !== e[g][f[1] - 1]) a(e[g][f[1]]).before("<td><br/></td>"); else r(e[g][f[1]], "colspan", parseInt(e[g][f[1]].getAttribute("colspan"), 10) + 1);
                s();
            });
            ...
            p().each(function(d, e) {
                var f = m(), h = n(e, 2), i, j = a("<tr></tr>", b.getDocument(), b.getDocument()).get(0);
                for (i = 0; i < f[0].length; i += 1) if (!c) if (h[0] + 1 >= f.length || f[h[0]][i] !== f[h[0] + 1][i]) u(j, "<br>"); else r(f[h[0]][i], "rowspan", parseInt(f[h[0]][i].getAttribute("rowspan"), 10) + 1); else if (h[0] - 1 < 0 || f[h[0]][i] !== f[h[0] - 1][i]) u(j, "<br>"); else r(f[h[0]][i], "rowspan", parseInt(f[h[0]][i].getAttribute("rowspan"), 10) + 1);
            ...
            p().each(function(a, b) {
                var c = n(b), d;
                d = m();
                for (a = 0; a < d.length; a += 1) if (c[1] - 1 >= 0 && d[a][c[1] - 1] === d[a][c[1]]) r(d[a][c[1] - 1], "colspan", parseInt(d[a][c[1] - 1].getAttribute("colspan"), 10) - 1); else if (c[1] + 1 < d[0].length && d[a][c[1] + 1] === d[a][c[1]]) r(d[a][c[1]], "colspan", parseInt(d[a][c[1]].getAttribute("colspan"), 10) - 1); else r(d[a][c[1]], "remove");
                s();
            });
        }, y = function() {
            var c = [];
            ...
            p().each(function(b, d) {
                var e = n(d), f, g, h, i = d.parentNode, j;
                if (c[e[0]]) return;
                c[e[0]] = true;
                g = m();
                for (f = 0; f < g[0].length; f += 1) if (e[0] - 1 >= 0 && g[e[0] - 1][f] === g[e[0]][f]) r(g[e[0] - 1][f], "rowspan", parseInt(g[e[0] - 1][f].getAttribute("rowspan"), 10) - 1); else if (e[0] + 1 < g.length && g[e[0] + 1][f] === g[e[0]][f]) {
                    h = f + 1;
                    j = false;
                    while (h < g[0].length && !j) {
                        if (g[e[0] + 1][h] !== g[e[0]][f] && i !== g[e[0] + 1][h].parentNode) {
                            r(g[e[0]][f], "rowspan", parseInt(g[e[0]][f].getAttribute("rowspan"), 10) - 1);
                            r(g[e[0]][f], "before", g[e[0] + 1][h]);
                            j = true;
                        }
                        h += 1;
                    }
                    if (!j) r(g[e[0]][f], "append", a(i).next());
                }
                s();
                a(i).remove();
            });
            ...
            for (h = 0; h < i.length; h += 1) if (i[h][b] !== i[h][d ? b - 1 : b + 1]) {
                ...
                k = (j + c) / g.outerWidth() * 100;
                r(i[h][b], "width", k.toFixed(f) + "%");
            }
            if (!e) s();
        }, A = function() {
            var a, b, c, d, e, f;
            ...
            for (c = 0; c < a[0].length; c += 1) {
                ...
                if (!f) for (b = 0; b < a.length; b += 1) r(a[b][c], "colspan", d - e);
            }
            ...
            s();
            a = m();
            for (c = 0; c < a[0].length; c += 1) z(c, 0, false, true);
            s();
        }, B = function() {
            var b = q(), c = 0, d, e, h, i = [], j = 0, k = 0, l, n;
            if (b && (b[0] - b[2] || b[1] - b[3])) {
                m(function(f, g, m) {
                    if (f >= b[0] && f <= b[2]) if (g >= b[1] && g <= b[3]) {
                        ...
                        if ("" !== a.trim(m.innerHTML.replace(/<br(\/)?>/g, ""))) i.push(m.innerHTML + "<br/>");
                        l = 0;
                        n = 0;
                        if (m.hasAttribute("colspan")) l = parseInt(m.getAttribute("colspan"), 10);
                        if (m.hasAttribute("rowspan")) n = parseInt(m.getAttribute("rowspan"), 10);
                        if (l > 1) j += l - 1;
                        if (n > 1) k += n - 1;
                        if (!d) {
                            d = a(m);
                ...
                if (k > 1) d.attr("rowspan", k);
                r(d, "width", (c / g.outerWidth() * 100).toFixed(f) + "%");
            ...
            p().each(function(i, j) {
                h = a(j);
                b = n(h.get(0));
                if (!h.attr("colspan") || parseInt(h.attr("colspan"), 10) < 2) m(function(a, c, d) {
                    if (b[1] === c && b[0] !== a && d !== h.get(0)) r(d, "colspan", d.hasAttribute("colspan") ? parseInt(d.getAttribute("colspan"), 10) + 1 : 2);
                }); else r(h, "colspan", parseInt(h.attr("colspan"), 10) - 1);
                c = a("<td><br/></td>");
                if (h.attr("rowspan")) r(c, "rowspan", h.attr("rowspan"));
                h.after(c);
                d = h.outerWidth();
                e = d / g.outerWidth() / 2;
                r(h, "width", (100 * e).toFixed(f) + "%");
                r(c, "width", (100 * e).toFixed(f) + "%");
                s();
            ...
            p().each(function(i, j) {
                ...
                if (!h.attr("rowspan") || parseInt(h.attr("rowspan"), 10) < 2) {
                    m(function(a, c, d) {
                        if (b[0] === a && b[1] !== c && d !== h.get(0)) r(d, "rowspan", d.hasAttribute("rowspan") ? parseInt(d.getAttribute("rowspan"), 10) + 1 : 2);
                    });
                    h.closest("tr").after(d);
                    d.append(c);
                } else {
                    r(h, "rowspan", parseInt(h.attr("rowspan"), 10) - 1);
                    m(function(c, d, i) {
                ...
                if (h.attr("colspan")) r(c, "colspan", h.attr("colspan"));
                s();
                h.removeClass("jodit_focused_cell");
            });
            A();
            ...
            var d, f, h, i, j, k, l, p, q, r;
            if (!G) {
                G = a('<div class="border_resizer">' + "<div></div>" + "</div>");
                G.on("mousedown", function(c) {
                    d = true;
                    r = false;
                    f = parseInt(c.clientX, 10);
                    p = parseInt(G.css("left"), 10);
                    G.addClass("border_resizer_clicked");
                    b.$editor.addClass("non-selected");
                    i = n(G.targets[0], true);
                    j = n(G.targets[1]);
                    k = 1e8;
                    l = 0;
                    m(function(c, d, e) {
                        if (d === i[1]) k = Math.min(b.helper.offset(a(e)).left, k);
                        if (d === j[1]) l = Math.max(b.helper.offset(a(e)).left + a(e).outerWidth(), l);
                    });
                });
                a(b.getDocument()).off(".jodit-border-resizer" + e).on("mousemove.jodit-border-resizer" + e, function(a) {
                    ...
                    if (d) {
                        ...
                        if (p + q > k + b.options.tableprocessor.resizerOffset && p + q < l - b.options.tableprocessor.resizerOffset) G.css("left", p + q + "px");
                    }
                    ...
                    if (d && G.is(":visible")) {
                        G.removeClass("border_resizer_clicked");
                        G.hide();
                    }
                    if (r) {
                        p = parseInt(G.css("left"), 10);
            ...
            g.off(".jodit-border-resizer").on("mousemove.jodit-border-resizer", "td,th", function(c) {
                ...
                if (!G.hasClass("border_resizer_clicked") && ("TD" === d.tagName || "TH" === d.tagName)) {
                    e = a(d).offset();
                    h = a(d).outerWidth();
                    if (Math.abs(e.left - c.clientX) < 10 && a(d).prev().length || Math.abs(e.left + h - c.clientX) < 10 && a(d).next().length) {
                        G.target = a(d);
                        G.$table = a(d).closest("table");
                        G.targets = [];
                        if (Math.abs(e.left - c.clientX) < 10) {
                            i = n(d);
                            G.targets[0] = o(i[0], i[1] - 1);
                            G.targets[1] = d;
                        } else {
                            i = n(d, true);
                            G.targets[0] = d;
                            G.targets[1] = o(i[0], i[1] + 1);
                        }
                        G.css({
                            display: "block",
            ...
            var e = c.target || c.srcElement, f, h, i, j, k, n;
            n = m();
            ...
            if (!c.shiftKey && !l) {
                ...
                f = q();
                for (i = f[0]; i <= f[2]; i += 1) for (h = f[1]; h <= f[3]; h += 1) a(n[i][h]).addClass("jodit_focused_cell");
                if (!d) return K(c, true);
            }
            if (p().length) {
                j = n[f[2]][f[3]];
                k = n[f[2]][f[1]];
                b.events.fire("showPopap", [ g.get(0), b.helper.offset(k).left + Math.round((b.helper.offset(j).left + a(j).outerWidth() - b.helper.offset(k).left) / 2), b.helper.offset(j).top + a(j).outerHeight() ]);
            }
        };
        if (c) {
            I();
            g.on("dragstart", "td,th", function(a) {
                ...
                if (l && J !== c) {
                    p().removeClass("jodit_focused_cell");
                    a(J).addClass("jodit_focused_cell");
                    b.start();
                    K(b);
                    console.log("select " + " - " + b.start());
                    b.preventDefault();
                }
            });
...
!function(a) {
    ...
    Jodit.modules.Uploader = function(b, c) {
        ...
        var d = "", e = c || b.options.uploader, f = function(b) {
            ...
            e.prepareData(l);
            if (i) i(l);
            if (e.data && a.isPlainObject(e.data)) {
                n = Object.keys(e.data);
                for (k = 0; k < n.length; k += 1) l.append(n[k], e.data[n[k]]);
            }
            g(l, function(c) {
            ...
            c.on("paste", function(a) {
                ...
                if (a.clipboardData && a.clipboardData.files && a.clipboardData.files.length) {
                    h(a.clipboardData.files, d, f);
                    return false;
                }
                if (b.browser("ff")) {
                    if (!a.clipboardData.types.length && "text/plain" !== a.clipboardData.types[0]) {
            ...
            if (b.editor) if (b.options.enableDragAndDropFileToEditor && b.options.uploader && b.options.uploader.url) k(b.$editor);
        };
        return {
            init: l,
            bind: k,
    ...
    Jodit.plugins.codeMirror = function(b) {
        if (b.options.codeMirror) {
            var c, d = false, e = "jodit_codemirror", f = function() {
                if (!d && c && b.getRealMode() === Jodit.MODE_TEXTAREA) {
                    b.val(c.getValue());
                    b.$area.trigger("updatestack");
                }
            }, g = function(a, b) {
            ...
            b.events.on("afterResize changeElementValue", function() {
                if (c && b.getMode() === Jodit.MODE_SPLIT) c.setSize(null, b.$editor.outerHeight());
            });
            b.events.on("afterSetMode afterResize", function() {
                ...
                var d = function() {
                    ...
                    if (c) {
                        c.setSize(null, b.$editor.outerHeight());
            ...
            if (void 0 === window.CodeMirror && !a("script." + e).length) {
                g(b.options.codeMirrorUrlJS, function() {
...
Jodit.lang.de = {
    ...
    "contains detailed help for using": "ausf\xfchrliche Hilfe enth\xe4lt f\xfcr die Verwendung von",
    "For information about the license, please go to our website:": "F\xfcr Informationen \xfcber die Lizenz, gehen Sie bitte auf unsere Webseite:",
    "Buy full version": "Vollversion kaufen",
    "Copyright \xa9 XDSoft.net - Chupurnov Valeriy. All rights reserved.": "Copyright \xa9 XDSoft.net - Chupurnov Valeriy. Alle Rechte vorbehalten.",
    Anchor: "Anker",
    "Open in new tab": "In neuer Registerkarte \xf6ffnen",
    "Open editor in fullsize": "Editor \xf6ffnen in voller Gr\xf6\xdfe",
    "Clear Formatting": "Formatierung l\xf6schen",
    "Fill color or set the text color": "F\xfcllen Sie Farbe oder stellen Sie die Textfarbe",
    Redo: "Redo",
    Undo: "R\xfcckg\xe4ngig machen",
    Bold: "Fett gedruckt",
    Italic: "Kursiv",
    "Insert Unordered List": "Ungeordnete Liste einf\xfcgen",
    "Insert Ordered List": "Legen Sie Sortierte Liste",
    "Justify Center": "einmitten",
    "Justify Full": "Begr\xfcnden Voll",
    "Justify Left": "Begr\xfcnden links",
    "Justify Right": "Begr\xfcnden Rechts",
    ...
    Link: "Link",
    "Open link in new tab": "Link in neuem Tab \xf6ffnen",
    Image: "Image",
    Advansed: "Erweiterte",
    ...
    Middle: "Mitte",
    Bottom: "Boden",
    "Insert column before": "Spalte einf\xfcgen vor",
    "Insert column after": "Spalte einf\xfcgen nach",
    "Insert row above": "Zeile einf\xfcgen oben",
    "Insert row below": "Zeile unterhalb einf\xfcgen",
...
Jodit.lang.ru = {
    ...
    "Copyright \xa9 XDSoft.net - Chupurnov Valeriy. All rights reserved.": "\u0410\u0432\u0442\u043e\u0440\u0441\u043a\u0438\u0435 \u043f\u0440\u0430\u0432\u0430 \xa9 XDSoft.net - \u0427\u0443\u043f\u0443\u0440\u043d\u043e\u0432 \u0412\u0430\u043b\u0435\u0440\u0438\u0439. \u0412\u0441\u0435 \u043f\u0440\u0430\u0432\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043d\u044b.",
    Anchor: "\u0410\u043d\u043a\u043e\u0440",
