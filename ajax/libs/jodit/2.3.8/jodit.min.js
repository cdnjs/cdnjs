...
!function(a) {
    ...
    Jodit.modules.Events = function(b) {
        var c = {}, d, e = function() {
            ...
            e = e.split(/[\s,]+/);
            for (g = 0; g < e.length; g += 1) {
                if (void 0 === c.handlers[e[g]]) continue;
                for (h = 0; h < c.handlers[e[g]].length; h += 1) {
                    d = e[g];
                    if (false === c.handlers[e[g]][h].apply(c, f || [])) i = false;
                }
            }
            return i;
        };
    ...
    Jodit.plugins.codeMirror = function(b) {
        if (b.options.codeMirror) {
            var c, d = false, e = "jodit_codemirror", f = function() {
                if (!d && c && a.inArray(b.getMode(), [ Jodit.MODE_TEXTAREA, Jodit.MODE_SPLIT ]) !== -1) {
                    b.val(c.getValue());
