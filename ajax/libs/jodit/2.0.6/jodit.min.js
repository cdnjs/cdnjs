...
!function() {
    ...
    var a = {}, b = a.toString, c = a.hasOwnProperty, d = [], e = d.indexOf, f = function(a, b) {
        var c, d = [], e = document, g = /[\s]+/, h = Array.prototype.slice, i = function(a) {
            ...
            if ("string" === D(a)) {
                d = (b.createElement ? b : e).createElement("div");
                d.innerHTML = a;
                g = d.firstChild;
                while (g) {
                    c.push(g);
...
!function(a) {
    ...
    Jodit.plugins.codeMirror = function(b) {
        if (b.options.codeMirror) {
            var c, d = "jodit_codemirror", e = function() {
                if (c && b.getMode() === Jodit.MODE_TEXTAREA) b.val(c.getValue());
            }, f = function(a) {
            ...
            if (void 0 === window.CodeMirror && !a("script." + d).length) {
                f(b.options.codeMirrorUrlJS);
                setTimeout(function() {
                    f(b.options.codeMirrorXMLUrl);
                }, 400);
