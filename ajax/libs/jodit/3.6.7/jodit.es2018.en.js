...
const isHTML = (str) => (0,is_string/* isString */.H)(str) && /<([A-Za-z][A-Za-z0-9]*)\b[^>]*>(.*?)<\/\1>/m.test(str);
...
var valign = __webpack_require__(126);
// EXTERNAL MODULE: ./src/styles/icons/video.svg
var icons_video = __webpack_require__(127);
