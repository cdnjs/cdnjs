    ...
    Jodit.prototype.i18n = function(a) {
        var b = void 0 !== Jodit.lang[this.options.language] ? Jodit.lang[this.options.language] : Jodit.lang.en, c = Array.prototype.slice.call(arguments), d = function(a) {
            return a.replace(/([0-9]{1})\$/gm, function(a) {
                a[1] = parseInt(a[1], 10);
                if (void 0 !== c[a[1]]) return c[a[1]]; else return "";
            });
        };
        if (void 0 !== this.options.i18n[this.options.language] && void 0 !== this.options.i18n[this.options.language][a]) return d(this.options.i18n[this.options.language][a]);
...
!function(a) {
    ...
    Jodit.modules.FileBrowser = function(b) {
        ...
        }).on("click", ">a>i.remove", function(c) {
            var d = a(this).parent().data("path");
            Jodit.Confirm(b.i18n("Are you shure?"), "", function(b) {
                if (b) {
                    D(d, a(this).parent().data("name"));
                    A(e);
                }
            });
            c.stopPropagation();
