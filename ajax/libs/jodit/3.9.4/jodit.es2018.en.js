...
__webpack_require__.d(__webpack_exports__, {
  ...
  "ConfigFlatten": function() { return /* reexport */ ConfigFlatten; },
  "ConfigProto": function() { return /* reexport */ ConfigProto; },
  "LimitedStack": function() { return /* reexport */ utils/* LimitedStack */.lI; },
  "appendScript": function() { return /* reexport */ appendScript; },
  "appendScriptAsync": function() { return /* reexport */ appendScriptAsync; },
  "appendStyleAsync": function() { return /* reexport */ appendStyleAsync; },
  "applyStyles": function() { return /* reexport */ applyStyles; },
  "asArray": function() { return /* reexport */ asArray; },
  "attr": function() { return /* reexport */ utils/* attr */.Lj; },
  "browser": function() { return /* reexport */ browser; },
  "buildQuery": function() { return /* reexport */ buildQuery; },
  ...
  "clearCenterAlign": function() { return /* reexport */ css/* clearCenterAlign */.b; },
  ...
  "completeUrl": function() { return /* reexport */ completeUrl; },
  "convertMediaUrlToVideoEmbed": function() { return /* reexport */ convertMediaUrlToVideoEmbed; },
  "css": function() { return /* reexport */ css/* css */.i; },
  "cssPath": function() { return /* reexport */ cssPath; },
  "ctrlKey": function() { return /* reexport */ ctrlKey; },
  "dataBind": function() { return /* reexport */ data_bind/* dataBind */.q; },
  "defaultLanguage": function() { return /* reexport */ default_language/* defaultLanguage */.X; },
  "each": function() { return /* reexport */ each; },
  "error": function() { return /* reexport */ type/* error */.v; },
  "fastClone": function() { return /* reexport */ fastClone; },
  ...
  "getXPathByElement": function() { return /* reexport */ getXPathByElement; },
  ...
  "parseQuery": function() { return /* reexport */ parseQuery; },
  "position": function() { return /* reexport */ position; },
  "refs": function() { return /* reexport */ refs; },
  "reset": function() { return /* reexport */ utils/* reset */.mc; },
  "resolveElement": function() { return /* reexport */ resolveElement; },
  ...
  "toArray": function() { return /* reexport */ to_array/* toArray */.q; },
  ...
  "val": function() { return /* reexport */ val; }
});
...
var to_array = __webpack_require__(31);
...
var color_to_hex = __webpack_require__(29);
...
const getXPathByElement = (element, root) => {
    ...
    return (getXPathByElement(element.parentNode, root) +
        ...
        (sames.length > 1
            ? '[' + ((0,to_array/* toArray */.q)(sames).indexOf(element) + 1) + ']'
            : ''));
};
const refs = (root) => {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "gj": function() { return /* reexport */ getClassName; },
  "kc": function() { return /* reexport */ keepNames; },
  "XP": function() { return /* reexport */ utils/* keys */.XP; },
...
var is_numeric = __webpack_require__(22);
// EXTERNAL MODULE: ./src/core/helpers/checker/is-array.ts
var is_array = __webpack_require__(7);
// EXTERNAL MODULE: ./src/core/helpers/checker/index.ts + 14 modules
var checker = __webpack_require__(19);
...
/* harmony import */ var _checker_is_promise__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24);
/* harmony import */ var _get__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(30);
/* harmony import */ var _data_bind__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _checker_is_void__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21);
/* harmony import */ var _checker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony import */ var _css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
...
function attr(elm, keyOrAttributes, value) {
    if (!elm || !(0,_checker_is_function__WEBPACK_IMPORTED_MODULE_4__/* .isFunction */ .m)(elm.getAttribute)) {
        return null;
    }
    if (!(0,_checker__WEBPACK_IMPORTED_MODULE_1__/* .isString */ .HD)(keyOrAttributes)) {
        Object.keys(keyOrAttributes).forEach(key => {
            const value = keyOrAttributes[key];
            if ((0,_checker__WEBPACK_IMPORTED_MODULE_1__/* .isPlainObject */ .PO)(value) && key === 'style') {
                (0,_css__WEBPACK_IMPORTED_MODULE_2__/* .css */ .i)(elm, value);
            }
            else {
                if (key === 'className') {
                    key = 'class';
    ...
    let key = (0,_string__WEBPACK_IMPORTED_MODULE_3__/* .CamelCaseToKebabCase */ .gP)(keyOrAttributes);
    if (/^-/.test(key)) {
...
function callPromise(condition, callback) {
    if ((0,_checker_is_promise__WEBPACK_IMPORTED_MODULE_5__/* .isPromise */ .t)(condition)) {
...
const reset = function (key) {
    ...
    if (!(key in map)) {
        ...
        try {
            ...
            const func = (0,_get__WEBPACK_IMPORTED_MODULE_6__/* .get */ .U)(key, iframe.contentWindow), bind = (0,_get__WEBPACK_IMPORTED_MODULE_6__/* .get */ .U)(key.split('.').slice(0, -1).join('.'), iframe.contentWindow);
            if ((0,_checker_is_function__WEBPACK_IMPORTED_MODULE_4__/* .isFunction */ .m)(func)) {
...
/* harmony export */ });
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/* harmony import */ var _checker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
...
/* harmony import */ var _plugin_system__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
function getContainer(jodit, classFunc, tag = 'div', createInsideEditor = false) {
    ...
    if (!data[key]) {
        let c = view.c, body = (0,_helpers___WEBPACK_IMPORTED_MODULE_2__.isJoditObject)(jodit) && jodit.o.shadowRoot
            ? jodit.o.shadowRoot
            : jodit.od.body;
        if (createInsideEditor &&
            ...
            body =
                (0,_helpers___WEBPACK_IMPORTED_MODULE_2__.isJoditObject)(jodit) && jodit.o.shadowRoot
                    ? jodit.o.shadowRoot
                    : place;
        }
...
/* harmony import */ var _selection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
class Dom {
    ...
    static wrap(current, tag, create) {
        ...
        if (!current.parentNode) {
            throw (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.error)('Element should be in DOM');
        }
    ...
    static isNode(object) {
        ...
        const win = (0,_helpers__WEBPACK_IMPORTED_MODULE_1__.get)('ownerDocument.defaultView', object);
...
/* harmony default export */ var decorators_watch = ((/* unused pure expression or super */ null && (watch)));
...
var is_void = __webpack_require__(21);
...
var is_native_function = __webpack_require__(23);
...
/* harmony export */ });
/* harmony import */ var _checker___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
/* harmony import */ var _normalize___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26);
...
function css(element, key, value, onlyStyleMode = false) {
    ...
    if ((0,_checker___WEBPACK_IMPORTED_MODULE_0__/* .isBoolean */ .jn)(value)) {
        onlyStyleMode = value;
        value = undefined;
    }
    if ((0,_checker___WEBPACK_IMPORTED_MODULE_0__/* .isPlainObject */ .PO)(key) || value !== undefined) {
        const setValue = (elm, _key, _value) => {
            ...
            if (_value !== undefined &&
                (_value == null ||
                    css(elm, _key, true) !== (0,_normalize___WEBPACK_IMPORTED_MODULE_1__/* .normalizeCssValue */ .Zh)(_key, _value))) {
...
/* harmony export */ });
/* harmony import */ var _checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
/* harmony import */ var _checker_is_void__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
/* harmony import */ var _checker_is_native_function__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
const toArray = function toArray(...args) {
    ...
    const func = (0,_checker_is_native_function__WEBPACK_IMPORTED_MODULE_1__/* .isNativeFunction */ .Q)(Array.from)
        ? Array.from
        : (_a = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_0__/* .reset */ .mc)('Array.from')) !== null && _a !== void 0 ? _a : Array.from;
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var _traits__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _icon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
class UIElement extends _component__WEBPACK_IMPORTED_MODULE_0__/* .ViewComponent */ .Hr {
    ...
    setMod(name, value, container = this.container) {
        _traits__WEBPACK_IMPORTED_MODULE_2__/* .Mods.setMod.call */ .$.setMod.call(this, name, value, container);
        return this;
    }
    getMod(name) {
...
/* harmony export */ });
/* harmony import */ var _helpers_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
var get_control_type = __webpack_require__(38);
// EXTERNAL MODULE: ./src/config.ts
var config = __webpack_require__(1);
// EXTERNAL MODULE: ./src/core/helpers/checker/index.ts + 14 modules
var checker = __webpack_require__(19);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
...
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
/* harmony export */ });
/* harmony import */ var _helpers_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
/*!
 * Jodit Editor (https://xdsoft.net/jodit/)
 * Released under MIT see LICENSE.txt in the project root for license information.
 * Copyright (c) 2013-2021 Valeriy Chupurnov. All rights reserved. https://xdsoft.net
...
var decorators = __webpack_require__(17);
// EXTERNAL MODULE: ./src/core/ui/icon.ts
var ui_icon = __webpack_require__(35);
...
/* harmony default export */ __webpack_exports__["Z"] = ([
    {
        ...
        popup: (editor, _, _1, close) => {
            ...
            const makeColorPicker = (key) => (0,_modules_widget__WEBPACK_IMPORTED_MODULE_2__/* .ColorPickerWidget */ .YW)(editor, (value) => {
                selected.forEach(cell => {
                    (0,_core_helpers__WEBPACK_IMPORTED_MODULE_1__.css)(cell, key, value);
                });
                editor.lock();
                editor.setEditorValue();
                close();
                editor.unlock();
            }, (0,_core_helpers__WEBPACK_IMPORTED_MODULE_1__.css)(selected[0], key));
...
__webpack_require__.d(modules_namespaceObject, {
  ...
  "ObserveObject": function() { return events/* ObserveObject */.P5; },
  ...
  "ToolbarButton": function() { return ToolbarButton; },
  "ToolbarCollection": function() { return ToolbarCollection; },
  "ToolbarContent": function() { return ToolbarContent; },
  "ToolbarEditorCollection": function() { return ToolbarEditorCollection; },
  "UIBlock": function() { return ui/* UIBlock */.eC; },
  "UIButton": function() { return ui/* UIButton */.y3; },
  "UICheckbox": function() { return ui/* UICheckbox */.mA; },
  "UIElement": function() { return ui/* UIElement */.u1; },
  "UIForm": function() { return ui/* UIForm */.x4; },
  "UIGroup": function() { return ui/* UIGroup */.qe; },
  "UIInput": function() { return ui/* UIInput */.u3; },
  "UIList": function() { return ui/* UIList */.bz; },
  "UISeparator": function() { return ui/* UISeparator */.lU; },
  "UITextArea": function() { return ui/* UITextArea */.GJ; },
  "Uploader": function() { return Uploader; },
  "View": function() { return View; },
  "ViewComponent": function() { return component/* ViewComponent */.Hr; },
  "ViewWithToolbar": function() { return ViewWithToolbar; },
  "defaultNameSpace": function() { return events/* defaultNameSpace */.rO; }
});
...
__webpack_require__.d(plugins_namespaceObject, {
  ...
  "WrapTextNodes": function() { return WrapTextNodes; },
  "about": function() { return about; },
  "addNewLine": function() { return addNewLine; },
  "bold": function() { return bold; },
  "classSpan": function() { return classSpan; },
  "cleanHtml": function() { return cleanHtml; },
  "clipboard": function() { return clipboard; },
  "color": function() { return color; },
  "copyFormat": function() { return copyFormat; },
  "enter": function() { return enter; },
  "errorMessages": function() { return errorMessages; },
  "file": function() { return file; },
  "focus": function() { return focus_focus; },
  "font": function() { return font; },
  "formatBlock": function() { return formatBlock; },
  "fullsize": function() { return fullsize; },
  "hotkeys": function() { return hotkeys; },
  "hr": function() { return hr; },
  "iframe": function() { return iframe; },
  "image": function() { return image_image; },
  "imageProcessor": function() { return imageProcessor; },
  "imageProperties": function() { return imageProperties; },
  "indent": function() { return indent; },
  "inlinePopup": function() { return inlinePopup; },
  "justify": function() { return justify; },
  "limit": function() { return limit; },
  "link": function() { return link_link; },
  "media": function() { return media; },
  "mobile": function() { return mobile; },
  "orderedList": function() { return orderedList; },
  ...
  "resizeCells": function() { return resizeCells; },
  "resizeHandler": function() { return resizeHandler; },
  "resizer": function() { return resizer; },
  "search": function() { return search; },
  "select": function() { return select_select; },
  "selectCells": function() { return selectCells; },
...
__webpack_require__.d(icons_namespaceObject, {
  "about": function() { return icons_about; },
  "addcolumn": function() { return addcolumn; },
  "addrow": function() { return addrow; },
  ...
  "arrows_alt": function() { return arrows_alt; },
  "arrows_h": function() { return arrows_h; },
  "attachment": function() { return attachment; },
  "bin": function() { return bin; },
  "bold": function() { return icons_bold; },
  "brush": function() { return brush; },
  "cancel": function() { return cancel; },
  "center": function() { return center; },
  "chain_broken": function() { return chain_broken; },
  "check": function() { return check; },
  "check_square": function() { return check_square; },
  "chevron": function() { return chevron; },
  "copy": function() { return copy; },
  "copyformat": function() { return copyformat; },
  "crop": function() { return crop; },
  "cut": function() { return cut; },
  "dedent": function() { return dedent; },
  "dots": function() { return dots; },
  "enter": function() { return icons_enter; },
  "eraser": function() { return eraser; },
  "eye": function() { return eye; },
  "file": function() { return icons_file; },
  "folder": function() { return folder; },
  "font": function() { return icons_font; },
  "fontsize": function() { return fontsize; },
  "fullsize": function() { return icons_fullsize; },
  "hr": function() { return icons_hr; },
  "image": function() { return icons_image; },
  "indent": function() { return icons_indent; },
  "info_circle": function() { return info_circle; },
  "italic": function() { return italic; },
  "justify": function() { return icons_justify; },
  "left": function() { return left; },
  "link": function() { return icons_link; },
  ...
  "paste": function() { return icons_paste; },
  ...
  "search": function() { return icons_search; },
  "select_all": function() { return select_all; },
  "settings": function() { return settings; },
  "shrink": function() { return shrink; },
  "source": function() { return icons_source; },
  "splitg": function() { return splitg; },
  "splitv": function() { return splitv; },
  "strikethrough": function() { return strikethrough; },
  "subscript": function() { return subscript; },
  "superscript": function() { return superscript; },
  "table": function() { return icons_table; },
  "th": function() { return th; },
  "th_list": function() { return th_list; },
  "ul": function() { return ul; },
  "underline": function() { return underline; },
  "undo": function() { return undo; },
  "unlink": function() { return unlink; },
  "unlock": function() { return unlock; },
  "update": function() { return update; },
  "upload": function() { return upload; },
  "valign": function() { return valign; },
  "video": function() { return icons_video; }
});
...
var traits = __webpack_require__(34);
...
let ToolbarButton = class ToolbarButton extends ui_button/* UIButton */.y3 {
    ...
    onChangeTooltip() {
        (0,helpers.attr)(this.button, 'aria-label', this.state.tooltip);
...
class ViewWithToolbar extends View {
    ...
    get toolbarContainer() {
        if (!this.o.fullsize &&
            ((0,helpers.isString)(this.o.toolbar) || dom/* Dom.isHTMLElement */.i.isHTMLElement(this.o.toolbar))) {
...
class addNewLine extends Plugin {
    constructor() {
        ...
        this.onMouseMove = (e) => {
            ...
            if (!dom/* Dom.isHTMLElement */.i.isHTMLElement(currentElement) ||
            ...
            if (this.isMatchedTag(currentElement)) {
                const parentBox = dom/* Dom.up */.i.up(currentElement, dom/* Dom.isBlock */.i.isBlock, editor.editor);
...
function findNotEmptyNeighbor(node, left, root) {
    return (0,utils/* call */.RE)(left ? dom/* Dom.prev */.i.prev : dom/* Dom.next */.i.next, node, n => Boolean(n && (!dom/* Dom.isText */.i.isText(n) || (0,string/* trim */.fy)((n === null || n === void 0 ? void 0 : n.nodeValue) || '').length)), root);
}
...
class cleanHtml extends Plugin {
    constructor() {
        ...
        this.visitNode = (nodeElm, current, remove) => {
            ...
            if (this.j.o.cleanHTML.fillEmptyParagraph &&
                dom/* Dom.isBlock */.i.isBlock(nodeElm) &&
    ...
    isRemovableNode(node, current) {
        ...
        if (current &&
            ...
            dom/* Dom.up */.i.up(node, dom/* Dom.isBlock */.i.isBlock, this.j.editor) !==
                dom/* Dom.up */.i.up(current, dom/* Dom.isBlock */.i.isBlock, this.j.editor)) {
            return true;
        }
        return (this.j.o.cleanHTML.removeEmptyElements &&
            ...
            !dom/* Dom.isTemporary */.i.isTemporary(node) &&
...
class WrapTextNodes extends Plugin {
    constructor() {
        ...
        this.isNotClosed = (n) => dom/* Dom.isElement */.i.isElement(n) && !(dom/* Dom.isBlock */.i.isBlock(n) || dom/* Dom.isTag */.i.isTag(n, ['hr', 'style']));
    }
    afterInit(jodit) {
...
function pasteInsertHtml(e, editor, html) {
    ...
    if (!(0,helpers.isVoid)(result) &&
        ((0,helpers.isString)(result) || (0,helpers.isNumber)(result) || dom/* Dom.isNode */.i.isNode(result))) {
        html = result;
    }
...
class paste extends Plugin {
    ...
    defaultPasteProcess(e) {
        ...
        if (dt && text && (0,helpers.trim)(text) !== '') {
            ...
            if ((0,helpers.isString)(text) || dom/* Dom.isNode */.i.isNode(text)) {
...
config/* Config.prototype.controls.brush */.D.prototype.controls.brush = {
    ...
    popup: (editor, current, self, close, button) => {
        ...
        if (current && current !== editor.editor && dom/* Dom.isNode */.i.isNode(current)) {
            ...
            dom/* Dom.up */.i.up(current, (node) => {
                if (dom/* Dom.isHTMLElement */.i.isHTMLElement(node)) {
    ...
    exec(jodit, current, { button }) {
        ...
        if (current &&
            ...
            dom/* Dom.isNode */.i.isNode(current) &&
...
class enter extends Plugin {
    ...
    hasPreviousBlock(current) {
        const editor = this.j;
        return Boolean(dom/* Dom.prev */.i.prev(current, elm => dom/* Dom.isBlock */.i.isBlock(elm) || dom/* Dom.isImage */.i.isImage(elm), editor.editor));
    }
    checkUnsplittableBox(currentBox) {
        const editor = this.j, sel = editor.selection;
        if (!dom/* Dom.canSplitBlock */.i.canSplitBlock(currentBox)) {
...
;// CONCATENATED MODULE: ./src/plugins/keyboard/key-arrow-outside.ts
...
class KeyArrowOutside extends Plugin {
    afterInit(jodit) { }
    beforeDestruct(jodit) { }
    onKeyDownArrow(e) {
        var _a;
        ...
        if (!dom/* Dom.isText */.i.isText(endContainer)) {
            return;
        }
        if (((_a = endContainer.nodeValue) === null || _a === void 0 ? void 0 : _a.length) === endOffset) {
            const { parentNode } = endContainer;
            if (dom/* Dom.isInlineBlock */.i.isInlineBlock(parentNode) &&
                !findNotEmptyNeighbor(parentNode, false, this.j.editor)) {
                dom/* Dom.after */.i.after(parentNode, this.j.createInside.text(constants.NBSP_SPACE));
            }
        }
    }
}
    ...
    if (editor.o.showMessageErrors) {
        const activeClass = editor.getFullElName(ELM_NAME, 'active', true), messagesBox = editor.c.div(editor.getFullElName(ELM_NAME)), calcOffsets = () => {
            ...
            (0,helpers.toArray)(messagesBox.childNodes).forEach(elm => {
                (0,helpers.css)(elm, 'bottom', height + 'px');
                height +=
...
config/* Config.prototype.controls.paragraph */.D.prototype.controls.paragraph = {
    ...
    isActive: (editor, control) => {
        const current = editor.s.current();
        if (current) {
            const currentBpx = dom/* Dom.closest */.i.closest(current, dom/* Dom.isBlock */.i.isBlock, editor.editor);
            return Boolean(currentBpx &&
                currentBpx !== editor.editor &&
                control.list !== undefined &&
...
function fullsize(editor) {
    ...
    const resize = () => {
        ...
        if (events) {
            if (isEnabled) {
                oldHeight = (0,helpers.css)(container, 'height', true);
                oldWidth = (0,helpers.css)(container, 'width', true);
                (0,helpers.css)(container, {
...
config/* Config.prototype.controls.align */.D.prototype.controls.align = {
    ...
    isActive: (editor, btn) => {
        ...
        if (current && btn.defaultValue) {
            const currentBox = dom/* Dom.closest */.i.closest(current, dom/* Dom.isBlock */.i.isBlock, editor.editor) || editor.editor;
...
const clearAlign = (node) => {
    dom/* Dom.each */.i.each(node, elm => {
        if (dom/* Dom.isHTMLElement */.i.isHTMLElement(elm)) {
...
const alignElement = (command, box) => {
    if (dom/* Dom.isNode */.i.isNode(box) && dom/* Dom.isElement */.i.isElement(box)) {
        clearAlign(box);
...
function justify(editor) {
    ...
    const callback = (command) => {
        ...
        editor.s.eachSelection((current) => {
            ...
            let currentBox = dom/* Dom.up */.i.up(current, dom/* Dom.isBlock */.i.isBlock, editor.editor);
            if (!currentBox) {
        ...
        this.find = (start, query, next, deep, range) => {
            if (start && query.length) {
                ...
                this.eachMap(start, (elm) => {
                    ...
                    else if (dom/* Dom.isBlock */.i.isBlock(elm) && sentence !== '') {
    ...
    popup: (editor, current, control, close, button) => {
        ...
        editor.e
            ...
            if (crnt && editor.s.isCollapsed()) {
                const block = dom/* Dom.closest */.i.closest(crnt, dom/* Dom.isBlock */.i.isBlock, editor.editor);
                if (block &&
                    block !== editor.editor &&
...
class resizeCells extends Plugin {
    ...
    resizeColumns() {
        ...
        const nextTD = (0,helpers.call)(this.isRTL ? dom/* Dom.prev */.i.prev : dom/* Dom.next */.i.next, this.workCell, dom/* Dom.isCell */.i.isCell, this.workCell.parentNode);
    ...
    calcHandlePosition(table, cell, offsetX = 0, delta = 0) {
        ...
        if (offsetX <= constants.NEARBY) {
            const prevTD = (0,helpers.call)(this.isRTL ? dom/* Dom.next */.i.next : dom/* Dom.prev */.i.prev, cell, dom/* Dom.isCell */.i.isCell, cell.parentNode);
            this.setWorkCell(prevTD || cell, prevTD ? null : true);
        }
        else {
            const nextTD = (0,helpers.call)(!this.isRTL ? dom/* Dom.next */.i.next : dom/* Dom.prev */.i.prev, cell, dom/* Dom.isCell */.i.isCell, cell.parentNode);
    ...
    observe(table) {
        ...
        this.j.e
            ...
            const cell = dom/* Dom.up */.i.up(event.target, dom/* Dom.isCell */.i.isCell, table);
            if (!cell) {
                return;
            }
        ...
        switch (event.key) {
            ...
            case constants.KEY_LEFT: {
                ...
                if (!next) {
                    ...
                    next = dom/* Dom */.i[sibling](block, dom/* Dom.isCell */.i.isCell, table);
                }
                break;
            }
            case constants.KEY_UP:
