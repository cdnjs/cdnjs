...
"use strict";function Font(t){t=t||{},this.names={fontFamily:{en:t.familyName||" "},fontSubfamily:{en:t.styleName||" "},designer:{en:t.designer||" "},designerURL:{en:t.designerURL||" "},manufacturer:{en:t.manufacturer||" "},manufacturerURL:{en:t.manufacturerURL||" "},license:{en:t.license||" "},licenseURL:{en:t.licenseURL||" "},version:{en:t.version||"Version 0.1"},description:{en:t.description||" "},copyright:{en:t.copyright||" "},trademark:{en:t.trademark||" "}},this.unitsPerEm=t.unitsPerEm||1e3,this.ascender=t.ascender,this.descender=t.descender,this.supported=!0,this.glyphs=new glyphset.GlyphSet(this,t.glyphs||[]),this.encoding=new encoding.DefaultEncoding(this),this.tables={}}var path=require("./path"),sfnt=require("./tables/sfnt"),encoding=require("./encoding"),glyphset=require("./glyphset");Font.prototype.hasChar=function(t){return null!==this.encoding.charToGlyphIndex(t)},Font.prototype.charToGlyphIndex=function(t){return this.encoding.charToGlyphIndex(t)},Font.prototype.charToGlyph=function(t){var e=this.charToGlyphIndex(t),n=this.glyphs.get(e);return n||(n=this.glyphs.get(0)),n},Font.prototype.stringToGlyphs=function(t){for(var e=[],n=0;n<t.length;n+=1){var o=t[n];e.push(this.charToGlyph(o))}return e},Font.prototype.nameToGlyphIndex=function(t){return this.glyphNames.nameToGlyphIndex(t)},Font.prototype.nameToGlyph=function(t){var e=this.nametoGlyphIndex(t),n=this.glyphs.get(e);return n||(n=this.glyphs.get(0)),n},Font.prototype.glyphIndexToName=function(t){return this.glyphNames.glyphIndexToName?this.glyphNames.glyphIndexToName(t):""},Font.prototype.getKerningValue=function(t,e){t=t.index||t,e=e.index||e;var n=this.getGposKerningValue;return n?n(t,e):this.kerningPairs[t+","+e]||0},Font.prototype.forEachGlyph=function(t,e,n,o,i,r){e=void 0!==e?e:0,n=void 0!==n?n:0,o=void 0!==o?o:72,i=i||{};for(var s=void 0===i.kerning?!0:i.kerning,h=1/this.unitsPerEm*o,a=this.stringToGlyphs(t),p=0;p<a.length;p+=1){var u=a[p];if(r(u,e,n,o,i),u.advanceWidth&&(e+=u.advanceWidth*h),s&&p<a.length-1){var c=this.getKerningValue(u,a[p+1]);e+=c*h}}},Font.prototype.getPath=function(t,e,n,o,i){var r=new path.Path;return this.forEachGlyph(t,e,n,o,i,function(t,e,n,o){var i=t.getPath(e,n,o);r.extend(i)}),r},Font.prototype.draw=function(t,e,n,o,i,r){this.getPath(e,n,o,i,r).draw(t)},Font.prototype.drawPoints=function(t,e,n,o,i,r){this.forEachGlyph(e,n,o,i,r,function(e,n,o,i){e.drawPoints(t,n,o,i)})},Font.prototype.drawMetrics=function(t,e,n,o,i,r){this.forEachGlyph(e,n,o,i,r,function(e,n,o,i){e.drawMetrics(t,n,o,i)})},Font.prototype.getEnglishName=function(t){var e=this.names[t];return e?e.en:void 0},Font.prototype.validate=function(){function t(t,e){t||n.push(e)}function e(e){var n=o.getEnglishName(e);t(n&&n.trim().length>0,"No English "+e+" specified.")}var n=[],o=this;e("fontFamily"),e("weightName"),e("manufacturer"),e("copyright"),e("version"),t(this.unitsPerEm>0,"No unitsPerEm specified.")},Font.prototype.toTables=function(){return sfnt.fontToTable(this)},Font.prototype.toBuffer=function(){for(var t=this.toTables(),e=t.encode(),n=new ArrayBuffer(e.length),o=new Uint8Array(n),i=0;i<e.length;i++)o[i]=e[i];return n},Font.prototype.download=function(){var t=this.getEnglishName("fontFamily"),e=this.getEnglishName("fontSubfamily"),n=t.replace(/\s/g,"")+"-"+e+".otf",o=this.toBuffer();window.requestFileSystem=window.requestFileSystem||window.webkitRequestFileSystem,window.requestFileSystem(window.TEMPORARY,o.byteLength,function(t){t.root.getFile(n,{create:!0},function(t){t.createWriter(function(e){var n=new DataView(o),i=new Blob([n],{type:"font/opentype"});e.write(i),e.addEventListener("writeend",function(){location.href=t.toURL()},!1)})})},function(t){throw t})},exports.Font=Font;
