...
"use strict";function toArrayBuffer(e){for(var a=new ArrayBuffer(e.length),r=new Uint8Array(a),s=0;s<e.length;s+=1)r[s]=e[s];return a}function loadFromFile(e,a){var r=require("fs");r.readFile(e,function(e,r){return e?a(e.message):void a(null,toArrayBuffer(r))})}function loadFromUrl(e,a){var r=new XMLHttpRequest;r.open("get",e,!0),r.responseType="arraybuffer",r.onload=function(){return 200!==r.status?a("Font could not be loaded: "+r.statusText):a(null,r.response)},r.send()}function parseBuffer(e){var a,r,s,t,n,o,l,p=new _font.Font,i=new DataView(e,0),u=parse.getFixed(i,0);if(1===u)p.outlinesFormat="truetype";else{if(u=parse.getTag(i,0),"OTTO"!==u)throw new Error("Unsupported OpenType version "+u);p.outlinesFormat="cff"}for(var f=parse.getUShort(i,4),c=12,h=0;f>h;h+=1){var d=parse.getTag(i,c),m=parse.getULong(i,c+8);switch(d){case"cmap":p.tables.cmap=cmap.parse(i,m),p.encoding=new encoding.CmapEncoding(p.tables.cmap);break;case"head":p.tables.head=head.parse(i,m),p.unitsPerEm=p.tables.head.unitsPerEm,a=p.tables.head.indexToLocFormat;break;case"hhea":p.tables.hhea=hhea.parse(i,m),p.ascender=p.tables.hhea.ascender,p.descender=p.tables.hhea.descender,p.numberOfHMetrics=p.tables.hhea.numberOfHMetrics;break;case"hmtx":r=m;break;case"maxp":p.tables.maxp=maxp.parse(i,m),p.numGlyphs=p.tables.maxp.numGlyphs;break;case"name":p.tables.name=_name.parse(i,m),p.familyName=p.tables.name.fontFamily,p.styleName=p.tables.name.fontSubfamily;break;case"OS/2":p.tables.os2=os2.parse(i,m);break;case"post":p.tables.post=post.parse(i,m),p.glyphNames=new encoding.GlyphNames(p.tables.post);break;case"glyf":s=m;break;case"loca":t=m;break;case"CFF ":n=m;break;case"kern":o=m;break;case"GPOS":l=m}c+=16}if(s&&t){var b=0===a,y=loca.parse(i,t,p.numGlyphs,b);p.glyphs=glyf.parse(i,s,y,p),hmtx.parse(i,r,p.numberOfHMetrics,p.numGlyphs,p.glyphs),encoding.addGlyphNames(p)}else{if(!n)throw new Error("Font doesn't contain TrueType or CFF outlines.");cff.parse(i,n,p),encoding.addGlyphNames(p)}return p.kerningPairs=o?kern.parse(i,o):{},l&&gpos.parse(i,l,p),p}function load(e,a){var r="undefined"==typeof window,s=r?loadFromFile:loadFromUrl;s(e,function(e,r){if(e)return a(e);var s=parseBuffer(r);return a(null,s)})}function loadSync(e){var a=require("fs"),r=a.readFileSync(e);return parseBuffer(toArrayBuffer(r))}var encoding=require("./encoding"),_font=require("./font"),glyph=require("./glyph"),parse=require("./parse"),path=require("./path"),cmap=require("./tables/cmap"),cff=require("./tables/cff"),glyf=require("./tables/glyf"),gpos=require("./tables/gpos"),head=require("./tables/head"),hhea=require("./tables/hhea"),hmtx=require("./tables/hmtx"),kern=require("./tables/kern"),loca=require("./tables/loca"),maxp=require("./tables/maxp"),_name=require("./tables/name"),os2=require("./tables/os2"),post=require("./tables/post");exports._parse=parse,exports.Font=_font.Font,exports.Glyph=glyph.Glyph,exports.Path=path.Path,exports.parse=parseBuffer,exports.load=load,exports.loadSync=loadSync;
