...
/***/ function(module, exports, __webpack_require__) {
	...
	function filterBody(body, filter, colKeys) {
	...
	function camelizeHeader(header) {
	  header.forEach(function (p) {
	    if (p.key.indexOf(' ') !== -1 || p.key.indexOf('-') !== -1) {
	      p.key = camelCase(p.key.replace(/\-/, ' ').replace(/\./, '※').replace(/_/, 'ʫ')).replace(/※/, '.').replace(/ʫ/, '_');
	    }
	  });
	}
	
	function returnPage(body) {
	  var _ref = arguments.length <= 1 || arguments[1] === undefined ? { itemsPerPage: 20, currentPage: 1 } : arguments[1];
	
	  var itemsPerPage = _ref.itemsPerPage;
	  var currentPage = _ref.currentPage;
	
	  var zeroIndexedCurrentPage = currentPage - 1;
	  return body.slice(zeroIndexedCurrentPage * itemsPerPage, (zeroIndexedCurrentPage + 1) * itemsPerPage);
	}
	
	exports.default = { deriveBody: deriveBody, bodyWithIds: bodyWithIds, filterBody: filterBody,
	  sortBody: sortBody, camelizeHeader: camelizeHeader, returnPage: returnPage };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bodyParsing = __webpack_require__(72);
	
	var _bodyParsing2 = _interopRequireDefault(_bodyParsing);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var pascalCase = __webpack_require__(162);
	var camelCase = __webpack_require__(41);
	...
	exports.default = {
	  ...
	  computed: {
	    numPages: function numPages() {
	      return Math.ceil(this.pBody.filter(function (i) {
	        return i._show === true;
	    ...
	    bodyPage: function bodyPage() {
	      return _bodyParsing2.default.returnPage(this.pBody, { itemsPerPage: this.itemsPerPage, currentPage: this.currentPage });
	    },
	  ...
	  beforeCompile: function beforeCompile() {
	    ...
	    if (this.$options._content !== undefined) {
	      ...
	      (0, _from2.default)(this.$options._content.querySelectorAll('[col]')).forEach(function (el) {
	        _this3.elHarvest.push(_this3.$options._content.removeChild(el));
	      });
	
	      (0, _from2.default)(this.$options._content.querySelectorAll('footer')).forEach(function (el) {
	        var footerComponent = el.getAttribute(':is') || el.getAttribute('v-bind:is');
	        if (footerComponent) {
	          _this3.footerComponents.push(footerComponent);
	        }
	        _this3.footerTemplates.push(_this3.$options._content.removeChild(el));
	      });
	
	      this.$options._content.innerHTML = '';
	    }
	
	    this.elHarvest.forEach(function (el) {
	      var tag = el.tagName.toLowerCase();
	
	      var col = camelCase(el.attributes.col.value.replace(/\-/, ' ').replace(/\./, 'ʬ').replace(/\+/, 'ʭ').replace(/_/, 'ʫ')).replace(/ʬ/, '.').replace(/ʭ/, '+').replace(/ʫ/, '_');
	      if (commonTagRE.test(tag)) {
	        console.error('[Smart Table Usage Error] HTML element"' + tag + '" cannot be a component. Skipping');
	        return;
	      }
	
	      _this3.$root.$options.components.PlainText = _vue2.default.extend(_PlainText2.default);
	
	      var res = _this3.$root.$options.components[tag] || _this3.$root.$options.components[camelCase(tag)] || _this3.$root.$options.components[pascalCase(tag)];
	      ...
	      var initProps = {
	        init: function init() {
	          ...
	          (0, _from2.default)(el.attributes).forEach(function (att) {
	            _this4.$options.el.setAttribute(att.name, att.value);
	          });
	        }
	      };
	      var contentDeamon = {
	      ...
	      var smartMethods = {
	        methods: {
	          ...
	          statics: function statics(staticName) {
	            var _this5 = this;
	
	            var maybeStatics = this.$parent.statics.find(function (s) {
	              return s._id === _this5.id;
	            });
	            var _statics = void 0;
	            if (maybeStatics === undefined) {
	              var firstStatic = (0, _defineProperty3.default)({ _id: this.id }, staticName, { v: undefined });
	            ...
	            if (_statics[staticName] === undefined) {
	              _statics = (0, _assign2.default)({}, _statics, (0, _defineProperty3.default)({}, staticName, { v: undefined }));
	            }
	            return _statics[staticName];
	          }
	        }
	      };
	      _this3.$options.components[col] = _vue2.default.extend({
	    ...
	    var counter = 0;
	    this.footerTemplates.forEach(function (el) {
	      _this3.$options.components['footer' + counter] = _vue2.default.extend({
	        template: el.innerHTML,
	        mixins: [smartFooter]
	      });
	      _this3.footers.push('footer' + counter);
	      counter++;
	    });
	    this.footerComponents.forEach(function (cmpName) {
	      var res = _this3.$root.$options.components[cmpName] || _this3.$root.$options.components[camelCase(cmpName)] || _this3.$root.$options.components[pascalCase(cmpName)];
	      var baseMixin = res.options;
	      _this3.$options.components['footer' + counter] = _vue2.default.extend({
	  ...
	  methods: {
	    makepBody: function makepBody() {
	      ...
	      _bodyParsing2.default.deriveBody(this.pBody, this.tableHeader.map(function (c) {
	        return c.key;
	      }));
	      this.applyFilters();
	
	      var insistingIds = this.pBody.map(function (r) {
	        return r._id;
	      });
	      var childrenToRemove = this.$children.filter(function (c) {
	        return c.id && insistingIds.indexOf(c.id) === -1;
	      });
	      childrenToRemove.forEach(function (c) {
	        return c.$destroy();
	      });
	
	      this.tableHeader.map(function (col) {
	        return col.key;
	      }).forEach(function (col) {
	        if (_this6.$options.components[col] === undefined) {
	          _this6.$options.components[col] = _vue2.default.extend(_PlainText2.default);
	        }
	      });
	    },
	    ...
	    tdFooterClasses: function tdFooterClasses(index) {
	      return '';
	    },
	    ...
	    refresh: function refresh() {
	      ...
	      this.$http.get(this.endpoint).then(function (response) {
	        ...
	        if (_this7.bodyPath.length === 0) {
	          ...
	          retBody = retJson[_this7.bodyPath];
	          _this7.meta = retJson;
	          delete _this7.meta[_this7.bodyPath];
	        }
	        if (retBody === undefined) {
	          console.warn('[Smart Table Warning] Received body was empty. Body-path used was: \'' + _this7.bodyPath + '\'');
	        }
	    ...
	    isEditable: function isEditable(col) {
	      return this.editable.indexOf(col) !== -1 || this.editable.map(function (c) {
	        return camelCase(c);
	      }).indexOf(col) !== -1 || this.editable.map(function (c) {
	        return pascalCase(c);
	      }).indexOf(col) !== -1;
	    },
	    put: function put(_ref) {
	      ...
	      var childDidntExplicitlySetAValue = value === undefined;
	      var valueToSend = value || child.value;
	      this.$dispatch('before-request');
	      ...
	      if (httpRESTreq) {
	        this.$http.put(this.endpoint + '/' + id + '/' + col, {
	          ...
	          if (childDidntExplicitlySetAValue) {
	            _vue2.default.set(child, 'value', child.valueBeforeEnteringEditMode);
	          }
	          _this9.$dispatch('error', { table: _this9.$options._ref, status: response.status, data: response.data });
	    ...
	    doOrderBy: function doOrderBy(col) {
	      ...
	      this.orderKey = col;
	      _bodyParsing2.default.sortBody(this.pBody, col, this.reverseOrder, this.compareFunction(col));
	    },
	    ...
	    applyFilters: function applyFilters() {
	      ...
	      this.filters.forEach(function (f) {
	        ...
	        _bodyParsing2.default.filterBody(_this10.pBody, filter, col, cumulative);
	        cumulative = true;
	      });
	    }
	  },
	  events: {
	    ...
	    'saveNewValue': function saveNewValue(_ref3) {
	      var id = _ref3.id;
	      var col = _ref3.col;
	      ...
	      if (id === '____add-row') {
	        ...
	        if (child.mode === 'edit') {
	          this.put({ value: value, id: id, col: col, child: child });
	        }
	      }
	    },
	    'enterEditMode': function enterEditMode(_ref4) {
	      var id = _ref4.id;
	      var col = _ref4.col;
	    ...
	    'filter': function filter(_ref6) {
	      var _filter = _ref6.filter;
	      var col = _ref6.col;
	      var _ref6$table = _ref6.table;
	      var table = _ref6$table === undefined ? this.tableId : _ref6$table;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(130)
	
	var NON_WORD_REGEXP = __webpack_require__(133)
	var CAMEL_CASE_REGEXP = __webpack_require__(131)
	var CAMEL_CASE_UPPER_REGEXP = __webpack_require__(132)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(43) && !__webpack_require__(67)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject       = __webpack_require__(138)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.smart-filter {\n  display: none;\n}\n", "", {"version":3,"sources":["/./src/components/SmartTable.vue"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAupBA;EACE,cAAc;CACf","file":"SmartTable.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.smart-filter {\n  display: none;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.pointer-cursor[_v-22804018] {\n  cursor: pointer;\n}\n.full-height[_v-22804018] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  padding: 0.71428571em;\n  vertical-align: middle;\n}\n.padding[_v-22804018] {\n  padding: 0.71428571em;\n}\n", "", {"version":3,"sources":["/./src/components/PlainText.vue"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AAkHA;EACE,gBAAgB;CACjB;AACD;EACE,qBAAqB;EACrB,qBAAqB;EACrB,cAAc;EACd,sBAAsB;EACtB,uBAAuB;CACxB;AACD;EACE,sBAAsB;CACvB","file":"PlainText.vue","sourcesContent":["\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.pointer-cursor[_v-22804018] {\n  cursor: pointer;\n}\n.full-height[_v-22804018] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  padding: 0.71428571em;\n  vertical-align: middle;\n}\n.padding[_v-22804018] {\n  padding: 0.71428571em;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var upperCase = __webpack_require__(160)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var camelCase = __webpack_require__(41)
	var upperCaseFirst = __webpack_require__(161)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SmartTable.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SmartTable.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-22804018&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./PlainText.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-22804018&scoped=true!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./PlainText.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
