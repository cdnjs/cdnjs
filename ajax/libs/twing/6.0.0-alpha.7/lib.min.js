...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEnvironment=void 0;const extension_set_1=require("./extension-set"),parser_1=require("./parser"),html_1=require("./escaping-stragegy/html"),css_1=require("./escaping-stragegy/css"),js_1=require("./escaping-stragegy/js"),url_1=require("./escaping-stragegy/url"),html_attribute_1=require("./escaping-stragegy/html-attribute"),source_1=require("./source"),token_stream_1=require("./token-stream"),source_map_runtime_1=require("./source-map-runtime"),security_policy_1=require("./sandbox/security-policy"),markup_1=require("./markup"),template_1=require("./template"),runtime_1=require("./error/runtime"),path_1=require("path"),luxon_1=require("luxon"),events_1=require("events"),loader_1=require("./error/loader"),lexer_1=require("./lexer"),createHash=require("create-hash"),core_1=require("./extension/core");function createEnvironment(e,t){const r={css:(0,css_1.createCssEscapingStrategyHandler)(),html:(0,html_1.createHtmlEscapingStrategyHandler)(),html_attr:(0,html_attribute_1.createHtmlAttributeEscapingStrategyHandler)(),js:(0,js_1.createJsEscapingStrategyHandler)(),url:(0,url_1.createUrlEscapingStrategyHandler)()},a=(0,extension_set_1.createExtensionSet)();a.addExtension((0,core_1.createCoreExtension)());const n=null==t?void 0:t.autoEscapingStrategy,s=(null==t?void 0:t.autoReload)||!1,o=(null==t?void 0:t.cache)||null,i=(null==t?void 0:t.charset)||"UTF-8",l=(null==t?void 0:t.dateFormat)||"F j, Y H:i",u=(null==t?void 0:t.dateIntervalFormat)||"%d days",c=(null==t?void 0:t.numberFormat)||{decimalPoint:".",numberOfDecimals:0,thousandSeparator:","},d=new events_1.EventEmitter,m=new Map,p=(null==t?void 0:t.sandboxPolicy)||(0,security_policy_1.createSandboxSecurityPolicy)();let g,_,h=!(null==t||!t.sandboxed);const y="name"===n?e=>{let t=(0,path_1.extname)(e);switch(".twig"===t&&(e=(0,path_1.basename)(e,t),t=(0,path_1.extname)(e)),t){case".js":return"js";case".css":return"css";case".txt":return null;default:return"html"}}:()=>void 0===n?"html":n,v=new Map,x={get charset(){return i},get dateFormat(){return l},get dateIntervalFormat(){return u},get numberFormat(){return c},get filters(){return a.filters},get functions(){return a.functions},get isSandboxed(){return h},set isSandboxed(e){h=e},get isStrictVariables(){return!(null==t||!t.strictVariables)},get loader(){return e},get sandboxPolicy(){return p},get tests(){return a.tests},get timezone(){return(null==t?void 0:t.timezone)||luxon_1.Settings.defaultZoneName},addExtension:a.addExtension,addFilter:a.addFilter,addFunction:a.addFunction,addNodeVisitor:a.addNodeVisitor,addOperator:a.addOperator,addTagHandler:a.addTagHandler,addTest:a.addTest,createTemplateFromString:(e,t)=>{const r=createHash("sha256").update(e).digest("hex").toString();t=null!==t?`${t} (string template ${r})`:`__string_template__${r}`;const a=x.parse(x.tokenize((0,source_1.createSource)(t,e))),n=(0,template_1.createTemplate)(x,a);return x.registerTemplate(n,t),Promise.resolve(n)},escape:(e,t,a,n,s)=>{if("boolean"==typeof t)return Promise.resolve(t);let o;if(null==t)o="";else if(s&&(0,markup_1.isAMarkup)(t))o=t.toString();else{let s;if(!0===a&&(a=y(e.templateName)),null===a)s=(e=>e);else if(void 0===(s=r[a]))return Promise.reject((0,runtime_1.createRuntimeError)(`Invalid escaping strategy "${a}" (valid ones: ${Object.keys(r).sort().join(", ")}).`));o=s(t.toString(),n||x.charset,e.templateName)}return Promise.resolve(o)},loadTemplate:async(t,r=null)=>{let a;d.emit("load",t,r);const n=await(async(t,r)=>{let a=await e.getCacheKey(t,r);return null===a?null:createHash("sha256").update(a).digest("hex")})(t,r);if(n&&(a=v.get(n)),a)return Promise.resolve(a);{const a=o&&n?await o.generateKey(n):null,i=o&&a?await o.getTimestamp(a):0,l=async()=>{if(null===o||null===a)return Promise.resolve(null);let n;if(s){n=await e.isFresh(t,i,r)?await o.load(a):null}else n=await o.load(a);return n},u=async()=>{const n=await e.getSourceContext(t,r);if(null===n)return null;const s=x.parse(x.tokenize(n));return null!==o&&null!==a&&await o.write(a,s),s};let c=await l();if(null===c&&(c=await u()),null===c)throw(0,loader_1.createTemplateLoadingError)([t]);const d=(0,template_1.createTemplate)(x,c);return x.registerTemplate(d,n),d}},mergeGlobals:e=>{for(let[t,r]of m)e.has(t)||e.set(t,r);return e},on:(e,t)=>{d.on(e,t)},registerEscapingStrategy:(e,t)=>{r[t]=e},parse:(e,r)=>{_||(_=(0,parser_1.createParser)(a.unaryOperators,a.binaryOperators,a.tagHandlers,a.nodeVisitors,a.filters,a.functions,a.tests,r||(null==t?void 0:t.parserOptions)||{strict:!0}));try{return _.parse(e)}catch(t){const r=e.source;throw t.source||(t.source=r.resolvedName),t}},registerTemplate:(e,t)=>{v.set(t,e)},render:(e,t)=>x.loadTemplate(e).then(e=>e.render(t)),renderWithSourceMap:(e,t)=>{const r=(0,source_map_runtime_1.createSourceMapRuntime)();return x.loadTemplate(e).then(e=>e.render(t,void 0,r)).then(e=>{const{sourceNode:t}=r,{map:a}=t.toStringWithSourceMap();return{data:e,sourceMap:JSON.parse(a.toString())}})},resolveTemplate:(e,t)=>{const r=a=>{if(a<e.length){const n=e[a];return null===n?r(a+1):"string"!=typeof n?Promise.resolve(n):x.loadTemplate(n,t).catch(()=>r(a+1))}return Promise.reject((0,loader_1.createTemplateLoadingError)(e.map(e=>null===e?"":e),void 0,t))};return r(0)},setGlobal:(e,t)=>{m.set(e,t)},tokenize:e=>{g||(g=(0,lexer_1.createLexer)(a.binaryOperators,a.unaryOperators));const t=g.tokenizeSource(e);return(0,token_stream_1.createTokenStream)(t.toAst(),t.source)}};return x}exports.createEnvironment=createEnvironment;

},{"./error/loader":7,"./error/runtime":9,"./escaping-stragegy/css":10,"./escaping-stragegy/html":12,"./escaping-stragegy/html-attribute":11,"./escaping-stragegy/js":13,"./escaping-stragegy/url":14,"./extension-set":15,"./extension/core":16,"./lexer":114,"./markup":119,"./parser":209,"./sandbox/security-policy":216,"./source":218,"./source-map-runtime":217,"./template":241,"./token-stream":243,"create-hash":251,"events":254,"luxon":378,"path":385}],5:[function(require,module,exports){
...
},{"./error/loader":7,"./error/parsing":8,"./error/runtime":9,"./sandbox/security-error":210}],6:[function(require,module,exports){
...
},{"locutus/php/strings/bin2hex":356,"locutus/php/strings/ltrim":359,"utf8-binary-cutter":438}],11:[function(require,module,exports){
...
},{"locutus/php/strings/ord":362}],12:[function(require,module,exports){
...
},{"locutus/php/strings/bin2hex":356,"locutus/php/strings/sprintf":364,"utf8-binary-cutter":438}],14:[function(require,module,exports){
...
},{"locutus/php/url/rawurlencode":371}],15:[function(require,module,exports){
...
},{"capitalize":247}],20:[function(require,module,exports){
...
},{"../../../helpers/iconv":96,"buffer":246}],22:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.date=void 0;const luxon_1=require("luxon"),format_duration_1=require("../../../helpers/format-duration"),format_date_time_1=require("../../../helpers/format-date-time"),date_1=require("../functions/date"),date=(e,t,r,o)=>(0,date_1.date)(e,t,o).then(t=>{const{environment:o}=e;return t instanceof luxon_1.Duration?(null===r&&(r=o.dateIntervalFormat),Promise.resolve((0,format_duration_1.formatDuration)(t,r))):(null===r&&(r=o.dateFormat),Promise.resolve((0,format_date_time_1.formatDateTime)(t,r)))});exports.date=date;

},{"../../../helpers/format-date-time":86,"../../../helpers/format-duration":87,"../functions/date":55,"luxon":378}],24:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.escape=void 0;const markup_1=require("../../../markup"),escape=(e,r,t,p)=>{const{environment:s}=e;return s.escape(e,r,t||!0,p).then(e=>"string"==typeof e?(0,markup_1.createMarkup)(e):e)};exports.escape=escape;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.format=void 0;const sprintf=require("locutus/php/strings/sprintf"),format=(...r)=>Promise.resolve(sprintf(...r));exports.format=format;

},{"locutus/php/strings/sprintf":364}],29:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-map":104,"../../../helpers/merge-iterables":107}],37:[function(require,module,exports){
...
},{"../../../markup":119,"locutus/php/strings/nl2br":360}],38:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.numberFormat=void 0;const phpNumberFormat=require("locutus/php/strings/number_format"),numberFormat=(r,e,t,m,o)=>{const{environment:n}=r;return null===t&&(t=n.numberFormat.numberOfDecimals),null===m&&(m=n.numberFormat.decimalPoint),null===o&&(o=n.numberFormat.thousandSeparator),Promise.resolve(phpNumberFormat(e,t,m,o))};exports.numberFormat=numberFormat;

},{"locutus/php/strings/number_format":361}],39:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-hash":103,"locutus/php/strings/strtr":367}],42:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":104,"../../../helpers/reverse":112,"esrever":253}],43:[function(require,module,exports){
...
},{"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-map":104,"../../../helpers/slice-map":113}],45:[function(require,module,exports){
...
},{"locutus/php/strings/explode":358}],48:[function(require,module,exports){
...
},{"locutus/php/strings/strip_tags":365}],49:[function(require,module,exports){
...
},{"locutus/php/strings/ucwords":369}],50:[function(require,module,exports){
...
},{"../../../error/runtime":9,"locutus/php/strings/ltrim":359,"locutus/php/strings/rtrim":363,"locutus/php/strings/trim":368}],51:[function(require,module,exports){
...
},{"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-hash":103,"locutus/php/url/http_build_query":370}],53:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.date=exports.createDate=void 0;const luxon_1=require("luxon"),modify_date_1=require("../../../helpers/modify-date"),runtime_1=require("../../../error/runtime"),createDate=(e,t,o)=>{const r=e.environment.timezone;try{return Promise.resolve((()=>{let e;if(null===t?e=luxon_1.DateTime.local():"number"==typeof t?e=luxon_1.DateTime.fromMillis(1e3*t):"string"==typeof t?"now"===t?e=luxon_1.DateTime.local():((e=luxon_1.DateTime.fromISO(t,{setZone:!0})).isValid||(e=luxon_1.DateTime.fromRFC2822(t,{setZone:!0})),e.isValid||(e=luxon_1.DateTime.fromSQL(t,{setZone:!0})),!e.isValid&&/^-{0,1}\d+$/.test(t)&&(e=luxon_1.DateTime.fromMillis(1e3*Number.parseInt(t),{setZone:!0})),e.isValid||(e=(0,modify_date_1.modifyDate)(t))):e=t instanceof luxon_1.DateTime?t:luxon_1.DateTime.fromJSDate(t),!e||!e.isValid)throw(0,runtime_1.createRuntimeError)(`Failed to parse date "${t}".`);return!1!==o&&(null===o&&(o=r),e=e.setZone(o)),e})())}catch(e){return Promise.reject(e)}};exports.createDate=createDate;const date=(e,t,o)=>t instanceof luxon_1.Duration?Promise.resolve(t):(0,exports.createDate)(e,t,o);exports.date=date;

},{"../../../error/runtime":9,"../../../helpers/modify-date":108,"luxon":378}],56:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.dump=void 0;const iterate_1=require("../../../helpers/iterate"),is_traversable_1=require("../../../helpers/is-traversable"),iterator_to_hash_1=require("../../../helpers/iterator-to-hash"),count_1=require("../../../helpers/count"),markup_1=require("../../../markup"),varDump=(...e)=>{let r=0,t=function(e){let r="";return r=null==e?"NULL":"boolean"==typeof e?"bool("+e+")":"number"==typeof e?parseFloat(""+e)===parseInt(""+e,10)?"int("+e+")":"float("+e+")":"function"==typeof e?"object(Closure) (0) {}":"string("+e.length+') "'+e+'"'},o=(e,a)=>{(0,is_traversable_1.isTraversable)(e)&&(e=(0,iterator_to_hash_1.iteratorToHash)(e));let n,u=4*(a+1),s=" ".repeat(4*a),l=" ".repeat(u),p="";if("object"==typeof e&&null!==e){p+="array("+(r=(0,count_1.count)(e))+") {\n";for(let r in e){let u=e[r];"object"!=typeof u||null===u||u instanceof Date?(p+=l,p+="[",p+=r,p+="] =>\n",p+=l,p+=n=t(u),p+="\n"):(p+=l,p+="[",p+=r,p+="] =>\n",p+=l,p+=o(u,a+1))}p+=s+"}\n"}else p=t(e)+"\n";return p},a=[];for(let r of e)a.push(o(r,0));return a.join("")},dump=(e,...r)=>{if(r.length<1){const r=new Map;return(0,iterate_1.iterate)(e,(e,t)=>(r.set(e,t),Promise.resolve())).then(()=>(0,markup_1.createMarkup)(varDump(r)))}return Promise.resolve((0,markup_1.createMarkup)(varDump(...r)))};exports.dump=dump;

},{"../../../helpers/count":80,"../../../helpers/is-traversable":100,"../../../helpers/iterate":101,"../../../helpers/iterator-to-hash":103,"../../../markup":119}],57:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.include=void 0;const iterator_to_map_1=require("../../../helpers/iterator-to-map"),merge_iterables_1=require("../../../helpers/merge-iterables"),is_traversable_1=require("../../../helpers/is-traversable"),runtime_1=require("../../../error/runtime"),is_plain_object_1=require("../../../helpers/is-plain-object"),context_1=require("../../../context"),map_like_1=require("../../../helpers/map-like"),markup_1=require("../../../markup");function include(e,r,t,i,a,n,o,s,l){const u=e.environment,_=e.templateName,p=u.isSandboxed;if(!(0,is_plain_object_1.isPlainObject)(n)&&!(0,is_traversable_1.isTraversable)(n)){const e=null==n;return Promise.reject((0,runtime_1.createRuntimeError)(`Variables passed to the "include" function or tag must be iterable, got "${e?n:typeof n}".`,void 0,_))}n=(0,iterator_to_map_1.iteratorToMap)(n),o&&(n=(0,merge_iterables_1.mergeIterables)(r,n)),l&&(p||(u.isSandboxed=!0)),(0,map_like_1.isAMapLike)(a)||(a=new Map([[0,a]]));return(r=>e.environment.resolveTemplate([...r.values()],_).catch(e=>{if(s)return null;throw e}))(a).then(e=>{return t.start(),(e?e.execute((0,context_1.createContext)(e.mergeGlobals(n)),t,void 0,i||void 0):Promise.resolve("")).then(()=>{const e=t.getAndClean();return(0,markup_1.createMarkup)(e)})}).finally(()=>{l&&!p&&(u.isSandboxed=!1)})}exports.include=include;

},{"../../../context":3,"../../../error/runtime":9,"../../../helpers/is-plain-object":99,"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-map":104,"../../../helpers/map-like":106,"../../../helpers/merge-iterables":107,"../../../markup":119}],58:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.source=void 0;const loader_1=require("../../../error/loader"),source=(e,r,o)=>{const t=e.environment,l=e.templateName;return t.loader.getSourceContext(r,l).then(e=>{if(!o&&null===e)throw(0,loader_1.createTemplateLoadingError)([r]);return(null==e?void 0:e.code)||null})};exports.source=source;

},{"../../../error/loader":7}],63:[function(require,module,exports){
"use strict";function templateFromString(e,t,r){return e.environment.createTemplateFromString(t,r)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.templateFromString=void 0,exports.templateFromString=templateFromString;
...
},{"../../../../node_modules/is-buffer/index.js":293,"../markup":119,"./map-like":106,"luxon":378}],79:[function(require,module,exports){
...
},{"pad":384}],88:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getAttribute=void 0;const map_like_1=require("./map-like"),runtime_1=require("../error/runtime"),examine_object_1=require("./examine-object"),is_plain_object_1=require("./is-plain-object"),get_1=require("./get"),isBool=require("locutus/php/var/is_bool"),isFloat=require("locutus/php/var/is_float"),isObject=require("isobject"),getAttribute=(e,t,i,r,o,s,a)=>{a=null===a?!e.isStrictVariables:a;const{isSandboxed:l}=e;try{return Promise.resolve((()=>{let n;if("method"!==o){let r;if(r=isBool(i)?i?1:0:isFloat(i)?parseInt(i):i,t&&((0,map_like_1.isAMapLike)(t)&&t.has(r)||(0,is_plain_object_1.isPlainObject)(t)&&Reflect.has(t,r)))return!!s||("array"!==o&&l&&e.sandboxPolicy.checkPropertyAllowed(t,i),(0,get_1.get)(t,r));if("array"===o||(0,map_like_1.isAMapLike)(t)||null===t||"object"!=typeof t){if(s)return!1;if(a)return;throw n=(0,map_like_1.isAMapLike)(t)?t.size<1?`Index "${r}" is out of bounds as the array is empty.`:`Index "${r}" is out of bounds for array [${[...t.values()]}].`:"array"===o?null===t?`Impossible to access a key ("${i}") on a null variable.`:`Impossible to access a key ("${i}") on a ${typeof t} variable ("${t.toString()}").`:null===t?`Impossible to access an attribute ("${i}") on a null variable.`:`Impossible to access an attribute ("${i}") on a ${typeof t} variable ("${t}").`,(0,runtime_1.createRuntimeError)(n)}}if(null===t||!isObject(t)||(0,map_like_1.isAMapLike)(t)){if(s)return!1;if(a)return;throw n=null===t?`Impossible to invoke a method ("${i}") on a null variable.`:(0,map_like_1.isAMapLike)(t)?`Impossible to invoke a method ("${i}") on an array.`:`Impossible to invoke a method ("${i}") on a ${typeof t} variable ("${t}").`,(0,runtime_1.createRuntimeError)(n)}if("method"!==o&&Reflect.has(t,i)&&"function"!=typeof t[i])return!!s||(l&&e.sandboxPolicy.checkPropertyAllowed(t,i),(0,get_1.get)(t,i));let u=[];for(let e of(0,examine_object_1.examineObject)(t))"function"==typeof t[e]&&u.push(e);u.sort();let c=u.map(e=>e.toLowerCase()),p=new Map;for(let e=0;e<u.length;e++){let t=u[e],i=c[e];p.set(t,t),p.set(i,t);let r="";if("g"===i[0]&&0===i.indexOf("get"))r=t.substr(3),i=i.substr(3);else if("i"===i[0]&&0===i.indexOf("is"))r=t.substr(2),i=i.substr(2);else{if("h"!==i[0]||0!==i.indexOf("has"))continue;if(r=t.substr(3),i=i.substr(3),c.includes("is"+i))continue}r.length>0&&(p.has(r)||p.set(r,t),p.has(i)||p.set(i,t))}let b,f,m=i;if(p.has(i))b=p.get(i);else{if(!p.has(f=m.toLowerCase())){if(s)return!1;if(a)return;throw(0,runtime_1.createRuntimeError)(`Neither the property "${i}" nor one of the methods ${i}()" or "get${i}()"/"is${i}()"/"has${i}()" exist and have public access in class "${t.constructor.name}".`)}b=p.get(f)}return!!s||(l&&e.sandboxPolicy.checkMethodAllowed(t,b),(0,get_1.get)(t,b).apply(t,[...r.values()]))})())}catch(e){return Promise.reject(e)}};exports.getAttribute=getAttribute;

},{"../error/runtime":9,"./examine-object":84,"./get":95,"./is-plain-object":99,"./map-like":106,"isobject":296,"locutus/php/var/is_bool":373,"locutus/php/var/is_float":374}],89:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getContextValue=void 0;const runtime_1=require("../error/runtime"),getContextValue=(e,t,r,s,i,o)=>{const{environment:n}=e,a=new Map([["_self",e.templateName],["_context",t],["_charset",n.charset]]),l=()=>a.has(r);let u;if(o)u=!!l()||t.has(r);else if(l())u=a.get(r);else if(s)u=t.get(r);else if(i||!n.isStrictVariables)u=t.has(r)?t.get(r):null;else if(void 0===(u=t.get(r)))return Promise.reject((0,runtime_1.createRuntimeError)(`Variable "${r}" does not exist.`));return Promise.resolve(u)};exports.getContextValue=getContextValue;
...
},{"./iterator-to-map":104,"./map-like":106}],96:[function(require,module,exports){
...
},{"../markup":119,"./compare":78,"./is-traversable":100,"./iterator-to-array":102,"./map-like":106}],98:[function(require,module,exports){
...
},{"luxon":378}],109:[function(require,module,exports){
...
},{"regex-parser":403}],110:[function(require,module,exports){
...
"use strict";function sliceMap(e,t,s,i){let r=new Map,o=0,p=0;t<0&&(t=e.size+t);for(let[l,a]of e){if(o>=t&&o<t+s){let e;"number"==typeof l?(e=i?l:p,p++):e=l,r.set(e,a)}if(o>=t+s)break;o++}return r}Object.defineProperty(exports,"__esModule",{value:!0}),exports.sliceMap=void 0,exports.sliceMap=sliceMap;

},{}],114:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createLexer=exports.TwingLexer=exports.typeToEnglish=void 0;const twig_lexer_1=require("twig-lexer"),token_stream_1=require("./token-stream"),parsing_1=require("./error/parsing"),typeToEnglish=e=>{switch(e){case twig_lexer_1.TokenType.EOF:return"end of template";case twig_lexer_1.TokenType.TEXT:return"text";case twig_lexer_1.TokenType.TAG_START:return"begin of statement block";case twig_lexer_1.TokenType.VARIABLE_START:return"begin of print statement";case twig_lexer_1.TokenType.TAG_END:return"end of statement block";case twig_lexer_1.TokenType.VARIABLE_END:return"end of print statement";case twig_lexer_1.TokenType.NAME:return"name";case twig_lexer_1.TokenType.NUMBER:return"number";case twig_lexer_1.TokenType.STRING:return"string";case twig_lexer_1.TokenType.OPERATOR:return"operator";case twig_lexer_1.TokenType.PUNCTUATION:return"punctuation";case twig_lexer_1.TokenType.INTERPOLATION_START:return"begin of string interpolation";case twig_lexer_1.TokenType.INTERPOLATION_END:return"end of string interpolation";case twig_lexer_1.TokenType.COMMENT_START:return"begin of comment statement";case twig_lexer_1.TokenType.COMMENT_END:return"end of comment statement";case twig_lexer_1.TokenType.ARROW:return"arrow function";default:throw new Error(`Token of type "${e}" does not exist.`)}};exports.typeToEnglish=typeToEnglish;class TwingLexer extends twig_lexer_1.Lexer{constructor(e,r){super();for(let t of[e,r])for(let[e]of t)this.operators.includes(e)||this.operators.push(e)}tokenizeSource(e){try{const r=this.tokenize(e.code);return(0,token_stream_1.createTokenStream)(r,e)}catch(r){const{message:t,line:n,column:o}=r;throw(0,parsing_1.createParsingError)(t,{line:n,column:o},e.resolvedName,r)}}}exports.TwingLexer=TwingLexer;const createLexer=(e,r)=>new TwingLexer(e,r);exports.createLexer=createLexer;

},{"./error/parsing":8,"./token-stream":243,"twig-lexer":431}],115:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createArrayLoader=void 0;const iterator_to_map_1=require("../helpers/iterator-to-map"),source_1=require("../source"),createArrayLoader=e=>{const r=(0,iterator_to_map_1.iteratorToMap)(e),t={setTemplate:(e,t)=>{r.set(e,t)},getSourceContext:(e,o)=>t.exists(e,o).then(t=>t?(0,source_1.createSource)(e,r.get(e)):null),exists:e=>Promise.resolve(r.has(e)),getCacheKey:(e,o)=>t.exists(e,o).then(t=>t?e+":"+r.get(e):null),isFresh:()=>Promise.resolve(!0),resolve:(e,r)=>t.exists(e,r).then(r=>r?e:null)};return t};exports.createArrayLoader=createArrayLoader;

},{"../helpers/iterator-to-map":104,"../source":218}],116:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createChainLoader=void 0;const createChainLoader=e=>{let r=new Map;return{get loaders(){return e},addLoader:t=>{e.push(t),r=new Map},exists:(t,n)=>{const s=r.get(t);if(s)return Promise.resolve(s);const l=s=>{if(s<e.length){return e[s].exists(t,n).then(e=>(r.set(t,e),!!e||l(s+1)))}return Promise.resolve(!1)};return l(0).then(e=>(r.set(t,e),e))},getCacheKey:(r,t)=>{const n=s=>{if(s<e.length){const l=e[s];return l.exists(r,t).then(e=>e?l.getCacheKey(r,t):n(s+1)).then(e=>null===e?n(s+1):e)}return Promise.resolve(null)};return n(0).then(e=>e||null)},getSourceContext:(r,t)=>{const n=s=>{if(s<e.length){return e[s].getSourceContext(r,t).then(e=>null===e?n(s+1):e)}return Promise.resolve(null)};return n(0).then(e=>e||null)},isFresh:(r,t,n)=>{const s=l=>{if(l<e.length){return e[l].isFresh(r,t,n).then(e=>null===e?s(l+1):e)}return Promise.resolve(null)};return s(0)},resolve:(r,t)=>{const n=s=>{if(s<e.length){return e[s].resolve(r,t).then(e=>null===e?n(s+1):e)}return Promise.resolve(null)};return n(0).then(e=>null===e?null:e)}}};exports.createChainLoader=createChainLoader;

},{}],117:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createFilesystemLoader=exports.MAIN_NAMESPACE=void 0;const path_1=require("path"),source_1=require("../source"),rtrim=require("locutus/php/strings/rtrim");exports.MAIN_NAMESPACE="__main__";const createFilesystemLoader=(e,t=[],r=null)=>{const s=new Map;let o=new Map;const n=r||".",i=t=>new Promise(r=>{e.stat(t,(e,t)=>{r(e?null:t)})}),l=e=>{e=a(e);const t=o.get(e);if(t)return Promise.resolve(t);const[r,l]=u(e),p=s.get(r);if(!p)return Promise.resolve(null);const c=async t=>{if(t<p.length){let r=p[t];(0,path_1.isAbsolute)(r)||(r=(0,path_1.join)(n,r));const s=await i((0,path_1.join)(r,l));if(s&&s.isFile()){const t=(0,path_1.resolve)((0,path_1.join)(r,l));return o.set(e,t),Promise.resolve(t)}return c(t+1)}return Promise.resolve(null)};return c(0)},a=e=>e.replace(/\\/g,"/").replace(/\/{2,}/g,"/"),u=(e,t=exports.MAIN_NAMESPACE)=>{if("@"===e[0]){let t=e.indexOf("/");if(t>=0){return[e.substr(1,t-1),e.substr(t+1)]}}return[t,e]},p=(e,t=exports.MAIN_NAMESPACE)=>{o=new Map;let r=s.get(t);r||(r=[],s.set(t,r)),r.push(rtrim(e,"/\\\\"))},c=(e,t=exports.MAIN_NAMESPACE)=>{Array.isArray(e)||(e=[e]),s.set(t,[]);for(const r of e)p(r,t)};return c(t),{addPath:p,exists:e=>(e=a(e),o.has(e)?Promise.resolve(!0):l(e).then(e=>null!==e)),getCacheKey:e=>l(e).then(e=>null===e?null:(0,path_1.relative)(n,e)),getNamespaces:()=>[...s.keys()],getPaths:(e=exports.MAIN_NAMESPACE)=>{return s.get(e)||[]},getSourceContext:t=>l(t).then(r=>null===r?null:new Promise((s,o)=>{e.readFile(r,(e,n)=>{e?o(e):s((0,source_1.createSource)(t,n.toString(),r))})})),isFresh:(e,t)=>l(e).then(e=>null===e||i(e).then(e=>e.mtime.getTime()<=t)),prependPath:(e,t=exports.MAIN_NAMESPACE)=>{o=new Map,e=rtrim(e,"/\\\\");const r=s.get(t);r?r.unshift(e):s.set(t,[e])},resolve:e=>l(e),setPaths:c}};exports.createFilesystemLoader=createFilesystemLoader;

},{"../source":218,"locutus/php/strings/rtrim":363,"path":385}],118:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createRelativeFilesystemLoader=void 0;const path_1=require("path"),source_1=require("../source"),createRelativeFilesystemLoader=e=>{let t=new Map;const r=t=>new Promise(r=>{e.stat(t,(e,t)=>{r(e?null:t)})}),s=(e,s)=>{return(()=>{e=l(o(e,s));const i=t.get(e);return i?Promise.resolve(i):r(e).then(r=>{if(null==r?void 0:r.isFile()){const r=(0,path_1.resolve)(e);return t.set(e,r),r}return null})})()},l=e=>e.replace(/\\/g,"/").replace(/\/{2,}/g,"/"),o=(e,t)=>(e&&t&&!(0,path_1.isAbsolute)(e)&&(e=(0,path_1.join)((0,path_1.dirname)(t),e)),e);return{exists:(e,r)=>(e=l(o(e,r)),t.has(e)?Promise.resolve(!0):s(e,r).then(e=>null!==e)),isFresh:(e,t,l)=>s(e,l).then(e=>null===e||r(e).then(e=>e.mtime.getTime()<=t)),getCacheKey:(e,t)=>Promise.resolve(l(o(e,t))),getSourceContext:(t,r)=>s(t,r).then(r=>null===r?null:new Promise((s,l)=>{e.readFile(r,(e,o)=>{e?l(e):s((0,source_1.createSource)(t,o.toString(),r))})})),resolve:(e,t)=>s(e,t)}};exports.createRelativeFilesystemLoader=createRelativeFilesystemLoader;

},{"../source":218,"path":385}],119:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"./helpers/iconv":96,"buffer":246}],120:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createNodeTraverser=void 0;const node_1=require("./node"),ksort_1=require("./helpers/ksort"),push_1=require("./helpers/push"),createNodeTraverser=e=>{const r=new Map;for(const o of e){let e=r.get(o.priority);e||(e=new Map,r.set(o.priority,e)),(0,push_1.push)(e,o)}const o=(e,r)=>{r=e.enterNode(r);for(const[t,s]of(0,node_1.getChildren)(r)){const n=o(e,s);n?n!==s&&(r.children[t]=n):delete r.children[t]}return e.leaveNode(r)};return e=>{let t=e;(0,ksort_1.ksort)(r);for(const[,s]of r)for(const[,r]of s)t=o(r,e);return t}};exports.createNodeTraverser=createNodeTraverser;

},{"./helpers/ksort":105,"./helpers/push":110,"./node":126}],121:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createNodeVisitor=void 0;const createNodeVisitor=(e,t,r)=>({enterNode:e,leaveNode:t,get priority(){return r}});exports.createNodeVisitor=createNodeVisitor;

},{}],122:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createCoreNodeVisitor=void 0;const attribute_accessor_1=require("../node/expression/attribute-accessor"),name_1=require("../node/expression/name"),block_function_1=require("../node/expression/block-function"),constant_1=require("../node/expression/constant"),method_call_1=require("../node/expression/method-call"),parsing_1=require("../error/parsing"),test_1=require("../node/expression/call/test"),array_1=require("../node/expression/array"),conditional_1=require("../node/expression/conditional"),function_1=require("../node/expression/call/function"),filter_1=require("../node/expression/call/filter"),createCoreNodeVisitor=()=>{const e=[];return{enterNode:t=>{if(!e.includes(t)){if(e.push(t),t.is(filter_1.filterNodeType)&&"default"===t.attributes.operatorName)return(e=>{const{line:t,column:r}=e,{arguments:i}=e.children,o=e.children.operand;let s;if(o.is("name")||o.is("get_attribute")){const n=(0,test_1.createTestNode)(o,"defined",(0,array_1.createArrayNode)([],t,r),t,r),a=(0,array_1.getKeyValuePairs)(i).map(({value:e})=>e),c=a.length>0?a[0]:(0,constant_1.createConstantNode)("",t,r);s=(0,conditional_1.createConditionalNode)(n,e,c,t,r)}else s=e;return s})(t);if(t.is(test_1.testNodeType)&&"defined"===t.attributes.operatorName)return(e=>{const t=e.children.operand;if(!(t.is("name")||t.is("get_attribute")||t.is("block_reference_expression")||t.is("constant")||t.is("array")||t.is("method_call")||t.is(function_1.functionNodeType)&&"constant"===t.attributes.operatorName))throw(0,parsing_1.createParsingError)('The "defined" test only works with simple variables.',e);let r;if(t.is("block_reference_expression")){const e=(0,block_function_1.cloneBlockReferenceExpressionNode)(t);e.attributes.shouldTestExistence=!0,r=e}else if(t.is("constant")||t.is("array"))r=(0,constant_1.createConstantNode)(!0,t.line,t.column);else if(t.is("name")){const e=(0,name_1.cloneNameNode)(t);e.attributes.shouldTestExistence=!0,r=e}else if(t.is("method_call")){const e=(0,method_call_1.cloneMethodCallNode)(t);e.attributes.shouldTestExistence=!0,r=e}else if(t.is("get_attribute")){const e=(0,attribute_accessor_1.cloneGetAttributeNode)(t);e.attributes.shouldTestExistence=!0;const i=e=>{if(e.attributes.isOptimizable=!1,e.attributes.shouldIgnoreStrictCheck=!0,e.children.target.is("get_attribute")){const t=(0,attribute_accessor_1.cloneGetAttributeNode)(e.children.target);i(t),e.children.target=t}};i(e),r=e}else r=t;return e.children.operand=r,e})(t)}return t},leaveNode:e=>e.is("get_attribute")?(e=>{const{shouldIgnoreStrictCheck:t}=e.attributes,{target:r}=e.children;if(t&&r.is("name")){const t=(0,name_1.cloneNameNode)(r);t.attributes.shouldIgnoreStrictCheck=!0,e.children.target=t}return e})(e):e,priority:0}};exports.createCoreNodeVisitor=createCoreNodeVisitor;

},{"../error/parsing":8,"../node/expression/array":138,"../node/expression/attribute-accessor":141,"../node/expression/block-function":168,"../node/expression/call/filter":170,"../node/expression/call/function":171,"../node/expression/call/test":172,"../node/expression/conditional":173,"../node/expression/constant":174,"../node/expression/method-call":177,"../node/expression/name":178}],123:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEscaperNodeVisitor=void 0;const filter_1=require("../node/expression/call/filter"),print_1=require("../node/output/print"),do_1=require("../node/do"),conditional_1=require("../node/expression/conditional"),inline_print_1=require("../node/output/inline-print"),escape_1=require("../node/expression/escape"),node_visitor_1=require("../node-visitor"),get_filter_1=require("../helpers/get-filter"),get_function_1=require("../helpers/get-function"),function_1=require("../node/expression/call/function"),createEscaperNodeVisitor=(e,i)=>{const t=new Map,n=[];let r=new Map;const o=n=>{let r=t.get(n);if(void 0===r){if(n.is("constant"))r=["all"];else if(n.is("block_reference_expression"))r=["all"];else if(n.is("parent"))r=["all"];else if(n.is("conditional")){const{expr2:e,expr3:i}=n.children;r=l(o(e),o(i))}else if(n.is(filter_1.filterNodeType)){const{arguments:i}=n.children,{operatorName:t}=n.attributes,{operand:s}=n.children,c=(0,get_filter_1.getFilter)(e,t);c?(r=c.getSafe(i))&&r.length<1&&(r=l(o(s),c.preservesSafety)):r=[]}else if(n.is(function_1.functionNodeType)){const{operatorName:e}=n.attributes,{arguments:t}=n.children,o=(0,get_function_1.getFunction)(i,e);r=o?o.getSafe(t):[]}else r=n.is("method_call")?["all"]:[];t.set(n,r)}return r},l=(e,i)=>e.includes("all")?i:i.includes("all")?e:e.filter(e=>i.includes(e)),s=()=>!n.length||n[n.length-1],c=(e,i)=>{const{line:t,column:n}=i;return(0,escape_1.createEscapeNode)(i,e,t,n)},a=(e,i)=>{const{expr2:t,expr3:n}=e.children;return f(i,t)!==f(i,n)},u=(e,i)=>{let{expr1:t,expr2:n,expr3:r}=e.children;return n=n.is("conditional")&&a(n,i)?u(n,i):d((0,inline_print_1.createInlinePrintNode)(n,n.line,n.column),i),r=r.is("conditional")&&a(r,i)?u(r,i):d((0,inline_print_1.createInlinePrintNode)(r,r.line,r.column),i),(0,conditional_1.createConditionalNode)(t,n,r,e.line,e.column)},d=(e,i)=>{const t=e.children.node;return f(i,t)?e:(0,inline_print_1.createInlinePrintNode)(c(i,t),e.line,e.column)},p=(e,i)=>{const t=e.children.expr;return f(i,t)?e:(0,print_1.createPrintNode)(c(i,t),e.line,e.column)},_=i=>{const t=i.attributes.operatorName,n=(0,get_filter_1.getFilter)(e,t);if(!n)return i;const r=n.preEscape;if(null===r)return i;const o=i.children.operand;return f(r,o)?i:(i.children.operand=c(r,o),i)},f=(e,i)=>{let n=t.get(i);return void 0===n&&(n=o(i)),n.includes(e)||n.includes("all")};return(0,node_visitor_1.createNodeVisitor)(e=>{if(e.is("module"))r=new Map;else if(e.is("auto_escape")){const{strategy:i}=e.attributes;n.push(!0===i?"html":null!==i&&i)}else if(e.is("block")){const i=r.get(e.attributes.name);n.push(void 0!==i?i:s())}return e},e=>{if("module"===e.type)r=new Map;else{if(e.is(filter_1.filterNodeType))return _(e);if(e.is("print")){const i=s();if(!1!==i){const{expr:t}=e.children;return t.is("conditional")&&a(t,i)?(0,do_1.createDoNode)(u(t,i),t.line,t.column,null):p(e,i)}}}return e.is("auto_escape")||e.is("block")?n.pop():e.is("block_reference")&&r.set(e.attributes.name,s()),e},0)};exports.createEscaperNodeVisitor=createEscaperNodeVisitor;

},{"../helpers/get-filter":91,"../helpers/get-function":93,"../node-visitor":121,"../node/do":135,"../node/expression/call/filter":170,"../node/expression/call/function":171,"../node/expression/conditional":173,"../node/expression/escape":175,"../node/output/inline-print":198,"../node/output/print":199}],124:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createMacroAutoImportNodeVisitor=void 0;const method_call_1=require("../node/expression/method-call"),node_visitor_1=require("../node-visitor"),createMacroAutoImportNodeVisitor=()=>(0,node_visitor_1.createNodeVisitor)(e=>e,e=>{if(e.is("get_attribute")&&e.children.target.is("name")&&"_self"===e.children.target.attributes.name&&e.children.attribute.is("constant")){const t=e.children.attribute.attributes.value;e=(0,method_call_1.createMethodCallNode)(e.children.target,t,e.children.arguments,e.line,e.column)}return e},-10);exports.createMacroAutoImportNodeVisitor=createMacroAutoImportNodeVisitor;

},{"../node-visitor":121,"../node/expression/method-call":177}],125:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSandboxNodeVisitor=void 0;const node_1=require("../node"),check_security_1=require("../node/check-security"),check_to_string_1=require("../node/check-to-string"),node_visitor_1=require("../node-visitor"),function_1=require("../node/expression/call/function"),filter_1=require("../node/expression/call/filter"),createSandboxNodeVisitor=()=>{let e,t,i,r=!0;const o=(e,t)=>{const i=e.children[t];(i.is("name")||i.is("get_attribute"))&&(e.children[t]=(0,check_to_string_1.createCheckToStringNode)(i,i.line,i.column))},n=(e,t)=>{const i=e.children[t];for(const[e]of(0,node_1.getChildren)(i))o(i,e)};return(0,node_visitor_1.createNodeVisitor)(s=>{if(s.is("module"))return e=new Map,t=new Map,i=new Map,s;{const{tag:c}=s;if(c&&!e.has(c)&&e.set(c,s),s.is(filter_1.filterNodeType)){const{operatorName:e}=s.attributes;t.has(e)||t.set(e,s)}if(s.is(function_1.functionNodeType)){const{operatorName:e}=s.attributes;i.has(e)||i.set(e,s)}s.is("range")&&!i.has("range")&&i.set("range",s),s.is("print")&&(r=!0,o(s,"expr")),s.is("set")&&(r=!0),r&&(s.is("concat")&&(o(s,"left"),o(s,"right")),s.is(filter_1.filterNodeType)&&(o(s,"operand"),n(s,"arguments")),s.is(function_1.functionNodeType)&&n(s,"arguments"),s.is("escape")&&o(s,"body"))}return s},o=>(o.is("module")?o.children.securityCheck=(0,check_security_1.createCheckSecurityNode)(t,e,i,o.line,o.column):(o.is("print")||o.is("set"))&&(r=!1),o),0)};exports.createSandboxNodeVisitor=createSandboxNodeVisitor;

},{"../node":126,"../node-visitor":121,"../node/check-security":131,"../node/check-to-string":132,"../node/expression/call/filter":170,"../node/expression/call/function":171}],126:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBaseNode=exports.getChildrenCount=exports.getChildren=void 0;const var_export=require("locutus/php/var/var_export"),getChildren=e=>Object.entries(e.children);exports.getChildren=getChildren;const getChildrenCount=e=>Object.keys(e.children).length;exports.getChildrenCount=getChildrenCount;const createBaseNode=(e,t={},r={},o=0,n=0,s=null)=>{const i={attributes:t,children:r,column:n,line:o,tag:s,isACaptureNode:!1,isAnOutputNode:!1,execute:async(...e)=>{const t=[];for(const[,r]of(0,exports.getChildren)(i))t.push(await r.execute(...e));return t},is:e=>e===i.type,toString:()=>{const e=[],t=e=>e&&void 0!==e.type&&void 0!==e.attributes&&void 0!==e.children;for(const[r,o]of Object.entries(i.attributes)){const n=t(o)?o.toString():String(var_export(o,!0));e.push(`${r}: ${n.replace(/\n/g,"")}`)}e.push(`line: ${o}`),e.push(`column: ${n}`);const r=[`Node<${i.type?'"'+i.type+'"':"null"}, ${e.join(", ")}> (`];if((0,exports.getChildrenCount)(i)){for(let[e,t]of(0,exports.getChildren)(i)){const o=(""+e).length+4,n=[];for(let e of t.toString().split("\n"))n.push(" ".repeat(o)+e);r.push(`  ${e}: ${n.join("\n").trimLeft()}`)}r.push(")")}else r[0]+=")";return r.join("\n")},type:e};return i};exports.createBaseNode=createBaseNode;

},{"locutus/php/var/var_export":375}],127:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createApplyNode=exports.applyNodeType=void 0;const node_1=require("../node"),array_1=require("./expression/array"),filter_1=require("./expression/call/filter"),constant_1=require("./expression/constant");exports.applyNodeType="apply";const createApplyNode=(e,t,r,o)=>{const a=(0,node_1.createBaseNode)(exports.applyNodeType,{},{body:t,filters:e},r,o,"apply"),s=Object.assign(Object.assign({},a),{execute:async(...e)=>{const t=e[2],{body:r,filters:o}=s.children,{line:a,column:n}=s;return t.start(),r.execute(...e).then(async()=>{let r=t.getAndClean();const s=(0,array_1.getKeyValuePairs)(o);for(;s.length>0;){const{key:t,value:o}=s.pop(),p=t.attributes.value,c=(0,filter_1.createFilterNode)((0,constant_1.createConstantNode)(r,a,n),p,o,a,n);r=await c.execute(...e)}t.echo(r)})}});return s};exports.createApplyNode=createApplyNode;

},{"../node":126,"./expression/array":138,"./expression/call/filter":170,"./expression/constant":174}],128:[function(require,module,exports){
...
},{"../node":126}],129:[function(require,module,exports){
...
},{"../node":126}],130:[function(require,module,exports){
...
},{"../node":126}],131:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createCheckSecurityNode=void 0;const node_1=require("../node"),security_not_allowed_filter_error_1=require("../sandbox/security-not-allowed-filter-error"),security_not_allowed_tag_error_1=require("../sandbox/security-not-allowed-tag-error"),createCheckSecurityNode=(e,r,t,o,s)=>{const c=(0,node_1.createBaseNode)("check_security",{usedFilters:e,usedTags:r,usedFunctions:t},{},o,s);return Object.assign(Object.assign({},c),{execute:e=>{const{environment:r}=e,{usedTags:t,usedFunctions:o,usedFilters:s}=c.attributes;try{r.isSandboxed&&r.sandboxPolicy.checkSecurity([...t.keys()],[...s.keys()],[...o.keys()])}catch(r){throw(r=>{r.source=e.templateName,(0,security_not_allowed_tag_error_1.isASandboxSecurityNotAllowedTagError)(r)?r.location=t.get(r.tagName):(0,security_not_allowed_filter_error_1.isASandboxSecurityNotAllowedFilterError)(r)?r.location=s.get(r.filterName):r.location=o.get(r.functionName)})(r),r}return Promise.resolve()}})};exports.createCheckSecurityNode=createCheckSecurityNode;

},{"../node":126,"../sandbox/security-not-allowed-filter-error":211,"../sandbox/security-not-allowed-tag-error":215}],132:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createCheckToStringNode=void 0;const node_1=require("../node"),createCheckToStringNode=(e,t,r)=>{const o=(0,node_1.createBaseNode)("check_to_string",{},{expr:e},t,r);return Object.assign(Object.assign({},o),{execute:(...e)=>{const[t]=e,{expr:r}=o.children;return r.execute(...e).then(e=>(t.assertToStringAllowed(e),e))}})};exports.createCheckToStringNode=createCheckToStringNode;

},{"../node":126}],133:[function(require,module,exports){
...
},{"../node":126}],134:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createDeprecatedNode=void 0;const node_1=require("../node"),createDeprecatedNode=(e,t,r,c)=>{const o=(0,node_1.createBaseNode)("deprecated",{},{expr:e},t,r,c),n=Object.assign(Object.assign({},o),{execute:(e,...t)=>{const{expr:r}=n.children;return r.execute(e,...t).then(t=>{console.warn(`${t} ("${e.templateName}" at line ${n.line}, column ${n.column})`)})}});return n};exports.createDeprecatedNode=createDeprecatedNode;

},{"../node":126}],135:[function(require,module,exports){
...
},{"../node":126}],136:[function(require,module,exports){
...
},{"../node":126}],137:[function(require,module,exports){
...
},{"../expression":136}],138:[function(require,module,exports){
...
},{"../../helpers/record":111,"../expression":136,"./constant":174,"locutus/php/array/array_chunk":301}],139:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createArrowFunctionNode=void 0;const expression_1=require("../expression"),createArrowFunctionNode=(e,r,t,o)=>{const n=(0,expression_1.createBaseExpressionNode)("arrow_function",{},{expr:e,names:r},t,o);return Object.assign(Object.assign({},n),{execute:(...e)=>{const[,r]=e,{expr:t}=n.children,o=Object.values(n.children.names.children);return Promise.resolve((...n)=>{let s=0;for(const e of o){const{name:t}=e.attributes;r.set(t,n[s]),s++}return t.execute(...e)})}})};exports.createArrowFunctionNode=createArrowFunctionNode;

},{"../expression":136}],140:[function(require,module,exports){
...
},{"../../node":126}],141:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cloneGetAttributeNode=exports.createAttributeAccessorNode=void 0;const expression_1=require("../expression"),get_attribute_1=require("../../helpers/get-attribute"),createAttributeAccessorNode=(e,t,r,s,o,c)=>{const i=(0,expression_1.createBaseExpressionNode)("get_attribute",{isOptimizable:!0,type:s,shouldTestExistence:!1},{target:e,attribute:t,arguments:r},o,c),u=Object.assign(Object.assign({},i),{execute:(...e)=>{const[t]=e,{target:r,attribute:s,arguments:o}=u.children,{type:c,shouldIgnoreStrictCheck:i,shouldTestExistence:n}=u.attributes,{environment:a}=t;return Promise.all([r.execute(...e),s.execute(...e),o.execute(...e)]).then(([e,r,s])=>{return t.getTraceableMethod(get_attribute_1.getAttribute,u.line,u.column,t.templateName)(a,e,r,s,c,n,i||null)})}});return u};exports.createAttributeAccessorNode=createAttributeAccessorNode;const cloneGetAttributeNode=e=>{const{children:t,attributes:r,line:s,column:o}=e,{arguments:c,attribute:i,target:u}=t,{type:n}=r;return(0,exports.createAttributeAccessorNode)(u,i,c,n,s,o)};exports.cloneGetAttributeNode=cloneGetAttributeNode;

},{"../../helpers/get-attribute":88,"../expression":136}],142:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBinaryNodeFactory=exports.createBaseBinaryNode=void 0;const expression_1=require("../expression"),createBaseBinaryNode=(e,r,t,a)=>{const s=(0,expression_1.createBaseExpressionNode)(e,{},{left:r[0],right:r[1]},t,a);return Object.assign({},s)};exports.createBaseBinaryNode=createBaseBinaryNode;const createBinaryNodeFactory=(e,r)=>{return(t,a,s)=>{const o=(0,exports.createBaseBinaryNode)(e,t,a,s);return Object.assign(Object.assign({},o),{execute:(...e)=>r.execute(o,...e)})}};exports.createBinaryNodeFactory=createBinaryNodeFactory;

},{"../expression":136}],143:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createAddNode=exports.addNodeType=void 0;const binary_1=require("../binary");exports.addNodeType="add",exports.createAddNode=(0,binary_1.createBinaryNodeFactory)(exports.addNodeType,{execute:async(e,...t)=>{const{left:r,right:d}=e.children;return await r.execute(...t)+await d.execute(...t)}});

},{"../binary":142}],144:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createAndNode=exports.andNodeType=void 0;const binary_1=require("../binary");exports.andNodeType="and",exports.createAndNode=(0,binary_1.createBinaryNodeFactory)(exports.andNodeType,{execute:async(e,...t)=>{const{left:r,right:a}=e.children;return!(!await r.execute(...t)||!await a.execute(...t))}});

},{"../binary":142}],145:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBitwiseAndNode=exports.bitwiseAndNodeType=void 0;const binary_1=require("../binary");exports.bitwiseAndNodeType="bitwise_and",exports.createBitwiseAndNode=(0,binary_1.createBinaryNodeFactory)(exports.bitwiseAndNodeType,{execute:async(e,...t)=>{const{left:i,right:r}=e.children;return await i.execute(...t)&await r.execute(...t)}});

},{"../binary":142}],146:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBitwiseOrNode=exports.bitwiseOrNodeType=void 0;const binary_1=require("../binary");exports.bitwiseOrNodeType="bitwise_or",exports.createBitwiseOrNode=(0,binary_1.createBinaryNodeFactory)(exports.bitwiseOrNodeType,{execute:async(e,...t)=>{const{left:r,right:i}=e.children;return await r.execute(...t)|await i.execute(...t)}});

},{"../binary":142}],147:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBitwiseXorNode=exports.bitwiseXorNodeType=void 0;const binary_1=require("../binary");exports.bitwiseXorNodeType="bitwise_xor",exports.createBitwiseXorNode=(0,binary_1.createBinaryNodeFactory)(exports.bitwiseXorNodeType,{execute:async(e,...t)=>{const{left:r,right:i}=e.children;return await r.execute(...t)^await i.execute(...t)}});

},{"../binary":142}],148:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createConcatenateNode=exports.concatenateNodeTYpe=void 0;const binary_1=require("../binary"),concatenate_1=require("../../../helpers/concatenate");exports.concatenateNodeTYpe="concat",exports.createConcatenateNode=(0,binary_1.createBinaryNodeFactory)(exports.concatenateNodeTYpe,{execute:async(e,...t)=>{const{left:a,right:c}=e.children,n=await a.execute(...t),o=await c.execute(...t);return(0,concatenate_1.concatenate)(n,o)}});

},{"../../../helpers/concatenate":79,"../binary":142}],149:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createDivideAndFloorNode=exports.divideAndFloorNodeType=void 0;const binary_1=require("../binary");exports.divideAndFloorNodeType="floor_div",exports.createDivideAndFloorNode=(0,binary_1.createBinaryNodeFactory)(exports.divideAndFloorNodeType,{execute:async(e,...o)=>{const{left:r,right:t}=e.children;return Math.floor(await r.execute(...o)/await t.execute(...o))}});

},{"../binary":142}],150:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createDivideNode=exports.divideNodeType=void 0;const binary_1=require("../binary");exports.divideNodeType="div",exports.createDivideNode=(0,binary_1.createBinaryNodeFactory)(exports.divideNodeType,{execute:async(e,...t)=>{const{left:i,right:r}=e.children;return await i.execute(...t)/await r.execute(...t)}});

},{"../binary":142}],151:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEndsWithNode=void 0;const binary_1=require("../binary");exports.createEndsWithNode=(0,binary_1.createBinaryNodeFactory)("ends_with",{execute:async(e,...t)=>{const{left:r,right:i}=e.children,n=await r.execute(...t);if("string"!=typeof n)return!1;const s=await i.execute(...t);return"string"==typeof s&&(s.length<1||n.endsWith(s))}});

},{"../binary":142}],152:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsEqualNode=void 0;const binary_1=require("../binary"),compare_1=require("../../../helpers/compare");exports.createIsEqualNode=(0,binary_1.createBinaryNodeFactory)("equals",{execute:async(e,...r)=>{const{left:a,right:t}=e.children,c=await a.execute(...r),o=await t.execute(...r);return(0,compare_1.compare)(c,o)}});

},{"../../../helpers/compare":78,"../binary":142}],153:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsGreaterThanOrEqualToNode=void 0;const binary_1=require("../binary");exports.createIsGreaterThanOrEqualToNode=(0,binary_1.createBinaryNodeFactory)("greater_equal",{execute:async(e,...r)=>{const{left:t,right:a}=e.children;return await t.execute(...r)>=await a.execute(...r)}});

},{"../binary":142}],154:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsGreaterThanNode=void 0;const binary_1=require("../binary");exports.createIsGreaterThanNode=(0,binary_1.createBinaryNodeFactory)("greater",{execute:async(e,...r)=>{const{left:t,right:a}=e.children;return await t.execute(...r)>await a.execute(...r)}});

},{"../binary":142}],155:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsInNode=void 0;const binary_1=require("../binary"),is_in_1=require("../../../helpers/is-in");exports.createIsInNode=(0,binary_1.createBinaryNodeFactory)("in",{execute:async(e,...r)=>{const{left:i,right:t}=e.children;return(0,is_in_1.isIn)(await i.execute(...r),await t.execute(...r))}});

},{"../../../helpers/is-in":97,"../binary":142}],156:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsLessThanOrEqualToNode=void 0;const binary_1=require("../binary");exports.createIsLessThanOrEqualToNode=(0,binary_1.createBinaryNodeFactory)("less_equal",{execute:async(e,...r)=>{const{left:t,right:a}=e.children;return await t.execute(...r)<=await a.execute(...r)}});

},{"../binary":142}],157:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsLessThanNode=void 0;const binary_1=require("../binary");exports.createIsLessThanNode=(0,binary_1.createBinaryNodeFactory)("less",{execute:async(e,...t)=>{const{left:r,right:s}=e.children;return await r.execute(...t)<await s.execute(...t)}});

},{"../binary":142}],158:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsNotEqualToNode=void 0;const binary_1=require("../binary"),compare_1=require("../../../helpers/compare");exports.createIsNotEqualToNode=(0,binary_1.createBinaryNodeFactory)("not_equal",{execute:async(e,...r)=>{const{left:t,right:o}=e.children;return Promise.resolve(!(0,compare_1.compare)(await t.execute(...r),await o.execute(...r)))}});

},{"../../../helpers/compare":78,"../binary":142}],159:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIsNotInNode=void 0;const binary_1=require("../binary"),is_in_1=require("../../../helpers/is-in");exports.createIsNotInNode=(0,binary_1.createBinaryNodeFactory)("not_in",{execute:async(e,...r)=>{const{left:t,right:i}=e.children;return Promise.resolve(!(0,is_in_1.isIn)(await t.execute(...r),await i.execute(...r)))}});

},{"../../../helpers/is-in":97,"../binary":142}],160:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createMatchesNode=void 0;const binary_1=require("../binary"),parse_regular_expression_1=require("../../../helpers/parse-regular-expression");exports.createMatchesNode=(0,binary_1.createBinaryNodeFactory)("matches",{execute:async(e,...r)=>(0,parse_regular_expression_1.parseRegularExpression)(await e.children.right.execute(...r)).test(await e.children.left.execute(...r))});

},{"../../../helpers/parse-regular-expression":109,"../binary":142}],161:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createModuloNode=void 0;const binary_1=require("../binary");exports.createModuloNode=(0,binary_1.createBinaryNodeFactory)("mod",{execute:async(e,...t)=>{const{left:r,right:o}=e.children;return await r.execute(...t)%await o.execute(...t)}});

},{"../binary":142}],162:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createMultiplyNode=void 0;const binary_1=require("../binary");exports.createMultiplyNode=(0,binary_1.createBinaryNodeFactory)("mul",{execute:async(e,...t)=>{const{left:r,right:a}=e.children;return await r.execute(...t)*await a.execute(...t)}});

},{"../binary":142}],163:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createOrNode=void 0;const binary_1=require("../binary");exports.createOrNode=(0,binary_1.createBinaryNodeFactory)("or",{execute:async(e,...r)=>{const{left:t,right:a}=e.children;return!(!await t.execute(...r)&&!await a.execute(...r))}});

},{"../binary":142}],164:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createPowerNode=void 0;const binary_1=require("../binary");exports.createPowerNode=(0,binary_1.createBinaryNodeFactory)("power",{execute:async(e,...r)=>{const{left:t,right:o}=e.children;return Math.pow(await t.execute(...r),await o.execute(...r))}});

},{"../binary":142}],165:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createRangeNode=void 0;const binary_1=require("../binary"),create_range_1=require("../../../helpers/create-range");exports.createRangeNode=(0,binary_1.createBinaryNodeFactory)("range",{execute:async(e,...r)=>{const a=await e.children.left.execute(...r),t=await e.children.right.execute(...r);return(0,create_range_1.createRange)(a,t,1)}});

},{"../../../helpers/create-range":81,"../binary":142}],166:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createStartsWithNode=void 0;const binary_1=require("../binary");exports.createStartsWithNode=(0,binary_1.createBinaryNodeFactory)("starts_with",{execute:async(t,...e)=>{const{left:r,right:i}=t.children,a=await r.execute(...e);if("string"!=typeof a)return!1;const s=await i.execute(...e);return"string"==typeof s&&(s.length<1||a.startsWith(s))}});

},{"../binary":142}],167:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSubtractNode=void 0;const binary_1=require("../binary");exports.createSubtractNode=(0,binary_1.createBinaryNodeFactory)("sub",{execute:async(e,...t)=>{const{left:r,right:a}=e.children;return await r.execute(...t)-await a.execute(...t)}});

},{"../binary":142}],168:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cloneBlockReferenceExpressionNode=exports.createBlockFunctionNode=void 0;const expression_1=require("../expression"),createBlockFunctionNode=(e,o,n,t,c)=>{const s={name:e};o&&(s.template=o);const r=(0,expression_1.createBaseExpressionNode)("block_reference_expression",{shouldTestExistence:!1},s,n,t,c),l=Object.assign(Object.assign({},r),{execute:async(...e)=>{const[o,n,t,c,,s]=e,{template:r,name:i}=l.children,a=await i.execute(...e);let u;if(r){const n=await r.execute(...e);u=o.loadTemplate(n,r.line,r.column)}else u=Promise.resolve(o);return u.then(e=>{if(l.attributes.shouldTestExistence){return e.getTraceableMethod(e.hasBlock,l.line,l.column,o.templateName)(a,n.clone(),t,c)}{const i=e.getTraceableMethod(e.renderBlock,l.line,l.column,o.templateName);return r?i(a,n.clone(),t,new Map,!1,s):i(a,n.clone(),t,c,!0,s)}})}});return l};exports.createBlockFunctionNode=createBlockFunctionNode;const cloneBlockReferenceExpressionNode=e=>(0,exports.createBlockFunctionNode)(e.children.name,e.children.template||null,e.line,e.column);exports.cloneBlockReferenceExpressionNode=cloneBlockReferenceExpressionNode;

},{"../expression":136}],169:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBaseCallNode=void 0;const expression_1=require("../expression"),constant_1=require("./constant"),array_1=require("./array"),get_filter_1=require("../../helpers/get-filter"),get_test_1=require("../../helpers/get-test"),get_function_1=require("../../helpers/get-function"),runtime_1=require("../../error/runtime"),array_merge=require("locutus/php/array/array_merge"),snakeCase=require("snake-case"),createBaseCallNode=(e,t,r,a,s,n)=>{let o={arguments:a};null!==r&&(o.operand=r);const u=(0,expression_1.createBaseExpressionNode)(e,{operatorName:t},o,s,n),i=e=>snakeCase(e).toLowerCase(),l=Object.assign(Object.assign({},u),{execute:async(...t)=>{const[r,a,o,,,c]=t,{environment:f}=r,{operatorName:p}=l.attributes;let m;switch(e){case"filter":m=(0,get_filter_1.getFilter)(f.filters,p);break;case"function":m=(0,get_function_1.getFunction)(f.functions,p);break;default:m=(0,get_test_1.getTest)(f.tests,p)}if(null===m)throw(0,runtime_1.createRuntimeError)(`Unknown ${e} "${p}".`,u);const{operand:g,arguments:_}=l.children,d=((t,r,a)=>{const o=e,l=u.attributes.operatorName,c=new Map;let f=!1;const p=(0,array_1.getKeyValuePairs)(t);for(let{key:e,value:t}of p){let r=e.attributes.value;if("string"==typeof r)f=!0,r=i(r);else if(f)throw(0,runtime_1.createRuntimeError)(`Positional arguments cannot be used after named arguments for ${o} "${l}".`,u);c.set(r,{key:e,value:t})}const m=r,g=[];let _=[],d=[],h=0;for(const e of m){const t=""+i(e.name);g.push(t);const r=c.get(t);if(r){if(c.has(h))throw(0,runtime_1.createRuntimeError)(`Argument "${t}" is defined twice for ${o} "${l}".`,u);(d=array_merge(d,_)).push(r.value),c.delete(t),_=[]}else{const r=c.get(h);if(r)(d=array_merge(d,_)).push(r.value),c.delete(h),_=[],++h;else{if(void 0===e.defaultValue)throw(0,runtime_1.createRuntimeError)(`Value for argument "${t}" is required for ${o} "${l}".`,u);d.push((0,constant_1.createConstantNode)(e.defaultValue,s,n))}}}if(a){const e=[],t=[];for(const[r,a]of c)t.push(a.value),e.push(r);for(const t of e)c.delete(t);t.length&&(d=array_merge(d,_)).push(...t)}if(c.size>0){const e=[...c.values()][0];throw(0,runtime_1.createRuntimeError)(`Unknown argument${c.size>1?"s":""} "${[...c.keys()].join('", "')}" for ${o} "${l}(${g.join(", ")})".`,e.key)}return d})(_,m.acceptedArguments,m.isVariadic),h=[];m.needsTemplate&&h.push(r),m.needsContext&&h.push(a),m.needsOutputBuffer&&h.push(o),m.needsSourceMapRuntime&&h.push(c),h.push(...m.nativeArguments),g&&h.push(await g.execute(...t));const y=await Promise.all([...d.map(e=>e.execute(...t))]);return h.push(...y),m.getTraceableCallable(l.line,l.column,r.templateName)(...h)}});return l};exports.createBaseCallNode=createBaseCallNode;

},{"../../error/runtime":9,"../../helpers/get-filter":91,"../../helpers/get-function":93,"../../helpers/get-test":94,"../expression":136,"./array":138,"./constant":174,"locutus/php/array/array_merge":302,"snake-case":416}],170:[function(require,module,exports){
...
},{"../call":169}],171:[function(require,module,exports){
...
},{"../call":169}],172:[function(require,module,exports){
...
},{"../call":169}],173:[function(require,module,exports){
...
},{"../expression":136}],174:[function(require,module,exports){
...
},{"../expression":136}],175:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEscapeNode=void 0;const expression_1=require("../expression"),createEscapeNode=(e,t,s,r)=>{const c=(0,expression_1.createBaseExpressionNode)("escape",{strategy:t},{body:e},s,r),o=Object.assign(Object.assign({},c),{execute:(...e)=>{const[t]=e,{environment:s}=t,{strategy:r}=o.attributes,{body:c}=o.children;return c.execute(...e).then(e=>{return t.getTraceableMethod(s.escape,o.line,o.column,t.templateName)(t,e,r,null,!0)})}});return o};exports.createEscapeNode=createEscapeNode;
...
},{"./array":138}],177:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cloneMethodCallNode=exports.createMethodCallNode=exports.methodCallNodeType=void 0;const expression_1=require("../expression"),array_1=require("./array");exports.methodCallNodeType="method_call";const createMethodCallNode=(e,t,o,a,r)=>{const s=(0,expression_1.createBaseExpressionNode)(exports.methodCallNodeType,{methodName:t,shouldTestExistence:!1},{operand:e,arguments:o},a,r),l=Object.assign(Object.assign({},s),{execute:async(...e)=>{const[t,o,a,,r,d]=e,{methodName:n,shouldTestExistence:c}=s.attributes,{operand:i,arguments:u}=s.children,{templateName:h}=t;if(c)return r.get(i.attributes.name).hasMacro(n);{const s=(0,array_1.getKeyValuePairs)(u),c=[];for(const{value:t}of s){const o=await t.execute(...e);c.push(o)}return t.callMacro(r.get(i.attributes.name),n,a,c,l.line,l.column,o,h,d)}}});return l};exports.createMethodCallNode=createMethodCallNode;const cloneMethodCallNode=e=>(0,exports.createMethodCallNode)(e.children.operand,e.attributes.methodName,e.children.arguments,e.line,e.column);exports.cloneMethodCallNode=cloneMethodCallNode;

},{"../expression":136,"./array":138}],178:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cloneNameNode=exports.createNameNode=exports.nameNodeType=void 0;const node_1=require("../../node"),get_context_value_1=require("../../helpers/get-context-value");exports.nameNodeType="name";const createNameNode=(e,t,o)=>{const a={name:e,isAlwaysDefined:!1,shouldIgnoreStrictCheck:!1,shouldTestExistence:!1},n=(0,node_1.createBaseNode)(exports.nameNodeType,a,{},t,o),s=Object.assign(Object.assign({},n),{execute:(e,t)=>{const{name:o,isAlwaysDefined:a,shouldIgnoreStrictCheck:n,shouldTestExistence:r}=s.attributes;return e.getTraceableMethod(get_context_value_1.getContextValue,s.line,s.column,e.templateName)(e,t,o,a,n,r)}});return s};exports.createNameNode=createNameNode;const cloneNameNode=e=>(0,exports.createNameNode)(e.attributes.name,e.line,e.column);exports.cloneNameNode=cloneNameNode;

},{"../../helpers/get-context-value":90,"../../node":126}],179:[function(require,module,exports){
...
},{"./array":138,"./binary/and":144,"./call/test":172,"./conditional":173,"./unary/not":183}],180:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createParentFunctionNode=exports.parentFunctionNodeType=void 0;const expression_1=require("../expression");exports.parentFunctionNodeType="parent";const createParentFunctionNode=(e,t,n)=>{const r=(0,expression_1.createBaseExpressionNode)(exports.parentFunctionNodeType,{name:e},{},t,n),o=Object.assign(Object.assign({},r),{execute:(...e)=>{const[t,n,r,,,s]=e,{name:a}=o.attributes;return t.getTraceableMethod(t.renderParentBlock,o.line,o.column,t.templateName)(a,n,r,s)}});return o};exports.createParentFunctionNode=createParentFunctionNode;

},{"../expression":136}],181:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBaseUnaryNode=exports.createUnaryNodeFactory=void 0;const expression_1=require("../expression"),createUnaryNodeFactory=(e,r)=>{return(t,a,s)=>{const o=(0,exports.createBaseUnaryNode)(e,t,a,s);return Object.assign(Object.assign({},o),{execute:(...e)=>r.execute(o,...e)})}};exports.createUnaryNodeFactory=createUnaryNodeFactory;const createBaseUnaryNode=(e,r,t,a)=>{const s=(0,expression_1.createBaseExpressionNode)(e,{},{operand:r},t,a);return Object.assign({},s)};exports.createBaseUnaryNode=createBaseUnaryNode;

},{"../expression":136}],182:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createNegativeNode=exports.negativeNodeType=void 0;const unary_1=require("../unary");exports.negativeNodeType="neg",exports.createNegativeNode=(0,unary_1.createUnaryNodeFactory)(exports.negativeNodeType,{execute:(e,...t)=>{const{operand:r}=e.children;return r.execute(...t).then(e=>-e)}});

},{"../unary":181}],183:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createNotNode=exports.notNodeType=void 0;const unary_1=require("../unary");exports.notNodeType="not",exports.createNotNode=(0,unary_1.createUnaryNodeFactory)(exports.notNodeType,{execute:(e,...t)=>{const{operand:o}=e.children;return o.execute(...t).then(e=>!e)}});

},{"../unary":181}],184:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createPositiveNode=exports.positiveNodeType=void 0;const unary_1=require("../unary");exports.positiveNodeType="pos",exports.createPositiveNode=(0,unary_1.createUnaryNodeFactory)(exports.positiveNodeType,{execute:(e,...o)=>{const{operand:t}=e.children;return t.execute(...o).then(e=>+e)}});

},{"../unary":181}],185:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createFlushNode=void 0;const node_1=require("../node"),createFlushNode=(e,s,o)=>Object.assign(Object.assign({},(0,node_1.createBaseNode)("flush",{},{},e,s,o)),{execute:(...e)=>{return e[2].flush(),Promise.resolve()}});exports.createFlushNode=createFlushNode;

},{"../node":126}],186:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createForLoopNode=void 0;const node_1=require("../node"),createForLoopNode=(e,t,o)=>{const s=(0,node_1.createBaseNode)("for_loop",{hasAnIf:!1,hasAnElse:!1},{},e,t,o),r=Object.assign(Object.assign({},s),{execute:(...e)=>{const{hasAnElse:t,hasAnIf:o}=r.attributes,[,s]=e;t&&s.set("_iterated",!0);const n=s.get("loop");return n.set("index0",n.get("index0")+1),n.set("index",n.get("index")+1),n.set("first",!1),!o&&n.has("length")&&(n.set("revindex0",n.get("revindex0")-1),n.set("revindex",n.get("revindex")-1),n.set("last",0===n.get("revindex0"))),Promise.resolve()}});return r};exports.createForLoopNode=createForLoopNode;

},{"../node":126}],187:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createForNode=void 0;const node_1=require("../node"),for_loop_1=require("./for-loop"),if_1=require("./if"),ensure_traversable_1=require("../helpers/ensure-traversable"),count_1=require("../helpers/count"),iterate_1=require("../helpers/iterate"),createForNode=(e,t,r,s,a,o,n,l,c)=>{const i=(0,for_loop_1.createForLoopNode)(n,l,c),u={};let d=0;u[d++]=a,u[d++]=i;let _=(0,node_1.createBaseNode)(null,{},u,n,l);if(s){const e={};let t=0;e[t++]=s,e[t++]=_,_=(0,if_1.createIfNode)((0,node_1.createBaseNode)(null,{},e,n,l),null,n,l),i.attributes.hasAnIf=!0}const p={keyTarget:e,valueTarget:t,sequence:r,body:_};o&&(p.else=o,i.attributes.hasAnElse=!0);const f=(0,node_1.createBaseNode)("for",{hasAnIf:null!==s},p,n,l,c),b=Object.assign(Object.assign({},f),{execute:async(...r)=>{const[,s]=r,{sequence:a,body:o,else:n,valueTarget:l,keyTarget:c}=b.children,{hasAnIf:i}=b.attributes;s.set("_parent",s.clone());const u=await a.execute(...r);let d=(0,ensure_traversable_1.ensureTraversable)(u);if(d===s?s.set("_seq",s.clone()):s.set("_seq",d),n&&s.set("_iterated",!1),s.set("loop",new Map([["parent",s.get("_parent")],["index0",0],["index",1],["first",!0]])),!i){const e=(0,count_1.count)(s.get("_seq")),t=s.get("loop");t.set("revindex0",e-1),t.set("revindex",e),t.set("length",e),t.set("last",1===e)}const _=await c.execute(...r),p=await l.execute(...r);await(0,iterate_1.iterate)(s.get("_seq"),async(e,t)=>{s.set(_,e),s.set(p,t),await o.execute(...r)}),n&&!1===s.get("_iterated")&&await n.execute(...r);const f=s.get("_parent");s.delete("_seq"),s.delete("_iterated"),s.delete(e.attributes.name),s.delete(t.attributes.name),s.delete("_parent"),s.delete("loop");for(const[e,t]of f)s.has(e)||s.set(e,t)}});return b};exports.createForNode=createForNode;

},{"../helpers/count":80,"../helpers/ensure-traversable":82,"../helpers/iterate":101,"../node":126,"./for-loop":186,"./if":188}],188:[function(require,module,exports){
...
},{"../helpers/evaluate":83,"../node":126}],189:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createImportNode=void 0;const node_1=require("../node"),createImportNode=(e,t,a,r,o,s)=>{const n=(0,node_1.createBaseNode)("import",{global:a},{expr:e,var:t},r,o,s),c=Object.assign(Object.assign({},n),{execute:async(...e)=>{const[t,,,,a]=e,{var:r,expr:o}=n.children,{global:s}=n.attributes;let i;if(o.is("name")&&"_self"===o.attributes.name)i=t;else{const a=await o.execute(...e);i=await t.loadTemplate(a,c.line,c.column)}a.set(r.attributes.name,i),s&&t.aliases.set(r.attributes.name,i)}});return c};exports.createImportNode=createImportNode;

},{"../node":126}],190:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBaseIncludeNode=void 0;const node_1=require("../node"),createBaseIncludeNode=(e,t,a,c,n,o,s)=>{const r=(0,node_1.createBaseNode)(e,t,a,n,o,s),d=Object.assign(Object.assign({},r),{execute:async(...e)=>{const[t,a,n,,,o]=e,{include:s}=t,{variables:i}=d.children,{only:l,ignoreMissing:u}=d.attributes,b=await c(...e),N=t.getTraceableMethod(s,r.line,r.column,t.templateName),g=await N(t,a,n,o||null,b,await i.execute(...e),!l,u,!1,d.line,d.column);n.echo(g)}});return d};exports.createBaseIncludeNode=createBaseIncludeNode;

},{"../node":126}],191:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEmbedNode=exports.embedNodeType=void 0;const include_1=require("../include");exports.embedNodeType="embed";const createEmbedNode=(e,t,d,o,r)=>{const c=(0,include_1.createBaseIncludeNode)(exports.embedNodeType,e,t,e=>{const{templateName:t,index:d}=s.attributes;return e.loadTemplate(t,s.line,s.column,d)},d,o,r),s=Object.assign(c,{});return s};exports.createEmbedNode=createEmbedNode;

},{"../include":190}],192:[function(require,module,exports){
...
},{"../include":190}],193:[function(require,module,exports){
...
},{"../node":126}],194:[function(require,module,exports){
...
},{"../node":126}],195:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createModuleNode=void 0;const node_1=require("../node"),createModuleNode=(e,t,o,r,c,u,n,d,s)=>{const l={body:e,blocks:o,macros:r,traits:c,securityCheck:(0,node_1.createBaseNode)(null)};null!==t&&(l.parent=t);const a=(0,node_1.createBaseNode)("module",{index:0,source:n},l,d,s),i=Object.assign(Object.assign({},a),{get embeddedTemplates(){return u},get source(){return n},execute:(...e)=>{const[t,,o,,,r]=e,{securityCheck:c,body:u}=i.children;return c.execute(...e).then(()=>(null==r||r.enterSourceMapBlock(i.line,i.column,i.type,t.source,o),u.execute(...e).then(()=>{null==r||r.leaveSourceMapBlock(o)})))}});return i};exports.createModuleNode=createModuleNode;

},{"../node":126}],196:[function(require,module,exports){
...
},{"../node":126}],197:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBlockReferenceNode=exports.blockReferenceType=void 0;const output_1=require("../output");exports.blockReferenceType="block_reference";const createBlockReferenceNode=(e,t,c,o)=>{const r=(0,output_1.createBaseOutputNode)(exports.blockReferenceType,{name:e},{},t,c,o),n=Object.assign(Object.assign({},r),{execute:(...e)=>{const[t,c,o,r,,s]=e,{name:u}=n.attributes;return t.getTraceableMethod(t.renderBlock,n.line,n.column,t.templateName)(u,c.clone(),o,r,!0,s).then(o.echo)}});return n};exports.createBlockReferenceNode=createBlockReferenceNode;

},{"../output":196}],198:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createInlinePrintNode=exports.inlinePrintNodeType=void 0;const output_1=require("../output");exports.inlinePrintNodeType="inline_print";const createInlinePrintNode=(e,t,n,r=null)=>{const i=(0,output_1.createBaseOutputNode)(exports.inlinePrintNodeType,{},{node:e},t,n,r),o=Object.assign(Object.assign({},i),{execute:(...e)=>{const[,,t]=e;return o.children.node.execute(...e).then(t.echo)}});return o};exports.createInlinePrintNode=createInlinePrintNode;

},{"../output":196}],199:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createPrintNode=exports.printNodeType=void 0;const output_1=require("../output");exports.printNodeType="print";const createPrintNode=(e,t,r)=>{const o=(0,output_1.createBaseOutputNode)(exports.printNodeType,{},{expr:e},t,r,null),n=Object.assign(Object.assign({},o),{execute:(...e)=>{const[t,,r,,,o]=e;return null==o||o.enterSourceMapBlock(n.line,n.column,n.type,t.source,r),n.children.expr.execute(...e).then(e=>{r.echo(e),null==o||o.leaveSourceMapBlock(r)})}});return n};exports.createPrintNode=createPrintNode;

},{"../output":196}],200:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSpacelessNode=exports.spacelessNodeType=void 0;const output_1=require("../output");exports.spacelessNodeType="spaceless";const createSpacelessNode=(e,s,t,o)=>{const c=(0,output_1.createBaseOutputNode)(exports.spacelessNodeType,{},{body:e},s,t,o),r=Object.assign(Object.assign({},c),{execute:(...e)=>{const[,,s]=e;return s.start(),r.children.body.execute(...e).then(()=>{const e=s.getAndClean().replace(/>\s+</g,"><").trim();s.echo(e)})}});return r};exports.createSpacelessNode=createSpacelessNode;

},{"../output":196}],201:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTextNode=exports.createBaseTextNode=exports.textNodeType=void 0;const output_1=require("../output");exports.textNodeType="text";const createBaseTextNode=(e,t,o,r,s=null)=>{const a=(0,output_1.createBaseOutputNode)(e,{data:t},{},o,r,s),c=Object.assign(Object.assign({},a),{execute(...e){const[t,,o,,,r]=e;return null==r||r.enterSourceMapBlock(c.line,c.column,c.type,t.source,o),o.echo(c.attributes.data),null==r||r.leaveSourceMapBlock(o),Promise.resolve()}});return c};exports.createBaseTextNode=createBaseTextNode;const createTextNode=(e,t,o)=>(0,exports.createBaseTextNode)(exports.textNodeType,e,t,o);exports.createTextNode=createTextNode;

},{"../output":196}],202:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSandboxNode=exports.sandboxNodeType=void 0;const node_1=require("../node");exports.sandboxNodeType="sandbox";const createSandboxNode=(e,o,d,n)=>{const t=(0,node_1.createBaseNode)(exports.sandboxNodeType,{},{body:e},o,d,n);return Object.assign(Object.assign({},t),{execute:(...e)=>{const[o]=e,{environment:d}=o,{body:n}=t.children,s=d.isSandboxed;return s||(d.isSandboxed=!0),n.execute(...e).finally(()=>{s||(d.isSandboxed=!1)})}})};exports.createSandboxNode=createSandboxNode;

},{"../node":126}],204:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSetNode=void 0;const node_1=require("../node"),constant_1=require("./expression/constant"),text_1=require("./output/text"),markup_1=require("../markup"),arguments_1=require("./expression/arguments"),createSetNode=(e,t,s,a,r,n)=>{const o=(0,node_1.createBaseNode)("set",{capture:e,safe:!1},{names:t,values:s},a,r,n);if(o.attributes.capture){o.attributes.safe=!0;const{values:e}=o.children;e.is(text_1.textNodeType)&&(o.children.values=(0,arguments_1.createArgumentsNode)({0:(0,constant_1.createConstantNode)(e.attributes.data,e.line,e.column)},e.line,e.column),o.attributes.capture=!1)}const c=Object.assign(Object.assign({},o),{execute:async(...e)=>{const[t,s,a]=e,{environment:r}=t,{names:n,values:o}=c.children,{capture:u,safe:i}=c.attributes,d=await n.execute(...e),p=e=>i&&""!==e?(0,markup_1.createMarkup)(e,r.charset):e;if(u){a.start(),await o.execute(...e);const t=a.getAndClean();for(const e of d)s.set(e,p(t))}else{const t=await o.execute(...e);let a=0;for(const e of d){const r=t[a];s.set(e,p(r)),a++}}},isACaptureNode:!0});return c};exports.createSetNode=createSetNode;

},{"../markup":119,"../node":126,"./expression/arguments":137,"./expression/constant":174,"./output/text":201}],205:[function(require,module,exports){
...
},{"../node":126}],206:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createWithNode=void 0;const node_1=require("../node"),runtime_1=require("../error/runtime"),context_1=require("../context"),merge_iterables_1=require("../helpers/merge-iterables"),iterator_to_map_1=require("../helpers/iterator-to-map"),createWithNode=(e,t,r,o,a,i)=>{const s={body:e};t&&(s.variables=t);const c=(0,node_1.createBaseNode)("with",{only:r},s,o,a,i),n=Object.assign(Object.assign({},c),{execute:async(e,t,...r)=>{const{variables:o,body:a}=c.children,{only:i}=c.attributes;let s;if(o){const a=await o.execute(e,t,...r);if("object"!=typeof a)throw(0,runtime_1.createRuntimeError)('Variables passed to the "with" tag must be a hash.',n,e.templateName);s=i?(0,context_1.createContext)():t.clone(),s=(0,context_1.createContext)(e.mergeGlobals((0,merge_iterables_1.mergeIterables)(s,(0,iterator_to_map_1.iteratorToMap)(a))))}else s=t.clone();s.set("_parent",t.clone()),await a.execute(e,s,...r)}});return n};exports.createWithNode=createWithNode;

},{"../context":3,"../error/runtime":9,"../helpers/iterator-to-map":104,"../helpers/merge-iterables":107,"../node":126}],207:[function(require,module,exports){
...
},{"stream":428}],209:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createParser=void 0;const parsing_1=require("./error/parsing"),node_1=require("./node"),text_1=require("./node/output/text"),print_1=require("./node/output/print"),body_1=require("./node/body"),module_1=require("./node/module"),node_traverser_1=require("./node-traverser"),comment_1=require("./node/comment"),is_made_of_whitespace_only_1=require("./helpers/is-made-of-whitespace-only"),constant_1=require("./node/expression/constant"),concatenate_1=require("./node/expression/binary/concatenate"),assignment_1=require("./node/expression/assignment"),arrow_function_1=require("./node/expression/arrow-function"),name_1=require("./node/expression/name"),parent_function_1=require("./node/expression/parent-function"),block_function_1=require("./node/expression/block-function"),attribute_accessor_1=require("./node/expression/attribute-accessor"),array_1=require("./node/expression/array"),method_call_1=require("./node/expression/method-call"),hash_1=require("./node/expression/hash"),not_1=require("./node/expression/unary/not"),conditional_1=require("./node/expression/conditional"),twig_lexer_1=require("twig-lexer"),lexer_1=require("./lexer"),function_1=require("./node/expression/call/function"),filter_1=require("./node/expression/call/filter"),record_1=require("./helpers/record"),arguments_1=require("./node/expression/arguments"),block_reference_1=require("./node/output/block-reference"),spaceless_1=require("./node/output/spaceless"),get_function_1=require("./helpers/get-function"),get_filter_1=require("./helpers/get-filter"),get_test_1=require("./helpers/get-test"),core_1=require("./node-visitor/core"),escaper_1=require("./node-visitor/escaper"),macro_auto_import_1=require("./node-visitor/macro-auto-import"),sandbox_1=require("./node-visitor/sandbox"),test_1=require("./node/expression/call/test"),pos_1=require("./node/expression/unary/pos"),neg_1=require("./node/expression/unary/neg"),nameRegExp=new RegExp(twig_lexer_1.namePattern),getNames=e=>[...e.values()].map(({name:e})=>e),createParser=(e,t,r,n,o,a,l,s)=>{const i=new Map;let c=0,u=null,_={},p=[],d={},T=[{method:new Map,template:[]}],g={},N=[],m=1;const x=getNames(o),y=getNames(a),f=getNames(l),k=r.map(({tag:e})=>e),w=[],h=(e,t)=>{if(!(t.is("constant")||t.is("array")||t.is(hash_1.hashNodeType)||t.is(neg_1.negativeNodeType)||t.is(pos_1.positiveNodeType)))return t;for(const[,r]of(0,node_1.getChildren)(t))if(null!==h(e,r))return r;return null},v=(e,t,r=!1)=>{if(t.is(text_1.textNodeType)&&!(0,is_made_of_whitespace_only_1.isMadeOfWhitespaceOnly)(t.attributes.data)||!t.is(text_1.textNodeType)&&!t.is(block_reference_1.blockReferenceType)&&t.isAnOutputNode&&!t.is(spaceless_1.spacelessNodeType)){if(t.toString().indexOf(String.fromCharCode(239,187,191))>-1){const e=t.attributes.data.substring(3);if(""===e||(0,is_made_of_whitespace_only_1.isMadeOfWhitespaceOnly)(e))return null}throw(0,parsing_1.createParsingError)("A template that extends another one cannot include content outside Twig blocks. Did you forget to put the content inside a {% block %} tag?",t,e.source.resolvedName)}if(t.isACaptureNode)return t;if(r||"spaceless"!==t.type||console.warn(`Using the spaceless tag at the root level of a child template in "${e.source.name}" at line ${t.line} is deprecated since Twig 2.5.0 and will become a syntax error in Twig 3.0.`),r&&"block_reference"===t.type)return console.warn(`Nesting a block definition under a non-capturing node in "${e.source.name}" at line ${t.line} is deprecated since Twig 2.5.0 and will become a syntax error in Twig 3.0.`),null;if(t.isAnOutputNode&&"spaceless"!==t.type)return null;r=r||null!==t.type;for(let[n,o]of(0,node_1.getChildren)(t))null!==o&&null===v(e,o,r)&&delete t.children[n];return t},A=(e,t,r,n)=>{const{strict:a}=s,l=(0,get_filter_1.getFilter)(o,t);if(l){if(l.isDeprecated){let t=`Filter "${l.name}" is deprecated`;!0!==l.deprecatedVersion&&(t+=` since version ${l.deprecatedVersion}`),l.alternative&&(t+=`. Use "${l.alternative}" instead`),t+=` in "${e.source.name}" at line ${r}.`,console.warn(t)}}else if(a){const o=(0,parsing_1.createParsingError)(`Unknown filter "${t}".`,{line:r,column:n},e.source.resolvedName);throw o.addSuggestions(t,x),o}return filter_1.createFilterNode},U=(e,t,r,n)=>{switch(t){case"parent":if(E(e),!(()=>p)().length)throw(0,parsing_1.createParsingError)('Calling "parent" outside a block is forbidden.',{line:r,column:n},e.source.resolvedName);if(!u&&!O())throw(0,parsing_1.createParsingError)('Calling "parent" on a template that does not extend nor "use" another template is forbidden.',{line:r,column:n},e.source.resolvedName);return(0,parent_function_1.createParentFunctionNode)(L(),r,n);case"block":const o=E(e),l=(0,array_1.getKeyValuePairs)(o);if(l.length<1)throw(0,parsing_1.createParsingError)('The "block" function takes one argument (the block name).',{line:r,column:n},e.source.resolvedName);return(0,block_function_1.createBlockFunctionNode)(l[0].value,l.length>1?l[1].value:null,r,n);case"attribute":const i=E(e),c=(0,array_1.getKeyValuePairs)(i);if(c.length<2)throw(0,parsing_1.createParsingError)('The "attribute" function takes at least two arguments (the variable and the attributes).',{line:r,column:n},e.source.resolvedName);return(0,attribute_accessor_1.createAttributeAccessorNode)(c[0].value,c[1].value,c.length>2?c[2].value:(0,array_1.createArrayNode)([],r,n),"any",r,n);default:const _=b(t);if(_){const t=E(e);return(0,method_call_1.createMethodCallNode)(_.node,_.name,t,r,n)}const d=E(e,!0);return((e,t,r,n)=>{const{strict:o}=s,l=(0,get_function_1.getFunction)(a,t);if(l){if(l.isDeprecated){let t=`Function "${l.name}" is deprecated`;!0!==l.deprecatedVersion&&(t+=` since version ${l.deprecatedVersion}`),l.alternative&&(t+=`. Use "${l.alternative}" instead`),t+=` in "${e.source.name}" at line ${r}.`,console.warn(t)}}else if(o){const o=(0,parsing_1.createParsingError)(`Unknown function "${t}".`,{line:r,column:n},e.source.resolvedName);throw o.addSuggestions(t,y),o}return function_1.createFunctionNode})(e,t,r,n)(t,d,r,n)}},b=e=>{let t;const r=t=>{const r=t.method;return r&&r.has(e)?r.get(e):null};t=r(T[0])||null;let n=T.length;return!t&&n>1&&(t=r(T[n-1])||null),t},O=()=>Object.keys(g).length>0,P=e=>e.test(twig_lexer_1.TokenType.OPERATOR)&&t.get(e.value)||null,C=t=>t.test(twig_lexer_1.TokenType.OPERATOR)&&e.get(t.value)||null,E=(e,t=!1,r=!1,n)=>{const{line:o,column:a}=e.current,l=[];let s,i;for(e.expect(twig_lexer_1.TokenType.PUNCTUATION,"(");!e.test(twig_lexer_1.TokenType.PUNCTUATION,")");){if(l.length>0&&e.expect(twig_lexer_1.TokenType.PUNCTUATION,","),r){i=e.expect(twig_lexer_1.TokenType.NAME,null);const{line:t,column:r}=e.current;s=(0,name_1.createNameNode)(i.value,t,r)}else s=I(e,0,n);let c=void 0;if(t&&(i=e.nextIf(twig_lexer_1.TokenType.OPERATOR,"="))){if(!s.is("name"))throw(0,parsing_1.createParsingError)(`A parameter name must be a string, "${s.type.toString()}" given.`,s,e.source.resolvedName);if(c=(0,constant_1.createConstantNode)(s.attributes.name,s.line,s.column),r){s=S(e);const t=h(e,s);if(null!==t)throw(0,parsing_1.createParsingError)("A default value for an argument must be a constant (a boolean, a string, a number, or an array).",t,e.source.resolvedName)}else s=I(e,0,n)}r&&void 0===c&&(c=(0,constant_1.createConstantNode)(s.attributes.name,o,a),s=(0,constant_1.createConstantNode)(null,o,a)),l.push({key:c,value:s})}return e.expect(twig_lexer_1.TokenType.PUNCTUATION,")"),(0,array_1.createArrayNode)(l,o,a)},I=(e,t=0,r)=>{if(r){const t=(e=>{let t,r,n,o;if(e.look(1).test(twig_lexer_1.TokenType.ARROW))return r=e.current.line,n=e.current.column,t=e.expect(twig_lexer_1.TokenType.NAME),o={0:(0,assignment_1.createAssignmentNode)(t.value,t.line,t.column)},e.expect(twig_lexer_1.TokenType.ARROW),(0,arrow_function_1.createArrowFunctionNode)(I(e,0),(0,node_1.createBaseNode)(null,{},o),r,n);let a=0;if(!e.look(a).test(twig_lexer_1.TokenType.PUNCTUATION,"("))return null;for(++a;++a,e.look(a).test(twig_lexer_1.TokenType.PUNCTUATION,",");)++a;if(e.look(a).test(twig_lexer_1.TokenType.PUNCTUATION,")"),++a,!e.look(a).test(twig_lexer_1.TokenType.ARROW))return null;for(r=(t=e.expect(twig_lexer_1.TokenType.PUNCTUATION,"(")).line,n=t.column,o={},a=0;;){if(!(t=e.current).test(twig_lexer_1.TokenType.NAME))throw(0,parsing_1.createParsingError)(`Unexpected token "${(0,lexer_1.typeToEnglish)(t.type)}" of value "${t.value}".`,t,e.source.resolvedName);if(o[a++]=(0,assignment_1.createAssignmentNode)(t.value,t.line,t.column),e.next(),!e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,","))break}return e.expect(twig_lexer_1.TokenType.PUNCTUATION,")"),e.expect(twig_lexer_1.TokenType.ARROW),(0,arrow_function_1.createArrowFunctionNode)(I(e,0),(0,node_1.createBaseNode)(null,{},o),r,n)})(e);if(t)return t}let n=(e=>{let t,r=e.current;if(null!==(t=C(r))){e.next();const n=I(e,t.precedence),o=t.expressionFactory;return M(e,o([n,(0,node_1.createBaseNode)(null)],r.line,r.column),r)}if(r.test(twig_lexer_1.TokenType.PUNCTUATION,"(")){e.next();const t=I(e);return e.expect(twig_lexer_1.TokenType.PUNCTUATION,")","An opened parenthesis is not properly closed"),M(e,t,r)}return S(e)})(e),o=e.current,a=null;if("is not"===o.value||"is"===o.value)e.next(),n="is not"===o.value?$(e,n):V(e,n);else for(;null!==(a=P(o))&&a.precedence>=t;){e.next();const{expressionFactory:t}=a;n=t([n,I(e,"LEFT"===a.associativity?a.precedence+1:a.precedence)],o.line,o.column),o=e.current}return 0===t?((e,t)=>{let r,n;for(;e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,"?");){if(e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,":"))r=t,n=I(e);else if(r=I(e),e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,":"))n=I(e);else{const{line:t,column:r}=e.current;n=(0,constant_1.createConstantNode)("",t,r)}const{line:o,column:a}=e.current;t=(0,conditional_1.createConditionalNode)(t,r,n,o,a)}return t})(e,n):n},R=(e,t)=>(e.next(),q(e,t)),q=(e,t)=>{let r=null;for(;;){const n=e.expect(twig_lexer_1.TokenType.NAME),{value:o,line:a,column:l}=n;let s;s=e.test(twig_lexer_1.TokenType.PUNCTUATION,"(")?E(e,!0,!1,!0):(0,array_1.createArrayNode)([],a,l);const i=A(e,o,a,l);if(r=i(null===r?t:r,o,s,n.line,n.column),!e.test(twig_lexer_1.TokenType.PUNCTUATION,"|"))break;e.next()}return r},$=(e,t)=>{const{line:r,column:n}=e.current;return(0,not_1.createNotNode)(V(e,t),r,n)},M=(e,t,r)=>{for(;;){let n=e.current;if(n.type!==twig_lexer_1.TokenType.PUNCTUATION)break;if("."===n.value||"["===n.value)t=F(e,t,r);else{if("|"!==n.value)break;t=R(e,t)}}return t},S=t=>{const r=t.current;let n;switch(r.type){case twig_lexer_1.TokenType.NAME:switch(t.next(),r.value){case"true":case"TRUE":n=(0,constant_1.createConstantNode)(!0,r.line,r.column);break;case"false":case"FALSE":n=(0,constant_1.createConstantNode)(!1,r.line,r.column);break;case"none":case"NONE":case"null":case"NULL":n=(0,constant_1.createConstantNode)(null,r.line,r.column);break;default:n="("===t.current.value?U(t,r.value,r.line,r.column):(0,name_1.createNameNode)(r.value,r.line,r.column)}break;case twig_lexer_1.TokenType.NUMBER:t.next(),n=(0,constant_1.createConstantNode)(r.value,r.line,r.column);break;case twig_lexer_1.TokenType.STRING:case twig_lexer_1.TokenType.INTERPOLATION_START:n=B(t);break;case twig_lexer_1.TokenType.OPERATOR:let o=nameRegExp.exec(r.value);if(null!==o&&o[0]===r.value){t.next(),n=(0,name_1.createNameNode)(r.value,r.line,r.column);break}if(e.has(r.value)){const o=e.get(r.value);t.next();const a=S(t),{expressionFactory:l}=o;n=l([a,(0,node_1.createBaseNode)(null)],r.line,r.column);break}default:if(r.test(twig_lexer_1.TokenType.PUNCTUATION,"["))n=(e=>{const{line:t,column:r}=e.current;e.expect(twig_lexer_1.TokenType.PUNCTUATION,"[","An array element was expected");const n=[];let o=!0;for(;!e.test(twig_lexer_1.TokenType.PUNCTUATION,"]")&&(o||(e.expect(twig_lexer_1.TokenType.PUNCTUATION,",","An array element must be followed by a comma"),!e.test(twig_lexer_1.TokenType.PUNCTUATION,"]")));)o=!1,n.push(I(e));return e.expect(twig_lexer_1.TokenType.PUNCTUATION,"]","An opened array is not properly closed"),(0,array_1.createArrayNode)(n.map(e=>({value:e})),t,r)})(t);else{if(!r.test(twig_lexer_1.TokenType.PUNCTUATION,"{"))throw!r.test(twig_lexer_1.TokenType.OPERATOR,"=")||"=="!==t.look(-1).value&&"!="!==t.look(-1).value?(0,parsing_1.createParsingError)(`Unexpected token "${(0,lexer_1.typeToEnglish)(r.type)}" of value "${r.value}".`,r,t.source.resolvedName):(0,parsing_1.createParsingError)(`Unexpected operator of value "${r.value}". Did you try to use "===" or "!==" for strict comparison? Use "is same as(value)" instead.`,r,t.source.resolvedName);n=(e=>{e.expect(twig_lexer_1.TokenType.PUNCTUATION,"{","A hash element was expected");let t=!0;const r=[];for(;!e.test(twig_lexer_1.TokenType.PUNCTUATION,"}")&&(t||(e.expect(twig_lexer_1.TokenType.PUNCTUATION,",","A hash value must be followed by a comma"),!e.test(twig_lexer_1.TokenType.PUNCTUATION,"}")));){let n,o;if(t=!1,(n=e.nextIf(twig_lexer_1.TokenType.STRING))||(n=e.nextIf(twig_lexer_1.TokenType.NAME))||(n=e.nextIf(twig_lexer_1.TokenType.NUMBER)))o=(0,constant_1.createConstantNode)(n.value,n.line,n.column);else{if(!e.test(twig_lexer_1.TokenType.PUNCTUATION,"(")){const{type:t,line:r,value:n,column:o}=e.current;throw(0,parsing_1.createParsingError)(`A hash key must be a quoted string, a number, a name, or an expression enclosed in parentheses (unexpected token "${(0,lexer_1.typeToEnglish)(t)}" of value "${n}".`,{line:r,column:o},e.source.resolvedName)}o=I(e)}e.expect(twig_lexer_1.TokenType.PUNCTUATION,":","A hash key must be followed by a colon (:)");const a=I(e);r.push({key:o,value:a})}return e.expect(twig_lexer_1.TokenType.PUNCTUATION,"}","An opened hash is not properly closed"),(0,hash_1.createHashNode)(r,e.current.line,e.current.column)})(t)}}return M(t,n,r)},B=e=>{const t=[];let r,n=!0;for(;;)if(n&&(r=e.nextIf(twig_lexer_1.TokenType.STRING)))t.push((0,constant_1.createConstantNode)(r.value,r.line,r.column)),n=!1;else{if(!e.nextIf(twig_lexer_1.TokenType.INTERPOLATION_START))break;t.push(I(e)),e.expect(twig_lexer_1.TokenType.INTERPOLATION_END),n=!0}let o=t.shift();for(const e of t)o=(0,concatenate_1.createConcatenateNode)([o,e],e.line,e.column);return o},F=(e,t,r)=>{let n,o=e.next(),a="any";const{line:l,column:s}=o,{line:i,column:c}=r,u=[],_=()=>(0,array_1.createArrayNode)(u.map(e=>({value:e})),l,s);if("."===o.value){o=e.next();let r=nameRegExp.exec(o.value);if(o.type!==twig_lexer_1.TokenType.NAME&&o.type!==twig_lexer_1.TokenType.NUMBER&&(o.type!==twig_lexer_1.TokenType.OPERATOR||null===r))throw(0,parsing_1.createParsingError)("Expected name or number.",{line:l,column:s+1},e.source.resolvedName);if(n=(0,constant_1.createConstantNode)(o.value,l,s),e.test(twig_lexer_1.TokenType.PUNCTUATION,"(")){a="method";const t=E(e);for(const{value:e}of(0,array_1.getKeyValuePairs)(t))u.push(e)}if(t.is("name")&&(e=>{let t;const r=t=>{const r=t.template;return r&&r.includes(e)?e:null};t=r(T[0])||null;let n=T.length;return!t&&n>1&&(t=r(T[n-1])||null),t})(t.attributes.name)){const e=n.attributes.value;return(0,method_call_1.createMethodCallNode)(t,e,_(),l,s)}}else{a="array";let r=!1;if(e.test(twig_lexer_1.TokenType.PUNCTUATION,":")?(r=!0,n=(0,constant_1.createConstantNode)(0,o.line,o.column)):n=I(e),e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,":")&&(r=!0),r){let r;r=e.test(twig_lexer_1.TokenType.PUNCTUATION,"]")?(0,constant_1.createConstantNode)(null,o.line,o.column):I(e);const a=A(e,"slice",o.line,o.column)(t,"slice",(0,array_1.createArrayNode)([{key:(0,constant_1.createConstantNode)(0,l,s),value:n},{key:(0,constant_1.createConstantNode)(1,l,s),value:r}],1,1),o.line,o.column);return e.expect(twig_lexer_1.TokenType.PUNCTUATION,"]"),a}e.expect(twig_lexer_1.TokenType.PUNCTUATION,"]")}return(0,attribute_accessor_1.createAttributeAccessorNode)(t,n,_(),a,i,c)},V=(e,t)=>{const{line:r,column:n}=e.current,o=(e=>{const{line:t,column:r}=e.current,{strict:n}=s;let o=e.expect(twig_lexer_1.TokenType.NAME).value,a=(0,get_test_1.getTest)(l,o);if(a||(e.test(twig_lexer_1.TokenType.NAME)?(o=o+" "+e.current.value,(a=(0,get_test_1.getTest)(l,o))?e.next():n||(e.next(),a={name:o,isDeprecated:!1,alternative:void 0,deprecatedVersion:void 0})):n||(a={name:o,isDeprecated:!1,alternative:void 0,deprecatedVersion:void 0})),a){if(a.isDeprecated){let r=`Test "${a.name}" is deprecated`;!0!==a.deprecatedVersion&&(r+=` since version ${a.deprecatedVersion}`),a.alternative&&(r+=`. Use "${a.alternative}" instead`),r+=` in "${e.source.name}" at line ${t}.`,console.warn(r)}return o}const i=(0,parsing_1.createParsingError)(`Unknown test "${o}".`,{line:t,column:r},e.source.resolvedName);throw i.addSuggestions(o,f),i})(e);let a=(0,array_1.createArrayNode)([],r,n);if(e.test(twig_lexer_1.TokenType.PUNCTUATION,"(")&&(a=E(e,!0)),"defined"===o&&t.is("name")){const e=b(t.attributes.name);null!==e&&(t=(0,method_call_1.createMethodCallNode)(e.node,e.name,(0,array_1.createArrayNode)([],t.line,t.column),t.line,t.column))}return(0,test_1.createTestNode)(t,o,a,r,n)},L=()=>p[p.length-1],D=(e,t,n,o)=>{if(0===i.size)for(const e of r)i.set(e.tag,e.initialize(W));let a,{line:l,column:s}=e.current,c={},u=0;for(;!e.isEOF();)switch(e.current.type){case twig_lexer_1.TokenType.TEXT:a=e.next(),c[u++]=(0,text_1.createTextNode)(a.value,a.line,a.column);break;case twig_lexer_1.TokenType.VARIABLE_START:a=e.next();const r=I(e);e.expect(twig_lexer_1.TokenType.VARIABLE_END),c[u++]=(0,print_1.createPrintNode)(r,a.line,a.column);break;case twig_lexer_1.TokenType.TAG_START:if(e.next(),(a=e.current).type!==twig_lexer_1.TokenType.NAME)throw(0,parsing_1.createParsingError)("A block must start with a tag name.",a,e.source.resolvedName);if(null!==n&&n(a))return o&&e.next(),1===Object.keys(c).length?c[0]:(0,node_1.createBaseNode)(null,{},c,l,s);if(!i.has(a.value)){let r;throw null!==n?(r=(0,parsing_1.createParsingError)(`Unexpected "${a.value}" tag`,a,e.source.resolvedName)).appendMessage(` (expecting closing tag for the "${t}" tag defined line ${l}).`):(r=(0,parsing_1.createParsingError)(`Unknown "${a.value}" tag.`,a,e.source.resolvedName)).addSuggestions(a.value,k),r}e.next();const _=i.get(a.value)(a,e);null!==_&&(c[u++]=_);break;case twig_lexer_1.TokenType.COMMENT_START:a=e.next(),e.test(twig_lexer_1.TokenType.TEXT)&&(a=e.expect(twig_lexer_1.TokenType.TEXT)),e.expect(twig_lexer_1.TokenType.COMMENT_END),c[u++]=(0,comment_1.createCommentNode)(a.value,a.line,a.column)}return 1===Object.keys(c).length?c[0]:(0,node_1.createBaseNode)(null,{},c,l,s)},W={addImportedSymbol:(e,t,r,n)=>{const o=T[0];"method"===e?o[e].set(t,{name:r,node:n}):o[e].push(t)},addTrait:e=>{(0,record_1.pushToRecord)(g,e)},embedTemplate:e=>{e.attributes.index=m++,N.push(e)},getBlock:e=>_[e]||null,getVarName:(e="__internal_")=>`${e}${c++}`,isMainScope:()=>1===T.length,parse:(e,t=null,r=null,l)=>{let s;w.push({stream:e,parent:u,blocks:_,blockStack:p,macros:d,importedSymbols:T,traits:g,embeddedTemplates:N}),u=null,_={},d={},g={},p=[],T=[{method:new Map,template:[]}],N=[];try{s=D(e,t,r,l),null!==u&&null===(s=v(e,s))&&(s=(0,node_1.createBaseNode)(null))}catch(t){throw t.source||(t.source=e.source.resolvedName),t}let i=(0,module_1.createModuleNode)((0,body_1.createBodyNode)(s,1,1),u,(0,node_1.createBaseNode)(null,{},_),(0,node_1.createBaseNode)(null,{},d),(0,node_1.createBaseNode)(null,{},g),N,e.source,1,1),c=(0,node_traverser_1.createNodeTraverser)(n);i=c(i),i=(c=(0,node_traverser_1.createNodeTraverser)([(0,core_1.createCoreNodeVisitor)(),(0,escaper_1.createEscaperNodeVisitor)(o,a),(0,macro_auto_import_1.createMacroAutoImportNodeVisitor)(),(0,sandbox_1.createSandboxNodeVisitor)()]))(i);const m=w.pop();return u=m.parent,_=m.blocks,d=m.macros,g=m.traits,p=m.blockStack,T=m.importedSymbols,N=m.embeddedTemplates,i},parseArguments:E,parseAssignmentExpression:e=>{const t={},{line:r,column:n}=e.current;for(;;){let r=e.current;e.test(twig_lexer_1.TokenType.OPERATOR)&&nameRegExp.exec(r.value)?e.next():e.expect(twig_lexer_1.TokenType.NAME,null,"Only variables can be assigned to");let n=r.value;if(["true","false","none","null"].indexOf(n.toLowerCase())>-1)throw(0,parsing_1.createParsingError)(`You cannot assign a value to "${n}".`,r,e.source.resolvedName);if((0,record_1.pushToRecord)(t,(0,assignment_1.createAssignmentNode)(n,r.line,r.column)),!e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,","))break}return(0,arguments_1.createArgumentsNode)(t,r,n)},parseExpression:I,parseFilterExpressionRaw:q,parseFilterDefinitions:e=>{const t=[];for(;;){const r=e.expect(twig_lexer_1.TokenType.NAME),{value:n,line:o,column:a}=r;let l;if(l=e.test(twig_lexer_1.TokenType.PUNCTUATION,"(")?E(e,!0,!1,!0):(0,array_1.createArrayNode)([],o,a),t.unshift({name:n,arguments:l}),!e.test(twig_lexer_1.TokenType.PUNCTUATION,"|"))break;e.next()}return t},parseMultiTargetExpression:e=>{const{line:t,column:r}=e.current,n={};for(;(0,record_1.pushToRecord)(n,I(e)),e.nextIf(twig_lexer_1.TokenType.PUNCTUATION,","););return(0,arguments_1.createArgumentsNode)(n,t,r)},peekBlockStack:L,popBlockStack:()=>{p.pop()},popLocalScope:()=>{T.shift()},pushBlockStack:e=>{p.push(e)},pushLocalScope:()=>{T.unshift({method:new Map,template:[]})},setBlock:(e,t)=>{_[e]=t},setMacro:(e,t)=>{d[e]=t},subparse:D,get parent(){return u},set parent(e){u=e}};return W};exports.createParser=createParser;

},{"./error/parsing":8,"./helpers/get-filter":91,"./helpers/get-function":93,"./helpers/get-test":94,"./helpers/is-made-of-whitespace-only":98,"./helpers/record":111,"./lexer":114,"./node":126,"./node-traverser":120,"./node-visitor/core":122,"./node-visitor/escaper":123,"./node-visitor/macro-auto-import":124,"./node-visitor/sandbox":125,"./node/body":130,"./node/comment":133,"./node/expression/arguments":137,"./node/expression/array":138,"./node/expression/arrow-function":139,"./node/expression/assignment":140,"./node/expression/attribute-accessor":141,"./node/expression/binary/concatenate":148,"./node/expression/block-function":168,"./node/expression/call/filter":170,"./node/expression/call/function":171,"./node/expression/call/test":172,"./node/expression/conditional":173,"./node/expression/constant":174,"./node/expression/hash":176,"./node/expression/method-call":177,"./node/expression/name":178,"./node/expression/parent-function":180,"./node/expression/unary/neg":182,"./node/expression/unary/not":183,"./node/expression/unary/pos":184,"./node/module":195,"./node/output/block-reference":197,"./node/output/print":199,"./node/output/spaceless":200,"./node/output/text":201,"twig-lexer":431}],210:[function(require,module,exports){
...
},{"../error/base":6}],211:[function(require,module,exports){
...
},{"./security-error":210}],212:[function(require,module,exports){
...
},{"./security-error":210}],213:[function(require,module,exports){
...
},{"./security-error":210}],214:[function(require,module,exports){
...
},{"./security-error":210}],215:[function(require,module,exports){
...
},{"./security-error":210}],216:[function(require,module,exports){
...
},{"../markup":119,"./security-not-allowed-filter-error":211,"./security-not-allowed-function-error":212,"./security-not-allowed-method-error":213,"./security-not-allowed-property-error":214,"./security-not-allowed-tag-error":215}],217:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSourceMapRuntime=void 0;const path_1=require("path"),source_map_1=require("source-map"),createSourceMapRuntime=()=>{let e=[new source_map_1.SourceNode];return{get sourceNode(){return e[0]},enterSourceMapBlock:(t,r,o,u,c)=>{c.start();let a=u.resolvedName;(0,path_1.isAbsolute)(a)&&(a=(0,path_1.relative)(".",a));const p=new source_map_1.SourceNode(t,r-1,a,"",o);e[0].setSourceContent(a,u.code),e.push(p)},leaveSourceMapBlock:t=>{const r=e.pop(),o=t.getAndFlush();0===r.children.length&&r.add(o),e[e.length-1].add(r)}}};exports.createSourceMapRuntime=createSourceMapRuntime;

},{"path":385,"source-map":427}],218:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSource=void 0;const createSource=(e,r,t)=>({get code(){return r},get name(){return e},get resolvedName(){return t||e}});exports.createSource=createSource;

},{}],219:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createApplyTagHandler=void 0;const twig_lexer_1=require("twig-lexer"),apply_1=require("../node/apply"),array_1=require("../node/expression/array"),constant_1=require("../node/expression/constant"),createApplyTagHandler=()=>{return{tag:"apply",initialize:e=>(r,a)=>{const{line:t,column:p}=r,n=e.parseFilterDefinitions(a);a.expect(twig_lexer_1.TokenType.TAG_END);let l=e.subparse(a,"apply",e=>e.test(twig_lexer_1.TokenType.NAME,"endapply"),!0);return a.expect(twig_lexer_1.TokenType.TAG_END),(0,apply_1.createApplyNode)((0,array_1.createArrayNode)(n.map(({name:e,arguments:r})=>({key:(0,constant_1.createConstantNode)(e,t,p),value:r})),t,p),l,t,p)}}};exports.createApplyTagHandler=createApplyTagHandler;

},{"../node/apply":127,"../node/expression/array":138,"../node/expression/constant":174,"twig-lexer":431}],220:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createAutoEscapeTagHandler=void 0;const parsing_1=require("../error/parsing"),auto_escape_1=require("../node/auto-escape"),twig_lexer_1=require("twig-lexer"),createAutoEscapeTagHandler=()=>{const e="autoescape";return{tag:e,initialize:t=>(r,a)=>{const{line:s,column:o}=r;let n;if(a.test(twig_lexer_1.TokenType.TAG_END))n=!0;else{const e=t.parseExpression(a);if(!e.is("constant")||"string"!=typeof e.attributes.value&&!1!==e.attributes.value){const{line:t,column:r}=e;throw(0,parsing_1.createParsingError)("An escaping strategy must be a string or false.",{line:t,column:r},a.source.resolvedName)}const{value:r}=e.attributes;n=!1===r?null:r}a.expect(twig_lexer_1.TokenType.TAG_END);let i=t.subparse(a,e,e=>e.test(twig_lexer_1.TokenType.NAME,"endautoescape"),!0);return a.expect(twig_lexer_1.TokenType.TAG_END),(0,auto_escape_1.createAutoEscapeNode)(n,i,s,o,e)}}};exports.createAutoEscapeTagHandler=createAutoEscapeTagHandler;

},{"../error/parsing":8,"../node/auto-escape":128,"twig-lexer":431}],221:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createBlockTagHandler=void 0;const node_1=require("../node"),parsing_1=require("../error/parsing"),block_1=require("../node/block"),print_1=require("../node/output/print"),block_reference_1=require("../node/output/block-reference"),twig_lexer_1=require("twig-lexer"),createBlockTagHandler=()=>{return{tag:"block",initialize:e=>(r,o)=>{const{line:l,column:c}=r,n=o.expect(twig_lexer_1.TokenType.NAME).value;let t,a=e.getBlock(n);if(null!==a)throw(0,parsing_1.createParsingError)(`The block '${n}' has already been defined at {${a.line}:${a.column}}.`,{line:l,column:c},o.source.resolvedName);if(a=(0,block_1.createBlockNode)(n,(0,node_1.createBaseNode)(null),l,c),e.setBlock(n,a),e.pushLocalScope(),e.pushBlockStack(n),o.nextIf(twig_lexer_1.TokenType.TAG_END)){t=e.subparse(o,"block",e=>e.test(twig_lexer_1.TokenType.NAME,"endblock"),!0);const r=o.nextIf(twig_lexer_1.TokenType.NAME);if(r){const e=r.value;if(e!==n){const{line:l,column:c}=r;throw(0,parsing_1.createParsingError)(`Expected endblock for block "${n}" (but "${e}" given).`,{line:l,column:c},o.source.resolvedName)}}}else t=(0,node_1.createBaseNode)(null,{},{0:(0,print_1.createPrintNode)(e.parseExpression(o),l,c)});return o.expect(twig_lexer_1.TokenType.TAG_END),a.children.body=t,e.popBlockStack(),e.popLocalScope(),(0,block_reference_1.createBlockReferenceNode)(n,l,c,"block")}}};exports.createBlockTagHandler=createBlockTagHandler;

},{"../error/parsing":8,"../node":126,"../node/block":129,"../node/output/block-reference":197,"../node/output/print":199,"twig-lexer":431}],222:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createDeprecatedTagHandler=void 0;const deprecated_1=require("../node/deprecated"),twig_lexer_1=require("twig-lexer"),createDeprecatedTagHandler=()=>{const e="deprecated";return{tag:e,initialize:r=>(t,a)=>{const d=r.parseExpression(a);return a.expect(twig_lexer_1.TokenType.TAG_END),(0,deprecated_1.createDeprecatedNode)(d,t.line,t.column,e)}}};exports.createDeprecatedTagHandler=createDeprecatedTagHandler;

},{"../node/deprecated":134,"twig-lexer":431}],223:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createDoTagHandler=void 0;const do_1=require("../node/do"),twig_lexer_1=require("twig-lexer"),createDoTagHandler=()=>{return{tag:"do",initialize:e=>(r,o)=>{const t=e.parseExpression(o);return o.expect(twig_lexer_1.TokenType.TAG_END),(0,do_1.createDoNode)(t,r.line,r.column,"do")}}};exports.createDoTagHandler=createDoTagHandler;

},{"../node/do":135,"twig-lexer":431}],224:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEmbedTagHandler=void 0;const include_1=require("./include"),embed_1=require("../node/include/embed"),twig_lexer_1=require("twig-lexer"),createEmbedTagHandler=()=>{return{tag:"embed",initialize:e=>(n,t)=>{const{line:r,column:i}=n;let l,_,o=e.parseExpression(t),a=(0,include_1.parseArguments)(e,t,r,i),T=a.variables,d=a.only,s=a.ignoreMissing;l=_=new twig_lexer_1.Token(twig_lexer_1.TokenType.STRING,"__parent__",n.line,n.column),o.is("constant")?l=new twig_lexer_1.Token(twig_lexer_1.TokenType.STRING,o.attributes.value,n.line,n.column):o.is("name")&&(l=new twig_lexer_1.Token(twig_lexer_1.TokenType.NAME,o.attributes.name,n.line,n.column)),t.injectTokens([new twig_lexer_1.Token(twig_lexer_1.TokenType.TAG_START,"",n.line,n.column),new twig_lexer_1.Token(twig_lexer_1.TokenType.NAME,"extends",n.line,n.column),l,new twig_lexer_1.Token(twig_lexer_1.TokenType.TAG_END,"",n.line,n.column)]);let m=e.parse(t,"embed",e=>e.test(twig_lexer_1.TokenType.NAME,"endembed"),!0);_===l&&(m.children.parent=o),e.embedTemplate(m),t.expect(twig_lexer_1.TokenType.TAG_END);const{source:c,index:g}=m.attributes;return(0,embed_1.createEmbedNode)({templateName:c.name,index:g,only:d,ignoreMissing:s},{variables:T},n.line,n.column,"embed")}}};exports.createEmbedTagHandler=createEmbedTagHandler;

},{"../node/include/embed":191,"./include":232,"twig-lexer":431}],225:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createExtendsTagHandler=void 0;const parsing_1=require("../error/parsing"),twig_lexer_1=require("twig-lexer"),createExtendsTagHandler=()=>{return{tag:"extends",initialize:e=>(r,n)=>{const{line:t,column:a}=r;if(e.peekBlockStack())throw(0,parsing_1.createParsingError)('Cannot use "extend" in a block.',{line:t,column:a},n.source.resolvedName);if(!e.isMainScope())throw(0,parsing_1.createParsingError)('Cannot use "extend" in a macro.',{line:t,column:a},n.source.resolvedName);if(null!==e.parent)throw(0,parsing_1.createParsingError)("Multiple extends tags are forbidden.",{line:t,column:a},n.source.resolvedName);return e.parent=e.parseExpression(n),n.expect(twig_lexer_1.TokenType.TAG_END),null}}};exports.createExtendsTagHandler=createExtendsTagHandler;

},{"../error/parsing":8,"twig-lexer":431}],226:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createFilterTagHandler=void 0;const block_function_1=require("../node/expression/block-function"),constant_1=require("../node/expression/constant"),block_1=require("../node/block"),print_1=require("../node/output/print"),twig_lexer_1=require("twig-lexer"),createFilterTagHandler=()=>{const e="filter";return{tag:e,initialize:t=>(r,n)=>{let o=r.line,i=r.column;console.warn(`The "filter" tag in "${n.source.name}" at line ${o} is deprecated since Twig 2.9, use the "apply" tag instead.`);const c=t.getVarName(),l=(0,block_function_1.createBlockFunctionNode)((0,constant_1.createConstantNode)(c,o,i),null,o,i,e),a=t.parseFilterExpressionRaw(n,l,e);n.expect(twig_lexer_1.TokenType.TAG_END);const s=t.subparse(n,e,e=>e.test(twig_lexer_1.TokenType.NAME,"endfilter"),!0);n.expect(twig_lexer_1.TokenType.TAG_END);const _=(0,block_1.createBlockNode)(c,s,o,i);return t.setBlock(c,_),(0,print_1.createPrintNode)(a,o,i)}}};exports.createFilterTagHandler=createFilterTagHandler;

},{"../node/block":129,"../node/expression/block-function":168,"../node/expression/constant":174,"../node/output/print":199,"twig-lexer":431}],227:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createFlushTagHandler=void 0;const flush_1=require("../node/flush"),twig_lexer_1=require("twig-lexer"),createFlushTagHandler=()=>{return{tag:"flush",initialize:()=>(e,r)=>(r.expect(twig_lexer_1.TokenType.TAG_END),(0,flush_1.createFlushNode)(e.line,e.column,"flush"))}};exports.createFlushTagHandler=createFlushTagHandler;

},{"../node/flush":185,"twig-lexer":431}],228:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createForTagHandler=void 0;const node_1=require("../node"),parsing_1=require("../error/parsing"),assignment_1=require("../node/expression/assignment"),for_1=require("../node/for"),twig_lexer_1=require("twig-lexer"),createForTagHandler=()=>{const e=e=>e.test(twig_lexer_1.TokenType.NAME,["else","endfor"]),n=e=>e.test(twig_lexer_1.TokenType.NAME,"endfor"),r=(e,n)=>{if(n.is("get_attribute")&&n.children.target.is("name")&&"loop"===n.children.target.attributes.name)throw(0,parsing_1.createParsingError)('The "loop" variable cannot be used in a looping condition.',n,e.source.resolvedName);for(const[,t]of(0,node_1.getChildren)(n))r(e,t)},t=(e,n)=>{if(n.is("get_attribute")&&n.children.target.is("name")&&"loop"===n.children.target.attributes.name){let r=n.children.attribute;if(r.is("constant")&&["length","revindex0","revindex","last"].indexOf(r.attributes.value)>-1)throw(0,parsing_1.createParsingError)(`The "loop.${r.attributes.value}" variable is not defined when looping with a condition.`,n,e.source.resolvedName)}if(!n.is("for"))for(let[,r]of(0,node_1.getChildren)(n))t(e,r)};return{tag:"for",initialize:i=>(o,s)=>{const{line:a,column:l}=o,d=i.parseAssignmentExpression(s);s.expect(twig_lexer_1.TokenType.OPERATOR,"in");let c=i.parseExpression(s),g=null;s.nextIf(twig_lexer_1.TokenType.NAME,"if")&&(console.warn(`Using an "if" condition on "for" tag in "${s.source.name}" at line ${a} is deprecated since Twig 2.10.0, use a "filter" filter or an "if" condition inside the "for" body instead (if your condition depends on a variable updated inside the loop).`),g=i.parseExpression(s)),s.expect(twig_lexer_1.TokenType.TAG_END);let u,p,_,f=i.subparse(s,"for",e);return"else"==s.next().value?(s.expect(twig_lexer_1.TokenType.TAG_END),u=i.subparse(s,"for",n,!0)):u=null,s.expect(twig_lexer_1.TokenType.TAG_END),(0,node_1.getChildrenCount)(d)>1?(p=d.children[0],p=(0,assignment_1.createAssignmentNode)(p.attributes.name,p.line,p.column),_=d.children[1],_=(0,assignment_1.createAssignmentNode)(_.attributes.name,_.line,_.column)):(p=(0,assignment_1.createAssignmentNode)("_key",a,l),_=d.children[0],_=(0,assignment_1.createAssignmentNode)(_.attributes.name,_.line,_.column)),g&&(r(s,g),t(s,f)),(0,for_1.createForNode)(p,_,c,g,f,u,a,l,"for")}}};exports.createForTagHandler=createForTagHandler;

},{"../error/parsing":8,"../node":126,"../node/expression/assignment":140,"../node/for":187,"twig-lexer":431}],229:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createFromTagHandler=void 0;const import_1=require("../node/import"),assignment_1=require("../node/expression/assignment"),twig_lexer_1=require("twig-lexer"),createFromTagHandler=()=>{return{tag:"from",initialize:e=>(r,t)=>{let o=e.parseExpression(t);t.expect(twig_lexer_1.TokenType.NAME,"import");let n=new Map;for(;;){let e=t.expect(twig_lexer_1.TokenType.NAME).value,r=e;if(t.nextIf(twig_lexer_1.TokenType.NAME,"as")&&(r=t.expect(twig_lexer_1.TokenType.NAME).value),n.set(e,r),!t.nextIf(twig_lexer_1.TokenType.PUNCTUATION,","))break}t.expect(twig_lexer_1.TokenType.TAG_END);const i=(0,assignment_1.createAssignmentNode)(e.getVarName(),r.line,r.column),a=(0,import_1.createImportNode)(o,i,!0,r.line,r.column,"from");for(const[r,t]of n)e.addImportedSymbol("method",t,r,i);return a}}};exports.createFromTagHandler=createFromTagHandler;

},{"../node/expression/assignment":140,"../node/import":189,"twig-lexer":431}],230:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createIfTagHandler=void 0;const node_1=require("../node"),if_1=require("../node/if"),twig_lexer_1=require("twig-lexer"),createIfTagHandler=()=>{const e=e=>e.test(twig_lexer_1.TokenType.NAME,["elseif","else","endif"]);return{tag:"if",initialize:r=>(t,i)=>{const{line:s,column:n}=t;let a=r.parseExpression(i);i.expect(twig_lexer_1.TokenType.TAG_END);let l=0,o=r.subparse(i,"if",e);const _={[l++]:a,[l++]:o};let c=null,p=i.isEOF();for(;!p;)switch(i.next().value){case"else":i.expect(twig_lexer_1.TokenType.TAG_END),c=r.subparse(i,"if",e=>e.test(twig_lexer_1.TokenType.NAME,"endif"));break;case"elseif":a=r.parseExpression(i),i.expect(twig_lexer_1.TokenType.TAG_END),o=r.subparse(i,"if",e),_[l++]=a,_[l++]=o;break;case"endif":p=!0}return i.expect(twig_lexer_1.TokenType.TAG_END),(0,if_1.createIfNode)((0,node_1.createBaseNode)(null,{},_),c,s,n,"if")}}};exports.createIfTagHandler=createIfTagHandler;

},{"../node":126,"../node/if":188,"twig-lexer":431}],231:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createImportTagHandler=void 0;const assignment_1=require("../node/expression/assignment"),import_1=require("../node/import"),twig_lexer_1=require("twig-lexer"),createImportTagHandler=()=>{return{tag:"import",initialize:e=>(t,r)=>{const o=e.parseExpression(r);r.expect(twig_lexer_1.TokenType.NAME,"as");const n=(0,assignment_1.createAssignmentNode)(r.expect(twig_lexer_1.TokenType.NAME).value,t.line,t.column);return r.expect(twig_lexer_1.TokenType.TAG_END),e.addImportedSymbol("template",n.attributes.name),(0,import_1.createImportNode)(o,n,e.isMainScope(),t.line,t.column,"import")}}};exports.createImportTagHandler=createImportTagHandler;

},{"../node/expression/assignment":140,"../node/import":189,"twig-lexer":431}],232:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.parseArguments=exports.createIncludeTagHandler=void 0;const include_1=require("../node/include/include"),twig_lexer_1=require("twig-lexer"),array_1=require("../node/expression/array"),createIncludeTagHandler=()=>{return{tag:"include",initialize:e=>(r,n)=>{const{line:i,column:t}=r,s=e.parseExpression(n),{ignoreMissing:l,only:a,variables:o}=(0,exports.parseArguments)(e,n,i,t);return(0,include_1.createIncludeNode)({only:a,ignoreMissing:l},{expression:s,variables:o},r.line,r.column,"include")}}};exports.createIncludeTagHandler=createIncludeTagHandler;const parseArguments=(e,r,n,i)=>{let t=!1;r.nextIf(twig_lexer_1.TokenType.NAME,"ignore")&&(r.expect(twig_lexer_1.TokenType.NAME,"missing"),t=!0);let s=(0,array_1.createArrayNode)([],n,i);r.nextIf(twig_lexer_1.TokenType.NAME,"with")&&(s=e.parseExpression(r));let l=!1;return r.nextIf(twig_lexer_1.TokenType.NAME,"only")&&(l=!0),r.expect(twig_lexer_1.TokenType.TAG_END),{variables:s,only:l,ignoreMissing:t}};exports.parseArguments=parseArguments;

},{"../node/expression/array":138,"../node/include/include":192,"twig-lexer":431}],233:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createLineTagHandler=void 0;const twig_lexer_1=require("twig-lexer"),line_1=require("../node/line"),createLineTagHandler=()=>{return{tag:"line",initialize:()=>(e,r)=>{const n=r.expect(twig_lexer_1.TokenType.NUMBER);return r.expect(twig_lexer_1.TokenType.TAG_END),(0,line_1.createLineNode)(Number(n.value),e.line,e.column,"line")}}};exports.createLineTagHandler=createLineTagHandler;

},{"../node/line":193,"twig-lexer":431}],234:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createMacroTagHandler=void 0;const parsing_1=require("../error/parsing"),body_1=require("../node/body"),macro_1=require("../node/macro"),twig_lexer_1=require("twig-lexer"),array_1=require("../node/expression/array"),createMacroTagHandler=()=>{return{tag:"macro",initialize:e=>(r,a)=>{const{line:o,column:t}=r,c=a.expect(twig_lexer_1.TokenType.NAME).value,n=e.parseArguments(a,!0,!0);for(const{key:e,value:r}of(0,array_1.getKeyValuePairs)(n)){const{value:a}=e.attributes;if(a===macro_1.VARARGS_NAME)throw(0,parsing_1.createParsingError)(`The argument "${macro_1.VARARGS_NAME}" in macro "${c}" cannot be defined because the variable "${macro_1.VARARGS_NAME}" is reserved for arbitrary arguments.`,r)}a.expect(twig_lexer_1.TokenType.TAG_END),e.pushLocalScope();const i=e.subparse(a,"macro",e=>e.test(twig_lexer_1.TokenType.NAME,"endmacro"),!0),s=a.nextIf(twig_lexer_1.TokenType.NAME);if(s){const e=s.value;if(e!=c){const{line:r,column:o}=s;throw(0,parsing_1.createParsingError)(`Expected endmacro for macro "${c}" (but "${e}" given).`,{line:r,column:o},a.source.resolvedName)}}return e.popLocalScope(),a.expect(twig_lexer_1.TokenType.TAG_END),e.setMacro(c,(0,macro_1.createMacroNode)(c,(0,body_1.createBodyNode)(i,o,t),n,o,t,"macro")),null}}};exports.createMacroTagHandler=createMacroTagHandler;

},{"../error/parsing":8,"../node/body":130,"../node/expression/array":138,"../node/macro":194,"twig-lexer":431}],235:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSandboxTagHandler=void 0;const parsing_1=require("../error/parsing"),sandbox_1=require("../node/sandbox"),node_1=require("../node"),is_made_of_whitespace_only_1=require("../helpers/is-made-of-whitespace-only"),twig_lexer_1=require("twig-lexer"),createSandboxTagHandler=()=>{const e="sandbox";return{tag:e,initialize:r=>(a,n)=>{n.expect(twig_lexer_1.TokenType.TAG_END);let t=r.subparse(n,e,e=>e.test(twig_lexer_1.TokenType.NAME,"endsandbox"),!0);if(n.expect(twig_lexer_1.TokenType.TAG_END),!t.is("include"))for(const[,e]of(0,node_1.getChildren)(t))if(!(e.is("text")&&(0,is_made_of_whitespace_only_1.isMadeOfWhitespaceOnly)(e.attributes.data)||e.is("include")))throw(0,parsing_1.createParsingError)('Only "include" tags are allowed within a "sandbox" section.',e,n.source.resolvedName);return(0,sandbox_1.createSandboxNode)(t,a.line,a.column,e)}}};exports.createSandboxTagHandler=createSandboxTagHandler;

},{"../error/parsing":8,"../helpers/is-made-of-whitespace-only":98,"../node":126,"../node/sandbox":203,"twig-lexer":431}],236:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSetTagHandler=void 0;const parsing_1=require("../error/parsing"),set_1=require("../node/set"),twig_lexer_1=require("twig-lexer"),node_1=require("../node"),createSetTagHandler=()=>{return{tag:"set",initialize:e=>(r,t)=>{const{line:n,column:s}=r,o=e.parseAssignmentExpression(t);let i,a=!1;if(t.nextIf(twig_lexer_1.TokenType.OPERATOR,"=")){if(i=e.parseMultiTargetExpression(t),t.expect(twig_lexer_1.TokenType.TAG_END),(0,node_1.getChildrenCount)(o)!==(0,node_1.getChildrenCount)(i)){const{line:e,column:r}=t.current;throw(0,parsing_1.createParsingError)("When using set, you must have the same number of variables and assignments.",{line:e,column:r},t.source.resolvedName)}}else{if(a=!0,(0,node_1.getChildrenCount)(o)>1){const{line:e,column:r}=t.current;throw(0,parsing_1.createParsingError)("When using set with a block, you cannot have a multi-target.",{line:e,column:r},t.source.resolvedName)}t.expect(twig_lexer_1.TokenType.TAG_END),i=e.subparse(t,"set",e=>e.test(twig_lexer_1.TokenType.NAME,"endset"),!0),t.expect(twig_lexer_1.TokenType.TAG_END)}return(0,set_1.createSetNode)(a,o,i,n,s,"set")}}};exports.createSetTagHandler=createSetTagHandler;

},{"../error/parsing":8,"../node":126,"../node/set":204,"twig-lexer":431}],237:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSpacelessTagHandler=void 0;const spaceless_1=require("../node/output/spaceless"),twig_lexer_1=require("twig-lexer"),createSpacelessTagHandler=()=>{const e="spaceless";return{tag:e,initialize:s=>(t,a)=>{const{line:r,column:c}=t;console.warn(`The "spaceless" tag in "${a.source.name}" at line ${r} is deprecated since Twig 2.7, use the "spaceless" filter instead.`),a.expect(twig_lexer_1.TokenType.TAG_END);const l=s.subparse(a,e,e=>e.test(twig_lexer_1.TokenType.NAME,"endspaceless"),!0);return a.expect(twig_lexer_1.TokenType.TAG_END),(0,spaceless_1.createSpacelessNode)(l,r,c,e)}}};exports.createSpacelessTagHandler=createSpacelessTagHandler;

},{"../node/output/spaceless":200,"twig-lexer":431}],238:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createUseTagHandler=void 0;const parsing_1=require("../error/parsing"),constant_1=require("../node/expression/constant"),node_1=require("../node"),twig_lexer_1=require("twig-lexer"),trait_1=require("../node/trait"),arguments_1=require("../node/expression/arguments"),createUseTagHandler=()=>{return{tag:"use",initialize:e=>(r,t)=>{const{line:n,column:a}=r,s=e.parseExpression(t);if(!s.is("constant"))throw(0,parsing_1.createParsingError)('The template references in a "use" statement must be a string.',{line:n,column:a},t.source.resolvedName);const i={};if(t.nextIf(twig_lexer_1.TokenType.NAME,"with"))for(;;){const e=t.expect(twig_lexer_1.TokenType.NAME).value;let r=e;if(t.nextIf(twig_lexer_1.TokenType.NAME,"as")&&(r=t.expect(twig_lexer_1.TokenType.NAME).value),i[e]=(0,constant_1.createConstantNode)(r,n,a),!t.nextIf(twig_lexer_1.TokenType.PUNCTUATION,","))break}return t.expect(twig_lexer_1.TokenType.TAG_END),e.addTrait((0,trait_1.createTraitNode)(s,(0,arguments_1.createArgumentsNode)(i,n,a),n,a)),(0,node_1.createBaseNode)(null)}}};exports.createUseTagHandler=createUseTagHandler;

},{"../error/parsing":8,"../node":126,"../node/expression/arguments":137,"../node/expression/constant":174,"../node/trait":205,"twig-lexer":431}],239:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createVerbatimTagHandler=void 0;const verbatim_1=require("../node/output/verbatim"),twig_lexer_1=require("twig-lexer"),createVerbatimTagHandler=()=>{const e="verbatim";return{tag:e,initialize:t=>(r,a)=>{a.expect(twig_lexer_1.TokenType.TAG_END);let i=t.subparse(a,e,e=>e.test(twig_lexer_1.TokenType.NAME,"endverbatim"),!0);a.expect(twig_lexer_1.TokenType.TAG_END);let n="";return i.is("text")&&(n=i.attributes.data),(0,verbatim_1.createVerbatimNode)(n,r.line,r.column,e)}}};exports.createVerbatimTagHandler=createVerbatimTagHandler;

},{"../node/output/verbatim":202,"twig-lexer":431}],240:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createWithTagHandler=void 0;const with_1=require("../node/with"),twig_lexer_1=require("twig-lexer"),createWithTagHandler=()=>{return{tag:"with",initialize:e=>(t,r)=>{let i=null,l=!1;r.test(twig_lexer_1.TokenType.TAG_END)||(i=e.parseExpression(r),l=null!==r.nextIf(twig_lexer_1.TokenType.NAME,"only")),r.expect(twig_lexer_1.TokenType.TAG_END);let n=e.subparse(r,"with",e=>e.test(twig_lexer_1.TokenType.NAME,"endwith"),!0);return r.expect(twig_lexer_1.TokenType.TAG_END),(0,with_1.createWithNode)(n,i,l,t.line,t.column,"with")}}};exports.createWithTagHandler=createWithTagHandler;

},{"../node/with":206,"twig-lexer":431}],241:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTemplate=void 0;const context_1=require("./context"),output_buffer_1=require("./output-buffer"),merge_iterables_1=require("./helpers/merge-iterables"),runtime_1=require("./error/runtime"),node_1=require("./node"),error_1=require("./error"),map_like_1=require("./helpers/map-like"),markup_1=require("./markup"),include_1=require("./extension/core/functions/include"),loader_1=require("./error/loader"),clone_map_1=require("./helpers/clone-map"),body_1=require("./node/body"),array_1=require("./node/expression/array"),iterator_to_map_1=require("./helpers/iterator-to-map"),createTemplate=(e,t)=>{let r=new Map,n=new Map,o=null,a=null;const{blocks:l}=t.children;for(const[e,t]of(0,node_1.getChildren)(l)){const n=(e,r,n,o)=>{const a=_.aliases.clone();return t.children.body.execute(_,e,r,n,a,o)};r.set(e,n)}const{macros:s}=t.children;for(const[t,r]of Object.entries(s.children)){const o=async(t,n,...o)=>{const{body:a,arguments:l}=r.children,s=(0,array_1.getKeyValuePairs)(l),i=_.aliases.clone(),c=new Map;for(const{key:e,value:r}of s){const a=e.attributes.value,l=await r.execute(_,(0,context_1.createContext)(),t,new Map,i,n);let s=o.shift();void 0===s&&(s=l),c.set(a,s)}c.set("varargs",o);const u=(0,context_1.createContext)(_.mergeGlobals(c)),m=new Map;return t.start(),await a.execute(_,u,t,m,i,n).then(()=>{const r=t.getContents();return(0,markup_1.createMarkup)(r,e.charset)}).finally(()=>{t.endAndClean()})};n.set(t,o)}let i=null;const c=new Map;for(const e of t.embeddedTemplates)c.set(e.attributes.index,e);const{parent:u,macros:m,body:d}=t.children,{line:p,column:h}=t;let g=void 0===u&&0===(0,node_1.getChildrenCount)(m);if(g){let e=d.children.content;0===(0,node_1.getChildrenCount)(e)&&(e=(0,body_1.createBodyNode)(e,p,h));for(const[,t]of Object.entries(e.children))if(0!==(0,node_1.getChildrenCount)(t)){g=!1;break}}const _={get aliases(){return f},get blockHandlers(){return r},get canBeUsedAsATrait(){return g},get environment(){return e},get macroHandlers(){return n},get source(){return t.attributes.source},get templateName(){return _.source.name},assertToStringAllowed:t=>(e.isSandboxed&&"object"==typeof t&&e.sandboxPolicy.checkMethodAllowed(t,"toString"),t),callMacro:(e,t,r,n,o,a,l,s,i)=>{const c=e=>e.macroHandlers.has(t)?Promise.resolve(e.macroHandlers.get(t)):e.getParent(l,r).then(e=>e?c(e):null);return c(e).then(l=>{if(l)return l(r,i,...n);throw(0,runtime_1.createRuntimeError)(`Macro "${t}" is not defined in template "${e.templateName}".`,{line:o,column:a},s)})},displayBlock:(e,t,r,n,o,a)=>_.getBlocks().then(l=>{let s,i;if(o&&void 0!==(i=n.get(e))){const[e,t]=i;s=e.blockHandlers.get(t)}else if(void 0!==(i=l.get(e))){const[e,t]=i;s=e.blockHandlers.get(t)}return s?s(t,r,n,a):_.getParent(t,r).then(o=>{if(o)return o.displayBlock(e,t,r,(0,merge_iterables_1.mergeIterables)(l,n),!1,a);if(n.has(e)){const[t]=n.get(e);throw(0,runtime_1.createRuntimeError)(`Block "${e}" should not call parent() in "${t.templateName}" as the block does not exist in the parent template "${_.templateName}".`,void 0,t.templateName)}throw(0,runtime_1.createRuntimeError)(`Block "${e}" on template "${_.templateName}" does not exist.`,void 0,_.templateName)})}),execute:async(e,r,n=new Map,o)=>{const a=_.aliases.clone();return Promise.all([_.getParent(e,r),_.getBlocks()]).then(([l,s])=>t.execute(_,e,r,(0,merge_iterables_1.mergeIterables)(s,n),a,o).then(()=>{if(l){const t=(0,merge_iterables_1.mergeIterables)(s,n);return l.execute(e,r,t,o)}})).catch(e=>{throw e.source||(e.source=_.templateName),(0,loader_1.isATemplateLoadingError)(e)&&(e=(0,runtime_1.createRuntimeError)(e.rootMessage,e.location,e.source,e)),e})},getBlocks:()=>o?Promise.resolve(o):_.getTraits().then(e=>o=(0,merge_iterables_1.mergeIterables)(e,new Map([...r.keys()].map(e=>[e,[_,e]])))),getParent:async(e,r)=>{if(null!==a)return Promise.resolve(a);const n=t.children.parent;return n?_.getBlocks().then(async t=>{const o=await n.execute(_,e,r,t,(0,context_1.createContext)()),l=await _.loadTemplate(o,n.line,n.column);return n.is("constant")&&(a=l),l}):Promise.resolve(null)},getTraceableMethod:(e,t,r,n)=>(...o)=>e(...o).catch(e=>{if(!(0,error_1.isATwingError)(e))throw(0,runtime_1.createRuntimeError)(`An exception has been thrown during the rendering of a template ("${e.message}").`,{line:t,column:r},n,e);throw void 0===e.location&&(e.location={line:t,column:r},e.source=n),e}),getTraits:async()=>{if(null===i){i=new Map;const{traits:e}=t.children;for(const[,t]of(0,node_1.getChildren)(e)){const{template:e,targets:r}=t.children,n=e.attributes.value,o=await _.loadTemplate(n,e.line,e.column);if(!o.canBeUsedAsATrait)throw(0,runtime_1.createRuntimeError)(`Template ${n} cannot be used as a trait.`,e,_.templateName);const a=(0,clone_map_1.cloneMap)(await o.getBlocks());for(const[t,o]of(0,node_1.getChildren)(r)){const r=a.get(t);if(!r)throw(0,runtime_1.createRuntimeError)(`Block "${t}" is not defined in trait "${n}".`,e,_.templateName);const l=o.attributes.value;a.set(l,r),a.delete(t)}i=(0,merge_iterables_1.mergeIterables)(i,a)}}return Promise.resolve(i)},hasBlock:(e,t,r,n)=>n.has(e)?Promise.resolve(!0):_.getBlocks().then(n=>n.has(e)?Promise.resolve(!0):_.getParent(t,r).then(o=>!!o&&o.hasBlock(e,t,r,n))),hasMacro:e=>Promise.resolve(_.macroHandlers.has(e)),include:(e,t,r,n,o,a,l,s,i,c,u)=>(0,include_1.include)(e,t,r,n,o,a,l,s,i).catch(e=>{throw void 0===e.location&&(e.location={line:c,column:u}),e}),loadTemplate:(t,r,n,o)=>{let a;if(void 0!==o){const t=c.get(o);a=Promise.resolve((0,exports.createTemplate)(e,t))}else a="string"==typeof t?e.loadTemplate(t):(0,map_like_1.isAMapLike)(t)?e.resolveTemplate([...t.values()],_.templateName):Promise.resolve(t);return a.catch(e=>{throw void 0===e.location&&(e.location={line:r,column:n}),e})},mergeGlobals:e.mergeGlobals,render:(t,r,n)=>{const o=r||(0,output_buffer_1.createOutputBuffer)();return o.start(),_.execute((0,context_1.createContext)(e.mergeGlobals((0,iterator_to_map_1.iteratorToMap)(t))),o,void 0,n).then(()=>o.getContents())},renderBlock:(e,t,r,n,o,a)=>(r.start(),_.displayBlock(e,t,r,n,o,a).then(()=>r.getAndClean())),renderParentBlock:(e,t,r,n)=>(r.start(),_.getBlocks().then(o=>((e,t,r,n,o)=>_.getTraits().then(a=>{if(a.has(e)){const[l,s]=a.get(e);return l.displayBlock(s,t,r,n,!1,o)}return _.getParent(t,r).then(a=>{if(null!==a)return a.displayBlock(e,t,r,n,!1,o);throw(0,runtime_1.createRuntimeError)(`The template has no parent and no traits defining the "${e}" block.`,void 0,_.templateName)})}))(e,t,r,o,n).then(()=>r.getAndClean())))},f=(0,context_1.createContext)();return f.set("_self",_),_};exports.createTemplate=createTemplate;

},{"./context":3,"./error":5,"./error/loader":7,"./error/runtime":9,"./extension/core/functions/include":57,"./helpers/clone-map":77,"./helpers/iterator-to-map":104,"./helpers/map-like":106,"./helpers/merge-iterables":107,"./markup":119,"./node":126,"./node/body":130,"./node/expression/array":138,"./output-buffer":208}],242:[function(require,module,exports){
...
},{"./callable-wrapper":2}],243:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTokenStream=void 0;const parsing_1=require("./error/parsing"),twig_lexer_1=require("twig-lexer"),lexer_1=require("./lexer"),createTokenStream=(e,t)=>{const r=new twig_lexer_1.TokenStream(e),n={get current(){return r.current},get source(){return t},injectTokens:e=>{r.injectTokens(e)},next:()=>r.next(),nextIf:(e,t)=>r.nextIf(e,t),expect:(e,r=null,o=null)=>{let l=n.current;if(!l.test(e,r||void 0)){const{line:n,column:i}=l;throw(0,parsing_1.createParsingError)(o?`${o}.`:`Unexpected token "${(0,lexer_1.typeToEnglish)(l.type)}" of value "${l.value}" ("${(0,lexer_1.typeToEnglish)(e)}" expected${r?` with value "${r}"`:""}).`,{line:n,column:i},t.resolvedName)}return n.next(),l},look:e=>r.look(e),test:(e,t)=>r.test(e,t),isEOF:()=>n.current.type===twig_lexer_1.TokenType.EOF,toAst:()=>r.traverse((e,t)=>((e=(0,twig_lexer_1.astVisitor)(e,t))&&e.test(twig_lexer_1.TokenType.TEST_OPERATOR)&&(e=new twig_lexer_1.Token(twig_lexer_1.TokenType.OPERATOR,e.value,e.line,e.column)),e))};return n};exports.createTokenStream=createTokenStream;

},{"./error/parsing":8,"./lexer":114,"twig-lexer":431}],244:[function(require,module,exports){
...
},{"base64-js":244,"buffer":246,"ieee754":291}],247:[function(require,module,exports){
...
},{"inherits":292,"safe-buffer":406,"stream":428,"string_decoder":429}],249:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":246}],250:[function(require,module,exports){
...
},{"buffer":246}],251:[function(require,module,exports){
...
},{"cipher-base":248,"inherits":292,"md5.js":379,"ripemd160":404,"sha.js":409}],252:[function(require,module,exports){
...
},{"clone":249}],253:[function(require,module,exports){
...
},{"inherits":292,"readable-stream":270,"safe-buffer":406}],256:[function(require,module,exports){
...
},{"./_stream_readable":259,"./_stream_writable":261,"_process":387,"inherits":292}],258:[function(require,module,exports){
...
},{"../errors":256,"./_stream_duplex":257,"./internal/streams/async_iterator":262,"./internal/streams/buffer_list":263,"./internal/streams/destroy":264,"./internal/streams/from":266,"./internal/streams/state":268,"./internal/streams/stream":269,"_process":387,"buffer":246,"events":254,"inherits":292,"string_decoder/":429,"util":245}],260:[function(require,module,exports){
...
},{"../errors":256,"./_stream_duplex":257,"./internal/streams/destroy":264,"./internal/streams/state":268,"./internal/streams/stream":269,"_process":387,"buffer":246,"inherits":292,"util-deprecate":439}],262:[function(require,module,exports){
(function (process){(function (){
...
},{"./end-of-stream":265,"_process":387}],263:[function(require,module,exports){
...
},{"buffer":246,"util":245}],264:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":387}],265:[function(require,module,exports){
...
},{"safer-buffer":407}],273:[function(require,module,exports){
...
},{"safer-buffer":407,"string_decoder":429}],276:[function(require,module,exports){
...
},{"safer-buffer":407}],277:[function(require,module,exports){
...
},{"safer-buffer":407}],289:[function(require,module,exports){
...
},{"../encodings":274,"./bom-handling":289,"./extend-node":245,"./streams":245,"_process":387,"safer-buffer":407}],291:[function(require,module,exports){
...
},{"../i18n/i18n_loc_get_default":306,"../info/ini_get":307,"../strings/strnatcmp":366}],305:[function(require,module,exports){
...
},{"../_helpers/_phpCastString":298}],367:[function(require,module,exports){
...
},{"../array/krsort":304,"../info/ini_set":308}],368:[function(require,module,exports){
...
},{"../url/rawurlencode":371,"../url/urlencode":372}],371:[function(require,module,exports){
...
},{"../strings/echo":357}],376:[function(require,module,exports){
(function (global){(function (){
...
},{"hash-base":255,"inherits":292,"safe-buffer":406}],380:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":381,"./vendor/camel-case-upper-regexp":382,"./vendor/non-word-regexp":383,"lower-case":377}],381:[function(require,module,exports){
...
},{"wcwidth":441}],385:[function(require,module,exports){
(function (process){(function (){
...
},{"./_stream_readable":391,"./_stream_writable":393,"core-util-is":250,"inherits":292,"process-nextick-args":386}],390:[function(require,module,exports){
...
},{"./_stream_transform":392,"core-util-is":250,"inherits":292}],391:[function(require,module,exports){
(function (process,global){(function (){
...
},{"./_stream_duplex":389,"./internal/streams/BufferList":394,"./internal/streams/destroy":395,"./internal/streams/stream":396,"_process":387,"core-util-is":250,"events":254,"inherits":292,"isarray":295,"process-nextick-args":386,"safe-buffer":397,"string_decoder/":398,"util":245}],392:[function(require,module,exports){
...
},{"./_stream_duplex":389,"core-util-is":250,"inherits":292}],393:[function(require,module,exports){
...
},{"./_stream_duplex":389,"./internal/streams/destroy":395,"./internal/streams/stream":396,"_process":387,"core-util-is":250,"inherits":292,"process-nextick-args":386,"safe-buffer":397,"timers":430,"util-deprecate":439}],394:[function(require,module,exports){
...
},{"safe-buffer":397,"util":245}],395:[function(require,module,exports){
...
},{"events":254}],397:[function(require,module,exports){
...
},{"buffer":246}],398:[function(require,module,exports){
...
},{"buffer":246,"hash-base":255,"inherits":292}],405:[function(require,module,exports){
...
},{"buffer":246}],407:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":387,"buffer":246}],408:[function(require,module,exports){
...
},{"./hash":408,"inherits":292,"safe-buffer":406}],411:[function(require,module,exports){
...
},{"./hash":408,"inherits":292,"safe-buffer":406}],412:[function(require,module,exports){
...
},{"./hash":408,"./sha256":413,"inherits":292,"safe-buffer":406}],413:[function(require,module,exports){
...
},{"./hash":408,"inherits":292,"safe-buffer":406}],414:[function(require,module,exports){
...
},{"./hash":408,"./sha512":415,"inherits":292,"safe-buffer":406}],415:[function(require,module,exports){
...
},{"./hash":408,"inherits":292,"safe-buffer":406}],416:[function(require,module,exports){
var noCase=require("no-case");module.exports=function(e,n){return noCase(e,n,"_")};

},{"no-case":380}],417:[function(require,module,exports){
...
},{"events":254,"inherits":292,"readable-stream/duplex.js":388,"readable-stream/passthrough.js":399,"readable-stream/readable.js":400,"readable-stream/transform.js":401,"readable-stream/writable.js":402}],429:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,isEncoding=Buffer.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function _normalizeEncoding(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function normalizeEncoding(t){var e=_normalizeEncoding(t);if("string"!=typeof e&&(Buffer.isEncoding===isEncoding||!isEncoding(t)))throw new Error("Unknown encoding: "+t);return e||t}function StringDecoder(t){var e;switch(this.encoding=normalizeEncoding(t),this.encoding){case"utf16le":this.text=utf16Text,this.end=utf16End,e=4;break;case"utf8":this.fillLast=utf8FillLast,e=4;break;case"base64":this.text=base64Text,this.end=base64End,e=3;break;default:return this.write=simpleWrite,void(this.end=simpleEnd)}this.lastNeed=0,this.lastTotal=0,this.lastChar=Buffer.allocUnsafe(e)}function utf8CheckByte(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function utf8CheckIncomplete(t,e,s){var i=e.length-1;if(i<s)return 0;var n=utf8CheckByte(e[i]);return n>=0?(n>0&&(t.lastNeed=n-1),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(t.lastNeed=n-2),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(2===n?n=0:t.lastNeed=n-3),n):0}function utf8CheckExtraBytes(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function utf8FillLast(t){var e=this.lastTotal-this.lastNeed,s=utf8CheckExtraBytes(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function utf8Text(t,e){var s=utf8CheckIncomplete(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function utf8End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function utf16Text(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function utf16End(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function base64Text(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function base64End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function simpleWrite(t){return t.toString(this.encoding)}function simpleEnd(t){return t&&t.length?this.write(t):""}exports.StringDecoder=StringDecoder,StringDecoder.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},StringDecoder.prototype.end=utf8End,StringDecoder.prototype.text=utf8Text,StringDecoder.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};
...
},{"buffer":246,"lodash":376}],438:[function(require,module,exports){
...
},{"./combining":440,"defaults":252}]},{},[1])(1)
});
