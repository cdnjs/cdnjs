...
},{"locutus/php/strings/bin2hex":356,"locutus/php/strings/ltrim":358,"utf8-binary-cutter":436}],11:[function(require,module,exports){
...
},{"locutus/php/strings/bin2hex":356,"locutus/php/strings/sprintf":363,"utf8-binary-cutter":436}],14:[function(require,module,exports){
...
},{"../../../helpers/format-date-time":86,"../../../helpers/format-duration":87,"../functions/date":55,"luxon":376}],24:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/modify-date":108,"luxon":376}],56:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/iconv":96,"../../../helpers/is-traversable":100,"../../../helpers/iterator-to-array":102,"buffer":246,"locutus/php/array/array_rand":303,"locutus/php/math/mt_rand":344,"runes":403}],61:[function(require,module,exports){
...
},{"../../../../node_modules/is-buffer/index.js":293,"../markup":119,"./map-like":106,"luxon":376}],79:[function(require,module,exports){
...
},{"pad":382}],88:[function(require,module,exports){
...
},{"../error/runtime":9,"./examine-object":84,"./get":95,"./is-plain-object":99,"./map-like":106,"isobject":296,"locutus/php/var/is_bool":372,"locutus/php/var/is_float":373}],89:[function(require,module,exports){
...
},{"luxon":376}],109:[function(require,module,exports){
...
},{"regex-parser":401}],110:[function(require,module,exports){
...
},{"./error/parsing":8,"./token-stream":243,"twig-lexer":429}],115:[function(require,module,exports){
...
},{"../source":218,"locutus/php/strings/rtrim":362,"path":383}],118:[function(require,module,exports){
...
},{"../source":218,"path":383}],119:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"../../error/runtime":9,"../../helpers/get-filter":91,"../../helpers/get-function":93,"../../helpers/get-test":94,"../expression":136,"./array":138,"./constant":174,"locutus/php/array/array_merge":302,"snake-case":414}],170:[function(require,module,exports){
...
},{"stream":426}],209:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createParser=void 0;const parsing_1=require("./error/parsing"),node_1=require("./node"),text_1=require("./node/output/text"),print_1=require("./node/output/print"),body_1=require("./node/body"),module_1=require("./node/module"),node_traverser_1=require("./node-traverser"),comment_1=require("./node/comment"),is_made_of_whitespace_only_1=require("./helpers/is-made-of-whitespace-only"),constant_1=require("./node/expression/constant"),concatenate_1=require("./node/expression/binary/concatenate"),assignment_1=require("./node/expression/assignment"),arrow_function_1=require("./node/expression/arrow-function"),name_1=require("./node/expression/name"),parent_function_1=require("./node/expression/parent-function"),block_function_1=require("./node/expression/block-function"),attribute_accessor_1=require("./node/expression/attribute-accessor"),array_1=require("./node/expression/array"),method_call_1=require("./node/expression/method-call"),hash_1=require("./node/expression/hash"),not_1=require("./node/expression/unary/not"),conditional_1=require("./node/expression/conditional"),twig_lexer_1=require("twig-lexer"),lexer_1=require("./lexer"),function_1=require("./node/expression/call/function"),filter_1=require("./node/expression/call/filter"),record_1=require("./helpers/record"),arguments_1=require("./node/expression/arguments"),get_function_1=require("./helpers/get-function"),get_filter_1=require("./helpers/get-filter"),get_test_1=require("./helpers/get-test"),core_1=require("./node-visitor/core"),escaper_1=require("./node-visitor/escaper"),macro_auto_import_1=require("./node-visitor/macro-auto-import"),sandbox_1=require("./node-visitor/sandbox"),test_1=require("./node/expression/call/test"),pos_1=require("./node/expression/unary/pos"),neg_1=require("./node/expression/unary/neg"),nameRegExp=new RegExp(twig_lexer_1.namePattern),getNames=e=>[...e.values()].map(({name:e})=>e),createParser=(e,t,r,n,o,a,s,l)=>{const c=new Map;let i=0,u=null,d={},p=[],m={},N=[{method:new Map,template:[]}],_={},f=[],g=1;const T=getNames(o),x=getNames(a),h=getNames(s),v=r.map(({tag:e})=>e),A=[],U=(e,t)=>{if(!(t.is("constant")||t.is("array")||t.is(hash_1.hashNodeType)||t.is(neg_1.negativeNodeType)||t.is(pos_1.positiveNodeType)))return t;for(const[,r]of(0,node_1.getChildren)(t))if(null!==U(e,r))return r;return null},y=(e,t,r=!1)=>{if(t.is(text_1.textNodeType)&&!(0,is_made_of_whitespace_only_1.isMadeOfWhitespaceOnly)(t.attributes.data)){const{data:r}=t.attributes;if(r.indexOf(String.fromCharCode(239,187,191))>-1){const e=r.substring(3);if(""===e||(0,is_made_of_whitespace_only_1.isMadeOfWhitespaceOnly)(e))return null}throw(0,parsing_1.createParsingError)("A template that extends another one cannot include content outside Twig blocks. Did you forget to put the content inside a {% block %} tag?",t,e.source.resolvedName)}if(t.isACaptureNode)return t;if(r||"spaceless"!==t.type||console.warn(`Using the spaceless tag at the root level of a child template in "${e.source.name}" at line ${t.line} is deprecated since Twig 2.5.0 and will become a syntax error in Twig 3.0.`),r&&"block_reference"===t.type)return console.warn(`Nesting a block definition under a non-capturing node in "${e.source.name}" at line ${t.line} is deprecated since Twig 2.5.0 and will become a syntax error in Twig 3.0.`),null;if(t.isAnOutputNode&&"spaceless"!==t.type)return null;r=r||null!==t.type;for(let[n,o]of(0,node_1.getChildren)(t))null!==o&&null===y(e,o,r)&&delete t.children[n];return t},b=(e,t,r,n)=>{const{strict:a}=l,s=(0,get_filter_1.getFilter)(o,t);if(s){if(s.isDeprecated){let t=`Filter "${s.name}" is deprecated`;!0!==s.deprecatedVersion&&(t+=` since version ${s.deprecatedVersion}`),s.alternative&&(t+=`. Use "${s.alternative}" instead`),t+=` in "${e.source.name}" at line ${r}.`,console.warn(t)}}else if(a){const o=(0,parsing_1.createParsingError)(`Unknown filter "${t}".`,{line:r,column:n},e.source.resolvedName);throw o.addSuggestions(t,T),o}return filter_1.createFilterNode},O=(e,t,r,n)=>{switch(t){case"parent":if(I(e),!(()=>p)().length)throw(0,parsing_1.createParsingError)('Calling "parent" outside a block is forbidden.',{line:r,column:n},e.source.resolvedName);if(!u&&!C())throw(0,parsing_1.createParsingError)('Calling "parent" on a template that does not extend nor "use" another template is forbidden.',{line:r,column:n},e.source.resolvedName);return(0,parent_function_1.createParentFunctionNode)(L(),r,n);case"block":const o=I(e),s=(0,array_1.getKeyValuePairs)(o);if(s.length<1)throw(0,parsing_1.createParsingError)('The "block" function takes one argument (the block name).',{line:r,column:n},e.source.resolvedName);return(0,block_function_1.createBlockFunctionNode)(s[0].value,s.length>1?s[1].value:null,r,n);case"attribute":const c=I(e),i=(0,array_1.getKeyValuePairs)(c);if(i.length<2)throw(0,parsing_1.createParsingError)('The "attribute" function takes at least two arguments (the variable and the attributes).',{line:r,column:n},e.source.resolvedName);return(0,attribute_accessor_1.createAttributeAccessorNode)(i[0].value,i[1].value,i.length>2?i[2].value:(0,array_1.createArrayNode)([],r,n),"any",r,n);default:const d=P(t);if(d){const t=I(e);return(0,method_call_1.createMethodCallNode)(d.node,d.name,t,r,n)}const m=I(e,!0);return((e,t,r,n)=>{const{strict:o}=l,s=(0,get_function_1.getFunction)(a,t);if(s){if(s.isDeprecated){let t=`Function "${s.name}" is deprecated`;!0!==s.deprecatedVersion&&(t+=` since version ${s.deprecatedVersion}`),s.alternative&&(t+=`. Use "${s.alternative}" instead`),t+=` in "${e.source.name}" at line ${r}.`,console.warn(t)}}else if(o){const o=(0,parsing_1.createParsingError)(`Unknown function "${t}".`,{line:r,column:n},e.source.resolvedName);throw o.addSuggestions(t,x),o}return function_1.createFunctionNode})(e,t,r,n)(t,m,r,n)}},P=e=>{let t;const r=t=>{const r=t.method;return r&&r.has(e)?r.get(e):null};t=r(N[0])||null;let n=N.length;return!t&&n>1&&(t=r(N[n-1])||null),t},C=()=>Object.keys(_).length>0,E=e=>e.test("OPERATOR")&&t.get(e.value)||null,k=t=>t.test("OPERATOR")&&e.get(t.value)||null,I=(e,t=!1,r=!1,n)=>{const{line:o,column:a}=e.current,s=[];let l,c;for(e.expect("PUNCTUATION","(");!e.test("PUNCTUATION",")");){if(s.length>0&&e.expect("PUNCTUATION",","),r){c=e.expect("NAME",null);const{line:t,column:r}=e.current;l=(0,name_1.createNameNode)(c.value,t,r)}else l=w(e,0,n);let i=void 0;if(t&&(c=e.nextIf("OPERATOR","="))){if(!l.is("name"))throw(0,parsing_1.createParsingError)(`A parameter name must be a string, "${l.type.toString()}" given.`,l,e.source.resolvedName);if(i=(0,constant_1.createConstantNode)(l.attributes.name,l.line,l.column),r){l=S(e);const t=U(e,l);if(null!==t)throw(0,parsing_1.createParsingError)("A default value for an argument must be a constant (a boolean, a string, a number, or an array).",t,e.source.resolvedName)}else l=w(e,0,n)}r&&void 0===i&&(i=(0,constant_1.createConstantNode)(l.attributes.name,o,a),l=(0,constant_1.createConstantNode)(null,o,a)),s.push({key:i,value:l})}return e.expect("PUNCTUATION",")"),(0,array_1.createArrayNode)(s,o,a)},w=(e,t=0,r)=>{if(r){const t=(e=>{let t,r,n,o;if(e.look(1).test("ARROW"))return r=e.current.line,n=e.current.column,t=e.expect("NAME"),o={0:(0,assignment_1.createAssignmentNode)(t.value,t.line,t.column)},e.expect("ARROW"),(0,arrow_function_1.createArrowFunctionNode)(w(e,0),(0,node_1.createBaseNode)(null,{},o),r,n);let a=0;if(!e.look(a).test("PUNCTUATION","("))return null;for(++a;++a,e.look(a).test("PUNCTUATION",",");)++a;if(e.look(a).test("PUNCTUATION",")"),++a,!e.look(a).test("ARROW"))return null;for(r=(t=e.expect("PUNCTUATION","(")).line,n=t.column,o={},a=0;;){if(!(t=e.current).test("NAME"))throw(0,parsing_1.createParsingError)(`Unexpected token "${(0,lexer_1.typeToEnglish)(t.type)}" of value "${t.value}".`,t,e.source.resolvedName);if(o[a++]=(0,assignment_1.createAssignmentNode)(t.value,t.line,t.column),e.next(),!e.nextIf("PUNCTUATION",","))break}return e.expect("PUNCTUATION",")"),e.expect("ARROW"),(0,arrow_function_1.createArrowFunctionNode)(w(e,0),(0,node_1.createBaseNode)(null,{},o),r,n)})(e);if(t)return t}let n=(e=>{let t,r=e.current;if(null!==(t=k(r))){e.next();const n=w(e,t.precedence),o=t.expressionFactory;return M(e,o([n,(0,node_1.createBaseNode)(null)],r.line,r.column),r)}if(r.test("PUNCTUATION","(")){e.next();const t=w(e);return e.expect("PUNCTUATION",")","An opened parenthesis is not properly closed"),M(e,t,r)}return S(e)})(e),o=e.current,a=null;if("is not"===o.value||"is"===o.value)e.next(),n="is not"===o.value?$(e,n):V(e,n);else for(;null!==(a=E(o))&&a.precedence>=t;){e.next();const{expressionFactory:t}=a;n=t([n,w(e,"LEFT"===a.associativity?a.precedence+1:a.precedence)],o.line,o.column),o=e.current}return 0===t?((e,t)=>{let r,n;for(;e.nextIf("PUNCTUATION","?");){if(e.nextIf("PUNCTUATION",":"))r=t,n=w(e);else if(r=w(e),e.nextIf("PUNCTUATION",":"))n=w(e);else{const{line:t,column:r}=e.current;n=(0,constant_1.createConstantNode)("",t,r)}const{line:o,column:a}=e.current;t=(0,conditional_1.createConditionalNode)(t,r,n,o,a)}return t})(e,n):n},R=(e,t)=>(e.next(),q(e,t)),q=(e,t)=>{let r=null;for(;;){const n=e.expect("NAME"),{value:o,line:a,column:s}=n;let l;l=e.test("PUNCTUATION","(")?I(e,!0,!1,!0):(0,array_1.createArrayNode)([],a,s);const c=b(e,o,a,s);if(r=c(null===r?t:r,o,l,n.line,n.column),!e.test("PUNCTUATION","|"))break;e.next()}return r},$=(e,t)=>{const{line:r,column:n}=e.current;return(0,not_1.createNotNode)(V(e,t),r,n)},M=(e,t,r)=>{for(;;){let n=e.current;if("PUNCTUATION"!==n.type)break;if("."===n.value||"["===n.value)t=F(e,t,r);else{if("|"!==n.value)break;t=R(e,t)}}return t},S=t=>{const r=t.current;let n;switch(r.type){case"NAME":switch(t.next(),r.value){case"true":case"TRUE":n=(0,constant_1.createConstantNode)(!0,r.line,r.column);break;case"false":case"FALSE":n=(0,constant_1.createConstantNode)(!1,r.line,r.column);break;case"none":case"NONE":case"null":case"NULL":n=(0,constant_1.createConstantNode)(null,r.line,r.column);break;default:n="("===t.current.value?O(t,r.value,r.line,r.column):(0,name_1.createNameNode)(r.value,r.line,r.column)}break;case"NUMBER":t.next(),n=(0,constant_1.createConstantNode)(r.value,r.line,r.column);break;case"STRING":case"INTERPOLATION_START":n=B(t);break;case"OPERATOR":let o=nameRegExp.exec(r.value);if(null!==o&&o[0]===r.value){t.next(),n=(0,name_1.createNameNode)(r.value,r.line,r.column);break}if(e.has(r.value)){const o=e.get(r.value);t.next();const a=S(t),{expressionFactory:s}=o;n=s([a,(0,node_1.createBaseNode)(null)],r.line,r.column);break}default:if(r.test("PUNCTUATION","["))n=(e=>{const{line:t,column:r}=e.current;e.expect("PUNCTUATION","[","An array element was expected");const n=[];let o=!0;for(;!e.test("PUNCTUATION","]")&&(o||(e.expect("PUNCTUATION",",","An array element must be followed by a comma"),!e.test("PUNCTUATION","]")));)o=!1,n.push(w(e));return e.expect("PUNCTUATION","]","An opened array is not properly closed"),(0,array_1.createArrayNode)(n.map(e=>({value:e})),t,r)})(t);else{if(!r.test("PUNCTUATION","{"))throw!r.test("OPERATOR","=")||"=="!==t.look(-1).value&&"!="!==t.look(-1).value?(0,parsing_1.createParsingError)(`Unexpected token "${(0,lexer_1.typeToEnglish)(r.type)}" of value "${r.value}".`,r,t.source.resolvedName):(0,parsing_1.createParsingError)(`Unexpected operator of value "${r.value}". Did you try to use "===" or "!==" for strict comparison? Use "is same as(value)" instead.`,r,t.source.resolvedName);n=(e=>{e.expect("PUNCTUATION","{","A hash element was expected");let t=!0;const r=[];for(;!e.test("PUNCTUATION","}")&&(t||(e.expect("PUNCTUATION",",","A hash value must be followed by a comma"),!e.test("PUNCTUATION","}")));){let n,o;if(t=!1,(n=e.nextIf("STRING"))||(n=e.nextIf("NAME"))||(n=e.nextIf("NUMBER")))o=(0,constant_1.createConstantNode)(n.value,n.line,n.column);else{if(!e.test("PUNCTUATION","(")){const{type:t,line:r,value:n,column:o}=e.current;throw(0,parsing_1.createParsingError)(`A hash key must be a quoted string, a number, a name, or an expression enclosed in parentheses (unexpected token "${(0,lexer_1.typeToEnglish)(t)}" of value "${n}".`,{line:r,column:o},e.source.resolvedName)}o=w(e)}e.expect("PUNCTUATION",":","A hash key must be followed by a colon (:)");const a=w(e);r.push({key:o,value:a})}return e.expect("PUNCTUATION","}","An opened hash is not properly closed"),(0,hash_1.createHashNode)(r,e.current.line,e.current.column)})(t)}}return M(t,n,r)},B=e=>{const t=[];let r,n=!0;for(;;)if(n&&(r=e.nextIf("STRING")))t.push((0,constant_1.createConstantNode)(r.value,r.line,r.column)),n=!1;else{if(!e.nextIf("INTERPOLATION_START"))break;t.push(w(e)),e.expect("INTERPOLATION_END"),n=!0}let o=t.shift();for(const e of t)o=(0,concatenate_1.createConcatenateNode)([o,e],e.line,e.column);return o},F=(e,t,r)=>{let n,o=e.next(),a="any";const{line:s,column:l}=o,{line:c,column:i}=r,u=[],d=()=>(0,array_1.createArrayNode)(u.map(e=>({value:e})),s,l);if("."===o.value){o=e.next();let r=nameRegExp.exec(o.value);if("NAME"!==o.type&&"NUMBER"!==o.type&&("OPERATOR"!==o.type||null===r))throw(0,parsing_1.createParsingError)("Expected name or number.",{line:s,column:l+1},e.source.resolvedName);if(n=(0,constant_1.createConstantNode)(o.value,s,l),e.test("PUNCTUATION","(")){a="method";const t=I(e);for(const{value:e}of(0,array_1.getKeyValuePairs)(t))u.push(e)}if(t.is("name")&&(e=>{let t;const r=t=>{const r=t.template;return r&&r.includes(e)?e:null};t=r(N[0])||null;let n=N.length;return!t&&n>1&&(t=r(N[n-1])||null),t})(t.attributes.name)){const e=n.attributes.value;return(0,method_call_1.createMethodCallNode)(t,e,d(),s,l)}}else{a="array";let r=!1;if(e.test("PUNCTUATION",":")?(r=!0,n=(0,constant_1.createConstantNode)(0,o.line,o.column)):n=w(e),e.nextIf("PUNCTUATION",":")&&(r=!0),r){let r;r=e.test("PUNCTUATION","]")?(0,constant_1.createConstantNode)(null,o.line,o.column):w(e);const a=b(e,"slice",o.line,o.column)(t,"slice",(0,array_1.createArrayNode)([{key:(0,constant_1.createConstantNode)(0,s,l),value:n},{key:(0,constant_1.createConstantNode)(1,s,l),value:r}],1,1),o.line,o.column);return e.expect("PUNCTUATION","]"),a}e.expect("PUNCTUATION","]")}return(0,attribute_accessor_1.createAttributeAccessorNode)(t,n,d(),a,c,i)},V=(e,t)=>{const{line:r,column:n}=e.current,o=(e=>{const{line:t,column:r}=e.current,{strict:n}=l;let o=e.expect("NAME").value,a=(0,get_test_1.getTest)(s,o);if(a||(e.test("NAME")?(o=o+" "+e.current.value,(a=(0,get_test_1.getTest)(s,o))?e.next():n||(e.next(),a={name:o,isDeprecated:!1,alternative:void 0,deprecatedVersion:void 0})):n||(a={name:o,isDeprecated:!1,alternative:void 0,deprecatedVersion:void 0})),a){if(a.isDeprecated){let r=`Test "${a.name}" is deprecated`;!0!==a.deprecatedVersion&&(r+=` since version ${a.deprecatedVersion}`),a.alternative&&(r+=`. Use "${a.alternative}" instead`),r+=` in "${e.source.name}" at line ${t}.`,console.warn(r)}return o}const c=(0,parsing_1.createParsingError)(`Unknown test "${o}".`,{line:t,column:r},e.source.resolvedName);throw c.addSuggestions(o,h),c})(e);let a=(0,array_1.createArrayNode)([],r,n);if(e.test("PUNCTUATION","(")&&(a=I(e,!0)),"defined"===o&&t.is("name")){const e=P(t.attributes.name);null!==e&&(t=(0,method_call_1.createMethodCallNode)(e.node,e.name,(0,array_1.createArrayNode)([],t.line,t.column),t.line,t.column))}return(0,test_1.createTestNode)(t,o,a,r,n)},L=()=>p[p.length-1],D=(e,t,n)=>{if(0===c.size)for(const e of r)c.set(e.tag,e.initialize(W));let o,{line:a,column:s}=e.current,l={},i=0;for(;!e.isEOF();)switch(e.current.type){case"TEXT":o=e.next(),l[i++]=(0,text_1.createTextNode)(o.value,o.line,o.column);break;case"VARIABLE_START":o=e.next();const r=w(e);e.expect("VARIABLE_END"),l[i++]=(0,print_1.createPrintNode)(r,o.line,o.column);break;case"TAG_START":if(e.next(),"NAME"!==(o=e.current).type)throw(0,parsing_1.createParsingError)("A block must start with a tag name.",o,e.source.resolvedName);if(null!==n&&n(o))return 1===Object.keys(l).length?l[0]:(0,node_1.createBaseNode)(null,{},l,a,s);if(!c.has(o.value)){let r;throw null!==n?(r=(0,parsing_1.createParsingError)(`Unexpected "${o.value}" tag`,o,e.source.resolvedName)).appendMessage(` (expecting closing tag for the "${t}" tag defined line ${a}).`):(r=(0,parsing_1.createParsingError)(`Unknown "${o.value}" tag.`,o,e.source.resolvedName)).addSuggestions(o.value,v),r}e.next();const u=c.get(o.value)(o,e);null!==u&&(l[i++]=u);break;case"COMMENT_START":o=e.next(),e.test("TEXT")&&(o=e.expect("TEXT")),e.expect("COMMENT_END"),l[i++]=(0,comment_1.createCommentNode)(o.value,o.line,o.column)}return 1===Object.keys(l).length?l[0]:(0,node_1.createBaseNode)(null,{},l,a,s)},W={addImportedSymbol:(e,t,r,n)=>{const o=N[0];"method"===e?o[e].set(t,{name:r,node:n}):o[e].push(t)},addTrait:e=>{(0,record_1.pushToRecord)(_,e)},embedTemplate:e=>{e.attributes.index=g++,f.push(e)},getBlock:e=>d[e]||null,getVarName:(e="__internal_")=>`${e}${i++}`,isMainScope:()=>1===N.length,parse:(e,t=null,r=null)=>{let s;A.push({stream:e,parent:u,blocks:d,blockStack:p,macros:m,importedSymbols:N,traits:_,embeddedTemplates:f}),u=null,d={},m={},_={},p=[],N=[{method:new Map,template:[]}],f=[];try{s=D(e,t,r),null!==u&&null===(s=y(e,s))&&(s=(0,node_1.createBaseNode)(null))}catch(t){throw t.source||(t.source=e.source.resolvedName),t}let l=(0,module_1.createModuleNode)((0,body_1.createBodyNode)(s,1,1),u,(0,node_1.createBaseNode)(null,{},d),(0,node_1.createBaseNode)(null,{},m),(0,node_1.createBaseNode)(null,{},_),f,e.source,1,1),c=(0,node_traverser_1.createNodeTraverser)(n);l=c(l),l=(c=(0,node_traverser_1.createNodeTraverser)([(0,core_1.createCoreNodeVisitor)(),(0,escaper_1.createEscaperNodeVisitor)(o,a),(0,macro_auto_import_1.createMacroAutoImportNodeVisitor)(),(0,sandbox_1.createSandboxNodeVisitor)()]))(l);const i=A.pop();return u=i.parent,d=i.blocks,m=i.macros,_=i.traits,p=i.blockStack,N=i.importedSymbols,f=i.embeddedTemplates,l},parseArguments:I,parseAssignmentExpression:e=>{const t={},{line:r,column:n}=e.current;for(;;){let r=e.current;e.test("OPERATOR")&&nameRegExp.exec(r.value)?e.next():e.expect("NAME",null,"Only variables can be assigned to");let n=r.value;if(["true","false","none","null"].indexOf(n.toLowerCase())>-1)throw(0,parsing_1.createParsingError)(`You cannot assign a value to "${n}".`,r,e.source.resolvedName);if((0,record_1.pushToRecord)(t,(0,assignment_1.createAssignmentNode)(n,r.line,r.column)),!e.nextIf("PUNCTUATION",","))break}return(0,arguments_1.createArgumentsNode)(t,r,n)},parseExpression:w,parseFilterExpressionRaw:q,parseFilterDefinitions:e=>{const t=[];for(;;){const r=e.expect("NAME"),{value:n,line:o,column:a}=r;let s;if(s=e.test("PUNCTUATION","(")?I(e,!0,!1,!0):(0,array_1.createArrayNode)([],o,a),t.unshift({name:n,arguments:s}),!e.test("PUNCTUATION","|"))break;e.next()}return t},parseMultiTargetExpression:e=>{const{line:t,column:r}=e.current,n={};for(;(0,record_1.pushToRecord)(n,w(e)),e.nextIf("PUNCTUATION",","););return(0,arguments_1.createArgumentsNode)(n,t,r)},peekBlockStack:L,popBlockStack:()=>{p.pop()},popLocalScope:()=>{N.shift()},pushBlockStack:e=>{p.push(e)},pushLocalScope:()=>{N.unshift({method:new Map,template:[]})},setBlock:(e,t)=>{d[e]=t},setMacro:(e,t)=>{m[e]=t},subparse:D,get parent(){return u},set parent(e){u=e}};return W};exports.createParser=createParser;

},{"./error/parsing":8,"./helpers/get-filter":91,"./helpers/get-function":93,"./helpers/get-test":94,"./helpers/is-made-of-whitespace-only":98,"./helpers/record":111,"./lexer":114,"./node":126,"./node-traverser":120,"./node-visitor/core":122,"./node-visitor/escaper":123,"./node-visitor/macro-auto-import":124,"./node-visitor/sandbox":125,"./node/body":130,"./node/comment":133,"./node/expression/arguments":137,"./node/expression/array":138,"./node/expression/arrow-function":139,"./node/expression/assignment":140,"./node/expression/attribute-accessor":141,"./node/expression/binary/concatenate":148,"./node/expression/block-function":168,"./node/expression/call/filter":170,"./node/expression/call/function":171,"./node/expression/call/test":172,"./node/expression/conditional":173,"./node/expression/constant":174,"./node/expression/hash":176,"./node/expression/method-call":177,"./node/expression/name":178,"./node/expression/parent-function":180,"./node/expression/unary/neg":182,"./node/expression/unary/not":183,"./node/expression/unary/pos":184,"./node/module":195,"./node/output/print":199,"./node/output/text":201,"twig-lexer":429}],210:[function(require,module,exports){
...
},{"path":383,"source-map":425}],218:[function(require,module,exports){
...
},{"../node/apply":127,"../node/expression/array":138,"../node/expression/constant":174}],220:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createAutoEscapeTagHandler=void 0;const parsing_1=require("../error/parsing"),auto_escape_1=require("../node/auto-escape"),createAutoEscapeTagHandler=()=>{const e="autoescape";return{tag:e,initialize:t=>(a,r)=>{const{line:s,column:o}=a;let n;if(r.test("TAG_END"))n=!0;else{const e=t.parseExpression(r);if(!e.is("constant")||"string"!=typeof e.attributes.value&&!1!==e.attributes.value){const{line:t,column:a}=e;throw(0,parsing_1.createParsingError)("An escaping strategy must be a string or false.",{line:t,column:a},r.source.resolvedName)}const{value:a}=e.attributes;n=!1===a?null:a}r.expect("TAG_END");let c=t.subparse(r,e,e=>e.test("NAME","endautoescape"));return r.next(),r.expect("TAG_END"),(0,auto_escape_1.createAutoEscapeNode)(n,c,s,o,e)}}};exports.createAutoEscapeTagHandler=createAutoEscapeTagHandler;

},{"../error/parsing":8,"../node/auto-escape":128}],221:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":126,"../node/block":129,"../node/output/block-reference":197,"../node/output/print":199}],222:[function(require,module,exports){
...
},{"../node/deprecated":134}],223:[function(require,module,exports){
...
},{"../node/do":135}],224:[function(require,module,exports){
...
},{"../node/include/embed":191,"./include":232,"twig-lexer":429}],225:[function(require,module,exports){
...
},{"../error/parsing":8}],226:[function(require,module,exports){
...
},{"../node/block":129,"../node/expression/block-function":168,"../node/expression/constant":174,"../node/output/print":199}],227:[function(require,module,exports){
...
},{"../node/flush":185}],228:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":126,"../node/expression/assignment":140,"../node/for":187}],229:[function(require,module,exports){
...
},{"../node/expression/assignment":140,"../node/import":189}],230:[function(require,module,exports){
...
},{"../node":126,"../node/if":188}],231:[function(require,module,exports){
...
},{"../node/expression/assignment":140,"../node/import":189}],232:[function(require,module,exports){
...
},{"../node/expression/array":138,"../node/include/include":192}],233:[function(require,module,exports){
...
},{"../node/line":193}],234:[function(require,module,exports){
...
},{"../error/parsing":8,"../node/body":130,"../node/expression/array":138,"../node/macro":194}],235:[function(require,module,exports){
...
},{"../error/parsing":8,"../helpers/is-made-of-whitespace-only":98,"../node":126,"../node/sandbox":203}],236:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":126,"../node/set":204}],237:[function(require,module,exports){
...
},{"../node/output/spaceless":200}],238:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":126,"../node/expression/arguments":137,"../node/expression/constant":174,"../node/trait":205}],239:[function(require,module,exports){
...
},{"../node/output/verbatim":202}],240:[function(require,module,exports){
...
},{"./error/parsing":8,"./lexer":114,"twig-lexer":429}],244:[function(require,module,exports){
...
},{"inherits":292,"safe-buffer":404,"stream":426,"string_decoder":427}],249:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"cipher-base":248,"inherits":292,"md5.js":377,"ripemd160":402,"sha.js":407}],252:[function(require,module,exports){
...
},{"inherits":292,"readable-stream":270,"safe-buffer":404}],256:[function(require,module,exports){
...
},{"./_stream_readable":259,"./_stream_writable":261,"_process":385,"inherits":292}],258:[function(require,module,exports){
...
},{"../errors":256,"./_stream_duplex":257,"./internal/streams/async_iterator":262,"./internal/streams/buffer_list":263,"./internal/streams/destroy":264,"./internal/streams/from":266,"./internal/streams/state":268,"./internal/streams/stream":269,"_process":385,"buffer":246,"events":254,"inherits":292,"string_decoder/":427,"util":245}],260:[function(require,module,exports){
...
},{"../errors":256,"./_stream_duplex":257,"./internal/streams/destroy":264,"./internal/streams/state":268,"./internal/streams/stream":269,"_process":385,"buffer":246,"inherits":292,"util-deprecate":437}],262:[function(require,module,exports){
(function (process){(function (){
...
},{"./end-of-stream":265,"_process":385}],263:[function(require,module,exports){
...
},{"_process":385}],265:[function(require,module,exports){
...
},{"safer-buffer":405}],273:[function(require,module,exports){
...
},{"safer-buffer":405,"string_decoder":427}],276:[function(require,module,exports){
...
},{"safer-buffer":405}],277:[function(require,module,exports){
...
},{"safer-buffer":405}],288:[function(require,module,exports){
...
},{"safer-buffer":405}],289:[function(require,module,exports){
...
},{"../encodings":274,"./bom-handling":289,"./extend-node":245,"./streams":245,"_process":385,"safer-buffer":405}],291:[function(require,module,exports){
...
},{"hash-base":255,"inherits":292,"safe-buffer":404}],378:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":379,"./vendor/camel-case-upper-regexp":380,"./vendor/non-word-regexp":381,"lower-case":375}],379:[function(require,module,exports){
...
},{"wcwidth":439}],383:[function(require,module,exports){
(function (process){(function (){
...
},{"./_stream_readable":389,"./_stream_writable":391,"core-util-is":250,"inherits":292,"process-nextick-args":384}],388:[function(require,module,exports){
...
},{"./_stream_transform":390,"core-util-is":250,"inherits":292}],389:[function(require,module,exports){
(function (process,global){(function (){
...
},{"./_stream_duplex":387,"./internal/streams/BufferList":392,"./internal/streams/destroy":393,"./internal/streams/stream":394,"_process":385,"core-util-is":250,"events":254,"inherits":292,"isarray":295,"process-nextick-args":384,"safe-buffer":395,"string_decoder/":396,"util":245}],390:[function(require,module,exports){
...
},{"./_stream_duplex":387,"core-util-is":250,"inherits":292}],391:[function(require,module,exports){
...
},{"./_stream_duplex":387,"./internal/streams/destroy":393,"./internal/streams/stream":394,"_process":385,"core-util-is":250,"inherits":292,"process-nextick-args":384,"safe-buffer":395,"timers":428,"util-deprecate":437}],392:[function(require,module,exports){
...
},{"safe-buffer":395,"util":245}],393:[function(require,module,exports){
...
},{"process-nextick-args":384}],394:[function(require,module,exports){
module.exports=require("events").EventEmitter;

},{"events":254}],395:[function(require,module,exports){
...
},{"buffer":246}],396:[function(require,module,exports){
...
},{"./readable":398}],398:[function(require,module,exports){
exports=module.exports=require("./lib/_stream_readable.js"),exports.Stream=exports,exports.Readable=exports,exports.Writable=require("./lib/_stream_writable.js"),exports.Duplex=require("./lib/_stream_duplex.js"),exports.Transform=require("./lib/_stream_transform.js"),exports.PassThrough=require("./lib/_stream_passthrough.js");

},{"./lib/_stream_duplex.js":387,"./lib/_stream_passthrough.js":388,"./lib/_stream_readable.js":389,"./lib/_stream_transform.js":390,"./lib/_stream_writable.js":391}],399:[function(require,module,exports){
module.exports=require("./readable").Transform;

},{"./readable":398}],400:[function(require,module,exports){
module.exports=require("./lib/_stream_writable.js");

},{"./lib/_stream_writable.js":391}],401:[function(require,module,exports){
...
},{"buffer":246,"hash-base":255,"inherits":292}],403:[function(require,module,exports){
...
},{"buffer":246}],405:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":385,"buffer":246}],406:[function(require,module,exports){
...
},{"safe-buffer":404}],407:[function(require,module,exports){
...
},{"./sha":408,"./sha1":409,"./sha224":410,"./sha256":411,"./sha384":412,"./sha512":413}],408:[function(require,module,exports){
...
},{"./hash":406,"inherits":292,"safe-buffer":404}],409:[function(require,module,exports){
...
},{"./hash":406,"inherits":292,"safe-buffer":404}],410:[function(require,module,exports){
...
},{"./hash":406,"./sha256":411,"inherits":292,"safe-buffer":404}],411:[function(require,module,exports){
...
},{"./hash":406,"inherits":292,"safe-buffer":404}],412:[function(require,module,exports){
...
},{"./hash":406,"./sha512":413,"inherits":292,"safe-buffer":404}],413:[function(require,module,exports){
...
},{"./hash":406,"inherits":292,"safe-buffer":404}],414:[function(require,module,exports){
var noCase=require("no-case");module.exports=function(e,n){return noCase(e,n,"_")};

},{"no-case":378}],415:[function(require,module,exports){
...
},{"./util":424}],416:[function(require,module,exports){
...
},{"./base64":417}],417:[function(require,module,exports){
...
},{"./util":424}],420:[function(require,module,exports){
...
},{"./array-set":415,"./base64-vlq":416,"./binary-search":418,"./quick-sort":420,"./util":424}],422:[function(require,module,exports){
...
},{"./array-set":415,"./base64-vlq":416,"./mapping-list":419,"./util":424}],423:[function(require,module,exports){
...
},{"./source-map-generator":422,"./util":424}],424:[function(require,module,exports){
...
},{"./lib/source-map-consumer":421,"./lib/source-map-generator":422,"./lib/source-node":423}],426:[function(require,module,exports){
...
},{"events":254,"inherits":292,"readable-stream/duplex.js":386,"readable-stream/passthrough.js":397,"readable-stream/readable.js":398,"readable-stream/transform.js":399,"readable-stream/writable.js":400}],427:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,isEncoding=Buffer.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function _normalizeEncoding(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function normalizeEncoding(t){var e=_normalizeEncoding(t);if("string"!=typeof e&&(Buffer.isEncoding===isEncoding||!isEncoding(t)))throw new Error("Unknown encoding: "+t);return e||t}function StringDecoder(t){var e;switch(this.encoding=normalizeEncoding(t),this.encoding){case"utf16le":this.text=utf16Text,this.end=utf16End,e=4;break;case"utf8":this.fillLast=utf8FillLast,e=4;break;case"base64":this.text=base64Text,this.end=base64End,e=3;break;default:return this.write=simpleWrite,void(this.end=simpleEnd)}this.lastNeed=0,this.lastTotal=0,this.lastChar=Buffer.allocUnsafe(e)}function utf8CheckByte(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function utf8CheckIncomplete(t,e,s){var i=e.length-1;if(i<s)return 0;var n=utf8CheckByte(e[i]);return n>=0?(n>0&&(t.lastNeed=n-1),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(t.lastNeed=n-2),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(2===n?n=0:t.lastNeed=n-3),n):0}function utf8CheckExtraBytes(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function utf8FillLast(t){var e=this.lastTotal-this.lastNeed,s=utf8CheckExtraBytes(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function utf8Text(t,e){var s=utf8CheckIncomplete(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function utf8End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function utf16Text(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function utf16End(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function base64Text(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function base64End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function simpleWrite(t){return t.toString(this.encoding)}function simpleEnd(t){return t&&t.length?this.write(t):""}exports.StringDecoder=StringDecoder,StringDecoder.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},StringDecoder.prototype.end=utf8End,StringDecoder.prototype.text=utf8Text,StringDecoder.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};

},{"safe-buffer":404}],428:[function(require,module,exports){
...
},{"process/browser.js":385,"timers":428}],429:[function(require,module,exports){
...
},{"./lib/Lexer":430,"./lib/SyntaxError":431,"./lib/Token":432,"./lib/TokenStream":433,"./lib/TokenType":434}],430:[function(require,module,exports){
...
},{"./SyntaxError":431,"./Token":432}],431:[function(require,module,exports){
...
},{"./Token":432}],434:[function(require,module,exports){
...
},{"buffer":246,"lodash":374}],436:[function(require,module,exports){
"use strict";module.exports=require("./lib/utf8-binary-cutter");

},{"./lib/utf8-binary-cutter":435}],437:[function(require,module,exports){
(function (global){(function (){
...
},{"./combining":438,"defaults":252}]},{},[1])(1)
});
