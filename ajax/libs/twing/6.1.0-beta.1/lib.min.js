...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEnvironment=void 0;const extension_set_1=require("./extension-set"),parser_1=require("./parser"),html_1=require("./escaping-stragegy/html"),css_1=require("./escaping-stragegy/css"),js_1=require("./escaping-stragegy/js"),url_1=require("./escaping-stragegy/url"),html_attribute_1=require("./escaping-stragegy/html-attribute"),token_stream_1=require("./token-stream"),source_map_runtime_1=require("./source-map-runtime"),security_policy_1=require("./sandbox/security-policy"),template_1=require("./template"),luxon_1=require("luxon"),events_1=require("events"),loader_1=require("./error/loader"),lexer_1=require("./lexer"),core_1=require("./extension/core"),lib_1=require("../lib"),createEnvironment=(e,t)=>{const r={css:(0,css_1.createCssEscapingStrategyHandler)(),html:(0,html_1.createHtmlEscapingStrategyHandler)(),html_attr:(0,html_attribute_1.createHtmlAttributeEscapingStrategyHandler)(),js:(0,js_1.createJsEscapingStrategyHandler)(),url:(0,url_1.createUrlEscapingStrategyHandler)()},a=(0,extension_set_1.createExtensionSet)();a.addExtension((0,core_1.createCoreExtension)());const n=(null==t?void 0:t.autoReload)||!1,s=(null==t?void 0:t.cache)||null,o=(null==t?void 0:t.charset)||"UTF-8",i=(null==t?void 0:t.dateFormat)||"F j, Y H:i",l=(null==t?void 0:t.dateIntervalFormat)||"%d days",u=(null==t?void 0:t.numberFormat)||{decimalPoint:".",numberOfDecimals:0,thousandSeparator:","},c=new events_1.EventEmitter,d=(null==t?void 0:t.sandboxPolicy)||(0,security_policy_1.createSandboxSecurityPolicy)();let p,m,g=!(null==t||!t.sandboxed);const _=new Map,y={get charset(){return o},get dateFormat(){return i},get dateIntervalFormat(){return l},get escapingStrategyHandlers(){return r},get filters(){return a.filters},get functions(){return a.functions},get isStrictVariables(){return!(null==t||!t.strictVariables)},get loader(){return e},get numberFormat(){return u},get sandboxPolicy(){return d},get tests(){return a.tests},get timezone(){return(null==t?void 0:t.timezone)||luxon_1.Settings.defaultZoneName},addExtension:a.addExtension,addFilter:a.addFilter,addFunction:a.addFunction,addNodeVisitor:a.addNodeVisitor,addOperator:a.addOperator,addTagHandler:a.addTagHandler,addTest:a.addTest,loadTemplate:async(t,r=null)=>{c.emit("load",t,r);let a=await e.resolve(t,r)||t,o=_.get(a);if(o)return Promise.resolve(o);{const o=s?await s.getTimestamp(a):0,i=async()=>{if(null===s)return Promise.resolve(null);let a;if(n){a=await e.isFresh(t,o,r)?await s.load(t):null}else a=await s.load(t);return a},l=async()=>{const a=await e.getSource(t,r);if(null===a)return null;const n=y.parse(y.tokenize(a));return null!==s&&await s.write(t,n),n};let u=await i();if(null===u&&(u=await l()),null===u)throw(0,loader_1.createTemplateLoadingError)([t]);const c=(0,template_1.createTemplate)(y,u);return _.set(a,c),c}},on:(e,t)=>{c.on(e,t)},registerEscapingStrategy:(e,t)=>{r[t]=e},parse:(e,r)=>{if(!m){const e=a.nodeVisitors;if(null==t?void 0:t.autoEscapingStrategy){const r=t.autoEscapingStrategy;e.unshift({enterNode:e=>e,leaveNode:e=>("template"===e.type&&(e.children.body=(0,lib_1.createAutoEscapeNode)(r,e.children.body,e.line,e.column)),e)})}m=(0,parser_1.createParser)(a.unaryOperators,a.binaryOperators,a.tagHandlers,a.nodeVisitors,a.filters,a.functions,a.tests,r||(null==t?void 0:t.parserOptions)||{strict:!0,level:3})}try{return m.parse(e)}catch(t){const r=e.source;throw t.source||(t.source=r.name),t}},render:(e,t)=>y.loadTemplate(e).then(e=>e.render(t,{sandboxed:g})),renderWithSourceMap:(e,t)=>{const r=(0,source_map_runtime_1.createSourceMapRuntime)();return y.loadTemplate(e).then(e=>e.render(t,{sandboxed:g,sourceMapRuntime:r})).then(e=>{const{sourceMap:t}=r;return{data:e,sourceMap:t}})},tokenize:e=>{var r;const n=(null===(r=null==t?void 0:t.parserOptions)||void 0===r?void 0:r.level)||3;p||(p=(0,lexer_1.createLexer)(n,a.binaryOperators,a.unaryOperators));const s=p.tokenizeSource(e);return(0,token_stream_1.createTokenStream)(s.toAst(),s.source)}};return y};exports.createEnvironment=createEnvironment;

},{"../lib":1,"./error/loader":7,"./escaping-stragegy/css":10,"./escaping-stragegy/html":12,"./escaping-stragegy/html-attribute":11,"./escaping-stragegy/js":13,"./escaping-stragegy/url":14,"./extension-set":15,"./extension/core":16,"./lexer":116,"./parser":250,"./sandbox/security-policy":257,"./source-map-runtime":258,"./template":282,"./token-stream":284,"events":294,"luxon":398}],5:[function(require,module,exports){
...
},{"./error/loader":7,"./error/parsing":8,"./error/runtime":9,"./sandbox/security-error":251}],6:[function(require,module,exports){
...
},{"./base":6,"levenshtein":321}],9:[function(require,module,exports){
...
},{"locutus/php/strings/bin2hex":380,"locutus/php/strings/ltrim":382,"utf8-binary-cutter":455}],11:[function(require,module,exports){
...
},{"locutus/php/strings/ord":385}],12:[function(require,module,exports){
...
},{"htmlspecialchars":296}],13:[function(require,module,exports){
...
},{"locutus/php/strings/bin2hex":380,"locutus/php/strings/sprintf":387,"utf8-binary-cutter":455}],14:[function(require,module,exports){
...
},{"locutus/php/url/rawurlencode":394}],15:[function(require,module,exports){
...
},{"../filter":73,"../function":74,"../node/expression/binary/add":183,"../node/expression/binary/and":184,"../node/expression/binary/bitwise-and":185,"../node/expression/binary/bitwise-or":186,"../node/expression/binary/bitwise-xor":187,"../node/expression/binary/concatenate":188,"../node/expression/binary/divide":190,"../node/expression/binary/divide-and-floor":189,"../node/expression/binary/ends-with":191,"../node/expression/binary/has-every":192,"../node/expression/binary/has-some":193,"../node/expression/binary/is-equal-to":194,"../node/expression/binary/is-greater-than":196,"../node/expression/binary/is-greater-than-or-equal-to":195,"../node/expression/binary/is-in":197,"../node/expression/binary/is-less-than":199,"../node/expression/binary/is-less-than-or-equal-to":198,"../node/expression/binary/is-not-equal-to":200,"../node/expression/binary/is-not-in":201,"../node/expression/binary/matches":202,"../node/expression/binary/modulo":203,"../node/expression/binary/multiply":204,"../node/expression/binary/or":205,"../node/expression/binary/power":206,"../node/expression/binary/range":207,"../node/expression/binary/spaceship":208,"../node/expression/binary/starts-with":209,"../node/expression/binary/subtract":210,"../node/expression/nullish-coalescing":222,"../node/expression/unary/negative":226,"../node/expression/unary/not":227,"../node/expression/unary/positive":228,"../operator":248,"../test":283,"./core/filters/abs":17,"./core/filters/batch":18,"./core/filters/capitalize":19,"./core/filters/column":20,"./core/filters/convert-encoding":21,"./core/filters/date":23,"./core/filters/date-modify":22,"./core/filters/default":24,"./core/filters/escape":25,"./core/filters/filter":26,"./core/filters/first":27,"./core/filters/format":28,"./core/filters/join":29,"./core/filters/json-encode":30,"./core/filters/keys":31,"./core/filters/last":32,"./core/filters/length":33,"./core/filters/lower":34,"./core/filters/map":35,"./core/filters/merge":36,"./core/filters/nl2br":37,"./core/filters/number_format":38,"./core/filters/raw":39,"./core/filters/reduce":40,"./core/filters/replace":41,"./core/filters/reverse":42,"./core/filters/round":43,"./core/filters/slice":44,"./core/filters/sort":45,"./core/filters/spaceless":46,"./core/filters/split":47,"./core/filters/striptags":48,"./core/filters/title":49,"./core/filters/trim":50,"./core/filters/upper":51,"./core/filters/url_encode":52,"./core/functions/constant":53,"./core/functions/cycle":54,"./core/functions/date":55,"./core/functions/dump":56,"./core/functions/include":57,"./core/functions/max":58,"./core/functions/min":59,"./core/functions/random":60,"./core/functions/range":61,"./core/functions/source":62,"./core/functions/template-from-string":63,"./core/tests/is-constant":64,"./core/tests/is-defined":65,"./core/tests/is-divisible-by":66,"./core/tests/is-empty":67,"./core/tests/is-even":68,"./core/tests/is-iterable":69,"./core/tests/is-null":70,"./core/tests/is-odd":71,"./core/tests/is-same-as":72}],17:[function(require,module,exports){
...
},{"capitalize":288}],20:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/is-plain-object":100,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-map":105}],21:[function(require,module,exports){
...
},{"../../../helpers/iconv":97,"buffer":287}],22:[function(require,module,exports){
...
},{"../../../helpers/format-date-time":86,"../../../helpers/format-duration":87,"../functions/date":55,"luxon":398}],24:[function(require,module,exports){
...
},{"../../../markup":120}],26:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":105}],27:[function(require,module,exports){
...
},{"locutus/php/strings/sprintf":387}],29:[function(require,module,exports){
...
},{"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-array":103}],30:[function(require,module,exports){
...
},{"../../../helpers/is-plain-object":100,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-array":103,"../../../helpers/iterator-to-hash":104,"../../../helpers/iterator-to-map":105}],31:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":105}],32:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":105}],36:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-map":105,"../../../helpers/merge-iterables":107}],37:[function(require,module,exports){
...
},{"../../../markup":120,"locutus/php/strings/nl2br":383}],38:[function(require,module,exports){
...
},{"locutus/php/strings/number_format":384}],39:[function(require,module,exports){
...
},{"../../../markup":120}],40:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":105}],41:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-hash":104,"locutus/php/strings/strtr":390}],42:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-map":105,"../../../helpers/reverse":112,"esrever":293}],43:[function(require,module,exports){
...
},{"../../../error/runtime":9,"locutus/php/math/ceil":343,"locutus/php/math/floor":352,"locutus/php/math/round":374}],44:[function(require,module,exports){
...
},{"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-map":105,"../../../helpers/slice-map":113}],45:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/asort":75,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-map":105}],46:[function(require,module,exports){
...
},{"../../../markup":120}],47:[function(require,module,exports){
...
},{"locutus/php/strings/explode":381}],48:[function(require,module,exports){
...
},{"locutus/php/strings/strip_tags":388}],49:[function(require,module,exports){
...
},{"locutus/php/strings/ucwords":392}],50:[function(require,module,exports){
...
},{"../../../error/runtime":9,"locutus/php/strings/ltrim":382,"locutus/php/strings/rtrim":386,"locutus/php/strings/trim":391}],51:[function(require,module,exports){
...
},{"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-hash":104,"locutus/php/url/http_build_query":393}],53:[function(require,module,exports){
...
},{"../../../helpers/map-like":106}],55:[function(require,module,exports){
...
},{"../../../error/runtime":9,"../../../helpers/modify-date":108,"luxon":398}],56:[function(require,module,exports){
...
},{"../../../helpers/iterate":102,"../../../helpers/php":110,"../../../markup":120}],57:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.include=void 0;const iterator_to_map_1=require("../../../helpers/iterator-to-map"),merge_iterables_1=require("../../../helpers/merge-iterables"),is_traversable_1=require("../../../helpers/is-traversable"),runtime_1=require("../../../error/runtime"),is_plain_object_1=require("../../../helpers/is-plain-object"),context_1=require("../../../context"),markup_1=require("../../../markup"),include=(e,r,t,i,a,o)=>{const{template:s,charset:u,context:n,nodeExecutor:l,outputBuffer:c,sourceMapRuntime:_}=e,p=s.name;if(!(0,is_plain_object_1.isPlainObject)(t)&&!(0,is_traversable_1.isTraversable)(t)){const e=null==t;return Promise.reject((0,runtime_1.createRuntimeError)(`Variables passed to the "include" function or tag must be iterable, got "${e?t:typeof t}".`,void 0,p))}t=(0,iterator_to_map_1.iteratorToMap)(t),i&&(t=(0,merge_iterables_1.mergeIterables)(n,t)),Array.isArray(r)||(r=[r]);return(e=>s.resolveTemplate(e).catch(e=>{if(a)return null;throw e}))(r).then(e=>(c.start(),e?e.render((0,context_1.createContext)(t),{nodeExecutor:l,outputBuffer:c,sandboxed:o,sourceMapRuntime:_||void 0}):Promise.resolve(""))).then(()=>{const e=c.getAndClean();return(0,markup_1.createMarkup)(e,u)})};exports.include=include;

},{"../../../context":3,"../../../error/runtime":9,"../../../helpers/is-plain-object":100,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-map":105,"../../../helpers/merge-iterables":107,"../../../markup":120}],58:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-array":103,"locutus/php/math":357}],59:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-array":103,"locutus/php/math":357}],60:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"../../../error/runtime":9,"../../../helpers/iconv":97,"../../../helpers/is-traversable":101,"../../../helpers/iterator-to-array":103,"buffer":287,"locutus/php/array/array_rand":327,"locutus/php/math/mt_rand":368,"runes":409}],61:[function(require,module,exports){
...
},{"../../../helpers/iterator-to-array":103,"is-plain-object":319}],68:[function(require,module,exports){
...
},{"./sort":114}],76:[function(require,module,exports){
...
},{"./iterate":102}],77:[function(require,module,exports){
...
},{"../../../../node_modules/is-buffer/index.js":318,"../markup":120,"./iterator-to-map":105,"./map-like":106,"luxon":398}],79:[function(require,module,exports){
...
},{"./iterator-to-map":105,"locutus/php/array/range":329}],82:[function(require,module,exports){
...
},{"./is-plain-object":100,"./is-traversable":101}],83:[function(require,module,exports){
...
},{"./map-like":106}],84:[function(require,module,exports){
...
},{"pad":404}],88:[function(require,module,exports){
...
},{"../error/runtime":9,"./examine-object":84,"./get":96,"./is-plain-object":100,"./map-like":106,"./php":110,"isobject":320}],89:[function(require,module,exports){
...
},{"locutus/php/array/array_chunk":325}],95:[function(require,module,exports){
...
},{"./iterator-to-map":105,"./map-like":106}],97:[function(require,module,exports){
...
},{"iconv-lite":315}],98:[function(require,module,exports){
...
},{"../markup":120,"./compare":78,"./is-traversable":101,"./iterator-to-array":103,"./map-like":106}],99:[function(require,module,exports){
...
},{"is-plain-object":319}],101:[function(require,module,exports){
...
},{"./iterator-to-map":105}],107:[function(require,module,exports){
...
},{"luxon":398}],109:[function(require,module,exports){
...
},{"regex-parser":407}],110:[function(require,module,exports){
...
},{"./count":80,"./is-traversable":101,"./iterator-to-hash":104}],111:[function(require,module,exports){
...
},{"../error":5,"../error/runtime":9}],116:[function(require,module,exports){
...
},{"./error/parsing":8,"./token-stream":284,"twig-lexer":448}],117:[function(require,module,exports){
...
},{"../source":259}],118:[function(require,module,exports){
...
},{"../source":259,"locutus/php/strings/rtrim":386,"path":405}],120:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"../helpers/get-key-value-pairs":94,"../node/expression/call/filter":213,"../node/expression/constant":217}],123:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeBlockReferenceNode=void 0;const traceable_method_1=require("../helpers/traceable-method"),executeBlockReferenceNode=(e,t)=>{const{template:o,context:c,outputBuffer:r,blocks:n,nodeExecutor:l,sandboxed:u,sourceMapRuntime:a}=t,{name:d}=e.attributes;return(0,traceable_method_1.getTraceableMethod)(o.renderBlock,e.line,e.column,o.name)(d,c.clone(),r,n,!0,u,l,a).then(r.echo)};exports.executeBlockReferenceNode=executeBlockReferenceNode;

},{"../helpers/traceable-method":115}],125:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeCheckSecurityNode=void 0;const security_not_allowed_filter_error_1=require("../sandbox/security-not-allowed-filter-error"),security_not_allowed_tag_error_1=require("../sandbox/security-not-allowed-tag-error"),executeCheckSecurityNode=(e,r)=>{const{template:t,sandboxed:o}=r,{usedTags:c,usedFunctions:i,usedFilters:s}=e.attributes;try{o&&t.checkSecurity([...c.keys()],[...s.keys()],[...i.keys()])}catch(e){throw(e=>{e.source=t.name,(0,security_not_allowed_tag_error_1.isASandboxSecurityNotAllowedTagError)(e)?e.location=c.get(e.tagName):(0,security_not_allowed_filter_error_1.isASandboxSecurityNotAllowedFilterError)(e)?e.location=s.get(e.filterName):e.location=i.get(e.functionName)})(e),e}return Promise.resolve()};exports.executeCheckSecurityNode=executeCheckSecurityNode;

},{"../sandbox/security-not-allowed-filter-error":252,"../sandbox/security-not-allowed-tag-error":256}],126:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeCheckToStringNode=void 0;const traceable_method_1=require("../helpers/traceable-method"),executeCheckToStringNode=(e,t)=>{const{template:r,nodeExecutor:o,sandboxed:c}=t,{value:n}=e.children;return o(n,t).then(e=>{if(c){return(0,traceable_method_1.getTraceableMethod)(e=>{if(null!==e&&"object"==typeof e)try{r.checkMethodAllowed(e,"toString")}catch(e){return Promise.reject(e)}return Promise.resolve(e)},n.line,n.column,r.name)(e)}return e})};exports.executeCheckToStringNode=executeCheckToStringNode;

},{"../helpers/traceable-method":115}],127:[function(require,module,exports){
...
},{"../../helpers/get-key-value-pairs":94}],132:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeAttributeAccessorNode=void 0;const traceable_method_1=require("../../helpers/traceable-method"),get_attribute_1=require("../../helpers/get-attribute"),executeAttributeAccessorNode=(e,t)=>{const{template:r,sandboxed:o,isStrictVariables:s,nodeExecutor:c}=t,{target:u,attribute:i,arguments:a}=e.children,{type:l,shouldIgnoreStrictCheck:b,shouldTestExistence:d}=e.attributes;return Promise.all([c(u,t),c(i,t),c(a,t)]).then(([t,c,u])=>{return(0,traceable_method_1.getTraceableMethod)(get_attribute_1.getAttribute,e.line,e.column,r.name)(r,t,c,u,l,d,b||null,o,s)})};exports.executeAttributeAccessorNode=executeAttributeAccessorNode;

},{"../../helpers/get-attribute":88,"../../helpers/traceable-method":115}],135:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeBinaryNode=void 0;const compare_1=require("../../helpers/compare"),concatenate_1=require("../../helpers/concatenate"),map_like_1=require("../../helpers/map-like"),is_in_1=require("../../helpers/is-in"),parse_regular_expression_1=require("../../helpers/parse-regular-expression"),create_range_1=require("../../helpers/create-range"),runtime_1=require("../../error/runtime"),executeBinaryNode=async(e,a)=>{const{left:t,right:r}=e.children,{nodeExecutor:i}=a;switch(e.type){case"add":return await i(t,a)+await i(r,a);case"and":return!(!await i(t,a)||!await i(r,a));case"bitwise_and":return await i(t,a)&await i(r,a);case"bitwise_or":return await i(t,a)|await i(r,a);case"bitwise_xor":return await i(t,a)^await i(r,a);case"concatenate":{const e=await i(t,a),s=await i(r,a);return(0,concatenate_1.concatenate)(e,s)}case"divide":return await i(t,a)/await i(r,a);case"divide_and_floor":return Math.floor(await i(t,a)/await i(r,a));case"ends_with":{const e=await i(t,a);if("string"!=typeof e)return!1;const s=await i(r,a);return"string"==typeof s&&(s.length<1||e.endsWith(s))}case"has_every":{const e=await i(t,a),s=await i(r,a);return"function"!=typeof s?Promise.resolve(!0):(0,map_like_1.isAMapLike)(e)||Array.isArray(e)?(0,map_like_1.every)(e,s):Promise.resolve(!0)}case"has_some":{const e=await i(t,a),s=await i(r,a);return"function"!=typeof s?Promise.resolve(!1):(0,map_like_1.isAMapLike)(e)||Array.isArray(e)?(0,map_like_1.some)(e,s):Promise.resolve(!1)}case"is_equal_to":{const e=await i(t,a),s=await i(r,a);return(0,compare_1.compare)(e,s)}case"is_greater_than":return await i(t,a)>await i(r,a);case"is_greater_than_or_equal_to":return await i(t,a)>=await i(r,a);case"is_in":return(0,is_in_1.isIn)(await i(t,a),await i(r,a));case"is_less_than":return await i(t,a)<await i(r,a);case"is_less_than_or_equal_to":return await i(t,a)<=await i(r,a);case"is_not_equal_to":return Promise.resolve(!(0,compare_1.compare)(await i(t,a),await i(r,a)));case"is_not_in":return Promise.resolve(!(0,is_in_1.isIn)(await i(t,a),await i(r,a)));case"matches":return(0,parse_regular_expression_1.parseRegularExpression)(await i(r,a)).test(await i(t,a));case"modulo":return await i(t,a)%await i(r,a);case"multiply":return await i(t,a)*await i(r,a);case"or":return!(!await i(t,a)&&!await i(r,a));case"power":return Math.pow(await i(t,a),await i(r,a));case"range":{const e=await i(t,a),s=await i(r,a);return(0,create_range_1.createRange)(e,s,1)}case"spaceship":{const e=await i(t,a),s=await i(r,a);return(0,compare_1.compare)(e,s)?0:e<s?-1:1}case"starts_with":{const e=await i(t,a);if("string"!=typeof e)return!1;const s=await i(r,a);return"string"==typeof s&&(s.length<1||e.startsWith(s))}case"subtract":return await i(t,a)-await i(r,a)}return Promise.reject((0,runtime_1.createRuntimeError)(`Unrecognized binary node of type "${e.type}"`,e))};exports.executeBinaryNode=executeBinaryNode;

},{"../../error/runtime":9,"../../helpers/compare":78,"../../helpers/concatenate":79,"../../helpers/create-range":81,"../../helpers/is-in":98,"../../helpers/map-like":106,"../../helpers/parse-regular-expression":109}],136:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeBlockFunction=void 0;const traceable_method_1=require("../../helpers/traceable-method"),executeBlockFunction=async(e,t)=>{const{template:o,context:c,nodeExecutor:n,outputBuffer:l,blocks:a,sandboxed:r,sourceMapRuntime:u}=t,{template:s,name:i}=e.children,d=await n(i,t);let m;if(s){const e=await n(s,t);m=(0,traceable_method_1.getTraceableMethod)(o.loadTemplate,s.line,s.column,o.name)(e)}else m=Promise.resolve(o);return m.then(t=>{if(e.attributes.shouldTestExistence){return(0,traceable_method_1.getTraceableMethod)(t.hasBlock,e.line,e.column,o.name)(d,c.clone(),l,a,r,n)}{const i=(0,traceable_method_1.getTraceableMethod)(t.renderBlock,e.line,e.column,o.name);return s?i(d,c.clone(),l,new Map,!1,r,n,u):i(d,c.clone(),l,a,!0,r,n,u)}})};exports.executeBlockFunction=executeBlockFunction;

},{"../../helpers/traceable-method":115}],137:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeCallNode=void 0;const runtime_1=require("../../error/runtime"),traceable_method_1=require("../../helpers/traceable-method"),constant_1=require("../../node/expression/constant"),get_key_value_pairs_1=require("../../helpers/get-key-value-pairs"),array_merge=require("locutus/php/array/array_merge"),snakeCase=require("snake-case"),normalizeName=e=>snakeCase(e).toLowerCase(),getArguments=(e,t,r,a)=>{const n=e.type,o=e.attributes.operatorName,s=new Map;let u=!1;const i=(0,get_key_value_pairs_1.getKeyValuePairs)(t);for(let{key:t,value:r}of i){let a=t.attributes.value;if("string"==typeof a)u=!0,a=normalizeName(a);else if(u)throw(0,runtime_1.createRuntimeError)(`Positional arguments cannot be used after named arguments for ${n} "${o}".`,e);s.set(a,{key:t,value:r})}const l=r,c=[];let m=[],p=[],f=0;for(const t of l){const r=""+normalizeName(t.name);c.push(r);const a=s.get(r);if(a){if(s.has(f))throw(0,runtime_1.createRuntimeError)(`Argument "${r}" is defined twice for ${n} "${o}".`,e);(p=array_merge(p,m)).push(a.value),s.delete(r),m=[]}else{const a=s.get(f);if(a)(p=array_merge(p,m)).push(a.value),s.delete(f),m=[],++f;else{if(void 0===t.defaultValue)throw(0,runtime_1.createRuntimeError)(`Value for argument "${r}" is required for ${n} "${o}".`,e);p.push((0,constant_1.createConstantNode)(t.defaultValue,e.line,e.column))}}}if(a){const e=[],t=[];for(const[r,a]of s)t.push(a.value),e.push(r);for(const t of e)s.delete(t);t.length&&(p=array_merge(p,m)).push(...t)}if(s.size>0){const e=[...s.values()][0];throw(0,runtime_1.createRuntimeError)(`Unknown argument${s.size>1?"s":""} "${[...s.keys()].join('", "')}" for ${n} "${o}(${c.join(", ")})".`,e.key)}return p},executeCallNode=async(e,t)=>{const{type:r}=e,{template:a,nodeExecutor:n}=t,{operatorName:o}=e.attributes;let s;switch(r){case"filter":s=a.getFilter(o);break;case"function":s=a.getFunction(o);break;default:s=a.getTest(o)}if(null===s)throw(0,runtime_1.createRuntimeError)(`Unknown ${r} "${o}".`,e);const{operand:u,arguments:i}=e.children,l=getArguments(e,i,s.acceptedArguments,s.isVariadic),c=[];c.push(...s.nativeArguments),u&&c.push(await n(u,t));const m=await Promise.all([...l.map(e=>n(e,t))]);return c.push(...m),(0,traceable_method_1.getTraceableMethod)(s.callable,e.line,e.column,a.name)(t,...c).then(e=>e)};exports.executeCallNode=executeCallNode;

},{"../../error/runtime":9,"../../helpers/get-key-value-pairs":94,"../../helpers/traceable-method":115,"../../node/expression/constant":217,"locutus/php/array/array_merge":326,"snake-case":420}],138:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeEscapeNode=void 0;const traceable_method_1=require("../../helpers/traceable-method"),executeEscapeNode=(e,t)=>{const{template:r,nodeExecutor:c}=t,{strategy:o}=e.attributes,{body:a}=e.children;return c(a,t).then(t=>{return(0,traceable_method_1.getTraceableMethod)(r.escape,e.line,e.column,r.name)(t,o,null,!0)})};exports.executeEscapeNode=executeEscapeNode;

},{"../../helpers/traceable-method":115}],140:[function(require,module,exports){
...
},{"../../helpers/get-key-value-pairs":94}],141:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeMethodCall=void 0;const runtime_1=require("../../error/runtime"),get_key_value_pairs_1=require("../../helpers/get-key-value-pairs"),executeMethodCall=async(e,t)=>{const{template:r,context:a,outputBuffer:n,aliases:o,nodeExecutor:s,sandboxed:u,sourceMapRuntime:i}=t,{methodName:l,shouldTestExistence:c}=e.attributes,{operand:d,arguments:m}=e.children;if(c)return o.get(d.attributes.name).hasMacro(l);{const c=(0,get_key_value_pairs_1.getKeyValuePairs)(m),p=[];for(const{value:e}of c){const r=await s(e,t);p.push(r)}const h=o.get(d.attributes.name),_=e=>{const t=e.macroHandlers.get(l);return t?Promise.resolve(t):e.getParent(a,n,u,s).then(e=>e?_(e):null)};return _(h).then(t=>{if(t)return t(n,u,i,s,...p);throw(0,runtime_1.createRuntimeError)(`Macro "${l}" is not defined in template "${h.name}".`,e,r.name)})}};exports.executeMethodCall=executeMethodCall;

},{"../../error/runtime":9,"../../helpers/get-key-value-pairs":94}],142:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeNameNode=void 0;const traceable_method_1=require("../../helpers/traceable-method"),get_context_value_1=require("../../helpers/get-context-value"),executeNameNode=(e,{template:t,context:a,charset:o,isStrictVariables:r})=>{const{name:c,isAlwaysDefined:s,shouldIgnoreStrictCheck:l,shouldTestExistence:u}=e.attributes;return(0,traceable_method_1.getTraceableMethod)(get_context_value_1.getContextValue,e.line,e.column,t.name)(o,t.name,r,a,c,s,l,u)};exports.executeNameNode=executeNameNode;

},{"../../helpers/get-context-value":90,"../../helpers/traceable-method":115}],143:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeParentFunction=void 0;const traceable_method_1=require("../../helpers/traceable-method"),executeParentFunction=(e,t)=>{const{template:n,context:r,nodeExecutor:o,outputBuffer:c,sandboxed:u,sourceMapRuntime:a}=t,{name:s}=e.attributes;return(0,traceable_method_1.getTraceableMethod)(n.renderParentBlock,e.line,e.column,n.name)(s,r,c,u,o,a)};exports.executeParentFunction=executeParentFunction;

},{"../../helpers/traceable-method":115}],144:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeUnaryNode=void 0;const runtime_1=require("../../error/runtime"),executeUnaryNode=(e,r)=>{const{operand:t}=e.children,{nodeExecutor:n}=r;switch(e.type){case"negative":return n(t,r).then(e=>-e);case"not":return n(t,r).then(e=>!e);case"positive":return n(t,r).then(e=>+e)}return Promise.reject((0,runtime_1.createRuntimeError)(`Unrecognized unary node of type "${e.type}"`,e))};exports.executeUnaryNode=executeUnaryNode;

},{"../../error/runtime":9}],146:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeForNode=void 0;const ensure_traversable_1=require("../helpers/ensure-traversable"),count_1=require("../helpers/count"),iterate_1=require("../helpers/iterate"),executeForNode=async(e,t)=>{const{context:r,nodeExecutor:s}=t,{sequence:a,body:o,else:n,valueTarget:i,keyTarget:l}=e.children,{hasAnIf:c}=e.attributes;r.set("_parent",r.clone());const u=await s(a,t);let d=(0,ensure_traversable_1.ensureTraversable)(u);if(d===r?r.set("_seq",r.clone()):r.set("_seq",d),n&&r.set("_iterated",!1),r.set("loop",new Map([["parent",r.get("_parent")],["index0",0],["index",1],["first",!0]])),!c){const e=(0,count_1.count)(r.get("_seq")),t=r.get("loop");t.set("revindex0",e-1),t.set("revindex",e),t.set("length",e),t.set("last",1===e)}const _=await s(l,t),p=await s(i,t);await(0,iterate_1.iterate)(r.get("_seq"),async(e,a)=>{r.set(_,e),r.set(p,a),await s(o,t)}),n&&!1===r.get("_iterated")&&await s(n,t);const x=r.get("_parent");r.delete("_seq"),r.delete("_iterated"),r.delete(l.attributes.name),r.delete(i.attributes.name),r.delete("_parent"),r.delete("loop");for(const[e,t]of x)r.has(e)||r.set(e,t)};exports.executeForNode=executeForNode;

},{"../helpers/count":80,"../helpers/ensure-traversable":82,"../helpers/iterate":102}],149:[function(require,module,exports){
...
},{"../helpers/evaluate":83,"../node":167}],150:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeImportNode=void 0;const traceable_method_1=require("../helpers/traceable-method"),executeImportNode=async(e,t)=>{const{template:a,aliases:o,nodeExecutor:s}=t,{alias:r,templateName:l}=e.children,{global:c}=e.attributes;let m;if("name"===l.type&&"_self"===l.attributes.name)m=a;else{const o=await s(l,t),r=(0,traceable_method_1.getTraceableMethod)(a.loadTemplate,e.line,e.column,a.name);m=await r(o)}o.set(r.attributes.name,m),c&&a.aliases.set(r.attributes.name,m)};exports.executeImportNode=executeImportNode;

},{"../helpers/traceable-method":115}],151:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeBaseIncludeNode=void 0;const traceable_method_1=require("../helpers/traceable-method"),include_1=require("../extension/core/functions/include"),executeBaseIncludeNode=async(e,t,c)=>{const{nodeExecutor:o,outputBuffer:a,sandboxed:n,template:u}=t,{variables:d}=e.children,{only:r,ignoreMissing:i}=e.attributes,l=await c(t),s=(0,traceable_method_1.getTraceableMethod)(include_1.include,e.line,e.column,u.name),x=await s(t,l,await o(d,t),!r,i,n);a.echo(x)};exports.executeBaseIncludeNode=executeBaseIncludeNode;

},{"../extension/core/functions/include":57,"../helpers/traceable-method":115}],152:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.executeEmbedNode=void 0;const include_1=require("../include"),traceable_method_1=require("../../helpers/traceable-method"),executeEmbedNode=(e,t)=>(0,include_1.executeBaseIncludeNode)(e,t,({template:t})=>{const{index:d}=e.attributes;return(0,traceable_method_1.getTraceableMethod)(t.loadEmbeddedTemplate,e.line,e.column,t.name)(d)});exports.executeEmbedNode=executeEmbedNode;

},{"../../helpers/traceable-method":115,"../include":151}],153:[function(require,module,exports){
...
},{"../include":151}],154:[function(require,module,exports){
...
},{"./node":167}],163:[function(require,module,exports){
...
},{"../node-visitor":163,"../node/do":176,"../node/expression/conditional":216,"../node/expression/escape":218,"../node/print":239}],166:[function(require,module,exports){
...
},{"../node":167,"../node-visitor":163,"../node/check-security":172,"../node/check-to-string":173}],167:[function(require,module,exports){
...
},{"../node":167}],169:[function(require,module,exports){
...
},{"../node":167}],170:[function(require,module,exports){
...
},{"../node":167}],172:[function(require,module,exports){
...
},{"../node":167}],173:[function(require,module,exports){
...
},{"../node":167}],174:[function(require,module,exports){
...
},{"../node":167}],175:[function(require,module,exports){
...
},{"../node":167}],176:[function(require,module,exports){
...
},{"../node":167}],177:[function(require,module,exports){
...
},{"../node":167}],178:[function(require,module,exports){
...
},{"../../helpers/record":111,"../expression":177,"./constant":217}],179:[function(require,module,exports){
...
},{"../expression":177}],180:[function(require,module,exports){
...
},{"../../node":167}],181:[function(require,module,exports){
...
},{"../expression":177}],182:[function(require,module,exports){
...
},{"../expression":177}],183:[function(require,module,exports){
...
},{"../binary":182}],184:[function(require,module,exports){
...
},{"../binary":182}],185:[function(require,module,exports){
...
},{"../binary":182}],186:[function(require,module,exports){
...
},{"../binary":182}],187:[function(require,module,exports){
...
},{"../binary":182}],188:[function(require,module,exports){
...
},{"../binary":182}],189:[function(require,module,exports){
...
},{"../binary":182}],190:[function(require,module,exports){
...
},{"../binary":182}],191:[function(require,module,exports){
...
},{"../binary":182}],192:[function(require,module,exports){
...
},{"../binary":182}],193:[function(require,module,exports){
...
},{"../binary":182}],194:[function(require,module,exports){
...
},{"../binary":182}],195:[function(require,module,exports){
...
},{"../binary":182}],196:[function(require,module,exports){
...
},{"../binary":182}],197:[function(require,module,exports){
...
},{"../binary":182}],198:[function(require,module,exports){
...
},{"../binary":182}],199:[function(require,module,exports){
...
},{"../binary":182}],200:[function(require,module,exports){
...
},{"../binary":182}],201:[function(require,module,exports){
...
},{"../binary":182}],202:[function(require,module,exports){
...
},{"../binary":182}],203:[function(require,module,exports){
...
},{"../binary":182}],204:[function(require,module,exports){
...
},{"../binary":182}],205:[function(require,module,exports){
...
},{"../binary":182}],206:[function(require,module,exports){
...
},{"../binary":182}],207:[function(require,module,exports){
...
},{"../binary":182}],208:[function(require,module,exports){
...
},{"../binary":182}],209:[function(require,module,exports){
...
},{"../binary":182}],210:[function(require,module,exports){
...
},{"../binary":182}],211:[function(require,module,exports){
...
},{"../expression":177}],212:[function(require,module,exports){
...
},{"../expression":177}],213:[function(require,module,exports){
...
},{"../call":212}],214:[function(require,module,exports){
...
},{"../call":212}],215:[function(require,module,exports){
...
},{"../call":212}],216:[function(require,module,exports){
...
},{"../expression":177}],217:[function(require,module,exports){
...
},{"../expression":177}],218:[function(require,module,exports){
...
},{"../expression":177}],219:[function(require,module,exports){
...
},{"./array":178}],220:[function(require,module,exports){
...
},{"../expression":177}],221:[function(require,module,exports){
...
},{"../../node":167}],222:[function(require,module,exports){
...
},{"./array":178,"./binary/and":184,"./call/test":215,"./conditional":216,"./unary/not":227}],223:[function(require,module,exports){
...
},{"../expression":177}],224:[function(require,module,exports){
...
},{"../expression":177}],225:[function(require,module,exports){
...
},{"../expression":177}],226:[function(require,module,exports){
...
},{"../unary":225}],227:[function(require,module,exports){
...
},{"../unary":225}],228:[function(require,module,exports){
...
},{"../unary":225}],229:[function(require,module,exports){
...
},{"../node":167}],230:[function(require,module,exports){
...
},{"../node":167}],231:[function(require,module,exports){
...
},{"../node":167,"./for-loop":230,"./if":232}],232:[function(require,module,exports){
...
},{"../node":167}],233:[function(require,module,exports){
...
},{"../node":167}],234:[function(require,module,exports){
...
},{"../node":167}],235:[function(require,module,exports){
...
},{"../include":234}],236:[function(require,module,exports){
...
},{"../include":234}],237:[function(require,module,exports){
...
},{"../node":167}],238:[function(require,module,exports){
...
},{"../node":167}],239:[function(require,module,exports){
...
},{"../node":167}],240:[function(require,module,exports){
...
},{"../node":167}],241:[function(require,module,exports){
...
},{"../node":167,"./expression/constant":217}],242:[function(require,module,exports){
...
},{"../node":167}],243:[function(require,module,exports){
...
},{"../node":167}],244:[function(require,module,exports){
...
},{"../node":167}],245:[function(require,module,exports){
...
},{"../node":167}],246:[function(require,module,exports){
...
},{"./text":244}],247:[function(require,module,exports){
...
},{"../node":167}],248:[function(require,module,exports){
...
},{"../error/base":6}],252:[function(require,module,exports){
...
},{"./security-error":251}],253:[function(require,module,exports){
...
},{"./security-error":251}],254:[function(require,module,exports){
...
},{"./security-error":251}],255:[function(require,module,exports){
...
},{"./security-error":251}],256:[function(require,module,exports){
...
},{"./security-error":251}],257:[function(require,module,exports){
...
},{"../markup":120,"./security-not-allowed-filter-error":252,"./security-not-allowed-function-error":253,"./security-not-allowed-method-error":254,"./security-not-allowed-property-error":255,"./security-not-allowed-tag-error":256}],258:[function(require,module,exports){
...
},{"path":405,"source-map":431}],259:[function(require,module,exports){
...
},{"../node/apply":168,"../node/expression/array":178,"../node/expression/constant":217}],261:[function(require,module,exports){
...
},{"../node/deprecated":175}],264:[function(require,module,exports){
...
},{"../node/do":176}],265:[function(require,module,exports){
...
},{"../node/include/embed":235,"./include":273,"twig-lexer":448}],266:[function(require,module,exports){
...
},{"../error/parsing":8}],267:[function(require,module,exports){
...
},{"../node/block":171,"../node/expression/block-function":211,"../node/expression/constant":217,"../node/print":239}],268:[function(require,module,exports){
...
},{"../node/flush":229}],269:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":167,"../node/expression/assignment":180,"../node/for":231}],270:[function(require,module,exports){
...
},{"../node/expression/assignment":180,"../node/import":233}],271:[function(require,module,exports){
...
},{"../node":167,"../node/if":232}],272:[function(require,module,exports){
...
},{"../node/expression/assignment":180,"../node/import":233}],273:[function(require,module,exports){
...
},{"../node/expression/array":178,"../node/include/include":236}],274:[function(require,module,exports){
...
},{"../node/line":237}],275:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createMacroTagHandler=void 0;const parsing_1=require("../error/parsing"),macro_1=require("../node/macro"),get_key_value_pairs_1=require("../helpers/get-key-value-pairs"),node_1=require("../../lib/node"),createMacroTagHandler=()=>{return{tag:"macro",initialize:e=>(r,a)=>{const{line:o,column:t}=r,c=a.expect("NAME").value,n=e.parseArguments(a,!0,!0);for(const{key:e,value:r}of(0,get_key_value_pairs_1.getKeyValuePairs)(n)){const{value:a}=e.attributes;if(a===macro_1.VARARGS_NAME)throw(0,parsing_1.createParsingError)(`The argument "${macro_1.VARARGS_NAME}" in macro "${c}" cannot be defined because the variable "${macro_1.VARARGS_NAME}" is reserved for arbitrary arguments.`,r)}a.expect("TAG_END"),e.pushLocalScope();const s=e.subparse(a,"macro",e=>e.test("NAME","endmacro"));a.next();const i=a.nextIf("NAME");if(i){const e=i.value;if(e!=c){const{line:r,column:o}=i;throw(0,parsing_1.createParsingError)(`Expected endmacro for macro "${c}" (but "${e}" given).`,{line:r,column:o},a.source.name)}}return e.popLocalScope(),a.expect("TAG_END"),e.setMacro(c,(0,macro_1.createMacroNode)(c,(0,node_1.createNode)({body:s},o,t),n,o,t,"macro")),null}}};exports.createMacroTagHandler=createMacroTagHandler;

},{"../../lib/node":167,"../error/parsing":8,"../helpers/get-key-value-pairs":94,"../node/macro":238}],276:[function(require,module,exports){
...
},{"../error/parsing":8,"../helpers/is-made-of-whitespace-only":99,"../node":167,"../node/sandbox":240}],277:[function(require,module,exports){
...
},{"../error/parsing":8,"../node":167,"../node/set":241}],278:[function(require,module,exports){
...
},{"../node/verbatim":246}],281:[function(require,module,exports){
...
},{"../node/with":247}],282:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTemplate=void 0;const context_1=require("./context"),output_buffer_1=require("./output-buffer"),merge_iterables_1=require("./helpers/merge-iterables"),runtime_1=require("./error/runtime"),node_1=require("./node"),markup_1=require("./markup"),loader_1=require("./error/loader"),clone_map_1=require("./helpers/clone-map"),iterator_to_map_1=require("./helpers/iterator-to-map"),source_1=require("./source"),get_filter_1=require("./helpers/get-filter"),get_test_1=require("./helpers/get-test"),get_function_1=require("./helpers/get-function"),createHash=require("create-hash"),traceable_method_1=require("./helpers/traceable-method"),node_executor_1=require("./node-executor"),get_key_value_pairs_1=require("./helpers/get-key-value-pairs"),createTemplate=(e,t)=>{const{charset:r,dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,numberFormat:s,timezone:l}=e,c=new Map;let i=null;const{blocks:u}=t.children;for(const[e,t]of(0,node_1.getChildren)(u)){const i=(e,c,i,u,d,m)=>{const p=y.aliases.clone();return d(t.children.body,{aliases:p,blocks:i,charset:r,context:e,dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,nodeExecutor:d,numberFormat:s,outputBuffer:c,sandboxed:u,sourceMapRuntime:m,template:y,timezone:l})};c.set(e,i)}const d=new Map,{macros:m}=t.children;for(const[t,c]of Object.entries(m.children)){const i=async(t,i,u,d,...m)=>{const{body:p,arguments:g}=c.children,_=(0,get_key_value_pairs_1.getKeyValuePairs)(g),h=y.aliases.clone(),b=new Map;for(const{key:e,value:c}of _){const p=e.attributes.value,g=await d(c,{aliases:h,blocks:new Map,charset:r,context:(0,context_1.createContext)(),dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,nodeExecutor:d,numberFormat:s,outputBuffer:t,sandboxed:i,sourceMapRuntime:u,template:y,timezone:l});let _=m.shift();void 0===_&&(_=g),b.set(p,_)}b.set("varargs",m);const f=(0,context_1.createContext)(b),x=new Map;return t.start(),await d(p,{aliases:h,blocks:x,charset:r,context:f,dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,nodeExecutor:d,numberFormat:s,outputBuffer:t,sandboxed:i,sourceMapRuntime:u,template:y,timezone:l}).then(()=>{const r=t.getContents();return(0,markup_1.createMarkup)(r,e.charset)}).finally(()=>{t.endAndClean()})};d.set(t,i)}let p=null;const g=new Map;for(const e of t.embeddedTemplates)g.set(e.attributes.index,e);let _=null;const{parent:h,macros:b,body:f}=t.children,{line:x,column:k}=t;let v=void 0===h&&0===(0,node_1.getChildrenCount)(b);if(v){let e=f;0===(0,node_1.getChildrenCount)(f)&&(e=(0,node_1.createNode)({body:f},x,k));for(const[,t]of Object.entries(e.children))if(0!==(0,node_1.getChildrenCount)(t)){v=!1;break}}const y={get aliases(){return T},get ast(){return t},get blockHandlers(){return c},get canBeUsedAsATrait(){return v},get macroHandlers(){return d},get name(){return y.source.name},get source(){return t.attributes.source},checkMethodAllowed:e.sandboxPolicy.checkMethodAllowed,checkPropertyAllowed:e.sandboxPolicy.checkPropertyAllowed,checkSecurity:e.sandboxPolicy.checkSecurity,createTemplateFromString:(t,r)=>{const o=createHash("sha256").update(t).digest("hex").toString();r=null!==r?`${r} (string template ${o})`:`__string_template__${o}`;const a=e.parse(e.tokenize((0,source_1.createSource)(r,t))),n=(0,exports.createTemplate)(e,a);return Promise.resolve(n)},displayBlock:(e,t,r,o,a,n,s,l)=>y.getBlocks().then(c=>{let i,u;if(a&&void 0!==(u=o.get(e))){const[e,t]=u;i=e.blockHandlers.get(t)}else if(void 0!==(u=c.get(e))){const[e,t]=u;i=e.blockHandlers.get(t)}return i?i(t,r,o,n,s,l):y.getParent(t,r,n,s,l).then(a=>{if(a)return a.displayBlock(e,t,r,(0,merge_iterables_1.mergeIterables)(c,o),!1,n,s,l);{const t=o.get(e);if(t){const[r]=t;throw(0,runtime_1.createRuntimeError)(`Block "${e}" should not call parent() in "${r.name}" as the block does not exist in the parent template "${y.name}".`,void 0,r.name)}throw(0,runtime_1.createRuntimeError)(`Block "${e}" on template "${y.name}" does not exist.`,void 0,y.name)}})}),escape:(t,r,o)=>{if("boolean"==typeof t)return Promise.resolve(t);if((0,markup_1.isAMarkup)(t))return Promise.resolve(t);let a;if(null==t)a="";else{const n=e.escapingStrategyHandlers[r];if(void 0===n)return Promise.reject((0,runtime_1.createRuntimeError)(`Invalid escaping strategy "${r}" (valid ones: ${Object.keys(e.escapingStrategyHandlers).sort().join(", ")}).`));a=n(t.toString(),o||e.charset,y.name)}return Promise.resolve(a)},execute:async(e,c,i,u,d)=>{const m=y.aliases.clone(),p=(null==d?void 0:d.sandboxed)||!1,g=null==d?void 0:d.sourceMapRuntime;return Promise.all([y.getParent(e,c,p,u,g),y.getBlocks()]).then(([d,_])=>{const h=(0,merge_iterables_1.mergeIterables)(_,i);return u(t,{aliases:m,blocks:h,charset:r,context:e,dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,nodeExecutor:u,numberFormat:s,outputBuffer:c,sandboxed:p,sourceMapRuntime:g,template:y,timezone:l}).then(()=>{if(d)return d.execute(e,c,h,u,{sandboxed:p,sourceMapRuntime:g})})}).catch(e=>{throw e.source||(e.source=y.name),(0,loader_1.isATemplateLoadingError)(e)&&(e=(0,runtime_1.createRuntimeError)(e.rootMessage,e.location,e.source,e)),e})},getBlocks:()=>i?Promise.resolve(i):y.getTraits().then(e=>i=(0,merge_iterables_1.mergeIterables)(e,new Map([...c.keys()].map(e=>[e,[y,e]])))),getFilter:t=>(0,get_filter_1.getFilter)(e.filters,t),getFunction:t=>(0,get_function_1.getFunction)(e.functions,t),getParent:async(e,c,i,u,d)=>{if(null!==_)return Promise.resolve(_);const m=t.children.parent;return m?y.getBlocks().then(async t=>{const p=await u(m,{aliases:(0,context_1.createContext)(),blocks:t,charset:r,context:e,dateFormat:o,dateIntervalFormat:a,isStrictVariables:n,nodeExecutor:u,numberFormat:s,outputBuffer:c,sandboxed:i,sourceMapRuntime:d,template:y,timezone:l}),g=(0,traceable_method_1.getTraceableMethod)(y.loadTemplate,m.line,m.column,y.name),h=await g(p);return"constant"===m.type&&(_=h),h}):Promise.resolve(null)},getTemplateSource:t=>e.loader.getSource(t,y.name),getTest:t=>(0,get_test_1.getTest)(e.tests,t),getTraits:async()=>{if(null===p){p=new Map;const{traits:e}=t.children;for(const[,t]of(0,node_1.getChildren)(e)){const{template:e,targets:r}=t.children,o=e.attributes.value,a=(0,traceable_method_1.getTraceableMethod)(y.loadTemplate,e.line,e.column,y.name),n=await a(o);if(!n.canBeUsedAsATrait)throw(0,runtime_1.createRuntimeError)(`Template ${o} cannot be used as a trait.`,e,y.name);const s=(0,clone_map_1.cloneMap)(await n.getBlocks());for(const[t,a]of(0,node_1.getChildren)(r)){const r=s.get(t);if(!r)throw(0,runtime_1.createRuntimeError)(`Block "${t}" is not defined in trait "${o}".`,e,y.name);const n=a.attributes.value;s.set(n,r),s.delete(t)}p=(0,merge_iterables_1.mergeIterables)(p,s)}}return Promise.resolve(p)},hasBlock:(e,t,r,o,a,n,s)=>o.has(e)?Promise.resolve(!0):y.getBlocks().then(o=>o.has(e)?Promise.resolve(!0):y.getParent(t,r,a,n,s).then(l=>!!l&&l.hasBlock(e,t,r,o,a,n,s))),hasMacro:e=>Promise.resolve(y.macroHandlers.has(e)),loadEmbeddedTemplate:t=>{const r=g.get(t);return void 0===r?Promise.reject((0,loader_1.createTemplateLoadingError)([`embedded#${t}`])):Promise.resolve((0,exports.createTemplate)(e,r))},loadTemplate:t=>{let r;return r="string"==typeof t?e.loadTemplate(t,y.name):Array.isArray(t)?y.resolveTemplate(t):Promise.resolve(t)},render:(e,t)=>{const r=(null==t?void 0:t.outputBuffer)||(0,output_buffer_1.createOutputBuffer)();r.start();const o=(null==t?void 0:t.nodeExecutor)||node_executor_1.executeNode;return y.execute((0,context_1.createContext)((0,iterator_to_map_1.iteratorToMap)(e)),r,new Map,o,{sandboxed:null==t?void 0:t.sandboxed,sourceMapRuntime:null==t?void 0:t.sourceMapRuntime}).then(()=>r.getAndFlush())},renderBlock:(e,t,r,o,a,n,s,l)=>(r.start(),y.displayBlock(e,t,r,o,a,n,s,l).then(()=>r.getAndClean())),renderParentBlock:(e,t,r,o,a,n)=>(r.start(),y.getBlocks().then(s=>((e,t,r,o,a,n,s)=>y.getTraits().then(l=>{const c=l.get(e);if(c){const[e,l]=c;return e.displayBlock(l,t,r,o,!1,a,n,s)}return y.getParent(t,r,a,n,s).then(l=>{if(null!==l)return l.displayBlock(e,t,r,o,!1,a,n,s);throw(0,runtime_1.createRuntimeError)(`The template has no parent and no traits defining the "${e}" block.`,void 0,y.name)})}))(e,t,r,s,o,a,n).then(()=>r.getAndClean()))),resolveTemplate:e=>{const t=r=>{if(r<e.length){const o=e[r];return null===o?t(r+1):"string"!=typeof o?Promise.resolve(o):y.loadTemplate(o).catch(()=>t(r+1))}return Promise.reject((0,loader_1.createTemplateLoadingError)(e.map(e=>null===e?"":e),void 0,y.name))};return t(0)}},T=(0,context_1.createContext)();return T.set("_self",y),y};exports.createTemplate=createTemplate;

},{"./context":3,"./error/loader":7,"./error/runtime":9,"./helpers/clone-map":77,"./helpers/get-filter":91,"./helpers/get-function":93,"./helpers/get-key-value-pairs":94,"./helpers/get-test":95,"./helpers/iterator-to-map":105,"./helpers/merge-iterables":107,"./helpers/traceable-method":115,"./markup":120,"./node":167,"./node-executor":121,"./output-buffer":249,"./source":259,"create-hash":291}],283:[function(require,module,exports){
...
},{"./callable-wrapper":2}],284:[function(require,module,exports){
...
},{"./error/parsing":8,"./lexer":116,"twig-lexer":448}],285:[function(require,module,exports){
...
},{"base64-js":285,"buffer":287,"ieee754":316}],288:[function(require,module,exports){
...
},{"inherits":317,"safe-buffer":410,"stream":432,"string_decoder":447}],290:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"buffer":287}],291:[function(require,module,exports){
...
},{"cipher-base":289,"inherits":317,"md5.js":399,"ripemd160":408,"sha.js":413}],292:[function(require,module,exports){
...
},{"clone":290}],293:[function(require,module,exports){
...
},{"inherits":317,"safe-buffer":410,"stream":432}],296:[function(require,module,exports){
...
},{"safer-buffer":411}],298:[function(require,module,exports){
...
},{"./tables/big5-added.json":304,"./tables/cp936.json":305,"./tables/cp949.json":306,"./tables/cp950.json":307,"./tables/eucjp.json":308,"./tables/gb18030-ranges.json":309,"./tables/gbk-added.json":310,"./tables/shiftjis.json":311}],299:[function(require,module,exports){
...
},{"./dbcs-codec":297,"./dbcs-data":298,"./internal":300,"./sbcs-codec":301,"./sbcs-data":303,"./sbcs-data-generated":302,"./utf16":312,"./utf7":313}],300:[function(require,module,exports){
...
},{"safer-buffer":411,"string_decoder":447}],301:[function(require,module,exports){
...
},{"safer-buffer":411}],302:[function(require,module,exports){
...
},{"safer-buffer":411}],313:[function(require,module,exports){
...
},{"safer-buffer":411}],314:[function(require,module,exports){
...
},{"../encodings":299,"./bom-handling":314,"./extend-node":286,"./streams":286,"_process":406,"safer-buffer":411}],316:[function(require,module,exports){
...
},{"isobject":320}],320:[function(require,module,exports){
...
},{"./_php_cast_int":324}],324:[function(require,module,exports){
...
},{"../i18n/i18n_loc_get_default":330,"../info/ini_get":331,"../strings/strnatcmp":389}],329:[function(require,module,exports){
...
},{"./abs":333,"./acos":334,"./acosh":335,"./asin":336,"./asinh":337,"./atan":338,"./atan2":339,"./atanh":340,"./base_convert":341,"./bindec":342,"./ceil":343,"./cos":344,"./cosh":345,"./decbin":346,"./dechex":347,"./decoct":348,"./deg2rad":349,"./exp":350,"./expm1":351,"./floor":352,"./fmod":353,"./getrandmax":354,"./hexdec":355,"./hypot":356,"./is_finite":358,"./is_infinite":359,"./is_nan":360,"./lcg_value":361,"./log":362,"./log10":363,"./log1p":364,"./max":365,"./min":366,"./mt_getrandmax":367,"./mt_rand":368,"./octdec":369,"./pi":370,"./pow":371,"./rad2deg":372,"./rand":373,"./round":374,"./sin":375,"./sinh":376,"./sqrt":377,"./tan":378,"./tanh":379}],358:[function(require,module,exports){
...
},{"../_helpers/_php_cast_float":323,"../_helpers/_php_cast_int":324}],375:[function(require,module,exports){
...
},{"../_helpers/_phpCastString":322}],389:[function(require,module,exports){
...
},{"../_helpers/_phpCastString":322}],390:[function(require,module,exports){
...
},{"../array/krsort":328,"../info/ini_set":332}],391:[function(require,module,exports){
...
},{"../url/rawurlencode":394,"../url/urlencode":395}],394:[function(require,module,exports){
...
},{"hash-base":295,"inherits":317,"safe-buffer":410}],400:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":401,"./vendor/camel-case-upper-regexp":402,"./vendor/non-word-regexp":403,"lower-case":397}],401:[function(require,module,exports){
...
},{"wcwidth":458}],405:[function(require,module,exports){
(function (process){(function (){
...
},{"buffer":287,"hash-base":295,"inherits":317}],409:[function(require,module,exports){
...
},{"buffer":287}],411:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":406,"buffer":287}],412:[function(require,module,exports){
...
},{"safe-buffer":410}],413:[function(require,module,exports){
...
},{"./sha":414,"./sha1":415,"./sha224":416,"./sha256":417,"./sha384":418,"./sha512":419}],414:[function(require,module,exports){
...
},{"./hash":412,"inherits":317,"safe-buffer":410}],415:[function(require,module,exports){
...
},{"./hash":412,"inherits":317,"safe-buffer":410}],416:[function(require,module,exports){
...
},{"./hash":412,"./sha256":417,"inherits":317,"safe-buffer":410}],417:[function(require,module,exports){
...
},{"./hash":412,"inherits":317,"safe-buffer":410}],418:[function(require,module,exports){
...
},{"./hash":412,"./sha512":419,"inherits":317,"safe-buffer":410}],419:[function(require,module,exports){
...
},{"./hash":412,"inherits":317,"safe-buffer":410}],420:[function(require,module,exports){
var noCase=require("no-case");module.exports=function(e,n){return noCase(e,n,"_")};

},{"no-case":400}],421:[function(require,module,exports){
...
},{"./util":430}],422:[function(require,module,exports){
...
},{"./base64":423}],423:[function(require,module,exports){
...
},{"./util":430}],426:[function(require,module,exports){
...
},{"./array-set":421,"./base64-vlq":422,"./binary-search":424,"./quick-sort":426,"./util":430}],428:[function(require,module,exports){
...
},{"./array-set":421,"./base64-vlq":422,"./mapping-list":425,"./util":430}],429:[function(require,module,exports){
...
},{"./source-map-generator":428,"./util":430}],430:[function(require,module,exports){
...
},{"./lib/source-map-consumer":427,"./lib/source-map-generator":428,"./lib/source-node":429}],432:[function(require,module,exports){
...
},{"events":294,"inherits":317,"readable-stream/lib/_stream_duplex.js":434,"readable-stream/lib/_stream_passthrough.js":435,"readable-stream/lib/_stream_readable.js":436,"readable-stream/lib/_stream_transform.js":437,"readable-stream/lib/_stream_writable.js":438,"readable-stream/lib/internal/streams/end-of-stream.js":442,"readable-stream/lib/internal/streams/pipeline.js":444}],433:[function(require,module,exports){
...
},{"./_stream_readable":436,"./_stream_writable":438,"_process":406,"inherits":317}],435:[function(require,module,exports){
...
},{"./_stream_transform":437,"inherits":317}],436:[function(require,module,exports){
...
},{"../errors":433,"./_stream_duplex":434,"./internal/streams/async_iterator":439,"./internal/streams/buffer_list":440,"./internal/streams/destroy":441,"./internal/streams/from":443,"./internal/streams/state":445,"./internal/streams/stream":446,"_process":406,"buffer":287,"events":294,"inherits":317,"string_decoder/":447,"util":286}],437:[function(require,module,exports){
...
},{"../errors":433,"./_stream_duplex":434,"inherits":317}],438:[function(require,module,exports){
(function (process,global){(function (){
...
},{"../errors":433,"./_stream_duplex":434,"./internal/streams/destroy":441,"./internal/streams/state":445,"./internal/streams/stream":446,"_process":406,"buffer":287,"inherits":317,"util-deprecate":456}],439:[function(require,module,exports){
(function (process){(function (){
...
},{"./end-of-stream":442,"_process":406}],440:[function(require,module,exports){
...
},{"buffer":287,"util":286}],441:[function(require,module,exports){
(function (process){(function (){
...
},{"_process":406}],442:[function(require,module,exports){
...
},{"../../../errors":433}],443:[function(require,module,exports){
...
},{"../../../errors":433,"./end-of-stream":442}],445:[function(require,module,exports){
...
},{"../../../errors":433}],446:[function(require,module,exports){
module.exports=require("events").EventEmitter;

},{"events":294}],447:[function(require,module,exports){
...
},{"safe-buffer":410}],448:[function(require,module,exports){
...
},{"./lib/Lexer":449,"./lib/SyntaxError":450,"./lib/Token":451,"./lib/TokenStream":452,"./lib/TokenType":453}],449:[function(require,module,exports){
...
},{"./SyntaxError":450,"./Token":451}],450:[function(require,module,exports){
...
},{"./Token":451}],453:[function(require,module,exports){
...
},{"buffer":287,"lodash":396}],455:[function(require,module,exports){
"use strict";module.exports=require("./lib/utf8-binary-cutter");

},{"./lib/utf8-binary-cutter":454}],456:[function(require,module,exports){
(function (global){(function (){
...
},{"./combining":457,"defaults":292}]},{},[1])(1)
});
