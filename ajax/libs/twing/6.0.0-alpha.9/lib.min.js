...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEnvironment=void 0;const extension_set_1=require("./extension-set"),parser_1=require("./parser"),html_1=require("./escaping-stragegy/html"),css_1=require("./escaping-stragegy/css"),js_1=require("./escaping-stragegy/js"),url_1=require("./escaping-stragegy/url"),html_attribute_1=require("./escaping-stragegy/html-attribute"),source_1=require("./source"),token_stream_1=require("./token-stream"),template_1=require("./node/template"),source_map_runtime_1=require("./source-map-runtime"),security_policy_1=require("./sandbox/security-policy"),markup_1=require("./markup"),template_2=require("./template"),runtime_1=require("./error/runtime"),luxon_1=require("luxon"),events_1=require("events"),loader_1=require("./error/loader"),lexer_1=require("./lexer"),createHash=require("create-hash"),core_1=require("./extension/core"),lib_1=require("../lib");function createEnvironment(e,t){const r={css:(0,css_1.createCssEscapingStrategyHandler)(),html:(0,html_1.createHtmlEscapingStrategyHandler)(),html_attr:(0,html_attribute_1.createHtmlAttributeEscapingStrategyHandler)(),js:(0,js_1.createJsEscapingStrategyHandler)(),url:(0,url_1.createUrlEscapingStrategyHandler)()},a=(0,extension_set_1.createExtensionSet)();a.addExtension((0,core_1.createCoreExtension)());const n=(null==t?void 0:t.autoReload)||!1,s=(null==t?void 0:t.cache)||null,o=(null==t?void 0:t.charset)||"UTF-8",i=(null==t?void 0:t.dateFormat)||"F j, Y H:i",l=(null==t?void 0:t.dateIntervalFormat)||"%d days",u=(null==t?void 0:t.numberFormat)||{decimalPoint:".",numberOfDecimals:0,thousandSeparator:","},c=new events_1.EventEmitter,d=new Map,m=(null==t?void 0:t.sandboxPolicy)||(0,security_policy_1.createSandboxSecurityPolicy)();let p,g,_=!(null==t||!t.sandboxed);const y=new Map,h={get charset(){return o},get dateFormat(){return i},get dateIntervalFormat(){return l},get numberFormat(){return u},get filters(){return a.filters},get functions(){return a.functions},get isSandboxed(){return _},set isSandboxed(e){_=e},get isStrictVariables(){return!(null==t||!t.strictVariables)},get loader(){return e},get sandboxPolicy(){return m},get tests(){return a.tests},get timezone(){return(null==t?void 0:t.timezone)||luxon_1.Settings.defaultZoneName},addExtension:a.addExtension,addFilter:a.addFilter,addFunction:a.addFunction,addNodeVisitor:a.addNodeVisitor,addOperator:a.addOperator,addTagHandler:a.addTagHandler,addTest:a.addTest,createTemplateFromString:(e,t)=>{const r=createHash("sha256").update(e).digest("hex").toString();t=null!==t?`${t} (string template ${r})`:`__string_template__${r}`;const a=h.parse(h.tokenize((0,source_1.createSource)(t,e))),n=(0,template_2.createTemplate)(h,a);return h.registerTemplate(n,t),Promise.resolve(n)},escape:(e,t,a,n)=>{if("boolean"==typeof t)return Promise.resolve(t);if((0,markup_1.isAMarkup)(t))return Promise.resolve(t);let s;if(null==t)s="";else{const o=r[a];if(void 0===o)return Promise.reject((0,runtime_1.createRuntimeError)(`Invalid escaping strategy "${a}" (valid ones: ${Object.keys(r).sort().join(", ")}).`));s=o(t.toString(),n||h.charset,e.templateName)}return Promise.resolve(s)},loadTemplate:async(t,r=null)=>{let a;c.emit("load",t,r);const o=await(async(t,r)=>{let a=await e.getCacheKey(t,r);return null===a?null:createHash("sha256").update(a).digest("hex")})(t,r);if(o&&(a=y.get(o)),a)return Promise.resolve(a);{const a=s&&o?await s.generateKey(o):null,i=s&&a?await s.getTimestamp(a):0,l=async()=>{if(null===s||null===a)return Promise.resolve(null);let o;if(n){o=await e.isFresh(t,i,r)?await s.load(a):null}else o=await s.load(a);return o},u=async()=>{const n=await e.getSourceContext(t,r);if(null===n)return null;const o=h.parse(h.tokenize(n));return null!==s&&null!==a&&await s.write(a,o),o};let c=await l();if(null===c&&(c=await u()),null===c)throw(0,loader_1.createTemplateLoadingError)([t]);const d=(0,template_2.createTemplate)(h,c);return h.registerTemplate(d,o),d}},mergeGlobals:e=>{for(let[t,r]of d)e.has(t)||e.set(t,r);return e},on:(e,t)=>{c.on(e,t)},registerEscapingStrategy:(e,t)=>{r[t]=e},parse:(e,r)=>{if(!g){const e=a.nodeVisitors;if(null==t?void 0:t.autoEscapingStrategy){const r=t.autoEscapingStrategy;e.unshift({enterNode:e=>e,leaveNode:e=>{if(e.is(template_1.templateNodeType)){const t=(0,lib_1.createAutoEscapeNode)(r,e.children.body.children.content,e.line,e.column,"foo");e.children.body.children.content=t}return e}})}g=(0,parser_1.createParser)(a.unaryOperators,a.binaryOperators,a.tagHandlers,a.nodeVisitors,a.filters,a.functions,a.tests,r||(null==t?void 0:t.parserOptions)||{strict:!0})}try{return g.parse(e)}catch(t){const r=e.source;throw t.source||(t.source=r.resolvedName),t}},registerTemplate:(e,t)=>{y.set(t,e)},render:(e,t)=>h.loadTemplate(e).then(e=>e.render(t)),renderWithSourceMap:(e,t)=>{const r=(0,source_map_runtime_1.createSourceMapRuntime)();return h.loadTemplate(e).then(e=>e.render(t,void 0,r)).then(e=>{const{sourceMap:t}=r;return{data:e,sourceMap:t}})},resolveTemplate:(e,t)=>{const r=a=>{if(a<e.length){const n=e[a];return null===n?r(a+1):"string"!=typeof n?Promise.resolve(n):h.loadTemplate(n,t).catch(()=>r(a+1))}return Promise.reject((0,loader_1.createTemplateLoadingError)(e.map(e=>null===e?"":e),void 0,t))};return r(0)},setGlobal:(e,t)=>{d.set(e,t)},tokenize:e=>{p||(p=(0,lexer_1.createLexer)(a.binaryOperators,a.unaryOperators));const t=p.tokenizeSource(e);return(0,token_stream_1.createTokenStream)(t.toAst(),t.source)}};return h}exports.createEnvironment=createEnvironment;

},{"../lib":1,"./error/loader":7,"./error/runtime":9,"./escaping-stragegy/css":10,"./escaping-stragegy/html":12,"./escaping-stragegy/html-attribute":11,"./escaping-stragegy/js":13,"./escaping-stragegy/url":14,"./extension-set":15,"./extension/core":16,"./lexer":113,"./markup":118,"./node/template":201,"./parser":206,"./sandbox/security-policy":213,"./source":215,"./source-map-runtime":214,"./template":238,"./token-stream":240,"create-hash":247,"events":250,"luxon":369}],5:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.escape=void 0;const markup_1=require("../../../markup"),escape=(e,r,t,s)=>{const{environment:p}=e;return null===t&&(t="html"),p.escape(e,r,t,s).then(e=>"string"==typeof e?(0,markup_1.createMarkup)(e,p.charset):e)};exports.escape=escape;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getAttribute=void 0;const map_like_1=require("./map-like"),runtime_1=require("../error/runtime"),examine_object_1=require("./examine-object"),is_plain_object_1=require("./is-plain-object"),get_1=require("./get"),php_1=require("./php"),isObject=require("isobject"),getAttribute=(e,t,i,r,s,o,a)=>{a=null===a?!e.isStrictVariables:a;const{isSandboxed:n}=e;try{return Promise.resolve((()=>{let l;if("method"!==s){let r;if(r=(0,php_1.isBoolean)(i)?i?1:0:(0,php_1.isFloat)(i)?parseInt(i):i,t&&((0,map_like_1.isAMapLike)(t)&&t.has(r)||(0,is_plain_object_1.isPlainObject)(t)&&Reflect.has(t,r)))return!!o||("array"!==s&&n&&e.sandboxPolicy.checkPropertyAllowed(t,i),(0,get_1.get)(t,r));if("array"===s||(0,map_like_1.isAMapLike)(t)||null===t||"object"!=typeof t){if(o)return!1;if(a)return;throw l=(0,map_like_1.isAMapLike)(t)?t.size<1?`Index "${r}" is out of bounds as the array is empty.`:`Index "${r}" is out of bounds for array [${[...t.values()]}].`:"array"===s?null===t?`Impossible to access a key ("${i}") on a null variable.`:`Impossible to access a key ("${i}") on a ${typeof t} variable ("${t.toString()}").`:null===t?`Impossible to access an attribute ("${i}") on a null variable.`:`Impossible to access an attribute ("${i}") on a ${typeof t} variable ("${t}").`,(0,runtime_1.createRuntimeError)(l)}}if(null===t||!isObject(t)||(0,map_like_1.isAMapLike)(t)){if(o)return!1;if(a)return;throw l=null===t?`Impossible to invoke a method ("${i}") on a null variable.`:(0,map_like_1.isAMapLike)(t)?`Impossible to invoke a method ("${i}") on an array.`:`Impossible to invoke a method ("${i}") on a ${typeof t} variable ("${t}").`,(0,runtime_1.createRuntimeError)(l)}if("method"!==s&&Reflect.has(t,i)&&"function"!=typeof t[i])return!!o||(n&&e.sandboxPolicy.checkPropertyAllowed(t,i),(0,get_1.get)(t,i));let u=[];for(let e of(0,examine_object_1.examineObject)(t))"function"==typeof t[e]&&u.push(e);u.sort();let c=u.map(e=>e.toLowerCase()),p=new Map;for(let e=0;e<u.length;e++){let t=u[e],i=c[e];p.set(t,t),p.set(i,t);let r="";if("g"===i[0]&&0===i.indexOf("get"))r=t.substr(3),i=i.substr(3);else if("i"===i[0]&&0===i.indexOf("is"))r=t.substr(2),i=i.substr(2);else{if("h"!==i[0]||0!==i.indexOf("has"))continue;if(r=t.substr(3),i=i.substr(3),c.includes("is"+i))continue}r.length>0&&(p.has(r)||p.set(r,t),p.has(i)||p.set(i,t))}let b,f,m=i;if(p.has(i))b=p.get(i);else{if(!p.has(f=m.toLowerCase())){if(o)return!1;if(a)return;throw(0,runtime_1.createRuntimeError)(`Neither the property "${i}" nor one of the methods ${i}()" or "get${i}()"/"is${i}()"/"has${i}()" exist and have public access in class "${t.constructor.name}".`)}b=p.get(f)}return!!o||(n&&e.sandboxPolicy.checkMethodAllowed(t,b),(0,get_1.get)(t,b).apply(t,[...r.values()]))})())}catch(e){return Promise.reject(e)}};exports.getAttribute=getAttribute;
...
},{"./error/parsing":8,"./token-stream":240,"twig-lexer":419}],114:[function(require,module,exports){
...
},{"../helpers/iterator-to-map":104,"../source":215}],115:[function(require,module,exports){
...
},{"../source":215,"locutus/php/strings/rtrim":357,"path":376}],117:[function(require,module,exports){
...
},{"../source":215,"path":376}],118:[function(require,module,exports){
(function (Buffer){(function (){
...
},{"../node":124}],131:[function(require,module,exports){
...
},{"../../helpers/get-attribute":88,"../expression":134}],140:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.cloneBlockReferenceExpressionNode=exports.createBlockFunctionNode=exports.blockFunctionNodeType=void 0;const expression_1=require("../expression");exports.blockFunctionNodeType="block_function";const createBlockFunctionNode=(e,o,n,t,c)=>{const s={name:e};o&&(s.template=o);const l=(0,expression_1.createBaseExpressionNode)(exports.blockFunctionNodeType,{shouldTestExistence:!1},s,n,t,c),r=Object.assign(Object.assign({},l),{execute:async(...e)=>{const[o,n,t,c,,s]=e,{template:l,name:i}=r.children,a=await i.execute(...e);let p;if(l){const n=await l.execute(...e);p=o.loadTemplate(n,l.line,l.column)}else p=Promise.resolve(o);return p.then(e=>{if(r.attributes.shouldTestExistence){return e.getTraceableMethod(e.hasBlock,r.line,r.column,o.templateName)(a,n.clone(),t,c)}{const i=e.getTraceableMethod(e.renderBlock,r.line,r.column,o.templateName);return l?i(a,n.clone(),t,new Map,!1,s):i(a,n.clone(),t,c,!0,s)}})}});return r};exports.createBlockFunctionNode=createBlockFunctionNode;const cloneBlockReferenceExpressionNode=e=>(0,exports.createBlockFunctionNode)(e.children.name,e.children.template||null,e.line,e.column);exports.cloneBlockReferenceExpressionNode=cloneBlockReferenceExpressionNode;

},{"../expression":134}],167:[function(require,module,exports){
...
},{"../../error/runtime":9,"../../helpers/get-filter":91,"../../helpers/get-function":93,"../../helpers/get-test":94,"../expression":134,"./array":136,"./constant":172,"locutus/php/array/array_merge":297,"snake-case":391}],168:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEscapeNode=void 0;const expression_1=require("../expression"),createEscapeNode=(e,t)=>{const s=(0,expression_1.createBaseExpressionNode)("escape",{strategy:t},{body:e},e.line,e.column),r=Object.assign(Object.assign({},s),{execute:(...e)=>{const[t]=e,{environment:s}=t,{strategy:c}=r.attributes,{body:o}=r.children;return o.execute(...e).then(e=>{return t.getTraceableMethod(s.escape,r.line,r.column,t.templateName)(t,e,c,null,!0)})}});return r};exports.createEscapeNode=createEscapeNode;

},{"../expression":134}],174:[function(require,module,exports){
...
},{"../expression":134,"./array":136}],176:[function(require,module,exports){
...
},{"../../helpers/get-context-value":90,"../../node":124}],177:[function(require,module,exports){
...
},{"../node":124}],188:[function(require,module,exports){
...
},{"../node":124}],189:[function(require,module,exports){
...
},{"../include":188}],190:[function(require,module,exports){
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSetNode=void 0;const node_1=require("../node"),constant_1=require("./expression/constant"),text_1=require("./output/text"),arguments_1=require("./expression/arguments"),createSetNode=(e,t,s,a,r,n)=>{const o=(0,node_1.createBaseNode)("set",{capture:e},{names:t,values:s},a,r,n);if(o.attributes.capture){const{values:e}=o.children;e.is(text_1.textNodeType)&&(o.children.values=(0,arguments_1.createArgumentsNode)({0:(0,constant_1.createConstantNode)(e.attributes.data,e.line,e.column)},e.line,e.column),o.attributes.capture=!1)}const c=Object.assign(Object.assign({},o),{execute:async(...e)=>{const[,t,s]=e,{names:a,values:r}=c.children,{capture:n}=c.attributes,o=await a.execute(...e);if(n){s.start(),await r.execute(...e);const a=s.getAndClean();for(const e of o)t.set(e,a)}else{const s=await r.execute(...e);let a=0;for(const e of o){const r=s[a];t.set(e,r),a++}}},isACaptureNode:!0});return c};exports.createSetNode=createSetNode;

},{"../node":124,"./expression/arguments":135,"./expression/constant":172,"./output/text":197}],201:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTemplateNode=exports.templateNodeType=void 0;const node_1=require("../node");exports.templateNodeType="template";const createTemplateNode=(e,t,o,r,c,s,n,a,l)=>{const d={body:e,blocks:o,macros:r,traits:c,securityCheck:(0,node_1.createBaseNode)(null)};null!==t&&(d.parent=t);const p=(0,node_1.createBaseNode)(exports.templateNodeType,{index:0,source:n},d,a,l),u=Object.assign(Object.assign({},p),{get embeddedTemplates(){return s},get source(){return n},execute:(...e)=>{const[t,,o,,,r]=e,{securityCheck:c,body:s}=u.children;return c.execute(...e).then(()=>(null==r||r.enterSourceMapBlock(u.line,u.column,u.type,t.source,o),s.execute(...e).then(()=>{null==r||r.leaveSourceMapBlock(o)})))}});return u};exports.createTemplateNode=createTemplateNode;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createSourceMapRuntime=void 0;const path_1=require("path"),source_map_1=require("source-map"),createSourceMapRuntime=()=>{let e=[new source_map_1.SourceNode];return{get sourceMap(){const{map:t}=e[0].toStringWithSourceMap();return JSON.parse(t.toString())},enterSourceMapBlock:(t,r,o,a,c)=>{c.start();let u=a.resolvedName;(0,path_1.isAbsolute)(u)&&(u=(0,path_1.relative)(".",u));const p=new source_map_1.SourceNode(t,r-1,u,"",o);e[0].setSourceContent(u,a.code),e.push(p)},leaveSourceMapBlock:t=>{const r=e.pop(),o=t.getAndFlush();0===r.children.length&&r.add(o),e[e.length-1].add(r)}}};exports.createSourceMapRuntime=createSourceMapRuntime;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createEmbedTagHandler=void 0;const include_1=require("./include"),embed_1=require("../node/include/embed"),twig_lexer_1=require("twig-lexer"),createEmbedTagHandler=()=>{return{tag:"embed",initialize:e=>(n,t)=>{const{line:r,column:i}=n;let l,a,o=e.parseExpression(t),d=(0,include_1.parseArguments)(e,t,r,i),s=d.variables,m=d.only,c=d.ignoreMissing;l=a=new twig_lexer_1.Token("STRING","__parent__",n.line,n.column),o.is("constant")?l=new twig_lexer_1.Token("STRING",o.attributes.value,n.line,n.column):o.is("name")&&(l=new twig_lexer_1.Token("NAME",o.attributes.name,n.line,n.column)),t.injectTokens([new twig_lexer_1.Token("TAG_START","",n.line,n.column),new twig_lexer_1.Token("NAME","extends",n.line,n.column),l,new twig_lexer_1.Token("TAG_END","",n.line,n.column)]);let _=e.parse(t,"embed",e=>e.test("NAME","endembed"));t.next(),a===l&&(_.children.parent=o),e.embedTemplate(_),t.expect("TAG_END");const{source:u,index:b}=_.attributes;return(0,embed_1.createEmbedNode)({templateName:u.name,index:b,only:m,ignoreMissing:c},{variables:s},n.line,n.column,"embed")}}};exports.createEmbedTagHandler=createEmbedTagHandler;

},{"../node/include/embed":189,"./include":229,"twig-lexer":419}],222:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createExtendsTagHandler=void 0;const parsing_1=require("../error/parsing"),createExtendsTagHandler=()=>{return{tag:"extends",initialize:e=>(r,n)=>{const{line:a,column:t}=r;if(e.peekBlockStack())throw(0,parsing_1.createParsingError)('Cannot use "extend" in a block.',{line:a,column:t},n.source.resolvedName);if(!e.isMainScope())throw(0,parsing_1.createParsingError)('Cannot use "extend" in a macro.',{line:a,column:t},n.source.resolvedName);if(null!==e.parent)throw(0,parsing_1.createParsingError)("Multiple extends tags are forbidden.",{line:a,column:t},n.source.resolvedName);return e.parent=e.parseExpression(n),n.expect("TAG_END"),null}}};exports.createExtendsTagHandler=createExtendsTagHandler;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.createTokenStream=void 0;const parsing_1=require("./error/parsing"),twig_lexer_1=require("twig-lexer"),lexer_1=require("./lexer"),createTokenStream=(e,t)=>{const r=new twig_lexer_1.TokenStream(e),n={get current(){return r.current},get source(){return t},injectTokens:e=>{r.injectTokens(e)},next:()=>r.next(),nextIf:(e,t)=>r.nextIf(e,t),expect:(e,r=null,o=null)=>{let l=n.current;if(!l.test(e,r||void 0)){const{line:n,column:i}=l;throw(0,parsing_1.createParsingError)(o?`${o}.`:`Unexpected token "${(0,lexer_1.typeToEnglish)(l.type)}" of value "${l.value}" ("${(0,lexer_1.typeToEnglish)(e)}" expected${r?` with value "${r}"`:""}).`,{line:n,column:i},t.resolvedName)}return n.next(),l},look:e=>r.look(e),test:(e,t)=>r.test(e,t),isEOF:()=>"EOF"===n.current.type,toAst:()=>r.traverse((e,t)=>((e=(0,twig_lexer_1.astVisitor)(e,t))&&e.test("TEST_OPERATOR")&&(e=new twig_lexer_1.Token("OPERATOR",e.value,e.line,e.column)),e))};return n};exports.createTokenStream=createTokenStream;

},{"./error/parsing":8,"./lexer":113,"twig-lexer":419}],241:[function(require,module,exports){
