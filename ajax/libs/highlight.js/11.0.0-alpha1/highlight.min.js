...
return"("+e.map((e=>d(e))).join("|")+")"}function _(e){
return RegExp(e.toString()+"|").exec("").length-1}
const p=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./
;function f(e,{joinWith:n}){let t=0;return e.map((e=>{t+=1;const n=t
;let a=d(e),i="";for(;a.length>0;){const e=p.exec(a);if(!e){i+=a;break}
...
},S=x("//","$"),A=x("/\\*","\\*/"),C=x("#","$");var k=Object.freeze({
...
},COMMENT:x,C_LINE_COMMENT_MODE:S,C_BLOCK_COMMENT_MODE:A,HASH_COMMENT_MODE:C,
...
H;G(e,e.begin,{key:"beginScope"}),e.begin=f(e.begin,{joinWith:""})}})(e),(e=>{
...
H;G(e,e.end,{key:"endScope"}),e.end=f(e.end,{joinWith:""})}})(e)}function W(e){
...
;if(S.addText(t),t="",C+=i,e.startsWith("_"))t+=n[0];else{
...
;M.relevance>0&&(C+=e.relevance),S.addSublanguage(e._emitter,e.language)
})():c(),A=""}function u(e,n){let t=1;for(;void 0!==n[t];){if(!e._emit[t]){t++
;continue}const a=w.classNameAliases[e[t]]||e[t],i=n[t]
;a?S.addKeyword(i,a):(A=i,c(),A=""),t++}}function _(e,n){
...
value:M}}),M}function p(e,n,t){let i=((e,n)=>{const t=e&&e.exec(n)
...
const t=e[0],a=n.substr(e.index),i=p(M,e,a);if(!i)return J;const s=M
...
M.scope&&!M.isMultiClass&&S.closeNode(),M.skip||M.subLanguage||(C+=M.relevance),
...
g(),t.returnBegin||t.excludeBegin||(A=n)),_(t,e),t.returnBegin?0:n.length})(s)
;if("illegal"===s.type&&!i){
...
;e.forEach((e=>S.openNode(e)))})();let A="",C=0,k=0,T=0,R=!1;try{
...
;k=e.index+t}return y(n.substr(k)),S.closeAllNodes(),S.finalize(),O=S.toHTML(),{
language:e,value:O,relevance:C,illegal:!1,_emitter:S,_top:M}}catch(t){
...
context:n.slice(k-100,k+100),mode:t.mode,resultSoFar:O},_emitter:S};if(r)return{
...
language:s.secondBest.language,relevance:s.secondBest.relevance})}let p=!1
;function f(){
...
q("10.7.0","Please use highlightElement now."),_(e)),configure:e=>{d=V(d,e)},
initHighlighting:()=>{
...
}),e.debugMode=()=>{r=!1},e.safeMode=()=>{r=!0},e.versionString="11.0.0-alpha1"
;for(const e in k)"object"==typeof k[e]&&n(k[e]);return Object.assign(e,k),e
...
const ge="[A-Za-z$_][0-9A-Za-z$_]*",ue=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],be=["true","false","null","undefined","NaN","Infinity"],me=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer","BigInt64Array","BigUint64Array","BigInt"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
;function _e(e){const n=ge,t={begin:/<[A-Za-z0-9\\._:-]+/,
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},ce,i]}},grmr_javascript:_e,
...
begin:b(/\./,g(m(...fe,...he))),end:m(...fe,...he),excludeBegin:!0},s={
match:b(/\./,m(...Ne)),relevance:0
},r=Ne.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:m(...Ne.filter((e=>"string"!=typeof e)).concat(Ee).map(pe),...he)}]},l={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(ve),literal:ye},c=[i,s,o],d=[{
match:b(/\./,m(...Oe)),relevance:0},{className:"built_in",
match:b(/\b/,m(...Oe),/(?=\()/)}],u={match:/->/,relevance:0},_=[u,{
...
match:b(/`/,ke,/`/)},M=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${Ce}+`}],x=[{match:/(@|#)available/,
className:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:De,
contains:[..._,f,v]}]}},{className:"keyword",match:b(/@/,m(...Re))},{
className:"meta",match:b(/@/,ke)}],S={match:g(/\b[A-Z]/),relevance:0,contains:[{
className:"type",
match:b(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Ce,"+")
...
match:b(ke,/\s*:/),keywords:"_|0",relevance:0
},...a,...c,...d,..._,f,v,...M,...x,S]},k={beginKeywords:"func",contains:[{
className:"title",match:m(O.match,ke,Se),endsParent:!0,relevance:0},n]},T={
begin:/</,end:/>/,contains:[...a,S]},R={begin:/\(/,end:/\)/,keywords:l,
contains:[{begin:m(g(b(ke,/\s*:/)),g(b(ke,/\s+/,ke,/\s*:/))),end:/:/,
relevance:0,contains:[{className:"keyword",match:/\b_\b/},{className:"params",
match:ke}]},...a,...c,..._,f,v,...x,S,C],endsParent:!0,illegal:/["']/},D={
...
className:"title",match:Se,endsParent:!0,relevance:0}]},B={
beginKeywords:"precedencegroup",end:e.MATCH_NOTHING_RE,contains:[{
className:"title",match:Te,relevance:0},{begin:/{/,end:/}/,relevance:0,
endsParent:!0,keywords:[...we,...ye],contains:[S]}]};for(const e of v.variants){
...
},...c,...d,..._,f,v,...M,...x,S,C]}},grmr_typescript:e=>{const n={$pattern:ge,
...
aliases:["yml"],contains:l}}});const Le=Y;for(const e of Object.keys(Ie)){
const n=e.replace("grmr_","");Le.registerLanguage(n,Ie[e])}return Le}()
