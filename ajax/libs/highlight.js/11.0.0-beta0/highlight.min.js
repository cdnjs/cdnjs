...
}),Object.freeze(n),Object.getOwnPropertyNames(n).forEach((t=>{var a=n[t]
;"object"!=typeof a||Object.isFrozen(a)||e(a)})),n}var n=e,t=e;n.default=t
;class a{constructor(e){
...
const h="[a-zA-Z]\\w*",E="[a-zA-Z_]\\w*",N="\\b\\d+(\\.\\d+)?",y="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",w="\\b(0b[01]+)",v={
...
;function F(e,n,t="keyword"){const a={}
...
;var Y=(e=>{const t=Object.create(null),i=Object.create(null),s=[];let r=!0
;const o="Could not find the language '{}', did you forget to load/include a language module?",l={
disableAutodetect:!0,name:"Plain text",contains:[]};let d={
ignoreUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,
languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",
languages:null,__emitter:c};function g(e){return d.noHighlightRe.test(e)}
function u(e,n,t,a){let i="",s=""
;"object"==typeof n?(i=e,t=n.ignoreIllegals,s=n.language,
a=void 0):(q("10.7.0","highlight(lang, code, ...args) has been deprecated."),
q("10.7.0","Please use highlight(code, options) instead.\nhttps://github.com/highlightjs/highlight.js/issues/2277"),
s=e,i=n);const r={code:i,language:s};y("before:highlight",r)
;const o=r.result?r.result:b(r.language,r.code,t,a)
;return o.code=r.code,y("after:highlight",o),o}function b(e,n,i,s){
function l(e,n){const t=w.case_insensitive?n[0].toLowerCase():n[0]
;return Object.prototype.hasOwnProperty.call(e.keywords,t)&&e.keywords[t]}
function c(){if(!M.keywords)return void S.addText(A);let e=0
;M.keywordPatternRe.lastIndex=0;let n=M.keywordPatternRe.exec(A),t="";for(;n;){
t+=A.substring(e,n.index);const a=l(M,n);if(a){const[e,i]=a
;if(S.addText(t),t="",k+=i,e.startsWith("_"))t+=n[0];else{
const t=w.classNameAliases[e]||e;S.addKeyword(n[0],t)}}else t+=n[0]
;e=M.keywordPatternRe.lastIndex,n=M.keywordPatternRe.exec(A)}
t+=A.substr(e),S.addText(t)}function g(){null!=M.subLanguage?(()=>{
if(""===A)return;let e=null;if("string"==typeof M.subLanguage){
if(!t[M.subLanguage])return void S.addText(A)
...
const t=e[0],a=n.substr(e.index),i=_(M,e,a);if(!i)return J;const s=M
;M.endScope&&M.endScope._wrap?(g(),
S.addKeyword(t,M.endScope._wrap)):M.endScope&&M.endScope._multi?(g(),
u(M.endScope,e)):s.skip?A+=t:(s.returnEnd||s.excludeEnd||(A+=t),
g(),s.excludeEnd&&(A=t));do{
M.scope&&!M.isMultiClass&&S.closeNode(),M.skip||M.subLanguage||(k+=M.relevance),
M=M.parent}while(M!==i.parent)
;return i.starts&&p(i.starts,e),s.returnEnd?0:t.length}let N={};function y(t,s){
const o=s&&s[0];if(A+=t,null==o)return g(),0
;if("begin"===N.type&&"end"===s.type&&N.index===s.index&&""===o){
if(A+=n.slice(s.index,s.index+1),!r){const n=Error(`0 width match regex (${e})`)
...
;return A+=o,o.length}const w=h(e)
...
;const e=M.matcher.exec(n);if(!e)break;const t=y(n.substring(C,e.index),e)
;C=e.index+t}return y(n.substr(C)),S.closeAllNodes(),S.finalize(),O=S.toHTML(),{
language:e,value:O,relevance:k,illegal:!1,_emitter:S,_top:M}}catch(t){
...
context:n.slice(C-100,C+100),mode:t.mode,resultSoFar:O},_emitter:S};if(r)return{
language:e,value:X(n),illegal:!1,relevance:0,errorRaised:t,_emitter:S,_top:M}
;throw t}}function m(e,n){n=n||d.languages||Object.keys(t);const a=(e=>{
const n={value:X(e),illegal:!1,relevance:0,_top:l,_emitter:new d.__emitter(d)}
;return n._emitter.addText(e),n})(e),i=n.filter(h).filter(N).map((n=>b(n,e,!1)))
...
}):m(a);y("after:highlightElement",{el:e,result:s,text:a
...
;function f(){
"loading"!==document.readyState?document.querySelectorAll("pre code").forEach(p):_=!0
}function h(e){return e=(e||"").toLowerCase(),t[e]||t[i[e]]}
function E(e,{languageName:n}){"string"==typeof e&&(e=[e]),e.forEach((e=>{
i[e.toLowerCase()]=n}))}function N(e){const n=h(e)
...
},registerLanguage:(n,a)=>{let i=null;try{i=a(e)}catch(e){
if(P("Language definition for '{}' could not be registered.".replace("{}",n)),
!r)throw e;P(e),i=l}
i.name||(i.name=n),t[n]=i,i.rawDefinition=a.bind(null,e),i.aliases&&E(i.aliases,{
languageName:n})},unregisterLanguage:e=>{delete t[e]
;for(const n of Object.keys(i))i[n]===e&&delete i[n]},
listLanguages:()=>Object.keys(t),getLanguage:h,registerAliases:E,
...
}),e.debugMode=()=>{r=!1},e.safeMode=()=>{r=!0},e.versionString="11.0.0-beta0"
;for(const e in C)"object"==typeof C[e]&&n(C[e]);return Object.assign(e,C),e
...
label:"func.def",contains:[f],illegal:/%/},y={
...
contains:[f]},y,{relevance:0,match:/\b[A-Z][A-Z_]+\b/,
...
className:"meta-string",begin:/<.*?>/},n,e.C_BLOCK_COMMENT_MODE]},l={
...
end:/\)/,contains:[e.inherit(s,{className:"meta-string"})]}]
...
end:"\\)",contains:d},{begin:"!important"}]},_={
...
grmr_xml:e=>{const n=b(/[A-Z_]/,u(/[A-Z0-9_.-]*:/),/[A-Z0-9_.-]*/),t={
className:"symbol",begin:/&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/},a={begin:/\s/,
contains:[{className:"meta-keyword",begin:/#?[a-z_][a-z1-9_-]+/,illegal:/\n/}]
},i=e.inherit(a,{begin:/\(/,end:/\)/}),s=e.inherit(e.APOS_STRING_MODE,{
className:"meta-string"}),r=e.inherit(e.QUOTE_STRING_MODE,{
className:"meta-string"}),o={endsWithParent:!0,illegal:/</,relevance:0,
contains:[{className:"attr",begin:/[A-Za-z0-9._:-]+/,relevance:0},{begin:/=\s*/,
relevance:0,contains:[{className:"string",endsParent:!0,variants:[{begin:/"/,
end:/"/,contains:[t]},{begin:/'/,end:/'/,contains:[t]},{begin:/[^\s"'=<>`]+/}]}]
...
className:"class",begin:"("+t.keyword.join("|")+")\\b",end:/(\{|$)/,
excludeEnd:!0,keywords:t,contains:[e.UNDERSCORE_TITLE_MODE]},{
begin:"\\."+e.UNDERSCORE_IDENT_RE,relevance:0}]}},grmr_perl:e=>{
const n=/[dualxmsipngr]{0,12}/,t={$pattern:/[\w.]+/,
...
relevance:0},s,c,e.HASH_COMMENT_MODE,{variants:[{className:"function",
beginKeywords:"def"},{className:"class",beginKeywords:"class"}],end:/:/,
illegal:/[${=;\n,]/,contains:[e.UNDERSCORE_TITLE_MODE,d,{begin:/->/,
endsWithParent:!0,keywords:n}]},{className:"meta",begin:/^[\t ]*@/,
end:/(?=#)|$/,contains:[l,d,s]}]}},grmr_python_repl:e=>({aliases:["pycon"],
...
end:b(/"""/,e),contains:[h(e),E(e),N(e)]}),w=(e="")=>({begin:b(e,/"/),
end:b(/"/,e),contains:[h(e),N(e)]}),v={className:"string",
...
},...a,...c,...p,f,v,...x,S,k],endsParent:!0,illegal:/["']/},R={
...
},...c,...d,...p,f,v,...M,...x,S,k]}},grmr_typescript:e=>{const n={$pattern:ge,
