hljs.registerLanguage("fsharp",(()=>{"use strict";function e(e){
...
"variable.constant":["__LINE__","__SOURCE_DIRECTORY__","__SOURCE_FILE__"]},o={
variants:[e.COMMENT(/\(\*(?!\))/,/\*\)/,{contains:["self"]
}),e.C_LINE_COMMENT_MODE]},r={match:t(/('|\^)/,e.UNDERSCORE_IDENT_RE),
...
};return d.contains=[b,g,p,u,_,a,o,c,l,f,r],{name:"F#",aliases:["fs","f#"],
...
},p,u,_]},o,{begin:[/type/,/\s+/,e.UNDERSCORE_IDENT_RE],beginScope:{1:"keyword",
3:"title.class"},end:n(/\(|=|$/),contains:[r]},{scope:"meta",begin:/^\s*\[</,
