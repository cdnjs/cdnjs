hljs.registerLanguage("wren",(()=>{"use strict";return e=>{
const a=e.regex,s=/[a-zA-Z]\w*/,t=["as","break","class","construct","continue","else","for","foreign","if","import","in","is","return","static","var","while"],c=["true","false","null"],n=["this","super"],i=["-","~",/\*/,"%",/\.\.\./,/\.\./,/\+/,"<<",">>",">=","<=","<",">",/\^/,/!=/,/!/,/\bis\b/,"==","&&","&",/\|\|/,/\|/,/\?:/,"="],r={
relevance:0,match:a.concat(/\b(?!(if|while|for|else|super)\b)/,s,/(?=\s*[({])/),
className:"title.function"},o={
match:a.concat(a.either(a.concat(/\b(?!(if|while|for|else|super)\b)/,s),a.either(...i)),/(?=\s*\([^)]+\)\s*\{)/),
...
match:a.either(...i),className:"operator"},b={className:"property",
...
begin:/%\(/,end:/\)/,contains:[u,p,r,h,m]},f={scope:"string",begin:/"/,end:/"/,
...
},d,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE,p,l,g,o,r,m,h,b,_]}}}))();