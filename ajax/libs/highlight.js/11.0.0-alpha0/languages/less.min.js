...
relevance:i}),u={$pattern:/[a-z-]+/,keyword:"and or not only",
attribute:t.join(" ")},p={begin:"\\(",end:"\\)",contains:g,keywords:u,
relevance:0}
...
className:"selector-pseudo",begin:"::("+n.join("|")+")"},{begin:"\\(",end:"\\)",
contains:h},{begin:"!important"}]},E={begin:`[\\w-]+:(:)?(${l.join("|")})`,
