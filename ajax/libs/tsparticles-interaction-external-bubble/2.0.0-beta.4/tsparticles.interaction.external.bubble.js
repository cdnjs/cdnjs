...
class Bubbler extends external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ExternalInteractorBase {
  constructor(container) {
    ...
    this.handleClickMode = mode => {
      if (mode !== external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.ClickMode.bubble) {
        return;
      }
  ...
  isEnabled() {
    const container = this.container,
          ...
          divs = events.onDiv,
          divBubble = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.isDivModeEnabled)(external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.DivMode.bubble, divs);
  ...
  hoverBubbleColor(particle, ratio, divBubble) {
    ...
    if (!particle.bubble.finalColor) {
      ...
      particle.bubble.finalColor = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToHsl)(bubbleColor);
    }
