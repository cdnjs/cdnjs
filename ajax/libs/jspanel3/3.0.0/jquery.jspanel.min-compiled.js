...
/* jquery.jspanel.js version 3.0.0 2016-06-12 14:50 */
...
var jsPanel = { version: "3.0.0", date: "2016-06-12 14:50", id: 0, ziBase: 100, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel"><div class="jsPanel-hdr"><div class="jsPanel-headerbar"><div class="jsPanel-titlebar"><h3 class="jsPanel-title"></h3></div><div class="jsPanel-controlbar"><div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div><div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div><div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div><div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div><div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div><div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div></div></div><div class="jsPanel-hdr-toolbar"></div></div><div class="jsPanel-content"></div><div class="jsPanel-ftr"></div></div>',
  replacementTemplate: '<div class="jsPanel-replacement"><div class="jsPanel-hdr"><div class="jsPanel-headerbar"><div class="jsPanel-titlebar"><h3 class="jsPanel-title"></h3></div><div class="jsPanel-controlbar"><div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div><div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div><div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div></div></div></div></div>',
  themes: "default primary info success warning danger".split(" "), tplHeaderOnly: '<div class="jsPanel"><div class="jsPanel-hdr"><div class="jsPanel-headerbar"><div class="jsPanel-titlebar"><h3 class="jsPanel-title"></h3></div><div class="jsPanel-controlbar"><div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div></div></div><div class="jsPanel-hdr-toolbar"></div></div></div>',
  tplContentOnly: '<div class="jsPanel"><div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div></div>', activePanels: { list: [], getPanel: function getPanel(b) {
      ...
      if ("normalized" === a.data("status") || "maximized" === a.data("status")) {
        ...
        b(document).trigger("jspanelbeforeunsmallify", d);if (b.isFunction(a.option.onbeforeunsmallify) && !1 === a.option.onbeforeunsmallify.call(a, a)) return a;a.css("overflow", "visible");a.animate({ height: a.smallify.height }, { done: function done() {
            if ("smallified" === a.data("status")) {
              if (a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"), a.data("status", "normalized"), b(document).trigger("jspanelnormalized", d), b.isFunction(a.option.onnormalized) && !1 === a.option.onnormalized.call(a, a)) return a;
            } else if (a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev"), a.data("status", "maximized"), b(document).trigger("jspanelmaximized", d), b.isFunction(a.option.onmaximized) && !1 === a.option.onmaximized.call(a, a)) return a;b(document).trigger("jspanelunsmallified", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onunsmallified) && a.option.onunsmallified.call(a, a);
          } });
