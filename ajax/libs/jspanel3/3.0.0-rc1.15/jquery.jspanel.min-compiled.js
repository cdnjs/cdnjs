...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(b) {
    if (void 0 === b || null === b) throw new TypeError("Cannot convert first argument to object");for (var c = Object(b), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), a = Object.keys(Object(e)), f = 0, n = a.length; f < n; f++) {
        var p = a[f],
            l = Object.getOwnPropertyDescriptor(e, p);void 0 !== l && l.enumerable && (c[p] = e[p]);
      }
    }return c;
  } });
Array.prototype.find || (Array.prototype.find = function (b, c) {
  if (null == this) throw new TypeError("Array.prototype.find called on null or undefined");if ("function" !== typeof b) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, a, f = 0; f < e; f++) {
    if (a = d[f], b.call(c, a, f, d)) return a;
  }
});
Array.prototype.findIndex || (Array.prototype.findIndex = function (b, c) {
  if (null === this) throw new TypeError("Array.prototype.findIndex called on null or undefined");if ("function" !== typeof b) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, a, f = 0; f < e; f++) {
    if (a = d[f], b.call(c, a, f, d)) return f;
  }return -1;
});
Array.prototype.includes || (Array.prototype.includes = function (b, c) {
  var d = Object(this),
      e = parseInt(d.length) || 0;if (0 === e) return !1;var a = parseInt(c) || 0;0 <= a || (a = e + a, 0 > a && (a = 0));for (var f; a < e;) {
    f = d[a];if (b === f || b !== b && f !== f) return !0;a++;
  }return !1;
...
var jsPanel = { version: "3.0.0 RC1.15", date: "2016-05-26 10:55", id: 0, ziBase: 100, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>', replacementTemplate: '<div class="jsPanel-replacement">\n                            <div class="jsPanel-hdr">\n                                <div class="jsPanel-headerbar">\n                                    <div class="jsPanel-titlebar">\n                                        <h3 class="jsPanel-title"></h3>\n                                    </div>\n                                    <div class="jsPanel-controlbar">\n                                        <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                                        <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                                    </div>\n                                </div>\n                            </div>\n                          </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(b) {
    ...
    function d(a, b) {
      ...
      var b = {},
          c = p(g.of);u.includes(a) ? b.left = c.left : v.includes(a) ? b.left = c.left + c.width / 2 : w.includes(a) ? b.left = c.left + c.width : b.left = c.left;x.includes(a) ? b.top = c.top : y.includes(a) ? b.top = c.top + c.height / 2 : z.includes(a) ? b.top = c.top + c.height : b.top = c.top;return b;
    }function f(a) {
      var b = {},
          c = h.getBoundingClientRect();u.includes(a) ? b.left = 0 : v.includes(a) ? b.left = c.width / 2 : w.includes(a) ? b.left = c.width : b.left = 0;x.includes(a) ? b.top = 0 : y.includes(a) ? b.top = c.height / 2 : z.includes(a) ? b.top = c.height : b.top = 0;return b;
    }function n(a) {
      var b = {},
          c = h.getBoundingClientRect(),
          d = document.querySelector(g.of).getBoundingClientRect(),
          k = d.left - c.left,
          c = d.top - c.top;u.includes(a) ? b.left = k : v.includes(a) ? b.left = k + d.width / 2 : w.includes(a) ? b.left = k + d.width : b.left = k;x.includes(a) ? b.top = c : y.includes(a) ? b.top = c + d.height / 2 : z.includes(a) ? b.top = c + d.height : b.top = c;return b;
    }function p(a) {
      ...
      l = c.match(/\b[a-z]{4,6}-{1}[a-z]{3,6}\b/);k = c.match(/DOWN|UP|RIGHT|LEFT/);var q = c.match(/[+-]?\d+\.?\d*%?/g);c = $.isArray(l) ? { my: l[0], at: l[0] } : { my: "center", at: "center" };$.isArray(k) && (c.autoposition = k[0]);$.isArray(q) && (c.offsetX = q[0], 2 === q.length && (c.offsetY = q[1]));
    }g = Object.assign({ my: "center", at: "center",
      offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);l = "string" === typeof b ? document.querySelector(b) : b.jquery ? b[0] : b;h = l.parentElement;g.of || (h === document.body ? g.of = "window" : g.of = h);k = p(l);"string" === typeof g.offsetX && "%" === g.offsetX.slice(-1) ? g.offsetX = "window" === g.of ? window.innerWidth * (parseInt(g.offsetX, 10) / 100) : h.clientWidth * (parseInt(g.offsetX, 10) / 100) : "string" === typeof g.offsetX ? g.offsetX = parseFloat(g.offsetX) : $.isFunction(g.offsetX) && (g.offsetX = parseInt(g.offsetX.call(b, b)));"string" === typeof g.offsetY && "%" === g.offsetY.slice(-1) ? g.offsetY = "window" === g.of ? window.innerHeight * (parseInt(g.offsetY, 10) / 100) : h.clientHeight * (parseInt(g.offsetY, 10) / 100) : "string" === typeof g.offsetY ? g.offsetY = parseFloat(g.offsetY) : $.isFunction(g.offsetY) && (g.offsetY = parseInt(g.offsetY.call(b, b)));q = parseInt(d(h, "border-left-width"));u.includes(g.my) ? r = q : v.includes(g.my) ? r = k.width / 2 + q : w.includes(g.my) && (r = k.width + q);q = parseInt(d(h, "border-top-width"));x.includes(g.my) ? t = q : y.includes(g.my) ? t = k.height / 2 + q : z.includes(g.my) && (t = k.height + q);l.parentElement === document.body ? "window" === g.of ? (k = e(g.at), g.fixed ? (r = k.left - r + g.offsetX - window.pageXOffset, t = k.top - t + g.offsetY - window.pageYOffset) : (r = k.left - r + g.offsetX, t = k.top - t + g.offsetY)) : (k = a(g.at), r = k.left - r + g.offsetX, t = k.top - t + g.offsetY) : (k = "string" === typeof g.of ? document.querySelector(g.of) : g.of.jquery ? g.of[0] : g.of, k = h === k ? f(g.at) : n(g.at), r = k.left - r + g.offsetX, t = k.top - t + g.offsetY);if (g.autoposition) {
      k = [];q = this.autopositionSpacing;g.my === g.at && (m = g.my);l.setAttribute("data-autoposition", g.autoposition);$.isFunction(g.offsetX) || l.setAttribute("data-offsetx", g.offsetX);$.isFunction(g.offsetY) || l.setAttribute("data-offsety", g.offsetY);l.classList.add(m);m = document.getElementsByClassName(m);for (var A = 0; A < m.length; A++) {
        m[A].parentElement === h && k.push(m[A]);
      }if ("DOWN" === g.autoposition) for (m = 0; m < k.length - 1; m++) {
        t += k[m].getBoundingClientRect().height + q;
      } else if ("UP" === g.autoposition) for (m = 0; m < k.length - 1; m++) {
        t -= k[m].getBoundingClientRect().height + q;
      } else if ("RIGHT" === g.autoposition) for (m = 0; m < k.length - 1; m++) {
        r += k[m].getBoundingClientRect().width + q;
      } else if ("LEFT" === g.autoposition) for (m = 0; m < k.length - 1; m++) {
        r -= k[m].getBoundingClientRect().width + q;
      }
    }m = { left: r, top: t };"function" === typeof g.modify && (m = g.modify.call(m, m));l.style.position = "absolute";l.style.left = m.left + "px";l.style.top = m.top + "px";l.style.opacity = 1;"window" === g.of && g.fixed && h === document.body && (l.style.position = "fixed");return l;
    ...
    if (0 === c) d = c = b = d;else {
      var e = function e(a, b, c) {
        0 > c && (c += 1);1 < c && --c;return c < 1 / 6 ? a + 6 * (b - a) * c : .5 > c ? b : c < 2 / 3 ? a + (b - a) * (2 / 3 - c) * 6 : a;
          ...
          a = .5 > d ? d * (1 + c) : d + c - d * c,
          f = 2 * d - a;d = e(f, a, b + 1 / 3);c = e(f, a, b);b = e(f, a, b - 1 / 3);
    ...
    b /= 255;c /= 255;d /= 255;var e = Math.max(b, c, d),
        a = Math.min(b, c, d),
        f,
        n = (e + a) / 2;if (e === a) f = a = 0;else {
      var p = e - a,
          a = .5 < n ? p / (2 - e - a) : p / (e + a);switch (e) {case b:
          f = (c - d) / p + (c < d ? 6 : 0);break;case c:
          f = (d - b) / p + 2;break;case d:
          f = (b - c) / p + 4;}f /= 6;
    }f *= 360;a = 100 * a + "%";n = 100 * n + "%";return { css: "hsl(" + f + "," + a + "," + n + ")", h: f, s: a, l: n };
    ...
    var c = this.color(b),
        ...
        a,
        f,
        n;this.perceivedBrightness(b) <= this.pbTreshold ? a = "#ffffff" : a = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? f = "#ffffff" : f = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? n = "#000000" : n = "#ffffff";return [c.hsl.css, d, e, a, f, n];
    ...
    function c(a) {
      if (a.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== b.footer.css("display") ? p : 0 < parseFloat(b.option.contentSize.height) ? n : l;
    }function d(a) {
      if (a.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!b.option.headerRemove) return l;if (0 < parseFloat(b.option.contentSize.height)) return n;if ("none" !== b.footer.css("display")) return p;
      }
    }function e(a) {
      if (a.match(/lefttop|righttop/)) return b.option.headerRemove ? n : l;
    }function a(a) {
      if (a.match(/left|right/)) {
        if (0 < parseFloat(b.option.contentSize.height)) return n;if (!b.option.headerRemove) return l;if ("none" !== b.footer.css("display")) return p;
      }
    }var f = b.option.paneltype.connectorBG || null,
        n = b.content.css("background-color"),
        p = b.footer.css("background-color"),
        l = b.css("background-color");b.hasClass("jsPanel-tooltip-top") ? (b.append("<div class='jsPanel-connector jsPanel-connector-top'>"), $(".jsPanel-connector-top", b).css("border-top-color", f || c("top")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-bottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-bottom'>"), $(".jsPanel-connector-bottom", b).css("border-bottom-color", f || d("bottom")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10) : b.hasClass("jsPanel-tooltip-left") ? (b.append("<div class='jsPanel-connector jsPanel-connector-left'>"), $(".jsPanel-connector-left", b).css("border-left-color", f || a("left")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-right") ? (b.append("<div class='jsPanel-connector jsPanel-connector-right'>"), $(".jsPanel-connector-right", b).css("border-right-color", f || a("right")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-lefttopcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-lefttopcorner'>"), $(".jsPanel-connector-lefttopcorner", b).css("background-color", f || c("lefttopcorner"))) : b.hasClass("jsPanel-tooltip-righttopcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-righttopcorner'>"), $(".jsPanel-connector-righttopcorner", b).css("background-color", f || c("righttopcorner"))) : b.hasClass("jsPanel-tooltip-rightbottomcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-rightbottomcorner'>"), $(".jsPanel-connector-rightbottomcorner", b).css("background-color", f || d("rightbottomcorner"))) : b.hasClass("jsPanel-tooltip-leftbottomcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-leftbottomcorner'>"), $(".jsPanel-connector-leftbottomcorner", b).css("background-color", f || d("leftbottomcorner"))) : b.hasClass("jsPanel-tooltip-lefttop") ? (b.append("<div class='jsPanel-connector jsPanel-connector-lefttop'>"), $(".jsPanel-connector-lefttop", b).css("border-left-color", f || e("lefttop")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-leftbottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-leftbottom'>"), $(".jsPanel-connector-leftbottom", b).css("border-left-color", f || c("leftbottom")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-topleft") ? (b.append("<div class='jsPanel-connector jsPanel-connector-topleft'>"), $(".jsPanel-connector-topleft", b).css("border-top-color", f || c("topleft")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-topright") ? (b.append("<div class='jsPanel-connector jsPanel-connector-topright'>"), $(".jsPanel-connector-topright", b).css("border-top-color", f || c("topright")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-righttop") ? (b.append("<div class='jsPanel-connector jsPanel-connector-righttop'>"), $(".jsPanel-connector-righttop", b).css("border-right-color", f || e("righttop")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-rightbottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-rightbottom'>"), $(".jsPanel-connector-rightbottom", b).css("border-right-color", f || c("rightbottom")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-bottomleft") ? (b.append("<div class='jsPanel-connector jsPanel-connector-bottomleft'>"), $(".jsPanel-connector-bottomleft", b).css("border-bottom-color", f || d("bottomleft")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10) : b.hasClass("jsPanel-tooltip-bottomright") && (b.append("<div class='jsPanel-connector jsPanel-connector-bottomright'>"), $(".jsPanel-connector-bottomright", b).css("border-bottom-color", f || d("bottomright")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10);
    ...
    var c = "close maximize normalize minimize smallify smallifyrev".split(" "),
        ...
        f = b.header.headerbar;"bootstrap" === a || "glyphicon" === a ? (c.forEach(function (a, b) {
      $(".jsPanel-btn-" + a + " span", f).removeClass().addClass("glyphicon glyphicon-" + d[b]);
    }), $(".jsPanel-headerbar .jsPanel-btn", b).css("padding-top", "4px")) : "font-awesome" === a && c.forEach(function (a, b) {
      $(".jsPanel-btn-" + a + " span", f).removeClass().addClass("fa fa-" + e[b]);
    });
  ...
  }, exportPanels: function exportPanels(b) {
    b = void 0 === b ? ".jsPanel" : b;var c,
        d,
        e,
        a,
        f,
        ...
        p,
        l = [],
        k;b = $(".jsPanel").not(".jsPanel-tooltip, .jsPanel-hint, .jsPanel-modal").filter(b);b.each(function (a, b) {
      "normalized" !== $(b).data("status") && $(".jsPanel-btn-normalize", b).trigger("click");
    });
    b.each(function (b, h) {
      p = $(h).data("container");c = $(h).offset();d = $(h).position();"body" === p.toLowerCase() ? (e = Math.floor(c.top - $(window).scrollTop()), a = Math.floor(c.left - $(window).scrollLeft())) : (e = Math.floor(d.top), a = Math.floor(d.left));f = $(h).css("width");n = $(".jsPanel-content", h).css("height");k = { status: $(h).data("status"), id: $(h).prop("id"), headerTitle: $(".jsPanel-title", h).html(), custom: $(h).data("custom"), content: $(h).data("content"), contentSize: { width: f, height: n }, position: { my: "left-top", at: "left-top",
          offsetX: a, offsetY: e } };$(h).data("ajaxURL") && (k.contentAjax = { url: $(h).data("ajaxURL"), autoload: !0 });if ($(h).data("iframeDOC") || $(h).data("iframeSRC")) k.contentIframe = { src: $(h).data("iframeSRC") || "", srcdoc: $(h).data("iframeDOC") || "" };l.push(k);switch (k.status) {case "minimized":
          $(".jsPanel-btn-minimize", h).trigger("click");break;case "maximized":
          $(".jsPanel-btn-maximize", h).trigger("click");break;case "smallified":
          $(".jsPanel-btn-smallify", h).trigger("click");break;case "smallifiedMax":
          $(".jsPanel-btn-smallify", h).trigger("click");}
    });window.localStorage.setItem("jspanels", JSON.stringify(l));return l;
  }, importPanels: function importPanels(b) {
    var c = JSON.parse(localStorage.jspanels) || {},
        d = b["default"] || {},
        e;c.forEach(function (a) {
      e = "string" === typeof a.custom.config ? $.extend(!0, {}, d, b[a.custom.config], a) : $.extend(!0, {}, d, a);$.jsPanel(e);
    });
  ...
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
      ...
      b(document).trigger("jspanelbeforeclose", d);if (b.isFunction(a.option.onbeforeclose) && !1 === a.option.onbeforeclose.call(a, a)) return a;var c = a.option.position;if (c.autoposition || "string" === typeof c && c.match(/DOWN|RIGHT|UP|LEFT/)) {
        ...
        g && (jsPanel.lastbeforeclose = { parent: c, "class": g[0] });
      }a.closeChildpanels().remove();c = jsPanel.activePanels.list.findIndex(function (a) {
        return a === d;
      });-1 < c && jsPanel.activePanels.list.splice(c, 1);b("#" + d + "-min").remove();"modal" === a.option.paneltype && b("#jsPanel-modal-backdrop-" + a.attr("id")).remove();a.option.paneltype.tooltip && b(f).removeClass("hasTooltip");b(document).trigger("jspanelclosed", d);b(document).trigger("jspanelstatuschange", d);var e, l;jsPanel.lastbeforeclose && (e = jsPanel.lastbeforeclose.parent, e = b("." + jsPanel.lastbeforeclose["class"], e), l = jsPanel.lastbeforeclose["class"]);e && (e.each(function (a, c) {
        b(c).removeClass(l);
      }), e.each(function (a, b) {
        var c = b.getAttribute("data-autoposition"),
            d = b.getAttribute("data-offsetx"),
            k = b.getAttribute("data-offsety");jsPanel.position(b, { my: l, at: l, autoposition: c, offsetX: d, offsetY: k });
      ...
      c.length ? (b(".jsPanel-minimized-box").length || b(c[0]).append("<div class='jsPanel-minimized-box'>"), b(".jsPanel-minimized-box").append(h)) : b("#jsPanel-replacement-container").append(h);b(document).trigger("jspanelminimized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onminimized) && a.option.onminimized.call(a, a);b(".jsPanel-btn-normalize", h).css("display", "block").click(function () {
        a.css("left", h.left);h.remove();b(".jsPanel-btn-normalize", a).trigger("click");
      });"disabled" === a[0].dataset.btnnormalize ? b(".jsPanel-btn-normalize", h).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === a[0].dataset.btnnormalize && b(".jsPanel-btn-normalize", h).remove();b(".jsPanel-btn-maximize", h).click(function () {
        a.css("left", h.left);h.remove();b(".jsPanel-btn-maximize", a).trigger("click");
      });"disabled" === a[0].dataset.btnmaximize ? b(".jsPanel-btn-maximize", h).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === a[0].dataset.btnmaximize && b(".jsPanel-btn-maximize", h).remove();b(".jsPanel-btn-close", h).click(function () {
        h.remove();a.close();
      });"disabled" === a[0].dataset.btnclose && b(".jsPanel-btn-close", h).css({ pointerEvents: "none", opacity: .5, cursor: "default" });return a;
      ...
      c = void 0 === c ? a.option.theme.toLowerCase().replace(/ /g, "") : c;c = c.toLowerCase().replace(/ /g, "");var e = [],
          ...
          l,
          m,
          n;jsPanel.themes.forEach(function (b, c, d) {
        a.removeClass("panel card card-inverse jsPanel-theme-" + b + "  panel-" + b + " card-" + b);
      });a.header.removeClass("panel-heading").title.removeClass("panel-title");a.content.removeClass("panel-body").css("border-top-color", "");a.footer.removeClass("panel-footer card-footer");a.css("background", "").content.css({ borderTop: "", backgroundColor: "", color: "" });a.css({ borderWidth: "", borderStyle: "", borderColor: "" });b(".jsPanel-hdr *", a).css({ color: "" });a.header.toolbar.css({ boxShadow: "", width: "", marginLeft: "" });c.endsWith("filled") ? (e[1] = "filled", e[0] = c.substr(0, c.length - 6)) : c.endsWith("filledlight") ? (e[1] = "filledlight", e[0] = c.substr(0, c.length - 11)) : (e[1] = "", e[0] = c);e[0].match("-") && (f = e[0].split("-"), l = !0);l ? (a.addClass("panel panel-" + f[1]).addClass("card card-inverse card-" + f[1]).header.addClass("panel-heading").title.addClass("panel-title"), a.content.addClass("panel-body").css("border-top-color", function () {
        return a.header.css("border-top-color");
      }), a.footer.addClass("panel-footer card-footer"), n = "transparent" === b(".panel-heading", a).css("background-color") ? a.css("background-color").replace(/\s+/g, "") : b(".panel-heading", a).css("background-color").replace(/\s+/g, ""), f = jsPanel.calcColors(n), b("*", a.header).css("color", f[3]), a.option.headerToolbar ? a.header.toolbar.css({ boxShadow: "0 0 1px " + f[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : a.content.css({ borderTop: "1px solid " + f[3] }), "filled" === e[1] ? a.content.css({ backgroundColor: n, color: f[3] }) : "filledlight" === e[1] && a.content.css({ backgroundColor: f[1], color: "#000000" })) : jsPanel.themes.includes(e[0]) ? (a.addClass("jsPanel-theme-" + e[0]), "filled" === e[1] ? a.content.css("background", "").addClass("jsPanel-content-filled") : "filledlight" === e[1] && a.content.css("background", "").addClass("jsPanel-content-filledlight"), a.option.headerToolbar || a.content.css({ borderTop: "1px solid " + a.header.title.css("color") })) : (m = jsPanel.calcColors(e[0]), a.css("background-color", m[0]), b(".jsPanel-hdr *", a).css({ color: m[3] }), a.option.headerToolbar ? a.header.toolbar.css({ boxShadow: "0 0 1px " + m[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : a.content.css({ borderTop: "1px solid " + m[3] }), "filled" === e[1] ? a.content.css({ "background-color": m[0], color: m[3] }) : "filledlight" === e[1] && a.content.css({ "background-color": m[1] }));a.option.border ? (f = a.option.border.split(" "), a.css({ "border-width": f[0], "border-style": f[1] }), l ? a.css("border-color", n) : jsPanel.themes.includes(e[0]) || a.css("border-color", m[0])) : a.css({ borderWidth: "", borderStyle: "", borderColor: "" });d && b.isFunction(d) && d.call(a, a);return a;
