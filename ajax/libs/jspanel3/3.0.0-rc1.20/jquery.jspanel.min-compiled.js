...
(function (b) {
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
      ...
      });"disabled" === a[0].dataset.btnmaximize ? b(".jsPanel-btn-maximize", e).css({ pointerEvents: "none", opacity: .5,
        cursor: "default" }) : "removed" === a[0].dataset.btnmaximize && b(".jsPanel-btn-maximize", e).remove();b(".jsPanel-btn-close", e).click(function () {
        e.remove();a.close();
    ...
    });a.appendTo(a.option.container);
    jsPanel.activePanels.list.push(d);b(document).trigger("jspanelloaded", d);a.data("container", a.option.container);a.setTheme();a.option.headerRemove ? (a.header.remove(), a.content.addClass("jsPanel-content-noheader"), ["close", "maximize", "minimize", "normalize", "smallify"].forEach(function (b) {
    ...
    a.css({ width: function width() {
    ...
    }"string" === typeof a.option.contentOverflow ? a.content.css("overflow", a.option.contentOverflow) : b.isPlainObject(a.option.contentOverflow) && a.content.css({ "overflow-y": a.option.contentOverflow.vertical || a.option.contentOverflow["overflow-y"],
      ...
      var d = b(c.target).closest(".jsPanel").css("z-index");!a.hasClass("jsPanel-modal") && d <= jsPanel.zi && a.front(c.target);
    }, !1);jsPanel.updateCachedData(a);"string" === typeof a.option.setstatus && ("maximize smallify" === a.option.setstatus ? a.maximize().smallify() : a[a.option.setstatus]());
    "number" === typeof a.option.autoclose && 0 < a.option.autoclose && window.setTimeout(function () {
      a && a.close();
  ...
  };b.jsPanel.defaults = { autoclose: !1, border: !1, callback: !1, container: "body", content: !1, contentAjax: !1, contentIframe: !1, contentOverflow: "hidden", contentSize: { width: 400, height: 200 }, custom: !1, dblclicks: !1, draggable: { handle: "div.jsPanel-hdr, div.jsPanel-ftr", opacity: .8 }, footerToolbar: !1,
    headerControls: { close: !1, maximize: !1, minimize: !1, normalize: !1, smallify: !1, controls: "all", iconfont: "jsglyph" }, headerRemove: !1, headerTitle: "jsPanel", headerToolbar: !1, id: function id() {
      return "jsPanel-" + (jsPanel.id += 1);
    }, load: !1, maximizedMargin: { top: 5, right: 5, bottom: 5, left: 5 }, onbeforeclose: !1, onbeforemaximize: !1, onbeforeminimize: !1, onbeforenormalize: !1, onclosed: !1, onmaximized: !1, onminimized: !1, onnormalized: !1, onbeforeresize: !1, onresized: !1, onsmallified: !1, onunsmallified: !1, onfronted: !1, paneltype: !1, position: { my: "center",
