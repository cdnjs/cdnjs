...
$(".jsPanel-hdr, .jsPanel-content",a).css({background:""});$(".jsPanel-headerlogo, .jsPanel-title, .jsPanel-controlbar .jsPanel-btn .jsglyph, .jsPanel-hdr-toolbar, .jsPanel-content",a).css({color:""});a.header.title.removeClass("panel-title");a.header.toolbar.css({boxShadow:"",width:"",marginLeft:""});a.content.removeClass("panel-body").css({borderTop:"",borderTopColor:""});a.footer.removeClass("panel-footer card-footer")},close:function(a){function b(a){for(var b=arguments.length,d=Array(1<b?b-1:
0),c=1;c<b;c++)d[c-1]=arguments[c];d=l;b=a.option.position;if(b.autoposition||"string"===typeof b&&b.match(/DOWN|RIGHT|UP|LEFT/))if(b=$(a).parent(),c=document.getElementById(f).className.match(/left-top|center-top|right-top|left-center|center|right-center|left-bottom|center-bottom|right-bottom/))jsPanel.lastbeforeclose={parent:b,"class":c[0]};a.closeChildpanels().remove();$("#"+f).length||function(){var b=jsPanel.activePanels.list.findIndex(function(a){return a===f});-1<b&&jsPanel.activePanels.list.splice(b,
1);jsPanel.remMinReplacement(a);"modal"===a.option.paneltype&&jsPanel.removeModalBackdrop(a);a.option.paneltype.tooltip&&$(h).removeClass("hasTooltip");$(document).trigger("jspanelclosed",f);$(document).trigger("jspanelstatuschange",f);var c=b=b=void 0;jsPanel.lastbeforeclose&&(b=jsPanel.lastbeforeclose.parent,b=$("."+jsPanel.lastbeforeclose["class"],b),c=jsPanel.lastbeforeclose["class"]);b&&(b.each(function(a,b){$(b).removeClass(c)}),b.each(function(b,d){jsPanel.position(d,a.option.position)}));
jsPanel.lastbeforeclose=!1;!0===d[2]?$.noop():$.isFunction(a.option.onclosed)&&a.option.onclosed.call(a,a);d[0]&&$.isFunction(d[0])&&d[0].call(a,a);jsPanel.resetZis()}()}for(var c=arguments.length,e=Array(1<c?c-1:0),d=1;d<c;d++)e[d-1]=arguments[d];var f=a.attr("id"),h=this.setTrigger(a.option.position),c=a.option.delayClose,l=e;$(document).trigger("jspanelbeforeclose",f);if($.isFunction(a.option.onbeforeclose))if(!0===e[1])$.noop();else if(!1===a.option.onbeforeclose.call(a,a))return a;c?"number"===
typeof c&&0<c?window.setTimeout(function(){b(a,e[0],e[2])},c):b(a,e[0],e[2]):b(a,e[0],e[2])},closeChildpanels:function(a){$(".jsPanel",a).each(function(a,c){c.jspanel.close()});return a},closeTooltips:function(){$(".jsPanel-tooltip").each(function(a,b){b.jspanel&&b.jspanel.close()})},calcPositionFactors:function(a){"body"===a.option.container?(a.hf=parseInt(a.css("left"),10)/($(window).outerWidth()-a.outerWidth()),a.vf=parseInt(a.css("top"),10)/($(window).outerHeight()-a.outerHeight())):(a.hf=parseInt(a.css("left"),
10)/(a.parent().outerWidth()-a.outerWidth()),a.vf=parseInt(a.css("top"),10)/(a.parent().outerHeight()-a.outerHeight()))},color:function(a){var b=a.toLowerCase(),c,e,d;a={};c=/^rgba?\(([0-9]{1,3}),([0-9]{1,3}),([0-9]{1,3}),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;e=/^hsla?\(([0-9]{1,3}),([0-9]{1,3}\%),([0-9]{1,3}\%),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;d={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",
...
arguments[0]?arguments[0]:a.jsPanel.resizedefaults.width,c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:a.jsPanel.resizedefaults.height,e=2<arguments.length&&void 0!==arguments[2]?arguments[2]:a.jsPanel.resizedefaults.callback,f={},g=b;a.isPlainObject(g)||(f.width=b,f.height=c,f.callback=e,g=a.extend({},!1,a.jsPanel.resizedefaults,f));jsPanel.resize(d,g);return d};d.setTheme=function(){var b=0<arguments.length&&void 0!==arguments[0]?arguments[0]:I.toLowerCase().replace(/ /g,""),c=arguments[1],
b=b.toLowerCase().replace(/ /g,"");jsPanel.clearTheme(d);if("none"===I)return d.css("background-color","white"),d;b=jsPanel.getThemeDetails(b);b.bs?jsPanel.applyBootstrapTheme(d,b):jsPanel.themes.includes(b.color)?jsPanel.applyBuiltInTheme(d,b):jsPanel.applyArbitraryTheme(d,b);l?jsPanel.applyThemeBorder(d,b):d.css({borderWidth:"",borderStyle:"",borderColor:""});c&&a.isFunction(c)&&c.call(d,d);return d};d.smallify=function(a){return jsPanel.smallify(d,a)};d.toolbarAdd=function(a,b,c){return jsPanel.toolbarAdd(d,
a,b,c)};d.updateCachedData=function(){d.cachedData.top=d.css("top");d.cachedData.left=d.css("left");d.cachedData.width=d.css("width");d.cachedData.height=d.css("height")};a(".jsPanel-btn-close",d).on("click",function(a){a.preventDefault();jsPanel.close(d)});a(".jsPanel-btn-minimize",d).on("click",function(a){a.preventDefault();jsPanel.minimize(d)});a(".jsPanel-btn-maximize",d).on("click",function(a){a.preventDefault();jsPanel.maximize(d)});a(".jsPanel-btn-normalize",d).on("click",function(a){a.preventDefault();
jsPanel.normalize(d)});a(".jsPanel-btn-smallify, .jsPanel-btn-smallifyrev",d).on("click",function(a){a.preventDefault();jsPanel.smallify(d)});d.appendTo(a(m)[0]);jsPanel.activePanels.list.push(c);a(document).trigger("jspanelloaded",c);d.data("container",m);d.setTheme();q?(d.header.remove(),d.content.addClass("jsPanel-content-noheader"),"close maximize minimize normalize smallify smallifyrev".split(" ").forEach(function(a){d[0].setAttribute("data-btn"+a,"removed")})):("closeonly"===v.controls?["maximize",
"minimize","normalize","smallify"].forEach(function(a){jsPanel.setControlStatus(d,a,"remove")}):"none"===v.controls?"close maximize minimize normalize smallify smallifyrev".split(" ").forEach(function(a){jsPanel.setControlStatus(d,a,"remove")}):["close","maximize","minimize","normalize","smallify"].forEach(function(a){"disable"===v[a]?jsPanel.setControlStatus(d,a,"disable"):"remove"===v[a]?jsPanel.setControlStatus(d,a,"remove"):d[0].setAttribute("data-btn"+a,"enabled")}),u&&("string"===typeof u&&
"<"!==u.substring(0,1)?d.header.logo.append('<img src="'+u+'" height="38" alt="logo">'):d.header.logo.append(u)));(q||1>a(".jsPanel-hdr").length)&&d.content.css("border","none");jsPanel.configIconfont(d);"modal"===y?(jsPanel.insertModalBackdrop(d),d.addClass("jsPanel-modal").css("z-index",jsPanel.modalcount+9999)):"hint"===y?d.addClass("jsPanel-hint").css("z-index",1E4):y.tooltip&&(f=jsPanel.setTrigger(C),d.addClass("jsPanel-tooltip"),jsPanel.setTooltipClass(d),y.solo&&jsPanel.closeTooltips(),jsPanel.setTooltipMode(d,
f));y.tooltip&&a(f).addClass("hasTooltip");G&&!q&&d.toolbarAdd("header",G);x&&d.toolbarAdd("footer",x);g&&(d.content.append(g),d.data("content",g));r&&("string"===typeof r&&(d.option.contentAjax={url:r,autoload:!0}),jsPanel.ajax(d));a.isPlainObject(p)&&(p.src||p.srcdoc)&&jsPanel.iframe(d);y.connector&&jsPanel.addConnector(d);"string"===typeof k&&(f=k.trim().split(" "),k={width:f[0],height:f[f.length-1]});0===k.height&&(k.height="0");d.content.css({width:k.width||a.jsPanel.defaults.contentSize.width,
height:k.height||a.jsPanel.defaults.contentSize.height});d.css({width:function(){return 0<a(".jsPanel-content",d).length?d.content.outerWidth()+"px":k.width||a.jsPanel.defaults.contentSize.width},zIndex:function(){jsPanel.setZi(d)}});d.content.css("width","100%");jsPanel.position(d,C);jsPanel.calcPositionFactors(d);d.data("status","normalized");a(document).trigger("jspanelstatuschange",c);if(!y&&t){if(t.title)d.header.headerbar.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(t.title,
d)});if(t.content)d.content.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(t.content,d)});if(t.footer)d.footer.on("dblclick",function(a){a.preventDefault();jsPanel.dblclickhelper(t.footer,d)})}"string"===typeof n?d.content.css("overflow",n):a.isPlainObject(n)&&d.content.css({"overflow-y":n.vertical||n["overflow-y"],"overflow-x":n.horizontal||n["overflow-x"]});a.isPlainObject(w)?d.draggable(w):"disabled"===w?(a(".jsPanel-titlebar, .jsPanel-ftr",d).css("cursor","default"),d.draggable({disabled:!0})):
a(".jsPanel-titlebar, .jsPanel-ftr",d).css("cursor","default");d.on("dragstop",function(){return jsPanel.calcPositionFactors(d)});a.isPlainObject(D)?d.resizable(D):"disabled"===D&&(d.resizable({disabled:!0}),a(".ui-icon-gripsmall-diagonal-se, .ui-resizable-handle.ui-resizable-sw",d).css({"background-image":"none","text-indent":-9999}),a(".ui-resizable-handle",d).css({cursor:"inherit"}));d.on("resize",function(){return jsPanel.contentResize(d)});!0===E.rtl&&(a(".jsPanel-hdr, .jsPanel-headerbar, .jsPanel-titlebar, .jsPanel-controlbar, .jsPanel-hdr-toolbar, .jsPanel-ftr",
d).addClass("jsPanel-rtl"),[d.header.title,d.content,a("*",d.header.toolbar),a("*",d.footer)].forEach(function(a){a.prop("dir","rtl");E.lang&&a.prop("lang",E.lang)}),a(".ui-icon-gripsmall-diagonal-se",d).css({backgroundImage:"none",textIndent:-9999}));"string"===typeof H&&d.addClass(H).css("opacity",1);d.header.title.empty().prepend(J);d[0].addEventListener("mousedown",function(b){a(b.target).hasClass("jsglyph-close")||a(b.target).hasClass("jsglyph-minimize")||(b=a(b.target).closest(".jsPanel").css("z-index"),
!d.hasClass("jsPanel-modal")&&b<=jsPanel.zi&&d.front())},!1);d.updateCachedData();"string"===typeof F&&("maximize smallify"===F?d.maximize().smallify():d[F]());"number"===typeof b&&0<b&&window.setTimeout(function(){d&&d.close()},b);d.on("resizestop",function(b,e){("smallified"===d.data("status")||"smallifiedMax"===d.data("status"))&&d.outerHeight()>e.originalSize.height&&(d.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"),d.data("status","normalized"),a(document).trigger("jspanelnormalized",
c),a(document).trigger("jspanelstatuschange",c));jsPanel.calcPositionFactors(d)});B&&a(window).resize(function(b){if(b.target===window){var c=d.data("status");if("maximized"===c&&!a.isFunction(B))d.maximize(!1,!1);else if("normalized"===c||"smallified"===c||"maximized"===c)a.isFunction(B)?B.call(d,b,d):d.reposition({left:function(){var b;b="body"===this.option.container?(a(window).outerWidth()-this.outerWidth())*this.hf:(this.parent().outerWidth()-this.outerWidth())*this.hf;return 0>=b?0:b},top:function(){var b;
b="body"===this.option.container?(a(window).outerHeight()-this.outerHeight())*this.vf:(this.parent().outerHeight()-this.outerHeight())*this.vf;return 0>=b?0:b}})}});d[0].jspanel={options:d.option,close:function(){jsPanel.close(d,(0>=arguments.length?void 0:arguments[0])||!1,(1>=arguments.length?void 0:arguments[1])||!1,(2>=arguments.length?void 0:arguments[2])||!1)},normalize:function(a){return jsPanel.normalize(d,a)},maximize:function(a){return jsPanel.maximize(d,a)},minimize:function(a){return jsPanel.minimize(d,
a)},smallify:function(a){return jsPanel.smallify(d,a)},front:function(a){return jsPanel.front(d,a)},closeChildpanels:function(){return jsPanel.closeChildpanels(d)},reposition:function(a,b){return jsPanel.reposition(d,a,b)},resize:function(a,b,c){return d.resize(a,b,c)},contentResize:function(a){return jsPanel.contentResize(d,a)},contentReload:function(a){return jsPanel.contentReload(d,a)},headerTitle:function(a){return jsPanel.headerTitle(d,a)},headerControl:function(a,b){return jsPanel.headerControl(d,
