...
Object.assign || Object.defineProperty(Object, "assign", { enumerable: !1, configurable: !0, writable: !0, value: function value(b) {
    if (void 0 === b || null === b) throw new TypeError("Cannot convert first argument to object");for (var c = Object(b), d = 1; d < arguments.length; d++) {
      var e = arguments[d];if (void 0 !== e && null !== e) for (var e = Object(e), a = Object.keys(Object(e)), h = 0, l = a.length; h < l; h++) {
        var n = a[h],
            k = Object.getOwnPropertyDescriptor(e, n);void 0 !== k && k.enumerable && (c[n] = e[n]);
      }
    }return c;
  } });
Array.prototype.find || (Array.prototype.find = function (b, c) {
  if (null == this) throw new TypeError("Array.prototype.find called on null or undefined");if ("function" !== typeof b) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, a, h = 0; h < e; h++) {
    if (a = d[h], b.call(c, a, h, d)) return a;
  }
});
Array.prototype.findIndex || (Array.prototype.findIndex = function (b, c) {
  if (null === this) throw new TypeError("Array.prototype.findIndex called on null or undefined");if ("function" !== typeof b) throw new TypeError("predicate must be a function");for (var d = Object(this), e = d.length >>> 0, a, h = 0; h < e; h++) {
    if (a = d[h], b.call(c, a, h, d)) return h;
  }return -1;
});
Array.prototype.includes || (Array.prototype.includes = function (b, c) {
  var d = Object(this),
      e = parseInt(d.length) || 0;if (0 === e) return !1;var a = parseInt(c) || 0;0 <= a || (a = e + a, 0 > a && (a = 0));for (var h; a < e;) {
    h = d[a];if (b === h || b !== b && h !== h) return !0;a++;
  }return !1;
});String.prototype.includes || (String.prototype.includes = function () {
  return -1 !== String.prototype.indexOf.apply(this, arguments);
});
var jsPanel = { version: "3.0.1", date: "2016-06-25 12:00", id: 0, ziBase: 100, zi: 100, modalcount: 0, autopositionSpacing: 5, pbTreshold: .556, lastbeforeclose: !1, template: '<div class="jsPanel">\n                <div class="jsPanel-hdr">\n                    <div class="jsPanel-headerbar">\n                        <div class="jsPanel-titlebar">\n                            <h3 class="jsPanel-title"></h3>\n                        </div>\n                        <div class="jsPanel-controlbar">\n                            <div class="jsPanel-btn jsPanel-btn-smallify"><span class="jsglyph jsglyph-chevron-up"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-smallifyrev"><span class="jsglyph jsglyph-chevron-down"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-minimize"><span class="jsglyph jsglyph-minimize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-normalize"><span class="jsglyph jsglyph-normalize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-maximize"><span class="jsglyph jsglyph-maximize"></span></div>\n                            <div class="jsPanel-btn jsPanel-btn-close"><span class="jsglyph jsglyph-close"></span></div>\n                        </div>\n                    </div>\n                    <div class="jsPanel-hdr-toolbar"></div>\n                </div>\n                <div class="jsPanel-content"></div>\n                <div class="jsPanel-ftr"></div>\n               </div>',
  ...
  tplContentOnly: '<div class="jsPanel">\n                        <div class="jsPanel-content jsPanel-content-noheader jsPanel-content-nofooter"></div>\n                     </div>', activePanels: { list: [], getPanel: function getPanel(b) {
    ...
    function e(a) {
      ...
      var b = {},
          c = n(f.of);u.includes(a) ? b.left = c.left : v.includes(a) ? b.left = c.left + c.width / 2 : w.includes(a) ? b.left = c.left + c.width : b.left = c.left;x.includes(a) ? b.top = c.top : y.includes(a) ? b.top = c.top + c.height / 2 : z.includes(a) ? b.top = c.top + c.height : b.top = c.top;return b;
    }function h(a) {
      var b = {},
      ...
      var b = {},
          ...
          l = d.left - c.left,
          c = d.top - c.top;u.includes(a) ? b.left = l : v.includes(a) ? b.left = l + d.width / 2 : w.includes(a) ? b.left = l + d.width : b.left = l;x.includes(a) ? b.top = c : y.includes(a) ? b.top = c + d.height / 2 : z.includes(a) ? b.top = c + d.height : b.top = c;return b;
    }function n(a) {
      ...
      k = c.match(/\b[a-z]{4,6}-{1}[a-z]{3,6}\b/);g = c.match(/DOWN|UP|RIGHT|LEFT/);var q = c.match(/[+-]?\d+\.?\d*%?/g);c = $.isArray(k) ? { my: k[0], at: k[0] } : { my: "center", at: "center" };$.isArray(g) && (c.autoposition = g[0]);$.isArray(q) && (c.offsetX = q[0], 2 === q.length && (c.offsetY = q[1]));
    }f = Object.assign({ my: "center", at: "center", offsetX: 0, offsetY: 0, modify: !1, fixed: "true" }, c);k = "string" === typeof b ? document.querySelector(b) : b.jquery ? b[0] : b;r = k.parentElement;f.of || (r === document.body ? f.of = "window" : f.of = r);g = n(k);"string" === typeof f.offsetX && "%" === f.offsetX.slice(-1) ? f.offsetX = "window" === f.of ? window.innerWidth * (parseInt(f.offsetX, 10) / 100) : r.clientWidth * (parseInt(f.offsetX, 10) / 100) : "string" === typeof f.offsetX ? f.offsetX = parseFloat(f.offsetX) : $.isFunction(f.offsetX) && (f.offsetX = parseInt(f.offsetX.call(b, b)));"string" === typeof f.offsetY && "%" === f.offsetY.slice(-1) ? f.offsetY = "window" === f.of ? window.innerHeight * (parseInt(f.offsetY, 10) / 100) : r.clientHeight * (parseInt(f.offsetY, 10) / 100) : "string" === typeof f.offsetY ? f.offsetY = parseFloat(f.offsetY) : $.isFunction(f.offsetY) && (f.offsetY = parseInt(f.offsetY.call(b, b)));q = parseInt(d(r, "border-left-width"));u.includes(f.my) ? p = q : v.includes(f.my) ? p = g.width / 2 + q : w.includes(f.my) && (p = g.width + q);q = parseInt(d(r, "border-top-width"));x.includes(f.my) ? t = q : y.includes(f.my) ? t = g.height / 2 + q : z.includes(f.my) && (t = g.height + q);k.parentElement === document.body ? "window" === f.of ? (g = e(f.at), f.fixed ? (p = g.left - p + f.offsetX - window.pageXOffset, t = g.top - t + f.offsetY - window.pageYOffset) : (p = g.left - p + f.offsetX, t = g.top - t + f.offsetY)) : (g = a(f.at), p = g.left - p + f.offsetX, t = g.top - t + f.offsetY) : (g = "string" === typeof f.of ? document.querySelector(f.of) : f.of.jquery ? f.of[0] : f.of, g = r === g ? h(f.at) : l(f.at), p = g.left - p + f.offsetX, t = g.top - t + f.offsetY);if (f.autoposition) {
      g = [];q = this.autopositionSpacing;f.my === f.at && (m = f.my);k.setAttribute("data-autoposition", f.autoposition);$.isFunction(f.offsetX) || k.setAttribute("data-offsetx", f.offsetX);$.isFunction(f.offsetY) || k.setAttribute("data-offsety", f.offsetY);k.classList.add(m);m = document.getElementsByClassName(m);for (var A = 0; A < m.length; A++) {
        m[A].parentElement === r && g.push(m[A]);
      }if ("DOWN" === f.autoposition) for (m = 0; m < g.length - 1; m++) {
        t += g[m].getBoundingClientRect().height + q;
      } else if ("UP" === f.autoposition) for (m = 0; m < g.length - 1; m++) {
        t -= g[m].getBoundingClientRect().height + q;
      } else if ("RIGHT" === f.autoposition) for (m = 0; m < g.length - 1; m++) {
        p += g[m].getBoundingClientRect().width + q;
      } else if ("LEFT" === f.autoposition) for (m = 0; m < g.length - 1; m++) {
        p -= g[m].getBoundingClientRect().width + q;
      }
    }m = { left: p, top: t };"function" === typeof f.modify && (m = f.modify.call(m, m));k.style.position = "absolute";k.style.left = m.left + "px";k.style.top = m.top + "px";k.style.opacity = 1;"window" === f.of && f.fixed && r === document.body && (k.style.position = "fixed");return k;
    ...
    if (0 === c) d = c = b = d;else {
      var e = function e(a, b, c) {
        0 > c && (c += 1);1 < c && --c;return c < 1 / 6 ? a + 6 * (b - a) * c : .5 > c ? b : c < 2 / 3 ? a + (b - a) * (2 / 3 - c) * 6 : a;
          ...
          a = .5 > d ? d * (1 + c) : d + c - d * c,
          h = 2 * d - a;d = e(h, a, b + 1 / 3);c = e(h, a, b);b = e(h, a, b - 1 / 3);
    ...
    b /= 255;c /= 255;d /= 255;var e = Math.max(b, c, d),
        a = Math.min(b, c, d),
        h,
        l = (e + a) / 2;if (e === a) h = a = 0;else {
      var n = e - a,
          a = .5 < l ? n / (2 - e - a) : n / (e + a);switch (e) {case b:
          h = (c - d) / n + (c < d ? 6 : 0);break;case c:
          h = (d - b) / n + 2;break;case d:
          h = (b - c) / n + 4;}h /= 6;
    }h *= 360;a = 100 * a + "%";l = 100 * l + "%";return { css: "hsl(" + h + "," + a + "," + l + ")", h: h, s: a, l: l };
    ...
    var c = b.toLowerCase(),
        d,
        e,
        a;b = {};d = /^rgba?\(([0-9]{1,3}),([0-9]{1,3}),([0-9]{1,3}),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;e = /^hsla?\(([0-9]{1,3}),([0-9]{1,3}\%),([0-9]{1,3}\%),?(0|1|0\.[0-9]{1,2}|\.[0-9]{1,2})?\)$/gi;a = { aliceblue: "f0f8ff", antiquewhite: "faebd7", aqua: "0ff", aquamarine: "7fffd4",
      ...
      magenta: "f0f", maroon: "800000", mediumaquamarine: "66cdaa", mediumblue: "0000cd", mediumorchid: "ba55d3", mediumpurple: "9370d8", mediumseagreen: "3cb371", mediumslateblue: "7b68ee", mediumspringgreen: "00fa9a", mediumturquoise: "48d1cc", mediumvioletred: "c71585", midnightblue: "191970", mintcream: "f5fffa", mistyrose: "ffe4e1", moccasin: "ffe4b5", navajowhite: "ffdead", navy: "000080", oldlace: "fdf5e6", olive: "808000", olivedrab: "6b8e23", orange: "ffa500", orangered: "ff4500", orchid: "da70d6", palegoldenrod: "eee8aa", palegreen: "98fb98",
      ...
      thistle: "d8bfd8", tomato: "ff6347", turquoise: "40e0d0", violet: "ee82ee", wheat: "f5deb3", white: "fff", whitesmoke: "f5f5f5", yellow: "ff0", yellowgreen: "9acd32" };a[c] && (c = a[c]);null !== c.match(/^#?([0-9a-f]{3}|[0-9a-f]{6})$/gi) ? (c = c.replace("#", ""), 1 === c.length % 2 ? (d = String(c.substr(0, 1)) + c.substr(0, 1), e = String(c.substr(1, 1)) + c.substr(1, 1), c = String(c.substr(2, 1)) + c.substr(2, 1), b.rgb = { r: parseInt(d, 16), g: parseInt(e, 16), b: parseInt(c, 16) }, b.hex = "#" + d + e + c) : (b.rgb = { r: parseInt(c.substr(0, 2), 16), g: parseInt(c.substr(2, 2), 16), b: parseInt(c.substr(4, 2), 16) }, b.hex = "#" + c), c = this.rgbToHsl(b.rgb.r, b.rgb.g, b.rgb.b), b.hsl = c, b.rgb.css = "rgb(" + b.rgb.r + "," + b.rgb.g + "," + b.rgb.b + ")") : c.match(d) ? (d = d.exec(c), b.rgb = { css: c, r: d[1], g: d[2], b: d[3] }, b.hex = this.rgbToHex(d[1], d[2], d[3]), c = this.rgbToHsl(d[1], d[2], d[3]), b.hsl = c) : c.match(e) ? (d = e.exec(c), c = d[1] / 360, e = d[2].substr(0, d[2].length - 1) / 100, a = d[3].substr(0, d[3].length - 1) / 100, c = this.hslToRgb(c, e, a), b.rgb = { css: "rgb(" + c[0] + "," + c[1] + "," + c[2] + ")", r: c[0], g: c[1], b: c[2] }, b.hex = this.rgbToHex(b.rgb.r, b.rgb.g, b.rgb.b), b.hsl = { css: "hsl(" + d[1] + "," + d[2] + "," + d[3] + ")", h: d[1], s: d[2], l: d[3] }) : (b.hex = "#f5f5f5", b.rgb = { css: "rgb(245,245,245)", r: 245, g: 245, b: 245 }, b.hsl = { css: "hsl(0,0%,96.08%)", h: 0, s: "0%", l: "96.08%" });return b;
    ...
    var c = this.color(b),
        ...
        a,
        h,
        l;this.perceivedBrightness(b) <= this.pbTreshold ? a = "#ffffff" : a = "#000000";this.perceivedBrightness(d) <= this.pbTreshold ? h = "#ffffff" : h = "#000000";this.perceivedBrightness(e) <= this.pbTreshold ? l = "#000000" : l = "#ffffff";return [c.hsl.css, d, e, a, h, l];
    ...
    function c(a) {
      if (a.match(/top|topleft|topright|lefttopcorner|righttopcorner|leftbottom|rightbottom/)) return "none" !== b.footer.css("display") ? n : 0 < parseFloat(b.option.contentSize.height) ? l : k;
    }function d(a) {
      if (a.match(/bottom|bottomleft|bottomright|leftbottomcorner|rightbottomcorner/)) {
        if (!b.option.headerRemove) return k;if (0 < parseFloat(b.option.contentSize.height)) return l;if ("none" !== b.footer.css("display")) return n;
      }
    }function e(a) {
      if (a.match(/lefttop|righttop/)) return b.option.headerRemove ? l : k;
    }function a(a) {
      if (a.match(/left|right/)) {
        if (0 < parseFloat(b.option.contentSize.height)) return l;if (!b.option.headerRemove) return k;
        if ("none" !== b.footer.css("display")) return n;
      }
    }var h = b.option.paneltype.connectorBG || null,
        l = b.content.css("background-color"),
        n = b.footer.css("background-color"),
        k = b.css("background-color");b.hasClass("jsPanel-tooltip-top") ? (b.append("<div class='jsPanel-connector jsPanel-connector-top'>"), $(".jsPanel-connector-top", b).css("border-top-color", h || c("top")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-bottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-bottom'>"), $(".jsPanel-connector-bottom", b).css("border-bottom-color", h || d("bottom")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10) : b.hasClass("jsPanel-tooltip-left") ? (b.append("<div class='jsPanel-connector jsPanel-connector-left'>"), $(".jsPanel-connector-left", b).css("border-left-color", h || a("left")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-right") ? (b.append("<div class='jsPanel-connector jsPanel-connector-right'>"), $(".jsPanel-connector-right", b).css("border-right-color", h || a("right")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-lefttopcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-lefttopcorner'>"), $(".jsPanel-connector-lefttopcorner", b).css("background-color", h || c("lefttopcorner"))) : b.hasClass("jsPanel-tooltip-righttopcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-righttopcorner'>"), $(".jsPanel-connector-righttopcorner", b).css("background-color", h || c("righttopcorner"))) : b.hasClass("jsPanel-tooltip-rightbottomcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-rightbottomcorner'>"), $(".jsPanel-connector-rightbottomcorner", b).css("background-color", h || d("rightbottomcorner"))) : b.hasClass("jsPanel-tooltip-leftbottomcorner") ? (b.append("<div class='jsPanel-connector jsPanel-connector-leftbottomcorner'>"), $(".jsPanel-connector-leftbottomcorner", b).css("background-color", h || d("leftbottomcorner"))) : b.hasClass("jsPanel-tooltip-lefttop") ? (b.append("<div class='jsPanel-connector jsPanel-connector-lefttop'>"), $(".jsPanel-connector-lefttop", b).css("border-left-color", h || e("lefttop")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-leftbottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-leftbottom'>"), $(".jsPanel-connector-leftbottom", b).css("border-left-color", h || c("leftbottom")), b.option.position.offsetX = b.option.position.offsetX - 12 || -12) : b.hasClass("jsPanel-tooltip-topleft") ? (b.append("<div class='jsPanel-connector jsPanel-connector-topleft'>"), $(".jsPanel-connector-topleft", b).css("border-top-color", h || c("topleft")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-topright") ? (b.append("<div class='jsPanel-connector jsPanel-connector-topright'>"), $(".jsPanel-connector-topright", b).css("border-top-color", h || c("topright")), b.option.position.offsetY = b.option.position.offsetY - 10 || -10) : b.hasClass("jsPanel-tooltip-righttop") ? (b.append("<div class='jsPanel-connector jsPanel-connector-righttop'>"), $(".jsPanel-connector-righttop", b).css("border-right-color", h || e("righttop")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-rightbottom") ? (b.append("<div class='jsPanel-connector jsPanel-connector-rightbottom'>"), $(".jsPanel-connector-rightbottom", b).css("border-right-color", h || c("rightbottom")), b.option.position.offsetX = b.option.position.offsetX + 12 || 12) : b.hasClass("jsPanel-tooltip-bottomleft") ? (b.append("<div class='jsPanel-connector jsPanel-connector-bottomleft'>"), $(".jsPanel-connector-bottomleft", b).css("border-bottom-color", h || d("bottomleft")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10) : b.hasClass("jsPanel-tooltip-bottomright") && (b.append("<div class='jsPanel-connector jsPanel-connector-bottomright'>"), $(".jsPanel-connector-bottomright", b).css("border-bottom-color", h || d("bottomright")), b.option.position.offsetY = b.option.position.offsetY + 10 || 10);
  ...
  setTooltipMode: function setTooltipMode(b, c) {
    ...
    var c = "close maximize normalize minimize smallify smallifyrev".split(" "),
        ...
        h = b.header.headerbar;"bootstrap" === a || "glyphicon" === a ? (c.forEach(function (a, b) {
      $(".jsPanel-btn-" + a + " span", h).removeClass().addClass("glyphicon glyphicon-" + d[b]);
    }), $(".jsPanel-headerbar .jsPanel-btn", b).css("padding-top", "4px")) : "font-awesome" === a && c.forEach(function (a, b) {
      $(".jsPanel-btn-" + a + " span", h).removeClass().addClass("fa fa-" + e[b]);
    });
    ...
    b = void 0 === b ? ".jsPanel" : b;c = void 0 === c ? "jspanels" : c;var d,
      ...
      k = $(c).data("container");d = $(c).offset();e = $(c).position();"body" === k.toLowerCase() ? (a = Math.floor(d.top - $(window).scrollTop()), h = Math.floor(d.left - $(window).scrollLeft())) : (a = Math.floor(e.top), h = Math.floor(e.left));l = $(c).css("width");n = $(".jsPanel-content", c).css("height");f = { status: $(c).data("status"), id: $(c).prop("id"), headerTitle: $(".jsPanel-title", c).html(), custom: $(c).data("custom"), content: $(c).data("content"), contentSize: { width: l, height: n }, position: { my: "left-top", at: "left-top", offsetX: h, offsetY: a } };$(c).data("ajaxURL") && (f.contentAjax = { url: $(c).data("ajaxURL"), autoload: !0 });if ($(c).data("iframeDOC") || $(c).data("iframeSRC")) f.contentIframe = { src: $(c).data("iframeSRC") || "", srcdoc: $(c).data("iframeDOC") || "" };g.push(f);switch (f.status) {case "minimized":
    ...
    });window.localStorage.setItem(c, JSON.stringify(g));return g;
...
(function (b) {
  b.jsPanel = function (c) {
    var d;c = c || {};var e = b.extend(!0, {}, c.config || {}, c),
        ...
        h;"tooltip" === e.paneltype && (e.paneltype = { tooltip: !0 });e.paneltype ? "modal" === e.paneltype ? a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.modaldefaults, e) : e.paneltype.tooltip ? a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.tooltipdefaults, e) : "hint" === e.paneltype && (a.option = b.extend(!0, {}, b.jsPanel.defaults, b.jsPanel.hintdefaults, e)) : a.option = b.extend(!0, {}, b.jsPanel.defaults, e);if (a.option.paneltype.tooltip && (h = jsPanel.setTrigger(a.option.position), b(h).hasClass("hasTooltip"))) return !1;"string" === typeof a.option.id ? d = a.option.id : b.isFunction(a.option.id) && (a.option.id = d = a.option.id());if (0 < b("#" + d).length) return console.warn("jsPanel Error: No jsPanel created - id attribute passed with option.id already exists in document"), !1;a.attr("id", d);a.data("custom", a.option.custom);a.header = b(".jsPanel-hdr", a);a.header.headerbar = b(".jsPanel-headerbar", a.header);a.header.title = b(".jsPanel-title", a.header.headerbar);a.header.controls = b(".jsPanel-controlbar", a.header.headerbar);a.header.toolbar = b(".jsPanel-hdr-toolbar", a.header);a.content = b(".jsPanel-content", a);a.content.height = "";a.footer = b(".jsPanel-ftr", a);a.data("status", "initialized");a.cachedData = {};a.close = function (c) {
      b(document).trigger("jspanelbeforeclose", d);if (b.isFunction(a.option.onbeforeclose) && !1 === a.option.onbeforeclose.call(a, a)) return a;var n = a.option.position;if (n.autoposition || "string" === typeof n && n.match(/DOWN|RIGHT|UP|LEFT/)) {
        var n = b("#" + d).parent(),
            e = document.getElementById(d).className.match(/left-top|center-top|right-top|left-center|center|right-center|left-bottom|center-bottom|right-bottom/);e && (jsPanel.lastbeforeclose = { parent: n, "class": e[0] });
      }a.closeChildpanels().remove();if (!b("#" + d).length) {
        n = jsPanel.activePanels.list.findIndex(function (a) {
          return a === d;
        });-1 < n && jsPanel.activePanels.list.splice(n, 1);b("#" + d + "-min").remove();"modal" === a.option.paneltype && b("#jsPanel-modal-backdrop-" + a.attr("id")).remove();a.option.paneltype.tooltip && b(h).removeClass("hasTooltip");b(document).trigger("jspanelclosed", d);b(document).trigger("jspanelstatuschange", d);var g, f;jsPanel.lastbeforeclose && (g = jsPanel.lastbeforeclose.parent, g = b("." + jsPanel.lastbeforeclose["class"], g), f = jsPanel.lastbeforeclose["class"]);g && (g.each(function (a, c) {
          b(c).removeClass(f);
        }), g.each(function (a, b) {
          var c = b.getAttribute("data-autoposition"),
              d = b.getAttribute("data-offsetx"),
              l = b.getAttribute("data-offsety");jsPanel.position(b, { my: f, at: f, autoposition: c, offsetX: d, offsetY: l });
        }));
      ...
      d = void 0 === d ? "enable" : d;var e = function e(c, d) {
        var l = a.header.headerbar,
            e = a[0];"disable" === d ? "removed" !== e.getAttribute("data-btn" + c) && (e.setAttribute("data-btn" + c, "disabled"), b(".jsPanel-btn-" + c, l).css({ pointerEvents: "none", opacity: .4, cursor: "default" })) : "enable" === d ? "removed" !== e.getAttribute("data-btn" + c) && (e.setAttribute("data-btn" + c, "enabled"), b(".jsPanel-btn-" + c, l).css({ pointerEvents: "auto", opacity: 1, cursor: "pointer" })) : "remove" === d && "close" !== c && (e.setAttribute("data-btn" + c, "removed"), b(".jsPanel-btn-" + c, l).remove());
      ...
      var e = a.option.maximizedMargin,
          k = a[0].parentNode;"normalized" === a.data("status") && a.updateCachedData();b(document).trigger("jspanelbeforemaximize", d);if (b.isFunction(a.option.onbeforemaximize) && !1 === a.option.onbeforemaximize.call(a, a)) return a;a.css("overflow", "visible");if (k === document.body) {
        var g;jsPanel.isIE || jsPanel.isEdge ? g = 11 : g = 0;a.css({ width: document.documentElement.clientWidth - e.left - e.right - g + "px", height: document.documentElement.clientHeight - e.top - e.bottom + "px", left: e.left + "px", top: e.top + "px" });!1 === a.option.position.fixed && a.css({ left: window.pageXOffset + e.left + "px", top: window.pageYOffset + e.top + "px" });
      } else a.css({ width: k.clientWidth - e.left - e.right + "px", height: k.clientHeight - e.top - e.bottom + "px", left: e.left + "px", top: e.top + "px" });a.contentResize().data("status", "maximized").css("z-index", jsPanel.setZi(a));a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev");b("#" + a.prop("id") + "-min").remove();b(document).trigger("jspanelmaximized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onmaximized) && a.option.onmaximized.call(a, a);c && b.isFunction(c) && c.call(a, a);return a;
    };a.minimize = function (c) {
      if ("minimized" === a.data("status")) return a;b(document).trigger("jspanelbeforeminimize", d);if (b.isFunction(a.option.onbeforeminimize) && !1 === a.option.onbeforeminimize.call(a, a)) return a;var e = a.header.headerbar.css("color"),
          k;k = a.hasClass("panel") ? "transparent" === a.header.css("background-color") ? a.css("background-color") : a.header.css("background-color") : a.css("background-color");"normalized" === a.data("status") && a.updateCachedData();var g = b(jsPanel.replacementTemplate);g.left = a.css("left");a.css("left", "-9999px").data("status", "minimized");g.css({ backgroundColor: k }).prop("id", a.prop("id") + "-min").find("h3").css({ color: e }).prop("title", a.header.title[0].textContent).html(a.headerTitle());k = a.option.headerControls.iconfont;if ("font-awesome" === k) b(".jsglyph.jsglyph-normalize", g).removeClass().addClass("fa fa-expand"), b(".jsglyph.jsglyph-maximize", g).removeClass().addClass("fa fa-arrows-alt"), b(".jsglyph.jsglyph-close", g).removeClass().addClass("fa fa-times");else if ("bootstrap" === k || "glyphicon" === k) b(".jsglyph.jsglyph-normalize", g).removeClass().addClass("glyphicon glyphicon-resize-full"), b(".jsglyph.jsglyph-maximize", g).removeClass().addClass("glyphicon glyphicon-fullscreen"), b(".jsglyph.jsglyph-close", g).removeClass().addClass("glyphicon glyphicon-remove");b(".jsPanel-btn span", g).css({ color: e });e = b(a.option.container).closest(".jsPanel-content");e.length ? (b(".jsPanel-minimized-box").length || b(e[0]).append("<div class='jsPanel-minimized-box'>"), b(".jsPanel-minimized-box").append(g)) : b("#jsPanel-replacement-container").append(g);
      b(document).trigger("jspanelminimized", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onminimized) && a.option.onminimized.call(a, a);c && b.isFunction(c) && c.call(a, a);b(".jsPanel-btn-normalize", g).css("display", "block").click(function () {
        a.css("left", g.left);g.remove();b(".jsPanel-btn-normalize", a).trigger("click");
      });"disabled" === a[0].dataset.btnnormalize ? b(".jsPanel-btn-normalize", g).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === a[0].dataset.btnnormalize && b(".jsPanel-btn-normalize", g).remove();b(".jsPanel-btn-maximize", g).click(function () {
        a.css("left", g.left);g.remove();b(".jsPanel-btn-maximize", a).trigger("click");
      });"disabled" === a[0].dataset.btnmaximize ? b(".jsPanel-btn-maximize", g).css({ pointerEvents: "none", opacity: .5, cursor: "default" }) : "removed" === a[0].dataset.btnmaximize && b(".jsPanel-btn-maximize", g).remove();b(".jsPanel-btn-close", g).click(function () {
        g.remove();a.close();
      });"disabled" === a[0].dataset.btnclose && b(".jsPanel-btn-close", g).css({ pointerEvents: "none",
      ...
      a.css("background", "").content.css({ borderTop: "", backgroundColor: "", color: "" });a.css({ borderWidth: "", borderStyle: "", borderColor: "" });b(".jsPanel-hdr *", a).css({ color: "" });a.header.toolbar.css({ boxShadow: "", width: "", marginLeft: "" });"filled" === c.substr(-6, 6) ? (e[1] = "filled", e[0] = c.substr(0, c.length - 6)) : "filledlight" === c.substr(-11, 11) ? (e[1] = "filledlight", e[0] = c.substr(0, c.length - 11)) : (e[1] = "", e[0] = c);e[0].match("-") && (g = e[0].split("-"), f = !0);f ? (a.addClass("panel panel-" + g[1]).addClass("card card-inverse card-" + g[1]).header.addClass("panel-heading").title.addClass("panel-title"), a.content.addClass("panel-body").css("border-top-color", function () {
        return a.header.css("border-top-color");
      }), a.footer.addClass("panel-footer card-footer"), p = "transparent" === b(".panel-heading", a).css("background-color") ? a.css("background-color").replace(/\s+/g, "") : b(".panel-heading", a).css("background-color").replace(/\s+/g, ""), g = jsPanel.calcColors(p), b("*", a.header).css("color", g[3]), a.option.headerToolbar ? a.header.toolbar.css({ boxShadow: "0 0 1px " + g[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : a.content.css({ borderTop: "1px solid " + g[3] }), "filled" === e[1] ? a.content.css({ backgroundColor: p, color: g[3] }) : "filledlight" === e[1] && a.content.css({ backgroundColor: g[1], color: "#000000" })) : jsPanel.themes.includes(e[0]) ? (a.addClass("jsPanel-theme-" + e[0]), "filled" === e[1] ? a.content.css("background", "").addClass("jsPanel-content-filled") : "filledlight" === e[1] && a.content.css("background", "").addClass("jsPanel-content-filledlight"), a.option.headerToolbar || a.content.css({ borderTop: "1px solid " + a.header.title.css("color") })) : (h = jsPanel.calcColors(e[0]), a.css("background-color", h[0]), b(".jsPanel-hdr *", a).css({ color: h[3] }), a.option.headerToolbar ? a.header.toolbar.css({ boxShadow: "0 0 1px " + h[3] + " inset", width: "calc(100% + 4px)", marginLeft: "-2px" }) : a.content.css({ borderTop: "1px solid " + h[3] }), "filled" === e[1] ? a.content.css({ "background-color": h[0], color: h[3] }) : "filledlight" === e[1] && a.content.css({ "background-color": h[1] }));a.option.border ? (g = a.option.border.split(" "), a.css({ "border-width": g[0], "border-style": g[1] }), f ? a.css("border-color", p) : jsPanel.themes.includes(e[0]) || a.css("border-color", h[0])) : a.css({ borderWidth: "", borderStyle: "", borderColor: "" });d && b.isFunction(d) && d.call(a, a);return a;
      ...
      if ("normalized" === a.data("status") || "maximized" === a.data("status")) {
        ...
        b(document).trigger("jspanelbeforeunsmallify", d);if (b.isFunction(a.option.onbeforeunsmallify) && !1 === a.option.onbeforeunsmallify.call(a, a)) return a;a.css("overflow", "visible");a.animate({ height: a.smallify.height }, { done: function done() {
            "smallified" === a.data("status") ? (a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"), a.data("status", "normalized"), b(document).trigger("jspanelnormalized", d)) : (a.hideControls(".jsPanel-btn-maximize, .jsPanel-btn-smallifyrev"), a.data("status", "maximized"), b(document).trigger("jspanelmaximized", d));b(document).trigger("jspanelunsmallified", d);b(document).trigger("jspanelstatuschange", d);b.isFunction(a.option.onunsmallified) && a.option.onunsmallified.call(a, a);
          } });
    ...
    a.option.headerToolbar && !a.option.headerRemove && a.toolbarAdd("header", a.option.headerToolbar);a.option.footerToolbar && a.toolbarAdd("footer", a.option.footerToolbar);a.option.content && (a.content.append(a.option.content), a.data("content", a.option.content));"string" === typeof a.option.contentAjax ? (a.option.contentAjax = { url: a.option.contentAjax, autoload: !0 }, jsPanel.ajax(a)) : b.isPlainObject(a.option.contentAjax) && jsPanel.ajax(a);b.isPlainObject(a.option.contentIframe) && (a.option.contentIframe.src || a.option.contentIframe.srcdoc) && jsPanel.iframe(a);a.option.paneltype.connector && jsPanel.addConnector(a);"string" === typeof a.option.contentSize && (c = a.option.contentSize.trim().split(" "), e = c.length, a.option.contentSize = { width: c[0], height: c[--e] });0 === a.option.contentSize.height && (a.option.contentSize.height = "0");a.content.css({ width: a.option.contentSize.width || b.jsPanel.defaults.contentSize.width, height: a.option.contentSize.height || b.jsPanel.defaults.contentSize.height });a.css({ width: function width() {
      ...
      "text-indent": -9999 }), b(".ui-resizable-handle", a).css({ cursor: "inherit" }));a.on("resize", function () {
    ...
    }), b(".ui-icon-gripsmall-diagonal-se", a).css({ backgroundImage: "none",
      textIndent: -9999 }));"string" === typeof a.option.show && a.addClass(a.option.show).css("opacity", 1);a.header.title.empty().prepend(a.option.headerTitle);a[0].addEventListener("mousedown", function (c) {
      ...
      a && a.close();
    }, a.option.autoclose);a.on("resizestop", function () {
      if ("maximized" === a.data("status") || "normalized" === a.data("status")) a.hideControls(".jsPanel-btn-normalize, .jsPanel-btn-smallifyrev"), a.data("status", "normalized"), b(document).trigger("jspanelnormalized", d), b(document).trigger("jspanelstatuschange", d);else if ("smallified" === a.data("status") || "smallifiedMax" === a.data("status")) {
        var c = parseInt(a.smallify.height) - a.header.outerHeight();a.content.css("height", c);
      }
    ...
    }, load: !1, maximizedMargin: { top: 5, right: 5, bottom: 5, left: 5 }, onbeforeclose: !1, onbeforemaximize: !1, onbeforeminimize: !1, onbeforenormalize: !1, onbeforesmallify: !1, onbeforeunsmallify: !1, onclosed: !1, onmaximized: !1, onminimized: !1, onnormalized: !1, onbeforeresize: !1, onresized: !1, onsmallified: !1, onunsmallified: !1, onfronted: !1, paneltype: !1, position: { my: "center", at: "center" }, resizable: { handles: "n, e, s, w, ne, se, sw, nw", autoHide: !1, minWidth: 40, minHeight: 40 }, rtl: !1, setstatus: !1, show: !1, template: !1, theme: "default" };
  b.jsPanel.modaldefaults = { draggable: "disabled", headerControls: { controls: "closeonly" }, position: { my: "center", at: "center" }, resizable: "disabled" };b.jsPanel.tooltipdefaults = { draggable: !1, headerControls: { controls: "closeonly" }, position: { fixed: !1 }, resizable: !1 };b.jsPanel.hintdefaults = { autoclose: 8E3, draggable: !1, headerControls: { controls: "closeonly" }, resizable: !1 };b(document).ready(function () {
