(function (global, factory) {
   ...
   */
   ...
   var window$1 = Function(' return this')() || undefined
   var browser = {
       window: window$1,
   ...
   /* istanbul ignore if  */
   if (window$1.location && window$1.navigator && window$1.window) {
       var doc = window$1.document
       ...
       if (window$1.VBArray) {
           browser.msie = doc.documentMode || (window$1.XMLHttpRequest ? 7 : 6)
