...
const Ge = function() {
  ...
  Ue.parseDirective(this, e, t, r);
}, Ze = function(e, t, r, o, l, n, a, s, i) {
  if (e == null || t === void 0 || t === null || r === void 0 || r === null || o === void 0 || o === null)
    return;
  let u = {};
  const d = Ft.find((y) => y.from === t && y.to === r);
  if (d ? u = d : Ft.push(u), u.type = e, u.from = t, u.to = r, u.label = { text: o }, l == null)
    u.techn = { text: "" };
...
}, r0 = function(e, t, r, o, l, n, a, s, i, u, d) {
    ...
    if (r)
      ...
      for (const s of n)
        t[e].width = Math.max(
          Yt(s, o),
          t[e].width
        ), a = xe(s, o), t[e].height = t[e].height + a;
    }
}
const Re = function(e, t, r) {
  ...
  for (const n of o) {
    ...
    switch (s.fontSize = s.fontSize - 2, a.typeC4Shape.width = Yt(
      "<<" + a.typeC4Shape.text + ">>",
      s
...
const I0 = function(e, t, r, o) {
  let l = 0;
  for (let n of t) {
    l = l + 1;
    let a = n.wrap && b.wrap, s = B0(b);
    o.db.getC4Type() === "C4Dynamic" && (n.label.text = l + ": " + n.label.text);
    let u = Yt(n.label.text, s);
    I("label", n, a, s, u), n.techn && n.techn.text !== "" && (u = Yt(n.techn.text, s), I("techn", n, a, s, u)), n.descr && n.descr.text !== "" && (u = Yt(n.descr.text, s), I("descr", n, a, s, u));
...
const V0 = function(e, t, r, o) {
  ...
  let n;
  l === "sandbox" && (n = Qt("#i" + t));
  const a = l === "sandbox" ? Qt(n.nodes()[0].contentDocument.body) : Qt("body");
  let s = o.db;
  o.db.setWrap(b.wrap), Te = s.getC4ShapeInRow(), oe = s.getC4BoundaryInRow(), _e.debug(`C:${JSON.stringify(b, null, 2)}`);
  const i = l === "sandbox" ? a.select(`[id="${t}"]`) : Qt(`[id="${t}"]`);
  ...
  d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX).attr("y", p.starty + b.diagramMarginY), ze(i, T, S, b.useMaxWidth);
  const L = d ? 60 : 0;
  i.attr(
    "viewBox",
