import { c as xe, s as Fe, g as Me, b as Pe, a as Ye, m as Ue, l as ve, B as Be, j as oe, k as Qe, f as Te } from "./mermaid-08b2ff5f.js";
import { G as He, l as We } from "./layout-1171b506.js";
import { l as Ke } from "./line-47adbd5d.js";
...
const we = (e, t) => e.insert("rect", "#" + t).attr("class", "req reqBox").attr("x", 0).attr("y", 0).attr("width", y.rect_min_width + "px").attr("height", y.rect_min_height + "px"), Ve = (e, t, a) => {
  ...
  Rt(g, o, h), mt(R, o, h), It(x, o), We(o), bt(h, o), x.forEach(function(N) {
    Et(h, N, o, t, c);
  });
  const S = y.rect_padding, T = h.node().getBBox(), v = T.width + S * 2, A = T.height + S * 2;
  Qe(h, A, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S} ${T.y - S} ${v} ${A}`);
}, St = {
  draw: kt
}, wt = {
  parser: Ge,
