import { c as U, s as xt, g as kt, b as Ot, a as bt, y as Rt, z as Nt, m as Tt, l as tt, A as vt, j as at, x as At, k as Mt, B as It, C as wt } from "./mermaid-29dd296b.js";
import { G as St, l as Bt } from "./layout-2ee26998.js";
import { l as Dt } from "./line-4e7c049f.js";
...
function ee(t) {
  ...
  for (let f = 0; f < c; ++f) {
    ...
    for (let y = 0; y < 80; ++y) {
      const M = Math.floor(y / 20), D = st(h, 5) + te(M, _, g, E) + O + r[M] + l[y] >>> 0;
