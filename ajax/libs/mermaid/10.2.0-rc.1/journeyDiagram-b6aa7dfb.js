import { c as V, y as gt, z as mt, s as xt, g as _t, b as kt, a as vt, m as bt, A as wt, j as Z, k as Tt } from "./mermaid-29dd296b.js";
import { d as st } from "./arc-77507825.js";
...
`);
  ...
  for (const [f, d] of t.entries()) {
    if (s !== d.section) {
      ...
      B.drawSection(e, n, r), s = d.section, y++;
    }
    const T = d.people.reduce((v, _) => (P[_] && (v[_] = P[_]), v), {});
    d.x = f * r.taskMargin + f * r.width + C, d.y = l, d.width = r.diagramMarginX, d.height = r.diagramMarginY, d.colour = x, d.fill = u, d.num = g, d.actors = T, B.drawTask(e, d, r), S.insert(d.x, d.y, d.x + d.width + r.taskMargin, 300 + 5 * 30);
  }
}, ct = {
  setConf: Wt,
  draw: Gt
