import { V as it, c as U, s as gt, g as dt, y as mt, z as _t, a as vt, b as kt, m as bt, f as xt, l as B, A as St, j as nt, k as wt, X as At } from "./mermaid-29dd296b.js";
import { i as Et } from "./init-f9637058.js";
import { a as Dt } from "./array-2ff2c7a6.js";
import { c as z } from "./constant-2fe7eae5.js";
import { d as lt } from "./arc-77507825.js";
...
var rt = function() {
  var t = function(k, e, i, a) {
    ...
    parse: function(e) {
      var i = this, a = [0], n = [], f = [null], r = [], p = this.table, d = "", F = 0, X = 0, K = 2, q = 1, ft = r.slice.call(arguments, 1), _ = Object.create(this.lexer), M = { yy: {} };
...
Expecting ` + H.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : et = "Parse error on line " + (F + 1) + ": Unexpected " + (b == q ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(et, {
        ...
        switch (S[0]) {
          case 1:
            a.push(b), f.push(_.yytext), r.push(_.yylloc), a.push(S[1]), b = null, X = _.yyleng, d = _.yytext, F = _.yylineno, Z = _.yylloc;
            break;
          case 2:
...
const Nt = function(t, s, c) {
  ...
  t = xt.sanitizeText(t, U()), J[t] === void 0 && (J[t] = s, B.debug("Added new section :", t));
}, Ct = () => J, Ft = function(t) {
  st = t;
}, Mt = function() {
  return st;
...
` + t);
    ...
    var I = g.selectAll(".legend").data(x.domain()).enter().append("g").attr("class", "legend").attr("transform", function(p, d) {
      const F = u + h, X = F * x.domain().length / 2, K = 12 * u, q = d * F - X;
