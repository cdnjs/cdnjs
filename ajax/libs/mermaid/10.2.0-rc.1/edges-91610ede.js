import { l as x, q as H, c as w, as as O, j as v, d as Z, x as U, B as F } from "./mermaid-29dd296b.js";
import { c as P } from "./createText-742d30a7.js";
import { p as Q } from "./svgDraw-69fa6853.js";
import { l as et } from "./line-4e7c049f.js";
const st = (r, t, e, n) => {
  t.forEach((a) => {
    yt[a](r, e, n);
  });
...
const ar = () => {
  ...
  if (t.startLabelLeft) {
    ...
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), L[t.id] || (L[t.id] = {}), L[t.id].startLeft = o, j(l, t.startLabelLeft);
  }
  if (t.startLabelRight) {
    ...
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), L[t.id] || (L[t.id] = {}), L[t.id].startRight = o, j(l, t.startLabelRight);
  }
  if (t.endLabelLeft) {
    const c = T(t.endLabelLeft, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), o.node().appendChild(c), L[t.id] || (L[t.id] = {}), L[t.id].endLeft = o, j(l, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const c = T(t.endLabelRight, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), o.node().appendChild(c), L[t.id] || (L[t.id] = {}), L[t.id].endRight = o, j(l, t.endLabelRight);
  }
  return n;
};
function j(r, t) {
