import { V as H, W as at, B as lt, D as ot, s as ct, g as ht, b as ut, a as yt, E as ft, d as pt, c as et, l as it, X as gt, U as dt, k as mt, Y as _t } from "./mermaid-d06ecb0d.js";
import { d as tt } from "./arc-1bdcaf65.js";
...
var J = function() {
  var e = function(x, t, i, n) {
    ...
    parse: function(t) {
      var i = this, n = [0], a = [], o = [null], s = [], V = this.table, m = "", p = 0, P = 0, z = 2, j = 1, B = s.slice.call(arguments, 1), y = Object.create(this.lexer), N = { yy: {} };
...
Expecting ` + W.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : q = "Parse error on line " + (p + 1) + ": Unexpected " + (_ == j ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(q, {
        ...
        switch (b[0]) {
          case 1:
            n.push(_), o.push(y.yytext), s.push(y.yylloc), n.push(b[1]), _ = null, P = y.yyleng, m = y.yytext, p = y.yylineno, X = y.yylloc;
            break;
          case 2:
...
const wt = structuredClone(nt), At = () => structuredClone(wt), $t = () => {
  ...
  e = pt(e, et()), U[e] === void 0 && (U[e] = h, it.debug(`added new section: ${e}, with value: ${h}`));
...
` + e);
  ...
  const s = d.selectAll(".legend").data(a.domain()).enter().append("g").attr("class", "legend").attr("transform", (p, P) => {
    const z = v + w, j = z * a.domain().length / 2, B = 12 * v, y = P * z - j;
