...
const dayjsCustomParseFormat = function(o, C, d) {
  ...
  proto.parse = function(cfg) {
    ...
    if (typeof format === "string") {
      ...
      this.$d = parseFormattedInput(date2, format, utc);
      this.init();
      if (pl && pl !== true)
