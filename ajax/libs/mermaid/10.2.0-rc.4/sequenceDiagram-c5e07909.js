import { g as me, A as we, z as _e, c as lt, s as te, b as ke, a as Le, m as Pe, B as Ie, l as K, d as It, e as ee, f as _, T as ne, a2 as Ne, h as ve, j as Pt, k as Ae, x as C } from "./mermaid-f9e1d345.js";
import { d as Se, a as Me, b as Re, c as De, e as zt, g as Nt } from "./svgDrawCommon-a1b854f7.js";
import { s as Ve } from "./selectAll-1ca3f704.js";
var Bt = function() {
...
const de = (t, e) => {
  ...
  if (e.rectData = u, e.properties != null && e.properties.icon) {
    ...
    p.charAt(0) === "@" ? Re(l, u.x + u.width - 20, u.y + 10, p.substr(1)) : De(l, u.x + u.width - 20, u.y + 10, p);
  }
  Kt(r)(
    e.description,
    l,
...
const S0 = function(t, e, r, n) {
  ...
  let i = 0, s = 0;
  for (const c of r) {
    const l = e[c], u = D0(l), d = D.drawPopup(
      t,
      l,
      u,
      a,
...
const M0 = function(t, e, r, n) {
  ...
  f.init(), K.debug(n.db);
  const d = i === "sandbox" ? l.select(`[id="${e}"]`) : Pt(`[id="${e}"]`), T = n.db.getActors(), y = n.db.getBoxes(), p = n.db.getActorKeys(), x = n.db.getMessages(), w = n.db.getDiagramTitle(), I = n.db.hasAtLeastOneBox(), A = n.db.hasAtLeastOneBoxWithTitle(), M = R0(T, x, n);
  a.height = V0(T, M, y), D.insertComputerIcon(d), D.insertDatabaseIcon(d), D.insertClockIcon(d), I && (f.bumpVerticalPos(a.boxMargin), A && f.bumpVerticalPos(y[0].textMaxHeight)), qt(d, T, p, 0, a, x, !1);
  const N = B0(x, T, M, n);
  ...
  x.forEach(function(m) {
    ...
    switch (m.type) {
      case n.db.LINETYPE.NOTE:
        f.resetVerticalPos(), j = m.noteModel, v0(d, j);
        break;
      ...
      default:
        try {
          ...
          const v = A0(d, L);
          G.push({ messageModel: L, lineStartY: v }), f.models.addMessage(L);
        } catch (v) {
  ...
  }), G.forEach((m) => S0(d, m.messageModel, m.lineStartY, n)), a.mirrorActors && (f.bumpVerticalPos(a.boxMargin * 2), qt(d, T, p, f.getVerticalPos(), a, x, !0), f.bumpVerticalPos(a.boxMargin), de(d, f.getVerticalPos())), f.models.boxes.forEach(function(m) {
  ...
  K.debug("For line height fix Querying: #" + e + " .actor-line"), Ve("#" + e + " .actor-line").attr("y2", O.stopy);
  ...
  w && d.append("text").text(w).attr("x", (O.stopx - O.startx) / 2 - 2 * a.diagramMarginX).attr("y", -25), Ae(d, q, J, a.useMaxWidth);
  const Q = w ? 40 : 0;
  d.attr(
    "viewBox",
...
const C0 = function(t, e, r) {
  ...
  return t.forEach(function(d) {
    switch (d.id = C.random({ length: 10 }), d.type) {
      ...
      case n.db.LINETYPE.ACTIVE_START:
        {
          const y = e[d.from ? d.from.actor : d.to.actor], p = At(d.from ? d.from.actor : d.to.actor).length, x = y.x + y.width / 2 + (p - 1) * a.activationWidth / 2, w = {
            startx: x,
    ...
    d.placement !== void 0 ? (l = C0(d, e, n), d.noteModel = l, s.forEach((y) => {
