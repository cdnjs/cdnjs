import { X as cn, Z as D, $ as U, a0 as Y, a1 as hn } from "./mermaid-f9e1d345.js";
...
function Rn(n) {
  ...
  function f(c) {
    ...
    d === "n" ? (L = !0, d = "g") : J[d] || (w === void 0 && (w = 12), G = !0, d = "g"), (k || m === "0" && p === "=") && (k = !0, m = "0", p = "=");
    ...
    function V(s) {
      ...
      if (d === "c")
        ...
        s = +s;
        var P = s < 0 || 1 / s < 0;
        if (s = isNaN(s) ? h : O(Math.abs(s), w), G && (s = $n(s)), P && +s == 0 && M !== "+" && (P = !1), N = (P ? M === "(" ? M : u : M === "-" || M === "(" ? "" : M) + N, g = (d === "s" ? W[8 + rn / 3] : "") + g + (P && M === "(" ? ")" : ""), fn) {
