...
// ../parser/dist/chunks/mermaid-parser.core/chunk-CDQIA6O3.mjs
...
var MermaidAstReflection = class extends AbstractAstReflection {
  ...
  getAllTypes() {
    return [Architecture, Branch, Checkout, CherryPicking, Commit, Common, Direction, Edge, GitGraph, Group2, Info, Junction, Merge, Packet, PacketBlock, Pie, PieSection, Service, Statement];
  }
  computeIsSubtype(subtype, supertype) {
    switch (subtype) {
      case Branch:
