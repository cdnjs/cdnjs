...
const fs = "10.5.0-rc.1", si = Object.freeze(dp);
...
const vr = (t, e) => {
  ...
  const { diagram: t } = await import("./c4Diagram-12be1abe.js");
  ...
  const { diagram: t } = await import("./flowDiagram-1dfcd976.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-d795bc77.js");
  ...
  const { diagram: t } = await import("./erDiagram-db16a1f5.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-55eb6e0f.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-2cd711a9.js");
  ...
  const { diagram: t } = await import("./infoDiagram-9d790972.js");
  ...
  const { diagram: t } = await import("./pieDiagram-eedd51e5.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-77c060f8.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-2e9121aa.js");
  ...
  const { diagram: t } = await import("./sequenceDiagram-c814e7fd.js");
  ...
  const { diagram: t } = await import("./classDiagram-fb5791e4.js");
  ...
  const { diagram: t } = await import("./classDiagram-v2-b5542164.js");
  return { id: Cl, diagram: t };
}, Z_ = {
  id: Cl,
  detector: X_,
  ...
  const { diagram: t } = await import("./stateDiagram-ceb24925.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-7601fcf2.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-16b9f3e3.js");
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-74010886.js");
  ...
  const { diagram: t } = await import("./timeline-definition-1005be1f.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-6563d6f4.js");
  return { id: Bl, diagram: t };
}, Ly = {
  id: Bl,
  detector: By,
  ...
  const { diagram: t } = await import("./sankeyDiagram-968d02e8.js");
  return { id: Fl, diagram: t };
}, Oy = {
  id: Fl,
  detector: Ey,
