...
import { b as bisector, t as tickStep, c as continuous, a as copy, l as linear } from "./linear-30ff326f.js";
...
const timeMillisecond = millisecond;
millisecond.range;
...
function time() {
  return initRange.apply(calendar(timeTicks, timeTickInterval, timeYear, timeMonth, sunday, timeDay, timeHour, timeMinute, timeSecond, timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
var parser = function() {
