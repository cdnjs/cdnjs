...
var AtlasCollection = /* @__PURE__ */ function() {
  ...
  _createClass(AtlasCollection2, [{
    ...
    key: "draw",
    value: /* @__PURE__ */ __name(function draw(id2, key, bb, doDrawing) {
    ...
    key: "deleteKey",
    value: /* @__PURE__ */ __name(function deleteKey(id2, key) {
      this.idToKey["delete"](id2);
      this.getIdsFor(key)["delete"](id2);
    }, "deleteKey")
  }, {
    key: "checkKeyIsInvalid",
    value: /* @__PURE__ */ __name(function checkKeyIsInvalid(id2, newKey) {
...
var AtlasManager = /* @__PURE__ */ function() {
  ...
  _createClass(AtlasManager2, [{
    ...
    key: "isRenderable",
    value: /* @__PURE__ */ __name(function isRenderable(ele, type) {
    ...
    value: /* @__PURE__ */ __name(function getOrCreateAtlas(ele, bb, type) {
    ...
    value: /* @__PURE__ */ __name(function canAddToCurrentBatch(ele, type) {
      if (this.batchAtlases.length === this.maxAtlasesPerBatch) {
        var opts = this.renderTypes.get(type);
        var styleKey = opts.getKey(ele);
    ...
    key: "getAdjustedBB",
    value: /* @__PURE__ */ __name(function getAdjustedBB(bb, padding, first2, ratio) {
      var x1 = bb.x1, y1 = bb.y1, w = bb.w, h = bb.h;
      if (padding) {
        x1 -= padding;
        y1 -= padding;
...
var ElementDrawingWebGL = /* @__PURE__ */ function() {
  ...
  _createClass(ElementDrawingWebGL2, [{
    ...
    value: /* @__PURE__ */ __name(function addTextureRenderType(type, opts) {
    ...
    value: /* @__PURE__ */ __name(function getCurveSegmentPoints(controlPoints3, segments) {
      if (controlPoints3.length == 4) {
        return controlPoints3;
      }
    ...
    key: "setCurvePoint",
    value: /* @__PURE__ */ __name(function setCurvePoint(points, t, curvePoints, cpi) {
      if (points.length <= 2) {
...
var OverlayUnderlayRenderer = /* @__PURE__ */ function() {
  ...
  _createClass(OverlayUnderlayRenderer2, [{
    key: "getStyleKey",
    value: /* @__PURE__ */ __name(function getStyleKey(type, node) {
    ...
    key: "isVisible",
    value: /* @__PURE__ */ __name(function isVisible(type, node) {
      var opacity = node.pstyle("".concat(type, "-opacity")).value;
      return opacity > 0;
    }, "isVisible")
  }, {
    key: "getStyle",
    value: /* @__PURE__ */ __name(function getStyle(type, node) {
      var opacity = node.pstyle("".concat(type, "-opacity")).value;
    ...
    key: "getPadding",
    value: /* @__PURE__ */ __name(function getPadding(type, node) {
      return node.pstyle("".concat(type, "-padding")).pfValue;
    }, "getPadding")
  }, {
    key: "draw",
    value: /* @__PURE__ */ __name(function draw(type, context, node, bb) {
...
function drawAtlases(r) {
  var draw = /* @__PURE__ */ __name(function draw2(drawing, renderType, row) {
...
function renderWebgl(r, options2, renderTarget) {
  ...
  if (r.data.canvasNeedsRedraw[r.NODE] || renderTarget.picking) {
    var draw = /* @__PURE__ */ __name(function draw2(ele, index) {
      index += 1;
      if (ele.isNode()) {
