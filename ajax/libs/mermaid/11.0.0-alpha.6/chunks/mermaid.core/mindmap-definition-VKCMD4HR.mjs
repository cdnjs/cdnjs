...
var parser = function() {
  ...
  var parser2 = {
    ...
    parseError: /* @__PURE__ */ __name(function parseError2(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
...
var mindmapDb_exports = {};
__export(mindmapDb_exports, {
  addNode: () => addNode,
  clear: () => clear,
...
var sanitizeText2 = /* @__PURE__ */ __name((text) => sanitizeText(text, getConfig()), "sanitizeText");
var nodes = [];
var cnt = 0;
var elements = {};
...
var parseError;
var setErrorHandler = /* @__PURE__ */ __name((handler) => {
  parseError = handler;
}, "setErrorHandler");
var getLogger = /* @__PURE__ */ __name(() => log, "getLogger");
var getNodeById = /* @__PURE__ */ __name((id) => nodes[id], "getNodeById");
...
var rectBkg = /* @__PURE__ */ __name(function(elem, node) {
...
var cloudBkg = /* @__PURE__ */ __name(function(elem, node) {
  const w = node.width;
  const h = node.height;
  const r1 = 0.15 * w;
  const r2 = 0.25 * w;
...
var bangBkg = /* @__PURE__ */ __name(function(elem, node) {
  const w = node.width;
  const h = node.height;
  const r = 0.15 * w;
  elem.append("path").attr("id", "node-" + node.id).attr("class", "node-bkg node-" + type2Str(node.type)).attr(
...
var circleBkg = /* @__PURE__ */ __name(function(elem, node) {
...
var hexagonBkg = /* @__PURE__ */ __name(function(elem, node) {
  const h = node.height;
  const f = 4;
  const m = h / f;
...
var roundedRectBkg = /* @__PURE__ */ __name(function(elem, node) {
...
var drawEdge = /* @__PURE__ */ __name(function drawEdge2(edgesElem, mindmap, parent, depth, fullSection) {
  const section = fullSection % (MAX_SECTIONS - 1);
...
var positionNode = /* @__PURE__ */ __name(function(node) {
  const nodeElem = getElementById(node.id);
  const x = node.x || 0;
  const y = node.y || 0;
  nodeElem.attr("transform", "translate(" + x + "," + y + ")");
}, "positionNode");
var svgDraw_default = { drawNode, positionNode, drawEdge };
...
function drawNodes(svg, mindmap, section, conf) {
  svgDraw_default.drawNode(svg, mindmap, section, conf);
  if (mindmap.children) {
...
function layoutMindmap(node, conf) {
  return new Promise((resolve) => {
    const renderEl = select2("body").append("div").attr("id", "cy").attr("style", "display:none");
    const cy = cytoscape({
...
function positionNodes(cy) {
  cy.nodes().map((node, id) => {
    ...
    svgDraw_default.positionNode(data);
...
var draw = /* @__PURE__ */ __name(async (text, id, version, diagObj) => {
  const conf = getConfig();
