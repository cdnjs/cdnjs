...
var addVertex = /* @__PURE__ */ __name(function(_id, textObj, type, style, classes2, dir, props = {}) {
  let txt;
  let id = _id;
  if (id === void 0) {
    return;
...
var updateLinkInterpolate = /* @__PURE__ */ __name(function(positions, interp) {
...
var addVertices = /* @__PURE__ */ __name(function(vert, g, svgId, root, doc, diagObj) {
...
var addEdges = /* @__PURE__ */ __name(function(edges2, g, diagObj) {
