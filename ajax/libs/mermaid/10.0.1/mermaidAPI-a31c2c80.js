...
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-8889d224.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-f287d002.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-1c493a4f.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-417dde94.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-8df9bfe0.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-c5c3511a.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-acd93334.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-2a3b1d9b.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-3e33df24.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-ffa2ea72.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-cd41be19.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-7564dbca.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-3a9af217.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-6094bd92.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-300118e1.js");
...
//# sourceMappingURL=mermaidAPI-a31c2c80.js.map
