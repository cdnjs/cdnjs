import { l as y, p as I, c as b, aR as Q, j as E, d as V, z as A, F as lt } from "./mermaid-635594ce.js";
import { a as et } from "./createText-e0cdef87.js";
import { l as ct } from "./line-5fd5224c.js";
const ht = (r, t, a, i) => {
  t.forEach((s) => {
    wt[s](r, a, i);
  });
...
const At = (r, t) => {
  ...
  return E(M).attr(
    ...
    const L = k == null ? void 0 : k.getBBox();
    p += ((L == null ? void 0 : L.height) ?? 0) + i;
  }), l.attr("class", "outer title-state").attr("x", -h / 2 - a).attr("y", -(f / 2) - a).attr("width", h + t.padding).attr("height", f + t.padding), v(t, l), t.intersect = function(k) {
    return w.rect(t, k);
  }, n;
}, tt = {
  rhombus: K,
