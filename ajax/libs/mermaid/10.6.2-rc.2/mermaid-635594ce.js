...
const ds = "10.6.2-rc.2", Oe = Object.freeze(mp);
...
const Sr = (t, e) => {
  ...
  const { diagram: t } = await import("./c4Diagram-0769eab5.js");
  ...
  const { diagram: t } = await import("./flowDiagram-d5379580.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-de2ec4ab.js");
  ...
  const { diagram: t } = await import("./erDiagram-6c3ba6c2.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-c8e5f92e.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-6adf8f3f.js");
  ...
  const { diagram: t } = await import("./infoDiagram-503d942d.js");
  ...
  const { diagram: t } = await import("./pieDiagram-50e13798.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-4a79d674.js");
  ...
  const { diagram: t } = await import("./xychartDiagram-9b2fd51a.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-dce38f1b.js");
  return { id: Cl, diagram: t };
}, Gy = {
  id: Cl,
  detector: Uy,
  ...
  const { diagram: t } = await import("./sequenceDiagram-5967f3c1.js");
  ...
  const { diagram: t } = await import("./classDiagram-2c724adb.js");
  ...
  const { diagram: t } = await import("./classDiagram-v2-b09e1149.js");
  ...
  const { diagram: t } = await import("./stateDiagram-21ff2fbd.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-1ca880cf.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-4184f07c.js");
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-08e9fcec.js");
  return { id: Fl, diagram: t };
}, Y_ = {
  id: Fl,
  detector: j_,
  ...
  const { diagram: t } = await import("./timeline-definition-9924cc78.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-9fbfd3df.js");
  ...
  const { diagram: t } = await import("./sankeyDiagram-77521454.js");
