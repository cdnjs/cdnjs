import { d as Xe, c as F, G as ye, s as We, g as qe, a as He, b as Je, B as Ze, D as $e, f as v, E as et, l as tt, z as Pe, j as U } from "./mermaid-635594ce.js";
var De = function() {
  var e = function(L, u, r, h) {
    for (r = r || {}, h = L.length; h--; r[L[h]] = u)
      ;
    return r;
  }, n = [1, 16], a = [1, 17], o = [1, 18], l = [1, 37], A = [1, 38], g = [1, 24], D = [1, 22], B = [1, 23], _ = [1, 29], ne = [1, 30], ue = [1, 31], re = [1, 32], ae = [1, 33], le = [1, 34], ce = [1, 25], oe = [1, 26], he = [1, 27], Ae = [1, 28], d = [1, 42], E = [1, 39], C = [1, 40], m = [1, 41], k = [1, 43], pe = [1, 9], c = [1, 8, 9], Y = [1, 54], K = [1, 55], j = [1, 56], Q = [1, 57], X = [1, 58], fe = [1, 59], de = [1, 60], W = [1, 8, 9, 38], Ne = [1, 71], V = [1, 8, 9, 12, 13, 21, 36, 38, 41, 58, 59, 60, 61, 62, 63, 64, 69, 71], q = [1, 8, 9, 12, 13, 19, 21, 36, 38, 41, 45, 58, 59, 60, 61, 62, 63, 64, 69, 71, 84, 86, 87, 88, 89], H = [13, 84, 86, 87, 88, 89], G = [13, 63, 64, 84, 86, 87, 88, 89], ve = [13, 58, 59, 60, 61, 62, 84, 86, 87, 88, 89], Ee = [1, 90], Ce = [1, 8, 9, 36, 38, 41], J = [1, 8, 9, 21], me = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(u, r, h, i, p, t, M) {
      var s = t.length - 1;
      switch (p) {
        case 8:
          this.$ = t[s - 1];
    ...
    parse: function(u) {
      var r = this, h = [0], i = [], p = [null], t = [], M = this.table, s = "", Z = 0, Le = 0, Ye = 2, xe = 1, Ke = t.slice.call(arguments, 1), b = Object.create(this.lexer), I = { yy: {} };
      ...
      function Qe() {
        var N;
        return N = i.pop() || b.lex() || xe, typeof N != "number" && (N instanceof Array && (i = N, N = i.pop()), N = r.symbols_[N] || N), N;
      }
      for (var T, O, y, Te, P = {}, $, S, Ie, ee; ; ) {
        if (O = h[h.length - 1], this.defaultActions[O] ? y = this.defaultActions[O] : ((T === null || typeof T > "u") && (T = Qe()), y = M[O] && M[O][T]), typeof y > "u" || !y.length || !y[0]) {
          var Fe = "";
          ee = [];
          for ($ in M[O])
...
Expecting ` + ee.join(", ") + ", got '" + (this.terminals_[T] || T) + "'" : Fe = "Parse error on line " + (Z + 1) + ": Unexpected " + (T == xe ? "end of input" : "'" + (this.terminals_[T] || T) + "'"), this.parseError(Fe, {
        ...
        switch (y[0]) {
          case 1:
            h.push(T), p.push(b.yytext), t.push(b.yylloc), h.push(y[1]), T = null, Le = b.yyleng, s = b.yytext, Z = b.yylineno, ke = b.yylloc;
            break;
          case 2:
            if (S = this.productions_[y[1]][1], P.$ = p[p.length - S], P._$ = {
              ...
              return Te;
            S && (h = h.slice(0, -1 * S * 2), p = p.slice(0, -1 * S), t = t.slice(0, -1 * S)), h.push(this.productions_[y[1]][0]), p.push(P.$), t.push(P._$), Ie = M[h[h.length - 2]][h[h.length - 1]], h.push(Ie);
            break;
          case 3:
            return !0;
        }
    ...
    var L = {
      ...
      unput: function(u) {
        ...
        return this.yylloc = {
          ...
          last_column: h ? (h.length === i.length ? this.yylloc.first_column : 0) + i[i.length - h.length].length - h[0].length : this.yylloc.first_column - r
...
` + r + "^";
      ...
      test_match: function(u, r) {
        ...
        }, this.yytext += u[0], this.match += u[0], this.matches = u, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(u[0].length), this.matched += u[0], h = this.performAction.call(this, this.yy, this, r, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), h)
          return h;
        if (this._backtrack) {
          for (var t in p)
            this[t] = p[t];
      ...
      next: function() {
        ...
        for (var p = this._currentRules(), t = 0; t < p.length; t++)
          if (h = this._input.match(this.rules[p[t]]), h && (!r || h[0].length > r[0].length)) {
            if (r = h, i = t, this.options.backtrack_lexer) {
              if (u = this.test_match(h, p[t]), u !== !1)
                return u;
              if (this._backtrack) {
                r = !1;
                continue;
        ...
        return r ? (u = this.test_match(r, p[i]), u !== !1 ? u : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: function(r, h, i, p) {
        switch (i) {
          case 0:
            return 52;
          case 1:
...
class Re {
  ...
  parseMember(n) {
    ...
    if (this.memberType === "method") {
      const o = /([#+~-])?(.+)\((.*)\)([\s$*])?(.*)([$*])?/, l = n.match(o);
      if (l) {
        const A = l[1] ? l[1].trim() : "";
        if (Oe.includes(A) && (this.visibility = A), this.id = l[2].trim(), this.parameters = l[3] ? l[3].trim() : "", a = l[4] ? l[4].trim() : "", this.returnType = l[5] ? l[5].trim() : "", a === "") {
          const g = this.returnType.substring(this.returnType.length - 1);
          g.match(/[$*]/) && (a = g, this.returnType = this.returnType.substring(0, this.returnType.length - 1));
        }
      }
    } else {
      const o = n.length, l = n.substring(0, 1), A = n.substring(o - 1);
      Oe.includes(l) && (this.visibility = l), A.match(/[$*]/) && (a = A), this.id = n.substring(
        this.visibility === "" ? 0 : 1,
        a === "" ? o : o - 1
      );
    }
...
const R = (e) => v.sanitizeText(e, F()), w = function(e) {
  ...
  return { className: o, type: a };
}, st = function(e, n) {
  const a = v.sanitizeText(e, F());
  n && (n = R(n));
  const { className: o } = w(a);
  f[o].label = n;
}, se = function(e) {
  const n = v.sanitizeText(e, F()), { className: a, type: o } = w(n);
  if (Object.hasOwn(f, a))
    return;
  const l = v.sanitizeText(a, F());
  f[l] = {
    id: l,
    type: o,
    label: l,
  ...
  tt.debug("Adding relation: " + JSON.stringify(e)), se(e.id1), se(e.id2), e.id1 = w(e.id1).className, e.id2 = w(e.id2).className, e.relationTitle1 = v.sanitizeText(e.relationTitle1.trim(), F()), e.relationTitle2 = v.sanitizeText(e.relationTitle2.trim(), F()), _e.push(e);
}, ct = function(e, n) {
  const a = w(e).className;
  f[a].annotations.push(n);
}, Ge = function(e, n) {
  se(e);
  const a = w(e).className, o = f[a];
  if (typeof n == "string") {
    const l = n.trim();
    l.startsWith("<<") && l.endsWith(">>") ? o.annotations.push(R(l.substring(2, l.length - 2))) : l.indexOf(")") > 0 ? o.methods.push(new Re(l, "method")) : l && o.members.push(new Re(l, "attribute"));
  }
}, ot = function(e, n) {
  Array.isArray(n) && (n.reverse(), n.forEach((a) => Ge(e, a)));
}, ht = function(e, n) {
  const a = {
    id: `note${te.length}`,
    class: n,
  ...
  e.split(",").forEach(function(a) {
    let o = a;
    a[0].match(/\d/) && (o = ie + o), f[o] !== void 0 && f[o].cssClasses.push(n);
  });
}, pt = function(e, n) {
  e.split(",").forEach(function(a) {
    n !== void 0 && (f[a].tooltip = R(n));
  });
}, ft = function(e, n) {
  ...
  e.split(",").forEach(function(l) {
    let A = l;
    l[0].match(/\d/) && (A = ie + A), f[A] !== void 0 && (f[A].link = Pe.formatUrl(n, o), o.securityLevel === "sandbox" ? f[A].linkTarget = "_top" : typeof a == "string" ? f[A].linkTarget = R(a) : f[A].linkTarget = "_blank");
  }), Se(e, "clickable");
}, Et = function(e, n, a) {
  e.split(",").forEach(function(o) {
    Ct(o, n, a), f[o].haveCallback = !0;
  }), Se(e, "clickable");
}, Ct = function(e, n, a) {
  const o = v.sanitizeText(e, F());
...
const kt = () => Ue, Tt = (e) => {
  ...
  if (x[e] !== void 0)
    for (const a of n) {
      const { className: o } = w(a);
      f[o].parent = e, x[e].classes[o] = f[o];
    }
}, vt = {
  setAccTitle: We,
  getAccTitle: qe,
