...
import { p as decodeEntities } from "./mermaidAPI-b1da2278.js";
...
const rect = (parent, node) => {
  ...
  rect2.attr("class", "basic label-container").attr("style", node.style).attr("rx", node.rx).attr("ry", node.ry).attr("x", -bbox.width / 2 - node.padding).attr("y", -bbox.height / 2 - node.padding).attr("width", totalWidth).attr("height", totalHeight);
  if (node.props) {
...
//# sourceMappingURL=edges-b51cdd98.js.map
