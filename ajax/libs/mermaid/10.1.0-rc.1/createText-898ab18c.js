...
import { p as ut } from "./mermaidAPI-12c6e56f.js";
...
`).replace(ct, "").replace(ot, "    ");
  ...
  r.sort(function(i, u) {
    ...
    if (s !== p)
      return s - p;
    var h = c.quality ? 0 : 1, d = f.quality ? 0 : 1;
    return h !== d ? h - d : i < u ? -1 : i > u ? 1 : 0;
  });
  var a, l = function i(u, c) {
    var f = [];
    for (c = c || a, a = c; u; ) {
      var s = null, p = null, h = null, d = NaN, S = 0, x = r[0], y = t[x];
      do {
        var b = y.order, w = c.prevCapture == null ? "" : c.prevCapture[0], k = y.match(u, c, w);
        if (k) {
          var A = y.quality ? y.quality(k, c, w) : 0;
          A <= d || (s = x, p = y, h = k, d = A);
        }
        S++, x = r[S], y = t[x];
      } while (
...
` + u);
      ...
      if (Array.isArray(E))
        ...
        if (E == null || typeof E != "object")
          throw new Error("parse() function returned invalid parse result: '".concat(E, "'"));
        E.type == null && (E.type = s), f.push(E);
      }
...
`), a.prevCapture = null, l(J(u), a);
  ...
  return e.regex = t, e;
}, ft = typeof Symbol == "function" && Symbol.for && Symbol.for("react.element") || 60103, g = function(t, e, r) {
  var a = {
    $$typeof: ft,
    type: t,
    key: e ?? void 0,
...
*$)`), xt = /(?:^|\n)( *)$/, P = function() {
  var n = /^ *\| *| *\| *$/g, t = / *$/, e = /^ *-+: *$/, r = /^ *:-+: *$/, a = /^ *:-+ *$/, l = function(s) {
    ...
    return x.forEach(function(b, w) {
      b.type === "tableSeparator" ? (!d || w !== 0 && w !== x.length - 1) && y.push([]) : (b.type === "text" && (x[w + 1] == null || x[w + 1].type === "tableSeparator") && (b.content = b.content.replace(t, "")), y[y.length - 1].push(b));
    }), y;
  }, u = function(s, p, h, d) {
    var S = s.trim().split(`
`);
    ...
    return function(p, h, d) {
      d.inline = !0;
      var S = i(p[1], h, d, s), x = o(p[2], h, d, s), y = u(p[3], h, d, s);
      return d.inline = !1, {
        type: "table",
        header: S,
        align: x,
  ...
  heading: {
    ...
    react: function(t, e, r) {
      return g("h" + t.level, r.key, {
        children: e(t.content, r)
      });
    },
    html: function(t, e, r) {
      return v("h" + t.level, e(t.content, r));
    }
  },
  nptable: {
    order: m++,
  ...
  codeBlock: {
    ...
    html: function(t, e, r) {
      var a = t.lang ? "markdown-code-" + t.lang : void 0, l = v("code", R(t.content), {
        class: a
      });
      return v("pre", l);
    }
  ...
  blockQuote: {
    ...
    react: function(t, e, r) {
      return g("blockquote", r.key, {
        children: e(t.content, r)
      });
    },
    html: function(t, e, r) {
      return v("blockquote", e(t.content, r));
    }
  },
  list: {
    order: m++,
...
`).match(gt), i = !1, u = o.map(function(c, f) {
        var s = K.exec(c), p = s ? s[0].length : 0, h = new RegExp("^ {1," + p + "}", "gm"), d = c.replace(h, "").replace(K, ""), S = f === o.length - 1, x = d.indexOf(`
...
`) !== -1, y = x || S && i;
        ...
        e._list = !0;
        var k;
        y ? (e.inline = !1, k = d.replace(z, `

`)) : (e.inline = !0, k = d.replace(z, ""));
        var A = t(k, e);
  ...
  table: {
    ...
    html: function(t, e, r) {
      var a = function(f) {
        ...
        return v("tr", f);
      }).join(""), i = v("thead", v("tr", l)), u = v("tbody", o);
      return v("table", i + u);
    }
  },
  newline: {
...
`;
  ...
  strong: {
    ...
    parse: O,
    react: function(t, e, r) {
      return g("strong", r.key, {
        children: e(t.content, r)
      });
    },
    html: function(t, e, r) {
      return v("strong", e(t.content, r));
    }
  },
  u: {
    order: m++,
  ...
  return e.children = rt(t.source), g("div", null, e);
}, at = {
  defaultRules: L,
  parserFor: V,
  outputFor: H,
...
function Y(n, t) {
  n.text(""), t.forEach((e, r) => {
    ...
    r !== 0 && [
      ...
      "{",
      "}"
    ].includes(e.content) ? a.text(e.content) : a.text(" " + e.content);
  });
}
const Nt = (n, t = "", {
  style: e = "",
...
//# sourceMappingURL=createText-898ab18c.js.map
