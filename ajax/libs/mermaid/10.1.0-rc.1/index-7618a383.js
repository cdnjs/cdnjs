import { b as G, a as b, m as D, G as j, l as A } from "./layout-05c0c491.js";
import { c as O, i as X, a as M, b as _, d as $, u as H, s as V, e as U, f as W, p as B, g as Y, h as q } from "./edges-1ecdb580.js";
import { l as i, m as N, g as E, h as L } from "./commonDb-41f8b4c5.js";
import { c as z } from "./createText-898ab18c.js";
var K = 4;
function Q(e) {
  return G(e, K);
}
...
const tt = () => {
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (i.warn(
      ...
      v(n, e)
    ), x[n] = R(n, e), f[n] = { id: v(n, e), clusterData: e.node(n) });
  }), e.nodes().forEach(function(n) {
  ...
  t.width <= l.width + d ? t.diff = (l.width - t.width) / 2 - t.padding / 2 : t.diff = -t.padding / 2, i.trace("Data ", t, JSON.stringify(t)), r.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("x", t.x - w / 2).attr("y", t.y - t.height / 2 - g).attr("width", w).attr("height", t.height + d), a.attr(
    "transform",
...
const lt = (e, t) => {
  ...
  t.nodes().forEach(function(c) {
    ...
    if (i.info("(Insert) Node XXX" + c + ": " + JSON.stringify(t.node(c))), o && o.clusterNode) {
      ...
      t.children(c).length > 0 ? (i.info("Cluster - the non recursive path XXX", c, o.id, o, t), i.info(v(o.id, t)), f[o.id] = { id: v(o.id, t), node: o }) : (i.info("Node - the non recursive path", c, o.id, o), U(g, t.node(c), s));
...
//# sourceMappingURL=index-7618a383.js.map
