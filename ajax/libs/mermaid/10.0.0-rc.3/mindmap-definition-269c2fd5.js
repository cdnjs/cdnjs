import { w as sanitizeText$1, g as getConfig, l as log, s as select, a as setupGraphViewbox, u as lighten, v as darken } from "./mermaid-be6c5b5d.js";
import { i as isDark } from "./is_dark-69368466.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-a2fbbaa3.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-c3576259.js").then((n) => n.c)).default;
...
//# sourceMappingURL=mindmap-definition-269c2fd5.js.map
