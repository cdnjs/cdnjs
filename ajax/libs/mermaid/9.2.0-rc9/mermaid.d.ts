 ...
 * @deprecated This is an internal function and should not be used. Will be removed in v10.
 */
declare const parseAsync: (txt: string) => Promise<unknown>;
/**
 * @param txt
 * @param id
 * @param delay
 ...
 * @deprecated This is an internal function and should not be used. Will be removed in v10.
 */
declare const renderAsync: (id: string, text: string, cb: (svgCode: string, bindFunctions?: ((element: Element) => void) | undefined) => void, container?: Element) => Promise<void>;
