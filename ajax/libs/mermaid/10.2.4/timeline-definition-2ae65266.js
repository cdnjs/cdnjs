import { ax as bt, ay as kt, B as vt, j as Z, c as wt, l as T, t as St, az as Et, aA as Tt, aB as It } from "./mermaid-be6aa4a6.js";
...
`), T.debug("timeline", s.db);
  ...
  let y;
  l === "sandbox" && (y = Z("#i" + t));
  const d = (l === "sandbox" ? Z(y.nodes()[0].contentDocument.body) : Z("body")).select("#" + t);
  d.append("g");
