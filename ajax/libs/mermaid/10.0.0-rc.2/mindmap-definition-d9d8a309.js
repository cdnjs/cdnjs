import { w as sanitizeText$1, g as getConfig, l as log, s as select, a as setupGraphViewbox, u as lighten, v as darken } from "./mermaid-e517fc14.js";
import { i as isDark } from "./is_dark-2725d1eb.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-549be243.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-71440e28.js").then((n) => n.c)).default;
...
//# sourceMappingURL=mindmap-definition-d9d8a309.js.map
