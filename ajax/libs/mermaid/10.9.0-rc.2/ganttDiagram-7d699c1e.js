import { J as Be, K as Ze, R as Xe, L as qe, M as Dn, N as $t, O as Mn, P as ye, Q as ke, c as wt, s as _n, g as Sn, C as Un, D as Yn, b as Fn, a as Ln, T as nt, E as En, e as An, A as In, l as qt, j as zt, k as Wn, f as On } from "./mermaid-53111d1c.js";
import { b as Hn, t as Ue, c as Nn, a as Vn, l as Pn } from "./linear-f20166f7.js";
...
const on = bt(0), jt = bt(1), ur = bt(2), fr = bt(3), _t = bt(4), hr = bt(5), dr = bt(6);
on.range;
jt.range;
ur.range;
fr.range;
...
function ui(t, e) {
  return t = fn(t), z(_t.count(pt(t), t) + (pt(t).getUTCDay() === 4), e, 2);
}
function fi(t) {
  return t.getUTCDay();
}
...
var he = function() {
  var t = function(w, o, d, m) {
    ...
    parse: function(o) {
      var d = this, m = [0], u = [], _ = [null], c = [], X = this.table, f = "", h = 0, S = 0, G = 2, H = 1, V = c.slice.call(arguments, 1), I = Object.create(this.lexer), P = { yy: {} };
...
Expecting ` + Pt.join(", ") + ", got '" + (this.terminals_[M] || M) + "'" : Kt = "Parse error on line " + (h + 1) + ": Unexpected " + (M == H ? "end of input" : "'" + (this.terminals_[M] || M) + "'"), this.parseError(Kt, {
        ...
        switch (R[0]) {
          case 1:
            m.push(M), _.push(I.yytext), c.push(I.yylloc), m.push(R[1]), M = null, S = I.yyleng, f = I.yytext, h = I.yylineno, it = I.yylloc;
            break;
          case 2:
      ...
      return function(F) {
        for (var D = {}, w = 0, o = 0; w < B; w += 1) {
          ...
          if (typeof d == "string")
            ...
            var m = d.regex, u = d.parser, _ = F.slice(o), c = m.exec(_)[0];
    ...
    return function(y, L, O) {
      ...
      W.parse = function(Z) {
        ...
        if (typeof T == "string") {
          ...
          D && (o = A[2]), k = this.$locale(), !F && o && (k = O.Ls[o]), this.$d = function(_, c, X) {
            try {
              if (["x", "X"].indexOf(c) > -1)
                return new Date((c === "X" ? 1e3 : 1) * _);
              var f = q(c)(_), h = f.year, S = f.month, G = f.day, H = f.hours, V = f.minutes, I = f.seconds, P = f.milliseconds, st = f.zone, it = /* @__PURE__ */ new Date(), p = G || (h || S ? 1 : it.getDate()), E = h || it.getFullYear(), M = 0;
              h && !S || (M = S > 0 ? S - 1 : it.getMonth());
...
nt.extend(Mi);
nt.extend(Si);
let at = "", be = "", ve, xe = "", Ht = [], Nt = [], we = {}, Ce = [], Jt = [], St = "", De = "";
const yn = ["active", "done", "crit", "milestone"];
let Me = [], Vt = !1, _e = !1, Se = "sunday", de = 0;
const Ui = function() {
  Ce = [], Jt = [], St = "", Me = [], Zt = 0, ge = void 0, Xt = void 0, K = [], at = "", be = "", De = "", ve = void 0, xe = "", Ht = [], Nt = [], Vt = !1, _e = !1, de = 0, we = {}, En(), Se = "sunday";
}, Yi = function(t) {
  be = t;
}, Fi = function() {
  return be;
...
const vn = {}, rs = function(t, e) {
  ...
  let n = e;
  wt().securityLevel !== "loose" && (n = An(e)), t.split(",").forEach(function(r) {
    vt(r) !== void 0 && (wn(r, () => {
      window.open(n, "_self");
    }), we[r] = n);
  }), xn(t, "clickable");
...
const hs = function(t, e, n, r) {
  ...
  function W(T, F, D, w, o, d, m) {
    const _ = [...new Set(T.map((h) => h.order))].map((h) => T.find((S) => S.order === h));
    q.append("g").selectAll("rect").data(_).enter().append("rect").attr("x", 0).attr("y", function(h, S) {
      return S = h.order, S * F + D - 2;
    }).attr("width", function() {
    ...
    if (c.append("rect").attr("id", function(h) {
      ...
      return S = h.order, S * F + D;
    }).attr("width", function(h) {
      return h.milestone ? o : y(h.renderEndTime || h.endTime) - y(h.startTime);
    }).attr("height", o).attr("transform-origin", function(h, S) {
      return S = h.order, (y(h.startTime) + w + 0.5 * (y(h.endTime) - y(h.startTime))).toString() + "px " + (S * F + D + 0.5 * o).toString() + "px";
      ...
      let V = "";
      return h.active ? h.crit ? V += " activeCrit" : V = " active" : h.done ? h.crit ? V = " doneCrit" : V = " done" : h.crit && (V += " crit"), V.length === 0 && (V = " task"), h.milestone && (V = " milestone " + V), V += H, V += " " + G, S + V;
    }), c.append("text").attr("id", function(h) {
      return h.id + "-text";
    }).text(function(h) {
      return h.task;
    }).attr("font-size", i.fontSize).attr("x", function(h) {
      let S = y(h.startTime), G = y(h.renderEndTime || h.endTime);
      h.milestone && (S += 0.5 * (y(h.endTime) - y(h.startTime)) - 0.5 * o), h.milestone && (G = S + o);
      const H = this.getBBox().width;
      return H > G - S ? G + H + 1.5 * i.leftPadding > m ? S + w - 5 : G + w + 5 : (G - S) / 2 + S + w;
    }).attr("y", function(h, S) {
      return S = h.order, S * F + i.barHeight / 2 + (i.fontSize / 2 - 2) + D;
    }).attr("text-height", o).attr("class", function(h) {
      const S = y(h.startTime);
      let G = y(h.endTime);
      h.milestone && (G = S + o);
      const H = this.getBBox().width;
      let V = "";
      ...
      let P = "";
      return h.active && (h.crit ? P = "activeCritText" + I : P = "activeText" + I), h.done ? h.crit ? P = P + " doneCritText" + I : P = P + " doneText" + I : h.crit && (P = P + " critText" + I), h.milestone && (P += " milestoneText"), H > G - S ? G + H + 1.5 * i.leftPadding > m ? V + " taskTextOutsideLeft taskTextOutside" + I + " " + P : V + " taskTextOutsideRight taskTextOutside" + I + " " + P + " width-" + H : V + " taskText taskText" + I + " " + P + " width-" + H;
    }), wt().securityLevel === "sandbox") {
      let h;
      h = zt("#i" + e);
      const S = h.nodes()[0].contentDocument;
      c.filter(function(G) {
        return X[G.id] !== void 0;
      }).each(function(G) {
        var H = S.querySelector("#" + G.id), V = S.querySelector("#" + G.id + "-text");
        const I = H.parentNode;
        var P = S.createElement("a");
  ...
  function B(T, F, D, w, o, d, m, u) {
    ...
    let h = null, S = nt(_);
    for (; S.valueOf() <= c; )
      r.db.isInvalidDate(S, X, m, u) ? h ? h.end = S : h = {
        start: S,
        end: S
      } : h && (f.push(h), h = null), S = S.add(1, "d");
