import{a as J}from"./chunk-4KE642ED.mjs";import{a as Z}from"./chunk-SMOKE4MT.mjs";import"./chunk-EHAGHLZW.mjs";import"./chunk-LHGCIUPS.mjs";import"./chunk-LNU3G5WL.mjs";import"./chunk-YSDDPGMQ.mjs";import{a as H}from"./chunk-WVHPJQMP.mjs";import"./chunk-BKDDFIKN.mjs";import"./chunk-YPUTD6PB.mjs";import{k as V,l as U}from"./chunk-F3VO2MTM.mjs";import"./chunk-TI4EEUUG.mjs";import"./chunk-6BY5RJGC.mjs";import{Aa as C,Da as N,M as O,P as j,Q as _,R as z,S as B,T as M,U as W,V as I,X as L,b as m,ha as q,s as F}from"./chunk-NQURTBEV.mjs";import{a as t}from"./chunk-GTKDMUJJ.mjs";var K=F.pie,A={sections:new Map,showData:!1,config:K},u=A.sections,w=A.showData,ce=structuredClone(K),pe=t(()=>structuredClone(ce),"getConfig"),me=t(()=>{u=new Map,w=A.showData,j()},"clear"),le=t(({label:e,value:i})=>{u.has(e)||(u.set(e,i),m.debug(`added new section: ${e}, with value: ${i}`))},"addSection"),de=t(()=>u,"getSections"),fe=t(e=>{w=e},"setShowData"),ge=t(()=>w,"getShowData"),S={getConfig:pe,clear:me,setDiagramTitle:W,getDiagramTitle:I,setAccTitle:_,getAccTitle:z,setAccDescription:B,getAccDescription:M,addSection:le,getSections:de,setShowData:fe,getShowData:ge};var De=t((e,i)=>{J(e,i),i.setShowData(e.showData),e.sections.map(i.addSection)},"populateDb"),Q={parse:t(async e=>{let i=await Z("pie",e);m.debug(i),De(i,S)},"parse")};var ue=t(e=>`
  .pieCircle{
