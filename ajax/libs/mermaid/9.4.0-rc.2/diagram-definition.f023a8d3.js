import { w as Hu, g as jr, l as ur, s as Zr, a as Xu, u as qu, v as Wu } from "./mermaid.ecabf3c1.js";
import { c as $t, g as Ku } from "./_commonjsHelpers.a6551a8d.js";
import { i as Zu } from "./is_dark.faadfe03.js";
var Bn = function() {
...
const Ju = () => {
  ...
  for (let e = gt.length - 1; e >= 0; e--)
    if (gt[e].level < t)
      return gt[e];
  return null;
}, el = () => gt.length > 0 ? gt[0] : null, tl = (t, e, r, a) => {
...
const nl = (t) => {
  Hs = t;
}, il = () => ur, sl = (t) => gt[t], Zn = (t) => Kn[t], ol = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  sanitizeText: ea,
  clear: Ju,
  getMindmap: el,
  ...
  getNodeById: sl,
  getElementById: Zn
}, Symbol.toStringTag, { value: "Module" })), Xs = 12;
function ul(t, e) {
  t.each(function() {
...
const gl = function(t, e) {
  ...
  const n = r % (Xs - 1), i = t.append("g");
  e.section = n;
  let s = "section-" + n;
  n < 0 && (s += " section-root"), i.attr("class", (e.class ? e.class + " " : "") + "mindmap-node " + s);
  const o = i.append("g"), u = i.append("g"), f = u.append("text").text(e.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(ul, e.width).node().getBBox(), h = a.fontSize.replace ? a.fontSize.replace("px", "") : a.fontSize;
  ...
  switch (e.type) {
    ...
    case Me.RECT:
      ...
      break;
    case Me.CIRCLE:
      o.attr("transform", "translate(" + e.width / 2 + ", " + +e.height / 2 + ")"), cl(o, e);
      break;
    case Me.CLOUD:
      hl(o, e);
      break;
  ...
  return Ys(e.id, i), e.height;
}, ml = function(e, r, a, n, i) {
  const s = i % (Xs - 1), o = a.x + a.width / 2, u = a.y + a.height / 2, l = r.x + r.width / 2, f = r.y + r.height / 2, h = l > o ? o + Math.abs(o - l) / 2 : o - Math.abs(o - l) / 2, c = f > u ? u + Math.abs(u - f) / 2 : u - Math.abs(u - f) / 2, v = l > o ? Math.abs(o - h) / 2 + o : -Math.abs(o - h) / 2 + o, d = f > u ? Math.abs(u - c) / 2 + u : -Math.abs(u - c) / 2 + u;
  e.append("path").attr(
    "d",
    a.direction === "TB" || a.direction === "BT" ? `M${o},${u} Q${o},${d} ${h},${c} T${l},${f}` : `M${o},${u} Q${v},${u} ${h},${c} T${l},${f}`
  ).attr("class", "edge section-edge-" + s + " edge-depth-" + n);
}, bl = function(t) {
  const e = Zn(t.id), r = t.x || 0, a = t.y || 0;
  e.attr("transform", "translate(" + r + "," + a + ")");
}, qs = { drawNode: yl, positionNode: bl, drawEdge: ml };
function El(t) {
  var e = typeof t;
  return t != null && (e == "object" || e == "function");
}
var ha = El, wl = typeof $t == "object" && $t && $t.Object === Object && $t, xl = wl, Tl = xl, Cl = typeof self == "object" && self && self.Object === Object && self, Dl = Tl || Cl || Function("return this")(), ja = Dl, Sl = ja, Ll = function() {
  return Sl.Date.now();
}, Al = Ll, Ol = /\s/;
function Nl(t) {
  for (var e = t.length; e-- && Ol.test(t.charAt(e)); )
    ;
  return e;
}
var Ml = Nl, Il = Ml, Rl = /^\s+/;
function kl(t) {
  return t && t.slice(0, Il(t) + 1).replace(Rl, "");
}
var Pl = kl, Bl = ja, Fl = Bl.Symbol, Qn = Fl, Di = Qn, Ws = Object.prototype, Gl = Ws.hasOwnProperty, zl = Ws.toString, Vr = Di ? Di.toStringTag : void 0;
function $l(t) {
  var e = Gl.call(t, Vr), r = t[Vr];
  try {
    t[Vr] = void 0;
    var a = !0;
  } catch {
...
var Vl = $l, _l = Object.prototype, Ul = _l.toString;
function Yl(t) {
  return Ul.call(t);
}
var Hl = Yl, Si = Qn, Xl = Vl, ql = Hl, Wl = "[object Null]", Kl = "[object Undefined]", Li = Si ? Si.toStringTag : void 0;
function Zl(t) {
  return t == null ? t === void 0 ? Kl : Wl : Li && Li in Object(t) ? Xl(t) : ql(t);
}
var Ks = Zl;
function Ql(t) {
  return t != null && typeof t == "object";
}
var Jl = Ql, jl = Ks, ef = Jl, tf = "[object Symbol]";
function rf(t) {
  return typeof t == "symbol" || ef(t) && jl(t) == tf;
}
var va = rf, af = Pl, Ai = ha, nf = va, Oi = 0 / 0, sf = /^[-+]0x[0-9a-f]+$/i, of = /^0b[01]+$/i, uf = /^0o[0-7]+$/i, lf = parseInt;
function ff(t) {
  if (typeof t == "number")
    return t;
  if (nf(t))
  ...
  t = af(t);
  var r = of.test(t);
  return r || uf.test(t) ? lf(t.slice(2), r ? 2 : 8) : sf.test(t) ? Oi : +t;
}
var hf = ff, vf = ha, wn = Al, Ni = hf, cf = "Expected a function", df = Math.max, gf = Math.min;
function pf(t, e, r) {
  var a, n, i, s, o, u, l = 0, f = !1, h = !1, c = !0;
  if (typeof t != "function")
    throw new TypeError(cf);
  e = Ni(e) || 0, vf(r) && (f = !!r.leading, h = "maxWait" in r, i = h ? df(Ni(r.maxWait) || 0, e) : i, c = "trailing" in r ? !!r.trailing : c);
  function v(S) {
    var b = a, x = n;
...
var yf = pf, Zs = { exports: {} }, Qs = { exports: {} };
(function(t, e) {
  (function() {
...
(function(t) {
  t.exports = Qs.exports;
})(Zs);
var mf = Array.isArray, en = mf, bf = en, Ef = va, wf = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, xf = /^\w*$/;
function Tf(t, e) {
  if (bf(t))
    return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || Ef(t) ? !0 : xf.test(t) || !wf.test(t) || e != null && t in Object(e);
}
var Cf = Tf, Df = Ks, Sf = ha, Lf = "[object AsyncFunction]", Af = "[object Function]", Of = "[object GeneratorFunction]", Nf = "[object Proxy]";
function Mf(t) {
  if (!Sf(t))
    return !1;
  var e = Df(t);
  return e == Af || e == Of || e == Lf || e == Nf;
}
var If = Mf, Rf = ja, kf = Rf["__core-js_shared__"], Pf = kf, xn = Pf, Mi = function() {
...
var Ff = Bf, Gf = Function.prototype, zf = Gf.toString;
function $f(t) {
  if (t != null) {
    try {
      return zf.call(t);
...
var Vf = $f, _f = If, Uf = Ff, Yf = ha, Hf = Vf, Xf = /[\\^$.*+?()[\]{}|]/g, qf = /^\[object .+?Constructor\]$/, Wf = Function.prototype, Kf = Object.prototype, Zf = Wf.toString, Qf = Kf.hasOwnProperty, Jf = RegExp(
  "^" + Zf.call(Qf).replace(Xf, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function jf(t) {
  if (!Yf(t) || Uf(t))
    return !1;
...
var rh = th, ah = eh, nh = rh;
function ih(t, e) {
  var r = nh(t, e);
  return ah(r) ? r : void 0;
}
var Jn = ih, sh = Jn, oh = sh(Object, "create"), tn = oh, Ii = tn;
function uh() {
...
var hh = fh, vh = tn, ch = "__lodash_hash_undefined__", dh = Object.prototype, gh = dh.hasOwnProperty;
function ph(t) {
  var e = this.__data__;
  if (vh) {
    var r = e[t];
  ...
  return gh.call(e, t) ? e[t] : void 0;
}
var yh = ph, mh = tn, bh = Object.prototype, Eh = bh.hasOwnProperty;
function wh(t) {
  var e = this.__data__;
  return mh ? e[t] !== void 0 : Eh.call(e, t);
}
var xh = wh, Th = tn, Ch = "__lodash_hash_undefined__";
function Dh(t, e) {
  var r = this.__data__;
  return this.size += this.has(t) ? 0 : 1, r[t] = Th && e === void 0 ? Ch : e, this;
}
var Sh = Dh, Lh = lh, Ah = hh, Oh = yh, Nh = xh, Mh = Sh;
function Or(t) {
...
Or.prototype.clear = Lh;
Or.prototype.delete = Ah;
Or.prototype.get = Oh;
Or.prototype.has = Nh;
Or.prototype.set = Mh;
var Ih = Or;
...
var rn = Fh, Gh = rn, zh = Array.prototype, $h = zh.splice;
function Vh(t) {
  var e = this.__data__, r = Gh(e, t);
  if (r < 0)
    return !1;
  var a = e.length - 1;
  return r == a ? e.pop() : $h.call(e, r, 1), --this.size, !0;
}
var _h = Vh, Uh = rn;
function Yh(t) {
  var e = this.__data__, r = Uh(e, t);
...
var Wh = qh, Kh = rn;
function Zh(t, e) {
  var r = this.__data__, a = Kh(r, t);
  return a < 0 ? (++this.size, r.push([t, e])) : r[a][1] = e, this;
}
var Qh = Zh, Jh = kh, jh = _h, ev = Hh, tv = Wh, rv = Qh;
function Nr(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.clear(); ++e < r; ) {
    var a = t[e];
...
Nr.prototype.clear = Jh;
Nr.prototype.delete = jh;
Nr.prototype.get = ev;
Nr.prototype.has = tv;
Nr.prototype.set = rv;
var av = Nr, nv = Jn, iv = ja, sv = nv(iv, "Map"), ov = sv, Ri = Ih, uv = av, lv = ov;
function fv() {
...
var an = gv, pv = an;
function yv(t) {
  var e = pv(this, t).delete(t);
  return this.size -= e ? 1 : 0, e;
}
var mv = yv, bv = an;
function Ev(t) {
  return bv(this, t).get(t);
}
var wv = Ev, xv = an;
function Tv(t) {
  return xv(this, t).has(t);
}
var Cv = Tv, Dv = an;
function Sv(t, e) {
  var r = Dv(this, t), a = r.size;
  return r.set(t, e), this.size += r.size == a ? 0 : 1, this;
}
var Lv = Sv, Av = hv, Ov = mv, Nv = wv, Mv = Cv, Iv = Lv;
function Mr(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.clear(); ++e < r; ) {
    var a = t[e];
...
Mr.prototype.clear = Av;
Mr.prototype.delete = Ov;
Mr.prototype.get = Nv;
Mr.prototype.has = Mv;
Mr.prototype.set = Iv;
var Rv = Mr, js = Rv, kv = "Expected a function";
function jn(t, e) {
  ...
  return r.cache = new (jn.Cache || js)(), r;
}
jn.Cache = js;
var Pv = jn, Bv = Pv, Fv = 500;
function Gv(t) {
...
var zv = Gv, $v = zv, Vv = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, _v = /\\(\\)?/g, Uv = $v(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(Vv, function(r, a, n, i) {
    e.push(n ? i.replace(_v, "$1") : a || r);
  }), e;
}), eo = Uv;
function Yv(t, e) {
...
var to = Yv, ki = Qn, Hv = to, Xv = en, qv = va, Wv = 1 / 0, Pi = ki ? ki.prototype : void 0, Bi = Pi ? Pi.toString : void 0;
function ro(t) {
  if (typeof t == "string")
    return t;
  if (Xv(t))
...
var ao = Qv, Jv = en, jv = Cf, ec = eo, tc = ao;
function rc(t, e) {
  return Jv(t) ? t : jv(t, e) ? [t] : ec(tc(t));
}
var no = rc, ac = va, nc = 1 / 0;
function ic(t) {
...
var lc = uc, fc = lc;
function hc(t, e, r) {
  var a = t == null ? void 0 : fc(t, e);
  return a === void 0 ? r : a;
}
var vc = hc, cc = Jn, dc = function() {
  try {
...
var yc = pc, mc = yc, bc = Js, Ec = Object.prototype, wc = Ec.hasOwnProperty;
function xc(t, e, r) {
  var a = t[e];
  (!(wc.call(t, e) && bc(a, r)) || r === void 0 && !(e in t)) && mc(t, e, r);
}
var Tc = xc, Cc = 9007199254740991, Dc = /^(?:0|[1-9]\d*)$/;
function Sc(t, e) {
  var r = typeof t;
  return e = e == null ? Cc : e, !!e && (r == "number" || r != "symbol" && Dc.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
var Lc = Sc, Ac = Tc, Oc = no, Nc = Lc, Gi = ha, Mc = ei;
function Ic(t, e, r, a) {
  if (!Gi(t))
    return t;
  e = Oc(e, t);
  for (var n = -1, i = e.length, s = i - 1, o = t; o != null && ++n < i; ) {
    ...
    if (n != s) {
      var f = o[u];
      l = a ? a(f, u, o) : void 0, l === void 0 && (l = Gi(f) ? f : Nc(e[n + 1]) ? [] : {});
    }
    Ac(o, u, l), o = o[u];
  }
  return t;
...
var Gc = Fc, zc = to, $c = Gc, Vc = en, _c = va, Uc = eo, Yc = ei, Hc = ao;
function Xc(t) {
  return Vc(t) ? zc(t, Yc) : _c(t) ? [t] : $c(Uc(Hc(t)));
}
var qc = Xc, Wc = yf, Kc = Zs.exports, Zc = vc, Qc = Bc, Jc = qc;
function ca(t) {
  return t && typeof t == "object" && "default" in t ? t : { default: t };
}
var nn = /* @__PURE__ */ ca(Wc), da = /* @__PURE__ */ ca(Kc), jc = /* @__PURE__ */ ca(Zc), ed = /* @__PURE__ */ ca(Qc), td = /* @__PURE__ */ ca(Jc);
function _e(t) {
...
var Be = typeof window > "u" ? null : window, Vi = Be ? Be.navigator : null;
Be && Be.document;
var sd = _e(""), so = _e({}), od = _e(function() {
}), ud = typeof HTMLElement > "u" ? "undefined" : _e(HTMLElement), ga = function(e) {
  return e && e.instanceString && Fe(e.instanceString) ? e.instanceString() : null;
}, le = function(e) {
  return e != null && _e(e) == sd;
}, Fe = function(e) {
  return e != null && _e(e) === od;
}, Ie = function(e) {
  return !ft(e) && (Array.isArray ? Array.isArray(e) : e != null && e instanceof Array);
}, Te = function(e) {
  return e != null && _e(e) === so && !Ie(e) && e.constructor === Object;
}, ld = function(e) {
  return e != null && _e(e) === so;
}, ae = function(e) {
  ...
  return ga(e) === "collection" && e._private.single;
}, oo = function(e) {
  return ga(e) === "collection" && !e._private.single;
}, ai = function(e) {
  return ga(e) === "core";
}, uo = function(e) {
  return ga(e) === "stylesheet";
}, hd = function(e) {
  return ga(e) === "event";
}, Yt = function(e) {
  ...
  return ld(e) && Fe(e.then);
}, gd = function() {
  return Vi && Vi.userAgent.match(/msie|trident|edge/i);
}, ta = function(e, r) {
  r || (r = function() {
...
}, Ve = "(?:[-+]?(?:(?:\\d+|\\d*\\.\\d+)(?:[Ee][+-]?\\d+)?))", pd = "rgb[a]?\\((" + Ve + "[%]?)\\s*,\\s*(" + Ve + "[%]?)\\s*,\\s*(" + Ve + "[%]?)(?:\\s*,\\s*(" + Ve + "))?\\)", yd = "rgb[a]?\\((?:" + Ve + "[%]?)\\s*,\\s*(?:" + Ve + "[%]?)\\s*,\\s*(?:" + Ve + "[%]?)(?:\\s*,\\s*(?:" + Ve + "))?\\)", md = "hsl[a]?\\((" + Ve + ")\\s*,\\s*(" + Ve + "[%])\\s*,\\s*(" + Ve + "[%])(?:\\s*,\\s*(" + Ve + "))?\\)", bd = "hsl[a]?\\((?:" + Ve + ")\\s*,\\s*(?:" + Ve + "[%])\\s*,\\s*(?:" + Ve + "[%])(?:\\s*,\\s*(?:" + Ve + "))?\\)", Ed = "\\#[0-9a-fA-F]{3}", wd = "\\#[0-9a-fA-F]{6}", fo = function(e, r) {
  ...
  return Ad[e.toLowerCase()];
}, Ld = function(e) {
  return (Ie(e) ? e : null) || Sd(e) || Td(e) || Dd(e) || Cd(e);
}, Ad = {
  transparent: [0, 0, 0, 0],
  ...
  return r;
}, Tn = Be ? Be.performance : null, co = Tn && Tn.now ? function() {
  return Tn.now();
} : function() {
  return Date.now();
}, Od = function() {
  ...
  return Od(e);
}, Mt = co, br = 9261, go = 65599, Xr = 5381, po = function(e) {
  ...
  return r;
}, Ui = !0, Rd = console.warn != null, kd = console.trace != null, ii = Number.MAX_SAFE_INTEGER || 9007199254740991, mo = function() {
  return !0;
}, Xa = function() {
  return !1;
}, Yi = function() {
  ...
  !bo() || (Rd ? console.warn(e) : (console.log(e), kd && console.trace()));
}, Pd = function(e) {
  return ce({}, e);
}, Ct = function(e) {
  return e == null ? e : Ie(e) ? e.slice() : Te(e) ? Pd(e) : e;
}, Bd = function(e) {
  return e.slice();
}, Eo = function(e, r) {
...
}(), Dt = typeof Map < "u" ? Map : zd, $d = "undefined", Vd = /* @__PURE__ */ function() {
  function t(e) {
    if (ti(this, t), this._obj = /* @__PURE__ */ Object.create(null), this.size = 0, e != null) {
      var r;
...
}(), Ir = (typeof Set > "u" ? "undefined" : _e(Set)) !== $d ? Set : Vd, on = function(e, r) {
  var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0;
  if (e === void 0 || r === void 0 || !ai(e)) {
...
var _d = Ze({
  ...
  dijkstra: function(e) {
    ...
    var a = _d(e), n = a.root, i = a.weight, s = a.directed, o = this, u = i, l = le(n) ? this.filter(n)[0] : n[0], f = {}, h = {}, c = {}, v = this.byGroup(), d = v.nodes, g = v.edges;
  ...
  aStar: function(e) {
    var r = this.cy(), a = Hd(e), n = a.root, i = a.goal, s = a.heuristic, o = a.directed, u = a.weight;
    n = r.collection(n)[0], i = r.collection(i)[0];
    var l = n.id(), f = i.id(), h = {}, c = {}, v = {}, d = new da.default(function(z, F) {
  ...
  floydWarshall: function(e) {
    for (var r = this.cy(), a = qd(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), u = o.nodes, l = o.edges, f = u.length, h = f * f, c = function(U) {
      return u.indexOf(U);
    }, v = function(U) {
      return u[U];
  ...
  bellmanFord: function(e) {
    var r = this, a = Kd(e), n = a.weight, i = a.directed, s = a.root, o = n, u = this, l = this.cy(), f = this.byGroup(), h = f.edges, c = f.nodes, v = c.length, d = new Dt(), g = !1, y = [];
...
}, Qd = Math.sqrt(2), Jd = function(e, r, a) {
  ...
  kargerStein: function() {
    ...
    var i = a.length, s = n.length, o = Math.ceil(Math.pow(Math.log(i) / Math.LN2, 2)), u = Math.floor(i / Qd);
    if (i < 2) {
    ...
    for (var c = 1 / 0, v = [], d = new Array(i), g = new Array(i), y = new Array(i), p = function(B, z) {
      ...
      for (var m = 0; m < i; m++)
        g[m] = m;
      var T = Cn(g, l.slice(), i, u), C = T.slice();
      p(g, y);
      var S = Cn(g, T, u, 2), b = Cn(y, C, u, 2);
...
}, Do = function(e, r, a, n, i, s, o) {
  var u = ya(i, s), l = i / 2, f = s / 2, h;
  {
  ...
  if (l > 0) {
    ...
    g = f;
  return ut(e, r, g);
}, bg = function(e, r, a, n, i, s, o) {
  for (var u = new Array(a.length), l = s / 2, f = o / 2, h = fi(s, o), c = h * h, v = 0; v < a.length / 4; v++) {
  ...
  if (E !== 0) {
    ...
    return y === 0 || p === 0 ? Sn(e, a, o) === o ? [o, u] : Sn(e, a, i) === i ? [i, s] : Sn(i, o, a) === a ? [a, n] : [] : [];
  ...
  return l;
}, wg = function(e, r, a, n, i, s, o, u) {
  for (var l = [], f, h = new Array(a.length), c = s / 2, v = o / 2, d = fi(s, o), g = 0; g < a.length / 4; g++) {
  ...
  pageRank: function(e) {
    for (var r = Tg(e), a = r.dampingFactor, n = r.precision, i = r.iterations, s = r.weight, o = this._private.cy, u = this.byGroup(), l = u.nodes, f = u.edges, h = l.length, c = h * h, v = f.length, d = new Array(c), g = new Array(h), y = (1 - a) / h, p = 0; p < h; p++) {
      for (var E = 0; E < h; E++) {
        var m = p * h + E;
        d[m] = 0;
      }
...
var Wi = Ze({
  ...
  closenessCentralityNormalized: function(e) {
    for (var r = Wi(e), a = r.harmonic, n = r.weight, i = r.directed, s = this.cy(), o = {}, u = 0, l = this.nodes(), f = this.floydWarshall({
      weight: n,
      directed: i
    }), h = 0; h < l.length; h++) {
  ...
  closenessCentrality: function(e) {
    var r = Wi(e), a = r.root, n = r.weight, i = r.directed, s = r.harmonic;
    a = this.filter(a)[0];
...
var Dg = Ze({
  ...
  betweennessCentrality: function(e) {
    for (var r = Dg(e), a = r.directed, n = r.weight, i = n != null, s = this.cy(), o = this.nodes(), u = {}, l = {}, f = 0, h = {
      set: function(m, T) {
        l[m] = T, T > f && (f = T);
      },
      get: function(m) {
    ...
    for (var g = function(m) {
      for (var T = o[m].id(), C = [], S = {}, b = {}, x = {}, w = new da.default(function(H, Y) {
        return x[H] - x[Y];
      }), D = 0; D < o.length; D++) {
        var A = o[D].id();
        S[A] = [], b[A] = 0, x[A] = 1 / 0;
...
var Sg = Ze({
  ...
  for (var r = 0; r < e.length; r++)
    for (var a = 0; a < e.length; a++)
      r != a && Pg(e[r], e[a]) && e.splice(a, 1);
  return e;
}, Ki = function(e) {
  for (var r = this.nodes(), a = this.edges(), n = this.cy(), i = Lg(e), s = {}, o = 0; o < r.length; o++)
    s[r[o].id()] = o;
  for (var u = r.length, l = u * u, f = new Array(l), h, c = 0; c < l; c++)
    f[c] = 0;
  for (var v = 0; v < a.length; v++) {
    var d = a[v], g = s[d.source().id()], y = s[d.target().id()], p = Ag(d, i.attributes);
    f[g * u + y] += p, f[y * u + g] += p;
  }
  Og(f, u, i.multFactor), No(f, u);
  for (var E = !0, m = 0; E && m < i.maxIterations; )
    E = !1, h = Mg(f, u, i.expandFactor), f = Ig(h, u, i.inflateFactor), Rg(f, h, l, 4) || (E = !0), m++;
  var T = kg(f, u, r, n);
  return T = Bg(T), T;
}, Fg = {
  markovClustering: Ki,
  ...
  return Math.max(e, Mo(r, a));
}, _r = function(e, r, a, n, i) {
  for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : Gg, o = n, u, l, f = 0; f < e; f++)
    u = r(f), l = a(f), o = i(o, u, l);
  return s(o);
}, Lr = {
  euclidean: function(e, r, a) {
    return e >= 2 ? _r(e, r, a, 0, Qi, zg) : _r(e, r, a, 0, Zi);
  },
  squaredEuclidean: function(e, r, a) {
    return _r(e, r, a, 0, Qi);
  },
  manhattan: function(e, r, a) {
    return _r(e, r, a, 0, Zi);
  },
  max: function(e, r, a) {
    return _r(e, r, a, -1 / 0, $g);
  }
};
Lr["squared-euclidean"] = Lr.squaredEuclidean;
Lr.squaredeuclidean = Lr.squaredEuclidean;
function ln(t, e, r, a, n, i) {
  var s;
...
var Vg = Ze({
  ...
  return o;
}, Io = function(e, r, a, n, i) {
  for (var s = 1 / 0, o = 0, u = 0; u < r.length; u++) {
    var l = qa(a, e, r[u], n, i);
    l < s && (s = l, o = u);
  }
  return o;
}, Ro = function(e, r, a) {
  ...
  if (e.length < 50)
    for (var n = 0; n < r; n++) {
      for (var i = e[Math.floor(Math.random() * e.length)]; Yg(i, a, n); )
  ...
  for (var n = 0, i = 0; i < r.length; i++)
    n += qa("manhattan", r[i], e, a, "kMedoids");
  return n;
}, Hg = function(e) {
  var r = this.cy(), a = this.nodes(), n = null, i = hi(e), s = new Array(i.k), o = {}, u;
  i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, u = Ln(a, i.k, i.attributes)) : _e(i.testCentroids) === "object" ? u = i.testCentroids : u = Ln(a, i.k, i.attributes) : u = Ln(a, i.k, i.attributes);
  for (var l = !0, f = 0; l && f < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
      n = a[h], o[n.id()] = Io(n, u, i.distance, i.attributes, "kMeans");
    l = !1;
    for (var c = 0; c < i.k; c++) {
      var v = Ro(c, a, o);
      if (v.length !== 0) {
        for (var d = i.attributes.length, g = u[c], y = new Array(d), p = new Array(d), E = 0; E < d; E++) {
          ...
          y[E] = p[E] / v.length, _g(y[E], g[E], i.sensitivityThreshold) || (l = !0);
        }
  ...
  var r = this.cy(), a = this.nodes(), n = null, i = hi(e), s = new Array(i.k), o, u = {}, l, f = new Array(i.k);
  i.testMode ? typeof i.testCentroids == "number" || (_e(i.testCentroids) === "object" ? o = i.testCentroids : o = Ji(a, i.k)) : o = Ji(a, i.k);
  for (var h = !0, c = 0; h && c < i.maxIterations; ) {
    for (var v = 0; v < a.length; v++)
      n = a[v], u[n.id()] = Io(n, o, i.distance, i.attributes, "kMedoids");
    h = !1;
    for (var d = 0; d < o.length; d++) {
      var g = Ro(d, a, u);
      if (g.length !== 0) {
        f[d] = ji(o[d], g, i.attributes);
        for (var y = 0; y < g.length; y++)
          l = ji(g[y], g, i.attributes), l < f[d] && (f[d] = l, o[d] = g[y], h = !0);
        s[d] = r.collection(g);
      }
    }
    c++;
  ...
  for (var o, u, l, f = 2 / (i.m - 1), h = 0; h < a.length; h++)
    for (var c = 0; c < n.length; c++) {
      o = 0;
      for (var v = 0; v < a.length; v++)
        u = qa(i.distance, n[c], a[h], i.attributes, "cmeans"), l = qa(i.distance, n[c], a[v], i.attributes, "cmeans"), o += Math.pow(u / l, f);
      e[c][h] = 1 / o;
    }
}, Kg = function(e, r, a, n) {
  ...
  var r = this.cy(), a = this.nodes(), n = hi(e), i, s, o, u, l;
  ...
  for (var E = !0, m = 0; E && m < n.maxIterations; )
    E = !1, qg(s, a, o, l, n), Wg(o, u, s, a, n), Ug(o, u, n.sensitivityThreshold) || (E = !0), m++;
  return i = Kg(a, o, n, r), {
    clusters: i,
  ...
  var r = Qg(e), a = Jg[r.linkage];
  return a != null && (r.linkage = a), r;
}, ts = function(e, r, a, n, i) {
  for (var s = 0, o = 1 / 0, u, l = i.attributes, f = function(w, D) {
    return ln(i.distance, l.length, function(A) {
      return l[A](w);
    }, function(A) {
      return l[A](D);
    }, w, D);
  ...
  if (!e)
    return [];
  var n = [], i = [], s = [];
  return r === 0 ? (e.left && Oa(e.left, n), e.right && Oa(e.right, i), s = n.concat(i), [a.collection(s)]) : r === 1 ? e.value ? [a.collection(e.value)] : (e.left && Oa(e.left, n), e.right && Oa(e.right, i), [a.collection(n), a.collection(i)]) : e.value ? [a.collection(e.value)] : (e.left && (n = t(e.left, r - 1, a)), e.right && (i = t(e.right, r - 1, a)), n.concat(i));
}, rs = function(e) {
  for (var r = this.cy(), a = this.nodes(), n = jg(e), i = n.attributes, s = function(m, T) {
    return ln(n.distance, i.length, function(C) {
      return i[C](m);
    }, function(C) {
      return i[C](T);
    }, m, T);
  ...
  for (var y = ts(o, f, u, l, n); y; )
    y = ts(o, f, u, l, n);
  var p;
  return n.mode === "dendrogram" ? (p = tp(o[0], n.dendrogramDepth, r), n.addDendrogram && ep(o[0], r)) : (p = new Array(o.length), o.forEach(function(E, m) {
    E.key = E.index = null, p[m] = r.collection(E.value);
  })), p;
}, rp = {
  hierarchicalClustering: rs,
  hca: rs
}, ap = Ze({
  distance: "euclidean",
  preference: "median",
  ...
  return n.some(function(i) {
    ...
    return "'".concat(i, "'");
  }).join(", "), "] or a number.  Got: ").concat(a)), ap(e);
}, ip = function(e, r, a, n) {
  var i = function(o, u) {
    return n[u](o);
  };
  return -ln(e, n.length, function(s) {
    return i(r, s);
  }, function(s) {
    return i(a, s);
  }, r, a);
  ...
  var a = null;
  return r === "median" ? a = ng(e) : r === "mean" ? a = ag(e) : r === "min" ? a = tg(e) : r === "max" ? a = rg(e) : a = r, a;
}, op = function(e, r, a) {
  for (var n = [], i = 0; i < e; i++)
  ...
  for (var n = as(e, r, a), i = 0; i < a.length; i++) {
  ...
  for (var r = this.cy(), a = this.nodes(), n = np(e), i = {}, s = 0; s < a.length; s++)
    i[a[s].id()] = s;
  var o, u, l, f, h, c;
  ...
  for (var d = 0; d < o; d++)
    for (var g = 0; g < o; g++)
      d !== g && (l[d * o + g] = ip(n.distance, a[d], a[g], n.attributes));
  f = sp(l, n.preference);
  for (var y = 0; y < o; y++)
    l[y * o + y] = f;
  h = new Array(u);
  ...
  for (var G = op(o, h, c), X = up(o, l, G), K = {}, Z = 0; Z < G.length; Z++)
    K[G[Z]] = [];
  ...
  hierholzer: function(e) {
    ...
    var a = fp(e), n = a.root, i = a.directed, s = this, o = !1, u, l, f;
  ...
  hopcroftTarjanBiconnected: Na,
  htbc: Na,
  htb: Na,
  hopcroftTarjanBiconnectedComponents: Na
}, Ma = function() {
  ...
  tarjanStronglyConnected: Ma,
  tsc: Ma,
  tscc: Ma,
  tarjanStronglyConnectedComponents: Ma
}, ko = {};
[na, Ud, Yd, Xd, Wd, Zd, jd, Cg, Tr, Cr, zn, Fg, Zg, rp, lp, hp, vp, cp].forEach(function(t) {
  ce(ko, t);
});
/*!
...
*/
var Po = 0, Bo = 1, Fo = 2, Rt = function t(e) {
  if (!(this instanceof t))
    return new t(e);
  this.id = "Thenable/1.0.7", this.state = Po, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = {
    then: this.then.bind(this)
  }, typeof e == "function" && e.call(this, this.fulfill.bind(this), this.reject.bind(this));
};
Rt.prototype = {
  fulfill: function(e) {
    return is(this, Bo, "fulfillValue", e);
  },
  reject: function(e) {
    return is(this, Fo, "rejectReason", e);
  },
  then: function(e, r) {
    var a = this, n = new Rt();
    return a.onFulfilled.push(os(e, n, "fulfill")), a.onRejected.push(os(r, n, "reject")), Go(a), n.proxy;
  }
};
var is = function(e, r, a, n) {
  return e.state === Po && (e.state = r, e[a] = n, Go(e)), e;
}, Go = function(e) {
  e.state === Bo ? ss(e, "onFulfilled", e.fulfillValue) : e.state === Fo && ss(e, "onRejected", e.rejectReason);
}, ss = function(e, r, a) {
  if (e[r].length !== 0) {
    var n = e[r];
    e[r] = [];
...
var Rr = typeof Promise < "u" ? Promise : Rt, $n = function(e, r, a) {
  var n = ai(e), i = !n, s = this._private = ce({
    duration: 1e3
  }, r, a);
...
nr.complete = nr.completed;
nr.run = nr.play;
nr.running = nr.playing;
var gp = {
  animated: function() {
    return function() {
  ...
  data: function(e) {
    ...
    return e = ce({}, r, e), function(n, i) {
      ...
      if (le(n)) {
        var h = n.indexOf(".") !== -1, c = h && td.default(n);
        if (s.allowGetting && i === void 0) {
          var v;
          return f && (s.beforeGet(f), c && f._private[s.field][n] === void 0 ? v = jc.default(f._private[s.field], c) : v = f._private[s.field][n]), v;
          ...
          if (d) {
            ...
            for (var y = 0, p = l.length; y < p; y++) {
              var E = l[y];
              s.canSet(E) && (c && f._private[s.field][n] === void 0 ? ed.default(E._private[s.field], c, i) : E._private[s.field][n] = i);
            }
...
Ga.className = Ga.classNames = Ga.classes;
var xe = {
  metaChar: "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]",
  comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=",
  boolOp: "\\?|\\!|\\^",
...
var Ne = function() {
  ...
  return xd(t.selector, e.selector);
}), bp = function() {
  for (var t = {}, e, r = 0; r < Vn.length; r++)
    e = Vn[r], t[e.selector] = e.matches;
  return t;
}(), Ep = function(e, r) {
  return bp[e](r);
}, wp = "(" + Vn.map(function(t) {
  return t.selector;
}).join("|") + ")", dr = function(e) {
...
var xp = function(e) {
  for (var r, a, n, i = 0; i < _n.length; i++) {
    var s = _n[i], o = s.name, u = e.match(s.regexObj);
    if (u != null) {
      a = u, r = s, n = o;
      var l = u[0];
...
$e[ie.META_COMPARE] = function(t, e) {
  ...
  return zo(Op(e, r), a, n);
};
$e[ie.DATA_COMPARE] = function(t, e) {
  var r = t.field, a = t.operator, n = t.value;
  return zo(vi(e, r), a, n);
};
...
var dt = function(e, r) {
  return function(n, i, s, o) {
    ...
    if (u == null ? f = "" : ft(u) && u.length === 1 && (f = u.id()), l.length === 1 && f) {
      var h = l[0]._private, c = h.traversalCache = h.traversalCache || {}, v = c[r] = c[r] || [], d = rr(f), g = v[d];
...
ce(fn, {
  degree: An(function(t, e) {
    return e.source().same(e.target()) ? 2 : 1;
  }),
  indegree: An(function(t, e) {
    return e.target().same(t) ? 1 : 0;
  }),
  outdegree: An(function(t, e) {
    ...
    if (a && a.isNode())
      if (u)
        for (var l = 0; l < this.length; l++) {
          var f = this[l];
          r !== void 0 ? f.position(e, (r - s[e]) / i) : o !== void 0 && f.position(xo(o, i, s));
        }
      else {
        var h = a.position();
        return o = un(h, i, s), e === void 0 ? o : o[e];
      }
    else if (!u)
      return;
    return this;
...
var Pp = Uo, Dr, Kt;
Dr = Kt = {};
Kt.renderedBoundingBox = function(t) {
...
Kt.dirtyCompoundBoundsCache = function() {
...
Kt.updateCompoundBounds = function() {
  var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, e = this.cy();
...
var ct = function(e) {
  ...
  if (!r.cy().headless()) {
    ...
    if (o !== "none") {
      ...
      h.x1 = u - s, h.y1 = l - s, h.x2 = u + s, h.y2 = l + s, h.w = h.x2 - h.x1, h.h = h.y2 - h.y1, Fa(h, 1), Et(e, h.x1, h.y1, h.x2, h.y2);
    }
  }
}, On = function(e, r, a) {
  if (!r.cy().headless()) {
  ...
  if (m) {
    ...
    if (n && r.includeEdges && l && (Ia(s, e, "mid-source"), Ia(s, e, "mid-target"), Ia(s, e, "source"), Ia(s, e, "target")), n) {
    ...
    Xi(he, s), Dn(he, p), Fa(he, 1), n && (f = s.x1, h = s.x2, c = s.y1, v = s.y2, Et(s, f - x, c - x, h + x, v + x));
    var de = o.overlayBounds = o.overlayBounds || {};
    Xi(de, s), Dn(de, p), Fa(de, 1);
    var ee = o.labelBounds = o.labelBounds || {};
    ee.all != null ? lg(ee.all) : ee.all = lt(), n && r.includeLabels && (r.includeMainLabels && On(s, e, null), l && (r.includeSourceLabels && On(s, e, "source"), r.includeTargetLabels && On(s, e, "target")));
  }
  return s.x1 = ct(s.x1), s.y1 = ct(s.y1), s.x2 = ct(s.x2), s.y2 = ct(s.y2), s.w = ct(s.x2 - s.x1), s.h = ct(s.y2 - s.y1), s.w > 0 && s.h > 0 && m && (Dn(s, p), Fa(s, 1)), s;
}, Ho = function(e) {
  ...
  if (e.isEdge()) {
    ...
    return Md([n(r.x), n(r.y), n(a.x), n(a.y)]);
  } else
    return 0;
}, ls = function(e, r) {
  var a = e._private, n, i = e.isEdge(), s = r == null ? fs : Ho(r), o = s === fs, u = Xo(e), l = a.bbCachePosKey === u, f = r.useCache && l, h = function(g) {
    return g._private.bbCache == null || g._private.styleDirty;
  }, c = !f || h(e) || i && h(e.source()) || h(e.target());
  if (c ? (l || e.recalculateRenderedStyle(f), n = Bp(e, ua), a.bbCache = n, a.bbCachePosKey = u) : n = a.bbCache, !o) {
    var v = e.isNode();
    n = lt(), (r.includeNodes && v || r.includeEdges && !v) && (r.includeOverlays ? er(n, a.overlayBounds) : er(n, a.bodyBounds)), r.includeLabels && (r.includeMainLabels && (!i || r.includeSourceLabels && r.includeTargetLabels) ? er(n, a.labelBounds.all) : (r.includeMainLabels && er(n, a.labelBounds.mainRot), r.includeSourceLabels && er(n, a.labelBounds.sourceRot), r.includeTargetLabels && er(n, a.labelBounds.targetRot))), n.w = n.x2 - n.x1, n.h = n.y2 - n.y1;
  }
  return n;
}, ua = {
  includeNodes: !0,
...
Kt.boundingBox = function(t) {
  var e;
  if (this.length === 1 && this[0]._private.bbCache != null && !this[0]._private.styleDirty && (t === void 0 || t.useCache === void 0 || t.useCache === !0))
    t === void 0 ? t = ua : t = hs(t), e = ls(this[0], t);
  else {
    e = lt(), t = t || ua;
    var r = hs(t), a = this, n = a.cy(), i = n.styleEnabled();
    if (i)
      for (var s = 0; s < a.length; s++) {
        var o = a[s], u = o._private, l = Xo(o), f = u.bbCachePosKey === l, h = r.useCache && f && !u.styleDirty;
...
Kt.dirtyBoundingBoxCache = function() {
...
Wr = ma = {};
var qo = function(e) {
  e.uppercaseName = _i(e.name), e.autoName = "auto" + e.uppercaseName, e.labelName = "label" + e.uppercaseName, e.outerName = "outer" + e.uppercaseName, e.uppercaseOuterName = _i(e.outerName), Wr[e.name] = function() {
...
var Gp = ma, zp = function(e, r) {
  if (e.isEdge())
    return r(e);
}, $p = function(e, r) {
  if (e.isEdge()) {
    var a = e.cy();
    return un(r(e), a.zoom(), a.pan());
  }
}, Vp = function(e, r) {
  if (e.isEdge()) {
...
}, Wp = Object.keys(vs).reduce(function(t, e) {
  var r = vs[e], a = qp(e);
  return t[e] = function() {
    return zp(this, r.get);
  }, r.mult ? t[a] = function() {
    return Vp(this, r.get);
  } : t[a] = function() {
    return $p(this, r.get);
  }, t;
}, {}), Kp = ce({}, Pp, Fp, Gp, Wp);
...
Wo.prototype = {
  ...
  recycle: function(e, r) {
    if (this.isImmediatePropagationStopped = this.isPropagationStopped = this.isDefaultPrevented = Yr, e != null && e.preventDefault ? (this.type = e.type, this.isDefaultPrevented = e.defaultPrevented ? Ra : Yr) : e != null && e.type ? r = e : this.type = e, r != null && (this.originalEvent = r.originalEvent, this.type = r.type != null ? r.type : this.type, this.cy = r.cy, this.target = r.target, this.position = r.position, this.renderedPosition = r.renderedPosition, this.namespace = r.namespace, this.layout = r.layout), this.cy != null && this.position != null && this.renderedPosition == null) {
  ...
  stopImmediatePropagation: function() {
    this.isImmediatePropagationStopped = Ra, this.stopPropagation();
  },
...
var Ko = /^([^.]+)(\.(?:[^.]+))?$/, Zp = ".*", Zo = {
  ...
  context: null
}, cs = Object.keys(Zo), Qp = {};
function hn() {
  for (var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Qp, e = arguments.length > 1 ? arguments[1] : void 0, r = 0; r < cs.length; r++) {
    var a = cs[r];
    this[a] = t[a] || Zo[a];
  }
  this.context = e || this.context, this.listeners = [], this.emitting = 0;
}
var Wt = hn.prototype, Qo = function(e, r, a, n, i, s, o) {
  ...
  return e.addEventFields(e.context, r), new Wo(r.type, r);
}, Jp = function(e, r, a) {
  if (hd(a)) {
    r(e, a);
    return;
  ...
  for (var n = Ie(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
    ...
    if (!Yt(s)) {
      var o = s.match(Ko);
      if (o) {
        var u = o[1], l = o[2] ? o[2] : null, f = ds(e, {
          type: u,
          namespace: l,
          target: e.context
        });
...
Wt.on = Wt.addListener = function(t, e, r, a, n) {
  return Qo(this, function(i, s, o, u, l, f, h) {
...
Wt.removeListener = Wt.off = function(t, e, r, a) {
  var n = this;
  this.emitting !== 0 && (this.listeners = Bd(this.listeners));
  for (var i = this.listeners, s = function(l) {
    var f = i[l];
    Qo(n, function(h, c, v, d, g, y) {
...
Wt.emit = Wt.trigger = function(t, e, r) {
  ...
  return this.emitting++, Ie(e) || (e = [e]), Jp(this, function(i, s) {
    r != null && (a = [{
      event: s.event,
      type: s.type,
    ...
    for (var o = function(f) {
      var h = a[f];
      if (h.type === s.type && (!h.namespace || h.namespace === s.namespace || h.namespace === Zp) && i.eventMatches(i.context, h, s)) {
        var c = [s];
        e != null && Gd(c, e), i.beforeEmit(i.context, h, s), h.conf && h.conf.one && (i.listeners = i.listeners.filter(function(g) {
          return g !== h;
        }));
...
var jp = {
  ...
  eventMatches: function(e, r, a) {
    var n = r.qualifier;
    return n != null ? e !== a.target && pa(a.target) && n.matches(a.target) : !0;
  },
  ...
  createEmitter: function() {
    for (var e = 0; e < this.length; e++) {
      ...
      a.emitter || (a.emitter = new hn(jp, r));
    }
    return this;
  },
  emitter: function() {
  ...
  on: function(e, r, a) {
    for (var n = ka(r), i = 0; i < this.length; i++) {
      var s = this[i];
      s.emitter().on(e, n, a);
    }
    return this;
...
function di(t) {
  ...
  return function() {
    ...
    if (i) {
      ...
      return r(u) && (!s || Nn(u, r)) && (u === l || r(l) && (!s || Nn(l, r)));
    }
  };
}
var kr = vn("eleTakesUpSpace", function(t) {
  return t.pstyle("display").value === "element" && t.width() !== 0 && (t.isNode() ? t.height() !== 0 : !0);
});
We.takesUpSpace = cn("takesUpSpace", di({
  ok: kr
}));
var ay = vn("eleInteractive", function(t) {
  return t.pstyle("events").value === "yes" && t.pstyle("visibility").value === "visible" && kr(t);
}), ny = vn("parentInteractive", function(t) {
  return t.pstyle("visibility").value === "visible" && kr(t);
});
We.interactive = cn("interactive", di({
  ok: ay,
  parentOk: ny,
  edgeOkViaNode: kr
}));
...
We.isBundledBezier = cn("isBundledBezier", function() {
...
ce(et, {
  ...
  parallelEdges: dt(ws(), "parallelEdges"),
  codirectedEdges: dt(ws({
    codirected: !0
  }), "codirectedEdges")
});
function ws(t) {
...
var Ke = function(e, r) {
  ...
  if (!r)
    r = [];
  else if (r.length > 0 && Te(r[0]) && !pa(r[0])) {
    s = !0;
...
}, ke = on.prototype = Ke.prototype = Object.create(Array.prototype);
...
ke.collection = function() {
  return oo(this) ? this : new Ke(this._private.cy, [this]);
};
ke.unique = function() {
...
ke.clone = function() {
  for (var t = this.cy(), e = [], r = 0; r < this.length; r++) {
    var a = this[r], n = a.json(), i = new on(t, n, !1);
    e.push(i);
  }
  return new Ke(t, e);
};
...
[ko, mp, Ga, _t, Ar, kp, fn, Kp, Jo, jo, ey, Wa, za, We, Ut, et].forEach(function(t) {
  ce(ke, t);
});
var oy = {
  add: function(e) {
  ...
  if (!s.easingImpl)
    if (o == null)
      ...
      le(h) ? (v = h, d = []) : (v = h[1], d = h.slice(2).map(function(B) {
        return +B;
      })), d.length > 0 ? (v === "spring" && d.push(s.duration), s.easingImpl = $a[v].apply(null, d)) : s.easingImpl = $a[v];
    }
...
function Cs(t, e) {
  ...
  function n(f, h) {
    ...
    for (var p = function(S) {
      ...
      !T.playing && !T.applying || (T.playing && T.applying && (T.applying = !1), T.started || hy(f, m, t), fy(f, m, t, h), T.applying && (T.applying = !1), p(T.frames), T.step != null && T.step(t), m.completed() && (v.splice(E, 1), T.hooked = !1, T.playing = !1, T.started = !1, p(T.completes)), g = !0);
    }
...
var vy = {
  ...
  startAnimationLoop: function() {
    ...
    if (e._private.animationsRunning = !0, !e.styleEnabled())
      return;
    function r() {
      !e._private.animationsRunning || Ha(function(i) {
        Cs(i, e), r();
      });
    }
    var a = e.renderer();
  ...
  createEmitter: function() {
    var e = this._private;
    return e.emitter || (e.emitter = new hn(cy, this)), this;
  },
  emitter: function() {
    return this._private.emitter;
  },
  on: function(e, r, a) {
    return this.emitter().on(e, Pa(r), a), this;
  },
  removeListener: function(e, r, a) {
    return this.emitter().removeListener(e, Pa(r), a), this;
  },
  removeAllListeners: function() {
    return this.emitter().removeAllListeners(), this;
  },
  one: function(e, r, a) {
    return this.emitter().one(e, Pa(r), a), this;
  },
  once: function(e, r, a) {
    return this.emitter().one(e, Pa(r), a), this;
  },
...
rt.updateStyleHints = function(t) {
  ...
  e.styleKey = Nd(O[0], O[1]);
  var R = e.styleKeys;
  e.labelDimsKey = Ft(R.labelDimensions);
  var B = i(t, ["label"], R.labelDimensions);
  if (e.labelKey = Ft(B), e.labelStyleKey = Ft(Sa(R.commonLabel, B)), !o) {
    var z = i(t, ["source-label"], R.labelDimensions);
    e.sourceLabelKey = Ft(z), e.sourceLabelStyleKey = Ft(Sa(R.commonLabel, z));
    var F = i(t, ["target-label"], R.labelDimensions);
    e.targetLabelKey = Ft(F), e.targetLabelStyleKey = Ft(Sa(R.commonLabel, F));
  }
  if (o) {
...
rt.applyParsedProperty = function(t, e) {
  ...
  if (a && a.name.substr(0, 3) === "pie" && Ae("The pie style properties are deprecated.  Create charts using background images instead."), e.name === "curve-style" && t.isEdge() && (e.value !== "bezier" && t.isLoop() || e.value === "haystack" && (t.source().isParent() || t.target().isParent())) && (a = e = this.parse(e.name, "bezier", u)), a.delete)
...
rt.checkBoundsTrigger = function(t, e, r, a) {
  this.checkTrigger(t, e, r, a, function(n) {
    ...
    t.dirtyCompoundBoundsCache(), t.dirtyBoundingBoxCache(), n.triggersBoundsOfParallelBeziers && (e === "curve-style" && (r === "bezier" || a === "bezier") || e === "display" && (r === "none" || a === "none")) && t.parallelEdges().forEach(function(i) {
...
var ba = {};
ba.applyBypass = function(t, e, r, a) {
  var n = this, i = [], s = !0;
  if (e === "*" || e === "**") {
    if (r !== void 0)
...
ba.overrideBypass = function(t, e, r) {
  e = ni(e);
...
ba.removeAllBypasses = function(t, e) {
  return this.removeBypasses(t, this.propertyNames, e);
};
ba.removeBypasses = function(t, e, r) {
...
St.getRawStyle = function(t, e) {
  ...
  if (t = t[0], t) {
    for (var a = {}, n = 0; n < r.properties.length; n++) {
      ...
      s != null && (a[i.name] = s, a[sn(i.name)] = s);
    }
    return a;
  }
};
...
St.getPropsList = function(t) {
  ...
  if (a)
    for (var i = Object.keys(a), s = 0; s < i.length; s++) {
      var o = i[s], u = a[o], l = n[o] || n[ni(o)], f = this.parse(l.name, u);
      f && r.push(f);
    }
  return r;
};
...
var qe = {};
(function() {
  var t = Ve, e = yd, r = bd, a = Ed, n = wd, i = function(X) {
    return "^" + X + "\\s*\\(\\s*([\\w\\.]+)\\s*\\)$";
  }, s = function(X) {
    var K = t + "|\\w+|" + e + "|" + r + "|" + a + "|" + n;
...
var gn = {};
gn.parse = function(t, e, r, a) {
  var n = this;
  if (Fe(e))
    return n.parseImplWarn(t, e, r, a);
  var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, u = yo(t, o, s, i), l = n.propCache = n.propCache || [], f;
  return (f = l[u]) || (f = l[u] = n.parseImplWarn(t, e, r, a)), (r || a === "mapping") && (f = Ct(f), f && (f.value = Ct(f.value))), f;
};
gn.parseImplWarn = function(t, e, r, a) {
...
gn.parseImpl = function(t, e, r, a) {
  ...
  if (!(!u || a || e.length < 7 || e[1] !== "a")) {
    if (e.length >= 7 && e[0] === "d" && (f = new RegExp(o.data.regex).exec(e))) {
      ...
      if (l.color) {
        var y = d.value, p = g.value, E = y[0] === p[0] && y[1] === p[1] && y[2] === p[2] && (y[3] === p[3] || (y[3] == null || y[3] === 1) && (p[3] == null || p[3] === 1));
        if (E)
          return !1;
      }
      return {
  ...
  if (l.number) {
    ...
    return l.unitless || L !== "px" && L !== "em" ? I.pfValue = e : I.pfValue = L === "px" || !L ? e : this.getEmSizeInPixels() * e, (L === "ms" || L === "s") && (I.pfValue = L === "ms" ? e : 1e3 * e), (L === "deg" || L === "rad") && (I.pfValue = L === "rad" ? e : ig(e)), L === "%" && (I.pfValue = e / 100), I;
  } else if (l.propList) {
    var k = [], R = "" + e;
    if (R !== "none") {
...
tt.css = function() {
  ...
  if (e.length === 1)
    for (var r = e[0], a = 0; a < t.properties.length; a++) {
      ...
      i === void 0 && (i = r[sn(n.name)]), i !== void 0 && this.cssRule(n.name, i);
    }
  else
...
tt.append = function(t) {
  return uo(t) ? t.appendToStyle(this) : Ie(t) ? this.appendFromJson(t) : le(t) && this.appendFromString(t), this;
};
...
[rt, ba, gi, St, dn, pi, qe, gn].forEach(function(t) {
  ce(tt, t);
});
je.types = tt.types;
...
var yy = {
  ...
  setStyle: function(e) {
    var r = this._private;
    return uo(e) ? r.style = e.generateStyle(this) : Ie(e) ? r.style = je.fromJson(this, e) : le(e) ? r.style = je.fromString(this, e) : r.style = je(this), r.style;
  },
  ...
  selectionType: function(e) {
    var r = this._private;
    if (r.selectionType == null && (r.selectionType = my), e !== void 0)
  ...
  getZoomedViewport: function(e) {
    ...
    if (r.zoomingEnabled || (o = !0), ae(e) ? s = e : Te(e) && (s = e.level, e.position != null ? i = un(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !r.panningEnabled && (o = !0)), s = s > r.maxZoom ? r.maxZoom : s, s = s < r.minZoom ? r.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var u = a, l = n, f = s, h = {
        x: -f / l * (i.x - u.x) + i.x,
...
ir.centre = ir.center;
ir.autolockNodes = ir.autolock;
ir.autoungrabifyNodes = ir.autoungrabify;
var la = {
  data: Le.data({
    field: "data",
    bindingEvent: "data",
...
ce(Ka, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !Ya(e) && Ya(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = !0, r.invalidateSize(), r.initRenderer(ce({}, n, n.renderer, {
...
Ka.$id = Ka.getElementById;
[oy, vy, ru, Un, Va, dy, Yn, _a, yy, ir, la].forEach(function(t) {
  ce(Ka, t);
});
var by = {
  fit: !0,
...
function pn(t) {
  this.options = ce({}, xy, t), this.options.layout = this;
}
pn.prototype.run = function() {
  ...
  var a = Ty(e, r, t);
  Mn && Sy(a), t.randomize && Ly(a);
  var n = Mt(), i = function() {
    Ay(a, e, t), t.fit === !0 && e.fit(t.padding);
  }, s = function(c) {
    return !(r.stopped || c >= t.numIter || (Oy(a, t), a.temperature = a.temperature * t.coolingFactor, a.temperature < t.minTemp));
  }, o = function() {
  ...
  if (t.animate === !0) {
    var f = function h() {
      ...
      if (!l)
        ...
        var v = Mt();
        v - n >= t.animationThreshold && i(), Ha(h);
      }
    };
    f();
  } else {
...
var Ty = function(e, r, a) {
  ...
  for (var l = 0; l < s.edgeSize; l++) {
    ...
    if (I != k) {
      for (var R = Cy(A.sourceId, A.targetId, s), B = s.graphSet[R], z = 0, g = s.layoutNodes[O]; B.indexOf(g.id) === -1; )
  ...
  var n = a.layout, i = a.eles.nodes(), s = su(e, a, i);
  i.positions(s), e.ready !== !0 && (e.ready = !0, n.one("layoutready", a.ready), n.emit({
    type: "layoutready",
    layout: this
  }));
}, Oy = function(e, r, a) {
  Ny(e, r), Ry(e), ky(e, r), Py(e), By(e);
}, Ny = function(e, r) {
  ...
  if (!(i !== s && !a.isCompound)) {
    ...
    o === 0 && u === 0 && (o = Ss(l), u = Ss(l));
    var f = Iy(e, r, o, u);
    if (f > 0)
      var h = n.nodeOverlap * f, c = Math.sqrt(o * o + u * u), v = h * o / c, d = h * u / c;
    else
      var g = Za(e, o, u), y = Za(r, -1 * o, -1 * u), p = y.x - g.x, E = y.y - g.y, m = p * p + E * E, c = Math.sqrt(m), h = (e.nodeRepulsion + r.nodeRepulsion) / m, v = h * p / c, d = h * E / c;
  ...
  for (var a = 0; a < e.edgeSize; a++) {
    ...
    if (!(l === 0 && f === 0)) {
      var h = Za(s, l, f), c = Za(u, -1 * l, -1 * f), v = c.x - h.x, d = c.y - h.y, g = Math.sqrt(v * v + d * d), y = Math.pow(n.idealLength - g, 2) / n.elasticity;
      if (g !== 0)
        var p = y * v / g, E = y * d / g;
      else
        var p = 0, E = 0;
  ...
  for (var a = 0; a < e.nodeSize; a++) {
    ...
    if (!(0 < n.children.length || n.isLocked)) {
      var i = Fy(n.offsetX, n.offsetY, e.temperature);
      n.positionX += i.x, n.positionY += i.y, n.offsetX = 0, n.offsetY = 0, n.minX = n.positionX - n.width, n.maxX = n.positionX + n.width, n.minY = n.positionY - n.height, n.maxY = n.positionY + n.height, Gy(n, e);
    }
  }
  for (var a = 0; a < e.nodeSize; a++) {
    var n = e.layoutNodes[a];
...
var mi = {};
mi.arrowShapeWidth = 0.3;
mi.registerArrowShapes = function() {
  ...
  function E(b) {
    ...
    if (w.edgeType === "segments" || w.edgeType === "straight" || w.edgeType === "haystack") {
      for (var I = w.allpts, k = 0; k + 3 < I.length; k += 2)
        if (cg(t, e, I[k], I[k + 1], I[k + 2], I[k + 3], O) && M > (P = mg(t, e, I[k], I[k + 1], I[k + 2], I[k + 3])))
          return y(b, P), !0;
      ...
      for (var I = w.allpts, k = 0; k + 5 < w.allpts.length; k += 4)
        if (dg(t, e, I[k], I[k + 1], I[k + 2], I[k + 3], I[k + 4], I[k + 5], O) && M > (P = yg(t, e, I[k], I[k + 1], I[k + 2], I[k + 3], I[k + 4], I[k + 5])))
          return y(b, P), !0;
    }
...
var Qa = {};
Qa.calculateArrowAngles = function(t) {
  ...
  if (e.midtgtArrowAngle = La(u, l), e.midDispX = u, e.midDispY = l, u *= -1, l *= -1, i) {
    var d = e.allpts;
    if (d.length / 2 % 2 !== 0) {
  ...
  if (e.midsrcArrowAngle = La(u, l), i)
    ...
    u = c - p, l = v - E;
  e.tgtArrowAngle = La(u, l);
};
Qa.getArrowWidth = Qa.getArrowHeight = function(t, e) {
...
it.findBezierPoints = function(t, e, r, a, n) {
  ...
  for (var p = 0; p < v; p++) {
    var E = (0.5 - e.eles.length / 2 + r) * f * (n ? -1 : 1), m = void 0, T = To(E);
...
it.findTaxiPoints = function(t, e) {
  ...
  var I = p === a, k = I ? O : M, R = I ? A : D, B = To(R), z = !1;
  ...
  if (!(!t || t.length === 0)) {
    ...
    for (var T = function(b) {
      ...
      if (!w.hasUnbundled) {
        ...
        oi(w.eles), A.forEach(function(J) {
...
it.getSegmentPoints = function(t) {
  ...
  if (r === "segments")
    return this.recalculateRenderedStyle(t), hu(e.segpts);
};
it.getControlPoints = function(t) {
  var e = t[0]._private.rscratch, r = e.edgeType;
  if (r === "bezier" || r === "multibezier" || r === "self" || r === "compound")
    return this.recalculateRenderedStyle(t), hu(e.ctrlpts);
};
...
var Ea = {};
Ea.manualEndptToPx = function(t, e) {
...
Ea.findEndpoints = function(t) {
  ...
  if (w === "inside-to-node")
    ...
    if (G.length > 0) {
      var X = i, K = jt(X, Er(r)), Z = jt(X, Er(G)), te = K;
  ...
  var de = Aa(r, D, e.arrowShapes[o].spacing(t) + l), ee = Aa(r, D, e.arrowShapes[o].gap(t) + l);
  if (c.endX = ee[0], c.endY = ee[1], c.arrowEndX = de[0], c.arrowEndY = de[1], b === "inside-to-node")
    ...
    if (N.length > 0) {
      var _ = s, Q = jt(_, Er(r)), q = jt(_, Er(N)), W = Q;
  ...
  var j = Aa(r, A, e.arrowShapes[u].spacing(t) + f), oe = Aa(r, A, e.arrowShapes[u].gap(t) + f);
...
Ea.getSourceEndpoint = function(t) {
  var e = t[0]._private.rscratch;
...
Ea.getTargetEndpoint = function(t) {
  var e = t[0]._private.rscratch;
  switch (this.recalculateRenderedStyle(t), e.edgeType) {
    case "haystack":
      return {
...
bi.storeEdgeProjections = function(t) {
  ...
  if (e.rstyle.bezierPts = null, e.rstyle.linePts = null, e.rstyle.haystackPts = null, a === "multibezier" || a === "bezier" || a === "self" || a === "compound") {
    ...
    for (var n = 0; n + 5 < r.allpts.length; n += 4)
      Yy(this, t, r.allpts.slice(n, n + 6));
  } else if (a === "segments")
...
bi.recalculateEdgeProjections = function(t) {
  ...
  if (!!(i.mid || i.source || i.target)) {
    ...
    var u = function f() {
      ...
      function E(b, x, w, D, A) {
        var L = ar(x, w), M = b.segments[b.segments.length - 1], O = {
          p0: x,
          p1: w,
          t0: D,
          t1: A,
      ...
      if (!!i[h]) {
        ...
        switch (a.edgeType) {
          ...
          case "multibezier": {
            ...
            L = ia(0, L, 1), e = xr(x.p0, x.p1, x.p2, L), c = Hy(x.p0, x.p1, x.p2, L);
            break;
          }
          case "straight":
          case "segments":
          case "haystack": {
            for (var M = 0, O, P, I, k, R = a.allpts.length, B = 0; B + 3 < R && (v ? (I = {
              ...
              x: a.allpts[R - 4 - B],
              y: a.allpts[R - 3 - B]
            }), O = ar(I, k), P = M, M += O, !(M >= d)); B += 2)
              ;
            var z = d - P, F = z / O;
            F = ia(0, F, 1), e = og(I, k, F), c = cu(I, k);
            break;
          }
        }
...
Lt.calculateLabelDimensions = function(t, e) {
  var r = this, a = rr(e, t._private.labelDimsKey), n = r.labelDimCache || (r.labelDimCache = []), i = n[a];
  if (i != null)
    return i;
...
var du = {}, Ns = 28, Ms = !1;
du.getNodeShape = function(t) {
  var e = this, r = t.pstyle("shape").value;
  if (r === "cutrectangle" && (t.width() < Ns || t.height() < Ns))
    return Ms || (Ae("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Ms = !0), "rectangle";
  if (t.isParent())
...
yn.onUpdateEleCalcs = function(t) {
  var e = this.onUpdateEleCalcsFns = this.onUpdateEleCalcsFns || [];
  e.push(t);
};
yn.recalculateRenderedStyle = function(t, e) {
  var r = function(T) {
...
var mn = {};
mn.updateCachedGrabbedEles = function() {
...
mn.invalidateCachedZSortedEles = function() {
  this.cachedZSortedEles = null;
};
mn.getCachedZSortedEles = function(t) {
  if (t || !this.cachedZSortedEles) {
    var e = this.cy.mutableElements().toArray();
    e.sort(eu), e.interactive = e.filter(function(r) {
...
var gu = {};
[fr, Qa, it, Ea, bi, Lt, du, yn, mn].forEach(function(t) {
  ce(gu, t);
});
var pu = {};
...
Br.binder = function(t) {
  var e = this, r = t === window || t === document || t === document.body || vd(t);
    ...
    if (!(!_ && !x(N))) {
      ...
      if (t.hoverData.which === 3) {
        if (He) {
          ...
          ye ? ye.emit(Qt) : q.emit(Qt), t.hoverData.cxtDragged = !0, (!t.hoverData.cxtOver || me !== t.hoverData.cxtOver) && (t.hoverData.cxtOver && t.hoverData.cxtOver.emit({
            originalEvent: N,
            type: "cxtdragout",
            position: {
              x: j[0],
    ...
    if (!!_) {
      ...
      if (t.data.bgActivePosistion && (t.redrawHint("select", !0), t.redraw()), t.hoverData.tapholdCancelled = !0, t.data.bgActivePosistion = void 0, oe && oe.unactivate(), t.hoverData.which === 3) {
        ...
        if (r(pe, ["mouseup", "tapend", "vmouseup"], N, {
          x: q[0],
          y: q[1]
        }), !t.dragData.didDrag && !t.hoverData.dragged && !t.hoverData.selecting && !t.hoverData.isOverThresholdDrag && (r(oe, ["click", "tap", "vclick"], N, {
          x: q[0],
          y: q[1]
  ...
  t.registerBinding(window, "touchmove", K = function(N) {
    ...
    if (!(!_ && !x(N))) {
      ...
      if (_ && t.touchData.cxt) {
        N.preventDefault();
        var yt = N.touches[0].clientX - F, Xe = N.touches[0].clientY - $, vt = N.touches[1].clientX - F, at = N.touches[1].clientY - $, Ot = G(yt, Xe, vt, at), Bt = Ot / R, vr = 150, Qt = vr * vr, cr = 1.5, Ta = cr * cr;
        if (Bt >= Ta || Ot >= Qt) {
      ...
      if (_ && t.touchData.cxt) {
        ...
        if (Je) {
          ...
          for (var ot = 0; ot < Je.length; ot++) {
            var Ca = Je[ot]._private;
            Ca.grabbed = !1, Ca.rscratch.inDragLayer = !1;
          }
        }
        var Tt = t.touchData.start, yt = N.touches[0].clientX - F, Xe = N.touches[0].clientY - $, vt = N.touches[1].clientX - F, at = N.touches[1].clientY - $, wi = Y(yt, Xe, vt, at), Bu = wi / k;
        if (H) {
          var Fu = yt - M, Gu = Xe - O, zu = vt - P, $u = at - I, Vu = (Fu + zu) / 2, _u = (Gu + $u) / 2, zr = q.zoom(), bn = zr * Bu, Da = q.pan(), xi = z[0] * zr + Da.x, Ti = z[1] * zr + Da.y, Uu = {
            x: -bn / zr * (xi - Da.x - Vu) + xi,
            y: -bn / zr * (Ti - Da.y - _u) + Ti
          };
          if (Tt && Tt.active()) {
            var Je = t.dragData.touchDragEles;
          ...
          }), q.emit("pinchzoom"), k = wi, M = yt, O = Xe, P = vt, I = at, t.pinching = !0;
        }
        if (N.touches[0]) {
          var oe = t.projectIntoViewport(N.touches[0].clientX, N.touches[0].clientY);
          W[0] = oe[0], W[1] = oe[1];
        ...
        var mt = t.touchData.start, En = t.touchData.last, st;
        if (!t.hoverData.draggingEles && !t.swipePanning && (st = t.findNearestElement(W[0], W[1], !0, !0)), _ && mt != null && N.preventDefault(), _ && mt != null && t.nodeIsDraggable(mt))
          if (Oe) {
            var Je = t.dragData.touchDragEles, Ci = !t.dragData.didDrag;
            Ci && v(Je, {
              inDragLayer: !0
            ...
            if (ae(me[0]) && ae(me[1]) && ($r.x += me[0], $r.y += me[1], Ci)) {
              t.redrawHint("eles", !0);
        ...
        if (r(mt || st, ["touchmove", "tapdrag", "vmousemove"], N, {
          x: W[0],
          y: W[1]
        }), (!mt || !mt.grabbed()) && st != En && (En && En.emit({
          originalEvent: N,
          type: "tapdragout",
          position: {
            x: W[0],
        ...
        if (_ && (mt == null || mt.pannable()) && q.panningEnabled() && q.userPanningEnabled()) {
          var Yu = n(mt, t.touchData.starts);
          Yu && (N.preventDefault(), t.data.bgActivePosistion || (t.data.bgActivePosistion = Er(t.touchData.startPosition)), t.swipePanning ? (q.panBy({
            x: me[0] * j,
            y: me[1] * j
...
kt.generateEllipse = function() {
  return this.nodeShapes.ellipse = {
    ...
    intersectLine: function(e, r, a, n, i, s, o) {
      return Eg(i, s, e, r, a / 2 + o, n / 2 + o);
    },
    checkPoint: function(e, r, a, n, i, s, o) {
      return tr(e, r, n, i, s, o, a);
    }
  };
};
kt.generateRoundPolygon = function(t, e) {
  ...
  return this.nodeShapes[t] = {
    ...
    intersectLine: function(f, h, c, v, d, g, y) {
      return wg(d, g, this.points, f, h, c, v);
    },
    checkPoint: function(f, h, c, v, d, g, y) {
      return bg(f, h, this.points, g, y, v, d);
    }
  };
};
kt.generateRoundRectangle = function() {
  return this.nodeShapes["round-rectangle"] = this.nodeShapes.roundrectangle = {
    ...
    intersectLine: function(e, r, a, n, i, s, o) {
      return Do(i, s, e, r, a, n, o);
    },
    checkPoint: function(e, r, a, n, i, s, o) {
      var u = ya(n, i), l = u * 2;
      return !!(It(e, r, this.points, s, o, n, i - l, [0, -1], a) || It(e, r, this.points, s, o, n - l, i, [0, -1], a) || tr(e, r, l, l, s - n / 2 + u, o - i / 2 + u, a) || tr(e, r, l, l, s + n / 2 - u, o - i / 2 + u, a) || tr(e, r, l, l, s + n / 2 - u, o + i / 2 - u, a) || tr(e, r, l, l, s - n / 2 + u, o + i / 2 - u, a));
    }
  };
};
...
kt.generateBarrel = function() {
  return this.nodeShapes.barrel = {
    ...
    generateBarrelBezierPts: function(e, r, a, n) {
      var i = r / 2, s = e / 2, o = a - s, u = a + s, l = n - i, f = n + i, h = Gn(e, r), c = h.heightOffset, v = h.widthOffset, d = h.ctrlPtOffsetPct * e, g = {
    ...
    checkPoint: function(e, r, a, n, i, s, o) {
      var u = Gn(n, i), l = u.heightOffset, f = u.widthOffset;
      ...
      for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(b, x, w) {
        ...
        if (P <= b && b <= I && k <= x && x <= R) {
          var B = xg(D, A, L), z = gg(B[0], B[1], B[2], b), F = z.filter(function($) {
            return 0 <= $ && $ <= 1;
          });
          if (F.length > 0)
            return F[0];
...
kt.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, r, a, n, i, s, o) {
      ...
      return c.length > 0 ? c : Do(i, s, e, r, a, n, o);
    },
    checkPoint: function(e, r, a, n, i, s, o) {
      var u = ya(n, i), l = 2 * u;
      ...
      return !!(ut(e, r, c) || tr(e, r, l, l, s + n / 2 - u, o + i / 2 - u, a) || tr(e, r, l, l, s - n / 2 + u, o + i / 2 - u, a));
    }
  };
};
kt.registerNodeShapes = function() {
  ...
  var a = new Array(20);
  {
    var n = Fn(5, 0), i = Fn(5, Math.PI / 5), s = 0.5 * (3 - Math.sqrt(5));
    s *= 1.57;
  ...
  a = Ao(a), this.generatePolygon("star", a), this.generatePolygon("vee", [-1, -1, 0, -0.333, 1, -1, 0, 1]), this.generatePolygon("rhomboid", [-1, -1, 0.333, -1, 1, 1, -0.333, 1]), this.nodeShapes.concavehexagon = this.generatePolygon("concave-hexagon", [-1, -0.95, -0.75, 0, -1, 0.95, 1, 0.95, 0.75, 0, 1, -0.95]);
  {
...
[mi, gu, pu, Br, kt, wa].forEach(function(t) {
  ce(Fr, t);
});
var In = 1e3 / 60, mu = {
  ...
  function t(e) {
    ...
    ti(this, t), this.idsByKey = new Dt(), this.keyForId = new Dt(), this.cachesByLvl = new Dt(), this.lvls = [], this.getKey = e, this.doesEleInvalidateKey = r;
  }
  return ri(t, [{
    key: "getIdsFor",
    value: function(r) {
...
}(), Rs = 25, Ba = 50, Ua = -4, Hn = 3, Wy = 7.99, Ky = 8, Zy = 1024, Qy = 1024, Jy = 1024, jy = 0.2, em = 0.8, tm = 10, rm = 0.15, am = 0.1, nm = 0.9, im = 0.9, sm = 100, om = 1, wr = {
  dequeue: "dequeue",
  downscale: "downscale",
  ...
  var n = um(r);
  ce(a, n), a.lookup = new qy(n.getKey, n.doesEleInvalidateKey), a.setupDequeueing();
}, Ue = Kr.prototype;
Ue.reasons = wr;
...
Ue.getElementQueue = function() {
  var t = this, e = t.eleCacheQueue = t.eleCacheQueue || new da.default(function(r, a) {
...
Ue.getElement = function(t, e, r, a, n) {
  ...
  if (!e || e.w === 0 || e.h === 0 || isNaN(e.w) || isNaN(e.h) || !t.visible() || t.removed() || !i.allowEdgeTxrCaching && t.isEdge() || !i.allowParentTxrCaching && t.isParent())
    return null;
  if (a == null && (a = Math.ceil(ui(o * r))), a < Ua)
    a = Ua;
  else if (o >= Wy || a > Hn)
    return null;
  ...
  if (v && v.invalidated && (v.invalidated = !1, v.texture.invalidatedWidth -= v.width), v)
    return v;
  var d;
  if (f <= Rs ? d = Rs : f <= Ba ? d = Ba : d = Math.ceil(f / Ba) * Ba, f > Jy || h > Qy)
    return null;
  ...
  }, m = n && n === wr.dequeue, T = n && n === wr.highQuality, C = n && n === wr.downscale, S, b = a + 1; b <= Hn; b++) {
    var x = u.get(t, b);
    if (x) {
      S = x;
      break;
  ...
  return v = {
    ...
    height: f,
    scaledLabelShown: c
  }, y.usedWidth += Math.ceil(h + Ky), y.eleCaches.push(v), u.set(t, a, v), i.checkTextureFullness(y), v;
};
...
Ue.checkTextureUtility = function(t) {
  t.invalidatedWidth >= jy * t.width && this.retireTexture(t);
};
Ue.checkTextureFullness = function(t) {
  var e = this, r = e.getTextureQueue(t.height);
  t.usedWidth / t.width > em && t.fullnessChecks >= tm ? Ht(r, t) : t.fullnessChecks++;
};
...
Ue.addTexture = function(t, e) {
  ...
  return a.push(n), n.eleCaches = [], n.height = t, n.width = Math.max(Zy, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = r.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
};
Ue.recycleTexture = function(t, e) {
  for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, oi(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), Ht(n, s), a.push(s), s;
  }
};
...
Ue.dequeue = function(t) {
  for (var e = this, r = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < om && r.size() > 0; s++) {
...
Ue.setupDequeueing = mu.setupDequeueing({
  deqRedrawThreshold: sm,
  deqCost: rm,
  deqAvgCost: am,
  deqNoDrawCost: nm,
  deqFastCost: im,
...
var lm = 1, Jr = -4, Ja = 2, fm = 3.99, hm = 50, vm = 50, cm = 0.15, dm = 0.1, gm = 0.9, pm = 0.9, ym = 1, ks = 250, mm = 4e3 * 4e3, bm = !0, bu = function(e) {
  var r = this, a = r.renderer = e, n = a.cy;
  r.layersByLevel = {}, r.firstGet = !0, r.lastInvalidationTime = Mt() - 2 * ks, r.skipping = !1, r.eleTxrDeqs = n.collection(), r.scheduleElementRefinement = nn.default(function() {
    r.refineElementTextures(r.eleTxrDeqs), r.eleTxrDeqs.unmerge(r.eleTxrDeqs);
  }, vm), a.beforeRender(function(s, o) {
    o - r.lastInvalidationTime <= ks ? r.skipping = !0 : r.skipping = !1;
  }, a.beforeRenderPriorities.lyrTxrSkip);
  var i = function(o, u) {
    return u.reqs - o.reqs;
  };
  r.layersQueue = new da.default(i), r.setupDequeueing();
}, Qe = bu.prototype, Ps = 0, Em = Math.pow(2, 53) - 1;
...
Qe.getLayers = function(t, e, r) {
  ...
  var u = a.layersByLevel, l = Math.pow(2, r), f = u[r] = u[r] || [], h, c = a.levelIsComplete(r, t), v, d = function() {
    var D = function(P) {
      ...
      if (!v)
        for (var I = r + P; Jr <= I && I <= Ja && !D(I); I += P)
          ;
    };
    A(1), A(-1);
  ...
  if (a.skipping && !o)
    return null;
  for (var p = null, E = t.length / lm, m = !o, T = 0; T < t.length; T++) {
    var C = t[T], S = C._private.rscratch, b = S.imgLayerCaches = S.imgLayerCaches || {}, x = b[r];
    if (x) {
      p = x;
      continue;
    }
    if ((!p || p.eles.length >= E || !Co(p.bb, C.boundingBox())) && (p = y({
      insert: !0,
      after: p
    }), !p))
      return null;
...
Qe.drawEleInLayer = function(t, e, r, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (r = n.getEleLevelForLayerLevel(r, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, r, bm), i.setImgSmoothing(s, !0));
};
...
Qe.updateElementsInLayers = function(t, e) {
  for (var r = this, a = pa(t[0]), n = 0; n < t.length; n++)
    for (var i = a ? null : t[n], s = a ? t[n] : t[n].ele, o = s._private.rscratch, u = o.imgLayerCaches = o.imgLayerCaches || {}, l = Jr; l <= Ja; l++) {
      var f = u[l];
      !f || i && r.getEleLevelForLayerLevel(f.level) !== i.level || e(f, s, i);
    }
};
Qe.haveLayers = function() {
  for (var t = this, e = !1, r = Jr; r <= Ja; r++) {
...
Qe.dequeue = function(t) {
  for (var e = this, r = e.layersQueue, a = [], n = 0; n < ym && r.size() !== 0; ) {
    var i = r.peek();
    if (i.replacement) {
      r.pop();
      continue;
...
Qe.requestRedraw = nn.default(function() {
  var t = this.renderer;
  t.redrawHint("eles", !0), t.redrawHint("drag", !0), t.redraw();
}, 100);
Qe.setupDequeueing = mu.setupDequeueing({
...
At.drawCachedElement = function(t, e, r, a, n, i) {
  ...
  if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || li(c, a))) {
    ...
    s.drawElementUnderlay(t, e), s.drawCachedElementPortion(t, e, u, r, n, v, Dm, Om), (!d || !g) && s.drawCachedElementPortion(t, e, l, r, n, v, Sm, Rn), d && !g && (s.drawCachedElementPortion(t, e, f, r, n, v, Lm, Rn), s.drawCachedElementPortion(t, e, h, r, n, v, Am, Rn)), s.drawElementOverlay(t, e);
  }
};
...
Pt.drawEdgeOverlay = wu("overlay");
Pt.drawEdgeUnderlay = wu("underlay");
...
Pt.drawArrowShape = function(t, e, r, a, n, i, s, o) {
  ...
  if (l) {
    var p = u.arrowPathCache = u.arrowPathCache || [], E = rr(n), m = p[E];
...
var Ei = {};
Ei.safeDrawImage = function(t, e, r, a, n, i, s, o, u, l) {
  if (!(n <= 0 || i <= 0 || u <= 0 || l <= 0))
    try {
...
Ei.drawInscribedImage = function(t, e, r, a, n) {
    ...
    if (c != null && c !== "" && !isNaN(u) && !isNaN(l)) {
      ...
      if (S > 0 || x > 0 && b > 0) {
        ...
        if (S > 0) {
          ...
          I.indexOf("round") === 0 ? Nm(t, D, A, L, M, 2) : t.fillRect(D, A, L, M), t.fillStyle = O;
        }
        if (x > 0 && b > 0) {
...
Gr.drawNode = function(t, e, r) {
  ...
  if (!(!ae(h.x) || !ae(h.y)) && !(i && !e.visible())) {
    ...
    if (v) {
      t.translate(h.x, h.y);
      var F = s.nodePathCache = s.nodePathCache || [], $ = yo(B === "polygon" ? B + "," + z.join(",") : B, "" + u, "" + o), U = F[$];
...
Gr.drawNodeOverlay = xu("overlay");
Gr.drawNodeUnderlay = xu("underlay");
...
ht.createGradientStyleFor = function(t, e, r, a, n) {
  ...
  if (a === "radial-gradient")
    if (r.isEdge()) {
      var l = r.sourceEndpoint(), f = r.targetEndpoint(), h = r.midpoint(), c = ar(l, h), v = ar(f, h);
...
var Zt = {};
Zt.drawPolygonPath = function(t, e, r, a, n, i) {
  var s = a / 2, o = n / 2;
...
Zt.drawRoundPolygonPath = function(t, e, r, a, n, i) {
  var s = a / 2, o = n / 2, u = fi(a, n);
  t.beginPath && t.beginPath();
...
Zt.drawRoundRectanglePath = function(t, e, r, a, n) {
  var i = a / 2, s = n / 2, o = ya(a, n);
...
Zt.drawBottomRoundRectanglePath = function(t, e, r, a, n) {
  var i = a / 2, s = n / 2, o = ya(a, n);
...
Zt.drawCutRectanglePath = function(t, e, r, a, n) {
  var i = a / 2, s = n / 2, o = Oo();
...
Zt.drawBarrelPath = function(t, e, r, a, n) {
  var i = a / 2, s = n / 2, o = e - i, u = e + i, l = r - s, f = r + s, h = Gn(a, n), c = h.widthOffset, v = h.heightOffset, d = h.ctrlPtOffsetPct * c;
...
var Gs = Math.sin(0), zs = Math.cos(0), Xn = {}, qn = {}, Tu = Math.PI / 40;
for (var mr = 0 * Math.PI; mr < 2 * Math.PI; mr += Tu)
  Xn[mr] = Math.sin(mr), qn[mr] = Math.cos(mr);
Zt.drawEllipsePath = function(t, e, r, a, n) {
  if (t.beginPath && t.beginPath(), t.ellipse)
    t.ellipse(e, r, a / 2, n / 2, 0, 0, 2 * Math.PI);
  else
    for (var i, s, o = a / 2, u = n / 2, l = 0 * Math.PI; l < 2 * Math.PI; l += Tu)
      i = e - o * Xn[l] * Gs + o * qn[l] * zs, s = r + u * qn[l] * Gs + u * Xn[l] * zs, l === 0 ? t.moveTo(i, s) : t.lineTo(i, s);
  t.closePath();
};
var xa = {};
...
xa.png = function(t) {
  return Cu(t, this.bufferCanvasImage(t), "image/png");
};
xa.jpg = function(t) {
  return Cu(t, this.bufferCanvasImage(t), "image/jpeg");
};
var Du = {};
Du.nodeShapeImpl = function(t, e, r, a, n, i, s) {
  switch (t) {
    case "ellipse":
...
function Su(t) {
  ...
  gd() && (s["-ms-touch-action"] = "none", s["touch-action"] = "none");
...
[Eu, At, Pt, Ei, hr, Gr, ht, Zt, xa, Du].forEach(function(t) {
  ce(Ce, t);
});
var Pm = [{
  name: "null",
...
function Ou(t, e, r) {
  ...
  if (t === "core") {
    ...
    var v = Nu("renderer", "base"), d = v.prototype, g = r, y = r.prototype, p = function() {
...
sr.css = function(t, e) {
  ...
  if (le(t))
    ...
    for (var a = t, n = Object.keys(a), i = 0; i < n.length; i++) {
      var s = n[i], o = a[s];
      if (o != null) {
        var u = je.properties[s] || je.properties[sn(s)];
        if (u != null) {
          var l = u.name, f = o;
          this[r].properties.push({
            name: l,
...
sr.style = sr.css;
sr.generateStyle = function(t) {
  var e = new je(t);
  return this.appendToStyle(e);
};
sr.appendToStyle = function(t) {
  for (var e = 0; e < this.length; e++) {
...
or.use = function(t) {
  ...
  return e.unshift(or), t.apply(null, e), this;
};
or.warnings = function(t) {
  return bo(t);
};
or.version = zm;
or.stylesheet = or.Stylesheet = Mu;
var Iu = or, Ru = { exports: {} }, kn = { exports: {} }, Pn = { exports: {} }, Vs;
function $m() {
...
const _m = /* @__PURE__ */ Ku(Ru.exports);
Iu.use(_m);
function ku(t, e, r, a) {
  qs.drawNode(t, e, r, a), e.children && e.children.forEach((n, i) => {
    ku(t, n, r < 0 ? i : r, a);
  });
}
function Um(t, e) {
...
function Ym(t, e) {
  return new Promise((r) => {
    const a = Zr("body").append("div").attr("id", "cy").attr("style", "display:none"), n = Iu({
    ...
    a.remove(), Pu(t, n, e, 0), n.nodes().forEach(function(i) {
      i.layoutDimensions = () => {
        const s = i.data();
...
function Hm(t) {
  t.nodes().map((e, r) => {
    const a = e.data();
    a.x = e.position().x, a.y = e.position().y, qs.positionNode(a);
    const n = Zn(a.nodeId);
...
` + t);
  ...
  const h = u.append("g");
  h.attr("class", "mindmap-nodes"), ku(h, l, -1, n);
  const c = await Ym(l, n);
  Um(f, c), Hm(c), Xu(void 0, u, n.mindmap.padding, n.mindmap.useMaxWidth);
}, qm = {
  draw: Xm
}, Wm = (t) => {
  let e = "";
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++)
    t["lineColor" + r] = t["lineColor" + r] || t["cScaleInv" + r], Zu(t["lineColor" + r]) ? t["lineColor" + r] = qu(t["lineColor" + r], 20) : t["lineColor" + r] = Wu(t["lineColor" + r], 20);
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++) {
    const a = "" + (17 - 3 * r);
    e += `
...
//# sourceMappingURL=diagram-definition.f023a8d3.js.map
