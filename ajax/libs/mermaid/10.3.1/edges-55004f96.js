import { l as x, q as N, c as w, ax as z, j as E, d as F, z as j, F as Q } from "./mermaid-7e6c58c3.js";
import { c as rt } from "./createText-c64d47ca.js";
import { p as V } from "./svgDraw-3570afd5.js";
import { l as it } from "./line-331572f9.js";
const nt = (r, t, e, n) => {
  t.forEach((a) => {
    xt[a](r, e, n);
  });
...
const nr = (r, t) => {
  ...
  if (r.startLabelLeft) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = j.calcTerminalLabelPosition(r.arrowTypeStart ? 10 : 0, "start_left", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
  if (r.startLabelRight) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = j.calcTerminalLabelPosition(
  ...
  if (r.endLabelLeft) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = j.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_left", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
  if (r.endLabelRight) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = j.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_right", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
