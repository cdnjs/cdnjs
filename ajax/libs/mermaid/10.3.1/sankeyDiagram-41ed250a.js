import { c as getConfig, g as getAccTitle, s as setAccTitle, a as getAccDescription, b as setAccDescription, D as getDiagramTitle, B as setDiagramTitle, E as clear$1, f as common, aw as defaultConfig, j as d3select, k as configureSvgSize } from "./mermaid-a918c5c0.js";
...
const draw = function(text, id, _version, diagObj) {
  ...
  const nodeWidth = 10;
  const sankey = Sankey().nodeId((d) => d.id).nodeWidth(nodeWidth).nodePadding(10).nodeAlign(nodeAlign).extent([
    [0, 0],
    [width, height]
  ]);
  sankey(graph);
