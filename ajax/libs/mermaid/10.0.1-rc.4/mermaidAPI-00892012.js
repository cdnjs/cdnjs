...
import { g as getConfig, l as log, f as setConfig, h as getSiteConfig, u as updateSiteConfig, r as reset, i as defaultConfig, s as setLogLevel, a as addDirective, j as evaluate, k as saveConfigFromInitialize, t as theme, m as setSiteConfig } from "./config-389b86ff.js";
import { a as registerDiagram, r as registerLazyLoadedDiagrams, d as detectType, g as getDiagram, e as extractFrontMatter, b as getDiagramLoader, U as UnknownDiagramError, p as parseDirective, u as utils, c as directiveSanitizer, f as getStyles } from "./utils-d5eeff82.js";
import { r as renderer } from "./errorRenderer-d05351b9.js";
import DOMPurify from "dompurify";
import isEmpty from "lodash-es/isEmpty.js";
const version = "10.0.1-rc.4";
const id$i = "c4";
const detector$i = (txt) => {
  return txt.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
};
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-59e398b6.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-7d05efc6.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-b98ae8e2.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-ff16dd15.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-02e1e810.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-3916c8ee.js");
...
const loader$c = async () => {
  const { diagram } = await import("./infoDiagram-1b335302.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-40ff0b1a.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-d61dc50e.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-31e82e86.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-5bd5e829.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-e460cb0c.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-d24dcb37.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-2df72fe7.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-a84c9fa2.js");
...
const loader$3 = async () => {
  const { diagram } = await import("./errorDiagram-bb949655.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-c1e1e4f8.js");
...
const loader$1 = async () => {
  const { diagram } = await import("./timeline-definition-24ebf147.js");
...
const loader = async () => {
  const { diagram } = await import("./mindmap-definition-c8a05b8a.js");
  return { id, diagram };
};
const plugin = {
  id,
...
//# sourceMappingURL=mermaidAPI-00892012.js.map
