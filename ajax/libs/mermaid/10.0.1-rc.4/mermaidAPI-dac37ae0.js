...
const Se = "10.0.1-rc.4", We = "c4", ar = (e) => e.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null, nr = async () => {
  const { diagram: e } = await import("./c4Diagram-f988ed6f.js");
  ...
  const { diagram: e } = await import("./flowDiagram-a2178b9f.js");
  ...
  const { diagram: e } = await import("./flowDiagram-v2-cd9bb30a.js");
  ...
  const { diagram: e } = await import("./erDiagram-e426066f.js");
  ...
  const { diagram: e } = await import("./gitGraphDiagram-f6674f1b.js");
  ...
  const { diagram: e } = await import("./ganttDiagram-b8d1ef8b.js");
  ...
  const { diagram: e } = await import("./pieDiagram-ef1678aa.js");
  ...
  const { diagram: e } = await import("./requirementDiagram-0704ee96.js");
  ...
  const { diagram: e } = await import("./sequenceDiagram-95b5e122.js");
  ...
  const { diagram: e } = await import("./classDiagram-46e88b66.js");
  ...
  const { diagram: e } = await import("./classDiagram-v2-6c019d01.js");
  ...
  const { diagram: e } = await import("./stateDiagram-c03b63db.js");
  ...
  const { diagram: e } = await import("./stateDiagram-v2-ebbdf48c.js");
  ...
  const { diagram: e } = await import("./journeyDiagram-111cc5d5.js");
  ...
  const { diagram: e } = await import("./flowchart-elk-definition-1d3f2b81.js");
...
//# sourceMappingURL=mermaidAPI-dac37ae0.js.map
