import { g as getConfig, l as log, h as setConfig, i as getSiteConfig, u as updateSiteConfig, r as reset, j as defaultConfig, s as setLogLevel, a as addDirective, f as select, k as evaluate, p as purify, m as saveConfigFromInitialize, t as theme, n as setSiteConfig } from "./config-b4fa35bb.js";
import { a as registerDiagram, r as registerLazyLoadedDiagrams, d as detectType, g as getDiagram, e as extractFrontMatter, b as getDiagramLoader, U as UnknownDiagramError, c as getNative, f as root, t as toSource, h as baseGetTag, M as Map, j as isFunction, k as freeGlobal, p as parseDirective, u as utils, m as directiveSanitizer, n as getStyles } from "./utils-872dfc50.js";
...
const version = "10.0.1-rc.5";
const id$i = "c4";
const detector$i = (txt) => {
  return txt.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
};
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-f1ee6620.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-0fe4d9e8.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-1e230af2.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-e1492a39.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-12dad8b8.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-5122891c.js");
...
const loader$c = async () => {
  const { diagram } = await import("./infoDiagram-47175ff4.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-96d9347f.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-781cb062.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-e3cce0c9.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-485657ba.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-ba43c3ea.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-f50429d5.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-d45eb29b.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-e4a5d820.js");
...
const loader$3 = async () => {
  const { diagram } = await import("./errorDiagram-8d01edd9.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-25f6b683.js");
...
const loader$1 = async () => {
  const { diagram } = await import("./timeline-definition-3a60be4b.js");
...
const loader = async () => {
  const { diagram } = await import("./mindmap-definition-b11d8ccb.js");
  return { id, diagram };
};
const plugin = {
  id,
...
//# sourceMappingURL=mermaidAPI-a4ea135a.js.map
