...
const Se = "10.0.1-rc.5", We = "c4", ar = (e) => e.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null, nr = async () => {
  const { diagram: e } = await import("./c4Diagram-e25a2e71.js");
  ...
  const { diagram: e } = await import("./flowDiagram-c6967c01.js");
  ...
  const { diagram: e } = await import("./flowDiagram-v2-39b724ba.js");
  ...
  const { diagram: e } = await import("./erDiagram-9bc53dbb.js");
  ...
  const { diagram: e } = await import("./gitGraphDiagram-b84c10aa.js");
  ...
  const { diagram: e } = await import("./ganttDiagram-4feae85d.js");
  ...
  const { diagram: e } = await import("./pieDiagram-67f8262b.js");
  ...
  const { diagram: e } = await import("./requirementDiagram-5e49e58a.js");
  ...
  const { diagram: e } = await import("./sequenceDiagram-1c418db7.js");
  ...
  const { diagram: e } = await import("./classDiagram-02b3c365.js");
  ...
  const { diagram: e } = await import("./classDiagram-v2-d146ae6d.js");
  ...
  const { diagram: e } = await import("./stateDiagram-fe1ee9c6.js");
  ...
  const { diagram: e } = await import("./stateDiagram-v2-2bbbc829.js");
  ...
  const { diagram: e } = await import("./journeyDiagram-88cb29b2.js");
  ...
  const { diagram: e } = await import("./flowchart-elk-definition-9e77da25.js");
...
//# sourceMappingURL=mermaidAPI-d8af8047.js.map
