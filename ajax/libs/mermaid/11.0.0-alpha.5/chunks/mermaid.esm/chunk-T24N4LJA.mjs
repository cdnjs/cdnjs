  ...
  "../../node_modules/.pnpm/dayjs@1.11.7/node_modules/dayjs/dayjs.min.js"(exports, module) {
    ...
    !function(t, e) {
      ...
      var t = 1e3, e = 6e4, n = 36e5, r = "millisecond", i = "second", s = "minute", u = "hour", a = "day", o = "week", f = "month", h = "quarter", c = "year", d = "date", l = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t4) {
        ...
        return { M: f, y: c, w: o, d: a, D: d, h: u, m: s, s: i, ms: r, Q: h }[t4] || String(t4 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t4) {
        return void 0 === t4;
      } }, g = "en", D = {};
      D[g] = M;
      var p = /* @__PURE__ */ __name(function(t4) {
        return t4 instanceof _;
      }, "p"), S = /* @__PURE__ */ __name(function t4(e3, n2, r2) {
        var i2;
        if (!e3)
          return g;
        if ("string" == typeof e3) {
      ...
      }, "t"), w = /* @__PURE__ */ __name(function(t4, e3) {
        if (p(t4))
          return t4.clone();
      ...
      var _ = function() {
        ...
        return m2.parse = function(t4) {
          ...
          var n2 = this, r2 = !!O.u(e3) || e3, h2 = O.p(t4), l2 = /* @__PURE__ */ __name(function(t5, e4) {
          ...
          var n2, o2 = O.p(t4), h2 = "set" + (this.$u ? "UTC" : ""), l2 = (n2 = {}, n2[a] = h2 + "Date", n2[d] = h2 + "Date", n2[f] = h2 + "Month", n2[c] = h2 + "FullYear", n2[u] = h2 + "Hours", n2[s] = h2 + "Minutes", n2[i] = h2 + "Seconds", n2[r] = h2 + "Milliseconds", n2)[o2], $2 = o2 === a ? this.$D + (e3 - this.$W) : e3;
          if (o2 === f || o2 === c) {
          ...
          var d2, l2 = this;
          r2 = Number(r2);
          var $2 = O.p(h2), y3 = /* @__PURE__ */ __name(function(t4) {
            var e3 = w(l2);
          ...
          var r2 = t4 || "YYYY-MM-DDTHH:mm:ssZ", i2 = O.z(this), s2 = this.$H, u2 = this.$m, a2 = this.$M, o2 = n2.weekdays, f2 = n2.months, h2 = /* @__PURE__ */ __name(function(t5, n3, i3, s3) {
            return t5 && (t5[n3] || t5(e3, r2)) || i3[n3].slice(0, s3);
          }, "h"), c2 = /* @__PURE__ */ __name(function(t5) {
            return O.s(s2 % 12 || 12, t5, "0");
          }, "c"), d2 = n2.meridiem || function(t5, e4, n3) {
            var r3 = t5 < 12 ? "AM" : "PM";
          ...
          var $2, y3 = O.p(d2), M3 = w(r2), m3 = (M3.utcOffset() - this.utcOffset()) * e, v2 = this - M3, g2 = O.m(this, M3);
          return g2 = ($2 = {}, $2[c] = g2 / 12, $2[f] = g2, $2[h] = g2 / 3, $2[o] = (v2 - m3) / 6048e5, $2[a] = (v2 - m3) / 864e5, $2[u] = v2 / n, $2[s] = v2 / e, $2[i] = v2 / t, $2)[y3] || v2, l2 ? g2 : O.a(g2);
      ...
      return w.prototype = T, [["$ms", r], ["$s", i], ["$m", s], ["$H", u], ["$W", a], ["$M", f], ["$y", c], ["$D", d]].forEach(function(t4) {
        T[t4[1]] = function(e3) {
...
// ../../node_modules/.pnpm/dompurify@3.0.5/node_modules/dompurify/dist/purify.js
var require_purify = __commonJS({
  "../../node_modules/.pnpm/dompurify@3.0.5/node_modules/dompurify/dist/purify.js"(exports, module) {
    "use strict";
    (function(global, factory) {
      ...
      function addToSet(set3, array2, transformCaseFunc) {
      ...
      function createDOMPurify() {
        ...
        const _createIterator = /* @__PURE__ */ __name(function _createIterator2(root2) {
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/utils/channel.js
var Channel = {
  /* CLAMP */
  min: {
    r: 0,
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/utils/lang.js
var Lang = {
  /* API */
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/utils/unit.js
var Unit = {
  /* API */
  dec2hex: (dec) => {
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/utils/index.js
var Utils = {
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/constants.js
var DEC2HEX = {};
for (let i = 0; i <= 255; i++)
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/channels/type.js
var Type = class {
  static {
    __name(this, "Type");
  }
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/channels/index.js
var Channels = class {
  static {
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/channels/reusable.js
var channels = new channels_default({ r: 0, g: 0, b: 0, a: 0 }, "transparent");
var reusable_default = channels;

// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/color/hex.js
var Hex = {
  /* VARIABLES */
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/color/hsl.js
var HSL = {
  /* VARIABLES */
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/color/keyword.js
var Keyword = {
  /* VARIABLES */
  colors: {
    aliceblue: "#f0f8ff",
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/color/rgb.js
var RGB = {
  /* VARIABLES */
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/color/index.js
var Color = {
  /* VARIABLES */
  format: {
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/change.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/rgba.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/channel.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/luminance.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/is_light.js
var isLight = /* @__PURE__ */ __name((color2) => {
  return luminance_default(color2) >= 0.5;
}, "isLight");
var is_light_default = isLight;

// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/is_dark.js
var isDark = /* @__PURE__ */ __name((color2) => {
  return !is_light_default(color2);
}, "isDark");
var is_dark_default = isDark;

// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/adjust_channel.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/lighten.js
var lighten = /* @__PURE__ */ __name((color2, amount) => {
  return adjust_channel_default(color2, "l", amount);
}, "lighten");
var lighten_default = lighten;

// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/darken.js
var darken = /* @__PURE__ */ __name((color2, amount) => {
  return adjust_channel_default(color2, "l", -amount);
}, "darken");
var darken_default = darken;

// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/adjust.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/mix.js
...
// ../../node_modules/.pnpm/khroma@2.0.0/node_modules/khroma/dist/methods/invert.js
