...
// ../parser/dist/chunks/mermaid-parser.core/chunk-O6L2WK4J.mjs
...
var MermaidAstReflection = class extends AbstractAstReflection {
  ...
  getAllTypes() {
    return [Architecture, Axis, Branch, Checkout, CherryPicking, Commit, Curve, Direction, Edge, Entry, GitGraph, Group2, Info, Junction, Merge, Option2, Packet, PacketBlock, Pie, PieSection, Radar, Service, Statement];
  }
  computeIsSubtype(subtype, supertype) {
    switch (subtype) {
      case Branch:
