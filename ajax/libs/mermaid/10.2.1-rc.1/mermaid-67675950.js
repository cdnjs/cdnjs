...
const version = "10.2.1-rc.1";
const id$i = "c4";
const detector$i = (txt) => {
  return txt.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
};
const loader$i = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-db5a9fac.js");
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-c9700a66.js");
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-7f12d8de.js");
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-dcb67aac.js");
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-03e9bb3c.js");
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-63b93491.js");
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-6414e3f2.js");
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-d1023fbb.js");
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-607acc8f.js");
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-ee24b059.js");
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-766bebf3.js");
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-cac278ec.js");
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-5f7d0b36.js");
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-2e94ff6d.js");
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-dd734dd7.js");
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-845f133e.js");
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-22874db2.js");
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-2e71e3b2.js");
...
const loader = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-3121dd80.js");
...
if (DataView$1 && getTag(new DataView$1(new ArrayBuffer(1))) != dataViewTag$1 || Map$2 && getTag(new Map$2()) != mapTag$2 || Promise$2 && getTag(Promise$2.resolve()) != promiseTag || Set$1 && getTag(new Set$1()) != setTag$2 || WeakMap$1 && getTag(new WeakMap$1()) != weakMapTag$1) {
...
export {
  addFunction as $,
  getDiagramTitle as A,
  clear as B,
  Color$1 as C,
  curveBasis as D,
  parseGenericTypes as E,
  random as F,
  getConfig as G,
  ...
  Rgb as R,
  parseFontSize as S,
  getThemeVariables$2 as T,
  defaultConfig$1 as U,
  constant as V,
  interpolateNumber as W,
  color as X,
  interpolateRgb as Y,
  interpolateString as Z,
  _,
  ...
  defaultConfig as au,
  decodeEntities as av,
  commonDb$1 as aw,
  parseDirective$1 as ax,
  isDark$1 as ay,
  lighten$1 as az,
  ...
  curveLinear as o,
  getStylesFromArray as p,
  evaluate as q,
  interpolateToCurve as r,
  setAccTitle as s,
