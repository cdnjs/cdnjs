import { w as sanitizeText$1, g as getConfig, l as log, s as select, a as setupGraphViewbox, u as lighten, v as darken } from "./mermaid-826c5692.js";
import { i as isDark } from "./is_dark-09c2c34a.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-b0b53730.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-a6ea1c00.js").then((n) => n.c)).default;
...
//# sourceMappingURL=diagram-definition-d9e38f65.js.map
