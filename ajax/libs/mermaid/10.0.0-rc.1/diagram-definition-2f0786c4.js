import { w as ft, g as B, l as C, s as P, a as yt, u as mt, v as bt } from "./mermaid-39873191.js";
import { i as Et } from "./is_dark-fef7f56e.js";
var Z = function() {
...
async function zt(e, t) {
  if (!H) {
    H = (await import("./cytoscape.cjs-467d517e.js").then((s) => s.c)).default;
    const n = (await import("./cytoscape-cose-bilkent-90e34237.js").then((s) => s.c)).default;
    H.use(n);
  }
...
` + e);
  ...
  Ht(b, y), Gt(y), yt(void 0, g, i.mindmap.padding, i.mindmap.useMaxWidth);
}, Yt = {
  draw: Xt
}, qt = (e) => {
  let t = "";
  for (let n = 0; n < e.THEME_COLOR_LIMIT; n++)
    e["lineColor" + n] = e["lineColor" + n] || e["cScaleInv" + n], Et(e["lineColor" + n]) ? e["lineColor" + n] = mt(e["lineColor" + n], 20) : e["lineColor" + n] = bt(e["lineColor" + n], 20);
  for (let n = 0; n < e.THEME_COLOR_LIMIT; n++) {
    const s = "" + (17 - 3 * n);
    t += `
...
//# sourceMappingURL=diagram-definition-2f0786c4.js.map
