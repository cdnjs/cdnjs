import { s as He, g as We, a as qe, b as Je, c as R, z as Ze, A as $e, m as et, B as tt, l as st, f as De, x as Ve, j as M } from "./mermaid-9357f3d0.js";
var Be = function() {
  var e = function(v, n, r, c) {
    for (r = r || {}, c = v.length; c--; r[v[c]] = n)
      ;
    return r;
  }, u = [1, 34], l = [1, 35], o = [1, 36], h = [1, 37], F = [1, 9], m = [1, 8], _ = [1, 19], D = [1, 20], z = [1, 21], Y = [1, 40], L = [1, 41], K = [1, 27], j = [1, 25], Q = [1, 26], X = [1, 32], H = [1, 33], W = [1, 28], q = [1, 29], J = [1, 30], Z = [1, 31], f = [1, 45], d = [1, 42], E = [1, 43], C = [1, 44], k = [1, 46], pe = [1, 24], a = [1, 16, 24], $ = [1, 60], ee = [1, 61], te = [1, 62], se = [1, 63], ie = [1, 64], fe = [1, 65], de = [1, 66], ue = [1, 16, 24, 52], Le = [1, 77], w = [1, 16, 24, 27, 28, 36, 50, 52, 55, 68, 69, 70, 71, 72, 73, 74, 79, 81], ne = [1, 16, 24, 27, 28, 34, 36, 50, 52, 55, 59, 68, 69, 70, 71, 72, 73, 74, 79, 81, 94, 96, 97, 98, 99], Ie = [1, 86], re = [28, 94, 96, 97, 98, 99], V = [28, 73, 74, 94, 96, 97, 98, 99], xe = [28, 68, 69, 70, 71, 72, 94, 96, 97, 98, 99], Ee = [1, 99], Ce = [1, 16, 24, 50, 52, 55], ae = [1, 16, 24, 36], Oe = [8, 9, 10, 11, 19, 23, 44, 46, 48, 53, 57, 58, 60, 61, 63, 65, 75, 76, 78, 82, 94, 96, 97, 98, 99], ge = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(n, r, c, i, A, t, G) {
      var s = t.length - 1;
      switch (A) {
        case 4:
          i.setDirection("TB");
    ...
    parse: function(n) {
      var r = this, c = [0], i = [], A = [null], t = [], G = this.table, s = "", ce = 0, Re = 0, Ke = 2, Pe = 1, je = t.slice.call(arguments, 1), g = Object.create(this.lexer), I = { yy: {} };
      for (var ke in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, ke) && (I.yy[ke] = this.yy[ke]);
      g.setInput(n, I.yy), I.yy.lexer = g, I.yy.parser = this, typeof g.yylloc > "u" && (g.yylloc = {});
      var Fe = g.yylloc;
      t.push(Fe);
      var Qe = g.options && g.options.ranges;
      typeof I.yy.parseError == "function" ? this.parseError = I.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function Xe() {
        var y;
        return y = i.pop() || g.lex() || Pe, typeof y != "number" && (y instanceof Array && (i = y, y = i.pop()), y = r.symbols_[y] || y), y;
      }
      for (var b, x, B, be, O = {}, le, T, we, oe; ; ) {
        if (x = c[c.length - 1], this.defaultActions[x] ? B = this.defaultActions[x] : ((b === null || typeof b > "u") && (b = Xe()), B = G[x] && G[x][b]), typeof B > "u" || !B.length || !B[0]) {
          var _e = "";
          oe = [];
          for (le in G[x])
            this.terminals_[le] && le > Ke && oe.push("'" + this.terminals_[le] + "'");
          g.showPosition ? _e = "Parse error on line " + (ce + 1) + `:
` + g.showPosition() + `
Expecting ` + oe.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : _e = "Parse error on line " + (ce + 1) + ": Unexpected " + (b == Pe ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(_e, {
            text: g.match,
        ...
        switch (B[0]) {
          case 1:
            c.push(b), A.push(g.yytext), t.push(g.yylloc), c.push(B[1]), b = null, Re = g.yyleng, s = g.yytext, ce = g.yylineno, Fe = g.yylloc;
            break;
          case 2:
            if (T = this.productions_[B[1]][1], O.$ = A[A.length - T], O._$ = {
              ...
              A,
              t
            ].concat(je)), typeof be < "u")
              return be;
            T && (c = c.slice(0, -1 * T * 2), A = A.slice(0, -1 * T), t = t.slice(0, -1 * T)), c.push(this.productions_[B[1]][0]), A.push(O.$), t.push(O._$), we = G[c[c.length - 2]][c[c.length - 1]], c.push(we);
            break;
          case 3:
            return !0;
        }
...
` + r + "^";
      ...
      test_match: function(n, r) {
        ...
        }, this.yytext += n[0], this.match += n[0], this.matches = n, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(n[0].length), this.matched += n[0], c = this.performAction.call(this, this.yy, this, r, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), c)
          return c;
        if (this._backtrack) {
          for (var t in A)
            this[t] = A[t];
      ...
      next: function() {
        ...
        for (var A = this._currentRules(), t = 0; t < A.length; t++)
          if (c = this._input.match(this.rules[A[t]]), c && (!r || c[0].length > r[0].length)) {
            if (r = c, i = t, this.options.backtrack_lexer) {
              if (n = this.test_match(c, A[t]), n !== !1)
                return n;
              if (this._backtrack) {
                r = !1;
                continue;
...
` + this.showPosition(), {
      ...
      options: {},
      performAction: function(r, c, i, A) {
        switch (i) {
          case 0:
  ...
  return me.prototype = ge, ge.Parser = me, new me();
}();
Be.parser = Be;
const Lt = Be, Ae = "classId-";
let ve = [], p = {}, he = [], Te = 0, N = {}, ye = 0, U = [];
const S = (e) => De.sanitizeText(e, R()), it = function(e, u, l) {
  et.parseDirective(this, e, u, l);
}, P = function(e) {
  let u = "", l = e;
  if (e.indexOf("~") > 0) {
    const o = e.split("~");
  ...
  st.debug("Adding relation: " + JSON.stringify(e)), Se(e.id1), Se(e.id2), e.id1 = P(e.id1).className, e.id2 = P(e.id2).className, e.relationTitle1 = De.sanitizeText(
  ...
  Array.isArray(u) && (u.reverse(), u.forEach((l) => Me(e, l)));
}, pt = function(e, u) {
  const l = {
    id: `note${he.length}`,
    class: u,
  ...
  e.split(",").forEach(function(h) {
    let F = h;
    h[0].match(/\d/) && (F = Ae + F), p[F] !== void 0 && (p[F].link = Ve.formatUrl(u, o), o.securityLevel === "sandbox" ? p[F].linkTarget = "_top" : typeof l == "string" ? p[F].linkTarget = S(l) : p[F].linkTarget = "_blank");
  }), Ne(e, "clickable");
}, gt = function(e, u, l) {
  e.split(",").forEach(function(o) {
    mt(o, u, l), p[o].haveCallback = !0;
  }), Ne(e, "clickable");
}, mt = function(e, u, l) {
  if (R().securityLevel !== "loose" || u === void 0)
    return;
  const h = e;
  if (p[h] !== void 0) {
    const F = Ge(h);
    ...
    if (typeof l == "string") {
      ...
      for (let _ = 0; _ < m.length; _++) {
        let D = m[_].trim();
        D.charAt(0) === '"' && D.charAt(D.length - 1) === '"' && (D = D.substr(1, D.length - 2)), m[_] = D;
      }
    }
    m.length === 0 && m.push(F), U.push(function() {
      const _ = document.querySelector(`[id="${F}"]`);
  ...
  let u = M(".mermaidTooltip");
  (u._groups || u)[0][0] === null && (u = M("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), M(e).select("svg").selectAll("g.node").on("mouseover", function() {
    const h = M(this);
    if (h.attr("title") === null)
      return;
    const m = this.getBoundingClientRect();
    u.transition().duration(200).style("opacity", ".9"), u.text(h.attr("title")).style("left", window.scrollX + m.left + (m.right - m.left) / 2 + "px").style("top", window.scrollY + m.top - 14 + document.body.scrollTop + "px"), u.html(u.html().replace(/&lt;br\/&gt;/g, "<br/>")), h.classed("hover", !0);
  }).on("mouseout", function() {
    u.transition().duration(500).style("opacity", 0), M(this).classed("hover", !1);
  });
};
U.push(Ue);
let ze = "TB";
const _t = () => ze, Dt = (e) => {
  ...
  N[e] !== void 0 && u.map((l) => {
    N[e].classes[l] = p[l], delete p[l], Te--;
  });
}, It = {
  parseDirective: it,
  setAccTitle: He,
