import { U as Dt, V as I, l as lt, s as zt, g as Et, z as It, A as kt, a as Bt, b as Vt, c as Tt, m as wt, B as Rt, d as Wt, j as yt, k as Nt } from "./mermaid-9357f3d0.js";
import { l as St } from "./linear-e84f7512.js";
...
class Qt {
  ...
  getQuadrantPoints(a) {
    const { quadrantSpace: h } = a, { quadrantHeight: f, quadrantLeft: g, quadrantTop: x, quadrantWidth: c } = h, p = St().domain([0, 1]).range([g, c + g]), s = St().domain([0, 1]).range([f + x, x]);
