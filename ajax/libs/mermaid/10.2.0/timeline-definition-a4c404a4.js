import { ay as bt, az as kt, B as vt, j as Z, c as wt, l as T, t as St, aA as Et, aB as Tt, aC as It } from "./mermaid-9357f3d0.js";
...
var Y = function() {
  var n = function(k, r, a, h) {
    for (a = a || {}, h = k.length; h--; a[k[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], y = [1, 18], f = [1, 19], d = [1, 23], m = [1, 24], S = [1, 27], _ = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], b = {
    trace: function() {
    },
    yy: {},
...
Expecting ` + U.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : X = "Parse error on line " + (C + 1) + ": Unexpected " + (w == j ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(X, {
        ...
        switch (N[0]) {
          case 1:
            ...
            break;
          case 2:
            if ($ = this.productions_[N[1]][1], F.$ = g[g.length - $], F._$ = {
              ...
              return Q;
            $ && (h = h.slice(0, -1 * $ * 2), g = g.slice(0, -1 * $), c = c.slice(0, -1 * $)), h.push(this.productions_[N[1]][0]), g.push(F.$), c.push(F._$), nt = M[h[h.length - 2]][h[h.length - 1]], h.push(nt);
            break;
          case 3:
            return !0;
        }
...
const zt = function(n, t, e) {
  ...
  function n(i, o, l, y, f, d, m, S) {
    const _ = o.append("text").attr("x", l + f / 2).attr("y", y + d / 2 + 5).style("font-color", S).style("text-anchor", "middle").text(i);
    s(_, m);
  }
  function t(i, o, l, y, f, d, m, S, _) {
  ...
  function e(i, o, l, y, f, d, m, S) {
    ...
    v.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, _, l, y, f, d, m, S), s(v, m);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
function _t(n, t) {
  n.each(function() {
    var e = Z(this), s = e.text().split(/(\s+|<br>)/).reverse(), i, o = [], l = 1.1, y = e.attr("y"), f = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", f + "em");
...
`), T.debug("timeline", s.db);
  ...
  for (const [P, p] of m.entries()) {
    ...
    T.debug("taskHeight before draw", L), v = Math.max(v, L + 20), g = Math.max(g, p.events.length);
    let H = 0;
  ...
  T.debug("bounds", M), S && d.append("text").text(S).attr("x", M.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v + 150 : v + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", I).attr("x2", M.width + 3 * o).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), St(
    void 0,
    d,
    ((G = i.timeline) == null ? void 0 : G.padding) ?? 50,
    ((j = i.timeline) == null ? void 0 : j.useMaxWidth) ?? !1
  );
}, at = function(n, t, e, s, i, o, l, y, f, d, m) {
  var S;
  for (const _ of t) {
    const b = {
      descr: _.task,
