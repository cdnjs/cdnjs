import { d as yp, c as nn, l as qr, j as ei, t as mp, aA as bp, aB as Ep, aC as wp } from "./mermaid-9357f3d0.js";
import { c as xp } from "./createText-8ca1146d.js";
import { c as Ca, g as Tp } from "./_commonjsHelpers-10dfc225.js";
var Ki = function() {
...
` + he, ve.parser);
  ...
  jp(U, K), ty(K), mp(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
}, ay = {
  draw: ry
}, ny = (he) => {
  let fe = "";
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++)
    he["lineColor" + ee] = he["lineColor" + ee] || he["cScaleInv" + ee], bp(he["lineColor" + ee]) ? he["lineColor" + ee] = Ep(he["lineColor" + ee], 20) : he["lineColor" + ee] = wp(he["lineColor" + ee], 20);
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++) {
    const ve = "" + (17 - 3 * ee);
    fe += `
