import { b as G, i as y, m as D, G as j, l as A } from "./layout-dcf3f9fb.js";
import { c as O, i as E, a as M, b as _, d as $, u as V, s as H, e as U, f as W, p as B, g as Y, h as q } from "./edges-b46c88ba.js";
import { l as i, k as X, g as C, f as J } from "./config-e567ef17.js";
var z = 4;
function K(e) {
  return G(e, z);
}
...
const I = () => {
  x = {}, L = {}, d = {};
}, N = (e, t) => (i.trace("In isDecendant", t, " ", e, " = ", x[t].includes(e)), !!x[t].includes(e)), tt = (e, t) => (i.info("Decendants of ", t, " is ", x[t]), i.info("Edge is ", e), e.v === t || e.w === t ? !1 : x[t] ? x[t].includes(e.v) || N(e.v, t) || N(e.w, t) || x[t].includes(e.w) : (i.debug("Tilt, ", t, ",not in decendants"), !1)), R = (e, t, n, r) => {
  i.warn(
    "Copying children of ",
    e,
    "root",
  ...
  e.nodes().forEach(function(n) {
    e.children(n).length > 0 && (i.warn(
      ...
      b(n, e)
    ), x[n] = T(n, e), d[n] = { id: b(n, e), clusterData: e.node(n) });
  }), e.nodes().forEach(function(n) {
  ...
  for (const s of n)
    ...
    e.children(s) && e.children(s).length > 0) {
      ...
      i.warn("Old graph before copy", v(e)), R(s, e, l, s), e.setNode(s, {
        clusterNode: !0,
        id: s,
...
const ot = (e, t) => {
  ...
  t.nodes().forEach(function(a) {
    ...
    if (r !== void 0) {
      ...
      i.info("Setting data for cluster XXX (", a, ") ", w, r), t.setNode(r.id, w), t.parent(a) || (i.trace("Setting parent", a, r.id), t.setParent(a, r.id, w));
    }
    if (i.info("(Insert) Node XXX" + a + ": " + JSON.stringify(t.node(a))), o && o.clusterNode) {
      i.info("Cluster identified", a, o.width, t.node(a));
      const w = k(h, o.graph, n, t.node(a)), S = w.elem;
      V(o, S), o.diff = w.diff || 0, i.info("Node bounds (abc123)", a, o, o.width, o.x, o.y), H(S, o), i.warn("Recursive render complete ", S, o);
    } else
  ...
  return nt(t).forEach(function(a) {
    ...
    const w = Y(l, a, o, d, n, t);
    q(o, w);
  }), t.nodes().forEach(function(a) {
    const o = t.node(a);
    i.info(a, o.type, o.diff), o.type === "group" && (g = o.diff);
  }), { elem: c, diff: g };
}, ht = (e, t, n, r, s) => {
  M(e, n, r, s), _(), $(), lt(), I(), i.warn("Graph at first:", v(t)), et(t), i.warn("Graph after:", v(t)), k(e, t, r);
};
export {
  ht as r
};
//# sourceMappingURL=index-76f977dc.js.map
