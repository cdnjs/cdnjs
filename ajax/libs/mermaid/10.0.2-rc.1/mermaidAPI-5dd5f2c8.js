...
const Se = "10.0.2-rc.1", We = "c4", ar = (e) => e.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null, nr = async () => {
  const { diagram: e } = await import("./c4Diagram-37207b52.js");
  ...
  const { diagram: e } = await import("./flowDiagram-f9c15892.js");
  ...
  const { diagram: e } = await import("./flowDiagram-v2-5d60540a.js");
  ...
  const { diagram: e } = await import("./erDiagram-79c81e86.js");
  ...
  const { diagram: e } = await import("./gitGraphDiagram-cd759d51.js");
  ...
  const { diagram: e } = await import("./ganttDiagram-5917eee9.js");
  ...
  const { diagram: e } = await import("./pieDiagram-6648bfee.js");
  ...
  const { diagram: e } = await import("./requirementDiagram-6bf6f55d.js");
  ...
  const { diagram: e } = await import("./sequenceDiagram-51100f96.js");
  ...
  const { diagram: e } = await import("./classDiagram-48cfce68.js");
  ...
  const { diagram: e } = await import("./classDiagram-v2-9e3ea30d.js");
  ...
  const { diagram: e } = await import("./stateDiagram-dd702cbc.js");
  ...
  const { diagram: e } = await import("./stateDiagram-v2-e4c4d8b9.js");
  ...
  const { diagram: e } = await import("./journeyDiagram-06f901ce.js");
  ...
  const { diagram: e } = await import("./flowchart-elk-definition-c88569ce.js");
...
//# sourceMappingURL=mermaidAPI-5dd5f2c8.js.map
