...
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-ec0c0f9a.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-3b40750e.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-911c1c78.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-51132ce0.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-d1bc7519.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-a17f4af0.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-463144a9.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-41e27188.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-d4f03a5a.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-c8f2636e.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-9e9bbab3.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-aabf090e.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-ab14822f.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-bffbd969.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-e4112086.js");
...
//# sourceMappingURL=mermaidAPI-08671f15.js.map
