...
const version = "10.0.2-rc.1";
const id$i = "c4";
const detector$i = (txt) => {
  return txt.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
};
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-7507cab0.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-291f380f.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-e855006b.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-4a6876cc.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-85cf2bda.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-7dc825de.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-65863ef2.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-9687df8f.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-f40a5415.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-6291568d.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-8a1ce16f.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-44c58456.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-58684769.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-22fe3e90.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-e1db1699.js");
...
//# sourceMappingURL=mermaidAPI-a66ccec5.js.map
