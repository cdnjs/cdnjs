import { c as Y, g as Ut, s as zt, a as Mt, b as Ht, B as Xt, D as Kt, l as D, f as ot, E as Wt, a7 as Jt } from "./mermaid-f7929a23.js";
var gt = function() {
  var t = function(C, r, n, i) {
    ...
    performAction: function(r, n, i, o, p, e, B) {
      var l = e.length - 1;
      switch (p) {
        case 3:
        ...
        case 12:
          const $ = e[l - 1];
          $.description = o.trimColon(e[l]), this.$ = $;
          break;
        case 13:
    ...
    parse: function(r) {
      var n = this, i = [0], o = [], p = [null], e = [], B = this.table, l = "", A = 0, O = 0, st = 2, $ = 1, ft = e.slice.call(arguments, 1), S = Object.create(this.lexer), L = { yy: {} };
      ...
      function jt() {
        var x;
        return x = o.pop() || S.lex() || $, typeof x != "number" && (x instanceof Array && (o = x, x = o.pop()), x = n.symbols_[x] || x), x;
      }
      for (var _, v, m, pt, N = {}, it, b, Ct, rt; ; ) {
        if (v = i[i.length - 1], this.defaultActions[v] ? m = this.defaultActions[v] : ((_ === null || typeof _ > "u") && (_ = jt()), m = B[v] && B[v][_]), typeof m > "u" || !m.length || !m[0]) {
          var St = "";
          rt = [];
          for (it in B[v])
...
` + S.showPosition() + `
Expecting ` + rt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : St = "Parse error on line " + (A + 1) + ": Unexpected " + (_ == $ ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(St, {
            text: S.match,
        ...
        switch (m[0]) {
          ...
          case 2:
            if (b = this.productions_[m[1]][1], N.$ = p[p.length - b], N._$ = {
              ...
              return pt;
            b && (i = i.slice(0, -1 * b * 2), p = p.slice(0, -1 * b), e = e.slice(0, -1 * b)), i.push(this.productions_[m[1]][0]), p.push(N.$), e.push(N._$), Ct = B[i[i.length - 2]][i[i.length - 1]], i.push(Ct);
            break;
          case 3:
            return !0;
        }
