import { aQ as ye, s as me, g as Ve, a as Le, b as ve, B as Ie, D as Re, c as pt, l as Z1, z as dt, E as Ne, f as Oe, j as N1 } from "./mermaid-c2fb2af7.js";
var ht = function() {
  var e = function(h1, a, l, f) {
    for (l = l || {}, f = h1.length; f--; l[h1[f]] = a)
      ;
    return l;
  }, u = [1, 4], n = [1, 3], r = [1, 5], c = [1, 8, 9, 10, 11, 27, 34, 36, 38, 42, 58, 81, 82, 83, 84, 85, 86, 99, 102, 103, 106, 108, 111, 112, 113, 118, 119, 120, 121], o = [2, 2], h = [1, 13], U = [1, 14], F = [1, 15], O = [1, 16], z = [1, 23], c1 = [1, 25], p1 = [1, 26], d1 = [1, 27], S = [1, 49], k = [1, 48], l1 = [1, 29], w1 = [1, 30], U1 = [1, 31], G1 = [1, 32], M1 = [1, 33], B = [1, 44], x = [1, 46], y = [1, 42], m = [1, 47], V = [1, 43], L = [1, 50], v = [1, 45], I = [1, 51], R = [1, 52], K1 = [1, 34], j1 = [1, 35], Y1 = [1, 36], X1 = [1, 37], v1 = [1, 57], b = [1, 8, 9, 10, 11, 27, 32, 34, 36, 38, 42, 58, 81, 82, 83, 84, 85, 86, 99, 102, 103, 106, 108, 111, 112, 113, 118, 119, 120, 121], Q = [1, 61], W = [1, 60], q = [1, 62], z1 = [8, 9, 11, 73, 75], k1 = [1, 88], b1 = [1, 93], g1 = [1, 92], D1 = [1, 89], F1 = [1, 85], T1 = [1, 91], C1 = [1, 87], S1 = [1, 94], _1 = [1, 90], B1 = [1, 95], x1 = [1, 86], H1 = [8, 9, 10, 11, 73, 75], N = [8, 9, 10, 11, 44, 73, 75], M = [8, 9, 10, 11, 29, 42, 44, 46, 48, 50, 52, 54, 56, 58, 61, 63, 65, 66, 68, 73, 75, 86, 99, 102, 103, 106, 108, 111, 112, 113], Et = [8, 9, 11, 42, 58, 73, 75, 86, 99, 102, 103, 106, 108, 111, 112, 113], I1 = [42, 58, 86, 99, 102, 103, 106, 108, 111, 112, 113], kt = [1, 121], bt = [1, 120], gt = [1, 128], Dt = [1, 142], Ft = [1, 143], Tt = [1, 144], Ct = [1, 145], St = [1, 130], _t = [1, 132], Bt = [1, 136], xt = [1, 137], yt = [1, 138], mt = [1, 139], Vt = [1, 140], Lt = [1, 141], vt = [1, 146], It = [1, 147], Rt = [1, 126], Nt = [1, 127], Ot = [1, 134], Pt = [1, 129], wt = [1, 133], Ut = [1, 131], nt = [8, 9, 10, 11, 27, 32, 34, 36, 38, 42, 58, 81, 82, 83, 84, 85, 86, 99, 102, 103, 106, 108, 111, 112, 113, 118, 119, 120, 121], Gt = [1, 149], T = [8, 9, 11], K = [8, 9, 10, 11, 14, 42, 58, 86, 102, 103, 106, 108, 111, 112, 113], p = [1, 169], P = [1, 165], w = [1, 166], d = [1, 170], A = [1, 167], E = [1, 168], y1 = [75, 113, 116], g = [8, 9, 10, 11, 12, 14, 27, 29, 32, 42, 58, 73, 81, 82, 83, 84, 85, 86, 87, 102, 106, 108, 111, 112, 113], Mt = [10, 103], o1 = [31, 47, 49, 51, 53, 55, 60, 62, 64, 65, 67, 69, 113, 114, 115], Z = [1, 235], J = [1, 233], $ = [1, 237], t1 = [1, 231], e1 = [1, 232], s1 = [1, 234], u1 = [1, 236], n1 = [1, 238], m1 = [1, 255], Kt = [8, 9, 11, 103], H = [8, 9, 10, 11, 58, 81, 102, 103, 106, 107, 108, 109], it = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(a, l, f, i, C, t, R1) {
      var s = t.length - 1;
      switch (C) {
        case 2:
          this.$ = [];
        ...
        case 71:
          ...
          break;
        case 72:
          var j = i.destructLink(t[s], t[s - 2]);
    ...
    parse: function(a) {
      var l = this, f = [0], i = [], C = [null], t = [], R1 = this.table, s = "", j = 0, jt = 0, Se = 2, Yt = 1, _e = t.slice.call(arguments, 1), _ = Object.create(this.lexer), A1 = { yy: {} };
      for (var at in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, at) && (A1.yy[at] = this.yy[at]);
      ...
      function xe() {
        var r1;
        return r1 = i.pop() || _.lex() || Yt, typeof r1 != "number" && (r1 instanceof Array && (i = r1, r1 = i.pop()), r1 = l.symbols_[r1] || r1), r1;
      }
      for (var G, E1, Y, lt, V1 = {}, Q1, i1, Xt, W1; ; ) {
        if (E1 = f[f.length - 1], this.defaultActions[E1] ? Y = this.defaultActions[E1] : ((G === null || typeof G > "u") && (G = xe()), Y = R1[E1] && R1[E1][G]), typeof Y > "u" || !Y.length || !Y[0]) {
          var ot = "";
          W1 = [];
          for (Q1 in R1[E1])
            this.terminals_[Q1] && Q1 > Se && W1.push("'" + this.terminals_[Q1] + "'");
          _.showPosition ? ot = "Parse error on line " + (j + 1) + `:
` + _.showPosition() + `
Expecting ` + W1.join(", ") + ", got '" + (this.terminals_[G] || G) + "'" : ot = "Parse error on line " + (j + 1) + ": Unexpected " + (G == Yt ? "end of input" : "'" + (this.terminals_[G] || G) + "'"), this.parseError(ot, {
            text: _.match,
        ...
        switch (Y[0]) {
          case 1:
            f.push(G), C.push(_.yytext), t.push(_.yylloc), f.push(Y[1]), G = null, jt = _.yyleng, s = _.yytext, j = _.yylineno, ct = _.yylloc;
            break;
          case 2:
            if (i1 = this.productions_[Y[1]][1], V1.$ = C[C.length - i1], V1._$ = {
              first_line: t[t.length - (i1 || 1)].first_line,
              last_line: t[t.length - 1].last_line,
              first_column: t[t.length - (i1 || 1)].first_column,
              last_column: t[t.length - 1].last_column
            }, Be && (V1._$.range = [
              t[t.length - (i1 || 1)].range[0],
              t[t.length - 1].range[1]
            ]), lt = this.performAction.apply(V1, [
              s,
              jt,
              j,
              A1.yy,
              ...
              C,
              t
            ].concat(_e)), typeof lt < "u")
              return lt;
            i1 && (f = f.slice(0, -1 * i1 * 2), C = C.slice(0, -1 * i1), t = t.slice(0, -1 * i1)), f.push(this.productions_[Y[1]][0]), C.push(V1.$), t.push(V1._$), Xt = R1[f[f.length - 2]][f[f.length - 1]], f.push(Xt);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
  ...
  return rt.prototype = it, it.Parser = rt, new rt();
}();
ht.parser = ht;
const ze = ht, Pe = "flowchart-";
let zt = 0, At = pt(), D = {}, f1 = [], L1 = {}, a1 = [], J1 = {}, $1 = {}, q1 = 0, ft = !0, X, tt, et = [];
const st = (e) => Oe.sanitizeText(e, At), P1 = function(e) {
  ...
  F !== void 0 && F.trim().length !== 0 && (D[F] === void 0 && (D[F] = {
    ...
    styles: [],
    classes: []
  }), zt++, u !== void 0 ? (At = pt(), U = st(u.text.trim()), D[F].labelType = u.type, U[0] === '"' && U[U.length - 1] === '"' && (U = U.substring(1, U.length - 1)), D[F].text = U) : D[F].text === void 0 && (D[F].text = e), n !== void 0 && (D[F].type = n), r != null && r.forEach(function(O) {
    D[F].styles.push(O);
  ...
  Z1.info("abc78 Got edge...", o);
  const h = n.text;
  if (h !== void 0 && (o.text = st(h.text.trim()), o.text[0] === '"' && o.text[o.text.length - 1] === '"' && (o.text = o.text.substring(1, o.text.length - 1)), o.labelType = h.type), n !== void 0 && (o.type = n.type, o.stroke = n.stroke, o.length = n.length), (o == null ? void 0 : o.length) > 10 && (o.length = 10), f1.length < 280)
    Z1.info("abc78 pushing edge..."), f1.push(o);
  else
    throw new Error("Too many edges");
}, Wt = function(e, u, n) {
  Z1.info("addLink (abc78)", e, u, n);
  let r, c;
  ...
  e.forEach(function(n) {
    n === "default" ? f1.defaultInterpolate = u : f1[n].interpolate = u;
  });
}, Zt = function(e, u) {
  e.forEach(function(n) {
    n === "default" ? f1.defaultStyle = u : (dt.isSubstringInArray("fill", u) === -1 && u.push("fill:none"), f1[n].style = u);
  });
}, Jt = function(e, u) {
  ...
  e.split(",").forEach(function(n) {
    u !== void 0 && ($1[tt === "gen-1" ? P1(n) : n] = st(u));
  });
}, Ue = function(e, u, n) {
  let r = P1(e);
  if (pt().securityLevel !== "loose" || u === void 0)
    return;
  let c = [];
  if (typeof n == "string") {
    c = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
  ...
  e.split(",").forEach(function(r) {
    D[r] !== void 0 && (D[r].link = dt.formatUrl(u, At), D[r].linkTarget = n);
  }), ut(e, "clickable");
}, ee = function(e) {
...
const le = function(e = "gen-1") {
  D = {}, L1 = {}, f1 = [], et = [ce], a1 = [], J1 = {}, q1 = 0, $1 = {}, ft = !0, tt = e, Ne();
}, oe = (e) => {
  tt = e || "gen-2";
}, he = function() {
  ...
  function o(z) {
    const c1 = { boolean: {}, number: {}, string: {} }, p1 = [];
    let d1;
    return { nodeList: z.filter(function(k) {
      const l1 = typeof k;
      return k.stmt && k.stmt === "dir" ? (d1 = k.value, !1) : k.trim() === "" ? !1 : l1 in c1 ? c1[l1].hasOwnProperty(k) ? !1 : c1[l1][k] = !0 : p1.includes(k) ? !1 : p1.push(k);
    }), dir: d1 };
  }
  let h = [];
  ...
  if (h = U, tt === "gen-1")
    for (let z = 0; z < h.length; z++)
      h[z] = P1(h[z]);
  r = r || "subGraph" + q1, c = c || "", c = st(c), q1 = q1 + 1;
  const O = {
    id: r,
    nodes: h,
    title: c.trim(),
  ...
  return Z1.info("Adding", O.id, O.nodes, O.dir), O.nodes = Fe(O, a1).nodes, a1.push(O), J1[r] = O, r;
}, Ge = function(e) {
  for (const [u, n] of a1.entries())
    if (n.id === e)
      return u;
  return -1;
};
let O1 = -1;
const pe = [], de = function(e, u) {
  const n = a1[u].nodes;
  if (O1 = O1 + 1, O1 > 2e3)
    return;
  if (pe[O1] = u, a1[u].id === e)
    return {
      result: !0,
      count: 0
    };
  ...
  O1 = -1, a1.length > 0 && de("none", a1.length - 1);
}, ke = function() {
  return a1;
}, be = () => ft ? (ft = !1, !0) : !1, Me = (e) => {
