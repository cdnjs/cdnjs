import { d as Xe, c as F, G as ye, s as We, g as qe, a as He, b as Je, B as Ze, D as $e, f as v, E as et, l as tt, z as Pe, j as U } from "./mermaid-c2fb2af7.js";
var De = function() {
  var e = function(L, u, a, o) {
    ...
    performAction: function(u, a, o, i, p, t, M) {
      var s = t.length - 1;
      switch (p) {
        case 8:
          this.$ = t[s - 1];
    ...
    parse: function(u) {
      var a = this, o = [0], i = [], p = [null], t = [], M = this.table, s = "", Z = 0, Le = 0, Ye = 2, xe = 1, Ke = t.slice.call(arguments, 1), b = Object.create(this.lexer), I = { yy: {} };
      ...
      for (var T, O, y, Te, w = {}, $, S, Ie, ee; ; ) {
        if (O = o[o.length - 1], this.defaultActions[O] ? y = this.defaultActions[O] : ((T === null || typeof T > "u") && (T = Qe()), y = M[O] && M[O][T]), typeof y > "u" || !y.length || !y[0]) {
          var Fe = "";
          ee = [];
          for ($ in M[O])
        ...
        switch (y[0]) {
          ...
          case 2:
            if (S = this.productions_[y[1]][1], w.$ = p[p.length - S], w._$ = {
              ...
              return Te;
            S && (o = o.slice(0, -1 * S * 2), p = p.slice(0, -1 * S), t = t.slice(0, -1 * S)), o.push(this.productions_[y[1]][0]), p.push(w.$), t.push(w._$), Ie = M[o[o.length - 2]][o[o.length - 1]], o.push(Ie);
            break;
          case 3:
            return !0;
        }
...
const R = (e) => v.sanitizeText(e, F()), P = function(e) {
  ...
  tt.debug("Adding relation: " + JSON.stringify(e)), se(e.id1), se(e.id2), e.id1 = P(e.id1).className, e.id2 = P(e.id2).className, e.relationTitle1 = v.sanitizeText(e.relationTitle1.trim(), F()), e.relationTitle2 = v.sanitizeText(e.relationTitle2.trim(), F()), _e.push(e);
}, ct = function(e, n) {
  ...
  Array.isArray(n) && (n.reverse(), n.forEach((r) => Ge(e, r)));
}, ht = function(e, n) {
  const r = {
    id: `note${te.length}`,
    class: n,
