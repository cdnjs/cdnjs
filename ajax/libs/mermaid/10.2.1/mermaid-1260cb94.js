...
const Ko = "10.2.1", Ja = "c4", X0 = (t) => t.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null, K0 = async () => {
  const { diagram: t } = await import("./c4Diagram-254213a1.js");
  ...
  const { diagram: t } = await import("./flowDiagram-c77506ee.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-3d18812b.js");
  ...
  const { diagram: t } = await import("./erDiagram-e8df9b8a.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-bd3cf386.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-e6339652.js");
  ...
  const { diagram: t } = await import("./infoDiagram-673229a6.js");
  ...
  const { diagram: t } = await import("./pieDiagram-1492e6de.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-47d99734.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-ca360737.js");
  ...
  const { diagram: t } = await import("./sequenceDiagram-914a5886.js");
  ...
  const { diagram: t } = await import("./classDiagram-42b3c27c.js");
  ...
  const { diagram: t } = await import("./classDiagram-v2-74b55d00.js");
  ...
  const { diagram: t } = await import("./stateDiagram-83676724.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-967b4cd7.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-2a24f107.js");
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-aba443f1.js");
  ...
  const { diagram: t } = await import("./timeline-definition-4a21fd34.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-978d0aa1.js");
...
:root { --mermaid-alt-font-family: ${t.altFontFamily}}`), !Di(i) && kl.includes(e)) {
  ...
  let r = t;
  return !i && !e && (r = r.replace(/marker-end="url\(.*?#/g, 'marker-end="url(#')), r = rx(r), r = r.replace(/<br>/g, "<br/>"), r;
}, ax = (t = "", e) => {
