...
const loader$k = async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-c0b17d02.js");
...
const loader$j = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-d6f8fe3a.js");
...
const loader$i = async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-v2-58f49b84.js");
...
const loader$h = async () => {
  const { diagram: diagram2 } = await import("./erDiagram-dedf2781.js");
...
const loader$g = async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-e0ffc2d1.js");
...
const loader$f = async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-088dbd90.js");
...
const loader$e = async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-64895a6e.js");
...
const loader$d = async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-3fca7ce7.js");
...
const loader$c = async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-0ca4be02.js");
...
const loader$b = async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-e13af0f0.js");
...
const loader$a = async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-84aa38e3.js");
...
const loader$9 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-a8cc8886.js");
...
const loader$8 = async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-802a48d3.js");
...
const loader$7 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-9a586ac6.js");
...
const loader$6 = async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-96f2b9df.js");
...
const loader$5 = async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-adaa34f8.js");
...
const loader$4 = async () => {
  const { diagram: diagram2 } = await import("./flowchart-elk-definition-56584a6c.js");
...
const loader$3 = async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-1a90b03d.js");
...
const loader$2 = async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-57868176.js");
...
const loader$1 = async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-a7f8e230.js");
...
function extractFrontMatter(text, db, setDiagramConfig) {
  var _a, _b;
...
class Diagram {
  constructor(text) {
    ...
    this.parser.parse = (text2) => originalParse(cleanupComments(extractFrontMatter(text2, this.db, addDirective)));
...
export {
  ...
  selectSvgElement as B,
  defaultConfig$1 as C,
  parseDirective$1 as D,
  cleanAndMerge as E,
  parseFontSize as F,
  getThemeVariables$2 as G,
  addFunction as H,
  generateId as I,
  lineBreakRegex as J,
  defaultConfig as K,
