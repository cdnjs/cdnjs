import { b as sanitizeText$1, g as getConfig, l as log, f as select, J as lighten, K as darken } from "./config-6850764f.js";
import { s as setupGraphViewbox } from "./setupGraphViewbox-7dc9988d.js";
import { i as isDark } from "./is_dark-883495fe.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-67a96faf.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-50b79e80.js").then((n) => n.c)).default;
...
//# sourceMappingURL=mindmap-definition-cfb90453.js.map
