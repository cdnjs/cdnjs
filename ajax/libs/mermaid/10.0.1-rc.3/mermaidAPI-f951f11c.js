...
const version = "10.0.1-rc.3";
const id$i = "c4";
const detector$i = (txt) => {
  return txt.match(/^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/) !== null;
};
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-2e5464f0.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-11e238f2.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-5feae17d.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-a4fa2d5b.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-2c8cb435.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-e36a207c.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-ab071a74.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-7adfa1e0.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-abc3d763.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-b3c9a682.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-b0aee2e3.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-f5b65825.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-2c2903c6.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-227d9e27.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-87f7ee8d.js");
...
const loader = async () => {
  const { diagram } = await import("./mindmap-definition-d19b2799.js");
  return { id, diagram };
};
const plugin = {
  id,
...
//# sourceMappingURL=mermaidAPI-f951f11c.js.map
