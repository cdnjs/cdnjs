import { b as addHtmlLabel, g as db, p as parser } from "./add-html-label-157170b7.js";
import { l as log, f as select, g as getConfig, k as evaluate, e as common } from "./config-6850764f.js";
import { a as insertMarkers, e as insertNode, f as insertEdgeLabel } from "./edges-e151653b.js";
import { s as setupGraphViewbox } from "./setupGraphViewbox-7dc9988d.js";
import { y as getStylesFromArray, z as interpolateToCurve, x as curveLinear } from "./utils-bd4440bf.js";
...
const draw = async function(text, id, _version, diagObj) {
  var _a;
  if (!elk) {
    const ELK = (await import("./elk.bundled-d20db0d0.js").then((n) => n.e)).default;
    elk = new ELK();
  }
  diagObj.db.clear();
  nodeDb = {};
...
//# sourceMappingURL=flowchart-elk-definition-8026be65.js.map
