import { b as V, g as O, p as q } from "./add-html-label-d40b2200.js";
import { l as p, f as I, g as G, k as J, e as U } from "./config-d3eb77a7.js";
import { a as K, e as Q, f as Z } from "./edges-dd67c27b.js";
import { s as X } from "./setupGraphViewbox-b1cfe372.js";
import { y as H, z as R, x as D } from "./utils-9337f219.js";
import { l as Y } from "./isPlainObject-adb25d66.js";
...
`), c.style === void 0 && (o.style = o.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), o.labelStyle = o.labelStyle.replace("color:", "fill:"), o.id = i, o.classes = "flowchart-link " + k + " " + S;
  ...
  var C;
  if (!P) {
    const w = (await import("./elk.bundled-ff98ceca.js").then((b) => b.e)).default;
    P = new w();
  }
...
//# sourceMappingURL=flowchart-elk-definition-1705a81b.js.map
