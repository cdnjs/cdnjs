import { b as ft, g as B, l as C, f as P, J as yt, K as mt } from "./config-d3eb77a7.js";
import { s as bt } from "./setupGraphViewbox-b1cfe372.js";
import { i as Et } from "./is_dark-9ca97e2b.js";
var Z = function() {
...
async function zt(e, t) {
  if (!H) {
    H = (await import("./cytoscape.cjs-9166cf9c.js").then((s) => s.c)).default;
    const n = (await import("./cytoscape-cose-bilkent-af24d214.js").then((s) => s.c)).default;
    H.use(n);
  }
...
` + e);
  ...
  Ht(b, y), Gt(y), bt(void 0, g, i.mindmap.padding, i.mindmap.useMaxWidth);
}, Yt = {
  draw: Xt
}, qt = (e) => {
  let t = "";
...
//# sourceMappingURL=mindmap-definition-e571dff1.js.map
