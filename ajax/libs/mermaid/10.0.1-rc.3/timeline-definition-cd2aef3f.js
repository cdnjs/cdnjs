import { p as bt } from "./utils-9337f219.js";
import { c as kt, f as vt } from "./commonDb-cf9156a6.js";
import { f as Z, g as wt, l as T, J as St, K as Et } from "./config-d3eb77a7.js";
import { d as it } from "./arc-80524574.js";
import { s as Tt } from "./setupGraphViewbox-b1cfe372.js";
import { i as It } from "./is_dark-9ca97e2b.js";
...
const Nt = Y;
let W = "", ct = 0;
const D = [], J = [], B = [], ot = () => kt, lt = (n, t, e) => {
  bt(globalThis, n, t, e);
}, ht = function() {
  D.length = 0, J.length = 0, W = "", B.length = 0, vt();
}, dt = function(n) {
  W = n, D.push(n);
}, ut = function() {
  return D;
...
const Vt = function(n, t, e) {
  ...
  const o = tt();
  o.x = t.x, o.y = t.y, o.fill = t.fill, o.width = e.width, o.height = e.height, o.class = "task task-type-" + t.num, o.rx = 3, o.ry = 3, K(i, o), t.x + 14, xt(e)(
    t.task,
    i,
    o.x,
    o.y,
...
`), T.debug("timeline", s.db);
  ...
  T.debug("bounds", M), S && d.append("text").text(S).attr("x", M.width / 2 - l).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v + 150 : v + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", l).attr("y1", I).attr("x2", M.width + 3 * l).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Tt(
    void 0,
    d,
...
//# sourceMappingURL=timeline-definition-cd2aef3f.js.map
