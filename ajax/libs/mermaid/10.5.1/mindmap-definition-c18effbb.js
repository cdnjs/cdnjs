import { d as mp, c as nn, l as qr, Q as Ca, T as Vu, j as ei, r as bp, aT as Ep, aU as wp, aV as xp } from "./mermaid-5f2d2ec5.js";
import { c as Tp } from "./createText-56dbee71.js";
var Ki = function() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var ln = _l, ri = D ? D.performance : null, ss = ri && ri.now ? function() {
      ...
      vs() && (ql ? console.warn(e) : (console.log(e), Wl && console.trace()));
    }, Kl = function(e) {
      return Ue({}, e);
    }, or = function(e) {
      return e == null ? e : te(e) ? e.slice() : L(e) ? Kl(e) : e;
    }, Zl = function(e) {
      return e.slice();
    }, ds = function(e, r) {
      for (
    ...
    }(), ur = typeof Map < "u" ? Map : jl, ef = "undefined", tf = /* @__PURE__ */ function() {
      function t(e) {
    ...
    }(), Jr = (typeof Set > "u" ? "undefined" : ee(Set)) !== ef ? Set : tf, vn = function(e, r) {
      ...
      return e = {
        ...
        var s;
        L(a) && !ge(a) && (s = a, a = s.roots || s.root, n = s.visit, i = s.directed), i = arguments.length === 2 && !Y(n) ? n : i, n = Y(n) ? n : function() {
        };
        ...
        for (var A = function() {
          ...
          var re = c[z], W = h[z], Z = W != null ? W.source() : null, ie = W != null ? W.target() : null, oe = W == null ? void 0 : X.same(Z) ? ie[0] : Z[0], de = void 0;
          if (de = n(X, W, oe, d++, re), de === !0)
            return g = X, "break";
          if (de === !1)
            return "break";
          for (var se = X.connectedEdges().filter(function(ye) {
            ...
            var we = se[ve], Te = we.connectedNodes().filter(function(ye) {
    ...
    var rf = sl(function(t, e) {
      ...
      dijkstra: function(e) {
        ...
        var a = af(e), n = a.root, i = a.weight, s = a.directed, o = this, l = i, u = j(n) ? this.filter(n)[0] : n[0], f = {}, h = {}, c = {}, v = this.byGroup(), d = v.nodes, g = v.edges;
        ...
        for (var M = function(W, Z) {
          for (var ie = (s ? W.edgesTo(Z) : W.edgesWith(Z)).intersect(g), oe = 1 / 0, de, se = 0; se < ie.length; se++) {
            var ve = ie[se], we = l(ve);
            (we < oe || !de) && (oe = we, de = ve);
          }
          return {
            edge: de,
            dist: oe
        ...
        return {
          ...
          pathTo: function(W) {
            var Z = j(W) ? d.filter(W)[0] : W[0], ie = [], oe = Z, de = oe.id();
            if (Z.length > 0)
              for (ie.unshift(Z); h[de]; ) {
                var se = h[de];
                ie.unshift(se.edge), ie.unshift(se.node), oe = se.node, de = oe.id();
              }
            return o.spawn(ie);
          }
        };
      ...
      // Implemented from pseudocode from wikipedia
      aStar: function(e) {
        var r = this.cy(), a = of(e), n = a.root, i = a.goal, s = a.heuristic, o = a.directed, l = a.weight;
        n = r.collection(n)[0], i = r.collection(i)[0];
        var u = n.id(), f = i.id(), h = {}, c = {}, v = {}, d = new Ra(function(de, se) {
          return c[de.id()] - c[se.id()];
        }), g = new Jr(), y = {}, p = {}, m = function(se, ve) {
          d.push(se), g.add(ve);
        }, b, E, M = function() {
      ...
      floydWarshall: function(e) {
        for (var r = this.cy(), a = lf(e), n = a.weight, i = a.directed, s = n, o = this.byGroup(), l = o.nodes, u = o.edges, f = l.length, h = f * f, c = function(we) {
          return l.indexOf(we);
        }, v = function(we) {
          return l[we];
        ...
        var oe = function(we) {
          ...
          distance: function(we, Te) {
            var Ee = de(we), ye = de(Te);
            return d[Ee * f + ye];
          },
          path: function(we, Te) {
            var Ee = de(we), ye = de(Te), ae = v(Ee);
            if (Ee === ye)
      ...
      bellmanFord: function(e) {
        var r = this, a = hf(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), f = this.byGroup(), h = f.edges, c = f.nodes, v = c.length, d = new ur(), g = !1, y = [];
        ...
        if (C)
          for (var oe = [], de = 0; de < p; de++) {
            var se = h[de], ve = se.source(), we = se.target(), Te = o(se), Ee = m(ve).dist, ye = m(we).dist;
            if (Ee + Te < ye || !i && ye + Te < Ee)
              if (g || (ft("Graph contains a negative weight cycle for Bellman-Ford"), g = !0), e.findNegativeWeightCycles !== !1) {
                var ae = [];
                Ee + Te < ye && ae.push(ve), !i && ye + Te < Ee && ae.push(we);
      ...
      // bellmanFord
    }, vf = Math.sqrt(2), df = function(e, r, a) {
      ...
      kargerStein: function() {
        ...
        var i = a.length, s = n.length, o = Math.ceil(Math.pow(Math.log(i) / Math.LN2, 2)), l = Math.floor(i / vf);
        if (i < 2) {
        ...
        for (var c = 1 / 0, v = [], d = new Array(i), g = new Array(i), y = new Array(i), p = function(oe, de) {
          for (var se = 0; se < i; se++)
            de[se] = oe[se];
        }, m = 0; m <= o; m++) {
          for (var b = 0; b < i; b++)
            g[b] = b;
          var E = si(g, u.slice(), i, l), M = E.slice();
          p(g, y);
          var A = si(g, E, l, 2), w = si(y, M, l, 2);
        ...
        var re = function(oe) {
          ...
          return oe.forEach(function(se) {
            de.merge(se), se.connectedEdges().forEach(function(ve) {
              e.contains(ve) && !I.contains(ve) && de.merge(ve);
            });
          }), de;
        }, W = [re(C), re(B)], Z = {
          cut: I,
      ...
      {
        var oe = a - u + l, de = n + f - l;
        if (R = Pa(e, r, a, n, oe, de, l + o), R.length > 0 && R[0] <= oe && R[1] >= de)
          return [R[0], R[1]];
      }
      return [];
    }, Of = function(e, r, a, n, i, s, o) {
      var l = o, u = Math.min(a, i), f = Math.max(a, i), h = Math.min(n, s), c = Math.max(n, s);
      return u - l <= e && e <= f + l && h - l <= r && r <= c + l;
    }, Nf = function(e, r, a, n, i, s, o, l, u) {
      var f = {
        x1: Math.min(a, o, i) - u,
        x2: Math.max(a, o, i) + u,
        y1: Math.min(n, l, s) - u,
      ...
      if (u > 0) {
        ...
        g = f;
      return Yt(e, r, g);
    }, Pf = function(e, r, a, n, i, s, o) {
      for (var l = new Array(a.length), u = s / 2, f = o / 2, h = ci(s, o), c = h * h, v = 0; v < a.length / 4; v++) {
      ...
      if (m !== 0) {
        ...
        return y === 0 || p === 0 ? fi(e, a, o) === o ? [o, l] : fi(e, a, i) === i ? [i, s] : fi(i, o, a) === a ? [a, n] : [] : [];
      ...
      return u;
    }, Ff = function(e, r, a, n, i, s, o, l) {
      for (var u = [], f, h = new Array(a.length), c = s / 2, v = o / 2, d = ci(s, o), g = 0; g < a.length / 4; g++) {
      ...
      pageRank: function(e) {
        for (var r = Gf(e), a = r.dampingFactor, n = r.precision, i = r.iterations, s = r.weight, o = this._private.cy, l = this.byGroup(), u = l.nodes, f = l.edges, h = u.length, c = h * h, v = f.length, d = new Array(c), g = new Array(h), y = (1 - a) / h, p = 0; p < h; p++) {
          for (var m = 0; m < h; m++) {
            var b = p * h + m;
            d[b] = 0;
          }
        ...
        for (var ie = new Array(h), oe = new Array(h), de, se = 0; se < h; se++)
          ie[se] = 1;
    ...
    var Ls = Lt({
      ...
      closenessCentralityNormalized: function(e) {
        for (var r = Ls(e), a = r.harmonic, n = r.weight, i = r.directed, s = this.cy(), o = {}, l = 0, u = this.nodes(), f = this.floydWarshall({
          weight: n,
          directed: i
        }), h = 0; h < u.length; h++) {
      ...
      closenessCentrality: function(e) {
        var r = Ls(e), a = r.root, n = r.weight, i = r.directed, s = r.harmonic;
        a = this.filter(a)[0];
    ...
    var Vf = Lt({
      ...
      betweennessCentrality: function(e) {
        for (var r = Vf(e), a = r.directed, n = r.weight, i = n != null, s = this.cy(), o = this.nodes(), l = {}, u = {}, f = 0, h = {
          set: function(b, E) {
            u[b] = E, E > f && (f = E);
          },
          get: function(b) {
        ...
        for (var g = function(b) {
          ...
          for (var de = {}, se = 0; se < o.length; se++)
            de[o[se].id()] = 0;
          for (; M.length > 0; ) {
            for (var ve = M.pop(), we = 0; we < A[ve].length; we++) {
              var Te = A[ve][we];
              de[Te] = de[Te] + w[Te] / w[ve] * (1 + de[ve]);
            }
            ve != o[b].id() && h.set(ve, h.get(ve) + de[ve]);
          }
        }, y = 0; y < o.length; y++)
          g(y);
        var p = {
    ...
    var _f = Lt({
      ...
      for (var r = this.nodes(), a = this.edges(), n = this.cy(), i = Uf(e), s = {}, o = 0; o < r.length; o++)
        s[r[o].id()] = o;
      for (var l = r.length, u = l * l, f = new Array(u), h, c = 0; c < u; c++)
        f[c] = 0;
      for (var v = 0; v < a.length; v++) {
        var d = a[v], g = s[d.source().id()], y = s[d.target().id()], p = Yf(d, i.attributes);
        f[g * l + y] += p, f[y * l + g] += p;
      }
      Hf(f, l, i.multFactor), As(f, l);
      for (var m = !0, b = 0; m && b < i.maxIterations; )
        m = !1, h = qf(f, l, i.expandFactor), f = Wf(h, l, i.inflateFactor), Kf(f, h, u, 4) || (m = !0), b++;
      var E = Zf(f, l, r, n);
      return E = Jf(E), E;
    }, jf = {
      markovClustering: Os,
      ...
      return Math.max(e, Ns(r, a));
    }, za = function(e, r, a, n, i) {
      for (var s = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : eh, o = n, l, u, f = 0; f < e; f++)
        l = r(f), u = a(f), o = i(o, l, u);
      return s(o);
    }, na = {
      euclidean: function(e, r, a) {
        return e >= 2 ? za(e, r, a, 0, Is, th) : za(e, r, a, 0, Ms);
      },
      squaredEuclidean: function(e, r, a) {
        return za(e, r, a, 0, Is);
      },
      manhattan: function(e, r, a) {
        return za(e, r, a, 0, Ms);
      },
      max: function(e, r, a) {
        return za(e, r, a, -1 / 0, rh);
      }
    };
    ...
    var ah = Lt({
      ...
      var r = this.cy(), a = this.nodes(), n = null, i = gi(e), s = new Array(i.k), o = {}, l;
      i.testMode ? typeof i.testCentroids == "number" ? (i.testCentroids, l = pi(a, i.k, i.attributes)) : ee(i.testCentroids) === "object" ? l = i.testCentroids : l = pi(a, i.k, i.attributes) : l = pi(a, i.k, i.attributes);
      for (var u = !0, f = 0; u && f < i.maxIterations; ) {
        for (var h = 0; h < a.length; h++)
          n = a[h], o[n.id()] = Rs(n, l, i.distance, i.attributes, "kMeans");
        u = !1;
        for (var c = 0; c < i.k; c++) {
          var v = ks(c, a, o);
          if (v.length !== 0) {
            for (var d = i.attributes.length, g = l[c], y = new Array(d), p = new Array(d), m = 0; m < d; m++) {
              ...
              y[m] = p[m] / v.length, nh(y[m], g[m], i.sensitivityThreshold) || (u = !0);
            }
      ...
      var r = this.cy(), a = this.nodes(), n = null, i = gi(e), s = new Array(i.k), o, l = {}, u, f = new Array(i.k);
      i.testMode ? typeof i.testCentroids == "number" || (ee(i.testCentroids) === "object" ? o = i.testCentroids : o = Ps(a, i.k)) : o = Ps(a, i.k);
      for (var h = !0, c = 0; h && c < i.maxIterations; ) {
        for (var v = 0; v < a.length; v++)
          n = a[v], l[n.id()] = Rs(n, o, i.distance, i.attributes, "kMedoids");
        h = !1;
        for (var d = 0; d < o.length; d++) {
          var g = ks(d, a, l);
          if (g.length !== 0) {
            f[d] = Bs(o[d], g, i.attributes);
            for (var y = 0; y < g.length; y++)
              u = Bs(g[y], g, i.attributes), u < f[d] && (f[d] = u, o[d] = g[y], h = !0);
            s[d] = r.collection(g);
          }
        }
        c++;
      ...
      var r = this.cy(), a = this.nodes(), n = gi(e), i, s, o, l, u;
      ...
      for (var m = !0, b = 0; m && b < n.maxIterations; )
        m = !1, lh(s, a, o, u, n), fh(o, l, s, a, n), ih(o, l, n.sensitivityThreshold) || (m = !0), b++;
      return i = hh(a, o, n, r), {
        clusters: i,
      ...
      for (var r = this.cy(), a = this.nodes(), n = gh(e), i = n.attributes, s = function(b, E) {
      ...
      for (var y = zs(o, f, l, u, n); y; )
        y = zs(o, f, l, u, n);
      var p;
      return n.mode === "dendrogram" ? (p = yh(o[0], n.dendrogramDepth, r), n.addDendrogram && ph(o[0], r)) : (p = new Array(o.length), o.forEach(function(m, b) {
      ...
      return n.some(function(i) {
        ...
        return "'".concat(i, "'");
      }).join(", "), "] or a number.  Got: ").concat(a)), bh(e);
    }, wh = function(e, r, a, n) {
      var i = function(o, l) {
        return n[l](o);
      };
      ...
      var a = null;
      return r === "median" ? a = Ef(e) : r === "mean" ? a = bf(e) : r === "min" ? a = yf(e) : r === "max" ? a = mf(e) : a = r, a;
    }, Th = function(e, r, a) {
      for (var n = [], i = 0; i < e; i++)
      ...
      for (var n = $s(e, r, a), i = 0; i < a.length; i++) {
      ...
      for (var r = this.cy(), a = this.nodes(), n = Eh(e), i = {}, s = 0; s < a.length; s++)
        i[a[s].id()] = s;
      var o, l, u, f, h, c;
      ...
      for (var d = 0; d < o; d++)
        for (var g = 0; g < o; g++)
          d !== g && (u[d * o + g] = wh(n.distance, a[d], a[g], n.attributes));
      f = xh(u, n.preference);
      for (var y = 0; y < o; y++)
        u[y * o + y] = f;
      h = new Array(l);
      ...
      for (C = 0; C < n.maxIterations; C++) {
        ...
        for (var Z = 0; Z < o; Z++) {
          ...
          for (var de = 0; de < o; de++)
            c[de * o + Z] = (1 - n.damping) * Math.min(0, ie - E[de]) + n.damping * b[de];
          c[Z * o + Z] = (1 - n.damping) * (ie - E[Z]) + n.damping * b[Z];
        }
        for (var se = 0, ve = 0; ve < o; ve++) {
          var we = c[ve * o + ve] + h[ve * o + ve] > 0 ? 1 : 0;
          w[C % n.minIterations * o + ve] = we, se += we;
        }
      ...
      for (var ae = Th(o, h, c), xe = Ch(o, u, ae), Ce = {}, Oe = 0; Oe < ae.length; Oe++)
        Ce[ae[Oe]] = [];
      ...
      hierholzer: function(e) {
        ...
        var a = Sh(e), n = a.root, i = a.directed, s = this, o = !1, l, u, f;
    ...
    [Ia, nf, sf, uf, ff, cf, gf, $f, ra, aa, di, jf, ch, mh, Dh, Lh, Ah, Oh].forEach(function(t) {
      Ue(_s, t);
    });
    /*!
    ...
    */
    var Us = 0, Ys = 1, Hs = 2, pr = function t(e) {
      if (!(this instanceof t))
        return new t(e);
      this.id = "Thenable/1.0.7", this.state = Us, this.fulfillValue = void 0, this.rejectReason = void 0, this.onFulfilled = [], this.onRejected = [], this.proxy = {
    ...
    pr.prototype = {
      ...
      fulfill: function(e) {
        return Xs(this, Ys, "fulfillValue", e);
      },
      reject: function(e) {
        return Xs(this, Hs, "rejectReason", e);
      },
      /*  "The then Method" [Promises/A+ 1.1, 1.2, 2.2]  */
      then: function(e, r) {
        var a = this, n = new pr();
        return a.onFulfilled.push(Ks(e, n, "fulfill")), a.onRejected.push(Ks(r, n, "reject")), qs(a), n.proxy;
      }
    };
    var Xs = function(e, r, a, n) {
      return e.state === Us && (e.state = r, e[a] = n, qs(e)), e;
    }, qs = function(e) {
      e.state === Ys ? Ws(e, "onFulfilled", e.fulfillValue) : e.state === Hs && Ws(e, "onRejected", e.rejectReason);
    }, Ws = function(e, r, a) {
      if (e[r].length !== 0) {
        var n = e[r];
        e[r] = [];
    ...
    var ia = typeof Promise < "u" ? Promise : pr, yi = function(e, r, a) {
    ...
    Ue(zr, {
      ...
      hook: function() {
        ...
        if (!e.hooked) {
          ...
          e.queue ? r = a.queue : r = a.current, r.push(this), ge(e.target) && e.target.cy().addToAnimationPool(e.target), e.hooked = !0;
        }
        return this;
      },
      play: function() {
    ...
    var Mh = {
      ...
      // stop
    }, Ih = Array.isArray, Tn = Ih, Rh = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, kh = /^\w*$/;
    function Ph(t, e) {
      if (Tn(t))
        return !1;
      var r = typeof t;
      return r == "number" || r == "symbol" || r == "boolean" || t == null || Aa(t) ? !0 : kh.test(t) || !Rh.test(t) || e != null && t in Object(e);
    }
    var Bh = Ph, Fh = "[object AsyncFunction]", zh = "[object Function]", Gh = "[object GeneratorFunction]", $h = "[object Proxy]";
    function Vh(t) {
      if (!Rr(t))
        return !1;
      var e = as(t);
      return e == zh || e == Gh || e == Fh || e == $h;
    }
    var _h = Vh, Uh = un["__core-js_shared__"], mi = Uh, Zs = function() {
    ...
    var Hh = Yh, Xh = Function.prototype, qh = Xh.toString;
    function Wh(t) {
      if (t != null) {
        try {
          return qh.call(t);
    ...
    var Kh = Wh, Zh = /[\\^$.*+?()[\]{}|]/g, Qh = /^\[object .+?Constructor\]$/, Jh = Function.prototype, jh = Object.prototype, ec = Jh.toString, tc = jh.hasOwnProperty, rc = RegExp(
      "^" + ec.call(tc).replace(Zh, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    );
    function ac(t) {
      if (!Rr(t) || Hh(t))
        return !1;
    ...
    var bi = oc, uc = bi(Object, "create"), Ga = uc;
    function lc() {
    ...
    var cc = hc, vc = "__lodash_hash_undefined__", dc = Object.prototype, gc = dc.hasOwnProperty;
    function pc(t) {
      var e = this.__data__;
      if (Ga) {
        var r = e[t];
      ...
      return gc.call(e, t) ? e[t] : void 0;
    }
    var yc = pc, mc = Object.prototype, bc = mc.hasOwnProperty;
    function Ec(t) {
      var e = this.__data__;
      return Ga ? e[t] !== void 0 : bc.call(e, t);
    }
    var wc = Ec, xc = "__lodash_hash_undefined__";
    function Tc(t, e) {
      var r = this.__data__;
      return this.size += this.has(t) ? 0 : 1, r[t] = Ga && e === void 0 ? xc : e, this;
    }
    var Cc = Tc;
    function sa(t) {
    ...
    sa.prototype.clear = fc, sa.prototype.delete = cc, sa.prototype.get = yc, sa.prototype.has = wc, sa.prototype.set = Cc;
    var Qs = sa;
    function Dc() {
    ...
    var Cn = Ac, Oc = Array.prototype, Nc = Oc.splice;
    function Mc(t) {
      var e = this.__data__, r = Cn(e, t);
      if (r < 0)
        return !1;
      var a = e.length - 1;
      return r == a ? e.pop() : Nc.call(e, r, 1), --this.size, !0;
    }
    var Ic = Mc;
    function Rc(t) {
      var e = this.__data__, r = Cn(e, t);
    ...
    oa.prototype.clear = Sc, oa.prototype.delete = Ic, oa.prototype.get = kc, oa.prototype.has = Bc, oa.prototype.set = zc;
    var Gc = oa, $c = bi(un, "Map"), Vc = $c;
    function _c() {
    ...
    function Xc(t, e) {
      var r = t.__data__;
      return Hc(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
    }
    var Dn = Xc;
    function qc(t) {
    ...
    ua.prototype.clear = Uc, ua.prototype.delete = Wc, ua.prototype.get = Zc, ua.prototype.has = Jc, ua.prototype.set = ev;
    var js = ua, tv = "Expected a function";
    function Ei(t, e) {
      ...
      return r.cache = new (Ei.Cache || js)(), r;
    }
    Ei.Cache = js;
    var rv = Ei, av = 500;
    function nv(t) {
      var e = rv(t, function(a) {
        return r.size === av && r.clear(), a;
      }), r = e.cache;
      return e;
    }
    var iv = nv, sv = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, ov = /\\(\\)?/g, uv = iv(function(t) {
      var e = [];
      return t.charCodeAt(0) === 46 && e.push(""), t.replace(sv, function(r, a, n, i) {
        e.push(n ? i.replace(ov, "$1") : a || r);
      }), e;
    }), eo = uv;
    function lv(t, e) {
    ...
    var to = lv, fv = 1 / 0, ro = Zr ? Zr.prototype : void 0, ao = ro ? ro.toString : void 0;
    function no(t) {
      if (typeof t == "string")
        return t;
      if (Tn(t))
    ...
    var io = cv;
    function vv(t, e) {
      return Tn(t) ? t : Bh(t, e) ? [t] : eo(io(t));
    }
    var so = vv, dv = 1 / 0;
    function gv(t) {
    ...
    var yv = pv;
    function mv(t, e, r) {
      var a = t == null ? void 0 : yv(t, e);
      return a === void 0 ? r : a;
    }
    var bv = mv, Ev = function() {
      try {
    ...
    var xv = wv, Tv = Object.prototype, Cv = Tv.hasOwnProperty;
    function Dv(t, e, r) {
      var a = t[e];
      (!(Cv.call(t, e) && Js(a, r)) || r === void 0 && !(e in t)) && xv(t, e, r);
    }
    var Sv = Dv, Lv = 9007199254740991, Av = /^(?:0|[1-9]\d*)$/;
    function Ov(t, e) {
      var r = typeof t;
      return e = e ?? Lv, !!e && (r == "number" || r != "symbol" && Av.test(t)) && t > -1 && t % 1 == 0 && t < e;
    }
    var Nv = Ov;
    function Mv(t, e, r, a) {
      if (!Rr(t))
      ...
      for (var n = -1, i = e.length, s = i - 1, o = t; o != null && ++n < i; ) {
        ...
        if (n != s) {
          var f = o[l];
          u = a ? a(f, l, o) : void 0, u === void 0 && (u = Rr(f) ? f : Nv(e[n + 1]) ? [] : {});
        }
        Sv(o, l, u), o = o[l];
      }
      return t;
    ...
    var Bv = Pv;
    function Fv(t) {
      return Tn(t) ? to(t, wi) : Aa(t) ? [t] : Bv(eo(io(t)));
    }
    var zv = Fv, Gv = {
      // access data field
      data: function(e) {
        ...
        return e = Ue({}, r, e), function(n, i) {
          ...
          if (j(n)) {
            var h = n.indexOf(".") !== -1, c = h && zv(n);
            if (s.allowGetting && i === void 0) {
              var v;
              return f && (s.beforeGet(f), c && f._private[s.field][n] === void 0 ? v = bv(f._private[s.field], c) : v = f._private[s.field][n]), v;
              ...
              if (d) {
                ...
                for (var y = 0, p = u.length; y < p; y++) {
                  var m = u[y];
                  s.canSet(m) && (c && f._private[s.field][n] === void 0 ? kv(m._private[s.field], c, i) : m._private[s.field][n] = i);
                }
    ...
    var gt = function() {
      ...
      return Ju(t.selector, e.selector);
    }), _v = function() {
      for (var t = {}, e, r = 0; r < xi.length; r++)
        e = xi[r], t[e.selector] = e.matches;
      return t;
    }(), Uv = function(e, r) {
      return _v[e](r);
    }, Yv = "(" + xi.map(function(t) {
      return t.selector;
    }).join("|") + ")", la = function(e) {
    ...
    var Hv = function(e) {
      for (var r, a, n, i = 0; i < Ti.length; i++) {
        var s = Ti[i], o = s.name, l = e.match(s.regexObj);
        if (l != null) {
          a = l, r = s, n = o;
          var u = l[0];
    ...
    var jv = function(e) {
      ...
      this.inputText = e, this.currentSubject = null, this.compoundCount = 0, this.edgeCount = 0, this.length = 0, e == null || j(e) && e.match(/^\s*$/) || (ge(e) ? this.addQuery({
        checks: [{
          type: Be.COLLECTION,
          value: e.collection()
        }]
    ...
    var Kt = function(e, r) {
      return function(n, i, s, o) {
        var l = n, u = this, f;
        if (l == null ? f = "" : ge(l) && l.length === 1 && (f = l.id()), u.length === 1 && f) {
    ...
    Ue(Ln, {
      degree: Si(function(t, e) {
        return e.source().same(e.target()) ? 2 : 1;
      }),
      indegree: Si(function(t, e) {
        return e.target().same(t) ? 1 : 0;
      }),
      outdegree: Si(function(t, e) {
        ...
        if (a && a.isNode())
          if (l)
            for (var u = 0; u < this.length; u++) {
              var f = this[u];
              r !== void 0 ? f.position(e, (r - s[e]) / i) : o !== void 0 && f.position(ys(o, i, s));
            }
          else {
            var h = a.position();
    ...
    var Zt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          ...
          if (ie || oe) {
            var de = ie ? Va(i.rstyle, "labelAngle", a) : p.pfValue, se = Math.cos(de), ve = Math.sin(de), we = (F + R) / 2, Te = (X + z) / 2;
            if (!y) {
              switch (l.value) {
                case "left":
                  we = R;
      ...
      if (b) {
            ...
            if (f = Math.min(y.srcX, y.midX, y.tgtX), h = Math.max(y.srcX, y.midX, y.tgtX), c = Math.min(y.srcY, y.midY, y.tgtY), v = Math.max(y.srcY, y.midY, y.tgtY), f -= B, h += B, c -= B, v += B, rr(s, f, c, h, v), W === "haystack") {
              ...
              if (de != null)
                for (var se = 0; se < de.length; se++) {
                  var ve = de[se];
                  f = ve.x - B, h = ve.x + B, c = ve.y - B, v = ve.y + B, rr(s, f, c, h, v);
                }
            }
          } else {
        ...
        bs(He, s), ui(He, p), pn(He, 1), n && (f = s.x1, h = s.x2, c = s.y1, v = s.y2, rr(s, f - I, c - I, h + I, v + I));
        var qe = o.overlayBounds = o.overlayBounds || {};
        bs(qe, s), ui(qe, p), pn(qe, 1);
        var Re = o.labelBounds = o.labelBounds || {};
        Re.all != null ? Df(Re.all) : Re.all = Ut(), n && r.includeLabels && (r.includeMainLabels && Li(s, e, null), u && (r.includeSourceLabels && Li(s, e, "source"), r.includeTargetLabels && Li(s, e, "target")));
      }
      return s.x1 = Zt(s.x1), s.y1 = Zt(s.y1), s.x2 = Zt(s.x2), s.y2 = Zt(s.y2), s.w = Zt(s.x2 - s.x1), s.h = Zt(s.y2 - s.y1), s.w > 0 && s.h > 0 && b && (ui(s, p), pn(s, 1)), s;
    }, po = function(e) {
      ...
      if (e.isEdge()) {
        ...
        return Hl([n(r.x), n(r.y), n(a.x), n(a.y)]);
      } else
        return 0;
    }, mo = function(e, r) {
      var a = e._private, n, i = e.isEdge(), s = r == null ? bo : po(r), o = s === bo, l = yo(e), u = a.bbCachePosKey === l, f = r.useCache && u, h = function(g) {
        return g._private.bbCache == null || g._private.styleDirty;
      }, c = !f || h(e) || i && h(e.source()) || h(e.target());
      if (c ? (u || e.recalculateRenderedStyle(f), n = id(e, _a), a.bbCache = n, a.bbCachePosKey = l) : n = a.bbCache, !o) {
        var v = e.isNode();
    ...
    Ar.boundingBox = function(t) {
      ...
      if (this.length === 1 && this[0]._private.bbCache != null && !this[0]._private.styleDirty && (t === void 0 || t.useCache === void 0 || t.useCache === !0))
        t === void 0 ? t = _a : t = Eo(t), e = mo(this[0], t);
      else {
        e = Ut(), t = t || _a;
        var r = Eo(t), a = this, n = a.cy(), i = n.styleEnabled();
        if (i)
          for (var s = 0; s < a.length; s++) {
            var o = a[s], l = o._private, u = yo(o), f = l.bbCachePosKey === u, h = r.useCache && f && !l.styleDirty;
    ...
    }, yd = Object.keys(xo).reduce(function(t, e) {
      var r = xo[e], a = pd(e);
      return t[e] = function() {
        return ud(this, r.get);
      }, r.mult ? t[a] = function() {
        return fd(this, r.get);
      } : t[a] = function() {
    ...
    var Co = /^([^.]+)(\.(?:[^.]+))?$/, bd = ".*", Do = {
      ...
      context: null
    }, So = Object.keys(Do), Ed = {};
    function Nn() {
      for (var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Ed, e = arguments.length > 1 ? arguments[1] : void 0, r = 0; r < So.length; r++) {
        var a = So[r];
        this[a] = t[a] || Do[a];
      }
      this.context = e || this.context, this.listeners = [], this.emitting = 0;
    }
    var Or = Nn.prototype, Lo = function(e, r, a, n, i, s, o) {
      ...
      return e.addEventFields(e.context, r), new To(r.type, r);
    }, wd = function(e, r, a) {
      if (ct(a)) {
        r(e, a);
        return;
      ...
      for (var n = te(a) ? a : a.split(/\s+/), i = 0; i < n.length; i++) {
        ...
        if (!Pe(s)) {
          var o = s.match(Co);
          if (o) {
            var l = o[1], u = o[2] ? o[2] : null, f = Ao(e, {
              type: l,
              namespace: u,
              target: e.context
            });
    ...
    Or.on = Or.addListener = function(t, e, r, a, n) {
      return Lo(this, function(i, s, o, l, u, f, h) {
      ...
      var n = this;
      this.emitting !== 0 && (this.listeners = Zl(this.listeners));
      for (var i = this.listeners, s = function(u) {
        var f = i[u];
        Lo(n, function(h, c, v, d, g, y) {
      ...
      return this.emitting++, te(e) || (e = [e]), wd(this, function(i, s) {
        r != null && (a = [{
          event: s.event,
          type: s.type,
        ...
        for (var o = function(f) {
          var h = a[f];
          if (h.type === s.type && (!h.namespace || h.namespace === s.namespace || h.namespace === bd) && i.eventMatches(i.context, h, s)) {
            var c = [s];
            e != null && Jl(c, e), i.beforeEmit(i.context, h, s), h.conf && h.conf.one && (i.listeners = i.listeners.filter(function(g) {
              return g !== h;
            }));
    ...
    var xd = {
      ...
      createEmitter: function() {
        for (var e = 0; e < this.length; e++) {
          ...
          a.emitter || (a.emitter = new Nn(xd, r));
        }
        return this;
      },
      emitter: function() {
    ...
    var Td = {
      ...
      function i(f) {
        ...
        return h.value === "auto" ? n ? f.zDepth() : 0 : h.value === "bottom" ? -1 : h.value === "top" ? ai : 0;
      }
      var s = i(e) - i(r);
      if (s !== 0)
        return s;
    ...
    function Oi(t) {
      ...
      return function() {
        ...
        if (i) {
          ...
          return r(l) && (!s || Ai(l, r)) && (l === u || r(u) && (!s || Ai(u, r)));
        }
      };
    }
    ...
    At.takesUpSpace = Pn("takesUpSpace", Oi({
      ok: va
    }));
    var Sd = kn("eleInteractive", function(t) {
      return t.pstyle("events").value === "yes" && t.pstyle("visibility").value === "visible" && va(t);
    }), Ld = kn("parentInteractive", function(t) {
      return t.pstyle("visibility").value === "visible" && va(t);
    });
    At.interactive = Pn("interactive", Oi({
      ok: Sd,
      parentOk: Ld,
      edgeOkViaNode: va
    ...
    Ue(Pt, {
      ...
      parallelEdges: Kt(Go(), "parallelEdges"),
      codirectedEdges: Kt(Go({
        codirected: !0
      }), "codirectedEdges")
    });
    function Go(t) {
    ...
    mt.instanceString = function() {
      ...
      if (o.length > 0) {
        for (var oe = o.length === r.length ? r : new Ot(a, o), de = 0; de < oe.length; de++) {
          var se = oe[de];
          se.isNode() || (se.parallelEdges().clearTraversalCache(), se.source().clearTraversalCache(), se.target().clearTraversalCache());
        }
        var ve;
        n.hasCompoundNodes ? ve = a.collection().merge(oe).merge(oe.connectedNodes()).merge(oe.parent()) : ve = oe, ve.dirtyCompoundBoundsCache().dirtyBoundingBoxCache().updateStyle(t), t ? oe.emitAndNotify("add") : e && oe.emit("add");
      }
      return r;
    }, mt.removed = function() {
      var t = this[0];
      ...
      return this;
    }, [_s, Vv, Sn, Lr, fa, ad, Ln, md, Oo, No, Td, In, Rn, At, Nr, Pt].forEach(function(t) {
      Ue(mt, t);
    });
    var Nd = {
      add: function(e) {
    ...
    function _o(t, e) {
      ...
      function n(f, h) {
        ...
        for (var p = function(A) {
          ...
          !E.playing && !E.applying || (E.playing && E.applying && (E.applying = !1), E.started || kd(f, b, t), Rd(f, b, t, h), E.applying && (E.applying = !1), p(E.frames), E.step != null && E.step(t), b.completed() && (v.splice(m, 1), E.hooked = !1, E.playing = !1, E.started = !1, p(E.completes)), g = !0);
        }
    ...
    var Pd = {
      ...
      createEmitter: function() {
        var e = this._private;
        return e.emitter || (e.emitter = new Nn(Bd, this)), this;
      },
      emitter: function() {
        return this._private.emitter;
      },
    ...
    var Gn = {
      ...
      collection: function(e, r) {
        return j(e) ? this.$(e) : ge(e) ? e.collection() : te(e) ? (r || (r = {}), new Ot(this, e, r.unique, r.removed)) : new Ot(this);
      },
      nodes: function(e) {
    ...
    Bt.apply = function(t) {
      ...
      if (e.labelKey = Er(oe), e.labelStyleKey = Er(hn(ie.commonLabel, oe)), !o) {
        var de = i(t, ["source-label"], ie.labelDimensions);
        e.sourceLabelKey = Er(de), e.sourceLabelStyleKey = Er(hn(ie.commonLabel, de));
        var se = i(t, ["target-label"], ie.labelDimensions);
        e.targetLabelKey = Er(se), e.targetLabelStyleKey = Er(hn(ie.commonLabel, se));
      }
      if (o) {
        var ve = e.styleKeys, we = ve.nodeBody, Te = ve.nodeBorder, Ee = ve.backgroundImage, ye = ve.compound, ae = ve.pie, xe = [we, Te, Ee, ye, ae].filter(function(Ce) {
          return Ce != null;
        }).reduce(hn, [Qr, Oa]);
      ...
      switch (a.mapped) {
        ...
        case s.fn: {
          var de = a.value, se = a.fnValue != null ? a.fnValue : de(t);
    ...
    var Ri = {};
    Ri.appendFromString = function(t) {
    ...
    (function() {
      ...
      for (var we = 0; we < de.length; we++) {
        var Te = de[we], Ee = W[Te.pointsTo], ye = {
          name: Te.name,
          alias: !0,
          pointsTo: Ee
        };
    ...
    Vn.parse = function(t, e, r, a) {
      ...
      var i = a === "mapping" || a === !0 || a === !1 || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, l = ls(t, o, s, i), u = n.propCache = n.propCache || [], f;
      ...
      if (u.number) {
        ...
        return u.unitless || R !== "px" && R !== "em" ? W.pfValue = e : W.pfValue = R === "px" || !R ? e : this.getEmSizeInPixels() * e, (R === "ms" || R === "s") && (W.pfValue = R === "ms" ? e : 1e3 * e), (R === "deg" || R === "rad") && (W.pfValue = R === "rad" ? e : wf(e)), R === "%" && (W.pfValue = e / 100), W;
      } else if (u.propList) {
        var Z = [], ie = "" + e;
        if (ie !== "none") {
          for (var oe = ie.split(/\s*,\s*|\s+/), de = 0; de < oe.length; de++) {
            var se = oe[de].trim();
    ...
    }, [Bt, Wa, Ii, lr, $n, Ri, Nt, Vn].forEach(function(t) {
      Ue(zt, t);
    ...
    var $d = {
      ...
      selectionType: function(e) {
        var r = this._private;
        if (r.selectionType == null && (r.selectionType = Vd), e !== void 0)
    ...
    Ue(_n, {
      ...
      mount: function(e) {
        if (e != null) {
          ...
          return !he(e) && he(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = !0, r.invalidateSize(), r.initRenderer(Ue({}, n, n.renderer, {
    ...
    }), _n.$id = _n.getElementById, [Nd, Pd, Uo, Ni, zn, Fd, Mi, Gn, $d, $r, Ka].forEach(function(t) {
      Ue(_n, t);
    });
    var _d = {
      fit: !0,
    ...
    Ho.prototype.run = function() {
      ...
      if (e.avoidOverlap)
        for (var ie = 0; ie < n.length; ie++) {
          var oe = n[ie], de = oe.layoutDimensions(e), se = de.w, ve = de.h;
          Z = Math.max(Z, se, ve);
        }
    ...
    qo.prototype.run = function() {
      ...
      if (e.equidistant) {
        for (var ie = 0, oe = 0, de = 0; de < p.length; de++) {
          var se = p[de], ve = se.r - oe;
          ie = Math.max(ie, ve);
        }
        oe = 0;
    ...
    function Un(t) {
      this.options = Ue({}, Hd, t), this.options.layout = this;
    }
    Un.prototype.run = function() {
      ...
      var a = Xd(e, r, t);
      ki && Kd(a), t.randomize && Zd(a);
      var n = dr(), i = function() {
        Qd(a, e, t), t.fit === !0 && e.fit(t.padding);
      }, s = function(c) {
        return !(r.stopped || c >= t.numIter || (Jd(a, t), a.temperature = a.temperature * t.coolingFactor, a.temperature < t.minTemp));
      }, o = function() {
    ...
    var Xd = function(e, r, a) {
      ...
      for (var u = 0; u < s.edgeSize; u++) {
        ...
        if (W != Z) {
          for (var ie = qd(F.sourceId, F.targetId, s), oe = s.graphSet[ie], de = 0, g = s.layoutNodes[z]; oe.indexOf(g.id) === -1; )
            g = s.layoutNodes[s.idToIndex[g.parentId]], de++;
          for (g = s.layoutNodes[re]; oe.indexOf(g.id) === -1; )
            g = s.layoutNodes[s.idToIndex[g.parentId]], de++;
          R *= de * a.nestingFactor;
        }
      ...
      var n = a.layout, i = a.eles.nodes(), s = Wo(e, a, i);
      i.positions(s), e.ready !== !0 && (e.ready = !0, n.one("layoutready", a.ready), n.emit({
        type: "layoutready",
        layout: this
      }));
    }, Jd = function(e, r, a) {
      jd(e, r), rg(e), ag(e, r), ng(e), ig(e);
    }, jd = function(e, r) {
      ...
      for (var a = 0; a < e.nodeSize; a++) {
        ...
        if (!(0 < n.children.length || n.isLocked)) {
          var i = sg(n.offsetX, n.offsetY, e.temperature);
          n.positionX += i.x, n.positionY += i.y, n.offsetX = 0, n.offsetY = 0, n.minX = n.positionX - n.width, n.maxX = n.positionX + n.width, n.minY = n.positionY - n.height, n.maxY = n.positionY + n.height, og(n, e);
        }
      }
      for (var a = 0; a < e.nodeSize; a++) {
        var n = e.layoutNodes[a];
    ...
    Qo.prototype.run = function() {
      ...
      if (i.h === 0 || i.w === 0)
        ...
        for (var F = {}, R = function(Te, Ee) {
          ...
          var oe = n[ie], de = e.position(oe);
          if (de && (de.row !== void 0 || de.col !== void 0)) {
            var se = {
              row: de.row,
              col: de.col
            };
    ...
    var Bi = {};
    Bi.arrowShapeWidth = 0.3, Bi.registerArrowShapes = function() {
    ...
    Vr.projectIntoViewport = function(t, e) {
      ...
      function m(w) {
        ...
        if (C.edgeType === "segments" || C.edgeType === "straight" || C.edgeType === "haystack") {
          for (var W = C.allpts, Z = 0; Z + 3 < W.length; Z += 2)
            if (Of(t, e, W[Z], W[Z + 1], W[Z + 2], W[Z + 3], z) && X > (re = kf(t, e, W[Z], W[Z + 1], W[Z + 2], W[Z + 3])))
              return y(w, re), !0;
          ...
          for (var W = C.allpts, Z = 0; Z + 5 < C.allpts.length; Z += 4)
            if (Nf(t, e, W[Z], W[Z + 1], W[Z + 2], W[Z + 3], W[Z + 4], W[Z + 5], z) && X > (re = Rf(t, e, W[Z], W[Z + 1], W[Z + 2], W[Z + 3], W[Z + 4], W[Z + 5])))
              return y(w, re), !0;
        }
        for (var ie = ie || I.source, oe = oe || I.target, de = n.getArrowWidth(B, F), se = [{
          name: "source",
          x: C.arrowStartX,
          y: C.arrowStartY,
          ...
          var ve = se[Z], we = i.arrowShapes[w.pstyle(ve.name + "-arrow-shape").value], Te = w.pstyle("width").pfValue;
          if (we.roughCollide(t, e, de, ve.angle, {
            x: ve.x,
            y: ve.y
          }, Te, f) && we.collide(t, e, de, ve.angle, {
            x: ve.x,
            y: ve.y
          }, Te, f))
            return y(w), !0;
      ...
      function E(w, I) {
        ...
        if (!(!z || !X)) {
          var re = b(C.rscratch, "labelX", I), W = b(C.rscratch, "labelY", I), Z = b(C.rscratch, "labelAngle", I), ie = w.pstyle(F + "text-margin-x").pfValue, oe = w.pstyle(F + "text-margin-y").pfValue, de = R.x1 - B - ie, se = R.x2 + B - ie, ve = R.y1 - B - oe, we = R.y2 + B - oe;
          if (Z) {
            ...
            }, ae = ye(de, ve), xe = ye(de, we), Ce = ye(se, ve), Oe = ye(se, we), Ie = [
    ...
    Vt.findHaystackPoints = function(t) {
      ...
      for (var p = 0; p < v; p++) {
        var m = (0.5 - e.eles.length / 2 + r) * f * (n ? -1 : 1), b = void 0, E = ms(m);
      ...
      var W = p === a, Z = W ? z : X, ie = W ? F : B, oe = ms(ie), de = !1;
      !(re && (E || A)) && (m === o && ie < 0 || m === l && ie > 0 || m === i && ie > 0 || m === s && ie < 0) && (oe *= -1, Z = oe * Math.abs(Z), de = !0);
      var se;
      if (E) {
        var ve = M < 0 ? 1 + M : M;
        se = ve * Z;
      ...
      if (!(!t || t.length === 0)) {
        ...
        for (var E = function(w) {
          ...
          if (!C.hasUnbundled) {
            ...
            ii(C.eles), F.forEach(function(Se) {
          ...
          var W = C.srcPos = X.position(), Z = C.tgtPos = z.position(), ie = C.srcW = X.outerWidth(), oe = C.srcH = X.outerHeight(), de = C.tgtW = z.outerWidth(), se = C.tgtH = z.outerHeight(), ve = C.srcShape = r.nodeShapes[e.getNodeShape(X)], we = C.tgtShape = r.nodeShapes[e.getNodeShape(z)];
          C.dirCounts = {
            north: 0,
            west: 0,
            south: 0,
          ...
          for (var Te = 0; Te < C.eles.length; Te++) {
            ...
            if (!C.calculatedIntersection && X !== z && (C.hasBezier || C.hasUnbundled)) {
              ...
              var Oe = ve.intersectLine(W.x, W.y, ie, oe, Z.x, Z.y, 0), Ie = C.srcIntn = Oe, He = we.intersectLine(Z.x, Z.y, de, se, W.x, W.y, 0), qe = C.tgtIntn = He, Re = C.intersectionPts = {
                x1: Oe[0],
                x2: He[0],
                y1: Oe[1],
                y2: He[1]
              ...
              C.nodesOverlap = !k(ke) || we.checkPoint(Oe[0], Oe[1], 0, de, se, Z.x, Z.y) || ve.checkPoint(He[0], He[1], 0, ie, oe, W.x, W.y), C.vectorNormInverse = We, B = {
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (C === "inside-to-node")
        ...
        var ie = n._private.rscratch, oe = ie.labelWidth, de = ie.labelHeight, se = ie.labelX, ve = ie.labelY, we = oe / 2, Te = de / 2, Ee = n.pstyle("text-valign").value;
        Ee === "top" ? ve -= Te : Ee === "bottom" && (ve += Te);
        var ye = n.pstyle("text-halign").value;
        ye === "left" ? se -= we : ye === "right" && (se += we);
        var ae = Ba(R[0], R[1], [se - we, ve - Te, se + we, ve - Te, se + we, ve + Te, se - we, ve + Te], s.x, s.y);
        if (ae.length > 0) {
    ...
    Fi.storeEdgeProjections = function(t) {
    ...
    }, Fi.recalculateEdgeProjections = function(t) {
    ...
    fr.recalculateEdgeLabelProjections = function(t) {
      ...
      if (i.mid || i.source || i.target) {
        ...
        var o = nu(a.midDispX, a.midDispY);
          ...
          if (i[h]) {
            ...
            switch (a.edgeType) {
              ...
              case "multibezier": {
                ...
                R = ka(0, R, 1), e = ea(I.p0, I.p1, I.p2, R), c = dg(I.p0, I.p1, I.p2, R);
                break;
              }
              case "straight":
              case "segments":
              case "haystack": {
                for (var X = 0, z, re, W, Z, ie = a.allpts.length, oe = 0; oe + 3 < ie && (v ? (W = {
                  ...
                  ;
                var de = d - re, se = de / z;
                se = ka(0, se, 1), e = Tf(W, Z, se), c = iu(W, Z);
                break;
              }
            }
      ...
      var r = t._private, a = e ? e + "-" : "", n = t.pstyle(a + "label").strValue, i = t.pstyle("text-transform").value, s = function(de, se) {
        return se ? (xr(r.rscratch, de, e, se), se) : er(r.rscratch, de, e);
      };
      if (!n)
        return "";
...
`), p = 0; p < y.length; p++) {
    ...
    su.getNodeShape = function(t) {
      ...
      if (r === "cutrectangle" && (t.width() < ou || t.height() < ou))
        return uu || (ft("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), uu = !0), "rectangle";
      if (t.isParent())
    ...
    var lu = {};
    [Vr, Hn, Vt, Qa, Fi, fr, su, Xn, qn].forEach(function(t) {
      Ue(lu, t);
    });
    var fu = {};
    fu.getCachedImage = function(t, e, r) {
    ...
    ya.registerBinding = function(t, e, r, a) {
      ...
      t.registerBinding(t.container, "mousedown", function(N) {
        if (I(N)) {
          ...
          if (N.which == 3) {
            ...
            Le ? (Le.activate(), Le.emit(dt), t.hoverData.down = Le) : le.emit(dt), t.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), t.hoverData.cxtDragged = !1;
          } else if (N.which == 1) {
            Le && Le.activate();
            {
      ...
      var X, z, re, W, Z, ie, oe, de, se, ve, we, Te, Ee, ye = function(N, le, De, me) {
      ...
      t.registerBinding(t.container, "touchstart", xe = function(N) {
        if (t.hasTouchStarted = !0, !!I(N)) {
          ...
          if (N.touches[1]) {
            ...
            se = Ke[0], ve = Ke[1], we = Ke[2], Te = Ke[3], X = N.touches[0].clientX - se, z = N.touches[0].clientY - ve, re = N.touches[1].clientX - se, W = N.touches[1].clientY - ve, Ee = 0 <= X && X <= we && 0 <= re && re <= we && 0 <= z && z <= Te && 0 <= W && W <= Te;
            var Le = le.pan(), ze = le.zoom();
            Z = ye(X, z, re, W), ie = ae(X, z, re, W), oe = [(X + re) / 2, (z + W) / 2], de = [(oe[0] - Le.x) / ze, (oe[1] - Le.y) / ze];
            var at = 200, dt = at * at;
      ...
      t.registerBinding(window, "touchmove", Ce = function(N) {
        ...
        if (!(!le && !I(N))) {
          ...
          if (le && t.touchData.cxt) {
            N.preventDefault();
            var nr = N.touches[0].clientX - se, Rt = N.touches[0].clientY - ve, Qt = N.touches[1].clientX - se, _t = N.touches[1].clientY - ve, br = ae(nr, Rt, Qt, _t), Ir = br / ie, xa = 150, Hr = xa * xa, Ta = 1.5, Qn = Ta * Ta;
            if (Ir >= Qn || br >= Hr) {
          ...
          if (le && t.touchData.cxt) {
            ...
            var cr = t.touchData.start, nr = N.touches[0].clientX - se, Rt = N.touches[0].clientY - ve, Qt = N.touches[1].clientX - se, _t = N.touches[1].clientY - ve, Pu = ye(nr, Rt, Qt, _t), lp = Pu / Z;
            if (Ee) {
              var fp = nr - X, hp = Rt - z, cp = Qt - re, vp = _t - W, dp = (fp + cp) / 2, gp = (hp + vp) / 2, rn = me.zoom(), Hi = rn * lp, jn = me.pan(), Bu = de[0] * rn + jn.x, Fu = de[1] * rn + jn.y, pp = {
                x: -Hi / rn * (Bu - jn.x - dp) + Bu,
                y: -Hi / rn * (Fu - jn.y - gp) + Fu
              };
              if (cr && cr.active()) {
                var Gt = t.dragData.touchDragEles;
              ...
              }), me.emit("pinchzoom"), Z = Pu, X = nr, z = Rt, re = Qt, W = _t, t.pinching = !0;
            }
            if (N.touches[0]) {
              var ze = t.projectIntoViewport(N.touches[0].clientX, N.touches[0].clientY);
              be[0] = ze[0], be[1] = ze[1];
            ...
            var ir = t.touchData.start, Xi = t.touchData.last, Ht;
            if (!t.hoverData.draggingEles && !t.swipePanning && (Ht = t.findNearestElement(be[0], be[1], !0, !0)), le && ir != null && N.preventDefault(), le && ir != null && t.nodeIsDraggable(ir))
              if (dt) {
                var Gt = t.dragData.touchDragEles, zu = !t.dragData.didDrag;
                zu && v(Gt, {
                  inDragLayer: !0
                ...
                if (k(Qe[0]) && k(Qe[1]) && (an.x += Qe[0], an.y += Qe[1], zu)) {
                  t.redrawHint("eles", !0);
            ...
            if (r(ir || Ht, ["touchmove", "tapdrag", "vmousemove"], N, {
              x: be[0],
              y: be[1]
            }), (!ir || !ir.grabbed()) && Ht != Xi && (Xi && Xi.emit({
              originalEvent: N,
              type: "tapdragout",
              position: {
                x: be[0],
            ...
            if (le && (ir == null || ir.pannable()) && me.panningEnabled() && me.userPanningEnabled()) {
              var yp = n(ir, t.touchData.starts);
              yp && (N.preventDefault(), t.data.bgActivePosistion || (t.data.bgActivePosistion = jr(t.touchData.startPosition)), t.swipePanning ? (me.panBy({
                x: Qe[0] * Le,
                y: Qe[1] * Le
    ...
    yr.generatePolygon = function(t, e) {
      ...
      return this.nodeShapes[t] = {
        ...
        intersectLine: function(f, h, c, v, d, g, y) {
          return Ff(d, g, this.points, f, h, c, v);
        },
        checkPoint: function(f, h, c, v, d, g, y) {
          return Pf(f, h, this.points, g, y, v, d);
        }
      };
      ...
      return this.nodeShapes.barrel = {
        ...
        generateBarrelBezierPts: function(e, r, a, n) {
          var i = r / 2, s = e / 2, o = a - s, l = a + s, u = n - i, f = n + i, h = vi(e, r), c = h.heightOffset, v = h.widthOffset, d = h.ctrlPtOffsetPct * e, g = {
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          var l = vi(n, i), u = l.heightOffset, f = l.widthOffset;
          ...
          for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(w, I, C) {
            ...
            if (re <= w && w <= W && Z <= I && I <= ie) {
              var oe = zf(B, F, R), de = Mf(oe[0], oe[1], oe[2], w), se = de.filter(function(ve) {
                return 0 <= ve && ve <= 1;
              });
              if (se.length > 0)
                return se[0];
      ...
      return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
        ...
        intersectLine: function(e, r, a, n, i, s, o) {
          ...
          return c.length > 0 ? c : ws(i, s, e, r, a, n, o);
        },
        checkPoint: function(e, r, a, n, i, s, o) {
          var l = Fa(n, i), u = 2 * l;
      ...
      var a = new Array(20);
      {
        var n = hi(5, 0), i = hi(5, Math.PI / 5), s = 0.5 * (3 - Math.sqrt(5));
        s *= 1.57;
      ...
      a = Cs(a), this.generatePolygon("star", a), this.generatePolygon("vee", [-1, -1, 0, -0.333, 1, -1, 0, 1]), this.generatePolygon("rhomboid", [-1, -1, 0.333, -1, 1, 1, -0.333, 1]), this.nodeShapes.concavehexagon = this.generatePolygon("concave-hexagon", [-1, -0.95, -0.75, 0, -1, 0.95, 1, 0.95, 0.75, 0, 1, -0.95]);
      {
    ...
    ma.clientFunctions = ["redrawHint", "render", "renderTo", "matchCanvasSize", "nodeShapeImpl", "arrowShapeImpl"], ma.init = function(t) {
      ...
      return !1;
    }, [Bi, lu, fu, ya, yr, Ja].forEach(function(t) {
      Ue(ma, t);
    });
    var zi = 1e3 / 60, vu = {
    ...
    }(), du = 25, Wn = 50, Kn = -4, Gi = 3, yg = 7.99, mg = 8, bg = 1024, Eg = 1024, wg = 1024, xg = 0.2, Tg = 0.8, Cg = 10, Dg = 0.15, Sg = 0.1, Lg = 0.9, Ag = 0.9, Og = 100, Ng = 1, ba = {
      dequeue: "dequeue",
      downscale: "downscale",
      ...
      var n = Mg(r);
      Ue(a, n), a.lookup = new pg(n.getKey, n.doesEleInvalidateKey), a.setupDequeueing();
    }, Dt = ja.prototype;
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      if (!e || e.w === 0 || e.h === 0 || isNaN(e.w) || isNaN(e.h) || !t.visible() || t.removed() || !i.allowEdgeTxrCaching && t.isEdge() || !i.allowParentTxrCaching && t.isParent())
        return null;
      if (a == null && (a = Math.ceil(oi(o * r))), a < Kn)
        a = Kn;
      else if (o >= yg || a > Gi)
        return null;
      ...
      if (v && v.invalidated && (v.invalidated = !1, v.texture.invalidatedWidth -= v.width), v)
        return v;
      var d;
      if (f <= du ? d = du : f <= Wn ? d = Wn : d = Math.ceil(f / Wn) * Wn, f > wg || h > Eg)
        return null;
      ...
      }, b = n && n === ba.dequeue, E = n && n === ba.highQuality, M = n && n === ba.downscale, A, w = a + 1; w <= Gi; w++) {
        var I = l.get(t, w);
        if (I) {
          A = I;
          break;
      ...
      return v = {
        ...
        height: f,
        scaledLabelShown: c
      }, y.usedWidth += Math.ceil(h + mg), y.eleCaches.push(v), l.set(t, a, v), i.checkTextureFullness(y), v;
      ...
      t.invalidatedWidth >= xg * t.width && this.retireTexture(t);
    }, Dt.checkTextureFullness = function(t) {
      var e = this, r = e.getTextureQueue(t.height);
      t.usedWidth / t.width > Tg && t.fullnessChecks >= Cg ? wr(r, t) : t.fullnessChecks++;
      ...
      return a.push(n), n.eleCaches = [], n.height = t, n.width = Math.max(bg, e), n.usedWidth = 0, n.invalidatedWidth = 0, n.fullnessChecks = 0, n.canvas = r.renderer.makeOffscreenCanvas(n.width, n.height), n.context = n.canvas.getContext("2d"), n;
    }, Dt.recycleTexture = function(t, e) {
      for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
        var s = n[i];
        if (s.width >= e)
          return s.retired = !1, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, ii(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), wr(n, s), a.push(s), s;
      }
      ...
      for (var e = this, r = e.getElementQueue(), a = e.getElementKeyToQueue(), n = [], i = e.lookup, s = 0; s < Ng && r.size() > 0; s++) {
      ...
      i != null && (i.eles.length === 1 ? (i.reqs = ai, r.updateItem(i), r.pop(), a[n] = null) : i.eles.unmerge(t));
    }, Dt.onDequeue = function(t) {
      this.onDequeues.push(t);
    }, Dt.offDequeue = function(t) {
      wr(this.onDequeues, t);
    }, Dt.setupDequeueing = vu.setupDequeueing({
      deqRedrawThreshold: Og,
      deqCost: Dg,
      deqAvgCost: Sg,
      deqNoDrawCost: Lg,
      deqFastCost: Ag,
    ...
    var Ig = 1, en = -4, Zn = 2, Rg = 3.99, kg = 50, Pg = 50, Bg = 0.15, Fg = 0.1, zg = 0.9, Gg = 0.9, $g = 1, gu = 250, Vg = 4e3 * 4e3, _g = !0, pu = function(e) {
      var r = this, a = r.renderer = e, n = a.cy;
      r.layersByLevel = {}, r.firstGet = !0, r.lastInvalidationTime = dr() - 2 * gu, r.skipping = !1, r.eleTxrDeqs = n.collection(), r.scheduleElementRefinement = ln(function() {
        r.refineElementTextures(r.eleTxrDeqs), r.eleTxrDeqs.unmerge(r.eleTxrDeqs);
      }, Pg), a.beforeRender(function(s, o) {
        o - r.lastInvalidationTime <= gu ? r.skipping = !0 : r.skipping = !1;
      }, a.beforeRenderPriorities.lyrTxrSkip);
      var i = function(o, l) {
        return l.reqs - o.reqs;
      };
      r.layersQueue = new Ra(i), r.setupDequeueing();
    }, Mt = pu.prototype, yu = 0, Ug = Math.pow(2, 53) - 1;
    Mt.makeLayer = function(t, e) {
      ...
      if (a.skipping && !o)
        return null;
      for (var p = null, m = t.length / Ig, b = !o, E = 0; E < t.length; E++) {
        var M = t[E], A = M._private.rscratch, w = A.imgLayerCaches = A.imgLayerCaches || {}, I = w[r];
        if (I) {
          p = I;
          continue;
        }
        if ((!p || p.eles.length >= m || !Es(p.bb, M.boundingBox())) && (p = y({
          insert: !0,
          after: p
        }), !p))
          return null;
      ...
      o.w === 0 || o.h === 0 || !e.visible() || (r = n.getEleLevelForLayerLevel(r, a), i.setImgSmoothing(s, !1), i.drawCachedElement(s, e, null, null, r, _g), i.setImgSmoothing(s, !0));
      ...
      for (var e = this, r = e.layersQueue, a = [], n = 0; n < $g && r.size() !== 0; ) {
        var i = r.peek();
        if (i.replacement) {
          r.pop();
          continue;
    ...
    }, 100), Mt.setupDequeueing = vu.setupDequeueing({
    ...
    hr.drawCachedElement = function(t, e, r, a, n, i) {
      ...
      if (!(c.w === 0 || c.h === 0 || !e.visible()) && (!a || li(c, a))) {
        var d = e.isEdge(), g = e.element()._private.rscratch.badLine;
        s.drawElementUnderlay(t, e), s.drawCachedElementPortion(t, e, l, r, n, v, Wg, Jg), (!d || !g) && s.drawCachedElementPortion(t, e, u, r, n, v, Kg, $i), d && !g && (s.drawCachedElementPortion(t, e, f, r, n, v, Zg, $i), s.drawCachedElementPortion(t, e, h, r, n, v, Qg, $i)), s.drawElementOverlay(t, e);
      }
    ...
    mr.drawEdgeOverlay = wu("overlay"), mr.drawEdgeUnderlay = wu("underlay"), mr.drawEdgePath = function(t, e, r, a) {
    ...
    var Vi = {};
    Vi.safeDrawImage = function(t, e, r, a, n, i, s, o, l, u) {
      if (!(n <= 0 || i <= 0 || l <= 0 || u <= 0))
        try {
    ...
    }, Vi.drawInscribedImage = function(t, e, r, a, n) {
      ...
      if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? C = f(r, "background-width", "pfValue", a) * y : C = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? B = f(r, "background-height", "pfValue", a) * p : B = f(r, "background-height", "pfValue", a)), !(C === 0 || B === 0)) {
        ...
        ie === "%" ? Z += (p - B) * oe : Z += oe;
        var de = f(r, "background-offset-y", "units", a), se = f(r, "background-offset-y", "pfValue", a);
        de === "%" ? Z += (p - B) * se : Z += se, m.pathCache && (R -= o, Z -= l, o = 0, l = 0);
        var ve = t.globalAlpha;
        t.globalAlpha = M;
        ...
        t.globalAlpha = ve, Te && i.setImgSmoothing(t, we);
      }
    };
    var _r = {};
    _r.eleTextBiggerThanMin = function(t, e) {
      if (!e) {
        var r = t.cy().zoom(), a = this.getPixelRatio(), n = Math.ceil(oi(r * a));
        e = Math.pow(2, n);
      }
      ...
      if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
          ...
          if (A > 0 || I > 0 && w > 0) {
            ...
            if (I > 0 && w > 0) {
              var Z = t.strokeStyle, ie = t.lineWidth, oe = e.pstyle("text-border-color").value, de = e.pstyle("text-border-style").value;
              ...
              if (t.strokeRect(B, F, R, X), de === "double") {
                var se = I / 2;
          ...
          var ve = 2 * e.pstyle("text-outline-width").pfValue;
          if (ve > 0 && (t.lineWidth = ve), e.pstyle("text-wrap").value === "wrap") {
            ...
            for (var ae = 0; ae < we.length; ae++)
              ve > 0 && t.strokeText(we[ae], l, u), t.fillText(we[ae], l, u), u += Te;
          } else
            ve > 0 && t.strokeText(c, l, u), t.fillText(c, l, u);
    ...
    Ea.drawNode = function(t, e, r) {
      ...
      if (!(!k(h.x) || !k(h.y)) && !(i && !e.visible())) {
        ...
        }, oe = e.pstyle("shape").strValue, de = e.pstyle("shape-polygon-points").pfValue;
        if (v) {
          t.translate(h.x, h.y);
          var se = s.nodePathCache = s.nodePathCache || [], ve = ls(oe === "polygon" ? oe + "," + de.join(",") : oe, "" + l, "" + o), we = se[ve];
          we != null ? (d = we, g = !0, f.pathCache = d) : (d = new Path2D(), se[ve] = f.pathCache = d);
        }
        var Te = function() {
          if (!g) {
            var ke = h;
    ...
    Ea.drawNodeOverlay = xu("overlay"), Ea.drawNodeUnderlay = xu("underlay"), Ea.hasPie = function(t) {
    ...
    Wt.getPixelRatio = function() {
      ...
      var ie = l.extent(), oe = s.pinching || s.hoverData.dragging || s.swipePanning || s.data.wheelZooming || s.hoverData.draggingEles || s.cy.animated(), de = s.hideEdgesOnViewport && oe, se = [];
      if (se[s.NODE] = !f[s.NODE] && c && !s.clearedForMotionBlur[s.NODE] || s.clearingMotionBlur, se[s.NODE] && (s.clearedForMotionBlur[s.NODE] = !0), se[s.DRAG] = !f[s.DRAG] && c && !s.clearedForMotionBlur[s.DRAG] || s.clearingMotionBlur, se[s.DRAG] && (s.clearedForMotionBlur[s.DRAG] = !0), f[s.NODE] || r || a || se[s.NODE]) {
        var ve = c && !se[s.NODE] && v !== 1, z = e || (ve ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_NODE] : u.contexts[s.NODE]), we = c && !ve ? "motionBlur" : void 0;
        R(z, we), de ? s.drawCachedNodes(z, B.nondrag, o, ie) : s.drawLayeredElements(z, B.nondrag, o, ie), s.debug && s.drawDebugPoints(z, B.nondrag), !r && !c && (f[s.NODE] = !1);
      }
      if (!a && (f[s.DRAG] || r || se[s.DRAG])) {
        var ve = c && !se[s.DRAG] && v !== 1, z = e || (ve ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG] : u.contexts[s.DRAG]);
        R(z, c && !ve ? "motionBlur" : void 0), de ? s.drawCachedNodes(z, B.drag, o, ie) : s.drawCachedElements(z, B.drag, o, ie), s.debug && s.drawDebugPoints(z, B.drag), !r && !c && (f[s.DRAG] = !1);
      }
    ...
    Mr.drawPolygonPath = function(t, e, r, a, n, i) {
      ...
      var i = a / 2, s = n / 2, o = e - i, l = e + i, u = r - s, f = r + s, h = vi(a, n), c = h.widthOffset, v = h.heightOffset, d = h.ctrlPtOffsetPct * c;
    ...
    for (var Tu = Math.sin(0), Cu = Math.cos(0), _i = {}, Ui = {}, Du = Math.PI / 40, wa = 0 * Math.PI; wa < 2 * Math.PI; wa += Du)
      _i[wa] = Math.sin(wa), Ui[wa] = Math.cos(wa);
    Mr.drawEllipsePath = function(t, e, r, a, n) {
      if (t.beginPath && t.beginPath(), t.ellipse)
        t.ellipse(e, r, a / 2, n / 2, 0, 0, 2 * Math.PI);
      else
        for (var i, s, o = a / 2, l = n / 2, u = 0 * Math.PI; u < 2 * Math.PI; u += Du)
          i = e - o * _i[u] * Tu + o * Ui[u] * Cu, s = r + l * Ui[u] * Tu + l * _i[u] * Cu, u === 0 ? t.moveTo(i, s) : t.lineTo(i, s);
      t.closePath();
    };
    var tn = {};
    ...
    tn.png = function(t) {
      return Lu(t, this.bufferCanvasImage(t), "image/png");
    }, tn.jpg = function(t) {
      return Lu(t, this.bufferCanvasImage(t), "image/jpeg");
    };
    var Au = {};
    Au.nodeShapeImpl = function(t, e, r, a, n, i, s) {
      switch (t) {
        case "ellipse":
    ...
    function Ou(t) {
      ...
      var u = Ut(), f = function(ae) {
        ...
        return Ce;
      }, de = e.data.eleTxrCache = new ja(e, {
        getKey: v,
        ...
        isVisible: C
      }), ve = e.data.slbTxrCache = new ja(e, {
        getKey: g,
        drawElement: b,
        getBoundingBox: w,
        getRotationPoint: z,
        ...
        isVisible: C
      }), Te = e.data.lyrTxrCache = new pu(e);
      e.onUpdateEleCalcs(function(ae, xe) {
        de.invalidateElements(xe), se.invalidateElements(xe), ve.invalidateElements(xe), we.invalidateElements(xe), Te.invalidateElements(xe);
      ...
      de.onDequeue(Ee), se.onDequeue(Ee), ve.onDequeue(Ee), we.onDequeue(Ee);
    }
    ...
    }, [mu, hr, mr, Vi, _r, Ea, Wt, Mr, tn, Au].forEach(function(t) {
      Ue(ot, t);
    });
    var np = [{
      name: "null",
    ...
    function Iu(t, e, r) {
      ...
      if (t === "core") {
        ...
        var v = Ru("renderer", "base"), d = v.prototype, g = r, y = r.prototype, p = function() {
    ...
    var Yi = function() {
      ...
      if (arguments.length === 3)
        return Iu.apply(null, arguments);
      if (arguments.length === 4)
    ...
    Za.prototype.extension = Yi, ip.forEach(function(t) {
      t.extensions.forEach(function(e) {
        Iu(t.type, e.name, e.impl);
      });
    });
    var ku = function t() {
      if (!(this instanceof t))
    ...
    var up = "3.23.0", Yr = function(e) {
      if (e === void 0 && (e = {}), L(e))
        return new Za(e);
      if (j(e))
        return Yi.apply(Yi, arguments);
    };
    return Yr.use = function(t) {
      ...
      return vs(t);
    }, Yr.version = up, Yr.stylesheet = Yr.Stylesheet = ku, Yr;
  });
})(qu);
var Xp = qu.exports;
const Wu = /* @__PURE__ */ Vu(Xp);
var Ku = { exports: {} }, qi = { exports: {} }, Wi = { exports: {} }, Gu;
function qp() {
  return Gu || (Gu = 1, function(pe, fe) {
    (function(ce, H) {
      pe.exports = H();
    })(Ca, function() {
      return (
        ...
        function(ee) {
          ...
          return H.m = ee, H.c = ce, H.i = function(O) {
            return O;
          }, H.d = function(O, T, x) {
          ...
          function(ee, ce, H) {
            ...
            V.prototype.getNodes = function() {
              ...
              for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, J = T.MAX_VALUE, j = -T.MAX_VALUE, Y, te, L, $, k, q = this.nodes, he = q.length, ge = 0; ge < he; ge++) {
                var Ae = q[ge];
              ...
              for (var ne = T.MAX_VALUE, ue = -T.MAX_VALUE, J = T.MAX_VALUE, j = -T.MAX_VALUE, Y, te, L, $, k = Q.length, q = 0; q < k; q++) {
                var he = Q[q];
                Y = he.getLeft(), te = he.getRight(), L = he.getTop(), $ = he.getBottom(), ne > Y && (ne = Y), ue < te && (ue = te), J > L && (J = L), j < $ && (j = $);
              }
              var ge = new P(ne, J, ue - ne, j - J);
              return ge;
              ...
              for (te.forEach(function(ge) {
                ne.push(ge), ue.add(ge);
              }); ne.length !== 0; ) {
              ...
              if (this.isConnected = !1, ue.size >= this.nodes.length) {
                ...
                ue.forEach(function(ge) {
                  ge.owner == Q && he++;
                }), he == this.nodes.length && (this.isConnected = !0);
              }
            }, ee.exports = V;
          },
          /* 6 */
          ...
          function(ee, ce, H) {
            ...
            T.calcSeparationAmount = function(x, S, G, U) {
              ...
              var V = x.getX(), _ = x.getY(), Q = x.getRight(), ne = x.getX(), ue = x.getBottom(), J = x.getRight(), j = x.getWidthHalf(), Y = x.getHeightHalf(), te = S.getX(), L = S.getY(), $ = S.getRight(), k = S.getX(), q = S.getBottom(), he = S.getRight(), ge = S.getWidthHalf(), Ae = S.getHeightHalf(), Ne = !1, _e = !1;
              if (U === K) {
                if (P > D)
                ...
                if (-tt === Pe ? U > K ? (G[0] = ne, G[1] = ue, Ne = !0) : (G[0] = Q, G[1] = _, Ne = !0) : tt === Pe && (U > K ? (G[0] = V, G[1] = _, Ne = !0) : (G[0] = J, G[1] = ue, Ne = !0)), -ct === Pe ? K > U ? (G[2] = k, G[3] = q, _e = !0) : (G[2] = $, G[3] = L, _e = !0) : ct === Pe && (K > U ? (G[2] = te, G[3] = L, _e = !0) : (G[2] = he, G[3] = q, _e = !0)), Ne && _e)
                  return !1;
                ...
                if (!_e)
                  switch (Xe) {
                    case 1:
                      ...
                      break;
                    case 2:
                      nt = he, je = D + ge * Pe, G[2] = nt, G[3] = je;
                      break;
                    case 3:
                      je = q, nt = K + Ae / Pe, G[2] = nt, G[3] = je;
                      break;
                    case 4:
                      nt = k, je = D + -ge * Pe, G[2] = nt, G[3] = je;
                      break;
                  }
              }
              return !1;
              ...
              var P = x.x, K = x.y, D = S.x, V = S.y, _ = G.x, Q = G.y, ne = U.x, ue = U.y, J = void 0, j = void 0, Y = void 0, te = void 0, L = void 0, $ = void 0, k = void 0, q = void 0, he = void 0;
              return Y = V - K, L = P - D, k = D * K - P * V, te = ue - Q, $ = _ - ne, q = ne * Q - _ * ue, he = Y * $ - te * L, he === 0 ? null : (J = (L * q - $ * k) / he, j = (te * k - Y * q) / he, new O(J, j));
      ...
      return (
        ...
        function(ce) {
          ...
          function O(T) {
            ...
            return ce[T].call(x.exports, x, x.exports, O), x.l = !0, x.exports;
          }
          return O.m = ce, O.c = H, O.i = function(T) {
            return T;
          }, O.d = function(T, x, S) {
          ...
          function(ce, H, O) {
            ...
            for (var S in T)
              x[S] = T[S];
            x.DEFAULT_USE_MULTI_LEVEL_SCALING = !1, x.DEFAULT_RADIAL_SEPARATION = T.DEFAULT_EDGE_LENGTH, x.DEFAULT_COMPONENT_SEPERATION = 60, x.TILE = !0, x.TILING_PADDING_VERTICAL = 10, x.TILING_PADDING_HORIZONTAL = 10, x.TREE_REDUCTION_ON_INCREMENTAL = !1, ce.exports = x;
          },
          /* 2 */
          /***/
          function(ce, H, O) {
          ...
          function(ce, H, O) {
            ...
            Y.prototype.newGraphManager = function() {
              ...
              if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                if (P.TREE_REDUCTION_ON_INCREMENTAL) {
                  ...
                  var $ = new Set(this.getAllNodes()), k = this.nodesWithGravity.filter(function(ge) {
                    return $.has(ge);
                  });
              ...
              if (this.isTreeGrowing) {
                if (this.growTreeIterations % 10 == 0)
                  if (this.prunedNodesAll.length > 0) {
                    ...
                    var L = new Set(this.getAllNodes()), $ = this.nodesWithGravity.filter(function(he) {
                      return L.has(he);
                    });
              ...
              var L = [], $, k = this.graphManager.getGraphs(), q = k.length, he;
              for (he = 0; he < q; he++)
                $ = k[he], $.updateConnected(), $.isConnected || (L = L.concat($.getNodes()));
              return L;
              ...
              for (k = 0; k < L.length; k++) {
                var q = L[k];
                if (!$.has(q)) {
                  var he = q.getSource(), ge = q.getTarget();
                  if (he == ge)
                    q.getBendpoints().push(new _()), q.getBendpoints().push(new _()), this.createDummyNodesForBendpoints(q), $.add(q);
                  else {
                    var Ae = [];
                    if (Ae = Ae.concat(he.getEdgeListToNode(ge)), Ae = Ae.concat(ge.getEdgeListToNode(he)), !$.has(Ae[0])) {
                      if (Ae.length > 1) {
                        var Ne;
              ...
              for (var $ = new V(0, 0), k = Math.ceil(Math.sqrt(L.length)), q = 0, he = 0, ge = 0, Ae = new _(0, 0), Ne = 0; Ne < L.length; Ne++) {
                Ne % k == 0 && (ge = 0, he = q, Ne != 0 && (he += P.DEFAULT_COMPONENT_SEPERATION), q = 0);
                var _e = L[Ne], tt = Q.findCenterOfTree(_e);
                $.x = ge, $.y = he, Ae = Y.radialLayout(_e, tt, $), Ae.y > q && (q = Math.floor(Ae.y)), ge = Math.floor(Ae.x + P.DEFAULT_COMPONENT_SEPERATION);
              }
              ...
              var he = J.calculateBounds(L), ge = new j();
              ge.setDeviceOrgX(he.getMinX()), ge.setDeviceOrgY(he.getMinY()), ge.setWorldOrgX(k.x), ge.setWorldOrgY(k.y);
              for (var Ae = 0; Ae < L.length; Ae++) {
                var Ne = L[Ae];
                Ne.transform(ge);
              }
              var _e = new _(he.getMaxX(), he.getMaxY());
              return ge.inverseTransformPoint(_e);
            }, Y.branchRadialLayout = function(L, $, k, q, he, ge) {
              var Ae = (q - k + 1) / 2;
              Ae < 0 && (Ae += 180);
              var Ne = (Ae + k) % 360, _e = Ne * ue.TWO_PI / 360, tt = he * Math.cos(_e), ct = he * Math.sin(_e);
              L.setCenter(tt, ct);
              var Pe = [];
              ...
              for (var Et = Math.abs(q - k) / $e, kt = lt; Xe != $e; kt = ++kt % rt) {
                ...
                if (vt != $) {
                  ...
                  Y.branchRadialLayout(vt, L, vr, qt, he + ge, ge), Xe++;
                }
              }
            }, Y.maxDiagonalInTree = function(L) {
              for (var $ = ne.MIN_VALUE, k = 0; k < L.length; k++) {
                var q = L[k], he = q.getDiagonal();
                he > $ && ($ = he);
              }
              return $;
              ...
              for (var k = [], q = this.graphManager.getAllNodes(), he = 0; he < q.length; he++) {
                var ge = q[he], Ae = ge.getParent();
                this.getNodeDegreeWithChildren(ge) === 0 && (Ae.id == null || !this.getToBeTiled(Ae)) && k.push(ge);
              }
              for (var he = 0; he < k.length; he++) {
                var ge = k[he], Ne = ge.getParent().id;
                typeof $[Ne] > "u" && ($[Ne] = []), $[Ne] = $[Ne].concat(ge);
              }
              ...
              for (var L = this.compoundOrder.length - 1; L >= 0; L--) {
                var $ = this.compoundOrder[L], k = $.id, q = $.paddingLeft, he = $.paddingTop;
                this.adjustLocations(this.tiledMemberPack[k], $.rect.x, $.rect.y, q, he);
              }
            }, Y.prototype.repopulateZeroDegreeMembers = function() {
              var L = this, $ = this.tiledZeroDegreePack;
              Object.keys($).forEach(function(k) {
                var q = L.idToDummyNode[k], he = q.paddingLeft, ge = q.paddingTop;
                L.adjustLocations($[k], q.rect.x, q.rect.y, he, ge);
              });
              ...
              for (var q = k.getNodes(), he = 0; he < q.length; he++) {
                var ge = q[he];
                if (this.getNodeDegree(ge) > 0)
                  return this.toBeTiled[$] = !1, !1;
                if (ge.getChild() == null) {
                  this.toBeTiled[ge.id] = !1;
                  continue;
                }
                if (!this.getToBeTiled(ge))
                  return this.toBeTiled[$] = !1, !1;
              }
              ...
              for (var $ = L.getEdges(), k = 0, q = 0; q < $.length; q++) {
                var he = $[q];
                he.getSource().id !== he.getTarget().id && (k = k + 1);
              }
              return k;
              ...
              for (var k = L.getChild().getNodes(), q = 0; q < k.length; q++) {
                var he = k[q];
                $ += this.getNodeDegreeWithChildren(he);
              }
              return $;
            ...
            }, Y.prototype.adjustLocations = function(L, $, k, q, he) {
              $ += q, k += he;
              for (var ge = $, Ae = 0; Ae < L.rows.length; Ae++) {
                var Ne = L.rows[Ae];
                $ = ge;
              ...
              this.tiledMemberPack = [], Object.keys(L).forEach(function(q) {
                var he = $[q];
                k.tiledMemberPack[q] = k.tileNodes(L[q], he.paddingLeft + he.paddingRight), he.rect.width = k.tiledMemberPack[q].width, he.rect.height = k.tiledMemberPack[q].height;
              });
            }, Y.prototype.tileNodes = function(L, $) {
              var k = P.TILING_PADDING_VERTICAL, q = P.TILING_PADDING_HORIZONTAL, he = {
                rows: [],
                rowWidth: [],
                rowHeight: [],
                width: 0,
              ...
              for (var ge = 0; ge < L.length; ge++) {
                var Ae = L[ge];
                he.rows.length == 0 ? this.insertNodeToRow(he, Ae, 0, $) : this.canAddHorizontal(he, Ae.rect.width, Ae.rect.height) ? this.insertNodeToRow(he, Ae, this.getShortestRowIndex(he), $) : this.insertNodeToRow(he, Ae, he.rows.length, $), this.shiftToLastRow(he);
              }
              return he;
              ...
              if (k == L.rows.length) {
                var ge = [];
                L.rows.push(ge), L.rowWidth.push(he), L.rowHeight.push(0);
              }
              ...
              if (q < 0)
                return !0;
              var he = L.rowWidth[q];
              if (he + L.horizontalPadding + $ <= L.width)
                return !0;
              var ge = 0;
              L.rowHeight[q] < k && q > 0 && (ge = k + L.verticalPadding - L.rowHeight[q]);
              var Ae;
              L.width - he >= $ + L.horizontalPadding ? Ae = (L.height + ge) / (he + $ + L.horizontalPadding) : Ae = (L.height + ge) / L.width, ge = k + L.verticalPadding;
              var Ne;
              return L.width < $ ? Ne = (L.height + ge) / $ : Ne = (L.height + ge) / L.width, Ne < 1 && (Ne = 1 / Ne), Ae < 1 && (Ae = 1 / Ae), Ae < Ne;
            }, Y.prototype.shiftToLastRow = function(L) {
              var $ = this.getLongestRowIndex(L), k = L.rowWidth.length - 1, q = L.rows[$], he = q[q.length - 1], ge = he.width + L.horizontalPadding;
              if (L.width - L.rowWidth[k] > ge && $ != k) {
                q.splice(-1, 1), L.rows[k].push(he), L.rowWidth[$] = L.rowWidth[$] - ge, L.rowWidth[k] = L.rowWidth[k] + ge, L.width = L.rowWidth[instance.getLongestRowIndex(L)];
                ...
                L.rowHeight[$] = Ae, L.rowHeight[k] < he.height + L.verticalPadding && (L.rowHeight[k] = he.height + L.verticalPadding);
              ...
              for (var L = [], $ = !0, k; $; ) {
                var q = this.graphManager.getAllNodes(), he = [];
                $ = !1;
                for (var ge = 0; ge < q.length; ge++)
                  k = q[ge], k.getEdges().length == 1 && !k.getEdges()[0].isInterGraph && k.getChild() == null && (he.push([k, k.getEdges()[0], k.getOwner()]), $ = !0);
                if ($ == !0) {
                  for (var Ae = [], Ne = 0; Ne < he.length; Ne++)
                    he[Ne][0].getEdges().length == 1 && (Ae.push(he[Ne]), he[Ne][0].getOwner().remove(he[Ne][0]));
              ...
              for (var $ = L.length, k = L[$ - 1], q, he = 0; he < k.length; he++)
                q = k[he], this.findPlaceforPrunedNode(q), q[2].add(q[0]), q[2].add(q[1], q[1].source, q[1].target);
              ...
              var he = k.startX, ge = k.finishX, Ae = k.startY, Ne = k.finishY, _e = 0, tt = 0, ct = 0, Pe = 0, $e = [_e, ct, tt, Pe];
              if (Ae > 0)
                for (var Xe = he; Xe <= ge; Xe++)
                  $e[0] += this.grid[Xe][Ae - 1].length + this.grid[Xe][Ae].length - 1;
              if (ge < this.grid.length - 1)
                for (var Xe = Ae; Xe <= Ne; Xe++)
                  $e[1] += this.grid[ge + 1][Xe].length + this.grid[ge][Xe].length - 1;
              if (Ne < this.grid[0].length - 1)
                for (var Xe = he; Xe <= ge; Xe++)
                  $e[2] += this.grid[Xe][Ne + 1].length + this.grid[Xe][Ne].length - 1;
              if (he > 0)
                for (var Xe = Ae; Xe <= Ne; Xe++)
                  $e[3] += this.grid[he - 1][Xe].length + this.grid[he][Xe].length - 1;
          ...
          function(ce, H, O) {
            var T = {};
            T.layoutBase = O(0), T.CoSEConstants = O(1), T.CoSEEdge = O(2), T.CoSEGraph = O(3), T.CoSEGraphManager = O(4), T.CoSELayout = O(6), T.CoSENode = O(5), ce.exports = T;
          }
          /******/
        ])
      );
        ...
        function(ce, H, O) {
          ...
          _.prototype.run = function() {
            ...
            for (var q = 0; q < k.length; q++) {
              var he = k[q], ge = this.idToLNode[he.data("source")], Ae = this.idToLNode[he.data("target")];
              if (ge !== Ae && ge.getEdgesBetween(Ae).length == 0) {
                var Ne = L.add(Y.newEdge(), ge, Ae);
                Ne.id = he.id();
              }
            }
            ...
            for (var Y = J.length, te = 0; te < Y; te++) {
              ...
              if (L.outerWidth() != null && L.outerHeight() != null ? k = ue.add(new U(j.graphManager, new P(L.position("x") - q.w / 2, L.position("y") - q.h / 2), new K(parseFloat(q.w), parseFloat(q.h)))) : k = ue.add(new U(this.graphManager)), k.id = L.data("id"), k.paddingLeft = parseInt(L.css("padding")), k.paddingTop = parseInt(L.css("padding")), k.paddingRight = parseInt(L.css("padding")), k.paddingBottom = parseInt(L.css("padding")), this.options.nodeDimensionsIncludeLabels && L.isParent()) {
                var he = L.boundingBox({ includeLabels: !0, includeNodes: !1 }).w, ge = L.boundingBox({ includeLabels: !0, includeNodes: !1 }).h, Ae = L.css("text-halign");
                k.labelWidth = he, k.labelHeight = ge, k.labelPos = Ae;
              }
...
var Kp = Ku.exports;
const Zp = /* @__PURE__ */ Vu(Kp);
Wu.use(Zp);
function Zu(pe, fe, ee, ce) {
  Xu.drawNode(pe, fe, ee, ce), fe.children && fe.children.forEach((H, O) => {
    Zu(pe, H, ee < 0 ? O : ee, ce);
  });
}
function Qp(pe, fe) {
  fe.edges().map((ee, ce) => {
    ...
    if (ee[0]._private.bodyBounds) {
      ...
      qr.trace("Edge: ", ce, H), pe.insert("path").attr(
        "d",
...
function Jp(pe, fe) {
  return new Promise((ee) => {
    const ce = ei("body").append("div").attr("id", "cy").attr("style", "display:none"), H = Wu({
    ...
    ce.remove(), Qu(pe, H, fe, 0), H.nodes().forEach(function(O) {
      O.layoutDimensions = () => {
        const T = O.data();
...
function jp(pe) {
  pe.nodes().map((fe, ee) => {
    const ce = fe.data();
    ce.x = fe.position().x, ce.y = fe.position().y, Xu.positionNode(ce);
    const H = Qi(ce.nodeId);
    qr.info("Id:", ee, "Position: (", fe.position().x, ", ", fe.position().y, ")", ce), H.attr(
      "transform",
      `translate(${fe.position().x - ce.width / 2}, ${fe.position().y - ce.height / 2})`
    ), H.attr("attr", `apa-${ee})`);
  });
}
const ey = async (pe, fe, ee, ce) => {
  const H = nn();
  H.htmlLabels = !1, qr.debug(`Rendering mindmap diagram
` + pe, ce.parser);
  ...
  S.append("g");
  const G = ce.db.getMindmap(), U = S.append("g");
  U.attr("class", "mindmap-edges");
  const P = S.append("g");
  P.attr("class", "mindmap-nodes"), Zu(P, G, -1, H);
  const K = await Jp(G, H);
  Qp(U, K), jp(K), bp(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
}, ty = {
  draw: ey
}, ry = (pe) => {
  let fe = "";
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++)
    pe["lineColor" + ee] = pe["lineColor" + ee] || pe["cScaleInv" + ee], Ep(pe["lineColor" + ee]) ? pe["lineColor" + ee] = wp(pe["lineColor" + ee], 20) : pe["lineColor" + ee] = xp(pe["lineColor" + ee], 20);
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++) {
    const ce = "" + (17 - 3 * ee);
    fe += `
