...
var Yt = function() {
  var e = function(bt, _, x, m) {
    ...
    parse: function(_) {
      var x = this, m = [0], g = [], T = [null], h = [], Tt = this.table, y = "", Et = 0, se = 0, Ee = 2, ae = 1, ke = h.slice.call(arguments, 1), D = Object.create(this.lexer), kt = { yy: {} };
      ...
      for (var M, At, N, qt, vt = {}, Mt, z, re, Lt; ; ) {
        if (At = m[m.length - 1], this.defaultActions[At] ? N = this.defaultActions[At] : ((M === null || typeof M > "u") && (M = Ce()), N = Tt[At] && Tt[At][M]), typeof N > "u" || !N.length || !N[0]) {
          var Gt = "";
          Lt = [];
          for (Mt in Tt[At])
...
}, Qe = function(e, t, r, o, l, n, a, s, i, u, d) {
...
class ge {
  ...
  insert(t) {
    ...
    (r >= this.data.widthLimit || o >= this.data.widthLimit || this.nextData.cnt > ye) && (r = this.nextData.startx + t.margin + b.nextLinePaddingX, l = this.nextData.stopy + t.margin * 2, this.nextData.stopx = o = r + t.width, this.nextData.starty = this.nextData.stopy, this.nextData.stopy = n = l + t.height, this.nextData.cnt = 1), t.x = r, t.y = l, this.updateVal(this.data, "startx", r, Math.min), this.updateVal(this.data, "starty", l, Math.min), this.updateVal(this.data, "stopx", o, Math.max), this.updateVal(this.data, "stopy", n, Math.max), this.updateVal(this.nextData, "startx", r, Math.min), this.updateVal(this.nextData, "starty", l, Math.min), this.updateVal(this.nextData, "stopx", o, Math.max), this.updateVal(this.nextData, "stopy", n, Math.max);
  }
  init(t) {
    this.name = "", this.data = {
      startx: void 0,
...
const C0 = function(e, t, r, o) {
  ...
  for (let n of t) {
    ...
    let d = r(n.from), f = r(n.to), p = A0(d, f);
...
const v0 = function(e, t, r, o) {
  ...
  let s = o.db;
  o.db.setWrap(b.wrap), ye = s.getC4ShapeInRow(), Zt = s.getC4BoundaryInRow(), le.debug(`C:${JSON.stringify(b, null, 2)}`);
  ...
  xe(i, "", u, f, o), F.insertArrowHead(i), F.insertArrowEnd(i), F.insertArrowCrossHead(i), F.insertArrowFilledHead(i), C0(i, o.db.getRels(), o.db.getC4Shape, o), u.data.stopx = Ut, u.data.stopy = Ft;
  const p = u.data;
  let O = p.stopy - p.starty + 2 * b.diagramMarginY;
  const S = p.stopx - p.startx + 2 * b.diagramMarginX;
  d && i.append("text").text(d).attr("x", (p.stopx - p.startx) / 2 - 4 * b.diagramMarginX).attr("y", p.starty + b.diagramMarginY), Se(i, O, S, b.useMaxWidth);
  const L = d ? 60 : 0;
  i.attr(
    "viewBox",
