import { d as Xe, c as F, G as ye, s as We, g as qe, a as He, b as Je, B as Ze, D as $e, f as v, E as et, l as tt, z as Pe, j as U } from "./mermaid-5f2d2ec5.js";
var De = function() {
...
const R = (e) => v.sanitizeText(e, F()), P = function(e) {
  ...
  tt.debug("Adding relation: " + JSON.stringify(e)), se(e.id1), se(e.id2), e.id1 = P(e.id1).className, e.id2 = P(e.id2).className, e.relationTitle1 = v.sanitizeText(
    e.relationTitle1.trim(),
    F()
  ), e.relationTitle2 = v.sanitizeText(
