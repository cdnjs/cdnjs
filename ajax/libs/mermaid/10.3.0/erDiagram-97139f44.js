import { c as V, s as xt, g as Rt, b as Ot, a as bt, B as Nt, D as Tt, m as At, l as et, E as Mt, j as st, z as vt, k as Dt, F as wt, G as It } from "./mermaid-42f7bf2b.js";
import { G as St, l as Lt } from "./layout-c5a37d74.js";
import { l as Bt } from "./line-ce5d1152.js";
  ...
  var t = function(M, a, l, d) {
    ...
    parse: function(a) {
      ...
      for (var D, H, L, at, K = {}, $, F, ut, tt; ; ) {
        if (H = d[d.length - 1], this.defaultActions[H] ? L = this.defaultActions[H] : ((D === null || typeof D > "u") && (D = kt()), L = Q[H] && Q[H][D]), typeof L > "u" || !L.length || !L[0]) {
          var nt = "";
          tt = [];
          for ($ in Q[H])
...
Expecting ` + tt.join(", ") + ", got '" + (this.terminals_[D] || D) + "'" : nt = "Parse error on line " + (J + 1) + ": Unexpected " + (D == dt ? "end of input" : "'" + (this.terminals_[D] || D) + "'"), this.parseError(nt, {
        ...
        if (L[0] instanceof Array && L.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + H + ", token: " + D);
        switch (L[0]) {
          case 1:
