import {
  version
} from "./chunks/mermaid.esm/chunk-ZIY44AE2.mjs";
import {
  selectSvgElement
} from "./chunks/mermaid.esm/chunk-VNRP4OIW.mjs";
import {
  registerLayoutLoaders
} from "./chunks/mermaid.esm/chunk-M7N4Q5GZ.mjs";
import "./chunks/mermaid.esm/chunk-C6CSAIDW.mjs";
import "./chunks/mermaid.esm/chunk-KW7S66XI.mjs";
import {
  dedent
} from "./chunks/mermaid.esm/chunk-YP6PVJQ3.mjs";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
  ...
  removeDirectives,
  utils_default
} from "./chunks/mermaid.esm/chunk-I7ZFS43C.mjs";
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunks/mermaid.esm/chunk-DD37ZF33.mjs";
import {
  isEmpty_default
...
var loader = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/c4Diagram-JXFYNHDU.mjs");
...
var loader2 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/flowDiagram-67NZXU7I.mjs");
...
var loader4 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/erDiagram-XPQADTZV.mjs");
...
var loader5 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/gitGraphDiagram-L4TVWIEC.mjs");
...
var loader6 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/ganttDiagram-B2ZMZPXB.mjs");
...
var loader7 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/infoDiagram-BT4ZP4BK.mjs");
...
var loader8 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/pieDiagram-S3RQDLUV.mjs");
...
var loader9 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/quadrantDiagram-5GZ6ANOP.mjs");
...
var loader10 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/xychartDiagram-LJ63XVUT.mjs");
...
var loader11 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/requirementDiagram-VSKUXUHY.mjs");
...
var loader12 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/sequenceDiagram-OCNP7Z2K.mjs");
...
var loader13 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/classDiagram-CXGEL3SQ.mjs");
...
var loader14 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/classDiagram-v2-YNGOW5FH.mjs");
...
var loader15 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/stateDiagram-ERABNXIO.mjs");
...
var loader16 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/stateDiagram-v2-VU32QY5R.mjs");
...
var loader17 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/journeyDiagram-COMCLUAH.mjs");
...
var loader19 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/timeline-definition-3FLJNPJ3.mjs");
...
var loader20 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/mindmap-definition-E2KP2TZY.mjs");
...
var loader21 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/sankeyDiagram-H4IPBKTF.mjs");
...
var loader22 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/diagram-JJFYOK3T.mjs");
...
var loader23 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await import("./chunks/mermaid.esm/blockDiagram-PSHTR7TV.mjs");
...
var loadRegisteredDiagrams = /* @__PURE__ */ __name(async () => {
  ...
  const results = await Promise.allSettled(
    Object.entries(detectors).map(async ([key, { detector: detector24, loader: loader25 }]) => {
      if (loader25) {
        try {
          getDiagram(key);
        } catch {
          try {
            const { diagram: diagram2, id: id24 } = await loader25();
            registerDiagram(id24, diagram2, detector24);
          } catch (err) {
...
var load = loader24.load;
var loadAll = loader24.loadAll;
...
var appendDivSvgG = /* @__PURE__ */ __name((parentRoot, id24, enclosingDivId, divStyle, svgXlink) => {
  const enclosingDiv = parentRoot.append("div");
  enclosingDiv.attr("id", enclosingDivId);
  if (divStyle) {
    enclosingDiv.attr("style", divStyle);
  }
  const svgNode = enclosingDiv.append("svg").attr("id", id24).attr("width", "100%").attr("xmlns", XMLNS_SVG_STD);
  if (svgXlink) {
...
var removeExistingElements = /* @__PURE__ */ __name((doc, id24, divId, iFrameId) => {
  doc.getElementById(id24)?.remove();
  doc.getElementById(divId)?.remove();
  doc.getElementById(iFrameId)?.remove();
}, "removeExistingElements");
var render = /* @__PURE__ */ __name(async function(id24, text, svgContainingElement) {
  addDiagrams();
  ...
  const idSelector = "#" + id24;
  const iFrameID = "i" + id24;
  const iFrameID_selector = "#" + iFrameID;
  const enclosingDivID = "d" + id24;
  ...
  if (svgContainingElement !== void 0) {
    ...
    appendDivSvgG(root, id24, enclosingDivID, `font-family: ${fontFamily}`, XMLNS_XLINK_STD);
  } else {
    removeExistingElements(document, id24, enclosingDivID, iFrameID);
    if (isSandboxed) {
    ...
    appendDivSvgG(root, id24, enclosingDivID);
  }
  let diag;
  ...
  try {
    await diag.renderer.draw(text, id24, version, diag);
  } catch (e) {
    if (config.suppressErrorRendering) {
      removeTempElements();
    } else {
      errorRenderer_default.draw(text, id24, version);
    }
    throw e;
  }
  ...
  root.select(`[id="${id24}"]`).selectAll("foreignobject > *").attr("xmlns", XMLNS_XHTML_STD);
...
var runThrowsErrors = /* @__PURE__ */ __name(async function({ postRenderCallback, querySelector, nodes } = {
  ...
  for (const element of Array.from(nodesToProcess)) {
    ...
    const id24 = `mermaid-${idGenerator.next()}`;
    ...
    try {
      const { svg, bindFunctions } = await render2(id24, txt, element);
      element.innerHTML = svg;
      if (postRenderCallback) {
        await postRenderCallback(id24);
      }
      if (bindFunctions) {
...
var render2 = /* @__PURE__ */ __name((id24, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = /* @__PURE__ */ __name(() => new Promise((res, rej) => {
      mermaidAPI.render(id24, text, container).then(
        (r) => {
          res(r);
          resolve(r);
        },
