...
const fs = "10.5.0", si = Object.freeze(dp);
...
const vr = (t, e) => {
  ...
  const { diagram: t } = await import("./c4Diagram-be6d31b5.js");
  ...
  const { diagram: t } = await import("./flowDiagram-2527b41f.js");
  ...
  const { diagram: t } = await import("./flowDiagram-v2-596664fa.js");
  ...
  const { diagram: t } = await import("./erDiagram-5298a456.js");
  ...
  const { diagram: t } = await import("./gitGraphDiagram-0775767f.js");
  ...
  const { diagram: t } = await import("./ganttDiagram-9d08f276.js");
  ...
  const { diagram: t } = await import("./infoDiagram-121d662e.js");
  ...
  const { diagram: t } = await import("./pieDiagram-eb4af4ec.js");
  ...
  const { diagram: t } = await import("./quadrantDiagram-d3fede19.js");
  ...
  const { diagram: t } = await import("./requirementDiagram-3865c41f.js");
  ...
  const { diagram: t } = await import("./sequenceDiagram-a000a341.js");
  ...
  const { diagram: t } = await import("./classDiagram-ad76bf5a.js");
  ...
  const { diagram: t } = await import("./classDiagram-v2-6e58f5b0.js");
  return { id: Cl, diagram: t };
}, Z_ = {
  id: Cl,
  detector: X_,
  ...
  const { diagram: t } = await import("./stateDiagram-c0051853.js");
  ...
  const { diagram: t } = await import("./stateDiagram-v2-056072cc.js");
  ...
  const { diagram: t } = await import("./journeyDiagram-943d6037.js");
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-8cd0f1e2.js");
  ...
  const { diagram: t } = await import("./timeline-definition-5dc05eb7.js");
  ...
  const { diagram: t } = await import("./mindmap-definition-5c6cc2b2.js");
  return { id: Bl, diagram: t };
}, Ly = {
  id: Bl,
  detector: By,
  ...
  const { diagram: t } = await import("./sankeyDiagram-f71fea45.js");
  return { id: Fl, diagram: t };
}, Oy = {
  id: Fl,
  detector: Ey,
