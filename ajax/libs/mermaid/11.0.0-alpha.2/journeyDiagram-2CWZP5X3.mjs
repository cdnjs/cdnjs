...
`,"getStyles"),vt=Yt;import{select as et}from"d3";import{arc as wt}from"d3";var tt=o(function(t,e){return gt(t,e)},"drawRect"),Ot=o(function(t,e){let s=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),r=t.append("g");r.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),r.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function u(p){let k=wt().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);p.append("path").attr("class","mouth").attr("d",k).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}o(u,"smile");function c(p){let k=wt().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);p.append("path").attr("class","mouth").attr("d",k).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}o(c,"sad");function f(p){p.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return o(f,"ambivalent"),e.score>3?u(r):e.score<3?c(r):f(r),s},"drawFace"),St=o(function(t,e){let i=t.append("circle");return i.attr("cx",e.cx),i.attr("cy",e.cy),i.attr("class","actor-"+e.pos),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("r",e.r),i.class!==void 0&&i.attr("class",i.class),e.title!==void 0&&i.append("title").text(e.title),i},"drawCircle"),Mt=o(function(t,e){return xt(t,e)},"drawText"),qt=o(function(t,e){function i(r,u,c,f,p){return r+","+u+" "+(r+c)+","+u+" "+(r+c)+","+(u+f-p)+" "+(r+c-p*1.2)+","+(u+f)+" "+r+","+(u+f)}o(i,"genPoints");let s=t.append("polygon");s.attr("points",i(e.x,e.y,50,20,7)),s.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,Mt(t,e)},"drawLabel"),Wt=o(function(t,e,i){let s=t.append("g"),r=Z();r.x=e.x,r.y=e.y,r.fill=e.fill,r.width=i.width*e.taskCount+i.diagramMarginX*(e.taskCount-1),r.height=i.height,r.class="journey-section section-type-"+e.num,r.rx=3,r.ry=3,tt(s,r),$t(i)(e.text,s,r.x,r.y,r.width,r.height,{class:"journey-section section-type-"+e.num},i,e.colour)},"drawSection"),Tt=-1,Xt=o(function(t,e,i){let s=e.x+i.width/2,r=t.append("g");Tt++;let u=300+5*30;r.append("line").attr("id","task"+Tt).attr("x1",s).attr("y1",e.y).attr("x2",s).attr("y2",u).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Ot(r,{cx:s,cy:300+(5-e.score)*30,score:e.score});let c=Z();c.x=e.x,c.y=e.y,c.fill=e.fill,c.width=i.width,c.height=i.height,c.class="task task-type-"+e.num,c.rx=3,c.ry=3,tt(r,c);let f=e.x+14;e.people.forEach(p=>{let k=e.actors[p].color,x={cx:f,cy:e.y,r:7,fill:k,stroke:"#000",title:p,pos:e.actors[p].position};St(r,x),f+=10}),$t(i)(e.task,r,c.x,c.y,c.width,c.height,{class:"task"},i,e.colour)},"drawTask"),Gt=o(function(t,e){mt(t,e)},"drawBackgroundRect"),$t=function(){function t(r,u,c,f,p,k,x,m){let y=u.append("text").attr("x",c+p/2).attr("y",f+k/2+5).style("font-color",m).style("text-anchor","middle").text(r);s(y,x)}o(t,"byText");function e(r,u,c,f,p,k,x,m,y){let{taskFontSize:S,taskFontFamily:v}=m,_=r.split(/<br\s*\/?>/gi);for(let n=0;n<_.length;n++){let a=n*S-S*(_.length-1)/2,h=u.append("text").attr("x",c+p/2).attr("y",f).attr("fill",y).style("text-anchor","middle").style("font-size",S).style("font-family",v);h.append("tspan").attr("x",c+p/2).attr("dy",a).text(_[n]),h.attr("y",f+k/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),s(h,x)}}o(e,"byTspan");function i(r,u,c,f,p,k,x,m){let y=u.append("switch"),v=y.append("foreignObject").attr("x",c).attr("y",f).attr("width",p).attr("height",k).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");v.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(r),e(r,y,c,f,p,k,x,m),s(v,x)}o(i,"byFo");function s(r,u){for(let c in u)c in u&&r.attr(c,u[c])}return o(s,"_setTextAttrs"),function(r){return r.textPlacement==="fo"?i:r.textPlacement==="old"?t:e}}(),Ht=o(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics"),N={drawRect:tt,drawCircle:St,drawSection:Wt,drawText:Mt,drawLabel:qt,drawTask:Xt,drawBackgroundRect:Gt,initGraphics:Ht};var Ut=o(function(t){Object.keys(t).forEach(function(i){q[i]=t[i]})},"setConf"),A={};function Zt(t){let e=P().journey,i=60;Object.keys(A).forEach(s=>{let r=A[s].color,u={cx:20,cy:i,r:7,fill:r,stroke:"#000",pos:A[s].position};N.drawCircle(t,u);let c={x:40,y:i+7,fill:"#666",text:s,textMargin:e.boxTextMargin|5};N.drawText(t,c),i+=20})}o(Zt,"drawActorLegend");var q=P().journey,F=q.leftMargin,Jt=o(function(t,e,i,s){let r=P().journey,u=P().securityLevel,c;u==="sandbox"&&(c=et("#i"+e));let f=u==="sandbox"?et(c.nodes()[0].contentDocument.body):et("body");E.init();let p=f.select("#"+e);N.initGraphics(p);let k=s.db.getTasks(),x=s.db.getDiagramTitle(),m=s.db.getActors();for(let a in A)delete A[a];let y=0;m.forEach(a=>{A[a]={color:r.actorColours[y%r.actorColours.length],position:y},y++}),Zt(p),E.insert(0,0,F,Object.keys(A).length*50),Kt(p,k,0);let S=E.getBounds();x&&p.append("text").text(x).attr("x",F).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);let v=S.stopy-S.starty+2*r.diagramMarginY,_=F+S.stopx+2*r.diagramMarginX;lt(p,v,_,r.useMaxWidth),p.append("line").attr("x1",F).attr("y1",r.height*4).attr("x2",_-F-4).attr("y2",r.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let n=x?70:0;p.attr("viewBox",`${S.startx} -25 ${_} ${v+n}`),p.attr("preserveAspectRatio","xMinYMin meet"),p.attr("height",v+n+25)},"draw"),E={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},updateVal:function(t,e,i,s){t[e]===void 0?t[e]=i:t[e]=s(i,t[e])},updateBounds:function(t,e,i,s){let r=P().journey,u=this,c=0;function f(p){return o(function(x){c++;let m=u.sequenceItems.length-c+1;u.updateVal(x,"starty",e-m*r.boxMargin,Math.min),u.updateVal(x,"stopy",s+m*r.boxMargin,Math.max),u.updateVal(E.data,"startx",t-m*r.boxMargin,Math.min),u.updateVal(E.data,"stopx",i+m*r.boxMargin,Math.max),p!=="activation"&&(u.updateVal(x,"startx",t-m*r.boxMargin,Math.min),u.updateVal(x,"stopx",i+m*r.boxMargin,Math.max),u.updateVal(E.data,"starty",e-m*r.boxMargin,Math.min),u.updateVal(E.data,"stopy",s+m*r.boxMargin,Math.max))},"updateItemBounds")}o(f,"updateFn"),this.sequenceItems.forEach(f())},insert:function(t,e,i,s){let r=Math.min(t,i),u=Math.max(t,i),c=Math.min(e,s),f=Math.max(e,s);this.updateVal(E.data,"startx",r,Math.min),this.updateVal(E.data,"starty",c,Math.min),this.updateVal(E.data,"stopx",u,Math.max),this.updateVal(E.data,"stopy",f,Math.max),this.updateBounds(r,c,u,f)},bumpVerticalPos:function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},getVerticalPos:function(){return this.verticalPos},getBounds:function(){return this.data}},rt=q.sectionFills,Et=q.sectionColours,Kt=o(function(t,e,i){let s=P().journey,r="",u=s.height*2+s.diagramMarginY,c=i+u,f=0,p="#CCC",k="black",x=0;for(let[m,y]of e.entries()){if(r!==y.section){p=rt[f%rt.length],x=f%rt.length,k=Et[f%Et.length];let v=0,_=y.section;for(let a=m;a<e.length&&e[a].section==_;a++)v=v+1;let n={x:m*s.taskMargin+m*s.width+F,y:50,text:y.section,fill:p,num:x,colour:k,taskCount:v};N.drawSection(t,n,s),r=y.section,f++}let S=y.people.reduce((v,_)=>(A[_]&&(v[_]=A[_]),v),{});y.x=m*s.taskMargin+m*s.width+F,y.y=c,y.width=s.diagramMarginX,y.height=s.diagramMarginY,y.colour=k,y.fill=p,y.num=x,y.actors=S,N.drawTask(t,y,s),E.insert(y.x,y.y,y.x+y.width+s.taskMargin,300+5*30)}},"drawTasks"),it={setConf:Ut,draw:Jt};var Te={parser:_t,db:Q,renderer:it,styles:vt,init:t=>{it.setConf(t.journey),Q.clear()}};export{Te as diagram};
