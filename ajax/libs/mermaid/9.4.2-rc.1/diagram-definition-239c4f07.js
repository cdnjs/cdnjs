import { w as sanitizeText$1, g as getConfig, l as log, s as select, a as setupGraphViewbox, u as lighten, v as darken } from "./mermaid-0163aeae.js";
import { i as isDark } from "./is_dark-b1f60628.js";
var parser = function() {
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await import("./cytoscape.cjs-49860ed7.js").then((n) => n.c)).default;
    const coseBilkent = (await import("./cytoscape-cose-bilkent-00e3e53e.js").then((n) => n.c)).default;
...
//# sourceMappingURL=diagram-definition-239c4f07.js.map
