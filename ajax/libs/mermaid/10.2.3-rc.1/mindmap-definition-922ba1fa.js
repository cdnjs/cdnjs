import { d as yp, c as nn, l as qr, O as Ca, au as mp, j as ei, t as bp, az as Ep, aA as wp, aB as xp } from "./mermaid-ebb4e3f3.js";
import { c as Tp } from "./createText-13c656ab.js";
var Ki = function() {
...
` + he, ve.parser);
  ...
  jp(U, K), ty(K), bp(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
}, ay = {
  draw: ry
}, ny = (he) => {
  let fe = "";
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++)
    he["lineColor" + ee] = he["lineColor" + ee] || he["cScaleInv" + ee], Ep(he["lineColor" + ee]) ? he["lineColor" + ee] = wp(he["lineColor" + ee], 20) : he["lineColor" + ee] = xp(he["lineColor" + ee], 20);
  for (let ee = 0; ee < he.THEME_COLOR_LIMIT; ee++) {
    const ve = "" + (17 - 3 * ee);
    fe += `
