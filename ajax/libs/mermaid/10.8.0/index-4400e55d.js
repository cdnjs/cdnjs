import { i as N, G as A } from "./graph-940f1512.js";
import { m as J, l as H } from "./layout-5e46170e.js";
import { c as V } from "./clone-e2cbe4d9.js";
import { c as L, g as D, i as p, a as U, b as W, d as _, u as q, s as z, e as K, f as Q, p as O, h as Y, j as Z } from "./edges-a720f28b.js";
import { l as s, c as T, p as S, j as R } from "./mermaid-a09fe7cd.js";
import { a as I } from "./createText-e916aecc.js";
function m(e) {
  var t = {
    options: {
...
const nt = () => {
  g = {}, P = {}, l = {};
}, B = (e, t) => (s.trace("In isDecendant", t, " ", e, " = ", g[t].includes(e)), !!g[t].includes(e)), it = (e, t) => (s.info("Decendants of ", t, " is ", g[t]), s.info("Edge is ", e), e.v === t || e.w === t ? !1 : g[t] ? g[t].includes(e.v) || B(e.v, t) || B(e.w, t) || g[t].includes(e.w) : (s.debug("Tilt, ", t, ",not in decendants"), !1)), k = (e, t, n, r) => {
  s.warn(
    "Copying children of ",
    e,
    "root",
...
const dt = (e, t) => {
  ...
  await Promise.all(
    ...
    s.info("Edge " + c.v + " -> " + c.w + ": " + JSON.stringify(c)), s.info("Edge " + c.v + " -> " + c.w + ": ", c, " ", JSON.stringify(t.edge(c))), s.info("Fix", l, "ids:", c.v, c.w, "Translateing: ", l[c.v], l[c.w]), Q(w, o);
  }), t.edges().forEach(function(c) {
