import { l as Y, T as D, k as M } from "./mermaid-a09fe7cd.js";
var O = function() {
  var a = function(u, t, e, n) {
    ...
    parse: function(t) {
      var e = this, n = [0], s = [], r = [null], i = [], d = this.table, $ = "", v = 0, T = 0, N = 2, L = 1, R = i.slice.call(arguments, 1), o = Object.create(this.lexer), p = { yy: {} };
...
Expecting ` + S.join(", ") + ", got '" + (this.terminals_[l] || l) + "'" : A = "Parse error on line " + (v + 1) + ": Unexpected " + (l == L ? "end of input" : "'" + (this.terminals_[l] || l) + "'"), this.parseError(A, {
        ...
        switch (h[0]) {
          case 1:
            n.push(l), r.push(o.yytext), i.push(o.yylloc), n.push(h[1]), l = null, T = o.yyleng, $ = o.yytext, v = o.yylineno, I = o.yylloc;
            break;
          case 2:
