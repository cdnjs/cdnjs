import { G as V } from "./graph-940f1512.js";
import { S as D, u as M, v as R, x as F, y as j, o as A, l as y, p as U, c as C, f as z, q as $, n as E, j as _, z as H, r as W, A as X } from "./mermaid-a09fe7cd.js";
import { r as J } from "./index-4400e55d.js";
import { c as K } from "./channel-b111d153.js";
function Q(e) {
...
`), o.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + g + " " + w, l.setEdge(o.start, o.end, t, a);
  ...
  if (await J(S, t, ["point", "circle", "cross"], "flowchart", l), H.insertTitle(T, "flowchartTitleText", u.titleTopMargin, a.db.getDiagramTitle()), W(t, T, u.diagramPadding, u.useMaxWidth), a.db.indexNodes("subGraph" + k), !u.htmlLabels) {
