import { p as A, d as S, s as G } from "./styles-24532e8e.js";
import { E as W, z as B, l as u, F as I, c as H, j as M, k as O } from "./mermaid-a09fe7cd.js";
import { G as P } from "./graph-940f1512.js";
import { l as X } from "./layout-5e46170e.js";
...
const L = 20, E = function(i) {
  ...
  const y = n.node().getBBox(), m = y.width + L * 2, w = y.height + L * 2;
  O(n, w, m, p.useMaxWidth);
  const b = `${y.x - L} ${y.y - L} ${m} ${w}`;
