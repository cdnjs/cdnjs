import { c as rt, g as mt, s as _t, a as kt, b as xt, C as vt, B as bt, D as wt, f as St, ao as Lt, j as G, r as Et } from "./mermaid-a09fe7cd.js";
...
var tt = function() {
  var t = function(m, i, o, c) {
    ...
    performAction: function(i, o, c, _, b, d, x) {
      var E = d.length - 1;
      switch (b) {
        case 7:
    ...
    parse: function(i) {
      var o = this, c = [0], _ = [], b = [null], d = [], x = this.table, E = "", L = 0, A = 0, N = 2, C = 1, j = d.slice.call(arguments, 1), S = Object.create(this.lexer), M = { yy: {} };
      for (var $ in this.yy)
      ...
      function g() {
        var v;
        return v = _.pop() || S.lex() || C, typeof v != "number" && (v instanceof Array && (_ = v, v = _.pop()), v = o.symbols_[v] || v), v;
      }
...
` + S.showPosition() + `
Expecting ` + r.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : k = "Parse error on line " + (L + 1) + ": Unexpected " + (w == C ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(k, {
            text: S.match,
...
` + o + "^";
      ...
      test_match: function(i, o) {
        ...
        }, this.options.ranges && (b.yylloc.range = this.yylloc.range.slice(0))), _ = i[0].match(/(?:\r\n?|\n).*/g), _ && (this.yylineno += _.length), this.yylloc = {
      ...
      next: function() {
        ...
        return o ? (i = this.test_match(o, b[_]), i !== !1 ? i : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
function Gt() {
  let t = 0, n = 0, s = 1, a = 1, u = 24, y = 8, p, m = Ut, i = dt, o, c, _ = Ft, b = Wt, d = 6;
  function x() {
...
it.prototype = gt.prototype = {
  ...
  arcTo: function(t, n, s, a, u) {
    t = +t, n = +n, s = +s, a = +a, u = +u;
    var y = this._x1, p = this._y1, m = s - t, i = a - n, o = y - t, c = p - n, _ = o * o + c * c;
    if (u < 0)
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(c * m - i * o) > D) || !u)
        ...
        var b = s - y, d = a - p, x = m * m + i * i, E = b * b + d * d, L = Math.sqrt(x), A = Math.sqrt(_), N = u * Math.tan((et - Math.acos((x + _ - E) / (2 * L * A))) / 2), C = N / A, j = N / L;
        Math.abs(C - 1) > D && (this._ += "L" + (t + C * o) + "," + (n + C * c)), this._ += "A" + u + "," + u + ",0,0," + +(c * b > o * d) + "," + (this._x1 = t + j * m) + "," + (this._y1 = n + j * i);
      }
  },
  arc: function(t, n, s, a, u, y) {
    t = +t, n = +n, s = +s, y = !!y;
    var p = s * Math.cos(a), m = s * Math.sin(a), i = t + p, o = n + m, c = 1 ^ y, _ = y ? a - u : u - a;
    if (s < 0)
      throw new Error("negative radius: " + s);
    this._x1 === null ? this._ += "M" + i + "," + o : (Math.abs(this._x1 - i) > D || Math.abs(this._y1 - o) > D) && (this._ += "L" + i + "," + o), s && (_ < 0 && (_ = _ % nt + nt), _ > Yt ? this._ += "A" + s + "," + s + ",0,1," + c + "," + (t - p) + "," + (n - m) + "A" + s + "," + s + ",0,1," + c + "," + (this._x1 = i) + "," + (this._y1 = o) : _ > D && (this._ += "A" + s + "," + s + ",0," + +(_ >= et) + "," + c + "," + (this._x1 = t + s * Math.cos(u)) + "," + (this._y1 = n + s * Math.sin(u))));
  },
