import { U as H, V as at, B as lt, C as ct, s as ot, g as ht, b as ut, a as yt, D as ft, d as pt, c as et, l as it, W as gt, T as dt, X as mt, k as _t } from "./mermaid-a09fe7cd.js";
import { d as tt } from "./arc-d4b18033.js";
...
function St() {
  var e = bt, u = vt, A = null, p = F(0), g = F(H), E = F(0);
  function y(a) {
    var l, d = (a = kt(a)).length, m, I, $ = 0, _ = new Array(d), v = new Array(d), o = +p.apply(this, arguments), T = Math.min(H, Math.max(-H, g.apply(this, arguments) - o)), O, w = Math.min(Math.abs(T) / d, E.apply(this, arguments)), b = w * (T < 0 ? -1 : 1), t;
    for (l = 0; l < d; ++l)
...
var J = function() {
  var e = function(b, t, i, n) {
    for (i = i || {}, n = b.length; n--; i[b[n]] = t)
      ;
    return i;
  }, u = [1, 3], A = [1, 4], p = [1, 5], g = [1, 6], E = [1, 10, 12, 14, 16, 18, 19, 20, 21, 22], y = [2, 4], a = [1, 5, 10, 12, 14, 16, 18, 19, 20, 21, 22], l = [20, 21, 22], d = [2, 7], m = [1, 12], I = [1, 13], $ = [1, 14], _ = [1, 15], v = [1, 16], o = [1, 17], T = {
    trace: function() {
    },
    yy: {},
    ...
    table: [{ 3: 1, 4: 2, 5: u, 20: A, 21: p, 22: g }, { 1: [3] }, { 3: 7, 4: 2, 5: u, 20: A, 21: p, 22: g }, e(E, y, { 6: 8, 7: [1, 9] }), e(a, [2, 14]), e(a, [2, 15]), e(a, [2, 16]), { 1: [2, 1] }, e(l, d, { 8: 10, 9: 11, 1: [2, 2], 10: m, 12: I, 14: $, 16: _, 18: v, 19: o }), e(E, y, { 6: 18 }), e(E, [2, 5]), { 4: 19, 20: A, 21: p, 22: g }, { 11: [1, 20] }, { 13: [1, 21] }, { 15: [1, 22] }, { 17: [1, 23] }, e(l, [2, 12]), e(l, [2, 13]), e(l, d, { 8: 10, 9: 11, 1: [2, 3], 10: m, 12: I, 14: $, 16: _, 18: v, 19: o }), e(E, [2, 6]), e(l, [2, 8]), e(l, [2, 9]), e(l, [2, 10]), e(l, [2, 11])],
    ...
    parse: function(t) {
      var i = this, n = [0], r = [], c = [null], s = [], V = this.table, x = "", f = 0, P = 0, R = 2, M = 1, B = s.slice.call(arguments, 1), h = Object.create(this.lexer), N = { yy: {} };
...
J.parser = J;
const At = J, nt = at.pie, G = {
  sections: {},
  showData: !1,
  config: nt
};
let U = G.sections, K = G.showData;
const Et = structuredClone(nt), wt = () => structuredClone(Et), $t = () => {
...
` + e);
  const g = p.db, E = et(), y = gt(g.getConfig(), E.pie), a = 40, l = 18, d = 4, m = 450, I = m, $ = dt(u), _ = $.append("g"), v = g.getSections();
