import { p as R, d as N, s as $ } from "./styles-24532e8e.js";
import { l as c, c as r, j as k, z as B, r as G, o as E, q as C, n as A, f as _ } from "./mermaid-a09fe7cd.js";
import { G as z } from "./graph-940f1512.js";
import { r as q } from "./index-4400e55d.js";
...
`), t.style === void 0 && (s.style = s.style || "stroke: #333; stroke-width: 1.5px;fill:none"), s.labelStyle = s.labelStyle.replace("color:", "fill:"))), e.setEdge(t.id1, t.id2, s, n);
  ...
  c.info("config:", t);
  const l = (t == null ? void 0 : t.nodeSpacing) ?? 50, a = (t == null ? void 0 : t.rankSpacing) ?? 50, i = new z({
    multigraph: !0,
    compound: !0
  }).setGraph({
