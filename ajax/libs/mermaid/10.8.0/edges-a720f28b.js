import { l as g, p as H, c as b, b4 as Q, j as B, d as q, z as j, E as lt } from "./mermaid-a09fe7cd.js";
import { a as st } from "./createText-e916aecc.js";
import { l as ct } from "./line-0f31738a.js";
const ht = (e, t, a, i) => {
  t.forEach((l) => {
    wt[l](e, a, i);
  });
          ...
          (u) => new Promise((S) => {
            function E() {
              if (u.style.display = "flex", u.style.flexDirection = "column", d) {
                const C = b().fontSize ? b().fontSize : window.getComputedStyle(document.body).fontSize, W = 5, D = parseInt(C, 10) * W + "px";
...
const Gt = (e, t) => {
  ...
  }), f += l, o.attr("class", "divider").attr("x1", -h / 2 - a).attr("x2", h / 2 + a).attr("y1", -y / 2 - a + l + f).attr("y2", -y / 2 - a + l + f), f += l, D.forEach((v) => {
    B(v).attr(
      "transform",
