import { c as Z, s as Et, g as mt, b as gt, a as kt, B as xt, D as Rt, l as V, E as Ot, j as rt, z as bt, k as Nt, F as Tt, G as At } from "./mermaid-8d01e515.js";
import { G as Mt, l as wt } from "./layout-05534f1b.js";
import { l as St } from "./line-973c5b8b.js";
...
const te = function(t) {
  ...
  r.forEach((T) => {
    ...
    a.tn = L, a.nn = w;
    const n = L.node().getBBox(), c = w.node().getBBox();
  ...
  if (r.length > 0) {
    ...
    o.forEach((O) => {
      ...
      const w = t.insert("rect", "#" + O.tn.node().id).classed(`er ${R}`, !0).attr("x", 0).attr("y", M).attr("width", m + l * 2 + T).attr("height", O.height + u * 2), a = parseFloat(w.attr("x")) + parseFloat(w.attr("width"));
      O.nn.attr(
        "transform",
        "translate(" + (a + l) + "," + L + ")"
      );
...
const ne = function(t, e, r, u, l) {
  ...
  wt(h), ie(o, h), m.forEach(function(I) {
    ne(o, I, h, _, u);
  });
