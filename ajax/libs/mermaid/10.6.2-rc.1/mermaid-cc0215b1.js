...
var Qe = 0.7, qi = 1 / Qe, Be = "\\s*([+-]?\\d+)\\s*", ti = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Et = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", iu = /^#([0-9a-f]{3,8})$/, ru = new RegExp(`^rgb\\(${Be},${Be},${Be}\\)$`), nu = new RegExp(`^rgb\\(${Et},${Et},${Et}\\)$`), ou = new RegExp(`^rgba\\(${Be},${Be},${Be},${ti}\\)$`), su = new RegExp(`^rgba\\(${Et},${Et},${Et},${ti}\\)$`), au = new RegExp(`^hsl\\(${ti},${Et},${Et}\\)$`), lu = new RegExp(`^hsla\\(${ti},${Et},${Et},${ti}\\)$`), bo = {
  aliceblue: 15792383,
...
function ei(t) {
  var e, i;
  return t = (t + "").trim().toLowerCase(), (e = iu.exec(t)) ? (i = e[1].length, e = parseInt(e[1], 16), i === 6 ? So(e) : i === 3 ? new ft(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : i === 8 ? xi(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : i === 4 ? xi(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = ru.exec(t)) ? new ft(e[1], e[2], e[3], 1) : (e = nu.exec(t)) ? new ft(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = ou.exec(t)) ? xi(e[1], e[2], e[3], e[4]) : (e = su.exec(t)) ? xi(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = au.exec(t)) ? Bo(e[1], e[2] / 100, e[3] / 100, 1) : (e = lu.exec(t)) ? Bo(e[1], e[2] / 100, e[3] / 100, e[4]) : bo.hasOwnProperty(t) ? So(bo[t]) : t === "transparent" ? new ft(NaN, NaN, NaN, 0) : null;
}
function So(t) {
...
var bu = Zs(Cu, "px, ", "px)", "deg)"), Tu = Zs(xu, ", ", ")", ")"), Le = 0, je = 0, qe = 0, Js = 1e3, Wi, Ue, Hi = 0, fe = 0, lr = 0, ii = typeof performance == "object" && performance.now ? performance : Date, Qs = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
  setTimeout(t, 17);
};
function Bn() {
  return fe || (Qs(ku), fe = ii.now() + lr);
}
function ku() {
  fe = 0;
}
...
function en(t) {
  if (!Le) {
    ...
    var e = t - fe;
    e > 24 ? (t < 1 / 0 && (je = setTimeout(Eo, t - ii.now() - lr)), qe && (qe = clearInterval(qe))) : (qe || (Hi = ii.now(), qe = setInterval(vu, Js)), Le = 1, Qs(Eo));
  }
}
function Mo(t, e, i) {
  var r = new ji();
...
var Bu = Os("start", "end", "cancel", "interrupt"), Fu = [], ea = 0, Oo = 1, rn = 2, Li = 3, $o = 4, nn = 5, Ei = 6;
...
function ia(t, e) {
  var i;
  return (typeof e == "number" ? Qt : e instanceof ei ? Ao : (i = ei(e)) ? (e = i, Ao) : _u)(t, e);
}
function Iu(t) {
  return function() {
    this.removeAttribute(t);
...
var df = hi.prototype.constructor;
function pf() {
...
hi.prototype.interrupt = Eu;
hi.prototype.transition = If;
...
const sd = bt(Array.prototype.forEach), Wo = bt(Array.prototype.pop), ze = bt(Array.prototype.push), Mi = bt(String.prototype.toLowerCase), Rr = bt(String.prototype.toString), ad = bt(String.prototype.match), St = bt(String.prototype.replace), ld = bt(String.prototype.indexOf), hd = bt(String.prototype.trim), gt = bt(RegExp.prototype.test), We = cd(TypeError);
function bt(t) {
  return function(e) {
...
function xa() {
  ...
  const ih = n.createElement("form"), lo = function(d) {
    ...
    if (!(Te && Te === d)) {
      ...
      th.indexOf(d.PARSER_MEDIA_TYPE) === -1 ? oe = eh : oe = d.PARSER_MEDIA_TYPE, tt = oe === "application/xhtml+xml" ? Rr : Mi, T = "ALLOWED_TAGS" in d ? N({}, d.ALLOWED_TAGS, tt) : H, R = "ALLOWED_ATTR" in d ? N({}, d.ALLOWED_ATTR, tt) : U, Lr = "ALLOWED_NAMESPACES" in d ? N({}, d.ALLOWED_NAMESPACES, Rr) : Ql, Fr = "ADD_URI_SAFE_ATTR" in d ? N(
        ke(ao),
  ...
  }, ho = N({}, ["mi", "mo", "mn", "ms", "mtext"]), co = N({}, ["foreignobject", "desc", "title", "annotation-xml"]), rh = N({}, ["title", "style", "font", "a", "script"]), _i = N({}, Pr);
  N(_i, qr), N(_i, ud);
  const Mr = N({}, zr);
  N(Mr, fd);
  const nh = function(d) {
    ...
    return Lr[d.namespaceURI] ? d.namespaceURI === yi ? m.namespaceURI === qt ? b === "svg" : m.namespaceURI === mi ? b === "svg" && (j === "annotation-xml" || ho[j]) : !!_i[b] : d.namespaceURI === mi ? m.namespaceURI === qt ? b === "math" : m.namespaceURI === yi ? b === "math" && co[j] : !!Mr[b] : d.namespaceURI === qt ? m.namespaceURI === yi && !co[j] || m.namespaceURI === mi && !ho[j] ? !1 : !Mr[b] && (rh[b] || !_i[b]) : !!(oe === "application/xhtml+xml" && Lr[d.namespaceURI]) : !1;
  }, se = function(d) {
    ze(e.removed, {
      element: d
    });
    ...
    return d instanceof l && !nh(d) || (b === "noscript" || b === "noembed" || b === "noframes") && gt(/<\/no(script|embed|frames)/i, d.innerHTML) ? (se(d), !0) : (st && d.nodeType === 3 && (m = d.textContent, m = St(m, Nt, " "), m = St(m, At, " "), m = St(m, E, " "), d.textContent !== m && (ze(e.removed, {
      element: d.cloneNode()
...
const fr = /<br\s*\/?>/gi, Td = (t) => t ? Ta(t).replace(/\\n/g, "#br#").split("#br#") : [""], ba = (t) => {
  ...
  FORBID_TAGS: ["style"]
}).toString(), t), kd = (t, e) => typeof t == "string" ? ri(t, e) : t.flat().map((i) => ri(i, e)), Sd = (t) => fr.test(t), vd = (t) => t.split(fr), wd = (t) => t.replace(/#br#/g, "<br/>"), Ta = (t) => t.replace(fr, "#br#"), Bd = (t) => {
  let e = "";
...
const zd = qd, Wd = new zd({ r: 0, g: 0, b: 0, a: 0 }, "transparent"), dr = Wd, Sa = {
  ...
  return $.lang.round(n);
}, Gd = Yd, Vd = (t) => Gd(t) >= 0.5, Xd = Vd, Kd = (t) => !Xd(t), ui = Kd, Zd = (t, e, i) => {
...
const Ee = {}, mr = function(t, e) {
  t = t.replace(La, "").replace(Xe, "").replace(yp, `
`);
...
}, _p = (t) => Ee[t].loader, ln = (t, e, { depth: i = 2, clobber: r = !1 } = {}) => {
...
var Tp = Dt.Symbol;
const Xi = Tp;
var Ia = Object.prototype, kp = Ia.hasOwnProperty, Sp = Ia.toString, He = Xi ? Xi.toStringTag : void 0;
function vp(t) {
  var e = kp.call(t, He), i = t[He];
  try {
    t[He] = void 0;
    var r = !0;
  } catch {
...
function rg(t) {
  var e = this.__data__;
  return ni ? e[t] !== void 0 : ig.call(e, t);
}
var ng = "__lodash_hash_undefined__";
function og(t, e) {
  var i = this.__data__;
  return this.size += this.has(t) ? 0 : 1, i[t] = ni && e === void 0 ? ng : e, this;
}
function de(t) {
...
Ne.prototype.clear = bg;
Ne.prototype.delete = Tg;
Ne.prototype.get = kg;
Ne.prototype.has = Sg;
Ne.prototype.set = wg;
var Bg = function() {
...
var Pa = Object.prototype, Hg = Pa.hasOwnProperty, jg = Pa.propertyIsEnumerable, Ug = rs(function() {
  ...
  return di(t) && Hg.call(t, "callee") && !jg.call(t, "callee");
};
const Zi = Ug;
...
var Ha = typeof exports == "object" && exports && !exports.nodeType && exports, Ke = Ha && typeof module == "object" && module && !module.nodeType && module, Em = Ke && Ke.exports === Ha, jr = Em && $a.process, Mm = function() {
  try {
...
var Ja = "comm", Qa = "rule", tl = "decl", P0 = "@import", q0 = "@keyframes", z0 = Math.abs, Hn = String.fromCharCode;
function el(t) {
  return t.trim();
}
function un(t, e, i) {
...
function Z0(t) {
  return Y0(Ni("", null, null, null, [""], t = U0(t), 0, [0], t));
}
      ...
      default:
        ...
        switch (W += Hn(S), S * v) {
          ...
          case 44:
            ...
            break;
          case 64:
            ce() === 45 && (W += Ur(wt())), c = ce(), u = f = te(z = W += K0(Di())), S++;
            break;
          case 45:
            y === 45 && te(W) == 2 && (v = 0);
        }
...
function us(t, e, i, r, n, o, s, a, l, h, u) {
  for (var f = n - 1, c = n === 0 ? o : [""], p = il(c), y = 0, v = 0, M = 0; y < r; ++y)
    for (var q = 0, S = ai(t, f + 1, f = z0(v = s[y])), z = t; q < p; ++q)
      (z = el(v > 0 ? c[q] + " " + S : un(S, /&\f/g, c[q]))) && (l[M++] = z);
  return jn(t, e, i, n === 0 ? Qa : a, l, h, u);
}
function J0(t, e, i) {
  return jn(t, e, i, Ja, Hn(H0()), ai(t, 2, -2), 0);
}
function fs(t, e, i, r) {
...
const ds = "10.6.2-rc.1", Oe = Object.freeze(gp);
...
const Sr = (t, e) => {
...
}, ty = (t) => (ut = nt({}, Oe), ut = nt(ut, t), t.theme && Yt[t.theme] && (ut.themeVariables = Yt[t.theme].getThemeVariables(t.themeVariables)), Sr(ut, $e), ut), ey = (t) => {
  nl = nt({}, t);
}, iy = (t) => (ut = nt(ut, t), Sr(ut, $e), ut), ol = () => nt({}, ut), sl = (t) => (ll(t), nt(Je, t), $t()), $t = () => nt({}, Je), al = (t) => {
  ...
  ps[t] || (A.warn(ny[t]), ps[t] = !0);
}, ll = (t) => {
  t && (t.lazyLoadedDiagrams || t.loadExternalDiagramsAtStartup) && oy("LAZY_LOAD_DEPRECATED");
}, hl = "c4", sy = (t) => /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(t), ay = async () => {
  const { diagram: t } = await import("./c4Diagram-114aab0f.js");
  return { id: hl, diagram: t };
}, ly = {
  id: hl,
  detector: sy,
  loader: ay
}, hy = ly, cl = "flowchart", cy = (t, e) => {
  var i, r;
  ...
  const { diagram: t } = await import("./flowDiagram-c4250527.js");
  return { id: cl, diagram: t };
}, fy = {
  id: cl,
  detector: cy,
  loader: uy
}, dy = fy, ul = "flowchart-v2", py = (t, e) => {
  var i, r, n;
  ...
  const { diagram: t } = await import("./flowDiagram-v2-e00ae6da.js");
  return { id: ul, diagram: t };
}, my = {
  id: ul,
  detector: py,
  loader: gy
}, yy = my, fl = "er", _y = (t) => /^\s*erDiagram/.test(t), Cy = async () => {
  const { diagram: t } = await import("./erDiagram-6dbf40f6.js");
  return { id: fl, diagram: t };
}, xy = {
  id: fl,
  detector: _y,
  loader: Cy
}, by = xy, dl = "gitGraph", Ty = (t) => /^\s*gitGraph/.test(t), ky = async () => {
  const { diagram: t } = await import("./gitGraphDiagram-474f3996.js");
  return { id: dl, diagram: t };
}, Sy = {
  id: dl,
  detector: Ty,
  loader: ky
}, vy = Sy, pl = "gantt", wy = (t) => /^\s*gantt/.test(t), By = async () => {
  const { diagram: t } = await import("./ganttDiagram-117d088a.js");
  return { id: pl, diagram: t };
}, Fy = {
  id: pl,
  detector: wy,
  loader: By
}, Ay = Fy, gl = "info", Ly = (t) => /^\s*info/.test(t), Ey = async () => {
  const { diagram: t } = await import("./infoDiagram-6cb98dde.js");
  return { id: gl, diagram: t };
}, My = {
  id: gl,
  detector: Ly,
  loader: Ey
}, ml = "pie", Oy = (t) => /^\s*pie/.test(t), $y = async () => {
  const { diagram: t } = await import("./pieDiagram-efcc7428.js");
  return { id: ml, diagram: t };
}, Iy = {
  id: ml,
  detector: Oy,
  loader: $y
}, yl = "quadrantChart", Dy = (t) => /^\s*quadrantChart/.test(t), Ny = async () => {
  const { diagram: t } = await import("./quadrantDiagram-ae10360b.js");
  return { id: yl, diagram: t };
}, Ry = {
  id: yl,
  detector: Dy,
  loader: Ny
}, Py = Ry, _l = "xychart", qy = (t) => /^\s*xychart-beta/.test(t), zy = async () => {
  const { diagram: t } = await import("./xychartDiagram-df889be8.js");
  return { id: _l, diagram: t };
}, Wy = {
  id: _l,
  detector: qy,
  loader: zy
}, Hy = Wy, Cl = "requirement", jy = (t) => /^\s*requirement(Diagram)?/.test(t), Uy = async () => {
  const { diagram: t } = await import("./requirementDiagram-72682124.js");
  return { id: Cl, diagram: t };
}, Yy = {
  id: Cl,
  detector: jy,
  loader: Uy
}, Gy = Yy, xl = "sequence", Vy = (t) => /^\s*sequenceDiagram/.test(t), Xy = async () => {
  const { diagram: t } = await import("./sequenceDiagram-0fad285e.js");
  return { id: xl, diagram: t };
}, Ky = {
  id: xl,
  detector: Vy,
  loader: Xy
}, Zy = Ky, bl = "class", Jy = (t, e) => {
  var i;
  return ((i = e == null ? void 0 : e.class) == null ? void 0 : i.defaultRenderer) === "dagre-wrapper" ? !1 : /^\s*classDiagram/.test(t);
}, Qy = async () => {
  const { diagram: t } = await import("./classDiagram-edef5281.js");
  return { id: bl, diagram: t };
}, t_ = {
  id: bl,
  detector: Jy,
  loader: Qy
}, e_ = t_, Tl = "classDiagram", i_ = (t, e) => {
  var i;
  ...
  const { diagram: t } = await import("./classDiagram-v2-bb09c9b9.js");
  return { id: Tl, diagram: t };
}, n_ = {
  id: Tl,
  detector: i_,
  loader: r_
}, o_ = n_, kl = "state", s_ = (t, e) => {
  var i;
  return ((i = e == null ? void 0 : e.state) == null ? void 0 : i.defaultRenderer) === "dagre-wrapper" ? !1 : /^\s*stateDiagram/.test(t);
}, a_ = async () => {
  const { diagram: t } = await import("./stateDiagram-181260a0.js");
  return { id: kl, diagram: t };
}, l_ = {
  id: kl,
  detector: s_,
  loader: a_
}, h_ = l_, Sl = "stateDiagram", c_ = (t, e) => {
  var i;
  ...
  const { diagram: t } = await import("./stateDiagram-v2-de8c4b96.js");
  return { id: Sl, diagram: t };
}, f_ = {
  id: Sl,
  detector: c_,
  loader: u_
}, d_ = f_, vl = "journey", p_ = (t) => /^\s*journey/.test(t), g_ = async () => {
  const { diagram: t } = await import("./journeyDiagram-8d3d1933.js");
  return { id: vl, diagram: t };
}, m_ = {
  id: vl,
  detector: p_,
  loader: g_
}, y_ = m_, __ = function(t, e) {
  for (let i of e)
    t.attr(i[0], i[1]);
}, C_ = function(t, e, i) {
...
`);
  ...
  Yn = Vn(t);
}, L_ = () => Yn, E_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  clear: S_,
  getAccDescription: F_,
  getAccTitle: w_,
  getDiagramTitle: L_,
  setAccDescription: B_,
  setAccTitle: v_,
  setDiagramTitle: A_
}, Symbol.toStringTag, { value: "Module" })), M_ = A, O_ = bn, Xn = $t, _1 = sl, C1 = Oe, $_ = (t) => ri(t, Xn()), I_ = x_, D_ = () => E_, er = {}, ir = (t, e, i) => {
  var r;
  if (er[t])
    throw new Error(`Diagram ${t} already registered.`);
  er[t] = e, i && Oa(t, i), T_(t, e.styles), (r = e.injectUtils) == null || r.call(
    e,
    M_,
    O_,
    Xn,
...
`);
  ...
  const { diagram: t } = await import("./flowchart-elk-definition-ad021167.js");
  return { id: Fl, diagram: t };
}, U_ = {
  id: Fl,
  detector: H_,
  loader: j_
}, Y_ = U_, Al = "timeline", G_ = (t) => /^\s*timeline/.test(t), V_ = async () => {
  const { diagram: t } = await import("./timeline-definition-7642552d.js");
  return { id: Al, diagram: t };
}, X_ = {
  id: Al,
  detector: G_,
  loader: V_
}, K_ = X_, Ll = "mindmap", Z_ = (t) => /^\s*mindmap/.test(t), J_ = async () => {
  const { diagram: t } = await import("./mindmap-definition-abe2120a.js");
  return { id: Ll, diagram: t };
}, Q_ = {
  id: Ll,
  detector: Z_,
  loader: J_
}, tC = Q_, El = "sankey", eC = (t) => /^\s*sankey-beta/.test(t), iC = async () => {
  const { diagram: t } = await import("./sankeyDiagram-6490643d.js");
...
let gs = !1;
const Zn = () => {
  gs || (gs = !0, ir("error", W_, (t) => t.toLowerCase().trim() === "error"), ir(
    "---",
...
class Ml {
  constructor(e, i = {}) {
    this.text = e, this.metadata = i, this.type = "graph", this.text = N0(e), this.text += `
`;
    const r = $t();
    try {
      this.type = mr(e, r);
...
function cC(t) {
  ...
  var e = [];
  for (var i in Object(t))
    hC.call(t, i) && i != "constructor" && e.push(i);
  return e;
}
var uC = ye(Dt, "DataView");
const mn = uC;
var fC = ye(Dt, "Promise");
const yn = fC;
var dC = ye(Dt, "Set");
const _n = dC;
var pC = ye(Dt, "WeakMap");
const Cn = pC;
var ms = "[object Map]", gC = "[object Object]", ys = "[object Promise]", _s = "[object Set]", Cs = "[object WeakMap]", xs = "[object DataView]", mC = me(mn), yC = me(oi), _C = me(yn), CC = me(_n), xC = me(Cn), ae = De;
(mn && ae(new mn(new ArrayBuffer(1))) != xs || oi && ae(new oi()) != ms || yn && ae(yn.resolve()) != ys || _n && ae(new _n()) != _s || Cn && ae(new Cn()) != Cs) && (ae = function(t) {
  var e = De(t), i = e == gC ? t.constructor : void 0, r = i ? me(i) : "";
  if (r)
    switch (r) {
      case mC:
        return xs;
...
const bC = ae;
var TC = "[object Map]", kC = "[object Set]", SC = Object.prototype, vC = SC.hasOwnProperty;
function Yr(t) {
  if (t == null)
    return !0;
...
const wC = "graphics-document document";
function BC(t, e) {
...
var IC = Ol, DC = LC, NC = EC, RC = OC, PC = $C, qC = MC, at = {
  isNothing: IC,
  isObject: DC,
  toArray: NC,
  repeat: RC,
...
function YC(t, e) {
  if (e = e || {}, Object.keys(e).forEach(function(i) {
    ...
    return i;
  }, this.instanceOf = e.instanceOf || null, this.predicate = e.predicate || null, this.represent = e.represent || null, this.representName = e.representName || null, this.defaultStyle = e.defaultStyle || null, this.multi = e.multi || !1, this.styleAliases = UC(e.styleAliases || null), jC.indexOf(this.kind) === -1)
...
xn.prototype.extend = function(e) {
  ...
  return n.implicit = (this.implicit || []).concat(i), n.explicit = (this.explicit || []).concat(r), n.compiledImplicit = bs(n, "implicit"), n.compiledExplicit = bs(n, "explicit"), n.compiledTypeMap = GC(n.compiledImplicit, n.compiledExplicit), n;
};
var VC = xn, XC = new ot("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: function(t) {
    return t !== null ? t : "";
  }
}), KC = new ot("tag:yaml.org,2002:seq", {
  kind: "sequence",
  construct: function(t) {
    return t !== null ? t : [];
  }
}), ZC = new ot("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(t) {
    return t !== null ? t : {};
  }
...
var ix = new ot("tag:yaml.org,2002:null", {
  kind: "scalar",
  resolve: QC,
  construct: tx,
  predicate: ex,
...
var sx = new ot("tag:yaml.org,2002:bool", {
  kind: "scalar",
  resolve: rx,
  construct: nx,
  predicate: ox,
...
var dx = new ot("tag:yaml.org,2002:int", {
  kind: "scalar",
  resolve: cx,
  construct: ux,
  predicate: fx,
...
function gx(t) {
  return !(t === null || !px.test(t) || // Quick hack to not allow integers end with `_`
...
function _x(t, e) {
  ...
  if (isNaN(t))
    ...
    return "-0.0";
  return i = t.toString(10), yx.test(i) ? i.replace("e", ".e") : i;
}
function Cx(t) {
  return Object.prototype.toString.call(t) === "[object Number]" && (t % 1 !== 0 || at.isNegativeZero(t));
}
var xx = new ot("tag:yaml.org,2002:float", {
  kind: "scalar",
  resolve: gx,
  construct: mx,
  predicate: Cx,
...
var vx = new ot("tag:yaml.org,2002:timestamp", {
  kind: "scalar",
  resolve: Tx,
  construct: kx,
  instanceOf: Date,
...
var Bx = new ot("tag:yaml.org,2002:merge", {
  kind: "scalar",
  resolve: wx
...
var Mx = new ot("tag:yaml.org,2002:binary", {
  kind: "scalar",
  resolve: Fx,
  construct: Ax,
  predicate: Ex,
  represent: Lx
}), Ox = Object.prototype.hasOwnProperty, $x = Object.prototype.toString;
function Ix(t) {
  if (t === null)
    return !0;
  var e = [], i, r, n, o, s, a = t;
  for (i = 0, r = a.length; i < r; i += 1) {
    if (n = a[i], s = !1, $x.call(n) !== "[object Object]")
      return !1;
    for (o in n)
      if (Ox.call(n, o))
        if (!s)
...
var Nx = new ot("tag:yaml.org,2002:omap", {
  kind: "sequence",
  resolve: Ix,
  construct: Dx
...
function Px(t) {
  ...
  for (o = new Array(s.length), e = 0, i = s.length; e < i; e += 1) {
    if (r = s[e], Rx.call(r) !== "[object Object]" || (n = Object.keys(r), n.length !== 1))
      return !1;
    o[e] = [n[0], r[n[0]]];
  }
  return !0;
...
var zx = new ot("tag:yaml.org,2002:pairs", {
  kind: "sequence",
  resolve: Px,
  construct: qx
...
var Ux = new ot("tag:yaml.org,2002:set", {
  kind: "mapping",
  resolve: Hx,
  construct: jx
}), Yx = bx.extend({
...
}), re = Object.prototype.hasOwnProperty, rr = 1, Rl = 2, Pl = 3, nr = 4, Xr = 1, Gx = 2, Ts = 3, Vx = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, Xx = /[\x85\u2028\u2029]/, Kx = /[,\[\]\{\}]/, ql = /^(?:!|!!|![a-z\-]+!)$/i, zl = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function ks(t) {
...
function eb(t, e) {
  this.input = t, this.filename = e.filename || null, this.schema = e.schema || Yx, this.onWarning = e.onWarning || null, this.legacy = e.legacy || !1, this.json = e.json || !1, this.listener = e.listener || null, this.implicitTypes = this.schema.compiledImplicit, this.typeMap = this.schema.compiledTypeMap, this.length = t.length, this.position = 0, this.line = 0, this.lineStart = 0, this.lineIndent = 0, this.firstTabInLine = -1, this.documents = [];
}
function jl(t, e) {
  var i = {
    name: t.filename,
  ...
  return i.snippet = WC(i), new Ut(e, i);
}
function F(t, e) {
  throw jl(t, e);
}
...
function ee(t, e, i, r) {
  ...
  if (e < i) {
    if (a = t.input.slice(e, i), r)
      ...
      Vx.test(a) && F(t, "the stream contains non-printable characters");
    t.result += a;
  }
}
function ws(t, e, i, r) {
  ...
  for (t.kind = "scalar", t.result = "", t.position++, i = r = t.position; (a = t.input.charCodeAt(t.position)) !== 0; ) {
    ...
    if (a === 92) {
      if (ee(t, i, t.position, !0), a = t.input.charCodeAt(++t.position), Mt(a))
        ...
        for (n = s, o = 0; n > 0; n--)
          a = t.input.charCodeAt(++t.position), (s = Zx(a)) >= 0 ? o = (o << 4) + s : F(t, "expected hexadecimal character");
        t.result += tb(o), t.position++;
      } else
...
function sb(t, e) {
  ...
  for (t.kind = "scalar", t.result = ""; f !== 0; )
    if (f = t.input.charCodeAt(++t.position), f === 43 || f === 45)
      Xr === n ? n = f === 43 ? Ts : Gx : F(t, "repeat of a chomping mode identifier");
    else if ((u = Qx(f)) >= 0)
...
function lb(t) {
  ...
  if (t.tag !== null && F(t, "duplication of a tag property"), s = t.input.charCodeAt(++t.position), s === 60 ? (i = !0, s = t.input.charCodeAt(++t.position)) : s === 33 ? (r = !0, n = "!!", s = t.input.charCodeAt(++t.position)) : n = "!", e = t.position, i) {
    ...
    o = t.input.slice(e, t.position), Kx.test(o) && F(t, "tag suffix cannot contain flow indicator characters");
  }
...
function Ie(t, e, i, r, n) {
  ...
  if (a && (a = h || n), (l === 1 || nr === i) && (rr === i || Rl === i ? v = e : v = e + 1, M = t.position - t.lineStart, l === 1 ? a && (Bs(t, M) || ab(t, M, v)) || ob(t, v) ? u = !0 : (s && sb(t, v) || rb(t, v) || nb(t, v) ? u = !0 : cb(t) ? (u = !0, (t.tag !== null || t.anchor !== null) && F(t, "alias node should not have any properties")) : ib(t, v, rr === i) && (u = !0, t.tag === null && (t.tag = "?")), t.anchor !== null && (t.anchorMap[t.anchor] = t.result)) : l === 0 && (u = a && Bs(t, M))), t.tag === null)
...
`), t.charCodeAt(0) === 65279 && (t = t.slice(1)));
  var i = new eb(t, e), r = t.indexOf("\0");
...
function kb(t) {
  const e = xb(t), i = bb(e), r = Tb(i.text), n = Za(i.config, r.directive);
  return t = AC(r.text), {
    code: t,
    title: i.title,
    config: n
...
const Sb = 5e4, vb = "graph TB;a[Maximum text size in diagram exceeded];style a fill:#faa", wb = "sandbox", Bb = "loose", Fb = "http://www.w3.org/2000/svg", Ab = "http://www.w3.org/1999/xlink", Lb = "http://www.w3.org/1999/xhtml", Eb = "100%", Mb = "100%", Ob = "border:0;margin:0;", $b = "margin:0", Ib = "allow-top-navigation-by-user-activation allow-popups", Db = 'The "iframe" tag is not supported by your browser.', Nb = ["foreignobject"], Rb = ["dominant-baseline"];
function Yl(t) {
  const e = kb(t);
  return tr(), ry(e.config ?? {}), e;
}
...
:root { --mermaid-alt-font-family: ${t.altFontFamily}}`), !Yr(e)) {
  ...
  const n = qb(t, i), o = k_(e, n, t.themeVariables);
  return pn(Z0(`${r}{${o}}`), Q0);
}, Wb = (t = "", e, i) => {
  let r = t;
  return !i && !e && (r = r.replace(
    ...
    'marker-end="url(#'
  )), r = R0(r), r = r.replace(/<br>/g, "<br/>"), r;
}, Hb = (t = "", e) => {
  var n, o;
  const i = (o = (n = e == null ? void 0 : e.viewBox) == null ? void 0 : n.baseVal) != null && o.height ? e.viewBox.baseVal.height + "px" : Mb, r = btoa('<body style="' + $b + '">' + t + "</body>");
  return `<iframe style="width:${Eb};height:${i};${Ob}" src="data:text/html;base64,${r}" sandbox="${Ib}">
  ${Db}
</iframe>`;
}, As = (t, e, i, r, n) => {
  const o = t.append("div");
  o.attr("id", i), r && o.attr("style", r);
  const s = o.append("svg").attr("id", e).attr("width", "100%").attr("xmlns", Fb);
...
const jb = (t, e, i, r) => {
  ...
  e = r.code;
  const n = $t();
  A.debug(n), e.length > ((n == null ? void 0 : n.maxTextSize) ?? Sb) && (e = vb);
  const o = "#" + t, s = "i" + t, a = "#" + s, l = "d" + t, h = "#" + l;
  let u = Ct("body");
  const f = n.securityLevel === wb, c = n.securityLevel === Bb, p = n.fontFamily;
  if (i !== void 0) {
    if (i && (i.innerHTML = ""), f) {
      const T = Ls(Ct(i), s);
...
function Yb(t = {}) {
  var i;
  t != null && t.fontFamily && !((i = t.themeVariables) != null && i.fontFamily) && (t.themeVariables || (t.themeVariables = {}), t.themeVariables.fontFamily = t.fontFamily), ey(t), t != null && t.theme && t.theme in Yt ? t.themeVariables = Yt[t.theme].getThemeVariables(
    t.themeVariables
  ) : t && (t.themeVariables = Yt.default.getThemeVariables(t.themeVariables));
  const e = typeof t == "object" ? ty(t) : ol();
  bn(e.logLevel), Zn();
}
function Gb(t, e, i, r) {
  BC(e, t), FC(e, i, r, e.attr("id"));
}
...
const Vb = async () => {
  ...
  for (const l of Array.from(n)) {
    ...
    s = l.innerHTML, s = ah(Ze.entityDecode(s)).trim().replace(/<br\s*\/?>/gi, "<br/>");
