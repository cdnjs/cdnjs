import { p as M, d as N, s as R } from "./styles-e49523c0.js";
import { l as c, c as r, j as k, z as $, r as B, q as E, n as C, o as G, f as A } from "./mermaid-cc0215b1.js";
import { G as z } from "./layout-227b645f.js";
import { r as q } from "./index-70a400b8.js";
import "./edges-8e43b2b1.js";
import "./createText-0abd1a9d.js";
import "./line-d42cab03.js";
...
const P = function(o, t, p, n) {
  ...
  c.info("keys:", e), c.info(o), e.forEach(function(s) {
    ...
    t.setNode(l.id, i), _(l.classes, t, p, n, l.id), c.info("setNode", i);
  });
}, _ = function(o, t, p, n, e) {
...
`), e.style === void 0 && (s.style = s.style || "stroke: #333; stroke-width: 1.5px;fill:none"), s.labelStyle = s.labelStyle.replace("color:", "fill:"))), t.setEdge(e.id1, e.id2, s, n);
  ...
  c.info(f), P(y, i, t, n), _(d, i, t, n), H(f, i), F(m, i, f.length + 1, d);
  let b;
  s === "sandbox" && (b = k("#i" + t));
  ...
  if (await q(
    ...
    "classDiagram",
    t
  ), $.insertTitle(u, "classTitleText", (e == null ? void 0 : e.titleTopMargin) ?? 5, n.db.getDiagramTitle()), B(i, u, e == null ? void 0 : e.diagramPadding, e == null ? void 0 : e.useMaxWidth), !(e != null && e.htmlLabels)) {
    const T = s === "sandbox" ? b.nodes()[0].contentDocument : document, I = T.querySelectorAll('[id="' + t + '"] .edgeLabel .label');
    for (const w of I) {
