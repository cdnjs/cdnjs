...
const loader$i = async () => {
  const { diagram } = await import("./c4Diagram-2ae3841a.js");
...
const loader$h = async () => {
  const { diagram } = await import("./flowDiagram-ee152de2.js");
...
const loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-566a30e4.js");
...
const loader$f = async () => {
  const { diagram } = await import("./erDiagram-508b3995.js");
...
const loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-e326c88e.js");
...
const loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-18b8bb1d.js");
...
const loader$b = async () => {
  const { diagram } = await import("./pieDiagram-00db3e06.js");
...
const loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-61f3cb14.js");
...
const loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2682829a.js");
...
const loader$8 = async () => {
  const { diagram } = await import("./classDiagram-58722808.js");
...
const loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-4cc74290.js");
...
const loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-224b91ac.js");
...
const loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-03fb723d.js");
...
const loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-37931021.js");
...
const loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-99086e81.js");
...
const loader = async () => {
  const { diagram } = await import("./mindmap-definition-2a1985ac.js");
  return { id, diagram };
};
const plugin = {
  id,
...
//# sourceMappingURL=mermaidAPI-a1a81019.js.map
