import { m as gt } from "./mermaidAPI-f2dd6058.js";
...
var K = function() {
  var t = function(_, n, a, h) {
    for (a = a || {}, h = _.length; h--; a[_[h]] = n)
      ;
    return a;
  }, e = [1, 2], i = [1, 5], r = [6, 9, 11, 17, 18, 20, 22, 23, 24, 26], s = [1, 15], o = [1, 16], l = [1, 17], y = [1, 18], u = [1, 19], x = [1, 20], f = [1, 24], g = [4, 6, 9, 11, 17, 18, 20, 22, 23, 24, 26], p = {
    trace: function() {
    },
    yy: {},
    ...
    table: [{ 3: 1, 4: e, 7: 3, 12: 4, 26: i }, { 1: [3] }, t(r, [2, 3], { 5: 6 }), { 3: 7, 4: e, 7: 3, 12: 4, 26: i }, { 13: 8, 27: [1, 9] }, { 27: [2, 18] }, { 6: [1, 10], 7: 21, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: s, 18: o, 20: l, 22: y, 23: u, 24: x, 26: i }, { 1: [2, 2] }, { 14: 22, 15: [1, 23], 29: f }, t([15, 29], [2, 19]), t(r, [2, 8], { 1: [2, 1] }), t(r, [2, 4]), { 7: 21, 10: 25, 12: 4, 17: s, 18: o, 20: l, 22: y, 23: u, 24: x, 26: i }, t(r, [2, 6]), t(r, [2, 7]), t(r, [2, 11]), { 19: [1, 26] }, { 21: [1, 27] }, t(r, [2, 14]), t(r, [2, 15]), { 25: [1, 28] }, t(r, [2, 17]), { 11: [1, 29] }, { 16: 30, 28: [1, 31] }, { 11: [2, 21] }, t(r, [2, 5]), t(r, [2, 12]), t(r, [2, 13]), t(r, [2, 16]), t(g, [2, 9]), { 14: 32, 29: f }, { 29: [2, 20] }, { 11: [1, 33] }, t(g, [2, 10])],
    ...
    parse: function(n) {
      var a = this, h = [0], d = [], m = [null], c = [], R = this.table, k = "", z = 0, tt = 0, yt = 2, et = 1, pt = c.slice.call(arguments, 1), v = Object.create(this.lexer), A = { yy: {} };
      ...
      function ft() {
        var E;
        return E = d.pop() || v.lex() || et, typeof E != "number" && (E instanceof Array && (d = E, E = d.pop()), E = a.symbols_[E] || E), E;
      }
...
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : U = "Parse error on line " + (z + 1) + ": Unexpected " + (w == et ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(U, {
        ...
        switch (M[0]) {
          case 1:
            h.push(w), m.push(v.yytext), c.push(v.yylloc), h.push(M[1]), w = null, tt = v.yyleng, k = v.yytext, z = v.yylineno, H = v.yylloc;
            break;
          case 2:
...
const zt = function(t, e, i) {
  ...
  function t(s, o, l, y, u, x, f, g) {
    const p = o.append("text").attr("x", l + u / 2).attr("y", y + x / 2 + 5).style("font-color", g).style("text-anchor", "middle").text(s);
    r(p, f);
  }
  function e(s, o, l, y, u, x, f, g, p) {
    ...
    for (let n = 0; n < _.length; n++) {
      ...
      h.append("tspan").attr("x", l + u / 2).attr("dy", a).text(_[n]), h.attr("y", y + x / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), r(h, f);
    }
  }
  function i(s, o, l, y, u, x, f, g) {
    const p = o.append("switch"), b = p.append("foreignObject").attr("x", l).attr("y", y).attr("width", u).attr("height", x).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    b.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(s), e(s, p, l, y, u, x, f, g), r(b, f);
  }
  function r(s, o) {
    for (const l in o)
      l in o && s.attr(l, o[l]);
...
`);
  ...
  const u = y.select("#" + e);
  j.initGraphics(u);
  const x = r.db.getTasks(), f = r.db.getDiagramTitle(), g = r.db.getActors();
  for (const a in P)
    delete P[a];
  let p = 0;
  g.forEach((a) => {
  ...
  }), Gt(u), S.insert(0, 0, C, Object.keys(P).length * 50), Xt(u, x, 0);
  const T = S.getBounds();
  ...
  let y = 0, u = "#CCC", x = "black", f = 0;
  for (const [g, p] of e.entries()) {
    if (s !== p.section) {
      u = J[y % J.length], f = y % J.length, x = lt[y % lt.length];
      const b = {
      ...
      j.drawSection(t, b, r), s = p.section, y++;
    }
    const T = p.people.reduce((b, _) => (P[_] && (b[_] = P[_]), b), {});
    p.x = g * r.taskMargin + g * r.width + C, p.y = l, p.width = r.diagramMarginX, p.height = r.diagramMarginY, p.colour = x, p.fill = u, p.num = f, p.actors = T, j.drawTask(t, p, r), S.insert(p.x, p.y, p.x + p.width + r.taskMargin, 300 + 5 * 30);
  }
}, ct = {
  setConf: Wt,
  draw: Ht
...
//# sourceMappingURL=journeyDiagram-006423cd.js.map
