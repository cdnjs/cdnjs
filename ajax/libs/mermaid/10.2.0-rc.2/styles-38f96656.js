import { c as Y, g as Ht, s as Xt, a as Kt, b as Wt, y as Jt, z as qt, m as Qt, l as x, f as ht, A as Zt, a1 as te } from "./mermaid-72e0d5b8.js";
var mt = function() {
...
mt.parser = mt;
const Ie = mt, ee = "LR", Oe = "TB", Tt = "state", Rt = "relation", se = "classDef", ie = "applyClass", xt = "default", re = "divider", vt = "[*]", wt = "start", Bt = vt, $t = "end", It = "color", Ot = "fill", ne = "bgFill", ae = ",";
function Pt() {
  return {};
}
let Vt = ee, lt = [], P = Pt();
...
}, I = function(t, s = xt, n = null, h = null, u = null, f = null, p = null, v = null) {
  const d = t == null ? void 0 : t.trim();
  g.states[d] === void 0 ? (x.info("Adding state ", d, h), g.states[d] = {
    id: d,
    descriptions: [],
    type: s,
    doc: n,
    ...
    styles: [],
    textStyles: []
  }) : (g.states[d].doc || (g.states[d].doc = n), g.states[d].type || (g.states[d].type = s)), h && (x.info("Setting state description", d, h), typeof h == "string" && Et(d, h.trim()), typeof h == "object" && h.forEach((k) => Et(d, k.trim()))), u && (g.states[d].note = u, g.states[d].note.text = ht.sanitizeText(
    g.states[d].note.text,
    Y()
  )), f && (x.info("Setting state classes", d, f), (typeof f == "string" ? [f] : f).forEach((T) => Dt(d, T.trim()))), p && (x.info("Setting state styles", d, p), (typeof p == "string" ? [p] : p).forEach((T) => Ee(d, T.trim()))), v && (x.info("Setting state styles", d, p), (typeof v == "string" ? [v] : v).forEach((T) => xe(d, T.trim())));
}, Yt = function(t) {
  ot = {
    root: Ft()
