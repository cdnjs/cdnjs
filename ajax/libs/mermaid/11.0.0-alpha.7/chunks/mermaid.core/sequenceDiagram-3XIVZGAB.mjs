...
var autoWrap = /* @__PURE__ */ __name(() => {
  ...
  return getConfig2().sequence.wrap;
}, "autoWrap");
...
var parseBoxData = /* @__PURE__ */ __name(function(str) {
  ...
  return {
    color,
    text: title !== void 0 ? sanitizeText(title.replace(/^:?(?:no)?wrap:/, ""), getConfig2()) : void 0,
...
var drawActorTypeParticipant = /* @__PURE__ */ __name(async function(elem, actor, conf2, isFooter) {
...
var drawActorTypeActor = /* @__PURE__ */ __name(async function(elem, actor, conf2, isFooter) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  ...
  if (!isFooter) {
    actorCnt++;
    elem.append("line").attr("id", "actor" + actorCnt).attr("x1", center).attr("y1", centerY).attr("x2", center).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", actor.name);
    actor.actorCnt = actorCnt;
  }
...
var drawBox = /* @__PURE__ */ __name(async function(elem, box, conf2) {
...
var insertArrowHead = /* @__PURE__ */ __name(function(elem) {
  elem.append("defs").append("marker").attr("id", "arrowhead").attr("refX", 7.9).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 12).attr("markerHeight", 12).attr("orient", "auto").append("path").attr("d", "M -1 0 L 10 5 L 0 10 z");
}, "insertArrowHead");
...
var addActorRenderingData = /* @__PURE__ */ __name(async function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  let prevWidth = 0;
  let prevMargin = 0;
  let prevBox = void 0;
  let maxHeight = 0;
...
var draw = /* @__PURE__ */ __name(async function(_text, id, _version, diagObj) {
  ...
  for (const box2 of bounds.models.boxes) {
    ...
    await svgDraw_default.drawBox(diagram2, box2, conf);
  }
  if (hasBoxes) {
    bounds.bumpVerticalPos(conf.boxMargin);
  }
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    ...
    textDimensions = utils_default.calculateTextDimensions(
      shouldWrap ? utils_default.wrapLabel(
        msg.message,
        common_default.getMax(conf.width, actors[msg.from].width),
        noteFont(conf)
      ) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? common_default.getMax(conf.width, actors[msg.from].width) : common_default.getMax(
