...
// ../../node_modules/.pnpm/dompurify@3.0.11/node_modules/dompurify/dist/purify.js
var require_purify = __commonJS({
  "../../node_modules/.pnpm/dompurify@3.0.11/node_modules/dompurify/dist/purify.js"(exports, module) {
    "use strict";
...
var renderKatex = /* @__PURE__ */ __name(async (text, config2) => {
  ...
  const { default: katex } = await import("./katex-W7D3EZIJ.mjs");
  return text.split(lineBreakRegex).map(
    (line) => hasKatex(line) ? `<div style="display: flex; align-items: center; justify-content: center; white-space: nowrap;">
              ${line}
            </div>` : `<div>${line}</div>`
  ).join("").replace(
    katexRegex,
