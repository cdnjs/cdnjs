...
import {
  ...
  interpolateToCurve,
  utils_default
} from "./chunk-SQL7QJ3C.mjs";
import {
  isFunction_default,
  isPlainObject_default
} from "./chunk-TNAZEAIZ.mjs";
import {
  channel_default,
  clear,
  common_default,
...
var updateLink = /* @__PURE__ */ __name(function(positions, style) {
  positions.forEach(function(pos) {
    ...
    if (pos === "default") {
      ...
      if (utils_default.isSubstringInArray("fill", style) === -1) {
...
var setLink = /* @__PURE__ */ __name(function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = utils_default.formatUrl(linkStr, config);
...
// ../../node_modules/.pnpm/dagre-d3-es@7.0.10/node_modules/dagre-d3-es/src/dagre-js/util.js
function isSubgraph(g, v) {
  return !!g.children(v).length;
}
__name(isSubgraph, "isSubgraph");
function edgeToId(e) {
  return escapeId(e.v) + ":" + escapeId(e.w) + ":" + escapeId(e.name);
}
__name(edgeToId, "edgeToId");
var ID_DELIM = /:/g;
...
__name(applyTransition, "applyTransition");

// ../../node_modules/.pnpm/dagre-d3-es@7.0.10/node_modules/dagre-d3-es/src/dagre-js/label/add-html-label.js
...
var addVertices = /* @__PURE__ */ __name(async function(vert, g, svgId, root, doc, diagObj) {
...
var addEdges = /* @__PURE__ */ __name(async function(edges2, g, diagObj) {
  log.info("abc78 edges = ", edges2);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle2;
  ...
  for (const edge of edges2) {
    ...
    if (edge.interpolate !== void 0) {
      ...
      edgeData.curve = interpolateToCurve(edges2.defaultInterpolate, linear_default);
    } else {
    ...
    edgeData.label = await renderKatex(edge.text.replace(common_default.lineBreakRegex, "\n"), getConfig());
    if (edge.style === void 0) {
...
var draw = /* @__PURE__ */ __name(async function(text, id, _version, diagObj) {
  ...
  await addEdges(edges2, g, diagObj);
  const svg = root.select(`[id="${id}"]`);
  const element = root.select("#" + id + " g");
  await render(element, g, ["point", "circle", "cross"], "flowchart", id);
  utils_default.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
