...
var parser = function() {
  var o = /* @__PURE__ */ __name(function(k, v, o2, l) {
    for (o2 = o2 || {}, l = k.length; l--; o2[k[l]] = v)
      ;
    return o2;
  }, "o"), $V0 = [1, 3], $V1 = [1, 6], $V2 = [1, 4], $V3 = [1, 5], $V4 = [2, 5], $V5 = [1, 12], $V6 = [5, 7, 13, 19, 21, 23, 24, 26, 28, 31, 37, 40, 47], $V7 = [7, 13, 19, 21, 23, 24, 26, 28, 31, 37, 40], $V8 = [7, 12, 13, 19, 21, 23, 24, 26, 28, 31, 37, 40], $V9 = [7, 13, 47], $Va = [1, 42], $Vb = [1, 41], $Vc = [7, 13, 29, 32, 35, 38, 47], $Vd = [1, 55], $Ve = [1, 56], $Vf = [1, 57], $Vg = [7, 13, 32, 35, 42, 47];
  var parser2 = {
...
var commit = /* @__PURE__ */ __name(function(msg, id, type, tag) {
  log.debug("Entering commit:", msg, id, type, tag);
  id = common_default.sanitizeText(id, getConfig());
  msg = common_default.sanitizeText(msg, getConfig());
  tag = common_default.sanitizeText(tag, getConfig());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
...
var merge = /* @__PURE__ */ __name(function(otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = common_default.sanitizeText(otherBranch, getConfig());
  custom_id = common_default.sanitizeText(custom_id, getConfig());
...
var cherryPick = /* @__PURE__ */ __name(function(sourceId, targetId, tag, parentCommitId) {
  log.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = common_default.sanitizeText(sourceId, getConfig());
  targetId = common_default.sanitizeText(targetId, getConfig());
  tag = common_default.sanitizeText(tag, getConfig());
  parentCommitId = common_default.sanitizeText(parentCommitId, getConfig());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    const commit2 = {
      ...
      tag: tag ?? `cherry-pick:${sourceCommit.id}${sourceCommit.type === commitType.MERGE ? `|parent:${parentCommitId}` : ""}`
    };
    head = commit2;
    commits[commit2.id] = commit2;
    branches[curBranch] = commit2.id;
...
var setParallelBTPos = /* @__PURE__ */ __name((sortedKeys, commits2, defaultPos2, commitStep, layoutOffset) => {
  ...
  sortedKeys.forEach((key) => {
    ...
    const x = branchPos[commit2.branch].pos;
    const y = curPos + layoutOffset;
    commitPos[commit2.id] = { x, y };
  });
  curPos = maxPosition;
...
var drawCommits = /* @__PURE__ */ __name((svg, commits2, modifyGraph) => {
  ...
  sortedKeys.forEach((key) => {
    ...
    const y = dir === "TB" || dir === "BT" ? posWithOffset : branchPos[commit2.branch].pos;
    const x = dir === "TB" || dir === "BT" ? branchPos[commit2.branch].pos : posWithOffset;
    if (modifyGraph) {
      let typeClass;
