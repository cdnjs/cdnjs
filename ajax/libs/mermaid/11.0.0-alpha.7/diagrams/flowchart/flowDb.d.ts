 ...
 *
 */
export declare const getVertices: () => Record<string, FlowVertex>;
/**
 ...
 *
 */
export declare const getClasses: () => Record<string, FlowClass>;
/**
...
declare const _default: {
    ...
    getDirection: () => string;
    getVertices: () => Record<string, FlowVertex>;
    getEdges: () => FlowEdge[] & {
        defaultInterpolate?: string | undefined;
        defaultStyle?: string[] | undefined;
    };
    getClasses: () => Record<string, FlowClass>;
