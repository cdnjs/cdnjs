import { p as St, f as $ } from "./flowDb-03511daa.js";
import { h as S, u as Lt, r as Et, p as _t, l as Tt, d as D, f as tt, G as Nt } from "./layout-49db011e.js";
import { j as x, o as G, p as z, q as et, c as J, f as rt, l as I, r as V, t as At } from "./mermaid-17672fee.js";
import { a as N, b as at, i as nt, c as _, e as st, d as it, f as Ct, g as It } from "./styles-c4bf2442.js";
import { l as Bt } from "./line-d38762f6.js";
import { s as Mt } from "./selectAll-15c8cb5f.js";
import "./index-3cc6e2ca.js";
import "./edges-01e30c2b.js";
import "./createText-4e0f1f0c.js";
import "./svgDraw-b86ce8e1.js";
...
var q = function(r, e, t) {
  ...
  a.exit().remove(), a.enter().append("g").attr("class", "node").style("opacity", 0), a = r.selectAll("g.node"), a.each(function(i) {
    ...
    var d = c.append("g").attr("class", "label"), l = K(d, o), y = t[o.shape], h = _t(l.node().getBBox(), "width", "height");
    ...
    var p = y(u, h, o).classed("label-container", !0);
    N(p, o.style);
...
function ne(r, e, t, n) {
  var a, s, i, o, c, d, l, y, h, u, p, m, f, v, k;
  if (a = e.y - r.y, i = r.x - e.x, c = e.x * r.y - r.x * e.y, h = a * t.x + i * t.y + c, u = a * n.x + i * n.y + c, !(h !== 0 && u !== 0 && j(h, u)) && (s = n.y - t.y, o = t.x - n.x, d = n.x * t.y - t.x * n.y, l = s * r.x + o * r.y + d, y = s * e.x + o * e.y + d, !(l !== 0 && y !== 0 && j(l, y)) && (p = a * o - s * i, p !== 0)))
    return m = Math.abs(p / 2), f = i * d - o * c, v = f < 0 ? (f - m) / p : (f + m) / p, f = s * c - a * d, k = f < 0 ? (f - m) / p : (f + m) / p, { x: v, y: k };
}
function j(r, e) {
  return r * e > 0;
}
function T(r, e, t) {
  ...
  return s.length ? (s.length > 1 && s.sort(function(p, m) {
    var f = p.x - t.x, v = p.y - t.y, k = Math.sqrt(f * f + v * v), B = m.x - t.x, E = m.y - t.y, U = Math.sqrt(B * B + E * E);
...
function ye(r) {
  r.shapes().question = ct, r.shapes().hexagon = dt, r.shapes().stadium = gt, r.shapes().subroutine = mt, r.shapes().cylinder = wt, r.shapes().rect_left_inv_arrow = ht, r.shapes().lean_right = ut, r.shapes().lean_left = ft, r.shapes().trapezoid = pt, r.shapes().inv_trapezoid = yt, r.shapes().rect_right_inv_arrow = vt;
}
function ve(r) {
  r({ question: ct }), r({ hexagon: dt }), r({ stadium: gt }), r({ subroutine: mt }), r({ cylinder: wt }), r({ rect_left_inv_arrow: ht }), r({ lean_right: ut }), r({ lean_left: ft }), r({ trapezoid: pt }), r({ inv_trapezoid: yt }), r({ rect_right_inv_arrow: vt });
}
function A(r, e, t, n) {
...
const ge = {
  ...
  Object.keys(r).forEach(function(d) {
    ...
    if (et(J().flowchart.htmlLabels)) {
      ...
      p = at(i, v).node(), p.parentNode.removeChild(p);
    } else {
...
`), i.style === void 0 && (l.style = l.style || "stroke: #333; stroke-width: 1.5px;fill:none"), l.labelStyle = l.labelStyle.replace("color:", "fill:"))), l.id = o, l.class = c + " " + d, l.minlen = i.length || 1, e.setEdge(t.db.lookUpDomId(i.start), t.db.lookUpDomId(i.end), l, n);
  ...
  d === void 0 && (d = "TD");
  const l = s.nodeSpacing || 50, y = s.rankSpacing || 50, h = new Nt({
    multigraph: !0,
    compound: !0
  }).setGraph({
    rankdir: d,
