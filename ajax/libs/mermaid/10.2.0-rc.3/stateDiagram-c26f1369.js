import { d as N, p as C, s as U } from "./styles-19ae0830.js";
import { c as t, B as F, x as O, f as L, l as b, j as H, k as X } from "./mermaid-17672fee.js";
import { G as P, l as J } from "./layout-49db011e.js";
import { l as Y } from "./line-d38762f6.js";
...
const T = {}, $ = (e, n) => {
  ...
  n.type === "start" && j(s), n.type === "end" && Q(s), (n.type === "fork" || n.type === "join") && V(s, n), n.type === "note" && et(n.note.text, s), n.type === "divider" && q(s), n.type === "default" && n.descriptions.length === 0 && Z(s, n), n.type === "default" && n.descriptions.length > 0 && D(s, n);
