...
` + o + "^";
      ...
      next: function() {
        ...
        return o ? (a = this.test_match(o, X[i]), a !== !1 ? a : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
O2.parser = O2;
const et = O2, Ye = "flowchart-";
let J2 = 0, G2 = w2(), z = {}, J1 = [], t2 = {}, W1 = [], C2 = {}, K2 = {}, F2 = 0, P2 = !0, f1, _2, B2 = [];
const T2 = (e) => We.sanitizeText(e, G2), $2 = function(e, u, n) {
  Ke.parseDirective(this, e, u, n);
}, c2 = function(e) {
  ...
  H !== void 0 && H.trim().length !== 0 && (z[H] === void 0 && (z[H] = {
    ...
    styles: [],
    classes: []
  }), J2++, u !== void 0 ? (G2 = w2(), u1 = T2(u.text.trim()), z[H].labelType = u.type, u1[0] === '"' && u1[u1.length - 1] === '"' && (u1 = u1.substring(1, u1.length - 1)), z[H].text = u1) : z[H].text === void 0 && (z[H].text = e), n !== void 0 && (z[H].type = n), r != null && r.forEach(function(s1) {
    z[H].styles.push(s1);
  ...
  e.split(",").forEach(function(r) {
    z[r] !== void 0 && (z[r].link = M2.formatUrl(u, G2), z[r].linkTarget = n);
  }), y2(e, "clickable");
}, ce = function(e) {
  return K2[e];
}, oe = function(e, u, n) {
...
const Ee = function(e = "gen-1") {
  z = {}, t2 = {}, J1 = [], B2 = [pe], W1 = [], C2 = {}, F2 = 0, K2 = [], P2 = !0, _2 = e, je();
}, be = (e) => {
  _2 = e || "gen-2";
}, ke = function() {
  ...
  return U2.info("Adding", s1.id, s1.nodes, s1.dir), s1.nodes = me(s1, W1).nodes, W1.push(s1), C2[r] = s1, r;
}, Qe = function(e) {
