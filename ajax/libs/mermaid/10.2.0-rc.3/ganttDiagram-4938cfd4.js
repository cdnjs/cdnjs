import { G as yn, H as kn, R as pn, I as vn, J as ar, K as sr, L as ve, M as je, N as qe, O as or, P as se, Q as cr, S as oe, W as ur, Y as lr, T as fr, c as xt, s as hr, g as dr, y as mr, z as gr, b as yr, a as kr, U as rt, m as pr, A as vr, e as Tr, x as xr, l as Te, j as Ht, k as br, f as Mr } from "./mermaid-17672fee.js";
...
function ai(t, e) {
  ...
  if (!n)
    return t + "";
  var r = n[0], i = n[1], a = i - (An = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1, s = r.length;
  ...
  function h(p) {
    ...
    function y(u) {
      ...
      if (N === "c")
        ...
        u = +u;
        var Z = u < 0 || 1 / u < 0;
        if (u = isNaN(u) ? f : w(Math.abs(u), O), V && (u = ii(u)), Z && +u == 0 && _ !== "+" && (Z = !1), l = (Z ? _ === "(" ? _ : c : _ === "-" || _ === "(" ? "" : _) + l, M = (N === "s" ? Ke[8 + An / 3] : "") + M + (Z && _ === "(" ? ")" : ""), d) {
...
function pi(t) {
  ...
  return t.ticks = function(n) {
    var r = e();
    return Ar(r[0], r[r.length - 1], n ?? 10);
...
const [Ai, Yi] = Fi(yt, ne, Ct, Dt, te, Kt);
function ye(t) {
  if (0 <= t.y && t.y < 100) {
...
function Ia() {
  return Tn.apply(Xn(Ai, Yi, yt, ne, Ct, Dt, te, Kt, Nt, ie).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
var _e = function() {
  var t = function(w, d, y, u) {
    ...
    parse: function(d) {
      var y = this, u = [0], l = [], M = [null], o = [], E = this.table, g = "", Z = 0, j = 0, K = 2, T = 1, F = o.slice.call(arguments, 1), A = Object.create(this.lexer), Y = { yy: {} };
...
rt.extend(Ka);
rt.extend(ts);
let ct = "", ze = "", Oe, Pe = "", zt = [], Ot = [], He = {}, Ve = [], ae = [], Ft = "", Re = "";
const $n = ["active", "done", "crit", "milestone"];
let Be = [], Pt = !1, Ze = !1, Fe = 0;
const es = function(t, e, n) {
  pr.parseDirective(this, t, e, n);
}, ns = function() {
  Ve = [], ae = [], Ft = "", Be = [], qt = 0, Ye = void 0, Xt = void 0, G = [], ct = "", ze = "", Re = "", Oe = void 0, Pe = "", zt = [], Ot = [], Pt = !1, Ze = !1, Fe = 0, He = {}, vr();
}, rs = function(t) {
  ze = t;
}, is = function() {
  return ze;
...
const er = {}, _s = function(t, e) {
  ...
  r.length === 0 && r.push(t), At(t) !== void 0 && rr(t, () => {
    xr.runFunc(e, ...r);
  });
}, rr = function(t, e) {
  Be.push(
