import { i as V, G as q } from "./layout-49db011e.js";
import { v as M, p as N, l as u, q as R, c as C, f as I, r as $, o as E, j as _, x as F, t as U } from "./mermaid-17672fee.js";
import { f as H } from "./flowDb-03511daa.js";
import { r as W } from "./index-3cc6e2ca.js";
import { s as X } from "./selectAll-15c8cb5f.js";
function oe(e, l) {
...
const G = {}, Y = function(e) {
  ...
  e.forEach(function(o) {
    ...
    const k = "LS-" + o.start, h = "LE-" + o.end, t = { style: "", labelStyle: "" };
...
`), o.style === void 0 && (t.style = t.style || "stroke: #333; stroke-width: 1.5px;fill:none;"), t.labelStyle = t.labelStyle.replace("color:", "fill:"), t.id = r, t.classes = "flowchart-link " + k + " " + h, l.setEdge(o.start, o.end, t, a);
  ...
  z(n, t, l, k, h, a), P(m, t);
  const T = k.select(`[id="${l}"]`), S = k.select("#" + l + " g");
  if (await W(S, t, ["point", "circle", "cross"], "flowchart", l), F.insertTitle(T, "flowchartTitleText", w.titleTopMargin, a.db.getDiagramTitle()), U(t, T, w.diagramPadding, w.useMaxWidth), a.db.indexNodes("subGraph" + g), !w.htmlLabels) {
