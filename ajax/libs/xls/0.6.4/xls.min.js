...
function parse_compobj(obj){var v={};var o=obj.content;var l=28,m;m=__lpstr(o,l);l+=4+__readUInt32LE(o,l);v.UserType=m;m=__readUInt32LE(o,l);l+=4;switch(m){case 0:break;case 4294967295:case 4294967294:l+=4;break;default:if(m>400)throw new Error("Unsupported Clipboard: "+m.toString(16));l+=m}m=__lpstr(o,l);l+=m.length===0?0:5+m.length;v.Reserved1=m;if((m=__readUInt32LE(o,l))!==1907550708)return v;throw"Unsupported Unicode Extension"}function parse_xlscfb(cfb){reset_cp();var CompObj=cfb.find("!CompObj");var Summary=cfb.find("!SummaryInformation");var Workbook=cfb.find("/Workbook");if(!Workbook)Workbook=cfb.find("/Book");var CompObjP,SummaryP,WorkbookP;function slurp(R,blob,length,opts){var read=blob.read_shift.bind(blob);var l=length;var bufs=[blob.slice(blob.l,blob.l+l)];blob.l+=length;var next=RecordEnum[__readUInt16LE(blob,blob.l)];while(next&&next.n==="Continue"){l=__readUInt16LE(blob,blob.l+2);bufs.push(blob.slice(blob.l+4,blob.l+4+l));blob.l+=4+l;next=RecordEnum[__readUInt16LE(blob,blob.l)]}var b=bconcat(bufs);prep_blob(b);var ll=0;b.lens=[];bufs.forEach(function(x){b.lens.push(ll);ll+=x.length});return R.f(b,b.length,opts)}function parse_workbook(blob){var wb={opts:{}};var Sheets={};var out=[];var read=blob.read_shift.bind(blob);var lst=[],seen={};var Directory={};var found_sheet=false;var range={};var last_formula=null;var sst=[];var cur_sheet="";var Preamble={};var lastcell,last_cell;var shared_formulae={};var temp_val;var XFs=[];function addline(cell,line){lastcell=cell;last_cell=encode_cell(cell);out[last_cell]=line}var opts={enc:false,sbcch:0,snames:[],sharedf:shared_formulae,rrtabid:[],lastuser:"",codepage:0,winlocked:0,wtf:false};var supbooks=[[]];var sbc=0,sbci=0,sbcli=0;supbooks.SheetNames=opts.snames;supbooks.sharedf=opts.sharedf;var last_Rn="";var file_depth=0;while(blob.l<blob.length-1){var s=blob.l;var RecordType=read(2);if(RecordType===0&&last_Rn==="EOF")break;var length=blob.l===blob.length?0:read(2),y;var R=RecordEnum[RecordType];if(R&&R.f){last_Rn=R.n;if(R.r===2||R.r==12){var rt=read(2);length-=2;if(!opts.enc&&rt!==RecordType)throw"rt mismatch";if(R.r==12){blob.l+=10;length-=10}}var val;if(R.n==="EOF")val=R.f(blob,length,opts);else val=slurp(R,blob,length,opts);switch(R.n){case"Date1904":wb.opts.Date1904=val;break;case"WriteProtect":wb.opts.WriteProtect=true;break;case"FilePass":opts.enc=val;if(XLS.verbose>=2)console.error(val);throw new Error("Password protection unsupported");case"WriteAccess":opts.lastuser=val;break;case"FileSharing":break;case"CodePage":opts.codepage=val;if(typeof current_codepage!=="undefined")current_codepage=val;if(typeof current_cptable!=="undefined")current_cptable=cptable[val];break;case"RRTabId":opts.rrtabid=val;break;case"WinProtect":opts.winlocked=val;break;case"Template":break;case"RefreshAll":wb.opts.RefreshAll=val;break;case"BookBool":break;case"UsesELFs":break;case"MTRSettings":{if(val[0]&&val[1])throw"Unsupported threads: "+val}break;case"CalcCount":wb.opts.CalcCount=val;break;case"CalcDelta":wb.opts.CalcDelta=val;break;case"CalcIter":wb.opts.CalcIter=val;break;case"CalcMode":wb.opts.CalcMode=val;break;case"CalcPrecision":wb.opts.CalcPrecision=val;break;case"CalcSaveRecalc":wb.opts.CalcSaveRecalc=val;break;case"CalcRefMode":opts.CalcRefMode=val;break;case"Uncalced":break;case"ForceFullCalculation":wb.opts.FullCalc=val;break;case"WsBool":break;case"Header":break;case"Footer":break;case"HCenter":break;case"VCenter":break;case"Pls":break;case"Setup":break;case"DefColWidth":break;case"GCW":break;case"LHRecord":break;case"ColInfo":break;case"Row":break;case"DBCell":break;case"MulBlank":break;case"EntExU2":break;case"SxView":break;case"Sxvd":break;case"SXVI":break;case"SXVDEx":break;case"SxIvd":break;case"SXDI":break;case"SXLI":break;case"SXEx":break;case"QsiSXTag":break;case"Selection":break;case"Feat":break;case"FeatHdr":case"FeatHdr11":break;case"Feature11":case"Feature12":case"List12":break;case"Blank":break;case"Country":break;case"RecalcId":break;case"DefaultRowHeight":case"DxGCol":break;case"Fbi":case"Fbi2":case"GelFrame":break;case"Font":break;case"XF":XFs.push(val);break;case"XFCRC":break;case"XFExt":break;case"Style":break;case"StyleExt":break;case"Palette":break;case"ClrtClient":break;case"Theme":break;case"ExtSST":break;case"BookExt":break;case"RichTextStream":break;case"BkHim":break;case"ScenarioProtect":break;case"ObjProtect":break;case"CondFmt12":break;case"Table":break;case"TableStyles":break;case"SXStreamID":break;case"SXVS":break;case"DConRef":break;case"SXAddl":break;case"ScenMan":break;case"DCon":break;case"CellWatch":break;case"PrintRowCol":break;case"PrintGrid":break;case"PrintSize":break;case"SupBook":supbooks[++sbc]=[val];sbci=0;break;case"ExternName":supbooks[sbc][++sbci]=val;break;case"XCT":break;case"CRN":break;case"Index":break;case"Lbl":supbooks[0][++sbcli]=val;break;case"ExternSheet":supbooks[sbc]=supbooks[sbc].concat(val);sbci+=val.length;break;case"Protect":out["!protect"]=val;break;case"Password":if(val!==0&&XLS.verbose>=2)console.error("Password verifier: "+val);break;case"Prot4Rev":case"Prot4RevPass":break;case"BoundSheet8":{Directory[val.pos]=val;opts.snames.push(val.name)}break;case"EOF":{if(--file_depth)break;var nout={};if(range.e){out["!range"]=range;if(range.e.r>0&&range.e.c>0){range.e.r--;range.e.c--;out["!ref"]=encode_range(range);range.e.r++;range.e.c++}}for(y in out)if(out.hasOwnProperty(y))nout[y]=out[y];if(cur_sheet==="")Preamble=nout;else Sheets[cur_sheet]=nout}break;case"BOF":{if(file_depth++)break;out={};cur_sheet=(Directory[s]||{name:""}).name;lst.push([R.n,s,val,Directory[s]])}break;case"Number":{temp_val={ixfe:val.ixfe,XF:XFs[val.ixfe],v:val.val,t:"n"};addline({c:val.c,r:val.r},temp_val)}break;case"BoolErr":{temp_val={ixfe:val.ixfe,XF:XFs[val.ixfe],v:val.val,t:val.t};addline({c:val.c,r:val.r},temp_val)}break;case"RK":{temp_val={ixfe:val.ixfe,XF:XFs[val.ixfe],v:val.rknum,t:"n"};addline({c:val.c,r:val.r},temp_val)}break;case"MulRk":{for(var j=val.c;j<=val.C;++j){var ixfe=val.rkrec[j-val.c][0];addline({c:j,r:val.r},{ixfe:ixfe,XF:XFs[ixfe],v:val.rkrec[j-val.c][1],t:"n"})}}break;case"Formula":{switch(val.val){case"String":last_formula=val;break;case"Array Formula":throw"Array Formula unsupported";default:addline(val.cell,{v:val.val,f:stringify_formula(val.formula,range,val.cell,supbooks),ixfe:val.cell.ixfe,XF:XFs[val.cell.ixfe],t:"n"})}}break;case"String":{if(last_formula){last_formula.val=val;addline(last_formula.cell,{v:last_formula.val,f:stringify_formula(last_formula.formula,range,last_formula.cell,supbooks),ixfe:last_formula.cell.ixfe,t:"s"});last_formula=null}}break;case"Array":{}break;case"ShrFmla":{out[last_cell].f=stringify_formula(val[0],range,lastcell,supbooks);shared_formulae[last_cell]=val[0]}break;case"LabelSst":{addline({c:val.c,r:val.r},{v:sst[val.isst].t,ixfe:val.ixfe,t:"s"})}break;case"Label":{addline({c:val.c,r:val.r},{v:val.val,ixfe:val.ixfe,t:"s"})}break;case"Dimensions":{range=val}break;case"SST":{sst=val}break;case"Format":{SSF.load(val[1],val[0])}break;case"Scl":{}break;case"SheetExt":{}break;case"SheetExtOptional":{}break;case"ObNoMacros":{}break;case"ObProj":{}break;case"CodeName":{}break;case"GUIDTypeLib":{}break;case"MergeCells":break;case"WOpt":break;case"HLink":case"HLinkTooltip":break;case"PhoneticInfo":break;case"OleObjectSize":break;case"TxO":break;case"DXF":case"DXFN":case"DXFN12":case"DXFN12List":case"DXFN12NoCB":break;case"Dv":case"DVal":break;case"BRAI":case"Series":case"SeriesText":break;case"DConn":break;case"DbOrParamQry":break;case"DBQueryExt":break;case"IFmtRecord":break;case"CondFmt":case"CF":case"CF12":case"CFEx":break;case"Note":break;case"NameCmt":break;case"Dat":case"Begin":case"End":case"StartBlock":case"EndBlock":case"Frame":case"Area":case"Axis":case"AxisLine":case"Tick":break;case"AxesUsed":case"CrtLayout12":case"CrtLayout12A":case"CrtLink":case"CrtLine":case"CrtMlFrt":break;case"LineFormat":case"AreaFormat":case"Chart":case"Chart3d":case"Chart3DBarShape":case"ChartFormat":case"ChartFrtInfo":break;case"PlotArea":case"PlotGrowth":break;case"SeriesList":case"SerParent":case"SerAuxTrend":break;case"DataFormat":case"SerToCrt":case"FontX":break;case"CatSerRange":case"AxcExt":case"SerFmt":break;case"ShtProps":break;case"DefaultText":case"Text":case"CatLab":break;case"DataLabExtContents":break;case"Legend":case"LegendException":break;case"Pie":case"Scatter":break;case"PieFormat":case"MarkerFormat":break;case"StartObject":case"EndObject":break;case"AlRuns":case"ObjectLink":break;case"SIIndex":break;case"AttachedLabel":break;case"Line":case"Bar":break;case"Surf":break;case"AxisParent":break;case"Pos":break;case"ValueRange":break;case"SXViewEx9":break;case"SXViewLink":break;case"PivotChartBits":break;case"SBaseRef":break;case"TextPropsStream":break;case"LnExt":break;case"MkrExt":break;case"CrtCoopt":break;case"Qsi":case"Qsif":case"Qsir":case"QsiSXTag":break;case"TxtQry":break;case"FilterMode":break;case"AutoFilter":case"AutoFilterInfo":break;case"DropDownObjIds":break;case"Sort":break;case"SortData":break;case"ShapePropsStream":break;case"MsoDrawing":case"MsoDrawingGroup":case"MsoDrawingSelection":break;case"Obj":break;case"ImData":break;case"Excel9File":break;case"Units":break;case"InterfaceHdr":case"Mms":case"InterfaceEnd":case"DSF":case"BuiltInFnGroupCount":case"Window1":case"Window2":case"HideObj":case"GridSet":case"Guts":case"UserBView":case"UserSViewBegin":case"UserSViewEnd":case"Pane":case"WebPub":case"AutoWebPub":case"RightMargin":case"LeftMargin":case"TopMargin":case"BottomMargin":case"HeaderFooter":case"HFPicture":case"PLV":case"HorizontalPageBreaks":case"VerticalPageBreaks":case"Backup":case"CompressPictures":case"Compat12":break;case"Continue":case"ContinueFrt12":break;default:throw"Unrecognized Record "+R.n}lst.push([R.n,s,val]);continue}lst.push(["Unrecognized",Number(RecordType).toString(16),RecordType]);read(length)}var sheetnamesraw=Object.keys(Directory).sort(function(a,b){return Number(a)-Number(b)}).map(function(x){return Directory[x].name});var sheetnames=[];sheetnamesraw.forEach(function(x){sheetnames.push(x)});wb.Directory=sheetnamesraw;wb.SheetNames=sheetnamesraw;wb.Sheets=Sheets;wb.Preamble=Preamble;wb.Strings=sst;wb.SSF=SSF.get_table();if(opts.enc)wb.Encryption=opts.enc;return wb}if(Workbook)WorkbookP=parse_workbook(Workbook.content);else throw new Error("Cannot find Workbook stream");if(CompObj)CompObjP=parse_compobj(CompObj);return WorkbookP}function format_cell(cell,v){if(!cell)return"";if(typeof cell.w!=="undefined")return cell.w;if(typeof v==="undefined")v=cell.v;if(!cell.XF)return v;try{cell.w=SSF.format(cell.XF.ifmt||0,v)}catch(e){return v}return cell.w}function sheet_to_row_object_array(sheet,opts){var val,row,r,hdr={},isempty,R,C,v;var out=[];opts=opts||{};if(!sheet["!ref"])return out;r=utils.decode_range(sheet["!ref"]);for(R=r.s.r,C=r.s.c;C<=r.e.c;++C){val=sheet[utils.encode_cell({c:C,r:R})];if(!val)continue;hdr[C]=format_cell(val)}for(R=r.s.r+1;R<=r.e.r;++R){isempty=true;row=Object.create({__rowNum__:R});for(C=r.s.c;C<=r.e.c;++C){val=sheet[utils.encode_cell({c:C,r:R})];if(!val)continue;v=(val||{}).v;switch(val.t){case"e":continue;case"s":case"str":break;case"b":case"n":break;default:throw"unrecognized type "+val.t}if(typeof v!=="undefined"){row[hdr[C]]=opts.raw?v||val.v:format_cell(val,v);isempty=false}}if(!isempty)out.push(row)}return out}function sheet_to_csv(sheet,opts){var out="",txt="";opts=opts||{};if(!sheet["!ref"])return out;var r=utils.decode_range(sheet["!ref"]);for(var R=r.s.r;R<=r.e.r;++R){var row=[];for(var C=r.s.c;C<=r.e.c;++C){var val=sheet[utils.encode_cell({c:C,r:R})];if(!val){row.push("");continue}txt=format_cell(val);row.push(String(txt).replace(/\\n/g,"\n").replace(/\\t/g,"	").replace(/\\\\/g,"\\").replace(/\\\"/g,'""'))}out+=row.join(opts.FS||",")+(opts.RS||"\n")}return out}var make_csv=sheet_to_csv;function get_formulae(ws){var cmds=[];for(var y in ws)if(y[0]!=="!"&&ws.hasOwnProperty(y)){var x=ws[y];var val="";if(x.f)val=x.f;else if(typeof x.v==="number")val=x.v;else val=x.v;cmds.push(y+"="+val)}return cmds}var utils={encode_col:encode_col,encode_row:encode_row,encode_cell:encode_cell,encode_range:encode_range,decode_col:decode_col,decode_row:decode_row,split_cell:split_cell,decode_cell:decode_cell,decode_range:decode_range,sheet_to_csv:sheet_to_csv,make_csv:sheet_to_csv,get_formulae:get_formulae,format_cell:format_cell,sheet_to_row_object_array:sheet_to_row_object_array};function xlsread(f,options){return parse_xlscfb(CFB.read(f,options))}var readFile=function(f){return parse_xlscfb(CFB.read(f,{type:"file"}))};function decode_row(rowstr){return Number(unfix_row(rowstr))-1}function encode_row(row){return""+(row+1)}function fix_row(cstr){return cstr.replace(/([A-Z]|^)([0-9]+)$/,"$1$$$2")}function unfix_row(cstr){return cstr.replace(/\$([0-9]+)$/,"$1")}function decode_col(colstr){var c=unfix_col(colstr),d=0,i=0;for(;i!==c.length;++i)d=26*d+c.charCodeAt(i)-64;return d-1}function encode_col(col){var s="";for(++col;col;col=Math.floor((col-1)/26))s=String.fromCharCode((col-1)%26+65)+s;return s}function fix_col(cstr){return cstr.replace(/^([A-Z])/,"$$$1")}function unfix_col(cstr){return cstr.replace(/^\$([A-Z])/,"$1")}function split_cell(cstr){return cstr.replace(/(\$?[A-Z]*)(\$?[0-9]*)/,"$1,$2").split(",")}function decode_cell(cstr){var splt=split_cell(cstr);return{c:decode_col(splt[0]),r:decode_row(splt[1])}}function encode_cell(cell){return encode_col(cell.c)+encode_row(cell.r)}function fix_cell(cstr){return fix_col(fix_row(cstr))}function unfix_cell(cstr){return unfix_col(unfix_row(cstr))}function decode_range(range){var x=range.split(":").map(decode_cell);return{s:x[0],e:x[x.length-1]}}function encode_range(cs,ce){if(typeof ce==="undefined"||typeof ce==="number")return encode_range(cs.s,cs.e);if(typeof cs!=="string")cs=encode_cell(cs);if(typeof ce!=="string")ce=encode_cell(ce);return cs==ce?cs:cs+":"+ce}function shift_cell(cell,tgt){if(tgt.s){if(cell.cRel)cell.c+=tgt.s.c;if(cell.rRel)cell.r+=tgt.s.r}else{cell.c+=tgt.c;cell.r+=tgt.r}cell.cRel=cell.rRel=0;while(cell.c>=256)cell.c-=256;while(cell.r>=65536)cell.r-=65536;return cell}function shift_range(cell,range){cell.s=shift_cell(cell.s,range.s);cell.e=shift_cell(cell.e,range.s);return cell}XLS.parse_xlscfb=parse_xlscfb;XLS.read=xlsread;XLS.readFile=readFile;XLS.utils=utils;XLS.CFB=CFB;XLS.SSF=SSF;if(typeof module!=="undefined"&&require.main===module){var wb=readFile(process.argv[2]||"Book1.xls");var target_sheet=process.argv[3]||"";if(target_sheet==="")target_sheet=wb.Directory[0];var ws=wb.Sheets[target_sheet];console.log(target_sheet);console.log(make_csv(ws))}})(typeof exports!=="undefined"?exports:XLS);