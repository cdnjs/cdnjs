var libh3 = function (libh3) {
  ...
  function (global, env, buffer) {
    ...
    function ga(a, c, d, e) {
      ...
      a = ((c | 0) < 0) << 31 >> 31;
      g = (i | 0) < (a | 0) | (i | 0) == (a | 0) & h >>> 0 < c >>> 0;
      h = gd((g ? c : h) | 0, (g ? a : i) | 0, 12, 0) | 0;
      i = G() | 0;
      b[e >> 2] = h;
      b[e + 4 >> 2] = i;
      e = 0;
    ...
    function ha(a, c, d, f, g, h, i) {
      ...
      a: while (1) {
        ...
        if ((u | 0) > 0 | (u | 0) == 0 & t >>> 0 > 0) {
          v = +(t >>> 0) + 4294967296.0 * +(u | 0);
          w = 0;
          x = 0;

          do {
            N = +e[F >> 3];
            j = hd(t | 0, u | 0, w | 0, x | 0) | 0;
            M = +(j >>> 0) + 4294967296.0 * +(G() | 0);
            L = +(w >>> 0) + 4294967296.0 * +(x | 0);
            e[I >> 3] = N * M / v + +e[H >> 3] * L / v;
            e[E >> 3] = +e[C >> 3] * M / v + +e[D >> 3] * L / v;
            j = Jb(I, f, A) | 0;
            if (j | 0) { break a; }
            s = A;
            r = b[s >> 2] | 0;
            s = b[s + 4 >> 2] | 0;
            m = od(r | 0, s | 0, c | 0, d | 0) | 0;
            o = G() | 0;
            j = i + (m << 3) | 0;
            l = j;
            k = b[l >> 2] | 0;
            ...
            b: do { if ((k | 0) == 0 & (l | 0) == 0) {
              ...
              while (1) {
                ...
                if ((k | 0) == (r | 0) & (n | 0) == (s | 0)) { break b; }
                l = gd(m | 0, j | 0, 1, 0) | 0;
                m = nd(l | 0, G() | 0, c | 0, d | 0) | 0;
                j = G() | 0;
                q = gd(q | 0, p | 0, 1, 0) | 0;
                p = G() | 0;
                l = i + (m << 3) | 0;
    ...
    function ia(a, c, d, e) {
      ...
      a: do { if (!d) {
        b: do { if ((b[m >> 2] | 0) > 0) {
          ...
          while (1) {
            d = ha((b[h >> 2] | 0) + (g << 3) | 0, D, E, c, F, f, j) | 0;
            g = g + 1 | 0;
            if (d | 0) { break; }
            if ((g | 0) >= (b[m >> 2] | 0)) { break b; }
          }
              ...
              while (1) {
                ...
                e: do { if (!((o | 0) == 0 & (p | 0) == 0)) {
                  ...
                  if (!((j | 0) == 0 & (l | 0) == 0)) {
                    ...
                    do {
                      if ((c | 0) > (E | 0) | (c | 0) == (E | 0) & n >>> 0 > D >>> 0) { break d; }
    ...
    function ya(a, c) {
      ...
      e[j >> 3] = +e[a + 24 >> 3];
      l = +Xb(d, f);
      k = +A(+(l * l / +sd(+ +q(+((+e[g >> 3] - +e[j >> 3]) / (+e[d >> 3] - +e[f >> 3]))), 3.0) / (k * (k * 2.59807621135) * .8)));
      j = ~~k >>> 0;
      g = +q(k) >= 1.0 ? k > 0.0 ? ~~+C(+p(k / 4294967296.0), 4294967295.0) >>> 0 : ~~+A((k - +(~~k >>> 0)) / 4294967296.0) >>> 0 : 0;
      h = (j | 0) == 0 & (g | 0) == 0;
      F((h ? 0 : g) | 0);
      S = i;
      return (h ? 1 : j) | 0;
    ...
    function Ya(a, c, d, e, f) {
      ...
      if (g >>> 0 > 1) {
        ...
        do { if ((b[h >> 2] | 0) == (b[i >> 2] | 0) ? (b[h + 4 >> 2] | 0) == (b[i + 4 >> 2] | 0) : 0) {
          i = (g ^ 15) * 3 | 0;
          h = qd(a | 0, c | 0, i | 0) | 0;
          G() | 0;
          h = h & 7;
          ...
          G() | 0;
          i = i & 7;
          if ((!((h | 0) == 0 | (i | 0) == 0) ? (b[15536 + (h << 2) >> 2] | 0) != (i | 0) : 0) ? (b[15568 + (h << 2) >> 2] | 0) != (i | 0) : 0) { break; }
          b[f >> 2] = 1;
          f = 0;
          S = k;
          return f | 0;
      ...
      if (((((!((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0) ? (c = j + 8 | 0, !((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0)) : 0) ? (c = j + 16 | 0, !((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0)) : 0) ? (c = j + 24 | 0, !((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0)) : 0) ? (c = j + 32 | 0, !((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0)) : 0) ? (c = j + 40 | 0, !((b[c >> 2] | 0) == (d | 0) ? (b[c + 4 >> 2] | 0) == (e | 0) : 0)) : 0) {
        g = j + 48 | 0;
    ...
    function Rc(a, c, d, e) {
      ...
      if (!(!l ? (s = rd(7, 0, (k ^ 15) * 3 | 0) | 0, (s & a | 0) == 0 & ((G() | 0) & c | 0) == 0) : 0)) {
        f = (ub(a, c) | 0) != 0;
        ...
        j = b[h >> 2] | 0;
        h = b[h + 4 >> 2] | 0;
        g = h >>> 0 < c >>> 0 | (h | 0) == (c | 0) & j >>> 0 < a >>> 0;
        f = g ? j : a;
        g = g ? h : c;
        if (!(!l ? (l = rd(7, 0, (k ^ 15) * 3 | 0) | 0, (j & l | 0) == 0 & (h & (G() | 0) | 0) == 0) : 0)) { o = 13; }

        a: do { if ((o | 0) == 13) {
          h = (d + -1 + i | 0) % (i | 0) | 0;
          i = ub(a, c) | 0;

          do { if ((h | 0) >= 0 ? (m = (i | 0) != 0, ((m ? 4 : 5) | 0) >= (h | 0)) : 0) {
            if (Qc(a, c, v) | 0) { break; }
            h = (b[v >> 2] | 0) + h | 0;
            if (m) { h = 22288 + (((h | 0) % 5 | 0) << 2) | 0; }else { h = 22320 + (((h | 0) % 6 | 0) << 2) | 0; }
            h = b[h >> 2] | 0;
            ...
            if ((h | 0) != 7) {
              ...
              if (j >>> 0 < g >>> 0 | (j | 0) == (g | 0) & i >>> 0 < f >>> 0) {
                if (!(ub(i, j) | 0)) { f = b[22384 + ((((b[p >> 2] | 0) + (b[22352 + (h << 2) >> 2] | 0) | 0) % 6 | 0) << 2) >> 2] | 0; }else { f = ea(i, j, a, c) | 0; }
                d = ub(i, j) | 0;

                if ((f + -1 | 0) >>> 0 <= 5 ? (q = (d | 0) != 0, !((f | 0) == 1 & q)) : 0) {
                  do { if (!(Qc(i, j, v) | 0)) {
                    if (q) {
                      d = ((b[21936 + (f << 2) >> 2] | 0) + 5 - (b[v >> 2] | 0) | 0) % 5 | 0;
                      break;
                    } else {
                      d = ((b[21968 + (f << 2) >> 2] | 0) + 6 - (b[v >> 2] | 0) | 0) % 6 | 0;
                      break;
                    }
                  } else { d = -1; } } while (0);
        ...
        if ((f | 0) == (j | 0) & (g | 0) == (h | 0)) {
          i = (ub(j, h) | 0) != 0;
          if (i) { a = ea(j, h, a, c) | 0; }else { a = b[22384 + ((((b[t >> 2] | 0) + (b[22352 + (s << 2) >> 2] | 0) | 0) % 6 | 0) << 2) >> 2] | 0; }
          d = ub(j, h) | 0;
          if ((a + -1 | 0) >>> 0 <= 5 ? (u = (d | 0) != 0, !((a | 0) == 1 & u)) : 0) {
            do { if (!(Qc(j, h, v) | 0)) {
              if (u) {
                d = ((b[21936 + (a << 2) >> 2] | 0) + 5 - (b[v >> 2] | 0) | 0) % 5 | 0;
                break;
              } else {
                d = ((b[21968 + (a << 2) >> 2] | 0) + 6 - (b[v >> 2] | 0) | 0) % 6 | 0;
                break;
              }
            } else { d = -1; } } while (0);
          } else { d = -1; }
    ...
    return {
      ...
      _exactEdgeLengthKm: jc,
      _exactEdgeLengthM: kc,
      _exactEdgeLengthRads: ic,
      _free: ed,
...
function createError(messages, errCode, meta) {
  ...
  var hasValue = 'value' in meta; // Throw a custom error type with the code attached
...
function cellToChildren(h3Index, res) {
  ...
  try {
    ...
    var count = readInt64AsDoubleFromPointer(countPtr);
...
function gridDiskDistances(h3Index, ringSize) {
  ...
  try {
    ...
    try {
      throwIfError(H3.gridDiskDistances(lower, upper, ringSize, kRings, distances)); // Create an array of empty arrays to hold the output
...
function uncompactCells(compactedSet, res) {
  ...
  try {
    ...
    var uncompactCellSize = readInt64AsDoubleFromPointer(uncompactCellSizePtr);
    validateArrayLength(uncompactCellSize); // Allocate memory for uncompacted hexagons
