...
(c&&c.onDragExit(),this.dragTarget_&&this.dragTarget_.onDragEnter());this.dragTarget_&&this.dragTarget_.onDragOver()};
Blockly.BlockDragger.prototype.endDrag=function(a,b){this.drag(a,b);this.dragIconData_=[];this.fireDragEndEvent_();Blockly.utils.dom.stopTextWidthCache();Blockly.blockAnimations.disconnectUiStop();if(this.dragTarget_&&this.dragTarget_.shouldPreventBlockMove(this.draggingBlock_))a=this.startXY_;else{var c=this.pixelsToWorkspaceUnits_(b);a=Blockly.utils.Coordinate.sum(this.startXY_,c)}this.draggingBlock_.moveOffDragSurface(a);if(this.dragTarget_)this.dragTarget_.onBlockDrop(this.draggingBlock_);this.wouldDeleteBlock_?
(this.fireMoveEvent_(),this.draggingBlock_.dispose(!1,!0),Blockly.draggingConnections=[]):(this.draggingBlock_.setDragging(!1),c?this.updateBlockLocationAfterMove_(c):Blockly.bumpObjectIntoBounds_(this.draggingBlock_.workspace,this.workspace_.getMetricsManager().getScrollMetrics(!0),this.draggingBlock_));this.workspace_.setResizesEnabled(!0);this.updateToolboxStyle_(!0)};
Blockly.BlockDragger.prototype.updateBlockLocationAfterMove_=function(a){this.draggingBlock_.moveConnections(a.x,a.y);this.fireMoveEvent_();this.draggedConnectionManager_.wouldConnectBlock()?this.draggedConnectionManager_.applyConnections():this.draggingBlock_.render();this.draggingBlock_.scheduleSnapAndBump()};Blockly.BlockDragger.prototype.fireDragEndEvent_=function(){var a=new (Blockly.Events.get(Blockly.Events.BLOCK_DRAG))(this.draggingBlock_,!1,this.draggingBlock_.getDescendants(!1));Blockly.Events.fire(a)};
Blockly.BlockDragger.prototype.updateToolboxStyle_=function(a){var b=this.workspace_.getToolbox();if(b){var c=this.draggingBlock_.isDeletable()?"blocklyToolboxDelete":"blocklyToolboxGrab";a&&"function"==typeof b.removeStyle?b.removeStyle(c):a||"function"!=typeof b.addStyle||b.addStyle(c)}};Blockly.BlockDragger.prototype.fireMoveEvent_=function(){var a=new (Blockly.Events.get(Blockly.Events.BLOCK_MOVE))(this.draggingBlock_);a.oldCoordinate=this.startXY_;a.recordNew();Blockly.Events.fire(a)};
Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_=function(){this.draggingBlock_.setDeleteStyle(this.wouldDeleteBlock_)};Blockly.BlockDragger.prototype.pixelsToWorkspaceUnits_=function(a){a=new Blockly.utils.Coordinate(a.x/this.workspace_.scale,a.y/this.workspace_.scale);this.workspace_.isMutator&&a.scale(1/this.workspace_.options.parentWorkspace.scale);return a};
Blockly.BlockDragger.prototype.dragIcons_=function(a){for(var b=0;b<this.dragIconData_.length;b++){var c=this.dragIconData_[b];c.icon.setIconLocation(Blockly.utils.Coordinate.sum(c.location,a))}};Blockly.BlockDragger.prototype.getInsertionMarkers=function(){return this.draggedConnectionManager_&&this.draggedConnectionManager_.getInsertionMarkers?this.draggedConnectionManager_.getInsertionMarkers():[]};Blockly.registry.register(Blockly.registry.Type.BLOCK_DRAGGER,Blockly.registry.DEFAULT,Blockly.BlockDragger);Blockly.IContextMenu=function(){};Blockly.IDeletable=function(){};Blockly.IBubble=function(){};Blockly.Bubble=function(a,b,c,d,e,f){this.workspace_=a;this.content_=b;this.shape_=c;this.onMouseDownResizeWrapper_=this.onMouseDownBubbleWrapper_=this.moveCallback_=this.resizeCallback_=null;this.disposed=!1;c=Blockly.Bubble.ARROW_ANGLE;this.workspace_.RTL&&(c=-c);this.arrow_radians_=Blockly.utils.math.toRadians(c);a.getBubbleCanvas().appendChild(this.createDom_(b,!(!e||!f)));this.setAnchorLocation(d);e&&f||(a=this.content_.getBBox(),e=a.width+2*Blockly.Bubble.BORDER_WIDTH,f=a.height+2*Blockly.Bubble.BORDER_WIDTH);
...
Blockly.BubbleDragger.prototype.dragBubble=function(a,b){b=this.pixelsToWorkspaceUnits_(b);b=Blockly.utils.Coordinate.sum(this.startXY_,b);this.draggingBubble_.moveDuringDrag(this.dragSurface_,b);b=this.dragTarget_;this.dragTarget_=this.workspace_.getDragTarget(a);a=this.wouldDeleteBubble_;this.wouldDeleteBubble_=this.shouldDelete_(this.dragTarget_);a!=this.wouldDeleteBubble_&&this.updateCursorDuringBubbleDrag_();this.dragTarget_!==b&&(b&&b.onDragExit(),this.dragTarget_&&this.dragTarget_.onDragEnter());
this.dragTarget_&&this.dragTarget_.onDragOver()};Blockly.BubbleDragger.prototype.shouldDelete_=function(a){return a&&this.workspace_.getComponentManager().hasCapability(a.id,Blockly.ComponentManager.Capability.DELETE_AREA)?a.wouldDeleteBubble(this.draggingBubble_):!1};Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_=function(){this.draggingBubble_.setDeleteStyle(this.wouldDeleteBubble_)};
Blockly.BubbleDragger.prototype.endBubbleDrag=function(a,b){this.dragBubble(a,b);this.dragTarget_&&this.dragTarget_.shouldPreventBubbleMove(this.draggingBubble_)?a=this.startXY_:(a=this.pixelsToWorkspaceUnits_(b),a=Blockly.utils.Coordinate.sum(this.startXY_,a));this.draggingBubble_.moveTo(a.x,a.y);if(this.dragTarget_)this.dragTarget_.onBubbleDrop(this.draggingBubble_);this.wouldDeleteBubble_?(this.fireMoveEvent_(),this.draggingBubble_.dispose(!1,!0)):(this.dragSurface_&&this.dragSurface_.clearAndHide(this.workspace_.getBubbleCanvas()),
this.draggingBubble_&&this.draggingBubble_.setDragging(!1),this.fireMoveEvent_());this.workspace_.setResizesEnabled(!0);(a=this.workspace_.getToolbox())&&"function"==typeof a.removeStyle&&(b=this.draggingBubble_.isDeletable()?"blocklyToolboxDelete":"blocklyToolboxGrab",a.removeStyle(b));Blockly.Events.setGroup(!1)};
Blockly.BubbleDragger.prototype.fireMoveEvent_=function(){if(this.draggingBubble_.isComment){var a=new (Blockly.Events.get(Blockly.Events.COMMENT_MOVE))(this.draggingBubble_);a.setOldCoordinate(this.startXY_);a.recordNew();Blockly.Events.fire(a)}};Blockly.BubbleDragger.prototype.pixelsToWorkspaceUnits_=function(a){a=new Blockly.utils.Coordinate(a.x/this.workspace_.scale,a.y/this.workspace_.scale);this.workspace_.isMutator&&a.scale(1/this.workspace_.options.parentWorkspace.scale);return a};
...
Blockly.Toolbox.prototype.wouldDeleteBlock=function(a,b){return this.wouldDelete_=!a.getParent()&&a.isDeletable()};Blockly.Toolbox.prototype.getToolboxItemById=function(a){return this.contentMap_[a]||null};Blockly.Toolbox.prototype.getWidth=function(){return this.width_};Blockly.Toolbox.prototype.getHeight=function(){return this.height_};Blockly.Toolbox.prototype.getFlyout=function(){return this.flyout_};Blockly.Toolbox.prototype.getWorkspace=function(){return this.workspace_};
Blockly.Toolbox.prototype.getSelectedItem=function(){return this.selectedItem_};Blockly.Toolbox.prototype.getPreviouslySelectedItem=function(){return this.previouslySelectedItem_};Blockly.Toolbox.prototype.isHorizontal=function(){return this.horizontalLayout_};
...
Blockly.Trashcan.prototype.onDragExit=function(){Blockly.Trashcan.superClass_.onDragExit.call(this);this.setLidOpen(!1)};Blockly.Trashcan.prototype.onBlockDrop=function(a){Blockly.Trashcan.superClass_.onBlockDrop.call(this,a);this.onDrop_()};Blockly.Trashcan.prototype.onBubbleDrop=function(a){Blockly.Trashcan.superClass_.onBubbleDrop.call(this,a);this.onDrop_()};Blockly.Trashcan.prototype.onDrop_=function(){setTimeout(this.setLidOpen.bind(this,!1),100)};
