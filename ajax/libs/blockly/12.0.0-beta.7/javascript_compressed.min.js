...
`)+"("+n+", "+e+")",N.FUNCTION_CALL]}}),A=(O.math_round=r,O.math_single=r,O.math_trig=r,{procedures_callnoreturn:function(e,t){return t.forBlock.procedures_callreturn(e,t)[0]+";\n"},procedures_callreturn:function(t,n){const e=n.getProcedureName(t.getFieldValue("NAME")),r=[],a=t.getVars();for(let e=0;e<a.length;e++)r[e]=n.valueToCode(t,"ARG"+e,N.NONE)||"null";return[e+"("+r.join(", ")+")",N.FUNCTION_CALL]}}),_=(A.procedures_defnoreturn=a,A.procedures_defreturn=a,A.procedures_ifreturn=function(e,t){let n="if ("+(t.valueToCode(e,"CONDITION",N.NONE)||"false")+") {\n";return t.STATEMENT_SUFFIX&&(n+=t.prefixLines(t.injectId(t.STATEMENT_SUFFIX,e),t.INDENT)),e.hasReturnValue_?(e=t.valueToCode(e,"VALUE",N.NONE)||"null",n+=t.INDENT+"return "+e+";\n"):n+=t.INDENT+"return;\n",n+"}\n"},/^\s*'([^']|\\')*'\s*$/),L={text:function(e,t){return[t.quote_(e.getFieldValue("TEXT")),N.ATOMIC]},text_append:function(e,t){var n=t.getVariableName(e.getFieldValue("VAR"));return e=t.valueToCode(e,"TEXT",N.NONE)||"''",n+" += "+T(e)[0]+";\n"},text_changeCase:function(e,t){var n={UPPERCASE:".toUpperCase()",LOWERCASE:".toLowerCase()",TITLECASE:null}[e.getFieldValue("CASE")];return e=t.valueToCode(e,"TEXT",n?N.MEMBER:N.NONE)||"''",[n?e+n:t.provideFunction_("textToTitleCase",`
...
function ${t.FUNCTION_NAME_PLACEHOLDER_}(sequence${"FROM_END"===r||"FROM_START"===r?", at1":""}${"FROM_END"===a||"FROM_START"===a?", at2":""}) {
  ...
  var end = ${s("sequence",a,"at2")} + 1;
  return sequence.slice(start, end);
}
`)+"("+i+("FROM_END"===r||"FROM_START"===r?", "+o:"")+("FROM_END"===a||"FROM_START"===a?", "+e:"")+")";return[i,N.FUNCTION_CALL]},text_indexOf:function(e,t){var n="FIRST"===e.getFieldValue("END")?"indexOf":"lastIndexOf",r=t.valueToCode(e,"FIND",N.NONE)||"''";return t=(t.valueToCode(e,"VALUE",N.MEMBER)||"''")+"."+n+"("+r+")",e.workspace.options.oneBasedIndex?[t+" + 1",N.ADDITION]:[t,N.FUNCTION_CALL]},text_isEmpty:function(e,t){return["!"+(t.valueToCode(e,"VALUE",N.MEMBER)||"''")+".length",N.LOGICAL_NOT]},text_join:function(t,n){switch(t.itemCount_){case 0:return["''",N.ATOMIC];case 1:return t=n.valueToCode(t,"ADD0",N.NONE)||"''",T(t);case 2:var r=n.valueToCode(t,"ADD0",N.NONE)||"''";return t=n.valueToCode(t,"ADD1",N.NONE)||"''",[T(r)[0]+" + "+T(t)[0],N.ADDITION];default:r=Array(t.itemCount_);for(let e=0;e<t.itemCount_;e++)r[e]=n.valueToCode(t,"ADD"+e,N.NONE)||"''";return["["+r.join(",")+"].join('')",N.FUNCTION_CALL]}},text_length:function(e,t){return[(t.valueToCode(e,"VALUE",N.MEMBER)||"''")+".length",N.MEMBER]},text_print:function(e,t){return"window.alert("+(t.valueToCode(e,"TEXT",N.NONE)||"''")+");\n"}},C=(L.text_prompt=o,L.text_prompt_ext=o,L.text_replace=function(e,t){var n=t.valueToCode(e,"TEXT",N.NONE)||"''",r=t.valueToCode(e,"FROM",N.NONE)||"''";return e=t.valueToCode(e,"TO",N.NONE)||"''",[t.provideFunction_("textReplace",`
function ${t.FUNCTION_NAME_PLACEHOLDER_}(haystack, needle, replacement) {
  needle = needle.replace(/([-()\\[\\]{}+?*.$\\^|,:#<!\\\\])/g, '\\\\$1')
                 .replace(/\\x08/g, '\\\\x08');
  return haystack.replace(new RegExp(needle, 'g'), replacement);
}
`)+"("+n+", "+r+", "+e+")",N.FUNCTION_CALL]},L.text_reverse=function(e,t){return[(t.valueToCode(e,"TEXT",N.MEMBER)||"''")+".split('').reverse().join('')",N.FUNCTION_CALL]},L.text_trim=function(e,t){var n={LEFT:".replace(/^[\\s\\xa0]+/, '')",RIGHT:".replace(/[\\s\\xa0]+$/, '')",BOTH:".trim()"}[e.getFieldValue("MODE")];return[(t.valueToCode(e,"TEXT",N.MEMBER)||"''")+n,N.FUNCTION_CALL]},{}),M=(C.variables_get=i,C.variables_set=u,{}),R=(M.variables_get_dynamic=i,M.variables_set_dynamic=u,new e),f=Object.assign({},c,I,d,O,A,L,C,M);for(const m in f)R.forBlock[m]=f[m];c={};return c.JavascriptGenerator=e,c.Order=N,c.javascriptGenerator=R,c.__namespace__=E,c});