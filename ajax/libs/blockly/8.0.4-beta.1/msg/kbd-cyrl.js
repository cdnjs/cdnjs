...
messages["ADD_COMMENT"] = "КIэщIэтхэн";
...
messages["CHANGE_VALUE_TITLE"] = "Change value:";  // untranslated
...
messages["COLLAPSE_ALL"] = "Блокхэр зэкIуэцIылъхьэн";
messages["COLLAPSE_BLOCK"] = "Блокыр зэкIуэцIылъхьэн";
messages["COLOUR_BLEND_COLOUR1"] = "1 плъыфэ";
messages["COLOUR_BLEND_COLOUR2"] = "2 плъыфэ";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "1 плъыфэм щыщу";
messages["COLOUR_BLEND_TITLE"] = "зэхэпщэн";
messages["COLOUR_BLEND_TOOLTIP"] = "ПлъыфитIыр епт зэхущытыкIэмкIэ хэхэпщэн (0.0 - 1.0).";
messages["COLOUR_PICKER_HELPURL"] = "https://ru.wikipedia.org/wiki/Цвет";
messages["COLOUR_PICKER_TOOLTIP"] = "Плъыфэхэм узыхуейр къыхэх.";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "сыт хуэдэ плъыфэми";
messages["COLOUR_RANDOM_TOOLTIP"] = "Плъыфэр езыр-езыру къыхегъэхын.";
messages["COLOUR_RGB_BLUE"] = "щIыхуу";
messages["COLOUR_RGB_GREEN"] = "удзыфэу";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "плъыжьу";
messages["COLOUR_RGB_TITLE"] = "плъыфэхэм щыщ";
...
messages["CONTROLS_IF_MSG_ELSE"] = "армырамэ";
messages["CONTROLS_IF_MSG_ELSEIF"] = "армырамэ щыпкъэу";
messages["CONTROLS_IF_MSG_IF"] = "щыпкъэу";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "гъэзэщIэн";
messages["CONTROLS_REPEAT_TITLE"] = "%1 къытегъэзэжын";
messages["CONTROLS_REPEAT_TOOLTIP"] = "Унафэр зыбжанэрэ егъэзащIэ.";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "къытегъэзэжын, къихьэх";
...
messages["DELETE_BLOCK"] = "Блокыр тегъэкIын";
...
messages["DELETE_X_BLOCKS"] = "Блоку %1 тегъэкIын";
messages["DIALOG_CANCEL"] = "ЩӀегъуэжын";
messages["DIALOG_OK"] = "ХЪУАЩ";
messages["DISABLE_BLOCK"] = "Блокыр гъэуфIынкIын";
messages["DUPLICATE_BLOCK"] = "ЩIэтхыкIын";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "Блокыр щIэгъэнэн";
messages["EXPAND_ALL"] = "Блокхэр зэкIуэц1ыхын";
messages["EXPAND_BLOCK"] = "Блокыр зэкIуэц1ыхын";
messages["EXTERNAL_INPUTS"] = "External Inputs";  // untranslated
messages["HELP"] = "ДэӀэпыкъуэгъуэ";
...
messages["LOGIC_BOOLEAN_FALSE"] = "пцIы";
messages["LOGIC_BOOLEAN_HELPURL"] = "https://github.com/google/blockly/wiki/Logic#values";  // untranslated
messages["LOGIC_BOOLEAN_TOOLTIP"] = "Е щыпкъэ е пцIы къуетыж.";
messages["LOGIC_BOOLEAN_TRUE"] = "щыпкъэ";
...
messages["LOGIC_TERNARY_IF_FALSE"] = "if false";  // untranslated
...
messages["MATH_ARITHMETIC_TOOLTIP_ADD"] = "БжыгъитIыр зэхелъхьэри къыщIэкIар къуетыж.";
messages["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] = "Япэ бжыгъэр етIуанэмкIэ егуэшри къыщIэкIар къуетыж.";
messages["MATH_ARITHMETIC_TOOLTIP_MINUS"] = "БжыгъитIыр зэхехри къыщIэкIар къуетыж.";
messages["MATH_ARITHMETIC_TOOLTIP_MULTIPLY"] = "БжыгъитIыр зэхуегъэбагъуэри къыщIэкIар къуетыж.";
...
messages["MATH_IS_DIVISIBLE_BY"] = "мыбыкIэ мэгуэш";
messages["MATH_IS_EVEN"] = "зэпэбж";
messages["MATH_IS_NEGATIVE"] = "is negative";  // untranslated
messages["MATH_IS_ODD"] = "зэпэмыбж";
messages["MATH_IS_POSITIVE"] = "is positive";  // untranslated
messages["MATH_IS_PRIME"] = "къызэрыгуэкI";
...
messages["PROCEDURES_BEFORE_PARAMS"] = "игъусэр:";
messages["PROCEDURES_CALLNORETURN_HELPURL"] = "https://ru.wikipedia.org/wiki/Функция_%28программирование%29";
messages["PROCEDURES_CALLNORETURN_TOOLTIP"] = "Run the user-defined function '%1'.";  // untranslated
messages["PROCEDURES_CALLRETURN_HELPURL"] = "https://ru.wikipedia.org/wiki/Функция_%28программирование%29";
messages["PROCEDURES_CALLRETURN_TOOLTIP"] = "Run the user-defined function '%1' and use its output.";  // untranslated
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "игъусэр:";
...
messages["REMOVE_COMMENT"] = "КIэщIэтхэр тегъэкIыжын";
...
messages["TEXT_INDEXOF_OPERATOR_FIRST"] = "япэу къыщыхэщыр къэгъуэтын";
messages["TEXT_INDEXOF_OPERATOR_LAST"] = "иужьыу къыщыхэщыр къэгъуэтын";
...
messages["TEXT_ISEMPTY_TITLE"] = "%1 нэщIщ";
...
messages["TEXT_LENGTH_TITLE"] = "%1 и кIыхьагъыр";
...
messages["VARIABLES_DEFAULT_NAME"] = "Iыхьэ";
