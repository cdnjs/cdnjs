...
messages["ADD_COMMENT"] = "ਟਿੱਪਣੀ ਕਰੋ";
...
messages["CHANGE_VALUE_TITLE"] = "ਮੁੱਲ ਬਦਲੋ:";
messages["CLEAN_UP"] = "ਬਲਾਕ ਸਾਫ਼ ਕਰੋ";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "ਬਲਾਕਾਂ ਨੂੰ ਸਮੇਟੋ";
messages["COLLAPSE_BLOCK"] = "ਬਲਾਕ ਸਮੇਟੋ";
messages["COLOUR_BLEND_COLOUR1"] = "ਰੰਗ 1";
messages["COLOUR_BLEND_COLOUR2"] = "ਰੰਗ 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "ਅਨੁਪਾਤ";
messages["COLOUR_BLEND_TITLE"] = "ਮਿਸ਼ਰਣ ਕਰੋ";
messages["COLOUR_BLEND_TOOLTIP"] = "ਦਿੱਤੇ ਅਨੁਪਾਤ (0.0 - 1.0) ਅਨੁਸਾਰ ਦੋ ਰੰਗ ਮਿਲਾਓ।";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "ਰੰਗ-ਫੱਟੀ ਵਿੱਚੋਂ ਰੰਗ ਚੁਣੋ";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "ਰਲ਼ਵਾਂ ਰੰਗ";
messages["COLOUR_RANDOM_TOOLTIP"] = "ਰਲ਼ਵਾਂ ਰੰਗ ਚੁਣੋ";
messages["COLOUR_RGB_BLUE"] = "ਨੀਲਾ";
messages["COLOUR_RGB_GREEN"] = "ਹਰਾ";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ਲਾਲ";
messages["COLOUR_RGB_TITLE"] = "colour with";  // untranslated
messages["COLOUR_RGB_TOOLTIP"] = "ਰੰਗ ਬਣਾਉਣ ਲਈ ਲਾਲ, ਹਰੇ ਅਤੇ ਨੀਲੇ ਨੂੰ ਨਿਰਧਾਰਿਤ ਮਾਤਰਾ ਵਿੱਚ ਮਿਲਾਓ। ਰਲਾਉਣ ਦੀ ਮਾਤਰਾ ਦਾ ਮੁੱਲ 0 ਤੋਂ 100 ਦੇ ਵਿਚਕਾਰ ਹੀ ਰੱਖੋ।";
...
messages["CONTROLS_IF_MSG_ELSE"] = "ਹੋਰ";
messages["CONTROLS_IF_MSG_ELSEIF"] = "else if";  // untranslated
messages["CONTROLS_IF_MSG_IF"] = "ਜੇ";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "ਕਰੋ";
messages["CONTROLS_REPEAT_TITLE"] = "%1 ਵਾਰੀ ਦੁਹਰਾਉ";
...
messages["DELETE_ALL_BLOCKS"] = "ਕੀ ਸਾਰੇ %1 ਬਲਾਕ ਮਿਟਾਉਣੇ ਹਨ?";
messages["DELETE_BLOCK"] = "ਬਲਾਕ ਮਿਟਾਉ";
...
messages["DELETE_X_BLOCKS"] = "%1 ਬਲਾਕ ਮਿਟਾਉ";
messages["DIALOG_CANCEL"] = "ਰੱਦ ਕਰੋ";
messages["DIALOG_OK"] = "ਠੀਕ ਹੈ।";
messages["DISABLE_BLOCK"] = "ਬਲਾਕ ਬੰਦ ਕਰੋ";
messages["DUPLICATE_BLOCK"] = "ਨਕਲ";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "ਬਲਾਕ ਚਾਲੂ ਕਰੋ";
messages["EXPAND_ALL"] = "ਬਲਾਕਾਂ ਨੂੰ ਫੈਲਾਉ";
messages["EXPAND_BLOCK"] = "ਬਲਾਕ ਫੈਲਾਉ";
messages["EXTERNAL_INPUTS"] = "ਬਾਹਰੀ ਇੱਨਪੁੱਟ";
messages["HELP"] = "ਮਦਦ";
...
messages["LISTS_GET_INDEX_FIRST"] = "ਪਹਿਲਾ";
...
messages["LISTS_GET_INDEX_LAST"] = "ਆਖ਼ਰੀ";
messages["LISTS_GET_INDEX_RANDOM"] = "ਰਲ਼ਵਾਂ";
...
messages["LISTS_SORT_ORDER_DESCENDING"] = "ਘਟਦੇ ਕ੍ਰਮ ਵਿੱਚ";
...
messages["LOGIC_BOOLEAN_FALSE"] = "ਝੂਠ";
...
messages["LOGIC_BOOLEAN_TRUE"] = "ਸੱਚ";
...
messages["LOGIC_TERNARY_CONDITION"] = "ਟੈਸਟ";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "ਜੇ ਝੂਠ";
messages["LOGIC_TERNARY_IF_TRUE"] = "ਜੇ ਸੱਚ";
...
messages["MATH_ARITHMETIC_HELPURL"] = "https://pa.wikipedia.org/wiki/ਗਿਣਤੀ";
messages["MATH_ARITHMETIC_TOOLTIP_ADD"] = "ਦੋ ਅੰਕਾੰ ਦਾ ਜੋੜ ਮੋੜੋ।";
...
messages["MATH_NUMBER_TOOLTIP"] = "ਇੱਕ ਅੰਕ";
...
messages["MATH_SINGLE_HELPURL"] = "https://pa.wikipedia.org/wiki/ਵਰਗ_ਮੂਲ";
messages["MATH_SINGLE_OP_ABSOLUTE"] = "absolute";  // untranslated
messages["MATH_SINGLE_OP_ROOT"] = "ਵਰਗ ਮੂਲ";
...
messages["MATH_SINGLE_TOOLTIP_ROOT"] = "ਇੱਕ ਅੰਕ ਦਾ ਵਰਗ ਮੂਲ ਮੋੜੋ।";
...
messages["PROCEDURES_DEFRETURN_RETURN"] = "ਮੋੜੋ";
...
messages["REDO"] = "ਮੁੜ ਕਰੋ";
messages["REMOVE_COMMENT"] = "ਟਿੱਪਣੀ ਹਟਾਉ";
...
messages["TODAY"] = "ਅੱਜ";
messages["UNDO"] = "ਅਣਕੀਤਾ ਕਰੋ";
messages["UNNAMED_KEY"] = "ਬੇਨਾਮ";
messages["VARIABLES_DEFAULT_NAME"] = "ਸਮੱਗਰੀ";
