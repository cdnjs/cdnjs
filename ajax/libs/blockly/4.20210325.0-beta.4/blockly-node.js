...
Blockly.utils.string.commonWordPrefix = function(a, b) {
  ...
  for (var c = 0, d = b || Blockly.utils.string.shortestStringLength(a), e = 0;
       e < d; e++) {
...
Blockly.utils.string.wrapScore_ = function(a, b, c) {
  for (var d = [0], e = [], f = 0; f < a.length; f++)
    d[d.length - 1] += a[f].length,
        !0 === b[f] ? (d.push(0), e.push(a[f].charAt(a[f].length - 1))) :
                      !1 === b[f] && d[d.length - 1]++;
  a = Math.max.apply(Math, d);
  for (f = b = 0; f < d.length; f++)
    b -= 2 * Math.pow(Math.abs(c - d[f]), 1.5), b -= Math.pow(a - d[f], 1.5),
        -1 != '.?!'.indexOf(e[f]) ? b += c / 3 :
                                    -1 != ',;)]}'.indexOf(e[f]) && (b += c / 4);
...
Blockly.utils.string.wrapMutate_ = function(a, b, c) {
  for (var d = Blockly.utils.string.wrapScore_(a, b, c), e, f = 0;
       f < b.length - 1; f++)
    if (b[f] != b[f + 1]) {
      var g = [].concat(b);
      g[f] = !g[f];
...
Blockly.utils.style.getStyle_ = function(a, b) {
  return Blockly.utils.style.getComputedStyle(a, b) ||
      Blockly.utils.style.getCascadedStyle(a, b) || a.style && a.style[b]
};
...
Blockly.utils.style.getPageOffset = function(a) {
  ...
  c = new Blockly.utils.Coordinate(
      window.pageXOffset || c.scrollLeft, window.pageYOffset || c.scrollTop);
  b.x = a.left + c.x;
  b.y = a.top + c.y;
  return b
};
...
Blockly.utils.style.getBorderBox = function(a) {
  ...
  return {
    top: parseFloat(d), right: parseFloat(c), bottom: parseFloat(a),
        left: parseFloat(b)
  }
};
...
Blockly.utils.userAgent.IPHONE = b('iPhone') && !Blockly.utils.userAgent.IPAD &&
...
Blockly.utils.isTargetInput = function(a) {
  return 'textarea' == a.target.type || 'text' == a.target.type ||
      'number' == a.target.type || 'email' == a.target.type ||
      'password' == a.target.type || 'search' == a.target.type ||
      'tel' == a.target.type || 'url' == a.target.type ||
...
Blockly.utils.checkMessageReferences = function(a) {
  for (var b = !0, c = Blockly.Msg, d = a.match(/%{BKY_[A-Z]\w*}/ig), e = 0;
       e < d.length; e++) {
...
Blockly.utils.tokenizeInterpolation_ = function(a, b) {
  ...
  for (var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
    var k = d[h];
    0 == e ?
        '%' == k ? ((k = f.join('')) && c.push(k), f.length = 0, e = 1) :
                   f.push(k) :
        1 == e ?
        '%' == k ? (f.push(k), e = 0) :
                   b && '0' <= k && '9' >= k ?
                   ...
                   '{' == k ? e = 3 : (f.push('%', k), e = 0) :
        2 == e ?
        '0' <= k&& '9' >= k ? g += k : (c.push(parseInt(g, 10)), h--, e = 0) :
        3 == e &&
                    ('' == k ?
                         (f.splice(0, 0, '%{'), h--, e = 0) :
                         '}' != k ?
                                   ...
                                   (e = Blockly.Msg[k],
                                    'string' == typeof e ?
                                        Array.prototype.push.apply(
                                            c,
                                            Blockly.utils
                                                .tokenizeInterpolation_(e, b)) :
                                        b ? c.push(String(e)) : c.push(e)) :
                                   c.push('%{' + e + '}')) :
                              c.push('%{' + e + '}'),
                          e = f.length = 0))
  }
...
Blockly.utils.getViewportBBox = function() {
  ...
  return {
    right: document.documentElement.clientWidth + a.x,
        bottom: document.documentElement.clientHeight + a.y, top: a.y, left: a.x
  }
};
...
Blockly.utils.getDocumentScroll = function() {
  ...
  return Blockly.utils.userAgent.IE && b.pageYOffset != a.scrollTop ?
      ...
      new Blockly.utils.Coordinate(
          b.pageXOffset || a.scrollLeft, b.pageYOffset || a.scrollTop)
};
...
Blockly.Events.fireNow_ = function() {
  for (var a = Blockly.Events.filter(Blockly.Events.FIRE_QUEUE_, !0),
           b = Blockly.Events.FIRE_QUEUE_.length = 0, c;
       c = a[b]; b++)
    if (c.workspaceId) {
...
Blockly.Events.filter = function(a, b) {
  ...
  for (var d = [], e = Object.create(null), f = 0, g; g = c[f]; f++)
    if (!g.isNull()) {
      ...
      if (!k)
        ...
        l.newParentId = g.newParentId, l.newInputName = g.newInputName,
        l.newCoordinate = g.newCoordinate, k.index = f;
      else if (
          g.type == Blockly.Events.CHANGE && g.element == l.element &&
          g.name == l.name)
        l.newValue = g.newValue;
      else if (
          g.type != Blockly.Events.UI || 'click' != g.element ||
          'commentOpen' != l.element && 'mutatorOpen' != l.element &&
  ...
  b || c.reverse();
  for (f = 1; g = c[f]; f++)
    g.type == Blockly.Events.CHANGE && 'mutation' == g.element &&
    ...
    if (a = b.getBlockById(a.blockId)) {
      ...
      if (c && c.isEnabled())
        for (b = a.getDescendants(!1), a = 0; c = b[a]; a++) c.setEnabled(!0);
          ...
          (a.outputConnection || a.previousConnection) && !b.isDragging()) {
        do
...
Blockly.utils.xml.createElement = function(a) {
  return Blockly.utils.xml.document().createElementNS(
      Blockly.utils.xml.NAME_SPACE, a)
};
...
Blockly.Events.Change = function(a, b, c, d, e) {
  a &&
      (Blockly.Events.Change.superClass_.constructor.call(this, a),
       this.element = b, this.name = c, this.oldValue = d, this.newValue = e)
};
...
Blockly.Events.Change.prototype.run = function(a) {
  ...
  if (b)
    switch (b.mutator && b.mutator.setVisible(!1),
            a = a ? this.newValue : this.oldValue, this.element) {
      case 'field':
...
Blockly.Events.Create = function(a) {
  a &&
      (Blockly.Events.Create.superClass_.constructor.call(this, a),
       this.xml = a.workspace.rendered ? Blockly.Xml.blockToDomWithXY(a) :
...
Blockly.Events.Create.prototype.run = function(a) {
  ...
  if (a)
    a = Blockly.utils.xml.createElement('xml'), a.appendChild(this.xml),
...
Blockly.Events.Delete = function(a) {
  if (a) {
    ...
    this.oldXml = a.workspace.rendered ? Blockly.Xml.blockToDomWithXY(a) :
                                         Blockly.Xml.blockToDom(a);
    this.ids = Blockly.Events.getDescendantIds(a)
  }
};
...
Blockly.Events.Delete.prototype.run = function(a) {
  ...
  if (a) {
    ...
    a = Blockly.utils.xml.createElement('xml'), a.appendChild(this.oldXml),
    Blockly.Xml.domToWorkspace(a, b)
};
Blockly.Events.Move = function(a) {
  a &&
      (Blockly.Events.Move.superClass_.constructor.call(this, a),
       a = this.currentLocation_(), this.oldParentId = a.parentId,
...
Blockly.Events.Move.prototype.toJson = function() {
  ...
  this.newCoordinate &&
      (a.newCoordinate = Math.round(this.newCoordinate.x) + ',' +
...
Blockly.Events.Move.prototype.fromJson = function(a) {
  ...
  a.newCoordinate &&
      (a = a.newCoordinate.split(','),
       this.newCoordinate =
           new Blockly.utils.Coordinate(Number(a[0]), Number(a[1])))
};
...
Blockly.Events.Move.prototype.currentLocation_ = function() {
  var a = this.getEventWorkspace_().getBlockById(this.blockId), b = {},
      c = a.getParent();
  if (c) {
...
Blockly.utils.object.inherits(
    Blockly.Events.FinishedLoading, Blockly.Events.Abstract);
...
Blockly.Events.VarCreate = function(a) {
  a &&
      (Blockly.Events.VarCreate.superClass_.constructor.call(this, a),
       this.varType = a.type, this.varName = a.name)
};
...
Blockly.Events.VarCreate.prototype.run = function(a) {
  var b = this.getEventWorkspace_();
  a ? b.createVariable(this.varName, this.varType, this.varId) :
...
Blockly.Events.VarDelete.prototype.run = function(a) {
  var b = this.getEventWorkspace_();
  a ? b.deleteVariableById(this.varId) :
...
Blockly.Events.VarRename = function(a, b) {
  a &&
      (Blockly.Events.VarRename.superClass_.constructor.call(this, a),
       this.oldName = a.name, this.newName = b)
};
...
Blockly.utils.dom.getTextWidth = function(a) {
  ...
  if (Blockly.utils.dom.cacheWidths_ && (c = Blockly.utils.dom.cacheWidths_[b]))
    return c;
  try {
    c = Blockly.utils.userAgent.IE || Blockly.utils.userAgent.EDGE ?
        a.getBBox().width :
...
Blockly.Xml.variablesToDom = function(a) {
  for (var b = Blockly.utils.xml.createElement('variables'), c = 0, d; d = a[c];
       c++) {
...
Blockly.Xml.blockToDom = function(a, b) {
  ...
  if (d = a.getCommentText()) {
    var e = a.commentModel.size, f = a.commentModel.pinned,
  ...
  void 0 != a.inputsInline && a.inputsInline != a.inputsInlineDefault &&
...
Blockly.Xml.cloneShadow_ = function(a, b) {
  for (var c = a = a.cloneNode(!0), d; c;)
    if (b && 'shadow' == c.nodeName && c.removeAttribute('id'), c.firstChild)
      ...
      for (; c && !c.nextSibling;)
        d = c, c = c.parentNode,
        d.nodeType == Blockly.utils.dom.Node.TEXT_NODE && '' == d.data.trim() &&
            c.firstChild != d && Blockly.utils.dom.removeNode(d);
      c &&
          (d = c, c = c.nextSibling,
           d.nodeType == Blockly.utils.dom.Node.TEXT_NODE &&
               '' == d.data.trim() && Blockly.utils.dom.removeNode(d))
    }
  return a
};
...
Blockly.Xml.domToBlock = function(a, b) {
  ...
  try {
    ...
    if (b.rendered) {
      ...
      for (f = e.length - 1; 0 <= f; f--) e[f].initModel()
  } finally {
...
Blockly.Connection.prototype.canConnectWithReason_ = function(a) {
  ...
  return b && b == c ?
      ...
      this.checkType_(a) ? b.isShadow() && !c.isShadow() ?
...
Blockly.Connection.prototype.isConnectionAllowed = function(a) {
  if (a.sourceBlock_.isInsertionMarker() ||
  ...
  switch (a.type) {
    ...
    case Blockly.INPUT_VALUE:
      if (a.isConnected() && !a.targetBlock().isMovable() &&
...
Blockly.Connection.prototype.onCheckChanged_ = function() {
  this.isConnected() && !this.checkType_(this.targetConnection) &&
      (this.isSuperior() ? this.targetBlock() : this.sourceBlock_).unplug()
};
Blockly.Connection.prototype.setCheck = function(a) {
  a ? (Array.isArray(a) || (a = [a]), this.check_ = a, this.onCheckChanged_()) :
      this.check_ = null;
  return this
};
...
Blockly.Connection.prototype.getParentInput = function() {
  for (var a = null, b = this.sourceBlock_, c = b.inputList, d = 0;
       d < b.inputList.length; d++)
...
Blockly.Extensions.apply = function(a, b, c) {
  ...
  if (c)
    Blockly.Extensions.checkBlockHasMutatorProperties_(
        'Error after applying mutator "' + a + '": ', b);
  else if (!Blockly.Extensions.mutatorPropertiesMatch_(e, b))
    throw Error(
        'Error when applying extension "' + a +
...
Blockly.Extensions.checkNoMutatorProperties_ = function(a, b) {
  if (Blockly.Extensions.getMutatorProperties_(b).length)
    throw Error(
        'Error: tried to apply mutation "' + a +
...
Blockly.Extensions.checkDropdownOptionsInTable_ = function(a, b, c) {
  ...
  if (!d.isOptionListDynamic()) {
    ...
    for (var e = 0; e < d.length; ++e) {
      ...
      null == c[f] &&
          console.warn(
              'No tooltip mapping for value ' + f + ' of field ' + b +
              ' of block type ' + a.type)
    }
  }
};
Blockly.Extensions.buildTooltipWithFieldText = function(a, b) {
  ...
  return function() {
    this.setTooltip(function() {
      ...
      return Blockly.utils.replaceMessageReferences(a).replace(
          '%1', c ? c.getText() : '')
    }.bind(this))
  }
};
Blockly.Extensions.extensionParentTooltip_ = function() {
  ...
  this.setTooltip(function() {
    ...
    return a && a.getInputsInline() && a.tooltip ||
...
Blockly.blockAnimations.disposeUiStep_ = function(a, b, c, d) {
  ...
  1 < e ? Blockly.utils.dom.removeNode(a) :
          (a.setAttribute(
               'transform',
               'translate(' +
                   (a.translateX_ + (b ? -1 : 1) * a.bBox_.width * d / 2 * e) +
                   ',' + (a.translateY_ + a.bBox_.height * d * e) + ') scale(' +
                   (1 - e) * d + ')'),
...
Blockly.blockAnimations.connectionUiEffect = function(a) {
  ...
  if (!(1 > c)) {
    ...
    a.outputConnection ?
        ...
        a.previousConnection && (d.x += (a.RTL ? -23 : 23) * c, d.y += 3 * c);
...
Blockly.blockAnimations.connectionUiStep_ = function(a, b, c) {
  ...
  1 < d ? Blockly.utils.dom.removeNode(a) :
          (a.setAttribute('r', 25 * d * c), a.style.opacity = 1 - d,
           Blockly.blockAnimations.disconnectPid_ = setTimeout(
               Blockly.blockAnimations.connectionUiStep_, 10, a, b, c))
};
  ...
  1 < d ?
      ...
      (a.skew_ =
       ...
       Blockly.blockAnimations.disconnectPid_ =
           setTimeout(Blockly.blockAnimations.disconnectUiStep_, 10, a, b, c));
...
Blockly.InsertionMarkerManager.prototype.applyConnections = function() {
  if (this.closestConnection_ &&
      (Blockly.Events.disable(), this.hidePreview_(), Blockly.Events.enable(),
       this.localConnection_.connect(this.closestConnection_),
       this.topBlock_.rendered)) {
    var a = this.localConnection_.isSuperior() ? this.closestConnection_ :
...
Blockly.InsertionMarkerManager.prototype.update = function(a, b) {
  ...
  if ((this.wouldDeleteBlock_ = this.shouldDelete_(c, b)) ||
      this.shouldUpdatePreviews_(c, a))
    Blockly.Events.disable(), this.maybeHidePreview_(c),
        this.maybeShowPreview_(c), Blockly.Events.enable()
};
...
Blockly.InsertionMarkerManager.prototype.initAvailableConnections_ =
  ...
  b && b != this.topBlock_.nextConnection &&
      (a.push(b), this.lastOnStack_ = b,
...
Blockly.InsertionMarkerManager.prototype.getCandidate_ = function(a) {
  for (var b = this.getStartRadius_(), c = null, d = null, e = 0;
       e < this.availableConnections_.length; e++) {
  ...
  return b.type == Blockly.OUTPUT_VALUE ?
      !a.isConnected() ||
              Blockly.Connection.lastConnectionInRow_(
                  this.topBlock_, a.targetConnection.getSourceBlock()) ?
      !1 :
      !0 :
      b == b.sourceBlock_.getFirstStatementConnection() ?
      !1 :
      !this.topBlock_.nextConnection && b.type == Blockly.PREVIOUS_STATEMENT &&
                  a.isConnected() ?
      !0 :
      !1
};
Blockly.InsertionMarkerManager.prototype.shouldDelete_ = function(a, b) {
  ...
  return !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable() &&
      !c
};
  ...
  if (!this.wouldDeleteBlock_) {
    ...
    b &&
        (b == this.closestConnection_ || b.sourceBlock_.isInsertionMarker() ?
             ...
             (this.closestConnection_ = b, this.localConnection_ = a,
              this.showPreview_()))
  }
};
...
Blockly.InsertionMarkerManager.prototype.maybeHidePreview_ = function(a) {
  if (a.closest) {
    ...
    this.closestConnection_ && this.localConnection_ &&
        (b || a || this.wouldDeleteBlock_) && this.hidePreview_()
  } else
    this.hidePreview_();
  this.localConnection_ = this.closestConnection_ = this.markerConnection_ =
      null
};
...
Blockly.InsertionMarkerManager.prototype.disconnectMarker_ = function() {
  if (this.markerConnection_) {
    var a = this.markerConnection_, b = a.sourceBlock_, c = b.nextConnection,
        d = b.previousConnection, e = b.outputConnection;
    ...
    !(a != c || d && d.targetConnection) || e ?
        ...
        (c = a.targetConnection, c.sourceBlock_.unplug(!1),
         d = d ? d.targetConnection : null, b.unplug(!0), d && d.connect(c)) :
        b.unplug(!0);
...
Blockly.InsertionMarkerManager.prototype.connectMarker_ = function() {
  var a = this.localConnection_, b = this.closestConnection_,
      c = this.lastOnStack_ && a == this.lastOnStack_ ? this.lastMarker_ :
                                                        this.firstMarker_;
...
Blockly.BlockDragger.prototype.startBlockDrag = function(a, b) {
  ...
  if (this.draggingBlock_.getParent() ||
      b && this.draggingBlock_.nextConnection &&
  ...
  if (c = this.workspace_.getToolbox()) {
    var d = this.draggingBlock_.isDeletable() ? 'blocklyToolboxDelete' :
                                                'blocklyToolboxGrab';
    c.addStyle(d)
  }
};
...
Blockly.BlockDragger.prototype.endBlockDrag = function(a, b) {
  ...
  this.maybeDeleteBlock_() ||
      (this.draggingBlock_.moveConnections_(c.x, c.y),
       this.draggingBlock_.setDragging(!1), this.fireMoveEvent_(),
  ...
  if (c = this.workspace_.getToolbox())
    d = this.draggingBlock_.isDeletable() ? 'blocklyToolboxDelete' :
                                            'blocklyToolboxGrab',
    c.removeStyle(d);
  Blockly.Events.setGroup(!1)
};
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function() {
  ...
  this.wouldDeleteBlock_ ?
      (a && setTimeout(a.close.bind(a), 100), this.fireMoveEvent_(),
...
Blockly.BlockDragger.prototype.pixelsToWorkspaceUnits_ = function(a) {
  a = new Blockly.utils.Coordinate(
      a.x / this.workspace_.scale, a.y / this.workspace_.scale);
...
Blockly.Touch = {};
Blockly.Touch.TOUCH_ENABLED = 'ontouchstart' in Blockly.utils.global ||
...
Blockly.longStart_ = function(a, b) {
  ...
  a.changedTouches && 1 != a.changedTouches.length ||
      (Blockly.longPid_ = setTimeout(function() {
         a.changedTouches &&
             (a.button = 2, a.clientX = a.changedTouches[0].clientX,
...
Blockly.Touch.isMouseOrTouchEvent = function(a) {
  return Blockly.utils.string.startsWith(a.type, 'touch') ||
...
Blockly.ScrollbarPair = function(a) {
  this.workspace_ = a;
  this.hScroll =
      new Blockly.Scrollbar(a, !0, !0, 'blocklyMainWorkspaceScrollbar');
  this.vScroll =
      new Blockly.Scrollbar(a, !1, !0, 'blocklyMainWorkspaceScrollbar');
...
Blockly.Scrollbar = function(a, b, c, d) {
  ...
  b ? (this.svgBackground_.setAttribute('height', a),
       ...
       this.svgHandle_.setAttribute('y', 2.5), this.lengthAttribute_ = 'width',
       this.positionAttribute_ = 'x') :
      (this.svgBackground_.setAttribute('width', a),
       this.outerSvg_.setAttribute('width', a),
       this.svgHandle_.setAttribute('width', a - 5),
       this.svgHandle_.setAttribute('x', 2.5), this.lengthAttribute_ = 'height',
...
Blockly.Scrollbar.metricsAreEquivalent_ = function(a, b) {
  return a && b && a.viewWidth == b.viewWidth && a.viewHeight == b.viewHeight &&
          a.viewLeft == b.viewLeft && a.viewTop == b.viewTop &&
          a.absoluteTop == b.absoluteTop && a.absoluteLeft == b.absoluteLeft &&
          a.contentWidth == b.contentWidth &&
          a.contentHeight == b.contentHeight &&
          a.contentLeft == b.contentLeft && a.contentTop == b.contentTop ?
      !0 :
      !1
};
...
Blockly.Scrollbar.prototype.setPosition_ = function(a, b) {
  ...
  Blockly.utils.dom.setCssTransform(
      this.outerSvg_,
      'translate(' + (this.position_.x + this.origin_.x) + 'px,' +
          (this.position_.y + this.origin_.y) + 'px)')
};
...
Blockly.Scrollbar.prototype.resizeViewHorizontal = function(a) {
  ...
  this.setPosition_(
      b,
      a.absoluteTop + a.viewHeight - Blockly.Scrollbar.scrollbarThickness - .5);
...
Blockly.Scrollbar.prototype.createDom_ = function(a) {
  ...
  a && (b += ' ' + a);
  this.outerSvg_ =
      Blockly.utils.dom.createSvgElement('svg', {'class': b}, null);
  ...
  this.svgHandle_ = Blockly.utils.dom.createSvgElement(
      'rect', {'class': 'blocklyScrollbarHandle', rx: a, ry: a},
      this.svgGroup_);
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function(a) {
  ...
  if (Blockly.utils.isRightButton(a))
    ...
    var b = Blockly.utils.mouseToSvg(
        a, this.workspace_.getParentSvg(),
...
Blockly.Scrollbar.prototype.onMouseMoveHandle_ = function(a) {
  this.setHandlePosition(this.constrainHandle_(
...
Blockly.Cursor.prototype['in'] = function() {
  var a = this.getCurNode();
  if (!a) return null;
  if (a.getType() == Blockly.ASTNode.types.PREVIOUS ||
...
Blockly.Cursor.prototype.out = function() {
  var a = this.getCurNode();
  if (!a) return null;
  (a = a.out()) && a.getType() == Blockly.ASTNode.types.BLOCK &&
      (a = a.prev() || a);
  a && this.setCurNode(a);
  return a
};
...
Blockly.Theme.prototype.getComponentStyle = function(a) {
  return (a = this.componentStyles_[a]) && 'string' == typeof propertyValue &&
...
Blockly.ThemeManager.prototype.dispose = function() {
  this.componentDB_ = this.subscribedWorkspaces_ = this.theme_ = this.owner_ =
      null
};
Blockly.Themes = {};
...
Blockly.VariableMap.prototype.renameVariable = function(a, b) {
  ...
  try {
    c && c.getId() != a.getId() ? this.renameVariableWithConflict_(a, b, c, d) :
...
Blockly.VariableMap.prototype.createVariable = function(a, b, c) {
  ...
  if (d) {
    if (c && d.getId() != c)
      throw Error(
          'Variable "' + a + '" is already in use and its id is "' + d.getId() +
  ...
  if (b) {
    ...
    for (var e; e = d[a]; a++)
      if ('procedures_defnoreturn' == e.type ||
        ...
        c = Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace('%1', c)
                .replace('%2', a);
        Blockly.alert(c);
        return
      }
    var f = this;
    1 < d.length ? (c = Blockly.Msg.DELETE_VARIABLE_CONFIRMATION
                            .replace('%1', String(d.length))
                            .replace('%2', c),
                    Blockly.confirm(
                        c,
                        function(a) {
...
Blockly.VariableMap.prototype.getVariableUsesById = function(a) {
  for (var b = [], c = this.workspace.getAllBlocks(!1), d = 0; d < c.length;
       d++) {
...
Blockly.Workspace.prototype.sortObjects_ = function(a, b) {
  ...
  return c.y + Blockly.Workspace.prototype.sortObjects_.offset * c.x -
...
Blockly.Workspace.prototype.getBlocksByType = function(a, b) {
  ...
  b && 1 < c.length &&
      (this.sortObjects_.offset =
           Math.sin(Blockly.utils.math.toRadians(Blockly.Workspace.SCAN_ANGLE)),
       this.RTL && (this.sortObjects_.offset *= -1), c.sort(this.sortObjects_));
  return c
};
...
Blockly.Workspace.prototype.undo = function(a) {
  var b = a ? this.redoStack_ : this.undoStack_,
      c = a ? this.undoStack_ : this.redoStack_, d = b.pop();
  if (d) {
...
Blockly.Workspace.prototype.fireChangeListener = function(a) {
  if (a.recordUndo)
    for (this.undoStack_.push(a), this.redoStack_.length = 0;
...
Blockly.Bubble.prototype.createDom_ = function(a, b) {
  ...
  this.bubbleBack_ = Blockly.utils.dom.createSvgElement(
      ...
      c);
  b ? (this.resizeGroup_ = Blockly.utils.dom.createSvgElement(
           'g', {
       ...
       Blockly.utils.dom.createSvgElement(
           'polygon', {points: '0,x x,x x,0'.replace(/x/g, c.toString())},
           this.resizeGroup_),
       Blockly.utils.dom.createSvgElement(
           'line', {
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
  ...
  var b = this.getOptimalRelativeLeft_(a), c = this.getOptimalRelativeTop_(a),
  ...
  c == a ?
      ...
      g == a ? (this.relativeLeft_ = f.x, this.relativeTop_ = f.y) :
               h == a ? (this.relativeLeft_ = b.x, this.relativeTop_ = b.y) :
                        (this.relativeLeft_ = d.x, this.relativeTop_ = d.y)
};
Blockly.Bubble.prototype.getOverlap_ = function(a, b) {
  var c = this.workspace_.RTL ? this.anchorXY_.x - a.x - this.width_ :
...
Blockly.Bubble.prototype.getOptimalRelativeLeft_ = function(a) {
  ...
  if (this.workspace_.RTL)
    var c = this.anchorXY_.x - b, d = c - this.width_,
        e = a.viewLeft + a.viewWidth,
        f = a.viewLeft +
        Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
  else
    d = b + this.anchorXY_.x, c = d + this.width_, f = a.viewLeft,
    e = a.viewLeft + a.viewWidth -
        Blockly.Scrollbar.scrollbarThickness / this.workspace_.scale;
  this.workspace_.RTL ? d<f ? b = -(f - this.anchorXY_.x + this.width_) : c>e &&
          (b = -(e - this.anchorXY_.x)) :
                        d<f ? b = f - this.anchorXY_.x : c>e &&
          (b = e - this.anchorXY_.x - this.width_);
  return b
};
  ...
  this.resizeGroup_ &&
      (this.workspace_.RTL ?
           this.resizeGroup_.setAttribute(
               'transform',
               'translate(' + 2 * Blockly.Bubble.BORDER_WIDTH + ',' + (b - c) +
                   ') scale(-1 1)') :
           this.resizeGroup_.setAttribute(
...
Blockly.Bubble.prototype.renderArrow_ = function() {
  var a = [], b = this.width_ / 2, c = this.height_ / 2,
      d = -this.relativeLeft_, e = -this.relativeTop_;
  if (b == d && c == e)
    a.push('M ' + b + ',' + c);
  else {
    e -= c;
...
Blockly.Events.CommentChange = function(a, b, c) {
  a &&
      (Blockly.Events.CommentChange.superClass_.constructor.call(this, a),
       this.oldContents_ = b, this.newContents_ = c)
};
Blockly.utils.object.inherits(
...
Blockly.Events.CommentChange.prototype.run = function(a) {
  ...
  b ? b.setContent(a ? this.newContents_ : this.oldContents_) :
...
Blockly.Events.CommentMove = function(a) {
  a &&
      (Blockly.Events.CommentMove.superClass_.constructor.call(this, a),
       this.comment_ = a, this.oldCoordinate_ = a.getXY(),
...
Blockly.Events.CommentMove.prototype.toJson = function() {
  ...
  this.newCoordinate_ &&
      (a.newCoordinate = Math.round(this.newCoordinate_.x) + ',' +
...
Blockly.BubbleDragger = function(a, b) {
  ...
  this.dragSurface_ = Blockly.utils.is3dSupported() && b.getBlockDragSurface() ?
...
Blockly.BubbleDragger.prototype.startBubbleDrag = function() {
  ...
  if (a) {
    var b = this.draggingBubble_.isDeletable() ? 'blocklyToolboxDelete' :
                                                 'blocklyToolboxGrab';
    a.addStyle(b)
  }
};
...
Blockly.BubbleDragger.prototype.endBubbleDrag = function(a, b) {
  ...
  this.workspace_.toolbox_ &&
      (c = this.draggingBubble_.isDeletable() ? 'blocklyToolboxDelete' :
                                                'blocklyToolboxGrab',
...
Blockly.Tooltip.onMouseOver_ = function(a) {
  if (!Blockly.Tooltip.blocked_) {
    ...
    Blockly.Tooltip.element_ != a &&
        (Blockly.Tooltip.hide(), Blockly.Tooltip.poisonedElement_ = null,
         Blockly.Tooltip.element_ = a);
    ...
    if (Blockly.Tooltip.visible) {
      ...
      Blockly.Tooltip.poisonedElement_ != Blockly.Tooltip.element_ &&
          (clearTimeout(Blockly.Tooltip.showPid_),
           Blockly.Tooltip.lastX_ = a.pageX, Blockly.Tooltip.lastY_ = a.pageY,
...
Blockly.Tooltip.show_ = function() {
  if (!Blockly.Tooltip.blocked_ &&
    ...
    d = a ? d - (Blockly.Tooltip.OFFSET_X + Blockly.Tooltip.DIV.offsetWidth) :
    ...
    a ? d = Math.max(Blockly.Tooltip.MARGINS - window.scrollX, d) :
        d + Blockly.Tooltip.DIV.offsetWidth >
                b + window.scrollX - 2 * Blockly.Tooltip.MARGINS &&
            (d = b - Blockly.Tooltip.DIV.offsetWidth -
...
Blockly.Gesture = function(a, b) {
  this.startWorkspace_ = this.targetBlock_ = this.startBlock_ =
      this.startField_ = this.startBubble_ = this.currentDragDeltaXY_ =
          this.mouseDownXY_ = null;
  this.creatorWorkspace_ = b;
  this.isDraggingBubble_ = this.isDraggingBlock_ = this.isDraggingWorkspace_ =
      this.hasExceededDragRadius_ = !1;
  this.mostRecentEvent_ = a;
  this.flyout_ = this.workspaceDragger_ = this.blockDragger_ =
      this.bubbleDragger_ = this.onUpWrapper_ = this.onMoveWrapper_ = null;
...
Blockly.Gesture.prototype.dispose = function() {
  ...
  this.flyout_ = this.startWorkspace_ = this.targetBlock_ = this.startBlock_ =
...
Blockly.Gesture.prototype.updateDragDelta_ = function(a) {
  this.currentDragDeltaXY_ =
      Blockly.utils.Coordinate.difference(a, this.mouseDownXY_);
...
Blockly.Gesture.prototype.updateIsDraggingBlock_ = function() {
  ...
  this.flyout_ ? this.isDraggingBlock_ = this.updateIsDraggingFromFlyout_() :
...
Blockly.Gesture.prototype.updateIsDraggingWorkspace_ = function() {
  if (this.flyout_ ? this.flyout_.isScrollable() :
    ...
    this.isDraggingWorkspace_ = !0, this.workspaceDragger_.startDrag()
};
Blockly.Gesture.prototype.updateIsDragging_ = function() {
  ...
  this.updateIsDraggingBubble_() || this.updateIsDraggingBlock_() ||
      this.updateIsDraggingWorkspace_()
};
Blockly.Gesture.prototype.startDraggingBlock_ = function() {
  this.blockDragger_ =
      new Blockly.BlockDragger(this.targetBlock_, this.startWorkspace_);
...
Blockly.Gesture.prototype.startDraggingBubble_ = function() {
  this.bubbleDragger_ =
      new Blockly.BubbleDragger(this.startBubble_, this.startWorkspace_);
...
Blockly.Gesture.prototype.doStart = function(a) {
  Blockly.utils.isTargetInput(a) ?
      this.cancel() :
      (this.hasStarted_ = !0, Blockly.blockAnimations.disconnectUiStop(),
       this.startWorkspace_.updateScreenCalculationsIfScrolled(),
       this.startWorkspace_.isMutator && this.startWorkspace_.resize(),
       this.startWorkspace_.markFocused(), this.mostRecentEvent_ = a,
       Blockly.hideChaff(!!this.flyout_), Blockly.Tooltip.block(),
       this.targetBlock_ &&
       ...
       Blockly.utils.isRightButton(a) ?
           ...
           ('touchstart' != a.type.toLowerCase() &&
                ...
                'mouse' == a.pointerType || Blockly.longStart_(a, this),
            this.mouseDownXY_ =
...
Blockly.Gesture.prototype.handleRightClick = function(a) {
  this.targetBlock_ ?
      (this.bringBlockToFront_(), Blockly.hideChaff(this.flyout_),
       this.targetBlock_.showContextMenu_(a)) :
      this.startBubble_ ? this.startBubble_.showContextMenu_(a) :
                          this.startWorkspace_ && !this.flyout_ &&
...
Blockly.Gesture.prototype.doWorkspaceClick_ = function(a) {
  ...
  a.shiftKey ? (Blockly.navigation.enableKeyboardAccessibility(),
...
Blockly.Gesture.prototype.setStartBlock = function(a) {
  this.startBlock_ || this.startBubble_ ||
      (this.startBlock_ = a,
...
Blockly.Gesture.prototype.isBlockClick_ = function() {
  return !!this.startBlock_ && !this.hasExceededDragRadius_ &&
      !this.isFieldClick_()
};
Blockly.Gesture.prototype.isFieldClick_ = function() {
  return (this.startField_ ? this.startField_.isClickable() : !1) &&
      !this.hasExceededDragRadius_ && (!this.flyout_ || !this.flyout_.autoClose)
};
Blockly.Gesture.prototype.isWorkspaceClick_ = function() {
  return !this.startBlock_ && !this.startBubble_ && !this.startField_ &&
      !this.hasExceededDragRadius_
};
...
Blockly.Field.prototype.init = function() {
  this.fieldGroup_ ||
      (this.fieldGroup_ = Blockly.utils.dom.createSvgElement('g', {}, null),
       ...
       this.initView(), this.updateEditable(), this.setTooltip(this.tooltip_),
       this.bindEvents_(), this.initModel())
};
...
Blockly.Field.prototype.isClickable = function() {
  return !!this.sourceBlock_ && this.sourceBlock_.isEditable() &&
      !!this.showEditor_ && 'function' === typeof this.showEditor_
};
...
Blockly.Field.prototype.getSize = function() {
  ...
  this.isDirty_ ? (this.render_(), this.isDirty_ = !1) :
                  this.visible_ && 0 == this.size_.width &&
          (console.warn(
...
Blockly.Field.prototype.getScaledBBox_ = function() {
  ...
  return {
    top: c.y, bottom: c.y + b, left: c.x, right: c.x + a
  }
};
...
Blockly.Field.prototype.setValue = function(a) {
  if (null !== a) {
    ...
    if (!(a instanceof Error)) {
      if (b = this.getValidator())
        if (b = b.call(this, a), a = this.processValidation_(a, b),
            a instanceof Error)
          return;
      b = this.getValue();
      b !== a &&
          (this.sourceBlock_ && Blockly.Events.isEnabled() &&
               Blockly.Events.fire(new Blockly.Events.BlockChange(
                   this.sourceBlock_, 'field', this.name || null, b, a)),
           this.doValueUpdate_(a), this.isDirty_ && this.forceRerender())
    }
  }
};
Blockly.Field.prototype.processValidation_ = function(a, b) {
  if (null === b)
    return this.doValueInvalid_(a), this.isDirty_ && this.forceRerender(),
           Error();
  void 0 !== b && (a = b);
  return a
};
...
Blockly.Field.prototype.onMouseDown_ = function(a) {
  this.sourceBlock_ && this.sourceBlock_.workspace &&
      (a = this.sourceBlock_.workspace.getGesture(a)) && a.setStartField(this)
};
...
Blockly.Field.prototype.setCursorSvg = function(a) {
  a ? (this.fieldGroup_.appendChild(a), this.cursorSvg_ = a) :
      this.cursorSvg_ = null
};
Blockly.Field.prototype.setMarkerSvg = function(a) {
  a ? (this.fieldGroup_.appendChild(a), this.markerSvg_ = a) :
...
Blockly.fieldRegistry.fromJson = function(a) {
  ...
  return b ?
      b.fromJson(a) :
      (console.warn(
           'Blockly could not create a field of type ' + a.type +
...
Blockly.Input.prototype.setVisible = function(a) {
  ...
  for (var c = (this.visible_ = a) ? 'block' : 'none', d = 0, e;
       e = this.fieldRow[d]; d++)
    e.setVisible(a);
  this.connection &&
...
Blockly.utils.colour.parse = function(a) {
  ...
  return c &&
          (a = Number(c[1]), b = Number(c[2]), c = Number(c[3]),
...
Blockly.utils.colour.rgbToHex = function(a, b, c) {
  b = a << 16 | b << 8 | c;
  return 16 > a ? '#' + (16777216 | b).toString(16).substr(1) :
                  '#' + b.toString(16)
};
    ...
    try {
      this.workspace &&
          (this.workspace.removeTopBlock(this),
           ...
           delete this.workspace.blockDB_[this.id], this.workspace = null);
...
Blockly.Block.prototype.unplugFromStack_ = function(a) {
  ...
  a && c && !c.isShadow() &&
      (a = this.nextConnection.targetConnection, a.disconnect(),
...
Blockly.Block.prototype.getColourBorder = function() {
  ...
  a = this.getColour();
  return {
    colourBorder: null, colourLight: Blockly.utils.colour.blend('#fff', a, .3),
...
Blockly.Block.prototype.setStyle = function(a) {
  ...
  if (b)
    ...
    this.colourTertiary_ = b.colourTertiary, this.hat = b.hat,
  ...
  for (var a = [], b = 0, c; c = this.inputList[b]; b++)
    for (var d = 0, e; e = c.fieldRow[d]; d++)
      e.referencesVariables() &&
          (e = this.workspace.getVariableById(e.getValue())) && a.push(e);
  return a
};
Blockly.Block.prototype.updateVarName = function(a) {
  for (var b = 0, c; c = this.inputList[b]; b++)
    for (var d = 0, e; e = c.fieldRow[d]; d++)
      e.referencesVariables() && a.getId() == e.getValue() &&
...
Blockly.Block.prototype.getInputsInline = function() {
  ...
  for (var a = 1; a < this.inputList.length; a++)
    if (this.inputList[a - 1].type == Blockly.DUMMY_INPUT &&
        this.inputList[a].type == Blockly.DUMMY_INPUT)
      return !1;
  for (a = 1; a < this.inputList.length; a++)
    if (this.inputList[a - 1].type == Blockly.INPUT_VALUE &&
        this.inputList[a].type == Blockly.DUMMY_INPUT)
      return !0;
  return !1
};
...
Blockly.Block.prototype.setEnabled = function(a) {
  this.isEnabled() != a &&
      (Blockly.Events.fire(new Blockly.Events.BlockChange(
           this, 'disabled', null, this.disabled, !a)),
       this.disabled = !a)
};
...
Blockly.Block.prototype.toString = function(a, b) {
  ...
  if (this.collapsed_)
    ...
    for (var e = 0, f; f = this.inputList[e]; e++) {
      ...
      f.connection &&
          ((f = f.connection.targetBlock()) ? c.push(f.toString(void 0, b)) :
                                              c.push(d))
    }
  c = c.join(' ').trim() || '???';
...
Blockly.Block.prototype.jsonInit = function(a) {
  ...
  for (var c = 0; void 0 !== a['message' + c];)
    this.interpolate_(
        a['message' + c], a['args' + c] || [], a['lastDummyAlign' + c]),
        c++;
  ...
  void 0 !== a.tooltip &&
      (c = a.tooltip, c = Blockly.utils.replaceMessageReferences(c),
       this.setTooltip(c));
  void 0 !== a.enableContextMenu &&
      (c = a.enableContextMenu, this.contextMenu = !!c);
  void 0 !== a.helpUrl &&
      (c = a.helpUrl, c = Blockly.utils.replaceMessageReferences(c),
       this.setHelpUrl(c));
...
Blockly.Block.prototype.interpolate_ = function(a, b, c) {
  ...
  for (var g = 0; g < d.length; g++) {
    ...
    if ('number' == typeof h) {
      if (0 >= h || h > b.length)
        throw Error(
            'Block "' + this.type + '": Message index %' + h +
            ' out of range.');
      if (e[h])
        throw Error(
  ...
  if (f != b.length)
    throw Error(
        'Block "' + this.type + '": Message does not reference all ' +
        b.length + ' arg(s).');
  a.length &&
...
Blockly.Block.prototype.moveInputBefore = function(a, b) {
  if (a != b) {
    for (var c = -1, d = b ? -1 : this.inputList.length, e = 0, f;
         f = this.inputList[e]; e++)
      if (f.name == a) {
        if (c = e, -1 != d) break
...
Blockly.Block.prototype.setCommentText = function(a) {
  this.commentModel.text != a &&
      (Blockly.Events.fire(new Blockly.Events.BlockChange(
           this, 'comment', null, this.commentModel.text, a)),
...
Blockly.BlockDragSurfaceSvg.prototype.translateSurfaceInternal_ = function() {
  ...
  this.SVG_.style.display = 'block';
  Blockly.utils.dom.setCssTransform(
      this.SVG_, 'translate3d(' + a + 'px, ' + b + 'px, 0px)')
};
Blockly.BlockDragSurfaceSvg.prototype.translateSurface = function(a, b) {
  this.surfaceXY_ =
      new Blockly.utils.Coordinate(a * this.scale_, b * this.scale_);
...
Blockly.BlockDragSurfaceSvg.prototype.clearAndHide = function(a) {
  a ? a.appendChild(this.getCurrentBlock()) :
...
Blockly.Component.prototype.render_ = function(a, b) {
  ...
  a ? a.insertBefore(this.element_, b || null) :
...
Blockly.Component.prototype.addChildAt = function(a, b, c) {
  ...
  a.inDocument_ && this.inDocument_ && a.getParent() == this ?
      (c = this.getContentElement(), b = c.childNodes[b] || null,
       b != a.getElement() && c.insertBefore(a.getElement(), b)) :
      c ? (this.element_ || this.createDom(), b = this.getChildAt(b + 1),
           a.render_(this.getContentElement(), b ? b.element_ : null)) :
          this.inDocument_ && !a.inDocument_ && a.element_ &&
...
Blockly.utils.aria.setRole = function(a, b) {
  b ? a.setAttribute(Blockly.utils.aria.ROLE_ATTRIBUTE_, b) :
...
Blockly.Menu.prototype.attachEvents_ = function() {
  ...
  this.mouseOverHandler_ = Blockly.bindEventWithChecks_(
      a, 'mouseover', this, this.handleMouseOver_, !0);
  this.clickHandler_ =
      Blockly.bindEventWithChecks_(a, 'click', this, this.handleClick_, !0);
  this.mouseEnterHandler_ = Blockly.bindEventWithChecks_(
      a, 'mouseenter', this, this.handleMouseEnter_, !0);
  this.mouseLeaveHandler_ = Blockly.bindEventWithChecks_(
      a, 'mouseleave', this, this.handleMouseLeave_, !0);
  this.onKeyDownWrapper_ =
      Blockly.bindEventWithChecks_(a, 'keydown', this, this.handleKeyEvent)
};
...
Blockly.Menu.prototype.setHighlightedIndex = function(a) {
  ...
  b ? (b.setHighlighted(!0), this.highlightedIndex_ = a) :
...
Blockly.Menu.prototype.handleMouseOver_ = function(a) {
  (a = this.getMenuItem(a.target)) && a.isEnabled() &&
...
Blockly.MenuItem.prototype.createDom = function() {
  ...
  a.id = this.getId();
  this.setElementInternal(a);
  a.className = 'goog-menuitem goog-option ' +
  ...
  Blockly.utils.aria.setRole(
      a,
      this.roleName_ ||
          (this.checkable_ ? Blockly.utils.aria.Role.MENUITEMCHECKBOX :
                             Blockly.utils.aria.Role.MENUITEM));
  Blockly.utils.aria.setState(
      a, Blockly.utils.aria.State.SELECTED,
...
Blockly.MenuItem.prototype.setChecked = function(a) {
  if (this.checkable_) {
    ...
    b && this.isEnabled() &&
        (a ? (Blockly.utils.dom.addClass(b, 'goog-option-selected'),
              Blockly.utils.aria.setState(
                  b, Blockly.utils.aria.State.SELECTED, !0)) :
             (Blockly.utils.dom.removeClass(b, 'goog-option-selected'),
              Blockly.utils.aria.setState(
                  b, Blockly.utils.aria.State.SELECTED, !1)))
  }
};
Blockly.MenuItem.prototype.setHighlighted = function(a) {
  ...
  var b = this.getElement();
  b && this.isEnabled() &&
      (a ? Blockly.utils.dom.addClass(b, 'goog-menuitem-highlight') :
...
Blockly.ContextMenu.blockDeleteOption = function(a) {
  ...
  return {
    text: 1 == b ? Blockly.Msg.DELETE_BLOCK :
                   Blockly.Msg.DELETE_X_BLOCKS.replace('%1', String(b)),
        enabled: !0, callback: function() {
          Blockly.Events.setGroup(!0);
          a.dispose(!0, !0);
          Blockly.Events.setGroup(!1)
        }
...
Blockly.ContextMenu.blockHelpOption = function(a) {
  return {
    enabled: !('function' == typeof a.helpUrl ? !a.helpUrl() : !a.helpUrl),
        text: Blockly.Msg.HELP, callback: function() {
          a.showHelp_()
        }
  }
};
...
Blockly.ContextMenu.workspaceCommentOption = function(a, b) {
  ...
  c.callback = function() {
    var c = new Blockly.WorkspaceCommentSvg(
            a, Blockly.Msg.WORKSPACE_COMMENT_DEFAULT_TEXT,
...
Blockly.RenderedConnection.prototype.tighten_ = function() {
  ...
  if (0 != a || 0 != b) {
    ...
    c.getSvgRoot().setAttribute(
        'transform', 'translate(' + (d.x - a) + ',' + (d.y - b) + ')');
...
Blockly.RenderedConnection.prototype.highlight = function() {
  ...
  a = this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ?
      Blockly.utils.svgPaths.moveBy(0, -5) +
          Blockly.utils.svgPaths.lineOnAxis('v', 5) + a.PUZZLE_TAB.pathDown +
          Blockly.utils.svgPaths.lineOnAxis('v', 5) :
      Blockly.utils.svgPaths.moveBy(-5, 0) +
          Blockly.utils.svgPaths.lineOnAxis('h', 5) + a.NOTCH.pathLeft +
...
Blockly.RenderedConnection.prototype.hideAll = function() {
  ...
  if (this.targetConnection)
    for (var a = this.targetBlock().getDescendants(!1), b = 0; b < a.length;
         b++) {
      ...
      (this.iconGroup_ = Blockly.utils.dom.createSvgElement(
       ...
       this.block_.isInFlyout &&
           Blockly.utils.dom.addClass(
               this.iconGroup_, 'blocklyIconGroupReadonly'),
...
Blockly.Icon.prototype.iconClick_ = function(a) {
  this.block_.workspace.isDragging() || this.block_.isInFlyout ||
      Blockly.utils.isRightButton(a) || this.setVisible(!this.isVisible())
};
...
Blockly.Icon.prototype.computeIconLocation = function() {
  ...
  a = new Blockly.utils.Coordinate(
      a.x + b.x + this.SIZE / 2, a.y + b.y + this.SIZE / 2);
...
Blockly.Warning.textToDom_ = function(a) {
  ...
  for (var c = 0; c < a.length; c++) {
    var d = Blockly.utils.dom.createSvgElement(
            'tspan', {dy: '1em', x: Blockly.Bubble.BORDER_WIDTH}, b),
...
Blockly.Warning.prototype.createBubble = function() {
  ...
  this.bubble_ = new Blockly.Bubble(
      this.block_.workspace, this.paragraphElement_, this.block_.svgPath_,
      this.iconXY_, null, null);
  this.bubble_.setSvgId(this.block_.id);
  if (this.block_.RTL)
    for (var a = this.paragraphElement_.getBBox().width, b = 0, c;
         c = this.paragraphElement_.childNodes[b]; b++)
...
Blockly.BlockSvg.prototype.initSvg = function() {
  ...
  this.updateColour();
  this.updateMovable();
  this.workspace.options.readOnly || this.eventsInit_ ||
      Blockly.bindEventWithChecks_(
...
Blockly.BlockSvg.prototype.setParent = function(a) {
  ...
  if (a != b) {
    ...
    if (!this.workspace.isClearing && c) {
      ...
      a ? (a.getSvgRoot().appendChild(c), a = this.getRelativeToSurfaceXY(),
...
Blockly.BlockSvg.prototype.getRelativeToSurfaceXY = function() {
  var a = 0, b = 0,
      c = this.useDragSurface_ ? this.workspace.blockDragSurface_.getGroup() :
                                 null,
      d = this.getSvgRoot();
  if (d) {
    do {
...
Blockly.BlockSvg.prototype.snapToGrid = function() {
  if (this.workspace && !this.workspace.isDragging() && !this.getParent() &&
      !this.isInFlyout) {
...
Blockly.BlockSvg.prototype.generateContextMenu = function() {
  ...
  var a = this, b = [];
  if (!this.isInFlyout) {
    this.isDeletable() && this.isMovable() &&
        b.push(Blockly.ContextMenu.blockDuplicateOption(a));
    this.workspace.options.comments && !this.collapsed_ && this.isEditable() &&
        b.push(Blockly.ContextMenu.blockCommentOption(a));
    if (this.isMovable())
      if (this.collapsed_)
        this.workspace.options.collapse &&
            (c = {enabled: !0}, c.text = Blockly.Msg.EXPAND_BLOCK,
             c.callback = function() {
               a.setCollapsed(!1)
             }, b.push(c));
      else {
        for (var c = 1; c < this.inputList.length; c++)
          if (this.inputList[c - 1].type != Blockly.NEXT_STATEMENT &&
              this.inputList[c].type != Blockly.NEXT_STATEMENT) {
            c = {enabled: !0};
            var d = this.getInputsInline();
            c.text =
                d ? Blockly.Msg.EXTERNAL_INPUTS : Blockly.Msg.INLINE_INPUTS;
            c.callback = function() {
              a.setInputsInline(!d)
            };
            b.push(c);
        ...
        this.workspace.options.collapse &&
            (c = {enabled: !0}, c.text = Blockly.Msg.COLLAPSE_BLOCK,
             c.callback = function() {
               a.setCollapsed(!0)
             }, b.push(c))
      }
    this.workspace.options.disable && this.isEditable() &&
        (c = {
          text: this.isEnabled() ? Blockly.Msg.DISABLE_BLOCK :
...
Blockly.BlockSvg.prototype.setDragging = function(a) {
  if (a) {
    ...
    Blockly.draggingConnections_ =
        Blockly.draggingConnections_.concat(this.getConnections_(!0));
...
Blockly.BlockSvg.prototype.setInsertionMarker = function(a) {
  this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) &&
...
Blockly.BlockSvg.prototype.updateColour = function() {
  if (this.isEnabled()) {
    this.isShadow() ? this.setShadowColour_() :
...
Blockly.BlockSvg.prototype.setBorderColour_ = function() {
  ...
  a.colourBorder ? (this.svgPathLight_.style.display = 'none',
...
Blockly.BlockSvg.prototype.setCommentText = function(a) {
  ...
  this.commentModel.text != a &&
      (Blockly.BlockSvg.superClass_.setCommentText.call(this, a), a = null != a,
       !!this.commentIcon_ == a ?
           this.commentIcon_.updateText() :
           (a ? this.comment = this.commentIcon_ = new Blockly.Comment(this) :
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
  ...
  if (this.workspace.isDragging()) {
    ...
    'string' == typeof a ?
        ...
        this.warning && !c ? (this.warning.dispose(), d = !0) :
                             this.warning &&
                (d = this.warning.getText(), this.warning.setText('', c),
...
Blockly.BlockSvg.prototype.setDeleteStyle = function(a) {
  a ? Blockly.utils.dom.addClass(this.svgGroup_, 'blocklyDraggingDelete') :
  ...
  if (this.workspace && !this.workspace.isDragging()) {
    ...
    if (!a.isInFlyout)
      for (var b = this.getConnections_(!1), c = 0, d; d = b[c]; c++) {
        ...
        for (var e = d.neighbours_(Blockly.SNAP_RADIUS), f = 0, g; g = e[f];
             f++)
...
Blockly.BlockSvg.prototype.setCursorSvg = function(a) {
  a ? (this.svgGroup_.appendChild(a), this.cursorSvg_ = a) :
      this.cursorSvg_ = null
};
Blockly.BlockSvg.prototype.setMarkerSvg = function(a) {
  a ? (this.cursorSvg_ ? this.svgGroup_.insertBefore(a, this.cursorSvg_) :
...
Blockly.BlockSvg.prototype.highlightForReplacement = function(a) {
  a ? Blockly.utils.dom.addClass(this.svgGroup_, 'blocklyReplaceable') :
...
Blockly.DropDownDiv.createDom = function() {
  if (!Blockly.DropDownDiv.DIV_) {
    ...
    Blockly.DropDownDiv.DIV_.style.transition = 'transform ' +
        Blockly.DropDownDiv.ANIMATION_TIME + 's, opacity ' +
...
Blockly.DropDownDiv.showPositionedByField = function(a, b, c) {
  var d = a.fieldGroup_.getBoundingClientRect(), e = d.left + d.width / 2,
      f = d.bottom;
  d = d.top;
  c && (d += c);
...
Blockly.DropDownDiv.getBoundsInfo_ = function() {
  ...
  return {
    left: a.left, right: a.left + b.width, top: a.top, bottom: a.top + b.height,
...
Blockly.DropDownDiv.getPositionBelowMetrics = function(a, b, c, d) {
  ...
  return {
    initialX: a.divX, initialY: b, finalX: a.divX,
        finalY: b + Blockly.DropDownDiv.PADDING_Y, arrowX: a.arrowX,
        arrowY:
            -(Blockly.DropDownDiv.ARROW_SIZE / 2 +
              Blockly.DropDownDiv.BORDER_SIZE),
        arrowAtTop: !0, arrowVisible: !0
  }
};
Blockly.DropDownDiv.getPositionAboveMetrics = function(a, b, c, d) {
  a = Blockly.DropDownDiv.getPositionX(a, c.left, c.right, d.width);
  return {
    initialX: a.divX, initialY: b - d.height, finalX: a.divX,
        finalY: b - d.height - Blockly.DropDownDiv.PADDING_Y, arrowX: a.arrowX,
        arrowY: d.height - 2 * Blockly.DropDownDiv.BORDER_SIZE -
        Blockly.DropDownDiv.ARROW_SIZE / 2,
        arrowAtTop: !1, arrowVisible: !0
  }
};
Blockly.DropDownDiv.getPositionTopOfPageMetrics = function(a, b, c) {
  ...
  return {
    initialX: a.divX, initialY: 0, finalX: a.divX, finalY: 0, arrowVisible: !1
  }
};
Blockly.DropDownDiv.getPositionX = function(a, b, c, d) {
  ...
  d = Blockly.utils.math.clamp(
      b, e - a, d - b - Blockly.DropDownDiv.ARROW_SIZE);
  return {
    arrowX: d, divX: a
  }
};
...
Blockly.DropDownDiv.hideIfOwner = function(a, b) {
  return Blockly.DropDownDiv.owner_ === a ?
      (b ? Blockly.DropDownDiv.hideWithoutAnimation() :
...
Blockly.DropDownDiv.repositionForWindowResize = function() {
  if (Blockly.DropDownDiv.owner_) {
    ...
    Blockly.DropDownDiv.positionInternal_(
        d.initialX, d.initialY, d.finalX, d.finalY)
  } else
    Blockly.DropDownDiv.hide()
};
...
Blockly.Grid.prototype.setLineAttributes_ = function(a, b, c, d, e, f) {
  a &&
      (a.setAttribute('stroke-width', b), a.setAttribute('x1', c),
       a.setAttribute('y1', e), a.setAttribute('x2', d),
       a.setAttribute('y2', f))
};
...
Blockly.Grid.createDom = function(a, b, c) {
  a = Blockly.utils.dom.createSvgElement(
      'pattern', {id: 'blocklyGridPattern' + a, patternUnits: 'userSpaceOnUse'},
      c);
...
Blockly.Options = function(a) {
  ...
  p = 'end' === p ? !1 : !0;
  p = n ? p ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM :
          p == m ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT;
  var q = a.css;
  void 0 === q && (q = !0);
...
Blockly.Options.parseMoveOptions = function(a, b) {
  var c = a.move || {}, d = {};
  d.scrollbars = void 0 === c.scrollbars && void 0 === a.scrollbars ?
      b :
...
Blockly.WorkspaceDragSurfaceSvg.prototype.translateSurface = function(a, b) {
  ...
  this.SVG_.style.display = 'block';
  Blockly.utils.dom.setCssTransform(
      this.SVG_, 'translate3d(' + c + 'px, ' + d + 'px, 0px)')
};
...
Blockly.WorkspaceDragSurfaceSvg.prototype.clearAndHide = function(a) {
  ...
  if (!(b && c && Blockly.utils.dom.hasClass(b, 'blocklyBlockCanvas') &&
...
Blockly.ConnectionDB.prototype.findPositionForConnection_ = function(a) {
  ...
  for (var b = 0, c = this.connections_.length; b < c;) {
    ...
    if (this.connections_[d].y_ < a.y_)
      b = d + 1;
    else if (this.connections_[d].y_ > a.y_)
      c = d;
    else {
      b = d;
      break
...
Blockly.ConnectionDB.prototype.getNeighbours = function(a, b) {
  ...
  for (var d = this.connections_, e = a.x_, f = a.y_, g = 0, h = d.length - 2,
           k = h;
       g < k;)
...
Blockly.ConnectionDB.prototype.searchForClosest = function(a, b, c) {
  ...
  for (var g = b, h, k = f - 1; 0 <= k && this.isInYRange_(k, a.y_, b);)
    ...
    a.isConnectionAllowed(h, g) && (c = h, g = h.distanceFrom(a)), k--;
  for (; f < this.connections_.length && this.isInYRange_(f, a.y_, b);)
    h = this.connections_[f],
    a.isConnectionAllowed(h, g) && (c = h, g = h.distanceFrom(a)), f++;
  a.x_ = e;
  a.y_ = d;
  return {
    connection: c, radius: g
  }
};
...
Blockly.TouchGesture.prototype.bindMouseEvents = function(a) {
  this.onStartWrapper_ = Blockly.bindEventWithChecks_(
      document, 'mousedown', null, this.handleStart.bind(this), !0);
  this.onMoveWrapper_ = Blockly.bindEventWithChecks_(
      document, 'mousemove', null, this.handleMove.bind(this), !0);
  this.onUpWrapper_ = Blockly.bindEventWithChecks_(
      document, 'mouseup', null, this.handleUp.bind(this), !0);
  a.preventDefault();
  a.stopPropagation()
};
Blockly.TouchGesture.prototype.handleStart = function(a) {
  !this.isDragging() && Blockly.Touch.isTouchEvent(a) &&
      (this.handleTouchStart(a), this.isMultiTouch() && Blockly.longStop_())
};
Blockly.TouchGesture.prototype.handleMove = function(a) {
  this.isDragging() ? Blockly.Touch.shouldHandleEvent(a) &&
...
Blockly.TouchGesture.prototype.handleTouchStart = function(a) {
  ...
  2 == b.length &&
      (this.startDistance_ = Blockly.utils.Coordinate.distance(
           this.cachedPoints_[b[0]], this.cachedPoints_[b[1]]),
       this.isMultiTouch_ = !0, a.preventDefault())
};
...
Blockly.WorkspaceAudio.prototype.play = function(a, b) {
  ...
  if (c) {
    ...
    null != this.lastSound_ && d - this.lastSound_ < Blockly.SOUND_LIMIT ||
        (this.lastSound_ = d,
         c = Blockly.utils.userAgent.IPAD || Blockly.utils.userAgent.ANDROID ?
             c :
             c.cloneNode(),
...
Blockly.WorkspaceSvg.prototype.setCursor = function(a) {
  this.cursor_ && this.cursor_.getDrawer() &&
...
Blockly.WorkspaceSvg.prototype.setMarker = function(a) {
  this.marker_ && this.marker_.getDrawer() &&
...
Blockly.WorkspaceSvg.prototype.getInverseScreenCTM = function() {
  if (this.inverseScreenCTMDirty_) {
    ...
    a &&
        (this.inverseScreenCTM_ = a.inverse(), this.inverseScreenCTMDirty_ = !1)
  }
...
Blockly.WorkspaceSvg.prototype.getSvgXY = function(a) {
  var b = 0, c = 0, d = 1;
  if (Blockly.utils.dom.containsNode(this.getCanvas(), a) ||
...
Blockly.WorkspaceSvg.prototype.createDom = function(a) {
  ...
  a &&
      (this.svgBackground_ = Blockly.utils.dom.createSvgElement(
           'rect', {height: '100%', width: '100%', 'class': a}, this.svgGroup_),
       'blocklyMainBackground' == a&& this.grid_ ?
           this.svgBackground_.style.fill =
               'url(#' + this.grid_.getPatternId() + ')' :
           this.themeManager_.subscribe(
               this.svgBackground_, 'workspace', 'fill'));
  ...
  this.isFlyout ||
      (Blockly.bindEventWithChecks_(
           this.svgGroup_, 'mousedown', this, this.onMouseDown_, !1, !0),
       Blockly.bindEventWithChecks_(
...
Blockly.WorkspaceSvg.prototype.dispose = function() {
  ...
  this.flyoutButtonCallbacks_ = this.toolboxCategoryCallbacks_ =
...
Blockly.WorkspaceSvg.prototype.getFlyout = function() {
  return this.flyout_ ? this.flyout_ :
                        this.toolbox_ ? this.toolbox_.flyout_ : null
};
...
Blockly.WorkspaceSvg.prototype.setupDragSurface = function() {
  if (this.useWorkspaceDragSurface_ && !this.isDragSurfaceActive_) {
    ...
    this.workspaceDragSurface_.setContentsAndShow(
        this.svgBlockCanvas_, this.svgBubbleCanvas_, a, b, c, this.scale);
...
Blockly.WorkspaceSvg.prototype.render = function() {
  ...
  if (this.currentGesture_)
    for (a = this.currentGesture_.getInsertionMarkers(), b = 0; b < a.length;
         b++)
      a[b].render(!1)
};
...
Blockly.WorkspaceSvg.prototype.paste = function(a) {
  !this.rendered ||
      ...
      (this.currentGesture_ && this.currentGesture_.cancel(),
       'comment' == a.tagName.toLowerCase() ? this.pasteWorkspaceComment_(a) :
                                              this.pasteBlock_(a))
};
Blockly.WorkspaceSvg.prototype.pasteBlock_ = function(a) {
    ...
    if (!isNaN(d) && !isNaN(e)) {
      ...
      do {
        ...
        if (!a) {
          ...
          for (var l; l = k[c]; c++)
            if (l.closest(
                     Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(d, e))
                    .connection) {
              a = !0;
              break
            }
  ...
  Blockly.Events.isEnabled() && !b.isShadow() &&
...
Blockly.WorkspaceSvg.prototype.refreshToolboxSelection = function() {
  ...
  a && !a.currentGesture_ && a.toolbox_ && a.toolbox_.flyout_ &&
...
Blockly.WorkspaceSvg.prototype.recordDeleteAreas = function() {
  this.deleteAreaTrash_ = this.trashcan && this.svgGroup_.parentNode ?
...
Blockly.WorkspaceSvg.prototype.startDrag = function(a, b) {
  var c = Blockly.utils.mouseToSvg(
      a, this.getParentSvg(), this.getInverseScreenCTM());
  c.x /= this.scale;
  c.y /= this.scale;
...
Blockly.WorkspaceSvg.prototype.onMouseWheel_ = function(a) {
  if (Blockly.Gesture.inProgress())
    ...
    if (b || c) {
      ...
      !b || !a.ctrlKey && c ?
          (b = this.scrollX - d.x, c = this.scrollY - d.y,
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function(a) {
  ...
  if (!this.options.readOnly && !this.isFlyout) {
    var d = [], e = this.getTopBlocks(!0), f = Blockly.utils.genUid(), g = this,
        h = {};
    ...
    d.push(h);
    this.isMovable() &&
        (h = {}, h.text = Blockly.Msg.CLEAN_UP, h.enabled = 1 < e.length,
         h.callback = this.cleanUp.bind(this), d.push(h));
...
Blockly.WorkspaceSvg.prototype.zoomCenter = function(a) {
  ...
  if (this.flyout_) {
    ...
    c = b.viewWidth / 2 + b.absoluteLeft, b = b.viewHeight / 2 + b.absoluteTop;
  this.zoom(c, b, a)
};
...
Blockly.WorkspaceSvg.prototype.beginCanvasTransition = function() {
  Blockly.utils.dom.addClass(
      this.svgBlockCanvas_, 'blocklyCanvasTransitioning');
  Blockly.utils.dom.addClass(
      this.svgBubbleCanvas_, 'blocklyCanvasTransitioning')
};
...
Blockly.WorkspaceSvg.prototype.centerOnBlock = function(a) {
  if (this.isMovable()) {
    if (a = this.getBlockById(a)) {
      var b = a.getRelativeToSurfaceXY(), c = a.getHeightWidth(),
          d = this.scale;
...
Blockly.WorkspaceSvg.prototype.setScale = function(a) {
  ...
  this.scrollbar &&
      (this.flyout_ ? (this.scrollbar.hScroll.resizeViewHorizontal(a),
...
Blockly.WorkspaceSvg.getContentDimensionsExact_ = function(a) {
  ...
  b = b.right * c;
  return {
    top: a, bottom: d, left: e, right: b, width: b - e, height: d - a
  }
};
Blockly.WorkspaceSvg.getContentDimensionsBounded_ = function(a, b) {
  var c = Blockly.WorkspaceSvg.getContentDimensionsExact_(a), d = b.width,
      e = b.height, f = d / 2, g = e / 2, h = Math.min(c.left - f, c.right - d),
      k = Math.min(c.top - g, c.bottom - e);
  return {
    left: h, top: k, height: Math.max(c.bottom + g, c.top + e) - k,
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function() {
  ...
  this.toolbox_&& this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT ?
      f = a.width :
      this.flyout_ && this.toolboxPosition == Blockly.TOOLBOX_AT_LEFT &&
          (f = b.width);
  var g = 0;
  this.toolbox_&& this.toolboxPosition == Blockly.TOOLBOX_AT_TOP ?
      g = a.height :
      this.flyout_ && this.toolboxPosition == Blockly.TOOLBOX_AT_TOP &&
          (g = b.height);
  return {
    contentHeight: e.height, contentWidth: e.width, contentTop: e.top,
        contentLeft: e.left, viewHeight: d.height, viewWidth: d.width,
        viewTop: -this.scrollY, viewLeft: -this.scrollX, absoluteTop: g,
        absoluteLeft: f, svgHeight: c.height, svgWidth: c.width,
        toolboxWidth: a.width, toolboxHeight: a.height, flyoutWidth: b.width,
        flyoutHeight: b.height, toolboxPosition: this.toolboxPosition
  }
};
...
Blockly.WorkspaceSvg.prototype.getGesture = function(a) {
  ...
  return c ? b && c.hasStarted() ?
             (console.warn('Tried to start the same gesture twice.'),
              c.cancel(), null) :
             c :
             b ? this.currentGesture_ = new Blockly.TouchGesture(a, this) : null
};
...
Blockly.createDom_ = function(a, b) {
  ...
  var c = Blockly.utils.dom.createSvgElement(
      ...
      f = Blockly.utils.dom.createSvgElement(
          'filter', {id: 'blocklyEmbossFilter' + e}, d);
  Blockly.utils.dom.createSvgElement(
  ...
  var g = Blockly.utils.dom.createSvgElement(
      ...
      f);
  Blockly.utils.dom.createSvgElement(
      'fePointLight', {x: -5E3, y: -1E4, z: 2E4}, g);
  Blockly.utils.dom.createSvgElement(
      'feComposite',
  ...
  f = Blockly.utils.dom.createSvgElement(
      ...
      d);
  Blockly.utils.dom.createSvgElement(
      'rect', {width: 10, height: 10, fill: '#aaa'}, f);
  Blockly.utils.dom.createSvgElement(
      'path', {d: 'M 0 0 L 10 10 M 10 0 L 0 10', stroke: '#cc0'}, f);
...
Blockly.createMainWorkspace_ = function(a, b, c, d) {
  ...
  !b.hasCategories && b.languageTree &&
  ...
  b.readOnly || e.isMovable() || e.addChangeListener(function(a) {
    if (!e.isDragging() && !e.isMovable() &&
      ...
      e.isContentBounded() ?
          (c = e.getBlocksBoundingBox(), b.contentLeft = c.left,
           b.contentTop = c.top, b.contentRight = c.right,
           b.contentBottom = c.bottom) :
          (b.contentLeft = c.contentLeft / d, b.contentTop = c.contentTop / d,
           b.contentRight = (c.contentLeft + c.contentWidth) / d,
           b.contentBottom = (c.contentTop + c.contentHeight) / d);
      if (b.contentTop < b.viewTop || b.contentBottom > b.viewBottom ||
          b.contentLeft < b.viewLeft || b.contentRight > b.viewRight) {
        c = null;
...
Blockly.init_ = function(a) {
  ...
  b.languageTree &&
      (a.toolbox_ ? a.toolbox_.init(a) :
                    a.flyout_ &&
               (a.flyout_.init(a), a.flyout_.show(b.languageTree.childNodes),
...
Blockly.inject.bindDocumentEvents_ = function() {
  Blockly.documentEventsBound_ ||
      (Blockly.bindEventWithChecks_(
       ...
       Blockly.bindEventWithChecks_(
           document, 'keydown', null, Blockly.onKeyDown_),
...
Blockly.ASTNode.createConnectionNode = function(a) {
  return a ? a.type == Blockly.INPUT_VALUE ||
...
Blockly.ASTNode.createInputNode = function(a) {
  return a ? new Blockly.ASTNode(Blockly.ASTNode.types.INPUT, a.connection) :
             null
};
...
Blockly.ASTNode.createWorkspaceNode = function(a, b) {
  return new Blockly.ASTNode(
      Blockly.ASTNode.types.WORKSPACE, a, {wsCoordinate: b})
};
...
Blockly.ASTNode.prototype.findNextForField_ = function() {
  var a = this.location_, b = a.getParentInput(), c = a.getSourceBlock(),
...
Blockly.ASTNode.prototype.findPrevForInput_ = function() {
  for (var a = this.location_.getParentInput(), b = a.getSourceBlock(),
           c = b.inputList.indexOf(a), d;
       d = b.inputList[c]; c--) {
...
Blockly.ASTNode.prototype.findTopASTNodeForBlock_ = function(a) {
  ...
  return b ? Blockly.ASTNode.createConnectionNode(b) :
...
Blockly.ASTNode.prototype.out = function() {
  switch (this.type_) {
    case Blockly.ASTNode.types.STACK:
      ...
      a = new Blockly.utils.Coordinate(
          a.x, a.y + Blockly.ASTNode.DEFAULT_OFFSET_Y);
...
Blockly.user.keyMap.serializeKeyEvent = function(a) {
  for (var b = Blockly.utils.object.values(Blockly.user.keyMap.modifierKeys),
           c = '', d = 0, e;
       e = b[d]; d++)
...
Blockly.user.keyMap.createDefaultKeyMap = function() {
  var a = {},
      b = Blockly.user.keyMap.createSerializedKey(
...
Blockly.navigation.focusFlyout_ = function() {
  ...
  b && b.getWorkspace() &&
      (a = b.getWorkspace().getTopBlocks(!0),
       0 < a.length &&
           (a = a[0], a = Blockly.ASTNode.createStackNode(a),
            Blockly.navigation.getFlyoutCursor_().setCurNode(a)))
};
Blockly.navigation.focusWorkspace_ = function() {
  Blockly.hideChaff();
  var a = Blockly.getMainWorkspace(), b = a.getCursor(), c = !!a.getToolbox(),
      d = a.getTopBlocks(!0);
  ...
  0 < d.length ?
      ...
      (c = new Blockly.utils.Coordinate(100, 100),
       a = Blockly.ASTNode.createWorkspaceNode(a, c), b.setCurNode(a))
};
...
Blockly.navigation.insertFromFlyout = function() {
  ...
  if (b && b.isVisible()) {
    ...
    c.isEnabled() ?
        (b = b.createBlock(c), b.render(), b.setConnectionsHidden(!1),
...
Blockly.navigation.moveBlockToWorkspace_ = function(a, b) {
  if (a.isShadow())
    return Blockly.navigation.warn_(
...
Blockly.navigation.modify_ = function() {
  ...
  var c = a.getType(), d = b.getType(), e = b.getLocation(),
      f = a.getLocation();
...
Blockly.navigation.getInferiorConnection_ = function(a) {
  ...
  return a.isSuperior() ? b.previousConnection ?
                          b.previousConnection :
                          b.outputConnection ? b.outputConnection : null :
                          a
};
...
Blockly.navigation.connect_ = function(a, b) {
  ...
  if (c && d && Blockly.navigation.moveAndConnect_(c, d) ||
  ...
  switch (b.type) {
    ...
    case Blockly.OUTPUT_VALUE:
      for (var c = 0; c < a.inputList.length; c++) {
        ...
        if (d && d.type === Blockly.INPUT_VALUE &&
    ...
    c.isConnected() ?
        (b = c.isSuperior() ? c : c.targetConnection,
         ...
         c.getSourceBlock().isShadow() ?
             ...
             (b.disconnect(), c.bumpAwayFrom_(b),
...
Blockly.navigation.getSourceBlock_ = function(a) {
  return a ? a.getType() === Blockly.ASTNode.types.BLOCK ?
             a.getLocation() :
...
Blockly.navigation.moveCursorOnBlockDelete = function(a) {
  ...
  if (b && (b = b.getCursor())) {
    ...
    c === a ? c.getParent() ?
              ...
              b.setCurNode(Blockly.ASTNode.createWorkspaceNode(
                  c.workspace, c.getRelativeToSurfaceXY())) :
...
Blockly.navigation.onBlocklyAction = function(a) {
  ...
  Blockly.keyboardAccessibilityMode ?
      b ? -1 < Blockly.navigation.READONLY_ACTION_LIST.indexOf(a) &&
...
Blockly.Names.prototype.getNameForUserVariable_ = function(a) {
  return this.variableMap_ ?
      (a = this.variableMap_.getVariableById(a)) ? a.name : null :
      (console.log(
...
Blockly.Names.prototype.getName = function(a, b) {
  ...
  c = a.toLowerCase() + '_' + b;
  var d = b == Blockly.Variables.NAME_TYPE ||
...
Blockly.Names.prototype.getDistinctName = function(a, b) {
  for (var c = this.safeName_(a), d = '';
       this.dbReverse_[c + d] || c + d in this.reservedDict_;)
    d = d ? d + 1 : 2;
  c += d;
  this.dbReverse_[c] = !0;
  return (b == Blockly.Variables.NAME_TYPE ||
                  b == Blockly.Names.DEVELOPER_VARIABLE_TYPE ?
              this.variablePrefix_ :
              '') +
      c
...
Blockly.Procedures.findLegalName = function(a, b) {
  ...
  for (a = a || Blockly.Msg.UNNAMED_KEY || 'unnamed';
...
Blockly.Procedures.flyoutCategory = function(a) {
  ...
  if (Blockly.Blocks.procedures_defnoreturn) {
    ...
    e.appendChild(Blockly.utils.xml.createTextNode(
  ...
  Blockly.Blocks.procedures_defreturn &&
      (d = Blockly.utils.xml.createElement('block'),
       ...
       d.setAttribute('gap', 16), e = Blockly.utils.xml.createElement('field'),
       e.setAttribute('name', 'NAME'),
       e.appendChild(Blockly.utils.xml.createTextNode(
  ...
  Blockly.Blocks.procedures_ifreturn &&
      (d = Blockly.utils.xml.createElement('block'),
       d.setAttribute('type', 'procedures_ifreturn'), d.setAttribute('gap', 16),
       c.push(d));
...
Blockly.Procedures.mutateCallers = function(a) {
  var b = Blockly.Events.recordUndo, c = a.getProcedureDef()[0],
      d = a.mutationToDom(!0);
        ...
        (e = d.getDeveloperVars,
         Blockly.Variables.ALL_DEVELOPER_VARS_WARNINGS_BY_BLOCK_TYPE_[d.type] ||
             (console.warn(
                  ...
                  d.type + '\')'),
              Blockly.Variables
                  .ALL_DEVELOPER_VARS_WARNINGS_BY_BLOCK_TYPE_[d.type] = !0));
    if (e)
...
Blockly.Variables.flyoutCategoryBlocks = function(a) {
  ...
  if (0 < a.length) {
    ...
    if (Blockly.Blocks.variables_get) {
      ...
      for (var e; e = a[c]; c++)
        d = Blockly.utils.xml.createElement('block'),
        d.setAttribute('type', 'variables_get'), d.setAttribute('gap', 8),
        d.appendChild(Blockly.Variables.generateVariableFieldDom(e)), b.push(d)
    }
  }
  return b
};
Blockly.Variables.generateUniqueName = function(a) {
  ...
  if (a.length)
    for (var c = 1, d = 0, e = 'ijkmnopqrstuvwxyzabcdefgh'.charAt(d); !b;) {
      ...
      f ? (d++, 25 == d && (d = 0, c++),
           e = 'ijkmnopqrstuvwxyzabcdefgh'.charAt(d), 1 < c && (e += c)) :
          b = e
    }
  else
    b = 'i';
  ...
  var d = function(e) {
    ...
    Blockly.Variables.promptName(f, e, function(e) {
      if (e) {
        ...
        f ? (f = Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE
                     .replace('%1', e.toLowerCase())
                     .replace('%2', f.type),
             Blockly.alert(
                 f,
                 function() {
...
Blockly.WidgetDiv.hide = function() {
  Blockly.WidgetDiv.owner_ &&
      (Blockly.WidgetDiv.owner_ = null,
       ...
       Blockly.WidgetDiv.dispose_ = null, Blockly.WidgetDiv.DIV.innerHTML = '')
};
...
Blockly.WidgetDiv.positionWithAnchor = function(a, b, c, d) {
  ...
  0 > e ? Blockly.WidgetDiv.positionInternal_(a, 0, c.height + e) :
...
Blockly.svgSize = function(a) {
  return {
    width: a.cachedWidth_, height: a.cachedHeight_
  }
};
  ...
  if (!(Blockly.utils.isTargetInput(a) || b.rendered && !b.isVisible()))
    if (b.options.readOnly)
      ...
      if (a.keyCode == Blockly.utils.KeyCodes.ESC)
        ...
        if (a.keyCode == Blockly.utils.KeyCodes.BACKSPACE ||
      ...
      c && !Blockly.selected.workspace.isFlyout &&
          (Blockly.Events.setGroup(!0), Blockly.hideChaff(),
           Blockly.selected.dispose(!0, !0), Blockly.Events.setGroup(!1))
    }
};
Blockly.copy_ = function(a) {
  ...
  Blockly.clipboardTypeCounts_ =
      a.isComment ? null : Blockly.utils.getBlockTypeCounts(a, !0)
};
...
Blockly.hideChaff = function(a) {
  ...
  a ||
      (a = Blockly.getMainWorkspace(),
       ...
       a.toolbox_ && a.toolbox_.flyout_ && a.toolbox_.flyout_.autoClose &&
    ...
    if (c) {
      ...
      null == d || '' === d ?
          ...
          (Blockly.Blocks[d] &&
               console.warn(
                   'Block definition #' + b +
                   ' in JSON array overwrites prior definition of "' + d +
                   '".'),
...
Blockly.bindEventWithChecks_ = function(a, b, c, d, e, f) {
  ...
  if (Blockly.utils.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
    for (var l = 0, m; m = Blockly.Touch.TOUCH_MAP[b][l]; l++)
      ...
      a.addEventListener(b, h, !1), k.push([a, b, h]),
...
Blockly.bindEvent_ = function(a, b, c, d) {
  ...
  if (Blockly.utils.global.PointerEvent && b in Blockly.Touch.TOUCH_MAP)
    for (var g = 0, h; h = Blockly.Touch.TOUCH_MAP[b][g]; g++)
      ...
      a.addEventListener(b, e, !1), f.push([a, b, e]),
      b in Blockly.Touch.TOUCH_MAP) {
    var k = function(a) {
...
Blockly.Comment.prototype.drawIcon_ = function(a) {
  Blockly.utils.dom.createSvgElement(
      'circle', {'class': 'blocklyIconShape', r: '8', cx: '8', cy: '8'}, a);
  Blockly.utils.dom.createSvgElement(
      'path', {
        'class': 'blocklyIconSymbol',
...
Blockly.Comment.prototype.resizeTextarea_ = function() {
  var a = this.model_.size, b = 2 * Blockly.Bubble.BORDER_WIDTH,
      c = a.width - b;
  a = a.height - b;
...
Blockly.Comment.prototype.createEditableBubble_ = function() {
  this.bubble_ = new Blockly.Bubble(
      this.block_.workspace, this.createEditor_(), this.block_.svgPath_,
...
Blockly.Comment.prototype.setBubbleSize = function(a, b) {
  this.bubble_ ? this.bubble_.setBubbleSize(a, b) :
...
Blockly.Comment.prototype.updateText = function() {
  this.textarea_ ? this.textarea_.value = this.model_.text :
                   this.paragraphElement_ &&
...
Blockly.tree.BaseNode.prototype.initAccessibility = function() {
  ...
  if (a) {
    ...
    Blockly.utils.aria.setState(
        a, Blockly.utils.aria.State.LEVEL, this.getDepth());
    b &&
        Blockly.utils.aria.setState(
            a, Blockly.utils.aria.State.LABELLEDBY, b.id);
    ...
    if (b = this.getChildrenElement())
      if (Blockly.utils.aria.setRole(b, Blockly.utils.aria.Role.GROUP),
          b.hasChildNodes())
        for (Blockly.utils.aria.setState(
                 a, Blockly.utils.aria.State.EXPANDED, !1),
             a = this.getChildCount(), b = 1;
             b <= a; b++) {
...
Blockly.tree.BaseNode.prototype.addChildAt = function(a, b) {
  ...
  if (e = this.getElement())
    if (this.updateExpandIcon(),
        Blockly.utils.aria.setState(
            e, Blockly.utils.aria.State.EXPANDED, this.getExpanded()),
        this.getExpanded()) {
        ...
        (Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, a),
         a &&
             (a = this.getTree().getElement(),
              Blockly.utils.aria.setState(
                  a, Blockly.utils.aria.State.ACTIVEDESCENDANT, this.getId())))
  }
};
    ...
    if (!a && d && this.contains(d.getSelectedItem()) && this.select(), e) {
      if (c = this.getChildrenElement())
        Blockly.utils.style.setElementShown(c, a),
            Blockly.utils.aria.setState(
                e, Blockly.utils.aria.State.EXPANDED, a),
...
Blockly.tree.BaseNode.prototype.selectChild = function() {
  return this.hasChildren() ?
      (this.getExpanded() ? this.getFirstChild().select() :
                            this.setExpanded(!0),
       !0) :
      !1
};
...
Blockly.tree.TreeControl.prototype.setSelectedItem = function(a) {
  if (a != this.selectedItem_ &&
      (!this.onBeforeSelected_ ||
       this.onBeforeSelected_.call(this.toolbox_, a))) {
...
Blockly.tree.TreeControl.prototype.initAccessibility = function() {
  ...
  Blockly.utils.aria.setState(
      a, Blockly.utils.aria.State.LABELLEDBY, this.getLabelElement().id)
};
...
Blockly.tree.TreeControl.prototype.attachEvents_ = function() {
  ...
  this.onFocusWrapper_ =
      Blockly.bindEvent_(a, 'focus', this, this.handleFocus_);
  this.onBlurWrapper_ = Blockly.bindEvent_(a, 'blur', this, this.handleBlur_);
  this.onClickWrapper_ =
      Blockly.bindEventWithChecks_(a, 'click', this, this.handleMouseEvent_);
  this.onKeydownWrapper_ =
      Blockly.bindEvent_(a, 'keydown', this, this.handleKeyEvent_)
};
...
Blockly.tree.TreeControl.prototype.handleKeyEvent_ = function(a) {
  ...
  if (b = this.selectedItem_ && this.selectedItem_.onKeyDown(a) || b)
    Blockly.utils.style.scrollIntoContainerView(
        this.selectedItem_.getElement(), this.getElement().parentNode),
        a.preventDefault();
  return b
};
...
Blockly.FieldTextInput.prototype.doValueInvalid_ = function(a) {
  this.isBeingEdited_ &&
      (this.isTextValid_ = !1, a = this.value_,
       this.value_ = this.htmlInput_.untypedDefaultValue_,
       this.sourceBlock_ && Blockly.Events.isEnabled() &&
           Blockly.Events.fire(new Blockly.Events.BlockChange(
               this.sourceBlock_, 'field', this.name || null, a, this.value_)))
};
...
Blockly.FieldTextInput.prototype.render_ = function() {
  ...
  this.isBeingEdited_ &&
      (this.sourceBlock_.RTL ? setTimeout(this.resizeEditor_.bind(this), 0) :
                               this.resizeEditor_(),
       this.isTextValid_ ?
           (Blockly.utils.dom.removeClass(
                this.htmlInput_, 'blocklyInvalidInput'),
...
Blockly.FieldTextInput.prototype.widgetCreate_ = function() {
  ...
  b.oldValue_ = null;
  Blockly.utils.userAgent.GECKO ? setTimeout(this.resizeEditor_.bind(this), 0) :
                                  this.resizeEditor_();
...
Blockly.FieldTextInput.prototype.bindInputEvents_ = function(a) {
  this.onKeyDownWrapper_ = Blockly.bindEventWithChecks_(
      a, 'keydown', this, this.onHtmlInputKeyDown_);
  this.onKeyInputWrapper_ =
      Blockly.bindEventWithChecks_(a, 'input', this, this.onHtmlInputChange_)
};
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
  a.keyCode == Blockly.utils.KeyCodes.ENTER ?
      ...
      a.keyCode == Blockly.utils.KeyCodes.TAB &&
              (Blockly.WidgetDiv.hide(),
               Blockly.DropDownDiv.hideWithoutAnimation(),
               this.sourceBlock_.tab(this, !a.shiftKey), a.preventDefault())
};
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
  a = this.htmlInput_.value;
  a !== this.htmlInput_.oldValue_ &&
      (this.htmlInput_.oldValue_ = a, Blockly.Events.setGroup(!0),
       a = this.getValueFromEditorText_(a), this.setValue(a),
       this.forceRerender(), Blockly.Events.setGroup(!1))
};
...
Blockly.FieldTextInput.prototype.resizeEditor_ = function() {
  ...
  b = new Blockly.utils.Coordinate(
      this.sourceBlock_.RTL ? b.right - a.offsetWidth : b.left, b.top);
  b.y += 1;
  Blockly.utils.userAgent.GECKO && Blockly.WidgetDiv.DIV.style.top &&
      (--b.x, --b.y);
...
Blockly.FieldAngle.prototype.dropdownCreate_ = function() {
  ...
  this.gauge_ = Blockly.utils.dom.createSvgElement(
      'path', {'class': 'blocklyAngleGauge'}, a);
  ...
  for (var c = 0; 360 > c; c += 15)
    Blockly.utils.dom.createSvgElement(
        ...
        a);
  this.clickWrapper_ =
      Blockly.bindEventWithChecks_(a, 'click', this, this.hide_);
  this.clickSurfaceWrapper_ =
      Blockly.bindEventWithChecks_(b, 'click', this, this.onMouseMove, !0, !0);
  this.moveSurfaceWrapper_ = Blockly.bindEventWithChecks_(
      b, 'mousemove', this, this.onMouseMove, !0, !0);
  return a
};
...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
  if (this.gauge_) {
    ...
    if (!isNaN(b)) {
      ...
      e && (b = 1 - b);
      a.push(
          ' l ', g, ',', h, ' A ', Blockly.FieldAngle.RADIUS, ',',
          Blockly.FieldAngle.RADIUS, ' 0 ', b, ' ', e, ' ', c, ',', d, ' z')
    }
...
Blockly.FieldCheckbox.prototype.doClassValidation_ = function(a) {
  return !0 === a || 'TRUE' === a ? 'TRUE' :
                                    !1 === a || 'FALSE' === a ? 'FALSE' : null
};
...
Blockly.FieldColour = function(a, b, c) {
  Blockly.FieldColour.superClass_.constructor.call(
      this, a || Blockly.FieldColour.COLOURS[0], b, c);
  this.size_ = new Blockly.utils.Size(
      Blockly.FieldColour.DEFAULT_WIDTH, Blockly.FieldColour.DEFAULT_HEIGHT)
};
...
Blockly.FieldColour.prototype.moveHighlightBy_ = function(a, b) {
  ...
  e += a;
  f += b;
  0 > a ? 0 > e && 0 < f ? (e = d - 1, f--) : 0 > e && (e = 0) :
          0 < a ? e > d - 1 &&
              f<Math.floor(c.length / d) - 1 ? (e = 0, f++) : e>d - 1 && e-- :
                  0 > b ? 0 > f && (f = 0) :
                          0 < b && f > Math.floor(c.length / d) - 1 &&
...
Blockly.FieldColour.prototype.onMouseMove_ = function(a) {
  ...
  null !== b && b !== this.highlightedIndex_ &&
...
Blockly.FieldColour.prototype.setHighlightedCell_ = function(a, b) {
  ...
  Blockly.utils.aria.setState(
      this.picker_, Blockly.utils.aria.State.ACTIVEDESCENDANT,
      a.getAttribute('id'))
};
Blockly.FieldColour.prototype.dropdownCreate_ = function() {
  var a = this.columns_ || Blockly.FieldColour.COLUMNS,
      b = this.colours_ || Blockly.FieldColour.COLOURS,
      c = this.titles_ || Blockly.FieldColour.TITLES, d = this.getValue(),
  ...
  for (var f, g = 0; g < b.length; g++) {
    ...
    Blockly.utils.aria.setState(
        h, Blockly.utils.aria.State.SELECTED, b[g] == d);
    h.style.backgroundColor = b[g];
    b[g] == d &&
        (h.className = 'blocklyColourSelected', this.highlightedIndex_ = g)
  }
  this.onClickWrapper_ =
      Blockly.bindEventWithChecks_(e, 'click', this, this.onClick_, !0);
  this.onMouseMoveWrapper_ =
      Blockly.bindEventWithChecks_(e, 'mousemove', this, this.onMouseMove_, !0);
  this.onMouseEnterWrapper_ = Blockly.bindEventWithChecks_(
      e, 'mouseenter', this, this.onMouseEnter_, !0);
  this.onMouseLeaveWrapper_ = Blockly.bindEventWithChecks_(
      e, 'mouseleave', this, this.onMouseLeave_, !0);
  this.onKeyDownWrapper_ =
...
Blockly.FieldDropdown.prototype.initView = function() {
  ...
  this.imageElement_ = Blockly.utils.dom.createSvgElement(
      'image', {y: Blockly.FieldDropdown.IMAGE_Y_OFFSET}, this.fieldGroup_);
  this.arrow_ =
...
Blockly.FieldDropdown.prototype.dropdownCreate_ = function() {
  ...
  Blockly.utils.aria.setState(
      a.getElement(), Blockly.utils.aria.State.ACTIVEDESCENDANT,
  ...
  return b ?
      ...
      (this.sourceBlock_ &&
           console.warn(
               ...
               this.sourceBlock_.type + ', Field name: ' + this.name +
               ', Value: ' + a),
       null)
};
...
Blockly.FieldDropdown.prototype.renderSelectedImage_ = function(a) {
  ...
  this.imageElement_.setAttributeNS(
      Blockly.utils.dom.XLINK_NS, 'xlink:href', a.src);
  ...
  this.sourceBlock_.RTL ?
      (a = Blockly.Field.DEFAULT_TEXT_OFFSET - 1,
       this.imageElement_.setAttribute(
           'x', Blockly.Field.DEFAULT_TEXT_OFFSET + b),
        ...
        (b = !0,
         console.error(
             'Invalid option[' + c +
                 ...
                 d[1] + ' in: ',
             d)) :
        d[0] && 'string' != typeof d[0] && 'string' != typeof d[0].src &&
                (b = !0,
                 console.error(
                     'Invalid option[' + c +
...
Blockly.FieldImage.fromJson = function(a) {
  return new Blockly.FieldImage(
      a.src, a.width, a.height, void 0, void 0, void 0, a)
};
...
Blockly.FieldImage.prototype.initView = function() {
  this.imageElement_ = Blockly.utils.dom.createSvgElement(
      ...
      this.fieldGroup_);
  this.imageElement_.setAttributeNS(
      Blockly.utils.dom.XLINK_NS, 'xlink:href', this.value_)
};
...
Blockly.FieldMultilineInput.prototype.initView = function() {
  ...
  this.textGroup_ = Blockly.utils.dom.createSvgElement(
      'g', {'class': 'blocklyEditableText'}, this.fieldGroup_)
};
...
Blockly.FieldMultilineInput.prototype.updateSize_ = function() {
  for (var a = this.textGroup_.childNodes, b = 0, c = 0, d = 0; d < a.length;
       d++) {
  ...
  this.borderRect_ &&
      (b += Blockly.Field.X_PADDING, this.borderRect_.setAttribute('width', b),
...
Blockly.FieldMultilineInput.prototype.widgetCreate_ = function() {
  var a = Blockly.WidgetDiv.DIV, b = this.workspace_.scale,
...
Blockly.FieldNumber.prototype.widgetCreate_ = function() {
  ...
  Infinity > this.max_ &&
      Blockly.utils.aria.setState(
          a, Blockly.utils.aria.State.VALUEMAX, this.max_);
  return a
};
...
Blockly.FieldVariable.prototype.fromXml = function(a) {
  ...
  b = Blockly.Variables.getOrCreateVariablePackage(
      this.sourceBlock_.workspace, b, c, d);
  if (null != d && d !== b.type)
    throw Error(
        'Serialized variable type with id \'' + b.getId() + '\' had type ' +
        b.type + ', and does not match variable field that references it: ' +
...
Blockly.FieldVariable.prototype.doValueUpdate_ = function(a) {
  this.variable_ =
      Blockly.Variables.getVariable(this.sourceBlock_.workspace, a);
...
Blockly.FieldVariable.prototype.getVariableTypes_ = function() {
  ...
  if (0 == a.length)
    throw a = this.getText(),
          Error(
              '\'variableTypes\' of field variable ' + a +
              ' was an empty list');
  return a
};
...
Blockly.FieldVariable.dropdownCreate = function() {
  ...
  Blockly.Msg.DELETE_VARIABLE && c.push([
    Blockly.Msg.DELETE_VARIABLE.replace('%1', a), Blockly.DELETE_VARIABLE_ID
  ]);
  return c
};
...
Blockly.Flyout.prototype.createDom = function(a) {
  this.svgGroup_ = Blockly.utils.dom.createSvgElement(
      a, {'class': 'blocklyFlyout', style: 'display: none'}, null);
  this.svgBackground_ = Blockly.utils.dom.createSvgElement(
...
Blockly.Flyout.prototype.init = function(a) {
  ...
  this.scrollbar_ = new Blockly.Scrollbar(
      this.workspace_, this.horizontalLayout_, !1, 'blocklyFlyoutScrollbar');
  this.hide();
  Array.prototype.push.apply(
      this.eventWrappers_,
...
Blockly.Flyout.prototype.dispose = function() {
  ...
  this.workspace_ &&
      (this.workspace_.getThemeManager().unsubscribe(this.svgBackground_),
       this.workspace_.targetWorkspace = null, this.workspace_.dispose(),
       this.workspace_ = null);
  this.svgGroup_ &&
      (Blockly.utils.dom.removeNode(this.svgGroup_), this.svgGroup_ = null);
...
Blockly.Flyout.prototype.positionAt_ = function(a, b, c, d) {
  ...
  'svg' == this.svgGroup_.tagName ?
      Blockly.utils.dom.setCssTransform(
          this.svgGroup_, 'translate(' + c + 'px,' + d + 'px)') :
      this.svgGroup_.setAttribute(
...
Blockly.Flyout.prototype.show = function(a) {
  ...
  for (var d = this.horizontalLayout_ ? this.GAP_X : this.GAP_Y, e = 0, f;
       f = a[e]; e++)
    if (f.tagName) switch (f.tagName.toUpperCase()) {
        ...
        case 'BUTTON':
          ...
          f = new Blockly.FlyoutButton(
              this.workspace_, this.targetWorkspace_, f, g);
          b.push({type: 'button', button: f});
          c.push(d)
      }
  this.layout_(b, c);
  this.listeners_.push(Blockly.bindEventWithChecks_(
      this.svgBackground_, 'mouseover', this, function() {
...
Blockly.Flyout.prototype.addBlockListeners_ = function(a, b, c) {
  this.listeners_.push(Blockly.bindEventWithChecks_(
      a, 'mousedown', null, this.blockMouseDown_(b)));
  this.listeners_.push(Blockly.bindEventWithChecks_(
...
Blockly.Flyout.prototype.createBlock = function(a) {
  ...
  if (Blockly.Events.isEnabled())
    for (Blockly.Events.setGroup(!0),
         Blockly.Events.fire(new Blockly.Events.Create(b)), c = 0;
         c < a.length; c++)
...
Blockly.Flyout.prototype.createRect_ = function(a, b, c, d, e) {
  b = Blockly.utils.dom.createSvgElement(
      'rect', {'fill-opacity': 0, x: b, y: c, height: d.height, width: d.width},
      null);
  b.tooltip = a;
...
Blockly.Flyout.prototype.filterForCapacity_ = function() {
  for (var a = this.workspace_.getTopBlocks(!1), b = 0, c; c = a[b]; b++)
    if (-1 == this.permanentlyDisabled_.indexOf(c))
      for (var d = this.targetWorkspace_.isCapacityAvailable(
...
Blockly.FlyoutButton.prototype.createDom = function() {
  ...
  this.svgGroup_ = Blockly.utils.dom.createSvgElement(
      'g', {'class': a}, this.workspace_.getCanvas());
  if (!this.isLabel_)
    var b = Blockly.utils.dom.createSvgElement(
        'rect',
...
Blockly.HorizontalFlyout.prototype.getMetrics_ = function() {
  ...
  return {
    viewHeight: d, viewWidth: this.width_ - 2 * this.SCROLLBAR_PADDING,
        contentHeight: (a.height + 2 * this.MARGIN) * this.workspace_.scale,
        contentWidth: (a.width + 2 * this.MARGIN) * this.workspace_.scale,
        viewTop: -this.workspace_.scrollY, viewLeft: -this.workspace_.scrollX,
        contentTop: 0, contentLeft: 0, absoluteTop: b, absoluteLeft: c
  }
};
...
Blockly.HorizontalFlyout.prototype.setBackgroundPath_ = function(a, b) {
  ...
  c ? (d.push('h', a + 2 * this.CORNER_RADIUS), d.push('v', b),
       d.push(
...
Blockly.HorizontalFlyout.prototype.wheel_ = function(a) {
  ...
  c &&
      (b = this.getMetrics_(), c = b.viewLeft + c,
       c = Math.min(c, b.contentWidth - b.viewWidth), c = Math.max(c, 0),
...
Blockly.VerticalFlyout.prototype.getMetrics_ = function() {
  ...
  var b = this.SCROLLBAR_PADDING, c = this.height_ - 2 * this.SCROLLBAR_PADDING,
      d = this.width_;
  this.RTL || (d -= this.SCROLLBAR_PADDING);
  return {
    viewHeight: c, viewWidth: d,
        ...
        viewLeft: -this.workspace_.scrollX, contentTop: a.y, contentLeft: a.x,
        absoluteTop: b, absoluteLeft: 0
  }
};
...
Blockly.VerticalFlyout.prototype.setBackgroundPath_ = function(a, b) {
  ...
  d.push('h', c ? -a : a);
  d.push(
      'a', this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, c ? 0 : 1,
      c ? -this.CORNER_RADIUS : this.CORNER_RADIUS, this.CORNER_RADIUS);
...
Blockly.VerticalFlyout.prototype.layout_ = function(a, b) {
  this.workspace_.scale = this.targetWorkspace_.scale;
  for (var c = this.MARGIN, d = this.RTL ? c : c + this.tabWidth_, e = 0, f;
       f = a[e]; e++)
    if ('block' == f.type) {
      f = f.block;
      for (var g = f.getDescendants(!1), h = 0, k; k = g[h]; h++)
...
Blockly.VerticalFlyout.prototype.getClientRect = function() {
  ...
  Blockly.utils.userAgent.GECKO && this.targetWorkspace_ &&
      this.targetWorkspace_.isMutator &&
      (a = this.targetWorkspace_.svgGroup_.getBoundingClientRect().x,
       10 > Math.abs(a - b) &&
           (b += this.leftEdge_ *
                this.targetWorkspace_.options.parentWorkspace.scale));
  return new Blockly.utils.Rect(-1E9, 1E9, b, 1E9)
};
Blockly.VerticalFlyout.prototype.reflowInternal_ = function() {
  this.workspace_.scale = this.targetWorkspace_.scale;
  for (var a = 0, b = this.workspace_.getTopBlocks(!1), c = 0, d; d = b[c];
       c++) {
    ...
    e &&
        (d.outputConnection &&
             (e = this.scrubNakedValue(e),
              this.STATEMENT_PREFIX && !d.suppressPrefixSuffix &&
                  (e = this.injectId(this.STATEMENT_PREFIX, d) + e),
              this.STATEMENT_SUFFIX && !d.suppressPrefixSuffix &&
...
Blockly.Generator.prototype.blockToCode = function(a, b) {
  ...
  if ('string' == typeof c)
    return this.STATEMENT_PREFIX && !a.suppressPrefixSuffix &&
           ...
           this.STATEMENT_SUFFIX && !a.suppressPrefixSuffix &&
...
Blockly.Generator.prototype.addLoopTrap = function(a, b) {
  this.INFINITE_LOOP_TRAP &&
      (a = this.prefixLines(
               this.injectId(this.INFINITE_LOOP_TRAP, b), this.INDENT) +
           a);
  this.STATEMENT_SUFFIX && !b.suppressPrefixSuffix &&
      (a = this.prefixLines(
               this.injectId(this.STATEMENT_SUFFIX, b), this.INDENT) +
           a);
  this.STATEMENT_PREFIX && !b.suppressPrefixSuffix &&
      (a +=
       this.prefixLines(this.injectId(this.STATEMENT_PREFIX, b), this.INDENT));
  return a
};
...
Blockly.CursorSvg.prototype.createDom = function() {
  this.svgGroup_ = Blockly.utils.dom.createSvgElement(
      'g', {
        'class': this.isMarker_ ? Blockly.CursorSvg.MARKER_CLASS :
...
Blockly.CursorSvg.prototype.setParent_ = function(a) {
  this.isMarker_ ? (this.parent_ && this.parent_.setMarkerSvg(null),
...
Blockly.CursorSvg.prototype.showWithBlockPrevOutput_ = function(a) {
  if (a) {
    var b = a.width, c = a.height, d = c * Blockly.CursorSvg.HEIGHT_MULTIPLIER,
        e = Blockly.CursorSvg.BLOCK_PADDING;
    a.previousConnection ? this.positionPrevious_(b, e, d) :
                           a.outputConnection ? this.positionOutput_(b, c) :
...
Blockly.CursorSvg.prototype.showWithStack_ = function(a) {
  ...
  var d = -1 * Blockly.CursorSvg.STACK_PADDING / 2,
      e = -1 * Blockly.CursorSvg.STACK_PADDING / 2, f = d;
...
Blockly.CursorSvg.prototype.positionBlock_ = function(a, b, c) {
  a = Blockly.utils.svgPaths.moveBy(-1 * b, c) +
...
Blockly.CursorSvg.prototype.positionOutput_ = function(a, b) {
  var c = Blockly.utils.svgPaths.moveBy(a, 0) +
      Blockly.utils.svgPaths.lineOnAxis(
          'h', -1 * (a - this.constants_.PUZZLE_TAB.width)) +
      Blockly.utils.svgPaths.lineOnAxis(
...
Blockly.CursorSvg.prototype.draw = function(a) {
  a ? a.getType() === Blockly.ASTNode.types.BLOCK ?
...
Blockly.CursorSvg.prototype.createCursorSvg_ = function() {
  var a = this.isMarker_ ? Blockly.CursorSvg.MARKER_COLOR :
  ...
  this.isMarker_ ||
      (Blockly.utils.dom.createSvgElement(
           'animate', {
             ...
             dur: '1s',
             values:
                 Blockly.CursorSvg.CURSOR_COLOR + ';transparent;transparent;',
...
Blockly.Mutator.prototype.drawIcon_ = function(a) {
  ...
  Blockly.utils.dom.createSvgElement(
      ...
      a);
  Blockly.utils.dom.createSvgElement(
      'circle', {'class': 'blocklyIconShape', r: '2.7', cx: '8', cy: '8'}, a)
};
...
Blockly.Mutator.prototype.createEditor_ = function() {
  this.svgDialog_ = Blockly.utils.dom.createSvgElement(
      'svg', {x: Blockly.Bubble.BORDER_WIDTH, y: Blockly.Bubble.BORDER_WIDTH},
      null);
  if (this.quarkNames_.length)
    for (var a = Blockly.utils.xml.createElement('xml'), b = 0, c;
         c = this.quarkNames_[b]; b++) {
      var d = Blockly.utils.xml.createElement('block');
...
Blockly.Mutator.prototype.resizeBubble_ = function() {
  ...
  c += 3 * a;
  if (Math.abs(this.workspaceWidth_ - c) > a ||
      Math.abs(this.workspaceHeight_ - b) > a)
    this.workspaceWidth_ = c, this.workspaceHeight_ = b,
...
Blockly.Mutator.prototype.setVisible = function(a) {
  if (a != this.isVisible())
    if (Blockly.Events.fire(
      ...
      this.svgDialog_ = null, this.workspace_.dispose(),
      this.rootBlock_ = this.workspace_ = null, this.bubble_.dispose(),
      this.bubble_ = null, this.workspaceHeight_ = this.workspaceWidth_ = 0,
      this.sourceListener_ &&
          (this.block_.workspace.removeChangeListener(this.sourceListener_),
           this.sourceListener_ = null)
};
Blockly.Mutator.prototype.workspaceChanged_ = function(a) {
  if (a.type != Blockly.Events.UI &&
    ...
    if (this.rootBlock_.workspace == this.workspace_) {
      ...
      c.rendered && c.render();
      a != b && Blockly.keyboardAccessibilityMode &&
...
Blockly.Mutator.findParentWs = function(a) {
  ...
  if (a && a.options) {
    ...
    a.isFlyout ? c && c.options && (b = c.options.parentWorkspace) :
                 c && (b = c)
  }
  return b
};
...
Blockly.blockRendering.ConstantProvider.prototype.makeJaggedTeeth = function() {
  var a = this.JAGGED_TEETH_HEIGHT, b = this.JAGGED_TEETH_WIDTH,
      c = Blockly.utils.svgPaths.line([
        ...
        Blockly.utils.svgPaths.point(-12, 6), Blockly.utils.svgPaths.point(6, 3)
      ]);
  return {
    height: a, width: b, path: c
  }
};
Blockly.blockRendering.ConstantProvider.prototype.makeStartHat = function() {
  var a = this.START_HAT_HEIGHT, b = this.START_HAT_WIDTH,
      c = Blockly.utils.svgPaths.curve('c', [
        ...
        Blockly.utils.svgPaths.point(70, -a), Blockly.utils.svgPaths.point(b, 0)
      ]);
  return {
    height: a, width: b, path: c
  }
  ...
  function a(a) {
    ...
    return Blockly.utils.svgPaths.curve(
               ...
               [
                 ...
                 Blockly.utils.svgPaths.point(-b, d * l), m
               ]) +
        Blockly.utils.svgPaths.curve(
            's', [Blockly.utils.svgPaths.point(b, 2.5 * d), e])
  }
  var b = this.TAB_WIDTH, c = this.TAB_HEIGHT, d = a(!0), e = a(!1);
  return {
    width: b, height: c, pathDown: e, pathUp: d
  }
};
Blockly.blockRendering.ConstantProvider.prototype.makeNotch = function() {
  ...
  var b = this.NOTCH_WIDTH, c = this.NOTCH_HEIGHT, d = (b - 3) / 2, e = a(1),
      f = a(-1);
  return {
    width: b, height: c, pathLeft: e, pathRight: f
  }
};
Blockly.blockRendering.ConstantProvider.prototype.makeInsideCorners =
  ...
  var a = this.CORNER_RADIUS,
      b = Blockly.utils.svgPaths.arc(
          'a', '0 0,0', a, Blockly.utils.svgPaths.point(-a, a)),
      c = Blockly.utils.svgPaths.arc(
          'a', '0 0,0', a, Blockly.utils.svgPaths.point(a, a));
  return {
    width: a, height: a, pathTop: b, pathBottom: c
  }
};
Blockly.blockRendering.ConstantProvider.prototype.makeOutsideCorners =
    function() {
  var a = this.CORNER_RADIUS,
      b = Blockly.utils.svgPaths.moveBy(0, a) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,1', a, Blockly.utils.svgPaths.point(a, -a));
  a = Blockly.utils.svgPaths.arc(
      'a', '0 0,1', a, Blockly.utils.svgPaths.point(-a, -a));
  return {
    topLeft: b, bottomLeft: a
  }
};
...
Blockly.blockRendering.InputConnection = function(a, b) {
  ...
  this.input = b;
  this.align = b.align;
  if (this.connectedBlock = b.connection && b.connection.targetBlock() ?
...
Blockly.blockRendering.SquareCorner = function(a, b) {
  ...
  this.type =
      (b && 'left' != b ? Blockly.blockRendering.Types.RIGHT_SQUARE_CORNER :
                          Blockly.blockRendering.Types.LEFT_SQUARE_CORNER) |
...
Blockly.blockRendering.RoundCorner = function(a, b) {
  ...
  this.type =
      (b && 'left' != b ? Blockly.blockRendering.Types.RIGHT_ROUND_CORNER :
                          Blockly.blockRendering.Types.LEFT_ROUND_CORNER) |
      Blockly.blockRendering.Types.CORNER;
...
Blockly.blockRendering.InRowSpacer = function(a, b) {
  ...
  this.type = this.type | Blockly.blockRendering.Types.SPACER |
...
Blockly.blockRendering.Row = function(a) {
  ...
  this.elements = [];
  this.xPos = this.yPos = this.widthWithConnectedBlocks = this.minWidth =
      this.minHeight = this.width = this.height = 0;
  this.hasJaggedEdge = this.hasDummyInput = this.hasInlineInput =
...
Blockly.blockRendering.RenderInfo = function(a, b) {
  ...
  this.outputConnection = b.outputConnection ?
      new Blockly.blockRendering.OutputConnection(
          this.constants_, b.outputConnection) :
      null;
...
Blockly.blockRendering.RenderInfo.prototype.createRows_ = function() {
  ...
  if (b.length)
    for (var c = 0, d; d = b[c]; c++) {
      ...
      this.isCollapsed && d.collapseHidden ? this.hiddenIcons.push(e) :
                                             a.elements.push(e)
    }
  d = null;
...
Blockly.blockRendering.RenderInfo.prototype.populateTopRow_ = function() {
  var a = this.block_.hat ? 'cap' === this.block_.hat :
  ...
  a ? (a = new Blockly.blockRendering.Hat(this.constants_),
       this.topRow.elements.push(a), this.topRow.capline = a.ascenderHeight) :
      b &&
          (this.topRow.hasPreviousConnection = !0,
           this.topRow.connection =
               new Blockly.blockRendering.PreviousConnection(
                   this.constants_, this.block_.previousConnection),
...
Blockly.blockRendering.RenderInfo.prototype.populateBottomRow_ = function() {
  ...
  this.bottomRow.minHeight = this.block_.inputList.length &&
  ...
  this.bottomRow.hasNextConnection &&
      (this.bottomRow.connection = new Blockly.blockRendering.NextConnection(
           this.constants_, this.block_.nextConnection),
...
Blockly.blockRendering.RenderInfo.prototype.addElemSpacing_ = function() {
  for (var a = 0, b; b = this.rows[a]; a++) {
    ...
    b.startsWithElemSpacer() &&
        b.elements.push(new Blockly.blockRendering.InRowSpacer(
            this.constants_, this.getInRowSpacing_(null, c[0])));
    ...
    b.endsWithElemSpacer() &&
        b.elements.push(new Blockly.blockRendering.InRowSpacer(
            this.constants_, this.getInRowSpacing_(c[c.length - 1], null)))
  }
};
Blockly.blockRendering.RenderInfo.prototype.getInRowSpacing_ = function(a, b) {
  ...
  return a && Blockly.blockRendering.Types.isLeftSquareCorner(a) && b &&
          (Blockly.blockRendering.Types.isPreviousConnection(b) ||
           Blockly.blockRendering.Types.isNextConnection(b)) ?
      b.notchOffset :
      a && Blockly.blockRendering.Types.isLeftRoundedCorner(a) && b &&
              (Blockly.blockRendering.Types.isPreviousConnection(b) ||
               Blockly.blockRendering.Types.isNextConnection(b)) ?
...
Blockly.blockRendering.RenderInfo.prototype.getElemCenterline_ = function(
  ...
  if (Blockly.blockRendering.Types.isBottomRow(a)) {
    ...
    return Blockly.blockRendering.Types.isNextConnection(b) ? c + b.height / 2 :
                                                              c - b.height / 2
  }
  return Blockly.blockRendering.Types.isTopRow(a) ?
      Blockly.blockRendering.Types.isHat(b) ? a.capline - b.height / 2 :
...
Blockly.blockRendering.RenderInfo.prototype.finalize_ = function() {
  for (var a = 0, b = 0, c = 0, d; d = this.rows[c]; c++)
    d.yPos = b, d.xPos = this.startX, b += d.height,
    a = Math.max(a, d.widthWithConnectedBlocks), this.recordElemPositions_(d);
...
Blockly.blockRendering.Drawer.prototype.drawOutline_ = function() {
  ...
  for (var a = 1; a < this.info_.rows.length - 1; a++) {
    ...
    b.hasJaggedEdge ?
        ...
        b.hasExternalInput ? this.drawValueInput_(b) : this.drawRightSideRow_(b)
  }
  this.drawBottom_();
  this.drawLeft_()
};
  ...
  for (var c = 0, d; d = b[c]; c++)
    Blockly.blockRendering.Types.isLeftRoundedCorner(d) ?
        ...
        Blockly.blockRendering.Types.isSpacer(d) &&
                    (this.outlinePath_ +=
                     Blockly.utils.svgPaths.lineOnAxis('h', d.width));
...
Blockly.blockRendering.Drawer.prototype.drawJaggedEdge_ = function(a) {
  this.outlinePath_ += this.constants_.JAGGED_TEETH.path +
      Blockly.utils.svgPaths.lineOnAxis(
          'v', a.height - this.constants_.JAGGED_TEETH.height)
};
Blockly.blockRendering.Drawer.prototype.drawValueInput_ = function(a) {
  ...
  var c = 'function' == typeof b.shape.pathDown ? b.shape.pathDown(b.height) :
                                                  b.shape.pathDown;
  this.outlinePath_ +=
      Blockly.utils.svgPaths.lineOnAxis('H', b.xPos + b.width) + c +
...
Blockly.blockRendering.Drawer.prototype.drawStatementInput_ = function(a) {
  ...
  b = b.shape.pathRight +
      Blockly.utils.svgPaths.lineOnAxis(
          'h', -(b.notchOffset - this.constants_.INSIDE_CORNERS.width)) +
      this.constants_.INSIDE_CORNERS.pathTop;
  var d = a.height - 2 * this.constants_.INSIDE_CORNERS.height;
  this.outlinePath_ += Blockly.utils.svgPaths.lineOnAxis('H', c) + b +
...
Blockly.blockRendering.Drawer.prototype.drawBottom_ = function() {
  ...
  for (var c = b.length - 1, d; d = b[c]; c--)
    Blockly.blockRendering.Types.isNextConnection(d) ?
        ...
        Blockly.blockRendering.Types.isSpacer(d) &&
                    (this.outlinePath_ +=
                     Blockly.utils.svgPaths.lineOnAxis('h', -1 * d.width))
};
Blockly.blockRendering.Drawer.prototype.drawLeft_ = function() {
  ...
  if (a) {
    ...
    a = 'function' == typeof a.shape.pathUp ? a.shape.pathUp(a.height) :
                                              a.shape.pathUp;
...
Blockly.blockRendering.Drawer.prototype.drawInlineInput_ = function(a) {
  var b = a.width, c = a.height, d = a.connectionOffsetY,
      e = a.connectionHeight + d;
  this.inlinePath_ += Blockly.utils.svgPaths.moveTo(
                          a.xPos + a.connectionWidth, a.centerline - c / 2) +
      Blockly.utils.svgPaths.lineOnAxis('v', d) + a.shape.pathDown +
      Blockly.utils.svgPaths.lineOnAxis('v', c - e) +
      Blockly.utils.svgPaths.lineOnAxis('h', b - a.connectionWidth) +
      Blockly.utils.svgPaths.lineOnAxis('v', -c) + 'z';
...
Blockly.blockRendering.Drawer.prototype.positionNextConnection_ = function() {
  ...
  if (a.connection) {
    ...
    a.connectionModel.setOffsetInBlock(
        this.info_.RTL ? -b : b, a.centerline - a.height / 2)
  }
};
Blockly.blockRendering.Drawer.prototype.positionOutputConnection_ = function() {
  if (this.info_.outputConnection) {
    ...
    this.block_.outputConnection.setOffsetInBlock(
        this.info_.RTL ? -a : a, this.info_.outputConnection.connectionOffsetY)
  }
};
...
Blockly.blockRendering.Renderer.prototype.render = function(a) {
  Blockly.blockRendering.useDebugger && !a.renderingDebugger &&
...
Blockly.geras.Highlighter.prototype.drawTopCorner = function(a) {
  ...
  for (var b = 0, c; c = a.elements[b]; b++)
    Blockly.blockRendering.Types.isLeftSquareCorner(c) ?
        ...
        Blockly.blockRendering.Types.isSpacer(c) && 0 != c.width &&
                        (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
                             'H', c.xPos + c.width - this.highlightOffset_));
  this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
      'H', a.xPos + a.width - this.highlightOffset_)
};
Blockly.geras.Highlighter.prototype.drawJaggedEdge_ = function(a) {
  this.info_.RTL &&
      (this.steps_ +=
       Blockly.utils.svgPaths.lineOnAxis('H', a.width - this.highlightOffset_),
...
Blockly.geras.Highlighter.prototype.drawValueInput = function(a) {
  ...
  if (this.RTL_) {
    ...
    this.steps_ += Blockly.utils.svgPaths.moveTo(
                       b.xPos + b.width - this.highlightOffset_, a.yPos) +
        this.puzzleTabPaths_.pathDown(this.RTL_) +
        Blockly.utils.svgPaths.lineOnAxis('v', c)
  } else
    this.steps_ += Blockly.utils.svgPaths.moveTo(b.xPos + b.width, a.yPos) +
        this.puzzleTabPaths_.pathDown(this.RTL_)
};
Blockly.geras.Highlighter.prototype.drawStatementInput = function(a) {
  ...
  if (this.RTL_) {
    ...
    this.steps_ += Blockly.utils.svgPaths.moveTo(b.xPos, a.yPos) +
        this.insideCornerPaths_.pathTop(this.RTL_) +
        Blockly.utils.svgPaths.lineOnAxis('v', c) +
        this.insideCornerPaths_.pathBottom(this.RTL_) +
        Blockly.utils.svgPaths.lineTo(
            a.width - b.xPos - this.insideCornerPaths_.width, 0)
  } else
    this.steps_ += Blockly.utils.svgPaths.moveTo(b.xPos, a.yPos + a.height) +
        this.insideCornerPaths_.pathBottom(this.RTL_) +
        Blockly.utils.svgPaths.lineTo(
            a.width - b.xPos - this.insideCornerPaths_.width, 0)
};
  ...
  this.RTL_ &&
      (this.steps_ += Blockly.utils.svgPaths.lineOnAxis('H', b),
       a.height > this.highlightOffset_ &&
           (this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
                'V', a.yPos + a.height - this.highlightOffset_)))
};
Blockly.geras.Highlighter.prototype.drawBottomRow = function(a) {
  if (this.RTL_)
    this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
        'V', a.baseline - this.highlightOffset_);
  else {
  ...
  this.RTL_ ||
      (a = this.info_.topRow,
       Blockly.blockRendering.Types.isLeftRoundedCorner(a.elements[0]) ?
           ...
           this.steps_ += Blockly.utils.svgPaths.lineOnAxis(
               'V', a.capline + this.highlightOffset_))
};
Blockly.geras.Highlighter.prototype.drawInlineInput = function(a) {
  var b = this.highlightOffset_, c = a.xPos + a.connectionWidth,
      d = a.centerline - a.height / 2, e = a.width - a.connectionWidth,
      f = d + b;
  this.RTL_ ? (d = a.connectionOffsetY - b,
               a = a.height - (a.connectionOffsetY + a.connectionHeight) + b,
               this.inlineSteps_ += Blockly.utils.svgPaths.moveTo(c - b, f) +
                   Blockly.utils.svgPaths.lineOnAxis('v', d) +
                   this.puzzleTabPaths_.pathDown(this.RTL_) +
...
Blockly.geras.RenderInfo.prototype.getInRowSpacing_ = function(a, b) {
  ...
  if (Blockly.blockRendering.Types.isIcon(a) && b &&
      !Blockly.blockRendering.Types.isInput(b))
    return this.constants_.LARGE_PADDING;
  if (Blockly.blockRendering.Types.isInlineInput(a) && b &&
      !Blockly.blockRendering.Types.isInput(b))
    return b.isEditable ? this.constants_.MEDIUM_PADDING :
                          this.constants_.LARGE_PADDING;
  ...
  if (Blockly.blockRendering.Types.isLeftRoundedCorner(a) && b) {
    ...
    if (Blockly.blockRendering.Types.isNextConnection(b))
      return c = (this.RTL ? 1 : -1) * this.constants_.DARK_PATH_OFFSET / 2,
             b.notchOffset - this.constants_.CORNER_RADIUS + c
  }
  return !Blockly.blockRendering.Types.isInput(a) && b &&
              !Blockly.blockRendering.Types.isInput(b) &&
...
Blockly.geras.RenderInfo.prototype.getElemCenterline_ = function(a, b) {
  ...
  if (Blockly.blockRendering.Types.isTopRow(a))
    return Blockly.blockRendering.Types.isHat(b) ? a.capline - b.height / 2 :
                                                   a.capline + b.height / 2;
  c = a.yPos;
  Blockly.blockRendering.Types.isField(b) ||
      ...
      c = Blockly.blockRendering.Types.isInlineInput(b) ? c + b.height / 2 :
                                                          c + a.height / 2;
  return c
};
Blockly.geras.RenderInfo.prototype.finalize_ = function() {
  for (var a = 0, b = 0, c = 0, d; d = this.rows[c]; c++) {
    ...
    d == this.bottomRow && e < this.constants_.MIN_BLOCK_HEIGHT &&
        (e = this.constants_.MIN_BLOCK_HEIGHT - e, this.bottomRow.height += e,
         b += e);
...
Blockly.geras.Drawer.prototype.positionInlineInputConnection_ = function(a) {
  ...
  if (a.connection) {
    ...
    a.connection.setOffsetInBlock(
        c, b + a.connectionOffsetY + this.constants_.DARK_PATH_OFFSET)
  }
};
...
Blockly.geras.HighlightConstantProvider.prototype.makeInsideCorner =
    function() {
  var a = this.constantProvider.CORNER_RADIUS, b = this.OFFSET,
      c = (1 - Math.SQRT1_2) * (a + b) - b,
      d = Blockly.utils.svgPaths.moveBy(c, c) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,0', a, Blockly.utils.svgPaths.point(-c - b, a - c)),
      e = Blockly.utils.svgPaths.arc(
          'a', '0 0,0', a + b, Blockly.utils.svgPaths.point(a + b, a + b)),
      f = Blockly.utils.svgPaths.moveBy(c, -c) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,0', a + b, Blockly.utils.svgPaths.point(a - c, c + b));
  return {
    width: a + b, height: a, pathTop: function(a) {
      return a ? d : ''
...
Blockly.geras.HighlightConstantProvider.prototype.makeOutsideCorner =
  ...
  var a = this.constantProvider.CORNER_RADIUS, b = this.OFFSET,
      ...
      d = Blockly.utils.svgPaths.moveBy(c, c) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,1', a - b, Blockly.utils.svgPaths.point(a - c, -c + b)),
      e = Blockly.utils.svgPaths.moveBy(b, a) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,1', a - b, Blockly.utils.svgPaths.point(a, -a + b)),
      f = -c,
      g = Blockly.utils.svgPaths.moveBy(c, f) +
      Blockly.utils.svgPaths.arc(
          'a', '0 0,1', a - b, Blockly.utils.svgPaths.point(-c + b, -f - a));
  return {
...
Blockly.geras.HighlightConstantProvider.prototype.makePuzzleTab = function() {
  var a = this.constantProvider.TAB_WIDTH, b = this.constantProvider.TAB_HEIGHT,
      c = Blockly.utils.svgPaths.moveBy(-2, -b + 3.4) +
      Blockly.utils.svgPaths.lineTo(-.45 * a, -2.1),
      d = Blockly.utils.svgPaths.lineOnAxis('v', 2.5) +
      Blockly.utils.svgPaths.moveBy(.97 * -a, 2.5) +
      Blockly.utils.svgPaths.curve(
          'q',
          [
            Blockly.utils.svgPaths.point(.05 * -a, 10),
            Blockly.utils.svgPaths.point(.3 * a, 9.5)
          ]) +
      Blockly.utils.svgPaths.moveBy(.67 * a, -1.9) +
      Blockly.utils.svgPaths.lineOnAxis('v', 2.5),
      e = Blockly.utils.svgPaths.lineOnAxis('v', -1.5) +
      Blockly.utils.svgPaths.moveBy(-.92 * a, -.5) +
      Blockly.utils.svgPaths.curve(
          'q',
          [
            Blockly.utils.svgPaths.point(-.19 * a, -5.5),
            Blockly.utils.svgPaths.point(0, -11)
          ]) +
      Blockly.utils.svgPaths.moveBy(.92 * a, 1),
      f = Blockly.utils.svgPaths.moveBy(-5, b - .7) +
      Blockly.utils.svgPaths.lineTo(.46 * a, -2.1);
  return {
...
Blockly.geras.HighlightConstantProvider.prototype.makeStartHat = function() {
  var a = this.constantProvider.START_HAT.height,
      b = Blockly.utils.svgPaths.moveBy(25, -8.7) +
      Blockly.utils.svgPaths.curve(
          'c',
          [
            Blockly.utils.svgPaths.point(29.7, -6.2),
            Blockly.utils.svgPaths.point(57.2, -.5),
            Blockly.utils.svgPaths.point(75, 8.7)
          ]),
      c = Blockly.utils.svgPaths.curve(
              'c',
              [
      ...
      Blockly.utils.svgPaths.moveTo(100.5, a + .5);
  return {
    path: function(a) {
      return a ? b : c
    }
...
Blockly.Toolbox.prototype.renderTree = function(a) {
  ...
  this.horizontalLayout_ &&
      Blockly.utils.aria.setState(
          this.tree_.getElement(), Blockly.utils.aria.State.ORIENTATION,
          'horizontal')
};
...
Blockly.Toolbox.prototype.handleAfterTreeSelected_ = function(a, b) {
  ...
  if (a != b && a != this) {
    var c = new Blockly.Events.Ui(
        null, 'category', a && a.getText(), b && b.getText());
...
Blockly.Toolbox.prototype.position = function() {
  ...
  if (a) {
    ...
    b = Blockly.svgSize(b);
    this.horizontalLayout_ ?
        (a.style.left = '0', a.style.height = 'auto',
         a.style.width = b.width + 'px', this.height = a.offsetHeight,
        ...
        (this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ?
             a.style.right = '0' :
             a.style.left = '0',
         a.style.height = b.height + 'px', this.width = a.offsetWidth);
...
Blockly.Toolbox.prototype.setColour_ = function(a, b, c) {
  ...
  if (null === a || '' === a)
    ...
    var d = Number(a);
    isNaN(d) ? (d = Blockly.utils.colour.parse(a)) ?
               (b.hexColour = d, this.hasColours_ = !0) :
               (b.hexColour = '',
                console.warn(
                    'Toolbox category "' + c +
                    '" has unrecognized colour attribute: ' + a)) :
...
Blockly.Toolbox.prototype.addColour_ = function(a) {
  ...
  for (var b = 0, c; c = a[b]; b++) {
    ...
    if (d) {
      var e =
          this.hasColours_ ? '8px solid ' + (c.hexColour || '#ddd') : 'none';
...
Blockly.Toolbox.prototype.getClientRect = function() {
  ...
  var a = this.HtmlDiv.getBoundingClientRect(), b = a.top, c = b + a.height,
      d = a.left;
  a = d + a.width;
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  var b = Blockly.utils.dom.createSvgElement(
      'clipPath', {id: 'blocklyTrashBodyClipPath' + a}, this.svgGroup_);
  Blockly.utils.dom.createSvgElement(
      'rect',
      {width: this.WIDTH_, height: this.BODY_HEIGHT_, y: this.LID_HEIGHT_}, b);
  var c = Blockly.utils.dom.createSvgElement(
      'image', {
  ...
  b = Blockly.utils.dom.createSvgElement(
      'clipPath', {id: 'blocklyTrashLidClipPath' + a}, this.svgGroup_);
  Blockly.utils.dom.createSvgElement(
      'rect', {width: this.WIDTH_, height: this.LID_HEIGHT_}, b);
...
Blockly.Trashcan.prototype.position = function() {
  if (this.verticalSpacing_) {
    var a = this.workspace_.getMetrics();
    a &&
        (this.left_ = a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT ||
         ...
         this.top_ = a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM ?
...
Blockly.Trashcan.prototype.getClientRect = function() {
  ...
  return new Blockly.utils.Rect(
      b, b + this.LID_HEIGHT_ + this.BODY_HEIGHT_ + 2 * this.MARGIN_HOTSPOT_, a,
...
Blockly.Trashcan.prototype.animateLid_ = function() {
  ...
  this.lidOpen_ > this.minOpenness_ && 1 > this.lidOpen_ &&
      (this.lidTask_ = setTimeout(this.animateLid_.bind(this), 20))
};
Blockly.Trashcan.prototype.setLidAngle_ = function(a) {
  var b = this.workspace_.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ||
      this.workspace_.horizontalLayout && this.workspace_.RTL;
  this.svgLid_.setAttribute(
      'transform',
      'rotate(' + (b ? -a : a) + ',' + (b ? 4 : this.WIDTH_ - 4) + ',' +
          (this.LID_HEIGHT_ - 2) + ')')
};
...
Blockly.Trashcan.prototype.cleanBlockXML_ = function(a) {
  for (var b = a = a.cloneNode(!0); b;) {
    b.removeAttribute &&
        (b.removeAttribute('x'), b.removeAttribute('y'),
    ...
    a &&
        (this.left_ = a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT ||
         ...
         a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM ?
             ...
             (this.top_ = a.viewHeight + a.absoluteTop - this.HEIGHT_ -
                  this.verticalSpacing_,
...
Blockly.ZoomControls.prototype.createZoomOutSvg_ = function(a) {
  ...
  var c = Blockly.utils.dom.createSvgElement(
      'clipPath', {id: 'blocklyZoomoutClipPath' + a}, this.zoomOutGroup_);
...
Blockly.ZoomControls.prototype.createZoomInSvg_ = function(a) {
  ...
  this.zoomInGroup_ = Blockly.utils.dom.createSvgElement(
      'g', {'class': 'blocklyZoom'}, this.svgGroup_);
  var c = Blockly.utils.dom.createSvgElement(
      'clipPath', {id: 'blocklyZoominClipPath' + a}, this.zoomInGroup_);
  Blockly.utils.dom.createSvgElement('rect', {width: 32, height: 32}, c);
  a = Blockly.utils.dom.createSvgElement(
      'image', {
        width: Blockly.SPRITE.width,
...
Blockly.ZoomControls.prototype.createZoomResetSvg_ = function(a) {
  ...
  this.zoomResetGroup_ = Blockly.utils.dom.createSvgElement(
      'g', {'class': 'blocklyZoom'}, this.svgGroup_);
  var c = Blockly.utils.dom.createSvgElement(
      'clipPath', {id: 'blocklyZoomresetClipPath' + a}, this.zoomResetGroup_);
  Blockly.utils.dom.createSvgElement('rect', {width: 32, height: 32}, c);
  a = Blockly.utils.dom.createSvgElement(
      'image', {
        width: Blockly.SPRITE.width,
...
Blockly.Themes.Dark = new Blockly.Theme(
    Blockly.Themes.Dark.defaultBlockStyles, Blockly.Themes.Dark.categoryStyles);
