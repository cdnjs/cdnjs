...
function ${t.FUNCTION_NAME_PLACEHOLDER_}(type, direction) {
  ...
  return function(a, b) { return compare(a, b) * direction; };
      ...
      `))+'("'+e+'", '+r+"))",E.FUNCTION_CALL]},lists_split:function(e,t){let n=t.valueToCode(e,"INPUT",E.MEMBER);if(t=t.valueToCode(e,"DELIM",E.NONE)||"''","SPLIT"===(e=e.getFieldValue("MODE")))n=n||"''",e="split";else{if("JOIN"!==e)throw Error("Unknown mode: "+e);n=n||"[]",e="join"}return[n+"."+e+"("+t+")",E.FUNCTION_CALL]}}),d={},I=(d.controls_if=t,d.controls_ifelse=t,d.logic_boolean=function(e,t){return["TRUE"===e.getFieldValue("BOOL")?"true":"false",E.ATOMIC]},d.logic_compare=function(e,t){var n={EQ:"==",NEQ:"!=",LT:"<",LTE:"<=",GT:">",GTE:">="}[e.getFieldValue("OP")],r="=="===n||"!="===n?E.EQUALITY:E.RELATIONAL;return[(t.valueToCode(e,"A",r)||"0")+" "+n+" "+(e=t.valueToCode(e,"B",r)||"0"),r]},d.logic_negate=function(e,t){var n=E.LOGICAL_NOT;return["!"+(t.valueToCode(e,"BOOL",n)||"true"),n]},d.logic_null=function(e,t){return["null",E.ATOMIC]},d.logic_operation=function(e,t){var n="AND"===e.getFieldValue("OP")?"&&":"||",r="&&"==n?E.LOGICAL_AND:E.LOGICAL_OR;let a=t.valueToCode(e,"A",r);return e=t.valueToCode(e,"B",r),e=a||e?(t="&&"==n?"true":"false",a=a||t,e||t):a="false",[a+" "+n+" "+e,r]},d.logic_ternary=function(e,t){return[(t.valueToCode(e,"IF",E.CONDITIONAL)||"false")+" ? "+(t.valueToCode(e,"THEN",E.CONDITIONAL)||"null")+" : "+(e=t.valueToCode(e,"ELSE",E.CONDITIONAL)||"null"),E.CONDITIONAL]},{controls_flow_statements:function(e,t){let n="";var r;switch(t.STATEMENT_PREFIX&&(n+=t.injectId(t.STATEMENT_PREFIX,e)),t.STATEMENT_SUFFIX&&(n+=t.injectId(t.STATEMENT_SUFFIX,e)),!t.STATEMENT_PREFIX||(r=e.getSurroundLoop())&&!r.suppressPrefixSuffix&&(n+=t.injectId(t.STATEMENT_PREFIX,r)),e.getFieldValue("FLOW")){case"BREAK":return n+"break;\n";case"CONTINUE":return n+"continue;\n"}throw Error("Unknown flow statement.")},controls_for:function(t,n){var r=n.getVariableName(t.getFieldValue("VAR")),a=n.valueToCode(t,"FROM",E.ASSIGNMENT)||"0",o=n.valueToCode(t,"TO",E.ASSIGNMENT)||"0",i=n.valueToCode(t,"BY",E.ASSIGNMENT)||"1",u=n.statementToCode(t,"DO"),u=n.addLoopTrap(u,t);if(N.isNumber$$module$core$utils$string(a)&&N.isNumber$$module$core$utils$string(o)&&N.isNumber$$module$core$utils$string(i))t="for ("+r+" = "+a+"; "+r+((n=Number(a)<=Number(o))?" <= ":" >= ")+o+"; "+r,t=1===(r=Math.abs(Number(i)))?t+(n?"++":"--"):t+(n?" += ":" -= ")+r,t+=") {\n"+u+"}\n";else{t="";let e=a;a.match(/^\w+$/)||N.isNumber$$module$core$utils$string(a)||(t+="var "+(e=n.nameDB_.getDistinctName(r+"_start",N.NameType$$module$core$names.VARIABLE))+" = "+a+";\n"),(a=o).match(/^\w+$/)||N.isNumber$$module$core$utils$string(o)||(t+="var "+(a=n.nameDB_.getDistinctName(r+"_end",N.NameType$$module$core$names.VARIABLE))+" = "+o+";\n"),t+="var "+(o=n.nameDB_.getDistinctName(r+"_inc",N.NameType$$module$core$names.VARIABLE))+" = ",t=N.isNumber$$module$core$utils$string(i)?t+(Math.abs(i)+";\n"):t+"Math.abs("+i+");\n",t=(t=(t+="if ("+e+" > "+a+") {\n")+(n.INDENT+o+" = -"+o+";\n"))+"}\nfor ("+r+" = "+e+"; "+o+" >= 0 ? "+r+" <= "+a+" : "+r+" >= "+a+"; "+r+" += "+o+") {\n"+u+"}\n"}return t},controls_forEach:function(e,t){var n=t.getVariableName(e.getFieldValue("VAR")),r=t.valueToCode(e,"LIST",E.ASSIGNMENT)||"[]",a=t.statementToCode(e,"DO"),a=t.addLoopTrap(a,e);e="";let o=r;return r.match(/^\w+$/)||(e+="var "+(o=t.nameDB_.getDistinctName(n+"_list",N.NameType$$module$core$names.VARIABLE))+" = "+r+";\n"),r=t.nameDB_.getDistinctName(n+"_index",N.NameType$$module$core$names.VARIABLE),a=t.INDENT+n+" = "+o+"["+r+"];\n"+a,e+("for (var "+r+" in "+o)+") {\n"+a+"}\n"}}),_=(I.controls_repeat=n,I.controls_repeat_ext=n,I.controls_whileUntil=function(e,t){var n="UNTIL"===e.getFieldValue("MODE");let r=t.valueToCode(e,"BOOL",n?E.LOGICAL_NOT:E.NONE)||"false",a=t.statementToCode(e,"DO");return a=t.addLoopTrap(a,e),"while ("+(r=n?"!"+r:r)+") {\n"+a+"}\n"},{math_arithmetic:function(e,t){var n=(r={ADD:[" + ",E.ADDITION],MINUS:[" - ",E.SUBTRACTION],MULTIPLY:[" * ",E.MULTIPLICATION],DIVIDE:[" / ",E.DIVISION],POWER:[null,E.NONE]}[e.getFieldValue("OP")])[0],r=r[1],a=t.valueToCode(e,"A",r)||"0";return e=t.valueToCode(e,"B",r)||"0",n?[a+n+e,r]:["Math.pow("+a+", "+e+")",E.FUNCTION_CALL]},math_atan2:function(e,t){var n=t.valueToCode(e,"X",E.NONE)||"0";return["Math.atan2("+(t.valueToCode(e,"Y",E.NONE)||"0")+", "+n+") / Math.PI * 180",E.DIVISION]},math_change:function(e,t){var n=t.valueToCode(e,"DELTA",E.ADDITION)||"0";return(e=t.getVariableName(e.getFieldValue("VAR")))+" = (typeof "+e+" === 'number' ? "+e+" : 0) + "+n+";\n"},math_constant:function(e,t){return{PI:["Math.PI",E.MEMBER],E:["Math.E",E.MEMBER],GOLDEN_RATIO:["(1 + Math.sqrt(5)) / 2",E.DIVISION],SQRT2:["Math.SQRT2",E.MEMBER],SQRT1_2:["Math.SQRT1_2",E.MEMBER],INFINITY:["Infinity",E.ATOMIC]}[e.getFieldValue("CONSTANT")]},math_constrain:function(e,t){return["Math.min(Math.max("+(t.valueToCode(e,"VALUE",E.NONE)||"0")+", "+(t.valueToCode(e,"LOW",E.NONE)||"0")+"), "+(e=t.valueToCode(e,"HIGH",E.NONE)||"Infinity")+")",E.FUNCTION_CALL]},math_modulo:function(e,t){return[(t.valueToCode(e,"DIVIDEND",E.MODULUS)||"0")+" % "+(e=t.valueToCode(e,"DIVISOR",E.MODULUS)||"0"),E.MODULUS]},math_number:function(e,t){return[e=Number(e.getFieldValue("NUM")),0<=e?E.ATOMIC:E.UNARY_NEGATION]},math_number_property:function(e,t){var n={EVEN:[" % 2 === 0",E.MODULUS,E.EQUALITY],ODD:[" % 2 === 1",E.MODULUS,E.EQUALITY],WHOLE:[" % 1 === 0",E.MODULUS,E.EQUALITY],POSITIVE:[" > 0",E.RELATIONAL,E.RELATIONAL],NEGATIVE:[" < 0",E.RELATIONAL,E.RELATIONAL],DIVISIBLE_BY:[null,E.MODULUS,E.EQUALITY],PRIME:[null,E.NONE,E.FUNCTION_CALL]},r=e.getFieldValue("PROPERTY"),[a,o,i]=n[r],n=t.valueToCode(e,"NUMBER_TO_CHECK",o)||"0";return[e="PRIME"===r?t.provideFunction_("mathIsPrime",`
