...
declare module exports {
     ...
     */
    function generateUniqueName(workspace: Workspace): string;
...
declare module CommentBase {
     ...
     */
    function CommentCreateDeleteHelper(event: Events.CommentCreate|Events.CommentDelete, create: boolean): void;
}
