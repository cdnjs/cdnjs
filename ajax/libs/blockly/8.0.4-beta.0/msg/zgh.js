...
messages["ADD_COMMENT"] = "ⵔⵏⵓ ⴰⵅⴼⴰⵡⴰⵍ";
...
messages["CHANGE_VALUE_TITLE"] = "ⵙⵏⴼⵍ ⴰⵣⴰⵍ:";
...
messages["COLOUR_BLEND_COLOUR1"] = "ⴰⴽⵍⵓ 1";
messages["COLOUR_BLEND_COLOUR2"] = "ⴰⴽⵍⵓ 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "ⴰⵙⵙⴰⵖ";
messages["COLOUR_BLEND_TITLE"] = "ⵙⵎⵔⴽⵙ";
...
messages["COLOUR_RGB_BLUE"] = "ⴰⵏⵉⵍⵉ";
messages["COLOUR_RGB_GREEN"] = "ⴰⵣⴳⵣⴰ";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ⴰⵣⴳⴳⵯⴰⵖ";
messages["COLOUR_RGB_TITLE"] = "ⴽⵍⵓ ⵙ";
messages["COLOUR_RGB_TOOLTIP"] = "ⴰⵣⴰⵍⵏ ⵉⴼⵓⴽⴽ ⴰⴷ ⵉⵍⵉⵏ ⴳⵔ 0 ⴷ 100.";
...
messages["CONTROLS_IF_MSG_ELSE"] = "ⵎⴽ ⴷ ⵓⵀⵓ";
messages["CONTROLS_IF_MSG_ELSEIF"] = "ⵉⵙ";
messages["CONTROLS_IF_MSG_IF"] = "ⵎⴽ";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "ⴳ";
messages["CONTROLS_REPEAT_TITLE"] = "ⴰⵍⵙ %1 ⵜⵉⴽⴽⴰⵍ";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "ⴰⵍⵙ ⴰⵔⴷ";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "ⴰⵍⵙ ⴰⴷⴷⴰⴳ";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "While a value is false, then do some statements.";  // untranslated
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "ⴽⵓⴷ ⵉⴷⵜⵜⴰ ⵡⴰⵣⴰⵍ, ⵙⵙⵍⴽⵎ ⴽⵔⴰ ⵏ ⵡⴰⵏⴰⴹⵏ.";
messages["DELETE_ALL_BLOCKS"] = "ⴽⴽⵙ %1 ⵉⴱⵍⵓⴽⵏ ⵎⴰⵕⵕⴰ?";
messages["DELETE_BLOCK"] = "ⴽⴽⵙ ⴰⴱⵍⵓⴽ";
messages["DELETE_VARIABLE"] = "ⴽⴽⵙ ⴰⵎⵙⴽⵉⵍ '%1'";
messages["DELETE_VARIABLE_CONFIRMATION"] = "Delete %1 uses of the '%2' variable?";  // untranslated
messages["DELETE_X_BLOCKS"] = "ⴽⴽⵙ %1 ⵉⴱⵍⵓⴽⵏ";
messages["DIALOG_CANCEL"] = "ⵙⵔ";
messages["DIALOG_OK"] = "ⵡⴰⵅⵅⴰ";
...
messages["LISTS_GET_INDEX_FIRST"] = "ⴰⵎⵣⵡⴰⵔⵓ";
messages["LISTS_GET_INDEX_FROM_END"] = "# ⵙⴳ ⵜⵉⴳⵉⵔⴰ";
...
messages["LISTS_GET_INDEX_LAST"] = "ⴰⵎⴳⴳⴰⵔⵓ";
messages["LISTS_GET_INDEX_RANDOM"] = "random";  // untranslated
messages["LISTS_GET_INDEX_REMOVE"] = "ⵙⵉⵜⵜⵢ";
...
messages["LISTS_GET_SUBLIST_END_FROM_START"] = "ⴰⵔ #";
messages["LISTS_GET_SUBLIST_END_LAST"] = "ⴰⵔ ⵜⴳⵉⵔⴰ";
...
messages["LISTS_INLIST"] = "ⴳ ⵜⵍⴳⴰⵎⵜ";
...
messages["LISTS_LENGTH_TITLE"] = "ⵜⵉⵖⵣⵉ ⵏ %1";
...
messages["LISTS_SET_INDEX_INPUT_TO"] = "ⴰⵎ";
...
messages["LISTS_SORT_TYPE_NUMERIC"] = "ⴰⵎⵓⵟⵟⵓⵏ";
...
messages["LOGIC_BOOLEAN_FALSE"] = "ⴰⵔⵎⵉⴷⵉ";
...
messages["LOGIC_BOOLEAN_TRUE"] = "ⴰⵎⵉⴷⵉ";
...
messages["LOGIC_TERNARY_CONDITION"] = "ⴰⵔⵎ";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "ⵎⴽ ⵓⵔ ⵉⴷⵜⵜⵉ";
messages["LOGIC_TERNARY_IF_TRUE"] = "ⵎⴽ ⵉⴷⵜⵜⴰ";
...
messages["MATH_ATAN2_TITLE"] = "atan2 ⵙⴳ X:%1 Y:%2";
...
messages["MATH_CHANGE_TITLE"] = "ⵙⵏⴼⵍ %1 ⵙ %2";
messages["MATH_CHANGE_TOOLTIP"] = "ⵔⵏⵓ ⵢⴰⵏ ⵓⵎⴹⴰⵏ ⵖⵔ ⵓⵎⵙⴽⵉⵍ '%1'";
...
messages["MATH_NUMBER_TOOLTIP"] = "ⴽⵔⴰ ⵏ ⵓⵎⴹⴰⵏ.";
...
messages["NEW_COLOUR_VARIABLE"] = "ⵙⴽⵔ ⴰⴽⵍⵓ ⴰⵎⵙⴽⵉⵍ...";
messages["NEW_NUMBER_VARIABLE"] = "ⵙⴽⵔ ⴰⵎⴹⴰⵏ ⴰⵎⵙⴽⵉⵍ...";
messages["NEW_STRING_VARIABLE"] = "Create string variable...";  // untranslated
messages["NEW_VARIABLE"] = "ⵙⴽⵔ ⴰⵎⵙⴽⵉⵍ...";
messages["NEW_VARIABLE_TITLE"] = "ⵉⵙⵎ ⵏ ⵓⵎⵙⴽⵉⵍ ⴰⵎⴰⵢⵏⵓ:";
messages["NEW_VARIABLE_TYPE_TITLE"] = "ⴰⵏⴰⵡ ⴰⵎⴰⵢⵏⵓ ⵏ ⵓⵎⵙⴽⵉⵍ:";
messages["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
messages["PROCEDURES_ALLOW_STATEMENTS"] = "allow statements";  // untranslated
messages["PROCEDURES_BEFORE_PARAMS"] = "ⵙ:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "ⵙ:";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "ⴳ ⴽⵔⴰ";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "ⵉ";
...
messages["PROCEDURES_MUTATORARG_TOOLTIP"] = "ⵔⵏⵓ ⴰⵏⴽⵛⴰⵎ ⵖⵔ ⵜⵙⵖⵏⵜ.";
...
messages["REDO"] = "ⴰⵍⵙ";
messages["REMOVE_COMMENT"] = "ⴽⴽⵙ ⴰⵅⴼⴰⵡⴰⵍ";
messages["RENAME_VARIABLE"] = "ⵙⵏⴼⵍ ⵉⵙⵎ ⵏ ⵓⵎⵙⴽⵉⵍ...";
messages["RENAME_VARIABLE_TITLE"] = "ⵙⵏⴼⵍ ⵉⵎⵙⴽⵉⵍⵏ ⴰⴽⴽ '%1' ⵖⵔ:";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "ⵍⴽⵎ";
...
messages["TEXT_INDEXOF_TITLE"] = "ⴳ ⵓⴹⵕⵉⵚ %1 %2 %3";
...
messages["TEXT_JOIN_TITLE_CREATEWITH"] = "ⵙⵏⴼⵍⵓⵍ ⴰⴹⵕⵉⵚ ⵙ";
...
messages["TEXT_LENGTH_TITLE"] = "ⵜⵉⵖⵣⵉ ⵏ %1";
...
messages["TODAY"] = "ⴰⵙⵙⴰ";
messages["UNDO"] = "ⵙⵔ";
messages["UNNAMED_KEY"] = "ⴰⵔⵉⵙⵎ";
messages["VARIABLES_DEFAULT_NAME"] = "ⴰⴼⵔⴷⵉⵙ";
