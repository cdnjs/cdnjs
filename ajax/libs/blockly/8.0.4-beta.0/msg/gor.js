...
messages["ADD_COMMENT"] = "Moduhenga tuladu";
...
messages["CHANGE_VALUE_TITLE"] = "Ubawa nilai";
...
messages["COLLAPSE_ALL"] = "Mohe'uto Blok";
messages["COLLAPSE_BLOCK"] = "Mohe'uto Blok";
messages["COLOUR_BLEND_COLOUR1"] = "laku 1";
messages["COLOUR_BLEND_COLOUR2"] = "laku 2";
...
messages["COLOUR_BLEND_TITLE"] = "Ulawuwa";
messages["COLOUR_BLEND_TOOLTIP"] = "Mongulawu dulo laku pe'eenta wolo rasio (0.0-1.0)";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Laku";
messages["COLOUR_PICKER_TOOLTIP"] = "Piliya laku lonto daputari lo laku";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "Laku acak";
messages["COLOUR_RANDOM_TOOLTIP"] = "Piliya laku acak";
messages["COLOUR_RGB_BLUE"] = "wahu'ente";
messages["COLOUR_RGB_GREEN"] = "moyidu";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "meela";
messages["COLOUR_RGB_TITLE"] = "wolo laku";
messages["COLOUR_RGB_TOOLTIP"] = "Pohutuwa laku wolo jumula u tilantu monto u meela, moyidu wawu wahu'ente. Nga'amila musi o woolota 0 wawu 100";
...
messages["CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK"] = "Mokaluwari lonto u'uulangiya";
...
messages["CONTROLS_IF_MSG_ELSE"] = "uweewo";
messages["CONTROLS_IF_MSG_ELSEIF"] = "wonu uweewo";
messages["CONTROLS_IF_MSG_IF"] = "wonu";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "pohutuwa";
messages["CONTROLS_REPEAT_TITLE"] = "ulangiya %1 kali";
...
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "ulangiya sambe";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "Ulangiya wonu";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "Wonu nilai diya banari, pohutuwa parenta";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "Wonu nilai banari, pohutuwa po'ongoolo";
messages["DELETE_ALL_BLOCKS"] = "Luluta nga'amila %1 blocks?";
messages["DELETE_BLOCK"] = "Moluluto Blok";
...
messages["DELETE_X_BLOCKS"] = "Moluluto %1 Blok";
messages["DIALOG_CANCEL"] = "Cancel";  // untranslated
messages["DIALOG_OK"] = "OK";  // untranslated
messages["DISABLE_BLOCK"] = "Moberenti Blok";
messages["DUPLICATE_BLOCK"] = "Duplikat";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "Momulayi Blok";
messages["EXPAND_ALL"] = "Lolade Blok";
messages["EXPAND_BLOCK"] = "Lolade Blok";
messages["EXTERNAL_INPUTS"] = "tuwanga lonto eksternal";
messages["HELP"] = "Tuulungi";
messages["INLINE_INPUTS"] = "tuwanga lo inline";
...
messages["LOGIC_BOOLEAN_FALSE"] = "tala";
...
messages["LOGIC_BOOLEAN_TRUE"] = "banari";
...
messages["LOGIC_TERNARY_CONDITION"] = "yimontalo";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "wonu tala";
messages["LOGIC_TERNARY_IF_TRUE"] = "wonu banari";
...
messages["MATH_NUMBER_TOOLTIP"] = "Noomoro";
...
messages["MATH_SINGLE_OP_ROOT"] = "akar pangkat dua";
...
messages["NEW_VARIABLE"] = "Variabel bohu...";
messages["NEW_VARIABLE_TITLE"] = "Tanggulo Variabel bohu";
...
messages["PROCEDURES_CREATE_DO"] = "Pohutu '%1'";
...
messages["REMOVE_COMMENT"] = "Mohinggi tuladu";
messages["RENAME_VARIABLE"] = "Tangguli uulangi variabel";
messages["RENAME_VARIABLE_TITLE"] = "Tangguli uulangi nga'amila % variabel ode:";
...
messages["TEXT_CHANGECASE_OPERATOR_LOWERCASE"] = "mowali hurupu kiki'o";
messages["TEXT_CHANGECASE_OPERATOR_TITLECASE"] = "to Title Case";  // untranslated
messages["TEXT_CHANGECASE_OPERATOR_UPPERCASE"] = "mowali HURUPU DAMANGO";
messages["TEXT_CHANGECASE_TOOLTIP"] = "Return a copy of the text in a different case.";  // untranslated
messages["TEXT_CHARAT_FIRST"] = "hama tulade bungaliyo";
messages["TEXT_CHARAT_FROM_END"] = "hama hurupu # monto wuleya";
messages["TEXT_CHARAT_FROM_START"] = "hama hurupu #";
...
messages["TEXT_CHARAT_RANDOM"] = "hama tulade ambulati";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "wayito";
messages["TEXT_CREATE_JOIN_TOOLTIP"] = "Duhengi, yinggila, meyalo susungiya ulangi tuladu blok.";
messages["TEXT_GET_SUBSTRING_END_FROM_END"] = "ode tuladu # monto wuleya";
messages["TEXT_GET_SUBSTRING_END_FROM_START"] = "ode hurupu";
messages["TEXT_GET_SUBSTRING_END_LAST"] = "to tulade pulitiyo";
messages["TEXT_GET_SUBSTRING_HELPURL"] = "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";  // untranslated
messages["TEXT_GET_SUBSTRING_INPUT_IN_TEXT"] = "to delomo tuladu";
...
messages["TEXT_INDEXOF_OPERATOR_FIRST"] = "lolohe u yilowali bohuliyo to delomo tuladu";
messages["TEXT_INDEXOF_OPERATOR_LAST"] = "lolohe u yilowali pulitiyo to delomo tuladu";
...
messages["TEXT_ISEMPTY_TITLE"] = "%1 koosongi";
messages["TEXT_ISEMPTY_TOOLTIP"] = "Pohalinga banari wonu tuladu u sadi-sadia koosongi.";
...
messages["TEXT_LENGTH_TITLE"] = "haya'o lo %1";
