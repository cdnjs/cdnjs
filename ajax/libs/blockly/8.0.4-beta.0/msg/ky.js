...
messages["ADD_COMMENT"] = "Пикириңизди кошуңуз";
...
messages["CHANGE_VALUE_TITLE"] = "маанисин өзгөрт";
messages["CLEAN_UP"] = "Блокторду тазалоо";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "Блокторду жашыруу";
messages["COLLAPSE_BLOCK"] = "Блокту жашыруу";
messages["COLOUR_BLEND_COLOUR1"] = "1-түс";
messages["COLOUR_BLEND_COLOUR2"] = "2-түс";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "катышы";
messages["COLOUR_BLEND_TITLE"] = "аралаштыруу";
messages["COLOUR_BLEND_TOOLTIP"] = "Эки түстү берилген катыш (0.0 - 1.0) менен аралаштыр.";
messages["COLOUR_PICKER_HELPURL"] = "https://en.wikipedia.org/wiki/Color";
messages["COLOUR_PICKER_TOOLTIP"] = "палитрадан түс танда";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "тушкелди түс";
messages["COLOUR_RANDOM_TOOLTIP"] = "Түстү тушкелди тандоо.";
messages["COLOUR_RGB_BLUE"] = "көк";
messages["COLOUR_RGB_GREEN"] = "жашыл";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "кызыл";
messages["COLOUR_RGB_TITLE"] = "түсү менен";
messages["COLOUR_RGB_TOOLTIP"] = "Кызыл, жашыл жана көк түстөрдөн жаңы түс жаса. Ар бир түстүн мааниси 0 менен 100 арасында болуусу керек.";
...
messages["CONTROLS_FOREACH_TITLE"] = "%2 катарынын ар бир элементи %1 үчүн";
...
messages["CONTROLS_FOR_TITLE"] = "%1 менен %2 ден %3 кө чейин %4 төн эсепте";
...
messages["CONTROLS_IF_MSG_ELSE"] = "башка";
messages["CONTROLS_IF_MSG_ELSEIF"] = "же болбосо";
messages["CONTROLS_IF_MSG_IF"] = "эгерде";
...
messages["CONTROLS_REPEAT_INPUT_DO"] = "жаса";
messages["CONTROLS_REPEAT_TITLE"] = "%1 жолу кайтала";
messages["CONTROLS_REPEAT_TOOLTIP"] = "Билдирүүнү бир канча жолу кайтала";
messages["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "Кайтала чейин";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "Кайтала эгерде";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "Маани ката болгон учурда билдирүүлөрдү кайтала";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "Маани туура болгон учурда билдирүүлөрдү кайтала";
messages["DELETE_ALL_BLOCKS"] = "1% блоктордун баарын өчүрүү, йа?";
messages["DELETE_BLOCK"] = "Блокту Өчүрүү";
...
messages["DELETE_X_BLOCKS"] = "Блоктун 1%ын Өчүрүү";
messages["DIALOG_CANCEL"] = "Cancel";  // untranslated
messages["DIALOG_OK"] = "OK";
messages["DISABLE_BLOCK"] = "Блок жараксыз";
messages["DUPLICATE_BLOCK"] = "Дубликат";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "Блок жарактуу";
messages["EXPAND_ALL"] = "Блокторду кеңейтүү";
messages["EXPAND_BLOCK"] = "Блокту кеңейтүү";
messages["EXTERNAL_INPUTS"] = "Тышкы Толуктоолор";
messages["HELP"] = "Жардам";
messages["INLINE_INPUTS"] = "Ички Толуктоолор";
...
messages["LOGIC_NEGATE_TITLE"] = " %1 эмес";
...
messages["LOGIC_OPERATION_OR"] = "же";
...
messages["LOGIC_TERNARY_CONDITION"] = "текшерүү";
messages["LOGIC_TERNARY_HELPURL"] = "https://en.wikipedia.org/wiki/%3F:";  // untranslated
messages["LOGIC_TERNARY_IF_FALSE"] = "ката болсо";
messages["LOGIC_TERNARY_IF_TRUE"] = "туура болсо";
...
messages["NEW_VARIABLE"] = "жаңы өзгөрмө";
messages["NEW_VARIABLE_TITLE"] = "Жаңы өзгөрмөнүн аты";
...
messages["REMOVE_COMMENT"] = "Жорумду өчүрүү";
messages["RENAME_VARIABLE"] = "Өзгөрмөнүн атын алмаштыруу";
messages["RENAME_VARIABLE_TITLE"] = "Баардык '%1' өзгөрмөнүнүн атын алмаштыр";
...
messages["TEXT_ISEMPTY_TITLE"] = "%1 бош";
