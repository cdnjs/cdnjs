...
messages["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "Can't delete the variable '%1' because it's part of the definition of the function '%2'";
...
messages["DELETE_VARIABLE_CONFIRMATION"] = "Delete %1 uses of the '%2' variable?";
...
messages["LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM"] = "Removes and returns the item at the specified position in a list.";
...
messages["LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM"] = "Removes the item at the specified position in a list.";
...
messages["LISTS_INDEX_FROM_END_TOOLTIP"] = "%1 is the last item.";
messages["LISTS_INDEX_FROM_START_TOOLTIP"] = "%1 is the first item.";
...
messages["LISTS_INDEX_OF_TOOLTIP"] = "Returns the index of the first/last occurrence of the item in the list. Returns %1 if item is not found.";
...
messages["LISTS_REVERSE_MESSAGE0"] = "reverse %1";
messages["LISTS_REVERSE_TOOLTIP"] = "Reverse a copy of a list.";
...
messages["LISTS_SET_INDEX_TOOLTIP_INSERT_FROM"] = "Inserts the item at the specified position in a list.";
...
messages["LISTS_SET_INDEX_TOOLTIP_SET_FROM"] = "Sets the item at the specified position in a list.";
...
messages["LISTS_SORT_ORDER_ASCENDING"] = "ascending";
messages["LISTS_SORT_ORDER_DESCENDING"] = "descending";
messages["LISTS_SORT_TITLE"] = "sort %1 %2 %3";
messages["LISTS_SORT_TOOLTIP"] = "Sort a copy of a list.";
messages["LISTS_SORT_TYPE_IGNORECASE"] = "alphabetic, ignore case";
messages["LISTS_SORT_TYPE_NUMERIC"] = "numeric";
messages["LISTS_SORT_TYPE_TEXT"] = "alphabetic";
...
messages["MATH_ATAN2_TOOLTIP"] = "Return the arctangent of point (X, Y) in degrees from -180 to 180.";
...
messages["TEXT_CHARAT_TITLE"] = "in text %1 %2";
...
messages["TEXT_COUNT_TOOLTIP"] = "Count how many times some text occurs within some other text.";
...
messages["TEXT_INDEXOF_TOOLTIP"] = "Returns the index of the first/last occurrence of the first text in the second text. Returns %1 if text is not found.";
...
messages["TEXT_REPLACE_TOOLTIP"] = "Replace all occurances of some text within some other text.";
...
messages["TEXT_REVERSE_TOOLTIP"] = "Reverses the order of the characters in the text.";
...
messages["VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE"] = "A variable named '%1' already exists for another type: '%2'.";
