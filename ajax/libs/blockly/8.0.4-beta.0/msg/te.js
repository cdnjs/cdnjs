...
messages["ADD_COMMENT"] = "వ్యాఖ్య చేర్చు";
...
messages["CHANGE_VALUE_TITLE"] = "విలువ మార్చు";
messages["CLEAN_UP"] = "నిరోదనలను శుభ్రపరుచు";
messages["COLLAPSED_WARNINGS_WARNING"] = "Collapsed blocks contain warnings.";  // untranslated
messages["COLLAPSE_ALL"] = "నిరోదనలను కూల్చు";
messages["COLLAPSE_BLOCK"] = "నరోదన కూల్చు";
messages["COLOUR_BLEND_COLOUR1"] = "రంగు 1";
messages["COLOUR_BLEND_COLOUR2"] = "రంగు 2";
messages["COLOUR_BLEND_HELPURL"] = "https://meyerweb.com/eric/tools/color-blend/#:::rgbp";  // untranslated
messages["COLOUR_BLEND_RATIO"] = "నిష్పత్తి";
messages["COLOUR_BLEND_TITLE"] = "మిశ్రమం";
messages["COLOUR_BLEND_TOOLTIP"] = "రెండు రంగులను (0.0 - 1.0) నిష్పత్తిలో మిశ్రమించాలి.";
messages["COLOUR_PICKER_HELPURL"] = "https://te.wikipedia.org/wiki/రంగు";
messages["COLOUR_PICKER_TOOLTIP"] = "చిత్రకారుడు ఉపయోగించే రంగుల నుండి ఒక దానిని ఎంచుకో.";
messages["COLOUR_RANDOM_HELPURL"] = "http://randomcolour.com";  // untranslated
messages["COLOUR_RANDOM_TITLE"] = "యాదృచ్ఛిక రంగు";
messages["COLOUR_RANDOM_TOOLTIP"] = "యాదృచ్ఛికంగా ఒక రంగును ఎంచుకో.";
messages["COLOUR_RGB_BLUE"] = "నీలం";
messages["COLOUR_RGB_GREEN"] = "ఆకుపచ్చ";
messages["COLOUR_RGB_HELPURL"] = "https://www.december.com/html/spec/colorpercompact.html";  // untranslated
messages["COLOUR_RGB_RED"] = "ఎరుపు";
messages["COLOUR_RGB_TITLE"] = "తో రంగు";
messages["COLOUR_RGB_TOOLTIP"] = "ఎరుపు,పచ్చ మరియు బులుగు రంగులను సమంగా ఉపయోగించి ఒక రంగును సృష్ఠించండి.అన్ని విలువలు 0 నుండి 100 మధ్యలో ఉండాలి.";
...
messages["CONTROLS_FOREACH_TITLE"] = "ఒక అంశం కోసం %1 జాబితా లో %2";
...
messages["CONTROLS_FOR_TITLE"] = "దీనితో లెక్కించు %1 నుండి %2 వరకు %3 తో %4";
...
messages["CONTROLS_IF_MSG_IF"] = "అయితే";
...
messages["CONTROLS_REPEAT_HELPURL"] = "https://te.wikipedia.org/wiki/For_loop";
messages["CONTROLS_REPEAT_INPUT_DO"] = "చేయు";
messages["CONTROLS_REPEAT_TITLE"] = "%1 సార్లు మళ్ళీ కొనసాగించు";
messages["CONTROLS_REPEAT_TOOLTIP"] = "కొన్ని నివేదికలు లేదా ప్రతిపాదనలు అనేక మార్లు చెయ్యండి.";
messages["CONTROLS_WHILEUNTIL_HELPURL"] = "https://github.com/google/blockly/wiki/Loops#repeat";  // untranslated
messages["CONTROLS_WHILEUNTIL_OPERATOR_UNTIL"] = "అంతవరకు మళ్ళీ కొనసాగించండి";
messages["CONTROLS_WHILEUNTIL_OPERATOR_WHILE"] = "repeat while";  // untranslated
messages["CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL"] = "ఒక వె తప్పైనప్పుడు కొన్ని నివేదికలు లేదా ప్రతిపాదనలు చెయ్యండి.";
messages["CONTROLS_WHILEUNTIL_TOOLTIP_WHILE"] = "ఒక వెల నిజమైనప్పుడు కొన్ని నివేదికలు లేదా ప్రతిపాదనలు చెయ్యండి.";
messages["DELETE_ALL_BLOCKS"] = "మెుత్తం %1నిరోదనలను తొలగించు?";
messages["DELETE_BLOCK"] = "నిరోదన తొలగించు";
...
messages["DELETE_X_BLOCKS"] = "%1నిరోదనలను తోలగించు";
messages["DIALOG_CANCEL"] = "రద్దు";
messages["DIALOG_OK"] = "సరే";
messages["DISABLE_BLOCK"] = "నిరోదన పని చేయకుండా చేయు";
messages["DUPLICATE_BLOCK"] = "నకలు";
messages["DUPLICATE_COMMENT"] = "Duplicate Comment";  // untranslated
messages["ENABLE_BLOCK"] = "నిరోదన ప్రారంబించు";
messages["EXPAND_ALL"] = "నిరోదనలను విస్తరించు";
messages["EXPAND_BLOCK"] = "నిరోదన విస్తరించు";
...
messages["LISTS_CREATE_WITH_CONTAINER_TITLE_ADD"] = "జాబితా";
...
messages["LISTS_GET_INDEX_FIRST"] = "మొదటి";
messages["LISTS_GET_INDEX_FROM_END"] = "#చివరి నుండి";
messages["LISTS_GET_INDEX_FROM_START"] = "#";  // untranslated
messages["LISTS_GET_INDEX_GET"] = "పొందు";
messages["LISTS_GET_INDEX_GET_REMOVE"] = "తెచ్చుకుని, తీసెయ్యి";
messages["LISTS_GET_INDEX_LAST"] = "చివరి";
messages["LISTS_GET_INDEX_RANDOM"] = "యాదృచ్చిక";
messages["LISTS_GET_INDEX_REMOVE"] = "తొలగించు";
...
messages["LISTS_GET_SUBLIST_END_FROM_END"] = "చివరి నుండి # వరకు";
messages["LISTS_GET_SUBLIST_END_FROM_START"] = "# కు";
messages["LISTS_GET_SUBLIST_END_LAST"] = "తుదకు";
...
messages["LISTS_INLIST"] = "జాబితాలో";
...
messages["LISTS_SET_INDEX_INPUT_TO"] = "గా";
...
messages["LOGIC_BOOLEAN_FALSE"] = "అసత్యం";
...
messages["LOGIC_BOOLEAN_TRUE"] = "సత్యం";
...
messages["LOGIC_TERNARY_IF_FALSE"] = "అసత్యమైతే";
messages["LOGIC_TERNARY_IF_TRUE"] = "సత్యమైతే";
...
messages["MATH_ARITHMETIC_HELPURL"] = "https://te.wikipedia.org/wiki/Arithmetic";
messages["MATH_ARITHMETIC_TOOLTIP_ADD"] = "రెండు సంఖ్యల మొత్తానికి తిరిగి వెళ్ళండి.";
messages["MATH_ARITHMETIC_TOOLTIP_DIVIDE"] = "Return the quotient of the two numbers.";  // untranslated
messages["MATH_ARITHMETIC_TOOLTIP_MINUS"] = "రెండు సంఖ్యల తేడాకి తిరిగి వెళ్ళండి";
...
messages["MATH_IS_DIVISIBLE_BY"] = "దీనితో భాగించబడును";
messages["MATH_IS_EVEN"] = "is even";  // untranslated
messages["MATH_IS_NEGATIVE"] = "ప్రతికూలంగా ఉంది";
messages["MATH_IS_ODD"] = "is odd";  // untranslated
messages["MATH_IS_POSITIVE"] = "అనుకూలంగా ఉంది";
...
messages["MATH_NUMBER_TOOLTIP"] = "ఒ సంఖ్య.";
messages["MATH_ONLIST_HELPURL"] = "";  // untranslated
messages["MATH_ONLIST_OPERATOR_AVERAGE"] = "జాబితా సగటు";
...
messages["MATH_ONLIST_OPERATOR_SUM"] = "జాబితా మొత్తం";
...
messages["NEW_VARIABLE"] = "కొత్త వ్యత్యాసం...";
messages["NEW_VARIABLE_TITLE"] = "కొత్త వ్యత్యాసం పేరు:";
...
messages["PROCEDURES_BEFORE_PARAMS"] = "తో:";
...
messages["PROCEDURES_CALL_BEFORE_PARAMS"] = "తో:";
...
messages["PROCEDURES_DEFNORETURN_PROCEDURE"] = "ఏదో ఒకటి చేయి";
messages["PROCEDURES_DEFNORETURN_TITLE"] = "కు";
...
messages["PROCEDURES_DEFRETURN_RETURN"] = "తిరిగి వెళ్ళు";
...
messages["REDO"] = "మళ్ళీ చెయ్యి";
messages["REMOVE_COMMENT"] = "వ్యాఖ్యను తొలగించు";
messages["RENAME_VARIABLE"] = "పునఃనామకరణ వ్యత్యాసం...";
messages["RENAME_VARIABLE_TITLE"] = "మొత్తం వ్యత్యాసాలను '%1' దీనికి పునఃనామకరణించు:";
...
messages["TEXT_CHARAT_FIRST"] = "మొదటి వర్ణాన్ని పొందు";
...
messages["TEXT_CHARAT_LAST"] = "చివరి వర్ణాన్ని పొందు";
messages["TEXT_CHARAT_RANDOM"] = "యాదృశ్చిక వర్ణాన్ని పొందు";
...
messages["TEXT_CREATE_JOIN_TITLE_JOIN"] = "చేరు";
...
messages["TEXT_ISEMPTY_TITLE"] = "% 1 ఖాళీ";
...
messages["TEXT_LENGTH_TITLE"] = "%1 పొడువు";
...
messages["TODAY"] = "నేడు";
messages["UNDO"] = "రద్దుచెయ్యి";
messages["UNNAMED_KEY"] = "unnamed";  // untranslated
messages["VARIABLES_DEFAULT_NAME"] = "అంశం";
