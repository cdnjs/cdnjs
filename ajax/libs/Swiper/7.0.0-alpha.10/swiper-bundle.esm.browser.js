...
function onTouchMove(event) {
  ...
  if (params.freeMode && params.freeMode.enabled && swiper.freeMode || params.watchSlidesProgress || params.watchSlidesVisibility) {
...
// Swiper Class
const components = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Fade, Cube, Flip, Coverflow, Thumb, freeMode, Grid, Manipulation];
