...
(function (global, factory) {
        ...
        if (!swiper.animating) {
          ...
          if (!swiper.onTranslateToWrapperTransitionEnd) {
            swiper.onTranslateToWrapperTransitionEnd = function transitionEnd(e) {
              ...
              swiper.wrapperEl.removeEventListener('webkitTransitionEnd', swiper.onTranslateToWrapperTransitionEnd);
          ...
          swiper.wrapperEl.addEventListener('webkitTransitionEnd', swiper.onTranslateToWrapperTransitionEnd);
        }
      }
      ...
      if (speed === 0) {
        ...
        if (!swiper.onSlideToWrapperTransitionEnd) {
          swiper.onSlideToWrapperTransitionEnd = function transitionEnd(e) {
            ...
            swiper.wrapperEl.removeEventListener('webkitTransitionEnd', swiper.onSlideToWrapperTransitionEnd);
    ...
    function loopFix(slideRealIndex, slideTo) {
      ...
      const activeSlideIndex = elementIndex(swiper.slides.filter(el => el.classList.contains('swiper-slide-active'))[0]);
    ...
    function Virtual(_ref) {
      ...
      function renderSlide(slide, index) {
        ...
        let slideEl;
        if (params.renderSlide) slideEl = params.renderSlide.call(swiper, slide, index);else if (swiper.isElement) {
        ...
        if (!slideEl.getAttribute('data-swiper-slide-index')) slideEl.setAttribute('data-swiper-slide-index', index);
    ...
    function Navigation(_ref) {
      ...
      on('enable disable', () => {
        ...
        if (!Array.isArray(nextEl)) nextEl = [nextEl];
        if (!Array.isArray(prevEl)) prevEl = [prevEl];
        [...nextEl, ...prevEl].forEach(el => el.classList[swiper.enabled ? 'remove' : 'add'](swiper.params.navigation.lockClass));
      });
      on('click', (_s, e) => {
        let {
          nextEl,
        ...
        if (swiper.params.navigation.hideOnClick && !prevEl.includes(targetEl) && !nextEl.includes(targetEl)) {
          ...
          [...nextEl, ...prevEl].forEach(el => el.classList.toggle(swiper.params.navigation.hiddenClass));
        }
      });
  ...
  .replace(/ /g, '.')}`;
    ...
    function Pagination(_ref) {
      ...
      function update() {
        ...
        if (!Array.isArray(el)) el = [el]; // Current/Total
    ...
    function Parallax(_ref) {
      ...
      const setTranslate = () => {
        ...
        slides.forEach((slideEl, slideIndex) => {
          ...
          slideEl.querySelectorAll('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]').forEach(subEl => {
    ...
    function Thumb(_ref) {
      ...
      function onThumbClick() {
        ...
        if (swiper.params.loop) {
          ...
          const prevIndex = swiper.slides.indexOf(elementPrevAll(swiper.slides[currentIndex], `[data-swiper-slide-index="${slideToIndex}"]`)[0]);
          const nextIndex = swiper.slides.indexOf(elementNextAll(swiper.slides[currentIndex], `[data-swiper-slide-index="${slideToIndex}"]`)[0]);
      ...
      function update(initial) {
        ...
        if (swiper.realIndex !== thumbsSwiper.realIndex || useOffset) {
          ...
          if (thumbsSwiper.params.loop) {
            ...
            const prevThumbsIndex = thumbsSwiper.slides.indexOf(elementPrevAll(thumbsSwiper.slides[currentThumbsIndex], `[data-swiper-slide-index="${swiper.realIndex}"]`)[0]);
            const nextThumbsIndex = thumbsSwiper.slides.indexOf(elementNextAll(thumbsSwiper.slides[currentThumbsIndex], `[data-swiper-slide-index="${swiper.realIndex}"]`)[0]);
    ...
    function effectVirtualTransitionEnd(_ref) {
      ...
      if (swiper.params.virtualTranslate && duration !== 0) {
        ...
        if (allSlides) {
          ...
          transitionEndTarget = transformEl ? [...slides[activeIndex].querySelectorAll(activeIndex)] : [slides[activeIndex]];
        }
    ...
    function EffectFade(_ref) {
      ...
      const setTransition = duration => {
        ...
        const transitionElements = transformEl ? findElementsInElements(swiper.slides, transformEl) : swiper.slides;
