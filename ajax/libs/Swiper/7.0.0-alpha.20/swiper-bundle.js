...
(function (global, factory) {
  ...
  .replace(/ /g, '.')}`;
    ...
    function virtualEffectTransitionEnd({
      swiper,
      duration,
      transformEl,
      allSlides
    ...
    function EffectCards({
      ...
      `;
          ...
          if (params.slideShadows) {
            ...
            if ($shadowEl.length) $shadowEl[0].style.opacity = Math.min(Math.max(Math.abs(progress), 0), 1);
          }
    ...
    // Swiper Class
    const modules = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Thumb, freeMode, Grid, Manipulation, EffectFade, EffectCube, EffectFlip, EffectCoverflow, EffectCustom, EffectCards];
    Swiper.use(modules);
