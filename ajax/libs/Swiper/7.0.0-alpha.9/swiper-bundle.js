...
(function (global, factory) {
  ...
  .replace(/ /g, '.')}`;
    ...
    // Swiper Class
    const components = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Fade, Cube, Flip, Coverflow, Thumb, freeMode, Grid];
