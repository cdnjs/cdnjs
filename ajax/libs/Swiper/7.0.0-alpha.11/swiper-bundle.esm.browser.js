...
// Swiper Class
const modules = [Virtual, Keyboard, Mousewheel, Navigation, Pagination, Scrollbar, Parallax, Zoom, Lazy, Controller, A11y, History, HashNavigation, Autoplay, Fade, Cube, Flip, Coverflow, Thumb, freeMode, Grid, Manipulation];
Swiper.use(modules);
