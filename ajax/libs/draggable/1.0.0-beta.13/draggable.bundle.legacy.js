...
const ResizeMirror_onDragOver = Symbol('onDragOver');
...
class ResizeMirror extends AbstractPlugin {
  ...
  constructor(draggable) {
    ...
    this[ResizeMirror_onDragOver] = this[ResizeMirror_onDragOver].bind(this);
  }
   ...
   */
  attach() {
    this.draggable.on('mirror:created', this[onMirrorCreated]).on('drag:over', this[ResizeMirror_onDragOver]).on('drag:over:container', this[ResizeMirror_onDragOver]);
  }
   ...
   */
  detach() {
    this.draggable.off('mirror:created', this[onMirrorCreated]).off('mirror:destroy', this[onMirrorDestroy]).off('drag:over', this[ResizeMirror_onDragOver]).off('drag:over:container', this[ResizeMirror_onDragOver]);
  }
   ...
   * @private
   */
  [ResizeMirror_onDragOver](dragEvent) {
...
class Snappable extends AbstractPlugin {
   ...
   */
  attach() {
    this.draggable.on('drag:start', this[Snappable_onDragStart]).on('drag:stop', this[Snappable_onDragStop]).on('drag:over', this[Snappable_onDragOver]).on('drag:out', this[onDragOut]).on('droppable:over', this[Snappable_onDragOver]).on('droppable:out', this[onDragOut]).on('mirror:created', this[Snappable_onMirrorCreated]).on('mirror:destroy', this[Snappable_onMirrorDestroy]);
  }
