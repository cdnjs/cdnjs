...
const { addEvent, extend, fireEvent, isNumber, pick, pushUnique, syncTimeout } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
function onChartRedraw(e) {
    if (this.renderer) {
        ...
        if (chart.seriesLabelTimer) {
            external_highcharts_src_js_default_default().clearTimeout(chart.seriesLabelTimer);
        }
...
/* harmony default export */ const series_label_src = ((external_highcharts_src_js_default_default()));

export { series_label_src as default };
