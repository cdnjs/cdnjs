...
const { series: { prototype: { pointClass: Point } }, seriesTypes: { pie: { prototype: { pointClass: PiePoint } } } } = (external_highcharts_src_js_default_SeriesRegistry_default());
...
const { defined, extend: ItemSeries_extend, fireEvent, isNumber, merge: ItemSeries_merge, pick } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('item', ItemSeries);
/* *
 *
 *  Default Export
 *
...
/* harmony default export */ const item_series_src = ((external_highcharts_src_js_default_default()));

export { item_series_src as default };
