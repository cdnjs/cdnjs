...
const { addEvent, extend: VennSeries_extend, isArray: VennSeries_isArray, isNumber: VennSeries_isNumber, isObject: VennSeries_isObject, merge } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
