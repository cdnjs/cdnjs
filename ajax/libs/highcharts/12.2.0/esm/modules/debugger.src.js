...
const { addEvent, find, isNumber, pushUnique } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Constants
 *
...
function compose(ChartClass) {
    if (pushUnique(composed, 'Debugger')) {
        ...
        addEvent((external_highcharts_src_js_default_default()), 'displayError', onHighchartsDisplayError);
...
;// ./code/es-modules/masters/modules/debugger.src.js
...
/* harmony default export */ const debugger_src = ((external_highcharts_src_js_default_default()));

export { debugger_src as default };
