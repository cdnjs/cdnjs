...
const { addEvent, defined, extend, fireEvent, isNumber, merge, objectEach: Data_objectEach, pick, splat } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
addEvent((external_highcharts_src_js_default_Axis_default()), 'afterSetOptions', function () {
...
// option group, data.
addEvent((external_highcharts_src_js_default_Chart_default()), 'init', function (e) {
