...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("highcharts/indicators/aroon-oscillator", ["highcharts/highcharts"], function (amd1) {return factory(amd1,amd1["SeriesRegistry"]);});
	else if(typeof exports === 'object')
		exports["highcharts/indicators/aroon-oscillator"] = factory(root["_Highcharts"], root["_Highcharts"]["SeriesRegistry"]);
	else
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ aroon_oscillator_src)
});
...
const { aroon: AroonIndicator } = (highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default()).seriesTypes;

const { extend, merge: AroonOscillatorIndicator_merge } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Class
 *
...
;// ./code/es-modules/masters/indicators/aroon-oscillator.src.js




/* harmony default export */ const aroon_oscillator_src = ((highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default()));
