...
const { correctFloat, merge, extend } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Class
 *
...
external_highcharts_src_js_default_SeriesRegistry_default().registerSeriesType('pareto', ParetoSeries);
/* *
 *
 *  Default export
 *
...
/* harmony default export */ const pareto_src = ((external_highcharts_src_js_default_default()));

export { pareto_src as default };
