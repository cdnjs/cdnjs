...
(h.prototype=c.prototype,new h)}}(),k=a.seriesTypes.sma,u=b.isArray,p=b.merge;b=function(a){function b(){var c=null!==a&&a.apply(this,arguments)||this;c.data=void 0;c.points=void 0;c.options=void 0;return c}g(b,a);b.prototype.getValues=function(a,b){b=b.period;var c=a.xData,g=(a=a.yData)?a.length:0,q=[],h=[],k=[],r=[],f=1;if(!(c.length<=b)&&u(a[0])&&4===a[0].length){for(;f<b;){var d=a[f-1];q.push((d[1]+d[2]+d[3])/3);f++}for(f=b;f<=g;f++){d=a[f-1];d=(d[1]+d[2]+d[3])/3;var m=q.push(d);var l=q.slice(m-
