// Fine Uploader 5.12.0-alpha - (c) 2013-present Widen Enterprises, Inc. MIT licensed. http://fineuploader.com
(function(global) {
    (function($) {
        "use strict";
    ...
    qq.UploadHandler = function(spec) {
        ...
        qq.extend(this, {
            ...
            cancel: function(id, reason) {
                var self = this, cancelFinalizationEffort = new qq.Promise(), onCancelRetVal = onCancel(id, getName(id), cancelFinalizationEffort, reason);
    ...
    qq.UploadHandlerController = function(o, namespace) {
        ...
        qq.extend(this, {
            ...
            cancel: function(id, reason) {
                var cancelRetVal = handler.cancel(id, reason);
    ...
    (function() {
        ...
        qq.uiPrivateApi = {
            ...
            _onCancel: function(id, name, reason) {
                var fileContainer = this._templating.getFileContainer(id), templating = this._templating;
