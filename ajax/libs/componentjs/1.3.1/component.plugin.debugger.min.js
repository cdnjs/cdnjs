...
a.dbg_canvas_info.y-=j,a.dbg_reposition())})})}),500)}b.debug(3,"debugger enabled")}else/*  disable debugger  */
...
var e=a.dbg_grabber_offset-a.jq(".dbg .header",a.dbg.document).height(),f=c-a.dbg_grabber_offset+a.jq(".dbg .status",a.dbg.document).height();a.jq(".dbg .viewer",a.dbg.document).height(e),a.jq(".dbg .console",a.dbg.document).height(f),a.jq(".dbg .infobox",a.dbg.document).height(f),a.jq(".dbg .infobox",a.dbg.document).css("top",a.dbg_grabber_offset+a.jq(".dbg .status",a.dbg.document).height()),a.jq(".dbg .grabber",a.dbg.document).css("top",a.dbg_grabber_offset),/*  explicitly set the canvas size of the viewer  */
...
a.dbg_state_invalid.console&&(a.jq(".dbg .console .text",a.dbg.document).html(a.dbg_logbook),a.jq(".dbg .console",a.dbg.document).scrollTop(0),a.dbg_state_invalid.console=!0),a.dbg_state_invalid.components||a.dbg_state_invalid.requests||a.dbg_state_invalid.states){/*  walk the component tree to determine information about components  */
