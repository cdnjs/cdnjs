...
$cs.version={major:1,minor:3,micro:1,date:20160731},/*
...
_cs.annotation(c,"extend",a.extend)}/*
         ...
         */
_cs.isdefined(a.statics)&&_cs.extend(c,a.statics),_cs.isdefined(a.protos)&&_cs.mixin(c.prototype,a.protos);/*
...
var f=function(a,b){var c=_cs.annotation(b,"extend");return null!==c&&("clazz"===_cs.istypeof(c)&&("function"===_cs.istypeof(c[a])||"object"===_cs.istypeof(c.prototype)&&"function"===_cs.istypeof(c.prototype[a])||f(a,c)))};if(_cs.isdefined(a.mixin)){/*  inherit from mixin classes  */
for(var g=0;g<a.mixin.length;g++){/*  inherit all static fields  */
_cs.extend(c,a.mixin[g],d);/*  as methods in mixin classes (traits) always have to call "this.base()",
...
for(var h in a.mixin[g].prototype)if(_cs.isown(a.mixin[g].prototype,h)&&("function"!==_cs.istypeof(c.prototype[h])||!_cs.isown(c.prototype,h))){var i;/*  provide a trampoline function  */
i=f(h,c)?function(){return this.base.apply(this,arguments)}:function(){},_cs.annotation(i,"name",h),c.prototype[h]=i}/*  inherit prototype methods  */
_cs.mixin(c.prototype,a.mixin[g].prototype,d)}/*  remember mixin classes  */
...
var j=_cs.nop;_cs.isdefined(a.cons)?j=a.cons:_cs.isdefined(a.extend)&&(j=function(){this.base()}),_cs.annotation(c,"cons",j),/*  provide name for underlying implementation of "base()" for constructor  */
_cs.annotation(j,"name","cons"),_cs.isdefined(a.extend)&&_cs.annotation(j,"base",_cs.annotation(a.extend,"cons")),/*  remember user-supplied setup function  */
_cs.isdefined(a.setup)&&_cs.annotation(c,"setup",a.setup),/*  remember dynamics for per-object initialization  */
_cs.isdefined(a.dynamics)&&_cs.annotation(c,"dynamics",a.dynamics);/*
...
var k=function(a,b){for(var c=_cs.annotation(a,b);null===c&&_cs.annotation(a.caller,"clone")===!0;)c=_cs.annotation(a.caller,b),a=a.caller;return c},l=function(a,b,c){/*  determine inheritance of current class  */
var d=_cs.annotation(b,"extend");if(null===d)return null;/*  find function in current class' prototype and mixin chain  */
var e=!1;if("function"===_cs.istypeof(b.prototype[a])&&_cs.isown(b.prototype,a))for(var f=b.prototype[a];"function"===_cs.istypeof(f);){if(f===c){e=!0;break}f=k(f,"base")}/*  if not found, search recusively in the parent hierarchy,
                starting from the parent class  */
/*  if not found, search recusively in the parent hierarchy,
                starting from the parent class  */
return e?d:l(a,d,c)},m=function(a){if(null===_cs.annotation(a,"clone"))for(;_cs.annotation(a.caller,"clone")===!0;)a=a.caller;return a};/*
...
var a=k(arguments.callee.caller,"name"),b=k(arguments.callee.caller,"base"),c=l(a,this.constructor,m(arguments.callee.caller));/*  attempt 1: call base/super/parent function in mixin chain  */
if("function"===_cs.istypeof(b))return b.apply(this,arguments);if("string"===_cs.istypeof(a)&&"clazz"===_cs.istypeof(c)&&"function"===_cs.istypeof(c[a]))return c[a].apply(this,arguments);if("string"===_cs.istypeof(a)&&"clazz"===_cs.istypeof(c)&&"object"===_cs.istypeof(c.prototype)&&"function"===_cs.istypeof(c.prototype[a]))return c.prototype[a].apply(this,arguments);throw _cs.exception("base",'no base method found for method "'+a+'" in inheritance/mixin chain')},b){var n=function(a,b){/*  depth-first traversal  */
...
"function"===_cs.istypeof(_cs.annotation(b,"setup"))&&_cs.annotation(b,"setup").call(a)};n(c,c)}/*  return created class  */
/*
...
c.silent||$cs.debug(1,"event: "+b.path("/")+": dispatch on "+d),/*  further annotate event object  */
...
_cs.states.splice(g,0,f)},/*  determine state index via state name  */
