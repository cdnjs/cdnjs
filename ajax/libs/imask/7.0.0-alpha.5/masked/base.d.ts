...
export default class Masked<Value = any> {
    ...
    prepareChar?: (chars: string, masked: this, flags: AppendFlags) => string | [string, ChangeDetails];
    /** Validates if value is acceptable */
    validate?: (value: string, masked: this, flags: AppendFlags) => boolean;
    /** Does additional processing at the end of editing */
    commit?: (value: string, masked: this) => void;
    /** Format typed value to string */
    format?: (value: Value, masked: this) => string;
    /** Parse strgin to get typed value */
    parse?: (str: string, masked: this) => Value;
