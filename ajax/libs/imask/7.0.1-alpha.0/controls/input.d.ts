...
import { FactoryOpts, type FactoryArg, type FactoryReturnMasked } from '../masked/factory';
...
export default class InputMask<Opts extends FactoryArg> {
    ...
    */
    ...
    updateOptions<UpdateOpts extends Partial<Opts>>(opts: UpdateOpts extends FactoryOpts ? UpdateOpts : never): void;
    /** Updates cursor */
