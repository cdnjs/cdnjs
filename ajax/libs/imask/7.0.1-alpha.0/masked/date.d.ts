...
export type MaskedDateOptions<Value = Date | null> = Omit<MaskedPatternOptions<Value>, 'mask'> & Partial<Pick<MaskedDate<Value>, DateOptionsKeys>> & {
    mask?: string | DateMaskType;
};
/** Date mask */
export default class MaskedDate<Value = Date | null> extends MaskedPattern<Value> {
