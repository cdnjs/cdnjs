...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fullcalendar"), require("moment"), require("superagent"));
	else if(typeof define === 'function' && define.amd)
		define(["fullcalendar", "moment", "superagent"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("fullcalendar"), require("moment"), require("superagent")) : factory(root["FullCalendar"], root["moment"], root["superagent"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_48__) {
...
var ResourceViewMixin = /** @class */ (function (_super) {
    ...
    ResourceViewMixin.prototype.queryScroll = function () {
        ...
        if (this.isResourcesRendered) {
            fullcalendar_1.assignTo(scroll, this.queryResourceScroll());
        }
        return scroll;
    };
...
var tslib_1 = __webpack_require__(1);
var fullcalendar_1 = __webpack_require__(0);
var ResourceDayTableMixin_1 = __webpack_require__(20);
var ResourceComponentFootprint_1 = __webpack_require__(5);
        ...
        for (var _i = 0, genericSegs_1 = genericSegs; _i < genericSegs_1.length; _i++) {
            ...
            for (var resourceIndex = 0; resourceIndex < resourceCnt; resourceIndex++) {
                ...
                if (!(componentFootprint instanceof ResourceComponentFootprint_1.default) ||
                    ...
                    var copy = fullcalendar_1.assignTo({}, seg);
...
var fullcalendar_1 = __webpack_require__(0);
var ClippedScroller_1 = __webpack_require__(23);
var ScrollerCanvas_1 = __webpack_require__(24);
var ScrollJoiner_1 = __webpack_require__(15);
var ScrollFollower_1 = __webpack_require__(25);
var TimelineEventRenderer_1 = __webpack_require__(16);
var TimelineFillRenderer_1 = __webpack_require__(27);
var TimelineHelperRenderer_1 = __webpack_require__(28);
var TimelineEventDragging_1 = __webpack_require__(39);
var TimelineEventResizing_1 = __webpack_require__(40);
var TimelineView_defaults_1 = __webpack_require__(41);
var TimelineView = /** @class */ (function (_super) {
    ...
    */
    ...
    TimelineView.prototype.renderSkeleton = function () {
        ...
        this.timeBodyScroller.canvas.bgEl.appendChild(this.slatContainerEl = fullcalendar_1.createElement('div', { className: 'fc-slats' }));
        this.innerEl = this.timeBodyScroller.canvas.contentEl; // for TimelineHelperRenderer
        this.innerEl.appendChild(this.segContainerEl = fullcalendar_1.createElement('div', { className: 'fc-event-container' }));
    ...
    TimelineView.prototype.renderDates = function (dateProfile) {
        ...
        this.timeHeadColEls = fullcalendar_1.findElements(this.timeHeadScroller.canvas.contentEl, 'col');
        this.slatContainerEl.innerHTML = slatHtmlRes.bodyHtml;
        this.slatColEls = fullcalendar_1.findElements(this.slatContainerEl, 'col');
        this.slatEls = fullcalendar_1.findElements(this.slatContainerEl, 'td');
        ...
        this.slatInnerCoordCache = new fullcalendar_1.CoordCache({
            els: fullcalendar_1.findChildren(this.slatEls, 'div'),
            isHorizontal: true,
        ...
        if (this.headDateFollower) {
            this.headDateFollower.setSpriteEls(fullcalendar_1.findElements(this.timeHeadEl, 'tr:not(:last-child) .fc-cell-text'));
        }
    };
    ...
    TimelineView.prototype.renderNowIndicator = function (date) {
        ...
        if (this.normalizedUnzonedRange.containsDate(date)) {
            ...
            var styleProps = this.isRTL ?
                { right: -coord } :
                { left: coord };
            var arrowEl = fullcalendar_1.createElement('div', {
                className: 'fc-now-indicator fc-now-indicator-arrow',
                style: styleProps
            });
            var lineEl = fullcalendar_1.createElement('div', {
    ...
    TimelineView.prototype.unrenderNowIndicator = function () {
        if (this.nowIndicatorEls) {
            this.nowIndicatorEls.forEach(fullcalendar_1.removeElement);
    ...
    TimelineView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        if (isDatesRendered) {
            this.timeHeadColEls.slice(0, -1).concat(this.slatColEls.slice(0, -1)).forEach(function (el) {
    ...
    TimelineView.prototype.computeSlotWidth = function () {
        ...
        var innerEls = fullcalendar_1.findElements(this.timeHeadEl, 'tr:last-child th .fc-cell-text'); // TODO: cache
        ...
        var minWidth = window.getComputedStyle(this.timeHeadColEls[0]).minWidth;
        if (minWidth) {
    ...
    TimelineView.prototype.getHeadHeight = function () {
        // TODO: cache <table>
        var table = this.timeHeadScroller.canvas.contentEl.querySelector('table');
        return table ? table.offsetHeight : 0; // why the check?
    };
    TimelineView.prototype.setHeadHeight = function (h) {
        // TODO: cache <table>
        var table = this.timeHeadScroller.canvas.contentEl.querySelector('table');
        if (table) { // why?
            fullcalendar_1.applyStyleProp(table, 'height', h);
        }
    };
...
var tslib_1 = __webpack_require__(1);
var fullcalendar_1 = __webpack_require__(0);
var ScrollFollowerSprite_1 = __webpack_require__(26);
var TimelineEventRenderer = /** @class */ (function (_super) {
    ...
    TimelineEventRenderer.prototype.renderFgSegs = function (segs) {
        ...
        for (var _d = 0, segs_5 = segs; _d < segs_5.length; _d++) {
            var seg = segs_5[_d];
            var titleEl = seg.el.querySelector('.fc-title');
            if (titleEl) {
...
var RowParent = /** @class */ (function (_super) {
    ...
    RowParent.prototype.renderSkeleton = function () {
        ...
        if (this.hasOwnRow) { // only bother rendering TRs if we know this node has a real row
            ...
            for (var type in this.view.tbodyHash) {
                ...
                if (prevRow) {
                    fullcalendar_1.insertAfterElement(prevRow.trHash[type], tr);
                }
                else {
                    fullcalendar_1.prependToElement(tbody, tr); // belongs in the very first position
                }
            }
            // build a single jQuery object. use event delegation for calling toggleExpanded
            trs.forEach(function (tr) {
                fullcalendar_1.listenBySelector(tr, 'click', '.fc-expander', _this.toggleExpanded.bind(_this));
            });
            this.trs = trs;
            this.thisRowShown();
        }
    ...
    */
    RowParent.prototype.removeElement = function () {
        ...
        this.thisRowHidden();
        this.trHash = {};
        this.trs.forEach(fullcalendar_1.removeElement); // remove from DOM
        this.trs = [];
        for (var _i = 0, _a = this.children; _i < _a.length; _i++) {
            var child = _a[_i];
    ...
    */
    RowParent.prototype.indicateExpanded = function () {
        var _this = this;
        fullcalendar_1.findElements(this.trs, '.fc-expander .fc-icon').forEach(function (iconEl) {
            iconEl.classList.remove(_this.getCollapsedIcon());
            iconEl.classList.add(_this.getExpandedIcon());
        });
    };
    /*
    ...
    */
    RowParent.prototype.indicateCollapsed = function () {
        var _this = this;
        fullcalendar_1.findElements(this.trs, '.fc-expander .fc-icon').forEach(function (iconEl) {
            iconEl.classList.remove(_this.getExpandedIcon());
            iconEl.classList.add(_this.getCollapsedIcon());
        });
    };
    RowParent.prototype.indicateExpandingEnabled = function () {
        fullcalendar_1.findElements(this.trs, '.fc-expander-space').forEach(function (spaceEl) {
    ...
    RowParent.prototype.indicateExpandingDisabled = function () {
        ...
        fullcalendar_1.findElements(this.trs, '.fc-expander-space').forEach(function (spaceEl) {
            ...
            var iconEl = spaceEl.querySelector('.fc-icon');
            iconEl.classList.remove(_this.getExpandedIcon());
            iconEl.classList.remove(_this.getCollapsedIcon());
        });
    };
    ...
    */
    RowParent.prototype.animateExpand = function () {
        ...
        if (trs) {
            ...
            trs.forEach(function (tr) {
                fullcalendar_1.whenTransitionDone(tr, function () {
    ...
    */
    RowParent.prototype.setTrInnerHeight = function (height) {
        ...
        for (var type in this.trHash) {
            var tr = this.trHash[type];
            fullcalendar_1.applyStyleProp(getTrHeightDiv(tr), 'height', height);
        }
    };
    // Triggering
    // ------------------------------------------------------------------------------------------------------------------
...
function getTrHeightDiv(tr) {
    return fullcalendar_1.findChildren(fullcalendar_1.findChildren(tr), 'div:not(.fc-cell-content)')[0];
}
...
var tslib_1 = __webpack_require__(1);
var fullcalendar_1 = __webpack_require__(0);
var ResourceViewMixin_1 = __webpack_require__(8);
var ResourceDayGrid_1 = __webpack_require__(12);
var ResourceTimeGrid_1 = __webpack_require__(37);
...
var ResourceDayTableMixin = /** @class */ (function (_super) {
    ...
    ResourceDayTableMixin.prototype.processHeadResourceEls = function (containerEl) {
        var _this = this;
        fullcalendar_1.findElements(containerEl, '.fc-resource-cell').forEach(function (node, col) {
            var resource;
...
var tslib_1 = __webpack_require__(1);
var fullcalendar_1 = __webpack_require__(0);
var EnhancedScroller_1 = __webpack_require__(38);
/*
...
var ClippedScroller = /** @class */ (function (_super) {
    ...
    */
    ...
    ClippedScroller.prototype.renderEl = function () {
        return fullcalendar_1.createElement('div', {
            className: 'fc-scroller-clip'
        }, _super.prototype.renderEl.call(this));
    };
    ClippedScroller.prototype.updateSize = function () {
        ...
        if ((this.isHScrollbarsClipped || (this.overflowX === 'hidden')) && // should never show?
    ...
    */
    ClippedScroller.prototype.getScrollbarWidths = function () {
        var widths = _super.prototype.getScrollbarWidths.call(this);
        if (this.isVScrollbarsClipped) {
            widths.left = 0;
            widths.right = 0;
        }
    ...
    */
    ScrollerCanvas.prototype.setGutters = function (gutters) {
        if (!gutters) {
            ...
            fullcalendar_1.assignTo(this.gutters, gutters);
        }
        this.updateSize();
    };
...
var ScrollFollower = /** @class */ (function () {
    ...
    */
    ...
    ScrollFollower.prototype.computeInnerRect = function (el) {
        var contentOffset = this.contentOffset;
        var rect = fullcalendar_1.computeInnerRect(el, true);
        return {
...
var ScrollFollowerSprite = /** @class */ (function () {
    ...
    */
    ...
    ScrollFollowerSprite.prototype.cacheDimensions = function () {
        ...
        var containerRect = (this.containerRect = joinRects(follower.computeInnerRect(parentEl), naturalRect));
    ...
    ScrollFollowerSprite.prototype.resetPosition = function () {
        fullcalendar_1.applyStyle(this.el, {
            top: '',
            left: ''
        });
    };
    ...
    ScrollFollowerSprite.prototype.assignPosition = function () {
        if (this.isEnabled) {
            if (!this.rect) { // completely offscreen?
                ...
                this.absolutize();
                fullcalendar_1.applyStyle(this.absoluteEl, {
                ...
                this.unabsolutize();
                fullcalendar_1.forceClassName(this.el, 'fc-following', top_1 || left);
                fullcalendar_1.applyStyle(this.el, {
                    top: top_1,
                    left: left
                });
    ...
    ScrollFollowerSprite.prototype.unabsolutize = function () {
        if (this.isAbsolute) {
            fullcalendar_1.removeElement(this.absoluteEl);
...
var TimelineHelperRenderer = /** @class */ (function (_super) {
    ...
    */
    TimelineHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        var helperContainerEl = fullcalendar_1.createElement('div', { className: 'fc-event-container fc-helper-container' });
...
var ResourceComponentFootprint_1 = __webpack_require__(5);
var ResourceViewMixin_1 = __webpack_require__(8);
var TimelineView_1 = __webpack_require__(13);
var Spreadsheet_1 = __webpack_require__(42);
var ResourceTimelineEventRenderer_1 = __webpack_require__(43);
var RowParent_1 = __webpack_require__(17);
var ResourceRow_1 = __webpack_require__(44);
var HRowGroup_1 = __webpack_require__(45);
var VRowGroup_1 = __webpack_require__(30);
var EventRow_1 = __webpack_require__(32);
var ResourceTimelineView = /** @class */ (function (_super) {
    ...
    ResourceTimelineView.prototype.renderSkeleton = function () {
        ...
        fullcalendar_1.removeElement(this.segContainerEl);
        this.segContainerEl = null;
        var timeBodyContainerEl = fullcalendar_1.htmlToElement("<div class=\"fc-rows\"> <table class=\"" + theme.getClass('tableGrid') + "\"> <tbody></tbody> </table> </div>");
    ...
    ResourceTimelineView.prototype.initDividerMoving = function () {
        ...
        this.dividerEls = fullcalendar_1.findElements(this.el, '.fc-divider');
        ...
        var dividerMousedown = this.dividerMousedown.bind(this);
    ...
    ResourceTimelineView.prototype.getNaturalDividerWidth = function () {
        var el = this.el.querySelector('.fc-resource-area');
    ...
    ResourceTimelineView.prototype.syncHeadHeights = function () {
        ...
        var headHeight = Math.max(this.spreadsheet.getHeadHeight(), this.getHeadHeight());
    ...
    ResourceTimelineView.prototype.queryResourceScroll = function () {
        var scroll = {};
        var scrollerTop = this.timeBodyScroller.scrollEl.getBoundingClientRect().top;
    ...
    ResourceTimelineView.prototype.applyResourceScroll = function (scroll) {
        if (scroll.resourceId) {
            ...
            if (row) {
                ...
                if (el) {
                    var innerTop = this.timeBodyScroller.canvas.el.getBoundingClientRect().top; // TODO: use -scrollHeight or something
                    var elBottom = el.getBoundingClientRect().bottom;
    ...
    ResourceTimelineView.prototype.scrollToResource = function (resource) {
        ...
        if (row) {
            ...
            if (el) {
                var innerTop = this.timeBodyScroller.canvas.el.getBoundingClientRect().top; // TODO: use -scrollHeight or something
                var scrollTop = el.getBoundingClientRect().top - innerTop;
                this.timeBodyScroller.setScrollTop(scrollTop);
                this.spreadsheet.bodyScroller.setScrollTop(scrollTop);
            }
        }
    ...
    ResourceTimelineView.prototype.prepareHits = function () {
        ...
        var trArray = shownEventRows.map(function (row) { return (row.getTr('event')); });
    ...
    ResourceTimelineView.prototype.descendantAdded = function (row) {
        this.setIsNesting(Boolean(this.nestingCnt += row.depth ? 1 : 0));
    };
    ResourceTimelineView.prototype.descendantRemoved = function (row) {
        this.setIsNesting(Boolean(this.nestingCnt -= row.depth ? 1 : 0));
    };
    ResourceTimelineView.prototype.setIsNesting = function (newIsNesting) {
        if (newIsNesting !== this.isNesting) {
            fullcalendar_1.forceClassName(this.el, 'fc-nested', newIsNesting);
            fullcalendar_1.forceClassName(this.el, 'fc-flat', !newIsNesting);
    ...
    ResourceTimelineView.prototype.syncRowHeights = function (visibleRows, safe) {
        ...
        if (!safe) {
            var h1 = this.spreadsheet.tbodyEl.offsetHeight;
            var h2 = this.timeBodyTbodyEl.offsetHeight;
            if (Math.abs(h1 - h2) > 1) {
...
var tslib_1 = __webpack_require__(1);
var fullcalendar_1 = __webpack_require__(0);
var RowGroup_1 = __webpack_require__(31);
/*
    ...
    */
    VRowGroup.prototype.renderRowspan = function () {
        ...
        if (this.rowSpan) { // takes up at least one row?
            ...
            if (!this.groupTd) {
                this.groupTd =
                    fullcalendar_1.createElement('td', { className: theme.getClass('widgetContent') }, this.renderGroupContentEl());
            }
            ...
            if (leadingTr !== this.leadingTr) {
                if (leadingTr) { // might not exist if child was unrendered before parent
                    fullcalendar_1.prependToElement(leadingTr, this.groupTd); // parents will later prepend their own
                }
            ...
            if (this.groupTd) {
                fullcalendar_1.removeElement(this.groupTd);
                this.groupTd = null;
            }
            this.leadingTr = null;
        }
...
var RowGroup = /** @class */ (function (_super) {
    ...
    */
    RowGroup.prototype.renderGroupContentEl = function () {
        var contentEl = fullcalendar_1.createElement('div', { className: 'fc-cell-content' }, this.renderGroupTextEl());
    ...
    */
    RowGroup.prototype.renderGroupTextEl = function () {
        ...
        var el = fullcalendar_1.createElement('span', { className: 'fc-cell-text' });
        el.innerText = text;
        return el;
    };
    return RowGroup;
...
var EventRow = /** @class */ (function (_super) {
    ...
    EventRow.prototype.renderEventSkeleton = function (tr) {
        var theme = this.view.calendar.theme;
        tr.innerHTML = "<td class=\"" + theme.getClass('widgetContent') + "\"> <div> <div class=\"fc-event-container\"></div> </div> </td>";
...
var schedulerVersion = '4.0.0-alpha.2';
...
Object.defineProperty(exports, "__esModule", { value: true });
var exportHooks = __webpack_require__(0);
var ResourceAgendaView_1 = __webpack_require__(19);
var ResourceBasicView_1 = __webpack_require__(21);
var ResourceMonthView_1 = __webpack_require__(22);
var TimelineView_1 = __webpack_require__(13);
var ResourceTimelineView_1 = __webpack_require__(29);
...
var EnhancedScroller = /** @class */ (function (_super) {
    ...
    EnhancedScroller.prototype.bindPreventTouchScroll = function () {
        if (!this.preventTouchScrollHandler) {
            this.scrollEl.addEventListener('touchmove', (this.preventTouchScrollHandler = fullcalendar_1.preventDefault));
        }
    };
    ...
    */
    EnhancedScroller.prototype.getScrollLeft = function () {
        var direction = window.getComputedStyle(this.scrollEl).direction;
        var node = this.scrollEl;
...
var Spreadsheet = /** @class */ (function () {
    ...
    Spreadsheet.prototype.renderSkeleton = function () {
        ...
        this.bodyScroller.canvas.contentEl.innerHTML = // colGroupHtml hack
            "<div class=\"fc-rows\"> <table class=\"" + theme.getClass('tableGrid') + "\">" + this.colGroupHtml + "<tbody></tbody> </table> </div>";
        ...
        this.headColEls = fullcalendar_1.findElements(this.headEl, 'col');
        this.headCellEls = fullcalendar_1.findElements(this.headScroller.canvas.contentEl, 'tr:last-child th');
        this.bodyColEls = fullcalendar_1.findElements(this.el, 'col');
    ...
    Spreadsheet.prototype.initColResizing = function () {
        var _this = this;
        fullcalendar_1.findElements(this.headEl, 'th .fc-col-resizer').forEach(function (resizerEl, i) {
    ...
    Spreadsheet.prototype.applyColWidths = function () {
        ...
        for (i = 0; i < cssWidths.length; i++) {
            cssWidth = cssWidths[i];
            fullcalendar_1.applyStyleProp(this.headColEls[i], 'width', cssWidth);
            fullcalendar_1.applyStyleProp(this.bodyColEls[i], 'width', cssWidth);
        }
    ...
    Spreadsheet.prototype.computeColMinWidths = function () {
        ...
        return this.givenColWidths.map(function (width, i) { return (typeof width === 'number' ?
            width :
            parseInt(window.getComputedStyle(_this.headColEls[i]).minWidth, 10) || COL_MIN_WIDTH); });
    };
    Spreadsheet.prototype.queryColWidths = function () {
        return this.headCellEls.map(function (node) { return (node.offsetWidth); });
    };
    // Sizing
    // ---------------------------------------------------------------------------------
    ...
    Spreadsheet.prototype.getHeadHeight = function () {
        // TODO: cache <table>
        return this.headScroller.canvas.contentEl.querySelector('table').offsetHeight;
    };
    Spreadsheet.prototype.setHeadHeight = function (h) {
        // TODO: cache <table>
        fullcalendar_1.applyStyleProp(this.headScroller.canvas.contentEl.querySelector('table'), 'height', h);
    };
    ...
    Spreadsheet.prototype.updateCellFollower = function () {
        ...
        for (var _i = 0, _a = this.view.rowHierarchy.getNodes(); _i < _a.length; _i++) {
            ...
            if (row instanceof VRowGroup_1.default) {
                if (row.groupTd) {
                    var cellContent = row.groupTd.querySelector('.fc-cell-content');
                    if (cellContent) {
    ...
    */
    ResourceRow.prototype.renderSpreadsheetSkeleton = function (tr) {
        ...
        for (var _i = 0, _a = this.view.colSpecs; _i < _a.length; _i++) {
            ...
            var td = fullcalendar_1.createElement('td', { className: theme.getClass('widgetContent') }, contentEl);
            // the first cell of the row needs to have an inner div for setTrInnerHeight
            if (colSpec.isMain) {
                td.appendChild(fullcalendar_1.createElement('div', null, td.childNodes) // inner wrap
                );
            }
            tr.appendChild(td);
        }
...
var HRowGroup = /** @class */ (function (_super) {
    ...
    */
    HRowGroup.prototype.renderSpreadsheetSkeleton = function (tr) {
        ...
        fullcalendar_1.prependToElement(contentEl, '<span class="fc-expander">' +
            '<span class="fc-icon"></span>' +
            '</span>');
        tr.appendChild(fullcalendar_1.createElement('td', {
            className: 'fc-divider',
            colSpan: this.view.colSpecs.length // span across all columns
        }, fullcalendar_1.createElement('div', null, contentEl)) // needed by setTrInnerHeight
        );
    };
    /*
    ...
    */
    HRowGroup.prototype.renderEventSkeleton = function (tr) {
        ...
        fullcalendar_1.appendToElement(tr, "  <td class=\"fc-divider\">   <div></div>  </td>  ");
        return tr;
    };
    return HRowGroup;
}(RowGroup_1.default));
...
var ResourceManager_1 = __webpack_require__(47);
var ResourceComponentFootprint_1 = __webpack_require__(5);
...
fullcalendar_1.Calendar.prototype.addResource = function (resourceInput, scroll) {
    ...
    this.resourceManager.addResource(resourceInput, function (resource) {
...
fullcalendar_1.Calendar.prototype.getResourceEvents = function (idOrResource) {
    var _this = this;
    var resource = (typeof idOrResource === 'object' && idOrResource) ? // non-null object
        idOrResource :
    ...
    if (resource) {
        ...
        return this.clientEvents(function (event) {
            return _this.getEventResourceIds(event).indexOf(resource.id) !== -1;
        });
    }
    else {
        return [];
...
fullcalendar_1.Calendar.prototype.getEventResources = function (idOrEvent) {
    var event = (typeof idOrEvent === 'object' && idOrEvent) ? // non-null object
        idOrEvent :
...
var ResourceManager = /** @class */ (function (_super) {
    ...
    function ResourceManager(calendar) {
        ...
        _this.fetchId = 0;
        _this.isFetchingInitiated = false;
        _this.isFetchingResolved = false;
    ...
    */
    ResourceManager.prototype.getResources = function (start, end, callback) {
    ...
    */
    ResourceManager.prototype.fetchResources = function (start, end, callback) {
        var _this = this;
        var currentFetchId = (this.fetchId += 1);
        this.isFetchingInitiated = true;
        this.isFetchingResolved = false;
        var callbacks = this.fetchingResourcesCallbacks = [callback];
        this.fetchResourceInputs(function (resourceInputs) {
            if (currentFetchId === _this.fetchId) {
                _this.setResources(resourceInputs);
                _this.isFetchingResolved = true;
                _this.fetchingResourcesCallbacks = null;
                fullcalendar_1.applyAll(callbacks, null, [_this.topLevelResources]);
            }
        }, start, end);
    };
    ResourceManager.prototype.whenFetchingResolved = function (callback) {
    ...
    */
    ResourceManager.prototype.fetchResourceInputs = function (callback, start, end) {
        ...
        if (Array.isArray(source)) {
            ...
            theRequest.end(function (error, res) {
                ...
                if (resourceInputs) {
                    var callbackRes = fullcalendar_1.applyAll(source.success, null, [resourceInputs, res]);
                    ...
                    fullcalendar_1.applyAll(source.error, null, [error, res]);
                    callback([]);
                }
            });
        }
    ...
    ResourceManager.prototype.addResource = function (resourceInput, callback) {
        var _this = this;
        if (this.isFetchingInitiated) {
            this.whenFetchingResolved(function () {
    ...
    ResourceManager.prototype.removeResource = function (idOrResource) {
        var _this = this;
        var id = (typeof idOrResource === 'object' && idOrResource) ? // non-null object
            idOrResource.id :
            idOrResource;
        if (this.isFetchingInitiated) {
            this.whenFetchingResolved(function () {
    ...
    ResourceManager.prototype.buildResource = function (resourceInput) {
        var _this = this;
        var resource = fullcalendar_1.assignTo({}, resourceInput);
...
Object.defineProperty(exports, "__esModule", { value: true });
var fullcalendar_1 = __webpack_require__(0);
var license_1 = __webpack_require__(51);
...
fullcalendar_1.View.prototype.watchResources = function () {
    ...
    this.watch('initialResources', initialDepNames, function (deps, callback) {
        _this.getInitialResources(deps.dateProfile, callback);
...
fullcalendar_1.View.prototype.getInitialResources = function (dateProfile, callback) {
    var calendar = this.calendar;
    if (dateProfile) {
        calendar.resourceManager.getResources(calendar.msToMoment(dateProfile.activeUnzonedRange.startMs, dateProfile.isRangeAllDay), calendar.msToMoment(dateProfile.activeUnzonedRange.endMs, dateProfile.isRangeAllDay), callback);
    }
    else {
...
var moment = __webpack_require__(14);
var core = __webpack_require__(0);
var RELEASE_DATE = '2018-04-13'; // for Scheduler
...
function isValidKey(key) {
    ...
    if (parts && (parts[1].length === 10)) {
        ...
        var releaseDate = moment.utc(core.mockSchedulerReleaseDate || RELEASE_DATE);
...
fullcalendar_1.EventDef.prototype.applyMiscProps = function (rawProps) {
    rawProps = fullcalendar_1.assignTo({}, rawProps); // clone, because of delete
