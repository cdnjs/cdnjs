	...
	var createField = function createField(_ref) {
	  ...
	  var Field = function (_Component) {
	    ...
	    _createClass(Field, [{
	      key: 'shouldComponentUpdate',
	      value: function shouldComponentUpdate(nextProps) {
	        var propsWithoutComponent = _extends({}, this.props);
	        var nextPropsWithoutComponent = _extends({}, nextProps);
	        delete propsWithoutComponent.component;
	        delete nextPropsWithoutComponent.component;
	        return (0, _reactAddonsShallowCompare2.default)({ props: propsWithoutComponent }, nextPropsWithoutComponent);
	      }
	    }, {
