...
/***/ function(module, exports) {
	...
	var createFieldArrayProps = function createFieldArrayProps(getIn, size, name, _ref, syncError) {
	  ...
	  var rest = _objectWithoutProperties(_ref, ["arrayInsert", "arrayMove", "arrayPop", "arrayPush", "arrayRemove", "arrayRemoveAll", "arrayShift", "arraySplice", "arraySwap", "arrayUnshift", "asyncError", "dirty", "pristine", "state", "submitError", "submitFailed", "value", "props"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noop2 = __webpack_require__(126);
	...
	var createFieldProps = function createFieldProps(getIn, name, _ref, syncError) {
	  ...
	  var rest = _objectWithoutProperties(_ref, ['asyncError', 'blur', 'change', 'dirty', 'focus', 'pristine', 'state', 'submitError', 'value', '_value', 'props']);
