...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setIn = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _es6Error = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.untouch = exports.touch = exports.swapArrayValues = exports.setSubmitFailed = exports.stopSubmit = exports.stopAsyncValidation = exports.startSubmit = exports.startAsyncValidation = exports.reset = exports.removeArrayValue = exports.initialize = exports.focus = exports.destroy = exports.change = exports.blur = exports.addArrayValue = undefined;
	...
	var setSubmitFailed = exports.setSubmitFailed = function setSubmitFailed() {
	  return { type: _actionTypes.SET_SUBMIT_FAILED };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isClass = __webpack_require__(49);
	...
	var _bindActionData = __webpack_require__(3);
	  ...
	  var ConnectedField = function (_Component) {
	    ...
	    _createClass(ConnectedField, [{
	      ...
	      value: function render() {
	        ...
	        return factory((0, _createFieldProps2.default)(getIn, name, props, this.syncError, initialValues && getIn(initialValues, name), defaultValue, asyncValidate));
	      }
	    }, {
	      key: 'syncError',
	      get: function get() {
	        ...
	        return _plain2.default.getIn(syncErrors, name);
	      }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFieldProps = function createFieldProps(getIn, name, _ref, syncError, initialPropValue) {
	  ...
	  var rest = _objectWithoutProperties(_ref, ['asyncError', 'blur', 'change', 'focus', 'initial', 'state', 'submitError', 'submitFailed', 'value', '_value']);

	  var defaultValue = arguments.length <= 5 || arguments[5] === undefined ? '' : arguments[5];
	  var asyncValidate = arguments.length <= 6 || arguments[6] === undefined ? _lodash4.default : arguments[6];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createReducer = function createReducer(structure) {
	  ...
	  var behaviors = (_behaviors = {}, _defineProperty(_behaviors, _actionTypes.ADD_ARRAY_VALUE, function (state) {
	    return state;
	  }), _defineProperty(_behaviors, _actionTypes.BLUR, function (state, _ref) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.CHANGE, function (state, _ref2) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.SET_SUBMIT_FAILED, function (state) {
	    var result = state;
	    result = setIn(result, 'submitFailed', true);
	    result = deleteIn(result, 'submitting');
	    return result;
	  ...
	  var byForm = function byForm(reducer) {
	    return function () {
	      ...
	      var result = reducer(formState, rest);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var formActions = _objectWithoutProperties(importedActions, ['blur', 'change', 'focus']);

	var getDisplayName = function getDisplayName(Comp) {
	  return Comp.displayName || Comp.name || 'Component';
	};
	var propsToUpdateFor = ['asyncValidating', 'dirty', 'error', 'invalid', 'pristine', 'submitting', 'submitFailed', 'syncErrors', 'valid'];
	        ...
	        _createClass(Form, [{
	          ...
	          value: function shouldComponentUpdate(nextProps) {
	            ...
	            return propsToUpdateFor.some(function (prop) {
	              return !_plain2.default.deepEqual(_this3.props[prop], nextProps[prop]);
	            });
	          }
	        }, {
	          key: 'register',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(62),
