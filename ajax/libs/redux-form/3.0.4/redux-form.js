	...
	var createHigherOrderComponent = function createHigherOrderComponent(config, isReactNative, React, WrappedComponent) {
	  ...
	  return function (reduxMountPoint, formName, formKey) {
	    ...
	    var decorate = formKey !== undefined && formKey !== null ? _reactRedux.connect(function (state) {
	      ...
	      return _extends({}, typeof mapDispatchToProps === 'function' ? mapDispatchToProps(dispatch, ownProps) : _redux.bindActionCreators(mapDispatchToProps, dispatch), _redux.bindActionCreators(_bindActionData2['default'](unboundActions, { form: formName, key: formKey }), dispatch), {
	        dispatch: dispatch
	      });
	      ...
	      return _extends({}, typeof mapDispatchToProps === 'function' ? mapDispatchToProps(dispatch, ownProps) : _redux.bindActionCreators(mapDispatchToProps, dispatch), _redux.bindActionCreators(_bindActionData2['default'](unboundActions, { form: formName }), dispatch), {
	        dispatch: dispatch
	      });
	    });
