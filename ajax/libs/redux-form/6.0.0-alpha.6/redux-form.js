...
/***/ function(module, exports, __webpack_require__) {
	...
	var setSubmitFailed = exports.setSubmitFailed = function setSubmitFailed() {
	  ...
	  return { type: _actionTypes.SET_SUBMIT_FAILED, fields: fields };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createReducer = function createReducer(structure) {
	  ...
	  var behaviors = (_behaviors = {}, _defineProperty(_behaviors, _actionTypes.ADD_ARRAY_VALUE, function (state) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.SET_SUBMIT_FAILED, function (state, _ref8) {
	    ...
	    return state;
	  }), _defineProperty(_behaviors, _actionTypes.TOUCH, function (state, _ref9) {
	    ...
	    result = setIn(result, 'anyTouched', true);
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.UNTOUCH, function (state, _ref10) {
