	          ...
	          value: function submit(submitOrEvent) {
	            ...
	            if (!submitOrEvent || (0, _silenceEvent2.default)(submitOrEvent)) {
	              ...
	              return (0, _silenceEvents2.default)(function () {
	                return !_this7.submitPromise && _this7.listenToSubmit((0, _handleSubmit2.default)(checkSubmit(submitOrEvent), _this7.props, _this7.isValid(), _this7.asyncValidate, _this7.getFieldList()));
	              });
	            }
	          }
	        }, {
