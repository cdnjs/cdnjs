	  ...
	  var ConnectedField = function (_Component) {
	    ...
	    _createClass(ConnectedField, [{
	      ...
	      value: function render() {
	        ...
	        var adapter = this.context._reduxForm.adapter;
	        ...
	        if (!element) {
	          element = (0, _react.createElement)(component, props);
	        }
	        return element;
	      }
	    }, {
...
/***/ function(module, exports) {
	...
	var createFieldArrayProps = function createFieldArrayProps(getIn, size, name, _ref, syncError) {
	  ...
	  var rest = _objectWithoutProperties(_ref, ["arrayInsert", "arrayPop", "arrayPush", "arrayRemove", "arrayShift", "arraySplice", "arraySwap", "arrayUnshift", "asyncError", "dirty", "pristine", "state", "submitError", "submitFailed", "value"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createReducer = function createReducer(structure) {
	  ...
	  var behaviors = (_behaviors = {}, _defineProperty(_behaviors, _actionTypes.ARRAY_INSERT, function (state, _ref) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.REGISTER_FIELD, function (state, _ref13) {
	    var _ref13$payload = _ref13.payload;
	    var name = _ref13$payload.name;
	    var type = _ref13$payload.type;
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.START_ASYNC_VALIDATION, function (state, _ref14) {
	    var field = _ref14.meta.field;

	    return setIn(state, 'asyncValidating', field || true);
	  }), _defineProperty(_behaviors, _actionTypes.START_SUBMIT, function (state) {
	    return setIn(state, 'submitting', true);
	  }), _defineProperty(_behaviors, _actionTypes.STOP_ASYNC_VALIDATION, function (state, _ref15) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.STOP_SUBMIT, function (state, _ref16) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.SET_SUBMIT_FAILED, function (state, _ref17) {
	    ...
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.TOUCH, function (state, _ref18) {
	    ...
	    result = setIn(result, 'anyTouched', true);
	    return result;
	  }), _defineProperty(_behaviors, _actionTypes.UNREGISTER_FIELD, function (state, _ref19) {
	    var name = _ref19.payload.name;
	  ...
	  }), _defineProperty(_behaviors, _actionTypes.UNTOUCH, function (state, _ref20) {
