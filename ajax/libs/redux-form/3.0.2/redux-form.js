...
/***/ function(module, exports, __webpack_require__) {
	...
	var createHigherOrderComponent = function createHigherOrderComponent(config, isReactNative, React, WrappedComponent) {
	  var mapStateToProps = arguments.length <= 4 || arguments[4] === undefined ? function () {
	    return {};
	  } : arguments[4];
	  var mapDispatchToProps = arguments.length <= 5 || arguments[5] === undefined ? function () {
	    return {};
	  } : arguments[5];
	  ...
	  return function (reduxMountPoint, formName, formKey) {
	    ...
	    var decorate = formKey !== undefined && formKey !== null ? _reactRedux.connect(function (state) {
	      ...
	      return _extends({}, typeof mapDispatchToProps === 'function' ? mapDispatchToProps(dispatch) : _redux.bindActionCreators(mapDispatchToProps, dispatch), _redux.bindActionCreators(_bindActionData2['default'](unboundActions, { form: formName, key: formKey }), dispatch), {
	        dispatch: dispatch
	      });
	      ...
	      return _extends({}, typeof mapDispatchToProps === 'function' ? mapDispatchToProps(dispatch) : _redux.bindActionCreators(mapDispatchToProps, dispatch), _redux.bindActionCreators(_bindActionData2['default'](unboundActions, { form: formName }), dispatch), {
	        dispatch: dispatch
	      });
	    });
	...
	var readFields = function readFields(props, myFields, asyncValidate, isReactNative) {
	  ...
	  var fieldObjects = fields.reduce(function (accumulator, name) {
	    ...
	    if (form._initializedAt) {
	      ...
	      var key = name + form._initializedAt;
	      if (field.key !== key) {
	        diff.key = key;
	      }
	    }
