...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bindActionCreatorsAndDispatch = __webpack_require__(3);

	var _bindActionCreatorsAndDispatch2 = _interopRequireDefault(_bindActionCreatorsAndDispatch);

	var _actions = __webpack_require__(2);

	exports['default'] = _reduxForm2['default'];
	exports.bindActionCreatorsAndDispatch = _bindActionCreatorsAndDispatch2['default'];
...
/***/ function(module, exports) {
	...
	exports["default"] = bindActionCreatorsAndDispatch;

	function bindActionCreatorsAndDispatch(actionCreators, dispatch) {
	  var _arguments = arguments;

	  var boundActionCreators = Object.keys(actionCreators).reduce(function (result, key) {
	    result[key] = function () {
	      return dispatch(actionCreators[key].apply(undefined, _arguments));
	    };
	    return result;
	  }, {});
	  return _extends({}, boundActionCreators, {
	    dispatch: dispatch
	  });
	}
