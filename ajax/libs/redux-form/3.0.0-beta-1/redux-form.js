	  ...
	  return function (WrappedComponent, mapDispatchToProps) {
	    ...
	    return (function (_Component) {
	      ...
	      ReduxFormConnector.prototype.render = function render() {
	        ...
	        var passableProps = _objectWithoutProperties(_props, ['reduxMountPoint', 'form', 'touchOnBlur', 'touchOnChange']);
	...
	var readFields = function readFields(props, myFields, asyncValidate, isReactNative) {
	  ...
	  return _extends({}, fields.reduce(function (accumulator, name) {
	    ...
	    if (field.name !== name) {
	      ...
	      if (!readonly) {
	        field.onBlur = _eventsCreateOnBlur2['default'](name, blur, isReactNative, asyncBlurFields.includes(name) && function (blurName, blurValue) {
