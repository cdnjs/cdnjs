...
/***/ function(module, exports, __webpack_require__) {
	...
	var readField = function readField(state, fieldName, pathToHere, fields, syncErrors, asyncValidate, isReactNative, props) {
	  ...
	  if (dotIndex > 0) {
	    ...
	    var previous = fields[key];
	    var result = readField(state[key] || {}, rest, nextPath, fields[key], syncErrors, asyncValidate, isReactNative, props, callback, nextPath);
	    if (result !== previous) {
	      var _extends2;

	      fields[key] = _extends({}, fields[key], (_extends2 = {}, _extends2[key] = result, _extends2));
	    }
	    return result;
	  }
