!function(global, factory) {
    ...
    function hook(obj, name, a, b, c) {
        var fn = obj[name];
        if (fn && fn.call) return fn.call(obj, a, b, c); else ;
    }
    ...
    function innerDiffNode(dom, vnode, context) {
        ...
        if (childrenLen > min) removeOrphanedChildren(dom, children);
    ...
    function recollectNodeTree(node, unmountOnly) {
        ...
        if (component) unmountComponent(node, component, !unmountOnly); else {
            ...
            if (c && c.length) removeOrphanedChildren(node, c, unmountOnly);
        }
    }
    ...
    function unmountComponent(dom, component, remove) {
        ...
        if (base) {
            ...
            removeOrphanedChildren(base, base.childNodes, !0);
        }
        if (remove) {
