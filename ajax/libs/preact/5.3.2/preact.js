!function(global, factory) {
    ...
    function setComponentProps(component, props, opts, context, mountAll) {
        ...
        if (empty(b) || mountAll) hook(component, 'componentWillMount'); else hook(component, 'componentWillReceiveProps', props, context);
    ...
    function renderComponent(component, opts, mountAll) {
        if (!component._disableRendering) {
            ...
            if (!isUpdate || mountAll) {
                ...
                if (!diffLevel) flushMounts();
            } else if (!skip) hook(component, 'componentDidUpdate', previousProps, previousState, previousContext);
