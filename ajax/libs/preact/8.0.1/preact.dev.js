    ...
    *	Benchmarks: https://esbench.com/bench/57ee8f8e330ab09900a1a1a0
        ...
        while (stack.length) {
            if ((child = stack.pop()) && child.pop !== undefined) {
                ...
                if (simple = typeof nodeName !== 'function') {
                    if (typeof child === 'number') child = String(child);else if (child === true || child === false || child == null) child = '';else if (typeof child !== 'string') simple = false;
                }
    ...
    function idiff(dom, vnode, context, mountAll, componentRoot) {
        ...
        var fc = out.firstChild,
            props = out['__preactattr_'] != null ? out['__preactattr_'] : out['__preactattr_'] = {},
