...
[],b=0;b<a.length;++b)m.push(d(a[b],b));return m}function k(a){return function(d){return a+"//"+d.toLowerCase()}}function f(){throw Error("algoliasearch: Not implemented in this environment.\nIf you feel this is a mistake, write to support@algolia.com");}function w(a,d){var b=a.toLowerCase().replace(".","").replace("()","");return"algoliasearch: `"+a+"` was replaced by `"+d+"`. Please see https://github.com/algolia/algoliasearch-client-js/wiki/Deprecated#"+b}function p(a,d){d(a,0)}function n(a,d){var b=
!1;return function(){b||(console.log(d),b=!0);return a.apply(this,arguments)}}l.exports=c;"development"===e.env.NODE_ENV&&g(5).enable("algoliasearch*");var r=g(5)("algoliasearch"),u=g(11);c.prototype={deleteIndex:function(a,d){return this._jsonRequest({method:"DELETE",url:"/1/indexes/"+encodeURIComponent(a),hostType:"write",callback:d})},moveIndex:function(a,d,b){d={operation:"move",destination:d};return this._jsonRequest({method:"POST",url:"/1/indexes/"+encodeURIComponent(a)+"/operation",body:d,
...
a[b].length;++f)c.push(a[b][f]);d.push("("+c.join(",")+")")}else d.push(a[b]);a=d.join(",")}this.securityTags=a},setUserToken:function(a){this.userToken=a},startQueriesBatch:n(function(){this._batch=[]},w("client.startQueriesBatch()","client.search()")),addQueryInBatch:n(function(a,d,b){this._batch.push({indexName:a,query:d,params:b})},w("client.addQueryInBatch()","client.search()")),clearCache:function(){this.cache={}},sendQueriesBatch:n(function(a){return this.search(this._batch,a)},w("client.sendQueriesBatch()",
...
"/keys",body:f,hostType:"write",callback:c})},addUserKeyWithValidity:n(function(a,b,c){return this.addUserKey(a,b,c)},w("index.addUserKeyWithValidity()","index.addUserKey()")),updateUserKey:function(a,b,c,f){if(2===arguments.length||"function"===typeof c)f=c,c=null;var e={acl:b};c&&(e.validity=c.validity,e.maxQueriesPerIPPerHour=c.maxQueriesPerIPPerHour,e.maxHitsPerQuery=c.maxHitsPerQuery);return this.as._jsonRequest({method:"PUT",url:"/1/indexes/"+encodeURIComponent(this.indexName)+"/keys/"+a,body:e,
...
v||a||(v=!0,u||(b.debug("JSONP: Fail. Script loaded but did not call the callback"),l(),e(Error("Failed to load JSONP script"))))}function g(){"loaded"!==this.readyState&&"complete"!==this.readyState||f()}function l(){clearTimeout(t);m.onload=null;m.onreadystatechange=null;m.onerror=null;d.removeChild(m);try{delete window[q],delete window[q+"_loaded"]}catch(a){window[q]=null,window[q+"_loaded"]=null}}function n(){b.debug("JSONP: Script timeout");a=!0;l();e(Error("Timeout - Could not connect to endpoint "+
c))}function r(){b.debug("JSONP: Script error");v||a||(l(),e(Error("Failed to load JSONP script")))}if("GET"!==b.method)e(Error("Method "+b.method+" "+c+" is not supported by JSONP."));else{b.debug("JSONP: start");var u=!1,a=!1;h+=1;var d=document.getElementsByTagName("head")[0],m=document.createElement("script"),q="algoliaJSONP_"+h,v=!1;window[q]=function(b){try{delete window[q]}catch(d){window[q]=void 0}a||(u=!0,l(),e(null,{body:b}))};c+="&callback="+q;b.jsonBody&&b.jsonBody.params&&(c+="&"+b.jsonBody.params);
var t=setTimeout(n,b.timeout);m.onreadystatechange=g;m.onload=f;m.onerror=r;m.async=!0;m.defer=!0;m.src=c;d.appendChild(m)}};var h=0},{}],15:[function(g,l,e){(function(e){var c=g(12),b=g(13),k=g(18),f=g(14);window.algoliasearch=g(16);e.angular.module("algoliasearch",[]).service("algolia",["$http","$q","$timeout",function(e,h,l){function r(a,b,c){var f=g(9),e=g(17);c=f(!0,{},c)||{};void 0===c.protocol&&(c.protocol=e());c._ua=r.ua;return new u(a,b,c)}function u(){b.apply(this,arguments)}r.version=g(19);
r.ua="Algolia for AngularJS "+r.version;c(u,b);u.prototype._request=function(a,b){var c=h.defer(),f=c.resolve,g=c.reject,t,r=b.body;a=k(a,b.headers);var u=h(function(c){l(function(){t=!0;c("test");f(Error("Timeout - Could not connect to endpoint "+a))},b.timeout)});e({url:a,method:b.method,data:r,cache:!1,timeout:u}).then(function(a){f({statusCode:a.status,body:a.data})},function(a){t||(0===a.status?g(Error("Network error")):f({body:a.data,statusCode:a.status}))});return c.promise};u.prototype._request.fallback=
function(a,b){a=k(a,b.headers);return h(function(c,e){f(a,b,function(a,b){a?e(a):c(b)})})};u.prototype._promise={reject:function(a){return h.reject(a)},resolve:function(a){return h.when(a)},delay:function(a){return h(function(b){l(b,a)})}};return{Client:function(a,b,c){return r(a,b,c)},ua:r.ua,version:r.version}}])}).call(this,"undefined"!==typeof global?global:"undefined"!==typeof self?self:"undefined"!==typeof window?window:{})},{12:12,13:13,14:14,16:16,17:17,18:18,19:19,9:9}],16:[function(g,l,
e){(function(e){function c(a,f,e){var h=g(9),k=g(17);e=h(!0,{},e)||{};void 0===e.protocol&&(e.protocol=k());e._ua=c.ua;return new b(a,f,e)}function b(){w.apply(this,arguments)}l.exports=c;var k=g(12),f=e.Promise||g(8).Promise,w=g(13),p=g(18),n=g(14);c.version=g(19);c.ua="Algolia for vanilla JavaScript "+c.version;var r="XDomainRequest"in window,u="withCredentials"in new XMLHttpRequest,a="timeout"in new XMLHttpRequest;k(b,w);b.prototype._request=function(b,c){return new f(function(e,f){function g(){if(!x){a||
clearTimeout(w);var b=null;try{b=JSON.parse(n.responseText)}catch(c){}e({body:b,statusCode:n.status})}}function h(b){x||(a||clearTimeout(w),f(Error("Could not connect to host, error was:"+b)))}function k(){a||(x=!0,n.abort());e(Error("Timeout - Could not connect to endpoint "+b))}if(u||r){b=p(b,c.headers);var l=c.body,n=u?new XMLHttpRequest:new XDomainRequest,w,x;n instanceof XMLHttpRequest?n.open(c.method,b,!0):n.open(c.method,b);u&&l&&"GET"!==c.method&&n.setRequestHeader("content-type","application/x-www-form-urlencoded");
n.onprogress=function(){};n.onload=g;n.onerror=h;a?(n.timeout=c.timeout,n.ontimeout=k):w=setTimeout(k,c.timeout);n.send(l)}else f(Error("CORS not supported"))})};b.prototype._request.fallback=function(a,b){a=p(a,b.headers);return new f(function(c,e){n(a,b,function(a,b){a?e(a):c(b)})})};b.prototype._promise={reject:function(a){return f.reject(a)},resolve:function(a){return f.resolve(a)},delay:function(a){return new f(function(b){setTimeout(b,a)})}}}).call(this,"undefined"!==typeof global?global:"undefined"!==
