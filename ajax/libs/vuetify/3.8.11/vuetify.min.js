...
const Ve=2.4,we=.2126729,Se=.7151522,ke=.072175,xe=.55,Ce=.58,Ne=.57,Ee=.62,Ie=.03,_e=1.45,Pe=5e-4,Be=1.25,Re=1.25,Ae=.078,Te=12.82051282051282,De=.06,Fe=.001
...
s=e>-Fe?0:e>-Ae?e-e*Te*De:e+De}return 100*s}function $e(e){t.warn(`Vuetify: ${e}`)}function Me(e){t.warn(`Vuetify error: ${e}`)}const Oe=.20689655172413793,Le=e=>e>Oe**3?Math.cbrt(e):e/(3*Oe**2)+4/29,je=e=>e>Oe?e**3:3*Oe**2*(e-4/29)
...
return(isNaN(a)||a<0||a>4294967295)&&$e(`'${e}' is not a valid hex(a) color`),ct(t)}if("object"==typeof e){if(S(e,["r","g","b"]))return e
...
return M(e?.aliasName||e?.name)}const wt=Symbol.for("vuetify:defaults")
...
t.provide(wt,t.computed((()=>i.value?z(e?.value??{},i.value):e?.value)))}}}function Ct(e){if(e._setup=e._setup??e.setup,!e.name)return $e("The component is missing an explicit name, unable to generate default prop value"),e
...
t.onMounted((()=>{w.value=!0})),t.provide(Zt,{register:(e,a)=>{let{id:c,order:d,position:f,layoutSize:g,elementSize:h,active:b,disableTransitions:S,absolute:k}=a
...
let c
return c=g(o)?t.mergeProps(u,function(e){const t=["checked","disabled"]
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const $l=ht({baseColor:String,divided:Boolean,...Vl(),...yt(),...Rl(),...Sl(),...vl(),...Pa(),...ba(),...Fl()},"VBtnGroup"),Ml=Nt()({name:"VBtnGroup",props:$l(),setup(e,a){let{slots:l}=a
...
t.onScopeDispose((()=>{e.disconnect()})),t.watch(o,((t,a)=>{a&&(e.unobserve(a),n.value=!1),t&&e.observe(t)}),{flush:"post"})}return{intersectionRef:o,isIntersecting:n}}const eo=ht({bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...yt(),...Kl(),...Pa({tag:"div"}),...ba()},"VProgressCircular"),to=Nt()({name:"VProgressCircular",props:eo(),setup(e,a){let{slots:l}=a
const o=2*Math.PI*20,n=t.ref(),{themeClasses:r}=Na(e),{sizeClasses:i,sizeStyles:s}=Xl(e),{textColorClasses:u,textColorStyles:c}=cl((()=>e.color)),{textColorClasses:d,textColorStyles:v}=cl((()=>e.bgColor)),{intersectionRef:p,isIntersecting:m}=Jl(),{resizeRef:g,contentRect:h}=Xt(),y=t.toRef((()=>R(parseFloat(e.modelValue),0,100))),b=t.toRef((()=>Number(e.width))),V=t.toRef((()=>s.value?Number(e.size):h.value?h.value.width:Math.max(b.value,32))),w=t.toRef((()=>20/(1-b.value/V.value)*2)),S=t.toRef((()=>b.value/V.value*w.value)),k=t.toRef((()=>f((100-y.value)/100*o)))
...
Ao(e,t,xo(t.oldValue))}},Fo=ht({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Ul},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ft,appendIcon:Ft,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},...Vl(),...yt(),...Rl(),...nl(),...Sl(),...Ll(),...io(),...lo(),...vo(),...vl(),...go(),...Kl(),...Pa({tag:"button"}),...ba(),...Fl({variant:"elevated"})},"VBtn"),zo=Nt()({name:"VBtn",props:Fo(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
const{themeClasses:o}=Na(e),{borderClasses:n}=wl(e),{colorClasses:r,colorStyles:i,variantClasses:s}=zl(e),{densityClasses:u}=Al(e),{roundedClasses:c}=pl(e),{sizeClasses:d,sizeStyles:v}=Xl(e)
...
return t.createVNode(Mn,t.mergeProps(a,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value,e.class],style:e.style}),{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),Hn=ht({activeClass:String,appendAvatar:String,appendIcon:Ft,baseColor:String,closable:Boolean,closeIcon:{type:Ft,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:Ft,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:Ft,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},modelValue:{type:Boolean,default:!0},onClick:G(),onClickOnce:G(),...Vl(),...yt(),...Rl(),...Sl(),...Ll(),...vl(),...go(),...Kl(),...Pa({tag:"span"}),...ba(),...Fl({variant:"tonal"})},"VChip"),Wn=Nt()({name:"VChip",directives:{vRipple:Do},props:Hn(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{t:r}=fa(),{borderClasses:i}=wl(e),{densityClasses:s}=Al(e),{elevationClasses:u}=kl(e),{roundedClasses:c}=pl(e),{sizeClasses:d}=Xl(e),{themeClasses:v}=Na(e),p=na(e,"modelValue"),m=jl(e,On,!1),f=fo(e,l),g=t.toRef((()=>!1!==e.link&&f.isLink.value)),h=t.computed((()=>!e.disabled&&!1!==e.link&&(!!m||e.link||f.isClickable.value))),y=t.toRef((()=>({"aria-label":r(e.closeLabel),disabled:e.disabled,onClick(e){e.preventDefault(),e.stopPropagation(),p.value=!1,o("click:close",e)}}))),{colorClasses:b,colorStyles:V,variantClasses:w}=zl((()=>({color:!m||m.isSelected.value?e.color??e.baseColor:e.baseColor,variant:e.variant})))
...
t.provide(ar,{...e,isGroupActivator:!0})})(),()=>l.default?.()}}),sr=ht({activeColor:String,baseColor:String,color:String,collapseIcon:{type:Ft,default:"$collapse"},expandIcon:{type:Ft,default:"$expand"},rawId:[String,Number],prependIcon:Ft,appendIcon:Ft,fluid:Boolean,subgroup:Boolean,title:String,value:null,...yt(),...Pa()},"VListGroup"),ur=Nt()({name:"VListGroup",props:sr(),setup(e,a){let{slots:l}=a
const{isOpen:o,open:n,id:r}=rr((()=>e.value),!0),i=t.computed((()=>`v-list-group--id-${String(e.rawId??r.value)}`)),s=Gn(),{isBooted:u}=Il()
...
const{themeClasses:I}=Na(e),{borderClasses:_}=wl(e),{colorClasses:P,colorStyles:B,variantClasses:R}=zl(N),{densityClasses:A}=Al(e),{dimensionStyles:T}=rl(e),{elevationClasses:D}=kl(e),{roundedClasses:F}=pl(x),z=t.toRef((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),$=t.computed((()=>({isActive:V.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
...
return o?t.createVNode(ur,t.mergeProps(u,{value:e.returnObject?i:n?.value,rawId:n?.value}),{activator:a=>{let{props:o}=a
const r={...n,...o,value:e.returnObject?i:n.value}
return l.header?l.header({props:r}):t.createVNode(mr,r,s)},default:()=>t.createVNode(Vr,{items:o,returnObject:e.returnObject},l)}):l.item?l.item({props:n}):t.createVNode(mr,t.mergeProps(n,{value:e.returnObject?i:n.value}),s)}))}}),wr=ht({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean,valueComparator:Function},"list-items")
function Sr(e,t){const a=p(t,e.itemTitle,t),l=p(t,e.itemValue,a),o=p(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?C(t,["children"]):t:p(t,e.itemProps)}
...
if(c&&"string"==typeof e){f.push(Sr(m,e))
continue}const t=r.get(e)
if(!v&&t)f.push(...t)
else{for(const t of v?i:s)if(p(e,t.value)){f.push(t)
continue e}f.push(Sr(m,e))}}return f},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{value:t}=e
return t}))}}}function Cr(e,t){const a=p(t,e.itemType,"item"),l=ne(t)?t:p(t,e.itemTitle),o=ne(t)?t:p(t,e.itemValue,void 0),n=p(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?C(t,["children"]):p(t,e.itemProps)}
...
return a}const Er=ht({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,expandIcon:Ft,collapseIcon:Ft,lines:{type:[Boolean,String],default:"one"},slim:Boolean,nav:Boolean,"onClick:open":G(),"onClick:select":G(),"onUpdate:opened":G(),...or({selectStrategy:"single-leaf",openStrategy:"list"}),...Vl(),...yt(),...Rl(),...nl(),...Sl(),itemType:{type:String,default:"type"},...wr(),...vl(),...Pa(),...ba(),...Fl({variant:"text"})},"VList"),Ir=Nt()({name:"VList",props:Er(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:o}=function(e){return{items:t.computed((()=>Nr(e,e.items)))}}(e),{themeClasses:n}=Na(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl((()=>e.bgColor)),{borderClasses:s}=wl(e),{densityClasses:u}=Al(e),{dimensionStyles:c}=rl(e),{elevationClasses:d}=kl(e),{roundedClasses:v}=pl(e),{children:p,open:m,parents:f,select:g,getPath:h}=nr(e),y=t.toRef((()=>e.lines?`v-list--${e.lines}-line`:void 0)),b=t.toRef((()=>e.activeColor)),V=t.toRef((()=>e.baseColor)),w=t.toRef((()=>e.color))
...
return Dt((()=>t.createVNode(fl,{transition:e.transition},{default:()=>[t.withDirectives(t.createElementVNode("div",{class:t.normalizeClass(["v-counter",{"text-error":e.max&&!e.disabled&&parseFloat(e.value)>parseFloat(e.max)},e.class]),style:t.normalizeStyle(e.style)},[l.default?l.default({counter:o.value,max:e.max,value:e.value}):o.value]),[[t.vShow,e.active]])]}))),{}}}),Vi=ht({floating:Boolean,...yt()},"VFieldLabel"),wi=Nt()({name:"VFieldLabel",props:Vi(),setup(e,a){let{slots:l}=a
return Dt((()=>t.createVNode(qo,{class:t.normalizeClass(["v-field-label",{"v-field-label--floating":e.floating},e.class]),style:t.normalizeStyle(e.style),"aria-hidden":e.floating||void 0},l))),{}}}),Si=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],ki=ht({appendInnerIcon:Ft,bgColor:String,clearable:Boolean,clearIcon:{type:Ft,default:"$clear"},active:Boolean,centerAffix:{type:Boolean,default:void 0},color:String,baseColor:String,dirty:Boolean,disabled:{type:Boolean,default:null},glow:Boolean,error:Boolean,flat:Boolean,iconColor:[Boolean,String],label:String,persistentClear:Boolean,prependInnerIcon:Ft,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Si.includes(e)},"onClick:clear":G(),"onClick:appendInner":G(),"onClick:prependInner":G(),...yt(),...io(),...vl(),...ba()},"VField"),xi=Nt()({name:"VField",inheritAttrs:!1,props:{id:String,...rn(),...ki()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return t.createVNode(xi,t.mergeProps({ref:f,onMousedown:b,onClick:V,"onClick:clear":a=>function(a,l){a.stopPropagation(),y(),t.nextTick((()=>{r.value=null,l(),K(e["onClick:clear"],a)}))}(a,p),"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:e.role},C,{id:l.value,active:h.value||s.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===v.value}),{...n,default:a=>{let{props:{class:l,...i}}=a
const s=t.withDirectives(t.createElementVNode("input",t.mergeProps({ref:g,value:r.value,onInput:w,autofocus:e.autofocus,readonly:d.value,disabled:o.value,name:e.name,placeholder:e.placeholder,size:1,type:e.type,onFocus:y,onBlur:u},i,S),null),[[hl,{handler:c},null,{once:!0}]])
return t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{class:"v-text-field__prefix"},[t.createElementVNode("span",{class:"v-text-field__prefix__text"},[e.prefix])]),n.default?t.createElementVNode("div",{class:t.normalizeClass(l),"data-no-activator":""},[n.default(),s]):t.cloneVNode(s,{class:l}),e.suffix&&t.createElementVNode("span",{class:"v-text-field__suffix"},[t.createElementVNode("span",{class:"v-text-field__suffix__text"},[e.suffix])])])}})},details:o?l=>t.createElementVNode(t.Fragment,null,[n.details?.(l),a&&t.createElementVNode(t.Fragment,null,[t.createElementVNode("span",null,null),t.createVNode(bi,{active:e.persistentCounter||i.value,value:d.value,max:v.value,disabled:e.disabled},n.counter)])]):void 0})})),fi({},m,f,g)}}),_i=ht({renderless:Boolean,...yt()},"VVirtualScrollItem"),Pi=Nt()({name:"VVirtualScrollItem",inheritAttrs:!1,props:_i(),emits:{"update:height":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{resizeRef:r,contentRect:i}=Xt(void 0,"border")
t.watch((()=>i.value?.height),(e=>{null!=e&&o("update:height",e)})),Dt((()=>e.renderless?t.createElementVNode(t.Fragment,null,[n.default?.({itemRef:r})]):t.createElementVNode("div",t.mergeProps({ref:r,class:["v-virtual-scroll__item",e.class],style:e.style},l),[n.default?.()])))}}),Bi=ht({itemHeight:{type:[Number,String],default:null},itemKey:{type:[String,Array,Function],default:null},height:[Number,String]},"virtual")
function Ri(e,l){const o=En(),n=t.shallowRef(0)
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Ai=ht({items:{type:Array,default:()=>[]},renderless:Boolean,...Bi(),...yt(),...nl()},"VVirtualScroll"),Ti=Nt()({name:"VVirtualScroll",props:Ai(),setup(e,a){let{slots:l}=a
const o=bt("VVirtualScroll"),{dimensionStyles:n}=rl(e),{calculateVisibleItems:r,containerRef:i,markerRef:s,handleScroll:u,handleScrollend:c,handleItemResize:d,scrollToIndex:v,paddingTop:p,paddingBottom:m,computedItems:g}=Ri(e,t.toRef((()=>e.items)))
...
i.value===document.documentElement?(document[e]("scroll",u,{passive:!0}),document[e]("scrollend",c)):(i.value?.[e]("scroll",u,{passive:!0}),i.value?.[e]("scrollend",c))}t.onMounted((()=>{i.value=Bt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),Dt((()=>{const a=g.value.map((a=>t.createVNode(Pi,{key:a.key,renderless:e.renderless,"onUpdate:height":e=>d(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
break}}}}}const Fi=ht({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Ft,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...wr({itemChildren:!1})},"Select"),zi=ht({...Fi(),...C(Ei({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...ml({transition:{component:Ma}})},"VSelect"),$i=Nt()({name:"VSelect",props:zi(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
...
let y,b="",V=-1
const w=t.computed((()=>e.hideSelected?u.value.filter((t=>!p.value.some((a=>(e.valueComparator||d)(a,t))))):u.value)),S=t.computed((()=>e.hideNoData&&!w.value.length||f.isReadonly.value||f.isDisabled.value)),k=na(e,"menu"),x=t.computed({get:()=>k.value,set:e=>{k.value&&!e&&i.value?.ΨopenChildren.size||e&&S.value||(k.value=e)}}),C=t.toRef((()=>x.value?e.closeText:e.openText)),N=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),E=t.ref(),I=Di(E,r)
...
return o.item?.({item:l,index:n,props:s})??t.createVNode(mr,t.mergeProps(s,{role:"option"}),{prepend:a=>{let{isSelected:o}=a
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(an,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,i.prependAvatar&&t.createVNode(Yo,{image:i.prependAvatar},null),i.prependIcon&&t.createVNode(Ql,{icon:i.prependIcon},null)])}})}}),o["append-item"]?.()]})]}),p.value.map(((l,n)=>{function r(e){e.stopPropagation(),e.preventDefault(),T(l,!1)}const i={"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},s=a?!!o.chip:!!o.selection,u=s?ae(a?o.chip({item:l,index:n,props:i}):o.selection({item:l,index:n})):void 0
...
return t.createElementVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Ql,{class:"v-select__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon},null):void 0])}})})),fi({isFocused:h,menu:x,select:T},r)}}),Mi=(e,t,a)=>{if(null==e||null==t)return-1
...
return n===l.length-1&&i.push(t.createElementVNode("span",{class:t.normalizeClass(`${e}__unmask`)},[a.slice(o[1])])),t.createElementVNode(t.Fragment,null,[i])})):a}const Wi=ht({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:Boolean,search:String,...Li({filterKeys:["title"]}),...Fi(),...C(Ei({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...ml({transition:!1})},"VAutocomplete"),Ui=Nt()({name:"VAutocomplete",props:Wi(),emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
...
return e.multiple?a:a[0]??null})),w=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:V.value.length)),S=dn(e),{filteredItems:k,getMatches:x}=ji(e,m,(()=>s.value?"":b.value)),C=t.computed((()=>e.hideSelected?k.value.filter((e=>!V.value.some((t=>t.value===e.value)))):k.value)),N=t.computed((()=>!(!e.chips&&!o.chip))),E=t.computed((()=>N.value||!!o.selection)),I=t.computed((()=>V.value.map((e=>e.props.value)))),_=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&b.value===C.value[0]?.title)&&C.value.length>0&&!s.value&&!u.value)),P=t.computed((()=>e.hideNoData&&!C.value.length||S.isReadonly.value||S.isDisabled.value)),R=na(e,"menu"),A=t.computed({get:()=>R.value,set:e=>{R.value&&!e&&c.value?.ΨopenChildren.size||e&&P.value||(R.value=e)}}),T=t.computed((()=>A.value?e.closeText:e.openText)),D=t.ref(),F=Di(D,r)
...
return t.createElementVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(an,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Yo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Ql,{icon:l.props.prependIcon},null)])},title:()=>s.value?l.title:Hi("v-autocomplete",l.title,x(l)?.title)})}}),o["append-item"]?.()]})]}),V.value.map(((a,l)=>{function n(e){e.stopPropagation(),e.preventDefault(),K(a,!1)}const r={"onClick:close":n,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),n(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=N.value?!!o.chip:!!o.selection,s=i?ae(N.value?o.chip({item:a,index:l,props:r}):o.selection({item:a,index:l})):void 0
...
return t.createVNode(ol,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})})),fi({},s)}}),ls=ht({inset:Boolean,...ts({transition:"bottom-sheet-transition"})},"VBottomSheet"),os=Nt()({name:"VBottomSheet",props:ls(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue")
return Dt((()=>{const a=as.filterProps(e)
return t.createVNode(as,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)})),{}}}),ns=ht({divider:[Number,String],...yt()},"VBreadcrumbsDivider"),rs=Nt()({name:"VBreadcrumbsDivider",props:ns(),setup(e,a){let{slots:l}=a
return Dt((()=>t.createElementVNode("li",{"aria-hidden":"true",class:t.normalizeClass(["v-breadcrumbs-divider",e.class]),style:t.normalizeStyle(e.style)},[l?.default?.()??e.divider]))),{}}}),is=ht({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...yt(),...go(),...Pa({tag:"li"})},"VBreadcrumbsItem"),ss=Nt()({name:"VBreadcrumbsItem",props:is(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createElementVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(ss,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(rs,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),ds=Nt()({name:"VCardActions",props:yt(),setup(e,a){let{slots:l}=a
return kt({VBtn:{slim:!0,variant:"text"}}),Dt((()=>t.createElementVNode("div",{class:t.normalizeClass(["v-card-actions",e.class]),style:t.normalizeStyle(e.style)},[l.default?.()]))),{}}}),vs=ht({opacity:[Number,String],...yt(),...Pa()},"VCardSubtitle"),ps=Nt()({name:"VCardSubtitle",props:vs(),setup(e,a){let{slots:l}=a
return Dt((()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-subtitle",e.class]),style:t.normalizeStyle([{"--v-card-subtitle-opacity":e.opacity},e.style])},l))),{}}}),ms=Et("v-card-title"),fs=ht({appendAvatar:String,appendIcon:Ft,prependAvatar:String,prependIcon:Ft,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...yt(),...Rl()},"VCardItem"),gs=Nt()({name:"VCardItem",props:fs(),setup(e,a){let{slots:l}=a
...
return t.createElementVNode("div",{class:t.normalizeClass(["v-card-item",e.class]),style:t.normalizeStyle(e.style)},[o&&t.createElementVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(ol,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Yo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Ql,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createElementVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(ms,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(ps,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createElementVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(ol,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ql,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Yo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),hs=ht({opacity:[Number,String],...yt(),...Pa()},"VCardText"),ys=Nt()({name:"VCardText",props:hs(),setup(e,a){let{slots:l}=a
return Dt((()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-text",e.class]),style:t.normalizeStyle([{"--v-card-text-opacity":e.opacity},e.style])},l))),{}}}),bs=ht({appendAvatar:String,appendIcon:Ft,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Ft,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...Vl(),...yt(),...Rl(),...nl(),...Sl(),...io(),...lo(),...vo(),...vl(),...go(),...Pa(),...ba(),...Fl({variant:"elevated"})},"VCard"),Vs=Nt()({name:"VCard",directives:{vRipple:Do},props:bs(),setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=Na(e),{borderClasses:r}=wl(e),{colorClasses:i,colorStyles:s,variantClasses:u}=zl(e),{densityClasses:c}=Al(e),{dimensionStyles:d}=rl(e),{elevationClasses:v}=kl(e),{loaderClasses:p}=so(e),{locationStyles:m}=oo(e),{positionClasses:f}=po(e),{roundedClasses:g}=pl(e),h=fo(e,l)
return Dt((()=>{const a=!1!==e.link&&h.isLink.value,l=!e.disabled&&!1!==e.link&&(e.link||h.isClickable.value),y=a?"a":e.tag,b=!(!o.title&&null==e.title),V=!(!o.subtitle&&null==e.subtitle),w=b||V,S=!!(o.append||e.appendAvatar||e.appendIcon),k=!!(o.prepend||e.prependAvatar||e.prependIcon),x=!(!o.image&&!e.image),C=w||k||S,N=!(!o.text&&null==e.text)
return t.withDirectives(t.createVNode(y,t.mergeProps({class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":l},n.value,r.value,i.value,c.value,v.value,p.value,f.value,g.value,u.value,e.class],style:[s.value,d.value,m.value,e.style],onClick:l&&h.navigate,tabindex:e.disabled?-1:void 0},h.linkProps),{default:()=>[x&&t.createElementVNode("div",{key:"image",class:"v-card__image"},[o.image?t.createVNode(ol,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},o.image):t.createVNode(bl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(uo,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),C&&t.createVNode(gs,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),N&&t.createVNode(ys,{key:"text"},{default:()=>[o.text?.()??e.text]}),o.default?.(),o.actions&&t.createVNode(ds,null,{default:o.actions}),Dl(l,"v-card")]}),[[Do,l&&e.ripple]])})),{}}}),ws=e=>{const{touchstartX:t,touchendX:a,touchstartY:l,touchendY:o}=e
...
w(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},xs=Symbol.for("vuetify:v-window"),Cs=Symbol.for("vuetify:v-window-group"),Ns=ht({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},...yt(),...Pa(),...ba()},"VWindow"),Es=Nt()({name:"VWindow",directives:{vTouch:ks},props:Ns(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=Na(e),{isRtl:n}=ha(),{t:r}=fa(),i=Hl(e,Cs),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),m=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
return Dt((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:t.normalizeClass(["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[t.createElementVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createElementVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[ks,V.value]]))),{group:i}}}),Is=ht({color:String,cycle:Boolean,delimiterIcon:{type:Ft,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...Ns({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),_s=Nt()({name:"VCarousel",props:Is(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue"),{t:n}=fa(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,Number(e.interval)>0?Number(e.interval):6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),Dt((()=>{const a=Es.filterProps(e)
...
return l.item?l.item({props:o,item:e}):t.createVNode(zo,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(ro,{absolute:!0,class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})})),{}}}),Ps=ht({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...yt(),...Ll(),...ei()},"VWindowItem"),Bs=Nt()({name:"VWindowItem",directives:{vTouch:ks},props:Ps(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(xs),n=jl(e,Cs),{isBooted:r}=Il()
...
return Dt((()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-edit",e.class]),style:t.normalizeStyle(e.style)},[n.value?.map((e=>t.createVNode(Ls,e,null))),o.value.length>1&&t.createVNode(zo,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
...
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const Us=ht({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...vl(),...Sl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),Ys=e=>{const a=t.computed((()=>parseFloat(e.min))),l=t.computed((()=>parseFloat(e.max))),o=t.computed((()=>Number(e.step)>0?parseFloat(e.step):0)),n=t.computed((()=>Math.max(A(o.value),A(a.value))))
...
return t.provide(Hs,j),j},qs=ht({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,...yt()},"VSliderThumb"),Ks=Nt()({name:"VSliderThumb",directives:{vRipple:Do},props:qs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(Hs),{isRtl:r,rtlClasses:i}=ha()
if(!n)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider")
const{min:s,max:u,thumbColor:c,step:d,disabled:v,thumbSize:p,thumbLabel:m,direction:g,isReversed:h,vertical:y,readonly:b,elevation:w,mousePressed:S,decimals:k,indexFromEnd:x}=n,C=t.computed((()=>v.value?void 0:w.value)),{elevationClasses:N}=kl(C),{textColorClasses:E,textColorStyles:I}=cl(c),{pageup:_,pagedown:P,end:B,home:R,left:A,right:T,down:D,up:F}=V,z=[_,P,B,R,A,T,D,F],$=t.computed((()=>d.value?[1,2,3]:[1,5,10]))
...
const au=ht({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]}))}(tu)},disabled:Boolean,color:Object,maxHeight:[Number,String],...yt()},"VColorPickerSwatches")
const lu=Ct({name:"VColorPickerSwatches",props:au(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return t.createElementVNode("div",{class:"v-color-picker-swatches__color",onClick:()=>n&&l("update:color",n)},[t.createElementVNode("div",{style:{background:r}},[e.color&&d(e.color,n)?t.createVNode(Ql,{size:"x-small",icon:"$success",color:ft(a,"#FFFFFF")>2?"white":"black"},null):void 0])])}))])))])]))),{}}}),ou=Et("v-picker-title"),nu=ht({color:String,...Vl(),...yt(),...nl(),...Sl(),...lo(),...vo(),...vl(),...Pa(),...ba()},"VSheet"),ru=Nt()({name:"VSheet",props:nu(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=Na(e),{backgroundColorClasses:n,backgroundColorStyles:r}=dl((()=>e.color)),{borderClasses:i}=wl(e),{dimensionStyles:s}=rl(e),{elevationClasses:u}=kl(e),{locationStyles:c}=oo(e),{positionClasses:d}=po(e),{roundedClasses:v}=pl(e)
return Dt((()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-sheet",o.value,n.value,i.value,u.value,d.value,v.value,e.class]),style:t.normalizeStyle([r.value,s.value,c.value,e.style])},l))),{}}}),iu=ht({bgColor:String,divided:Boolean,landscape:Boolean,title:String,hideHeader:Boolean,...nu()},"VPicker"),su=Nt()({name:"VPicker",props:iu(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl((()=>e.color))
return Dt((()=>{const a=ru.filterProps(e),r=!(!e.title&&!l.title)
...
default:return l.getTime()-o.getTime()}}function Su(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0)}function ku(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}class xu{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return mu(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
return t.onBeforeMount((()=>{e.modes.includes(o.value)||(o.value=e.modes[0])})),kt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Dt((()=>{const a=su.filterProps(e)
return t.createVNode(su,t.mergeProps(a,{class:["v-color-picker",s.value,e.class],style:[{"--v-color-picker-color-hsv":it({...i.value??Fs,a:1})},e.style]}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(Ds,{key:"canvas",color:i.value,"onUpdate:color":c,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createElementVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(eu,{key:"preview",color:i.value,"onUpdate:color":c,hideAlpha:!o.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(js,{key:"edit",modes:e.modes,mode:o.value,"onUpdate:mode":e=>o.value=e,color:i.value,"onUpdate:color":c,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(lu,{key:"swatches",color:i.value,"onUpdate:color":c,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)])})})),{}}}),Pu=ht({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...Li({filterKeys:["title"]}),...Fi({hideNoData:!0,returnObject:!0}),...C(Ei({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...ml({transition:!1})},"VCombobox"),Bu=Nt()({name:"VCombobox",props:Pu(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
const{t:r}=fa(),i=t.ref(),s=t.shallowRef(!1),u=t.shallowRef(!0),c=t.shallowRef(!1),v=t.ref(),p=t.ref(),m=t.shallowRef(-1)
let f=!1
const{items:g,transformIn:h,transformOut:y}=xr(e),{textColorClasses:b,textColorStyles:V}=cl((()=>i.value?.color)),w=na(e,"modelValue",[],(e=>h(B(e))),(t=>{const a=y(t)
return e.multiple?a:a[0]??null})),S=dn(e),k=t.computed((()=>!(!e.chips&&!n.chip))),x=t.computed((()=>k.value||!!n.selection)),C=t.shallowRef(e.multiple||x.value?"":w.value[0]?.title??""),N=t.computed({get:()=>C.value,set:t=>{if(C.value=t??"",e.multiple||x.value||(w.value=[Sr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&q(Sr(e,t))})),C.value="")}t||(m.value=-1),u.value=!t}}),E=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(w.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?w.value.length:N.value.length)),{filteredItems:I,getMatches:P}=ji(e,g,(()=>u.value?"":N.value)),R=t.computed((()=>e.hideSelected?I.value.filter((e=>!w.value.some((t=>t.value===e.value)))):I.value)),A=t.computed((()=>e.hideNoData&&!R.value.length||S.isReadonly.value||S.isDisabled.value)),T=na(e,"menu"),D=t.computed({get:()=>T.value,set:e=>{T.value&&!e&&v.value?.ΨopenChildren.size||e&&A.value||(T.value=e)}}),F=t.toRef((()=>D.value?e.closeText:e.openText))
...
return t===R.value[0].value}))&&q(I.value[0]),u.value=!0),"ArrowDown"===t.key&&$.value&&M.value?.focus("next"),"Enter"===t.key&&N.value&&(q(Sr(e,N.value)),x.value&&(C.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&x.value&&w.value.length>0&&!N.value)return q(w.value[0],!1)
...
return Dt((()=>t.createElementVNode(t.Fragment,null,[o.default?.({model:r,save:p,cancel:m,isPristine:s.value,get actions(){return g=!0,f}}),!e.hideActions&&!g&&f()]))),{save:p,cancel:m,isPristine:s}}}),Tu=ht({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Du=Symbol.for("vuetify:datatable:expanded")
function Fu(e){const a=t.toRef((()=>e.expandOnClick)),l=na(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return t.provide(Du,r),r}function zu(){const e=t.inject(Du)
if(!e)throw new Error("foo")
return e}const $u=ht({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Mu=Symbol.for("vuetify:data-table-group")
function Ou(e){return{groupBy:na(e,"groupBy")}}function Lu(e){const{disableSort:a,groupBy:l,sortBy:o}=e,n=t.ref(new Set)
...
return t.provide(Mu,i),i}function ju(){const e=t.inject(Mu)
if(!e)throw new Error("Missing group!")
return e}function Hu(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
...
n.push({depth:a,id:s,key:i,value:o,items:r.length?Hu(e,r,a+1,s):e,type:"group"})})),n}function Wu(e,t){const a=[]
for(const l of e)"type"in l&&"group"===l.type?(null!=l.value&&a.push(l),(t.has(l.id)||null==l.value)&&a.push(...Wu(l.items,t))):a.push(l)
return a}function Uu(e,a,l){return{flatItems:t.computed((()=>{if(!a.value.length)return e.value
return Wu(Hu(e.value,a.value.map((e=>e.key))),l.value)}))}}function Yu(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
const i=bt("VDataTable")
let s=null
t.watch((()=>({page:a.value,itemsPerPage:l.value,sortBy:o.value,groupBy:n.value,search:r.value})),(e=>{d(s,e)||(s&&s.search!==e.search&&(a.value=1),i.emit("update:options",e),s=e)}),{deep:!0,immediate:!0})}const Gu=ht({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),qu=Symbol.for("vuetify:data-table-pagination")
function Ku(e){return{page:na(e,"page",void 0,(e=>Number(e??1))),itemsPerPage:na(e,"itemsPerPage",void 0,(e=>Number(e??10)))}}function Xu(e){const{page:a,itemsPerPage:l,itemsLength:o}=e,n=t.computed((()=>-1===l.value?0:l.value*(a.value-1))),r=t.computed((()=>-1===l.value?o.value:Math.min(o.value,n.value+l.value))),i=t.computed((()=>-1===l.value||0===o.value?1:Math.ceil(o.value/l.value)))
...
return t.provide(qu,s),s}function Zu(e){const a=bt("usePaginatedItems"),{items:l,startIndex:o,stopIndex:n,itemsPerPage:r}=e,i=t.computed((()=>r.value<=0?l.value:l.value.slice(o.value,n.value)))
return t.watch(i,(e=>{a.emit("update:currentItems",e)}),{immediate:!0}),{paginatedItems:i}}const Qu={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},Ju={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return Ju.select({items:a,value:t,selected:l})}},ec={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a,selected:l}=e
return ec.select({items:a,value:t,selected:l})}},tc=ht({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:{type:Function,default:d}},"DataTable-select"),ac=Symbol.for("vuetify:data-table-selection")
function lc(e,a){let{allItems:l,currentPage:o}=a
...
switch(e.selectStrategy){case"single":return Qu
case"all":return ec
default:return Ju}})),u=t.shallowRef(null)
...
return t.provide(ac,m),m}function oc(){const e=t.inject(ac)
if(!e)throw new Error("Missing selection!")
return e}const nc=ht({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),rc=Symbol.for("vuetify:data-table-sort")
function ic(e){return{sortBy:na(e,"sortBy"),mustSort:t.toRef((()=>e.mustSort)),multiSort:t.toRef((()=>e.multiSort))}}function sc(e){const{sortBy:a,mustSort:l,multiSort:o,page:n}=e
...
return t.provide(rc,r),r}function uc(){const e=t.inject(rc)
if(!e)throw new Error("Missing sort!")
return e}function cc(e,a,l,o){const n=fa(),r=t.computed((()=>l.value.length?function(e,t,a,l){const o=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),n=e.map((e=>[e,l?.transform?l.transform(e):e]))
...
return{sortedItems:r}}const dc=ht({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function vc(e,t){return{type:"item",value:e.returnObject?t:p(t,e.itemValue),selectable:p(t,e.itemSelectable,!0),raw:t}}function pc(e){const a=t.computed((()=>function(e,t){const a=[]
for(const l of t)a.push(vc(e,l))
return a}(e,e.items)))
return{items:a}}const mc=ht({search:String,loading:Boolean,...yt(),...dc(),...tc(),...nc(),...Gu({itemsPerPage:5}),...Tu(),...$u(),...Li(),...Pa(),...ml({transition:{component:Ua,hideOnLeave:!0}})},"VDataIterator"),fc=Nt()({name:"VDataIterator",props:mc(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"groupBy"),n=t.toRef((()=>e.search)),{items:r}=pc(e),{filteredItems:i}=ji(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=ic(e),{page:d,itemsPerPage:v}=Ku(e),{toggleSort:p}=sc({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:m,opened:f,extractRows:g,isGroupOpen:h,toggleGroup:y}=Lu({groupBy:o,sortBy:s}),{sortedItems:b}=cc(e,i,m,{transform:e=>e.raw}),{flatItems:V}=Uu(b,o,f),w=t.toRef((()=>V.value.length)),{startIndex:S,stopIndex:k,pageCount:x,prevPage:C,nextPage:N,setItemsPerPage:E,setPage:I}=Xu({page:d,itemsPerPage:v,itemsLength:w}),{paginatedItems:_}=Zu({items:V,startIndex:S,stopIndex:k,itemsPerPage:v}),P=t.computed((()=>g(_.value))),{isSelected:B,select:R,selectAll:A,toggleSelect:T}=lc(e,{allItems:r,currentPage:P}),{isExpanded:D,toggleExpand:F}=Fu(e)
Yu({page:d,itemsPerPage:v,sortBy:s,groupBy:o,search:n})
...
if(e.children)for(const a of e.children)Ec(a,t)
else t.push(e)
return t}function Ic(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Set
for(const a of e)a.key&&t.add(a.key),a.children&&Ic(a.children,t)
return t}function _c(e){if(e.key)return"data-table-group"===e.key?Cc:["data-table-expand","data-table-select"].includes(e.key)?Nc:void 0}function Pc(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
return e.children?Math.max(t,...e.children.map((e=>Pc(e,t+1)))):t}function Bc(e,t){const a=[]
let l=0
...
if(n.push({...a,rowspan:s??1,colspan:a.children?Ec(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
o.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(n)}return{columns:e.map((e=>Ec(e))).flat(),headers:a}}function Rc(e){const t=[]
for(const a of e){const e={..._c(a),...a},l=e.key??("string"==typeof e.value?e.value:null),o=e.value??l??null,n={...e,key:l,value:o,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?Rc(e.children):void 0}
t.push(n)}return t}function Ac(e,a){const l=t.ref([]),o=t.ref([]),n=t.ref({}),r=t.ref({}),i=t.ref({})
t.watchEffect((()=>{const s=(e.headers||Object.keys(e.items[0]??{}).map((e=>({key:e,title:t.capitalize(e)})))).slice(),u=Ic(s)
...
const d=Math.max(...c.map((e=>Pc(e))))+1,v=Bc(c,d)
...
return t.provide(xc,s),s}function Tc(){const e=t.inject(xc)
if(!e)throw new Error("Missing headers!")
return e}const Dc=ht({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Ft,default:"$sortAsc"},sortDescIcon:{type:Ft,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Nn(),...io()},"VDataTableHeaders"),Fc=Nt()({name:"VDataTableHeaders",props:Dc(),setup(e,a){let{slots:l}=a
const{t:o}=fa(),{toggleSort:n,sortBy:r,isSorted:i}=uc(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=oc(),{columns:v,headers:p}=Tc(),{loaderClasses:m}=so(e)
...
const{isGroupOpen:o,toggleGroup:n,extractRows:r}=ju(),{isSelected:i,isSomeSelected:s,select:u}=oc(),{columns:c}=Tc(),d=t.computed((()=>r([e.item])))
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(Vc,{class:"v-data-table-group-header-row__column"},{default:()=>[t.createVNode(zo,{size:"small",variant:"text",icon:a,onClick:r},null),t.createElementVNode("span",null,[e.item.value]),t.createElementVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const e=i(d.value),a=s(d.value)&&!e,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createElementVNode("td",null,[t.createVNode(an,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createElementVNode("td",null,null)}))])}}),Mc=ht({index:Number,item:Object,cellProps:[Object,Function],onClick:G(),onContextmenu:G(),onDblclick:G(),...Nn()},"VDataTableRow"),Oc=Nt()({name:"VDataTableRow",props:Mc(),setup(e,a){let{slots:l}=a
const{displayClasses:o,mobile:n}=En(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=oc(),{isExpanded:d,toggleExpand:p}=zu(),{toggleSort:m,sortBy:f,isSorted:g}=uc(),{columns:h}=Tc()
...
return t.createVNode(Vc,t.mergeProps({align:a.align,class:{"v-data-table__td--expanded-row":"data-table-expand"===a.key,"v-data-table__td--select-row":"data-table-select"===a.key},fixed:a.fixed,fixedOffset:a.fixedOffset,lastFixed:a.lastFixed,maxWidth:n.value?void 0:a.maxWidth,noPadding:"data-table-select"===a.key||"data-table-expand"===a.key,nowrap:a.nowrap,width:n.value?void 0:a.width},S,k),{default:()=>{if("data-table-select"===a.key)return l["item.data-table-select"]?.({...V,props:{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((()=>i(h)),["stop"])}})??t.createVNode(an,{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((t=>i(h,e.index,t)),["stop"])},null)
...
return n.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??o])]):o}})}))])))}}),Lc=ht({loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...Nn()},"VDataTableRows"),jc=Nt()({name:"VDataTableRows",inheritAttrs:!1,props:Lc(),setup(e,a){let{attrs:l,slots:o}=a
const{columns:n}=Tc(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=zu(),{isSelected:u,toggleSelect:c}=oc(),{toggleGroup:d,isGroupOpen:v}=ju(),{t:p}=fa(),{mobile:m}=En(e)
...
return{type:"item",key:e.returnObject?p(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function Gc(e,a){return{items:t.computed((()=>Yc(e,e.items,a.value)))}}const qc=ht({...Lc(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Tu(),...$u(),...kc(),...Uc(),...tc(),...nc(),...Dc(),...Hc()},"DataTable"),Kc=ht({...Gu(),...qc(),...Li(),...yc()},"VDataTable"),Xc=Nt()({name:"VDataTable",props:Kc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Ou(e),{sortBy:r,multiSort:i,mustSort:s}=ic(e),{page:u,itemsPerPage:c}=Ku(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:m,sortRawFunctions:f,filterFunctions:g}=Ac(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:h}=Gc(e,v),y=t.toRef((()=>e.search)),{filteredItems:b}=ji(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=sc({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:x,toggleGroup:C}=Lu({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:N}=cc(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:m,sortRawFunctions:f}),{flatItems:E}=Uu(N,n,S),I=t.computed((()=>E.value.length)),{startIndex:_,stopIndex:P,pageCount:B,setItemsPerPage:R}=Xu({page:u,itemsPerPage:c,itemsLength:I}),{paginatedItems:A}=Zu({items:E,startIndex:_,stopIndex:P,itemsPerPage:c}),T=t.computed((()=>k(A.value))),{isSelected:D,select:F,selectAll:z,toggleSelect:$,someSelected:M,allSelected:O}=lc(e,{allItems:h,currentPage:T}),{isExpanded:L,toggleExpand:j}=Fu(e)
Yu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
return Dt((()=>{const a=bc.filterProps(e),n=Fc.filterProps(e),r=jc.filterProps(e),i=Wc.filterProps(e)
return t.createVNode(Wc,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(H.value),default:()=>o.default?o.default(H.value):t.createElementVNode(t.Fragment,null,[o.colgroup?.(H.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(Fc,n,o)]),o.thead?.(H.value),!e.hideDefaultBody&&t.createElementVNode("tbody",null,[o["body.prepend"]?.(H.value),o.body?o.body(H.value):t.createVNode(jc,t.mergeProps(l,r,{items:A.value}),o),o["body.append"]?.(H.value)]),o.tbody?.(H.value),o.tfoot?.(H.value)]),bottom:()=>o.bottom?o.bottom(H.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(yr,null,null),t.createVNode(bc,a,{prepend:o["footer.prepend"]})])})})),{}}}),Zc=ht({...C(qc(),["hideDefaultFooter"]),...$u(),...Bi(),...Li()},"VDataTableVirtual"),Qc=Nt()({name:"VDataTableVirtual",props:Zc(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Ou(e),{sortBy:r,multiSort:i,mustSort:s}=ic(e),{disableSort:u}=t.toRefs(e),{columns:c,headers:d,filterFunctions:v,sortFunctions:p,sortRawFunctions:m}=Ac(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:g}=Gc(e,c),h=t.toRef((()=>e.search)),{filteredItems:y}=ji(e,g,h,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:b}=sc({sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:V,opened:w,extractRows:S,isGroupOpen:k,toggleGroup:x}=Lu({groupBy:n,sortBy:r,disableSort:u}),{sortedItems:C}=cc(e,y,V,{transform:e=>({...e.raw,...e.columns}),sortFunctions:p,sortRawFunctions:m}),{flatItems:N}=Uu(C,n,w),E=t.computed((()=>S(N.value))),{isSelected:I,select:_,selectAll:P,toggleSelect:B,someSelected:R,allSelected:A}=lc(e,{allItems:E,currentPage:E}),{isExpanded:T,toggleExpand:D}=Fu(e),{containerRef:F,markerRef:z,paddingTop:$,paddingBottom:M,computedItems:O,handleItemResize:L,handleScroll:j,handleScrollend:H,calculateVisibleItems:W,scrollToIndex:U}=Ri(e,N),Y=t.computed((()=>O.value.map((e=>e.raw))))
Yu({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
return Dt((()=>{const a=Fc.filterProps(e),n=jc.filterProps(e),r=Wc.filterProps(e)
return t.createVNode(Wc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(G.value),wrapper:()=>t.createElementVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createElementVNode("table",null,[o.colgroup?.(G.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(Fc,a,o)]),o.thead?.(G.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{key:"tbody"},[t.createElementVNode("tr",{ref:z,style:{height:f($.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(G.value),t.createVNode(jc,t.mergeProps(l,n,{items:Y.value}),{...o,item:e=>t.createVNode(Pi,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>L(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Oc,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(G.value),t.createElementVNode("tr",{style:{height:f(M.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])]),o.tbody?.(G.value),o.tfoot?.(G.value)])]),bottom:()=>o.bottom?.(G.value)})})),{calculateVisibleItems:W,scrollToIndex:U}}}),Jc=ht({itemsLength:{type:[Number,String],required:!0},...Gu(),...qc(),...yc()},"VDataTableServer"),ed=Nt()({name:"VDataTableServer",props:Jc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Ou(e),{sortBy:r,multiSort:i,mustSort:s}=ic(e),{page:u,itemsPerPage:c}=Ku(e),{disableSort:d}=t.toRefs(e),v=t.computed((()=>parseInt(e.itemsLength,10))),{columns:p,headers:m}=Ac(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:f}=Gc(e,p),{toggleSort:g}=sc({sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:h,isGroupOpen:y,toggleGroup:b,extractRows:V}=Lu({groupBy:n,sortBy:r,disableSort:d}),{pageCount:w,setItemsPerPage:S}=Xu({page:u,itemsPerPage:c,itemsLength:v}),{flatItems:k}=Uu(f,n,h),{isSelected:x,select:C,selectAll:N,toggleSelect:E,someSelected:I,allSelected:_}=lc(e,{allItems:f,currentPage:f}),{isExpanded:P,toggleExpand:B}=Fu(e),R=t.computed((()=>V(f.value)))
Yu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef((()=>e.search))}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
Dt((()=>{const a=bc.filterProps(e),n=Fc.filterProps(e),r=jc.filterProps(e),i=Wc.filterProps(e)
return t.createVNode(Wc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(A.value),default:()=>o.default?o.default(A.value):t.createElementVNode(t.Fragment,null,[o.colgroup?.(A.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Fc,n,o)]),o.thead?.(A.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(A.value),o.body?o.body(A.value):t.createVNode(jc,t.mergeProps(l,r,{items:k.value}),o),o["body.append"]?.(A.value)]),o.tbody?.(A.value),o.tfoot?.(A.value)]),bottom:()=>o.bottom?o.bottom(A.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(yr,null,null),t.createVNode(bc,a,{prepend:o["footer.prepend"]})])})}))}}),td=ht({fluid:{type:Boolean,default:!1},...yt(),...nl(),...Pa()},"VContainer"),ad=Nt()({name:"VContainer",props:td(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ha(),{dimensionStyles:n}=rl(e)
return Dt((()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-container",{"v-container--fluid":e.fluid},o.value,e.class]),style:t.normalizeStyle([n.value,e.style])},l))),{}}}),ld=bn.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),od=bn.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),nd=bn.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),rd={col:Object.keys(ld),offset:Object.keys(od),order:Object.keys(nd)}
function id(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const sd=["auto","start","end","center","baseline","stretch"],ud=ht({cols:{type:[Boolean,String,Number],default:!1},...ld,offset:{type:[String,Number],default:null},...od,order:{type:[String,Number],default:null},...nd,alignSelf:{type:String,default:null,validator:e=>sd.includes(e)},...yt(),...Pa()},"VCol"),cd=Nt()({name:"VCol",props:ud(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in rd)rd[a].forEach((l=>{const o=e[l],n=id(a,l,o)
n&&t.push(n)}))
const l=t.some((e=>e.startsWith("v-col-")))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t}))
return()=>t.h(e.tag,{class:[o.value,e.class],style:e.style},l.default?.())}}),dd=["start","end","center"],vd=["space-between","space-around","space-evenly"]
function pd(e,a){return bn.reduce(((l,o)=>(l[e+t.capitalize(o)]=a(),l)),{})}const md=[...dd,"baseline","stretch"],fd=e=>md.includes(e),gd=pd("align",(()=>({type:String,default:null,validator:fd}))),hd=[...dd,...vd],yd=e=>hd.includes(e),bd=pd("justify",(()=>({type:String,default:null,validator:yd}))),Vd=[...dd,...vd,"stretch"],wd=e=>Vd.includes(e),Sd=pd("alignContent",(()=>({type:String,default:null,validator:wd}))),kd={align:Object.keys(gd),justify:Object.keys(bd),alignContent:Object.keys(Sd)},xd={align:"align",justify:"justify",alignContent:"align-content"}
function Cd(e,t,a){let l=xd[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const Nd=ht({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:fd},...gd,justify:{type:String,default:null,validator:yd},...bd,alignContent:{type:String,default:null,validator:wd},...Sd,...yt(),...Pa()},"VRow"),Ed=Nt()({name:"VRow",props:Nd(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in kd)kd[a].forEach((l=>{const o=e[l],n=Cd(a,l,o)
n&&t.push(n)}))
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t}))
return()=>t.h(e.tag,{class:["v-row",o.value,e.class],style:e.style},l.default?.())}}),Id=Et("v-spacer","div","VSpacer"),_d=ht({active:{type:[String,Array],default:void 0},controlHeight:[Number,String],disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Ft,default:"$next"},prevIcon:{type:Ft,default:"$prev"},modeIcon:{type:Ft,default:"$subgroup"},text:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),Pd=Nt()({name:"VDatePickerControls",props:_d(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:text":()=>!0},setup(e,a){let{emit:l}=a
...
function s(){l("click:prev")}function u(){l("click:next")}function c(){l("click:year")}function d(){l("click:month")}return Dt((()=>t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-controls"]),style:{"--v-date-picker-controls-height":f(e.controlHeight)}},[t.createVNode(zo,{class:"v-date-picker-controls__month-btn","data-testid":"month-btn",disabled:o.value,text:e.text,variant:"text",rounded:!0,onClick:d},null),t.createVNode(zo,{class:"v-date-picker-controls__mode-btn","data-testid":"year-btn",disabled:n.value,density:"comfortable",icon:e.modeIcon,variant:"text",onClick:c},null),t.createVNode(Id,null,null),t.createElementVNode("div",{class:"v-date-picker-controls__month"},[t.createVNode(zo,{"data-testid":"prev-month",disabled:r.value,density:"comfortable",icon:e.prevIcon,variant:"text",onClick:s},null),t.createVNode(zo,{"data-testid":"next-month",disabled:i.value,icon:e.nextIcon,density:"comfortable",variant:"text",onClick:u},null)])]))),{}}}),Bd=ht({appendIcon:Ft,color:String,header:String,transition:String,onClick:G()},"VDatePickerHeader"),Rd=Nt()({name:"VDatePickerHeader",props:Bd(),emits:{click:()=>!0,"click:append":()=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value]),style:t.normalizeStyle(r.value),onClick:i},[o.prepend&&t.createElementVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(fl,{key:"content",name:e.transition},{default:()=>[t.createElementVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createElementVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode(ol,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(zo,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),Ad=ht({allowedDates:[Array,Function],disabled:{type:Boolean,default:null},displayValue:null,modelValue:Array,month:[Number,String],max:null,min:null,showAdjacentMonths:Boolean,year:[Number,String],weekdays:{type:Array,default:()=>[0,1,2,3,4,5,6]},weeksInMonth:{type:String,default:"dynamic"},firstDayOfWeek:{type:[Number,String],default:void 0}},"calendar")
const Td=ht({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},...C(Ad(),["displayValue"])},"VDatePickerMonth"),Dd=Nt()({name:"VDatePickerMonth",props:Td(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=t.ref(),{daysInMonth:r,model:i,weekNumbers:s,weekDays:u,weekdayLabels:c}=function(e){const a=Iu(),l=na(e,"modelValue",[],(e=>B(e).map((e=>a.date(e))))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=na(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
return e.weekdays.map((e=>(e+t)%7))})),s=t.computed((()=>{const t=a.getWeekdays(e.firstDayOfWeek)
...
const l=a.date(t)
return!((!e.min||!a.isAfter(a.date(e.min),l))&&(!e.max||!a.isAfter(l,a.date(e.max)))&&(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"!=typeof e.allowedDates||e.allowedDates(l)))}return{displayValue:o,daysInMonth:v,daysInWeek:d,genDays:c,model:l,weeksInMonth:u,weekDays:i,weekdayLabels:s,weekNumbers:p}}(e),d=Iu(),v=t.shallowRef(),p=t.shallowRef(),m=t.shallowRef(!1),f=t.toRef((()=>m.value?e.reverseTransition:e.transition))
...
r.value=e}(n)}
return o.month?.({month:a,i:n,props:i})??t.createVNode(zo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),$d=ht({color:String,height:[String,Number],min:null,max:null,modelValue:Number,allowedYears:[Array,Function]},"VDatePickerYears"),Md=Nt()({name:"VDatePickerYears",props:$d(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=Iu(),r=na(e,"modelValue"),i=t.computed((()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
const s=le()
function u(t){return Array.isArray(e.allowedYears)&&e.allowedYears.length?e.allowedYears.includes(t):"function"!=typeof e.allowedYears||e.allowedYears(t)}return t.onMounted((async()=>{await t.nextTick(),s.el?.focus()})),Dt((()=>t.createElementVNode("div",{class:"v-date-picker-years",style:{height:f(e.height)}},[t.createElementVNode("div",{class:"v-date-picker-years__content"},[i.value.map(((a,n)=>{const i={ref:r.value===a.value?s:void 0,active:r.value===a.value,color:r.value===a.value?e.color:void 0,rounded:!0,text:a.text,disabled:a.isDisabled,variant:r.value===a.value?"flat":"text",onClick:()=>{r.value!==a.value?r.value=a.value:l("update:modelValue",r.value)}}
return o.year?.({year:a,i:n,props:i})??t.createVNode(zo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Od=ht({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,..._d(),...Td({weeksInMonth:"static"}),...C(Fd(),["modelValue"]),...C($d(),["modelValue"]),...iu({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Ld=Nt()({name:"VDatePicker",props:Od(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=Iu(),{t:r}=fa(),{rtlClasses:i}=ha(),s=na(e,"modelValue",void 0,(e=>B(e).map((e=>n.date(e)))),(t=>e.multiple?t:t[0])),u=na(e,"viewMode"),c=t.computed((()=>{const t=n.date(e.min)
...
return!1}return!0}function N(t){if("function"==typeof e.allowedDates){const e=n.parseISO(`${h.value}-${t+1}-01`)
...
return!1}return!0}function E(){f.value<11?f.value++:(h.value++,f.value=0,T()),A()}function I(){f.value>0?f.value--:(h.value--,f.value=11,T()),A()}function _(){u.value="month"}function P(){u.value="months"===u.value?"month":"months"}function R(){u.value="year"===u.value?"month":"year"}function A(){"months"===u.value&&P()}function T(){"year"===u.value&&R()}return t.watch(s,((e,t)=>{const a=B(t),l=B(e)
if(!l.length)return
const o=n.date(a[a.length-1]),r=n.date(l[l.length-1]),i=n.getMonth(r),s=n.getYear(r)
i!==f.value&&(f.value=i,A()),s!==h.value&&(h.value=s,T()),y.value=n.isBefore(o,r)})),Dt((()=>{const a=su.filterProps(e),l=Pd.filterProps(e),n=Rd.filterProps(e),v=Dd.filterProps(e),m=C(zd.filterProps(e),["modelValue"]),g=C(Md.filterProps(e),["modelValue"]),y={color:p.value,header:b.value,transition:w.value}
return t.createVNode(su,t.mergeProps(a,{color:p.value,class:["v-date-picker",`v-date-picker--${u.value}`,{"v-date-picker--show-week":e.showWeek},i.value,e.class],style:e.style}),{title:()=>o.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(ol,{defaults:{VDatePickerHeader:{...y}}},{default:()=>[o.header?.(y)]}):t.createVNode(Rd,t.mergeProps({key:"header"},n,y,{onClick:"month"!==u.value?_:void 0}),{...o,default:void 0}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(Pd,t.mergeProps(l,{disabled:S.value,text:V.value,"onClick:next":E,"onClick:prev":I,"onClick:month":P,"onClick:year":R}),null),t.createVNode(Ua,{hideOnLeave:!0},{default:()=>["months"===u.value?t.createVNode(zd,t.mergeProps({key:"date-picker-months"},m,{modelValue:f.value,"onUpdate:modelValue":[e=>f.value=e,A],min:c.value,max:d.value,year:h.value,allowedMonths:N}),null):"year"===u.value?t.createVNode(Md,t.mergeProps({key:"date-picker-years"},g,{modelValue:h.value,"onUpdate:modelValue":[e=>h.value=e,T],min:c.value,max:d.value,allowedYears:x}),null):t.createVNode(Dd,t.mergeProps({key:"date-picker-month"},v,{modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,month:f.value,"onUpdate:month":[e=>f.value=e,A],year:h.value,"onUpdate:year":[e=>h.value=e,T],min:c.value,max:d.value}),null)]})]),actions:o.actions})})),{}}}),jd=ht({actionText:String,bgColor:String,color:String,icon:Ft,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...yt(),...nl(),...Kl({size:void 0}),...ba()},"VEmptyState"),Hd=Nt()({name:"VEmptyState",props:jd(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
for(const a of e)l.push(...await av(a,lv(t,a)))
a(l)}))}}))}function lv(e,t){return t.isDirectory?`${e}/${t.name}`:e}const ov=ht({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},...fn({prependIcon:"$file"}),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>B(e).every((e=>null!=e&&"object"==typeof e))},...ki({clearable:!0})},"VFileInput"),nv=Nt()({name:"VFileInput",inheritAttrs:!1,props:ov(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
if(a.length)for(const e of a){const a=await av(e,lv(".",e))
...
function x(){y.value!==document.activeElement&&y.value?.focus(),s.value||u()}function C(e){y.value?.click()}function N(e){o("mousedown:control",e)}function E(e){y.value?.click(),o("click:control",e)}function I(a){a.stopPropagation(),x(),t.nextTick((()=>{i.value=[],K(e["onClick:clear"],a)}))}function _(e){e.preventDefault(),e.stopImmediatePropagation(),w.value=!0}function R(e){e.preventDefault(),w.value=!1}async function A(e){if(e.preventDefault(),e.stopImmediatePropagation(),w.value=!1,!y.value||!k(e))return
const t=new DataTransfer
for(const a of await S(e))t.items.add(a)
y.value.files=t.files,y.value.dispatchEvent(new Event("change",{bubbles:!0}))}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&y.value&&(y.value.value="")})),Dt((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,u]=P(l),{modelValue:d,...S}=gn.filterProps(e),k=xi.filterProps(e)
return t.createVNode(gn,t.mergeProps({ref:g,modelValue:e.multiple?i.value:i.value[0],class:["v-file-input",{"v-file-input--chips":!!e.chips,"v-file-input--dragging":w.value,"v-file-input--hide":e.hideInput,"v-input--plain-underlined":V.value},e.class],style:e.style,"onClick:prepend":C},r,S,{centerAffix:!V.value,focused:s.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:r,isReadonly:d,isValid:f}=a
return t.createVNode(xi,t.mergeProps({ref:h,"prepend-icon":e.prependIcon,onMousedown:N,onClick:E,"onClick:clear":I,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},k,{id:l.value,active:b.value||r.value,dirty:r.value||e.dirty,disabled:o.value,focused:s.value,error:!1===f.value,onDragover:_,onDrop:A}),{...n,default:a=>{let{props:{class:l,...r}}=a
...
const t=e.target
i.value=[...t.files??[]]},onDragleave:R,onFocus:x,onBlur:c},r,u),null),t.createElementVNode("div",{class:t.normalizeClass(l)},[!!i.value?.length&&!e.hideInput&&(n.selection?n.selection({fileNames:m.value,totalBytes:v.value,totalBytesReadable:p.value}):e.chips?m.value.map((e=>t.createVNode(Wn,{key:e,size:"small",text:e},null))):m.value.join(", "))])])}})},details:o?l=>t.createElementVNode(t.Fragment,null,[n.details?.(l),a&&t.createElementVNode(t.Fragment,null,[t.createElementVNode("span",null,null),t.createVNode(bi,{active:!!i.value?.length,value:f.value,disabled:e.disabled},n.counter)])]):void 0})})),fi({},g,h,y)}}),rv=ht({app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...Vl(),...yt(),...Sl(),...ea(),...vl(),...Pa({tag:"footer"}),...ba()},"VFooter"),iv=Nt()({name:"VFooter",props:rv(),setup(e,a){let{slots:l}=a
const o=t.ref(),{themeClasses:n}=Na(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl((()=>e.color)),{borderClasses:s}=wl(e),{elevationClasses:u}=kl(e),{roundedClasses:c}=pl(e),d=t.shallowRef(32),{resizeRef:v}=Xt((e=>{e.length&&(d.value=e[0].target.clientHeight)})),p=t.computed((()=>"auto"===e.height?d.value:parseInt(e.height,10)))
...
t&&r.value?.submit()})),t.preventDefault()}return Dt((()=>t.createElementVNode("form",{ref:r,class:t.normalizeClass(["v-form",e.class]),style:t.normalizeStyle(e.style),novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),fi(n,r)}}),cv=ht({disabled:Boolean,modelValue:{type:Boolean,default:null},...qr()},"VHover"),dv=Nt()({name:"VHover",props:cv(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=na(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Kr(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),vv=ht({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...nl(),...Pa()},"VInfiniteScroll"),pv=Ct({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=Jl()
return t.watch(n,(async t=>{l("intersect",e.side,t)})),Dt((()=>t.createElementVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:o},[t.createTextVNode(" ")]))),{}}}),mv=Nt()({name:"VInfiniteScroll",props:vv(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return t.createVNode(a,{ref:n,class:t.normalizeClass(["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}]),style:t.normalizeStyle(b.value)},{default:()=>[t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),o&&c&&t.createVNode(pv,{key:"start",side:"start",onIntersect:m,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(pv,{key:"end",side:"end",onIntersect:m,rootMargin:s.value},null),t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),fv=Symbol.for("vuetify:v-item-group"),gv=ht({...yt(),...Ol({selectedClass:"v-item--selected"}),...Pa(),...ba()},"VItemGroup"),hv=Nt()({name:"VItemGroup",props:gv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=Na(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Hl(e,fv)
return()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-item-group",o.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),yv=Nt()({name:"VItem",props:Ll(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=jl(e,fv)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),bv=Et("v-kbd","kbd"),Vv=ht({...yt(),...nl(),...Jt()},"VLayout"),wv=Nt()({name:"VLayout",props:Vv(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=la(e),{dimensionStyles:u}=rl(e)
return Dt((()=>t.createElementVNode("div",{ref:s,class:t.normalizeClass([o.value,e.class]),style:t.normalizeStyle([u.value,n.value,e.style])},[l.default?.()]))),{getLayoutItem:r,items:i}}}),Sv=ht({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...yt(),...ea()},"VLayoutItem"),kv=Nt()({name:"VLayoutItem",props:Sv(),setup(e,a){let{slots:l}=a
...
return()=>t.createElementVNode("div",{class:t.normalizeClass(["v-layout-item",e.class]),style:t.normalizeStyle([o.value,e.style])},[l.default?.()])}}),xv=ht({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...yt(),...nl(),...Pa(),...ml({transition:"fade-transition"})},"VLazy"),Cv=Nt()({name:"VLazy",directives:{vIntersect:hl},props:xv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=rl(e),n=na(e,"modelValue")
function r(e){n.value||(n.value=e)}return Dt((()=>t.withDirectives(t.createVNode(e.tag,{class:t.normalizeClass(["v-lazy",e.class]),style:t.normalizeStyle([o.value,e.style])},{default:()=>[n.value&&t.createVNode(fl,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[hl,{handler:r,options:e.options},null]]))),{}}}),Nv=ht({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...yt()},"VLocaleProvider"),Ev=Nt()({name:"VLocaleProvider",props:Nv(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ga(e)
return Dt((()=>t.createElementVNode("div",{class:t.normalizeClass(["v-locale-provider",o.value,e.class]),style:t.normalizeStyle(e.style)},[l.default?.()]))),{}}}),Iv=ht({scrollable:Boolean,...yt(),...nl(),...Pa({tag:"main"})},"VMain"),_v=Nt()({name:"VMain",props:Iv(),setup(e,a){let{slots:l}=a
...
const Pv=100,Bv=20
function Rv(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Av(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=Rv(t),o=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(o-l)*Math.abs(o),a===e.length-1&&(t*=.5)}return 1e3*Rv(t)}function Tv(){const e={}
...
const l=a[0],o=[],n=[]
for(const e of a){if(l[0]-e[0]>Pv)break
o.push({t:e[0],d:e[1].clientX}),n.push({t:e[0],d:e[1].clientY})}return{x:Av(o),y:Av(n),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Dv(){throw new Error}const Fv=["start","end","left","right","top","bottom"],zv=ht({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>Fv.includes(e)},sticky:Boolean,...Vl(),...yt(),...qr(),...Nn({mobile:null}),...Sl(),...ea(),...vl(),...Pa({tag:"nav"}),...ba()},"VNavigationDrawer"),$v=Nt()({name:"VNavigationDrawer",props:zv(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{isRtl:r}=ha(),{themeClasses:i}=Na(e),{borderClasses:s}=wl(e),{backgroundColorClasses:u,backgroundColorStyles:c}=dl((()=>e.color)),{elevationClasses:d}=kl(e),{displayClasses:v,mobile:p}=En(e),{roundedClasses:m}=pl(e),g=mo(),h=na(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:y}=Il(),{scopeId:b}=ai(),V=t.ref(),w=t.shallowRef(!1),{runOpenDelay:S,runCloseDelay:k}=Kr(e,(e=>{w.value=e})),x=t.computed((()=>e.rail&&e.expandOnHover&&w.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),C=t.computed((()=>ue(e.location,r.value))),N=t.toRef((()=>e.persistent)),E=t.computed((()=>!e.permanent&&(p.value||e.temporary))),I=t.computed((()=>e.sticky&&!E.value&&"bottom"!==C.value))
oa((()=>e.expandOnHover&&null!=e.rail),(()=>{t.watch(w,(e=>o("update:rail",!e)))})),oa((()=>!e.disableResizeWatcher),(()=>{t.watch(E,(a=>!e.permanent&&t.nextTick((()=>h.value=!a))))})),oa((()=>!e.disableRouteWatcher&&!!g),(()=>{t.watch(g.currentRoute,(()=>E.value&&(h.value=!1)))})),t.watch((()=>e.permanent),(e=>{e&&(h.value=!0)})),null!=e.modelValue||E.value||(h.value=e.permanent||!p.value)
...
return t.createElementVNode(t.Fragment,null,[t.createVNode(e.tag,t.mergeProps({ref:V,onMouseenter:S,onMouseleave:k,class:["v-navigation-drawer",`v-navigation-drawer--${C.value}`,{"v-navigation-drawer--expand-on-hover":e.expandOnHover,"v-navigation-drawer--floating":e.floating,"v-navigation-drawer--is-hovering":w.value,"v-navigation-drawer--rail":e.rail,"v-navigation-drawer--temporary":E.value,"v-navigation-drawer--persistent":N.value,"v-navigation-drawer--active":h.value,"v-navigation-drawer--sticky":I.value},i.value,u.value,s.value,v.value,d.value,m.value,e.class],style:[c.value,A.value,y.value,F.value,e.style]},b,l),{default:()=>[a&&t.createElementVNode("div",{key:"image",class:"v-navigation-drawer__img"},[n.image?t.createVNode(ol,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{alt:"",cover:!0,height:"inherit",src:e.image}}},n.image):t.createVNode(bl,{key:"image-img",alt:"",cover:!0,height:"inherit",src:e.image},null)]),n.prepend&&t.createElementVNode("div",{class:"v-navigation-drawer__prepend"},[n.prepend?.()]),t.createElementVNode("div",{class:"v-navigation-drawer__content"},[n.default?.()]),n.append&&t.createElementVNode("div",{class:"v-navigation-drawer__append"},[n.append?.()])]}),t.createVNode(t.Transition,{name:"fade-transition"},{default:()=>[E.value&&(_.value||h.value)&&!!e.scrim&&t.createElementVNode("div",t.mergeProps({class:["v-navigation-drawer__scrim",z.backgroundColorClasses.value],style:[$.value,z.backgroundColorStyles.value],onClick:()=>{N.value||(h.value=!1)}},b),null)]})])})),{isStuck:D}}}),Mv=Ct({name:"VNoSsr",setup(e,t){let{slots:a}=t
const l=Jr()
return()=>l.value&&a.default?.()}})
const Ov=ht({controlVariant:{type:String,default:"default"},inset:Boolean,hideInput:Boolean,modelValue:{type:Number,default:null},min:{type:Number,default:Number.MIN_SAFE_INTEGER},max:{type:Number,default:Number.MAX_SAFE_INTEGER},step:{type:Number,default:1},precision:{type:Number,default:0},...C(Ei(),["modelValue","validationValue"])},"VNumberInput"),Lv=Nt()({name:"VNumberInput",props:{...Ov()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.ref(),{holdStart:n,holdStop:r}=function(e){let{toggleUpDown:a}=e,l=-1,o=-1
function n(){window.clearTimeout(l),window.clearInterval(o),window.removeEventListener("pointerup",n),document.removeEventListener("blur",n)}function r(e){a("up"===e)}return t.onScopeDispose(n),{holdStart:function(e){n(),r(e),window.addEventListener("pointerup",n),document.addEventListener("blur",n),l=window.setTimeout((()=>{o=window.setInterval((()=>r(e)),50)}),500)},holdStop:n}}({toggleUpDown:x}),i=dn(e),s=t.computed((()=>i.isDisabled.value||i.isReadonly.value)),u=t.shallowRef(e.focused)
function c(t){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:e.precision
const l=null==a?String(t):t.toFixed(a)
return u.value?Number(l).toString():l}const d=na(e,"modelValue",null,(e=>e??null),(t=>null==t?t??null:R(Number(t),e.min,e.max))),v=t.shallowRef(null)
t.watchEffect((()=>{u.value&&!s.value||(null==d.value?v.value=null:isNaN(d.value)||(v.value=c(d.value)))}))
const p=t.computed({get:()=>v.value,set(t){null===t||""===t?(d.value=null,v.value=null):!isNaN(Number(t))&&Number(t)<=e.max&&Number(t)>=e.min&&(d.value=Number(t),v.value=t)}}),m=t.computed((()=>!s.value&&(d.value??0)+e.step<=e.max)),f=t.computed((()=>!s.value&&(d.value??0)-e.step>=e.min)),g=t.computed((()=>e.hideInput?"stacked":e.controlVariant)),h=t.toRef((()=>"split"===g.value?"$plus":"$collapse")),y=t.toRef((()=>"split"===g.value?"$minus":"$expand")),b=t.toRef((()=>"split"===g.value?"default":"small")),V=t.toRef((()=>"stacked"===g.value?"auto":"100%")),w={props:{onClick:E,onPointerup:I,onPointerdown:_,onPointercancel:I}},S={props:{onClick:E,onPointerup:I,onPointerdown:P,onPointercancel:I}}
function k(e){if(null==e)return 0
const t=e.toString(),a=t.indexOf(".")
return~a?t.length-a:0}function x(){let t=!(arguments.length>0&&void 0!==arguments[0])||arguments[0]
if(s.value)return
if(null==d.value)return void(p.value=c(R(0,e.min,e.max)))
let a=Math.max(k(d.value),k(e.step))
null!=e.precision&&(a=Math.max(a,e.precision)),t?m.value&&(p.value=c(d.value+e.step,a)):f.value&&(p.value=c(d.value-e.step,a))}function C(t){if(!t.data)return
...
return[e[0],e[1].substring(0,t)].join(".")}return a}(r,e.precision);/^-?(\d+(\.\d*)?|(\.\d+)|\d*|\.)$/.test(r)||(t.preventDefault(),a.value=i),null!=e.precision&&(r.split(".")[1]?.length>e.precision&&(t.preventDefault(),a.value=i),0===e.precision&&r.includes(".")&&(t.preventDefault(),a.value=i))}async function N(e){["Enter","ArrowLeft","ArrowRight","Backspace","Delete","Tab"].includes(e.key)||e.ctrlKey||["ArrowDown","ArrowUp"].includes(e.key)&&(e.preventDefault(),B(),await t.nextTick(),"ArrowDown"===e.key?x(!1):x())}function E(e){e.stopPropagation()}function I(e){const t=e.currentTarget
t?.releasePointerCapture(e.pointerId),e.preventDefault(),r()}function _(e){const t=e.currentTarget
t?.setPointerCapture(e.pointerId),e.preventDefault(),e.stopPropagation(),n("up")}function P(e){const t=e.currentTarget
t?.setPointerCapture(e.pointerId),e.preventDefault(),e.stopPropagation(),n("down")}function B(){if(s.value)return
if(!o.value)return
const t=o.value.value
t&&!isNaN(Number(t))?p.value=c(R(Number(t),e.min,e.max)):p.value=null}function A(){s.value||(null===d.value||isNaN(d.value)?p.value=null:p.value=d.value.toString())}function T(){B()}return t.watch((()=>e.precision),(()=>function(){if(s.value)return
if(null===d.value||isNaN(d.value))return void(p.value=null)
p.value=null==e.precision?String(d.value):d.value.toFixed(e.precision)}())),t.onMounted((()=>{B()})),Dt((()=>{const{modelValue:a,...n}=Ii.filterProps(e)
function r(){return l.increment?t.createVNode(ol,{key:"increment-defaults",defaults:{VBtn:{disabled:!m.value,flat:!0,height:V.value,size:b.value,icon:h.value}}},{default:()=>[l.increment(w)]}):t.createVNode(zo,{"aria-hidden":"true","data-testid":"increment",disabled:!m.value,flat:!0,height:V.value,icon:h.value,key:"increment-btn",onClick:E,onPointerdown:_,onPointerup:I,onPointercancel:I,size:b.value,tabindex:"-1"},null)}function i(){return l.decrement?t.createVNode(ol,{key:"decrement-defaults",defaults:{VBtn:{disabled:!f.value,flat:!0,height:V.value,size:b.value,icon:y.value}}},{default:()=>[l.decrement(S)]}):t.createVNode(zo,{"aria-hidden":"true","data-testid":"decrement",disabled:!f.value,flat:!0,height:V.value,icon:y.value,key:"decrement-btn",onClick:E,onPointerdown:P,onPointerup:I,onPointercancel:I,size:b.value,tabindex:"-1"},null)}function s(){return t.createElementVNode("div",{class:"v-number-input__control"},[i(),t.createVNode(yr,{vertical:"stacked"!==g.value},null),r()])}function c(){return e.hideInput||e.inset?void 0:t.createVNode(yr,{vertical:!0},null)}const v="split"===g.value?t.createElementVNode("div",{class:"v-number-input__control"},[t.createVNode(yr,{vertical:!0},null),r()]):e.reverse||"hidden"===g.value?void 0:t.createElementVNode(t.Fragment,null,[c(),s()]),k=l["append-inner"]||v,x="split"===g.value?t.createElementVNode("div",{class:"v-number-input__control"},[i(),t.createVNode(yr,{vertical:!0},null)]):e.reverse&&"hidden"!==g.value?t.createElementVNode(t.Fragment,null,[s(),c()]):void 0,B=l["prepend-inner"]||x
return t.createVNode(Ii,t.mergeProps({ref:o},n,{modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,focused:u.value,"onUpdate:focused":e=>u.value=e,validationValue:d.value,onBeforeinput:C,onFocus:A,onBlur:T,onKeydown:N,class:["v-number-input",{"v-number-input--default":"default"===g.value,"v-number-input--hide-input":e.hideInput,"v-number-input--inset":e.inset,"v-number-input--reverse":e.reverse,"v-number-input--split":"split"===g.value,"v-number-input--stacked":"stacked"===g.value},e.class],style:e.style,inputmode:"decimal"}),{...l,"append-inner":k?function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createElementVNode(t.Fragment,null,[l["append-inner"]?.(...a),v])}:void 0,"prepend-inner":B?function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createElementVNode(t.Fragment,null,[x,l["prepend-inner"]?.(...a)])}:void 0})})),fi({},o)}}),jv=ht({autofocus:Boolean,divider:String,focusAll:Boolean,label:{type:String,default:"$vuetify.input.otp"},length:{type:[Number,String],default:6},modelValue:{type:[Number,String],default:void 0},placeholder:String,type:{type:String,default:"number"},...nl(),...rn(),...k(ki({variant:"outlined"}),["baseColor","bgColor","class","color","disabled","error","loading","rounded","style","theme","variant"])},"VOtpInput"),Hv=Nt()({name:"VOtpInput",props:jv(),emits:{finish:e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{dimensionStyles:r}=rl(e),{isFocused:i,focus:s,blur:u}=sn(e),c=na(e,"modelValue","",(e=>null==e?[]:String(e).split("")),(e=>e.join(""))),{t:d}=fa(),v=t.computed((()=>Number(e.length))),p=t.computed((()=>Array(v.value).fill(0))),m=t.ref(-1),f=t.ref(),g=t.ref([]),h=t.computed((()=>g.value[m.value])),y=t.effectScope()
function b(){if(S(h.value.value))return void(h.value.value="")
const e=c.value.slice(),t=h.value.value
e[m.value]=t
let a=null
m.value>c.value.length?a=c.value.length+1:m.value+1!==v.value&&(a="next"),c.value=e,a&&Q(f.value,a)}function V(e){const t=c.value.slice(),a=m.value
let l=null;["ArrowLeft","ArrowRight","Backspace","Delete"].includes(e.key)&&(e.preventDefault(),"ArrowLeft"===e.key?l="prev":"ArrowRight"===e.key?l="next":["Backspace","Delete"].includes(e.key)&&(t[m.value]="",c.value=t,m.value>0&&"Backspace"===e.key?l="prev":requestAnimationFrame((()=>{g.value[a]?.select()}))),requestAnimationFrame((()=>{null!=l&&Q(f.value,l)})))}function w(){u(),m.value=-1}function S(t){return"number"===e.type&&/[^0-9]/g.test(t)}return y.run((()=>{const{intersectionRef:e,isIntersecting:a}=Jl()
t.watch(a,(t=>{t&&(e.value?.focus(),y.stop())})),t.watchEffect((()=>{e.value=g.value[0]}))})),kt({VField:{color:t.toRef((()=>e.color)),bgColor:t.toRef((()=>e.color)),baseColor:t.toRef((()=>e.baseColor)),disabled:t.toRef((()=>e.disabled)),error:t.toRef((()=>e.error)),variant:t.toRef((()=>e.variant))}},{scoped:!0}),t.watch(c,(e=>{e.length===v.value&&(m.value=v.value-1,o("finish",e.join("")))}),{deep:!0}),t.watch(m,(e=>{e<0||t.nextTick((()=>{g.value[e]?.select()}))})),Dt((()=>{const[a,o]=P(l)
...
const a=t?.clipboardData?.getData("Text").trim().slice(0,v.value)??""
...
const Wv=ht({scale:{type:[Number,String],default:.5},...yt()},"VParallax"),Uv=Nt()({name:"VParallax",props:Wv(),setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return Dt((()=>t.createVNode(bl,{class:t.normalizeClass(["v-parallax",{"v-parallax--active":n.value},e.class]),style:t.normalizeStyle(e.style),ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),Yv=ht({...Jo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Gv=Nt()({name:"VRadio",props:Yv(),setup(e,a){let{slots:l}=a
return Dt((()=>{const a=en.filterProps(e)
return t.createVNode(en,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)})),{}}}),qv=ht({height:{type:[Number,String],default:"auto"},...fn(),...C(Xo(),["multiple"]),trueIcon:{type:Ft,default:"$radioOn"},falseIcon:{type:Ft,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Kv=Nt()({name:"VRadioGroup",inheritAttrs:!1,props:qv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
Dt((()=>{const a=!(!e.closable&&!o.actions),{modelValue:l,...n}=up.filterProps(e)
return t.createElementVNode(t.Fragment,null,[i.value&&!!s.value&&(o.default?t.createVNode(ol,{defaults:{VSnackbar:s.value}},{default:()=>[o.default({item:s.value})]}):t.createVNode(up,t.mergeProps(n,s.value,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,onAfterLeave:u}),{text:o.text?()=>o.text?.({item:s.value}):void 0,actions:a?()=>t.createElementVNode(t.Fragment,null,[o.actions?t.createVNode(ol,{defaults:{VBtn:v.value}},{default:()=>[o.actions({item:s.value,props:{onClick:d}})]}):t.createVNode(zo,t.mergeProps(v.value,{onClick:d}),null)]):void 0}))])}))}}),vp=ht({autoDraw:Boolean,autoDrawDuration:[Number,String],autoDrawEasing:{type:String,default:"ease"},color:String,gradient:{type:Array,default:()=>[]},gradientDirection:{type:String,validator:e=>["top","bottom","left","right"].includes(e),default:"top"},height:{type:[String,Number],default:75},labels:{type:Array,default:()=>[]},labelSize:{type:[Number,String],default:7},lineWidth:{type:[String,Number],default:4},id:String,itemValue:{type:String,default:"value"},modelValue:{type:Array,default:()=>[]},min:[String,Number],max:[String,Number],padding:{type:[String,Number],default:8},showLabels:Boolean,smooth:[Boolean,String,Number],width:{type:[Number,String],default:300}},"Line"),pp=ht({autoLineWidth:Boolean,...vp()},"VBarline"),mp=Nt()({name:"VBarline",props:pp(),setup(e,a){let{slots:l}=a
...
return(a?`M${o.x} ${l-o.x+2} L${o.x} ${o.y}`:`M${o.x} ${o.y}`)+e.map(((a,l)=>{const n=e[l+1],r=e[l-1]||o,i=n&&(u=a,c=r,gp((s=n).x+c.x)===gp(2*u.x)&&gp(s.y+c.y)===gp(2*u.y))
var s,u,c
if(!n||i)return`L${a.x} ${a.y}`
const d=Math.min(hp(r,a),hp(n,a)),v=d/2<t?d/2:t,p=yp(r,a,v),m=yp(n,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${m.x} ${m.y}`})).join("")+(a?`L${n.x} ${l-o.x+2} Z`:"")}function gp(e){return parseInt(e,10)}function hp(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function yp(e,t,a){const l=e.x-t.x,o=e.y-t.y,n=Math.sqrt(l*l+o*o),r=l/n,i=o/n
return{x:t.x+r*a,y:t.y+i*a}}const bp=ht({fill:Boolean,...vp()},"VTrendline"),Vp=Nt()({name:"VTrendline",props:bp(),setup(e,a){let{slots:l}=a
...
return fp(u(f.value,m.value),a,t,parseInt(e.height,10))}t.watch((()=>e.modelValue),(async()=>{if(await t.nextTick(),!e.autoDraw||!s.value)return
...
Dt((()=>{const a="trend"===e.type?Vp:mp,r="trend"===e.type?Vp.filterProps(e):mp.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:o.value,style:n.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)}))}}),kp=ht({...yt(),...gi({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),xp=Nt()({name:"VSpeedDial",props:kp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(hi,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:e.class,style:e.style,contentClass:["v-speed-dial__content",i.value,e.contentClass],location:r.value,ref:n,transition:"fade-transition"}),{...l,default:a=>t.createVNode(ol,{defaults:{VBtn:{size:"small"}}},{default:()=>[t.createVNode(fl,{appear:!0,group:!0,transition:e.transition},{default:()=>[l.default?.(a)]})]})})})),{}}}),Cp=Symbol.for("vuetify:v-stepper"),Np=ht({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),Ep=Nt()({name:"VStepperActions",props:Np(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=fa()
function r(){l("click:prev")}function i(){l("click:next")}return Dt((()=>{const a={onClick:r},l={onClick:i}
return t.createElementVNode("div",{class:"v-stepper-actions"},[t.createVNode(ol,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(zo,a,null)]}),t.createVNode(ol,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(zo,l,null)]})])})),{}}}),Ip=Et("v-stepper-header"),_p=ht({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Ft,default:"$complete"},editable:Boolean,editIcon:{type:Ft,default:"$edit"},error:Boolean,errorIcon:{type:Ft,default:"$error"},icon:Ft,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),Pp=ht({..._p(),...Ll()},"VStepperItem"),Bp=Nt()({name:"VStepperItem",directives:{vRipple:Do},props:Pp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=jl(e,Cp,!0),n=t.computed((()=>o?.value.value??e.value)),r=t.computed((()=>e.rules.every((e=>!0===e())))),i=t.computed((()=>!e.disabled&&e.editable)),s=t.computed((()=>!e.disabled&&e.editable)),u=t.computed((()=>e.error||!r.value)),c=t.computed((()=>e.complete||e.rules.length>0&&r.value)),d=t.computed((()=>u.value?e.errorIcon:c.value?e.completeIcon:o.isSelected.value&&e.editable?e.editIcon:e.icon)),v=t.computed((()=>({canEdit:s.value,hasError:u.value,hasCompleted:c.value,title:e.title,subtitle:e.subtitle,step:n.value,value:e.value})))
...
return t.withDirectives(t.createElementVNode("button",{class:t.normalizeClass(["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value]),disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&Dl(!0,"v-stepper-item"),t.createVNode(Yo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Ql,{icon:d.value},null):n.value)]}),t.createElementVNode("div",{class:"v-stepper-item__content"},[r&&t.createElementVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createElementVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[Do,e.ripple&&e.editable,null]])})),{}}}),Rp=ht({...C(Ns(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),Ap=Nt()({name:"VStepperWindow",props:Rp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Cp,null),n=na(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return Dt((()=>{const a=Es.filterProps(e)
return t.createVNode(Es,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),Tp=ht({...Ps()},"VStepperWindowItem"),Dp=Nt()({name:"VStepperWindowItem",props:Tp(),setup(e,a){let{slots:l}=a
return Dt((()=>{const a=Bs.filterProps(e)
return t.createVNode(Bs,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)})),{}}}),Fp=ht({altLabels:Boolean,bgColor:String,completeIcon:Ft,editIcon:Ft,editable:Boolean,errorIcon:Ft,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},nonLinear:Boolean,flat:Boolean,...Nn()},"Stepper"),zp=ht({...Fp(),...Ol({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...nu(),...k(Np(),["prevText","nextText"])},"VStepper"),$p=Nt()({name:"VStepper",props:zp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=Hl(e,Cp),{displayClasses:s,mobile:u}=En(e),{completeIcon:c,editIcon:d,errorIcon:v,color:m,editable:f,prevText:g,nextText:h}=t.toRefs(e),y=t.computed((()=>e.items.map(((t,a)=>({title:p(t,e.itemTitle,t),value:p(t,e.itemValue,a+1),raw:t}))))),b=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
return kt({VStepperItem:{editable:f,errorIcon:v,completeIcon:c,editIcon:d,prevText:g,nextText:h},VStepperActions:{color:m,disabled:t.computed((()=>e.disabled?e.disabled:0===b.value?"prev":b.value===o.value.length-1&&"next")),prevText:g,nextText:h}}),Dt((()=>{const a=ru.filterProps(e),o=!(!l.header&&!e.items.length),i=e.items.length>0,c=!(e.hideActions||!i&&!l.actions)
return t.createVNode(ru,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":u.value},s.value,e.class],style:e.style}),{default:()=>[o&&t.createVNode(Ip,{key:"stepper-header"},{default:()=>[y.value.map(((e,a)=>{let{raw:o,...n}=e
return t.createElementVNode(t.Fragment,null,[!!a&&t.createVNode(yr,null,null),t.createVNode(Bp,n,{default:l[`header-item.${n.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])}))]}),i&&t.createVNode(Ap,{key:"stepper-window"},{default:()=>[y.value.map((e=>t.createVNode(Dp,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),c&&(l.actions?.({next:n,prev:r})??t.createVNode(Ep,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),Mp=ht({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...fn(),...Jo()},"VSwitch"),Op=Nt()({name:"VSwitch",inheritAttrs:!1,props:Mp(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,l){let{attrs:o,slots:n}=l
...
return t.createVNode(zo,t.mergeProps({symbol:Hp,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createElementVNode("div",{ref:s,class:t.normalizeClass(["v-tab__slider",n.value]),style:t.normalizeStyle(r.value)},null)])})})),fi({},i)}}),Yp=ht({...C(Ns(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Gp=Nt()({name:"VTabsWindow",props:Yp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Hp,null),n=na(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return Dt((()=>{const a=Es.filterProps(e)
return t.createVNode(Es,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),qp=ht({...Ps()},"VTabsWindowItem"),Kp=Nt()({name:"VTabsWindowItem",props:qp(),setup(e,a){let{slots:l}=a
return Dt((()=>{const a=Bs.filterProps(e)
return t.createVNode(Bs,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)})),{}}})
const Xp=ht({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...$n({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Rl(),...Pa()},"VTabs"),Zp=Nt()({name:"VTabs",props:Xp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return t.createElementVNode(t.Fragment,null,[t.createVNode(Mn,t.mergeProps(a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},i.value,s.value,e.class],style:[{"--v-tabs-height":f(e.height)},u.value,e.style],role:"tablist",symbol:Hp},c,l),{default:()=>[o.default?.()??r.value.map((e=>o.tab?.({item:e})??t.createVNode(Up,t.mergeProps(e,{key:e.text,value:e.value}),{default:o[`tab.${e.value}`]?()=>o[`tab.${e.value}`]?.({item:e}):void 0})))]}),d&&t.createVNode(Gp,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,key:"tabs-window"},c),{default:()=>[r.value.map((e=>o.item?.({item:e})??t.createVNode(Kp,{value:e.value},{default:()=>o[`item.${e.value}`]?.({item:e})}))),o.window?.()]})])})),{}}}),Qp=ht({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...fn(),...ki()},"VTextarea"),Jp=Nt()({name:"VTextarea",directives:{vIntersect:hl},inheritAttrs:!1,props:Qp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const r=na(e,"modelValue"),{isFocused:i,focus:s,blur:u}=sn(e),{onIntersect:c}=Ci(e),d=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(r.value):(r.value||"").toString().length)),v=t.computed((()=>l.maxlength?l.maxlength:!e.counter||"number"!=typeof e.counter&&"string"!=typeof e.counter?void 0:e.counter)),p=t.ref(),m=t.ref(),g=t.shallowRef(""),h=t.ref(),y=t.computed((()=>e.persistentPlaceholder||i.value||e.active))
...
return t.createVNode(gn,t.mergeProps({ref:p,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow,"v-input--plain-underlined":N.value},e.class],style:e.style},s,I,{centerAffix:1===C.value&&!N.value,focused:i.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:s,isReadonly:d,isValid:v}=a
return t.createVNode(xi,t.mergeProps({ref:m,style:{"--v-textarea-control-height":g.value},onClick:V,onMousedown:w,"onClick:clear":S,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},_,{id:l.value,active:y.value||s.value,centerAffix:1===C.value&&!N.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===v.value}),{...n,default:a=>{let{props:{class:l,...n}}=a
return t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{class:"v-text-field__prefix"},[e.prefix]),t.withDirectives(t.createElementVNode("textarea",t.mergeProps({ref:h,class:l,value:r.value,onInput:k,autofocus:e.autofocus,readonly:d.value,disabled:o.value,placeholder:e.placeholder,rows:e.rows,name:e.name,onFocus:b,onBlur:u},n,f),null),[[hl,{handler:c},null,{once:!0}]]),e.autoGrow&&t.withDirectives(t.createElementVNode("textarea",{class:t.normalizeClass([l,"v-textarea__sizer"]),id:`${n.id}-sizer`,"onUpdate:modelValue":e=>r.value=e,ref:x,readonly:!0,"aria-hidden":"true"},null),[[t.vModelText,r.value]]),e.suffix&&t.createElementVNode("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:o?l=>t.createElementVNode(t.Fragment,null,[n.details?.(l),a&&t.createElementVNode(t.Fragment,null,[t.createElementVNode("span",null,null),t.createVNode(bi,{active:e.persistentCounter||i.value,value:d.value,max:v.value,disabled:e.disabled},n.counter)])]):void 0})})),fi({},p,m,h)}}),em=ht({withBackground:Boolean,...yt(),...ba(),...Pa()},"VThemeProvider"),tm=Nt()({name:"VThemeProvider",props:em(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=Na(e)
return()=>e.withBackground?t.createVNode(e.tag,{class:t.normalizeClass(["v-theme-provider",o.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[l.default?.()]}):l.default?.()}}),am=ht({dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:Ft,iconColor:String,lineColor:String,...yt(),...vl(),...Kl(),...Sl()},"VTimelineDivider"),lm=Nt()({name:"VTimelineDivider",props:am(),setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})})),fi({},s)}}),vm=Nt()({name:"VValidation",props:pn(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=mn(e,"validation")
return()=>a.default?.(l)}})
var pm=Object.freeze({__proto__:null,VAlert:Wo,VAlertTitle:Lo,VApp:_a,VAppBar:Pl,VAppBarNavIcon:Mo,VAppBarTitle:Oo,VAutocomplete:Ui,VAvatar:Yo,VBadge:Gi,VBanner:Qi,VBannerActions:Ki,VBannerText:Xi,VBottomNavigation:es,VBottomSheet:os,VBreadcrumbs:cs,VBreadcrumbsDivider:rs,VBreadcrumbsItem:ss,VBtn:zo,VBtnGroup:Ml,VBtnToggle:Gl,VCard:Vs,VCardActions:ds,VCardItem:gs,VCardSubtitle:ps,VCardText:ys,VCardTitle:ms,VCarousel:_s,VCarouselItem:As,VCheckbox:yn,VCheckboxBtn:an,VChip:Wn,VChipGroup:jn,VClassIcon:jt,VCode:Ts,VCol:cd,VColorPicker:_u,VCombobox:Bu,VComponentIcon:Mt,VConfirmEdit:Au,VContainer:ad,VCounter:bi,VDataIterator:fc,VDataTable:Xc,VDataTableFooter:bc,VDataTableHeaders:Fc,VDataTableRow:Oc,VDataTableRows:jc,VDataTableServer:ed,VDataTableVirtual:Qc,VDatePicker:Ld,VDatePickerControls:Pd,VDatePickerHeader:Rd,VDatePickerMonth:Dd,VDatePickerMonths:zd,VDatePickerYears:Md,VDefaultsProvider:ol,VDialog:as,VDialogBottomTransition:Ha,VDialogTopTransition:Wa,VDialogTransition:Ma,VDivider:yr,VEmptyState:Hd,VExpandTransition:tl,VExpandXTransition:al,VExpansionPanel:Xd,VExpansionPanelText:Yd,VExpansionPanelTitle:qd,VExpansionPanels:Jd,VFab:tv,VFabTransition:ja,VFadeTransition:Ua,VField:xi,VFieldLabel:wi,VFileInput:nv,VFooter:iv,VForm:uv,VHover:dv,VIcon:Ql,VImg:bl,VInfiniteScroll:mv,VInput:gn,VItem:yv,VItemGroup:hv,VKbd:bv,VLabel:qo,VLayout:wv,VLayoutItem:kv,VLazy:Cv,VLigatureIcon:Lt,VList:Ir,VListGroup:ur,VListImg:_r,VListItem:mr,VListItemAction:Br,VListItemMedia:Ar,VListItemSubtitle:dr,VListItemTitle:vr,VListSubheader:gr,VLocaleProvider:Ev,VMain:_v,VMenu:hi,VMessages:nn,VNavigationDrawer:$v,VNoSsr:Mv,VNumberInput:Lv,VOtpInput:Hv,VOverlay:vi,VPagination:hc,VParallax:Uv,VProgressCircular:to,VProgressLinear:ro,VRadio:Gv,VRadioGroup:Kv,VRangeSlider:Zv,VRating:Jv,VResponsive:sl,VRow:Ed,VScaleTransition:Ya,VScrollXReverseTransition:qa,VScrollXTransition:Ga,VScrollYReverseTransition:Xa,VScrollYTransition:Ka,VSelect:$i,VSelectionControl:en,VSelectionControlGroup:Qo,VSheet:ru,VSkeletonLoader:rp,VSlideGroup:Mn,VSlideGroupItem:ip,VSlideXReverseTransition:Qa,VSlideXTransition:Za,VSlideYReverseTransition:el,VSlideYTransition:Ja,VSlider:Js,VSnackbar:up,VSnackbarQueue:dp,VSpacer:Id,VSparkline:Sp,VSpeedDial:xp,VStepper:$p,VStepperActions:Ep,VStepperHeader:Ip,VStepperItem:Bp,VStepperWindow:Ap,VStepperWindowItem:Dp,VSvgIcon:Ot,VSwitch:Op,VSystemBar:jp,VTab:Up,VTable:Wc,VTabs:Zp,VTabsWindow:Gp,VTabsWindowItem:Kp,VTextField:Ii,VTextarea:Jp,VThemeProvider:tm,VTimeline:im,VTimelineItem:nm,VToolbar:Nl,VToolbarItems:um,VToolbarTitle:Ra,VTooltip:dm,VValidation:vm,VVirtualScroll:Ti,VWindow:Es,VWindowItem:Bs})
function mm(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const fm={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:o,immediate:n,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),o&&mm(e,t)}))
n&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:mm}
const gm={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}}
function hm(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,o="object"==typeof l&&l.options||{passive:!0},n="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",n,o),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:n,options:o,target:a?void 0:r})}function ym(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:o=e}=e._onScroll[t.instance.$.uid]
o.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const bm={mounted:hm,unmounted:ym,updated:function(e,t){t.value!==t.oldValue&&(ym(e,t),hm(e,t))}}
const Vm=function(e,a){const l=function(e,a){return function(l,o,n){const r="function"==typeof a?a(o):a,i=o.value?.text??o.value??r?.text,s=g(o.value)?o.value:{},u=()=>i??l.textContent,c=(n.ctx===o.instance.$?function(e,t){const a=new Set,l=t=>{for(const o of t){if(!o)continue
...
var wm=Object.freeze({__proto__:null,ClickOutside:ui,Intersect:hl,Mutate:fm,Resize:gm,Ripple:Do,Scroll:bm,Tooltip:Vm,Touch:ks})
function Sm(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:l,...o}=e,n=z(l,o),{aliases:r={},components:i={},directives:s={}}=n,u=t.effectScope()
return u.run((()=>{const e=function(e){return t.ref(e)}(n.defaults),l=function(e,l){const{thresholds:o,mobileBreakpoint:n}=Sn(e),r=t.shallowRef(xn(l)),i=t.shallowRef(Cn(l)),s=t.reactive({}),u=t.shallowRef(kn(l))
...
if(m.run((()=>{o.install(u)})),u.onUnmount((()=>m.stop())),u.provide(wt,e),u.provide(Vn,l),u.provide(ya,o),u.provide(zt,c),u.provide(pa,d),u.provide(Cu,v.options),u.provide(Nu,v.instance),u.provide(In,p),a&&n.ssr)if(u.$nuxt)u.$nuxt.hook("app:suspense:resolve",(()=>{l.update()}))
...
if(a&&e in a)return a[e]}Sm.version="3.8.11"
const xm=function(){return Sm({components:pm,directives:wm,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Cm="3.8.11"
