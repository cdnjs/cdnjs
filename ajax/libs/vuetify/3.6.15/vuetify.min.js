...
return{layoutIsReady:t.nextTick(),getLayoutItem:e.getLayoutItem,mainRect:e.mainRect,mainStyles:e.mainStyles}}function oa(e){const a=t.inject(Jt)
...
return t.onBeforeUnmount((()=>a.unregister(l))),{layoutItemStyles:i,layoutRect:a.layoutRect,layoutItemScrimStyles:s,layoutIsReady:r}}function na(e){const a=t.inject(Jt,null),l=t.computed((()=>a?a.rootZIndex.value-100:1e3)),o=t.ref([]),n=t.reactive(new Map),r=t.reactive(new Map),i=t.reactive(new Map),s=t.reactive(new Map),u=t.reactive(new Map),{resizeRef:c,contentRect:d}=Qt(),v=ae((()=>{const e=[...new Set([...i.values()].map((e=>e.value)))].sort(((e,t)=>e-t)),t=[]
...
return{id:a,...l,size:Number(o.value),position:i.value}})))),y=e=>h.value.find((t=>t.id===e)),b=yt("createLayout"),V=t.nextTick()
t.provide(Jt,{register:(e,a)=>{let{id:c,order:d,position:f,layoutSize:m,elementSize:g,active:y,disableTransitions:V,absolute:w}=a
i.set(c,d),n.set(c,f),r.set(c,m),s.set(c,y),V&&u.set(c,V)
const S=O(ea,b?.vnode).indexOf(e)
...
return{layoutClasses:t.computed((()=>["v-layout",{"v-layout--full-height":e.fullHeight}])),layoutStyles:t.computed((()=>({zIndex:a?l.value:void 0,position:a?"relative":void 0,overflow:a?"hidden":void 0}))),getLayoutItem:y,items:h,layoutRect:d,layoutIsReady:V,layoutRef:c}}function ra(e,a){let l
...
return t.withDirectives(t.createVNode(rl,t.mergeProps({class:["v-img",{"v-img--booting":!P.value},r.value,s.value,e.class],style:[{width:f("auto"===e.width?p.value:e.width)},i.value,e.style]},a,{aspectRatio:h.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(N,null,null),t.createVNode(C,null,null),t.createVNode(B,null,null),t.createVNode(_,null,null),t.createVNode(I,null,null)]),default:n.default}),[[t.resolveDirective("intersect"),{handler:y,options:e.options},null,{once:!0}]])})),{currentSrc:c,image:d,state:v,naturalWidth:p,naturalHeight:m}}}),yl=gt({border:[Boolean,Number,String]},"border")
...
t?t!==r.value&&(r.value?.removeEventListener("scroll",f),r.value=t,r.value.addEventListener("scroll",f,{passive:!0})):Fe(`Unable to locate element with identifier ${e}`)}),{immediate:!0})})),t.onBeforeUnmount((()=>{r.value?.removeEventListener("scroll",f)})),l&&t.watch(l,f,{immediate:!0}),{scrollThreshold:v,currentScroll:i,currentThreshold:u,isScrollActive:c,scrollRatio:p,isScrollingUp:d,savedScroll:s}}(e,{canScroll:i}),v=t.computed((()=>r.value.hide||r.value.fullyHide)),p=t.computed((()=>e.collapse||r.value.collapse&&(r.value.inverted?d.value>0:0===d.value))),f=t.computed((()=>e.flat||r.value.fullyHide&&!n.value||r.value.elevate&&(r.value.inverted?s.value>0:0===s.value))),m=t.computed((()=>r.value.fadeImage?r.value.inverted?1-d.value:d.value:void 0)),g=t.computed((()=>{const t=Number(o.value?.contentHeight??e.height),a=Number(o.value?.extensionHeight??0)
...
const{ssrBootStyles:h}=Cl(),{layoutItemStyles:y,layoutIsReady:b}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.toRef(e,"location"),layoutSize:g,elementSize:t.shallowRef(void 0),active:n,absolute:t.toRef(e,"absolute")})
return $t((()=>{const a=xl.filterProps(e)
return t.createVNode(xl,t.mergeProps({ref:o,class:["v-app-bar",{"v-app-bar--bottom":"bottom"===e.location},e.class],style:[{...y.value,"--v-toolbar-image-opacity":m.value,height:void 0,...h.value},e.style]},a,{collapse:p.value,flat:f.value}),l)})),b}}),Bl=[null,"default","comfortable","compact"],Pl=gt({density:{type:String,default:"default",validator:e=>Bl.includes(e)}},"density")
...
Ao(e,t,So(t.oldValue))}},Do=gt({active:{type:Boolean,default:void 0},baseColor:String,symbol:{type:null,default:Hl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Mt,appendIcon:Mt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:String,...yl(),...ht(),...Pl(),...ll(),...Vl(),...Ol(),...no(),...to(),...uo(),...cl(),...fo(),...Gl(),...Ba({tag:"button"}),...wa(),...Dl({variant:"elevated"})},"VBtn"),Eo=It()({name:"VBtn",props:Do(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=ka(e),{borderClasses:r}=bl(e),{densityClasses:i}=Al(e),{dimensionStyles:s}=ol(e),{elevationClasses:u}=wl(e),{loaderClasses:c}=ro(e),{locationStyles:d}=ao(e),{positionClasses:v}=co(e),{roundedClasses:p}=dl(e),{sizeClasses:f,sizeStyles:m}=ql(e),g=Ll(e,e.symbol,!1),h=po(e,l),y=t.computed((()=>void 0!==e.active?e.active:h.isLink.value?h.isActive?.value:g?.isSelected.value)),b=t.computed((()=>({color:g?.isSelected.value&&(!h.isLink.value||h.isActive?.value)||!g||h.isActive?.value?e.color??e.baseColor:e.baseColor,variant:e.variant}))),{colorClasses:V,colorStyles:w,variantClasses:S}=El(b),k=t.computed((()=>g?.disabled.value||e.disabled)),x=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border))),N=t.computed((()=>{if(void 0!==e.value&&"symbol"!=typeof e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value}))
function C(e){k.value||h.isLink.value&&(e.metaKey||e.ctrlKey||e.shiftKey||0!==e.button||"_blank"===l.target)||(h.navigate?.(e),g?.toggle())}return function(e,a){t.watch((()=>e.isActive?.value),(l=>{e.isLink.value&&l&&a&&t.nextTick((()=>{a(!0)}))}),{immediate:!0})}(h,g?.select),$t((()=>{const a=h.isLink.value?"a":e.tag,l=!(!e.prependIcon&&!o.prepend),b=!(!e.appendIcon&&!o.append),_=!(!e.icon||!0===e.icon)
return t.withDirectives(t.createVNode(a,{type:"a"===a?void 0:"button",class:["v-btn",g?.selectedClass.value,{"v-btn--active":y.value,"v-btn--block":e.block,"v-btn--disabled":k.value,"v-btn--elevated":x.value,"v-btn--flat":e.flat,"v-btn--icon":!!e.icon,"v-btn--loading":e.loading,"v-btn--readonly":e.readonly,"v-btn--slim":e.slim,"v-btn--stacked":e.stacked},n.value,r.value,V.value,i.value,u.value,c.value,v.value,p.value,f.value,S.value,e.class],style:[w.value,s.value,d.value,m.value,e.style],"aria-busy":!!e.loading||void 0,disabled:k.value||void 0,href:h.href.value,tabindex:e.loading||e.readonly?-1:void 0,onClick:C,value:N.value},{default:()=>[Tl(!0,"v-btn"),!e.icon&&l&&t.createVNode("span",{key:"prepend",class:"v-btn__prepend"},[o.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!e.prependIcon,defaults:{VIcon:{icon:e.prependIcon}}},o.prepend):t.createVNode(Xl,{key:"prepend-icon",icon:e.prependIcon},null)]),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[!o.default&&_?t.createVNode(Xl,{key:"content-icon",icon:e.icon},null):t.createVNode(al,{key:"content-defaults",disabled:!_,defaults:{VIcon:{icon:e.icon}}},{default:()=>[o.default?.()??e.text]})]),!e.icon&&b&&t.createVNode("span",{key:"append",class:"v-btn__append"},[o.append?t.createVNode(al,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VIcon:{icon:e.appendIcon}}},o.append):t.createVNode(Xl,{key:"append-icon",icon:e.appendIcon},null)]),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[o.loader?.()??t.createVNode(Jl,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,width:"2"},null)])]}),[[To,!k.value&&e.ripple,"",{center:!!e.icon}]])})),{group:g}}}),Fo=gt({...Do({icon:"$menu",variant:"text"})},"VAppBarNavIcon"),$o=It()({name:"VAppBarNavIcon",props:Fo(),setup(e,a){let{slots:l}=a
...
!0!==o&&(!1===o||"string"==typeof o?a.push(o||""):console.warn(`${o} is not a valid value. Rule functions must return boolean true or a string.`))}return i.value=a,m.value=!1,s.value=t,i.value}return t.onBeforeMount((()=>{r?.register({id:y.value,vm:h,validate:w,reset:b,resetValidation:V})})),t.onBeforeUnmount((()=>{r?.unregister(y.value)})),t.onMounted((async()=>{p.value.lazy||await w(!0),r?.update(y.value,f.value,v.value)})),ra((()=>p.value.input),(()=>{t.watch(n,(()=>{if(null!=n.value)w()
...
n.set(c,t?"on":a?"off":"indeterminate"),c=i.get(c)}if(e&&!o){const e=Array.from(n.entries()).reduce(((e,t)=>{let[a,l]=t
return"on"===l&&e.push(a),e}),[])
...
const r=po(e,l),i=t.computed((()=>void 0===e.value?r.href.value:e.value)),{activate:s,isActivated:u,select:c,isSelected:d,isIndeterminate:v,isGroupActivator:p,root:f,parent:m,openOnSelect:g}=ar(i,!1),h=Wn(),y=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||(f.activatable.value?u.value:d.value)))),b=t.computed((()=>!1!==e.link&&r.isLink.value)),V=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||!!h&&(f.selectable.value||f.activatable.value||null!=e.value)))),w=t.computed((()=>e.rounded||e.nav)),S=t.computed((()=>e.color??e.activeColor)),k=t.computed((()=>({color:y.value?S.value??e.baseColor:e.baseColor,variant:e.variant})))
t.watch((()=>r.isActive?.value),(e=>{e&&null!=m.value&&f.open(m.value,!0),e&&g(e)}),{immediate:!0})
const{themeClasses:x}=ka(e),{borderClasses:N}=bl(e),{colorClasses:C,colorStyles:_,variantClasses:I}=El(k),{densityClasses:B}=Al(e),{dimensionStyles:P}=ol(e),{elevationClasses:A}=wl(e),{roundedClasses:R}=dl(w),T=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),D=t.computed((()=>({isActive:y.value,select:c,isSelected:d.value,isIndeterminate:v.value})))
function E(t){n("click",t),V.value&&(r.navigate?.(t),p||(f.activatable.value?s(!u.value,t):(f.selectable.value||null!=e.value)&&c(!d.value,t)))}function F(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),E(e))}return $t((()=>{const a=b.value?"a":e.tag,l=o.title||null!=e.title,n=o.subtitle||null!=e.subtitle,i=!(!e.appendAvatar&&!e.appendIcon),s=!(!i&&!o.append),u=!(!e.prependAvatar&&!e.prependIcon),c=!(!u&&!o.prepend)
var d,v
return h?.updateHasPrepend(c),e.activeColor&&(d="active-color",v=["color","base-color"],v=Array.isArray(v)?v.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${v.at(-1)}'`:`'${v}'`,t.warn(`[Vuetify UPGRADE] '${d}' is deprecated, use ${v} instead.`)),t.withDirectives(t.createVNode(a,{class:["v-list-item",{"v-list-item--active":y.value,"v-list-item--disabled":e.disabled,"v-list-item--link":V.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!c&&h?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&y.value},x.value,N.value,C.value,B.value,A.value,T.value,R.value,I.value,e.class],style:[_.value,P.value,e.style],href:r.href.value,tabindex:V.value?h?-2:0:void 0,onClick:E,onKeydown:V.value&&!b.value&&F},{default:()=>[Tl(V.value||y.value,"v-list-item"),c&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!u,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(D.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(sr,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(ir,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(D.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(al,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(D.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),V.value&&e.ripple]])})),{activate:s,isActivated:u,isGroupActivator:p,isSelected:d,list:h,select:c}}}),dr=gt({color:String,inset:Boolean,sticky:Boolean,title:String,...ht(),...Ba()},"VListSubheader"),vr=It()({name:"VListSubheader",props:dr(),setup(e,a){let{slots:l}=a
...
function Gr(e,l){let{isActive:o,isTop:n}=l
const r=yt("useActivator"),i=t.ref()
let s=!1,u=!1,c=!0
const d=t.computed((()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover)),v=t.computed((()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!d.value)),{runOpenDelay:p,runCloseDelay:f}=Ur(e,(t=>{t!==(e.openOnHover&&s||d.value&&u)||e.openOnHover&&o.value&&!n.value||(o.value!==t&&(c=!0),o.value=t)})),m=t.ref(),g=e=>{e.stopPropagation(),i.value=e.currentTarget||e.target,o.value||(m.value=[e.clientX,e.clientY]),o.value=!o.value},h=e=>{e.sourceCapabilities?.firesTouchEvents||(s=!0,i.value=e.currentTarget||e.target,p())},y=e=>{s=!1,f()},b=e=>{!1!==ee(e.target,":focus-visible")&&(u=!0,e.stopPropagation(),i.value=e.currentTarget||e.target,p())},V=e=>{u=!1,e.stopPropagation(),f()},w=t.computed((()=>{const t={}
...
if(e.openOnHover&&(a.onMouseenter=()=>{s=!0,p()},a.onMouseleave=()=>{s=!1,f()}),d.value&&(a.onFocusin=()=>{u=!0,p()},a.onFocusout=()=>{u=!1,f()}),e.closeOnContentClick){const e=t.inject(Hr,null)
...
const N=le(),_=t.computed((()=>"cursor"===e.target&&m.value?m.value:N.value?N.el:qr(e.target,r)||i.value)),I=t.computed((()=>Array.isArray(_.value)?void 0:_.value))
let B
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,r,{activatorEl:i,activatorEvents:w})}))):B&&B.stop()}),{flush:"post",immediate:!0}),t.onScopeDispose((()=>{B?.stop()})),{activatorEl:i,activatorRef:x,target:_,targetEl:I,targetRef:N,activatorEvents:w,contentEvents:S,scrimEvents:k}}function qr(e,t){if(!e)return
let a
...
const i=yt("VOverlay"),s=ia(e,"modelValue"),u=t.computed({get:()=>s.value,set:t=>{t&&e.disabled||(s.value=t)}}),{themeClasses:c}=ka(e),{rtlClasses:d,isRtl:v}=ba(),{hasContent:p,onAfterLeave:m}=Zr(e,u),g=ul(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:h,localTop:y,stackStyles:b}=function(e,a,l){const o=yt("useStack"),n=!l,r=t.inject(Jr,void 0),i=t.reactive({activeChildren:new Set})
t.provide(Jr,i)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(u,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:V,activatorRef:w,target:S,targetEl:k,targetRef:x,activatorEvents:N,contentEvents:C,scrimEvents:_}=Gr(e,{isActive:u,isTop:y}),{teleportTarget:I}=function(e){return{teleportTarget:t.computed((()=>{const l=e()
if(!0===l||!a)return
...
if(t)return t
const a=V?.value?.getRootNode()||i.proxy?.$el?.getRootNode()
return a instanceof ShadowRoot&&a})),{dimensionStyles:B}=ol(e),P=Kr(),{scopeId:A}=Qr()
t.watch((()=>e.disabled),(e=>{e&&(u.value=!1)}))
const R=t.ref(),T=t.ref(),D=t.ref(),{contentStyles:E,updateLocation:F}=function(e,l){const o=t.ref({}),n=t.ref()
function r(e){n.value?.(e)}return a&&ra((()=>!(!l.isActive.value||!e.locationStrategy)),(a=>{t.watch((()=>e.locationStrategy),a),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0})),window.addEventListener("resize",r,{passive:!0}),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(l,e,o)?.updateLocation:n.value=Rr[e.locationStrategy](l,e,o)?.updateLocation})),{contentStyles:o,updateLocation:n}}(e,{isRtl:v,contentEl:D,target:S,isActive:u})
function $(t){r("click:outside",t),e.persistent?j():u.value=!1}function M(t){return u.value&&h.value&&(!e.scrim||t.target===T.value||t instanceof MouseEvent&&t.shadowTarget===T.value)}function O(t){"Escape"===t.key&&h.value&&(e.persistent?j():(u.value=!1,D.value?.contains(document.activeElement)&&V.value?.focus()))}!function(e,l){if(!a)return
let o
t.watchEffect((async()=>{o?.stop(),l.isActive.value&&e.scrollStrategy&&(o=t.effectScope(),await new Promise((e=>setTimeout(e))),o.active&&o.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(l,e,o):Lr[e.scrollStrategy]?.(l,e,o)})))})),t.onScopeDispose((()=>{o?.stop()}))}(e,{root:R,contentEl:D,targetEl:k,isActive:u,updateLocation:F}),a&&t.watch(u,(e=>{e?window.addEventListener("keydown",O):window.removeEventListener("keydown",O)}),{immediate:!0}),t.onBeforeUnmount((()=>{a&&window.removeEventListener("keydown",O)}))
const L=vo()
ra((()=>e.closeOnBack),(()=>{!function(e,l){let o,n,r=!1
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e?.beforeEach(((e,t,a)=>{mo?r?l(a):a():setTimeout((()=>r?l(a):a())),mo=!0})),n=e?.afterEach((()=>{mo=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(L,(t=>{h.value&&u.value?(t(!1),e.persistent?j():u.value=!1):t()}))}))
const z=t.ref()
function j(){e.noClickAnimation||D.value&&ge(D.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:At})}function H(){r("afterEnter")}function W(){m(),r("afterLeave")}return t.watch((()=>u.value&&(e.absolute||e.contained)&&null==I.value),(e=>{if(e){const e=Tt(R.value)
e&&e!==document.scrollingElement&&(z.value=e.scrollTop)}})),$t((()=>t.createVNode(t.Fragment,null,[o.activator?.({isActive:u.value,targetRef:x,props:t.mergeProps({ref:w},N.value,e.activatorProps)}),P.value&&p.value&&t.createVNode(t.Teleport,{disabled:!I.value,to:I.value},{default:()=>[t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":u.value,"v-overlay--contained":e.contained},c.value,d.value,e.class],style:[b.value,{"--v-overlay-opacity":e.opacity,top:f(z.value)},e.style],ref:R},A,n),[t.createVNode(ri,t.mergeProps({color:g,modelValue:u.value&&!!e.scrim,ref:T},_.value),null),t.createVNode(pl,{appear:!0,persisted:!0,transition:e.transition,target:S.value,onAfterEnter:H,onAfterLeave:W},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:D,class:["v-overlay__content",e.contentClass],style:[B.value,E.value]},C.value,e.contentProps),[o.default?.({isActive:u})]),[[t.vShow,u.value],[t.resolveDirective("click-outside"),{handler:$,closeConditional:M,include:()=>[V.value]}]])]})])]})]))),{activatorEl:V,scrimEl:T,target:S,animateClick:j,contentEl:D,globalTop:h,localTop:y,updateLocation:F}}}),ui=Symbol("Forwarded refs")
...
o&&l.push(...o)}}}}})}const vi=gt({id:String,...k(ii({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:$a}}),["absolute"])},"VMenu"),pi=It()({name:"VMenu",props:vi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"modelValue"),{scopeId:n}=Qr(),r=St(),i=t.computed((()=>e.id||`v-menu-${r}`)),s=t.ref(),u=t.inject(Hr,null),c=t.shallowRef(0)
async function d(e){const a=e.relatedTarget,l=e.target
if(await t.nextTick(),o.value&&a!==l&&s.value?.contentEl&&s.value?.globalTop&&![document,s.value.contentEl].includes(l)&&!s.value.contentEl.contains(l)){const e=K(s.value.contentEl)
e[0]?.focus()}}function v(e){u?.closeParents(e)}function p(t){if(!e.disabled)if("Tab"===t.key||"Enter"===t.key&&!e.closeOnContentClick){if("Enter"===t.key&&(t.target instanceof HTMLTextAreaElement||t.target instanceof HTMLInputElement&&t.target.closest("form")))return
...
a&&o.value?"ArrowDown"===t.key?(t.preventDefault(),Z(a,"next")):"ArrowUp"===t.key&&(t.preventDefault(),Z(a,"prev")):["ArrowDown","ArrowUp"].includes(t.key)&&(o.value=!0,t.preventDefault(),setTimeout((()=>setTimeout((()=>f(t))))))}t.provide(Hr,{register(){++c.value},unregister(){--c.value},closeParents(t){setTimeout((()=>{c.value||e.persistent||null!=t&&(!s.value?.contentEl||function(e,t){const a=e.clientX,l=e.clientY,o=t.getBoundingClientRect(),n=o.left,r=o.top,i=o.right,s=o.bottom
...
return t.createVNode(si,t.mergeProps({ref:s,id:i.value,class:["v-menu",e.class],style:e.style},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,absolute:!0,activatorProps:m.value,"onClick:outside":v,onKeydown:p},n),{activator:l.activator,default:function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createVNode(al,{root:"VMenu"},{default:()=>[l.default?.(...a)]})}})})),di({id:i,ΨopenChildren:c},s)}}),fi=gt({active:Boolean,disabled:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...ht(),...vl({transition:{component:Za}})},"VCounter"),mi=It()({name:"VCounter",functional:!0,props:fi(),setup(e,a){let{slots:l}=a
...
const o=yt("VVirtualScroll"),{dimensionStyles:n}=ol(e),{containerRef:r,markerRef:i,handleScroll:s,handleScrollend:u,handleItemResize:c,scrollToIndex:d,paddingTop:v,paddingBottom:p,computedItems:m}=Ii(e,t.toRef(e,"items"))
...
r.value===document.documentElement?(document[e]("scroll",s,{passive:!0}),document[e]("scrollend",u)):(r.value?.[e]("scroll",s,{passive:!0}),r.value?.[e]("scrollend",u))}t.onMounted((()=>{r.value=Tt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),$t((()=>{const a=m.value.map((a=>t.createVNode(Ci,{key:a.index,renderless:e.renderless,"onUpdate:height":e=>c(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
const{t:n}=ha(),r=t.ref(),i=t.ref(),s=t.ref(),u=ia(e,"menu"),c=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren||(u.value=e)}}),{items:d,transformIn:v,transformOut:p}=Vr(e),f=ia(e,"modelValue",[],(e=>v(null===e?[null]:P(e))),(t=>{const a=p(t)
...
return t.createVNode(xi,t.mergeProps({ref:r},u,{modelValue:S.value,"onUpdate:modelValue":[e=>S.value=e,Y],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:x.value,dirty:l,onChange:j,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!A.value,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:e.readonly,placeholder:l?void 0:e.placeholder,"onClick:clear":M,"onMousedown:control":O,onKeydown:z}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:D.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:H},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:E,selected:R.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:$,onFocusin:W,onFocusout:U,onScrollPassive:F,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},e.listProps),{default:()=>[o["prepend-item"]?.(),!I.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{title:n(e.noDataText)},null)),t.createVNode(Pi,{ref:d,renderless:!0,items:I.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
const{themeClasses:o}=xa(),{borderClasses:n}=bl(e),{backgroundColorClasses:r,backgroundColorStyles:i}=ul(t.toRef(e,"bgColor")),{densityClasses:s}=Al(e),{elevationClasses:u}=wl(e),{roundedClasses:c}=dl(e),{ssrBootStyles:d}=Cl(),v=t.computed((()=>Number(e.height)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0))),p=ia(e,"active",e.active),{layoutItemStyles:m,layoutIsReady:g}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:t.computed((()=>p.value?v.value:0)),elementSize:v,active:p,absolute:t.toRef(e,"absolute")})
return zl(e,Hl),Nt({VBtn:{baseColor:t.toRef(e,"baseColor"),color:t.toRef(e,"color"),density:t.toRef(e,"density"),stacked:t.computed((()=>"horizontal"!==e.mode)),variant:"text"}},{scoped:!0}),$t((()=>t.createVNode(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":p.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":"shift"===e.mode},o.value,r.value,n.value,s.value,u.value,c.value,e.class],style:[i.value,m.value,{height:f(v.value)},d.value,e.style]},{default:()=>[l.default&&t.createVNode("div",{class:"v-bottom-navigation__content"},[l.default()])]}))),g}}),Ki=gt({fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...ii({origin:"center center",scrollStrategy:"block",transition:{component:$a},zIndex:2400})},"VDialog"),Xi=It()({name:"VDialog",props:Ki(),emits:{"update:modelValue":e=>!0,afterLeave:()=>!0},setup(e,l){let{emit:o,slots:n}=l
...
const{t:r}=ha(),i=t.ref(),s=t.shallowRef(!1),u=t.shallowRef(!0),c=t.shallowRef(!1),d=t.ref(),v=t.ref(),p=ia(e,"menu"),f=t.computed({get:()=>p.value,set:e=>{p.value&&!e&&d.value?.ΨopenChildren||(p.value=e)}}),m=t.shallowRef(-1)
let g=!1
...
a.length>1&&(a.forEach((t=>{(t=t.trim())&&G(yr(e,t))})),B.value="")}t||(m.value=-1),u.value=!t}}),R=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:A.value.length))
...
return t===E.value[0].value}))&&G(T.value[0]),u.value=!0),"ArrowDown"===t.key&&$.value&&O.value?.focus("next"),"Enter"===t.key&&A.value&&(G(yr(e,A.value)),_.value&&(B.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&_.value&&x.value.length>0&&!A.value)return G(x.value[0],!1)
...
x.value=e?[a]:[],B.value=e&&!_.value?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function q(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function K(e){c.value=!1}function X(t){null!=t&&(""!==t||e.multiple||_.value)||(x.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(m.value=-1,f.value=!1,A.value)){if(e.multiple)return void G(yr(e,A.value))
if(!_.value)return
x.value.some((e=>{let{title:t}=e
return t===A.value}))?B.value="":G(yr(e,A.value))}})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=E.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
...
return t.createVNode(xi,t.mergeProps({ref:i},o,{modelValue:A.value,"onUpdate:modelValue":[e=>A.value=e,X],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:R.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!_.value,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:e.readonly,placeholder:l?void 0:e.placeholder,"onClick:clear":j,"onMousedown:control":H,onKeydown:U}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:M.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:Y},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:O,selected:F.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:z,onFocusin:q,onFocusout:K,onScrollPassive:L,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},e.listProps),{default:()=>[n["prepend-item"]?.(),!E.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(cr,{title:r(e.noDataText)},null)),t.createVNode(Pi,{ref:v,renderless:!0,items:E.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
return $t((()=>t.createVNode(Ja,{onAfterLeave:r},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-expansion-panel-text",e.class],style:e.style},[l.default&&n.value&&t.createVNode("div",{class:"v-expansion-panel-text__wrapper"},[l.default?.()])]),[[t.vShow,o.isSelected.value]])]}))),{}}}),$d=gt({color:String,expandIcon:{type:Mt,default:"$expand"},collapseIcon:{type:Mt,default:"$collapse"},hideActions:Boolean,focusable:Boolean,static:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean,...ht()},"VExpansionPanelTitle"),Md=It()({name:"VExpansionPanelTitle",directives:{Ripple:To},props:$d(),setup(e,a){let{slots:l}=a
const o=t.inject(Dd)
if(!o)throw new Error("[Vuetify] v-expansion-panel-title needs to be placed inside v-expansion-panel")
const{backgroundColorClasses:n,backgroundColorStyles:r}=ul(e,"color"),i=t.computed((()=>({collapseIcon:e.collapseIcon,disabled:o.disabled.value,expanded:o.isSelected.value,expandIcon:e.expandIcon,readonly:e.readonly}))),s=t.computed((()=>o.isSelected.value?e.collapseIcon:e.expandIcon))
return $t((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--focusable":e.focusable,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(i.value),!e.hideActions&&t.createVNode(al,{defaults:{VIcon:{icon:s.value}}},{default:()=>[t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?.(i.value)??t.createVNode(Xl,null,null)])]})]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Od=gt({title:String,text:String,bgColor:String,...Vl(),...Ol(),...cl(),...Ba(),...$d(),...Ed()},"VExpansionPanel"),Ld=It()({name:"VExpansionPanel",props:Od(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
const o=t.ref(),n=t.shallowRef(),{themeClasses:r}=ka(e),{backgroundColorClasses:i,backgroundColorStyles:s}=ul(t.toRef(e,"color")),{borderClasses:u}=bl(e),{elevationClasses:c}=wl(e),{roundedClasses:d}=dl(e),v=t.shallowRef(32),{resizeRef:p}=Qt((e=>{e.length&&(v.value=e[0].target.clientHeight)})),m=t.computed((()=>"auto"===e.height?v.value:parseInt(e.height,10)))
return ra((()=>e.app),(()=>{const a=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:m,elementSize:t.computed((()=>"auto"===e.height?void 0:m.value)),active:t.computed((()=>e.app)),absolute:t.toRef(e,"absolute")})
t.watchEffect((()=>{o.value=a.layoutItemStyles.value,n.value=a.layoutIsReady}))})),$t((()=>t.createVNode(e.tag,{ref:p,class:["v-footer",r.value,i.value,u.value,c.value,d.value,e.class],style:[s.value,e.app?o.value:{height:f(e.height)},e.style]},l))),e.app?n.value:{}}}),Xd=gt({...ht(),...sn()},"VForm"),Zd=It()({name:"VForm",props:Xd(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return $t((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[u.value,n.value,e.style]},[t.createVNode(t.Suspense,null,{default:()=>[t.createVNode(t.Fragment,null,[l.default?.()])]})]))),{getLayoutItem:r,items:i}}}),cv=gt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...ht(),...aa()},"VLayoutItem"),dv=It()({name:"VLayoutItem",props:cv(),setup(e,a){let{slots:l}=a
const{layoutItemStyles:o,layoutIsReady:n}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.toRef(e,"position"),elementSize:t.toRef(e,"size"),layoutSize:t.toRef(e,"size"),active:t.toRef(e,"modelValue"),absolute:t.toRef(e,"absolute")})
return $t((()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()]))),n}}),vv=gt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...ht(),...ll(),...Ba(),...vl({transition:"fade-transition"})},"VLazy"),pv=It()({name:"VLazy",directives:{intersect:ml},props:vv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const{dimensionStyles:o}=ol(e),{mainStyles:n,layoutIsReady:r}=la(),{ssrBootStyles:i}=Cl()
return $t((()=>t.createVNode(e.tag,{class:["v-main",{"v-main--scrollable":e.scrollable},e.class],style:[n.value,i.value,o.value,e.style]},{default:()=>[e.scrollable?t.createVNode("div",{class:"v-main__scroller"},[l.default?.()]):l.default?.()]}))),r}})
const yv=100,bv=20
...
return B.value?t*P.value:t})),R=t.computed((()=>["top","bottom"].includes(e.location)?0:x.value)),{layoutItemStyles:T,layoutItemScrimStyles:D,layoutIsReady:E}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:N,layoutSize:A,elementSize:R,active:t.computed((()=>h.value||B.value)),disableTransitions:t.computed((()=>B.value)),absolute:t.computed((()=>e.absolute||I.value&&"string"!=typeof F.value))}),{isStuck:F,stickyStyles:$}=function(e){let{rootEl:a,isSticky:l,layoutItemStyles:o}=e
...
if(a&&e in a)return a[e]}rf.version="3.6.15"
const uf=function(){return rf({components:Zp,directives:nf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},cf="3.6.15"
