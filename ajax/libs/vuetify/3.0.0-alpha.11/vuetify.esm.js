...
import { Fragment, isRef, ref, computed, provide, inject, getCurrentInstance, shallowReactive, toRaw, watchEffect, capitalize, camelize, h, watch, onBeforeUnmount, createVNode, mergeProps, Transition, onBeforeMount, nextTick, withDirectives, vShow, resolveDirective, toRef, resolveDynamicComponent, onMounted, unref, toRefs, reactive, defineComponent as defineComponent$1, TransitionGroup, effectScope, onScopeDispose, warn, toHandlers, Teleport, readonly, onBeforeUpdate, createTextVNode, vModelDynamic } from 'vue';
...
var VDefaultsProvider = defineComponent$1({
  props: {
    defaults: Object
  },
      ...
      return createVNode(Fragment, null, [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
        ...
        default: () => [hasContent.value && createVNode("div", mergeProps({
          ...
          default: () => [withDirectives(createVNode("div", {
            ...
            isActive
          })], 46, ["onKeydown"]), [[vShow, isActive.value], [resolveDirective("click-outside"), {
...
const VInput = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      }, [slots == null ? void 0 : (_slots$prepend = slots.prepend) == null ? void 0 : _slots$prepend.call(slots), props.prependIcon && createVNode(VIcon, {
        "icon": props.prependIcon
      }, null, 8, ["icon"])], 8, ["onClick"]), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), hasAppend && createVNode("div", {
        "class": "v-input__append",
        "onClick": e => emit('click:append', e)
      }, [slots == null ? void 0 : (_slots$append = slots.append) == null ? void 0 : _slots$append.call(slots), props.appendIcon && createVNode(VIcon, {
        "icon": props.appendIcon
  ...
  setup(props, {
    ...
    useRender(() => {
      ...
      return createVNode(VInput, mergeProps({
        ...
        default: () => [createVNode("div", {
        ...
        }, null, 8, ["icon"]), slots == null ? void 0 : (_slots$prependInner = slots.prependInner) == null ? void 0 : _slots$prependInner.call(slots, slotProps.value)], 8, ["onClick"]), createVNode("div", {
          ...
          default: () => [hasClear && ((_inputRef$value = inputRef.value) == null ? void 0 : _inputRef$value.value) && createVNode("div", {
        ...
        details: hasDetails && (() => {
          ...
          return createVNode(Fragment, null, [createVNode(MaybeTransition, {
            "transition": props.transition
          }, {
            default: () => [withDirectives(createVNode("div", {
              "class": "v-field__details"
            }, [props.hint], 512), [[vShow, props.hint && (props.persistentHint || slotProps.value.isFocused)]])]
  ...
  setup(props, {
    ...
    useRender(() => {
      ...
      return createVNode(VField, mergeProps({
        ...
        }) => createVNode(Fragment, null, [createVNode("input", mergeProps({
          "ref": inputRef,
          "type": "file",
        ...
        }, slotProps, restAttrs), null, 16, ["disabled", "multiple", "onClick", "onChange"]), isDirty.value && createVNode("div", {
          "class": fieldClass
  ...
  setup(props, {
    ...
    return () => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(!!(isClickable || isActive.value), 'v-list-item'), hasPrepend && (slots.prepend ? slots.prepend() : createVNode(VListItemAvatar, {
          "left": true
        }, {
          ...
          _: 1
        }), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), hasAppend && (slots.append ? slots.append() : createVNode(VListItemAvatar, {
          "right": true
        }, {
          default: () => [createVNode(VAvatar, {
            "density": props.density,
      ...
      return createVNode(VField, mergeProps({
        ...
        default: ({
          ...
          return createVNode(Fragment, null, [props.prefix && createVNode("span", {
            ...
            "size": 1,
            "type": props.type
          }, slotProps, restAttrs), null, 16, ["onUpdate:modelValue", "autofocus", "disabled", "placeholder", "type"]), [[vModelDynamic, model.value], [resolveDirective("intersect"), {
            handler: onIntersect
          }, null, {
            once: true
...
var VTimelineDivider = defineComponent$1({
...
export { components, createVuetify, directives, provideRtl, useDisplay, useRtl, useTheme, version };
