...
return t.withDirectives(t.createVNode(tl,t.mergeProps({class:["v-img",{"v-img--absolute":e.absolute,"v-img--booting":!P.value},r.value,s.value,e.class],style:[{width:f("auto"===e.width?p.value:e.width)},i.value,e.style]},a,{aspectRatio:h.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(N,null,null),t.createVNode(C,null,null),t.createVNode(B,null,null),t.createVNode(_,null,null),t.createVNode(I,null,null)]),default:n.default}),[[t.resolveDirective("intersect"),{handler:y,options:e.options},null,{once:!0}]])})),{currentSrc:c,image:d,state:v,naturalWidth:p,naturalHeight:m}}}),pl=st({border:[Boolean,Number,String]},"border")
...
No(e,t,go(t.oldValue))}},Io=st({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Ml},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Tt,appendIcon:Tt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:String,...pl(),...ut(),...Nl(),...Qa(),...ml(),...Dl(),...eo(),...Xl(),...oo(),...nl(),...so(),...jl(),...xa({tag:"button"}),...ga(),...Bl({variant:"elevated"})},"VBtn"),Bo=kt()({name:"VBtn",props:Io(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=ya(e),{borderClasses:r}=fl(e),{densityClasses:i}=Cl(e),{dimensionStyles:s}=Ja(e),{elevationClasses:u}=gl(e),{loaderClasses:c}=to(e),{locationStyles:d}=Zl(e),{positionClasses:v}=no(e),{roundedClasses:p}=rl(e),{sizeClasses:f,sizeStyles:m}=Hl(e),g=El(e,e.symbol,!1),h=io(e,l),y=t.computed((()=>void 0!==e.active?e.active:h.isLink.value?h.isActive?.value:g?.isSelected.value)),b=t.computed((()=>y.value?e.activeColor??e.color:e.color)),V=t.computed((()=>({color:g?.isSelected.value&&(!h.isLink.value||h.isActive?.value)||!g||h.isActive?.value?b.value??e.baseColor:e.baseColor,variant:e.variant}))),{colorClasses:w,colorStyles:S,variantClasses:k}=Pl(V),x=t.computed((()=>g?.disabled.value||e.disabled)),N=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border))),C=t.computed((()=>{if(void 0!==e.value&&"symbol"!=typeof e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value}))
function _(e){x.value||h.isLink.value&&(e.metaKey||e.ctrlKey||e.shiftKey||0!==e.button||"_blank"===l.target)||(h.navigate?.(e),g?.toggle())}return function(e,a){t.watch((()=>e.isActive?.value),(l=>{e.isLink.value&&l&&a&&t.nextTick((()=>{a(!0)}))}),{immediate:!0})}(h,g?.select),Rt((()=>{const a=h.isLink.value?"a":e.tag,l=!(!e.prependIcon&&!o.prepend),b=!(!e.appendIcon&&!o.append),V=!(!e.icon||!0===e.icon)
return t.withDirectives(t.createVNode(a,{type:"a"===a?void 0:"button",class:["v-btn",g?.selectedClass.value,{"v-btn--active":y.value,"v-btn--block":e.block,"v-btn--disabled":x.value,"v-btn--elevated":N.value,"v-btn--flat":e.flat,"v-btn--icon":!!e.icon,"v-btn--loading":e.loading,"v-btn--readonly":e.readonly,"v-btn--slim":e.slim,"v-btn--stacked":e.stacked},n.value,r.value,w.value,i.value,u.value,c.value,v.value,p.value,f.value,k.value,e.class],style:[S.value,s.value,d.value,m.value,e.style],"aria-busy":!!e.loading||void 0,disabled:x.value||void 0,href:h.href.value,tabindex:e.loading||e.readonly?-1:void 0,onClick:_,value:C.value},{default:()=>[Il(!0,"v-btn"),!e.icon&&l&&t.createVNode("span",{key:"prepend",class:"v-btn__prepend"},[o.prepend?t.createVNode(Za,{key:"prepend-defaults",disabled:!e.prependIcon,defaults:{VIcon:{icon:e.prependIcon}}},o.prepend):t.createVNode(Ul,{key:"prepend-icon",icon:e.prependIcon},null)]),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[!o.default&&V?t.createVNode(Ul,{key:"content-icon",icon:e.icon},null):t.createVNode(Za,{key:"content-defaults",disabled:!V,defaults:{VIcon:{icon:e.icon}}},{default:()=>[o.default?.()??e.text]})]),!e.icon&&b&&t.createVNode("span",{key:"append",class:"v-btn__append"},[o.append?t.createVNode(Za,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VIcon:{icon:e.appendIcon}}},o.append):t.createVNode(Ul,{key:"append-icon",icon:e.appendIcon},null)]),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[o.loader?.()??t.createVNode(ql,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,width:"2"},null)])]}),[[_o,!x.value&&!!e.ripple,"",{center:!!e.icon}]])})),{group:g}}}),Po=st({...Io({icon:"$menu",variant:"text"})},"VAppBarNavIcon"),Ao=kt()({name:"VAppBarNavIcon",props:Po(),setup(e,a){let{slots:l}=a
...
!0!==o&&(!1===o||"string"==typeof o?a.push(o||""):console.warn(`${o} is not a valid value. Rule functions must return boolean true or a string.`))}return i.value=a,m.value=!1,s.value=t,i.value}return t.onBeforeMount((()=>{r?.register({id:y.value,vm:h,validate:w,reset:b,resetValidation:V})})),t.onBeforeUnmount((()=>{r?.unregister(y.value)})),t.onMounted((async()=>{p.value.lazy||await w(!p.value.eager),r?.update(y.value,f.value,v.value)})),ta((()=>p.value.input||p.value.invalidInput&&!1===f.value),(()=>{t.watch(n,(()=>{if(null!=n.value)w()
...
return e}return l.delete(t),l},select:()=>null},Hn={open:e=>{let{id:a,value:l,opened:o,parents:n}=e
if(l){let e=t.toRaw(n.get(a))
for(o.add(a);null!=e&&e!==a;)o.add(e),e=t.toRaw(n.get(e))
return o}return o.delete(a),o},select:()=>null},Wn={open:Hn.open,select:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(!a)return l
const n=[]
let r=o.get(t)
...
const l=t.ref(new Map),o=t.ref(new Map),n=aa(e,"opened",e.opened,(e=>new Set(t.toRaw(e))),(e=>[...e.values()])),r=t.computed((()=>{if("object"==typeof e.activeStrategy)return e.activeStrategy
...
n.set(c,a?"on":l?"off":"indeterminate"),c=t.toRaw(i.get(c))}return e&&!o&&0===Array.from(n.entries()).reduce(((e,t)=>{let[a,l]=t
...
const r=io(e,l),i=t.computed((()=>void 0===e.value?r.href.value:e.value)),{activate:s,isActivated:u,select:c,isOpen:d,isSelected:v,isIndeterminate:p,isGroupActivator:f,root:m,parent:g,openOnSelect:h}=Zn(i,!1),y=On(),b=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||(m.activatable.value?u.value:v.value)))),V=t.computed((()=>!1!==e.link&&r.isLink.value)),w=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||!!y&&(m.selectable.value||m.activatable.value||null!=e.value)))),S=t.computed((()=>e.rounded||e.nav)),k=t.computed((()=>e.color??e.activeColor)),x=t.computed((()=>({color:b.value?k.value??e.baseColor:e.baseColor,variant:e.variant})))
t.watch((()=>r.isActive?.value),(e=>{e&&null!=g.value&&m.open(g.value,!0),e&&h(e)}),{immediate:!0})
const{themeClasses:N}=ya(e),{borderClasses:C}=fl(e),{colorClasses:_,colorStyles:I,variantClasses:B}=Pl(x),{densityClasses:P}=Cl(e),{dimensionStyles:A}=Ja(e),{elevationClasses:R}=gl(e),{roundedClasses:T}=rl(S),D=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),E=t.computed((()=>({isActive:b.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
function F(t){n("click",t),w.value&&(r.navigate?.(t),f||(m.activatable.value?s(!u.value,t):(m.selectable.value||null!=e.value)&&c(!v.value,t)))}function $(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),F(e))}return Rt((()=>{const a=V.value?"a":e.tag,l=o.title||null!=e.title,n=o.subtitle||null!=e.subtitle,i=!(!e.appendAvatar&&!e.appendIcon),s=!(!i&&!o.append),u=!(!e.prependAvatar&&!e.prependIcon),c=!(!u&&!o.prepend)
var d,v
return y?.updateHasPrepend(c),e.activeColor&&(d="active-color",v=["color","base-color"],v=Array.isArray(v)?v.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${v.at(-1)}'`:`'${v}'`,t.warn(`[Vuetify UPGRADE] '${d}' is deprecated, use ${v} instead.`)),t.withDirectives(t.createVNode(a,{class:["v-list-item",{"v-list-item--active":b.value,"v-list-item--disabled":e.disabled,"v-list-item--link":w.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!c&&y?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&b.value},N.value,C.value,_.value,P.value,R.value,D.value,T.value,B.value,e.class],style:[I.value,A.value,e.style],href:r.href.value,tabindex:w.value?y?-2:0:void 0,onClick:F,onKeydown:w.value&&!V.value&&$},{default:()=>[Il(w.value||b.value,"v-list-item"),c&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(Za,{key:"prepend-defaults",disabled:!u,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(E.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Mo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Ul,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(lr,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(ar,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(E.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(Za,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(E.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ul,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Mo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),w.value&&e.ripple]])})),{activate:s,isActivated:u,isGroupActivator:f,isSelected:v,list:y,select:c}}}),rr=st({color:String,inset:Boolean,sticky:Boolean,title:String,...ut(),...xa()},"VListSubheader"),ir=kt()({name:"VListSubheader",props:rr(),setup(e,a){let{slots:l}=a
...
return Rt((()=>t.createVNode(qa,{onAfterLeave:r},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-expansion-panel-text",e.class],style:e.style},[l.default&&n.value&&t.createVNode("div",{class:"v-expansion-panel-text__wrapper"},[l.default?.()])]),[[t.vShow,o.isSelected.value]])]}))),{}}}),Dd=st({color:String,expandIcon:{type:Tt,default:"$expand"},collapseIcon:{type:Tt,default:"$collapse"},hideActions:Boolean,focusable:Boolean,static:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean,...ut(),...Qa()},"VExpansionPanelTitle"),Ed=kt()({name:"VExpansionPanelTitle",directives:{Ripple:_o},props:Dd(),setup(e,a){let{slots:l}=a
const o=t.inject(Ad)
if(!o)throw new Error("[Vuetify] v-expansion-panel-title needs to be placed inside v-expansion-panel")
const{backgroundColorClasses:n,backgroundColorStyles:r}=ol(e,"color"),{dimensionStyles:i}=Ja(e),s=t.computed((()=>({collapseIcon:e.collapseIcon,disabled:o.disabled.value,expanded:o.isSelected.value,expandIcon:e.expandIcon,readonly:e.readonly}))),u=t.computed((()=>o.isSelected.value?e.collapseIcon:e.expandIcon))
return Rt((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--focusable":e.focusable,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,i.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(s.value),!e.hideActions&&t.createVNode(Za,{defaults:{VIcon:{icon:u.value}}},{default:()=>[t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?.(s.value)??t.createVNode(Ul,null,null)])]})]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Fd=st({title:String,text:String,bgColor:String,...ml(),...Dl(),...nl(),...xa(),...Dd(),...Rd()},"VExpansionPanel"),$d=kt()({name:"VExpansionPanel",props:Fd(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
if(a&&e in a)return a[e]}tf.version="3.6.13-3.7.0-beta.0.0"
const lf=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return tf({components:Yp,directives:ef,...e})},of="3.6.13-3.7.0-beta.0.0"
