...
if(null==e||""===e)return
const a=Number(e)
return isNaN(a)?String(e):isFinite(a)?`${a}${t}`:void 0}function m(e){return null!==e&&"object"==typeof e&&!Array.isArray(e)}function g(e){let t
...
function B(e){const[t,a]=k(e,[N]),l=x(t,_),[o,n]=k(a,["class","style","id",/^data-/])
...
const ua="$vuetify.",ca=(e,t)=>e.replace(/\{(\d+)\}/g,((e,a)=>String(t[Number(a)]))),da=(e,t,a)=>function(l){for(var o=arguments.length,n=new Array(o>1?o-1:0),r=1;r<o;r++)n[r-1]=arguments[r]
...
Ao(e,t,So(t.oldValue))}},Do=gt({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Hl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Mt,appendIcon:Mt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},...yl(),...ht(),...Pl(),...ll(),...Vl(),...Ol(),...no(),...to(),...uo(),...cl(),...fo(),...Gl(),...Ba({tag:"button"}),...wa(),...Dl({variant:"elevated"})},"VBtn"),Eo=It()({name:"VBtn",props:Do(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
const o=ia(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=un(e),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!P(""===o.value?null:o.value).length&&!P(""===n.value?null:n.value).length))),c=t.computed((()=>e.errorMessages?.length?P(e.errorMessages).concat(i.value).slice(0,Math.max(0,Number(e.maxErrors))):i.value)),d=t.computed((()=>{let t=(e.validateOn??r.validateOn?.value)||"input"
...
return t.createVNode(Fn,t.mergeProps(a,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value,e.class],style:e.style}),{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),Ln=gt({activeClass:String,appendAvatar:String,appendIcon:Mt,closable:Boolean,closeIcon:{type:Mt,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:Mt,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},modelValue:{type:Boolean,default:!0},onClick:Y(),onClickOnce:Y(),...yl(),...ht(),...Pl(),...Vl(),...Ol(),...cl(),...fo(),...Gl(),...Ba({tag:"span"}),...wa(),...Dl({variant:"tonal"})},"VChip"),zn=It()({name:"VChip",directives:{Ripple:To},props:Ln(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return $t((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),sr=Bt("v-list-item-title"),ur=gt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Mt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},value:null,onClick:Y(),onClickOnce:Y(),...yl(),...ht(),...Pl(),...ll(),...Vl(),...cl(),...fo(),...Ba(),...wa(),...Dl({variant:"text"})},"VListItem"),cr=It()({name:"VListItem",directives:{Ripple:To},props:ur(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
B("last")}e.preventDefault()}}function I(e){S.value=!0}function B(e){if(k.value)return Z(k.value,e)}return $t((()=>t.createVNode(e.tag,{ref:k,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},n.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:x,onFocusout:N,onFocus:C,onKeydown:_,onMousedown:I},{default:()=>[t.createVNode(gr,{items:o.value,returnObject:e.returnObject},l)]}))),{open:f,select:g,focus:B,children:p,parents:m,getPath:h}}}),Nr=Bt("v-list-img"),Cr=gt({start:Boolean,end:Boolean,...ht(),...Ba()},"VListItemAction"),_r=It()({name:"VListItemAction",props:Cr(),setup(e,a){let{slots:l}=a
...
t.provide(Jr,i)
const s=t.shallowRef(Number(a.value))
ra(e,(()=>{const e=ei.at(-1)?.[1]
s.value=e?e+10:Number(a.value),n&&ei.push([o.uid,s.value]),r?.activeChildren.add(o.uid),t.onScopeDispose((()=>{if(n){const e=t.toRaw(ei).findIndex((e=>e[0]===o.uid))
...
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&e?.beforeEach&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e.beforeEach(((e,t,a)=>{mo?r?l(a):a():setTimeout((()=>r?l(a):a())),mo=!0})),n=e?.afterEach((()=>{mo=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(z,(t=>{V.value&&v.value?(t(!1),e.persistent?H():v.value=!1):t()}))}))
const j=t.ref()
function H(){e.noClickAnimation||c.value&&he(c.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:At})}function W(){r("afterEnter")}function U(){y(),r("afterLeave")}return t.watch((()=>v.value&&(e.absolute||e.contained)&&null==A.value),(e=>{if(e){const e=Tt(s.value)
e&&e!==document.scrollingElement&&(j.value=e.scrollTop)}})),$t((()=>t.createVNode(t.Fragment,null,[o.activator?.({isActive:v.value,targetRef:_,props:t.mergeProps({ref:x},I.value,e.activatorProps)}),T.value&&h.value&&t.createVNode(t.Teleport,{disabled:!A.value,to:A.value},{default:()=>[t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":v.value,"v-overlay--contained":e.contained},p.value,m.value,e.class],style:[S.value,{"--v-overlay-opacity":e.opacity,top:f(j.value)},e.style],ref:s,onKeydown:L},D,n),[t.createVNode(ri,t.mergeProps({color:b,modelValue:v.value&&!!e.scrim,ref:u},P.value),null),t.createVNode(pl,{appear:!0,persisted:!0,transition:e.transition,target:N.value,onAfterEnter:W,onAfterLeave:U},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:c,class:["v-overlay__content",e.contentClass],style:[R.value,E.value]},B.value,e.contentProps),[o.default?.({isActive:v})]),[[t.vShow,v.value],[t.resolveDirective("click-outside"),{handler:$,closeConditional:M,include:()=>[k.value]}]])]})])]})]))),{activatorEl:k,scrimEl:u,target:N,animateClick:H,contentEl:c,globalTop:V,localTop:w,updateLocation:F}}}),ui=Symbol("Forwarded refs")
...
function p(t,a){e.autofocus&&t&&a[0].target?.focus?.()}const f=t.ref(),m=t.ref(),g=t.ref(),h=t.computed((()=>wi.includes(e.type)||e.persistentPlaceholder||i.value||e.active))
...
t.nextTick((()=>{l.selectionStart=e[0],l.selectionEnd=e[1]}))}}return $t((()=>{const a=!!(n.counter||!1!==e.counter&&null!=e.counter),o=!(!a&&!n.details),[s,k]=B(l),{modelValue:x,...N}=pn.filterProps(e),C=Vi.filterProps(e)
...
let P=-1
function R(){c.value&&d.value&&(I=0,B=0,window.clearTimeout(P),D())}let T=-1
...
t-B>500?(I=Math.sign(e-_),v=d.value.offsetTop):I=e-_,_=e,B=t,window.clearTimeout(P),P=window.setTimeout(R,500),D()},handleScrollend:R,handleItemResize:function(e,t){const a=y[e],l=n.value
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Ii=gt({items:{type:Array,default:()=>[]},renderless:Boolean,...Ci(),...ht(),...ll()},"VVirtualScroll"),Bi=It()({name:"VVirtualScroll",props:Ii(),setup(e,a){let{slots:l}=a
const o=yt("VVirtualScroll"),{dimensionStyles:n}=ol(e),{calculateVisibleItems:r,containerRef:i,markerRef:s,handleScroll:u,handleScrollend:c,handleItemResize:d,scrollToIndex:v,paddingTop:p,paddingBottom:m,computedItems:g}=_i(e,t.toRef(e,"items"))
...
i.value===document.documentElement?(document[e]("scroll",u,{passive:!0}),document[e]("scrollend",c)):(i.value?.[e]("scroll",u,{passive:!0}),i.value?.[e]("scrollend",c))}t.onMounted((()=>{i.value=Tt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),$t((()=>{const a=g.value.map((a=>t.createVNode(Ni,{key:a.key,renderless:e.renderless,"onUpdate:height":e=>d(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
function Pi(e,a){const l=t.shallowRef(!1)
let o
...
break}}}}}const Ai=gt({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Mt,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...hr({itemChildren:!1})},"Select"),Ri=gt({...Ai(),...x(Si({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:{component:$a}})},"VSelect"),Ti=It()({name:"VSelect",props:Ri(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.ref(),s=t.ref(),u=ia(e,"menu"),d=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren.size||(u.value=e)}}),{items:v,transformIn:p,transformOut:f}=Vr(e),m=ia(e,"modelValue",[],(e=>p(null===e?[null]:P(e))),(t=>{const a=f(t)
...
let w,S=""
const k=t.computed((()=>e.hideSelected?v.value.filter((t=>!m.value.some((a=>(e.valueComparator||c)(a,t))))):v.value)),x=t.computed((()=>e.hideNoData&&!k.value.length||h.isReadonly.value||h.isDisabled.value)),N=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),C=t.ref(),_=Pi(C,r)
function I(t){e.openOnClear&&(d.value=!0)}function B(){x.value||(d.value=!d.value)}function A(e){le(e)&&R(e)}function R(e){if(!e.key||h.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(e.key)&&e.preventDefault(),["Enter","ArrowDown"," "].includes(e.key)&&(d.value=!0),["Escape","Tab"].includes(e.key)&&(d.value=!1),"Home"===e.key?C.value?.focus("first"):"End"===e.key&&C.value?.focus("last")
if(!le(e))return
...
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Xl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),di({isFocused:b,menu:d,select:T},r)}}),Di=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),Ei=gt({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function Fi(e,a,l,o){const n=t.shallowRef([]),r=t.shallowRef(new Map),i=t.computed((()=>o?.transform?t.unref(a).map((e=>[e,o.transform(e)])):t.unref(a)))
return t.watchEffect((()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],o=a?.default??Di,n=!!a?.filterKeys&&P(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
const l=d[t]
p.push(l),f.set(l.value,a)})),n.value=p,r.value=f})),{filteredItems:n,filteredMatches:r,getMatches:function(e){return r.value.get(e.value)}}}const $i=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:Boolean,search:String,...Ei({filterKeys:["title"]}),...Ai(),...x(Si({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VAutocomplete"),Mi=It()({name:"VAutocomplete",props:$i(),emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),d=t.ref(),v=t.ref(),p=ia(e,"menu"),f=t.computed({get:()=>p.value,set:e=>{p.value&&!e&&d.value?.ΨopenChildren.size||(p.value=e)}}),m=t.shallowRef(-1),g=t.computed((()=>r.value?.color)),h=t.computed((()=>f.value?e.closeText:e.openText)),{items:y,transformIn:b,transformOut:V}=Vr(e),{textColorClasses:w,textColorStyles:S}=sl(g),k=ia(e,"search",""),x=ia(e,"modelValue",[],(e=>b(null===e?[null]:P(e))),(t=>{const a=V(t)
return e.multiple?a:a[0]??null})),N=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:x.value.length)),C=un(e),{filteredItems:_,getMatches:I}=Fi(e,y,(()=>s.value?"":k.value)),B=t.computed((()=>e.hideSelected?_.value.filter((e=>!x.value.some((t=>t.value===e.value)))):_.value)),A=t.computed((()=>!(!e.chips&&!o.chip))),R=t.computed((()=>A.value||!!o.selection)),T=t.computed((()=>x.value.map((e=>e.props.value)))),D=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&k.value===B.value[0]?.title)&&B.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!B.value.length||C.isReadonly.value||C.isDisabled.value)),F=t.ref(),$=Pi(F,r)
...
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Xl,{class:"v-autocomplete__menu-icon",icon:e.menuIcon,onMousedown:L,onClick:J,"aria-label":n(h.value),title:n(h.value),tabindex:"-1"},null):void 0])}})})),di({isFocused:i,isPristine:s,menu:f,search:k,filteredItems:_,select:X},r)}}),Oi=gt({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Mt,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...ht(),...to({location:"top end"}),...cl(),...Ba(),...wa(),...vl({transition:"scale-rotate-transition"})},"VBadge"),Li=It()({name:"VBadge",inheritAttrs:!1,props:Oi(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=ul(t.toRef(e,"color")),{roundedClasses:n}=dl(e),{t:r}=ha(),{textColorClasses:i,textColorStyles:s}=sl(t.toRef(e,"textColor")),{themeClasses:u}=xa(),{locationStyles:c}=ao(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?Number(e.offsetY??0):["left","right"].includes(t)?Number(e.offsetX??0):0)))
return $t((()=>{const d=Number(e.content),v=!e.max||isNaN(d)?e.content:d<=Number(e.max)?d:`${e.max}+`,[p,f]=k(a.attrs,["aria-atomic","aria-label","aria-live","role","title"])
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline},e.class]},f,{style:e.style}),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[a.slots.default?.(),t.createVNode(pl,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,l.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,d),"aria-live":"polite",role:"status"},p),[e.dot?void 0:a.slots.badge?a.slots.badge?.():e.icon?t.createVNode(Xl,{icon:e.icon},null):v]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),zi=gt({color:String,density:String,...ht()},"VBannerActions"),ji=It()({name:"VBannerActions",props:zi(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Hi=Bt("v-banner-text"),Wi=gt({avatar:String,bgColor:String,color:String,icon:Mt,lines:String,stacked:Boolean,sticky:Boolean,text:String,...yl(),...ht(),...Pl(),...ll(),...kn({mobile:null}),...Vl(),...to(),...uo(),...cl(),...Ba(),...wa()},"VBanner"),Ui=It()({name:"VBanner",props:Wi(),setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||u.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},m.value,o.value,r.value,i.value,s.value,d.value,p.value,f.value,e.class],style:[n.value,c.value,v.value,e.style],role:"banner"},{default:()=>[b&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!y,defaults:{VAvatar:{color:g.value,density:h.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(Wo,{key:"prepend-avatar",color:g.value,density:h.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(Hi,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(ji,{key:"actions"},l.actions)]})}))}}),Yi=gt({baseColor:String,bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...yl(),...ht(),...Pl(),...Vl(),...cl(),...aa({name:"bottom-navigation"}),...Ba({tag:"header"}),...Ml({selectedClass:"v-btn--selected"}),...wa()},"VBottomNavigation"),Gi=It()({name:"VBottomNavigation",props:Yi(),emits:{"update:active":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(al,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})})),di({},s)}}),Xi=gt({inset:Boolean,...qi({transition:"bottom-sheet-transition"})},"VBottomSheet"),Zi=It()({name:"VBottomSheet",props:Xi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"modelValue")
return $t((()=>{const a=Ki.filterProps(e)
return t.createVNode(Ki,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)})),{}}}),Qi=gt({divider:[Number,String],...ht()},"VBreadcrumbsDivider"),Ji=It()({name:"VBreadcrumbsDivider",props:Qi(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),es=gt({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...ht(),...fo(),...Ba({tag:"li"})},"VBreadcrumbsItem"),ts=It()({name:"VBreadcrumbsItem",props:es(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(ts,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(Ji,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),os=It()({name:"VCardActions",props:ht(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),ns=gt({opacity:[Number,String],...ht(),...Ba()},"VCardSubtitle"),rs=It()({name:"VCardSubtitle",props:ns(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),is=Bt("v-card-title"),ss=gt({appendAvatar:String,appendIcon:Mt,prependAvatar:String,prependIcon:Mt,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...ht(),...Pl()},"VCardItem"),us=It()({name:"VCardItem",props:ss(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(is,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(rs,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(al,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),cs=gt({opacity:[Number,String],...ht(),...Ba()},"VCardText"),ds=It()({name:"VCardText",props:cs(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-text",e.class],style:[{"--v-card-text-opacity":e.opacity},e.style]},l))),{}}}),vs=gt({appendAvatar:String,appendIcon:Mt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...yl(),...ht(),...Pl(),...ll(),...Vl(),...no(),...to(),...uo(),...cl(),...fo(),...Ba(),...wa(),...Dl({variant:"elevated"})},"VCard"),ps=It()({name:"VCard",directives:{Ripple:To},props:vs(),setup(e,a){let{attrs:l,slots:o}=a
...
function ms(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
t.touchendX=a.clientX,t.touchendY=a.clientY,t.end?.({originalEvent:e,...t}),fs(t)}(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
t.touchmoveX=a.clientX,t.touchmoveY=a.clientY,t.move?.({originalEvent:e,...t})}(e,t)}}const gs={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,o=a?.options??{passive:!0},n=t.instance?.$.uid
if(!l||!n)return
const r=ms(t.value)
...
V(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},hs=Symbol.for("vuetify:v-window"),ys=Symbol.for("vuetify:v-window-group"),bs=gt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},...ht(),...Ba(),...wa()},"VWindow"),Vs=It()({name:"VWindow",directives:{Touch:gs},props:bs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ka(e),{isRtl:n}=ba(),{t:r}=ha(),i=zl(e,ys),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
t.watch(f,((e,t)=>{const a=i.items.value.length,l=a-1
c.value=a<=2?e<t:e===l&&0===t||(0!==e||t!==l)&&e<t})),t.provide(hs,{transition:d,isReversed:c,transitionCount:v,transitionHeight:p,rootRef:s})
...
return $t((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value,e.class],style:e.style},{default:()=>[t.createVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[t.resolveDirective("touch"),V.value]]))),{group:i}}}),ws=gt({color:String,cycle:Boolean,delimiterIcon:{type:Mt,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...bs({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),Ss=It()({name:"VCarousel",props:ws(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"modelValue"),{t:n}=ha(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,Number(e.interval)>0?Number(e.interval):6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),$t((()=>{const a=Vs.filterProps(e)
return t.createVNode(Vs,t.mergeProps({ref:r},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-carousel",{"v-carousel--hide-delimiter-background":e.hideDelimiterBackground,"v-carousel--vertical-delimiters":e.verticalDelimiters},e.class],style:[{height:f(e.height)},e.style]}),{default:l.default,additional:a=>{let{group:r}=a
...
return l.item?l.item({props:o,item:e}):t.createVNode(Eo,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(oo,{class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})})),{}}}),ks=gt({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...ht(),...Ol(),...Xr()},"VWindowItem"),xs=It()({name:"VWindowItem",directives:{Touch:gs},props:ks(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(hs),n=Ll(e,ys),{isBooted:r}=Cl()
...
return $t((()=>t.createVNode(pl,{transition:p.value,disabled:!r.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value,e.class],style:e.style},[m.value&&l.default?.()]),[[t.vShow,n.isSelected.value]])]}))),{groupItem:n}}}),Ns=gt({...gl(),...ks()},"VCarouselItem"),Cs=It()({name:"VCarouselItem",inheritAttrs:!1,props:Ns(),setup(e,a){let{slots:l,attrs:o}=a
$t((()=>{const a=hl.filterProps(e),n=xs.filterProps(e)
return t.createVNode(xs,t.mergeProps({class:["v-carousel-item",e.class]},n),{default:()=>[t.createVNode(hl,t.mergeProps(o,a),l)]})}))}}),_s=Bt("v-code","code"),Is=_t({name:"VColorPickerCanvas",props:gt({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...ht()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
const Bs={h:0,s:0,v:0,a:1},Ps={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:et,from:at},As={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:lt,from:ot},Rs={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:ct,from:function(e){return at(ut(e))}},Ts={rgb:{...Ps,inputs:Ps.inputs?.slice(0,3)},rgba:Ps,hsl:{...As,inputs:As.inputs.slice(0,3)},hsla:As,hex:{...Rs,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:Rs},Ds=e=>{let{label:a,...l}=e
return t.createVNode("div",{class:"v-color-picker-edit__input"},[t.createVNode("input",l,null),t.createVNode("span",null,[a])])},Es=_t({name:"VColorPickerEdit",props:gt({color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Ts).includes(e)},modes:{type:Array,default:()=>Object.keys(Ts),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys(Ts).includes(e)))},...ht()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
const o=t.computed((()=>e.modes.map((e=>({...Ts[e],name:e}))))),n=t.computed((()=>{const t=o.value.find((t=>t.name===e.mode))
if(!t)return[]
...
return $t((()=>t.createVNode("div",{class:["v-color-picker-edit",e.class],style:e.style},[n.value?.map((e=>t.createVNode(Ds,e,null))),o.value.length>1&&t.createVNode(Eo,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)]))),{}}}),Fs=Symbol.for("vuetify:v-slider")
function $s(e,t,a){const l="vertical"===a,o=t.getBoundingClientRect(),n="touches"in e?e.touches[0]:e
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const Ms=gt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...cl(),...Vl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),Os=e=>{const a=t.computed((()=>parseFloat(e.min))),l=t.computed((()=>parseFloat(e.max))),o=t.computed((()=>Number(e.step)>0?parseFloat(e.step):0)),n=t.computed((()=>Math.max(R(o.value),R(a.value))))
...
return(l?d.value:d.value!==s.value)&&(p=1-p),h(v.value+p*(f.value-v.value))}const R=e=>{const t=P(e)
null!=t&&r({value:t}),C.value=!1,_.value=0},T=e=>{const l=P(e)
B.value=i(e),B.value&&(C.value=!0,B.value.contains(e.target)?_.value=$s(e,B.value,a.direction):(_.value=0,null!=l&&n({value:l})),null!=l&&o({value:l}),t.nextTick((()=>B.value?.focus())))},D={passive:!0,capture:!0}
function E(e){const t=P(e)
...
return!!t})))),j={activeThumbRef:B,color:t.toRef(a,"color"),decimals:g,disabled:S,direction:t.toRef(a,"direction"),elevation:t.toRef(a,"elevation"),hasLabels:z,isReversed:u,indexFromEnd:d,min:v,max:f,mousePressed:C,numTicks:w,onSliderMousedown:function(e){0===e.button&&(e.preventDefault(),T(e),window.addEventListener("mousemove",E,D),window.addEventListener("mouseup",F,{passive:!1}))},onSliderTouchstart:function(e){T(e),window.addEventListener("touchmove",E,D),e.target?.addEventListener("touchend",$,{passive:!1})},parsedTicks:L,parseMouseMove:P,position:M,readonly:t.toRef(a,"readonly"),rounded:t.toRef(a,"rounded"),roundValue:h,showTicks:O,startOffset:_,step:m,thumbSize:y,thumbColor:k,thumbLabel:t.toRef(a,"thumbLabel"),ticks:t.toRef(a,"ticks"),tickSize:b,trackColor:x,trackContainerRef:I,trackFillColor:N,trackSize:V,vertical:c}
return t.provide(Fs,j),j},zs=gt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,...ht()},"VSliderThumb"),js=It()({name:"VSliderThumb",directives:{Ripple:To},props:zs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(Fs),{isRtl:r,rtlClasses:i}=ba()
...
return t.createVNode("div",{class:"v-slider__container",onMousedown:y.value?void 0:p,onTouchstartPassive:y.value?void 0:f},[t.createVNode("input",{id:o.value,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:s.value},null),t.createVNode(Ws,{ref:m,start:0,stop:S.value},{"tick-label":l["tick-label"]}),t.createVNode(js,{ref:n,"aria-describedby":r.value,focused:b.value,min:u.value,max:c.value,modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,position:S.value,elevation:e.elevation,onFocus:V,onBlur:w,ripple:e.ripple,name:e.name},{"thumb-label":l["thumb-label"]})])}})})),{}}}),Gs=_t({name:"VColorPickerPreview",props:gt({color:{type:Object},disabled:Boolean,hideAlpha:Boolean,...ht()},"VColorPickerPreview")(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
const o=new AbortController
async function r(){if(!n)return
const t=new window.EyeDropper
try{const a=at(Je((await t.open({signal:o.signal})).sRGBHex))
l("update:color",{...e.color??Bs,...a})}catch(e){}}return t.onUnmounted((()=>o.abort())),$t((()=>t.createVNode("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[n&&t.createVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Eo,{onClick:r,icon:"$eyeDropper",variant:"plain",density:"comfortable"},null)]),t.createVNode("div",{class:"v-color-picker-preview__dot"},[t.createVNode("div",{style:{background:rt(e.color??Bs)}},null)]),t.createVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(Ys,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Bs,h:t}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(Ys,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Bs,a:t}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])]))),{}}})
var qs={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const Ks=gt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]}))}(qs)},disabled:Boolean,color:Object,maxHeight:[Number,String],...ht()},"VColorPickerSwatches")
const Xs=_t({name:"VColorPickerSwatches",props:Ks(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return t.onBeforeMount((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),Nt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),$t((()=>{const l=Qs.filterProps(e)
return t.createVNode(Qs,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",r.value,e.class],style:[{"--v-color-picker-color-hsv":rt({...n.value??Bs,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(Is,{key:"canvas",color:n.value,"onUpdate:color":s,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(Gs,{key:"preview",color:n.value,"onUpdate:color":s,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(Es,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:n.value,"onUpdate:color":s,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(Xs,{key:"swatches",color:n.value,"onUpdate:color":s,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
const eu=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...Ei({filterKeys:["title"]}),...Ai({hideNoData:!0,returnObject:!0}),...x(Si({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VCombobox"),tu=It()({name:"VCombobox",props:eu(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
...
let h=!1
const y=t.computed((()=>i.value?.color)),b=t.computed((()=>m.value?e.closeText:e.openText)),{items:V,transformIn:w,transformOut:S}=Vr(e),{textColorClasses:k,textColorStyles:x}=sl(y),N=ia(e,"modelValue",[],(e=>w(P(e))),(t=>{const a=S(t)
return e.multiple?a:a[0]??null})),C=un(e),_=t.computed((()=>!(!e.chips&&!n.chip))),B=t.computed((()=>_.value||!!n.selection)),A=t.shallowRef(e.multiple||B.value?"":N.value[0]?.title??""),R=t.computed({get:()=>A.value,set:t=>{if(A.value=t??"",e.multiple||B.value||(N.value=[yr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
...
return t===F.value[0].value}))&&K(D.value[0]),u.value=!0),"ArrowDown"===t.key&&M.value&&L.value?.focus("next"),"Enter"===t.key&&R.value&&(K(yr(e,R.value)),B.value&&(A.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&B.value&&N.value.length>0&&!R.value)return K(N.value[0],!1)
...
N.value=e?[a]:[],A.value=e&&!B.value?a.title:"",t.nextTick((()=>{m.value=!1,u.value=!0}))}}function X(e){s.value=!0,setTimeout((()=>{d.value=!0}))}function Z(e){d.value=!1}function Q(t){null!=t&&(""!==t||e.multiple||B.value)||(N.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(g.value=-1,m.value=!1,R.value)){if(e.multiple)return void K(yr(e,R.value))
if(!B.value)return
...
default:r=n??{timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(a,r).format(o)}function uu(e,t){return e.getTime()>t.getTime()}function cu(e,t){return e.getTime()===t.getTime()}function du(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0)}class vu{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return ru(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
let o=[]
const n=lu(e),r=ou(e),i=a??au[t.slice(-2).toUpperCase()]??0,s=(n.getDay()-i+7)%7,u=(r.getDay()-i+7)%7
...
t.setDate(t.getDate()+e),o.push(t)}return o.length>0&&l.push(o),l}(e,this.locale,t?Number(t):void 0)}startOfWeek(e,t){return function(e,t,a){const l=a??au[t.slice(-2).toUpperCase()]??0,o=new Date(e)
for(;o.getDay()!==l;)o.setDate(o.getDate()-1)
return o}(e,this.locale,t?Number(t):void 0)}endOfWeek(e){return function(e,t){const a=new Date(e),l=((au[t.slice(-2).toUpperCase()]??0)+6)%7
for(;a.getDay()!==l;)a.setDate(a.getDate()+1)
return a}(e,this.locale)}startOfMonth(e){return lu(e)}endOfMonth(e){return ou(e)}format(e,t){return su(e,t,this.locale,this.formats)}isEqual(e,t){return cu(e,t)}isValid(e){return function(e){const t=new Date(e)
return t instanceof Date&&!isNaN(t.getTime())}(e)}isWithinRange(e,t){return function(e,t){return uu(e,t[0])&&function(e,t){return e.getTime()<t.getTime()}(e,t[1])}(e,t)}isAfter(e,t){return uu(e,t)}isAfterDay(e,t){return function(e,t){return uu(du(e),du(t))}(e,t)}isBefore(e,t){return!uu(e,t)&&!cu(e,t)}isSameDay(e,t){return function(e,t){return e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameMonth(e,t){return function(e,t){return e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameYear(e,t){return function(e,t){return e.getFullYear()===t.getFullYear()}(e,t)}setMinutes(e,t){return function(e,t){const a=new Date(e)
...
default:return l.getTime()-o.getTime()}}(e,t,a)}getWeekdays(e){return function(e,t){const a=t??au[e.slice(-2).toUpperCase()]??0
return p(7).map((t=>{const l=new Date(iu)
return l.setDate(iu.getDate()+a+t),new Intl.DateTimeFormat(e,{weekday:"narrow"}).format(l)}))}(this.locale,e?Number(e):void 0)}getYear(e){return function(e){return e.getFullYear()}(e)}getMonth(e){return function(e){return e.getMonth()}(e)}getDate(e){return function(e){return e.getDate()}(e)}getNextMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()+1,1)}(e)}getPreviousMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()-1,1)}(e)}getHours(e){return function(e){return e.getHours()}(e)}getMinutes(e){return function(e){return e.getMinutes()}(e)}startOfDay(e){return du(e)}endOfDay(e){return function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}(e)}startOfYear(e){return function(e){return new Date(e.getFullYear(),0,1)}(e)}endOfYear(e){return function(e){return new Date(e.getFullYear(),11,31)}(e)}}const pu=Symbol.for("vuetify:date-options"),fu=Symbol.for("vuetify:date-adapter")
...
return t.watch(a.current,(t=>{l.locale=e.locale[t]??t??l.locale})),l}function gu(){const e=t.inject(pu)
if(!e)throw new Error("[Vuetify] Could not find injected date options")
return mu(e,ha())}const hu=gt({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"}},"VConfirmEdit"),yu=It()({name:"VConfirmEdit",props:hu(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return $t((()=>t.createVNode(t.Fragment,null,[o.default?.({model:r,save:u,cancel:d,isPristine:s.value,get actions(){return p=!0,v}}),!p&&v()]))),{save:u,cancel:d,isPristine:s}}}),bu=gt({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Vu=Symbol.for("vuetify:datatable:expanded")
function wu(e){const a=t.toRef(e,"expandOnClick"),l=ia(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return t.provide(Vu,r),r}function Su(){const e=t.inject(Vu)
if(!e)throw new Error("foo")
return e}const ku=gt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),xu=Symbol.for("vuetify:data-table-group")
function Nu(e){return{groupBy:ia(e,"groupBy")}}function Cu(e){const{disableSort:a,groupBy:l,sortBy:o}=e,n=t.ref(new Set)
...
return t.provide(xu,i),i}function _u(){const e=t.inject(xu)
if(!e)throw new Error("Missing group!")
return e}function Iu(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
...
n.push({depth:a,id:s,key:i,value:o,items:r.length?Iu(e,r,a+1,s):e,type:"group"})})),n}function Bu(e,t){const a=[]
for(const l of e)"type"in l&&"group"===l.type?(null!=l.value&&a.push(l),(t.has(l.id)||null==l.value)&&a.push(...Bu(l.items,t))):a.push(l)
return a}function Pu(e,a,l){return{flatItems:t.computed((()=>{if(!a.value.length)return e.value
return Bu(Iu(e.value,a.value.map((e=>e.key))),l.value)}))}}function Au(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
const i=yt("VDataTable"),s=t.computed((()=>({page:a.value,itemsPerPage:l.value,sortBy:o.value,groupBy:n.value,search:r.value})))
let u=null
t.watch(s,(()=>{c(u,s.value)||(u&&u.search!==s.value.search&&(a.value=1),i.emit("update:options",s.value),u=s.value)}),{deep:!0,immediate:!0})}const Ru=gt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Tu=Symbol.for("vuetify:data-table-pagination")
function Du(e){return{page:ia(e,"page",void 0,(e=>Number(e??1))),itemsPerPage:ia(e,"itemsPerPage",void 0,(e=>Number(e??10)))}}function Eu(e){const{page:a,itemsPerPage:l,itemsLength:o}=e,n=t.computed((()=>-1===l.value?0:l.value*(a.value-1))),r=t.computed((()=>-1===l.value?o.value:Math.min(o.value,n.value+l.value))),i=t.computed((()=>-1===l.value||0===o.value?1:Math.ceil(o.value/l.value)))
...
return t.provide(Tu,s),s}function Fu(e){const a=yt("usePaginatedItems"),{items:l,startIndex:o,stopIndex:n,itemsPerPage:r}=e,i=t.computed((()=>r.value<=0?l.value:l.value.slice(o.value,n.value)))
return t.watch(i,(e=>{a.emit("update:currentItems",e)}),{immediate:!0}),{paginatedItems:i}}const $u={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},Mu={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return Mu.select({items:a,value:t,selected:l})}},Ou={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a,selected:l}=e
return Ou.select({items:a,value:t,selected:l})}},Lu=gt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:{type:Function,default:c}},"DataTable-select"),zu=Symbol.for("vuetify:data-table-selection")
function ju(e,a){let{allItems:l,currentPage:o}=a
...
switch(e.selectStrategy){case"single":return $u
case"all":return Ou
default:return Mu}}))
...
return t.provide(zu,p),p}function Hu(){const e=t.inject(zu)
if(!e)throw new Error("Missing selection!")
return e}const Wu=gt({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),Uu=Symbol.for("vuetify:data-table-sort")
function Yu(e){return{sortBy:ia(e,"sortBy"),mustSort:t.toRef(e,"mustSort"),multiSort:t.toRef(e,"multiSort")}}function Gu(e){const{sortBy:a,mustSort:l,multiSort:o,page:n}=e
...
return t.provide(Uu,r),r}function qu(){const e=t.inject(Uu)
if(!e)throw new Error("Missing sort!")
return e}function Ku(e,a,l,o){const n=ha(),r=t.computed((()=>l.value.length?function(e,t,a,l){const o=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),n=e.map((e=>[e,l?.transform?l.transform(e):e]))
...
return{sortedItems:r}}const Xu=gt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function Zu(e,t){return{type:"item",value:e.returnObject?t:v(t,e.itemValue),selectable:v(t,e.itemSelectable,!0),raw:t}}function Qu(e){const a=t.computed((()=>function(e,t){const a=[]
for(const l of t)a.push(Zu(e,l))
return a}(e,e.items)))
return{items:a}}const Ju=gt({search:String,loading:Boolean,...ht(),...Xu(),...Lu(),...Wu(),...Ru({itemsPerPage:5}),...bu(),...ku(),...Ei(),...Ba(),...vl({transition:{component:Ha,hideOnLeave:!0}})},"VDataIterator"),ec=It()({name:"VDataIterator",props:Ju(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"groupBy"),n=t.toRef(e,"search"),{items:r}=Qu(e),{filteredItems:i}=Fi(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=Yu(e),{page:d,itemsPerPage:v}=Du(e),{toggleSort:p}=Gu({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:f,opened:m,extractRows:g,isGroupOpen:h,toggleGroup:y}=Cu({groupBy:o,sortBy:s}),{sortedItems:b}=Ku(e,i,f,{transform:e=>e.raw}),{flatItems:V}=Pu(b,o,m),w=t.computed((()=>V.value.length)),{startIndex:S,stopIndex:k,pageCount:x,prevPage:N,nextPage:C,setItemsPerPage:_,setPage:I}=Eu({page:d,itemsPerPage:v,itemsLength:w}),{paginatedItems:B}=Fu({items:V,startIndex:S,stopIndex:k,itemsPerPage:v}),P=t.computed((()=>g(B.value))),{isSelected:A,select:R,selectAll:T,toggleSelect:D}=ju(e,{allItems:r,currentPage:P}),{isExpanded:E,toggleExpand:F}=wu(e)
Au({page:d,itemsPerPage:v,sortBy:s,groupBy:o,search:n})
...
return Math.max(0,Math.floor(Number(((t-a*l)/a).toFixed(2))))}const y=t.computed((()=>{if(f.value<=0||isNaN(f.value)||f.value>Number.MAX_SAFE_INTEGER)return[]
if(g.value<=0)return[]
...
return $t((()=>{const a=ac.filterProps(e)
return t.createVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createVNode("span",null,[o(e.itemsPerPageText)]),t.createVNode(Ti,{items:v.value,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined","hide-details":!0},null)]),t.createVNode("div",{class:"v-data-table-footer__info"},[t.createVNode("div",null,[o(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(ac,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable","first-aria-label":e.firstPageLabel,"last-aria-label":e.lastPageLabel,length:r.value,"next-aria-label":e.nextPageLabel,"previous-aria-label":e.prevPageLabel,rounded:!0,"show-first-last-page":!0,"total-visible":e.showCurrentPage?1:0,variant:"plain"},a),null)])])})),{}}}),nc=(rc={align:{type:String,default:"start"},fixed:Boolean,fixedOffset:[Number,String],height:[Number,String],lastFixed:Boolean,noPadding:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},ic=(e,a)=>{let{slots:l}=a
const o=e.tag??"td"
return t.createVNode(o,{class:["v-data-table__td",{"v-data-table-column--fixed":e.fixed,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap},`v-data-table-column--align-${e.align}`],style:{height:f(e.height),width:f(e.width),maxWidth:f(e.maxWidth),left:f(e.fixedOffset||null)}},{default:()=>[l.default?.()]})},ic.props=rc,ic)
var rc,ic
const sc=gt({headers:Array},"DataTable-header"),uc=Symbol.for("vuetify:data-table-headers"),cc={title:"",sortable:!1},dc={...cc,width:48}
function vc(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e.children)for(const a of e.children)vc(a,t)
else t.push(e)
return t}function pc(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Set
for(const a of e)a.key&&t.add(a.key),a.children&&pc(a.children,t)
return t}function fc(e){if(e.key)return"data-table-group"===e.key?cc:["data-table-expand","data-table-select"].includes(e.key)?dc:void 0}function mc(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
return e.children?Math.max(t,...e.children.map((e=>mc(e,t+1)))):t}function gc(e,t){const a=[]
let l=0
...
const n=[]
let r=1
for(;e>0;){const{element:a,priority:i}=o.dequeue(),s=t-l-mc(a)
if(n.push({...a,rowspan:s??1,colspan:a.children?vc(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
o.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(n)}return{columns:e.map((e=>vc(e))).flat(),headers:a}}function hc(e){const t=[]
for(const a of e){const e={...fc(a),...a},l=e.key??("string"==typeof e.value?e.value:null),o=e.value??l??null,n={...e,key:l,value:o,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?hc(e.children):void 0}
t.push(n)}return t}function yc(e,a){const l=t.ref([]),o=t.ref([]),n=t.ref({}),r=t.ref({}),i=t.ref({})
t.watchEffect((()=>{const s=(e.headers||Object.keys(e.items[0]??{}).map((e=>({key:e,title:t.capitalize(e)})))).slice(),u=pc(s)
...
else t?isNaN(Number(e.width))?Me(`Multiple fixed columns should have a static width (key: ${e.key})`):e.minWidth=Math.max(Number(e.width)||0,Number(e.minWidth)||0):e.lastFixed=!0,t=!0
...
const d=Math.max(...c.map((e=>mc(e))))+1,v=gc(c,d)
...
return t.provide(uc,s),s}function bc(){const e=t.inject(uc)
if(!e)throw new Error("Missing headers!")
return e}const Vc=gt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Mt,default:"$sortAsc"},sortDescIcon:{type:Mt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...kn(),...no()},"VDataTableHeaders"),wc=It()({name:"VDataTableHeaders",props:Vc(),setup(e,a){let{slots:l}=a
const{t:o}=ha(),{toggleSort:n,sortBy:r,isSorted:i}=qu(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=Hu(),{columns:v,headers:p}=bc(),{loaderClasses:m}=ro(e)
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(nc,{class:"v-data-table-group-header-row__column"},{default:()=>[t.createVNode(Eo,{size:"small",variant:"text",icon:a,onClick:r},null),t.createVNode("span",null,[e.item.value]),t.createVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const e=i(d.value),a=s(d.value)&&!e,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(en,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),xc=gt({index:Number,item:Object,cellProps:[Object,Function],onClick:Y(),onContextmenu:Y(),onDblclick:Y(),...kn()},"VDataTableRow"),Nc=It()({name:"VDataTableRow",props:xc(),setup(e,a){let{slots:l}=a
const{displayClasses:o,mobile:n}=xn(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=Hu(),{isExpanded:v,toggleExpand:p}=Su(),{toggleSort:f,sortBy:m,isSorted:g}=qu(),{columns:h}=bc()
...
return t.createVNode(nc,t.mergeProps({align:a.align,class:{"v-data-table__td--expanded-row":"data-table-expand"===a.key,"v-data-table__td--select-row":"data-table-select"===a.key},fixed:a.fixed,fixedOffset:a.fixedOffset,lastFixed:a.lastFixed,maxWidth:n.value?void 0:a.maxWidth,noPadding:"data-table-select"===a.key||"data-table-expand"===a.key,nowrap:a.nowrap,width:n.value?void 0:a.width},S,k),{default:()=>{if(l[y]&&!n.value)return l[y]?.(V)
...
return n.value?t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??e])]):e}})}))])))}}),Cc=gt({loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...kn()},"VDataTableRows"),_c=It()({name:"VDataTableRows",inheritAttrs:!1,props:Cc(),setup(e,a){let{attrs:l,slots:o}=a
const{columns:n}=bc(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=Su(),{isSelected:u,toggleSelect:c}=Hu(),{toggleGroup:d,isGroupOpen:v}=_u(),{t:p}=ha(),{mobile:f}=xn(e)
...
return o["group-header"]?o["group-header"](e):t.createVNode(kc,t.mergeProps({key:`group-header_${a.id}`,item:a},Rt(l,":group-header",(()=>e))),o)}const m={index:p,item:a.raw,internalItem:a,columns:n.value,isExpanded:s,toggleExpand:i,isSelected:u,toggleSelect:c},g={...m,props:t.mergeProps({key:`item_${a.key??a.index}`,onClick:r.value?()=>{i(a)}:void 0,index:p,item:a,cellProps:e.cellProps,mobile:f.value},Rt(l,":row",(()=>m)),"function"==typeof e.rowProps?e.rowProps({item:m.item,index:m.index,internalItem:m.internalItem}):e.rowProps)}
return t.createVNode(t.Fragment,{key:g.props.key},[o.item?o.item(g):t.createVNode(Nc,g.props,o),s(a)&&o["expanded-row"]?.(m)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),Ic=gt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...ht(),...Pl(),...Ba(),...wa()},"VTable"),Bc=It()({name:"VTable",props:Ic(),setup(e,a){let{slots:l,emit:o}=a
const{themeClasses:n}=ka(e),{densityClasses:r}=Al(e)
return $t((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},n.value,r.value,e.class],style:e.style},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),Pc=gt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
function Ac(e,t,a){return t.map(((t,l)=>function(e,t,a,l){const o=e.returnObject?t:v(t,e.itemValue),n=v(t,e.itemSelectable,!0),r=l.reduce(((e,a)=>(null!=a.key&&(e[a.key]=v(t,a.value)),e)),{})
return{type:"item",key:e.returnObject?v(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function Rc(e,a){return{items:t.computed((()=>Ac(e,e.items,a.value)))}}const Tc=gt({...Cc(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...bu(),...ku(),...sc(),...Pc(),...Lu(),...Wu(),...Vc(),...Ic()},"DataTable"),Dc=gt({...Ru(),...Tc(),...Ei(),...lc()},"VDataTable"),Ec=It()({name:"VDataTable",props:Dc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Nu(e),{sortBy:r,multiSort:i,mustSort:s}=Yu(e),{page:u,itemsPerPage:c}=Du(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:f,sortRawFunctions:m,filterFunctions:g}=yc(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:h}=Rc(e,v),y=t.toRef(e,"search"),{filteredItems:b}=Fi(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=Gu({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:x,toggleGroup:N}=Cu({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:C}=Ku(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:m}),{flatItems:_}=Pu(C,n,S),I=t.computed((()=>_.value.length)),{startIndex:B,stopIndex:P,pageCount:A,setItemsPerPage:R}=Eu({page:u,itemsPerPage:c,itemsLength:I}),{paginatedItems:T}=Fu({items:_,startIndex:B,stopIndex:P,itemsPerPage:c}),D=t.computed((()=>k(T.value))),{isSelected:E,select:F,selectAll:$,toggleSelect:M,someSelected:O,allSelected:L}=ju(e,{allItems:h,currentPage:D}),{isExpanded:z,toggleExpand:j}=wu(e)
Au({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
return $t((()=>{const a=oc.filterProps(e),n=wc.filterProps(e),r=_c.filterProps(e),i=Bc.filterProps(e)
return t.createVNode(Bc,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(H.value),default:()=>o.default?o.default(H.value):t.createVNode(t.Fragment,null,[o.colgroup?.(H.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(wc,n,o)]),o.thead?.(H.value),!e.hideDefaultBody&&t.createVNode("tbody",null,[o["body.prepend"]?.(H.value),o.body?o.body(H.value):t.createVNode(_c,t.mergeProps(l,r,{items:T.value}),o),o["body.append"]?.(H.value)]),o.tbody?.(H.value),o.tfoot?.(H.value)]),bottom:()=>o.bottom?o.bottom(H.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(fr,null,null),t.createVNode(oc,a,{prepend:o["footer.prepend"]})])})})),{}}}),Fc=gt({...Tc(),...ku(),...Ci(),...Ei()},"VDataTableVirtual"),$c=It()({name:"VDataTableVirtual",props:Fc(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Nu(e),{sortBy:r,multiSort:i,mustSort:s}=Yu(e),{disableSort:u}=t.toRefs(e),{columns:c,headers:d,filterFunctions:v,sortFunctions:p,sortRawFunctions:m}=yc(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:g}=Rc(e,c),h=t.toRef(e,"search"),{filteredItems:y}=Fi(e,g,h,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:b}=Gu({sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:V,opened:w,extractRows:S,isGroupOpen:k,toggleGroup:x}=Cu({groupBy:n,sortBy:r,disableSort:u}),{sortedItems:N}=Ku(e,y,V,{transform:e=>({...e.raw,...e.columns}),sortFunctions:p,sortRawFunctions:m}),{flatItems:C}=Pu(N,n,w),_=t.computed((()=>S(C.value))),{isSelected:I,select:B,selectAll:P,toggleSelect:A,someSelected:R,allSelected:T}=ju(e,{allItems:_,currentPage:_}),{isExpanded:D,toggleExpand:E}=wu(e),{containerRef:F,markerRef:$,paddingTop:M,paddingBottom:O,computedItems:L,handleItemResize:z,handleScroll:j,handleScrollend:H}=_i(e,C),W=t.computed((()=>L.value.map((e=>e.raw))))
Au({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
$t((()=>{const a=wc.filterProps(e),n=_c.filterProps(e),r=Bc.filterProps(e)
return t.createVNode(Bc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(U.value),wrapper:()=>t.createVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[o.colgroup?.(U.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(wc,a,o)]),!e.hideDefaultBody&&t.createVNode("tbody",null,[t.createVNode("tr",{ref:$,style:{height:f(M.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(U.value),t.createVNode(_c,t.mergeProps(l,n,{items:W.value}),{...o,item:e=>t.createVNode(Ni,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>z(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Nc,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(U.value),t.createVNode("tr",{style:{height:f(O.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])])])]),bottom:()=>o.bottom?.(U.value)})}))}}),Mc=gt({itemsLength:{type:[Number,String],required:!0},...Ru(),...Tc(),...lc()},"VDataTableServer"),Oc=It()({name:"VDataTableServer",props:Mc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Nu(e),{sortBy:r,multiSort:i,mustSort:s}=Yu(e),{page:u,itemsPerPage:c}=Du(e),{disableSort:d}=t.toRefs(e),v=t.computed((()=>parseInt(e.itemsLength,10))),{columns:p,headers:f}=yc(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:m}=Rc(e,p),{toggleSort:g}=Gu({sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:h,isGroupOpen:y,toggleGroup:b,extractRows:V}=Cu({groupBy:n,sortBy:r,disableSort:d}),{pageCount:w,setItemsPerPage:S}=Eu({page:u,itemsPerPage:c,itemsLength:v}),{flatItems:k}=Pu(m,n,h),{isSelected:x,select:N,selectAll:C,toggleSelect:_,someSelected:I,allSelected:B}=ju(e,{allItems:m,currentPage:m}),{isExpanded:P,toggleExpand:A}=wu(e),R=t.computed((()=>V(m.value)))
Au({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef(e,"search")}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
$t((()=>{const a=oc.filterProps(e),n=wc.filterProps(e),r=_c.filterProps(e),i=Bc.filterProps(e)
return t.createVNode(Bc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(T.value),default:()=>o.default?o.default(T.value):t.createVNode(t.Fragment,null,[o.colgroup?.(T.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(wc,n,o)]),o.thead?.(T.value),!e.hideDefaultBody&&t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(T.value),o.body?o.body(T.value):t.createVNode(_c,t.mergeProps(l,r,{items:k.value}),o),o["body.append"]?.(T.value)]),o.tbody?.(T.value),o.tfoot?.(T.value)]),bottom:()=>o.bottom?o.bottom(T.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(fr,null,null),t.createVNode(oc,a,{prepend:o["footer.prepend"]})])})}))}}),Lc=gt({fluid:{type:Boolean,default:!1},...ht(),...ll(),...Ba()},"VContainer"),zc=It()({name:"VContainer",props:Lc(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ba(),{dimensionStyles:n}=ol(e)
return $t((()=>t.createVNode(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},o.value,e.class],style:[n.value,e.style]},l))),{}}}),jc=gn.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),Hc=gn.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Wc=gn.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Uc={col:Object.keys(jc),offset:Object.keys(Hc),order:Object.keys(Wc)}
function Yc(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const Gc=["auto","start","end","center","baseline","stretch"],qc=gt({cols:{type:[Boolean,String,Number],default:!1},...jc,offset:{type:[String,Number],default:null},...Hc,order:{type:[String,Number],default:null},...Wc,alignSelf:{type:String,default:null,validator:e=>Gc.includes(e)},...ht(),...Ba()},"VCol"),Kc=It()({name:"VCol",props:qc(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in Uc)Uc[a].forEach((l=>{const o=e[l],n=Yc(a,l,o)
n&&t.push(n)}))
const l=t.some((e=>e.startsWith("v-col-")))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t}))
return()=>t.h(e.tag,{class:[o.value,e.class],style:e.style},l.default?.())}}),Xc=["start","end","center"],Zc=["space-between","space-around","space-evenly"]
function Qc(e,a){return gn.reduce(((l,o)=>(l[e+t.capitalize(o)]=a(),l)),{})}const Jc=[...Xc,"baseline","stretch"],ed=e=>Jc.includes(e),td=Qc("align",(()=>({type:String,default:null,validator:ed}))),ad=[...Xc,...Zc],ld=e=>ad.includes(e),od=Qc("justify",(()=>({type:String,default:null,validator:ld}))),nd=[...Xc,...Zc,"stretch"],rd=e=>nd.includes(e),id=Qc("alignContent",(()=>({type:String,default:null,validator:rd}))),sd={align:Object.keys(td),justify:Object.keys(od),alignContent:Object.keys(id)},ud={align:"align",justify:"justify",alignContent:"align-content"}
function cd(e,t,a){let l=ud[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const dd=gt({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:ed},...td,justify:{type:String,default:null,validator:ld},...od,alignContent:{type:String,default:null,validator:rd},...id,...ht(),...Ba()},"VRow"),vd=It()({name:"VRow",props:dd(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in sd)sd[a].forEach((l=>{const o=e[l],n=cd(a,l,o)
n&&t.push(n)}))
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t}))
return()=>t.h(e.tag,{class:["v-row",o.value,e.class],style:e.style},l.default?.())}}),pd=Bt("v-spacer","div","VSpacer"),fd=gt({active:{type:[String,Array],default:void 0},disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Mt,default:"$next"},prevIcon:{type:Mt,default:"$prev"},modeIcon:{type:Mt,default:"$subgroup"},text:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),md=It()({name:"VDatePickerControls",props:fd(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:text":()=>!0},setup(e,a){let{emit:l}=a
...
function s(){l("click:prev")}function u(){l("click:next")}function c(){l("click:year")}function d(){l("click:month")}return $t((()=>t.createVNode("div",{class:["v-date-picker-controls"]},[t.createVNode(Eo,{class:"v-date-picker-controls__month-btn","data-testid":"month-btn",disabled:o.value,text:e.text,variant:"text",rounded:!0,onClick:d},null),t.createVNode(Eo,{class:"v-date-picker-controls__mode-btn","data-testid":"year-btn",disabled:n.value,density:"comfortable",icon:e.modeIcon,variant:"text",onClick:c},null),t.createVNode(pd,null,null),t.createVNode("div",{class:"v-date-picker-controls__month"},[t.createVNode(Eo,{"data-testid":"prev-month",disabled:r.value,icon:e.prevIcon,variant:"text",onClick:s},null),t.createVNode(Eo,{"data-testid":"next-month",disabled:i.value,icon:e.nextIcon,variant:"text",onClick:u},null)])]))),{}}}),gd=gt({appendIcon:Mt,color:String,header:String,transition:String,onClick:Y()},"VDatePickerHeader"),hd=It()({name:"VDatePickerHeader",props:gd(),emits:{click:()=>!0,"click:append":()=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.createVNode("div",{class:["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value],style:r.value,onClick:i},[o.prepend&&t.createVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(pl,{key:"content",name:e.transition},{default:()=>[t.createVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode(al,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(Eo,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),yd=gt({allowedDates:[Array,Function],disabled:{type:Boolean,default:null},displayValue:null,modelValue:Array,month:[Number,String],max:null,min:null,showAdjacentMonths:Boolean,year:[Number,String],weekdays:{type:Array,default:()=>[0,1,2,3,4,5,6]},weeksInMonth:{type:String,default:"dynamic"},firstDayOfWeek:[Number,String]},"calendar")
function bd(e){const a=gu(),l=ia(e,"modelValue",[],(e=>P(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=ia(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
const l=a.date(t)
return!(!e.min||!a.isAfter(a.date(e.min),l))||(!(!e.max||!a.isAfter(l,a.date(e.max)))||(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?!e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"==typeof e.allowedDates&&!e.allowedDates(l)))}return{displayValue:o,daysInMonth:v,daysInWeek:d,genDays:c,model:l,weeksInMonth:u,weekDays:s,weekNumbers:p}}const Vd=gt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},...x(yd(),["displayValue"])},"VDatePickerMonth"),wd=It()({name:"VDatePickerMonth",props:Vd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=t.ref(),{daysInMonth:r,model:i,weekNumbers:s}=bd(e),u=gu(),c=t.shallowRef(),d=t.shallowRef(),v=t.shallowRef(!1),p=t.computed((()=>v.value?e.reverseTransition:e.transition))
...
r.value=e}(n)}
return o.month?.({month:a,i:n,props:i})??t.createVNode(Eo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),xd=gt({color:String,height:[String,Number],min:null,max:null,modelValue:Number},"VDatePickerYears"),Nd=It()({name:"VDatePickerYears",props:xd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=gu(),r=ia(e,"modelValue"),i=t.computed((()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
return o.year?.({year:a,i:n,props:i})??t.createVNode(Eo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Cd=Bt("v-picker-title"),_d=gt({bgColor:String,landscape:Boolean,title:String,hideHeader:Boolean,...Zs()},"VPicker"),Id=It()({name:"VPicker",props:_d(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color"))
return $t((()=>{const a=Qs.filterProps(e),r=!(!e.title&&!l.title)
return t.createVNode(Qs,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(Cd,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(al,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}}),Bd=gt({header:{type:String,default:"$vuetify.datePicker.header"},...fd(),...Vd({weeksInMonth:"static"}),...x(Sd(),["modelValue"]),...x(xd(),["modelValue"]),..._d({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Pd=It()({name:"VDatePicker",props:Bd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=gu(),{t:r}=ha(),i=ia(e,"modelValue",void 0,(e=>P(e)),(t=>e.multiple?t:t[0])),s=ia(e,"viewMode"),u=t.computed((()=>{const t=n.date(e.min)
return e.min&&n.isValid(t)?t:null})),c=t.computed((()=>{const t=n.date(e.max)
return e.max&&n.isValid(t)?t:null})),d=t.computed((()=>{const e=n.date()
let t=e
return i.value?.[0]?t=n.date(i.value[0]):u.value&&n.isBefore(e,u.value)?t=u.value:c.value&&n.isAfter(e,c.value)&&(t=c.value),t&&n.isValid(t)?t:e})),v=t.ref(Number(e.month??n.getMonth(n.startOfMonth(d.value)))),p=t.ref(Number(e.year??n.getYear(n.startOfYear(n.setMonth(d.value,v.value))))),f=t.shallowRef(!1),m=t.computed((()=>e.multiple&&i.value.length>1?r("$vuetify.datePicker.itemsSelected",i.value.length):i.value[0]&&n.isValid(i.value[0])?n.format(n.date(i.value[0]),"normalDateWithWeekday"):r(e.header))),g=t.computed((()=>{let e=n.date()
return e=n.setDate(e,1),e=n.setMonth(e,v.value),e=n.setYear(e,p.value),n.format(e,"monthAndYear")})),h=t.computed((()=>`date-picker-header${f.value?"-reverse":""}-transition`)),y=t.computed((()=>{if(e.disabled)return!0
const t=[]
if("month"!==s.value)t.push("prev","next")
else{let e=n.date()
if(e=n.startOfMonth(e),e=n.setMonth(e,v.value),e=n.setYear(e,p.value),u.value){const a=n.addDays(n.startOfMonth(e),-1)
n.isAfter(u.value,a)&&t.push("prev")}if(c.value){const a=n.addDays(n.endOfMonth(e),1)
n.isAfter(a,c.value)&&t.push("next")}}return t}))
function b(){v.value<11?v.value++:(p.value++,v.value=0,C(p.value)),N(v.value)}function V(){v.value>0?v.value--:(p.value--,v.value=11,C(p.value)),N(v.value)}function w(){s.value="month"}function S(){s.value="months"===s.value?"month":"months"}function k(){s.value="year"===s.value?"month":"year"}function N(e){"months"===s.value&&S(),l("update:month",e)}function C(e){"year"===s.value&&k(),l("update:year",e)}return t.watch(i,((e,t)=>{const a=P(t),l=P(e)
if(!l.length)return
const o=n.date(a[a.length-1]),r=n.date(l[l.length-1]),i=n.getMonth(r),s=n.getYear(r)
i!==v.value&&(v.value=i,N(v.value)),s!==p.value&&(p.value=s,C(p.value)),f.value=n.isBefore(o,r)})),$t((()=>{const a=Id.filterProps(e),l=md.filterProps(e),n=hd.filterProps(e),d=wd.filterProps(e),f=x(kd.filterProps(e),["modelValue"]),_=x(Nd.filterProps(e),["modelValue"]),I={header:m.value,transition:h.value}
return t.createVNode(Id,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(al,{defaults:{VDatePickerHeader:{...I}}},{default:()=>[o.header?.(I)]}):t.createVNode(hd,t.mergeProps({key:"header"},n,I,{onClick:"month"!==s.value?w:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(md,t.mergeProps(l,{disabled:y.value,text:g.value,"onClick:next":b,"onClick:prev":V,"onClick:month":S,"onClick:year":k}),null),t.createVNode(Ha,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(kd,t.mergeProps({key:"date-picker-months"},f,{modelValue:v.value,"onUpdate:modelValue":[e=>v.value=e,N],min:u.value,max:c.value,year:p.value}),null):"year"===s.value?t.createVNode(Nd,t.mergeProps({key:"date-picker-years"},_,{modelValue:p.value,"onUpdate:modelValue":[e=>p.value=e,C],min:u.value,max:c.value}),null):t.createVNode(wd,t.mergeProps({key:"date-picker-month"},d,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:v.value,"onUpdate:month":[e=>v.value=e,N],year:p.value,"onUpdate:year":[e=>p.value=e,C],min:u.value,max:c.value}),null)]})]),actions:o.actions})})),{}}}),Ad=gt({actionText:String,bgColor:String,color:String,icon:Mt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...ht(),...ll(),...Gl({size:void 0}),...wa()},"VEmptyState"),Rd=It()({name:"VEmptyState",props:Ad(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return $t((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--focusable":e.focusable,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,i.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(s.value),!e.hideActions&&t.createVNode(al,{defaults:{VIcon:{icon:u.value}}},{default:()=>[t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?.(s.value)??t.createVNode(Xl,null,null)])]})]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Md=gt({title:String,text:String,bgColor:String,...Vl(),...Ol(),...cl(),...Ba(),...Fd(),...Dd()},"VExpansionPanel"),Od=It()({name:"VExpansionPanel",props:Md(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Ll(e,Td),{backgroundColorClasses:n,backgroundColorStyles:r}=ul(e,"bgColor"),{elevationClasses:i}=wl(e),{roundedClasses:s}=dl(e),u=t.computed((()=>o?.disabled.value||e.disabled)),c=t.computed((()=>o.group.items.value.reduce(((e,t,a)=>(o.group.selected.value.includes(t.id)&&e.push(a),e)),[]))),d=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==1))})),v=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==-1))}))
return t.provide(Td,o),$t((()=>{const a=!(!l.text&&!e.text),c=!(!l.title&&!e.title),p=$d.filterProps(e),f=Ed.filterProps(e)
return t.createVNode(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":o.isSelected.value,"v-expansion-panel--before-active":d.value,"v-expansion-panel--after-active":v.value,"v-expansion-panel--disabled":u.value},s.value,n.value,e.class],style:[r.value,e.style]},{default:()=>[t.createVNode("div",{class:["v-expansion-panel__shadow",...i.value]},null),t.createVNode(al,{defaults:{VExpansionPanelTitle:{...p},VExpansionPanelText:{...f}}},{default:()=>[c&&t.createVNode($d,{key:"title"},{default:()=>[l.title?l.title():e.title]}),a&&t.createVNode(Ed,{key:"text"},{default:()=>[l.text?l.text():e.text]}),l.default?.()]})]})})),{groupItem:o}}}),Ld=["default","accordion","inset","popout"],zd=gt({flat:Boolean,...Ml(),...S(Md(),["bgColor","collapseIcon","color","eager","elevation","expandIcon","focusable","hideActions","readonly","ripple","rounded","tile","static"]),...wa(),...ht(),...Ba(),variant:{type:String,default:"default",validator:e=>Ld.includes(e)}},"VExpansionPanels"),jd=It()({name:"VExpansionPanels",props:zd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{next:o,prev:n}=zl(e,Td),{themeClasses:r}=ka(e),i=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return Nt({VExpansionPanel:{bgColor:t.toRef(e,"bgColor"),collapseIcon:t.toRef(e,"collapseIcon"),color:t.toRef(e,"color"),eager:t.toRef(e,"eager"),elevation:t.toRef(e,"elevation"),expandIcon:t.toRef(e,"expandIcon"),focusable:t.toRef(e,"focusable"),hideActions:t.toRef(e,"hideActions"),readonly:t.toRef(e,"readonly"),ripple:t.toRef(e,"ripple"),rounded:t.toRef(e,"rounded"),static:t.toRef(e,"static")}}),$t((()=>t.createVNode(e.tag,{class:["v-expansion-panels",{"v-expansion-panels--flat":e.flat,"v-expansion-panels--tile":e.tile},r.value,i.value,e.class],style:e.style},{default:()=>[l.default?.({prev:n,next:o})]}))),{next:o,prev:n}}}),Hd=gt({app:Boolean,appear:Boolean,extended:Boolean,layout:Boolean,offset:Boolean,modelValue:{type:Boolean,default:!0},...x(Do({active:!0}),["location"]),...aa(),...to(),...vl({transition:"fab-transition"})},"VFab"),Wd=It()({name:"VFab",props:Hd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{ref:d,class:["v-fab",{"v-fab--absolute":e.absolute,"v-fab--app":!!e.app,"v-fab--extended":e.extended,"v-fab--offset":e.offset,[`v-fab--${u.value}`]:s.value,[`v-fab--${c.value}`]:s.value},e.class],style:[e.app?{...r.value}:{height:e.absolute?"100%":"inherit"},e.style]},[t.createVNode("div",{class:"v-fab__container"},[t.createVNode(pl,{appear:e.appear,transition:e.transition},{default:()=>[t.withDirectives(t.createVNode(Eo,t.mergeProps({ref:i},a,{active:void 0,location:void 0}),l),[[t.vShow,e.active]])]})])])})),{}}}),Ud=gt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},...vn({prependIcon:"$file"}),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>P(e).every((e=>null!=e&&"object"==typeof e))},...bi({clearable:!0})},"VFileInput"),Yd=It()({name:"VFileInput",inheritAttrs:!1,props:Ud(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
function w(){y.value!==document.activeElement&&y.value?.focus(),s.value||u()}function S(e){y.value?.click()}function k(e){o("mousedown:control",e)}function x(e){y.value?.click(),o("click:control",e)}function N(a){a.stopPropagation(),w(),t.nextTick((()=>{i.value=[],q(e["onClick:clear"],a)}))}function C(e){e.preventDefault()}function _(e){e.preventDefault(),e.dataTransfer&&(i.value=[...e.dataTransfer.files??[]])}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&y.value&&(y.value.value="")})),$t((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,u]=B(l),{modelValue:d,...I}=pn.filterProps(e),P=Vi.filterProps(e)
...
t.watchEffect((()=>{o.value=a.layoutItemStyles.value}))})),$t((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",n.value,r.value,s.value,u.value,c.value,e.class],style:[i.value,e.app?o.value:{height:f(e.height)},e.style]},l))),{}}}),Kd=gt({...ht(),...sn()},"VForm"),Xd=It()({name:"VForm",props:Kd(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
t&&r.value?.submit()})),t.preventDefault()}return $t((()=>t.createVNode("form",{ref:r,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),di(n,r)}}),Zd=gt({disabled:Boolean,modelValue:{type:Boolean,default:null},...Wr()},"VHover"),Qd=It()({name:"VHover",props:Zd(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=ia(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Ur(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),Jd=gt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...ll(),...Ba()},"VInfiniteScroll"),ev=_t({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=Zl()
return t.watch(n,(async t=>{l("intersect",e.side,t)})),$t((()=>t.createVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:o},[t.createTextVNode(" ")]))),{}}}),tv=It()({name:"VInfiniteScroll",props:Jd(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),o&&c&&t.createVNode(ev,{key:"start",side:"start",onIntersect:m,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(ev,{key:"end",side:"end",onIntersect:m,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),av=Symbol.for("vuetify:v-item-group"),lv=gt({...ht(),...Ml({selectedClass:"v-item--selected"}),...Ba(),...wa()},"VItemGroup"),ov=It()({name:"VItemGroup",props:lv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ka(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=zl(e,av)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),nv=It()({name:"VItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=Ll(e,av)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),rv=Bt("v-kbd","kbd"),iv=gt({...ht(),...ll(),...ta()},"VLayout"),sv=It()({name:"VLayout",props:iv(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=na(e),{dimensionStyles:u}=ol(e)
return $t((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[u.value,n.value,e.style]},[l.default?.()]))),{getLayoutItem:r,items:i}}}),uv=gt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...ht(),...aa()},"VLayoutItem"),cv=It()({name:"VLayoutItem",props:uv(),setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()])}}),dv=gt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...ht(),...ll(),...Ba(),...vl({transition:"fade-transition"})},"VLazy"),vv=It()({name:"VLazy",directives:{intersect:ml},props:dv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=ol(e),n=ia(e,"modelValue")
function r(e){n.value||(n.value=e)}return $t((()=>t.withDirectives(t.createVNode(e.tag,{class:["v-lazy",e.class],style:[o.value,e.style]},{default:()=>[n.value&&t.createVNode(pl,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[t.resolveDirective("intersect"),{handler:r,options:e.options},null]]))),{}}}),pv=gt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...ht()},"VLocaleProvider"),fv=It()({name:"VLocaleProvider",props:pv(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ya(e)
return $t((()=>t.createVNode("div",{class:["v-locale-provider",o.value,e.class],style:e.style},[l.default?.()]))),{}}}),mv=gt({scrollable:Boolean,...ht(),...ll(),...Ba({tag:"main"})},"VMain"),gv=It()({name:"VMain",props:mv(),setup(e,a){let{slots:l}=a
...
const hv=100,yv=20
function bv(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Vv(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=bv(t),o=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(o-l)*Math.abs(o),a===e.length-1&&(t*=.5)}return 1e3*bv(t)}function wv(){const e={}
return{addMovement:function(t){Array.from(t.changedTouches).forEach((a=>{(e[a.identifier]??(e[a.identifier]=new j(yv))).push([t.timeStamp,a])}))},endTouch:function(t){Array.from(t.changedTouches).forEach((t=>{delete e[t.identifier]}))},getVelocity:function(t){const a=e[t]?.values().reverse()
if(!a)throw new Error(`No samples for touch id ${t}`)
const l=a[0],o=[],n=[]
for(const e of a){if(l[0]-e[0]>hv)break
o.push({t:e[0],d:e[1].clientX}),n.push({t:e[0],d:e[1].clientY})}return{x:Vv(o),y:Vv(n),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Sv(){throw new Error}const kv=["start","end","left","right","top","bottom"],xv=gt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>kv.includes(e)},sticky:Boolean,...yl(),...ht(),...Wr(),...kn({mobile:null}),...Vl(),...aa(),...cl(),...Ba({tag:"nav"}),...wa()},"VNavigationDrawer"),Nv=It()({name:"VNavigationDrawer",props:xv(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
const s=t.computed((()=>["left","right"].includes(i.value))),{addMovement:u,endTouch:c,getVelocity:d}=wv()
let v=!1
const p=t.shallowRef(!1),f=t.shallowRef(0),m=t.shallowRef(0)
let g
function h(e,t){return("left"===i.value?e:"right"===i.value?document.documentElement.clientWidth-e:"top"===i.value?e:"bottom"===i.value?document.documentElement.clientHeight-e:Sv())-(t?n.value:0)}function y(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
const a="left"===i.value?(e-m.value)/n.value:"right"===i.value?(document.documentElement.clientWidth-e-m.value)/n.value:"top"===i.value?(e-m.value)/n.value:"bottom"===i.value?(document.documentElement.clientHeight-e-m.value)/n.value:Sv()
return t?Math.max(0,Math.min(1,a)):a}function b(e){if(r.value)return
const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,d="left"===i.value?t<25:"right"===i.value?t>document.documentElement.clientWidth-25:"top"===i.value?a<25:"bottom"===i.value?a>document.documentElement.clientHeight-25:Sv(),p=l.value&&("left"===i.value?t<n.value:"right"===i.value?t>document.documentElement.clientWidth-n.value:"top"===i.value?a<n.value:"bottom"===i.value?a>document.documentElement.clientHeight-n.value:Sv());(d||p||l.value&&o.value)&&(g=[t,a],m.value=h(s.value?t:a,l.value),f.value=y(s.value?t:a),v=m.value>-20&&m.value<80,c(e),u(e))}function V(e){const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY
...
l.value=n?t.direction===({left:"right",right:"left",top:"down",bottom:"up"}[i.value]||Sv()):f.value>.5}const S=t.computed((()=>p.value?{transform:"left"===i.value?`translateX(calc(-100% + ${f.value*n.value}px))`:"right"===i.value?`translateX(calc(100% - ${f.value*n.value}px))`:"top"===i.value?`translateY(calc(-100% + ${f.value*n.value}px))`:"bottom"===i.value?`translateY(calc(100% - ${f.value*n.value}px))`:Sv(),transition:"none"}:void 0))
...
return B.value?t*P.value:t})),{layoutItemStyles:R,layoutItemScrimStyles:T}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:N,layoutSize:A,elementSize:x,active:t.computed((()=>h.value||B.value)),disableTransitions:t.computed((()=>B.value)),absolute:t.computed((()=>e.absolute||I.value&&"string"!=typeof D.value))}),{isStuck:D,stickyStyles:E}=function(e){let{rootEl:a,isSticky:l,layoutItemStyles:o}=e
...
const Bv=gt({scale:{type:[Number,String],default:.5},...ht()},"VParallax"),Pv=It()({name:"VParallax",props:Bv(),setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return $t((()=>t.createVNode(hl,{class:["v-parallax",{"v-parallax--active":n.value},e.class],style:e.style,ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),Av=gt({...Zo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Rv=It()({name:"VRadio",props:Av(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=Qo.filterProps(e)
return t.createVNode(Qo,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)})),{}}}),Tv=gt({height:{type:[Number,String],default:"auto"},...vn(),...x(qo(),["multiple"]),trueIcon:{type:Mt,default:"$radioOn"},falseIcon:{type:Mt,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Dv=It()({name:"VRadioGroup",inheritAttrs:!1,props:Tv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return t.createVNode(t.Fragment,null,[c&&t.createVNode(Yo,{id:l.value},{default:()=>[c]}),t.createVNode(Xo,t.mergeProps(u,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:d.value,"aria-labelledby":c?l.value:void 0,multiple:!1},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),Ev=gt({...on(),...vn(),...Ms(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),Fv=It()({name:"VRangeSlider",props:Ev(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=ba()
const u=Os(e),c=ia(e,"modelValue",void 0,(e=>e?.length?e.map((e=>u.roundValue(e))):[0,0])),{activeThumbRef:d,hasLabels:v,max:p,min:f,mousePressed:m,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b,readonly:V}=Ls({props:e,steps:u,onSliderStart:()=>{o("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
const a=$s(t,n.value.$el,e.direction),l=$s(t,r.value.$el,e.direction),o=Math.abs(a),i=Math.abs(l)
...
return t.createVNode("div",{class:"v-slider__container",onMousedown:V.value?void 0:g,onTouchstartPassive:V.value?void 0:h},[t.createVNode("input",{id:`${o.value}_start`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[0]},null),t.createVNode("input",{id:`${o.value}_stop`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[1]},null),t.createVNode(Ws,{ref:b,start:x.value,stop:N.value},{"tick-label":l["tick-label"]}),t.createVNode(js,{ref:n,"aria-describedby":i.value,focused:w&&d.value===n.value?.$el,modelValue:c.value[0],"onUpdate:modelValue":e=>c.value=[e,c.value[1]],onFocus:e=>{S(),d.value=n.value?.$el,p.value!==f.value&&c.value[0]===c.value[1]&&c.value[1]===f.value&&e.relatedTarget!==r.value?.$el&&(n.value?.$el.blur(),r.value?.$el.focus())},onBlur:()=>{k(),d.value=void 0},min:f.value,max:c.value[1],position:x.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t.createVNode(js,{ref:r,"aria-describedby":i.value,focused:w&&d.value===r.value?.$el,modelValue:c.value[1],"onUpdate:modelValue":e=>c.value=[c.value[0],e],onFocus:e=>{S(),d.value=r.value?.$el,p.value!==f.value&&c.value[0]===c.value[1]&&c.value[0]===p.value&&e.relatedTarget!==n.value?.$el&&(r.value?.$el.blur(),n.value?.$el.focus())},onBlur:()=>{k(),d.value=void 0},min:c.value[0],max:p.value,position:N.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})})),{}}}),$v=gt({name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Mt,default:"$ratingEmpty"},fullIcon:{type:Mt,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...ht(),...Pl(),...Gl(),...Ba(),...wa()},"VRating"),Mv=It()({name:"VRating",props:$v(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{t:o}=ha(),{themeClasses:n}=ka(e),r=ia(e,"modelValue"),i=t.computed((()=>A(parseFloat(r.value),0,Number(e.length)))),s=t.computed((()=>p(Number(e.length),1))),u=t.computed((()=>s.value.flatMap((t=>e.halfIncrements?[t-.5,t]:[t])))),c=t.shallowRef(-1),d=t.computed((()=>u.value.map((t=>{const a=e.hover&&c.value>-1,l=i.value>=t,o=c.value>=t,n=(a?o:l)?e.fullIcon:e.emptyIcon,r=e.activeColor??e.color
...
if(!e)return t
const a=Ov[e]
if(e===a);else{if(e.includes(","))return Hv(e)
if(e.includes("@"))return zv(e)
a.includes(",")?t=Hv(a):a.includes("@")?t=zv(a):a&&t.push(jv(a))}return[Lv(e,t)]}function Hv(e){return e.replace(/\s/g,"").split(",").map(jv)}const Wv=gt({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...ll(),...Vl(),...wa()},"VSkeletonLoader"),Uv=It()({name:"VSkeletonLoader",props:Wv(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color")),{dimensionStyles:r}=ol(e),{elevationClasses:i}=wl(e),{themeClasses:s}=ka(e),{t:u}=ha(),c=t.computed((()=>jv(P(e.type).join(","))))
return $t((()=>{const a=!l.default||e.loading,d=e.boilerplate||!a?{}:{ariaLive:"polite",ariaLabel:u(e.loadingText),role:"alert"}
return t.createVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,o.value,i.value],style:[n.value,a?r.value:{}]},d),[a?c.value:l.default?.()])})),{}}}),Yv=It()({name:"VSlideGroupItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=Ll(e,Dn)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const Gv=gt({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...to({location:"bottom"}),...uo(),...cl(),...Dl(),...wa(),...x(ii({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),qv=It()({name:"VSnackbar",props:Gv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return{x:l+t*c,y:v-a+Number(e<0)*a,height:a,value:e}}))}const f=t.computed((()=>{const t=[],a=p(d.value,c.value),l=a.length
...
function Qv(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:75
if(0===e.length)return""
const o=e.shift(),n=e[e.length-1]
return(a?`M${o.x} ${l-o.x+2} L${o.x} ${o.y}`:`M${o.x} ${o.y}`)+e.map(((a,l)=>{const n=e[l+1],r=e[l-1]||o,i=n&&(u=a,c=r,Jv((s=n).x+c.x)===Jv(2*u.x)&&Jv(s.y+c.y)===Jv(2*u.y))
var s,u,c
if(!n||i)return`L${a.x} ${a.y}`
const d=Math.min(ep(r,a),ep(n,a)),v=d/2<t?d/2:t,p=tp(r,a,v),f=tp(n,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${f.x} ${f.y}`})).join("")+(a?`L${n.x} ${l-o.x+2} Z`:"")}function Jv(e){return parseInt(e,10)}function ep(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function tp(e,t,a){const l=e.x-t.x,o=e.y-t.y,n=Math.sqrt(l*l+o*o),r=l/n,i=o/n
return{x:t.x+r*a,y:t.y+i*a}}const ap=gt({fill:Boolean,...Kv()},"VTrendline"),lp=It()({name:"VTrendline",props:ap(),setup(e,a){let{slots:l}=a
...
return Qv(u(m.value,f.value),a,t,parseInt(e.height,10))}t.watch((()=>e.modelValue),(async()=>{if(await t.nextTick(),!e.autoDraw||!s.value)return
...
$t((()=>{const a="trend"===e.type?lp:Zv,r="trend"===e.type?lp.filterProps(e):Zv.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:o.value,style:n.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)}))}}),rp=gt({...ht(),...vi({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),ip=It()({name:"VSpeedDial",props:rp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(pi,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:e.class,style:e.style,contentClass:["v-speed-dial__content",i.value,e.contentClass],location:r.value,ref:n,transition:"fade-transition"}),{...l,default:a=>t.createVNode(al,{defaults:{VBtn:{size:"small"}}},{default:()=>[t.createVNode(pl,{appear:!0,group:!0,transition:e.transition},{default:()=>[l.default?.(a)]})]})})})),{}}}),sp=Symbol.for("vuetify:v-stepper"),up=gt({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),cp=It()({name:"VStepperActions",props:up(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=ha()
function r(){l("click:prev")}function i(){l("click:next")}return $t((()=>{const a={onClick:r},l={onClick:i}
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode(al,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(Eo,a,null)]}),t.createVNode(al,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(Eo,l,null)]})])})),{}}}),dp=Bt("v-stepper-header"),vp=gt({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Mt,default:"$complete"},editable:Boolean,editIcon:{type:Mt,default:"$edit"},error:Boolean,errorIcon:{type:Mt,default:"$error"},icon:Mt,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),pp=gt({...vp(),...Ol()},"VStepperItem"),fp=It()({name:"VStepperItem",directives:{Ripple:To},props:pp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Ll(e,sp,!0),n=t.computed((()=>o?.value.value??e.value)),r=t.computed((()=>e.rules.every((e=>!0===e())))),i=t.computed((()=>!e.disabled&&e.editable)),s=t.computed((()=>!e.disabled&&e.editable)),u=t.computed((()=>e.error||!r.value)),c=t.computed((()=>e.complete||e.rules.length>0&&r.value)),d=t.computed((()=>u.value?e.errorIcon:c.value?e.completeIcon:o.isSelected.value&&e.editable?e.editIcon:e.icon)),v=t.computed((()=>({canEdit:s.value,hasError:u.value,hasCompleted:c.value,title:e.title,subtitle:e.subtitle,step:n.value,value:e.value})))
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&Tl(!0,"v-stepper-item"),t.createVNode(Wo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Xl,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),mp=gt({...x(bs(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),gp=It()({name:"VStepperWindow",props:mp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(sp,null),n=ia(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return $t((()=>{const a=Vs.filterProps(e)
return t.createVNode(Vs,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),hp=gt({...ks()},"VStepperWindowItem"),yp=It()({name:"VStepperWindowItem",props:hp(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=xs.filterProps(e)
return t.createVNode(xs,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)})),{}}}),bp=gt({altLabels:Boolean,bgColor:String,completeIcon:Mt,editIcon:Mt,editable:Boolean,errorIcon:Mt,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},nonLinear:Boolean,flat:Boolean,...kn()},"Stepper"),Vp=gt({...bp(),...Ml({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...Zs(),...S(up(),["prevText","nextText"])},"VStepper"),wp=It()({name:"VStepper",props:Vp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=zl(e,sp),{displayClasses:s,mobile:u}=xn(e),{completeIcon:c,editIcon:d,errorIcon:p,color:f,editable:m,prevText:g,nextText:h}=t.toRefs(e),y=t.computed((()=>e.items.map(((t,a)=>({title:v(t,e.itemTitle,t),value:v(t,e.itemValue,a+1),raw:t}))))),b=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
return Nt({VStepperItem:{editable:m,errorIcon:p,completeIcon:c,editIcon:d,prevText:g,nextText:h},VStepperActions:{color:f,disabled:t.computed((()=>e.disabled?e.disabled:0===b.value?"prev":b.value===o.value.length-1&&"next")),prevText:g,nextText:h}}),$t((()=>{const a=Qs.filterProps(e),o=!(!l.header&&!e.items.length),i=e.items.length>0,c=!(e.hideActions||!i&&!l.actions)
return t.createVNode(Qs,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":u.value},s.value,e.class],style:e.style}),{default:()=>[o&&t.createVNode(dp,{key:"stepper-header"},{default:()=>[y.value.map(((e,a)=>{let{raw:o,...n}=e
return t.createVNode(t.Fragment,null,[!!a&&t.createVNode(fr,null,null),t.createVNode(fp,n,{default:l[`header-item.${n.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])}))]}),i&&t.createVNode(gp,{key:"stepper-window"},{default:()=>[y.value.map((e=>t.createVNode(yp,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),c&&(l.actions?.({next:n,prev:r})??t.createVNode(cp,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),Sp=gt({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...vn(),...Zo()},"VSwitch"),kp=It()({name:"VSwitch",inheritAttrs:!1,props:Sp(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,l){let{attrs:o,slots:n}=l
...
return t.createVNode(t.Fragment,null,[l,t.createVNode("div",{class:["v-switch__thumb",{"v-switch__thumb--filled":o||e.loading},e.inset||p?void 0:r.value],style:e.inset?void 0:i.value},[n.thumb?t.createVNode(al,{defaults:{VIcon:{icon:o,size:"x-small"}}},{default:()=>[n.thumb({...V,icon:o})]}):t.createVNode(Wa,null,{default:()=>[e.loading?t.createVNode(io,{name:"v-switch",active:!0,color:!1===g.value?void 0:f.value},{default:e=>n.loader?n.loader(e):t.createVNode(Jl,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):o&&t.createVNode(Xl,{key:String(o),icon:o,size:"x-small"},null)]})])])}})}})})),{}}}),xp=gt({color:String,height:[Number,String],window:Boolean,...ht(),...Vl(),...aa(),...cl(),...Ba(),...wa()},"VSystemBar"),Np=It()({name:"VSystemBar",props:xp(),setup(e,a){let{slots:l}=a
...
return $t((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value,e.class],style:[r.value,d.value,u.value,e.style]},l))),{}}}),Cp=Symbol.for("vuetify:v-tabs"),_p=gt({fixed:Boolean,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...x(Do({selectedClass:"v-tab--selected",variant:"text"}),["active","block","flat","location","position","symbol"])},"VTab"),Ip=It()({name:"VTab",props:_p(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createVNode(Eo,t.mergeProps({symbol:Cp,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),di({},i)}}),Bp=gt({...x(bs(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Pp=It()({name:"VTabsWindow",props:Bp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return $t((()=>{const a=Vs.filterProps(e)
return t.createVNode(Vs,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),Ap=gt({...ks()},"VTabsWindowItem"),Rp=It()({name:"VTabsWindowItem",props:Ap(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=xs.filterProps(e)
return t.createVNode(xs,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)})),{}}})
const Tp=gt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...En({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Pl(),...Ba()},"VTabs"),Dp=It()({name:"VTabs",props:Tp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return t.createVNode(t.Fragment,null,[t.createVNode(Fn,t.mergeProps(a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},i.value,s.value,e.class],style:[{"--v-tabs-height":f(e.height)},u.value,e.style],role:"tablist",symbol:Cp},c,l),{default:()=>[o.default?.()??r.value.map((e=>o.tab?.({item:e})??t.createVNode(Ip,t.mergeProps(e,{key:e.text,value:e.value}),{default:o[`tab.${e.value}`]?()=>o[`tab.${e.value}`]?.({item:e}):void 0})))]}),d&&t.createVNode(Pp,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,key:"tabs-window"},c),{default:()=>[r.value.map((e=>o.item?.({item:e})??t.createVNode(Rp,{value:e.value},{default:()=>o[`item.${e.value}`]?.({item:e})}))),o.window?.()]})])})),{}}}),Ep=gt({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...vn(),...bi()},"VTextarea"),Fp=It()({name:"VTextarea",directives:{Intersect:ml},inheritAttrs:!1,props:Ep(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return t.watchEffect((()=>{e.autoGrow||(N.value=Number(e.rows))})),t.onMounted(_),t.watch(r,_),t.watch((()=>e.rows),_),t.watch((()=>e.maxRows),_),t.watch((()=>e.density),_),t.watch(x,(e=>{e?(I=new ResizeObserver(_),I.observe(x.value)):I?.disconnect()})),t.onBeforeUnmount((()=>{I?.disconnect()})),$t((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,f]=B(l),{modelValue:_,...I}=pn.filterProps(e),P=Vi.filterProps(e)
...
case"end":return t[1]
default:return null}}))
return $t((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,i.value,r.value,e.class],style:[{"--v-timeline-line-thickness":f(e.lineThickness)},e.style]},l))),{}}}),Up=gt({...ht(),...Dl({variant:"text"})},"VToolbarItems"),Yp=It()({name:"VToolbarItems",props:Up(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{color:t.toRef(e,"color"),height:"inherit",variant:t.toRef(e,"variant")}}),$t((()=>t.createVNode("div",{class:["v-toolbar-items",e.class],style:e.style},[l.default?.()]))),{}}}),Gp=gt({id:String,text:String,...x(ii({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:!1}),["absolute","persistent"])},"VTooltip"),qp=It()({name:"VTooltip",props:Gp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})})),di({},s)}}),Kp=It()({name:"VValidation",props:cn(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=dn(e,"validation")
return()=>a.default?.(l)}})
var Xp=Object.freeze({__proto__:null,VAlert:jo,VAlertTitle:Oo,VApp:Ia,VAppBar:Il,VAppBarNavIcon:$o,VAppBarTitle:Mo,VAutocomplete:Mi,VAvatar:Wo,VBadge:Li,VBanner:Ui,VBannerActions:ji,VBannerText:Hi,VBottomNavigation:Gi,VBottomSheet:Zi,VBreadcrumbs:ls,VBreadcrumbsDivider:Ji,VBreadcrumbsItem:ts,VBtn:Eo,VBtnGroup:$l,VBtnToggle:Ul,VCard:ps,VCardActions:os,VCardItem:us,VCardSubtitle:rs,VCardText:ds,VCardTitle:is,VCarousel:Ss,VCarouselItem:Cs,VCheckbox:mn,VCheckboxBtn:en,VChip:zn,VChipGroup:On,VClassIcon:Wt,VCode:_s,VCol:Kc,VColorPicker:Js,VCombobox:tu,VComponentIcon:zt,VConfirmEdit:yu,VContainer:zc,VCounter:mi,VDataIterator:ec,VDataTable:Ec,VDataTableFooter:oc,VDataTableHeaders:wc,VDataTableRow:Nc,VDataTableRows:_c,VDataTableServer:Oc,VDataTableVirtual:$c,VDatePicker:Pd,VDatePickerControls:md,VDatePickerHeader:hd,VDatePickerMonth:wd,VDatePickerMonths:kd,VDatePickerYears:Nd,VDefaultsProvider:al,VDialog:Ki,VDialogBottomTransition:za,VDialogTopTransition:ja,VDialogTransition:$a,VDivider:fr,VEmptyState:Rd,VExpandTransition:Ja,VExpandXTransition:el,VExpansionPanel:Od,VExpansionPanelText:Ed,VExpansionPanelTitle:$d,VExpansionPanels:jd,VFab:Wd,VFabTransition:La,VFadeTransition:Ha,VField:Vi,VFieldLabel:hi,VFileInput:Yd,VFooter:qd,VForm:Xd,VHover:Qd,VIcon:Xl,VImg:hl,VInfiniteScroll:tv,VInput:pn,VItem:nv,VItemGroup:ov,VKbd:rv,VLabel:Yo,VLayout:sv,VLayoutItem:cv,VLazy:vv,VLigatureIcon:Ht,VList:xr,VListGroup:nr,VListImg:Nr,VListItem:cr,VListItemAction:_r,VListItemMedia:Br,VListItemSubtitle:ir,VListItemTitle:sr,VListSubheader:vr,VLocaleProvider:fv,VMain:gv,VMenu:pi,VMessages:ln,VNavigationDrawer:Nv,VNoSsr:Cv,VOtpInput:Iv,VOverlay:si,VPagination:ac,VParallax:Pv,VProgressCircular:Jl,VProgressLinear:oo,VRadio:Rv,VRadioGroup:Dv,VRangeSlider:Fv,VRating:Mv,VResponsive:rl,VRow:vd,VScaleTransition:Wa,VScrollXReverseTransition:Ya,VScrollXTransition:Ua,VScrollYReverseTransition:qa,VScrollYTransition:Ga,VSelect:Ti,VSelectionControl:Qo,VSelectionControlGroup:Xo,VSheet:Qs,VSkeletonLoader:Uv,VSlideGroup:Fn,VSlideGroupItem:Yv,VSlideXReverseTransition:Xa,VSlideXTransition:Ka,VSlideYReverseTransition:Qa,VSlideYTransition:Za,VSlider:Ys,VSnackbar:qv,VSpacer:pd,VSparkline:np,VSpeedDial:ip,VStepper:wp,VStepperActions:cp,VStepperHeader:dp,VStepperItem:fp,VStepperWindow:gp,VStepperWindowItem:yp,VSvgIcon:jt,VSwitch:kp,VSystemBar:Np,VTab:Ip,VTable:Bc,VTabs:Dp,VTabsWindow:Pp,VTabsWindowItem:Rp,VTextField:ki,VTextarea:Fp,VThemeProvider:Mp,VTimeline:Wp,VTimelineItem:jp,VToolbar:xl,VToolbarItems:Yp,VToolbarTitle:Aa,VTooltip:qp,VValidation:Kp,VVirtualScroll:Bi,VWindow:Vs,VWindowItem:xs})
function Zp(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Qp={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:o,immediate:n,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),o&&Zp(e,t)}))
n&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:Zp}
const Jp={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}}
function ef(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,o="object"==typeof l&&l.options||{passive:!0},n="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",n,o),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:n,options:o,target:a?void 0:r})}function tf(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:o=e}=e._onScroll[t.instance.$.uid]
o.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const af={mounted:ef,unmounted:tf,updated:function(e,t){t.value!==t.oldValue&&(tf(e,t),ef(e,t))}}
const lf=function(e,a){const l=function(e,a){return function(l,o,n){const r="function"==typeof a?a(o):a,i=o.value?.text??o.value??r?.text,s=m(o.value)?o.value:{},u=()=>i??l.textContent,c=(n.ctx===o.instance.$?function(e,t){const a=new Set,l=t=>{for(const o of t){if(!o)continue
...
return{mounted:l,updated:l,unmounted(e){t.render(null,e)}}}(qp,(e=>({activator:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value})))
var of=Object.freeze({__proto__:null,ClickOutside:ni,Intersect:ml,Mutate:Qp,Resize:Jp,Ripple:To,Scroll:af,Tooltip:lf,Touch:gs})
...
if(d.install(e),e.provide(kt,u),e.provide(hn,c),e.provide(Va,d),e.provide(Ot,v),e.provide(ma,p),e.provide(pu,f.options),e.provide(fu,f.instance),e.provide(Nn,m),a&&n.ssr)if(e.$nuxt)e.$nuxt.hook("app:suspense:resolve",(()=>{c.update()}))
...
if(a&&e in a)return a[e]}nf.version="3.7.18"
const sf=function(){return nf({components:Xp,directives:of,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},uf="3.7.18"
