...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  props: (0,_util__WEBPACK_IMPORTED_MODULE_3__.makeProps)({
    ...
    ...(0,_composables_theme__WEBPACK_IMPORTED_MODULE_12__.makeThemeProps)()
  }),
  ...
  setup(props, {
    ...
    const {
      themeClasses
    } = (0,_composables_theme__WEBPACK_IMPORTED_MODULE_12__.useTheme)(props);
    const {
      borderClasses
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ */ "./src/components/VList/VListItemAvatar.tsx");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ */ "./src/components/VList/VListItemHeader.ts");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ */ "./src/components/VList/VListItemTitle.ts");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./ */ "./src/components/VList/VListItemSubtitle.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(props, {
    ...
    const {
      colorClasses,
      colorStyles
    } = (0,_composables_color__WEBPACK_IMPORTED_MODULE_11__.useColor)((0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => {
    ...
    return () => {
      ...
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(props.tag, {
        ...
        }, themeClasses.value, colorClasses.value, borderClasses.value, densityClasses.value, elevationClasses.value, roundedClasses.value],
        "style": [colorStyles.value, dimensionStyles.value],
        "tabindex": isClickable ? 0 : undefined
      }, {
        default: () => [(isClickable || props.active) && (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)("div", {
          "class": "v-list-item__overlay"
        }, null), hasPrepend && (slots.prepend ? slots.prepend() : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(___WEBPACK_IMPORTED_MODULE_12__.default, {
          "left": true
        }, {
          default: () => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_VAvatar__WEBPACK_IMPORTED_MODULE_13__.default, {
            "density": props.density,
            "icon": props.prependIcon,
            "image": props.prependAvatar
          }, null, 8, ["density", "icon", "image"])]
        }, 8, ["left"])), hasHeader && (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(___WEBPACK_IMPORTED_MODULE_14__.default, null, {
          default: () => [hasTitle && (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(___WEBPACK_IMPORTED_MODULE_15__.default, null, {
            default: () => [slots.title ? slots.title() : props.title]
          }), hasSubtitle && (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(___WEBPACK_IMPORTED_MODULE_16__.default, null, {
            default: () => [slots.subtitle ? slots.subtitle() : props.subtitle]
          })],
          _: 1
        }), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), hasAppend && (slots.append ? slots.append() : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(___WEBPACK_IMPORTED_MODULE_12__.default, {
          "right": true
        }, {
          default: () => [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_VAvatar__WEBPACK_IMPORTED_MODULE_13__.default, {
            "density": props.density,
        ...
        _: 1
      }, 8, ["class", "style", "tabindex"]), [[(0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDirective)("ripple"), isClickable]]);
    };
  }
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../util */ "./src/util/easing.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../util */ "./src/util/useRender.ts");
  ...
  setup(props, {
    ...
    function animateClick() {
      ...
      (_content$value2 = content.value) == null ? void 0 : _content$value2.animate([{
        ...
        duration: 150,
        easing: _util__WEBPACK_IMPORTED_MODULE_12__.standardEasing
      });
    }
    ...
    (0,_util__WEBPACK_IMPORTED_MODULE_13__.useRender)(() => {
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util */ "./src/util/propsFactory.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util */ "./src/util/colorUtils.ts");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util */ "./src/util/helpers.ts");
...
function createTheme(options) {
  ...
  const computedThemes = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => {
    return Object.keys(themes.value).reduce((obj, key) => {
      ...
      for (const color of Object.keys(theme.colors)) {
        ...
        theme.colors[onColor] = (0,_util__WEBPACK_IMPORTED_MODULE_2__.intToHex)((0,_util__WEBPACK_IMPORTED_MODULE_2__.getLuma)(theme.colors[color]) > 0.18 ? 0x0 : 0xffffff);
      }
  ...
  function genColorVariations(name, color) {
    ...
    for (const variation of ['lighten', 'darken']) {
      const fn = variation === 'lighten' ? _util__WEBPACK_IMPORTED_MODULE_2__.lighten : _util__WEBPACK_IMPORTED_MODULE_2__.darken;

      for (const amount of (0,_util__WEBPACK_IMPORTED_MODULE_3__.createRange)(variations.value[variation], 1)) {
        obj[`${name}-${variation}-${amount}`] = (0,_util__WEBPACK_IMPORTED_MODULE_2__.intToHex)(fn((0,_util__WEBPACK_IMPORTED_MODULE_2__.colorToInt)(color), amount));
      }
    }
  ...
  function genCssVariables(name) {
    ...
    for (const [key, value] of Object.entries(theme.colors)) {
      const rgb = (0,_util__WEBPACK_IMPORTED_MODULE_2__.colorToRGB)(value);
      variables.push(`--v-theme-${key}: ${rgb.r},${rgb.g},${rgb.b}`);

      if (!key.startsWith('on-')) {
        variables.push(`--v-theme-${key}-overlay-multiplier: ${(0,_util__WEBPACK_IMPORTED_MODULE_2__.getLuma)(value) > 0.18 ? lightOverlay : darkOverlay}`);
      }
    }
  ...
  function updateStyles() {
    ...
    for (const themeName of Object.keys(computedThemes.value)) {
      ...
      lines.push(...createCssClass(`.v-theme--${themeName}`, [...genCssVariables(themeName), ...Object.keys(variables).map(key => {
        ...
        const color = typeof value === 'string' && value.startsWith('#') ? (0,_util__WEBPACK_IMPORTED_MODULE_2__.colorToRGB)(value) : undefined;
...
/* harmony export */   "VDefaultsProvider": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VDefaultsProvider),
...
/* harmony export */   "VList": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VList),
/* harmony export */   "VListImg": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListImg),
/* harmony export */   "VListItem": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItem),
/* harmony export */   "VListItemAvatar": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItemAvatar),
/* harmony export */   "VListItemHeader": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItemHeader),
/* harmony export */   "VListItemMedia": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItemMedia),
/* harmony export */   "VListItemSubtitle": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItemSubtitle),
/* harmony export */   "VListItemTitle": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListItemTitle),
/* harmony export */   "VListSubheader": () => (/* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_1__.VListSubheader),
