...
return t.provide(Le,n),n}function Me(e,t){return l=>Object.keys(e).reduce(((a,o)=>{const n="object"==typeof e[o]&&null!=e[o]&&!Array.isArray(e[o])?e[o]:{type:e[o]}
return a[o]=l&&o in l?{...n,default:l[o]}:n,t&&!a[o].source&&(a[o].source=t),a}),{})}function ze(e,t){var l,a
return(null==(l=e.props)?void 0:l.hasOwnProperty(t))||(null==(a=e.props)?void 0:a.hasOwnProperty(I(t)))}const Fe=function(e){return e._setup=e._setup??e.setup,e.name?(e._setup&&(e.props=e.props??{},e.props=Me(e.props,e.name)(),e.props._as=String,e.setup=function(l,a){const o=t.getCurrentInstance(),n=Pe(),r=t.shallowRef(),i=t.shallowReactive({...t.toRaw(l)})
...
ze(o.vnode,e)||(n=(null==a?void 0:a[e])??(null==t?void 0:t[e])??l[e]),i[e]!==n&&(i[e]=n)}}))
...
function De(){let e=!(arguments.length>0&&void 0!==arguments[0])||arguments[0]
return l=>(e?Fe:t.defineComponent)(l)}function je(e){let l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"div",a=arguments.length>2?arguments[2]:void 0
return Fe({name:a??t.capitalize(t.camelize(e.replace(/__/g,"-"))),props:{tag:{type:String,default:l}},setup(l,a){let{slots:o}=a
return()=>{var a
return t.h(l.tag,{class:e},null==(a=o.default)?void 0:a.call(o))}}})}function He(e){if("function"!=typeof e.getRootNode){for(;e.parentNode;)e=e.parentNode
return e!==document?null:document}const t=e.getRootNode()
return t!==document&&t.getRootNode({composed:!0})!==document?null:t}const We="cubic-bezier(0.4, 0, 0.2, 1)"
function Ue(e){for(;e;){if(Xe(e))return e
e=e.parentElement}return document.scrollingElement}function Ye(e,t){const l=[]
if(t&&e&&!t.contains(e))return l
for(;e&&(Xe(e)&&l.push(e),e!==t);)e=e.parentElement
return l}function Xe(e){if(!e||e.nodeType!==Node.ELEMENT_NODE)return!1
const t=window.getComputedStyle(e)
return"scroll"===t.overflowY||"auto"===t.overflowY&&e.scrollHeight>e.clientHeight}function Ge(e){Ie("useRender").render=e}const qe=Symbol.for("vuetify:layout"),Ke=Symbol.for("vuetify:layout-item"),Ze=Me({overlaps:{type:Array,default:()=>[]},fullHeight:Boolean},"layout"),Je=Me({name:{type:String},order:{type:[Number,String],default:0},absolute:Boolean},"layout-item")
function Qe(){const e=t.inject(qe)
if(!e)throw new Error("[Vuetify] Could not find injected layout")
return{getLayoutItem:e.getLayoutItem,mainRect:e.mainRect,mainStyles:e.mainStyles}}function et(e){const l=t.inject(qe)
...
return{id:l,...a,size:Number(o.value),position:r.value}})))),V=e=>b.value.find((t=>t.id===e)),S=Ie("createLayout"),w=t.ref(!1)
...
const x=$(Ke,null==S?void 0:S.vnode).indexOf(e)
...
return{layoutClasses:t.computed((()=>["v-layout",{"v-layout--full-height":e.fullHeight}])),layoutStyles:t.computed((()=>({zIndex:a.value,position:l?"relative":void 0,overflow:l?"hidden":void 0}))),getLayoutItem:V,items:b,layoutRect:v,layoutRef:d}}const lt=2.4,at=.2126729,ot=.7151522,nt=.072175,rt=.03,it=12.82051282051282,st=.06
...
function It(e){const l=null!=e&&e.adapter&&null!=(null==e?void 0:e.adapter).name?null==e?void 0:e.adapter:function(e){const l=t.ref((null==e?void 0:e.locale)??"en"),a=t.ref((null==e?void 0:e.fallback)??"en"),o=t.ref({en:Vt,...null==e?void 0:e.messages})
...
return{isRtl:e.isRtl,rtlClasses:e.rtlClasses}}const Rt=Fe({name:"VApp",props:{...Ze({fullHeight:!0}),...dt()},setup(e,l){let{slots:a}=l
...
return Fe({name:e,props:{group:Boolean,hideOnLeave:Boolean,leaveAbsolute:Boolean,mode:{type:String,default:a},origin:{type:String,default:l}},setup(l,a){let{slots:o}=a
...
return Fe({name:e,props:{mode:{type:String,default:a}},setup(a,o){let{slots:n}=o
...
e.style.overflow=e._initialStyle.overflow,null!=t&&(e.style[a]=t),delete e._initialStyle}}const Mt=Fe({name:"VDialogTransition",props:{target:Object},setup(e,l){let{slots:a}=l
...
null==(a=zt(t))||a.forEach((e=>{Z(e,[{opacity:0},{opacity:0,offset:.33},{opacity:1}],{duration:450*s,easing:We})})),u.finished.then((()=>l()))},onAfterEnter(e){e.style.removeProperty("pointer-events")},onBeforeLeave(e){e.style.pointerEvents="none"},async onLeave(t,l){var a
await new Promise((e=>requestAnimationFrame(e)))
const{x:o,y:n,sx:r,sy:i,speed:s}=Ft(e.target,t)
Z(t,[{transform:""},{transform:`translate(${o}px, ${n}px) scale(${r}, ${i})`,opacity:0}],{duration:125*s,easing:"cubic-bezier(0.4, 0, 1, 1)"}).finished.then((()=>l())),null==(a=zt(t))||a.forEach((e=>{Z(e,[{},{opacity:0,offset:.2},{opacity:0}],{duration:250*s,easing:We})}))},onAfterLeave(e){e.style.removeProperty("pointer-events")}}
...
return{x:s-(o+a.left),y:u-(n+a.top),sx:p,sy:f,speed:g}}const Dt=Tt("fab-transition","center center","out-in"),jt=Tt("dialog-bottom-transition"),Ht=Tt("dialog-top-transition"),Wt=Tt("fade-transition"),Ut=Tt("scale-transition"),Yt=Tt("scroll-x-transition"),Xt=Tt("scroll-x-reverse-transition"),Gt=Tt("scroll-y-transition"),qt=Tt("scroll-y-reverse-transition"),Kt=Tt("slide-x-transition"),Zt=Tt("slide-x-reverse-transition"),Jt=Tt("slide-y-transition"),Qt=Tt("slide-y-reverse-transition"),el=Pt("expand-transition",Ot()),tl=Pt("expand-x-transition",Ot("",!0)),ll=Me({height:[Number,String],maxHeight:[Number,String],maxWidth:[Number,String],minHeight:[Number,String],minWidth:[Number,String],width:[Number,String]},"dimension")
function al(e){return{dimensionStyles:t.computed((()=>({height:g(e.height),maxHeight:g(e.maxHeight),maxWidth:g(e.maxWidth),minHeight:g(e.minHeight),minWidth:g(e.minWidth),width:g(e.width)})))}}const ol=Fe({name:"VResponsive",props:{aspectRatio:[String,Number],contentClass:String,...ll()},setup(e,l){let{slots:a}=l
...
e._observe=Object(e._observe),e._observe[t.instance.$.uid]={init:!1,observer:i},i.observe(e)},unmounted:nl},il=Me({transition:{type:[Boolean,String,Object],default:"fade-transition",validator:e=>!0!==e}},"transition"),sl=(e,l)=>{var a
let{slots:o}=l
...
return t.h(i,t.mergeProps("string"==typeof n?{name:n}:s,r),o)},ul=Fe({name:"VImg",directives:{intersect:rl},props:{aspectRatio:[String,Number],alt:String,cover:Boolean,eager:Boolean,gradient:String,lazySrc:String,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},sizes:String,src:{type:[String,Object],default:""},srcset:String,width:[String,Number],...il()},emits:{loadstart:e=>!0,load:e=>!0,error:e=>!0},setup(e,l){let{emit:o,slots:n}=l
...
{const e=t.watch(v,(t=>{t&&(requestAnimationFrame((()=>{requestAnimationFrame((()=>{C.value=!0}))})),e())}))}return Ge((()=>t.withDirectives(t.createVNode(ol,{class:["v-img",{"v-img--booting":!C.value}],style:{width:g("auto"===e.width?u.value:e.width)},aspectRatio:v.value,"aria-label":e.alt,role:e.alt?"img":void 0},{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(V,null,null),t.createVNode(S,null,null),t.createVNode(x,null,null),t.createVNode(w,null,null),t.createVNode(k,null,null)]),default:n.default}),[[t.resolveDirective("intersect"),{handler:p,options:e.options},null,{once:!0}]]))),{currentSrc:r,image:i,state:s,naturalWidth:u,naturalHeight:c}}}),cl=Me({tag:{type:String,default:"div"}},"tag"),dl=De()({name:"VToolbarTitle",props:{text:String,...cl()},setup(e,l){let{slots:a}=l
return Ge((()=>{var l
const o=!!(a.default||a.text||e.text)
return t.createVNode(e.tag,{class:"v-toolbar-title"},{default:()=>[o&&t.createVNode("div",{class:"v-toolbar-title__placeholder"},[a.text?a.text():e.text,null==(l=a.default)?void 0:l.call(a)])]})})),{}}}),vl=Me({border:[Boolean,Number,String]},"border")
...
return o}))
return{borderClasses:a}}const fl=Me({elevation:{type:[Number,String],validator(e){const t=parseInt(e)
return!isNaN(t)&&t>=0&&t<=24}}},"elevation")
function ml(e){return{elevationClasses:t.computed((()=>{const l=t.isRef(e)?e.value:e.elevation,a=[]
return null==l||a.push(`elevation-${l}`),a}))}}const gl=Me({rounded:{type:[Boolean,Number,String],default:void 0}},"rounded")
...
return{backgroundColorClasses:o,backgroundColorStyles:n}}const Sl=[null,"prominent","default","comfortable","compact"],wl=Me({absolute:Boolean,collapse:Boolean,color:String,density:{type:String,default:"default",validator:e=>Sl.includes(e)},extended:Boolean,extensionHeight:{type:[Number,String],default:48},flat:Boolean,floating:Boolean,height:{type:[Number,String],default:64},image:String,title:String,...vl(),...fl(),...gl(),...cl({tag:"header"}),...dt()},"v-toolbar"),kl=De()({name:"VToolbar",props:wl(),setup(e,l){var a
let{slots:o}=l
...
const xl=Fe({name:"VAppBar",props:{modelValue:{type:Boolean,default:!0},location:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},...wl(),...Je(),height:{type:[Number,String],default:64}},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return Ge((()=>{const[l]=function(e){return S(e,Object.keys((null==kl?void 0:kl.props)??{}))}(e)
return t.createVNode(kl,t.mergeProps({ref:o,class:["v-app-bar",{"v-app-bar--bottom":"bottom"===e.location}],style:{...i.value,height:void 0}},l),a)})),{}}}),Cl=[null,"default","comfortable","compact"],Nl=Me({density:{type:String,default:"default",validator:e=>Cl.includes(e)}},"density")
...
function Il(e,l){return t.createVNode(t.Fragment,null,[e&&t.createVNode("span",{key:"overlay",class:`${l}__overlay`},null),t.createVNode("span",{key:"underlay",class:`${l}__underlay`},null)])}const $l=Me({color:String,variant:{type:String,default:"elevated",validator:e=>Bl.includes(e)}},"variant")
...
return{colorClasses:o,colorStyles:n,variantClasses:a}}const El=Fe({name:"VBtnGroup",props:{divided:Boolean,...vl(),...Nl(),...fl(),...gl(),...cl(),...dt(),...$l()},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{densityClasses:n}=_l(e),{borderClasses:r}=pl(e),{elevationClasses:i}=ml(e),{roundedClasses:s}=hl(e)
Oe({VBtn:{height:"auto",color:t.toRef(e,"color"),density:t.toRef(e,"density"),flat:!0,variant:t.toRef(e,"variant")}}),Ge((()=>t.createVNode(e.tag,{class:["v-btn-group",{"v-btn-group--divided":e.divided},o.value,r.value,n.value,i.value,s.value]},a)))}}),Rl=Me({modelValue:{type:null,default:void 0},multiple:Boolean,mandatory:[Boolean,String],max:Number,selectedClass:String,disabled:Boolean},"group"),Ll=Me({value:null,disabled:Boolean,selectedClass:String},"group-item")
...
for(let a=0;a<e.length;a++){const o=e[a]
null!=o.value?null!=t.find((e=>v(e,o.value)))&&l.push(o.id):t.includes(a)&&l.push(o.id)}return l}const Ml=Symbol.for("vuetify:v-btn-toggle"),zl=De()({name:"VBtnToggle",props:Rl(),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{isSelected:o,next:n,prev:r,select:i,selected:s}=Pl(e,Ml)
return Ge((()=>{var e
return t.createVNode(El,{class:"v-btn-toggle"},{default:()=>[null==(e=a.default)?void 0:e.call(a,{isSelected:o,next:n,prev:r,select:i,selected:s})]})})),{next:n,prev:r,select:i}}}),Fl={collapse:"mdi-chevron-up",complete:"mdi-check",cancel:"mdi-close-circle",close:"mdi-close",delete:"mdi-close-circle",clear:"mdi-close-circle",success:"mdi-check-circle",info:"mdi-information",warning:"mdi-alert-circle",error:"mdi-close-circle",prev:"mdi-chevron-left",next:"mdi-chevron-right",checkboxOn:"mdi-checkbox-marked",checkboxOff:"mdi-checkbox-blank-outline",checkboxIndeterminate:"mdi-minus-box",delimiter:"mdi-circle",sort:"mdi-arrow-up",expand:"mdi-chevron-down",menu:"mdi-menu",subgroup:"mdi-menu-down",dropdown:"mdi-menu-down",radioOn:"mdi-radiobox-marked",radioOff:"mdi-radiobox-blank",edit:"mdi-pencil",ratingEmpty:"mdi-star-outline",ratingFull:"mdi-star",ratingHalf:"mdi-star-half-full",loading:"mdi-cached",first:"mdi-page-first",last:"mdi-page-last",unfold:"mdi-unfold-more-horizontal",file:"mdi-paperclip",plus:"mdi-plus",minus:"mdi-minus"},Dl={component:e=>t.h(Gl,{...e,class:"mdi"})},jl=[String,Function,Object],Hl=Symbol.for("vuetify:icons"),Wl=Me({icon:{type:jl,required:!0},tag:{type:String,required:!0}},"icon"),Ul=Fe({name:"VComponentIcon",props:Wl(),setup:e=>()=>t.createVNode(e.tag,null,{default:()=>[t.createVNode(e.icon,null,null)]})}),Yl=Fe({name:"VSvgIcon",inheritAttrs:!1,props:Wl(),setup(e,l){let{attrs:a}=l
return()=>t.createVNode(e.tag,t.mergeProps(a,{style:null}),{default:()=>[t.createVNode("svg",{class:"v-icon__svg",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",role:"img","aria-hidden":"true"},[t.createVNode("path",{d:e.icon},null)])]})}}),Xl=Fe({name:"VLigatureIcon",props:Wl(),setup:e=>()=>t.createVNode(e.tag,null,{default:()=>[e.icon]})}),Gl=Fe({name:"VClassIcon",props:Wl(),setup:e=>()=>t.createVNode(e.tag,{class:e.icon},null)}),ql={svg:{component:Yl},class:{component:Gl}}
function Kl(e){return _({defaultSet:"mdi",sets:{...ql,mdi:Dl},aliases:Fl},e)}const Zl=["x-small","small","default","large","x-large"],Jl=Me({size:{type:[String,Number],default:"default"}},"size")
function Ql(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
return L((()=>{let l,a
return T(Zl,e.size)?l=`${t}--size-${e.size}`:e.size&&(a={width:g(e.size),height:g(e.size)}),{sizeClasses:l,sizeStyles:a}}))}const ea=Me({color:String,start:Boolean,end:Boolean,icon:jl,...Jl(),...cl({tag:"i"}),...dt()},"v-icon"),ta=Fe({name:"VIcon",props:ea(),setup(e,l){let a,{attrs:o,slots:n}=l
...
t.onBeforeUnmount((()=>{a.disconnect()})),t.watch(l,((e,t)=>{t&&(a.unobserve(t),o.value=!1),e&&a.observe(e)}),{flush:"post"})}return{intersectionRef:l,isIntersecting:o}}const aa=Fe({name:"VProgressCircular",props:{bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...Jl(),...cl({tag:"div"}),...dt()},setup(e,l){let{slots:a}=l
...
ba(e,t,ca(t.oldValue))}},wa=Fe({name:"VProgressLinear",props:{active:{type:Boolean,default:!0},bgColor:String,bgOpacity:[Number,String],bufferValue:{type:[Number,String],default:0},clickable:Boolean,color:String,height:{type:[Number,String],default:4},indeterminate:Boolean,max:{type:[Number,String],default:100},modelValue:{type:[Number,String],default:0},reverse:Boolean,stream:Boolean,striped:Boolean,roundedBar:Boolean,...gl(),...cl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
let{slots:o}=l
return t.createVNode("div",{class:`${e.name}__loader`},[(null==(a=o.default)?void 0:a.call(o,{color:e.color,isActive:e.active}))||t.createVNode(wa,{active:e.active,color:e.color,height:"2",indeterminate:!0},null)])}const Na={center:"center",top:"bottom",bottom:"top",left:"right",right:"left"},_a=Me({location:String},"location")
...
return{locationStyles:n}}const Ia=["static","relative","fixed","absolute","sticky"],$a=Me({position:{type:String,validator:e=>Ia.includes(e)}},"position")
...
w.value||(null==(t=V.navigate)||t.call(V,e),null==b||b.toggle())}},{default:()=>[Il(!0,"v-btn"),!e.icon&&B&&t.createVNode(Lt,{key:"prepend",defaults:{VIcon:{icon:e.prependIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__prepend"},[(null==(l=o.prepend)?void 0:l.call(o))??t.createVNode(ta,null,null)])]}),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[t.createVNode(Lt,{key:"content",defaults:{VIcon:{icon:$?e.icon:void 0}}},{default:()=>[(null==(a=o.default)?void 0:a.call(o))??($&&t.createVNode(ta,{key:"icon"},null))]})]),!e.icon&&I&&t.createVNode(Lt,{key:"append",defaults:{VIcon:{icon:e.appendIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__append"},[(null==(x=o.append)?void 0:x.call(o))??t.createVNode(ta,null,null)])]}),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[(null==(C=o.loader)?void 0:C.call(o))??t.createVNode(aa,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"23",width:"2"},null)])]}),[[t.resolveDirective("ripple"),!w.value&&e.ripple,null]])})),{}}}),Oa=Fe({name:"VAppBarNavIcon",props:{icon:{type:jl,default:"$menu"}},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(Pa,{class:"v-app-bar-nav-icon",icon:e.icon},a))),{}}}),Ma=Fe({name:"VToolbarItems",props:$l({variant:"text"}),setup(e,l){let{slots:a}=l
return Oe({VBtn:{color:t.toRef(e,"color"),height:"inherit",variant:t.toRef(e,"variant")}}),Ge((()=>{var e
return t.createVNode("div",{class:"v-toolbar-items"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),za=Fe({name:"VAppBarTitle",props:{...dl.props},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(dl,{class:"v-app-bar-title"},a))),{}}}),Fa=je("v-alert-title"),Da=["success","info","warning","error"],ja=Fe({name:"VAlert",props:{border:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:jl,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>Da.includes(e)},...Nl(),...ll(),...fl(),..._a(),...$a(),...gl(),...cl(),...dt(),...$l({variant:"flat"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return o.value&&t.createVNode(e.tag,{class:["v-alert",e.border&&{"v-alert--border":!!e.border,[`v-alert--border-${!0===e.border?"start":e.border}`]:!0},{"v-alert--prominent":e.prominent},i.value,s.value,d.value,p.value,m.value,g.value,c.value],style:[u.value,v.value,f.value],role:"alert"},{default:()=>[Il(!1,"v-alert"),e.border&&t.createVNode("div",{key:"border",class:["v-alert__border",h.value],style:y.value},null),b&&t.createVNode(Lt,{key:"prepend",defaults:{VIcon:{density:e.density,icon:n.value,size:e.prominent?44:28}}},{default:()=>[t.createVNode("div",{class:"v-alert__prepend"},[a.prepend?a.prepend():n.value&&t.createVNode(ta,null,null)])]}),t.createVNode("div",{class:"v-alert__content"},[S&&t.createVNode(Fa,{key:"title"},{default:()=>[a.title?a.title():e.title]}),w&&(a.text?a.text():e.text),null==(l=a.default)?void 0:l.call(a)]),a.append&&t.createVNode("div",{key:"append",class:"v-alert__append"},[a.append()]),k&&t.createVNode(Lt,{key:"close",defaults:{VBtn:{icon:e.closeIcon,size:"x-small",variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-alert__close"},[(null==(r=a.close)?void 0:r.call(a,{props:V.value}))??t.createVNode(Pa,V.value,null)])]})]})}}}),Ha=Fe({name:"VMessages",props:{active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...il({transition:{component:Jt,leaveAbsolute:!0,group:!0}})},setup(e,l){let{slots:a}=l
const o=t.computed((()=>k(e.messages))),{textColorClasses:n,textColorStyles:r}=bl(t.computed((()=>e.color)))
return Ge((()=>t.createVNode(sl,{transition:e.transition,tag:"div",class:["v-messages",n.value],style:r.value},{default:()=>[e.active&&o.value.map(((e,l)=>t.createVNode("div",{class:"v-messages__message",key:`${l}-${o.value}`},[a.message?a.message({message:e}):e])))]}))),{}}}),Wa=Symbol.for("vuetify:form"),Ua=Me({disabled:Boolean,fastFail:Boolean,lazyValidation:Boolean,readonly:Boolean,modelValue:{type:Boolean,default:null}},"form")
function Ya(){return t.inject(Wa,null)}const Xa=Me({disabled:Boolean,error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:Boolean,rules:{type:Array,default:()=>[]},modelValue:null,validationValue:null},"validation")
...
return t.createVNode(ta,{icon:e[`${o}Icon`],"aria-label":i,onClick:r},null)}}}const Ka=Me({id:String,appendIcon:jl,prependIcon:jl,hideDetails:[Boolean,String],messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":M,"onClick:append":M,...Nl(),...Xa()},"VInput"),Za=De()({name:"VInput",props:{...Ka()},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o,emit:n}=l
const{densityClasses:r}=_l(e),{InputIcon:i}=qa(e),s=Re(),u=t.computed((()=>e.id||`input-${s}`)),{errorMessages:c,isDirty:d,isDisabled:v,isReadonly:p,isPristine:f,isValid:m,isValidating:g,reset:h,resetValidation:y,validate:b,validationClasses:V}=Ga(e,"v-input",u),S=t.computed((()=>({id:u,isDirty:d,isDisabled:v,isReadonly:p,isPristine:f,isValid:m,isValidating:g,reset:h,resetValidation:y,validate:b})))
...
function Ja(e){return S(e,Object.keys(Za.props).filter((e=>!O(e))))}const Qa=Fe({name:"VLabel",props:{text:String,clickable:Boolean,...dt()},setup(e,l){let{slots:a}=l
return Ge((()=>{var l
return t.createVNode("label",{class:["v-label",{"v-label--clickable":e.clickable}]},[e.text,null==(l=a.default)?void 0:l.call(a)])})),{}}}),eo=Symbol.for("vuetify:selection-control-group"),to=Me({color:String,disabled:Boolean,error:Boolean,id:String,inline:Boolean,falseIcon:jl,trueIcon:jl,ripple:{type:Boolean,default:!0},multiple:{type:Boolean,default:null},name:String,readonly:Boolean,modelValue:null,type:String,valueComparator:{type:Function,default:v},...dt(),...Nl()},"VSelectionControlGroup"),lo=Fe({name:"VSelectionControlGroup",props:{defaultsTarget:{type:String,default:"VSelectionControl"},...to()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=bt(e,"modelValue"),n=Re(),r=t.computed((()=>e.id||`v-selection-control-group-${n}`)),i=t.computed((()=>e.name||r.value))
return t.provide(eo,{modelValue:o}),Oe({[e.defaultsTarget]:{color:t.toRef(e,"color"),disabled:t.toRef(e,"disabled"),density:t.toRef(e,"density"),error:t.toRef(e,"error"),inline:t.toRef(e,"inline"),modelValue:o,multiple:t.computed((()=>!!e.multiple||null==e.multiple&&Array.isArray(o.value))),name:i,falseIcon:t.toRef(e,"falseIcon"),trueIcon:t.toRef(e,"trueIcon"),readonly:t.toRef(e,"readonly"),ripple:t.toRef(e,"ripple"),type:t.toRef(e,"type"),valueComparator:t.toRef(e,"valueComparator")}}),Ge((()=>{var l
return t.createVNode("div",{class:["v-selection-control-group",{"v-selection-control-group--inline":e.inline}],"aria-labelled-by":"radio"===e.type?r.value:void 0,role:"radio"===e.type?"radiogroup":void 0},[null==(l=a.default)?void 0:l.call(a)])})),{}}}),ao=Me({label:String,trueValue:null,falseValue:null,value:null,...to()},"VSelectionControl")
const oo=De()({name:"VSelectionControl",directives:{Ripple:Sa},inheritAttrs:!1,props:ao(),emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const{densityClasses:r,icon:i,model:s,textColorClasses:u,textColorStyles:c,trueValue:d}=function(e){const l=t.inject(eo,void 0),{densityClasses:a}=_l(e),o=bt(e,"modelValue"),n=t.computed((()=>void 0!==e.trueValue?e.trueValue:void 0===e.value||e.value)),r=t.computed((()=>void 0!==e.falseValue&&e.falseValue)),i=t.computed((()=>!!e.multiple||null==e.multiple&&Array.isArray(o.value))),s=t.computed({get(){const t=l?l.modelValue.value:o.value
...
let s=a
i.value&&(s=t?[...k(o.value),a]:k(o.value).filter((t=>!e.valueComparator(t,n.value)))),l?l.modelValue.value=s:o.value=s}}),{textColorClasses:u,textColorStyles:c}=bl(t.computed((()=>!s.value||e.error||e.disabled?void 0:e.color))),d=t.computed((()=>s.value?e.trueIcon:e.falseIcon))
return{group:l,densityClasses:a,trueValue:n,falseValue:r,model:s,textColorClasses:u,textColorStyles:c,icon:d}}(e),v=Re(),p=t.computed((()=>e.id||`input-${v}`)),f=t.ref(!1),m=t.ref(!1),g=t.ref()
function h(e){f.value=!0,(!n||n&&e.target.matches(":focus-visible"))&&(m.value=!0)}function y(){f.value=!1,m.value=!1}function b(e){s.value=e.target.checked}return Ge((()=>{var l,n
const v=o.label?o.label({label:e.label,props:{for:p.value}}):e.label,[V,S]=w(a)
return t.createVNode("div",t.mergeProps({class:["v-selection-control",{"v-selection-control--dirty":s.value,"v-selection-control--disabled":e.disabled,"v-selection-control--error":e.error,"v-selection-control--focused":f.value,"v-selection-control--focus-visible":m.value,"v-selection-control--inline":e.inline},r.value]},V),[t.createVNode("div",{class:["v-selection-control__wrapper",u.value],style:c.value},[null==(l=o.default)?void 0:l.call(o),t.withDirectives(t.createVNode("div",{class:["v-selection-control__input"]},[i.value&&t.createVNode(ta,{key:"icon",icon:i.value},null),t.createVNode("input",t.mergeProps({ref:g,checked:s.value,disabled:e.disabled,id:p.value,onBlur:y,onFocus:h,onInput:b,"aria-readonly":e.readonly,type:e.type,value:d.value,name:e.name,"aria-checked":"checkbox"===e.type?s.value:void 0},S),null),null==(n=o.input)?void 0:n.call(o,{model:s,textColorClasses:u,textColorStyles:c,props:{onFocus:h,onBlur:y,id:p.value}})]),[[t.resolveDirective("ripple"),e.ripple&&[!e.disabled&&!e.readonly,null,["center","circle"]]]])]),v&&t.createVNode(Qa,{for:p.value,clickable:!0},{default:()=>[v]})])})),{isFocused:f,input:g}}})
function no(e){return S(e,Object.keys(oo.props))}const ro=Me({indeterminate:Boolean,indeterminateIcon:{type:jl,default:"$checkboxIndeterminate"},...ao({falseIcon:"$checkboxOff",trueIcon:"$checkboxOn"})},"VCheckboxBtn"),io=Fe({name:"VCheckboxBtn",props:ro(),emits:{"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,l){let{slots:a}=l
...
return Ge((()=>t.createVNode(oo,t.mergeProps(e,{modelValue:n.value,"onUpdate:modelValue":[e=>n.value=e,r],class:"v-checkbox-btn",type:"checkbox",inline:!0,falseIcon:i.value,trueIcon:s.value,"aria-checked":e.indeterminate?"mixed":void 0}),a))),{}}})
const so=Fe({name:"VCheckbox",inheritAttrs:!1,props:{...Ka(),...ro()},setup(e,l){let{attrs:a,slots:o}=l
const n=Re(),r=t.computed((()=>e.id||`checkbox-${n}`))
return Ge((()=>{const[l,n]=w(a),[i,s]=Ja(e),[u,c]=function(e){return S(e,Object.keys(io.props))}(e)
return t.createVNode(Za,t.mergeProps({class:"v-checkbox"},l,i,{id:r.value}),{...o,default:e=>{let{id:l,isDisabled:a,isReadonly:r}=e
return t.createVNode(io,t.mergeProps(u,{id:l.value,disabled:a.value,readonly:r.value},n),o)}})})),{}}}),uo=Me({start:Boolean,end:Boolean,icon:jl,image:String,...Nl(),...gl(),...Jl(),...cl(),...$l({variant:"flat"})},"VAvatar"),co=Fe({name:"VAvatar",props:uo(),setup(e,l){let{slots:a}=l
...
return Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},o.value,i.value,s.value,u.value,r.value],style:[n.value,c.value]},{default:()=>[e.image?t.createVNode(ul,{key:"image",src:e.image,alt:""},null):e.icon?t.createVNode(ta,{key:"icon",icon:e.icon},null):null==(l=a.default)?void 0:l.call(a),Il(!1,"v-avatar")]})})),{}}}),vo=Symbol.for("vuetify:v-chip-group"),po=Fe({name:"VChipGroup",props:{column:Boolean,filter:Boolean,valueComparator:{type:Function,default:v},...Rl({selectedClass:"v-chip--selected"}),...cl(),...dt(),...$l({variant:"tonal"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Pl(e,vo)
return Oe({VChip:{color:t.toRef(e,"color"),filter:t.toRef(e,"filter"),variant:t.toRef(e,"variant")}}),Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value]},{default:()=>[null==(l=a.default)?void 0:l.call(a,{isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),fo=Fe({name:"VChip",directives:{Ripple:Sa},props:{activeClass:String,appendAvatar:String,appendIcon:jl,closable:Boolean,closeIcon:{type:jl,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:String,default:"$complete"},label:Boolean,link:Boolean,pill:Boolean,prependAvatar:String,prependIcon:jl,ripple:{type:Boolean,default:!0},text:String,modelValue:{type:Boolean,default:!0},...vl(),...Nl(),...fl(),...Ll(),...gl(),...La(),...Jl(),...cl({tag:"span"}),...dt(),...$l({variant:"tonal"})},emits:{"click:close":e=>!0,"update:active":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0},setup(e,l){let{attrs:a,emit:o,slots:n}=l
const{borderClasses:r}=pl(e),{colorClasses:i,colorStyles:s,variantClasses:u}=Al(e),{densityClasses:c}=_l(e),{elevationClasses:d}=ml(e),{roundedClasses:v}=hl(e),{sizeClasses:p}=Ql(e),{themeClasses:f}=ft(e),m=bt(e,"modelValue"),g=Tl(e,vo,!1),h=Ra(e,a)
...
case"multiple":default:return Vo}})),s=bt(e,"selected",e.selected,(e=>r.value.in(e,a.value,o.value)),(e=>r.value.out(e,a.value,o.value)))
...
return!a.isGroupActivator&&a.root.register(o.value,a.id.value,l),t.onBeforeUnmount((()=>{!a.isGroupActivator&&a.root.unregister(o.value)})),l&&t.provide(xo,n),n},Io=Fe({name:"VListGroupActivator",setup(e,l){let{slots:a}=l
return(()=>{const e=t.inject(xo,Co)
t.provide(xo,{...e,isGroupActivator:!0})})(),()=>{var e
return null==(e=a.default)?void 0:e.call(a)}}}),$o=Me({activeColor:String,color:String,collapseIcon:{type:jl,default:"$collapse"},expandIcon:{type:jl,default:"$expand"},prependIcon:jl,appendIcon:jl,fluid:Boolean,subgroup:Boolean,value:null,...cl()},"VListGroup"),Ao=De()({name:"VListGroup",props:{title:String,...$o()},setup(e,l){let{slots:a}=l
...
return Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":null==r?void 0:r.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup}]},{default:()=>[a.activator&&t.createVNode(Lt,{defaults:{VListItem:{active:o.value,activeColor:e.activeColor,color:e.color,prependIcon:e.prependIcon||e.subgroup&&u.value,appendIcon:e.appendIcon||!e.subgroup&&u.value,title:e.title,value:e.value}}},{default:()=>[t.createVNode(Io,null,{default:()=>[a.activator({props:s.value,isOpen:o})]})]}),t.createVNode(el,null,{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items"},[null==(l=a.default)?void 0:l.call(a)]),[[t.vShow,o.value]])]})]})})),{}}})
const Eo=je("v-list-item-subtitle"),Ro=je("v-list-item-title"),Lo=De()({name:"VListItem",directives:{Ripple:Sa},props:{active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:jl,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:jl,subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,...vl(),...Nl(),...ll(),...fl(),...gl(),...La(),...cl(),...dt(),...$l({variant:"text"})},setup(e,l){let{attrs:a,slots:o}=l
const n=Ra(e,a),r=t.computed((()=>e.value??n.href.value)),{select:i,isSelected:s,isIndeterminate:u,isGroupActivator:c,root:d,parent:v,openOnSelect:p}=Bo(r,!1),f=yo(),m=t.computed((()=>{var t
...
c||(null==(l=n.navigate)||l.call(n,t),null!=e.value&&i(!s.value,t))})},{default:()=>[Il(h.value||m.value,"v-list-item"),E&&t.createVNode(Lt,{key:"prepend",defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[t.createVNode("div",{class:"v-list-item__prepend"},[e.prependAvatar&&t.createVNode(co,{key:"prepend-avatar"},null),e.prependIcon&&t.createVNode(ta,{key:"prepend-icon"},null),null==(l=o.prepend)?void 0:l.call(o,$.value)])]}),t.createVNode("div",{class:"v-list-item__content"},[y&&t.createVNode(Ro,{key:"title"},{default:()=>[(null==(a=o.title)?void 0:a.call(o,{title:e.title}))??e.title]}),b&&t.createVNode(Eo,{key:"subtitle"},{default:()=>[(null==(r=o.subtitle)?void 0:r.call(o,{subtitle:e.subtitle}))??e.subtitle]}),null==(u=o.default)?void 0:u.call(o,$.value)]),A&&t.createVNode(Lt,{key:"append",defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[t.createVNode("div",{class:"v-list-item__append"},[null==(d=o.append)?void 0:d.call(o,$.value),e.appendIcon&&t.createVNode(ta,{key:"append-icon"},null),e.appendAvatar&&t.createVNode(co,{key:"append-avatar"},null)])]})]}),[[t.resolveDirective("ripple"),h.value]])})),{}}}),To=Fe({name:"VListSubheader",props:{color:String,inset:Boolean,sticky:Boolean,title:String,...cl()},setup(e,l){let{slots:a}=l
const{textColorClasses:o,textColorStyles:n}=bl(t.toRef(e,"color"))
return Ge((()=>{var l
const r=!(!a.default&&!e.title)
return t.createVNode(e.tag,{class:["v-list-subheader",{"v-list-subheader--inset":e.inset,"v-list-subheader--sticky":e.sticky},o.value],style:{textColorStyles:n}},{default:()=>[r&&t.createVNode("div",{class:"v-list-subheader__text"},[(null==(l=a.default)?void 0:l.call(a))??e.title])]})})),{}}}),Po=De()({name:"VListChildren",props:{items:Array},setup(e,l){let{slots:a}=l
return ho(),()=>{var l,o
...
return a.header?a.header({...o,...l}):t.createVNode(Lo,t.mergeProps(o,l),u)},default:()=>t.createVNode(Po,{items:l},a)}):a.item?a.item(o):t.createVNode(Lo,o,u)})))}}}),Oo=Me({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean},"item")
function Mo(e,t){const l=f(t,e.itemTitle,t),a=e.returnObject?t:f(t,e.itemValue,l),o=f(t,e.itemChildren),n={title:l,value:a,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?S(t,["children"])[1]:t:f(t,e.itemProps)}
...
return l}function Fo(e){return{items:t.computed((()=>zo(e,e.items))),transformIn:function(t){return t.map((t=>Mo(e,t)))},transformOut:function(e){return e.map((e=>{let{props:t}=e
...
return l}const Ho=De()({name:"VList",props:{activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,lines:{type:[Boolean,String],default:"one"},nav:Boolean,...No({selectStrategy:"single-leaf",openStrategy:"list"}),...vl(),...Nl(),...ll(),...fl(),itemType:{type:String,default:"type"},...Oo(),...gl(),...cl(),...dt(),...$l({variant:"text"})},emits:{"update:selected":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,l){let{slots:a}=l
const{items:o}=function(e){return{items:t.computed((()=>jo(e,e.items)))}}(e),{themeClasses:n}=ft(e),{backgroundColorClasses:r,backgroundColorStyles:i}=Vl(t.toRef(e,"bgColor")),{borderClasses:s}=pl(e),{densityClasses:u}=_l(e),{dimensionStyles:c}=al(e),{elevationClasses:d}=ml(e),{roundedClasses:v}=hl(e),{open:p,select:f}=_o(e),m=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),g=t.toRef(e,"activeColor"),h=t.toRef(e,"color")
return ho(),Oe({VListGroup:{activeColor:g,color:h},VListItem:{activeClass:t.toRef(e,"activeClass"),activeColor:g,color:h,density:t.toRef(e,"density"),disabled:t.toRef(e,"disabled"),lines:t.toRef(e,"lines"),nav:t.toRef(e,"nav"),variant:t.toRef(e,"variant")}}),Ge((()=>t.createVNode(e.tag,{class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav},n.value,r.value,s.value,u.value,d.value,m.value,v.value],style:[i.value,c.value]},{default:()=>[t.createVNode(Po,{items:o.value},a)]}))),{open:p,select:f}}}),Wo=je("v-list-img"),Uo=Fe({name:"VListItemAction",props:{start:Boolean,end:Boolean,...cl()},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end}]},a))),{}}}),Yo=Fe({name:"VListItemMedia",props:{start:Boolean,end:Boolean,...cl()},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(e.tag,{class:["v-list-item-media",{"v-list-item-media--start":e.start,"v-list-item-media--end":e.end}]},a))),{}}}),Xo=Me({closeDelay:[Number,String],openDelay:[Number,String]},"delay")
...
return{runCloseDelay:o("closeDelay"),runOpenDelay:o("openDelay")}}const qo=Symbol.for("vuetify:v-menu"),Ko=Me({activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...Xo()},"VOverlay/useActivator")
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,x,{activatorEl:i,activatorEvents:V})}))):C&&C.stop()}),{flush:"post",immediate:!0}),{activatorEl:i,activatorRef:k,activatorEvents:V,contentEvents:S,scrimEvents:w}}const Jo=Me({eager:Boolean},"lazy")
...
return t.x-=parseFloat(e.style.left||0),t.y-=parseFloat(e.style.top||0),t}(e.contentEl.value),a=Ye(e.contentEl.value)
...
return requestAnimationFrame((()=>{o.value.maxHeight&&f()})),{updateLocation:f}}},an=Me({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in ln},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]},"VOverlay/locationStrategies")
...
const o=null==(a=e.root.value)?void 0:a.offsetParent,n=[...new Set([...Ye(e.activatorEl.value,l.contained?o:void 0),...Ye(e.contentEl.value,l.contained?o:void 0)])].filter((e=>!e.classList.contains("v-overlay-scroll-blocked"))),r=window.innerWidth-document.documentElement.offsetWidth,i=(s=o||document.documentElement,Xe(s)&&s)
var s
...
t=r/(1e3/60)>2},!rn||sn.length?(sn.push(a),cn()):(rn=!1,a(),cn())}pn(e.activatorEl.value??e.contentEl.value,(e=>{t?(cancelAnimationFrame(l),l=requestAnimationFrame((()=>{l=requestAnimationFrame((()=>{a(e)}))}))):a(e)}))}},vn=Me({scrollStrategy:{type:[String,Function],default:"block",validator:e=>"function"==typeof e||e in dn}},"VOverlay/scrollStrategies")
function pn(e,l){const a=[document,...Ye(e)]
...
return o.push(t),!o.some((t=>null==t?void 0:t.contains(e.target)))}function bn(e,t){return("object"==typeof t.value&&t.value.closeConditional||hn)(e)}function Vn(e,t){const l=He(e)
...
return t.createVNode(t.Transition,{name:"fade-transition",appear:!0},{default:()=>[e.modelValue&&t.createVNode("div",t.mergeProps({class:["v-overlay__scrim",e.color.backgroundColorClasses.value],style:e.color.backgroundColorStyles.value},o),null)]})}const kn=De()({name:"VOverlay",directives:{ClickOutside:Sn},inheritAttrs:!1,props:{absolute:Boolean,attach:[Boolean,String,Object],closeOnBack:{type:Boolean,default:!0},contained:Boolean,contentClass:null,contentProps:null,disabled:Boolean,noClickAnimation:Boolean,modelValue:Boolean,persistent:Boolean,scrim:{type:[String,Boolean],default:!0},zIndex:{type:[Number,String],default:2e3},...Ko(),...ll(),...Jo(),...an(),...vn(),...dt(),...il()},emits:{"click:outside":e=>!0,"update:modelValue":e=>!0,afterLeave:()=>!0},setup(e,a){let{slots:o,attrs:n,emit:r}=a
const i=bt(e,"modelValue"),s=t.computed({get:()=>i.value,set:t=>{t&&e.disabled||(i.value=t)}}),{teleportTarget:u}=gn(t.computed((()=>e.attach||e.contained))),{themeClasses:c}=ft(e),{rtlClasses:d,isRtl:v}=Et(),{hasContent:p,onAfterLeave:f}=Qo(e,s),m=Vl(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:h,localTop:y,stackStyles:b}=function(e,l){const a=Ie("useStack"),o=t.inject(fn,void 0),n=t.reactive({activeChildren:new Set})
t.provide(fn,n)
...
return{globalTop:t.readonly(i),localTop:s,stackStyles:t.computed((()=>({zIndex:r.value})))}}(s,t.toRef(e,"zIndex")),{activatorEl:V,activatorRef:S,activatorEvents:w,contentEvents:k,scrimEvents:x}=Zo(e,{isActive:s,isTop:y}),{dimensionStyles:C}=al(e)
...
const L=t.ref()
function T(){e.noClickAnimation||_.value&&Z(_.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:We})}return t.watch((()=>s.value&&(e.absolute||e.contained)&&null==u.value),(e=>{if(e){const e=Ue(N.value)
...
return{scopeId:e?{[e]:""}:void 0}}const _n=De()({name:"VMenu",inheritAttrs:!1,props:{modelValue:Boolean,id:String,...il({transition:{component:Mt}})},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const n=bt(e,"modelValue"),{scopeId:r}=Nn(),i=Re(),s=t.computed((()=>e.id||`v-menu-${i}`)),u=t.ref(),c=t.inject(qo,null)
let d=0
...
return t.createVNode(Lt,{root:!0},{default:()=>[null==(e=o.default)?void 0:e.call(o,...a)]})}}))),Cn({id:s},u)}}),Bn=Fe({name:"VFieldLabel",props:{floating:Boolean},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(Qa,{class:["v-field-label",{"v-field-label--floating":e.floating}],"aria-hidden":e.floating||void 0},a))),{}}}),In=Me({focused:Boolean},"focus")
...
function n(){a.value=!0}function r(){a.value=!1}return{focusClasses:o,isFocused:a,focus:n,blur:r}}const An=["underlined","outlined","filled","solo","plain"],En=Me({appendInnerIcon:jl,bgColor:String,clearable:Boolean,clearIcon:{type:jl,default:"$clear"},active:Boolean,color:String,dirty:Boolean,disabled:Boolean,error:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:jl,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>An.includes(e)},"onClick:clear":M,"onClick:appendInner":M,"onClick:prependInner":M,...dt(),...ka()},"v-field"),Rn=De()({name:"VField",inheritAttrs:!1,props:{id:String,...In(),...En()},emits:{"click:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,l){let{attrs:a,emit:o,slots:n}=l
const{themeClasses:r}=ft(e),{loaderClasses:i}=xa(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=$n(e),{InputIcon:v}=qa(e),p=t.computed((()=>e.dirty||e.active)),f=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),m=Re(),h=t.computed((()=>e.id||`input-${m}`)),y=t.ref(),b=t.ref(),V=t.ref(),{backgroundColorClasses:S,backgroundColorStyles:w}=Vl(t.toRef(e,"bgColor")),{textColorClasses:k,textColorStyles:x}=bl(t.computed((()=>p.value&&u.value&&!e.error&&!e.disabled?e.color:void 0)))
...
t.style.visibility="visible",l.style.visibility="hidden",Z(t,{transform:`translate(${n}px, ${r}px) scale(${v})`,color:p,...s},{duration:d,easing:We,direction:e?"normal":"reverse"}).finished.then((()=>{t.style.removeProperty("visibility"),l.style.removeProperty("visibility")}))}}),{flush:"post"})
...
v.value||(v.value=!0)}function h(e){g(),o("click:control",e)}function y(l){l.stopPropagation(),g(),t.nextTick((()=>{r.value="",z(e["onClick:clear"],l)}))}function b(e){r.value=e.target.value}return Ge((()=>{const l=!!(n.counter||e.counter||e.counterValue),V=!(!l&&!n.details),[S,k]=w(a),[{modelValue:x,...C}]=Ja(e),[N]=Ln(e)
...
return t.createVNode(Rn,t.mergeProps({ref:d,onMousedown:e=>{e.target!==p.value&&e.preventDefault()},"onClick:control":h,"onClick:clear":y,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:"textbox"},N,{id:a.value,active:f.value||s.value,dirty:s.value||e.dirty,focused:v.value,error:!1===m.value}),{...n,default:l=>{let{props:{class:a,...s}}=l
const d=t.withDirectives(t.createVNode("input",t.mergeProps({ref:p,value:r.value,onInput:b,autofocus:e.autofocus,readonly:c.value,disabled:i.value,name:e.name,placeholder:e.placeholder,size:1,type:e.type,onFocus:g,onBlur:()=>v.value=!1},s,k),null),[[t.resolveDirective("intersect"),{handler:u},null,{once:!0}]])
return t.createVNode(t.Fragment,null,[e.prefix&&t.createVNode("span",{class:"v-text-field__prefix"},[e.prefix]),n.default?t.createVNode("div",{class:a,onClick:e=>o("click:input",e),"data-no-activator":""},[n.default(),d]):t.cloneVNode(d,{class:a}),e.suffix&&t.createVNode("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:V?a=>{var o
return t.createVNode(t.Fragment,null,[null==(o=n.details)?void 0:o.call(n,a),l&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Tn,{active:e.persistentCounter||v.value,value:i.value,max:s.value},n.counter)])])}:void 0})})),Cn({},c,d,p)}}),Mn=Me({chips:Boolean,closableChips:Boolean,eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:jl,default:"$dropdown"},menuProps:{type:Object},modelValue:{type:null,default:()=>[]},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,readonly:Boolean,...Oo({itemChildren:!1})},"select"),zn=De()({name:"VSelect",props:{...Mn(),...il({transition:{component:Mt}})},emits:{"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:a}=l
const{t:o}=$t(),n=t.ref(),r=bt(e,"menu"),{items:i,transformIn:s,transformOut:u}=Fo(e),c=bt(e,"modelValue",[],(e=>s(k(e))),(t=>{const l=u(t)
...
return e.multiple&&!e.hideSelected?t.createVNode(io,{modelValue:a,ripple:!1},null):void 0}})})),null==(u=a["append-item"])?void 0:u.call(a)]})]}),d.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),g(o)},modelValue:!0,"onUpdate:modelValue":void 0}
return t.createVNode("div",{key:o.value,class:"v-select__selection"},[l?t.createVNode(Lt,{defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[a.chip?a.chip({item:o,index:n,props:r}):t.createVNode(fo,r,null)]}):a.selection?a.selection({item:o,index:n}):t.createVNode("span",{class:"v-select__selection-text"},[o.title,e.multiple&&n<d.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({menu:r,select:g},n)}}),Fn=(e,t,l)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),Dn=Me({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
...
return{item:a[t],matches:l}}))}))}}const Hn=De()({name:"VAutocomplete",props:{search:String,...Dn({filterKeys:["title"]}),...Mn(),...il({transition:!1})},emits:{"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:a}=l
const{t:o}=$t(),n=t.ref(),r=t.ref(!1),i=t.ref(!0),s=bt(e,"menu"),{items:u,transformIn:c,transformOut:d}=Fo(e),v=bt(e,"search",""),p=bt(e,"modelValue",[],(e=>c(k(e))),(t=>{const l=d(t)
...
l?(w.value=!0,v.value=e.multiple||a.selection?"":String((null==(o=m.value.at(-1))?void 0:o.props.title)??""),i.value=!0,t.nextTick((()=>w.value=!1))):(s.value=!1,v.value="")})),t.watch(v,(e=>{r.value&&!w.value&&(e&&(s.value=!0),i.value=!e)})),Ge((()=>{const l=!(!e.chips&&!a.chip)
return t.createVNode(On,{ref:n,modelValue:v.value,"onUpdate:modelValue":e=>{null==e&&(p.value=[])},validationValue:p.externalValue,dirty:p.value.length>0,onInput:V,class:["v-autocomplete",{"v-autocomplete--active-menu":s.value,"v-autocomplete--chips":!!e.chips,["v-autocomplete--"+(e.multiple?"multiple":"single")]:!0,"v-autocomplete--selection-slot":!!a.selection}],appendInnerIcon:e.menuIcon,readonly:e.readonly,"onClick:clear":h,"onClick:control":y,"onClick:input":y,onFocus:()=>r.value=!0,onBlur:()=>r.value=!1,onKeydown:b},{...a,default:()=>{var n,r,u
return t.createVNode(t.Fragment,null,[t.createVNode(_n,t.mergeProps({modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,activator:"parent",contentClass:"v-autocomplete__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:S},e.menuProps),{default:()=>[t.createVNode(Ho,{selected:g.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault()},{default:()=>[!f.value.length&&!e.hideNoData&&((null==(n=a["no-data"])?void 0:n.call(a))??t.createVNode(Lo,{title:o(e.noDataText)},null)),null==(r=a["prepend-item"])?void 0:r.call(a),f.value.map(((l,o)=>{var n
...
return t.createVNode("div",{key:o.value,class:"v-autocomplete__selection"},[l?t.createVNode(Lt,{defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[a.chip?a.chip({item:o,index:n,props:r}):t.createVNode(fo,r,null)]}):a.selection?a.selection({item:o,index:n}):t.createVNode("span",{class:"v-autocomplete__selection-text"},[o.title,e.multiple&&n<m.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({isFocused:r,isPristine:i,menu:s,search:v,filteredItems:f,select:x},n)}}),Wn=Fe({name:"VBadge",inheritAttrs:!1,props:{bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:jl,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,..._a({location:"top end"}),...gl(),...cl(),...dt(),...il({transition:"scale-rotate-transition"})},setup(e,l){const{backgroundColorClasses:a,backgroundColorStyles:o}=Vl(t.toRef(e,"color")),{roundedClasses:n}=hl(e),{t:r}=$t(),{textColorClasses:i,textColorStyles:s}=bl(t.toRef(e,"textColor")),{themeClasses:u}=mt(),{locationStyles:c}=Ba(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline}]},y),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[null==(d=(v=l.slots).default)?void 0:d.call(v),t.createVNode(sl,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,a.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,m),"aria-live":"polite",role:"status"},h),[e.dot?void 0:l.slots.badge?null==(p=(f=l.slots).badge)?void 0:p.call(f):e.icon?t.createVNode(ta,{icon:e.icon},null):g]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),Un=Fe({name:"VBannerActions",props:{color:String,density:String},setup(e,l){let{slots:a}=l
return Oe({VBtn:{color:e.color,density:e.density,variant:"text"}}),Ge((()=>{var e
return t.createVNode("div",{class:"v-banner-actions"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),Yn=je("v-banner-text"),Xn=Symbol.for("vuetify:display"),Gn={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}}
...
function d(){i.value=Kn(),c.value=qn()}return t.watchEffect((()=>{const e=c.value<n.sm,t=c.value<n.md&&!e,l=c.value<n.lg&&!(t||e),a=c.value<n.xl&&!(l||t||e),o=c.value<n.xxl&&!(a||l||t||e),d=c.value>=n.xxl,v=e?"xs":t?"sm":l?"md":a?"lg":o?"xl":"xxl",p="number"==typeof r?r:n[r],f=s.ssr?s.android||s.ios||s.opera:c.value<p
u.xs=e,u.sm=t,u.md=l,u.lg=a,u.xl=o,u.xxl=d,u.smAndUp=!e,u.mdAndUp=!(e||t),u.lgAndUp=!(e||t||l),u.xlAndUp=!(e||t||l||a),u.smAndDown=!(l||a||o||d),u.mdAndDown=!(a||o||d),u.lgAndDown=!(o||d),u.xlAndDown=!d,u.name=v,u.height=i.value,u.width=c.value,u.mobile=f,u.mobileBreakpoint=r,u.platform=s,u.thresholds=n})),l&&window.addEventListener("resize",d,{passive:!0}),{...t.toRefs(u),update:d}}function Jn(){const e=t.inject(Xn)
if(!e)throw new Error("Could not find Vuetify display injection")
return e}const Qn=Fe({name:"VBanner",props:{avatar:String,color:String,icon:jl,lines:String,stacked:Boolean,sticky:Boolean,text:String,...vl(),...Nl(),...ll(),...fl(),..._a(),...$a(),...gl(),...cl(),...dt()},setup(e,l){let{slots:a}=l
const{borderClasses:o}=pl(e),{densityClasses:n}=_l(e),{mobile:r}=Jn(),{dimensionStyles:i}=al(e),{elevationClasses:s}=ml(e),{locationStyles:u}=Ba(e),{positionClasses:c}=Aa(e),{roundedClasses:d}=hl(e),{themeClasses:v}=ft(e),p=t.toRef(e,"color"),f=t.toRef(e,"density")
Oe({VBannerActions:{color:p,density:f}}),Ge((()=>{var l
const m=!(!e.text&&!a.text),g=!!(a.prepend||e.avatar||e.icon)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||r.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},o.value,n.value,s.value,c.value,d.value,v.value],style:[i.value,u.value],role:"banner"},{default:()=>[g&&t.createVNode(Lt,{key:"prepend",defaults:{VAvatar:{color:p.value,density:f.value,icon:e.icon,image:e.avatar}}},{default:()=>[t.createVNode("div",{class:"v-banner__prepend"},[a.prepend?a.prepend():(e.avatar||e.icon)&&t.createVNode(co,null,null)])]}),t.createVNode("div",{class:"v-banner__content"},[m&&t.createVNode(Yn,{key:"text"},{default:()=>[a.text?a.text():e.text]}),null==(l=a.default)?void 0:l.call(a)]),a.actions&&t.createVNode(Un,null,{default:()=>[a.actions()]})]})}))}}),er=Fe({name:"VBottomNavigation",props:{bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},...vl(),...Nl(),...fl(),...gl(),...Je({name:"bottom-navigation"}),...cl({tag:"header"}),...Rl({modelValue:!0,selectedClass:"v-btn--selected"}),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return t.createVNode(o,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,"v-breadcrumbs-item--link":n.isLink.value,[`${e.activeClass}`]:r.value&&e.activeClass},s.value],style:[u.value],href:n.href.value,"aria-current":r.value?"page":void 0,onClick:n.navigate},{default:()=>[(null==(l=a.default)?void 0:l.call(a))??e.title]})})),{}}}),ar=De()({name:"VBreadcrumbs",props:{activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:jl,items:{type:Array,default:()=>[]},...Nl(),...gl(),...cl({tag:"ul"})},setup(e,l){let{slots:a}=l
...
return null==(e=a.title)?void 0:e.call(a,{item:l,index:o})}:void 0}),o<n.length-1&&t.createVNode(tr,null,{default:()=>[(null==(r=a.divider)?void 0:r.call(a,{item:l,index:o}))??e.divider]})])})),null==(l=a.default)?void 0:l.call(a)]})})),{}}}),or=Fe({name:"VCardActions",setup(e,l){let{slots:a}=l
return Oe({VBtn:{variant:"text"}}),Ge((()=>{var e
return t.createVNode("div",{class:"v-card-actions"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),nr=je("v-card-subtitle"),rr=je("v-card-title"),ir=t.defineComponent({name:"VCardItem",props:{appendAvatar:String,appendIcon:jl,prependAvatar:String,prependIcon:jl,subtitle:String,title:String,...Nl()},setup(e,l){let{slots:a}=l
...
return t.createVNode("div",{class:"v-card-item"},[s&&t.createVNode(Lt,{key:"prepend",defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},{default:()=>[t.createVNode("div",{class:"v-card-item__prepend"},[(null==(l=a.prepend)?void 0:l.call(a))??t.createVNode(co,null,null)])]}),t.createVNode("div",{class:"v-card-item__content"},[c&&t.createVNode(rr,{key:"title"},{default:()=>[(null==(o=a.title)?void 0:o.call(a))??e.title]}),d&&t.createVNode(nr,{key:"subtitle"},{default:()=>[(null==(n=a.subtitle)?void 0:n.call(a))??e.subtitle]}),null==(r=a.default)?void 0:r.call(a)]),u&&t.createVNode(Lt,{key:"append",defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},{default:()=>[t.createVNode("div",{class:"v-card-item__append"},[(null==(i=a.append)?void 0:i.call(a))??t.createVNode(co,null,null)])]})])})),{}}}),sr=je("v-card-text"),ur=Fe({name:"VCard",directives:{Ripple:Sa},props:{appendAvatar:String,appendIcon:jl,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:jl,ripple:Boolean,subtitle:String,text:String,title:String,...dt(),...vl(),...Nl(),...ll(),...fl(),...ka(),..._a(),...$a(),...gl(),...La(),...cl(),...$l({variant:"elevated"})},setup(e,l){let{attrs:a,slots:o}=l
...
return t.withDirectives(t.createVNode(S,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value],style:[s.value,d.value,f.value],href:h.href.value,onClick:b.value&&h.navigate},{default:()=>[_&&t.createVNode(Lt,{key:"image",defaults:{VImg:{cover:!0,src:e.image}}},{default:()=>[t.createVNode("div",{class:"v-card__image"},[(null==(l=o.image)?void 0:l.call(o))??t.createVNode(ul,null,null)])]}),t.createVNode(Ca,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),B&&t.createVNode(ir,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),I&&t.createVNode(sr,{key:"text"},{default:()=>[(null==(a=o.text)?void 0:a.call(o))??e.text]}),null==(V=o.default)?void 0:V.call(o),o.actions&&t.createVNode(or,null,{default:o.actions}),Il(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value]])})),{}}})
...
V(r).forEach((e=>{o.removeEventListener(e,r[e])})),delete o._touchHandlers[n]}},fr=Symbol.for("vuetify:v-window"),mr=Symbol.for("vuetify:v-window-group"),gr=De()({name:"VWindow",directives:{Touch:pr},props:{continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{default:"force"},...cl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{isRtl:n}=Et(),{t:r}=$t(),i=Pl(e,mr),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.ref(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.ref(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
return{ssrBootStyles:t.computed((()=>e.value?void 0:{transition:"none !important"})),isBooted:t.readonly(e)}}const yr=Fe({name:"VWindowItem",directives:{Touch:pr},props:{reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...Ll(),...Jo()},emits:{"group:selected":e=>!0},setup(e,l){let{slots:a}=l
const o=t.inject(fr),n=Tl(e,mr),{isBooted:r}=hr()
...
return Ge((()=>{var e
return t.createVNode(sl,{transition:r.value&&p.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value]},[f.value&&(null==(e=a.default)?void 0:e.call(a))]),[[t.vShow,n.isSelected.value]])]})})),{}}}),br=Fe({name:"VCarousel",props:{color:String,cycle:Boolean,delimiterIcon:{type:jl,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>e>0},modelValue:null,progress:[Boolean,String],showArrows:{type:[Boolean,String],default:!0,validator:e=>"boolean"==typeof e||"hover"===e},verticalDelimiters:[Boolean,String]},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return t.createVNode("div",{class:"v-color-picker-edit__input"},[t.createVNode("input",a,null),t.createVNode("span",null,[l])])},Er=Fe({name:"VColorPickerEdit",props:{color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys($r).includes(e)},modes:{type:Array,default:()=>Object.keys($r),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys($r).includes(e)))}},emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,l){let{emit:a}=l
...
return Ge((()=>{var l
return t.createVNode("div",{class:"v-color-picker-edit"},[null==(l=n.value)?void 0:l.map((e=>t.createVNode(Ar,e,null))),o.value.length>1&&t.createVNode(Pa,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
...
return a?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const Tr=Me({disabled:Boolean,error:Boolean,readonly:Boolean,max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...gl(),...fl({elevation:2})},"slider"),Pr=e=>{let{props:l,handleSliderMouseUp:a,handleMouseMove:o,getActiveThumb:n}=e
...
return t.provide(Rr,F),F},Or=Fe({name:"VSliderThumb",directives:{Ripple:Sa},props:{focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0}},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a,emit:o}=l
const n=t.inject(Rr)
...
return Ge((()=>{const[l,s]=Ja(e),v=!!(e.label||a.label||a.prepend)
...
const si=Fe({name:"VColorPickerSwatches",props:{swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const l=e[t]
...
return()=>t.createVNode(e.tag,{class:["v-sheet",o.value,n.value,i.value,u.value,d.value,v.value],style:[r.value,s.value,c.value]},a)}}),ci=Fe({name:"VColorPicker",inheritAttrs:!1,props:{canvasHeight:{type:[String,Number],default:150},disabled:Boolean,dotSize:{type:[Number,String],default:10},hideCanvas:Boolean,hideSliders:Boolean,hideInputs:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys($r).includes(e)},modes:{type:Array,default:()=>Object.keys($r),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys($r).includes(e)))},showSwatches:Boolean,swatches:Array,swatchesMaxHeight:{type:[Number,String],default:150},modelValue:{type:[Object,String]},width:{type:[Number,String],default:300},...fl(),...gl(),...dt()},emits:{"update:modelValue":e=>!0,"update:mode":e=>!0},setup(e){const l=bt(e,"mode"),a=t.ref(null),o=bt(e,"modelValue",void 0,(e=>{let t=Cr(e)
...
const di=De()({name:"VCombobox",props:{delimiters:Array,...Dn({filterKeys:["title"]}),...Mn({hideNoData:!0,returnObject:!0}),...il({transition:!1})},emits:{"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){var a
let{emit:o,slots:n}=l
const{t:r}=$t(),i=t.ref(),s=t.ref(!1),u=t.ref(!0),c=bt(e,"menu"),d=t.ref(-1),v=t.computed((()=>{var e
return null==(e=i.value)?void 0:e.color})),{items:p,transformIn:f,transformOut:m}=Fo(e),{textColorClasses:g,textColorStyles:h}=bl(v),y=bt(e,"modelValue",[],(e=>f(k(e||[]))),(t=>{const l=m(t)
return e.multiple?l:l[0]??null})),b=t.ref(e.multiple?"":(null==(a=y.value[0])?void 0:a.title)??""),V=t.computed({get:()=>b.value,set:t=>{var l
if(b.value=t,e.multiple||(y.value=[Mo(e,t)]),t&&e.multiple&&null!=(l=e.delimiters)&&l.length){const l=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
l.length>1&&(l.forEach((t=>{(t=t.trim())&&$(Mo(e,t))})),b.value="")}t||(d.value=-1),s.value&&(c.value=!0),u.value=!t}})
t.watch(b,(e=>{o("update:search",e)})),t.watch(y,(t=>{var l
e.multiple||(b.value=(null==(l=t[0])?void 0:l.title)??"")}))
const{filteredItems:S}=jn(e,p,t.computed((()=>u.value?void 0:V.value))),w=t.computed((()=>y.value.map((e=>p.value.find((t=>t.value===e.value))||e)))),x=t.computed((()=>w.value.map((e=>e.props.value)))),C=t.computed((()=>w.value[d.value]))
...
const e=d.value+1
w.value[e]?d.value=e:(d.value=-1,i.value.setSelectionRange(0,0))}"Enter"===l.key&&($(Mo(e,V.value)),V.value="")}}function I(){s.value&&(u.value=!0)}function $(l){if(e.multiple){const e=x.value.findIndex((e=>e===l.value))
if(-1===e)y.value=[...y.value,l]
else{const t=[...y.value]
t.splice(e,1),y.value=t}V.value=""}else y.value=[l],b.value=l.title,t.nextTick((()=>{c.value=!1,u.value=!0}))}return t.watch(S,(t=>{!t.length&&e.hideNoData&&(c.value=!1)})),t.watch(s,(t=>{if(t)d.value=-1
else{if(c.value=!1,!e.multiple||!V.value)return
y.value=[...y.value,Mo(e,V.value)],V.value=""}})),Ge((()=>{const l=!(!e.chips&&!n.chip)
return t.createVNode(On,{ref:i,modelValue:V.value,"onUpdate:modelValue":[e=>V.value=e,e=>{null==e&&(y.value=[])}],validationValue:y.externalValue,dirty:y.value.length>0,class:["v-combobox",{"v-combobox--active-menu":c.value,"v-combobox--chips":!!e.chips,"v-combobox--selecting-index":d.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0}],appendInnerIcon:e.items.length?e.menuIcon:void 0,readonly:e.readonly,"onClick:clear":N,"onClick:control":_,"onClick:input":_,onFocus:()=>s.value=!0,onBlur:()=>s.value=!1,onKeydown:B},{...n,default:()=>{var a,o,i
return t.createVNode(t.Fragment,null,[t.createVNode(_n,t.mergeProps({modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-combobox__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:I},e.menuProps),{default:()=>[t.createVNode(Ho,{selected:x.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault()},{default:()=>[!S.value.length&&!e.hideNoData&&((null==(a=n["no-data"])?void 0:a.call(n))??t.createVNode(Lo,{title:r(e.noDataText)},null)),null==(o=n["prepend-item"])?void 0:o.call(n),S.value.map(((l,a)=>{var o
let{item:r,matches:i}=l
return(null==(o=n.item)?void 0:o.call(n,{item:r,index:a,props:t.mergeProps(r.props,{onClick:()=>$(r)})}))??t.createVNode(Lo,t.mergeProps({key:a},r.props,{onClick:()=>$(r)}),{prepend:l=>{let{isSelected:a}=l
return e.multiple&&!e.hideSelected?t.createVNode(io,{modelValue:a,ripple:!1},null):void 0},title:()=>{var e
return u.value?r.title:function(e,l,a){if(Array.isArray(l))throw new Error("Multiple matches is not implemented")
return"number"==typeof l&&~l?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,l)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(l,a)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(l+a)])]):e}(r.title,i.title,(null==(e=V.value)?void 0:e.length)??0)}})})),null==(i=n["append-item"])?void 0:i.call(n)]})]}),w.value.map(((a,o)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),$(a)},modelValue:!0,"onUpdate:modelValue":void 0}
return t.createVNode("div",{key:a.value,class:["v-combobox__selection",o===d.value&&["v-combobox__selection--selected",g.value]],style:o===d.value?h.value:{}},[l?t.createVNode(Lt,{defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[n.chip?n.chip({item:a,index:o,props:r}):t.createVNode(fo,r,null)]}):n.selection?n.selection({item:a,index:o}):t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&o<w.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({isFocused:s,isPristine:u,menu:c,search:V,selectionIndex:d,filteredItems:S,select:$},i)}}),vi=De()({name:"VDialog",inheritAttrs:!1,props:{fullscreen:Boolean,origin:{type:String,default:"center center"},retainFocus:{type:Boolean,default:!0},scrollable:Boolean,modelValue:Boolean,...il({transition:{component:Mt}})},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:o,slots:n}=a
const r=bt(e,"modelValue"),{scopeId:i}=Nn(),s=t.ref()
...
a===t?l.focus():t.focus()}}return l&&t.watch((()=>r.value&&e.retainFocus),(e=>{e?document.addEventListener("focusin",u):document.removeEventListener("focusin",u)}),{immediate:!0}),t.watch(r,(async e=>{var l,a;(await t.nextTick(),e)?null==(l=s.value.contentEl)||l.focus({preventScroll:!0}):null==(a=s.value.activatorEl)||a.focus({preventScroll:!0})})),Ge((()=>t.createVNode(kn,t.mergeProps({modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable}],transition:e.transition,scrollStrategy:"block",ref:s,"aria-role":"dialog","aria-modal":"true",activatorProps:{"aria-haspopup":"dialog","aria-expanded":String(r.value)},"z-index":2400},i,o),{activator:n.activator,default:function(){for(var e,l=arguments.length,a=new Array(l),o=0;o<l;o++)a[o]=arguments[o]
return t.createVNode(Lt,{root:!0},{default:()=>[null==(e=n.default)?void 0:e.call(n,...a)]})}}))),Cn({},s)}}),pi=Symbol.for("vuetify:v-expansion-panel"),fi=["default","accordion","inset","popout"],mi=Fe({name:"VExpansionPanels",props:{color:String,variant:{type:String,default:"default",validator:e=>fi.includes(e)},readonly:Boolean,...Rl(),...cl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
Pl(e,pi)
const{themeClasses:o}=ft(e),n=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return Oe({VExpansionPanel:{color:t.toRef(e,"color")},VExpansionPanelTitle:{readonly:t.toRef(e,"readonly")}}),Ge((()=>t.createVNode(e.tag,{class:["v-expansion-panels",o.value,n.value]},a))),{}}}),gi=Me({color:String,expandIcon:{type:jl,default:"$expand"},collapseIcon:{type:jl,default:"$collapse"},hideActions:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean},"VExpansionPanelTitle"),hi=Fe({name:"VExpansionPanelTitle",directives:{Ripple:Sa},props:{...gi()},setup(e,l){let{slots:a}=l
const o=t.inject(pi)
...
return t.createVNode(t.Fragment,null,[null==(a=n.details)?void 0:a.call(n,e),l&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Tn,{active:!!i.value.length,value:v.value},n.counter)])])}:void 0})})),Cn({},p,f,g)}}),Si=Fe({name:"VFooter",props:{app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...vl(),...fl(),...Je(),...gl(),...cl({tag:"footer"}),...dt()},setup(e,l){let{slots:a}=l
...
return Ge((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",o.value,n.value,s.value,u.value,c.value],style:[i,e.app?f.value:void 0]},a))),{}}}),wi=Fe({name:"VForm",props:{...Ua()},emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,l){let{slots:a,emit:o}=l
...
return t.createVNode("form",{ref:r,class:"v-form",novalidate:!0,onReset:i,onSubmit:s},[null==(e=a.default)?void 0:e.call(a,n)])})),Cn(n,r)}}),ki=Fe({name:"VContainer",props:{fluid:{type:Boolean,default:!1},...cl()},setup(e,l){let{slots:a}=l
...
if(null!=l&&!1!==l){if(t){a+=`-${t.replace(e,"")}`}return"col"===e&&(a="v-"+a),"col"!==e||""!==l&&!0!==l?(a+=`-${l}`,a.toLowerCase()):a.toLowerCase()}}const $i=["auto","start","end","center","baseline","stretch"],Ai=Fe({name:"VCol",props:{cols:{type:[Boolean,String,Number],default:!1},...Ci,offset:{type:[String,Number],default:null},...Ni,order:{type:[String,Number],default:null},..._i,alignSelf:{type:String,default:null,validator:e=>$i.includes(e)},...cl()},setup(e,l){let{slots:a}=l
...
if(null!=l){if(t){a+=`-${t.replace(e,"")}`}return a+=`-${l}`,a.toLowerCase()}}const Gi=Fe({name:"VRow",props:{dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:Oi},...Mi,justify:{type:String,default:null,validator:Fi},...Di,alignContent:{type:String,default:null,validator:Hi},...Wi,...cl()},setup(e,l){let{slots:a}=l
const o=t.computed((()=>{const t=[]
let l
...
return()=>{var l
return t.h(e.tag,{class:["v-row",o.value]},null==(l=a.default)?void 0:l.call(a))}}}),qi=je("flex-grow-1","div","VSpacer"),Ki=Fe({name:"VHover",props:{disabled:Boolean,modelValue:{type:Boolean,default:void 0},...Xo()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:l}=t
const a=bt(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Go(e,(t=>!e.disabled&&(a.value=t)))
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,{isHovering:a.value,props:{onMouseenter:o,onMouseleave:n}})}}}),Zi=Symbol.for("vuetify:v-item-group"),Ji=Fe({name:"VItemGroup",props:{...Rl({selectedClass:"v-item--selected"}),...cl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Pl(e,Zi)
return()=>{var l
return t.createVNode(e.tag,{class:["v-item-group",o.value]},{default:()=>[null==(l=a.default)?void 0:l.call(a,{isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}}),Qi=De()({name:"VItem",props:Ll(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:l}=t
const{isSelected:a,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=Tl(e,Zi)
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,{isSelected:a.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}}),es=je("v-kbd"),ts=Fe({name:"VLayout",props:Ze(),setup(e,l){let{slots:a}=l
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=tt(e)
return Ge((()=>{var e
return t.createVNode("div",{ref:s,class:o.value,style:n.value},[null==(e=a.default)?void 0:e.call(a)])})),{getLayoutItem:r,items:i}}}),ls=Fe({name:"VLayoutItem",props:{position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...Je()},setup(e,l){let{slots:a}=l
...
return()=>{var e
return t.createVNode("div",{class:["v-layout-item"],style:o.value},[null==(e=a.default)?void 0:e.call(a)])}}}),as=Fe({name:"VLazy",directives:{intersect:rl},props:{modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...ll(),...cl(),...il({transition:"fade-transition"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{dimensionStyles:o}=al(e),n=bt(e,"modelValue")
function r(e){n.value||(n.value=e)}return Ge((()=>{var l
return t.withDirectives(t.createVNode(e.tag,{class:"v-lazy",style:o.value},{default:()=>[n.value&&t.createVNode(sl,{transition:e.transition},{default:()=>[null==(l=a.default)?void 0:l.call(a)]})]}),[[t.resolveDirective("intersect"),r,e.options]])})),{}}}),os=Fe({name:"VLocaleProvider",props:{locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0}},setup(e,l){let{slots:a}=l
const{rtlClasses:o}=At(e)
return Ge((()=>{var e
return t.createVNode("div",{class:["v-locale-provider",o.value]},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),ns=Fe({name:"VMain",props:{scrollable:Boolean,...cl({tag:"main"})},setup(e,l){let{slots:a}=l
...
return l>a&&e>=0?"right":l>a&&e<=0?"left":a>l&&t>=0?"down":a>l&&t<=0?"up":function(){throw new Error}()}}}}}function us(){throw new Error}const cs=["start","end","left","right","bottom"],ds=Fe({name:"VNavigationDrawer",props:{color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:Boolean,railWidth:{type:[Number,String],default:56},scrim:{type:[String,Boolean],default:!0},image:String,temporary:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>cs.includes(e)},sticky:Boolean,...vl(),...fl(),...Je(),...gl(),...cl({tag:"nav"}),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const{isRtl:n}=Et(),{themeClasses:r}=ft(e),{borderClasses:i}=pl(e),{backgroundColorClasses:s,backgroundColorStyles:u}=Vl(t.toRef(e,"color")),{elevationClasses:c}=ml(e),{mobile:d}=Jn(),{roundedClasses:v}=hl(e),p=Ea(),f=bt(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:m}=hr(),h=t.ref(),y=t.ref(!1),b=t.computed((()=>e.rail&&e.expandOnHover&&y.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),V=t.computed((()=>H(e.location,n.value))),S=t.computed((()=>!e.permanent&&(d.value||e.temporary))),w=t.computed((()=>e.sticky&&!S.value&&"bottom"!==V.value))
...
const vs=Fe({name:"VNoSsr",setup(e,a){let{slots:o}=a
const n=t.ref(!1)
...
const fs=Fe({name:"VParallax",props:{scale:{type:[Number,String],default:.5}},setup(e,l){let{slots:a}=l
const{intersectionRef:o,isIntersecting:n}=la(),{resizeRef:i,contentRect:s}=r(),{height:u}=Jn(),c=t.ref()
let d
t.watchEffect((()=>{var e
o.value=i.value=null==(e=c.value)?void 0:e.$el})),t.watch(n,(e=>{e?(d=Ue(o.value),d=d===document.scrollingElement?document:d,d.addEventListener("scroll",f,{passive:!0}),f()):d.removeEventListener("scroll",f)})),t.onBeforeUnmount((()=>{var e
...
t.style.setProperty("transform",`translateY(${i}px) scale(${p})`)})))}return Ge((()=>t.createVNode(ul,{class:["v-parallax",{"v-parallax--active":n.value}],ref:c,cover:!0,onLoadstart:f,onLoad:f},a))),{}}}),ms=Fe({name:"VRadio",props:{...ao({falseIcon:"$radioOff",trueIcon:"$radioOn"})},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(oo,t.mergeProps(e,{class:"v-radio",type:"radio"}),a))),{}}}),gs=Fe({name:"VRadioGroup",inheritAttrs:!1,props:{height:{type:[Number,String],default:"auto"},...Ka(),...function(e,t){const l={...e}
return t.forEach((e=>delete l[e])),l}(to(),["multiple"]),trueIcon:{type:jl,default:"$radioOn"},falseIcon:{type:jl,default:"$radioOff"},type:{type:String,default:"radio"}},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const n=Re(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=bt(e,"modelValue")
return Ge((()=>{const[l,n]=w(a),[s,u]=Ja(e),[c,d]=no({...e,multiple:!1}),v=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
...
return t.createVNode(t.Fragment,null,[v&&t.createVNode(Qa,{for:a.value,clickable:!0},{default:()=>[v]}),t.createVNode(lo,t.mergeProps(c,{id:a.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:r.value,readonly:s.value},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),hs=Fe({name:"VRangeSlider",props:{...In(),...Ka(),...Tr(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return r<i||r===i&&l<0?o.value.$el:n.value.$el}}),h=bt(e,"modelValue",void 0,(e=>e&&e.length?e.map((e=>m(e))):[0,0])),{isFocused:y,focus:b,blur:V}=$n(e),S=t.computed((()=>f(h.value[0]))),w=t.computed((()=>f(h.value[1])))
return Ge((()=>{const[l,f]=Ja(e),m=!!(e.label||a.label||a.prepend)
...
return u<=n?n=Math.max(u-v,0):c<=d&&(n=Math.min(n-(c-d-v),a-l)),n}const Ss=Symbol.for("vuetify:v-slide-group"),ws=De()({name:"VSlideGroup",props:{centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:Ss},nextIcon:{type:jl,default:"$next"},prevIcon:{type:jl,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...cl(),...Rl({selectedClass:"v-slide-group-item--active"})},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:o}=a
const{isRtl:n}=Et(),{mobile:i}=Jn(),s=Pl(e,e.symbol),u=t.ref(!1),c=t.ref(0),d=t.ref(0),v=t.ref(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=r(),{resizeRef:g,contentRect:h}=r(),y=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),b=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(l){let l=-1
...
function d(){n.value&&(n.value=!1)}return Ge((()=>{const[l,u]=w(a),[v,p]=Ja(e),[f,m]=no(e),g=t.ref()
function h(){var e,t
...
return t.createVNode(oo,t.mergeProps({ref:g},f,{modelValue:r.value,"onUpdate:modelValue":[e=>r.value=e,d],id:a.value,type:"checkbox","aria-checked":n.value?"mixed":void 0,disabled:i.value,readonly:c.value},u),{...o,default:()=>t.createVNode("div",{class:"v-switch__track",onClick:h},null),input:l=>{let{textColorClasses:a,textColorStyles:n}=l
return t.createVNode("div",{class:["v-switch__thumb",a.value],style:n.value},[e.loading&&t.createVNode(Ca,{name:"v-switch",active:!0,color:!1===v.value?void 0:s.value},{default:e=>o.loader?o.loader(e):t.createVNode(aa,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)})])}})}})})),{}}}),Ns=Fe({name:"VSystemBar",props:{color:String,height:[Number,String],window:Boolean,...fl(),...Je(),...gl(),...cl(),...dt()},setup(e,l){let{slots:a}=l
...
return Ge((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value],style:[r.value,c.value]},a))),{}}}),_s=Symbol.for("vuetify:v-tabs"),Bs=Fe({name:"VTab",props:{fixed:Boolean,icon:[Boolean,String,Function,Object],prependIcon:jl,appendIcon:jl,stacked:Boolean,title:String,ripple:{type:Boolean,default:!0},color:String,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...cl(),...La(),...Ll({selectedClass:"v-tab--selected"}),...dt()},setup(e,l){let{slots:a,attrs:o}=l
...
Z(t,{backgroundColor:[o,""],transform:[`translate${d}(${f}px) scale${d}(${n[p]/r[p]})`,`translate${d}(${f/h}px) scale${d}(${(g-1)/h+1})`,""],transformOrigin:Array(3).fill(m)},{duration:225,easing:We})}}return Ge((()=>{const[l]=S(e,["href","to","replace","icon","stacked","prependIcon","appendIcon","ripple","theme","disabled","selectedClass","value","color"])
return t.createVNode(Pa,t.mergeProps({_as:"VTab",symbol:_s,ref:u,class:["v-tab"],tabindex:s.value?0:-1,role:"tab","aria-selected":String(s.value),active:!1,block:e.fixed,maxWidth:e.fixed?300:void 0,variant:"text",rounded:0},l,o,{"onGroup:selected":d}),{default:()=>[a.default?a.default():e.title,!e.hideSlider&&t.createVNode("div",{ref:c,class:["v-tab__slider",n.value],style:r.value},null)]})})),{}}})
const Is=Fe({name:"VTabs",props:{alignTabs:{type:String,default:"start"},color:String,direction:{type:String,default:"horizontal"},fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,modelValue:null,mandatory:{type:[Boolean,String],default:"force"},...Nl(),...cl()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return t.createVNode("div",{class:["v-timeline-divider",{"v-timeline-divider--fill-dot":e.fillDot}]},[t.createVNode("div",{class:["v-timeline-divider__before",c.value],style:d.value},null),!e.hideDot&&t.createVNode("div",{key:"dot",class:["v-timeline-divider__dot",u.value,s.value,o.value],style:n.value},[t.createVNode("div",{class:["v-timeline-divider__inner-dot",i.value,s.value],style:r.value},[(null==(l=a.default)?void 0:l.call(a))??(e.icon?t.createVNode(ta,null,null):void 0)])]),t.createVNode("div",{class:["v-timeline-divider__after",c.value],style:d.value},null)])})),{}}}),Ts=Fe({name:"VTimelineItem",props:{density:String,dotColor:String,fillDot:Boolean,hideDot:Boolean,hideOpposite:{type:Boolean,default:void 0},icon:jl,iconColor:String,lineInset:[Number,String],...gl(),...fl(),...Jl(),...cl(),...ll()},setup(e,l){let{slots:a}=l
...
return(null==(t=o.default)?void 0:t.call(o,...a))??e.text}}))),Cn({},u)}}),Os=Fe({name:"VValidation",props:{...Xa()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:l}=t
const a=Ga(e,"validation")
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,a)}}})
var Ms=Object.freeze({__proto__:null,VApp:Rt,VAppBar:xl,VAppBarNavIcon:Oa,VAppBarTitle:za,VAlert:ja,VAlertTitle:Fa,VAutocomplete:Hn,VAvatar:co,VBadge:Wn,VBanner:Qn,VBannerActions:Un,VBannerText:Yn,VBottomNavigation:er,VBreadcrumbs:ar,VBreadcrumbsItem:lr,VBreadcrumbsDivider:tr,VBtn:Pa,VBtnGroup:El,VBtnToggle:zl,VCard:ur,VCardActions:or,VCardItem:ir,VCardSubtitle:nr,VCardText:sr,VCardTitle:rr,VCarousel:br,VCarouselItem:Vr,VCheckbox:so,VCheckboxBtn:io,VChip:fo,VChipGroup:po,VCode:Sr,VColorPicker:ci,VCombobox:di,VCounter:Tn,VDefaultsProvider:Lt,VDialog:vi,VDivider:mo,VExpansionPanels:mi,VExpansionPanel:bi,VExpansionPanelText:yi,VExpansionPanelTitle:hi,VField:Rn,VFieldLabel:Bn,VFileInput:Vi,VFooter:Si,VForm:wi,VContainer:ki,VCol:Ai,VRow:Gi,VSpacer:qi,VHover:Ki,VIcon:ta,VComponentIcon:Ul,VSvgIcon:Yl,VLigatureIcon:Xl,VClassIcon:Gl,VImg:ul,VInput:Za,VItemGroup:Ji,VItem:Qi,VKbd:es,VLabel:Qa,VLayout:ts,VLayoutItem:ls,VLazy:as,VList:Ho,VListGroup:Ao,VListImg:Wo,VListItem:Lo,VListItemAction:Uo,VListItemMedia:Yo,VListItemSubtitle:Eo,VListItemTitle:Ro,VListSubheader:To,VLocaleProvider:os,VMain:ns,VMenu:_n,VMessages:Ha,VNavigationDrawer:ds,VNoSsr:vs,VOverlay:kn,VPagination:ps,VParallax:fs,VProgressCircular:aa,VProgressLinear:wa,VRadio:ms,VRadioGroup:gs,VRangeSlider:hs,VRating:ys,VResponsive:ol,VSelect:zn,VSelectionControl:oo,VSelectionControlGroup:lo,VSheet:ui,VSlideGroup:ws,VSlideGroupItem:ks,VSlider:zr,VSnackbar:xs,VSwitch:Cs,VSystemBar:Ns,VTabs:Is,VTab:Bs,VTable:$s,VTextarea:As,VTextField:On,VThemeProvider:Es,VTimeline:Rs,VTimelineItem:Ts,VToolbar:kl,VToolbarTitle:dl,VToolbarItems:Ma,VTooltip:Ps,VValidation:Os,VWindow:gr,VWindowItem:yr,VDialogTransition:Mt,VFabTransition:Dt,VDialogBottomTransition:jt,VDialogTopTransition:Ht,VFadeTransition:Wt,VScaleTransition:Ut,VScrollXTransition:Yt,VScrollXReverseTransition:Xt,VScrollYTransition:Gt,VScrollYReverseTransition:qt,VSlideXTransition:Kt,VSlideXReverseTransition:Zt,VSlideYTransition:Jt,VSlideYReverseTransition:Qt,VExpandTransition:el,VExpandXTransition:tl})
...
var Us=Object.freeze({__proto__:null,ClickOutside:Sn,Intersect:rl,Mutate:Fs,Resize:Ds,Ripple:Sa,Scroll:Ws,Touch:pr})
function Ys(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:a,...o}=e,n=_(a,o),{aliases:r={},components:i={},directives:s={}}=n,u=Te(n.defaults),c=Zn(n.display,n.ssr),d=pt(n.theme),v=Kl(n.icons),p=It(n.locale),f=e=>{for(const t in s)e.directive(t,s[t])
for(const t in i)e.component(t,i[t])
for(const t in r)e.component(t,Fe({...r[t],name:t,aliasName:r[t].name}))
if(d.install(e),e.provide(Le,u),e.provide(Xn,c),e.provide(ct,d),e.provide(Hl,v),e.provide(Bt,p),l&&n.ssr){const{mount:l}=e
e.mount=function(){const a=l(...arguments)
return t.nextTick((()=>c.update())),e.mount=l,a}}Re.reset(),e.mixin({computed:{$vuetify(){return t.reactive({defaults:Xs.call(this,Le),display:Xs.call(this,Xn),theme:Xs.call(this,ct),icons:Xs.call(this,Hl),locale:Xs.call(this,Bt)})}}})}
return{install:f,defaults:u,display:c,theme:d,icons:v,locale:p}}function Xs(e){var t,l
const a=this.$,o=(null==(t=a.parent)?void 0:t.provides)??(null==(l=a.vnode.appContext)?void 0:l.provides)
if(o&&e in o)return o[e]}Ys.version="3.0.0-beta.15"
const Gs=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Ys({components:Ms,directives:Us,...e})},qs="3.0.0-beta.15"
Gs.version=qs,e.components=Ms,e.createVuetify=Gs,e.directives=Us,e.useDisplay=Jn,e.useLayout=Qe,e.useLocale=$t,e.useRtl=Et,e.useTheme=mt,e.version=qs,Object.defineProperty(e,"__esModule",{value:!0})}))
