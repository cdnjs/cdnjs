...
let l
t.watchEffect((async()=>{l?.stop(),a.isActive.value&&e.scrollStrategy&&(l=t.effectScope(),await t.nextTick(),l.active&&l.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(a,e,l):ir[e.scrollStrategy]?.(a,e,l)})))})),t.onScopeDispose((()=>{l?.stop()}))}(e,{root:A,contentEl:R,targetEl:k,isActive:s,updateLocation:E}),o&&t.watch(s,(e=>{e?window.addEventListener("keydown",$):window.removeEventListener("keydown",$)}),{immediate:!0}),t.onBeforeUnmount((()=>{o&&window.removeEventListener("keydown",$)}))
const M=lo()
...
let o=[]
for(let n=1;n<=42-t.length;n++)o.push(a.addDays(l,n)),n%7==0&&(e.push(o),o=[])}return e})),s=t.computed((()=>{const t=i.value.flat(),o=a.date()
return t.map(((t,n)=>{const i=a.toISO(t),s=!a.isSameMonth(t,r.value),u=a.isSameDay(t,a.startOfMonth(r.value)),d=a.isSameDay(t,a.endOfMonth(r.value)),v=a.isSameDay(t,r.value)
return{date:t,isoDate:i,formatted:a.format(t,"keyboardDate"),year:a.getYear(t),month:a.getMonth(t),isDisabled:c(t),isWeekStart:n%7==0,isWeekEnd:n%7==6,isToday:a.isSameDay(t,o),isAdjacent:s,isHidden:s&&!e.showAdjacentMonths,isStart:u,isSelected:l.value.some((e=>a.isSameDay(t,e))),isEnd:d,isSame:v,localized:a.format(t,"dayOfMonth")}}))})),u=t.computed((()=>i.value.map((e=>e.length?function(e,t){const a=e.toJsDate(t)
...
function c(t){if(e.disabled)return!0
const l=a.date(t)
return!(!e.min||!a.isAfter(a.date(e.min),l))||(!(!e.max||!a.isAfter(l,a.date(e.max)))||(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?!e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"==typeof e.allowedDates&&!e.allowedDates(l)))}return{displayValue:o,daysInMonth:s,model:l,weeksInMonth:i,weekNumbers:u}}const Gc=a({color:String,hideWeekdays:Boolean,multiple:Boolean,showWeek:Boolean,...Uc()},"VDatePickerMonth"),qc=gt()({name:"VDatePickerMonth",props:Gc(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
t.splice(e,1),i.value=t}}else i.value=[t]}return()=>t.createVNode("div",{class:"v-date-picker-month"},[e.showWeek&&t.createVNode("div",{key:"weeks",class:"v-date-picker-month__weeks"},[!e.hideWeekdays&&t.createVNode("div",{key:"hide-week-days",class:"v-date-picker-month__day"},[t.createTextVNode(" ")]),s.value.map((e=>t.createVNode("div",{class:["v-date-picker-month__day","v-date-picker-month__day--adjacent"]},[e])))]),t.createVNode("div",{ref:n,class:"v-date-picker-month__days"},[!e.hideWeekdays&&u.getWeekdays().map((e=>t.createVNode("div",{class:["v-date-picker-month__day","v-date-picker-month__weekday"]},[e]))),r.value.map(((a,l)=>{const n={props:{onClick:()=>c(a.date)},item:a,i:l}
...
return At((()=>t.createVNode(Ea,{onAfterLeave:r},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-expansion-panel-text",e.class],style:e.style},[l.default&&n.value&&t.createVNode("div",{class:"v-expansion-panel-text__wrapper"},[l.default?.()])]),[[t.vShow,o.isSelected.value]])]}))),{}}}),cd=a({color:String,expandIcon:{type:Pl,default:"$expand"},collapseIcon:{type:Pl,default:"$collapse"},hideActions:Boolean,static:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean,...l()},"VExpansionPanelTitle"),dd=gt()({name:"VExpansionPanelTitle",directives:{Ripple:xo},props:cd(),setup(e,a){let{slots:l}=a
const o=t.inject(od)
...
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),Pd=ht("v-kbd"),Bd=a({...l(),...Dt()},"VLayout"),Ad=gt()({name:"VLayout",props:Bd(),setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()])}}),Ed=a({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...l(),...Ma(),...ca(),...ja({transition:"fade-transition"})},"VLazy"),Dd=gt()({name:"VLazy",directives:{intersect:Ua},props:Ed(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
c.value=E(t,0,v.value-d.value)}const D=t.computed((()=>{let e=c.value>v.value-d.value?-(v.value-d.value)+pv(v.value-d.value-c.value):-c.value
...
return t.createVNode(_s,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":e.mobile},e.class],style:e.style}),{default:()=>[o&&t.createVNode(kv,{key:"stepper-header"},{default:()=>[v.value.map(((e,a)=>t.createVNode(t.Fragment,null,[!!a&&t.createVNode(Dn,null,null),t.createVNode(Nv,e,{default:l[`header-item.${e.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])))]}),i&&t.createVNode(Iv,{key:"stepper-window"},{default:()=>[v.value.map((e=>t.createVNode(Bv,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),s&&(l.actions?.({next:n,prev:r})??t.createVNode(wv,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),Ev=a({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...en(),...Oo()},"VSwitch"),Dv=gt()({name:"VSwitch",inheritAttrs:!1,props:Ev(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
var dp=Object.freeze({__proto__:null,ClickOutside:Dr,Intersect:Ua,Mutate:rp,Resize:ip,Ripple:xo,Scroll:cp,Touch:Yi})
...
if(a&&e in a)return a[e]}vp.version="3.4.8"
const fp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return vp({components:op,directives:dp,...e})},mp="3.4.8"
