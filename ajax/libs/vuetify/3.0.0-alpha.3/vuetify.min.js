...
function maybeTransition(props, data, vNodes) {
  ...
  return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.h)(external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.Transition, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.mergeProps)(typeof props.transition === 'string' ? {
    name: props.transition
  } : props.transition, data), () => vNodes);
}
const randomHexColor = () => {
  const n = (Math.random() * 0xfffff * 1000000).toString(16);
  return '#' + n.slice(0, 6);
};
const toKebabCase = str => str.replace(/([A-Z])/g, match => "-".concat(match.toLowerCase()));
...
function createTheme(options) {
  ...
  return {
    ...
    current,
    themeClasses: (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => parsedOptions.isDisabled ? '' : "v-theme--".concat(current.value)),
...
function provideTheme(props = {}, context) {
  ...
  const themeClasses = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => theme.isDisabled ? '' : "v-theme--".concat(current.value));
...
function useLayoutItem(name, priority, position, amount) {
  const layout = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.inject)(VuetifyLayoutKey);
  if (!layout) throw new Error('Could not find injected Vuetify layout');
  const id = name != null ? name : "layout-item-".concat(getUid());
...
function createRtlScope(currentScope, localeScope, options) {
  ...
  return {
    ...
    rtlClasses: (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => "v-locale--is-".concat(isRtl.value ? 'rtl' : 'ltr'))
  };
}
...
/* harmony default export */ var VAvatar = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    return () => (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(props.tag, {
      ...
      }, backgroundColorClasses.value, roundedClasses.value, sizeClasses.value],
...
/* harmony default export */ var VBadge = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, ctx) {
    ...
    function calculatePosition(offset) {
      return "calc(100% - ".concat(convertToUnit(position.value + parseInt(offset != null ? offset : 0, 10)), ")");
    }
    ...
    return () => {
      ...
      const content = !props.max || isNaN(value) ? props.content : value <= props.max ? value : "".concat(props.max, "+");
      ...
      return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(props.tag, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.mergeProps)({
        ...
        default: () => [(0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
        ...
        }, [ctx.slots.default == null ? void 0 : ctx.slots.default(), maybeTransition(props, {}, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("span", (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.mergeProps)({
          ...
          "aria-live": "polite",
          "role": "status"
        }, badgeAttrs), [props.dot ? undefined : ctx.slots.badge ? ctx.slots.badge == null ? void 0 : ctx.slots.badge() : props.icon ? (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(VIcon, {
          "icon": props.icon
  ...
  setup(props, {
    ...
    return () => {
      ...
      return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(props.tag, {
        ...
        }, [slots.thumbnail == null ? void 0 : slots.thumbnail(), props.avatar && (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("img", {
        ...
        }, [slots.default == null ? void 0 : slots.default()])]), slots.actions && (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
...
;// CONCATENATED MODULE: ./src/util/useDirective.ts
/**
...
/* harmony default export */ var VBtn = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    return () => (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(props.tag, {
      ...
      }, null), typeof props.icon === 'boolean' ? slots.default == null ? void 0 : slots.default() : (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(VIcon, {
        "icon": props.icon,
        "size": props.size
      }, null, 8, ["icon", "size"])],
      _: 1
    }, 8, ["class", "style", "disabled"]), [useDirective(Ripple, {
...
/* harmony default export */ var VResponsive = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    }, null, 4), slots.additional == null ? void 0 : slots.additional(), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
...
// Types
function intersect_mounted(el, binding) {
  ...
  const observer = new IntersectionObserver((entries = [], observer) => {
    ...
    if (el._observe.init && modifiers.once) intersect_unmounted(el); // Otherwise, mark the observer as initted
...
function intersect_unmounted(el) {
  /* istanbul ignore if */
...
const Intersect = {
  mounted: intersect_mounted,
  unmounted: intersect_unmounted
};
  ...
  setup(props, {
    ...
    const __image = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
      ...
      return maybeTransition(props, {
        appear: true
      }, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.withDirectives)(sources ? (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("picture", {
        "class": "v-img__picture"
      }, [sources, img]) : img, [[external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.vShow, state.value === 'loaded']]));
    });

    const __preloadImage = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
      return maybeTransition(props, {}, normalisedSrc.value.lazySrc && state.value !== 'loaded' ? (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("img", {
    ...
    const __placeholder = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
      ...
      const placeholder = state.value === 'loading' || state.value === 'error' && !slots.error ? (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
    ...
    const __error = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
      ...
      const error = state.value === 'error' ? (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
        "class": "v-img__error"
...
/* harmony default export */ var VLayout = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    useRender(() => (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
...
/* harmony default export */ var VLayoutItem = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    const styles = useLayoutItem(props.name, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.toRef)(props, 'priority'), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
      var _props$position;

      return (_props$position = props.position) != null ? _props$position : 'left';
    }), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.toRef)(props, 'size'));
    return () => (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
      "style": styles.value
    }, [], 4);
  }
...
/* harmony default export */ var VLocaleProvider = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, ctx) {
    ...
    }, [ctx.slots.default == null ? void 0 : ctx.slots.default()], 2);
  }
...
function useProxiedModel(props, prop, defaultValue, transformIn = v => v, transformOut = v => v) {
  ...
  const propIsDefined = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
    ...
    return !!(typeof props[prop] !== 'undefined' && ((vm == null ? void 0 : (_vm$vnode$props = vm.vnode.props) == null ? void 0 : _vm$vnode$props.hasOwnProperty(prop)) || (vm == null ? void 0 : (_vm$vnode$props2 = vm.vnode.props) == null ? void 0 : _vm$vnode$props2.hasOwnProperty(toKebabCase(prop)))));
  });
...
/* harmony default export */ var VNavigationDrawer = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    const {
      positionClasses,
      positionStyles
    } = usePosition(props, 'v-navigation-drawer');
    const {
      roundedClasses
    ...
    const size = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => Number(props.rail ? props.railWidth : props.width));
    ...
    const layoutStyles = useLayoutItem(props.name, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.toRef)(props, 'priority'), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => props.right ? 'right' : 'left'), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => !isTemporary.value && isActive.value ? size.value : 0));
    ...
    return () => {
      ...
      const translate = (!props.permanent && !isActive.value ? 105 : 0) * (!props.right && !props.bottom ? -1 : 1);
      return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(props.tag, {
        ...
        "style": [layoutStyles.value, positionStyles.value, {
          transform: "translate".concat(props.bottom ? 'Y' : 'X', "(").concat(convertToUnit(translate, '%'), ")"),
          width: convertToUnit(width.value)
        }]
      }, {
        default: () => [hasImg && (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
        ...
        }, [slots.prepend == null ? void 0 : slots.prepend()]), (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
          "class": "v-navigation-drawer__content"
        }, [slots.default == null ? void 0 : slots.default()]), slots.append && (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
...
/* harmony default export */ var VThemeProvider = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, context) {
    const {
      themeClasses
    } = provideTheme(props, context);
    return () => {
      return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", {
        "class": ['v-theme-provider', themeClasses.value]
      }, [(0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)("div", null, [context.slots.default == null ? void 0 : context.slots.default()])], 2);
    };
  }
...
/* harmony default export */ function expand_transition(expandedParentClass = '', x = false) {
  ...
  const offsetProperty = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.camelize)("offset-".concat(sizeProperty));
  return {
    onBeforeEnter(el) {
...
const VDialogTransition = createCssTransition('dialog-transition');
