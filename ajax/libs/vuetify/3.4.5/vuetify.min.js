...
return t.createVNode("div",{class:`${e.name}__loader`},[l.default?.({color:e.color,isActive:e.active})||t.createVNode(Zl,{absolute:e.absolute,active:e.active,color:e.color,height:"2",indeterminate:!0},null)])}const to=["static","relative","fixed","absolute","sticky"],ao=a({position:{type:String,validator:e=>to.includes(e)}},"position")
...
function r(e){n.value?.(e)}return o&&jt((()=>!(!a.isActive.value||!e.locationStrategy)),(o=>{t.watch((()=>e.locationStrategy),o),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0})),window.addEventListener("resize",r,{passive:!0}),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(a,e,l)?.updateLocation:n.value=er[e.locationStrategy](a,e,l)?.updateLocation})),{contentStyles:l,updateLocation:n}}(e,{isRtl:v,contentEl:R,target:w,isActive:s})
...
return t.createVNode(t.Fragment,{key:m.props.key},[o.item?o.item(m):t.createVNode(Qu,m.props,o),s(a)&&o["expanded-row"]?.(f)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),ac=a({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...l(),...vl(),...da(),...aa()},"VTable"),lc=gt()({name:"VTable",props:ac(),setup(e,a){let{slots:l,emit:o}=a
...
v.value=n.isBefore(a,l)})),At((()=>{const a=ed.filterProps(e),l=Hc.filterProps(e),n=Uc.filterProps(e),u=Gc.filterProps(e),v=C(Kc.filterProps(e),["modelValue"]),x=C(Zc.filterProps(e),["modelValue"]),N={header:p.value,transition:m.value}
return t.createVNode(ed,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(Fa,{defaults:{VDatePickerHeader:{...N}}},{default:()=>[o.header?.(N)]}):t.createVNode(Uc,t.mergeProps({key:"header"},n,N,{onClick:"month"!==s.value?S:void 0}),o),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Hc,t.mergeProps(l,{disabled:y.value,text:f.value,"onClick:next":b,"onClick:prev":V,"onClick:month":w,"onClick:year":k}),null),t.createVNode(Na,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Kc,t.mergeProps({key:"date-picker-months"},v,{modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,min:g.value,max:h.value}),null):"year"===s.value?t.createVNode(Zc,t.mergeProps({key:"date-picker-years"},x,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,min:g.value,max:h.value}),null):t.createVNode(Gc,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:c.value,"onUpdate:month":e=>c.value=e,year:d.value,"onUpdate:year":e=>d.value=e,min:g.value,max:h.value}),null)]})]),actions:o.actions})})),{}}}),ld=Symbol.for("vuetify:v-expansion-panel"),od=["default","accordion","inset","popout"],nd=a({color:String,static:Boolean,variant:{type:String,default:"default",validator:e=>od.includes(e)},readonly:Boolean,...l(),...Vl(),...da(),...aa()},"VExpansionPanels"),rd=gt()({name:"VExpansionPanels",props:nd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
kl(e,ld)
const{themeClasses:o}=na(e),n=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return vt({VExpansionPanel:{color:t.toRef(e,"color"),readonly:t.toRef(e,"readonly"),static:t.toRef(e,"static")}}),At((()=>t.createVNode(e.tag,{class:["v-expansion-panels",o.value,n.value,e.class],style:e.style},l))),{}}}),id=a({...l(),..._r()},"VExpansionPanelText"),sd=gt()({name:"VExpansionPanelText",props:id(),setup(e,a){let{slots:l}=a
const o=t.inject(ld)
...
return t.provide(ld,o),vt({VExpansionPanelText:{eager:t.toRef(e,"eager")},VExpansionPanelTitle:{readonly:t.toRef(e,"readonly")}}),At((()=>{const a=!(!l.text&&!e.text),c=!(!l.title&&!e.title)
...
if(a&&e in a)return a[e]}dp.version="3.4.5"
const pp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return dp({components:lp,directives:cp,...e})},fp="3.4.5"
