      ...
      return createVNode(VDataTableColumn, {
        ...
        default: () => {
          ...
          if (column.key === 'data-table-select') {
            ...
            return ((_slots$columnDataTa = slots['column.data-table-select']) == null ? void 0 : _slots$columnDataTa.call(slots, slotProps)) ?? createVNode(VCheckboxBtn, {
    ...
    useRender(() => createVNode("tr", {
      ...
      default: () => {
        ...
        if (column.key === 'data-table-select') {
          ...
          return ((_slots$itemDataTabl = slots['item.data-table-select']) == null ? void 0 : _slots$itemDataTabl.call(slots, slotProps)) ?? createVNode(VCheckboxBtn, {
        ...
        if (column.key === 'data-table-expand') {
          ...
          return ((_slots$itemDataTabl2 = slots['item.data-table-expand']) == null ? void 0 : _slots$itemDataTabl2.call(slots, slotProps)) ?? createVNode(VBtn, {
...
const VDataTableRows = defineComponent({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(Fragment, null, [props.loading ? ((_slots$loading = slots.loading) == null ? void 0 : _slots$loading.call(slots)) ?? createVNode(VDataTableRow, {
        "class": "v-data-table-rows-no-data",
        "key": "loading"
      }, {
        default: () => [t(props.loadingText)]
      }) : undefined, !props.loading && !props.items.length && !props.hideNoData && (((_slots$noData = slots['no-data']) == null ? void 0 : _slots$noData.call(slots)) ?? createVNode(VDataTableRow, {
        "class": "v-data-table-rows-no-data",
        "key": "no-data"
      }, {
