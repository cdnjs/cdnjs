...
if(a&&e in a)return a[e]}nd.version="3.3.8"
const id=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return nd({components:jc,directives:qc,...e})},sd="3.3.8"
...
return l(),a},e.useDisplay=cr,e.useLayout=ht,e.useLocale=At,e.useRtl=Pt,e.useTheme=Gt,e.version=sd}))
