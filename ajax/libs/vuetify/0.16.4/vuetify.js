    ...
    genMenu: function genMenu() {
      ...
      var data = {
        ...
        props: {
          ...
          openOnClick: false,
          value: this.menuIsActive && (!this.tags || this.tags && this.filteredItems.length > 0),
