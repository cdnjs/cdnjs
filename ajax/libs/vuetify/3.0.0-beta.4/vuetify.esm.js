...
import { Fragment, ref, computed, unref, provide, inject, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, shallowRef, shallowReactive, toRaw, watchEffect, watch, effectScope, capitalize, camelize, h, reactive, readonly, onBeforeUnmount, onDeactivated, onActivated, onMounted, createVNode, toRefs, TransitionGroup, Transition, mergeProps, onBeforeMount, nextTick, withDirectives, vShow, resolveDirective, isRef, toRef, resolveDynamicComponent, onScopeDispose, vModelDynamic, warn, toHandlers, Teleport, createTextVNode, onBeforeUpdate, vModelText } from 'vue';
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return withDirectives(createVNode(Tag, {
        ...
        default: () => [genOverlays(true, 'v-btn'), createVNode("span", {
          "class": "v-btn__content",
          "data-no-activator": ""
        }, [!props.icon && props.prependIcon && createVNode(VIcon, {
          "class": "v-btn__icon",
          ...
          "end": true
        }, null)]), props.loading && createVNode("span", {
          "class": "v-btn__loader"
        }, [slots.loader ? slots.loader() : createVNode(VProgressCircular, {
          "indeterminate": true,
          "size": "23",
          "width": "2"
        }, null)])]
          ...
          return createVNode(Fragment, null, [createVNode(VMenu, mergeProps({
            ...
            default: () => [createVNode(VList, {
              ...
              default: () => [!items.value.length && !props.hideNoData && ((_slots$noData = (_slots$noData2 = slots['no-data']) == null ? void 0 : _slots$noData2.call(slots)) != null ? _slots$noData : createVNode(VListItem, {
                ...
                })) != null ? _slots$item : createVNode(VListItem, mergeProps(item.props, {
                  "onClick": () => select(item)
                }), {
                  prepend: _ref2 => {
                    let {
                    ...
                    return props.multiple ? createVNode(VCheckboxBtn, {
