    ...
    setup(props, _ref) {
      ...
      return () => {
        ...
        return vue.withDirectives(vue.createVNode(Tag, {
          ...
          default: () => [genOverlays(true, 'v-btn'), vue.createVNode("span", {
            "class": "v-btn__content",
            "data-no-activator": ""
          }, [!props.icon && props.prependIcon && vue.createVNode(VIcon, {
            "class": "v-btn__icon",
            ...
            "end": true
          }, null)]), props.loading && vue.createVNode("span", {
            "class": "v-btn__loader"
          }, [slots.loader ? slots.loader() : vue.createVNode(VProgressCircular, {
            "indeterminate": true,
            "size": "23",
            "width": "2"
          }, null)])]
            ...
            return vue.createVNode(vue.Fragment, null, [vue.createVNode(VMenu, vue.mergeProps({
              ...
              default: () => [vue.createVNode(VList, {
                ...
                default: () => [!items.value.length && !props.hideNoData && ((_slots$noData = (_slots$noData2 = slots['no-data']) == null ? void 0 : _slots$noData2.call(slots)) != null ? _slots$noData : vue.createVNode(VListItem, {
                  ...
                  })) != null ? _slots$item : vue.createVNode(VListItem, vue.mergeProps(item.props, {
                    "onClick": () => select(item)
                  }), {
                    prepend: _ref2 => {
                      let {
