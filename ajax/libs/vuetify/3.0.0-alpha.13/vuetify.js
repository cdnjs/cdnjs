...
(function (global, factory) {
  ...
  function useOverlay(isActive) {
    ...
    const overlayZIndex = vue.computed(() => ROOT_ZINDEX + layout.overlays.value.indexOf(id) + 1);
    return {
      overlayZIndex,
    ...
    setup(props, _ref) {
      ...
      return () => {
        ...
        return vue.createVNode(props.tag, {
          ...
          }, [slots.append()])]), isExtended && vue.createVNode("div", {
      ...
      return () => {
        ...
        return vue.createVNode(props.tag, {
          ...
          default: () => [props.image && vue.createVNode(VImg, {
            "src": props.image,
            "alt": ""
          }, null), props.icon && !props.image && vue.createVNode(VIcon, {
            "icon": props.icon
  ...
  const VField = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const isDirty = vue.computed(() => wrapInArray(model.value || []).length > 0);
      const isActive = vue.computed(() => isDirty.value || isFocused.value);
      ...
      useRender(() => {
        ...
        return vue.createVNode("div", vue.mergeProps({
          ...
          }, themeClasses.value, backgroundColorClasses.value, focusClasses.value, loaderClasses.value, textColorClasses.value],
      ...
      return () => {
        ...
        return vue.createVNode(props.tag, {
          ...
          default: () => [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
            ...
            }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)]), [[vue.vShow, isOpen.value]])]
          })]
        });
      };
    }
  ...
  const VNavigationDrawer = defineComponent({
    ...
    setup(props, _ref) {
      ...
      if (!props.disableRouteWatcher && router) {
        vue.watch(() => router.currentRoute.value, () => isTemporary.value && (isActive.value = false));
      }
  ...
  const useSlider = _ref => {
    ...
    const thumbColor = vue.computed(() => {
      ...
      return props.disabled ? undefined : (_props$thumbColor = props.thumbColor) != null ? _props$thumbColor : props.color;
    });
    const trackColor = vue.computed(() => {
      var _props$trackColor;

      return props.disabled ? undefined : (_props$trackColor = props.trackColor) != null ? _props$trackColor : props.color;
    });
    const trackFillColor = vue.computed(() => {
      var _props$trackFillColor;

      return props.disabled ? undefined : (_props$trackFillColor = props.trackFillColor) != null ? _props$trackFillColor : props.color;
    });
    ...
    const data = {
      ...
      roundValue,
      showTickLabels: vue.toRef(props, 'showTickLabels'),
  ...
  const VTextField = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const isFocused = vue.ref(false);
      const inputRef = vue.ref();
      const isActive = vue.computed(() => isFocused.value || activeTypes.includes(props.type) || props.persistentPlaceholder);
      const messages = vue.computed(() => {
        return props.messages.length ? props.messages : isActive.value || props.persistentHint ? props.hint : '';
      });
          ...
          default: _ref2 => {
            ...
            return vue.createVNode(VField, vue.mergeProps({
              ...
              default: _ref3 => {
                ...
                }, [props.prefix]), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), vue.withDirectives(vue.createVNode("input", vue.mergeProps({
                  "ref": inputRef,
                  "class": fieldClass,
                  "onUpdate:modelValue": $event => model.value = $event,
    ...
    setup(props, _ref) {
      ...
      useRender(() => {
        return vue.createVNode(VTextField, vue.mergeProps({
          ...
          appendInner: () => vue.createVNode(VIcon, {
          ...
          }), selections.value.length > 0 && vue.createVNode("div", {
            "class": "v-select__selections v-field__input"
          }, [selections.value.map((selection, index) => vue.createVNode("div", {
            "class": "v-select__selection"
          }, [props.chips ? vue.createVNode(VChip, {
            "text": selection.title,
            "size": "small"
          }, null) : vue.createVNode("span", {
            "class": "v-select__selection-text"
          }, [selection.title, index < model.value.length - 1 && vue.createVNode("span", {
  ...
  const VWindow = vue.defineComponent({
    name: 'VWindow',
    directives: {
      Touch
    },
    ...
    setup(props, _ref) {
      ...
      return () => {
        ...
        return vue.withDirectives(vue.createVNode(props.tag, {
          ...
          }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), props.showArrows !== false && vue.createVNode("div", {
