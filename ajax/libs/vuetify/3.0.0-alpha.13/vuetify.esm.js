...
import { Fragment, isRef, ref, computed, unref, provide, inject, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, shallowReactive, toRaw, watchEffect, capitalize, camelize, h, watch, readonly, onBeforeUnmount, onDeactivated, onActivated, reactive, onMounted, createVNode, mergeProps, Transition, onBeforeMount, nextTick, withDirectives, vShow, resolveDirective, toRef, resolveDynamicComponent, toRefs, TransitionGroup, vModelDynamic, effectScope, onScopeDispose, warn, toHandlers, Teleport, onBeforeUpdate, createTextVNode, vModelText } from 'vue';
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        }, [slots.append()])]), isExtended && createVNode("div", {
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [props.image && createVNode(VImg, {
          "src": props.image,
          "alt": ""
        }, null), props.icon && !props.image && createVNode(VIcon, {
          "icon": props.icon
    ...
    return () => {
      ...
      return createVNode(props.tag, {
        ...
        default: () => [(_slots$activator = slots.activator) == null ? void 0 : _slots$activator.call(slots, {
          ...
          }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots)]), [[vShow, isOpen.value]])]
        })]
      });
    };
  }
...
const VTextField = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isFocused = ref(false);
    const inputRef = ref();
    const isActive = computed(() => isFocused.value || activeTypes.includes(props.type) || props.persistentPlaceholder);
    const messages = computed(() => {
      return props.messages.length ? props.messages : isActive.value || props.persistentHint ? props.hint : '';
    });
        ...
        default: _ref2 => {
          ...
          return createVNode(VField, mergeProps({
            ...
            default: _ref3 => {
              ...
              }, [props.prefix]), (_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), withDirectives(createVNode("input", mergeProps({
                "ref": inputRef,
                "class": fieldClass,
                "onUpdate:modelValue": $event => model.value = $event,
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      return createVNode(VTextField, mergeProps({
        ...
        }), selections.value.length > 0 && createVNode("div", {
          "class": "v-select__selections v-field__input"
        }, [selections.value.map((selection, index) => createVNode("div", {
          "class": "v-select__selection"
        }, [props.chips ? createVNode(VChip, {
          "text": selection.title,
          "size": "small"
        }, null) : createVNode("span", {
          "class": "v-select__selection-text"
        }, [selection.title, index < model.value.length - 1 && createVNode("span", {
...
const VWindow = defineComponent$1({
  name: 'VWindow',
  directives: {
    Touch
  },
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return withDirectives(createVNode(props.tag, {
        ...
        }, [(_slots$default = slots.default) == null ? void 0 : _slots$default.call(slots), props.showArrows !== false && createVNode("div", {
