...
let Oa=!1
const Fa=He({name:"VBtn",directives:{Ripple:ka},props:{active:{type:Boolean,default:void 0},symbol:{type:null,default:zl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Wl,appendIcon:Wl,block:Boolean,stacked:Boolean,ripple:{type:Boolean,default:!0},...fl(),...yl(),...Il(),...ol(),...gl(),...Ll(),...Ca(),...Ba(),...Ea(),...La(),...ea(),...vl({tag:"button"}),...ft(),...El({variant:"elevated"})},emits:{"group:selected":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
...
w.value||(null==(t=V.navigate)||t.call(V,e),null==b||b.toggle())}},{default:()=>[Al(!0,"v-btn"),!e.icon&&I&&t.createVNode(Lt,{key:"prepend",defaults:{VIcon:{icon:e.prependIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__prepend"},[(null==(l=o.prepend)?void 0:l.call(o))??t.createVNode(aa,null,null)])]}),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[t.createVNode(Lt,{key:"content",defaults:{VIcon:{icon:$?e.icon:void 0}}},{default:()=>[(null==(a=o.default)?void 0:a.call(o))??($&&t.createVNode(aa,{key:"icon"},null))]})]),!e.icon&&B&&t.createVNode(Lt,{key:"append",defaults:{VIcon:{icon:e.appendIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__append"},[(null==(x=o.append)?void 0:x.call(o))??t.createVNode(aa,null,null)])]}),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[(null==(C=o.loader)?void 0:C.call(o))??t.createVNode(na,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"23",width:"2"},null)])]}),[[t.resolveDirective("ripple"),!w.value&&e.ripple,null]])})),{}}}),Ma=He({name:"VAppBarNavIcon",props:{icon:{type:Wl,default:"$menu"}},setup(e,l){let{slots:a}=l
...
const{themeClasses:r}=ht(e),{loaderClasses:i}=Na(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=qa(e),{InputIcon:v}=Ua(e),p=t.computed((()=>e.dirty||e.active)),f=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),m=Pe(),h=t.computed((()=>e.id||`input-${m}`)),y=t.computed((()=>`${h.value}-messages`)),b=t.ref(),V=t.ref(),S=t.ref(),{backgroundColorClasses:w,backgroundColorStyles:k}=wl(t.toRef(e,"bgColor")),{textColorClasses:x,textColorStyles:C}=Sl(t.computed((()=>p.value&&u.value&&!e.error&&!e.disabled?e.color:void 0)))
...
const Go=Ue("v-list-item-subtitle"),qo=Ue("v-list-item-title"),Ko=We()({name:"VListItem",directives:{Ripple:ka},props:{active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Wl,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Wl,subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,onClick:F,onClickOnce:F,...fl(),...Il(),...ol(),...gl(),...yl(),...La(),...vl(),...ft(),...El({variant:"text"})},emits:{click:e=>!0},setup(e,l){let{attrs:a,slots:o,emit:n}=l
...
const I=t.ref(),B=t.ref(),{contentStyles:$,updateLocation:A}=function(e,a){const o=t.ref({}),n=t.ref()
let r
function i(e){var t
...
null==(e=o)||e.stop()}))}(e,{root:I,contentEl:B,activatorEl:V,isActive:s,updateLocation:A}),l&&t.watch(s,(e=>{e?window.addEventListener("keydown",T):window.removeEventListener("keydown",T)}),{immediate:!0})
const P=Ta()
...
const L=t.ref()
function O(){e.noClickAnimation||B.value&&J(B.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:Xe})}return t.watch((()=>s.value&&(e.absolute||e.contained)&&null==u.value),(e=>{if(e){const e=Ge(I.value)
e&&e!==document.scrollingElement&&(L.value=e.scrollTop)}})),Ze((()=>{var l,a
return t.createVNode(t.Fragment,null,[null==(l=o.activator)?void 0:l.call(o,{isActive:s.value,props:t.mergeProps({ref:S},t.toHandlers(w.value),e.activatorProps)}),N.value&&t.createVNode(t.Teleport,{disabled:!u.value,to:u.value},{default:()=>[p.value&&t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},c.value,d.value],style:[b.value,{top:g(L.value)}],ref:I},_,n),[t.createVNode(Yn,t.mergeProps({color:m,modelValue:s.value&&!!e.scrim},t.toHandlers(x.value)),null),t.createVNode(cl,{appear:!0,persisted:!0,transition:e.transition,target:V.value,onAfterLeave:()=>{f(),r("afterLeave")}},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:B,class:["v-overlay__content",e.contentClass],style:[C.value,$.value]},t.toHandlers(k.value),e.contentProps),[null==(a=o.default)?void 0:a.call(o,{isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:E,closeConditional:R,include:()=>[V.value]}]])]})])]})])})),{activatorEl:V,animateClick:O,contentEl:B,globalTop:h,localTop:y,updateLocation:A}}})
...
return t.createVNode(t.Fragment,null,[t.createVNode(Kn,t.mergeProps({modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,activator:"parent",contentClass:"v-select__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition},e.menuProps),{default:()=>[i&&t.createVNode(nn,{ref:m,selected:p.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusout:S},{default:()=>[!f.value.length&&!e.hideNoData&&((null==(n=a["no-data"])?void 0:n.call(a))??t.createVNode(Ko,{title:o(e.noDataText)},null)),null==(s=a["prepend-item"])?void 0:s.call(a),f.value.map(((l,o)=>{var n
...
return t.createVNode("div",{class:"v-card-actions"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),vr=Ue("v-card-subtitle"),pr=Ue("v-card-title"),fr=He({name:"VCardItem",props:{appendAvatar:String,appendIcon:Wl,prependAvatar:String,prependIcon:Wl,subtitle:String,title:String,...Il()},setup(e,l){let{slots:a}=l
...
return t.withDirectives(t.createVNode(S,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value],style:[s.value,d.value,f.value],href:h.href.value,onClick:b.value&&h.navigate,tabindex:e.disabled?-1:void 0},{default:()=>[_&&t.createVNode(Lt,{key:"image",defaults:{VImg:{cover:!0,src:e.image}}},{default:()=>[t.createVNode("div",{class:"v-card__image"},[(null==(l=o.image)?void 0:l.call(o))??t.createVNode(dl,null,null)])]}),t.createVNode(_a,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),I&&t.createVNode(fr,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),B&&t.createVNode(mr,{key:"text"},{default:()=>[(null==(a=o.text)?void 0:a.call(o))??e.text]}),null==(V=o.default)?void 0:V.call(o),o.actions&&t.createVNode(dr,null,{default:o.actions}),Al(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value]])})),{}}})
...
Ze((()=>t.createVNode(Cr,{class:"v-carousel-item",value:e.value},{default:()=>[t.createVNode(dl,o,a)]})))}}),Ir=Ue("v-code"),Br=He({name:"VColorPickerCanvas",props:{color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300}},emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,l){let{emit:a}=l
...
const A=e=>{$||(x.value=0,a(B(e))),k.value=!1,$=!1,x.value=0},E=e=>{_.value=n(e),_.value&&(_.value.focus(),k.value=!0,_.value.contains(e.target)?($=!0,x.value=Dr(e,_.value,l.direction)):(x.value=0,o(B(e))))},R={passive:!0,capture:!0}
function T(e){$=!0,o(B(e))}function P(e){e.stopPropagation(),e.preventDefault(),A(e),window.removeEventListener("mousemove",T,R),window.removeEventListener("mouseup",P)}function L(e){var t
...
e.splice(t,1),y.value=e}S.value=""}else y.value=[l],V.value=l.title,t.nextTick((()=>{c.value=!1,u.value=!0}))}function P(e){s.value=!0}function L(e){var t
...
return t.createVNode(t.Fragment,null,[t.createVNode(Kn,t.mergeProps({modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-combobox__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:R},e.menuProps),{default:()=>[a&&t.createVNode(nn,{ref:B,selected:_.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusin:P,onFocusout:L},{default:()=>[!N.value.length&&!e.hideNoData&&((null==(o=n["no-data"])?void 0:o.call(n))??t.createVNode(Ko,{title:r(e.noDataText)},null)),null==(i=n["prepend-item"])?void 0:i.call(n),N.value.map(((l,a)=>{var o
...
return t.createVNode("div",{key:a.value,class:["v-combobox__selection",o===d.value&&["v-combobox__selection--selected",g.value]],style:o===d.value?h.value:{}},[l?t.createVNode(Lt,{defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[n.chip?n.chip({item:a,index:o,props:r}):t.createVNode($o,r,null)]}):n.selection?n.selection({item:a,index:o}):t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&o<C.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),vo({isFocused:s,isPristine:u,menu:c,search:S,selectionIndex:d,filteredItems:w,select:T},i)}}),bi=We()({name:"VDialog",props:{fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...Xn({origin:"center center",scrollStrategy:"block",transition:{component:zt},zIndex:2400})},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:o}=a
...
return Ze((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",o.value,n.value,s.value,u.value,c.value],style:[i.value,e.app?f.value:void 0]},a))),{}}}),Bi=He({name:"VForm",props:{...lo()},emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,l){let{slots:a,emit:o}=l
...
return t.createVNode(t.Fragment,null,[v&&t.createVNode(Ya,{id:a.value},{default:()=>[v]}),t.createVNode(bo,t.mergeProps(c,{id:a.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:u.value,"aria-labelledby":v?a.value:void 0},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),xs=He({name:"VRangeSlider",props:{...Ga(),...ro(),...jr(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return t.createVNode("div",{class:"v-slider__container",onMousedown:v,onTouchstartPassive:p},[t.createVNode("input",{id:`${d.value}_start`,name:e.name||d.value,disabled:e.disabled,readonly:e.readonly,tabindex:"-1",value:h.value[0]},null),t.createVNode("input",{id:`${d.value}_stop`,name:e.name||d.value,disabled:e.disabled,readonly:e.readonly,tabindex:"-1",value:h.value[1]},null),t.createVNode(Ur,{ref:g,start:S.value,stop:w.value},{"tick-label":a["tick-label"]}),t.createVNode(Wr,{ref:o,"aria-describedby":f.value,focused:y&&i.value===(null==(r=o.value)?void 0:r.$el),modelValue:h.value[0],"onUpdate:modelValue":e=>h.value=[e,h.value[1]],onFocus:e=>{var t,l,a,r;(b(),i.value=null==(t=o.value)?void 0:t.$el,h.value[0]===h.value[1]&&h.value[1]===c.value&&e.relatedTarget!==(null==(l=n.value)?void 0:l.$el))&&(null==(a=o.value)||a.$el.blur(),null==(r=n.value)||r.$el.focus())},onBlur:()=>{V(),i.value=void 0},min:c.value,max:h.value[1],position:S.value},{"thumb-label":a["thumb-label"]}),t.createVNode(Wr,{ref:n,"aria-describedby":f.value,focused:y&&i.value===(null==(s=n.value)?void 0:s.$el),modelValue:h.value[1],"onUpdate:modelValue":e=>h.value=[h.value[0],e],onFocus:e=>{var t,l,a,r;(b(),i.value=null==(t=n.value)?void 0:t.$el,h.value[0]===h.value[1]&&h.value[0]===u.value&&e.relatedTarget!==(null==(l=o.value)?void 0:l.$el))&&(null==(a=n.value)||a.$el.blur(),null==(r=o.value)||r.$el.focus())},onBlur:()=>{V(),i.value=void 0},min:h.value[0],max:u.value,position:w.value},{"thumb-label":a["thumb-label"]})])}})})),{}}}),Cs=We()({name:"VRating",props:{name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Wl,default:"$ratingEmpty"},fullIcon:{type:Wl,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...Il(),...ea(),...vl(),...ft()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
function B(e){if(I.value=!0,u.value&&g.value)for(const t of e.composedPath())for(const e of g.value.children)if(e===t)return void(c.value=_s({selectedElement:e,containerSize:d.value,contentSize:v.value,isRtl:n.value,currentScrollOffset:c.value,isHorizontal:p.value}))}function $(e){I.value=!1}function A(e){var t
...
return t.createVNode("div",{class:["v-switch__thumb",a.value],style:n.value},[e.loading&&t.createVNode(_a,{name:"v-switch",active:!0,color:!1===m.value?void 0:d.value},{default:e=>o.loader?o.loader(e):t.createVNode(na,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)})])}})}})})),{}}}),Rs=He({name:"VSystemBar",props:{color:String,height:[Number,String],window:Boolean,...gl(),...tt(),...yl(),...vl(),...ft()},setup(e,l){let{slots:a}=l
...
if(o&&e in o)return o[e]}Qs.version="3.1.1"
const tu=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Qs({components:Us,directives:Js,...e})},lu="3.1.1"
