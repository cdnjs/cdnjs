...
return Object.assign(o,t),Object.assign(n,l),[o,n]}function P(e){return null==e?[]:Array.isArray(e)?e:[e]}function R(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
...
return Object.defineProperty(a,"value",{enumerable:!0,get:()=>e.value,set:t=>e.value=t}),Object.defineProperty(a,"el",{enumerable:!0,get:()=>g(e.value)}),a}function oe(e){const t=1===e.key.length,a=!e.ctrlKey&&!e.metaKey&&!e.altKey
...
const be=2.4,Ve=.2126729,we=.7151522,Se=.072175,ke=.55,xe=.58,Ne=.57,Ce=.62,_e=.03,Ie=1.45,Be=5e-4,Pe=1.25,Re=1.25,Ae=.078,Te=12.82051282051282,De=.06,Ee=.001
...
s=e<Ee?0:e<Ae?e-e*Te*De:e-De}else{const e=(c**Ce-u**Ne)*Re
s=e>-Ee?0:e>-Ae?e-e*Te*De:e+De}return 100*s}function $e(e){t.warn(`Vuetify: ${e}`)}function Me(e){t.warn(`Vuetify error: ${e}`)}const Oe=.20689655172413793,Le=e=>e>Oe**3?Math.cbrt(e):e/(3*Oe**2)+4/29,ze=e=>e>Oe?e**3:3*Oe**2*(e-4/29)
...
return(isNaN(a)||a<0||a>4294967295)&&$e(`'${e}' is not a valid hex(a) color`),ut(t)}if("object"==typeof e){if(V(e,["r","g","b"]))return e
if(V(e,["h","s","l"]))return et(ot(e))
if(V(e,["h","s","v"]))return et(e)}throw new TypeError(`Invalid color: ${null==e?e:String(e)||e.constructor.name}\nExpected #hex, #hexa, rgb(), rgba(), hsl(), hsla(), object or number`)}function et(e){const{h:t,s:a,v:l,a:o}=e,n=e=>{const o=(e+t/60)%6
...
return M(e?.aliasName||e?.name)}let wt=0,St=new WeakMap
...
t.provide(xt,t.computed((()=>i.value?F(e?.value??{},i.value):e?.value)))}}}function It(e){if(e._setup=e._setup??e.setup,!e.name)return $e("The component is missing an explicit name, unable to generate default prop value"),e
if(e._setup){e.props=ht(e.props??{},e.name)()
const t=Object.keys(e.props).filter((e=>"class"!==e&&"style"!==e))
e.filterProps=function(e){return w(e,t)},e.props._as=String,e.setup=function(t,a){const l=Nt()
...
function Tt(e,t,a){return Object.keys(e).filter((e=>C(e)&&e.endsWith(t))).reduce(((l,o)=>(l[o.slice(0,-t.length)]=t=>e[o](t,a(t)),l)),{})}function Dt(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
...
return{layoutIsReady:t.nextTick(),getLayoutItem:e.getLayoutItem,mainRect:e.mainRect,mainStyles:e.mainStyles}}function na(e){const a=t.inject(ea)
...
return t.onBeforeUnmount((()=>a.unregister(l))),{layoutItemStyles:i,layoutRect:a.layoutRect,layoutItemScrimStyles:s,layoutIsReady:r}}function ra(e){const a=t.inject(ea,null),l=t.computed((()=>a?a.rootZIndex.value-100:1e3)),o=t.ref([]),n=t.reactive(new Map),r=t.reactive(new Map),i=t.reactive(new Map),s=t.reactive(new Map),u=t.reactive(new Map),{resizeRef:c,contentRect:d}=Jt(),v=ae((()=>{const e=[...new Set([...i.values()].map((e=>e.value)))].sort(((e,t)=>e-t)),t=[]
...
return{id:a,...l,size:Number(o.value),position:i.value}})))),y=e=>h.value.find((t=>t.id===e)),b=bt("createLayout"),V=t.nextTick()
t.provide(ea,{register:(e,a)=>{let{id:c,order:d,position:f,layoutSize:m,elementSize:g,active:y,disableTransitions:V,absolute:w}=a
i.set(c,d),n.set(c,f),r.set(c,m),s.set(c,y),V&&u.set(c,V)
const S=O(ta,b?.vnode).indexOf(e)
...
return{layoutClasses:t.computed((()=>["v-layout",{"v-layout--full-height":e.fullHeight}])),layoutStyles:t.computed((()=>({zIndex:a?l.value:void 0,position:a?"relative":void 0,overflow:a?"hidden":void 0}))),getLayoutItem:y,items:h,layoutRect:d,layoutIsReady:V,layoutRef:c}}function ia(e,a){let l
...
return Mt((()=>t.createVNode("div",{ref:s,class:["v-application",o.themeClasses.value,n.value,u.value,e.class],style:[e.style]},[t.createVNode("div",{class:"v-application__wrap"},[t.createVNode(t.Suspense,null,{default:()=>[t.createVNode(t.Fragment,null,[l.default?.()])]})])]))),{getLayoutItem:r,items:i,theme:o}}}),Pa=ht({tag:{type:String,default:"div"}},"tag"),Ra=ht({text:String,...yt(),...Pa()},"VToolbarTitle"),Aa=Bt()({name:"VToolbarTitle",props:Ra(),setup(e,a){let{slots:l}=a
...
Oa(t)?.forEach((e=>{he(e,[{opacity:0},{opacity:0,offset:.33},{}],{duration:450*i,easing:At})})),s.finished.then((()=>a()))},onAfterEnter(e){e.style.removeProperty("pointer-events")},onBeforeLeave(e){e.style.pointerEvents="none"},async onLeave(t,a){await new Promise((e=>requestAnimationFrame(e)))
const{x:l,y:o,sx:n,sy:r,speed:i}=La(e.target,t)
he(t,[{},{transform:`translate(${l}px, ${o}px) scale(${n}, ${r})`,opacity:0}],{duration:125*i,easing:"cubic-bezier(0.4, 0, 1, 1)"}).finished.then((()=>a())),Oa(t)?.forEach((e=>{he(e,[{},{opacity:0,offset:.2},{opacity:0}],{duration:250*i,easing:At})}))},onAfterLeave(e){e.style.removeProperty("pointer-events")}}
...
function sl(e){return H((()=>{const t=[],a={}
...
return d.value=!(!e.extended&&!g),t.createVNode(e.tag,{class:["v-toolbar",{"v-toolbar--absolute":e.absolute,"v-toolbar--collapse":e.collapse,"v-toolbar--flat":e.flat,"v-toolbar--floating":e.floating,[`v-toolbar--density-${e.density}`]:!0},o.value,r.value,i.value,s.value,u.value,c.value,e.class],style:[n.value,e.style]},{default:()=>[m&&t.createVNode("div",{key:"image",class:"v-toolbar__image"},[l.image?t.createVNode(ll,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},l.image):t.createVNode(yl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(ll,{defaults:{VTabs:{height:f(v.value)}}},{default:()=>[t.createVNode("div",{class:"v-toolbar__content",style:{height:f(v.value)}},[l.prepend&&t.createVNode("div",{class:"v-toolbar__prepend"},[l.prepend?.()]),a&&t.createVNode(Aa,{key:"title",text:e.title},{text:l.title}),l.default?.(),l.append&&t.createVNode("div",{class:"v-toolbar__append"},[l.append?.()])])]}),t.createVNode(ll,{defaults:{VTabs:{height:f(p.value)}}},{default:()=>[t.createVNode(el,null,{default:()=>[d.value&&t.createVNode("div",{class:"v-toolbar__extension",style:{height:f(p.value)}},[g])]})]})]})})),{contentHeight:v,extensionHeight:p}}}),Cl=ht({scrollTarget:{type:String},scrollThreshold:{type:[String,Number],default:300}},"scroll")
...
t?t!==r.value&&(r.value?.removeEventListener("scroll",f),r.value=t,r.value.addEventListener("scroll",f,{passive:!0})):$e(`Unable to locate element with identifier ${e}`)}),{immediate:!0})})),t.onBeforeUnmount((()=>{r.value?.removeEventListener("scroll",f)})),l&&t.watch(l,f,{immediate:!0}),{scrollThreshold:v,currentScroll:i,currentThreshold:u,isScrollActive:c,scrollRatio:p,isScrollingUp:d,savedScroll:s}}(e,{canScroll:i}),v=t.computed((()=>r.value.hide||r.value.fullyHide)),p=t.computed((()=>e.collapse||r.value.collapse&&(r.value.inverted?d.value>0:0===d.value))),f=t.computed((()=>e.flat||r.value.fullyHide&&!n.value||r.value.elevate&&(r.value.inverted?s.value>0:0===s.value))),m=t.computed((()=>r.value.fadeImage?r.value.inverted?1-d.value:d.value:void 0)),g=t.computed((()=>{const t=Number(o.value?.contentHeight??e.height),a=Number(o.value?.extensionHeight??0)
...
const{ssrBootStyles:h}=_l(),{layoutItemStyles:y,layoutIsReady:b}=na({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.toRef(e,"location"),layoutSize:g,elementSize:t.shallowRef(void 0),active:n,absolute:t.toRef(e,"absolute")})
return Mt((()=>{const a=Nl.filterProps(e)
return t.createVNode(Nl,t.mergeProps({ref:o,class:["v-app-bar",{"v-app-bar--bottom":"bottom"===e.location},e.class],style:[{...y.value,"--v-toolbar-image-opacity":m.value,height:void 0,...h.value},e.style]},a,{collapse:p.value,flat:f.value}),l)})),b}}),Pl=[null,"default","comfortable","compact"],Rl=ht({density:{type:String,default:"default",validator:e=>Pl.includes(e)}},"density")
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const $l=ht({baseColor:String,divided:Boolean,...bl(),...yt(),...Rl(),...wl(),...dl(),...Pa(),...Sa(),...El()},"VBtnGroup"),Ml=Bt()({name:"VBtnGroup",props:$l(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=xa(e),{densityClasses:n}=Al(e),{borderClasses:r}=Vl(e),{elevationClasses:i}=Sl(e),{roundedClasses:s}=vl(e)
...
const o=t.reactive([]),n=sa(e,"modelValue",[],(e=>null==e?[]:Hl(o,P(e))),(t=>{const a=function(e,t){const a=[]
...
return H((()=>{let a,l
return W(Gl,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:f(e.size),height:f(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const Xl=ht({color:String,disabled:Boolean,start:Boolean,end:Boolean,icon:Ot,...yt(),...ql(),...Pa({tag:"i"}),...Sa()},"VIcon"),Zl=Bt()({name:"VIcon",props:Xl(),setup(e,a){let{attrs:l,slots:o}=a
...
return{positionClasses:t.computed((()=>e.position?`${a}--${e.position}`:void 0))}}function po(){return bt("useRouter")?.proxy?.$router}function fo(e,a){const l=t.resolveDynamicComponent("RouterLink"),o=t.computed((()=>!(!e.href&&!e.to))),n=t.computed((()=>o?.value||G(a,"click")||G(e,"click")))
...
function Bo(e){Io||e.keyCode!==h.enter&&e.keyCode!==h.space||(Io=!0,xo(e))}function Po(e){Io=!1,Co(e)}function Ro(e){Io&&(Io=!1,Co(e))}function Ao(e,t,a){const{value:l,modifiers:o}=t,n=ko(l)
...
e.addEventListener("touchstart",xo,{passive:!0}),e.addEventListener("touchend",Co,{passive:!0}),e.addEventListener("touchmove",_o,{passive:!0}),e.addEventListener("touchcancel",Co),e.addEventListener("mousedown",xo),e.addEventListener("mouseup",Co),e.addEventListener("mouseleave",Co),e.addEventListener("keydown",Bo),e.addEventListener("keyup",Po),e.addEventListener("blur",Ro),e.addEventListener("dragstart",Co,{passive:!0})}else!n&&a&&To(e)}function To(e){e.removeEventListener("mousedown",xo),e.removeEventListener("touchstart",xo),e.removeEventListener("touchend",Co),e.removeEventListener("touchmove",_o),e.removeEventListener("touchcancel",Co),e.removeEventListener("mouseup",Co),e.removeEventListener("mouseleave",Co),e.removeEventListener("keydown",Bo),e.removeEventListener("keyup",Po),e.removeEventListener("dragstart",Co),e.removeEventListener("blur",Ro)}const Do={mounted:function(e,t){Ao(e,t,!1)},unmounted:function(e){delete e._ripple,To(e)},updated:function(e,t){if(t.value===t.oldValue)return
Ao(e,t,ko(t.oldValue))}},Eo=ht({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Wl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ot,appendIcon:Ot,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:String,...bl(),...yt(),...Rl(),...ol(),...wl(),...Ll(),...ro(),...ao(),...co(),...dl(),...mo(),...ql(),...Pa({tag:"button"}),...Sa(),...El({variant:"elevated"})},"VBtn"),Fo=Bt()({name:"VBtn",props:Eo(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=xa(e),{borderClasses:r}=Vl(e),{densityClasses:i}=Al(e),{dimensionStyles:s}=nl(e),{elevationClasses:u}=Sl(e),{loaderClasses:c}=io(e),{locationStyles:d}=lo(e),{positionClasses:v}=vo(e),{roundedClasses:p}=vl(e),{sizeClasses:f,sizeStyles:m}=Kl(e),g=zl(e,e.symbol,!1),h=fo(e,l),y=t.computed((()=>void 0!==e.active?e.active:h.isLink.value?h.isActive?.value:g?.isSelected.value)),b=t.computed((()=>y.value?e.activeColor??e.color:e.color)),V=t.computed((()=>({color:g?.isSelected.value&&(!h.isLink.value||h.isActive?.value)||!g||h.isActive?.value?b.value??e.baseColor:e.baseColor,variant:e.variant}))),{colorClasses:w,colorStyles:S,variantClasses:k}=Fl(V),x=t.computed((()=>g?.disabled.value||e.disabled)),N=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border))),C=t.computed((()=>{if(void 0!==e.value&&"symbol"!=typeof e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value}))
...
return Mt((()=>{const a=k(Jo.filterProps(e),["modelValue"])
...
const o=sa(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=cn(),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!P(""===o.value?null:o.value).length&&!P(""===n.value?null:n.value).length))),c=t.computed((()=>!!(e.disabled??r?.isDisabled.value))),d=t.computed((()=>!!(e.readonly??r?.isReadonly.value))),v=t.computed((()=>e.errorMessages?.length?P(e.errorMessages).concat(i.value).slice(0,Math.max(0,+e.maxErrors)):i.value)),p=t.computed((()=>{let t=(e.validateOn??r?.validateOn.value)||"input"
...
async function n(t,a){return Bn(t,F(e,a),!1,o)}return n.horizontal=async(t,a)=>Bn(t,F(e,a),!0,o),n}function Rn(e,t){const a=e?"scrollWidth":"scrollHeight"
...
const n=Tn(o,a),r=An(o,l,a),i=Tn(o,t),s=Dn(o,t),u=.4*i
...
const t=Tn(p.value,f.el),l=An(p.value,n.value,f.el)
if(!(Rn(p.value,f.el)<=t||Math.abs(e-l)<16)){if(p.value&&n.value&&f.el){const{scrollWidth:t,offsetWidth:a}=f.el
...
function B(e){I||S.value||e.relatedTarget&&g.el?.contains(e.relatedTarget)||A(),I=!1}function P(){I=!0}function R(e){function t(t){e.preventDefault(),A(t)}g.el&&(p.value?"ArrowRight"===e.key?t(n.value?"prev":"next"):"ArrowLeft"===e.key&&t(n.value?"next":"prev"):"ArrowDown"===e.key?t("next"):"ArrowUp"===e.key&&t("prev"),"Home"===e.key?t("first"):"End"===e.key&&t("last"))}function A(e){if(!g.el)return
let t
if(e)if("next"===e){if(t=g.el.querySelector(":focus")?.nextElementSibling,!t)return A("first")}else if("prev"===e){if(t=g.el.querySelector(":focus")?.previousElementSibling,!t)return A("last")}else"first"===e?t=g.el.firstElementChild:"last"===e&&(t=g.el.lastElementChild)
...
return t.createVNode($n,t.mergeProps(a,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value,e.class],style:e.style}),{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),zn=ht({activeClass:String,appendAvatar:String,appendIcon:Ot,closable:Boolean,closeIcon:{type:Ot,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:String,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:Ot,ripple:{type:[Boolean,Object],default:!0},text:String,modelValue:{type:Boolean,default:!0},onClick:Y(),onClickOnce:Y(),...bl(),...yt(),...Rl(),...wl(),...Ll(),...dl(),...mo(),...ql(),...Pa({tag:"span"}),...Sa(),...El({variant:"tonal"})},"VChip"),jn=Bt()({name:"VChip",directives:{Ripple:Do},props:zn(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{t:r}=ya(),{borderClasses:i}=Vl(e),{colorClasses:s,colorStyles:u,variantClasses:c}=Fl(e),{densityClasses:d}=Al(e),{elevationClasses:v}=Sl(e),{roundedClasses:p}=vl(e),{sizeClasses:f}=Kl(e),{themeClasses:m}=xa(e),g=sa(e,"modelValue"),h=zl(e,Mn,!1),y=fo(e,l),b=t.computed((()=>!1!==e.link&&y.isLink.value)),V=t.computed((()=>!e.disabled&&!1!==e.link&&(!!h||e.link||y.isClickable.value))),w=t.computed((()=>({"aria-label":r(e.closeLabel),onClick(e){e.preventDefault(),e.stopPropagation(),g.value=!1,o("click:close",e)}})))
...
return Mt((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),ur=Pt("v-list-item-title"),cr=ht({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Ot,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Ot,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number],title:[String,Number],value:null,onClick:Y(),onClickOnce:Y(),...bl(),...yt(),...Rl(),...ol(),...wl(),...dl(),...mo(),...Pa(),...Sa(),...El({variant:"text"})},"VListItem"),dr=Bt()({name:"VListItem",directives:{Ripple:Do},props:cr(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
function br(e,t){const a=v(t,e.itemTitle,t),l=v(t,e.itemValue,a),o=v(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?k(t,["children"]):t:v(t,e.itemProps)}
...
return t}))}}}function Sr(e,t){const a=v(t,e.itemType,"item"),l=function(e){return"string"==typeof e||"number"==typeof e||"boolean"==typeof e}(t)?t:v(t,e.itemTitle),o=v(t,e.itemValue,void 0),n=v(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?k(t,["children"]):v(t,e.itemProps)}
...
function Rr(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Ar(e,t){if("top"===e.side||"bottom"===e.side){const{side:a,align:l}=e
return Rr({x:"left"===l?0:"center"===l?t.width/2:"right"===l?t.width:l,y:"top"===a?0:"bottom"===a?t.height:a},t)}if("left"===e.side||"right"===e.side){const{side:a,align:l}=e
return Rr({x:"left"===a?0:"right"===a?t.width:a,y:"top"===l?0:"center"===l?t.height/2:"bottom"===l?t.height:l},t)}return Rr({x:t.width/2,y:t.height/2},t)}const Tr={static:function(){},connected:function(e,a,l){(Array.isArray(e.target.value)||function(e){for(;e;){if("fixed"===window.getComputedStyle(e).position)return!0
...
function qr(e,l){let{isActive:o,isTop:n}=l
const r=bt("useActivator"),i=t.ref()
let s=!1,u=!1,c=!0
const d=t.computed((()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover)),v=t.computed((()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!d.value)),{runOpenDelay:p,runCloseDelay:f}=Yr(e,(t=>{t!==(e.openOnHover&&s||d.value&&u)||e.openOnHover&&o.value&&!n.value||(o.value!==t&&(c=!0),o.value=t)})),m=t.ref(),g=e=>{e.stopPropagation(),i.value=e.currentTarget||e.target,o.value||(m.value=[e.clientX,e.clientY]),o.value=!o.value},h=e=>{e.sourceCapabilities?.firesTouchEvents||(s=!0,i.value=e.currentTarget||e.target,p())},y=e=>{s=!1,f()},b=e=>{!1!==ee(e.target,":focus-visible")&&(u=!0,e.stopPropagation(),i.value=e.currentTarget||e.target,p())},V=e=>{u=!1,e.stopPropagation(),f()},w=t.computed((()=>{const t={}
...
if(e.openOnHover&&(a.onMouseenter=()=>{s=!0,p()},a.onMouseleave=()=>{s=!1,f()}),d.value&&(a.onFocusin=()=>{u=!0,p()},a.onFocusout=()=>{u=!1,f()}),e.closeOnContentClick){const e=t.inject(Wr,null)
...
const N=le(),_=t.computed((()=>"cursor"===e.target&&m.value?m.value:N.value?N.el:Kr(e.target,r)||i.value)),I=t.computed((()=>Array.isArray(_.value)?void 0:_.value))
let B
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,r,{activatorEl:i,activatorEvents:w})}))):B&&B.stop()}),{flush:"post",immediate:!0}),t.onScopeDispose((()=>{B?.stop()})),{activatorEl:i,activatorRef:x,target:_,targetEl:I,targetRef:N,activatorEvents:w,contentEvents:S,scrimEvents:k}}function Kr(e,t){if(!e)return
let a
...
return o.push(t),!o.some((t=>t?.contains(e.target)))}function oi(e,t){return("object"==typeof t.value&&t.value.closeConditional||ai)(e)}function ni(e,t){const a=Rt(e)
...
t._clickOutside.lastMousedownWasOutside&&li(e,t,a)&&setTimeout((()=>{oi(e,a)&&l&&l(e)}),0)}(a,e,t),l=a=>{e._clickOutside.lastMousedownWasOutside=li(a,e,t)}
ni(e,(e=>{e.addEventListener("click",a,!0),e.addEventListener("mousedown",l,!0)})),e._clickOutside||(e._clickOutside={lastMousedownWasOutside:!1}),e._clickOutside[t.instance.$.uid]={onClick:a,onMousedown:l}},unmounted(e,t){e._clickOutside&&(ni(e,(a=>{if(!a||!e._clickOutside?.[t.instance.$.uid])return
...
const i=sa(e,"modelValue"),s=t.computed({get:()=>i.value,set:t=>{t&&e.disabled||(i.value=t)}}),{themeClasses:u}=xa(e),{rtlClasses:c,isRtl:d}=Va(),{hasContent:v,onAfterLeave:p}=Qr(e,s),m=cl(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:g,localTop:h,stackStyles:y}=function(e,a,l){const o=bt("useStack"),n=!l,r=t.inject(ei,void 0),i=t.reactive({activeChildren:new Set})
t.provide(ei,i)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(s,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:b,activatorRef:V,target:w,targetEl:S,targetRef:k,activatorEvents:x,contentEvents:N,scrimEvents:C}=qr(e,{isActive:s,isTop:h}),{teleportTarget:_}=function(e){return{teleportTarget:t.computed((()=>{const l=e()
if(!0===l||!a)return
...
return a instanceof ShadowRoot&&a})),{dimensionStyles:I}=nl(e),B=Xr(),{scopeId:P}=Jr()
...
function r(e){n.value?.(e)}return a&&ia((()=>!(!l.isActive.value||!e.locationStrategy)),(a=>{t.watch((()=>e.locationStrategy),a),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0})),window.addEventListener("resize",r,{passive:!0}),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(l,e,o)?.updateLocation:n.value=Tr[e.locationStrategy](l,e,o)?.updateLocation})),{contentStyles:o,updateLocation:n}}(e,{isRtl:d,contentEl:T,target:w,isActive:s})
function F(t){r("click:outside",t),e.persistent?z():s.value=!1}function $(t){return s.value&&g.value&&(!e.scrim||t.target===A.value)}function M(t){"Escape"===t.key&&g.value&&(e.persistent?z():(s.value=!1,T.value?.contains(document.activeElement)&&b.value?.focus()))}!function(e,l){if(!a)return
let o
t.watchEffect((async()=>{o?.stop(),l.isActive.value&&e.scrollStrategy&&(o=t.effectScope(),await new Promise((e=>setTimeout(e))),o.active&&o.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(l,e,o):zr[e.scrollStrategy]?.(l,e,o)})))})),t.onScopeDispose((()=>{o?.stop()}))}(e,{root:R,contentEl:T,targetEl:S,isActive:s,updateLocation:E}),a&&t.watch(s,(e=>{e?window.addEventListener("keydown",M):window.removeEventListener("keydown",M)}),{immediate:!0}),t.onBeforeUnmount((()=>{a&&window.removeEventListener("keydown",M)}))
const O=po()
ia((()=>e.closeOnBack),(()=>{!function(e,l){let o,n,r=!1
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e?.beforeEach(((e,t,a)=>{go?r?l(a):a():setTimeout((()=>r?l(a):a())),go=!0})),n=e?.afterEach((()=>{go=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(O,(t=>{g.value&&s.value?(t(!1),e.persistent?z():s.value=!1):t()}))}))
const L=t.ref()
function z(){e.noClickAnimation||T.value&&he(T.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:At})}function j(){r("afterEnter")}function H(){p(),r("afterLeave")}return t.watch((()=>s.value&&(e.absolute||e.contained)&&null==_.value),(e=>{if(e){const e=Dt(R.value)
e&&e!==document.scrollingElement&&(L.value=e.scrollTop)}})),Mt((()=>t.createVNode(t.Fragment,null,[o.activator?.({isActive:s.value,targetRef:k,props:t.mergeProps({ref:V},x.value,e.activatorProps)}),B.value&&v.value&&t.createVNode(t.Teleport,{disabled:!_.value,to:_.value},{default:()=>[t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},u.value,c.value,e.class],style:[y.value,{"--v-overlay-opacity":e.opacity,top:f(L.value)},e.style],ref:R},P,n),[t.createVNode(ii,t.mergeProps({color:m,modelValue:s.value&&!!e.scrim,ref:A},C.value),null),t.createVNode(fl,{appear:!0,persisted:!0,transition:e.transition,target:w.value,onAfterEnter:j,onAfterLeave:H},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:T,class:["v-overlay__content",e.contentClass],style:[I.value,D.value]},N.value,e.contentProps),[o.default?.({isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:F,closeConditional:$,include:()=>[b.value]}]])]})])]})]))),{activatorEl:b,scrimEl:A,target:w,animateClick:z,contentEl:T,globalTop:g,localTop:h,updateLocation:E}}}),ci=Symbol("Forwarded refs")
...
o&&l.push(...o)}}}}})}const pi=ht({id:String,...k(si({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:Ma}}),["absolute"])},"VMenu"),fi=Bt()({name:"VMenu",props:pi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=sa(e,"modelValue"),{scopeId:n}=Jr(),r=kt(),i=t.computed((()=>e.id||`v-menu-${r}`)),s=t.ref(),u=t.inject(Wr,null),c=t.shallowRef(new Set)
...
a&&o.value?"ArrowDown"===t.key?(t.preventDefault(),Z(a,"next")):"ArrowUp"===t.key&&(t.preventDefault(),Z(a,"prev")):["ArrowDown","ArrowUp"].includes(t.key)&&(o.value=!0,t.preventDefault(),setTimeout((()=>setTimeout((()=>f(t))))))}t.provide(Wr,{register(){c.value.add(r)},unregister(){c.value.delete(r)},closeParents(t){setTimeout((()=>{c.value.size||e.persistent||null!=t&&(!t||function(e,t){const a=e.clientX,l=e.clientY,o=t.getBoundingClientRect(),n=o.left,r=o.top,i=o.right,s=o.bottom
return a>=n&&a<=i&&l>=r&&l<=s}(t,s.value.contentEl))||(o.value=!1,u?.closeParents())}),40)}}),t.onBeforeUnmount((()=>u?.unregister())),t.onDeactivated((()=>o.value=!1)),t.watch(o,(e=>{e?(u?.register(),document.addEventListener("focusin",d,{once:!0})):(u?.unregister(),document.removeEventListener("focusin",d))}))
...
return t.createVNode(ui,t.mergeProps({ref:s,id:i.value,class:["v-menu",e.class],style:e.style},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,absolute:!0,activatorProps:m.value,"onClick:outside":v,onKeydown:p},n),{activator:l.activator,default:function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createVNode(ll,{root:"VMenu"},{default:()=>[l.default?.(...a)]})}})})),vi({id:i,ΨopenChildren:c},s)}}),mi=ht({active:Boolean,disabled:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...yt(),...pl({transition:{component:Qa}})},"VCounter"),gi=Bt()({name:"VCounter",functional:!0,props:mi(),setup(e,a){let{slots:l}=a
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(h[e]=t,S())}}}const Pi=ht({items:{type:Array,default:()=>[]},renderless:Boolean,...Ii(),...yt(),...ol()},"VVirtualScroll"),Ri=Bt()({name:"VVirtualScroll",props:Pi(),setup(e,a){let{slots:l}=a
...
break}}}}}const Ti=ht({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Ot,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...yr({itemChildren:!1})},"Select"),Di=ht({...Ti(),...k(xi({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...pl({transition:{component:Ma}})},"VSelect"),Ei=Bt()({name:"VSelect",props:Di(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ya(),r=t.ref(),i=t.ref(),s=t.ref(),u=sa(e,"menu"),c=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren.size||(u.value=e)}}),{items:d,transformIn:v,transformOut:p}=wr(e),f=sa(e,"modelValue",[],(e=>v(null===e?[null]:P(e))),(t=>{const a=p(t)
...
function _(t){e.openOnClear&&(c.value=!0)}function I(){k.value||(c.value=!c.value)}function B(e){oe(e)&&R(e)}function R(t){if(!t.key||e.readonly||g?.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"," "].includes(t.key)&&(c.value=!0),["Escape","Tab"].includes(t.key)&&(c.value=!1),"Home"===t.key?N.value?.focus("first"):"End"===t.key&&N.value?.focus("last")
...
a&&window.requestAnimationFrame((()=>{e>=0&&s.value?.scrollToIndex(e)}))}}function A(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(tn,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Uo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Zl,{icon:l.props.prependIcon},null)])}})}}),o["append-item"]?.()]})]}),f.value.map(((l,n)=>{function r(e){e.stopPropagation(),e.preventDefault(),A(l,!1)}const i={"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},s=a?!!o.chip:!!o.selection,u=s?te(a?o.chip({item:l,index:n,props:i}):o.selection({item:l,index:n})):void 0
...
return t===I.value[0].value}))&&K(I.value[0]),"ArrowDown"===t.key&&T.value&&E.value?.focus("next"),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&R.value&&k.value.length>0&&!S.value)return K(k.value[0],!1)
...
t&&K(t)}}function H(){e.eager&&d.value?.calculateVisibleItems()}function W(){i.value&&(s.value=!0,r.value?.focus())}function U(e){i.value=!0,setTimeout((()=>{u.value=!0}))}function Y(e){u.value=!1}function G(t){null!=t&&(""!==t||e.multiple||R.value)||(k.value=[])}const q=t.shallowRef(!1)
...
k.value=e?[a]:[],S.value=e&&!R.value?a.title:"",t.nextTick((()=>{p.value=!1,s.value=!0}))}}return t.watch(i,((a,l)=>{a!==l&&(a?(q.value=!0,S.value=e.multiple||R.value?"":String(k.value.at(-1)?.props.title??""),s.value=!0,t.nextTick((()=>q.value=!1))):(e.multiple||null!=S.value||(k.value=[]),p.value=!1,k.value.some((e=>{let{title:t}=e
...
return t.createVNode(Ni,t.mergeProps({ref:r},u,{modelValue:S.value,"onUpdate:modelValue":[e=>S.value=e,G],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:x.value,dirty:l,onChange:j,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!R.value,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:e.readonly,placeholder:l?void 0:e.placeholder,"onClick:clear":$,"onMousedown:control":M,onKeydown:z}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(fi,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:D.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:H,onAfterLeave:W},e.menuProps),{default:()=>[a&&t.createVNode(Nr,t.mergeProps({ref:E,selected:A.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:L,onFocusin:U,onFocusout:Y,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},F,e.listProps),{default:()=>[o["prepend-item"]?.(),!I.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(dr,{title:n(e.noDataText)},null)),t.createVNode(Ri,{ref:d,renderless:!0,items:I.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
return Mt((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),us=Pt("v-card-title"),cs=ht({appendAvatar:String,appendIcon:Ot,prependAvatar:String,prependIcon:Ot,subtitle:[String,Number],title:[String,Number],...yt(),...Rl()},"VCardItem"),ds=Bt()({name:"VCardItem",props:cs(),setup(e,a){let{slots:l}=a
...
const Rs={h:0,s:0,v:0,a:1},As={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
...
const{thumbColor:s,step:u,disabled:c,thumbSize:d,thumbLabel:v,direction:p,isReversed:m,vertical:g,readonly:h,elevation:b,mousePressed:V,decimals:w,indexFromEnd:S}=n,k=t.computed((()=>c.value?void 0:b.value)),{elevationClasses:x}=Sl(k),{textColorClasses:N,textColorStyles:C}=ul(s),{pageup:_,pagedown:I,end:B,home:P,left:R,right:A,down:T,up:D}=y,E=[_,I,B,P,R,A,T,D],F=t.computed((()=>u.value?[1,2,3]:[1,5,10]))
function $(t){const a=function(t,a){if(!E.includes(t.key))return
t.preventDefault()
const l=u.value||.1,o=(e.max-e.min)/l
if([R,A,T,D].includes(t.key)){const e=(g.value?[r.value?R:A,m.value?T:D]:S.value!==r.value?[R,D]:[A,D]).includes(t.key)?1:-1,o=t.shiftKey?2:t.ctrlKey?1:0
...
l("update:color",{...e.color??Rs,...a})}catch(e){}}return t.onUnmounted((()=>o.abort())),Mt((()=>t.createVNode("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[n&&t.createVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Fo,{onClick:r,icon:"$eyeDropper",variant:"plain",density:"comfortable"},null)]),t.createVNode("div",{class:"v-color-picker-preview__dot"},[t.createVNode("div",{style:{background:rt(e.color??Rs)}},null)]),t.createVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(qs,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Rs,h:t}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(qs,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Rs,a:t}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])]))),{}}})
...
return V(t,["r","g","b"])?a=et(e):V(t,["h","s","l"])?a=lt(e):V(t,["h","s","v"])&&(a=e),function(e,t){if(t){const{a:t,...a}=e
...
return t.createVNode(eu,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",r.value,e.class],style:[{"--v-color-picker-color-hsv":rt({...n.value??Rs,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(Ps,{key:"canvas",color:n.value,"onUpdate:color":s,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(Ks,{key:"preview",color:n.value,"onUpdate:color":s,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode($s,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:n.value,"onUpdate:color":s,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(Qs,{key:"swatches",color:n.value,"onUpdate:color":s,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
const au=ht({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...$i({filterKeys:["title"]}),...Ti({hideNoData:!0,returnObject:!0}),...k(xi({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...pl({transition:!1})},"VCombobox"),lu=Bt()({name:"VCombobox",props:au(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
...
let g=!1
const h=t.computed((()=>i.value?.color)),y=t.computed((()=>f.value?e.closeText:e.openText)),{items:b,transformIn:V,transformOut:w}=wr(e),{textColorClasses:S,textColorStyles:k}=ul(h),x=sa(e,"modelValue",[],(e=>V(P(e))),(t=>{const a=w(t)
return e.multiple?a:a[0]??null})),N=cn(),C=t.computed((()=>!(!e.chips&&!n.chip))),_=t.computed((()=>C.value||!!n.selection)),B=t.shallowRef(e.multiple||_.value?"":x.value[0]?.title??""),R=t.computed({get:()=>B.value,set:t=>{if(B.value=t??"",e.multiple||_.value||(x.value=[br(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&q(br(e,t))})),B.value="")}t||(m.value=-1),u.value=!t}}),A=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:R.value.length))
...
const{filteredItems:T,getMatches:D}=Mi(e,b,(()=>u.value?"":R.value)),E=t.computed((()=>e.hideSelected?T.value.filter((e=>!x.value.some((t=>t.value===e.value)))):T.value)),F=t.computed((()=>x.value.map((e=>e.value)))),$=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&R.value===E.value[0]?.title)&&E.value.length>0&&!u.value&&!c.value)),M=t.computed((()=>e.hideNoData&&!E.value.length||e.readonly||N?.isReadonly.value)),O=t.ref(),L=Ai(O,i)
function z(t){g=!0,e.openOnClear&&(f.value=!0)}function j(){M.value||(f.value=!0)}function H(e){M.value||(s.value&&(e.preventDefault(),e.stopPropagation()),f.value=!f.value)}function W(e){oe(e)&&i.value?.focus()}function U(t){if(function(e){return e.isComposing&&I.includes(e.key)}(t)||e.readonly||N?.isReadonly.value)return
...
return t===E.value[0].value}))&&q(T.value[0]),u.value=!0),"ArrowDown"===t.key&&$.value&&O.value?.focus("next"),"Enter"===t.key&&R.value&&(q(br(e,R.value)),_.value&&(B.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&_.value&&x.value.length>0&&!R.value)return q(x.value[0],!1)
if(~m.value){const e=m.value
q(x.value[m.value],!1),m.value=e>=l-1?l-2:e}else"Backspace"!==t.key||R.value||(m.value=l-1)}if(e.multiple){if("ArrowLeft"===t.key){if(m.value<0&&a>0)return
const e=m.value>-1?m.value-1:l-1
x.value[e]?m.value=e:(m.value=-1,i.value.setSelectionRange(R.value.length,R.value.length))}if("ArrowRight"===t.key){if(m.value<0)return
const e=m.value+1
...
x.value=e?[a]:[],B.value=e&&!_.value?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function K(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function X(e){c.value=!1}function Z(t){null!=t&&(""!==t||e.multiple||_.value)||(x.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(m.value=-1,f.value=!1,R.value)){if(e.multiple)return void q(br(e,R.value))
if(!_.value)return
x.value.some((e=>{let{title:t}=e
return t===R.value}))?B.value="":q(br(e,R.value))}})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=E.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
...
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(l.title,D(l)?.title,R.value?.length??0)})}}),n["append-item"]?.()]})]}),x.value.map(((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),q(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=C.value?!!n.chip:!!n.selection,s=i?te(C.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
...
n.push({depth:a,id:s,key:i,value:o,items:r.length?Pu(e,r,a+1,s):e,type:"group"})})),n}function Ru(e,t){const a=[]
for(const l of e)"type"in l&&"group"===l.type?(null!=l.value&&a.push(l),(t.has(l.id)||null==l.value)&&a.push(...Ru(l.items,t))):a.push(l)
return a}function Au(e,a,l){return{flatItems:t.computed((()=>{if(!a.value.length)return e.value
return Ru(Pu(e.value,a.value.map((e=>e.key))),l.value)}))}}function Tu(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
...
const n=sa(e,"modelValue",e.modelValue,(t=>new Set(P(t).map((t=>l.value.find((a=>e.valueComparator(t,a.value)))?.value??t)))),(e=>[...e.values()])),r=t.computed((()=>l.value.filter((e=>e.selectable)))),i=t.computed((()=>o.value.filter((e=>e.selectable)))),s=t.computed((()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
...
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(tn,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),Cc=ht({index:Number,item:Object,cellProps:[Object,Function],onClick:Y(),onContextmenu:Y(),onDblclick:Y(),...xn()},"VDataTableRow"),_c=Bt()({name:"VDataTableRow",props:Cc(),setup(e,a){let{slots:l}=a
...
return t.createVNode(t.Fragment,{key:g.props.key},[o.item?o.item(g):t.createVNode(_c,g.props,o),s(a)&&o["expanded-row"]?.(m)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),Pc=ht({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...yt(),...Rl(),...Pa(),...Sa()},"VTable"),Rc=Bt()({name:"VTable",props:Pc(),setup(e,a){let{slots:l,emit:o}=a
const{themeClasses:n}=xa(e),{densityClasses:r}=Al(e)
return Mt((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},n.value,r.value,e.class],style:e.style},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),Ac=ht({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
...
const U=t.computed((()=>({sortBy:r.value,toggleSort:b,someSelected:A.value,allSelected:T.value,isSelected:I,select:B,selectAll:P,toggleSelect:R,isExpanded:D,toggleExpand:E,isGroupOpen:k,toggleGroup:x,items:_.value.map((e=>e.raw)),internalItems:_.value,groupedItems:C.value,columns:c.value,headers:d.value})))
Mt((()=>{const a=kc.filterProps(e),n=Bc.filterProps(e),r=Rc.filterProps(e)
return t.createVNode(Rc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r),{top:()=>o.top?.(U.value),wrapper:()=>t.createVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[o.colgroup?.(U.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(kc,t.mergeProps(a,{sticky:e.fixedHeader}),o)]),!e.hideDefaultBody&&t.createVNode("tbody",null,[t.createVNode("tr",{ref:$,style:{height:f(M.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(U.value),t.createVNode(Bc,t.mergeProps(l,n,{items:W.value}),{...o,item:e=>t.createVNode(_i,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>z(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
...
function wd(e){const a=yu(),l=sa(e,"modelValue",[],(e=>P(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=sa(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
return t.createVNode(eu,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(Id,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(ll,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}}),Rd=ht({header:{type:String,default:"$vuetify.datePicker.header"},...gd(),...Sd({weeksInMonth:"static"}),...k(xd(),["modelValue"]),...k(Cd(),["modelValue"]),...Bd({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Ad=Bt()({name:"VDatePicker",props:Rd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=yu(),{t:r}=ya(),i=sa(e,"modelValue",void 0,(e=>P(e)),(t=>e.multiple?t:t[0])),s=sa(e,"viewMode"),u=t.computed((()=>{const e=n.date(i.value?.[0])
...
i!==c.value&&(c.value=i,N(c.value)),s!==d.value&&(d.value=s,C(d.value)),v.value=n.isBefore(o,r)})),Mt((()=>{const a=Pd.filterProps(e),l=hd.filterProps(e),n=bd.filterProps(e),u=kd.filterProps(e),v=k(Nd.filterProps(e),["modelValue"]),_=k(_d.filterProps(e),["modelValue"]),I={header:p.value,transition:m.value}
return t.createVNode(Pd,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(ll,{defaults:{VDatePickerHeader:{...I}}},{default:()=>[o.header?.(I)]}):t.createVNode(bd,t.mergeProps({key:"header"},n,I,{onClick:"month"!==s.value?w:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(hd,t.mergeProps(l,{disabled:y.value,text:f.value,"onClick:next":b,"onClick:prev":V,"onClick:month":S,"onClick:year":x}),null),t.createVNode(Wa,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Nd,t.mergeProps({key:"date-picker-months"},v,{modelValue:c.value,"onUpdate:modelValue":[e=>c.value=e,N],min:g.value,max:h.value,year:d.value}),null):"year"===s.value?t.createVNode(_d,t.mergeProps({key:"date-picker-years"},_,{modelValue:d.value,"onUpdate:modelValue":[e=>d.value=e,C],min:g.value,max:h.value}),null):t.createVNode(kd,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:c.value,"onUpdate:month":[e=>c.value=e,N],year:d.value,"onUpdate:year":[e=>d.value=e,C],min:g.value,max:h.value}),null)]})]),actions:o.actions})})),{}}}),Td=ht({actionText:String,bgColor:String,color:String,icon:Ot,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...yt(),...ol(),...ql({size:void 0}),...Sa()},"VEmptyState"),Dd=Bt()({name:"VEmptyState",props:Td(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
const{themeClasses:o}=xa(e),{backgroundColorClasses:n,backgroundColorStyles:r}=cl(t.toRef(e,"color")),{borderClasses:i}=Vl(e),{elevationClasses:s}=Sl(e),{roundedClasses:u}=vl(e),c=t.shallowRef(32),{resizeRef:d}=Jt((e=>{e.length&&(c.value=e[0].target.clientHeight)})),v=t.computed((()=>"auto"===e.height?c.value:parseInt(e.height,10))),{layoutItemStyles:p,layoutIsReady:m}=na({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:v,elementSize:t.computed((()=>"auto"===e.height?void 0:v.value)),active:t.computed((()=>e.app)),absolute:t.toRef(e,"absolute")})
return Mt((()=>t.createVNode(e.tag,{ref:d,class:["v-footer",o.value,n.value,i.value,s.value,u.value,e.class],style:[r.value,e.app?p.value:{height:f(e.height)},e.style]},l))),e.app?m:{}}}),Zd=ht({...yt(),...un()},"VForm"),Qd=Bt()({name:"VForm",props:Zd(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return Mt((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[u.value,n.value,e.style]},[t.createVNode(t.Suspense,null,{default:()=>[t.createVNode(t.Fragment,null,[l.default?.()])]})]))),{getLayoutItem:r,items:i}}}),dv=ht({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...yt(),...la()},"VLayoutItem"),vv=Bt()({name:"VLayoutItem",props:dv(),setup(e,a){let{slots:l}=a
const{layoutItemStyles:o,layoutIsReady:n}=na({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.toRef(e,"position"),elementSize:t.toRef(e,"size"),layoutSize:t.toRef(e,"size"),active:t.toRef(e,"modelValue"),absolute:t.toRef(e,"absolute")})
return Mt((()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()]))),n}}),pv=ht({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...yt(),...ol(),...Pa(),...pl({transition:"fade-transition"})},"VLazy"),fv=Bt()({name:"VLazy",directives:{intersect:gl},props:pv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const{dimensionStyles:o}=nl(e),{mainStyles:n,layoutIsReady:r}=oa(),{ssrBootStyles:i}=_l()
return Mt((()=>t.createVNode(e.tag,{class:["v-main",{"v-main--scrollable":e.scrollable},e.class],style:[n.value,i.value,o.value,e.style]},{default:()=>[e.scrollable?t.createVNode("div",{class:"v-main__scroller"},[l.default?.()]):l.default?.()]}))),r}})
const bv=100,Vv=20
...
return{addMovement:function(t){Array.from(t.changedTouches).forEach((a=>{(e[a.identifier]??(e[a.identifier]=new j(Vv))).push([t.timeStamp,a])}))},endTouch:function(t){Array.from(t.changedTouches).forEach((t=>{delete e[t.identifier]}))},getVelocity:function(t){const a=e[t]?.values().reverse()
...
t.watchEffect((()=>{a.value?.style.setProperty("transform",S.value?.transform||"none"),a.value?.style.setProperty("transition",S.value?.transition||null)})),t.onScopeDispose((()=>{a.value?.style.setProperty("transform",e),a.value?.style.setProperty("transition",l)}))})),{isDragging:p,dragProgress:f,dragStyles:S}}({el:V,isActive:h,isTemporary:_,width:x,touchless:t.toRef(e,"touchless"),position:N}),R=t.computed((()=>{const t=_.value?0:e.rail&&e.expandOnHover?Number(e.railWidth):x.value
return B.value?t*P.value:t})),A=t.computed((()=>["top","bottom"].includes(e.location)?0:x.value)),{layoutItemStyles:T,layoutItemScrimStyles:D,layoutIsReady:E}=na({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:N,layoutSize:R,elementSize:A,active:t.computed((()=>h.value||B.value)),disableTransitions:t.computed((()=>B.value)),absolute:t.computed((()=>e.absolute||I.value&&"string"!=typeof F.value))}),{isStuck:F,stickyStyles:$}=function(e){let{rootEl:a,isSticky:l,layoutItemStyles:o}=e
...
const Rv=ht({scale:{type:[Number,String],default:.5},...yt()},"VParallax"),Av=Bt()({name:"VParallax",props:Rv(),setup(e,a){let{slots:l}=a
...
const{backgroundColorClasses:o,backgroundColorStyles:n}=cl(t.toRef(e,"color")),{dimensionStyles:r}=nl(e),{elevationClasses:i}=Sl(e),{themeClasses:s}=xa(e),{t:u}=ya(),c=t.computed((()=>Wv(P(e.type).join(","))))
return Mt((()=>{const a=!l.default||e.loading
return t.createVNode("div",{class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,o.value,i.value],style:[n.value,a?r.value:{}],"aria-busy":e.boilerplate?void 0:a,"aria-live":e.boilerplate?void 0:"polite","aria-label":e.boilerplate?void 0:u(e.loadingText),role:e.boilerplate?void 0:"alert"},[a?c.value:l.default?.()])})),{}}}),qv=Bt()({name:"VSlideGroupItem",props:Ll(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=zl(e,En)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const Kv=ht({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...ao({location:"bottom"}),...co(),...dl(),...El(),...Sa(),...k(si({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),Xv=Bt()({name:"VSnackbar",props:Kv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
a.value=Math.max(e-t,0),a.value<=0&&o()}),r)},reset:function(){o(),t.nextTick((()=>a.value=e))}}}(Number(e.timeout)),p=t.ref(),f=t.ref(),m=t.shallowRef(!1),h=t.shallowRef(0),y=t.ref(),b=t.inject(ea,void 0)
ia((()=>!!b),(()=>{const e=oa()
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,onClick:function(){o?.toggle()}},[i.value&&Dl(!0,"v-stepper-item"),t.createVNode(Uo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Zl,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),hp=ht({...k(ws(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),yp=Bt()({name:"VStepperWindow",props:hp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
he(t,{backgroundColor:[a,"currentcolor"],transform:[`translate${r}(${v}px) scale${r}(${l[d]/o[d]||0})`,`translate${r}(${v/m}px) scale${r}(${(f-1)/m+1})`,"none"],transformOrigin:Array(3).fill(p)},{duration:225,easing:At})}}return Mt((()=>{const a=Fo.filterProps(e)
return t.createVNode(Fo,t.mergeProps({symbol:Ip,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),vi({},i)}}),Rp=ht({...k(ws(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Ap=Bt()({name:"VTabsWindow",props:Rp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const Ep=ht({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...Fn({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Rl(),...Pa()},"VTabs"),Fp=Bt()({name:"VTabs",props:Ep(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=sa(e,"modelValue"),r=t.computed((()=>function(e){return e?e.map((e=>m(e)?e:{text:e,value:e})):[]}(e.items))),{densityClasses:i}=Al(e),{backgroundColorClasses:s,backgroundColorStyles:u}=cl(t.toRef(e,"bgColor")),{scopeId:c}=Jr()
...
const{blueprint:l,...o}=e,n=F(l,o),{aliases:r={},components:i={},directives:s={}}=n,u=function(e){return t.ref(e)}(n.defaults),c=function(e,l){const{thresholds:o,mobileBreakpoint:n}=Vn(e),r=t.shallowRef(Sn(l)),i=t.shallowRef(kn(l)),s=t.reactive({}),u=t.shallowRef(wn(l))
...
if(a&&e in a)return a[e]}sf.version="3.7.0-beta.1"
const cf=function(){return sf({components:Qp,directives:rf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},df="3.7.0-beta.1"
