...
const pn=ht({disabled:{type:Boolean,default:null},error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:{type:Boolean,default:null},rules:{type:Array,default:()=>[]},modelValue:null,validateOn:String,validationValue:null,...rn()},"validation")
function fn(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Vt(),l=arguments.length>2&&void 0!==arguments[2]?arguments[2]:t.useId()
const o=na(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=dn(e),i=function(e){const a=t.inject(vn,null)
...
return{input:a.has("input"),blur:a.has("blur")||a.has("input")||a.has("invalid-input"),invalidInput:a.has("invalid-input"),lazy:a.has("lazy"),eager:a.has("eager")}})),p=t.computed((()=>!e.error&&!e.errorMessages?.length&&(!e.rules.length||(u.value?!s.value.length&&!v.value.lazy||null:!s.value.length)))),f=t.shallowRef(!1),m=t.computed((()=>({[`${a}--error`]:!1===p.value,[`${a}--dirty`]:c.value,[`${a}--disabled`]:r.isDisabled.value,[`${a}--readonly`]:r.isReadonly.value}))),g=bt("validation"),h=t.computed((()=>e.name??t.unref(l)))
...
!0!==o&&(!1===o||"string"==typeof o?a.push(o||""):console.warn(`${o} is not a valid value. Rule functions must return boolean true or a string.`))}return s.value=a,f.value=!1,u.value=t,s.value}return t.onBeforeMount((()=>{r.register?.({id:h.value,vm:g,validate:V,reset:y,resetValidation:b})})),t.onBeforeUnmount((()=>{r.unregister?.(h.value)})),t.onMounted((async()=>{v.value.lazy||await V(!v.value.eager),r.update?.(h.value,p.value,d.value)})),oa((()=>v.value.input||v.value.invalidInput&&!1===p.value),(()=>{t.watch(n,(()=>{if(null!=n.value)V()
else if(e.focused){const a=t.watch((()=>e.focused),(e=>{e||V(),a()}))}}))})),oa((()=>v.value.blur),(()=>{t.watch((()=>e.focused),(e=>{e||V()}))})),t.watch([p,d],(()=>{r.update?.(h.value,p.value,d.value)})),{errorMessages:d,isDirty:c,isDisabled:r.isDisabled,isReadonly:r.isReadonly,isPristine:u,isValid:p,isValidating:f,reset:y,resetValidation:b,validate:V,validationClasses:m}}const mn=ht({id:String,appendIcon:Ft,baseColor:String,centerAffix:{type:Boolean,default:!0},color:String,glow:Boolean,iconColor:[Boolean,String],prependIcon:Ft,hideDetails:[Boolean,String],hideSpinButtons:Boolean,hint:String,persistentHint:Boolean,messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":G(),"onClick:append":G(),...yt(),...Al(),...k(nl(),["maxWidth","minWidth","width"]),...ba(),...pn()},"VInput"),gn=Ct()({name:"VInput",props:{...mn()},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const{densityClasses:r}=Tl(e),{dimensionStyles:i}=rl(e),{themeClasses:s}=Ca(e),{rtlClasses:u}=ha(),{InputIcon:c}=ln(e),d=t.useId(),v=t.computed((()=>e.id||`input-${d}`)),p=t.computed((()=>`${v.value}-messages`)),{errorMessages:f,isDirty:m,isDisabled:g,isReadonly:h,isPristine:y,isValid:b,isValidating:V,reset:w,resetValidation:S,validate:k,validationClasses:x}=fn(e,"v-input",v),N=t.computed((()=>({id:v,messagesId:p,isDirty:m,isDisabled:g,isReadonly:h,isPristine:y,isValid:b,isValidating:V,reset:w,resetValidation:S,validate:k}))),C=t.toRef((()=>e.error||e.disabled?void 0:e.focused?e.color:e.baseColor)),I=t.toRef((()=>{if(e.iconColor)return!0===e.iconColor?C.value:e.iconColor})),_=t.computed((()=>e.errorMessages?.length||!y.value&&f.value.length?f.value:e.hint&&(e.persistentHint||e.focused)?e.hint:e.messages))
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,{"v-input--center-affix":e.centerAffix,"v-input--focused":e.focused,"v-input--glow":e.glow,"v-input--hide-spin-buttons":e.hideSpinButtons},r.value,s.value,u.value,x.value,e.class],style:[i.value,e.style]},[a&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[o.prepend?.(N.value),e.prependIcon&&t.createVNode(c,{key:"prepend-icon",name:"prepend",color:I.value},null)]),o.default&&t.createVNode("div",{class:"v-input__control"},[o.default?.(N.value)]),l&&t.createVNode("div",{key:"append",class:"v-input__append"},[e.appendIcon&&t.createVNode(c,{key:"append-icon",name:"append",color:I.value},null),o.append?.(N.value)]),d&&t.createVNode("div",{id:p.value,class:"v-input__details",role:"alert","aria-live":"polite"},[t.createVNode(nn,{active:n,messages:_.value},{message:o.message}),o.details?.(N.value)])])})),{reset:w,resetValidation:S,validate:k,isValid:b,errorMessages:f}}}),hn=ht({...mn(),...N(tn(),["inline"])},"VCheckbox"),yn=Ct()({name:"VCheckbox",inheritAttrs:!1,props:hn(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=na(e,"modelValue"),{isFocused:r,focus:i,blur:s}=sn(e),u=t.useId()
return Et((()=>{const[a,c]=B(l),d=gn.filterProps(e),v=an.filterProps(e)
return t.createVNode(gn,t.mergeProps({class:["v-checkbox",e.class]},a,d,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,id:e.id||`checkbox-${u}`,focused:r.value,style:e.style}),{...o,default:e=>{let{id:a,messagesId:l,isDisabled:r,isReadonly:u,isValid:d}=e
return t.createVNode(an,t.mergeProps(v,{id:a.value,"aria-describedby":l.value,disabled:r.value,readonly:u.value},c,{error:!1===d.value,modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,onFocus:i,onBlur:s}),o)}})})),{}}}),bn=["sm","md","lg","xl","xxl"],Vn=Symbol.for("vuetify:display"),wn={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}},Sn=function(){return $(wn,arguments.length>0&&void 0!==arguments[0]?arguments[0]:wn)}
function kn(e){return a&&!e?window.innerWidth:"object"==typeof e&&e.clientWidth||0}function xn(e){return a&&!e?window.innerHeight:"object"==typeof e&&e.clientHeight||0}function Nn(e){const t=a&&!e?window.navigator.userAgent:"ssr"
function l(e){return Boolean(t.match(e))}return{android:l(/android/i),ios:l(/iphone|ipad|ipod/i),cordova:l(/cordova/i),electron:l(/electron/i),chrome:l(/chrome/i),edge:l(/edge/i),firefox:l(/firefox/i),opera:l(/opera/i),win:l(/win/i),mac:l(/mac/i),linux:l(/linux/i),touch:o,ssr:"ssr"===t}}const Cn=ht({mobile:{type:Boolean,default:!1},mobileBreakpoint:[Number,String]},"display")
function In(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{mobile:null},a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Vt()
const l=t.inject(Vn)
...
const a=t.inject(_n),{isRtl:l}=ha()
if(!a)throw new Error("[Vuetify] Could not find injected goto instance")
const o={...a,rtl:t.toRef((()=>a.rtl.value||l.value))}
async function n(t,a){return Rn(t,$(e,a),!1,o)}return n.horizontal=async(t,a)=>Rn(t,$(e,a),!0,o),n}function Tn(e,t){const a=e?"scrollWidth":"scrollHeight"
return t?.[a]||0}function Dn(e,t,a){if(!a)return 0
const{scrollLeft:l,offsetWidth:o,scrollWidth:n}=a
return e?t?n-o+l:l:a.scrollTop}function En(e,t){const a=e?"offsetWidth":"offsetHeight"
return t?.[a]||0}function Fn(e,t){const a=e?"offsetLeft":"offsetTop"
return t?.[a]||0}const $n=Symbol.for("vuetify:v-slide-group"),Mn=ht({centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:$n},nextIcon:{type:Ft,default:"$next"},prevIcon:{type:Ft,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...yt(),...Cn({mobile:null}),...Ba(),...Ll({selectedClass:"v-slide-group-item--active"})},"VSlideGroup"),On=Ct()({name:"VSlideGroup",props:Mn(),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
const{isRtl:n}=ha(),{displayClasses:r,mobile:i}=In(e),s=Hl(e,e.symbol),u=t.shallowRef(!1),c=t.shallowRef(0),d=t.shallowRef(0),v=t.shallowRef(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=Xt(),{resizeRef:g,contentRect:h}=Xt(),y=An(),b=t.computed((()=>({container:f.el,duration:200,easing:"easeOutQuart"}))),V=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),w=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(a){let a=-1
...
const o=En(l,a)
return Fn(l,t)-o/2+En(l,t)/2}({containerElement:f.el,isHorizontal:p.value,selectedElement:e}):function(e){let{selectedElement:t,containerElement:a,isRtl:l,isHorizontal:o}=e
const n=En(o,a),r=Dn(o,l,a),i=En(o,t),s=Fn(o,t),u=.4*i
...
const t=En(p.value,f.el),l=Dn(p.value,n.value,f.el)
if(!(Tn(p.value,f.el)<=t||Math.abs(e-l)<16)){if(p.value&&n.value&&f.el){const{scrollWidth:t,offsetWidth:a}=f.el
...
const e=Tn(p.value,f.el),t=function(e,t){const a=e?"clientWidth":"clientHeight"
return t?.[a]||0}(p.value,f.el)
return e-t-Math.abs(c.value)>1}))
return Et((()=>t.createVNode(e.tag,{class:["v-slide-group",{"v-slide-group--vertical":!p.value,"v-slide-group--has-affixes":F.value,"v-slide-group--is-overflowing":u.value},r.value,e.class],style:e.style,tabindex:S.value||s.selected.value.length?-1:0,onFocus:P},{default:()=>[F.value&&t.createVNode("div",{key:"prev",class:["v-slide-group__prev",{"v-slide-group__prev--disabled":!$.value}],onMousedown:B,onClick:()=>$.value&&D("prev")},[o.prev?.(E.value)??t.createVNode(Ua,null,{default:()=>[t.createVNode(Ql,{icon:n.value?e.nextIcon:e.prevIcon},null)]})]),t.createVNode("div",{key:"container",ref:f,class:"v-slide-group__container",onScroll:N},[t.createVNode("div",{ref:g,class:"v-slide-group__content",onFocusin:C,onFocusout:I,onKeydown:R},[o.default?.(E.value)])]),F.value&&t.createVNode("div",{key:"next",class:["v-slide-group__next",{"v-slide-group__next--disabled":!M.value}],onMousedown:B,onClick:()=>M.value&&D("next")},[o.next?.(E.value)??t.createVNode(Ua,null,{default:()=>[t.createVNode(Ql,{icon:n.value?e.prevIcon:e.nextIcon},null)]})])]}))),{selected:s.selected,scrollTo:D,scrollOffset:c,focus:T,hasPrev:$,hasNext:M}}}),Ln=Symbol.for("vuetify:v-chip-group"),zn=ht({baseColor:String,column:Boolean,filter:Boolean,valueComparator:{type:Function,default:d},...Mn(),...yt(),...Ll({selectedClass:"v-chip--selected"}),...Ba(),...ba(),...Fl({variant:"tonal"})},"VChipGroup"),jn=Ct()({name:"VChipGroup",props:zn(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=Ca(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Hl(e,Ln)
return kt({VChip:{baseColor:t.toRef((()=>e.baseColor)),color:t.toRef((()=>e.color)),disabled:t.toRef((()=>e.disabled)),filter:t.toRef((()=>e.filter)),variant:t.toRef((()=>e.variant))}}),Et((()=>{const a=On.filterProps(e)
return t.createVNode(On,t.mergeProps(a,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value,e.class],style:e.style}),{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),Hn=ht({activeClass:String,appendAvatar:String,appendIcon:Ft,baseColor:String,closable:Boolean,closeIcon:{type:Ft,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:Ft,default:"$complete"},label:Boolean,link:{type:Boolean,default:void 0},pill:Boolean,prependAvatar:String,prependIcon:Ft,ripple:{type:[Boolean,Object],default:!0},text:{type:[String,Number,Boolean],default:void 0},modelValue:{type:Boolean,default:!0},onClick:G(),onClickOnce:G(),...Vl(),...yt(),...Al(),...Sl(),...zl(),...vl(),...go(),...Kl(),...Ba({tag:"span"}),...ba(),...Fl({variant:"tonal"})},"VChip"),Wn=Ct()({name:"VChip",directives:{Ripple:Eo},props:Hn(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0,click:e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{t:r}=ma(),{borderClasses:i}=wl(e),{densityClasses:s}=Tl(e),{elevationClasses:u}=kl(e),{roundedClasses:c}=pl(e),{sizeClasses:d}=Xl(e),{themeClasses:v}=Ca(e),p=na(e,"modelValue"),f=jl(e,Ln,!1),m=mo(e,l),g=t.toRef((()=>!1!==e.link&&m.isLink.value)),h=t.computed((()=>!e.disabled&&!1!==e.link&&(!!f||e.link||m.isClickable.value))),y=t.toRef((()=>({"aria-label":r(e.closeLabel),onClick(e){e.preventDefault(),e.stopPropagation(),p.value=!1,o("click:close",e)}}))),{colorClasses:b,colorStyles:V,variantClasses:w}=$l((()=>({color:!f||f.isSelected.value?e.color??e.baseColor:e.baseColor,variant:e.variant})))
...
return p.value&&t.withDirectives(t.createVNode(a,t.mergeProps({class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":h.value,"v-chip--filter":x,"v-chip--pill":e.pill,[`${e.activeClass}`]:e.activeClass&&m.isActive?.value},v.value,i.value,b.value,s.value,u.value,c.value,d.value,w.value,f?.selectedClass.value,e.class],style:[V.value,e.style],disabled:e.disabled||void 0,draggable:e.draggable,tabindex:h.value?0:void 0,onClick:S,onKeydown:h.value&&!g.value&&k},m.linkProps),{default:()=>[El(h.value,"v-chip"),x&&t.createVNode(al,{key:"filter"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?t.createVNode(ol,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},n.filter):t.createVNode(Ql,{key:"filter-icon",icon:e.filterIcon},null)]),[[t.vShow,f.isSelected.value]])]}),C&&t.createVNode("div",{key:"prepend",class:"v-chip__prepend"},[n.prepend?t.createVNode(ol,{key:"prepend-defaults",disabled:!N,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},n.prepend):t.createVNode(t.Fragment,null,[e.prependIcon&&t.createVNode(Ql,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&t.createVNode(Yo,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),t.createVNode("div",{class:"v-chip__content","data-no-activator":""},[n.default?.({isSelected:f?.isSelected.value,selectedClass:f?.selectedClass.value,select:f?.select,toggle:f?.toggle,value:f?.value.value,disabled:e.disabled})??t.toDisplayString(e.text)]),o&&t.createVNode("div",{key:"append",class:"v-chip__append"},[n.append?t.createVNode(ol,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},n.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ql,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Yo,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),r&&t.createVNode("button",t.mergeProps({key:"close",class:"v-chip__close",type:"button","data-testid":"close-chip"},y.value),[n.close?t.createVNode(ol,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},n.close):t.createVNode(Ql,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}),[[t.resolveDirective("ripple"),h.value&&e.ripple,null]])}}}),Un=Symbol.for("vuetify:list")
function Yn(){const e=t.inject(Un,{hasPrepend:t.shallowRef(!1),updateHasPrepend:()=>null}),a={hasPrepend:t.shallowRef(!1),updateHasPrepend:e=>{e&&(a.hasPrepend.value=e)}}
return t.provide(Un,a),e}function Gn(){return t.inject(Un,null)}const qn=e=>{const a={activate:a=>{let{id:l,value:o,activated:n}=a
...
n.length&&(o=a.in(n.slice(0,1),t,l))}return o},out:(e,t,l)=>a.out(e,t,l)}},Xn={open:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(a){const e=new Set
e.add(t)
let a=o.get(t)
for(;null!=a;)e.add(a),a=o.get(a)
return e}return l.delete(t),l},select:()=>null},Zn={open:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(a){let e=o.get(t)
for(l.add(t);null!=e&&e!==t;)l.add(e),e=o.get(e)
return l}return l.delete(t),l},select:()=>null},Qn={open:Zn.open,select:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(!a)return l
const n=[]
let r=o.get(t)
for(;null!=r;)n.push(r),r=o.get(r)
return new Set(n)}},Jn=e=>{const a={select:a=>{let{id:l,value:o,selected:n}=a
...
return t}}
return a},er=e=>{const a=Jn(e)
return{select:e=>{let{selected:l,id:o,...n}=e
o=t.toRaw(o)
const r=l.has(o)?new Map([[o,l.get(o)]]):new Map
return a.select({...n,id:o,selected:r})},in:(e,t,l)=>e?.length?a.in(e.slice(0,1),t,l):new Map,out:(e,t,l)=>a.out(e,t,l)}},tr=e=>{const a={select:a=>{let{id:l,value:o,selected:n,children:r,parents:i}=a
l=t.toRaw(l)
...
return a}}
return a},ar=Symbol.for("vuetify:nested"),lr={id:t.shallowRef(),root:{register:()=>null,unregister:()=>null,parents:t.ref(new Map),children:t.ref(new Map),open:()=>null,openOnSelect:()=>null,activate:()=>null,select:()=>null,activatable:t.ref(!1),selectable:t.ref(!1),opened:t.ref(new Set),activated:t.ref(new Set),selected:t.ref(new Map),selectedValues:t.ref([]),getPath:()=>[]}},or=ht({activatable:Boolean,selectable:Boolean,activeStrategy:[String,Function,Object],selectStrategy:[String,Function,Object],openStrategy:[String,Object],opened:null,activated:null,selected:null,mandatory:Boolean},"nested"),nr=e=>{let a=!1
...
switch(e.activeStrategy){case"leaf":return(e=>{const a=qn(e)
...
case"single-leaf":return(e=>{const a=Kn(e)
return{activate:e=>{let{id:l,activated:o,children:n,...r}=e
return l=t.toRaw(l),n.has(l)?o:a.activate({id:l,activated:o,children:n,...r})},in:a.in,out:a.out}})(e.mandatory)
case"independent":return qn(e.mandatory)
default:return Kn(e.mandatory)}})),i=t.computed((()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
if("function"==typeof e.selectStrategy)return e.selectStrategy(e.mandatory)
switch(e.selectStrategy){case"single-leaf":return(e=>{const a=er(e)
return{select:e=>{let{id:l,selected:o,children:n,...r}=e
return l=t.toRaw(l),n.has(l)?o:a.select({id:l,selected:o,children:n,...r})},in:a.in,out:a.out}})(e.mandatory)
case"leaf":return(e=>{const a=Jn(e)
return{select:e=>{let{id:l,selected:o,children:n,...r}=e
return l=t.toRaw(l),n.has(l)?o:a.select({id:l,selected:o,children:n,...r})},in:a.in,out:a.out}})(e.mandatory)
case"independent":return Jn(e.mandatory)
case"single-independent":return er(e.mandatory)
case"trunk":return(e=>{const t=tr(e)
...
default:return tr(e.mandatory)}})),s=t.computed((()=>{if("object"==typeof e.openStrategy)return e.openStrategy
switch(e.openStrategy){case"list":return Qn
case"single":return Xn
default:return Zn}})),u=na(e,"activated",e.activated,(e=>r.value.in(e,l.value,o.value)),(e=>r.value.out(e,l.value,o.value))),c=na(e,"selected",e.selected,(e=>i.value.in(e,l.value,o.value)),(e=>i.value.out(e,l.value,o.value)))
...
return t.provide(ar,f),f.root},rr=(e,a)=>{const l=t.inject(ar,lr),o=Symbol("nested item"),n=t.computed((()=>t.toValue(e)??o)),r={...l,id:n,open:(e,t)=>l.root.open(n.value,e,t),openOnSelect:(e,t)=>l.root.openOnSelect(n.value,e,t),isOpen:t.computed((()=>l.root.opened.value.has(n.value))),parent:t.computed((()=>l.root.parents.value.get(n.value))),activate:(e,t)=>l.root.activate(n.value,e,t),isActivated:t.computed((()=>l.root.activated.value.has(t.toRaw(n.value)))),select:(e,t)=>l.root.select(n.value,e,t),isSelected:t.computed((()=>"on"===l.root.selected.value.get(t.toRaw(n.value)))),isIndeterminate:t.computed((()=>"indeterminate"===l.root.selected.value.get(t.toRaw(n.value)))),isLeaf:t.computed((()=>!l.root.children.value.get(n.value))),isGroupActivator:l.isGroupActivator}
return t.onBeforeMount((()=>{!l.isGroupActivator&&l.root.register(n.value,l.id.value,a)})),t.onBeforeUnmount((()=>{!l.isGroupActivator&&l.root.unregister(n.value)})),a&&t.provide(ar,r),r},ir=Nt({name:"VListGroupActivator",setup(e,a){let{slots:l}=a
return(()=>{const e=t.inject(ar,lr)
t.provide(ar,{...e,isGroupActivator:!0})})(),()=>l.default?.()}}),sr=ht({activeColor:String,baseColor:String,color:String,collapseIcon:{type:Ft,default:"$collapse"},expandIcon:{type:Ft,default:"$expand"},prependIcon:Ft,appendIcon:Ft,fluid:Boolean,subgroup:Boolean,title:String,value:null,...yt(),...Ba()},"VListGroup"),ur=Ct()({name:"VListGroup",props:sr(),setup(e,a){let{slots:l}=a
const{isOpen:o,open:n,id:r}=rr((()=>e.value),!0),i=t.computed((()=>`v-list-group--id-${String(r.value)}`)),s=Gn(),{isBooted:u}=_l()
...
return Et((()=>t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":s?.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":o.value},e.class],style:e.style},{default:()=>[l.activator&&t.createVNode(ol,{defaults:p.value},{default:()=>[t.createVNode(ir,null,{default:()=>[l.activator({props:d.value,isOpen:o.value})]})]}),t.createVNode(ml,{transition:{component:tl},disabled:!u.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items",role:"group","aria-labelledby":i.value},[l.default?.()]),[[t.vShow,o.value]])]})]}))),{isOpen:o}}}),cr=ht({opacity:[Number,String],...yt(),...Ba()},"VListItemSubtitle"),dr=Ct()({name:"VListItemSubtitle",props:cr(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),vr=It("v-list-item-title"),pr=ht({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Ft,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Ft,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},value:null,onClick:G(),onClickOnce:G(),...Vl(),...yt(),...Al(),...nl(),...Sl(),...vl(),...go(),...Ba(),...ba(),...Fl({variant:"text"})},"VListItem"),fr=Ct()({name:"VListItem",directives:{Ripple:Eo},props:pr(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const r=mo(e,l),i=t.computed((()=>void 0===e.value?r.href.value:e.value)),{activate:s,isActivated:u,select:c,isOpen:d,isSelected:v,isIndeterminate:p,isGroupActivator:f,root:m,parent:g,openOnSelect:h,id:y}=rr(i,!1),b=Gn(),V=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||(m.activatable.value?u.value:v.value)))),w=t.toRef((()=>!1!==e.link&&r.isLink.value)),S=t.computed((()=>!!b&&(m.selectable.value||m.activatable.value||null!=e.value))),k=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||S.value))),x=t.toRef((()=>e.rounded||e.nav)),N=t.toRef((()=>e.color??e.activeColor)),C=t.toRef((()=>({color:V.value?N.value??e.baseColor:e.baseColor,variant:e.variant})))
...
return o.default?t.createVNode("div",{class:["v-divider__wrapper",{"v-divider__wrapper--vertical":e.vertical,"v-divider__wrapper--inset":e.inset}]},[a,t.createVNode("div",{class:"v-divider__content"},[o.default()]),a]):a})),{}}}),br=ht({items:Array,returnObject:Boolean},"VListChildren"),Vr=Ct()({name:"VListChildren",props:br(),setup(e,a){let{slots:l}=a
return Yn(),()=>l.default?.()??e.items?.map((a=>{let{children:o,props:n,type:r,raw:i}=a
if("divider"===r)return l.divider?.({props:n})??t.createVNode(yr,n,null)
if("subheader"===r)return l.subheader?.({props:n})??t.createVNode(gr,n,null)
const s={subtitle:l.subtitle?e=>l.subtitle?.({...e,item:i}):void 0,prepend:l.prepend?e=>l.prepend?.({...e,item:i}):void 0,append:l.append?e=>l.append?.({...e,item:i}):void 0,title:l.title?e=>l.title?.({...e,item:i}):void 0},u=ur.filterProps(n)
return o?t.createVNode(ur,t.mergeProps({value:n?.value},u),{activator:a=>{let{props:o}=a
const r={...n,...o,value:e.returnObject?i:n.value}
return l.header?l.header({props:r}):t.createVNode(fr,r,s)},default:()=>t.createVNode(Vr,{items:o,returnObject:e.returnObject},l)}):l.item?l.item({props:n}):t.createVNode(fr,t.mergeProps(n,{value:e.returnObject?i:n.value}),s)}))}}),wr=ht({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean,valueComparator:Function},"list-items")
function Sr(e,t){const a=p(t,e.itemTitle,t),l=p(t,e.itemValue,a),o=p(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?N(t,["children"]):t:p(t,e.itemProps)}
return{title:String(n.title??""),value:n.value,props:n,children:Array.isArray(o)?kr(e,o):void 0,raw:t}}function kr(e,t){const a=k(e,["itemTitle","itemValue","itemChildren","itemProps","returnObject","valueComparator"]),l=[]
for(const e of t)l.push(Sr(a,e))
return l}function xr(e){const a=t.computed((()=>kr(e,e.items))),l=t.computed((()=>a.value.some((e=>null===e.value)))),o=t.shallowRef(new Map),n=t.shallowRef([])
...
if(c&&"string"==typeof e){m.push(Sr(f,e))
continue}const t=r.get(e)
if(!v&&t)m.push(...t)
else{for(const t of v?i:s)if(p(e,t.value)){m.push(t)
continue e}m.push(Sr(f,e))}}return m},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{value:t}=e
return t}))}}}function Nr(e,t){const a=p(t,e.itemType,"item"),l=ne(t)?t:p(t,e.itemTitle),o=p(t,e.itemValue,void 0),n=p(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?N(t,["children"]):p(t,e.itemProps)}
return{type:a,title:r.title,value:r.value,props:r,children:"item"===a&&n?Cr(e,n):void 0,raw:t}}function Cr(e,t){const a=[]
for(const l of t)a.push(Nr(e,l))
return a}const Ir=ht({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,expandIcon:Ft,collapseIcon:Ft,lines:{type:[Boolean,String],default:"one"},slim:Boolean,nav:Boolean,"onClick:open":G(),"onClick:select":G(),"onUpdate:opened":G(),...or({selectStrategy:"single-leaf",openStrategy:"list"}),...Vl(),...yt(),...Al(),...nl(),...Sl(),itemType:{type:String,default:"type"},...wr(),...vl(),...Ba(),...ba(),...Fl({variant:"text"})},"VList"),_r=Ct()({name:"VList",props:Ir(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:o}=function(e){return{items:t.computed((()=>Cr(e,e.items)))}}(e),{themeClasses:n}=Ca(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl((()=>e.bgColor)),{borderClasses:s}=wl(e),{densityClasses:u}=Tl(e),{dimensionStyles:c}=rl(e),{elevationClasses:d}=kl(e),{roundedClasses:v}=pl(e),{children:p,open:f,parents:m,select:g,getPath:h}=nr(e),y=t.toRef((()=>e.lines?`v-list--${e.lines}-line`:void 0)),b=t.toRef((()=>e.activeColor)),V=t.toRef((()=>e.baseColor)),w=t.toRef((()=>e.color))
Yn(),kt({VListGroup:{activeColor:b,baseColor:V,color:w,expandIcon:t.toRef((()=>e.expandIcon)),collapseIcon:t.toRef((()=>e.collapseIcon))},VListItem:{activeClass:t.toRef((()=>e.activeClass)),activeColor:b,baseColor:V,color:w,density:t.toRef((()=>e.density)),disabled:t.toRef((()=>e.disabled)),lines:t.toRef((()=>e.lines)),nav:t.toRef((()=>e.nav)),slim:t.toRef((()=>e.slim)),variant:t.toRef((()=>e.variant))}})
...
P("last")}e.preventDefault()}}function _(e){S.value=!0}function P(e){if(k.value)return Q(k.value,e)}return Et((()=>t.createVNode(e.tag,{ref:k,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},n.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:x,onFocusout:N,onFocus:C,onKeydown:I,onMousedown:_},{default:()=>[t.createVNode(Vr,{items:o.value,returnObject:e.returnObject},l)]}))),{open:f,select:g,focus:P,children:p,parents:m,getPath:h}}}),Pr=It("v-list-img"),Br=ht({start:Boolean,end:Boolean,...yt(),...Ba()},"VListItemAction"),Rr=Ct()({name:"VListItemAction",props:Br(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end},e.class],style:e.style},l))),{}}}),Ar=ht({start:Boolean,end:Boolean,...yt(),...Ba()},"VListItemMedia"),Tr=Ct()({name:"VListItemMedia",props:Ar(),setup(e,a){let{slots:l}=a
...
function Dr(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Er(e,t){if("top"===e.side||"bottom"===e.side){const{side:a,align:l}=e
...
return Dr({x:"left"===a?0:"right"===a?t.width:a,y:"top"===l?0:"center"===l?t.height/2:"bottom"===l?t.height:l},t)}return Dr({x:t.width/2,y:t.height/2},t)}const Fr={static:function(){},connected:function(e,a,l){(Array.isArray(e.target.value)||function(e){for(;e;){if("fixed"===window.getComputedStyle(e).position)return!0
...
return Object.assign(l.value,{"--v-overlay-anchor-origin":`${p.anchor.side} ${p.anchor.align}`,transformOrigin:`${p.origin.side} ${p.origin.align}`,top:m(Mr(y)),left:e.isRtl.value?void 0:m(Mr(g)),right:e.isRtl.value?m(Mr(-g)):void 0,minWidth:m("y"===S?Math.min(r.value,h.width):r.value),maxWidth:m(Or(A(b.x,r.value===1/0?0:r.value,s.value))),maxHeight:m(Or(A(b.y,i.value===1/0?0:i.value,u.value)))}),{available:b,contentBox:t,flipped:V}}return t.watch((()=>[o.value,n.value,a.offset,a.minWidth,a.minHeight,a.maxWidth,a.maxHeight]),(()=>y())),t.nextTick((()=>{const e=y()
if(!e)return
const{available:t,contentBox:a}=e
a.height>t.y&&requestAnimationFrame((()=>{y(),requestAnimationFrame((()=>{y()}))}))})),{updateLocation:y}}},$r=ht({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in Fr},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]},"VOverlay-location-strategies")
...
const zr=[]
let jr=-1
function Hr(){cancelAnimationFrame(jr),jr=requestAnimationFrame((()=>{const e=zr.shift()
e&&e(),zr.length?Hr():Lr=!0}))}const Wr={none:null,close:function(e){Yr(e.targetEl.value??e.contentEl.value,(function(t){e.isActive.value=!1}))},block:function(e,a){const l=e.root.value?.offsetParent,o=[...new Set([...At(e.targetEl.value,a.contained?l:void 0),...At(e.contentEl.value,a.contained?l:void 0)])].filter((e=>!e.classList.contains("v-overlay-scroll-blocked"))),n=window.innerWidth-document.documentElement.offsetWidth,r=(i=l||document.documentElement,Tt(i)&&i)
var i
...
o=l/(1e3/60)>2},!Lr||zr.length?(zr.push(a),Hr()):(Lr=!1,a(),Hr())}r=("undefined"==typeof requestIdleCallback?e=>e():requestIdleCallback)((()=>{l.run((()=>{Yr(e.targetEl.value??e.contentEl.value,(e=>{o?(cancelAnimationFrame(n),n=requestAnimationFrame((()=>{n=requestAnimationFrame((()=>{i(e)}))}))):i(e)}))}))})),t.onScopeDispose((()=>{"undefined"!=typeof cancelIdleCallback&&cancelIdleCallback(r),cancelAnimationFrame(n)}))}},Ur=ht({scrollStrategy:{type:[String,Function],default:"block",validator:e=>"function"==typeof e||e in Wr}},"VOverlay-scroll-strategies")
function Yr(e,a){const l=[document,...At(e)]
l.forEach((e=>{e.addEventListener("scroll",a,{passive:!0})})),t.onScopeDispose((()=>{l.forEach((e=>{e.removeEventListener("scroll",a)}))}))}const Gr=Symbol.for("vuetify:v-menu"),qr=ht({closeDelay:[Number,String],openDelay:[Number,String]},"delay")
function Kr(e,t){let l=()=>{}
function o(o){l?.()
...
return()=>window.clearTimeout(l)}(n,(()=>{t?.(o),e(o)}))}))}return{clearDelay:l,runOpenDelay:function(){return o(!0)},runCloseDelay:function(){return o(!1)}}}const Xr=ht({target:[String,Object],activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...qr()},"VOverlay-activator")
function Zr(e,l){let{isActive:o,isTop:n,contentEl:r}=l
const i=bt("useActivator"),s=t.ref()
let u=!1,c=!1,d=!0
const v=t.computed((()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover)),p=t.computed((()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!v.value)),{runOpenDelay:f,runCloseDelay:m}=Kr(e,(t=>{t!==(e.openOnHover&&u||v.value&&c)||e.openOnHover&&o.value&&!n.value||(o.value!==t&&(d=!0),o.value=t)})),g=t.ref(),h=e=>{e.stopPropagation(),s.value=e.currentTarget||e.target,o.value||(g.value=[e.clientX,e.clientY]),o.value=!o.value},y=e=>{e.sourceCapabilities?.firesTouchEvents||(u=!0,s.value=e.currentTarget||e.target,f())},b=e=>{u=!1,m()},V=e=>{!1!==te(e.target,":focus-visible")&&(c=!0,e.stopPropagation(),s.value=e.currentTarget||e.target,f())},w=e=>{c=!1,e.stopPropagation(),m()},S=t.computed((()=>{const t={}
...
if(e.openOnHover&&(a.onMouseenter=()=>{u=!0,f()},a.onMouseleave=()=>{u=!1,m()}),v.value&&(a.onFocusin=()=>{c=!0,f()},a.onFocusout=()=>{c=!1,m()}),e.closeOnContentClick){const e=t.inject(Gr,null)
...
const C=le(),_=t.computed((()=>"cursor"===e.target&&g.value?g.value:C.value?C.el:Qr(e.target,i)||s.value)),P=t.computed((()=>Array.isArray(_.value)?void 0:_.value))
let B
...
return a}function Jr(){if(!a)return t.shallowRef(!1)
const{ssr:e}=In()
if(e){const e=t.shallowRef(!1)
return t.onMounted((()=>{e.value=!0})),e}return t.shallowRef(!0)}const ei=ht({eager:Boolean},"lazy")
function ti(e,a){const l=t.shallowRef(!1),o=t.toRef((()=>l.value||e.eager||a.value))
return t.watch(a,(()=>l.value=!0)),{isBooted:l,hasContent:o,onAfterLeave:function(){e.eager||(l.value=!1)}}}function ai(){const e=bt("useScopeId").vnode.scopeId
return{scopeId:e?{[e]:""}:void 0}}const li=Symbol.for("vuetify:stack"),oi=t.reactive([])
function ni(){return!0}function ri(e,t,a){if(!e||!1===ii(e,a))return!1
const l=_t(t)
if("undefined"!=typeof ShadowRoot&&l instanceof ShadowRoot&&l.host===e.target)return!1
const o=("object"==typeof a.value&&a.value.include||(()=>[]))()
return o.push(t),!o.some((t=>t?.contains(e.target)))}function ii(e,t){return("object"==typeof t.value&&t.value.closeConditional||ni)(e)}function si(e,t){const a=_t(e)
t(document),"undefined"!=typeof ShadowRoot&&a instanceof ShadowRoot&&t(a)}const ui={mounted(e,t){const a=a=>function(e,t,a){const l="function"==typeof a.value?a.value:a.value.handler
e.shadowTarget=e.target,t._clickOutside.lastMousedownWasOutside&&ri(e,t,a)&&setTimeout((()=>{ii(e,a)&&l&&l(e)}),0)}(a,e,t),l=a=>{e._clickOutside.lastMousedownWasOutside=ri(a,e,t)}
...
function ci(e){const{modelValue:a,color:l,...o}=e
return t.createVNode(t.Transition,{name:"fade-transition",appear:!0},{default:()=>[e.modelValue&&t.createVNode("div",t.mergeProps({class:["v-overlay__scrim",e.color.backgroundColorClasses.value],style:e.color.backgroundColorStyles.value},o),null)]})}const di=ht({absolute:Boolean,attach:[Boolean,String,Object],closeOnBack:{type:Boolean,default:!0},contained:Boolean,contentClass:null,contentProps:null,disabled:Boolean,opacity:[Number,String],noClickAnimation:Boolean,modelValue:Boolean,persistent:Boolean,scrim:{type:[Boolean,String],default:!0},zIndex:{type:[Number,String],default:2e3},...Xr(),...yt(),...nl(),...ei(),...$r(),...Ur(),...ba(),...fl()},"VOverlay"),vi=Ct()({name:"VOverlay",directives:{ClickOutside:ui},inheritAttrs:!1,props:{_disableGlobalStack:Boolean,...di()},emits:{"click:outside":e=>!0,"update:modelValue":e=>!0,keydown:e=>!0,afterEnter:()=>!0,afterLeave:()=>!0},setup(e,l){let{slots:o,attrs:n,emit:r}=l
const i=bt("VOverlay"),s=t.ref(),u=t.ref(),c=t.ref(),d=na(e,"modelValue"),v=t.computed({get:()=>d.value,set:t=>{t&&e.disabled||(d.value=t)}}),{themeClasses:p}=Ca(e),{rtlClasses:f,isRtl:g}=ha(),{hasContent:h,onAfterLeave:y}=ti(e,v),b=dl((()=>"string"==typeof e.scrim?e.scrim:null)),{globalTop:V,localTop:w,stackStyles:S}=function(e,a,l){const o=bt("useStack"),n=!l,r=t.inject(li,void 0),i=t.reactive({activeChildren:new Set})
t.provide(li,i)
const s=t.shallowRef(Number(t.toValue(a)))
oa(e,(()=>{const e=oi.at(-1)?.[1]
s.value=e?e+10:Number(t.toValue(a)),n&&oi.push([o.uid,s.value]),r?.activeChildren.add(o.uid),t.onScopeDispose((()=>{if(n){const e=t.toRaw(oi).findIndex((e=>e[0]===o.uid))
oi.splice(e,1)}r?.activeChildren.delete(o.uid)}))}))
const u=t.shallowRef(!0)
n&&t.watchEffect((()=>{const e=oi.at(-1)?.[0]===o.uid
setTimeout((()=>u.value=e))}))
const c=t.toRef((()=>!i.activeChildren.size))
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.toRef((()=>({zIndex:s.value})))}}(v,(()=>e.zIndex),e._disableGlobalStack),{activatorEl:k,activatorRef:x,target:N,targetEl:C,targetRef:I,activatorEvents:_,contentEvents:P,scrimEvents:B}=Zr(e,{isActive:v,isTop:w,contentEl:c}),{teleportTarget:R}=function(e){return{teleportTarget:t.computed((()=>{const l=e()
if(!0===l||!a)return
...
if(a)return a}for(const e of a){const a=e.value&&e.value[pi]
if(!a)continue
const l=a.slice()
for(;l.length;){const e=l.shift(),a=fi(e.value,t)
if(a)return a
const o=e.value&&e.value[pi]
o&&l.push(...o)}}}}})}const gi=ht({id:String,submenu:Boolean,...N(di({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",location:void 0,openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:Oa}}),["absolute"])},"VMenu"),hi=Ct()({name:"VMenu",props:gi(),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
const n=na(e,"modelValue"),{scopeId:r}=ai(),{isRtl:i}=ha(),s=t.useId(),u=t.toRef((()=>e.id||`v-menu-${s}`)),c=t.ref(),d=t.inject(Gr,null),v=t.shallowRef(new Set)
...
return Et((()=>{const a=vi.filterProps(e)
return t.createVNode(vi,t.mergeProps({ref:c,id:u.value,class:["v-menu",e.class],style:e.style},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,absolute:!0,activatorProps:h.value,location:e.location??(e.submenu?"end":"bottom"),"onClick:outside":f,onKeydown:m},r),{activator:o.activator,default:function(){for(var e=arguments.length,a=new Array(e),l=0;l<e;l++)a[l]=arguments[l]
return t.createVNode(ol,{root:"VMenu"},{default:()=>[o.default?.(...a)]})}})})),mi({id:u,ΨopenChildren:v},c)}}),yi=ht({active:Boolean,disabled:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...yt(),...fl({transition:{component:Ja}})},"VCounter"),bi=Ct()({name:"VCounter",functional:!0,props:yi(),setup(e,a){let{slots:l}=a
const o=t.toRef((()=>e.max?`${e.value} / ${e.max}`:String(e.value)))
return Et((()=>t.createVNode(ml,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-counter",{"text-error":e.max&&!e.disabled&&parseFloat(e.value)>parseFloat(e.max)},e.class],style:e.style},[l.default?l.default({counter:o.value,max:e.max,value:e.value}):o.value]),[[t.vShow,e.active]])]}))),{}}}),Vi=ht({floating:Boolean,...yt()},"VFieldLabel"),wi=Ct()({name:"VFieldLabel",props:Vi(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode(qo,{class:["v-field-label",{"v-field-label--floating":e.floating},e.class],style:e.style,"aria-hidden":e.floating||void 0},l))),{}}}),Si=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],ki=ht({appendInnerIcon:Ft,bgColor:String,clearable:Boolean,clearIcon:{type:Ft,default:"$clear"},active:Boolean,centerAffix:{type:Boolean,default:void 0},color:String,baseColor:String,dirty:Boolean,disabled:{type:Boolean,default:null},glow:Boolean,error:Boolean,flat:Boolean,iconColor:[Boolean,String],label:String,persistentClear:Boolean,prependInnerIcon:Ft,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Si.includes(e)},"onClick:clear":G(),"onClick:appendInner":G(),"onClick:prependInner":G(),...yt(),...io(),...vl(),...ba()},"VField"),xi=Ct()({name:"VField",inheritAttrs:!1,props:{id:String,...rn(),...ki()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return t.createVNode("div",t.mergeProps({class:["v-field",{"v-field--active":g.value,"v-field--appended":m,"v-field--center-affix":e.centerAffix??!N.value,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--glow":e.glow,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":o,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!b(),[`v-field--variant-${e.variant}`]:!0},r.value,_.value,s.value,i.value,p.value,f.value,e.class],style:[P.value,e.style],onClick:T},l),[t.createVNode("div",{class:"v-field__overlay"},null),t.createVNode(uo,{name:"v-field",active:!!e.loading,color:e.error?"error":"string"==typeof e.loading?e.loading:e.color},{default:n.loader}),o&&t.createVNode("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&t.createVNode(v,{key:"prepend-icon",name:"prependInner",color:I.value},null),n["prepend-inner"]?.(A.value)]),t.createVNode("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&y.value&&t.createVNode(wi,{key:"floating-label",ref:k,class:[B.value],floating:!0,for:V.value,style:R.value},{default:()=>[b()]}),h.value&&t.createVNode(wi,{key:"label",ref:S,for:V.value},{default:()=>[b()]}),n.default?.({...A.value,props:{id:V.value,class:"v-field__input","aria-describedby":w.value},focus:c,blur:d})??t.createVNode("div",{id:V.value,class:"v-field__input","aria-describedby":w.value},null)]),u&&t.createVNode(al,{key:"clear"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-field__clearable",onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},[t.createVNode(ol,{defaults:{VIcon:{icon:e.clearIcon}}},{default:()=>[n.clear?n.clear({...A.value,props:{onFocus:c,onBlur:d,onClick:e["onClick:clear"]}}):t.createVNode(v,{name:"clear",onFocus:c,onBlur:d},null)]})]),[[t.vShow,e.dirty]])]}),m&&t.createVNode("div",{key:"append",class:"v-field__append-inner"},[n["append-inner"]?.(A.value),e.appendInnerIcon&&t.createVNode(v,{key:"append-icon",name:"appendInner",color:I.value},null)]),t.createVNode("div",{class:["v-field__outline",B.value],style:R.value},[a&&t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-field__outline__start"},null),y.value&&t.createVNode("div",{class:"v-field__outline__notch"},[t.createVNode(wi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})]),t.createVNode("div",{class:"v-field__outline__end"},null)]),N.value&&y.value&&t.createVNode(wi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})])])})),{controlRef:x,fieldIconColor:I}}}),Ni=["color","file","time","date","datetime-local","week","month"],Ci=ht({autofocus:Boolean,counter:[Boolean,Number,String],counterValue:[Number,Function],prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,suffix:String,role:String,type:{type:String,default:"text"},modelModifiers:Object,...mn(),...ki()},"VTextField"),Ii=Ct()({name:"VTextField",directives:{Intersect:hl},inheritAttrs:!1,props:Ci(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
function p(t,a){e.autofocus&&t&&a[0].target?.focus?.()}const f=t.ref(),m=t.ref(),g=t.ref(),h=t.computed((()=>Ni.includes(e.type)||e.persistentPlaceholder||i.value||e.active))
...
t.nextTick((()=>{l.selectionStart=e[0],l.selectionEnd=e[1]}))}}return Et((()=>{const a=!!(n.counter||!1!==e.counter&&null!=e.counter),o=!(!a&&!n.details),[s,S]=B(l),{modelValue:k,...x}=gn.filterProps(e),N=xi.filterProps(e)
return t.createVNode(gn,t.mergeProps({ref:f,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-input--plain-underlined":v.value},e.class],style:e.style},s,x,{centerAffix:!v.value,focused:i.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:s,isReadonly:c,isValid:d,reset:v}=a
return t.createVNode(xi,t.mergeProps({ref:m,onMousedown:b,onClick:V,"onClick:clear":a=>function(a,l){a.stopPropagation(),y(),t.nextTick((()=>{r.value=null,l(),K(e["onClick:clear"],a)}))}(a,v),"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"],role:e.role},N,{id:l.value,active:h.value||s.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===d.value}),{...n,default:a=>{let{props:{class:l,...i}}=a
...
return t.createVNode(t.Fragment,null,[e.prefix&&t.createVNode("span",{class:"v-text-field__prefix"},[t.createVNode("span",{class:"v-text-field__prefix__text"},[e.prefix])]),n.default?t.createVNode("div",{class:l,"data-no-activator":""},[n.default(),s]):t.cloneVNode(s,{class:l}),e.suffix&&t.createVNode("span",{class:"v-text-field__suffix"},[t.createVNode("span",{class:"v-text-field__suffix__text"},[e.suffix])])])}})},details:o?l=>t.createVNode(t.Fragment,null,[n.details?.(l),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(bi,{active:e.persistentCounter||i.value,value:c.value,max:d.value,disabled:e.disabled},n.counter)])]):void 0})})),mi({},f,m,g)}}),_i=ht({renderless:Boolean,...yt()},"VVirtualScrollItem"),Pi=Ct()({name:"VVirtualScrollItem",inheritAttrs:!1,props:_i(),emits:{"update:height":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{resizeRef:r,contentRect:i}=Xt(void 0,"border")
t.watch((()=>i.value?.height),(e=>{null!=e&&o("update:height",e)})),Et((()=>e.renderless?t.createVNode(t.Fragment,null,[n.default?.({itemRef:r})]):t.createVNode("div",t.mergeProps({ref:r,class:["v-virtual-scroll__item",e.class],style:e.style},l),[n.default?.()])))}}),Bi=ht({itemHeight:{type:[Number,String],default:null},itemKey:{type:[String,Array,Function],default:null},height:[Number,String]},"virtual")
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Ai=ht({items:{type:Array,default:()=>[]},renderless:Boolean,...Bi(),...yt(),...nl()},"VVirtualScroll"),Ti=Ct()({name:"VVirtualScroll",props:Ai(),setup(e,a){let{slots:l}=a
const o=bt("VVirtualScroll"),{dimensionStyles:n}=rl(e),{calculateVisibleItems:r,containerRef:i,markerRef:s,handleScroll:u,handleScrollend:c,handleItemResize:d,scrollToIndex:v,paddingTop:p,paddingBottom:f,computedItems:g}=Ri(e,t.toRef((()=>e.items)))
...
i.value===document.documentElement?(document[e]("scroll",u,{passive:!0}),document[e]("scrollend",c)):(i.value?.[e]("scroll",u,{passive:!0}),i.value?.[e]("scrollend",c))}t.onMounted((()=>{i.value=Rt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),Et((()=>{const a=g.value.map((a=>t.createVNode(Pi,{key:a.key,renderless:e.renderless,"onUpdate:height":e=>d(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
break}}}}}const Ei=ht({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Ft,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...wr({itemChildren:!1})},"Select"),Fi=ht({...Ei(),...N(Ci({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...fl({transition:{component:Oa}})},"VSelect"),$i=Ct()({name:"VSelect",props:Fi(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ma(),r=t.ref(),i=t.ref(),s=t.ref(),{items:u,transformIn:c,transformOut:v}=xr(e),p=na(e,"modelValue",[],(e=>c(null===e?[null]:R(e))),(t=>{const a=v(t)
...
return t.createVNode(Ii,t.mergeProps({ref:r},c,{modelValue:p.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":M,focused:h.value,"onUpdate:focused":e=>h.value=e,validationValue:p.externalValue,counterValue:f.value,dirty:u,class:["v-select",{"v-select--active-menu":k.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":p.value.length,"v-select--selection-slot":!!o.selection},e.class],style:e.style,inputmode:"none",placeholder:d,"onClick:clear":_,"onMousedown:control":P,onBlur:D,onKeydown:A,"aria-label":n(x.value),title:n(x.value)}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(hi,t.mergeProps({ref:i,modelValue:k.value,"onUpdate:modelValue":e=>k.value=e,activator:"parent",contentClass:"v-select__content",disabled:w.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:E,onAfterLeave:F},N.value),{default:()=>[l&&t.createVNode(_r,t.mergeProps({ref:C,selected:g.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:B,onFocusin:$,tabindex:"-1","aria-live":"polite","aria-label":`${e.label}-list`,color:e.itemColor??e.color},I,e.listProps),{default:()=>[o["prepend-item"]?.(),!V.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(fr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Ti,{ref:s,renderless:!0,items:V.value,itemKey:"value"},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
if(!s||u)return t.createVNode("div",{key:l.value,class:"v-select__selection"},[a?o.chip?t.createVNode(ol,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[u]}):t.createVNode(Wn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title,disabled:l.props.disabled},i),null):u??t.createVNode("span",{class:"v-select__selection-text"},[l.title,e.multiple&&n<p.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),n=0;n<a;n++)l[n]=arguments[n]
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Ql,{class:"v-select__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon},null):void 0])}})})),mi({isFocused:h,menu:k,select:T},r)}}),Mi=(e,t,a)=>{if(null==e||null==t)return-1
...
return l.length?l:-1}
function Oi(e,t){if(null!=e&&"boolean"!=typeof e&&-1!==e)return"number"==typeof e?[[e,e+t.length]]:Array.isArray(e[0])?e:[e]}const Li=ht({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
...
return t.watchEffect((()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],o=a?.default??Mi,n=!!a?.filterKeys&&R(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
const l=d[t]
v.push(l),f.set(l.value,a)})),n.value=v,r.value=f})),{filteredItems:n,filteredMatches:r,getMatches:function(e){return r.value.get(e.value)}}}function ji(e,a,l){return null!=l&&l.length?l.map(((o,n)=>{const r=0===n?0:l[n-1][1],i=[t.createVNode("span",{class:`${e}__unmask`},[a.slice(r,o[0])]),t.createVNode("span",{class:`${e}__mask`},[a.slice(o[0],o[1])])]
return n===l.length-1&&i.push(t.createVNode("span",{class:`${e}__unmask`},[a.slice(o[1])])),t.createVNode(t.Fragment,null,[i])})):a}const Hi=ht({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:Boolean,search:String,...Li({filterKeys:["title"]}),...Ei(),...N(Ci({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...fl({transition:!1})},"VAutocomplete"),Wi=Ct()({name:"VAutocomplete",props:Hi(),emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ma(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),c=t.ref(),v=t.ref(),p=t.shallowRef(-1),{items:f,transformIn:m,transformOut:g}=xr(e),{textColorClasses:h,textColorStyles:y}=cl((()=>r.value?.color)),b=na(e,"search",""),V=na(e,"modelValue",[],(e=>m(null===e?[null]:R(e))),(t=>{const a=g(t)
return e.multiple?a:a[0]??null})),w=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:V.value.length)),S=dn(e),{filteredItems:k,getMatches:x}=zi(e,f,(()=>s.value?"":b.value)),N=t.computed((()=>e.hideSelected?k.value.filter((e=>!V.value.some((t=>t.value===e.value)))):k.value)),C=t.computed((()=>!(!e.chips&&!o.chip))),I=t.computed((()=>C.value||!!o.selection)),_=t.computed((()=>V.value.map((e=>e.props.value)))),P=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&b.value===N.value[0]?.title)&&N.value.length>0&&!s.value&&!u.value)),B=t.computed((()=>e.hideNoData&&!N.value.length||S.isReadonly.value||S.isDisabled.value)),A=na(e,"menu"),T=t.computed({get:()=>A.value,set:e=>{A.value&&!e&&c.value?.ΨopenChildren.size||e&&B.value||(A.value=e)}}),D=t.computed((()=>T.value?e.closeText:e.openText)),E=t.ref(),F=Di(E,r)
...
a&&window.requestAnimationFrame((()=>{e>=0&&v.value?.scrollToIndex(e)}))}})),t.watch((()=>e.items),((e,t)=>{T.value||i.value&&!t.length&&e.length&&(T.value=!0)})),Et((()=>{const a=!!(!e.hideNoData||N.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),l=V.value.length>0,u=Ii.filterProps(e)
return t.createVNode(Ii,t.mergeProps({ref:r},u,{modelValue:b.value,"onUpdate:modelValue":[e=>b.value=e,G],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:V.externalValue,counterValue:w.value,dirty:l,onChange:j,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":T.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!I.value,"v-autocomplete--selecting-index":p.value>-1},e.class],style:e.style,readonly:S.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":$,"onMousedown:control":M,onKeydown:z}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(hi,t.mergeProps({ref:c,modelValue:T.value,"onUpdate:modelValue":e=>T.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:B.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:H,onAfterLeave:W},e.menuProps),{default:()=>[a&&t.createVNode(_r,t.mergeProps({ref:E,selected:_.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:L,onFocusin:U,onFocusout:Y,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},F,e.listProps),{default:()=>[o["prepend-item"]?.(),!N.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(fr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Ti,{ref:v,renderless:!0,items:N.value,itemKey:"value"},{default:a=>{let{item:l,index:n,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!P.value||0!==n)||void 0,onClick:()=>K(l,null)})
return o.item?.({item:l,index:n,props:i})??t.createVNode(fr,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:o}=a
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(an,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Yo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Ql,{icon:l.props.prependIcon},null)])},title:()=>s.value?l.title:ji("v-autocomplete",l.title,x(l)?.title)})}}),o["append-item"]?.()]})]}),V.value.map(((a,l)=>{function n(e){e.stopPropagation(),e.preventDefault(),K(a,!1)}const r={"onClick:close":n,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),n(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=C.value?!!o.chip:!!o.selection,s=i?ae(C.value?o.chip({item:a,index:l,props:r}):o.selection({item:a,index:l})):void 0
if(!i||s)return t.createVNode("div",{key:a.value,class:["v-autocomplete__selection",l===p.value&&["v-autocomplete__selection--selected",h.value]],style:l===p.value?y.value:{}},[C.value?o.chip?t.createVNode(ol,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(Wn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createVNode("span",{class:"v-autocomplete__selection-text"},[a.title,e.multiple&&l<V.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),i=0;i<a;i++)l[i]=arguments[i]
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Ql,{class:"v-autocomplete__menu-icon",color:r.value?.fieldIconColor,icon:e.menuIcon,onMousedown:O,onClick:ee,"aria-label":n(D.value),title:n(D.value),tabindex:"-1"},null):void 0])}})})),mi({isFocused:i,isPristine:s,menu:T,search:b,filteredItems:k,select:K},r)}}),Ui=ht({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Ft,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...yt(),...lo({location:"top end"}),...vl(),...Ba(),...ba(),...fl({transition:"scale-rotate-transition"})},"VBadge"),Yi=Ct()({name:"VBadge",inheritAttrs:!1,props:Ui(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=dl((()=>e.color)),{roundedClasses:n}=pl(e),{t:r}=ma(),{textColorClasses:i,textColorStyles:s}=cl((()=>e.textColor)),{themeClasses:u}=Ia(),{locationStyles:c}=oo(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?Number(e.offsetY??0):["left","right"].includes(t)?Number(e.offsetX??0):0)))
...
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline},e.class]},f,{style:e.style}),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[a.slots.default?.(),t.createVNode(ml,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,l.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,d),"aria-live":"polite",role:"status"},p),[e.dot?void 0:a.slots.badge?a.slots.badge?.():e.icon?t.createVNode(Ql,{icon:e.icon},null):v]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),Gi=ht({color:String,density:String,...yt()},"VBannerActions"),qi=Ct()({name:"VBannerActions",props:Gi(),setup(e,a){let{slots:l}=a
return kt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),Et((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Ki=It("v-banner-text"),Xi=ht({avatar:String,bgColor:String,color:String,icon:Ft,lines:String,stacked:Boolean,sticky:Boolean,text:String,...Vl(),...yt(),...Al(),...nl(),...Cn({mobile:null}),...Sl(),...lo(),...vo(),...vl(),...Ba(),...ba()},"VBanner"),Zi=Ct()({name:"VBanner",props:Xi(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl((()=>e.bgColor)),{borderClasses:r}=wl(e),{densityClasses:i}=Tl(e),{displayClasses:s,mobile:u}=In(e),{dimensionStyles:c}=rl(e),{elevationClasses:d}=kl(e),{locationStyles:v}=oo(e),{positionClasses:p}=po(e),{roundedClasses:f}=pl(e),{themeClasses:m}=Ca(e),g=t.toRef((()=>e.color)),h=t.toRef((()=>e.density))
kt({VBannerActions:{color:g,density:h}}),Et((()=>{const a=!(!e.text&&!l.text),y=!(!e.avatar&&!e.icon),b=!(!y&&!l.prepend)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||u.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},m.value,o.value,r.value,i.value,s.value,d.value,p.value,f.value,e.class],style:[n.value,c.value,v.value,e.style],role:"banner"},{default:()=>[b&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode(ol,{key:"prepend-defaults",disabled:!y,defaults:{VAvatar:{color:g.value,density:h.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(Yo,{key:"prepend-avatar",color:g.value,density:h.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(Ki,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(qi,{key:"actions"},l.actions)]})}))}}),Qi=ht({baseColor:String,bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...Vl(),...yt(),...Al(),...Sl(),...vl(),...ea({name:"bottom-navigation"}),...Ba({tag:"header"}),...Ll({selectedClass:"v-btn--selected"}),...ba()},"VBottomNavigation"),Ji=Ct()({name:"VBottomNavigation",props:Qi(),emits:{"update:active":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return Hl(e,Ul),kt({VBtn:{baseColor:t.toRef((()=>e.baseColor)),color:t.toRef((()=>e.color)),density:t.toRef((()=>e.density)),stacked:t.toRef((()=>"horizontal"!==e.mode)),variant:"text"}},{scoped:!0}),Et((()=>t.createVNode(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":p.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":"shift"===e.mode},o.value,r.value,n.value,s.value,u.value,c.value,e.class],style:[i.value,f.value,{height:m(v.value)},d.value,e.style]},{default:()=>[l.default&&t.createVNode("div",{class:"v-bottom-navigation__content"},[l.default()])]}))),{}}}),es=ht({fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...di({origin:"center center",scrollStrategy:"block",transition:{component:Oa},zIndex:2400})},"VDialog"),ts=Ct()({name:"VDialog",props:es(),emits:{"update:modelValue":e=>!0,afterEnter:()=>!0,afterLeave:()=>!0},setup(e,l){let{emit:o,slots:n}=l
const r=na(e,"modelValue"),{scopeId:i}=ai(),s=t.ref()
...
t===a?l.focus():a.focus()}}function c(){o("afterEnter"),(e.scrim||e.retainFocus)&&s.value?.contentEl&&!s.value.contentEl.contains(document.activeElement)&&s.value.contentEl.focus({preventScroll:!0})}function d(){o("afterLeave")}return t.onBeforeUnmount((()=>{document.removeEventListener("focusin",u)})),a&&t.watch((()=>r.value&&e.retainFocus),(e=>{e?document.addEventListener("focusin",u):document.removeEventListener("focusin",u)}),{immediate:!0}),t.watch(r,(async e=>{e||(await t.nextTick(),s.value.activatorEl?.focus({preventScroll:!0}))})),Et((()=>{const a=vi.filterProps(e),l=t.mergeProps({"aria-haspopup":"dialog"},e.activatorProps),o=t.mergeProps({tabindex:-1},e.contentProps)
return t.createVNode(vi,t.mergeProps({ref:s,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable},e.class],style:e.style},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,"aria-modal":"true",activatorProps:l,contentProps:o,height:e.fullscreen?void 0:e.height,width:e.fullscreen?void 0:e.width,maxHeight:e.fullscreen?void 0:e.maxHeight,maxWidth:e.fullscreen?void 0:e.maxWidth,role:"dialog",onAfterEnter:c,onAfterLeave:d},i),{activator:n.activator,default:function(){for(var e=arguments.length,a=new Array(e),l=0;l<e;l++)a[l]=arguments[l]
return t.createVNode(ol,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})})),mi({},s)}}),as=ht({inset:Boolean,...es({transition:"bottom-sheet-transition"})},"VBottomSheet"),ls=Ct()({name:"VBottomSheet",props:as(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue")
return Et((()=>{const a=ts.filterProps(e)
return t.createVNode(ts,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)})),{}}}),os=ht({divider:[Number,String],...yt()},"VBreadcrumbsDivider"),ns=Ct()({name:"VBreadcrumbsDivider",props:os(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),rs=ht({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...yt(),...go(),...Ba({tag:"li"})},"VBreadcrumbsItem"),is=Ct()({name:"VBreadcrumbsItem",props:rs(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(is,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(ns,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),cs=Ct()({name:"VCardActions",props:yt(),setup(e,a){let{slots:l}=a
return kt({VBtn:{slim:!0,variant:"text"}}),Et((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),ds=ht({opacity:[Number,String],...yt(),...Ba()},"VCardSubtitle"),vs=Ct()({name:"VCardSubtitle",props:ds(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),ps=It("v-card-title"),fs=ht({appendAvatar:String,appendIcon:Ft,prependAvatar:String,prependIcon:Ft,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...yt(),...Al()},"VCardItem"),ms=Ct()({name:"VCardItem",props:fs(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(ol,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Yo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Ql,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(ps,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(vs,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(ol,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ql,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Yo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),gs=ht({opacity:[Number,String],...yt(),...Ba()},"VCardText"),hs=Ct()({name:"VCardText",props:gs(),setup(e,a){let{slots:l}=a
return Et((()=>t.createVNode(e.tag,{class:["v-card-text",e.class],style:[{"--v-card-text-opacity":e.opacity},e.style]},l))),{}}}),ys=ht({appendAvatar:String,appendIcon:Ft,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Ft,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...Vl(),...yt(),...Al(),...nl(),...Sl(),...io(),...lo(),...vo(),...vl(),...go(),...Ba(),...ba(),...Fl({variant:"elevated"})},"VCard"),bs=Ct()({name:"VCard",directives:{Ripple:Eo},props:ys(),setup(e,a){let{attrs:l,slots:o}=a
...
function ws(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
t.touchendX=a.clientX,t.touchendY=a.clientY,t.end?.({originalEvent:e,...t}),Vs(t)}(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
t.touchmoveX=a.clientX,t.touchmoveY=a.clientY,t.move?.({originalEvent:e,...t})}(e,t)}}const Ss={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,o=a?.options??{passive:!0},n=t.instance?.$.uid
if(!l||!n)return
const r=ws(t.value)
...
w(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},ks=Symbol.for("vuetify:v-window"),xs=Symbol.for("vuetify:v-window-group"),Ns=ht({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},...yt(),...Ba(),...ba()},"VWindow"),Cs=Ct()({name:"VWindow",directives:{Touch:Ss},props:Ns(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=Ca(e),{isRtl:n}=ha(),{t:r}=ma(),i=Hl(e,xs),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
t.watch(f,((e,t)=>{const a=i.items.value.length,l=a-1
c.value=a<=2?e<t:e===l&&0===t||(0!==e||t!==l)&&e<t})),t.provide(ks,{transition:d,isReversed:c,transitionCount:v,transitionHeight:p,rootRef:s})
...
return Et((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value,e.class],style:e.style},{default:()=>[t.createVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[t.resolveDirective("touch"),V.value]]))),{group:i}}}),Is=ht({color:String,cycle:Boolean,delimiterIcon:{type:Ft,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...Ns({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),_s=Ct()({name:"VCarousel",props:Is(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue"),{t:n}=ma(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,Number(e.interval)>0?Number(e.interval):6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),Et((()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({ref:r},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-carousel",{"v-carousel--hide-delimiter-background":e.hideDelimiterBackground,"v-carousel--vertical-delimiters":e.verticalDelimiters},e.class],style:[{height:m(e.height)},e.style]}),{default:l.default,additional:a=>{let{group:r}=a
...
return l.item?l.item({props:o,item:e}):t.createVNode($o,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(ro,{class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})})),{}}}),Ps=ht({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...yt(),...zl(),...ei()},"VWindowItem"),Bs=Ct()({name:"VWindowItem",directives:{Touch:Ss},props:Ps(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(ks),n=jl(e,xs),{isBooted:r}=_l()
...
return!!s.value&&{name:"string"!=typeof t?o.transition.value:t,onBeforeEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:c,onAfterLeave:u,onLeaveCancelled:d,onEnter:v}})),{hasContent:f}=ti(e,n.isSelected)
return Et((()=>t.createVNode(ml,{transition:p.value,disabled:!r.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value,e.class],style:e.style},[f.value&&l.default?.()]),[[t.vShow,n.isSelected.value]])]}))),{groupItem:n}}}),Rs=ht({...yl(),...Ps()},"VCarouselItem"),As=Ct()({name:"VCarouselItem",inheritAttrs:!1,props:Rs(),setup(e,a){let{slots:l,attrs:o}=a
Et((()=>{const a=bl.filterProps(e),n=Bs.filterProps(e)
return t.createVNode(Bs,t.mergeProps({class:["v-carousel-item",e.class]},n),{default:()=>[t.createVNode(bl,t.mergeProps(o,a),l)]})}))}}),Ts=It("v-code","code"),Ds=Nt({name:"VColorPickerCanvas",props:ht({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...yt()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
const Es={h:0,s:0,v:0,a:1},Fs={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:tt,from:lt},$s={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:ot,from:nt},Ms={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:dt,from:function(e){return lt(ct(e))}},Os={rgb:{...Fs,inputs:Fs.inputs?.slice(0,3)},rgba:Fs,hsl:{...$s,inputs:$s.inputs.slice(0,3)},hsla:$s,hex:{...Ms,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:Ms},Ls=e=>{let{label:a,...l}=e
return t.createVNode("div",{class:"v-color-picker-edit__input"},[t.createVNode("input",l,null),t.createVNode("span",null,[a])])},zs=Nt({name:"VColorPickerEdit",props:ht({color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Os).includes(e)},modes:{type:Array,default:()=>Object.keys(Os),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys(Os).includes(e)))},...yt()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
...
o&&l("update:color",t.from(r(a??t.to(Es),o.value)))}}}))}))
return Et((()=>t.createVNode("div",{class:["v-color-picker-edit",e.class],style:e.style},[n.value?.map((e=>t.createVNode(Ls,e,null))),o.value.length>1&&t.createVNode($o,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)]))),{}}}),js=Symbol.for("vuetify:v-slider")
function Hs(e,t,a){const l="vertical"===a,o=t.getBoundingClientRect(),n="touches"in e?e.touches[0]:e
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const Ws=ht({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...vl(),...Sl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),Us=e=>{const a=t.computed((()=>parseFloat(e.min))),l=t.computed((()=>parseFloat(e.max))),o=t.computed((()=>Number(e.step)>0?parseFloat(e.step):0)),n=t.computed((()=>Math.max(T(o.value),T(a.value))))
...
return parseFloat(Math.min(i,l.value).toFixed(n.value))}}},Ys=e=>{let{props:a,steps:l,onSliderStart:o,onSliderMove:n,onSliderEnd:r,getActiveThumb:i}=e
...
P.value=i(e),P.value&&(C.value=!0,P.value.contains(e.target)?I.value=Hs(e,P.value,a.direction):(I.value=0,null!=l&&n({value:l})),null!=l&&o({value:l}),t.nextTick((()=>P.value?.focus())))},D={passive:!0,capture:!0}
...
return t.provide(js,j),j},Gs=ht({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,...yt()},"VSliderThumb"),qs=Ct()({name:"VSliderThumb",directives:{Ripple:Eo},props:Gs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(js),{isRtl:r,rtlClasses:i}=ha()
...
return Et((()=>{const a=gn.filterProps(e),o=!!(e.label||l.label||l.prepend)
return t.createVNode(gn,t.mergeProps({class:["v-slider",{"v-slider--has-labels":!!l["tick-label"]||h.value,"v-slider--focused":b.value,"v-slider--pressed":d.value,"v-slider--disabled":e.disabled},r.value,e.class],style:e.style},a,{focused:b.value}),{...l,prepend:o?a=>t.createVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(qo,{id:a.id.value,class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:o,messagesId:r}=a
return t.createVNode("div",{class:"v-slider__container",onMousedown:y.value?void 0:p,onTouchstartPassive:y.value?void 0:f},[t.createVNode("input",{id:o.value,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:s.value},null),t.createVNode(Xs,{ref:m,start:0,stop:S.value},{"tick-label":l["tick-label"]}),t.createVNode(qs,{ref:n,"aria-describedby":r.value,focused:b.value,min:u.value,max:c.value,modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,position:S.value,elevation:e.elevation,onFocus:V,onBlur:w,ripple:e.ripple,name:e.name},{"thumb-label":l["thumb-label"]})])}})})),{}}}),Js=Nt({name:"VColorPickerPreview",props:ht({color:{type:Object},disabled:Boolean,hideAlpha:Boolean,...yt()},"VColorPickerPreview")(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
l("update:color",{...e.color??Es,...a})}catch(e){}}return t.onUnmounted((()=>o.abort())),Et((()=>t.createVNode("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[n&&t.createVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode($o,{density:"comfortable",disabled:e.disabled,icon:"$eyeDropper",variant:"plain",onClick:r},null)]),t.createVNode("div",{class:"v-color-picker-preview__dot"},[t.createVNode("div",{style:{background:it(e.color??Es)}},null)]),t.createVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(Qs,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Es,h:t}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(Qs,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Es,a:t}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])]))),{}}})
var eu={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const tu=ht({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]}))}(eu)},disabled:Boolean,color:Object,maxHeight:[Number,String],...yt()},"VColorPickerSwatches")
const au=Nt({name:"VColorPickerSwatches",props:tu(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
...
return Et((()=>t.createVNode(e.tag,{class:["v-sheet",o.value,n.value,i.value,u.value,d.value,v.value,e.class],style:[r.value,s.value,c.value,e.style]},l))),{}}}),ru=ht({bgColor:String,divided:Boolean,landscape:Boolean,title:String,hideHeader:Boolean,...ou()},"VPicker"),iu=Ct()({name:"VPicker",props:ru(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl((()=>e.color))
return Et((()=>{const a=nu.filterProps(e),r=!(!e.title&&!l.title)
return t.createVNode(nu,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--divided":e.divided,"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(lu,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(ol,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}})
...
default:return null}}function uu(e,t,a){const l=a??su(t)?.firstDay??0,o=new Date(e)
...
function mu(e,t,a,l){const o=pu(e)??new Date,n=l?.[t]
...
default:r=n??{timeZone:"UTC",timeZoneName:"short"}}return new Intl.DateTimeFormat(a,r).format(o)}function gu(e,t){const a=new Date(e)
return a.setDate(a.getDate()+t),a}function hu(e){return e.getFullYear()}function yu(e,t){return e.getTime()>t.getTime()}function bu(e,t){return e.getTime()===t.getTime()}function Vu(e,t,a){const l=new Date(e),o=new Date(t)
...
default:return l.getTime()-o.getTime()}}function wu(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0,0)}class Su{constructor(e){this.locale=e.locale,this.formats=e.formats}date(e){return pu(e)}toJsDate(e){return e}toISO(e){return function(e,t){const a=e.toJsDate(t)
...
let o=[]
const n=cu(e),r=du(e),i=a??su(t)?.firstDay??0,s=(n.getDay()-i+7)%7,u=(r.getDay()-i+7)%7
...
return a}(e,this.locale)}startOfMonth(e){return cu(e)}endOfMonth(e){return du(e)}format(e,t){return mu(e,t,this.locale,this.formats)}isEqual(e,t){return bu(e,t)}isValid(e){return function(e){const t=new Date(e)
return t instanceof Date&&!isNaN(t.getTime())}(e)}isWithinRange(e,t){return function(e,t){return yu(e,t[0])&&function(e,t){return e.getTime()<t.getTime()}(e,t[1])}(e,t)}isAfter(e,t){return yu(e,t)}isAfterDay(e,t){return function(e,t){return yu(wu(e),wu(t))}(e,t)}isBefore(e,t){return!yu(e,t)&&!bu(e,t)}isSameDay(e,t){return function(e,t){return e.getDate()===t.getDate()&&e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameMonth(e,t){return function(e,t){return e.getMonth()===t.getMonth()&&e.getFullYear()===t.getFullYear()}(e,t)}isSameYear(e,t){return function(e,t){return e.getFullYear()===t.getFullYear()}(e,t)}setMinutes(e,t){return function(e,t){const a=new Date(e)
...
return a.setFullYear(t),a}(e,t)}getDiff(e,t,a){return Vu(e,t,a)}getWeekdays(e){const t=void 0!==e?Number(e):void 0
return function(e,t){const a=t??su(e)?.firstDay??0
return f(7).map((t=>{const l=new Date(fu)
return l.setDate(fu.getDate()+a+t),new Intl.DateTimeFormat(e,{weekday:"narrow"}).format(l)}))}(this.locale,t)}getYear(e){return hu(e)}getMonth(e){return function(e){return e.getMonth()}(e)}getWeek(e,t,a){const l=void 0!==t?Number(t):void 0
...
s<hu(gu(uu(e,t,n),6))&&i(s+1)>=r&&s++
const u=new Date(s,0,1),c=i(s)
return 1+Vu(e,gu(u,c>=r?c-7:c),"weeks")}(e,this.locale,l,a)}getDate(e){return function(e){return e.getDate()}(e)}getNextMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()+1,1)}(e)}getPreviousMonth(e){return function(e){return new Date(e.getFullYear(),e.getMonth()-1,1)}(e)}getHours(e){return function(e){return e.getHours()}(e)}getMinutes(e){return function(e){return e.getMinutes()}(e)}startOfDay(e){return wu(e)}endOfDay(e){return function(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate(),23,59,59,999)}(e)}startOfYear(e){return function(e){return new Date(e.getFullYear(),0,1)}(e)}endOfYear(e){return function(e){return new Date(e.getFullYear(),11,31)}(e)}}const ku=Symbol.for("vuetify:date-options"),xu=Symbol.for("vuetify:date-adapter")
...
return t.onBeforeMount((()=>{e.modes.includes(o.value)||(o.value=e.modes[0])})),kt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Et((()=>{const a=iu.filterProps(e)
return t.createVNode(iu,t.mergeProps(a,{class:["v-color-picker",s.value,e.class],style:[{"--v-color-picker-color-hsv":it({...i.value??Es,a:1})},e.style]}),{...l,default:()=>t.createVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(Ds,{key:"canvas",color:i.value,"onUpdate:color":c,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(Js,{key:"preview",color:i.value,"onUpdate:color":c,hideAlpha:!o.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(zs,{key:"edit",modes:e.modes,mode:o.value,"onUpdate:mode":e=>o.value=e,color:i.value,"onUpdate:color":c,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(au,{key:"swatches",color:i.value,"onUpdate:color":c,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)])})})),{}}}),_u=ht({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...Li({filterKeys:["title"]}),...Ei({hideNoData:!0,returnObject:!0}),...N(Ci({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...fl({transition:!1})},"VCombobox"),Pu=Ct()({name:"VCombobox",props:_u(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
const{t:r}=ma(),i=t.ref(),s=t.shallowRef(!1),u=t.shallowRef(!0),c=t.shallowRef(!1),v=t.ref(),p=t.ref(),f=t.shallowRef(-1)
let m=!1
const{items:g,transformIn:h,transformOut:y}=xr(e),{textColorClasses:b,textColorStyles:V}=cl((()=>i.value?.color)),w=na(e,"modelValue",[],(e=>h(R(e))),(t=>{const a=y(t)
return e.multiple?a:a[0]??null})),S=dn(e),k=t.computed((()=>!(!e.chips&&!n.chip))),x=t.computed((()=>k.value||!!n.selection)),N=t.shallowRef(e.multiple||x.value?"":w.value[0]?.title??""),C=t.computed({get:()=>N.value,set:t=>{if(N.value=t??"",e.multiple||x.value||(w.value=[Sr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&q(Sr(e,t))})),N.value="")}t||(f.value=-1),u.value=!t}}),I=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(w.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?w.value.length:C.value.length)),{filteredItems:_,getMatches:B}=zi(e,g,(()=>u.value?"":C.value)),A=t.computed((()=>e.hideSelected?_.value.filter((e=>!w.value.some((t=>t.value===e.value)))):_.value)),T=t.computed((()=>e.hideNoData&&!A.value.length||S.isReadonly.value||S.isDisabled.value)),D=na(e,"menu"),E=t.computed({get:()=>D.value,set:e=>{D.value&&!e&&v.value?.ΨopenChildren.size||e&&T.value||(D.value=e)}}),F=t.toRef((()=>E.value?e.closeText:e.openText))
...
const $=t.computed((()=>w.value.map((e=>e.value)))),M=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&C.value===A.value[0]?.title)&&A.value.length>0&&!u.value&&!c.value)),O=t.ref(),L=Di(O,i)
...
return t===A.value[0].value}))&&q(_.value[0]),u.value=!0),"ArrowDown"===t.key&&M.value&&O.value?.focus("next"),"Enter"===t.key&&C.value&&(q(Sr(e,C.value)),x.value&&(N.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&x.value&&w.value.length>0&&!C.value)return q(w.value[0],!1)
...
w.value=e?[a]:[],N.value=e&&!x.value?a.title:"",t.nextTick((()=>{E.value=!1,u.value=!0}))}}function K(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function X(e){c.value=!1}function Z(t){null!=t&&(""!==t||e.multiple||x.value)||(w.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(f.value=-1,E.value=!1,C.value)){if(e.multiple)return void q(Sr(e,C.value))
if(!x.value)return
w.value.some((e=>{let{title:t}=e
return t===C.value}))?N.value="":q(Sr(e,C.value))}})),t.watch(E,(()=>{if(!e.hideSelected&&E.value&&w.value.length){const t=A.value.findIndex((t=>w.value.some((a=>(e.valueComparator||d)(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&p.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{E.value||s.value&&!t.length&&e.length&&(E.value=!0)})),Et((()=>{const a=!!(!e.hideNoData||A.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=w.value.length>0,o=Ii.filterProps(e)
return t.createVNode(Ii,t.mergeProps({ref:i},o,{modelValue:C.value,"onUpdate:modelValue":[e=>C.value=e,Z],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:w.externalValue,counterValue:I.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":E.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!x.value,"v-combobox--selecting-index":f.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:S.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":z,"onMousedown:control":j,onKeydown:U}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(hi,t.mergeProps({ref:v,modelValue:E.value,"onUpdate:modelValue":e=>E.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:T.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:Y,onAfterLeave:G},e.menuProps),{default:()=>[a&&t.createVNode(_r,t.mergeProps({ref:O,selected:$.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:W,onFocusin:K,onFocusout:X,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},L,e.listProps),{default:()=>[n["prepend-item"]?.(),!A.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(fr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(Ti,{ref:p,renderless:!0,items:A.value,itemKey:"value"},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(an,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Yo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Ql,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:ji("v-combobox",l.title,B(l)?.title)})}}),n["append-item"]?.()]})]}),w.value.map(((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),q(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=k.value?!!n.chip:!!n.selection,s=i?ae(k.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
if(!i||s)return t.createVNode("div",{key:a.value,class:["v-combobox__selection",l===f.value&&["v-combobox__selection--selected",b.value]],style:l===f.value?V.value:{}},[k.value?n.chip?t.createVNode(ol,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(Wn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<w.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Ql,{class:"v-combobox__menu-icon",color:i.value?.fieldIconColor,icon:e.menuIcon,onMousedown:H,onClick:ee,"aria-label":r(F.value),title:r(F.value),tabindex:"-1"},null)])}})})),mi({isFocused:s,isPristine:u,menu:E,search:C,selectionIndex:f,filteredItems:_,select:q},i)}}),Bu=ht({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"},disabled:{type:[Boolean,Array],default:void 0},hideActions:Boolean},"VConfirmEdit"),Ru=Ct()({name:"VConfirmEdit",props:Bu(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return Et((()=>t.createVNode(t.Fragment,null,[o.default?.({model:r,save:p,cancel:f,isPristine:s.value,get actions(){return g=!0,m}}),!e.hideActions&&!g&&m()]))),{save:p,cancel:f,isPristine:s}}}),Au=ht({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Tu=Symbol.for("vuetify:datatable:expanded")
function Du(e){const a=t.toRef((()=>e.expandOnClick)),l=na(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return t.provide(Tu,r),r}function Eu(){const e=t.inject(Tu)
if(!e)throw new Error("foo")
return e}const Fu=ht({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),$u=Symbol.for("vuetify:data-table-group")
function Mu(e){return{groupBy:na(e,"groupBy")}}function Ou(e){const{disableSort:a,groupBy:l,sortBy:o}=e,n=t.ref(new Set)
...
return e}function zu(e,t){let a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"root"
if(!t.length)return[]
...
n.push({depth:a,id:s,key:i,value:o,items:r.length?zu(e,r,a+1,s):e,type:"group"})})),n}function ju(e,t){const a=[]
for(const l of e)"type"in l&&"group"===l.type?(null!=l.value&&a.push(l),(t.has(l.id)||null==l.value)&&a.push(...ju(l.items,t))):a.push(l)
return a}function Hu(e,a,l){return{flatItems:t.computed((()=>{if(!a.value.length)return e.value
return ju(zu(e.value,a.value.map((e=>e.key))),l.value)}))}}function Wu(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
const i=bt("VDataTable")
let s=null
t.watch((()=>({page:a.value,itemsPerPage:l.value,sortBy:o.value,groupBy:n.value,search:r.value})),(e=>{d(s,e)||(s&&s.search!==e.search&&(a.value=1),i.emit("update:options",e),s=e)}),{deep:!0,immediate:!0})}const Uu=ht({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Yu=Symbol.for("vuetify:data-table-pagination")
function Gu(e){return{page:na(e,"page",void 0,(e=>Number(e??1))),itemsPerPage:na(e,"itemsPerPage",void 0,(e=>Number(e??10)))}}function qu(e){const{page:a,itemsPerPage:l,itemsLength:o}=e,n=t.computed((()=>-1===l.value?0:l.value*(a.value-1))),r=t.computed((()=>-1===l.value?o.value:Math.min(o.value,n.value+l.value))),i=t.computed((()=>-1===l.value||0===o.value?1:Math.ceil(o.value/l.value)))
...
return t.provide(Yu,s),s}function Ku(e){const a=bt("usePaginatedItems"),{items:l,startIndex:o,stopIndex:n,itemsPerPage:r}=e,i=t.computed((()=>r.value<=0?l.value:l.value.slice(o.value,n.value)))
return t.watch(i,(e=>{a.emit("update:currentItems",e)}),{immediate:!0}),{paginatedItems:i}}const Xu={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
return new Set(a?[t[0]?.value]:[])},selectAll:e=>{let{selected:t}=e
return t}},Zu={showSelectAll:!0,allSelected:e=>{let{currentPage:t}=e
...
return Zu.select({items:a,value:t,selected:l})}},Qu={showSelectAll:!0,allSelected:e=>{let{allItems:t}=e
return t},select:e=>{let{items:t,value:a,selected:l}=e
for(const e of t)a?l.add(e.value):l.delete(e.value)
return l},selectAll:e=>{let{value:t,allItems:a,selected:l}=e
return Qu.select({items:a,value:t,selected:l})}},Ju=ht({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:{type:Function,default:d}},"DataTable-select"),ec=Symbol.for("vuetify:data-table-selection")
function tc(e,a){let{allItems:l,currentPage:o}=a
...
switch(e.selectStrategy){case"single":return Xu
case"all":return Qu
default:return Zu}})),u=t.shallowRef(null)
...
return t.provide(ec,f),f}function ac(){const e=t.inject(ec)
if(!e)throw new Error("Missing selection!")
return e}const lc=ht({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),oc=Symbol.for("vuetify:data-table-sort")
function nc(e){return{sortBy:na(e,"sortBy"),mustSort:t.toRef((()=>e.mustSort)),multiSort:t.toRef((()=>e.multiSort))}}function rc(e){const{sortBy:a,mustSort:l,multiSort:o,page:n}=e
...
return t.provide(oc,r),r}function ic(){const e=t.inject(oc)
if(!e)throw new Error("Missing sort!")
return e}function sc(e,a,l,o){const n=ma(),r=t.computed((()=>l.value.length?function(e,t,a,l){const o=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),n=e.map((e=>[e,l?.transform?l.transform(e):e]))
...
return{sortedItems:r}}const uc=ht({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function cc(e,t){return{type:"item",value:e.returnObject?t:p(t,e.itemValue),selectable:p(t,e.itemSelectable,!0),raw:t}}function dc(e){const a=t.computed((()=>function(e,t){const a=[]
for(const l of t)a.push(cc(e,l))
return a}(e,e.items)))
return{items:a}}const vc=ht({search:String,loading:Boolean,...yt(),...uc(),...Ju(),...lc(),...Uu({itemsPerPage:5}),...Au(),...Fu(),...Li(),...Ba(),...fl({transition:{component:Ua,hideOnLeave:!0}})},"VDataIterator"),pc=Ct()({name:"VDataIterator",props:vc(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"groupBy"),n=t.toRef((()=>e.search)),{items:r}=dc(e),{filteredItems:i}=zi(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=nc(e),{page:d,itemsPerPage:v}=Gu(e),{toggleSort:p}=rc({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:f,opened:m,extractRows:g,isGroupOpen:h,toggleGroup:y}=Ou({groupBy:o,sortBy:s}),{sortedItems:b}=sc(e,i,f,{transform:e=>e.raw}),{flatItems:V}=Hu(b,o,m),w=t.toRef((()=>V.value.length)),{startIndex:S,stopIndex:k,pageCount:x,prevPage:N,nextPage:C,setItemsPerPage:I,setPage:_}=qu({page:d,itemsPerPage:v,itemsLength:w}),{paginatedItems:P}=Ku({items:V,startIndex:S,stopIndex:k,itemsPerPage:v}),B=t.computed((()=>g(P.value))),{isSelected:R,select:A,selectAll:T,toggleSelect:D}=tc(e,{allItems:r,currentPage:B}),{isExpanded:E,toggleExpand:F}=Du(e)
Wu({page:d,itemsPerPage:v,sortBy:s,groupBy:o,search:n})
...
return Et((()=>{const a=mc.filterProps(e)
return t.createVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createVNode("span",null,[o(e.itemsPerPageText)]),t.createVNode($i,{items:v.value,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined","hide-details":!0},null)]),t.createVNode("div",{class:"v-data-table-footer__info"},[t.createVNode("div",null,[o(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(mc,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable","first-aria-label":e.firstPageLabel,"last-aria-label":e.lastPageLabel,length:r.value,"next-aria-label":e.nextPageLabel,"previous-aria-label":e.prevPageLabel,rounded:!0,"show-first-last-page":!0,"total-visible":e.showCurrentPage?1:0,variant:"plain"},a),null)])])})),{}}}),yc=(bc={align:{type:String,default:"start"},fixed:Boolean,fixedOffset:[Number,String],height:[Number,String],lastFixed:Boolean,noPadding:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},Vc=(e,a)=>{let{slots:l}=a
const o=e.tag??"td"
return t.createVNode(o,{class:["v-data-table__td",{"v-data-table-column--fixed":e.fixed,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap},`v-data-table-column--align-${e.align}`],style:{height:m(e.height),width:m(e.width),maxWidth:m(e.maxWidth),left:m(e.fixedOffset||null)}},{default:()=>[l.default?.()]})},Vc.props=bc,Vc)
var bc,Vc
const wc=ht({headers:Array},"DataTable-header"),Sc=Symbol.for("vuetify:data-table-headers"),kc={title:"",sortable:!1},xc={...kc,width:48}
...
return t}function Ic(e){if(e.key)return"data-table-group"===e.key?kc:["data-table-expand","data-table-select"].includes(e.key)?xc:void 0}function _c(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
return t.provide(Sc,s),s}function Ac(){const e=t.inject(Sc)
if(!e)throw new Error("Missing headers!")
return e}const Tc=ht({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Ft,default:"$sortAsc"},sortDescIcon:{type:Ft,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Cn(),...io()},"VDataTableHeaders"),Dc=Ct()({name:"VDataTableHeaders",props:Tc(),setup(e,a){let{slots:l}=a
const{t:o}=ma(),{toggleSort:n,sortBy:r,isSorted:i}=ic(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=ac(),{columns:v,headers:p}=Ac(),{loaderClasses:f}=so(e)
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(yc,{class:"v-data-table-group-header-row__column"},{default:()=>[t.createVNode($o,{size:"small",variant:"text",icon:a,onClick:r},null),t.createVNode("span",null,[e.item.value]),t.createVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const e=i(d.value),a=s(d.value)&&!e,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(an,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),$c=ht({index:Number,item:Object,cellProps:[Object,Function],onClick:G(),onContextmenu:G(),onDblclick:G(),...Cn()},"VDataTableRow"),Mc=Ct()({name:"VDataTableRow",props:$c(),setup(e,a){let{slots:l}=a
const{displayClasses:o,mobile:n}=In(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=ac(),{isExpanded:d,toggleExpand:p}=Eu(),{toggleSort:f,sortBy:m,isSorted:g}=ic(),{columns:h}=Ac()
...
return t.createVNode(yc,t.mergeProps({align:a.align,class:{"v-data-table__td--expanded-row":"data-table-expand"===a.key,"v-data-table__td--select-row":"data-table-select"===a.key},fixed:a.fixed,fixedOffset:a.fixedOffset,lastFixed:a.lastFixed,maxWidth:n.value?void 0:a.maxWidth,noPadding:"data-table-select"===a.key||"data-table-expand"===a.key,nowrap:a.nowrap,width:n.value?void 0:a.width},S,k),{default:()=>{if("data-table-select"===a.key)return l["item.data-table-select"]?.({...V,props:{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((()=>i(h)),["stop"])}})??t.createVNode(an,{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((t=>i(h,e.index,t)),["stop"])},null)
...
return n.value?t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??o])]):o}})}))])))}}),Oc=ht({loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...Cn()},"VDataTableRows"),Lc=Ct()({name:"VDataTableRows",inheritAttrs:!1,props:Oc(),setup(e,a){let{attrs:l,slots:o}=a
const{columns:n}=Ac(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=Eu(),{isSelected:u,toggleSelect:c}=ac(),{toggleGroup:d,isGroupOpen:v}=Lu(),{t:p}=ma(),{mobile:f}=In(e)
...
return o["group-header"]?o["group-header"](e):t.createVNode(Fc,t.mergeProps({key:`group-header_${a.id}`,item:a},Bt(l,":group-header",(()=>e))),o)}const m={index:p,item:a.raw,internalItem:a,columns:n.value,isExpanded:s,toggleExpand:i,isSelected:u,toggleSelect:c},g={...m,props:t.mergeProps({key:`item_${a.key??a.index}`,onClick:r.value?()=>{i(a)}:void 0,index:p,item:a,cellProps:e.cellProps,mobile:f.value},Bt(l,":row",(()=>m)),"function"==typeof e.rowProps?e.rowProps({item:m.item,index:m.index,internalItem:m.internalItem}):e.rowProps)}
return t.createVNode(t.Fragment,{key:g.props.key},[o.item?o.item(g):t.createVNode(Mc,g.props,o),s(a)&&o["expanded-row"]?.(m)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),zc=ht({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...yt(),...Al(),...Ba(),...ba()},"VTable"),jc=Ct()({name:"VTable",props:zc(),setup(e,a){let{slots:l,emit:o}=a
const{themeClasses:n}=Ca(e),{densityClasses:r}=Tl(e)
return Et((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},n.value,r.value,e.class],style:e.style},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:m(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),Hc=ht({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
function Wc(e,t,a){return t.map(((t,l)=>function(e,t,a,l){const o=e.returnObject?t:p(t,e.itemValue),n=p(t,e.itemSelectable,!0),r=l.reduce(((e,a)=>(null!=a.key&&(e[a.key]=p(t,a.value)),e)),{})
return{type:"item",key:e.returnObject?p(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function Uc(e,a){return{items:t.computed((()=>Wc(e,e.items,a.value)))}}const Yc=ht({...Oc(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Au(),...Fu(),...wc(),...Hc(),...Ju(),...lc(),...Tc(),...zc()},"DataTable"),Gc=ht({...Uu(),...Yc(),...Li(),...gc()},"VDataTable"),qc=Ct()({name:"VDataTable",props:Gc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Mu(e),{sortBy:r,multiSort:i,mustSort:s}=nc(e),{page:u,itemsPerPage:c}=Gu(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:f,sortRawFunctions:m,filterFunctions:g}=Rc(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:h}=Uc(e,v),y=t.toRef((()=>e.search)),{filteredItems:b}=zi(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=rc({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:x,toggleGroup:N}=Ou({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:C}=sc(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:m}),{flatItems:I}=Hu(C,n,S),_=t.computed((()=>I.value.length)),{startIndex:P,stopIndex:B,pageCount:R,setItemsPerPage:A}=qu({page:u,itemsPerPage:c,itemsLength:_}),{paginatedItems:T}=Ku({items:I,startIndex:P,stopIndex:B,itemsPerPage:c}),D=t.computed((()=>k(T.value))),{isSelected:E,select:F,selectAll:$,toggleSelect:M,someSelected:O,allSelected:L}=tc(e,{allItems:h,currentPage:D}),{isExpanded:z,toggleExpand:j}=Du(e)
Wu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
return Et((()=>{const a=hc.filterProps(e),n=Dc.filterProps(e),r=Lc.filterProps(e),i=jc.filterProps(e)
return t.createVNode(jc,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(H.value),default:()=>o.default?o.default(H.value):t.createVNode(t.Fragment,null,[o.colgroup?.(H.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(Dc,n,o)]),o.thead?.(H.value),!e.hideDefaultBody&&t.createVNode("tbody",null,[o["body.prepend"]?.(H.value),o.body?o.body(H.value):t.createVNode(Lc,t.mergeProps(l,r,{items:T.value}),o),o["body.append"]?.(H.value)]),o.tbody?.(H.value),o.tfoot?.(H.value)]),bottom:()=>o.bottom?o.bottom(H.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(yr,null,null),t.createVNode(hc,a,{prepend:o["footer.prepend"]})])})})),{}}}),Kc=ht({...N(Yc(),["hideDefaultFooter"]),...Fu(),...Bi(),...Li()},"VDataTableVirtual"),Xc=Ct()({name:"VDataTableVirtual",props:Kc(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Mu(e),{sortBy:r,multiSort:i,mustSort:s}=nc(e),{disableSort:u}=t.toRefs(e),{columns:c,headers:d,filterFunctions:v,sortFunctions:p,sortRawFunctions:f}=Rc(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:g}=Uc(e,c),h=t.toRef((()=>e.search)),{filteredItems:y}=zi(e,g,h,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:b}=rc({sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:V,opened:w,extractRows:S,isGroupOpen:k,toggleGroup:x}=Ou({groupBy:n,sortBy:r,disableSort:u}),{sortedItems:N}=sc(e,y,V,{transform:e=>({...e.raw,...e.columns}),sortFunctions:p,sortRawFunctions:f}),{flatItems:C}=Hu(N,n,w),I=t.computed((()=>S(C.value))),{isSelected:_,select:P,selectAll:B,toggleSelect:R,someSelected:A,allSelected:T}=tc(e,{allItems:I,currentPage:I}),{isExpanded:D,toggleExpand:E}=Du(e),{containerRef:F,markerRef:$,paddingTop:M,paddingBottom:O,computedItems:L,handleItemResize:z,handleScroll:j,handleScrollend:H,calculateVisibleItems:W,scrollToIndex:U}=Ri(e,C),Y=t.computed((()=>L.value.map((e=>e.raw))))
Wu({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
return Et((()=>{const a=Dc.filterProps(e),n=Lc.filterProps(e),r=jc.filterProps(e)
return t.createVNode(jc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(G.value),wrapper:()=>t.createVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:m(e.height)}},[t.createVNode("table",null,[o.colgroup?.(G.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(Dc,a,o)]),o.thead?.(G.value),!e.hideDefaultBody&&t.createVNode("tbody",{key:"tbody"},[t.createVNode("tr",{ref:$,style:{height:m(M.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(G.value),t.createVNode(Lc,t.mergeProps(l,n,{items:Y.value}),{...o,item:e=>t.createVNode(Pi,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>z(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Mc,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(G.value),t.createVNode("tr",{style:{height:m(O.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])]),o.tbody?.(G.value),o.tfoot?.(G.value)])]),bottom:()=>o.bottom?.(G.value)})})),{calculateVisibleItems:W,scrollToIndex:U}}}),Zc=ht({itemsLength:{type:[Number,String],required:!0},...Uu(),...Yc(),...gc()},"VDataTableServer"),Qc=Ct()({name:"VDataTableServer",props:Zc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Mu(e),{sortBy:r,multiSort:i,mustSort:s}=nc(e),{page:u,itemsPerPage:c}=Gu(e),{disableSort:d}=t.toRefs(e),v=t.computed((()=>parseInt(e.itemsLength,10))),{columns:p,headers:f}=Rc(e,{groupBy:n,showSelect:t.toRef((()=>e.showSelect)),showExpand:t.toRef((()=>e.showExpand))}),{items:m}=Uc(e,p),{toggleSort:g}=rc({sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:h,isGroupOpen:y,toggleGroup:b,extractRows:V}=Ou({groupBy:n,sortBy:r,disableSort:d}),{pageCount:w,setItemsPerPage:S}=qu({page:u,itemsPerPage:c,itemsLength:v}),{flatItems:k}=Hu(m,n,h),{isSelected:x,select:N,selectAll:C,toggleSelect:I,someSelected:_,allSelected:P}=tc(e,{allItems:m,currentPage:m}),{isExpanded:B,toggleExpand:R}=Du(e),A=t.computed((()=>V(m.value)))
Wu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef((()=>e.search))}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),kt({VDataTableRows:{hideNoData:t.toRef((()=>e.hideNoData)),noDataText:t.toRef((()=>e.noDataText)),loading:t.toRef((()=>e.loading)),loadingText:t.toRef((()=>e.loadingText))}})
...
Et((()=>{const a=hc.filterProps(e),n=Dc.filterProps(e),r=Lc.filterProps(e),i=jc.filterProps(e)
return t.createVNode(jc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(T.value),default:()=>o.default?o.default(T.value):t.createVNode(t.Fragment,null,[o.colgroup?.(T.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Dc,n,o)]),o.thead?.(T.value),!e.hideDefaultBody&&t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(T.value),o.body?o.body(T.value):t.createVNode(Lc,t.mergeProps(l,r,{items:k.value}),o),o["body.append"]?.(T.value)]),o.tbody?.(T.value),o.tfoot?.(T.value)]),bottom:()=>o.bottom?o.bottom(T.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(yr,null,null),t.createVNode(hc,a,{prepend:o["footer.prepend"]})])})}))}}),Jc=ht({fluid:{type:Boolean,default:!1},...yt(),...nl(),...Ba()},"VContainer"),ed=Ct()({name:"VContainer",props:Jc(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ha(),{dimensionStyles:n}=rl(e)
return Et((()=>t.createVNode(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},o.value,e.class],style:[n.value,e.style]},l))),{}}}),td=bn.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),ad=bn.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),ld=bn.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),od={col:Object.keys(td),offset:Object.keys(ad),order:Object.keys(ld)}
function nd(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const rd=["auto","start","end","center","baseline","stretch"],id=ht({cols:{type:[Boolean,String,Number],default:!1},...td,offset:{type:[String,Number],default:null},...ad,order:{type:[String,Number],default:null},...ld,alignSelf:{type:String,default:null,validator:e=>rd.includes(e)},...yt(),...Ba()},"VCol"),sd=Ct()({name:"VCol",props:id(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in od)od[a].forEach((l=>{const o=e[l],n=nd(a,l,o)
n&&t.push(n)}))
const l=t.some((e=>e.startsWith("v-col-")))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t}))
return()=>t.h(e.tag,{class:[o.value,e.class],style:e.style},l.default?.())}}),ud=["start","end","center"],cd=["space-between","space-around","space-evenly"]
function dd(e,a){return bn.reduce(((l,o)=>(l[e+t.capitalize(o)]=a(),l)),{})}const vd=[...ud,"baseline","stretch"],pd=e=>vd.includes(e),fd=dd("align",(()=>({type:String,default:null,validator:pd}))),md=[...ud,...cd],gd=e=>md.includes(e),hd=dd("justify",(()=>({type:String,default:null,validator:gd}))),yd=[...ud,...cd,"stretch"],bd=e=>yd.includes(e),Vd=dd("alignContent",(()=>({type:String,default:null,validator:bd}))),wd={align:Object.keys(fd),justify:Object.keys(hd),alignContent:Object.keys(Vd)},Sd={align:"align",justify:"justify",alignContent:"align-content"}
function kd(e,t,a){let l=Sd[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const xd=ht({dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:pd},...fd,justify:{type:String,default:null,validator:gd},...hd,alignContent:{type:String,default:null,validator:bd},...Vd,...yt(),...Ba()},"VRow"),Nd=Ct()({name:"VRow",props:xd(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in wd)wd[a].forEach((l=>{const o=e[l],n=kd(a,l,o)
n&&t.push(n)}))
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t}))
return()=>t.h(e.tag,{class:["v-row",o.value,e.class],style:e.style},l.default?.())}}),Cd=It("v-spacer","div","VSpacer"),Id=ht({active:{type:[String,Array],default:void 0},controlHeight:[Number,String],disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Ft,default:"$next"},prevIcon:{type:Ft,default:"$prev"},modeIcon:{type:Ft,default:"$subgroup"},text:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),_d=Ct()({name:"VDatePickerControls",props:Id(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:text":()=>!0},setup(e,a){let{emit:l}=a
...
r.value=e}(n)}
return o.month?.({month:a,i:n,props:i})??t.createVNode($o,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Fd=ht({color:String,height:[String,Number],min:null,max:null,modelValue:Number},"VDatePickerYears"),$d=Ct()({name:"VDatePickerYears",props:Fd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=Cu(),r=na(e,"modelValue"),i=t.computed((()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
return o.year?.({year:a,i:n,props:i})??t.createVNode($o,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Md=ht({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,...Id(),...Ad({weeksInMonth:"static"}),...N(Dd(),["modelValue"]),...N(Fd(),["modelValue"]),...ru({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Od=Ct()({name:"VDatePicker",props:Md(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=Cu(),{t:r}=ma(),{rtlClasses:i}=ha(),s=na(e,"modelValue",void 0,(e=>R(e).map((e=>n.date(e)))),(t=>e.multiple?t:t[0])),u=na(e,"viewMode"),c=t.computed((()=>{const t=n.date(e.min)
...
i!==f.value&&(f.value=i,I(f.value)),s!==m.value&&(m.value=s,_(m.value)),g.value=n.isBefore(o,r)})),Et((()=>{const a=iu.filterProps(e),l=_d.filterProps(e),n=Bd.filterProps(e),v=Td.filterProps(e),g=N(Ed.filterProps(e),["modelValue"]),P=N($d.filterProps(e),["modelValue"]),B={color:p.value,header:h.value,transition:b.value}
return t.createVNode(iu,t.mergeProps(a,{color:p.value,class:["v-date-picker",`v-date-picker--${u.value}`,{"v-date-picker--show-week":e.showWeek},i.value,e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(ol,{defaults:{VDatePickerHeader:{...B}}},{default:()=>[o.header?.(B)]}):t.createVNode(Bd,t.mergeProps({key:"header"},n,B,{onClick:"month"!==u.value?k:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(_d,t.mergeProps(l,{disabled:V.value,text:y.value,"onClick:next":w,"onClick:prev":S,"onClick:month":x,"onClick:year":C}),null),t.createVNode(Ua,{hideOnLeave:!0},{default:()=>["months"===u.value?t.createVNode(Ed,t.mergeProps({key:"date-picker-months"},g,{modelValue:f.value,"onUpdate:modelValue":[e=>f.value=e,I],min:c.value,max:d.value,year:m.value}),null):"year"===u.value?t.createVNode($d,t.mergeProps({key:"date-picker-years"},P,{modelValue:m.value,"onUpdate:modelValue":[e=>m.value=e,_],min:c.value,max:d.value}),null):t.createVNode(Td,t.mergeProps({key:"date-picker-month"},v,{modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,month:f.value,"onUpdate:month":[e=>f.value=e,I],year:m.value,"onUpdate:year":[e=>m.value=e,_],min:c.value,max:d.value}),null)]})]),actions:o.actions})})),{}}}),Ld=ht({actionText:String,bgColor:String,color:String,icon:Ft,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...yt(),...nl(),...Kl({size:void 0}),...ba()},"VEmptyState"),zd=Ct()({name:"VEmptyState",props:Ld(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const{themeClasses:n}=Ca(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl((()=>e.bgColor)),{dimensionStyles:s}=rl(e),{displayClasses:u}=In()
...
return Et((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--focusable":e.focusable,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,i.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(s.value),!e.hideActions&&t.createVNode(ol,{defaults:{VIcon:{icon:u.value}}},{default:()=>[t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?.(s.value)??t.createVNode(Ql,null,null)])]})]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Gd=ht({title:String,text:String,bgColor:String,...Sl(),...zl(),...vl(),...Ba(),...Ud(),...Hd()},"VExpansionPanel"),qd=Ct()({name:"VExpansionPanel",props:Gd(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=jl(e,jd),{backgroundColorClasses:n,backgroundColorStyles:r}=dl((()=>e.bgColor)),{elevationClasses:i}=kl(e),{roundedClasses:s}=pl(e),u=t.toRef((()=>o?.disabled.value||e.disabled)),c=t.computed((()=>o.group.items.value.reduce(((e,t,a)=>(o.group.selected.value.includes(t.id)&&e.push(a),e)),[]))),d=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==1))})),v=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==-1))}))
return t.provide(jd,o),Et((()=>{const a=!(!l.text&&!e.text),c=!(!l.title&&!e.title),p=Yd.filterProps(e),f=Wd.filterProps(e)
return t.createVNode(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":o.isSelected.value,"v-expansion-panel--before-active":d.value,"v-expansion-panel--after-active":v.value,"v-expansion-panel--disabled":u.value},s.value,n.value,e.class],style:[r.value,e.style]},{default:()=>[t.createVNode("div",{class:["v-expansion-panel__shadow",...i.value]},null),t.createVNode(ol,{defaults:{VExpansionPanelTitle:{...p},VExpansionPanelText:{...f}}},{default:()=>[c&&t.createVNode(Yd,{key:"title"},{default:()=>[l.title?l.title():e.title]}),a&&t.createVNode(Wd,{key:"text"},{default:()=>[l.text?l.text():e.text]}),l.default?.()]})]})})),{groupItem:o}}}),Kd=["default","accordion","inset","popout"],Xd=ht({flat:Boolean,...Ll(),...k(Gd(),["bgColor","collapseIcon","color","eager","elevation","expandIcon","focusable","hideActions","readonly","ripple","rounded","tile","static"]),...ba(),...yt(),...Ba(),variant:{type:String,default:"default",validator:e=>Kd.includes(e)}},"VExpansionPanels"),Zd=Ct()({name:"VExpansionPanels",props:Xd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{next:o,prev:n}=Hl(e,jd),{themeClasses:r}=Ca(e),i=t.toRef((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return kt({VExpansionPanel:{bgColor:t.toRef((()=>e.bgColor)),collapseIcon:t.toRef((()=>e.collapseIcon)),color:t.toRef((()=>e.color)),eager:t.toRef((()=>e.eager)),elevation:t.toRef((()=>e.elevation)),expandIcon:t.toRef((()=>e.expandIcon)),focusable:t.toRef((()=>e.focusable)),hideActions:t.toRef((()=>e.hideActions)),readonly:t.toRef((()=>e.readonly)),ripple:t.toRef((()=>e.ripple)),rounded:t.toRef((()=>e.rounded)),static:t.toRef((()=>e.static))}}),Et((()=>t.createVNode(e.tag,{class:["v-expansion-panels",{"v-expansion-panels--flat":e.flat,"v-expansion-panels--tile":e.tile},r.value,i.value,e.class],style:e.style},{default:()=>[l.default?.({prev:n,next:o})]}))),{next:o,prev:n}}}),Qd=ht({app:Boolean,appear:Boolean,extended:Boolean,layout:Boolean,offset:Boolean,modelValue:{type:Boolean,default:!0},...N(Fo({active:!0}),["location"]),...ea(),...lo(),...fl({transition:"fab-transition"})},"VFab"),Jd=Ct()({name:"VFab",props:Qd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{ref:d,class:["v-fab",{"v-fab--absolute":e.absolute,"v-fab--app":!!e.app,"v-fab--extended":e.extended,"v-fab--offset":e.offset,[`v-fab--${u.value}`]:s.value,[`v-fab--${c.value}`]:s.value},e.class],style:[e.app?{...r.value}:{height:e.absolute?"100%":"inherit"},e.style]},[t.createVNode("div",{class:"v-fab__container"},[t.createVNode(ml,{appear:e.appear,transition:e.transition},{default:()=>[t.withDirectives(t.createVNode($o,t.mergeProps({ref:i},a,{active:void 0,location:void 0}),l),[[t.vShow,e.active]])]})])])})),{}}}),ev=ht({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},...mn({prependIcon:"$file"}),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>R(e).every((e=>null!=e&&"object"==typeof e))},...ki({clearable:!0})},"VFileInput"),tv=Ct()({name:"VFileInput",inheritAttrs:!1,props:ev(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
y.value.files=t.files,y.value.dispatchEvent(new Event("change",{bubbles:!0}))}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&y.value&&(y.value.value="")})),Et((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,u]=B(l),{modelValue:d,...R}=gn.filterProps(e),A=xi.filterProps(e)
return t.createVNode(gn,t.mergeProps({ref:g,modelValue:e.multiple?i.value:i.value[0],class:["v-file-input",{"v-file-input--chips":!!e.chips,"v-file-input--dragging":w.value,"v-file-input--hide":e.hideInput,"v-input--plain-underlined":V.value},e.class],style:e.style,"onClick:prepend":k},r,R,{centerAffix:!V.value,focused:s.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:r,isReadonly:d,isValid:m}=a
return t.createVNode(xi,t.mergeProps({ref:h,"prepend-icon":e.prependIcon,onMousedown:x,onClick:N,"onClick:clear":C,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},A,{id:l.value,active:b.value||r.value,dirty:r.value||e.dirty,disabled:o.value,focused:s.value,error:!1===m.value,onDragover:I,onDrop:P}),{...n,default:a=>{let{props:{class:l,...r}}=a
...
const t=e.target
i.value=[...t.files??[]]},onDragleave:_,onFocus:S,onBlur:c},r,u),null),t.createVNode("div",{class:l},[!!i.value?.length&&!e.hideInput&&(n.selection?n.selection({fileNames:f.value,totalBytes:v.value,totalBytesReadable:p.value}):e.chips?f.value.map((e=>t.createVNode(Wn,{key:e,size:"small",text:e},null))):f.value.join(", "))])])}})},details:o?l=>t.createVNode(t.Fragment,null,[n.details?.(l),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(bi,{active:!!i.value?.length,value:m.value,disabled:e.disabled},n.counter)])]):void 0})})),mi({},g,h,y)}}),av=ht({app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...Vl(),...yt(),...Sl(),...ea(),...vl(),...Ba({tag:"footer"}),...ba()},"VFooter"),lv=Ct()({name:"VFooter",props:av(),setup(e,a){let{slots:l}=a
...
t.watchEffect((()=>{o.value=a.layoutItemStyles.value}))})),Et((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",n.value,r.value,s.value,u.value,c.value,e.class],style:[i.value,e.app?o.value:{height:m(e.height)},e.style]},l))),{}}}),ov=ht({...yt(),...cn()},"VForm"),nv=Ct()({name:"VForm",props:ov(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
t&&r.value?.submit()})),t.preventDefault()}return Et((()=>t.createVNode("form",{ref:r,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),mi(n,r)}}),rv=ht({disabled:Boolean,modelValue:{type:Boolean,default:null},...qr()},"VHover"),iv=Ct()({name:"VHover",props:rv(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=na(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Kr(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),sv=ht({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...nl(),...Ba()},"VInfiniteScroll"),uv=Nt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=Jl()
return t.watch(n,(async t=>{l("intersect",e.side,t)})),Et((()=>t.createVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:o},[t.createTextVNode(" ")]))),{}}}),cv=Ct()({name:"VInfiniteScroll",props:sv(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),o&&c&&t.createVNode(uv,{key:"start",side:"start",onIntersect:f,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(uv,{key:"end",side:"end",onIntersect:f,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),dv=Symbol.for("vuetify:v-item-group"),vv=ht({...yt(),...Ll({selectedClass:"v-item--selected"}),...Ba(),...ba()},"VItemGroup"),pv=Ct()({name:"VItemGroup",props:vv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=Ca(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Hl(e,dv)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),fv=Ct()({name:"VItem",props:zl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=jl(e,dv)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),mv=It("v-kbd","kbd"),gv=ht({...yt(),...nl(),...Jt()},"VLayout"),hv=Ct()({name:"VLayout",props:gv(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=la(e),{dimensionStyles:u}=rl(e)
return Et((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[u.value,n.value,e.style]},[l.default?.()]))),{getLayoutItem:r,items:i}}}),yv=ht({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...yt(),...ea()},"VLayoutItem"),bv=Ct()({name:"VLayoutItem",props:yv(),setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()])}}),Vv=ht({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...yt(),...nl(),...Ba(),...fl({transition:"fade-transition"})},"VLazy"),wv=Ct()({name:"VLazy",directives:{intersect:hl},props:Vv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=rl(e),n=na(e,"modelValue")
function r(e){n.value||(n.value=e)}return Et((()=>t.withDirectives(t.createVNode(e.tag,{class:["v-lazy",e.class],style:[o.value,e.style]},{default:()=>[n.value&&t.createVNode(ml,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[t.resolveDirective("intersect"),{handler:r,options:e.options},null]]))),{}}}),Sv=ht({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...yt()},"VLocaleProvider"),kv=Ct()({name:"VLocaleProvider",props:Sv(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ga(e)
return Et((()=>t.createVNode("div",{class:["v-locale-provider",o.value,e.class],style:e.style},[l.default?.()]))),{}}}),xv=ht({scrollable:Boolean,...yt(),...nl(),...Ba({tag:"main"})},"VMain"),Nv=Ct()({name:"VMain",props:xv(),setup(e,a){let{slots:l}=a
...
const l=a[0],o=[],n=[]
for(const e of a){if(l[0]-e[0]>Cv)break
...
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Rv(){throw new Error}const Av=["start","end","left","right","top","bottom"],Tv=ht({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>Av.includes(e)},sticky:Boolean,...Vl(),...yt(),...qr(),...Cn({mobile:null}),...Sl(),...ea(),...vl(),...Ba({tag:"nav"}),...ba()},"VNavigationDrawer"),Dv=Ct()({name:"VNavigationDrawer",props:Tv(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{isRtl:r}=ha(),{themeClasses:i}=Ca(e),{borderClasses:s}=wl(e),{backgroundColorClasses:u,backgroundColorStyles:c}=dl((()=>e.color)),{elevationClasses:d}=kl(e),{displayClasses:v,mobile:p}=In(e),{roundedClasses:f}=pl(e),g=fo(),h=na(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:y}=_l(),{scopeId:b}=ai(),V=t.ref(),w=t.shallowRef(!1),{runOpenDelay:S,runCloseDelay:k}=Kr(e,(e=>{w.value=e})),x=t.computed((()=>e.rail&&e.expandOnHover&&w.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),N=t.computed((()=>ue(e.location,r.value))),C=t.toRef((()=>e.persistent)),I=t.computed((()=>!e.permanent&&(p.value||e.temporary))),_=t.computed((()=>e.sticky&&!I.value&&"bottom"!==N.value))
...
l.value=n?t.direction===({left:"right",right:"left",top:"down",bottom:"up"}[i.value]||Rv()):f.value>.5}const S=t.computed((()=>p.value?{transform:"left"===i.value?`translateX(calc(-100% + ${f.value*n.value}px))`:"right"===i.value?`translateX(calc(100% - ${f.value*n.value}px))`:"top"===i.value?`translateY(calc(-100% + ${f.value*n.value}px))`:"bottom"===i.value?`translateY(calc(100% - ${f.value*n.value}px))`:Rv(),transition:"none"}:void 0))
...
return t.createVNode(t.Fragment,null,[v,l["prepend-inner"]?.(...a)])}:void 0})})),mi({},o)}}),Mv=ht({autofocus:Boolean,divider:String,focusAll:Boolean,label:{type:String,default:"$vuetify.input.otp"},length:{type:[Number,String],default:6},modelValue:{type:[Number,String],default:void 0},placeholder:String,type:{type:String,default:"number"},...nl(),...rn(),...k(ki({variant:"outlined"}),["baseColor","bgColor","class","color","disabled","error","loading","rounded","style","theme","variant"])},"VOtpInput"),Ov=Ct()({name:"VOtpInput",props:Mv(),emits:{finish:e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return t.createVNode("div",t.mergeProps({class:["v-otp-input",{"v-otp-input--divided":!!e.divider},e.class],style:[e.style]},a),[t.createVNode("div",{ref:m,class:"v-otp-input__content",style:[r.value]},[p.value.map(((a,l)=>t.createVNode(t.Fragment,null,[e.divider&&0!==l&&t.createVNode("span",{class:"v-otp-input__divider"},[e.divider]),t.createVNode(xi,{focused:i.value&&e.focusAll||f.value===l,key:l},{...n,loader:void 0,default:()=>t.createVNode("input",{ref:e=>g.value[l]=e,"aria-label":d(e.label,l+1),autofocus:0===l&&e.autofocus,autocomplete:"one-time-code",class:["v-otp-input__field"],disabled:e.disabled,inputmode:"number"===e.type?"numeric":"text",min:"number"===e.type?0:void 0,maxlength:0===l?v.value:"1",placeholder:e.placeholder,type:"number"===e.type?"text":e.type,value:c.value[l],onInput:y,onFocus:e=>function(e,t){s(),f.value=t}(0,l),onBlur:V,onKeydown:b,onPaste:e=>function(e,t){t.preventDefault(),t.stopPropagation()
const a=t?.clipboardData?.getData("Text").slice(0,v.value)??""
w(a)||(c.value=a.split(""),g.value?.[e].blur())}(l,e)},null)})]))),t.createVNode("input",t.mergeProps({class:"v-otp-input-input",type:"hidden"},o,{value:c.value.join("")}),null),t.createVNode(vi,{contained:!0,"content-class":"v-otp-input__loader","model-value":!!e.loading,persistent:!0},{default:()=>[n.loader?.()??t.createVNode(to,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"24",width:"2"},null)]}),n.default?.()])])})),{blur:()=>{g.value?.some((e=>e.blur()))},focus:()=>{g.value?.[0].focus()},reset:function(){c.value=[]},isFocused:i}}})
const Lv=ht({scale:{type:[Number,String],default:.5},...yt()},"VParallax"),zv=Ct()({name:"VParallax",props:Lv(),setup(e,a){let{slots:l}=a
const{intersectionRef:o,isIntersecting:n}=Jl(),{resizeRef:r,contentRect:i}=Xt(),{height:s}=In(),u=t.ref()
let c
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return Et((()=>t.createVNode(bl,{class:["v-parallax",{"v-parallax--active":n.value},e.class],style:e.style,ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),jv=ht({...Jo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Hv=Ct()({name:"VRadio",props:jv(),setup(e,a){let{slots:l}=a
return Et((()=>{const a=en.filterProps(e)
return t.createVNode(en,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)})),{}}}),Wv=ht({height:{type:[Number,String],default:"auto"},...mn(),...N(Xo(),["multiple"]),trueIcon:{type:Ft,default:"$radioOn"},falseIcon:{type:Ft,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Uv=Ct()({name:"VRadioGroup",inheritAttrs:!1,props:Wv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=t.useId(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=na(e,"modelValue")
return Et((()=>{const[a,n]=B(l),s=gn.filterProps(e),u=en.filterProps(e),c=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
return t.createVNode(gn,t.mergeProps({class:["v-radio-group",e.class],style:e.style},a,s,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,id:r.value}),{...o,default:a=>{let{id:l,messagesId:r,isDisabled:s,isReadonly:d}=a
return t.createVNode(t.Fragment,null,[c&&t.createVNode(qo,{id:l.value},{default:()=>[c]}),t.createVNode(Qo,t.mergeProps(u,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:d.value,"aria-labelledby":c?l.value:void 0,multiple:!1},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),Yv=ht({...rn(),...mn(),...Ws(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),Gv=Ct()({name:"VRangeSlider",props:Yv(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=ha()
const u=Us(e),c=na(e,"modelValue",void 0,(e=>e?.length?e.map((e=>u.roundValue(e))):[0,0])),{activeThumbRef:d,hasLabels:v,max:p,min:f,mousePressed:m,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b,readonly:V}=Ys({props:e,steps:u,onSliderStart:()=>{o("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
return Et((()=>{const a=gn.filterProps(e),o=!!(e.label||l.label||l.prepend)
return t.createVNode(gn,t.mergeProps({class:["v-slider","v-range-slider",{"v-slider--has-labels":!!l["tick-label"]||v.value,"v-slider--focused":w.value,"v-slider--pressed":m.value,"v-slider--disabled":e.disabled},s.value,e.class],style:e.style,ref:i},a,{focused:w.value}),{...l,prepend:o?a=>t.createVNode(t.Fragment,null,[l.label?.(a)??(e.label?t.createVNode(qo,{class:"v-slider__label",text:e.label},null):void 0),l.prepend?.(a)]):void 0,default:a=>{let{id:o,messagesId:i}=a
return t.createVNode("div",{class:"v-slider__container",onMousedown:V.value?void 0:g,onTouchstartPassive:V.value?void 0:h},[t.createVNode("input",{id:`${o.value}_start`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[0]},null),t.createVNode("input",{id:`${o.value}_stop`,name:e.name||o.value,disabled:!!e.disabled,readonly:!!e.readonly,tabindex:"-1",value:c.value[1]},null),t.createVNode(Xs,{ref:b,start:x.value,stop:N.value},{"tick-label":l["tick-label"]}),t.createVNode(qs,{ref:n,"aria-describedby":i.value,focused:w&&d.value===n.value?.$el,modelValue:c.value[0],"onUpdate:modelValue":e=>c.value=[e,c.value[1]],onFocus:e=>{S(),d.value=n.value?.$el,p.value!==f.value&&c.value[0]===c.value[1]&&c.value[1]===f.value&&e.relatedTarget!==r.value?.$el&&(n.value?.$el.blur(),r.value?.$el.focus())},onBlur:()=>{k(),d.value=void 0},min:f.value,max:c.value[1],position:x.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]}),t.createVNode(qs,{ref:r,"aria-describedby":i.value,focused:w&&d.value===r.value?.$el,modelValue:c.value[1],"onUpdate:modelValue":e=>c.value=[c.value[0],e],onFocus:e=>{S(),d.value=r.value?.$el,p.value!==f.value&&c.value[0]===c.value[1]&&c.value[0]===p.value&&e.relatedTarget!==n.value?.$el&&(r.value?.$el.blur(),n.value?.$el.focus())},onBlur:()=>{k(),d.value=void 0},min:c.value[0],max:p.value,position:N.value,ripple:e.ripple},{"thumb-label":l["thumb-label"]})])}})})),{}}}),qv=ht({name:String,itemAriaLabel:{type:String,default:"$vuetify.rating.ariaLabel.item"},activeColor:String,color:String,clearable:Boolean,disabled:Boolean,emptyIcon:{type:Ft,default:"$ratingEmpty"},fullIcon:{type:Ft,default:"$ratingFull"},halfIncrements:Boolean,hover:Boolean,length:{type:[Number,String],default:5},readonly:Boolean,modelValue:{type:[Number,String],default:0},itemLabels:Array,itemLabelPosition:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},ripple:Boolean,...yt(),...Al(),...Kl(),...Ba(),...ba()},"VRating"),Kv=Ct()({name:"VRating",props:qv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:["v-rating",{"v-rating--hover":e.hover,"v-rating--readonly":e.readonly},n.value,e.class],style:e.style},{default:()=>[t.createVNode(g,{value:0,index:-1,showStar:!1},null),s.value.map(((l,o)=>t.createVNode("div",{class:"v-rating__wrapper"},[a&&"top"===e.itemLabelPosition?h({value:l,index:o,label:e.itemLabels?.[o]}):void 0,t.createVNode("div",{class:"v-rating__item"},[e.halfIncrements?t.createVNode(t.Fragment,null,[t.createVNode(g,{value:l-.5,index:2*o},null),t.createVNode(g,{value:l,index:2*o+1},null)]):t.createVNode(g,{value:l,index:o},null)]),a&&"bottom"===e.itemLabelPosition?h({value:l,index:o,label:e.itemLabels?.[o]}):void 0])))]})})),{}}}),Xv={actions:"button@2",article:"heading, paragraph",avatar:"avatar",button:"button",card:"image, heading","card-avatar":"image, list-item-avatar",chip:"chip","date-picker":"list-item, heading, divider, date-picker-options, date-picker-days, actions","date-picker-options":"text, avatar@2","date-picker-days":"avatar@28",divider:"divider",heading:"heading",image:"image","list-item":"text","list-item-avatar":"avatar, text","list-item-two-line":"sentences","list-item-avatar-two-line":"avatar, sentences","list-item-three-line":"paragraph","list-item-avatar-three-line":"avatar, paragraph",ossein:"ossein",paragraph:"text@3",sentences:"text@2",subtitle:"text",table:"table-heading, table-thead, table-tbody, table-tfoot","table-heading":"chip, text","table-thead":"heading@6","table-tbody":"table-row-divider@6","table-row-divider":"table-row, divider","table-row":"text@6","table-tfoot":"text@2, avatar@2",text:"text"}
function Zv(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
return t.createVNode("div",{class:["v-skeleton-loader__bone",`v-skeleton-loader__${e}`]},[a])}function Qv(e){const[t,a]=e.split("@")
return Array.from({length:a}).map((()=>Jv(t)))}function Jv(e){let t=[]
if(!e)return t
const a=Xv[e]
if(e===a);else{if(e.includes(","))return ep(e)
if(e.includes("@"))return Qv(e)
a.includes(",")?t=ep(a):a.includes("@")?t=Qv(a):a&&t.push(Jv(a))}return[Zv(e,t)]}function ep(e){return e.replace(/\s/g,"").split(",").map(Jv)}const tp=ht({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...nl(),...Sl(),...ba()},"VSkeletonLoader"),ap=Ct()({name:"VSkeletonLoader",props:tp(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl((()=>e.color)),{dimensionStyles:r}=rl(e),{elevationClasses:i}=kl(e),{themeClasses:s}=Ca(e),{t:u}=ma(),c=t.computed((()=>Jv(R(e.type).join(","))))
return Et((()=>{const a=!l.default||e.loading,d=e.boilerplate||!a?{}:{ariaLive:"polite",ariaLabel:u(e.loadingText),role:"alert"}
return t.createVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,o.value,i.value],style:[n.value,a?r.value:{}]},d),[a?c.value:l.default?.()])})),{}}}),lp=Ct()({name:"VSlideGroupItem",props:zl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=jl(e,$n)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const op=ht({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...lo({location:"bottom"}),...vo(),...vl(),...Fl(),...ba(),...N(di({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),np=Ct()({name:"VSnackbar",props:op(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue"),{positionClasses:n}=po(e),{scopeId:r}=ai(),{themeClasses:i}=Ca(e),{colorClasses:s,colorStyles:u,variantClasses:c}=$l(e),{roundedClasses:d}=pl(e),v=function(e){const a=t.shallowRef(e())
let l=-1
...
return Et((()=>{const a=vi.filterProps(e),g=!!(l.default||l.text||e.text)
return t.createVNode(vi,t.mergeProps({ref:p,class:["v-snackbar",{"v-snackbar--active":o.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--timer":!!e.timer,"v-snackbar--vertical":e.vertical},I.value,n.value,e.class],style:[h.value,e.style]},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,contentProps:t.mergeProps({class:["v-snackbar__wrapper",i.value,s.value,d.value,c.value],style:[u.value],onPointerenter:S,onPointerleave:k},a.contentProps),persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",_disableGlobalStack:!0,onTouchstartPassive:x,onTouchend:N,onAfterLeave:C},r),{default:()=>[El(!1,"v-snackbar"),e.timer&&!m.value&&t.createVNode("div",{key:"timer",class:"v-snackbar__timer"},[t.createVNode(ro,{ref:f,color:"string"==typeof e.timer?e.timer:"info",max:e.timeout,"model-value":v.time.value},null)]),g&&t.createVNode("div",{key:"content",class:"v-snackbar__content",role:"status","aria-live":"polite"},[l.text?.()??e.text,l.default?.()]),l.actions&&t.createVNode(ol,{defaults:{VBtn:{variant:"text",ripple:!1,slim:!0}}},{default:()=>[t.createVNode("div",{class:"v-snackbar__actions"},[l.actions({isActive:o})])]})],activator:l.activator})})),mi({},p)}}),rp=ht({closable:[Boolean,String],closeText:{type:String,default:"$vuetify.dismiss"},modelValue:{type:Array,default:()=>[]},...N(op(),["modelValue"])},"VSnackbarQueue"),ip=Ct()({name:"VSnackbarQueue",props:rp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
Et((()=>{const a=!(!e.closable&&!o.actions),{modelValue:l,...n}=np.filterProps(e)
return t.createVNode(t.Fragment,null,[i.value&&!!s.value&&(o.default?t.createVNode(ol,{defaults:{VSnackbar:s.value}},{default:()=>[o.default({item:s.value})]}):t.createVNode(np,t.mergeProps(n,s.value,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,onAfterLeave:u}),{text:o.text?()=>o.text?.({item:s.value}):void 0,actions:a?()=>t.createVNode(t.Fragment,null,[o.actions?t.createVNode(ol,{defaults:{VBtn:v.value}},{default:()=>[o.actions({item:s.value,props:{onClick:d}})]}):t.createVNode($o,t.mergeProps(v.value,{onClick:d}),null)]):void 0}))])}))}}),sp=ht({autoDraw:Boolean,autoDrawDuration:[Number,String],autoDrawEasing:{type:String,default:"ease"},color:String,gradient:{type:Array,default:()=>[]},gradientDirection:{type:String,validator:e=>["top","bottom","left","right"].includes(e),default:"top"},height:{type:[String,Number],default:75},labels:{type:Array,default:()=>[]},labelSize:{type:[Number,String],default:7},lineWidth:{type:[String,Number],default:4},id:String,itemValue:{type:String,default:"value"},modelValue:{type:Array,default:()=>[]},min:[String,Number],max:[String,Number],padding:{type:[String,Number],default:8},showLabels:Boolean,smooth:[Boolean,String,Number],width:{type:[Number,String],default:300}},"Line"),up=ht({autoLineWidth:Boolean,...sp()},"VBarline"),cp=Ct()({name:"VBarline",props:up(),setup(e,a){let{slots:l}=a
...
function dp(e,t){let a=arguments.length>2&&void 0!==arguments[2]&&arguments[2],l=arguments.length>3&&void 0!==arguments[3]?arguments[3]:75
if(0===e.length)return""
const o=e.shift(),n=e[e.length-1]
return(a?`M${o.x} ${l-o.x+2} L${o.x} ${o.y}`:`M${o.x} ${o.y}`)+e.map(((a,l)=>{const n=e[l+1],r=e[l-1]||o,i=n&&(u=a,c=r,vp((s=n).x+c.x)===vp(2*u.x)&&vp(s.y+c.y)===vp(2*u.y))
var s,u,c
if(!n||i)return`L${a.x} ${a.y}`
const d=Math.min(pp(r,a),pp(n,a)),v=d/2<t?d/2:t,p=fp(r,a,v),f=fp(n,a,v)
return`L${p.x} ${p.y}S${a.x} ${a.y} ${f.x} ${f.y}`})).join("")+(a?`L${n.x} ${l-o.x+2} Z`:"")}function vp(e){return parseInt(e,10)}function pp(e,t){return Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2))}function fp(e,t,a){const l=e.x-t.x,o=e.y-t.y,n=Math.sqrt(l*l+o*o),r=l/n,i=o/n
return{x:t.x+r*a,y:t.y+i*a}}const mp=ht({fill:Boolean,...sp()},"VTrendline"),gp=Ct()({name:"VTrendline",props:mp(),setup(e,a){let{slots:l}=a
...
return dp(u(m.value,f.value),a,t,parseInt(e.height,10))}t.watch((()=>e.modelValue),(async()=>{if(await t.nextTick(),!e.autoDraw||!s.value)return
...
Et((()=>{const a="trend"===e.type?gp:cp,r="trend"===e.type?gp.filterProps(e):cp.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:o.value,style:n.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)}))}}),bp=ht({...yt(),...gi({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),Vp=Ct()({name:"VSpeedDial",props:bp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return Et((()=>{const a=hi.filterProps(e)
return t.createVNode(hi,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:e.class,style:e.style,contentClass:["v-speed-dial__content",i.value,e.contentClass],location:r.value,ref:n,transition:"fade-transition"}),{...l,default:a=>t.createVNode(ol,{defaults:{VBtn:{size:"small"}}},{default:()=>[t.createVNode(ml,{appear:!0,group:!0,transition:e.transition},{default:()=>[l.default?.(a)]})]})})})),{}}}),wp=Symbol.for("vuetify:v-stepper"),Sp=ht({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),kp=Ct()({name:"VStepperActions",props:Sp(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=ma()
function r(){l("click:prev")}function i(){l("click:next")}return Et((()=>{const a={onClick:r},l={onClick:i}
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode(ol,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode($o,a,null)]}),t.createVNode(ol,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode($o,l,null)]})])})),{}}}),xp=It("v-stepper-header"),Np=ht({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Ft,default:"$complete"},editable:Boolean,editIcon:{type:Ft,default:"$edit"},error:Boolean,errorIcon:{type:Ft,default:"$error"},icon:Ft,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),Cp=ht({...Np(),...zl()},"VStepperItem"),Ip=Ct()({name:"VStepperItem",directives:{Ripple:Eo},props:Cp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&El(!0,"v-stepper-item"),t.createVNode(Yo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Ql,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),_p=ht({...N(Ns(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),Pp=Ct()({name:"VStepperWindow",props:_p(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(wp,null),n=na(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return Et((()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),Bp=ht({...Ps()},"VStepperWindowItem"),Rp=Ct()({name:"VStepperWindowItem",props:Bp(),setup(e,a){let{slots:l}=a
return Et((()=>{const a=Bs.filterProps(e)
return t.createVNode(Bs,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)})),{}}}),Ap=ht({altLabels:Boolean,bgColor:String,completeIcon:Ft,editIcon:Ft,editable:Boolean,errorIcon:Ft,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},nonLinear:Boolean,flat:Boolean,...Cn()},"Stepper"),Tp=ht({...Ap(),...Ll({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...ou(),...k(Sp(),["prevText","nextText"])},"VStepper"),Dp=Ct()({name:"VStepper",props:Tp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=Hl(e,wp),{displayClasses:s,mobile:u}=In(e),{completeIcon:c,editIcon:d,errorIcon:v,color:f,editable:m,prevText:g,nextText:h}=t.toRefs(e),y=t.computed((()=>e.items.map(((t,a)=>({title:p(t,e.itemTitle,t),value:p(t,e.itemValue,a+1),raw:t}))))),b=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
return kt({VStepperItem:{editable:m,errorIcon:v,completeIcon:c,editIcon:d,prevText:g,nextText:h},VStepperActions:{color:f,disabled:t.computed((()=>e.disabled?e.disabled:0===b.value?"prev":b.value===o.value.length-1&&"next")),prevText:g,nextText:h}}),Et((()=>{const a=nu.filterProps(e),o=!(!l.header&&!e.items.length),i=e.items.length>0,c=!(e.hideActions||!i&&!l.actions)
return t.createVNode(nu,t.mergeProps(a,{color:e.bgColor,class:["v-stepper",{"v-stepper--alt-labels":e.altLabels,"v-stepper--flat":e.flat,"v-stepper--non-linear":e.nonLinear,"v-stepper--mobile":u.value},s.value,e.class],style:e.style}),{default:()=>[o&&t.createVNode(xp,{key:"stepper-header"},{default:()=>[y.value.map(((e,a)=>{let{raw:o,...n}=e
return t.createVNode(t.Fragment,null,[!!a&&t.createVNode(yr,null,null),t.createVNode(Ip,n,{default:l[`header-item.${n.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])}))]}),i&&t.createVNode(Pp,{key:"stepper-window"},{default:()=>[y.value.map((e=>t.createVNode(Rp,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),c&&(l.actions?.({next:n,prev:r})??t.createVNode(kp,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),Ep=ht({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...mn(),...Jo()},"VSwitch"),Fp=Ct()({name:"VSwitch",inheritAttrs:!1,props:Ep(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,l){let{attrs:o,slots:n}=l
...
function h(){r.value&&(r.value=!1)}function y(e){e.stopPropagation(),e.preventDefault(),v.value?.input?.click()}return Et((()=>{const[a,l]=B(o),m=gn.filterProps(e),b=en.filterProps(e)
return t.createVNode(gn,t.mergeProps({class:["v-switch",{"v-switch--flat":e.flat},{"v-switch--inset":e.inset},{"v-switch--indeterminate":r.value},s.value,e.class]},a,m,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,id:g.value,focused:u.value,style:e.style}),{...n,default:a=>{let{id:o,messagesId:s,isDisabled:u,isReadonly:m,isValid:g}=a
...
return t.createVNode(t.Fragment,null,[l,t.createVNode("div",{class:["v-switch__thumb",{"v-switch__thumb--filled":o||e.loading},e.inset||p?void 0:r.value],style:e.inset?void 0:i.value},[n.thumb?t.createVNode(ol,{defaults:{VIcon:{icon:o,size:"x-small"}}},{default:()=>[n.thumb({...V,icon:o})]}):t.createVNode(Ya,null,{default:()=>[e.loading?t.createVNode(uo,{name:"v-switch",active:!0,color:!1===g.value?void 0:f.value},{default:e=>n.loader?n.loader(e):t.createVNode(to,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):o&&t.createVNode(Ql,{key:String(o),icon:o,size:"x-small"},null)]})])])}})}})})),{}}}),$p=ht({color:String,height:[Number,String],window:Boolean,...yt(),...Sl(),...ea(),...vl(),...Ba(),...ba()},"VSystemBar"),Mp=Ct()({name:"VSystemBar",props:$p(),setup(e,a){let{slots:l}=a
...
return Et((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value,e.class],style:[r.value,d.value,u.value,e.style]},l))),{}}}),Op=Symbol.for("vuetify:v-tabs"),Lp=ht({fixed:Boolean,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...N(Fo({selectedClass:"v-tab--selected",variant:"text"}),["active","block","flat","location","position","symbol"])},"VTab"),zp=Ct()({name:"VTab",props:Lp(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createVNode($o,t.mergeProps({symbol:Op,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),mi({},i)}}),jp=ht({...N(Ns(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Hp=Ct()({name:"VTabsWindow",props:jp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Op,null),n=na(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return Et((()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),Wp=ht({...Ps()},"VTabsWindowItem"),Up=Ct()({name:"VTabsWindowItem",props:Wp(),setup(e,a){let{slots:l}=a
return Et((()=>{const a=Bs.filterProps(e)
return t.createVNode(Bs,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)})),{}}})
const Yp=ht({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...Mn({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Al(),...Ba()},"VTabs"),Gp=Ct()({name:"VTabs",props:Yp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=na(e,"modelValue"),r=t.computed((()=>function(e){return e?e.map((e=>g(e)?e:{text:e,value:e})):[]}(e.items))),{densityClasses:i}=Tl(e),{backgroundColorClasses:s,backgroundColorStyles:u}=dl((()=>e.bgColor)),{scopeId:c}=ai()
return kt({VTab:{color:t.toRef((()=>e.color)),direction:t.toRef((()=>e.direction)),stacked:t.toRef((()=>e.stacked)),fixed:t.toRef((()=>e.fixedTabs)),sliderColor:t.toRef((()=>e.sliderColor)),hideSlider:t.toRef((()=>e.hideSlider))}}),Et((()=>{const a=On.filterProps(e),d=!!(o.window||e.items.length>0)
return t.createVNode(t.Fragment,null,[t.createVNode(On,t.mergeProps(a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},i.value,s.value,e.class],style:[{"--v-tabs-height":m(e.height)},u.value,e.style],role:"tablist",symbol:Op},c,l),{default:()=>[o.default?.()??r.value.map((e=>o.tab?.({item:e})??t.createVNode(zp,t.mergeProps(e,{key:e.text,value:e.value}),{default:o[`tab.${e.value}`]?()=>o[`tab.${e.value}`]?.({item:e}):void 0})))]}),d&&t.createVNode(Hp,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,key:"tabs-window"},c),{default:()=>[r.value.map((e=>o.item?.({item:e})??t.createVNode(Up,{value:e.value},{default:()=>o[`item.${e.value}`]?.({item:e})}))),o.window?.()]})])})),{}}}),qp=ht({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...mn(),...ki()},"VTextarea"),Kp=Ct()({name:"VTextarea",directives:{Intersect:hl},inheritAttrs:!1,props:qp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
return t.watchEffect((()=>{e.autoGrow||(N.value=Number(e.rows))})),t.onMounted(I),t.watch(r,I),t.watch((()=>e.rows),I),t.watch((()=>e.maxRows),I),t.watch((()=>e.density),I),t.watch(x,(e=>{e?(_=new ResizeObserver(I),_.observe(x.value)):_?.disconnect()})),t.onBeforeUnmount((()=>{_?.disconnect()})),Et((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,m]=B(l),{modelValue:I,..._}=gn.filterProps(e),P=xi.filterProps(e)
return t.createVNode(gn,t.mergeProps({ref:p,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow,"v-input--plain-underlined":C.value},e.class],style:e.style},s,_,{centerAffix:1===N.value&&!C.value,focused:i.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:s,isReadonly:c,isValid:d}=a
return t.createVNode(xi,t.mergeProps({ref:f,style:{"--v-textarea-control-height":g.value},onClick:V,onMousedown:w,"onClick:clear":S,"onClick:prependInner":e["onClick:prependInner"],"onClick:appendInner":e["onClick:appendInner"]},P,{id:l.value,active:y.value||s.value,centerAffix:1===N.value&&!C.value,dirty:s.value||e.dirty,disabled:o.value,focused:i.value,error:!1===d.value}),{...n,default:a=>{let{props:{class:l,...n}}=a
return t.createVNode(t.Fragment,null,[e.prefix&&t.createVNode("span",{class:"v-text-field__prefix"},[e.prefix]),t.withDirectives(t.createVNode("textarea",t.mergeProps({ref:h,class:l,value:r.value,onInput:k,autofocus:e.autofocus,readonly:c.value,disabled:o.value,placeholder:e.placeholder,rows:e.rows,name:e.name,onFocus:b,onBlur:u},n,m),null),[[t.resolveDirective("intersect"),{handler:v},null,{once:!0}]]),e.autoGrow&&t.withDirectives(t.createVNode("textarea",{class:[l,"v-textarea__sizer"],id:`${n.id}-sizer`,"onUpdate:modelValue":e=>r.value=e,ref:x,readonly:!0,"aria-hidden":"true"},null),[[t.vModelText,r.value]]),e.suffix&&t.createVNode("span",{class:"v-text-field__suffix"},[e.suffix])])}})},details:o?l=>t.createVNode(t.Fragment,null,[n.details?.(l),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(bi,{active:e.persistentCounter||i.value,value:c.value,max:d.value,disabled:e.disabled},n.counter)])]):void 0})})),mi({},p,f,h)}}),Xp=ht({withBackground:Boolean,...yt(),...ba(),...Ba()},"VThemeProvider"),Zp=Ct()({name:"VThemeProvider",props:Xp(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=Ca(e)
return()=>e.withBackground?t.createVNode(e.tag,{class:["v-theme-provider",o.value,e.class],style:e.style},{default:()=>[l.default?.()]}):l.default?.()}}),Qp=ht({dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:Ft,iconColor:String,lineColor:String,...yt(),...vl(),...Kl(),...Sl()},"VTimelineDivider"),Jp=Ct()({name:"VTimelineDivider",props:Qp(),setup(e,a){let{slots:l}=a
...
case"end":return t[1]
default:return null}}))
return Et((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,i.value,r.value,e.class],style:[{"--v-timeline-line-thickness":m(e.lineThickness)},e.style]},l))),{}}}),of=ht({...yt(),...Fl({variant:"text"})},"VToolbarItems"),nf=Ct()({name:"VToolbarItems",props:of(),setup(e,a){let{slots:l}=a
return kt({VBtn:{color:t.toRef((()=>e.color)),height:"inherit",variant:t.toRef((()=>e.variant))}}),Et((()=>t.createVNode("div",{class:["v-toolbar-items",e.class],style:e.style},[l.default?.()]))),{}}}),rf=ht({id:String,interactive:Boolean,text:String,...N(di({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:null}),["absolute","persistent"])},"VTooltip"),sf=Ct()({name:"VTooltip",props:rf(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=na(e,"modelValue"),{scopeId:n}=ai(),r=t.useId(),i=t.toRef((()=>e.id||`v-tooltip-${r}`)),s=t.ref(),u=t.computed((()=>e.location.split(" ").length>1?e.location:e.location+" center")),c=t.computed((()=>"auto"===e.origin||"overlap"===e.origin||e.origin.split(" ").length>1||e.location.split(" ").length>1?e.origin:e.origin+" center")),d=t.toRef((()=>null!=e.transition?e.transition:o.value?"scale-transition":"fade-transition")),v=t.computed((()=>t.mergeProps({"aria-describedby":i.value},e.activatorProps)))
return Et((()=>{const a=vi.filterProps(e)
return t.createVNode(vi,t.mergeProps({ref:s,class:["v-tooltip",{"v-tooltip--interactive":e.interactive},e.class],style:e.style,id:i.value},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,transition:d.value,absolute:!0,location:u.value,origin:c.value,persistent:!0,role:"tooltip",activatorProps:v.value,_disableGlobalStack:!0},n),{activator:l.activator,default:function(){for(var t=arguments.length,a=new Array(t),o=0;o<t;o++)a[o]=arguments[o]
return l.default?.(...a)??e.text}})})),mi({},s)}}),uf=Ct()({name:"VValidation",props:pn(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=fn(e,"validation")
return()=>a.default?.(l)}})
var cf=Object.freeze({__proto__:null,VAlert:Wo,VAlertTitle:zo,VApp:Pa,VAppBar:Bl,VAppBarNavIcon:Oo,VAppBarTitle:Lo,VAutocomplete:Wi,VAvatar:Yo,VBadge:Yi,VBanner:Zi,VBannerActions:qi,VBannerText:Ki,VBottomNavigation:Ji,VBottomSheet:ls,VBreadcrumbs:us,VBreadcrumbsDivider:ns,VBreadcrumbsItem:is,VBtn:$o,VBtnGroup:Ol,VBtnToggle:Gl,VCard:bs,VCardActions:cs,VCardItem:ms,VCardSubtitle:vs,VCardText:hs,VCardTitle:ps,VCarousel:_s,VCarouselItem:As,VCheckbox:yn,VCheckboxBtn:an,VChip:Wn,VChipGroup:jn,VClassIcon:jt,VCode:Ts,VCol:sd,VColorPicker:Iu,VCombobox:Pu,VComponentIcon:Ot,VConfirmEdit:Ru,VContainer:ed,VCounter:bi,VDataIterator:pc,VDataTable:qc,VDataTableFooter:hc,VDataTableHeaders:Dc,VDataTableRow:Mc,VDataTableRows:Lc,VDataTableServer:Qc,VDataTableVirtual:Xc,VDatePicker:Od,VDatePickerControls:_d,VDatePickerHeader:Bd,VDatePickerMonth:Td,VDatePickerMonths:Ed,VDatePickerYears:$d,VDefaultsProvider:ol,VDialog:ts,VDialogBottomTransition:Ha,VDialogTopTransition:Wa,VDialogTransition:Oa,VDivider:yr,VEmptyState:zd,VExpandTransition:tl,VExpandXTransition:al,VExpansionPanel:qd,VExpansionPanelText:Wd,VExpansionPanelTitle:Yd,VExpansionPanels:Zd,VFab:Jd,VFabTransition:ja,VFadeTransition:Ua,VField:xi,VFieldLabel:wi,VFileInput:tv,VFooter:lv,VForm:nv,VHover:iv,VIcon:Ql,VImg:bl,VInfiniteScroll:cv,VInput:gn,VItem:fv,VItemGroup:pv,VKbd:mv,VLabel:qo,VLayout:hv,VLayoutItem:bv,VLazy:wv,VLigatureIcon:zt,VList:_r,VListGroup:ur,VListImg:Pr,VListItem:fr,VListItemAction:Rr,VListItemMedia:Tr,VListItemSubtitle:dr,VListItemTitle:vr,VListSubheader:gr,VLocaleProvider:kv,VMain:Nv,VMenu:hi,VMessages:nn,VNavigationDrawer:Dv,VNoSsr:Ev,VNumberInput:$v,VOtpInput:Ov,VOverlay:vi,VPagination:mc,VParallax:zv,VProgressCircular:to,VProgressLinear:ro,VRadio:Hv,VRadioGroup:Uv,VRangeSlider:Gv,VRating:Kv,VResponsive:sl,VRow:Nd,VScaleTransition:Ya,VScrollXReverseTransition:qa,VScrollXTransition:Ga,VScrollYReverseTransition:Xa,VScrollYTransition:Ka,VSelect:$i,VSelectionControl:en,VSelectionControlGroup:Qo,VSheet:nu,VSkeletonLoader:ap,VSlideGroup:On,VSlideGroupItem:lp,VSlideXReverseTransition:Qa,VSlideXTransition:Za,VSlideYReverseTransition:el,VSlideYTransition:Ja,VSlider:Qs,VSnackbar:np,VSnackbarQueue:ip,VSpacer:Cd,VSparkline:yp,VSpeedDial:Vp,VStepper:Dp,VStepperActions:kp,VStepperHeader:xp,VStepperItem:Ip,VStepperWindow:Pp,VStepperWindowItem:Rp,VSvgIcon:Lt,VSwitch:Fp,VSystemBar:Mp,VTab:zp,VTable:jc,VTabs:Gp,VTabsWindow:Hp,VTabsWindowItem:Up,VTextField:Ii,VTextarea:Kp,VThemeProvider:Zp,VTimeline:lf,VTimelineItem:tf,VToolbar:Cl,VToolbarItems:nf,VToolbarTitle:Aa,VTooltip:sf,VValidation:uf,VVirtualScroll:Ti,VWindow:Cs,VWindowItem:Bs})
function df(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const vf={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:o,immediate:n,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),o&&df(e,t)}))
n&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:df}
const pf={mounted:function(e,t){const a=t.value,l={passive:!t.modifiers?.active}
window.addEventListener("resize",a,l),e._onResize=Object(e._onResize),e._onResize[t.instance.$.uid]={handler:a,options:l},t.modifiers?.quiet||a()},unmounted:function(e,t){if(!e._onResize?.[t.instance.$.uid])return
const{handler:a,options:l}=e._onResize[t.instance.$.uid]
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}}
function ff(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,o="object"==typeof l&&l.options||{passive:!0},n="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",n,o),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:n,options:o,target:a?void 0:r})}function mf(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:o=e}=e._onScroll[t.instance.$.uid]
o.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const gf={mounted:ff,unmounted:mf,updated:function(e,t){t.value!==t.oldValue&&(mf(e,t),ff(e,t))}}
const hf=function(e,a){const l=function(e,a){return function(l,o,n){const r="function"==typeof a?a(o):a,i=o.value?.text??o.value??r?.text,s=g(o.value)?o.value:{},u=()=>i??l.textContent,c=(n.ctx===o.instance.$?function(e,t){const a=new Set,l=t=>{for(const o of t){if(!o)continue
...
return{mounted:l,updated:l,unmounted(e){t.render(null,e)}}}(sf,(e=>({activator:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value})))
var yf=Object.freeze({__proto__:null,ClickOutside:ui,Intersect:hl,Mutate:vf,Resize:pf,Ripple:Eo,Scroll:gf,Tooltip:hf,Touch:Ss})
function bf(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:l,...o}=e,n=$(l,o),{aliases:r={},components:i={},directives:s={}}=n,u=t.effectScope()
return u.run((()=>{const e=function(e){return t.ref(e)}(n.defaults),l=function(e,l){const{thresholds:o,mobileBreakpoint:n}=Sn(e),r=t.shallowRef(xn(l)),i=t.shallowRef(Nn(l)),s=t.reactive({}),u=t.shallowRef(kn(l))
function c(){r.value=xn(),u.value=kn()}return t.watchEffect((()=>{const e=u.value<o.sm,t=u.value<o.md&&!e,a=u.value<o.lg&&!(t||e),l=u.value<o.xl&&!(a||t||e),c=u.value<o.xxl&&!(l||a||t||e),d=u.value>=o.xxl,v=e?"xs":t?"sm":a?"md":l?"lg":c?"xl":"xxl",p="number"==typeof n?n:o[n],f=u.value<p
s.xs=e,s.sm=t,s.md=a,s.lg=l,s.xl=c,s.xxl=d,s.smAndUp=!e,s.mdAndUp=!(e||t),s.lgAndUp=!(e||t||a),s.xlAndUp=!(e||t||a||l),s.smAndDown=!(a||l||c||d),s.mdAndDown=!(l||c||d),s.lgAndDown=!(c||d),s.xlAndDown=!d,s.name=v,s.height=r.value,s.width=u.value,s.mobile=f,s.mobileBreakpoint=n,s.platform=i.value,s.thresholds=o})),a&&(window.addEventListener("resize",c,{passive:!0}),t.onScopeDispose((()=>{window.removeEventListener("resize",c)}),!0)),{...t.toRefs(s),update:function(){c(),i.value=Nn()},ssr:!!l}}(n.display,n.ssr),o=Na(n.theme),c=Ht(n.icons),d=fa(n.locale),v=function(e,t){const a=$({adapter:Su,locale:{af:"af-ZA",bg:"bg-BG",ca:"ca-ES",ckb:"",cs:"cs-CZ",de:"de-DE",el:"el-GR",en:"en-US",et:"et-EE",fa:"fa-IR",fi:"fi-FI",hr:"hr-HR",hu:"hu-HU",he:"he-IL",id:"id-ID",it:"it-IT",ja:"ja-JP",ko:"ko-KR",lv:"lv-LV",lt:"lt-LT",nl:"nl-NL",no:"no-NO",pl:"pl-PL",pt:"pt-PT",ro:"ro-RO",ru:"ru-RU",sk:"sk-SK",sl:"sl-SI",srCyrl:"sr-SP",srLatn:"sr-SP",sv:"sv-SE",th:"th-TH",tr:"tr-TR",az:"az-AZ",uk:"uk-UA",vi:"vi-VN",zhHans:"zh-CN",zhHant:"zh-TW"}},e)
...
if(f.run((()=>{o.install(u)})),u.onUnmount((()=>f.stop())),u.provide(wt,e),u.provide(Vn,l),u.provide(ya,o),u.provide($t,c),u.provide(pa,d),u.provide(ku,v.options),u.provide(xu,v.instance),u.provide(_n,p),a&&n.ssr)if(u.$nuxt)u.$nuxt.hook("app:suspense:resolve",(()=>{l.update()}))
...
if(a&&e in a)return a[e]}bf.version="3.8.6"
const wf=function(){return bf({components:cf,directives:yf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},Sf="3.8.6"
