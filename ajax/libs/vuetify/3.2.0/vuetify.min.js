...
if(a&&e in a)return a[e]}yu.version="3.2.0"
const Vu=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return yu({components:tu,directives:su,...e})},Su="3.2.0"
Vu.version=Su,e.components=tu,e.createVuetify=Vu,e.directives=su,e.useDefaults=je,e.useDisplay=Wn,e.useLayout=st,e.useLocale=Dt,e.useRtl=Ot,e.useTheme=xt,e.version=Su}))
