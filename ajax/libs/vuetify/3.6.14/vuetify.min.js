...
t._clickOutside.lastMousedownWasOutside&&ai(e,t,a)&&setTimeout((()=>{li(e,a)&&l&&l(e)}),0)}(a,e,t),l=a=>{e._clickOutside.lastMousedownWasOutside=ai(a,e,t)}
oi(e,(e=>{e.addEventListener("click",a,!0),e.addEventListener("mousedown",l,!0)})),e._clickOutside||(e._clickOutside={lastMousedownWasOutside:!1}),e._clickOutside[t.instance.$.uid]={onClick:a,onMousedown:l}},unmounted(e,t){e._clickOutside&&(oi(e,(a=>{if(!a||!e._clickOutside?.[t.instance.$.uid])return
...
const i=ia(e,"modelValue"),s=t.computed({get:()=>i.value,set:t=>{t&&e.disabled||(i.value=t)}}),{themeClasses:u}=ka(e),{rtlClasses:c,isRtl:d}=ba(),{hasContent:v,onAfterLeave:p}=Zr(e,s),m=ul(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:g,localTop:h,stackStyles:y}=function(e,a,l){const o=yt("useStack"),n=!l,r=t.inject(Jr,void 0),i=t.reactive({activeChildren:new Set})
t.provide(Jr,i)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(s,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:b,activatorRef:V,target:w,targetEl:S,targetRef:k,activatorEvents:x,contentEvents:N,scrimEvents:C}=Gr(e,{isActive:s,isTop:h}),{teleportTarget:_}=function(e){return{teleportTarget:t.computed((()=>{const l=e()
if(!0===l||!a)return
...
return a instanceof ShadowRoot&&a})),{dimensionStyles:I}=ol(e),B=Kr(),{scopeId:P}=Qr()
...
function r(e){n.value?.(e)}return a&&ra((()=>!(!l.isActive.value||!e.locationStrategy)),(a=>{t.watch((()=>e.locationStrategy),a),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0})),window.addEventListener("resize",r,{passive:!0}),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(l,e,o)?.updateLocation:n.value=Rr[e.locationStrategy](l,e,o)?.updateLocation})),{contentStyles:o,updateLocation:n}}(e,{isRtl:d,contentEl:T,target:w,isActive:s})
...
let o
t.watchEffect((async()=>{o?.stop(),l.isActive.value&&e.scrollStrategy&&(o=t.effectScope(),await new Promise((e=>setTimeout(e))),o.active&&o.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(l,e,o):Lr[e.scrollStrategy]?.(l,e,o)})))})),t.onScopeDispose((()=>{o?.stop()}))}(e,{root:A,contentEl:T,targetEl:S,isActive:s,updateLocation:E}),a&&t.watch(s,(e=>{e?window.addEventListener("keydown",M):window.removeEventListener("keydown",M)}),{immediate:!0}),t.onBeforeUnmount((()=>{a&&window.removeEventListener("keydown",M)}))
const O=vo()
ra((()=>e.closeOnBack),(()=>{!function(e,l){let o,n,r=!1
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e?.beforeEach(((e,t,a)=>{mo?r?l(a):a():setTimeout((()=>r?l(a):a())),mo=!0})),n=e?.afterEach((()=>{mo=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(O,(t=>{g.value&&s.value?(t(!1),e.persistent?z():s.value=!1):t()}))}))
const L=t.ref()
function z(){e.noClickAnimation||T.value&&ge(T.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:At})}function j(){r("afterEnter")}function H(){p(),r("afterLeave")}return t.watch((()=>s.value&&(e.absolute||e.contained)&&null==_.value),(e=>{if(e){const e=Tt(A.value)
e&&e!==document.scrollingElement&&(L.value=e.scrollTop)}})),$t((()=>t.createVNode(t.Fragment,null,[o.activator?.({isActive:s.value,targetRef:k,props:t.mergeProps({ref:V},x.value,e.activatorProps)}),B.value&&v.value&&t.createVNode(t.Teleport,{disabled:!_.value,to:_.value},{default:()=>[t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},u.value,c.value,e.class],style:[y.value,{"--v-overlay-opacity":e.opacity,top:f(L.value)},e.style],ref:A},P,n),[t.createVNode(ri,t.mergeProps({color:m,modelValue:s.value&&!!e.scrim,ref:R},C.value),null),t.createVNode(pl,{appear:!0,persisted:!0,transition:e.transition,target:w.value,onAfterEnter:j,onAfterLeave:H},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:T,class:["v-overlay__content",e.contentClass],style:[I.value,D.value]},N.value,e.contentProps),[o.default?.({isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:F,closeConditional:$,include:()=>[b.value]}]])]})])]})]))),{activatorEl:b,scrimEl:R,target:w,animateClick:z,contentEl:T,globalTop:g,localTop:h,updateLocation:E}}}),ui=Symbol("Forwarded refs")
...
const{t:r}=ha(),i=ia(e,"modelValue",e.modelValue,(e=>P(e)),(t=>e.multiple||Array.isArray(e.modelValue)?t:t[0]??null)),{isFocused:s,focus:u,blur:c}=nn(e),d=t.computed((()=>"boolean"!=typeof e.showSize?e.showSize:void 0)),v=t.computed((()=>(i.value??[]).reduce(((e,t)=>{let{size:a=0}=t
...
if(a&&e in a)return a[e]}rf.version="3.6.14"
const uf=function(){return rf({components:Zp,directives:nf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},cf="3.6.14"
