...
return Ge((()=>{const[l,s]=Qa(e),v=!!(e.label||a.label||a.prepend)
...
return Ge((()=>{const[l,f]=Qa(e),m=!!(e.label||a.label||a.prepend)
...
return{install:a}}
Ys.version="3.0.0-beta.12"
const Xs=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Ys({components:Ms,directives:Us,...e})},Gs="3.0.0-beta.12"
