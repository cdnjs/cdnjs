...
t.watchEffect((()=>{r.value.hide?r.value.inverted?n.value=s.value>u.value:n.value=c.value||s.value<u.value:n.value=!0}))
...
return ct((()=>{const a=n.isLink.value?"a":e.tag
return t.createVNode(a,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,"v-breadcrumbs-item--link":n.isLink.value,[`${e.activeClass}`]:r.value&&e.activeClass},s.value,e.class],style:[u.value,e.style],href:n.href.value,"aria-current":r.value?"page":void 0,onClick:n.navigate},{default:()=>[l.default?.()??e.title]})})),{}}}),ii=a({activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:gl,items:{type:Array,default:()=>[]},...l(),...Ja(),...ja(),...Zt({tag:"ul"})},"VBreadcrumbs"),si=Ge()({name:"VBreadcrumbs",props:ii(),setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:["v-breadcrumbs",o.value,r.value,i.value,e.class],style:[n.value,e.style]},{default:()=>[a&&t.createVNode("div",{key:"prepend",class:"v-breadcrumbs__prepend"},[l.prepend?t.createVNode(xa,{key:"prepend-defaults",disabled:!e.icon,defaults:{VIcon:{icon:e.icon,start:!0}}},l.prepend):t.createVNode(Bl,{key:"prepend-icon",start:!0,icon:e.icon},null)]),s.value.map(((e,a,o)=>{let{item:n,raw:r}=e
...
const{thumbColor:r,step:i,vertical:s,disabled:u,thumbSize:c,thumbLabel:d,direction:v,readonly:f,elevation:m,isReversed:g,horizontalDirection:y,mousePressed:b,decimals:V}=n,{textColorClasses:w,textColorStyles:S}=Da(r),{pageup:k,pagedown:x,end:C,home:N,left:_,right:I,down:B,up:R}=h,A=[k,x,C,N,_,I,B,R],E=t.computed((()=>i.value?[1,2,3]:[1,5,10]))
function T(t){const a=function(t,a){if(!A.includes(t.key))return
t.preventDefault()
const l=i.value||.1,o=(e.max-e.min)/l
if([_,I,B,R].includes(t.key)){const e=("rtl"===y.value?[_,R]:[I,R]).includes(t.key)?1:-1,o=t.shiftKey?2:t.ctrlKey?1:0
a+=e*l*E.value[o]}else t.key===N?a=e.min:t.key===C?a=e.max:a-=(t.key===x?1:-1)*l*(o>100?o/10:10)
return Math.max(e.min,Math.min(e.max,a))}(t,e.modelValue)
null!=a&&o("update:modelValue",a)}return ct((()=>{const a=p(s.value||g.value?100-e.position:e.position,"%"),{elevationClasses:o}=za(t.computed((()=>u.value?void 0:m.value)))
return t.createVNode("div",{class:["v-slider-thumb",{"v-slider-thumb--focused":e.focused,"v-slider-thumb--pressed":e.focused&&b.value},e.class],style:[{"--v-slider-thumb-position":a,"--v-slider-thumb-size":p(c.value)},e.style],role:"slider",tabindex:u.value?-1:0,"aria-valuemin":e.min,"aria-valuemax":e.max,"aria-valuenow":e.modelValue,"aria-readonly":!!f.value,"aria-orientation":v.value,onKeydown:f.value?void 0:T},[t.createVNode("div",{class:["v-slider-thumb__surface",w.value,o.value],style:{...S.value}},null),t.withDirectives(t.createVNode("div",{class:["v-slider-thumb__ripple",w.value],style:S.value},null),[[t.resolveDirective("ripple"),e.ripple,null,{circle:!0,center:!0}]]),t.createVNode(va,{origin:"bottom center"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-slider-thumb__label-container"},[t.createVNode("div",{class:["v-slider-thumb__label"]},[t.createVNode("div",null,[l["thumb-label"]?.({modelValue:e.modelValue})??e.modelValue.toFixed(i.value?V.value:1)])])]),[[t.vShow,d.value&&e.focused||"always"===d.value]])]})])})),{}}}),Gi=a({start:{type:Number,required:!0},stop:{type:Number,required:!0},...l()},"VSliderTrack"),Xi=Ge()({name:"VSliderTrack",props:Gi(),emits:{},setup(e,a){let{slots:l}=a
const o=t.inject(Oi)
...
const{themeClasses:o}=Wt(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Fa(t.toRef(e,"color")),{borderClasses:i}=La(e),{elevationClasses:s}=za(e),{roundedClasses:u}=Ha(e),c=t.shallowRef(32),{resizeRef:d}=dt((e=>{e.length&&(c.value=e[0].target.clientHeight)})),v=t.computed((()=>"auto"===e.height?c.value:parseInt(e.height,10))),{layoutItemStyles:p}=ht({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:v,elementSize:t.computed((()=>"auto"===e.height?void 0:v.value)),active:t.computed((()=>e.app)),absolute:t.toRef(e,"absolute")})
return ct((()=>t.createVNode(e.tag,{ref:d,class:["v-footer",o.value,n.value,i.value,s.value,u.value,e.class],style:[r.value,e.app?p.value:void 0,e.style]},l))),{}}}),zs=a({...l(),...Mo()},"VForm"),js=Ge()({name:"VForm",props:zs(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return l-1}(t+e/2),s=Math.round(f.value/3);-1===l&&n<=o.value+2*s-1?o.value=x(n-s,0,a.value.length):1===l&&n>=o.value+2*s-1&&(o.value=x(n-s,0,a.value.length-f.value)),g=i.value.scrollTop},handleItemResize:function(e,t){r.value=Math.max(r.value,t),p[e]=t,d.set(a.value[e],t)}}}const Dc=a({items:{type:Array,default:()=>[]},...Lc(),...l(),...Ca()},"VVirtualScroll"),Fc=Ge()({name:"VVirtualScroll",props:Dc(),setup(e,a){let{slots:l}=a
...
if(a&&e in a)return a[e]}ld.version="3.3.4"
const nd=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return ld({components:Oc,directives:Gc,...e})},rd="3.3.4"
