...
return At((()=>t.createVNode(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},o.value,n.value,s.value,u.value,c.value,i.value,e.class],style:[r.value,d.value,e.style]},{default:()=>[l.default?t.createVNode(Fa,{key:"content-defaults",defaults:{VImg:{cover:!0,image:e.image},VIcon:{icon:e.icon}}},{default:()=>[l.default()]}):e.image?t.createVNode(Za,{key:"image",src:e.image,alt:"",cover:!0},null):e.icon?t.createVNode(zl,{key:"icon",icon:e.icon},null):e.text,pl(!1,"v-avatar")]}))),{}}}),Do=a({text:String,onClick:K(),...l(),...ta()},"VLabel"),Fo=gt()({name:"VLabel",props:Do(),setup(e,a){let{slots:l}=a
...
return a}return e}(a,!k(t,["a"])&&1===e.a)}return e}(t,e.modelValue):null)),n=t.computed((()=>o.value?{...o.value,h:l.value??o.value.h}:null)),{rtlClasses:r}=Qt()
let i=!0
...
return t.createVNode(As,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",r.value,e.class],style:[{"--v-color-picker-color-hsv":Je({...n.value??us,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(ss,{key:"canvas",color:n.value,"onUpdate:color":s,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(_s,{key:"preview",color:n.value,"onUpdate:color":s,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(ms,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:n.value,"onUpdate:color":s,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(Ps,{key:"swatches",color:n.value,"onUpdate:color":s,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
...
if(a&&e in a)return a[e]}gp.version="3.5.4"
const yp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return gp({components:sp,directives:mp,...e})},bp="3.5.4"
