...
return t.watchEffect((()=>{for(const e in l.value)a[e]=l.value[e]}),{flush:"sync"}),t.toRefs(a)}function P(e,t){return e.includes(t)}const L=/^on[^a-z]/,O=e=>L.test(e),F=[Function,Array]
...
return l||(l=P(D,a)?"start":P(j,a)?"top":"center"),{side:W(a,t),align:W(l,t)}}function W(e,t){return"start"===e?t?"right":"left":"end"===e?t?"left":"right":e}function U(e){return{side:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.side],align:e.align}}function Y(e){return{side:e.side,align:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.align]}}function G(e){return{side:e.align,align:e.side}}function X(e){return P(D,e.side)?"y":"x"}class q{constructor(e){let{x:t,y:a,width:l,height:o}=e
...
return void 0===o?`rgb(${t}, ${a}, ${l})`:`rgba(${t}, ${a}, ${l}, ${o})`}(he(e))}function ke(e){const t=Math.round(e).toString(16)
return("00".substr(0,2-t.length)+t).toUpperCase()}function we(e){let{r:t,g:a,b:l,a:o}=e
return`#${[ke(t),ke(a),ke(l),void 0!==o?ke(Math.round(255*o)):""].join("")}`}function xe(e){e=_e(e)
let[t,a,l,o]=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:1
const a=[]
let l=0
for(;l<e.length;)a.push(e.substr(l,t)),l+=t
return a}(e,2).map((e=>parseInt(e,16)))
return o=void 0===o?o:o/255,{r:t,g:a,b:l,a:o}}function Ce(e){return ye(xe(e))}function Ne(e){return we(he(e))}function _e(e){return e.startsWith("#")&&(e=e.slice(1)),3!==(e=e.replace(/([^0-9a-f])/gi,"F")).length&&4!==e.length||(e=e.split("").map((e=>e+e)).join("")),6!==e.length&&(e=N(N(e,6),8,"F")),e}function Ie(e,t){const a=pe(ue(e))
...
const t=Re(e).type
return B(t?.aliasName||t?.name)}let Te=0,Pe=new WeakMap
function Le(){const e=Re("getUid")
if(Pe.has(e))return Pe.get(e)
{const t=Te++
return Pe.set(e,t),t}}function Oe(e,t){return a=>Object.keys(e).reduce(((l,o)=>{const n="object"==typeof e[o]&&null!=e[o]&&!Array.isArray(e[o])?e[o]:{type:e[o]}
return l[o]=a&&o in a?{...n,default:a[o]}:n,t&&!l[o].source&&(l[o].source=t),l}),{})}Le.reset=()=>{Te=0,Pe=new WeakMap}
...
return"string"!=typeof t||function(e,t){return void 0!==e.props?.[t]||void 0!==e.props?.[B(t)]}(n.vnode,t)?a:r.value?.[t]??o.value.global?.[t]??a}}),s=t.shallowRef()
...
t.onMounted((()=>{k.value=!0})),t.provide(Je,{register:(e,a)=>{let{id:r,order:d,position:v,layoutSize:g,elementSize:h,active:y,disableTransitions:V,absolute:w}=a
...
for(const r of m(l.variations[a],1))o.colors[`${e}-${a}-${r}`]=we(n(ge(t),r))}}for(const e of Object.keys(o.colors)){if(/^on-[a-z]/.test(e)||o.colors[`on-${e}`])continue
...
function At(e){const a=e?.adapter&&(l=e?.adapter,null!=l.name)?e?.adapter:function(e){const a=t.ref(e?.locale??"en"),l=t.ref(e?.fallback??"en"),o=t.ref({en:kt,...e?.messages})
...
return{isRtl:e.isRtl,rtlClasses:e.rtlClasses}}const Pt=We()({name:"VApp",props:{...et({fullHeight:!0}),...ft()},setup(e,a){let{slots:l}=a
...
return t.createVNode(ca,{transition:e.transition,appear:!0},{default:()=>[t.withDirectives(l?t.createVNode("picture",{class:"v-img__picture"},[l,a]):a,[[t.vShow,"loaded"===s.value]])]})},k=()=>t.createVNode(ca,{transition:e.transition},{default:()=>[d.value.lazySrc&&"loaded"!==s.value&&t.createVNode("img",{class:["v-img__img","v-img__img--preload",V.value],src:d.value.lazySrc,alt:e.alt},null)]}),w=()=>n.placeholder?t.createVNode(ca,{transition:e.transition,appear:!0},{default:()=>[("loading"===s.value||"error"===s.value&&!n.error)&&t.createVNode("div",{class:"v-img__placeholder"},[n.placeholder()])]}):null,x=()=>n.error?t.createVNode(ca,{transition:e.transition,appear:!0},{default:()=>["error"===s.value&&t.createVNode("div",{class:"v-img__error"},[n.error()])]}):null,C=()=>e.gradient?t.createVNode("div",{class:"v-img__gradient",style:{backgroundImage:`linear-gradient(${e.gradient})`}},null):null,N=t.ref(!1)
{const e=t.watch(v,(t=>{t&&(requestAnimationFrame((()=>{requestAnimationFrame((()=>{N.value=!0}))})),e())}))}return Ze((()=>t.withDirectives(t.createVNode(ra,{class:["v-img",{"v-img--booting":!N.value}],style:{width:g("auto"===e.width?u.value:e.width)},aspectRatio:v.value,"aria-label":e.alt,role:e.alt?"img":void 0},{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(S,null,null),t.createVNode(k,null,null),t.createVNode(C,null,null),t.createVNode(w,null,null),t.createVNode(x,null,null)]),default:n.default}),[[t.resolveDirective("intersect"),{handler:p,options:e.options},null,{once:!0}]]))),{currentSrc:r,image:i,state:s,naturalWidth:u,naturalHeight:c}}}),va=Oe({tag:{type:String,default:"div"}},"tag"),pa=Oe({text:String,...va()},"v-toolbar-title"),fa=We()({name:"VToolbarTitle",props:pa(),setup(e,a){let{slots:l}=a
...
return e.value.background&&(me(e.value.background)?a.backgroundColor=e.value.background:t.push(`bg-${e.value.background}`)),e.value.text&&(me(e.value.text)?(a.color=e.value.text,a.caretColor=e.value.text):t.push(`text-${e.value.text}`)),{colorClasses:t,colorStyles:a}}))}function ka(e,a){const l=t.computed((()=>({text:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=Sa(l)
return{textColorClasses:o,textColorStyles:n}}function wa(e,a){const l=t.computed((()=>({background:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=Sa(l)
...
function Pa(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Ee()
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const La=Oe({divided:Boolean,...ma(),...$a(),...ha(),...ba(),...va(),...ft(),...Ta()},"v-btn-group"),Oa=We()({name:"VBtnGroup",props:La(),setup(e,a){let{slots:l}=a
...
return T((()=>{let a,l
return P(al,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:g(e.size),height:g(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const nl=Oe({color:String,start:Boolean,end:Boolean,icon:Ga,...ll(),...va({tag:"i"}),...ft()},"v-icon"),rl=We()({name:"VIcon",props:nl(),setup(e,a){let l,{attrs:o,slots:n}=a
...
return{component:a.sets[n??a.defaultSet].component,icon:r}}))}})(l||e),{sizeClasses:s}=ol(e),{textColorClasses:u,textColorStyles:c}=ka(t.toRef(e,"color"))
...
const o=2*Math.PI*20,n=t.ref(),{themeClasses:i}=ht(e),{sizeClasses:s,sizeStyles:u}=ol(e),{textColorClasses:c,textColorStyles:d}=ka(t.toRef(e,"color")),{textColorClasses:v,textColorStyles:p}=ka(t.toRef(e,"bgColor")),{intersectionRef:f,isIntersecting:m}=il(),{resizeRef:h,contentRect:y}=r(),b=t.computed((()=>Math.max(0,Math.min(100,parseFloat(e.modelValue))))),V=t.computed((()=>Number(e.width))),S=t.computed((()=>u.value?Number(e.size):y.value?y.value.width:Math.max(V.value,32))),k=t.computed((()=>20/(1-V.value/S.value)*2)),w=t.computed((()=>V.value/S.value*k.value)),x=t.computed((()=>g((100-b.value)/100*o)))
return t.watchEffect((()=>{f.value=n.value,h.value=n.value})),Ze((()=>t.createVNode(e.tag,{ref:n,class:["v-progress-circular",{"v-progress-circular--indeterminate":!!e.indeterminate,"v-progress-circular--visible":m.value,"v-progress-circular--disable-shrink":"disable-shrink"===e.indeterminate},i.value,s.value,c.value],style:[u.value,d.value],role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":e.indeterminate?void 0:b.value},{default:()=>[t.createVNode("svg",{style:{transform:`rotate(calc(-90deg + ${Number(e.rotate)}deg))`},xmlns:"http://www.w3.org/2000/svg",viewBox:`0 0 ${k.value} ${k.value}`},[t.createVNode("circle",{class:["v-progress-circular__underlay",v.value],style:p.value,fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":w.value,"stroke-dasharray":o,"stroke-dashoffset":0},null),t.createVNode("circle",{class:"v-progress-circular__overlay",fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":w.value,"stroke-dasharray":o,"stroke-dashoffset":x.value},null)]),l.default&&t.createVNode("div",{class:"v-progress-circular__content"},[l.default({value:b.value})])]}))),{}}}),ul=Symbol("rippleStop")
...
function Vl(e){bl||e.keyCode!==y.enter&&e.keyCode!==y.space||(bl=!0,ml(e))}function Sl(e){bl=!1,hl(e)}function kl(e){bl&&(bl=!1,hl(e))}function wl(e,t,a){const{value:l,modifiers:o}=t,n=fl(l)
...
e.addEventListener("touchstart",ml,{passive:!0}),e.addEventListener("touchend",hl,{passive:!0}),e.addEventListener("touchmove",yl,{passive:!0}),e.addEventListener("touchcancel",hl),e.addEventListener("mousedown",ml),e.addEventListener("mouseup",hl),e.addEventListener("mouseleave",hl),e.addEventListener("keydown",Vl),e.addEventListener("keyup",Sl),e.addEventListener("blur",kl),e.addEventListener("dragstart",hl,{passive:!0})}else!n&&a&&xl(e)}function xl(e){e.removeEventListener("mousedown",ml),e.removeEventListener("touchstart",ml),e.removeEventListener("touchend",hl),e.removeEventListener("touchmove",yl),e.removeEventListener("touchcancel",hl),e.removeEventListener("mouseup",hl),e.removeEventListener("mouseleave",hl),e.removeEventListener("keydown",Vl),e.removeEventListener("keyup",Sl),e.removeEventListener("dragstart",hl),e.removeEventListener("blur",kl)}const Cl={mounted:function(e,t){wl(e,t,!1)},unmounted:function(e){delete e._ripple,xl(e)},updated:function(e,t){if(t.value===t.oldValue)return
wl(e,t,fl(t.oldValue))}},Nl={center:"center",top:"bottom",bottom:"top",left:"right",right:"left"},_l=Oe({location:String},"location")
...
const o=St(e,"modelValue"),{isRtl:n}=Tt(),{themeClasses:r}=ht(e),{locationStyles:i}=Il(e),{textColorClasses:s,textColorStyles:u}=ka(e,"color"),{backgroundColorClasses:c,backgroundColorStyles:d}=wa(t.computed((()=>e.bgColor||e.color))),{backgroundColorClasses:v,backgroundColorStyles:p}=wa(e,"color"),{roundedClasses:f}=Va(e),{intersectionRef:m,isIntersecting:h}=il(),y=t.computed((()=>parseInt(e.max,10))),b=t.computed((()=>parseInt(e.height,10))),V=t.computed((()=>parseFloat(e.bufferValue)/y.value*100)),S=t.computed((()=>parseFloat(o.value)/y.value*100)),k=t.computed((()=>n.value!==e.reverse)),w=t.computed((()=>e.indeterminate?"fade-transition":"slide-x-transition")),x=t.computed((()=>null==e.bgOpacity?e.bgOpacity:parseFloat(e.bgOpacity)))
...
function Pl(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Ee()
...
let Ml=!1
const zl=We()({name:"VBtn",directives:{Ripple:Cl},props:{active:{type:Boolean,default:void 0},symbol:{type:null,default:Ha},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ga,appendIcon:Ga,block:Boolean,stacked:Boolean,ripple:{type:Boolean,default:!0},...ma(),...ba(),...$a(),...oa(),...ha(),...Ma(),...$l(),..._l(),...Tl(),...Fl(),...ll(),...va({tag:"button"}),...ft(),...Ta({variant:"elevated"})},emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=ht(e),{borderClasses:r}=ga(e),{colorClasses:i,colorStyles:s,variantClasses:u}=Pa(e),{densityClasses:c}=Aa(e),{dimensionStyles:d}=na(e),{elevationClasses:v}=ya(e),{loaderClasses:p}=Al(e),{locationStyles:f}=Il(e),{positionClasses:m}=Pl(e),{roundedClasses:g}=Va(e),{sizeClasses:h,sizeStyles:y}=ol(e),b=za(e,e.symbol,!1),V=Ol(e,l),S=t.computed((()=>void 0!==e.active?e.active:V.isLink.value?V.isActive?.value:b?.isSelected.value)),k=t.computed((()=>b?.disabled.value||e.disabled)),w=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border))),x=t.computed((()=>{if(void 0!==e.value)return Object(e.value)===e.value?JSON.stringify(e.value,null,0):e.value}))
...
return t.createVNode(rl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r},null)}}}const Xl=We()({name:"VLabel",props:{text:String,clickable:Boolean,...ft()},setup(e,a){let{slots:l}=a
return Ze((()=>t.createVNode("label",{class:["v-label",{"v-label--clickable":e.clickable}]},[e.text,l.default?.()]))),{}}}),ql=We()({name:"VFieldLabel",props:{floating:Boolean},setup(e,a){let{slots:l}=a
return Ze((()=>t.createVNode(Xl,{class:["v-field-label",{"v-field-label--floating":e.floating}],"aria-hidden":e.floating||void 0},l))),{}}}),Kl=Oe({focused:Boolean},"focus")
...
function n(){l.value=!0}function r(){l.value=!1}return{focusClasses:o,isFocused:l,focus:n,blur:r}}const Jl=["underlined","outlined","filled","solo","plain"],Ql=Oe({appendInnerIcon:Ga,bgColor:String,clearable:Boolean,clearIcon:{type:Ga,default:"$clear"},active:Boolean,color:String,dirty:Boolean,disabled:Boolean,error:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:Ga,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Jl.includes(e)},"onClick:clear":F,"onClick:appendInner":F,"onClick:prependInner":F,...ft(),...$l()},"v-field"),eo=We()({name:"VField",inheritAttrs:!1,props:{id:String,...Kl(),...Ql()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{themeClasses:r}=ht(e),{loaderClasses:i}=Al(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=Zl(e),{InputIcon:v}=Gl(e),p=t.computed((()=>e.dirty||e.active)),f=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),m=Le(),h=t.computed((()=>e.id||`input-${m}`)),y=t.computed((()=>`${h.value}-messages`)),b=t.ref(),V=t.ref(),S=t.ref(),{backgroundColorClasses:k,backgroundColorStyles:w}=wa(t.toRef(e,"bgColor")),{textColorClasses:x,textColorStyles:C}=ka(t.computed((()=>p.value&&u.value&&!e.error&&!e.disabled?e.color:void 0)))
...
const o=t.computed((()=>x(e.messages))),{textColorClasses:n,textColorStyles:r}=ka(t.computed((()=>e.color)))
...
function io(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:Ee(),l=arguments.length>2&&void 0!==arguments[2]?arguments[2]:Le()
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,r.value,S.value]},[a&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[o.prepend?.(k.value),e.prependIcon&&t.createVNode(i,{key:"prepend-icon",name:"prepend"},null)]),o.default&&t.createVNode("div",{class:"v-input__control"},[o.default?.(k.value)]),l&&t.createVNode("div",{key:"append",class:"v-input__append"},[e.appendIcon&&t.createVNode(i,{key:"append-icon",name:"append"},null),o.append?.(k.value)]),s&&t.createVNode("div",{class:"v-input__details"},[t.createVNode(ao,{id:c.value,active:n,messages:d.value.length>0?d.value:e.messages},{message:o.message}),o.details?.(k.value)])])})),{reset:y,resetValidation:b,validate:V}}})
...
function y(){m.value!==document.activeElement&&m.value?.focus(),i.value||s()}function b(e){o("mousedown:control",e),e.target!==m.value&&(y(),e.preventDefault())}function V(e){y(),o("click:control",e)}function S(a){a.stopPropagation(),y(),t.nextTick((()=>{r.value=null,z(e["onClick:clear"],a)}))}function k(e){r.value=e.target.value}return Ze((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,x]=w(l),[{modelValue:C,...N}]=co(e),[_]=to(e)
...
let s=l
i.value&&(s=t?[...x(o.value),l]:x(o.value).filter((t=>!e.valueComparator(t,n.value)))),a?a.modelValue.value=s:o.value=s}}),{textColorClasses:u,textColorStyles:c}=ka(t.computed((()=>!s.value||e.error||e.disabled?void 0:e.color))),d=t.computed((()=>s.value?e.trueIcon:e.falseIcon))
...
function xo(e){return S(e,Object.keys(wo.props))}const Co=Oe({indeterminate:Boolean,indeterminateIcon:{type:Ga,default:"$checkboxIndeterminate"},...ko({falseIcon:"$checkboxOff",trueIcon:"$checkboxOn"})},"v-checkbox-btn"),No=We()({name:"VCheckboxBtn",props:Co(),emits:{"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,a){let{slots:l}=a
...
return Ze((()=>t.createVNode(wo,t.mergeProps(e,{modelValue:n.value,"onUpdate:modelValue":[e=>n.value=e,r],class:"v-checkbox-btn",type:"checkbox",inline:!0,falseIcon:i.value,trueIcon:s.value,"aria-checked":e.indeterminate?"mixed":void 0}),l))),{}}})
const _o=We()({name:"VCheckbox",inheritAttrs:!1,props:{...so(),...Co()},emits:{"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{isFocused:n,focus:r,blur:i}=Zl(e),s=Le(),u=t.computed((()=>e.id||`checkbox-${s}`))
return Ze((()=>{const[a,s]=w(l),[c,d]=co(e),[v,p]=function(e){return S(e,Object.keys(No.props))}(e)
...
return t.createVNode(No,t.mergeProps(v,{id:a.value,"aria-describedby":l.value,disabled:n.value,readonly:u.value},s,{onFocus:r,onBlur:i}),o)}})})),{}}}),Io=Oe({start:Boolean,end:Boolean,icon:Ga,image:String,...$a(),...ba(),...ll(),...va(),...ft(),...Ta({variant:"flat"})},"v-avatar"),Bo=We()({name:"VAvatar",props:Io(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{colorClasses:n,colorStyles:r,variantClasses:i}=Pa(e),{densityClasses:s}=Aa(e),{roundedClasses:u}=Va(e),{sizeClasses:c,sizeStyles:d}=ol(e)
...
const{t:r}=Rt(),{borderClasses:i}=ga(e),{colorClasses:s,colorStyles:u,variantClasses:c}=Pa(e),{densityClasses:d}=Aa(e),{elevationClasses:v}=ya(e),{roundedClasses:p}=Va(e),{sizeClasses:f}=ol(e),{themeClasses:m}=ht(e),g=St(e,"modelValue"),h=za(e,$o,!1),y=Ol(e,l),b=t.computed((()=>!1!==e.link&&y.isLink.value)),V=t.computed((()=>!e.disabled&&!1!==e.link&&(!!h||e.link||y.isClickable.value))),S=t.computed((()=>({"aria-label":r(e.closeLabel),onClick(e){g.value=!1,o("click:close",e)}})))
...
return g.value&&t.withDirectives(t.createVNode(a,{class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":V.value,"v-chip--filter":x,"v-chip--pill":e.pill},m.value,i.value,_?s.value:void 0,d.value,v.value,p.value,f.value,c.value,h?.selectedClass.value],style:[_?u.value:void 0],disabled:e.disabled||void 0,draggable:e.draggable,href:y.href.value,tabindex:V.value?0:void 0,onClick:k,onKeydown:V.value&&!b.value&&w},{default:()=>[Ea(V.value,"v-chip"),x&&t.createVNode(la,{key:"filter"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?t.withDirectives(t.createVNode(Lt,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},null),[[t.resolveDirective("slot"),n.filter,"default"]]):t.createVNode(rl,{key:"filter-icon",icon:e.filterIcon},null)]),[[t.vShow,h.isSelected.value]])]}),N&&t.createVNode("div",{key:"prepend",class:"v-chip__prepend"},[n.prepend?t.createVNode(Lt,{key:"prepend-defaults",disabled:!C,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},n.prepend):t.createVNode(t.Fragment,null,[e.prependIcon&&t.createVNode(rl,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&t.createVNode(Bo,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),n.default?.({isSelected:h?.isSelected.value,selectedClass:h?.selectedClass.value,select:h?.select,toggle:h?.toggle,value:h?.value.value,disabled:e.disabled})??e.text,o&&t.createVNode("div",{key:"append",class:"v-chip__append"},[n.append?t.createVNode(Lt,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},n.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(rl,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Bo,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),r&&t.createVNode("div",t.mergeProps({key:"close",class:"v-chip__close"},S.value),[n.close?t.createVNode(Lt,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},n.close):t.createVNode(rl,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}),[[t.resolveDirective("ripple"),V.value&&e.ripple,null]])}}}),Eo=We()({name:"VDivider",props:{color:String,inset:Boolean,length:[Number,String],thickness:[Number,String],vertical:Boolean,...ft()},setup(e,a){let{attrs:l}=a
const{themeClasses:o}=ht(e),{textColorClasses:n,textColorStyles:r}=ka(t.toRef(e,"color")),i=t.computed((()=>{const t={}
...
function Po(){const e=t.inject(To,{hasPrepend:t.ref(!1),updateHasPrepend:()=>null}),a={hasPrepend:t.ref(!1),updateHasPrepend:e=>{e&&(a.hasPrepend.value=e)}}
return t.provide(To,a),e}function Lo(){return t.inject(To,null)}const Oo={open:e=>{let{id:t,value:a,opened:l,parents:o}=e
...
return t.provide(jo,d),d.root},Yo=(e,a)=>{const l=t.inject(jo,Ho),o=Symbol(Le()),n=t.computed((()=>e.value??o)),r={...l,id:n,open:(e,t)=>l.root.open(n.value,e,t),openOnSelect:(e,t)=>l.root.openOnSelect(n.value,e,t),isOpen:t.computed((()=>l.root.opened.value.has(n.value))),parent:t.computed((()=>l.root.parents.value.get(n.value))),select:(e,t)=>l.root.select(n.value,e,t),isSelected:t.computed((()=>"on"===l.root.selected.value.get(t.toRaw(n.value)))),isIndeterminate:t.computed((()=>"indeterminate"===l.root.selected.value.get(n.value))),isLeaf:t.computed((()=>!l.root.children.value.get(n.value))),isGroupActivator:l.isGroupActivator}
return!l.isGroupActivator&&l.root.register(n.value,l.id.value,a),t.onBeforeUnmount((()=>{!l.isGroupActivator&&l.root.unregister(n.value)})),a&&t.provide(jo,r),r},Go=He({name:"VListGroupActivator",setup(e,a){let{slots:l}=a
return(()=>{const e=t.inject(jo,Ho)
t.provide(jo,{...e,isGroupActivator:!0})})(),()=>l.default?.()}}),Xo=Oe({activeColor:String,color:String,collapseIcon:{type:Ga,default:"$collapse"},expandIcon:{type:Ga,default:"$expand"},prependIcon:Ga,appendIcon:Ga,fluid:Boolean,subgroup:Boolean,value:null,...va()},"v-list-group"),qo=We()({name:"VListGroup",props:{title:String,...Xo()},setup(e,a){let{slots:l}=a
const{isOpen:o,open:n,id:r}=Yo(t.toRef(e,"value"),!0),i=t.computed((()=>`v-list-group--id-${String(r.value)}`)),s=Lo()
...
return Ze((()=>t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":s?.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":o.value}]},{default:()=>[l.activator&&t.createVNode(Lt,{defaults:{VListItem:{active:o.value,activeColor:e.activeColor,color:e.color,prependIcon:e.prependIcon||e.subgroup&&d.value,appendIcon:e.appendIcon||!e.subgroup&&d.value,title:e.title,value:e.value}}},{default:()=>[t.createVNode(Go,null,{default:()=>[l.activator({props:c.value,isOpen:o.value})]})]}),t.createVNode(aa,null,{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items",role:"group","aria-labelledby":i.value},[l.default?.()]),[[t.vShow,o.value]])]})]}))),{}}})
const Ko=Ue("v-list-item-subtitle"),Zo=Ue("v-list-item-title"),Jo=We()({name:"VListItem",directives:{Ripple:Cl},props:{active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Ga,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Ga,ripple:{type:Boolean,default:!0},subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,onClick:F,onClickOnce:F,...ma(),...$a(),...oa(),...ha(),...ba(),...Fl(),...va(),...ft(),...Ta({variant:"text"})},emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const r=Ol(e,l),i=t.computed((()=>e.value??r.href.value)),{select:s,isSelected:u,isIndeterminate:c,isGroupActivator:d,root:v,parent:p,openOnSelect:f}=Yo(i,!1),m=Lo(),g=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||u.value))),h=t.computed((()=>!1!==e.link&&r.isLink.value)),y=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||null!=e.value&&!!m))),b=t.computed((()=>e.rounded||e.nav)),V=t.computed((()=>({color:g.value?e.activeColor??e.color:e.color,variant:e.variant})))
t.watch((()=>r.isActive?.value),(e=>{e&&null!=p.value&&v.open(p.value,!0),e&&f(e)}),{immediate:!0})
const{themeClasses:S}=ht(e),{borderClasses:k}=ga(e),{colorClasses:w,colorStyles:x,variantClasses:C}=Pa(V),{densityClasses:N}=Aa(e),{dimensionStyles:_}=na(e),{elevationClasses:I}=ya(e),{roundedClasses:B}=Va(b),$=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),A=t.computed((()=>({isActive:g.value,select:s,isSelected:u.value,isIndeterminate:c.value})))
...
return m?.updateHasPrepend(v),t.withDirectives(t.createVNode(a,{class:["v-list-item",{"v-list-item--active":g.value,"v-list-item--disabled":e.disabled,"v-list-item--link":y.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!v&&m?.hasPrepend.value,[`${e.activeClass}`]:e.activeClass&&g.value},S.value,k.value,l?w.value:void 0,N.value,I.value,$.value,B.value,C.value],style:[l?x.value:void 0,_.value],href:r.href.value,tabindex:y.value?0:void 0,onClick:R,onKeydown:y.value&&!h.value&&E},{default:()=>[Ea(y.value||g.value,"v-list-item"),v&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(Lt,{key:"prepend-defaults",disabled:!d,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(A.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Bo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(rl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[n&&t.createVNode(Zo,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),i&&t.createVNode(Ko,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(A.value)]),c&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(Lt,{key:"append-defaults",disabled:!s,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(A.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(rl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Bo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]}),[[t.resolveDirective("ripple"),y.value&&e.ripple]])})),{}}}),Qo=We()({name:"VListSubheader",props:{color:String,inset:Boolean,sticky:Boolean,title:String,...va()},setup(e,a){let{slots:l}=a
const{textColorClasses:o,textColorStyles:n}=ka(t.toRef(e,"color"))
...
const{items:o}=function(e){return{items:t.computed((()=>rn(e,e.items)))}}(e),{themeClasses:n}=ht(e),{backgroundColorClasses:r,backgroundColorStyles:i}=wa(t.toRef(e,"bgColor")),{borderClasses:s}=ga(e),{densityClasses:u}=Aa(e),{dimensionStyles:c}=na(e),{elevationClasses:d}=ya(e),{roundedClasses:v}=Va(e),{open:p,select:f}=Uo(e),m=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),g=t.toRef(e,"activeColor"),h=t.toRef(e,"color")
...
l?l.focus():x("next"===e?"first":"last")}else b.value.contains(document.activeElement)||t[0]?.focus()}return Ze((()=>t.createVNode(e.tag,{ref:b,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav},n.value,r.value,s.value,u.value,d.value,m.value,v.value],style:[i.value,c.value],role:"listbox","aria-activedescendant":void 0,onFocusin:V,onFocusout:S,onFocus:k,onKeydown:w},{default:()=>[t.createVNode(en,{items:o.value},l)]}))),{open:p,select:f,focus:x}}}),un=Ue("v-list-img"),cn=We()({name:"VListItemAction",props:{start:Boolean,end:Boolean,...va()},setup(e,a){let{slots:l}=a
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,x,{activatorEl:i,activatorEvents:V})}))):C&&C.stop()}),{flush:"post",immediate:!0}),t.onScopeDispose((()=>{C?.stop()})),{activatorEl:i,activatorRef:w,activatorEvents:V,contentEvents:S,scrimEvents:k}}const hn=Oe({eager:Boolean},"lazy")
...
function m(e){const l=new q(a),o=Vn(e.anchor,t),n=Vn(e.origin,l)
...
{const e=K(a,p)
b.x=p.width-e.x.before-e.x.after,b.y=p.height-e.y.before-e.y.after,h+=e.x.before,a.x+=e.x.before,y+=e.y.before,a.y+=e.y.before}break}const k=X(f.anchor)
return Object.assign(l.value,{"--v-overlay-anchor-origin":`${f.anchor.side} ${f.anchor.align}`,transformOrigin:`${f.origin.side} ${f.origin.align}`,top:g(wn(y)),left:g(wn(h)),minWidth:g("y"===k?Math.min(r.value,t.width):r.value),maxWidth:g(xn(C(b.x,r.value===1/0?0:r.value,s.value))),maxHeight:g(xn(C(b.y,i.value===1/0?0:i.value,u.value)))}),{available:b,contentBox:a}}return t.watch([e.activatorEl,e.contentEl],((e,t)=>{let[a,l]=e,[o,n]=t
...
a.height>t.y&&requestAnimationFrame((()=>{p(),requestAnimationFrame((()=>{p()}))}))})),{updateLocation:p}}},kn=Oe({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in Sn},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]},"v-overlay-location-strategies")
function wn(e){return Math.round(e*devicePixelRatio)/devicePixelRatio}function xn(e){return Math.ceil(e*devicePixelRatio)/devicePixelRatio}let Cn=!0
const Nn=[]
let _n=-1
function In(){cancelAnimationFrame(_n),_n=requestAnimationFrame((()=>{const e=Nn.shift()
e&&e(),Nn.length?In():Cn=!0}))}const Bn={none:null,close:function(e){An(e.activatorEl.value??e.contentEl.value,(function(t){e.isActive.value=!1}))},block:function(e,a){const l=e.root.value?.offsetParent,o=[...new Set([...qe(e.activatorEl.value,a.contained?l:void 0),...qe(e.contentEl.value,a.contained?l:void 0)])].filter((e=>!e.classList.contains("v-overlay-scroll-blocked"))),n=window.innerWidth-document.documentElement.offsetWidth,r=(i=l||document.documentElement,Ke(i)&&i)
var i
...
function An(e,a){const l=[document,...qe(e)]
...
function Tn(e){return a&&!e?window.innerWidth:0}function Pn(e){return a&&!e?window.innerHeight:0}function Ln(e){const t=a&&!e?window.navigator.userAgent:"ssr"
function l(e){return Boolean(t.match(e))}return{android:l(/android/i),ios:l(/iphone|ipad|ipod/i),cordova:l(/cordova/i),electron:l(/electron/i),chrome:l(/chrome/i),edge:l(/edge/i),firefox:l(/firefox/i),opera:l(/opera/i),win:l(/win/i),mac:l(/mac/i),linux:l(/linux/i),touch:o,ssr:"ssr"===t}}function On(e,l){const{thresholds:o,mobileBreakpoint:n}=function(){return I(En,arguments.length>0&&void 0!==arguments[0]?arguments[0]:En)}(e),r=t.ref(Pn(l)),i=t.shallowRef(Ln(l)),s=t.reactive({}),u=t.ref(Tn(l))
function c(){r.value=Pn(),u.value=Tn()}return t.watchEffect((()=>{const e=u.value<o.sm,t=u.value<o.md&&!e,a=u.value<o.lg&&!(t||e),l=u.value<o.xl&&!(a||t||e),c=u.value<o.xxl&&!(l||a||t||e),d=u.value>=o.xxl,v=e?"xs":t?"sm":a?"md":l?"lg":c?"xl":"xxl",p="number"==typeof n?n:o[n],f=u.value<p
...
var c
const{themeClasses:d}=ht(e),{rtlClasses:v,isRtl:p}=Tt(),{hasContent:f,onAfterLeave:m}=yn(e,s),h=wa(t.computed((()=>"string"==typeof e.scrim?e.scrim:null))),{globalTop:y,localTop:b,stackStyles:V}=function(e,a,l){const o=Re("useStack"),n=!l,r=t.inject(Dn,void 0),i=t.reactive({activeChildren:new Set})
t.provide(Dn,i)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(s,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:S,activatorRef:k,activatorEvents:w,contentEvents:x,scrimEvents:C}=gn(e,{isActive:s,isTop:b}),{dimensionStyles:N}=na(e),_=Mn(),{scopeId:I}=zn()
...
function E(t){r("click:outside",t),e.persistent?F():s.value=!1}function T(){return s.value&&y.value}function P(t){"Escape"===t.key&&y.value&&(e.persistent?F():s.value=!1)}!function(e,l){if(!a)return
let o
t.watchEffect((async()=>{o?.stop(),l.isActive.value&&e.scrollStrategy&&(o=t.effectScope(),await t.nextTick(),o.active&&o.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(l,e,o):Bn[e.scrollStrategy]?.(l,e,o)})))})),t.onScopeDispose((()=>{o?.stop()}))}(e,{root:B,contentEl:$,activatorEl:S,isActive:s,updateLocation:R}),a&&t.watch(s,(e=>{e?window.addEventListener("keydown",P):window.removeEventListener("keydown",P)}),{immediate:!0})
const L=Ll()
...
e&&e!==document.scrollingElement&&(O.value=e.scrollTop)}})),Ze((()=>t.createVNode(t.Fragment,null,[o.activator?.({isActive:s.value,props:t.mergeProps({ref:k},t.toHandlers(w.value),e.activatorProps)}),_.value&&t.createVNode(t.Teleport,{disabled:!u.value,to:u.value},{default:()=>[f.value&&t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},d.value,v.value],style:[V.value,{top:g(O.value)}],ref:B},I,n),[t.createVNode(Xn,t.mergeProps({color:h,modelValue:s.value&&!!e.scrim},t.toHandlers(C.value)),null),t.createVNode(ca,{appear:!0,persisted:!0,transition:e.transition,target:S.value,onAfterLeave:()=>{m(),r("afterLeave")}},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:$,class:["v-overlay__content",e.contentClass],style:[N.value,A.value]},t.toHandlers(x.value),e.contentProps),[o.default?.({isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:E,closeConditional:T,include:()=>[S.value]}]])]})])]})]))),{activatorEl:S,animateClick:F,contentEl:$,globalTop:y,localTop:b,updateLocation:R}}})
function Zn(e){return S(e,Object.keys(Kn.props))}const Jn=We()({name:"VMenu",props:{id:String,...k(qn({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:zt}}),["absolute"])},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=St(e,"modelValue"),{scopeId:n}=zn(),r=Le(),i=t.computed((()=>e.id||`v-menu-${r}`)),s=t.ref(),u=t.inject(fn,null),c=t.ref(0)
...
return t.createVNode(Lt,{root:!0},{default:()=>[l.default?.(...a)]})}})})),fo({id:i,ΨopenChildren:c},s)}}),Qn=Oe({chips:Boolean,closableChips:Boolean,eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:Ga,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,valueComparator:{type:Function,default:v},...tn({itemChildren:!1})},"v-select"),er=We()({name:"VSelect",props:{...Qn(),...k(go({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...ua({transition:{component:zt}})},emits:{"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,a){let{slots:l}=a
...
e.splice(a,1),v.value=e}}else v.value=[t],s.value=!1}function k(e){h.value?.$el.contains(e.relatedTarget)||(s.value=!1)}function w(e){null==e.relatedTarget&&n.value?.focus()}return Ze((()=>{const a=!(!e.chips&&!l.chip),i=!!(!e.hideNoData||g.value.length||l.prepend||l.append||l["no-data"]),[u]=yo(e)
return t.createVNode(ho,t.mergeProps({ref:n},u,{modelValue:v.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":e=>{null==e&&(v.value=[])},validationValue:v.externalValue,dirty:v.value.length>0,class:["v-select",{"v-select--active-menu":s.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":v.value.length}],appendInnerIcon:e.menuIcon,readonly:!0,"onClick:clear":y,"onMousedown:control":b,onBlur:k,onKeydown:V}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Jn,t.mergeProps({ref:r,modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,activator:"parent",contentClass:"v-select__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition},e.menuProps),{default:()=>[i&&t.createVNode(sn,{ref:h,selected:m.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusout:w},{default:()=>[!g.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Jo,{title:o(e.noDataText)},null)),l["prepend-item"]?.(),g.value.map(((a,o)=>l.item?l.item?.({item:a,index:o,props:t.mergeProps(a.props,{onClick:()=>S(a)})}):t.createVNode(Jo,t.mergeProps({key:o},a.props,{onClick:()=>S(a)}),{prepend:a=>{let{isSelected:l}=a
...
return t.createVNode("div",{key:o.value,class:"v-select__selection"},[a?l.chip?t.createVNode(Lt,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[l.chip?.({item:o,index:n,props:r})]}):t.createVNode(Ro,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title},r),null):l.selection?.({item:o,index:n})??t.createVNode("span",{class:"v-select__selection-text"},[o.title,e.multiple&&n<f.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))])})})),fo({menu:s,select:S},n)}}),tr=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),ar=Oe({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function lr(e,a,l,o){const n=t.computed((()=>"string"!=typeof l?.value&&"number"!=typeof l?.value?"":String(l.value))),r=t.ref([]),i=t.ref(new Map)
return t.watchEffect((()=>{r.value=[],i.value=new Map
const l=t.unref(a);(function(e,t,a){const l=[],o=a?.default??tr,n=!!a?.filterKeys&&x(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
const o=l[t]
r.value.push(o),i.value.set(o.value,a)}))})),{filteredItems:r,filteredMatches:i,getMatches:function(e){return i.value.get(e.value)}}}const or=We()({name:"VAutocomplete",props:{search:String,...ar({filterKeys:["title"]}),...Qn(),...k(go({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...ua({transition:!1})},emits:{"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(ho,t.mergeProps({ref:n},d,{modelValue:f.value,"onUpdate:modelValue":e=>{null==e&&(m.value=[])},validationValue:m.externalValue,dirty:m.value.length>0,onInput:_,class:["v-autocomplete",{"v-autocomplete--active-menu":c.value,"v-autocomplete--chips":!!e.chips,["v-autocomplete--"+(e.multiple?"multiple":"single")]:!0,"v-autocomplete--selection-slot":!!l.selection}],appendInnerIcon:e.menuIcon,readonly:e.readonly,"onClick:clear":w,"onMousedown:control":C,onFocus:()=>r.value=!0,onBlur:()=>r.value=!1,onKeydown:N}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Jn,t.mergeProps({ref:s,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-autocomplete__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:I},e.menuProps),{default:()=>[u&&t.createVNode(sn,{ref:k,selected:S.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusin:B,onFocusout:$},{default:()=>[!V.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Jo,{title:o(e.noDataText)},null)),l["prepend-item"]?.(),V.value.map(((a,o)=>l.item?.({item:a,index:o,props:t.mergeProps(a.props,{onClick:()=>R(a)})})??t.createVNode(Jo,t.mergeProps({key:o},a.props,{onClick:()=>R(a)}),{prepend:a=>{let{isSelected:l}=a
...
return t.createVNode("div",{key:o.value,class:"v-autocomplete__selection"},[a?l.chip?t.createVNode(Lt,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[l.chip?.({item:o,index:n,props:r})]}):t.createVNode(Ro,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title},r),null):l.selection?.({item:o,index:n})??t.createVNode("span",{class:"v-autocomplete__selection-text"},[o.title,e.multiple&&n<b.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))])})})),fo({isFocused:r,isPristine:i,menu:c,search:f,filteredItems:h,select:R},n)}}),nr=We()({name:"VBadge",inheritAttrs:!1,props:{bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Ga,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,..._l({location:"top end"}),...ba(),...va(),...ft(),...ua({transition:"scale-rotate-transition"})},setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=wa(t.toRef(e,"color")),{roundedClasses:n}=Va(e),{t:r}=Rt(),{textColorClasses:i,textColorStyles:s}=ka(t.toRef(e,"textColor")),{themeClasses:u}=yt(),{locationStyles:c}=Il(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline}]},f),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[a.slots.default?.(),t.createVNode(ca,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,l.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,d),"aria-live":"polite",role:"status"},p),[e.dot?void 0:a.slots.badge?a.slots.badge?.():e.icon?t.createVNode(rl,{icon:e.icon},null):v]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),rr=We()({name:"VBannerActions",props:{color:String,density:String},setup(e,a){let{slots:l}=a
return De({VBtn:{color:e.color,density:e.density,variant:"text"}}),Ze((()=>t.createVNode("div",{class:"v-banner-actions"},[l.default?.()]))),{}}}),ir=Ue("v-banner-text"),sr=We()({name:"VBanner",props:{avatar:String,color:String,icon:Ga,lines:String,stacked:Boolean,sticky:Boolean,text:String,...ma(),...$a(),...oa(),...ha(),..._l(),...Tl(),...ba(),...va(),...ft()},setup(e,a){let{slots:l}=a
const{borderClasses:o}=ga(e),{densityClasses:n}=Aa(e),{mobile:r}=Fn(),{dimensionStyles:i}=na(e),{elevationClasses:s}=ya(e),{locationStyles:u}=Il(e),{positionClasses:c}=Pl(e),{roundedClasses:d}=Va(e),{themeClasses:v}=ht(e),p=t.toRef(e,"color"),f=t.toRef(e,"density")
De({VBannerActions:{color:p,density:f}}),Ze((()=>{const a=!(!e.text&&!l.text),m=!(!e.avatar&&!e.icon),g=!(!m&&!l.prepend)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||r.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},o.value,n.value,s.value,c.value,d.value,v.value],style:[i.value,u.value],role:"banner"},{default:()=>[g&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode(Lt,{key:"prepend-defaults",disabled:!m,defaults:{VAvatar:{color:p.value,density:f.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(Bo,{key:"prepend-avatar",color:p.value,density:f.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(ir,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(rr,{key:"actions"},l.actions)]})}))}}),ur=We()({name:"VBottomNavigation",props:{bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...ma(),...$a(),...ha(),...ba(),...tt({name:"bottom-navigation"}),...va({tag:"header"}),...Fa({modelValue:!0,selectedClass:"v-btn--selected"}),...ft()},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=yt(),{borderClasses:n}=ga(e),{backgroundColorClasses:r,backgroundColorStyles:i}=wa(t.toRef(e,"bgColor")),{densityClasses:s}=Aa(e),{elevationClasses:u}=ya(e),{roundedClasses:c}=Va(e),{ssrBootStyles:d}=_a(),v=t.computed((()=>Number(e.height)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0))),p=t.toRef(e,"active"),{layoutItemStyles:f}=lt({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:t.computed((()=>p.value?v.value:0)),elementSize:v,active:p,absolute:t.toRef(e,"absolute")})
return Da(e,Ha),De({VBtn:{color:t.toRef(e,"color"),density:t.toRef(e,"density"),stacked:t.computed((()=>"horizontal"!==e.mode)),variant:"text"}},{scoped:!0}),Ze((()=>t.createVNode(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":p.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":"shift"===e.mode},o.value,r.value,n.value,s.value,u.value,c.value],style:[i.value,f.value,{height:g(v.value),transform:`translateY(${g(p.value?0:100,"%")})`},d.value]},{default:()=>[l.default&&t.createVNode("div",{class:"v-bottom-navigation__content"},[l.default()])]}))),{}}}),cr=We()({name:"VBreadcrumbsDivider",props:{divider:[Number,String]},setup(e,a){let{slots:l}=a
return Ze((()=>t.createVNode("li",{class:"v-breadcrumbs-divider"},[l?.default?.()??e.divider]))),{}}}),dr=We()({name:"VBreadcrumbsItem",props:{active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...Fl(),...va({tag:"li"})},setup(e,a){let{slots:l,attrs:o}=a
const n=Ol(e,o),r=t.computed((()=>e.active||n.isActive?.value)),i=t.computed((()=>r.value?e.activeColor:e.color)),{textColorClasses:s,textColorStyles:u}=ka(i)
return Ze((()=>{const a=n.isLink.value?"a":e.tag
return t.createVNode(a,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,"v-breadcrumbs-item--link":n.isLink.value,[`${e.activeClass}`]:r.value&&e.activeClass},s.value],style:[u.value],href:n.href.value,"aria-current":r.value?"page":void 0,onClick:n.navigate},{default:()=>[l.default?.()??e.title]})})),{}}}),vr=We()({name:"VBreadcrumbs",props:{activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:Ga,items:{type:Array,default:()=>[]},...$a(),...ba(),...va({tag:"ul"})},setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=wa(t.toRef(e,"bgColor")),{densityClasses:r}=Aa(e),{roundedClasses:i}=Va(e)
...
return t.createVNode(e.tag,{class:["v-breadcrumbs",o.value,r.value,i.value],style:n.value},{default:()=>[a&&t.createVNode("div",{key:"prepend",class:"v-breadcrumbs__prepend"},[l.prepend?t.createVNode(Lt,{key:"prepend-defaults",disabled:!e.icon,defaults:{VIcon:{icon:e.icon,start:!0}}},l.prepend):t.createVNode(rl,{key:"prepend-icon",start:!0,icon:e.icon},null)]),e.items.map(((e,a,o)=>t.createVNode(t.Fragment,null,[t.createVNode(dr,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof e?{title:e}:e),{default:l.title?()=>l.title?.({item:e,index:a}):void 0}),a<o.length-1&&t.createVNode(cr,null,{default:l.divider?()=>l.divider?.({item:e,index:a}):void 0})]))),l.default?.()]})})),{}}}),pr=He({name:"VCardActions",setup(e,a){let{slots:l}=a
return De({VBtn:{variant:"text"}}),Ze((()=>t.createVNode("div",{class:"v-card-actions"},[l.default?.()]))),{}}}),fr=Ue("v-card-subtitle"),mr=Ue("v-card-title"),gr=We()({name:"VCardItem",props:{appendAvatar:String,appendIcon:Ga,prependAvatar:String,prependIcon:Ga,subtitle:String,title:String,...$a()},setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:"v-card-item"},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(Lt,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar}}},l.prepend):a&&t.createVNode(Bo,{key:"prepend-avatar",density:e.density,icon:e.prependIcon,image:e.prependAvatar},null)]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(mr,{key:"title"},{default:()=>[l.title?.()??e.title]}),s&&t.createVNode(fr,{key:"subtitle"},{default:()=>[l.subtitle?.()??e.subtitle]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(Lt,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar}}},l.append):n&&t.createVNode(Bo,{key:"append-avatar",density:e.density,icon:e.appendIcon,image:e.appendAvatar},null)])])})),{}}}),hr=Ue("v-card-text"),yr=We()({name:"VCard",directives:{Ripple:Cl},props:{appendAvatar:String,appendIcon:Ga,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Ga,ripple:{type:Boolean,default:!0},subtitle:String,text:String,title:String,...ft(),...ma(),...$a(),...oa(),...ha(),...$l(),..._l(),...Tl(),...ba(),...Fl(),...va(),...Ta({variant:"elevated"})},setup(e,a){let{attrs:l,slots:o}=a
const{themeClasses:n}=ht(e),{borderClasses:r}=ga(e),{colorClasses:i,colorStyles:s,variantClasses:u}=Pa(e),{densityClasses:c}=Aa(e),{dimensionStyles:d}=na(e),{elevationClasses:v}=ya(e),{loaderClasses:p}=Al(e),{locationStyles:f}=Il(e),{positionClasses:m}=Pl(e),{roundedClasses:g}=Va(e),h=Ol(e,l),y=t.computed((()=>!1!==e.link&&h.isLink.value)),b=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||h.isClickable.value)))
return Ze((()=>{const a=y.value?"a":e.tag,l=!(!o.title&&!e.title),V=!(!o.subtitle&&!e.subtitle),S=l||V,k=!!(o.append||e.appendAvatar||e.appendIcon),w=!!(o.prepend||e.prependAvatar||e.prependIcon),x=!(!o.image&&!e.image),C=S||w||k,N=!(!o.text&&!e.text)
return t.withDirectives(t.createVNode(a,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value],style:[s.value,d.value,f.value],href:h.href.value,onClick:b.value&&h.navigate,tabindex:e.disabled?-1:void 0},{default:()=>[x&&t.createVNode("div",{key:"image",class:"v-card__image"},[o.image?t.createVNode(Lt,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},o.image):t.createVNode(da,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(Rl,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),C&&t.createVNode(gr,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),N&&t.createVNode(hr,{key:"text"},{default:()=>[o.text?.()??e.text]}),o.default?.(),o.actions&&t.createVNode(pr,null,{default:o.actions}),Ea(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value&&e.ripple]])})),{}}})
function br(e,t){const a=e.changedTouches[0]
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}function Vr(e,t){const a=e.changedTouches[0]
...
e.offsetX=a-t,e.offsetY=o-l,Math.abs(e.offsetY)<.5*Math.abs(e.offsetX)&&(e.left&&a<t-16&&e.left(e),e.right&&a>t+16&&e.right(e)),Math.abs(e.offsetX)<.5*Math.abs(e.offsetY)&&(e.up&&o<l-16&&e.up(e),e.down&&o>l+16&&e.down(e))})(t)}function Sr(e,t){const a=e.changedTouches[0]
t.touchmoveX=a.clientX,t.touchmoveY=a.clientY,t.move?.({originalEvent:e,...t})}const kr={mounted:function(e,t){const a=t.value,l=a?.parent?e.parentElement:e,o=a?.options??{passive:!0},n=t.instance?.$.uid
if(!l||!n)return
const r=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const t={touchstartX:0,touchstartY:0,touchendX:0,touchendY:0,touchmoveX:0,touchmoveY:0,offsetX:0,offsetY:0,left:e.left,right:e.right,up:e.up,down:e.down,start:e.start,move:e.move,end:e.end}
return{touchstart:e=>br(e,t),touchend:e=>Vr(e,t),touchmove:e=>Sr(e,t)}}(t.value)
...
V(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},wr=Symbol.for("vuetify:v-window"),xr=Symbol.for("vuetify:v-window-group"),Cr=We()({name:"VWindow",directives:{Touch:kr},props:{continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{default:"force"},...va(),...ft()},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{isRtl:n}=Tt(),{t:r}=Rt(),i=Da(e,xr),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.ref(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.ref(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
return Ze((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value]},{default:()=>[t.createVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[t.resolveDirective("touch"),V.value]]))),{group:i}}}),Nr=We()({name:"VWindowItem",directives:{Touch:kr},props:{reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...Ma(),...hn()},emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(wr),n=za(e,xr),{isBooted:r}=_a()
...
return Ze((()=>t.createVNode(ca,{transition:r.value&&p.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value]},[f.value&&l.default?.()]),[[t.vShow,n.isSelected.value]])]}))),{}}}),_r=We()({name:"VCarousel",props:{color:String,cycle:Boolean,delimiterIcon:{type:Ga,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>e>0},modelValue:null,progress:[Boolean,String],showArrows:{type:[Boolean,String],default:!0,validator:e=>"boolean"==typeof e||"hover"===e},verticalDelimiters:[Boolean,String]},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return l.item?l.item({props:o,item:e}):t.createVNode(zl,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(Bl,{class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next}))),{}}}),Ir=We()({name:"VCarouselItem",inheritAttrs:!1,props:{value:null},setup(e,a){let{slots:l,attrs:o}=a
Ze((()=>t.createVNode(Nr,{class:"v-carousel-item",value:e.value},{default:()=>[t.createVNode(da,o,l)]})))}}),Br=Ue("v-code"),$r=He({name:"VColorPickerCanvas",props:{color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300}},emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
function Ar(e,t){return t.every((t=>e.hasOwnProperty(t)))}function Rr(e){if(!e)return null
let t=null
if("string"==typeof e){t=Ce(_e(e))}return"object"==typeof e&&(Ar(e,["r","g","b"])?t=ye(e):Ar(e,["h","s","l"])?t=Ve(e):Ar(e,["h","s","v"])&&(t=e)),t}const Er={h:0,s:0,v:1,a:1},Tr={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:he,from:ye},Pr={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:be,from:Ve},Lr={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:Ne,from:Ce},Or={rgb:{...Tr,inputs:Tr.inputs?.slice(0,3)},rgba:Tr,hsl:{...Pr,inputs:Pr.inputs.slice(0,3)},hsla:Pr,hex:{...Lr,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:Lr},Fr=e=>{let{label:a,...l}=e
return t.createVNode("div",{class:"v-color-picker-edit__input"},[t.createVNode("input",l,null),t.createVNode("span",null,[a])])},Mr=He({name:"VColorPickerEdit",props:{color:Object,disabled:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Or).includes(e)},modes:{type:Array,default:()=>Object.keys(Or),validator:e=>Array.isArray(e)&&e.every((e=>Object.keys(Or).includes(e)))}},emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,a){let{emit:l}=a
const o=t.computed((()=>e.modes.map((e=>({...Or[e],name:e}))))),n=t.computed((()=>{const t=o.value.find((t=>t.name===e.mode))
if(!t)return[]
...
o&&l("update:color",t.from(r(a??Er,o.value)))}}}))}))
return Ze((()=>t.createVNode("div",{class:"v-color-picker-edit"},[n.value?.map((e=>t.createVNode(Fr,e,null))),o.value.length>1&&t.createVNode(zl,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
l("update:mode",o.value[(t+1)%o.value.length].name)}},null)]))),{}}}),zr=Symbol.for("vuetify:v-slider")
function Dr(e,t,a){const l="vertical"===a,o=t.getBoundingClientRect(),n="touches"in e?e.touches[0]:e
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const jr=Oe({disabled:Boolean,error:Boolean,readonly:Boolean,max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...ba(),...ha({elevation:2})},"slider"),Hr=e=>{let{props:a,handleSliderMouseUp:l,handleMouseMove:o,getActiveThumb:n}=e
...
const A=e=>{$||(x.value=0,l(B(e))),w.value=!1,$=!1,x.value=0},R=e=>{_.value=n(e),_.value&&(_.value.focus(),w.value=!0,_.value.contains(e.target)?($=!0,x.value=Dr(e,_.value,a.direction)):(x.value=0,o(B(e))))},E={passive:!0,capture:!0}
function T(e){$=!0,o(B(e))}function P(e){e.stopPropagation(),e.preventDefault(),A(e),window.removeEventListener("mousemove",T,E),window.removeEventListener("mouseup",P)}function L(e){A(e),window.removeEventListener("touchmove",T,E),e.target?.removeEventListener("touchend",L)}const O=e=>{const t=(e-u.value)/(c.value-u.value)*100
return C(isNaN(t)?0:t,0,100)},F=t.toRef(a,"showTicks"),M=t.computed((()=>F.value?a.ticks?Array.isArray(a.ticks)?a.ticks.map((e=>({value:e,position:O(e),label:e.toString()}))):Object.keys(a.ticks).map((e=>({value:parseFloat(e),position:O(parseFloat(e)),label:a.ticks[e]}))):h.value!==1/0?m(h.value+1).map((e=>{const t=u.value+e*d.value
return{value:t,position:O(t)}})):[]:[])),z=t.computed((()=>M.value.some((e=>{let{label:t}=e
return!!t})))),D={activeThumbRef:_,color:t.toRef(a,"color"),decimals:v,disabled:y,direction:t.toRef(a,"direction"),elevation:t.toRef(a,"elevation"),hasLabels:z,horizontalDirection:s,isReversed:i,min:u,max:c,mousePressed:w,numTicks:h,onSliderMousedown:function(e){e.preventDefault(),R(e),window.addEventListener("mousemove",T,E),window.addEventListener("mouseup",P,{passive:!1})},onSliderTouchstart:function(e){R(e),window.addEventListener("touchmove",T,E),e.target?.addEventListener("touchend",L,{passive:!1})},parsedTicks:M,parseMouseMove:B,position:O,readonly:t.toRef(a,"readonly"),rounded:t.toRef(a,"rounded"),roundValue:I,showTicks:F,startOffset:x,step:d,thumbSize:p,thumbColor:V,thumbLabel:t.toRef(a,"thumbLabel"),ticks:t.toRef(a,"ticks"),tickSize:f,trackColor:S,trackContainerRef:N,trackFillColor:k,trackSize:g,vertical:b}
return t.provide(zr,D),D},Wr=We()({name:"VSliderThumb",directives:{Ripple:Cl},props:{focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:Boolean,default:!0}},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(zr)
if(!n)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider")
const{thumbColor:r,step:i,vertical:s,disabled:u,thumbSize:c,thumbLabel:d,direction:v,readonly:p,elevation:f,isReversed:m,horizontalDirection:h,mousePressed:y,decimals:V}=n,{textColorClasses:S,textColorStyles:k}=ka(r),{pageup:w,pagedown:x,end:C,home:N,left:_,right:I,down:B,up:$}=b,A=[w,x,C,N,_,I,B,$],R=t.computed((()=>i.value?[1,2,3]:[1,5,10]))
...
return Ar(t,["r","g","b"])?a=he(e):Ar(t,["h","s","l"])?a=be(e):Ar(t,["h","s","v"])&&(a=e),function(e,t){if(t){const{a:t,...a}=e
return a}return e}(a,!Ar(t,["a"])&&1===e.a)}return e}(t,e.modelValue):null)),n=e=>{o.value=e,l.value=e}
return t.onMounted((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),De({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),Ze((()=>t.createVNode(hi,{rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker"],style:{"--v-color-picker-color-hsv":Se({...o.value??Er,a:1})},maxWidth:e.width},{default:()=>[!e.hideCanvas&&t.createVNode($r,{key:"canvas",color:o.value,"onUpdate:color":n,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(Gr,{key:"preview",color:o.value,"onUpdate:color":n,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(Mr,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:o.value,"onUpdate:color":n,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(mi,{key:"swatches",color:o.value,"onUpdate:color":n,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]}))),{}}})
const bi=We()({name:"VCombobox",props:{delimiters:Array,...ar({filterKeys:["title"]}),...Qn({hideNoData:!0,returnObject:!0}),...k(go({modelValue:null}),["validationValue","dirty","appendInnerIcon"]),...ua({transition:!1})},emits:{"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=Rt(),r=t.ref(),i=t.ref(!1),s=t.ref(!0),u=t.ref(),c=St(e,"menu"),d=t.computed({get:()=>c.value,set:e=>{c.value&&!e&&u.value?.ΨopenChildren||(c.value=e)}}),v=t.ref(-1),p=t.computed((()=>r.value?.color)),{items:f,transformIn:m,transformOut:g}=on(e),{textColorClasses:h,textColorStyles:y}=ka(p),b=St(e,"modelValue",[],(e=>m(x(e||[]))),(t=>{const a=g(t)
return e.multiple?a:a[0]??null})),V=no(),S=t.ref(e.multiple?"":b.value[0]?.title??""),k=t.computed({get:()=>S.value,set:t=>{if(S.value=t,e.multiple||(b.value=[an(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&P(an(e,t))})),S.value="")}t||(v.value=-1),i.value&&(d.value=!0),s.value=!t}})
t.watch(S,(e=>{l("update:search",e)})),t.watch(b,(t=>{e.multiple||(S.value=t[0]?.title??"")}))
const{filteredItems:w,getMatches:C}=lr(e,f,t.computed((()=>s.value?void 0:k.value))),N=t.computed((()=>b.value.map((t=>f.value.find((a=>e.valueComparator(a.value,t.value)))||t)))),_=t.computed((()=>e.hideSelected?w.value.filter((e=>!N.value.some((t=>t.value===e.value)))):w.value)),I=t.computed((()=>N.value.map((e=>e.props.value)))),B=t.computed((()=>N.value[v.value])),$=t.ref()
...
if((v.value>-1||["Enter","ArrowDown","ArrowUp"].includes(a.key))&&a.preventDefault(),["Enter","ArrowDown"].includes(a.key)&&(d.value=!0),["Escape"].includes(a.key)&&(d.value=!1),["Enter","Escape","Tab"].includes(a.key)&&(s.value=!0),"ArrowDown"===a.key?$.value?.focus("next"):"ArrowUp"===a.key&&$.value?.focus("prev"),e.multiple){if(["Backspace","Delete"].includes(a.key)){if(v.value<0)return void("Backspace"!==a.key||k.value||(v.value=o-1))
P(B.value),t.nextTick((()=>!B.value&&(v.value=o-2)))}if("ArrowLeft"===a.key){if(v.value<0&&l>0)return
const e=v.value>-1?v.value-1:o-1
N.value[e]?v.value=e:(v.value=-1,r.value.setSelectionRange(k.value.length,k.value.length))}if("ArrowRight"===a.key){if(v.value<0)return
const e=v.value+1
N.value[e]?v.value=e:(v.value=-1,r.value.setSelectionRange(0,0))}"Enter"===a.key&&k.value&&(P(an(e,k.value)),k.value="")}}function T(){i.value&&(s.value=!0)}function P(a){if(e.multiple){const t=I.value.findIndex((t=>e.valueComparator(t,a.value)))
if(-1===t)b.value=[...b.value,a]
else{const e=[...b.value]
e.splice(t,1),b.value=e}k.value=""}else b.value=[a],S.value=a.title,t.nextTick((()=>{d.value=!1,s.value=!0}))}function L(e){i.value=!0}function O(e){null==e.relatedTarget&&r.value?.focus()}return t.watch(w,(t=>{!t.length&&e.hideNoData&&(d.value=!1)})),t.watch(i,(t=>{if(t)v.value=-1
else{if(d.value=!1,!e.multiple||!k.value)return
b.value=[...b.value,an(e,k.value)],k.value=""}})),Ze((()=>{const a=!(!e.chips&&!o.chip),l=!!(!e.hideNoData||_.value.length||o.prepend||o.append||o["no-data"]),[c]=yo(e)
return t.createVNode(ho,t.mergeProps({ref:r},c,{modelValue:k.value,"onUpdate:modelValue":[e=>k.value=e,e=>{null==e&&(b.value=[])}],validationValue:b.externalValue,dirty:b.value.length>0,class:["v-combobox",{"v-combobox--active-menu":d.value,"v-combobox--chips":!!e.chips,"v-combobox--selecting-index":v.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0}],appendInnerIcon:e.items.length?e.menuIcon:void 0,readonly:e.readonly,"onClick:clear":A,"onMousedown:control":R,onFocus:()=>i.value=!0,onBlur:()=>i.value=!1,onKeydown:E}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Jn,t.mergeProps({ref:u,modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,activator:"parent",contentClass:"v-combobox__content",eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:T},e.menuProps),{default:()=>[l&&t.createVNode(sn,{ref:$,selected:I.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onFocusin:L,onFocusout:O},{default:()=>[!_.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(Jo,{title:n(e.noDataText)},null)),o["prepend-item"]?.(),_.value.map(((a,l)=>o.item?.({item:a,index:l,props:t.mergeProps(a.props,{onClick:()=>P(a)})})??t.createVNode(Jo,t.mergeProps({key:l},a.props,{onClick:()=>P(a)}),{prepend:a=>{let{isSelected:l}=a
...
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(a.title,C(a)?.title,k.value?.length??0)}))),o["append-item"]?.()]})]}),N.value.map(((l,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),P(l)},modelValue:!0,"onUpdate:modelValue":void 0}
return t.createVNode("div",{key:l.value,class:["v-combobox__selection",n===v.value&&["v-combobox__selection--selected",h.value]],style:n===v.value?y.value:{}},[a?o.chip?t.createVNode(Lt,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[o.chip?.({item:l,index:n,props:r})]}):t.createVNode(Ro,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title},r),null):o.selection?.({item:l,index:n})??t.createVNode("span",{class:"v-combobox__selection-text"},[l.title,e.multiple&&n<N.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))])})})),fo({isFocused:i,isPristine:s,menu:d,search:k,selectionIndex:v,filteredItems:w,select:P},r)}}),Vi=We()({name:"VDialog",props:{fullscreen:Boolean,retainFocus:{type:Boolean,default:!0},scrollable:Boolean,...qn({origin:"center center",scrollStrategy:"block",transition:{component:zt},zIndex:2400})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
...
return Ze((()=>{const[a]=Zn(e)
return t.createVNode(Kn,t.mergeProps({ref:i,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable}]},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,"aria-role":"dialog","aria-modal":"true",activatorProps:u.value},r),{activator:o.activator,default:function(){for(var e=arguments.length,a=new Array(e),l=0;l<e;l++)a[l]=arguments[l]
return t.createVNode(Lt,{root:!0},{default:()=>[o.default?.(...a)]})}})})),fo({},i)}}),Si=Symbol.for("vuetify:v-expansion-panel"),ki=["default","accordion","inset","popout"],wi=We()({name:"VExpansionPanels",props:{color:String,variant:{type:String,default:"default",validator:e=>ki.includes(e)},readonly:Boolean,...Fa(),...va(),...ft()},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
Da(e,Si)
...
function y(){g.value!==document.activeElement&&g.value?.focus(),m.value||(m.value=!0)}function b(t){z(e["onClick:prepend"],t),S(t)}function V(e){o("mousedown:control",e)}function S(e){g.value?.click(),o("click:control",e)}function k(a){a.stopPropagation(),y(),t.nextTick((()=>{i.value=[],z(e["onClick:clear"],a)}))}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&g.value&&(g.value.value="")})),Ze((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,s]=w(l),[{modelValue:x,...C}]=co(e),[N]=to(e)
...
const t=e.target
i.value=[...t.files??[]]},onFocus:y,onBlur:()=>m.value=!1},r,s),null),t.createVNode("div",{class:l},[!!i.value?.length&&(n.selection?n.selection({fileNames:d.value,totalBytes:u.value,totalBytesReadable:c.value}):e.chips?d.value.map((a=>t.createVNode(Ro,{key:a,size:"small",color:e.color},{default:()=>[a]}))):d.value.join(", "))])])}})},details:o?e=>t.createVNode(t.Fragment,null,[n.details?.(e),a&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(vo,{active:!!i.value?.length,value:v.value},n.counter)])]):void 0})})),fo({},p,f,g)}}),Bi=We()({name:"VFooter",props:{app:Boolean,color:String,height:{type:[Number,String],default:"auto"},...ma(),...ha(),...tt(),...ba(),...va({tag:"footer"}),...ft()},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{backgroundColorClasses:n,backgroundColorStyles:i}=wa(t.toRef(e,"color")),{borderClasses:s}=ga(e),{elevationClasses:u}=ya(e),{roundedClasses:c}=Va(e),d=t.ref(32),{resizeRef:v}=r((e=>{e.length&&(d.value=e[0].target.clientHeight)})),p=t.computed((()=>"auto"===e.height?d.value:parseInt(e.height,10))),{layoutItemStyles:f}=lt({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:p,elementSize:t.computed((()=>"auto"===e.height?void 0:p.value)),active:t.computed((()=>e.app)),absolute:t.toRef(e,"absolute")})
return Ze((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",o.value,n.value,s.value,u.value,c.value],style:[i.value,e.app?f.value:void 0]},l))),{}}}),$i=We()({name:"VForm",props:{...oo()},emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
t&&r.value?.submit()})),t.preventDefault()}return Ze((()=>t.createVNode("form",{ref:r,class:"v-form",novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),fo(n,r)}}),Ai=We()({name:"VContainer",props:{fluid:{type:Boolean,default:!1},...va()},setup(e,a){let{slots:l}=a
return Ze((()=>t.createVNode(e.tag,{class:["v-container",{"v-container--fluid":e.fluid}]},l))),{}}}),Ri=["sm","md","lg","xl","xxl"],Ei=Ri.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),Ti=Ri.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Pi=Ri.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Li={col:Object.keys(Ei),offset:Object.keys(Ti),order:Object.keys(Pi)}
function Oi(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const Fi=["auto","start","end","center","baseline","stretch"],Mi=We()({name:"VCol",props:{cols:{type:[Boolean,String,Number],default:!1},...Ei,offset:{type:[String,Number],default:null},...Ti,order:{type:[String,Number],default:null},...Pi,alignSelf:{type:String,default:null,validator:e=>Fi.includes(e)},...va()},setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in Li)Li[a].forEach((l=>{const o=e[l],n=Oi(a,l,o)
n&&t.push(n)}))
const l=t.some((e=>e.startsWith("v-col-")))
return t.push({"v-col":!l||!e.cols,[`v-col-${e.cols}`]:e.cols,[`offset-${e.offset}`]:e.offset,[`order-${e.order}`]:e.order,[`align-self-${e.alignSelf}`]:e.alignSelf}),t}))
return()=>t.h(e.tag,{class:o.value},l.default?.())}}),zi=["sm","md","lg","xl","xxl"],Di=["start","end","center"],ji=["space-between","space-around","space-evenly"]
function Hi(e,a){return zi.reduce(((l,o)=>(l[e+t.capitalize(o)]=a(),l)),{})}const Wi=[...Di,"baseline","stretch"],Ui=e=>Wi.includes(e),Yi=Hi("align",(()=>({type:String,default:null,validator:Ui}))),Gi=[...Di,...ji],Xi=e=>Gi.includes(e),qi=Hi("justify",(()=>({type:String,default:null,validator:Xi}))),Ki=[...Di,...ji,"stretch"],Zi=e=>Ki.includes(e),Ji=Hi("alignContent",(()=>({type:String,default:null,validator:Zi}))),Qi={align:Object.keys(Yi),justify:Object.keys(qi),alignContent:Object.keys(Ji)},es={align:"align",justify:"justify",alignContent:"align-content"}
function ts(e,t,a){let l=es[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const as=We()({name:"VRow",props:{dense:Boolean,noGutters:Boolean,align:{type:String,default:null,validator:Ui},...Yi,justify:{type:String,default:null,validator:Xi},...qi,alignContent:{type:String,default:null,validator:Zi},...Ji,...va()},setup(e,a){let{slots:l}=a
const o=t.computed((()=>{const t=[]
let a
for(a in Qi)Qi[a].forEach((l=>{const o=e[l],n=ts(a,l,o)
n&&t.push(n)}))
return t.push({"v-row--no-gutters":e.noGutters,"v-row--dense":e.dense,[`align-${e.align}`]:e.align,[`justify-${e.justify}`]:e.justify,[`align-content-${e.alignContent}`]:e.alignContent}),t}))
return()=>t.h(e.tag,{class:["v-row",o.value]},l.default?.())}}),ls=Ue("flex-grow-1","div","VSpacer"),os=We()({name:"VHover",props:{disabled:Boolean,modelValue:{type:Boolean,default:void 0},...vn()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=St(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=pn(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),ns=Symbol.for("vuetify:v-item-group"),rs=We()({name:"VItemGroup",props:{...Fa({selectedClass:"v-item--selected"}),...va(),...ft()},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Da(e,ns)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value]},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),is=We()({name:"VItem",props:Ma(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=za(e,ns)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),ss=Ue("v-kbd"),us=We()({name:"VLayout",props:et(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=ot(e)
return Ze((()=>t.createVNode("div",{ref:s,class:o.value,style:n.value},[l.default?.()]))),{getLayoutItem:r,items:i}}}),cs=We()({name:"VLayoutItem",props:{position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...tt()},setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item"],style:o.value},[l.default?.()])}}),ds=We()({name:"VLazy",directives:{intersect:sa},props:{modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...oa(),...va(),...ua({transition:"fade-transition"})},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=na(e),n=St(e,"modelValue")
function r(e){n.value||(n.value=e)}return Ze((()=>t.withDirectives(t.createVNode(e.tag,{class:"v-lazy",style:o.value},{default:()=>[n.value&&t.createVNode(ca,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[t.resolveDirective("intersect"),r,e.options]]))),{}}}),vs=We()({name:"VLocaleProvider",props:{locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0}},setup(e,a){let{slots:l}=a
const{rtlClasses:o}=Et(e)
return Ze((()=>t.createVNode("div",{class:["v-locale-provider",o.value]},[l.default?.()]))),{}}}),ps=We()({name:"VMain",props:{scrollable:Boolean,...va({tag:"main"})},setup(e,a){let{slots:l}=a
...
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function hs(){throw new Error}const ys=["start","end","left","right","top","bottom"],bs=We()({name:"VNavigationDrawer",props:{color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[String,Boolean],default:!0},image:String,temporary:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>ys.includes(e)},sticky:Boolean,...ma(),...ha(),...tt(),...ba(),...va({tag:"nav"}),...ft()},emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{isRtl:r}=Tt(),{themeClasses:i}=ht(e),{borderClasses:s}=ga(e),{backgroundColorClasses:u,backgroundColorStyles:c}=wa(t.toRef(e,"color")),{elevationClasses:d}=ya(e),{mobile:v}=Fn(),{roundedClasses:p}=Va(e),f=Ll(),m=St(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:h}=_a(),y=t.ref(),b=t.ref(!1),V=t.computed((()=>e.rail&&e.expandOnHover&&b.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),S=t.computed((()=>W(e.location,r.value))),k=t.computed((()=>!e.permanent&&(v.value||e.temporary))),w=t.computed((()=>e.sticky&&!k.value&&"bottom"!==S.value))
...
const n=St(e,"modelValue"),{t:i,n:s}=Rt(),{isRtl:u}=Tt(),{themeClasses:c}=ht(e),{width:d}=Fn(),v=t.ref(-1)
De(void 0,{scoped:!0})
...
const ks=We()({name:"VParallax",props:{scale:{type:[Number,String],default:.5}},setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${u})`)})))}return Ze((()=>t.createVNode(da,{class:["v-parallax",{"v-parallax--active":n.value}],ref:c,cover:!0,onLoadstart:f,onLoad:f},l))),{}}}),ws=We()({name:"VRadio",props:{...ko({falseIcon:"$radioOff",trueIcon:"$radioOn"})},setup(e,a){let{slots:l}=a
return Ze((()=>t.createVNode(wo,t.mergeProps(e,{class:"v-radio",type:"radio"}),l))),{}}}),xs=We()({name:"VRadioGroup",inheritAttrs:!1,props:{height:{type:[Number,String],default:"auto"},...so(),...k(Vo(),["multiple"]),trueIcon:{type:Ga,default:"$radioOn"},falseIcon:{type:Ga,default:"$radioOff"},type:{type:String,default:"radio"}},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=Le(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=St(e,"modelValue")
return Ze((()=>{const[a,n]=w(l),[s,u]=co(e),[c,d]=xo({...e,multiple:!1}),v=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
...
return t.createVNode(t.Fragment,null,[v&&t.createVNode(Xl,{id:l.value},{default:()=>[v]}),t.createVNode(So,t.mergeProps(c,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:u.value,"aria-labelledby":v?l.value:void 0},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),Cs=We()({name:"VRangeSlider",props:{...Kl(),...so(),...jr(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.ref(),n=t.ref(),r=t.ref()
const{activeThumbRef:i,hasLabels:s,max:u,min:c,mousePressed:d,onSliderMousedown:v,onSliderTouchstart:p,position:f,roundValue:m,trackContainerRef:g}=Hr({props:e,handleSliderMouseUp:e=>{h.value=i.value===o.value?.$el?[e,h.value[1]]:[h.value[0],e]},handleMouseMove:t=>{const[a,l]=h.value
...
const a=Dr(t,o.value.$el,e.direction),l=Dr(t,n.value.$el,e.direction),r=Math.abs(a),i=Math.abs(l)
return r<i||r===i&&a<0?o.value.$el:n.value.$el}}),h=St(e,"modelValue",void 0,(e=>e&&e.length?e.map((e=>m(e))):[0,0])),{isFocused:y,focus:b,blur:V}=Zl(e),S=t.computed((()=>f(h.value[0]))),k=t.computed((()=>f(h.value[1])))
...
return u<=n?n=Math.max(u-v,0):c<=d&&(n=Math.min(n-(c-d-v),l-a)),n}const Bs=Symbol.for("vuetify:v-slide-group"),$s=We()({name:"VSlideGroup",props:{centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:Bs},nextIcon:{type:Ga,default:"$next"},prevIcon:{type:Ga,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...va(),...Fa({selectedClass:"v-slide-group-item--active"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
const{isRtl:n}=Tt(),{mobile:i}=Fn(),s=Da(e,e.symbol),u=t.ref(!1),c=t.ref(0),d=t.ref(0),v=t.ref(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=r(),{resizeRef:g,contentRect:h}=r(),y=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),b=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(a){let a=-1
...
c.value=C(t,0,v.value-d.value)}const P=t.computed((()=>{let e=c.value>v.value-d.value?-(v.value-d.value)+_s(v.value-d.value-c.value):-c.value
...
return Ze((()=>t.createVNode(e.tag,{class:["v-slide-group",{"v-slide-group--vertical":!p.value,"v-slide-group--has-affixes":O.value,"v-slide-group--is-overflowing":u.value}],tabindex:I.value||s.selected.value.length?-1:0,onFocus:A},{default:()=>[O.value&&t.createVNode("div",{key:"prev",class:["v-slide-group__prev",{"v-slide-group__prev--disabled":!F.value}],onClick:()=>T("prev")},[o.prev?.(L.value)??t.createVNode(Yt,null,{default:()=>[t.createVNode(rl,{icon:n.value?e.nextIcon:e.prevIcon},null)]})]),t.createVNode("div",{key:"container",ref:f,class:"v-slide-group__container",onScroll:_},[t.createVNode("div",{ref:g,class:"v-slide-group__content",style:P.value,onTouchstartPassive:w,onTouchmovePassive:x,onTouchendPassive:N,onFocusin:B,onFocusout:$,onKeydown:R},[o.default?.(L.value)])]),O.value&&t.createVNode("div",{key:"next",class:["v-slide-group__next",{"v-slide-group__next--disabled":!M.value}],onClick:()=>T("next")},[o.next?.(L.value)??t.createVNode(Yt,null,{default:()=>[t.createVNode(rl,{icon:n.value?e.prevIcon:e.nextIcon},null)]})])]}))),{selected:s.selected,scrollTo:T,scrollOffset:c,focus:E}}}),As=We()({name:"VSlideGroupItem",props:{...Ma()},emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=za(e,Bs)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}}),Rs=We()({name:"VSnackbar",props:{multiLine:Boolean,timeout:{type:[Number,String],default:5e3},vertical:Boolean,..._l({location:"bottom"}),...Tl(),...ba(),...Ta(),...ft(),...k(qn({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=St(e,"modelValue"),{locationStyles:n}=Il(e),{positionClasses:r}=Pl(e),{scopeId:i}=zn(),{themeClasses:s}=ht(e),{colorClasses:u,colorStyles:c,variantClasses:d}=Pa(e),{roundedClasses:v}=Va(e),p=t.ref()
t.watch(o,m),t.watch((()=>e.timeout),m),t.onMounted((()=>{o.value&&m()}))
let f=-1
function m(){window.clearTimeout(f)
const t=Number(e.timeout)
o.value&&-1!==t&&(f=window.setTimeout((()=>{o.value=!1}),t))}function g(){window.clearTimeout(f)}return Ze((()=>{const[a]=Zn(e)
return t.createVNode(Kn,t.mergeProps({ref:p,class:["v-snackbar",{"v-snackbar--active":o.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--vertical":e.vertical},r.value]},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,contentProps:t.mergeProps({class:["v-snackbar__wrapper",s.value,u.value,v.value,d.value],style:[n.value,c.value],onPointerenter:g,onPointerleave:m},a.contentProps),persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",_disableGlobalStack:!0},i),{default:()=>[Ea(!1,"v-snackbar"),l.default&&t.createVNode("div",{class:"v-snackbar__content",role:"status","aria-live":"polite"},[l.default()]),l.actions&&t.createVNode(Lt,{defaults:{VBtn:{variant:"text",ripple:!1}}},{default:()=>[t.createVNode("div",{class:"v-snackbar__actions"},[l.actions()])]})],activator:l.activator})})),fo({},p)}}),Es=We()({name:"VSwitch",inheritAttrs:!1,props:{indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...so(),...ko()},emits:{"update:focused":e=>!0,"update:modelValue":()=>!0,"update:indeterminate":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=St(e,"indeterminate"),r=St(e,"modelValue"),{loaderClasses:i}=Al(e),{isFocused:s,focus:u,blur:c}=Zl(e),d=t.computed((()=>"string"==typeof e.loading&&""!==e.loading?e.loading:e.color)),v=Le(),p=t.computed((()=>e.id||`switch-${v}`))
function f(){n.value&&(n.value=!1)}return Ze((()=>{const[a,v]=w(l),[m,g]=co(e),[h,y]=xo(e),b=t.ref()
...
return t.createVNode("div",{class:["v-switch__thumb",l.value],style:n.value},[e.loading&&t.createVNode(Rl,{name:"v-switch",active:!0,color:!1===m.value?void 0:d.value},{default:e=>o.loader?o.loader(e):t.createVNode(sl,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)})])}})}})})),{}}}),Ts=We()({name:"VSystemBar",props:{color:String,height:[Number,String],window:Boolean,...ha(),...tt(),...ba(),...va(),...ft()},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{backgroundColorClasses:n,backgroundColorStyles:r}=wa(t.toRef(e,"color")),{elevationClasses:i}=ya(e),{roundedClasses:s}=Va(e),{ssrBootStyles:u}=_a(),c=t.computed((()=>e.height??(e.window?32:24))),{layoutItemStyles:d}=lt({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.ref("top"),layoutSize:c,elementSize:c,active:t.computed((()=>!0)),absolute:t.toRef(e,"absolute")})
return Ze((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value],style:[r.value,d.value,u.value]},l))),{}}}),Ps=Symbol.for("vuetify:v-tabs"),Ls=We()({name:"VTab",props:{fixed:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ga,appendIcon:Ga,stacked:Boolean,title:String,ripple:{type:Boolean,default:!0},color:String,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...va(),...Fl(),...Ma({selectedClass:"v-tab--selected"}),...ft()},setup(e,a){let{slots:l,attrs:o}=a
const{textColorClasses:n,textColorStyles:r}=ka(e,"sliderColor"),i=t.computed((()=>"horizontal"===e.direction)),s=t.ref(!1),u=t.ref(),c=t.ref()
...
J(t,{backgroundColor:[a,""],transform:[`translate${r}(${v}px) scale${r}(${l[d]/o[d]})`,`translate${r}(${v/m}px) scale${r}(${(f-1)/m+1})`,""],transformOrigin:Array(3).fill(p)},{duration:225,easing:Ge})}}return Ze((()=>{const[a]=S(e,["href","to","replace","icon","stacked","prependIcon","appendIcon","ripple","theme","disabled","selectedClass","value","color"])
return t.createVNode(zl,t.mergeProps({_as:"VTab",symbol:Ps,ref:u,class:["v-tab"],tabindex:s.value?0:-1,role:"tab","aria-selected":String(s.value),active:!1,block:e.fixed,maxWidth:e.fixed?300:void 0,variant:"text",rounded:0},a,o,{"onGroup:selected":d}),{default:()=>[l.default?l.default():e.title,!e.hideSlider&&t.createVNode("div",{ref:c,class:["v-tab__slider",n.value],style:r.value},null)]})})),{}}})
...
var t})),{densityClasses:r}=Aa(e),{backgroundColorClasses:i,backgroundColorStyles:s}=wa(t.toRef(e,"bgColor"))
return De({VTab:{color:t.toRef(e,"color"),direction:t.toRef(e,"direction"),stacked:t.toRef(e,"stacked"),fixed:t.toRef(e,"fixedTabs"),sliderColor:t.toRef(e,"sliderColor"),hideSlider:t.toRef(e,"hideSlider")}}),Ze((()=>t.createVNode($s,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},r.value,i.value],style:[{"--v-tabs-height":g(e.height)},s.value],role:"tablist",symbol:Ps,mandatory:e.mandatory,direction:e.direction},{default:()=>[l.default?l.default():n.value.map((e=>t.createVNode(Ls,t.mergeProps(e,{key:e.title}),null)))]}))),{}}}),Fs=We()({name:"VTable",props:{fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...$a(),...va(),...ft()},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ht(e),{densityClasses:n}=Aa(e)
return Ze((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},o.value,n.value]},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:g(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),Ms=We()({name:"VTextarea",directives:{Intersect:sa},inheritAttrs:!1,props:{autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,hint:String,persistentHint:Boolean,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,...so(),...Ql()},emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const r=St(e,"modelValue"),{isFocused:i,focus:s,blur:u}=Zl(e),c=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(r.value):(r.value||"").toString().length)),d=t.computed((()=>l.maxlength?l.maxlength:!e.counter||"number"!=typeof e.counter&&"string"!=typeof e.counter?void 0:e.counter))
...
function V(){h.value!==document.activeElement&&h.value?.focus(),i.value||s()}function S(e){V(),o("click:control",e)}function k(e){o("mousedown:control",e)}function x(a){a.stopPropagation(),V(),t.nextTick((()=>{r.value="",z(e["onClick:clear"],a)}))}function N(e){r.value=e.target.value}const _=t.ref()
...
return t.onMounted(I),t.watch(r,I),t.watch((()=>e.rows),I),t.watch((()=>e.maxRows),I),t.watch((()=>e.density),I),t.watch(_,(e=>{e?(B=new ResizeObserver(I),B.observe(_.value)):B?.disconnect()})),t.onBeforeUnmount((()=>{B?.disconnect()})),Ze((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,g]=w(l),[{modelValue:C,...I}]=co(e),[B]=to(e)
...
return l.default?.(...a)??e.text}})})),fo({},s)}}),Us=We()({name:"VValidation",props:{...ro()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=io(e,"validation")
return()=>a.default?.(l)}})
var Ys=Object.freeze({__proto__:null,VApp:Pt,VAppBar:Ia,VAppBarNavIcon:Dl,VAppBarTitle:Hl,VAlert:Yl,VAlertTitle:Wl,VAutocomplete:or,VAvatar:Bo,VBadge:nr,VBanner:sr,VBannerActions:rr,VBannerText:ir,VBottomNavigation:ur,VBreadcrumbs:vr,VBreadcrumbsItem:dr,VBreadcrumbsDivider:cr,VBtn:zl,VBtnGroup:Oa,VBtnToggle:Wa,VCard:yr,VCardActions:pr,VCardItem:gr,VCardSubtitle:fr,VCardText:hr,VCardTitle:mr,VCarousel:_r,VCarouselItem:Ir,VCheckbox:_o,VCheckboxBtn:No,VChip:Ro,VChipGroup:Ao,VCode:Br,VColorPicker:yi,VCombobox:bi,VCounter:vo,VDefaultsProvider:Lt,VDialog:Vi,VDivider:Eo,VExpansionPanels:wi,VExpansionPanel:_i,VExpansionPanelText:Ni,VExpansionPanelTitle:Ci,VField:eo,VFieldLabel:ql,VFileInput:Ii,VFooter:Bi,VForm:$i,VContainer:Ai,VCol:Mi,VRow:as,VSpacer:ls,VHover:os,VIcon:rl,VComponentIcon:Ka,VSvgIcon:Za,VLigatureIcon:Ja,VClassIcon:Qa,VImg:da,VInput:uo,VItemGroup:rs,VItem:is,VKbd:ss,VLabel:Xl,VLayout:us,VLayoutItem:cs,VLazy:ds,VList:sn,VListGroup:qo,VListImg:un,VListItem:Jo,VListItemAction:cn,VListItemMedia:dn,VListItemSubtitle:Ko,VListItemTitle:Zo,VListSubheader:Qo,VLocaleProvider:vs,VMain:ps,VMenu:Jn,VMessages:ao,VNavigationDrawer:bs,VNoSsr:Vs,VOverlay:Kn,VPagination:Ss,VParallax:ks,VProgressCircular:sl,VProgressLinear:Bl,VRadio:ws,VRadioGroup:xs,VRangeSlider:Cs,VRating:Ns,VResponsive:ra,VSelect:er,VSelectionControl:wo,VSelectionControlGroup:So,VSheet:hi,VSlideGroup:$s,VSlideGroupItem:As,VSlider:Yr,VSnackbar:Rs,VSwitch:Es,VSystemBar:Ts,VTabs:Os,VTab:Ls,VTable:Fs,VTextarea:Ms,VTextField:ho,VThemeProvider:zs,VTimeline:Ds,VTimelineItem:Hs,VToolbar:Na,VToolbarTitle:fa,VToolbarItems:jl,VTooltip:Ws,VValidation:Us,VWindow:Cr,VWindowItem:Nr,VDialogTransition:zt,VFabTransition:Ht,VDialogBottomTransition:Wt,VDialogTopTransition:Ut,VFadeTransition:Yt,VScaleTransition:Gt,VScrollXTransition:Xt,VScrollXReverseTransition:qt,VScrollYTransition:Kt,VScrollYReverseTransition:Zt,VSlideXTransition:Jt,VSlideXReverseTransition:Qt,VSlideYTransition:ea,VSlideYReverseTransition:ta,VExpandTransition:aa,VExpandXTransition:la})
function Gs(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Xs={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:o,immediate:n,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((function(){let a=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],l=arguments.length>1?arguments[1]:void 0
s?.(a,l),o&&Gs(e,t)}))
n&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:Gs}
...
function Ks(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,o="object"==typeof l&&l.options||{passive:!0},n="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",n,o),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:n,options:o,target:a?void 0:r})}function Zs(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:o=e}=e._onScroll[t.instance.$.uid]
o.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const Js={mounted:Ks,unmounted:Zs,updated:function(e,t){t.value!==t.oldValue&&(Zs(e,t),Ks(e,t))}}
var Qs=Object.freeze({__proto__:null,ClickOutside:Gn,Intersect:sa,Mutate:Xs,Resize:qs,Ripple:Cl,Scroll:Js,Touch:kr})
function eu(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:l,...o}=e,n=I(l,o),{aliases:r={},components:i={},directives:s={}}=n,u=Me(n.defaults),c=On(n.display,n.ssr),d=gt(n.theme),v=tl(n.icons),p=At(n.locale),f=e=>{for(const t in s)e.directive(t,s[t])
...
return t.nextTick((()=>c.update())),e.mount=a,l}}Le.reset(),("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&e.mixin({computed:{$vuetify(){return t.reactive({defaults:tu.call(this,Fe),display:tu.call(this,Rn),theme:tu.call(this,pt),icons:tu.call(this,Xa),locale:tu.call(this,$t)})}}})}
return{install:f,defaults:u,display:c,theme:d,icons:v,locale:p}}function tu(e){const t=this.$,a=t.parent?.provides??t.vnode.appContext?.provides
if(a&&e in a)return a[e]}eu.version="3.1.10"
const au=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return eu({components:Ys,directives:Qs,...e})},lu="3.1.10"
au.version=lu,e.components=Ys,e.createVuetify=au,e.directives=Qs,e.useDisplay=Fn,e.useLayout=at,e.useLocale=Rt,e.useRtl=Tt,e.useTheme=yt,e.version=lu,Object.defineProperty(e,"__esModule",{value:!0})}))
