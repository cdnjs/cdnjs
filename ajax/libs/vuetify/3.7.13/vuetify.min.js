...
for(const l of t)Object.hasOwn(e,l)&&(a[l]=e[l])
...
function P(e){const[t,a]=k(e,[N]),l=x(t,_),[o,n]=k(a,["class","style","id",/^data-/])
return Object.assign(o,t),Object.assign(n,l),[o,n]}function B(e){return null==e?[]:Array.isArray(e)?e:[e]}function A(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,a=arguments.length>2&&void 0!==arguments[2]?arguments[2]:1
...
g(n)&&g(r)?l[o]=F(n,r,a):a&&Array.isArray(n)&&Array.isArray(r)?l[o]=a(n,r):l[o]=r}return l}function $(e){return e.map((e=>e.type===t.Fragment?$(e.children):e)).flat()}function M(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:""
...
return Object.defineProperty(a,"value",{enumerable:!0,get:()=>e.value,set:t=>e.value=t}),Object.defineProperty(a,"el",{enumerable:!0,get:()=>h(e.value)}),a}function le(e){const t=1===e.key.length,a=!e.ctrlKey&&!e.metaKey&&!e.altKey
return t&&a}function oe(e){return"string"==typeof e||"number"==typeof e||"boolean"==typeof e||"bigint"==typeof e}const ne=["top","bottom"],re=["start","end","left","right"]
function ie(e,t){let[a,l]=e.split(" ")
return l||(l=W(ne,a)?"start":W(re,a)?"top":"center"),{side:se(a,t),align:se(l,t)}}function se(e,t){return"start"===e?t?"right":"left":"end"===e?t?"left":"right":e}function ue(e){return{side:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.side],align:e.align}}function ce(e){return{side:e.side,align:{center:"center",top:"bottom",bottom:"top",left:"right",right:"left"}[e.align]}}function de(e){return{side:e.align,align:e.side}}function ve(e){return W(ne,e.side)?"y":"x"}class pe{constructor(e){let{x:t,y:a,width:l,height:o}=e
...
s=e>-.001?0:e>-.078?e-e*Te*De:e+De}return 100*s}function $e(e){t.warn(`Vuetify: ${e}`)}function Me(e){t.warn(`Vuetify error: ${e}`)}const Oe=.20689655172413793,Le=e=>e>Oe**3?Math.cbrt(e):e/(3*Oe**2)+4/29,ze=e=>e>Oe?e**3:3*Oe**2*(e-4/29)
...
t.provide(kt,t.computed((()=>i.value?F(e?.value??{},i.value):e?.value)))}}}function _t(e){if(e._setup=e._setup??e.setup,!e.name)return $e("The component is missing an explicit name, unable to generate default prop value"),e
...
return a=>(e?_t:t.defineComponent)(a)}function Pt(e){let a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"div",l=arguments.length>2?arguments[2]:void 0
...
{const e=t.watch(h,(t=>{t&&(requestAnimationFrame((()=>{requestAnimationFrame((()=>{B.value=!0}))})),e())}))}return $t((()=>{const a=rl.filterProps(e)
return t.withDirectives(t.createVNode(rl,t.mergeProps({class:["v-img",{"v-img--absolute":e.absolute,"v-img--booting":!B.value},r.value,s.value,e.class],style:[{width:f("auto"===e.width?p.value:e.width)},i.value,e.style]},a,{aspectRatio:h.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(N,null,null),t.createVNode(C,null,null),t.createVNode(P,null,null),t.createVNode(_,null,null),t.createVNode(I,null,null)]),default:n.default}),[[t.resolveDirective("intersect"),{handler:y,options:e.options},null,{once:!0}]])})),{currentSrc:c,image:d,state:v,naturalWidth:p,naturalHeight:m}}}),yl=gt({border:[Boolean,Number,String]},"border")
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const Fl=gt({baseColor:String,divided:Boolean,...yl(),...ht(),...Bl(),...Vl(),...cl(),...Pa(),...wa(),...Dl()},"VBtnGroup"),$l=It()({name:"VBtnGroup",props:Fl(),setup(e,a){let{slots:l}=a
...
const o=t.reactive([]),n=ia(e,"modelValue",[],(e=>null==e?[]:jl(o,B(e))),(t=>{const a=function(e,t){const a=[]
...
return H((()=>{let a,l
return W(Yl,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:f(e.size),height:f(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const Kl=gt({color:String,disabled:Boolean,start:Boolean,end:Boolean,icon:Mt,...ht(),...Gl(),...Pa({tag:"i"}),...wa()},"VIcon"),Xl=It()({name:"VIcon",props:Kl(),setup(e,a){let{attrs:l,slots:o}=a
...
t.onBeforeUnmount((()=>{e.disconnect()})),t.watch(o,((t,a)=>{a&&(e.unobserve(a),n.value=!1),t&&e.observe(t)}),{flush:"post"})}return{intersectionRef:o,isIntersecting:n}}const Ql=gt({bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...ht(),...Gl(),...Pa({tag:"div"}),...wa()},"VProgressCircular"),Jl=It()({name:"VProgressCircular",props:Ql(),setup(e,a){let{slots:l}=a
...
function Io(e){_o||e.keyCode!==y.enter&&e.keyCode!==y.space||(_o=!0,ko(e))}function Po(e){_o=!1,No(e)}function Bo(e){_o&&(_o=!1,No(e))}function Ao(e,t,a){const{value:l,modifiers:o}=t,n=So(l)
...
e.addEventListener("touchstart",ko,{passive:!0}),e.addEventListener("touchend",No,{passive:!0}),e.addEventListener("touchmove",Co,{passive:!0}),e.addEventListener("touchcancel",No),e.addEventListener("mousedown",ko),e.addEventListener("mouseup",No),e.addEventListener("mouseleave",No),e.addEventListener("keydown",Io),e.addEventListener("keyup",Po),e.addEventListener("blur",Bo),e.addEventListener("dragstart",No,{passive:!0})}else!n&&a&&Ro(e)}function Ro(e){e.removeEventListener("mousedown",ko),e.removeEventListener("touchstart",ko),e.removeEventListener("touchend",No),e.removeEventListener("touchmove",Co),e.removeEventListener("touchcancel",No),e.removeEventListener("mouseup",No),e.removeEventListener("mouseleave",No),e.removeEventListener("keydown",Io),e.removeEventListener("keyup",Po),e.removeEventListener("dragstart",No),e.removeEventListener("blur",Bo)}const To={mounted:function(e,t){Ao(e,t,!1)},unmounted:function(e){delete e._ripple,Ro(e)},updated:function(e,t){if(t.value===t.oldValue)return
Ao(e,t,So(t.oldValue))}},Do=gt({active:{type:Boolean,default:void 0},activeColor:String,baseColor:String,symbol:{type:null,default:Hl},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Mt,appendIcon:Mt,block:Boolean,readonly:Boolean,slim:Boolean,stacked:Boolean,ripple:{type:[Boolean,Object],default:!0},text:String,...yl(),...ht(),...Bl(),...ll(),...Vl(),...Ol(),...no(),...to(),...uo(),...cl(),...fo(),...Gl(),...Pa({tag:"button"}),...wa(),...Dl({variant:"elevated"})},"VBtn"),Eo=It()({name:"VBtn",props:Do(),emits:{"group:selected":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return $t((()=>t.createVNode(Eo,t.mergeProps(e,{class:["v-app-bar-nav-icon"]}),l))),{}}}),Mo=It()({name:"VAppBarTitle",props:Ba(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(Aa,t.mergeProps(e,{class:"v-app-bar-title"}),l))),{}}}),Oo=Pt("v-alert-title"),Lo=["success","info","warning","error"],zo=gt({border:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:Mt,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>Lo.includes(e)},...ht(),...Bl(),...ll(),...Vl(),...to(),...uo(),...cl(),...Pa(),...wa(),...Dl({variant:"flat"})},"VAlert"),jo=It()({name:"VAlert",props:zo(),emits:{"click:close":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.createVNode(Xl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r,onKeydown:function(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),q(r,new PointerEvent("click",e)))}},null)}}}const an=gt({active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...ht(),...vl({transition:{component:Za,leaveAbsolute:!0,group:!0}})},"VMessages"),ln=It()({name:"VMessages",props:an(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>B(e.messages))),{textColorClasses:n,textColorStyles:r}=sl(t.computed((()=>e.color)))
return $t((()=>t.createVNode(pl,{transition:e.transition,tag:"div",class:["v-messages",n.value,e.class],style:[r.value,e.style]},{default:()=>[e.active&&o.value.map(((e,a)=>t.createVNode("div",{class:"v-messages__message",key:`${a}-${o.value}`},[l.message?l.message({message:e}):e])))]}))),{}}}),on=gt({focused:Boolean,"onUpdate:focused":Y()},"focus")
...
const o=ia(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=un(e),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!B(""===o.value?null:o.value).length&&!B(""===n.value?null:n.value).length))),c=t.computed((()=>e.errorMessages?.length?B(e.errorMessages).concat(i.value).slice(0,Math.max(0,+e.maxErrors)):i.value)),d=t.computed((()=>{let t=(e.validateOn??r.validateOn?.value)||"input"
...
async function n(t,a){return In(t,F(e,a),!1,o)}return n.horizontal=async(t,a)=>In(t,F(e,a),!0,o),n}function Bn(e,t){const a=e?"scrollWidth":"scrollHeight"
...
return t?.[a]||0}const Dn=Symbol.for("vuetify:v-slide-group"),En=gt({centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:Dn},nextIcon:{type:Mt,default:"$next"},prevIcon:{type:Mt,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...ht(),...kn({mobile:null}),...Pa(),...Ml({selectedClass:"v-slide-group-item--active"})},"VSlideGroup"),Fn=It()({name:"VSlideGroup",props:En(),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
const{isRtl:n}=ba(),{displayClasses:r,mobile:i}=xn(e),s=zl(e,e.symbol),u=t.shallowRef(!1),c=t.shallowRef(0),d=t.shallowRef(0),v=t.shallowRef(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=Qt(),{resizeRef:g,contentRect:h}=Qt(),y=Pn(),b=t.computed((()=>({container:f.el,duration:200,easing:"easeOutQuart"}))),V=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),w=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(a){let a=-1
...
else{t=K(g.el)[0]}t&&t.focus({preventScroll:!0})}function D(e){const t=p.value&&n.value?-1:1,a=("prev"===e?-t:t)*d.value
let l=c.value+a
...
return $t((()=>t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":s?.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":o.value},e.class],style:e.style},{default:()=>[l.activator&&t.createVNode(al,{defaults:p.value},{default:()=>[t.createVNode(lr,null,{default:()=>[l.activator({props:d.value,isOpen:o.value})]})]}),t.createVNode(pl,{transition:{component:Ja},disabled:!u.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items",role:"group","aria-labelledby":i.value},[l.default?.()]),[[t.vShow,o.value]])]})]}))),{isOpen:o}}}),rr=gt({opacity:[Number,String],...ht(),...Pa()},"VListItemSubtitle"),ir=It()({name:"VListItemSubtitle",props:rr(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),sr=Pt("v-list-item-title"),ur=gt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Mt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number],title:[String,Number],value:null,onClick:Y(),onClickOnce:Y(),...yl(),...ht(),...Bl(),...ll(),...Vl(),...cl(),...fo(),...Pa(),...wa(),...Dl({variant:"text"})},"VListItem"),cr=It()({name:"VListItem",directives:{Ripple:To},props:ur(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
const{themeClasses:I}=ka(e),{borderClasses:P}=bl(e),{colorClasses:B,colorStyles:A,variantClasses:R}=El(C),{densityClasses:T}=Al(e),{dimensionStyles:D}=ol(e),{elevationClasses:E}=wl(e),{roundedClasses:F}=dl(x),$=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),M=t.computed((()=>({isActive:V.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
...
return l.header?l.header({props:r}):t.createVNode(cr,r,s)},default:()=>t.createVNode(gr,{items:o,returnObject:e.returnObject},l)}):l.item?l.item({props:n}):t.createVNode(cr,t.mergeProps(n,{value:e.returnObject?i:n.value}),s)}))}}),hr=gt({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean,valueComparator:Function},"list-items")
...
return{title:String(n.title??""),value:n.value,props:n,children:Array.isArray(o)?br(e,o):void 0,raw:t}}function br(e,t){const a=S(e,["itemTitle","itemValue","itemChildren","itemProps","returnObject","valueComparator"]),l=[]
for(const e of t)l.push(yr(a,e))
return l}function Vr(e){const a=t.computed((()=>br(e,e.items))),l=t.computed((()=>a.value.some((e=>null===e.value)))),o=t.shallowRef(new Map),n=t.shallowRef([])
return t.watchEffect((()=>{const e=a.value,t=new Map,l=[]
for(let a=0;a<e.length;a++){const o=e[a]
if(oe(o.value)||null===o.value){let e=t.get(o.value)
e||(e=[],t.set(o.value,e)),e.push(o)}else l.push(o)}o.value=t,n.value=l})),{items:a,transformIn:function(t){const r=o.value,i=a.value,s=n.value,u=l.value,d=e.returnObject,v=!!e.valueComparator,p=e.valueComparator||c,f=S(e,["itemTitle","itemValue","itemChildren","itemProps","returnObject","valueComparator"]),m=[]
e:for(const e of t){if(!u&&null===e)continue
if(d&&"string"==typeof e){m.push(yr(f,e))
continue}const t=r.get(e)
if(!v&&t)m.push(...t)
else{for(const t of v?i:s)if(p(e,t.value)){m.push(t)
continue e}m.push(yr(f,e))}}return m},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{value:t}=e
return t}))}}}function wr(e,t){const a=v(t,e.itemType,"item"),l=oe(t)?t:v(t,e.itemTitle),o=v(t,e.itemValue,void 0),n=v(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?x(t,["children"]):v(t,e.itemProps)}
...
P("last")}e.preventDefault()}}function I(e){S.value=!0}function P(e){if(k.value)return Z(k.value,e)}return $t((()=>t.createVNode(e.tag,{ref:k,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},n.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:x,onFocusout:N,onFocus:C,onKeydown:_,onMousedown:I},{default:()=>[t.createVNode(gr,{items:o.value,returnObject:e.returnObject},l)]}))),{open:f,select:g,focus:P,children:p,parents:m,getPath:h}}}),Nr=Pt("v-list-img"),Cr=gt({start:Boolean,end:Boolean,...ht(),...Pa()},"VListItemAction"),_r=It()({name:"VListItemAction",props:Cr(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end},e.class],style:e.style},l))),{}}}),Ir=gt({start:Boolean,end:Boolean,...ht(),...Pa()},"VListItemMedia"),Pr=It()({name:"VListItemMedia",props:Ir(),setup(e,a){let{slots:l}=a
...
function Br(e,t){return{x:e.x+t.x,y:e.y+t.y}}function Ar(e,t){if("top"===e.side||"bottom"===e.side){const{side:a,align:l}=e
return Br({x:"left"===l?0:"center"===l?t.width/2:"right"===l?t.width:l,y:"top"===a?0:"bottom"===a?t.height:a},t)}if("left"===e.side||"right"===e.side){const{side:a,align:l}=e
return Br({x:"left"===a?0:"right"===a?t.width:a,y:"top"===l?0:"center"===l?t.height/2:"bottom"===l?t.height:l},t)}return Br({x:t.width/2,y:t.height/2},t)}const Rr={static:function(){},connected:function(e,a,l){(Array.isArray(e.target.value)||function(e){for(;e;){if("fixed"===window.getComputedStyle(e).position)return!0
e=e.offsetParent}return!1}(e.target.value))&&Object.assign(l.value,{position:"fixed",top:0,[e.isRtl.value?"right":"left"]:0})
const{preferredAnchor:o,preferredOrigin:n}=H((()=>{const t=ie(a.location,e.isRtl.value),l="overlap"===a.origin?t:"auto"===a.origin?ue(t):ie(a.origin,e.isRtl.value)
...
const _=ae(),I=t.computed((()=>"cursor"===e.target&&g.value?g.value:_.value?_.el:qr(e.target,i)||s.value)),P=t.computed((()=>Array.isArray(I.value)?void 0:I.value))
let B
...
a&&function(e,t){Object.keys(t).forEach((a=>{if(C(a)){const l=U(a),o=ye.get(e)
...
a&&function(e,t){Object.keys(t).forEach((t=>{if(C(t)){const a=U(t),l=ye.get(e)
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,i,{activatorEl:s,activatorEvents:S})}))):B&&B.stop()}),{flush:"post",immediate:!0}),t.onScopeDispose((()=>{B?.stop()})),{activatorEl:s,activatorRef:N,target:I,targetEl:P,targetRef:_,activatorEvents:S,contentEvents:k,scrimEvents:x}}function qr(e,t){if(!e)return
let a
...
return o.push(t),!o.some((t=>t?.contains(e.target)))}function li(e,t){return("object"==typeof t.value&&t.value.closeConditional||ti)(e)}function oi(e,t){const a=Bt(e)
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(v,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:k,activatorRef:x,target:N,targetEl:C,targetRef:_,activatorEvents:I,contentEvents:P,scrimEvents:B}=Gr(e,{isActive:v,isTop:w,contentEl:c}),{teleportTarget:A}=function(e){return{teleportTarget:t.computed((()=>{const l=e()
if(!0===l||!a)return
...
if(await t.nextTick(),n.value&&a!==l&&c.value?.contentEl&&c.value?.globalTop&&![document,c.value.contentEl].includes(l)&&!c.value.contentEl.contains(l)){const e=K(c.value.contentEl)
...
X(K(c.value?.contentEl,!1),t.shiftKey?"prev":"next",(e=>e.tabIndex>=0))||(n.value=!1,c.value?.activatorEl?.focus())}else e.submenu&&t.key===(i.value?"ArrowRight":"ArrowLeft")&&(n.value=!1,c.value?.activatorEl?.focus())}function g(t){if(e.disabled)return
const a=c.value?.contentEl
a&&n.value?"ArrowDown"===t.key?(t.preventDefault(),t.stopImmediatePropagation(),Z(a,"next")):"ArrowUp"===t.key?(t.preventDefault(),t.stopImmediatePropagation(),Z(a,"prev")):e.submenu&&(t.key===(i.value?"ArrowRight":"ArrowLeft")?n.value=!1:t.key===(i.value?"ArrowLeft":"ArrowRight")&&(t.preventDefault(),Z(a,"first"))):(e.submenu?t.key===(i.value?"ArrowLeft":"ArrowRight"):["ArrowDown","ArrowUp"].includes(t.key))&&(n.value=!0,t.preventDefault(),setTimeout((()=>setTimeout((()=>g(t))))))}t.provide(Hr,{register(){v.value.add(s)},unregister(){v.value.delete(s)},closeParents(t){setTimeout((()=>{v.value.size||e.persistent||null!=t&&(!c.value?.contentEl||function(e,t){const a=e.clientX,l=e.clientY,o=t.getBoundingClientRect(),n=o.left,r=o.top,i=o.right,s=o.bottom
...
function A(e){e.target!==document.activeElement&&e.preventDefault()}return $t((()=>{const a="outlined"===e.variant,o=!(!n["prepend-inner"]&&!e.prependInnerIcon),u=!(!e.clearable&&!n.clear||e.disabled),f=!!(n["append-inner"]||e.appendInnerIcon||u),b=()=>n.label?n.label({...B.value,label:e.label,props:{for:V.value}}):e.label
return t.createVNode("div",t.mergeProps({class:["v-field",{"v-field--active":g.value,"v-field--appended":f,"v-field--center-affix":e.centerAffix??!N.value,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":o,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!b(),[`v-field--variant-${e.variant}`]:!0},r.value,C.value,s.value,i.value,p.value,m.value,e.class],style:[_.value,e.style],onClick:A},l),[t.createVNode("div",{class:"v-field__overlay"},null),t.createVNode(io,{name:"v-field",active:!!e.loading,color:e.error?"error":"string"==typeof e.loading?e.loading:e.color},{default:n.loader}),o&&t.createVNode("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&t.createVNode(v,{key:"prepend-icon",name:"prependInner"},null),n["prepend-inner"]?.(B.value)]),t.createVNode("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&y.value&&t.createVNode(hi,{key:"floating-label",ref:k,class:[I.value],floating:!0,for:V.value,style:P.value},{default:()=>[b()]}),h.value&&t.createVNode(hi,{key:"label",ref:S,for:V.value},{default:()=>[b()]}),n.default?.({...B.value,props:{id:V.value,class:"v-field__input","aria-describedby":w.value},focus:c,blur:d})]),u&&t.createVNode(el,{key:"clear"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-field__clearable",onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},[t.createVNode(al,{defaults:{VIcon:{icon:e.clearIcon}}},{default:()=>[n.clear?n.clear({...B.value,props:{onFocus:c,onBlur:d,onClick:e["onClick:clear"]}}):t.createVNode(v,{name:"clear",onFocus:c,onBlur:d},null)]})]),[[t.vShow,e.dirty]])]}),f&&t.createVNode("div",{key:"append",class:"v-field__append-inner"},[n["append-inner"]?.(B.value),e.appendInnerIcon&&t.createVNode(v,{key:"append-icon",name:"appendInner"},null)]),t.createVNode("div",{class:["v-field__outline",I.value],style:P.value},[a&&t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-field__outline__start"},null),y.value&&t.createVNode("div",{class:"v-field__outline__notch"},[t.createVNode(hi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})]),t.createVNode("div",{class:"v-field__outline__end"},null)]),N.value&&y.value&&t.createVNode(hi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})])])})),{controlRef:x}}})
function wi(e){return S(e,Object.keys(Vi.props).filter((e=>!C(e)&&"class"!==e&&"style"!==e)))}const Si=["color","file","time","date","datetime-local","week","month"],ki=gt({autofocus:Boolean,counter:[Boolean,Number,String],counterValue:[Number,Function],prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,suffix:String,role:String,type:{type:String,default:"text"},modelModifiers:Object,...vn(),...bi()},"VTextField"),xi=It()({name:"VTextField",directives:{Intersect:ml},inheritAttrs:!1,props:ki(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
let B=-1
function R(){c.value&&d.value&&(I=0,P=0,window.clearTimeout(B),D())}let T=-1
function D(){cancelAnimationFrame(T),T=requestAnimationFrame(E)}function E(){if(!c.value||!g.value)return
const e=_-v,t=Math.sign(I),a=A(C(Math.max(0,e-100)),0,l.value.length),o=A(C(e+g.value+100)+1,a+1,l.value.length)
...
t-P>500?(I=Math.sign(e-_),v=d.value.offsetTop):I=e-_,_=e,P=t,window.clearTimeout(B),B=window.setTimeout(R,500),D()},handleScrollend:R,handleItemResize:function(e,t){const a=y[e],l=n.value
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Pi=gt({items:{type:Array,default:()=>[]},renderless:Boolean,..._i(),...ht(),...ll()},"VVirtualScroll"),Bi=It()({name:"VVirtualScroll",props:Pi(),setup(e,a){let{slots:l}=a
...
break}}}}}const Ri=gt({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Mt,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...hr({itemChildren:!1})},"Select"),Ti=gt({...Ri(),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:{component:$a}})},"VSelect"),Di=It()({name:"VSelect",props:Ti(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.ref(),s=t.ref(),u=ia(e,"menu"),d=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren.size||(u.value=e)}}),{items:v,transformIn:p,transformOut:f}=Vr(e),m=ia(e,"modelValue",[],(e=>p(null===e?[null]:B(e))),(t=>{const a=f(t)
return e.multiple?a:a[0]??null})),g=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(m.value):"number"==typeof e.counterValue?e.counterValue:m.value.length)),h=un(e),y=t.computed((()=>m.value.map((e=>e.value)))),b=t.shallowRef(!1),V=t.computed((()=>d.value?e.closeText:e.openText))
let w,S=""
const k=t.computed((()=>e.hideSelected?v.value.filter((t=>!m.value.some((a=>(e.valueComparator||c)(a,t))))):v.value)),x=t.computed((()=>e.hideNoData&&!k.value.length||h.isReadonly.value||h.isDisabled.value)),N=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),C=t.ref(),_=Ai(C,r)
function I(t){e.openOnClear&&(d.value=!0)}function P(){x.value||(d.value=!d.value)}function A(e){le(e)&&R(e)}function R(e){if(!e.key||h.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(e.key)&&e.preventDefault(),["Enter","ArrowDown"," "].includes(e.key)&&(d.value=!0),["Escape","Tab"].includes(e.key)&&(d.value=!1),"Home"===e.key?C.value?.focus("first"):"End"===e.key&&C.value?.focus("last")
if(!le(e))return
...
else if(ee(r.value,":autofill")||ee(r.value,":-webkit-autofill")){const t=v.value.find((t=>t.title===e))
...
a&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{d.value||b.value&&!t.length&&e.length&&(d.value=!0)})),$t((()=>{const a=!(!e.chips&&!o.chip),l=!!(!e.hideNoData||k.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),u=m.value.length>0,c=xi.filterProps(e),v=u||!b.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(xi,t.mergeProps({ref:r},c,{modelValue:m.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":M,focused:b.value,"onUpdate:focused":e=>b.value=e,validationValue:m.externalValue,counterValue:g.value,dirty:u,class:["v-select",{"v-select--active-menu":d.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":m.value.length,"v-select--selection-slot":!!o.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":I,"onMousedown:control":P,onBlur:D,onKeydown:R,"aria-label":n(V.value),title:n(V.value)}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:i,modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,activator:"parent",contentClass:"v-select__content",disabled:x.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:E,onAfterLeave:F},N.value),{default:()=>[l&&t.createVNode(xr,t.mergeProps({ref:C,selected:y.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:A,onFocusin:$,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},_,e.listProps),{default:()=>[o["prepend-item"]?.(),!k.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Bi,{ref:s,renderless:!0,items:k.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(en,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Wo,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(Xl,{icon:l.props.prependIcon},null)])}})}}),o["append-item"]?.()]})]}),m.value.map(((l,n)=>{function r(e){e.stopPropagation(),e.preventDefault(),T(l,!1)}const i={"onClick:close":r,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),r(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},s=a?!!o.chip:!!o.selection,u=s?te(a?o.chip({item:l,index:n,props:i}):o.selection({item:l,index:n})):void 0
if(!s||u)return t.createVNode("div",{key:l.value,class:"v-select__selection"},[a?o.chip?t.createVNode(al,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[u]}):t.createVNode(zn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title,disabled:l.props.disabled},i),null):u??t.createVNode("span",{class:"v-select__selection-text"},[l.title,e.multiple&&n<m.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),n=0;n<a;n++)l[n]=arguments[n]
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Xl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),di({isFocused:b,menu:d,select:T},r)}}),Ei=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),Fi=gt({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function $i(e,a,l,o){const n=t.shallowRef([]),r=t.shallowRef(new Map),i=t.computed((()=>o?.transform?t.unref(a).map((e=>[e,o.transform(e)])):t.unref(a)))
return t.watchEffect((()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],o=a?.default??Ei,n=!!a?.filterKeys&&B(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
const l=d[t]
p.push(l),f.set(l.value,a)})),n.value=p,r.value=f})),{filteredItems:n,filteredMatches:r,getMatches:function(e){return r.value.get(e.value)}}}const Mi=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:Boolean,search:String,...Fi({filterKeys:["title"]}),...Ri(),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VAutocomplete"),Oi=It()({name:"VAutocomplete",props:Mi(),emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),d=t.ref(),v=t.ref(),p=ia(e,"menu"),f=t.computed({get:()=>p.value,set:e=>{p.value&&!e&&d.value?.ΨopenChildren.size||(p.value=e)}}),m=t.shallowRef(-1),g=t.computed((()=>r.value?.color)),h=t.computed((()=>f.value?e.closeText:e.openText)),{items:y,transformIn:b,transformOut:V}=Vr(e),{textColorClasses:w,textColorStyles:S}=sl(g),k=ia(e,"search",""),x=ia(e,"modelValue",[],(e=>b(null===e?[null]:B(e))),(t=>{const a=V(t)
return e.multiple?a:a[0]??null})),N=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:x.value.length)),C=un(e),{filteredItems:_,getMatches:I}=$i(e,y,(()=>s.value?"":k.value)),P=t.computed((()=>e.hideSelected?_.value.filter((e=>!x.value.some((t=>t.value===e.value)))):_.value)),A=t.computed((()=>!(!e.chips&&!o.chip))),R=t.computed((()=>A.value||!!o.selection)),T=t.computed((()=>x.value.map((e=>e.props.value)))),D=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&k.value===P.value[0]?.title)&&P.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!P.value.length||C.isReadonly.value||C.isDisabled.value)),F=t.ref(),$=Ai(F,r)
function M(t){e.openOnClear&&(f.value=!0),k.value=""}function O(){E.value||(f.value=!0)}function L(e){E.value||(i.value&&(e.preventDefault(),e.stopPropagation()),f.value=!f.value)}function z(e){" "!==e.key&&le(e)&&r.value?.focus()}function j(t){if(C.isReadonly.value)return
...
const e=m.value+1
x.value[e]?m.value=e:(m.value=-1,r.value.setSelectionRange(0,0))}else~m.value&&le(t)&&(m.value=-1)}function H(e){if(ee(r.value,":autofill")||ee(r.value,":-webkit-autofill")){const t=y.value.find((t=>t.title===e.target.value))
...
return Nt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Wi=Pt("v-banner-text"),Ui=gt({avatar:String,bgColor:String,color:String,icon:Mt,lines:String,stacked:Boolean,sticky:Boolean,text:String,...yl(),...ht(),...Bl(),...ll(),...kn({mobile:null}),...Vl(),...to(),...uo(),...cl(),...Pa(),...wa()},"VBanner"),Yi=It()({name:"VBanner",props:Ui(),setup(e,a){let{slots:l}=a
...
return $t((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),ts=gt({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...ht(),...fo(),...Pa({tag:"li"})},"VBreadcrumbsItem"),as=It()({name:"VBreadcrumbsItem",props:ts(),setup(e,a){let{slots:l,attrs:o}=a
...
return Nt({VBtn:{slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),rs=gt({opacity:[Number,String],...ht(),...Pa()},"VCardSubtitle"),is=It()({name:"VCardSubtitle",props:rs(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),ss=Pt("v-card-title"),us=gt({appendAvatar:String,appendIcon:Mt,prependAvatar:String,prependIcon:Mt,subtitle:[String,Number],title:[String,Number],...ht(),...Bl()},"VCardItem"),cs=It()({name:"VCardItem",props:us(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(ss,{key:"title"},{default:()=>[l.title?.()??e.title]}),s&&t.createVNode(is,{key:"subtitle"},{default:()=>[l.subtitle?.()??e.subtitle]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(al,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),ds=gt({opacity:[Number,String],...ht(),...Pa()},"VCardText"),vs=It()({name:"VCardText",props:ds(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-text",e.class],style:[{"--v-card-text-opacity":e.opacity},e.style]},l))),{}}}),ps=gt({appendAvatar:String,appendIcon:Mt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},subtitle:[String,Number],text:[String,Number],title:[String,Number],...yl(),...ht(),...Bl(),...ll(),...Vl(),...no(),...to(),...uo(),...cl(),...fo(),...Pa(),...wa(),...Dl({variant:"elevated"})},"VCard"),fs=It()({name:"VCard",directives:{Ripple:To},props:ps(),setup(e,a){let{attrs:l,slots:o}=a
...
const Bs={h:0,s:0,v:0,a:1},As={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)})},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)})},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:et,from:at},Rs={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:lt,from:ot},Ts={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t}],to:ct,from:function(e){return at(ut(e))}},Ds={rgb:{...As,inputs:As.inputs?.slice(0,3)},rgba:As,hsl:{...Rs,inputs:Rs.inputs.slice(0,3)},hsla:Rs,hex:{...Ts,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t}]},hexa:Ts},Es=e=>{let{label:a,...l}=e
...
o&&l("update:color",t.from(r(a??t.to(Bs),o.value)))}}}))}))
...
return(l?d.value:d.value!==s.value)&&(p=1-p),h(v.value+p*(f.value-v.value))}const R=e=>{const t=B(e)
null!=t&&r({value:t}),C.value=!1,_.value=0},T=e=>{const l=B(e)
P.value=i(e),P.value&&(C.value=!0,P.value.contains(e.target)?_.value=Ms(e,P.value,a.direction):(_.value=0,null!=l&&n({value:l})),null!=l&&o({value:l}),t.nextTick((()=>P.value?.focus())))},D={passive:!0,capture:!0}
function E(e){const t=B(e)
null!=t&&n({value:t})}function F(e){e.stopPropagation(),e.preventDefault(),R(e),window.removeEventListener("mousemove",E,D),window.removeEventListener("mouseup",F)}function $(e){R(e),window.removeEventListener("touchmove",E,D),e.target?.removeEventListener("touchend",$)}const M=e=>{const t=(e-v.value)/(f.value-v.value)*100
...
l("update:color",{...e.color??Bs,...a})}catch(e){}}return t.onUnmounted((()=>o.abort())),$t((()=>t.createVNode("div",{class:["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class],style:e.style},[n&&t.createVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Eo,{onClick:r,icon:"$eyeDropper",variant:"plain",density:"comfortable"},null)]),t.createVNode("div",{class:"v-color-picker-preview__dot"},[t.createVNode("div",{style:{background:rt(e.color??Bs)}},null)]),t.createVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(Gs,{class:"v-color-picker-preview__track v-color-picker-preview__hue",modelValue:e.color?.h,"onUpdate:modelValue":t=>l("update:color",{...e.color??Bs,h:t}),step:0,min:0,max:360,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(Gs,{class:"v-color-picker-preview__track v-color-picker-preview__alpha",modelValue:e.color?.a??1,"onUpdate:modelValue":t=>l("update:color",{...e.color??Bs,a:t}),step:1/256,min:0,max:1,disabled:e.disabled,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])]))),{}}})
...
return t.onBeforeMount((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),Nt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),$t((()=>{const l=Js.filterProps(e)
return t.createVNode(Js,t.mergeProps({rounded:e.rounded,elevation:e.elevation,theme:e.theme,class:["v-color-picker",r.value,e.class],style:[{"--v-color-picker-color-hsv":rt({...n.value??Bs,a:1})},e.style]},l,{maxWidth:e.width}),{default:()=>[!e.hideCanvas&&t.createVNode(Ps,{key:"canvas",color:n.value,"onUpdate:color":s,disabled:e.disabled,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(qs,{key:"preview",color:n.value,"onUpdate:color":s,hideAlpha:!a.value.endsWith("a"),disabled:e.disabled},null),!e.hideInputs&&t.createVNode(Fs,{key:"edit",modes:e.modes,mode:a.value,"onUpdate:mode":e=>a.value=e,color:n.value,"onUpdate:color":s,disabled:e.disabled},null)]),e.showSwatches&&t.createVNode(Zs,{key:"swatches",color:n.value,"onUpdate:color":s,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled},null)]})})),{}}})
const tu=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...Fi({filterKeys:["title"]}),...Ri({hideNoData:!0,returnObject:!0}),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VCombobox"),au=It()({name:"VCombobox",props:tu(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
const{t:r}=ha(),i=t.ref(),s=t.shallowRef(!1),u=t.shallowRef(!0),d=t.shallowRef(!1),v=t.ref(),p=t.ref(),f=ia(e,"menu"),m=t.computed({get:()=>f.value,set:e=>{f.value&&!e&&v.value?.ΨopenChildren.size||(f.value=e)}}),g=t.shallowRef(-1)
let h=!1
const y=t.computed((()=>i.value?.color)),b=t.computed((()=>m.value?e.closeText:e.openText)),{items:V,transformIn:w,transformOut:S}=Vr(e),{textColorClasses:k,textColorStyles:x}=sl(y),N=ia(e,"modelValue",[],(e=>w(B(e))),(t=>{const a=S(t)
return e.multiple?a:a[0]??null})),C=un(e),_=t.computed((()=>!(!e.chips&&!n.chip))),P=t.computed((()=>_.value||!!n.selection)),A=t.shallowRef(e.multiple||P.value?"":N.value[0]?.title??""),R=t.computed({get:()=>A.value,set:t=>{if(A.value=t??"",e.multiple||P.value||(N.value=[yr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&K(yr(e,t))})),A.value="")}t||(g.value=-1),u.value=!t}}),T=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(N.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?N.value.length:R.value.length))
t.watch(A,(e=>{h?t.nextTick((()=>h=!1)):s.value&&!m.value&&(m.value=!0),o("update:search",e)})),t.watch(N,(t=>{e.multiple||P.value||(A.value=t[0]?.title??"")}))
const{filteredItems:D,getMatches:E}=$i(e,V,(()=>u.value?"":R.value)),F=t.computed((()=>e.hideSelected?D.value.filter((e=>!N.value.some((t=>t.value===e.value)))):D.value)),$=t.computed((()=>N.value.map((e=>e.value)))),M=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&R.value===F.value[0]?.title)&&F.value.length>0&&!u.value&&!d.value)),O=t.computed((()=>e.hideNoData&&!F.value.length||C.isReadonly.value||C.isDisabled.value)),L=t.ref(),z=Ai(L,i)
function j(t){h=!0,e.openOnClear&&(m.value=!0)}function H(){O.value||(m.value=!0)}function W(e){O.value||(s.value&&(e.preventDefault(),e.stopPropagation()),m.value=!m.value)}function U(e){" "!==e.key&&le(e)&&i.value?.focus()}function Y(t){if(function(e){return e.isComposing&&I.includes(e.key)}(t)||C.isReadonly.value)return
...
return t===F.value[0].value}))&&K(D.value[0]),u.value=!0),"ArrowDown"===t.key&&M.value&&L.value?.focus("next"),"Enter"===t.key&&R.value&&(K(yr(e,R.value)),P.value&&(A.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&P.value&&N.value.length>0&&!R.value)return K(N.value[0],!1)
...
const e=g.value+1
N.value[e]?g.value=e:(g.value=-1,i.value.setSelectionRange(0,0))}else~g.value&&le(t)&&(g.value=-1)}function G(){e.eager&&p.value?.calculateVisibleItems()}function q(){s.value&&(u.value=!0,i.value?.focus())}function K(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
N.value=e?[a]:[],A.value=e&&!P.value?a.title:"",t.nextTick((()=>{m.value=!1,u.value=!0}))}}function X(e){s.value=!0,setTimeout((()=>{d.value=!0}))}function Z(e){d.value=!1}function Q(t){null!=t&&(""!==t||e.multiple||P.value)||(N.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(g.value=-1,m.value=!1,R.value)){if(e.multiple)return void K(yr(e,R.value))
if(!P.value)return
N.value.some((e=>{let{title:t}=e
return t===R.value}))?A.value="":K(yr(e,R.value))}})),t.watch(m,(()=>{if(!e.hideSelected&&m.value&&N.value.length){const t=F.value.findIndex((t=>N.value.some((a=>(e.valueComparator||c)(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&p.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{m.value||s.value&&!t.length&&e.length&&(m.value=!0)})),$t((()=>{const a=!!(!e.hideNoData||F.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=N.value.length>0,o=xi.filterProps(e)
return t.createVNode(xi,t.mergeProps({ref:i},o,{modelValue:R.value,"onUpdate:modelValue":[e=>R.value=e,Q],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:N.externalValue,counterValue:T.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":m.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!P.value,"v-combobox--selecting-index":g.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:C.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":j,"onMousedown:control":H,onKeydown:Y}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:v,modelValue:m.value,"onUpdate:modelValue":e=>m.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:O.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:G,onAfterLeave:q},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:L,selected:$.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:U,onFocusin:X,onFocusout:Z,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},z,e.listProps),{default:()=>[n["prepend-item"]?.(),!F.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(Bi,{ref:p,renderless:!0,items:F.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
return $t((()=>t.createVNode(t.Fragment,null,[o.default?.({model:r,save:u,cancel:d,isPristine:s.value,get actions(){return p=!0,v}}),!p&&v()]))),{save:u,cancel:d,isPristine:s}}}),Vu=gt({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),wu=Symbol.for("vuetify:datatable:expanded")
...
n.push({depth:a,id:s,key:i,value:o,items:r.length?Pu(e,r,a+1,s):e,type:"group"})})),n}function Bu(e,t){const a=[]
for(const l of e)"type"in l&&"group"===l.type?(null!=l.value&&a.push(l),(t.has(l.id)||null==l.value)&&a.push(...Bu(l.items,t))):a.push(l)
return a}function Au(e,a,l){return{flatItems:t.computed((()=>{if(!a.value.length)return e.value
return Bu(Pu(e.value,a.value.map((e=>e.key))),l.value)}))}}function Ru(e){let{page:a,itemsPerPage:l,sortBy:o,groupBy:n,search:r}=e
...
return t.watch(i,(e=>{a.emit("update:currentItems",e)}),{immediate:!0}),{paginatedItems:i}}const Mu={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
...
const n=ia(e,"modelValue",e.modelValue,(t=>new Set(B(t).map((t=>l.value.find((a=>e.valueComparator(t,a.value)))?.value??t)))),(e=>[...e.values()])),r=t.computed((()=>l.value.filter((e=>e.selectable)))),i=t.computed((()=>o.value.filter((e=>e.selectable)))),s=t.computed((()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
switch(e.selectStrategy){case"single":return Mu
case"all":return Lu
default:return Ou}}))
function u(e){return B(e).every((e=>n.value.has(e.value)))}function c(e,t){const a=s.value.select({items:e,value:t,selected:new Set(n.value)})
...
n.value=t},isSelected:u,isSomeSelected:function(e){return B(e).some((e=>n.value.has(e.value)))},someSelected:d,allSelected:v,showSelectAll:t.computed((()=>s.value.showSelectAll))}
...
return a}(e,e.items)))
return{items:a}}const ec=gt({search:String,loading:Boolean,...ht(),...Zu(),...zu(),...Uu(),...Tu({itemsPerPage:5}),...Vu(),...xu(),...Fi(),...Pa(),...vl({transition:{component:Ha,hideOnLeave:!0}})},"VDataIterator"),tc=It()({name:"VDataIterator",props:ec(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"groupBy"),n=t.toRef(e,"search"),{items:r}=Ju(e),{filteredItems:i}=$i(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=Gu(e),{page:d,itemsPerPage:v}=Eu(e),{toggleSort:p}=qu({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:f,opened:m,extractRows:g,isGroupOpen:h,toggleGroup:y}=_u({groupBy:o,sortBy:s}),{sortedItems:b}=Xu(e,i,f,{transform:e=>e.raw}),{flatItems:V}=Au(b,o,m),w=t.computed((()=>V.value.length)),{startIndex:S,stopIndex:k,pageCount:x,prevPage:N,nextPage:C,setItemsPerPage:_,setPage:I}=Fu({page:d,itemsPerPage:v,itemsLength:w}),{paginatedItems:P}=$u({items:V,startIndex:S,stopIndex:k,itemsPerPage:v}),B=t.computed((()=>g(P.value))),{isSelected:A,select:R,selectAll:T,toggleSelect:D}=Hu(e,{allItems:r,currentPage:B}),{isExpanded:E,toggleExpand:F}=Su(e)
...
return e}const wc=gt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Mt,default:"$sortAsc"},sortDescIcon:{type:Mt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...kn(),...no()},"VDataTableHeaders"),Sc=It()({name:"VDataTableHeaders",props:wc(),setup(e,a){let{slots:l}=a
...
return t.createVNode(t.Fragment,{key:g.props.key},[o.item?o.item(g):t.createVNode(Cc,g.props,o),s(a)&&o["expanded-row"]?.(m)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),Pc=gt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...ht(),...Bl(),...Pa(),...wa()},"VTable"),Bc=It()({name:"VTable",props:Pc(),setup(e,a){let{slots:l,emit:o}=a
...
return{type:"item",key:e.returnObject?v(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function Tc(e,a){return{items:t.computed((()=>Rc(e,e.items,a.value)))}}const Dc=gt({..._c(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...Vu(),...xu(),...uc(),...Ac(),...zu(),...Uu(),...wc(),...Pc()},"DataTable"),Ec=gt({...Tu(),...Dc(),...Fi(),...oc()},"VDataTable"),Fc=It()({name:"VDataTable",props:Ec(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Cu(e),{sortBy:r,multiSort:i,mustSort:s}=Gu(e),{page:u,itemsPerPage:c}=Eu(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:f,sortRawFunctions:m,filterFunctions:g}=bc(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:h}=Tc(e,v),y=t.toRef(e,"search"),{filteredItems:b}=$i(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=qu({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:x,toggleGroup:N}=_u({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:C}=Xu(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:f,sortRawFunctions:m}),{flatItems:_}=Au(C,n,S),I=t.computed((()=>_.value.length)),{startIndex:P,stopIndex:B,pageCount:A,setItemsPerPage:R}=Fu({page:u,itemsPerPage:c,itemsLength:I}),{paginatedItems:T}=$u({items:_,startIndex:P,stopIndex:B,itemsPerPage:c}),D=t.computed((()=>k(T.value))),{isSelected:E,select:F,selectAll:$,toggleSelect:M,someSelected:O,allSelected:L}=Hu(e,{allItems:h,currentPage:D}),{isExpanded:z,toggleExpand:j}=Su(e)
...
$t((()=>{const a=Sc.filterProps(e),n=Ic.filterProps(e),r=Bc.filterProps(e)
return t.createVNode(Bc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(U.value),wrapper:()=>t.createVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[o.colgroup?.(U.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(Sc,a,o)]),!e.hideDefaultBody&&t.createVNode("tbody",null,[t.createVNode("tr",{ref:$,style:{height:f(M.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(U.value),t.createVNode(Ic,t.mergeProps(l,n,{items:W.value}),{...o,item:e=>t.createVNode(Ci,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>z(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
...
$t((()=>{const a=nc.filterProps(e),n=Sc.filterProps(e),r=Ic.filterProps(e),i=Bc.filterProps(e)
return t.createVNode(Bc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(T.value),default:()=>o.default?o.default(T.value):t.createVNode(t.Fragment,null,[o.colgroup?.(T.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Sc,n,o)]),o.thead?.(T.value),!e.hideDefaultBody&&t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(T.value),o.body?o.body(T.value):t.createVNode(Ic,t.mergeProps(l,r,{items:k.value}),o),o["body.append"]?.(T.value)]),o.tbody?.(T.value),o.tfoot?.(T.value)]),bottom:()=>o.bottom?o.bottom(T.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(fr,null,null),t.createVNode(nc,a,{prepend:o["footer.prepend"]})])})}))}}),zc=gt({fluid:{type:Boolean,default:!1},...ht(),...ll(),...Pa()},"VContainer"),jc=It()({name:"VContainer",props:zc(),setup(e,a){let{slots:l}=a
...
function Vd(e){const a=hu(),l=ia(e,"modelValue",[],(e=>B(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=ia(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
const l=a.date(t)
return!(!e.min||!a.isAfter(a.date(e.min),l))||(!(!e.max||!a.isAfter(l,a.date(e.max)))||(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?!e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"==typeof e.allowedDates&&!e.allowedDates(l)))}return{displayValue:o,daysInMonth:v,daysInWeek:d,genDays:c,model:l,weeksInMonth:u,weekDays:s,weekNumbers:p}}const wd=gt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},...x(bd(),["displayValue"])},"VDatePickerMonth"),Sd=It()({name:"VDatePickerMonth",props:wd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return o.year?.({year:a,i:n,props:i})??t.createVNode(Eo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),_d=Pt("v-picker-title"),Id=gt({bgColor:String,landscape:Boolean,title:String,hideHeader:Boolean,...Qs()},"VPicker"),Pd=It()({name:"VPicker",props:Id(),setup(e,a){let{slots:l}=a
...
return t.createVNode(Js,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(_d,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(al,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}}),Bd=gt({header:{type:String,default:"$vuetify.datePicker.header"},...md(),...wd({weeksInMonth:"static"}),...x(kd(),["modelValue"]),...x(Nd(),["modelValue"]),...Id({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Ad=It()({name:"VDatePicker",props:Bd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=hu(),{t:r}=ha(),i=ia(e,"modelValue",void 0,(e=>B(e)),(t=>e.multiple?t:t[0])),s=ia(e,"viewMode"),u=t.computed((()=>{const e=n.date(i.value?.[0])
...
return t.createVNode(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":o.isSelected.value,"v-expansion-panel--before-active":d.value,"v-expansion-panel--after-active":v.value,"v-expansion-panel--disabled":u.value},s.value,n.value,e.class],style:[r.value,e.style]},{default:()=>[t.createVNode("div",{class:["v-expansion-panel__shadow",...i.value]},null),t.createVNode(al,{defaults:{VExpansionPanelTitle:{...p},VExpansionPanelText:{...f}}},{default:()=>[c&&t.createVNode(Md,{key:"title"},{default:()=>[l.title?l.title():e.title]}),a&&t.createVNode(Fd,{key:"text"},{default:()=>[l.text?l.text():e.text]}),l.default?.()]})]})})),{groupItem:o}}}),zd=["default","accordion","inset","popout"],jd=gt({flat:Boolean,...Ml(),...S(Od(),["bgColor","collapseIcon","color","eager","elevation","expandIcon","focusable","hideActions","readonly","ripple","rounded","tile","static"]),...wa(),...ht(),...Pa(),variant:{type:String,default:"default",validator:e=>zd.includes(e)}},"VExpansionPanels"),Hd=It()({name:"VExpansionPanels",props:jd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{next:o,prev:n}=zl(e,Dd),{themeClasses:r}=ka(e),i=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return Nt({VExpansionPanel:{bgColor:t.toRef(e,"bgColor"),collapseIcon:t.toRef(e,"collapseIcon"),color:t.toRef(e,"color"),eager:t.toRef(e,"eager"),elevation:t.toRef(e,"elevation"),expandIcon:t.toRef(e,"expandIcon"),focusable:t.toRef(e,"focusable"),hideActions:t.toRef(e,"hideActions"),readonly:t.toRef(e,"readonly"),ripple:t.toRef(e,"ripple"),rounded:t.toRef(e,"rounded"),static:t.toRef(e,"static")}}),$t((()=>t.createVNode(e.tag,{class:["v-expansion-panels",{"v-expansion-panels--flat":e.flat,"v-expansion-panels--tile":e.tile},r.value,i.value,e.class],style:e.style},{default:()=>[l.default?.({prev:n,next:o})]}))),{next:o,prev:n}}}),Wd=gt({app:Boolean,appear:Boolean,extended:Boolean,layout:Boolean,offset:Boolean,modelValue:{type:Boolean,default:!0},...x(Do({active:!0}),["location"]),...aa(),...to(),...vl({transition:"fab-transition"})},"VFab"),Ud=It()({name:"VFab",props:Wd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
function w(){y.value!==document.activeElement&&y.value?.focus(),s.value||u()}function S(e){y.value?.click()}function k(e){o("mousedown:control",e)}function x(e){y.value?.click(),o("click:control",e)}function N(a){a.stopPropagation(),w(),t.nextTick((()=>{i.value=[],q(e["onClick:clear"],a)}))}return t.watch(i,(e=>{(!Array.isArray(e)||!e.length)&&y.value&&(y.value.value="")})),$t((()=>{const a=!(!n.counter&&!e.counter),o=!(!a&&!n.details),[r,u]=P(l),{modelValue:d,...C}=pn.filterProps(e),_=wi(e)
return t.createVNode(pn,t.mergeProps({ref:g,modelValue:e.multiple?i.value:i.value[0],class:["v-file-input",{"v-file-input--chips":!!e.chips,"v-file-input--hide":e.hideInput,"v-input--plain-underlined":V.value},e.class],style:e.style,"onClick:prepend":S},r,C,{centerAffix:!V.value,focused:s.value}),{...n,default:a=>{let{id:l,isDisabled:o,isDirty:r,isReadonly:d,isValid:m}=a
...
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),ev=gt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...ll(),...Pa()},"VInfiniteScroll"),tv=_t({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=Zl()
return t.watch(n,(async t=>{l("intersect",e.side,t)})),$t((()=>t.createVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:o},[t.createTextVNode(" ")]))),{}}}),av=It()({name:"VInfiniteScroll",props:ev(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),o&&c&&t.createVNode(tv,{key:"start",side:"start",onIntersect:m,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(tv,{key:"end",side:"end",onIntersect:m,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),lv=Symbol.for("vuetify:v-item-group"),ov=gt({...ht(),...Ml({selectedClass:"v-item--selected"}),...Pa(),...wa()},"VItemGroup"),nv=It()({name:"VItemGroup",props:ov(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),iv=Pt("v-kbd","kbd"),sv=gt({...ht(),...ll(),...ta()},"VLayout"),uv=It()({name:"VLayout",props:sv(),setup(e,a){let{slots:l}=a
...
return $t((()=>t.createVNode("div",{class:["v-locale-provider",o.value,e.class],style:e.style},[l.default?.()]))),{}}}),gv=gt({scrollable:Boolean,...ht(),...ll(),...Pa({tag:"main"})},"VMain"),hv=It()({name:"VMain",props:gv(),setup(e,a){let{slots:l}=a
...
return P.value?t*B.value:t})),{layoutItemStyles:R,layoutItemScrimStyles:T}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:N,layoutSize:A,elementSize:x,active:t.computed((()=>h.value||P.value)),disableTransitions:t.computed((()=>P.value)),absolute:t.computed((()=>e.absolute||I.value&&"string"!=typeof D.value))}),{isStuck:D,stickyStyles:E}=function(e){let{rootEl:a,isSticky:l,layoutItemStyles:o}=e
...
const Bv=gt({scale:{type:[Number,String],default:.5},...ht()},"VParallax"),Av=It()({name:"VParallax",props:Bv(),setup(e,a){let{slots:l}=a
...
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color")),{dimensionStyles:r}=ol(e),{elevationClasses:i}=wl(e),{themeClasses:s}=ka(e),{t:u}=ha(),c=t.computed((()=>Hv(B(e.type).join(","))))
...
const qv=gt({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...to({location:"bottom"}),...uo(),...cl(),...Dl(),...wa(),...x(ii({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),Kv=It()({name:"VSnackbar",props:qv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode(al,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(Eo,a,null)]}),t.createVNode(al,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(Eo,l,null)]})])})),{}}}),vp=Pt("v-stepper-header"),pp=gt({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Mt,default:"$complete"},editable:Boolean,editIcon:{type:Mt,default:"$edit"},error:Boolean,errorIcon:{type:Mt,default:"$error"},icon:Mt,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),fp=gt({...pp(),...Ol()},"VStepperItem"),mp=It()({name:"VStepperItem",directives:{Ripple:To},props:fp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&Tl(!0,"v-stepper-item"),t.createVNode(Wo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Xl,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),gp=gt({...x(Vs(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),hp=It()({name:"VStepperWindow",props:gp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(Eo,t.mergeProps({symbol:_p,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),di({},i)}}),Bp=gt({...x(Vs(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Ap=It()({name:"VTabsWindow",props:Bp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
const Dp=gt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...En({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Bl(),...Pa()},"VTabs"),Ep=It()({name:"VTabs",props:Dp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
const of=function(e,a){const l=function(e,a){return function(l,o,n){const r="function"==typeof a?a(o):a,i=o.value?.text??o.value??r?.text,s=m(o.value)?o.value:{},u=()=>i??l.textContent,c=(n.ctx===o.instance.$?function(e,t){const a=new Set,l=t=>{for(const o of t){if(!o)continue
...
return{mounted:l,updated:l,unmounted(e){t.render(null,e)}}}(Kp,(e=>({activator:"parent",location:e.arg?.replace("-"," "),text:"boolean"==typeof e.value?void 0:e.value})))
...
if(a&&e in a)return a[e]}rf.version="3.7.13"
const uf=function(){return rf({components:Zp,directives:nf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},cf="3.7.13"
