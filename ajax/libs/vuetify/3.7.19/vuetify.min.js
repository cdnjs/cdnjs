...
return t.createVNode(nc,t.mergeProps({align:a.align,class:{"v-data-table__td--expanded-row":"data-table-expand"===a.key,"v-data-table__td--select-row":"data-table-select"===a.key},fixed:a.fixed,fixedOffset:a.fixedOffset,lastFixed:a.lastFixed,maxWidth:n.value?void 0:a.maxWidth,noPadding:"data-table-select"===a.key||"data-table-expand"===a.key,nowrap:a.nowrap,width:n.value?void 0:a.width},S,k),{default:()=>{if("data-table-select"===a.key)return l["item.data-table-select"]?.({...V,props:{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((()=>i(h)),["stop"])}})??t.createVNode(en,{disabled:!h.selectable,modelValue:r([h]),onClick:t.withModifiers((()=>i(h)),["stop"])},null)
...
function bd(e){const a=gu(),l=ia(e,"modelValue",[],(e=>P(e).map((e=>a.date(e))))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=ia(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
const n=gu(),{t:r}=ha(),i=ia(e,"modelValue",void 0,(e=>P(e).map((e=>n.date(e)))),(t=>e.multiple?t:t[0])),s=ia(e,"viewMode"),u=t.computed((()=>{const t=n.date(e.min)
...
if(a&&e in a)return a[e]}nf.version="3.7.19"
const sf=function(){return nf({components:Xp,directives:of,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},uf="3.7.19"
