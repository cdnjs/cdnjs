...
return t.createVNode(tn,t.mergeProps({class:["v-checkbox",e.class]},a,d,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,id:c.value,focused:r.value,style:e.style}),{...o,default:e=>{let{id:a,messagesId:l,isDisabled:r,isReadonly:c,isValid:d}=e
return t.createVNode(Ho,t.mergeProps(v,{id:a.value,"aria-describedby":l.value,disabled:r.value,readonly:c.value},u,{error:!1===d.value,modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,onFocus:i,onBlur:s}),o)}})})),{}}}),on=["sm","md","lg","xl","xxl"],nn=Symbol.for("vuetify:display"),rn={mobileBreakpoint:"lg",thresholds:{xs:0,sm:600,md:960,lg:1280,xl:1920,xxl:2560}}
...
f.value=e?[a]:[],t.nextTick((()=>{c.value=!1}))}}function R(e){N.value?.$el.contains(e.relatedTarget)||(c.value=!1)}function E(){y.value&&r.value?.focus()}function D(e){y.value=!0}function F(e){if(null==e)f.value=[]
...
o&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),(e=>{y.value&&e.length&&!c.value&&(c.value=!0)})),At((()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||S.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=f.value.length>0,d=li.filterProps(e),v=u||!y.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
...
const i=t.mergeProps(o.props,{ref:r,key:n,onClick:()=>A(o,null)})
...
return e.multiple?a:a[0]??null})),x=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(k.value):"number"==typeof e.counterValue?e.counterValue:k.value.length)),N=Zo(),{filteredItems:C,getMatches:_}=gi(e,h,(()=>s.value?"":S.value)),I=t.computed((()=>e.hideSelected?C.value.filter((e=>!k.value.some((t=>t.value===e.value)))):C.value)),P=t.computed((()=>!(!e.chips&&!l.chip))),B=t.computed((()=>P.value||!!l.selection)),A=t.computed((()=>k.value.map((e=>e.props.value)))),R=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&S.value===I.value[0]?.title)&&I.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!I.value.length||e.readonly||N?.isReadonly.value)),D=t.ref(),{onListScroll:F,onListKeydown:$}=ci(D,r)
function M(t){e.openOnClear&&(p.value=!0),S.value=""}function L(){E.value||(p.value=!0)}function O(e){E.value||(i.value&&(e.preventDefault(),e.stopPropagation()),p.value=!p.value)}function z(t){if(e.readonly||N?.isReadonly.value)return
const a=r.value.selectionStart,l=k.value.length
if((f.value>-1||["Enter","ArrowDown","ArrowUp"].includes(t.key))&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(p.value=!0),["Escape"].includes(t.key)&&(p.value=!1),R.value&&["Enter","Tab"].includes(t.key)&&q(I.value[0]),"ArrowDown"===t.key&&R.value&&D.value?.focus("next"),e.multiple){if(["Backspace","Delete"].includes(t.key)){if(f.value<0)return void("Backspace"!==t.key||S.value||(f.value=l-1))
const e=f.value,a=k.value[f.value]
a&&!a.props.disabled&&q(a,!1),f.value=e>=l-1?l-2:e}if("ArrowLeft"===t.key){if(f.value<0&&a>0)return
...
const e=f.value+1
k.value[e]?f.value=e:(f.value=-1,r.value.setSelectionRange(0,0))}}}function j(e){if(le(r.value,":autofill")||le(r.value,":-webkit-autofill")){const t=h.value.find((t=>t.title===e.target.value))
...
if(!a.props.disabled)if(e.multiple){const t=k.value.findIndex((t=>e.valueComparator(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...k.value,a]:[...k.value]
e.splice(t,1),k.value=e}else o&&(k.value=[...k.value,a])
e.clearOnSelect&&(S.value="")}else{const e=!1!==l
k.value=e?[a]:[],S.value=e&&!B.value?a.title:"",t.nextTick((()=>{p.value=!1,s.value=!0}))}}return t.watch(i,((a,l)=>{a!==l&&(a?(Y.value=!0,S.value=e.multiple||B.value?"":String(k.value.at(-1)?.props.title??""),s.value=!0,t.nextTick((()=>Y.value=!1))):(e.multiple||null!=S.value?!R.value||u.value||k.value.some((e=>{let{value:t}=e
...
o&&window.requestAnimationFrame((()=>{e>=0&&d.value?.scrollToIndex(e)}))}})),t.watch((()=>e.items),(e=>{i.value&&e.length&&!p.value&&(p.value=!0)})),At((()=>{const a=!!(!e.hideNoData||I.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),o=k.value.length>0,u=li.filterProps(e)
return t.createVNode(li,t.mergeProps({ref:r},u,{modelValue:S.value,"onUpdate:modelValue":[e=>S.value=e,G],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:x.value,dirty:o,onChange:j,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!B.value,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:e.readonly,placeholder:o?void 0:e.placeholder,"onClick:clear":M,"onMousedown:control":L,onKeydown:z}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Gr,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:E.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:H},e.menuProps),{default:()=>[a&&t.createVNode(lr,t.mergeProps({ref:D,selected:A.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:$,onFocusin:W,onFocusout:U,onScrollPassive:F,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},e.listProps),{default:()=>[l["prepend-item"]?.(),!I.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Hn,{title:n(e.noDataText)},null)),t.createVNode(ui,{ref:d,renderless:!0,items:I.value},{default:a=>{let{item:o,index:n,itemRef:r}=a
const i=t.mergeProps(o.props,{ref:r,key:n,active:!(!R.value||0!==n)||void 0,onClick:()=>q(o,null)})
return l.item?.({item:o,index:n,props:i})??t.createVNode(Hn,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:l}=a
...
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-autocomplete__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(a+l)])]):e}(o.title,_(o)?.title,S.value?.length??0)})}}),l["append-item"]?.()]})]}),k.value.map(((a,o)=>{const n={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),q(a,!1)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},r=P.value?!!l.chip:!!l.selection,i=r?oe(P.value?l.chip({item:a,index:o,props:n}):l.selection({item:a,index:o})):void 0
if(!r||i)return t.createVNode("div",{key:a.value,class:["v-autocomplete__selection",o===f.value&&["v-autocomplete__selection--selected",V.value]],style:o===f.value?w.value:{}},[P.value?l.chip?t.createVNode(Fa,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[i]}):t.createVNode(kn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},n),null):i??t.createVNode("span",{class:"v-autocomplete__selection-text"},[a.title,e.multiple&&o<k.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,o=new Array(a),r=0;r<a;r++)o[r]=arguments[r]
return t.createVNode(t.Fragment,null,[l["append-inner"]?.(...o),e.menuIcon?t.createVNode(Ol,{class:"v-autocomplete__menu-icon",icon:e.menuIcon,onMousedown:O,onClick:ae,"aria-label":n(g.value),title:n(g.value)},null):void 0])}})})),Wr({isFocused:i,isPristine:s,menu:p,search:S,filteredItems:C,select:q},r)}}),bi=a({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Il,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...l(),...Ul({location:"top end"}),...Wa(),...ua(),...ta(),...Ga({transition:"scale-rotate-transition"})},"VBadge"),Vi=gt()({name:"VBadge",inheritAttrs:!1,props:bi(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=Ha(t.toRef(e,"color")),{roundedClasses:n}=Ua(e),{t:r}=Zt(),{textColorClasses:i,textColorStyles:s}=ja(t.toRef(e,"textColor")),{themeClasses:u}=oa(),{locationStyles:c}=Gl(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return e.multiple?a:a[0]??null})),N=Zo(),C=t.computed((()=>!(!e.chips&&!n.chip))),_=t.computed((()=>C.value||!!n.selection)),I=t.shallowRef(e.multiple||_.value?"":x.value[0]?.title??""),P=t.computed({get:()=>I.value,set:t=>{if(I.value=t??"",e.multiple||_.value||(x.value=[Zn(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&Y(Zn(e,t))})),I.value="")}t||(m.value=-1),u.value=!t}}),B=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:P.value.length))
t.watch(I,(e=>{g?t.nextTick((()=>g=!1)):s.value&&!f.value&&(f.value=!0),l("update:search",e)})),t.watch(x,(t=>{e.multiple||_.value||(I.value=t[0]?.title??"")}))
const{filteredItems:R,getMatches:E}=gi(e,b,(()=>u.value?"":P.value)),D=t.computed((()=>e.hideSelected?R.value.filter((e=>!x.value.some((t=>t.value===e.value)))):R.value)),F=t.computed((()=>x.value.map((e=>e.value)))),$=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&P.value===D.value[0]?.title)&&D.value.length>0&&!u.value&&!c.value)),M=t.computed((()=>e.hideNoData&&!D.value.length||e.readonly||N?.isReadonly.value)),L=t.ref(),{onListScroll:O,onListKeydown:z}=ci(L,i)
function j(t){g=!0,e.openOnClear&&(f.value=!0)}function H(){M.value||(f.value=!0)}function W(e){M.value||(s.value&&(e.preventDefault(),e.stopPropagation()),f.value=!f.value)}function U(t){if(function(e){return e.isComposing&&A.includes(e.key)}(t)||e.readonly||N?.isReadonly.value)return
const a=i.value.selectionStart,l=x.value.length
if((m.value>-1||["Enter","ArrowDown","ArrowUp"].includes(t.key))&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(f.value=!0),["Escape"].includes(t.key)&&(f.value=!1),["Enter","Escape","Tab"].includes(t.key)&&($.value&&["Enter","Tab"].includes(t.key)&&Y(R.value[0]),u.value=!0),"ArrowDown"===t.key&&$.value&&L.value?.focus("next"),"Enter"===t.key&&P.value&&(Y(Zn(e,P.value)),_.value&&(P.value="")),e.multiple){if(["Backspace","Delete"].includes(t.key)){if(m.value<0)return void("Backspace"!==t.key||P.value||(m.value=l-1))
const e=m.value,a=x.value[m.value]
a&&!a.props.disabled&&Y(a,!1),m.value=e>=l-1?l-2:e}if("ArrowLeft"===t.key){if(m.value<0&&a>0)return
...
if(!a.props.disabled)if(e.multiple){const t=x.value.findIndex((t=>e.valueComparator(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...x.value,a]:[...x.value]
e.splice(t,1),x.value=e}else o&&(x.value=[...x.value,a])
e.clearOnSelect&&(P.value="")}else{const e=!1!==l
x.value=e?[a]:[],I.value=e&&!_.value?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function q(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function K(e){c.value=!1}function X(t){(null==t||""===t&&!e.multiple)&&(x.value=[])}return t.watch(s,((t,a)=>{t||t===a||(m.value=-1,f.value=!1,!$.value||c.value||x.value.some((e=>{let{value:t}=e
return t===D.value[0].value}))?P.value&&Y(Zn(e,P.value)):Y(D.value[0]))})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=D.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
o&&window.requestAnimationFrame((()=>{t>=0&&v.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),(e=>{s.value&&e.length&&!f.value&&(f.value=!0)})),At((()=>{const a=!!(!e.hideNoData||D.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=x.value.length>0,o=li.filterProps(e)
return t.createVNode(li,t.mergeProps({ref:i},o,{modelValue:P.value,"onUpdate:modelValue":[e=>P.value=e,X],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:B.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!_.value,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:e.readonly,placeholder:l?void 0:e.placeholder,"onClick:clear":j,"onMousedown:control":H,onKeydown:U}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(Gr,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:M.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:G},e.menuProps),{default:()=>[a&&t.createVNode(lr,t.mergeProps({ref:L,selected:F.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:z,onFocusin:q,onFocusout:K,onScrollPassive:O,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},e.listProps),{default:()=>[n["prepend-item"]?.(),!D.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(Hn,{title:r(e.noDataText)},null)),t.createVNode(ui,{ref:v,renderless:!0,items:D.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(l.title,E(l)?.title,P.value?.length??0)})}}),n["append-item"]?.()]})]}),x.value.map(((a,l)=>{const o={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),Y(a,!1)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},r=C.value?!!n.chip:!!n.selection,i=r?oe(C.value?n.chip({item:a,index:l,props:o}):n.selection({item:a,index:l})):void 0
if(!r||i)return t.createVNode("div",{key:a.value,class:["v-combobox__selection",l===m.value&&["v-combobox__selection--selected",S.value]],style:l===m.value?k.value:{}},[C.value?n.chip?t.createVNode(Fa,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[i]}):t.createVNode(kn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},o),null):i??t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<x.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Ol,{class:"v-combobox__menu-icon",icon:e.menuIcon,onMousedown:W,onClick:ae,"aria-label":r(y.value),title:r(y.value)},null)])}})})),Wr({isFocused:s,isPristine:u,menu:f,search:P,selectionIndex:m,filteredItems:R,select:Y},i)}}),Es=a({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Ds=Symbol.for("vuetify:datatable:expanded")
...
if(a&&e in a)return a[e]}mp.version="3.5.7"
const hp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return mp({components:ip,directives:fp,...e})},yp="3.5.7"
