...
a&&o.value?"ArrowDown"===t.key?(t.preventDefault(),Z(a,"next")):"ArrowUp"===t.key&&(t.preventDefault(),Z(a,"prev")):["ArrowDown","ArrowUp"].includes(t.key)&&(o.value=!0,t.preventDefault(),setTimeout((()=>setTimeout((()=>f(t))))))}t.provide(Mr,{register(){++c.value},unregister(){--c.value},closeParents(e){setTimeout((()=>{c.value||null!=e&&(!e||function(e,t){const a=e.clientX,l=e.clientY,o=t.getBoundingClientRect(),n=o.left,r=o.top,i=o.right,s=o.bottom
...
const n=aa(e,"indeterminate"),r=aa(e,"modelValue"),{loaderClasses:i}=to(e),{isFocused:s,focus:u,blur:c}=Jo(e),d=t.ref(),v=t.computed((()=>"string"==typeof e.loading&&""!==e.loading?e.loading:e.color)),p=Ct(),f=t.computed((()=>e.id||`switch-${p}`))
function m(){n.value&&(n.value=!1)}function g(e){e.stopPropagation(),e.preventDefault(),d.value?.input?.click()}return Rt((()=>{const[a,p]=B(l),h=rn.filterProps(e),y=Yo.filterProps(e)
...
if(a&&e in a)return a[e]}af.version="3.6.5"
const of=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return af({components:Gp,directives:tf,...e})},nf="3.6.5"
