...
return a}function $e(){var e
let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"composables"
return I(null==(e=Ie(t).type)?void 0:e.name)}let Ae=0,Ee=new WeakMap
...
const b=t.computed((()=>({"v-img__img--cover":e.cover,"v-img__img--contain":!e.cover}))),V=t.computed((()=>{var l
if(!d.value.src||"idle"===s.value)return
const a=t.h("img",{class:["v-img__img",b.value],src:d.value.src,srcset:d.value.srcset,alt:"",sizes:e.sizes,ref:i,onLoad:f,onError:m}),o=null==(l=n.sources)?void 0:l.call(n)
return t.createVNode(Qt,{transition:e.transition,appear:!0},{default:()=>[t.withDirectives(o?t.createVNode("picture",{class:"v-img__picture"},[o,a]):a,[[t.vShow,"loaded"===s.value]])]})})),S=t.computed((()=>t.createVNode(Qt,{transition:e.transition},{default:()=>[d.value.lazySrc&&"loaded"!==s.value&&t.createVNode("img",{class:["v-img__img","v-img__img--preload",b.value],src:d.value.lazySrc,alt:""},null)]}))),w=t.computed((()=>{if(n.placeholder)return t.createVNode(Qt,{transition:e.transition,appear:!0},{default:()=>[("loading"===s.value||"error"===s.value&&!n.error)&&t.createVNode("div",{class:"v-img__placeholder"},[n.placeholder()])]})})),k=t.computed((()=>{if(n.error)return t.createVNode(Qt,{transition:e.transition,appear:!0},{default:()=>["error"===s.value&&t.createVNode("div",{class:"v-img__error"},[n.error()])]})})),x=t.computed((()=>{if(e.gradient)return t.createVNode("div",{class:"v-img__gradient",style:{backgroundImage:`linear-gradient(${e.gradient})`}},null)})),C=t.ref(!1)
{const e=t.watch(v,(t=>{t&&(requestAnimationFrame((()=>{requestAnimationFrame((()=>{C.value=!0}))})),e())}))}return Ge((()=>t.withDirectives(t.createVNode(qt,{class:["v-img",{"v-img--booting":!C.value}],style:{width:g("auto"===e.width?u.value:e.width)},aspectRatio:v.value,"aria-label":e.alt,role:e.alt?"img":void 0},{additional:()=>[V.value,S.value,x.value,w.value,k.value],default:n.default}),[[t.resolveDirective("intersect"),{handler:p,options:e.options},null,{once:!0}]]))),{currentSrc:r,image:i,state:s,naturalWidth:u,naturalHeight:c}}}),tl=Xe({tag:{type:String,default:"div"}},"tag"),ll=Fe()({name:"VToolbarTitle",props:{text:String,...tl()},setup(e,l){let{slots:a}=l
return Ge((()=>{var l
...
function ml(e,l,a){let o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:e=>e,n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:e=>e
const r=Ie("useProxiedModel"),i=t.computed((()=>{var t,a
return e[l],!!(null!=r&&null!=(t=r.vnode.props)&&t.hasOwnProperty(l)||null!=r&&null!=(a=r.vnode.props)&&a.hasOwnProperty(I(l)))})),s=t.ref(o(e[l]))
return t.computed({get:()=>i.value?o(e[l]):s.value,set(t){(i.value?o(e[l]):s.value)!==t&&(s.value=t,null==r||r.emit(`update:${l}`,n(t)))}})}const gl=ze({name:"VAppBar",props:{modelValue:{type:Boolean,default:!0},location:{type:String,default:"top",validator:e=>["top","bottom"].includes(e)},...pl(),...Je(),height:{type:[Number,String],default:64}},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=t.ref(),n=ml(e,"modelValue"),r=t.computed((()=>{var e,t
...
return t.createVNode(fl,t.mergeProps({ref:o,class:["v-app-bar",{"v-app-bar--bottom":"bottom"===e.location}],style:{...i.value,height:void 0}},l),a)})),{}}}),hl=[null,"default","comfortable","compact"],yl=Xe({density:{type:String,default:"default",validator:e=>hl.includes(e)}},"density")
function bl(e){let l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
const a=t.computed((()=>`${l}--density-${e.density}`))
return{densityClasses:a}}const Vl=["elevated","flat","tonal","outlined","text","plain"]
function Sl(e,l){return t.createVNode(t.Fragment,null,[e&&t.createVNode("span",{key:"overlay",class:`${l}__overlay`},null),t.createVNode("span",{key:"underlay",class:`${l}__underlay`},null)])}const wl=Xe({color:String,variant:{type:String,default:"elevated",validator:e=>Vl.includes(e)}},"variant")
function kl(e){let l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
...
return{colorClasses:o,colorStyles:n,variantClasses:a}}const xl=ze({name:"VBtnGroup",props:{divided:Boolean,...al(),...yl(),...nl(),...il(),...tl(),...dt(),...wl()},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{densityClasses:n}=bl(e),{borderClasses:r}=ol(e),{elevationClasses:i}=rl(e),{roundedClasses:s}=sl(e)
Oe({VBtn:{height:"auto",color:t.toRef(e,"color"),density:t.toRef(e,"density"),flat:!0,variant:t.toRef(e,"variant")}}),Ge((()=>t.createVNode(e.tag,{class:["v-btn-group",{"v-btn-group--divided":e.divided},o.value,r.value,n.value,i.value,s.value]},a)))}}),Cl=Xe({modelValue:{type:null,default:void 0},multiple:Boolean,mandatory:[Boolean,String],max:Number,selectedClass:String,disabled:Boolean},"group"),Nl=Xe({value:null,disabled:Boolean,selectedClass:String},"group-item")
function _l(e,l){let a=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
...
return t.watch(u,(e=>{o.emit("group:selected",{value:e})})),{id:n,isSelected:u,toggle:()=>r.select(n,!u.value),select:e=>r.select(n,e),selectedClass:c,value:i,disabled:s,group:r}}function Bl(e,l){let a=!1
const o=t.reactive([]),n=ml(e,"modelValue",[],(e=>null==e?[]:Il(o,k(e))),(t=>{const l=function(e,t){const l=[]
...
n.value=l??!a?[t]:[]}},disabled:t.toRef(e,"disabled"),prev:()=>s(o.length-1),next:()=>s(1),isSelected:e=>n.value.includes(e),selectedClass:t.computed((()=>e.selectedClass)),items:t.computed((()=>o)),getItemIndex:e=>function(e,t){const l=Il(e,[t])
return l.length?e.findIndex((e=>e.id===l[0])):-1}(o,e)}
return t.provide(l,u),u}function Il(e,t){const l=[]
for(let a=0;a<e.length;a++){const o=e[a]
null!=o.value?null!=t.find((e=>v(e,o.value)))&&l.push(o.id):t.includes(a)&&l.push(o.id)}return l}const $l=Symbol.for("vuetify:v-btn-toggle"),Al=Fe()({name:"VBtnToggle",props:Cl({selectedClass:"v-btn--selected"}),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{isSelected:o,next:n,prev:r,select:i,selected:s}=Bl(e,$l)
return Ge((()=>{var e
return t.createVNode(xl,{class:"v-btn-toggle"},{default:()=>[null==(e=a.default)?void 0:e.call(a,{isSelected:o,next:n,prev:r,select:i,selected:s})]})})),{next:n,prev:r,select:i}}}),El={collapse:"mdi-chevron-up",complete:"mdi-check",cancel:"mdi-close-circle",close:"mdi-close",delete:"mdi-close-circle",clear:"mdi-close-circle",success:"mdi-check-circle",info:"mdi-information",warning:"mdi-alert-circle",error:"mdi-close-circle",prev:"mdi-chevron-left",next:"mdi-chevron-right",checkboxOn:"mdi-checkbox-marked",checkboxOff:"mdi-checkbox-blank-outline",checkboxIndeterminate:"mdi-minus-box",delimiter:"mdi-circle",sort:"mdi-arrow-up",expand:"mdi-chevron-down",menu:"mdi-menu",subgroup:"mdi-menu-down",dropdown:"mdi-menu-down",radioOn:"mdi-radiobox-marked",radioOff:"mdi-radiobox-blank",edit:"mdi-pencil",ratingEmpty:"mdi-star-outline",ratingFull:"mdi-star",ratingHalf:"mdi-star-half-full",loading:"mdi-cached",first:"mdi-page-first",last:"mdi-page-last",unfold:"mdi-unfold-more-horizontal",file:"mdi-paperclip",plus:"mdi-plus",minus:"mdi-minus"},Rl={component:e=>t.h(Fl,{...e,class:"mdi"})},Ll=[String,Function,Object],Tl=Symbol.for("vuetify:icons"),Pl=Xe({icon:{type:Ll,required:!0},tag:{type:String,required:!0}},"icon"),Ol=ze({name:"VComponentIcon",props:Pl(),setup:e=>()=>t.createVNode(e.tag,null,{default:()=>[t.createVNode(e.icon,null,null)]})}),Ml=ze({name:"VSvgIcon",inheritAttrs:!1,props:Pl(),setup(e,l){let{attrs:a}=l
return()=>t.createVNode(e.tag,t.mergeProps(a,{style:null}),{default:()=>[t.createVNode("svg",{class:"v-icon__svg",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",role:"img","aria-hidden":"true"},[t.createVNode("path",{d:e.icon},null)])]})}}),zl=ze({name:"VLigatureIcon",props:Pl(),setup:e=>()=>t.createVNode(e.tag,null,{default:()=>[e.icon]})}),Fl=ze({name:"VClassIcon",props:Pl(),setup:e=>()=>t.createVNode(e.tag,{class:e.icon},null)}),Dl={svg:{component:Ml},class:{component:Fl}}
function jl(e){return _({defaultSet:"mdi",sets:{...Dl,mdi:Rl},aliases:El},e)}const Hl=["x-small","small","default","large","x-large"],Wl=Xe({size:{type:[String,Number],default:"default"}},"size")
function Ul(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
return L((()=>{let l,a
return T(Hl,e.size)?l=`${t}--size-${e.size}`:e.size&&(a={width:g(e.size),height:g(e.size)}),{sizeClasses:l,sizeStyles:a}}))}const Yl=Xe({color:String,start:Boolean,end:Boolean,icon:Ll,...Wl(),...tl({tag:"i"}),...dt()},"v-icon"),Xl=ze({name:"VIcon",props:Yl(),setup(e,l){let a,{attrs:o,slots:n}=l
...
const{themeClasses:r}=ft(e),{iconData:i}=(e=>{const l=t.inject(Tl)
...
if("string"!=typeof o)return{component:Ol,icon:o}
const r=Object.keys(l.sets).find((e=>"string"==typeof o&&o.startsWith(`${e}:`))),i=r?o.slice(r.length+1):o
return{component:l.sets[r??l.defaultSet].component,icon:i}}))}})(a||e),{sizeClasses:s}=Ul(e),{textColorClasses:u,textColorStyles:c}=cl(t.toRef(e,"color"))
...
t.onBeforeUnmount((()=>{a.disconnect()})),t.watch(l,((e,t)=>{t&&(a.unobserve(t),o.value=!1),e&&a.observe(e)}),{flush:"post"})}return{intersectionRef:l,isIntersecting:o}}const ql=ze({name:"VProgressCircular",props:{bgColor:String,color:String,indeterminate:[Boolean,String],modelValue:{type:[Number,String],default:0},rotate:{type:[Number,String],default:0},width:{type:[Number,String],default:4},...Wl(),...tl({tag:"div"}),...dt()},setup(e,l){let{slots:a}=l
const o=2*Math.PI*20,n=t.ref(),{themeClasses:i}=ft(e),{sizeClasses:s,sizeStyles:u}=Ul(e),{textColorClasses:c,textColorStyles:d}=cl(t.toRef(e,"color")),{textColorClasses:v,textColorStyles:p}=cl(t.toRef(e,"bgColor")),{intersectionRef:f,isIntersecting:m}=Gl(),{resizeRef:h,contentRect:y}=r(),b=t.computed((()=>Math.max(0,Math.min(100,parseFloat(e.modelValue))))),V=t.computed((()=>Number(e.width))),S=t.computed((()=>u.value?Number(e.size):y.value?y.value.width:Math.max(V.value,32))),w=t.computed((()=>20/(1-V.value/S.value)*2)),k=t.computed((()=>V.value/S.value*w.value)),x=t.computed((()=>g((100-b.value)/100*o)))
return t.watchEffect((()=>{f.value=n.value,h.value=n.value})),Ge((()=>t.createVNode(e.tag,{ref:n,class:["v-progress-circular",{"v-progress-circular--indeterminate":!!e.indeterminate,"v-progress-circular--visible":m.value,"v-progress-circular--disable-shrink":"disable-shrink"===e.indeterminate},i.value,s.value,c.value],style:[u.value,d.value],role:"progressbar","aria-valuemin":"0","aria-valuemax":"100","aria-valuenow":e.indeterminate?void 0:b.value},{default:()=>[t.createVNode("svg",{style:{transform:`rotate(calc(-90deg + ${Number(e.rotate)}deg))`},xmlns:"http://www.w3.org/2000/svg",viewBox:`0 0 ${w.value} ${w.value}`},[t.createVNode("circle",{class:["v-progress-circular__underlay",v.value],style:p.value,fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":k.value,"stroke-dasharray":o,"stroke-dashoffset":0},null),t.createVNode("circle",{class:"v-progress-circular__overlay",fill:"transparent",cx:"50%",cy:"50%",r:20,"stroke-width":k.value,"stroke-dasharray":o,"stroke-dashoffset":x.value},null)]),a.default&&t.createVNode("div",{class:"v-progress-circular__content"},[a.default({value:b.value})])]}))),{}}}),Kl=Symbol("rippleStop")
...
p&&"static"===p.position&&(t.style.position="relative",t.dataset.previousPosition="static"),n.classList.add("v-ripple__animation--enter"),n.classList.add("v-ripple__animation--visible"),Zl(n,`translate(${s}, ${u}) scale3d(${i},${i},${i})`),Jl(n,0),n.dataset.activated=String(performance.now()),setTimeout((()=>{n.classList.remove("v-ripple__animation--enter"),n.classList.add("v-ripple__animation--in"),Zl(n,`translate(${c}, ${d}) scale3d(1,1,1)`),Jl(n,.08)}),0)},hide(e){var t
...
setTimeout((()=>{a.classList.remove("v-ripple__animation--in"),a.classList.add("v-ripple__animation--out"),Jl(a,0),setTimeout((()=>{1===e.getElementsByClassName("v-ripple__animation").length&&e.dataset.previousPosition&&(e.style.position=e.dataset.previousPosition,delete e.dataset.previousPosition),a.parentNode&&e.removeChild(a.parentNode)}),300)}),n)}}
...
null!=l&&null!=(e=l._ripple)&&e.showTimerCommit&&(l._ripple.showTimerCommit(),l._ripple.showTimerCommit=null)}),80)}else ta.show(e,l,t)}}function oa(e){e[Kl]=!0}function na(e){const t=e.currentTarget
if(t&&t._ripple){if(window.clearTimeout(t._ripple.showTimer),"touchend"===e.type&&t._ripple.showTimerCommit)return t._ripple.showTimerCommit(),t._ripple.showTimerCommit=null,void(t._ripple.showTimer=window.setTimeout((()=>{na(e)})))
...
function sa(e){ia||e.keyCode!==y.enter&&e.keyCode!==y.space||(ia=!0,aa(e))}function ua(e){ia=!1,na(e)}function ca(e){ia&&(ia=!1,na(e))}function da(e,t,l){const{value:a,modifiers:o}=t,n=la(a)
if(n||ta.hide(e),e._ripple=e._ripple??{},e._ripple.enabled=n,e._ripple.centered=o.center,e._ripple.circle=o.circle,h(a)&&a.class&&(e._ripple.class=a.class),n&&!l){if(o.stop)return e.addEventListener("touchstart",oa,{passive:!0}),void e.addEventListener("mousedown",oa)
e.addEventListener("touchstart",aa,{passive:!0}),e.addEventListener("touchend",na,{passive:!0}),e.addEventListener("touchmove",ra,{passive:!0}),e.addEventListener("touchcancel",na),e.addEventListener("mousedown",aa),e.addEventListener("mouseup",na),e.addEventListener("mouseleave",na),e.addEventListener("keydown",sa),e.addEventListener("keyup",ua),e.addEventListener("blur",ca),e.addEventListener("dragstart",na,{passive:!0})}else!n&&l&&va(e)}function va(e){e.removeEventListener("mousedown",aa),e.removeEventListener("touchstart",aa),e.removeEventListener("touchend",na),e.removeEventListener("touchmove",ra),e.removeEventListener("touchcancel",na),e.removeEventListener("mouseup",na),e.removeEventListener("mouseleave",na),e.removeEventListener("keydown",sa),e.removeEventListener("keyup",ua),e.removeEventListener("dragstart",na),e.removeEventListener("blur",ca)}const pa={mounted:function(e,t){da(e,t,!1)},unmounted:function(e){delete e._ripple,va(e)},updated:function(e,t){if(t.value===t.oldValue)return
da(e,t,la(t.oldValue))}},fa=ze({name:"VProgressLinear",props:{active:{type:Boolean,default:!0},bgColor:String,bgOpacity:[Number,String],bufferValue:{type:[Number,String],default:0},clickable:Boolean,color:String,height:{type:[Number,String],default:4},indeterminate:Boolean,max:{type:[Number,String],default:100},modelValue:{type:[Number,String],default:0},reverse:Boolean,stream:Boolean,striped:Boolean,roundedBar:Boolean,...il(),...tl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=ml(e,"modelValue"),{isRtl:n}=kt(),{themeClasses:r}=ft(e),{textColorClasses:i,textColorStyles:s}=cl(e,"color"),{backgroundColorClasses:u,backgroundColorStyles:c}=dl(t.computed((()=>e.bgColor||e.color))),{backgroundColorClasses:d,backgroundColorStyles:v}=dl(e,"color"),{roundedClasses:p}=sl(e),{intersectionRef:f,isIntersecting:m}=Gl(),h=t.computed((()=>parseInt(e.max,10))),y=t.computed((()=>parseInt(e.height,10))),b=t.computed((()=>parseFloat(e.bufferValue)/h.value*100)),V=t.computed((()=>parseFloat(o.value)/h.value*100)),S=t.computed((()=>n.value!==e.reverse)),w=t.computed((()=>e.indeterminate?"fade-transition":"slide-x-transition")),k=t.computed((()=>null==e.bgOpacity?e.bgOpacity:parseFloat(e.bgOpacity)))
...
return"center"!==t&&(l?i[ya[t]]=`calc(100% - ${r(t)}px)`:i[t]=0),"center"!==n?l?i[ya[n]]=`calc(100% - ${r(n)}px)`:i[n]=0:("center"===t?i.top=i.left="50%":i[{top:"left",bottom:"left",left:"top",right:"top"}[t]]="50%",i.transform={top:"translateX(-50%)",bottom:"translateX(-50%)",left:"translateY(-50%)",right:"translateY(-50%)",center:"translate(-50%, -50%)"}[t]),i}))
return{locationStyles:n}}const Sa=["static","relative","fixed","absolute","sticky"],wa=Xe({position:{type:String,validator:e=>Sa.includes(e)}},"position")
function ka(e){let l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
const a=t.computed((()=>e.position?`${l}--${e.position}`:void 0))
return{positionClasses:a}}function xa(){var e,t
return null==(e=Ie("useRouter"))||null==(t=e.proxy)?void 0:t.$router}function Ca(e,l){const a=t.resolveDynamicComponent("RouterLink"),o=t.computed((()=>!(!e.href&&!e.to))),n=t.computed((()=>(null==o?void 0:o.value)||!(!l.onClick&&!l.onClickOnce)))
if("string"==typeof a)return{isLink:o,isClickable:n,href:t.toRef(e,"href")}
const r=e.to?a.useLink(e):void 0
return{...r,isLink:o,isClickable:n,href:t.computed((()=>e.to?null==r?void 0:r.route.value.href:e.href))}}const Na=Xe({href:String,replace:Boolean,to:[String,Object]},"router")
let _a=!1
const Ba=ze({name:"VBtn",directives:{Ripple:pa},props:{active:Boolean,symbol:{type:null,default:$l},flat:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ll,appendIcon:Ll,block:Boolean,stacked:Boolean,ripple:{type:Boolean,default:!0},...al(),...il(),...yl(),...Xt(),...nl(),...Nl(),...ma(),...ba(),...wa(),...Na(),...Wl(),...tl({tag:"button"}),...dt(),...wl({variant:"elevated"})},emits:{"group:selected":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const{themeClasses:n}=ft(e),{borderClasses:r}=ol(e),{colorClasses:i,colorStyles:s,variantClasses:u}=kl(e),{densityClasses:c}=bl(e),{dimensionStyles:d}=Gt(e),{elevationClasses:v}=rl(e),{loaderClasses:p}=ga(e),{locationStyles:f}=Va(e),{positionClasses:m}=ka(e),{roundedClasses:g}=sl(e),{sizeClasses:h}=Ul(e),y=_l(e,e.symbol,!1),b=Ca(e,a),V=t.computed((()=>(null==y?void 0:y.disabled.value)||e.disabled)),S=t.computed((()=>"elevated"===e.variant&&!(e.disabled||e.flat||e.border)))
return function(e,l){t.watch((()=>{var t
return null==(t=e.isExactActive)?void 0:t.value}),(a=>{e.isLink.value&&a&&l&&t.nextTick((()=>{l(!0)}))}),{immediate:!0})}(b,null==y?void 0:y.select),Ge((()=>{var l,a,w,k
const x=b.isLink.value?"a":e.tag,C=!y||y.isSelected.value,N=!(!e.prependIcon&&!o.prepend),_=!(!e.appendIcon&&!o.append)
return t.withDirectives(t.createVNode(x,{type:"a"===x?void 0:"button",class:["v-btn",null==y?void 0:y.selectedClass.value,{"v-btn--active":e.active,"v-btn--block":e.block,"v-btn--disabled":V.value,"v-btn--elevated":S.value,"v-btn--flat":e.flat,"v-btn--icon":!!e.icon,"v-btn--loading":e.loading,"v-btn--stacked":e.stacked},n.value,r.value,C?i.value:void 0,c.value,v.value,p.value,m.value,g.value,h.value,u.value],style:[C?s.value:void 0,d.value,f.value],disabled:V.value||void 0,href:b.href.value,onClick:e=>{var t
V.value||(null==(t=b.navigate)||t.call(b,e),null==y||y.toggle())}},{default:()=>[Sl(!0,"v-btn"),!e.icon&&N&&t.createVNode(Ct,{key:"prepend",defaults:{VIcon:{icon:e.prependIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__prepend"},[(null==(l=o.prepend)?void 0:l.call(o))??t.createVNode(Xl,null,null)])]}),t.createVNode("span",{class:"v-btn__content","data-no-activator":""},[t.createVNode(Ct,{key:"content",defaults:{VIcon:{icon:"string"==typeof e.icon?e.icon:void 0}}},{default:()=>[(null==(a=o.default)?void 0:a.call(o))??("string"==typeof e.icon&&t.createVNode(Xl,{key:"icon"},null))]})]),!e.icon&&_&&t.createVNode(Ct,{key:"append",defaults:{VIcon:{icon:e.appendIcon}}},{default:()=>[t.createVNode("span",{class:"v-btn__append"},[(null==(w=o.append)?void 0:w.call(o))??t.createVNode(Xl,null,null)])]}),!!e.loading&&t.createVNode("span",{key:"loader",class:"v-btn__loader"},[(null==(k=o.loader)?void 0:k.call(o))??t.createVNode(ql,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"23",width:"2"},null)])]}),[[t.resolveDirective("ripple"),!V.value&&e.ripple,null]])})),{}}}),Ia=ze({name:"VAppBarNavIcon",props:{icon:{type:Ll,default:"$menu"}},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(Ba,{class:"v-app-bar-nav-icon",icon:e.icon},a))),{}}}),$a=ze({name:"VToolbarItems",props:wl({variant:"text"}),setup(e,l){let{slots:a}=l
return Oe({VBtn:{color:t.toRef(e,"color"),height:"inherit",variant:t.toRef(e,"variant")}}),Ge((()=>{var e
return t.createVNode("div",{class:"v-toolbar-items"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),Aa=ze({name:"VAppBarTitle",props:{...ll.props},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(ll,{class:"v-app-bar-title"},a))),{}}}),Ea=De("v-alert-title"),Ra=Symbol.for("vuetify:locale-adapter"),La=Symbol.for("vuetify:locale")
function Ta(){const e=t.inject(Ra)
if(!e)throw new Error("[Vuetify] Could not find injected locale adapter")
return e.getScope()}function Pa(e,l){const a=(o=l)&&o.hasOwnProperty("getScope")&&o.hasOwnProperty("createScope")&&o.hasOwnProperty("createRoot")?l:function(e){const l=e=>{const l=t.ref(e.current),a=t.ref(e.fallback),o=t.ref(e.messages)
return{current:l,fallback:a,messages:o,t:za(l,a,o),n:Fa(l,a)}}
...
return t.provide(La,a),a},getScope:()=>{const e=t.inject(La)
if(!e)throw new Error("[Vuetify] Could not find injected locale instance")
return e},createScope:e=>{const a=t.inject(La)
...
return t.provide(La,o),o}}}(l)
var o
const n=a.createRoot(e)
return null==e||e.provide(Vt,function(e,l){return St({rtl:{...bt,...(null==l?void 0:l.rtl)??{}},isRtl:t.ref(!1),rtlClasses:t.ref("")},e)}(n,l)),a}const Oa="$vuetify.",Ma=(e,t)=>e.replace(/\{(\d+)\}/g,((e,l)=>String(t[+l]))),za=(e,t,l)=>function(a){for(var o=arguments.length,n=new Array(o>1?o-1:0),r=1;r<o;r++)n[r-1]=arguments[r]
if(!a.startsWith(Oa))return Ma(a,n)
const i=a.replace(Oa,""),s=e.value&&l.value[e.value],u=t.value&&l.value[t.value]
let c=p(s,i,null)
return c||(Q(`Translation key "${a}" not found in "${e.value}", trying fallback locale`),c=p(u,i,null)),c||(ee(`Translation key "${a}" not found in fallback`),c=a),"string"!=typeof c&&(ee(`Translation key "${a}" has a non-string value`),c=a),Ma(c,n)}
function Fa(e,t){return(l,a)=>new Intl.NumberFormat([e.value,t.value],a).format(l)}const Da=["success","info","warning","error"],ja=ze({name:"VAlert",props:{border:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["top","end","bottom","start"].includes(e)},borderColor:String,closable:Boolean,closeIcon:{type:Ll,default:"$close"},closeLabel:{type:String,default:"$vuetify.close"},icon:{type:[Boolean,String,Function,Object],default:null},modelValue:{type:Boolean,default:!0},prominent:Boolean,title:String,text:String,type:{type:String,validator:e=>Da.includes(e)},...yl(),...Xt(),...nl(),...ba(),...wa(),...il(),...tl(),...dt(),...wl({variant:"flat"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=ml(e,"modelValue"),n=t.computed((()=>{if(!1!==e.icon)return e.type?e.icon??`$${e.type}`:e.icon})),r=t.computed((()=>({color:e.color??e.type,variant:e.variant}))),{themeClasses:i}=ft(e),{colorClasses:s,colorStyles:u,variantClasses:c}=kl(r),{densityClasses:d}=bl(e),{dimensionStyles:v}=Gt(e),{elevationClasses:p}=rl(e),{locationStyles:f}=Va(e),{positionClasses:m}=ka(e),{roundedClasses:g}=sl(e),{textColorClasses:h,textColorStyles:y}=cl(t.toRef(e,"borderColor")),{t:b}=Ta(),V=t.computed((()=>({"aria-label":b(e.closeLabel),onClick(e){o.value=!1}})))
return()=>{var l,r
const b=!(!a.prepend&&!n.value),S=!(!a.title&&!e.title),w=!(!e.text&&!a.text),k=!(!a.close&&!e.closable)
return o.value&&t.createVNode(e.tag,{class:["v-alert",e.border&&{"v-alert--border":!!e.border,[`v-alert--border-${!0===e.border?"start":e.border}`]:!0},{"v-alert--prominent":e.prominent},i.value,s.value,d.value,p.value,m.value,g.value,c.value],style:[u.value,v.value,f.value],role:"alert"},{default:()=>[Sl(!1,"v-alert"),e.border&&t.createVNode("div",{key:"border",class:["v-alert__border",h.value],style:y.value},null),b&&t.createVNode(Ct,{key:"prepend",defaults:{VIcon:{density:e.density,icon:n.value,size:e.prominent?44:28}}},{default:()=>[t.createVNode("div",{class:"v-alert__prepend"},[a.prepend?a.prepend():n.value&&t.createVNode(Xl,null,null)])]}),t.createVNode("div",{class:"v-alert__content"},[S&&t.createVNode(Ea,{key:"title"},{default:()=>[a.title?a.title():e.title]}),w&&(a.text?a.text():e.text),null==(l=a.default)?void 0:l.call(a)]),a.append&&t.createVNode("div",{key:"append",class:"v-alert__append"},[a.append()]),k&&t.createVNode(Ct,{key:"close",defaults:{VBtn:{icon:e.closeIcon,size:"x-small",variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-alert__close"},[(null==(r=a.close)?void 0:r.call(a,{props:V.value}))??t.createVNode(Ba,V.value,null)])]})]})}}}),Ha=ze({name:"VMessages",props:{active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...Jt({transition:{component:Ht,leaveAbsolute:!0,group:!0}})},setup(e,l){let{slots:a}=l
const o=t.computed((()=>k(e.messages))),{textColorClasses:n,textColorStyles:r}=cl(t.computed((()=>e.color)))
return Ge((()=>t.createVNode(Qt,{transition:e.transition,tag:"div",class:["v-messages",n.value],style:r.value},{default:()=>[e.active&&o.value.map(((e,l)=>t.createVNode("div",{class:"v-messages__message",key:`${l}-${o.value}`},[a.message?a.message({message:e}):e])))]}))),{}}}),Wa=Symbol.for("vuetify:form"),Ua=Xe({disabled:Boolean,fastFail:Boolean,lazyValidation:Boolean,readonly:Boolean,modelValue:{type:Boolean,default:null}})
function Ya(){return t.inject(Wa,null)}const Xa=Xe({disabled:Boolean,error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:Boolean,rules:{type:Array,default:()=>[]},modelValue:null,validationValue:null})
...
const o=ml(e,"modelValue"),n=t.computed((()=>e.validationValue??o.value)),r=Ya(),i=t.ref([]),s=t.ref(!0),u=t.computed((()=>!(!k(""===o.value?null:o.value).length&&!k(""===n.value?null:n.value).length))),c=t.computed((()=>!!(e.disabled||null!=r&&r.isDisabled.value))),d=t.computed((()=>!!(e.readonly||null!=r&&r.isReadonly.value))),v=t.computed((()=>e.errorMessages.length?k(e.errorMessages):i.value)),p=t.computed((()=>!e.error&&!v.value.length&&(!e.rules.length||(!s.value||null)))),f=t.ref(!1),m=t.computed((()=>({[`${l}--error`]:!1===p.value,[`${l}--dirty`]:u.value,[`${l}--disabled`]:c.value,[`${l}--readonly`]:d.value}))),g=t.computed((()=>e.name??t.unref(a)))
...
return t.createVNode(Xl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r},null)}}}const Ka=Xe({id:String,appendIcon:Ll,prependIcon:Ll,hideDetails:[Boolean,String],messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":M,"onClick:append":M,...yl(),...Xa()}),Za=Fe()({name:"VInput",props:{...Ka()},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o,emit:n}=l
const{densityClasses:r}=bl(e),{InputIcon:i}=qa(e),s=Re(),u=t.computed((()=>e.id||`input-${s}`)),{errorMessages:c,isDirty:d,isDisabled:v,isReadonly:p,isPristine:f,isValid:m,isValidating:g,reset:h,resetValidation:y,validate:b,validationClasses:V}=Ga(e,"v-input",u),S=t.computed((()=>({id:u,isDirty:d,isDisabled:v,isReadonly:p,isPristine:f,isValid:m,isValidating:g,reset:h,resetValidation:y,validate:b})))
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,r.value,V.value]},[d&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[e.prependIcon&&t.createVNode(i,{key:"prepend-icon",name:"prepend"},null),null==(a=o.prepend)?void 0:a.call(o,S.value)]),o.default&&t.createVNode("div",{class:"v-input__control"},[null==(n=o.default)?void 0:n.call(o,S.value)]),v&&t.createVNode("div",{key:"append",class:"v-input__append"},[null==(s=o.append)?void 0:s.call(o,S.value),e.appendIcon&&t.createVNode(i,{key:"append-icon",name:"append"},null)]),f&&t.createVNode("div",{class:"v-input__details"},[t.createVNode(Ha,{active:p,messages:c.value.length>0?c.value:e.messages},{message:o.message}),null==(u=o.details)?void 0:u.call(o,S.value)])])})),{reset:h,resetValidation:y,validate:b}}})
function Ja(e){return S(e,Object.keys(Za.props).filter((e=>!O(e))))}const Qa=ze({name:"VLabel",props:{text:String,...dt()},setup(e,l){let{slots:a}=l
return Ge((()=>{var l
return t.createVNode("label",{class:"v-label"},[e.text,null==(l=a.default)?void 0:l.call(a)])})),{}}}),eo=Symbol.for("vuetify:selection-control-group"),to=ze({name:"VSelectionControlGroup",props:{disabled:Boolean,id:String,inline:Boolean,name:String,falseIcon:Ll,trueIcon:Ll,multiple:{type:Boolean,default:null},readonly:Boolean,type:String,modelValue:null},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=ml(e,"modelValue"),n=Re(),r=t.computed((()=>e.id||`v-selection-control-group-${n}`)),i=t.computed((()=>e.name||r.value))
return t.provide(eo,{disabled:t.toRef(e,"disabled"),inline:t.toRef(e,"inline"),modelValue:o,multiple:t.computed((()=>!!e.multiple||null==e.multiple&&Array.isArray(o.value))),name:i,falseIcon:t.toRef(e,"falseIcon"),trueIcon:t.toRef(e,"trueIcon"),readonly:t.toRef(e,"readonly"),type:t.toRef(e,"type")}),Ge((()=>{var l
return t.createVNode("div",{class:"v-selection-control-group","aria-labelled-by":"radio"===e.type?r.value:void 0,role:"radio"===e.type?"radiogroup":void 0},[null==(l=a.default)?void 0:l.call(a)])})),{}}}),lo=Xe({color:String,disabled:Boolean,error:Boolean,id:String,inline:Boolean,label:String,falseIcon:Ll,trueIcon:Ll,ripple:{type:Boolean,default:!0},multiple:{type:Boolean,default:null},name:String,readonly:Boolean,trueValue:null,falseValue:null,modelValue:null,type:String,value:null,valueComparator:{type:Function,default:v},...dt(),...yl()})
const ao=Fe()({name:"VSelectionControl",directives:{Ripple:pa},inheritAttrs:!1,props:lo(),emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const{densityClasses:r,group:i,icon:s,model:u,textColorClasses:c,textColorStyles:d,trueValue:v}=function(e){const l=t.inject(eo,void 0),{densityClasses:a}=bl(e),o=ml(e,"modelValue"),n=t.computed((()=>void 0!==e.trueValue?e.trueValue:void 0===e.value||e.value)),r=t.computed((()=>void 0!==e.falseValue&&e.falseValue)),i=t.computed((()=>(null==l?void 0:l.multiple.value)||!!e.multiple||null==e.multiple&&Array.isArray(o.value))),s=t.computed({get(){const t=l?l.modelValue.value:o.value
...
return Ge((()=>t.createVNode(ao,t.mergeProps(e,{class:"v-checkbox-btn",type:"checkbox",inline:!0,"onUpdate:modelValue":r,falseIcon:i.value,trueIcon:s.value,"aria-checked":e.indeterminate?"mixed":void 0}),a))),{}}})
const io=ze({name:"VCheckbox",inheritAttrs:!1,props:{...Ka(),...no()},setup(e,l){let{attrs:a,slots:o}=l
const n=Re(),r=t.computed((()=>e.id||`checkbox-${n}`))
return Ge((()=>{const[l,n]=w(a),[i,s]=Ja(e),[u,c]=function(e){return S(e,Object.keys(ro.props))}(e)
return t.createVNode(Za,t.mergeProps({class:"v-checkbox"},l,i,{id:r.value}),{...o,default:e=>{let{id:l,isDisabled:a,isReadonly:r}=e
return t.createVNode(ro,t.mergeProps(u,{id:l.value,disabled:a.value,readonly:r.value},n),o)}})})),{}}}),so=Xe({color:String,start:Boolean,end:Boolean,icon:Ll,image:String,...yl(),...il(),...Wl(),...tl()}),uo=ze({name:"VAvatar",props:so(),setup(e,l){let{slots:a}=l
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl(t.toRef(e,"color")),{densityClasses:r}=bl(e),{roundedClasses:i}=sl(e),{sizeClasses:s,sizeStyles:u}=Ul(e)
return Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},o.value,r.value,i.value,s.value],style:[n.value,u.value]},{default:()=>[e.image?t.createVNode(el,{src:e.image,alt:""},null):e.icon?t.createVNode(Xl,{icon:e.icon},null):null==(l=a.default)?void 0:l.call(a)]})})),{}}}),co=Symbol.for("vuetify:v-chip-group"),vo=ze({name:"VChipGroup",props:{column:Boolean,filter:Boolean,valueComparator:{type:Function,default:v},...Cl({selectedClass:"v-chip--selected"}),...tl(),...dt(),...wl({variant:"tonal"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Bl(e,co)
return Oe({VChip:{color:t.toRef(e,"color"),filter:t.toRef(e,"filter"),variant:t.toRef(e,"variant")}}),Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-chip-group",{"v-chip-group--column":e.column},o.value]},{default:()=>[null==(l=a.default)?void 0:l.call(a,{isSelected:n,select:r,next:i,prev:s,selected:u.value})]})})),{}}}),po=ze({name:"VChip",directives:{Ripple:pa},props:{activeClass:String,appendAvatar:String,appendIcon:Ll,closable:Boolean,closeIcon:{type:Ll,default:"$delete"},closeLabel:{type:String,default:"$vuetify.close"},draggable:Boolean,filter:Boolean,filterIcon:{type:String,default:"$complete"},label:Boolean,link:Boolean,pill:Boolean,prependAvatar:String,prependIcon:Ll,ripple:{type:Boolean,default:!0},text:String,modelValue:{type:Boolean,default:!0},...al(),...yl(),...nl(),...Nl(),...il(),...Na(),...Wl(),...tl({tag:"span"}),...dt(),...wl({variant:"tonal"})},emits:{"click:close":e=>!0,"update:active":e=>!0,"update:modelValue":e=>!0,"group:selected":e=>!0},setup(e,l){let{attrs:a,emit:o,slots:n}=l
const{borderClasses:r}=ol(e),{colorClasses:i,colorStyles:s,variantClasses:u}=kl(e),{densityClasses:c}=bl(e),{elevationClasses:d}=rl(e),{roundedClasses:v}=sl(e),{sizeClasses:p}=Ul(e),{themeClasses:f}=ft(e),m=ml(e,"modelValue"),g=_l(e,co,!1),h=Ca(e,a)
...
return m.value&&t.withDirectives(t.createVNode(a,{class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":k,"v-chip--filter":V,"v-chip--pill":e.pill},f.value,r.value,w?i.value:void 0,c.value,d.value,v.value,p.value,u.value,null==g?void 0:g.selectedClass.value],style:[w?s.value:void 0],disabled:e.disabled||void 0,draggable:e.draggable,href:h.href.value,onClick:k&&x},{default:()=>[Sl(k,"v-chip"),V&&t.createVNode(Ct,{key:"filter",defaults:{VIcon:{icon:e.filterIcon}}},{default:()=>[t.createVNode(Yt,null,{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?n.filter():t.createVNode(Xl,null,null)]),[[t.vShow,g.isSelected.value]])]})]}),S&&t.createVNode(Ct,{key:"prepend",defaults:{VAvatar:{image:e.prependAvatar},VIcon:{icon:e.prependIcon}}},{default:()=>[n.prepend?t.createVNode("div",{class:"v-chip__prepend"},[n.prepend()]):e.prependAvatar?t.createVNode(uo,{start:!0},null):e.prependIcon?t.createVNode(Xl,{start:!0},null):void 0]}),(null==(l=n.default)?void 0:l.call(n,{isSelected:null==g?void 0:g.isSelected.value,selectedClass:null==g?void 0:g.selectedClass.value,select:null==g?void 0:g.select,toggle:null==g?void 0:g.toggle,value:null==g?void 0:g.value.value,disabled:e.disabled}))??e.text,o&&t.createVNode(Ct,{key:"append",defaults:{VAvatar:{image:e.appendAvatar},VIcon:{icon:e.appendIcon}}},{default:()=>[n.append?t.createVNode("div",{class:"v-chip__append"},[n.append()]):e.appendAvatar?t.createVNode(uo,{end:!0},null):e.appendIcon?t.createVNode(Xl,{end:!0},null):void 0]}),b&&t.createVNode(Ct,{key:"close",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},{default:()=>[t.createVNode("div",{class:"v-chip__close",onClick:y},[n.close?n.close():t.createVNode(Xl,null,null)])]})]}),[[t.resolveDirective("ripple"),k&&e.ripple,null]])}}}),fo=ze({name:"VDivider",props:{color:String,inset:Boolean,length:[Number,String],thickness:[Number,String],vertical:Boolean,...dt()},setup(e,l){let{attrs:a}=l
...
return Ge((()=>t.createVNode("hr",{class:[{"v-divider":!0,"v-divider--inset":e.inset,"v-divider--vertical":e.vertical},o.value,n.value],style:[i.value,r.value],"aria-orientation":a.role&&"separator"!==a.role?void 0:e.vertical?"vertical":"horizontal",role:`${a.role||"separator"}`},null))),{}}}),mo=Symbol.for("vuetify:list")
function go(){const e=t.inject(mo,{hasPrepend:t.ref(!1),updateHasPrepend:()=>null}),l={hasPrepend:t.ref(!1),updateHasPrepend:e=>{e&&(l.hasPrepend.value=e)}}
return t.provide(mo,l),e}function ho(){return t.inject(mo,null)}const yo={open:e=>{let{id:t,value:l,opened:a,parents:o}=e
if(l){const e=new Set
e.add(t)
let l=o.get(t)
for(;null!=l;)e.add(l),l=o.get(l)
return e}return a.delete(t),a},select:()=>null},bo={open:e=>{let{id:t,value:l,opened:a,parents:o}=e
if(l){let e=o.get(t)
for(a.add(t);null!=e&&e!==t;)a.add(e),e=o.get(e)
return a}return a.delete(t),a},select:()=>null},Vo={open:bo.open,select:e=>{let{id:t,value:l,opened:a,parents:o}=e
if(!l)return a
const n=[]
let r=o.get(t)
for(;null!=r;)n.push(r),r=o.get(r)
return new Set(n)}},So=e=>{const t={select:t=>{let{id:l,value:a,selected:o}=t
...
return null!=e&&e.length&&(o=t.in(e.slice(0,1),l,a)),o},out:(e,l,a)=>t.out(e,l,a)}},ko=Symbol.for("vuetify:nested"),xo={id:t.ref(),root:{register:()=>null,unregister:()=>null,parents:t.ref(new Map),children:t.ref(new Map),open:()=>null,openOnSelect:()=>null,select:()=>null,opened:t.ref(new Set),selected:t.ref(new Map),selectedValues:t.ref([])}},Co=Xe({selectStrategy:[String,Function],openStrategy:[String,Function],opened:Array,selected:Array,mandatory:Boolean},"nested"),No=e=>{let l=!1
const a=t.ref(new Map),o=t.ref(new Map),n=ml(e,"opened",e.opened,(e=>new Set(e)),(e=>[...e.values()])),r=t.computed((()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
switch(e.selectStrategy){case"single-leaf":return(e=>{const t=wo(e)
...
case"leaf":return(e=>{const t=So(e)
return{select:e=>{let{id:l,selected:a,children:o,...n}=e
return o.has(l)?a:t.select({id:l,selected:a,children:o,...n})},in:t.in,out:t.out}})(e.mandatory)
case"independent":return So(e.mandatory)
case"single-independent":return wo(e.mandatory)
...
switch(e.openStrategy){case"list":return Vo
case"single":return yo
case"multiple":default:return bo}})),s=ml(e,"selected",e.selected,(e=>r.value.in(e,a.value,o.value)),(e=>r.value.out(e,a.value,o.value)))
...
return t.provide(ko,d),d.root},_o=(e,l)=>{const a=t.inject(ko,xo),o=t.computed((()=>e.value??Re().toString())),n={...a,id:o,open:(e,t)=>a.root.open(o.value,e,t),openOnSelect:(e,t)=>a.root.openOnSelect(o.value,e,t),isOpen:t.computed((()=>a.root.opened.value.has(o.value))),parent:t.computed((()=>a.root.parents.value.get(o.value))),select:(e,t)=>a.root.select(o.value,e,t),isSelected:t.computed((()=>"on"===a.root.selected.value.get(o.value))),isIndeterminate:t.computed((()=>"indeterminate"===a.root.selected.value.get(o.value))),isLeaf:t.computed((()=>!a.root.children.value.get(o.value))),isGroupActivator:a.isGroupActivator}
return!a.isGroupActivator&&a.root.register(o.value,a.id.value,l),t.onBeforeUnmount((()=>{!a.isGroupActivator&&a.root.unregister(o.value)})),l&&t.provide(ko,n),n},Bo=ze({name:"VListGroupActivator",setup(e,l){let{slots:a}=l
return(()=>{const e=t.inject(ko,xo)
t.provide(ko,{...e,isGroupActivator:!0})})(),()=>{var e
return null==(e=a.default)?void 0:e.call(a)}}}),Io=Xe({activeColor:String,color:String,collapseIcon:{type:Ll,default:"$collapse"},expandIcon:{type:Ll,default:"$expand"},prependIcon:Ll,appendIcon:Ll,fluid:Boolean,subgroup:Boolean,value:null,...tl()}),$o=Fe()({name:"VListGroup",props:{title:String,...Io()},setup(e,l){let{slots:a}=l
const{isOpen:o,open:n}=_o(t.toRef(e,"value"),!0),r=ho(),i=e=>{n(!o.value,e)},s=t.computed((()=>({onClick:i,class:"v-list-group__header"}))),u=t.computed((()=>o.value?e.collapseIcon:e.expandIcon))
return Ge((()=>{var l
return t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":null==r?void 0:r.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup}]},{default:()=>[a.activator&&t.createVNode(Ct,{defaults:{VListItem:{active:o.value,activeColor:e.activeColor,color:e.color,prependIcon:e.prependIcon||e.subgroup&&u.value,appendIcon:e.appendIcon||!e.subgroup&&u.value,title:e.title,value:e.value}}},{default:()=>[t.createVNode(Bo,null,{default:()=>[a.activator({props:s.value,isOpen:o})]})]}),t.createVNode(Ut,null,{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items"},[null==(l=a.default)?void 0:l.call(a)]),[[t.vShow,o.value]])]})]})})),{}}})
const Ao=De("v-list-item-subtitle"),Eo=De("v-list-item-title"),Ro=Fe()({name:"VListItem",directives:{Ripple:pa},props:{active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Ll,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Ll,subtitle:[String,Number,Boolean],title:[String,Number,Boolean],value:null,...al(),...yl(),...Xt(),...nl(),...il(),...Na(),...tl(),...dt(),...wl({variant:"text"})},setup(e,l){let{attrs:a,slots:o}=l
const n=Ca(e,a),r=t.computed((()=>e.value??n.href.value)),{select:i,isSelected:s,isIndeterminate:u,isGroupActivator:c,root:d,parent:v,openOnSelect:p}=_o(r,!1),f=ho(),m=t.computed((()=>{var t
return!1!==e.active&&(e.active||(null==(t=n.isExactActive)?void 0:t.value)||s.value)})),g=t.computed((()=>!1!==e.link&&n.isLink.value)),h=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||n.isClickable.value||null!=e.value&&!!f))),y=t.computed((()=>e.rounded||e.nav)),b=t.computed((()=>({color:m.value?e.activeColor??e.color:e.color,variant:e.variant})))
t.watch((()=>{var e
return null==(e=n.isExactActive)?void 0:e.value}),(e=>{e&&null!=v.value&&d.open(v.value,!0),e&&p(e)}),{immediate:!0})
const{themeClasses:V}=ft(e),{borderClasses:S}=ol(e),{colorClasses:w,colorStyles:k,variantClasses:x}=kl(b),{densityClasses:C}=bl(e),{dimensionStyles:N}=Gt(e),{elevationClasses:_}=rl(e),{roundedClasses:B}=sl(y),I=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),$=t.computed((()=>({isActive:m.value,select:i,isSelected:s.value,isIndeterminate:u.value})))
...
c||(null==(l=n.navigate)||l.call(n,t),null!=e.value&&i(!s.value,t))})},{default:()=>[Sl(h.value||m.value,"v-list-item"),E&&t.createVNode(Ct,{key:"prepend",defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[t.createVNode("div",{class:"v-list-item__prepend"},[e.prependAvatar&&t.createVNode(uo,{key:"prepend-avatar"},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon"},null),null==(l=o.prepend)?void 0:l.call(o,$.value)])]}),t.createVNode("div",{class:"v-list-item__content"},[y&&t.createVNode(Eo,{key:"title"},{default:()=>[(null==(a=o.title)?void 0:a.call(o,{title:e.title}))??e.title]}),b&&t.createVNode(Ao,{key:"subtitle"},{default:()=>[(null==(r=o.subtitle)?void 0:r.call(o,{subtitle:e.subtitle}))??e.subtitle]}),null==(u=o.default)?void 0:u.call(o,$.value)]),A&&t.createVNode(Ct,{key:"append",defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[t.createVNode("div",{class:"v-list-item__append"},[null==(d=o.append)?void 0:d.call(o,$.value),e.appendIcon&&t.createVNode(Xl,{key:"append-icon"},null),e.appendAvatar&&t.createVNode(uo,{key:"append-avatar"},null)])]})]}),[[t.resolveDirective("ripple"),h.value]])})),{}}}),Lo=ze({name:"VListSubheader",props:{color:String,inset:Boolean,sticky:Boolean,title:String,...tl()},setup(e,l){let{slots:a}=l
const{textColorClasses:o,textColorStyles:n}=cl(t.toRef(e,"color"))
return Ge((()=>{var l
const r=!(!a.default&&!e.title)
return t.createVNode(e.tag,{class:["v-list-subheader",{"v-list-subheader--inset":e.inset,"v-list-subheader--sticky":e.sticky},o.value],style:{textColorStyles:n}},{default:()=>[r&&t.createVNode("div",{class:"v-list-subheader__text"},[(null==(l=a.default)?void 0:l.call(a))??e.title])]})})),{}}}),To=Fe()({name:"VListChildren",props:{items:Array},setup(e,l){let{slots:a}=l
return go(),()=>{var l,o
return(null==(l=a.default)?void 0:l.call(a))??(null==(o=e.items)?void 0:o.map((e=>{let{children:l,props:o,type:n,raw:r}=e
var i,s
if("divider"===n)return(null==(i=a.divider)?void 0:i.call(a,{props:o}))??t.createVNode(fo,o,null)
if("subheader"===n)return(null==(s=a.subheader)?void 0:s.call(a,{props:o}))??t.createVNode(Lo,o,{default:a.subheader})
...
return null==(t=a.title)?void 0:t.call(a,{...e,item:r})}:void 0},[c,d]=function(e){return S(e,Object.keys($o.props))}(o)
return l?t.createVNode($o,t.mergeProps({value:null==o?void 0:o.value},c),{activator:e=>{let{props:l}=e
return a.header?a.header({...o,...l}):t.createVNode(Ro,t.mergeProps(o,l),u)},default:()=>t.createVNode(To,{items:l},a)}):a.item?a.item(o):t.createVNode(Ro,o,u)})))}}}),Po=Xe({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean},"item")
function Oo(e,t){const l=f(t,e.itemTitle,t),a=f(t,e.itemValue,l),o=f(t,e.itemChildren),n={title:l,value:a,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?S(t,["children"])[1]:t:f(t,e.itemProps)}
return{title:String(n.title??""),value:n.value,props:n,children:Array.isArray(o)?Mo(e,o):void 0,raw:t}}function Mo(e,t){const l=[]
for(const a of t)l.push(Oo(e,a))
return l}function zo(e){return{items:t.computed((()=>Mo(e,e.items))),transformIn:function(t){return t.map((t=>Oo(e,t)))},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
return t})):t.map((e=>{let{props:t}=e
return t.value}))}}}function Fo(e,t){const l=f(t,e.itemType,"item"),a="string"==typeof t?t:f(t,e.itemTitle),o=f(t,e.itemValue,void 0),n=f(t,e.itemChildren),r={title:a,value:o,...!0===e.itemProps?S(t,["children"])[1]:f(t,e.itemProps)}
return{type:l,title:r.title,value:r.value,props:r,children:"item"===l&&n?Do(e,n):void 0,raw:t}}function Do(e,t){const l=[]
for(const a of t)l.push(Fo(e,a))
return l}const jo=Fe()({name:"VList",props:{activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,lines:{type:[Boolean,String],default:"one"},nav:Boolean,...Co({selectStrategy:"single-leaf",openStrategy:"list"}),...al(),...yl(),...Xt(),...nl(),itemType:{type:String,default:"type"},...Po(),...il(),...tl(),...dt(),...wl({variant:"text"})},emits:{"update:selected":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,l){let{slots:a}=l
const{items:o}=function(e){return{items:t.computed((()=>Do(e,e.items)))}}(e),{themeClasses:n}=ft(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl(t.toRef(e,"bgColor")),{borderClasses:s}=ol(e),{densityClasses:u}=bl(e),{dimensionStyles:c}=Gt(e),{elevationClasses:d}=rl(e),{roundedClasses:v}=sl(e),{open:p,select:f}=No(e),m=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),g=t.toRef(e,"activeColor"),h=t.toRef(e,"color")
return go(),Oe({VListGroup:{activeColor:g,color:h},VListItem:{activeClass:t.toRef(e,"activeClass"),activeColor:g,color:h,density:t.toRef(e,"density"),disabled:t.toRef(e,"disabled"),lines:t.toRef(e,"lines"),nav:t.toRef(e,"nav"),variant:t.toRef(e,"variant")}}),Ge((()=>t.createVNode(e.tag,{class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav},n.value,r.value,s.value,u.value,d.value,m.value,v.value],style:[i.value,c.value]},{default:()=>[t.createVNode(To,{items:o.value},a)]}))),{open:p,select:f}}}),Ho=De("v-list-img"),Wo=ze({name:"VListItemAction",props:{start:Boolean,end:Boolean,...tl()},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(e.tag,{class:["v-list-item-action",{"v-list-item-action--start":e.start,"v-list-item-action--end":e.end}]},a))),{}}}),Uo=ze({name:"VListItemMedia",props:{start:Boolean,end:Boolean,...tl()},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(e.tag,{class:["v-list-item-media",{"v-list-item-media--start":e.start,"v-list-item-media--end":e.end}]},a))),{}}}),Yo=Xe({closeDelay:[Number,String],openDelay:[Number,String]},"delay")
function Xo(e,t){const a={},o=o=>()=>{if(!l)return Promise.resolve(!0)
const n="openDelay"===o
...
return{runCloseDelay:o("closeDelay"),runOpenDelay:o("openDelay")}}const Go=Symbol.for("vuetify:v-menu"),qo=Xe({activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...Yo()})
function Ko(e,a){let{isActive:o,isTop:r}=a
const i=t.ref()
let s=!1,u=!1
const c=t.computed((()=>e.openOnFocus||null==e.openOnFocus&&e.openOnHover)),d=t.computed((()=>e.openOnClick||null==e.openOnClick&&!e.openOnHover&&!c.value)),{runOpenDelay:v,runCloseDelay:p}=Xo(e,(t=>{t!==(e.openOnHover&&s||c.value&&u)||e.openOnHover&&o.value&&!r.value||(o.value=t)})),f=e=>{e.stopPropagation(),i.value=e.currentTarget||e.target,o.value=!o.value},m=e=>{s=!0,i.value=e.currentTarget||e.target,v()},g=e=>{s=!1,p()},h=e=>{n&&!e.target.matches(":focus-visible")||(u=!0,e.stopPropagation(),i.value=e.currentTarget||e.target,v())},y=e=>{u=!1,e.stopPropagation(),p()},b=t.computed((()=>{const t={}
return d.value&&(t.click=f),e.openOnHover&&(t.mouseenter=m,t.mouseleave=g),c.value&&(t.focus=h,t.blur=y),t})),V=t.computed((()=>{const l={}
if(e.openOnHover&&(l.mouseenter=()=>{s=!0,v()},l.mouseleave=()=>{s=!1,p()}),e.closeOnContentClick){const e=t.inject(Go,null)
l.click=()=>{o.value=!1,null==e||e.closeParents()}}return l}))
t.watch(r,(t=>{!t||(!e.openOnHover||s||c.value&&u)&&(!c.value||u||e.openOnHover&&s)||(o.value=!1)}))
const S=t.ref()
t.watchEffect((()=>{S.value&&t.nextTick((()=>{const e=S.value
var t
i.value=(null==(t=e)?void 0:t.$el)?e.$el:e}))}))
const w=Ie("useActivator")
let k
return t.watch((()=>!!e.activator),(a=>{a&&l?(k=t.effectScope(),k.run((()=>{!function(e,l,a){let{activatorEl:o,activatorEvents:n}=a
...
e&&i(e)}e&&t.nextTick((()=>r()))}),{immediate:!0}),t.watch((()=>e.activatorProps),(()=>{r()})),t.onScopeDispose((()=>{i()}))}(e,w,{activatorEl:i,activatorEvents:b})}))):k&&k.stop()}),{flush:"post",immediate:!0}),{activatorEl:i,activatorRef:S,activatorEvents:b,contentEvents:V}}const Zo=Xe({eager:Boolean},"lazy")
function Jo(e,l){const a=t.ref(!1),o=t.computed((()=>a.value||e.eager||l.value))
return t.watch(l,(()=>a.value=!0)),{isBooted:a,hasContent:o,onAfterLeave:function(){e.eager||(a.value=!1)}}}function Qo(e,t){return{x:e.x+t.x,y:e.y+t.y}}function en(e,t){if("top"===e.side||"bottom"===e.side){const{side:l,align:a}=e
return Qo({x:"left"===a?0:"center"===a?t.width/2:"right"===a?t.width:a,y:"top"===l?0:"bottom"===l?t.height:l},t)}if("left"===e.side||"right"===e.side){const{side:l,align:a}=e
return Qo({x:"left"===l?0:"right"===l?t.width:l,y:"top"===a?0:"center"===a?t.height/2:"bottom"===a?t.height:a},t)}return Qo({x:t.width/2,y:t.height/2},t)}const tn={static:function(){},connected:function(e,a,o){const n=function(e){for(;e;){if("fixed"===window.getComputedStyle(e).position)return!0
...
function m(e){const a=new G(l),o=en(e.anchor,t),r=en(e.origin,a)
...
Object.assign(o.value,{"--v-overlay-anchor-origin":`${f.anchor.side} ${f.anchor.align}`,transformOrigin:`${f.origin.side} ${f.origin.align}`,top:g(an(y)),left:g(an(h)),minWidth:g("y"===w?Math.min(s.value,t.width):s.value),maxWidth:g(on(x(b.x,s.value===1/0?0:s.value,c.value))),maxHeight:g(on(x(b.y,u.value===1/0?0:u.value,d.value)))})}t.watch((()=>[r.value,i.value,a.offset,a.minWidth,a.minHeight,a.maxWidth,a.maxHeight]),(()=>f()),{immediate:!n}),n&&t.nextTick((()=>f()))
return requestAnimationFrame((()=>{o.value.maxHeight&&f()})),{updateLocation:f}}},ln=Xe({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in tn},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array]})
function an(e){return Math.round(e*devicePixelRatio)/devicePixelRatio}function on(e){return Math.ceil(e*devicePixelRatio)/devicePixelRatio}let nn=!0
const rn=[]
let sn=-1
function un(){cancelAnimationFrame(sn),sn=requestAnimationFrame((()=>{const e=rn.shift()
e&&e(),rn.length?un():nn=!0}))}const cn={none:null,close:function(e){vn(e.activatorEl.value??e.contentEl.value,(function(t){e.isActive.value=!1}))},block:function(e,l){var a
...
t=r/(1e3/60)>2},!nn||rn.length?(rn.push(a),un()):(nn=!1,a(),un())}vn(e.activatorEl.value??e.contentEl.value,(e=>{t?(cancelAnimationFrame(l),l=requestAnimationFrame((()=>{l=requestAnimationFrame((()=>{a(e)}))}))):a(e)}))}},dn=Xe({scrollStrategy:{type:[String,Function],default:"block",validator:e=>"function"==typeof e||e in cn}})
function vn(e,l){const a=[document,...Ue(e)]
a.forEach((e=>{e.addEventListener("scroll",l,{passive:!0})})),t.onScopeDispose((()=>{a.forEach((e=>{e.removeEventListener("scroll",l)}))}))}function pn(e,l){let a
t.watch(e,(e=>{var o
e&&!a?(a=t.effectScope(),a.run(l)):(null==(o=a)||o.stop(),a=void 0)}),{immediate:!0})}const fn=Symbol.for("vuetify:stack"),mn=t.reactive([])
...
return{globalTop:t.readonly(i),localTop:s,stackStyles:t.computed((()=>({zIndex:r.value})))}}(s,t.toRef(e,"zIndex")),{activatorEl:V,activatorRef:S,activatorEvents:w,contentEvents:k}=Ko(e,{isActive:s,isTop:y}),{dimensionStyles:x}=Gt(e)
t.watch((()=>e.disabled),(e=>{e&&(s.value=!1)}))
const C=t.ref(),N=t.ref(),{contentStyles:_,updateLocation:B}=function(e,a){const o=t.ref({}),n=t.ref()
let r
function i(e){var t
...
"function"==typeof e.locationStrategy?n.value=null==(t=e.locationStrategy(a,e,o))?void 0:t.updateLocation:n.value=null==(l=tn[e.locationStrategy](a,e,o))?void 0:l.updateLocation})))})),l&&window.addEventListener("resize",i,{passive:!0}),t.onScopeDispose((()=>{var e
l&&window.removeEventListener("resize",i),n.value=void 0,null==(e=r)||e.stop()})),{contentStyles:o,updateLocation:n}}(e,{isRtl:v,contentEl:N,activatorEl:V,isActive:s})
function I(t){r("click:outside",t),e.persistent?L():s.value=!1}function $(){return s.value&&h.value}function A(t){"Escape"===t.key&&h.value&&(e.persistent?L():s.value=!1)}!function(e,a){if(!l)return
let o
t.watchEffect((async()=>{var l
null==(l=o)||l.stop(),a.isActive.value&&e.scrollStrategy&&(o=t.effectScope(),await t.nextTick(),o.run((()=>{var t
"function"==typeof e.scrollStrategy?e.scrollStrategy(a,e):null==(t=cn[e.scrollStrategy])||t.call(cn,a,e)})))}))}(e,{root:C,contentEl:N,activatorEl:V,isActive:s,updateLocation:B}),l&&t.watch(s,(e=>{e?window.addEventListener("keydown",A):window.removeEventListener("keydown",A)}),{immediate:!0})
const E=xa()
pn((()=>e.closeOnBack),(()=>{!function(e,a){let o,n,r=!1
function i(e){var t
null!=(t=e.state)&&t.replaced||(r=!0,setTimeout((()=>r=!1)))}l&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=null==e?void 0:e.beforeEach(((e,t,l)=>{_a?r?a(l):l():setTimeout((()=>r?a(l):l())),_a=!0})),n=null==e?void 0:e.afterEach((()=>{_a=!1}))})),t.onScopeDispose((()=>{var e,t
window.removeEventListener("popstate",i),null==(e=o)||e(),null==(t=n)||t()})))}(E,(t=>{h.value&&s.value?(t(!1),e.persistent?L():s.value=!1):t()}))}))
const R=t.ref()
function L(){e.noClickAnimation||N.value&&Z(N.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:He})}return t.watch((()=>s.value&&(e.absolute||e.contained)&&null==u.value),(e=>{if(e){const e=We(C.value)
e&&e!==document.scrollingElement&&(R.value=e.scrollTop)}})),Ge((()=>{var a,i
return t.createVNode(t.Fragment,null,[null==(a=o.activator)?void 0:a.call(o,{isActive:s.value,props:t.mergeProps({ref:S},t.toHandlers(w.value),e.activatorProps)}),l&&t.createVNode(t.Teleport,{disabled:!u.value,to:u.value},{default:()=>[p.value&&t.createVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":s.value,"v-overlay--contained":e.contained},c.value,d.value],style:[b.value,{top:g(R.value)}],ref:C},n),[t.createVNode(wn,{color:m,modelValue:s.value&&!!e.scrim},null),t.createVNode(Qt,{appear:!0,persisted:!0,transition:e.transition,target:V.value,onAfterLeave:()=>{f(),r("afterLeave")}},{default:()=>[t.withDirectives(t.createVNode("div",t.mergeProps({ref:N,class:["v-overlay__content",e.contentClass],style:[x.value,_.value]},t.toHandlers(k.value),e.contentProps),[null==(i=o.default)?void 0:i.call(o,{isActive:s})]),[[t.vShow,s.value],[t.resolveDirective("click-outside"),{handler:I,closeConditional:$,include:()=>[V.value]}]])]})])]})])})),{activatorEl:V,animateClick:L,contentEl:N,globalTop:h,localTop:y,updateLocation:B}}}),xn=Symbol("Forwarded refs")
...
const n=ml(e,"modelValue"),{scopeId:r}=Nn(),i=Re(),s=t.computed((()=>e.id||`v-menu-${i}`)),u=t.ref(),c=t.inject(Go,null)
let d=0
function v(){null==c||c.closeParents()}return t.provide(Go,{register(){++d},unregister(){--d},closeParents(){setTimeout((()=>{d||(n.value=!1,null==c||c.closeParents())}),40)}}),t.watch(n,(e=>{e?null==c||c.register():null==c||c.unregister()})),Ge((()=>t.createVNode(kn,t.mergeProps({ref:u,modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,class:["v-menu"],transition:e.transition,absolute:!0,closeOnContentClick:!0,locationStrategy:"connected",scrollStrategy:"reposition",scrim:!1,openDelay:"300",closeDelay:"250",activatorProps:{"aria-haspopup":"menu","aria-expanded":String(n.value),"aria-owns":s.value},"onClick:outside":v},r,a),{default:o.default,activator:o.activator}))),Cn({id:s},u)}}),Bn=ze({name:"VFieldLabel",props:{floating:Boolean},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(Qa,{class:["v-field-label",{"v-field-label--floating":e.floating}],"aria-hidden":e.floating||void 0},a))),{}}}),In=Xe({focused:Boolean},"focus")
function $n(e){let l=arguments.length>1&&void 0!==arguments[1]?arguments[1]:$e()
const a=ml(e,"focused"),o=t.computed((()=>({[`${l}--focused`]:a.value})))
function n(){a.value=!0}function r(){a.value=!1}return{focusClasses:o,isFocused:a,focus:n,blur:r}}const An=["underlined","outlined","filled","solo","plain"],En=Xe({appendInnerIcon:Ll,bgColor:String,clearable:Boolean,clearIcon:{type:Ll,default:"$clear"},active:Boolean,color:String,dirty:Boolean,disabled:Boolean,error:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:Ll,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>An.includes(e)},"onClick:clear":M,"onClick:appendInner":M,"onClick:prependInner":M,...dt(),...ma()},"v-field"),Rn=Fe()({name:"VField",inheritAttrs:!1,props:{id:String,...In(),...En()},emits:{"click:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,l){let{attrs:a,emit:o,slots:n}=l
const{themeClasses:r}=ft(e),{loaderClasses:i}=ga(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=$n(e),{InputIcon:v}=qa(e),p=t.computed((()=>e.dirty||e.active)),f=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),m=Re(),h=t.computed((()=>e.id||`input-${m}`)),y=t.ref(),b=t.ref(),V=t.ref(),{backgroundColorClasses:S,backgroundColorStyles:w}=dl(t.toRef(e,"bgColor")),{textColorClasses:k,textColorStyles:x}=cl(t.computed((()=>p.value&&u.value&&!e.error&&!e.disabled?e.color:void 0)))
...
v.value||(v.value=!0)}function h(e){g(),o("click:control",e)}function y(l){l.stopPropagation(),g(),t.nextTick((()=>{r.value="",z(e["onClick:clear"],l)}))}return Ge((()=>{const l=!!(n.counter||e.counter||e.counterValue),b=!(!l&&!n.details),[V,S]=w(a),[{modelValue:k,...x}]=Ja(e),[C]=Ln(e)
return t.createVNode(Za,t.mergeProps({ref:c,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-text-field",{"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-text-field--flush-details":["plain","underlined"].includes(e.variant)}],"onClick:prepend":e["onClick:prepend"],"onClick:append":e["onClick:append"]},V,x,{messages:m.value}),{...n,default:l=>{let{id:a,isDisabled:i,isDirty:s,isReadonly:c,isValid:m}=l
...
return t.createVNode(t.Fragment,null,[null==(o=n.details)?void 0:o.call(n,a),l&&t.createVNode(t.Fragment,null,[t.createVNode("span",null,null),t.createVNode(Tn,{active:e.persistentCounter||v.value,value:i.value,max:s.value},n.counter)])])}:void 0})})),Cn({},c,d,p)}}),Mn=Xe({chips:Boolean,closableChips:Boolean,eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:Ll,default:"$dropdown"},menuProps:{type:Object},modelValue:{type:null,default:()=>[]},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,readonly:Boolean,...Po({itemChildren:!1})},"select"),zn=Fe()({name:"VSelect",props:{...Mn(),...Jt({transition:{component:It}})},emits:{"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:a}=l
const{t:o}=Ta(),n=t.ref(),r=ml(e,"menu"),{items:i,transformIn:s,transformOut:u}=zo(e),c=ml(e,"modelValue",[],(e=>s(k(e))),(t=>{const l=u(t)
...
return t.createVNode(On,{ref:n,modelValue:c.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":e=>{null==e&&(c.value=[])},validationValue:e.modelValue??c.value,dirty:c.value.length>0,class:["v-select",{"v-select--active-menu":r.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":c.value.length}],appendInnerIcon:e.menuIcon,readonly:!0,"onClick:clear":p,"onClick:control":f,onBlur:()=>r.value=!1,onKeydown:m},{...a,default:()=>{var n,s,u
return t.createVNode(t.Fragment,null,[t.createVNode(_n,t.mergeProps({modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,activator:"parent",contentClass:"v-select__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition},e.menuProps),{default:()=>[t.createVNode(jo,{selected:v.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault()},{default:()=>[!i.value.length&&!e.hideNoData&&((null==(n=a["no-data"])?void 0:n.call(a))??t.createVNode(Ro,{title:o(e.noDataText)},null)),null==(s=a["prepend-item"])?void 0:s.call(a),i.value.map(((l,o)=>{var n
return(null==(n=a.item)?void 0:n.call(a,{item:l,index:o,props:t.mergeProps(l.props,{onClick:()=>g(l)})}))??t.createVNode(Ro,t.mergeProps({key:o},l.props,{onClick:()=>g(l)}),{prepend:l=>{let{isSelected:a}=l
return e.multiple&&!e.hideSelected?t.createVNode(ro,{modelValue:a,ripple:!1},null):void 0}})})),null==(u=a["append-item"])?void 0:u.call(a)]})]}),d.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),g(o)},modelValue:!0}
return t.createVNode("div",{key:n,class:"v-select__selection"},[l?t.createVNode(Ct,{defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[a.chip?a.chip({item:o,index:n,props:r}):t.createVNode(po,r,null)]}):a.selection?a.selection({item:o,index:n}):t.createVNode("span",{class:"v-select__selection-text"},[o.title,e.multiple&&n<d.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({menu:r,select:g},n)}}),Fn=(e,t,l)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),Dn=Xe({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
...
const{t:o}=Ta(),n=t.ref(),r=t.ref(!1),i=t.ref(!0),s=ml(e,"menu"),{items:u,transformIn:c,transformOut:d}=zo(e),v=ml(e,"search",""),p=ml(e,"modelValue",[],(e=>c(k(e))),(t=>{const l=d(t)
...
return t.createVNode(On,{ref:n,modelValue:v.value,"onUpdate:modelValue":e=>{null==e&&(p.value=[])},validationValue:e.modelValue??p.value,dirty:p.value.length>0,onInput:V,class:["v-autocomplete",{"v-autocomplete--active-menu":s.value,"v-autocomplete--chips":!!e.chips,["v-autocomplete--"+(e.multiple?"multiple":"single")]:!0}],appendInnerIcon:e.menuIcon,readonly:e.readonly,"onClick:clear":h,"onClick:control":y,"onClick:input":y,onFocus:()=>r.value=!0,onBlur:()=>r.value=!1,onKeydown:b},{...a,default:()=>{var n
return t.createVNode(t.Fragment,null,[t.createVNode(_n,t.mergeProps({modelValue:s.value,"onUpdate:modelValue":e=>s.value=e,activator:"parent",contentClass:"v-autocomplete__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:S},e.menuProps),{default:()=>[t.createVNode(jo,{selected:g.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault()},{default:()=>[!f.value.length&&!e.hideNoData&&((null==(n=a["no-data"])?void 0:n.call(a))??t.createVNode(Ro,{title:o(e.noDataText)},null)),f.value.map(((l,o)=>{var n
let{item:r,matches:s}=l
return(null==(n=a.item)?void 0:n.call(a,{item:r,index:o,props:t.mergeProps(r.props,{onClick:()=>x(r)})}))??t.createVNode(Ro,t.mergeProps({key:o},r.props,{onClick:()=>x(r)}),{prepend:l=>{let{isSelected:a}=l
return e.multiple&&!e.hideSelected?t.createVNode(ro,{modelValue:a,ripple:!1},null):void 0},title:()=>{var e
...
return t.createVNode("div",{key:n,class:"v-autocomplete__selection"},[l?t.createVNode(Ct,{defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[a.chip?a.chip({item:o,index:n,props:r}):t.createVNode(po,r,null)]}):a.selection?a.selection({item:o,index:n}):t.createVNode("span",{class:"v-autocomplete__selection-text"},[o.title,e.multiple&&n<m.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({isFocused:r,isPristine:i,menu:s,search:v,filteredItems:f,select:x},n)}}),Wn=ze({name:"VBadge",inheritAttrs:!1,props:{bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Ll,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...ba({location:"top end"}),...il(),...tl(),...dt(),...Jt({transition:"scale-rotate-transition"})},setup(e,l){const{backgroundColorClasses:a,backgroundColorStyles:o}=dl(t.toRef(e,"color")),{roundedClasses:n}=sl(e),{t:r}=Ta(),{textColorClasses:i,textColorStyles:s}=cl(t.toRef(e,"textColor")),{themeClasses:u}=mt(),{locationStyles:c}=Va(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return e}const Qn=ze({name:"VBanner",props:{avatar:String,color:String,icon:Ll,lines:String,stacked:Boolean,sticky:Boolean,text:String,...al(),...yl(),...Xt(),...nl(),...ba(),...wa(),...il(),...tl(),...dt()},setup(e,l){let{slots:a}=l
const{borderClasses:o}=ol(e),{densityClasses:n}=bl(e),{mobile:r}=Jn(),{dimensionStyles:i}=Gt(e),{elevationClasses:s}=rl(e),{locationStyles:u}=Va(e),{positionClasses:c}=ka(e),{roundedClasses:d}=sl(e),{themeClasses:v}=ft(e),p=t.toRef(e,"color"),f=t.toRef(e,"density")
Oe({VBannerActions:{color:p,density:f}}),Ge((()=>{var l
const m=!(!e.text&&!a.text),g=!!(a.prepend||e.avatar||e.icon)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||r.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},o.value,n.value,s.value,c.value,d.value,v.value],style:[i.value,u.value],role:"banner"},{default:()=>[g&&t.createVNode(Ct,{key:"prepend",defaults:{VAvatar:{color:p.value,density:f.value,icon:e.icon,image:e.avatar}}},{default:()=>[t.createVNode("div",{class:"v-banner__prepend"},[a.prepend?a.prepend():(e.avatar||e.icon)&&t.createVNode(uo,null,null)])]}),t.createVNode("div",{class:"v-banner__content"},[m&&t.createVNode(Yn,{key:"text"},{default:()=>[a.text?a.text():e.text]}),null==(l=a.default)?void 0:l.call(a)]),a.actions&&t.createVNode(Un,null,{default:()=>[a.actions()]})]})}))}}),er=ze({name:"VBottomNavigation",props:{bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},...al(),...yl(),...nl(),...il(),...Je({name:"bottom-navigation"}),...tl({tag:"header"}),...Cl({modelValue:!0,selectedClass:"v-btn--selected"}),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=mt(),{borderClasses:n}=ol(e),{backgroundColorClasses:r,backgroundColorStyles:i}=dl(t.toRef(e,"bgColor")),{densityClasses:s}=bl(e),{elevationClasses:u}=rl(e),{roundedClasses:c}=sl(e),d=t.computed((()=>Number(e.height)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0))),v=ml(e,"modelValue",e.modelValue),{layoutItemStyles:p}=et({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:t.computed((()=>v.value?d.value:0)),elementSize:d,active:v,absolute:t.toRef(e,"absolute")})
return Bl(e,$l),Oe({VBtn:{color:t.toRef(e,"color"),density:t.toRef(e,"density"),stacked:t.computed((()=>"horizontal"!==e.mode)),variant:"text"}},{scoped:!0}),Ge((()=>t.createVNode(e.tag,{class:["v-bottom-navigation",{"v-bottom-navigation--active":v.value,"v-bottom-navigation--grow":e.grow,"v-bottom-navigation--shift":"shift"===e.mode},o.value,r.value,n.value,s.value,u.value,c.value],style:[i.value,p.value,{height:g(d.value),transform:`translateY(${g(v.value?0:100,"%")})`}]},{default:()=>[a.default&&t.createVNode("div",{class:"v-bottom-navigation__content"},[a.default()])]}))),{}}}),tr=De("v-breadcrumbs-divider","li"),lr=ze({name:"VBreadcrumbsItem",props:{active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...Na(),...tl({tag:"li"})},setup(e,l){let{slots:a,attrs:o}=l
const n=Ca(e,o),r=t.computed((()=>{var t
return e.active||(null==(t=n.isExactActive)?void 0:t.value)})),i=t.computed((()=>r.value?e.activeColor:e.color)),{textColorClasses:s,textColorStyles:u}=cl(i)
return Ge((()=>{var l
const o=n.isLink.value?"a":e.tag
return t.createVNode(o,{class:["v-breadcrumbs-item",{"v-breadcrumbs-item--active":r.value,"v-breadcrumbs-item--disabled":e.disabled,"v-breadcrumbs-item--link":n.isLink.value,[`${e.activeClass}`]:r.value&&e.activeClass},s.value],style:[u.value],href:n.href.value,"aria-current":r.value?"page":void 0,onClick:n.navigate},{default:()=>[(null==(l=a.default)?void 0:l.call(a))??e.title]})})),{}}}),ar=Fe()({name:"VBreadcrumbs",props:{activeClass:String,activeColor:String,bgColor:String,color:String,disabled:Boolean,divider:{type:String,default:"/"},icon:Ll,items:{type:Array,default:()=>[]},...yl(),...il(),...tl({tag:"ul"})},setup(e,l){let{slots:a}=l
const{backgroundColorClasses:o,backgroundColorStyles:n}=dl(t.toRef(e,"bgColor")),{densityClasses:r}=bl(e),{roundedClasses:i}=sl(e)
...
return t.createVNode(e.tag,{class:["v-breadcrumbs",o.value,r.value,i.value],style:n.value},{default:()=>[s&&t.createVNode(Ct,{key:"prepend",defaults:{VIcon:{icon:e.icon,start:!0}}},{default:()=>[t.createVNode("div",{class:"v-breadcrumbs__prepend"},[a.prepend?a.prepend():e.icon&&t.createVNode(Xl,null,null)])]}),e.items.map(((l,o,n)=>{var r
...
return t.createVNode("div",{class:"v-card-actions"},[null==(e=a.default)?void 0:e.call(a)])})),{}}}),nr=De("v-card-subtitle"),rr=De("v-card-title"),ir=t.defineComponent({name:"VCardItem",props:{appendAvatar:String,appendIcon:Ll,prependAvatar:String,prependIcon:Ll,subtitle:String,title:String,...yl()},setup(e,l){let{slots:a}=l
...
return t.createVNode("div",{class:"v-card-item"},[s&&t.createVNode(Ct,{key:"prepend",defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},{default:()=>[t.createVNode("div",{class:"v-card-item__prepend"},[(null==(l=a.prepend)?void 0:l.call(a))??t.createVNode(uo,null,null)])]}),t.createVNode("div",{class:"v-card-item__content"},[c&&t.createVNode(rr,{key:"title"},{default:()=>[(null==(o=a.title)?void 0:o.call(a))??e.title]}),d&&t.createVNode(nr,{key:"subtitle"},{default:()=>[(null==(n=a.subtitle)?void 0:n.call(a))??e.subtitle]}),null==(r=a.default)?void 0:r.call(a)]),u&&t.createVNode(Ct,{key:"append",defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},{default:()=>[t.createVNode("div",{class:"v-card-item__append"},[(null==(i=a.append)?void 0:i.call(a))??t.createVNode(uo,null,null)])]})])})),{}}}),sr=De("v-card-text"),ur=ze({name:"VCard",directives:{Ripple:pa},props:{appendAvatar:String,appendIcon:Ll,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Ll,ripple:Boolean,subtitle:String,text:String,title:String,...dt(),...al(),...yl(),...Xt(),...nl(),...ma(),...ba(),...wa(),...il(),...Na(),...tl(),...wl({variant:"elevated"})},setup(e,l){let{attrs:a,slots:o}=l
const{themeClasses:n}=ft(e),{borderClasses:r}=ol(e),{colorClasses:i,colorStyles:s,variantClasses:u}=kl(e),{densityClasses:c}=bl(e),{dimensionStyles:d}=Gt(e),{elevationClasses:v}=rl(e),{loaderClasses:p}=ga(e),{locationStyles:f}=Va(e),{positionClasses:m}=ka(e),{roundedClasses:g}=sl(e),h=Ca(e,a),y=t.computed((()=>!1!==e.link&&h.isLink.value)),b=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||h.isClickable.value)))
return Ge((()=>{var l,a,V
...
return t.withDirectives(t.createVNode(S,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value],style:[s.value,d.value,f.value],href:h.href.value,onClick:b.value&&h.navigate},{default:()=>[_&&t.createVNode(Ct,{key:"image",defaults:{VImg:{cover:!0,src:e.image}}},{default:()=>[t.createVNode("div",{class:"v-card__image"},[(null==(l=o.image)?void 0:l.call(o))??t.createVNode(el,null,null)])]}),t.createVNode(ha,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),B&&t.createVNode(ir,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),I&&t.createVNode(sr,{key:"text"},{default:()=>[(null==(a=o.text)?void 0:a.call(o))??e.text]}),null==(V=o.default)?void 0:V.call(o),o.actions&&t.createVNode(or,null,{default:o.actions}),Sl(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value]])})),{}}})
...
const{themeClasses:o}=ft(e),{isRtl:n}=kt(),{t:r}=Ta(),i=Bl(e,mr),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.ref(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.ref(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
l.push(m.value?a.prev?a.prev({props:o}):t.createVNode(Ba,o,null):t.createVNode("div",null,null))
...
return l.push(g.value?a.next?a.next({props:s}):t.createVNode(Ba,s,null):t.createVNode("div",null,null)),l})),V=t.computed((()=>{if(!1===e.touch)return e.touch
...
return!!s.value&&{name:"string"!=typeof t?o.transition.value:t,onBeforeEnter:c,onAfterEnter:u,onEnterCancelled:d,onBeforeLeave:c,onAfterLeave:u,onLeaveCancelled:d,onEnter:v}})),{hasContent:f}=Jo(e,n.isSelected)
return Ge((()=>{var e
return t.createVNode(Qt,{transition:r.value&&p.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value]},[f.value&&(null==(e=a.default)?void 0:e.call(a))]),[[t.vShow,n.isSelected.value]])]})})),{}}}),br=ze({name:"VCarousel",props:{color:String,cycle:Boolean,delimiterIcon:{type:Ll,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>e>0},modelValue:null,progress:[Boolean,String],showArrows:{type:[Boolean,String],default:!0,validator:e=>"boolean"==typeof e||"hover"===e},verticalDelimiters:[Boolean,String]},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=ml(e,"modelValue"),{t:n}=Ta(),r=t.ref()
let i=-1
...
return Ge((()=>{var l
return t.createVNode("div",{class:"v-color-picker-edit"},[null==(l=n.value)?void 0:l.map((e=>t.createVNode(Ar,e,null))),o.value.length>1&&t.createVNode(Ba,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
...
return x(isNaN(t)?0:t,0,100)},M=t.computed((()=>l.ticks?Array.isArray(l.ticks)?l.ticks.map((e=>({value:e,position:O(e),label:e.toString()}))):Object.keys(l.ticks).map((e=>({value:parseInt(e,10),position:O(parseInt(e,10)),label:l.ticks[e]}))):h.value!==1/0?m(h.value+1).map((e=>{const t=u.value+e*d.value
...
return t.provide(Rr,F),F},Or=ze({name:"VSliderThumb",directives:{Ripple:pa},props:{focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0}},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a,emit:o}=l
const n=t.inject(Rr)
...
return null==(e=o.value)?void 0:e.$el}}),m=ml(e,"modelValue",void 0,(e=>{const t="string"==typeof e?parseFloat(e):null==e?n.value:e
return s(t)})),{isFocused:g,focus:h,blur:y}=$n(e),b=t.computed((()=>v(m.value)))
return Ge((()=>{const[l,s]=Ja(e)
return t.createVNode(Za,t.mergeProps({class:["v-slider",{"v-slider--has-labels":!!a["tick-label"]||p.value,"v-slider--focused":g.value,"v-slider--pressed":i.value,"v-slider--disabled":e.disabled}]},l,{focused:g.value}),{...a,default:l=>{let{id:i}=l
...
const{t:n}=Ta(),r=t.ref(),i=t.ref(!1),s=t.ref(!0),u=ml(e,"menu"),c=t.ref(-1),d=t.computed((()=>{var e
return null==(e=r.value)?void 0:e.color})),{items:v,transformIn:p,transformOut:f}=zo(e),{textColorClasses:m,textColorStyles:g}=cl(d),h=ml(e,"modelValue",[],(e=>p(k(e||[]))),(t=>{const l=f(t)
return e.multiple?l:l[0]??null})),y=t.ref(""),b=t.computed({get:()=>y.value,set:t=>{var l
if(y.value=t,e.multiple||(h.value=[Oo(e,t)]),t&&e.multiple&&null!=(l=e.delimiters)&&l.length){const l=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
l.length>1&&(l.forEach((t=>{(t=t.trim())&&I(Oo(e,t))})),y.value="")}t||(c.value=-1),i.value&&(u.value=!0),s.value=!t}})
...
const e=c.value+1
S.value[e]?c.value=e:(c.value=-1,r.value.setSelectionRange(0,0))}"Enter"===l.key&&(I(Oo(e,b.value)),b.value="")}}function B(){i.value&&(s.value=!0)}function I(l){if(e.multiple){const e=w.value.findIndex((e=>e===l.value))
...
h.value=[...h.value,Oo(e,b.value)],b.value=""}})),Ge((()=>{const l=!(!e.chips&&!o.chip)
return t.createVNode(On,{ref:r,modelValue:b.value,"onUpdate:modelValue":[e=>b.value=e,e=>{null==e&&(h.value=[])}],validationValue:e.modelValue??h.value,dirty:h.value.length>0,class:["v-combobox",{"v-combobox--active-menu":u.value,"v-combobox--chips":!!e.chips,"v-combobox--selecting-index":c.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0}],appendInnerIcon:e.items.length?e.menuIcon:void 0,readonly:e.readonly,"onClick:clear":C,"onClick:control":N,"onClick:input":N,onFocus:()=>i.value=!0,onBlur:()=>i.value=!1,onKeydown:_},{...o,default:()=>{var a
return t.createVNode(t.Fragment,null,[t.createVNode(_n,t.mergeProps({modelValue:u.value,"onUpdate:modelValue":e=>u.value=e,activator:"parent",contentClass:"v-combobox__content",eager:e.eager,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:B},e.menuProps),{default:()=>[t.createVNode(jo,{selected:w.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault()},{default:()=>[!V.value.length&&!e.hideNoData&&((null==(a=o["no-data"])?void 0:a.call(o))??t.createVNode(Ro,{title:n(e.noDataText)},null)),V.value.map(((l,a)=>{var n
let{item:r,matches:i}=l
return(null==(n=o.item)?void 0:n.call(o,{item:r,index:a,props:t.mergeProps(r.props,{onClick:()=>I(r)})}))??t.createVNode(Ro,t.mergeProps({key:a},r.props,{onClick:()=>I(r)}),{prepend:l=>{let{isSelected:a}=l
return e.multiple&&!e.hideSelected?t.createVNode(ro,{modelValue:a,ripple:!1},null):void 0},title:()=>{var e
...
return t.createVNode("div",{key:n,class:["v-combobox__selection",n===c.value&&["v-combobox__selection--selected",m.value]],style:n===c.value?g.value:{}},[l?t.createVNode(Ct,{defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[o.chip?o.chip({item:a,index:n,props:r}):t.createVNode(po,r,null)]}):o.selection?o.selection({item:a,index:n}):t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&n<S.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))])}})})),Cn({isFocused:i,isPristine:s,menu:u,search:b,selectionIndex:c,filteredItems:V,select:I},r)}}),vi=Fe()({name:"VDialog",inheritAttrs:!1,props:{fullscreen:Boolean,origin:{type:String,default:"center center"},retainFocus:{type:Boolean,default:!0},scrollable:Boolean,modelValue:Boolean,...Xt({width:"auto"}),...Jt({transition:{component:It}})},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:o,slots:n}=a
const r=ml(e,"modelValue"),{dimensionStyles:i}=Gt(e),{scopeId:s}=Nn(),u=t.ref()
function c(e){var t,l
const a=e.relatedTarget,o=e.target
if(a!==o&&null!=(t=u.value)&&t.contentEl&&null!=(l=u.value)&&l.globalTop&&![document,u.value.contentEl].includes(o)&&!u.value.contentEl.contains(o)){const e=[...u.value.contentEl.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])')].filter((e=>!e.hasAttribute("disabled")))
if(!e.length)return
const t=e[0],l=e[e.length-1]
a===t?l.focus():t.focus()}}return l&&t.watch((()=>r.value&&e.retainFocus),(e=>{e?document.addEventListener("focusin",c):document.removeEventListener("focusin",c)}),{immediate:!0}),t.watch(r,(async e=>{var l,a;(await t.nextTick(),e)?null==(l=u.value.contentEl)||l.focus({preventScroll:!0}):null==(a=u.value.activatorEl)||a.focus({preventScroll:!0})})),Ge((()=>t.createVNode(kn,t.mergeProps({modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable}],style:i.value,transition:e.transition,scrollStrategy:"block",ref:u,"aria-role":"dialog","aria-modal":"true",activatorProps:{"aria-haspopup":"dialog","aria-expanded":String(r.value)},"z-index":2400},s,o),{default:n.default,activator:n.activator}))),Cn({},u)}}),pi=Symbol.for("vuetify:v-expansion-panel"),fi=["default","accordion","inset","popout"],mi=ze({name:"VExpansionPanels",props:{color:String,variant:{type:String,default:"default",validator:e=>fi.includes(e)},readonly:Boolean,...Cl(),...tl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
Bl(e,pi)
const{themeClasses:o}=ft(e),n=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return Oe({VExpansionPanel:{color:t.toRef(e,"color")},VExpansionPanelTitle:{readonly:t.toRef(e,"readonly")}}),Ge((()=>t.createVNode(e.tag,{class:["v-expansion-panels",o.value,n.value]},a))),{}}}),gi=Xe({color:String,expandIcon:{type:Ll,default:"$expand"},collapseIcon:{type:Ll,default:"$collapse"},hideActions:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean}),hi=ze({name:"VExpansionPanelTitle",directives:{Ripple:pa},props:{...gi()},setup(e,l){let{slots:a}=l
const o=t.inject(pi)
...
null==(t=g.value)||t.click(),o("click:control",e)}function S(l){l.stopPropagation(),y(),t.nextTick((()=>{i.value=[],null!=g&&g.value&&(g.value.value=""),z(e["onClick:clear"],l)}))}return Ge((()=>{const l=!(!n.counter&&!e.counter),o=!(!l&&!n.details),[r,s]=w(a),[{modelValue:k,...x}]=Ja(e),[C]=Ln(e)
return t.createVNode(Za,t.mergeProps({ref:p,modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,class:"v-file-input","onClick:prepend":b,"onClick:append":e["onClick:append"]},r,x,{messages:h.value}),{...n,default:l=>{let{isDisabled:a,isDirty:o,isReadonly:r,isValid:v}=l
...
const t=e.target
i.value=[...t.files??[]]},onFocus:y,onBlur:()=>m.value=!1},v,s),null),i.value.length>0&&t.createVNode("div",{class:o},[n.selection?n.selection({fileNames:d.value,totalBytes:u.value,totalBytesReadable:c.value}):e.chips?d.value.map((l=>t.createVNode(po,{key:l,size:"small",color:e.color},{default:()=>[l]}))):d.value.join(", ")])])}})},details:o?e=>{var a
...
return Ge((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",o.value,n.value,s.value,u.value,c.value],style:[i,e.app?f.value:void 0]},a))),{}}}),wi=ze({name:"VForm",props:{...Ua()},emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,l){let{slots:a,emit:o}=l
const n=function(e){const l=ml(e,"modelValue"),a=t.computed((()=>e.disabled)),o=t.computed((()=>e.readonly)),n=t.ref(!1),r=t.ref([]),i=t.ref([])
return t.watch(r,(()=>{let e=0,t=0
const a=[]
for(const l of r.value)!1===l.isValid?(t++,a.push({id:l.id,errorMessages:l.errorMessages})):!0===l.isValid&&e++
i.value=a,l.value=!(t>0)&&(e===r.value.length||null)}),{deep:!0}),t.provide(Wa,{register:e=>{let{id:t,validate:l,reset:a,resetValidation:o}=e
...
return()=>{var l
return t.h(e.tag,{class:["v-row",o.value]},null==(l=a.default)?void 0:l.call(a))}}}),qi=De("flex-grow-1","div","VSpacer"),Ki=ze({name:"VHover",props:{disabled:Boolean,modelValue:{type:Boolean,default:void 0},...Yo()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:l}=t
const a=ml(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Xo(e,(t=>!e.disabled&&(a.value=t)))
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,{isHovering:a.value,props:{onMouseenter:o,onMouseleave:n}})}}}),Zi=Symbol.for("vuetify:v-item-group"),Ji=ze({name:"VItemGroup",props:{...Cl({selectedClass:"v-item--selected"}),...tl(),...dt()},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const{themeClasses:o}=ft(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Bl(e,Zi)
return()=>{var l
return t.createVNode(e.tag,{class:["v-item-group",o.value]},{default:()=>[null==(l=a.default)?void 0:l.call(a,{isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}}),Qi=Fe()({name:"VItem",props:Nl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:l}=t
const{isSelected:a,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=_l(e,Zi)
return()=>{var e
...
const{dimensionStyles:o}=Gt(e),n=ml(e,"modelValue")
...
const o=function(e){const l=t.inject(Ra)
...
const{isRtl:n}=kt(),{themeClasses:r}=ft(e),{borderClasses:i}=ol(e),{backgroundColorClasses:s,backgroundColorStyles:u}=dl(t.toRef(e,"color")),{elevationClasses:c}=rl(e),{mobile:d}=Jn(),{roundedClasses:v}=sl(e),p=xa(),f=ml(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:m}=hr(),h=t.ref(),y=t.ref(!1),b=t.computed((()=>e.rail&&e.expandOnHover&&y.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),V=t.computed((()=>H(e.location,n.value))),S=t.computed((()=>!e.permanent&&(d.value||e.temporary))),w=t.computed((()=>e.sticky&&!S.value&&"bottom"!==V.value))
...
const ps=ze({name:"VPagination",props:{activeColor:String,start:{type:[Number,String],default:1},modelValue:{type:Number,default:e=>e.start},disabled:Boolean,length:{type:[Number,String],default:1,validator:e=>e%1==0},totalVisible:[Number,String],firstIcon:{type:Ll,default:"$first"},prevIcon:{type:Ll,default:"$prev"},nextIcon:{type:Ll,default:"$next"},lastIcon:{type:Ll,default:"$last"},ariaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.root"},pageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.page"},currentPageAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.currentPage"},firstAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.first"},previousAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.previous"},nextAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.next"},lastAriaLabel:{type:String,default:"$vuetify.pagination.ariaLabel.last"},ellipsis:{type:String,default:"..."},showFirstLastPage:Boolean,...al(),...yl(),...nl(),...il(),...Wl(),...tl({tag:"nav"}),...dt(),...wl({variant:"text"})},emits:{"update:modelValue":e=>!0,first:e=>!0,prev:e=>!0,next:e=>!0,last:e=>!0},setup(e,l){let{slots:a,emit:o}=l
const n=ml(e,"modelValue"),{t:i,n:s}=Ta(),{isRtl:u}=kt(),{themeClasses:c}=ft(e),d=t.ref(-1)
Oe(void 0,{scoped:!0})
const{resizeRef:v}=r((t=>{if(!t.length)return
const{target:l,contentRect:a}=t[0],o=l.querySelector(".v-pagination__list > *")
if(!o)return
const n=a.width,r=o.getBoundingClientRect().width+2*parseFloat(getComputedStyle(o).marginRight),i=e.showFirstLastPage?5:3
d.value=Math.max(0,Math.floor((n-r*i)/r))})),p=t.computed((()=>parseInt(e.length,10))),f=t.computed((()=>parseInt(e.start,10))),g=t.computed((()=>e.totalVisible?parseInt(e.totalVisible,10):d.value>=0?d.value:p.value)),h=t.computed((()=>{if(p.value<=0||isNaN(p.value)||p.value>Number.MAX_SAFE_INTEGER)return[]
...
null==(e=V.value[t])||e.$el.focus()}function C(l){l.key===b.left&&!e.disabled&&n.value>e.start?(n.value=n.value-1,t.nextTick(x)):l.key===b.right&&!e.disabled&&n.value<f.value+p.value-1&&(n.value=n.value+1,t.nextTick(x))}return Ge((()=>t.createVNode(e.tag,{ref:v,class:["v-pagination",c.value],role:"navigation","aria-label":i(e.ariaLabel),onKeydown:C,"data-test":"v-pagination-root"},{default:()=>[t.createVNode("ul",{class:"v-pagination__list"},[e.showFirstLastPage&&t.createVNode("li",{key:"first",class:"v-pagination__first","data-test":"v-pagination-first"},[a.first?a.first(k.value.first):t.createVNode(Ba,t.mergeProps({_as:"VPaginationBtn"},k.value.first),null)]),t.createVNode("li",{key:"prev",class:"v-pagination__prev","data-test":"v-pagination-prev"},[a.prev?a.prev(k.value.prev):t.createVNode(Ba,t.mergeProps({_as:"VPaginationBtn"},k.value.prev),null)]),w.value.map(((e,l)=>t.createVNode("li",{key:e.page,class:["v-pagination__item",{"v-pagination__item--is-active":e.isActive}],"data-test":"v-pagination-item"},[a.item?a.item(e):t.createVNode(Ba,t.mergeProps({_as:"VPaginationBtn"},e.props),{default:()=>[e.page]})]))),t.createVNode("li",{key:"next",class:"v-pagination__next","data-test":"v-pagination-next"},[a.next?a.next(k.value.next):t.createVNode(Ba,t.mergeProps({_as:"VPaginationBtn"},k.value.next),null)]),e.showFirstLastPage&&t.createVNode("li",{key:"last",class:"v-pagination__last","data-test":"v-pagination-last"},[a.last?a.last(k.value.last):t.createVNode(Ba,t.mergeProps({_as:"VPaginationBtn"},k.value.last),null)])])]}))),{}}})
const fs=ze({name:"VParallax",props:{scale:{type:[Number,String],default:1.3}},setup(e,l){let{slots:a}=l
const{intersectionRef:o,isIntersecting:n}=Gl(),r=t.ref()
let i
t.watchEffect((()=>{var e
...
var d
l.style.setProperty("transform",`translateY(${c}px) scale(${e.scale})`)})))}return Ge((()=>t.createVNode(el,{class:["v-parallax",{"v-parallax--active":n.value}],ref:r,cover:!0,onLoadstart:u,onLoad:u},a))),{}}}),ms=ze({name:"VRadio",props:{...lo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},setup(e,l){let{slots:a}=l
return Ge((()=>t.createVNode(ao,t.mergeProps(e,{class:"v-radio",type:"radio"}),a))),{}}}),gs=ze({name:"VRadioGroup",inheritAttrs:!1,props:{height:{type:[Number,String],default:"auto"},...Ka(),...lo(),trueIcon:{type:Ll,default:"$radioOn"},falseIcon:{type:Ll,default:"$radioOff"},type:{type:String,default:"radio"}},emits:{"update:modelValue":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const n=Re(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=ml(e,"modelValue")
return Oe({VRadio:{color:t.toRef(e,"color"),density:t.toRef(e,"density")}}),Ge((()=>{const[l,n]=w(a),[s,u]=Ja(e),[c,d]=oo(e),v=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
return t.createVNode(Za,t.mergeProps({class:"v-radio-group"},l,s,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,id:r.value}),{...o,default:l=>{let{id:a,isDisabled:r,isReadonly:s}=l
return t.createVNode(t.Fragment,null,[v&&t.createVNode(Qa,{for:a.value},{default:()=>[v]}),t.createVNode(to,t.mergeProps(c,{id:a.value,trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:r.value,readonly:s.value},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),hs=ze({name:"VRangeSlider",props:{...In(),...Ka(),...Tr(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
...
return u<=n?n=Math.max(u-v,0):c<=d&&(n=Math.min(n-(c-d-v),a-l)),n}const Ss=Symbol.for("vuetify:v-slide-group"),ws=ze({name:"VSlideGroup",props:{centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:Ss},nextIcon:{type:Ll,default:"$next"},prevIcon:{type:Ll,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...tl(),...Cl({selectedClass:"v-slide-group-item--active"})},emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:o}=a
const{isRtl:n}=kt(),{mobile:i}=Jn(),s=Bl(e,e.symbol),u=t.ref(!1),c=t.ref(0),d=t.ref(0),v=t.ref(0),p=t.computed((()=>"horizontal"===e.direction)),{resizeRef:f,contentRect:m}=r(),{resizeRef:g,contentRect:h}=r(),y=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[0])):-1)),b=t.computed((()=>s.selected.value.length?s.items.value.findIndex((e=>e.id===s.selected.value[s.selected.value.length-1])):-1))
if(l){let l=-1
...
return Ge((()=>{var l,a,r
return t.createVNode(e.tag,{class:["v-slide-group",{"v-slide-group--vertical":!p.value,"v-slide-group--has-affixes":O.value,"v-slide-group--is-overflowing":u.value}],tabindex:B.value||s.selected.value.length?-1:0,onFocus:A},{default:()=>[O.value&&t.createVNode("div",{key:"prev",class:["v-slide-group__prev",{"v-slide-group__prev--disabled":!M.value}],onClick:()=>L("prev")},[(null==(l=o.prev)?void 0:l.call(o,P.value))??t.createVNode(Tt,null,{default:()=>[t.createVNode(Xl,{icon:n.value?e.nextIcon:e.prevIcon},null)]})]),t.createVNode("div",{key:"container",ref:f,class:"v-slide-group__container",onScroll:_},[t.createVNode("div",{ref:g,class:"v-slide-group__content",style:T.value,onTouchstartPassive:k,onTouchmovePassive:C,onTouchendPassive:N,onFocusin:I,onFocusout:$,onKeydown:E},[null==(a=o.default)?void 0:a.call(o,P.value)])]),O.value&&t.createVNode("div",{key:"next",class:["v-slide-group__next",{"v-slide-group__next--disabled":!z.value}],onClick:()=>L("next")},[(null==(r=o.next)?void 0:r.call(o,P.value))??t.createVNode(Tt,null,{default:()=>[t.createVNode(Xl,{icon:n.value?e.prevIcon:e.nextIcon},null)]})])]})})),{selected:s.selected,scrollTo:L,scrollOffset:c,focus:R}}}),ks=ze({name:"VSlideGroupItem",props:{...Nl()},emits:{"group:selected":e=>!0},setup(e,t){let{slots:l}=t
const a=_l(e,Ss)
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,{isSelected:a.isSelected.value,select:a.select,toggle:a.toggle,selectedClass:a.selectedClass.value})}}}),xs=ze({name:"VSnackbar",props:{contentClass:{type:String,default:""},multiLine:Boolean,timeout:{type:[Number,String],default:5e3},vertical:Boolean,modelValue:Boolean,...ba({location:"bottom"}),...wa(),...il(),...wl(),...Jt({transition:"v-snackbar-transition"})},emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:a}=l
const o=ml(e,"modelValue"),{locationStyles:n}=Va(e),{positionClasses:r}=ka(e),{scopeId:i}=Nn(),{colorClasses:s,colorStyles:u,variantClasses:c}=kl(e),{roundedClasses:d}=sl(e),v=t.ref()
t.watch(o,f),t.watch((()=>e.timeout),f),t.onMounted((()=>{o.value&&f()}))
let p=-1
function f(){window.clearTimeout(p)
const t=Number(e.timeout)
o.value&&-1!==t&&(p=window.setTimeout((()=>{o.value=!1}),t))}function m(){window.clearTimeout(p)}return Ge((()=>t.createVNode(kn,t.mergeProps({modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,ref:v,class:["v-snackbar",{"v-snackbar--active":o.value,"v-snackbar--multi-line":e.multiLine&&!e.vertical,"v-snackbar--vertical":e.vertical},r.value],style:[u.value],contentProps:{style:n.value},contentClass:e.contentClass,persistent:!0,noClickAnimation:!0,scrim:!1,scrollStrategy:"none",transition:e.transition},i),{default:()=>[t.createVNode("div",{class:["v-snackbar__wrapper",s.value,d.value,c.value],onPointerenter:m,onPointerleave:f},[Sl(!1,"v-snackbar"),a.default&&t.createVNode("div",{class:"v-snackbar__content",role:"status","aria-live":"polite"},[a.default()]),a.actions&&t.createVNode(Ct,{defaults:{VBtn:{variant:"text",ripple:!1}}},{default:()=>[t.createVNode("div",{class:"v-snackbar__actions"},[a.actions()])]})])],activator:a.activator}))),Cn({},v)}}),Cs=ze({name:"VSwitch",inheritAttrs:!1,props:{indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...Ka(),...lo()},emits:{"update:indeterminate":e=>!0},setup(e,l){let{attrs:a,slots:o}=l
const n=ml(e,"indeterminate"),{loaderClasses:r}=ga(e),i=t.computed((()=>"string"==typeof e.loading&&""!==e.loading?e.loading:e.color)),s=Re(),u=t.computed((()=>e.id||`switch-${s}`))
function c(){n.value&&(n.value=!1)}return Ge((()=>{const[l,s]=w(a),[d,v]=Ja(e),[p,f]=oo(e),m=t.ref()
function g(){var e,t
null==(e=m.value)||null==(t=e.input)||t.click()}return t.createVNode(Za,t.mergeProps({class:["v-switch",{"v-switch--inset":e.inset},{"v-switch--indeterminate":n.value},r.value]},l,d,{id:u.value}),{...o,default:l=>{let{id:a,isDisabled:r,isReadonly:u,isValid:d}=l
return t.createVNode(ao,t.mergeProps({ref:m},p,{id:a.value,type:"checkbox","onUpdate:modelValue":c,"aria-checked":n.value?"mixed":void 0,disabled:r.value,readonly:u.value},s),{...o,default:()=>t.createVNode("div",{class:"v-switch__track",onClick:g},null),input:l=>{let{textColorClasses:a}=l
return t.createVNode("div",{class:["v-switch__thumb",a.value]},[e.loading&&t.createVNode(ha,{name:"v-switch",active:!0,color:!1===d.value?void 0:i.value},{default:e=>o.loader?o.loader(e):t.createVNode(ql,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)})])}})}})})),{}}}),Ns=ze({name:"VSystemBar",props:{color:String,height:[Number,String],window:Boolean,...nl(),...Je(),...il(),...tl(),...dt()},setup(e,l){let{slots:a}=l
...
return Ge((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value],style:[r.value,c.value]},a))),{}}}),_s=Symbol.for("vuetify:v-tabs"),Bs=ze({name:"VTab",props:{fixed:Boolean,icon:[Boolean,String,Function,Object],prependIcon:Ll,appendIcon:Ll,stacked:Boolean,title:String,ripple:{type:Boolean,default:!0},color:String,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...tl(),...Na(),...Nl({selectedClass:"v-tab--selected"}),...dt()},setup(e,l){let{slots:a,attrs:o}=l
...
null==(e=N)||e.disconnect()})),Ge((()=>{const l=!!(n.counter||e.counter||e.counterValue),o=!(!l&&!n.details),[g,x]=w(a),[{modelValue:C,...N}]=Ja(e),[_]=Ln(e)
return t.createVNode(Za,t.mergeProps({ref:c,modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-textarea v-text-field",{"v-textarea--prefixed":e.prefix,"v-textarea--suffixed":e.suffix,"v-text-field--prefixed":e.prefix,"v-text-field--suffixed":e.suffix,"v-textarea--auto-grow":e.autoGrow,"v-textarea--no-resize":e.noResize||e.autoGrow}],"onClick:prepend":e["onClick:prepend"],"onClick:append":e["onClick:append"]},g,N,{messages:h.value}),{...n,default:l=>{let{isDisabled:a,isDirty:o,isReadonly:i,isValid:s}=l
...
case"end":return t[1]
default:return null}}))
return Ge((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,i.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,r.value],style:{"--v-timeline-line-thickness":g(e.lineThickness)}},a))),{}}}),Ls=ze({name:"VTimelineDivider",props:{dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:Ll,iconColor:String,lineColor:String,...il(),...Wl(),...nl()},setup(e,l){let{slots:a}=l
const{sizeClasses:o,sizeStyles:n}=Ul(e,"v-timeline-divider__dot"),{backgroundColorStyles:r,backgroundColorClasses:i}=dl(t.toRef(e,"dotColor")),{roundedClasses:s}=sl(e,"v-timeline-divider__dot"),{elevationClasses:u}=rl(e),{backgroundColorClasses:c,backgroundColorStyles:d}=dl(t.toRef(e,"lineColor"))
return Oe({VIcon:{color:t.toRef(e,"iconColor"),icon:t.toRef(e,"icon"),size:t.toRef(e,"size")}}),Ge((()=>{var l
return t.createVNode("div",{class:["v-timeline-divider",{"v-timeline-divider--fill-dot":e.fillDot}]},[t.createVNode("div",{class:["v-timeline-divider__before",c.value],style:d.value},null),!e.hideDot&&t.createVNode("div",{key:"dot",class:["v-timeline-divider__dot",u.value,s.value,o.value],style:n.value},[t.createVNode("div",{class:["v-timeline-divider__inner-dot",i.value,s.value],style:r.value},[(null==(l=a.default)?void 0:l.call(a))??(e.icon?t.createVNode(Xl,null,null):void 0)])]),t.createVNode("div",{class:["v-timeline-divider__after",c.value],style:d.value},null)])})),{}}}),Ts=ze({name:"VTimelineItem",props:{density:String,dotColor:String,fillDot:Boolean,hideDot:Boolean,hideOpposite:{type:Boolean,default:void 0},icon:Ll,iconColor:String,lineInset:[Number,String],...il(),...nl(),...Wl(),...tl(),...Xt()},setup(e,l){let{slots:a}=l
...
return(null==(t=o.default)?void 0:t.call(o,...a))??e.text}}))),Cn({},u)}}),Os=ze({name:"VValidation",props:{...Xa()},emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:l}=t
const a=Ga(e,"validation")
return()=>{var e
return null==(e=l.default)?void 0:e.call(l,a)}}})
var Ms=Object.freeze({__proto__:null,VApp:xt,VAppBar:gl,VAppBarNavIcon:Ia,VAppBarTitle:Aa,VAlert:ja,VAlertTitle:Ea,VAutocomplete:Hn,VAvatar:uo,VBadge:Wn,VBanner:Qn,VBannerActions:Un,VBannerText:Yn,VBottomNavigation:er,VBreadcrumbs:ar,VBreadcrumbsItem:lr,VBreadcrumbsDivider:tr,VBtn:Ba,VBtnGroup:xl,VBtnToggle:Al,VCard:ur,VCardActions:or,VCardItem:ir,VCardSubtitle:nr,VCardText:sr,VCardTitle:rr,VCarousel:br,VCarouselItem:Vr,VCheckbox:io,VCheckboxBtn:ro,VChip:po,VChipGroup:vo,VCode:Sr,VColorPicker:ci,VCombobox:di,VCounter:Tn,VDefaultsProvider:Ct,VDialog:vi,VDivider:fo,VExpansionPanels:mi,VExpansionPanel:bi,VExpansionPanelText:yi,VExpansionPanelTitle:hi,VField:Rn,VFieldLabel:Bn,VFileInput:Vi,VFooter:Si,VForm:wi,VContainer:ki,VCol:Ai,VRow:Gi,VSpacer:qi,VHover:Ki,VIcon:Xl,VComponentIcon:Ol,VSvgIcon:Ml,VLigatureIcon:zl,VClassIcon:Fl,VImg:el,VInput:Za,VItemGroup:Ji,VItem:Qi,VKbd:es,VLabel:Qa,VLayout:ts,VLayoutItem:ls,VLazy:as,VList:jo,VListGroup:$o,VListImg:Ho,VListItem:Ro,VListItemAction:Wo,VListItemMedia:Uo,VListItemSubtitle:Ao,VListItemTitle:Eo,VListSubheader:Lo,VLocaleProvider:os,VMain:ns,VMenu:_n,VMessages:Ha,VNavigationDrawer:ds,VNoSsr:vs,VOverlay:kn,VPagination:ps,VParallax:fs,VProgressCircular:ql,VProgressLinear:fa,VRadio:ms,VRadioGroup:gs,VRangeSlider:hs,VRating:ys,VResponsive:qt,VSelect:zn,VSelectionControl:ao,VSelectionControlGroup:to,VSheet:ui,VSlideGroup:ws,VSlideGroupItem:ks,VSlider:zr,VSnackbar:xs,VSwitch:Cs,VSystemBar:Ns,VTabs:Is,VTab:Bs,VTable:$s,VTextarea:As,VTextField:On,VThemeProvider:Es,VTimeline:Rs,VTimelineItem:Ts,VToolbar:fl,VToolbarTitle:ll,VToolbarItems:$a,VTooltip:Ps,VValidation:Os,VWindow:gr,VWindowItem:yr,VDialogTransition:It,VFabTransition:Et,VDialogBottomTransition:Rt,VDialogTopTransition:Lt,VFadeTransition:Tt,VScaleTransition:Pt,VScrollXTransition:Ot,VScrollXReverseTransition:Mt,VScrollYTransition:zt,VScrollYReverseTransition:Ft,VSlideXTransition:Dt,VSlideXReverseTransition:jt,VSlideYTransition:Ht,VSlideYReverseTransition:Wt,VExpandTransition:Ut,VExpandXTransition:Yt})
...
var Us=Object.freeze({__proto__:null,ClickOutside:Sn,Intersect:Zt,Mutate:Fs,Resize:Ds,Ripple:pa,Scroll:Ws,Touch:pr})
...
for(const e in i)a.component(e,ze({...i[e],name:e}))
function c(e){a.provide(Le,Te(r.defaults)),a.provide(Xn,Zn(r.display,e)),a.provide(ct,pt(a,r.theme)),a.provide(Tl,jl(r.icons)),a.provide(Ra,Pa(a,r.locale))}l||c(),Re.reset()
const d=a.mount
...
const o=d(e,t,l)
return a.mount=d,o},a.mixin({computed:{$vuetify(){return t.reactive({defaults:v.call(this,Le),display:v.call(this,Xn),theme:v.call(this,ct),icons:v.call(this,Tl),locale:v.call(this,Ra),rtl:v.call(this,Vt)})}}})}
return{install:a}}
Ys.version="3.0.0-beta.10"
const Xs=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return Ys({components:Ms,directives:Us,...e})},Gs="3.0.0-beta.10"
Xs.version=Gs,e.components=Ms,e.createVuetify=Xs,e.directives=Us,e.provideRtl=wt,e.useDisplay=Jn,e.useLayout=Qe,e.useLocale=Ta,e.useRtl=kt,e.useTheme=mt,e.version=Gs,Object.defineProperty(e,"__esModule",{value:!0})}))
