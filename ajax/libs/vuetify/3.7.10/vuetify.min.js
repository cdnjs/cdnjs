...
return o=void 0===o?o:o/255,{r:t,g:a,b:l,a:o}}function ct(e){return st(et(e))}function dt(e,t){const a=je(Ke(e))
return a[0]=a[0]+10*t,qe(He(a))}function vt(e,t){const a=je(Ke(e))
return a[0]=a[0]-10*t,qe(He(a))}function pt(e){return Ke(Je(e))[1]}function ft(e,t){const a=pt(e),l=pt(t)
return(Math.max(a,l)+.05)/(Math.min(a,l)+.05)}function mt(e){const t=Math.abs(Fe(Je(0),Je(e)))
return Math.abs(Fe(Je(16777215),Je(e)))>Math.min(t,50)?"#fff":"#000"}function gt(e,t){return a=>Object.keys(e).reduce(((l,o)=>{const n="object"==typeof e[o]&&null!=e[o]&&!Array.isArray(e[o])?e[o]:{type:e[o]}
...
return O(e?.aliasName||e?.name)}let Vt=0,wt=new WeakMap
...
t.provide(kt,t.computed((()=>i.value?$(e?.value??{},i.value):e?.value)))}}}function _t(e){if(e._setup=e._setup??e.setup,!e.name)return $e("The component is missing an explicit name, unable to generate default prop value"),e
if(e._setup){e.props=gt(e.props??{},e.name)()
const t=Object.keys(e.props).filter((e=>"class"!==e&&"style"!==e))
e.filterProps=function(e){return S(e,t)},e.props._as=String,e.setup=function(t,a){const l=xt()
...
function Rt(e,t,a){return Object.keys(e).filter((e=>_(e)&&e.endsWith(t))).reduce(((l,o)=>(l[o.slice(0,-t.length)]=t=>e[o](t,a(t)),l)),{})}function Tt(e){let t=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
...
const x=L(ea,V?.vnode).indexOf(e)
...
const r=yt("useProxiedModel"),i=t.ref(void 0!==e[a]?e[a]:l),s=O(a),u=s!==a?t.computed((()=>(e[a],!(!r.vnode.props?.hasOwnProperty(a)&&!r.vnode.props?.hasOwnProperty(s)||!r.vnode.props?.hasOwnProperty(`onUpdate:${a}`)&&!r.vnode.props?.hasOwnProperty(`onUpdate:${s}`))))):t.computed((()=>(e[a],!(!r.vnode.props?.hasOwnProperty(a)||!r.vnode.props?.hasOwnProperty(`onUpdate:${a}`)))))
...
return Object.defineProperty(c,"externalValue",{get:()=>u.value?e[a]:i.value}),c}var sa={badge:"Badge",open:"Open",close:"Close",dismiss:"Dismiss",confirmEdit:{ok:"OK",cancel:"Cancel"},dataIterator:{noResultsText:"No matching records found",loadingText:"Loading items..."},dataTable:{itemsPerPageText:"Rows per page:",ariaLabel:{sortDescending:"Sorted descending.",sortAscending:"Sorted ascending.",sortNone:"Not sorted.",activateNone:"Activate to remove sorting.",activateDescending:"Activate to sort descending.",activateAscending:"Activate to sort ascending."},sortBy:"Sort by"},dataFooter:{itemsPerPageText:"Items per page:",itemsPerPageAll:"All",nextPage:"Next page",prevPage:"Previous page",firstPage:"First page",lastPage:"Last page",pageText:"{0}-{1} of {2}"},dateRangeInput:{divider:"to"},datePicker:{itemsSelected:"{0} selected",range:{title:"Select dates",header:"Enter dates"},title:"Select date",header:"Enter date",input:{placeholder:"Enter date"}},noDataText:"No data available",carousel:{prev:"Previous visual",next:"Next visual",ariaLabel:{delimiter:"Carousel slide {0} of {1}"}},calendar:{moreEvents:"{0} more",today:"Today"},input:{clear:"Clear {0}",prependAction:"{0} prepended action",appendAction:"{0} appended action",otp:"Please enter OTP character {0}"},fileInput:{counter:"{0} files",counterSize:"{0} files ({1} in total)"},fileUpload:{title:"Drag and drop files here",divider:"or",browse:"Browse Files"},timePicker:{am:"AM",pm:"PM",title:"Select Time"},pagination:{ariaLabel:{root:"Pagination Navigation",next:"Next page",previous:"Previous page",page:"Go to page {0}",currentPage:"Page {0}, Current page",first:"First page",last:"Last page"}},stepper:{next:"Next",prev:"Previous"},rating:{ariaLabel:{item:"Rating {0} of {1}"}},loading:"Loading...",infiniteScroll:{loadMore:"Load more",empty:"No more"}}
...
let c=d(s,i,null)
return c||($e(`Translation key "${l}" not found in "${e.value}", trying fallback locale`),c=d(u,i,null)),c||(Me(`Translation key "${l}" not found in fallback`),c=l),"string"!=typeof c&&(Me(`Translation key "${l}" has a non-string value`),c=l),ca(c,n)}
...
l.push(`--v-theme-${o}: ${e.r},${e.g},${e.b}`),o.startsWith("on-")||l.push(`--v-theme-${o}-overlay-multiplier: ${pt(n)>.18?t:a}`)}for(const[t,a]of Object.entries(e.variables)){const e="string"==typeof a&&a.startsWith("#")?Je(a):void 0,o=e?`${e.r}, ${e.g}, ${e.b}`:void 0
...
Ma(t)?.forEach((e=>{he(e,[{opacity:0},{opacity:0,offset:.33},{}],{duration:450*i,easing:At})})),s.finished.then((()=>a()))},onAfterEnter(e){e.style.removeProperty("pointer-events")},onBeforeLeave(e){e.style.pointerEvents="none"},async onLeave(t,a){await new Promise((e=>requestAnimationFrame(e)))
const{x:l,y:o,sx:n,sy:r,speed:i}=Oa(e.target,t)
he(t,[{},{transform:`translate(${l}px, ${o}px) scale(${n}, ${r})`,opacity:0}],{duration:125*i,easing:"cubic-bezier(0.4, 0, 1, 1)"}).finished.then((()=>a())),Ma(t)?.forEach((e=>{he(e,[{},{opacity:0,offset:.2},{opacity:0}],{duration:250*i,easing:At})}))},onAfterLeave(e){e.style.removeProperty("pointer-events")}}
return()=>e.target?t.createVNode(t.Transition,t.mergeProps({name:"dialog-transition"},o,{css:!1}),l):t.createVNode(t.Transition,{name:"dialog-transition"},l)}})
function Ma(e){const t=e.querySelector(":scope > .v-card, :scope > .v-sheet, :scope > .v-list")?.children
return t&&[...t]}function Oa(e,t){const a=me(e),l=ge(t),[o,n]=getComputedStyle(t).transformOrigin.split(" ").map((e=>parseFloat(e))),[r,i]=getComputedStyle(t).getPropertyValue("--v-overlay-anchor-origin").split(" ")
...
function il(e){return W((()=>{const t=[],a={}
...
var l
return e.value.text&&(Xe(e.value.text)?(a.color=e.value.text,a.caretColor=e.value.text):t.push(`text-${e.value.text}`)),{colorClasses:t,colorStyles:a}}))}function sl(e,a){const l=t.computed((()=>({text:t.isRef(e)?e.value:a?e[a]:null}))),{colorClasses:o,colorStyles:n}=il(l)
...
const o=t.reactive([]),n=ia(e,"modelValue",[],(e=>null==e?[]:jl(o,A(e))),(t=>{const a=function(e,t){const a=[]
...
return W((()=>{let a,l
return U(Yl,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:f(e.size),height:f(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const Kl=gt({color:String,disabled:Boolean,start:Boolean,end:Boolean,icon:Mt,...ht(),...Gl(),...Ba({tag:"i"}),...wa()},"VIcon"),Xl=It()({name:"VIcon",props:Kl(),setup(e,a){let{attrs:l,slots:o}=a
...
let o=l
if("string"==typeof o&&(o=o.trim(),o.startsWith("$")&&(o=a.aliases?.[o.slice(1)])),o||$e(`Could not find aliased icon "${l}"`),Array.isArray(o))return{component:jt,icon:o}
...
return{positionClasses:t.computed((()=>e.position?`${a}--${e.position}`:void 0))}}function vo(){return yt("useRouter")?.proxy?.$router}function po(e,a){const l=t.resolveDynamicComponent("RouterLink"),o=t.computed((()=>!(!e.href&&!e.to))),n=t.computed((()=>o?.value||q(a,"click")||q(e,"click")))
if("string"==typeof l||!("useLink"in l)){const a=t.toRef(e,"href")
return{isLink:o,isClickable:n,href:a,linkProps:t.reactive({href:a})}}const r=t.computed((()=>({...e,to:t.toRef((()=>e.to||""))}))),i=l.useLink(r.value),s=t.computed((()=>e.to?i:void 0)),u=function(){const e=yt("useRoute")
...
return{isLink:o,isClickable:n,isActive:d,route:s.value?.route,navigate:s.value?.navigate,href:v,linkProps:t.reactive({href:v,"aria-current":t.computed((()=>d.value?"page":void 0))})}}const fo=gt({href:String,replace:Boolean,to:[String,Object],exact:Boolean},"router")
let mo=!1
...
function Io(e){_o||e.keyCode!==y.enter&&e.keyCode!==y.space||(_o=!0,ko(e))}function Bo(e){_o=!1,No(e)}function Po(e){_o&&(_o=!1,No(e))}function Ao(e,t,a){const{value:l,modifiers:o}=t,n=So(l)
...
return $t((()=>{const a=x(Qo.filterProps(e),["modelValue"])
...
return t.createVNode(Xl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r,onKeydown:function(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),K(r,new PointerEvent("click",e)))}},null)}}}const an=gt({active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...ht(),...vl({transition:{component:Za,leaveAbsolute:!0,group:!0}})},"VMessages"),ln=It()({name:"VMessages",props:an(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>A(e.messages))),{textColorClasses:n,textColorStyles:r}=sl(t.computed((()=>e.color)))
return $t((()=>t.createVNode(pl,{transition:e.transition,tag:"div",class:["v-messages",n.value,e.class],style:[r.value,e.style]},{default:()=>[e.active&&o.value.map(((e,a)=>t.createVNode("div",{class:"v-messages__message",key:`${a}-${o.value}`},[l.message?l.message({message:e}):e])))]}))),{}}}),on=gt({focused:Boolean,"onUpdate:focused":G()},"focus")
...
function un(e){const a=t.inject(rn,null)
return{...a,isReadonly:t.computed((()=>!!(e?.readonly??a?.isReadonly.value))),isDisabled:t.computed((()=>!!(e?.disabled??a?.isDisabled.value)))}}const cn=gt({disabled:{type:Boolean,default:null},error:Boolean,errorMessages:{type:[Array,String],default:()=>[]},maxErrors:{type:[Number,String],default:1},name:String,label:String,readonly:{type:Boolean,default:null},rules:{type:Array,default:()=>[]},modelValue:null,validateOn:String,validationValue:null,...on()},"validation")
...
const o=ia(e,"modelValue"),n=t.computed((()=>void 0===e.validationValue?o.value:e.validationValue)),r=un(e),i=t.ref([]),s=t.shallowRef(!0),u=t.computed((()=>!(!A(""===o.value?null:o.value).length&&!A(""===n.value?null:n.value).length))),c=t.computed((()=>e.errorMessages?.length?A(e.errorMessages).concat(i.value).slice(0,Math.max(0,+e.maxErrors)):i.value)),d=t.computed((()=>{let t=(e.validateOn??r.validateOn?.value)||"input"
...
!0!==o&&(!1===o||"string"==typeof o?a.push(o||""):console.warn(`${o} is not a valid value. Rule functions must return boolean true or a string.`))}return i.value=a,p.value=!1,s.value=t,i.value}return t.onBeforeMount((()=>{r.register?.({id:g.value,vm:m,validate:b,reset:h,resetValidation:y})})),t.onBeforeUnmount((()=>{r.unregister?.(g.value)})),t.onMounted((async()=>{d.value.lazy||await b(!d.value.eager),r.update?.(g.value,v.value,c.value)})),ra((()=>d.value.input||d.value.invalidInput&&!1===v.value),(()=>{t.watch(n,(()=>{if(null!=n.value)b()
else if(e.focused){const a=t.watch((()=>e.focused),(e=>{e||b(),a()}))}}))})),ra((()=>d.value.blur),(()=>{t.watch((()=>e.focused),(e=>{e||b()}))})),t.watch([v,c],(()=>{r.update?.(g.value,v.value,c.value)})),{errorMessages:c,isDirty:u,isDisabled:r.isDisabled,isReadonly:r.isReadonly,isPristine:s,isValid:v,isValidating:p,reset:h,resetValidation:y,validate:b,validationClasses:f}}const vn=gt({id:String,appendIcon:Mt,centerAffix:{type:Boolean,default:!0},prependIcon:Mt,hideDetails:[Boolean,String],hideSpinButtons:Boolean,hint:String,persistentHint:Boolean,messages:{type:[Array,String],default:()=>[]},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},"onClick:prepend":G(),"onClick:append":G(),...ht(),...Pl(),...N(ll(),["maxWidth","minWidth","width"]),...wa(),...cn()},"VInput"),pn=It()({name:"VInput",props:{...vn()},emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,{"v-input--center-affix":e.centerAffix,"v-input--hide-spin-buttons":e.hideSpinButtons},r.value,s.value,u.value,x.value,e.class],style:[i.value,e.style]},[a&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[o.prepend?.(N.value),e.prependIcon&&t.createVNode(c,{key:"prepend-icon",name:"prepend"},null)]),o.default&&t.createVNode("div",{class:"v-input__control"},[o.default?.(N.value)]),l&&t.createVNode("div",{key:"append",class:"v-input__append"},[e.appendIcon&&t.createVNode(c,{key:"append-icon",name:"append"},null),o.append?.(N.value)]),d&&t.createVNode("div",{id:p.value,class:"v-input__details",role:"alert","aria-live":"polite"},[t.createVNode(ln,{active:n,messages:C.value},{message:o.message}),o.details?.(N.value)])])})),{reset:w,resetValidation:S,validate:k,isValid:b,errorMessages:f}}}),fn=gt({...vn(),...x(Jo(),["inline"])},"VCheckbox"),mn=It()({name:"VCheckbox",inheritAttrs:!1,props:fn(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=ia(e,"modelValue"),{isFocused:r,focus:i,blur:s}=nn(e),u=St(),c=t.computed((()=>e.id||`checkbox-${u}`))
return $t((()=>{const[a,u]=P(l),d=pn.filterProps(e),v=en.filterProps(e)
...
async function n(t,a){return In(t,$(e,a),!1,o)}return n.horizontal=async(t,a)=>In(t,$(e,a),!0,o),n}function Pn(e,t){const a=e?"scrollWidth":"scrollHeight"
...
function B(e){I||S.value||e.relatedTarget&&g.el?.contains(e.relatedTarget)||T(),I=!1}function P(){I=!0}function A(e){function t(t){e.preventDefault(),T(t)}g.el&&(p.value?"ArrowRight"===e.key?t(n.value?"prev":"next"):"ArrowLeft"===e.key&&t(n.value?"next":"prev"):"ArrowDown"===e.key?t("next"):"ArrowUp"===e.key&&t("prev"),"Home"===e.key?t("first"):"End"===e.key&&t("last"))}function R(e,t){if(!e)return
let a=e
...
return g.value&&t.withDirectives(t.createVNode(a,t.mergeProps({class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":V.value,"v-chip--filter":x,"v-chip--pill":e.pill,[`${e.activeClass}`]:e.activeClass&&y.isActive?.value},m.value,i.value,_?s.value:void 0,d.value,v.value,p.value,f.value,c.value,h?.selectedClass.value,e.class],style:[_?u.value:void 0,e.style],disabled:e.disabled||void 0,draggable:e.draggable,tabindex:V.value?0:void 0,onClick:S,onKeydown:V.value&&!b.value&&k},y.linkProps),{default:()=>[Tl(V.value,"v-chip"),x&&t.createVNode(el,{key:"filter"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?t.createVNode(al,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},n.filter):t.createVNode(Xl,{key:"filter-icon",icon:e.filterIcon},null)]),[[t.vShow,h.isSelected.value]])]}),C&&t.createVNode("div",{key:"prepend",class:"v-chip__prepend"},[n.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!N,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},n.prepend):t.createVNode(t.Fragment,null,[e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),t.createVNode("div",{class:"v-chip__content","data-no-activator":""},[n.default?.({isSelected:h?.isSelected.value,selectedClass:h?.selectedClass.value,select:h?.select,toggle:h?.toggle,value:h?.value.value,disabled:e.disabled})??e.text]),o&&t.createVNode("div",{key:"append",class:"v-chip__append"},[n.append?t.createVNode(al,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},n.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),r&&t.createVNode("button",t.mergeProps({key:"close",class:"v-chip__close",type:"button","data-testid":"close-chip"},w.value),[n.close?t.createVNode(al,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},n.close):t.createVNode(Xl,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}),[[t.resolveDirective("ripple"),V.value&&e.ripple,null]])}}}),jn=Symbol.for("vuetify:list")
...
return l}return l.delete(t),l},select:()=>null},Kn={open:qn.open,select:e=>{let{id:t,value:a,opened:l,parents:o}=e
if(!a)return l
const n=[]
let r=o.get(t)
...
return e?.length&&(o=a.in(e.slice(0,1),t,l)),o},out:(e,t,l)=>a.out(e,t,l)}},Qn=Symbol.for("vuetify:nested"),Jn={id:t.shallowRef(),root:{register:()=>null,unregister:()=>null,parents:t.ref(new Map),children:t.ref(new Map),open:()=>null,openOnSelect:()=>null,activate:()=>null,select:()=>null,activatable:t.ref(!1),selectable:t.ref(!1),opened:t.ref(new Set),activated:t.ref(new Set),selected:t.ref(new Map),selectedValues:t.ref([]),getPath:()=>[]}},er=gt({activatable:Boolean,selectable:Boolean,activeStrategy:[String,Function,Object],selectStrategy:[String,Function,Object],openStrategy:[String,Object],opened:null,activated:null,selected:null,mandatory:Boolean},"nested"),tr=e=>{let a=!1
const l=t.ref(new Map),o=t.ref(new Map),n=ia(e,"opened",e.opened,(e=>new Set(e)),(e=>[...e.values()])),r=t.computed((()=>{if("object"==typeof e.activeStrategy)return e.activeStrategy
...
const v=yt("nested"),p=new Set,f={id:t.shallowRef(),root:{opened:n,activatable:t.toRef(e,"activatable"),selectable:t.toRef(e,"selectable"),activated:u,selected:c,selectedValues:t.computed((()=>{const e=[]
...
return $t((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),sr=Bt("v-list-item-title"),ur=gt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Mt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number],title:[String,Number],value:null,onClick:G(),onClickOnce:G(),...yl(),...ht(),...Pl(),...ll(),...Vl(),...cl(),...fo(),...Ba(),...wa(),...Dl({variant:"text"})},"VListItem"),cr=It()({name:"VListItem",directives:{Ripple:To},props:ur(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
const r=po(e,l),i=t.computed((()=>void 0===e.value?r.href.value:e.value)),{activate:s,isActivated:u,select:c,isOpen:d,isSelected:v,isIndeterminate:p,isGroupActivator:f,root:m,parent:g,openOnSelect:h,id:y}=ar(i,!1),b=Wn(),V=t.computed((()=>!1!==e.active&&(e.active||r.isActive?.value||(m.activatable.value?u.value:v.value)))),w=t.computed((()=>!1!==e.link&&r.isLink.value)),S=t.computed((()=>!!b&&(m.selectable.value||m.activatable.value||null!=e.value))),k=t.computed((()=>!e.disabled&&!1!==e.link&&(e.link||r.isClickable.value||S.value))),x=t.computed((()=>e.rounded||e.nav)),N=t.computed((()=>e.color??e.activeColor)),C=t.computed((()=>({color:V.value?N.value??e.baseColor:e.baseColor,variant:e.variant})))
function _(){null!=g.value&&m.open(g.value,!0),h(!0)}t.watch((()=>r.isActive?.value),(e=>{e&&_()})),t.onBeforeMount((()=>{r.isActive?.value&&_()}))
const{themeClasses:I}=ka(e),{borderClasses:B}=bl(e),{colorClasses:P,colorStyles:A,variantClasses:R}=El(C),{densityClasses:T}=Al(e),{dimensionStyles:D}=ol(e),{elevationClasses:E}=wl(e),{roundedClasses:F}=dl(x),$=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),M=t.computed((()=>({isActive:V.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
function O(t){n("click",t),k.value&&(r.navigate?.(t),f||(m.activatable.value?s(!u.value,t):(m.selectable.value||null!=e.value)&&c(!v.value,t)))}function L(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.target.dispatchEvent(new MouseEvent("click",e)))}return $t((()=>{const a=w.value?"a":e.tag,l=o.title||null!=e.title,n=o.subtitle||null!=e.subtitle,i=!(!e.appendAvatar&&!e.appendIcon),s=!(!i&&!o.append),c=!(!e.prependAvatar&&!e.prependIcon),d=!(!c&&!o.prepend)
var p,f
return b?.updateHasPrepend(d),e.activeColor&&(p="active-color",f=["color","base-color"],f=Array.isArray(f)?f.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${f.at(-1)}'`:`'${f}'`,t.warn(`[Vuetify UPGRADE] '${p}' is deprecated, use ${f} instead.`)),t.withDirectives(t.createVNode(a,t.mergeProps({class:["v-list-item",{"v-list-item--active":V.value,"v-list-item--disabled":e.disabled,"v-list-item--link":k.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!d&&b?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&V.value},I.value,B.value,P.value,T.value,E.value,$.value,F.value,R.value,e.class],style:[A.value,D.value,e.style],tabindex:k.value?b?-2:0:void 0,"aria-selected":S.value?m.activatable.value?u.value:m.selectable.value?v.value:V.value:void 0,onClick:O,onKeydown:k.value&&!w.value&&L},r.linkProps),{default:()=>[Tl(k.value||V.value,"v-list-item"),d&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!c,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(M.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(sr,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(ir,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(M.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(al,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(M.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),k.value&&e.ripple]])})),{activate:s,isActivated:u,isGroupActivator:f,isSelected:v,list:b,select:c,root:m,id:y}}}),dr=gt({color:String,inset:Boolean,sticky:Boolean,title:String,...ht(),...Ba()},"VListSubheader"),vr=It()({name:"VListSubheader",props:dr(),setup(e,a){let{slots:l}=a
...
function yr(e,t){const a=v(t,e.itemTitle,t),l=v(t,e.itemValue,a),o=v(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?x(t,["children"]):t:v(t,e.itemProps)}
...
return t}))}}}function wr(e,t){const a=v(t,e.itemType,"item"),l=function(e){return"string"==typeof e||"number"==typeof e||"boolean"==typeof e}(t)?t:v(t,e.itemTitle),o=v(t,e.itemValue,void 0),n=v(t,e.itemChildren),r={title:l,value:o,...!0===e.itemProps?x(t,["children"]):v(t,e.itemProps)}
...
return a}const kr=gt({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,expandIcon:Mt,collapseIcon:Mt,lines:{type:[Boolean,String],default:"one"},slim:Boolean,nav:Boolean,"onClick:open":G(),"onClick:select":G(),"onUpdate:opened":G(),...er({selectStrategy:"single-leaf",openStrategy:"list"}),...yl(),...ht(),...Pl(),...ll(),...Vl(),itemType:{type:String,default:"type"},...hr(),...cl(),...Ba(),...wa(),...Dl({variant:"text"})},"VList"),xr=It()({name:"VList",props:kr(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:o}=function(e){return{items:t.computed((()=>Sr(e,e.items)))}}(e),{themeClasses:n}=ka(e),{backgroundColorClasses:r,backgroundColorStyles:i}=ul(t.toRef(e,"bgColor")),{borderClasses:s}=bl(e),{densityClasses:u}=Al(e),{dimensionStyles:c}=ol(e),{elevationClasses:d}=wl(e),{roundedClasses:v}=dl(e),{children:p,open:f,parents:m,select:g,getPath:h}=tr(e),y=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),b=t.toRef(e,"activeColor"),V=t.toRef(e,"baseColor"),w=t.toRef(e,"color")
Hn(),Nt({VListGroup:{activeColor:b,baseColor:V,color:w,expandIcon:t.toRef(e,"expandIcon"),collapseIcon:t.toRef(e,"collapseIcon")},VListItem:{activeClass:t.toRef(e,"activeClass"),activeColor:b,baseColor:V,color:w,density:t.toRef(e,"density"),disabled:t.toRef(e,"disabled"),lines:t.toRef(e,"lines"),nav:t.toRef(e,"nav"),slim:t.toRef(e,"slim"),variant:t.toRef(e,"variant")}})
const S=t.shallowRef(!1),k=t.ref()
function x(e){S.value=!0}function N(e){S.value=!1}function C(e){S.value||e.relatedTarget&&k.value?.contains(e.relatedTarget)||B()}function _(e){const t=e.target
if(k.value&&!["INPUT","TEXTAREA"].includes(t.tagName)){if("ArrowDown"===e.key)B("next")
else if("ArrowUp"===e.key)B("prev")
else if("Home"===e.key)B("first")
else{if("End"!==e.key)return
B("last")}e.preventDefault()}}function I(e){S.value=!0}function B(e){if(k.value)return Q(k.value,e)}return $t((()=>t.createVNode(e.tag,{ref:k,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},n.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled||S.value?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:x,onFocusout:N,onFocus:C,onKeydown:_,onMousedown:I},{default:()=>[t.createVNode(gr,{items:o.value,returnObject:e.returnObject},l)]}))),{open:f,select:g,focus:B,children:p,parents:m,getPath:h}}}),Nr=Bt("v-list-img"),Cr=gt({start:Boolean,end:Boolean,...ht(),...Ba()},"VListItemAction"),_r=It()({name:"VListItemAction",props:Cr(),setup(e,a){let{slots:l}=a
...
function g(e){const l=new pe(a),o=Ar(e.anchor,t),n=Ar(e.origin,l)
...
return Object.assign(l.value,{"--v-overlay-anchor-origin":`${m.anchor.side} ${m.anchor.align}`,transformOrigin:`${m.origin.side} ${m.origin.align}`,top:f(Dr(y)),left:e.isRtl.value?void 0:f(Dr(h)),right:e.isRtl.value?f(Dr(-h)):void 0,minWidth:f("y"===S?Math.min(r.value,t.width):r.value),maxWidth:f(Er(R(b.x,r.value===1/0?0:r.value,s.value))),maxHeight:f(Er(R(b.y,i.value===1/0?0:i.value,u.value)))}),{available:b,contentBox:a}}return t.watch([e.target,e.contentEl],((e,t)=>{let[a,l]=e,[o,n]=t
...
const C=le(),I=t.computed((()=>"cursor"===e.target&&g.value?g.value:C.value?C.el:qr(e.target,i)||s.value)),B=t.computed((()=>Array.isArray(I.value)?void 0:I.value))
let P
...
function i(e){e.state?.replaced||(r=!0,setTimeout((()=>r=!1)))}a&&e?.beforeEach&&(t.nextTick((()=>{window.addEventListener("popstate",i),o=e.beforeEach(((e,t,a)=>{mo?r?l(a):a():setTimeout((()=>r?l(a):a())),mo=!0})),n=e?.afterEach((()=>{mo=!1}))})),t.onScopeDispose((()=>{window.removeEventListener("popstate",i),o?.(),n?.()})))}(L,(t=>{V.value&&v.value?(t(!1),e.persistent?j():v.value=!1):t()}))}))
const z=t.ref()
function j(){e.noClickAnimation||c.value&&he(c.value,[{transformOrigin:"center"},{transform:"scale(1.03)"},{transformOrigin:"center"}],{duration:150,easing:At})}function H(){r("afterEnter")}function W(){y(),r("afterLeave")}return t.watch((()=>v.value&&(e.absolute||e.contained)&&null==A.value),(e=>{if(e){const e=Tt(s.value)
...
o&&l.push(...o)}}}}})}const vi=gt({id:String,submenu:Boolean,...x(ii({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",location:void 0,openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:$a}}),["absolute"])},"VMenu"),pi=It()({name:"VMenu",props:vi(),emits:{"update:modelValue":e=>!0},setup(e,l){let{slots:o}=l
const n=ia(e,"modelValue"),{scopeId:r}=Qr(),{isRtl:i}=ba(),s=St(),u=t.computed((()=>e.id||`v-menu-${s}`)),c=t.ref(),d=t.inject(Hr,null),v=t.shallowRef(new Set)
...
return t.createVNode(si,t.mergeProps({ref:c,id:u.value,class:["v-menu",e.class],style:e.style},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,absolute:!0,activatorProps:h.value,location:e.location??(e.submenu?"end":"bottom"),"onClick:outside":f,onKeydown:m},r),{activator:o.activator,default:function(){for(var e=arguments.length,a=new Array(e),l=0;l<e;l++)a[l]=arguments[l]
return t.createVNode(al,{root:"VMenu"},{default:()=>[o.default?.(...a)]})}})})),di({id:u,ΨopenChildren:v},c)}}),fi=gt({active:Boolean,disabled:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...ht(),...vl({transition:{component:Za}})},"VCounter"),mi=It()({name:"VCounter",functional:!0,props:fi(),setup(e,a){let{slots:l}=a
...
return $t((()=>t.createVNode(Yo,{class:["v-field-label",{"v-field-label--floating":e.floating},e.class],style:e.style,"aria-hidden":e.floating||void 0},l))),{}}}),yi=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],bi=gt({appendInnerIcon:Mt,bgColor:String,clearable:Boolean,clearIcon:{type:Mt,default:"$clear"},active:Boolean,centerAffix:{type:Boolean,default:void 0},color:String,baseColor:String,dirty:Boolean,disabled:{type:Boolean,default:null},error:Boolean,flat:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:Mt,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>yi.includes(e)},"onClick:clear":G(),"onClick:appendInner":G(),"onClick:prependInner":G(),...ht(),...no(),...cl(),...wa()},"VField"),Vi=It()({name:"VField",inheritAttrs:!1,props:{id:String,...on(),...bi()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{themeClasses:r}=ka(e),{loaderClasses:i}=ro(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=nn(e),{InputIcon:v}=tn(e),{roundedClasses:p}=dl(e),{rtlClasses:m}=ba(),g=t.computed((()=>e.dirty||e.active)),h=t.computed((()=>!(!e.label&&!n.label))),y=t.computed((()=>!e.singleLine&&h.value)),b=St(),V=t.computed((()=>e.id||`input-${b}`)),w=t.computed((()=>`${V.value}-messages`)),S=t.ref(),k=t.ref(),x=t.ref(),N=t.computed((()=>["plain","underlined"].includes(e.variant))),{backgroundColorClasses:C,backgroundColorStyles:_}=ul(t.toRef(e,"bgColor")),{textColorClasses:I,textColorStyles:B}=sl(t.computed((()=>e.error||e.disabled?void 0:g.value&&u.value?e.color:e.baseColor)))
...
t.style.visibility="visible",a.style.visibility="hidden",he(t,{transform:`translate(${n}px, ${r}px) scale(${v})`,color:p,...s},{duration:d,easing:At,direction:e?"normal":"reverse"}).finished.then((()=>{t.style.removeProperty("visibility"),a.style.removeProperty("visibility")}))}))}}),{flush:"post"})
const P=t.computed((()=>({isActive:g,isFocused:u,controlRef:x,blur:d,focus:c})))
function A(e){e.target!==document.activeElement&&e.preventDefault()}return $t((()=>{const a="outlined"===e.variant,o=!(!n["prepend-inner"]&&!e.prependInnerIcon),u=!(!e.clearable&&!n.clear||e.disabled),f=!!(n["append-inner"]||e.appendInnerIcon||u),b=()=>n.label?n.label({...P.value,label:e.label,props:{for:V.value}}):e.label
return t.createVNode("div",t.mergeProps({class:["v-field",{"v-field--active":g.value,"v-field--appended":f,"v-field--center-affix":e.centerAffix??!N.value,"v-field--disabled":e.disabled,"v-field--dirty":e.dirty,"v-field--error":e.error,"v-field--flat":e.flat,"v-field--has-background":!!e.bgColor,"v-field--persistent-clear":e.persistentClear,"v-field--prepended":o,"v-field--reverse":e.reverse,"v-field--single-line":e.singleLine,"v-field--no-label":!b(),[`v-field--variant-${e.variant}`]:!0},r.value,C.value,s.value,i.value,p.value,m.value,e.class],style:[_.value,e.style],onClick:A},l),[t.createVNode("div",{class:"v-field__overlay"},null),t.createVNode(io,{name:"v-field",active:!!e.loading,color:e.error?"error":"string"==typeof e.loading?e.loading:e.color},{default:n.loader}),o&&t.createVNode("div",{key:"prepend",class:"v-field__prepend-inner"},[e.prependInnerIcon&&t.createVNode(v,{key:"prepend-icon",name:"prependInner"},null),n["prepend-inner"]?.(P.value)]),t.createVNode("div",{class:"v-field__field","data-no-activator":""},[["filled","solo","solo-inverted","solo-filled"].includes(e.variant)&&y.value&&t.createVNode(hi,{key:"floating-label",ref:k,class:[I.value],floating:!0,for:V.value,style:B.value},{default:()=>[b()]}),h.value&&t.createVNode(hi,{key:"label",ref:S,for:V.value},{default:()=>[b()]}),n.default?.({...P.value,props:{id:V.value,class:"v-field__input","aria-describedby":w.value},focus:c,blur:d})]),u&&t.createVNode(el,{key:"clear"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-field__clearable",onMousedown:e=>{e.preventDefault(),e.stopPropagation()}},[t.createVNode(al,{defaults:{VIcon:{icon:e.clearIcon}}},{default:()=>[n.clear?n.clear({...P.value,props:{onFocus:c,onBlur:d,onClick:e["onClick:clear"]}}):t.createVNode(v,{name:"clear",onFocus:c,onBlur:d},null)]})]),[[t.vShow,e.dirty]])]}),f&&t.createVNode("div",{key:"append",class:"v-field__append-inner"},[n["append-inner"]?.(P.value),e.appendInnerIcon&&t.createVNode(v,{key:"append-icon",name:"appendInner"},null)]),t.createVNode("div",{class:["v-field__outline",I.value],style:B.value},[a&&t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-field__outline__start"},null),y.value&&t.createVNode("div",{class:"v-field__outline__notch"},[t.createVNode(hi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})]),t.createVNode("div",{class:"v-field__outline__end"},null)]),N.value&&y.value&&t.createVNode(hi,{ref:k,floating:!0,for:V.value},{default:()=>[b()]})])])})),{controlRef:x}}})
function wi(e){return S(e,Object.keys(Vi.props).filter((e=>!_(e)&&"class"!==e&&"style"!==e)))}const Si=["color","file","time","date","datetime-local","week","month"],ki=gt({autofocus:Boolean,counter:[Boolean,Number,String],counterValue:[Number,Function],prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,suffix:String,role:String,type:{type:String,default:"text"},modelModifiers:Object,...vn(),...bi()},"VTextField"),xi=It()({name:"VTextField",directives:{Intersect:ml},inheritAttrs:!1,props:ki(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
t.nextTick((()=>{l.selectionStart=e[0],l.selectionEnd=e[1]}))}}return $t((()=>{const a=!!(n.counter||!1!==e.counter&&null!=e.counter),o=!(!a&&!n.details),[s,k]=P(l),{modelValue:x,...N}=pn.filterProps(e),C=wi(e)
...
function N(e){return e=R(e,0,l.value.length-1),b[e]||0}function C(e){return function(e,t){let a=e.length-1,l=0,o=0,n=null,r=-1
if(e[a]<t)return a
for(;l<=a;)if(o=l+a>>1,n=e[o],n>t)a=o-1
else{if(!(n<t))return n===t?o:l
r=o,l=o+1}return r}(b,e)}t.onScopeDispose((()=>{k.clear()}))
let _=0,I=0,B=0
t.watch(g,((e,t)=>{t&&(D(),e<t&&requestAnimationFrame((()=>{I=0,D()})))}))
let P=-1
function A(){c.value&&d.value&&(I=0,B=0,window.clearTimeout(P),D())}let T=-1
function D(){cancelAnimationFrame(T),T=requestAnimationFrame(E)}function E(){if(!c.value||!g.value)return
const e=_-v,t=Math.sign(I),a=R(C(Math.max(0,e-100)),0,l.value.length),o=R(C(e+g.value+100)+1,a+1,l.value.length)
...
!c.value||e&&!t?w=e:c.value.scrollTop=t}const $=t.computed((()=>l.value.slice(r.value,i.value).map(((e,t)=>({raw:e,index:t+r.value,key:m(e)&&"value"in e?e.value:t+r.value})))))
return t.watch(l,(()=>{y=Array.from({length:l.value.length}),b=Array.from({length:l.value.length}),k.immediate(),D()}),{deep:!0}),{calculateVisibleItems:D,containerRef:c,markerRef:d,computedItems:$,paddingTop:s,paddingBottom:u,scrollToIndex:F,handleScroll:function(){if(!c.value||!d.value)return
const e=c.value.scrollTop,t=performance.now()
t-B>500?(I=Math.sign(e-_),v=d.value.offsetTop):I=e-_,_=e,B=t,window.clearTimeout(P),P=window.setTimeout(A,500),D()},handleScrollend:A,handleItemResize:function(e,t){const a=y[e],l=n.value
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Bi=gt({items:{type:Array,default:()=>[]},renderless:Boolean,..._i(),...ht(),...ll()},"VVirtualScroll"),Pi=It()({name:"VVirtualScroll",props:Bi(),setup(e,a){let{slots:l}=a
...
i.value===document.documentElement?(document[e]("scroll",u,{passive:!0}),document[e]("scrollend",c)):(i.value?.[e]("scroll",u,{passive:!0}),i.value?.[e]("scrollend",c))}t.onMounted((()=>{i.value=Tt(o.vnode.el,!0),e(!0)})),t.onScopeDispose(e)})),$t((()=>{const a=g.value.map((a=>t.createVNode(Ci,{key:a.key,renderless:e.renderless,"onUpdate:height":e=>d(a.index,e)},{default:e=>l.default?.({item:a.raw,index:a.index,...e})})))
...
break}}}}}function Ri(){const e=t.shallowRef(!1)
function a(){e.value=!0}function l(){e.value=!1}return t.onMounted((()=>{document.body.addEventListener("mousedown",a),document.body.addEventListener("mouseup",l)})),t.onUnmounted((()=>{document.body.removeEventListener("mousedown",a),document.body.removeEventListener("mouseup",l)})),{isMousedown:e}}const Ti=gt({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,listProps:{type:Object},menu:Boolean,menuIcon:{type:Mt,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...hr({itemChildren:!1})},"Select"),Di=gt({...Ti(),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:{component:$a}})},"VSelect"),Ei=It()({name:"VSelect",props:Di(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.ref(),s=t.ref(),u=ia(e,"menu"),c=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren.size||(u.value=e)}}),{items:d,transformIn:v,transformOut:p}=Vr(e),f=ia(e,"modelValue",[],(e=>v(null===e?[null]:A(e))),(t=>{const a=p(t)
return e.multiple?a:a[0]??null})),m=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(f.value):"number"==typeof e.counterValue?e.counterValue:f.value.length)),g=un(e),{isMousedown:h}=Ri(),y=t.computed((()=>f.value.map((e=>e.value)))),b=t.shallowRef(!1),V=t.computed((()=>c.value?e.closeText:e.openText))
let w,S=""
const k=t.computed((()=>e.hideSelected?d.value.filter((t=>!f.value.some((a=>e.valueComparator(a,t))))):d.value)),x=t.computed((()=>e.hideNoData&&!k.value.length||g.isReadonly.value||g.isDisabled.value)),N=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),C=t.ref(),_=Ai(C,r)
function I(t){e.openOnClear&&(c.value=!0)}function B(){x.value||(c.value=!c.value)}function P(e){oe(e)&&R(e)}function R(e){if(!e.key||g.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(e.key)&&e.preventDefault(),["Enter","ArrowDown"," "].includes(e.key)&&(c.value=!0),["Escape","Tab"].includes(e.key)&&(c.value=!1),"Home"===e.key?C.value?.focus("first"):"End"===e.key&&C.value?.focus("last")
if(!oe(e))return
const t=performance.now()
t-w>1e3&&(S=""),S+=e.key.toLowerCase(),w=t
const l=d.value.find((e=>e.title.toLowerCase().startsWith(S)))
if(void 0!==l){f.value=[l]
const e=k.value.indexOf(l)
...
f.value=e?[a]:[],t.nextTick((()=>{c.value=!1}))}}function D(e){C.value?.$el.contains(e.relatedTarget)||h.value||(c.value=!1)}function E(){e.eager&&s.value?.calculateVisibleItems()}function F(){b.value&&r.value?.focus()}function $(e){b.value=!0}function M(e){if(null==e)f.value=[]
else if(te(r.value,":autofill")||te(r.value,":-webkit-autofill")){const t=d.value.find((t=>t.title===e))
t&&T(t)}else r.value&&(r.value.value="")}return t.watch(c,(()=>{if(!e.hideSelected&&c.value&&f.value.length){const t=k.value.findIndex((t=>f.value.some((a=>e.valueComparator(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{c.value||b.value&&!t.length&&e.length&&(c.value=!0)})),$t((()=>{const a=!(!e.chips&&!o.chip),l=!!(!e.hideNoData||k.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),u=f.value.length>0,d=xi.filterProps(e),v=u||!b.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(xi,t.mergeProps({ref:r},d,{modelValue:f.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":M,focused:b.value,"onUpdate:focused":e=>b.value=e,validationValue:f.externalValue,counterValue:m.value,dirty:u,class:["v-select",{"v-select--active-menu":c.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":f.value.length,"v-select--selection-slot":!!o.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":I,"onMousedown:control":B,onBlur:D,onKeydown:R,"aria-label":n(V.value),title:n(V.value)}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:i,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-select__content",disabled:x.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:E,onAfterLeave:F},N.value),{default:()=>[l&&t.createVNode(xr,t.mergeProps({ref:C,selected:y.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:P,onFocusin:$,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},_,e.listProps),{default:()=>[o["prepend-item"]?.(),!k.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Pi,{ref:s,renderless:!0,items:k.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Xl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),di({isFocused:b,menu:c,select:T},r)}}),Fi=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),$i=gt({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
function Mi(e,a,l,o){const n=t.shallowRef([]),r=t.shallowRef(new Map),i=t.computed((()=>o?.transform?t.unref(a).map((e=>[e,o.transform(e)])):t.unref(a)))
...
const l=d[t]
p.push(l),f.set(l.value,a)})),n.value=p,r.value=f})),{filteredItems:n,filteredMatches:r,getMatches:function(e){return r.value.get(e.value)}}}const Oi=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:Boolean,search:String,...$i({filterKeys:["title"]}),...Ti(),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VAutocomplete"),Li=It()({name:"VAutocomplete",props:Oi(),emits:{"update:focused":e=>!0,"update:search":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,l){let{slots:o}=l
const{t:n}=ha(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),c=t.ref(),d=t.ref(),v=ia(e,"menu"),p=t.computed({get:()=>v.value,set:e=>{v.value&&!e&&c.value?.ΨopenChildren.size||(v.value=e)}}),f=t.shallowRef(-1),m=t.computed((()=>r.value?.color)),g=t.computed((()=>p.value?e.closeText:e.openText)),{items:h,transformIn:y,transformOut:b}=Vr(e),{textColorClasses:V,textColorStyles:w}=sl(m),{isMousedown:S}=Ri(),k=ia(e,"search",""),x=ia(e,"modelValue",[],(e=>y(null===e?[null]:A(e))),(t=>{const a=b(t)
return e.multiple?a:a[0]??null})),N=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:x.value.length)),C=un(e),{filteredItems:_,getMatches:I}=Mi(e,h,(()=>s.value?"":k.value)),B=t.computed((()=>e.hideSelected?_.value.filter((e=>!x.value.some((t=>t.value===e.value)))):_.value)),P=t.computed((()=>!(!e.chips&&!o.chip))),R=t.computed((()=>P.value||!!o.selection)),T=t.computed((()=>x.value.map((e=>e.props.value)))),D=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&k.value===B.value[0]?.title)&&B.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!B.value.length||C.isReadonly.value||C.isDisabled.value)),F=t.ref(),$=Ai(F,r)
function M(t){e.openOnClear&&(p.value=!0),k.value=""}function O(){E.value||(p.value=!0)}function L(e){E.value||(i.value&&(e.preventDefault(),e.stopPropagation()),p.value=!p.value)}function z(e){" "!==e.key&&oe(e)&&r.value?.focus()}function j(t){if(C.isReadonly.value)return
const a=r.value.selectionStart,l=x.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(p.value=!0),["Escape"].includes(t.key)&&(p.value=!1),D.value&&["Enter","Tab"].includes(t.key)&&!x.value.some((e=>{let{value:t}=e
return t===B.value[0].value}))&&X(B.value[0]),"ArrowDown"===t.key&&D.value&&F.value?.focus("next"),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&R.value&&x.value.length>0&&!k.value)return X(x.value[0],!1)
if(~f.value){t.preventDefault()
const e=f.value
X(x.value[f.value],!1),f.value=e>=l-1?l-2:e}else"Backspace"!==t.key||k.value||(f.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(f.value<0&&a>0)return
const e=f.value>-1?f.value-1:l-1
x.value[e]?f.value=e:(f.value=-1,r.value.setSelectionRange(k.value?.length,k.value?.length))}else if("ArrowRight"===t.key){if(f.value<0)return
const e=f.value+1
x.value[e]?f.value=e:(f.value=-1,r.value.setSelectionRange(0,0))}else~f.value&&oe(t)&&(f.value=-1)}function H(e){if(te(r.value,":autofill")||te(r.value,":-webkit-autofill")){const t=h.value.find((t=>t.title===e.target.value))
t&&X(t)}}function W(){e.eager&&d.value?.calculateVisibleItems()}function U(){i.value&&(s.value=!0,r.value?.focus())}function Y(e){i.value=!0,setTimeout((()=>{u.value=!0}))}function G(e){u.value=!1}function q(t){null!=t&&(""!==t||e.multiple||R.value)||(x.value=[])}const K=t.shallowRef(!1)
function X(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
e.clearOnSelect&&(k.value="")}else{const e=!1!==l
x.value=e?[a]:[],k.value=e&&!R.value?a.title:"",t.nextTick((()=>{p.value=!1,s.value=!0}))}}function Z(e){S.value||(p.value=!1)}return t.watch(i,((a,l)=>{a!==l&&(a?(K.value=!0,k.value=e.multiple||R.value?"":String(x.value.at(-1)?.props.title??""),s.value=!0,t.nextTick((()=>K.value=!1))):(e.multiple||null!=k.value||(x.value=[]),x.value.some((e=>{let{title:t}=e
return t===k.value}))||(k.value=""),f.value=-1))})),t.watch(k,(e=>{i.value&&!K.value&&(e&&(p.value=!0),s.value=!e)})),t.watch(p,(()=>{if(!e.hideSelected&&p.value&&x.value.length){const e=B.value.findIndex((e=>x.value.some((t=>e.value===t.value))))
a&&window.requestAnimationFrame((()=>{e>=0&&d.value?.scrollToIndex(e)}))}})),t.watch((()=>e.items),((e,t)=>{p.value||i.value&&!t.length&&e.length&&(p.value=!0)})),$t((()=>{const a=!!(!e.hideNoData||B.value.length||o["prepend-item"]||o["append-item"]||o["no-data"]),l=x.value.length>0,u=xi.filterProps(e)
return t.createVNode(xi,t.mergeProps({ref:r},u,{modelValue:k.value,"onUpdate:modelValue":[e=>k.value=e,q],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:x.externalValue,counterValue:N.value,dirty:l,onChange:H,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!R.value,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:C.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":M,onBlur:Z,"onMousedown:control":O,onKeydown:j}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:E.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:W,onAfterLeave:U},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:F,selected:T.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:z,onFocusin:Y,onFocusout:G,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},$,e.listProps),{default:()=>[o["prepend-item"]?.(),!B.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Pi,{ref:d,renderless:!0,items:B.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!D.value||0!==n)||void 0,onClick:()=>X(l,null)})
return o.item?.({item:l,index:n,props:i})??t.createVNode(cr,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:o}=a
...
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-autocomplete__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(a+l)])]):e}(l.title,I(l)?.title,k.value?.length??0)})}}),o["append-item"]?.()]})]}),x.value.map(((a,l)=>{function n(e){e.stopPropagation(),e.preventDefault(),X(a,!1)}const r={"onClick:close":n,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),n(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=P.value?!!o.chip:!!o.selection,s=i?ae(P.value?o.chip({item:a,index:l,props:r}):o.selection({item:a,index:l})):void 0
if(!i||s)return t.createVNode("div",{key:a.value,class:["v-autocomplete__selection",l===f.value&&["v-autocomplete__selection--selected",V.value]],style:l===f.value?w.value:{}},[P.value?o.chip?t.createVNode(al,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(zn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createVNode("span",{class:"v-autocomplete__selection-text"},[a.title,e.multiple&&l<x.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),r=0;r<a;r++)l[r]=arguments[r]
return t.createVNode(t.Fragment,null,[o["append-inner"]?.(...l),e.menuIcon?t.createVNode(Xl,{class:"v-autocomplete__menu-icon",icon:e.menuIcon,onMousedown:L,onClick:ee,"aria-label":n(g.value),title:n(g.value),tabindex:"-1"},null):void 0])}})})),di({isFocused:i,isPristine:s,menu:p,search:k,filteredItems:_,select:X},r)}}),zi=gt({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Mt,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...ht(),...to({location:"top end"}),...cl(),...Ba(),...wa(),...vl({transition:"scale-rotate-transition"})},"VBadge"),ji=It()({name:"VBadge",inheritAttrs:!1,props:zi(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=ul(t.toRef(e,"color")),{roundedClasses:n}=dl(e),{t:r}=ha(),{textColorClasses:i,textColorStyles:s}=sl(t.toRef(e,"textColor")),{themeClasses:u}=xa(),{locationStyles:c}=ao(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
return $t((()=>{const d=Number(e.content),v=!e.max||isNaN(d)?e.content:d<=+e.max?d:`${e.max}+`,[p,f]=k(a.attrs,["aria-atomic","aria-label","aria-live","role","title"])
return t.createVNode(e.tag,t.mergeProps({class:["v-badge",{"v-badge--bordered":e.bordered,"v-badge--dot":e.dot,"v-badge--floating":e.floating,"v-badge--inline":e.inline},e.class]},f,{style:e.style}),{default:()=>[t.createVNode("div",{class:"v-badge__wrapper"},[a.slots.default?.(),t.createVNode(pl,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("span",t.mergeProps({class:["v-badge__badge",u.value,l.value,n.value,i.value],style:[o.value,s.value,e.inline?{}:c.value],"aria-atomic":"true","aria-label":r(e.label,d),"aria-live":"polite",role:"status"},p),[e.dot?void 0:a.slots.badge?a.slots.badge?.():e.icon?t.createVNode(Xl,{icon:e.icon},null):v]),[[t.vShow,e.modelValue]])]})])]})})),{}}}),Hi=gt({color:String,density:String,...ht()},"VBannerActions"),Wi=It()({name:"VBannerActions",props:Hi(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Ui=Bt("v-banner-text"),Yi=gt({avatar:String,bgColor:String,color:String,icon:Mt,lines:String,stacked:Boolean,sticky:Boolean,text:String,...yl(),...ht(),...Pl(),...ll(),...kn({mobile:null}),...Vl(),...to(),...uo(),...cl(),...Ba(),...wa()},"VBanner"),Gi=It()({name:"VBanner",props:Yi(),setup(e,a){let{slots:l}=a
...
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||u.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},m.value,o.value,r.value,i.value,s.value,d.value,p.value,f.value,e.class],style:[n.value,c.value,v.value,e.style],role:"banner"},{default:()=>[b&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!y,defaults:{VAvatar:{color:g.value,density:h.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(Wo,{key:"prepend-avatar",color:g.value,density:h.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(Ui,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(Wi,{key:"actions"},l.actions)]})}))}}),qi=gt({baseColor:String,bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...yl(),...ht(),...Pl(),...Vl(),...cl(),...aa({name:"bottom-navigation"}),...Ba({tag:"header"}),...Ml({selectedClass:"v-btn--selected"}),...wa()},"VBottomNavigation"),Ki=It()({name:"VBottomNavigation",props:qi(),emits:{"update:active":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
t===a?l.focus():a.focus()}}function c(){o("afterEnter"),s.value?.contentEl&&!s.value.contentEl.contains(document.activeElement)&&s.value.contentEl.focus({preventScroll:!0})}function d(){o("afterLeave")}return t.onBeforeUnmount((()=>{document.removeEventListener("focusin",u)})),a&&t.watch((()=>r.value&&e.retainFocus),(e=>{e?document.addEventListener("focusin",u):document.removeEventListener("focusin",u)}),{immediate:!0}),t.watch(r,(async e=>{e||(await t.nextTick(),s.value.activatorEl?.focus({preventScroll:!0}))})),$t((()=>{const a=si.filterProps(e),l=t.mergeProps({"aria-haspopup":"dialog"},e.activatorProps),o=t.mergeProps({tabindex:-1},e.contentProps)
return t.createVNode(si,t.mergeProps({ref:s,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable},e.class],style:e.style},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,"aria-modal":"true",activatorProps:l,contentProps:o,height:e.fullscreen?void 0:e.height,width:e.fullscreen?void 0:e.width,maxHeight:e.fullscreen?void 0:e.maxHeight,maxWidth:e.fullscreen?void 0:e.maxWidth,role:"dialog",onAfterEnter:c,onAfterLeave:d},i),{activator:n.activator,default:function(){for(var e=arguments.length,a=new Array(e),l=0;l<e;l++)a[l]=arguments[l]
return t.createVNode(al,{root:"VDialog"},{default:()=>[n.default?.(...a)]})}})})),di({},s)}}),Qi=gt({inset:Boolean,...Xi({transition:"bottom-sheet-transition"})},"VBottomSheet"),Ji=It()({name:"VBottomSheet",props:Qi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"modelValue")
return $t((()=>{const a=Zi.filterProps(e)
return t.createVNode(Zi,t.mergeProps(a,{contentClass:["v-bottom-sheet__content",e.contentClass],modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-bottom-sheet",{"v-bottom-sheet--inset":e.inset},e.class],style:e.style}),l)})),{}}}),es=gt({divider:[Number,String],...ht()},"VBreadcrumbsDivider"),ts=It()({name:"VBreadcrumbsDivider",props:es(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),as=gt({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...ht(),...fo(),...Ba({tag:"li"})},"VBreadcrumbsItem"),ls=It()({name:"VBreadcrumbsItem",props:as(),setup(e,a){let{slots:l,attrs:o}=a
...
return t.createVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(ls,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(ts,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),rs=It()({name:"VCardActions",props:ht(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{slim:!0,variant:"text"}}),$t((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),is=gt({opacity:[Number,String],...ht(),...Ba()},"VCardSubtitle"),ss=It()({name:"VCardSubtitle",props:is(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),us=Bt("v-card-title"),cs=gt({appendAvatar:String,appendIcon:Mt,prependAvatar:String,prependIcon:Mt,subtitle:[String,Number],title:[String,Number],...ht(),...Pl()},"VCardItem"),ds=It()({name:"VCardItem",props:cs(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(us,{key:"title"},{default:()=>[l.title?.()??e.title]}),s&&t.createVNode(ss,{key:"subtitle"},{default:()=>[l.subtitle?.()??e.subtitle]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(al,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),vs=gt({opacity:[Number,String],...ht(),...Ba()},"VCardText"),ps=It()({name:"VCardText",props:vs(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-text",e.class],style:[{"--v-card-text-opacity":e.opacity},e.style]},l))),{}}}),fs=gt({appendAvatar:String,appendIcon:Mt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},subtitle:[String,Number],text:[String,Number],title:[String,Number],...yl(),...ht(),...Pl(),...ll(),...Vl(),...no(),...to(),...uo(),...cl(),...fo(),...Ba(),...wa(),...Dl({variant:"elevated"})},"VCard"),ms=It()({name:"VCard",directives:{Ripple:To},props:fs(),setup(e,a){let{attrs:l,slots:o}=a
...
return t.withDirectives(t.createVNode(a,t.mergeProps({class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value,e.class],style:[s.value,d.value,f.value,e.style],onClick:b.value&&h.navigate,tabindex:e.disabled?-1:void 0},h.linkProps),{default:()=>[x&&t.createVNode("div",{key:"image",class:"v-card__image"},[o.image?t.createVNode(al,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},o.image):t.createVNode(hl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(io,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),N&&t.createVNode(ds,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),C&&t.createVNode(ps,{key:"text"},{default:()=>[o.text?.()??e.text]}),o.default?.(),o.actions&&t.createVNode(rs,null,{default:o.actions}),Tl(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value&&e.ripple]])})),{}}}),gs=e=>{const{touchstartX:t,touchendX:a,touchstartY:l,touchendY:o}=e
...
V(o).forEach((e=>{a.removeEventListener(e,o[e])})),delete a._touchHandlers[l]}},bs=Symbol.for("vuetify:v-window"),Vs=Symbol.for("vuetify:v-window-group"),ws=gt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},...ht(),...Ba(),...wa()},"VWindow"),Ss=It()({name:"VWindow",directives:{Touch:ys},props:ws(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ka(e),{isRtl:n}=ba(),{t:r}=ha(),i=zl(e,Vs),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
return $t((()=>t.withDirectives(t.createVNode(e.tag,{ref:s,class:["v-window",{"v-window--show-arrows-on-hover":"hover"===e.showArrows},o.value,e.class],style:e.style},{default:()=>[t.createVNode("div",{class:"v-window__container",style:{height:p.value}},[l.default?.({group:i}),!1!==e.showArrows&&t.createVNode("div",{class:"v-window__controls"},[b.value])]),l.additional?.({group:i})]}),[[t.resolveDirective("touch"),V.value]]))),{group:i}}}),ks=gt({color:String,cycle:Boolean,delimiterIcon:{type:Mt,default:"$delimiter"},height:{type:[Number,String],default:500},hideDelimiters:Boolean,hideDelimiterBackground:Boolean,interval:{type:[Number,String],default:6e3,validator:e=>Number(e)>0},progress:[Boolean,String],verticalDelimiters:[Boolean,String],...ws({continuous:!0,mandatory:"force",showArrows:!0})},"VCarousel"),xs=It()({name:"VCarousel",props:ks(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=ia(e,"modelValue"),{t:n}=ha(),r=t.ref()
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,+e.interval>0?+e.interval:6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),$t((()=>{const a=Ss.filterProps(e)
...
return l.item?l.item({props:o,item:e}):t.createVNode(Eo,t.mergeProps(e,o),null)}))]})]),e.progress&&t.createVNode(oo,{class:"v-carousel__progress",color:"string"==typeof e.progress?e.progress:void 0,modelValue:(r.getItemIndex(o.value)+1)/r.items.value.length*100},null)])},prev:l.prev,next:l.next})})),{}}}),Ns=gt({reverseTransition:{type:[Boolean,String],default:void 0},transition:{type:[Boolean,String],default:void 0},...ht(),...Ol(),...Xr()},"VWindowItem"),Cs=It()({name:"VWindowItem",directives:{Touch:ys},props:Ns(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(bs),n=Ll(e,Vs),{isBooted:r}=Cl()
...
return $t((()=>t.createVNode(pl,{transition:p.value,disabled:!r.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-window-item",n.selectedClass.value,e.class],style:e.style},[m.value&&l.default?.()]),[[t.vShow,n.isSelected.value]])]}))),{groupItem:n}}}),_s=gt({...gl(),...Ns()},"VCarouselItem"),Is=It()({name:"VCarouselItem",inheritAttrs:!1,props:_s(),setup(e,a){let{slots:l,attrs:o}=a
$t((()=>{const a=hl.filterProps(e),n=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({class:["v-carousel-item",e.class]},n),{default:()=>[t.createVNode(hl,t.mergeProps(o,a),l)]})}))}}),Bs=Bt("v-code","code"),Ps=_t({name:"VColorPickerCanvas",props:gt({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...ht()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
return $t((()=>t.createVNode("div",{class:["v-color-picker-edit",e.class],style:e.style},[n.value?.map((e=>t.createVNode(Fs,e,null))),o.value.length>1&&t.createVNode(Eo,{icon:"$unfold",size:"x-small",variant:"plain",onClick:()=>{const t=o.value.findIndex((t=>t.name===e.mode))
...
return l?n.clientY-(o.top+o.height/2):n.clientX-(o.left+o.width/2)}const Ls=gt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,...cl(),...Vl({elevation:2}),ripple:{type:Boolean,default:!0}},"Slider"),zs=e=>{const a=t.computed((()=>parseFloat(e.min))),l=t.computed((()=>parseFloat(e.max))),o=t.computed((()=>+e.step>0?parseFloat(e.step):0)),n=t.computed((()=>Math.max(T(o.value),T(a.value))))
...
return(t?d.value:d.value!==s.value)&&(c=1-c),h(v.value+c*(f.value-v.value))}const A=e=>{r({value:P(e)}),C.value=!1,_.value=0},T=e=>{B.value=i(e),B.value&&(C.value=!0,B.value.contains(e.target)?_.value=Os(e,B.value,a.direction):(_.value=0,n({value:P(e)})),o({value:P(e)}),t.nextTick((()=>B.value?.focus())))},D={passive:!0,capture:!0}
...
return t.provide(Ms,j),j},Hs=gt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,...ht()},"VSliderThumb"),Ws=It()({name:"VSliderThumb",directives:{Ripple:To},props:Hs(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.inject(Ms),{isRtl:r,rtlClasses:i}=ba()
if(!n)throw new Error("[Vuetify] v-slider-thumb must be used inside v-slider or v-range-slider")
const{thumbColor:s,step:u,disabled:c,thumbSize:d,thumbLabel:v,direction:p,isReversed:m,vertical:g,readonly:h,elevation:y,mousePressed:V,decimals:w,indexFromEnd:S}=n,k=t.computed((()=>c.value?void 0:y.value)),{elevationClasses:x}=wl(k),{textColorClasses:N,textColorStyles:C}=sl(s),{pageup:_,pagedown:I,end:B,home:P,left:A,right:R,down:T,up:D}=b,E=[_,I,B,P,A,R,T,D],F=t.computed((()=>u.value?[1,2,3]:[1,5,10]))
...
const Zs=gt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map((t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]}))}(Xs)},disabled:Boolean,color:Object,maxHeight:[Number,String],...ht()},"VColorPickerSwatches")
const Qs=_t({name:"VColorPickerSwatches",props:Zs(),emits:{"update:color":e=>!0},setup(e,a){let{emit:l}=a
return $t((()=>t.createVNode("div",{class:["v-color-picker-swatches",e.class],style:[{maxHeight:f(e.maxHeight)},e.style]},[t.createVNode("div",null,[e.swatches.map((a=>t.createVNode("div",{class:"v-color-picker-swatches__swatch"},[a.map((a=>{const o=Je(a),n=at(o),r=nt(o)
return t.createVNode("div",{class:"v-color-picker-swatches__color",onClick:()=>n&&l("update:color",n)},[t.createVNode("div",{style:{background:r}},[e.color&&c(e.color,n)?t.createVNode(Xl,{size:"x-small",icon:"$success",color:ft(a,"#FFFFFF")>2?"white":"black"},null):void 0])])}))])))])]))),{}}}),Js=gt({color:String,...yl(),...ht(),...ll(),...Vl(),...to(),...uo(),...cl(),...Ba(),...wa()},"VSheet"),eu=It()({name:"VSheet",props:Js(),setup(e,a){let{slots:l}=a
...
return a}return e}(a,!w(t,["a"])&&1===e.a)}return e}(t,e.modelValue):null)),n=t.computed((()=>o.value?{...o.value,h:l.value??o.value.h}:null)),{rtlClasses:r}=ba()
let i=!0
t.watch(o,(e=>{i?e&&(l.value=e.h):i=!0}),{immediate:!0})
const s=e=>{i=!1,l.value=e.h,o.value=e}
return t.onBeforeMount((()=>{e.modes.includes(a.value)||(a.value=e.modes[0])})),Nt({VSlider:{color:void 0,trackColor:void 0,trackFillColor:void 0}}),$t((()=>{const l=eu.filterProps(e)
...
const au=gt({autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...$i({filterKeys:["title"]}),...Ti({hideNoData:!0,returnObject:!0}),...x(ki({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...vl({transition:!1})},"VCombobox"),lu=It()({name:"VCombobox",props:au(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,l){let{emit:o,slots:n}=l
...
let g=!1
const h=t.computed((()=>i.value?.color)),y=t.computed((()=>f.value?e.closeText:e.openText)),{items:b,transformIn:V,transformOut:w}=Vr(e),{textColorClasses:S,textColorStyles:k}=sl(h),x=ia(e,"modelValue",[],(e=>V(A(e))),(t=>{const a=w(t)
return e.multiple?a:a[0]??null})),N=un(e),{isMousedown:C}=Ri(),_=t.computed((()=>!(!e.chips&&!n.chip))),I=t.computed((()=>_.value||!!n.selection)),P=t.shallowRef(e.multiple||I.value?"":x.value[0]?.title??""),R=t.computed({get:()=>P.value,set:t=>{if(P.value=t??"",e.multiple||I.value||(x.value=[yr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&X(yr(e,t))})),P.value="")}t||(m.value=-1),u.value=!t}}),T=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:R.value.length))
t.watch(P,(e=>{g?t.nextTick((()=>g=!1)):s.value&&!f.value&&(f.value=!0),o("update:search",e)})),t.watch(x,(t=>{e.multiple||I.value||(P.value=t[0]?.title??"")}))
const{filteredItems:D,getMatches:E}=Mi(e,b,(()=>u.value?"":R.value)),F=t.computed((()=>e.hideSelected?D.value.filter((e=>!x.value.some((t=>t.value===e.value)))):D.value)),$=t.computed((()=>x.value.map((e=>e.value)))),M=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&R.value===F.value[0]?.title)&&F.value.length>0&&!u.value&&!c.value)),O=t.computed((()=>e.hideNoData&&!F.value.length||N.isReadonly.value||N.isDisabled.value)),L=t.ref(),z=Ai(L,i)
function j(t){g=!0,e.openOnClear&&(f.value=!0)}function H(){O.value||(f.value=!0)}function W(e){O.value||(s.value&&(e.preventDefault(),e.stopPropagation()),f.value=!f.value)}function U(e){" "!==e.key&&oe(e)&&i.value?.focus()}function Y(t){if(function(e){return e.isComposing&&B.includes(e.key)}(t)||N.isReadonly.value)return
const a=i.value.selectionStart,l=x.value.length
if(["Enter","ArrowDown","ArrowUp"].includes(t.key)&&t.preventDefault(),["Enter","ArrowDown"].includes(t.key)&&(f.value=!0),["Escape"].includes(t.key)&&(f.value=!1),["Enter","Escape","Tab"].includes(t.key)&&(M.value&&["Enter","Tab"].includes(t.key)&&!x.value.some((e=>{let{value:t}=e
return t===F.value[0].value}))&&X(D.value[0]),u.value=!0),"ArrowDown"===t.key&&M.value&&L.value?.focus("next"),"Enter"===t.key&&R.value&&(X(yr(e,R.value)),I.value&&(P.value="")),["Backspace","Delete"].includes(t.key)){if(!e.multiple&&I.value&&x.value.length>0&&!R.value)return X(x.value[0],!1)
if(~m.value){t.preventDefault()
const e=m.value
X(x.value[m.value],!1),m.value=e>=l-1?l-2:e}else"Backspace"!==t.key||R.value||(m.value=l-1)}else if(e.multiple)if("ArrowLeft"===t.key){if(m.value<0&&a>0)return
const e=m.value>-1?m.value-1:l-1
x.value[e]?m.value=e:(m.value=-1,i.value.setSelectionRange(R.value.length,R.value.length))}else if("ArrowRight"===t.key){if(m.value<0)return
const e=m.value+1
x.value[e]?m.value=e:(m.value=-1,i.value.setSelectionRange(0,0))}else~m.value&&oe(t)&&(m.value=-1)}function G(){e.eager&&v.value?.calculateVisibleItems()}function q(){s.value&&(u.value=!0,i.value?.focus())}function K(e){C.value||(f.value=!1)}function X(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
if(a&&!a.props.disabled)if(e.multiple){const t=x.value.findIndex((t=>e.valueComparator(t.value,a.value))),o=null==l?!~t:l
if(~t){const e=o?[...x.value,a]:[...x.value]
e.splice(t,1),x.value=e}else o&&(x.value=[...x.value,a])
e.clearOnSelect&&(R.value="")}else{const e=!1!==l
x.value=e?[a]:[],P.value=e&&!I.value?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function Z(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function Q(e){c.value=!1}function J(t){null!=t&&(""!==t||e.multiple||I.value)||(x.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(m.value=-1,R.value)){if(e.multiple)return void X(yr(e,R.value))
if(!I.value)return
x.value.some((e=>{let{title:t}=e
return t===R.value}))?P.value="":X(yr(e,R.value))}})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=F.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
a&&window.requestAnimationFrame((()=>{t>=0&&v.value?.scrollToIndex(t)}))}})),t.watch((()=>e.items),((e,t)=>{f.value||s.value&&!t.length&&e.length&&(f.value=!0)})),$t((()=>{const a=!!(!e.hideNoData||F.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),l=x.value.length>0,o=xi.filterProps(e)
return t.createVNode(xi,t.mergeProps({ref:i},o,{modelValue:R.value,"onUpdate:modelValue":[e=>R.value=e,J],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:T.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!I.value,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:N.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":j,onBlur:K,"onMousedown:control":H,onKeydown:Y}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:O.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:G,onAfterLeave:q},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:L,selected:$.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:U,onFocusin:Z,onFocusout:Q,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},z,e.listProps),{default:()=>[n["prepend-item"]?.(),!F.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(Pi,{ref:v,renderless:!0,items:F.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!M.value||0!==o)||void 0,onClick:()=>X(l,null)})
...
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-combobox__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-combobox__unmask"},[e.substr(a+l)])]):e}(l.title,E(l)?.title,R.value?.length??0)})}}),n["append-item"]?.()]})]}),x.value.map(((a,l)=>{function o(e){e.stopPropagation(),e.preventDefault(),X(a,!1)}const r={"onClick:close":o,onKeydown(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.stopPropagation(),o(e))},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=_.value?!!n.chip:!!n.selection,s=i?ae(_.value?n.chip({item:a,index:l,props:r}):n.selection({item:a,index:l})):void 0
if(!i||s)return t.createVNode("div",{key:a.value,class:["v-combobox__selection",l===m.value&&["v-combobox__selection--selected",S.value]],style:l===m.value?k.value:{}},[_.value?n.chip?t.createVNode(al,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:a.title}}},{default:()=>[s]}):t.createVNode(zn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:a.title,disabled:a.props.disabled},r),null):s??t.createVNode("span",{class:"v-combobox__selection-text"},[a.title,e.multiple&&l<x.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(Xl,{class:"v-combobox__menu-icon",icon:e.menuIcon,onMousedown:W,onClick:ee,"aria-label":r(y.value),title:r(y.value),tabindex:"-1"},null)])}})})),di({isFocused:s,isPristine:u,menu:f,search:R,selectionIndex:m,filteredItems:D,select:X},i)}}),ou={"001":1,AD:1,AE:6,AF:6,AG:0,AI:1,AL:1,AM:1,AN:1,AR:1,AS:0,AT:1,AU:1,AX:1,AZ:1,BA:1,BD:0,BE:1,BG:1,BH:6,BM:1,BN:1,BR:0,BS:0,BT:0,BW:0,BY:1,BZ:0,CA:0,CH:1,CL:1,CM:1,CN:1,CO:0,CR:1,CY:1,CZ:1,DE:1,DJ:6,DK:1,DM:0,DO:0,DZ:6,EC:1,EE:1,EG:6,ES:1,ET:0,FI:1,FJ:1,FO:1,FR:1,GB:1,"GB-alt-variant":0,GE:1,GF:1,GP:1,GR:1,GT:0,GU:0,HK:0,HN:0,HR:1,HU:1,ID:0,IE:1,IL:0,IN:0,IQ:6,IR:6,IS:1,IT:1,JM:0,JO:6,JP:0,KE:0,KG:1,KH:0,KR:0,KW:6,KZ:1,LA:0,LB:1,LI:1,LK:1,LT:1,LU:1,LV:1,LY:6,MC:1,MD:1,ME:1,MH:0,MK:1,MM:0,MN:1,MO:0,MQ:1,MT:0,MV:5,MX:0,MY:1,MZ:0,NI:0,NL:1,NO:1,NP:0,NZ:1,OM:6,PA:0,PE:0,PH:0,PK:0,PL:1,PR:0,PT:0,PY:0,QA:6,RE:1,RO:1,RS:1,RU:1,SA:0,SD:6,SE:1,SG:0,SI:1,SK:1,SM:1,SV:0,SY:6,TH:0,TJ:1,TM:1,TR:1,TT:0,TW:0,UA:1,UM:0,US:0,UY:1,UZ:1,VA:1,VE:0,VI:0,VN:1,WS:0,XK:1,YE:0,ZA:0,ZW:0}
...
return hu(e,ha())}const bu=gt({modelValue:null,color:String,cancelText:{type:String,default:"$vuetify.confirmEdit.cancel"},okText:{type:String,default:"$vuetify.confirmEdit.ok"}},"VConfirmEdit"),Vu=It()({name:"VConfirmEdit",props:bu(),emits:{cancel:()=>!0,save:e=>!0,"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
function u(){n.value=r.value,l("save",r.value)}function d(){r.value=structuredClone(t.toRaw(n.value)),l("cancel")}function v(a){return t.createVNode(t.Fragment,null,[t.createVNode(Eo,t.mergeProps({disabled:s.value,variant:"text",color:e.color,onClick:d,text:i(e.cancelText)},a),null),t.createVNode(Eo,t.mergeProps({disabled:s.value,variant:"text",color:e.color,onClick:u,text:i(e.okText)},a),null)])}let p=!1
return $t((()=>t.createVNode(t.Fragment,null,[o.default?.({model:r,save:u,cancel:d,isPristine:s.value,get actions(){return p=!0,v}}),!p&&v()]))),{save:u,cancel:d,isPristine:s}}}),wu=gt({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),Su=Symbol.for("vuetify:datatable:expanded")
function ku(e){const a=t.toRef(e,"expandOnClick"),l=ia(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return e}const Nu=gt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Cu=Symbol.for("vuetify:data-table-group")
function _u(e){return{groupBy:ia(e,"groupBy")}}function Iu(e){const{disableSort:a,groupBy:l,sortBy:o}=e,n=t.ref(new Set)
...
return[...new Set(a)]}({type:"group",items:e,id:"dummy",key:"dummy",value:"dummy",depth:0})},isGroupOpen:r}
...
let u=null
t.watch(s,(()=>{c(u,s.value)||(u&&u.search!==s.value.search&&(a.value=1),i.emit("update:options",s.value),u=s.value)}),{deep:!0,immediate:!0})}const Du=gt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10}},"DataTable-paginate"),Eu=Symbol.for("vuetify:data-table-pagination")
function Fu(e){return{page:ia(e,"page",void 0,(e=>+(e??1))),itemsPerPage:ia(e,"itemsPerPage",void 0,(e=>+(e??10)))}}function $u(e){const{page:a,itemsPerPage:l,itemsLength:o}=e,n=t.computed((()=>-1===l.value?0:l.value*(a.value-1))),r=t.computed((()=>-1===l.value?o.value:Math.min(o.value,n.value+l.value))),i=t.computed((()=>-1===l.value||0===o.value?1:Math.ceil(o.value/l.value)))
...
return t.provide(Eu,s),s}function Mu(e){const a=yt("usePaginatedItems"),{items:l,startIndex:o,stopIndex:n,itemsPerPage:r}=e,i=t.computed((()=>r.value<=0?l.value:l.value.slice(o.value,n.value)))
return t.watch(i,(e=>{a.emit("update:currentItems",e)}),{immediate:!0}),{paginatedItems:i}}const Ou={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
...
return zu.select({items:a,value:t,selected:l})}},ju=gt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:{type:Function,default:c}},"DataTable-select"),Hu=Symbol.for("vuetify:data-table-selection")
function Wu(e,a){let{allItems:l,currentPage:o}=a
const n=ia(e,"modelValue",e.modelValue,(t=>new Set(A(t).map((t=>l.value.find((a=>e.valueComparator(t,a.value)))?.value??t)))),(e=>[...e.values()])),r=t.computed((()=>l.value.filter((e=>e.selectable)))),i=t.computed((()=>o.value.filter((e=>e.selectable)))),s=t.computed((()=>{if("object"==typeof e.selectStrategy)return e.selectStrategy
...
return e}const Yu=gt({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),Gu=Symbol.for("vuetify:data-table-sort")
function qu(e){return{sortBy:ia(e,"sortBy"),mustSort:t.toRef(e,"mustSort"),multiSort:t.toRef(e,"multiSort")}}function Ku(e){const{sortBy:a,mustSort:l,multiSort:o,page:n}=e
...
return e}function Zu(e,a,l,o){const n=ha(),r=t.computed((()=>l.value.length?function(e,t,a,l){const o=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),n=e.map((e=>[e,l?.transform?l.transform(e):e]))
...
return{sortedItems:r}}const Qu=gt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
...
return a}(e,e.items)))
return{items:a}}const tc=gt({search:String,loading:Boolean,...ht(),...Qu(),...ju(),...Yu(),...Du({itemsPerPage:5}),...wu(),...Nu(),...$i(),...Ba(),...vl({transition:{component:Ha,hideOnLeave:!0}})},"VDataIterator"),ac=It()({name:"VDataIterator",props:tc(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
...
return $t((()=>{const a=oc.filterProps(e)
...
var sc,uc
const cc=gt({headers:Array},"DataTable-header"),dc=Symbol.for("vuetify:data-table-headers"),vc={title:"",sortable:!1},pc={...vc,width:48}
...
return e}const Sc=gt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,sortAscIcon:{type:Mt,default:"$sortAsc"},sortDescIcon:{type:Mt,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...kn(),...no()},"VDataTableHeaders"),kc=It()({name:"VDataTableHeaders",props:Sc(),setup(e,a){let{slots:l}=a
const{t:o}=ha(),{toggleSort:n,sortBy:r,isSorted:i}=Xu(),{someSelected:s,allSelected:u,selectAll:c,showSelectAll:d}=Uu(),{columns:v,headers:p}=wc(),{loaderClasses:m}=ro(e)
...
return l["data-table-group"]?.({item:e.item,count:d.value.length,props:{icon:a,onClick:r}})??t.createVNode(ic,{class:"v-data-table-group-header-row__column"},{default:()=>[t.createVNode(Eo,{size:"small",variant:"text",icon:a,onClick:r},null),t.createVNode("span",null,[e.item.value]),t.createVNode("span",null,[t.createTextVNode("("),d.value.length,t.createTextVNode(")")])]})}if("data-table-select"===a.key){const e=i(d.value),a=s(d.value)&&!e,o=e=>u(d.value,e)
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(en,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),Cc=gt({index:Number,item:Object,cellProps:[Object,Function],onClick:G(),onContextmenu:G(),onDblclick:G(),...kn()},"VDataTableRow"),_c=It()({name:"VDataTableRow",props:Cc(),setup(e,a){let{slots:l}=a
const{displayClasses:o,mobile:n}=xn(e,"v-data-table__tr"),{isSelected:r,toggleSelect:i,someSelected:s,allSelected:u,selectAll:c}=Uu(),{isExpanded:v,toggleExpand:p}=xu(),{toggleSort:f,sortBy:m,isSorted:g}=Xu(),{columns:h}=wc()
...
return n.value?t.createVNode(t.Fragment,null,[t.createVNode("div",{class:"v-data-table__td-title"},[l[b]?.(w)??a.title]),t.createVNode("div",{class:"v-data-table__td-value"},[l[y]?.(V)??e])]):e}})}))])))}}),Ic=gt({loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...kn()},"VDataTableRows"),Bc=It()({name:"VDataTableRows",inheritAttrs:!1,props:Ic(),setup(e,a){let{attrs:l,slots:o}=a
const{columns:n}=wc(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=xu(),{isSelected:u,toggleSelect:c}=Uu(),{toggleGroup:d,isGroupOpen:v}=Bu(),{t:p}=ha(),{mobile:f}=xn(e)
...
return o["group-header"]?o["group-header"](e):t.createVNode(Nc,t.mergeProps({key:`group-header_${a.id}`,item:a},Rt(l,":group-header",(()=>e))),o)}const m={index:p,item:a.raw,internalItem:a,columns:n.value,isExpanded:s,toggleExpand:i,isSelected:u,toggleSelect:c},g={...m,props:t.mergeProps({key:`item_${a.key??a.index}`,onClick:r.value?()=>{i(a)}:void 0,index:p,item:a,cellProps:e.cellProps,mobile:f.value},Rt(l,":row",(()=>m)),"function"==typeof e.rowProps?e.rowProps({item:m.item,index:m.index,internalItem:m.internalItem}):e.rowProps)}
return t.createVNode(t.Fragment,{key:g.props.key},[o.item?o.item(g):t.createVNode(_c,g.props,o),s(a)&&o["expanded-row"]?.(m)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),Pc=gt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...ht(),...Pl(),...Ba(),...wa()},"VTable"),Ac=It()({name:"VTable",props:Pc(),setup(e,a){let{slots:l,emit:o}=a
const{themeClasses:n}=ka(e),{densityClasses:r}=Al(e)
return $t((()=>t.createVNode(e.tag,{class:["v-table",{"v-table--fixed-height":!!e.height,"v-table--fixed-header":e.fixedHeader,"v-table--fixed-footer":e.fixedFooter,"v-table--has-top":!!l.top,"v-table--has-bottom":!!l.bottom,"v-table--hover":e.hover},n.value,r.value,e.class],style:e.style},{default:()=>[l.top?.(),l.default?t.createVNode("div",{class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[l.default()])]):l.wrapper?.(),l.bottom?.()]}))),{}}}),Rc=gt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},rowProps:[Object,Function],cellProps:[Object,Function],returnObject:Boolean},"DataTable-items")
...
return{type:"item",key:e.returnObject?v(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function Dc(e,a){return{items:t.computed((()=>Tc(e,e.items,a.value)))}}const Ec=gt({...Ic(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...wu(),...Nu(),...cc(),...Rc(),...ju(),...Yu(),...Sc(),...Pc()},"DataTable"),Fc=gt({...Du(),...Ec(),...$i(),...nc()},"VDataTable"),$c=It()({name:"VDataTable",props:Fc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
Tu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
Tu({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
$t((()=>{const a=kc.filterProps(e),n=Bc.filterProps(e),r=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(U.value),wrapper:()=>t.createVNode("div",{ref:F,onScrollPassive:j,onScrollend:H,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createVNode("table",null,[o.colgroup?.(U.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead"},[t.createVNode(kc,a,o)]),!e.hideDefaultBody&&t.createVNode("tbody",null,[t.createVNode("tr",{ref:$,style:{height:f(M.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(U.value),t.createVNode(Bc,t.mergeProps(l,n,{items:W.value}),{...o,item:e=>t.createVNode(Ci,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>z(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(_c,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(U.value),t.createVNode("tr",{style:{height:f(O.value),border:0}},[t.createVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])])])]),bottom:()=>o.bottom?.(U.value)})}))}}),Lc=gt({itemsLength:{type:[Number,String],required:!0},...Du(),...Ec(),...nc()},"VDataTableServer"),zc=It()({name:"VDataTableServer",props:Lc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
Tu({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef(e,"search")}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),Nt({VDataTableRows:{hideNoData:t.toRef(e,"hideNoData"),noDataText:t.toRef(e,"noDataText"),loading:t.toRef(e,"loading"),loadingText:t.toRef(e,"loadingText")}})
...
$t((()=>{const a=rc.filterProps(e),n=kc.filterProps(e),r=Bc.filterProps(e),i=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>o.top?.(T.value),default:()=>o.default?o.default(T.value):t.createVNode(t.Fragment,null,[o.colgroup?.(T.value),!e.hideDefaultHeader&&t.createVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(kc,n,o)]),o.thead?.(T.value),!e.hideDefaultBody&&t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(T.value),o.body?o.body(T.value):t.createVNode(Bc,t.mergeProps(l,r,{items:k.value}),o),o["body.append"]?.(T.value)]),o.tbody?.(T.value),o.tfoot?.(T.value)]),bottom:()=>o.bottom?o.bottom(T.value):!e.hideDefaultFooter&&t.createVNode(t.Fragment,null,[t.createVNode(fr,null,null),t.createVNode(rc,a,{prepend:o["footer.prepend"]})])})}))}}),jc=gt({fluid:{type:Boolean,default:!1},...ht(),...ll(),...Ba()},"VContainer"),Hc=It()({name:"VContainer",props:jc(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ba(),{dimensionStyles:n}=ol(e)
return $t((()=>t.createVNode(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},o.value,e.class],style:[n.value,e.style]},l))),{}}}),Wc=gn.reduce(((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e)),{}),Uc=gn.reduce(((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Yc=gn.reduce(((e,a)=>(e["order"+t.capitalize(a)]={type:[String,Number],default:null},e)),{}),Gc={col:Object.keys(Wc),offset:Object.keys(Uc),order:Object.keys(Yc)}
function qc(e,t,a){let l=e
if(null!=a&&!1!==a){if(t){l+=`-${t.replace(e,"")}`}return"col"===e&&(l="v-"+l),"col"!==e||""!==a&&!0!==a?(l+=`-${a}`,l.toLowerCase()):l.toLowerCase()}}const Kc=["auto","start","end","center","baseline","stretch"],Xc=gt({cols:{type:[Boolean,String,Number],default:!1},...Wc,offset:{type:[String,Number],default:null},...Uc,order:{type:[String,Number],default:null},...Yc,alignSelf:{type:String,default:null,validator:e=>Kc.includes(e)},...ht(),...Ba()},"VCol"),Zc=It()({name:"VCol",props:Xc(),setup(e,a){let{slots:l}=a
...
function s(){l("click:prev")}function u(){l("click:next")}function c(){l("click:year")}function d(){l("click:month")}return $t((()=>t.createVNode("div",{class:["v-date-picker-controls"]},[t.createVNode(Eo,{class:"v-date-picker-controls__month-btn",disabled:o.value,text:e.text,variant:"text",rounded:!0,onClick:d},null),t.createVNode(Eo,{key:"mode-btn",class:"v-date-picker-controls__mode-btn",disabled:n.value,density:"comfortable",icon:e.modeIcon,variant:"text",onClick:c},null),t.createVNode(md,{key:"mode-spacer"},null),t.createVNode("div",{key:"month-buttons",class:"v-date-picker-controls__month"},[t.createVNode(Eo,{disabled:r.value,icon:e.prevIcon,variant:"text",onClick:s},null),t.createVNode(Eo,{disabled:i.value,icon:e.nextIcon,variant:"text",onClick:u},null)])]))),{}}}),yd=gt({appendIcon:Mt,color:String,header:String,transition:String,onClick:G()},"VDatePickerHeader"),bd=It()({name:"VDatePickerHeader",props:yd(),emits:{click:()=>!0,"click:append":()=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return t.createVNode("div",{class:["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value],style:r.value,onClick:i},[o.prepend&&t.createVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(pl,{key:"content",name:e.transition},{default:()=>[t.createVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode(al,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(Eo,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),Vd=gt({allowedDates:[Array,Function],disabled:Boolean,displayValue:null,modelValue:Array,month:[Number,String],max:null,min:null,showAdjacentMonths:Boolean,year:[Number,String],weekdays:{type:Array,default:()=>[0,1,2,3,4,5,6]},weeksInMonth:{type:String,default:"dynamic"},firstDayOfWeek:[Number,String]},"calendar")
function wd(e){const a=yu(),l=ia(e,"modelValue",[],(e=>A(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=ia(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
return a.setMonth(l,t)}),(e=>a.getMonth(e))),i=t.computed((()=>e.firstDayOfWeek??e.weekdays[0])),s=t.computed((()=>{const t=Number(e.firstDayOfWeek??0)
return e.weekdays.map((e=>(e+t)%7))})),u=t.computed((()=>{const t=a.getWeekArray(r.value,i.value),l=t.flat()
...
function c(t,o){return t.filter((e=>s.value.includes(a.toJsDate(e).getDay()))).map(((t,n)=>{const i=a.toISO(t),s=!a.isSameMonth(t,r.value),u=a.isSameDay(t,a.startOfMonth(r.value)),c=a.isSameDay(t,a.endOfMonth(r.value)),d=a.isSameDay(t,r.value)
return{date:t,isoDate:i,formatted:a.format(t,"keyboardDate"),year:a.getYear(t),month:a.getMonth(t),isDisabled:f(t),isWeekStart:n%7==0,isWeekEnd:n%7==6,isToday:a.isSameDay(t,o),isAdjacent:s,isHidden:s&&!e.showAdjacentMonths,isStart:u,isSelected:l.value.some((e=>a.isSameDay(t,e))),isEnd:c,isSame:d,localized:a.format(t,"dayOfMonth")}}))}const d=t.computed((()=>{const t=a.startOfWeek(o.value,e.firstDayOfWeek),l=[]
for(let e=0;e<=6;e++)l.push(a.addDays(t,e))
return c(l,a.date())})),v=t.computed((()=>c(u.value.flat(),a.date()))),p=t.computed((()=>u.value.map((e=>e.length?function(e,t){const a=e.toJsDate(t)
...
const l=a.date(t)
return!(!e.min||!a.isAfter(a.date(e.min),l))||(!(!e.max||!a.isAfter(l,a.date(e.max)))||(Array.isArray(e.allowedDates)&&e.allowedDates.length>0?!e.allowedDates.some((e=>a.isSameDay(a.date(e),l))):"function"==typeof e.allowedDates&&!e.allowedDates(l)))}return{displayValue:o,daysInMonth:v,daysInWeek:d,genDays:c,model:l,weeksInMonth:u,weekDays:s,weekNumbers:p}}const Sd=gt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},...Vd()},"VDatePickerMonth"),kd=It()({name:"VDatePickerMonth",props:Sd(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
r.value=e}(n)}
return o.month?.({month:a,i:n,props:i})??t.createVNode(Eo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Cd=gt({color:String,height:[String,Number],min:null,max:null,modelValue:Number},"VDatePickerYears"),_d=It()({name:"VDatePickerYears",props:Cd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=yu(),r=ia(e,"modelValue"),i=t.computed((()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
return o.year?.({year:a,i:n,props:i})??t.createVNode(Eo,t.mergeProps({key:"month"},i),null)}))])]))),{}}}),Id=Bt("v-picker-title"),Bd=gt({bgColor:String,landscape:Boolean,title:String,hideHeader:Boolean,...Js()},"VPicker"),Pd=It()({name:"VPicker",props:Bd(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color"))
return $t((()=>{const a=eu.filterProps(e),r=!(!e.title&&!l.title)
return t.createVNode(eu,t.mergeProps(a,{color:e.bgColor,class:["v-picker",{"v-picker--landscape":e.landscape,"v-picker--with-actions":!!l.actions},e.class],style:e.style}),{default:()=>[!e.hideHeader&&t.createVNode("div",{key:"header",class:[o.value],style:[n.value]},[r&&t.createVNode(Id,{key:"picker-title"},{default:()=>[l.title?.()??e.title]}),l.header&&t.createVNode("div",{class:"v-picker__header"},[l.header()])]),t.createVNode("div",{class:"v-picker__body"},[l.default?.()]),l.actions&&t.createVNode(al,{defaults:{VBtn:{slim:!0,variant:"text"}}},{default:()=>[t.createVNode("div",{class:"v-picker__actions"},[l.actions()])]})]})})),{}}}),Ad=gt({header:{type:String,default:"$vuetify.datePicker.header"},...gd(),...Sd({weeksInMonth:"static"}),...x(xd(),["modelValue"]),...x(Cd(),["modelValue"]),...Bd({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Rd=It()({name:"VDatePicker",props:Ad(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,a){let{emit:l,slots:o}=a
const n=yu(),{t:r}=ha(),i=ia(e,"modelValue",void 0,(e=>A(e)),(t=>e.multiple?t:t[0])),s=ia(e,"viewMode"),u=t.computed((()=>{const e=n.date(i.value?.[0])
...
i!==c.value&&(c.value=i,N(c.value)),s!==d.value&&(d.value=s,C(d.value)),v.value=n.isBefore(o,r)})),$t((()=>{const a=Pd.filterProps(e),l=hd.filterProps(e),n=bd.filterProps(e),u=kd.filterProps(e),v=x(Nd.filterProps(e),["modelValue"]),_=x(_d.filterProps(e),["modelValue"]),I={header:p.value,transition:m.value}
return t.createVNode(Pd,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(al,{defaults:{VDatePickerHeader:{...I}}},{default:()=>[o.header?.(I)]}):t.createVNode(bd,t.mergeProps({key:"header"},n,I,{onClick:"month"!==s.value?w:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(hd,t.mergeProps(l,{disabled:y.value,text:f.value,"onClick:next":b,"onClick:prev":V,"onClick:month":S,"onClick:year":k}),null),t.createVNode(Ha,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Nd,t.mergeProps({key:"date-picker-months"},v,{modelValue:c.value,"onUpdate:modelValue":[e=>c.value=e,N],min:g.value,max:h.value,year:d.value}),null):"year"===s.value?t.createVNode(_d,t.mergeProps({key:"date-picker-years"},_,{modelValue:d.value,"onUpdate:modelValue":[e=>d.value=e,C],min:g.value,max:h.value}),null):t.createVNode(kd,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:c.value,"onUpdate:month":[e=>c.value=e,N],year:d.value,"onUpdate:year":[e=>d.value=e,C],min:g.value,max:h.value}),null)]})]),actions:o.actions})})),{}}}),Td=gt({actionText:String,bgColor:String,color:String,icon:Mt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...ht(),...ll(),...Gl({size:void 0}),...wa()},"VEmptyState"),Dd=It()({name:"VEmptyState",props:Td(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return $t((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--focusable":e.focusable,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,i.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(s.value),!e.hideActions&&t.createVNode(al,{defaults:{VIcon:{icon:u.value}}},{default:()=>[t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?.(s.value)??t.createVNode(Xl,null,null)])]})]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Ld=gt({title:String,text:String,bgColor:String,...Vl(),...Ol(),...cl(),...Ba(),...Md(),...Fd()},"VExpansionPanel"),zd=It()({name:"VExpansionPanel",props:Ld(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Ll(e,Ed),{backgroundColorClasses:n,backgroundColorStyles:r}=ul(e,"bgColor"),{elevationClasses:i}=wl(e),{roundedClasses:s}=dl(e),u=t.computed((()=>o?.disabled.value||e.disabled)),c=t.computed((()=>o.group.items.value.reduce(((e,t,a)=>(o.group.selected.value.includes(t.id)&&e.push(a),e)),[]))),d=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==1))})),v=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
return!o.isSelected.value&&c.value.some((t=>t-e==-1))}))
return t.provide(Ed,o),$t((()=>{const a=!(!l.text&&!e.text),c=!(!l.title&&!e.title),p=Od.filterProps(e),f=$d.filterProps(e)
return t.createVNode(e.tag,{class:["v-expansion-panel",{"v-expansion-panel--active":o.isSelected.value,"v-expansion-panel--before-active":d.value,"v-expansion-panel--after-active":v.value,"v-expansion-panel--disabled":u.value},s.value,n.value,e.class],style:[r.value,e.style]},{default:()=>[t.createVNode("div",{class:["v-expansion-panel__shadow",...i.value]},null),t.createVNode(al,{defaults:{VExpansionPanelTitle:{...p},VExpansionPanelText:{...f}}},{default:()=>[c&&t.createVNode(Od,{key:"title"},{default:()=>[l.title?l.title():e.title]}),a&&t.createVNode($d,{key:"text"},{default:()=>[l.text?l.text():e.text]}),l.default?.()]})]})})),{groupItem:o}}}),jd=["default","accordion","inset","popout"],Hd=gt({flat:Boolean,...Ml(),...S(Ld(),["bgColor","collapseIcon","color","eager","elevation","expandIcon","focusable","hideActions","readonly","ripple","rounded","tile","static"]),...wa(),...ht(),...Ba(),variant:{type:String,default:"default",validator:e=>jd.includes(e)}},"VExpansionPanels"),Wd=It()({name:"VExpansionPanels",props:Hd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{next:o,prev:n}=zl(e,Ed),{themeClasses:r}=ka(e),i=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return Nt({VExpansionPanel:{bgColor:t.toRef(e,"bgColor"),collapseIcon:t.toRef(e,"collapseIcon"),color:t.toRef(e,"color"),eager:t.toRef(e,"eager"),elevation:t.toRef(e,"elevation"),expandIcon:t.toRef(e,"expandIcon"),focusable:t.toRef(e,"focusable"),hideActions:t.toRef(e,"hideActions"),readonly:t.toRef(e,"readonly"),ripple:t.toRef(e,"ripple"),rounded:t.toRef(e,"rounded"),static:t.toRef(e,"static")}}),$t((()=>t.createVNode(e.tag,{class:["v-expansion-panels",{"v-expansion-panels--flat":e.flat,"v-expansion-panels--tile":e.tile},r.value,i.value,e.class],style:e.style},{default:()=>[l.default?.({prev:n,next:o})]}))),{next:o,prev:n}}}),Ud=gt({app:Boolean,appear:Boolean,extended:Boolean,layout:Boolean,offset:Boolean,modelValue:{type:Boolean,default:!0},...x(Do({active:!0}),["location"]),...aa(),...to(),...vl({transition:"fab-transition"})},"VFab"),Yd=It()({name:"VFab",props:Ud(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{ref:d,class:["v-fab",{"v-fab--absolute":e.absolute,"v-fab--app":!!e.app,"v-fab--extended":e.extended,"v-fab--offset":e.offset,[`v-fab--${u.value}`]:s.value,[`v-fab--${c.value}`]:s.value},e.class],style:[e.app?{...r.value}:{height:e.absolute?"100%":"inherit"},e.style]},[t.createVNode("div",{class:"v-fab__container"},[t.createVNode(pl,{appear:e.appear,transition:e.transition},{default:()=>[t.withDirectives(t.createVNode(Eo,t.mergeProps({ref:i},a,{active:void 0,location:void 0}),l),[[t.vShow,e.active]])]})])])})),{}}}),Gd=gt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},...vn({prependIcon:"$file"}),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>A(e).every((e=>null!=e&&"object"==typeof e))},...bi({clearable:!0})},"VFileInput"),qd=It()({name:"VFileInput",inheritAttrs:!1,props:Gd(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
t.watchEffect((()=>{o.value=a.layoutItemStyles.value}))})),$t((()=>t.createVNode(e.tag,{ref:v,class:["v-footer",n.value,r.value,s.value,u.value,c.value,e.class],style:[i.value,e.app?o.value:{height:f(e.height)},e.style]},l))),{}}}),Zd=gt({...ht(),...sn()},"VForm"),Qd=It()({name:"VForm",props:Zd(),emits:{"update:modelValue":e=>!0,submit:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
t&&r.value?.submit()})),t.preventDefault()}return $t((()=>t.createVNode("form",{ref:r,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),di(n,r)}}),Jd=gt({disabled:Boolean,modelValue:{type:Boolean,default:null},...Wr()},"VHover"),ev=It()({name:"VHover",props:Jd(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=ia(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=Ur(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),tv=gt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...ll(),...Ba()},"VInfiniteScroll"),av=_t({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
const{intersectionRef:o,isIntersecting:n}=Zl()
return t.watch(n,(async t=>{l("intersect",e.side,t)})),$t((()=>t.createVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:o},[t.createTextVNode(" ")]))),{}}}),lv=It()({name:"VInfiniteScroll",props:tv(),emits:{load:e=>!0},setup(e,a){let{slots:l,emit:o}=a
...
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),o&&c&&t.createVNode(av,{key:"start",side:"start",onIntersect:m,rootMargin:s.value},null),l.default?.(),u&&c&&t.createVNode(av,{key:"end",side:"end",onIntersect:m,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),ov=Symbol.for("vuetify:v-item-group"),nv=gt({...ht(),...Ml({selectedClass:"v-item--selected"}),...Ba(),...wa()},"VItemGroup"),rv=It()({name:"VItemGroup",props:nv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=ka(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=zl(e,ov)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),iv=It()({name:"VItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=Ll(e,ov)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),sv=Bt("v-kbd","kbd"),uv=gt({...ht(),...ll(),...ta()},"VLayout"),cv=It()({name:"VLayout",props:uv(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=na(e),{dimensionStyles:u}=ol(e)
return $t((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[u.value,n.value,e.style]},[l.default?.()]))),{getLayoutItem:r,items:i}}}),dv=gt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...ht(),...aa()},"VLayoutItem"),vv=It()({name:"VLayoutItem",props:dv(),setup(e,a){let{slots:l}=a
...
return()=>t.createVNode("div",{class:["v-layout-item",e.class],style:[o.value,e.style]},[l.default?.()])}}),pv=gt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...ht(),...ll(),...Ba(),...vl({transition:"fade-transition"})},"VLazy"),fv=It()({name:"VLazy",directives:{intersect:ml},props:pv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{dimensionStyles:o}=ol(e),n=ia(e,"modelValue")
function r(e){n.value||(n.value=e)}return $t((()=>t.withDirectives(t.createVNode(e.tag,{class:["v-lazy",e.class],style:[o.value,e.style]},{default:()=>[n.value&&t.createVNode(pl,{transition:e.transition,appear:!0},{default:()=>[l.default?.()]})]}),[[t.resolveDirective("intersect"),{handler:r,options:e.options},null]]))),{}}}),mv=gt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...ht()},"VLocaleProvider"),gv=It()({name:"VLocaleProvider",props:mv(),setup(e,a){let{slots:l}=a
const{rtlClasses:o}=ya(e)
return $t((()=>t.createVNode("div",{class:["v-locale-provider",o.value,e.class],style:e.style},[l.default?.()]))),{}}}),hv=gt({scrollable:Boolean,...ht(),...ll(),...Ba({tag:"main"})},"VMain"),yv=It()({name:"VMain",props:hv(),setup(e,a){let{slots:l}=a
...
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function xv(){throw new Error}const Nv=["start","end","left","right","top","bottom"],Cv=gt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>Nv.includes(e)},sticky:Boolean,...yl(),...ht(),...Wr(),...kn({mobile:null}),...Vl(),...aa(),...cl(),...Ba({tag:"nav"}),...wa()},"VNavigationDrawer"),_v=It()({name:"VNavigationDrawer",props:Cv(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
const Av=gt({scale:{type:[Number,String],default:.5},...ht()},"VParallax"),Rv=It()({name:"VParallax",props:Av(),setup(e,a){let{slots:l}=a
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return $t((()=>t.createVNode(hl,{class:["v-parallax",{"v-parallax--active":n.value},e.class],style:e.style,ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),Tv=gt({...Zo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Dv=It()({name:"VRadio",props:Tv(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=Qo.filterProps(e)
return t.createVNode(Qo,t.mergeProps(a,{class:["v-radio",e.class],style:e.style,type:"radio"}),l)})),{}}}),Ev=gt({height:{type:[Number,String],default:"auto"},...vn(),...x(qo(),["multiple"]),trueIcon:{type:Mt,default:"$radioOn"},falseIcon:{type:Mt,default:"$radioOff"},type:{type:String,default:"radio"}},"VRadioGroup"),Fv=It()({name:"VRadioGroup",inheritAttrs:!1,props:Ev(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const n=St(),r=t.computed((()=>e.id||`radio-group-${n}`)),i=ia(e,"modelValue")
return $t((()=>{const[a,n]=P(l),s=pn.filterProps(e),u=Qo.filterProps(e),c=o.label?o.label({label:e.label,props:{for:r.value}}):e.label
...
return t.createVNode(t.Fragment,null,[c&&t.createVNode(Yo,{id:l.value},{default:()=>[c]}),t.createVNode(Xo,t.mergeProps(u,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:d.value,"aria-labelledby":c?l.value:void 0,multiple:!1},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),$v=gt({...on(),...vn(),...Ls(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),Mv=It()({name:"VRangeSlider",props:$v(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=ba()
const u=zs(e),c=ia(e,"modelValue",void 0,(e=>e?.length?e.map((e=>u.roundValue(e))):[0,0])),{activeThumbRef:d,hasLabels:v,max:p,min:f,mousePressed:m,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b,readonly:V}=js({props:e,steps:u,onSliderStart:()=>{o("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
a.includes(",")?t=Uv(a):a.includes("@")?t=Hv(a):a&&t.push(Wv(a))}return[jv(e,t)]}function Uv(e){return e.replace(/\s/g,"").split(",").map(Wv)}const Yv=gt({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...ll(),...Vl(),...wa()},"VSkeletonLoader"),Gv=It()({name:"VSkeletonLoader",props:Yv(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color")),{dimensionStyles:r}=ol(e),{elevationClasses:i}=wl(e),{themeClasses:s}=ka(e),{t:u}=ha(),c=t.computed((()=>Wv(A(e.type).join(","))))
return $t((()=>{const a=!l.default||e.loading,d=e.boilerplate||!a?{}:{ariaLive:"polite",ariaLabel:u(e.loadingText),role:"alert"}
return t.createVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,o.value,i.value],style:[n.value,a?r.value:{}]},d),[a?c.value:l.default?.()])})),{}}}),qv=It()({name:"VSlideGroupItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const l=Ll(e,Dn)
return()=>a.default?.({isSelected:l.isSelected.value,select:l.select,toggle:l.toggle,selectedClass:l.selectedClass.value})}})
const Kv=gt({multiLine:Boolean,text:String,timer:[Boolean,String],timeout:{type:[Number,String],default:5e3},vertical:Boolean,...to({location:"bottom"}),...uo(),...cl(),...Dl(),...wa(),...x(ii({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","scrim","scrollStrategy"])},"VSnackbar"),Xv=It()({name:"VSnackbar",props:Kv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
a.value=Math.max(e()-t,0),a.value<=0&&o()}),r)},reset:function(){o(),t.nextTick((()=>a.value=e()))}}}((()=>Number(e.timeout))),p=t.ref(),f=t.ref(),m=t.shallowRef(!1),g=t.shallowRef(0),y=t.ref(),b=t.inject(Jt,void 0)
ra((()=>!!b),(()=>{const e=la()
...
return{x:t.x+r*a,y:t.y+i*a}}const op=gt({fill:Boolean,...Zv()},"VTrendline"),np=It()({name:"VTrendline",props:op(),setup(e,a){let{slots:l}=a
...
return ep(u(m.value,f.value),a,t,parseInt(e.height,10))}t.watch((()=>e.modelValue),(async()=>{if(await t.nextTick(),!e.autoDraw||!s.value)return
...
$t((()=>{const a="trend"===e.type?np:Jv,r="trend"===e.type?np.filterProps(e):Jv.filterProps(e)
return t.createVNode(a,t.mergeProps({key:e.type,class:o.value,style:n.value,viewBox:`0 0 ${e.width} ${parseInt(i.value,10)}`},r),l)}))}}),sp=gt({...ht(),...vi({offset:8,minWidth:0,openDelay:0,closeDelay:100,location:"top center",transition:"scale-transition"})},"VSpeedDial"),up=It()({name:"VSpeedDial",props:sp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(pi,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:e.class,style:e.style,contentClass:["v-speed-dial__content",i.value,e.contentClass],location:r.value,ref:n,transition:"fade-transition"}),{...l,default:a=>t.createVNode(al,{defaults:{VBtn:{size:"small"}}},{default:()=>[t.createVNode(pl,{appear:!0,group:!0,transition:e.transition},{default:()=>[l.default?.(a)]})]})})})),{}}}),cp=Symbol.for("vuetify:v-stepper"),dp=gt({color:String,disabled:{type:[Boolean,String],default:!1},prevText:{type:String,default:"$vuetify.stepper.prev"},nextText:{type:String,default:"$vuetify.stepper.next"}},"VStepperActions"),vp=It()({name:"VStepperActions",props:dp(),emits:{"click:prev":()=>!0,"click:next":()=>!0},setup(e,a){let{emit:l,slots:o}=a
const{t:n}=ha()
function r(){l("click:prev")}function i(){l("click:next")}return $t((()=>{const a={onClick:r},l={onClick:i}
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode(al,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(Eo,a,null)]}),t.createVNode(al,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(Eo,l,null)]})])})),{}}}),pp=Bt("v-stepper-header"),fp=gt({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Mt,default:"$complete"},editable:Boolean,editIcon:{type:Mt,default:"$edit"},error:Boolean,errorIcon:{type:Mt,default:"$error"},icon:Mt,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),mp=gt({...fp(),...Ol()},"VStepperItem"),gp=It()({name:"VStepperItem",directives:{Ripple:To},props:mp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Ll(e,cp,!0),n=t.computed((()=>o?.value.value??e.value)),r=t.computed((()=>e.rules.every((e=>!0===e())))),i=t.computed((()=>!e.disabled&&e.editable)),s=t.computed((()=>!e.disabled&&e.editable)),u=t.computed((()=>e.error||!r.value)),c=t.computed((()=>e.complete||e.rules.length>0&&r.value)),d=t.computed((()=>u.value?e.errorIcon:c.value?e.completeIcon:o.isSelected.value&&e.editable?e.editIcon:e.icon)),v=t.computed((()=>({canEdit:s.value,hasError:u.value,hasCompleted:c.value,title:e.title,subtitle:e.subtitle,step:n.value,value:e.value})))
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":c.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":u.value},o?.selectedClass.value],disabled:!e.editable,type:"button",onClick:function(){o?.toggle()}},[i.value&&Tl(!0,"v-stepper-item"),t.createVNode(Wo,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(v.value)??(d.value?t.createVNode(Xl,{icon:d.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(v.value)??e.title]),p&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(v.value)??e.subtitle]),l.default?.(v.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),hp=gt({...x(ws(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),yp=It()({name:"VStepperWindow",props:hp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(cp,null),n=ia(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return $t((()=>{const a=Ss.filterProps(e)
return t.createVNode(Ss,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),bp=gt({...Ns()},"VStepperWindowItem"),Vp=It()({name:"VStepperWindowItem",props:bp(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({_as:"VStepperWindowItem"},a,{class:["v-stepper-window-item",e.class],style:e.style}),l)})),{}}}),wp=gt({altLabels:Boolean,bgColor:String,completeIcon:Mt,editIcon:Mt,editable:Boolean,errorIcon:Mt,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},nonLinear:Boolean,flat:Boolean,...kn()},"Stepper"),Sp=gt({...wp(),...Ml({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...Js(),...N(dp(),["prevText","nextText"])},"VStepper"),kp=It()({name:"VStepper",props:Sp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=zl(e,cp),{displayClasses:s,mobile:u}=xn(e),{completeIcon:c,editIcon:d,errorIcon:p,color:f,editable:m,prevText:g,nextText:h}=t.toRefs(e),y=t.computed((()=>e.items.map(((t,a)=>({title:v(t,e.itemTitle,t),value:v(t,e.itemValue,a+1),raw:t}))))),b=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
return Nt({VStepperItem:{editable:m,errorIcon:p,completeIcon:c,editIcon:d,prevText:g,nextText:h},VStepperActions:{color:f,disabled:t.computed((()=>e.disabled?e.disabled:0===b.value?"prev":b.value===o.value.length-1&&"next")),prevText:g,nextText:h}}),$t((()=>{const a=eu.filterProps(e),o=!(!l.header&&!e.items.length),i=e.items.length>0,c=!(e.hideActions||!i&&!l.actions)
...
return t.createVNode(t.Fragment,null,[!!a&&t.createVNode(fr,null,null),t.createVNode(gp,n,{default:l[`header-item.${n.value}`]??l.header,icon:l.icon,title:l.title,subtitle:l.subtitle})])}))]}),i&&t.createVNode(yp,{key:"stepper-window"},{default:()=>[y.value.map((e=>t.createVNode(Vp,{value:e.value},{default:()=>l[`item.${e.value}`]?.(e)??l.item?.(e)})))]}),l.default?.({prev:r,next:n}),c&&(l.actions?.({next:n,prev:r})??t.createVNode(vp,{key:"stepper-actions","onClick:prev":r,"onClick:next":n},l))]})})),{prev:r,next:n}}}),xp=gt({indeterminate:Boolean,inset:Boolean,flat:Boolean,loading:{type:[Boolean,String],default:!1},...vn(),...Zo()},"VSwitch"),Np=It()({name:"VSwitch",inheritAttrs:!1,props:xp(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:indeterminate":e=>!0},setup(e,l){let{attrs:o,slots:n}=l
...
function h(){r.value&&(r.value=!1)}function y(e){e.stopPropagation(),e.preventDefault(),v.value?.input?.click()}return $t((()=>{const[a,l]=P(o),m=pn.filterProps(e),b=Qo.filterProps(e)
...
return t.createVNode(t.Fragment,null,[l,t.createVNode("div",{class:["v-switch__thumb",{"v-switch__thumb--filled":o||e.loading},e.inset||p?void 0:r.value],style:e.inset?void 0:i.value},[n.thumb?t.createVNode(al,{defaults:{VIcon:{icon:o,size:"x-small"}}},{default:()=>[n.thumb({...V,icon:o})]}):t.createVNode(Wa,null,{default:()=>[e.loading?t.createVNode(io,{name:"v-switch",active:!0,color:!1===g.value?void 0:f.value},{default:e=>n.loader?n.loader(e):t.createVNode(Jl,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):o&&t.createVNode(Xl,{key:String(o),icon:o,size:"x-small"},null)]})])])}})}})})),{}}}),Cp=gt({color:String,height:[Number,String],window:Boolean,...ht(),...Vl(),...aa(),...cl(),...Ba(),...wa()},"VSystemBar"),_p=It()({name:"VSystemBar",props:Cp(),setup(e,a){let{slots:l}=a
...
return $t((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value,e.class],style:[r.value,d.value,u.value,e.style]},l))),{}}}),Ip=Symbol.for("vuetify:v-tabs"),Bp=gt({fixed:Boolean,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...x(Do({selectedClass:"v-tab--selected",variant:"text"}),["active","block","flat","location","position","symbol"])},"VTab"),Pp=It()({name:"VTab",props:Bp(),setup(e,a){let{slots:l,attrs:o}=a
...
he(t,{backgroundColor:[a,"currentcolor"],transform:[`translate${r}(${v}px) scale${r}(${l[d]/o[d]||0})`,`translate${r}(${v/m}px) scale${r}(${(f-1)/m+1})`,"none"],transformOrigin:Array(3).fill(p)},{duration:225,easing:At})}}return $t((()=>{const a=Eo.filterProps(e)
return t.createVNode(Eo,t.mergeProps({symbol:Ip,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),di({},i)}}),Ap=gt({...x(ws(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Rp=It()({name:"VTabsWindow",props:Ap(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Ip,null),n=ia(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return $t((()=>{const a=Ss.filterProps(e)
return t.createVNode(Ss,t.mergeProps({_as:"VTabsWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),l)})),{}}}),Tp=gt({...Ns()},"VTabsWindowItem"),Dp=It()({name:"VTabsWindowItem",props:Tp(),setup(e,a){let{slots:l}=a
return $t((()=>{const a=Cs.filterProps(e)
return t.createVNode(Cs,t.mergeProps({_as:"VTabsWindowItem"},a,{class:["v-tabs-window-item",e.class],style:e.style}),l)})),{}}})
const Ep=gt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...En({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Pl(),...Ba()},"VTabs"),Fp=It()({name:"VTabs",props:Ep(),emits:{"update:modelValue":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return t.watchEffect((()=>{e.autoGrow||(N.value=+e.rows)})),t.onMounted(_),t.watch(r,_),t.watch((()=>e.rows),_),t.watch((()=>e.maxRows),_),t.watch((()=>e.density),_),t.watch(x,(e=>{e?(I=new ResizeObserver(_),I.observe(x.value)):I?.disconnect()})),t.onBeforeUnmount((()=>{I?.disconnect()})),$t((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,f]=P(l),{modelValue:_,...I}=pn.filterProps(e),B=wi(e)
...
case"end":return t[1]
default:return null}}))
return $t((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,i.value,r.value,e.class],style:[{"--v-timeline-line-thickness":f(e.lineThickness)},e.style]},l))),{}}}),Gp=gt({...ht(),...Dl({variant:"text"})},"VToolbarItems"),qp=It()({name:"VToolbarItems",props:Gp(),setup(e,a){let{slots:l}=a
return Nt({VBtn:{color:t.toRef(e,"color"),height:"inherit",variant:t.toRef(e,"variant")}}),$t((()=>t.createVNode("div",{class:["v-toolbar-items",e.class],style:e.style},[l.default?.()]))),{}}}),Kp=gt({id:String,text:String,...x(ii({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:!1}),["absolute","persistent"])},"VTooltip"),Xp=It()({name:"VTooltip",props:Kp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})})),di({},s)}}),Zp=It()({name:"VValidation",props:cn(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=dn(e,"validation")
return()=>a.default?.(l)}})
var Qp=Object.freeze({__proto__:null,VAlert:jo,VAlertTitle:Oo,VApp:Ia,VAppBar:Il,VAppBarNavIcon:$o,VAppBarTitle:Mo,VAutocomplete:Li,VAvatar:Wo,VBadge:ji,VBanner:Gi,VBannerActions:Wi,VBannerText:Ui,VBottomNavigation:Ki,VBottomSheet:Ji,VBreadcrumbs:ns,VBreadcrumbsDivider:ts,VBreadcrumbsItem:ls,VBtn:Eo,VBtnGroup:$l,VBtnToggle:Ul,VCard:ms,VCardActions:rs,VCardItem:ds,VCardSubtitle:ss,VCardText:ps,VCardTitle:us,VCarousel:xs,VCarouselItem:Is,VCheckbox:mn,VCheckboxBtn:en,VChip:zn,VChipGroup:On,VClassIcon:Wt,VCode:Bs,VCol:Zc,VColorPicker:tu,VCombobox:lu,VComponentIcon:zt,VConfirmEdit:Vu,VContainer:Hc,VCounter:mi,VDataIterator:ac,VDataTable:$c,VDataTableFooter:rc,VDataTableHeaders:kc,VDataTableRow:_c,VDataTableRows:Bc,VDataTableServer:zc,VDataTableVirtual:Oc,VDatePicker:Rd,VDatePickerControls:hd,VDatePickerHeader:bd,VDatePickerMonth:kd,VDatePickerMonths:Nd,VDatePickerYears:_d,VDefaultsProvider:al,VDialog:Zi,VDialogBottomTransition:za,VDialogTopTransition:ja,VDialogTransition:$a,VDivider:fr,VEmptyState:Dd,VExpandTransition:Ja,VExpandXTransition:el,VExpansionPanel:zd,VExpansionPanelText:$d,VExpansionPanelTitle:Od,VExpansionPanels:Wd,VFab:Yd,VFabTransition:La,VFadeTransition:Ha,VField:Vi,VFieldLabel:hi,VFileInput:qd,VFooter:Xd,VForm:Qd,VHover:ev,VIcon:Xl,VImg:hl,VInfiniteScroll:lv,VInput:pn,VItem:iv,VItemGroup:rv,VKbd:sv,VLabel:Yo,VLayout:cv,VLayoutItem:vv,VLazy:fv,VLigatureIcon:Ht,VList:xr,VListGroup:nr,VListImg:Nr,VListItem:cr,VListItemAction:_r,VListItemMedia:Br,VListItemSubtitle:ir,VListItemTitle:sr,VListSubheader:vr,VLocaleProvider:gv,VMain:yv,VMenu:pi,VMessages:ln,VNavigationDrawer:_v,VNoSsr:Iv,VOtpInput:Pv,VOverlay:si,VPagination:oc,VParallax:Rv,VProgressCircular:Jl,VProgressLinear:oo,VRadio:Dv,VRadioGroup:Fv,VRangeSlider:Mv,VRating:Lv,VResponsive:rl,VRow:fd,VScaleTransition:Wa,VScrollXReverseTransition:Ya,VScrollXTransition:Ua,VScrollYReverseTransition:qa,VScrollYTransition:Ga,VSelect:Ei,VSelectionControl:Qo,VSelectionControlGroup:Xo,VSheet:eu,VSkeletonLoader:Gv,VSlideGroup:Fn,VSlideGroupItem:qv,VSlideXReverseTransition:Xa,VSlideXTransition:Ka,VSlideYReverseTransition:Qa,VSlideYTransition:Za,VSlider:qs,VSnackbar:Xv,VSpacer:md,VSparkline:ip,VSpeedDial:up,VStepper:kp,VStepperActions:vp,VStepperHeader:pp,VStepperItem:gp,VStepperWindow:yp,VStepperWindowItem:Vp,VSvgIcon:jt,VSwitch:Np,VSystemBar:_p,VTab:Pp,VTable:Ac,VTabs:Fp,VTabsWindow:Rp,VTabsWindowItem:Dp,VTextField:xi,VTextarea:Mp,VThemeProvider:Lp,VTimeline:Yp,VTimelineItem:Wp,VToolbar:xl,VToolbarItems:qp,VToolbarTitle:Aa,VTooltip:Xp,VValidation:Zp,VVirtualScroll:Pi,VWindow:Ss,VWindowItem:Cs})
...
a.delete(o)}return!1}
if(!l([t.subTree]))return Me("Could not find original vnode, component will not inherit provides"),t
...
var rf=Object.freeze({__proto__:null,ClickOutside:ni,Intersect:ml,Mutate:ef,Resize:tf,Ripple:To,Scroll:of,Tooltip:nf,Touch:ys})
function sf(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:l,...o}=e,n=$(l,o),{aliases:r={},components:i={},directives:s={}}=n,u=function(e){return t.ref(e)}(n.defaults),c=function(e,l){const{thresholds:o,mobileBreakpoint:n}=bn(e),r=t.shallowRef(wn(l)),i=t.shallowRef(Sn(l)),s=t.reactive({}),u=t.shallowRef(Vn(l))
...
if(d.install(e),e.provide(kt,u),e.provide(hn,c),e.provide(Va,d),e.provide(Ot,v),e.provide(ma,p),e.provide(mu,f.options),e.provide(gu,f.instance),e.provide(Nn,m),a&&n.ssr)if(e.$nuxt)e.$nuxt.hook("app:suspense:resolve",(()=>{c.update()}))
...
if(a&&e in a)return a[e]}sf.version="3.7.10"
const cf=function(){return sf({components:Qp,directives:rf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},df="3.7.10"
