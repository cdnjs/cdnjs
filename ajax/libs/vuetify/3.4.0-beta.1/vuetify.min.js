...
At((()=>{const a=Uu.filterProps(e),l=Zu.filterProps(e),n=Qu.filterProps(e)
return t.createVNode(Qu,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},n),{top:()=>o.top?.(H.value),wrapper:()=>t.createVNode("div",{ref:E,onScrollPassive:O,onScrollend:z,class:"v-table__wrapper",style:{height:h(e.height)}},[t.createVNode("table",null,[t.createVNode("thead",null,[t.createVNode(Uu,t.mergeProps(a,{sticky:e.fixedHeader}),o)]),t.createVNode("tbody",null,[t.createVNode("tr",{ref:D,style:{height:h($.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(H.value),t.createVNode(Zu,t.mergeProps(l,{items:j.value}),{...o,item:e=>t.createVNode(li,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>L(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Ku,t.mergeProps(e.props,{ref:l,key:e.internalItem.index}),o)}})}),o["body.append"]?.(H.value),t.createVNode("tr",{style:{height:h(M.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)])])])]),bottom:()=>o.bottom?.(H.value)})}))}}),sc=a({itemsLength:{type:[Number,String],required:!0},...Ys(),...lc(),..._u()},"VDataTableServer"),uc=gt()({name:"VDataTableServer",props:sc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
At((()=>{const a=Iu.filterProps(e),l=Uu.filterProps(e),n=Zu.filterProps(e),r=Qu.filterProps(e)
return t.createVNode(Qu,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r),{top:()=>o.top?.(R.value),default:()=>o.default?o.default(R.value):t.createVNode(t.Fragment,null,[o.colgroup?.(R.value),t.createVNode("thead",{class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(Uu,t.mergeProps(l,{sticky:e.fixedHeader}),o)]),o.thead?.(R.value),t.createVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[o["body.prepend"]?.(R.value),o.body?o.body(R.value):t.createVNode(Zu,t.mergeProps(n,{items:w.value}),o),o["body.append"]?.(R.value)]),o.tbody?.(R.value),o.tfoot?.(R.value)]),bottom:()=>o.bottom?o.bottom(R.value):t.createVNode(Iu,a,{prepend:o["footer.prepend"]})})}))}}),cc=a({fluid:{type:Boolean,default:!1},...l(),...da()},"VContainer"),dc=gt()({name:"VContainer",props:cc(),setup(e,a){let{slots:l}=a
...
if(a&&e in a)return a[e]}up.version="3.4.0-beta.1"
const dp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return up({components:tp,directives:sp,...e})},vp="3.4.0-beta.1"
