...
if(n.push({...a,rowspan:s??1,colspan:a.children?Ou(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+1)
...
function V(){u.value="calendar"===u.value?"keyboard":"calendar"}function S(){d.value<11?d.value++:(v.value++,d.value=0,l("update:year",v.value)),l("update:month",d.value)}function w(){d.value>0?d.value--:(v.value--,d.value=11,l("update:year",v.value)),l("update:month",d.value)}function k(){s.value="months"===s.value?"month":"months"}function x(){s.value="year"===s.value?"month":"year"}return t.watch(d,(()=>{"months"===s.value&&k()})),t.watch(v,(()=>{"year"===s.value&&x()})),t.watch(i,((e,t)=>{const a=n.date(T(e)[0]),l=n.date(T(t)[0])
p.value=n.isBefore(a,l)})),At((()=>{const a=ed.filterProps(e),l=Hc.filterProps(e),n=Uc.filterProps(e),u=Gc.filterProps(e),c=C(Kc.filterProps(e),["modelValue"]),p=C(Zc.filterProps(e),["modelValue"]),N={header:f.value,transition:g.value,"onClick:append":V}
return t.createVNode(ed,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(Fa,{defaults:{VDatePickerHeader:{...N}}},{default:()=>[o.header?.(N)]}):t.createVNode(Uc,t.mergeProps({key:"header"},n,N),o),default:()=>"calendar"===e.inputMode?t.createVNode(t.Fragment,null,[t.createVNode(Hc,t.mergeProps(l,{disabled:b.value,text:m.value,"onClick:next":S,"onClick:prev":w,"onClick:month":k,"onClick:year":x}),null),t.createVNode(Na,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Kc,t.mergeProps({key:"date-picker-months"},c,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,min:h.value,max:y.value}),null):"year"===s.value?t.createVNode(Zc,t.mergeProps({key:"date-picker-years"},p,{modelValue:v.value,"onUpdate:modelValue":e=>v.value=e,min:h.value,max:y.value}),null):t.createVNode(Gc,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:d.value,"onUpdate:month":e=>d.value=e,year:v.value,"onUpdate:year":e=>v.value=e,min:h.value,max:y.value}),null)]})]):t.createVNode("div",{class:"v-date-picker__input"},[t.createVNode(ti,{label:r(e.inputText),placeholder:e.inputPlaceholder},null)]),actions:o.actions})})),{}}}),ld=Symbol.for("vuetify:v-expansion-panel"),od=["default","accordion","inset","popout"],nd=a({color:String,static:Boolean,variant:{type:String,default:"default",validator:e=>od.includes(e)},readonly:Boolean,...l(),...Vl(),...da(),...aa()},"VExpansionPanels"),rd=gt()({name:"VExpansionPanels",props:nd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
kl(e,ld)
...
if(a&&e in a)return a[e]}dp.version="3.4.3"
const pp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return dp({components:lp,directives:cp,...e})},fp="3.4.3"
