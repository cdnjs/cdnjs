...
return t.createVNode("div",{class:["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value],style:r.value,onClick:i},[o.prepend&&t.createVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(Wa,{key:"content",name:e.transition},{default:()=>[t.createVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode(Fa,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(_o,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),jc=a({allowedDates:[Array,Function],disabled:Boolean,color:String,month:[Number,String],hideWeekdays:Boolean,max:null,min:null,modelValue:Array,multiple:Boolean,showAdjacentMonths:Boolean,showWeek:Boolean,year:[Number,String]},"VDatePickerMonth"),Hc=gt()({name:"VDatePickerMonth",props:jc(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return null!=e&&(t=r.setMonth(t,Number(e))),t=r.setYear(t,r.getYear(u.value)),t}),(e=>r.getMonth(e))),d=t.computed((()=>{const e=r.getWeekArray(c.value),t=e.flat()
...
const n=gu(),{t:r}=Jt(),i=Ht(e,"modelValue",void 0,(e=>T(e)),(t=>e.multiple?t:t[0])),s=Ht(e,"viewMode"),u=Ht(e,"inputMode"),c=t.computed((()=>{const e=n.date(i.value?.[0])
return e&&n.isValid(e)?e:n.date()})),d=t.ref(Number(e.month??n.getMonth(n.startOfMonth(c.value)))),v=t.ref(Number(e.year??n.getYear(n.startOfYear(n.setMonth(c.value,d.value))))),p=t.shallowRef(!1),f=t.computed((()=>e.multiple&&i.value.length>1?r("$vuetify.datePicker.itemsSelected",i.value.length):i.value[0]&&n.isValid(i.value[0])?n.format(i.value[0],"normalDateWithWeekday"):r(e.header))),m=t.computed((()=>n.format(n.setYear(n.setMonth(n.date(),d.value),v.value),"monthAndYear"))),g=t.computed((()=>`date-picker-header${p.value?"-reverse":""}-transition`)),h=t.computed((()=>{const t=n.date(e.min)
return e.min&&n.isValid(t)?t:null})),y=t.computed((()=>{const t=n.date(e.max)
return e.max&&n.isValid(t)?t:null})),b=t.computed((()=>{if(e.disabled)return!0
const t=[]
if("month"!==s.value)t.push("prev","next")
else{let e=n.date()
if(e=n.setYear(e,v.value),e=n.setMonth(e,d.value),h.value){const a=n.addDays(n.startOfMonth(e),-1)
n.isAfter(h.value,a)&&t.push("prev")}if(y.value){const a=n.addDays(n.endOfMonth(e),1)
n.isAfter(a,y.value)&&t.push("next")}}return t}))
function V(){u.value="calendar"===u.value?"keyboard":"calendar"}function S(){d.value<11?(d.value++,l("update:month",d.value)):(v.value++,d.value=0,l("update:year",v.value))}function w(){d.value>0?(d.value--,l("update:month",d.value)):(v.value--,d.value=11,l("update:year",d.value))}function k(){s.value="months"===s.value?"month":"months"}function x(){s.value="year"===s.value?"month":"year"}return t.watch(d,(()=>{"months"===s.value&&k()})),t.watch(v,(()=>{"year"===s.value&&x()})),t.watch(i,((e,t)=>{const a=n.date(T(e)[0]),l=n.date(T(t)[0])
p.value=n.isBefore(a,l)})),At((()=>{const a=Xc.filterProps(e),l=Lc.filterProps(e),n=zc.filterProps(e),u=Hc.filterProps(e),c=C(Uc.filterProps(e),["modelValue"]),p=C(Gc.filterProps(e),["modelValue"]),N={header:f.value,transition:g.value,"onClick:append":V}
return t.createVNode(Xc,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(Fa,{defaults:{VDatePickerHeader:{...N}}},{default:()=>[o.header?.(N)]}):t.createVNode(zc,t.mergeProps({key:"header"},n,N),o),default:()=>"calendar"===e.inputMode?t.createVNode(t.Fragment,null,[t.createVNode(Lc,t.mergeProps(l,{disabled:b.value,text:m.value,"onClick:next":S,"onClick:prev":w,"onClick:month":k,"onClick:year":x}),null),t.createVNode(Na,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Uc,t.mergeProps({key:"date-picker-months"},c,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,min:h.value,max:y.value}),null):"year"===s.value?t.createVNode(Gc,t.mergeProps({key:"date-picker-years"},p,{modelValue:v.value,"onUpdate:modelValue":e=>v.value=e,min:h.value,max:y.value}),null):t.createVNode(Hc,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:d.value,"onUpdate:month":e=>d.value=e,year:v.value,"onUpdate:year":e=>v.value=e,min:h.value,max:y.value}),null)]})]):t.createVNode("div",{class:"v-date-picker__input"},[t.createVNode(ti,{label:r(e.inputText),placeholder:e.inputPlaceholder},null)]),actions:o.actions})})),{}}}),Qc=Symbol.for("vuetify:v-expansion-panel"),ed=["default","accordion","inset","popout"],td=a({color:String,static:Boolean,variant:{type:String,default:"default",validator:e=>ed.includes(e)},readonly:Boolean,...l(),...Vl(),...da(),...aa()},"VExpansionPanels"),ad=gt()({name:"VExpansionPanels",props:td(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
kl(e,Qc)
