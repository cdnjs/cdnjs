...
const{themeClasses:_}=xa(e),{borderClasses:I}=Vl(e),{colorClasses:P,colorStyles:B,variantClasses:A}=Fl(C),{densityClasses:R}=Rl(e),{dimensionStyles:T}=nl(e),{elevationClasses:D}=Sl(e),{roundedClasses:E}=vl(x),F=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),$=t.computed((()=>({isActive:V.value,select:c,isOpen:d.value,isSelected:v.value,isIndeterminate:p.value})))
function M(t){n("click",t),k.value&&(r.navigate?.(t),f||(m.activatable.value?s(!u.value,t):(m.selectable.value||null!=e.value)&&c(!v.value,t)))}function O(e){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),e.target.dispatchEvent(new MouseEvent("click",e)))}return Mt((()=>{const a=w.value?"a":e.tag,l=o.title||null!=e.title,n=o.subtitle||null!=e.subtitle,i=!(!e.appendAvatar&&!e.appendIcon),s=!(!i&&!o.append),c=!(!e.prependAvatar&&!e.prependIcon),d=!(!c&&!o.prepend)
var p,f
return b?.updateHasPrepend(d),e.activeColor&&(p="active-color",f=["color","base-color"],f=Array.isArray(f)?f.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${f.at(-1)}'`:`'${f}'`,t.warn(`[Vuetify UPGRADE] '${p}' is deprecated, use ${f} instead.`)),t.withDirectives(t.createVNode(a,t.mergeProps({class:["v-list-item",{"v-list-item--active":V.value,"v-list-item--disabled":e.disabled,"v-list-item--link":k.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!d&&b?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&V.value},_.value,I.value,P.value,R.value,D.value,F.value,E.value,A.value,e.class],style:[B.value,T.value,e.style],tabindex:k.value?b?-2:0:void 0,"aria-selected":S.value?m.activatable.value?u.value:m.selectable.value?v.value:V.value:void 0,onClick:M,onKeydown:k.value&&!w.value&&O},r.linkProps),{default:()=>[Dl(k.value||V.value,"v-list-item"),d&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(ll,{key:"prepend-defaults",disabled:!c,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.($.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Uo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Zl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(ur,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(sr,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.($.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(ll,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.($.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Zl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Uo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),k.value&&e.ripple]])})),{activate:s,isActivated:u,isGroupActivator:f,isSelected:v,list:b,select:c,root:m,id:y}}}),vr=ht({color:String,inset:Boolean,sticky:Boolean,title:String,...yt(),...Ba()},"VListSubheader"),pr=Pt()({name:"VListSubheader",props:vr(),setup(e,a){let{slots:l}=a
...
if(a&&e in a)return a[e]}sf.version="3.7.5"
const cf=function(){return sf({components:Qp,directives:rf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},df="3.7.5"
