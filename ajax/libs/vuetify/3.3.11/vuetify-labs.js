...
(function (global, factory) {
    ...
    setup(props, _ref) {
      ...
      useRender(() => {
        ...
        return vue.createVNode(vue.Fragment, null, [props.items.map((item, index) => {
          ...
          return vue.createVNode(vue.Fragment, null, [slots.item ? slots.item(itemSlotProps) : vue.createVNode(VDataTableRow, itemSlotProps.props, slots), isExpanded(item) && slots['expanded-row']?.(slotProps)]);
        })]);
      });
      return {};
    }
  ...
  const VDataTableVirtual = genericComponent()({
    ...
    setup(props, _ref) {
      ...
      const headerHeight = vue.computed(() => headers.value.length * 56);
      const {
        containerRef,
        paddingTop,
        paddingBottom,
