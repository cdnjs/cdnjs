...
return W((()=>{let a,l
return U(Yl,e.size)?a=`${t}--size-${e.size}`:e.size&&(l={width:f(e.size),height:f(e.size)}),{sizeClasses:a,sizeStyles:l}}))}const Kl=gt({color:String,disabled:Boolean,start:Boolean,end:Boolean,icon:Mt,...ht(),...Gl(),...Pa({tag:"i"}),...wa()},"VIcon"),Xl=It()({name:"VIcon",props:Kl(),setup(e,a){let{attrs:l,slots:o}=a
...
async function n(t,a){return In(t,$(e,a),!1,o)}return n.horizontal=async(t,a)=>In(t,$(e,a),!0,o),n}function Bn(e,t){const a=e?"scrollWidth":"scrollHeight"
...
return $t((()=>t.createVNode(e.tag,{class:["v-list-item-subtitle",e.class],style:[{"--v-list-item-subtitle-opacity":e.opacity},e.style]},l))),{}}}),sr=Pt("v-list-item-title"),ur=gt({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Mt,baseColor:String,disabled:Boolean,lines:[Boolean,String],link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number],title:[String,Number],value:null,onClick:G(),onClickOnce:G(),...yl(),...ht(),...Bl(),...ll(),...Vl(),...cl(),...fo(),...Pa(),...wa(),...Dl({variant:"text"})},"VListItem"),cr=It()({name:"VListItem",directives:{Ripple:To},props:ur(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
P("last")}e.preventDefault()}}function I(e){S.value=!0}function P(e){if(k.value)return Q(k.value,e)}return $t((()=>t.createVNode(e.tag,{ref:k,class:["v-list",{"v-list--disabled":e.disabled,"v-list--nav":e.nav,"v-list--slim":e.slim},n.value,r.value,s.value,u.value,d.value,y.value,v.value,e.class],style:[i.value,c.value,e.style],tabindex:e.disabled||S.value?-1:0,role:"listbox","aria-activedescendant":void 0,onFocusin:x,onFocusout:N,onFocus:C,onKeydown:_,onMousedown:I},{default:()=>[t.createVNode(gr,{items:o.value,returnObject:e.returnObject},l)]}))),{open:f,select:g,focus:P,children:p,parents:m,getPath:h}}}),Nr=Pt("v-list-img"),Cr=gt({start:Boolean,end:Boolean,...ht(),...Pa()},"VListItemAction"),_r=It()({name:"VListItemAction",props:Cr(),setup(e,a){let{slots:l}=a
...
const C=le(),I=t.computed((()=>"cursor"===e.target&&g.value?g.value:C.value?C.el:qr(e.target,i)||s.value)),P=t.computed((()=>Array.isArray(I.value)?void 0:I.value))
let B
...
return e.multiple?a:a[0]??null})),m=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(f.value):"number"==typeof e.counterValue?e.counterValue:f.value.length)),g=un(e),h=t.computed((()=>f.value.map((e=>e.value)))),y=t.shallowRef(!1),b=t.computed((()=>c.value?e.closeText:e.openText))
let V,w=""
const S=t.computed((()=>e.hideSelected?d.value.filter((t=>!f.value.some((a=>e.valueComparator(a,t))))):d.value)),k=t.computed((()=>e.hideNoData&&!S.value.length||g.isReadonly.value||g.isDisabled.value)),x=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),N=t.ref(),C=Ai(N,r)
function _(t){e.openOnClear&&(c.value=!0)}function I(){k.value||(c.value=!c.value)}function P(e){oe(e)&&B(e)}function B(e){if(!e.key||g.isReadonly.value)return;["Enter"," ","ArrowDown","ArrowUp","Home","End"].includes(e.key)&&e.preventDefault(),["Enter","ArrowDown"," "].includes(e.key)&&(c.value=!0),["Escape","Tab"].includes(e.key)&&(c.value=!1),"Home"===e.key?N.value?.focus("first"):"End"===e.key&&N.value?.focus("last")
if(!oe(e))return
const t=performance.now()
t-V>1e3&&(w=""),w+=e.key.toLowerCase(),V=t
const l=d.value.find((e=>e.title.toLowerCase().startsWith(w)))
if(void 0!==l){f.value=[l]
const e=S.value.indexOf(l)
...
return t.createVNode(xi,t.mergeProps({ref:r},d,{modelValue:f.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":$,focused:y.value,"onUpdate:focused":e=>y.value=e,validationValue:f.externalValue,counterValue:m.value,dirty:u,class:["v-select",{"v-select--active-menu":c.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":f.value.length,"v-select--selection-slot":!!o.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":_,"onMousedown:control":I,onBlur:T,onKeydown:B,"aria-label":n(b.value),title:n(b.value)}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:i,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-select__content",disabled:k.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:D,onAfterLeave:E},x.value),{default:()=>[l&&t.createVNode(xr,t.mergeProps({ref:N,selected:h.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:P,onFocusin:F,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},C,e.listProps),{default:()=>[o["prepend-item"]?.(),!S.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Bi,{ref:s,renderless:!0,items:S.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,onClick:()=>R(l,null)})
...
return t.watchEffect((()=>{const s="function"==typeof l?l():t.unref(l),u="string"!=typeof s&&"number"!=typeof s?"":String(s),c=function(e,t,a){const l=[],o=a?.default??Ei,n=!!a?.filterKeys&&A(a.filterKeys),r=Object.keys(a?.customKeyFilter??{}).length
...
return t.createVNode(xi,t.mergeProps({ref:r},u,{modelValue:S.value,"onUpdate:modelValue":[e=>S.value=e,G],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:x.value,dirty:l,onChange:j,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!B.value,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:N.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":$,"onMousedown:control":M,onKeydown:z}),{...o,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:D.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:H,onAfterLeave:W},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:E,selected:R.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:L,onFocusin:U,onFocusout:Y,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},F,e.listProps),{default:()=>[o["prepend-item"]?.(),!I.value.length&&!e.hideNoData&&(o["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(Bi,{ref:d,renderless:!0,items:I.value},{default:a=>{let{item:l,index:n,itemRef:r}=a
const i=t.mergeProps(l.props,{ref:r,key:l.value,active:!(!T.value||0!==n)||void 0,onClick:()=>K(l,null)})
return o.item?.({item:l,index:n,props:i})??t.createVNode(cr,t.mergeProps(i,{role:"option"}),{prepend:a=>{let{isSelected:o}=a
...
return(t?d.value:d.value!==s.value)&&(c=1-c),h(v.value+c*(f.value-v.value))}const A=e=>{r({value:B(e)}),C.value=!1,_.value=0},T=e=>{P.value=i(e),P.value&&(C.value=!0,P.value.contains(e.target)?_.value=Ms(e,P.value,a.direction):(_.value=0,n({value:B(e)})),o({value:B(e)}),t.nextTick((()=>P.value?.focus())))},D={passive:!0,capture:!0}
...
return e.multiple?a:a[0]??null})),N=un(e),C=t.computed((()=>!(!e.chips&&!n.chip))),_=t.computed((()=>C.value||!!n.selection)),I=t.shallowRef(e.multiple||_.value?"":x.value[0]?.title??""),B=t.computed({get:()=>I.value,set:t=>{if(I.value=t??"",e.multiple||_.value||(x.value=[yr(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&q(yr(e,t))})),I.value="")}t||(m.value=-1),u.value=!t}}),R=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:B.value.length))
...
x.value=e?[a]:[],I.value=e&&!_.value?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function K(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function X(e){c.value=!1}function Z(t){null!=t&&(""!==t||e.multiple||_.value)||(x.value=[])}return t.watch(s,((t,a)=>{if(!t&&t!==a&&(m.value=-1,f.value=!1,B.value)){if(e.multiple)return void q(yr(e,B.value))
if(!_.value)return
x.value.some((e=>{let{title:t}=e
return t===B.value}))?I.value="":q(yr(e,B.value))}})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=E.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
...
return t.createVNode(xi,t.mergeProps({ref:i},o,{modelValue:B.value,"onUpdate:modelValue":[e=>B.value=e,Z],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:R.value,dirty:l,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!_.value,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:N.isReadonly.value,placeholder:l?void 0:e.placeholder,"onClick:clear":z,"onMousedown:control":j,onKeydown:U}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(pi,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:M.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterEnter:Y,onAfterLeave:G},e.menuProps),{default:()=>[a&&t.createVNode(xr,t.mergeProps({ref:O,selected:F.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:W,onFocusin:K,onFocusout:X,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},L,e.listProps),{default:()=>[n["prepend-item"]?.(),!E.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(cr,{key:"no-data",title:r(e.noDataText)},null)),t.createVNode(Bi,{ref:v,renderless:!0,items:E.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(en,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),Nc=gt({index:Number,item:Object,cellProps:[Object,Function],onClick:G(),onContextmenu:G(),onDblclick:G(),...kn()},"VDataTableRow"),Cc=It()({name:"VDataTableRow",props:Nc(),setup(e,a){let{slots:l}=a
...
function Vd(e){const a=hu(),l=ia(e,"modelValue",[],(e=>A(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=ia(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
const n=hu(),{t:r}=ha(),i=ia(e,"modelValue",void 0,(e=>A(e)),(t=>e.multiple?t:t[0])),s=ia(e,"viewMode"),u=t.computed((()=>{const e=n.date(i.value?.[0])
...
return{addMovement:function(t){Array.from(t.changedTouches).forEach((a=>{(e[a.identifier]??(e[a.identifier]=new H(bv))).push([t.timeStamp,a])}))},endTouch:function(t){Array.from(t.changedTouches).forEach((t=>{delete e[t.identifier]}))},getVelocity:function(t){const a=e[t]?.values().reverse()
...
return P.value?t*B.value:t})),R=t.computed((()=>["top","bottom"].includes(e.location)?0:x.value)),{layoutItemStyles:T,layoutItemScrimStyles:D}=oa({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:N,layoutSize:A,elementSize:R,active:t.computed((()=>h.value||P.value)),disableTransitions:t.computed((()=>P.value)),absolute:t.computed((()=>e.absolute||I.value&&"string"!=typeof E.value))}),{isStuck:E,stickyStyles:F}=function(e){let{rootEl:a,isSticky:l,layoutItemStyles:o}=e
...
const{backgroundColorClasses:o,backgroundColorStyles:n}=ul(t.toRef(e,"color")),{dimensionStyles:r}=ol(e),{elevationClasses:i}=wl(e),{themeClasses:s}=ka(e),{t:u}=ha(),c=t.computed((()=>Hv(A(e.type).join(","))))
...
if(a&&e in a)return a[e]}rf.version="3.7.8"
const uf=function(){return rf({components:Zp,directives:nf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},cf="3.7.8"
