...
return o=void 0===o?o:o/255,{r:t,g:a,b:l,a:o}}function at(e){return qe(tt(e))}function lt(e){return et(Ge(e))}function ot(e,t){const a=De(ze(e))
...
var l
const o=function(e,a){const l=t.ref(a?.rtl??{af:!1,ar:!0,bg:!1,ca:!1,ckb:!1,cs:!1,de:!1,el:!1,en:!1,es:!1,et:!1,fa:!0,fi:!1,fr:!1,hr:!1,hu:!1,he:!0,id:!1,it:!1,ja:!1,ko:!1,lv:!1,lt:!1,nl:!1,no:!1,pl:!1,pt:!1,ro:!1,ru:!1,sk:!1,sl:!1,srCyrl:!1,srLatn:!1,sv:!1,th:!1,tr:!1,az:!1,uk:!1,vi:!1,zhHans:!1,zhHant:!1}),o=t.computed((()=>l.value[e.current.value]??!1))
...
l.push(`--v-${t}: ${o??a}`)}return l}const ia=a({...l(),...Et({fullHeight:!0}),...ta()},"VApp"),sa=gt()({name:"VApp",props:ia(),setup(e,a){let{slots:l}=a
...
return{x:s-(o+l.left),y:u-(n+l.top),sx:p,sy:f,speed:g}}const Va=pa("fab-transition","center center","out-in"),Sa=pa("dialog-bottom-transition"),wa=pa("dialog-top-transition"),ka=pa("fade-transition"),xa=pa("scale-transition"),Na=pa("scroll-x-transition"),Ca=pa("scroll-x-reverse-transition"),_a=pa("scroll-y-transition"),Ia=pa("scroll-y-reverse-transition"),Pa=pa("slide-x-transition"),Ba=pa("slide-x-reverse-transition"),Aa=pa("slide-y-transition"),Ra=pa("slide-y-reverse-transition"),Ta=fa("expand-transition",ma()),Da=fa("expand-x-transition",ma("",!0)),Ea=a({defaults:Object,disabled:Boolean,reset:[Number,String],root:[Boolean,String],scoped:Boolean},"VDefaultsProvider"),Fa=gt(!1)({name:"VDefaultsProvider",props:Ea(),setup(e,a){let{slots:l}=a
...
return t.withDirectives(t.createVNode(Oa,t.mergeProps({class:["v-img",{"v-img--booting":!_.value},e.class],style:[{width:h("auto"===e.width?c.value:e.width)},e.style]},a,{aspectRatio:p.value,"aria-label":e.alt,role:e.alt?"img":void 0}),{additional:()=>t.createVNode(t.Fragment,null,[t.createVNode(w,null,null),t.createVNode(k,null,null),t.createVNode(C,null,null),t.createVNode(x,null,null),t.createVNode(N,null,null)]),default:o.default}),[[t.resolveDirective("intersect"),{handler:f,options:e.options},null,{once:!0}]])})),{currentSrc:i,image:s,state:u,naturalWidth:c,naturalHeight:d}}}),Ya=a({border:[Boolean,Number,String]},"border")
...
return o}))
return{borderClasses:l}}function Ka(e){return G((()=>{const t=[],a={}
...
return d.value=!(!e.extended&&!m),t.createVNode(e.tag,{class:["v-toolbar",{"v-toolbar--absolute":e.absolute,"v-toolbar--collapse":e.collapse,"v-toolbar--flat":e.flat,"v-toolbar--floating":e.floating,[`v-toolbar--density-${e.density}`]:!0},o.value,r.value,i.value,s.value,u.value,c.value,e.class],style:[n.value,e.style]},{default:()=>[f&&t.createVNode("div",{key:"image",class:"v-toolbar__image"},[l.image?t.createVNode(Fa,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},l.image):t.createVNode(Ga,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(Fa,{defaults:{VTabs:{height:h(v.value)}}},{default:()=>[t.createVNode("div",{class:"v-toolbar__content",style:{height:h(v.value)}},[l.prepend&&t.createVNode("div",{class:"v-toolbar__prepend"},[l.prepend?.()]),a&&t.createVNode(da,{key:"title",text:e.title},{text:l.title}),l.default?.(),l.append&&t.createVNode("div",{class:"v-toolbar__append"},[l.append?.()])])]}),t.createVNode(Fa,{defaults:{VTabs:{height:h(p.value)}}},{default:()=>[t.createVNode(Ta,null,{default:()=>[d.value&&t.createVNode("div",{class:"v-toolbar__extension",style:{height:h(p.value)}},[m])]})]})]})})),{contentHeight:v,extensionHeight:p}}}),nl=a({scrollTarget:{type:String},scrollThreshold:{type:[String,Number],default:300}},"scroll")
...
return{colorClasses:o,colorStyles:n,variantClasses:l}}const gl=a({divided:Boolean,...Ya(),...l(),...cl(),...Ja(),...el(),...ua(),...ta(),...fl()},"VBtnGroup"),hl=gt()({name:"VBtnGroup",props:gl(),setup(e,a){let{slots:l}=a
...
const o=t.reactive([]),n=zt(e,"modelValue",[],(e=>null==e?[]:wl(o,T(e))),(t=>{const a=function(e,t){const a=[]
...
return{locationStyles:n}}const ql=a({absolute:Boolean,active:{type:Boolean,default:!0},bgColor:String,bgOpacity:[Number,String],bufferValue:{type:[Number,String],default:0},clickable:Boolean,color:String,height:{type:[Number,String],default:4},indeterminate:Boolean,max:{type:[Number,String],default:100},modelValue:{type:[Number,String],default:0},reverse:Boolean,stream:Boolean,striped:Boolean,roundedBar:Boolean,...l(),...Gl({location:"top"}),...el(),...ua(),...ta()},"VProgressLinear"),Kl=gt()({name:"VProgressLinear",props:ql(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=zt(e,"modelValue"),{isRtl:n,rtlClasses:r}=Qt(),{themeClasses:i}=la(e),{locationStyles:s}=Yl(e),{textColorClasses:u,textColorStyles:c}=Xa(e,"color"),{backgroundColorClasses:d,backgroundColorStyles:v}=Za(t.computed((()=>e.bgColor||e.color))),{backgroundColorClasses:p,backgroundColorStyles:f}=Za(e,"color"),{roundedClasses:m}=tl(e),{intersectionRef:g,isIntersecting:y}=jl(),b=t.computed((()=>parseInt(e.max,10))),V=t.computed((()=>parseInt(e.height,10))),S=t.computed((()=>parseFloat(e.bufferValue)/b.value*100)),w=t.computed((()=>parseFloat(o.value)/b.value*100)),k=t.computed((()=>n.value!==e.reverse)),x=t.computed((()=>e.indeterminate?"fade-transition":"slide-x-transition")),N=t.computed((()=>null==e.bgOpacity?e.bgOpacity:parseFloat(e.bgOpacity)))
...
return At((()=>t.createVNode(e.tag,{class:["v-avatar",{"v-avatar--start":e.start,"v-avatar--end":e.end},o.value,n.value,s.value,u.value,c.value,i.value,e.class],style:[r.value,d.value,e.style]},{default:()=>[e.image?t.createVNode(Ga,{key:"image",src:e.image,alt:"",cover:!0},null):e.icon?t.createVNode(zl,{key:"icon",icon:e.icon},null):l.default?.()??e.text,pl(!1,"v-avatar")]}))),{}}}),Eo=a({text:String,clickable:Boolean,...l(),...ta()},"VLabel"),Fo=gt()({name:"VLabel",props:Eo(),setup(e,a){let{slots:l}=a
...
return t.createVNode(zl,{icon:e[`${o}Icon`],"aria-label":i,onClick:r},null)}}}const Go=a({active:Boolean,color:String,messages:{type:[Array,String],default:()=>[]},...l(),...za({transition:{component:Aa,leaveAbsolute:!0,group:!0}})},"VMessages"),Yo=gt()({name:"VMessages",props:Go(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-input",`v-input--${e.direction}`,{"v-input--center-affix":e.centerAffix,"v-input--hide-spin-buttons":e.hideSpinButtons},r.value,i.value,w.value,e.class],style:e.style},[a&&t.createVNode("div",{key:"prepend",class:"v-input__prepend"},[o.prepend?.(k.value),e.prependIcon&&t.createVNode(s,{key:"prepend-icon",name:"prepend"},null)]),o.default&&t.createVNode("div",{class:"v-input__control"},[o.default?.(k.value)]),l&&t.createVNode("div",{key:"append",class:"v-input__append"},[e.appendIcon&&t.createVNode(s,{key:"append-icon",name:"append"},null),o.append?.(k.value)]),u&&t.createVNode("div",{class:"v-input__details"},[t.createVNode(Yo,{id:d.value,active:n,messages:x.value},{message:o.message}),o.details?.(k.value)])])})),{reset:b,resetValidation:V,validate:S,isValid:h,errorMessages:v}}}),ln=a({...tn(),...C(Ho(),["inline"])},"VCheckbox"),on=gt()({name:"VCheckbox",inheritAttrs:!1,props:ln(),emits:{"update:modelValue":e=>!0,"update:focused":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
...
return g.value&&t.withDirectives(t.createVNode(a,{class:["v-chip",{"v-chip--disabled":e.disabled,"v-chip--label":e.label,"v-chip--link":V.value,"v-chip--filter":x,"v-chip--pill":e.pill},m.value,i.value,_?s.value:void 0,d.value,v.value,p.value,f.value,c.value,h?.selectedClass.value,e.class],style:[_?u.value:void 0,e.style],disabled:e.disabled||void 0,draggable:e.draggable,href:y.href.value,tabindex:V.value?0:void 0,onClick:w,onKeydown:V.value&&!b.value&&k},{default:()=>[pl(V.value,"v-chip"),x&&t.createVNode(Da,{key:"filter"},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-chip__filter"},[n.filter?t.createVNode(Fa,{key:"filter-defaults",disabled:!e.filterIcon,defaults:{VIcon:{icon:e.filterIcon}}},n.filter):t.createVNode(zl,{key:"filter-icon",icon:e.filterIcon},null)]),[[t.vShow,h.isSelected.value]])]}),C&&t.createVNode("div",{key:"prepend",class:"v-chip__prepend"},[n.prepend?t.createVNode(Fa,{key:"prepend-defaults",disabled:!N,defaults:{VAvatar:{image:e.prependAvatar,start:!0},VIcon:{icon:e.prependIcon,start:!0}}},n.prepend):t.createVNode(t.Fragment,null,[e.prependIcon&&t.createVNode(zl,{key:"prepend-icon",icon:e.prependIcon,start:!0},null),e.prependAvatar&&t.createVNode(Do,{key:"prepend-avatar",image:e.prependAvatar,start:!0},null)])]),t.createVNode("div",{class:"v-chip__content"},[n.default?.({isSelected:h?.isSelected.value,selectedClass:h?.selectedClass.value,select:h?.select,toggle:h?.toggle,value:h?.value.value,disabled:e.disabled})??e.text]),o&&t.createVNode("div",{key:"append",class:"v-chip__append"},[n.append?t.createVNode(Fa,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{end:!0,image:e.appendAvatar},VIcon:{end:!0,icon:e.appendIcon}}},n.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(zl,{key:"append-icon",end:!0,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Do,{key:"append-avatar",end:!0,image:e.appendAvatar},null)])]),r&&t.createVNode("button",t.mergeProps({key:"close",class:"v-chip__close",type:"button"},S.value),[n.close?t.createVNode(Fa,{key:"close-defaults",defaults:{VIcon:{icon:e.closeIcon,size:"x-small"}}},n.close):t.createVNode(zl,{key:"close-icon",icon:e.closeIcon,size:"x-small"},null)])]}),[[t.resolveDirective("ripple"),V.value&&e.ripple,null]])}}}),dn=Symbol.for("vuetify:list")
...
case"multiple":default:return mn}})),s=zt(e,"selected",e.selected,(e=>r.value.in(e,l.value,o.value)),(e=>r.value.out(e,l.value,o.value)))
...
return At((()=>t.createVNode(e.tag,{class:["v-list-group",{"v-list-group--prepend":s?.hasPrepend.value,"v-list-group--fluid":e.fluid,"v-list-group--subgroup":e.subgroup,"v-list-group--open":o.value},e.class],style:e.style},{default:()=>[l.activator&&t.createVNode(Fa,{defaults:p.value},{default:()=>[t.createVNode(xn,null,{default:()=>[l.activator({props:d.value,isOpen:o.value})]})]}),t.createVNode(ja,{transition:{component:Ta},disabled:!u.value},{default:()=>[t.withDirectives(t.createVNode("div",{class:"v-list-group__items",role:"group","aria-labelledby":i.value},[l.default?.()]),[[t.vShow,o.value]])]})]}))),{}}}),_n=ht("v-list-item-subtitle"),In=ht("v-list-item-title"),Pn=a({active:{type:Boolean,default:void 0},activeClass:String,activeColor:String,appendAvatar:String,appendIcon:Il,baseColor:String,disabled:Boolean,lines:String,link:{type:Boolean,default:void 0},nav:Boolean,prependAvatar:String,prependIcon:Il,ripple:{type:[Boolean,Object],default:!0},slim:Boolean,subtitle:[String,Number],title:[String,Number],value:null,onClick:K(),onClickOnce:K(),...Ya(),...l(),...cl(),...$a(),...Ja(),...el(),...oo(),...ua(),...ta(),...fl({variant:"text"})},"VListItem"),Bn=gt()({name:"VListItem",directives:{Ripple:ko},props:Pn(),emits:{click:e=>!0},setup(e,a){let{attrs:l,slots:o,emit:n}=a
...
const{themeClasses:w}=la(e),{borderClasses:k}=qa(e),{colorClasses:x,colorStyles:N,variantClasses:C}=ml(S),{densityClasses:_}=dl(e),{dimensionStyles:I}=Ma(e),{elevationClasses:P}=Qa(e),{roundedClasses:B}=tl(b),A=t.computed((()=>e.lines?`v-list-item--${e.lines}-line`:void 0)),R=t.computed((()=>({isActive:g.value,select:s,isSelected:u.value,isIndeterminate:c.value})))
...
var d,v
return m?.updateHasPrepend(c),e.activeColor&&(d="active-color",v=["color","base-color"],v=Array.isArray(v)?v.slice(0,-1).map((e=>`'${e}'`)).join(", ")+` or '${v.at(-1)}'`:`'${v}'`,t.warn(`[Vuetify UPGRADE] '${d}' is deprecated, use ${v} instead.`)),t.withDirectives(t.createVNode(a,{class:["v-list-item",{"v-list-item--active":g.value,"v-list-item--disabled":e.disabled,"v-list-item--link":y.value,"v-list-item--nav":e.nav,"v-list-item--prepend":!c&&m?.hasPrepend.value,"v-list-item--slim":e.slim,[`${e.activeClass}`]:e.activeClass&&g.value},w.value,k.value,x.value,_.value,P.value,A.value,B.value,C.value,e.class],style:[N.value,I.value,e.style],href:r.href.value,tabindex:y.value?m?-2:0:void 0,onClick:T,onKeydown:y.value&&!h.value&&D},{default:()=>[pl(y.value||g.value,"v-list-item"),c&&t.createVNode("div",{key:"prepend",class:"v-list-item__prepend"},[o.prepend?t.createVNode(Fa,{key:"prepend-defaults",disabled:!u,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon},VListItemAction:{start:!0}}},{default:()=>[o.prepend?.(R.value)]}):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Do,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(zl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)]),t.createVNode("div",{class:"v-list-item__content","data-no-activator":""},[l&&t.createVNode(In,{key:"title"},{default:()=>[o.title?.({title:e.title})??e.title]}),n&&t.createVNode(_n,{key:"subtitle"},{default:()=>[o.subtitle?.({subtitle:e.subtitle})??e.subtitle]}),o.default?.(R.value)]),s&&t.createVNode("div",{key:"append",class:"v-list-item__append"},[o.append?t.createVNode(Fa,{key:"append-defaults",disabled:!i,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon},VListItemAction:{end:!0}}},{default:()=>[o.append?.(R.value)]}):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(zl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Do,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)]),t.createVNode("div",{class:"v-list-item__spacer"},null)])]}),[[t.resolveDirective("ripple"),y.value&&e.ripple]])})),{}}}),An=a({color:String,inset:Boolean,sticky:Boolean,title:String,...l(),...ua()},"VListSubheader"),Rn=gt()({name:"VListSubheader",props:An(),setup(e,a){let{slots:l}=a
const{textColorClasses:o,textColorStyles:n}=Xa(t.toRef(e,"color"))
return At((()=>{const a=!(!l.default&&!e.title)
return t.createVNode(e.tag,{class:["v-list-subheader",{"v-list-subheader--inset":e.inset,"v-list-subheader--sticky":e.sticky},o.value,e.class],style:[{textColorStyles:n},e.style]},{default:()=>[a&&t.createVNode("div",{class:"v-list-subheader__text"},[l.default?.()??e.title])]})})),{}}}),Tn=a({color:String,inset:Boolean,length:[Number,String],thickness:[Number,String],vertical:Boolean,...l(),...ta()},"VDivider"),Dn=gt()({name:"VDivider",props:Tn(),setup(e,a){let{attrs:l}=a
...
return At((()=>t.createVNode("hr",{class:[{"v-divider":!0,"v-divider--inset":e.inset,"v-divider--vertical":e.vertical},o.value,n.value,e.class],style:[i.value,r.value,e.style],"aria-orientation":l.role&&"separator"!==l.role?void 0:e.vertical?"vertical":"horizontal",role:`${l.role||"separator"}`},null))),{}}}),En=a({items:Array,returnObject:Boolean},"VListChildren"),Fn=gt()({name:"VListChildren",props:En(),setup(e,a){let{slots:l}=a
...
return l.header?l.header({props:r}):t.createVNode(Bn,r,s)},default:()=>t.createVNode(Fn,{items:o},l)}):l.item?l.item({props:n}):t.createVNode(Bn,t.mergeProps(n,{value:e.returnObject?i:n.value}),s)}))}}),$n=a({items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemChildren:{type:[Boolean,String,Array,Function],default:"children"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},returnObject:Boolean,valueComparator:{type:Function,default:p}},"list-items")
function Mn(e,t){const a=m(t,e.itemTitle,t),l=m(t,e.itemValue,a),o=m(t,e.itemChildren),n={title:a,value:l,...!0===e.itemProps?"object"!=typeof t||null==t||Array.isArray(t)?void 0:"children"in t?C(t,["children"]):t:m(t,e.itemProps)}
...
return{items:a,transformIn:function(t){return l.value||(t=t.filter((e=>null!==e))),t.map((t=>e.returnObject&&"string"==typeof t?Mn(e,t):a.value.find((a=>e.valueComparator(t,a.value)))||Mn(e,t)))},transformOut:function(t){return e.returnObject?t.map((e=>{let{raw:t}=e
...
return a}const Hn=a({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,lines:{type:[Boolean,String],default:"one"},slim:Boolean,nav:Boolean,...Sn({selectStrategy:"single-leaf",openStrategy:"list"}),...Ya(),...l(),...cl(),...$a(),...Ja(),itemType:{type:String,default:"type"},...$n(),...el(),...ua(),...ta(),...fl({variant:"text"})},"VList"),Wn=gt()({name:"VList",props:Hn(),emits:{"update:selected":e=>!0,"update:opened":e=>!0,"click:open":e=>!0,"click:select":e=>!0},setup(e,a){let{slots:l}=a
const{items:o}=function(e){return{items:t.computed((()=>jn(e,e.items)))}}(e),{themeClasses:n}=la(e),{backgroundColorClasses:r,backgroundColorStyles:i}=Za(t.toRef(e,"bgColor")),{borderClasses:s}=qa(e),{densityClasses:u}=dl(e),{dimensionStyles:c}=Ma(e),{elevationClasses:d}=Qa(e),{roundedClasses:v}=tl(e),{open:p,select:f}=wn(e),m=t.computed((()=>e.lines?`v-list--${e.lines}-line`:void 0)),g=t.toRef(e,"activeColor"),h=t.toRef(e,"baseColor"),y=t.toRef(e,"color")
...
return()=>window.clearTimeout(a)}(n,(()=>{t?.(l),e(l)}))}))}return{clearDelay:a,runOpenDelay:function(){return l(!0)},runCloseDelay:function(){return l(!1)}}}const vr=a({target:[String,Object],activator:[String,Object],activatorProps:{type:Object,default:()=>({})},openOnClick:{type:Boolean,default:void 0},openOnHover:Boolean,openOnFocus:{type:Boolean,default:void 0},closeOnContentClick:Boolean,...cr()},"VOverlay-activator")
...
return{globalTop:t.readonly(u),localTop:c,stackStyles:t.computed((()=>({zIndex:s.value})))}}(s,t.toRef(e,"zIndex"),e._disableGlobalStack),{activatorEl:V,activatorRef:S,target:w,targetEl:k,targetRef:x,activatorEvents:N,contentEvents:C,scrimEvents:_}=pr(e,{isActive:s,isTop:y}),{dimensionStyles:I}=Ma(e),P=xr(),{scopeId:B}=_r()
...
function r(e){n.value?.(e)}return o&&Ot((()=>!(!a.isActive.value||!e.locationStrategy)),(o=>{t.watch((()=>e.locationStrategy),o),t.onScopeDispose((()=>{window.removeEventListener("resize",r),n.value=void 0})),window.addEventListener("resize",r,{passive:!0}),"function"==typeof e.locationStrategy?n.value=e.locationStrategy(a,e,l)?.updateLocation:n.value=Jn[e.locationStrategy](a,e,l)?.updateLocation})),{contentStyles:l,updateLocation:n}}(e,{isRtl:v,contentEl:R,target:w,isActive:s})
...
let l
t.watchEffect((async()=>{l?.stop(),a.isActive.value&&e.scrollStrategy&&(l=t.effectScope(),await t.nextTick(),l.active&&l.run((()=>{"function"==typeof e.scrollStrategy?e.scrollStrategy(a,e,l):rr[e.scrollStrategy]?.(a,e,l)})))})),t.onScopeDispose((()=>{l?.stop()}))}(e,{root:A,contentEl:R,targetEl:k,isActive:s,updateLocation:D}),o&&t.watch(s,(e=>{e?window.addEventListener("keydown",$):window.removeEventListener("keydown",$)}),{immediate:!0}),t.onBeforeUnmount((()=>{o&&window.removeEventListener("keydown",$)}))
const M=ao()
...
return e[Mr]=a,new Proxy(e,{get(e,t){if(Reflect.has(e,t))return Reflect.get(e,t)
...
if(a)return a}for(const e of a){const a=e.value&&e.value[Mr]
if(!a)continue
const l=a.slice()
for(;l.length;){const e=l.shift(),a=Lr(e.value,t)
if(a)return a
const o=e.value&&e.value[Mr]
o&&l.push(...o)}}}}})}const zr=a({id:String,...C(Fr({closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:ha}}),["absolute"])},"VMenu"),jr=gt()({name:"VMenu",props:zr(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=zt(e,"modelValue"),{scopeId:n}=_r(),r=Nt(),i=t.computed((()=>e.id||`v-menu-${r}`)),s=t.ref(),u=t.inject(ur,null),c=t.shallowRef(0)
...
return At((()=>{const a=$r.filterProps(e)
return t.createVNode($r,t.mergeProps({ref:s,class:["v-menu",e.class],style:e.style},a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,absolute:!0,activatorProps:m.value,"onClick:outside":v,onKeydown:p},n),{activator:l.activator,default:function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createVNode(Fa,{root:"VMenu"},{default:()=>[l.default?.(...a)]})}})})),Or({id:i,ΨopenChildren:c},s)}}),Hr=a({active:Boolean,max:[Number,String],value:{type:[Number,String],default:0},...l(),...za({transition:{component:Aa}})},"VCounter"),Wr=gt()({name:"VCounter",functional:!0,props:Hr(),setup(e,a){let{slots:l}=a
const o=t.computed((()=>e.max?`${e.value} / ${e.max}`:String(e.value)))
return At((()=>t.createVNode(ja,{transition:e.transition},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-counter",e.class],style:e.style},[l.default?l.default({counter:o.value,max:e.max,value:e.value}):o.value]),[[t.vShow,e.active]])]}))),{}}}),Ur=a({floating:Boolean,...l()},"VFieldLabel"),Gr=gt()({name:"VFieldLabel",props:Ur(),setup(e,a){let{slots:l}=a
return At((()=>t.createVNode(Fo,{class:["v-field-label",{"v-field-label--floating":e.floating},e.class],style:e.style,"aria-hidden":e.floating||void 0},l))),{}}}),Yr=["underlined","outlined","filled","solo","solo-inverted","solo-filled","plain"],qr=a({appendInnerIcon:Il,bgColor:String,clearable:Boolean,clearIcon:{type:Il,default:"$clear"},active:Boolean,centerAffix:{type:Boolean,default:void 0},color:String,baseColor:String,dirty:Boolean,disabled:{type:Boolean,default:null},error:Boolean,flat:Boolean,label:String,persistentClear:Boolean,prependInnerIcon:Il,reverse:Boolean,singleLine:Boolean,variant:{type:String,default:"filled",validator:e=>Yr.includes(e)},"onClick:clear":K(),"onClick:appendInner":K(),"onClick:prependInner":K(),...l(),...Xl(),...el(),...ta()},"VField"),Kr=gt()({name:"VField",inheritAttrs:!1,props:{id:String,...qo(),...qr()},emits:{"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{themeClasses:r}=la(e),{loaderClasses:i}=Zl(e),{focusClasses:s,isFocused:u,focus:c,blur:d}=Ko(e),{InputIcon:v}=Uo(e),{roundedClasses:p}=tl(e),{rtlClasses:f}=Qt(),m=t.computed((()=>e.dirty||e.active)),g=t.computed((()=>!(e.singleLine||!e.label&&!n.label))),y=Nt(),b=t.computed((()=>e.id||`input-${y}`)),V=t.computed((()=>`${b.value}-messages`)),S=t.ref(),w=t.ref(),k=t.ref(),x=t.computed((()=>["plain","underlined"].includes(e.variant))),{backgroundColorClasses:N,backgroundColorStyles:C}=Za(t.toRef(e,"bgColor")),{textColorClasses:_,textColorStyles:I}=Xa(t.computed((()=>e.error||e.disabled?void 0:m.value&&u.value?e.color:e.baseColor)))
...
t.nextTick((()=>{l.selectionStart=e[0],l.selectionEnd=e[1]}))}}return At((()=>{const a=!!(n.counter||!1!==e.counter&&null!=e.counter),o=!(!a&&!n.details),[s,k]=R(l),{modelValue:x,...N}=an.filterProps(e),C=Xr(e)
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(h[e]=t,S())}}}const oi=a({items:{type:Array,default:()=>[]},renderless:Boolean,...ai(),...l(),...$a()},"VVirtualScroll"),ni=gt()({name:"VVirtualScroll",props:oi(),setup(e,a){let{slots:l}=a
const o=St("VVirtualScroll"),{dimensionStyles:n}=Ma(e),{containerRef:r,markerRef:i,handleScroll:s,handleScrollend:u,handleItemResize:c,scrollToIndex:d,paddingTop:v,paddingBottom:p,computedItems:f}=li(e,t.toRef(e,"items"))
...
break}}}}}const ii=a({chips:Boolean,closableChips:Boolean,closeText:{type:String,default:"$vuetify.close"},openText:{type:String,default:"$vuetify.open"},eager:Boolean,hideNoData:Boolean,hideSelected:Boolean,menu:Boolean,menuIcon:{type:Il,default:"$dropdown"},menuProps:{type:Object},multiple:Boolean,noDataText:{type:String,default:"$vuetify.noDataText"},openOnClear:Boolean,itemColor:String,...$n({itemChildren:!1})},"Select"),si=a({...ii(),...C(Jr({modelValue:null,role:"combobox"}),["validationValue","dirty","appendInnerIcon"]),...za({transition:{component:ha}})},"VSelect"),ui=gt()({name:"VSelect",props:si(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:menu":e=>!0},setup(e,a){let{slots:l}=a
const{t:n}=Zt(),r=t.ref(),i=t.ref(),s=t.ref(),u=zt(e,"menu"),c=t.computed({get:()=>u.value,set:e=>{u.value&&!e&&i.value?.ΨopenChildren||(u.value=e)}}),{items:d,transformIn:v,transformOut:p}=On(e),f=zt(e,"modelValue",[],(e=>v(null===e?[null]:T(e))),(t=>{const a=p(t)
...
let V,S=""
const w=t.computed((()=>e.hideSelected?d.value.filter((e=>!f.value.some((t=>t===e)))):d.value)),k=t.computed((()=>e.hideNoData&&!w.value.length||e.readonly||g?.isReadonly.value)),x=t.computed((()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}}))),N=t.ref(),{onListScroll:C,onListKeydown:_}=ri(N,r)
...
o&&window.requestAnimationFrame((()=>{t>=0&&s.value?.scrollToIndex(t)}))}})),t.watch(w,((t,a)=>{y.value&&(!t.length&&e.hideNoData&&(c.value=!1),!a.length&&t.length&&(c.value=!0))})),At((()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||w.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=f.value.length>0,d=Qr.filterProps(e),v=u||!y.value&&e.label&&!e.persistentPlaceholder?void 0:e.placeholder
return t.createVNode(Qr,t.mergeProps({ref:r},d,{modelValue:f.value.map((e=>e.props.value)).join(", "),"onUpdate:modelValue":F,focused:y.value,"onUpdate:focused":e=>y.value=e,validationValue:f.externalValue,counterValue:m.value,dirty:u,class:["v-select",{"v-select--active-menu":c.value,"v-select--chips":!!e.chips,["v-select--"+(e.multiple?"multiple":"single")]:!0,"v-select--selected":f.value.length,"v-select--selection-slot":!!l.selection},e.class],style:e.style,inputmode:"none",placeholder:v,"onClick:clear":I,"onMousedown:control":P,onBlur:R,onKeydown:B,"aria-label":n(b.value),title:n(b.value)}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:i,modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,activator:"parent",contentClass:"v-select__content",disabled:k.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:D},x.value),{default:()=>[o&&t.createVNode(Wn,{ref:N,selected:h.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:_,onFocusin:E,onScrollPassive:C,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},{default:()=>[l["prepend-item"]?.(),!w.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Bn,{title:n(e.noDataText)},null)),t.createVNode(ni,{ref:s,renderless:!0,items:w.value},{default:a=>{let{item:o,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(Wo,{key:o.value,modelValue:l,ripple:!1,tabindex:"-1"},null):void 0,o.props.prependAvatar&&t.createVNode(Do,{image:o.props.prependAvatar},null),o.props.prependIcon&&t.createVNode(zl,{icon:o.props.prependIcon},null)])}})}}),l["append-item"]?.()]})]}),f.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),A(o)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=a?!!l.chip:!!l.selection,s=i?oe(a?l.chip({item:o,index:n,props:r}):l.selection({item:o,index:n})):void 0
if(!i||s)return t.createVNode("div",{key:o.value,class:"v-select__selection"},[a?l.chip?t.createVNode(Fa,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title,disabled:o.props.disabled},r),null):s??t.createVNode("span",{class:"v-select__selection-text"},[o.title,e.multiple&&n<f.value.length-1&&t.createVNode("span",{class:"v-select__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,o=new Array(a),n=0;n<a;n++)o[n]=arguments[n]
return t.createVNode(t.Fragment,null,[l["append-inner"]?.(...o),e.menuIcon?t.createVNode(zl,{class:"v-select__menu-icon",icon:e.menuIcon},null):void 0])}})})),Or({isFocused:y,menu:c,select:A},r)}}),ci=(e,t,a)=>null==e||null==t?-1:e.toString().toLocaleLowerCase().indexOf(t.toString().toLocaleLowerCase()),di=a({customFilter:Function,customKeyFilter:Object,filterKeys:[Array,String],filterMode:{type:String,default:"intersection"},noFilter:Boolean},"filter")
...
return t===I.value[0].value}))||G(I.value[0]):k.value=[],p.value=!1,w.value="",f.value=-1))})),t.watch(w,(e=>{i.value&&!U.value&&(e&&(p.value=!0),s.value=!e)})),t.watch(p,(()=>{if(!e.hideSelected&&p.value&&k.value.length){const e=I.value.findIndex((e=>k.value.some((t=>e.value===t.value))))
o&&window.requestAnimationFrame((()=>{e>=0&&d.value?.scrollToIndex(e)}))}})),t.watch(I,((t,a)=>{i.value&&(!t.length&&e.hideNoData&&(p.value=!1),!a.length&&t.length&&(p.value=!0))})),At((()=>{const a=!(!e.chips&&!l.chip),o=!!(!e.hideNoData||I.value.length||l["prepend-item"]||l["append-item"]||l["no-data"]),u=k.value.length>0,v=Qr.filterProps(e)
return t.createVNode(Qr,t.mergeProps({ref:r},v,{modelValue:w.value,"onUpdate:modelValue":[e=>w.value=e,W],focused:i.value,"onUpdate:focused":e=>i.value=e,validationValue:k.externalValue,counterValue:x.value,dirty:u,onChange:O,class:["v-autocomplete","v-autocomplete--"+(e.multiple?"multiple":"single"),{"v-autocomplete--active-menu":p.value,"v-autocomplete--chips":!!e.chips,"v-autocomplete--selection-slot":!!l.selection,"v-autocomplete--selecting-index":f.value>-1},e.class],style:e.style,readonly:e.readonly,placeholder:u?void 0:e.placeholder,"onClick:clear":F,"onMousedown:control":$,onKeydown:L}),{...l,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:c,modelValue:p.value,"onUpdate:modelValue":e=>p.value=e,activator:"parent",contentClass:"v-autocomplete__content",disabled:A.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:z},e.menuProps),{default:()=>[o&&t.createVNode(Wn,{ref:R,selected:P.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:E,onFocusin:j,onFocusout:H,onScrollPassive:D,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},{default:()=>[l["prepend-item"]?.(),!I.value.length&&!e.hideNoData&&(l["no-data"]?.()??t.createVNode(Bn,{title:n(e.noDataText)},null)),t.createVNode(ni,{ref:d,renderless:!0,items:I.value},{default:a=>{let{item:o,index:n,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(Wo,{key:o.value,modelValue:l,ripple:!1,tabindex:"-1"},null):void 0,o.props.prependAvatar&&t.createVNode(Do,{image:o.props.prependAvatar},null),o.props.prependIcon&&t.createVNode(zl,{icon:o.props.prependIcon},null)])},title:()=>s.value?o.title:function(e,a,l){if(null==a)return e
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-autocomplete__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(a+l)])]):e}(o.title,_(o)?.title,w.value?.length??0)})}}),l["append-item"]?.()]})]}),k.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),G(o,!1)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=a?!!l.chip:!!l.selection,s=i?oe(a?l.chip({item:o,index:n,props:r}):l.selection({item:o,index:n})):void 0
if(!i||s)return t.createVNode("div",{key:o.value,class:["v-autocomplete__selection",n===f.value&&["v-autocomplete__selection--selected",V.value]],style:n===f.value?S.value:{}},[a?l.chip?t.createVNode(Fa,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:o.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:o.title,disabled:o.props.disabled},r),null):s??t.createVNode("span",{class:"v-autocomplete__selection-text"},[o.title,e.multiple&&n<k.value.length-1&&t.createVNode("span",{class:"v-autocomplete__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,o=new Array(a),r=0;r<a;r++)o[r]=arguments[r]
return t.createVNode(t.Fragment,null,[l["append-inner"]?.(...o),e.menuIcon?t.createVNode(zl,{class:"v-autocomplete__menu-icon",icon:e.menuIcon,onMousedown:M,onClick:ae,"aria-label":n(g.value),title:n(g.value)},null):void 0])}})})),Or({isFocused:i,isPristine:s,menu:p,search:w,filteredItems:C,select:G},r)}}),mi=a({bordered:Boolean,color:String,content:[Number,String],dot:Boolean,floating:Boolean,icon:Il,inline:Boolean,label:{type:String,default:"$vuetify.badge"},max:[Number,String],modelValue:{type:Boolean,default:!0},offsetX:[Number,String],offsetY:[Number,String],textColor:String,...l(),...Gl({location:"top end"}),...el(),...ua(),...ta(),...za({transition:"scale-rotate-transition"})},"VBadge"),gi=gt()({name:"VBadge",inheritAttrs:!1,props:mi(),setup(e,a){const{backgroundColorClasses:l,backgroundColorStyles:o}=Za(t.toRef(e,"color")),{roundedClasses:n}=tl(e),{t:r}=Zt(),{textColorClasses:i,textColorStyles:s}=Xa(t.toRef(e,"textColor")),{themeClasses:u}=oa(),{locationStyles:c}=Yl(e,!0,(t=>(e.floating?e.dot?2:4:e.dot?8:12)+(["top","bottom"].includes(t)?+(e.offsetY??0):["left","right"].includes(t)?+(e.offsetX??0):0)))
...
return vt({VBtn:{color:e.color,density:e.density,slim:!0,variant:"text"}}),At((()=>t.createVNode("div",{class:["v-banner-actions",e.class],style:e.style},[l.default?.()]))),{}}}),bi=ht("v-banner-text"),Vi=a({avatar:String,bgColor:String,color:String,icon:Il,lines:String,stacked:Boolean,sticky:Boolean,text:String,...Ya(),...l(),...cl(),...$a(),...wr(),...Ja(),...Gl(),...eo(),...el(),...ua(),...ta()},"VBanner"),Si=gt()({name:"VBanner",props:Vi(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(e,"bgColor"),{borderClasses:r}=qa(e),{densityClasses:i}=dl(e),{displayClasses:s,mobile:u}=kr(e),{dimensionStyles:c}=Ma(e),{elevationClasses:d}=Qa(e),{locationStyles:v}=Yl(e),{positionClasses:p}=to(e),{roundedClasses:f}=tl(e),{themeClasses:m}=la(e),g=t.toRef(e,"color"),h=t.toRef(e,"density")
vt({VBannerActions:{color:g,density:h}}),At((()=>{const a=!(!e.text&&!l.text),y=!(!e.avatar&&!e.icon),b=!(!y&&!l.prepend)
return t.createVNode(e.tag,{class:["v-banner",{"v-banner--stacked":e.stacked||u.value,"v-banner--sticky":e.sticky,[`v-banner--${e.lines}-line`]:!!e.lines},m.value,o.value,r.value,i.value,s.value,d.value,p.value,f.value,e.class],style:[n.value,c.value,v.value,e.style],role:"banner"},{default:()=>[b&&t.createVNode("div",{key:"prepend",class:"v-banner__prepend"},[l.prepend?t.createVNode(Fa,{key:"prepend-defaults",disabled:!y,defaults:{VAvatar:{color:g.value,density:h.value,icon:e.icon,image:e.avatar}}},l.prepend):t.createVNode(Do,{key:"prepend-avatar",color:g.value,density:h.value,icon:e.icon,image:e.avatar},null)]),t.createVNode("div",{class:"v-banner__content"},[a&&t.createVNode(bi,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.()]),l.actions&&t.createVNode(yi,{key:"actions"},l.actions)]})}))}}),wi=a({bgColor:String,color:String,grow:Boolean,mode:{type:String,validator:e=>!e||["horizontal","shift"].includes(e)},height:{type:[Number,String],default:56},active:{type:Boolean,default:!0},...Ya(),...l(),...cl(),...Ja(),...el(),...Ft({name:"bottom-navigation"}),...ua({tag:"header"}),...yl({modelValue:!0,selectedClass:"v-btn--selected"}),...ta()},"VBottomNavigation"),ki=gt()({name:"VBottomNavigation",props:wi(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=oa(),{borderClasses:n}=qa(e),{backgroundColorClasses:r,backgroundColorStyles:i}=Za(t.toRef(e,"bgColor")),{densityClasses:s}=dl(e),{elevationClasses:u}=Qa(e),{roundedClasses:c}=tl(e),{ssrBootStyles:d}=rl(),v=t.computed((()=>Number(e.height)-("comfortable"===e.density?8:0)-("compact"===e.density?16:0))),p=t.toRef(e,"active"),{layoutItemStyles:f}=Mt({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.computed((()=>"bottom")),layoutSize:t.computed((()=>p.value?v.value:0)),elementSize:v,active:p,absolute:t.toRef(e,"absolute")})
...
const n=zt(e,"modelValue"),{scopeId:r}=_r(),i=t.ref()
...
return At((()=>{const a=$r.filterProps(e)
return t.createVNode($r,t.mergeProps({ref:i,class:["v-dialog",{"v-dialog--fullscreen":e.fullscreen,"v-dialog--scrollable":e.scrollable},e.class],style:e.style},a,{modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,"aria-modal":"true",activatorProps:u.value,role:"dialog"},r),{activator:l.activator,default:function(){for(var e=arguments.length,a=new Array(e),o=0;o<e;o++)a[o]=arguments[o]
return t.createVNode(Fa,{root:"VDialog"},{default:()=>[l.default?.(...a)]})}})})),Or({},i)}}),Ci=a({inset:Boolean,...xi({transition:"bottom-sheet-transition"})},"VBottomSheet"),_i=gt()({name:"VBottomSheet",props:Ci(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(t.Fragment,null,[l.item?.({item:n,index:a})??t.createVNode(Ai,t.mergeProps({key:a,disabled:a>=o.length-1},"string"==typeof n?{title:n}:n),{default:l.title?()=>l.title?.({item:n,index:a}):void 0}),a<o.length-1&&t.createVNode(Pi,null,{default:l.divider?()=>l.divider?.({item:r,index:a}):void 0})])})),l.default?.()]})})),{}}}),Di=gt()({name:"VCardActions",props:l(),setup(e,a){let{slots:l}=a
return vt({VBtn:{slim:!0,variant:"text"}}),At((()=>t.createVNode("div",{class:["v-card-actions",e.class],style:e.style},[l.default?.()]))),{}}}),Ei=ht("v-card-subtitle"),Fi=ht("v-card-title"),$i=a({appendAvatar:String,appendIcon:Il,prependAvatar:String,prependIcon:Il,subtitle:[String,Number],title:[String,Number],...l(),...cl()},"VCardItem"),Mi=gt()({name:"VCardItem",props:$i(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(Fa,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,icon:e.prependIcon,image:e.prependAvatar}}},l.prepend):a&&t.createVNode(Do,{key:"prepend-avatar",density:e.density,icon:e.prependIcon,image:e.prependAvatar},null)]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(Fi,{key:"title"},{default:()=>[l.title?.()??e.title]}),s&&t.createVNode(Ei,{key:"subtitle"},{default:()=>[l.subtitle?.()??e.subtitle]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(Fa,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,icon:e.appendIcon,image:e.appendAvatar}}},l.append):n&&t.createVNode(Do,{key:"append-avatar",density:e.density,icon:e.appendIcon,image:e.appendAvatar},null)])])})),{}}}),Li=ht("v-card-text"),Oi=a({appendAvatar:String,appendIcon:Il,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Il,ripple:{type:[Boolean,Object],default:!0},subtitle:[String,Number],text:[String,Number],title:[String,Number],...Ya(),...l(),...cl(),...$a(),...Ja(),...Xl(),...Gl(),...eo(),...el(),...oo(),...ua(),...ta(),...fl({variant:"elevated"})},"VCard"),zi=gt()({name:"VCard",directives:{Ripple:ko},props:Oi(),setup(e,a){let{attrs:l,slots:o}=a
...
return t.withDirectives(t.createVNode(a,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b.value},n.value,r.value,i.value,c.value,v.value,p.value,m.value,g.value,u.value,e.class],style:[s.value,d.value,f.value,e.style],href:h.href.value,onClick:b.value&&h.navigate,tabindex:e.disabled?-1:void 0},{default:()=>[x&&t.createVNode("div",{key:"image",class:"v-card__image"},[o.image?t.createVNode(Fa,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},o.image):t.createVNode(Ga,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(Jl,{name:"v-card",active:!!e.loading,color:"boolean"==typeof e.loading?void 0:e.loading},{default:o.loader}),N&&t.createVNode(Mi,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:o.item,prepend:o.prepend,title:o.title,subtitle:o.subtitle,append:o.append}),C&&t.createVNode(Li,{key:"text"},{default:()=>[o.text?.()??e.text]}),o.default?.(),o.actions&&t.createVNode(Di,null,{default:o.actions}),pl(b.value,"v-card")]}),[[t.resolveDirective("ripple"),b.value&&e.ripple]])})),{}}})
...
const{themeClasses:o}=la(e),{isRtl:n}=Qt(),{t:r}=Zt(),i=Sl(e,Yi),s=t.ref(),u=t.computed((()=>n.value?!e.reverse:e.reverse)),c=t.shallowRef(!1),d=t.computed((()=>`v-window-${"vertical"===e.direction?"y":"x"}${(u.value?!c.value:c.value)?"-reverse":""}-transition`)),v=t.shallowRef(0),p=t.ref(void 0),f=t.computed((()=>i.items.value.findIndex((e=>i.selected.value.includes(e.id)))))
...
const o=t.inject(Gi),n=Vl(e,Yi),{isBooted:r}=rl()
...
At((()=>{const a=Ga.filterProps(e),n=Qi.filterProps(e)
return t.createVNode(Qi,t.mergeProps({class:"v-carousel-item"},n),{default:()=>[t.createVNode(Ga,t.mergeProps(o,a),l)]})}))}}),as=ht("v-code"),ls=mt({name:"VColorPickerCanvas",props:a({color:{type:Object},disabled:Boolean,dotSize:{type:[Number,String],default:10},height:{type:[Number,String],default:150},width:{type:[Number,String],default:300},...l()},"VColorPickerCanvas")(),emits:{"update:color":e=>!0,"update:position":e=>!0},setup(e,a){let{emit:l}=a
...
return null!=t?Math.round(100*t)/100:1},getColor:(e,t)=>({...e,a:Number(t)})}],to:Ge,from:qe},rs={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)})},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)})},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)})},{label:"A",max:1,step:.01,getValue:e=>{let{a:t}=e
...
return(t?d.value:d.value!==s.value)&&(c=1-c),h(v.value+c*(p.value-v.value))}const A=e=>{r({value:B(e)}),C.value=!1,_.value=0},R=e=>{P.value=i(e),P.value&&(P.value.focus(),C.value=!0,P.value.contains(e.target)?_.value=vs(e,P.value,a.direction):(_.value=0,n({value:B(e)})),o({value:B(e)}))},T={passive:!0,capture:!0}
...
const{thumbColor:s,step:u,disabled:c,thumbSize:d,thumbLabel:v,direction:p,isReversed:f,vertical:m,readonly:g,elevation:y,mousePressed:b,decimals:V,indexFromEnd:w}=n,k=t.computed((()=>c.value?void 0:y.value)),{elevationClasses:x}=Qa(k),{textColorClasses:N,textColorStyles:C}=Xa(s),{pageup:_,pagedown:I,end:P,home:B,left:A,right:R,down:T,up:D}=S,E=[_,I,P,B,A,R,T,D],F=t.computed((()=>u.value?[1,2,3]:[1,5,10]))
function $(t){const a=function(t,a){if(!E.includes(t.key))return
t.preventDefault()
const l=u.value||.1,o=(e.max-e.min)/l
if([A,R,T,D].includes(t.key)){const e=(m.value?[r.value?A:R,f.value?T:D]:w.value!==r.value?[A,D]:[R,D]).includes(t.key)?1:-1,o=t.shiftKey?2:t.ctrlKey?1:0
a+=e*l*F.value[o]}else t.key===B?a=e.min:t.key===P?a=e.max:a-=(t.key===I?1:-1)*l*(o>100?o/10:10)
return Math.max(e.min,Math.min(e.max,a))}(t,e.modelValue)
null!=a&&o("update:modelValue",a)}return At((()=>{const a=h(w.value?100-e.position:e.position,"%")
...
return t.createVNode("div",{class:"v-color-picker-swatches__color",onClick:()=>n&&l("update:color",n)},[t.createVNode("div",{style:{background:r}},[e.color&&p(e.color,n)?t.createVNode(zl,{size:"x-small",icon:"$success",color:it(a,"#FFFFFF")>2?"white":"black"},null):void 0])])}))])))])]))),{}}}),Ns=a({color:String,...Ya(),...l(),...$a(),...Ja(),...Gl(),...eo(),...el(),...ua(),...ta()},"VSheet"),Cs=gt()({name:"VSheet",props:Ns(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(t.toRef(e,"color")),{borderClasses:i}=qa(e),{dimensionStyles:s}=Ma(e),{elevationClasses:u}=Qa(e),{locationStyles:c}=Yl(e),{positionClasses:d}=to(e),{roundedClasses:v}=tl(e)
...
let g=!1
const h=t.computed((()=>i.value?.color)),y=t.computed((()=>f.value?e.closeText:e.openText)),{items:b,transformIn:V,transformOut:S}=On(e),{textColorClasses:w,textColorStyles:k}=Xa(h),x=zt(e,"modelValue",[],(e=>V(T(e))),(t=>{const a=S(t)
return e.multiple?a:a[0]??null})),N=Jo(),C=t.shallowRef(e.multiple?"":x.value[0]?.title??""),_=t.computed({get:()=>C.value,set:t=>{if(C.value=t??"",e.multiple||(x.value=[Mn(e,t)]),t&&e.multiple&&e.delimiters?.length){const a=t.split(new RegExp(`(?:${e.delimiters.join("|")})+`))
a.length>1&&(a.forEach((t=>{(t=t.trim())&&U(Mn(e,t))})),C.value="")}t||(m.value=-1),u.value=!t}}),I=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?x.value.length:_.value.length))
t.watch(C,(e=>{g?t.nextTick((()=>g=!1)):s.value&&!f.value&&(f.value=!0),l("update:search",e)})),t.watch(x,(t=>{e.multiple||(C.value=t[0]?.title??"")}))
const{filteredItems:P,getMatches:B}=vi(e,b,(()=>u.value?"":_.value)),R=t.computed((()=>e.hideSelected?P.value.filter((e=>!x.value.some((t=>t.value===e.value)))):P.value)),D=t.computed((()=>x.value.map((e=>e.value)))),E=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&_.value===R.value[0]?.title)&&R.value.length>0&&!u.value&&!c.value)),F=t.computed((()=>e.hideNoData&&!R.value.length||e.readonly||N?.isReadonly.value)),$=t.ref(),{onListScroll:M,onListKeydown:L}=ri($,i)
...
const e=m.value+1
x.value[e]?m.value=e:(m.value=-1,i.value.setSelectionRange(0,0))}"Enter"===t.key&&_.value&&(U(Mn(e,_.value)),_.value="")}}function W(){s.value&&(u.value=!0,i.value?.focus())}function U(a){let l=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
...
x.value=e?[a]:[],C.value=e?a.title:"",t.nextTick((()=>{f.value=!1,u.value=!0}))}}function G(e){s.value=!0,setTimeout((()=>{c.value=!0}))}function Y(e){c.value=!1}function q(t){(null==t||""===t&&!e.multiple)&&(x.value=[])}return t.watch(s,((t,a)=>{t||t===a||(m.value=-1,f.value=!1,!E.value||c.value||x.value.some((e=>{let{value:t}=e
return t===R.value[0].value}))?e.multiple&&_.value&&U(Mn(e,_.value)):U(R.value[0]))})),t.watch(f,(()=>{if(!e.hideSelected&&f.value&&x.value.length){const t=R.value.findIndex((t=>x.value.some((a=>e.valueComparator(a.value,t.value)))))
o&&window.requestAnimationFrame((()=>{t>=0&&v.value?.scrollToIndex(t)}))}})),t.watch(R,((t,a)=>{s.value&&(!t.length&&e.hideNoData&&(f.value=!1),!a.length&&t.length&&(f.value=!0))})),At((()=>{const a=!(!e.chips&&!n.chip),l=!!(!e.hideNoData||R.value.length||n["prepend-item"]||n["append-item"]||n["no-data"]),o=x.value.length>0,c=Qr.filterProps(e)
return t.createVNode(Qr,t.mergeProps({ref:i},c,{modelValue:_.value,"onUpdate:modelValue":[e=>_.value=e,q],focused:s.value,"onUpdate:focused":e=>s.value=e,validationValue:x.externalValue,counterValue:I.value,dirty:o,class:["v-combobox",{"v-combobox--active-menu":f.value,"v-combobox--chips":!!e.chips,"v-combobox--selection-slot":!!n.selection,"v-combobox--selecting-index":m.value>-1,["v-combobox--"+(e.multiple?"multiple":"single")]:!0},e.class],style:e.style,readonly:e.readonly,placeholder:o?void 0:e.placeholder,"onClick:clear":O,"onMousedown:control":z,onKeydown:H}),{...n,default:()=>t.createVNode(t.Fragment,null,[t.createVNode(jr,t.mergeProps({ref:d,modelValue:f.value,"onUpdate:modelValue":e=>f.value=e,activator:"parent",contentClass:"v-combobox__content",disabled:F.value,eager:e.eager,maxHeight:310,openOnClick:!1,closeOnContentClick:!1,transition:e.transition,onAfterLeave:W},e.menuProps),{default:()=>[l&&t.createVNode(Wn,{ref:$,selected:D.value,selectStrategy:e.multiple?"independent":"single-independent",onMousedown:e=>e.preventDefault(),onKeydown:L,onFocusin:G,onFocusout:Y,onScrollPassive:M,tabindex:"-1","aria-live":"polite",color:e.itemColor??e.color},{default:()=>[n["prepend-item"]?.(),!R.value.length&&!e.hideNoData&&(n["no-data"]?.()??t.createVNode(Bn,{title:r(e.noDataText)},null)),t.createVNode(ni,{ref:v,renderless:!0,items:R.value},{default:a=>{let{item:l,index:o,itemRef:r}=a
...
return t.createVNode(t.Fragment,null,[e.multiple&&!e.hideSelected?t.createVNode(Wo,{key:l.value,modelValue:o,ripple:!1,tabindex:"-1"},null):void 0,l.props.prependAvatar&&t.createVNode(Do,{image:l.props.prependAvatar},null),l.props.prependIcon&&t.createVNode(zl,{icon:l.props.prependIcon},null)])},title:()=>u.value?l.title:function(e,a,l){if(null==a)return e
if(Array.isArray(a))throw new Error("Multiple matches is not implemented")
...
if(!i||s)return t.createVNode("div",{key:l.value,class:["v-combobox__selection",o===m.value&&["v-combobox__selection--selected",w.value]],style:o===m.value?k.value:{}},[a?n.chip?t.createVNode(Fa,{key:"chip-defaults",defaults:{VChip:{closable:e.closableChips,size:"small",text:l.title}}},{default:()=>[s]}):t.createVNode(cn,t.mergeProps({key:"chip",closable:e.closableChips,size:"small",text:l.title,disabled:l.props.disabled},r),null):s??t.createVNode("span",{class:"v-combobox__selection-text"},[l.title,e.multiple&&o<x.value.length-1&&t.createVNode("span",{class:"v-combobox__selection-comma"},[t.createTextVNode(",")])])])}))]),"append-inner":function(){for(var a=arguments.length,l=new Array(a),o=0;o<a;o++)l[o]=arguments[o]
return t.createVNode(t.Fragment,null,[n["append-inner"]?.(...l),e.hideNoData&&!e.items.length||!e.menuIcon?void 0:t.createVNode(zl,{class:"v-combobox__menu-icon",icon:e.menuIcon,onMousedown:j,onClick:ae,"aria-label":r(y.value),title:r(y.value)},null)])}})})),Or({isFocused:s,isPristine:u,menu:f,search:_,selectionIndex:m,filteredItems:P,select:U},i)}}),Bs=a({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),As=Symbol.for("vuetify:datatable:expanded")
function Rs(e){const a=t.toRef(e,"expandOnClick"),l=zt(e,"expanded",e.expanded,(e=>new Set(e)),(e=>[...e.values()]))
...
return e}const Ds=a({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),Es=Symbol.for("vuetify:data-table-group")
function Fs(e){return{groupBy:zt(e,"groupBy")}}function $s(e){const{groupBy:a,sortBy:l}=e,o=t.ref(new Set)
...
return t.provide(Es,r),r}function Ms(){const e=t.inject(Es)
...
return t.provide(Us,s),s}function qs(e){const a=St("usePaginatedItems"),{items:l,startIndex:o,stopIndex:n,itemsPerPage:r}=e,i=t.computed((()=>r.value<=0?l.value:l.value.slice(o.value,n.value)))
return t.watch(i,(e=>{a.emit("update:currentItems",e)})),{paginatedItems:i}}const Ks={showSelectAll:!1,allSelected:()=>[],select:e=>{let{items:t,value:a}=e
...
return t}(e)}startOfMonth(e){return lu(e)}endOfMonth(e){return ou(e)}format(e,t){return su(e,t,this.locale,this.formats)}isEqual(e,t){return cu(e,t)}isValid(e){return function(e){const t=new Date(e)
...
return mu(e,Zt())}const hu=a({sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:Boolean,mustSort:Boolean},"DataTable-sort"),yu=Symbol.for("vuetify:data-table-sort")
function bu(e){return{sortBy:zt(e,"sortBy"),mustSort:t.toRef(e,"mustSort"),multiSort:t.toRef(e,"multiSort")}}function Vu(e){const{sortBy:a,mustSort:l,multiSort:o,page:n}=e
...
return t.provide(yu,r),r}function Su(e,a,l,o){const n=Zt()
...
return a}(e,e.items)))}}const Nu=a({search:String,loading:Boolean,...l(),...wu(),...Js(),...hu(),...Ws({itemsPerPage:5}),...Bs(),...Ds(),...di(),...ua()},"VDataIterator"),Cu=gt()({name:"VDataIterator",props:Nu(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{slots:l}=a
const o=zt(e,"groupBy"),n=t.toRef(e,"search"),{items:r}=xu(e),{filteredItems:i}=vi(e,r,n,{transform:e=>e.raw}),{sortBy:s,multiSort:u,mustSort:c}=bu(e),{page:d,itemsPerPage:v}=Gs(e),{toggleSort:p}=Vu({sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:f,opened:m,extractRows:g,isGroupOpen:h,toggleGroup:y}=$s({groupBy:o,sortBy:s}),{sortedItems:b}=Su(e,i,f),{flatItems:V}=js(b,o,m),S=t.computed((()=>V.value.length)),{startIndex:w,stopIndex:k,pageCount:x,prevPage:N,nextPage:C,setItemsPerPage:_,setPage:I}=Ys({page:d,itemsPerPage:v,itemsLength:S}),{paginatedItems:P}=qs({items:V,startIndex:w,stopIndex:k,itemsPerPage:v}),B=t.computed((()=>g(P.value))),{isSelected:A,select:R,selectAll:T,toggleSelect:D}=eu(e,{allItems:r,currentPage:B}),{isExpanded:E,toggleExpand:F}=Rs(e)
...
const{t:o}=Zt(),{page:n,pageCount:r,startIndex:i,stopIndex:s,itemsLength:u,itemsPerPage:c,setItemsPerPage:d}=function(){const e=t.inject(Us)
...
return At((()=>{const a=Iu.filterProps(e)
return t.createVNode("div",{class:"v-data-table-footer"},[l.prepend?.(),t.createVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createVNode("span",null,[o(e.itemsPerPageText)]),t.createVNode(ui,{items:v.value,modelValue:c.value,"onUpdate:modelValue":e=>d(Number(e)),density:"compact",variant:"outlined","hide-details":!0},null)]),t.createVNode("div",{class:"v-data-table-footer__info"},[t.createVNode("div",null,[o(e.pageText,u.value?i.value+1:0,s.value,u.value)])]),t.createVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(Iu,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable","first-aria-label":e.firstPageLabel,"last-aria-label":e.lastPageLabel,length:r.value,"next-aria-label":e.nextPageLabel,"previous-aria-label":e.prevPageLabel,rounded:!0,"show-first-last-page":!0,"total-visible":e.showCurrentPage?1:0,variant:"plain"},a),null)])])})),{}}}),Au=(Ru={align:{type:String,default:"start"},fixed:Boolean,fixedOffset:[Number,String],height:[Number,String],lastFixed:Boolean,noPadding:Boolean,tag:String,width:[Number,String]},(Tu=(e,a)=>{let{slots:l}=a
const o=e.tag??"td"
...
var Ru,Tu
const Du=a({headers:Array},"DataTable-header"),Eu=Symbol.for("vuetify:data-table-headers"),Fu={title:"",sortable:!1},$u={...Fu,width:48}
function Mu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e.children)for(const a of e.children)Mu(a,t)
else t.push(e)
...
return t}function Ou(e){if(e.key)return"data-table-group"===e.key?Fu:["data-table-expand","data-table-select"].includes(e.key)?$u:void 0}function zu(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0
...
if(n.push({...a,rowspan:s??1,colspan:a.children?Mu(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
o.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(n)}return{columns:e.map((e=>Mu(e))).flat(),headers:a}}function Hu(e){const t=[]
...
return t.provide(Eu,i),i}function Uu(){const e=t.inject(Eu)
if(!e)throw new Error("Missing headers!")
return e}const Gu=a({color:String,sticky:Boolean,multiSort:Boolean,sortAscIcon:{type:Il,default:"$sortAsc"},sortDescIcon:{type:Il,default:"$sortDesc"},...Xl()},"VDataTableHeaders"),Yu=gt()({name:"VDataTableHeaders",props:Gu(),setup(e,a){let{slots:l}=a
...
return t.createVNode(Au,t.mergeProps({tag:"th",align:d.align,class:["v-data-table__th",{"v-data-table__th--sortable":d.sortable,"v-data-table__th--sorted":r(d),"v-data-table__th--fixed":d.fixed,"v-data-table__th--sticky":e.sticky},p.value],style:{width:h(d.width),minWidth:h(d.minWidth),...f(d,b)},colspan:d.colspan,rowspan:d.rowspan,onClick:d.sortable?()=>o(d):void 0,fixed:d.fixed,lastFixed:d.lastFixed,noPadding:V},d.headerProps),{default:()=>{const a=`header.${d.key}`,v={column:d,selectAll:u,isSorted:r,toggleSort:o,sortBy:n.value,someSelected:i.value,allSelected:s.value,getSortIcon:m}
...
return l["data-table-select"]?.({props:{modelValue:e,indeterminate:a,"onUpdate:modelValue":o}})??t.createVNode("td",null,[t.createVNode(Wo,{modelValue:e,indeterminate:a,"onUpdate:modelValue":o},null)])}return t.createVNode("td",null,null)}))])}}),Xu=a({index:Number,item:Object,cellProps:[Object,Function],onClick:K(),onContextmenu:K(),onDblclick:K()},"VDataTableRow"),Zu=gt()({name:"VDataTableRow",props:Xu(),setup(e,a){let{slots:l}=a
...
const{columns:n}=Uu(),{expandOnClick:r,toggleExpand:i,isExpanded:s}=Ts(),{isSelected:u,toggleSelect:c}=tu(),{toggleGroup:d,isGroupOpen:v}=Ms(),{t:p}=Zt()
...
return t.createVNode(t.Fragment,{key:m.props.key},[o.item?o.item(m):t.createVNode(Zu,m.props,o),s(a)&&o["expanded-row"]?.(f)])}))]):t.createVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createVNode("td",{colspan:n.value.length},[o["no-data"]?.()??p(e.noDataText)])]):t.createVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createVNode("td",{colspan:n.value.length},[o.loading?.()??p(e.loadingText)])]))),{}}}),ec=a({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,...l(),...cl(),...ua(),...ta()},"VTable"),tc=gt()({name:"VTable",props:ec(),setup(e,a){let{slots:l,emit:o}=a
...
return{type:"item",key:e.returnObject?m(t,e.itemValue):o,index:a,value:o,selectable:n,columns:r,raw:t}}(e,t,l,a)))}function oc(e,a){return{items:t.computed((()=>lc(e,e.items,a.value)))}}const nc=a({...Ju(),width:[String,Number],search:String,...Bs(),...Ds(),...Du(),...ac(),...Js(),...hu(),...Gu(),...ec()},"DataTable"),rc=a({...Ws(),...nc(),...di(),...Pu()},"VDataTable"),ic=gt()({name:"VDataTable",props:rc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Fs(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{page:u,itemsPerPage:c}=Gs(e),{columns:d,headers:v,sortFunctions:p,filterFunctions:f}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:m}=oc(e,d),g=t.toRef(e,"search"),{filteredItems:h}=vi(e,m,g,{transform:e=>e.columns,customKeyFilter:f}),{toggleSort:y}=Vu({sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:b,opened:V,extractRows:S,isGroupOpen:w,toggleGroup:k}=$s({groupBy:n,sortBy:r}),{sortedItems:x}=Su(e,h,b,p),{flatItems:N}=js(x,n,V),C=t.computed((()=>N.value.length)),{startIndex:_,stopIndex:I,pageCount:P,setItemsPerPage:B}=Ys({page:u,itemsPerPage:c,itemsLength:C}),{paginatedItems:A}=qs({items:N,startIndex:_,stopIndex:I,itemsPerPage:c}),R=t.computed((()=>S(A.value))),{isSelected:T,select:D,selectAll:E,toggleSelect:F,someSelected:$,allSelected:M}=eu(e,{allItems:m,currentPage:R}),{isExpanded:L,toggleExpand:O}=Rs(e)
...
return At((()=>{const a=Bu.filterProps(e),n=Yu.filterProps(e),r=Qu.filterProps(e),i=tc.filterProps(e)
return t.createVNode(tc,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i),{top:()=>o.top?.(z.value),default:()=>o.default?o.default(z.value):t.createVNode(t.Fragment,null,[o.colgroup?.(z.value),t.createVNode("thead",null,[t.createVNode(Yu,n,o)]),o.thead?.(z.value),t.createVNode("tbody",null,[o["body.prepend"]?.(z.value),o.body?o.body(z.value):t.createVNode(Qu,t.mergeProps(l,r,{items:A.value}),o),o["body.append"]?.(z.value)]),o.tbody?.(z.value),o.tfoot?.(z.value)]),bottom:()=>o.bottom?o.bottom(z.value):t.createVNode(t.Fragment,null,[t.createVNode(Dn,null,null),t.createVNode(Bu,a,{prepend:o["footer.prepend"]})])})})),{}}}),sc=a({...nc(),...Ds(),...ai(),...di()},"VDataTableVirtual"),uc=gt()({name:"VDataTableVirtual",props:sc(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Fs(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{columns:u,headers:c,sortFunctions:d,filterFunctions:v}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:p}=oc(e,u),f=t.toRef(e,"search"),{filteredItems:m}=vi(e,p,f,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:g}=Vu({sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:y,opened:b,extractRows:V,isGroupOpen:S,toggleGroup:w}=$s({groupBy:n,sortBy:r}),{sortedItems:k}=Su(e,m,y,d),{flatItems:x}=js(k,n,b),N=t.computed((()=>V(x.value))),{isSelected:C,select:_,selectAll:I,toggleSelect:P,someSelected:B,allSelected:A}=eu(e,{allItems:N,currentPage:N}),{isExpanded:R,toggleExpand:T}=Rs(e),{containerRef:D,markerRef:E,paddingTop:F,paddingBottom:$,computedItems:M,handleItemResize:L,handleScroll:O,handleScrollend:z}=li(e,x),j=t.computed((()=>M.value.map((e=>e.raw))))
...
At((()=>{const a=Yu.filterProps(e),n=Qu.filterProps(e),r=tc.filterProps(e)
return t.createVNode(tc,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r),{top:()=>o.top?.(H.value),wrapper:()=>t.createVNode("div",{ref:D,onScrollPassive:O,onScrollend:z,class:"v-table__wrapper",style:{height:h(e.height)}},[t.createVNode("table",null,[t.createVNode("thead",null,[t.createVNode(Yu,t.mergeProps(a,{sticky:e.fixedHeader}),o)]),t.createVNode("tbody",null,[t.createVNode("tr",{ref:E,style:{height:h(F.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)]),o["body.prepend"]?.(H.value),t.createVNode(Qu,t.mergeProps(l,n,{items:j.value}),{...o,item:e=>t.createVNode(ti,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>L(e.internalItem.index,t)},{default:a=>{let{itemRef:l}=a
return o.item?.({...e,itemRef:l})??t.createVNode(Zu,t.mergeProps(e.props,{ref:l,key:e.internalItem.index,index:e.internalItem.index}),o)}})}),o["body.append"]?.(H.value),t.createVNode("tr",{style:{height:h($.value),border:0}},[t.createVNode("td",{colspan:u.value.length,style:{height:0,border:0}},null)])])])]),bottom:()=>o.bottom?.(H.value)})}))}}),cc=a({itemsLength:{type:[Number,String],required:!0},...Ws(),...nc(),...Pu()},"VDataTableServer"),dc=gt()({name:"VDataTableServer",props:cc(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,a){let{attrs:l,slots:o}=a
const{groupBy:n}=Fs(e),{sortBy:r,multiSort:i,mustSort:s}=bu(e),{page:u,itemsPerPage:c}=Gs(e),d=t.computed((()=>parseInt(e.itemsLength,10))),{columns:v,headers:p}=Wu(e,{groupBy:n,showSelect:t.toRef(e,"showSelect"),showExpand:t.toRef(e,"showExpand")}),{items:f}=oc(e,v),{toggleSort:m}=Vu({sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:g,isGroupOpen:h,toggleGroup:y,extractRows:b}=$s({groupBy:n,sortBy:r}),{pageCount:V,setItemsPerPage:S}=Ys({page:u,itemsPerPage:c,itemsLength:d}),{flatItems:w}=js(f,n,g),{isSelected:k,select:x,selectAll:N,toggleSelect:C,someSelected:_,allSelected:I}=eu(e,{allItems:f,currentPage:f}),{isExpanded:P,toggleExpand:B}=Rs(e),A=t.computed((()=>b(f.value)))
...
return t.createVNode("div",{class:["v-date-picker-header",{"v-date-picker-header--clickable":!!e.onClick},n.value],style:r.value,onClick:i},[o.prepend&&t.createVNode("div",{key:"prepend",class:"v-date-picker-header__prepend"},[o.prepend()]),a&&t.createVNode(ja,{key:"content",name:e.transition},{default:()=>[t.createVNode("div",{key:e.header,class:"v-date-picker-header__content"},[o.default?.()??e.header])]}),l&&t.createVNode("div",{class:"v-date-picker-header__append"},[o.append?t.createVNode(Fa,{key:"append-defaults",disabled:!e.appendIcon,defaults:{VBtn:{icon:e.appendIcon,variant:"text"}}},{default:()=>[o.append?.()]}):t.createVNode(No,{key:"append-btn",icon:e.appendIcon,variant:"text",onClick:s},null)])])})),{}}}),Wc=a({allowedDates:[Array,Function],disabled:Boolean,displayValue:null,modelValue:Array,month:[Number,String],max:null,min:null,showAdjacentMonths:Boolean,year:[Number,String],weekdays:{type:Array,default:()=>[0,1,2,3,4,5,6]}},"calendar")
function Uc(e){const a=gu(),l=zt(e,"modelValue",[],(e=>T(e))),o=t.computed((()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date())),n=zt(e,"year",void 0,(e=>{const t=null!=e?Number(e):a.getYear(o.value)
...
return t.createVNode("div",{class:["v-date-picker-month__day",{"v-date-picker-month__day--adjacent":a.isAdjacent,"v-date-picker-month__day--hide-adjacent":a.isHidden,"v-date-picker-month__day--selected":a.isSelected,"v-date-picker-month__day--week-end":a.isWeekEnd,"v-date-picker-month__day--week-start":a.isWeekStart}],"data-v-date":a.isDisabled?void 0:a.isoDate},[(e.showAdjacentMonths||!a.isAdjacent)&&t.createVNode(Fa,{defaults:{VBtn:{color:!a.isSelected&&!a.isToday||a.isDisabled?void 0:e.color,disabled:a.isDisabled,icon:!0,ripple:!1,text:a.localized,variant:a.isDisabled?"text":a.isToday&&!a.isSelected?"outlined":"flat",onClick:()=>c(a.date)}}},{default:()=>[o.day?.(n)??t.createVNode(No,n.props,null)]})])}))])])}}),qc=a({color:String,height:[String,Number],modelValue:Number},"VDatePickerMonths"),Kc=gt()({name:"VDatePickerMonths",props:qc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=gu(),n=zt(e,"modelValue"),r=t.computed((()=>{let e=o.startOfYear(o.date())
...
function i(e){n.value=e}return l.month?.({month:a,i:o,props:r})??t.createVNode(No,t.mergeProps({key:"month"},r,{onClick:()=>i(o)}),null)}))])]))),{}}}),Xc=a({color:String,height:[String,Number],min:null,max:null,modelValue:Number},"VDatePickerYears"),Zc=gt()({name:"VDatePickerYears",props:Xc(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=gu(),n=zt(e,"modelValue"),r=t.computed((()=>{const t=o.getYear(o.date())
let a=t-100,l=t+52
...
return l.year?.({year:a,i:o,props:r})??t.createVNode(No,t.mergeProps({key:"month"},r),null)}))])]))),{}}}),Jc=ht("v-picker-title"),Qc=a({bgColor:String,landscape:Boolean,title:String,hideHeader:Boolean,...Ns()},"VPicker"),ed=gt()({name:"VPicker",props:Qc(),setup(e,a){let{slots:l}=a
...
v.value=n.isBefore(a,l)})),At((()=>{const a=ed.filterProps(e),l=zc.filterProps(e),n=Hc.filterProps(e),u=Yc.filterProps(e),v=C(Kc.filterProps(e),["modelValue"]),x=C(Zc.filterProps(e),["modelValue"]),N={header:p.value,transition:m.value}
return t.createVNode(ed,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(Fa,{defaults:{VDatePickerHeader:{...N}}},{default:()=>[o.header?.(N)]}):t.createVNode(Hc,t.mergeProps({key:"header"},n,N,{onClick:"month"!==s.value?S:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(zc,t.mergeProps(l,{disabled:y.value,text:f.value,"onClick:next":b,"onClick:prev":V,"onClick:month":w,"onClick:year":k}),null),t.createVNode(ka,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(Kc,t.mergeProps({key:"date-picker-months"},v,{modelValue:c.value,"onUpdate:modelValue":e=>c.value=e,min:g.value,max:h.value}),null):"year"===s.value?t.createVNode(Zc,t.mergeProps({key:"date-picker-years"},x,{modelValue:d.value,"onUpdate:modelValue":e=>d.value=e,min:g.value,max:h.value}),null):t.createVNode(Yc,t.mergeProps({key:"date-picker-month"},u,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:c.value,"onUpdate:month":e=>c.value=e,year:d.value,"onUpdate:year":e=>d.value=e,min:g.value,max:h.value}),null)]})]),actions:o.actions})})),{}}}),ld=Symbol.for("vuetify:v-expansion-panel"),od=["default","accordion","inset","popout"],nd=a({color:String,static:Boolean,variant:{type:String,default:"default",validator:e=>od.includes(e)},readonly:Boolean,...l(),...yl(),...ua(),...ta()},"VExpansionPanels"),rd=gt()({name:"VExpansionPanels",props:nd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
Sl(e,ld)
const{themeClasses:o}=la(e),n=t.computed((()=>e.variant&&`v-expansion-panels--variant-${e.variant}`))
return vt({VExpansionPanel:{color:t.toRef(e,"color"),readonly:t.toRef(e,"readonly"),static:t.toRef(e,"static")}}),At((()=>t.createVNode(e.tag,{class:["v-expansion-panels",o.value,n.value,e.class],style:e.style},l))),{}}}),id=a({...l(),...Nr()},"VExpansionPanelText"),sd=gt()({name:"VExpansionPanelText",props:id(),setup(e,a){let{slots:l}=a
const o=t.inject(ld)
if(!o)throw new Error("[Vuetify] v-expansion-panel-text needs to be placed inside v-expansion-panel")
const{hasContent:n,onAfterLeave:r}=Cr(e,o.isSelected)
return At((()=>t.createVNode(Ta,{onAfterLeave:r},{default:()=>[t.withDirectives(t.createVNode("div",{class:["v-expansion-panel-text",e.class],style:e.style},[l.default&&n.value&&t.createVNode("div",{class:"v-expansion-panel-text__wrapper"},[l.default?.()])]),[[t.vShow,o.isSelected.value]])]}))),{}}}),ud=a({color:String,expandIcon:{type:Il,default:"$expand"},collapseIcon:{type:Il,default:"$collapse"},hideActions:Boolean,static:Boolean,ripple:{type:[Boolean,Object],default:!1},readonly:Boolean,...l()},"VExpansionPanelTitle"),cd=gt()({name:"VExpansionPanelTitle",directives:{Ripple:ko},props:ud(),setup(e,a){let{slots:l}=a
const o=t.inject(ld)
...
return At((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(i.value),!e.hideActions&&t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?l.actions(i.value):t.createVNode(zl,{icon:o.isSelected.value?e.collapseIcon:e.expandIcon},null)])]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),dd=a({title:String,text:String,bgColor:String,...l(),...Ja(),...bl(),...Nr(),...el(),...ua(),...ud()},"VExpansionPanel"),vd=gt()({name:"VExpansionPanel",props:dd(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
const o=Vl(e,ld),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(e,"bgColor"),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e),u=t.computed((()=>o?.disabled.value||e.disabled)),c=t.computed((()=>o.group.items.value.reduce(((e,t,a)=>(o.group.selected.value.includes(t.id)&&e.push(a),e)),[]))),d=t.computed((()=>{const e=o.group.items.value.findIndex((e=>e.id===o.id))
...
t&&r.value?.submit()})),t.preventDefault()}return At((()=>t.createVNode("form",{ref:r,class:["v-form",e.class],style:e.style,novalidate:!0,onReset:i,onSubmit:s},[l.default?.(n)]))),Or(n,r)}}),bd=a({disabled:Boolean,modelValue:{type:Boolean,default:void 0},...cr()},"VHover"),Vd=gt()({name:"VHover",props:bd(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=zt(e,"modelValue"),{runOpenDelay:o,runCloseDelay:n}=dr(e,(t=>!e.disabled&&(l.value=t)))
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),Sd=a({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...$a(),...ua()},"VInfiniteScroll"),wd=mt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootRef:null,rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
...
return t.createVNode(a,{ref:n,class:["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":o,"v-infinite-scroll--end":u}],style:b.value},{default:()=>[t.createVNode("div",{class:"v-infinite-scroll__side"},[y("start",r.value)]),n.value&&o&&c&&t.createVNode(wd,{key:"start",side:"start",onIntersect:f,rootRef:n.value,rootMargin:s.value},null),l.default?.(),n.value&&u&&c&&t.createVNode(wd,{key:"end",side:"end",onIntersect:f,rootRef:n.value,rootMargin:s.value},null),t.createVNode("div",{class:"v-infinite-scroll__side"},[y("end",i.value)])]})}))}}),xd=Symbol.for("vuetify:v-item-group"),Nd=a({...l(),...yl({selectedClass:"v-item--selected"}),...ua(),...ta()},"VItemGroup"),Cd=gt()({name:"VItemGroup",props:Nd(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{isSelected:n,select:r,next:i,prev:s,selected:u}=Sl(e,xd)
return()=>t.createVNode(e.tag,{class:["v-item-group",o.value,e.class],style:e.style},{default:()=>[l.default?.({isSelected:n,select:r,next:i,prev:s,selected:u.value})]})}}),_d=gt()({name:"VItem",props:bl(),emits:{"group:selected":e=>!0},setup(e,t){let{slots:a}=t
const{isSelected:l,select:o,toggle:n,selectedClass:r,value:i,disabled:s}=Vl(e,xd)
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),Id=ht("v-kbd"),Pd=a({...l(),...Et()},"VLayout"),Bd=gt()({name:"VLayout",props:Pd(),setup(e,a){let{slots:l}=a
const{layoutClasses:o,layoutStyles:n,getLayoutItem:r,items:i,layoutRef:s}=Lt(e)
return At((()=>t.createVNode("div",{ref:s,class:[o.value,e.class],style:[n.value,e.style]},[l.default?.()]))),{getLayoutItem:r,items:i}}}),Ad=a({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...l(),...Ft()},"VLayoutItem"),Rd=gt()({name:"VLayoutItem",props:Ad(),setup(e,a){let{slots:l}=a
...
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function jd(){throw new Error}const Hd=["start","end","left","right","top","bottom"],Wd=a({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>Hd.includes(e)},sticky:Boolean,...Ya(),...l(),...wr(),...Ja(),...Ft(),...el(),...ua({tag:"nav"}),...ta()},"VNavigationDrawer"),Ud=gt()({name:"VNavigationDrawer",props:Wd(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
const{isRtl:r}=Qt(),{themeClasses:i}=la(e),{borderClasses:s}=qa(e),{backgroundColorClasses:u,backgroundColorStyles:c}=Za(t.toRef(e,"color")),{elevationClasses:d}=Qa(e),{displayClasses:v,mobile:p}=kr(e),{roundedClasses:f}=tl(e),m=ao(),g=zt(e,"modelValue",null,(e=>!!e)),{ssrBootStyles:y}=rl(),{scopeId:b}=_r(),V=t.ref(),S=t.shallowRef(!1),w=t.computed((()=>e.rail&&e.expandOnHover&&S.value?Number(e.width):Number(e.rail?e.railWidth:e.width))),k=t.computed((()=>se(e.location,r.value))),x=t.computed((()=>!e.permanent&&(p.value||e.temporary))),N=t.computed((()=>e.sticky&&!x.value&&"bottom"!==k.value))
Ot((()=>e.expandOnHover&&null!=e.rail),(()=>{t.watch(S,(e=>o("update:rail",!e)))})),Ot((()=>!e.disableResizeWatcher),(()=>{t.watch(x,(a=>!e.permanent&&t.nextTick((()=>g.value=!a))))})),Ot((()=>!e.disableRouteWatcher&&!!m),(()=>{t.watch(m.currentRoute,(()=>x.value&&(g.value=!1)))})),t.watch((()=>e.permanent),(e=>{e&&(g.value=!0)})),t.onBeforeMount((()=>{null!=e.modelValue||x.value||(g.value=e.permanent||!p.value)}))
...
return t.createVNode("div",t.mergeProps({class:["v-otp-input",{"v-otp-input--divided":!!e.divider},e.class],style:[e.style]},a),[t.createVNode("div",{ref:m,class:"v-otp-input__content",style:[r.value]},[p.value.map(((a,l)=>t.createVNode(t.Fragment,null,[e.divider&&0!==l&&t.createVNode("span",{class:"v-otp-input__divider"},[e.divider]),t.createVNode(Kr,{focused:i.value&&e.focusAll||f.value===l,key:l},{...n,loader:void 0,default:()=>t.createVNode("input",{ref:e=>g.value[l]=e,"aria-label":d(e.label,l+1),autofocus:0===l&&e.autofocus,autocomplete:"one-time-code",class:["v-otp-input__field"],disabled:e.disabled,inputmode:"number"===e.type?"numeric":"text",min:"number"===e.type?0:void 0,maxlength:"1",placeholder:e.placeholder,type:"number"===e.type?"text":e.type,value:c.value[l],onInput:y,onFocus:e=>{return t=l,s(),void(f.value=t)
...
var t,a}},null)})]))),t.createVNode("input",t.mergeProps({class:"v-otp-input-input",type:"hidden"},o,{value:c.value.join("")}),null),t.createVNode($r,{contained:!0,"content-class":"v-otp-input__loader","model-value":!!e.loading,persistent:!0},{default:()=>[n.loader?.()??t.createVNode(Wl,{color:"boolean"==typeof e.loading?void 0:e.loading,indeterminate:!0,size:"24",width:"2"},null)]}),n.default?.()])])})),{blur:()=>{g.value?.some((e=>e.blur()))},focus:()=>{g.value?.[0].focus()},reset:function(){c.value=[]},isFocused:i}}})
...
e.style.setProperty("transform",`translateY(${r}px) scale(${v})`)})))}return At((()=>t.createVNode(Ga,{class:["v-parallax",{"v-parallax--active":n.value},e.class],style:e.style,ref:u,cover:!0,onLoadstart:p,onLoad:p},l))),{}}}),Zd=a({...zo({falseIcon:"$radioOff",trueIcon:"$radioOn"})},"VRadio"),Jd=gt()({name:"VRadio",props:Zd(),setup(e,a){let{slots:l}=a
...
return t.createVNode(t.Fragment,null,[c&&t.createVNode(Fo,{id:l.value},{default:()=>[c]}),t.createVNode(Oo,t.mergeProps(u,{id:l.value,"aria-describedby":r.value,defaultsTarget:"VRadio",trueIcon:e.trueIcon,falseIcon:e.falseIcon,type:e.type,disabled:s.value,readonly:d.value,"aria-labelledby":c?l.value:void 0,multiple:!1},n,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e}),o)])}})})),{}}}),tv=a({...qo(),...tn(),...ps(),strict:Boolean,modelValue:{type:Array,default:()=>[0,0]}},"VRangeSlider"),av=gt()({name:"VRangeSlider",props:tv(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,end:e=>!0,start:e=>!0},setup(e,a){let{slots:l,emit:o}=a
const n=t.ref(),r=t.ref(),i=t.ref(),{rtlClasses:s}=Qt()
const u=fs(e),c=zt(e,"modelValue",void 0,(e=>e?.length?e.map((e=>u.roundValue(e))):[0,0])),{activeThumbRef:d,hasLabels:v,max:p,min:f,mousePressed:m,onSliderMousedown:g,onSliderTouchstart:h,position:y,trackContainerRef:b}=ms({props:e,steps:u,onSliderStart:()=>{o("start",c.value)},onSliderEnd:t=>{let{value:a}=t
...
a.includes(",")?t=uv(a):a.includes("@")?t=iv(a):a&&t.push(sv(a))}return[rv(e,t)]}function uv(e){return e.replace(/\s/g,"").split(",").map(sv)}const cv=a({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...$a(),...Ja(),...ta()},"VSkeletonLoader"),dv=gt()({name:"VSkeletonLoader",props:cv(),setup(e,a){let{slots:l}=a
const{backgroundColorClasses:o,backgroundColorStyles:n}=Za(t.toRef(e,"color")),{dimensionStyles:r}=Ma(e),{elevationClasses:i}=Qa(e),{themeClasses:s}=la(e),{t:u}=Zt(),c=t.computed((()=>sv(T(e.type).join(","))))
...
return u<=n?n=Math.max(u-v,0):c<=d&&(n=Math.min(n-(c-d-v),l-a)),n}const fv=Symbol.for("vuetify:v-slide-group"),mv=a({centerActive:Boolean,direction:{type:String,default:"horizontal"},symbol:{type:null,default:fv},nextIcon:{type:Il,default:"$next"},prevIcon:{type:Il,default:"$prev"},showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||["always","desktop","mobile"].includes(e)},...l(),...wr(),...ua(),...yl({selectedClass:"v-slide-group-item--active"})},"VSlideGroup"),gv=gt()({name:"VSlideGroup",props:mv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
c.value=D(t,0,v.value-d.value)}const E=t.computed((()=>{let e=c.value>v.value-d.value?-(v.value-d.value)+vv(v.value-d.value-c.value):-c.value
...
return t.withDirectives(t.createVNode("button",{class:["v-stepper-item",{"v-stepper-item--complete":u.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":s.value},o?.selectedClass.value],disabled:!e.editable,onClick:function(){o?.toggle()}},[t.createVNode(Do,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:a?e.color:void 0,size:24},{default:()=>[l.icon?.(d.value)??(c.value?t.createVNode(zl,{icon:c.value},null):n.value)]}),t.createVNode("div",{class:"v-stepper-item__content"},[r&&t.createVNode("div",{key:"title",class:"v-stepper-item__title"},[l.title?.(d.value)??e.title]),v&&t.createVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[l.subtitle?.(d.value)??e.subtitle]),l.default?.(d.value)])]),[[t.resolveDirective("ripple"),e.ripple&&e.editable,null]])})),{}}}),Nv=Symbol.for("vuetify:v-stepper"),Cv=a({...C(qi(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),_v=gt()({name:"VStepperWindow",props:Cv(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const o=t.inject(Nv,null),n=zt(e,"modelValue"),r=t.computed({get:()=>null==n.value&&o?o.items.value.find((e=>o.selected.value.includes(e.id)))?.value:n.value,set(e){n.value=e}})
return At((()=>{const a=Ki.filterProps(e)
return t.createVNode(Ki,t.mergeProps({_as:"VStepperWindow"},a,{modelValue:r.value,"onUpdate:modelValue":e=>r.value=e,class:"v-stepper-window",mandatory:!1,touch:!1}),l)})),{}}}),Iv=a({...Ji()},"VStepperWindowItem"),Pv=gt()({name:"VStepperWindowItem",props:Iv(),setup(e,a){let{slots:l}=a
return At((()=>{const a=Qi.filterProps(e)
return t.createVNode(Qi,t.mergeProps({_as:"VStepperWindowItem"},a,{class:"v-stepper-window-item"}),l)})),{}}}),Bv=Symbol.for("vuetify:v-stepper"),Av=a({altLabels:Boolean,bgColor:String,editable:Boolean,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:String,default:"title"},itemValue:{type:String,default:"value"},mobile:Boolean,nonLinear:Boolean,flat:Boolean,...yl({mandatory:"force",selectedClass:"v-stepper-item--selected"}),...Ns(),..._(Vv(),["prevText","nextText"])},"VStepper"),Rv=gt()({name:"VStepper",props:Av(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
const{items:o,next:n,prev:r,selected:i}=Sl(e,Bv),{color:s,editable:u,prevText:c,nextText:d}=t.toRefs(e),v=t.computed((()=>e.items.map(((t,a)=>({title:m(t,e.itemTitle,t),value:m(t,e.itemValue,a+1),raw:t}))))),p=t.computed((()=>o.value.findIndex((e=>i.value.includes(e.id)))))
...
return t.createVNode(t.Fragment,null,[l,t.createVNode("div",{class:["v-switch__thumb",{"v-switch__thumb--filled":n||e.loading},e.inset?void 0:r.value],style:e.inset?void 0:i.value},[t.createVNode(xa,null,{default:()=>[e.loading?t.createVNode(Jl,{name:"v-switch",active:!0,color:!1===h.value?void 0:v.value},{default:e=>o.loader?o.loader(e):t.createVNode(Wl,{active:e.isActive,color:e.color,indeterminate:!0,size:"16",width:"2"},null)}):n&&t.createVNode(zl,{key:n,icon:n,size:"x-small"},null)]})])])}})}})})),{}}}),Ev=a({color:String,height:[Number,String],window:Boolean,...l(),...Ja(),...Ft(),...el(),...ua(),...ta()},"VSystemBar"),Fv=gt()({name:"VSystemBar",props:Ev(),setup(e,a){let{slots:l}=a
const{themeClasses:o}=la(e),{backgroundColorClasses:n,backgroundColorStyles:r}=Za(t.toRef(e,"color")),{elevationClasses:i}=Qa(e),{roundedClasses:s}=tl(e),{ssrBootStyles:u}=rl(),c=t.computed((()=>e.height??(e.window?32:24))),{layoutItemStyles:d}=Mt({id:e.name,order:t.computed((()=>parseInt(e.order,10))),position:t.shallowRef("top"),layoutSize:c,elementSize:c,active:t.computed((()=>!0)),absolute:t.toRef(e,"absolute")})
return At((()=>t.createVNode(e.tag,{class:["v-system-bar",{"v-system-bar--window":e.window},o.value,n.value,i.value,s.value,e.class],style:[r.value,d.value,u.value,e.style]},l))),{}}}),$v=Symbol.for("vuetify:v-tabs"),Mv=a({fixed:Boolean,sliderColor:String,hideSlider:Boolean,direction:{type:String,default:"horizontal"},...C(xo({selectedClass:"v-tab--selected",variant:"text"}),["active","block","flat","location","position","symbol"])},"VTab"),Lv=gt()({name:"VTab",props:Mv(),setup(e,a){let{slots:l,attrs:o}=a
const{textColorClasses:n,textColorStyles:r}=Xa(e,"sliderColor"),i=t.ref(),s=t.ref(),u=t.computed((()=>"horizontal"===e.direction)),c=t.computed((()=>i.value?.group?.isSelected.value??!1))
...
return t.createVNode(No,t.mergeProps({symbol:$v,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),Or({},i)}})
const Ov=a({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,sliderColor:String,...mv({mandatory:"force"}),...cl(),...ua()},"VTabs"),zv=gt()({name:"VTabs",props:Ov(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(gv,t.mergeProps(a,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs",`v-tabs--${e.direction}`,`v-tabs--align-tabs-${e.alignTabs}`,{"v-tabs--fixed-tabs":e.fixedTabs,"v-tabs--grow":e.grow,"v-tabs--stacked":e.stacked},r.value,i.value,e.class],style:[{"--v-tabs-height":h(e.height)},s.value,e.style],role:"tablist",symbol:$v}),{default:()=>[l.default?l.default():n.value.map((e=>t.createVNode(Lv,t.mergeProps(e,{key:e.text}),null)))]})})),{}}}),jv=a({autoGrow:Boolean,autofocus:Boolean,counter:[Boolean,Number,String],counterValue:Function,prefix:String,placeholder:String,persistentPlaceholder:Boolean,persistentCounter:Boolean,noResize:Boolean,rows:{type:[Number,String],default:5,validator:e=>!isNaN(parseFloat(e))},maxRows:{type:[Number,String],validator:e=>!isNaN(parseFloat(e))},suffix:String,modelModifiers:Object,...tn(),...qr()},"VTextarea"),Hv=gt()({name:"VTextarea",directives:{Intersect:Wa},inheritAttrs:!1,props:jv(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0},setup(e,a){let{attrs:l,emit:o,slots:n}=a
...
case"end":return t[1]
default:return null}}))
return At((()=>t.createVNode(e.tag,{class:["v-timeline",`v-timeline--${e.direction}`,`v-timeline--align-${e.align}`,`v-timeline--justify-${e.justify}`,s.value,{"v-timeline--inset-line":!!e.lineInset},o.value,n.value,i.value,r.value,e.class],style:[{"--v-timeline-line-thickness":h(e.lineThickness)},e.style]},l))),{}}}),qv=a({dotColor:String,fillDot:Boolean,hideDot:Boolean,icon:Il,iconColor:String,lineColor:String,...l(),...el(),...Ml(),...Ja()},"VTimelineDivider"),Kv=gt()({name:"VTimelineDivider",props:qv(),setup(e,a){let{slots:l}=a
...
return l.default?.(...a)??e.text}})})),Or({},s)}}),ap=gt()({name:"VValidation",props:Qo(),emits:{"update:modelValue":e=>!0},setup(e,t){let{slots:a}=t
const l=en(e,"validation")
return()=>a.default?.(l)}})
var lp=Object.freeze({__proto__:null,VAlert:Ro,VAlertTitle:Po,VApp:sa,VAppBar:sl,VAppBarNavIcon:_o,VAppBarTitle:Io,VAutocomplete:fi,VAvatar:Do,VBadge:gi,VBanner:Si,VBannerActions:yi,VBannerText:bi,VBottomNavigation:ki,VBottomSheet:_i,VBreadcrumbs:Ti,VBreadcrumbsDivider:Pi,VBreadcrumbsItem:Ai,VBtn:No,VBtnGroup:hl,VBtnToggle:Nl,VCard:zi,VCardActions:Di,VCardItem:Mi,VCardSubtitle:Ei,VCardText:Li,VCardTitle:Fi,VCarousel:Zi,VCarouselItem:ts,VCheckbox:on,VCheckboxBtn:Wo,VChip:cn,VChipGroup:sn,VClassIcon:Dl,VCode:as,VCol:Sc,VColorPicker:_s,VCombobox:Ps,VComponentIcon:Al,VContainer:pc,VCounter:Wr,VDataIterator:Cu,VDataTable:ic,VDataTableFooter:Bu,VDataTableRow:Zu,VDataTableRows:Qu,VDataTableServer:dc,VDataTableVirtual:uc,VDatePicker:ad,VDatePickerControls:zc,VDatePickerHeader:Hc,VDatePickerMonth:Yc,VDatePickerMonths:Kc,VDatePickerYears:Zc,VDefaultsProvider:Fa,VDialog:Ni,VDialogBottomTransition:Sa,VDialogTopTransition:wa,VDialogTransition:ha,VDivider:Dn,VExpandTransition:Ta,VExpandXTransition:Da,VExpansionPanel:vd,VExpansionPanelText:sd,VExpansionPanelTitle:cd,VExpansionPanels:rd,VFabTransition:Va,VFadeTransition:ka,VField:Kr,VFieldLabel:Gr,VFileInput:fd,VFooter:gd,VForm:yd,VHover:Vd,VIcon:zl,VImg:Ga,VInfiniteScroll:kd,VInput:an,VItem:_d,VItemGroup:Cd,VKbd:Id,VLabel:Fo,VLayout:Bd,VLayoutItem:Rd,VLazy:Dd,VLigatureIcon:Tl,VList:Wn,VListGroup:Cn,VListImg:Un,VListItem:Bn,VListItemAction:Yn,VListItemMedia:Kn,VListItemSubtitle:_n,VListItemTitle:In,VListSubheader:Rn,VLocaleProvider:Fd,VMain:Md,VMenu:jr,VMessages:Yo,VNavigationDrawer:Ud,VNoSsr:Gd,VOtpInput:qd,VOverlay:$r,VPagination:Iu,VParallax:Xd,VProgressCircular:Wl,VProgressLinear:Kl,VRadio:Jd,VRadioGroup:ev,VRangeSlider:av,VRating:ov,VResponsive:Oa,VRow:Mc,VScaleTransition:xa,VScrollXReverseTransition:Ca,VScrollXTransition:Na,VScrollYReverseTransition:Ia,VScrollYTransition:_a,VSelect:ui,VSelectionControl:jo,VSelectionControlGroup:Oo,VSheet:Cs,VSkeletonLoader:dv,VSlideGroup:gv,VSlideGroupItem:hv,VSlideXReverseTransition:Ba,VSlideXTransition:Pa,VSlideYReverseTransition:Ra,VSlideYTransition:Aa,VSlider:Ss,VSnackbar:bv,VSpacer:Lc,VStepper:Rv,VStepperActions:Sv,VStepperHeader:wv,VStepperItem:xv,VStepperWindow:_v,VStepperWindowItem:Pv,VSvgIcon:Rl,VSwitch:Dv,VSystemBar:Fv,VTab:Lv,VTable:tc,VTabs:zv,VTextField:Qr,VTextarea:Hv,VThemeProvider:Uv,VTimeline:Yv,VTimelineItem:Zv,VToolbar:ol,VToolbarItems:Qv,VToolbarTitle:da,VTooltip:tp,VValidation:ap,VVirtualScroll:ni,VWindow:Ki,VWindowItem:Qi})
...
var cp=Object.freeze({__proto__:null,ClickOutside:Dr,Intersect:Wa,Mutate:np,Resize:rp,Ripple:ko,Scroll:up,Touch:Ui})
function dp(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
const{blueprint:a,...l}=e,n=L(a,l),{aliases:r={},components:i={},directives:s={}}=n,u=ct(n.defaults),c=Sr(n.display,n.ssr),d=aa(n.theme),v=Fl(n.icons),p=Xt(n.locale),f=fu(n.date,p),m=e=>{for(const t in s)e.directive(t,s[t])
for(const t in i)e.component(t,i[t])
for(const t in r)e.component(t,mt({...r[t],name:t,aliasName:r[t].name}))
if(d.install(e),e.provide(ut,u),e.provide(gr,c),e.provide(ea,d),e.provide(Pl,v),e.provide(Kt,p),e.provide(vu,f.options),e.provide(pu,f.instance),o&&n.ssr)if(e.$nuxt)e.$nuxt.hook("app:suspense:resolve",(()=>{c.update()}))
else{const{mount:a}=e
e.mount=function(){const l=a(...arguments)
return t.nextTick((()=>c.update())),e.mount=a,l}}Nt.reset(),("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&e.mixin({computed:{$vuetify(){return t.reactive({defaults:vp.call(this,ut),display:vp.call(this,gr),theme:vp.call(this,ea),icons:vp.call(this,Pl),locale:vp.call(this,Kt),date:vp.call(this,pu)})}}})}
...
if(a&&e in a)return a[e]}dp.version="3.4.11"
const pp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return dp({components:lp,directives:cp,...e})},fp="3.4.11"
pp.version=fp,e.components=lp,e.createVuetify=pp,e.directives=cp,e.useDate=gu,e.useDefaults=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},t=arguments.length>1?arguments[1]:void 0
const{props:a,provideSubDefaults:l}=ft(e,t)
return l(),a},e.useDisplay=kr,e.useLayout=$t,e.useLocale=Zt,e.useRtl=Qt,e.useTheme=oa,e.version=fp}))
