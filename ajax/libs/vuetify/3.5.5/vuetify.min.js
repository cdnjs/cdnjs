...
void 0!==l&&(f.value=[l])}function A(t){const a=f.value.findIndex((a=>e.valueComparator(a.value,t.value))),l=-1===a
if(e.multiple)if(l)f.value=[...f.value,t]
else{const e=[...f.value]
e.splice(a,1),f.value=e}else f.value=l?[t]:[],c.value=!1}function R(e){N.value?.$el.contains(e.relatedTarget)||(c.value=!1)}function E(){y.value&&r.value?.focus()}function D(e){y.value=!0}function F(e){if(null==e)f.value=[]
...
function G(a){if(a.props.disabled)return
const l=k.value.findIndex((t=>e.valueComparator(t.value,a.value))),o=-1===l
if(e.multiple){if(o)k.value=[...k.value,a]
else{const e=[...k.value]
e.splice(l,1),k.value=e}e.clearOnSelect&&(S.value="")}else k.value=o?[a]:[],U.value=!0,S.value=o?a.title:"",p.value=!1,s.value=!0,t.nextTick((()=>U.value=!1))}return t.watch(i,((a,l)=>{a!==l&&(a?(U.value=!0,S.value=e.multiple?"":String(k.value.at(-1)?.props.title??""),s.value=!0,t.nextTick((()=>U.value=!1))):(e.multiple||null!=S.value?!B.value||u.value||k.value.some((e=>{let{value:t}=e
...
return l.item?.({item:o,index:n,props:i})??t.createVNode(Hn,i,{prepend:a=>{let{isSelected:l}=a
...
return"number"==typeof a&&~a?t.createVNode(t.Fragment,null,[t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(0,a)]),t.createVNode("span",{class:"v-autocomplete__mask"},[e.substr(a,l)]),t.createVNode("span",{class:"v-autocomplete__unmask"},[e.substr(a+l)])]):e}(o.title,_(o)?.title,S.value?.length??0)})}}),l["append-item"]?.()]})]}),k.value.map(((o,n)=>{const r={"onClick:close":function(e){e.stopPropagation(),e.preventDefault(),G(o)},onMousedown(e){e.preventDefault(),e.stopPropagation()},modelValue:!0,"onUpdate:modelValue":void 0},i=a?!!l.chip:!!l.selection,s=i?oe(a?l.chip({item:o,index:n,props:r}):l.selection({item:o,index:n})):void 0
...
return n.item?.({item:l,index:o,props:i})??t.createVNode(Hn,i,{prepend:a=>{let{isSelected:o}=a
...
return new Promise((e=>requestAnimationFrame((function t(a){const l=(a-v)/n.duration,r=Math.floor(d+(c-d)*u(Math.max(l,1)))
...
return At((()=>t.withDirectives(t.createVNode("button",{class:["v-expansion-panel-title",{"v-expansion-panel-title--active":o.isSelected.value,"v-expansion-panel-title--static":e.static},n.value,e.class],style:[r.value,e.style],type:"button",tabindex:o.disabled.value?-1:void 0,disabled:o.disabled.value,"aria-expanded":o.isSelected.value,onClick:e.readonly?void 0:o.toggle},[t.createVNode("span",{class:"v-expansion-panel-title__overlay"},null),l.default?.(i.value),!e.hideActions&&t.createVNode("span",{class:"v-expansion-panel-title__icon"},[l.actions?l.actions(i.value):t.createVNode(Ol,{icon:o.isSelected.value?e.collapseIcon:e.expandIcon},null)])]),[[t.resolveDirective("ripple"),e.ripple]]))),{}}}),Vd=a({title:String,text:String,bgColor:String,...l(),...el(),...bl(),...Pr(),...Wa(),...ua(),...yd()},"VExpansionPanel"),wd=gt()({name:"VExpansionPanel",props:Vd(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
if(a&&e in a)return a[e]}mp.version="3.5.5"
const hp=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
return mp({components:ip,directives:fp,...e})},yp="3.5.5"
