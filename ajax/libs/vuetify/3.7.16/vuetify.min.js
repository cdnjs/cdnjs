...
return e.multiple?a:a[0]??null})),N=t.computed((()=>"function"==typeof e.counterValue?e.counterValue(x.value):"number"==typeof e.counterValue?e.counterValue:x.value.length)),C=un(e),{filteredItems:_,getMatches:I}=$i(e,y,(()=>s.value?"":k.value)),B=t.computed((()=>e.hideSelected?_.value.filter((e=>!x.value.some((t=>t.value===e.value)))):_.value)),A=t.computed((()=>!(!e.chips&&!o.chip))),R=t.computed((()=>A.value||!!o.selection)),T=t.computed((()=>x.value.map((e=>e.props.value)))),D=t.computed((()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&k.value===B.value[0]?.title)&&B.value.length>0&&!s.value&&!u.value)),E=t.computed((()=>e.hideNoData&&!B.value.length||C.isReadonly.value||C.isDisabled.value)),F=t.ref(),$=Ai(F,r)
...
return $t((()=>t.createVNode("li",{"aria-hidden":"true",class:["v-breadcrumbs-divider",e.class],style:e.style},[l?.default?.()??e.divider]))),{}}}),ts=gt({active:Boolean,activeClass:String,activeColor:String,color:String,disabled:Boolean,title:String,...ht(),...fo(),...Ba({tag:"li"})},"VBreadcrumbsItem"),as=It()({name:"VBreadcrumbsItem",props:ts(),setup(e,a){let{slots:l,attrs:o}=a
...
return $t((()=>t.createVNode(e.tag,{class:["v-card-subtitle",e.class],style:[{"--v-card-subtitle-opacity":e.opacity},e.style]},l))),{}}}),ss=Bt("v-card-title"),us=gt({appendAvatar:String,appendIcon:Mt,prependAvatar:String,prependIcon:Mt,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...ht(),...Pl()},"VCardItem"),cs=It()({name:"VCardItem",props:us(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:["v-card-item",e.class],style:e.style},[o&&t.createVNode("div",{key:"prepend",class:"v-card-item__prepend"},[l.prepend?t.createVNode(al,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},l.prepend):t.createVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Wo,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Xl,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(ss,{key:"title"},{default:()=>[l.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(is,{key:"subtitle"},{default:()=>[l.subtitle?.()??t.toDisplayString(e.subtitle)]}),l.default?.()]),r&&t.createVNode("div",{key:"append",class:"v-card-item__append"},[l.append?t.createVNode(al,{key:"append-defaults",disabled:!n,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},l.append):t.createVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Xl,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Wo,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])})),{}}}),ds=gt({opacity:[Number,String],...ht(),...Ba()},"VCardText"),vs=It()({name:"VCardText",props:ds(),setup(e,a){let{slots:l}=a
return $t((()=>t.createVNode(e.tag,{class:["v-card-text",e.class],style:[{"--v-card-text-opacity":e.opacity},e.style]},l))),{}}}),ps=gt({appendAvatar:String,appendIcon:Mt,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:Mt,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...yl(),...ht(),...Pl(),...ll(),...Vl(),...no(),...to(),...uo(),...cl(),...fo(),...Ba(),...wa(),...Dl({variant:"elevated"})},"VCard"),fs=It()({name:"VCard",directives:{Ripple:To},props:ps(),setup(e,a){let{attrs:l,slots:o}=a
...
let i=-1
function s(){e.cycle&&r.value&&(i=window.setTimeout(r.value.group.next,Number(e.interval)>0?Number(e.interval):6e3))}function u(){window.clearTimeout(i),window.requestAnimationFrame(s)}return t.watch(o,u),t.watch((()=>e.interval),u),t.watch((()=>e.cycle),(e=>{e?u():window.clearTimeout(i)})),t.onMounted(s),$t((()=>{const a=ws.filterProps(e)
...
B.value=i(e),B.value&&(C.value=!0,B.value.contains(e.target)?_.value=Ms(e,B.value,a.direction):(_.value=0,null!=l&&n({value:l})),null!=l&&o({value:l}),t.nextTick((()=>B.value?.focus())))},D={passive:!0,capture:!0}
...
return()=>t.h(e.tag,{class:["v-row",o.value,e.class],style:e.style},l.default?.())}}),fd=Bt("v-spacer","div","VSpacer"),md=gt({active:{type:[String,Array],default:void 0},disabled:{type:[Boolean,String,Array],default:null},nextIcon:{type:Mt,default:"$next"},prevIcon:{type:Mt,default:"$prev"},modeIcon:{type:Mt,default:"$subgroup"},text:String,viewMode:{type:String,default:"month"}},"VDatePickerControls"),gd=It()({name:"VDatePickerControls",props:md(),emits:{"click:year":()=>!0,"click:month":()=>!0,"click:prev":()=>!0,"click:next":()=>!0,"click:text":()=>!0},setup(e,a){let{emit:l}=a
...
e.splice(t,1),i.value=e}}(t):i.value=[t]}t.watch(r,((e,t)=>{t&&(v.value=u.isBefore(e[0].date,t[0].date))})),$t((()=>t.createVNode("div",{class:"v-date-picker-month"},[e.showWeek&&t.createVNode("div",{key:"weeks",class:"v-date-picker-month__weeks"},[!e.hideWeekdays&&t.createVNode("div",{key:"hide-week-days",class:"v-date-picker-month__day"},[t.createTextVNode(" ")]),s.value.map((e=>t.createVNode("div",{class:["v-date-picker-month__day","v-date-picker-month__day--adjacent"]},[e])))]),t.createVNode(pl,{name:p.value},{default:()=>[t.createVNode("div",{ref:n,key:r.value[0].date?.toString(),class:"v-date-picker-month__days"},[!e.hideWeekdays&&u.getWeekdays(e.firstDayOfWeek).map((e=>t.createVNode("div",{class:["v-date-picker-month__day","v-date-picker-month__weekday"]},[e]))),r.value.map(((a,l)=>{const n={props:{class:"v-date-picker-month__day-btn",color:!a.isSelected&&!a.isToday||a.isDisabled?void 0:e.color,disabled:a.isDisabled,icon:!0,ripple:!1,text:a.localized,variant:a.isDisabled?a.isToday?"outlined":"text":a.isToday&&!a.isSelected?"outlined":"flat",onClick:()=>m(a.date)},item:a,i:l}
...
i!==v.value&&(v.value=i,N(v.value)),s!==p.value&&(p.value=s,C(p.value)),f.value=n.isBefore(o,r)})),$t((()=>{const a=Bd.filterProps(e),l=gd.filterProps(e),n=yd.filterProps(e),d=Sd.filterProps(e),f=x(xd.filterProps(e),["modelValue"]),_=x(Cd.filterProps(e),["modelValue"]),I={header:m.value,transition:h.value}
return t.createVNode(Bd,t.mergeProps(a,{class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},e.class],style:e.style}),{title:()=>o.title?.()??t.createVNode("div",{class:"v-date-picker__title"},[r(e.title)]),header:()=>o.header?t.createVNode(al,{defaults:{VDatePickerHeader:{...I}}},{default:()=>[o.header?.(I)]}):t.createVNode(yd,t.mergeProps({key:"header"},n,I,{onClick:"month"!==s.value?w:void 0}),{...o,default:void 0}),default:()=>t.createVNode(t.Fragment,null,[t.createVNode(gd,t.mergeProps(l,{disabled:y.value,text:g.value,"onClick:next":b,"onClick:prev":V,"onClick:month":S,"onClick:year":k}),null),t.createVNode(Ha,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(xd,t.mergeProps({key:"date-picker-months"},f,{modelValue:v.value,"onUpdate:modelValue":[e=>v.value=e,N],min:u.value,max:c.value,year:p.value}),null):"year"===s.value?t.createVNode(Cd,t.mergeProps({key:"date-picker-years"},_,{modelValue:p.value,"onUpdate:modelValue":[e=>p.value=e,C],min:u.value,max:c.value}),null):t.createVNode(Sd,t.mergeProps({key:"date-picker-month"},d,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:v.value,"onUpdate:month":[e=>v.value=e,N],year:p.value,"onUpdate:year":[e=>p.value=e,C],min:u.value,max:c.value}),null)]})]),actions:o.actions})})),{}}}),Rd=gt({actionText:String,bgColor:String,color:String,icon:Mt,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...ht(),...ll(),...Gl({size:void 0}),...wa()},"VEmptyState"),Td=It()({name:"VEmptyState",props:Rd(),emits:{"click:action":e=>!0},setup(e,a){let{emit:l,slots:o}=a
...
return()=>a.default?.({isHovering:l.value,props:{onMouseenter:o,onMouseleave:n}})}}),ev=gt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...ll(),...Ba()},"VInfiniteScroll"),tv=_t({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,a){let{emit:l}=a
...
return()=>a.default?.({isSelected:l.value,selectedClass:r.value,select:o,toggle:n,value:i.value,disabled:s.value})}}),iv=Bt("v-kbd","kbd"),sv=gt({...ht(),...ll(),...ta()},"VLayout"),uv=It()({name:"VLayout",props:sv(),setup(e,a){let{slots:l}=a
...
return t.createVNode("div",{class:"v-stepper-actions"},[t.createVNode(al,{defaults:{VBtn:{disabled:["prev",!0].includes(e.disabled),text:n(e.prevText),variant:"text"}}},{default:()=>[o.prev?.({props:a})??t.createVNode(Eo,a,null)]}),t.createVNode(al,{defaults:{VBtn:{color:e.color,disabled:["next",!0].includes(e.disabled),text:n(e.nextText),variant:"tonal"}}},{default:()=>[o.next?.({props:l})??t.createVNode(Eo,l,null)]})])})),{}}}),vp=Bt("v-stepper-header"),pp=gt({color:String,title:String,subtitle:String,complete:Boolean,completeIcon:{type:Mt,default:"$complete"},editable:Boolean,editIcon:{type:Mt,default:"$edit"},error:Boolean,errorIcon:{type:Mt,default:"$error"},icon:Mt,ripple:{type:[Boolean,Object],default:!0},rules:{type:Array,default:()=>[]}},"StepperItem"),fp=gt({...pp(),...Ol()},"VStepperItem"),mp=It()({name:"VStepperItem",directives:{Ripple:To},props:fp(),emits:{"group:selected":e=>!0},setup(e,a){let{slots:l}=a
...
return t.createVNode(Eo,t.mergeProps({symbol:_p,ref:i,class:["v-tab",e.class],style:e.style,tabindex:c.value?0:-1,role:"tab","aria-selected":String(c.value),active:!1},a,o,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":d}),{...l,default:()=>t.createVNode(t.Fragment,null,[l.default?.()??e.text,!e.hideSlider&&t.createVNode("div",{ref:s,class:["v-tab__slider",n.value],style:r.value},null)])})})),di({},i)}}),Pp=gt({...x(Vs(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Ap=It()({name:"VTabsWindow",props:Pp(),emits:{"update:modelValue":e=>!0},setup(e,a){let{slots:l}=a
...
return t.watchEffect((()=>{e.autoGrow||(N.value=Number(e.rows))})),t.onMounted(_),t.watch(r,_),t.watch((()=>e.rows),_),t.watch((()=>e.maxRows),_),t.watch((()=>e.density),_),t.watch(x,(e=>{e?(I=new ResizeObserver(_),I.observe(x.value)):I?.disconnect()})),t.onBeforeUnmount((()=>{I?.disconnect()})),$t((()=>{const a=!!(n.counter||e.counter||e.counterValue),o=!(!a&&!n.details),[s,f]=B(l),{modelValue:_,...I}=pn.filterProps(e),P=wi(e)
...
if(a&&e in a)return a[e]}rf.version="3.7.16"
const uf=function(){return rf({components:Zp,directives:nf,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},cf="3.7.16"
