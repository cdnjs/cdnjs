...
function maybeTransition(props, data, vNodes) {
  ...
  return (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.h)(external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.Transition, (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.mergeProps)({
...
;// CONCATENATED MODULE: ./src/composables/border-radius.ts
// Utilities

 // Types

const makeBorderRadiusProps = propsFactory({
  rounded: [Boolean, Number, String]
}); // Composables

function useBorderRadius(props) {
  const borderRadiusClasses = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => {
    const classes = [];
...
function useSheet(props, name) {
  ...
  const {
    positionClasses,
    positionStyles
  } = usePosition(props, name);
  return {
    sheetClasses: (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => [themeClasses.value, borderClasses.value, borderRadiusClasses.value, elevationClasses.value, positionClasses.value]),
    sheetStyles: (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.computed)(() => [dimensionStyles.value, positionStyles.value])
  };
}
/* harmony default export */ var VSheet_VSheet = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  name: 'VSheet',
...
const VRow_breakpoints = ['sm', 'md', 'lg', 'xl']; // no xs
...
/* harmony default export */ var VImg = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  ...
  setup(props, {
    ...
    const naturalHeight = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.ref)(); // TODO: use expose() https://github.com/vuejs/vue-test-utils-next/issues/435

    const vm = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.getCurrentInstance)();
    vm.setupState = (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.reactive)({
      currentSrc,
      image,
      state,
      naturalWidth,
    ...
    return () => (0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.withDirectives)((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.createVNode)(VResponsive, {
      "class": "v-img",
...
/* harmony default export */ var VMain_VMain = ((0,external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_.defineComponent)({
  name: 'VMain',
...
/* harmony default export */ var components_VMain = ((/* unused pure expression or super */ null && (VMain)));
;// CONCATENATED MODULE: ./src/components/VSheet/index.ts


/* harmony default export */ var components_VSheet = ((/* unused pure expression or super */ null && (VSheet)));
