...
const CheckboxRoot = (0, _styled.default)(_SwitchBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styleProps.indeterminate && styles.indeterminate, styleProps.color !== 'default' && styles[`color${(0, _capitalize.default)(styleProps.color)}`]);
  }
})(({
  theme,
  styleProps
