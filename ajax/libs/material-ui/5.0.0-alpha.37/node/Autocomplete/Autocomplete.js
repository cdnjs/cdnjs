...
const AutocompleteRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({
      [`& .${_autocompleteClasses.default.tag}`]: (0, _extends2.default)({}, styles.tag, styles[`tagSize${(0, _capitalize.default)(size)}`]),
      [`& .${_autocompleteClasses.default.inputRoot}`]: styles.inputRoot,
      [`& .${_autocompleteClasses.default.input}`]: (0, _extends2.default)({}, styles.input, inputFocused && styles.inputFocused)
