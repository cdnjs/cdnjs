...
const DialogContainer = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.container, styles[`scroll${(0, _capitalize.default)(styleProps.scroll)}`]);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
...
const DialogPaper = (0, _styled.default)(_Paper.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.paper, styles[`scrollPaper${(0, _capitalize.default)(styleProps.scroll)}`], styles[`paperWidth${(0, _capitalize.default)(String(styleProps.maxWidth))})`], styleProps.fullWidth && styles.paperFullWidth, styleProps.fullScreen && styles.paperFullScreen);
  }
})(({
  theme,
  styleProps
