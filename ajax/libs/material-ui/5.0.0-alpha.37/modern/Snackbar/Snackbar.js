...
const SnackbarRoot = styled('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return _extends({}, styles.root, styles[`anchorOrigin${capitalize(styleProps.anchorOrigin.vertical)}${capitalize(styleProps.anchorOrigin.horizontal)}`]);
  }
})(({
  theme,
  styleProps
  ...
  return _extends({
    ...
    [theme.breakpoints.up('sm')]: _extends({}, styleProps.anchorOrigin.vertical === 'top' ? {
      top: 24
    } : {
      bottom: 24
