...
var IconButtonRoot = styled(ButtonBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))], styleProps.edge && styles["edge".concat(capitalize(styleProps.edge))], styles["size".concat(capitalize(styleProps.size))]);
  }
})(function (_ref) {
...
var IconButtonLabel = styled('span', {
  name: 'MuiIconButton',
  slot: 'Label',
  overridesResolver: function overridesResolver(props, styles) {
    return styles.label;
