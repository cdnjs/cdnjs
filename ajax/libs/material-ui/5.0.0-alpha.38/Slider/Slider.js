...
export const SliderRoot = styled('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return _extends({}, styles.root, styles[`color${capitalize(styleProps.color)}`], styleProps.size !== 'medium' && styles[`size${capitalize(styleProps.size)}`], marked && styles.marked, styleProps.orientation === 'vertical' && styles.vertical, styleProps.track === 'inverted' && styles.trackInverted, styleProps.track === false && styles.trackFalse);
  }
})(({
  theme,
  styleProps
...
export const SliderThumb = styled('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return _extends({}, styles.thumb, styles[`thumbColor${capitalize(styleProps.color)}`], styleProps.size !== 'medium' && styles[`thumbSize${capitalize(styleProps.size)}`]);
  }
})(({
  theme,
  styleProps
