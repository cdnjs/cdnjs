...
export var SliderRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styles["color".concat(capitalize(styleProps.color))], styleProps.size !== 'medium' && styles["size".concat(capitalize(styleProps.size))], marked && styles.marked, styleProps.orientation === 'vertical' && styles.vertical, styleProps.track === 'inverted' && styles.trackInverted, styleProps.track === false && styles.trackFalse);
  }
})(function (_ref) {
  var _extends2;
...
export var SliderThumb = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.thumb, styles["thumbColor".concat(capitalize(styleProps.color))], styleProps.size !== 'medium' && styles["thumbSize".concat(capitalize(styleProps.size))]);
  }
})(function (_ref4) {
  var _extends3;
