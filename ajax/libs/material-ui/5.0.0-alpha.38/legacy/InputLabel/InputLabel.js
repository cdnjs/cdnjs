...
var InputLabelRoot = styled(FormLabel, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends(_defineProperty({}, "& .".concat(formLabelClasses.asterisk), styles.asterisk), styles.root, !styleProps.formControl && styles.formControl, styleProps.size === 'small' && styles.sizeSmall, styleProps.shrink && styles.shrink, !styleProps.disableAnimation && styles.animated, styles[styleProps.variant]);
  }
})(function (_ref) {
