...
var DrawerPaper = styled(Paper, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.paper, styles["paperAnchor".concat(capitalize(styleProps.anchor))], styleProps.variant !== 'temporary' && styles["paperAnchorDocked".concat(capitalize(styleProps.anchor))]);
  }
})(function (_ref2) {
