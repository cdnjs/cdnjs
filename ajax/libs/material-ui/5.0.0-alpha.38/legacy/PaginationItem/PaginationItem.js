...
var rootOverridesResolver = function rootOverridesResolver(props, styles) {
  ...
  return _extends({}, styles.root, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.variant === 'text' && styles["text".concat(capitalize(styleProps.color))], styleProps.variant === 'outlined' && styles["outlined".concat(capitalize(styleProps.color))], styleProps.shape === 'rounded' && styles.rounded, styleProps.type === 'page' && styles.page, (styleProps.type === 'start-ellipsis' || styleProps.type === 'end-ellipsis') && styles.ellipsis, (styleProps.type === 'previous' || styleProps.type === 'next') && styles.previousNext, (styleProps.type === 'first' || styleProps.type === 'last') && styles.firstLast);
};
