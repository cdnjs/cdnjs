...
const LinearProgressRoot = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`color${(0, _capitalize.default)(styleProps.color)}`], styles[styleProps.variant]);
  }
})(({
  styleProps,
  theme
...
const LinearProgressDashed = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.dashed, styles[`dashedColor${(0, _capitalize.default)(styleProps.color)}`]);
  }
})(({
  styleProps,
  theme
...
const LinearProgressBar1 = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.bar, styles[`barColor${(0, _capitalize.default)(styleProps.color)}`], (styleProps.variant === 'indeterminate' || styleProps.variant === 'query') && styles.bar1Indeterminate, styleProps.variant === 'determinate' && styles.bar1Determinate, styleProps.variant === 'buffer' && styles.bar1Buffer);
  }
})(({
  styleProps,
  theme
...
const LinearProgressBar2 = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.bar, styles[`barColor${(0, _capitalize.default)(styleProps.color)}`], (styleProps.variant === 'indeterminate' || styleProps.variant === 'query') && styles.bar2Indeterminate, styleProps.variant === 'buffer' && styles.bar2Buffer);
  }
})(({
  styleProps,
  theme
