...
const SliderRoot = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`color${(0, _capitalize.default)(styleProps.color)}`], styleProps.size !== 'medium' && styles[`size${(0, _capitalize.default)(styleProps.size)}`], marked && styles.marked, styleProps.orientation === 'vertical' && styles.vertical, styleProps.track === 'inverted' && styles.trackInverted, styleProps.track === false && styles.trackFalse);
  }
})(({
  theme,
  styleProps
...
const SliderThumb = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.thumb, styles[`thumbColor${(0, _capitalize.default)(styleProps.color)}`], styleProps.size !== 'medium' && styles[`thumbSize${(0, _capitalize.default)(styleProps.size)}`]);
  }
})(({
  theme,
  styleProps
