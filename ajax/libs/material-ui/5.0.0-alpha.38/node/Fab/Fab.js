...
const FabRoot = (0, _styled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[styleProps.variant], styles[`size${(0, _capitalize.default)(styleProps.size)}`], styleProps.color === 'inherit' && styles.colorInherit, styleProps.color === 'primary' && styles.primary, styleProps.color === 'secondary' && styles.secondary);
  }
})(({
  theme,
  styleProps
...
const FabLabel = (0, _styled.default)('span', {
  name: 'MuiFab',
  slot: 'Label',
