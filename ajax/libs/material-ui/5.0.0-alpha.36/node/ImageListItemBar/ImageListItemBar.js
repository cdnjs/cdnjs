...
const ImageListItemBarTitleWrap = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.titleWrap, styles[`titleWrap${(0, _capitalize.default)(styleProps.position)}`], styleProps.actionIcon && styles[`titleWrapActionPos${(0, _capitalize.default)(styleProps.actionPosition)}`]);
  }
})(({
  theme,
  styleProps
...
const ImageListItemBarActionIcon = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.actionIcon, styles[`actionIconActionPos${(0, _capitalize.default)(styleProps.actionPosition)}`]);
  }
})(({
  styleProps
}) => {
...
const ImageListItemBar = /*#__PURE__*/React.forwardRef(function ImageListItemBar(inProps, ref) {
  ...
  const {
    ...
    position = 'bottom'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["actionIcon", "actionPosition", "className", "subtitle", "title", "position"]);
