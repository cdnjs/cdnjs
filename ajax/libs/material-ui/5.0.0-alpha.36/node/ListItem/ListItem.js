...
const overridesResolver = (props, styles) => {
  ...
  return (0, _extends2.default)({}, styles.root, styleProps.dense && styles.dense, styleProps.alignItems === 'flex-start' && styles.alignItemsFlexStart, styleProps.divider && styles.divider, !styleProps.disableGutters && styles.gutters, !styleProps.disablePadding && styles.padding, styleProps.button && styles.button, styleProps.hasSecondaryAction && styles.secondaryAction);
};
...
const ListItem = /*#__PURE__*/React.forwardRef(function ListItem(inProps, ref) {
  ...
  const {
    ...
    selected = false
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["alignItems", "autoFocus", "button", "children", "className", "component", "components", "componentsProps", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "disablePadding", "divider", "focusVisibleClassName", "secondaryAction", "selected"]);
