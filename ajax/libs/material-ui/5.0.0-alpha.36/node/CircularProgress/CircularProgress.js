...
const CircularProgressRoot = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[styleProps.variant], styles[`color${(0, _capitalize.default)(styleProps.color)}`]);
  }
})(({
  styleProps,
  theme
...
const CircularProgressCircle = (0, _styled.default)('circle', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.circle, styles[`circle${(0, _capitalize.default)(styleProps.variant)}`], styleProps.disableShrink && styles.circleDisableShrink);
  }
})(({
  styleProps,
  theme
