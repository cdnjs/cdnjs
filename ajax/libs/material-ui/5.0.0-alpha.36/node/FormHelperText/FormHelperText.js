...
const FormHelperTextRoot = (0, _styled.default)('p', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styleProps.size && styles[`size${(0, _capitalize.default)(styleProps.size)}`], styleProps.contained && styles.contained, styleProps.filled && styles.filled);
  }
})(({
  theme,
  styleProps
