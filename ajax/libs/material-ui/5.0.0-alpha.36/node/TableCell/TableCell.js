...
const TableCellRoot = (0, _styled.default)('td', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[styleProps.variant], styles[`size${(0, _capitalize.default)(styleProps.size)}`], styleProps.padding !== 'normal' && styles[`padding${(0, _capitalize.default)(styleProps.padding)}`], styleProps.align !== 'inherit' && styles[`align${(0, _capitalize.default)(styleProps.align)}`], styleProps.stickyHeader && styles.stickyHeader);
  }
})(({
  theme,
  styleProps
