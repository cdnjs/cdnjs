...
const CheckboxRoot = (0, _styled.default)(_SwitchBase.default, {
  ...
  '&:hover': {
    backgroundColor: (0, _colorManipulator.alpha)(styleProps.color === 'default' ? theme.palette.action.active : theme.palette[styleProps.color].main, theme.palette.action.hoverOpacity),
