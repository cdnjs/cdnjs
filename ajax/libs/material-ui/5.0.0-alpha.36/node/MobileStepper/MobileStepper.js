...
const MobileStepperRoot = (0, _styled.default)(_Paper.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`position${(0, _capitalize.default)(styleProps.position)}`]);
  }
})(({
  theme,
  styleProps
...
const MobileStepperDot = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.dot, styleProps.dotActive && styles.dotActive);
  }
})(({
  theme,
  styleProps
...
const MobileStepper = /*#__PURE__*/React.forwardRef(function MobileStepper(inProps, ref) {
  ...
  const {
    ...
    variant = 'dots'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["activeStep", "backButton", "className", "LinearProgressProps", "nextButton", "position", "steps", "variant"]);
