...
const TooltipPopper = (0, _styled.default)(_Popper.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.popper, !styleProps.disableInteractive && styles.popperInteractive, styleProps.arrow && styles.popperArrow, !styleProps.open && styles.popperClose);
  }
})(({
  theme,
  styleProps,
...
const TooltipTooltip = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.tooltip, styleProps.touch && styles.touch, styleProps.arrow && styles.tooltipArrow, styles[`tooltipPlacement${(0, _capitalize.default)(styleProps.placement.split('-')[0])}`]);
  }
})(({
  theme,
  styleProps
...
const Tooltip = /*#__PURE__*/React.forwardRef(function Tooltip(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["arrow", "children", "classes", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "title", "TransitionComponent", "TransitionProps"]);
