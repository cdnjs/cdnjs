...
const SpeedDialRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`direction${(0, _capitalize.default)(styleProps.direction)}`]);
  }
})(({
  theme,
  styleProps
...
const SpeedDialActions = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.actions, !styleProps.open && styles.actionsClosed);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
