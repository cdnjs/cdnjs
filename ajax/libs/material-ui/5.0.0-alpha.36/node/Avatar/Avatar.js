...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)(slots, _avatarClasses.getAvatarUtilityClass, classes);
};
...
const AvatarRoot = (0, _styled.default)('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[styleProps.variant], styleProps.colorDefault && styles.colorDefault);
  }
})(({
  theme,
  styleProps
