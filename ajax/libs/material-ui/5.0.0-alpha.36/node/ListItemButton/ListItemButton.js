...
const overridesResolver = (props, styles) => {
  ...
  return (0, _extends2.default)({}, styles.root, styleProps.dense && styles.dense, styleProps.alignItems === 'flex-start' && styles.alignItemsFlexStart, styleProps.divider && styles.divider, !styleProps.disableGutters && styles.gutters);
};
...
const ListItemButton = /*#__PURE__*/React.forwardRef(function ListItemButton(inProps, ref) {
  ...
  const {
    ...
    selected = false
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["alignItems", "autoFocus", "component", "children", "dense", "disableGutters", "divider", "focusVisibleClassName", "selected"]);
