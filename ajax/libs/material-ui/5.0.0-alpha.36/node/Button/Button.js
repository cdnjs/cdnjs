...
const ButtonLabel = (0, _styled.default)('span', {
  name: 'MuiButton',
  slot: 'Label',
...
const ButtonStartIcon = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.startIcon, styles[`iconSize${(0, _capitalize.default)(styleProps.size)}`]);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
...
const ButtonEndIcon = (0, _styled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.endIcon, styles[`iconSize${(0, _capitalize.default)(styleProps.size)}`]);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
