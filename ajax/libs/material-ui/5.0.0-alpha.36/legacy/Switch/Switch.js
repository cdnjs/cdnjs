...
var SwitchRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styleProps.edge && styles["edge".concat(capitalize(styleProps.edge))], styles["size".concat(capitalize(styleProps.size))]);
  }
})(function (_ref) {
  var _ref2;
...
var SwitchSwitchBase = styled(SwitchBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.switchBase, styles.input, styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))]);
  }
})(function (_ref3) {
  var _ref4;
