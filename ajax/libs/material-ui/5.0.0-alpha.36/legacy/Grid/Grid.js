...
function generateRowGap(_ref) {
  ...
  if (container && rowSpacing !== 0) {
    var themeSpacing = theme.spacing(rowSpacing);
...
function generateColumnGap(_ref2) {
  ...
  if (container && columnSpacing !== 0) {
    var themeSpacing = theme.spacing(columnSpacing);
...
}, generateRowGap, generateColumnGap, function (_ref6) {
