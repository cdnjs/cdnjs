...
var LinearProgressRoot = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styles["color".concat(capitalize(styleProps.color))], styles[styleProps.variant]);
  }
})(function (_ref) {
...
var LinearProgressDashed = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.dashed, styles["dashedColor".concat(capitalize(styleProps.color))]);
  }
})(function (_ref2) {
...
var LinearProgressBar1 = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.bar, styles["barColor".concat(capitalize(styleProps.color))], (styleProps.variant === 'indeterminate' || styleProps.variant === 'query') && styles.bar1Indeterminate, styleProps.variant === 'determinate' && styles.bar1Determinate, styleProps.variant === 'buffer' && styles.bar1Buffer);
  }
})(function (_ref3) {
...
var LinearProgressBar2 = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.bar, styles["barColor".concat(capitalize(styleProps.color))], (styleProps.variant === 'indeterminate' || styleProps.variant === 'query') && styles.bar2Indeterminate, styleProps.variant === 'buffer' && styles.bar2Buffer);
  }
})(function (_ref5) {
