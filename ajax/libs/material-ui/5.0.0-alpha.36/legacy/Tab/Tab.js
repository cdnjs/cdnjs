...
var TabRoot = styled(ButtonBase, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styleProps.label && styleProps.icon && styles.labelIcon, styles["textColor".concat(capitalize(styleProps.textColor))], styleProps.fullWidth && styles.fullWidth, styleProps.wrapped && styles.wrapped);
  }
})(function (_ref) {
