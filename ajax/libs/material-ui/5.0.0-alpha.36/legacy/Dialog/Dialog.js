...
var DialogContainer = styled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.container, styles["scroll".concat(capitalize(styleProps.scroll))]);
  }
})(function (_ref) {
...
var DialogPaper = styled(Paper, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.paper, styles["scrollPaper".concat(capitalize(styleProps.scroll))], styles["paperWidth".concat(capitalize(String(styleProps.maxWidth)), ")")], styleProps.fullWidth && styles.paperFullWidth, styleProps.fullScreen && styles.paperFullScreen);
  }
})(function (_ref2) {
