...
const ImageListItemRoot = (0, _experimentalStyled.default)('li', {}, {
...
const ImageListItem = /*#__PURE__*/React.forwardRef(function ImageListItem(inProps, ref) {
  ...
  const {
    ...
    style
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "cols", "component", "rows", "style"]);
  const {
    rowHeight = 'auto',
    gap,
    variant
  ...
  return /*#__PURE__*/React.createElement(ImageListItemRoot, (0, _extends2.default)({
    as: component,
