...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    ...
    switchBase: ['switchBase', `color${(0, _capitalize.default)(color)}`, checked && 'checked', disabled && 'disabled', 'input'],
    thumb: ['thumb'],
    track: ['track']
  };
...
const Switch = /*#__PURE__*/React.forwardRef(function Switch(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(SwitchRoot, {
    ...
    styleProps: styleProps
  }, /*#__PURE__*/React.createElement(SwitchSwitchBase, (0, _extends2.default)({
