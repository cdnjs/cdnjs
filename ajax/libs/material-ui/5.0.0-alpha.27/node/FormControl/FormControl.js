...
const overridesResolver = ({
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`margin${(0, _capitalize.default)(styleProps.margin)}`], styleProps.fullWidth && styles.fullWidth), styles.root || {});
};
...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    root: ['root', `margin${(0, _capitalize.default)(margin)}`, fullWidth && 'fullWidth']
  };
  return (0, _unstyled.unstable_composeClasses)(slots, _formControlClasses.getFormControlUtilityClasses, classes);
};

const FormControlRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiFormControl',
  slot: 'Root',
  overridesResolver
})(({
...
const FormControl = /*#__PURE__*/React.forwardRef(function FormControl(inProps, ref) {
  ...
  const {
    ...
    variant = 'standard'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "color", "component", "disabled", "error", "focused", "fullWidth", "hiddenLabel", "margin", "required", "size", "variant"]);
  ...
  return /*#__PURE__*/React.createElement(_FormControlContext.default.Provider, {
    value: childContext
  }, /*#__PURE__*/React.createElement(FormControlRoot, (0, _extends2.default)({
    as: component,
