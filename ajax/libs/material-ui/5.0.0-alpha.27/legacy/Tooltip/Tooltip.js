...
var TooltipTooltip = experimentalStyled('div', {}, {
  ...
  }, styleProps.placement.split('-')[0] === 'left' && _defineProperty({
    transformOrigin: 'right center',
    marginRight: '24px'
  }, theme.breakpoints.up('sm'), {
    marginRight: '14px'
  }), styleProps.placement.split('-')[0] === 'right' && _defineProperty({
    transformOrigin: 'left center',
    marginLeft: '24px'
  }, theme.breakpoints.up('sm'), {
    marginLeft: '14px'
  }), styleProps.placement.split('-')[0] === 'top' && _defineProperty({
    transformOrigin: 'center bottom',
    marginBottom: '24px'
  }, theme.breakpoints.up('sm'), {
    marginBottom: '14px'
  }), styleProps.placement.split('-')[0] === 'bottom' && _defineProperty({
...
var Tooltip = /*#__PURE__*/React.forwardRef(function Tooltip(inProps, ref) {
  ...
  var _props$arrow = props.arrow,
      ...
      other = _objectWithoutProperties(props, ["arrow", "children", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "title", "TransitionComponent", "TransitionProps"]);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.cloneElement(children, childrenProps), /*#__PURE__*/React.createElement(TooltipPopper, _extends({
    ...
    var TransitionPropsInner = _ref9.TransitionProps;
