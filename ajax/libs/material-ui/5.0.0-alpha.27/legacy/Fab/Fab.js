...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.color === 'inherit' && styles.colorInherit, styleProps.color === 'primary' && styles.primary, styleProps.color === 'secondary' && styles.secondary, _defineProperty({}, "& .".concat(fabClasses.label), styles.label)), styles.root || {});
};
...
var FabRoot = experimentalStyled(ButtonBase, {}, {
  name: 'MuiFab',
  slot: 'Root',
...
var FabLabel = experimentalStyled('span', {}, {
  name: 'MuiFab',
  slot: 'Label'
})({
...
var Fab = /*#__PURE__*/React.forwardRef(function Fab(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(FabRoot, _extends({
    ...
    ref: ref
  }, other), /*#__PURE__*/React.createElement(FabLabel, {
