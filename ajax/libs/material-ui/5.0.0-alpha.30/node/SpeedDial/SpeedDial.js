...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`direction${(0, _capitalize.default)(styleProps.direction)}`], {
    [`& .${_speedDialClasses.default.fab}`]: styles.fab,
    [`& .${_speedDialClasses.default.actions}`]: (0, _extends2.default)({}, styles.actions, !styleProps.open && styles.actionsClosed)
  }), styles.root || {});
};
...
const SpeedDialRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiSpeedDial',
  slot: 'Root',
  overridesResolver
})(({
...
const SpeedDialFab = (0, _experimentalStyled.default)(_Fab.default, {}, {
  name: 'MuiSpeedDial',
  slot: 'Fab'
})(() => ({
  pointerEvents: 'auto'
}));
const SpeedDialActions = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiSpeedDial',
  slot: 'Actions'
})(({
  styleProps
...
const SpeedDial = /*#__PURE__*/React.forwardRef(function SpeedDial(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["ariaLabel", "FabProps", "children", "className", "direction", "hidden", "icon", "onBlur", "onClose", "onFocus", "onKeyDown", "onMouseEnter", "onMouseLeave", "onOpen", "open", "openIcon", "TransitionComponent", "transitionDuration", "TransitionProps"]);
  ...
  const children = allItems.map((child, index) => {
    const _child$props = child.props,
      ...
      tooltipPlacement: tooltipPlacementProp
          ...
          ChildFabProps = (0, _objectWithoutPropertiesLoose2.default)(_child$props.FabProps, ["ref"]);
