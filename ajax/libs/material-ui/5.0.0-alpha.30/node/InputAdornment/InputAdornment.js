...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    root: ['root', disablePointerEvents && 'disablePointerEvents', position && `position${(0, _capitalize.default)(position)}`, variant, 'hiddenLabel', 'sizeSmall']
  };
...
const InputAdornmentRoot = (0, _experimentalStyled.default)('div', {}, {
  ...
  [`&.${_inputAdornmentClasses.default.positionStart}&:not(.Mui-hiddenLabel)`]: {
    marginTop: 16
  }
