...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`position${(0, _capitalize.default)(styleProps.position)}`], {
    [`& .${_mobileStepperClasses.default.dots}`]: styles.dots,
    [`& .${_mobileStepperClasses.default.dot}`]: (0, _extends2.default)({}, styles.dot, styleProps.dotActive && styles.dotActive),
    [`& .${_mobileStepperClasses.default.dotActive}`]: styles.dotActive,
    [`& .${_mobileStepperClasses.default.progress}`]: styles.progress
  }), styles.root || {});
};
