...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles.select, styles[styleProps.variant], {
    [`& .${_selectClasses.default.icon}`]: (0, _extends2.default)({}, styles.icon, styleProps.variant && styles[`icon${(0, _capitalize.default)(styleProps.variant)}`], styleProps.open && styles.iconOpen)
  }), styles.root || {});
};
...
const useUtilityClasses = styleProps => {
  ...
  return (0, _unstyled.unstable_composeClasses)(slots, _selectClasses.getSelectUtilitiyClasses, classes);
};
/**
