...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styleProps.indeterminate && styles.indeterminate, styleProps.color !== 'default' && styles[`color${(0, _capitalize.default)(styleProps.color)}`]), styles.root || {});
};
