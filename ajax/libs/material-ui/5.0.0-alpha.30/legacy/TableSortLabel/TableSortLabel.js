...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styleProps.active && styles.active, _defineProperty({}, "& .".concat(tableSortLabelClasses.icon), _extends({}, styles.icon, styles["iconDirection".concat(capitalize(styleProps.direction))]))), styles.root || {});
};
