...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.variant === 'text' && styles["text".concat(capitalize(styleProps.color))], styleProps.variant === 'outlined' && styles["outlined".concat(capitalize(styleProps.color))], styleProps.shape === 'rounded' && styles.rounded, (_extends2 = {}, _defineProperty(_extends2, "&.".concat(paginationItemClasses.ellipsis), styles.ellipsis), _defineProperty(_extends2, "&.".concat(paginationItemClasses.previousLast), styles.previousLast), _defineProperty(_extends2, "&.".concat(paginationItemClasses.firstLast), styles.firstLast), _defineProperty(_extends2, "&.".concat(paginationItemClasses.page), styles.page), _defineProperty(_extends2, "& .".concat(paginationItemClasses.icon), styles.icon), _extends2)), styles.root || {});
};
