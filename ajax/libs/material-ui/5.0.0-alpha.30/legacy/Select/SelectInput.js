...
export var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles.select, styles[styleProps.variant], _defineProperty({}, "& .".concat(selectClasses.icon), _extends({}, styles.icon, styleProps.variant && styles["icon".concat(capitalize(styleProps.variant))], styleProps.open && styles.iconOpen))), styles.root || {});
};
