...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles["size".concat(capitalize(styleProps.size))], styleProps.readOnly && styles.readOnly, (_extends2 = {}, _defineProperty(_extends2, "& .".concat(ratingClasses.label), styles.label), _defineProperty(_extends2, "& .".concat(ratingClasses.icon), styles.icon), _defineProperty(_extends2, "& .".concat(ratingClasses.iconEmpty), styles.iconEmpty), _defineProperty(_extends2, "& .".concat(ratingClasses.iconFilled), styles.iconFilled), _defineProperty(_extends2, "& .".concat(ratingClasses.iconHover), styles.iconHover), _defineProperty(_extends2, "& .".concat(ratingClasses.iconFocus), styles.iconFocus), _defineProperty(_extends2, "& .".concat(ratingClasses.iconActive), styles.iconActive), _defineProperty(_extends2, "& .".concat(ratingClasses.decimal), styles.decimal), _defineProperty(_extends2, "& .".concat(ratingClasses.visuallyHidden), styles.visuallyHidden), _extends2)), styles.root || {});
};
...
var RatingRoot = experimentalStyled('span', {}, {
  ...
  }, _defineProperty(_extends3, "&.Mui-focusVisible ".concat(ratingClasses.iconActive), {
...
var Rating = /*#__PURE__*/React.forwardRef(function Rating(inProps, ref) {
  ...
  return /*#__PURE__*/_jsxs(RatingRoot, _extends({
    ...
    }), !readOnly && !disabled && valueRounded == null && /*#__PURE__*/_jsxs(RatingLabel, {
