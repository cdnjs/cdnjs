...
const TabsRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiTabs',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({
      [`& .${_tabsClasses.default.scrollButtons}`]: (0, _extends2.default)({}, styles.scrollButtons, styleProps.scrollButtonsHideMobile && styles.scrollButtonsHideMobile)
...
const TabsScroller = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiTabs',
  slot: 'Scroller',
  overridesResolver: (props, styles) => {
    const {
    ...
    return (0, _extends2.default)({}, styles.scroller, styleProps.fixed && styles.fixed, styleProps.hideScrollbar && styles.hideScrollbar, styleProps.scrollableX && styles.scrollableX, styleProps.scrollableY && styles.scrollableY);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
...
const FlexContainer = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiTabs',
  slot: 'FlexContainer',
  overridesResolver: (props, styles) => {
    const {
    ...
    return (0, _extends2.default)({}, styles.flexContainer, styleProps.vertical && styles.flexContainerVertical, styleProps.centered && styles.centered);
  }
})(({
  styleProps
}) => (0, _extends2.default)({
...
const TabsIndicator = (0, _experimentalStyled.default)('span', {}, {
  name: 'MuiTabs',
  slot: 'Indicator',
...
const TabsScrollbarSize = (0, _experimentalStyled.default)(_ScrollbarSize.default, {}, {
  name: 'MuiTabs',
  slot: 'ScrollbarSize'
})({
  overflowX: 'auto',
...
const Tabs = /*#__PURE__*/React.forwardRef(function Tabs(inProps, ref) {
  ...
  const {
    ...
    visibleScrollbar = false
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"]);
