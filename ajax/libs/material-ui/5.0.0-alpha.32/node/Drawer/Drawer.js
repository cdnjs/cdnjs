...
const overridesResolver = (props, styles) => {
  ...
  return (0, _extends2.default)({}, styles.root, (styleProps.variant === 'permanent' || styleProps.variant === 'persistent') && styles.docked, styles.modal);
};
...
const DrawerDockedRoot = (0, _experimentalStyled.default)('div', {
  shouldForwardProp: _experimentalStyled.rootShouldForwardProp
}, {
  name: 'MuiDrawer',
  slot: 'Docked',
...
const DrawerPaper = (0, _experimentalStyled.default)(_Paper.default, {}, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.paper, styles[`paperAnchor${(0, _capitalize.default)(styleProps.anchor)}`], styleProps.variant !== 'temporary' && styles[`paperAnchorDocked${(0, _capitalize.default)(styleProps.anchor)}`]);
  }
})(({
  theme,
  styleProps
