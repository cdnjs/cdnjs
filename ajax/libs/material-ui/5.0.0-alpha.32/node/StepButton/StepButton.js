...
const StepButtonRoot = (0, _experimentalStyled.default)(_ButtonBase.default, {}, {
  name: 'MuiStepButton',
  slot: 'Root',
...
const StepButton = /*#__PURE__*/React.forwardRef(function StepButton(inProps, ref) {
  ...
  const {
    ...
    optional
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "icon", "optional"]);
  const {
    disabled
