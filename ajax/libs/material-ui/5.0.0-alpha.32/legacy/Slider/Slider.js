...
export var SliderRoot = experimentalStyled('span', {}, {
  ...
  return _extends({
    ...
    marginBottom: 'auto',
    marginRight: 20
  }), (_extends3 = {}, _defineProperty(_extends3, "& .".concat(sliderClasses.valueLabelCircle), {
    display: 'flex',
    alignItems: 'center',
  ...
  }), _defineProperty(_extends3, "& .".concat(sliderClasses.valueLabelLabel), {
    color: theme.palette.primary.contrastText,
    transform: 'rotate(45deg)',
    textAlign: 'center'
  }), _defineProperty(_extends3, "&.".concat(sliderClasses.dragging), _defineProperty({}, "& .".concat(sliderClasses.thumb, ", & .").concat(sliderClasses.track), {
    transition: 'none'
  })), _extends3));
});
...
export var SliderThumb = experimentalStyled('span', {}, {
  ...
  }, _defineProperty(_extends4, "&:hover, &.".concat(sliderClasses.focusVisible), {
    boxShadow: "0px 0px 0px 8px ".concat(alpha(theme.palette.primary.main, 0.16)),
    '@media (hover: none)': {
      boxShadow: 'none'
    }
  }), _defineProperty(_extends4, "&.".concat(sliderClasses.active), {
    boxShadow: "0px 0px 0px 14px ".concat(alpha(theme.palette.primary.main, 0.16))
  }), _defineProperty(_extends4, "&.".concat(sliderClasses.disabled), _extends({
    width: 8,
    height: 8,
    marginLeft: -4,
    marginTop: -3
  ...
  })), _extends4), styleProps.orientation === 'vertical' && {
    marginLeft: -5,
    marginBottom: -6
...
export var SliderValueLabel = experimentalStyled(SliderValueLabelUnstyled, {}, {
  ...
  return _extends((_extends5 = {
    // IE 11 centering bug, to remove from the customization demos once no longer supported
    left: 'calc(-50% - 4px)'
  }, _defineProperty(_extends5, "&.".concat(sliderClasses.valueLabelOpen), {
    transform: 'scale(1) translateY(-10px)'
  }), _defineProperty(_extends5, "zIndex", 1), _extends5), theme.typography.body2, {
