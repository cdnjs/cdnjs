...
function generateGrid(globalStyles, theme, breakpoint, styleProps) {
  ...
  if (size === true) {
    ...
    var width = "".concat(Math.round(size / styleProps.columns * 10e7) / 10e5, "%");
    var more = {};
...
var Grid = /*#__PURE__*/React.forwardRef(function Grid(inProps, ref) {
  ...
  var className = props.className,
      ...
      other = _objectWithoutProperties(props, ["className", "columns", "component", "container", "direction", "item", "lg", "md", "sm", "spacing", "wrap", "xl", "xs", "zeroMinWidth"]);
