...
var ImageListItemBarTitleWrap = experimentalStyled('div', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.titleWrap, styles["titleWrap".concat(capitalize(styleProps.position))], styleProps.actionIcon && styles["titleWrapActionPos".concat(capitalize(styleProps.actionPosition))]);
  }
})(function (_ref2) {
...
var ImageListItemBarActionIcon = experimentalStyled('div', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.actionIcon, styles["actionIconActionPos".concat(capitalize(styleProps.actionPosition))]);
  }
})(function (_ref5) {
