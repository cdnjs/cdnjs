...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)({
    [`& .${_speedDialIconClasses.default.icon}`]: (0, _extends2.default)({}, styles.icon, styleProps.open && styles.iconOpen, styleProps.open && styleProps.openIcon && styles.iconWithOpenIconOpen),
    [`& .${_speedDialIconClasses.default.openIcon}`]: (0, _extends2.default)({}, styles.openIcon, styleProps.open && styles.openIconOpen)
  }, styles.root || {});
};
...
const SpeedDialIconRoot = (0, _experimentalStyled.default)('span', {}, {
...
const SpeedDialIcon = /*#__PURE__*/React.forwardRef(function SpeedDialIcon(inProps, ref) {
  ...
  const {
    ...
    openIcon: openIconProp
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "icon", "open", "openIcon"]);
