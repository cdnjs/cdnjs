...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`position${(0, _capitalize.default)(styleProps.position)}`], {
    [`& .${_imageListItemBarClasses.default.titleWrap}`]: (0, _extends2.default)({}, styles.titleWrap, styles[`titleWrap${(0, _capitalize.default)(styleProps.position)}`], styleProps.actionIcon && styles[`titleWrapActionPos${(0, _capitalize.default)(styleProps.actionPosition)}`]),
    [`& .${_imageListItemBarClasses.default.title}`]: styles.title,
    [`& .${_imageListItemBarClasses.default.subtitle}`]: styles.subtitle,
    [`& .${_imageListItemBarClasses.default.actionIcon}`]: (0, _extends2.default)({}, styles.actionIcon, styles[`actionIconActionPos${(0, _capitalize.default)(styleProps.actionPosition)}`])
  }), styles.root || {});
};
