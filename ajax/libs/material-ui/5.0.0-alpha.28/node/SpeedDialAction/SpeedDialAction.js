...
const overridesResolverFab = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, !styleProps.open && styles.fabClosed), styles.fab || {});
};
...
const overridesResolverStatic = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, !styleProps.open && styles.staticTooltipClosed, styles[`tooltipPlacement${(0, _capitalize.default)(styleProps.tooltipPlacement)}`], {
    [`& .${_speedDialActionClasses.default.staticTooltipLabel}`]: styles.staticTooltipLabel
