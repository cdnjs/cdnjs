...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, !styleProps.disableInteractive && styles.popperInteractive, styleProps.arrow && styles.popperArrow, {
    [`& .${_tooltipClasses.default.tooltip}`]: (0, _extends2.default)({}, styles.tooltip, styleProps.touch && styles.touch, styleProps.arrow && styles.tooltipArrow, styles[`tooltipPlacement${(0, _capitalize.default)(styleProps.placement.split('-')[0])}`]),
    [`& .${_tooltipClasses.default.arrow}`]: styles.arrow
  }), styles.popper || {});
};
...
const TooltipPopper = (0, _experimentalStyled.default)(_Popper.default, {}, {
  name: 'MuiTooltip',
  slot: 'Popper',
  overridesResolver
})(({
...
const TooltipTooltip = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiTooltip',
  slot: 'Tooltip'
})(({
  theme,
...
const TooltipArrow = (0, _experimentalStyled.default)('span', {}, {
  name: 'MuiTooltip',
  slot: 'Arrow'
})(({
  theme
...
const Tooltip = /*#__PURE__*/React.forwardRef(function Tooltip(inProps, ref) {
  const _useThemeProps = (0, _useThemeProps2.default)({
    ...
    theme
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_useThemeProps, ["theme", "isRtl"]);
  ...
  const {
    ...
    TransitionProps
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["arrow", "children", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "title", "TransitionComponent", "TransitionProps"]);
