...
const overridesResolver = ({
  ...
  return deepmerge(styles.root || {}, _extends({}, styles[`margin${capitalize(styleProps.margin)}`], styleProps.fullWidth && styles.fullWidth));
};
...
const FormControl = /*#__PURE__*/React.forwardRef(function FormControl(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(FormControlContext.Provider, {
    value: childContext
  }, /*#__PURE__*/React.createElement(FormControlRoot, _extends({
    as: component,
