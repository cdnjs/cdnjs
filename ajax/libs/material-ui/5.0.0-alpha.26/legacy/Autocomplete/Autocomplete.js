...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  var disablePortal = styleProps.disablePortal,
  ...
  return deepmerge(styles.root || {}, _extends({}, fullWidth && styles.fullWidth, hasPopupIcon && styles.hasPopupIcon, hasClearIcon && styles.hasClearIcon, (_extends2 = {}, _defineProperty(_extends2, "& .".concat(autocompleteClasses.tag), _extends({}, styles.tag, styles["tagSize".concat(capitalize(size))])), _defineProperty(_extends2, "& .".concat(autocompleteClasses.inputRoot), styles.inputRoot), _defineProperty(_extends2, "& .".concat(autocompleteClasses.input), _extends({}, styles.input, inputFocused && styles.inputFocused)), _defineProperty(_extends2, "& .".concat(autocompleteClasses.endAdornment), styles.endAdornment), _defineProperty(_extends2, "& .".concat(autocompleteClasses.clearIndicator), styles.clearIndicator), _defineProperty(_extends2, "& .".concat(autocompleteClasses.popupIndicator), _extends({}, styles.popupIndicator, popupOpen && styles.popupIndicatorOpen)), _defineProperty(_extends2, "& .".concat(autocompleteClasses.popper), _extends({}, styles.popper, disablePortal && styles.popperDisablePortal)), _defineProperty(_extends2, "& .".concat(autocompleteClasses.paper), styles.paper), _defineProperty(_extends2, "& .".concat(autocompleteClasses.listbox), styles.listbox), _defineProperty(_extends2, "& .".concat(autocompleteClasses.loading), styles.loading), _defineProperty(_extends2, "& .".concat(autocompleteClasses.noOptions), styles.noOptions), _defineProperty(_extends2, "& .".concat(autocompleteClasses.option), styles.option), _defineProperty(_extends2, "& .".concat(autocompleteClasses.groupLabel), styles.groupLabel), _defineProperty(_extends2, "& .".concat(autocompleteClasses.groupUl), styles.groupUl), _extends2)));
};
...
var AutocompleteRoot = experimentalStyled('div', {}, {
  ...
  var _extends3, _MuiOutlinedInputR, _MuiFilledInputRoo, _$concat, _extends4;

  var styleProps = _ref.styleProps;
  return _extends((_extends3 = {}, _defineProperty(_extends3, "&.Mui-focused .".concat(autocompleteClasses.clearIndicator), {
    visibility: 'visible'
  ...
  }), _$concat)), _defineProperty(_extends4, "& .".concat(autocompleteClasses.input), _extends({
    flexGrow: 1,
...
var _ref10 = /*#__PURE__*/React.createElement(ClearIcon, {
  fontSize: "small"
});

var _ref11 = /*#__PURE__*/React.createElement(ArrowDropDownIcon, null);
