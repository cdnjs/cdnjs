...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styles["labelPlacement".concat(capitalize(styleProps.labelPlacement))], _defineProperty({}, "& .".concat(formControlLabelClasses.label), styles.label)));
};
