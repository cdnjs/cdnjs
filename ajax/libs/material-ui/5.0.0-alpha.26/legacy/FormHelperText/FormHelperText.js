...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.size && styles["size".concat(capitalize(styleProps.size))], styleProps.contained && styles.contained, styleProps.filled && styles.filled));
};
