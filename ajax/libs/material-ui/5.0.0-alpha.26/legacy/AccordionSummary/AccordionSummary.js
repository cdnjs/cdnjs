...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, (_deepmerge = {}, _defineProperty(_deepmerge, "& .".concat(accordionSummaryClasses.content), styles.content), _defineProperty(_deepmerge, "& .".concat(accordionSummaryClasses.expandIconWrapper), styles.expandIconWrapper), _deepmerge));
};
