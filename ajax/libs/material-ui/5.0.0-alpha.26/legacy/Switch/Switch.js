...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.edge && styles["edge".concat(capitalize(styleProps.edge))], styles["size".concat(capitalize(styleProps.size))], (_extends2 = {}, _defineProperty(_extends2, "& .".concat(switchClasses.switchBase), _extends({}, styles.switchBase, styles.input, styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))])), _defineProperty(_extends2, "& .".concat(switchClasses.thumb), styles.thumb), _defineProperty(_extends2, "& .".concat(switchClasses.track), styles.track), _extends2)));
};
...
var useUtilityClasses = function useUtilityClasses(styleProps) {
  ...
  var slots = {
    ...
    switchBase: ['switchBase', "color".concat(capitalize(color)), checked && 'checked', disabled && 'disabled', 'input'],
    thumb: ['thumb'],
    track: ['track']
  };
...
var Switch = /*#__PURE__*/React.forwardRef(function Switch(inProps, ref) {
  ...
  var icon = /*#__PURE__*/React.createElement(SwitchThumb, {
