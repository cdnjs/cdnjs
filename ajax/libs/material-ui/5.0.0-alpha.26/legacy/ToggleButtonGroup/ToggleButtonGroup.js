...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.orientation === 'vertical' && styles.vertical, _defineProperty({}, "& .".concat(toggleButtonGroupClasses.grouped), _extends({}, styles.grouped, styles["grouped".concat(capitalize(styleProps.orientation))]))));
};
...
var ToggleButtonGroup = /*#__PURE__*/React.forwardRef(function ToggleButtonGroup(inProps, ref) {
  ...
  var children = props.children,
      ...
      value = props.value,
      other = _objectWithoutProperties(props, ["children", "className", "exclusive", "onChange", "orientation", "size", "value"]);
  ...
  return /*#__PURE__*/React.createElement(ToggleButtonGroupRoot, _extends({
    role: "group",
