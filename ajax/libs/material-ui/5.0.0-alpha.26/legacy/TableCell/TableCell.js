...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.padding !== 'default' && styles["padding".concat(capitalize(styleProps.padding))], styleProps.align !== 'inherit' && styles["align".concat(capitalize(styleProps.align))], styleProps.stickyHeader && styles.stickyHeader));
};
