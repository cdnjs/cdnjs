...
export var overridesResolver = function overridesResolver(_ref, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.color === 'secondary' && styles.colorSecondary, styleProps.filled && styles.filled, _defineProperty({}, "& .".concat(formLabelClasses.asterisk), _extends({}, styles.asterisk))));
};
