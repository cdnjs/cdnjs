...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styleProps.orientation === 'vertical' && styles.vertical, {
    [`& .${_toggleButtonGroupClasses.default.grouped}`]: (0, _extends2.default)({}, styles.grouped, styles[`grouped${(0, _utils2.capitalize)(styleProps.orientation)}`])
  }));
};
...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    ...
    grouped: ['grouped', `grouped${(0, _utils2.capitalize)(orientation)}`]
  };
...
const ToggleButtonGroup = /*#__PURE__*/React.forwardRef(function ToggleButtonGroup(inProps, ref) {
  ...
  const {
    ...
    value
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "exclusive", "onChange", "orientation", "size", "value"]);
  ...
  return /*#__PURE__*/React.createElement(ToggleButtonGroupRoot, (0, _extends2.default)({
    role: "group",
