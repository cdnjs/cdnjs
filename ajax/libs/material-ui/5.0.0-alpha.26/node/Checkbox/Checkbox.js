...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styleProps.indeterminate && styles.indeterminate, styleProps.color !== 'default' && styles[`color${(0, _capitalize.default)(styleProps.color)}`]));
};
...
const CheckboxRoot = (0, _experimentalStyled.default)(_SwitchBase.default, {
  ...
  [`&.Mui-checked, &.${_checkboxClasses.default.indeterminate}`]: {
...
const Checkbox = /*#__PURE__*/React.forwardRef(function Checkbox(inProps, ref) {
  ...
  const {
    ...
    size = 'medium'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["checkedIcon", "color", "icon", "indeterminate", "indeterminateIcon", "inputProps", "size"]);
  ...
  return /*#__PURE__*/React.createElement(CheckboxRoot, (0, _extends2.default)({
    type: "checkbox",
    color: color,
