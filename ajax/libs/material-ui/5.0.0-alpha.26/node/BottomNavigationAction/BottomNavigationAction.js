...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, !styleProps.showLabel && !styleProps.selected && styles.iconOnly, {
    [`& .${_bottomNavigationActionClasses.default.wrapper}`]: styles.wrapper,
    [`& .${_bottomNavigationActionClasses.default.label}`]: styles.label
  }));
};
...
const BottomNavigationAction = /*#__PURE__*/React.forwardRef(function BottomNavigationAction(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(BottomNavigationActionRoot, (0, _extends2.default)({
    ref: ref,
