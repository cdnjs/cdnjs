...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[styleProps.variant], styleProps.animation !== false && styles[styleProps.animation], styleProps.hasChildren && styles.withChildren, styleProps.hasChildren && !styleProps.width && styles.fitContent, styleProps.hasChildren && !styleProps.height && styles.heightAuto));
};
...
const Skeleton = /*#__PURE__*/React.forwardRef(function Skeleton(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(SkeletonRoot, (0, _extends2.default)({
    as: component,
    ref: ref,
