...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, fullWidth && styles.fullWidth, hasPopupIcon && styles.hasPopupIcon, hasClearIcon && styles.hasClearIcon, {
    [`& .${_autocompleteClasses.default.tag}`]: (0, _extends2.default)({}, styles.tag, styles[`tagSize${(0, _utils2.capitalize)(size)}`]),
    ...
    [`& .${_autocompleteClasses.default.endAdornment}`]: styles.endAdornment,
    [`& .${_autocompleteClasses.default.clearIndicator}`]: styles.clearIndicator,
    [`& .${_autocompleteClasses.default.popupIndicator}`]: (0, _extends2.default)({}, styles.popupIndicator, popupOpen && styles.popupIndicatorOpen),
    [`& .${_autocompleteClasses.default.popper}`]: (0, _extends2.default)({}, styles.popper, disablePortal && styles.popperDisablePortal),
    [`& .${_autocompleteClasses.default.paper}`]: styles.paper,
    [`& .${_autocompleteClasses.default.listbox}`]: styles.listbox,
    [`& .${_autocompleteClasses.default.loading}`]: styles.loading,
    [`& .${_autocompleteClasses.default.noOptions}`]: styles.noOptions,
    [`& .${_autocompleteClasses.default.option}`]: styles.option,
    [`& .${_autocompleteClasses.default.groupLabel}`]: styles.groupLabel,
    [`& .${_autocompleteClasses.default.groupUl}`]: styles.groupUl
  }));
};
...
const useUtilityClasses = styleProps => {
  ...
  const slots = {
    ...
    tag: ['tag', `tagSize${(0, _utils2.capitalize)(size)})`],
...
const AutocompleteRoot = (0, _experimentalStyled.default)('div', {}, {
  ...
  [`&.Mui-focused .${_autocompleteClasses.default.clearIndicator}`]: {
    visibility: 'visible'
  },
...
const AutocompleteEndAdornment = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiAutocomplete',
  slot: 'EndAdornment'
})({
...
const AutocompleteClearIndicator = (0, _experimentalStyled.default)(_IconButton.default, {}, {
  name: 'MuiAutocomplete',
  slot: 'ClearIndicator'
})({
...
const AutocompletePopupIndicator = (0, _experimentalStyled.default)(_IconButton.default, {}, {
  name: 'MuiAutocomplete',
  slot: 'PopupIndicator'
})(({
  styleProps
...
const AutocompletePopper = (0, _experimentalStyled.default)(_Popper.default, {}, {
  name: 'MuiAutocomplete',
  slot: 'Popper'
})(({
  theme,
...
const AutocompletePaper = (0, _experimentalStyled.default)(_Paper.default, {}, {
  name: 'MuiAutocomplete',
  slot: 'Paper'
})(({
  theme
...
const AutocompleteLoading = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiAutocomplete',
  slot: 'Loading'
})(({
  theme
...
const AutocompleteNoOptions = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiAutocomplete',
  slot: 'NoOptions'
})(({
  theme
...
const AutocompleteListbox = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiAutocomplete',
  slot: 'Listbox'
})(({
  theme
...
const AutocompleteGroupLabel = (0, _experimentalStyled.default)(_ListSubheader.default, {}, {
  name: 'MuiAutocomplete',
  slot: 'GroupLabel'
})(({
  theme
...
const AutocompleteGroupUl = (0, _experimentalStyled.default)('ul', {}, {
  name: 'MuiAutocomplete',
  slot: 'GroupUl'
})({
...
const Autocomplete = /*#__PURE__*/React.forwardRef(function Autocomplete(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AutocompleteRoot, (0, _extends2.default)({
    ref: ref,
    ...
    InputProps: {
      ...
      endAdornment: /*#__PURE__*/React.createElement(AutocompleteEndAdornment, {
        ...
        styleProps: styleProps
      }, hasClearIcon ? /*#__PURE__*/React.createElement(AutocompleteClearIndicator, (0, _extends2.default)({}, getClearProps(), {
        "aria-label": clearText,
        title: clearText,
        className: classes.clearIndicator,
        styleProps: styleProps
      }), clearIcon) : null, hasPopupIcon ? /*#__PURE__*/React.createElement(AutocompletePopupIndicator, (0, _extends2.default)({}, getPopupIndicatorProps(), {
        disabled: disabled,
  ...
  }, noOptionsText) : null, groupedOptions.length > 0 ? /*#__PURE__*/React.createElement(AutocompleteListbox, (0, _extends2.default)({
    as: ListboxComponent,
