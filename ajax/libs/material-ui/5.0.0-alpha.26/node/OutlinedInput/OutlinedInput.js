...
const overridesResolver = (props, styles) => {
  return (0, _utils.deepmerge)((0, _InputBase.overridesResolver)(props, styles), (0, _extends2.default)({}, styles.notchedOutline));
};
...
const OutlinedInputRoot = (0, _experimentalStyled.default)(_InputBase.InputBaseRoot, {
  ...
  return (0, _extends2.default)({
    ...
    [`&.Mui-focused .${_outlinedInputClasses.default.notchedOutline}`]: {
      borderColor: theme.palette[styleProps.color].main,
      borderWidth: 2
    },
    [`&.Mui-error .${_outlinedInputClasses.default.notchedOutline}`]: {
      borderColor: theme.palette.error.main
    },
    [`&.Mui-disabled .${_outlinedInputClasses.default.notchedOutline}`]: {
...
const NotchedOutlineRoot = (0, _experimentalStyled.default)(_NotchedOutline.default, {}, {
  name: 'MuiOutlinedInput',
  slot: 'NotchedOutline'
})(({
  theme
...
const OutlinedInputInput = (0, _experimentalStyled.default)(_InputBase.InputBaseComponent, {
  shouldForwardProp: prop => (0, _experimentalStyled.shouldForwardProp)(prop) || prop === 'classes'
}, {
  name: 'MuiOutlinedInput',
  slot: 'Input'
...
const OutlinedInput = /*#__PURE__*/React.forwardRef(function OutlinedInput(inProps, ref) {
  ...
  const {
    ...
    type = 'text'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["fullWidth", "inputComponent", "label", "labelWidth", "multiline", "notched", "type"]);
  ...
  return /*#__PURE__*/React.createElement(_InputBase.default, (0, _extends2.default)({
    ...
    renderSuffix: state => /*#__PURE__*/React.createElement(NotchedOutlineRoot, {
