...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[styleProps.variant], styles[`size${(0, _capitalize.default)(styleProps.size)}`], styleProps.padding !== 'default' && styles[`padding${(0, _capitalize.default)(styleProps.padding)}`], styleProps.align !== 'inherit' && styles[`align${(0, _capitalize.default)(styleProps.align)}`], styleProps.stickyHeader && styles.stickyHeader));
};
...
const TableCell = /*#__PURE__*/React.forwardRef(function TableCell(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(TableCellRoot, (0, _extends2.default)({
    as: component,
    ref: ref,
