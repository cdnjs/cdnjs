...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[styleProps.variant], styleProps.animation !== false && styles[styleProps.animation], styleProps.hasChildren && styles.withChildren, styleProps.hasChildren && !styleProps.width && styles.fitContent, styleProps.hasChildren && !styleProps.height && styles.heightAuto), styles.root || {});
};
...
const pulseKeyframe = (0, _styledEngine.keyframes)`
  0% {
    opacity: 1;
  }
...
`;
const waveKeyframe = (0, _styledEngine.keyframes)`
  0% {
...
`;
const SkeletonRoot = (0, _experimentalStyled.default)('span', {}, {
  name: 'MuiSkeleton',
  slot: 'Root',
  overridesResolver
})(({
...
({
  styleProps
}) => styleProps.animation === 'pulse' && (0, _styledEngine.css)`
...
({
  styleProps,
  theme
}) => styleProps.animation === 'wave' && (0, _styledEngine.css)`
      position: relative;
      overflow: hidden;
...
const Skeleton = /*#__PURE__*/React.forwardRef(function Skeleton(inProps, ref) {
  ...
  const {
    ...
    width
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["animation", "className", "component", "height", "style", "variant", "width"]);
