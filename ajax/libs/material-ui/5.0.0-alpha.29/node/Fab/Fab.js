...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[styleProps.variant], styles[`size${(0, _capitalize.default)(styleProps.size)}`], styleProps.color === 'inherit' && styles.colorInherit, styleProps.color === 'primary' && styles.primary, styleProps.color === 'secondary' && styles.secondary, {
    [`& .${_fabClasses.default.label}`]: styles.label
  }), styles.root || {});
};
...
const FabRoot = (0, _experimentalStyled.default)(_ButtonBase.default, {}, {
  name: 'MuiFab',
  slot: 'Root',
  overridesResolver
})(({
...
const FabLabel = (0, _experimentalStyled.default)('span', {}, {
  name: 'MuiFab',
  slot: 'Label'
})({
...
const Fab = /*#__PURE__*/React.forwardRef(function Fab(inProps, ref) {
  ...
  const {
    ...
    variant = 'circular'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "color", "component", "disabled", "disableFocusRipple", "focusVisibleClassName", "size", "variant"]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(FabRoot, (0, _extends2.default)({
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(FabLabel, {
