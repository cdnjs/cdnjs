...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`underline${(0, _capitalize.default)(styleProps.underline)}`], styleProps.component === 'button' && styles.button), styles.root || {});
};
