...
var _cyan = _interopRequireDefault(require("../colors/cyan"));
...
const _excluded = ["warning", "info", "success", "mode", "contrastThreshold", "tonalOffset"];
const light = {
...
function createPalette(palette) {
  const {
    ...
    info = {
      light: _cyan.default[300],
      main: _cyan.default[500],
      dark: _cyan.default[700]
    },
    success = {
