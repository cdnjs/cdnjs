...
export var SliderRoot = experimentalStyled('span', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styles["color".concat(capitalize(styleProps.color))], marked && styles.marked, styleProps.orientation === 'vertical' && styles.vertical, styleProps.track === 'inverted' && styles.trackInverted, styleProps.track === false && styles.trackFalse);
  }
})(function (_ref) {
  var _extends2;
  ...
  return _extends({
    ...
    transition: 'none'
  })), _defineProperty(_extends2, "& .".concat(sliderClasses.valueLabelCircle), {
    display: 'flex',
    alignItems: 'center',
  ...
  }), _defineProperty(_extends2, "& .".concat(sliderClasses.valueLabelLabel), {
...
export var SliderThumb = experimentalStyled('span', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.thumb, styles["thumbColor".concat(capitalize(styleProps.color))]);
  }
})(function (_ref4) {
  var _extends3;
...
export var SliderValueLabel = experimentalStyled(SliderValueLabelUnstyled, {}, {
  ...
  }), _defineProperty(_extends4, "zIndex", 1), _extends4), theme.typography.body2, {
