...
var FormHelperTextRoot = experimentalStyled('p', {}, {
  name: 'MuiFormHelperText',
  slot: 'Root',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.root, styleProps.size && styles["size".concat(capitalize(styleProps.size))], styleProps.contained && styles.contained, styleProps.filled && styles.filled);
  }
})(function (_ref) {
  var _extends2;
