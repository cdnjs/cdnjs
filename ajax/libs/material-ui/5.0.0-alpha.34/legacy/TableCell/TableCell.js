...
var TableCellRoot = experimentalStyled('td', {}, {
  name: 'MuiTableCell',
  slot: 'Root',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.root, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.padding !== 'normal' && styles["padding".concat(capitalize(styleProps.padding))], styleProps.align !== 'inherit' && styles["align".concat(capitalize(styleProps.align))], styleProps.stickyHeader && styles.stickyHeader);
  }
})(function (_ref) {
