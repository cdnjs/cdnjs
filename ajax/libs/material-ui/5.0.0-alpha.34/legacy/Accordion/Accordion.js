...
var AccordionRoot = experimentalStyled(Paper, {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends(_defineProperty({}, "& .".concat(accordionClasses.region), styles.region), styles.root, !styleProps.square && styles.rounded, !styleProps.disableGutters && styles.gutters);
  }
})(function (_ref) {
  var _ref2;
