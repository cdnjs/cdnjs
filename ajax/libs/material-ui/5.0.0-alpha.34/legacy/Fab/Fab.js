...
var FabRoot = experimentalStyled(ButtonBase, {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styles[styleProps.variant], styles["size".concat(capitalize(styleProps.size))], styleProps.color === 'inherit' && styles.colorInherit, styleProps.color === 'primary' && styles.primary, styleProps.color === 'secondary' && styles.secondary);
  }
})(function (_ref) {
  var _extends2;
