...
var CircularProgressRoot = experimentalStyled('span', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.root, styles[styleProps.variant], styles["color".concat(capitalize(styleProps.color))]);
  }
})(function (_ref) {
...
var CircularProgressCircle = experimentalStyled('circle', {}, {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.circle, styles["circle".concat(capitalize(styleProps.variant))], styleProps.disableShrink && styles.circleDisableShrink);
  }
})(function (_ref3) {
