...
const ContainerRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiContainer',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`maxWidth${(0, _capitalize.default)(String(styleProps.maxWidth))}`], styleProps.fixed && styles.fixed, styleProps.disableGutters && styles.disableGutters);
  }
})(({
  theme,
  styleProps
...
const Container = /*#__PURE__*/React.forwardRef(function Container(inProps, ref) {
  ...
  const {
    ...
    maxWidth = 'lg'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "component", "disableGutters", "fixed", "maxWidth"]);
