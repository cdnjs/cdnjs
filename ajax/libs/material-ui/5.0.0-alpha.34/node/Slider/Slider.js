...
const SliderRoot = (0, _experimentalStyled.default)('span', {}, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styles[`color${(0, _capitalize.default)(styleProps.color)}`], marked && styles.marked, styleProps.orientation === 'vertical' && styles.vertical, styleProps.track === 'inverted' && styles.trackInverted, styleProps.track === false && styles.trackFalse);
  }
})(({
  theme,
  styleProps
...
const SliderTrack = (0, _experimentalStyled.default)('span', {}, {
  ...
  theme.palette.mode === 'light' ? (0, _colorManipulator.lighten)(theme.palette[styleProps.color].main, 0.62) : (0, _colorManipulator.darken)(theme.palette[styleProps.color].main, 0.5)
}));
...
const SliderThumb = (0, _experimentalStyled.default)('span', {}, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.thumb, styles[`thumbColor${(0, _capitalize.default)(styleProps.color)}`]);
  }
})(({
  theme,
  styleProps
  ...
  [`&:hover, &.${sliderClasses.focusVisible}`]: {
    boxShadow: `0px 0px 0px 8px ${(0, _colorManipulator.alpha)(theme.palette[styleProps.color].main, 0.16)}`,
    '@media (hover: none)': {
      boxShadow: 'none'
    }
  },
  [`&.${sliderClasses.active}`]: {
    boxShadow: `0px 0px 0px 14px ${(0, _colorManipulator.alpha)(theme.palette[styleProps.color].main, 0.16)}`
  },
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_SliderUnstyled.default, (0, _extends2.default)({}, other, {
    ...
    componentsProps: (0, _extends2.default)({}, componentsProps, {
      ...
      track: (0, _extends2.default)({}, componentsProps.track, shouldSpreadStyleProps(components.Track) && {
        styleProps: (0, _extends2.default)({}, (_componentsProps$trac = componentsProps.track) === null || _componentsProps$trac === void 0 ? void 0 : _componentsProps$trac.styleProps, {
          color
        })
      })
    }),
