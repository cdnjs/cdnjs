...
const SelectRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiSelect',
  slot: 'Root',
  overridesResolver: (props, styles) => {
    ...
    return {
      [`&.${_selectClasses.default.select}`]: (0, _extends2.default)({}, styles.root, styles.select, styles.selectMenu, styles[styleProps.variant])
    };
  }
})(_NativeSelectInput.nativeSelectRootStyles, {
  // Win specificity over the input base
  [`&.${_selectClasses.default.selectMenu}`]: {
    height: 'auto',
...
const SelectIcon = (0, _experimentalStyled.default)('svg', {}, {
  name: 'MuiSelect',
  slot: 'Icon',
  overridesResolver: (props, styles) => {
    const {
...
const SelectNativeInput = (0, _experimentalStyled.default)('input', {
  shouldForwardProp: prop => (0, _experimentalStyled.slotShouldForwardProp)(prop) && prop !== 'classes'
}, {
  name: 'MuiSelect',
  slot: 'NativeInput',
...
const SelectInput = /*#__PURE__*/React.forwardRef(function SelectInput(props, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(SelectRoot, (0, _extends2.default)({
      ...
      className: (0, _clsx.default)(classes.root, className, SelectDisplayProps.className) // The id is required for proper a11y
      ,
      id: buttonId,
