...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles["position".concat(capitalize(styleProps.position))], styleProps.disablePointerEvents === true && styles.disablePointerEvents, styles[styleProps.variant]), styles.root || {});
};
...
var InputAdornmentRoot = experimentalStyled('div', {}, {
