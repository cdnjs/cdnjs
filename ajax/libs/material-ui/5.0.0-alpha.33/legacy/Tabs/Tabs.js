...
var TabsRoot = experimentalStyled('div', {}, {
  name: 'MuiTabs',
  slot: 'Root',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends(_defineProperty({}, "& .".concat(tabsClasses.scrollButtons), _extends({}, styles.scrollButtons, styleProps.scrollButtonsHideMobile && styles.scrollButtonsHideMobile)), styles.root, styleProps.vertical && styles.vertical);
  }
})(function (_ref) {
...
var TabsScroller = experimentalStyled('div', {}, {
  name: 'MuiTabs',
  slot: 'Scroller',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
...
var FlexContainer = experimentalStyled('div', {}, {
  name: 'MuiTabs',
  slot: 'FlexContainer',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
...
var TabsIndicator = experimentalStyled('span', {}, {
  name: 'MuiTabs',
  slot: 'Indicator',
  overridesResolver: function overridesResolver(props, styles) {
...
var TabsScrollbarSize = experimentalStyled(ScrollbarSize, {}, {
  name: 'MuiTabs',
  slot: 'ScrollbarSize'
})({
  overflowX: 'auto',
...
var Tabs = /*#__PURE__*/React.forwardRef(function Tabs(inProps, ref) {
  ...
  var scroll = function scroll(scrollValue) {
    var _ref6 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref6$animation = _ref6.animation,
        animation = _ref6$animation === void 0 ? true : _ref6$animation;
