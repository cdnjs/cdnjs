...
var SpeedDialRoot = experimentalStyled('div', {}, {
  name: 'MuiSpeedDial',
  slot: 'Root',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.root, styles["direction".concat(capitalize(styleProps.direction))]);
  }
})(function (_ref) {
...
var SpeedDialFab = experimentalStyled(Fab, {}, {
  name: 'MuiSpeedDial',
  slot: 'Fab',
  overridesResolver: function overridesResolver(props, styles) {
    return styles.fab;
...
var SpeedDialActions = experimentalStyled('div', {}, {
  name: 'MuiSpeedDial',
  slot: 'Actions',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.actions, !styleProps.open && styles.actionsClosed);
  }
})(function (_ref6) {
