...
export var slotShouldForwardProp = function slotShouldForwardProp(prop) {
...
var experimentalStyled = function experimentalStyled(tag, options) {
  ...
  var overridesResolver = muiOptions.overridesResolver; // if skipVariantsResolver option is defined, take the value, otherwise, true for root and false for other slots

  var skipVariantsResolver = muiOptions.skipVariantsResolver !== undefined ? muiOptions.skipVariantsResolver : componentSlot && componentSlot !== 'Root' || false;
  ...
  var defaultStyledResolver = styled(tag, _extends({}, !componentSlot || componentSlot === 'Root' ? {
