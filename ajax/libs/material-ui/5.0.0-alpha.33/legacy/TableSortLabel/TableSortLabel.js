...
var TableSortLabelRoot = experimentalStyled(ButtonBase, {}, {
...
var TableSortLabelIcon = experimentalStyled('span', {}, {
  name: 'MuiTableSortLabel',
  slot: 'Icon',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.icon, styles["iconDirection".concat(capitalize(styleProps.direction))]);
  }
})(function (_ref3) {
