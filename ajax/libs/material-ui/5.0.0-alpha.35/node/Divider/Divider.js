...
const DividerWrapper = (0, _experimentalStyled.default)('span', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.wrapper, styleProps.orientation === 'vertical' && styles.wrapperVertical);
  }
})(({
  theme,
  styleProps
