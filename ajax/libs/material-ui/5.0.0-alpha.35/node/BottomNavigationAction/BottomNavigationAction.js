...
const BottomNavigationActionRoot = (0, _experimentalStyled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, !styleProps.showLabel && !styleProps.selected && styles.iconOnly);
  }
})(({
  theme,
  styleProps
...
const BottomNavigationActionWrapper = (0, _experimentalStyled.default)('span', {
  name: 'MuiBottomNavigationAction',
  slot: 'Wrapper',
...
const BottomNavigationActionLabel = (0, _experimentalStyled.default)('span', {
  name: 'MuiBottomNavigationAction',
  slot: 'Label',
...
const BottomNavigationAction = /*#__PURE__*/React.forwardRef(function BottomNavigationAction(inProps, ref) {
  ...
  const {
    ...
    value
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "icon", "label", "onChange", "onTouchStart", "onTouchEnd", "onClick", "selected", "showLabel", "value"]); // TODO: convert to simple assignment after the type error in defaultPropsHandler.js:60:6 is fixed
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(BottomNavigationActionRoot, (0, _extends2.default)({
    ref: ref,
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(BottomNavigationActionWrapper, {
