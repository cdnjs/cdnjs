...
const SpeedDialActionFab = (0, _experimentalStyled.default)(_Fab.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.fab, !styleProps.open && styles.fabClosed);
  }
})(({
  theme,
  styleProps
...
const SpeedDialActionStaticTooltip = (0, _experimentalStyled.default)('span', {
  name: 'MuiSpeedDialAction',
  slot: 'StaticTooltip',
  overridesResolver: (props, styles) => {
    const {
    ...
    return (0, _extends2.default)({}, styles.staticTooltip, !styleProps.open && styles.staticTooltipClosed, styles[`tooltipPlacement${(0, _capitalize.default)(styleProps.tooltipPlacement)}`]);
  }
})(({
  theme,
  styleProps
...
const SpeedDialActionStaticTooltipLabel = (0, _experimentalStyled.default)('span', {
  name: 'MuiSpeedDialAction',
...
const SpeedDialAction = /*#__PURE__*/React.forwardRef(function SpeedDialAction(inProps, ref) {
  ...
  const {
    ...
    tooltipTitle
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"]);
