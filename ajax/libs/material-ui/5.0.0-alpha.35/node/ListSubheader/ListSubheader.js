...
const ListSubheaderRoot = (0, _experimentalStyled.default)('li', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styleProps.color !== 'default' && styles[`color${(0, _capitalize.default)(styleProps.color)}`], !styleProps.disableGutters && styles.gutters, styleProps.inset && styles.inset, !styleProps.disableSticky && styles.sticky);
  }
})(({
  theme,
  styleProps
...
const ListSubheader = /*#__PURE__*/React.forwardRef(function ListSubheader(inProps, ref) {
  ...
  const {
    ...
    inset = false
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "color", "component", "disableGutters", "disableSticky", "inset"]);
