...
const TabRoot = (0, _experimentalStyled.default)(_ButtonBase.default, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return (0, _extends2.default)({}, styles.root, styleProps.label && styleProps.icon && styles.labelIcon, styles[`textColor${(0, _capitalize.default)(styleProps.textColor)}`], styleProps.fullWidth && styles.fullWidth, styleProps.wrapped && styles.wrapped);
  }
})(({
  theme,
  styleProps
