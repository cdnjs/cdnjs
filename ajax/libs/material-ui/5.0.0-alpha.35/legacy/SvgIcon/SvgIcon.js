...
var SvgIconRoot = experimentalStyled('svg', {
  name: 'MuiSvgIcon',
  slot: 'Root',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.root, styleProps.color !== 'inherit' && styles["color".concat(capitalize(styleProps.color))], styles["fontSize".concat(capitalize(styleProps.fontSize))]);
  }
})(function (_ref) {
...
= {
  ...
  .oneOfType([PropTypes.oneOf(['action', 'disabled', 'error', 'inherit', 'primary', 'secondary']), PropTypes.string]),
