...
var SpeedDialActionFab = experimentalStyled(Fab, {
  name: 'MuiSpeedDialAction',
  slot: 'Fab',
  skipVariantsResolver: false,
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.fab, !styleProps.open && styles.fabClosed);
  }
})(function (_ref) {
...
var SpeedDialActionStaticTooltip = experimentalStyled('span', {
  name: 'MuiSpeedDialAction',
  slot: 'StaticTooltip',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.staticTooltip, !styleProps.open && styles.staticTooltipClosed, styles["tooltipPlacement".concat(capitalize(styleProps.tooltipPlacement))]);
  }
})(function (_ref2) {
...
var SpeedDialActionStaticTooltipLabel = experimentalStyled('span', {
  name: 'MuiSpeedDialAction',
