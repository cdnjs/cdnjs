...
var BadgeBadge = styled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends({}, styles.badge, styles[styleProps.variant], styles["anchorOrigin".concat(capitalize(styleProps.anchorOrigin.vertical)).concat(capitalize(styleProps.anchorOrigin.horizontal)).concat(capitalize(styleProps.overlap))], styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))], styleProps.invisible && styles.invisible);
  }
})(function (_ref) {
