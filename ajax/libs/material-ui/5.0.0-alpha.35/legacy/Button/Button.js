...
var ButtonStartIcon = experimentalStyled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.startIcon, styles["iconSize".concat(capitalize(styleProps.size))]);
  }
})(function (_ref4) {
...
var ButtonEndIcon = experimentalStyled('span', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.endIcon, styles["iconSize".concat(capitalize(styleProps.size))]);
  }
})(function (_ref5) {
