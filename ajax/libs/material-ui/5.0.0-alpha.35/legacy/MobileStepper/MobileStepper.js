...
var MobileStepperRoot = experimentalStyled(Paper, {
...
var MobileStepperDots = experimentalStyled('div', {
  name: 'MuiMobileStepper',
  slot: 'Dots',
  overridesResolver: function overridesResolver(props, styles) {
    return styles.dots;
...
var MobileStepperDot = experimentalStyled('div', {
  name: 'MuiMobileStepper',
  slot: 'Dot',
  overridesResolver: function overridesResolver(props, styles) {
    var styleProps = props.styleProps;
    return _extends({}, styles.dot, styleProps.dotActive && styles.dotActive);
  }
})(function (_ref3) {
...
var MobileStepperProgress = experimentalStyled(LinearProgress, {
  name: 'MuiMobileStepper',
  slot: 'Progress',
  overridesResolver: function overridesResolver(props, styles) {
