...
var ListItemTextRoot = experimentalStyled('div', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends((_extends2 = {}, _defineProperty(_extends2, "& .".concat(listItemTextClasses.primary), styles.primary), _defineProperty(_extends2, "& .".concat(listItemTextClasses.secondary), styles.secondary), _extends2), styles.root, styleProps.inset && styles.inset, styleProps.primary && styleProps.secondary && styles.multiline, styleProps.dense && styles.dense);
  }
})(function (_ref) {
