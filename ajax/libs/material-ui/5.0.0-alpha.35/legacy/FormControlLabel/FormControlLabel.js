...
export var FormControlLabelRoot = experimentalStyled('label', {
  ...
  overridesResolver: function overridesResolver(props, styles) {
    ...
    return _extends(_defineProperty({}, "& .".concat(formControlLabelClasses.label), styles.label), styles.root, styles["labelPlacement".concat(capitalize(styleProps.labelPlacement))]);
  }
})(function (_ref) {
...
var FormControlLabel = /*#__PURE__*/React.forwardRef(function FormControlLabel(inProps, ref) {
  ...
  var checked = props.checked,
      ...
      value = props.value,
      other = _objectWithoutProperties(props, ["checked", "className", "componentProps", "control", "disabled", "disableTypography", "inputRef", "label", "labelPlacement", "name", "onChange", "value"]);
