...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styles["maxWidth".concat(capitalize(String(styleProps.maxWidth)))], styleProps.fixed && styles.fixed, styleProps.disableGutters && styles.disableGutters));
};
...
var ContainerRoot = experimentalStyled('div', {}, {
  name: 'MuiContainer',
  slot: 'Root',
  ...
  }), styleProps.maxWidth !== 'xs' && _defineProperty({}, theme.breakpoints.up(styleProps.maxWidth), {
