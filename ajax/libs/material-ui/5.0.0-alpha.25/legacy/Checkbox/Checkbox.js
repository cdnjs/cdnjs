...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(styles.root || {}, _extends({}, styleProps.indeterminate && styles.indeterminate, styleProps.color !== 'default' && styles["color".concat(capitalize(styleProps.color))]));
};
...
var useUtilityClasses = function useUtilityClasses(styleProps) {
  ...
  var finalClasses = composeClasses(slots, getCheckboxUtilityClass, classes);
  return _extends({}, classes, finalClasses);
};
