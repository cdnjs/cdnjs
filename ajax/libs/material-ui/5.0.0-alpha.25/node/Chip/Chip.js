...
const ChipRoot = (0, _experimentalStyled.default)('div', {}, {
  ...
  const backgroundColor = theme.palette.mode === 'light' ? theme.palette.grey[300] : theme.palette.grey[700];
  return (0, _extends2.default)({}, styleProps.clickable && {
    userSelect: 'none',
    WebkitTapHighlightColor: 'transparent',
    cursor: 'pointer',
  ...
  [`&.Mui-focusVisible, .${_chipClasses.default.clickable}&:hover`]: {
...
}, styleProps.variant === 'outlined' && styleProps.color === 'primary' && {
...
const Chip = /*#__PURE__*/React.forwardRef(function Chip(inProps, ref) {
  ...
  return /*#__PURE__*/React.createElement(ChipRoot, (0, _extends2.default)({
    as: component,
