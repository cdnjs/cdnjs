...
const useUtilityClasses = styleProps => {
  ...
  const finalClasses = (0, _unstyled.unstable_composeClasses)(slots, _checkboxClasses.getCheckboxUtilityClass, classes);
  return (0, _extends2.default)({}, classes, finalClasses);
};
