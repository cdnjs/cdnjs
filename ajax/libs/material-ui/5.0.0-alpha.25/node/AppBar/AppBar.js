...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)(styles.root || {}, (0, _extends2.default)({}, styles[`position${(0, _capitalize.default)(styleProps.position)}`], styles[`color${(0, _capitalize.default)(styleProps.color)}`]));
};
