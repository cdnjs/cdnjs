...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return _defineProperty({}, "&.".concat(selectClasses.select), _extends({}, styles.root, styles.select, styles.selectMenu, styles[styleProps.variant]));
};

var SelectRoot = experimentalStyled('div', {}, {
  name: 'MuiSelect',
  slot: 'Root',
  overridesResolver: overridesResolver
})(nativeSelectRootStyles, _defineProperty({}, "&.".concat(selectClasses.selectMenu), {
  height: 'auto',
...
var iconOverridesResolver = function iconOverridesResolver(props, styles) {
  var styleProps = props.styleProps;
  return _extends({}, styles.icon, styleProps.variant && styles["icon".concat(capitalize(styleProps.variant))], styleProps.open && styles.iconOpen);
};

var SelectIcon = experimentalStyled('svg', {}, {
  name: 'MuiSelect',
  slot: 'Icon',
  overridesResolver: iconOverridesResolver
})(nativeSelectIconStyles);
var SelectNativeInput = experimentalStyled('input', {}, {
  name: 'MuiSelect',
  slot: 'NativeInput',
