...
var PaginationItemPage = experimentalStyled(ButtonBase, {}, {
  ...
  var _extends4, _$concat;

  var theme = _ref2.theme,
      styleProps = _ref2.styleProps;
  return _extends({}, theme.typography.body2, (_extends4 = {
    borderRadius: 32 / 2,
    textAlign: 'center',
    boxSizing: 'border-box',
    minWidth: 32,
    ...
    margin: '0 3px',
    color: theme.palette.text.primary
  }, _defineProperty(_extends4, "&.".concat(paginationItemClasses.focusVisible), {
    backgroundColor: theme.palette.action.focus
  }), _defineProperty(_extends4, "&.".concat(paginationItemClasses.disabled), {
    opacity: theme.palette.action.disabledOpacity
  }), _extends4), styleProps.type === 'page' && _defineProperty({
