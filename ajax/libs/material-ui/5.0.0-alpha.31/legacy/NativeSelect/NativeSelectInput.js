...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles.select, styles[styleProps.variant]), styles.root || {});
};
...
var iconOverridesResolver = function iconOverridesResolver(props, styles) {
  var styleProps = props.styleProps;
  return deepmerge(_extends({}, styleProps.variant && styles["icon".concat(capitalize(styleProps.variant))], styleProps.open && styles.iconOpen), styles.icon || {});
};
...
var NativeSelectIcon = experimentalStyled('svg', {}, {
  name: 'MuiNativeSelect',
  slot: 'Icon',
  overridesResolver: iconOverridesResolver
