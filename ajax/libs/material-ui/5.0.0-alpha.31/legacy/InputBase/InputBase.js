...
export var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styleProps.formControl && styles.formControl, styleProps.startAdornment && styles.adornedStart, styleProps.endAdornment && styles.adornedEnd, styleProps.error && styles.error, styleProps.size === 'small' && styles.sizeSmall, styleProps.multiline && styles.multiline, styleProps.color && styles["color".concat(capitalize(styleProps.color))], styleProps.fullWidth && styles.fullWidth, styleProps.hiddenLabel && styles.hiddenLabel, _defineProperty({}, "& .".concat(inputBaseClasses.input), _extends({}, styles.input, styleProps.size === 'small' && styles.inputSizeSmall, styleProps.multiline && styles.inputMultiline, styleProps.type === 'search' && styles.inputTypeSearch, styleProps.startAdornment && styles.inputAdornedStart, styleProps.endAdornment && styles.inputAdornedEnd, styleProps.hiddenLabel && styles.inputHiddenLabel))), styles.root || {});
};
...
export var InputBaseComponent = experimentalStyled('input', {}, {
  ...
  }, _defineProperty(_extends4, "label[data-shrink=false] + .".concat(inputBaseClasses.formControl, " &"), {
  ...
  }), _defineProperty(_extends4, "&.".concat(inputBaseClasses.disabled), {
    opacity: 1,
    // Reset iOS opacity
    WebkitTextFillColor: theme.palette.text.disabled // Fix opacity Safari bug

  }), _defineProperty(_extends4, '&:-webkit-autofill', {
    animationDuration: '5000s',
    animationName: 'mui-auto-fill'
  }), _extends4), styleProps.size === 'small' && {
    paddingTop: 1
