...
export var FormLabelRoot = experimentalStyled('label', {}, {
  ...
  return _extends({
    ...
    lineHeight: '1.4375em',
    padding: 0
  }, _defineProperty(_extends3, "&.".concat(formLabelClasses.focused), {
    color: theme.palette[styleProps.color].main
  }), _defineProperty(_extends3, "&.".concat(formLabelClasses.disabled), {
    color: theme.palette.text.disabled
  }), _defineProperty(_extends3, "&.".concat(formLabelClasses.error), {
