...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styleProps.orientation === 'vertical' && styles.vertical, styleProps.fullWidth && styles.fullWidth, _defineProperty({}, "& .".concat(toggleButtonGroupClasses.grouped), _extends({}, styles.grouped, styles["grouped".concat(capitalize(styleProps.orientation))]))), styles.root || {});
};
