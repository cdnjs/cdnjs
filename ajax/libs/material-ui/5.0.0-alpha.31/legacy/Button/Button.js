...
var ButtonRoot = experimentalStyled(ButtonBase, {
  ...
  return _extends({}, theme.typography.button, (_extends3 = {
    minWidth: 64,
    padding: '6px 16px',
  ...
  }, _defineProperty(_extends3, "&.".concat(buttonClasses.focusVisible), _extends({}, styleProps.variant === 'contained' && {
    boxShadow: theme.shadows[6]
  })), _defineProperty(_extends3, "&.".concat(buttonClasses.disabled), _extends({
  ...
  })), _extends3), styleProps.variant === 'text' && {
    padding: '6px 8px'
  }, styleProps.variant === 'text' && styleProps.color !== 'inherit' && {
