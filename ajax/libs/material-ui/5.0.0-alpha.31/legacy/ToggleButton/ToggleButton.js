...
var ToggleButtonRoot = experimentalStyled(ButtonBase, {}, {
  ...
  return _extends({}, theme.typography.button, {
    ...
    width: '100%'
  }, (_extends3 = {}, _defineProperty(_extends3, "&.".concat(toggleButtonClasses.disabled), {
  ...
  }), _extends3), styleProps.color === 'standard' && _defineProperty({}, "&.".concat(toggleButtonClasses.selected), {
  ...
  }), styleProps.color !== 'standard' && _defineProperty({}, "&.".concat(toggleButtonClasses.selected), {
