...
var overridesResolver = function overridesResolver(props, styles) {
  ...
  return deepmerge(_extends({}, styles["position".concat(capitalize(styleProps.position))], (_extends2 = {}, _defineProperty(_extends2, "& .".concat(mobileStepperClasses.dots), styles.dots), _defineProperty(_extends2, "& .".concat(mobileStepperClasses.dot), _extends({}, styles.dot, styleProps.dotActive && styles.dotActive)), _defineProperty(_extends2, "& .".concat(mobileStepperClasses.dotActive), styles.dotActive), _defineProperty(_extends2, "& .".concat(mobileStepperClasses.progress), styles.progress), _extends2)), styles.root || {});
};
