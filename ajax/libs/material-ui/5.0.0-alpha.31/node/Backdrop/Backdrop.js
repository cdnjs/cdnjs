...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styleProps.invisible && styles.invisible), styles.root || {});
};
...
const Backdrop = /*#__PURE__*/React.forwardRef(function Backdrop(inProps, ref) {
  ...
  const {
    ...
    TransitionComponent = _Fade.default
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "components", "componentsProps", "className", "invisible", "open", "transitionDuration", "TransitionComponent"]);
