...
exports.default = exports.InputBaseComponent = exports.InputBaseRoot = exports.overridesResolver = void 0;
...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styleProps.formControl && styles.formControl, styleProps.startAdornment && styles.adornedStart, styleProps.endAdornment && styles.adornedEnd, styleProps.error && styles.error, styleProps.size === 'small' && styles.sizeSmall, styleProps.multiline && styles.multiline, styleProps.color && styles[`color${(0, _capitalize.default)(styleProps.color)}`], styleProps.fullWidth && styles.fullWidth, styleProps.hiddenLabel && styles.hiddenLabel, {
    [`& .${_inputBaseClasses.default.input}`]: (0, _extends2.default)({}, styles.input, styleProps.size === 'small' && styles.inputSizeSmall, styleProps.multiline && styles.inputMultiline, styleProps.type === 'search' && styles.inputTypeSearch, styleProps.startAdornment && styles.inputAdornedStart, styleProps.endAdornment && styles.inputAdornedEnd, styleProps.hiddenLabel && styles.inputHiddenLabel)
  }), styles.root || {});
};
...
const InputBaseRoot = (0, _experimentalStyled.default)('div', {}, {
  name: 'MuiInputBase',
  slot: 'Root',
  overridesResolver
})(({
...
const InputBaseComponent = (0, _experimentalStyled.default)('input', {}, {
  name: 'MuiInputBase',
  slot: 'Input'
})(({
  theme,
