...
const IconRoot = (0, _experimentalStyled.default)('span', {}, {
  name: 'MuiIcon',
  slot: 'Root',
  overridesResolver
})(({
...
const Icon = /*#__PURE__*/React.forwardRef(function Icon(inProps, ref) {
  ...
  const {
    ...
    fontSize = 'medium'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["baseClassName", "className", "color", "component", "fontSize"]);
