...
const TextFieldRoot = (0, _experimentalStyled.default)(_FormControl.default, {}, {
  name: 'MuiTextField',
  slot: 'Root',
  overridesResolver
})({});
...
const TextField = /*#__PURE__*/React.forwardRef(function TextField(inProps, ref) {
  ...
  const {
    ...
    variant = 'outlined'
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["autoComplete", "autoFocus", "children", "className", "color", "defaultValue", "disabled", "error", "FormHelperTextProps", "fullWidth", "helperText", "id", "InputLabelProps", "inputProps", "InputProps", "inputRef", "label", "maxRows", "minRows", "multiline", "name", "onBlur", "onChange", "onFocus", "placeholder", "required", "rows", "select", "SelectProps", "type", "value", "variant"]);
