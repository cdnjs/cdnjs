...
const overridesResolver = (props, styles) => {
  return (0, _utils.deepmerge)(styles.root || {}, {
    [`& .${_popoverClasses.default.paper}`]: styles.paper
  });
};
...
const PopoverRoot = (0, _experimentalStyled.default)(_Modal.default, {}, {
  name: 'MuiPopover',
  slot: 'Root',
  overridesResolver
})({});
const PopoverPaper = (0, _experimentalStyled.default)(_Paper.default, {}, {
  name: 'MuiPopover',
  slot: 'Paper'
})({
  position: 'absolute',
  ...
  const {
    ...
    TransitionProps: {
      onEntering
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["action", "anchorEl", "anchorOrigin", "anchorPosition", "anchorReference", "children", "className", "container", "elevation", "marginThreshold", "open", "PaperProps", "transformOrigin", "TransitionComponent", "transitionDuration", "TransitionProps"]);
