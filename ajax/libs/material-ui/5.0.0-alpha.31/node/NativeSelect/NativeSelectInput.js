...
exports.default = exports.nativeSelectIconStyles = exports.nativeSelectRootStyles = void 0;
...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles.select, styles[styleProps.variant]), styles.root || {});
};
...
exports.nativeSelectRootStyles = nativeSelectRootStyles;
const NativeSelectRoot = (0, _experimentalStyled.default)('select', {}, {
...
const iconOverridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styleProps.variant && styles[`icon${(0, _capitalize.default)(styleProps.variant)}`], styleProps.open && styles.iconOpen), styles.icon || {});
};
...
const NativeSelectInput = /*#__PURE__*/React.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(NativeSelectRoot, (0, _extends2.default)({
