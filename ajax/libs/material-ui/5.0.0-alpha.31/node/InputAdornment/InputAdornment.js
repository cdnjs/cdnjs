...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`position${(0, _capitalize.default)(styleProps.position)}`], styleProps.disablePointerEvents === true && styles.disablePointerEvents, styleProps.variant === 'filled' && styles.filled), styles.root || {});
};
...
const InputAdornmentRoot = (0, _experimentalStyled.default)('div', {}, {
...
const InputAdornment = /*#__PURE__*/React.forwardRef(function InputAdornment(inProps, ref) {
  ...
  const {
    ...
    variant: variantProp
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(props, ["children", "className", "component", "disablePointerEvents", "disableTypography", "position", "variant"]);
