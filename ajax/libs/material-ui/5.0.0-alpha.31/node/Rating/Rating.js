...
const overridesResolver = (props, styles) => {
  ...
  return (0, _utils.deepmerge)((0, _extends2.default)({}, styles[`size${(0, _utils2.capitalize)(styleProps.size)}`], styleProps.readOnly && styles.readOnly, {
    [`& .${_ratingClasses.default.label}`]: styles.label,
    [`& .${_ratingClasses.default.icon}`]: styles.icon,
    [`& .${_ratingClasses.default.iconEmpty}`]: styles.iconEmpty,
    [`& .${_ratingClasses.default.iconFilled}`]: styles.iconFilled,
    [`& .${_ratingClasses.default.iconHover}`]: styles.iconHover,
    [`& .${_ratingClasses.default.iconFocus}`]: styles.iconFocus,
    [`& .${_ratingClasses.default.iconActive}`]: styles.iconActive,
    [`& .${_ratingClasses.default.decimal}`]: styles.decimal,
