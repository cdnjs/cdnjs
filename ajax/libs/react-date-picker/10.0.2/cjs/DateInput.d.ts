...
declare function DateInput({ autoFocus, className, dayAriaLabel, dayPlaceholder, disabled, format, isCalendarOpen: isCalendarOpenProps, locale, maxDate, maxDetail, minDate, monthAriaLabel, monthPlaceholder, name, nativeInputAriaLabel, onChange: onChangeProps, required, returnValue, showLeadingZeros, value: valueProps, yearAriaLabel, yearPlaceholder, }: DateInputProps): JSX.Element;
