...
const DayInput_js_1 = __importDefault(require("./DateInput/DayInput.js"));
const MonthInput_js_1 = __importDefault(require("./DateInput/MonthInput.js"));
const MonthSelect_js_1 = __importDefault(require("./DateInput/MonthSelect.js"));
const NativeInput_js_1 = __importDefault(require("./DateInput/NativeInput.js"));
const YearInput_js_1 = __importDefault(require("./DateInput/YearInput.js"));
const Divider_js_1 = __importDefault(require("./Divider.js"));
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
    ...
    return placeholder.split(pattern).reduce((arr, element, index) => {
        ...
        (0, jsx_runtime_1.jsx)(Divider_js_1.default, { children: element }, `separator_${index}`));
        arr.push(divider);
...
function DateInput({ autoFocus, className, dayAriaLabel, dayPlaceholder, disabled, format, isCalendarOpen: isCalendarOpenProps = null, locale, maxDate, maxDetail = 'month', minDate, monthAriaLabel, monthPlaceholder, name = 'date', nativeInputAriaLabel, onChange: onChangeProps, onInvalidChange, required, returnValue = 'start', showLeadingZeros, value: valueProps, yearAriaLabel, yearPlaceholder, }) {
    ...
    const [month, setMonth] = (0, react_1.useState)(null);
    const [day, setDay] = (0, react_1.useState)(null);
    const [value, setValue] = (0, react_1.useState)(null);
    const yearInput = (0, react_1.useRef)(null);
    const monthInput = (0, react_1.useRef)(null);
    const monthSelect = (0, react_1.useRef)(null);
    const dayInput = (0, react_1.useRef)(null);
    const [isCalendarOpen, setIsCalendarOpen] = (0, react_1.useState)(isCalendarOpenProps);
    const lastPressedKey = (0, react_1.useRef)(undefined);
    (0, react_1.useEffect)(() => {
    ...
    function renderDay(currentMatch, index) {
        ...
        return ((0, jsx_runtime_1.jsx)(DayInput_js_1.default, { ...commonInputProps, ariaLabel: dayAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: dayInput, month: month, placeholder: dayPlaceholder, showLeadingZeros: showLeadingZerosFromFormat || showLeadingZeros, value: day, year: year }, "day"));
    }
    function renderMonth(currentMatch, index) {
        ...
        if (currentMatch.length > 2) {
            return ((0, jsx_runtime_1.jsx)(MonthSelect_js_1.default, { ...commonInputProps, ariaLabel: monthAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: monthSelect, locale: locale, placeholder: monthPlaceholder, short: currentMatch.length === 3, value: month, year: year }, "month"));
        }
        const showLeadingZerosFromFormat = currentMatch && currentMatch.length === 2;
        return ((0, jsx_runtime_1.jsx)(MonthInput_js_1.default, { ...commonInputProps, ariaLabel: monthAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: monthInput, placeholder: monthPlaceholder, showLeadingZeros: showLeadingZerosFromFormat || showLeadingZeros, value: month, year: year }, "month"));
    }
    function renderYear(_currentMatch, index) {
        return ((0, jsx_runtime_1.jsx)(YearInput_js_1.default, { ...commonInputProps, ariaLabel: yearAriaLabel, autoFocus: index === 0 && autoFocus, inputRef: yearInput, placeholder: yearPlaceholder, value: year, valueType: valueType }, "year"));
    }
