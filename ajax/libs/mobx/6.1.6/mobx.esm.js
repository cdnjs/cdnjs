...
var ComputedValue = /*#__PURE__*/function () {
  ...
  function ComputedValue(options) {
    ...
    this.name_ = process.env.NODE_ENV !== "production" ? options.name || "ComputedValue@" + getNextId() : "ComputedValue";
...
function autorun(view, opts) {
  ...
  var name = process.env.NODE_ENV !== "production" ? opts && opts.name || view.name || "Autorun@" + getNextId() : "Autorun";
...
function reaction(expression, effect, opts) {
  ...
  var name = process.env.NODE_ENV !== "production" ? opts.name || "Reaction@" + getNextId() : "Reaction";
...
var ObservableArrayAdministration = /*#__PURE__*/function () {
  ...
  function ObservableArrayAdministration(name, enhancer, owned_, legacyMode_) {
    ...
    this.atom_ = new Atom(process.env.NODE_ENV !== "production" ? name || "ObservableArray@" + getNextId() : "ObservableArray");
...
var ObservableMap = /*#__PURE__*/function () {
  ...
  _proto.has = function has(key) {
    ...
    if (!entry) {
      var newEntry = entry = new ObservableValue(this.has_(key), referenceEnhancer, process.env.NODE_ENV !== "production" ? this.name_ + "." + stringifyKey(key) + "?" : "ObservableValue.key?", false);
  ...
  _proto.addValue_ = function addValue_(key, newValue) {
    ...
    checkIfStateModificationsAreAllowed(this.keysAtom_);
    transaction(function () {
      var observable = new ObservableValue(newValue, _this3.enhancer_, process.env.NODE_ENV !== "production" ? _this3.name_ + "." + stringifyKey(key) : "ObservableValue.key", false);
...
var ObservableObjectAdministration = /*#__PURE__*/function () {
  ...
  autoBind_) {
    ...
    this.keysAtom_ = new Atom(process.env.NODE_ENV !== "production" ? name_ + ".keys" : "ObservableObject.keys"); // Optimization: we use this frequently
  ...
  _proto.has_ = function has_(key) {
    ...
    if (!entry) {
      entry = new ObservableValue(key in this.target_, referenceEnhancer, process.env.NODE_ENV !== "production" ? this.name_ + "." + stringifyKey(key) + "?" : "ObservableValue.key?", false);
...
function asObservableObject(target, options) {
  ...
  var name = process.env.NODE_ENV !== "production" ? (_options$name = options == null ? void 0 : options.name) != null ? _options$name : (isPlainObject(target) ? "ObservableObject" : target.constructor.name) + "@" + getNextId() : "ObservableObject";
