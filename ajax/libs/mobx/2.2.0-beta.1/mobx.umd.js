...
function trackDerivedFunction(derivation, f) {
    ...
    try {
        ...
        if (hasException) {
            var message = ("[mobx] An uncaught exception occurred while calculating your computed value, autorun or transformer. Or inside the render method of a React component. " +
