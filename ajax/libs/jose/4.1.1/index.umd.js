(function (global, factory) {
  ...
  function isNodeJs() {
    var _a, _b;
    try {
      return ((_b = (_a = getGlobal().process) === null || _a === void 0 ? void 0 : _a.versions) === null || _b === void 0 ? void 0 : _b.node) !== void 0;
    } catch (_c) {
      return false;
    }
  }
  ...
  var decodeBase64 = (encoded) => {
    return new Uint8Array(global_default.atob(encoded).split("").map((c) => c.charCodeAt(0)));
  };
  var decode = (input) => {
    let encoded = input;
  ...
  function isCryptoKey(key) {
    ...
    return key != null && key instanceof global_default.CryptoKey;
  }
...
-----END ${descriptor}-----`;
  ...
  var genericImport = async (replace, keyFormat, pem, alg, options) => {
    ...
    let algorithm;
    let keyUsages;
    const keyData = new Uint8Array(global_default.atob(pem.replace(replace, "")).split("").map((c) => c.charCodeAt(0)));
  ...
  var fetchJwks = async (url, timeout) => {
    ...
    const response = await global_default.fetch(url.href, {
