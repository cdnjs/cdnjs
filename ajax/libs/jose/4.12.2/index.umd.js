...
-----END ${descriptor}-----`;
  ...
  var genericImport = async (replace, keyFormat, pem, alg, options) => {
    ...
    try {
      return await webcrypto_default.subtle.importKey(keyFormat, keyData, algorithm, (_a = options === null || options === void 0 ? void 0 : options.extractable) !== null && _a !== void 0 ? _a : false, keyUsages);
    } catch (err) {
      if (algorithm.name === "Ed25519" && (err === null || err === void 0 ? void 0 : err.name) === "NotSupportedError" && isCloudflareWorkers()) {
        algorithm = { name: "NODE-ED25519", namedCurve: "NODE-ED25519" };
        return await webcrypto_default.subtle.importKey(keyFormat, keyData, algorithm, (_b = options === null || options === void 0 ? void 0 : options.extractable) !== null && _b !== void 0 ? _b : false, keyUsages);
      }
      throw err;
    }
  };
  ...
  var parse = async (jwk) => {
    ...
    delete keyData.use;
    try {
      return await webcrypto_default.subtle.importKey("jwk", keyData, ...rest);
    } catch (err) {
      if (algorithm.name === "Ed25519" && (err === null || err === void 0 ? void 0 : err.name) === "NotSupportedError" && isCloudflareWorkers()) {
  ...
  async function generateKeyPair(alg, options) {
    ...
    try {
      return await webcrypto_default.subtle.generateKey(algorithm, (_c = options === null || options === void 0 ? void 0 : options.extractable) !== null && _c !== void 0 ? _c : false, keyUsages);
    } catch (err) {
      if (algorithm.name === "Ed25519" && (err === null || err === void 0 ? void 0 : err.name) === "NotSupportedError" && isCloudflareWorkers()) {
        algorithm = { name: "NODE-ED25519", namedCurve: "NODE-ED25519" };
        return await webcrypto_default.subtle.generateKey(algorithm, (_d = options === null || options === void 0 ? void 0 : options.extractable) !== null && _d !== void 0 ? _d : false, keyUsages);
      }
      throw err;
    }
  }
