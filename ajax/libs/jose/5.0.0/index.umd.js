...
-----END ${descriptor}-----`;
  ...
  var genericImport = async (replace, keyFormat, pem, alg, options) => {
    ...
    return webcrypto_default.subtle.importKey(keyFormat, keyData, algorithm, (_a = options == null ? void 0 : options.extractable) != null ? _a : false, keyUsages);
  };
  ...
  var parse = async (jwk) => {
    ...
    const rest = [
      algorithm,
      (_a = jwk.ext) != null ? _a : false,
      (_b = jwk.key_ops) != null ? _b : keyUsages
    ];
    const keyData = { ...jwk };
    delete keyData.alg;
    delete keyData.use;
  ...
  async function flattenedDecrypt(jwe, key, options) {
    ...
    const protectedHeader = encoder.encode((_a = jwe.protected) != null ? _a : "");
    let additionalData;
    if (jwe.aad !== void 0) {
  ...
  var GeneralEncrypt = class {
    ...
    async encrypt() {
      ...
      for (let i = 0; i < this._recipients.length; i++) {
        ...
        const { encryptedKey, parameters } = await encrypt_key_management_default(((_a = recipient.unprotectedHeader) == null ? void 0 : _a.alg) || ((_b = this._protectedHeader) == null ? void 0 : _b.alg) || ((_c = this._unprotectedHeader) == null ? void 0 : _c.alg), enc, recipient.key, cek, { p2c });
  ...
  async function flattenedVerify(jws, key, options) {
    ...
    const data = concat(encoder.encode((_a = jws.protected) != null ? _a : ""), encoder.encode("."), typeof jws.payload === "string" ? encoder.encode(jws.payload) : jws.payload);
    let signature;
    try {
  ...
  async function calculateJwkThumbprint(jwk, digestAlgorithm) {
    ...
    digestAlgorithm != null ? digestAlgorithm : digestAlgorithm = "sha256";
  ...
  async function generateSecret(alg, options) {
    ...
    return webcrypto_default.subtle.generateKey(algorithm, (_a = options == null ? void 0 : options.extractable) != null ? _a : false, keyUsages);
  }
  function getModulusLengthOption(options) {
    var _a;
    const modulusLength = (_a = options == null ? void 0 : options.modulusLength) != null ? _a : 2048;
    if (typeof modulusLength !== "number" || modulusLength < 2048) {
  ...
  async function generateKeyPair(alg, options) {
    ...
    switch (alg) {
      ...
      case "EdDSA":
        keyUsages = ["sign", "verify"];
        const crv = (_a = options == null ? void 0 : options.crv) != null ? _a : "Ed25519";
        switch (crv) {
          case "Ed25519":
          case "Ed448":
            algorithm = { name: crv };
      ...
      case "ECDH-ES+A256KW": {
        ...
        const crv2 = (_b = options == null ? void 0 : options.crv) != null ? _b : "P-256";
        switch (crv2) {
          case "P-256":
          case "P-384":
          case "P-521": {
    ...
    return webcrypto_default.subtle.generateKey(algorithm, (_c = options == null ? void 0 : options.extractable) != null ? _c : false, keyUsages);
  }
