 ...
 */
export declare function createNode(nodeName: string, isSvg: boolean): ExtendedElement;
/**
 ...
 * @private
 */
export declare function setAccessor(node: ExtendedElement, name: string, old: any, value: any, isSvg: boolean): void;
