(function (global, factory) {
  ...
  */
  ...
  var _excluded$f = ["activeIndex", "id", "isFocused", "isMenuShown", "multiple", "onClick", "onFocus"],
  ...
  var _excluded$b = ["label", "onClick", "option", "position"];
  ...
  var _excluded$9 = ["defaultInputValue", "defaultOpen", "defaultSelected", "labelKey", "maxResults", "multiple"];
  ...
  function useTypeahead(_ref, ref) {
    var onChange = _ref.onChange,
      partialProps = _objectWithoutProperties(_ref, _excluded$8);
    ...
    if (isMenuShown) {
      ...
      var shouldPaginate = paginate && results.length > state.shownResults;
    ...
    function onClick(e) {
      ...
      var handleClick = (_props$inputProps = props.inputProps) === null || _props$inputProps === undefined ? undefined : _props$inputProps.onClick;
    ...
    function onPaginate(e) {
      setState(function (currentState) {
        ...
        return props.onPaginate(e, newState.shownResults);
      });
    }
    function onMenuItemSelect(option, e) {
  ...
  var _excluded$7 = ["className", "label", "onClick", "onKeyDown", "size"];
  /**
   * ClearButton
   */
  ...
  var Typeahead = /*#__PURE__*/React.forwardRef(function (props, ref) {
    var _useTypeahead = useTypeahead(props, ref),
      ...
      rest = _objectWithoutProperties(_useTypeahead, _excluded);
  ...
  var AsyncTypeahead = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(Typeahead, _extends({}, useAsync(props), {
      ref: ref
    }));
  });
