(function (global, factory) {
  ...
  */
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  var sizeValues = ['large', 'lg', 'small', 'sm'];
  ...
  var sizeType = PropTypes.oneOf(sizeValues);
  ...
  var _excluded$e = ["allowNew", "delay", "emptyLabel", "isLoading", "minLength", "onInputChange", "onSearch", "options", "promptText", "searchText", "useCache"];
  var propTypes$a = {
    /**
    ...
    _createClass(Typeahead, [{
      ...
      value: function render() {
        var _this$props4 = this.props;
            ...
            var props = _objectWithoutProperties(_this$props4, _excluded$d);
  ...
  var _excluded$c = ["className", "label", "onClick", "onKeyDown", "size"];
  var propTypes$8 = {
  ...
  */
  ...
  var _excluded$b = ["referenceElement"];
  ...
  var _excluded$a = ["onBlur", "onClick", "onFocus", "onRemove", "option"];
  var propTypes$5 = {
    onBlur: PropTypes.func,
    onClick: PropTypes.func,
    onFocus: PropTypes.func,
  ...
  var _excluded$9 = ["active", "children", "className", "onRemove", "tabIndex"],
      _excluded2 = ["readOnly"],
      _excluded3 = ["ref"];
  ...
  var _excluded$6 = ["children", "className", "inputClassName", "inputRef", "placeholder", "referenceElementRef", "selected", "shouldSelectHint"];
  ...
  var _excluded$5 = ["inputRef", "referenceElementRef", "shouldSelectHint"];
