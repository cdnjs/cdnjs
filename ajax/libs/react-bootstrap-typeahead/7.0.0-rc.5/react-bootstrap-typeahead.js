(function (global, factory) {
  ...
  var _excluded$h = ["allowNew", "labelKey"];
  function addCustomOption(results, _ref) {
    var allowNew = _ref.allowNew,
      labelKey = _ref.labelKey,
      state = _objectWithoutProperties(_ref, _excluded$h);
  ...
  */
  ...
  var _excluded$g = ["activeIndex", "id", "isFocused", "isMenuShown", "multiple", "onClick", "onFocus"],
  ...
  var _excluded$d = ["defaultInputValue", "defaultOpen", "defaultSelected", "labelKey", "multiple"];
  ...
  function useValidateProps(_ref) {
    ...
    React.useEffect(function () {
      ...
      warn(!caseSensitive || !isFunction(filterBy), 'Your `filterBy` function will override the `caseSensitive` prop.');
      warn(!ignoreDiacritics || !isFunction(filterBy), 'Your `filterBy` function will override the `ignoreDiacritics` prop.');
  ...
  function useTypeahead(userProps, ref) {
    useValidateProps(userProps);
    var onChange = userProps.onChange,
      partialProps = _objectWithoutProperties(userProps, _excluded$c);
  ...
  var _excluded$b = ["allowNew", "delay", "isLoading", "minLength", "onInputChange", "onSearch", "options", "useCache"];
  /**
  ...
  var _excluded$a = ["label", "option", "position"];
  ...
  function useToken(_ref) {
    ...
    var handleClick = function handleClick(e) {
      setActive(true);
      onClick === null || onClick === undefined || onClick(e);
    };
    ...
    var handleRemove = function handleRemove() {
      onRemove === null || onRemove === undefined || onRemove(option);
    };
  ...
  var Token = function Token(_ref3) {
    ...
    var tokenProps = useToken(_objectSpread2(_objectSpread2({}, props), {}, {
      option: option
    }));
    var child = /*#__PURE__*/React.createElement("div", {
      className: "rbt-token-label"
    }, children);
    return !props.disabled && !readOnly && isFunction(tokenProps.onRemove) ? /*#__PURE__*/React.createElement(InteractiveToken, _extends({}, props, tokenProps), child) : /*#__PURE__*/React.createElement(StaticToken, props, child);
  };
  ...
  var Menu = function Menu(_ref) {
    ...
    var children = React.Children.toArray(props.children).filter(Boolean).length ? props.children : /*#__PURE__*/React.createElement(BaseMenuItem, {
      disabled: true,
      role: "option"
    }, emptyLabel);
  ...
  exports.useTypeaheadState = useTypeaheadState;
