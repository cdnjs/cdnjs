(function (global, factory) {
  ...
  */
  ...
  var _excluded$e = ["defaultInputValue", "defaultOpen", "defaultSelected", "labelKey", "multiple"];
  ...
  function useTypeahead(_ref, ref) {
    var onChange = _ref.onChange,
      partialProps = _objectWithoutProperties(_ref, _excluded$d);
  ...
  var _excluded$c = ["allowNew", "delay", "isLoading", "minLength", "onInputChange", "onSearch", "options", "useCache"];
  /**
  ...
  var _excluded$b = ["label", "option", "position"];
