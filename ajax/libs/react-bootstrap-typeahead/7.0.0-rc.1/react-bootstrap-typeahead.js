(function (global, factory) {
  ...
  */
  ...
  var _excluded$b = ["allowNew", "delay", "emptyLabel", "isLoading", "minLength", "onInputChange", "onSearch", "options", "promptText", "searchText", "useCache"];
  /**
  ...
  var _excluded$a = ["defaultInputValue", "defaultOpen", "defaultSelected", "labelKey", "maxResults", "multiple"];
  ...
  function useTypeahead(_ref, ref) {
    var onChange = _ref.onChange,
      partialProps = _objectWithoutProperties(_ref, _excluded$9);
  ...
  var _excluded$8 = ["className", "label", "onClick", "onKeyDown", "size"];
  var propTypes$5 = {
  ...
  ClearButton.propTypes = propTypes$5;
  ...
  function Typeahead(props) {
    var children = props.children,
      ...
      results = props.results,
      size = props.size;
    var rootElementRef = useRootClose(props.hideMenu, {
    ...
    var menuProps = _objectSpread2(_objectSpread2({}, overlayProps), {}, {
    ...
    function renderInput() {
      var inputProps = _objectSpread2(_objectSpread2({}, props.getInputProps(props.inputProps)), {}, {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      tabIndex: -1
    }, renderInput(), props.isMenuShown && renderMenu(results, menuProps, props), auxContent && /*#__PURE__*/React.createElement("div", {
  ...
  var TypeaheadExport = /*#__PURE__*/React.forwardRef(function (props, ref) {
    var typeaheadProps = useTypeahead(props, ref);
    return /*#__PURE__*/React.createElement(TypeaheadManager, typeaheadProps, function (managerProps) {
      return /*#__PURE__*/React.createElement(Typeahead, _extends({}, props, managerProps));
    });
  });

  var AsyncTypeahead = /*#__PURE__*/React.forwardRef(function (props, ref) {
    return /*#__PURE__*/React.createElement(TypeaheadExport, _extends({}, useAsync(props), {
      ref: ref
    }));
  });
  ...
  exports.Token = Token;
  exports.Typeahead = TypeaheadExport;
