	...
	(function(root) {
	  ...
	  function setupBinding(root, factory) {
	    if (true) {
	      ...
	      !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1),__webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function(React, ReactDom) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactOnclickoutside = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Typeahead = _react2['default'].createClass({
	  ...
	  _renderInput: function _renderInput(filteredOptions) {
	    ...
	    var Input = multiple ? _TokenizerInputReact2['default'] : _TypeaheadInputReact2['default'];
	  ...
	  _renderMenu: function _renderMenu(filteredOptions) {
	    ...
	    return _react2['default'].createElement(_TypeaheadMenuReact2['default'], _extends({}, menuProps, {
	      activeIndex: activeIndex,
	  ...
	  _hideDropdown: function _hideDropdown() {
	    ...
	    var showMenu = _getInitialState2.showMenu;
