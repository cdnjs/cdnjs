...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    return (
      React.createElement("div", {className: classes, ref: "overlay", onClick: this.handleOverlayClick}, 
        React.createElement("div", {className: "overlay-top"}, 
          React.createElement("div", {className: "overlay-close", title: "close", onClick: this.handleCloseBtnClick}, "x")
        ), 
