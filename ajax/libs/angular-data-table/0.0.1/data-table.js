...
System.register("github:angular/bower-angular@1.4.0/angular", [], false, function(__require, __exports, __module) {
...
System.register("utils/throttle", ["github:angular/bower-angular@1.4.0"], function(_export) {
  'use strict';
  var angular;
  ...
  return {
    ...
    execute: function() {
      ;
      ;
      _export('default', angular.module('utils.throttle', []).constant('debounce', debounce).constant('throttle', throttle));
    }
  };
});

System.register("directives/footer/pager", [], function(_export) {
  'use strict';
  var pagerConfig,
      paginationConfig;
...
System.register("utils/dropdown", ["github:angular/bower-angular@1.4.0"], function(_export) {
  'use strict';
  var angular,
      DropdownController;
...
System.register("utils/sortable", ["github:angular/bower-angular@1.4.0"], function(_export) {
  'use strict';
  var angular;
...
System.register("directives/header/header", ["github:angular/bower-angular@1.4.0", "utils/sortable"], function(_export) {
  'use strict';
  var angular,
      Sortable,
      HeaderController;
...
System.register("directives/header/header-cell", ["github:angular/bower-angular@1.4.0", "utils/resizable"], function(_export) {
  'use strict';
  var angular,
      Resizable,
...
System.register("directives/body/row", ["github:angular/bower-angular@1.4.0", "utils/utils"], function(_export) {
  'use strict';
  var angular,
      DeepValueGetter,
      RowController;
...
System.register("directives/body/cell", ["github:angular/bower-angular@1.4.0"], function(_export) {
  'use strict';
  var angular,
      CellController;
  var _createClass = (function() {
...
System.register("directives/footer/footer", ["github:angular/bower-angular@1.4.0"], function(_export) {
  'use strict';
  var angular,
      FooterController;
  var _createClass = (function() {
...
System.register("github:angular/bower-angular@1.4.0", ["github:angular/bower-angular@1.4.0/angular"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("github:angular/bower-angular@1.4.0/angular");
  global.define = __define;
  return module.exports;
});

System.register("directives/menu/menu", ["github:angular/bower-angular@1.4.0", "utils/dropdown"], function(_export) {
  'use strict';
  var angular,
      Dropdown,
      DataTableMenuController;
  var _createClass = (function() {
    function defineProperties(target, props) {
      for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
  ...
  return {
    setters: [function(_angular) {
      angular = _angular['default'];
    }, function(_utilsDropdown) {
      Dropdown = _utilsDropdown['default'];
    }],
    execute: function() {
...
System.register("utils/math", ["github:angular/bower-angular@1.4.0", "utils/utils"], function(_export) {
  'use strict';
  var angular,
      ColumnsByPin;
...
System.register("directives/body/body", ["github:angular/bower-angular@1.4.0", "utils/utils", "utils/keys"], function(_export) {
  'use strict';
  var angular,
      requestAnimFrame,
      ColumnsByPin,
      ...
      BodyController = (function() {
          ...
          $scope.$watchCollection('values', function(newVal, oldVal) {
            if (newVal) {
              ...
              if (_this.options.scrollbarV) {
                ...
                (_rows = _this.rows).push.apply(_rows, _toConsumableArray($scope.values));
              }
            }
          });
          if (this.options.scrollbarV) {
        ...
        _createClass(BodyController, [{
          ...
          value: function buildRowsByGroup() {
            ...
            this.index = {};
            this.rowsByGroup = {};
            this.$scope.values.forEach(function(row) {
              var relVal = row[parentProp];
              if (relVal) {
                if (_this2.rowsByGroup[relVal]) {
                  _this2.rowsByGroup[relVal].push(row);
                } else {
                  _this2.rowsByGroup[relVal] = [row];
                }
              }
              _this2.index[row[prop]] = row;
              if (row[parentProp] === undefined) {
                row.$$depth = 0;
              } else {
                var parent = _this2.index[row[parentProp]];
          ...
          value: function getRows() {
            ...
            var rowIndex = indexes.first,
                idx = 0;
            while (rowIndex < indexes.last || this.options.internal.bodyHeight < this._viewportHeight && rowIndex < this.options.paging.count) {
          ...
          value: function rowStyles(scope, row) {
            if (this.options.scrollbarV) {
              return {transform: 'translate3d(0, ' + row.$$index * scope.options.rowHeight + 'px, 0)'};
            }
          }
        }, {
          key: 'rowClasses',
          ...
          value: function selectRowsBetween(index) {
            ...
            this.rows.forEach(function(row, i) {
              if (i >= _this3.prevIndex && i <= index) {
                var idx = _this3.selected.indexOf(row);
                if (idx === -1) {
                  _this3.selected.push(row);
                }
              }
            });
          }
          ...
          value: function scrollerStyles() {
            return {height: this.options.paging.count * this.options.rowHeight + 'px'};
          }
        }, {
          key: 'getRowValue',
...
System.register("data-table", ["github:angular/bower-angular@1.4.0", "utils/polyfill", "utils/throttle", "directives/footer/pager", "directives/menu/menu", "utils/resizable", "utils/sortable", "utils/math", "utils/utils", "defaults", "directives/header/header", "directives/header/header-cell", "directives/body/body", "directives/body/row", "directives/body/cell", "directives/footer/footer", "data-table.css!github:systemjs/plugin-css@0.1.10"], function(_export) {
  'use strict';
  var angular,
      Throttle,
      Pager,
  ...
  return {
    setters: [function(_angular) {
      ...
      Throttle = _utilsThrottle['default'];
    }, function(_directivesFooterPager) {
      Pager = _directivesFooterPager['default'];
    }, function(_directivesMenuMenu) {
      ColumnMenu = _directivesMenuMenu['default'];
    }, function(_utilsResizable) {
      Resizable = _utilsResizable.Resizable;
    }, function(_utilsSortable) {
      Sortable = _utilsSortable.Sortable;
    ...
    }, function(_directivesHeaderHeader) {
      HeaderController = _directivesHeaderHeader.HeaderController;
      HeaderDirective = _directivesHeaderHeader.HeaderDirective;
    }, function(_directivesHeaderHeaderCell) {
      HeaderCellDirective = _directivesHeaderHeaderCell.HeaderCellDirective;
      HeaderCellController = _directivesHeaderHeaderCell.HeaderCellController;
    }, function(_directivesBodyBody) {
      BodyController = _directivesBodyBody.BodyController;
      BodyHelper = _directivesBodyBody.BodyHelper;
      BodyDirective = _directivesBodyBody.BodyDirective;
    }, function(_directivesBodyRow) {
      RowController = _directivesBodyRow.RowController;
      RowDirective = _directivesBodyRow.RowDirective;
    }, function(_directivesBodyCell) {
      CellController = _directivesBodyCell.CellController;
      CellDirective = _directivesBodyCell.CellDirective;
    }, function(_directivesFooterFooter) {
      FooterController = _directivesFooterFooter.FooterController;
      FooterDirective = _directivesFooterFooter.FooterDirective;
    ...
    execute: function() {
        ...
        _createClass(DataTableController, [{
          ...
          value: function transposeColumnDefaults(columns) {
            ...
            columns.forEach(function(c, i) {
              ...
              if (!c.name) {
                _this3.$log.warn('\'Name\' property expected but not defined.', c);
                c.name = Math.random();
              }
              columns[i] = c;
            });
      ...
      ;
      _export('default', angular.module('data-table', [Throttle.name, Pager.name, ColumnMenu.name]).controller('DataTable', DataTableController).directive('dt', DataTableDirective).directive('resizable', Resizable).directive('sortable', Sortable).controller('HeaderController', HeaderController).directive('dtHeader', HeaderDirective).controller('HeaderCellController', HeaderCellController).directive('dtHeaderCell', HeaderCellDirective).controller('BodyController', BodyController).directive('dtBody', BodyDirective).controller('RowController', RowController).directive('dtRow', RowDirective).controller('CellController', CellController).directive('dtCell', CellDirective).controller('FooterController', FooterController).directive('dtFooter', FooterDirective));
    }
  };
});

System.register('data-table.css!github:systemjs/plugin-css@0.1.10', [], false, function() {});
(function(c){var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/css';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})
(".dt,.dt .dt-row-center,.dt .dt-row-left,.dt .dt-row-right{position:relative}.dt .dt-footer .pagination,.dt .dt-footer .pagination li,.dt-menu li,.dt-menu ul{padding:0;margin:0;list-style:none}.dt{justify-content:center}.dt *,.dt :after,.dt :before{-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}.dt .dt-clone{opacity:.4}.dt .dt-clone .dt-resize-handle{visibility:hidden}.dt .dt-cell,.dt .dt-header-cell{vertical-align:top;overflow:hidden;white-space:normal;line-height:1.625;touch-callout:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;-o-user-select:none;user-select:none}.dt .dt-header-inner,.dt .dt-row{display:-webkit-box;display:-moz-box;display:-ms-flexbox;display:-webkit-flex;display:flex;flex-direction:row;-webkit-flex-flow:row;-moz-flex-flow:row;-ms-flex-flow:row;-o-flex-flow:row;flex-flow:row}.dt .dt-row-left,.dt .dt-row-right{z-index:9}.dt .dt-header{overflow:hidden}.dt .dt-header .dt-header-inner{white-space:nowrap;align-items:stretch;-webkit-align-items:stretch}.dt .dt-header .dt-header-cell{position:relative;white-space:nowrap;display:inline-block}.dt .dt-header .dt-header-cell.dt-drag-over{background:#EEE}.dt .dt-header .dt-header-cell.sortable .dt-header-cell-label{cursor:pointer}.dt .dt-header .dt-header-cell .sort-btn{visibility:hidden;display:inline-block}.dt .dt-header .dt-header-cell .sort-btn.sort-asc,.dt .dt-header .dt-header-cell .sort-btn.sort-desc{visibility:visible}.dt .dt-header .dt-header-cell .dt-resize-handle{display:inline-block;position:absolute;right:0;top:0;bottom:0;width:5px;padding:0 5px;border-right:solid 1px #eee;visibility:hidden;cursor:ew-resize}.dt .dt-header .dt-header-cell.resizable:hover .dt-resize-handle{visibility:visible}.dt .dt-header .dt-header-cell:last-child .dt-resize-handle{visibility:hidden!important}.dt .dt-body{overflow:auto;position:relative;z-index:10}.dt .dt-body .dt-body-scroller{white-space:nowrap}.dt .dt-body .dt-row{backface-visibility:hidden;outline:0;white-space:nowrap}.dt .dt-body .dt-row>div{display:-webkit-box;display:-moz-box;display:-ms-flexbox;display:-webkit-flex;display:flex}.dt .dt-body .dt-row .dt-tree-toggle{cursor:pointer}.dt .dt-footer .page-count{display:inline-block}.dt .dt-footer .pagination{display:inline-block;float:right}.dt .dt-footer .pagination li,.dt .dt-footer .pagination li a{display:inline-block;outline:0}.dt.fixed .dt-body .dt-row{position:absolute;top:0}.dt-menu{text-align:left}.dt-menu .dropdown-menu{width:200px;display:none}.dt-menu .dropdown-menu.ddm-open{display:inline-block}.dt-menu ul{max-height:300px;overflow-y:auto}");