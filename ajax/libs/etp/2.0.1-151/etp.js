        ...
        (function (Object) {
            var Resource = (function () {
                function Resource() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.Object","name":"Resource","fields":[{"name":"namespace","type":"string"},{"name":"uri","type":"string"},{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"channelSubscribable","type":"boolean"},{"name":"objectType","type":"string"},{"name":"customData","type":{"type":"map","values":"string"}},{"name":"resourceType","type":"string"},{"name":"hasChildren","type":"int"},{"name":"uuid","type":["null","string"]},{"name":"lastChanged","type":"Energistics.Datatypes.DateTime"}],"fullName":"Energistics.Datatypes.Object.Resource","depends":["Energistics.Datatypes.DateTime"]}');
                }
                return Resource;
            })();
        ...
        (function (Store) {
            var DeleteObject = (function () {
                function DeleteObject() {
                    this.uri = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"DeleteObject","messageType":"3","protocol":"4","fields":[{"name":"uri","type":{"type":"array","items":"string"}}],"fullName":"Energistics.Protocol.Store.DeleteObject","depends":[]}');
                }
    ...
    (function (Protocol) {
        (function (Store) {
            var Object = (function () {
                function Object() {
                    this.dataObjects = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"Object","messageType":"4","protocol":"4","fields":[{"name":"dataObjects","type":{"type":"array","items":"Energistics.Datatypes.Object.DataObject"}}],"fullName":"Energistics.Protocol.Store.Object","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
                Object._protocol = 4;
    ...
    (function (Protocol) {
        (function (Store) {
            var PutObject = (function () {
                function PutObject() {
                    this.data = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"PutObject","messageType":"2","protocol":"4","fields":[{"name":"data","type":{"type":"array","items":"Energistics.Datatypes.Object.DataObject"}}],"fullName":"Energistics.Protocol.Store.PutObject","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
        ...
        (function (StoreNotification) {
            var ChangeNotification = (function () {
                function ChangeNotification() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.StoreNotification","name":"ChangeNotification","messageType":"2","protocol":"6","fields":[{"name":"change","type":"Energistics.Datatypes.Object.ObjectChange"}],"fullName":"Energistics.Protocol.StoreNotification.ChangeNotification","depends":["Energistics.Datatypes.Object.ObjectChange"]}');
                }
                ChangeNotification._protocol = 6;
    ...
    (function (Protocol) {
        (function (StoreNotification) {
            var DeleteNotification = (function () {
                ...
                DeleteNotification._protocol = 6;
        ...
        (function (StoreNotification) {
            var NotificationRequest = (function () {
                function NotificationRequest() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.StoreNotification","name":"NotificationRequest","messageType":"1","protocol":"6","fields":[{"name":"request","type":"Energistics.Datatypes.Object.NotificationRequestRecord"}],"fullName":"Energistics.Protocol.StoreNotification.NotificationRequest","depends":["Energistics.Datatypes.Object.NotificationRequestRecord"]}');
                }
                NotificationRequest._protocol = 6;
