...
(function (Energistics) {
    (function (Protocol) {
        (function (_ChannelDataFrame) {
            ...
            _ChannelDataFrame.MsgChannelDataFrame = 4;
        ...
        (function (ChannelStreaming) {
            var ChannelDelete = (function () {
                function ChannelDelete() {
                    this.channelId = 0;
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelStreaming","name":"ChannelDelete","messageType":"8","protocol":"1","senderRole":"producer","protocolRoles":"producer,consumer","fields":[{"name":"channelId","type":"long"},{"name":"deleteReason","type":["null","string"]}],"fullName":"Energistics.Protocol.ChannelStreaming.ChannelDelete","depends":[]}');
                }
        ...
        (function (ChannelStreaming) {
            var ChannelDescribe = (function () {
                function ChannelDescribe() {
                    this.uris = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelStreaming","name":"ChannelDescribe","messageType":"1","protocol":"1","senderRole":"consumer","protocolRoles":"producer,consumer","fields":[{"name":"uris","type":{"type":"array","items":"string"}}],"fullName":"Energistics.Protocol.ChannelStreaming.ChannelDescribe","depends":[]}');
                }
        ...
        (function (ChannelStreaming) {
            var ChannelStreamingStop = (function () {
                function ChannelStreamingStop() {
                    this.channels = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelStreaming","name":"ChannelStreamingStop","messageType":"5","protocol":"1","senderRole":"consumer","protocolRoles":"producer,consumer","fields":[{"name":"channels","type":{"type":"array","items":"int"}}],"fullName":"Energistics.Protocol.ChannelStreaming.ChannelStreamingStop","depends":[]}');
                }
        ...
        (function (ChannelStreaming) {
            var Start = (function () {
                function Start() {
                    ...
                    this.maxDataItems = 0;
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelStreaming","name":"Start","messageType":"0","protocol":"1","senderRole":"consumer","protocolRoles":"producer,consumer","fields":[{"name":"maxMessageRate","type":"int"},{"name":"maxDataItems","type":"int"}],"fullName":"Energistics.Protocol.ChannelStreaming.Start","depends":[]}');
                }
                Start._protocol = 1;
        ...
        (function (Core) {
            var Acknowledge = (function () {
                function Acknowledge() {
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Core","name":"Acknowledge","messageType":"1001","protocol":"0","senderRole":"*","protocolRoles":"client,server","fields":[],"fullName":"Energistics.Protocol.Core.Acknowledge","depends":[]}');
                }
        ...
        (function (Core) {
            var CloseSession = (function () {
                function CloseSession() {
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Core","name":"CloseSession","messageType":"5","protocol":"0","senderRole":"client,server","protocolRoles":"client,server","fields":[{"name":"reason","type":["null","string"]}],"fullName":"Energistics.Protocol.Core.CloseSession","depends":[]}');
                }
        ...
        (function (Core) {
            var ProtocolException = (function () {
                function ProtocolException() {
                    this.errorCode = 0;
                    this.errorMessage = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Core","name":"ProtocolException","messageType":"1000","protocol":"0","senderRole":"*","protocolRoles":"client,server","fields":[{"name":"errorCode","type":"int"},{"name":"errorMessage","type":"string"}],"fullName":"Energistics.Protocol.Core.ProtocolException","depends":[]}');
                }
        ...
        (function (Core) {
            var RequestSession = (function () {
                function RequestSession() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Core","name":"RequestSession","messageType":"1","protocol":"0","senderRole":"client","protocolRoles":"client,server","fields":[{"name":"applicationName","type":"string"},{"name":"requestedProtocols","type":{"type":"array","items":"Energistics.Datatypes.SupportedProtocol"}}],"fullName":"Energistics.Protocol.Core.RequestSession","depends":["Energistics.Datatypes.SupportedProtocol"]}');
                }
        ...
        (function (DataArray) {
            var GetDataArray = (function () {
                function GetDataArray() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.DataArray","name":"GetDataArray","messageType":"2","protocol":"7","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.DataArray.GetDataArray","depends":[]}');
                }
        ...
        (function (DataArray) {
            var GetDataArraySlice = (function () {
                function GetDataArraySlice() {
                    ...
                    this.start = [];
                    this.count = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.DataArray","name":"GetDataArraySlice","messageType":"3","protocol":"7","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uri","type":"string"},{"name":"start","type":{"type":"array","items":"long"}},{"name":"count","type":{"type":"array","items":"long"}}],"fullName":"Energistics.Protocol.DataArray.GetDataArraySlice","depends":[]}');
                }
        ...
        (function (Discovery) {
            var GetResources = (function () {
                function GetResources() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Discovery","name":"GetResources","messageType":"1","protocol":"3","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.Discovery.GetResources","depends":[]}');
                }
        ...
        (function (GrowingObject) {
            var GrowingObjectGet = (function () {
                function GrowingObjectGet() {
                    this.uuid = '';
                    this.uid = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectGet","messageType":"3","protocol":"6","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uuid","type":"string"},{"name":"uid","type":"string"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectGet","depends":[]}');
                }
        ...
        (function (GrowingObject) {
            var GrowingObjectPut = (function () {
                function GrowingObjectPut() {
                    ...
                    this.contentEncoding = '';
                    this.data = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectPut","messageType":"5","protocol":"6","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uuid","type":"string"},{"name":"contentType","type":"string"},{"name":"contentEncoding","type":"string"},{"name":"data","type":"bytes"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectPut","depends":[]}');
                }
        ...
        (function (GrowingObject) {
            var ObjectFragment = (function () {
                function ObjectFragment() {
                    ...
                    this.contentEncoding = '';
                    this.data = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"ObjectFragment","messageType":"6","protocol":"6","senderRole":"store","protocolRoles":"store,customer","fields":[{"name":"uuid","type":"string"},{"name":"contentType","type":"string"},{"name":"contentEncoding","type":"string"},{"name":"data","type":"bytes"}],"fullName":"Energistics.Protocol.GrowingObject.ObjectFragment","depends":[]}');
                }
        ...
        (function (Store) {
            var DeleteObject = (function () {
                function DeleteObject() {
                    this.uri = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"DeleteObject","messageType":"3","protocol":"4","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uri","type":{"type":"array","items":"string"}}],"fullName":"Energistics.Protocol.Store.DeleteObject","depends":[]}');
                }
    ...
    (function (Protocol) {
        (function (Store) {
            var GetObject = (function () {
                function GetObject() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"GetObject","messageType":"1","protocol":"4","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.Store.GetObject","depends":[]}');
                }
    ...
    (function (Protocol) {
        (function (Store) {
            var Object = (function () {
                function Object() {
                    this.dataObject = new Energistics.Datatypes.Object.DataObject();
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"Object","messageType":"4","protocol":"4","senderRole":"store","protocolRoles":"store,customer","fields":[{"name":"dataObject","type":"Energistics.Datatypes.Object.DataObject"}],"fullName":"Energistics.Protocol.Store.Object","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
                Object._protocol = 4;
        ...
        (function (Store) {
            var PutObject = (function () {
                function PutObject() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"PutObject","messageType":"2","protocol":"4","senderRole":"customer","protocolRoles":"store,customer","fields":[{"name":"data","type":"Energistics.Datatypes.Object.DataObject"}],"fullName":"Energistics.Protocol.Store.PutObject","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
        ...
        (function (StoreNotification) {
            var ChangeNotification = (function () {
                function ChangeNotification() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.StoreNotification","name":"ChangeNotification","messageType":"2","protocol":"5","senderRole":"store","protocolRoles":"store,customer","fields":[{"name":"change","type":"Energistics.Datatypes.Object.ObjectChange"}],"fullName":"Energistics.Protocol.StoreNotification.ChangeNotification","depends":["Energistics.Datatypes.Object.ObjectChange"]}');
                }
...
},{"assert":11,"./buffer_ieee754":14,"base64-js":16}],16:[function(require,module,exports){
(function (exports) {
	'use strict';
