        ...
        (function (GrowingObject) {
            var GrowingObjectDelete = (function () {
                function GrowingObjectDelete() {
                    this.uuid = '';
                    this.id = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectDelete","messageType":"1","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"id","type":"string"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectDelete","depends":[]}');
                }
        ...
        (function (GrowingObject) {
            var GrowingObjectGet = (function () {
                function GrowingObjectGet() {
                    this.uuid = '';
                    this.id = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectGet","messageType":"3","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"id","type":"string"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectGet","depends":[]}');
                }
