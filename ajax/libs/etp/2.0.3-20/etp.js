    ...
    (function (Datatypes) {
        var DataAttribute = (function () {
            function DataAttribute() {
                this.attributeId = 0;
                this.attributeValue = new Energistics.Datatypes.AnyArray();
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"DataAttribute","fields":[{"name":"attributeId","type":"int"},{"name":"attributeValue","type":"Energistics.Datatypes.AnyArray"}],"fullName":"Energistics.Datatypes.DataAttribute","depends":["Energistics.Datatypes.AnyArray"]}');
            }
        ...
        (function (ChannelData) {
            var DataItem = (function () {
                function DataItem() {
                    this.indexes = [];
                    this.channelId = 0;
                    this.value = new Energistics.Datatypes.AnyArray();
                    this.valueAttributes = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.ChannelData","name":"DataItem","fields":[{"name":"indexes","type":{"type":"array","items":"Energistics.Datatypes.ChannelData.IndexValue"}},{"name":"channelId","type":"long"},{"name":"value","type":"Energistics.Datatypes.AnyArray"},{"name":"valueAttributes","type":{"type":"array","items":"Energistics.Datatypes.DataAttribute"}}],"fullName":"Energistics.Datatypes.ChannelData.DataItem","depends":["Energistics.Datatypes.ChannelData.IndexValue","Energistics.Datatypes.AnyArray","Energistics.Datatypes.DataAttribute"]}');
                }
                return DataItem;
            })();
        ...
        (function (ChannelDataFrame) {
            var DataRow = (function () {
                function DataRow() {
                    this.index = [];
                    this.data = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.ChannelDataFrame","name":"DataRow","fields":[{"name":"index","type":{"type":"array","items":"Energistics.Datatypes.ChannelData.IndexValue"}},{"name":"data","type":{"type":"array","items":"Energistics.Datatypes.AnyArray"}}],"fullName":"Energistics.Datatypes.ChannelDataFrame.DataRow","depends":["Energistics.Datatypes.ChannelData.IndexValue","Energistics.Datatypes.AnyArray"]}');
                }
                return DataRow;
            })();
