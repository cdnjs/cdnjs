(function(e){if("function"==typeof bootstrap)bootstrap("etp",e);else if("object"==typeof exports)module.exports=e();else if("function"==typeof define&&define.amd)define(e);else if("undefined"!=typeof ses){if(!ses.ok())return;ses.makeEtp=e}else"undefined"!=typeof window?window.etp=e():global.etp=e()})(function(){var define,ses,bootstrap,module,exports;
return (function(e,t,n){function i(n,s){if(!t[n]){if(!e[n]){var o=typeof require=="function"&&require;if(!s&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var u=t[n]={exports:{}};e[n][0].call(u.exports,function(t){var r=e[n][1][t];return i(r?r:t)},u,u.exports)}return t[n].exports}var r=typeof require=="function"&&require;for(var s=0;s<n.length;s++)i(n[s]);return i})({1:[function(require,module,exports){
module.exports = {
    Energistics: require("./lib/EtpMessages").Energistics,
    Schemas: require("./lib/EtpMessages").Schemas,
	Util: require("./lib/Util"),
	SchemaCache: require("./lib/Util").SchemaCache
};

//# sourceMappingURL=index.js.map
},{"./lib/EtpMessages":2,"./lib/Util":3}],2:[function(require,module,exports){
    ...
    (function (Datatypes) {
        var ArrayOfBoolean = (function () {
            function ArrayOfBoolean() {
                this.values = [];
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"ArrayOfBoolean","fields":[{"name":"values","type":{"type":"array","items":"boolean"}}],"fullName":"Energistics.Datatypes.ArrayOfBoolean","depends":[]}');
            }
    ...
    (function (Datatypes) {
        var ArrayOfFloat = (function () {
            function ArrayOfFloat() {
                this.values = [];
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"ArrayOfFloat","fields":[{"name":"values","type":{"type":"array","items":"float"}}],"fullName":"Energistics.Datatypes.ArrayOfFloat","depends":[]}');
            }
            return ArrayOfFloat;
        })();
...
(function (Energistics) {
    (function (Datatypes) {
        var ArrayOfInt = (function () {
            function ArrayOfInt() {
                this.values = [];
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"ArrayOfInt","fields":[{"name":"values","type":{"type":"array","items":"int"}}],"fullName":"Energistics.Datatypes.ArrayOfInt","depends":[]}');
            }
            return ArrayOfInt;
        })();
    ...
    (function (Datatypes) {
        var ArrayOfLong = (function () {
            function ArrayOfLong() {
                this.values = [];
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"ArrayOfLong","fields":[{"name":"values","type":{"type":"array","items":"long"}}],"fullName":"Energistics.Datatypes.ArrayOfLong","depends":[]}');
            }
            return ArrayOfLong;
        })();
    ...
    (function (Datatypes) {
        var DateTime = (function () {
            function DateTime() {
                this.time = 0;
                this.offset = 0;
                this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"DateTime","aliases":["etp.dt"],"fields":[{"name":"time","type":"long"},{"name":"offset","type":"float"}],"fullName":"Energistics.Datatypes.DateTime","depends":[]}');
            }
            return DateTime;
        })();
...
(function (Energistics) {
    (function (Datatypes) {
        (function (Protocols) {
            ...
            Protocols[Protocols["Channel_Data_Frame"] = 2] = "Channel_Data_Frame";
            ...
            Protocols[Protocols["Notification"] = 6] = "Notification";
        ...
        (function (ChannelData) {
            var IndexMetadataRecord = (function () {
                function IndexMetadataRecord() {
                    this.indexType = 0 /* Time */;
                    this.uom = '';
                    this.direction = 0 /* Increasing */;
                    this.customData = {};
        ...
        (function (ChannelData) {
            var ChannelRangeInfo = (function () {
                function ChannelRangeInfo() {
                    this.channelId = [];
                    this.startIndex = new Energistics.Datatypes.ChannelData.IndexValue();
                    this.endIndex = new Energistics.Datatypes.ChannelData.IndexValue();
        ...
        (function (Object) {
            var Resource = (function () {
                function Resource() {
                    ...
                    this.resourceType = '';
                    this.hasChildren = 0;
                    this.lastChanged = new Energistics.Datatypes.DateTime();
        ...
        (function (_ChannelDataFrame) {
            var ChannelDataFrame = (function () {
                function ChannelDataFrame() {
                    this.channels = [];
                    this.data = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelDataFrame","name":"ChannelDataFrame","messageType":"4","protocol":"2","fields":[{"name":"channels","type":{"type":"array","items":"long"}},{"name":"data","type":{"type":"array","items":"Energistics.Datatypes.ChannelDataFrame.DataRow"}}],"fullName":"Energistics.Protocol.ChannelDataFrame.ChannelDataFrame","depends":["Energistics.Datatypes.ChannelDataFrame.DataRow"]}');
                }
        ...
        (function (ChannelStreaming) {
            var ChannelDelete = (function () {
                function ChannelDelete() {
                    this.channelId = 0;
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.ChannelStreaming","name":"ChannelDelete","messageType":"8","protocol":"1","fields":[{"name":"channelId","type":"long"},{"name":"deleteReason","type":["null","string"]}],"fullName":"Energistics.Protocol.ChannelStreaming.ChannelDelete","depends":[]}');
                }
        ...
        (function (_DataArray) {
            var DataArray = (function () {
                function DataArray() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.DataArray","name":"DataArray","messageType":"1","protocol":"7","fields":[{"name":"dimensions","type":{"type":"array","items":"long"}},{"name":"data","type":"Energistics.Datatypes.AnyArray"}],"fullName":"Energistics.Protocol.DataArray.DataArray","depends":["Energistics.Datatypes.AnyArray"]}');
                }
                DataArray._protocol = 7;
                DataArray._messageTypeId = 1;
                return DataArray;
            })();
            _DataArray.DataArray = DataArray;
        })(Protocol.DataArray || (Protocol.DataArray = {}));
        var DataArray = Protocol.DataArray;
    })(Energistics.Protocol || (Energistics.Protocol = {}));
    var Protocol = Energistics.Protocol;
})(exports.Energistics || (exports.Energistics = {}));
var Energistics = exports.Energistics;
        ...
        (function (DataArray) {
            var GetDataArray = (function () {
                function GetDataArray() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.DataArray","name":"GetDataArray","messageType":"2","protocol":"7","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.DataArray.GetDataArray","depends":[]}');
                }
        ...
        (function (DataArray) {
            var GetDataArraySlice = (function () {
                function GetDataArraySlice() {
                    ...
                    this.start = [];
                    this.count = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.DataArray","name":"GetDataArraySlice","messageType":"3","protocol":"7","fields":[{"name":"uri","type":"string"},{"name":"start","type":{"type":"array","items":"long"}},{"name":"count","type":{"type":"array","items":"long"}}],"fullName":"Energistics.Protocol.DataArray.GetDataArraySlice","depends":[]}');
                }
        ...
        (function (Discovery) {
            var GetResourcesResponse = (function () {
                function GetResourcesResponse() {
                    this.resource = new Energistics.Datatypes.Object.Resource();
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Discovery","name":"GetResourcesResponse","messageType":"2","protocol":"3","fields":[{"name":"resource","type":"Energistics.Datatypes.Object.Resource"}],"fullName":"Energistics.Protocol.Discovery.GetResourcesResponse","depends":["Energistics.Datatypes.Object.Resource"]}');
                }
...
(function (Energistics) {
    (function (Protocol) {
        (function (GrowingObject) {
            var GrowingObjectDelete = (function () {
                function GrowingObjectDelete() {
                    this.uuid = '';
                    this.uid = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectDelete","messageType":"1","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"uid","type":"string"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectDelete","depends":[]}');
                }
        ...
        })(Protocol.GrowingObject || (Protocol.GrowingObject = {}));
        var GrowingObject = Protocol.GrowingObject;
    })(Energistics.Protocol || (Energistics.Protocol = {}));
    var Protocol = Energistics.Protocol;
})(exports.Energistics || (exports.Energistics = {}));
var Energistics = exports.Energistics;
        ...
        (function (GrowingObject) {
            var GrowingObjectDeleteRange = (function () {
                function GrowingObjectDeleteRange() {
                    ...
                    this.startIndex = new Energistics.Datatypes.ChannelData.IndexValue();
                    this.endIndex = new Energistics.Datatypes.ChannelData.IndexValue();
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectDeleteRange","messageType":"2","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"startIndex","type":"Energistics.Datatypes.ChannelData.IndexValue"},{"name":"endIndex","type":"Energistics.Datatypes.ChannelData.IndexValue"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectDeleteRange","depends":["Energistics.Datatypes.ChannelData.IndexValue","Energistics.Datatypes.ChannelData.IndexValue"]}');
                }
        ...
        (function (GrowingObject) {
            var GrowingObjectGet = (function () {
                function GrowingObjectGet() {
                    this.uuid = '';
                    this.uid = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"GrowingObjectGet","messageType":"3","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"uid","type":"string"}],"fullName":"Energistics.Protocol.GrowingObject.GrowingObjectGet","depends":[]}');
                }
        ...
        (function (GrowingObject) {
            var ObjectFragment = (function () {
                function ObjectFragment() {
                    ...
                    this.contentEncoding = '';
                    this.data = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.GrowingObject","name":"ObjectFragment","messageType":"6","protocol":"6","fields":[{"name":"uuid","type":"string"},{"name":"contentType","type":"string"},{"name":"contentEncoding","type":"string"},{"name":"data","type":"bytes"}],"fullName":"Energistics.Protocol.GrowingObject.ObjectFragment","depends":[]}');
                }
        ...
        (function (Store) {
            var DeleteObject = (function () {
                function DeleteObject() {
                    this.uuid = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"DeleteObject","messageType":"3","protocol":"4","fields":[{"name":"uuid","type":{"type":"array","items":"string"}}],"fullName":"Energistics.Protocol.Store.DeleteObject","depends":[]}');
                }
    ...
    (function (Protocol) {
        (function (Store) {
            var GetObject = (function () {
                function GetObject() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"GetObject","messageType":"1","protocol":"4","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.Store.GetObject","depends":[]}');
                }
    ...
    (function (Protocol) {
        (function (Store) {
            var Object = (function () {
                function Object() {
                    this.dataObject = new Energistics.Datatypes.Object.DataObject();
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"Object","messageType":"4","protocol":"4","fields":[{"name":"dataObject","type":"Energistics.Datatypes.Object.DataObject"}],"fullName":"Energistics.Protocol.Store.Object","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
                Object._protocol = 4;
        ...
        (function (Store) {
            var PutObject = (function () {
                function PutObject() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"PutObject","messageType":"2","protocol":"4","fields":[{"name":"data","type":"Energistics.Datatypes.Object.DataObject"}],"fullName":"Energistics.Protocol.Store.PutObject","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
...
(function (Energistics) {
    (function (Protocol) {
        ...
        })(Protocol.StoreNotification || (Protocol.StoreNotification = {}));
        var StoreNotification = Protocol.StoreNotification;
    })(Energistics.Protocol || (Energistics.Protocol = {}));
    var Protocol = Energistics.Protocol;
})(exports.Energistics || (exports.Energistics = {}));
var Energistics = exports.Energistics;
...
},{"./EtpSchemas.js":4,"etp-avro":5}],6:[function(require,module,exports){
...
var BinaryReader = (function () {
    ...
    BinaryReader.prototype.readString = function () {
        ...
        return this.utf8Decode(this.readFixed(len));
    };
...
},{"fs":6,"./assert-type":8,"__browserify_buffer":7}],9:[function(require,module,exports){
var events = require('events');
