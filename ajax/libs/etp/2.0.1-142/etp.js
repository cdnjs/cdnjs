        ...
        (function (Object) {
            var Resource = (function () {
                function Resource() {
                    ...
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.Object","name":"Resource","fields":[{"name":"namespace","type":"string"},{"name":"uri","type":"string"},{"name":"version","type":"string"},{"name":"name","type":"string"},{"name":"objectType","type":"string"},{"name":"subscribable","type":"boolean"},{"name":"customData","type":{"type":"map","values":"string"}},{"name":"resourceType","type":"string"},{"name":"hasChildren","type":"int"},{"name":"uuid","type":["null","string"]},{"name":"lastChanged","type":"Energistics.Datatypes.DateTime"}],"fullName":"Energistics.Datatypes.Object.Resource","depends":["Energistics.Datatypes.DateTime"]}');
                }
                return Resource;
            })();
        ...
        (function (Object) {
            var DataObject = (function () {
                function DataObject() {
                    ...
                    this.data = null;
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.Object","name":"DataObject","fields":[{"name":"resource","type":"Energistics.Datatypes.Object.Resource"},{"name":"contentType","type":"string"},{"name":"contentEncoding","type":"string"},{"name":"data","type":"bytes"}],"fullName":"Energistics.Datatypes.Object.DataObject","depends":["Energistics.Datatypes.Object.Resource"]}');
                }
                return DataObject;
            })();
        ...
        (function (Store) {
            var DeleteObject = (function () {
                function DeleteObject() {
                    this.uri = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"DeleteObject","messageType":"2","protocol":"4","fields":[{"name":"uri","type":{"type":"array","items":"string"}}],"fullName":"Energistics.Protocol.Store.DeleteObject","depends":[]}');
                }
                DeleteObject._protocol = 4;
                DeleteObject._messageTypeId = 2;
                return DeleteObject;
            })();
    ...
    (function (Protocol) {
        (function (Store) {
            var GetObject = (function () {
                function GetObject() {
                    this.uri = '';
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"GetObject","messageType":"0","protocol":"4","fields":[{"name":"uri","type":"string"}],"fullName":"Energistics.Protocol.Store.GetObject","depends":[]}');
                }
                GetObject._protocol = 4;
                GetObject._messageTypeId = 0;
                return GetObject;
            })();
    ...
    (function (Protocol) {
        (function (Store) {
            var PutObject = (function () {
                function PutObject() {
                    this.data = [];
                    this._schema = JSON.parse('{"type":"record","namespace":"Energistics.Protocol.Store","name":"PutObject","messageType":"1","protocol":"4","fields":[{"name":"data","type":{"type":"array","items":"Energistics.Datatypes.Object.DataObject"}}],"fullName":"Energistics.Protocol.Store.PutObject","depends":["Energistics.Datatypes.Object.DataObject"]}');
                }
                PutObject._protocol = 4;
                PutObject._messageTypeId = 1;
                return PutObject;
            })();
