...
(function (Energistics) {
    ...
    (function (Datatypes) {
        var DateTime = (function () {
            ...
            DateTime._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes","name":"DateTime","aliases":["etp.dt"],"fields":[{"name":"time","type":"long"},{"name":"offset","type":"float"}],"fullName":"Energistics.Datatypes.DateTime","depends":[]}');
            return DateTime;
        })();
    ...
    (function (Datatypes) {
        ...
        (function (ChannelData) {
            var IndexValue = (function () {
                ...
                IndexValue._schema = JSON.parse('{"type":"record","namespace":"Energistics.Datatypes.ChannelData","name":"IndexValue","fields":[{"name":"item","type":["Energistics.Datatypes.DateTime","double","long"]}],"fullName":"Energistics.Datatypes.ChannelData.IndexValue","depends":["Energistics.Datatypes.DateTime"]}');
                return IndexValue;
            })();
