	  ...
	  createClass(View, [{
	    ...
	    get: function get() {
	      ...
	      if (!height || height === '0px' || height === 'auto') {
	        var clientHeight = this.component.clientHeight;
	    ...
	    get: function get() {
	      ...
	      return this.component.options.manifest.filter(function (component) {
	        return _this6.component.config[component].styles;
	      }).reduce(function (hash, component) {
	        hash[component] = _this6.component.config[component].styles;
	        return hash;
	      }, {});
	    }
	...
	var Component = function () {
	  ...
	  createClass(Component, [{
	    ...
	    get: function get() {
	      ...
	      return this.options.manifest.filter(function (component) {
	        return _this4.config[component].googleFonts;
	      }).reduce(function (fonts, component) {
	        return fonts.concat(_this4.config[component].googleFonts);
	      }, []);
	    }
