/**
 * svelte-range-slider-pips ~ 3.2.0
...
function create_each_block$1(ctx) {
	let if_block_anchor;
	let if_block = /*val*/ ctx[38] !== /*min*/ ctx[1] && /*val*/ ctx[38] !== /*max*/ ctx[2] && create_if_block_5$1(ctx);
