/**
 * svelte-range-slider-pips ~ 4.0.0-beta.4
...
(function (global, factory) {
	...
	function get_each_context(ctx, list, i) {
		...
		const constants_0 = `${/*focus*/ child_ctx[33] && /*activeHandle*/ child_ctx[36] === /*index*/ child_ctx[95]
	? 3
	: ''}`;

		child_ctx[92] = constants_0;
		const constants_1 = `calc((${/*sliderSize*/ child_ctx[37]}px * ${/*$springPositions*/ child_ctx[41][/*index*/ child_ctx[95]] / 100}))`;
		child_ctx[93] = constants_1;
		return child_ctx;
	}
	...
	function get_if_ctx(ctx) {
		...
		const constants_1 = /*handleFormatter*/ child_ctx[4](/*value*/ child_ctx[6], /*index*/ child_ctx[95], /*percent*/ child_ctx[96]);
	...
	function create_if_block_9(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[0] & /*handleFormatter, values, min, max, precision*/ 279 && raw_value !== (raw_value = /*formattedValue*/ ctx[97] + "")) html_tag.p(raw_value);
	...
	// (735:2) {#each values as value, index}
	function create_each_block(ctx) {
		...
		return {
			c() {
				...
				attr(span1, "aria-label", span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[95]]);

				attr(span1, "aria-valuemin", span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[95] === 1
				? /*values*/ ctx[2][0]
				: /*min*/ ctx[0]);

				attr(span1, "aria-valuemax", span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[95] === 0
				? /*values*/ ctx[2][1]
				: /*max*/ ctx[1]);

				attr(span1, "aria-valuenow", span1_aria_valuenow_value = /*value*/ ctx[6]);
				attr(span1, "aria-valuetext", span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[55](/*value*/ ctx[6], /*index*/ ctx[95]));
				...
				toggle_class(span1, "rsActive", /*focus*/ ctx[33] && /*activeHandle*/ ctx[36] === /*index*/ ctx[95]);
				toggle_class(span1, "rsPress", /*handlePressed*/ ctx[34] && /*activeHandle*/ ctx[36] === /*index*/ ctx[95]);
				set_style(span1, "z-index", /*zindex*/ ctx[92]);
				set_style(span1, "--handle-pos", /*$springPositions*/ ctx[41][/*index*/ ctx[95]]);
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen(span1, "blur", /*sliderBlurHandle*/ ctx[45]),
						listen(span1, "focus", /*sliderFocusHandle*/ ctx[46]),
						listen(span1, "keydown", /*sliderKeydown*/ ctx[47])
					];
			...
			p(ctx, dirty) {
				...
				if (dirty[0] & /*ariaLabels*/ 32 && span1_aria_label_value !== (span1_aria_label_value = /*ariaLabels*/ ctx[5][/*index*/ ctx[95]])) {
					attr(span1, "aria-label", span1_aria_label_value);
				}

				if (dirty[0] & /*range, values, min*/ 517 && span1_aria_valuemin_value !== (span1_aria_valuemin_value = /*range*/ ctx[9] === true && /*index*/ ctx[95] === 1
				? /*values*/ ctx[2][0]
				: /*min*/ ctx[0])) {
					attr(span1, "aria-valuemin", span1_aria_valuemin_value);
				}

				if (dirty[0] & /*range, values, max*/ 518 && span1_aria_valuemax_value !== (span1_aria_valuemax_value = /*range*/ ctx[9] === true && /*index*/ ctx[95] === 0
				? /*values*/ ctx[2][1]
				: /*max*/ ctx[1])) {
				...
				if (dirty[0] & /*values*/ 4 && span1_aria_valuetext_value !== (span1_aria_valuetext_value = /*ariaLabelFormatter*/ ctx[55](/*value*/ ctx[6], /*index*/ ctx[95]))) {
				...
				if (dirty[1] & /*$springPositions*/ 1024) {
					set_style(span1, "--handle-pos", /*$springPositions*/ ctx[41][/*index*/ ctx[95]]);
				}
			},
			d(detaching) {
	...
	function create_if_block_8(ctx) {
		...
		return {
			c() {
				...
				attr(span, "style", span_style_value = "" + (/*orientationStart*/ ctx[39] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[38] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"));
			},
			m(target, anchor) {
				insert(target, span, anchor);
			},
			p(ctx, dirty) {
				if (dirty[0] & /*limits, min, max, precision*/ 262403 | dirty[1] & /*orientationStart, orientationEnd*/ 384 && span_style_value !== (span_style_value = "" + (/*orientationStart*/ ctx[39] + ": " + valueAsPercent(/*limits*/ ctx[18][0], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8]) + "%; " + /*orientationEnd*/ ctx[38] + ": " + (100 - valueAsPercent(/*limits*/ ctx[18][1], /*min*/ ctx[0], /*max*/ ctx[1], /*precision*/ ctx[8])) + "%;"))) {
					attr(span, "style", span_style_value);
				}
			},
			d(detaching) {
	...
	function create_if_block_1(ctx) {
		...
		return {
			c() {
				...
				set_style(span, "--range-start", /*rangeStartPercent*/ ctx[43](/*$springPositions*/ ctx[41]));
				set_style(span, "--range-end", /*rangeEndPercent*/ ctx[44](/*$springPositions*/ ctx[41]));
				set_style(span, "--range-size", /*rangeEndPercent*/ ctx[44](/*$springPositions*/ ctx[41]) - /*rangeStartPercent*/ ctx[43](/*$springPositions*/ ctx[41]));
			},
			m(target, anchor) {
				insert(target, span, anchor);
				if (if_block) if_block.m(span, null);
	...
	function create_else_block(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[0] & /*reversed, values*/ 32772 && raw1_value !== (raw1_value = /*second*/ ctx[91] + "")) html_tag_1.p(raw1_value);
	...
	function create_if_block(ctx) {
		...
		rangepips = new RangePips({
				props: {
					...
					orientationStart: /*orientationStart*/ ctx[39],
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty[1] & /*orientationStart*/ 256) rangepips_changes.orientationStart = /*orientationStart*/ ctx[39];
	...
	function create_fragment(ctx) {
		...
		let if_block1 = /*hasRange*/ ctx[40] && create_if_block_1(ctx);
		...
		return {
			c() {
				...
				toggle_class(div, "rsRange", /*hasRange*/ ctx[40]);
				toggle_class(div, "rsDrag", /*hasRange*/ ctx[40] && /*draggy*/ ctx[10]);
				toggle_class(div, "rsMin", /*hasRange*/ ctx[40] && /*range*/ ctx[9] === 'min');
				toggle_class(div, "rsMax", /*hasRange*/ ctx[40] && /*range*/ ctx[9] === 'max');
				...
				set_style(div, "--slider-length", /*sliderSize*/ ctx[37]);
			},
			m(target, anchor) {
				insert(target, div, anchor);
				...
				if (!mounted) {
					dispose = [
						listen(window, "mousedown", /*bodyInteractStart*/ ctx[50]),
						listen(window, "touchstart", /*bodyInteractStart*/ ctx[50]),
						listen(window, "mousemove", /*bodyInteract*/ ctx[51]),
						listen(window, "touchmove", /*bodyInteract*/ ctx[51]),
						listen(window, "mouseup", /*bodyMouseUp*/ ctx[52]),
						listen(window, "touchend", /*bodyTouchEnd*/ ctx[53]),
						listen(window, "keydown", /*bodyKeyDown*/ ctx[54]),
						listen(div, "mousedown", /*sliderInteractStart*/ ctx[48]),
						listen(div, "mouseup", /*sliderInteractEnd*/ ctx[49]),
						listen(div, "touchstart", prevent_default(/*sliderInteractStart*/ ctx[48])),
						listen(div, "touchend", prevent_default(/*sliderInteractEnd*/ ctx[49]))
					];
			...
			p(ctx, dirty) {
				if (dirty[0] & /*ariaLabels, range, values, min, max, vertical, disabled, suffix, handleFormatter, precision, prefix, float*/ 50475831 | dirty[1] & /*ariaLabelFormatter, focus, activeHandle, handlePressed, $springPositions, sliderBlurHandle, sliderFocusHandle, sliderKeydown*/ 16892972) {
				...
				if (!current || dirty[0] & /*classes*/ 268435456 | dirty[1] & /*hasRange*/ 512) {
					toggle_class(div, "rsRange", /*hasRange*/ ctx[40]);
				}

				if (!current || dirty[0] & /*classes, draggy*/ 268436480 | dirty[1] & /*hasRange*/ 512) {
					toggle_class(div, "rsDrag", /*hasRange*/ ctx[40] && /*draggy*/ ctx[10]);
				}

				if (!current || dirty[0] & /*classes, range*/ 268435968 | dirty[1] & /*hasRange*/ 512) {
					toggle_class(div, "rsMin", /*hasRange*/ ctx[40] && /*range*/ ctx[9] === 'min');
				}
				...
				if (dirty[0] & /*style*/ 536870912 | dirty[1] & /*sliderSize*/ 64 || style_changed) {
					set_style(div, "--slider-length", /*sliderSize*/ ctx[37]);
				}
			},
			i(local) {
	...
	function instance($$self, $$props, $$invalidate) {
		...
		let $springPositions,
			...
			$$subscribe_springPositions = () => ($$unsubscribe_springPositions(), $$unsubscribe_springPositions = subscribe(springPositions, $$value => $$invalidate(41, $springPositions = $$value)), springPositions);
		...
		const checkValuesAgainstRangeGaps = () => {
			...
			if (rangeGapMin < 0) $$invalidate(56, rangeGapMin = 0);

			if (rangeGapMax < 0) $$invalidate(57, rangeGapMax = Infinity);

			// rangeGapMin must be less than rangeGapMax
			if (rangeGapMin > rangeGapMax) $$invalidate(56, rangeGapMin = rangeGapMax);
	 ...
	 **/
		...
		$$self.$$set = $$props => {
			...
			if ('pushy' in $$props) $$invalidate(58, pushy = $$props.pushy);
			...
			if ('rangeGapMin' in $$props) $$invalidate(56, rangeGapMin = $$props.rangeGapMin);
			if ('rangeGapMax' in $$props) $$invalidate(57, rangeGapMax = $$props.rangeGapMax);
			...
			if ('springValues' in $$props) $$invalidate(59, springValues = $$props.springValues);
			if ('spring' in $$props) $$invalidate(60, spring$1 = $$props.spring);
		};
		...
		$$self.$$.update = () => {
			...
			if ($$self.$$.dirty[0] & /*values, min, max, step, precision, limits*/ 264455 | $$self.$$.dirty[1] & /*valueLength, springValues, springPositions, spring*/ 1879048194) {
				{
					...
					$$invalidate(61, valueLength = values.length);
				}
			}
			...
			if ($$self.$$.dirty[0] & /*range, values*/ 516) {
				$$invalidate(40, hasRange = range === true && values.length === 2 || (range === 'min' || range === 'max') && values.length === 1);
			}
	 ...
	 **/
				$$invalidate(39, orientationStart = vertical
				? reversed ? 'top' : 'bottom'
				: reversed ? 'right' : 'left');
			}

			if ($$self.$$.dirty[0] & /*vertical, reversed*/ 36864) {
				$$invalidate(38, orientationEnd = vertical
				? reversed ? 'bottom' : 'top'
				: reversed ? 'left' : 'right');
			}
		};
