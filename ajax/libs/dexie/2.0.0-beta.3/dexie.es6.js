 ...
 *
 * Version 2.0.0-beta.3, Tue Oct 18 2016
 * www.dexie.com
...
const resolvedGlobalPromise = _global.Promise && _global.Promise.resolve();
...
var DEXIE_VERSION = '2.0.0-beta.3';
...
function Dexie(dbName, options) {
    ...
    */
    ...
    props(Transaction.prototype, {
        ...
        tables: {
            get: deprecated ("Transaction.tables", ()=>allTables)
        },

        table: deprecated ("Transaction.table()", name => allTables[name])
    });
