    ...
    ***************************************************************************** */
    ...
    function (_super) {
      ...
      __proto._collectPanels = function () {
        ...
        cameraElement.childNodes.forEach(function (node) {
    ...
    function (_super) {
      ...
      function Flicking(root, _a) {
        var _b = _a === void 0 ? {} : _a,
          ...
          return 1 - Math.pow(1 - x, 3);
            ...
            _0 = _b.useOrderManipulator,
            useOrderManipulator = _0 === void 0 ? false : _0;
      ...
      Object.defineProperty(__proto, "activatedPlugins", {
        /**
      ...
      __proto.setStatus = function (status) {
        ...
        if (((_a = panels[0]) === null || _a === void 0 ? void 0 : _a.html) && !this._renderExternal) {
          ...
          renderer.batchInsert({
            index: 0,
            elements: panels.map(function (panel) {
              return panel.html;
            })
          });
        }
      ...
      Flicking.VERSION = "4.0.0-beta.10";
      return Flicking;
    }(Component);
