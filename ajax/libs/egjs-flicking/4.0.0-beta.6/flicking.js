    ...
    function (_super) {
      ...
      __proto.render = function () {
        ...
        if (flicking.holding) {
          ...
          var wasVisiblePanels = __spreadArray([], __read(panels)).filter(function (panel) {
            return panel.element.parentElement === cameraElement && !includes(visiblePanels, panel);
          });

          visiblePanels.push.apply(visiblePanels, __spreadArray([], __read(wasVisiblePanels)));
        }
