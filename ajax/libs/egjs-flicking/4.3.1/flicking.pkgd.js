...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var parseElement = function (element) {
      ...
      element.forEach(function (el) {
        if (isString(el)) {
          ...
          elements.push.apply(elements, __spreadArray([], __read$1(toArray$3(tempDiv.children))));
    ...
    var includes = function (array, target) {
      ...
      try {
        for (var array_1 = __values$3(array), array_1_1 = array_1.next(); !array_1_1.done; array_1_1 = array_1.next()) {
    ...
    var find$1 = function (array, checker) {
      ...
      try {
        for (var array_2 = __values$3(array), array_2_1 = array_2.next(); !array_2_1.done; array_2_1 = array_2.next()) {
    ...
    **/
    ...
    var HoldingState = function (_super) {
      ...
      __proto.onFinish = function (ctx) {
        ...
        try {
          for (var panels_1 = __values$3(panels), panels_1_1 = panels_1.next(); !panels_1_1.done; panels_1_1 = panels_1.next()) {
    ...
    var Camera$1 = function () {
      ...
      function Camera(_a) {
        ...
        this._checkTranslateSupport = function () {
          ...
          try {
            for (var transforms_1 = __values$3(transforms), transforms_1_1 = transforms_1.next(); !transforms_1_1.done; transforms_1_1 = transforms_1.next()) {
    ...
    */
    ...
    var ElementPanel = function (_super) {
      __extends$2(ElementPanel, _super);
      /**
       * @param {object} options An options object<ko>옵션 오브젝트</ko>
    ...
    var VanillaRenderer = function (_super) {
      ...
      __proto._collectPanels = function () {
        ...
        var cameraChilds = toArray$3(cameraElement.children);
      ...
      __proto._createPanel = function (el, options) {
        return new ElementPanel(__assign$2({
          el: el
        }, options));
      };
    ...
    var Flicking = function (_super) {
      ...
      __proto._createRenderer = function () {
        ...
        return renderExternal ? new renderExternal.renderer(__assign$2(__assign$2({}, rendererOptions), renderExternal.rendererOptions)) : new VanillaRenderer(rendererOptions);
      };
    ...
    var ExternalPanel = function (_super) {
      __extends$2(ExternalPanel, _super);
      /**
       * @param {object} options An options object<ko>옵션 오브젝트</ko>
       * @param {HTMLElement} [options.el] A `HTMLElement` panel's referencing<ko>패널이 참조하는 `HTMLElement`</ko>
       * @param {number} [options.index] An initial index of the panel<ko>패널의 초기 인덱스</ko>
    ...
    var withFlickingMethods = function (prototype, flickingName) {
      [Component$2.prototype, Flicking.prototype].forEach(function (proto) {
