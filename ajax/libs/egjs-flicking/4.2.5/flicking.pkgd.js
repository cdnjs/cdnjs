...
(function (global, factory) {
    ...
    **/
    ...
    var StrictControl = function (_super) {
      __extends$1(StrictControl, _super);
      /** */
    ...
    var Renderer$1 = function () {
      ...
      __proto.batchInsert = function () {
        ...
        var allPanelsInserted = items.reduce(function (addedPanels, item) {
          ...
          panels.splice.apply(panels, __spreadArray([insertingIdx, 0], __read$1(panelsInserted))); // Insert the actual elements as camera element's children
          ...
          return __spreadArray(__spreadArray([], __read$1(addedPanels)), __read$1(panelsInserted));
        }, []);
      ...
      __proto.batchRemove = function () {
        ...
        var allPanelsRemoved = items.reduce(function (removed, item) {
          ...
          return __spreadArray(__spreadArray([], __read$1(removed)), __read$1(panelsRemoved));
        }, []);
    ...
    var Panel = function () {
      ...
      __proto.resize = function (cached) {
        ...
        if (cached) {
          ...
          this._margin = __assign$1({}, cached.margin);
    ...
    var ElementPanel = function (_super) {
      __extends$1(ElementPanel, _super);
      /**
       * @param {object} options An options object<ko>옵션 오브젝트</ko>
    ...
    var VanillaRenderer = function (_super) {
      __extends$1(VanillaRenderer, _super);
      ...
      __proto._createPanel = function (el, options) {
        return new ElementPanel(__assign$1({
          el: el
        }, options));
      };
      ...
      __proto._resetPanelElementOrder = function (panels) {
        ...
        var reversedPanels = __spreadArray([], __read$1(panels)).reverse();
    ...
    var ExternalRenderer = function (_super) {
      __extends$1(ExternalRenderer, _super);
    ...
    var Flicking = function (_super) {
      ...
      __proto.addPlugins = function () {
        ...
        (_a = this._plugins).push.apply(_a, __spreadArray([], __read$1(plugins)));
      ...
      __proto._createRenderer = function () {
        ...
        return renderExternal ? new renderExternal.renderer(__assign$1(__assign$1({}, rendererOptions), renderExternal.rendererOptions)) : new VanillaRenderer(rendererOptions);
      };
    ...
    var ExternalPanel = function (_super) {
      __extends$1(ExternalPanel, _super);
      /**
       * @param {object} options An options object<ko>옵션 오브젝트</ko>
       * @param {HTMLElement} [options.el] A `HTMLElement` panel's referencing<ko>패널이 참조하는 `HTMLElement`</ko>
       * @param {number} [options.index] An initial index of the panel<ko>패널의 초기 인덱스</ko>
          ...
          if (descriptor.value) {
            ...
            Object.defineProperty(prototype, name, {
              value: function () {
                ...
                return (_a = descriptor.value).call.apply(_a, __spreadArray([this[flickingName]], __read$1(args)));
              }
            });
          } else {
            ...
            if (descriptor.set) {
              getterDescriptor.set = function () {
                ...
                return (_a = descriptor.set) === null || _a === void 0 ? void 0 : _a.call.apply(_a, __spreadArray([this[flickingName]], __read$1(args)));
              };
            }
    ...
    var getRenderingPanels = (function (flicking, diffResult) {
      ...
      return __spreadArray(__spreadArray([], __read$1(flicking.panels.filter(function (panel) {
      ...
      }))), __read$1(diffResult.added.map(function (idx) {
     ...
     * egjs projects are licensed under the MIT license
     */
    merge$1(Flicking, Core);
    merge$1(Flicking, Camera);
    merge$1(Flicking, Control);
    merge$1(Flicking, Renderer);
    merge$1(Flicking, Constants);
    merge$1(Flicking, CFC);
