    ...
    ***************************************************************************** */
    ...
    function () {
      ...
      __proto._animateToPosition = function (_a) {
        var position = _a.position,
            ...
            axesEvent = _a.axesEvent;
        return __awaiter(this, void 0, void 0, function () {
          var currentPanel, animate, isTrusted, animation;
    ...
    function () {
      ...
      __proto.updateAdaptiveHeight = function () {
        var flicking = getFlickingAttached(this._flicking, "Camera");
        var anchorBelow = this.findAnchorIncludePosition(this._position);
        ...
        if (shouldAppendBoundAnchor) {
          newAnchors.push(new AnchorPoint({
            ...
            panel: findRight(panels, function (panel) {
              return panel.includePosition(range.max);
            })
          }));
        }
    ...
    function () {
      ...
      Object.defineProperty(__proto, "outsetProgress", {
        get: function () {
          var position = this.position + this._offset;
    ...
    function (_super) {
      ...
      Object.defineProperty(__proto, "plugins", {
        /**
      ...
      __proto.getStatus = function (_a) {
        ...
        if (visiblePanelsOnly) {
          ...
          status.visibleOffset = {
            index: (_c = (_b = visiblePanels[0]) === null || _b === void 0 ? void 0 : _b.index) !== null && _c !== void 0 ? _c : 0,
            position: visiblePanels[0] ? visiblePanels[0].range.min - visiblePanels[0].margin.prev : 0
          };
        }
      ...
      __proto.setStatus = function (status) {
        ...
        if (((_a = panels[0]) === null || _a === void 0 ? void 0 : _a.html) && !this._renderExternal) {
          ...
          renderer.insert(0, panels.map(function (panel) {
            return panel.html;
          }));
        }

        if (index) {
          var panelIndex = visibleOffset ? index - visibleOffset.index : index;
        ...
        if (position && this._moveType === MOVE_TYPE.FREE_SCROLL) {
          var cameraPosition = visibleOffset ? position - visibleOffset.position : position;
          void control.moveToPosition(cameraPosition, 0).catch(function () {
            return void 0;
          });
        }
      };
