          ...
          return __generator(this, function (_b) {
            ...
            if (duration <= 0) {
              ...
              , animate().then(function () {
                return _this._setActive(newActivePanel, currentPanel, isTrusted);
              })];
            }
          });
        });
    ...
    function (_super) {
      ...
      __proto.render = function () {
        ...
        if (flicking.holding) {
          ...
          var wasVisiblePanels = __spreadArray([], __read$1(panels)).filter(function (panel) {
            return panel.element.parentElement === cameraElement && !includes(visiblePanels, panel);
          });

          visiblePanels.push.apply(visiblePanels, __spreadArray([], __read$1(wasVisiblePanels)));
        }
        ...
        var invisiblePrevPanels = panels.filter(function (panel) {
          return !includes(visiblePanels, panel);
        }).filter(function (panel) {
          return panel.range.max + panel.offset < camera.visibleRange.min;
        });
    ...
    function (_super) {
      ...
      function Flicking(root, _a) {
        ...
        _this.resize = function () {
          ...
          var prevProgressInPanel = activePanel ? camera.getProgressInPanel(activePanel) : 0;
