        ...
        peerConnection.oniceconnectionstatechange = ()=>{
            switch(peerConnection.iceConnectionState){
                case "failed":
                    ...
                    this.connection.emit("error", new Error("Negotiation of connection to " + peerId + " failed."));
                    this.connection.close();
                    break;
                case "closed":
                    (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log("iceConnectionState is closed, closing connections to " + peerId);
                    this.connection.emit("error", new Error("Connection to " + peerId + " closed."));
                    this.connection.close();
                    break;
                case "disconnected":
...
class $f06f075a81a8b63e$export$23a2a68283c24d80 extends (0, $f5d7fbd88de797fd$exports.EventEmitter) {
    /**
...
class $392ccce28b647101$export$d365f7ad9d7df9c9 extends (0, $f06f075a81a8b63e$export$23a2a68283c24d80) {
    ...
    /** Allows user to send data. */ send(data, chunked = false) {
        if (!this.open) {
            super.emit("error", new Error("Connection is not open. You should listen for the `open` event before sending messages."));
            return;
        }
...
class $11967427976ce06d$var$PeerError extends Error {
...
class $11967427976ce06d$export$ecd1fc136c422448 extends (0, $f5d7fbd88de797fd$exports.EventEmitter) {
    /**
    ...
    /** Emits a typed error message. */ emitError(type, err) {
        ...
        this.emit("error", new $11967427976ce06d$var$PeerError(type, err));
    }
    /**
