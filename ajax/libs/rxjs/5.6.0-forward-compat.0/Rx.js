 ...
 * value.
 */
var throwIfEmpty$1 = function (errorFactory) {
...
function throwIfEmpty$$1(errorFactory) {
    if (errorFactory === void 0) { errorFactory = defaultErrorFactory; }
    return throwIfEmpty$1(errorFactory)(this);
}

Observable.prototype.throwIfEmpty = throwIfEmpty$$1;
