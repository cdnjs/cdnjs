 ...
 * @owner Observable
 */
function smooshMap(project, resultSelector, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    if (typeof resultSelector === 'function') {
        // DEPRECATED PATH
        return function (source) { return source.pipe(smooshMap(function (a, i) { return from(project(a, i)).pipe(map(function (b, ii) { return resultSelector(a, b, i, ii); })); }, concurrent)); };
    }
    else if (typeof resultSelector === 'number') {
        concurrent = resultSelector;
    }
    return function (source) { return source.lift(new SmooshMapOperator(project, concurrent)); };
}
var SmooshMapOperator = /** @class */ (function () {
    function SmooshMapOperator(project, concurrent) {
        if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
        this.project = project;
        this.concurrent = concurrent;
    }
    SmooshMapOperator.prototype.call = function (observer, source) {
        return source.subscribe(new SmooshMapSubscriber(observer, this.project, this.concurrent));
    };
    return SmooshMapOperator;
}());
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
 * @extends {Ignored}
 */
var SmooshMapSubscriber = /** @class */ (function (_super) {
    __extends(SmooshMapSubscriber, _super);
    function SmooshMapSubscriber(destination, project, concurrent) {
        if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
        var _this = _super.call(this, destination) || this;
        _this.project = project;
    ...
    SmooshMapSubscriber.prototype._next = function (value) {
    ...
    SmooshMapSubscriber.prototype._tryNext = function (value) {
        var result;
    ...
    SmooshMapSubscriber.prototype._innerSub = function (ish, value, index) {
        this.add(subscribeToResult(this, ish, value, index));
    };
    SmooshMapSubscriber.prototype._complete = function () {
        this.hasCompleted = true;
        if (this.active === 0 && this.buffer.length === 0) {
            this.destination.complete();
        }
    };
    SmooshMapSubscriber.prototype.notifyNext = function (outerValue, innerValue, outerIndex, innerIndex, innerSub) {
        this.destination.next(innerValue);
    };
    SmooshMapSubscriber.prototype.notifyComplete = function (innerSub) {
 ...
 * @owner Observable
 */
function smooshAll(concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return smooshMap(identity, concurrent);
}
...
function smoosh() {
    ...
    return smooshAll(concurrent)(fromArray(observables, scheduler));
}
...
function smoosh$1() {
    ...
    return function (source) { return source.lift.call(smoosh.apply(void 0, [source].concat(observables))); };
}
 ...
 * @owner Observable
 */
function smooshMapTo(innerObservable, resultSelector, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    if (typeof resultSelector === 'function') {
        return smooshMap(function () { return innerObservable; }, resultSelector, concurrent);
    }
    if (typeof resultSelector === 'number') {
        concurrent = resultSelector;
    }
    return smooshMap(function () { return innerObservable; }, concurrent);
}
 ...
 * @owner Observable
 */
function smooshScan(accumulator, seed, concurrent) {
    if (concurrent === void 0) { concurrent = Number.POSITIVE_INFINITY; }
    return function (source) { return source.lift(new SmooshScanOperator(accumulator, seed, concurrent)); };
}
var SmooshScanOperator = /** @class */ (function () {
    function SmooshScanOperator(accumulator, seed, concurrent) {
        this.accumulator = accumulator;
        this.seed = seed;
        this.concurrent = concurrent;
    }
    SmooshScanOperator.prototype.call = function (subscriber, source) {
        return source.subscribe(new SmooshScanSubscriber(subscriber, this.accumulator, this.seed, this.concurrent));
    };
    return SmooshScanOperator;
}());
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
 * @extends {Ignored}
 */
var SmooshScanSubscriber = /** @class */ (function (_super) {
    __extends(SmooshScanSubscriber, _super);
    function SmooshScanSubscriber(destination, accumulator, acc, concurrent) {
        var _this = _super.call(this, destination) || this;
        _this.accumulator = accumulator;
        _this.acc = acc;
        _this.concurrent = concurrent;
    ...
    SmooshScanSubscriber.prototype._next = function (value) {
        if (this.active < this.concurrent) {
            var index = this.index++;
    ...
    SmooshScanSubscriber.prototype._innerSub = function (ish, value, index) {
        this.add(subscribeToResult(this, ish, value, index));
    };
    SmooshScanSubscriber.prototype._complete = function () {
        this.hasCompleted = true;
        if (this.active === 0 && this.buffer.length === 0) {
    ...
    SmooshScanSubscriber.prototype.notifyNext = function (outerValue, innerValue, outerIndex, innerIndex, innerSub) {
        var destination = this.destination;
        this.acc = innerValue;
        this.hasValue = true;
        destination.next(innerValue);
    };
    SmooshScanSubscriber.prototype.notifyComplete = function (innerSub) {
        var buffer = this.buffer;
        this.remove(innerSub);
        this.active--;
        if (buffer.length > 0) {
...
var _operators = Object.freeze({
	...
	smooshMap: smooshMap,
	flatMap: smooshMap,
	smooshMapTo: smooshMapTo,
	smooshScan: smooshScan,
	min: min,
	multicast: multicast,
	observeOn: observeOn,
