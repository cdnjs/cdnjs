...
function shareReplay(bufferSize, windowTime, scheduler) {
    ...
    var hasError = false;
    var isComplete = true;
    return function (source) { return new Observable(function (observer) {
        refCount++;
        if (!subject || hasError) {
            hasError = false;
 ...
 * @owner Observable
 */
function publishReplay$1(bufferSize, windowTime, scheduler) {
    if (bufferSize === void 0) { bufferSize = Number.POSITIVE_INFINITY; }
    if (windowTime === void 0) { windowTime = Number.POSITIVE_INFINITY; }
    return publishReplay(bufferSize, windowTime, scheduler)(this);
}
