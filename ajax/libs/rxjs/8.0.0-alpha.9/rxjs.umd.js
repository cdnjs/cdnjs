...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function mergeMap(project, concurrent) {
        ...
        return function (source) { return new Observable(function (subscriber) { return mergeInternals(source, subscriber, project, concurrent); }); };
    }
    ...
    function reduce(accumulator, seed) {
        ...
        return function (source) { return new Observable(function (subscriber) { return scanInternals(accumulator, seed, hasSeed, false, true, source, subscriber); }); };
    }
    ...
    function combineLatestWith() {
        ...
        return function (source) { return new Observable(function (subscriber) { return combineLatestInit(__spreadArray([source], __read(otherSources), false))(subscriber); }); };
    }
    ...
    function find(predicate) {
        return function (source) { return new Observable(function (subscriber) { return createFind(predicate, 'value', source, subscriber); }); };
    }
    ...
    function findIndex(predicate) {
        return function (source) { return new Observable(function (subscriber) { return createFind(predicate, 'index', source, subscriber); }); };
    }
    ...
    function onErrorResumeNextWith() {
        ...
        var nextSources = argsOrArgArray(sources);
        return function (source) { return onErrorResumeNext.apply(void 0, __spreadArray([source], __read(nextSources), false)); };
    }
    ...
    function scan(accumulator, seed) {
        var hasSeed = arguments.length >= 2;
        return function (source) { return new Observable(function (subscriber) { return scanInternals(accumulator, seed, hasSeed, true, false, source, subscriber); }); };
    }
