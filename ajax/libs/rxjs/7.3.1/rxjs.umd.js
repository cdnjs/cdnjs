    ...
    ***************************************************************************** */
    ...
    function combineLatest$1() {
        ...
        return resultSelector
            ? pipe(combineLatest$1.apply(void 0, __spreadArray([], __read(args), false)), mapOneOrManyArgs(resultSelector))
    ...
    function combineLatestWith() {
        ...
        return combineLatest$1.apply(void 0, __spreadArray([], __read(otherSources), false));
    }
    ...
    function concat$1() {
        ...
        var scheduler = popScheduler(args);
        return operate(function (source, subscriber) {
            concatAll()(from(__spreadArray([source], __read(args), false), scheduler)).subscribe(subscriber);
        });
    }
    ...
    function concatWith() {
        ...
        return concat$1.apply(void 0, __spreadArray([], __read(otherSources), false));
    }
    ...
    function endWith() {
        ...
        return function (source) { return concat(source, of.apply(void 0, __spreadArray([], __read(values), false))); };
    }
    ...
    function mergeWith() {
        ...
        return merge$1.apply(void 0, __spreadArray([], __read(otherSources), false));
    }
    ...
    function handleReset(reset, on) {
        ...
        return on.apply(void 0, __spreadArray([], __read(args), false)).pipe(take(1))
    ...
    function zipWith() {
        ...
        return zip$1.apply(void 0, __spreadArray([], __read(otherInputs), false));
    }
    ...
    function race$1() {
        ...
        return raceWith.apply(void 0, __spreadArray([], __read(argsOrArgArray(args)), false));
    }
    ...
    function fromAjax(config) {
        return new Observable(function (destination) {
            ...
            var _request = __assign(__assign({ async: true, crossDomain: true, withCredentials: false, method: 'GET', timeout: 0, responseType: 'json' }, remainingConfig), { url: url, headers: headers, body: body });
            var xhr;
