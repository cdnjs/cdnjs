    ...
    ***************************************************************************** */
    ...
    var Subscription = (function () {
        ...
        Subscription.prototype.add = function (teardown) {
            ...
            if (teardown && teardown !== this) {
                if (this.closed) {
                    ...
                    (this._teardowns = (_a = this._teardowns) !== null && _a !== void 0 ? _a : new Set()).add(teardown);
                }
            }
        };
        ...
        Subscription.prototype.remove = function (teardown) {
            var _a;
            (_a = this._teardowns) === null || _a === void 0 ? void 0 : _a.delete(teardown);
            if (teardown instanceof Subscription) {
    ...
    var Subscriber = (function (_super) {
        ...
        Subscriber.create = function (next, error, complete) {
            return new SafeSubscriber({ next: next, error: error, complete: complete });
        };
    ...
    var SafeSubscriber = (function (_super) {
        ...
        function SafeSubscriber(observerOrNext) {
            var _a, _b, _c;
            var _this = _super.call(this) || this;
            var next;
            var error;
            ...
            if (isFunction(observerOrNext)) {
                ...
                next = (_a = observerOrNext.next) === null || _a === void 0 ? void 0 : _a.bind(observerOrNext);
                error = (_b = observerOrNext.error) === null || _b === void 0 ? void 0 : _b.bind(observerOrNext);
                complete = (_c = observerOrNext.complete) === null || _c === void 0 ? void 0 : _c.bind(observerOrNext);
            }
            _this.destination = {
    ...
    var Observable = (function () {
        ...
        Observable.prototype.subscribe = function (observerOrNext) {
            var subscriber = isSubscriber(observerOrNext) ? observerOrNext : new SafeSubscriber(observerOrNext);
