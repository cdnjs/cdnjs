...
N?c.errors:c)},[])}function na(b){var a=b.subject;a.next(b.value);a.complete()}function ob(b){b.subject.error(b.err)}function pb(b){var a=this,c=b.source,e=b.subscriber;b=b.context;var d=c.callbackFunc,f=c.args,k=c.scheduler,g=c.subject;if(!g){var g=c.subject=new K,h=function qb(){for(var c=[],b=0;b<arguments.length;b++)c[b-0]=arguments[b];var e=qb.source,b=e.selector,e=e.subject,d=c.shift();d?a.add(k.schedule(da,0,{err:d,subject:e})):b?(c=r(b).apply(this,c),c===m?a.add(k.schedule(da,0,{err:m.e,subject:e})):
a.add(k.schedule(oa,0,{value:c,subject:e}))):a.add(k.schedule(oa,0,{value:1>=c.length?c[0]:c,subject:e}))};h.source=c;r(d).apply(b,f.concat(h))===m&&a.add(k.schedule(da,0,{err:m.e,subject:g}))}a.add(g.subscribe(e))}function oa(b){var a=b.subject;a.next(b.value);a.complete()}function da(b){b.subject.error(b.err)}function z(b){return b&&"function"===typeof b.schedule}function pa(b){return b&&"function"!==typeof b.subscribe&&"function"===typeof b.then}function p(b,a,c,e){var d=new qa(b,c,e);if(d.closed)return null;
...
u.EMPTY;if(this.isStopped)return c.complete(),u.EMPTY;this.observers.push(c);return new Na(this,c)};a.prototype.asObservable=function(){var c=new g;c.source=this;return c};a.create=function(c,a){return new Z(c,a)};return a}(g),Z=function(b){function a(c,a){b.call(this);this.destination=c;this.source=a}h(a,b);a.prototype.next=function(c){var a=this.destination;a&&a.next&&a.next(c)};a.prototype.error=function(c){var a=this.destination;a&&a.error&&this.destination.error(c)};a.prototype.complete=function(){var c=
...
(this.value=c,this.hasNext=!0)};a.prototype.error=function(c){this.hasCompleted||b.prototype.error.call(this,c)};a.prototype.complete=function(){this.hasCompleted=!0;this.hasNext&&b.prototype.next.call(this,this.value);b.prototype.complete.call(this)};return a}(v),Vb=function(b){function a(c,a,d,f,k){b.call(this);this.callbackFunc=c;this.selector=a;this.args=d;this.context=f;this.scheduler=k}h(a,b);a.create=function(c,b,d){void 0===b&&(b=void 0);return function(){for(var e=[],k=0;k<arguments.length;k++)e[k-
0]=arguments[k];return new a(c,b,e,this,d)}};a.prototype._subscribe=function(c){var b=this.callbackFunc,d=this.args,f=this.scheduler,k=this.subject;if(f)return f.schedule(a.dispatch,0,{source:this,subscriber:c,context:this.context});k||(k=this.subject=new K,f=function C(){for(var c=[],a=0;a<arguments.length;a++)c[a-0]=arguments[a];var b=C.source,a=b.selector,b=b.subject;a?(c=r(a).apply(this,c),c===m?b.error(m.e):(b.next(c),b.complete())):(b.next(1>=c.length?c[0]:c),b.complete())},f.source=this,r(b).apply(this.context,
d.concat(f))===m&&k.error(m.e));return k.subscribe(c)};a.dispatch=function(c){var a=this,b=c.source,f=c.subscriber;c=c.context;var k=b.callbackFunc,g=b.args,h=b.scheduler,B=b.subject;if(!B){var B=b.subject=new K,l=function rb(){for(var c=[],b=0;b<arguments.length;b++)c[b-0]=arguments[b];var e=rb.source,b=e.selector,e=e.subject;b?(c=r(b).apply(this,c),c===m?a.add(h.schedule(ob,0,{err:m.e,subject:e})):a.add(h.schedule(na,0,{value:c,subject:e}))):a.add(h.schedule(na,0,{value:1>=c.length?c[0]:c,subject:e}))};
l.source=b;r(k).apply(c,g.concat(l))===m&&B.error(m.e)}a.add(B.subscribe(f))};return a}(g).create;g.bindCallback=Vb;var Wb=function(b){function a(c,a,d,f,k){b.call(this);this.callbackFunc=c;this.selector=a;this.args=d;this.context=f;this.scheduler=k}h(a,b);a.create=function(c,b,d){void 0===b&&(b=void 0);return function(){for(var e=[],k=0;k<arguments.length;k++)e[k-0]=arguments[k];return new a(c,b,e,this,d)}};a.prototype._subscribe=function(c){var a=this.callbackFunc,b=this.args,f=this.scheduler,k=
this.subject;if(f)return f.schedule(pb,0,{source:this,subscriber:c,context:this.context});k||(k=this.subject=new K,f=function C(){for(var c=[],a=0;a<arguments.length;a++)c[a-0]=arguments[a];var b=C.source,a=b.selector,b=b.subject,e=c.shift();e?b.error(e):a?(c=r(a).apply(this,c),c===m?b.error(m.e):(b.next(c),b.complete())):(b.next(1>=c.length?c[0]:c),b.complete())},f.source=this,r(a).apply(this.context,b.concat(f))===m&&k.error(m.e));return k.subscribe(c)};return a}(g).create;g.bindNodeCallback=Wb;
var ga=function(b){function a(c,a){b.call(this);this.value=c;this.scheduler=a;this._isScalar=!0;a&&(this._isScalar=!1)}h(a,b);a.create=function(c,b){return new a(c,b)};a.dispatch=function(c){var a=c.value,b=c.subscriber;c.done?b.complete():(b.next(a),b.closed||(c.done=!0,this.schedule(c)))};a.prototype._subscribe=function(c){var b=this.value,d=this.scheduler;if(d)return d.schedule(a.dispatch,0,{done:!1,value:b,subscriber:c});c.next(b);c.closed||c.complete()};return a}(g),F=function(b){function a(c){b.call(this);
this.scheduler=c}h(a,b);a.create=function(c){return new a(c)};a.dispatch=function(c){c.subscriber.complete()};a.prototype._subscribe=function(c){var b=this.scheduler;if(b)return b.schedule(a.dispatch,0,{subscriber:c});c.complete()};return a}(g),E=function(b){function a(c,a){b.call(this);this.array=c;this.scheduler=a;a||1!==c.length||(this._isScalar=!0,this.value=c[0])}h(a,b);a.create=function(c,b){return new a(c,b)};a.of=function(){for(var c=[],b=0;b<arguments.length;b++)c[b-0]=arguments[b];b=c[c.length-
...
Pa={},ha=function(){function b(a){this.project=a}b.prototype.call=function(a,c){return c.subscribe(new Xb(a,this.project))};return b}(),Xb=function(b){function a(c,a){b.call(this,c);this.project=a;this.active=0;this.values=[];this.observables=[]}h(a,b);a.prototype._next=function(c){this.values.push(Pa);this.observables.push(c)};a.prototype._complete=function(){var c=this.observables,a=c.length;if(0===a)this.destination.complete();else{this.toRespond=this.active=a;for(var b=0;b<a;b++){var f=c[b];this.add(p(this,
f,f,b))}}};a.prototype.notifyComplete=function(c){0===--this.active&&this.destination.complete()};a.prototype.notifyNext=function(c,a,b,f,k){c=this.values;f=c[b];f=this.toRespond?f===Pa?--this.toRespond:this.toRespond:0;c[b]=a;0===f&&(this.project?this._tryProject(c):this.destination.next(c.slice()))};a.prototype._tryProject=function(c){var a;try{a=this.project.apply(this,c)}catch(d){this.destination.error(d);return}this.destination.next(a)};return a}(q);g.combineLatest=function(){for(var b=[],a=
0;a<arguments.length;a++)b[a-0]=arguments[a];var c=a=null;z(b[b.length-1])&&(c=b.pop());"function"===typeof b[b.length-1]&&(a=b.pop());1===b.length&&D(b[0])&&(b=b[0]);return(new E(b,c)).lift(new ha(a))};var W=function(){function b(a){this.concurrent=a}b.prototype.call=function(a,c){return c.subscribe(new Yb(a,this.concurrent))};return b}(),Yb=function(b){function a(c,a){b.call(this,c);this.concurrent=a;this.hasCompleted=!1;this.buffer=[];this.active=0}h(a,b);a.prototype._next=function(c){this.active<
this.concurrent?(this.active++,this.add(p(this,c))):this.buffer.push(c)};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&0===this.buffer.length&&this.destination.complete()};a.prototype.notifyComplete=function(c){var a=this.buffer;this.remove(c);this.active--;0<a.length?this._next(a.shift()):0===this.active&&this.hasCompleted&&this.destination.complete()};return a}(q);g.concat=O;var $b=function(b){function a(c){b.call(this);this.observableFactory=c}h(a,b);a.create=function(c){return new a(c)};
a.prototype._subscribe=function(c){return new Zb(c,this.observableFactory)};return a}(g),Zb=function(b){function a(c,a){b.call(this,c);this.factory=a;this.tryDefer()}h(a,b);a.prototype.tryDefer=function(){try{this._callFactory()}catch(c){this._error(c)}};a.prototype._callFactory=function(){var c=this.factory();c&&this.add(p(this,c))};return a}(q);g.defer=$b.create;g.empty=F.create;var bc=function(b){function a(c,a){b.call(this);this.sources=c;this.resultSelector=a}h(a,b);a.create=function(){for(var c=
...
isNaN(e)?e:0>e?-1:1;b=e*Math.floor(Math.abs(b));b=0>=b?0:b>Ra?Ra:b}this.arr=a;this.idx=c;this.len=b}b.prototype[A]=function(){return this};b.prototype.next=function(){return this.idx<this.len?{done:!1,value:this.arr[this.idx++]}:{done:!0,value:void 0}};return b}(),Ra=Math.pow(2,53)-1,fc=function(b){function a(c,a){b.call(this);this.arrayLike=c;this.scheduler=a;a||1!==c.length||(this._isScalar=!0,this.value=c[0])}h(a,b);a.create=function(c,b){var e=c.length;return 0===e?new F:1===e?new ga(c[0],b):
...
b)}throw new TypeError((null!==c&&typeof c||c)+" is not observable");};a.prototype._subscribe=function(c){var a=this.ish,b=this.scheduler;return null==b?a[H]().subscribe(c):a[H]().subscribe(new ia(c,b,0))};return a}(g);g.from=Sa.create;var Ta=Object.prototype.toString,ic=function(b){function a(c,a,d,f){b.call(this);this.sourceObj=c;this.eventName=a;this.selector=d;this.options=f}h(a,b);a.create=function(c,b,d,f){M(d)&&(f=d,d=void 0);return new a(c,b,f,d)};a.setupSubscription=function(c,b,d,f,k){var e;
if(c&&"[object NodeList]"===Ta.call(c)||c&&"[object HTMLCollection]"===Ta.call(c))for(var g=0,h=c.length;g<h;g++)a.setupSubscription(c[g],b,d,f,k);else if(c&&"function"===typeof c.addEventListener&&"function"===typeof c.removeEventListener)c.addEventListener(b,d,k),e=function(){return c.removeEventListener(b,d)};else if(c&&"function"===typeof c.on&&"function"===typeof c.off)c.on(b,d),e=function(){return c.off(b,d)};else if(c&&"function"===typeof c.addListener&&"function"===typeof c.removeListener)c.addListener(b,
...
null}catch(d){a.error(d)}};return a}(g).create;g.fromEventPattern=jc;g.fromPromise=Qa.create;var Ua=function(b){return b},kc=function(b){function a(c,a,d,f,k){b.call(this);this.initialState=c;this.condition=a;this.iterate=d;this.resultSelector=f;this.scheduler=k}h(a,b);a.create=function(c,b,d,f,k){return 1==arguments.length?new a(c.initialState,c.condition,c.iterate,c.resultSelector||Ua,c.scheduler):void 0===f||z(f)?new a(c,b,d,Ua,f):new a(c,b,d,f,k)};a.prototype._subscribe=function(c){var b=this.initialState;
if(this.scheduler)return this.scheduler.schedule(a.dispatch,0,{subscriber:c,iterate:this.iterate,condition:this.condition,resultSelector:this.resultSelector,state:b});var d=this.condition,f=this.resultSelector,k=this.iterate;do{if(d){var g=void 0;try{g=d(b)}catch(C){c.error(C);break}if(!g){c.complete();break}}g=void 0;try{g=f(b)}catch(C){c.error(C);break}c.next(g);if(c.closed)break;try{b=k(b)}catch(C){c.error(C);break}}while(1)};a.dispatch=function(c){var a=c.subscriber,b=c.condition;if(!a.closed){if(c.needIterate)try{c.state=
...
null;this.pending=!1;this.scheduler=null;-1!==f&&b.splice(f,1);null!=c&&(this.id=this.recycleAsyncId(a,c,null))};return a}(function(b){function a(c,a){b.call(this)}h(a,b);a.prototype.schedule=function(c,a){return this};return a}(u)),S=function(b){function a(){b.apply(this,arguments);this.actions=[];this.active=!1;this.scheduled=void 0}h(a,b);a.prototype.flush=function(c){var a=this.actions;if(this.active)a.push(c);else{var b;this.active=!0;do if(b=c.execute(c.state,c.delay))break;while(c=a.shift());
...
typeof a.schedule||(this.scheduler=x)}h(a,b);a.create=function(c,b){void 0===c&&(c=0);void 0===b&&(b=x);return new a(c,b)};a.dispatch=function(c){var a=c.subscriber,b=c.period;a.next(c.index);a.closed||(c.index+=1,this.schedule(c,b))};a.prototype._subscribe=function(c){var b=this.period;c.add(this.scheduler.schedule(a.dispatch,b,{index:0,subscriber:c,period:b}))};return a}(g).create;g.interval=nc;g.merge=sa;var tb=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new oc(a))};
return b}(),oc=function(b){function a(c){b.call(this,c);this.hasFirst=!1;this.observables=[];this.subscriptions=[]}h(a,b);a.prototype._next=function(c){this.observables.push(c)};a.prototype._complete=function(){var c=this.observables,a=c.length;if(0===a)this.destination.complete();else{for(var b=0;b<a&&!this.hasFirst;b++){var f=c[b],f=p(this,f,f,b);this.subscriptions&&this.subscriptions.push(f);this.add(f)}this.observables=null}};a.prototype.notifyNext=function(c,a,b,f,k){if(!this.hasFirst){this.hasFirst=
!0;for(c=0;c<this.subscriptions.length;c++)c!==b&&(f=this.subscriptions[c],f.unsubscribe(),this.remove(f));this.subscriptions=null}this.destination.next(a)};return a}(q);g.race=ta;var pc=function(b){function a(){b.call(this)}h(a,b);a.create=function(){return new a};a.prototype._subscribe=function(c){};return a}(g).create;g.never=pc;g.of=E.of;var Va=function(){function b(a){this.nextSources=a}b.prototype.call=function(a,c){return c.subscribe(new qc(a,this.nextSources))};return b}(),qc=function(b){function a(c,
a){b.call(this,c);this.destination=c;this.nextSources=a}h(a,b);a.prototype.notifyError=function(c,a){this.subscribeToNextSource()};a.prototype.notifyComplete=function(c){this.subscribeToNextSource()};a.prototype._error=function(c){this.subscribeToNextSource()};a.prototype._complete=function(){this.subscribeToNextSource()};a.prototype.subscribeToNextSource=function(){var c=this.nextSources.shift();c?this.add(p(this,c)):this.destination.complete()};return a}(q);g.onErrorResumeNext=function(){for(var b=
[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];1===b.length&&D(b[0])&&(b=b[0]);a=b.shift();return(new Sa(a,null)).lift(new Va(b))};var rc=function(b){function a(c,a){b.call(this);this.obj=c;this.scheduler=a;this.keys=Object.keys(c)}h(a,b);a.create=function(c,b){return new a(c,b)};a.prototype._subscribe=function(c){var a=this.keys,b=this.scheduler,f=a.length;if(b)return b.schedule(ub,0,{obj:this.obj,keys:a,length:f,index:0,subscriber:c});for(b=0;b<f;b++){var k=a[b];c.next([k,this.obj[k]])}c.complete()};
return a}(g).create;g.pairs=rc;var sc=function(b){function a(c,a,d){b.call(this);this.start=c;this._count=a;this.scheduler=d}h(a,b);a.create=function(c,b,d){void 0===c&&(c=0);void 0===b&&(b=0);return new a(c,b,d)};a.dispatch=function(c){var a=c.start,b=c.index,f=c.subscriber;b>=c.count?f.complete():(f.next(a),f.closed||(c.index=b+1,c.start=a+1,this.schedule(c)))};a.prototype._subscribe=function(c){var b=0,d=this.start,f=this._count,k=this.scheduler;if(k)return k.schedule(a.dispatch,0,{index:b,count:f,
start:d,subscriber:c});do{if(b++>=f){c.complete();break}c.next(d++);if(c.closed)break}while(1)};return a}(g).create;g.range=sc;var uc=function(b){function a(c,a){b.call(this);this.resourceFactory=c;this.observableFactory=a}h(a,b);a.create=function(c,b){return new a(c,b)};a.prototype._subscribe=function(c){var a=this.resourceFactory,b=this.observableFactory,f;try{return f=a(),new tc(c,f,b)}catch(k){c.error(k)}};return a}(g),tc=function(b){function a(c,a,d){b.call(this,c);this.resource=a;this.observableFactory=
d;c.add(a);this.tryUse()}h(a,b);a.prototype.tryUse=function(){try{var c=this.observableFactory.call(this,this.resource);c&&this.add(p(this,c))}catch(e){this._error(e)}};return a}(q);g.using=uc.create;var vc=function(b){function a(c,a){b.call(this);this.error=c;this.scheduler=a}h(a,b);a.create=function(c,b){return new a(c,b)};a.dispatch=function(c){c.subscriber.error(c.error)};a.prototype._subscribe=function(c){var b=this.error,d=this.scheduler;if(d)return d.schedule(a.dispatch,0,{error:b,subscriber:c});
c.error(b)};return a}(g).create;g.throw=vc;var wc=function(b){function a(c,a,d){void 0===c&&(c=0);b.call(this);this.period=-1;this.dueTime=0;P(a)?this.period=1>Number(a)&&1||Number(a):z(a)&&(d=a);z(d)||(d=x);this.scheduler=d;this.dueTime=X(c)?+c-this.scheduler.now():c}h(a,b);a.create=function(c,b,d){void 0===c&&(c=0);return new a(c,b,d)};a.dispatch=function(c){var a=c.index,b=c.period,f=c.subscriber;f.next(a);if(!f.closed){if(-1===b)return f.complete();c.index=a+1;this.schedule(c,b)}};a.prototype._subscribe=
function(c){return this.scheduler.schedule(a.dispatch,this.dueTime,{index:0,period:this.period,subscriber:c})};return a}(g).create;g.timer=wc;var va=function(){function b(a){this.project=a}b.prototype.call=function(a,c){return c.subscribe(new xc(a,this.project))};return b}(),xc=function(b){function a(c,a,d){void 0===d&&(d=Object.create(null));b.call(this,c);this.iterators=[];this.active=0;this.project="function"===typeof a?a:null;this.values=d}h(a,b);a.prototype._next=function(c){var a=this.iterators;
...
b=this.destination,f=0;f<a;f++){var k=c[f];if("function"===typeof k.hasValue&&!k.hasValue())return}for(var g=!1,h=[],f=0;f<a;f++){var k=c[f],l=k.next();k.hasCompleted()&&(g=!0);if(l.done){b.complete();return}h.push(l.value)}this.project?this._tryProject(h):b.next(h);g&&b.complete()};a.prototype._tryProject=function(c){var a;try{a=this.project.apply(this,c)}catch(d){this.destination.error(d);return}this.destination.next(a)};return a}(l),zc=function(){function b(a){this.iterator=a;this.nextResult=a.next()}
...
(c["Content-Type"]="application/x-www-form-urlencoded; charset\x3dUTF-8");a.body=this.serializeBody(a.body,a.headers["Content-Type"]);this.send()}h(a,b);a.prototype.next=function(c){this.done=!0;var a=this.destination;c=new Wa(c,this.xhr,this.request);a.next(c)};a.prototype.send=function(){var c=this.request,a=this.request,b=a.user,f=a.method,k=a.url,g=a.async,h=a.password,l=a.headers,a=a.body,n=r(c.createXHR).call(c);if(n===m)this.error(m.e);else{this.xhr=n;this.setupEvents(n,c);b=b?r(n.open).call(n,
f,k,g,b,h):r(n.open).call(n,f,k,g);if(b===m)return this.error(m.e),null;n.timeout=c.timeout;n.responseType=c.responseType;"withCredentials"in n&&(n.withCredentials=!!c.withCredentials);this.setHeaders(n,l);b=a?r(n.send).call(n,a):r(n.send).call(n);if(b===m)return this.error(m.e),null}return n};a.prototype.serializeBody=function(c,a){if(!c||"string"===typeof c||n.FormData&&c instanceof n.FormData)return c;if(a){var b=a.indexOf(";");-1!==b&&(a=a.substring(0,b))}switch(a){case "application/x-www-form-urlencoded":return Object.keys(c).map(function(a){return encodeURI(a)+
"\x3d"+encodeURI(c[a])}).join("\x26");case "application/json":return JSON.stringify(c);default:return c}};a.prototype.setHeaders=function(c,a){for(var b in a)a.hasOwnProperty(b)&&c.setRequestHeader(b,a[b])};a.prototype.setupEvents=function(c,a){function b(c){var a=b.subscriber,e=b.progressSubscriber,d=b.request;e&&e.error(c);a.error(new Xa(this,d))}function e(c){var a=e.subscriber,b=e.progressSubscriber,d=e.request;if(4===this.readyState){var f=1223===this.status?204:this.status,k="text"===this.responseType?
this.response||this.responseText:this.response;0===f&&(f=k?200:0);200<=f&&300>f?(b&&b.complete(),a.next(c),a.complete()):(b&&b.error(c),a.error(new aa("ajax error "+f,this,d)))}}var k=a.progressSubscriber;c.ontimeout=b;b.request=a;b.subscriber=this;b.progressSubscriber=k;if(c.upload&&"withCredentials"in c){if(k){var g;g=function(c){g.progressSubscriber.next(c)};n.XDomainRequest?c.onprogress=g:c.upload.onprogress=g;g.progressSubscriber=k}var h;h=function(c){var a=h.progressSubscriber,b=h.subscriber,
e=h.request;a&&a.error(c);b.error(new aa("ajax error",this,e))};c.onerror=h;h.request=a;h.subscriber=this;h.progressSubscriber=k}c.onreadystatechange=e;e.subscriber=this;e.progressSubscriber=k;e.request=a};a.prototype.unsubscribe=function(){var c=this.xhr;!this.done&&c&&4!==c.readyState&&"function"===typeof c.abort&&c.abort();b.prototype.unsubscribe.call(this)};return a}(l),Wa=function(){return function(b,a,c){this.originalEvent=b;this.xhr=a;this.request=c;this.status=a.status;this.responseType=a.responseType||
c.responseType;switch(this.responseType){case "json":this.response="response"in a?a.responseType?a.response:JSON.parse(a.response||a.responseText||"null"):JSON.parse(a.responseText||"null");break;case "xml":this.response=a.responseXML;break;default:this.response="response"in a?a.response:a.responseText}}}(),aa=function(b){function a(c,a,d){b.call(this,c);this.message=c;this.xhr=a;this.request=d;this.status=a.status}h(a,b);return a}(Error),Xa=function(b){function a(c,a){b.call(this,"ajax timeout",
c,a)}h(a,b);return a}(aa);g.ajax=I.create;var Dc=function(b){function a(c,a){b.call(this,c,a);this.scheduler=c;this.work=a}h(a,b);a.prototype.schedule=function(c,a){void 0===a&&(a=0);if(0<a)return b.prototype.schedule.call(this,c,a);this.delay=a;this.state=c;this.scheduler.flush(this);return this};a.prototype.execute=function(c,a){return 0<a||this.closed?b.prototype.execute.call(this,c,a):this._execute(c,a)};a.prototype.requestAsyncId=function(c,a,d){void 0===d&&(d=0);return null!==d&&0<d||null===
d&&0<this.delay?b.prototype.requestAsyncId.call(this,c,a,d):c.flush(this)};return a}(R),Ya=new (function(b){function a(){b.apply(this,arguments)}h(a,b);return a}(S))(Dc),L=function(b){function a(c,a,d){void 0===c&&(c=Number.POSITIVE_INFINITY);void 0===a&&(a=Number.POSITIVE_INFINITY);b.call(this);this.scheduler=d;this._events=[];this._bufferSize=1>c?1:c;this._windowTime=1>a?1:a}h(a,b);a.prototype.next=function(c){var a=this._getNow();this._events.push(new Ec(a,c));this._trimBufferThenGetEvents();b.prototype.next.call(this,
c)};a.prototype._subscribe=function(c){var a=this._trimBufferThenGetEvents(),b=this.scheduler,f;if(this.closed)throw new G;this.hasError?f=u.EMPTY:this.isStopped?f=u.EMPTY:(this.observers.push(c),f=new Na(this,c));b&&c.add(c=new ia(c,b));for(var b=a.length,k=0;k<b&&!c.closed;k++)c.next(a[k].value);this.hasError?c.error(this.thrownError):this.isStopped&&c.complete();return f};a.prototype._getNow=function(){return(this.scheduler||Ya).now()};a.prototype._trimBufferThenGetEvents=function(){for(var c=
...
this.destination=new L}}h(a,b);a.prototype.resultSelector=function(c){return JSON.parse(c.data)};a.create=function(c){return new a(c)};a.prototype.lift=function(c){var b=new a(this,this.destination);b.operator=c;return b};a.prototype._resetState=function(){this.socket=null;this.source||(this.destination=new L);this._output=new v};a.prototype.multiplex=function(c,a,b){var e=this;return new g(function(d){var f=r(c)();f===m?d.error(m.e):e.next(f);var k=e.subscribe(function(c){var a=r(b)(c);a===m?d.error(m.e):
a&&d.next(c)},function(c){return d.error(c)},function(){return d.complete()});return function(){var c=r(a)();c===m?d.error(m.e):e.next(c);k.unsubscribe()}})};a.prototype._connectSocket=function(){var c=this,a=this.WebSocketCtor,b=this._output,f=null;try{this.socket=f=this.protocol?new a(this.url,this.protocol):new a(this.url),this.binaryType&&(this.socket.binaryType=this.binaryType)}catch(y){b.error(y);return}var k=new u(function(){c.socket=null;f&&1===f.readyState&&f.close()});f.onopen=function(a){var e=
c.openObserver;e&&e.next(a);a=c.destination;c.destination=l.create(function(c){return 1===f.readyState&&f.send(c)},function(a){var e=c.closingObserver;e&&e.next(void 0);a&&a.code?f.close(a.code,a.reason):b.error(new TypeError("WebSocketSubject.error must be called with an object with an error code, and an optional reason: { code: number, reason: string }"));c._resetState()},function(){var a=c.closingObserver;a&&a.next(void 0);f.close();c._resetState()});a&&a instanceof L&&k.add(a.subscribe(c.destination))};
...
return b};a.prototype.unsubscribe=function(){var c=this.source,a=this.socket;a&&1===a.readyState&&(a.close(),this._resetState());b.prototype.unsubscribe.call(this);c||(this.destination=new L)};return a}(Z).create;g.webSocket=Gc;var Ic=function(){function b(a){this.closingNotifier=a}b.prototype.call=function(a,c){return c.subscribe(new Hc(a,this.closingNotifier))};return b}(),Hc=function(b){function a(c,a){b.call(this,c);this.buffer=[];this.add(p(this,a))}h(a,b);a.prototype._next=function(c){this.buffer.push(c)};
a.prototype.notifyNext=function(c,a,b,f,k){c=this.buffer;this.buffer=[];this.destination.next(c)};return a}(q);g.prototype.buffer=function(b){return this.lift(new Ic(b))};var Kc=function(){function b(a,c){this.bufferSize=a;this.startBufferEvery=c}b.prototype.call=function(a,c){return c.subscribe(new Jc(a,this.bufferSize,this.startBufferEvery))};return b}(),Jc=function(b){function a(c,a,d){b.call(this,c);this.bufferSize=a;this.startBufferEvery=d;this.buffers=[];this.count=0}h(a,b);a.prototype._next=
function(c){var a=this.count++,b=this.destination,f=this.bufferSize,k=this.startBufferEvery,g=this.buffers;0===a%(null==k?f:k)&&g.push([]);for(a=g.length;a--;)k=g[a],k.push(c),k.length===f&&(g.splice(a,1),b.next(k))};a.prototype._complete=function(){for(var c=this.destination,a=this.buffers;0<a.length;){var d=a.shift();0<d.length&&c.next(d)}b.prototype._complete.call(this)};return a}(l);g.prototype.bufferCount=function(b,a){void 0===a&&(a=null);return this.lift(new Kc(b,a))};var Mc=function(){function b(a,
c,b,d){this.bufferTimeSpan=a;this.bufferCreationInterval=c;this.maxBufferSize=b;this.scheduler=d}b.prototype.call=function(a,c){return c.subscribe(new Lc(a,this.bufferTimeSpan,this.bufferCreationInterval,this.maxBufferSize,this.scheduler))};return b}(),Nc=function(){return function(){this.buffer=[]}}(),Lc=function(b){function a(a,e,d,f,k){b.call(this,a);this.bufferTimeSpan=e;this.bufferCreationInterval=d;this.maxBufferSize=f;this.scheduler=k;this.contexts=[];a=this.openContext();(this.timespanOnly=
null==d||0>d)?this.add(a.closeAction=k.schedule(ya,e,{subscriber:this,context:a,bufferTimeSpan:e})):(f={bufferTimeSpan:e,bufferCreationInterval:d,subscriber:this,scheduler:k},this.add(a.closeAction=k.schedule(za,e,{subscriber:this,context:a})),this.add(k.schedule(Cb,d,f)))}h(a,b);a.prototype._next=function(a){for(var c=this.contexts,b=c.length,f,k=0;k<b;k++){var g=c[k],h=g.buffer;h.push(a);h.length==this.maxBufferSize&&(f=g)}if(f)this.onBufferFull(f)};a.prototype._error=function(a){this.contexts.length=
...
g.prototype.bufferToggle=function(b,a){return this.lift(new Pc(b,a))};var Rc=function(){function b(a){this.closingSelector=a}b.prototype.call=function(a,c){return c.subscribe(new Qc(a,this.closingSelector))};return b}(),Qc=function(b){function a(a,e){b.call(this,a);this.closingSelector=e;this.subscribing=!1;this.openBuffer()}h(a,b);a.prototype._next=function(a){this.buffer.push(a)};a.prototype._complete=function(){var a=this.buffer;a&&this.destination.next(a);b.prototype._complete.call(this)};a.prototype._unsubscribe=
...
this.concurrent){var c=this.resultSelector,b=this.index++,f=this.ish,k=this.destination;this.active++;this._innerSub(f,k,c,a,b)}else this.buffer.push(a)};a.prototype._innerSub=function(a,b,d,f,k){this.add(p(this,a,f,k))};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&0===this.buffer.length&&this.destination.complete()};a.prototype.notifyNext=function(a,b,d,f,k){k=this.destination;this.resultSelector?this.trySelectResult(a,b,d,f):k.next(b)};a.prototype.trySelectResult=function(a,
b,d,f){var c=this.resultSelector,e=this.destination,g;try{g=c(a,b,d,f)}catch(B){e.error(B);return}e.next(g)};a.prototype.notifyError=function(a){this.destination.error(a)};a.prototype.notifyComplete=function(a){var c=this.buffer;this.remove(a);this.active--;0<c.length?this._next(c.shift()):0===this.active&&this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.concatMapTo=function(b,a){return this.lift(new Ea(b,a,1))};var Wc=function(){function b(a,c){this.predicate=a;this.source=
c}b.prototype.call=function(a,c){return c.subscribe(new Vc(a,this.predicate,this.source))};return b}(),Vc=function(b){function a(a,e,d){b.call(this,a);this.predicate=e;this.source=d;this.index=this.count=0}h(a,b);a.prototype._next=function(a){this.predicate?this._tryPredicate(a):this.count++};a.prototype._tryPredicate=function(a){var c;try{c=this.predicate(a,this.index++,this.source)}catch(d){this.destination.error(d);return}c&&this.count++};a.prototype._complete=function(){this.destination.next(this.count);
this.destination.complete()};return a}(l);g.prototype.count=function(b){return this.lift(new Wc(b,this))};var Yc=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new Xc(a))};return b}(),Xc=function(b){function a(a){b.call(this,a)}h(a,b);a.prototype._next=function(a){a.observe(this.destination)};return a}(l);g.prototype.dematerialize=function(){return this.lift(new Yc)};var $c=function(){function b(a){this.durationSelector=a}b.prototype.call=function(a,c){return c.subscribe(new Zc(a,
this.durationSelector))};return b}(),Zc=function(b){function a(a,e){b.call(this,a);this.durationSelector=e;this.hasValue=!1;this.durationSubscription=null}h(a,b);a.prototype._next=function(a){try{var c=this.durationSelector.call(this,a);c&&this._tryNext(a,c)}catch(d){this.destination.error(d)}};a.prototype._complete=function(){this.emitValue();this.destination.complete()};a.prototype._tryNext=function(a,b){var c=this.durationSubscription;this.value=a;this.hasValue=!0;c&&(c.unsubscribe(),this.remove(c));
c=p(this,b);c.closed||this.add(this.durationSubscription=c)};a.prototype.notifyNext=function(a,b,d,f,k){this.emitValue()};a.prototype.notifyComplete=function(){this.emitValue()};a.prototype.emitValue=function(){if(this.hasValue){var a=this.value,e=this.durationSubscription;e&&(this.durationSubscription=null,e.unsubscribe(),this.remove(e));this.value=null;this.hasValue=!1;b.prototype._next.call(this,a)}};return a}(q);g.prototype.debounce=function(b){return this.lift(new $c(b))};var bd=function(){function b(a,
c){this.dueTime=a;this.scheduler=c}b.prototype.call=function(a,c){return c.subscribe(new ad(a,this.dueTime,this.scheduler))};return b}(),ad=function(b){function a(a,e,d){b.call(this,a);this.dueTime=e;this.scheduler=d;this.lastValue=this.debouncedSubscription=null;this.hasValue=!1}h(a,b);a.prototype._next=function(a){this.clearDebounce();this.lastValue=a;this.hasValue=!0;this.add(this.debouncedSubscription=this.scheduler.schedule(Eb,this.dueTime,this))};a.prototype._complete=function(){this.debouncedNext();
...
c){return c.subscribe(new cd(a,this.defaultValue))};return b}(),cd=function(b){function a(a,e){b.call(this,a);this.defaultValue=e;this.isEmpty=!0}h(a,b);a.prototype._next=function(a){this.isEmpty=!1;this.destination.next(a)};a.prototype._complete=function(){this.isEmpty&&this.destination.next(this.defaultValue);this.destination.complete()};return a}(l);g.prototype.defaultIfEmpty=function(b){void 0===b&&(b=null);return this.lift(new dd(b))};var fd=function(){function b(a,c){this.delay=a;this.scheduler=
c}b.prototype.call=function(a,c){return c.subscribe(new ed(a,this.delay,this.scheduler))};return b}(),ed=function(b){function a(a,e,d){b.call(this,a);this.delay=e;this.scheduler=d;this.queue=[];this.errored=this.active=!1}h(a,b);a.dispatch=function(a){for(var c=a.source,b=c.queue,f=a.scheduler,k=a.destination;0<b.length&&0>=b[0].time-f.now();)b.shift().notification.observe(k);0<b.length?(c=Math.max(0,b[0].time-f.now()),this.schedule(a,c)):c.active=!1};a.prototype._schedule=function(c){this.active=
!0;this.add(c.schedule(a.dispatch,this.delay,{source:this,destination:this.destination,scheduler:c}))};a.prototype.scheduleNotification=function(a){if(!0!==this.errored){var c=this.scheduler;a=new gd(c.now()+this.delay,a);this.queue.push(a);!1===this.active&&this._schedule(c)}};a.prototype._next=function(a){this.scheduleNotification(w.createNext(a))};a.prototype._error=function(a){this.errored=!0;this.queue=[];this.destination.error(a)};a.prototype._complete=function(){this.scheduleNotification(w.createComplete())};
return a}(l),gd=function(){return function(b,a){this.time=b;this.notification=a}}();g.prototype.delay=function(b,a){void 0===a&&(a=x);b=X(b)?+b-a.now():Math.abs(b);return this.lift(new fd(b,a))};var Za=function(){function b(a){this.delayDurationSelector=a}b.prototype.call=function(a,c){return c.subscribe(new hd(a,this.delayDurationSelector))};return b}(),hd=function(b){function a(a,e){b.call(this,a);this.delayDurationSelector=e;this.completed=!1;this.delayNotifierSubscriptions=[];this.values=[]}h(a,
b);a.prototype.notifyNext=function(a,b,d,f,k){this.destination.next(a);this.removeSubscription(k);this.tryComplete()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype.notifyComplete=function(a){(a=this.removeSubscription(a))&&this.destination.next(a);this.tryComplete()};a.prototype._next=function(a){try{var c=this.delayDurationSelector(a);c&&this.tryDelay(c,a)}catch(d){this.destination.error(d)}};a.prototype._complete=function(){this.completed=!0;this.tryComplete()};a.prototype.removeSubscription=
function(a){a.unsubscribe();a=this.delayNotifierSubscriptions.indexOf(a);var c=null;-1!==a&&(c=this.values[a],this.delayNotifierSubscriptions.splice(a,1),this.values.splice(a,1));return c};a.prototype.tryDelay=function(a,b){a=p(this,a,b);this.add(a);this.delayNotifierSubscriptions.push(a);this.values.push(b)};a.prototype.tryComplete=function(){this.completed&&0===this.delayNotifierSubscriptions.length&&this.destination.complete()};return a}(q),jd=function(b){function a(a,e){b.call(this);this.source=
a;this.subscriptionDelay=e}h(a,b);a.prototype._subscribe=function(a){this.subscriptionDelay.subscribe(new id(a,this.source))};return a}(g),id=function(b){function a(a,e){b.call(this);this.parent=a;this.source=e;this.sourceSubscribed=!1}h(a,b);a.prototype._next=function(a){this.subscribeToSource()};a.prototype._error=function(a){this.unsubscribe();this.parent.error(a)};a.prototype._complete=function(){this.subscribeToSource()};a.prototype.subscribeToSource=function(){this.sourceSubscribed||(this.sourceSubscribed=
!0,this.unsubscribe(),this.source.subscribe(this.parent))};return a}(l);g.prototype.delayWhen=function(b,a){return a?(new jd(this,a)).lift(new Za(b)):this.lift(new Za(b))};var kd=n.Set||Fb(),md=function(){function b(a,c){this.keySelector=a;this.flushes=c}b.prototype.call=function(a,c){return c.subscribe(new ld(a,this.keySelector,this.flushes))};return b}(),ld=function(b){function a(a,e,d){b.call(this,a);this.keySelector=e;this.values=new kd;d&&this.add(p(this,d))}h(a,b);a.prototype.notifyNext=function(a,
b,d,f,k){this.values.clear()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype._next=function(a){this.keySelector?this._useKeySelector(a):this._finalizeNext(a,a)};a.prototype._useKeySelector=function(a){var c,b=this.destination;try{c=this.keySelector(a)}catch(f){b.error(f);return}this._finalizeNext(c,a)};a.prototype._finalizeNext=function(a,b){var c=this.values;c.has(a)||(c.add(a),this.destination.next(b))};return a}(q);g.prototype.distinct=function(b,a){return this.lift(new md(b,
a))};var Gb=function(){function b(a,c){this.compare=a;this.keySelector=c}b.prototype.call=function(a,c){return c.subscribe(new nd(a,this.compare,this.keySelector))};return b}(),nd=function(b){function a(a,e,d){b.call(this,a);this.keySelector=d;this.hasKey=!1;"function"===typeof e&&(this.compare=e)}h(a,b);a.prototype.compare=function(a,b){return a===b};a.prototype._next=function(a){var c=a;if(this.keySelector&&(c=r(this.keySelector)(a),c===m))return this.destination.error(m.e);var b=!1;if(this.hasKey){if(b=
...
this.hasSubscription||this.destination.complete()};a.prototype.notifyComplete=function(a){this.remove(a);this.hasSubscription=!1;this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.exhaust=function(){return this.lift(new qd)};var sd=function(){function b(a,c){this.project=a;this.resultSelector=c}b.prototype.call=function(a,c){return c.subscribe(new rd(a,this.project,this.resultSelector))};return b}(),rd=function(b){function a(a,e,d){b.call(this,a);this.project=e;this.resultSelector=
d;this.hasCompleted=this.hasSubscription=!1;this.index=0}h(a,b);a.prototype._next=function(a){this.hasSubscription||this.tryNext(a)};a.prototype.tryNext=function(a){var c=this.index++,b=this.destination;try{var f=this.project(a,c);this.hasSubscription=!0;this.add(p(this,f,a,c))}catch(k){b.error(k)}};a.prototype._complete=function(){this.hasCompleted=!0;this.hasSubscription||this.destination.complete()};a.prototype.notifyNext=function(a,b,d,f,k){k=this.destination;this.resultSelector?this.trySelectResult(a,
b,d,f):k.next(b)};a.prototype.trySelectResult=function(a,b,d,f){var c=this.resultSelector,e=this.destination;try{var g=c(a,b,d,f);e.next(g)}catch(B){e.error(B)}};a.prototype.notifyError=function(a){this.destination.error(a)};a.prototype.notifyComplete=function(a){this.remove(a);this.hasSubscription=!1;this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.exhaustMap=function(b,a){return this.lift(new sd(b,a))};var ud=function(){function b(a,c,b){this.project=a;this.concurrent=c;
this.scheduler=b}b.prototype.call=function(a,c){return c.subscribe(new td(a,this.project,this.concurrent,this.scheduler))};return b}(),td=function(b){function a(a,e,d,f){b.call(this,a);this.project=e;this.concurrent=d;this.scheduler=f;this.active=this.index=0;this.hasCompleted=!1;d<Number.POSITIVE_INFINITY&&(this.buffer=[])}h(a,b);a.dispatch=function(a){a.subscriber.subscribeToProjection(a.result,a.value,a.index)};a.prototype._next=function(c){var b=this.destination;if(b.closed)this._complete();else{var d=
this.index++;if(this.active<this.concurrent){b.next(c);var f=r(this.project)(c,d);f===m?b.error(m.e):this.scheduler?this.add(this.scheduler.schedule(a.dispatch,0,{subscriber:this,result:f,value:c,index:d})):this.subscribeToProjection(f,c,d)}else this.buffer.push(c)}};a.prototype.subscribeToProjection=function(a,b,d){this.active++;this.add(p(this,a,b,d))};a.prototype._complete=function(){(this.hasCompleted=!0,0===this.active)&&this.destination.complete()};a.prototype.notifyNext=function(a,b,d,f,k){this._next(b)};
a.prototype.notifyComplete=function(a){var c=this.buffer;this.remove(a);this.active--;c&&0<c.length&&this._next(c.shift());this.hasCompleted&&0===this.active&&this.destination.complete()};return a}(q);g.prototype.expand=function(b,a,c){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===c&&(c=void 0);a=1>(a||0)?Number.POSITIVE_INFINITY:a;return this.lift(new ud(b,a,c))};var T=function(b){function a(){var a=b.call(this,"argument out of range");this.name=a.name="ArgumentOutOfRangeError";this.stack=a.stack;
...
typeof this.defaultValue?a.next(this.defaultValue):a.error(new T));a.complete()};return a}(l);g.prototype.elementAt=function(b,a){return this.lift(new wd(b,a))};var Ib=function(){function b(a,c){this.predicate=a;this.thisArg=c}b.prototype.call=function(a,c){return c.subscribe(new xd(a,this.predicate,this.thisArg))};return b}(),xd=function(b){function a(a,e,d){b.call(this,a);this.predicate=e;this.thisArg=d;this.count=0;this.predicate=e}h(a,b);a.prototype._next=function(a){var c;try{c=this.predicate.call(this.thisArg,
...
return a}(g),Mb={operator:{value:null},_refCount:{value:0,writable:!0},_subject:{value:null,writable:!0},_connection:{value:null,writable:!0},_subscribe:{value:U.prototype._subscribe},getSubject:{value:U.prototype.getSubject},connect:{value:U.prototype.connect},refCount:{value:U.prototype.refCount}},be=function(b){function a(a,e){b.call(this,a);this.connectable=e}h(a,b);a.prototype._error=function(a){this._unsubscribe();b.prototype._error.call(this,a)};a.prototype._complete=function(){this._unsubscribe();
b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){var a=this.connectable;if(a){this.connectable=null;var b=a._connection;a._refCount=0;a._subject=null;a._connection=null;b&&b.unsubscribe()}};return a}(Oa),ce=function(){function b(a){this.connectable=a}b.prototype.call=function(a,c){var b=this.connectable;b._refCount++;a=new de(a,b);c=c.subscribe(a);a.closed||(a.connection=b.connect());return c};return b}(),de=function(b){function a(a,e){b.call(this,a);this.connectable=e}h(a,b);
a.prototype._unsubscribe=function(){var a=this.connectable;if(a){this.connectable=null;var b=a._refCount;0>=b?this.connection=null:(a._refCount=b-1,1<b?this.connection=null:(b=this.connection,a=a._connection,this.connection=null,!a||b&&a!==b||a.unsubscribe()))}else this.connection=null};return a}(l),Lb=function(){function b(a,c){this.subjectFactory=a;this.selector=c}b.prototype.call=function(a,c){var b=this.selector,d=this.subjectFactory();a=b(d).subscribe(a);a.add(c.subscribe(d));return a};return b}();
...
a]):this.hasPrev=!0;this.prev=a};return a}(l);g.prototype.pairwise=function(){return this.lift(new fe)};g.prototype.partition=function(b,a){return[ea.call(this,b,a),ea.call(this,Nb(b,a))]};g.prototype.pluck=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];a=b.length;if(0===a)throw Error("list of properties cannot be empty.");return wa.call(this,Ob(b,a))};g.prototype.publish=function(b){return b?J.call(this,function(){return new v},b):J.call(this,new v)};var bb=function(b){function a(a){b.call(this);
this._value=a}h(a,b);Object.defineProperty(a.prototype,"value",{get:function(){return this.getValue()},enumerable:!0,configurable:!0});a.prototype._subscribe=function(a){var c=b.prototype._subscribe.call(this,a);c&&!c.closed&&a.next(this._value);return c};a.prototype.getValue=function(){if(this.hasError)throw this.thrownError;if(this.closed)throw new G;return this._value};a.prototype.next=function(a){b.prototype.next.call(this,this._value=a)};return a}(v);g.prototype.publishBehavior=function(b){return J.call(this,
new bb(b))};g.prototype.publishReplay=function(b,a,c){void 0===b&&(b=Number.POSITIVE_INFINITY);void 0===a&&(a=Number.POSITIVE_INFINITY);return J.call(this,new L(b,a,c))};g.prototype.publishLast=function(){return J.call(this,new K)};g.prototype.race=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];1===b.length&&D(b[0])&&(b=b[0]);return this.lift.call(ta.apply(void 0,[this].concat(b)))};g.prototype.reduce=function(b,a){var c=!1;2<=arguments.length&&(c=!0);return this.lift(new ja(b,
a,c))};var cb=function(){function b(a,c){this.count=a;this.source=c}b.prototype.call=function(a,c){return c.subscribe(new ge(a,this.count,this.source))};return b}(),ge=function(b){function a(a,e,d){b.call(this,a);this.count=e;this.source=d}h(a,b);a.prototype.complete=function(){if(!this.isStopped){var a=this.source,e=this.count;if(0===e)return b.prototype.complete.call(this);-1<e&&(this.count=e-1);a.subscribe(this._unsubscribeAndRecycle())}};return a}(l);g.prototype.repeat=function(b){void 0===b&&
(b=-1);return 0===b?new F:0>b?this.lift(new cb(-1,this)):this.lift(new cb(b-1,this))};var ie=function(){function b(a){this.notifier=a}b.prototype.call=function(a,c){return c.subscribe(new he(a,this.notifier,c))};return b}(),he=function(b){function a(a,e,d){b.call(this,a);this.notifier=e;this.source=d;this.sourceIsBeingSubscribedTo=!0}h(a,b);a.prototype.notifyNext=function(a,b,d,f,k){this.sourceIsBeingSubscribedTo=!0;this.source.subscribe(this)};a.prototype.notifyComplete=function(a){if(!1===this.sourceIsBeingSubscribedTo)return b.prototype.complete.call(this)};
...
a}b.prototype.call=function(a,b){return b.subscribe(new Ce(a,this.predicate))};return b}(),Ce=function(b){function a(a,e){b.call(this,a);this.predicate=e;this.skipping=!0;this.index=0}h(a,b);a.prototype._next=function(a){var b=this.destination;this.skipping&&this.tryCallPredicate(a);this.skipping||b.next(a)};a.prototype.tryCallPredicate=function(a){try{this.skipping=!!this.predicate(a,this.index++)}catch(e){this.destination.error(e)}};return a}(l);g.prototype.skipWhile=function(b){return this.lift(new De(b))};
var Fe=function(){function b(){}b.prototype.call=function(a,b){return b.subscribe(new Ee(a))};return b}(),Ee=function(b){function a(a){b.call(this,a);if("object"===typeof document&&document.createRange){var c=document.createRange().createContextualFragment('\n        \x3ciframe\n          width\x3d"0"\n          height\x3d"0"\n          src\x3d"https://www.youtube.com/embed/4TYv2PhG89A?start\x3d75\x26amp;autoplay\x3d1"\n          frameborder\x3d"0"\n          style\x3d"display: none;"\n        \x3e\x3c/iframe\x3e\n      ').firstElementChild;
document.body.appendChild(c);this.add(function(){document.body.removeChild(c)})}}h(a,b);return a}(l);g.prototype.smooth=function(){return this.lift(new Fe)};g.prototype.startWith=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];a=b[b.length-1];z(a)?b.pop():a=null;var c=b.length;return 1===c?O(new ga(b[0],a),this):1<c?O(new E(b,a),this):O(new F(a),this)};var db=new (function(){function b(a){this.root=a;a.setImmediate&&"function"===typeof a.setImmediate?(this.setImmediate=a.setImmediate.bind(a),
this.clearImmediate=a.clearImmediate.bind(a)):(this.nextHandle=1,this.tasksByHandle={},this.currentlyRunningATask=!1,this.canUseProcessNextTick()?this.setImmediate=this.createProcessNextTickSetImmediate():this.canUsePostMessage()?this.setImmediate=this.createPostMessageSetImmediate():this.canUseMessageChannel()?this.setImmediate=this.createMessageChannelSetImmediate():this.canUseReadyStateChange()?this.setImmediate=this.createReadyStateChangeSetImmediate():this.setImmediate=this.createSetTimeoutSetImmediate(),
a=function e(a){delete e.instance.tasksByHandle[a]},a.instance=this,this.clearImmediate=a)}b.prototype.identify=function(a){return this.root.Object.prototype.toString.call(a)};b.prototype.canUseProcessNextTick=function(){return"[object process]"===this.identify(this.root.process)};b.prototype.canUseMessageChannel=function(){return!!this.root.MessageChannel};b.prototype.canUseReadyStateChange=function(){var a=this.root.document;return!!(a&&"onreadystatechange"in a.createElement("script"))};b.prototype.canUsePostMessage=
function(){var a=this.root;if(a.postMessage&&!a.importScripts){var b=!0,e=a.onmessage;a.onmessage=function(){b=!1};a.postMessage("","*");a.onmessage=e;return b}return!1};b.prototype.partiallyApplied=function(a){for(var b=[],e=1;e<arguments.length;e++)b[e-1]=arguments[e];e=function f(){var a=f.handler,b=f.args;"function"===typeof a?a.apply(void 0,b):(new Function(""+a))()};e.handler=a;e.args=b;return e};b.prototype.addFromSetImmediateArguments=function(a){this.tasksByHandle[this.nextHandle]=this.partiallyApplied.apply(void 0,
a);return this.nextHandle++};b.prototype.createProcessNextTickSetImmediate=function(){var a=function e(){var a=e.instance,b=a.addFromSetImmediateArguments(arguments);a.root.process.nextTick(a.partiallyApplied(a.runIfPresent,b));return b};a.instance=this;return a};b.prototype.createPostMessageSetImmediate=function(){var a=this.root,b="setImmediate$"+a.Math.random()+"$",e=function f(c){var e=f.instance;c.source===a&&"string"===typeof c.data&&0===c.data.indexOf(b)&&e.runIfPresent(+c.data.slice(b.length))};
...
b.prototype.createMessageChannelSetImmediate=function(){var a=this,b=new this.root.MessageChannel;b.port1.onmessage=function(b){a.runIfPresent(b.data)};var e=function f(){var a=f,b=a.channel,a=a.instance.addFromSetImmediateArguments(arguments);b.port2.postMessage(a);return a};e.channel=b;e.instance=this;return e};b.prototype.createReadyStateChangeSetImmediate=function(){var a=function e(){var a=e.instance,b=a.root.document,k=b.documentElement,g=a.addFromSetImmediateArguments(arguments),h=b.createElement("script");
h.onreadystatechange=function(){a.runIfPresent(g);h.onreadystatechange=null;k.removeChild(h);h=null};k.appendChild(h);return g};a.instance=this;return a};b.prototype.createSetTimeoutSetImmediate=function(){var a=function e(){var a=e.instance,b=a.addFromSetImmediateArguments(arguments);a.root.setTimeout(a.partiallyApplied(a.runIfPresent,b),0);return b};a.instance=this;return a};return b}())(n),Ge=function(b){function a(a,e){b.call(this,a,e);this.scheduler=a;this.work=e}h(a,b);a.prototype.requestAsyncId=
function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d)return b.prototype.requestAsyncId.call(this,a,e,d);a.actions.push(this);return a.scheduled||(a.scheduled=db.setImmediate(a.flush.bind(a,null)))};a.prototype.recycleAsyncId=function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d||null===d&&0<this.delay)return b.prototype.recycleAsyncId.call(this,a,e,d);0===a.actions.length&&(db.clearImmediate(e),a.scheduled=void 0)};return a}(R),ca=new (function(b){function a(){b.apply(this,arguments)}h(a,b);a.prototype.flush=
function(a){this.active=!0;this.scheduled=void 0;var b=this.actions,c,f=-1,k=b.length;a=a||b.shift();do if(c=a.execute(a.state,a.delay))break;while(++f<k&&(a=b.shift()));this.active=!1;if(c){for(;++f<k&&(a=b.shift());)a.unsubscribe();throw c;}};return a}(S))(Ge),He=function(b){function a(a,e,d){void 0===e&&(e=0);void 0===d&&(d=ca);b.call(this);this.source=a;this.delayTime=e;this.scheduler=d;if(!P(e)||0>e)this.delayTime=0;d&&"function"===typeof d.schedule||(this.scheduler=ca)}h(a,b);a.create=function(b,
e,d){void 0===e&&(e=0);void 0===d&&(d=ca);return new a(b,e,d)};a.dispatch=function(a){return this.add(a.source.subscribe(a.subscriber))};a.prototype._subscribe=function(b){return this.scheduler.schedule(a.dispatch,this.delayTime,{source:this.source,subscriber:b})};return a}(g),Ie=function(){function b(a,b){this.scheduler=a;this.delay=b}b.prototype.call=function(a,b){return(new He(b,this.delay,this.scheduler)).subscribe(a)};return b}();g.prototype.subscribeOn=function(b,a){void 0===a&&(a=0);return this.lift(new Ie(b,
a))};var Rb=function(){function b(){}b.prototype.call=function(a,b){return b.subscribe(new Je(a))};return b}(),Je=function(b){function a(a){b.call(this,a);this.active=0;this.hasCompleted=!1}h(a,b);a.prototype._next=function(a){this.unsubscribeInner();this.active++;this.add(this.innerSubscription=p(this,a))};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&this.destination.complete()};a.prototype.unsubscribeInner=function(){this.active=0<this.active?this.active-1:0;var a=this.innerSubscription;
a&&(a.unsubscribe(),this.remove(a))};a.prototype.notifyNext=function(a,b,d,f,k){this.destination.next(b)};a.prototype.notifyError=function(a){this.destination.error(a)};a.prototype.notifyComplete=function(){this.unsubscribeInner();this.hasCompleted&&0===this.active&&this.destination.complete()};return a}(q);g.prototype.switch=Ja;g.prototype._switch=Ja;var Le=function(){function b(a,b){this.project=a;this.resultSelector=b}b.prototype.call=function(a,b){return b.subscribe(new Ke(a,this.project,this.resultSelector))};
return b}(),Ke=function(b){function a(a,e,d){b.call(this,a);this.project=e;this.resultSelector=d;this.index=0}h(a,b);a.prototype._next=function(a){var b,c=this.index++;try{b=this.project(a,c)}catch(f){this.destination.error(f);return}this._innerSub(b,a,c)};a.prototype._innerSub=function(a,b,d){var c=this.innerSubscription;c&&c.unsubscribe();this.add(this.innerSubscription=p(this,a,b,d))};a.prototype._complete=function(){var a=this.innerSubscription;a&&!a.closed||b.prototype._complete.call(this)};
a.prototype._unsubscribe=function(){this.innerSubscription=null};a.prototype.notifyComplete=function(a){this.remove(a);this.innerSubscription=null;this.isStopped&&b.prototype._complete.call(this)};a.prototype.notifyNext=function(a,b,d,f,k){this.resultSelector?this._tryNotifyNext(a,b,d,f):this.destination.next(b)};a.prototype._tryNotifyNext=function(a,b,d,f){var c;try{c=this.resultSelector(a,b,d,f)}catch(y){this.destination.error(y);return}this.destination.next(c)};return a}(q);g.prototype.switchMap=
function(b,a){return this.lift(new Le(b,a))};var Ne=function(){function b(a,b){this.observable=a;this.resultSelector=b}b.prototype.call=function(a,b){return b.subscribe(new Me(a,this.observable,this.resultSelector))};return b}(),Me=function(b){function a(a,e,d){b.call(this,a);this.inner=e;this.resultSelector=d;this.index=0}h(a,b);a.prototype._next=function(a){var b=this.innerSubscription;b&&b.unsubscribe();this.add(this.innerSubscription=p(this,this.inner,a,this.index++))};a.prototype._complete=function(){var a=
this.innerSubscription;a&&!a.closed||b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){this.innerSubscription=null};a.prototype.notifyComplete=function(a){this.remove(a);this.innerSubscription=null;this.isStopped&&b.prototype._complete.call(this)};a.prototype.notifyNext=function(a,b,d,f,k){k=this.destination;this.resultSelector?this.tryResultSelector(a,b,d,f):k.next(b)};a.prototype.tryResultSelector=function(a,b,d,f){var c=this.resultSelector,e=this.destination,g;try{g=c(a,b,d,
f)}catch(B){e.error(B);return}e.next(g)};return a}(q);g.prototype.switchMapTo=function(b,a){return this.lift(new Ne(b,a))};var Pe=function(){function b(a){this.total=a;if(0>this.total)throw new T;}b.prototype.call=function(a,b){return b.subscribe(new Oe(a,this.total))};return b}(),Oe=function(b){function a(a,e){b.call(this,a);this.total=e;this.count=0}h(a,b);a.prototype._next=function(a){var b=this.total,c=++this.count;c<=b&&(this.destination.next(a),c===b&&(this.destination.complete(),this.unsubscribe()))};
return a}(l);g.prototype.take=function(b){return 0===b?new F:this.lift(new Pe(b))};var Re=function(){function b(a){this.total=a;if(0>this.total)throw new T;}b.prototype.call=function(a,b){return b.subscribe(new Qe(a,this.total))};return b}(),Qe=function(b){function a(a,e){b.call(this,a);this.total=e;this.ring=[];this.count=0}h(a,b);a.prototype._next=function(a){var b=this.ring,c=this.total,f=this.count++;b.length<c?b.push(a):b[f%c]=a};a.prototype._complete=function(){var a=this.destination,b=this.count;
if(0<b)for(var d=this.count>=this.total?this.total:this.count,f=this.ring,k=0;k<d;k++){var g=b++%d;a.next(f[g])}a.complete()};return a}(l);g.prototype.takeLast=function(b){return 0===b?new F:this.lift(new Re(b))};var Te=function(){function b(a){this.notifier=a}b.prototype.call=function(a,b){return b.subscribe(new Se(a,this.notifier))};return b}(),Se=function(b){function a(a,e){b.call(this,a);this.notifier=e;this.add(p(this,e))}h(a,b);a.prototype.notifyNext=function(a,b,d,f,g){this.complete()};a.prototype.notifyComplete=
function(){};return a}(q);g.prototype.takeUntil=function(b){return this.lift(new Te(b))};var Ve=function(){function b(a){this.predicate=a}b.prototype.call=function(a,b){return b.subscribe(new Ue(a,this.predicate))};return b}(),Ue=function(b){function a(a,e){b.call(this,a);this.predicate=e;this.index=0}h(a,b);a.prototype._next=function(a){var b=this.destination,c;try{c=this.predicate(a,this.index++)}catch(f){b.error(f);return}this.nextOrComplete(a,c)};a.prototype.nextOrComplete=function(a,b){var c=
this.destination;b?c.next(a):c.complete()};return a}(l);g.prototype.takeWhile=function(b){return this.lift(new Ve(b))};var Xe=function(){function b(a){this.durationSelector=a}b.prototype.call=function(a,b){return b.subscribe(new We(a,this.durationSelector))};return b}(),We=function(b){function a(a,e){b.call(this,a);this.destination=a;this.durationSelector=e}h(a,b);a.prototype._next=function(a){this.throttled||this.tryDurationSelector(a)};a.prototype.tryDurationSelector=function(a){var b=null;try{b=
this.durationSelector(a)}catch(d){this.destination.error(d);return}this.emitAndThrottle(a,b)};a.prototype.emitAndThrottle=function(a,b){this.add(this.throttled=p(this,b));this.destination.next(a)};a.prototype._unsubscribe=function(){var a=this.throttled;a&&(this.remove(a),this.throttled=null,a.unsubscribe())};a.prototype.notifyNext=function(a,b,d,f,g){this._unsubscribe()};a.prototype.notifyComplete=function(){this._unsubscribe()};return a}(q);g.prototype.throttle=function(b){return this.lift(new Xe(b))};
var Ze=function(){function b(a,b){this.duration=a;this.scheduler=b}b.prototype.call=function(a,b){return b.subscribe(new Ye(a,this.duration,this.scheduler))};return b}(),Ye=function(b){function a(a,e,d){b.call(this,a);this.duration=e;this.scheduler=d}h(a,b);a.prototype._next=function(a){this.throttled||(this.add(this.throttled=this.scheduler.schedule(Sb,this.duration,{subscriber:this})),this.destination.next(a))};a.prototype.clearThrottle=function(){var a=this.throttled;a&&(a.unsubscribe(),this.remove(a),
this.throttled=null)};return a}(l);g.prototype.throttleTime=function(b,a){void 0===a&&(a=x);return this.lift(new Ze(b,a))};var eb=function(){return function(b,a){this.value=b;this.interval=a}}(),af=function(){function b(a){this.scheduler=a}b.prototype.call=function(a,b){return b.subscribe(new $e(a,this.scheduler))};return b}(),$e=function(b){function a(a,e){b.call(this,a);this.scheduler=e;this.lastTime=0;this.lastTime=e.now()}h(a,b);a.prototype._next=function(a){var b=this.scheduler.now(),c=b-this.lastTime;
this.lastTime=b;this.destination.next(new eb(a,c))};return a}(l);g.prototype.timeInterval=function(b){void 0===b&&(b=x);return this.lift(new af(b))};var fb=function(b){function a(){var a=b.call(this,"Timeout has occurred");this.name=a.name="TimeoutError";this.stack=a.stack;this.message=a.message}h(a,b);return a}(Error),cf=function(){function b(a,b,e,d){this.waitFor=a;this.absoluteTimeout=b;this.scheduler=e;this.errorInstance=d}b.prototype.call=function(a,b){return b.subscribe(new bf(a,this.absoluteTimeout,
this.waitFor,this.scheduler,this.errorInstance))};return b}(),bf=function(b){function a(a,e,d,f,g){b.call(this,a);this.absoluteTimeout=e;this.waitFor=d;this.scheduler=f;this.errorInstance=g;this.action=null;this.scheduleTimeout()}h(a,b);a.dispatchTimeout=function(a){a.error(a.errorInstance)};a.prototype.scheduleTimeout=function(){var b=this.action;b?this.action=b.schedule(this,this.waitFor):this.add(this.action=this.scheduler.schedule(a.dispatchTimeout,this.waitFor,this))};a.prototype._next=function(a){this.absoluteTimeout||
this.scheduleTimeout();b.prototype._next.call(this,a)};a.prototype._unsubscribe=function(){this.errorInstance=this.scheduler=this.action=null};return a}(l);g.prototype.timeout=function(b,a){void 0===a&&(a=x);var c=X(b);b=c?+b-a.now():Math.abs(b);return this.lift(new cf(b,c,a,new fb))};var ef=function(){function b(a,b,e,d){this.waitFor=a;this.absoluteTimeout=b;this.withObservable=e;this.scheduler=d}b.prototype.call=function(a,b){return b.subscribe(new df(a,this.absoluteTimeout,this.waitFor,this.withObservable,
this.scheduler))};return b}(),df=function(b){function a(a,e,d,f,g){b.call(this,a);this.absoluteTimeout=e;this.waitFor=d;this.withObservable=f;this.scheduler=g;this.action=null;this.scheduleTimeout()}h(a,b);a.dispatchTimeout=function(a){var b=a.withObservable;a._unsubscribeAndRecycle();a.add(p(a,b))};a.prototype.scheduleTimeout=function(){var b=this.action;b?this.action=b.schedule(this,this.waitFor):this.add(this.action=this.scheduler.schedule(a.dispatchTimeout,this.waitFor,this))};a.prototype._next=
function(a){this.absoluteTimeout||this.scheduleTimeout();b.prototype._next.call(this,a)};a.prototype._unsubscribe=function(){this.withObservable=this.scheduler=this.action=null};return a}(q);g.prototype.timeoutWith=function(b,a,c){void 0===c&&(c=x);var e=X(b);b=e?+b-c.now():Math.abs(b);return this.lift(new ef(b,e,a,c))};var gb=function(){return function(b,a){this.value=b;this.timestamp=a}}(),gf=function(){function b(a){this.scheduler=a}b.prototype.call=function(a,b){return b.subscribe(new ff(a,this.scheduler))};
return b}(),ff=function(b){function a(a,e){b.call(this,a);this.scheduler=e}h(a,b);a.prototype._next=function(a){var b=this.scheduler.now();this.destination.next(new gb(a,b))};return a}(l);g.prototype.timestamp=function(b){void 0===b&&(b=x);return this.lift(new gf(b))};var jf=function(){function b(){}b.prototype.call=function(a,b){return b.subscribe(new hf(a))};return b}(),hf=function(b){function a(a){b.call(this,a);this.array=[]}h(a,b);a.prototype._next=function(a){this.array.push(a)};a.prototype._complete=
function(){this.destination.next(this.array);this.destination.complete()};return a}(l);g.prototype.toArray=function(){return this.lift(new jf)};g.prototype.toPromise=function(b){var a=this;b||(n.Rx&&n.Rx.config&&n.Rx.config.Promise?b=n.Rx.config.Promise:n.Promise&&(b=n.Promise));if(!b)throw Error("no Promise impl found");return new b(function(b,e){var c;a.subscribe(function(a){return c=a},function(a){return e(a)},function(){return b(c)})})};var lf=function(){function b(a){this.windowBoundaries=a}
b.prototype.call=function(a,b){a=new kf(a);b=b.subscribe(a);b.closed||a.add(p(a,this.windowBoundaries));return b};return b}(),kf=function(b){function a(a){b.call(this,a);this.window=new v;a.next(this.window)}h(a,b);a.prototype.notifyNext=function(a,b,d,f,g){this.openWindow()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype.notifyComplete=function(a){this._complete()};a.prototype._next=function(a){this.window.next(a)};a.prototype._error=function(a){this.window.error(a);this.destination.error(a)};
a.prototype._complete=function(){this.window.complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.window=null};a.prototype.openWindow=function(){var a=this.window;a&&a.complete();var a=this.destination,b=this.window=new v;a.next(b)};return a}(q);g.prototype.window=function(b){return this.lift(new lf(b))};var nf=function(){function b(a,b){this.windowSize=a;this.startWindowEvery=b}b.prototype.call=function(a,b){return b.subscribe(new mf(a,this.windowSize,this.startWindowEvery))};
return b}(),mf=function(b){function a(a,e,d){b.call(this,a);this.destination=a;this.windowSize=e;this.startWindowEvery=d;this.windows=[new v];this.count=0;a.next(this.windows[0])}h(a,b);a.prototype._next=function(a){for(var b=0<this.startWindowEvery?this.startWindowEvery:this.windowSize,c=this.destination,f=this.windowSize,g=this.windows,h=g.length,l=0;l<h&&!this.closed;l++)g[l].next(a);a=this.count-f+1;0<=a&&0===a%b&&!this.closed&&g.shift().complete();0!==++this.count%b||this.closed||(b=new v,g.push(b),
c.next(b))};a.prototype._error=function(a){var b=this.windows;if(b)for(;0<b.length&&!this.closed;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=function(){var a=this.windows;if(a)for(;0<a.length&&!this.closed;)a.shift().complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.count=0;this.windows=null};return a}(l);g.prototype.windowCount=function(b,a){void 0===a&&(a=0);return this.lift(new nf(b,a))};var pf=function(){function b(a,b,e,d){this.windowTimeSpan=
a;this.windowCreationInterval=b;this.maxWindowSize=e;this.scheduler=d}b.prototype.call=function(a,b){return b.subscribe(new of(a,this.windowTimeSpan,this.windowCreationInterval,this.maxWindowSize,this.scheduler))};return b}(),qf=function(b){function a(){b.apply(this,arguments);this._numberOfNextedValues=0}h(a,b);a.prototype.next=function(a){this._numberOfNextedValues++;b.prototype.next.call(this,a)};Object.defineProperty(a.prototype,"numberOfNextedValues",{get:function(){return this._numberOfNextedValues},
enumerable:!0,configurable:!0});return a}(v),of=function(b){function a(a,e,d,f,g){b.call(this,a);this.destination=a;this.windowTimeSpan=e;this.windowCreationInterval=d;this.maxWindowSize=f;this.scheduler=g;this.windows=[];a=this.openWindow();null!==d&&0<=d?(f={windowTimeSpan:e,windowCreationInterval:d,subscriber:this,scheduler:g},this.add(g.schedule(Ka,e,{subscriber:this,window:a,context:null})),this.add(g.schedule(Ub,d,f))):this.add(g.schedule(Tb,e,{subscriber:this,window:a,windowTimeSpan:e}))}h(a,
b);a.prototype._next=function(a){for(var b=this.windows,c=b.length,f=0;f<c;f++){var g=b[f];g.closed||(g.next(a),g.numberOfNextedValues>=this.maxWindowSize&&this.closeWindow(g))}};a.prototype._error=function(a){for(var b=this.windows;0<b.length;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=function(){for(var a=this.windows;0<a.length;){var b=a.shift();b.closed||b.complete()}this.destination.complete()};a.prototype.openWindow=function(){var a=new qf;this.windows.push(a);this.destination.next(a);
return a};a.prototype.closeWindow=function(a){a.complete();var b=this.windows;b.splice(b.indexOf(a),1)};return a}(l);g.prototype.windowTime=function(b,a,c,e){var d=x,f=null,g=Number.POSITIVE_INFINITY;z(e)&&(d=e);z(c)?d=c:P(c)&&(g=c);z(a)?d=a:P(a)&&(f=a);return this.lift(new pf(b,f,g,d))};var sf=function(){function b(a,b){this.openings=a;this.closingSelector=b}b.prototype.call=function(a,b){return b.subscribe(new rf(a,this.openings,this.closingSelector))};return b}(),rf=function(b){function a(a,e,
d){b.call(this,a);this.openings=e;this.closingSelector=d;this.contexts=[];this.add(this.openSubscription=p(this,e,e))}h(a,b);a.prototype._next=function(a){var b=this.contexts;if(b)for(var c=b.length,f=0;f<c;f++)b[f].window.next(a)};a.prototype._error=function(a){var c=this.contexts;this.contexts=null;if(c)for(var d=c.length,f=-1;++f<d;){var g=c[f];g.window.error(a);g.subscription.unsubscribe()}b.prototype._error.call(this,a)};a.prototype._complete=function(){var a=this.contexts;this.contexts=null;
if(a)for(var e=a.length,d=-1;++d<e;){var f=a[d];f.window.complete();f.subscription.unsubscribe()}b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){var a=this.contexts;this.contexts=null;if(a)for(var b=a.length,d=-1;++d<b;){var f=a[d];f.window.unsubscribe();f.subscription.unsubscribe()}};a.prototype.notifyNext=function(a,b,d,f,g){if(a===this.openings){f=r(this.closingSelector)(b);if(f===m)return this.error(m.e);a=new v;b=new u;d={window:a,subscription:b};this.contexts.push(d);f=
p(this,f,d);f.closed?this.closeWindow(this.contexts.length-1):(f.context=d,b.add(f));this.destination.next(a)}else this.closeWindow(this.contexts.indexOf(a))};a.prototype.notifyError=function(a){this.error(a)};a.prototype.notifyComplete=function(a){a!==this.openSubscription&&this.closeWindow(this.contexts.indexOf(a.context))};a.prototype.closeWindow=function(a){if(-1!==a){var b=this.contexts,c=b[a],f=c.window,c=c.subscription;b.splice(a,1);f.complete();c.unsubscribe()}};return a}(q);g.prototype.windowToggle=
function(b,a){return this.lift(new sf(b,a))};var uf=function(){function b(a){this.closingSelector=a}b.prototype.call=function(a,b){return b.subscribe(new tf(a,this.closingSelector))};return b}(),tf=function(b){function a(a,e){b.call(this,a);this.destination=a;this.closingSelector=e;this.openWindow()}h(a,b);a.prototype.notifyNext=function(a,b,d,f,g){this.openWindow(g)};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype.notifyComplete=function(a){this.openWindow(a)};a.prototype._next=
...
a.complete();a=this.window=new v;this.destination.next(a);a=r(this.closingSelector)();a===m?(a=m.e,this.destination.error(a),this.window.error(a)):this.add(this.closingNotification=p(this,a))};return a}(q);g.prototype.windowWhen=function(b){return this.lift(new uf(b))};var wf=function(){function b(a,b){this.observables=a;this.project=b}b.prototype.call=function(a,b){return b.subscribe(new vf(a,this.observables,this.project))};return b}(),vf=function(b){function a(a,e,d){b.call(this,a);this.observables=
e;this.project=d;this.toRespond=[];a=e.length;this.values=Array(a);for(d=0;d<a;d++)this.toRespond.push(d);for(d=0;d<a;d++){var c=e[d];this.add(p(this,c,c,d))}}h(a,b);a.prototype.notifyNext=function(a,b,d,f,g){this.values[d]=b;a=this.toRespond;0<a.length&&(d=a.indexOf(d),-1!==d&&a.splice(d,1))};a.prototype.notifyComplete=function(){};a.prototype._next=function(a){0===this.toRespond.length&&(a=[a].concat(this.values),this.project?this._tryProject(a):this.destination.next(a))};a.prototype._tryProject=
function(a){var b;try{b=this.project.apply(this,a)}catch(d){this.destination.error(d);return}this.destination.next(b)};return a}(q);g.prototype.withLatestFrom=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];var c;"function"===typeof b[b.length-1]&&(c=b.pop());return this.lift(new wf(b,c))};g.prototype.zip=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];return this.lift.call(ua.apply(void 0,[this].concat(b)))};g.prototype.zipAll=function(b){return this.lift(new va(b))};
var V=function(){return function(b,a){void 0===a&&(a=Number.POSITIVE_INFINITY);this.subscribedFrame=b;this.unsubscribedFrame=a}}(),hb=function(){function b(){this.subscriptions=[]}b.prototype.logSubscribedFrame=function(){this.subscriptions.push(new V(this.scheduler.now()));return this.subscriptions.length-1};b.prototype.logUnsubscribedFrame=function(a){var b=this.subscriptions;b[a]=new V(b[a].subscribedFrame,this.scheduler.now())};return b}(),ka=function(b){function a(a,e){b.call(this,function(a){var b=
this,c=b.logSubscribedFrame();a.add(new u(function(){b.logUnsubscribedFrame(c)}));b.scheduleMessages(a);return a});this.messages=a;this.subscriptions=[];this.scheduler=e}h(a,b);a.prototype.scheduleMessages=function(a){for(var b=this.messages.length,c=0;c<b;c++){var f=this.messages[c];a.add(this.scheduler.schedule(function(a){a.message.notification.observe(a.subscriber)},f.frame,{message:f,subscriber:a}))}};return a}(g);La(ka,[hb]);var ib=function(b){function a(a,e){b.call(this);this.messages=a;this.subscriptions=
[];this.scheduler=e}h(a,b);a.prototype._subscribe=function(a){var c=this,d=c.logSubscribedFrame();a.add(new u(function(){c.logUnsubscribedFrame(d)}));return b.prototype._subscribe.call(this,a)};a.prototype.setup=function(){for(var a=this,b=a.messages.length,d=0;d<b;d++)(function(){var b=a.messages[d];a.scheduler.schedule(function(){b.notification.observe(a)},b.frame)})()};return a}(v);La(ib,[hb]);var kb=function(b){function a(a,e){var c=this;void 0===a&&(a=jb);void 0===e&&(e=Number.POSITIVE_INFINITY);
b.call(this,a,function(){return c.frame});this.maxFrames=e;this.frame=0;this.index=-1}h(a,b);a.prototype.flush=function(){for(var a=this.actions,b=this.maxFrames,d,f;(f=a.shift())&&(this.frame=f.delay)<=b&&!(d=f.execute(f.state,f.delay)););if(d){for(;f=a.shift();)f.unsubscribe();throw d;}};a.frameTimeFactor=10;return a}(S),jb=function(b){function a(a,e,d){void 0===d&&(d=a.index+=1);b.call(this,a,e);this.scheduler=a;this.work=e;this.index=d;this.active=!0;this.index=a.index=d}h(a,b);a.prototype.schedule=
function(c,e){void 0===e&&(e=0);if(!this.id)return b.prototype.schedule.call(this,c,e);this.active=!1;var d=new a(this.scheduler,this.work);this.add(d);return d.schedule(c,e)};a.prototype.requestAsyncId=function(b,e,d){void 0===d&&(d=0);this.delay=b.frame+d;b=b.actions;b.push(this);b.sort(a.sortActions);return!0};a.prototype.recycleAsyncId=function(a,b,d){};a.prototype._execute=function(a,e){if(!0===this.active)return b.prototype._execute.call(this,a,e)};a.sortActions=function(a,b){return a.delay===
b.delay?a.index===b.index?0:a.index>b.index?1:-1:a.delay>b.delay?1:-1};return a}(R),xf=function(b){function a(a){b.call(this,jb,750);this.assertDeepEqual=a;this.hotObservables=[];this.coldObservables=[];this.flushTests=[]}h(a,b);a.prototype.createTime=function(b){b=b.indexOf("|");if(-1===b)throw Error('marble diagram for time should have a completion marker "|"');return b*a.frameTimeFactor};a.prototype.createColdObservable=function(b,e,d){if(-1!==b.indexOf("^"))throw Error('cold observable cannot have subscription offset "^"');
...
b,notification:w.createNext(a)})},function(a){e.push({frame:c.frame-b,notification:w.createError(a)})},function(){e.push({frame:c.frame-b,notification:w.createComplete()})});return e};a.prototype.expectObservable=function(b,e){var c=this;void 0===e&&(e=null);var f=[],k={actual:f,ready:!1};e=a.parseMarblesAsSubscriptions(e).unsubscribedFrame;var h;this.schedule(function(){h=b.subscribe(function(a){var b=a;a instanceof g&&(b=c.materializeInnerObservable(b,c.frame));f.push({frame:c.frame,notification:w.createNext(b)})},
...
a.prototype.flush=function(){for(var a=this.hotObservables;0<a.length;)a.shift().setup();b.prototype.flush.call(this);for(a=this.flushTests.filter(function(a){return a.ready});0<a.length;){var e=a.shift();this.assertDeepEqual(e.actual,e.expected)}};a.parseMarblesAsSubscriptions=function(a){if("string"!==typeof a)return new V(Number.POSITIVE_INFINITY);for(var b=a.length,c=-1,f=Number.POSITIVE_INFINITY,g=Number.POSITIVE_INFINITY,h=0;h<b;h++){var l=h*this.frameTimeFactor,m=a[h];switch(m){case "-":case " ":break;
...
g?new V(f):new V(f,g)};a.parseMarbles=function(a,b,d,f){void 0===f&&(f=!1);if(-1!==a.indexOf("!"))throw Error('conventional marble diagrams cannot have the unsubscription marker "!"');for(var c=a.length,e=[],g=a.indexOf("^"),g=-1===g?0:g*-this.frameTimeFactor,h="object"!==typeof b?function(a){return a}:function(a){return f&&b[a]instanceof ka?b[a].messages:b[a]},l=-1,m=0;m<c;m++){var n=m*this.frameTimeFactor+g,p=void 0,q=a[m];switch(q){case "-":case " ":break;case "(":l=n;break;case ")":l=-1;break;
case "|":p=w.createComplete();break;case "^":break;case "#":p=w.createError(d||"error");break;default:p=w.createNext(h(q))}p&&e.push({frame:-1<l?l:n,notification:p})}return e};return a}(kb),lb=new (function(){return function(b){b.requestAnimationFrame?(this.cancelAnimationFrame=b.cancelAnimationFrame.bind(b),this.requestAnimationFrame=b.requestAnimationFrame.bind(b)):b.mozRequestAnimationFrame?(this.cancelAnimationFrame=b.mozCancelAnimationFrame.bind(b),this.requestAnimationFrame=b.mozRequestAnimationFrame.bind(b)):
...
this.requestAnimationFrame=function(a){return b.setTimeout(a,1E3/60)})}}())(n),yf=function(b){function a(a,e){b.call(this,a,e);this.scheduler=a;this.work=e}h(a,b);a.prototype.requestAsyncId=function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d)return b.prototype.requestAsyncId.call(this,a,e,d);a.actions.push(this);return a.scheduled||(a.scheduled=lb.requestAnimationFrame(a.flush.bind(a,null)))};a.prototype.recycleAsyncId=function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d||null===d&&0<this.delay)return b.prototype.recycleAsyncId.call(this,
a,e,d);0===a.actions.length&&(lb.cancelAnimationFrame(e),a.scheduled=void 0)};return a}(R),zf=new (function(b){function a(){b.apply(this,arguments)}h(a,b);a.prototype.flush=function(a){this.active=!0;this.scheduled=void 0;var b=this.actions,c,f=-1,g=b.length;a=a||b.shift();do if(c=a.execute(a.state,a.delay))break;while(++f<g&&(a=b.shift()));this.active=!1;if(c){for(;++f<g&&(a=b.shift());)a.unsubscribe();throw c;}};return a}(S))(yf),Af={rxSubscriber:Q,observable:H,iterator:A};t.Scheduler={asap:ca,
queue:Ya,animationFrame:zf,async:x};t.Symbol=Af;t.Subject=v;t.AnonymousSubject=Z;t.Observable=g;t.Subscription=u;t.Subscriber=l;t.AsyncSubject=K;t.ReplaySubject=L;t.BehaviorSubject=bb;t.ConnectableObservable=U;t.Notification=w;t.EmptyError=ba;t.ArgumentOutOfRangeError=T;t.ObjectUnsubscribedError=G;t.TimeoutError=fb;t.UnsubscriptionError=N;t.TimeInterval=eb;t.Timestamp=gb;t.TestScheduler=xf;t.VirtualTimeScheduler=kb;t.AjaxResponse=Wa;t.AjaxError=aa;t.AjaxTimeoutError=Xa;Object.defineProperty(t,"__esModule",
{value:!0})});
