...
d.prototype[k]}}var mb=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(b,a){b.__proto__=a}||function(b,a){for(var c in a)a.hasOwnProperty(c)&&(b[c]=a[c])},n;if("object"==typeof window&&window.window===window)n=window;else if("object"==typeof self&&self.self===self)n=self;else if("object"==typeof global&&global.global===global)n=global;else throw Error("RxJS could not find any global context (window, self, global)");var D=Array.isArray||function(b){return b&&"number"===typeof b.length},
m={e:{}},la,N=function(b){function a(c){b.call(this);this.errors=c;c=Error.call(this,c?c.length+" errors occurred during unsubscription:\n  "+c.map(function(c,a){return a+1+") "+c.toString()}).join("\n  "):"");this.name=c.name="UnsubscriptionError";this.stack=c.stack;this.message=c.message}k(a,b);return a}(Error),u=function(){function b(a){this.closed=!1;this._subscriptions=this._parents=this._parent=null;a&&(this._unsubscribe=a)}b.prototype.unsubscribe=function(){var a=!1,c;if(!this.closed){var b=
this._parent,d=this._parents,f=this._unsubscribe,h=this._subscriptions;this.closed=!0;this._subscriptions=this._parents=this._parent=null;for(var g=-1,k=d?d.length:0;b;)b.remove(this),b=++g<k&&d[g]||null;M(f)&&(b=r(f).call(this),b===m&&(a=!0,c=c||(m.e instanceof N?ma(m.e.errors):[m.e])));if(D(h))for(g=-1,k=h.length;++g<k;)b=h[g],null!=b&&"object"===typeof b&&(b=r(b.unsubscribe).call(b),b===m&&(a=!0,c=c||[],b=m.e,b instanceof N?c=c.concat(ma(b.errors)):c.push(b)));if(a)throw new N(c);}};b.prototype.add=
...
this.unsubscribe()};a.prototype._unsubscribeAndRecycle=function(){var c=this._parent,a=this._parents;this._parents=this._parent=null;this.unsubscribe();this.isStopped=this.closed=!1;this._parent=c;this._parents=a;return this};return a}(u),Ma=function(b){function a(c,a,d,f){b.call(this);this._parentSubscriber=c;var e;c=this;M(a)?e=a:a&&(e=a.next,d=a.error,f=a.complete,a!==Y&&(c=Object.create(a),M(c.unsubscribe)&&this.add(c.unsubscribe.bind(c)),c.unsubscribe=this.unsubscribe.bind(this)));this._context=
...
f,c.syncErrorThrown=!0}return!1};a.prototype._unsubscribe=function(){var c=this._parentSubscriber;this._parentSubscriber=this._context=null;c.unsubscribe()};return a}(l),H=function(b){var a=b.Symbol;"function"===typeof a?a.observable?b=a.observable:(b=a("observable"),a.observable=b):b="@@observable";return b}(n),g=function(){function b(a){this._isScalar=!1;a&&(this._subscribe=a)}b.prototype.lift=function(a){var c=new b;c.source=this;c.operator=a;return c};b.prototype.subscribe=function(a,c,b){var e=
this.operator;a:{if(a){if(a instanceof l)break a;if(a[Q]){a=a[Q]();break a}}a=a||c||b?new l(a,c,b):new l(Y)}e?e.call(a,this.source):a.add(this._trySubscribe(a));if(a.syncErrorThrowable&&(a.syncErrorThrowable=!1,a.syncErrorThrown))throw a.syncErrorValue;return a};b.prototype._trySubscribe=function(a){try{return this._subscribe(a)}catch(c){a.syncErrorThrown=!0,a.syncErrorValue=c,a.error(c)}};b.prototype.forEach=function(a,c){var b=this;c||(n.Rx&&n.Rx.config&&n.Rx.config.Promise?c=n.Rx.config.Promise:
n.Promise&&(c=n.Promise));if(!c)throw Error("no Promise impl found");return new c(function(c,e){var d;d=b.subscribe(function(c){if(d)try{a(c)}catch(C){e(C),d.unsubscribe()}else a(c)},e,c)})};b.prototype._subscribe=function(a){return this.source.subscribe(a)};b.prototype[H]=function(){return this};b.create=function(a){return new b(a)};return b}(),G=function(b){function a(){var c=b.call(this,"object unsubscribed");this.name=c.name="ObjectUnsubscribedError";this.stack=c.stack;this.message=c.message}
...
this.destination;c&&c.complete&&this.destination.complete()};a.prototype._subscribe=function(c){return this.source?this.source.subscribe(c):u.EMPTY};return a}(v),K=function(b){function a(){b.apply(this,arguments);this.value=null;this.hasCompleted=this.hasNext=!1}k(a,b);a.prototype._subscribe=function(c){return this.hasError?(c.error(this.thrownError),u.EMPTY):this.hasCompleted&&this.hasNext?(c.next(this.value),c.complete(),u.EMPTY):b.prototype._subscribe.call(this,c)};a.prototype.next=function(c){this.hasCompleted||
(this.value=c,this.hasNext=!0)};a.prototype.error=function(c){this.hasCompleted||b.prototype.error.call(this,c)};a.prototype.complete=function(){this.hasCompleted=!0;this.hasNext&&b.prototype.next.call(this,this.value);b.prototype.complete.call(this)};return a}(v),Vb=function(b){function a(c,a,d,f,h){b.call(this);this.callbackFunc=c;this.selector=a;this.args=d;this.context=f;this.scheduler=h}k(a,b);a.create=function(c,b,d){void 0===b&&(b=void 0);return function(){for(var e=[],h=0;h<arguments.length;h++)e[h-
0]=arguments[h];return new a(c,b,e,this,d)}};a.prototype._subscribe=function(c){var b=this.callbackFunc,d=this.args,f=this.scheduler,h=this.subject;if(f)return f.schedule(a.dispatch,0,{source:this,subscriber:c,context:this.context});h||(h=this.subject=new K,f=function C(){for(var c=[],a=0;a<arguments.length;a++)c[a-0]=arguments[a];var b=C.source,a=b.selector,b=b.subject;a?(c=r(a).apply(this,c),c===m?b.error(m.e):(b.next(c),b.complete())):(b.next(1>=c.length?c[0]:c),b.complete())},f.source=this,r(b).apply(this.context,
d.concat(f))===m&&h.error(m.e));return h.subscribe(c)};a.dispatch=function(c){var a=this,b=c.source,f=c.subscriber;c=c.context;var h=b.callbackFunc,g=b.args,k=b.scheduler,B=b.subject;if(!B){var B=b.subject=new K,l=function rb(){for(var c=[],b=0;b<arguments.length;b++)c[b-0]=arguments[b];var e=rb.source,b=e.selector,e=e.subject;b?(c=r(b).apply(this,c),c===m?a.add(k.schedule(ob,0,{err:m.e,subject:e})):a.add(k.schedule(na,0,{value:c,subject:e}))):a.add(k.schedule(na,0,{value:1>=c.length?c[0]:c,subject:e}))};
l.source=b;r(h).apply(c,g.concat(l))===m&&B.error(m.e)}a.add(B.subscribe(f))};return a}(g).create;g.bindCallback=Vb;var Wb=function(b){function a(c,a,d,f,h){b.call(this);this.callbackFunc=c;this.selector=a;this.args=d;this.context=f;this.scheduler=h}k(a,b);a.create=function(c,b,d){void 0===b&&(b=void 0);return function(){for(var e=[],h=0;h<arguments.length;h++)e[h-0]=arguments[h];return new a(c,b,e,this,d)}};a.prototype._subscribe=function(c){var a=this.callbackFunc,b=this.args,f=this.scheduler,h=
this.subject;if(f)return f.schedule(pb,0,{source:this,subscriber:c,context:this.context});h||(h=this.subject=new K,f=function C(){for(var c=[],a=0;a<arguments.length;a++)c[a-0]=arguments[a];var b=C.source,a=b.selector,b=b.subject,e=c.shift();e?b.error(e):a?(c=r(a).apply(this,c),c===m?b.error(m.e):(b.next(c),b.complete())):(b.next(1>=c.length?c[0]:c),b.complete())},f.source=this,r(a).apply(this.context,b.concat(f))===m&&h.error(m.e));return h.subscribe(c)};return a}(g).create;g.bindNodeCallback=Wb;
...
0;a<arguments.length;a++)b[a-0]=arguments[a];var c=a=null;z(b[b.length-1])&&(c=b.pop());"function"===typeof b[b.length-1]&&(a=b.pop());1===b.length&&D(b[0])&&(b=b[0]);return(new E(b,c)).lift(new ha(a))};var W=function(){function b(a){this.concurrent=a}b.prototype.call=function(a,c){return c.subscribe(new Yb(a,this.concurrent))};return b}(),Yb=function(b){function a(c,a){b.call(this,c);this.concurrent=a;this.hasCompleted=!1;this.buffer=[];this.active=0}k(a,b);a.prototype._next=function(c){this.active<
this.concurrent?(this.active++,this.add(p(this,c))):this.buffer.push(c)};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&0===this.buffer.length&&this.destination.complete()};a.prototype.notifyComplete=function(c){var a=this.buffer;this.remove(c);this.active--;0<a.length?this._next(a.shift()):0===this.active&&this.hasCompleted&&this.destination.complete()};return a}(q);g.concat=O;var $b=function(b){function a(c){b.call(this);this.observableFactory=c}k(a,b);a.create=function(c){return new a(c)};
a.prototype._subscribe=function(c){return new Zb(c,this.observableFactory)};return a}(g),Zb=function(b){function a(c,a){b.call(this,c);this.factory=a;this.tryDefer()}k(a,b);a.prototype.tryDefer=function(){try{this._callFactory()}catch(c){this._error(c)}};a.prototype._callFactory=function(){var c=this.factory();c&&this.add(p(this,c))};return a}(q);g.defer=$b.create;g.empty=F.create;var bc=function(b){function a(c,a){b.call(this);this.sources=c;this.resultSelector=a}k(a,b);a.create=function(){for(var c=
...
p(this,a[d],null,d);e&&(e.outerIndex=d,this.add(e))}}k(a,b);a.prototype.notifyNext=function(c,a,b,f,h){this.values[b]=a;h._hasValue||(h._hasValue=!0,this.haveValues++)};a.prototype.notifyComplete=function(c){var a=this.destination,b=this.haveValues,f=this.resultSelector,h=this.values,g=h.length;c._hasValue?(this.completed++,this.completed===g&&(b===g&&(c=f?f.apply(this,h):h,a.next(c)),a.complete())):a.complete()};return a}(q);g.forkJoin=bc.create;var Qa=function(b){function a(c,a){b.call(this);this.promise=
...
b;a._isScalar=!0;c.closed||c.add(f.schedule(ra,0,{value:b,subscriber:c}))},function(a){c.closed||c.add(f.schedule(sb,0,{err:a,subscriber:c}))}).then(null,function(c){n.setTimeout(function(){throw c;})})};return a}(g),ec=function(b){function a(c,a){b.call(this);this.scheduler=a;if(null==c)throw Error("iterator cannot be null.");if((a=c[A])||"string"!==typeof c)if(a||void 0===c.length){if(!a)throw new TypeError("object is not iterable");c=c[A]()}else c=new cc(c);else c=new dc(c);this.iterator=c}k(a,
...
typeof b.return&&b.return();break}}while(1)};return a}(g),dc=function(){function b(a,c,b){void 0===c&&(c=0);void 0===b&&(b=a.length);this.str=a;this.idx=c;this.len=b}b.prototype[A]=function(){return this};b.prototype.next=function(){return this.idx<this.len?{done:!1,value:this.str.charAt(this.idx++)}:{done:!0,value:void 0}};return b}(),cc=function(){function b(a,c,b){void 0===c&&(c=0);if(void 0===b)if(b=+a.length,isNaN(b))b=0;else if(0!==b&&"number"===typeof b&&n.isFinite(b)){var e;e=+b;e=0===e?e:
isNaN(e)?e:0>e?-1:1;b=e*Math.floor(Math.abs(b));b=0>=b?0:b>Ra?Ra:b}this.arr=a;this.idx=c;this.len=b}b.prototype[A]=function(){return this};b.prototype.next=function(){return this.idx<this.len?{done:!1,value:this.arr[this.idx++]}:{done:!0,value:void 0}};return b}(),Ra=Math.pow(2,53)-1,fc=function(b){function a(c,a){b.call(this);this.arrayLike=c;this.scheduler=a;a||1!==c.length||(this._isScalar=!0,this.value=c[0])}k(a,b);a.create=function(c,b){var e=c.length;return 0===e?new F:1===e?new ga(c[0],b):
...
this.scheduler,this.delay))};return b}(),ia=function(b){function a(c,a,d){void 0===d&&(d=0);b.call(this,c);this.scheduler=a;this.delay=d}k(a,b);a.dispatch=function(c){c.notification.observe(c.destination);this.unsubscribe()};a.prototype.scheduleMessage=function(c){this.add(this.scheduler.schedule(a.dispatch,this.delay,new hc(c,this.destination)))};a.prototype._next=function(c){this.scheduleMessage(w.createNext(c))};a.prototype._error=function(c){this.scheduleMessage(w.createError(c))};a.prototype._complete=
function(){this.scheduleMessage(w.createComplete())};return a}(l),hc=function(){return function(b,a){this.notification=b;this.destination=a}}(),Sa=function(b){function a(c,a){b.call(this,null);this.ish=c;this.scheduler=a}k(a,b);a.create=function(c,b){if(null!=c){if("function"===typeof c[H])return c instanceof g&&!b?c:new a(c,b);if(D(c))return new E(c,b);if(pa(c))return new Qa(c,b);if("function"===typeof c[A]||"string"===typeof c)return new ec(c,b);if(c&&"number"===typeof c.length)return new fc(c,
b)}throw new TypeError((null!==c&&typeof c||c)+" is not observable");};a.prototype._subscribe=function(c){var a=this.ish,b=this.scheduler;return null==b?a[H]().subscribe(c):a[H]().subscribe(new ia(c,b,0))};return a}(g);g.from=Sa.create;var Ta=Object.prototype.toString,ic=function(b){function a(c,a,d,f){b.call(this);this.sourceObj=c;this.eventName=a;this.selector=d;this.options=f}k(a,b);a.create=function(c,b,d,f){M(d)&&(f=d,d=void 0);return new a(c,b,f,d)};a.setupSubscription=function(c,b,d,f,h){var e;
...
this.work=null;this.pending=!1;this.scheduler=null;-1!==f&&b.splice(f,1);null!=c&&(this.id=this.recycleAsyncId(a,c,null))};return a}(function(b){function a(c,a){b.call(this)}k(a,b);a.prototype.schedule=function(c,a){return this};return a}(u)),S=function(b){function a(){b.apply(this,arguments);this.actions=[];this.active=!1;this.scheduled=void 0}k(a,b);a.prototype.flush=function(c){var a=this.actions;if(this.active)a.push(c);else{var b;this.active=!0;do if(b=c.execute(c.state,c.delay))break;while(c=
a.shift());this.active=!1;if(b){for(;c=a.shift();)c.unsubscribe();throw b;}}};return a}(function(){function b(a,c){void 0===c&&(c=b.now);this.SchedulerAction=a;this.now=c}b.prototype.schedule=function(a,c,b){void 0===c&&(c=0);return(new this.SchedulerAction(this,a)).schedule(b,c)};b.now=Date.now?Date.now:function(){return+new Date};return b}()),x=new S(R),nc=function(b){function a(c,a){void 0===c&&(c=0);void 0===a&&(a=x);b.call(this);this.period=c;this.scheduler=a;if(!P(c)||0>c)this.period=0;a&&"function"===
typeof a.schedule||(this.scheduler=x)}k(a,b);a.create=function(c,b){void 0===c&&(c=0);void 0===b&&(b=x);return new a(c,b)};a.dispatch=function(c){var a=c.subscriber,b=c.period;a.next(c.index);a.closed||(c.index+=1,this.schedule(c,b))};a.prototype._subscribe=function(c){var b=this.period;c.add(this.scheduler.schedule(a.dispatch,b,{index:0,subscriber:c,period:b}))};return a}(g).create;g.interval=nc;g.merge=sa;var tb=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new oc(a))};
return b}(),oc=function(b){function a(c){b.call(this,c);this.hasFirst=!1;this.observables=[];this.subscriptions=[]}k(a,b);a.prototype._next=function(c){this.observables.push(c)};a.prototype._complete=function(){var c=this.observables,a=c.length;if(0===a)this.destination.complete();else{for(var b=0;b<a&&!this.hasFirst;b++){var f=c[b],f=p(this,f,f,b);this.subscriptions&&this.subscriptions.push(f);this.add(f)}this.observables=null}};a.prototype.notifyNext=function(c,a,b,f,h){if(!this.hasFirst){this.hasFirst=
!0;for(c=0;c<this.subscriptions.length;c++)c!==b&&(f=this.subscriptions[c],f.unsubscribe(),this.remove(f));this.subscriptions=null}this.destination.next(a)};return a}(q);g.race=ta;var pc=function(b){function a(){b.call(this)}k(a,b);a.create=function(){return new a};a.prototype._subscribe=function(c){};return a}(g).create;g.never=pc;g.of=E.of;var Va=function(){function b(a){this.nextSources=a}b.prototype.call=function(a,c){return c.subscribe(new qc(a,this.nextSources))};return b}(),qc=function(b){function a(c,
...
c,a)}k(a,b);return a}(aa);g.ajax=I.create;var Dc=function(b){function a(c,a){b.call(this,c,a);this.scheduler=c;this.work=a}k(a,b);a.prototype.schedule=function(c,a){void 0===a&&(a=0);if(0<a)return b.prototype.schedule.call(this,c,a);this.delay=a;this.state=c;this.scheduler.flush(this);return this};a.prototype.execute=function(c,a){return 0<a||this.closed?b.prototype.execute.call(this,c,a):this._execute(c,a)};a.prototype.requestAsyncId=function(c,a,d){void 0===d&&(d=0);return null!==d&&0<d||null===
d&&0<this.delay?b.prototype.requestAsyncId.call(this,c,a,d):c.flush(this)};return a}(R),Ya=new (function(b){function a(){b.apply(this,arguments)}k(a,b);return a}(S))(Dc),L=function(b){function a(c,a,d){void 0===c&&(c=Number.POSITIVE_INFINITY);void 0===a&&(a=Number.POSITIVE_INFINITY);b.call(this);this.scheduler=d;this._events=[];this._bufferSize=1>c?1:c;this._windowTime=1>a?1:a}k(a,b);a.prototype.next=function(c){var a=this._getNow();this._events.push(new Ec(a,c));this._trimBufferThenGetEvents();b.prototype.next.call(this,
...
this._getNow(),a=this._bufferSize,b=this._windowTime,f=this._events,h=f.length,g=0;g<h&&!(c-f[g].time<b);)g++;h>a&&(g=Math.max(g,h-a));0<g&&f.splice(0,g);return f};return a}(v),Ec=function(){return function(b,a){this.time=b;this.value=a}}(),Fc=n.Object.assign||Bb,Gc=function(b){function a(c,a){if(c instanceof g)b.call(this,a,c);else{b.call(this);this.WebSocketCtor=n.WebSocket;this._output=new v;"string"===typeof c?this.url=c:Fc(this,c);if(!this.WebSocketCtor)throw Error("no WebSocket constructor can be found");
this.destination=new L}}k(a,b);a.prototype.resultSelector=function(c){return JSON.parse(c.data)};a.create=function(c){return new a(c)};a.prototype.lift=function(c){var b=new a(this,this.destination);b.operator=c;return b};a.prototype._resetState=function(){this.socket=null;this.source||(this.destination=new L);this._output=new v};a.prototype.multiplex=function(c,a,b){var e=this;return new g(function(d){var f=r(c)();f===m?d.error(m.e):e.next(f);var h=e.subscribe(function(c){var a=r(b)(c);a===m?d.error(m.e):
...
return b};a.prototype.unsubscribe=function(){var c=this.source,a=this.socket;a&&1===a.readyState&&(a.close(),this._resetState());b.prototype.unsubscribe.call(this);c||(this.destination=new L)};return a}(Z).create;g.webSocket=Gc;var Ic=function(){function b(a){this.closingNotifier=a}b.prototype.call=function(a,c){return c.subscribe(new Hc(a,this.closingNotifier))};return b}(),Hc=function(b){function a(c,a){b.call(this,c);this.buffer=[];this.add(p(this,a))}k(a,b);a.prototype._next=function(c){this.buffer.push(c)};
a.prototype.notifyNext=function(c,a,b,f,h){c=this.buffer;this.buffer=[];this.destination.next(c)};return a}(q);g.prototype.buffer=function(b){return this.lift(new Ic(b))};var Lc=function(){function b(a,c){this.bufferSize=a;this.subscriberClass=(this.startBufferEvery=c)&&a!==c?Jc:Kc}b.prototype.call=function(a,c){return c.subscribe(new this.subscriberClass(a,this.bufferSize,this.startBufferEvery))};return b}(),Kc=function(b){function a(c,a){b.call(this,c);this.bufferSize=a;this.buffer=[]}k(a,b);a.prototype._next=
function(c){var a=this.buffer;a.push(c);a.length==this.bufferSize&&(this.destination.next(a),this.buffer=[])};a.prototype._complete=function(){var c=this.buffer;0<c.length&&this.destination.next(c);b.prototype._complete.call(this)};return a}(l),Jc=function(b){function a(c,a,d){b.call(this,c);this.bufferSize=a;this.startBufferEvery=d;this.buffers=[];this.count=0}k(a,b);a.prototype._next=function(c){var a=this.bufferSize,b=this.startBufferEvery,f=this.buffers,h=this.count;this.count++;0===h%b&&f.push([]);
for(b=f.length;b--;)h=f[b],h.push(c),h.length===a&&(f.splice(b,1),this.destination.next(h))};a.prototype._complete=function(){for(var c=this.buffers,a=this.destination;0<c.length;){var d=c.shift();0<d.length&&a.next(d)}b.prototype._complete.call(this)};return a}(l);g.prototype.bufferCount=function(b,a){void 0===a&&(a=null);return this.lift(new Lc(b,a))};var Nc=function(){function b(a,c,b,d){this.bufferTimeSpan=a;this.bufferCreationInterval=c;this.maxBufferSize=b;this.scheduler=d}b.prototype.call=
function(a,c){return c.subscribe(new Mc(a,this.bufferTimeSpan,this.bufferCreationInterval,this.maxBufferSize,this.scheduler))};return b}(),Oc=function(){return function(){this.buffer=[]}}(),Mc=function(b){function a(c,a,d,f,h){b.call(this,c);this.bufferTimeSpan=a;this.bufferCreationInterval=d;this.maxBufferSize=f;this.scheduler=h;this.contexts=[];c=this.openContext();(this.timespanOnly=null==d||0>d)?this.add(c.closeAction=h.schedule(ya,a,{subscriber:this,context:c,bufferTimeSpan:a})):(f={bufferTimeSpan:a,
bufferCreationInterval:d,subscriber:this,scheduler:h},this.add(c.closeAction=h.schedule(za,a,{subscriber:this,context:c})),this.add(h.schedule(Cb,d,f)))}k(a,b);a.prototype._next=function(a){for(var c=this.contexts,b=c.length,f,h=0;h<b;h++){var g=c[h],k=g.buffer;k.push(a);k.length==this.maxBufferSize&&(f=g)}if(f)this.onBufferFull(f)};a.prototype._error=function(a){this.contexts.length=0;b.prototype._error.call(this,a)};a.prototype._complete=function(){for(var a=this.contexts,e=this.destination;0<a.length;){var d=
a.shift();e.next(d.buffer)}b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){this.contexts=null};a.prototype.onBufferFull=function(a){this.closeContext(a);a=a.closeAction;a.unsubscribe();this.remove(a);if(!this.closed&&this.timespanOnly){a=this.openContext();var c=this.bufferTimeSpan;this.add(a.closeAction=this.scheduler.schedule(ya,c,{subscriber:this,context:a,bufferTimeSpan:c}))}};a.prototype.openContext=function(){var a=new Oc;this.contexts.push(a);return a};a.prototype.closeContext=
function(a){this.destination.next(a.buffer);var c=this.contexts;0<=(c?c.indexOf(a):-1)&&c.splice(c.indexOf(a),1)};return a}(l);g.prototype.bufferTime=function(b){var a=arguments.length,c=x;z(arguments[arguments.length-1])&&(c=arguments[arguments.length-1],a--);var e=null;2<=a&&(e=arguments[1]);var d=Number.POSITIVE_INFINITY;3<=a&&(d=arguments[2]);return this.lift(new Nc(b,e,d,c))};var Qc=function(){function b(a,c){this.openings=a;this.closingSelector=c}b.prototype.call=function(a,c){return c.subscribe(new Pc(a,
this.openings,this.closingSelector))};return b}(),Pc=function(b){function a(a,e,d){b.call(this,a);this.openings=e;this.closingSelector=d;this.contexts=[];this.add(p(this,e))}k(a,b);a.prototype._next=function(a){for(var c=this.contexts,b=c.length,f=0;f<b;f++)c[f].buffer.push(a)};a.prototype._error=function(a){for(var c=this.contexts;0<c.length;){var d=c.shift();d.subscription.unsubscribe();d.buffer=null;d.subscription=null}this.contexts=null;b.prototype._error.call(this,a)};a.prototype._complete=function(){for(var a=
...
function(a){var c=this.buffer;this.remove(a);this.active--;0<c.length?this._next(c.shift()):0===this.active&&this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.concatMapTo=function(b,a){return this.lift(new Ea(b,a,1))};var Xc=function(){function b(a,c){this.predicate=a;this.source=c}b.prototype.call=function(a,c){return c.subscribe(new Wc(a,this.predicate,this.source))};return b}(),Wc=function(b){function a(a,e,d){b.call(this,a);this.predicate=e;this.source=d;this.index=this.count=
0}k(a,b);a.prototype._next=function(a){this.predicate?this._tryPredicate(a):this.count++};a.prototype._tryPredicate=function(a){var c;try{c=this.predicate(a,this.index++,this.source)}catch(d){this.destination.error(d);return}c&&this.count++};a.prototype._complete=function(){this.destination.next(this.count);this.destination.complete()};return a}(l);g.prototype.count=function(b){return this.lift(new Xc(b,this))};var Zc=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new Yc(a))};
return b}(),Yc=function(b){function a(a){b.call(this,a)}k(a,b);a.prototype._next=function(a){a.observe(this.destination)};return a}(l);g.prototype.dematerialize=function(){return this.lift(new Zc)};var ad=function(){function b(a){this.durationSelector=a}b.prototype.call=function(a,c){return c.subscribe(new $c(a,this.durationSelector))};return b}(),$c=function(b){function a(a,e){b.call(this,a);this.durationSelector=e;this.hasValue=!1;this.durationSubscription=null}k(a,b);a.prototype._next=function(a){try{var c=
...
function(){if(this.hasValue){var a=this.value,e=this.durationSubscription;e&&(this.durationSubscription=null,e.unsubscribe(),this.remove(e));this.value=null;this.hasValue=!1;b.prototype._next.call(this,a)}};return a}(q);g.prototype.debounce=function(b){return this.lift(new ad(b))};var cd=function(){function b(a,c){this.dueTime=a;this.scheduler=c}b.prototype.call=function(a,c){return c.subscribe(new bd(a,this.dueTime,this.scheduler))};return b}(),bd=function(b){function a(a,e,d){b.call(this,a);this.dueTime=
...
function(){var a=this.debouncedSubscription;null!==a&&(this.remove(a),a.unsubscribe(),this.debouncedSubscription=null)};return a}(l);g.prototype.debounceTime=function(b,a){void 0===a&&(a=x);return this.lift(new cd(b,a))};var ed=function(){function b(a){this.defaultValue=a}b.prototype.call=function(a,c){return c.subscribe(new dd(a,this.defaultValue))};return b}(),dd=function(b){function a(a,e){b.call(this,a);this.defaultValue=e;this.isEmpty=!0}k(a,b);a.prototype._next=function(a){this.isEmpty=!1;this.destination.next(a)};
a.prototype._complete=function(){this.isEmpty&&this.destination.next(this.defaultValue);this.destination.complete()};return a}(l);g.prototype.defaultIfEmpty=function(b){void 0===b&&(b=null);return this.lift(new ed(b))};var gd=function(){function b(a,c){this.delay=a;this.scheduler=c}b.prototype.call=function(a,c){return c.subscribe(new fd(a,this.delay,this.scheduler))};return b}(),fd=function(b){function a(a,e,d){b.call(this,a);this.delay=e;this.scheduler=d;this.queue=[];this.errored=this.active=!1}
k(a,b);a.dispatch=function(a){for(var c=a.source,b=c.queue,f=a.scheduler,h=a.destination;0<b.length&&0>=b[0].time-f.now();)b.shift().notification.observe(h);0<b.length?(c=Math.max(0,b[0].time-f.now()),this.schedule(a,c)):c.active=!1};a.prototype._schedule=function(c){this.active=!0;this.add(c.schedule(a.dispatch,this.delay,{source:this,destination:this.destination,scheduler:c}))};a.prototype.scheduleNotification=function(a){if(!0!==this.errored){var c=this.scheduler;a=new hd(c.now()+this.delay,a);
this.queue.push(a);!1===this.active&&this._schedule(c)}};a.prototype._next=function(a){this.scheduleNotification(w.createNext(a))};a.prototype._error=function(a){this.errored=!0;this.queue=[];this.destination.error(a)};a.prototype._complete=function(){this.scheduleNotification(w.createComplete())};return a}(l),hd=function(){return function(b,a){this.time=b;this.notification=a}}();g.prototype.delay=function(b,a){void 0===a&&(a=x);b=X(b)?+b-a.now():Math.abs(b);return this.lift(new gd(b,a))};var Za=
function(){function b(a){this.delayDurationSelector=a}b.prototype.call=function(a,c){return c.subscribe(new id(a,this.delayDurationSelector))};return b}(),id=function(b){function a(a,e){b.call(this,a);this.delayDurationSelector=e;this.completed=!1;this.delayNotifierSubscriptions=[];this.values=[]}k(a,b);a.prototype.notifyNext=function(a,b,d,f,h){this.destination.next(a);this.removeSubscription(h);this.tryComplete()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype.notifyComplete=
...
a.prototype.tryDelay=function(a,b){a=p(this,a,b);this.add(a);this.delayNotifierSubscriptions.push(a);this.values.push(b)};a.prototype.tryComplete=function(){this.completed&&0===this.delayNotifierSubscriptions.length&&this.destination.complete()};return a}(q),kd=function(b){function a(a,e){b.call(this);this.source=a;this.subscriptionDelay=e}k(a,b);a.prototype._subscribe=function(a){this.subscriptionDelay.subscribe(new jd(a,this.source))};return a}(g),jd=function(b){function a(a,e){b.call(this);this.parent=
a;this.source=e;this.sourceSubscribed=!1}k(a,b);a.prototype._next=function(a){this.subscribeToSource()};a.prototype._error=function(a){this.unsubscribe();this.parent.error(a)};a.prototype._complete=function(){this.subscribeToSource()};a.prototype.subscribeToSource=function(){this.sourceSubscribed||(this.sourceSubscribed=!0,this.unsubscribe(),this.source.subscribe(this.parent))};return a}(l);g.prototype.delayWhen=function(b,a){return a?(new kd(this,a)).lift(new Za(b)):this.lift(new Za(b))};var ld=
n.Set||Fb(),nd=function(){function b(a,c){this.keySelector=a;this.flushes=c}b.prototype.call=function(a,c){return c.subscribe(new md(a,this.keySelector,this.flushes))};return b}(),md=function(b){function a(a,e,d){b.call(this,a);this.keySelector=e;this.values=new ld;d&&this.add(p(this,d))}k(a,b);a.prototype.notifyNext=function(a,b,d,f,h){this.values.clear()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype._next=function(a){this.keySelector?this._useKeySelector(a):this._finalizeNext(a,
a)};a.prototype._useKeySelector=function(a){var c,b=this.destination;try{c=this.keySelector(a)}catch(f){b.error(f);return}this._finalizeNext(c,a)};a.prototype._finalizeNext=function(a,b){var c=this.values;c.has(a)||(c.add(a),this.destination.next(b))};return a}(q);g.prototype.distinct=function(b,a){return this.lift(new nd(b,a))};var Gb=function(){function b(a,c){this.compare=a;this.keySelector=c}b.prototype.call=function(a,c){return c.subscribe(new od(a,this.compare,this.keySelector))};return b}(),
od=function(b){function a(a,e,d){b.call(this,a);this.keySelector=d;this.hasKey=!1;"function"===typeof e&&(this.compare=e)}k(a,b);a.prototype.compare=function(a,b){return a===b};a.prototype._next=function(a){var c=a;if(this.keySelector&&(c=r(this.keySelector)(a),c===m))return this.destination.error(m.e);var b=!1;if(this.hasKey){if(b=r(this.compare)(this.key,c),b===m)return this.destination.error(m.e)}else this.hasKey=!0;!1===!!b&&(this.key=c,this.destination.next(a))};return a}(l);g.prototype.distinctUntilChanged=
Fa;g.prototype.distinctUntilKeyChanged=function(b,a){return Fa.call(this,function(c,e){return a?a(c[b],e[b]):c[b]===e[b]})};var Hb=function(){function b(a,c,b){this.nextOrObserver=a;this.error=c;this.complete=b}b.prototype.call=function(a,c){return c.subscribe(new pd(a,this.nextOrObserver,this.error,this.complete))};return b}(),pd=function(b){function a(a,e,d,f){b.call(this,a);a=new l(e,d,f);a.syncErrorThrowable=!0;this.add(a);this.safeSubscriber=a}k(a,b);a.prototype._next=function(a){var c=this.safeSubscriber;
c.next(a);c.syncErrorThrown?this.destination.error(c.syncErrorValue):this.destination.next(a)};a.prototype._error=function(a){var c=this.safeSubscriber;c.error(a);c.syncErrorThrown?this.destination.error(c.syncErrorValue):this.destination.error(a)};a.prototype._complete=function(){var a=this.safeSubscriber;a.complete();a.syncErrorThrown?this.destination.error(a.syncErrorValue):this.destination.complete()};return a}(l);g.prototype.do=Ga;g.prototype._do=Ga;var rd=function(){function b(){}b.prototype.call=
function(a,c){return c.subscribe(new qd(a))};return b}(),qd=function(b){function a(a){b.call(this,a);this.hasSubscription=this.hasCompleted=!1}k(a,b);a.prototype._next=function(a){this.hasSubscription||(this.hasSubscription=!0,this.add(p(this,a)))};a.prototype._complete=function(){this.hasCompleted=!0;this.hasSubscription||this.destination.complete()};a.prototype.notifyComplete=function(a){this.remove(a);this.hasSubscription=!1;this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.exhaust=
function(){return this.lift(new rd)};var td=function(){function b(a,c){this.project=a;this.resultSelector=c}b.prototype.call=function(a,c){return c.subscribe(new sd(a,this.project,this.resultSelector))};return b}(),sd=function(b){function a(a,e,d){b.call(this,a);this.project=e;this.resultSelector=d;this.hasCompleted=this.hasSubscription=!1;this.index=0}k(a,b);a.prototype._next=function(a){this.hasSubscription||this.tryNext(a)};a.prototype.tryNext=function(a){var c=this.index++,b=this.destination;
...
a.prototype.notifyComplete=function(a){this.remove(a);this.hasSubscription=!1;this.hasCompleted&&this.destination.complete()};return a}(q);g.prototype.exhaustMap=function(b,a){return this.lift(new td(b,a))};var vd=function(){function b(a,c,b){this.project=a;this.concurrent=c;this.scheduler=b}b.prototype.call=function(a,c){return c.subscribe(new ud(a,this.project,this.concurrent,this.scheduler))};return b}(),ud=function(b){function a(a,e,d,f){b.call(this,a);this.project=e;this.concurrent=d;this.scheduler=
...
function(b,a,c){void 0===a&&(a=Number.POSITIVE_INFINITY);void 0===c&&(c=void 0);a=1>(a||0)?Number.POSITIVE_INFINITY:a;return this.lift(new vd(b,a,c))};var T=function(b){function a(){var a=b.call(this,"argument out of range");this.name=a.name="ArgumentOutOfRangeError";this.stack=a.stack;this.message=a.message}k(a,b);return a}(Error),xd=function(){function b(a,c){this.index=a;this.defaultValue=c;if(0>a)throw new T;}b.prototype.call=function(a,c){return c.subscribe(new wd(a,this.index,this.defaultValue))};
return b}(),wd=function(b){function a(a,e,d){b.call(this,a);this.index=e;this.defaultValue=d}k(a,b);a.prototype._next=function(a){0===this.index--&&(this.destination.next(a),this.destination.complete())};a.prototype._complete=function(){var a=this.destination;0<=this.index&&("undefined"!==typeof this.defaultValue?a.next(this.defaultValue):a.error(new T));a.complete()};return a}(l);g.prototype.elementAt=function(b,a){return this.lift(new xd(b,a))};var Ib=function(){function b(a,c){this.predicate=a;
this.thisArg=c}b.prototype.call=function(a,c){return c.subscribe(new yd(a,this.predicate,this.thisArg))};return b}(),yd=function(b){function a(a,e,d){b.call(this,a);this.predicate=e;this.thisArg=d;this.count=0;this.predicate=e}k(a,b);a.prototype._next=function(a){var c;try{c=this.predicate.call(this.thisArg,a,this.count++)}catch(d){this.destination.error(d);return}c&&this.destination.next(a)};return a}(l);g.prototype.filter=ea;var Jb=function(){function b(a){this.callback=a}b.prototype.call=function(a,
c){return c.subscribe(new zd(a,this.callback))};return b}(),zd=function(b){function a(a,e){b.call(this,a);this.add(new u(e))}k(a,b);return a}(l);g.prototype.finally=Ha;g.prototype._finally=Ha;var $a=function(){function b(a,c,b,d){this.predicate=a;this.source=c;this.yieldIndex=b;this.thisArg=d}b.prototype.call=function(a,c){return c.subscribe(new Ad(a,this.predicate,this.source,this.yieldIndex,this.thisArg))};return b}(),Ad=function(b){function a(a,e,d,f,h){b.call(this,a);this.predicate=e;this.source=
...
a.complete())};return a}(l);g.prototype.first=function(b,a,c){return this.lift(new Cd(b,a,c,this))};var Dd=function(){function b(){this.size=0;this._values=[];this._keys=[]}b.prototype.get=function(a){a=this._keys.indexOf(a);return-1===a?void 0:this._values[a]};b.prototype.set=function(a,c){var b=this._keys.indexOf(a);-1===b?(this._keys.push(a),this._values.push(c),this.size++):this._values[b]=c;return this};b.prototype.delete=function(a){a=this._keys.indexOf(a);if(-1===a)return!1;this._values.splice(a,
1);this._keys.splice(a,1);this.size--;return!0};b.prototype.clear=function(){this._keys.length=0;this.size=this._values.length=0};b.prototype.forEach=function(a,c){for(var b=0;b<this.size;b++)a.call(c,this._values[b],this._keys[b])};return b}(),Ed=n.Map||Dd,Fd=function(){function b(){this.values={}}b.prototype.delete=function(a){this.values[a]=null;return!0};b.prototype.set=function(a,c){this.values[a]=c;return this};b.prototype.get=function(a){return this.values[a]};b.prototype.forEach=function(a,
c){var b=this.values,d;for(d in b)b.hasOwnProperty(d)&&null!==b[d]&&a.call(c,b[d],d)};b.prototype.clear=function(){this.values={}};return b}(),Hd=function(){function b(a,c,b,d){this.keySelector=a;this.elementSelector=c;this.durationSelector=b;this.subjectSelector=d}b.prototype.call=function(a,c){return c.subscribe(new Gd(a,this.keySelector,this.elementSelector,this.durationSelector,this.subjectSelector))};return b}(),Gd=function(b){function a(a,e,d,f,h){b.call(this,a);this.keySelector=e;this.elementSelector=
d;this.durationSelector=f;this.subjectSelector=h;this.groups=null;this.attemptedToUnsubscribe=!1;this.count=0}k(a,b);a.prototype._next=function(a){var c;try{c=this.keySelector(a)}catch(d){this.error(d);return}this._group(a,c)};a.prototype._group=function(a,b){var c=this.groups;c||(c=this.groups="string"===typeof b?new Fd:new Ed);var e=c.get(b),h;if(this.elementSelector)try{h=this.elementSelector(a)}catch(y){this.error(y)}else h=a;if(!e&&(e=this.subjectSelector?this.subjectSelector():new v,c.set(b,
e),a=new ab(b,e,this),this.destination.next(a),this.durationSelector)){a=void 0;try{a=this.durationSelector(new ab(b,e))}catch(y){this.error(y);return}this.add(a.subscribe(new Id(b,e,this)))}e.closed||e.next(h)};a.prototype._error=function(a){var c=this.groups;c&&(c.forEach(function(c,b){c.error(a)}),c.clear());this.destination.error(a)};a.prototype._complete=function(){var a=this.groups;a&&(a.forEach(function(a,c){a.complete()}),a.clear());this.destination.complete()};a.prototype.removeGroup=function(a){this.groups.delete(a)};
a.prototype.unsubscribe=function(){this.closed||(this.attemptedToUnsubscribe=!0,0===this.count&&b.prototype.unsubscribe.call(this))};return a}(l),Id=function(b){function a(a,e,d){b.call(this);this.key=a;this.group=e;this.parent=d}k(a,b);a.prototype._next=function(a){this._complete()};a.prototype._error=function(a){var c=this.group;c.closed||c.error(a);this.parent.removeGroup(this.key)};a.prototype._complete=function(){var a=this.group;a.closed||a.complete();this.parent.removeGroup(this.key)};return a}(l),
ab=function(b){function a(a,e,d){b.call(this);this.key=a;this.groupSubject=e;this.refCountSubscription=d}k(a,b);a.prototype._subscribe=function(a){var c=new u,b=this.refCountSubscription,f=this.groupSubject;b&&!b.closed&&c.add(new Jd(b));c.add(f.subscribe(a));return c};return a}(g),Jd=function(b){function a(a){b.call(this);this.parent=a;a.count++}k(a,b);a.prototype.unsubscribe=function(){var a=this.parent;a.closed||this.closed||(b.prototype.unsubscribe.call(this),--a.count,0===a.count&&a.attemptedToUnsubscribe&&
a.unsubscribe())};return a}(u);g.prototype.groupBy=function(b,a,c,e){return this.lift(new Hd(b,a,c,e))};var Ld=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new Kd(a))};return b}(),Kd=function(b){function a(){b.apply(this,arguments)}k(a,b);a.prototype._next=function(a){};return a}(l);g.prototype.ignoreElements=function(){return this.lift(new Ld)};var Nd=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new Md(a))};return b}(),Md=function(b){function a(a){b.call(this,
a)}k(a,b);a.prototype.notifyComplete=function(a){var c=this.destination;c.next(a);c.complete()};a.prototype._next=function(a){this.notifyComplete(!1)};a.prototype._complete=function(){this.notifyComplete(!0)};return a}(l);g.prototype.isEmpty=function(){return this.lift(new Nd)};var Pd=function(){function b(a){this.durationSelector=a}b.prototype.call=function(a,c){return c.subscribe(new Od(a,this.durationSelector))};return b}(),Od=function(b){function a(a,e){b.call(this,a);this.durationSelector=e;
...
return a}(q);g.prototype.audit=function(b){return this.lift(new Pd(b))};var Rd=function(){function b(a,c){this.duration=a;this.scheduler=c}b.prototype.call=function(a,c){return c.subscribe(new Qd(a,this.duration,this.scheduler))};return b}(),Qd=function(b){function a(a,e,d){b.call(this,a);this.duration=e;this.scheduler=d;this.hasValue=!1}k(a,b);a.prototype._next=function(a){this.value=a;this.hasValue=!0;this.throttled||this.add(this.throttled=this.scheduler.schedule(Kb,this.duration,this))};a.prototype.clearThrottle=
function(){var a=this.value,b=this.hasValue,d=this.throttled;d&&(this.remove(d),this.throttled=null,d.unsubscribe());b&&(this.value=null,this.hasValue=!1,this.destination.next(a))};return a}(l);g.prototype.auditTime=function(b,a){void 0===a&&(a=x);return this.lift(new Rd(b,a))};var Td=function(){function b(a,c,b,d){this.predicate=a;this.resultSelector=c;this.defaultValue=b;this.source=d}b.prototype.call=function(a,c){return c.subscribe(new Sd(a,this.predicate,this.resultSelector,this.defaultValue,
this.source))};return b}(),Sd=function(b){function a(a,e,d,f,h){b.call(this,a);this.predicate=e;this.resultSelector=d;this.defaultValue=f;this.source=h;this.hasValue=!1;this.index=0;"undefined"!==typeof f&&(this.lastValue=f,this.hasValue=!0)}k(a,b);a.prototype._next=function(a){var c=this.index++;this.predicate?this._tryPredicate(a,c):this.resultSelector?this._tryResultSelector(a,c):(this.lastValue=a,this.hasValue=!0)};a.prototype._tryPredicate=function(a,b){var c;try{c=this.predicate(a,b,this.source)}catch(f){this.destination.error(f);
return}c&&(this.resultSelector?this._tryResultSelector(a,b):(this.lastValue=a,this.hasValue=!0))};a.prototype._tryResultSelector=function(a,b){var c;try{c=this.resultSelector(a,b)}catch(f){this.destination.error(f);return}this.lastValue=c;this.hasValue=!0};a.prototype._complete=function(){var a=this.destination;this.hasValue?(a.next(this.lastValue),a.complete()):a.error(new ba)};return a}(l);g.prototype.last=function(b,a,c){return this.lift(new Td(b,a,c,this))};g.prototype.let=Ia;g.prototype.letBind=
Ia;var Vd=function(){function b(a,c,b){this.predicate=a;this.thisArg=c;this.source=b}b.prototype.call=function(a,c){return c.subscribe(new Ud(a,this.predicate,this.thisArg,this.source))};return b}(),Ud=function(b){function a(a,e,d,f){b.call(this,a);this.predicate=e;this.thisArg=d;this.source=f;this.index=0;this.thisArg=d||this}k(a,b);a.prototype.notifyComplete=function(a){this.destination.next(a);this.destination.complete()};a.prototype._next=function(a){var c=!1;try{c=this.predicate.call(this.thisArg,
a,this.index++,this.source)}catch(d){this.destination.error(d);return}c||this.notifyComplete(!1)};a.prototype._complete=function(){this.notifyComplete(!0)};return a}(l);g.prototype.every=function(b,a){return this.lift(new Vd(b,a,this))};g.prototype.map=wa;var Xd=function(){function b(a){this.value=a}b.prototype.call=function(a,c){return c.subscribe(new Wd(a,this.value))};return b}(),Wd=function(b){function a(a,e){b.call(this,a);this.value=e}k(a,b);a.prototype._next=function(a){this.destination.next(this.value)};
return a}(l);g.prototype.mapTo=function(b){return this.lift(new Xd(b))};var Zd=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new Yd(a))};return b}(),Yd=function(b){function a(a){b.call(this,a)}k(a,b);a.prototype._next=function(a){this.destination.next(w.createNext(a))};a.prototype._error=function(a){var c=this.destination;c.next(w.createError(a));c.complete()};a.prototype._complete=function(){var a=this.destination;a.next(w.createComplete());a.complete()};return a}(l);
g.prototype.materialize=function(){return this.lift(new Zd)};var ja=function(){function b(a,c,b){void 0===b&&(b=!1);this.accumulator=a;this.seed=c;this.hasSeed=b}b.prototype.call=function(a,c){return c.subscribe(new $d(a,this.accumulator,this.seed,this.hasSeed))};return b}(),$d=function(b){function a(a,e,d,f){b.call(this,a);this.accumulator=e;this.hasSeed=f;this.index=0;this.hasValue=!1;this.acc=d;this.hasSeed||this.index++}k(a,b);a.prototype._next=function(a){this.hasValue||(this.hasValue=this.hasSeed)?
...
[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];return this.lift.call(sa.apply(void 0,[this].concat(b)))};g.prototype.mergeAll=function(b){void 0===b&&(b=Number.POSITIVE_INFINITY);return this.lift(new W(b))};g.prototype.mergeMap=Ba;g.prototype.flatMap=Ba;g.prototype.flatMapTo=Da;g.prototype.mergeMapTo=Da;var be=function(){function b(a,c,b){this.accumulator=a;this.seed=c;this.concurrent=b}b.prototype.call=function(a,c){return c.subscribe(new ae(a,this.accumulator,this.seed,this.concurrent))};return b}(),
...
function(b,a,c){void 0===c&&(c=Number.POSITIVE_INFINITY);return this.lift(new be(b,a,c))};g.prototype.min=function(b){return this.lift(new ja("function"===typeof b?function(a,c){return 0>b(a,c)?a:c}:function(a,c){return a<c?a:c}))};var U=function(b){function a(a,e){b.call(this);this.source=a;this.subjectFactory=e;this._refCount=0}k(a,b);a.prototype._subscribe=function(a){return this.getSubject().subscribe(a)};a.prototype.getSubject=function(){var a=this._subject;if(!a||a.isStopped)this._subject=this.subjectFactory();
return this._subject};a.prototype.connect=function(){var a=this._connection;a||(a=this._connection=new u,a.add(this.source.subscribe(new ce(this.getSubject(),this))),a.closed?(this._connection=null,a=u.EMPTY):this._connection=a);return a};a.prototype.refCount=function(){return this.lift(new de(this))};return a}(g),Mb={operator:{value:null},_refCount:{value:0,writable:!0},_subject:{value:null,writable:!0},_connection:{value:null,writable:!0},_subscribe:{value:U.prototype._subscribe},getSubject:{value:U.prototype.getSubject},
connect:{value:U.prototype.connect},refCount:{value:U.prototype.refCount}},ce=function(b){function a(a,e){b.call(this,a);this.connectable=e}k(a,b);a.prototype._error=function(a){this._unsubscribe();b.prototype._error.call(this,a)};a.prototype._complete=function(){this._unsubscribe();b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){var a=this.connectable;if(a){this.connectable=null;var b=a._connection;a._refCount=0;a._subject=null;a._connection=null;b&&b.unsubscribe()}};return a}(Oa),
de=function(){function b(a){this.connectable=a}b.prototype.call=function(a,c){var b=this.connectable;b._refCount++;a=new ee(a,b);c=c.subscribe(a);a.closed||(a.connection=b.connect());return c};return b}(),ee=function(b){function a(a,e){b.call(this,a);this.connectable=e}k(a,b);a.prototype._unsubscribe=function(){var a=this.connectable;if(a){this.connectable=null;var b=a._refCount;0>=b?this.connection=null:(a._refCount=b-1,1<b?this.connection=null:(b=this.connection,a=a._connection,this.connection=
null,!a||b&&a!==b||a.unsubscribe()))}else this.connection=null};return a}(l),Lb=function(){function b(a,c){this.subjectFactory=a;this.selector=c}b.prototype.call=function(a,c){var b=this.selector,d=this.subjectFactory();a=b(d).subscribe(a);a.add(c.subscribe(d));return a};return b}();g.prototype.multicast=J;g.prototype.observeOn=function(b,a){void 0===a&&(a=0);return this.lift(new gc(b,a))};g.prototype.onErrorResumeNext=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];1===b.length&&
D(b[0])&&(b=b[0]);return this.lift(new Va(b))};var ge=function(){function b(){}b.prototype.call=function(a,c){return c.subscribe(new fe(a))};return b}(),fe=function(b){function a(a){b.call(this,a);this.hasPrev=!1}k(a,b);a.prototype._next=function(a){this.hasPrev?this.destination.next([this.prev,a]):this.hasPrev=!0;this.prev=a};return a}(l);g.prototype.pairwise=function(){return this.lift(new ge)};g.prototype.partition=function(b,a){return[ea.call(this,b,a),ea.call(this,Nb(b,a))]};g.prototype.pluck=
function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];a=b.length;if(0===a)throw Error("list of properties cannot be empty.");return wa.call(this,Ob(b,a))};g.prototype.publish=function(b){return b?J.call(this,function(){return new v},b):J.call(this,new v)};var bb=function(b){function a(a){b.call(this);this._value=a}k(a,b);Object.defineProperty(a.prototype,"value",{get:function(){return this.getValue()},enumerable:!0,configurable:!0});a.prototype._subscribe=function(a){var c=b.prototype._subscribe.call(this,
a);c&&!c.closed&&a.next(this._value);return c};a.prototype.getValue=function(){if(this.hasError)throw this.thrownError;if(this.closed)throw new G;return this._value};a.prototype.next=function(a){b.prototype.next.call(this,this._value=a)};return a}(v);g.prototype.publishBehavior=function(b){return J.call(this,new bb(b))};g.prototype.publishReplay=function(b,a,c){void 0===b&&(b=Number.POSITIVE_INFINITY);void 0===a&&(a=Number.POSITIVE_INFINITY);return J.call(this,new L(b,a,c))};g.prototype.publishLast=
function(){return J.call(this,new K)};g.prototype.race=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];1===b.length&&D(b[0])&&(b=b[0]);return this.lift.call(ta.apply(void 0,[this].concat(b)))};g.prototype.reduce=function(b,a){var c=!1;2<=arguments.length&&(c=!0);return this.lift(new ja(b,a,c))};var cb=function(){function b(a,c){this.count=a;this.source=c}b.prototype.call=function(a,c){return c.subscribe(new he(a,this.count,this.source))};return b}(),he=function(b){function a(a,
e,d){b.call(this,a);this.count=e;this.source=d}k(a,b);a.prototype.complete=function(){if(!this.isStopped){var a=this.source,e=this.count;if(0===e)return b.prototype.complete.call(this);-1<e&&(this.count=e-1);a.subscribe(this._unsubscribeAndRecycle())}};return a}(l);g.prototype.repeat=function(b){void 0===b&&(b=-1);return 0===b?new F:0>b?this.lift(new cb(-1,this)):this.lift(new cb(b-1,this))};var je=function(){function b(a){this.notifier=a}b.prototype.call=function(a,c){return c.subscribe(new ie(a,
this.notifier,c))};return b}(),ie=function(b){function a(a,e,d){b.call(this,a);this.notifier=e;this.source=d;this.sourceIsBeingSubscribedTo=!0}k(a,b);a.prototype.notifyNext=function(a,b,d,f,h){this.sourceIsBeingSubscribedTo=!0;this.source.subscribe(this)};a.prototype.notifyComplete=function(a){if(!1===this.sourceIsBeingSubscribedTo)return b.prototype.complete.call(this)};a.prototype.complete=function(){this.sourceIsBeingSubscribedTo=!1;if(!this.isStopped){if(!this.retries)this.subscribeToRetries();
else if(this.retriesSubscription.closed)return b.prototype.complete.call(this);this._unsubscribeAndRecycle();this.notifications.next()}};a.prototype._unsubscribe=function(){var a=this.notifications,b=this.retriesSubscription;a&&(a.unsubscribe(),this.notifications=null);b&&(b.unsubscribe(),this.retriesSubscription=null);this.retries=null};a.prototype._unsubscribeAndRecycle=function(){var a=this.notifications,e=this.retries,d=this.retriesSubscription;this.retriesSubscription=this.retries=this.notifications=
null;b.prototype._unsubscribeAndRecycle.call(this);this.notifications=a;this.retries=e;this.retriesSubscription=d;return this};a.prototype.subscribeToRetries=function(){this.notifications=new v;var a=r(this.notifier)(this.notifications);if(a===m)return b.prototype.complete.call(this);this.retries=a;this.retriesSubscription=p(this,a)};return a}(q);g.prototype.repeatWhen=function(b){return this.lift(new je(b))};var le=function(){function b(a,c){this.count=a;this.source=c}b.prototype.call=function(a,
c){return c.subscribe(new ke(a,this.count,this.source))};return b}(),ke=function(b){function a(a,e,d){b.call(this,a);this.count=e;this.source=d}k(a,b);a.prototype.error=function(a){if(!this.isStopped){var c=this.source,d=this.count;if(0===d)return b.prototype.error.call(this,a);-1<d&&(this.count=d-1);c.subscribe(this._unsubscribeAndRecycle())}};return a}(l);g.prototype.retry=function(b){void 0===b&&(b=-1);return this.lift(new le(b,this))};var ne=function(){function b(a,c){this.notifier=a;this.source=
c}b.prototype.call=function(a,c){return c.subscribe(new me(a,this.notifier,this.source))};return b}(),me=function(b){function a(a,e,d){b.call(this,a);this.notifier=e;this.source=d}k(a,b);a.prototype.error=function(a){if(!this.isStopped){var c=this.errors,d=this.retries,f=this.retriesSubscription;if(d)this.retriesSubscription=this.errors=null;else{c=new v;d=r(this.notifier)(c);if(d===m)return b.prototype.error.call(this,m.e);f=p(this,d)}this._unsubscribeAndRecycle();this.errors=c;this.retries=d;this.retriesSubscription=
f;c.next(a)}};a.prototype._unsubscribe=function(){var a=this.errors,b=this.retriesSubscription;a&&(a.unsubscribe(),this.errors=null);b&&(b.unsubscribe(),this.retriesSubscription=null);this.retries=null};a.prototype.notifyNext=function(a,b,d,f,h){a=this.errors;b=this.retries;d=this.retriesSubscription;this.retriesSubscription=this.retries=this.errors=null;this._unsubscribeAndRecycle();this.errors=a;this.retries=b;this.retriesSubscription=d;this.source.subscribe(this)};return a}(q);g.prototype.retryWhen=
function(b){return this.lift(new ne(b,this))};var pe=function(){function b(a){this.notifier=a}b.prototype.call=function(a,c){a=new oe(a);c=c.subscribe(a);c.add(p(a,this.notifier));return c};return b}(),oe=function(b){function a(){b.apply(this,arguments);this.hasValue=!1}k(a,b);a.prototype._next=function(a){this.value=a;this.hasValue=!0};a.prototype.notifyNext=function(a,b,d,f,h){this.emitValue()};a.prototype.notifyComplete=function(){this.emitValue()};a.prototype.emitValue=function(){this.hasValue&&
(this.hasValue=!1,this.destination.next(this.value))};return a}(q);g.prototype.sample=function(b){return this.lift(new pe(b))};var re=function(){function b(a,c){this.period=a;this.scheduler=c}b.prototype.call=function(a,c){return c.subscribe(new qe(a,this.period,this.scheduler))};return b}(),qe=function(b){function a(a,e,d){b.call(this,a);this.period=e;this.scheduler=d;this.hasValue=!1;this.add(d.schedule(Pb,e,{subscriber:this,period:e}))}k(a,b);a.prototype._next=function(a){this.lastValue=a;this.hasValue=
!0};a.prototype.notifyNext=function(){this.hasValue&&(this.hasValue=!1,this.destination.next(this.lastValue))};return a}(l);g.prototype.sampleTime=function(b,a){void 0===a&&(a=x);return this.lift(new re(b,a))};var te=function(){function b(a,c,b){void 0===b&&(b=!1);this.accumulator=a;this.seed=c;this.hasSeed=b}b.prototype.call=function(a,c){return c.subscribe(new se(a,this.accumulator,this.seed,this.hasSeed))};return b}(),se=function(b){function a(a,e,d,f){b.call(this,a);this.accumulator=e;this._seed=
d;this.hasSeed=f;this.index=0}k(a,b);Object.defineProperty(a.prototype,"seed",{get:function(){return this._seed},set:function(a){this.hasSeed=!0;this._seed=a},enumerable:!0,configurable:!0});a.prototype._next=function(a){if(this.hasSeed)return this._tryNext(a);this.seed=a;this.destination.next(a)};a.prototype._tryNext=function(a){var c=this.index++,b;try{b=this.accumulator(this.seed,a,c)}catch(f){this.destination.error(f)}this.seed=b;this.destination.next(b)};return a}(l);g.prototype.scan=function(b,
a){var c=!1;2<=arguments.length&&(c=!0);return this.lift(new te(b,a,c))};var ve=function(){function b(a,c){this.compareTo=a;this.comparor=c}b.prototype.call=function(a,c){return c.subscribe(new ue(a,this.compareTo,this.comparor))};return b}(),ue=function(b){function a(a,e,d){b.call(this,a);this.compareTo=e;this.comparor=d;this._a=[];this._b=[];this._oneComplete=!1;this.add(e.subscribe(new we(a,this)))}k(a,b);a.prototype._next=function(a){this._oneComplete&&0===this._b.length?this.emit(!1):(this._a.push(a),
this.checkValues())};a.prototype._complete=function(){this._oneComplete?this.emit(0===this._a.length&&0===this._b.length):this._oneComplete=!0};a.prototype.checkValues=function(){for(var a=this._a,b=this._b,d=this.comparor;0<a.length&&0<b.length;){var f=a.shift(),h=b.shift();d?(f=r(d)(f,h),f===m&&this.destination.error(m.e)):f=f===h;f||this.emit(!1)}};a.prototype.emit=function(a){var c=this.destination;c.next(a);c.complete()};a.prototype.nextB=function(a){this._oneComplete&&0===this._a.length?this.emit(!1):
(this._b.push(a),this.checkValues())};return a}(l),we=function(b){function a(a,e){b.call(this,a);this.parent=e}k(a,b);a.prototype._next=function(a){this.parent.nextB(a)};a.prototype._error=function(a){this.parent.error(a)};a.prototype._complete=function(){this.parent._complete()};return a}(l);g.prototype.sequenceEqual=function(b,a){return this.lift(new ve(b,a))};g.prototype.share=function(){return J.call(this,Qb).refCount()};var ye=function(){function b(a,c){this.predicate=a;this.source=c}b.prototype.call=
function(a,c){return c.subscribe(new xe(a,this.predicate,this.source))};return b}(),xe=function(b){function a(a,e,d){b.call(this,a);this.predicate=e;this.source=d;this.seenValue=!1;this.index=0}k(a,b);a.prototype.applySingleValue=function(a){this.seenValue?this.destination.error("Sequence contains more than one element"):(this.seenValue=!0,this.singleValue=a)};a.prototype._next=function(a){var c=this.index++;this.predicate?this.tryNext(a,c):this.applySingleValue(a)};a.prototype.tryNext=function(a,
b){try{this.predicate(a,b,this.source)&&this.applySingleValue(a)}catch(d){this.destination.error(d)}};a.prototype._complete=function(){var a=this.destination;0<this.index?(a.next(this.seenValue?this.singleValue:void 0),a.complete()):a.error(new ba)};return a}(l);g.prototype.single=function(b){return this.lift(new ye(b,this))};var Ae=function(){function b(a){this.total=a}b.prototype.call=function(a,c){return c.subscribe(new ze(a,this.total))};return b}(),ze=function(b){function a(a,e){b.call(this,
a);this.total=e;this.count=0}k(a,b);a.prototype._next=function(a){++this.count>this.total&&this.destination.next(a)};return a}(l);g.prototype.skip=function(b){return this.lift(new Ae(b))};var Ce=function(){function b(a){this.notifier=a}b.prototype.call=function(a,c){return c.subscribe(new Be(a,this.notifier))};return b}(),Be=function(b){function a(a,e){b.call(this,a);this.isInnerStopped=this.hasValue=!1;this.add(p(this,e))}k(a,b);a.prototype._next=function(a){this.hasValue&&b.prototype._next.call(this,
a)};a.prototype._complete=function(){this.isInnerStopped?b.prototype._complete.call(this):this.unsubscribe()};a.prototype.notifyNext=function(a,b,d,f,h){this.hasValue=!0};a.prototype.notifyComplete=function(){this.isInnerStopped=!0;this.isStopped&&b.prototype._complete.call(this)};return a}(q);g.prototype.skipUntil=function(b){return this.lift(new Ce(b))};var Ee=function(){function b(a){this.predicate=a}b.prototype.call=function(a,c){return c.subscribe(new De(a,this.predicate))};return b}(),De=function(b){function a(a,
e){b.call(this,a);this.predicate=e;this.skipping=!0;this.index=0}k(a,b);a.prototype._next=function(a){var b=this.destination;this.skipping&&this.tryCallPredicate(a);this.skipping||b.next(a)};a.prototype.tryCallPredicate=function(a){try{this.skipping=!!this.predicate(a,this.index++)}catch(e){this.destination.error(e)}};return a}(l);g.prototype.skipWhile=function(b){return this.lift(new Ee(b))};g.prototype.startWith=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];a=b[b.length-
1];z(a)?b.pop():a=null;var c=b.length;return 1===c?O(new ga(b[0],a),this):1<c?O(new E(b,a),this):O(new F(a),this)};var db=new (function(){function b(a){this.root=a;a.setImmediate&&"function"===typeof a.setImmediate?(this.setImmediate=a.setImmediate.bind(a),this.clearImmediate=a.clearImmediate.bind(a)):(this.nextHandle=1,this.tasksByHandle={},this.currentlyRunningATask=!1,this.canUseProcessNextTick()?this.setImmediate=this.createProcessNextTickSetImmediate():this.canUsePostMessage()?this.setImmediate=
...
e.instance,b=a.addFromSetImmediateArguments(arguments);a.root.setTimeout(a.partiallyApplied(a.runIfPresent,b),0);return b};a.instance=this;return a};return b}())(n),Fe=function(b){function a(a,e){b.call(this,a,e);this.scheduler=a;this.work=e}k(a,b);a.prototype.requestAsyncId=function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d)return b.prototype.requestAsyncId.call(this,a,e,d);a.actions.push(this);return a.scheduled||(a.scheduled=db.setImmediate(a.flush.bind(a,null)))};a.prototype.recycleAsyncId=function(a,
e,d){void 0===d&&(d=0);if(null!==d&&0<d||null===d&&0<this.delay)return b.prototype.recycleAsyncId.call(this,a,e,d);0===a.actions.length&&(db.clearImmediate(e),a.scheduled=void 0)};return a}(R),ca=new (function(b){function a(){b.apply(this,arguments)}k(a,b);a.prototype.flush=function(a){this.active=!0;this.scheduled=void 0;var b=this.actions,c,f=-1,h=b.length;a=a||b.shift();do if(c=a.execute(a.state,a.delay))break;while(++f<h&&(a=b.shift()));this.active=!1;if(c){for(;++f<h&&(a=b.shift());)a.unsubscribe();
throw c;}};return a}(S))(Fe),Ge=function(b){function a(a,e,d){void 0===e&&(e=0);void 0===d&&(d=ca);b.call(this);this.source=a;this.delayTime=e;this.scheduler=d;if(!P(e)||0>e)this.delayTime=0;d&&"function"===typeof d.schedule||(this.scheduler=ca)}k(a,b);a.create=function(b,e,d){void 0===e&&(e=0);void 0===d&&(d=ca);return new a(b,e,d)};a.dispatch=function(a){return this.add(a.source.subscribe(a.subscriber))};a.prototype._subscribe=function(b){return this.scheduler.schedule(a.dispatch,this.delayTime,
{source:this.source,subscriber:b})};return a}(g),He=function(){function b(a,b){this.scheduler=a;this.delay=b}b.prototype.call=function(a,b){return(new Ge(b,this.delay,this.scheduler)).subscribe(a)};return b}();g.prototype.subscribeOn=function(b,a){void 0===a&&(a=0);return this.lift(new He(b,a))};var Rb=function(){function b(){}b.prototype.call=function(a,b){return b.subscribe(new Ie(a))};return b}(),Ie=function(b){function a(a){b.call(this,a);this.active=0;this.hasCompleted=!1}k(a,b);a.prototype._next=
function(a){this.unsubscribeInner();this.active++;this.add(this.innerSubscription=p(this,a))};a.prototype._complete=function(){this.hasCompleted=!0;0===this.active&&this.destination.complete()};a.prototype.unsubscribeInner=function(){this.active=0<this.active?this.active-1:0;var a=this.innerSubscription;a&&(a.unsubscribe(),this.remove(a))};a.prototype.notifyNext=function(a,b,d,f,h){this.destination.next(b)};a.prototype.notifyError=function(a){this.destination.error(a)};a.prototype.notifyComplete=
function(){this.unsubscribeInner();this.hasCompleted&&0===this.active&&this.destination.complete()};return a}(q);g.prototype.switch=Ja;g.prototype._switch=Ja;var Ke=function(){function b(a,b){this.project=a;this.resultSelector=b}b.prototype.call=function(a,b){return b.subscribe(new Je(a,this.project,this.resultSelector))};return b}(),Je=function(b){function a(a,e,d){b.call(this,a);this.project=e;this.resultSelector=d;this.index=0}k(a,b);a.prototype._next=function(a){var b,c=this.index++;try{b=this.project(a,
...
a.prototype.notifyNext=function(a,b,d,f,h){this.resultSelector?this._tryNotifyNext(a,b,d,f):this.destination.next(b)};a.prototype._tryNotifyNext=function(a,b,d,f){var c;try{c=this.resultSelector(a,b,d,f)}catch(y){this.destination.error(y);return}this.destination.next(c)};return a}(q);g.prototype.switchMap=function(b,a){return this.lift(new Ke(b,a))};var Me=function(){function b(a,b){this.observable=a;this.resultSelector=b}b.prototype.call=function(a,b){return b.subscribe(new Le(a,this.observable,
this.resultSelector))};return b}(),Le=function(b){function a(a,e,d){b.call(this,a);this.inner=e;this.resultSelector=d;this.index=0}k(a,b);a.prototype._next=function(a){var b=this.innerSubscription;b&&b.unsubscribe();this.add(this.innerSubscription=p(this,this.inner,a,this.index++))};a.prototype._complete=function(){var a=this.innerSubscription;a&&!a.closed||b.prototype._complete.call(this)};a.prototype._unsubscribe=function(){this.innerSubscription=null};a.prototype.notifyComplete=function(a){this.remove(a);
this.innerSubscription=null;this.isStopped&&b.prototype._complete.call(this)};a.prototype.notifyNext=function(a,b,d,f,h){h=this.destination;this.resultSelector?this.tryResultSelector(a,b,d,f):h.next(b)};a.prototype.tryResultSelector=function(a,b,d,f){var c=this.resultSelector,e=this.destination,g;try{g=c(a,b,d,f)}catch(B){e.error(B);return}e.next(g)};return a}(q);g.prototype.switchMapTo=function(b,a){return this.lift(new Me(b,a))};var Oe=function(){function b(a){this.total=a;if(0>this.total)throw new T;
}b.prototype.call=function(a,b){return b.subscribe(new Ne(a,this.total))};return b}(),Ne=function(b){function a(a,e){b.call(this,a);this.total=e;this.count=0}k(a,b);a.prototype._next=function(a){var b=this.total,c=++this.count;c<=b&&(this.destination.next(a),c===b&&(this.destination.complete(),this.unsubscribe()))};return a}(l);g.prototype.take=function(b){return 0===b?new F:this.lift(new Oe(b))};var Qe=function(){function b(a){this.total=a;if(0>this.total)throw new T;}b.prototype.call=function(a,
b){return b.subscribe(new Pe(a,this.total))};return b}(),Pe=function(b){function a(a,e){b.call(this,a);this.total=e;this.ring=[];this.count=0}k(a,b);a.prototype._next=function(a){var b=this.ring,c=this.total,f=this.count++;b.length<c?b.push(a):b[f%c]=a};a.prototype._complete=function(){var a=this.destination,b=this.count;if(0<b)for(var d=this.count>=this.total?this.total:this.count,f=this.ring,h=0;h<d;h++){var g=b++%d;a.next(f[g])}a.complete()};return a}(l);g.prototype.takeLast=function(b){return 0===
b?new F:this.lift(new Qe(b))};var Se=function(){function b(a){this.notifier=a}b.prototype.call=function(a,b){return b.subscribe(new Re(a,this.notifier))};return b}(),Re=function(b){function a(a,e){b.call(this,a);this.notifier=e;this.add(p(this,e))}k(a,b);a.prototype.notifyNext=function(a,b,d,f,h){this.complete()};a.prototype.notifyComplete=function(){};return a}(q);g.prototype.takeUntil=function(b){return this.lift(new Se(b))};var Ue=function(){function b(a){this.predicate=a}b.prototype.call=function(a,
b){return b.subscribe(new Te(a,this.predicate))};return b}(),Te=function(b){function a(a,e){b.call(this,a);this.predicate=e;this.index=0}k(a,b);a.prototype._next=function(a){var b=this.destination,c;try{c=this.predicate(a,this.index++)}catch(f){b.error(f);return}this.nextOrComplete(a,c)};a.prototype.nextOrComplete=function(a,b){var c=this.destination;b?c.next(a):c.complete()};return a}(l);g.prototype.takeWhile=function(b){return this.lift(new Ue(b))};var We=function(){function b(a){this.durationSelector=
a}b.prototype.call=function(a,b){return b.subscribe(new Ve(a,this.durationSelector))};return b}(),Ve=function(b){function a(a,e){b.call(this,a);this.destination=a;this.durationSelector=e}k(a,b);a.prototype._next=function(a){this.throttled||this.tryDurationSelector(a)};a.prototype.tryDurationSelector=function(a){var b=null;try{b=this.durationSelector(a)}catch(d){this.destination.error(d);return}this.emitAndThrottle(a,b)};a.prototype.emitAndThrottle=function(a,b){this.add(this.throttled=p(this,b));
this.destination.next(a)};a.prototype._unsubscribe=function(){var a=this.throttled;a&&(this.remove(a),this.throttled=null,a.unsubscribe())};a.prototype.notifyNext=function(a,b,d,f,h){this._unsubscribe()};a.prototype.notifyComplete=function(){this._unsubscribe()};return a}(q);g.prototype.throttle=function(b){return this.lift(new We(b))};var Ye=function(){function b(a,b){this.duration=a;this.scheduler=b}b.prototype.call=function(a,b){return b.subscribe(new Xe(a,this.duration,this.scheduler))};return b}(),
Xe=function(b){function a(a,e,d){b.call(this,a);this.duration=e;this.scheduler=d}k(a,b);a.prototype._next=function(a){this.throttled||(this.add(this.throttled=this.scheduler.schedule(Sb,this.duration,{subscriber:this})),this.destination.next(a))};a.prototype.clearThrottle=function(){var a=this.throttled;a&&(a.unsubscribe(),this.remove(a),this.throttled=null)};return a}(l);g.prototype.throttleTime=function(b,a){void 0===a&&(a=x);return this.lift(new Ye(b,a))};var eb=function(){return function(b,a){this.value=
b;this.interval=a}}(),$e=function(){function b(a){this.scheduler=a}b.prototype.call=function(a,b){return b.subscribe(new Ze(a,this.scheduler))};return b}(),Ze=function(b){function a(a,e){b.call(this,a);this.scheduler=e;this.lastTime=0;this.lastTime=e.now()}k(a,b);a.prototype._next=function(a){var b=this.scheduler.now(),c=b-this.lastTime;this.lastTime=b;this.destination.next(new eb(a,c))};return a}(l);g.prototype.timeInterval=function(b){void 0===b&&(b=x);return this.lift(new $e(b))};var fb=function(b){function a(){var a=
b.call(this,"Timeout has occurred");this.name=a.name="TimeoutError";this.stack=a.stack;this.message=a.message}k(a,b);return a}(Error),bf=function(){function b(a,b,e,d){this.waitFor=a;this.absoluteTimeout=b;this.scheduler=e;this.errorInstance=d}b.prototype.call=function(a,b){return b.subscribe(new af(a,this.absoluteTimeout,this.waitFor,this.scheduler,this.errorInstance))};return b}(),af=function(b){function a(a,e,d,f,h){b.call(this,a);this.absoluteTimeout=e;this.waitFor=d;this.scheduler=f;this.errorInstance=
h;this.action=null;this.scheduleTimeout()}k(a,b);a.dispatchTimeout=function(a){a.error(a.errorInstance)};a.prototype.scheduleTimeout=function(){var b=this.action;b?this.action=b.schedule(this,this.waitFor):this.add(this.action=this.scheduler.schedule(a.dispatchTimeout,this.waitFor,this))};a.prototype._next=function(a){this.absoluteTimeout||this.scheduleTimeout();b.prototype._next.call(this,a)};a.prototype._unsubscribe=function(){this.errorInstance=this.scheduler=this.action=null};return a}(l);g.prototype.timeout=
function(b,a){void 0===a&&(a=x);var c=X(b);b=c?+b-a.now():Math.abs(b);return this.lift(new bf(b,c,a,new fb))};var df=function(){function b(a,b,e,d){this.waitFor=a;this.absoluteTimeout=b;this.withObservable=e;this.scheduler=d}b.prototype.call=function(a,b){return b.subscribe(new cf(a,this.absoluteTimeout,this.waitFor,this.withObservable,this.scheduler))};return b}(),cf=function(b){function a(a,e,d,f,h){b.call(this,a);this.absoluteTimeout=e;this.waitFor=d;this.withObservable=f;this.scheduler=h;this.action=
null;this.scheduleTimeout()}k(a,b);a.dispatchTimeout=function(a){var b=a.withObservable;a._unsubscribeAndRecycle();a.add(p(a,b))};a.prototype.scheduleTimeout=function(){var b=this.action;b?this.action=b.schedule(this,this.waitFor):this.add(this.action=this.scheduler.schedule(a.dispatchTimeout,this.waitFor,this))};a.prototype._next=function(a){this.absoluteTimeout||this.scheduleTimeout();b.prototype._next.call(this,a)};a.prototype._unsubscribe=function(){this.withObservable=this.scheduler=this.action=
null};return a}(q);g.prototype.timeoutWith=function(b,a,c){void 0===c&&(c=x);var e=X(b);b=e?+b-c.now():Math.abs(b);return this.lift(new df(b,e,a,c))};var gb=function(){return function(b,a){this.value=b;this.timestamp=a}}(),ff=function(){function b(a){this.scheduler=a}b.prototype.call=function(a,b){return b.subscribe(new ef(a,this.scheduler))};return b}(),ef=function(b){function a(a,e){b.call(this,a);this.scheduler=e}k(a,b);a.prototype._next=function(a){var b=this.scheduler.now();this.destination.next(new gb(a,
b))};return a}(l);g.prototype.timestamp=function(b){void 0===b&&(b=x);return this.lift(new ff(b))};var hf=function(){function b(){}b.prototype.call=function(a,b){return b.subscribe(new gf(a))};return b}(),gf=function(b){function a(a){b.call(this,a);this.array=[]}k(a,b);a.prototype._next=function(a){this.array.push(a)};a.prototype._complete=function(){this.destination.next(this.array);this.destination.complete()};return a}(l);g.prototype.toArray=function(){return this.lift(new hf)};g.prototype.toPromise=
function(b){var a=this;b||(n.Rx&&n.Rx.config&&n.Rx.config.Promise?b=n.Rx.config.Promise:n.Promise&&(b=n.Promise));if(!b)throw Error("no Promise impl found");return new b(function(b,e){var c;a.subscribe(function(a){return c=a},function(a){return e(a)},function(){return b(c)})})};var kf=function(){function b(a){this.windowBoundaries=a}b.prototype.call=function(a,b){a=new jf(a);b=b.subscribe(a);b.closed||a.add(p(a,this.windowBoundaries));return b};return b}(),jf=function(b){function a(a){b.call(this,
a);this.window=new v;a.next(this.window)}k(a,b);a.prototype.notifyNext=function(a,b,d,f,h){this.openWindow()};a.prototype.notifyError=function(a,b){this._error(a)};a.prototype.notifyComplete=function(a){this._complete()};a.prototype._next=function(a){this.window.next(a)};a.prototype._error=function(a){this.window.error(a);this.destination.error(a)};a.prototype._complete=function(){this.window.complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.window=null};a.prototype.openWindow=
function(){var a=this.window;a&&a.complete();var a=this.destination,b=this.window=new v;a.next(b)};return a}(q);g.prototype.window=function(b){return this.lift(new kf(b))};var mf=function(){function b(a,b){this.windowSize=a;this.startWindowEvery=b}b.prototype.call=function(a,b){return b.subscribe(new lf(a,this.windowSize,this.startWindowEvery))};return b}(),lf=function(b){function a(a,e,d){b.call(this,a);this.destination=a;this.windowSize=e;this.startWindowEvery=d;this.windows=[new v];this.count=
0;a.next(this.windows[0])}k(a,b);a.prototype._next=function(a){for(var b=0<this.startWindowEvery?this.startWindowEvery:this.windowSize,c=this.destination,f=this.windowSize,h=this.windows,g=h.length,k=0;k<g&&!this.closed;k++)h[k].next(a);a=this.count-f+1;0<=a&&0===a%b&&!this.closed&&h.shift().complete();0!==++this.count%b||this.closed||(b=new v,h.push(b),c.next(b))};a.prototype._error=function(a){var b=this.windows;if(b)for(;0<b.length&&!this.closed;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=
function(){var a=this.windows;if(a)for(;0<a.length&&!this.closed;)a.shift().complete();this.destination.complete()};a.prototype._unsubscribe=function(){this.count=0;this.windows=null};return a}(l);g.prototype.windowCount=function(b,a){void 0===a&&(a=0);return this.lift(new mf(b,a))};var of=function(){function b(a,b,e,d){this.windowTimeSpan=a;this.windowCreationInterval=b;this.maxWindowSize=e;this.scheduler=d}b.prototype.call=function(a,b){return b.subscribe(new nf(a,this.windowTimeSpan,this.windowCreationInterval,
this.maxWindowSize,this.scheduler))};return b}(),pf=function(b){function a(){b.apply(this,arguments);this._numberOfNextedValues=0}k(a,b);a.prototype.next=function(a){this._numberOfNextedValues++;b.prototype.next.call(this,a)};Object.defineProperty(a.prototype,"numberOfNextedValues",{get:function(){return this._numberOfNextedValues},enumerable:!0,configurable:!0});return a}(v),nf=function(b){function a(a,e,d,f,h){b.call(this,a);this.destination=a;this.windowTimeSpan=e;this.windowCreationInterval=d;
this.maxWindowSize=f;this.scheduler=h;this.windows=[];a=this.openWindow();null!==d&&0<=d?(f={windowTimeSpan:e,windowCreationInterval:d,subscriber:this,scheduler:h},this.add(h.schedule(Ka,e,{subscriber:this,window:a,context:null})),this.add(h.schedule(Ub,d,f))):this.add(h.schedule(Tb,e,{subscriber:this,window:a,windowTimeSpan:e}))}k(a,b);a.prototype._next=function(a){for(var b=this.windows,c=b.length,f=0;f<c;f++){var h=b[f];h.closed||(h.next(a),h.numberOfNextedValues>=this.maxWindowSize&&this.closeWindow(h))}};
a.prototype._error=function(a){for(var b=this.windows;0<b.length;)b.shift().error(a);this.destination.error(a)};a.prototype._complete=function(){for(var a=this.windows;0<a.length;){var b=a.shift();b.closed||b.complete()}this.destination.complete()};a.prototype.openWindow=function(){var a=new pf;this.windows.push(a);this.destination.next(a);return a};a.prototype.closeWindow=function(a){a.complete();var b=this.windows;b.splice(b.indexOf(a),1)};return a}(l);g.prototype.windowTime=function(b,a,c,e){var d=
x,f=null,h=Number.POSITIVE_INFINITY;z(e)&&(d=e);z(c)?d=c:P(c)&&(h=c);z(a)?d=a:P(a)&&(f=a);return this.lift(new of(b,f,h,d))};var rf=function(){function b(a,b){this.openings=a;this.closingSelector=b}b.prototype.call=function(a,b){return b.subscribe(new qf(a,this.openings,this.closingSelector))};return b}(),qf=function(b){function a(a,e,d){b.call(this,a);this.openings=e;this.closingSelector=d;this.contexts=[];this.add(this.openSubscription=p(this,e,e))}k(a,b);a.prototype._next=function(a){var b=this.contexts;
...
a.prototype.notifyComplete=function(a){a!==this.openSubscription&&this.closeWindow(this.contexts.indexOf(a.context))};a.prototype.closeWindow=function(a){if(-1!==a){var b=this.contexts,c=b[a],f=c.window,c=c.subscription;b.splice(a,1);f.complete();c.unsubscribe()}};return a}(q);g.prototype.windowToggle=function(b,a){return this.lift(new rf(b,a))};var tf=function(){function b(a){this.closingSelector=a}b.prototype.call=function(a,b){return b.subscribe(new sf(a,this.closingSelector))};return b}(),sf=
...
g.prototype.windowWhen=function(b){return this.lift(new tf(b))};var vf=function(){function b(a,b){this.observables=a;this.project=b}b.prototype.call=function(a,b){return b.subscribe(new uf(a,this.observables,this.project))};return b}(),uf=function(b){function a(a,e,d){b.call(this,a);this.observables=e;this.project=d;this.toRespond=[];a=e.length;this.values=Array(a);for(d=0;d<a;d++)this.toRespond.push(d);for(d=0;d<a;d++){var c=e[d];this.add(p(this,c,c,d))}}k(a,b);a.prototype.notifyNext=function(a,
b,d,f,h){this.values[d]=b;a=this.toRespond;0<a.length&&(d=a.indexOf(d),-1!==d&&a.splice(d,1))};a.prototype.notifyComplete=function(){};a.prototype._next=function(a){0===this.toRespond.length&&(a=[a].concat(this.values),this.project?this._tryProject(a):this.destination.next(a))};a.prototype._tryProject=function(a){var b;try{b=this.project.apply(this,a)}catch(d){this.destination.error(d);return}this.destination.next(b)};return a}(q);g.prototype.withLatestFrom=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-
0]=arguments[a];var c;"function"===typeof b[b.length-1]&&(c=b.pop());return this.lift(new vf(b,c))};g.prototype.zip=function(){for(var b=[],a=0;a<arguments.length;a++)b[a-0]=arguments[a];return this.lift.call(ua.apply(void 0,[this].concat(b)))};g.prototype.zipAll=function(b){return this.lift(new va(b))};var V=function(){return function(b,a){void 0===a&&(a=Number.POSITIVE_INFINITY);this.subscribedFrame=b;this.unsubscribedFrame=a}}(),hb=function(){function b(){this.subscriptions=[]}b.prototype.logSubscribedFrame=
function(){this.subscriptions.push(new V(this.scheduler.now()));return this.subscriptions.length-1};b.prototype.logUnsubscribedFrame=function(a){var b=this.subscriptions;b[a]=new V(b[a].subscribedFrame,this.scheduler.now())};return b}(),ka=function(b){function a(a,e){b.call(this,function(a){var b=this,c=b.logSubscribedFrame();a.add(new u(function(){b.logUnsubscribedFrame(c)}));b.scheduleMessages(a);return a});this.messages=a;this.subscriptions=[];this.scheduler=e}k(a,b);a.prototype.scheduleMessages=
function(a){for(var b=this.messages.length,c=0;c<b;c++){var f=this.messages[c];a.add(this.scheduler.schedule(function(a){a.message.notification.observe(a.subscriber)},f.frame,{message:f,subscriber:a}))}};return a}(g);La(ka,[hb]);var ib=function(b){function a(a,e){b.call(this);this.messages=a;this.subscriptions=[];this.scheduler=e}k(a,b);a.prototype._subscribe=function(a){var c=this,d=c.logSubscribedFrame();a.add(new u(function(){c.logUnsubscribedFrame(d)}));return b.prototype._subscribe.call(this,
...
f.delay)<=b&&!(d=f.execute(f.state,f.delay)););if(d){for(;f=a.shift();)f.unsubscribe();throw d;}};a.frameTimeFactor=10;return a}(S),jb=function(b){function a(a,e,d){void 0===d&&(d=a.index+=1);b.call(this,a,e);this.scheduler=a;this.work=e;this.index=d;this.active=!0;this.index=a.index=d}k(a,b);a.prototype.schedule=function(c,e){void 0===e&&(e=0);if(!this.id)return b.prototype.schedule.call(this,c,e);this.active=!1;var d=new a(this.scheduler,this.work);this.add(d);return d.schedule(c,e)};a.prototype.requestAsyncId=
function(b,e,d){void 0===d&&(d=0);this.delay=b.frame+d;b=b.actions;b.push(this);b.sort(a.sortActions);return!0};a.prototype.recycleAsyncId=function(a,b,d){};a.prototype._execute=function(a,e){if(!0===this.active)return b.prototype._execute.call(this,a,e)};a.sortActions=function(a,b){return a.delay===b.delay?a.index===b.index?0:a.index>b.index?1:-1:a.delay>b.delay?1:-1};return a}(R),wf=function(b){function a(a){b.call(this,jb,750);this.assertDeepEqual=a;this.hotObservables=[];this.coldObservables=
[];this.flushTests=[]}k(a,b);a.prototype.createTime=function(b){b=b.indexOf("|");if(-1===b)throw Error('marble diagram for time should have a completion marker "|"');return b*a.frameTimeFactor};a.prototype.createColdObservable=function(b,e,d){if(-1!==b.indexOf("^"))throw Error('cold observable cannot have subscription offset "^"');if(-1!==b.indexOf("!"))throw Error('cold observable cannot have unsubscription marker "!"');b=a.parseMarbles(b,e,d);b=new ka(b,this);this.coldObservables.push(b);return b};
a.prototype.createHotObservable=function(b,e,d){if(-1!==b.indexOf("!"))throw Error('hot observable cannot have unsubscription marker "!"');b=a.parseMarbles(b,e,d);b=new ib(b,this);this.hotObservables.push(b);return b};a.prototype.materializeInnerObservable=function(a,b){var c=this,e=[];a.subscribe(function(a){e.push({frame:c.frame-b,notification:w.createNext(a)})},function(a){e.push({frame:c.frame-b,notification:w.createError(a)})},function(){e.push({frame:c.frame-b,notification:w.createComplete()})});
return e};a.prototype.expectObservable=function(b,e){var c=this;void 0===e&&(e=null);var f=[],h={actual:f,ready:!1};e=a.parseMarblesAsSubscriptions(e).unsubscribedFrame;var k;this.schedule(function(){k=b.subscribe(function(a){var b=a;a instanceof g&&(b=c.materializeInnerObservable(b,c.frame));f.push({frame:c.frame,notification:w.createNext(b)})},function(a){f.push({frame:c.frame,notification:w.createError(a)})},function(){f.push({frame:c.frame,notification:w.createComplete()})})},0);e!==Number.POSITIVE_INFINITY&&
this.schedule(function(){return k.unsubscribe()},e);this.flushTests.push(h);return{toBe:function(b,c,d){h.ready=!0;h.expected=a.parseMarbles(b,c,d,!0)}}};a.prototype.expectSubscriptions=function(b){var c={actual:b,ready:!1};this.flushTests.push(c);return{toBe:function(b){b="string"===typeof b?[b]:b;c.ready=!0;c.expected=b.map(function(b){return a.parseMarblesAsSubscriptions(b)})}}};a.prototype.flush=function(){for(var a=this.hotObservables;0<a.length;)a.shift().setup();b.prototype.flush.call(this);
for(a=this.flushTests.filter(function(a){return a.ready});0<a.length;){var e=a.shift();this.assertDeepEqual(e.actual,e.expected)}};a.parseMarblesAsSubscriptions=function(a){if("string"!==typeof a)return new V(Number.POSITIVE_INFINITY);for(var b=a.length,c=-1,f=Number.POSITIVE_INFINITY,g=Number.POSITIVE_INFINITY,k=0;k<b;k++){var l=k*this.frameTimeFactor,m=a[k];switch(m){case "-":case " ":break;case "(":c=l;break;case ")":c=-1;break;case "^":if(f!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");
f=-1<c?c:l;break;case "!":if(g!==Number.POSITIVE_INFINITY)throw Error("found a second subscription point '^' in a subscription marble diagram. There can only be one.");g=-1<c?c:l;break;default:throw Error("there can only be '^' and '!' markers in a subscription marble diagram. Found instead '"+m+"'.");}}return 0>g?new V(f):new V(f,g)};a.parseMarbles=function(a,b,d,f){void 0===f&&(f=!1);if(-1!==a.indexOf("!"))throw Error('conventional marble diagrams cannot have the unsubscription marker "!"');for(var c=
a.length,e=[],g=a.indexOf("^"),g=-1===g?0:g*-this.frameTimeFactor,k="object"!==typeof b?function(a){return a}:function(a){return f&&b[a]instanceof ka?b[a].messages:b[a]},l=-1,m=0;m<c;m++){var n=m*this.frameTimeFactor+g,p=void 0,q=a[m];switch(q){case "-":case " ":break;case "(":l=n;break;case ")":l=-1;break;case "|":p=w.createComplete();break;case "^":break;case "#":p=w.createError(d||"error");break;default:p=w.createNext(k(q))}p&&e.push({frame:-1<l?l:n,notification:p})}return e};return a}(kb),lb=
...
(this.cancelAnimationFrame=b.msCancelAnimationFrame.bind(b),this.requestAnimationFrame=b.msRequestAnimationFrame.bind(b)):b.oRequestAnimationFrame?(this.cancelAnimationFrame=b.oCancelAnimationFrame.bind(b),this.requestAnimationFrame=b.oRequestAnimationFrame.bind(b)):(this.cancelAnimationFrame=b.clearTimeout.bind(b),this.requestAnimationFrame=function(a){return b.setTimeout(a,1E3/60)})}}())(n),xf=function(b){function a(a,e){b.call(this,a,e);this.scheduler=a;this.work=e}k(a,b);a.prototype.requestAsyncId=
function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d)return b.prototype.requestAsyncId.call(this,a,e,d);a.actions.push(this);return a.scheduled||(a.scheduled=lb.requestAnimationFrame(a.flush.bind(a,null)))};a.prototype.recycleAsyncId=function(a,e,d){void 0===d&&(d=0);if(null!==d&&0<d||null===d&&0<this.delay)return b.prototype.recycleAsyncId.call(this,a,e,d);0===a.actions.length&&(lb.cancelAnimationFrame(e),a.scheduled=void 0)};return a}(R),yf=new (function(b){function a(){b.apply(this,arguments)}k(a,
b);a.prototype.flush=function(a){this.active=!0;this.scheduled=void 0;var b=this.actions,c,f=-1,g=b.length;a=a||b.shift();do if(c=a.execute(a.state,a.delay))break;while(++f<g&&(a=b.shift()));this.active=!1;if(c){for(;++f<g&&(a=b.shift());)a.unsubscribe();throw c;}};return a}(S))(xf),zf={rxSubscriber:Q,observable:H,iterator:A};t.Scheduler={asap:ca,queue:Ya,animationFrame:yf,async:x};t.Symbol=zf;t.Subject=v;t.AnonymousSubject=Z;t.Observable=g;t.Subscription=u;t.Subscriber=l;t.AsyncSubject=K;t.ReplaySubject=
L;t.BehaviorSubject=bb;t.ConnectableObservable=U;t.Notification=w;t.EmptyError=ba;t.ArgumentOutOfRangeError=T;t.ObjectUnsubscribedError=G;t.TimeoutError=fb;t.UnsubscriptionError=N;t.TimeInterval=eb;t.Timestamp=gb;t.TestScheduler=wf;t.VirtualTimeScheduler=kb;t.AjaxResponse=Wa;t.AjaxError=aa;t.AjaxTimeoutError=Xa;Object.defineProperty(t,"__esModule",{value:!0})});
