...
var legend$1 = {
    ...
    toggleFocusLegend: function (targetIds, focus) {
        ...
        legend && legend.selectAll(".".concat(CLASS.legendItem))
...
var text = {
    ...
    updateText: function (durationForExit) {
        ...
        $el.text = $el.main.selectAll(".".concat(CLASS.texts)).selectAll(".".concat(CLASS.text))
            ...
            (withTransition && text.attr("x") ? text.transition(t) : text)
                ...
                selection.each(function (d) {
                    ...
                    if (this.childElementCount) {
                        this.setAttribute("transform", "translate(".concat(posX, " ").concat(posY, ")"));
                    }
                    else {
    ...
    getTooltipContent: function (d, defaultTitleFormat, defaultValueFormat, color) {
        ...
        var _loop_1 = function () {
            ...
            if ($$.isAreaRangeType(row)) {
                var _b = ["high", "low"].map(function (v) { return sanitise(valueFormat.apply(void 0, __spreadArray([$$.getAreaRangeData(row, v)], param, false))); }), high = _b[0], low = _b[1];
...
var transform = {
    ...
    transformMain: function (withTransition, transitions) {
        ...
        if (transitions && transitions.axisX) {
            ...
            xAxis = main.select(".".concat(CLASS.axisX));
            if (withTransition) {
        ...
        if (transitions && transitions.axisY) {
            ...
            yAxis = main.select(".".concat(CLASS.axisY));
            if (withTransition) {
        ...
        if (transitions && transitions.axisY2) {
            ...
            y2Axis = main.select(".".concat(CLASS.axisY2));
            if (withTransition) {
...
var ChartInternal = /** @class */ (function () {
    ...
    ChartInternal.prototype.showTargets = function () {
        ...
        svg.selectAll(".".concat(CLASS.target))
...
function nodeToSvgDataUrl(node, size) {
    ...
    var dataStr = "<svg xmlns=\"".concat(namespaces.svg, "\" width=\"").concat(size.width, "\" height=\"").concat(size.height, "\">\n\t\t\t<foreignObject width=\"100%\" height=\"100%\">\n\t\t\t\t").concat(styleXml, "\n\t\t\t\t").concat(nodeXml.replace(/(url\()[^#]+/g, "$1"), "\n\t\t\t</foreignObject></svg>")
        .replace("/\n/g", "%0A");
    ...
    Axis.prototype.init = function () {
        ...
        target.forEach(function (v) {
            ...
            axis[v] = main.append("g")
                ...
                .style("visibility", config["axis_".concat(v, "_show")] ? "visible" : "hidden");
            axis[v].append("text")
            ...
            _this.axesList[id].forEach(function (v, i) {
                ...
                if (g.empty()) {
                    g = main.append("g")
                        ...
                        .style("visibility", config["axis_".concat(id, "_show")] ? "visible" : "hidden")
                        .call(v);
                }
                else {
...
var grid = {
    ...
    removeGridLines: function (params, forX) {
        ...
        $$.$el.main.select(".".concat(classLines))
...
var region = {
    ...
    updateRegion: function (duration) {
        ...
        // select <g> element
        var list = $el.main.select(".".concat(CLASS.regions))
...
var shapeArc = {
    ...
    redrawArcText: function (duration) {
        ...
        if (hasGauge) {
            var isFullCircle = config.gauge_fullCircle;
            isFullCircle && text && text.attr("dy", "".concat(hasMultiArcGauge ? 0 : Math.round(state.radius / 14)));
...
var shapeArea = {
    ...
    updateArea: function (durationForExit) {
        ...
        $el.area = $el.main.selectAll(".".concat(CLASS.areas))
...
var shapeBar = {
    ...
    updateBar: function (durationForExit) {
        ...
        $el.bar = $el.main.selectAll(".".concat(CLASS.bars)).selectAll(".".concat(CLASS.bar))
            .data(barData);
    ...
    getBars: function (i, id) {
        ...
        return (id ? main
            .selectAll(".".concat(CLASS.bars).concat($$.getTargetSelectorSuffix(id))) : main)
            .selectAll(".".concat(CLASS.bar).concat(suffix));
    },
...
var shapePoint = {
    ...
    updateCircle: function () {
        ...
        if (config.point_show && !state.toggling) {
            var circles = $el.main.selectAll(".".concat(CLASS.circles))
            ...
            $el.circle = $el.main.selectAll(".".concat(CLASS.circles, " .").concat(CLASS.circle))
                .style("stroke", $$.color)
    ...
    redrawCircle: function (cx, cy, withTransition, flow) {
        ...
        var selectedCircles = main.selectAll(".".concat(CLASS.selectedCircle));
        if (!$$.config.point_show) {
            return [];
        }
    ...
    getCircles: function (i, id) {
        var $$ = this;
        var suffix = (isValue(i) ? "-".concat(i) : "");
        return (id ? $$.$el.main.selectAll(".".concat(CLASS.circles).concat($$.getTargetSelectorSuffix(id))) : $$.$el.main)
            .selectAll(".".concat(CLASS.circle).concat(suffix));
    },
...
var selection = _assign(_assign({}, drag), { 
    ...
    selectPoint: function (target, d, i) {
        ...
        main.select(".".concat(CLASS.selectedCircles).concat($$.getTargetSelectorSuffix(d.id)))
    ...
    unselectPoint: function (target, d, i) {
        ...
        $el.main.select(".".concat(CLASS.selectedCircles).concat($$.getTargetSelectorSuffix(d.id)))
            .selectAll(".".concat(CLASS.selectedCircle, "-").concat(i))
            .transition()
            .duration(100)
            .attr("r", 0)
...
var subchart = {
    ...
    initBrush: function () {
        ...
        $$.brush.update = function () {
            ...
            if (extent[1].filter(function (v) { return isNaN(v); }).length === 0) {
                subchart.main && subchart.main.select(".".concat(CLASS.brush)).call(this);
            }
            return this;
        };
    ...
    initSubchart: function () {
        ...
        $$.hasType("bar") && main.select(".".concat(CLASS.chart))
            .append("g")
            .attr("class", CLASS.chartBars);
    ...
    updateTargetsForSubchart: function (targets) {
        ...
        if (config.subchart_show) {
            // -- Bar --//
            var barUpdate = main.select(".".concat(CLASS.chartBars))
                .selectAll(".".concat(CLASS.chartBar))
                .data(targets)
                .attr("class", classChartBar);
            ...
            barEnter.append("g")
                .attr("class", classBars);
            // -- Line --//
            var lineUpdate = main.select(".".concat(CLASS.chartLines))
                .selectAll(".".concat(CLASS.chartLine))
                .data(targets)
                .attr("class", classChartLine);
    ...
    updateBarForSubchart: function (durationForExit) {
        ...
        subchart.bar = subchart.main.selectAll(".".concat(CLASS.bars)).selectAll(".".concat(CLASS.bar))
            .data($$.barData.bind($$));
        subchart.bar
            .exit()
            .transition()
    ...
    updateLineForSubchart: function (durationForExit) {
        var $$ = this;
        var subchart = $$.$el.subchart;
        subchart.line = subchart.main.selectAll(".".concat(CLASS.lines))
            .selectAll(".".concat(CLASS.line))
            .data($$.lineData.bind($$));
        subchart.line
            .exit()
    ...
    updateAreaForSubchart: function (durationForExit) {
        var $$ = this;
        var subchart = $$.$el.subchart;
        subchart.area = subchart.main.selectAll(".".concat(CLASS.areas))
            .selectAll(".".concat(CLASS.area))
            .data($$.lineData.bind($$));
        subchart.area
            .exit()
        ...
        if (config.subchart_show) {
            ...
            if (withSubchart) {
                ...
                Object.keys(shape.type).forEach(function (v) {
                    ...
                    var draw = $$["generateDraw".concat(name)](shape.indices[v], true);
                    $$["update".concat(name, "ForSubchart")](duration);
                    $$["redraw".concat(name, "ForSubchart")](draw, duration, duration);
                });
            }
        }
    },
    ...
    transformContext: function (withTransition, transitions) {
        ...
        if (transitions && transitions.axisSubX) {
            ...
            subXAxis = main.select(".".concat(CLASS.axisX));
            if (withTransition) {
...
var zoom = {
    ...
    bindZoomEvent: function (bind) {
        ...
        var config = $$.config, main = $$.$el.main;
        var zoomEnabled = config.zoom_enabled;
        var eventRects = main.select(".".concat(CLASS.eventRects));
        if (zoomEnabled && bind) {
...
export { area, areaLineRange, areaSpline, areaSplineRange, areaStep, bar, bb, bubble, bb as default, donut, gauge, line, pie, radar, scatter, selectionModule as selection, spline, step, subchartModule as subchart, zoomModule as zoom };
