...
function deepClone() {
  ...
  for (var _len3 = arguments.length, objectN = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) objectN[_key3] = arguments[_key3];
   ...
   */, _proto.preventLabelOverlap = function preventLabelOverlap(text) {
    ...
    text.each(function () {
      ...
      if (cell && this) {
        ...
        (0,external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_.select)(this)
        // @ts-ignore
