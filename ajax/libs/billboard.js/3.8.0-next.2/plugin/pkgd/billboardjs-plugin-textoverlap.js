...
var Voronoi = /*#__PURE__*/function () {
  ...
  _proto._init = function _init() {
    ...
    for (var _i2 = 0; _i2 < hull.length; ++_i2) {
      ...
      vectors[p0 + 3] = vectors[p1 + 1] = _x - x0;
    }
  };
  ...
  _proto._clipInfinite = function _clipInfinite(i, points, vx0, vy0, vxn, vyn) {
    ...
    if (P = this._clipFinite(i, P)) {
      for (var j = 0, n = P.length, _c, _c2 = this._edgecode(P[n - 2], P[n - 1]); j < n; j += 2) {
        _c = _c2, _c2 = this._edgecode(P[j], P[j + 1]);
        if (_c && _c2) j = this._edge(i, _c, _c2, P, j), n = P.length;
      }
    } else if (this.contains(i, (this.xmin + this.xmax) / 2, (this.ymin + this.ymax) / 2)) {
