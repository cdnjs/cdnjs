...
;// CONCATENATED MODULE: external {"commonjs":"d3-voronoi","commonjs2":"d3-voronoi","amd":"d3-voronoi","root":"d3"}
var external_commonjs_d3_voronoi_commonjs2_d3_voronoi_amd_d3_voronoi_root_d3_namespaceObject = undefined;
;// CONCATENATED MODULE: external {"commonjs":"d3-polygon","commonjs2":"d3-polygon","amd":"d3-polygon","root":"d3"}
var external_commonjs_d3_polygon_commonjs2_d3_polygon_amd_d3_polygon_root_d3_namespaceObject = undefined;
...
var TextOverlap = /*#__PURE__*/function (_Plugin) {
  ...
  return _proto.$init = function $init() {
    ...
    var text = (0,external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_namespaceObject.selectAll)(this.config.selector);
  ...
  , _proto.generateVoronoi = function generateVoronoi(data) {
    ...
    return min[1] = _ref[0], max[0] = _ref[1], (0,external_commonjs_d3_voronoi_commonjs2_d3_voronoi_amd_d3_voronoi_root_d3_namespaceObject.voronoi)().extent([min, max]).polygons(data);
  }
  /**
    ...
    text.each(function () {
      ...
      if (cell && this) {
        var _cell$data = cell.data,
            x = _cell$data[0],
            y = _cell$data[1],
            _d3PolygonCentroid = (0,external_commonjs_d3_polygon_commonjs2_d3_polygon_amd_d3_polygon_root_d3_namespaceObject.polygonCentroid)(cell),
        ...
        (0,external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_namespaceObject.select)(this) // @ts-ignore
        .attr("display", (0,external_commonjs_d3_polygon_commonjs2_d3_polygon_amd_d3_polygon_root_d3_namespaceObject.polygonArea)(cell) < area ? "none" : null).attr("text-anchor", txtAnchor).attr("dy", "0." + (angle === 1 ? 71 : 35) + "em").attr("transform", "translate(" + xTranslate + ", " + yTranslate + ")");
      }
    });
  }, TextOverlap;
}(Plugin);
...
((bb = typeof bb === "undefined" ? {} : bb).plugin = bb.plugin || {}).textoverlap = __webpack_exports__.default;
/******/ })()
;