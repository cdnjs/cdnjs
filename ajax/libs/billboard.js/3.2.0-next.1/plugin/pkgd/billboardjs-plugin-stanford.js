...
var TO_STRING_TAG_SUPPORT = __webpack_require__(93);
...
var $ = __webpack_require__(2);
var copyWithin = __webpack_require__(99);
...
var arrayMethodIsStrict = __webpack_require__(102);
...
var $ = __webpack_require__(2);
var lastIndexOf = __webpack_require__(126);
...
var $ = __webpack_require__(2);
var $reduce = __webpack_require__(130).left;
var arrayMethodIsStrict = __webpack_require__(102);
var CHROME_VERSION = __webpack_require__(20);
var IS_NODE = __webpack_require__(131);
...
var $ = __webpack_require__(2);
var $reduceRight = __webpack_require__(130).right;
var arrayMethodIsStrict = __webpack_require__(102);
var CHROME_VERSION = __webpack_require__(20);
var IS_NODE = __webpack_require__(131);
...
var toString = __webpack_require__(54);
var fails = __webpack_require__(6);
var internalSort = __webpack_require__(137);
var arrayMethodIsStrict = __webpack_require__(102);
var FF = __webpack_require__(138);
var IE_OR_EDGE = __webpack_require__(139);
var V8 = __webpack_require__(20);
var WEBKIT = __webpack_require__(140);
...
var toLength = __webpack_require__(47);
var toString = __webpack_require__(54);
var repeat = __webpack_require__(165);
var requireObjectCoercible = __webpack_require__(12);
...
var collectionStrong = __webpack_require__(183);
...
var uid = __webpack_require__(30);
var FREEZING = __webpack_require__(181);
...
var setSpecies = __webpack_require__(142);
var DESCRIPTORS = __webpack_require__(5);
var fastKey = __webpack_require__(180).fastKey;
var InternalStateModule = __webpack_require__(38);
...
var $ = __webpack_require__(2);
var expm1 = __webpack_require__(192);
...
var requireObjectCoercible = __webpack_require__(12);
var toString = __webpack_require__(54);
var whitespaces = __webpack_require__(208);
...
var $ = __webpack_require__(2);
var numberIsFinite = __webpack_require__(211);
...
var $ = __webpack_require__(2);
var toInteger = __webpack_require__(48);
var thisNumberValue = __webpack_require__(223);
var repeat = __webpack_require__(165);
var fails = __webpack_require__(6);
...
var $ = __webpack_require__(2);
var DESCRIPTORS = __webpack_require__(5);
var FORCED = __webpack_require__(229);
var toObject = __webpack_require__(29);
var aFunction = __webpack_require__(66);
var definePropertyModule = __webpack_require__(34);
...
var fails = __webpack_require__(6);
var isObject = __webpack_require__(15);
var onFreeze = __webpack_require__(180).onFreeze;
...
var $ = __webpack_require__(2);
var is = __webpack_require__(242);
...
var $ = __webpack_require__(2);
var parseFloatImplementation = __webpack_require__(219);
...
var newPromiseCapabilityModule = __webpack_require__(265);
...
var html = __webpack_require__(58);
var createElement = __webpack_require__(32);
var IS_IOS = __webpack_require__(260);
var IS_NODE = __webpack_require__(131);
...
var anObject = __webpack_require__(35);
var isObject = __webpack_require__(15);
var newPromiseCapability = __webpack_require__(265);
...
var WEBKIT_BUG = __webpack_require__(314);
...
var forcedStringHTMLMethod = __webpack_require__(331);
...
var createTypedArrayConstructor = __webpack_require__(345);
...
var fails = __webpack_require__(6);
var checkCorrectnessOfIteration = __webpack_require__(116);
var NATIVE_ARRAY_BUFFER_VIEWS = __webpack_require__(154).NATIVE_ARRAY_BUFFER_VIEWS;
...
var isArrayIteratorMethod = __webpack_require__(89);
var bind = __webpack_require__(65);
var aTypedArrayConstructor = __webpack_require__(154).aTypedArrayConstructor;
...
var exportTypedArrayMethod = __webpack_require__(154).exportTypedArrayMethod;
var fails = __webpack_require__(6);
var global = __webpack_require__(3);
...
var $ = __webpack_require__(2);
var global = __webpack_require__(3);
var task = __webpack_require__(259);
...
function numbers(values, valueof) {
  var _step, value, _iterator, index, _step2, _iterator2, _value;
  ...
  return regenerator.wrap(function (_context) {
    for (;;) switch (_context.prev = _context.next) {
      ...
      case 12:
        index = -1, _iterator2 = _createForOfIteratorHelperLoose(values);
      ...
      case 14:
        ...
        if (_value = _step2.value, _context.t1 = (_value = valueof(_value, ++index, values)) != null && (_value = +_value) >= _value, !_context.t1) {
          _context.next = 20;
          break;
        }

        return _context.next = 20, _value;
...
function transformer() {
  function rescale() {
    ...
    return clamp !== identity && (clamp = clamper(domain[0], domain[n - 1])), piecewise = n > 2 ? polymap : bimap, output = input = null, scale;
  }
...
/* harmony default export */ function ticks(start, stop, count) {
  ...
  if (step > 0) {
    ...
    for (r0 * step < start && ++r0, r1 * step > stop && --r1, ticks = Array(n = r1 - r0 + 1); ++i < n;) ticks[i] = (r0 + i) * step;
  } else {
    step = -step;
    ...
    for (_r / step < start && ++_r, _r2 / step > stop && --_r2, ticks = Array(n = _r2 - _r + 1); ++i < n;) ticks[i] = (_r + i) / step;
  }
...
function defaultLocale(definition) {
  return defaultLocale_locale = locale(definition), format = defaultLocale_locale.format, formatPrefix = defaultLocale_locale.formatPrefix, defaultLocale_locale;
}
...
function linearish(scale) {
  ...
  return scale.ticks = function (count) {
    ...
    for (stop < start && (step = start, start = stop, stop = step, step = i0, i0 = i1, i1 = step); maxIter-- > 0;) {
      if (step = tickIncrement(start, stop, count), step === prestep) return d[i0] = start, d[i1] = stop, domain(d);
      if (step > 0) start = Math.floor(start / step) * step, stop = Math.ceil(stop / step) * step;else if (step < 0) start = Math.ceil(start * step) / step, stop = Math.floor(stop * step) / step;else break;
      prestep = step;
    }
...
function loggish(transform) {
  ...
  return scale.base = function (_) {
    ...
    if (!(base % 1) && j - i < n) {
      ...
      z.length * 2 < n && (z = ticks(u, v, n));
    } else z = ticks(i, j, Math.min(j - i, n)).map(pows);

    return r ? z.reverse() : z;
  }, scale.tickFormat = function (count, specifier) {
    if (specifier == null && (specifier = base === 10 ? ".0e" : ","), typeof specifier !== "function" && (specifier = format(specifier)), count === Infinity) return specifier;
    count == null && (count = 10);
...
function sequential_transformer() {
  ...
  }, scale.range = range(value), scale.rangeRound = range(round), scale.unknown = function (_) {
    return arguments.length ? (unknown = _, scale) : unknown;
  }, function (t) {
...
function size_unsupportedIterableToArray(o, minLen) { if (o) { if (typeof o === "string") return size_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); return n === "Object" && o.constructor && (n = o.constructor.name), n === "Map" || n === "Set" ? Array.from(o) : n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? size_arrayLikeToArray(o, minLen) : void 0; } }

function size_arrayLikeToArray(arr, len) { (len == null || len > arr.length) && (len = arr.length); for (var i = 0, arr2 = Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }

/* harmony default export */ function size() {
  var size = 0;

  for (var _step, _iterator = size_createForOfIteratorHelperLoose(this); !(_step = _iterator()).done;) {
    _step.value;
    ++size;
...
function parseSvg(value) {
  return value == null ? decompose_identity : (svgNode || (svgNode = document.createElementNS("http://www.w3.org/2000/svg", "g")), svgNode.setAttribute("transform", value), !(value = svgNode.transform.baseVal.consolidate())) ? decompose_identity : (value = value.matrix, decompose(value.a, value.b, value.c, value.d, value.e, value.f));
}
...
var ColorScale = /*#__PURE__*/function () {
  ...
  return _proto.drawColorScale = function drawColorScale() {
    ...
    scaleFormat === "pow10" ? legendAxis.tickValues([1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7]) : isFunction(scaleFormat) ? legendAxis.tickFormat(scaleFormat) : legendAxis.tickFormat(format("d"));
    // Draw Axis
...
var Stanford = /*#__PURE__*/function (_Plugin) {
  ...
  return _proto.$beforeInit = function $beforeInit() {
    ...
    target.minEpochs = isNaN(config.scale_min) ? Math.min.apply(Math, epochs) : config.scale_min, target.maxEpochs = isNaN(config.scale_max) ? Math.max.apply(Math, epochs) : config.scale_max, target.colors = isFunction(config.colors) ? config.colors : hslLong(hsl(250, 1, .5), hsl(0, 1, .5)), target.colorscale = sequentialLog(target.colors).domain([target.minEpochs, target.maxEpochs]);
