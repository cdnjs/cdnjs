...
;// CONCATENATED MODULE: external {"commonjs":"d3-selection","commonjs2":"d3-selection","amd":"d3-selection","root":"d3"}
var external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_namespaceObject = undefined;
...
var BubbleCompare = /*#__PURE__*/function (_Plugin) {
  ...
  return _proto.$init = function $init() {
    ...
    d.raise && (0,external_commonjs_d3_selection_commonjs2_d3_selection_amd_d3_selection_root_d3_namespaceObject.select)(d.node().parentNode.parentNode).raise();
...
((bb = typeof bb === "undefined" ? {} : bb).plugin = bb.plugin || {}).bubblecompare = __webpack_exports__.default;
/******/ })()
;