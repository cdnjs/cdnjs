...
var Stanford = /*#__PURE__*/function (_Plugin) {
  ...
  return _proto.$beforeInit = function $beforeInit() {
    ...
    (_this$colorScale = this.colorScale) != null && _this$colorScale.drawColorScale(), (_this$elements = this.elements) == null ? void 0 : _this$elements.updateStanfordElements(duration);
