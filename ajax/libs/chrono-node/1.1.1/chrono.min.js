...
function baseOption(e){return{parsers:[new parser.ENISOFormatParser(e),new parser.ENDeadlineFormatParser(e),new parser.ENMonthNameLittleEndianParser(e),new parser.ENMonthNameMiddleEndianParser(e),new parser.ENSlashDateFormatParser(e),new parser.ENSlashDateFormatStartWithYearParser(e),new parser.ENTimeAgoFormatParser(e),new parser.ENTimeExpessionParser(e),new parser.JPStandardParser(e)],refiners:[new refiner.OverlapRemovalRefiner,new refiner.ENMergeDateTimeRefiner,new refiner.ENMergeDateRangeRefiner,new refiner.JPMergeDateRangeRefiner,new refiner.ExtractTimezoneOffsetRefiner,new refiner.ExtractTimezoneAbbrRefiner,new refiner.UnlikelyFormatFilter]}}var parser=require("./parsers/parser"),refiner=require("./refiners/refiner");exports.strictOption=function(){return baseOption(!0)},exports.casualOption=function(){var e=baseOption(!1);return e.parsers.unshift(new parser.ENCasualDateParser),e.parsers.unshift(new parser.ENWeekdayParser),e.parsers.unshift(new parser.JPCasualDateParser),e};
},{"./parsers/parser":16,"./refiners/refiner":24}],4:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(today|tonight|tomorrow|tmr|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e){var t=e[0].substr(e[1].length),a=e.index+e[1].length,s=new ParsedResult({index:a,text:t,ref:r}),n=moment(r),i=n.clone(),o=t.toLowerCase();if("tonight"==o)s.start.imply("hour",22),s.start.imply("meridiem",1);else if("tomorrow"==o||"tmr"==o)n.hour()>4&&i.add(1,"day");else if("yesterday"==o)i.add(-1,"day");else if(o.match(/last\s*night/))s.start.imply("hour",0),n.hour()>6&&i.add(-1,"day");else if(o.match("this")){var m=e[3].toLowerCase();"afternoon"==m?s.start.imply("hour",15):"evening"==m?s.start.imply("hour",18):"morning"==m&&s.start.imply("hour",6)}return s.start.assign("day",i.date()),s.start.assign("month",i.month()+1),s.start.assign("year",i.year()),s.tags.ENCasualDateParser=!0,s}};
},{"../../result":25,"../parser":16,"moment":1}],5:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(within|in)\s*([0-9]+|an?)\s*(minutes?|hours?|days?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,a){var e=a.index+a[1].length,t=a[0];t=a[0].substr(a[1].length,a[0].length-a[1].length);var s=new ParsedResult({index:e,text:t,ref:r}),n=a[3];n="a"===n||"an"===n?1:parseInt(n);var i=moment(r);return a[4].match(/day/)?(i.add(n,"d"),s.start.assign("year",i.year()),s.start.assign("month",i.month()+1),s.start.assign("day",i.date()),s):(a[4].match(/hour/)?i.add(n,"hour"):a[4].match(/minute/)&&i.add(n,"minute"),s.start.imply("year",i.year()),s.start.imply("month",i.month()+1),s.start.imply("day",i.date()),s.start.assign("hour",i.hour()),s.start.assign("minute",i.minute()),s.tags.ENDeadlineFormatParser=!0,s)}};
},{"../../result":25,"../parser":16,"moment":1}],6:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?)?)?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,s){var t=s[0].substr(s[1].length),r=s.index+s[1].length,n=new ParsedResult({text:t,index:r,ref:e});if(n.start.assign("year",parseInt(s[YEAR_NUMBER_GROUP])),n.start.assign("month",parseInt(s[MONTH_NUMBER_GROUP])),n.start.assign("day",parseInt(s[DATE_NUMBER_GROUP])),moment(n.start.get("month"))>12||moment(n.start.get("month"))<1||moment(n.start.get("day"))>31||moment(n.start.get("day"))<1)return null;if(null!=s[HOUR_NUMBER_GROUP])if(n.start.assign("hour",parseInt(s[HOUR_NUMBER_GROUP])),n.start.assign("minute",parseInt(s[MINUTE_NUMBER_GROUP])),null!=s[SECOND_NUMBER_GROUP]&&n.start.assign("second",parseInt(s[SECOND_NUMBER_GROUP])),null!=s[MILLISECOND_NUMBER_GROUP]&&n.start.assign("millisecond",parseInt(s[MILLISECOND_NUMBER_GROUP])),null==s[TZD_HOUR_OFFSET_GROUP])n.start.assign("timezoneOffset",0);else{var a=0,R=parseInt(s[TZD_HOUR_OFFSET_GROUP]);null!=s[TZD_MINUTE_OFFSET_GROUP]&&(a=parseInt(s[TZD_MINUTE_OFFSET_GROUP]));var _=60*R;0>_?_-=a:_+=a,n.start.assign("timezoneOffset",_)}return n.tags.ENISOFormatParser=!0,n}};
},{"../../result":25,"../parser":16,"moment":1}],7:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\\s*,?\\s*)?([0-9]{1,2})(?:st|nd|rd|th)?(?:\\s*(?:to|\\-|\\–|until|through|till|\\s)\\s*([0-9]{1,2})(?:st|nd|rd|th)?)?\\s*(?:of)?\\s*(Jan(?:uary|\\.)?|Feb(?:ruary|\\.)?|Mar(?:ch|\\.)?|Apr(?:il|\\.)?|May|Jun(?:e|\\.)?|Jul(?:y|\\.)?|Aug(?:ust|\\.)?|Sep(?:tember|\\.)?|Oct(?:ober|\\.)?|Nov(?:ember|\\.)?|Dec(?:ember|\\.)?)(?:(\\s*[0-9]{2,4}(?![^\\s]\\d))(\\s*BE)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,a){var r=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:t}),s=a[MONTH_NAME_GROUP];s=util.MONTH_OFFSET[s.toLowerCase()];var n=a[DATE_GROUP];n=parseInt(n);var d=null;if(a[YEAR_GROUP]&&(d=a[YEAR_GROUP],d=parseInt(d),a[YEAR_BE_GROUP]?d-=543:100>d&&(d+=2e3)),d)r.start.assign("day",n),r.start.assign("month",s),r.start.assign("year",d);else{var u=moment(t);u.month(s-1),u.date(n),u.year(moment(t).year());var i=u.clone().add(1,"y"),o=u.clone().add(-1,"y");Math.abs(i.diff(moment(t)))<Math.abs(u.diff(moment(t)))?u=i:Math.abs(o.diff(moment(t)))<Math.abs(u.diff(moment(t)))&&(u=o),r.start.assign("day",n),r.start.assign("month",s),r.start.imply("year",u.year())}if(a[WEEKDAY_GROUP]){var E=a[WEEKDAY_GROUP];E=util.WEEKDAY_OFFSET[E.toLowerCase()],r.start.assign("weekday",E)}return a[DATE_TO_GROUP]&&(r.end=r.start.clone(),r.end.assign("day",parseInt(a[DATE_TO_GROUP]))),r.tags.ENMonthNameLittleEndianParser=!0,r}};
},{"../../result":25,"../../utils/EN":26,"../parser":16,"moment":1}],8:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\\.?|Mon\\.?|Tue\\.?|Wed\\.?|Thu\\.?|Fri\\.?|Sat\\.?)\\s*,?\\s*)?(Jan\\.?|January|Feb\\.?|February|Mar\\.?|March|Apr\\.?|April|May\\.?|Jun\\.?|June|Jul\\.?|July|Aug\\.?|August|Sep\\.?|Sept\\.?|September|Oct\\.?|October|Nov\\.?|November|Dec\\.?|December)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*(?:(?:to|\\-)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*)?(?:\\s*,?\\s*(s*[0-9]{4})(\\s*BE)?\\s*)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,MONTH_NAME_GROUP=3,DATE_GROUP=4,DATE_TO_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,t){var r=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:a}),s=t[MONTH_NAME_GROUP];s=util.MONTH_OFFSET[s.toLowerCase()];var n=t[DATE_GROUP];n=parseInt(n);var d=null;if(t[YEAR_GROUP]&&(d=t[YEAR_GROUP],d=parseInt(d),t[YEAR_BE_GROUP]?d-=543:100>d&&(d+=2e3)),d)r.start.assign("day",n),r.start.assign("month",s),r.start.assign("year",d);else{var u=moment(a);u.month(s-1),u.date(n);var i=u.clone().add(1,"y"),E=u.clone().add(-1,"y");Math.abs(i.diff(moment(a)))<Math.abs(u.diff(moment(a)))?u=i:Math.abs(E.diff(moment(a)))<Math.abs(u.diff(moment(a)))&&(u=E),r.start.assign("day",n),r.start.assign("month",s),r.start.imply("year",u.year())}if(t[WEEKDAY_GROUP]){var o=t[WEEKDAY_GROUP];o=util.WEEKDAY_OFFSET[o.toLowerCase()],r.start.assign("weekday",o)}return t[DATE_TO_GROUP]&&(r.end=r.start.clone(),r.end.assign("day",parseInt(t[DATE_TO_GROUP]))),r.tags.ENMonthNameMiddleEndianParser=!0,r}};
},{"../../result":25,"../../utils/EN":26,"../parser":16,"moment":1}],9:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:((?:sun|mon|tues?|wed(?:nes)?|thu(?:rs?)?|fri|sat(?:ur)?)(?:day)?)\\s*\\,?\\s*)?([0-9]{1,2})[\\/\\.\\-]([0-9]{1,2})(?:[\\/\\.\\-]([0-9]{4}|[0-9]{2}))?(\\W|$)","i"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,wednesday:3,wed:3,thursday:4,thur:4,friday:5,fri:5,saturday:6,sat:6},OPENNING_GROUP=1,ENDING_GROUP=6,WEEKDAY_GROUP=2,MONTH_GROUP=3,DAY_GROUP=4,YEAR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t){if("/"==t[OPENNING_GROUP]||"/"==t[ENDING_GROUP])return void(t.index+=t[0].length);var s=t.index+t[OPENNING_GROUP].length,e=t[0].substr(t[OPENNING_GROUP].length,t[0].length-t[ENDING_GROUP].length),a=new ParsedResult({text:e,index:s,ref:r});if(!e.match(/^\d\.\d$/)&&!(e.match(/^\d\.\d{1,2}\.\d{1,2}$/)||!t[YEAR_GROUP]&&t[0].indexOf("/")<0)){var n=t[YEAR_GROUP]||moment(r).year()+"",P=t[MONTH_GROUP],u=t[DAY_GROUP];if(P=parseInt(P),u=parseInt(u),n=parseInt(n),(1>P||P>12)&&P>12){if(!(u>=1&&12>=u&&P>=13&&31>=P))return null;var d=P;P=u,u=d}return 1>u||u>31?null:(100>n&&(n>50?n=n+2500-543:n+=2e3),a.start.assign("day",u),a.start.assign("month",P),a.start.assign("year",n),t[WEEKDAY_GROUP]&&a.start.assign("weekday",DAYS_OFFSET[t[WEEKDAY_GROUP].toLowerCase()]),a.tags.ENSlashDateFormatParser=!0,a)}}};
},{"../../result":25,"../parser":16,"moment":1}],10:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})[\\-\\.\\/]([0-9]{1,2})[\\-\\.\\/]([0-9]{1,2})(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,e,r){var t=r[0].substr(r[1].length),s=r.index+r[1].length,a=new ParsedResult({text:t,index:s,ref:e});return a.start.assign("year",parseInt(r[YEAR_NUMBER_GROUP])),a.start.assign("month",parseInt(r[MONTH_NUMBER_GROUP])),a.start.assign("day",parseInt(r[DATE_NUMBER_GROUP])),moment(a.start.get("month"))>12||moment(a.start.get("month"))<1||moment(a.start.get("day"))>31||moment(a.start.get("day"))<1?null:(a.tags.ENDateFormatParser=!0,a)}};
},{"../../result":25,"../parser":16,"moment":1}],11:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(?:within\s*)?([0-9]+|an?)\s*(minutes?|hours?|weeks?|days?|months?|years?)\s*(?:ago|before|earlier)(?=(?:\W|$))/i,STRICT_PATTERN=/(\W|^)(?:within\s*)?([0-9]+|an?)\s*(minutes?|hours?|days?)\s*ago(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return this.isStrictMode()?STRICT_PATTERN:PATTERN},this.extract=function(t,a,e){if(e.index>0&&t[e.index-1].match(/\w/))return null;var t=e[0];t=e[0].substr(e[1].length,e[0].length-e[1].length),index=e.index+e[1].length;var r=new ParsedResult({index:index,text:t,ref:a}),s=e[2];s="a"===s||"an"===s?1:parseInt(s);var n=moment(a);return e[3].match(/hour/)||e[3].match(/minute/)?(e[3].match(/hour/)?n.add(-s,"hour"):e[3].match(/minute/)&&n.add(-s,"minute"),r.start.imply("day",n.date()),r.start.imply("month",n.month()+1),r.start.imply("year",n.year()),r.start.assign("hour",n.hour()),r.start.assign("minute",n.minute()),r.tags.ENTimeAgoFormatParser=!0,r):e[3].match(/weeks/)?(n.add(-s,"week"),r.start.imply("day",n.date()),r.start.imply("month",n.month()+1),r.start.imply("year",n.year()),r.start.imply("weekday",n.day()),r):(e[3].match(/day/)&&n.add(-s,"d"),e[3].match(/month/)&&n.add(-s,"month"),e[3].match(/year/)&&n.add(-s,"year"),r.start.assign("day",n.date()),r.start.assign("month",n.month()+1),r.start.assign("year",n.year()),r)}};
},{"../../result":25,"../parser":16,"moment":1}],12:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:at|from)\\s*)?(\\d{1,4}|noon|midnight)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\:|\\：)(\\d{2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|to|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,t,r){if(r.index>0&&e[r.index-1].match(/\w/))return null;var n=moment(t),s=new ParsedResult;s.ref=t,s.index=r.index+r[1].length,s.text=r[0].substring(r[1].length),s.tags.ENTimeExpressionParser=!0,s.start.imply("day",n.date()),s.start.imply("month",n.month()+1),s.start.imply("year",n.year());var a=0,i=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;s.start.assign("second",l)}if("noon"==r[HOUR_GROUP].toLowerCase()?(u=1,a=12):"midnight"==r[HOUR_GROUP].toLowerCase()?(u=0,a=0):a=parseInt(r[HOUR_GROUP]),null!=r[MINUTE_GROUP]?i=parseInt(r[MINUTE_GROUP]):a>100&&(i=a%100,a=parseInt(a/100)),i>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;var R=r[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==R&&(u=0,12==a&&(a=0)),"p"==R&&(u=1,12!=a&&(a+=12))}if(s.start.assign("hour",a),s.start.assign("minute",i),u>=0&&s.start.assign("meridiem",u),r=SECOND_REG_PATTERN.exec(e.substring(s.index+s.text.length)),!r)return s.text.match(/^\d+$/)?null:s;if(r[0].match(/^\s*(\+|\-)\s*\d{3,4}$/))return s;null==s.end&&(s.end=s.start.clone());var a=0,i=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;s.end.assign("second",l)}if(a=parseInt(r[2]),null!=r[MINUTE_GROUP]){if(i=parseInt(r[MINUTE_GROUP]),i>=60)return s}else a>100&&(i=a%100,a=parseInt(a/100));if(i>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;"a"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=0,12==a&&(a=0,s.end.isCertain("day")||s.end.imply("day",s.end.get("day")+1))),"p"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=1,12!=a&&(a+=12)),s.start.isCertain("meridiem")||(0==u?(s.start.imply("meridiem",0),12==s.start.get("hour")&&s.start.assign("hour",0)):(s.start.imply("meridiem",1),12!=s.start.get("hour")&&s.start.assign("hour",s.start.get("hour")+12)))}return a>=12&&(u=1),s.text=s.text+r[0],s.end.assign("hour",a),s.end.assign("minute",i),u>=0&&s.end.assign("meridiem",u),s}};
},{"../../result":25,"../parser":16,"moment":1}],13:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)(?:(?:\\,|\\(|\\（)\\s*)?(?:(this|last|next)\\s*)?(Sunday|Sun|Monday|Mon|Tuesday|Tues|Tue|Wednesday|Wed|Thursday|Thurs|Thur|Friday|Fri|Saturday|Sat)(?:\\s*(?:\\,|\\)|\\）))?(?:\\s*(this|last|next)\\s*week)?(?=\\W|$)","i"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tues:2,tue:2,wednesday:3,wed:3,thursday:4,thurs:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PREFIX_GROUP=2,WEEKDAY_GROUP=3,POSTFIX_GROUP=4;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,t,a){var r=a.index+a[1].length,e=a[0].substr(a[1].length,a[0].length-a[1].length),s=new ParsedResult({index:r,text:e,ref:t}),n=a[WEEKDAY_GROUP].toLowerCase(),u=DAYS_OFFSET[n];if(void 0===u)return null;var d=moment(t),y=a[PREFIX_GROUP],i=a[POSTFIX_GROUP];if(y||i){var h=y||i;h=h.toLowerCase(),"last"==h?d.day(u-7):"next"==h?d.day(u+7):"this"==h&&d.day(u)}else{var P=d.day();d.day(Math.abs(u-7-P)<Math.abs(u-P)?u-7:Math.abs(u+7-P)<Math.abs(u-P)?u+7:u)}return s.start.assign("weekday",u),s.start.imply("day",d.date()),s.start.imply("month",d.month()+1),s.start.imply("year",d.year()),s}};
},{"../../result":25,"../parser":16,"moment":1}],14:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/今日|当日|昨日|明日|今夜|今夕|今晩|今朝/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(r,t,e){var a=e.index,r=e[0],s=new ParsedResult({index:a,text:r,ref:t}),i=moment(t),n=i.clone();return"今夜"==r||"今夕"==r||"今晩"==r?(s.start.imply("hour",22),s.start.imply("meridiem",1)):"明日"==r?i.hour()>4&&n.add(1,"day"):"昨日"==r?n.add(-1,"day"):r.match("今朝")&&(s.start.imply("hour",6),s.start.imply("meridiem",0)),s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year()),s.tags.JPCasualDateParser=!0,s}};
},{"../../result":25,"../parser":16,"moment":1}],15:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/JP"),PATTERN=/(?:(同|((昭和|平成)?([0-9０-９]{2,4})))年\s*)?([0-9０-９]{1,2})月\s*([0-9０-９]{1,2})日/i,YEAR_GROUP=2,ERA_GROUP=3,YEAR_NUMBER_GROUP=4,MONTH_GROUP=5,DAY_GROUP=6;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,a,e){var r=moment(a),s=new ParsedResult({text:e[0],index:e.index,ref:a}),n=e[MONTH_GROUP];n=util.toHankaku(n),n=parseInt(n);var i=e[DAY_GROUP];if(i=util.toHankaku(i),i=parseInt(i),r.set("date",i),r.set("month",n-1),s.start.assign("day",r.date()),s.start.assign("month",r.month()+1),e[YEAR_GROUP])if(e[YEAR_GROUP].match("同年"))s.start.assign("year",r.year());else{var R=e[YEAR_NUMBER_GROUP];R=util.toHankaku(R),R=parseInt(R),"平成"==e[ERA_GROUP]?R+=1988:"昭和"==e[ERA_GROUP]&&(R+=1925),s.start.assign("year",R)}else{r.year(moment(a).year());var m=r.clone().add(1,"y"),P=r.clone().add(-1,"y");Math.abs(m.diff(moment(a)))<Math.abs(r.diff(moment(a)))?r=m:Math.abs(P.diff(moment(a)))<Math.abs(r.diff(moment(a)))&&(r=P),s.start.assign("day",r.date()),s.start.assign("month",r.month()+1),s.start.imply("year",r.year())}return s.tags.JPStandardParser=!0,s}};
},{"../../result":25,"../../utils/JP":27,"../parser":16,"moment":1}],16:[function(require,module,exports){
function Parser(r){this.isStrictMode=function(){return 1==r},this.pattern=function(){return/./i},this.extract=function(){return null},this.execute=function(r,e,a){for(var t=[],s=this.pattern(),i=r,n=s.exec(i);n;){n.index+=r.length-i.length;var P=this.extract(r,e,n,a);P?(i=r.substring(P.index+P.text.length),(!this.isStrictMode()||P.hasPossibleDates())&&t.push(P)):i=r.substring(n.index+1),n=s.exec(i)}return this.refiners&&this.refiners.forEach(function(){t=refiner.refine(t,r,options)}),t}}exports.Parser=Parser,exports.ENISOFormatParser=require("./EN/ENISOFormatParser").Parser,exports.ENDeadlineFormatParser=require("./EN/ENDeadlineFormatParser").Parser,exports.ENMonthNameLittleEndianParser=require("./EN/ENMonthNameLittleEndianParser").Parser,exports.ENMonthNameMiddleEndianParser=require("./EN/ENMonthNameMiddleEndianParser").Parser,exports.ENSlashDateFormatParser=require("./EN/ENSlashDateFormatParser").Parser,exports.ENSlashDateFormatStartWithYearParser=require("./EN/ENSlashDateFormatStartWithYearParser").Parser,exports.ENTimeAgoFormatParser=require("./EN/ENTimeAgoFormatParser").Parser,exports.ENTimeExpessionParser=require("./EN/ENTimeExpressionParser").Parser,exports.ENWeekdayParser=require("./EN/ENWeekdayParser").Parser,exports.ENCasualDateParser=require("./EN/ENCasualDateParser").Parser,exports.JPStandardParser=require("./JP/JPStandardParser").Parser,exports.JPCasualDateParser=require("./JP/JPCasualDateParser").Parser;
