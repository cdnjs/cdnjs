...
var ENISOFormatParser=require("./parsers/EN/ENISOFormatParser").Parser,ENDeadlineFormatParser=require("./parsers/EN/ENDeadlineFormatParser").Parser,ENMonthNameLittleEndianParser=require("./parsers/EN/ENMonthNameLittleEndianParser").Parser,ENMonthNameMiddleEndianParser=require("./parsers/EN/ENMonthNameMiddleEndianParser").Parser,ENSlashDateFormatParser=require("./parsers/EN/ENSlashDateFormatParser").Parser,ENTimeAgoFormatParser=require("./parsers/EN/ENTimeAgoFormatParser").Parser,ENTimeExpessionParser=require("./parsers/EN/ENTimeExpressionParser").Parser,ENWeekdayParser=require("./parsers/EN/ENWeekdayParser").Parser,ENCasualDateParser=require("./parsers/EN/ENCasualDateParser").Parser,ENMergeDateTimeRefiner=require("./refiners/EN/ENMergeDateTimeRefiner").Refiner,ENMergeDateRangeRefiner=require("./refiners/EN/ENMergeDateRangeRefiner").Refiner,JPStandardParser=require("./parsers/JP/JPStandardParser").Parser,JPCasualDateParser=require("./parsers/JP/JPCasualDateParser").Parser,JPMergeDateRangeRefiner=require("./refiners/JP/JPMergeDateRangeRefiner").Refiner,OverlapRemovalRefiner=require("./refiners/OverlapRemovalRefiner").Refiner,ExtractTimezoneOffsetRefiner=require("./refiners/ExtractTimezoneOffsetRefiner").Refiner,ExtractTimezoneAbbrRefiner=require("./refiners/ExtractTimezoneAbbrRefiner").Refiner,UnlikelyFormatFilter=require("./refiners/UnlikelyFormatFilter").Refiner;exports.strictOption=function(){return{parsers:[new ENISOFormatParser,new ENDeadlineFormatParser,new ENMonthNameLittleEndianParser,new ENMonthNameMiddleEndianParser,new ENSlashDateFormatParser,new ENTimeAgoFormatParser,new ENTimeExpessionParser,new JPStandardParser],refiners:[new OverlapRemovalRefiner,new ENMergeDateTimeRefiner,new ENMergeDateRangeRefiner,new JPMergeDateRangeRefiner,new ExtractTimezoneOffsetRefiner,new ExtractTimezoneAbbrRefiner,new UnlikelyFormatFilter]}},exports.casualOption=function(){var e=exports.strictOption();return e.parsers.unshift(new ENCasualDateParser),e.parsers.unshift(new ENWeekdayParser),e.parsers.unshift(new JPCasualDateParser),e};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(today|tonight|tomorrow|tmr|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,r,e){var a=e.index,t=e[0],s=new ParsedResult({index:a,text:t,ref:r}),i=moment(r),n=i.clone(),o=t.toLowerCase();if("tonight"==o)s.start.imply("hour",22),s.start.imply("meridiem",1);else if("tomorrow"==o||"tmr"==o)i.hour()>4&&n.add(1,"day");else if("yesterday"==o)n.add(-1,"day");else if(o.match(/last\s*night/))s.start.imply("hour",0),i.hour()>6&&n.add(-1,"day");else if(o.match("this")){var m=e[2].toLowerCase();"afternoon"==m?s.start.imply("hour",15):"evening"==m?s.start.imply("hour",18):"morning"==m&&s.start.imply("hour",6)}return s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year()),s.tags.ENCasualDateParser=!0,s}};
},{"../../result":24,"../parser":15,"moment":1}],5:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(within|in)\s*([0-9]+)\s*(minutes?|hours?|days?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,r,e){var a=e.index+e[1].length,t=e[0];t=e[0].substr(e[1].length,e[0].length-e[1].length);var s=new ParsedResult({index:a,text:t,ref:r}),n=e[3];n=parseInt(n);var i=moment(r);return e[4].match(/day/)?(i.add(n,"d"),s.start.assign("year",i.year()),s.start.assign("month",i.month()+1),s.start.assign("day",i.date()),s):(e[4].match(/hour/)?i.add(n,"hour"):e[4].match(/minute/)&&i.add(n,"minute"),s.start.imply("year",i.year()),s.start.imply("month",i.month()+1),s.start.imply("day",i.date()),s.start.assign("hour",i.hour()),s.start.assign("minute",i.minute()),s.tags.ENDeadlineFormatParser=!0,s)}};
},{"../../result":24,"../parser":15,"moment":1}],6:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?))?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,s,e){var t=e[0].substr(e[1]),r=e.index+e[1].length,R=new ParsedResult({text:t,index:r,ref:s});if(R.start.assign("year",parseInt(e[YEAR_NUMBER_GROUP])),R.start.assign("month",parseInt(e[MONTH_NUMBER_GROUP])),R.start.assign("day",parseInt(e[DATE_NUMBER_GROUP])),moment(R.start.get("month"))>12||moment(R.start.get("month"))<1||moment(R.start.get("day"))>31||moment(R.start.get("day"))<1)return null;if(null!=e[HOUR_NUMBER_GROUP])if(R.start.assign("hour",parseInt(e[HOUR_NUMBER_GROUP])),R.start.assign("minute",parseInt(e[MINUTE_NUMBER_GROUP])),null!=e[SECOND_NUMBER_GROUP]&&R.start.assign("second",parseInt(e[SECOND_NUMBER_GROUP])),null!=e[MILLISECOND_NUMBER_GROUP]&&R.start.assign("millisecond",parseInt(e[MILLISECOND_NUMBER_GROUP])),null==e[TZD_HOUR_OFFSET_GROUP])R.start.assign("timezoneOffset",0);else{var a=0,n=parseInt(e[TZD_HOUR_OFFSET_GROUP]);null!=e[TZD_MINUTE_OFFSET_GROUP]&&(a=parseInt(e[TZD_MINUTE_OFFSET_GROUP]));var _=60*n;0>_?_-=a:_+=a,R.start.assign("timezoneOffset",_)}return R.tags.ENISOFormatParser=!0,R}};
},{"../../result":24,"../parser":15,"moment":1}],7:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\\s*,?\\s*)?([0-9]{1,2})(?:st|nd|rd|th)?(?:\\s*(?:to|\\-|\\s)\\s*([0-9]{1,2})(?:st|nd|rd|th)?)?\\s*(?:of)?\\s*(Jan(?:uary|\\.)?|Feb(?:ruary|\\.)?|Mar(?:ch|\\.)?|Apr(?:il|\\.)?|May|Jun(?:e|\\.)?|Jul(?:y|\\.)?|Aug(?:ust|\\.)?|Sep(?:tember|\\.)?|Oct(?:ober|\\.)?|Nov(?:ember|\\.)?|Dec(?:ember|\\.)?)(?:(\\s*[0-9]{2,4}(?![^\\s]\\d))(\\s*BE)?)?(?=\\W|$)","i"),WEEKDAY_GROUP=2,DATE_GROUP=3,DATE_TO_GROUP=4,MONTH_NAME_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(e,t,a){var r=new ParsedResult({text:a[0].substr(a[1].length,a[0].length-a[1].length),index:a.index+a[1].length,ref:t}),s=moment(t),n=a[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var d=a[DATE_GROUP];d=parseInt(d);var u=null;if(a[YEAR_GROUP]&&(u=a[YEAR_GROUP],u=parseInt(u),a[YEAR_BE_GROUP]?u-=543:100>u&&(u+=2e3)),s.month(n-1),s.date(d),u)s.year(u),r.start.assign("day",s.date()),r.start.assign("month",s.month()+1),r.start.assign("year",s.year());else{s.year(moment(t).year());var i=s.clone().add(1,"y"),o=s.clone().add(-1,"y");Math.abs(i.diff(moment(t)))<Math.abs(s.diff(moment(t)))?s=i:Math.abs(o.diff(moment(t)))<Math.abs(s.diff(moment(t)))&&(s=o),r.start.assign("day",s.date()),r.start.assign("month",s.month()+1),r.start.imply("year",s.year())}if(a[WEEKDAY_GROUP]){var y=a[WEEKDAY_GROUP];y=util.WEEKDAY_OFFSET[y.toLowerCase()],r.start.assign("weekday",y)}return a[DATE_TO_GROUP]&&(r.end=r.start.clone(),r.end.assign("day",parseInt(a[DATE_TO_GROUP]))),r.tags.ENMonthNameLittleEndianParser=!0,r}};
},{"../../result":24,"../../utils/EN":25,"../parser":15,"moment":1}],8:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},regFullPattern=/(\W|^)((Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\s*,?\s*)?(Jan|January|Feb|February|Mar|March|Apr|April|May|Jun|June|Jul|July|Aug|August|Sep|September|Oct|October|Nov|November|Dec|December)\s*(([0-9]{1,2})(st|nd|rd|th)?\s*(to|\-)\s*)?([0-9]{1,2})(st|nd|rd|th)?(,)?(\s*[0-9]{4})(\s*BE)?(\W|$)/i,regShortPattern=/(\W|^)((Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun|Mon|Tue|Wed|Thu|Fri|Sat)\s*,?\s*)?(Jan|January|Feb|February|Mar|March|Apr|April|May|Jun|June|Jul|July|Aug|August|Sep|September|Oct|October|Nov|November|Dec|December)\s*(([0-9]{1,2})(st|nd|rd|th)?\s*(to|\-)\s*)?([0-9]{1,2})(st|nd|rd|th)?([^0-9]|$)/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return regShortPattern},this.extract=function(e,r,a){var t=new ParsedResult,n=[],s=null,u="",d=a.index;e=e.substr(d);var a=e.match(regFullPattern);if(a&&0==e.indexOf(a[0])){var e=a[0];if(e=e.substring(a[1].length,a[0].length-a[14].length),d+=a[1].length,u=e,e=e.replace(a[2],""),e=e.replace(a[4],a[4]+" "),a[5]&&(e=e.replace(a[5],"")),a[10]&&(e=e.replace(a[10],"")),a[11]&&(e=e.replace(","," ")),a[13]){var l=a[12];l=" "+(parseInt(l)-543),e=e.replace(a[13],""),e=e.replace(a[12],l)}if(e=e.replace(a[9],parseInt(a[9])+""),s=moment(e,"MMMM DD YYYY"),!s)return null;t.start.assign("day",s.date()),t.start.assign("month",s.month()+1),t.start.assign("year",s.year())}else{if(a=e.match(regShortPattern),!a)return null;var e=a[0];if(e=e.substring(a[1].length,a[0].length-a[11].length),d+=a[1].length,u=e,e=e.replace(a[2],""),e=e.replace(a[4],a[4]+" "),a[4]&&(e=e.replace(a[5],"")),s=moment(e,"MMMM DD"),!s)return null;n.push("year"),s.year(moment(r).year());var i=s.clone().add(1,"year"),y=s.clone().add(-1,"year");Math.abs(i.diff(moment(r)))<Math.abs(s.diff(moment(r)))?s=i:Math.abs(y.diff(moment(r)))<Math.abs(s.diff(moment(r)))&&(s=y),t.start.assign("day",s.date()),t.start.assign("month",s.month()+1),t.start.imply("year",s.year())}if(a[3]&&t.start.assign("weekday",DAYS_OFFSET[a[3].toLowerCase()]),a[5]){var o=parseInt(a[9]),h=parseInt(a[6]);t.end=t.start.clone(),t.start.assign("day",h),t.end.assign("day",o);var m=s.clone();s.date(h),m.date(o)}return t.index=d,t.text=u,t.ref=r,t.tags.ENMonthNameMiddleEndianParser=!0,t}};
},{"../../result":24,"../parser":15,"moment":1}],9:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(Sun|Sunday|Mon|Monday|Tue|Tuesday|Wed|Wednesday|Thur|Thursday|Fri|Friday|Sat|Saturday)?\s*\,?\s*([0-9]{1,2})[\/\.]([0-9]{1,2})([\/\.]([0-9]{4}|[0-9]{2}))?(\W|$)/i,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,wednesday:3,wed:3,thursday:4,thur:4,friday:5,fri:5,saturday:6,sat:6};exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(e,a,r){if("/"!=r[1]&&"/"!=r[7]){var t=r.index+r[1].length,e=r[0].substr(r[1].length,r[0].length-r[7].length),s=new ParsedResult({text:e,index:t,ref:a});if(!(e.match(/^\d.\d$/)||!r[6]&&r[0].indexOf("/")<0)){var n=null,d=r[6]||moment(a).year()+"",u=r[3],i=r[4];return u=parseInt(u),i=parseInt(i),d=parseInt(d),1>u||u>12?null:1>i||i>31?null:(100>d&&(d>50?d=d+2500-543:d+=2e3),e=u+"/"+i+"/"+d,n=moment(e,"M/D/YYYY"),n&&n.date()==i&&n.month()==u-1?(s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year()),r[2]&&s.start.assign("weekday",DAYS_OFFSET[r[2].toLowerCase()]),s.tags.ENSlashDateFormatParser=!0,s):null)}}}};
},{"../../result":24,"../parser":15,"moment":1}],10:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(?:within\s*)?([0-9]+)\s*(minutes?|hours?|days?)\s*ago(?=(?:\W|$))/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,e,r){if(r.index>0&&t[r.index-1].match(/\w/))return null;var t=r[0];t=r[0].substr(r[1].length,r[0].length-r[1].length),index=r.index+r[1].length;var a=new ParsedResult({index:index,text:t,ref:e}),s=r[2];s=parseInt(s);var n=moment(e);return r[3].match(/day/)?(impliedComponents=[],n.add(-s,"d"),a.start.assign("day",n.date()),a.start.assign("month",n.month()+1),a.start.assign("year",n.year()),a):(r[3].match(/hour/)?n.add(-s,"hour"):r[3].match(/minute/)&&n.add(-s,"minute"),a.start.imply("day",n.date()),a.start.imply("month",n.month()+1),a.start.imply("year",n.year()),a.start.assign("hour",n.hour()),a.start.assign("minute",n.minute()),a.tags.ENTimeAgoFormatParser=!0,a)}};
},{"../../result":24,"../parser":15,"moment":1}],11:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:at|from)?\\s*)?(\\d{1,4}|noon|midnight)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(AM|PM|A\\.M\\.|P\\.M\\.))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\~|\\〜|to|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(AM|PM|A\\.M\\.|P\\.M\\.))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.call(this),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,r,t){if(t.index>0&&e[t.index-1].match(/\w/))return null;var n=moment(r),s=new ParsedResult;s.ref=r,s.index=t.index+t[1].length,s.text=t[0].substring(t[1].length),s.tags.ENTimeExpressionParser=!0,s.start.imply("day",n.date()),s.start.imply("month",n.month()+1),s.start.imply("year",n.year());var a=0,i=0,l=-1;if(null!=t[SECOND_GROUP]){var u=parseInt(t[SECOND_GROUP]);if(u>=60)return null;s.start.assign("second",u)}if("noon"==t[HOUR_GROUP].toLowerCase()?(l=1,a=12):"midnight"==t[HOUR_GROUP].toLowerCase()?(l=0,a=0):a=parseInt(t[HOUR_GROUP]),null!=t[MINUTE_GROUP]?i=parseInt(t[MINUTE_GROUP]):a>100&&(i=a%100,a=parseInt(a/100)),i>=60)return null;if(a>24)return null;if(a>=12&&(l=1),null!=t[AM_PM_HOUR_GROUP]){if(a>12)return null;"am"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(l=0,12==a&&(a=0)),"pm"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(l=1,12!=a&&(a+=12))}if(s.start.assign("hour",a),s.start.assign("minute",i),l>=0&&s.start.assign("meridiem",l),t=SECOND_REG_PATTERN.exec(e.substring(s.index+s.text.length)),!t)return s.text.match(/^\d+$/)?null:s;null==s.end&&(s.end=s.start.clone());var a=0,i=0,l=-1;if(null!=t[SECOND_GROUP]){var u=parseInt(t[SECOND_GROUP]);if(u>=60)return null;s.end.assign("second",u)}if(a=parseInt(t[2]),null!=t[MINUTE_GROUP]){if(i=parseInt(t[MINUTE_GROUP]),i>=60)return s}else a>100&&(i=a%100,a=parseInt(a/100));if(i>=60)return null;if(a>24)return null;if(a>=12&&(l=1),null!=t[AM_PM_HOUR_GROUP]){if(a>12)return null;"am"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(l=0,12==a&&(a=0,s.end.isCertain("day")||s.end.imply("day",s.end.get("day")+1))),"pm"==t[AM_PM_HOUR_GROUP].replace(".","").toLowerCase()&&(l=1,12!=a&&(a+=12)),s.start.isCertain("meridiem")||(0==l?(s.start.imply("meridiem",0),12==s.start.get("hour")&&s.start.assign("hour",0)):(s.start.imply("meridiem",1),12!=s.start.get("hour")&&s.start.assign("hour",s.start.get("hour")+12)))}return a>=12&&(l=1),s.text=s.text+t[0],s.end.assign("hour",a),s.end.assign("minute",i),l>=0&&s.end.assign("meridiem",l),s}};
},{"../../result":24,"../parser":15,"moment":1}],12:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)((\,|\(|\（)\s*)?((this|last|next)\s*)?(Sunday|Sun|Monday|Mon|Tuesday|Tues|Tue|Wednesday|Wed|Thursday|Thurs|Thur|Friday|Fri|Saturday|Sat)(\s*(\,|\)|\）))?(\W|$)/i,DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tues:2,tue:2,wednesday:3,wed:3,thursday:4,thurs:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6};exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,e,a){var r=a.index+a[1].length,t=a[0].substr(a[1].length,a[0].length-a[9].length-a[1].length),s=new ParsedResult({index:r,text:t,ref:e}),n=a[6].toLowerCase(),u=DAYS_OFFSET[n];if(void 0===u)return null;var d=moment(e),y=a[5];if(y)y=y.toLowerCase(),"last"==y?d.day(u-7):"next"==y?d.day(u+7):"this"==y&&d.day(u);else{var i=d.day();d.day(Math.abs(u-7-i)<Math.abs(u-i)?u-7:Math.abs(u+7-i)<Math.abs(u-i)?u+7:u)}return s.start.assign("weekday",u),s.start.imply("day",d.date()),s.start.imply("month",d.month()+1),s.start.imply("year",d.year()),s}};
},{"../../result":24,"../parser":15,"moment":1}],13:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/今日|当日|昨日|明日|今夜|今夕|今晩|今朝/i;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(r,t,e){var a=e.index,r=e[0],s=new ParsedResult({index:a,text:r,ref:t}),i=moment(t),n=i.clone();return"今夜"==r||"今夕"==r||"今晩"==r?(s.start.imply("hour",22),s.start.imply("meridiem",1)):"明日"==r?i.hour()>4&&n.add(1,"day"):"昨日"==r?n.add(-1,"day"):r.match("今朝")&&(s.start.imply("hour",6),s.start.imply("meridiem",0)),s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year()),s.tags.JPCasualDateParser=!0,s}};
},{"../../result":24,"../parser":15,"moment":1}],14:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/JP"),PATTERN=/(?:(同|((昭和|平成)?([0-9０-９]{2,4})))年\s*)?([0-9０-９]{1,2})月\s*([0-9０-９]{1,2})日/i,YEAR_GROUP=2,ERA_GROUP=3,YEAR_NUMBER_GROUP=4,MONTH_GROUP=5,DAY_GROUP=6;exports.Parser=function(){Parser.call(this),this.pattern=function(){return PATTERN},this.extract=function(t,a,e){var r=moment(a),s=new ParsedResult({text:e[0],index:e.index,ref:a}),n=e[MONTH_GROUP];n=util.toHankaku(n),n=parseInt(n);var i=e[DAY_GROUP];if(i=util.toHankaku(i),i=parseInt(i),r.set("date",i),r.set("month",n-1),s.start.assign("day",r.date()),s.start.assign("month",r.month()+1),e[YEAR_GROUP])if(e[YEAR_GROUP].match("同年"))s.start.assign("year",r.year());else{var R=e[YEAR_NUMBER_GROUP];R=util.toHankaku(R),R=parseInt(R),"平成"==e[ERA_GROUP]?R+=1988:"昭和"==e[ERA_GROUP]&&(R+=1925),s.start.assign("year",R)}else{r.year(moment(a).year());var P=r.clone().add(1,"y"),m=r.clone().add(-1,"y");Math.abs(P.diff(moment(a)))<Math.abs(r.diff(moment(a)))?r=P:Math.abs(m.diff(moment(a)))<Math.abs(r.diff(moment(a)))&&(r=m),s.start.assign("day",r.date()),s.start.assign("month",r.month()+1),s.start.imply("year",r.year())}return s.tags.JPStandardParser=!0,s}};
},{"../../result":24,"../../utils/JP":26,"../parser":15,"moment":1}],15:[function(require,module,exports){
function Parser(){this.pattern=function(){return/./i},this.extract=function(){return null},this.execute=function(e,t,r){for(var n=[],i=this.pattern(),s=e,u=i.exec(s);u;){u.index+=e.length-s.length;var h=this.extract(e,t,u,r);h?(s=e.substring(h.index+h.text.length),n.push(h)):s=e.substring(u.index+1),u=i.exec(s)}return this.refiners&&this.refiners.forEach(function(){n=refiner.refine(n,e,options)}),n}}exports.Parser=Parser;
...
function ParsedResult(e){e=e||{},this.ref=e.ref,this.index=e.index,this.text=e.text,this.tags=e.tags||{},this.start=new ParsedComponents(e.start,e.ref),e.end&&(this.end=new ParsedComponents(e.end,e.ref))}function ParsedComponents(e,t){if(this.knownValues={},this.impliedValues={},e)for(key in e)this.knownValues[key]=e[key];t&&(t=moment(t),this.imply("day",t.date()),this.imply("month",t.month()+1),this.imply("year",t.year())),this.imply("hour",12),this.imply("minute",0),this.imply("second",0),this.imply("millisecond",0)}var moment=require("moment");ParsedResult.prototype.clone=function(){var e=new ParsedResult(this);e.tags=JSON.parse(JSON.stringify(this.tags)),e.start=this.start.clone(),this.end&&(e.end=this.end.clone())},ParsedComponents.prototype.clone=function(){var e=new ParsedComponents;return e.knownValues=JSON.parse(JSON.stringify(this.knownValues)),e.impliedValues=JSON.parse(JSON.stringify(this.impliedValues)),e},ParsedComponents.prototype.get=function(e){return e in this.knownValues?this.knownValues[e]:e in this.impliedValues?this.impliedValues[e]:void 0},ParsedComponents.prototype.assign=function(e,t){this.knownValues[e]=t,delete this.impliedValues[e]},ParsedComponents.prototype.imply=function(e,t){e in this.knownValues||(this.impliedValues[e]=t)},ParsedComponents.prototype.isCertain=function(e){return e in this.knownValues},ParsedComponents.prototype.date=function(){var e=moment();e.set("year",this.get("year")),e.set("month",this.get("month")-1),e.set("date",this.get("day")),e.set("hour",this.get("hour")),e.set("minute",this.get("minute")),e.set("second",this.get("second")),e.set("millisecond",this.get("millisecond"));var t=-(new Date).getTimezoneOffset(),s=this.isCertain("timezoneOffset")?this.get("timezoneOffset"):t,n=s-t;return e.add(-n,"minutes"),e.toDate()},exports.ParsedComponents=ParsedComponents,exports.ParsedResult=ParsedResult;
