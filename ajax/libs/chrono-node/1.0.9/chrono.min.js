...
var options=exports.options=require("./options");exports.Parser=require("./parsers/parser").Parser,exports.Refiner=require("./refiners/refiner").Filter,exports.Filter=require("./refiners/refiner").Filter,exports.ParsedResult=require("./result").ParsedResult,exports.ParsedComponents=require("./result").ParsedComponents;var Chrono=function(r){r=r||exports.options.strictOption(),this.option=r,this.parsers=new Object(r.parsers),this.refiners=new Object(r.refiners)};Chrono.prototype.parse=function(r,e,t){e=e||new Date,t=t||{};var s=[];return this.parsers.forEach(function(o){var n=o.execute(r,e,t);s=s.concat(n)}),s.sort(function(r,e){return r.index-e.index}),this.refiners.forEach(function(e){s=e.refine(r,s,t)}),s},Chrono.prototype.parseDate=function(r,e,t){var s=this.parse(r,e,t);return s.length>0?s[0].start.date():null},exports.Chrono=Chrono,exports.strict=new Chrono(options.strictOption()),exports.casual=new Chrono(options.casualOption()),exports.parse=function(){return exports.casual.parse.apply(exports.casual,arguments)},exports.parseDate=function(){return exports.casual.parseDate.apply(exports.casual,arguments)};
},{"./options":3,"./parsers/parser":16,"./refiners/refiner":24,"./result":25}],3:[function(require,module,exports){
function baseOption(e){return{parsers:[new ENISOFormatParser(e),new ENDeadlineFormatParser(e),new ENMonthNameLittleEndianParser(e),new ENMonthNameMiddleEndianParser(e),new ENSlashDateFormatParser(e),new ENSlashDateFormatStartWithYearParser(e),new ENTimeAgoFormatParser(e),new ENTimeExpessionParser(e),new JPStandardParser(e)],refiners:[new OverlapRemovalRefiner,new ENMergeDateTimeRefiner,new ENMergeDateRangeRefiner,new JPMergeDateRangeRefiner,new ExtractTimezoneOffsetRefiner,new ExtractTimezoneAbbrRefiner,new UnlikelyFormatFilter]}}var ENISOFormatParser=require("./parsers/EN/ENISOFormatParser").Parser,ENDeadlineFormatParser=require("./parsers/EN/ENDeadlineFormatParser").Parser,ENMonthNameLittleEndianParser=require("./parsers/EN/ENMonthNameLittleEndianParser").Parser,ENMonthNameMiddleEndianParser=require("./parsers/EN/ENMonthNameMiddleEndianParser").Parser,ENSlashDateFormatParser=require("./parsers/EN/ENSlashDateFormatParser").Parser,ENSlashDateFormatStartWithYearParser=require("./parsers/EN/ENSlashDateFormatStartWithYearParser").Parser,ENTimeAgoFormatParser=require("./parsers/EN/ENTimeAgoFormatParser").Parser,ENTimeExpessionParser=require("./parsers/EN/ENTimeExpressionParser").Parser,ENWeekdayParser=require("./parsers/EN/ENWeekdayParser").Parser,ENCasualDateParser=require("./parsers/EN/ENCasualDateParser").Parser,ENMergeDateTimeRefiner=require("./refiners/EN/ENMergeDateTimeRefiner").Refiner,ENMergeDateRangeRefiner=require("./refiners/EN/ENMergeDateRangeRefiner").Refiner,JPStandardParser=require("./parsers/JP/JPStandardParser").Parser,JPCasualDateParser=require("./parsers/JP/JPCasualDateParser").Parser,JPMergeDateRangeRefiner=require("./refiners/JP/JPMergeDateRangeRefiner").Refiner,OverlapRemovalRefiner=require("./refiners/OverlapRemovalRefiner").Refiner,ExtractTimezoneOffsetRefiner=require("./refiners/ExtractTimezoneOffsetRefiner").Refiner,ExtractTimezoneAbbrRefiner=require("./refiners/ExtractTimezoneAbbrRefiner").Refiner,UnlikelyFormatFilter=require("./refiners/UnlikelyFormatFilter").Refiner;exports.strictOption=function(){return baseOption(!0)},exports.casualOption=function(){var e=baseOption(!1);return e.parsers.unshift(new ENCasualDateParser),e.parsers.unshift(new ENWeekdayParser),e.parsers.unshift(new JPCasualDateParser),e};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(today|tonight|tomorrow|tmr|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e){var a=e.index,t=e[0],s=new ParsedResult({index:a,text:t,ref:r}),i=moment(r),n=i.clone(),o=t.toLowerCase();if("tonight"==o)s.start.imply("hour",22),s.start.imply("meridiem",1);else if("tomorrow"==o||"tmr"==o)i.hour()>4&&n.add(1,"day");else if("yesterday"==o)n.add(-1,"day");else if(o.match(/last\s*night/))s.start.imply("hour",0),i.hour()>6&&n.add(-1,"day");else if(o.match("this")){var m=e[2].toLowerCase();"afternoon"==m?s.start.imply("hour",15):"evening"==m?s.start.imply("hour",18):"morning"==m&&s.start.imply("hour",6)}return s.start.assign("day",n.date()),s.start.assign("month",n.month()+1),s.start.assign("year",n.year()),s.tags.ENCasualDateParser=!0,s}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)([0-9]{4})\\-([0-9]{1,2})\\-([0-9]{1,2})(?:T([0-9]{1,2}):([0-9]{1,2})(?::([0-9]{1,2})(?:\\.(\\d{1,4}))?)?(?:Z|([+-]\\d{2}):?(\\d{2})?)?)?(?=\\W|$)","i"),YEAR_NUMBER_GROUP=2,MONTH_NUMBER_GROUP=3,DATE_NUMBER_GROUP=4,HOUR_NUMBER_GROUP=5,MINUTE_NUMBER_GROUP=6,SECOND_NUMBER_GROUP=7,MILLISECOND_NUMBER_GROUP=8,TZD_HOUR_OFFSET_GROUP=9,TZD_MINUTE_OFFSET_GROUP=10;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,s,e){var t=e[0].substr(e[1]),r=e.index+e[1].length,a=new ParsedResult({text:t,index:r,ref:s});if(a.start.assign("year",parseInt(e[YEAR_NUMBER_GROUP])),a.start.assign("month",parseInt(e[MONTH_NUMBER_GROUP])),a.start.assign("day",parseInt(e[DATE_NUMBER_GROUP])),moment(a.start.get("month"))>12||moment(a.start.get("month"))<1||moment(a.start.get("day"))>31||moment(a.start.get("day"))<1)return null;if(null!=e[HOUR_NUMBER_GROUP])if(a.start.assign("hour",parseInt(e[HOUR_NUMBER_GROUP])),a.start.assign("minute",parseInt(e[MINUTE_NUMBER_GROUP])),null!=e[SECOND_NUMBER_GROUP]&&a.start.assign("second",parseInt(e[SECOND_NUMBER_GROUP])),null!=e[MILLISECOND_NUMBER_GROUP]&&a.start.assign("millisecond",parseInt(e[MILLISECOND_NUMBER_GROUP])),null==e[TZD_HOUR_OFFSET_GROUP])a.start.assign("timezoneOffset",0);else{var n=0,R=parseInt(e[TZD_HOUR_OFFSET_GROUP]);null!=e[TZD_MINUTE_OFFSET_GROUP]&&(n=parseInt(e[TZD_MINUTE_OFFSET_GROUP]));var _=60*R;0>_?_-=n:_+=n,a.start.assign("timezoneOffset",_)}return a.tags.ENISOFormatParser=!0,a}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(\\W|^)((?:sun|mon|tues?|wed(?:nes)?|thu(?:rs?)?|fri|sat(?:ur)?)(?:day)?)?\\s*\\,?\\s*([0-9]{1,2})[\\/\\.\\-]([0-9]{1,2})([\\/\\.\\-]([0-9]{4}|[0-9]{2}))?(\\W|$)","i"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,wednesday:3,wed:3,thursday:4,thur:4,friday:5,fri:5,saturday:6,sat:6};exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t){if("/"==t[1]||"/"==t[7])return void(t.index+=t[0].length);var s=t.index+t[1].length,e=t[0].substr(t[1].length,t[0].length-t[7].length),a=new ParsedResult({text:e,index:s,ref:r});if(!(e.match(/^\d.\d$/)||!t[6]&&t[0].indexOf("/")<0)){var n=t[6]||moment(r).year()+"",u=t[3],i=t[4];if(u=parseInt(u),i=parseInt(i),n=parseInt(n),(1>u||u>12)&&u>12){if(!(i>=1&&12>=i&&u>=13&&31>=u))return null;var d=u;u=i,i=d}return 1>i||i>31?null:(100>n&&(n>50?n=n+2500-543:n+=2e3),a.start.assign("day",i),a.start.assign("month",u),a.start.assign("year",n),t[2]&&a.start.assign("weekday",DAYS_OFFSET[t[2].toLowerCase()]),a.tags.ENSlashDateFormatParser=!0,a)}}};
...
function Parser(t){this.isStrictMode=function(){return 1==t},this.pattern=function(){return/./i},this.extract=function(){return null},this.execute=function(t,e,r){for(var n=[],i=this.pattern(),s=t,h=i.exec(s);h;){h.index+=t.length-s.length;var u=this.extract(t,e,h,r);u?(s=t.substring(u.index+u.text.length),(!this.isStrictMode()||u.hasPossibleDates())&&n.push(u)):s=t.substring(h.index+1),h=i.exec(s)}return this.refiners&&this.refiners.forEach(function(){n=refiner.refine(n,t,options)}),n}}exports.Parser=Parser;
...
exports.Refiner=function(){this.refine=function(i,n){return n}},exports.Filter=function(){exports.Refiner.call(this),this.isValid=function(){return!0},this.refine=function(i,n,t){for(var r=[],e=0;e<n.length;e++){var s=n[e];this.isValid(i,s,t)&&r.push(s)}return r}};
