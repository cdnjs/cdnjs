...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/EN"),DAYS_OFFSET={sunday:0,sun:0,monday:1,mon:1,tuesday:2,tue:2,wednesday:3,wed:3,thursday:4,thur:4,thu:4,friday:5,fri:5,saturday:6,sat:6},PATTERN=new RegExp("(\\W|^)(?:(Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sun\\.?|Mon\\.?|Tue\\.?|Wed\\.?|Thu\\.?|Fri\\.?|Sat\\.?)\\s*,?\\s*)?(Jan\\.?|January|Feb\\.?|February|Mar\\.?|March|Apr\\.?|April|May\\.?|Jun\\.?|June|Jul\\.?|July|Aug\\.?|August|Sep\\.?|Sept\\.?|September|Oct\\.?|October|Nov\\.?|November|Dec\\.?|December)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*(?:(?:to|\\-)\\s*([0-9]{1,2})(?:st|nd|rd|th)?\\s*)?(?:\\s*,?\\s*([0-9]{4})(\\s*BE)?\\s*)?(?=\\W|$)(?!\\:\\d)","i"),WEEKDAY_GROUP=2,MONTH_NAME_GROUP=3,DATE_GROUP=4,DATE_TO_GROUP=5,YEAR_GROUP=6,YEAR_BE_GROUP=7;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,a,t,r){e.indexOf("5 May 12:00")>=0&&console.log(t);var s=new ParsedResult({text:t[0].substr(t[1].length,t[0].length-t[1].length),index:t.index+t[1].length,ref:a}),n=t[MONTH_NAME_GROUP];n=util.MONTH_OFFSET[n.toLowerCase()];var d=t[DATE_GROUP];d=parseInt(d);var u=null;if(t[YEAR_GROUP]&&(u=t[YEAR_GROUP],u=parseInt(u),t[YEAR_BE_GROUP]?u-=543:100>u&&(u+=2e3)),u)s.start.assign("day",d),s.start.assign("month",n),s.start.assign("year",u);else{var i=moment(a);i.month(n-1),i.date(d);var o=i.clone().add(1,"y"),E=i.clone().add(-1,"y");Math.abs(o.diff(moment(a)))<Math.abs(i.diff(moment(a)))?i=o:Math.abs(E.diff(moment(a)))<Math.abs(i.diff(moment(a)))&&(i=E),s.start.assign("day",d),s.start.assign("month",n),s.start.imply("year",i.year())}if(t[WEEKDAY_GROUP]){var y=t[WEEKDAY_GROUP];y=util.WEEKDAY_OFFSET[y.toLowerCase()],s.start.assign("weekday",y)}return t[DATE_TO_GROUP]&&(s.end=s.start.clone(),s.end.assign("day",parseInt(t[DATE_TO_GROUP]))),s.tags.ENMonthNameMiddleEndianParser=!0,s}};
