...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,ParsedComponents=require("../../result").ParsedComponents,FIRST_REG_PATTERN=new RegExp("(^|\\s|T)(?:(?:at|from)\\s*)?(\\d{1,4}|noon|midnight)(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\:|\\：)(\\d{2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),SECOND_REG_PATTERN=new RegExp("^\\s*(\\-|\\–|\\~|\\〜|to|\\?)\\s*(\\d{1,4})(?:(?:\\.|\\:|\\：)(\\d{1,2})(?:(?:\\.|\\:|\\：)(\\d{1,2}))?)?(?:\\s*(A\\.M\\.|P\\.M\\.|AM?|PM?))?(?=\\W|$)","i"),HOUR_GROUP=2,MINUTE_GROUP=3,SECOND_GROUP=4,AM_PM_HOUR_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,t,r){if(r.index>0&&e[r.index-1].match(/\w/))return null;var n=moment(t),s=new ParsedResult;s.ref=t,s.index=r.index+r[1].length,s.text=r[0].substring(r[1].length),s.tags.ENTimeExpressionParser=!0,s.start.imply("day",n.date()),s.start.imply("month",n.month()+1),s.start.imply("year",n.year());var a=0,i=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;s.start.assign("second",l)}if("noon"==r[HOUR_GROUP].toLowerCase()?(u=1,a=12):"midnight"==r[HOUR_GROUP].toLowerCase()?(u=0,a=0):a=parseInt(r[HOUR_GROUP]),null!=r[MINUTE_GROUP]?i=parseInt(r[MINUTE_GROUP]):a>100&&(i=a%100,a=parseInt(a/100)),i>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;var d=r[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==d&&(u=0,12==a&&(a=0)),"p"==d&&(u=1,12!=a&&(a+=12))}if(s.start.assign("hour",a),s.start.assign("minute",i),u>=0&&s.start.assign("meridiem",u),r=SECOND_REG_PATTERN.exec(e.substring(s.index+s.text.length)),!r)return s.text.match(/^\d+$/)?null:s;if(r[0].match(/^\s*(\+|\-)\s*\d{3,4}$/))return s;null==s.end&&(s.end=new ParsedComponents(null,s.start.date()));var a=0,i=0,u=-1;if(null!=r[SECOND_GROUP]){var l=parseInt(r[SECOND_GROUP]);if(l>=60)return null;s.end.assign("second",l)}if(a=parseInt(r[2]),null!=r[MINUTE_GROUP]){if(i=parseInt(r[MINUTE_GROUP]),i>=60)return s}else a>100&&(i=a%100,a=parseInt(a/100));if(i>=60)return null;if(a>24)return null;if(a>=12&&(u=1),null!=r[AM_PM_HOUR_GROUP]){if(a>12)return null;"a"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=0,12==a&&(a=0,s.end.isCertain("day")||s.end.imply("day",s.end.get("day")+1))),"p"==r[AM_PM_HOUR_GROUP][0].toLowerCase()&&(u=1,12!=a&&(a+=12)),s.start.isCertain("meridiem")||(0==u?(s.start.imply("meridiem",0),12==s.start.get("hour")&&s.start.assign("hour",0)):(s.start.imply("meridiem",1),12!=s.start.get("hour")&&s.start.assign("hour",s.start.get("hour")+12)))}else a>=12&&(u=1);return s.text=s.text+r[0],s.end.assign("hour",a),s.end.assign("minute",i),u>=0&&s.end.assign("meridiem",u),s.end.date().getTime()<s.start.date().getTime()&&s.end.imply("day",s.end.get("day")+1),s}};
