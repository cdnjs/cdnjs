...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(today|tonight|tomorrow|tmr|yesterday|last\s*night|this\s*(morning|afternoon|evening))(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e,a){var t=e[0].substr(e[1].length),s=e.index+e[1].length,n=new ParsedResult({index:s,text:t,ref:r}),i=moment(r),o=i.clone(),m=t.toLowerCase();if("tonight"==m)n.start.imply("hour",22),n.start.imply("meridiem",1);else if("tomorrow"==m||"tmr"==m)i.hour()>1&&o.add(1,"day");else if("yesterday"==m)o.add(-1,"day");else if(m.match(/last\s*night/))n.start.imply("hour",0),i.hour()>6&&o.add(-1,"day");else if(m.match("this")){var h=e[3].toLowerCase();"afternoon"==h?n.start.imply("hour",15):"evening"==h?n.start.imply("hour",18):"morning"==h&&n.start.imply("hour",6)}return n.start.assign("day",o.date()),n.start.assign("month",o.month()+1),n.start.assign("year",o.year()),n.tags.ENCasualDateParser=!0,n}};
},{"../../result":32,"../parser":23,"moment":1}],5:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(within|in)\s*([0-9]+|an?)\s*(minutes?|hours?|days?)\s*(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,a,e){var s=a.index+a[1].length,t=a[0];t=a[0].substr(a[1].length,a[0].length-a[1].length);var n=new ParsedResult({index:s,text:t,ref:r}),i=a[3];i="a"===i||"an"===i?1:parseInt(i);var u=moment(r);return a[4].match(/day/)?(u.add(i,"d"),n.start.assign("year",u.year()),n.start.assign("month",u.month()+1),n.start.assign("day",u.date()),n):(a[4].match(/hour/)?u.add(i,"hour"):a[4].match(/minute/)&&u.add(i,"minute"),n.start.imply("year",u.year()),n.start.imply("month",u.month()+1),n.start.imply("day",u.date()),n.start.assign("hour",u.hour()),n.start.assign("minute",u.minute()),n.tags.ENDeadlineFormatParser=!0,n)}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(?:within\s*)?([0-9]+|an?)\s*(minutes?|hours?|weeks?|days?|months?|years?)\s*(?:ago|before|earlier)(?=(?:\W|$))/i,STRICT_PATTERN=/(\W|^)(?:within\s*)?([0-9]+|an?)\s*(minutes?|hours?|days?)\s*ago(?=(?:\W|$))/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return this.isStrictMode()?STRICT_PATTERN:PATTERN},this.extract=function(t,a,e,r){if(e.index>0&&t[e.index-1].match(/\w/))return null;var t=e[0];t=e[0].substr(e[1].length,e[0].length-e[1].length),index=e.index+e[1].length;var s=new ParsedResult({index:index,text:t,ref:a}),n=e[2];n="a"===n||"an"===n?1:parseInt(n);var i=moment(a);return e[3].match(/hour/)||e[3].match(/minute/)?(e[3].match(/hour/)?i.add(-n,"hour"):e[3].match(/minute/)&&i.add(-n,"minute"),s.start.imply("day",i.date()),s.start.imply("month",i.month()+1),s.start.imply("year",i.year()),s.start.assign("hour",i.hour()),s.start.assign("minute",i.minute()),s.tags.ENTimeAgoFormatParser=!0,s):e[3].match(/week/)?(i.add(-n,"week"),s.start.imply("day",i.date()),s.start.imply("month",i.month()+1),s.start.imply("year",i.year()),s.start.imply("weekday",i.day()),s):(e[3].match(/day/)&&i.add(-n,"d"),e[3].match(/month/)&&i.add(-n,"month"),e[3].match(/year/)&&i.add(-n,"year"),s.start.assign("day",i.date()),s.start.assign("month",i.month()+1),s.start.assign("year",i.year()),s)}};
