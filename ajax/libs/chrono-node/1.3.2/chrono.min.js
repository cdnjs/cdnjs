...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=/(\W|^)(now|today|tonight|last\s*night|(?:tomorrow|tmr|yesterday)\s*|tomorrow|tmr|yesterday)(?=\W|$)/i;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e,s){var t=e[0].substr(e[1].length),a=e.index+e[1].length,o=new ParsedResult({index:a,text:t,ref:r}),n=moment(r),i=n.clone(),m=t.toLowerCase();return"tonight"==m?(o.start.imply("hour",22),o.start.imply("meridiem",1)):/^tomorrow|^tmr/.test(m)?n.hour()>1&&i.add(1,"day"):/^yesterday/.test(m)?i.add(-1,"day"):m.match(/last\s*night/)?(o.start.imply("hour",0),n.hour()>6&&i.add(-1,"day")):m.match("now")&&(o.start.imply("hour",n.hour()),o.start.imply("minute",n.minute()),o.start.imply("second",n.second()),o.start.imply("millisecond",n.millisecond())),o.start.assign("day",i.date()),o.start.assign("month",i.month()+1),o.start.assign("year",i.year()),o.tags.ENCasualDateParser=!0,o}};
...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/FR");require("moment/locale/fr");var PATTERN=new RegExp("(\\W|^)(?:les?|la|l'|du|des?)\\s*("+util.INTEGER_WORDS_PATTERN+"|\\d+)?\\s*(prochaine?s?|derni[eè]re?s?|pass[ée]e?s?|pr[ée]c[ée]dents?|suivante?s?)?\\s*(secondes?|min(?:ute)?s?|heures?|jours?|semaines?|mois|trimestres?|années?)\\s*(prochaine?s?|derni[eè]re?s?|pass[ée]e?s?|pr[ée]c[ée]dents?|suivante?s?)?(?=\\W|$)","i"),MULTIPLIER_GROUP=2,MODIFIER_1_GROUP=3,RELATIVE_WORD_GROUP=4,MODIFIER_2_GROUP=5;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,s,a,t){var r=a.index+a[1].length,e=a[0];e=a[0].substr(a[1].length,a[0].length-a[1].length);var n=void 0===a[MULTIPLIER_GROUP]?"1":a[MULTIPLIER_GROUP];n=void 0!==util.INTEGER_WORDS[n]?util.INTEGER_WORDS[n]:parseInt(n);var d=void 0===a[MODIFIER_1_GROUP]?void 0===a[MODIFIER_2_GROUP]?"":a[MODIFIER_2_GROUP].toLowerCase():a[MODIFIER_1_GROUP].toLowerCase();if(d){var i=new ParsedResult({index:r,text:e,ref:s});i.tags.FRRelativeDateFormatParser=!0;var o;switch(!0){case/prochaine?s?/.test(d):case/suivants?/.test(d):o=1;break;case/derni[eè]re?s?/.test(d):case/pass[ée]e?s?/.test(d):case/pr[ée]c[ée]dents?/.test(d):o=-1}var u=n*o,c=moment(s),R=moment(s);c.locale("fr"),R.locale("fr");var m,l=a[RELATIVE_WORD_GROUP];switch(!0){case/secondes?/.test(l):c.add(u,"s"),R.add(o,"s"),m="second";break;case/min(?:ute)?s?/.test(l):c.add(u,"m"),R.add(o,"m"),m="minute";break;case/heures?/.test(l):c.add(u,"h"),R.add(o,"h"),m="hour";break;case/jours?/.test(l):c.add(u,"d"),R.add(o,"d"),m="day";break;case/semaines?/.test(l):c.add(u,"w"),R.add(o,"w"),m="week";break;case/mois?/.test(l):c.add(u,"M"),R.add(o,"M"),m="month";break;case/trimestres?/.test(l):c.add(u,"Q"),R.add(o,"Q"),m="quarter";break;case/années?/.test(l):c.add(u,"y"),R.add(o,"y"),m="year"}if(o>0){var h=c;c=R,R=h}return c.startOf(m),R.endOf(m),i.start.assign("year",c.year()),i.start.assign("month",c.month()+1),i.start.assign("day",c.date()),i.start.assign("minute",c.minute()),i.start.assign("second",c.second()),i.start.assign("hour",c.hour()),i.start.assign("millisecond",c.millisecond()),i.end=i.start.clone(),i.end.assign("year",R.year()),i.end.assign("month",R.month()+1),i.end.assign("day",R.date()),i.end.assign("minute",R.minute()),i.end.assign("second",R.second()),i.end.assign("hour",R.hour()),i.end.assign("millisecond",R.millisecond()),i}}};
