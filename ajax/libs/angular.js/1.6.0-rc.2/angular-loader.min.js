/*
 ...
 License: MIT
*/
(function(){'use strict';function g(a,c){c=c||Error;return function(){var d=arguments[0],e;e="["+(a?a+":":"")+d+"] http://errors.angularjs.org/1.6.0-rc.2/"+(a?a+"/":"")+d;for(d=1;d<arguments.length;d++){e=e+(1==d?"?":"&")+"p"+(d-1)+"=";var n=encodeURIComponent,b;b=arguments[d];b="function"==typeof b?b.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof b?"undefined":"string"!=typeof b?JSON.stringify(b):b;e+=n(b)}return new c(e)}}(function(a){function c(a,b,d){return a[b]||(a[b]=d())}var d=g("$injector"),
