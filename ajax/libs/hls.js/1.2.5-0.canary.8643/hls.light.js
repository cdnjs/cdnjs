...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  function BaseStreamController(hls, fragmentTracker, logPrefix) {
    ...
    _this.decrypter = new _crypt_decrypter__WEBPACK_IMPORTED_MODULE_14__["default"](hls, hls.config);
  ...
  _proto._doFragLoad = function _doFragLoad(frag, details, targetBufferTime, progressCallback) {
    ...
    this.throwIfFragContextChanged('FRAG_LOADING'); // Load key before streaming fragment data
...
var Decrypter = /*#__PURE__*/function () {
  ...
  _proto.webCryptoDecrypt = function webCryptoDecrypt(data, key, iv) {
    ...
    return this.fastAesKey.expandKey().then(function (aesKey) {
      ...
      _utils_logger__WEBPACK_IMPORTED_MODULE_3__["logger"].warn("[decrypter.ts]: WebCrypto Error, disable WebCrypto API, " + err.name + ": " + err.message);
...
var Hls = /*#__PURE__*/function () {
  ...
  function Hls(userConfig) {
    ...
    var id3TrackController = new _controller_id3_track_controller__WEBPACK_IMPORTED_MODULE_2__["default"](this); // network controllers
    ...
    var streamController = this.streamController = new _controller_stream_controller__WEBPACK_IMPORTED_MODULE_6__["default"](this, fragmentTracker); // Cap level controller uses streamController to flush the buffer
      ...
      return new Promise(function (resolve, reject) {
        ...
        var loaderCallbacks = {
          onSuccess: function onSuccess(response, stats, context, networkDetails) {
            ...
            _this.decryptkey = frag.decryptdata.key = new Uint8Array(response.data); // detach fragment key loader on load success
