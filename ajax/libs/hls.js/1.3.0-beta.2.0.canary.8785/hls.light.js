    ...
    if (ended) {
      this.blockBuffers(function () {
        ...
        if (!mediaSource || mediaSource.readyState !== 'open') {
          if (mediaSource) {
            _utils_logger__WEBPACK_IMPORTED_MODULE_2__.logger.warn("[buffer-controller]: Could not call mediaSource.endOfStream(). mediaSource.readyState: " + mediaSource.readyState);
          }
          return;
        }
...
var Hls = /*#__PURE__*/function () {
  ...
  _createClass(Hls, [{
    ...
    key: "version",
    get: function get() {
      return "1.3.0-beta.2.0.canary.8785";
    }
  }, {
    key: "Events",
    get: function get() {
