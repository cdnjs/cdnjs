...
/* harmony import */ var _controller_audio_stream_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/cues */ "./src/empty.js");
...
var BasePlaylistController = /*#__PURE__*/function () {
  ...
  _proto.playlistLoaded = function playlistLoaded(index, data, previousDetails) {
    ...
    if (details.live || previousDetails !== null && previousDetails !== void 0 && previousDetails.live) {
      ...
      var reloadInterval = (0,_level_helper__WEBPACK_IMPORTED_MODULE_2__.computeReloadInterval)(details, distanceToLiveEdgeMs);
      if (!details.updated) {
        this.requestScheduled = -1;
...
/* harmony import */ var _loader_key_loader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../loader/key-loader */ "./src/loader/key-loader.ts");
/* harmony import */ var _crypt_decrypter__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../crypt/decrypter */ "./src/crypt/decrypter.ts");
/* harmony import */ var _utils_time_ranges__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../utils/time-ranges */ "./src/utils/time-ranges.ts");
/* harmony import */ var _types_loader__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../types/loader */ "./src/types/loader.ts");
...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  function BaseStreamController(hls, fragmentTracker, logPrefix) {
    ...
    _this.keyLoader = new _loader_key_loader__WEBPACK_IMPORTED_MODULE_13__["default"](hls.config);
    _this.fragmentTracker = fragmentTracker;
    _this.config = hls.config;
    _this.decrypter = new _crypt_decrypter__WEBPACK_IMPORTED_MODULE_14__["default"](hls.config);
  ...
  _proto.fragBufferedComplete = function fragBufferedComplete(frag, part) {
    ...
    this.log("Buffered " + frag.type + " sn: " + frag.sn + (part ? ' part: ' + part.index : '') + " of " + (this.logPrefix === '[stream-controller]' ? 'level' : 'track') + " " + frag.level + " " + (media ? _utils_time_ranges__WEBPACK_IMPORTED_MODULE_15__["default"].toString(_utils_buffer_helper__WEBPACK_IMPORTED_MODULE_3__.BufferHelper.getBuffered(media)) : '(detached)'));
    this.state = State.IDLE;
    if (!media) {
      return;
    }
    if (!this.loadedmetadata && frag.type == _types_loader__WEBPACK_IMPORTED_MODULE_16__.PlaylistLevelType.MAIN && media.buffered.length && ((_this$fragCurrent = this.fragCurrent) === null || _this$fragCurrent === void 0 ? void 0 : _this$fragCurrent.sn) === ((_this$fragPrevious = this.fragPrevious) === null || _this$fragPrevious === void 0 ? void 0 : _this$fragPrevious.sn)) {
  ...
  _proto.handleFragLoadError = function handleFragLoadError(_ref2) {
    var data = _ref2.data;
  ...
  */;
  ...
  _proto.onFragmentOrKeyLoadError = function onFragmentOrKeyLoadError(filterType, data) {
    ...
    if (this.fragLoadError + 1 <= config.fragLoadingMaxRetry) {
      ...
      if (filterType === _types_loader__WEBPACK_IMPORTED_MODULE_16__.PlaylistLevelType.AUDIO) {
...
/* harmony import */ var _controller_stream_controller__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./controller/stream-controller */ "./src/controller/stream-controller.ts");
...
var Hls = /*#__PURE__*/function () {
  Hls.isSupported = function isSupported() {
    return (0,_is_supported__WEBPACK_IMPORTED_MODULE_7__.isSupported)();
  };
  /**
  ...
  function Hls(userConfig) {
    ...
    this._emitter = new eventemitter3__WEBPACK_IMPORTED_MODULE_10__.EventEmitter();
    ...
    this._media = null;
    this.url = null;
    var config = this.config = (0,_config__WEBPACK_IMPORTED_MODULE_9__.mergeConfig)(Hls.DefaultConfig, userConfig);
    this.userConfig = userConfig;
    (0,_utils_logger__WEBPACK_IMPORTED_MODULE_8__.enableLogs)(config.debug, 'Hls instance');
    this._autoLevelCapping = -1;
    if (config.progressive) {
      (0,_config__WEBPACK_IMPORTED_MODULE_9__.enableStreamingMode)(config);
    }
    ...
    var streamController = this.streamController = new _controller_stream_controller__WEBPACK_IMPORTED_MODULE_6__["default"](this, fragmentTracker);
    ...
    this.latencyController = this.createController(_controller_latency_controller__WEBPACK_IMPORTED_MODULE_3__["default"], null, coreComponents);
  ...
  _proto.trigger = function trigger(event, eventObject) {
    if (this.config.debug) {
      ...
      try {
        ...
        this.trigger(_events__WEBPACK_IMPORTED_MODULE_11__.Events.ERROR, {
          type: _errors__WEBPACK_IMPORTED_MODULE_12__.ErrorTypes.OTHER_ERROR,
          details: _errors__WEBPACK_IMPORTED_MODULE_12__.ErrorDetails.INTERNAL_EXCEPTION,
          fatal: false,
          event: event,
          error: e
        });
  ...
  _proto.destroy = function destroy() {
    ...
    this.trigger(_events__WEBPACK_IMPORTED_MODULE_11__.Events.DESTROYING, undefined);
    this.detachMedia();
  ...
  _proto.attachMedia = function attachMedia(media) {
    ...
    this._media = media;
    this.trigger(_events__WEBPACK_IMPORTED_MODULE_11__.Events.MEDIA_ATTACHING, {
      media: media
    });
  }
  ...
  _proto.detachMedia = function detachMedia() {
    ...
    this.trigger(_events__WEBPACK_IMPORTED_MODULE_11__.Events.MEDIA_DETACHING, undefined);
    this._media = null;
  }
  ...
  _proto.loadSource = function loadSource(url) {
    ...
    _utils_logger__WEBPACK_IMPORTED_MODULE_8__.logger.log("loadSource:" + loadingSource);
    if (media && loadedSource && loadedSource !== loadingSource && this.bufferController.hasSourceTypes()) {
      this.detachMedia();
      this.attachMedia(media);
    }
    // when attaching to a source URL, trigger a playlist load
    this.trigger(_events__WEBPACK_IMPORTED_MODULE_11__.Events.MANIFEST_LOADING, {
      url: url
    });
  }
  ...
  _createClass(Hls, [{
     ...
     */,
    set: function set(newLevel) {
      _utils_logger__WEBPACK_IMPORTED_MODULE_8__.logger.log("set startLevel:" + newLevel);
    ...
    key: "version",
    get: function get() {
      return "1.2.5-0.canary.8760";
    }
  }, {
    key: "Events",
    get: function get() {
      return _events__WEBPACK_IMPORTED_MODULE_11__.Events;
    }
  }, {
    key: "ErrorTypes",
    get: function get() {
      return _errors__WEBPACK_IMPORTED_MODULE_12__.ErrorTypes;
    }
  }, {
    key: "ErrorDetails",
    get: function get() {
      return _errors__WEBPACK_IMPORTED_MODULE_12__.ErrorDetails;
    }
  }, {
    key: "DefaultConfig",
    get: function get() {
...
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../errors */ "./src/errors.ts");
/* harmony import */ var _utils_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/logger */ "./src/utils/logger.ts");
/* harmony import */ var _fragment_loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fragment-loader */ "./src/loader/fragment-loader.ts");
/*
 * Decrypt key Loader
 */
...
var KeyLoader = /*#__PURE__*/function () {
  ...
  _proto.load = function load(frag) {
    ...
    if (uri !== this.decrypturl || this.decryptkey === null) {
      var config = this.config;
      if (loader) {
        _utils_logger__WEBPACK_IMPORTED_MODULE_1__.logger.warn("abort previous key loader for type:" + type);
        loader.abort();
      }
      if (!uri) {
      ...
      var keyLoader = frag.keyLoader = this.loader = new _Loader(config);
      this.decrypturl = uri;
      this.decryptkey = null;
      return new Promise(function (resolve, reject) {
        var loaderContext = {
        ...
        var loaderCallbacks = {
          onSuccess: function onSuccess(response, stats, context, networkDetails) {
            var frag = context.frag;
            if (!frag.decryptdata) {
              _utils_logger__WEBPACK_IMPORTED_MODULE_1__.logger.error('after key load, decryptdata unset');
              return reject(new _fragment_loader__WEBPACK_IMPORTED_MODULE_2__.LoadError({
            ...
            _this.decryptkey = frag.decryptdata.key = new Uint8Array(response.data);
          ...
          onError: function onError(error, context, networkDetails) {
            _this.resetLoader(context.frag, keyLoader);
            reject(new _fragment_loader__WEBPACK_IMPORTED_MODULE_2__.LoadError({
              type: _errors__WEBPACK_IMPORTED_MODULE_0__.ErrorTypes.NETWORK_ERROR,
              details: _errors__WEBPACK_IMPORTED_MODULE_0__.ErrorDetails.KEY_LOAD_ERROR,
              fatal: false,
              frag: frag,
          ...
          onTimeout: function onTimeout(stats, context, networkDetails) {
            ...
            reject(new _fragment_loader__WEBPACK_IMPORTED_MODULE_2__.LoadError({
              type: _errors__WEBPACK_IMPORTED_MODULE_0__.ErrorTypes.NETWORK_ERROR,
              details: _errors__WEBPACK_IMPORTED_MODULE_0__.ErrorDetails.KEY_LOAD_TIMEOUT,
              fatal: false,
              frag: frag,
              networkDetails: networkDetails
            }));
