...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.4.1-0.canary.9081");
      } catch (e) {
    ...
    _proto.getLevelSwitchAction = function getLevelSwitchAction(data, levelIndex) {
      ...
      if (level) {
        ...
        if (hls.autoLevelEnabled) {
          ...
          var _ref = (_data$context3 = data.context) != null ? _data$context3 : {},
  ...
  var BasePlaylistController = /*#__PURE__*/function () {
    ...
    _proto.checkRetry = function checkRetry(errorEvent) {
      ...
      var retry = action === NetworkErrorAction.RetryRequest && !!errorAction && !!retryConfig;
      if (retry) {
