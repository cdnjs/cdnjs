...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, context, id) {
    ...
    if (typeof console === 'object' && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        newLogger.log("Debug logs enabled for \"" + context + "\" in hls.js version " + "1.6.8-0.canary.11426");
      } catch (e) {
          ...
          if (gapLength > config.maxBufferHole) {
            ...
            if (!startGap) {
              ...
              if (startProvisioned) {
                ...
                while (pos < startTime) {
                  var provisioned = fragmentTracker.getAppendedFrag(pos, PlaylistLevelType.MAIN) || fragmentTracker.getPartialFragment(pos);
                  if (provisioned) {
  ...
  var version = "1.6.8-0.canary.11426";
      ...
      if (!altAudio) {
        ...
        if (fromAltAudio) {
          ...
          hls.once(Events.BUFFER_FLUSHED, function () {
            var _this2$hls;
            (_this2$hls = _this2.hls) == null || _this2$hls.trigger(Events.AUDIO_TRACK_SWITCHED, data);
          });
