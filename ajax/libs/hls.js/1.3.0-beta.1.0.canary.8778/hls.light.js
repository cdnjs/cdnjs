...
var BasePlaylistController = /*#__PURE__*/function () {
  ...
  _proto.onError = function onError(event, data) {
    if (data.fatal && (data.type === _errors__WEBPACK_IMPORTED_MODULE_4__.ErrorTypes.NETWORK_ERROR || data.type === _errors__WEBPACK_IMPORTED_MODULE_4__.ErrorTypes.KEY_SYSTEM_ERROR)) {
      this.stopLoad();
    }
  };
  _proto.clearTimer = function clearTimer() {
...
var Hls = /*#__PURE__*/function () {
  ...
  _createClass(Hls, [{
    ...
    key: "version",
    get: function get() {
      return "1.3.0-beta.1.0.canary.8778";
    }
  }, {
    key: "Events",
    get: function get() {
  ...
  _proto.getDecryptData = function getDecryptData(sn) {
    ...
    if (keyBytes) {
      switch (this.keyFormat) {
        ...
        default:
          {
            var _keydata = keyBytes.subarray(0, 16);
            if (_keydata.length !== 16) {
              var _padded = new Uint8Array(16);
              _padded.set(_keydata, 16 - _keydata.length);
              _keydata = _padded;
            }
            this.keyId = _keydata;
            break;
    ...
    if (this.keyFormat === _utils_mediakeys_helper__WEBPACK_IMPORTED_MODULE_1__.KeySystemFormats.FAIRPLAY) {
      this.pssh = getFairPlayV3Pssh(this.keyId, this.method, this.keyFormatVersions);
    }
    return this;
  };
  return LevelKey;
...
function getFairPlayV3Pssh(keyId, method, keyFormatVersions) {
  var SchemeFourCC;
  ...
  var scheme = method === 'ISO-23001-7' ? SchemeFourCC.CENC : SchemeFourCC.CBCS;
  var FpsBoxTypes = {
    fpsd: (0,_utils_keysystem_util__WEBPACK_IMPORTED_MODULE_0__.strToUtf8array)('fpsd'),
    // Parent box containing all info
    fpsi: (0,_utils_keysystem_util__WEBPACK_IMPORTED_MODULE_0__.strToUtf8array)('fpsi'),
    // Common info
    fpsk: (0,_utils_keysystem_util__WEBPACK_IMPORTED_MODULE_0__.strToUtf8array)('fpsk'),
    // key request
    fkri: (0,_utils_keysystem_util__WEBPACK_IMPORTED_MODULE_0__.strToUtf8array)('fkri'),
    // key request info
    fkvl: (0,_utils_keysystem_util__WEBPACK_IMPORTED_MODULE_0__.strToUtf8array)('fkvl') // version list
  };

  var makeFpsKeySystemInfoBox = function makeFpsKeySystemInfoBox(scheme) {
    var schemeArray = new Uint8Array(4);
    (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.writeUint32)(schemeArray, 0, scheme);
    return (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4Box)(FpsBoxTypes.fpsi, new Uint8Array([0, 0, 0, 0]), schemeArray);
  };
  var makeFpsKeyRequestBox = function makeFpsKeyRequestBox(keyId, versionList) {
    var args = [FpsBoxTypes.fpsk, (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4Box)(FpsBoxTypes.fkri, new Uint8Array([0x00, 0x00, 0x00, 0x00]), keyId)];
    if (versionList.length) {
      // List of integers
      var versionListBuffer = new Uint8Array(4 * versionList.length);
      var pos = 0;
      for (var _iterator = _createForOfIteratorHelperLoose(versionList), _step; !(_step = _iterator()).done;) {
        var version = _step.value;
        (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.writeUint32)(versionListBuffer, pos, version);
        pos += 4;
      }
      args.push((0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4Box)(FpsBoxTypes.fkvl, versionListBuffer));
    }
    var fpsk = _utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4Box.apply(null, args);
    return fpsk;
  };
  var kFairPlayStreamingKeySystemUUID = new Uint8Array([0x94, 0xce, 0x86, 0xfb, 0x07, 0xff, 0x4f, 0x43, 0xad, 0xb8, 0x93, 0xd2, 0xfa, 0x96, 0x8c, 0xa2]);
  var data = (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4Box)(FpsBoxTypes.fpsd, makeFpsKeySystemInfoBox(scheme), makeFpsKeyRequestBox(keyId, keyFormatVersions));
  return (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.mp4pssh)(kFairPlayStreamingKeySystemUUID, null, data);
}
...
var PlaylistLoader = /*#__PURE__*/function () {
  ...
  _proto.handleSidxRequest = function handleSidxRequest(response, context) {
    ...
    sidxReferences.forEach(function (segmentRef, index) {
      ...
      if (!frag) {
        _utils_logger__WEBPACK_IMPORTED_MODULE_3__.logger.error("no fragment for sidx index " + index);
        return;
      }
          ...
          if (scheme === 'cbcs' || scheme === 'cenc') {
            ...
            if (tenc) {
              ...
              if (!tencKeyId.some(function (b) {
                ...
                _utils_logger__WEBPACK_IMPORTED_MODULE_3__.logger.log("[eme] found 'tenc' patching map with keyId default: " + _hex__WEBPACK_IMPORTED_MODULE_4__["default"].hexDump(tencKeyId) + " -> " + _hex__WEBPACK_IMPORTED_MODULE_4__["default"].hexDump(keyId));
                tenc.set(keyId, 8);
              }
            }
          }
