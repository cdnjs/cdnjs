...
declare interface FragLoadFailResult {
    type: string;
    details: string;
    fatal: boolean;
    frag: Fragment;
...
export declare const HdcpLevels: readonly ["NONE", "TYPE-0", "TYPE-1", "TYPE-2", null];
...
declare class KeyLoader implements ComponentAPI {
    ...
    detach(): void;
    destroy(): void;
    createKeyLoadError(frag: Fragment, details: ErrorDetails | undefined, message: string, networkDetails?: any): LoadError;
