...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, context, id) {
    ...
    if (typeof console === 'object' && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        newLogger.log("Debug logs enabled for \"" + context + "\" in hls.js version " + "1.6.11-0.canary.11447");
      } catch (e) {
        ...
        if (!this._decryptdata && this.levelkeys && !this.levelkeys.NONE) {
          ...
          if (key) {
            ...
            if (keyFormats.length === 1) {
              var levelKey = this._decryptdata = this.levelkeys[keyFormats[0]] || null;
              if (levelKey) {
  ...
  var version = "1.6.11-0.canary.11447";
  ...
  var KeyLoader = /*#__PURE__*/function (_Logger) {
    ...
    _proto.loadInternal = function loadInternal(frag, keySystemFormat) {
      ...
      if ((_keyInfo2 = keyInfo) != null && _keyInfo2.keyLoadPromise) {
        ...
        var keyStatus = (_keyInfo$mediaKeySess = keyInfo.mediaKeySessionContext) == null ? void 0 : _keyInfo$mediaKeySess.keyStatus;
        switch (keyStatus) {
          case 'usable':
