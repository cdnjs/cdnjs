...
function enableLogs(debugConfig, context, id) {
  ...
  if (typeof console === 'object' && debugConfig === true || typeof debugConfig === 'object') {
    ...
    try {
      newLogger.log(`Debug logs enabled for "${context}" in hls.js version ${"1.6.8-0.canary.11390"}`);
    } catch (e) {
...
const version = "1.6.8-0.canary.11390";
    ...
    if (!altAudio) {
      ...
      if (fromAltAudio) {
        ...
        hls.once(Events.BUFFER_FLUSHED, () => {
          var _this$hls;
          (_this$hls = this.hls) == null || _this$hls.trigger(Events.AUDIO_TRACK_SWITCHED, data);
        });
