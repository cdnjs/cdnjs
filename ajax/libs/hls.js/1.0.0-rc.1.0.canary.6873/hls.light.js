...
var AbrController = /*#__PURE__*/function () {
  ...
  _proto.onFragBuffered = function onFragBuffered(event, data) {
    ...
    if (frag.type !== _types_loader__WEBPACK_IMPORTED_MODULE_5__["PlaylistLevelType"].MAIN || frag.sn === 'initSegment' || frag.bitrateTest) {
      return;
  ...
  */
  ...
  _proto.getInitialLiveFragment = function getInitialLiveFragment(levelDetails, fragments) {
    ...
    if (fragPrevious) {
      ...
      var liveStart = this.hls.liveSyncPosition || levelDetails.edge - levelDetails.totalduration / 2;
      frag = this.getFragmentAtPosition(liveStart, levelDetails.edge, levelDetails);
    }
  ...
  _proto.synchronizeToLiveEdge = function synchronizeToLiveEdge(levelDetails) {
    ...
    if (liveSyncPosition !== null && media.duration > liveSyncPosition && liveSyncPosition > currentTime) {
      ...
      if (currentTime < Math.max(start - config.maxFragLookUpTolerance, end - maxLatency)) {
        if (!this.loadedmetadata) {
          ...
          if (this.state === State.PARSED) {
            _utils_logger__WEBPACK_IMPORTED_MODULE_4__["logger"].warn('Could not append media in sync with live stream');
            this.state = State.IDLE;
          }
        }
...
var BufferController = /*#__PURE__*/function () {
  ...
  _proto.flushBackBuffer = function flushBackBuffer() {
    ...
    var currentTime = media.currentTime;
    var targetBackBufferPosition = currentTime - Math.max(backBufferLength, details.levelTargetDuration);
...
var LatencyController = /*#__PURE__*/function () {
  ...
  _createClass(LatencyController, [{
    ...
    get: function get() {
      ...
      return Math.min(Math.max(edge - levelDetails.totalduration, liveEdge - targetLatency - this.edgeStalled), edge - (this.config.lowLatencyMode && levelDetails.partTarget || levelDetails.targetduration));
    }
  }, {
    key: "edgeStalled",
    get: function get() {
...
var Hls = /*#__PURE__*/function () {
  ...
  _createClass(Hls, [{
    ...
    key: "version",
    get: function get() {
      return "1.0.0-rc.1.0.canary.6873";
    }
  }, {
    key: "Events",
    get: function get() {
