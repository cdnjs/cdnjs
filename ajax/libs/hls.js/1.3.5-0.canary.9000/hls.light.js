...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  _proto.getFwdBufferInfoAtPos = function getFwdBufferInfoAtPos(bufferable, pos, type) {
    ...
    var bufferInfo = _utils_buffer_helper__WEBPACK_IMPORTED_MODULE_3__.BufferHelper.bufferInfo(bufferable, pos, maxBufferHole);
    // Workaround flaw in getting forward buffer when maxBufferHole is smaller than gap at current pos
    if (bufferInfo.len === 0 && bufferInfo.nextStart !== undefined) {
      var bufferedFragAtPos = this.fragmentTracker.getBufferedFrag(pos, type);
      if (bufferedFragAtPos && bufferInfo.nextStart < bufferedFragAtPos.end) {
        return _utils_buffer_helper__WEBPACK_IMPORTED_MODULE_3__.BufferHelper.bufferInfo(bufferable, pos, Math.max(bufferInfo.nextStart, maxBufferHole));
      }
    }
    return bufferInfo;
  };
  ...
  _proto.isLoopLoading = function isLoopLoading(frag, targetBufferTime) {
    ...
    return (trackerState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_2__.FragmentState.OK || trackerState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_2__.FragmentState.PARTIAL && !!frag.gap) && this.nextLoadPosition > targetBufferTime;
  };
  ...
  */;
  ...
  _proto.getFragmentAtPosition = function getFragmentAtPosition(bufferEnd, end, levelDetails) {
    ...
    if (frag) {
      ...
      if (fragState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_2__.FragmentState.OK || fragState === _fragment_tracker__WEBPACK_IMPORTED_MODULE_2__.FragmentState.PARTIAL && frag.gap) {
        fragPrevious = frag;
      }
  ...
  _proto.onFragmentOrKeyLoadError = function onFragmentOrKeyLoadError(filterType, data) {
    ...
    var gapTagEncountered = data.details === _errors__WEBPACK_IMPORTED_MODULE_6__.ErrorDetails.FRAG_GAP;
...
/* harmony import */ var _fragment_finders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fragment-finders */ "./src/controller/fragment-finders.ts");
...
var ErrorController = /*#__PURE__*/function () {
  function ErrorController(hls) {
    ...
    this.error = void 0;
    this.hls = hls;
    this.log = _utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger.log.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger, "[info]:");
    this.warn = _utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger.warn.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger, "[warning]:");
    this.error = _utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger.error.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_6__.logger, "[error]:");
    this.registerListeners();
  }
  ...
  _proto.unregisterListeners = function unregisterListeners() {
    ...
    hls.off(_events__WEBPACK_IMPORTED_MODULE_0__.Events.ERROR, this.onError, this);
    hls.off(_events__WEBPACK_IMPORTED_MODULE_0__.Events.ERROR, this.onErrorOut, this);
    hls.off(_events__WEBPACK_IMPORTED_MODULE_0__.Events.MANIFEST_LOADING, this.onManifestLoading, this);
  };
  _proto.destroy = function destroy() {
    this.unregisterListeners();
  ...
  _proto.onError = function onError(event, data) {
    ...
    switch (data.details) {
      ...
      case _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.KEY_LOAD_TIMEOUT:
        ...
        return;
      case _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP:
      ...
      case _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.SUBTITLE_TRACK_LOAD_TIMEOUT:
        if (context) {
          ...
          if (level && (context.type === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistContextType.AUDIO_TRACK && context.groupId === level.audioGroupId || context.type === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistContextType.SUBTITLE_TRACK && context.groupId === level.textGroupId)) {
  ...
  _proto.getFragRetryOrSwitchAction = function getFragRetryOrSwitchAction(data) {
    ...
    if (level) {
      var _data$response2;
      if (data.details !== _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP) {
        level.fragmentError++;
      }
  ...
  _proto.getLevelSwitchAction = function getLevelSwitchAction(data, levelIndex) {
    ...
    if (level) {
      ...
      if (hls.autoLevelEnabled) {
        ...
        var nextLevel = -1;
        var levels = hls.levels;
        var fragErrorType = (_data$frag = data.frag) === null || _data$frag === void 0 ? void 0 : _data$frag.type;
        ...
        for (var i = levels.length; i--;) {
          ...
          if (candidate !== hls.loadLevel && levels[candidate].loadError === 0) {
            ...
            if (data.details === _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP && data.frag) {
              var levelDetails = levels[candidate].details;
              if (levelDetails) {
                var fragCandidate = (0,_fragment_finders__WEBPACK_IMPORTED_MODULE_4__.findFragmentByPTS)(data.frag, levelDetails.fragments, data.frag.start);
                if (fragCandidate !== null && fragCandidate !== void 0 && fragCandidate.gap) {
                  continue;
                }
              }
            } else if (playlistErrorType === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistContextType.AUDIO_TRACK && playlistErrorGroupId === levelCandidate.audioGroupId || playlistErrorType === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistContextType.SUBTITLE_TRACK && playlistErrorGroupId === levelCandidate.textGroupId) {
              // For audio/subs playlist errors find another group ID or fallthrough to redundant fail-over
              continue;
            } else if (fragErrorType === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistLevelType.AUDIO && level.audioGroupId === levelCandidate.audioGroupId || fragErrorType === _types_loader__WEBPACK_IMPORTED_MODULE_2__.PlaylistLevelType.SUBTITLE && level.textGroupId === levelCandidate.textGroupId) {
  ...
  _proto.onErrorOut = function onErrorOut(event, data) {
    ...
    switch ((_data$errorAction = data.errorAction) === null || _data$errorAction === void 0 ? void 0 : _data$errorAction.action) {
      ...
      case NetworkErrorAction.SendAlternateToPenaltyBox:
        ...
        if (!data.errorAction.resolved && data.details !== _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP) {
          data.fatal = true;
        }
        break;
  ...
  _proto.sendAlternateToPenaltyBox = function sendAlternateToPenaltyBox(data) {
    ...
    switch (flags) {
      ...
      case ErrorActionFlags.MoveAllAlternatesMatchingHDCP:
        if (hdcpLevel) {
          hls.maxHdcpLevel = _types_level__WEBPACK_IMPORTED_MODULE_5__.HdcpLevels[_types_level__WEBPACK_IMPORTED_MODULE_5__.HdcpLevels.indexOf(hdcpLevel) - 1];
          errorAction.resolved = true;
        }
...
function checkExpired(penalizedRendition, data, currentPenaltyState) {
  ...
  if (data.details === _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP && lastErrorDetails && data.frag) {
    var position = data.frag.start;
    var candidateFrag = (0,_fragment_finders__WEBPACK_IMPORTED_MODULE_4__.findFragmentByPTS)(null, lastErrorDetails.fragments, position);
...
function isPartial(fragmentEntity) {
  ...
  return fragmentEntity.buffered && (fragmentEntity.body.gap || ((_fragmentEntity$range = fragmentEntity.range.video) === null || _fragmentEntity$range === void 0 ? void 0 : _fragmentEntity$range.partial) || ((_fragmentEntity$range2 = fragmentEntity.range.audio) === null || _fragmentEntity$range2 === void 0 ? void 0 : _fragmentEntity$range2.partial));
}
...
var LatencyController = /*#__PURE__*/function () {
  ...
  _proto.onError = function onError(event, data) {
    ...
    this.stallCount++;
    if ((_this$levelDetails = this.levelDetails) !== null && _this$levelDetails !== void 0 && _this$levelDetails.live) {
...
var StreamController = /*#__PURE__*/function (_BaseStreamController) {
  ...
  _proto.doTickIdle = function doTickIdle() {
    ...
    if (frag && this.isLoopLoading(frag, targetBufferTime)) {
      ...
      frag = this.getNextFragmentLoopLoading(frag, levelDetails, bufferInfo, _types_loader__WEBPACK_IMPORTED_MODULE_6__.PlaylistLevelType.MAIN, maxBufLen);
    }
    if (!frag) {
      return;
    }
  ...
  */;
  ...
  _proto.onError = function onError(event, data) {
    ...
    switch (data.details) {
      case _errors__WEBPACK_IMPORTED_MODULE_11__.ErrorDetails.FRAG_GAP:
...
function createGapLoadError(frag, part) {
  ...
  var errorData = {
    type: _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorTypes.MEDIA_ERROR,
    details: _errors__WEBPACK_IMPORTED_MODULE_1__.ErrorDetails.FRAG_GAP,
    fatal: false,
    frag: frag,
    error: error,
    networkDetails: null
...
var Level = /*#__PURE__*/function () {
  ...
  _createClass(Level, [{
    ...
    get: function get() {
      ...
      return (_this$audioGroupIds = this.audioGroupIds) === null || _this$audioGroupIds === void 0 ? void 0 : _this$audioGroupIds[this.urlId];
    }
  }, {
    key: "textGroupId",
    get: function get() {
      var _this$textGroupIds;
      return (_this$textGroupIds = this.textGroupIds) === null || _this$textGroupIds === void 0 ? void 0 : _this$textGroupIds[this.urlId];
    }
  }]);
  return Level;
}();
