...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.4.11-0.canary.9437");
      } catch (e) {
  ...
  var AbrController = /*#__PURE__*/function () {
    ...
    _proto.getBwEstimate = function getBwEstimate() {
      return this.bwEstimator ? this.bwEstimator.getEstimate() : this.hls.config.abrEwmaDefaultEstimate;
    };
  ...
  var BufferController = /*#__PURE__*/function () {
    ...
    _proto.onMediaAttaching = function onMediaAttaching(event, data) {
      ...
      if (media && MediaSource$1) {
        var ms = this.mediaSource = new MediaSource$1();
