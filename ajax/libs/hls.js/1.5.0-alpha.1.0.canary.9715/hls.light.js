...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.5.0-alpha.1.0.canary.9715");
      } catch (e) {
  ...
  var Level = /*#__PURE__*/function () {
    ...
    _proto2.addGroupId = function addGroupId(type, groupId, fallbackIndex) {
      if (!groupId) {
        return;
      }
      var lastIndex = this.url.length - 1;
      if (type === 'audio') {
        var audioGroupsByUrlId = this._audioGroups;
        ...
        var subtitleGroupsByUrlId = this._subtitleGroups;
    ...
    _createClass(Level, [{
      ...
      key: "audioGroups",
      get: function get() {
        var _this$_audioGroups;
        return (_this$_audioGroups = this._audioGroups) == null ? void 0 : _this$_audioGroups[this.urlId];
      }
    }, {
      key: "subtitleGroups",
      get: function get() {
        var _this$_subtitleGroups;
        return (_this$_subtitleGroups = this._subtitleGroups) == null ? void 0 : _this$_subtitleGroups[this.urlId];
      }
    }]);
    return Level;
  }();
  ...
  var BufferController = /*#__PURE__*/function () {
    ...
    _proto.onBufferCodecs = function onBufferCodecs(event, data) {
      ...
      if (this.bufferCodecEventsExpected !== bufferCodecEventsExpected) {
        ...
        this.bufferCodecEventsExpected = this._bufferCodecEventsTotal = bufferCodecEventsExpected;
      }
  ...
  var LevelController = /*#__PURE__*/function (_BasePlaylistControll) {
    ...
    _proto.onManifestLoaded = function onManifestLoaded(event, data) {
      ...
      data.levels.forEach(function (levelParsed) {
        ...
        } else if ((fallbackIndex = levelFromSet.url.indexOf(levelParsed.url)) === -1) {
  ...
  var Hls = /*#__PURE__*/function () {
    ...
    _createClass(Hls, [{
       ...
       */
      function get() {
        return "1.5.0-alpha.1.0.canary.9715";
      }
    }, {
      key: "Events",
      get: function get() {
