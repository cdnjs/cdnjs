...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.4.0-beta.2.0.canary.9031");
      } catch (e) {
  ...
  var ErrorController = /*#__PURE__*/function () {
    ...
    _proto.redundantFailover = function redundantFailover(data) {
      ...
      var _loop = function _loop(i) {
        var newUrlId = (level.urlId + i) % redundantLevels;
  ...
  var Hls = /*#__PURE__*/function () {
    ...
    _createClass(Hls, [{
       ...
       */
      function get() {
        return "1.4.0-beta.2.0.canary.9031";
      }
    }, {
      key: "Events",
      get: function get() {
