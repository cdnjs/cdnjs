...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.4.2-0.canary.9145");
      } catch (e) {
  ...
  var FragmentTracker = /*#__PURE__*/function () {
    ...
    _proto.detectEvictedFragments = function detectEvictedFragments(elementaryStream, timeRange, playlistType, appendedPart) {
      ...
      var appendedPartSn = (appendedPart == null ? void 0 : appendedPart.fragment.sn) || 0;
