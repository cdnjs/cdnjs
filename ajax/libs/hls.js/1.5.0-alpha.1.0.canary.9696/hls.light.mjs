...
function enableLogs(debugConfig, id) {
  ...
  if (self.console && debugConfig === true || typeof debugConfig === 'object') {
    ...
    try {
      exportedLogger.log(`Debug logs enabled for "${id}" in hls.js version ${"1.5.0-alpha.1.0.canary.9696"}`);
    } catch (e) {
...
class Level {
  ...
  addGroupId(type, groupId, fallbackIndex) {
    if (!groupId) {
      return;
    }
...
class Hls {
   ...
   */
  static get version() {
    return "1.5.0-alpha.1.0.canary.9696";
  }
