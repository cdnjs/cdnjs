...
var BasePlaylistController = /*#__PURE__*/function () {
  ...
  _proto.playlistLoaded = function playlistLoaded(index, data, previousDetails) {
    ...
    if (details.live || previousDetails !== null && previousDetails !== void 0 && previousDetails.live) {
      ...
      var reloadInterval = Object(_level_helper__WEBPACK_IMPORTED_MODULE_2__["computeReloadInterval"])(details, distanceToLiveEdgeMs);
      if (!details.updated) {
        this.requestScheduled = -1;
...
var SampleAesDecrypter = /*#__PURE__*/function () {
  ...
  _proto.decryptAvcSample = function decryptAvcSample(samples, sampleIndex, unitIndex, callback, curUnit) {
    var _this2 = this;
    var decodedData = Object(_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_1__["discardEPB"])(curUnit.data);
        ...
        case 6:
          {
            ...
            Object(_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_5__["parseSEIMessageFromNALu"])(unit.data, 1, pes.pts, textTrack.samples);
            break;
            // SPS
          }
...
function alignMediaPlaylistByPDT(details, refDetails) {
  ...
  var delta = refPDT - refStart * 1000;
...
/*!********************************!*\
  !*** ./src/utils/mp4-tools.ts ***!
  \********************************/
/*! exports provided: RemuxerTrackIdConfig, bin2str, readUint16, readUint32, readSint32, writeUint32, findBox, parseSegmentIndex, parseInitSegment, getStartDTS, getDuration, computeRawDurationFromSamples, offsetStartDTS, segmentValidRange, appendUint8Array, parseSamples, parseSEIMessageFromNALu, discardEPB, parseEmsg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
