...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (self.console && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.4.11-0.canary.9504");
      } catch (e) {
      ...
      case 'hev1':
        {
          ...
          for (var i = constraintIndicator.length; i--;) {
            var _byte = constraintIndicator[i];
  ...
  var ErrorController = /*#__PURE__*/function () {
    ...
    _proto.redundantFailover = function redundantFailover(data) {
      ...
      var levelIndex = data.parent === PlaylistLevelType.MAIN ? data.level || 0 : hls.loadLevel;
  ...
  function getAudioTracksByGroup(allAudioTracks) {
    return allAudioTracks.reduce(function (audioTracksByGroup, track) {
      ...
      var channelsKey = track.attrs.CHANNELS || '2';
  ...
  function getCodecTiers(levels, audioTracksByGroup, minAutoLevel, maxAutoLevel) {
    return levels.slice(minAutoLevel, maxAutoLevel + 1).reduce(function (tiers, level) {
      ...
      var audioGroup = level.audioGroupId ? audioTracksByGroup.groups[level.audioGroupId] : null;
  ...
  var AbrController = /*#__PURE__*/function () {
    ...
    _proto.findBestLevel = function findBestLevel(currentBw, minAutoLevel, maxAutoLevel, bufferStarvationDelay, maxStarvationDelay, bwFactor, bwUpFactor) {
      ...
      if (firstSelection) {
        ...
        var _getStartCodecTier = getStartCodecTier(codecTiers, currentVideoRange, currentBw),
          codecSet = _getStartCodecTier.codecSet,
          videoRange = _getStartCodecTier.videoRange,
          minFramerate = _getStartCodecTier.minFramerate,
          minBitrate = _getStartCodecTier.minBitrate;
      ...
      var _loop = function _loop(i) {
          ...
          var fetchDuration = _this.getTimeToLoadFrag(ttfbEstimateSec, adjustedbw, bitrate * avgDuration, levelDetails === undefined);
          ...
          fetchDuration <= ttfbEstimateSec || !isFiniteNumber(fetchDuration) || live && !_this.bitrateTestDelay || fetchDuration < maxFetchDuration);
    ...
    _createClass(AbrController, [{
      ...
      get: function get() {
        ...
        var abrAutoLevel = this.findBestLevel(this.getBwEstimate(), minAutoLevel, maxAutoLevel, 0, maxStartDelay, 1, 1);
        if (abrAutoLevel > -1) {
          return abrAutoLevel;
        }
    ...
    _proto.appendChangeType = function appendChangeType(type, mimeType) {
      ...
      var operation = {
        ...
        onError: function onError(e) {
          _this4.warn("Failed to change " + type + " SourceBuffer type", e);
        }
      };
      ...
      var _loop = function _loop(trackName) {
        if (!sourceBuffer[trackName]) {
          ...
          try {
            ...
            _this11.addBufferListener(sbName, 'bufferedchange', function (event) {
  ...
  var LevelController = /*#__PURE__*/function (_BasePlaylistControll) {
    ...
    _proto.onManifestLoaded = function onManifestLoaded(event, data) {
      ...
      data.levels.forEach(function (levelParsed) {
        ...
        if (levelParsed.audioCodec) {
          levelParsed.audioCodec = getCodecCompatibleName(levelParsed.audioCodec, _this2.hls.config.preferManagedMediaSource);
        }
    ...
    _proto.filterAndSortMediaOptions = function filterAndSortMediaOptions(unfilteredLevels, data) {
        ...
        Promise.resolve().then(function () {
          if (_this3.hls) {
            if (unfilteredLevels.length) {
              _this3.warn("One or more CODECS in variant not supported: " + JSON.stringify(unfilteredLevels[0].attrs));
            }
      ...
      levels.sort(function (a, b) {
        ...
        if (a.codecSet !== b.codecSet) {
          var valueA = codecsSetSelectionPreferenceValue(a.codecSet);
          var valueB = codecsSetSelectionPreferenceValue(b.codecSet);
          if (valueA !== valueB) {
    ...
    ;
    _proto.onFragBuffered = function onFragBuffered(event, _ref3) {
      var frag = _ref3.frag;
  ...
  var MP4Remuxer = /*#__PURE__*/function () {
    ...
    _proto.remuxVideo = function remuxVideo(track, timeOffset, contiguous, audioTrackLength) {
      ...
      for (var _i = 0; _i < nbSamples; _i++) {
        ...
        _sample.dts = _sample.dts < dtsStep ? dtsStep++ : _sample.dts;
      ...
      for (var _i2 = 0; _i2 < nbSamples; _i2++) {
        var _VideoSample = inputSamples[_i2];
        ...
        var ptsDelta = void 0;
        if (_i2 < nbSamples - 1) {
          mp4SampleDuration = inputSamples[_i2 + 1].dts - _VideoSample.dts;
          ptsDelta = inputSamples[_i2 + 1].pts - _VideoSample.pts;
        } else {
          var config = this.config;
          var lastFrameDuration = _i2 > 0 ? _VideoSample.dts - inputSamples[_i2 - 1].dts : averageSampleDuration;
          ptsDelta = _i2 > 0 ? _VideoSample.pts - inputSamples[_i2 - 1].pts : averageSampleDuration;
