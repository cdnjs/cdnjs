...
/* harmony import */ var _utils_xhr_loader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/xhr-loader */ "./src/utils/xhr-loader.ts");
/* harmony import */ var _utils_fetch_loader__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/fetch-loader */ "./src/utils/fetch-loader.ts");
...
var hlsDefaultConfig = _objectSpread(_objectSpread({
  ...
  // used by buffer-controller
  loader: _utils_xhr_loader__WEBPACK_IMPORTED_MODULE_6__["default"],
  // loader: FetchLoader,
  fLoader: undefined,
  // used by fragment-loader
  pLoader: undefined,
...
function enableStreamingMode(config) {
  ...
  if (currentLoader !== _utils_fetch_loader__WEBPACK_IMPORTED_MODULE_7__["default"] && currentLoader !== _utils_xhr_loader__WEBPACK_IMPORTED_MODULE_6__["default"]) {
    ...
    var canStreamProgressively = (0,_utils_fetch_loader__WEBPACK_IMPORTED_MODULE_7__.fetchSupported)();
    if (canStreamProgressively) {
      config.loader = _utils_fetch_loader__WEBPACK_IMPORTED_MODULE_7__["default"];
  ...
  _proto.findBestLevel = function findBestLevel(currentBw, minAutoLevel, maxAutoLevel, maxFetchDuration, bwFactor, bwUpFactor) {
    ...
    for (var i = maxAutoLevel; i >= minAutoLevel; i--) {
      ...
      if (levelSkippedMax !== -1) {
        _utils_logger__WEBPACK_IMPORTED_MODULE_5__.logger.trace("[abr] Skipped level(s) " + levelSkippedMin + "-" + levelSkippedMax + " with CODECS:\"" + levels[levelSkippedMax].attrs.CODECS + "\"; not compatible with \"" + level.attrs.CODECS + "\"");
      }
...
/* harmony import */ var _level_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./level-controller */ "./src/controller/level-controller.ts");
function _extends() { _extends = Object.assign ? Object.assign.bind() : function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var ContentSteeringController = /*#__PURE__*/function () {
  function ContentSteeringController(hls) {
    ...
    this.hls = hls;
    this.log = _utils_logger__WEBPACK_IMPORTED_MODULE_3__.logger.log.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_3__.logger, "[content-steering]:");
    this.registerListeners();
  }
  ...
  _proto.startLoad = function startLoad() {
    ...
    if (this.enabled && this.uri) {
      if (this.updated) {
        var ttl = Math.max(this.timeToLoad * 1000 - (Date.now() - this.updated), 0);
  ...
  _proto.clonePathways = function clonePathways(pathwayClones) {
    ...
    pathwayClones.forEach(function (pathwayClone) {
      ...
      var clonedVariants = _this.getLevelsForPathway(baseId).map(function (baseLevel) {
        ...
        (0,_level_controller__WEBPACK_IMPORTED_MODULE_4__.addGroupId)(clonedLevel, 'audio', clonedAudioGroupId);
        (0,_level_controller__WEBPACK_IMPORTED_MODULE_4__.addGroupId)(clonedLevel, 'text', clonedSubtitleGroupId);
        return clonedLevel;
      });
...
var LevelController = /*#__PURE__*/function (_BasePlaylistControll) {
  ...
  _proto.filterAndSortMediaOptions = function filterAndSortMediaOptions(levels, data) {
    var audioTracks = [];
    var subtitleTracks = [];
  ...
  _proto.onError = function onError(event, data) {
    ...
    if (context && level && (context.type === _types_loader__WEBPACK_IMPORTED_MODULE_5__.PlaylistContextType.AUDIO_TRACK && level.audioGroupIds && context.groupId === level.audioGroupIds[level.urlId] || context.type === _types_loader__WEBPACK_IMPORTED_MODULE_5__.PlaylistContextType.SUBTITLE_TRACK && level.textGroupIds && context.groupId === level.textGroupIds[level.urlId])) {
    ...
    switch (data.details) {
      ...
      case _errors__WEBPACK_IMPORTED_MODULE_2__.ErrorDetails.KEY_LOAD_TIMEOUT:
        if (data.frag) {
          ...
          var variantLevelIndex = data.frag.type === _types_loader__WEBPACK_IMPORTED_MODULE_5__.PlaylistLevelType.MAIN ? data.frag.level : this.currentLevelIndex;
      ...
      case _errors__WEBPACK_IMPORTED_MODULE_2__.ErrorDetails.KEY_SYSTEM_NO_SESSION:
        levelIndex = ((_data$frag = data.frag) === null || _data$frag === void 0 ? void 0 : _data$frag.type) === _types_loader__WEBPACK_IMPORTED_MODULE_5__.PlaylistLevelType.MAIN ? data.frag.level : this.currentLevelIndex;
  ...
  _proto.redundantFailover = function redundantFailover(levelIndex) {
    ...
    if (redundantLevels > 1) {
      ...
      this._levels.forEach(function (lv) {
        lv.urlId = newUrlId;
      });
  ...
  _proto.removeLevel = function removeLevel(levelIndex, urlId) {
    ...
    var levels = this._levels.filter(function (level, index) {
      ...
      if (_this2.steering) {
        _this2.steering.removeLevel(level);
      }
      return false;
    });
...
var MP4Remuxer = /*#__PURE__*/function () {
  ...
  _proto.generateIS = function generateIS(audioTrack, videoTrack, timeOffset) {
    ...
    var tracks = {};
    var computePTSDTS = !this._initPTS;
...
var PassThroughRemuxer = /*#__PURE__*/function () {
  ...
  _proto.remux = function remux(audioTrack, videoTrack, id3Track, textTrack, timeOffset) {
    ...
    var startTime = audioTrack ? startDTS - initPTS.baseTime : lastEndTime;
    var endTime = startTime + duration;
    (0,_utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__.offsetStartDTS)(initData, data, initPTS.baseTime);
    if (duration > 0) {
