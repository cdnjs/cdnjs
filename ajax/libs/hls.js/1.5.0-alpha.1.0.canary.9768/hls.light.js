...
(function (global, factory) {
  ...
  function enableLogs(debugConfig, id) {
    ...
    if (typeof console === 'object' && debugConfig === true || typeof debugConfig === 'object') {
      ...
      try {
        exportedLogger.log("Debug logs enabled for \"" + id + "\" in hls.js version " + "1.5.0-alpha.1.0.canary.9768");
      } catch (e) {
  ...
  function getStartCodecTier(codecTiers, videoRange, currentBw, audioPreference) {
  ...
  var AbrController = /*#__PURE__*/function () {
    ...
    _proto.findBestLevel = function findBestLevel(currentBw, minAutoLevel, maxAutoLevel, bufferStarvationDelay, maxStarvationDelay, bwFactor, bwUpFactor) {
      ...
      if (firstSelection) {
        ...
        var startTier = getStartCodecTier(codecTiers, currentVideoRange, currentBw, audioPreference);
        var codecSet = startTier.codecSet,
          videoRange = startTier.videoRange,
  ...
  var Hls = /*#__PURE__*/function () {
    ...
    _createClass(Hls, [{
       ...
       */
      function get() {
        return "1.5.0-alpha.1.0.canary.9768";
      }
    }, {
      key: "Events",
      get: function get() {
