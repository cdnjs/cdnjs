...
/* harmony import */ var _error_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./error-controller */ "./src/controller/error-controller.ts");
/* harmony import */ var _utils_logger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/logger */ "./src/utils/logger.ts");
...
var BasePlaylistController = /*#__PURE__*/function () {
  function BasePlaylistController(hls, logPrefix) {
    ...
    this.log = void 0;
    this.warn = void 0;
    this.log = _utils_logger__WEBPACK_IMPORTED_MODULE_4__.logger.log.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_4__.logger, logPrefix + ":");
    this.warn = _utils_logger__WEBPACK_IMPORTED_MODULE_4__.logger.warn.bind(_utils_logger__WEBPACK_IMPORTED_MODULE_4__.logger, logPrefix + ":");
    this.hls = hls;
  }
    ...
    if (renditionReports) {
      ...
      for (var i = 0; i < renditionReports.length; i++) {
        ...
        try {
          ...
          _utils_logger__WEBPACK_IMPORTED_MODULE_4__.logger.warn("Could not construct new URL for Rendition Report: " + error);
          uri = attr.URI || '';
        }
  ...
  _proto.checkRetry = function checkRetry(errorEvent) {
    ...
    var isTimeout = (0,_utils_error_helper__WEBPACK_IMPORTED_MODULE_2__.isTimeoutError)(errorEvent);
    ...
    var retry = action === _error_controller__WEBPACK_IMPORTED_MODULE_3__.NetworkErrorAction.RetryRequest && !!errorAction && !!retryConfig;
    if (retry) {
      ...
      if (isTimeout && (_errorEvent$context = errorEvent.context) !== null && _errorEvent$context !== void 0 && _errorEvent$context.deliveryDirectives) {
        ...
        var delay = (0,_utils_error_helper__WEBPACK_IMPORTED_MODULE_2__.getRetryDelay)(retryConfig, retryCount);
...
/* harmony import */ var _error_controller__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./error-controller */ "./src/controller/error-controller.ts");
...
var BaseStreamController = /*#__PURE__*/function (_TaskLoop) {
  ...
  */;
  ...
  _proto.onFragmentOrKeyLoadError = function onFragmentOrKeyLoadError(filterType, data) {
    ...
    if (errorAction && action === _error_controller__WEBPACK_IMPORTED_MODULE_17__.NetworkErrorAction.RetryRequest && retryConfig) {
      if (!this.loadedmetadata) {
...
/* harmony import */ var _error_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./error-controller */ "./src/controller/error-controller.ts");
...
var ContentSteeringController = /*#__PURE__*/function () {
  ...
  _proto.onError = function onError(event, data) {
    var errorAction = data.errorAction;
    if ((errorAction === null || errorAction === void 0 ? void 0 : errorAction.action) === _error_controller__WEBPACK_IMPORTED_MODULE_4__.NetworkErrorAction.SendAlternateToPenaltyBox && errorAction.flags === _error_controller__WEBPACK_IMPORTED_MODULE_4__.ErrorActionFlags.MoveAllAlternatesMatchingHost) {
  ...
  _proto.onLevelUpdated = function onLevelUpdated(event, _ref2) {
    ...
    var _loop2 = function _loop2(_i) {
      ...
      for (var j = 0; j < attributes.length; j++) {
        ...
        if (!(0,_loader_date_range__WEBPACK_IMPORTED_MODULE_4__.isDateRangeCueAttribute)(key)) {
          continue;
        }
        var cue = cues[key];
        if (cue) {
          ...
          if ((0,_loader_date_range__WEBPACK_IMPORTED_MODULE_4__.isSCTE35Attribute)(key)) {
  ...
  _proto.onError = function onError(event, data) {
    ...
    switch (data.details) {
      ...
      case _errors__WEBPACK_IMPORTED_MODULE_11__.ErrorDetails.BUFFER_FULL_ERROR:
        ...
        break;
      case _errors__WEBPACK_IMPORTED_MODULE_11__.ErrorDetails.INTERNAL_EXCEPTION:
...
var TransmuxerInterface = /*#__PURE__*/function () {
  ...
  _proto.resetWorker = function resetWorker() {
    ...
    if (worker) {
      if (worker !== null && worker !== void 0 && worker.objectURL) {
...
/* harmony export */   "isDateRangeCueAttribute": () => (/* binding */ isDateRangeCueAttribute),
/* harmony export */   "isSCTE35Attribute": () => (/* binding */ isSCTE35Attribute)
/* harmony export */ });
/* harmony import */ var _home_runner_work_hls_js_hls_js_src_polyfills_number__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/polyfills/number */ "./src/polyfills/number.ts");
...
/* harmony import */ var _utils_mediakeys_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/mediakeys-helper */ "./src/empty.js");
/* harmony import */ var _utils_mediakeys_helper__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_utils_mediakeys_helper__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _utils_mp4_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/mp4-tools */ "./src/utils/mp4-tools.ts");
/* harmony import */ var _utils_logger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/logger */ "./src/utils/logger.ts");
...
/* harmony import */ var _utils_variable_substitution__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/variable-substitution */ "./src/empty.js");
/* harmony import */ var _utils_variable_substitution__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_utils_variable_substitution__WEBPACK_IMPORTED_MODULE_8__);
