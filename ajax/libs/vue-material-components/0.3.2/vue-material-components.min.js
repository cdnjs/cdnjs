...
c.set(this.options,r.value,r)}},e.prototype.ready=function(){this.refreshDropdownOptions()},e.prototype.createOption=function(e){var t=e.content,n=e.value,r=e.disabled
...
return this.moveIndicator(this.indicator.left,t.offsetLeft,this.indicator.right,n.offsetWidth-t.offsetLeft-t.offsetWidth),!0},e.prototype.resizeIndicator=function(){if(this.activeTab){var e=this.$els.indicator,t=this.activeTab.index,n=this.activeTab.$el,r=n.parentElement,i=r.offsetWidth,o=Math.max(i,r.scrollWidth)/this.tabsCount
