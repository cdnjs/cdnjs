 ...
 * 
 * — fixed #18, select[multiple] now allows to uncheck last elt
 * — fixed #19, dynamically disabled ctrls are not stuck to disabled state
 * — slight speedup of change handlers, removed unnecessery DOM traversal
 *
