...
angular.module("lumx.progress").run(['$templateCache', function(a) { a.put('progress.html', '<div class="progress-container progress-container--{{ vm.lxType }} progress-container--{{ vm.lxColor }}"\n' +
    '     ng-style="vm.getProgressDiameter()">\n' +
    '    <div class="progress-circular-wrapper" ng-if="vm.lxType === \'circular\'">\n' +
    ...
    '    </div>\n' +
    '\n' +
    '    <div class="progress-linear-wrapper" ng-if="vm.lxType === \'linear\'">\n' +
...
angular.module("lumx.checkbox").run(['$templateCache', function(a) { a.put('checkbox.html', '<div class="checkbox checkbox--{{ vm.lxColor }}">\n' +
    '    <input id="{{ vm.getCheckboxId() }}"\n' +
    '           type="checkbox"\n' +
    '           class="checkbox__input"\n' +
    '           name="{{ vm.name }}"\n' +
    '           ng-model="vm.ngModel"\n' +
    '           ng-true-value="{{ vm.ngTrueValue }}"\n' +
    '           ng-false-value="{{ vm.ngFalseValue }}"\n' +
    '           ng-change="vm.ngChange()"\n' +
    '           ng-disabled="vm.ngDisabled">\n' +
    '\n' +
    '    <label for="{{ vm.getCheckboxId() }}" class="checkbox__label" ng-transclude ng-if="!vm.getCheckboxHasChildren()"></label>\n' +
    '    <ng-transclude-replace ng-if="vm.getCheckboxHasChildren()"></ng-transclude-replace>\n' +
    '</div>\n' +
    '');
	a.put('checkbox-label.html', '<label for="{{ vm.getCheckboxId() }}" class="checkbox__label" ng-transclude></label>\n' +
    '');
...
angular.module("lumx.radio-button").run(['$templateCache', function(a) { a.put('radio-group.html', '<div class="radio-group" ng-transclude></div>\n' +
    '');
	a.put('radio-button.html', '<div class="radio-button radio-button--{{ vm.lxColor }}">\n' +
    '    <input id="{{ vm.getRadioButtonId() }}"\n' +
    '           type="radio"\n' +
    ...
    '           ng-disabled="vm.ngDisabled">\n' +
    '\n' +
    '    <label for="{{ vm.getRadioButtonId() }}" class="radio-button__label" ng-transclude ng-if="!vm.getRadioButtonHasChildren()"></label>\n' +
    '    <ng-transclude-replace ng-if="vm.getRadioButtonHasChildren()"></ng-transclude-replace>\n' +
    '</div>\n' +
    '');
	a.put('radio-button-label.html', '<label for="{{ vm.getRadioButtonId() }}" class="radio-button__label" ng-transclude></label>\n' +
    '');
	a.put('radio-button-help.html', '<span class="radio-button__help" ng-transclude></span>\n' +
    '');
	 }]);
angular.module("lumx.switch").run(['$templateCache', function(a) { a.put('switch_label.html', '<label for="{{ vm.getSwitchId() }}" class="switch__label" ng-transclude></label>\n' +
    '');
	a.put('switch_help.html', '<span class="switch__help" ng-transclude></span>\n' +
    '');
	a.put('switch.html', '<div class="switch switch--{{ vm.lxColor }}">\n' +
    '    <input id="{{ vm.getSwitchId() }}"\n' +
    '           type="checkbox"\n' +
    '           class="switch__input"\n' +
    '           name="{{ vm.name }}"\n' +
    '           ng-model="vm.ngModel"\n' +
    ...
    '           ng-disabled="vm.ngDisabled">\n' +
    '\n' +
    '    <label for="{{ vm.getSwitchId() }}" class="switch__label" ng-transclude ng-if="!vm.getSwitchHasChildren()"></label>\n' +
    '    <ng-transclude-replace ng-if="vm.getSwitchHasChildren()"></ng-transclude-replace>\n' +
    '</div>\n' +
    '');
	 }]);
angular.module("lumx.fab").run(['$templateCache', function(a) { a.put('fab.html', '<div class="fab">\n' +
    ...
    '                 lx-type="circular" lx-color="{{ vm.lxFabProgressColor }}" lx-diameter="64"\n' +
    '                 ng-if="vm.lxFabProgress"></lx-progress>\n' +
    '</div>\n' +
    '');
