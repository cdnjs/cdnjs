(function (global, factory) {
    ...
    PickListModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: PickListModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    PickListModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: PickListModule, declarations: [PickList], imports: [i3.CommonModule, i4.ButtonModule, i1.SharedModule, i5.RippleModule, i2.DragDropModule], exports: [PickList, i1.SharedModule, i2.DragDropModule] });
    PickListModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: PickListModule, imports: [[i3.CommonModule, i4.ButtonModule, i1.SharedModule, i5.RippleModule, i2.DragDropModule], i1.SharedModule, i2.DragDropModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: PickListModule, decorators: [{
                type: i0.NgModule,
                args: [{
