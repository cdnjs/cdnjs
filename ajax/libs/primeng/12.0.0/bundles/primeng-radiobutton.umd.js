(function (global, factory) {
    ...
    RadioControlRegistry.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioControlRegistry, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    RadioControlRegistry.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioControlRegistry, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioControlRegistry, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root',
                    }]
    ...
    RadioButtonModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioButtonModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    RadioButtonModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioButtonModule, declarations: [RadioButton], imports: [i1.CommonModule], exports: [RadioButton] });
    RadioButtonModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioButtonModule, imports: [[i1.CommonModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: RadioButtonModule, decorators: [{
                type: i0.NgModule,
                args: [{
