(function (global, factory) {
    ...
    EditorModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: EditorModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    EditorModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: EditorModule, declarations: [Editor], imports: [i1.CommonModule], exports: [Editor, api.SharedModule] });
    EditorModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: EditorModule, imports: [[i1.CommonModule], api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.4", ngImport: i0__namespace, type: EditorModule, decorators: [{
                type: i0.NgModule,
                args: [{
