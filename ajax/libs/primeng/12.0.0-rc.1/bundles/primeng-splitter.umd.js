(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Splitter = /** @class */ (function () {
        ...
        Splitter.prototype.ngAfterViewInit = function () {
            ...
            if (this.panels && this.panels.length) {
                ...
                if (!initialized) {
                    var children_1 = __spreadArray([], __read(this.el.nativeElement.children[0].children)).filter(function (child) { return dom.DomHandler.hasClass(child, 'p-splitter-panel'); });
                    var _panelSizes_1 = [];
        ...
        Splitter.prototype.restoreState = function () {
            ...
            if (stateString) {
                ...
                var children = __spreadArray([], __read(this.containerViewChild.nativeElement.children)).filter(function (child) { return dom.DomHandler.hasClass(child, 'p-splitter-panel'); });
    ...
    SplitterModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: SplitterModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    SplitterModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: SplitterModule, declarations: [Splitter], imports: [i1.CommonModule], exports: [Splitter, api.SharedModule] });
    SplitterModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: SplitterModule, imports: [[i1.CommonModule], api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: SplitterModule, decorators: [{
                type: i0.NgModule,
                args: [{
