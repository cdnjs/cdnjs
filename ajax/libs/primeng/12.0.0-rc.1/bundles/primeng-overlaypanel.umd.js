(function (global, factory) {
...
}(this, (function (exports, i0, i1, dom, api, i2, animations) { 'use strict';
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: OverlayPanel, decorators: [{
                type: i0.Component,
                args: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.Renderer2 }, { type: i0__namespace.ChangeDetectorRef }, { type: i0__namespace.NgZone }]; }, propDecorators: { dismissable: [{
                    type: i0.Input
                }], showCloseIcon: [{
                    type: i0.Input
                }], style: [{
    ...
    OverlayPanelModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: OverlayPanelModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    OverlayPanelModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: OverlayPanelModule, declarations: [OverlayPanel], imports: [i1.CommonModule, i2.RippleModule, api.SharedModule], exports: [OverlayPanel, api.SharedModule] });
    OverlayPanelModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: OverlayPanelModule, imports: [[i1.CommonModule, i2.RippleModule, api.SharedModule], api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: OverlayPanelModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i2.RippleModule, api.SharedModule],
