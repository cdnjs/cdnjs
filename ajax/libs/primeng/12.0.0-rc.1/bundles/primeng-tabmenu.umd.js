(function (global, factory) {
    ...
    TabMenuModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: TabMenuModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TabMenuModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: TabMenuModule, declarations: [TabMenu], imports: [i1.CommonModule, i3.RouterModule, api.SharedModule, i2.RippleModule], exports: [TabMenu, i3.RouterModule, api.SharedModule] });
    TabMenuModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: TabMenuModule, imports: [[i1.CommonModule, i3.RouterModule, api.SharedModule, i2.RippleModule], i3.RouterModule, api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: TabMenuModule, decorators: [{
                type: i0.NgModule,
                args: [{
