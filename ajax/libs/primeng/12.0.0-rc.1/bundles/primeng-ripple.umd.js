(function (global, factory) {
    ...
    Ripple.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: Ripple, deps: [{ token: i0__namespace.ElementRef }, { token: i0__namespace.NgZone }, { token: i1__namespace.PrimeNGConfig, optional: true }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    Ripple.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.0.0", type: Ripple, selector: "[pRipple]", host: { properties: { "class.p-ripple": "true" } }, ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: Ripple, decorators: [{
                type: i0.Directive,
                args: [{
                        selector: '[pRipple]',
                        host: {
    ...
    RippleModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: RippleModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    RippleModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: RippleModule, declarations: [Ripple], imports: [common.CommonModule], exports: [Ripple] });
    RippleModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: RippleModule, imports: [[common.CommonModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: RippleModule, decorators: [{
                type: i0.NgModule,
                args: [{
