import{NgModule,Component,Input,Output,EventEmitter,forwardRef,ViewChild,ChangeDetectorRef,ChangeDetectionStrategy,Injectable,Injector}from"@angular/core";import{CommonModule}from"@angular/common";import{NG_VALUE_ACCESSOR,NgControl}from"@angular/forms";import*as i0 from"@angular/core";const RADIO_VALUE_ACCESSOR={provide:NG_VALUE_ACCESSOR,useExisting:forwardRef(()=>RadioButton),multi:!0};class RadioControlRegistry{constructor(){this.accessors=[]}add(t,e){this.accessors.push([t,e])}remove(e){this.accessors=this.accessors.filter(t=>t[1]!==e)}select(e){this.accessors.forEach(t=>{this.isSameGroup(t,e)&&t[1]!==e&&t[1].writeValue(e.value)})}isSameGroup(t,e){return!!t[0].control&&(t[0].control.root===e.control.control.root&&t[1].name===e.name)}}RadioControlRegistry.ɵprov=i0.ɵɵdefineInjectable({factory:function(){return new RadioControlRegistry},token:RadioControlRegistry,providedIn:"root"}),RadioControlRegistry.decorators=[{type:Injectable,args:[{providedIn:"root"}]}];class RadioButton{constructor(t,e,o){this.cd=t,this.injector=e,this.registry=o,this.onClick=new EventEmitter,this.onFocus=new EventEmitter,this.onBlur=new EventEmitter,this.onModelChange=()=>{},this.onModelTouched=()=>{}}ngOnInit(){this.control=this.injector.get(NgControl),this.checkName(),this.registry.add(this.control,this)}handleClick(t,e,o){t.preventDefault(),this.disabled||(this.select(t),o&&e.focus())}select(t){this.disabled||(this.inputViewChild.nativeElement.checked=!0,this.checked=!0,this.onModelChange(this.value),this.registry.select(this),this.onClick.emit(t))}writeValue(t){this.checked=t==this.value,this.inputViewChild&&this.inputViewChild.nativeElement&&(this.inputViewChild.nativeElement.checked=this.checked),this.cd.markForCheck()}registerOnChange(t){this.onModelChange=t}registerOnTouched(t){this.onModelTouched=t}setDisabledState(t){this.disabled=t,this.cd.markForCheck()}onInputFocus(t){this.focused=!0,this.onFocus.emit(t)}onInputBlur(t){this.focused=!1,this.onModelTouched(),this.onBlur.emit(t)}onChange(t){this.select(t)}focus(){this.inputViewChild.nativeElement.focus()}ngOnDestroy(){this.registry.remove(this)}checkName(){this.name&&this.formControlName&&this.name!==this.formControlName&&this.throwNameError(),!this.name&&this.formControlName&&(this.name=this.formControlName)}throwNameError(){throw new Error(`
    ...
    `,providers:[RADIO_VALUE_ACCESSOR],changeDetection:ChangeDetectionStrategy.OnPush}]}],RadioButton.ctorParameters=()=>[{type:ChangeDetectorRef},{type:Injector},{type:RadioControlRegistry}],RadioButton.propDecorators={value:[{type:Input}],formControlName:[{type:Input}],name:[{type:Input}],disabled:[{type:Input}],label:[{type:Input}],tabindex:[{type:Input}],inputId:[{type:Input}],ariaLabelledBy:[{type:Input}],ariaLabel:[{type:Input}],style:[{type:Input}],styleClass:[{type:Input}],labelStyleClass:[{type:Input}],onClick:[{type:Output}],onFocus:[{type:Output}],onBlur:[{type:Output}],inputViewChild:[{type:ViewChild,args:["rb"]}]};class RadioButtonModule{}RadioButtonModule.decorators=[{type:NgModule,args:[{imports:[CommonModule],exports:[RadioButton],declarations:[RadioButton]}]}];export{RADIO_VALUE_ACCESSOR,RadioControlRegistry,RadioButton,RadioButtonModule};