import{Component,ViewEncapsulation,ChangeDetectorRef,Input,ChangeDetectionStrategy,NgModule}from"@angular/core";import{trigger,state,style,transition,animate}from"@angular/animations";import{CommonModule}from"@angular/common";import{RouterModule}from"@angular/router";class BasePanelMenuItem{constructor(e){this.ref=e}handleClick(e,t){t.disabled?e.preventDefault():(t.expanded=!t.expanded,this.ref.detectChanges(),t.url||e.preventDefault(),t.command&&t.command({originalEvent:e,item:t}))}}class PanelMenuSub extends BasePanelMenuItem{constructor(e){super(e)}}PanelMenuSub.decorators=[{type:Component,args:[{selector:"p-panelMenuSub",template:`
