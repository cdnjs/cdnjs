...
})(this, (function (exports, i0, i4, i1, i3, utils, dom, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: UITreeNode, decorators: [{
            ...
            return [{ type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [i0.forwardRef(function () { return Tree; })]
                        }] }];
    ...
    var Tree = /** @class */ (function () {
        function Tree(el, dragDropService, config) {
            ...
            this.onNodeContextMenuSelect = new i0.EventEmitter();
            this.onNodeDrop = new i0.EventEmitter();
                ...
                if (this.isCheckboxSelectionMode()) {
                    if (selected) {
                        ...
                        if (this.propagateSelectionDown)
                            ...
                            this.selection = __spreadArray(__spreadArray([], __read(this.selection || [])), [node]);
                        if (this.propagateSelectionUp && node.parent) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: Tree, decorators: [{
            ...
            return [{ type: i0__namespace.ElementRef }, { type: i3__namespace.TreeDragDropService, decorators: [{
                            type: i0.Optional
                        }] }, { type: i3__namespace.PrimeNGConfig }];
    ...
    TreeModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: TreeModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    TreeModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: TreeModule, declarations: [Tree, UITreeNode], imports: [i1.CommonModule, i4.ScrollingModule, i2.RippleModule], exports: [Tree, i3.SharedModule, i4.ScrollingModule] });
    TreeModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: TreeModule, imports: [[i1.CommonModule, i4.ScrollingModule, i2.RippleModule], i3.SharedModule, i4.ScrollingModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: TreeModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i4.ScrollingModule, i2.RippleModule],
                        exports: [Tree, i3.SharedModule, i4.ScrollingModule],
