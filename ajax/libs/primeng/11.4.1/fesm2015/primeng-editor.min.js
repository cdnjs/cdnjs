import{forwardRef,EventEmitter,Component,ChangeDetectionStrategy,ViewEncapsulation,ElementRef,Output,ContentChild,Input,ContentChildren,NgModule}from"@angular/core";import{CommonModule}from"@angular/common";import{Header,PrimeTemplate,SharedModule}from"primeng/api";import{DomHandler}from"primeng/dom";import{NG_VALUE_ACCESSOR}from"@angular/forms";import*as Quill from"quill";const EDITOR_VALUE_ACCESSOR={provide:NG_VALUE_ACCESSOR,useExisting:forwardRef(()=>Editor),multi:!0};class Editor{constructor(t){this.el=t,this.onTextChange=new EventEmitter,this.onSelectionChange=new EventEmitter,this.onInit=new EventEmitter,this.onModelChange=()=>{},this.onModelTouched=()=>{}}ngAfterViewInit(){let n=DomHandler.findSingle(this.el.nativeElement,"div.p-editor-content");var t={toolbar:DomHandler.findSingle(this.el.nativeElement,"div.p-editor-toolbar")},t=this.modules?Object.assign(Object.assign({},t),this.modules):t;this.quill=new Quill(n,{modules:t,placeholder:this.placeholder,readOnly:this.readonly,theme:"snow",formats:this.formats,bounds:this.bounds,debug:this.debug,scrollingContainer:this.scrollingContainer}),this.value&&this.quill.setContents(this.quill.clipboard.convert(this.value)),this.quill.on("text-change",(e,t,o)=>{if("user"===o){let t=DomHandler.findSingle(n,".ql-editor").innerHTML;var l=this.quill.getText().trim();"<p><br></p>"===t&&(t=null),this.onTextChange.emit({htmlValue:t,textValue:l,delta:e,source:o}),this.onModelChange(t),this.onModelTouched()}}),this.quill.on("selection-change",(t,e,o)=>{this.onSelectionChange.emit({range:t,oldRange:e,source:o})}),this.onInit.emit({editor:this.quill})}ngAfterContentInit(){this.templates.forEach(t=>{"header"===t.getType()&&(this.headerTemplate=t.template)})}writeValue(t){this.value=t,this.quill&&(t?this.quill.setContents(this.quill.clipboard.convert(t)):this.quill.setText(""))}registerOnChange(t){this.onModelChange=t}registerOnTouched(t){this.onModelTouched=t}getQuill(){return this.quill}get readonly(){return this._readonly}set readonly(t){this._readonly=t,this.quill&&(this._readonly?this.quill.disable():this.quill.enable())}}Editor.decorators=[{type:Component,args:[{selector:"p-editor",template:`
