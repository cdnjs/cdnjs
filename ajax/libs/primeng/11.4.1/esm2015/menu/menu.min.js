import{NgModule,Component,ElementRef,Input,Output,EventEmitter,Renderer2,ViewChild,Inject,forwardRef,ChangeDetectorRef,ChangeDetectionStrategy,ViewEncapsulation}from"@angular/core";import{trigger,style,transition,animate}from"@angular/animations";import{CommonModule}from"@angular/common";import{DomHandler,ConnectedOverlayScrollHandler}from"primeng/dom";import{RouterModule}from"@angular/router";import{RippleModule}from"primeng/ripple";class MenuItemContent{constructor(e){this.menu=e}}MenuItemContent.decorators=[{type:Component,args:[{selector:"[pMenuItemContent]",template:`
