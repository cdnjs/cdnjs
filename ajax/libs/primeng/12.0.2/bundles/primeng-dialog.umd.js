(function (global, factory) {
    ...
    Dialog.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: Dialog, deps: [{ token: i0__namespace.ElementRef }, { token: i0__namespace.Renderer2 }, { token: i0__namespace.NgZone }, { token: i0__namespace.ChangeDetectorRef }], target: i0__namespace.ɵɵFactoryTarget.Component });
    ...
    DialogModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: DialogModule, declarations: [Dialog], imports: [i1.CommonModule, i2.FocusTrapModule, i3.RippleModule], exports: [Dialog, api.SharedModule] });
    DialogModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: DialogModule, imports: [[i1.CommonModule, i2.FocusTrapModule, i3.RippleModule], api.SharedModule] });
