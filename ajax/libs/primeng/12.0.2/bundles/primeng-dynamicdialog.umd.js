(function (global, factory) {
...
}(this, (function (exports, i0, animations, i3, dom, rxjs) { 'use strict';
    ...
    DynamicDialogContent.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.0.5", type: DynamicDialogContent, selector: "[pDynamicDialogContent]", ngImport: i0__namespace });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: DynamicDialogComponent, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ComponentFactoryResolver }, { type: i0__namespace.ChangeDetectorRef }, { type: i0__namespace.Renderer2 }, { type: DynamicDialogConfig }, { type: DynamicDialogRef }, { type: i0__namespace.NgZone }]; }, propDecorators: { insertionPoint: [{
                    type: i0.ViewChild,
    ...
    DynamicDialogModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: DynamicDialogModule, declarations: [DynamicDialogComponent, DynamicDialogContent], imports: [i3.CommonModule] });
    DynamicDialogModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: DynamicDialogModule, imports: [[i3.CommonModule]] });
