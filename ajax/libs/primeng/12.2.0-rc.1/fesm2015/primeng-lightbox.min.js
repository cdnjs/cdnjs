import*as i0 from"@angular/core";import{Component,ChangeDetectionStrategy,ViewEncapsulation,Input,NgModule}from"@angular/core";import*as i1 from"@angular/common";import{CommonModule}from"@angular/common";import{DomHandler}from"primeng/dom";class Lightbox{constructor(i,A,e){this.el=i,this.renderer=A,this.cd=e,this.type="image",this.effectDuration="500ms",this.autoZIndex=!0,this.baseZIndex=0,this.closeOnEscape=!0}onImageClick(i,A,e,t){this.index=e,this.loading=!0,t.style.width="32px",t.style.height="32px",this.preventDocumentClickListener=!0,this.show(),this.displayImage(A),i.preventDefault()}ngAfterViewInit(){this.panel=DomHandler.findSingle(this.el.nativeElement,".ui-lightbox "),this.appendTo&&("body"===this.appendTo?document.body.appendChild(this.panel):DomHandler.appendChild(this.panel,this.appendTo))}onLinkClick(i,A){this.preventDocumentClickListener=!0,this.show(),i.preventDefault()}displayImage(i){setTimeout(()=>{this.cd.markForCheck(),this.currentImage=i,this.captionText=i.title,this.center()},1e3)}show(){this.mask=document.createElement("div"),DomHandler.addMultipleClasses(this.mask,"ui-widget-overlay ui-dialog-mask"),document.body.appendChild(this.mask),this.autoZIndex&&(this.zindex=this.baseZIndex+ ++DomHandler.zindex),this.mask.style.zIndex=this.zindex-1,this.center(),this.visible=!0,this.bindGlobalListeners()}hide(i){this.captionText=null,this.index=null,this.currentImage=null,this.visible=!1,this.mask&&(document.body.removeChild(this.mask),this.mask=null),this.unbindGlobalListeners(),i.preventDefault()}center(){var i=DomHandler.getOuterWidth(this.panel);let A=DomHandler.getOuterHeight(this.panel);0==i&&0==A&&(this.panel.style.visibility="hidden",this.panel.style.display="block",DomHandler.getOuterWidth(this.panel),A=DomHandler.getOuterHeight(this.panel),this.panel.style.display="none",this.panel.style.visibility="visible")}onImageLoad(i,A){let e=i.target;e.style.visibility="hidden",e.style.display="block";var t=DomHandler.getOuterWidth(e),i=DomHandler.getOuterHeight(e);e.style.display="none",e.style.visibility="visible",A.style.width=t+"px",A.style.height=i+"px",this.panel.style.left=parseInt(this.panel.style.left)+(DomHandler.getOuterWidth(this.panel)-t)/2+"px",this.panel.style.top=parseInt(this.panel.style.top)+(DomHandler.getOuterHeight(this.panel)-i)/2+"px",setTimeout(()=>{this.cd.markForCheck(),DomHandler.fadeIn(e,500),e.style.display="block",this.loading=!1},parseInt(this.effectDuration))}prev(i){this.captionText=null,this.loading=!0,i.style.display="none",0<this.index&&this.displayImage(this.images[--this.index])}next(i){this.captionText=null,this.loading=!0,i.style.display="none",this.index<=this.images.length-1&&this.displayImage(this.images[++this.index])}bindGlobalListeners(){var i=this.el?this.el.nativeElement.ownerDocument:"document";this.documentClickListener=this.renderer.listen(i,"click",i=>{!this.preventDocumentClickListener&&this.visible&&this.hide(i),this.preventDocumentClickListener=!1,this.cd.markForCheck()}),this.closeOnEscape&&!this.documentEscapeListener&&(this.documentEscapeListener=this.renderer.listen(i,"keydown",i=>{27==i.which&&parseInt(this.panel.style.zIndex)===DomHandler.zindex+this.baseZIndex&&this.hide(i)}))}unbindGlobalListeners(){this.documentEscapeListener&&(this.documentEscapeListener(),this.documentEscapeListener=null),this.documentClickListener&&(this.documentClickListener(),this.documentClickListener=null)}get leftVisible(){return this.images&&this.images.length&&0!=this.index&&!this.loading}get rightVisible(){return this.images&&this.images.length&&this.index<this.images.length-1&&!this.loading}ngOnDestroy(){this.unbindGlobalListeners(),this.appendTo&&this.el.nativeElement.appendChild(this.panel)}}Lightbox.ɵfac=i0.ɵɵngDeclareFactory({minVersion:"12.0.0",version:"12.0.5",ngImport:i0,type:Lightbox,deps:[{token:i0.ElementRef},{token:i0.Renderer2},{token:i0.ChangeDetectorRef}],target:i0.ɵɵFactoryTarget.Component}),Lightbox.ɵcmp=i0.ɵɵngDeclareComponent({minVersion:"12.0.0",version:"12.0.5",type:Lightbox,selector:"p-lightbox",inputs:{images:"images",type:"type",style:"style",styleClass:"styleClass",appendTo:"appendTo",easing:"easing",effectDuration:"effectDuration",autoZIndex:"autoZIndex",baseZIndex:"baseZIndex",closeOnEscape:"closeOnEscape"},host:{classAttribute:"p-element"},ngImport:i0,template:`
    ...
    `,changeDetection:ChangeDetectionStrategy.Default,encapsulation:ViewEncapsulation.None,styleUrls:["./lightbox.css","../dialog/dialog.css"],host:{class:"p-element"}}]}],ctorParameters:function(){return[{type:i0.ElementRef},{type:i0.Renderer2},{type:i0.ChangeDetectorRef}]},propDecorators:{images:[{type:Input}],type:[{type:Input}],style:[{type:Input}],styleClass:[{type:Input}],appendTo:[{type:Input}],easing:[{type:Input}],effectDuration:[{type:Input}],autoZIndex:[{type:Input}],baseZIndex:[{type:Input}],closeOnEscape:[{type:Input}]}});class LightboxModule{}LightboxModule.ɵfac=i0.ɵɵngDeclareFactory({minVersion:"12.0.0",version:"12.0.5",ngImport:i0,type:LightboxModule,deps:[],target:i0.ɵɵFactoryTarget.NgModule}),LightboxModule.ɵmod=i0.ɵɵngDeclareNgModule({minVersion:"12.0.0",version:"12.0.5",ngImport:i0,type:LightboxModule,declarations:[Lightbox],imports:[CommonModule],exports:[Lightbox]}),LightboxModule.ɵinj=i0.ɵɵngDeclareInjector({minVersion:"12.0.0",version:"12.0.5",ngImport:i0,type:LightboxModule,imports:[[CommonModule]]}),i0.ɵɵngDeclareClassMetadata({minVersion:"12.0.0",version:"12.0.5",ngImport:i0,type:LightboxModule,decorators:[{type:NgModule,args:[{imports:[CommonModule],exports:[Lightbox],declarations:[Lightbox]}]}]});export{Lightbox,LightboxModule};