(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng/dom'), require('primeng/api'), require('primeng/ripple'), require('primeng/utils'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('primeng/tooltip')) :
    typeof define === 'function' && define.amd ? define('primeng/contextmenu', ['exports', '@angular/core', '@angular/common', 'primeng/dom', 'primeng/api', 'primeng/ripple', 'primeng/utils', '@angular/router', 'rxjs', 'rxjs/operators', 'primeng/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.primeng = global.primeng || {}, global.primeng.contextmenu = {}), global.ng.core, global.ng.common, global.primeng.dom, global.primeng.api, global.primeng.ripple, global.primeng.utils, global.ng.router, global.rxjs, global.rxjs.operators, global.primeng.tooltip));
}(this, (function (exports, i0, i1, dom, i5, i3, utils, i4, rxjs, operators, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenuSub, decorators: [{
            ...
            return [{ type: undefined, decorators: [{
                            type: i0.Inject,
                            args: [i0.forwardRef(function () { return ContextMenu; })]
                        }] }];
        }, propDecorators: { item: [{
                    type: i0.Input
                }], root: [{
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenu, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.Renderer2 }, { type: i0__namespace.ChangeDetectorRef }, { type: i0__namespace.NgZone }, { type: i5__namespace.ContextMenuService }, { type: i5__namespace.PrimeNGConfig }]; }, propDecorators: { model: [{
                    type: i0.Input
                }], global: [{
                    type: i0.Input
                }], target: [{
    ...
    ContextMenuModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenuModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    ContextMenuModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenuModule, declarations: [ContextMenu, ContextMenuSub], imports: [i1.CommonModule, i4.RouterModule, i3.RippleModule, i2.TooltipModule], exports: [ContextMenu, i4.RouterModule, i2.TooltipModule] });
    ContextMenuModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenuModule, providers: [i5.ContextMenuService], imports: [[i1.CommonModule, i4.RouterModule, i3.RippleModule, i2.TooltipModule], i4.RouterModule, i2.TooltipModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ContextMenuModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i4.RouterModule, i3.RippleModule, i2.TooltipModule],
                        exports: [ContextMenu, i4.RouterModule, i2.TooltipModule],
                        declarations: [ContextMenu, ContextMenuSub],
                        providers: [i5.ContextMenuService]
                    }]
            }] });
