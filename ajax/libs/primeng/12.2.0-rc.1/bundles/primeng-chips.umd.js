(function (global, factory) {
...
}(this, (function (exports, i0, i1, api, inputtext, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CHIPS_VALUE_ACCESSOR = {
        ...
        useExisting: i0.forwardRef(function () { return Chips; }),
        multi: true
    };
    var Chips = /** @class */ (function () {
        function Chips(el, cd) {
            ...
            this.onChipClick = new i0.EventEmitter();
        ...
        Chips.prototype.addItem = function (event, item, preventDefault) {
            ...
            if (item && item.trim().length) {
                if (this.allowDuplicate || this.value.indexOf(item) === -1) {
                    this.value = __spreadArray(__spreadArray([], __read(this.value)), [item]);
                    this.onModelChange(this.value);
                    this.onAdd.emit({
                        originalEvent: event,
                        value: item
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: Chips, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.ChangeDetectorRef }]; }, propDecorators: { style: [{
                    type: i0.Input
                }], styleClass: [{
                    type: i0.Input
                }], disabled: [{
    ...
    ChipsModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ChipsModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    ChipsModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ChipsModule, declarations: [Chips], imports: [i1.CommonModule, inputtext.InputTextModule, api.SharedModule], exports: [Chips, inputtext.InputTextModule, api.SharedModule] });
    ChipsModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ChipsModule, imports: [[i1.CommonModule, inputtext.InputTextModule, api.SharedModule], inputtext.InputTextModule, api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: ChipsModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, inputtext.InputTextModule, api.SharedModule],
