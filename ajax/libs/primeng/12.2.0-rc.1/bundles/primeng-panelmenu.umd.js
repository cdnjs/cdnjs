(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('@angular/router'), require('primeng/tooltip')) :
    typeof define === 'function' && define.amd ? define('primeng/panelmenu', ['exports', '@angular/core', '@angular/animations', '@angular/common', '@angular/router', 'primeng/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.primeng = global.primeng || {}, global.primeng.panelmenu = {}), global.ng.core, global.ng.animations, global.ng.common, global.ng.router, global.primeng.tooltip));
}(this, (function (exports, i0, animations, i1, i3, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenuSub, decorators: [{
                type: i0.Component,
                args: [{
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenu, decorators: [{
                type: i0.Component,
                args: [{
    ...
    PanelMenuModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenuModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    PanelMenuModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenuModule, declarations: [PanelMenu, PanelMenuSub], imports: [i1.CommonModule, i3.RouterModule, i2.TooltipModule], exports: [PanelMenu, i3.RouterModule, i2.TooltipModule] });
    PanelMenuModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenuModule, imports: [[i1.CommonModule, i3.RouterModule, i2.TooltipModule], i3.RouterModule, i2.TooltipModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: PanelMenuModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i3.RouterModule, i2.TooltipModule],
                        exports: [PanelMenu, i3.RouterModule, i2.TooltipModule],
