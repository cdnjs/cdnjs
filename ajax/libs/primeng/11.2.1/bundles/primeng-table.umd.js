(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var SelectableRow = /** @class */ (function () {
        ...
        SelectableRow.prototype.onSpaceKeyDown = function (event) {
            event.preventDefault();
        };
    ...
    SelectableRow.propDecorators = {
        ...
        onSpaceKeyDown: [{ type: core.HostListener, args: ['keydown.space', ['$event'],] }],
        onPageDownKeyDown: [{ type: core.HostListener, args: ['keydown.pagedown', ['$event'],] }, { type: core.HostListener, args: ['keydown.pageup', ['$event'],] }, { type: core.HostListener, args: ['keydown.home', ['$event'],] }, { type: core.HostListener, args: ['keydown.end', ['$event'],] }]
    };
