(function (global, factory) {
...
})(this, (function (exports, i0, api, i2, i1, utils) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Carousel = /** @class */ (function () {
        ...
        Carousel.prototype.ngAfterContentChecked = function () {
            ...
            if (this.value && this.itemsContainer && (this.prevState.numScroll !== this._numScroll || this.prevState.numVisible !== this._numVisible || this.prevState.value.length !== this.value.length)) {
                ...
                this.prevState.value = __spreadArray([], __read(this._value));
        ...
        Carousel.prototype.setCloneItems = function () {
            ...
            if (this.isCircular()) {
                (_a = this.clonedItemsForStarting).push.apply(_a, __spreadArray([], __read(this.value.slice(-1 * this._numVisible))));
                (_b = this.clonedItemsForFinishing).push.apply(_b, __spreadArray([], __read(this.value.slice(0, this._numVisible))));
            }
        };
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: Carousel, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.NgZone }, { type: i0__namespace.ChangeDetectorRef }]; }, propDecorators: { page: [{
                    type: i0.Input
                }], numVisible: [{
                    type: i0.Input
                }], numScroll: [{
    ...
    CarouselModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CarouselModule, declarations: [Carousel], imports: [i1.CommonModule, api.SharedModule, i2.RippleModule], exports: [i1.CommonModule, Carousel, api.SharedModule] });
    CarouselModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CarouselModule, imports: [[i1.CommonModule, api.SharedModule, i2.RippleModule], i1.CommonModule, api.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CarouselModule, decorators: [{
                ...
                args: [{
                        ...
                        exports: [i1.CommonModule, Carousel, api.SharedModule],
