(function (global, factory) {
...
})(this, (function (exports, i0, i1, i3, utils, dom, animations, forms, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CascadeSelect = /** @class */ (function () {
        function CascadeSelect(el, cd, config, overlayService) {
            this.el = el;
            this.cd = cd;
            this.config = config;
        ...
        CascadeSelect.prototype.onOverlayClick = function (event) {
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CascadeSelect, decorators: [{
                type: i0.Component,
                args: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: i0__namespace.ChangeDetectorRef }, { type: i3__namespace.PrimeNGConfig }, { type: i3__namespace.OverlayService }]; }, propDecorators: { styleClass: [{
                    type: i0.Input
                }], style: [{
                    type: i0.Input
                }], options: [{
    ...
    CascadeSelectModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CascadeSelectModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    CascadeSelectModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CascadeSelectModule, declarations: [CascadeSelect, CascadeSelectSub], imports: [i1.CommonModule, i3.SharedModule, i2.RippleModule], exports: [CascadeSelect, CascadeSelectSub, i3.SharedModule] });
    CascadeSelectModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CascadeSelectModule, imports: [[i1.CommonModule, i3.SharedModule, i2.RippleModule], i3.SharedModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: CascadeSelectModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i3.SharedModule, i2.RippleModule],
                        exports: [CascadeSelect, CascadeSelectSub, i3.SharedModule],
