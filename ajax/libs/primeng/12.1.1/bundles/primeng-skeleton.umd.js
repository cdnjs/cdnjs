(function (global, factory) {
    ...
    SkeletonModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: SkeletonModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    SkeletonModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: SkeletonModule, declarations: [Skeleton], imports: [i1.CommonModule], exports: [Skeleton] });
    SkeletonModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: SkeletonModule, imports: [[i1.CommonModule]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: SkeletonModule, decorators: [{
                type: i0.NgModule,
                args: [{
