(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ObjectUtils = /** @class */ (function () {
        ...
        ObjectUtils.contains = function (value, list) {
            var e_1, _a;
    ...
    function ZIndexUtils() {
        var zIndexes = [];
        var generateZIndex = function (key, baseZIndex) {
            var lastZIndex = zIndexes.length > 0 ? zIndexes[zIndexes.length - 1] : { key: key, value: baseZIndex };
            var newZIndex = lastZIndex.value + (lastZIndex.key === key ? 0 : baseZIndex) + 1;
            zIndexes.push({ key: key, value: newZIndex });
            return newZIndex;
        };
        var revertZIndex = function (zIndex) {
            zIndexes = zIndexes.filter(function (obj) { return obj.value !== zIndex; });
        };
        ...
        return {
            get: getZIndex,
            set: function (key, el, baseZIndex) {
                if (el) {
            ...
            getCurrent: function () { return getCurrentZIndex(); }
        };
    }
