...
export declare type AddRemoveFcn = (g: GridStack, w: GridStackWidget, add: boolean) => GridItemHTMLElement;
/**
...
export declare class GridStack {
     ...
     **/
    load(layout: GridStackWidget[], addAndRemove?: boolean | AddRemoveFcn): GridStack;
    /**
