...
this.primereact.tabmenu = (function (exports, React, ripple, utils) {
  'use strict';
  ...
  var TabMenu = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    if (props.model) {
      var otherProps = utils.ObjectUtils.findDiffKeys(props, TabMenu.defaultProps);
