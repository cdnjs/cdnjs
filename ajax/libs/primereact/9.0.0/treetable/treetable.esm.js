...
import PrimeReact, { FilterMatchMode, ariaLabel, localeOption, FilterService } from 'primereact/api';
...
var TreeTableHeader = /*#__PURE__*/React.memo(function (props) {
  ...
  var createHeaderCell = function createHeaderCell(column, options) {
    ...
    if (options.filterOnly) {
      ...
      }, getColumnProp(column, 'header')), sortIconElement, sortBadge, filterElement), hasTooltip && /*#__PURE__*/React.createElement(Tooltip, _extends({
