...
this.primereact.componentbase = (function (exports, PrimeReact, hooks, utils) {
  ...
  var ComponentBase = {
    ...
    extend: function extend() {
      ...
      var getPTValue = function getPTValue() {
        ...
        return mergeSections || !mergeSections && self ? useMergeProps ? utils._mergeProps([globalPT, self, Object.keys(datasetProps).length ? datasetProps : {}], {
      ...
      var setMetaData = function setMetaData() {
        ...
        var sx = function sx() {
          ...
          if (when) {
            ...
            return utils._mergeProps([base, self], {
  ...
  var _usePT = function _usePT(pt, callback, key, params) {
    ...
    if (pt !== null && pt !== void 0 && pt.hasOwnProperty('_usept')) {
      ...
      return mergeSections || !mergeSections && value ? useMergeProps ? utils._mergeProps([originalValue, value], {
