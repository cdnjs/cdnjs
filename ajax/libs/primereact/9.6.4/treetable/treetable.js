...
this.primereact.treetable = (function (exports, React, PrimeReact, componentbase, utils, hooks, arrowdown, arrowup, spinner, paginator, ripple, overlayservice, chevrondown, chevronright, check, minus, inputtext, tooltip, sortalt, sortamountdown, sortamountupalt) {
  'use strict';
...
})({}, React, primereact.api, primereact.componentbase, primereact.utils, primereact.hooks, primereact.icons.arrowdown, primereact.icons.arrowup, primereact.icons.spinner, primereact.paginator, primereact.ripple, primereact.overlayservice, primereact.icons.chevrondown, primereact.icons.chevronright, primereact.icons.check, primereact.icons.minus, primereact.inputtext, primereact.tooltip, primereact.icons.sortalt, primereact.icons.sortamountdown, primereact.icons.sortamountupalt);
