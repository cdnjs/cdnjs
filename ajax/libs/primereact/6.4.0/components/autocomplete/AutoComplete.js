...
var AutoComplete = /*#__PURE__*/function (_Component) {
  ...
  function AutoComplete(props) {
    ...
    _this.virtualScrollerRef = /*#__PURE__*/(0, _react.createRef)();
  ...
  _createClass(AutoComplete, [{
        ...
        switch (event.which) {
          ...
          case 40:
            if (highlightItem) {
              ...
              highlightItem = _DomHandler.default.findSingle(this.overlayRef.current, 'li');
    ...
    value: function render() {
      ...
      }, input, loader, dropdown, /*#__PURE__*/_react.default.createElement(_AutoCompletePanel.AutoCompletePanel, _extends({
        ref: this.overlayRef,
