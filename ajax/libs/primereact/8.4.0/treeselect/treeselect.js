...
this.primereact.treeselect = (function (exports, React, PrimeReact, hooks, overlayservice, ripple, tree, utils, csstransition, portal) {
  'use strict';
  ...
  var TreeSelect = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    var expandPath = function expandPath(path) {
      if (path.length > 0) {
        var expandedKeys = _objectSpread({}, expandedKeysState || {});
    ...
    var otherProps = utils.ObjectUtils.findDiffKeys(props, TreeSelect.defaultProps);
...
})({}, React, primereact.api, primereact.hooks, primereact.overlayservice, primereact.ripple, primereact.tree, primereact.utils, primereact.csstransition, primereact.portal);
