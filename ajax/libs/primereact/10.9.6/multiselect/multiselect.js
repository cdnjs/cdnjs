...
this.primereact.multiselect = (function (exports, React, PrimeReact, componentbase, hooks, chevrondown, spinner, times, timescircle, overlayservice, tooltip, utils, csstransition, portal, virtualscroller, check, search, inputtext, ripple) {
  ...
  var MultiSelect = /*#__PURE__*/React__namespace.memo(/*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var alignOverlay = function alignOverlay() {
      !props.inline && utils.DomHandler.alignOverlay(overlayRef.current, labelContainerRef.current.parentElement, props.appendTo || context && context.appendTo || PrimeReact__default["default"].appendTo);
    };
    ...
    var getOptionValue = function getOptionValue(option) {
      ...
      if (props.optionValue) {
        return utils.ObjectUtils.resolveFieldData(option, props.optionValue);
      }
    ...
    var getLabel = function getLabel() {
      ...
      if (utils.ObjectUtils.isNotEmpty(props.maxSelectedLabels) && ((_props$value = props.value) === null || _props$value === void 0 ? void 0 : _props$value.length) > props.maxSelectedLabels) {
    ...
    var getLabelContent = function getLabelContent() {
      var valueLength = props.value ? props.value.length : 0;
      if (utils.ObjectUtils.isNotEmpty(props.maxSelectedLabels) && valueLength > props.maxSelectedLabels) {
        return getSelectedItemsLabel();
      }
      ...
      if (props.display === 'chip' && !empty) {
        ...
        return value.map(function (val, i) {
          ...
          var iconProps = mergeProps({
            'aria-label': PrimeReact.localeOption('removeTokenIcon'),
