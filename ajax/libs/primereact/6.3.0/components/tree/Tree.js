...
var Tree = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Tree, [{
    ...
    value: function renderHeader() {
      if (this.props.showHeader) {
        ...
        if (this.props.header) {
          ...
          content = _ObjectUtils.default.getJSXElement(this.props.header, defaultContentOptions);
        }
    ...
    value: function renderFooter() {
      var content = _ObjectUtils.default.getJSXElement(this.props.footer, this.props);
