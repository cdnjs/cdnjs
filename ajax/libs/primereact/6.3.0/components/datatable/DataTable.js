      ...
      if (this.props.sortMode === 'multiple') {
        ...
        if (sortOrder) {
          if (!multiSortMeta || !metaKey) {
            multiSortMeta = multiSortMeta ? multiSortMeta.filter(function (meta) {
...
_defineProperty(DataTable, "propTypes", {
  ...
  dragSelection: _propTypes.default.bool,
  cellSelection: _propTypes.default.bool,
  selection: _propTypes.default.any,
  onSelectionChange: _propTypes.default.func,
  contextMenuSelection: _propTypes.default.object,
  ...
  groupField: _propTypes.default.string,
  ...
  onCellUnselect: _propTypes.default.func,
