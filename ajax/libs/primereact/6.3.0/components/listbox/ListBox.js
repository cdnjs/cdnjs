...
var ListBox = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ListBox, [{
    ...
    value: function isOptionDisabled(option) {
      return this.props.optionDisabled ? _ObjectUtils.default.resolveFieldData(option, this.props.optionDisabled) : option && option['disabled'] !== undefined ? option['disabled'] : false;
    }
  }, {
