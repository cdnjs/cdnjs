  ...
  _createClass(GalleriaItemComponent, [{
    ...
    value: function renderBackwardNavigator() {
      if (this.props.showItemNavigators) {
        ...
        var buttonClassName = core.classNames('p-galleria-item-prev p-galleria-item-nav p-link', {
    ...
    value: function renderForwardNavigator() {
      if (this.props.showItemNavigators) {
        ...
        var buttonClassName = core.classNames('p-galleria-item-next p-galleria-item-nav p-link', {
          'p-disabled': isDisabled
        });
        return /*#__PURE__*/React__default['default'].createElement("button", {
          type: "button",
    ...
    value: function renderIndicator(index) {
      ...
      var indicatorItemClassName = core.classNames('p-galleria-indicator', {
    ...
    value: function renderIndicators() {
      if (this.props.showIndicators) {
        var indicatorsContentClassName = core.classNames('p-galleria-indicators p-reset', this.props.indicatorsContentClassName);
        var indicators = [];
...
var GalleriaThumbnailItem = /*#__PURE__*/function (_Component) {
  ...
  _createClass(GalleriaThumbnailItem, [{
    ...
    value: function render() {
      ...
      var itemClassName = core.classNames(this.props.className, 'p-galleria-thumbnail-item', {
...
var GalleriaThumbnails = /*#__PURE__*/function (_Component2) {
  ...
  function GalleriaThumbnails(props) {
    ...
    _this2.attributeSelector = core.UniqueComponentId();
    return _this2;
  }
  ...
  _createClass(GalleriaThumbnails, [{
    ...
    value: function renderBackwardNavigator() {
      if (this.props.showThumbnailNavigators) {
        ...
        var buttonClassName = core.classNames('p-galleria-thumbnail-prev p-link', {
          'p-disabled': isDisabled
        }),
            iconClassName = core.classNames('p-galleria-thumbnail-prev-icon pi', {
    ...
    value: function renderForwardNavigator() {
      if (this.props.showThumbnailNavigators) {
        ...
        var buttonClassName = core.classNames('p-galleria-thumbnail-next p-link', {
          'p-disabled': isDisabled
        }),
            iconClassName = core.classNames('p-galleria-thumbnail-next-icon pi', {
...
var Galleria = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Galleria, [{
    ...
    value: function renderElement() {
      ...
      var galleriaClassName = core.classNames('p-galleria p-component', this.props.className, {
    ...
    value: function renderGalleria() {
      ...
      if (this.props.fullScreen) {
        var maskClassName = core.classNames('p-galleria-mask', {
