...
this.primereact.tabview = (function (exports, React, core) {
  'use strict';
  ...
  var TabView = /*#__PURE__*/function (_Component2) {
    ...
    _createClass(TabView, [{
      ...
      value: function updateButtonState() {
        ...
        var width = core.DomHandler.getWidth(content);
        this.setState({
      ...
      value: function getVisibleButtonWidths() {
        ...
        return [prevBtn, nextBtn].reduce(function (acc, el) {
          return el ? acc + core.DomHandler.getWidth(el) : acc;
        }, 0);
      }
    }, {
      key: "navBackward",
      value: function navBackward() {
        var content = this.content;
        var width = core.DomHandler.getWidth(content) - this.getVisibleButtonWidths();
