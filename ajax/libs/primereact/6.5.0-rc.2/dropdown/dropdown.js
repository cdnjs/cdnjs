...
this.primereact.dropdown = (function (exports, React, utils, ripple, csstransition, portal, virtualscroller, tooltip, OverlayEventBus, PrimeReact) {
  'use strict';
  ...
  var DropdownPanelComponent = /*#__PURE__*/function (_Component) {
    ...
    _createClass(DropdownPanelComponent, [{
      ...
      value: function renderEmptyMessage(emptyMessage) {
        var message = utils.ObjectUtils.getJSXElement(emptyMessage, this.props);
        return /*#__PURE__*/React__default['default'].createElement("li", {
  ...
  var Dropdown = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function bindResizeListener() {
        ...
        if (!this.resizeListener) {
          this.resizeListener = function () {
            if (_this10.state.overlayVisible && !utils.DomHandler.isAndroid()) {
              _this10.hideOverlay();
            }
          };
      ...
      value: function isClearClicked(event) {
        return utils.DomHandler.hasClass(event.target, 'p-dropdown-clear-icon');
      }
    }, {
          ...
          if (this.props.optionGroupLabel) {
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                var filteredSubOptions = utils.FilterUtils.filter(this.getOptionGroupChildren(optgroup), searchFields, filterValue, this.props.filterMatchMode, this.props.filterLocale);
            ...
            return utils.FilterUtils.filter(this.props.options, searchFields, filterValue, this.props.filterMatchMode, this.props.filterLocale);
          }
        } else {
...
}({}, React, primereact.utils, primereact.ripple, primereact.csstransition, primereact.portal, primereact.virtualscroller, primereact.tooltip, primereact.overlayeventbus, primereact.api));
