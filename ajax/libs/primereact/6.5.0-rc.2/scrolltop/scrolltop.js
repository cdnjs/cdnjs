...
this.primereact.scrolltop = (function (exports, React, utils, csstransition, ripple) {
  'use strict';
  ...
  var ScrollTop = /*#__PURE__*/function (_Component) {
    ...
    _createClass(ScrollTop, [{
      ...
      value: function onEnter() {
        utils.ZIndexUtils.set('overlay', this.scrollElementRef.current);
      }
    }, {
      key: "onEntered",
      ...
      value: function render() {
        ...
        var iconClassName = utils.classNames('p-scrolltop-icon', this.props.icon);
