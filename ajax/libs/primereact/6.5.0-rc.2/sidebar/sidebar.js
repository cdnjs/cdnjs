...
this.primereact.sidebar = (function (exports, React, utils, csstransition, ripple, portal) {
  'use strict';
  ...
  var Sidebar = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Sidebar, [{
      ...
      value: function onEnter() {
        utils.ZIndexUtils.set('modal', this.sidebarRef.current, this.props.baseZIndex);
      ...
      value: function onExited() {
        utils.ZIndexUtils.clear(this.sidebarRef.current);
      }
    }, {
      key: "enableModality",
      value: function enableModality() {
        if (!this.mask) {
          ...
          this.mask.style.zIndex = String(utils.ZIndexUtils.get(this.sidebarRef.current) - 1);
          ...
          utils.DomHandler.addMultipleClasses(this.mask, maskClassName);
        ...
        if (this.mask) {
          ...
          if (this.props.blockScroll) {
            ...
            for (var i = 0; i < bodyChildren.length; i++) {
              ...
              if (utils.DomHandler.hasClass(bodyChild, 'p-sidebar-mask-scrollblocker')) {
      ...
      value: function bindDocumentEscapeListener() {
        ...
        this.documentEscapeListener = function (event) {
          if (event.which === 27) {
            if (utils.ZIndexUtils.get(_this2.sidebarRef.current) === utils.ZIndexUtils.getCurrent('modal')) {
      ...
      value: function renderElement() {
        var className = utils.classNames('p-sidebar p-component', this.props.className, 'p-sidebar-' + this.props.position, {
...
}({}, React, primereact.utils, primereact.csstransition, primereact.ripple, primereact.portal));
