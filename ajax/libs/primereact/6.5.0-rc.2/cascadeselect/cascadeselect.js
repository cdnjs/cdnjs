...
this.primereact.cascadeselect = (function (exports, React, utils, csstransition, ripple, OverlayEventBus, portal, PrimeReact) {
  'use strict';
      ...
      value: function bindResizeListener() {
        ...
        if (!this.resizeListener) {
          this.resizeListener = function () {
            if (_this5.state.overlayVisible && !utils.DomHandler.isAndroid()) {
              _this5.hide();
            }
          };
...
}({}, React, primereact.utils, primereact.csstransition, primereact.ripple, primereact.overlayeventbus, primereact.portal, primereact.api));
