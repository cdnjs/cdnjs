...
this.primereact.calendar = (function (exports, React, inputtext, button, csstransition, portal, utils, tooltip, ripple, PrimeReact, OverlayEventBus) {
  'use strict';
    ...
    _createClass(Calendar, [{
      ...
      value: function showOverlay(type) {
        ...
        if (this.props.onVisibleChange) {
          ...
          this.setState({
            ...
            OverlayEventBus__default['default'].on('overlay-click', _this10.overlayEventListener);
          });
        }
      }
    }, {
      ...
      value: function hideOverlay(type, callback) {
        ...
        var _hideCallback = function _hideCallback() {
          ...
          OverlayEventBus__default['default'].off('overlay-click', _this11.overlayEventListener);
      ...
      value: function onOverlayEnter() {
        if (this.props.autoZIndex) {
          utils.ZIndexUtils.set(this.props.touchUI ? 'modal' : 'overlay', this.overlayRef.current, this.props.baseZIndex);
        }
      ...
      value: function enableModality() {
        ...
        if (!this.touchUIMask) {
          ...
          utils.DomHandler.addMultipleClasses(this.touchUIMask, 'p-component-overlay p-datepicker-mask p-datepicker-mask-scrollblocker');
      ...
      value: function render() {
        ...
        var className = utils.classNames('p-calendar p-component p-inputwrapper', this.props.className, {
          'p-calendar-w-btn': this.props.showIcon,
          'p-calendar-disabled': this.props.disabled,
          'p-calendar-timeonly': this.props.timeOnly,
          'p-inputwrapper-filled': this.props.value || utils.DomHandler.hasClass(this.inputRef.current, 'p-filled') && this.inputRef.current.value !== '',
...
}({}, React, primereact.inputtext, primereact.button, primereact.csstransition, primereact.portal, primereact.utils, primereact.tooltip, primereact.ripple, primereact.api, primereact.overlayeventbus));
