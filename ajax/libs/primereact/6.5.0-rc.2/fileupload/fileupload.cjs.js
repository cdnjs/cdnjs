...
var FileUpload = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function renderChooseButton() {
      ...
      var chooseIconClassName = utils.classNames('p-button-icon p-button-icon-left p-clickable', {
    ...
    value: function renderBasic() {
      ...
      var iconClassName = utils.classNames('p-button-icon p-button-icon-left pi', {
