...
this.primereact.treetable = (function (exports, React, PrimeReact, hooks, paginator, utils, ripple, overlayservice, inputtext, tooltip) {
  'use strict';
  ...
  var TreeTableHeader = /*#__PURE__*/React__namespace.memo(function (props) {
    ...
    var createHeaderCell = function createHeaderCell(column, options) {
      ...
      if (options.filterOnly) {
        ...
        }, column.props.header), sortIconElement, sortBadge, filterElement), hasTooltip && /*#__PURE__*/React__namespace.createElement(tooltip.Tooltip, _extends({
...
})({}, React, primereact.api, primereact.hooks, primereact.paginator, primereact.utils, primereact.ripple, primereact.overlayservice, primereact.inputtext, primereact.tooltip);
