...
var Fieldset = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Fieldset, [{
    ...
    value: function renderToggleIcon(collapsed) {
      if (this.props.toggleable) {
        var className = utils.classNames('p-fieldset-toggler pi', {
          'pi-plus': collapsed,
          'pi-minus': !collapsed
        });
    ...
    value: function renderLegendContent(collapsed) {
      if (this.props.toggleable) {
        ...
        }, this.props.legend), /*#__PURE__*/React__default["default"].createElement(ripple.Ripple, null));
      }
    ...
    value: function render() {
      var className = utils.classNames('p-fieldset p-component', this.props.className, {
