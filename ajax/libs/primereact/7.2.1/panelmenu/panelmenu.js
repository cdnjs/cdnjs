...
this.primereact.panelmenu = (function (exports, React, utils, csstransition) {
  'use strict';
  ...
  var PanelMenuSub = /*#__PURE__*/function (_Component) {
    ...
    _createClass(PanelMenuSub, [{
      ...
      value: function renderSubmenu(item, active) {
        var submenuWrapperClassName = utils.classNames('p-toggleable-content', {
      ...
      value: function render() {
        var className = utils.classNames('p-submenu-list', this.props.className);
    ...
    _createClass(PanelMenu, [{
      ...
      value: function renderPanel(item, index) {
        ...
        return /*#__PURE__*/React__default["default"].createElement("div", {
          ...
          style: item.style
        }, content), /*#__PURE__*/React__default["default"].createElement(csstransition.CSSTransition, {
      ...
      key: "render",
      value: function render() {
        var className = utils.classNames('p-panelmenu p-component', this.props.className);
