  ...
  _createClass(TreeTableBody, [{
    ...
    value: function renderEmptyMessage() {
      if (this.props.loading) {
        ...
        var content = this.props.emptyMessage || PrimeReact.localeOption('emptyMessage');
    ...
    value: function sortNodes(data) {
      ...
      if (this.columnSortable && this.columnSortable === 'custom' && this.columnSortFunction) {
        ...
        value.sort(function (node1, node2) {
          ...
          return utils.ObjectUtils.sort(value1, value2, _this2.getSortOrder(), PrimeReact__default["default"].locale);
        });
