...
var BreadCrumb = /*#__PURE__*/function (_Component) {
  ...
  _createClass(BreadCrumb, [{
    ...
    value: function renderHome() {
      ...
      if (this.props.home) {
        var className = utils.classNames('p-breadcrumb-home', {
          'p-disabled': this.props.home.disabled
        }, this.props.home.className);
        var iconClassName = utils.classNames('p-menuitem-icon', this.props.home.icon);
    ...
    value: function render() {
      var className = utils.classNames('p-breadcrumb p-component', this.props.className);
