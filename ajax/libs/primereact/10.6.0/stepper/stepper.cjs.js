...
var ComponentBase = {
  ...
  extend: function extend() {
    ...
    var css = props.css;
    var defaultProps = _objectSpread$3(_objectSpread$3({}, props.defaultProps), ComponentBase.defaultProps);
    var inlineStyles = {};
    ...
    var getPTValue = function getPTValue() {
      ...
      var datasetProps = !isTransition && _objectSpread$3(_objectSpread$3({}, fkey === 'root' && _defineProperty({}, "".concat(datasetPrefix, "name"), params.props && params.props.__parentMetadata ? utils.ObjectUtils.toFlatCase(params.props.__TYPE) : componentName)), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), fkey));
      ...
      }) : _objectSpread$3(_objectSpread$3(_objectSpread$3({}, globalPT), self), Object.keys(datasetProps).length ? datasetProps : {}) : _objectSpread$3(_objectSpread$3({}, self), Object.keys(datasetProps).length ? datasetProps : {});
    };
    var setMetaData = function setMetaData() {
      ...
      var ptm = function ptm() {
        ...
        return getPTValue((props || {}).pt, key, _objectSpread$3(_objectSpread$3({}, metadata), params));
      };
      ...
      var cx = function cx() {
        var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        return !isUnstyled() ? getOptionValue(css && css.classes, key, _objectSpread$3({
          props: props,
          state: state
        }, params)) : undefined;
      };
      var sx = function sx() {
        ...
        if (when) {
          ...
          var self = getOptionValue(css && css.inlineStyles, key, _objectSpread$3({
            props: props,
            state: state
          }, params));
          var base = getOptionValue(inlineStyles, key, _objectSpread$3({
            props: props,
            state: state
          }, params));
...
var _usePT = function _usePT(pt, callback, key, params) {
  ...
  if (pt !== null && pt !== void 0 && pt.hasOwnProperty('_usept')) {
    ...
    }) : _objectSpread$3(_objectSpread$3({}, originalValue), value) : value;
  }
  return fn(pt);
};
