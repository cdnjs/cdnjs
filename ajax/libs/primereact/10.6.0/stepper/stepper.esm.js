...
import { ObjectUtils, mergeProps, classNames, UniqueComponentId } from 'primereact/utils';
...
var ComponentBase = {
  ...
  extend: function extend() {
    ...
    var getPTValue = function getPTValue() {
      ...
      var datasetProps = !isTransition && _objectSpread$3(_objectSpread$3({}, fkey === 'root' && _defineProperty({}, "".concat(datasetPrefix, "name"), params.props && params.props.__parentMetadata ? ObjectUtils.toFlatCase(params.props.__TYPE) : componentName)), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), fkey));
...
var StepperBase = ComponentBase$1.extend({
  defaultProps: {
    __TYPE: 'Stepper',
    activeStep: 0,
