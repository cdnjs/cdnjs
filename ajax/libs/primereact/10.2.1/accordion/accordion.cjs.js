...
var Accordion = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
  ...
  var getTabPT = function getTabPT(tab, key, index) {
    ...
    return utils.mergeProps(ptm("accordiontab.".concat(key), {
      accordiontab: tabMetaData
    }), ptm("accordiontab.".concat(key), tabMetaData), ptmo(tab.props, key, tabMetaData));
  };
  ...
  var createTabHeader = function createTabHeader(tab, selected, index) {
    ...
    var headerProps = utils.mergeProps({
      className: utils.classNames(getTabProp(tab, 'headerClassName'), getTabProp(tab, 'className'), cx('tab.header', {
        selected: selected,
  ...
  var createTabContent = function createTabContent(tab, selected, index) {
    ...
    var toggleableContentProps = utils.mergeProps({
      id: contentId,
      ref: contentRef,
      className: utils.classNames(getTabProp(tab, 'contentClassName'), getTabProp(tab, 'className'), cx('tab.toggleablecontent')),
      style: style,
      role: 'region',
