...
this.primereact.cascadeselect = (function (exports, React, PrimeReact, componentbase, csstransition, hooks, chevrondown, overlayservice, portal, utils, angleright, ripple) {
  'use strict';
  ...
  var CascadeSelect = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    hooks.useOnEscapeKey(overlayRef, overlayVisibleState, function () {
      return hide();
    });
    var onOptionSelect = function onOptionSelect(event) {
      if (props.onChange) {
...
})({}, React, primereact.api, primereact.componentbase, primereact.csstransition, primereact.hooks, primereact.icons.chevrondown, primereact.overlayservice, primereact.portal, primereact.utils, primereact.icons.angleright, primereact.ripple);
