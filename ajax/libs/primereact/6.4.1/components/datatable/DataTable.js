  ...
  _createClass(DataTable, [{
    ...
    value: function onColumnDrop(e) {
      ...
      if (this.draggedColumnEl) {
        var dragIndex = _DomHandler.default.index(this.draggedColumnEl);

        var dropIndex = _DomHandler.default.index(this.findParentHeader(event.currentTarget));
        ...
        if (allowDrop) {
          ...
          var isSameColumn = function isSameColumn(col1, col2) {
            return col1.columnKey || col2.columnKey ? _ObjectUtils.default.equals(col1, col2, 'columnKey') : _ObjectUtils.default.equals(col1, col2, 'field');
          };
          ...
          _ObjectUtils.default.reorderArray(columns, dragColIndex, dropColIndex);
...
_defineProperty(DataTable, "propTypes", {
  ...
  showGridlines: _propTypes.default.bool,
  ...
  onColumnResizerClick: _propTypes.default.func,
  onColumnResizerDoubleClick: _propTypes.default.func,
  onSort: _propTypes.default.func,
  onPage: _propTypes.default.func,
  onFilter: _propTypes.default.func,
  onVirtualScroll: _propTypes.default.func,
  onAllRowsSelect: _propTypes.default.func,
  onAllRowsUnselect: _propTypes.default.func,
