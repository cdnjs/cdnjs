...
exports.MultiStateCheckbox = void 0;
...
var MultiStateCheckbox = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MultiStateCheckbox, [{
    ...
    value: function findSelectedOptionMap() {
      ...
      if (this.props.options) {
        ...
        index = this.props.options.findIndex(function (option) {
          return _ObjectUtils.default.equals(_this2.props.value, _this2.getOptionValue(option), key);
        });
    ...
    value: function renderIcon(option) {
      ...
      var className = (0, _ClassNames.classNames)('p-checkbox-icon p-c', _defineProperty({}, "".concat(icon), true));
      ...
      if (this.props.iconTemplate) {
        ...
        return _ObjectUtils.default.getJSXElement(this.props.iconTemplate, defaultOptions);
      }
    ...
    value: function render() {
      ...
      var containerClassName = (0, _ClassNames.classNames)('p-multistatecheckbox p-checkbox p-component', this.props.className);
      var boxClassName = (0, _ClassNames.classNames)('p-checkbox-box', {
        'p-highlight': !!option,
...
_defineProperty(MultiStateCheckbox, "propTypes", {
  ...
  iconTemplate: _propTypes.default.any,
