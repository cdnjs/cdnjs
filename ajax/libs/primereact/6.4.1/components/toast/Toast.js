  ...
  _createClass(Toast, [{
    ...
    value: function show(value) {
      if (value) {
        ...
        this.state.messages.length === 0 && _ZIndexUtils.ZIndexUtils.set('toast', this.container, this.props.baseZIndex);
        this.setState({
    ...
    value: function onExited() {
      this.state.messages.length === 0 && _ZIndexUtils.ZIndexUtils.clear(this.container);
