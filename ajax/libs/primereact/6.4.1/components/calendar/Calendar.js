  ...
  _createClass(Calendar, [{
    ...
    value: function showOverlay(type) {
      ...
      if (this.props.onVisibleChange) {
        ...
        this.setState({
          ...
          _OverlayEventBus.default.on('overlay-click', _this10.overlayEventListener);
        });
      }
    }
  }, {
    ...
    value: function hideOverlay(type, callback) {
      ...
      var _hideCallback = function _hideCallback() {
        ...
        _OverlayEventBus.default.off('overlay-click', _this11.overlayEventListener);
    ...
    value: function isNavIconClicked(target) {
      return _DomHandler.default.hasClass(target, 'p-datepicker-prev') || _DomHandler.default.hasClass(target, 'p-datepicker-prev-icon') || _DomHandler.default.hasClass(target, 'p-datepicker-next') || _DomHandler.default.hasClass(target, 'p-datepicker-next-icon');
    }
  }, {
    key: "onWindowResize",
    value: function onWindowResize() {
      if (this.isVisible() && !_DomHandler.default.isAndroid()) {
        this.hideOverlay();
      }
    }
  }, {
    ...
    value: function renderTitleMonthElement(month) {
      ...
      if (this.props.monthNavigator && this.props.view !== 'month') {
        ...
        var content = /*#__PURE__*/_react.default.createElement("select", {
        ...
        if (this.props.monthNavigatorTemplate) {
          ...
          return _ObjectUtils.default.getJSXElement(this.props.monthNavigatorTemplate, defaultContentOptions);
        }
    ...
    value: function renderTitleYearElement(year) {
      ...
      if (this.props.yearNavigator) {
        ...
        if (this.props.yearNavigatorTemplate) {
          ...
          return _ObjectUtils.default.getJSXElement(this.props.yearNavigatorTemplate, defaultContentOptions);
        }
...
_defineProperty(Calendar, "propTypes", {
  ...
  monthNavigatorTemplate: _propTypes.default.func,
  yearNavigatorTemplate: _propTypes.default.func,
