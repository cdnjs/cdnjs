...
var PrimeReactProvider = function PrimeReactProvider(props) {
  ...
  var _useState9 = React.useState(propsValue.cssTransition || true),
    _useState10 = _slicedToArray(_useState9, 2),
    cssTransition = _useState10[0],
    setCssTransition = _useState10[1];
  var _useState11 = React.useState(propsValue.autoZIndex || true),
    _useState12 = _slicedToArray(_useState11, 2),
    autoZIndex = _useState12[0],
    setAutoZIndex = _useState12[1];
  var _useState13 = React.useState(propsValue.hideOverlaysOnDocumentScrolling || false),
    _useState14 = _slicedToArray(_useState13, 2),
    hideOverlaysOnDocumentScrolling = _useState14[0],
    setHideOverlaysOnDocumentScrolling = _useState14[1];
  var _useState15 = React.useState(propsValue.nonce || null),
    _useState16 = _slicedToArray(_useState15, 2),
    nonce = _useState16[0],
    setNonce = _useState16[1];
  var _useState17 = React.useState(propsValue.nullSortOrder || 1),
    _useState18 = _slicedToArray(_useState17, 2),
    nullSortOrder = _useState18[0],
    setNullSortOrder = _useState18[1];
  var _useState19 = React.useState(propsValue.zIndex || {
      modal: 1100,
      overlay: 1000,
      menu: 1000,
      tooltip: 1100,
  ...
  var _useState21 = React.useState(propsValue.ptOptions || {
      mergeSections: true,
      mergeProps: true
    }),
  ...
  var _useState23 = React.useState(propsValue.pt || undefined),
    ...
    pt = _useState24[0],
    setPt = _useState24[1];
  var _useState25 = React.useState(propsValue.unstyled || false),
    _useState26 = _slicedToArray(_useState25, 2),
    unstyled = _useState26[0],
    setUnstyled = _useState26[1];
  var _useState27 = React.useState(propsValue.filterMatchModeOptions || {
      text: [FilterMatchMode.STARTS_WITH, FilterMatchMode.CONTAINS, FilterMatchMode.NOT_CONTAINS, FilterMatchMode.ENDS_WITH, FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS],
      numeric: [FilterMatchMode.EQUALS, FilterMatchMode.NOT_EQUALS, FilterMatchMode.LESS_THAN, FilterMatchMode.LESS_THAN_OR_EQUAL_TO, FilterMatchMode.GREATER_THAN, FilterMatchMode.GREATER_THAN_OR_EQUAL_TO],
      date: [FilterMatchMode.DATE_IS, FilterMatchMode.DATE_IS_NOT, FilterMatchMode.DATE_BEFORE, FilterMatchMode.DATE_AFTER]
    }),
