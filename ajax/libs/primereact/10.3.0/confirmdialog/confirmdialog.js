...
this.primereact.confirmdialog = (function (exports, React, api, button, dialog, hooks, overlayservice, portal, utils, componentbase) {
  'use strict';
  ...
  var ConfirmDialog = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var getPropValue = function getPropValue(key) {
      return Object.assign(props, confirmProps.current)[key];
    };
...
})({}, React, primereact.api, primereact.button, primereact.dialog, primereact.hooks, primereact.overlayservice, primereact.portal, primereact.utils, primereact.componentbase);
