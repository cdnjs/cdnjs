...
var BodyCell = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createElement = function createElement() {
    ...
    var cellClassName = utils.ObjectUtils.getPropValue(props.cellClassName, value, {
      props: props.tableProps,
      rowData: props.rowData,
      column: props.column
    });
    var className = utils.classNames(getColumnProp('bodyClassName'), getColumnProp('className'), cellClassName, _defineProperty({
...
var TableBody = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var createExpansion = function createExpansion(rowData, index, expanded, colSpan) {
    if (expanded && !(isSubheaderGrouping && props.expandableRowGroups)) {
      var _content3 = utils.ObjectUtils.getJSXElement(props.rowExpansionTemplate, rowData, {
        index: index
      });
