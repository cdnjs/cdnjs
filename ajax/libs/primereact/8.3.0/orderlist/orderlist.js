...
this.primereact.orderlist = (function (exports, React, hooks, api, utils, button, ripple) {
  'use strict';
    ...
    var createItems = function createItems() {
      if (props.value) {
        return props.value.map(function (item, i) {
          ...
          if (props.dragdrop) {
            var items = [createDropPoint(i, key + '_droppoint'), /*#__PURE__*/React__namespace.createElement("li", {
              key: key,
...
})({}, React, primereact.hooks, primereact.api, primereact.utils, primereact.button, primereact.ripple);
