...
this.primereact.virtualscroller = (function (exports, React, core) {
  'use strict';
  ...
  var VirtualScroller = /*#__PURE__*/function (_Component) {
    ...
    _createClass(VirtualScroller, [{
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        if (!core.ObjectUtils.equals(prevProps.itemSize, this.props.itemSize) || !prevProps.items || prevProps.items.length !== (this.props.items || []).length) {
          this.init();
        }
      ...
      value: function renderItem(item, index) {
        ...
        var content = core.ObjectUtils.getJSXElement(this.props.itemTemplate, item, options);
        return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, {
          key: options.index
        }, content);
      }
      ...
      value: function renderContent() {
        ...
        var className = core.classNames('p-virtualscroller-content', {
      ...
      value: function render() {
        ...
        if (this.props.disabled) {
          var content = core.ObjectUtils.getJSXElement(this.props.contentTemplate, {
