...
this.primereact.treetable = (function (exports, React, api, core, paginator, inputtext) {
  'use strict';
  ...
  var TreeTableBodyCell = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTableBodyCell, [{
      ...
      value: function render() {
        ...
        if (this.state && this.state.editing) {
          if (this.props.editor) content = core.ObjectUtils.getJSXElement(this.props.editor, {
            node: this.props.node,
            rowData: this.props.node.data,
            value: core.ObjectUtils.resolveFieldData(this.props.node.data, this.props.field),
            field: this.props.field,
            rowIndex: this.props.rowIndex,
            props: this.props
          });else throw new Error("Editor is not found on column.");
        } else {
          if (this.props.body) content = core.ObjectUtils.getJSXElement(this.props.body, this.props.node, {
            field: this.props.field,
            rowIndex: this.props.rowIndex,
            props: this.props
          });else content = core.ObjectUtils.resolveFieldData(this.props.node.data, this.props.field);
        }
        /* eslint-disable */
...
}({}, React, primereact.api, primereact.core, primereact.paginator, primereact.inputtext));
