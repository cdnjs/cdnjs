...
var CascadeSelectSub = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createOption = function createOption(option, index) {
    ...
    var icon = props.optionGroupIcon || /*#__PURE__*/React__namespace.createElement(angleright.AngleRightIcon, {
      className: iconClassName
    });
    var optionGroup = isOptionGroup(option) && utils.IconUtils.getJSXIcon(icon, {
      className: iconClassName
    }, {
      props: props
    });
