...
this.primereact.autocomplete = (function (exports, React, PrimeReact, button, hooks, chevrondown, spinner, timescircle, inputtext, overlayservice, tooltip, utils, csstransition, portal, ripple, virtualscroller) {
  'use strict';
  ...
  var AutoCompleteBase = {
    ...
    getProps: function getProps(props) {
      return utils.ObjectUtils.getMergedProps(props, AutoCompleteBase.defaultProps);
    },
    getOtherProps: function getOtherProps(props) {
      return utils.ObjectUtils.getDiffProps(props, AutoCompleteBase.defaultProps);
    }
  };
