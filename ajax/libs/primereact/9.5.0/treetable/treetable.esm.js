...
var TreeTableRow = /*#__PURE__*/React.memo(function (props) {
  ...
  var createToggler = function createToggler() {
    ...
    var icon = expanded ? /*#__PURE__*/React.createElement(ChevronDownIcon, iconProps) : /*#__PURE__*/React.createElement(ChevronRightIcon, iconProps);
    var togglerIcon = IconUtils.getJSXIcon(props.togglerIcon || icon, _objectSpread$2({}, iconProps), {
      props: props
    });
    var style = {
...
var TreeTableHeader = /*#__PURE__*/React.memo(function (props) {
  ...
  var createHeaderCell = function createHeaderCell(column, options) {
    ...
    if (options.filterOnly) {
      ...
      }, resizer, title, sortIconElement, sortBadge, filterElement), hasTooltip && /*#__PURE__*/React.createElement(Tooltip, _extends({
...
var TreeTable = /*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var reorderIndicatorUpIcon = props.reorderableColumns && IconUtils.getJSXIcon(props.reorderIndicatorUpIcon || /*#__PURE__*/React.createElement(ArrowDownIcon, null), undefined, {
    props: props
  });
