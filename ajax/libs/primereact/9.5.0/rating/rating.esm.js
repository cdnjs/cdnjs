...
var Rating = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var createIcons = function createIcons() {
    return Array.from({
      ...
      var icon = active ? {
        type: props.onIcon || /*#__PURE__*/React.createElement(StarFillIcon, {
          className: iconClassName
        })
      } : {
        type: props.offIcon || /*#__PURE__*/React.createElement(StarIcon, {
          className: iconClassName
        })
      };
  ...
  var createCancelIcon = function createCancelIcon() {
    if (props.cancel) {
      ...
      var icon = props.cancelIcon || /*#__PURE__*/React.createElement(BanIcon, {
        className: iconClassName
      });
      var content = IconUtils.getJSXIcon(icon, _objectSpread({
        className: {
