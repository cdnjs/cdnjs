...
this.primereact.menu = (function (exports, React, utils, csstransition, overlayservice, portal, PrimeReact) {
  'use strict';
  ...
  var Menu = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Menu, [{
      ...
      value: function bindDocumentListeners() {
        ...
        if (!this.documentResizeListener) {
          this.documentResizeListener = function (event) {
            if (_this4.state.visible && !utils.DomHandler.isAndroid()) {
              _this4.hide(event);
            }
          };
      ...
      value: function renderElement() {
        if (this.props.model) {
          var className = utils.classNames('p-menu p-component', this.props.className, {
...
})({}, React, primereact.utils, primereact.csstransition, primereact.overlayservice, primereact.portal, primereact.api);
