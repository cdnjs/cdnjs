...
this.primereact.datascroller = (function (exports, React, utils, api) {
  'use strict';
  ...
  var DataScroller = /*#__PURE__*/function (_Component) {
    ...
    _createClass(DataScroller, [{
      ...
      value: function renderEmptyMessage() {
        var content = utils.ObjectUtils.getJSXElement(this.props.emptyMessage, this.props) || api.localeOption('emptyMessage');
