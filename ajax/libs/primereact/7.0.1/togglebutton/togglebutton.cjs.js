...
var ToggleButton = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ToggleButton, [{
    ...
    value: function render() {
      ...
      if (hasIcon) {
        iconClassName = utils.classNames('p-button-icon p-c', {
      ...
      }, hasIcon && utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: this.props
      }), /*#__PURE__*/React__default["default"].createElement("span", {
        className: "p-button-label"
      }, label), /*#__PURE__*/React__default["default"].createElement(ripple.Ripple, null));
    }
  }]);
