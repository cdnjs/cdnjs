    ...
    value: function moveUp(event) {
      if (this.props.selection) {
        ...
        for (var i = 0; i < this.props.selection.length; i++) {
          ...
          var selectedItemIndex = utils.ObjectUtils.findIndexInList(selectedItem, value, this.props.dataKey);
...
var OrderListSubList = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OrderListSubList, [{
    ...
    value: function onDrop(event) {
      ...
      utils.ObjectUtils.reorderArray(value, this.draggedItemIndex, dropIndex);
      this.dragOverItemIndex = null;
      utils.DomHandler.removeClass(event.target, 'p-orderlist-droppoint-highlight');
    ...
    value: function onListMouseMove(event) {
      if (this.dragging) {
        var offsetY = this.listElement.getBoundingClientRect().top + utils.DomHandler.getWindowScrollTop();
...
var OrderList = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OrderList, [{
    ...
    value: function onItemClick(event) {
      ...
      var index = utils.ObjectUtils.findIndexInList(event.value, this.state.selection, this.props.dataKey);
    ...
    value: function updateListScroll() {
      var listItems = utils.DomHandler.find(this.subList.listElement, '.p-orderlist-item.p-highlight');

      if (listItems && listItems.length) {
        switch (this.reorderDirection) {
          case 'up':
            utils.DomHandler.scrollInView(this.subList.listElement, listItems[0]);
            break;
          ...
          case 'down':
            utils.DomHandler.scrollInView(this.subList.listElement, listItems[listItems.length - 1]);
            break;
    ...
    value: function render() {
      ...
      var className = utils.classNames('p-orderlist p-component', this.props.className);
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ref: function ref(el) {
