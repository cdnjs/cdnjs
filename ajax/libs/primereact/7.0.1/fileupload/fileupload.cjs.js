...
var FileUpload = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function onDragOver(event) {
      if (!this.props.disabled) {
        event.dataTransfer.dropEffect = "copy";
        utils.DomHandler.addClass(this.content, 'p-fileupload-highlight');
        event.stopPropagation();
        event.preventDefault();
      }
    }
    ...
    value: function onDragLeave(event) {
      if (!this.props.disabled) {
        event.dataTransfer.dropEffect = "copy";
        utils.DomHandler.removeClass(this.content, 'p-fileupload-highlight');
      }
    }
  }, {
    key: "onDrop",
    ...
    value: function renderChooseButton() {
      ...
      }), utils.IconUtils.getJSXIcon(icon || 'pi pi-fw pi-plus', {
    ...
    value: function renderFile(file, index) {
      ...
      if (this.props.itemTemplate) {
        ...
        content = utils.ObjectUtils.getJSXElement(this.props.itemTemplate, file, defaultContentOptions);
      }
    ...
    value: function renderEmptyContent() {
      if (this.props.emptyTemplate && !this.hasFiles()) {
        return utils.ObjectUtils.getJSXElement(this.props.emptyTemplate, this.props);
      }
    ...
    value: function renderProgressBarContent() {
      if (this.props.progressBarTemplate) {
        return utils.ObjectUtils.getJSXElement(this.props.progressBarTemplate, this.props);
      }
    ...
    value: function renderAdvanced() {
      ...
      var className = utils.classNames('p-fileupload p-fileupload-advanced p-component', this.props.className);
      var headerClassName = utils.classNames('p-fileupload-buttonbar', this.props.headerClassName);
      var contentClassName = utils.classNames('p-fileupload-content', this.props.contentClassName);
      ...
      if (this.props.headerTemplate) {
        ...
        header = utils.ObjectUtils.getJSXElement(this.props.headerTemplate, defaultContentOptions);
      }
    ...
    value: function renderBasic() {
      ...
      var className = utils.classNames('p-fileupload p-fileupload-basic p-component', this.props.className);
