...
this.primereact.listbox = (function (exports, React, api, utils, ripple, inputtext, tooltip, virtualscroller) {
  'use strict';
  ...
  var ListBoxItem = /*#__PURE__*/function (_Component) {
    ...
    _createClass(ListBoxItem, [{
      ...
      value: function findNextItem(item) {
        ...
        if (nextItem) return utils.DomHandler.hasClass(nextItem, 'p-disabled') || utils.DomHandler.hasClass(nextItem, 'p-listbox-item-group') ? this.findNextItem(nextItem) : nextItem;else return null;
      }
    }, {
      key: "findPrevItem",
      value: function findPrevItem(item) {
        var prevItem = item.previousElementSibling;
        if (prevItem) return utils.DomHandler.hasClass(prevItem, 'p-disabled') || utils.DomHandler.hasClass(prevItem, 'p-listbox-item-group') ? this.findPrevItem(prevItem) : prevItem;else return null;
      }
    }, {
      key: "render",
    ...
    _createClass(ListBox, [{
      ...
      value: function removeOption(option) {
        ...
        return this.props.value.filter(function (val) {
          return !utils.ObjectUtils.equals(val, _this2.getOptionValue(option), _this2.props.dataKey);
        });
      }
    }, {
      key: "isSelected",
          ...
          if (this.props.optionGroupLabel) {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                var filteredSubOptions = api.FilterService.filter(this.getOptionGroupChildren(optgroup), searchFields, filterValue, this.props.filterMatchMode, this.props.filterLocale);
            ...
            return api.FilterService.filter(this.props.options, searchFields, filterValue, this.props.filterMatchMode, this.props.filterLocale);
          }
        } else {
      ...
      value: function renderItem(option, index) {
        if (this.props.optionGroupLabel) {
          var groupContent = this.props.optionGroupTemplate ? utils.ObjectUtils.getJSXElement(this.props.optionGroupTemplate, option, index) : this.getOptionGroupLabel(option);
      ...
      value: function render() {
        ...
        var listClassName = utils.classNames('p-listbox-list-wrapper', this.props.listClassName);
...
})({}, React, primereact.api, primereact.utils, primereact.ripple, primereact.inputtext, primereact.tooltip, primereact.virtualscroller);
