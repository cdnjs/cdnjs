...
var DataTable = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var onColumnHeaderDragStart = function onColumnHeaderDragStart(e) {
    ...
    colReorderIconWidth = utils.DomHandler.getHiddenElementOuterWidth(reorderIndicatorUpRef.current);
    colReorderIconHeight = utils.DomHandler.getHiddenElementOuterHeight(reorderIndicatorUpRef.current);
