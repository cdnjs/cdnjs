...
var TabView = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
  ...
  var _findNextHeaderAction = function findNextHeaderAction(tabElement) {
    ...
    return headerElement ? utils.DomHandler.getAttribute(headerElement, 'data-p-disabled') || utils.DomHandler.getAttribute(headerElement, 'data-pc-section') === 'inkbar' ? _findNextHeaderAction(headerElement) : utils.DomHandler.findSingle(headerElement, '[data-pc-section="headeraction"]') : null;
  };
  var _findPrevHeaderAction = function findPrevHeaderAction(tabElement) {
    ...
    return headerElement ? utils.DomHandler.getAttribute(headerElement, 'data-p-disabled') || utils.DomHandler.getAttribute(headerElement, 'data-pc-section') === 'inkbar' ? _findPrevHeaderAction(headerElement) : utils.DomHandler.findSingle(headerElement, '[data-pc-section="headeraction"]') : null;
  };
  ...
  var createTabHeader = function createTabHeader(tab, index) {
    ...
    var closeIconProps = mergeProps({
      ...
      tabIndex: 0,
      'aria-label': api.ariaLabel('close') || 'Close'
