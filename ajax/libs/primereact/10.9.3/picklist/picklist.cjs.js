    ...
    switch (event.code) {
      ...
      case 'KeyA':
        if (event.ctrlKey) {
          ...
          _onSelectionChange({
            originalEvent: event,
            value: isSource ? _toConsumableArray(sourceList) : _toConsumableArray(targetList)
      ...
      case 'KeyD':
        if (event.ctrlKey) {
          ...
          _onSelectionChange({
            originalEvent: event,
            value: []
          }, _isSource ? 'sourceSelection' : 'targetSelection', _isSource ? props.onSourceSelectionChange : props.onTargetSelectionChange);
          event.preventDefault();
        }
        break;
    }
