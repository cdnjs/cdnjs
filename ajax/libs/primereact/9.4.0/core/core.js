...
this.primereact = this.primereact || {};
this.primereact.checkbox = (function (exports, React, hooks, check, tooltip, utils) {
  'use strict';
...
})({}, React, primereact.hooks, primereact.icons.check, primereact.tooltip, primereact.utils);
...
this.primereact = this.primereact || {};
this.primereact.progressbar = (function (exports, React, utils, componentbase) {
    'use strict';
...
this.primereact = this.primereact || {};
this.primereact.dropdown = (function (exports, React, PrimeReact, hooks, chevrondown, times, overlayservice, tooltip, utils, csstransition, portal, virtualscroller, ripple, search) {
  'use strict';
...
})({}, React, primereact.api, primereact.hooks, primereact.icons.chevrondown, primereact.icons.times, primereact.overlayservice, primereact.tooltip, primereact.utils, primereact.csstransition, primereact.portal, primereact.virtualscroller, primereact.ripple, primereact.icons.search);
