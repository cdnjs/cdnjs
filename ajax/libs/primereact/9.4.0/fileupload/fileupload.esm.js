...
import { ObjectUtils, classNames, mergeProps, IconUtils, DomHandler } from 'primereact/utils';
...
var FileUpload = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var createChooseButton = function createChooseButton() {
    ...
    var icon = _icon || /*#__PURE__*/React.createElement(PlusIcon, {
      className: iconClassName
    });
    var chooseIcon = IconUtils.getJSXIcon(icon, {
      className: iconClassName
    }, {
      props: props
    });
    return /*#__PURE__*/React.createElement("span", {
      ...
      onBlur: onBlur,
      tabIndex: 0
    }, input, chooseIcon, label, /*#__PURE__*/React.createElement(Ripple, null));
  };
  ...
  var createAdvanced = function createAdvanced() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon = IconUtils.getJSXIcon(uploadOptions.icon || /*#__PURE__*/React.createElement(UploadIcon, {
      ...
      var cancelIcon = IconUtils.getJSXIcon(cancelOptions.icon || /*#__PURE__*/React.createElement(TimesIcon, {
  ...
  var createBasic = function createBasic() {
    ...
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? /*#__PURE__*/React.createElement(PlusIcon, {
      className: iconClassName
    }) : !chooseOptions.icon && hasFiles && !props.auto && /*#__PURE__*/React.createElement(UploadIcon, {
      className: iconClassName
    });
    var labelClassName = 'p-button-label p-clickable';
    ...
    return /*#__PURE__*/React.createElement("div", _extends({
      ...
      onBlur: onBlur,
      tabIndex: 0
    }, chooseIcon, label, input, /*#__PURE__*/React.createElement(Ripple, null)));
  };
