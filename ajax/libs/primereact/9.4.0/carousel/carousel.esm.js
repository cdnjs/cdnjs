...
var Carousel = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(function (inProps, ref) {
  ...
  var createBackwardNavigator = function createBackwardNavigator() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.prevIcon || /*#__PURE__*/React.createElement(ChevronUpIcon, {
      ...
      }, backwardNavigatorIcon, /*#__PURE__*/React.createElement(Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator() {
    if (props.showNavigators) {
      ...
      var icon = isVertical ? props.nextIcon || /*#__PURE__*/React.createElement(ChevronDownIcon, {
        className: iconClassName
      ...
      }, forwardNavigatorIcon, /*#__PURE__*/React.createElement(Ripple, null));
    }
    return null;
  };
