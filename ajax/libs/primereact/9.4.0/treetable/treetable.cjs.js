...
var TreeTableRow = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createToggler = function createToggler() {
    ...
    var icon = expanded ? /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, iconProps) : /*#__PURE__*/React__namespace.createElement(chevronright.ChevronRightIcon, iconProps);
    var togglerIcon = utils.IconUtils.getJSXIcon(props.togglerIcon || icon, _objectSpread$2({}, iconProps), {
      props: props
    });
    var style = {
...
var TreeTableHeader = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createSortIcon = function createSortIcon(column, sorted, sortOrder) {
    if (getColumnProp(column, 'sortable')) {
      ...
      var icon = sorted ? sortOrder < 0 ? /*#__PURE__*/React__namespace.createElement(sortamountdown.SortAmountDownIcon, {
        className: iconClassName
      }) : /*#__PURE__*/React__namespace.createElement(sortamountupalt.SortAmountUpAltIcon, {
        className: iconClassName
      }) : /*#__PURE__*/React__namespace.createElement(sortalt.SortAltIcon, {
        className: iconClassName
      });
  ...
  var createHeaderCell = function createHeaderCell(column, options) {
    ...
    if (options.filterOnly) {
      ...
      }, resizer, title, sortIconElement, sortBadge, filterElement), hasTooltip && /*#__PURE__*/React__namespace.createElement(tooltip.Tooltip, _extends({
...
var TreeTable = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
  ...
  var reorderIndicatorUpIcon = props.reorderableColumns && utils.IconUtils.getJSXIcon(props.reorderIndicatorUpIcon || /*#__PURE__*/React__namespace.createElement(arrowdown.ArrowDownIcon, null), undefined, {
    props: props
  });
  ...
  var reorderIndicatorDownIcon = utils.IconUtils.getJSXIcon(props.reorderIndicatorDownIcon || /*#__PURE__*/React__namespace.createElement(arrowup.ArrowUpIcon, null), undefined, {
    props: props
  });
