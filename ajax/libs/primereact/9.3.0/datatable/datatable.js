...
this.primereact.datatable = (function (exports, React, PrimeReact, utils, hooks, paginator, virtualscroller, overlayservice, ripple, check, times, pencil, chevrondown, chevronright, bars, button, csstransition, dropdown, inputtext, portal, filter, filterslash, trash, plus, tooltip, sortalt, sortamountdown, sortamountupalt, spinner, arrowdown, arrowup) {
  'use strict';
