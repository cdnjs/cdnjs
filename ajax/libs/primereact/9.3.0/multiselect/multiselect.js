...
this.primereact.multiselect = (function (exports, React, PrimeReact, hooks, overlayservice, tooltip, utils, csstransition, portal, virtualscroller, check, inputtext, ripple, times, search, timescircle, chevrondown) {
  'use strict';
  ...
  var MultiSelectHeader = /*#__PURE__*/React__namespace.memo(function (props) {
    ...
    var checkboxIconClassName = 'p-checkbox-icon p-c';
    var checkedIcon = props.itemCheckboxIcon || /*#__PURE__*/React__namespace.createElement(check.CheckIcon, {
      className: checkboxIconClassName
    });
    var itemCheckboxIcon = utils.IconUtils.getJSXIcon(checkedIcon, {
      className: checkboxIconClassName
    }, {
    ...
    var closeIcon = utils.IconUtils.getJSXIcon(icon, _objectSpread$2({}, iconProps), {
      props: props
    });
    ...
    }, closeIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
  ...
  var MultiSelectItem = /*#__PURE__*/React__namespace.memo(function (props) {
    ...
    }, checkboxIcon)), /*#__PURE__*/React__namespace.createElement("span", null, content), /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
  });
  ...
  var MultiSelect = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
      ...
      if (props.selectedItemTemplate) {
        ...
        if (props.display === 'chip' && !empty) {
          ...
          return value.map(function (val) {
            ...
            var icon = !props.disabled && (props.removeIcon ? utils.IconUtils.getJSXIcon(props.removeIcon, {
              ...
              props: props
            }) : /*#__PURE__*/React__namespace.createElement(timescircle.TimesCircleIcon, {
              className: "p-multiselect-token-icon",
              onClick: function onClick(e) {
                return removeChip(e, val);
              }
    ...
    var createClearIcon = function createClearIcon() {
      var iconClassName = 'p-multiselect-clear-icon';
      var icon = props.clearIcon || /*#__PURE__*/React__namespace.createElement(times.TimesIcon, {
        className: iconClassName
      });
      var clearIcon = utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
    ...
    var dropdownIcon = /*#__PURE__*/React__namespace.createElement("div", {
      className: "p-multiselect-trigger"
    }, props.dropdownIcon ? utils.IconUtils.getJSXIcon(props.dropdownIcon, {
      className: dropdownIconClass
    }, {
      props: props
    }) : /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, {
      className: dropdownIconClass
    }));
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("div", _extends({
      ...
      disabled: props.disabled,
      tabIndex: props.tabIndex
    }, ariaProps))), !props.inline && /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, label, clearIcon, dropdownIcon), /*#__PURE__*/React__namespace.createElement(MultiSelectPanel, _extends({
      ref: overlayRef,
...
})({}, React, primereact.api, primereact.hooks, primereact.overlayservice, primereact.tooltip, primereact.utils, primereact.csstransition, primereact.portal, primereact.virtualscroller, primereact.icons/check, primereact.inputtext, primereact.ripple, primereact.icons/times, primereact.icons/search, primereact.icons/timescircle, primereact.icons/chevrondown);
