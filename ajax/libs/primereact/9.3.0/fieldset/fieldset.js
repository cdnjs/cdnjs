...
this.primereact.fieldset = (function (exports, React, csstransition, hooks, ripple, utils, plus, minus) {
  'use strict';
  ...
  var FieldsetBase = {
    ...
    getProps: function getProps(props) {
      return utils.ObjectUtils.getMergedProps(props, FieldsetBase.defaultProps);
    },
    getOtherProps: function getOtherProps(props) {
      return utils.ObjectUtils.getDiffProps(props, FieldsetBase.defaultProps);
    }
  };
  ...
  var Fieldset = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createToggleIcon = function createToggleIcon() {
      if (props.toggleable) {
        var iconClassName = 'p-fieldset-toggler';
        var icon = collapsed ? props.expandIcon || /*#__PURE__*/React__namespace.createElement(plus.PlusIcon, {
          className: iconClassName
        }) : props.collapseIcon || /*#__PURE__*/React__namespace.createElement(minus.MinusIcon, {
          className: iconClassName
        });
...
})({}, React, primereact.csstransition, primereact.hooks, primereact.ripple, primereact.utils, primereact.icons/plus, primereact.icons/minus);
