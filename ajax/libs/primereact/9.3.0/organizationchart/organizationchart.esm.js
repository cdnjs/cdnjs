...
var OrganizationChartNode = /*#__PURE__*/React.memo(function (props) {
  ...
  var createToggler = function createToggler() {
    if (!leaf) {
      ...
      var icon;
      if (expandedState) {
        icon = props.togglerIcon || /*#__PURE__*/React.createElement(ChevronDownIcon, {
          className: iconClassName
        });
      } else {
        icon = props.togglerIcon || /*#__PURE__*/React.createElement(ChevronUpIcon, {
          className: iconClassName
        });
      }
      var togglerIcon = IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
      return (
        ...
        }, /*#__PURE__*/React.createElement("i", null, " ", togglerIcon, " "))
        /* eslint-enable */
      );
    }
