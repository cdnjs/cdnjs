  ...
  _createClass(SplitButtonItem, [{
    ...
    value: function renderMenuitem() {
      ...
      if (template) {
        ...
        content = utils.ObjectUtils.getJSXElement(template, this.props.menuitem, defaultContentOptions);
      }
...
var SplitButtonPanelComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SplitButtonPanelComponent, [{
    ...
    value: function renderElement() {
      var className = utils.classNames('p-menu p-menu-overlay p-component', this.props.menuClassName);
...
var SplitButton = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SplitButton, [{
    ...
    value: function alignOverlay() {
      utils.DomHandler.alignOverlay(this.overlayRef.current, this.defaultButton.parentElement, this.props.appendTo || PrimeReact__default["default"].appendTo);
    }
  }, {
    ...
    value: function render() {
      ...
      var className = utils.classNames('p-splitbutton p-component', this.props.className, {
        'p-disabled': this.props.disabled
      });
      var buttonClassName = utils.classNames('p-splitbutton-defaultbutton', this.props.buttonClassName);
      var menuButtonClassName = utils.classNames('p-splitbutton-menubutton', this.props.menuButtonClassName);
      var items = this.renderItems();
      var buttonContent = this.props.buttonTemplate ? utils.ObjectUtils.getJSXElement(this.props.buttonTemplate, this.props) : null;
