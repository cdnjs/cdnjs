...
this.primereact.menubar = (function (exports, React, utils, ripple, PrimeReact) {
  'use strict';
      ...
      value: function toggle(event) {
        ...
        this.setState(function (prevState) {
          ...
          if (_this2.state.mobileActive) {
            utils.ZIndexUtils.set('menu', _this2.rootmenu, PrimeReact__default["default"].autoZIndex, PrimeReact__default["default"].zIndex['menu']);
...
})({}, React, primereact.utils, primereact.ripple, primereact.api);
