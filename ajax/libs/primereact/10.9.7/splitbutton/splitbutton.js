...
this.primereact.splitbutton = (function (exports, React, PrimeReact, button, componentbase, hooks, chevrondown, overlayservice, csstransition, portal, utils, angleright, ripple, tooltip) {
  ...
  var SplitButton = /*#__PURE__*/React__namespace.memo(/*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var _React$useState = React__namespace.useState((_props$id = props.id) !== null && _props$id !== void 0 ? _props$id : utils.UniqueComponentId),
      _React$useState2 = _slicedToArray(_React$useState, 2),
      idState = _React$useState2[0],
      setIdState = _React$useState2[1];
    ...
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("div", rootProps, /*#__PURE__*/React__namespace.createElement(button.Button, _extends({
      ...
      className: utils.classNames(props.menuClassName, cx('menu')),
      onClick: onPanelClick,
      onShow: onMenuShow,
      onHide: onMenuHide,
      pt: ptm('menu'),
