...
this.primereact=this.primereact||{},this.primereact.hooks=function(e,t,r){"use strict";function n(e){if(e&&e.__esModule)return e;var t=Object.create(null);return e&&Object.keys(e).forEach((function(r){if("default"!==r){var n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,n.get?n:{enumerable:!0,get:function(){return e[r]}})}})),t.default=e,Object.freeze(t)}var u=n(t),c=function(e){var t=u.useRef(void 0);return u.useEffect((function(){t.current=e})),t.current},i=function(e){return u.useEffect((function(){return e}),[])},o=function(e){var t=e.target,n=void 0===t?"document":t,o=e.type,f=e.listener,l=e.options,a=e.when,s=void 0===a||a,v=u.useRef(null),d=u.useRef(null),g=c(l),m=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};r.ObjectUtils.isNotEmpty(e.target)&&(E(),(e.when||s)&&(v.current=r.DomHandler.getTargetElement(e.target))),!d.current&&v.current&&(d.current=function(e){return f&&f(e)},v.current.addEventListener(o,d.current,l))},E=function(){d.current&&(v.current.removeEventListener(o,d.current,l),d.current=null)};return u.useEffect((function(){s?v.current=r.DomHandler.getTargetElement(n):(E(),v.current=null)}),[n,s]),u.useEffect((function(){!d.current||d.current===f&&g===l||(E(),s&&m())}),[f,l]),i((function(){E()})),[m,E]};function f(e){if(Array.isArray(e))return e}function l(e,t){var r=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=r){var n,u,c=[],i=!0,o=!1;try{for(r=r.call(e);!(i=(n=r.next()).done)&&(c.push(n.value),!t||c.length!==t);i=!0);}catch(e){o=!0,u=e}finally{try{i||null==r.return||r.return()}finally{if(o)throw u}}return c}}function a(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function s(e,t){if(e){if("string"==typeof e)return a(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?a(e,t):void 0}}function v(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function d(e,t){return f(e)||l(e,t)||s(e,t)||v()}var g=function(e){var t=e.target,n=e.listener,o=e.options,f=e.when,l=void 0===f||f,a=u.useRef(null),s=u.useRef(null),v=u.useRef([]),d=c(o),g=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(r.ObjectUtils.isNotEmpty(e.target)&&(m(),(e.when||l)&&(a.current=r.DomHandler.getTargetElement(e.target))),!s.current&&a.current){var t=v.current=r.DomHandler.getScrollableParents(a.current);s.current=function(e){return n&&n(e)},t.forEach((function(e){return e.addEventListener("scroll",s.current,o)}))}},m=function(){s.current&&(v.current.forEach((function(e){return e.removeEventListener("scroll",s.current,o)})),s.current=null)};return u.useEffect((function(){l?a.current=r.DomHandler.getTargetElement(t):(m(),a.current=null)}),[t,l]),u.useEffect((function(){!s.current||s.current===n&&d===o||(m(),l&&g())}),[n,o]),i((function(){m()})),[g,m]},m=function(e){return o({target:"window",type:"resize",listener:e.listener})};return e.useEventListener=o,e.useInterval=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,r=!(arguments.length>2&&void 0!==arguments[2])||arguments[2],n=u.useRef(null),c=u.useRef(null),o=u.useCallback((function(){return clearInterval(n.current)}),[n.current]);return u.useEffect((function(){c.current=e})),u.useEffect((function(){if(r)return n.current=setInterval((function(){c.current()}),t),o;o()}),[t,r]),i((function(){o()})),[o]},e.useMountEffect=function(e){return u.useEffect(e,[])},e.useOverlayListener=function(e){var t=e.target,n=e.overlay,c=e.listener,f=e.when,l=void 0===f||f,a=u.useRef(null),s=u.useRef(null),v=d(o({type:"click",listener:function(e){c&&c(e,{type:"outside",valid:3!==e.which&&j(e)})}}),2),E=v[0],y=v[1],h=d(m({listener:function(e){c&&c(e,{type:"resize",valid:!r.DomHandler.isTouchDevice()})}}),2),p=h[0],b=h[1],R=d(g({target:a,listener:function(e){c&&c(e,{type:"scroll",valid:!0})}}),2),w=R[0],O=R[1],j=function(e){return a.current&&!(a.current.isSameNode(e.target)||a.current.contains(e.target)||s.current&&s.current.contains(e.target))},T=function(){y(),b(),O()};return u.useEffect((function(){l?(a.current=r.DomHandler.getTargetElement(t),s.current=r.DomHandler.getTargetElement(n)):(T(),a.current=s.current=null)}),[t,n,l]),u.useEffect((function(){T()}),[l]),i((function(){T()})),[function(){E(),p(),w()},T]},e.useOverlayScrollListener=g,e.usePrevious=c,e.useResizeListener=m,e.useTimeout=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,r=!(arguments.length>2&&void 0!==arguments[2])||arguments[2],n=u.useRef(null),c=u.useRef(null),o=u.useCallback((function(){return clearTimeout(n.current)}),[n.current]);return u.useEffect((function(){c.current=e})),u.useEffect((function(){if(r)return n.current=setTimeout((function(){c.current()}),t),o;o()}),[t,r]),i((function(){o()})),[o]},e.useUnmountEffect=i,e.useUpdateEffect=function(e,t){var r=u.useRef(!1);return u.useEffect((function(){if(r.current)return e&&e();r.current=!0}),t)},Object.defineProperty(e,"__esModule",{value:!0}),e}({},React,primereact.utils);
