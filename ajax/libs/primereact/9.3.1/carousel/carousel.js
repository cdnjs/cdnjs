...
this.primereact.carousel = (function (exports, React, PrimeReact, hooks, ripple, utils, chevronup, chevronright, chevrondown, chevronleft) {
  'use strict';
  ...
  var Carousel = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createBackwardNavigator = function createBackwardNavigator() {
      if (props.showNavigators) {
        ...
        var icon = isVertical ? props.prevIcon || /*#__PURE__*/React__namespace.createElement(chevronup.ChevronUpIcon, {
        ...
        }, backwardNavigatorIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
      }
      return null;
    };
    var createForwardNavigator = function createForwardNavigator() {
      if (props.showNavigators) {
        ...
        var icon = isVertical ? props.nextIcon || /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, {
          className: iconClassName
        ...
        }, forwardNavigatorIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
      }
      return null;
    };
...
})({}, React, primereact.api, primereact.hooks, primereact.ripple, primereact.utils, primereact.icons.chevronup, primereact.icons.chevronright, primereact.icons.chevrondown, primereact.icons.chevronleft);
