...
this.primereact.accordion = (function (exports, React, api, csstransition, hooks, utils, chevronright, chevrondown) {
  ...
  var Accordion = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createTabHeader = function createTabHeader(tab, selected, index) {
      ...
      var icon = selected ? props.collapseIcon || /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, {
        className: iconClassName
      }) : props.expandIcon || /*#__PURE__*/React__namespace.createElement(chevronright.ChevronRightIcon, {
        className: iconClassName
      });
