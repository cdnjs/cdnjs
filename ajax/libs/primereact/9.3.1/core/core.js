...
this.primereact = this.primereact || {};
this.primereact.messages = (function (exports, React, reactTransitionGroup, csstransition, utils, api, hooks, check, exclamationtriangle, infocircle, times, timescircle, ripple) {
  'use strict';
...
})({}, React, ReactTransitionGroup, primereact.csstransition, primereact.utils, primereact.api, primereact.hooks, primereact.icons.check, primereact.icons.exclamationtriangle, primereact.icons.infocircle, primereact.icons.times, primereact.icons.timescircle, primereact.ripple);
