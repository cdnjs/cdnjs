...
var GalleriaItem = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var createBackwardNavigator = function createBackwardNavigator() {
    if (props.showItemNavigators) {
      ...
      var icon = props.itemPrevIcon || /*#__PURE__*/React__namespace.createElement(chevronleft.ChevronLeftIcon, {
        className: iconClassName
      });
      var itemPrevIcon = utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
      return /*#__PURE__*/React__namespace.createElement("button", {
        ...
        onClick: navBackward,
        disabled: isDisabled
      }, itemPrevIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator() {
    if (props.showItemNavigators) {
      ...
      var icon = props.itemNextIcon || /*#__PURE__*/React__namespace.createElement(chevronright.ChevronRightIcon, {
        className: iconClassName
      });
      var itemNextIcon = utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
      return /*#__PURE__*/React__namespace.createElement("button", {
        ...
        onClick: navForward,
        disabled: isDisabled
      }, itemNextIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
    }
    return null;
  };
...
var GalleriaThumbnails = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var createBackwardNavigator = function createBackwardNavigator() {
    if (props.showThumbnailNavigators) {
      ...
      var icon = props.isVertical ? props.prevThumbnailIcon || /*#__PURE__*/React__namespace.createElement(chevronup.ChevronUpIcon, {
        className: iconClassName
      }) : props.prevThumbnailIcon || /*#__PURE__*/React__namespace.createElement(chevronleft.ChevronLeftIcon, {
        className: iconClassName
      });
      var prevThumbnailIcon = utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
      return /*#__PURE__*/React__namespace.createElement("button", {
        ...
        onClick: navBackward,
        disabled: isDisabled
      }, prevThumbnailIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
    }
    return null;
  };
  var createForwardNavigator = function createForwardNavigator() {
    if (props.showThumbnailNavigators) {
      ...
      var icon = props.isVertical ? props.nextThumbnailIcon || /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, {
        className: iconClassName
      }) : props.nextThumbnailIcon || /*#__PURE__*/React__namespace.createElement(chevronright.ChevronRightIcon, {
        className: iconClassName
      });
      var nextThumbnailIcon = utils.IconUtils.getJSXIcon(icon, {
        className: iconClassName
      }, {
        props: props
      });
      return /*#__PURE__*/React__namespace.createElement("button", {
        ...
        onClick: navForward,
        disabled: isDisabled
      }, nextThumbnailIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
    }
    return null;
  };
...
var Galleria = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
  ...
  var createElement = function createElement() {
    ...
    var closeIcon = utils.IconUtils.getJSXIcon(icon, _objectSpread({}, iconProps), {
      props: props
    });
    var closeButton = props.fullScreen && /*#__PURE__*/React__namespace.createElement("button", {
      type: "button",
    ...
    var element = /*#__PURE__*/React__namespace.createElement("div", _extends({
      ...
      style: props.style
    }, otherProps), closeButton, header, /*#__PURE__*/React__namespace.createElement("div", {
