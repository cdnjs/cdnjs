...
this.primereact.organizationchart = (function (exports, React, utils, chevrondown, chevronup) {
  'use strict';
  ...
  var OrganizationChartNode = /*#__PURE__*/React__namespace.memo(function (props) {
    ...
    var createToggler = function createToggler() {
      if (!leaf) {
        ...
        var icon;
        if (expandedState) {
          icon = props.togglerIcon || /*#__PURE__*/React__namespace.createElement(chevrondown.ChevronDownIcon, {
            className: iconClassName
          });
        } else {
          icon = props.togglerIcon || /*#__PURE__*/React__namespace.createElement(chevronup.ChevronUpIcon, {
            className: iconClassName
          });
        }
        var togglerIcon = utils.IconUtils.getJSXIcon(icon, {
          className: iconClassName
        }, {
          props: props
        });
        return (
          ...
          }, /*#__PURE__*/React__namespace.createElement("i", null, " ", togglerIcon, " "))
          /* eslint-enable */
        );
      }
...
})({}, React, primereact.utils, primereact.icons.chevrondown, primereact.icons.chevronup);
