...
var DataViewLayoutOptions = /*#__PURE__*/React.memo(function (inProps) {
  ...
  var listIcon = IconUtils.getJSXIcon(props.listIcon || /*#__PURE__*/React.createElement(BarsIcon, null), undefined, {
    props: props
  });
  var gridIcon = IconUtils.getJSXIcon(props.gridIcon || /*#__PURE__*/React.createElement(ThLargeIcon, null), undefined, {
    props: props
  });
  ...
  }, listIcon, /*#__PURE__*/React.createElement(Ripple, null)), /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: buttonGridClass,
    onClick: function onClick(event) {
      return changeLayout(event, 'grid');
    }
  }, gridIcon, /*#__PURE__*/React.createElement(Ripple, null)));
});
