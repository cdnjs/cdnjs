...
this.primereact.orderlist = (function (exports, React, PrimeReact, hooks, utils, button, angledown, angledoubleup, angleup, angledoubledown, ripple, search) {
  'use strict';
  ...
  var OrderListBase = {
    ...
    getProps: function getProps(props) {
      return utils.ObjectUtils.getMergedProps(props, OrderListBase.defaultProps);
    },
    getOtherProps: function getOtherProps(props) {
      return utils.ObjectUtils.getDiffProps(props, OrderListBase.defaultProps);
    }
  };
...
})({}, React, primereact.api, primereact.hooks, primereact.utils, primereact.button, primereact.icons.angledown, primereact.icons.angledoubleup, primereact.icons.angleup, primereact.icons.angledoubledown, primereact.ripple, primereact.icons.search);
