...
this.primereact.password = (function (exports, React, PrimeReact, csstransition, hooks, inputtext, overlayservice, portal, utils, eye, eyeslash) {
  'use strict';
  ...
  var Password = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createIcon = function createIcon() {
      var icon;
      if (unmaskedState) {
        icon = props.hideIcon || /*#__PURE__*/React__namespace.createElement(eyeslash.EyeSlashIcon, null);
      } else {
        icon = props.showIcon || /*#__PURE__*/React__namespace.createElement(eye.EyeIcon, null);
      }
      var eyeIcon = utils.IconUtils.getJSXIcon(icon, undefined, {
        props: props
      });
      if (props.toggleMask) {
...
})({}, React, primereact.api, primereact.csstransition, primereact.hooks, primereact.inputtext, primereact.overlayservice, primereact.portal, primereact.utils, primereact.icons.eye, primereact.icons.eyeslash);
