...
this.primereact.tabview = (function (exports, React, api, hooks, ripple, utils, chevronright, chevronleft, times) {
  'use strict';
  ...
  var TabViewBase = {
    ...
    getProps: function getProps(props) {
      return utils.ObjectUtils.getMergedProps(props, TabViewBase.defaultProps);
    },
    getOtherProps: function getOtherProps(props) {
      return utils.ObjectUtils.getDiffProps(props, TabViewBase.defaultProps);
    }
  };
  var TabPanelBase = {
    defaultProps: {
  ...
  var TabView = /*#__PURE__*/React__namespace.forwardRef(function (inProps, ref) {
    ...
    var createTabHeader = function createTabHeader(tab, index) {
      ...
      var leftIconElement = leftIcon && /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, utils.IconUtils.getJSXIcon(leftIcon, {
        props: props
      }));
      var titleElement = /*#__PURE__*/React__namespace.createElement("span", {
        className: "p-tabview-title"
      }, header);
      var rightIconElement = rightIcon && /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, utils.IconUtils.getJSXIcon(rightIcon, {
        props: props
      }));
    ...
    var createPrevButton = function createPrevButton() {
      var icon = props.prevButton || /*#__PURE__*/React__namespace.createElement(chevronleft.ChevronLeftIcon, null);
      var leftIcon = utils.IconUtils.getJSXIcon(icon, undefined, {
        props: props
      });
      if (props.scrollable && !backwardIsDisabledState) {
        ...
        }, leftIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
      }
      return null;
    };
    var createNextButton = function createNextButton() {
      var icon = props.prevButton || /*#__PURE__*/React__namespace.createElement(chevronright.ChevronRightIcon, null);
      var rightIcon = utils.IconUtils.getJSXIcon(icon, {
        'aria-hidden': 'true'
      }, {
        props: props
      });
      if (props.scrollable && !forwardIsDisabledState) {
        ...
        }, rightIcon, /*#__PURE__*/React__namespace.createElement(ripple.Ripple, null));
      }
    };
...
})({}, React, primereact.api, primereact.hooks, primereact.ripple, primereact.utils, primereact.icons.chevronright, primereact.icons.chevronleft, primereact.icons.times);
