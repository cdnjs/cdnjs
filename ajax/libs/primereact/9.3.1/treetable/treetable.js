...
this.primereact.treetable = (function (exports, React, PrimeReact, utils, hooks, paginator, ripple, overlayservice, chevrondown, chevronright, check, minus, inputtext, tooltip, sortalt, sortamountdown, sortamountupalt, spinner, arrowdown, arrowup) {
  'use strict';
...
})({}, React, primereact.api, primereact.utils, primereact.hooks, primereact.paginator, primereact.ripple, primereact.overlayservice, primereact.icons.chevrondown, primereact.icons.chevronright, primereact.icons.check, primereact.icons.minus, primereact.inputtext, primereact.tooltip, primereact.icons.sortalt, primereact.icons.sortamountdown, primereact.icons.sortamountupalt, primereact.icons.spinner, primereact.icons.arrowdown, primereact.icons.arrowup);
