...
import { classNames, ObjectUtils, mergeProps, IconUtils, DomHandler, UniqueComponentId } from 'primereact/utils';
    ...
    if (props.value) {
      return props.value.map(function (item, i) {
        ...
        if (props.dragdrop) {
          ...
          return /*#__PURE__*/React.createElement("li", _extends({
            key: key
          }, _itemProps), content, /*#__PURE__*/React.createElement(Ripple, null));
        }
      });
    }
    return null;
