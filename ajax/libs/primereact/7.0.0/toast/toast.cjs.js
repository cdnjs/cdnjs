...
var ToastMessageComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ToastMessageComponent, [{
    ...
    value: function onClick(event) {
      if (this.props.onClick && !(utils.DomHandler.hasClass(event.target, 'p-toast-icon-close') || utils.DomHandler.hasClass(event.target, 'p-toast-icon-close-icon'))) {
    ...
    value: function renderMessage() {
      if (this.props.message) {
        ...
        var contentEl = utils.ObjectUtils.getJSXElement(content, _objectSpread(_objectSpread({}, this.props), {}, {
    ...
    value: function render() {
      ...
      var className = utils.classNames('p-toast-message', {
      ...
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ...
        className: utils.classNames('p-toast-message-content', contentClassName),
        style: contentStyle
      }, message, closeIcon));
    }
  }]);
...
var Toast = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Toast, [{
    ...
    value: function show(value) {
      if (value) {
        if (value) {
          ...
          this.state.messages.length === 0 && utils.ZIndexUtils.set('toast', this.container, PrimeReact__default["default"].autoZIndex, this.props.baseZIndex || PrimeReact__default["default"].zIndex['toast']);
          this.setState({
    ...
    value: function onExited() {
      this.state.messages.length === 0 && utils.ZIndexUtils.clear(this.container);
    ...
    value: function render() {
      ...
      var className = utils.classNames('p-toast p-component p-toast-' + this.props.position, this.props.className);
      return /*#__PURE__*/React__default["default"].createElement("div", {
        ref: function ref(el) {
          _this2.container = el;
        },
