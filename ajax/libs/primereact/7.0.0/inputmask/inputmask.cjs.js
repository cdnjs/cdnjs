...
var InputMask = /*#__PURE__*/function (_Component) {
  ...
  _createClass(InputMask, [{
    ...
    value: function updateFilledState() {
      if (this.inputRef && this.inputRef.current && this.inputRef.current.value && this.inputRef.current.value.length > 0) utils.DomHandler.addClass(this.inputRef.current, 'p-filled');else utils.DomHandler.removeClass(this.inputRef.current, 'p-filled');
    }
  }, {
    key: "updateValue",
    ...
    value: function render() {
      var inputMaskClassName = utils.classNames('p-inputmask', this.props.className);
