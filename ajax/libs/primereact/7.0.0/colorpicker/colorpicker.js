...
this.primereact.colorpicker = (function (exports, React, utils, csstransition, portal, tooltip, overlayservice, PrimeReact) {
  'use strict';
  ...
  var ColorPicker = /*#__PURE__*/function (_Component) {
    ...
    _createClass(ColorPicker, [{
      ...
      value: function onHueDragStart(event) {
        ...
        this.pickHue(event);
        utils.DomHandler.addClass(this.container, 'p-colorpicker-dragging');
      }
    }, {
      key: "pickHue",
      ...
      value: function onDragEnd() {
        ...
        utils.DomHandler.removeClass(this.container, 'p-colorpicker-dragging');
      ...
      value: function renderInput() {
        if (!this.props.inline) {
          ...
          var inputProps = utils.ObjectUtils.findDiffKeys(this.props, ColorPicker.defaultProps);
      ...
      value: function render() {
        ...
        var containerClassName = utils.classNames('p-colorpicker p-component', {
...
})({}, React, primereact.utils, primereact.csstransition, primereact.portal, primereact.tooltip, primereact.overlayservice, primereact.api);
