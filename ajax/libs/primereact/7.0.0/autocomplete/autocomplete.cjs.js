  ...
  _createClass(AutoCompletePanelComponent, [{
    ...
    value: function renderGroupChildren(optionGroup, i) {
      ...
      return groupChildren.map(function (item, j) {
        var itemContent = _this.props.itemTemplate ? utils.ObjectUtils.getJSXElement(_this.props.itemTemplate, item, j) : _this.props.field ? utils.ObjectUtils.resolveFieldData(item, _this.props.field) : item;
        return /*#__PURE__*/React__default["default"].createElement("li", {
          ...
          "data-group": i,
          "data-index": j
        }, itemContent, /*#__PURE__*/React__default["default"].createElement(ripple.Ripple, null));
      });
    }
  }, {
    key: "renderItem",
    value: function renderItem(suggestion, index) {
      ...
      if (this.props.optionGroupLabel) {
        var groupContent = this.props.optionGroupTemplate ? utils.ObjectUtils.getJSXElement(this.props.optionGroupTemplate, suggestion, index) : this.props.getOptionGroupLabel(suggestion);
        ...
        var itemContent = this.props.itemTemplate ? utils.ObjectUtils.getJSXElement(this.props.itemTemplate, suggestion, index) : this.props.field ? utils.ObjectUtils.resolveFieldData(suggestion, this.props.field) : suggestion;
        return /*#__PURE__*/React__default["default"].createElement("li", {
          key: index + '_item',
          role: "option",
    ...
    value: function renderElement() {
      var panelClassName = utils.classNames('p-autocomplete-panel p-component', this.props.panelClassName);
  ...
  _createClass(AutoComplete, [{
    ...
    value: function formatValue(value) {
      if (value) {
        if (this.props.selectedItemTemplate && (this.props.multiple ? this.isSelected(value) : this.findOptionIndex(value) > -1)) {
          var resolvedFieldData = utils.ObjectUtils.getJSXElement(this.props.selectedItemTemplate, value);
          return resolvedFieldData ? resolvedFieldData : value;
        } else if (this.props.field) {
          var _resolvedFieldData = utils.ObjectUtils.resolveFieldData(value, this.props.field);
    ...
    value: function onOverlayEntering() {
      if (this.props.autoHighlight && this.props.suggestions && this.props.suggestions.length) {
        utils.DomHandler.addClass(this.overlayRef.current.firstChild.firstChild, 'p-highlight');
      }
    }
  }, {
    ...
    value: function alignOverlay() {
      ...
      utils.DomHandler.alignOverlay(this.overlayRef.current, target, this.props.appendTo || PrimeReact__default["default"].appendTo);
    }
  }, {
    key: "onPanelClick",
    ...
    value: function selectHighlightItem(event, item) {
      if (this.props.optionGroupLabel) {
        ...
        this.selectItem(event, this.props.suggestions[utils.DomHandler.index(item)]);
      }
    }
  }, {
    key: "findNextItem",
    value: function findNextItem(item) {
      ...
      return nextItem ? utils.DomHandler.hasClass(nextItem, 'p-autocomplete-item-group') ? this.findNextItem(nextItem) : nextItem : null;
    }
  }, {
    key: "findPrevItem",
    value: function findPrevItem(item) {
      var prevItem = item.previousElementSibling;
      return prevItem ? utils.DomHandler.hasClass(prevItem, 'p-autocomplete-item-group') ? this.findPrevItem(prevItem) : prevItem : null;
    }
  }, {
    key: "onInputFocus",
      ...
      if (this.props.suggestions) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var itemValue = this.props.field ? utils.ObjectUtils.resolveFieldData(item, this.props.field) : item;
    ...
    value: function onMultiInputFocus(event) {
      ...
      utils.DomHandler.addClass(this.multiContainer, 'p-focus');
    }
  }, {
    key: "onMultiInputBlur",
    value: function onMultiInputBlur(event) {
      this.onInputBlur(event);
      utils.DomHandler.removeClass(this.multiContainer, 'p-focus');
    }
  }, {
    key: "isSelected",
    value: function isSelected(val) {
      ...
      if (this.props.value && this.props.value.length) {
        for (var i = 0; i < this.props.value.length; i++) {
          if (utils.ObjectUtils.equals(this.props.value[i], val)) {
            selected = true;
            break;
          }
        }
    ...
    value: function findOptionIndex(option) {
      ...
      if (this.props.suggestions) {
        for (var i = 0; i < this.props.suggestions.length; i++) {
          if (utils.ObjectUtils.equals(option, this.props.suggestions[i])) {
            index = i;
            break;
          }
        }
    ...
    value: function getOptionGroupLabel(optionGroup) {
      return this.props.optionGroupLabel ? utils.ObjectUtils.resolveFieldData(optionGroup, this.props.optionGroupLabel) : optionGroup;
    }
  }, {
    ...
    value: function bindResizeListener() {
      ...
      if (!this.resizeListener) {
        this.resizeListener = function () {
          if (_this7.state.overlayVisible && !utils.DomHandler.isAndroid()) {
            _this7.hideOverlay();
          }
        };
    ...
    value: function renderSimpleAutoComplete() {
      var inputClassName = utils.classNames('p-autocomplete-input', this.props.inputClassName, {
    ...
    value: function renderChips() {
      ...
      if (this.props.value && this.props.value.length) {
        return this.props.value.map(function (val, index) {
          ...
          }, _this8.formatValue(val)), !_this8.props.disabled && utils.IconUtils.getJSXIcon(_this8.props.removeIcon, {
    ...
    value: function renderMultipleAutoComplete() {
      ...
      var multiContainerClass = utils.classNames('p-autocomplete-multiple-container p-component p-inputtext', {
    ...
    value: function render() {
      ...
      var input, dropdown;
      var className = utils.classNames('p-autocomplete p-component p-inputwrapper', this.props.className, {
