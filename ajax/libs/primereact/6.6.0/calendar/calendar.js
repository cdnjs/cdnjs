    ...
    _createClass(Calendar, [{
      ...
      value: function enableModality() {
        ...
        if (!this.touchUIMask) {
          ...
          core.DomHandler.addMultipleClasses(this.touchUIMask, 'p-component-overlay p-datepicker-mask p-datepicker-mask-scrollblocker p-component-overlay-enter');
      ...
      value: function disableModality() {
        ...
        if (this.touchUIMask) {
          core.DomHandler.addClass(this.touchUIMask, 'p-component-overlay-leave');
...
}({}, React, primereact.inputtext, primereact.button, primereact.core, primereact.api));
