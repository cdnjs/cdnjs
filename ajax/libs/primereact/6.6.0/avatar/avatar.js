...
this.primereact.avatar = (function (exports, React, core) {
  'use strict';
    ...
    _createClass(Avatar, [{
      ...
      value: function renderContent() {
        ...
        if (this.props.label) {
          ...
          var iconClassName = core.classNames('p-avatar-icon', this.props.icon);
          return /*#__PURE__*/React__default['default'].createElement("span", {
      ...
      value: function render() {
        var containerClassName = core.classNames('p-avatar p-component', {
        ...
        var content = this.props.template ? core.ObjectUtils.getJSXElement(this.props.template, this.props) : this.renderContent();
