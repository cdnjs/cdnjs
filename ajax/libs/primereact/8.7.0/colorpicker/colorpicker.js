...
this.primereact.colorpicker = (function (exports, React, PrimeReact, hooks, overlayservice, tooltip, utils, csstransition, portal) {
  ...
  var ColorPickerPanel = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    var createElement = function createElement() {
      var className = utils.classNames('p-colorpicker-panel', {
  ...
  var ColorPicker = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    var createInput = function createInput() {
      if (!props.inline) {
        ...
        var inputProps = utils.ObjectUtils.findDiffKeys(props, ColorPicker.defaultProps);
    ...
    var otherProps = utils.ObjectUtils.findDiffKeys(props, ColorPicker.defaultProps);
