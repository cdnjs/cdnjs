...
var OrganizationChartNode = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OrganizationChartNode, [{
    ...
    value: function render() {
      ...
      var nodeClassName = utils.classNames('p-organizationchart-node-content', this.node.className, {
        ...
        'p-highlight': this.isSelected()
          ...
          toggleIcon = utils.classNames('p-node-toggler-icon', {
      ...
      var _visibility = !this.getLeaf() && this.state.expanded ? 'inherit' : 'hidden',
        ...
        var leftClass = utils.classNames('p-organizationchart-line-left', {
          'p-organizationchart-line-top': index !== 0
        }),
            rightClass = utils.classNames('p-organizationchart-line-right', {
...
var OrganizationChart = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(OrganizationChart, [{
    ...
    value: function render() {
      ...
      var className = utils.classNames('p-organizationchart p-component', this.props.className);
