...
this.primereact.scrollpanel = (function (exports, React, utils) {
  'use strict';
    ...
    _createClass(ScrollPanel, [{
      ...
      value: function calculateContainerHeight() {
        var containerStyles = getComputedStyle(this.container),
            ...
            pureContainerHeight = utils.DomHandler.getHeight(this.container) - parseInt(xBarStyles['height'], 10);
      ...
      value: function moveBar() {
        ...
        this.frame = this.requestAnimationFrame(function () {
          if (_this2.scrollXRatio >= 1) {
            utils.DomHandler.addClass(_this2.xBar, 'p-scrollpanel-hidden');
          } else {
            utils.DomHandler.removeClass(_this2.xBar, 'p-scrollpanel-hidden');
          ...
          if (_this2.scrollYRatio >= 1) {
            utils.DomHandler.addClass(_this2.yBar, 'p-scrollpanel-hidden');
          } else {
            utils.DomHandler.removeClass(_this2.yBar, 'p-scrollpanel-hidden');
      ...
      value: function onYBarMouseDown(e) {
        ...
        utils.DomHandler.addClass(this.yBar, 'p-scrollpanel-grabbed');
      ...
      value: function onXBarMouseDown(e) {
        ...
        utils.DomHandler.addClass(this.xBar, 'p-scrollpanel-grabbed');
        utils.DomHandler.addClass(document.body, 'p-scrollpanel-grabbed');
        document.addEventListener('mousemove', this.onDocumentMouseMove);
        document.addEventListener('mouseup', this.onDocumentMouseUp);
        e.preventDefault();
      ...
      value: function onDocumentMouseUp(e) {
        utils.DomHandler.removeClass(this.yBar, 'p-scrollpanel-grabbed');
        utils.DomHandler.removeClass(this.xBar, 'p-scrollpanel-grabbed');
      ...
      value: function render() {
        ...
        var className = utils.classNames('p-scrollpanel p-component', this.props.className);
