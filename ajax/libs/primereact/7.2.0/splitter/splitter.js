...
this.primereact.splitter = (function (exports, React, utils) {
  'use strict';
  ...
  var Splitter = /*#__PURE__*/function (_Component2) {
    ...
    _createClass(Splitter, [{
      ...
      value: function onResizeStart(event, index) {
        ...
        this.size = this.props.layout === 'horizontal' ? utils.DomHandler.getWidth(this.container) : utils.DomHandler.getHeight(this.container);
        this.dragging = true;
        this.startPos = this.props.layout === 'horizontal' ? pageX : pageY;
        this.prevPanelElement = this.gutterElement.previousElementSibling;
        this.nextPanelElement = this.gutterElement.nextElementSibling;
        this.prevPanelSize = 100 * (this.props.layout === 'horizontal' ? utils.DomHandler.getOuterWidth(this.prevPanelElement, true) : utils.DomHandler.getOuterHeight(this.prevPanelElement, true)) / this.size;
        this.nextPanelSize = 100 * (this.props.layout === 'horizontal' ? utils.DomHandler.getOuterWidth(this.nextPanelElement, true) : utils.DomHandler.getOuterHeight(this.nextPanelElement, true)) / this.size;
        this.prevPanelIndex = index;
        utils.DomHandler.addClass(this.gutterElement, 'p-splitter-gutter-resizing');
        utils.DomHandler.addClass(this.container, 'p-splitter-resizing');
      }
    }, {
      key: "onResize",
      ...
      value: function onResizeEnd(event) {
        ...
        utils.DomHandler.removeClass(this.container, 'p-splitter-resizing');
        this.clear();
      }
    }, {
      ...
      value: function componentDidMount() {
        ...
        if (this.panelElement) {
          if (this.panelElement.childNodes && utils.ObjectUtils.isNotEmpty(utils.DomHandler.find(this.panelElement, '.p-splitter'))) {
            utils.DomHandler.addClass(this.panelElement, 'p-splitter-panel-nested');
          }
        }
      ...
      value: function render() {
        ...
        var className = utils.classNames("p-splitter p-component p-splitter-".concat(this.props.layout), this.props.className);
