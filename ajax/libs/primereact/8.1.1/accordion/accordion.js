...
this.primereact.accordion = (function (exports, React, csstransition, hooks, utils) {
  'use strict';
  ...
  var Accordion = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    var createTabHeader = function createTabHeader(tab, selected, index) {
      ...
      var header = tab.props.headerTemplate ? utils.ObjectUtils.getJSXElement(tab.props.headerTemplate, tab.props) : /*#__PURE__*/React__namespace.createElement("span", {
    ...
    var createTab = function createTab(tab, index) {
      if (shouldUseTab(tab)) {
        ...
        var _otherProps = utils.ObjectUtils.findDiffKeys(tab.props, AccordionTab.defaultProps);
    ...
    var otherProps = utils.ObjectUtils.findDiffKeys(props, Accordion.defaultProps);
...
})({}, React, primereact.csstransition, primereact.hooks, primereact.utils);
