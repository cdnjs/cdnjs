...
this.primereact.dataview = (function (exports, React, PrimeReact, componentbase, bars, spinner, thlarge, paginator, ripple, utils) {
  ...
  var classes = {
    ...
    root: function root(_ref2) {
      ...
      return utils.classNames('p-dataview p-component', (_classNames = {}, _defineProperty(_classNames, "p-dataview-".concat(props.layout), !!props.layout), _defineProperty(_classNames, 'p-dataview-loading', props.loading), _classNames));
    }
  };
