...
function confirmPopup(props) {
  ...
  var confirmPopupEl = _react.default.createElement(ConfirmPopup, props);
  ...
  var updateConfirmPopup = function updateConfirmPopup(newProps) {
    ...
    _reactDom.default.render(_react.default.cloneElement(confirmPopupEl, props), confirmPopupWrapper);
  };
...
var ConfirmPopup = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ConfirmPopup, [{
    ...
    value: function render() {
      ...
      return _reactDom.default.createPortal(element, this.appendTo);
    }
  }]);
