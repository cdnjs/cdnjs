...
function confirmDialog(props) {
  ...
  var confirmDialogEl = _react.default.createElement(ConfirmDialog, props);
  ...
  var updateConfirmDialog = function updateConfirmDialog(newProps) {
    ...
    _reactDom.default.render(_react.default.cloneElement(confirmDialogEl, props), confirmDialogWrapper);
  };
