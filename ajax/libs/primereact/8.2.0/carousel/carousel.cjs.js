...
var Carousel = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var createBackwardNavigator = function createBackwardNavigator() {
    ...
    var className = utils.classNames('p-carousel-prev p-link', {
  ...
  var createForwardNavigator = function createForwardNavigator() {
    ...
    var className = utils.classNames('p-carousel-next p-link', {
      'p-disabled': isDisabled
    });
  ...
  var createIndicators = function createIndicators() {
    var className = utils.classNames('p-carousel-indicators p-reset', props.indicatorsContentClassName);
    var indicators = [];
  ...
  var otherProps = utils.ObjectUtils.findDiffKeys(props, Carousel.defaultProps);
