...
this.primereact.mention = (function (exports, React, PrimeReact, csstransition, hooks, tooltip, utils, overlayservice, portal, ripple) {
  'use strict';
  ...
  var InputTextarea = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    var otherProps = utils.ObjectUtils.findDiffKeys(props, InputTextarea.defaultProps);
  ...
  var Mention = /*#__PURE__*/React__namespace.memo( /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
    ...
    var isFilled = React__namespace.useMemo(function () {
      return utils.ObjectUtils.isNotEmpty(props.value) || utils.ObjectUtils.isNotEmpty(props.defaultValue) || inputRef.current && utils.ObjectUtils.isNotEmpty(inputRef.current.value);
    ...
    var inputProps = utils.ObjectUtils.findDiffKeys(props, Mention.defaultProps);
...
})({}, React, primereact.api, primereact.csstransition, primereact.hooks, primereact.tooltip, primereact.utils, primereact.overlayservice, primereact.portal, primereact.ripple);
