...
var TreeTableBodyCell = function TreeTableBodyCell(props) {
  ...
  var className = utils.classNames(props.bodyClassName || props.className, {
  ...
  var onRowClick = function onRowClick(event, node) {
    ...
    if ((isSingleSelectionMode || isMultipleSelectionMode) && node.selectable !== false) {
      ...
      if (isMultipleSelectionMode && event.shiftKey) {
        utils.DomHandler.clearSelection(); // find first selected row
...
var TreeTableFooter = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createFooterRow = function createFooterRow(row, index) {
    var rowColumns = React__namespace.Children.toArray(row.props.children);
  ...
  var createColumnGroup = function createColumnGroup() {
    var rows = React__namespace.Children.toArray(props.columnGroup.props.children);
...
var TreeTableHeader = /*#__PURE__*/React__namespace.memo(function (props) {
  ...
  var createHeaderCell = function createHeaderCell(column, options) {
    ...
    if (column.props.filter && options.renderFilter) {
      filterElement = column.props.filterElement || /*#__PURE__*/React__namespace.createElement(inputtext.InputText, {
...
var TreeTable = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var sortNodes = function sortNodes(data) {
    ...
    if (columnSortable.current && columnSortable.current === 'custom' && columnSortFunction.current) {
      ...
      value.sort(function (node1, node2) {
        ...
        return utils.ObjectUtils.sort(value1, value2, getSortOrder(), PrimeReact__default["default"].locale);
      });
  ...
  var multisortField = function multisortField(node1, node2, multiSortMeta, index) {
    ...
    if (value1 == null && value2 != null) result = -1;else if (value1 != null && value2 == null) result = 1;else if (value1 == null && value2 == null) result = 0;else {
      if (value1 === value2) {
        ...
        if ((typeof value1 === 'string' || value1 instanceof String) && (typeof value2 === 'string' || value2 instanceof String)) return multiSortMeta[index].order * value1.localeCompare(value2, PrimeReact__default["default"].locale, {
          numeric: true
      ...
      for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
        ...
        for (var j = 0; j < columns.length; j++) {
          ...
          if (filterMeta) {
            ...
            filterConstraint = filterMatchMode === 'custom' ? col.props.filterFunction : PrimeReact.FilterService.filters[filterMatchMode];
            options = {
              rowData: node,
              filters: filters,
              props: props,
          ...
          if (props.globalFilter && !globalMatch) {
            ...
            filterConstraint = PrimeReact.FilterService.filters['contains'];
            paramsWithoutNode = {
              filterField: filterField,
              filterValue: filterValue,
              filterConstraint: filterConstraint,
