...
this.primereact.treetable = (function (exports, React, PrimeReact, hooks, paginator, utils, ripple, overlayservice, inputtext) {
  'use strict';
    ...
    var sortNodes = function sortNodes(data) {
      ...
      if (columnSortable.current && columnSortable.current === 'custom' && columnSortFunction.current) {
        ...
        value.sort(function (node1, node2) {
          ...
          return utils.ObjectUtils.sort(value1, value2, getSortOrder(), PrimeReact__default["default"].locale, PrimeReact__default["default"].nullSortOrder);
        });
...
})({}, React, primereact.api, primereact.hooks, primereact.paginator, primereact.utils, primereact.ripple, primereact.overlayservice, primereact.inputtext);
