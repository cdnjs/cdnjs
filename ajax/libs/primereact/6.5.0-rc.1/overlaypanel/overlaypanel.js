...
this.primereact.overlaypanel = (function (exports, React, utils, csstransition, ripple, OverlayEventBus, portal) {
  'use strict';
    ...
    _createClass(OverlayPanel, [{
      ...
      value: function show(event, target) {
        ...
        if (this.state.visible) {
          ...
          this.setState({
            ...
            OverlayEventBus__default['default'].on('overlay-click', _this6.overlayEventListener);
          });
        }
      }
    }, {
      ...
      value: function hide() {
        ...
        this.setState({
          ...
          OverlayEventBus__default['default'].off('overlay-click', _this7.overlayEventListener);
...
}({}, React, primereact.utils, primereact.csstransition, primereact.ripple, primereact.overlayeventbus, primereact.portal));
