...
this.primereact.slidemenu = (function (exports, React, utils, csstransition, OverlayEventBus, portal) {
  'use strict';
    ...
    _createClass(SlideMenu, [{
      ...
      value: function onEnter() {
        if (this.props.autoZIndex) {
          utils.ZIndexUtils.set('menu', this.menuRef.current, this.props.baseZIndex);
        }
      ...
      value: function bindDocumentResizeListener() {
        ...
        if (!this.documentResizeListener) {
          this.documentResizeListener = function (event) {
            if (_this9.state.visible && !utils.DomHandler.isAndroid()) {
              _this9.hide(event);
            }
          };
...
}({}, React, primereact.utils, primereact.csstransition, primereact.overlayeventbus, primereact.portal));
