...
this.primereact.menubar = (function (exports, React, utils, ripple) {
  'use strict';
    ...
    _createClass(Menubar, [{
      ...
      value: function toggle(event) {
        ...
        this.setState(function (prevState) {
          ...
          if (_this2.state.mobileActive) {
            utils.ZIndexUtils.set('menu', _this2.rootmenu);

            _this2.bindDocumentClickListener();
          } else {
            _this2.unbindDocumentClickListener();

            utils.ZIndexUtils.clear(_this2.rootmenu);
          }
        });
      }
    }, {
          ...
          this.documentClickListener = function (event) {
            if (_this3.state.mobileActive && _this3.isOutsideClicked(event)) {
              _this3.setState({
                ...
                utils.ZIndexUtils.clear(_this3.rootmenu);
              });
            }
          };
      ...
      value: function onLeafClick() {
        ...
        this.setState({
          ...
          utils.ZIndexUtils.clear(_this4.rootmenu);
        });
      }
    }, {
      key: "componentWillUnmount",
      value: function componentWillUnmount() {
        utils.ZIndexUtils.clear(this.rootmenu);
      }
    }, {
      ...
      value: function renderStartContent() {
        if (this.props.start) {
          var start = utils.ObjectUtils.getJSXElement(this.props.start, this.props);
          return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      value: function renderEndContent() {
        if (this.props.end) {
          var end = utils.ObjectUtils.getJSXElement(this.props.end, this.props);
          return /*#__PURE__*/React__default['default'].createElement("div", {
