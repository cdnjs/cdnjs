...
this.primereact.treeselect = (function (exports, React, utils, PrimeReact, OverlayEventBus, tree, csstransition, portal, ripple) {
  'use strict';
  ...
  var TreeSelectPanelComponent = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeSelectPanelComponent, [{
      ...
      value: function renderElement() {
        var className = utils.classNames('p-treeselect-panel p-component', this.props.panelClassName);
  ...
  var TreeSelect = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeSelect, [{
      ...
      value: function onClick(event) {
        if (!this.props.disabled && (!this.overlayRef || !this.overlayRef.current || !this.overlayRef.current.contains(event.target)) && !utils.DomHandler.hasClass(event.target, 'p-treeselect-close')) {
      ...
      value: function onOverlayEnter() {
        utils.ZIndexUtils.set('overlay', this.overlayRef.current);
        this.alignOverlay();
        this.scrollInView();
      }
    }, {
      ...
      value: function alignOverlay() {
        utils.DomHandler.alignOverlay(this.overlayRef.current, this.trigger.parentElement, this.props.appendTo || PrimeReact__default['default'].appendTo);
      }
    }, {
      key: "scrollInView",
      value: function scrollInView() {
        var highlightItem = utils.DomHandler.findSingle(this.overlayRef.current, '.p-treenode-content.p-highlight');
      ...
      value: function renderLabel(selectedNodes) {
        ...
        if (this.props.valueTemplate) {
          content = utils.ObjectUtils.getJSXElement(this.props.valueTemplate, selectedNodes, this.props);
        } else {
      ...
      value: function renderDropdownIcon() {
        ...
        var iconClassName = utils.classNames('p-treeselect-trigger-icon p-clickable', this.props.dropdownIcon);
        return /*#__PURE__*/React__default['default'].createElement("div", {
          ref: function ref(el) {
      ...
      value: function renderHeader() {
        ...
        if (this.props.header) {
          ...
          return utils.ObjectUtils.getJSXElement(this.props.header, defaultOptions);
        }
...
}({}, React, primereact.utils, primereact.api, primereact.overlayeventbus, primereact.tree, primereact.csstransition, primereact.portal, primereact.ripple));
