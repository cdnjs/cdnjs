...
this.primereact.datascroller = (function (exports, React, utils) {
  'use strict';
  ...
  var DataScroller = /*#__PURE__*/function (_Component) {
    ...
    _createClass(DataScroller, [{
      ...
      value: function render() {
        ...
        var className = utils.classNames('p-datascroller p-component', this.props.className, {
          'p-datascroller-inline': this.props.inline
        });
        var header = this.props.header && /*#__PURE__*/React__default['default'].createElement("div", {
          className: "p-datascroller-header"
        }, " ", this.props.header),
            footer = this.props.footer && /*#__PURE__*/React__default['default'].createElement("div", {
