  ...
  _createClass(ConfirmPopup, [{
    ...
    value: function show() {
      ...
      this.setState({
        ...
        OverlayEventBus__default['default'].on('overlay-click', _this5.overlayEventListener);
      });
    }
  }, {
    key: "hide",
    value: function hide(result) {
      ...
      this.setState({
        ...
        OverlayEventBus__default['default'].off('overlay-click', _this6.overlayEventListener);
    ...
    value: function renderContent() {
      var iconClassName = utils.classNames('p-confirm-popup-icon', this.props.icon);
