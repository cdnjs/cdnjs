...
var MultiSelectPanelComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MultiSelectPanelComponent, [{
    ...
    value: function renderEmptyFilter() {
      var emptyFilterMessage = utils.ObjectUtils.getJSXElement(this.props.emptyFilterMessage, this.props);
      return /*#__PURE__*/React__default['default'].createElement("li", {
...
var MultiSelect = /*#__PURE__*/function (_Component) {
  ...
  _createClass(MultiSelect, [{
    ...
    value: function render() {
      ...
      var iconClassName = utils.classNames('p-multiselect-trigger-icon p-c', this.props.dropdownIcon);
      var visibleOptions = this.getVisibleOptions();
