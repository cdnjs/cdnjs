...
this.primereact.treetable = (function (exports, React, utils, paginator, inputtext, OverlayEventBus, ripple) {
  'use strict';
    ...
    _createClass(TreeTableBodyCell, [{
      ...
      value: function render() {
        ...
        if (this.state && this.state.editing) {
          ...
          if (this.props.body) content = this.props.body(this.props.node, this.props);else content = utils.ObjectUtils.resolveFieldData(this.props.node.data, this.props.field);
        }
        /* eslint-disable */
  ...
  var TreeTableRow = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TreeTableRow, [{
      ...
      value: function onClick(event) {
        ...
        if (targetNode === 'INPUT' || targetNode === 'BUTTON' || targetNode === 'A' || utils.DomHandler.hasClass(event.target, 'p-clickable') || utils.DomHandler.hasClass(event.target, 'p-treetable-toggler') || utils.DomHandler.hasClass(event.target.parentElement, 'p-treetable-toggler')) {
          return;
        }
          ...
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            for (var j = 0; j < columns.length; j++) {
              ...
              if (filterMeta) {
                ...
                filterConstraint = filterMatchMode === 'custom' ? col.props.filterFunction : utils.FilterUtils[filterMatchMode];
                options = {
                  rowData: node,
                  filters: filters,
                  props: this.props,
              ...
              if (this.props.globalFilter && !globalMatch) {
                ...
                filterConstraint = utils.FilterUtils['contains'];
                paramsWithoutNode = {
                  filterField: filterField,
                  filterValue: filterValue,
                  filterConstraint: filterConstraint,
...
}({}, React, primereact.utils, primereact.paginator, primereact.inputtext, primereact.overlayeventbus, primereact.ripple));
