...
this.primereact.galleria = (function (exports, React, utils, ripple, csstransition, portal) {
  'use strict';
  ...
  var Galleria = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Galleria, [{
      ...
      value: function onEntering() {
        utils.ZIndexUtils.set('modal', this.mask, this.props.baseZIndex);
...
}({}, React, primereact.utils, primereact.ripple, primereact.csstransition, primereact.portal));
