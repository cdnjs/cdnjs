...
this.primereact.datatable = (function (exports, React, paginator, utils, OverlayEventBus, ripple, inputtext) {
  'use strict';
    ...
    _createClass(ScrollableView, [{
      ...
      value: function setScrollHeight() {
        if (this.props.scrollHeight) {
          ...
          if (frozenView) {
            var frozenScrollBody = utils.DomHandler.findSingle(frozenView, '.p-datatable-scrollable-body');
            ...
            if (this.props.scrollHeight.indexOf('%') !== -1) {
              ...
              if (this.props.frozen) {
                scrollBodyHeight -= utils.DomHandler.calculateScrollbarWidth();
              }
      ...
      value: function findDataTableContainer(element) {
        if (element) {
          ...
          while (el && !utils.DomHandler.hasClass(el, 'p-datatable')) {
            el = el.parentElement;
          }
      ...
      value: function onBodyScroll() {
        ...
        if (this.props.virtualScroll) {
          var viewport = utils.DomHandler.getClientHeight(this.scrollBody);
          var tableHeight = utils.DomHandler.getOuterHeight(this.scrollTable);
          var pageHeight = this.props.virtualRowHeight * this.props.rows;
          var virtualTableHeight = utils.DomHandler.getOuterHeight(this.virtualScroller);
      ...
      value: function render() {
        ...
        var className = utils.classNames('p-datatable-scrollable-view', {
          'p-datatable-frozen-view': this.props.frozen,
          'p-datatable-unfrozen-view': !this.props.frozen && this.props.frozenWidth
        });
        var tableBodyClassName = utils.classNames('p-datatable-scrollable-body-table', this.props.tableClassName, {
          'p-datatable-virtual-table': this.props.virtualScroll
        });
        var tableHeaderClassName = utils.classNames('p-datatable-scrollable-header-table', this.props.tableClassName);
        var tableFooterClassName = utils.classNames('p-datatable-scrollable-footer-table', this.props.tableClassName);
  ...
  var RowRadioButton = /*#__PURE__*/function (_Component) {
    ...
    _createClass(RowRadioButton, [{
      ...
      value: function render() {
        ...
        var className = utils.classNames('p-radiobutton-box p-component p-clickable', {
  ...
  var RowCheckbox = /*#__PURE__*/function (_Component) {
    ...
    _createClass(RowCheckbox, [{
      ...
      key: "render",
      value: function render() {
        var className = utils.classNames('p-checkbox-box p-component p-clickable', {
          'p-highlight': this.props.selected,
          'p-disabled': this.props.disabled,
          'p-focus': this.state.focused
        });
        var iconClassName = utils.classNames('p-checkbox-icon p-clickable', {
    ...
    _createClass(BodyCell, [{
      ...
      value: function onClick(event) {
        ...
        if (this.props.editMode !== 'row' && this.props.editor && !this.state.editing && (this.props.selectOnEdit || !this.props.selectOnEdit && this.props.selected)) {
          ...
          this.setState({
            ...
            if (_this2.props.editorValidatorEvent === 'click') {
              ...
              OverlayEventBus__default['default'].on('overlay-click', _this2.overlayEventListener);
            }
        ...
        if (this.props.allowCellSelection && this.props.onClick) {
          this.props.onClick({
            originalEvent: event,
            value: utils.ObjectUtils.resolveFieldData(this.props.rowData, this.props.field),
      ...
      value: function closeCell(event) {
        ...
        setTimeout(function () {
          _this4.setState({
            ...
            OverlayEventBus__default['default'].off('overlay-click', _this4.overlayEventListener);
      ...
      value: function findNextSelectableCell(cell) {
        ...
        if (nextCell) {
          return utils.DomHandler.hasClass(nextCell, 'p-selectable-cell') ? nextCell : this.findNextSelectableRow(nextCell);
        }
      ...
      value: function findPrevSelectableCell(cell) {
        ...
        if (prevCell) {
          return utils.DomHandler.hasClass(prevCell, 'p-selectable-cell') ? prevCell : this.findPrevSelectableRow(prevCell);
        }
      ...
      value: function findNextSelectableRow(row) {
        ...
        if (nextRow) {
          return utils.DomHandler.hasClass(nextRow, 'p-selectable-row') ? nextRow : this.findNextSelectableRow(nextRow);
        }
        ...
        if (this.props.editMode !== 'row' && this.container && this.props.editor) {
          ...
          this.tabindexTimeout = setTimeout(function () {
            if (_this6.state.editing) {
              var focusable = utils.DomHandler.findSingle(_this6.container, 'input');
      ...
      value: function render() {
        ...
        var cellClassName = utils.classNames(this.props.bodyClassName || this.props.className, {
        ...
        if (this.props.expander) {
          var iconClassName = utils.classNames('p-row-toggler-icon pi pi-fw p-clickable', {
          ...
          if (showReorder) {
            var reorderIcon = utils.classNames('p-datatable-reorderablerow-handle', this.props.rowReorderIcon);
          ...
          if (this.state.editing && this.props.editor) {
            ...
            if (this.props.body) content = this.props.body(this.props.rowData, this.props);else content = utils.ObjectUtils.resolveFieldData(this.props.rowData, this.props.field);
          }
        }
  ...
  var BodyRow = /*#__PURE__*/function (_Component) {
    ...
    _createClass(BodyRow, [{
      ...
      value: function render() {
        ...
        var className = utils.classNames(conditionalClassNames);
  ...
  var TableBody = /*#__PURE__*/function (_Component) {
    ...
    _createClass(TableBody, [{
      ...
      value: function allowSelection(event) {
        ...
        if (targetNode === 'INPUT' || targetNode === 'BUTTON' || targetNode === 'A' || utils.DomHandler.hasClass(event.originalEvent.target, 'p-clickable')) {
          return false;
        }
      ...
      value: function findRowIndex(rows, row) {
        return rows ? rows.findIndex(function (r) {
          return utils.ObjectUtils.equals(row, r);
        }) : -1;
      }
    }, {
      key: "isRowExpanded",
      value: function isRowExpanded(row) {
        ...
        if (dataKey) {
          var dataKeyValue = String(utils.ObjectUtils.resolveFieldData(row, dataKey));
          ...
          if (this.props.value && this.props.value.length) {
            ...
            var _loop = function _loop(i) {
              ...
              if (hasSubheaderGrouping) {
                var currentRowFieldData = utils.ObjectUtils.resolveFieldData(rowData, _this4.props.groupField);
                var previousRowFieldData = utils.ObjectUtils.resolveFieldData(_this4.props.value[i - 1], _this4.props.groupField);
              ...
              if (rowSpanGrouping) {
                ...
                var _currentRowFieldData = utils.ObjectUtils.resolveFieldData(rowData, _this4.props.sortField);

                var shouldCountRowSpan = i === startIndex || utils.ObjectUtils.resolveFieldData(_this4.props.value[i - 1], _this4.props.sortField) !== _currentRowFieldData;
                ...
                if (shouldCountRowSpan) {
                  ...
                  while (_currentRowFieldData === nextRowFieldData) {
                    ...
                    if (nextRowData) {
                      nextRowFieldData = utils.ObjectUtils.resolveFieldData(nextRowData, _this4.props.sortField);
                    } else {
                      break;
                    }
                  }
              ...
              if (hasSubheaderGrouping && (!_this4.props.expandableRowGroups || isRowGroupExpanded)) {
                var _currentRowFieldData2 = utils.ObjectUtils.resolveFieldData(rowData, _this4.props.groupField);

                var _nextRowFieldData = utils.ObjectUtils.resolveFieldData(_this4.props.value[i + 1], _this4.props.groupField);
      ...
      value: function render() {
        ...
        if (this.props.renderOptions.filterOnly) {
          return /*#__PURE__*/React__default['default'].createElement("th", {
            ...
            role: "columnheader",
            className: utils.classNames('p-filter-column', this.props.columnProps.filterHeaderClassName),
  ...
  var DataTable = /*#__PURE__*/function (_Component) {
    ...
    _createClass(DataTable, [{
      ...
      value: function saveColumnWidths(state) {
        var widths = [];
        var headers = utils.DomHandler.find(this.container, '.p-datatable-thead > tr > th.p-resizable-column');
        ...
        if (this.props.columnResizeMode === 'expand') {
          state.tableWidth = this.props.scrollable ? utils.DomHandler.findSingle(this.container, '.p-datatable-scrollable-header-table').style.width : utils.DomHandler.getOuterWidth(this.table) + 'px';
        }
      }
    }, {
      ...
      value: function restoreColumnWidths() {
        if (this.columnWidthsState) {
          ...
          if (this.props.scrollable) {
            var headerCols = utils.DomHandler.find(this.container, '.p-datatable-scrollable-header-table > colgroup > col');
            var bodyCols = utils.DomHandler.find(this.container, '.p-datatable-scrollable-body-table > colgroup > col');
      ...
      value: function sortSingle(data, sortField, sortOrder) {
        ...
        if (this.columnSortable && this.columnSortFunction) {
          ...
          value.sort(function (data1, data2) {
            var value1 = utils.ObjectUtils.resolveFieldData(data1, sortField);
            var value2 = utils.ObjectUtils.resolveFieldData(data2, sortField);
            var result = null;
          ...
          if (this.props.columnResizeMode === 'fit') {
            ...
            if (newColumnWidth > 15 && nextColumnWidth > 15) {
              if (this.props.scrollable) {
                ...
                var scrollableBodyTable = utils.DomHandler.findSingle(scrollableView, 'table.p-datatable-scrollable-body-table');
                var scrollableHeaderTable = utils.DomHandler.findSingle(scrollableView, 'table.p-datatable-scrollable-header-table');
                var scrollableFooterTable = utils.DomHandler.findSingle(scrollableView, 'table.p-datatable-scrollable-footer-table');
      ...
      value: function setScrollableItemsWidthOnExpandResize(column, newColumnWidth, delta) {
        ...
        var scrollableBody = utils.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-body');
        var scrollableHeader = utils.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-header');
        var scrollableFooter = utils.DomHandler.findSingle(scrollableView, '.p-datatable-scrollable-footer');
        var scrollableBodyTable = utils.DomHandler.findSingle(scrollableBody, 'table.p-datatable-scrollable-body-table');
        var scrollableHeaderTable = utils.DomHandler.findSingle(scrollableHeader, 'table.p-datatable-scrollable-header-table');
        var scrollableFooterTable = utils.DomHandler.findSingle(scrollableFooter, 'table.p-datatable-scrollable-footer-table');
        ...
        if (column) {
          var resizeColumnIndex = utils.DomHandler.index(column);
        ...
        if (this.draggedColumnEl) {
          ...
          if (allowDrop) {
            ...
            var isSameColumn = function isSameColumn(col1, col2) {
              return col1.columnKey || col2.columnKey ? utils.ObjectUtils.equals(col1, col2, 'columnKey') : utils.ObjectUtils.equals(col1, col2, 'field');
            };
        ...
        for (var i = 0; i < value.length; i++) {
          ...
          for (var j = 0; j < columns.length; j++) {
            ...
            if (filterMeta) {
              ...
              var dataFieldValue = utils.ObjectUtils.resolveFieldData(value[i], columnField);
              var filterMatchMode = filterMeta.matchMode || col.props.filterMatchMode;
              var filterConstraint = filterMatchMode === 'custom' ? col.props.filterFunction : utils.FilterUtils[filterMatchMode];
              var options = {
                rowData: value[i],
                filters: filters,
                props: this.props,
            ...
            if (!col.props.excludeGlobalFilter && this.props.globalFilter && !globalMatch) {
              globalMatch = utils.FilterUtils['contains'](utils.ObjectUtils.resolveFieldData(value[i], columnField), this.props.globalFilter, this.props.filterLocale);
            }
          }
...
}({}, React, primereact.paginator, primereact.utils, primereact.overlayeventbus, primereact.ripple, primereact.inputtext));
