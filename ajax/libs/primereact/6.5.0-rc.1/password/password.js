...
this.primereact.password = (function (exports, React, utils, tooltip, inputtext, csstransition, PrimeReact, OverlayEventBus, portal) {
  'use strict';
      ...
      value: function bindResizeListener() {
        ...
        if (!this.resizeListener) {
          this.resizeListener = function () {
            if (_this6.state.overlayVisible && !utils.DomHandler.isAndroid()) {
              _this6.hideOverlay();
            }
          };
...
}({}, React, primereact.utils, primereact.tooltip, primereact.inputtext, primereact.csstransition, primereact.api, primereact.overlayeventbus, primereact.portal));
