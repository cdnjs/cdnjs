...
this.primereact.dialog = (function (exports, React, utils, csstransition, ripple, portal) {
  'use strict';
      ...
      value: function componentDidMount() {
        ...
        if (this.props.visible) {
          this.setState({
            ...
            utils.ZIndexUtils.set('modal', _this5.mask, _this5.props.baseZIndex);
          });
        }
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (this.props.visible && !this.state.maskVisible) {
          this.setState({
            ...
            utils.ZIndexUtils.set('modal', _this6.mask, _this6.props.baseZIndex);
          });
        }
