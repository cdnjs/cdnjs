    ...
    _createClass(ButtonComponent, [{
      ...
      value: function getElementRef(el) {
        ...
        if (this.props.forwardRef) {
          if (utils.ObjectUtils.isFunction(this.props.forwardRef)) {
      ...
      value: function renderIcon() {
        ...
        if (icon) {
          ...
          var className = utils.classNames('p-button-icon p-c', (_classNames = {
          ...
          if (iconType !== 'string') {
            ...
            content = utils.ObjectUtils.getJSXElement(icon, defaultContentOptions);
          }
        }
