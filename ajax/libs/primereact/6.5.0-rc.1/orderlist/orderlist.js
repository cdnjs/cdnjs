...
this.primereact.orderlist = (function (exports, React, button, utils, ripple) {
  'use strict';
  ...
  var OrderListSubList = /*#__PURE__*/function (_Component) {
    ...
    _createClass(OrderListSubList, [{
      ...
      value: function isSelected(item) {
        return utils.ObjectUtils.findIndexInList(item, this.props.selection) !== -1;
      }
    }, {
      key: "onDragStart",
  ...
  var OrderList = /*#__PURE__*/function (_Component) {
    ...
    _createClass(OrderList, [{
      ...
      value: function onItemClick(event) {
        ...
        var index = utils.ObjectUtils.findIndexInList(event.value, this.state.selection);
...
}({}, React, primereact.button, primereact.utils, primereact.ripple));
