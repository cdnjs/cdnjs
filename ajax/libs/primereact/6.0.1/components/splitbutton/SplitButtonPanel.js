...
var SplitButtonPanel = /*#__PURE__*/function (_Component) {
  _inherits(SplitButtonPanel, _Component);

  var _super = _createSuper(SplitButtonPanel);
  ...
  _createClass(SplitButtonPanel, [{
    ...
    value: function renderElement() {
      ...
      var className = (0, _ClassNames.classNames)('p-menu p-menu-overlay p-component', this.props.menuClassName);
