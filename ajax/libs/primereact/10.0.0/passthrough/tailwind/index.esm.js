...
var Tailwind = {
  ...
  paginator: {
    ...
    firstpagebutton: function firstpagebutton(_ref135) {
    ...
    previouspagebutton: function previouspagebutton(_ref136) {
    ...
    nextpagebutton: function nextpagebutton(_ref137) {
    ...
    lastpagebutton: function lastpagebutton(_ref138) {
    ...
    pagebutton: function pagebutton(_ref139) {
  ...
  treetable: {
    ...
    scrollablewrapper: function scrollablewrapper(_ref145) {
    ...
    wrapper: function wrapper(_ref146) {
    ...
    headerrow: function headerrow(_ref150) {
    ...
    column: {
      headercell: function headercell(_ref152) {
      ...
      bodycell: function bodycell(_ref153) {
      ...
      rowtoggler: function rowtoggler(_ref154) {
      ...
      sorticon: function sorticon(_ref155) {
      ...
      checkbox: function checkbox(_ref156) {
      ...
      checkboxicon: function checkboxicon(_ref157) {
  ...
  datatable: {
    ...
    header: function header(_ref160) {
    ...
    column: {
      headercell: function headercell(_ref164) {
      ...
      bodycell: function bodycell(_ref165) {
      ...
      footercell: function footercell(_ref166) {
      ...
      sorticon: function sorticon(_ref167) {
      ...
      filterrowitem: function filterrowitem(_ref168) {
      ...
      filtermenubutton: function filtermenubutton(_ref169) {
      ...
      headerfilterclearbutton: function headerfilterclearbutton(_ref170) {
      ...
      radiobutton: function radiobutton(_ref171) {
      ...
      radiobuttonicon: function radiobuttonicon(_ref172) {
      ...
      headercheckbox: function headercheckbox(_ref173) {
      ...
      checkbox: function checkbox(_ref174) {
    ...
    bodyrow: function bodyrow(_ref175) {
