...
var classes = {
  root: function root(_ref) {
    ...
    return classNames("p-speeddial p-component p-speeddial-".concat(props.type), (_classNames = {}, _defineProperty(_classNames, "p-speeddial-direction-".concat(props.direction), props.type !== 'circle'), _defineProperty(_classNames, 'p-speeddial-opened', visible), _defineProperty(_classNames, 'p-disabled', props.disabled), _classNames));
  },
