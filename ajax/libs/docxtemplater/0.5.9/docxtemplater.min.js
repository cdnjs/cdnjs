...
(function(){var t,e,n;n="undefined"!=typeof global&&null!==global?global:window,e="undefined"!=typeof global&&null!==global?"node":"browser",n.ScopeManager=t=function(){function t(t,e,n,r,o){this.tags=t,this.scopePath=e,this.usedTags=n,this.currentScope=r,this.parser=o}return t.prototype.loopOver=function(t,e,n){var r,o,i,s,u;if(null==n&&(n=!1),n){if(!this.get(t))return e(this.currentScope);if("string"===this.getTypeOf(t))return;return void("object"===this.getTypeOf(t)&&this.get(t).length<1&&e(this.currentScope))}if(null!=this.get(t)){if("object"===this.getTypeOf(t))for(u=this.get(t),r=i=0,s=u.length;s>i;r=++i)o=u[r],e(o);return this.get(t)===!0?e(this.currentScope):void 0}},t.prototype.get=function(t){return this.currentScope[t]},t.prototype.getTypeOf=function(t){return typeof this.get(t)},t.prototype.getValueFromScope=function(t){var e,n,r;if(e=this.parser(t),n=e.get(this.currentScope),null!=n)if("string"==typeof n){if(this.useTag(t),r=n,-1!==r.indexOf("{")||-1!==r.indexOf("}"))throw new Error("You can't enter { or  } inside the content of a variable")}else r="number"==typeof n?String(n):n;else this.useTag(t),r="undefined";return r},t.prototype.useTag=function(t){var e,n,r,o,i,s;for(r=this.usedTags,s=this.scopePath,e=o=0,i=s.length;i>o;e=++o)n=s[e],null==r[n]&&(r[n]={}),r=r[n];return""!==t?r[t]=!0:void 0},t}()}).call(this);
