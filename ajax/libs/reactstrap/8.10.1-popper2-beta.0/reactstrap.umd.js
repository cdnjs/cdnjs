(function (global, factory) {
  ...
  var Button = /*#__PURE__*/function (_React$Component) {
    ...
    _proto.render = function render() {
      ...
      if (close && typeof attributes.children === 'undefined') {
        attributes.children = /*#__PURE__*/React__default['default'].createElement("span", {
          "aria-hidden": true
        }, "\xD7");
      }
  ...
  var Label = function Label(props) {
    ...
    var classes = mapToCssModules(classNames__default['default'](className, hidden ? 'visually-hidden' : false, check ? 'form-check-label' : false, size ? "col-form-label-" + size : false, colClasses, colClasses.length ? 'col-form-label' : false), cssModule);
    return /*#__PURE__*/React__default['default'].createElement(Tag, _extends({
      htmlFor: htmlFor
    }, attributes, {
      className: classes
