...
var NavLink$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(NavLink, _extends({
  innerRef: ref
}, props)));
...
var Dropdown$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Dropdown, _extends({
  innerRef: ref
}, props)));
...
var DropdownToggle$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(DropdownToggle, _extends({
  innerRef: ref
}, props)));
...
const _excluded$W = ["defaultOpen", "stayOpen", "innerRef"];
const propTypes$_ = {
  tag: tagPropType,
  className: PropTypes.string,
  cssModule: PropTypes.object,
...
var Collapse$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Collapse, _extends({
  innerRef: ref
}, props)));
...
var Card$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Card, _extends({
  innerRef: ref
}, props)));
...
class PopperContent extends React.Component {
  ...
  renderChildren() {
    ...
    const popperTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), transition), {}, {
...
var TooltipPopoverWrapper$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(TooltipPopoverWrapper, _extends({
  innerRef: ref
}, props)));
...
const FadePropTypes$1 = PropTypes.shape(Fade$1.propTypes);
const propTypes$z = {
  /** */
...
class Modal extends React.Component {
  ...
  render() {
    ...
    if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
      ...
      const modalTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), this.props.modalTransition), {}, {
        baseClass: hasTransition ? this.props.modalTransition.baseClass : '',
        timeout: hasTransition ? this.props.modalTransition.timeout : 0
      });

      const backdropTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), this.props.backdropTransition), {}, {
        baseClass: hasTransition ? this.props.backdropTransition.baseClass : '',
        timeout: hasTransition ? this.props.backdropTransition.timeout : 0
      });

      const Backdrop = backdrop && (hasTransition ? /*#__PURE__*/React.createElement(Fade$1, _extends({}, backdropTransition, {
        in: isOpen && !!backdrop,
        cssModule: cssModule,
...
var Modal$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Modal, _extends({
  innerRef: ref
}, props)));
...
var Form$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Form, _extends({
  innerRef: ref
}, props)));
...
var Input$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Input, _extends({
  innerRef: ref
}, props)));
...
const FadePropTypes = PropTypes.shape(Fade$1.propTypes);
const propTypes$k = {
  autoFocus: PropTypes.bool,
...
class Offcanvas extends React.Component {
  ...
  render() {
    ...
    if (!!this._element && (this.state.isOpen || !unmountOnClose)) {
      ...
      const offcanvasTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), this.props.offcanvasTransition), {}, {
...
var Offcanvas$1 = React.forwardRef((props, ref) => /*#__PURE__*/React.createElement(Offcanvas, _extends({
  innerRef: ref
}, props)));
...
const Alert = React.forwardRef((props, ref) => {
  ...
  const alertTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : '',
    timeout: fade ? transition.timeout : 0
  });
...
const Toast = React.forwardRef((props, ref) => {
  ...
  const toastTransition = _objectSpread2(_objectSpread2(_objectSpread2({}, Fade$1.defaultProps), transition), {}, {
    baseClass: fade ? transition.baseClass : '',
    timeout: fade ? transition.timeout : 0
  });
