...
/**
 * Create a new collection of animation events.
...
export class AssetRegistry extends EventHandler {
     ...
     * @param callback - The callback function that is used to filter assets.
 ...
 * @property loaded - True if the asset has finished attempting to load the resource. It is not guaranteed that the resources are available as there could have been a network error.
...
export namespace platform {
    ...
    /**
     * The global object. This will be the window object when running in a browser and
...
export class Application extends EventHandler {
    ...
    /**
     * Draws a single line. Line start and end coordinates are specified in world-space.
     ...
     * @param [color] - The color of the line. It defaults to white if not specified.
     * @param [depthTest] - Specifies if the line is depth tested againts the depth buffer. Defaults to true.
     * @param [layer] - The layer to render the line into. Defaults to {@link LAYERID_IMMEDIATE}.
     */
    drawLine(start: Vec3, end: Vec3, color?: Color, depthTest?: boolean, layer?: Layer): void;
    /**
     * Renders an arbitrary number of discrete line segments. The lines are not connected by each subsequent
     ...
     * @param positions - An array of points to draw lines between. The length of the array must be a multiple of 2.
     * @param colors - An array of colors to color the lines. This must be the same length as the position array.
     * The length of the array must also be a multiple of 2.
     * @param [depthTest] - Specifies if the lines are depth tested againts the depth buffer. Defaults to true.
     * @param [layer] - The layer to render the lines into. Defaults to {@link LAYERID_IMMEDIATE}.
     */
     ...
     * @param positions - An array of points to draw lines between. Each point is represented by 3 numbers - x, y and z coordinate.
     * @param colors - An array of colors to color the lines. This must be the same length as the position array.
     * The length of the array must also be a multiple of 2.
     * @param [depthTest] - Specifies if the lines are depth tested againts the depth buffer. Defaults to true.
     * @param [layer] - The layer to render the lines into. Defaults to {@link LAYERID_IMMEDIATE}.
 ...
 * @param weight - The weight of this layer. Defaults to 1.
 */
export class AnimComponentLayer {
    constructor(name: string, controller: any, component: AnimComponent, weight: number);
    /**
     ...
     * @param to - The state that this transition will transition to.
     * @param [time] - The duration of the transition in seconds. Defaults to 0.
     * @param [transitionOffset] - If provided, the destination state will begin playing its animation at this time. Given in normalized time, based on the states duration & must be between 0 and 1. Defaults to null.
     */
...
export class AnimComponent extends Component {
     ...
     * @param [weight] - The blending weight of the layer. Defaults to 1.
     * @param [mask] - A list of paths to bones in the model which should be animated in this layer. If omitted the full model is used. Defaults to null.
     * @param [blendType] - Defines how properties animated by this layer blend with animations of those properties in previous layers. Defaults to pc.ANIM_LAYER_OVERWRITE.
     * @returns The created anim component layer.
     */
     ...
     * @param name - The name of the anim component layer to find.
     * @returns Layer.
     */
...
export class CameraComponent extends Component {
     ...
     * @param [options.imageTracking] - Set to true to attempt to enable {@link XrImageTracking}.
     * @param [options.planeDetection] - Set to true to attempt to enable {@link XrPlaneDetection}.
...
mapping generated by this light. Valid range is 0 to 1. Defaults to 0.05.
 * @property numCascades - Number of shadow cascades. Can be 1, 2, 3 or 4. Defaults to 1, representing no cascades.
 * @property cascadeDistribution - The distribution of subdivision of the camera frustum for individual shadow cascades.
 ...
 * @property normalOffsetBias - Normal offset depth bias. Valid range is 0 to 1. Defaults to 0.
 * @property range - The range of the light. Affects omni and spot lights only.
Defaults to 10.
 ...
 * @property bakeNumSamples - If bake is true, this specifies the number of samples used to bake this light into the lightmap. Defaults to 1. Maximum value is 255.
 * @property bakeArea - If bake is true and the light type is {@link LIGHTTYPE_DIRECTIONAL}, this specifies the penumbra angle in degrees, allowing a soft shadow boundary. Defaults to 0.
 ...
 * @property vsmBlurSize - Number of samples used for blurring a variance shadow map. Only uneven numbers work, even are incremented. Minimum value is 1, maximum is 25. Defaults to 11.
 * @property cookieAsset - Asset that has texture that will be assigned to cookie internally once asset resource is available.
 * @property cookie - Projection texture. Must be 2D for spot and cubemap for omni light (ignored if incorrect type is used).
 ...
 * @property cookieChannel - Color channels of the projection texture to use. Can be "r", "g", "b", "a", "rgb".
...
export class LightComponent extends Component {
    ...
    */
    ...
    /**
     * The range of the light. Affects omni and spot lights only.
     * Defaults to 10.
    */
    range: number;
    /**
    ...
    */
    ...
    /**
     * If bake is true and the light type is {@link LIGHTTYPE_DIRECTIONAL}, this specifies the penumbra angle in degrees, allowing a soft shadow boundary. Defaults to 0.
    */
    bakeArea: number;
    /**
 ...
 * @property customAabb - If set, the object space bounding box is used as a bounding box for visibility culling of attached mesh instances. This is an optimization,
...
export class ModelComponent extends Component {
    ...
    */
    isStatic: boolean;
    /**
     * If set, the object space bounding box is used as a bounding box for visibility culling of attached mesh instances. This is an optimization,
     * allowing oversized bounding box to be specified for skinned characters in order to avoid per frame bounding box computations based on bone positions.
    */
    customAabb: BoundingBox;
    /**
 ...
 * @property renderAsset - The Render {@link Asset} used to set the mesh.
 ...
 * @property impulse - The total accumulated impulse applied by the constraint solver during the last substep. Describes how hard two objects collide.
...
export class ContactPoint {
    ...
    */
    normal: Vec3;
    /**
     * The total accumulated impulse applied by the constraint solver during the last substep. Describes how hard two objects collide.
    */
    impulse: number;
}
 ...
 * @property [scrollbar] - Gets the {@link ScrollbarComponent} attached to this entity. [read only]
...
export namespace script {
     ...
     * @param callback - A function which can set up and tear down a customized loading screen.
     */
...
- {@link CUBEFACE_POSZ}
- {@link CUBEFACE_NEGZ}
 * @param [options.flipY] - When set to true the image will be flipped in Y. Default is false.
...
export class VertexBuffer {
     ...
     * @returns True if function finished successfully, false otherwise.
     */
 ...
 * @param [config] - The Basis configuration.
 * @param [config.glueUrl] - URL of glue script.
 * @param [config.wasmUrl] - URL of the wasm module.
 * @param [config.fallbackUrl] - URL of the fallback script to use when wasm modules aren't supported.
 * @param [config.lazyInit] - Wait for first transcode request before initializing Basis
(default is false). Otherwise initialize Basis immediately.
 * @param [config.numWorkers] - Number of workers to use for transcoding (default is 1). While it is
 ...
 * @param [config.eagerWorkers] - Use eager workers (default is true). When enabled, jobs are assigned
 ...
 * @param [config.rgbPriority] - Array of texture compression formats in priority order for textures without alpha.
The supported compressed formats are: 'astc', 'atc', 'dxt', 'etc1', 'etc2', 'pvr'.
 * @param [config.rgbaPriority] - Array of texture compression formats in priority order for textures with alpha.
The supported compressed formats are: 'astc', 'atc', 'dxt', 'etc1', 'etc2', 'pvr'.
 */
...
export interface ContainerResource {
     ...
     * @returns A hierarchy of entities with render components on entities containing renderable geometry.
     */
...
export class ContainerHandler implements ResourceHandler {
    constructor(device: GraphicsDevice, assets: AssetRegistry, defaultMaterial: StandardMaterial);
    /**
     * Load a resource from a remote URL. When loaded (or failed),
     * use the callback to return an the raw resource data (or error).
     * @param url - Either the URL of the resource to load or a structure containing the
...
export class ResourceLoader {
     ...
     * @param callback - The callback used when the resource is loaded or an
 ...
 * @param device - The graphics device used by the lightmapper.
 ...
 * @property diffuseMapRotation - Controls the 2D rotation (in degrees) of the main (primary) diffuse map.
 ...
 * @property diffuseDetailMapRotation - Controls the 2D rotation (in degrees) of the main (secondary) diffuse map.
 ...
 * @property specularMapRotation - Controls the 2D rotation (in degrees) of the specular map.
 ...
 * @property clearCoatMapRotation - Controls the 2D rotation (in degrees) of the clear coat intensity map.
 ...
 * @property clearCoatGlossMapRotation - Controls the 2D rotation (in degrees) of the clear coat gloss map.
 ...
 * @property clearCoatNormalMapRotation - Controls the 2D rotation (in degrees) of the main clear coat map.
 ...
 * @property metalnessMapRotation - Controls the 2D rotation (in degrees) of the metalness map.
 ...
 * @property glossMapRotation - Controls the 2D rotation (in degrees) of the gloss map.
 ...
 * @property emissiveMapRotation - Controls the 2D rotation (in degrees) of the emissive map.
 ...
 * @property opacityMapRotation - Controls the 2D rotation (in degrees) of the opacity map.
 ...
 * @property normalMapRotation - Controls the 2D rotation (in degrees) of the main (primary) normal map.
 ...
 * @property normalDetailMapRotation - Controls the 2D rotation (in degrees) of the detail (secondary) normal map.
 ...
 * @property heightMapRotation - Controls the 2D rotation (in degrees) of the height map.
 ...
 * @property lightMapRotation - Controls the 2D rotation (in degrees) of the lightmap.
 ...
 * @property aoMapRotation - Controls the 2D rotation (in degrees) of the AO map.
...
export class StandardMaterial extends Material {
    ...
    */
    ...
    /**
     * Controls the 2D rotation (in degrees) of the clear coat intensity map.
    */
    ...
    */
    ...
    /**
     * Controls the 2D rotation (in degrees) of the main clear coat map.
    */
    ...
    */
    aoMapOffset: Vec2;
    /**
     * Controls the 2D rotation (in degrees) of the AO map.
    */
 ...
 * @property morphInstance - The morph instance managing morphing of this mesh instance, or null if morphing is not used.
 * @property skinInstance - The skin instance managing skinning of this mesh instance, or null if skinning is not used.
 ...
 * @property meshInstance - The mesh instance this morph instance controls the morphing of.
 * @property morph - The morph with its targets, which is being instanced.
 ...
 * @param [opts.calculateTangents] - Generate tangent information (defaults to false).
 ...
 * @param [opts.latitudeBands] - The number of divisions along the latitudinal axis of the sphere (defaults to 16).
 * @param [opts.longitudeBands] - The number of divisions along the longitudinal axis of the sphere (defaults to 16).
 * @param [opts.calculateTangents] - Generate tangent information (defaults to false).
 ...
 * @property lightmapFilterEnabled - Enables bilateral filter on runtime baked color lightmaps, which removes the noise and banding while preserving the edges. Defaults to false;
 ...
 * @property lightmapFilterRange - A range parameter of the bilateral filter. It's used when {@link Scene#lightmapFilterEnabled} is enabled. Larger value applies more widespread blur. This needs to be a positive non-zero value. Defaults to 10.
 * @property lightmapFilterSmoothness - A spatial parameter of the bilateral filter. It's used when {@link Scene#lightmapFilterEnabled} is enabled. Larger value blurs less similar colors. This needs to be a positive non-zero value. Defaults to 0.2.
 * @property ambientBake - If enabled, the ambient lighting will be baked into lightmaps. This will be either the {@link Scene#skybox} if set up, otherwise {@link Scene#ambientLight}. Defaults to false.
 * @property ambientBakeNumSamples - If {@link Scene#ambientBake} is true, this specifies the number of samples used to bake the ambient light into the lightmap. Defaults to 1. Maximum value is 255.
 * @property ambientBakeSpherePart - If {@link Scene#ambientBake} is true, this specifies a part of the sphere which represents the source of ambient light. The valid range is 0..1, representing a part of the sphere from top to the bottom.
 ...
 * @property ambientBakeOcclusionContrast - If {@link Scene#ambientBake} is true, this specifies the contrast of ambient occlusion. Typical range is -1 to 1. Defaults to 0, representing no change to contrast.
 * @property ambientBakeOcclusionBrightness - If {@link Scene#ambientBake} is true, this specifies the brightness of ambient occlusion. Typical range is -1 to 1. Defaults to 0, representing no change to brightness.
...
export class Scene extends EventHandler {
    ...
    */
    lightmapMode: number;
    /**
     * Enables bilateral filter on runtime baked color lightmaps, which removes the noise and banding while preserving the edges. Defaults to false;
    Note that the filtering takes place in the image space of the lightmap, and it does not filter across lightmap UV space seams, often making the seams more visible. It's important to balance the strength of the filter with number of samples used
    for lightmap baking to limit the visible artifacts.
    */
    lightmapFilterEnabled: boolean;
    /**
     * A range parameter of the bilateral filter. It's used when {@link Scene#lightmapFilterEnabled} is enabled. Larger value applies more widespread blur. This needs to be a positive non-zero value. Defaults to 10.
    */
    lightmapFilterRange: number;
    /**
     * A spatial parameter of the bilateral filter. It's used when {@link Scene#lightmapFilterEnabled} is enabled. Larger value blurs less similar colors. This needs to be a positive non-zero value. Defaults to 0.2.
    */
    lightmapFilterSmoothness: number;
    /**
     * If enabled, the ambient lighting will be baked into lightmaps. This will be either the {@link Scene#skybox} if set up, otherwise {@link Scene#ambientLight}. Defaults to false.
    */
    ambientBake: boolean;
    /**
     * If {@link Scene#ambientBake} is true, this specifies the number of samples used to bake the ambient light into the lightmap. Defaults to 1. Maximum value is 255.
    */
    ambientBakeNumSamples: number;
    /**
     * If {@link Scene#ambientBake} is true, this specifies a part of the sphere which represents the source of ambient light. The valid range is 0..1, representing a part of the sphere from top to the bottom.
    A value of 0.5 represents the upper hemisphere. A value of 1 represents a full sphere. Defaults to 0.4, which is a smaller upper hemisphere as this requires fewer samples to bake.
    */
    ambientBakeSpherePart: number;
    /**
     * If {@link Scene#ambientBake} is true, this specifies the contrast of ambient occlusion. Typical range is -1 to 1. Defaults to 0, representing no change to contrast.
    */
    ambientBakeOcclusionContrast: number;
    /**
     * If {@link Scene#ambientBake} is true, this specifies the brightness of ambient occlusion. Typical range is -1 to 1. Defaults to 0, representing no change to brightness.
    */
 ...
 * @param [halfExtents] - Half the distance across the box in each axis. The constructor takes a reference of this parameter. Defaults to 0.5 on each axis.
 */
 ...
 * @property center - Center of sphere.
 ...
 * @property supported - True if Plane Detection is supported.
 * @property available - True if Plane Detection is available. This property can be set to true only during a running session.
 * @property planes - Array of {@link XrPlane} instances that contain individual plane information, or null if plane detection is not available.
 * @param manager - WebXR Manager.
 */
export class XrPlaneDetection {
    constructor(manager: XrManager);
    /**
    ...
    */
    available: boolean;
    /**
     * Array of {@link XrPlane} instances that contain individual plane information, or null if plane detection is not available.
    */
    planes: XrPlane[] | null;
}
 ...
 * @property id - Unique identifier of a plane.
 * @property orientation - Plane's specific orientation (horizontal or vertical) or null if orientation is anything else.
 * @param planeDetection - Plane detection system.
...
export class XrPlane {
     ...
     * @returns The world space position of a plane.
     */
    getPosition(): Vec3;
    /**
     * Get the world space rotation of a plane.
     * @returns The world space rotation of a plane.
     */
    getRotation(): Quat;
    /**
