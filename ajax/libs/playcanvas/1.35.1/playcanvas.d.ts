...
declare namespace pc {
    ...
    * {number} view: Type of view. Can be pc.VIEW_CENTER, pc.VIEW_LEFT or pc.VIEW_RIGHT.
     ...
     */
    const TEXTURETYPE_SWIZZLEGGGR: number;
    /**
     ...
     */
    function reprojectTexture(device: pc.GraphicsDevice, source: pc.Texture, target: pc.Texture, specularPower?: number): void;
    /**
