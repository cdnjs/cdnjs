...
export class AnimComponentLayer {
     ...
     * @param [transitionOffset] - If provided, the destination state will begin playing its animation at this time. Given in normalised time, based on the states duration & must be between 0 and 1. Defaults to null.
     */
