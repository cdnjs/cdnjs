(function () {
  ...
  var DriverDOM = {
    ...
    setUnitPrecision: setUnitPrecision,
    setDecimalPixelTransformer: setDecimalPixelTransformer,
    setTagNamePrefix: setTagNamePrefix,
  ...
  if (typeof module !== 'undefined') module.exports = DriverDOM;else self.DriverDOM = DriverDOM;

}());
//# sourceMappingURL=driver-dom.js.map
