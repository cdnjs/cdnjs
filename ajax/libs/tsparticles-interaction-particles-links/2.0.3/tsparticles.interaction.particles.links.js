...
;// CONCATENATED MODULE: ./dist/Linker.js
...
;// CONCATENATED MODULE: ./dist/LinkInstance.js
  ...
  drawLinkLine(p1, link) {
    ...
    container.canvas.draw(ctx => {
      ...
      if (twinkle.enable) {
        ...
        const twinkleRgb = (0,external_commonjs_tsparticles_engine_commonjs2_tsparticles_engine_amd_tsparticles_engine_root_window_.colorToRgb)(twinkle.color);
...
;// CONCATENATED MODULE: ./dist/plugin.js
