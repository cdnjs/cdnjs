(function (global, factory) {
  ...
  function guideFormat(fieldOrDatumDef, type, format, formatType, config, omitTimeFormatConfig) {
    if (isCustomFormatType(formatType)) {
      ...
      return undefined; // handled in encode block
    } else if (format === undefined && formatType === undefined && config.normalizedNumberFormatType && config.customFormatTypes && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === 'normalize') {
      return undefined; // handled in encode block
    }
  ...
  */
  ...
  function labels(model, channel, specifiedLabelsSpec) {
    ...
    } else if (format === undefined && formatType === undefined && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === 'normalize' && channelDefType(fieldOrDatumDef) === 'quantitative') {
      let fmt = 'format';
