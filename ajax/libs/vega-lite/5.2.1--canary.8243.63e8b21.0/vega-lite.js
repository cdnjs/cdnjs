(function (global, factory) {
  ...
  'padding', 'facet', 'concat', 'numberFormat', 'numberFormatType', 'timeFormat', 'countTitle', 'header', 'axisQuantitative', 'axisTemporal', 'axisDiscrete', 'axisPoint', 'axisXBand', 'axisXPoint', 'axisXDiscrete', 'axisXQuantitative', 'axisXTemporal', 'axisYBand', 'axisYPoint', 'axisYDiscrete', 'axisYQuantitative', 'axisYTemporal', 'scale', 'selection', 'overlay' // FIXME: Redesign and unhide this
  ];
  ...
  */
  ...
  function labels(model, channel, specifiedLabelsSpec) {
    ...
    } else if (format === undefined && formatType === undefined && config.customFormatTypes && config.numberFormatType && channelDefType(fieldOrDatumDef) === 'quantitative') {
      return {
        text: formatCustomType({
          fieldOrDatumDef,
          field: 'datum.value',
