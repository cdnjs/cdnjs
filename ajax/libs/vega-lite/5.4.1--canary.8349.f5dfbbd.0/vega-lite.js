(function (global, factory) {
  ...
  function positionAndSize(fieldDef, channel, model) {
    ...
    const hasFixedSizeMixins = !!sizeMixins; // Otherwise, apply default value
    ...
    const defaultBandAlign = (scale === null || scale === void 0 ? void 0 : scale.get('type')) === 'band' && isRelativeBandSize(bandSize) && !hasFixedSizeMixins ? 'top' : 'middle';
