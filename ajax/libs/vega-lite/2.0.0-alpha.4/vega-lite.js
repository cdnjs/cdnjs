...
module.exports={
  ...
  "scripts": {
    ...
    "test": "tsc && npm run schema && npm run test:nocompile",
    "test:nocompile": "npm run test:only && npm run lint && npm run test:examples",
    "test:only": "nyc --reporter=html --reporter=text-summary --require ./test/babel.ts mocha build/test",
    "test:examples": "npm run data && mocha --require ./test/babel.ts build/examples",
    "test:debug": "npm run schema && npm run data && mocha --require ./test/babel.ts --debug-brk build/test build/examples",
