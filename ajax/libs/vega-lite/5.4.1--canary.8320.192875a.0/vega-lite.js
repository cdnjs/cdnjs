(function (global, factory) {
  ...
  function guideFormat(fieldOrDatumDef, type, format, formatType, config, omitTimeFormatConfig) {
    if (isCustomFormatType(formatType)) {
      ...
      if (channelDefType(fieldOrDatumDef) === 'quantitative' && (config.normalizedNumberFormatType && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === 'normalize' || // case: normalized number format
