(function (global, factory) {
  ...
  function encodingHasRangeChannels(encoding) {
  ...
  const scaleRules = {
    ...
    zero: _ref8 => {
      ...
      return zero(channel, fieldOrDatumDef, domain, markDef, scaleType, config.scale, hasRangeChannels);
    }
  ...
  function zero(channel, fieldDef, specifiedDomain, markDef, scaleType, scaleConfig, hasRangeChannels) {
    ...
    const defaultZero = (scaleConfig === null || scaleConfig === void 0 ? void 0 : scaleConfig.zero) === undefined ? true : scaleConfig === null || scaleConfig === void 0 ? void 0 : scaleConfig.zero; // If there is no custom domain, return configZero value (=`true` as default) only for the following cases:
