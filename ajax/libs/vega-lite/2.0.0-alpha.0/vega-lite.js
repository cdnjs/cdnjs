...
function init(channel, fieldDef, config, mark, topLevelSize, xyRangeSteps) {
    ...
    var scale = {
        type: type_1.default(fieldDef, channel, mark, topLevelSize, config)
    };
 ...
 */
function type(fieldDef, channel, mark, topLevelSize, config) {
    if (!channel_1.hasScale(channel)) {
        // There is no scale for these channels
        return null;
    }
    var specifiedScale = fieldDef.scale || {};
    var specifiedType = specifiedScale.type;
    if (specifiedType !== undefined) {
        ...
        if (channel_1.supportScaleType(channel, specifiedType)) {
            ...
            var newScaleType = defaultType(specifiedScale, fieldDef, channel, mark, topLevelSize, config);
 ...
 */
function defaultType(specifiedScale, fieldDef, channel, mark, topLevelSize, config) {
 ...
 */
function discreteToContinuousType(channel, mark, specifiedScale, topLevelSize, config) {
...
function haveRangeStep(specifiedScale, topLevelSize, config) {
    if (topLevelSize !== undefined) {
