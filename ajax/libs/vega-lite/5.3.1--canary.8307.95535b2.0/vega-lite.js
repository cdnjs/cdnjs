(function (global, factory) {
  ...
  function guideFormat(fieldOrDatumDef, type, format, formatType, config, omitTimeFormatConfig) {
    if (isCustomFormatType(formatType)) {
      ...
      if (config.normalizedNumberFormatType && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === 'normalize' && channelDefType(fieldOrDatumDef) === 'quantitative') {
        return undefined; // handled in encode block
      }
  ...
  function numberFormat(type, specifiedFormat, config, normalizedStack) {
