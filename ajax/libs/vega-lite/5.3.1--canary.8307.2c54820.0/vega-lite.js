(function (global, factory) {
  ...
  */
  ...
  function labels(model, channel, specifiedLabelsSpec) {
    ...
    } else if (format === undefined && formatType === undefined && config.customFormatTypes && config.normalizedNumberFormatType && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === 'normalize' && channelDefType(fieldOrDatumDef) === 'quantitative') {
      return {
        text: formatCustomType({
          fieldOrDatumDef,
          field: 'datum.value',
