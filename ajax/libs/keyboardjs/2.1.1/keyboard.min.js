...
(function (global){
function Keyboard(e,t,n,s){this._locale=null,this._currentContext=null,this._contexts={},this._listeners=[],this._appliedListeners=[],this._locales={},this._targetElement=null,this._targetWindow=null,this._targetPlatform="",this._targetUserAgent="",this._isModernBrowser=!1,this._targetKeyDownBinding=null,this._targetKeyUpBinding=null,this._targetResetBinding=null,this._paused=!1,this.setContext("global"),this.watch(e,t,n,s)}var Locale=require("./locale"),KeyCombo=require("./key-combo");Keyboard.prototype.setLocale=function(e,t){var n=null;"string"==typeof e?t?(n=new Locale(e),t(n,this._targetPlatform,this._targetUserAgent)):n=this._locales[e]||null:(n=e,e=n._localeName),this._locale=n,this._locales[e]=n,n&&(this._locale.pressedKeys=n.pressedKeys)},Keyboard.prototype.getLocale=function(e){return e||(e=this._locale.localeName),this._locales[e]||null},Keyboard.prototype.bind=function(e,t,n,s){if((null===e||"function"==typeof e)&&(s=n,n=t,t=e,e=null),e&&"object"==typeof e&&"number"==typeof e.length)for(var i=0;i<e.length;i+=1)this.bind(e[i],t,n);else this._listeners.push({keyCombo:e?new KeyCombo(e):null,pressHandler:t||null,releaseHandler:n||null,preventRepeat:s||!1,preventRepeatByDefault:s||!1})},Keyboard.prototype.addListener=Keyboard.prototype.bind,Keyboard.prototype.on=Keyboard.prototype.bind,Keyboard.prototype.unbind=function(e,t,n){if((null===e||"function"==typeof e)&&(n=t,t=e,e=null),e&&"object"==typeof e&&"number"==typeof e.length)for(var s=0;s<e.length;s+=1)this.unbind(e[s],t,n);else for(var s=0;s<this._listeners.length;s+=1){var i=this._listeners[s],r=!e&&!i.keyCombo||i.keyCombo.isEqual(e),o=!t&&!n||!t&&!i.pressHandler||t===i.pressHandler,l=!t&&!n||!n&&!i.releaseHandler||n===i.releaseHandler;r&&o&&l&&(this._listeners.splice(s,1),s-=1)}},Keyboard.prototype.removeListener=Keyboard.prototype.unbind,Keyboard.prototype.off=Keyboard.prototype.unbind,Keyboard.prototype.setContext=function(e){this._locale&&this.releaseAllKeys(),this._contexts[e]||(this._contexts[e]=[]),this._listeners=this._contexts[e],this._currentContext=e},Keyboard.prototype.getContext=function(){return this._currentContext},Keyboard.prototype.watch=function(e,t,n,s){var i=this;this.stop(),e&&null!==e||(e=global),"number"==typeof e.nodeType&&(s=n,n=t,t=e,e=global);var r=e.navigator&&e.navigator.userAgent||"",o=e.navigator&&e.navigator.platform||"";t&&null!==t||(t=e.document),n&&null!==n||(n=o),s&&null!==s||(s=r),this._isModernBrowser=!!e.addEventListener,this._targetKeyDownBinding=function(e){i.pressKey(e.keyCode,e)},this._targetKeyUpBinding=function(e){i.releaseKey(e.keyCode,e)},this._targetResetBinding=function(e){i.releaseAllKeys(e)},this._bindEvent(t,"keydown",this._targetKeyDownBinding),this._bindEvent(t,"keyup",this._targetKeyUpBinding),this._bindEvent(e,"focus",this._targetResetBinding),this._bindEvent(e,"blur",this._targetResetBinding),this._targetElement=t,this._targetWindow=e,this._targetPlatform=n,this._targetUserAgent=s},Keyboard.prototype.stop=function(){this._targetElement&&this._targetWindow&&(this._unbindEvent(this._targetElement,"keydown",this._targetKeyDownBinding),this._unbindEvent(this._targetElement,"keyup",this._targetKeyUpBinding),this._unbindEvent(this._targetWindow,"focus",this._targetResetBinding),this._unbindEvent(this._targetWindow,"blur",this._targetResetBinding),this._targetWindow=null,this._targetElement=null)},Keyboard.prototype.pressKey=function(e,t){if(!this._paused){if(!this._locale)throw new Error("Locale not set");this._locale.pressKey(e),this._applyBindings(t)}},Keyboard.prototype.releaseKey=function(e,t){if(!this._paused){if(!this._locale)throw new Error("Locale not set");this._locale.releaseKey(e),this._clearBindings(t)}},Keyboard.prototype.releaseAllKeys=function(e){if(!this._paused){if(!this._locale)throw new Error("Locale not set");this._locale.pressedKeys.length=0,this._clearBindings(e)}},Keyboard.prototype.pause=function(){this._paused||(this._locale&&this.releaseAllKeys(),this._paused=!0)},Keyboard.prototype.resume=function(){this._paused=!1},Keyboard.prototype.reset=function(){this.releaseAllKeys(),this._listeners.length=0},Keyboard.prototype._bindEvent=function(e,t,n){return this._isModernBrowser?e.addEventListener(t,n,!1):e.attachEvent("on"+t,n)},Keyboard.prototype._unbindEvent=function(e,t,n){return this._isModernBrowser?e.removeEventListener(t,n,!1):e.detachEvent("on"+t,n)},Keyboard.prototype._getGroupedListeners=function(){var e=[],t=[],n=this._listeners;return"global"!==this._currentContext&&(n=[].concat(n,this._contexts.global)),n.sort(function(e,t){return e.keyCombo.keyNames.length<t.keyCombo.keyNames.length}).forEach(function(n){for(var s=-1,i=0;i<t.length;i+=1)t[i].isEqual(n.keyCombo)&&(s=i);-1===s&&(s=t.length,t.push(n.keyCombo)),e[s]||(e[s]=[]),e[s].push(n)}),e},Keyboard.prototype._applyBindings=function(e){var t=!1;e||(e={}),e.preventRepeat=function(){t=!0},e.pressedKeys=this._locale.pressedKeys.slice(0);for(var n=this._locale.pressedKeys.slice(0),s=this._getGroupedListeners(),i=0;i<s.length;i+=1){var r=s[i],o=r[0].keyCombo;if(null===o||o.check(n)){for(var l=0;l<r.length;l+=1){var a=r[l],h=a.pressHandler;if(h&&!a.preventRepeat&&(h.call(this,e),t&&(a.preventRepeat=t,t=!1)),a.releaseHandler){var p=this._appliedListeners.indexOf(a);p>-1&&null===o&&(a.releaseHandler.call(this,e),this._appliedListeners.splice(p,1),p=-1),-1===p&&this._appliedListeners.push(a)}}if(o)for(var l=0;l<o.keyNames.length;l+=1){var p=n.indexOf(o.keyNames[l]);-1!==p&&(n.splice(p,1),l-=1)}}}},Keyboard.prototype._clearBindings=function(e){e||(e={});for(var t=0;t<this._appliedListeners.length;t+=1){var n=this._appliedListeners[t],s=n.keyCombo,i=n.releaseHandler;null!==s&&s.check(this._locale.pressedKeys)||(n.preventRepeat=n.preventRepeatByDefault,i.call(this,e),this._appliedListeners.splice(t,1),t-=1)}},module.exports=Keyboard;
