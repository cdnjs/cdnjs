(function (global, factory) {
    ...
    function renderVNodeToString(vNode, parent, context) {
        ...
        if ((flags & 14 /* VNodeFlags.Component */) !== 0) {
            ...
            if (childFlags$1 === 2 /* ChildFlags.HasVNodeChildren */ || (isArray(vNode) && vNode.length === 0)) {
                return '<!--!-->';
            }
            else if (childFlags$1 & 12 /* ChildFlags.MultipleChildren */ || isArray(vNode)) {
            ...
            if (childFlags === 2 /* ChildFlags.HasVNodeChildren */ || (isArray(vNode) && vNode.length === 0)) {
                ...
                return children.reduce(function (p, child) {
                    return p.then(function () {
                        return Promise.resolve(this$1$1.renderNode(child, context)).then(function () { return !!(child.flags & 16 /* VNodeFlags.Text */); });
                    });
