(function (exports,covutils) {
	...
	var require$$1 = (iota && typeof iota === 'object' && 'default' in iota ? iota['default'] : iota);

	var ndarray = createCommonjsModule(function (module) {
	var iota = require$$1
	var isBuffer = require$$0
...
b"+i+"*=d\
	...
	var template = (urlTemplate && typeof urlTemplate === 'object' && 'default' in urlTemplate ? urlTemplate['default'] : urlTemplate);
	  ...
	  var promises = tiles.map(function (tile) {
	    ...
	    return load$1(url).then(function (result) {
	      ...
	      for (var ax = 0; ax < tileShape.length; ax++) {
	        ...
	        var stop = _constraintsArr$ax2.stop;
