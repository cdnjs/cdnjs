...
var Coverage = function () {
  ...
  function Coverage(covjson, options) {
    ...
    this.prefixes = (0, _util.getNamespacePrefixes)(this.ld);
    ...
    if (domainType && domainType.indexOf(':') === -1) {
      domainType = _util.DOMAINTYPES_PREFIX + domainType;
    }
...
function transformNdArrayRange(range, domain) {
  ...
  if (range.actualMin === undefined) {
    var _minMax = (0, _array.minMax)(values);
  ...
  var ndarr = (0, _ndarray2.default)(values, shapeArr);
  range._ndarr = ndarr;
  ...
  try {
    for (var _iterator5 = axes[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      if (axis.dataType && axis.dataType.indexOf(':') === -1) {
        axis.dataType = _util.CORE_PREFIX + axis.dataType;
      }
...
},{"./constants.js":3,"./http":4,"./util.js":7,"covutils/lib/array.js":8,"covutils/lib/coverage/subset.js":11,"covutils/lib/domain/subset.js":13,"ndarray":14,"url-template":17}],2:[function(require,module,exports){
'use strict';
...
},{"./Coverage.js":1,"./constants.js":3,"./util.js":7,"covutils/lib/collection/create.js":9}],3:[function(require,module,exports){
'use strict';
...
},{"./http-common.js":5}],5:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.COVJSON_PROFILE_STANDALONE = exports.EXT = exports.MEDIATYPE = undefined;
...
var COVJSON_PROFILE_STANDALONE = exports.COVJSON_PROFILE_STANDALONE = _util.CORE_PREFIX + 'standalone';
...
exports.getNamespacePrefixes = getNamespacePrefixes;


var PREFIX = 'http://covjson.org/def/';
var CORE_PREFIX = exports.CORE_PREFIX = PREFIX + 'core#';
var DOMAINTYPES_PREFIX = exports.DOMAINTYPES_PREFIX = PREFIX + 'domainTypes#';
...
},{"covutils/lib/array.js":8}],8:[function(require,module,exports){
'use strict';
...
},{"../constants.js":10,"../domain/referencing.js":12}],10:[function(require,module,exports){
'use strict';
...
},{"../array.js":8,"../constants.js":10,"../domain/referencing.js":12,"../domain/subset.js":13}],12:[function(require,module,exports){
'use strict';
