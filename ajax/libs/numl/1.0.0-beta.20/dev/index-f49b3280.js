...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-6e445503.js')),
  hover: () => extractModule(import('./hover-20e67d09.js')),
  listbox: () => extractModule(import('./listbox-4b831d42.js')),
  option: () => extractModule(import('./option-1341817d.js')),
  active: () => extractModule(import('./active-2f425280.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-99720360.js')),
  popup: () => extractModule(import('./popup-41f10b8a.js')),
  control: () => extractModule(import('./control-0ca573e3.js')),
  radiogroup: () => extractModule(import('./radiogroup-6020e5cb.js')),
  action: () => extractModule(import('./action-542dadfa.js')),
  label: () => extractModule(import('./label-6b7cc73e.js')),
  code: () => extractModule(import('./code-655a9ca4.js')),
  markdown: () => extractModule(import('./markdown-ca9fa3f6.js')),
  datetime: () => extractModule(import('./datetime-132aa891.js')),
  number: () => extractModule(import('./number-c2ba5a40.js')),
  slider: () => extractModule(import('./slider-9d385e7f.js')),
  numinput: () => extractModule(import('./numinput-d6bfd89c.js')),
  input: () => extractModule(import('./input-1182968c.js')),
  textarea: () => extractModule(import('./textarea-2f4e5a02.js')),
  fileinput: () => extractModule(import('./fileinput-32be9c2a.js')),
  icon: () => extractModule(import('./icon-975e2f12.js')),
  svg: () => extractModule(import('./svg-a4e02208.js')),
  image: () => extractModule(import('./image-1a7703ea.js')),
  debug: () => extractModule(import('./debug-c0ba835f.js')),
  debugger: () => extractModule(import('./debugger-4d399a3e.js')),
  form: () => extractModule(import('./form-fbe0da79.js')),
  validator: () => extractModule(import('./validator-1c09dfd5.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-fcbac283.js')),
  progressbar: () => extractModule(import('./progressbar-1736a1c2.js')),
  value: () => extractModule(import('./value-02a3484b.js')),
  datepicker: () => extractModule(import('./datepicker-496be295.js')),
  dateinput: () => extractModule(import('./dateinput-b258ac6f.js')),
  inputgroup: () => extractModule(import('./inputgroup-d3f2116c.js')),
  menu: () => extractModule(import('./menu-9bb5951d.js')),
  menuitem: () => extractModule(import('./menuitem-09f513db.js')),
  offset: () => extractModule(import('./offset-5d3083c6.js')),
  appear: () => extractModule(import('./appear-7a7fb464.js')),
  hotkey: () => extractModule(import('./hotkey-f904695d.js')),
  current: () => extractModule(import('./current-2be5e07a.js')),
};
