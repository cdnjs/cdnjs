...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-dd04684f.js')),
  hover: () => extractModule(import('./hover-38350f7f.js')),
  listbox: () => extractModule(import('./listbox-e26e7dd7.js')),
  option: () => extractModule(import('./option-aaec8021.js')),
  active: () => extractModule(import('./active-be8c3928.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-1cb80800.js')),
  popup: () => extractModule(import('./popup-8fd7d7cd.js')),
  control: () => extractModule(import('./control-5a7dafef.js')),
  radiogroup: () => extractModule(import('./radiogroup-af9f30c5.js')),
  action: () => extractModule(import('./action-fb4968ee.js')),
  label: () => extractModule(import('./label-fa0ab4fc.js')),
  code: () => extractModule(import('./code-f8f3565e.js')),
  markdown: () => extractModule(import('./markdown-57c47c7b.js')),
  datetime: () => extractModule(import('./datetime-ff20dfd7.js')),
  number: () => extractModule(import('./number-c6e22633.js')),
  slider: () => extractModule(import('./slider-81abe5b4.js')),
  slider2d: () => extractModule(import('./slider2d-5a7c8720.js')),
  numinput: () => extractModule(import('./numinput-4e57a739.js')),
  input: () => extractModule(import('./input-a329f07e.js')),
  textarea: () => extractModule(import('./textarea-b630060b.js')),
  fileinput: () => extractModule(import('./fileinput-8f8d9bbd.js')),
  icon: () => extractModule(import('./icon-dd4d29ae.js')),
  svg: () => extractModule(import('./svg-c7c40475.js')),
  image: () => extractModule(import('./image-6010b882.js')),
  debug: () => extractModule(import('./debug-9eac3f0c.js')),
  debugger: () => extractModule(import('./debugger-88d401f9.js')),
  form: () => extractModule(import('./form-b2acaa5b.js')),
  validator: () => extractModule(import('./validator-add58a69.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-bcecabe7.js')),
  progressbar: () => extractModule(import('./progressbar-5c42cdf5.js')),
  value: () => extractModule(import('./value-4b76a26f.js')),
  datepicker: () => extractModule(import('./datepicker-f1db221e.js')),
  dateinput: () => extractModule(import('./dateinput-71cb930d.js')),
  inputgroup: () => extractModule(import('./inputgroup-4595b295.js')),
  menu: () => extractModule(import('./menu-9b2ce03c.js')),
  menuitem: () => extractModule(import('./menuitem-2ad678c6.js')),
  offset: () => extractModule(import('./offset-e2904676.js')),
  appear: () => extractModule(import('./appear-cc794963.js')),
  hotkey: () => extractModule(import('./hotkey-9ae506c4.js')),
  current: () => extractModule(import('./current-31987344.js')),
};
...
import('./focus-visible-90ce353c.js').then(() => {
  // do nothing
});
