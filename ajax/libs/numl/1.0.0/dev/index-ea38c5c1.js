...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-387096e9.js')),
  hover: () => extractModule(import('./hover-12d3e2c4.js')),
  listbox: () => extractModule(import('./listbox-736979b9.js')),
  option: () => extractModule(import('./option-01d3ebac.js')),
  active: () => extractModule(import('./active-c728dfac.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-77ad44dd.js')),
  popup: () => extractModule(import('./popup-c733aed3.js')),
  control: () => extractModule(import('./control-d13b2f76.js')),
  radiogroup: () => extractModule(import('./radiogroup-d8cdb83b.js')),
  action: () => extractModule(import('./action-27803562.js')),
  label: () => extractModule(import('./label-5f11e59b.js')),
  code: () => extractModule(import('./code-c3015b9d.js')),
  markdown: () => extractModule(import('./markdown-607c10d5.js')),
  datetime: () => extractModule(import('./datetime-28b042e8.js')),
  number: () => extractModule(import('./number-b0451d49.js')),
  slider: () => extractModule(import('./slider-e68bc518.js')),
  numinput: () => extractModule(import('./numinput-91aabb3f.js')),
  input: () => extractModule(import('./input-c3768a90.js')),
  textarea: () => extractModule(import('./textarea-74114af8.js')),
  fileinput: () => extractModule(import('./fileinput-4e2f8a6f.js')),
  icon: () => extractModule(import('./icon-1cbf1c49.js')),
  svg: () => extractModule(import('./svg-9a11d278.js')),
  image: () => extractModule(import('./image-3d8a3246.js')),
  debug: () => extractModule(import('./debug-aeb4c03f.js')),
  debugger: () => extractModule(import('./debugger-81c7aecb.js')),
  form: () => extractModule(import('./form-2d7df626.js')),
  validator: () => extractModule(import('./validator-91e995ed.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-b5d77e77.js')),
  progressbar: () => extractModule(import('./progressbar-d9cc37d6.js')),
  value: () => extractModule(import('./value-6ff31eac.js')),
  datepicker: () => extractModule(import('./datepicker-ede6e771.js')),
  dateinput: () => extractModule(import('./dateinput-7f7ceff2.js')),
  inputgroup: () => extractModule(import('./inputgroup-ed2b284e.js')),
  menu: () => extractModule(import('./menu-63d9eba6.js')),
  menuitem: () => extractModule(import('./menuitem-a33685ab.js')),
  offset: () => extractModule(import('./offset-756ca693.js')),
  appear: () => extractModule(import('./appear-797314b4.js')),
  hotkey: () => extractModule(import('./hotkey-85462085.js')),
  current: () => extractModule(import('./current-feb26f4e.js')),
};
...
import('./focus-visible-30dbb597.js').then(() => {
  // do nothing
});
