...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-9a40c713.js')),
  hover: () => extractModule(import('./hover-48a347d9.js')),
  listbox: () => extractModule(import('./listbox-0d47e462.js')),
  option: () => extractModule(import('./option-4a2563ba.js')),
  active: () => extractModule(import('./active-fab4a122.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-d8178478.js')),
  popup: () => extractModule(import('./popup-ed2d942f.js')),
  control: () => extractModule(import('./control-538501ca.js')),
  radiogroup: () => extractModule(import('./radiogroup-792e4820.js')),
  action: () => extractModule(import('./action-6ba00070.js')),
  label: () => extractModule(import('./label-a6d01048.js')),
  code: () => extractModule(import('./code-6e9e4037.js')),
  markdown: () => extractModule(import('./markdown-8820a126.js')),
  datetime: () => extractModule(import('./datetime-72f7819f.js')),
  number: () => extractModule(import('./number-4aeac2b0.js')),
  slider: () => extractModule(import('./slider-c4fd3338.js')),
  numinput: () => extractModule(import('./numinput-29ea44b2.js')),
  input: () => extractModule(import('./input-1f87b348.js')),
  textarea: () => extractModule(import('./textarea-dcef5de3.js')),
  fileinput: () => extractModule(import('./fileinput-cb0d7461.js')),
  icon: () => extractModule(import('./icon-34a85729.js')),
  svg: () => extractModule(import('./svg-96f59ea9.js')),
  image: () => extractModule(import('./image-61e45d30.js')),
  debug: () => extractModule(import('./debug-ade73296.js')),
  debugger: () => extractModule(import('./debugger-78f72961.js')),
  form: () => extractModule(import('./form-bbbc1be1.js')),
  validator: () => extractModule(import('./validator-bf3fcb84.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-ab86b8fd.js')),
  progressbar: () => extractModule(import('./progressbar-3aea8e8c.js')),
  value: () => extractModule(import('./value-a3fe6fad.js')),
  datepicker: () => extractModule(import('./datepicker-492c30a5.js')),
  dateinput: () => extractModule(import('./dateinput-02c6759e.js')),
  inputgroup: () => extractModule(import('./inputgroup-1ebada88.js')),
  menu: () => extractModule(import('./menu-0cc00f1a.js')),
  menuitem: () => extractModule(import('./menuitem-c26cfe8c.js')),
  offset: () => extractModule(import('./offset-dfa2f214.js')),
  appear: () => extractModule(import('./appear-097f7c55.js')),
  hotkey: () => extractModule(import('./hotkey-543dd0fa.js')),
  current: () => extractModule(import('./current-532a0292.js')),
};
