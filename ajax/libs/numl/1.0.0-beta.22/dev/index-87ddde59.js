...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-55d2b6b9.js')),
  hover: () => extractModule(import('./hover-73835510.js')),
  listbox: () => extractModule(import('./listbox-da0533d7.js')),
  option: () => extractModule(import('./option-6638aaf6.js')),
  active: () => extractModule(import('./active-32944a38.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-707fde4e.js')),
  popup: () => extractModule(import('./popup-0d849792.js')),
  control: () => extractModule(import('./control-b95e32aa.js')),
  radiogroup: () => extractModule(import('./radiogroup-6551f831.js')),
  action: () => extractModule(import('./action-2aef4ee8.js')),
  label: () => extractModule(import('./label-8159d35c.js')),
  code: () => extractModule(import('./code-254095c1.js')),
  markdown: () => extractModule(import('./markdown-8cbaffbe.js')),
  datetime: () => extractModule(import('./datetime-51ccc894.js')),
  number: () => extractModule(import('./number-e9582e32.js')),
  slider: () => extractModule(import('./slider-4bfdaa91.js')),
  numinput: () => extractModule(import('./numinput-60a2104b.js')),
  input: () => extractModule(import('./input-2fb848cb.js')),
  textarea: () => extractModule(import('./textarea-61b69d7d.js')),
  fileinput: () => extractModule(import('./fileinput-24a33636.js')),
  icon: () => extractModule(import('./icon-b332df57.js')),
  svg: () => extractModule(import('./svg-6c6966a3.js')),
  image: () => extractModule(import('./image-ec7d66d9.js')),
  debug: () => extractModule(import('./debug-fb7a0be5.js')),
  debugger: () => extractModule(import('./debugger-fa724cda.js')),
  form: () => extractModule(import('./form-e07b25e2.js')),
  validator: () => extractModule(import('./validator-0e4b8342.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-f38377ce.js')),
  progressbar: () => extractModule(import('./progressbar-34498fa7.js')),
  value: () => extractModule(import('./value-b6f37e28.js')),
  datepicker: () => extractModule(import('./datepicker-02ba837a.js')),
  dateinput: () => extractModule(import('./dateinput-609f4095.js')),
  inputgroup: () => extractModule(import('./inputgroup-975622dc.js')),
  menu: () => extractModule(import('./menu-3497fab1.js')),
  menuitem: () => extractModule(import('./menuitem-a1e2a2ee.js')),
  offset: () => extractModule(import('./offset-9b92f7c1.js')),
  appear: () => extractModule(import('./appear-118ff93b.js')),
  hotkey: () => extractModule(import('./hotkey-7315e2b1.js')),
  current: () => extractModule(import('./current-27318aa5.js')),
};
