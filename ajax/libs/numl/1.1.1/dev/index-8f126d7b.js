...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-1d1bece1.js')),
  hover: () => extractModule(import('./hover-3cd2e1fd.js')),
  listbox: () => extractModule(import('./listbox-09711d7d.js')),
  option: () => extractModule(import('./option-c3c8a74f.js')),
  active: () => extractModule(import('./active-b25f73dc.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-7568a63a.js')),
  popup: () => extractModule(import('./popup-15340141.js')),
  control: () => extractModule(import('./control-8d91cbf7.js')),
  radiogroup: () => extractModule(import('./radiogroup-3d677bb1.js')),
  action: () => extractModule(import('./action-39ec6057.js')),
  label: () => extractModule(import('./label-64d0cb75.js')),
  code: () => extractModule(import('./code-b6068ce7.js')),
  markdown: () => extractModule(import('./markdown-3bbdc593.js')),
  datetime: () => extractModule(import('./datetime-711e66fa.js')),
  number: () => extractModule(import('./number-ce131720.js')),
  slider: () => extractModule(import('./slider-f5345505.js')),
  slider2d: () => extractModule(import('./slider2d-1cf4820f.js')),
  numinput: () => extractModule(import('./numinput-8ed32a20.js')),
  input: () => extractModule(import('./input-82b19d90.js')),
  textarea: () => extractModule(import('./textarea-70d07d32.js')),
  fileinput: () => extractModule(import('./fileinput-f1a72260.js')),
  icon: () => extractModule(import('./icon-23331c30.js')),
  svg: () => extractModule(import('./svg-4c04e53d.js')),
  image: () => extractModule(import('./image-d89b5a71.js')),
  debug: () => extractModule(import('./debug-02f430ee.js')),
  debugger: () => extractModule(import('./debugger-e686ed57.js')),
  form: () => extractModule(import('./form-78706a15.js')),
  validator: () => extractModule(import('./validator-fb3796f4.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-ea3939fb.js')),
  progressbar: () => extractModule(import('./progressbar-6d6a7bf8.js')),
  value: () => extractModule(import('./value-1822a797.js')),
  datepicker: () => extractModule(import('./datepicker-b6895538.js')),
  dateinput: () => extractModule(import('./dateinput-03c6d5c1.js')),
  inputgroup: () => extractModule(import('./inputgroup-22ab1c78.js')),
  menu: () => extractModule(import('./menu-7f7ca755.js')),
  menuitem: () => extractModule(import('./menuitem-d5b2060f.js')),
  offset: () => extractModule(import('./offset-e3738371.js')),
  appear: () => extractModule(import('./appear-7099a0d2.js')),
  hotkey: () => extractModule(import('./hotkey-fb89afe1.js')),
  current: () => extractModule(import('./current-fbfa0562.js')),
};
...
import('./focus-visible-a38f9d0a.js').then(() => {
  // do nothing
});
