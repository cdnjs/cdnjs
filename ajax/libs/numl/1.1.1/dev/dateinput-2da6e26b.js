import { S as SvelteComponent, i as init, s as safe_not_equal, e as element, a as space, b as set_custom_element_data, c as insert, d as append, l as listen, n as noop, f as detach, k as createEventDispatcher } from './index-ed13919c.js';
import { s as startOfDay } from './index-41de65a4.js';

/* src/components/dateinput.svelte generated by Svelte v3.38.2 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			set_custom_element_data(nu_pane, "gap", "");
		...
		m(target, anchor) {
			insert(target, nu_pane, anchor);
			append(nu_pane, nu_value);
			append(nu_pane, t0);
			append(nu_pane, nu_icon);
...
function instance($$self, $$props, $$invalidate) {
	...
	value && startOfDay(Array.isArray(value)
	? value[0]
