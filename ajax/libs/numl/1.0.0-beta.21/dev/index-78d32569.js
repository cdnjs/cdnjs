...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-55def778.js')),
  hover: () => extractModule(import('./hover-fb60ca66.js')),
  listbox: () => extractModule(import('./listbox-94bcb78c.js')),
  option: () => extractModule(import('./option-d5827986.js')),
  active: () => extractModule(import('./active-357e7080.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-f50db4ac.js')),
  popup: () => extractModule(import('./popup-9117124a.js')),
  control: () => extractModule(import('./control-e80515ee.js')),
  radiogroup: () => extractModule(import('./radiogroup-831384a6.js')),
  action: () => extractModule(import('./action-552d7ec7.js')),
  label: () => extractModule(import('./label-275f241e.js')),
  code: () => extractModule(import('./code-9a241e96.js')),
  markdown: () => extractModule(import('./markdown-be9f1269.js')),
  datetime: () => extractModule(import('./datetime-c545e0c8.js')),
  number: () => extractModule(import('./number-223e1d27.js')),
  slider: () => extractModule(import('./slider-e08b6b09.js')),
  numinput: () => extractModule(import('./numinput-d96541a0.js')),
  input: () => extractModule(import('./input-68000ff7.js')),
  textarea: () => extractModule(import('./textarea-2957e318.js')),
  fileinput: () => extractModule(import('./fileinput-26b6f904.js')),
  icon: () => extractModule(import('./icon-a359e2a9.js')),
  svg: () => extractModule(import('./svg-8bae4eef.js')),
  image: () => extractModule(import('./image-2d35a1f2.js')),
  debug: () => extractModule(import('./debug-f437d79f.js')),
  debugger: () => extractModule(import('./debugger-18eb1d4f.js')),
  form: () => extractModule(import('./form-6b29618f.js')),
  validator: () => extractModule(import('./validator-cbae7c00.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-67b06672.js')),
  progressbar: () => extractModule(import('./progressbar-1d65855e.js')),
  value: () => extractModule(import('./value-f73bd522.js')),
  datepicker: () => extractModule(import('./datepicker-919756f5.js')),
  dateinput: () => extractModule(import('./dateinput-839a52c3.js')),
  inputgroup: () => extractModule(import('./inputgroup-e2167c41.js')),
  menu: () => extractModule(import('./menu-cfee7a83.js')),
  menuitem: () => extractModule(import('./menuitem-65534b20.js')),
  offset: () => extractModule(import('./offset-0344fa3c.js')),
  appear: () => extractModule(import('./appear-df015948.js')),
  hotkey: () => extractModule(import('./hotkey-adbe63c5.js')),
  current: () => extractModule(import('./current-860a0323.js')),
};
