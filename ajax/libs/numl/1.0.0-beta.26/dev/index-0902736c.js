...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-d7b63052.js')),
  hover: () => extractModule(import('./hover-c6fdc299.js')),
  listbox: () => extractModule(import('./listbox-0e608d87.js')),
  option: () => extractModule(import('./option-2734ce01.js')),
  active: () => extractModule(import('./active-c037393a.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-a0f2cc15.js')),
  popup: () => extractModule(import('./popup-4597685f.js')),
  control: () => extractModule(import('./control-2a298568.js')),
  radiogroup: () => extractModule(import('./radiogroup-550254f7.js')),
  action: () => extractModule(import('./action-c1abfdd0.js')),
  label: () => extractModule(import('./label-9bf29c70.js')),
  code: () => extractModule(import('./code-13f03b21.js')),
  markdown: () => extractModule(import('./markdown-31a6d0b1.js')),
  datetime: () => extractModule(import('./datetime-de3dc23d.js')),
  number: () => extractModule(import('./number-21d4f592.js')),
  slider: () => extractModule(import('./slider-a925815d.js')),
  numinput: () => extractModule(import('./numinput-fa5240f5.js')),
  input: () => extractModule(import('./input-9c87c2bc.js')),
  textarea: () => extractModule(import('./textarea-ccca344b.js')),
  fileinput: () => extractModule(import('./fileinput-58a0023b.js')),
  icon: () => extractModule(import('./icon-ab21872b.js')),
  svg: () => extractModule(import('./svg-15f0d0f0.js')),
  image: () => extractModule(import('./image-ddac27b0.js')),
  debug: () => extractModule(import('./debug-cecf996a.js')),
  debugger: () => extractModule(import('./debugger-09292ccf.js')),
  form: () => extractModule(import('./form-306102d8.js')),
  validator: () => extractModule(import('./validator-582a51c2.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-93e0a961.js')),
  progressbar: () => extractModule(import('./progressbar-fd45e46a.js')),
  value: () => extractModule(import('./value-d88ac968.js')),
  datepicker: () => extractModule(import('./datepicker-3a70ce52.js')),
  dateinput: () => extractModule(import('./dateinput-620fdc59.js')),
  inputgroup: () => extractModule(import('./inputgroup-a7db8e7c.js')),
  menu: () => extractModule(import('./menu-796ebc6c.js')),
  menuitem: () => extractModule(import('./menuitem-d9eedfc9.js')),
  offset: () => extractModule(import('./offset-70dde6bb.js')),
  appear: () => extractModule(import('./appear-89fb2f4e.js')),
  hotkey: () => extractModule(import('./hotkey-7de6ed14.js')),
  current: () => extractModule(import('./current-7e5b90f8.js')),
};
...
import('./focus-visible-8a5c8c68.js').then(() => {
  // do nothing
});
