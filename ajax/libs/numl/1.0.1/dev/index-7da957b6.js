...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-a6dce26a.js')),
  hover: () => extractModule(import('./hover-67c31009.js')),
  listbox: () => extractModule(import('./listbox-253985d0.js')),
  option: () => extractModule(import('./option-c9755e5d.js')),
  active: () => extractModule(import('./active-a5c54245.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-e56d9d0b.js')),
  popup: () => extractModule(import('./popup-802562d8.js')),
  control: () => extractModule(import('./control-3c96cb98.js')),
  radiogroup: () => extractModule(import('./radiogroup-abee4950.js')),
  action: () => extractModule(import('./action-55354063.js')),
  label: () => extractModule(import('./label-bb607162.js')),
  code: () => extractModule(import('./code-b36afc94.js')),
  markdown: () => extractModule(import('./markdown-d2c64167.js')),
  datetime: () => extractModule(import('./datetime-36d28464.js')),
  number: () => extractModule(import('./number-221985e5.js')),
  slider: () => extractModule(import('./slider-d64b44a1.js')),
  numinput: () => extractModule(import('./numinput-41124016.js')),
  input: () => extractModule(import('./input-d53814af.js')),
  textarea: () => extractModule(import('./textarea-dac03844.js')),
  fileinput: () => extractModule(import('./fileinput-79535aad.js')),
  icon: () => extractModule(import('./icon-8b6f9fce.js')),
  svg: () => extractModule(import('./svg-876fb371.js')),
  image: () => extractModule(import('./image-61b62713.js')),
  debug: () => extractModule(import('./debug-540e8b55.js')),
  debugger: () => extractModule(import('./debugger-7c86fefc.js')),
  form: () => extractModule(import('./form-248b098f.js')),
  validator: () => extractModule(import('./validator-def4e359.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-88b48ef9.js')),
  progressbar: () => extractModule(import('./progressbar-3836229d.js')),
  value: () => extractModule(import('./value-7b9bdd75.js')),
  datepicker: () => extractModule(import('./datepicker-1f3ae759.js')),
  dateinput: () => extractModule(import('./dateinput-3403efb6.js')),
  inputgroup: () => extractModule(import('./inputgroup-555f9941.js')),
  menu: () => extractModule(import('./menu-0db21527.js')),
  menuitem: () => extractModule(import('./menuitem-4e6225f3.js')),
  offset: () => extractModule(import('./offset-4da95dfd.js')),
  appear: () => extractModule(import('./appear-c53c64bb.js')),
  hotkey: () => extractModule(import('./hotkey-6e10835f.js')),
  current: () => extractModule(import('./current-d381be88.js')),
};
...
import('./focus-visible-56d659e8.js').then(() => {
  // do nothing
});
...
export { define as $, ALIAS_ATTR as A, Behavior as B, svgElement as C, error as D, extractModule as E, toCamelCase as F, hideEffect as G, isTouch as H, ICONS_PROVIDER as I, setTransitionTimeout as J, isValidDate as K, Nude as L, NuAbstract as M, NUMBER_TYPE as N, NuAction as O, elements as P, scheme as Q, ROOT as R, Svg as S, contrast as T, reduceMotion as U, CONTEXT as V, WidgetBehavior as W, behaviors as X, requestIdleCallback as Y, helpers as Z, styles as _, scrollParentToChild as a, assign as a0, units as a1, hue as a2, themes as a3, color as a4, FLEX_GAP_SUPPORTED as a5, STATES_MAP as a6, CUSTOM_UNITS as a7, ROOT_CONTEXT as a8, BOOL_TYPE as b, deepQuery as c, deepQueryAll as d, isFocusable as e, fixPosition as f, asyncDebounce as g, h$1 as h, isEqual as i, Routing as j, generateId as k, log as l, query as m, removeInnerRef as n, setInnerRef as o, setAriaRef as p, queryById as q, resetScroll as r, setAttr as s, devMode as t, isNoValue as u, getFloatFromAttr as v, warn$1 as w, fixture as x, parseAllValues as y, Icons as z };
