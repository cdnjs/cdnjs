import { R as ROOT } from './index-b33ae2bb.js';

/**
 * Ported version of https://github.com/WICG/focus-visible/blob/main/src/focus-visible.js
 */
...
function applyFocusVisiblePolyfill(scope) {
   ...
   * @param {Element} el
   */
  function addFocusVisibleMod(el) {
  ...
  function onBlur(e) {
    if (
      ...
      removeFocusVisibleMod(e.target);
    }
  }
  ...
  if (scope.nodeType === Node.DOCUMENT_FRAGMENT_NODE && scope.host) {
    ...
    scope.host.setAttribute('is-focus-visible', '');
  } else if (scope.nodeType === Node.DOCUMENT_NODE) {
    document.documentElement.setAttribute('data-nu-focus-visible', '');
  }
}
