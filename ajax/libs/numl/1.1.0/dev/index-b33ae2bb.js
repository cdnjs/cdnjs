...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-4870a8fd.js')),
  hover: () => extractModule(import('./hover-636b27be.js')),
  listbox: () => extractModule(import('./listbox-f5a08956.js')),
  option: () => extractModule(import('./option-d3a5bfe7.js')),
  active: () => extractModule(import('./active-60f3a112.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-72e7c0ab.js')),
  popup: () => extractModule(import('./popup-671c3696.js')),
  control: () => extractModule(import('./control-e1eae8fa.js')),
  radiogroup: () => extractModule(import('./radiogroup-f61b9263.js')),
  action: () => extractModule(import('./action-54b1fd57.js')),
  label: () => extractModule(import('./label-47a7f27a.js')),
  code: () => extractModule(import('./code-2532800a.js')),
  markdown: () => extractModule(import('./markdown-d91845e8.js')),
  datetime: () => extractModule(import('./datetime-4bf8b87a.js')),
  number: () => extractModule(import('./number-de2d04fc.js')),
  slider: () => extractModule(import('./slider-fa0557e3.js')),
  slider2d: () => extractModule(import('./slider2d-ed8d85a9.js')),
  numinput: () => extractModule(import('./numinput-eefa2c2c.js')),
  input: () => extractModule(import('./input-cf822507.js')),
  textarea: () => extractModule(import('./textarea-84bec4cb.js')),
  fileinput: () => extractModule(import('./fileinput-eebe7744.js')),
  icon: () => extractModule(import('./icon-31c77107.js')),
  svg: () => extractModule(import('./svg-6ddf5817.js')),
  image: () => extractModule(import('./image-91c7e2d2.js')),
  debug: () => extractModule(import('./debug-34698692.js')),
  debugger: () => extractModule(import('./debugger-aac7b54b.js')),
  form: () => extractModule(import('./form-c0087a53.js')),
  validator: () => extractModule(import('./validator-8ff308de.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-24f40d16.js')),
  progressbar: () => extractModule(import('./progressbar-4b85175c.js')),
  value: () => extractModule(import('./value-7ffa515e.js')),
  datepicker: () => extractModule(import('./datepicker-d494f8e6.js')),
  dateinput: () => extractModule(import('./dateinput-e2f05fcb.js')),
  inputgroup: () => extractModule(import('./inputgroup-293ccb32.js')),
  menu: () => extractModule(import('./menu-1deff251.js')),
  menuitem: () => extractModule(import('./menuitem-a2a7da13.js')),
  offset: () => extractModule(import('./offset-25709fea.js')),
  appear: () => extractModule(import('./appear-a3d9d401.js')),
  hotkey: () => extractModule(import('./hotkey-68074c6d.js')),
  current: () => extractModule(import('./current-d90b4816.js')),
};
...
import('./focus-visible-3d89eb46.js').then(() => {
  // do nothing
});
