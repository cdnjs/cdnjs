...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-4a4a6c9b.js')),
  hover: () => extractModule(import('./hover-b7b327b9.js')),
  listbox: () => extractModule(import('./listbox-f6d4285f.js')),
  option: () => extractModule(import('./option-a9715cdd.js')),
  active: () => extractModule(import('./active-05c829d2.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-2aa24952.js')),
  popup: () => extractModule(import('./popup-79d07a00.js')),
  control: () => extractModule(import('./control-47493043.js')),
  radiogroup: () => extractModule(import('./radiogroup-4339bf83.js')),
  action: () => extractModule(import('./action-ed6db214.js')),
  label: () => extractModule(import('./label-d13f98dd.js')),
  code: () => extractModule(import('./code-ef7c2a8c.js')),
  markdown: () => extractModule(import('./markdown-3353e227.js')),
  datetime: () => extractModule(import('./datetime-cc8ac553.js')),
  number: () => extractModule(import('./number-e836faa8.js')),
  slider: () => extractModule(import('./slider-fd9410f6.js')),
  numinput: () => extractModule(import('./numinput-c6a07d65.js')),
  input: () => extractModule(import('./input-0d31d297.js')),
  textarea: () => extractModule(import('./textarea-7f53c43a.js')),
  fileinput: () => extractModule(import('./fileinput-15feb9cb.js')),
  icon: () => extractModule(import('./icon-96b0169a.js')),
  svg: () => extractModule(import('./svg-aef7cc88.js')),
  image: () => extractModule(import('./image-3c7b40a4.js')),
  debug: () => extractModule(import('./debug-33d939c2.js')),
  debugger: () => extractModule(import('./debugger-37c0af6a.js')),
  form: () => extractModule(import('./form-1f7eb6c8.js')),
  validator: () => extractModule(import('./validator-2aa17e5f.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-bcc89a94.js')),
  progressbar: () => extractModule(import('./progressbar-d1f16aa7.js')),
  value: () => extractModule(import('./value-b6b20853.js')),
  datepicker: () => extractModule(import('./datepicker-4f4996b8.js')),
  dateinput: () => extractModule(import('./dateinput-1e29401c.js')),
  inputgroup: () => extractModule(import('./inputgroup-33170f45.js')),
  menu: () => extractModule(import('./menu-39aa2b5d.js')),
  menuitem: () => extractModule(import('./menuitem-7652a66b.js')),
  offset: () => extractModule(import('./offset-86cb0341.js')),
  appear: () => extractModule(import('./appear-d32a3542.js')),
  hotkey: () => extractModule(import('./hotkey-42e5e889.js')),
  current: () => extractModule(import('./current-b48e8f7e.js')),
};
...
transitionAttr('opacity, height').transition;
const EFFECTS = {
  collapse: {
    visible(el) {
