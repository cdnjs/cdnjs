...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-e16262d6.js')),
  hover: () => extractModule(import('./hover-0ddd8ef4.js')),
  listbox: () => extractModule(import('./listbox-78f3ee2b.js')),
  option: () => extractModule(import('./option-b7d475e0.js')),
  active: () => extractModule(import('./active-04def101.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-2b42de6c.js')),
  popup: () => extractModule(import('./popup-f1595aef.js')),
  control: () => extractModule(import('./control-624bb4bf.js')),
  radiogroup: () => extractModule(import('./radiogroup-c8bd109b.js')),
  action: () => extractModule(import('./action-703f5536.js')),
  label: () => extractModule(import('./label-94d7bcfc.js')),
  code: () => extractModule(import('./code-a6f9b710.js')),
  markdown: () => extractModule(import('./markdown-15d63cd2.js')),
  datetime: () => extractModule(import('./datetime-72c8fcb2.js')),
  number: () => extractModule(import('./number-9c870c16.js')),
  slider: () => extractModule(import('./slider-8e84a4a1.js')),
  numinput: () => extractModule(import('./numinput-9c31e2e3.js')),
  input: () => extractModule(import('./input-2dd7010b.js')),
  textarea: () => extractModule(import('./textarea-c3ec365f.js')),
  fileinput: () => extractModule(import('./fileinput-d7ebdf84.js')),
  icon: () => extractModule(import('./icon-0af52806.js')),
  svg: () => extractModule(import('./svg-afb7fba9.js')),
  image: () => extractModule(import('./image-1b7a1fb0.js')),
  debug: () => extractModule(import('./debug-13afcb78.js')),
  debugger: () => extractModule(import('./debugger-fb75e446.js')),
  form: () => extractModule(import('./form-598f780f.js')),
  validator: () => extractModule(import('./validator-cd2f7d7b.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-4a9d9a2e.js')),
  progressbar: () => extractModule(import('./progressbar-e39bfeca.js')),
  value: () => extractModule(import('./value-ad3d779d.js')),
  datepicker: () => extractModule(import('./datepicker-f5294a7b.js')),
  dateinput: () => extractModule(import('./dateinput-f69efddb.js')),
  inputgroup: () => extractModule(import('./inputgroup-4efde914.js')),
  menu: () => extractModule(import('./menu-20b2bc81.js')),
  menuitem: () => extractModule(import('./menuitem-f44bdea0.js')),
  offset: () => extractModule(import('./offset-649ab90c.js')),
  appear: () => extractModule(import('./appear-8a957029.js')),
  hotkey: () => extractModule(import('./hotkey-befbda1a.js')),
  current: () => extractModule(import('./current-352c312f.js')),
};
