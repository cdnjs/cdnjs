...
const BEHAVIORS = {
  focus: () => extractModule(import('./focus-5a043eb7.js')),
  hover: () => extractModule(import('./hover-772dc9ce.js')),
  listbox: () => extractModule(import('./listbox-d334af9e.js')),
  option: () => extractModule(import('./option-da1e9f40.js')),
  active: () => extractModule(import('./active-507584e2.js')),
  fixate: () => extractModule(Promise.resolve().then(function () { return fixate; })),
  orient: () => extractModule(import('./orient-2a4a1159.js')),
  popup: () => extractModule(import('./popup-ac0a4288.js')),
  control: () => extractModule(import('./control-1c611388.js')),
  radiogroup: () => extractModule(import('./radiogroup-595625e9.js')),
  action: () => extractModule(import('./action-2acb2c66.js')),
  label: () => extractModule(import('./label-e8b09427.js')),
  code: () => extractModule(import('./code-cc696ceb.js')),
  markdown: () => extractModule(import('./markdown-3eb18fbd.js')),
  datetime: () => extractModule(import('./datetime-fbfbe710.js')),
  number: () => extractModule(import('./number-c9b0ad00.js')),
  slider: () => extractModule(import('./slider-5dab7237.js')),
  numinput: () => extractModule(import('./numinput-d959f952.js')),
  input: () => extractModule(import('./input-e16f7aac.js')),
  textarea: () => extractModule(import('./textarea-446c3f5d.js')),
  fileinput: () => extractModule(import('./fileinput-62548326.js')),
  icon: () => extractModule(import('./icon-516cb377.js')),
  svg: () => extractModule(import('./svg-386e1973.js')),
  image: () => extractModule(import('./image-0fd8af03.js')),
  debug: () => extractModule(import('./debug-0d80ddb3.js')),
  debugger: () => extractModule(import('./debugger-f9ca2b28.js')),
  form: () => extractModule(import('./form-87899b3e.js')),
  validator: () => extractModule(import('./validator-ec407505.js')),
  group: () => Promise.resolve(GroupBehavior),
  tooltip: () => extractModule(import('./tooltip-a06dc2a8.js')),
  progressbar: () => extractModule(import('./progressbar-5eb34365.js')),
  value: () => extractModule(import('./value-59c16cc4.js')),
  datepicker: () => extractModule(import('./datepicker-c9a3b2a0.js')),
  dateinput: () => extractModule(import('./dateinput-7a2ae077.js')),
  inputgroup: () => extractModule(import('./inputgroup-f468829b.js')),
  menu: () => extractModule(import('./menu-0844e0fd.js')),
  menuitem: () => extractModule(import('./menuitem-b8ea299e.js')),
  offset: () => extractModule(import('./offset-b0534e25.js')),
  appear: () => extractModule(import('./appear-25cd7707.js')),
  hotkey: () => extractModule(import('./hotkey-f679744a.js')),
  current: () => extractModule(import('./current-1b0552cb.js')),
};
