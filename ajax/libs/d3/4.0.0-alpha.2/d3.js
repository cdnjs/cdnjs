(function (global, factory) {
	...
	function area() {
	  ...
	  area.curve = function(_) {
	    return arguments.length ? (curve = bind$2(_, arguments), context != null && (output = curve(context)), area) : curve;
	  };
	...
	function line() {
	  ...
	  line.curve = function(_) {
	    return arguments.length ? (curve = bind$2(_, arguments), context != null && (output = curve(context)), line) : curve;
	  };
	...
	function continuous(deinterpolate, reinterpolate) {
	  ...
	  scale.rangeRound = function(_) {
	    return range = slice$3.call(_), interpolate = round, rescale();
	  };
	  ...
	  scale.interpolate = function(_) {
	    return arguments.length ? (interpolate = bind$1.apply(null, arguments), rescale()) : interpolate;
	  };
	...
	function time() {
	  return calendar(year, month, sunday, day, hour, minute, second, millisecond, format$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
	};
