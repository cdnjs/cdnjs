(function (global, factory) {
	...
	color$1.prototype = Color$1.prototype = {
	  displayable: function() {
	    return this.rgb().displayable();
	  },
	  toString: function() {
	...
	function color$1(format) {
	  var m;
	  format = (format + "").trim().toLowerCase();
	  return (m = reHex3$1.exec(format)) ? (m = parseInt(m[1], 16), new Rgb$1((m >> 8 & 0xf) | (m >> 4 & 0x0f0), (m >> 4 & 0xf) | (m & 0xf0), ((m & 0xf) << 4) | (m & 0xf))) // #f00
	      : (m = reHex6$1.exec(format)) ? rgbn$1(parseInt(m[1], 16)) // #ff0000
	      : (m = reRgbInteger$1.exec(format)) ? new Rgb$1(m[1], m[2], m[3]) // rgb(255,0,0)
	      : (m = reRgbPercent$1.exec(format)) ? new Rgb$1(m[1] * 255 / 100, m[2] * 255 / 100, m[3] * 255 / 100) // rgb(100%,0%,0%)
	      : (m = reHslPercent$1.exec(format)) ? new Hsl$1(m[1], m[2] / 100, m[3] / 100) // hsl(120,50%,50%)
	      : named$1.hasOwnProperty(format) ? rgbn$1(named$1[format])
	      : null;
	}

	function rgbn$1(n) {
	  return new Rgb$1(n >> 16 & 0xff, n >> 8 & 0xff, n & 0xff);
	}

	function rgb$2(r, g, b) {
	  if (arguments.length === 1) {
	    if (!(r instanceof Color$1)) r = color$1(r);
	    if (r) {
	      r = r.rgb();
	      b = r.b;
	      g = r.g;
	...
	var _rgb$1 = rgb$2.prototype = Rgb$1.prototype = new Color$1;

	_rgb$1.brighter = function(k) {
	  k = k == null ? brighter$1 : Math.pow(brighter$1, k);
	  return new Rgb$1(this.r * k, this.g * k, this.b * k);
	};

	_rgb$1.darker = function(k) {
	...
	_rgb$1.displayable = function() {
	  return (0 <= this.r && this.r <= 255)
	      && (0 <= this.g && this.g <= 255)
	      && (0 <= this.b && this.b <= 255);
	};

	_rgb$1.toString = function() {
	...
	function hsl$1(h, s, l) {
	  if (arguments.length === 1) {
	    if (h instanceof Hsl$1) {
	      l = h.l;
	      s = h.s;
	      h = h.h;
	    } else {
	      if (!(h instanceof Color$1)) h = color$1(h);
	      if (h) {
	        if (h instanceof Hsl$1) return h;
	        h = h.rgb();
	        var r = h.r / 255,
	            g = h.g / 255,
	            b = h.b / 255,
	...
	var _hsl$1 = hsl$1.prototype = Hsl$1.prototype = new Color$1;

	_hsl$1.brighter = function(k) {
	  k = k == null ? brighter$1 : Math.pow(brighter$1, k);
	  return new Hsl$1(this.h, this.s, this.l * k);
	};

	_hsl$1.darker = function(k) {
	  k = k == null ? darker$1 : Math.pow(darker$1, k);
	  return new Hsl$1(this.h, this.s, this.l * k);
	};
	...
	function lab$1(l, a, b) {
	  if (arguments.length === 1) {
	    if (l instanceof Lab$1) {
	      b = l.b;
	      a = l.a;
	      l = l.l;
	    } else if (l instanceof Hcl$1) {
	      var h = l.h * deg2rad$1;
	      b = Math.sin(h) * l.c;
	      a = Math.cos(h) * l.c;
	      l = l.l;
	    } else {
	      if (!(l instanceof Rgb$1)) l = rgb$2(l);
	      b = rgb2xyz$1(l.r);
	      a = rgb2xyz$1(l.g);
	      l = rgb2xyz$1(l.b);
	      var x = xyz2lab$1((0.4124564 * b + 0.3575761 * a + 0.1804375 * l) / Xn$1),
	...
	var _lab$1 = lab$1.prototype = Lab$1.prototype = new Color$1;

	_lab$1.brighter = function(k) {
	  return new Lab$1(this.l + Kn$1 * (k == null ? 1 : k), this.a, this.b);
	};

	_lab$1.darker = function(k) {
	  return new Lab$1(this.l - Kn$1 * (k == null ? 1 : k), this.a, this.b);
	};
	...
	function hcl$1(h, c, l) {
	  if (arguments.length === 1) {
	    if (h instanceof Hcl$1) {
	      l = h.l;
	      c = h.c;
	      h = h.h;
	    } else {
	      if (!(h instanceof Lab$1)) h = lab$1(h);
	      l = h.l;
	      c = Math.sqrt(h.a * h.a + h.b * h.b);
	      h = Math.atan2(h.b, h.a) * rad2deg$2;
	      if (h < 0) h += 360;
	    }
	  }
	  return new Hcl$1(h, c, l);
	}
	...
	var _hcl$1 = hcl$1.prototype = Hcl$1.prototype = new Color$1;

	_hcl$1.brighter = function(k) {
	  return new Hcl$1(this.h, this.c, this.l + Kn$1 * (k == null ? 1 : k));
	};

	_hcl$1.darker = function(k) {
	  return new Hcl$1(this.h, this.c, this.l - Kn$1 * (k == null ? 1 : k));
	};
	...
	function cubehelix$3(h, s, l) {
	  if (arguments.length === 1) {
	    if (h instanceof Cubehelix$1) {
	      l = h.l;
	      s = h.s;
	      h = h.h;
	    } else {
	      if (!(h instanceof Rgb$1)) h = rgb$2(h);
	      var r = h.r / 255, g = h.g / 255, b = h.b / 255;
	      l = (BC_DA$1 * b + ED$1 * r - EB$1 * g) / (BC_DA$1 + ED$1 - EB$1);
	      var bl = b - l, k = (E$1 * (g - l) - C$1 * bl) / D$1;
	      s = Math.sqrt(k * k + bl * bl) / (E$1 * l * (1 - l)); // NaN if l=0 or l=1
	      h = s ? Math.atan2(k, bl) * rad2deg$2 - 120 : NaN;
	      if (h < 0) h += 360;
	    }
	  }
	  return new Cubehelix$1(h, s, l);
	}
	...
	var _cubehelix$1 = cubehelix$3.prototype = Cubehelix$1.prototype = new Color$1;

	_cubehelix$1.brighter = function(k) {
	  k = k == null ? brighter$1 : Math.pow(brighter$1, k);
	  return new Cubehelix$1(this.h, this.s, this.l * k);
	};

	_cubehelix$1.darker = function(k) {
	  k = k == null ? darker$1 : Math.pow(darker$1, k);
	  return new Cubehelix$1(this.h, this.s, this.l * k);
	};

	_cubehelix$1.rgb = function() {
	...
	function cubehelix$2() {
	  return linear()
	      ...
	      .range([cubehelix$3(300, 0.5, 0.0), cubehelix$3(-240, 0.5, 1.0)]);
	}
	...
	var a = cubehelix$3(-100, 0.75, 0.35);
	var b = cubehelix$3(80, 1.50, 0.8);
	var c = cubehelix$3(260, 0.75, 0.35);
	var d = cubehelix$3();
	...
	function selection_on(type, listener, capture) {
	  ...
	  return this.each(listener
	      ? (value ? onAdd(filter, key, name, listener, capture == null ? false : capture) : noop$2) // Attempt to add untyped listener is ignored.
