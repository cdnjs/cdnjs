(function (global, factory) {
	...
	function continuous(deinterpolate, reinterpolate) {
	  ...
	  scale.rangeRound = function(_) {
	    return range = slice$4.call(_), interpolate = round, rescale();
	  };
	...
	var a$1 = cubehelix(-100, 0.75, 0.35);
	var b = cubehelix(80, 1.50, 0.8);
	var c$1 = cubehelix(260, 0.75, 0.35);
	var d = cubehelix();
	var interpolateWarm = cubehelixLong(a$1, b);
	var interpolateCool = cubehelixLong(c$1, b);
