...
var DataStream = /*#__PURE__*/function () {
  ...
  createClass(DataStream, [{
    key: (_pairs = new weakMap$2(), iterator$2),
    ...
    value: function filter(callback) {
      ...
      return new DataStream(defineProperty$8({}, iterator$2, /*#__PURE__*/regenerator.mark(function _callee() {
    ...
    value: function map(callback) {
      ...
      return new DataStream(defineProperty$8({}, iterator$2, /*#__PURE__*/regenerator.mark(function _callee2() {
    ...
    value: function sort(callback) {
      ...
      return new DataStream(defineProperty$8({}, iterator$2, function () {
        var _context9;
...
var DataSet = /*#__PURE__*/function (_DataSetPart) {
  ...
  createClass(DataSet, [{
    ...
    value: function max(field) {
      ...
      var _iterator = _createForOfIteratorHelper$2(values$2(_context5 = __classPrivateFieldGet(this, _data)).call(_context5)),
          _step;
    ...
    value: function min(field) {
      ...
      var _iterator2 = _createForOfIteratorHelper$2(values$2(_context6 = __classPrivateFieldGet(this, _data)).call(_context6)),
          _step2;
    ...
    value: function stream(ids) {
      if (ids) {
        ...
        return new DataStream(defineProperty$8({}, iterator$2, bind$2(_context8 = entries$2(__classPrivateFieldGet(this, _data))).call(_context8, __classPrivateFieldGet(this, _data))));
      }
    }
    /* develblock:start */
...
function _createForOfIteratorHelper$3(o, allowArrayLike) { var it; if (typeof symbol$2 === "undefined" || getIteratorMethod$1(o) == null) { if (isArray$5(o) || (it = _unsupportedIterableToArray$4(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = getIterator$1(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function _unsupportedIterableToArray$4(o, minLen) { var _context5; if (!o) return; if (typeof o === "string") return _arrayLikeToArray$4(o, minLen); var n = slice$3(_context5 = Object.prototype.toString.call(o)).call(_context5, 8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return from_1$2(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray$4(o, minLen); }
...
var DataView = /*#__PURE__*/function (_DataSetPart) {
  ...
  createClass(DataView, [{
    ...
    value: function stream(ids) {
      ...
      return __classPrivateFieldGet(this, _data$1).stream(ids || defineProperty$8({}, iterator$2, bind$2(_context4 = keys$6(__classPrivateFieldGet(this, _ids))).call(_context4, __classPrivateFieldGet(this, _ids))));
    }
    /**
