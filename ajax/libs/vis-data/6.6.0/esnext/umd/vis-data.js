...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('uuid'), require('vis-util/esnext/umd/vis-util.js'), require('moment')) :
  typeof define === 'function' && define.amd ? define(['exports', 'uuid', 'vis-util/esnext/umd/vis-util.js', 'moment'], factory) :
  (global = global || self, factory(global.vis = global.vis || {}, global.uuidv4, global.vis, global.moment));
}(this, (function (exports, uuid, esnext, moment) {
  ...
  function convert(object, type) {
      ...
      switch (type) {
          ...
          case "number":
          case "Number":
              if (esnext.isString(object) && !isNaN(Date.parse(object))) {
          ...
          case "Date":
              ...
              if (esnext.isString(object)) {
                  ...
                  throw new Error("Cannot convert object of type " + esnext.getType(object) + " to type Date");
              }
          case "Moment":
              if (esnext.isNumber(object)) {
          ...
          case "ISODate":
              ...
              else if (esnext.isString(object)) {
                  match = ASPDateRegex.exec(object);
                  if (match) {
                      // object is an ASP date
