...
var getBuiltIn$8 = function (namespace, method) {
  return arguments.length < 2 ? aFunction$7(path$o[namespace]) || aFunction$7(global$g[namespace]) : path$o[namespace] && path$o[namespace][method] || global$g[namespace] && global$g[namespace][method];
};
...
var _export = function (options, source) {
  ...
  var target = GLOBAL ? path$n : path$n[TARGET] || (path$n[TARGET] = {});
  ...
  for (key in source) {
    ...
    if (options.bind && USE_NATIVE) resultProperty = bind$b(sourceProperty, global$a); // wrap global constructors for prevent changs in this version
    ...
    if (PROTO) {
      ...
      if (!has$8(path$n, VIRTUAL_PROTOTYPE)) {
        createNonEnumerableProperty$8(path$n, VIRTUAL_PROTOTYPE, {});
      } // export virtual prototype methods


      path$n[VIRTUAL_PROTOTYPE][key] = sourceProperty; // export real prototype methods
...
var parent$K = defineProperty$b.exports;
var defineProperty$9 = parent$K;

var parent$J = defineProperty$9;
var defineProperty$8 = parent$J;
...
var toLength$b = toLength$c; // `Array.prototype.{ reduce, reduceRight }` methods implementation
...
var engineIsNode = classof$a(global$9.process) == 'process';
...
var reduce_1 = function (it) {
  var own = it.reduce;
  return it === ArrayPrototype$e || it instanceof Array && own === ArrayPrototype$e.reduce ? reduce$2 : own;
};

var parent$H = reduce_1;
var reduce$1 = parent$H;
...
var arraySpeciesConstructor$1 = function (originalArray) {
  ...
  if (isArray$b(originalArray)) {
    ...
    if (typeof C == 'function' && (C === Array || isArray$b(C.prototype))) C = undefined;else if (isObject$9(C)) {
      C = C[SPECIES$3];
...
var createMethod$4 = function (TYPE) {
  ...
  return function ($this, callbackfn, that, specificCreate) {
    ...
    var length = toLength$a(self.length);
    var index = 0;
...
var filter_1 = function (it) {
  var own = it.filter;
  return it === ArrayPrototype$d || it instanceof Array && own === ArrayPrototype$d.filter ? filter$2 : own;
};

var parent$G = filter_1;
...
var map_1 = function (it) {
  var own = it.map;
  return it === ArrayPrototype$c || it instanceof Array && own === ArrayPrototype$c.map ? map$5 : own;
};
...
var bind$4 = functionBindContext; // `FlattenIntoArray` abstract operation
// https://tc39.github.io/proposal-flatMap/#sec-FlattenIntoArray

var flattenIntoArray$1 = function (target, original, source, sourceLen, start, depth, mapper, thisArg) {
  var targetIndex = start;
  var sourceIndex = 0;
  var mapFn = mapper ? bind$4(mapper, thisArg, 3) : false;
  var element;
  ...
  while (sourceIndex < sourceLen) {
    if (sourceIndex in source) {
      ...
      if (depth > 0 && isArray$a(element)) {
        targetIndex = flattenIntoArray$1(target, original, element, toLength$9(element.length), targetIndex, depth - 1) - 1;
      } else {
...
var flatMap_1 = function (it) {
  var own = it.flatMap;
  return it === ArrayPrototype$b || it instanceof Array && own === ArrayPrototype$b.flatMap ? flatMap$2 : own;
};

var parent$E = flatMap_1;
var flatMap$1 = parent$E;
...
var enforce = function (it) {
  return has$7(it) ? get(it) : set$3(it, {});
};
...
var classof$7 = classof$8; // `Object.prototype.toString` method implementation
...
var setToStringTag$5 = function (it, TAG, STATIC, SET_METHOD) {
  if (it) {
    ...
    if (SET_METHOD && !TO_STRING_TAG_SUPPORT) {
      createNonEnumerableProperty$5(target, 'toString', toString$6);
    }
  }
};
...
var getIteratorMethod$7 = function (it) {
  if (it != undefined) return it[ITERATOR$1] || it['@@iterator'] || Iterators$2[classof$6(it)];
};
...
/* , mapfn = undefined, thisArg = undefined */
  ...
  if (mapping) mapfn = bind$3(mapfn, argumentsLength > 2 ? arguments[2] : undefined, 2); // if the target is not iterable or it's an array with the default iterator - use a simple case
...
objectGetOwnPropertyNamesExternal.f = function getOwnPropertyNames(it) {
  return windowNames && toString$4.call(it) == '[object Window]' ? getWindowNames(it) : $getOwnPropertyNames$1(toIndexedObject$5(it));
};
...
var setSymbolDescriptor = DESCRIPTORS$9 && fails$b(function () {
...
var path$i = path$p;
var getOwnPropertySymbols$2 = path$i.Object.getOwnPropertySymbols;
...
var FORCED$5 = !DESCRIPTORS$8 || FAILS_ON_PRIMITIVES$2; // `Object.getOwnPropertyDescriptor` method
// https://tc39.es/ecma262/#sec-object.getownpropertydescriptor
...
var parent$z = getOwnPropertyDescriptor$3.exports;
var getOwnPropertyDescriptor$1 = parent$z;
...
var path$g = path$p;
var getOwnPropertyDescriptors$2 = path$g.Object.getOwnPropertyDescriptors;

var parent$y = getOwnPropertyDescriptors$2;
var getOwnPropertyDescriptors$1 = parent$y;
...
var parent$x = defineProperties$4.exports;
var defineProperties$1 = parent$x;
...
var path$e = path$p;
var isArray$7 = path$e.Array.isArray;
...
var parent$u = symbol$4;
var symbol$3 = parent$u;
...
var parent$t = symbol$3; // TODO: Remove from `core-js@4`
...
var parent$n = concat_1;
var concat$1 = parent$n;
...
var path$c = path$p;
var ownKeys$3 = path$c.Reflect.ownKeys;

var parent$m = ownKeys$3;
var ownKeys$2 = parent$m;
...
var forEach_1 = function (it) {
  ...
  || DOMIterables$3.hasOwnProperty(classof$4(it)) ? forEach$2 : own;
};
...
var reverse_1 = function (it) {
  var own = it.reverse;
  return it === ArrayPrototype$6 || it instanceof Array && own === ArrayPrototype$6.reverse ? reverse$2 : own;
};

var parent$j = reverse_1;
...
var splice_1 = function (it) {
  var own = it.splice;
  return it === ArrayPrototype$5 || it instanceof Array && own === ArrayPrototype$5.splice ? splice$2 : own;
};

var parent$i = splice_1;
var splice$1 = parent$i;
...
var path$9 = path$p;
var assign$4 = path$9.Object.assign;

var parent$h = assign$4;
var assign$3 = parent$h;
...
$$f({
  ...
  /* , position = 0 */
    ...
    return !!~toString$3(requireObjectCoercible$1(this)).indexOf(toString$3(notARegExp(searchString)), arguments.length > 1 ? arguments[1] : undefined);
  }
});
...
var path$8 = path$p;
var getPrototypeOf$3 = path$8.Object.getPrototypeOf;

var parent$g = getPrototypeOf$3;
var getPrototypeOf$2 = parent$g;
...
var hex = /^[+-]?0[Xx]/;
var FORCED$3 = $parseInt(whitespaces$1 + '08') !== 8 || $parseInt(whitespaces$1 + '0x16') !== 22; // `parseInt` method
...
var core = path$p; // eslint-disable-next-line es/no-json -- safe
...
var parent$e = stringify$3;
var stringify$2 = parent$e;
...
var toLength$2 = toLength$c; // `Array.prototype.fill` method implementation
...
function _createForOfIteratorHelper$3(o, allowArrayLike) { var it = typeof symbol !== "undefined" && getIteratorMethod$2(o) || o["@@iterator"]; if (!it) { if (isArray$1(o) || (it = _unsupportedIterableToArray$3(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function _unsupportedIterableToArray$3(o, minLen) { var _context21; if (!o) return; if (typeof o === "string") return _arrayLikeToArray$3(o, minLen); var n = slice$1(_context21 = Object.prototype.toString.call(o)).call(_context21, 8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return from$2(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray$3(o, minLen); }
...
var collection$2 = function (CONSTRUCTOR_NAME, wrapper, common) {
  ...
  if (!DESCRIPTORS$2 || typeof NativeConstructor != 'function' || !(IS_WEAK || NativePrototype.forEach && !fails$1(function () {
...
var some_1 = function (it) {
  var own = it.some;
  return it === ArrayPrototype$4 || it instanceof Array && own === ArrayPrototype$4.some ? some$2 : own;
};
...
var parent$3 = entries$3;
var entries$2 = parent$3;
...
var DataSetPart = /*#__PURE__*/function () {
  ...
  _createClass(DataSetPart, [{
    ...
    value: function _trigger(event, payload, senderId) {
      ...
      forEach$1(_context = concat(_context2 = []).call(_context2, _toConsumableArray(this._subscribers[event]), _toConsumableArray(this._subscribers["*"]))).call(_context, function (subscriber) {
...
function _createForOfIteratorHelper$2(o, allowArrayLike) { var it = typeof symbol !== "undefined" && getIteratorMethod$2(o) || o["@@iterator"]; if (!it) { if (isArray$1(o) || (it = _unsupportedIterableToArray$2(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function _unsupportedIterableToArray$2(o, minLen) { var _context10; if (!o) return; if (typeof o === "string") return _arrayLikeToArray$2(o, minLen); var n = slice$1(_context10 = Object.prototype.toString.call(o)).call(_context10, 8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return from$2(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray$2(o, minLen); }
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context10; forEach$1(_context10 = ownKeys(Object(source), true)).call(_context10, function (key) { _defineProperty(target, key, source[key]); }); } else if (getOwnPropertyDescriptors) { defineProperties(target, getOwnPropertyDescriptors(source)); } else { var _context11; forEach$1(_context11 = ownKeys(Object(source))).call(_context11, function (key) { defineProperty$4(target, key, getOwnPropertyDescriptor(source, key)); }); } } return target; }

function _createForOfIteratorHelper$1(o, allowArrayLike) { var it = typeof symbol !== "undefined" && getIteratorMethod$2(o) || o["@@iterator"]; if (!it) { if (isArray$1(o) || (it = _unsupportedIterableToArray$1(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof symbol !== "undefined" && getIteratorMethod$2(o) || o["@@iterator"]; if (!it) { if (isArray$1(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function _unsupportedIterableToArray(o, minLen) { var _context5; if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = slice$1(_context5 = Object.prototype.toString.call(o)).call(_context5, 8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return from$2(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
...
export { DELETE, DataSet, DataStream, DataView, Queue, createNewDataPipeFrom, isDataSetLike, isDataViewLike };
