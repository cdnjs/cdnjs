...
var fmt = _ember2['default'].String.fmt;
...
exports['default'] = {
  ...
  initialize: function initialize(container, app) {
    app.register('adapter:-firebase', _adaptersFirebase2['default']);
    app.register('serializer:-firebase', _serializersFirebase2['default']);
