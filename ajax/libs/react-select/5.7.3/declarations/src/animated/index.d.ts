...
declare const _default: import("memoize-one").MemoizedFn<(externalComponents?: Partial<{
    ...
    NoOptionsMessage: {
        <Option_13, IsMulti_13 extends boolean, Group_13 extends import("..").GroupBase<Option_13>>(props: import("..").NoticeProps<Option_13, IsMulti_13, Group_13>): import("@emotion/react").jsx.JSX.Element;
        defaultProps: {
            children: string;
        };
    };
