...
var _extends = require("@babel/runtime/helpers/extends"), index = require("./index-db3bdb30.cjs.prod.js"), _classCallCheck = require("@babel/runtime/helpers/classCallCheck"), _createClass = require("@babel/runtime/helpers/createClass"), _inherits = require("@babel/runtime/helpers/inherits"), _toConsumableArray = require("@babel/runtime/helpers/toConsumableArray"), React = require("react"), react = require("@emotion/react"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties");
...
for (var _extends__default = _interopDefault(_extends), _classCallCheck__default = _interopDefault(_classCallCheck), _createClass__default = _interopDefault(_createClass), _inherits__default = _interopDefault(_inherits), _toConsumableArray__default = _interopDefault(_toConsumableArray), React__default = _interopDefault(React), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), diacritics = [ {
  base: "A",
...
var shouldHideSelectedOptions = function(props) {
  ...
  return _createClass__default.default(Select, [ {
    ...
    value: function() {
      ...
      }, menuElement = React__default.default.createElement(index.MenuPlacer, _extends__default.default({}, commonProps, menuPlacementProps), (function(_ref6) {
