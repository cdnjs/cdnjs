...
define('proj4/Point',['require','proj4/mgrs'],function(require) {
  var mgrs = require('proj4/mgrs');
...
define('proj4/constants/PrimeMeridian',{
  "greenwich": 0.0, //"0dE",
...
define('proj4/constants/Ellipsoid',{
  "MERIT": {
    a: 6378137.0,
    rf: 298.257,
...
define('proj4/constants',['require','exports','module','proj4/constants/PrimeMeridian','proj4/constants/Ellipsoid','proj4/constants/Datum','proj4/constants/grids'],function(require,exports) {
...
define('proj4/projString',['require','proj4/common','proj4/constants'],function(require) {
...
define('proj4/wkt',['require','proj4/common','proj4/extend'],function(require) {
  var common = require('proj4/common');
...
define('proj4/defs',['require','proj4/global','proj4/projString','proj4/wkt'],function(require) {
...
define('proj4/datum',['require','proj4/common'],function(require) {
  var common = require('proj4/common');
...
define('proj4/projCode/tmerc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/utm',['require','exports','module','proj4/common','proj4/projCode/tmerc'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/gauss',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/sterea',['require','exports','module','proj4/common','proj4/projCode/gauss'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/stere',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/somerc',['require','exports','module'],function(require, exports) {
  /*
  references:
...
define('proj4/projCode/omerc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/lcc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/krovak',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/cass',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
    if (!this.sphere) {
      this.e0 = common.e0fn(this.es);
...
define('proj4/projCode/laea',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  /*
  reference
...
define('proj4/projCode/merc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/aea',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/gnom',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  /*
  reference:
...
define('proj4/projCode/cea',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  /*
  reference:  
...
define('proj4/projCode/eqc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/poly',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
    /* Place parameters in static storage for common use
      -------------------------------------------------*/
...
define('proj4/projCode/nzmg',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  /*
  reference
...
define('proj4/projCode/mill',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  /*
  reference
    "New Equal-Area Map Projections for Noncircular Regions", John P. Snyder,
...
define('proj4/projCode/sinu',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
    /* Place parameters in static storage for common use
    -------------------------------------------------*/
...
define('proj4/projCode/moll',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
    //no-op
  };
...
define('proj4/projCode/eqdc',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/projCode/vandg',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
...
define('proj4/projCode/aeqd',['require','exports','module','proj4/common'],function(require, exports) {
  var common = require('proj4/common');
  exports.init = function() {
...
define('proj4/Proj',['require','proj4/extend','proj4/common','proj4/defs','proj4/constants','proj4/datum','proj4/projections','proj4/wkt','proj4/projString'],function(require) {
  var extend = require('proj4/extend');
  var common = require('proj4/common');
...
define('proj4/datum_transform',['require','proj4/common'],function(require) {
  var common = require('proj4/common');
...
define('proj4/transform',['require','proj4/common','proj4/datum_transform','proj4/adjust_axis','proj4/Proj'],function(require) {
  var common = require('proj4/common');
...
define('proj4/core',['require','proj4/Point','proj4/Proj','proj4/transform'],function(require) {
