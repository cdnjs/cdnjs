(function (global, factory) {
    ...
    function createStoreInjector(grabStoresFn, component, injectNames) {
      ...
      var displayName = 'inject-' + (component.displayName || component.name || ((_component$constructo = component.constructor) == null ? undefined : _component$constructo.name) || 'Unknown');
      if (injectNames) {
      ...
      var Injector = /*#__PURE__*/function (_Component2) {
        function Injector(props, context) {
          ...
          _this2.wrappedInstance = undefined;
    ...
    var Provider = /*#__PURE__*/function (_Component) {
      ...
      _proto.getChildContext = function getChildContext() {
        ...
        for (var _key in props) {
          if (specialKeys[_key] === undefined && _key !== 'suppressChangedStoreWarning') {
      ...
      Provider.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (!nextProps.suppressChangedStoreWarning) {
          for (var key in nextProps) {
            if (specialKeys[key] === undefined && this.props[key] !== nextProps[key]) {
