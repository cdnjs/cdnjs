(function (global, factory) {
    ...
    EventEmitter.prototype.on = function on (cb) {
        ...
        return function () {
            var index = this$1$1.listeners.indexOf(cb);
            if (index !== -1) {
                this$1$1.listeners.splice(index, 1);
            }
        };
    };
        ...
        componentWillMount: function componentWillMount() {
            ...
            var initialRender = function () {
                reaction = new mobx.Reaction((initialName + ".render()"), function () {
                    if (!isRenderingPending) {
                        ...
                        if (typeof this$1$1.componentWillReact === 'function') {
                            this$1$1.componentWillReact(); // TODO: wrap in action?
                        }
                        if (!skipRender) {
                ...
                reaction.reactComponent = this$1$1;
                reactiveRender.$mobx = reaction;
                reactiveRender.$base = this$1$1.render;
                this$1$1.render = reactiveRender;
            ...
            var reactiveRender = function () {
                ...
                reaction.track(function () {
                    if (isDevtoolsEnabled) {
                        this$1$1.__$mobRenderStart = Date.now();
                    }
                    try {
                    ...
                    if (isDevtoolsEnabled) {
                        this$1$1.__$mobRenderEnd = Date.now();
                    }
                });
                if (exception) {
    ...
    function makeObserverRender(update, render, name) {
        ...
        var observer = function () {
            ...
            track(function () {
                try {
                    rendered = render.apply(this$1$1, parameters);
                }
                catch (error) {
                    caught = error;
                }
    ...
    function observerWrap(base) {
        ...
        function wrapper(props, context) {
            ...
            var ref = getUpdateHooks(this.ref, props);
            var onComponentDidUpdate = ref[0];
            var onComponentWillUpdate = ref[1];
            var proxy;
            var reaction = new mobx.Reaction(base.name, function () {
                ...
                reaction.track(function () {
                    next = inferno._HI(base.call(this$1$1, props, context));
                });
                if (next) {
