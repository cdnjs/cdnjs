    ...
    */
    ...
    function mapColorManager(attrs, colorRange, isNavigationBar) {
      ...
      return function (node, isNavigationBar, dsConf) {
        ...
        thisNodeColor = attrs.isLegendEnabled && (nodeColorValue === 0 || nodeColorValue) ? colorRange && colorRange.getColorByValue(nodeColorValue) && '#' + colorRange.getColorByValue(nodeColorValue) || normalizeColorCode(colorRange && colorRange.rangeOutsideColor) : UNDEF;
    ...
    var datasetDefStore,
      ...
      drawNavigation = function drawNavigation(drawingAreaMeasurement, isStacked) {
        ...
        for (i = 0; i < len; i += 1) {
          ...
          node[navigationMapper[isStacked ? 'stacked' : 'navigationHistory'].path] = drawPathFn(pathObj, localColorProvider(node, true, dsConf), node);
          // Get the configuration to draw text
        ...
        return {
          ...
          set: function set(hasNavigationBar) {
            var singleLineRatio,
              ...
              maxFontSize = dsConf.labelFontSize ? Math.max(dsConf.labelFontSize,
              // eslint-disable-line good-practices/no-single-usage-variable
...
exports["default"] = void 0;
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _commonspacemanager = _interopRequireDefault(__webpack_require__(525));
var _schedular = __webpack_require__(290);
var _lib = __webpack_require__(278);
var _toolbox = __webpack_require__(424);
var _treemap = _interopRequireDefault(__webpack_require__(1613));
var _helper = _interopRequireDefault(__webpack_require__(1615));
var _dependencyManager = __webpack_require__(286);
var _singleseriesDataset = _interopRequireDefault(__webpack_require__(600));
...
var _mouseTracker = _interopRequireDefault(__webpack_require__(598));
var _redraphaelShapes = _interopRequireDefault(__webpack_require__(448));
/* eslint require-jsdoc: 'error', valid-jsdoc: ["error", { "requireReturn": false }] */
...
var TreeMap = /*#__PURE__*/function (_CommonSpaceManager) {
  ...
  function TreeMap() {
    ...
    _this.registerFactory('legend', _legendmanager.default, ['canvas']);
...
var _lib = __webpack_require__(278);
var _dependencyManager = __webpack_require__(286);
var _index = _interopRequireDefault(__webpack_require__(1614));
/* eslint require-jsdoc: 'error', valid-jsdoc: ["error", { "requireReturn": false }] */
    ...
    result = {
      ...
      searchTreemap: function searchTreemap(x, y) {
        var res,
          ...
          _search = function search(ob, isY) {
            // Not found
            if (!ob || !ob.point) {
              return;
            }
            ...
            _search(ob.left, !isY);
            _search(ob.right, !isY);
          };
        _search(this.tree, false);
        return res;
      }
    }; // ------
    // eslint-disable-next-line good-practices/no-function-dependency
...
var TreeMapDS = /*#__PURE__*/function (_ComponentInterface) {
  ...
  _proto.configureAttributes = function configureAttributes(datasetJSON) {
    ...
    dsConf.showHoverEffect = (0, _lib.pluckNumber)(rawChartAttr.showhovereffect, 1);
    ...
    dsConf.plotToolText = (0, _lib.parseUnsafeString)((0, _lib.pluck)(rawChartAttr.plottooltext, ''), false);
  ...
  _proto.createContainer = function createContainer() {
    ...
    datasetGroup = dataset.getContainer('plots') ||
    // eslint-disable-line good-practices/no-single-usage-variable
    ...
    trackerGroup = dataset.getContainer('tracker') || dataset.addContainer('tracker',
    // eslint-disable-line good-practices/no-single-usage-variable
    ...
    */
    rendererAPI.disposeChild = function () {
      var rendererAPI,
        ...
        _removeFn = function removeFn(currentNode, depth) {
          var index,
            // eslint-disable-line
            childrenArr;
          ...
          for (index = 0; index < (currentNode.getChildren() || []).length; index++) {
            ...
            index = _removeFn(childrenArr[index], index);
          }
          return depth;
        };
    ...
    rendererAPI.disposeSelectedChildren = function () {
      var rendererAPI,
        ...
        _removeItems = function removeItems(currentNode, depth) {
          var index,
            // eslint-disable-line
            childrenArr;
          ...
          for (index = 0; index < (currentNode.getChildren() || []).length; ++index) {
            childrenArr = currentNode.getChildren();
            index = _removeItems(childrenArr[index], index);
          }
          return depth;
        };
      return function (node) {
...
exports.__esModule = true;
exports["default"] = void 0;
var _treemap = _interopRequireDefault(__webpack_require__(1611));
...
exports.__esModule = true;
exports["default"] = void 0;
var _treemap = _interopRequireDefault(__webpack_require__(1612));
var _default = exports["default"] = _treemap.default;
...
//# sourceMappingURL=http://localhost:3052/4.1.0-beta.4/map/eval/fusioncharts.treemap.js.map