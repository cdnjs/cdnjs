...
var _configuration = _interopRequireDefault(__webpack_require__(1640));
var _singleSeries = __webpack_require__(1644);
var _multiSeries = _interopRequireDefault(__webpack_require__(1650));
var _heatmapData = _interopRequireDefault(__webpack_require__(1651));
...
function AccessibilityExtension(FusionCharts) {
  ...
  FusionCharts.addEventListener('renderComplete', function (evt) {
    ...
    // Accessibility config should be enabled through chart instance only. It could be done by setting the value of accessibility to 1.
...
exports.__esModule = true;
exports["default"] = void 0;
var _supportedChartTypes = _interopRequireDefault(__webpack_require__(1649));
var _util = __webpack_require__(1645);
/* eslint-disable no-fallthrough */
...
var _default = exports["default"] = FCAccessibilityBase;
...
var _util = __webpack_require__(1645);
var _base = _interopRequireDefault(__webpack_require__(1648));
/* eslint-disable no-fallthrough */
/* eslint-disable default-case */
...
var _default = exports["default"] = FCAccessibilityExportEnabled;
...
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _util = __webpack_require__(1645);
var _legendEnabled = __webpack_require__(1646);
/* eslint-disable default-case */
...
var _default = exports["default"] = FCAccessibilityHeatMap;
...
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _util = __webpack_require__(1645);
var _exportEnabled = _interopRequireDefault(__webpack_require__(1647));
var _base = _interopRequireDefault(__webpack_require__(1648));
...
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; } /* eslint-disable no-empty-function */ /* eslint-disable no-fallthrough */ /* eslint-disable default-case */ /* eslint-disable no-inner-declarations */
var UNDEF;
var FCAccessibilityLegendEnabled = exports.FCAccessibilityLegendEnabled = /*#__PURE__*/function (_FCAccessibilityExpor) {
  // eslint-disable-next-line no-useless-constructor
  ...
  _proto.isAllLegendItemHidden = function isAllLegendItemHidden() {
    var legend = this.chartInstance.apiInstance._components.legend;
  ...
  _proto.makeLegendAccessible = function makeLegendAccessible(bLegend) {
    ...
    if (this.chartInstance.getChartAttribute('showlegend') !== '0') {
      ...
      if (legendTexts && legendTexts.length > 0) {
        ...
        var legendItems = (_this$chartInstance = this.chartInstance) == null || (_this$chartInstance = _this$chartInstance.apiInstance) == null || (_this$chartInstance = _this$chartInstance._components) == null || (_this$chartInstance = _this$chartInstance.legend) == null || (_this$chartInstance = _this$chartInstance[0]) == null || (_this$chartInstance = _this$chartInstance._components) == null ? void 0 : _this$chartInstance.legendItem;
...
var FCAccessibilityMultiSeries = /*#__PURE__*/function (_FCAccessibilityLegen) {
  ...
  _proto.makeMultiSeriesAccessible = function makeMultiSeriesAccessible(bEvent) {
    ...
    var bubblePlotProperties = function bubblePlotProperties(i, j) {
        var plotStat = {};
        // x value of bubble
        plotStat['{xValue}'] = _this2.chartData.dataset[i].data[j].x || '';
        // y value of bubble
        plotStat['{yValue}'] = _this2.chartData.dataset[i].data[j].y || '';
        // z value of bubble
        plotStat['{zValue}'] = _this2.chartData.dataset[i].data[j].z || '';
        // label of the bubble
        plotStat['{bubbleName}'] = _this2.chartData.dataset[i].data[j].name || '';
        // Series name
      ...
      defaultMultiSeriesPlotPorperties = function defaultMultiSeriesPlotPorperties(i, j) {
        var plotStat = {};
        // Label
        plotStat['{label}'] = _this2.chartData.categories && _this2.chartData.categories[0].category[j].label || '';
        // value
        plotStat['{value}'] = _this2.chartData.dataset[i].data[j].value;
        // Formatted value
        plotStat['{formattedValue}'] = _this2.chartInstance.formatNumber(_this2.chartData.dataset[i].data[j].value);
        // Series
        plotStat['{seriesName}'] = _this2.chartData.dataset[i].seriesname || '';
        return plotStat;
      },
...
var _default = exports["default"] = FCAccessibilityMultiSeries;
...
/* eslint-disable no-fallthrough */
/* eslint-disable default-case */
var FCAccessibilitySingleSeries = exports.FCAccessibilitySingleSeries = /*#__PURE__*/function (_FCAccessibilityExpor) {
  // eslint-disable-next-line no-useless-constructor
...
var FCAccessibilitySingleSeriesWithLegend = exports.FCAccessibilitySingleSeriesWithLegend = /*#__PURE__*/function (_FCAccessibilityLegen) {
  // eslint-disable-next-line no-useless-constructor
...
exports.__esModule = true;
exports["default"] = void 0;
var _util = __webpack_require__(1641);
...
var _default = exports["default"] = AccessibilityConfig;
...
// eslint-disable-next-line no-unused-vars
var chartTypes;
var _default = exports["default"] = chartTypes = {
  'msline': {
...
exports.__esModule = true;
exports["default"] = void 0;
var _accessibility = _interopRequireDefault(__webpack_require__(1639));
var _default = exports["default"] = _accessibility.default;
...
//# sourceMappingURL=http://localhost:3052/4.1.0-beta.4/map/eval/fusioncharts.accessibility.js.map