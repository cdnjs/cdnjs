...
var defaultPaletteOption = _interopRequireWildcard(__webpack_require__(538));
var _domEvent = _interopRequireDefault(__webpack_require__(280));
var _eventApi = __webpack_require__(285);
var _lib = __webpack_require__(278);
var _mapsDataset = _interopRequireDefault(__webpack_require__(1654));
var _canvas = _interopRequireDefault(__webpack_require__(527));
var _colorrange = _interopRequireDefault(__webpack_require__(1451));
var _legendmanager = _interopRequireDefault(__webpack_require__(1455));
...
var Maps = /*#__PURE__*/function (_MSCartesian) {
  ...
  function Maps() {
    ...
    _this2.registerFactory('axis', _lib.stubFN, ['canvas']);
  ...
  _proto._spaceManager = function _spaceManager() {
    ...
    availableHeight = legendPosition[0] === POSITION_BOTTOM || legendPosition[0] === _lib.POSITION_TOP ? config.canvasHeight * 0.225 : config.canvasWidth * 0.225;
...
var _default = exports["default"] = Maps;
...
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _componentInterface = __webpack_require__(294);
var _extAnnotation = _interopRequireDefault(__webpack_require__(390));
var _dependencyManager = __webpack_require__(286);
var _mapEntities = _interopRequireDefault(__webpack_require__(1656));
var _lib = __webpack_require__(278);
...
var Entities = /*#__PURE__*/function (_ComponentInterface) {
  ...
  _proto._batchRender = function _batchRender() {
    var dataset = this,
      ...
      ent,
      outlinesDrawn,
      _drawEntities = function drawEntities(entityStartIndex) {
        i = entityStartIndex;
        count = 0;
        ...
        while (keys[i] !== UNDEF) {
          ...
          if (count >= batchSize) {
            dataset.addJob('entityDraw', _drawEntities.bind(dataset, i), _schedular.priorityList.entitydraw);
            break;
          }
        }
        if (i === keysLength) {
...
exports["default"] = void 0;
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _entities = _interopRequireDefault(__webpack_require__(1655));
...
var _lib = __webpack_require__(278);
var _entities = _interopRequireDefault(__webpack_require__(1655));
var _markers = _interopRequireDefault(__webpack_require__(1657));
var _mapGroup = _interopRequireDefault(__webpack_require__(1658));
/**
...
exports.__esModule = true;
exports["default"] = void 0;
var _maps = _interopRequireDefault(__webpack_require__(1653));
...
//# sourceMappingURL=http://localhost:3052/4.1.0-beta.5/map/eval/fusioncharts.maps.js.map