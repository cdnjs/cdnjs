...
var _scatterbase = _interopRequireDefault(__webpack_require__(725));
var _zoomscatter = _interopRequireDefault(__webpack_require__(1619));
...
var _default = exports["default"] = ZoomScatter;
...
exports["default"] = void 0;
var _inheritsLoose2 = _interopRequireDefault(__webpack_require__(292));
var _scatter = _interopRequireDefault(__webpack_require__(729));
var _kdtree = _interopRequireDefault(__webpack_require__(730));
var _schedular = __webpack_require__(290);
var _lib = __webpack_require__(278);
var _linearRegression = _interopRequireDefault(__webpack_require__(416));
var UNDEF,
  win = window,
...
var ZoomScatter = /*#__PURE__*/function (_Scatter) {
  ...
  _proto.configureAttributes = function configureAttributes(datasetJSON) {
    ...
    conf.anchorBorderThickness = (0, _lib.pluckNumber)(datasetJSON.anchorborderthickness, chartAttr.anchorborderthickness, userGivenBorderColor ? 1 : 0);
  ...
  _proto.hasDrawingRefChanged = function hasDrawingRefChanged() {
    ...
    res = axisConfig.xZoomScale !== currVizRatioX || axisConfig.yZoomScale !== currVizRatioY || dsConfig.prevCanvasHeight !== chartConfig.canvasHeight || dsConfig.prevCanvasWidth !== chartConfig.canvasWidth;
  ...
  */;
  ...
  ;
  _proto.drawCommonElements = function drawCommonElements() {
    // Override and do nothing
  }
  // eslint-disable-next-line
  ;
  _proto.animateCommonElements = function animateCommonElements() {
    // Override and do nothing
  }
  ...
  */;
  ...
  // eslint-disable-next-line
  ;
  _proto.setContainerVisibility = function setContainerVisibility() {
    // empty fn
  }
  /**
  ...
  */;
  ...
  _proto._setConfigure = function _setConfigure() {
    ...
    for (i = 0; i < datasetLen; i += 1) {
      ...
      config.setTooltext = (0, _lib.getValidValue)((0, _lib.parseUnsafeString)((0, _lib.pluck)(setData.tooltext, conf.plotToolText), false));
...
exports.__esModule = true;
exports["default"] = void 0;
var _zoomscatter = _interopRequireDefault(__webpack_require__(1618));
var _default = exports["default"] = _zoomscatter.default;
...
exports.__esModule = true;
exports["default"] = void 0;
var _zoomscatter = _interopRequireDefault(__webpack_require__(1617));
...
//# sourceMappingURL=http://localhost:3052/4.1.0-beta.5/map/eval/fusioncharts.zoomscatter.js.map