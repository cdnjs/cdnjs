  ...
  _proto.makeExportAccessible = function makeExportAccessible() {
    if (this.chartData.chart.exportenabled) {
      ...
      var keyCaptured = false,
          exportItemIndex = -1;
      this.addTabIndexAndSetAria(exportButton, this.alternateTexts.exportMenu, this.chartPropertyMap, '4', 'button'); // eslint-disable-next-line no-inner-declarations
...
//# sourceMappingURL=http://localhost:3052/4.1.0-beta.8/map/eval/fusioncharts.accessibility.js.map