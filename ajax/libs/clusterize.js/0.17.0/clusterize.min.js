...
0);var e=q(b.rows)?b.rows:a.fetchMarkup(),g={data:"",bottom:0};b=a.scroll_elem.scrollTop;a.exploreEnvironment(e);a.insertToDOM(e,g);a.scroll_elem.scrollTop=b;var k=!1,l=0,r=!1,t=function(){x&&(r||(a.content_elem.style.pointerEvents="none"),r=!0,clearTimeout(l),l=setTimeout(function(){a.content_elem.style.pointerEvents="auto";r=!1},50));k!=(k=a.getClusterNum())&&a.insertToDOM(e,g);a.options.callbacks.scrollingProgress&&a.options.callbacks.scrollingProgress(a.getScrollProgress())},u=0,v=function(){clearTimeout(u);
u=setTimeout(a.refresh,100)};p("scroll",a.scroll_elem,t);p("resize",window,v);a.destroy=function(b){m("scroll",a.scroll_elem,t);m("resize",window,v);a.html((b?a.generateEmptyRow():e).join(""))};a.refresh=function(){a.getRowsHeight(e)&&a.update(e)};a.update=function(b){e=q(b)?b:[];b=a.scroll_elem.scrollTop;e.length*a.options.item_height<b&&(k=a.scroll_elem.scrollTop=0);a.insertToDOM(e,g);a.scroll_elem.scrollTop=b};a.clear=function(){a.update([])};a.getRowsAmount=function(){return e.length};a.getScrollProgress=
