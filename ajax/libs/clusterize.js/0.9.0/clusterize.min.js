...
f=0,k;k=d[f];f++)a.options[k]="undefined"!=typeof b[k]&&null!=b[k]?b[k]:c[k];c=["scroll","content"];for(f=0;d=c[f];f++)if(a[d+"_elem"]=b[d+"Id"]?document.getElementById(b[d+"Id"]):b[d+"Elem"],!a[d+"_elem"])throw Error("Error! Could not find "+d+" element");a.content_elem.hasAttribute("tabindex")||a.content_elem.setAttribute("tabindex",0);var e=p(b.rows)?b.rows:a.fetchMarkup(),h={data:""};b=a.scroll_elem.scrollTop;a.exploreEnvironment(e);a.insertToDOM(e,h);a.scroll_elem.scrollTop=b;var q=!1,g=function(){q!=
(q=a.getClusterNum())&&a.insertToDOM(e,h)},r=0,t=function(){clearTimeout(r);r=setTimeout(a.refresh,100)};n("scroll",a.scroll_elem,g);n("resize",window,t);a.destroy=function(b){l("scroll",a.scroll_elem,g);l("resize",window,t);a.html((b?a.generateEmptyRow():e).join(""))};a.refresh=function(){a.getRowsHeight(e)&&a.update(e)};a.update=function(b){e=p(b)?b:[];b=a.scroll_elem.scrollTop;e.length*a.options.item_height<b&&(q=a.scroll_elem.scrollTop=0);a.insertToDOM(e,h);a.scroll_elem.scrollTop=b};a.clear=
function(){a.update([])};a.getRowsAmount=function(){return e.length};var u=function(b,c){var d=p(c)?c:[];d.length&&(e="append"==b?e.concat(d):d.concat(e),a.insertToDOM(e,h))};a.append=function(a){u("append",a)};a.prepend=function(a){u("prepend",a)}};m.prototype={constructor:m,fetchMarkup:function(){for(var b=[],a=this.getChildNodes(this.content_elem);a.length;)b.push(a.shift().outerHTML);return b},exploreEnvironment:function(b){var a=this.options;a.content_tag=this.content_elem.tagName.toLowerCase();
if(b.length){g&&9>=g&&!a.tag&&(a.tag=b[0].split("<")[1].split(" ")[0].split(">")[0].toLowerCase());if(1>=this.content_elem.children.length||!a.tag){this.html(b[0]+b[0]+b[0]);var c=this.content_elem.children[1];a.tag||(a.tag=c.tagName.toLowerCase())}this.getRowsHeight(b)}},getRowsHeight:function(b){var a=this.options,c=a.item_height;a.cluster_height=0;if(b.length)return b=this.content_elem.children,a.item_height=b[Math.ceil(b.length/2)].offsetHeight,a.block_height=a.item_height*a.rows_in_block,a.rows_in_cluster=
a.blocks_in_cluster*a.rows_in_block,a.cluster_height=a.blocks_in_cluster*a.block_height,c!=a.item_height},getClusterNum:function(){var b=this.options;return Math.floor(this.scroll_elem.scrollTop/(b.cluster_height-b.block_height))},generateEmptyRow:function(){var b=this.options;if(!b.tag||!b.show_no_data_row)return[];var a=document.createElement(b.tag),c=document.createTextNode(b.no_data_text),d;a.className=b.no_data_class;"tr"==b.tag&&(d=document.createElement("td"),d.appendChild(c));a.appendChild(d||
c);return[a.outerHTML]},generate:function(b,a){var c=this.options,d=b.length;if(d<c.rows_in_block)return{rows_above:0,rows:d?b:this.generateEmptyRow()};c.cluster_height||this.exploreEnvironment(b);var f=(c.rows_in_cluster-c.rows_in_block)*a,f=0<f?f:0,k=f+c.rows_in_cluster,e=f*c.item_height,d=(d-k)*c.item_height,h=[],g=f;0<e?(c.keep_parity&&h.push(this.renderExtraTag("keep-parity")),h.push(this.renderExtraTag("top-space",e))):g++;for(c=f;c<k;c++)b[c]&&h.push(b[c]);0<d&&h.push(this.renderExtraTag("bottom-space",
d));return{rows_above:g,rows:h}},renderExtraTag:function(b,a){var c=document.createElement(this.options.tag);c.className=["clusterize-extra-row","clusterize-"+b].join(" ");a&&(c.style.height=a+"px");return c.outerHTML},insertToDOM:function(b,a){var c=this.generate(b,this.getClusterNum()),d=c.rows.join("");if(!this.options.verify_change||this.options.verify_change&&this.dataChanged(d,a))this.html(d),"ol"==this.options.content_tag&&this.content_elem.setAttribute("start",c.rows_above)},html:function(b){var a=
