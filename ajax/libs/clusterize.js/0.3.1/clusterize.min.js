...
tag:null,show_no_data_row:!0,no_data_class:"clusterize-no-data",no_data_text:"No data",keep_parity:!0,verify_change:!1};a.options={};"rows_in_block blocks_in_cluster verify_change show_no_data_row no_data_class no_data_text keep_parity tag".split(" ").forEach(function(k){a.options[k]="undefined"!=typeof b[k]&&null!=b[k]?b[k]:c[k]});["scroll","content"].forEach(function(c){a[c+"Elem"]=b[c+"Id"]?document.getElementById(b[c+"Id"]):b[c+"Elem"];if(!a[c+"Elem"])throw Error("Error! Could not find "+c+" element");
});var d=b.rows||[],f={data:""},g=a.scrollElem.scrollTop;a.calcClusterHeight(d);a.insertToDOM(d,f);a.scrollElem.scrollTop=g;var l=!1,h=function(){l!=(l=a.getClusterNum())&&a.insertToDOM(d,f)};a.scrollElem.addEventListener("scroll",h);a.destroy=function(b){a.scrollElem.removeEventListener("scroll",h);a.html(b?a.generateEmptyRow().join(""):d.join(""))};a.update=function(b){d=a.isArray(b)?b:[];b=a.scrollElem.scrollTop;a.insertToDOM(d,f);a.scrollElem.scrollTop=b};a.append=function(b){b=a.isArray(b)?b:
[];b.length&&(d=d.concat(b),a.insertToDOM(d,f))};a.clear=function(){a.update([])};a.getRowsAmount=function(){return d.length}};e.prototype={constructor:e,calcClusterHeight:function(b){var a=this.options;if(!a.item_height||!a.tag){if(!b.length)return;this.html(b[0]+b[0]+b[0]);b=this.contentElem.children[1];a.tag||(a.tag=b.tagName.toLowerCase());a.item_height=b.offsetHeight}a.block_height=a.item_height*a.rows_in_block;a.rows_in_cluster=a.blocks_in_cluster*a.rows_in_block;a.cluster_height=a.blocks_in_cluster*
a.block_height},getClusterNum:function(){var b=this.options;return Math.floor(this.scrollElem.scrollTop/(b.cluster_height-b.block_height))},generateEmptyRow:function(){var b=this.options;if(!b.tag||!b.show_no_data_row)return[];var a=document.createElement(b.tag),c=document.createTextNode(b.no_data_text);a.className=b.no_data_class;if("tr"==b.tag){var d=document.createElement("td");d.appendChild(c)}a.appendChild(d||c);return[a.outerHTML]},generate:function(b,a){var c=this.options,d=b.length;if(!d)return this.generateEmptyRow();
