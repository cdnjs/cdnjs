import{r as t,c as n,h as e,e as i,i as a}from"./p-16e19467.js";import{t as o,h as r}from"./p-0fff84d6.js";import{w as s,a as l,g as b,f as d,b as f,c}from"./p-2e817ac9.js";const h=class{constructor(e){t(this,e),this.fwClick=n(this,"fwClick",7),this.fwFocus=n(this,"fwFocus",7),this.fwBlur=n(this,"fwBlur",7),this.type="button",this.color="primary",this.size="normal",this.disabled=!1,this.loading=!1,this.showCaretIcon=!1,this.modalTriggerId="",this.fileUploaderId="",this.throttleDelay=200,this.hasLabel=!1,this.hasBeforeLabel=!1,this.hasAfterLabel=!1}async setFocus(){this.button.focus()}onFocus(){this.fwFocus.emit()}onBlur(){this.fwBlur.emit()}connectedCallback(){this.handleClickWithThrottle=o(this.handleClick,this,this.throttleDelay)}handlePreventDefault(t){t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation()}handleClick(t){""!==this.modalTriggerId&&this.modalTrigger(),""!==this.fileUploaderId?this.fileSubmit():"submit"===this.type&&this.fakeSubmit(t),this.fwClick.emit()}async fileSubmit(){const t=document.querySelector("fw-file-uploader#"+this.fileUploaderId);null!=t&&t.uploadFiles()}async modalTrigger(){const t=document.querySelector("fw-modal#"+this.modalTriggerId);null!=t&&t.open()}async fakeSubmit(t){const e=this.host.closest("form");if(e){t.preventDefault();const n=document.createElement("button");n.type="submit",n.style.display="none",e.appendChild(n),n.click(),n.remove()}}componentWillLoad(){this.handleSlotChange()}handleSlotChange(){this.hasLabel=r(this.host),this.hasBeforeLabel=r(this.host,"before-label"),this.hasAfterLabel=r(this.host,"after-label")}render(){return e(i,{onClick:t=>{if(this.disabled)return t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation(),!1}},e("button",{type:this.type,class:`
