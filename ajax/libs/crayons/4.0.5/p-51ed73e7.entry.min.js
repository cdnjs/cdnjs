import{r as e,h as t,c as i,e as o,i as a}from"./p-16e19467.js";import{h as s,r}from"./p-79178ffe.js";const n=class{constructor(t){e(this,t),this.shape="circle",this.name="",this.size="large",this.mode="dark"}getInitials(){let e="";if(this.initials)e=this.initials;else if(0<this.name.trim().length){const t=this.name.trim().split(" ");1===t.length?e=t.shift().charAt(0):1<t.length&&(e=t.shift().charAt(0)+t.pop().charAt(0))}return e}renderAltIcon(){return t("svg",{id:"error"===this.mode?"error-svg":"default-svg",width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg"},t("g",{"clip-path":"url(#a)",fill:"error"===this.mode?"#C82124":"#283DA5"},t("circle",{cx:12,cy:9,r:5}),t("ellipse",{cx:12,cy:24.5,rx:11,ry:9.5})),t("defs",null,t("clipPath",{id:"a"},t("path",{fill:"#fff",d:"M0 0h24v24H0z"}))))}render(){let e=`avatar 
    avatar--${this.shape}
    avatar--${this.size}
    avatar--${this.mode}
