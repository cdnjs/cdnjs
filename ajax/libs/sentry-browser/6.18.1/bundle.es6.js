...
var Sentry = (function (exports) {
  ...
  function sessionToSentryRequest(session, api) {
      ...
      const envelopeHeaders = JSON.stringify(Object.assign(Object.assign({ sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (!!api.tunnel && { dsn: dsnToString(api.dsn) })));
  ...
  function eventToSentryRequest(event, api) {
      ...
      if (useEnvelope) {
          const envelopeHeaders = JSON.stringify(Object.assign(Object.assign({ event_id: event.event_id, sent_at: new Date().toISOString() }, (sdkInfo && { sdk: sdkInfo })), (!!api.tunnel && { dsn: dsnToString(api.dsn) })));
          const itemHeaders = JSON.stringify({
              type: eventType,
