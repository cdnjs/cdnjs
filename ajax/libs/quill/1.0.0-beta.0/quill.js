	  ...
	  function Selection(scroll, emitter) {
	    ...
	    this.emitter.on(_emitter2.default.events.SCROLL_BEFORE_UPDATE, function () {
	      ...
	      _this.emitter.once(_emitter2.default.events.SCROLL_UPDATE, function () {
	        try {
	          _this.setNativeRange(native.start.node, native.start.offset, native.end.node, native.end.offsetTop);
	        } catch (ignored) {}
	      });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clipboard = function (_Module) {
	  ...
	  function Clipboard(quill, options) {
	    ...
	    _this.matchers = [[Node.TEXT_NODE, matchText], [Node.ELEMENT_NODE, matchNewline], [Node.ELEMENT_NODE, matchBlot], [Node.ELEMENT_NODE, matchSpacing], [Node.ELEMENT_NODE, matchAttributor], ['b, i', matchAliases]];
	    return _this;
	  }
	...
	var Keyboard = function (_Module) {
	  ...
	  _createClass(Keyboard, [{
	    ...
	    value: function onFormat(format, range) {
	      var formats = this.quill.getFormat(range);
	      this.quill.format(format, !formats[format], _quill2.default.sources.USER);
	    }
	  }, {
	    key: 'onTab',
	    value: function onTab(range, evt) {
	      ...
	      if (range.length === 0) {
	        ...
	        (function () {
	          ...
	          _this3.quill.update(_quill2.default.sources.USER);
	          _this3.quill.setSelection(range, _quill2.default.sources.SILENT);
	        })();
	      }
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toolbar = function (_Module) {
	  ...
	  function Toolbar(quill, options) {
	    ...
	    _this.container = _this.options.container || _this.options;
	    if (typeof _this.container === 'string') {
	      _this.container = document.querySelector(_this.container);
	    } else if (Array.isArray(_this.container)) {
	      var container = document.createElement('div');
	      addControls(container, _this.container);
	    ...
	    _this.handlers = {
	      'indent': function indent(value) {
	        var range = _this.quill.getSelection();
	        var formats = _this.quill.getFormat(range);
	        var indent = parseInt(formats.indent || 0);
	        if (value === '+1') {
	          _this.quill.format('indent', indent + 1);
	        } else if (value === '-1') {
	          _this.quill.format('indent', indent - 1);
	        }
	      },
	      'clean': function clean() {
	        var range = _this.quill.getSelection();
	        if (range != null) {
	          var startLength = _this.quill.getLength();
	          _this.quill.removeFormat(range);
	          var endLength = _this.quill.getLength();
	          // account for embed removals
	          _this.quill.setSelection(range.index, range.length - (startLength - endLength));
	        }
	        return true;
	      }
	    };
	...
	var SnowTheme = function (_BaseTheme) {
	  ...
	  _createClass(SnowTheme, [{
	    ...
	    value: function extendToolbar(toolbar) {
	      ...
	      toolbar.handlers['link'] = function (value) {
	        if (!value) return false;
	        _this2.linkTooltip.open(_this2.quill.selection.savedRange);
	        return true;
	      };
	    }
	  }]);
