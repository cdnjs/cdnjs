...
var Keyboard = function (_Module) {
  ...
  function Keyboard(quill, options) {
    ...
    _this.addBinding({ key: Keyboard.keys.BACKSPACE }, { ctrlKey: true }, function () {});
    _this.addBinding({ key: Keyboard.keys.DELETE }, { ctrlKey: true }, function () {});
