...
var _11 = function() {
	...
	function tryBlockRemove(parent, vnode3, source, counter) {
		...
		Promise.resolve(result).finally(function () {
			checkState(vnode3, original)
			tryResumeRemove(parent, vnode3, generation, counter)
		})
	}
	function tryResumeRemove(parent, vnode3, generation, counter) {
		if (--counter.v === 0) {
			onremove(vnode3)
	...
	function removeNode(parent, vnode3) {
		...
		tryResumeRemove(parent, vnode3, undefined, counter)
	}
