 ...
 */
declare function createSelectorHook(context?: React.Context<ReactReduxContextValue<any, any>>): UseSelector;
/**
...
declare const ReactReduxContext: React.Context<ReactReduxContextValue<any, UnknownAction>>;
 ...
 */
declare function createDispatchHook<S = unknown, A extends Action<string> = UnknownAction>(context?: Context<ReactReduxContextValue<S, A>>): <AppDispatch extends Dispatch<A> = Dispatch<A>>() => AppDispatch;
/**
 ...
 */
declare function createStoreHook<S = unknown, A extends Action = UnknownAction>(context?: Context<ReactReduxContextValue<S, A>>): <State = S, Action2 extends Action = A>() => Store<State, Action2, {}>;
/**
