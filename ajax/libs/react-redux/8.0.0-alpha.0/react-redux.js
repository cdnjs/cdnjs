(function (global, factory) {
  ...
  var useSyncExternalStore_development = createCommonjsModule(function (module, exports) {
  ...
  var useSyncExternalStore = createCommonjsModule(function (module) {

  {
    module.exports = useSyncExternalStore_development;
  }
  });
  ...
  function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
    ...
    const wrapWithConnect = WrappedComponent => {
      ...
      function ConnectFunction(props) {
        ...
        try {
          actualChildProps = useSyncExternalStore.useSyncExternalStore(subscribeForReact, actualChildPropsSelector, // TODO Need a real getServerSnapshot here
  ...
  var useSyncExternalStoreExtra_development = createCommonjsModule(function (module, exports) {
  ...
  function useSyncExternalStoreExtra(subscribe, getSnapshot, getServerSnapshot, selector, isEqual) {
    ...
    var value = useSyncExternalStore$1.useSyncExternalStore(subscribe, getSelection, getServerSelection);
    useEffect(function () {
      inst.hasValue = true;
      inst.value = value;
    }, [value]);
  ...
  var extra = createCommonjsModule(function (module) {

  {
    module.exports = useSyncExternalStoreExtra_development;
  }
  });
  ...
  function createSelectorHook(context = ReactReduxContext) {
    ...
    return function useSelector(selector, equalityFn = refEquality) {
      ...
      const selectedState = extra.useSyncExternalStoreExtra(store.subscribe, store.getState, // TODO Need a server-side snapshot here
