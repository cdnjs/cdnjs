...
var ObservableList = EventEmitter.extend({
	...
	/**
	 * @typesign (items: Array|cellx.ObservableList) -> cellx.ObservableList;
	 */
	...
	/**
	 * @typesign (index: int, items: Array|cellx.ObservableList) -> cellx.ObservableList;
	 */
	...
	/**
	 * @typesign (items: Array|cellx.ObservableList, fromIndex?: int) -> boolean;
	 */
