/*Type definitions for Survey JavaScript library v1.8.30
...
export declare class AdaptiveElement extends Base {
        ...
        constructor();
        get hasItems(): boolean;
        get items(): Array<AdaptiveActionBarItemWrapper>;
        set items(value: Array<AdaptiveActionBarItemWrapper>);
        get invisibleItems(): AdaptiveActionBarItemWrapper[];
        set invisibleItems(value: Array<AdaptiveActionBarItemWrapper>);
