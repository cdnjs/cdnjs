/*Type definitions for Survey JavaScript library v1.8.38
...
export declare class ReactSurveyModel extends SurveyModel {
    ...
    start(): boolean;
    wrapQuestion(element: JSX.Element, question: Question): JSX.Element;
}
...
export declare class QuestionRow extends QuestionRowModel {
    ...
    get survey(): import("survey-core").ISurvey;
