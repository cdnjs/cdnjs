/*Type definitions for Survey JavaScript library v1.8.44
...
export declare class Base {
        ...
        addUsedLocales(locales: Array<string>): void;
        findText(text: string, founded: Array<IFindElement>): void;
        protected getAllLocalizedStrings(arr: Array<LocalizableString>): void;
...
export declare class SurveyModel extends Base implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ISurveyErrorOwner, ILocalizableOwner {
        ...
        findText(text: string): Array<IFindElement>;
        /**
