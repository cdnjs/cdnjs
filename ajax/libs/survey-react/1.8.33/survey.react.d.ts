/*Type definitions for Survey JavaScript library v1.8.33
...
import { MatrixDropdownRowModelBase, QuestionMatrixDropdownModelBase, QuestionMatrixDropdownRenderedRow, QuestionMatrixDropdownRenderedCell } from "survey-core";
...
export declare class ActionBar extends SurveyElementBase<IActionBarProps, any> {
...
export interface ISurvey extends ITextProcessor, ISurveyErrorOwner {
        ...
        getUpdatedPageTitleActions(question: IPage, titleActions: Array<any>): Array<any>;
...
export declare class ActionBarItem extends SurveyElementBase<IActionBarItemProps, any> {
...
export declare class ActionBarSeparator extends React.Component<any, any> {
    constructor(props: any);
    render(): JSX.Element;
}
