/*Type definitions for Survey JavaScript library v1.8.58
...
export declare class SurveyQuestionRanking extends SurveyQuestionElementBase {
    ...
    protected renderItem(item: ItemValue, i: number, handleKeydown: (event: any) => void, cssClasses: any, itemClass: string): JSX.Element;
}
