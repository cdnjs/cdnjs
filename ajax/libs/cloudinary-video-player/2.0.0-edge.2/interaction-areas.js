...
const getInteractionAreaItem = (_ref, item, index, durationTime, onClick) => {
  ...
  return (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.elementsCreator)({
    tag: 'div',
    attr: {
      class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-item theme-").concat(theme),
    ...
    children: [{
      tag: 'div',
      attr: {
        class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-area-marker")
      },
      children: [{
        tag: 'div',
        attr: {
          class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-marker-shadow")
        },
        style: {
        ...
        tag: 'div',
        attr: {
          class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-marker-main")
        },
        style: {
...
const createInteractionAreaLayoutMessage = function (videojs, onClick) {
  ...
  const tracksContainer = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.elementsCreator)({
    tag: 'div',
    attr: {
      class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_CONTAINER_CLASS_NAME, " ").concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-message ").concat(showItAgainCheckbox ? '' : 'clickable')
    },
    onClick: !showItAgainCheckbox ? () => onClickInteractionAreaLayoutClick(checked, onClick) : null,
    children: [{
      tag: 'img',
      attr: {
        class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-icon"),
        src: _interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREA_HAND_ICON
      }
    }, {
      tag: 'h3',
      attr: {
        class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-message-title")
      },
      ...
      tag: 'div',
      attr: {
        class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-message-do-not-show")
      },
      children: [{
        tag: 'input',
        attr: {
          type: 'checkbox',
          class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-message-checkbox"),
          id
        },
        event: {
          name: 'input',
        ...
        tag: 'label',
        attr: {
          class: "".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_PREFIX, "-layout-message-checkbox-title"),
          for: id
        },
...
const getInteractionAreasContainer = videojs => videojs.el().querySelector(".".concat(_interaction_areas_const__WEBPACK_IMPORTED_MODULE_2__.INTERACTION_AREAS_CONTAINER_CLASS_NAME));
