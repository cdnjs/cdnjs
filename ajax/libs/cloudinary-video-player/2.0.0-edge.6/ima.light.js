  ...
  for (var macroName in macros) {
    ...
    if (resolvedMacroName.startsWith('r:')) {
      try {
        ...
        player.ads.error({
          errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).AdsMacroReplacementFailed,
          macro: macroName,
          error: error
        });
  ...
  var tryToResume = function tryToResume() {
    ...
    if (attempts--) {
      ...
      try {
        ...
        player.ads.error({
          errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).AdsResumeContentFailed,
          error: e
        });
...
var Preroll = /*#__PURE__*/function (_AdState) {
  ...
  _proto.onAdsError = function onAdsError(player) {
    ...
    player.ads.error({
      errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).AdsPrerollError
    });
...
var BeforePreroll = /*#__PURE__*/function (_ContentState) {
  ...
  _proto.onAdsError = function onAdsError() {
    ...
    this.player.ads.error({
      errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).BeforePrerollError
    });
    this.shouldResumeToContent = true;
  }
...
var Midroll = /*#__PURE__*/function (_AdState) {
  ...
  _proto.onAdsError = function onAdsError(player) {
    player.ads.error({
      errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).AdsMidrollError
    });
...
var Postroll = /*#__PURE__*/function (_AdState) {
  ...
  _proto.onAdsError = function onAdsError(player) {
    ...
    player.ads.error({
      errorType: (video_js__WEBPACK_IMPORTED_MODULE_0___default().Error).AdsPostrollError
    });
