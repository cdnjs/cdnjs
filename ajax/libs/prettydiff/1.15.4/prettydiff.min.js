...
builder.scriptEnd="]]></script>";return[builder.head+builder.cssCore+builder.cssColor+builder.cssExtra+builder.body+builder.bodyColor+builder.title+auto+proctime()+a[0]+builder.accessibility+a[1][0]+builder.scriptOpen+builder.scriptBody+builder.scriptEnd+"</body></html>",""]}if(options.mode==="diff"){return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent character differ"+"ences per lines compared.</p>"]}return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent presentation for"+" variable coloring and scope.</p>"]}()}};return core(api)};global.report="";global.edition={addon:{ace:150918},api:{dom:151029,nodeLocal:151029,wsh:151029},css:151031,csspretty:151029,csvpretty:151029,diffview:151029,documentation:151029,jspretty:151031,latest:0,markuppretty:151031,prettydiff:151029,safeSort:151003,version:"1.15.3",webtool:151029};global.edition.latest=function edition_latest(){"use strict";return Math.max(global.edition.css,global.edition.csspretty,global.edition.csvpretty,global.edition.diffview,global.edition.documentation,global.edition.jspretty,global.edition.markuppretty,global.edition.prettydiff,global.edition.webtool,global.edition.api.dom,global.edition.api.nodeLocal,global.edition.api.wsh)}();if(typeof exports==="object"||typeof exports==="function"){exports.report=global.report;exports.edition=global.edition;exports.api=function commonjs(x){"use strict";return prettydiff(x)}}else if((typeof define==="object"||typeof define==="function")&&(ace===undefined||ace.createEditSession===undefined)){define(function requirejs(require,exports){"use strict";exports.global=global;exports.api=function requirejs_export(x){return prettydiff(x)};if(typeof require==="number"){return require}return exports.api})}