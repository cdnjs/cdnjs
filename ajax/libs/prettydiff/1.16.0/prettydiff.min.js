...
builder.scriptEnd="]]></script>";return[builder.head+builder.cssCore+builder.cssColor+builder.cssExtra+builder.body+builder.bodyColor+builder.title+auto+proctime()+a[0]+builder.accessibility+a[1][0]+builder.scriptOpen+builder.scriptBody+builder.scriptEnd+"</body></html>",""]}if(options.mode==="diff"){return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent character differ"+"ences per lines compared.</p>"]}return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent presentation for"+" variable coloring and scope.</p>"]}()}};return core(api)};global.report="";global.edition={addon:{ace:150918},api:{dom:151130,nodeLocal:151130,wsh:151130},css:151109,csspretty:151130,csvpretty:151130,diffview:151130,documentation:151130,jspretty:151130,latest:0,markuppretty:151130,prettydiff:151130,safeSort:151130,version:"1.16.0",webtool:151130};global.edition.latest=function edition_latest(){"use strict";return Math.max(global.edition.css,global.edition.csspretty,global.edition.csvpretty,global.edition.diffview,global.edition.documentation,global.edition.jspretty,global.edition.markuppretty,global.edition.prettydiff,global.edition.webtool,global.edition.api.dom,global.edition.api.nodeLocal,global.edition.api.wsh)}();if(typeof exports==="object"||typeof exports==="function"){exports.report=global.report;exports.edition=global.edition;exports.api=function commonjs(x){"use strict";return prettydiff(x)}}else if((typeof define==="object"||typeof define==="function")&&(ace===undefined||ace.createEditSession===undefined)){define(function requirejs(require,exports){"use strict";exports.report=global.report;exports.edition=global.edition;exports.api=function requirejs_export(x){return prettydiff(x)};if(typeof require==="number"){return require}return exports.api})}
