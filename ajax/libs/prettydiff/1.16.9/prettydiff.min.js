...
builder.scriptEnd="]]></script>";return[builder.head+builder.cssCore+builder.cssColor+builder.cssExtra+builder.body+builder.bodyColor+builder.title+autostring+proctime()+a[0]+builder.accessibility+a[1][0]+builder.scriptOpen+builder.scriptBody+builder.scriptEnd+"</body></html>",""]}if(options.mode==="diff"){return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent character differ"+"ences per lines compared.</p>"]}return[a[1][0],autostring+proctime()+a[0]+" <p>Accessibility note. &lt;em&gt; tags in the output represent presentation for"+" variable coloring and scope.</p>"]}()}};return core(api)};global.report="";global.edition={addon:{ace:150918},api:{dom:160114,nodeLocal:160114,wsh:160101},css:151109,csspretty:151220,csvpretty:151130,diffview:160101,documentation:160114,jspretty:160114,latest:0,lint:160114,markuppretty:160114,prettydiff:160114,safeSort:151130,version:"1.16.9",webtool:151220};global.edition.latest=function edition_latest(){"use strict";return Math.max(global.edition.css,global.edition.csspretty,global.edition.csvpretty,global.edition.diffview,global.edition.documentation,global.edition.jspretty,global.edition.markuppretty,global.edition.prettydiff,global.edition.webtool,global.edition.api.dom,global.edition.api.nodeLocal,global.edition.api.wsh)}();if(typeof exports==="object"||typeof exports==="function"){exports.report=global.report;exports.edition=global.edition;exports.api=function commonjs(x){"use strict";return prettydiff(x)}}else if((typeof define==="object"||typeof define==="function")&&(ace===undefined||ace.createEditSession===undefined)){define(function requirejs(require,exports){"use strict";exports.report=global.report;exports.edition=global.edition;exports.api=function requirejs_export(x){return prettydiff(x)};if(typeof require==="number"){return require}return exports.api})}
