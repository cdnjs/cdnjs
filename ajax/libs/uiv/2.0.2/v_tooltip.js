...
function W(t, e, i, s, h, a, d) {
  ...
  let y;
  if (V(d) ? y = document.querySelector(d) : M(d) && (y = d(e)), O(y)) {
    const l = S ? 11 : 0, C = y.getBoundingClientRect(), p = o + C.top, I = c + C.left, $ = p + C.height, N = I + C.width;
...
const R = "in", X = {
  ...
  render() {
    ...
    return v(t, null, {
      default: () => {
        var e, i;
        return [(i = (e = this.$slots).default) == null ? void 0 : i.call(e), v("div", {
          ref: "popup",
          role: "tooltip",
