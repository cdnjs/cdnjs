import { openBlock, createElementBlock, normalizeClass, renderSlot, resolveComponent, createBlock, withCtx, createElementVNode, withModifiers, createCommentVNode, createTextVNode, toDisplayString, createVNode, createSlots, withDirectives, withKeys, vModelDynamic, vShow, Fragment, h, render as render$4 } from 'vue';
...
script$3.__file = "src/components/button/BtnGroup.vue";

var INPUT_TYPE_CHECKBOX = 'checkbox';
var INPUT_TYPE_RADIO = 'radio';

var script$2 = {
  components: { BtnGroup: script$3 },
  mixins: [linkMixin],
  props: {
    justified: {
      type: Boolean,
...
var _hoisted_1$2 = ["href", "target"];
var _hoisted_2$2 = ["type", "checked", "disabled"];
var _hoisted_3$2 = ["type", "disabled"];
var _hoisted_4$2 = ["type", "disabled"];
...
script$2.__file = "src/components/button/Btn.vue";
...
var _hoisted_3$1 = /*#__PURE__*/createElementVNode("span", { "aria-hidden": "true" }, "×", -1 /* HOISTED */);
var _hoisted_4$1 = { class: "modal-title" };
        ...
        ($props.header)
          ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
              renderSlot(_ctx.$slots, "header", {}, function () { return [
                ...
                createElementVNode("h4", _hoisted_4$1, [
...
var script = {
  components: { Modal: script$1, Btn: script$2 },
  mixins: [Local],
  props: {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_modal, {
    ...
    "onUpdate:modelValue": _cache[8] || (_cache[8] = function ($event) { return (($data.show) = $event); }),
    "auto-focus": "",
    size: $props.size,
    title: $props.title,
    header: !!$props.title,
    ...
    default: withCtx(function () { return [
      ($props.html)
        ...
        : (openBlock(), createElementBlock("p", _hoisted_2, toDisplayString($props.content), 1 /* TEXT */)),
      ($props.type === $data.TYPES.PROMPT)
        ? (openBlock(), createElementBlock("div", _hoisted_3, [
            createElementVNode("div", {
              ...
              withDirectives(createElementVNode("input", {
                ref: "input",
                "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) { return (($data.input) = $event); }),
                type: $props.inputType,
                class: "form-control",
                required: "",
                "data-action": "auto-focus",
                onChange: _cache[1] || (_cache[1] = function ($event) { return ($data.dirty = true); }),
                onKeyup: _cache[2] || (_cache[2] = withKeys(function () {
                  var args = [], len = arguments.length;
                  while ( len-- ) args[ len ] = arguments[ len ];

                  return ($options.validate && $options.validate.apply($options, args));
      }, ["enter"]))
              }, null, 40 /* PROPS, HYDRATE_EVENTS */, _hoisted_4), [
                [vModelDynamic, $data.input]
              ]),
              withDirectives(createElementVNode("span", { class: "help-block" }, toDisplayString($options.inputError), 513 /* TEXT, NEED_PATCH */), [
      ...
      ? {
          ...
          fn: withCtx(function () { return [
            createVNode(_component_btn, {
              ...
              onClick: _cache[3] || (_cache[3] = function ($event) { return ($options.toggle(false, 'ok')); }),
              textContent: toDisplayString($options.okBtnText)
            }, null, 8 /* PROPS */, ["type", "data-action", "textContent"])
          ]; })
        }
      : {
          name: "footer",
          fn: withCtx(function () { return [
            ($props.reverseButtons)
              ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ($props.type === $data.TYPES.CONFIRM)
                    ? (openBlock(), createBlock(_component_btn, {
                        key: 0,
                        type: $props.okType,
                        "data-action": $props.autoFocus === 'ok' ? 'auto-focus' : '',
                        onClick: _cache[4] || (_cache[4] = function ($event) { return ($options.toggle(false, 'ok')); }),
                        textContent: toDisplayString($options.okBtnText)
                      }, null, 8 /* PROPS */, ["type", "data-action", "textContent"]))
                    : (openBlock(), createBlock(_component_btn, {
                        key: 1,
                        ...
                        textContent: toDisplayString($options.okBtnText)
                      }, null, 8 /* PROPS */, ["type", "onClick", "textContent"])),
                  createVNode(_component_btn, {
                    type: $props.cancelType,
                    "data-action": $props.autoFocus === 'cancel' ? 'auto-focus' : '',
                    onClick: _cache[5] || (_cache[5] = function ($event) { return ($options.toggle(false, 'cancel')); }),
              ...
              : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                  createVNode(_component_btn, {
                    type: $props.cancelType,
                    "data-action": $props.autoFocus === 'cancel' ? 'auto-focus' : '',
                    onClick: _cache[6] || (_cache[6] = function ($event) { return ($options.toggle(false, 'cancel')); }),
                    textContent: toDisplayString($options.cancelBtnText)
                  }, null, 8 /* PROPS */, ["type", "data-action", "textContent"]),
                  ($props.type === $data.TYPES.CONFIRM)
                    ? (openBlock(), createBlock(_component_btn, {
                        ...
                        type: $props.okType,
                        "data-action": $props.autoFocus === 'ok' ? 'auto-focus' : '',
                        onClick: _cache[7] || (_cache[7] = function ($event) { return ($options.toggle(false, 'ok')); }),
                        textContent: toDisplayString($options.okBtnText)
                      }, null, 8 /* PROPS */, ["type", "data-action", "textContent"]))
                    : (openBlock(), createBlock(_component_btn, {
                        key: 1,
  ...
  ]), 1032 /* PROPS, DYNAMIC_SLOTS */, ["modelValue", "size", "title", "header", "backdrop", "cancel-text", "ok-text", "class", "onHide"]))
}

script.render = render;
script.__file = "src/components/messagebox/MessageBox.vue";

var destroy = function (container) {
  // console.log('destroyModal')
  render$4(null, container);
};
...
var init = function (type, options, cb, resolve, reject) {
  ...
  var vNode = h(script, Object.assign({}, {type: type},
    options,
