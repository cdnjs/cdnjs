import { openBlock as u, createElementBlock as f, normalizeClass as c, renderSlot as r, computed as I, unref as p, createBlock as V, resolveDynamicComponent as L, withCtx as k, createElementVNode as d, withModifiers as P, resolveComponent as D, createCommentVNode as v, createTextVNode as _, toDisplayString as S, createVNode as N } from "vue";
function A(e) {
...
const W = function(e, o) {
  ...
  let t;
  try {
    if (t = F.apply(this, arguments), A(t) && !o.$$locale)
      return t;
  } catch {
  }
  const n = e.split(".");
...
const oe = (e, o) => {
  ...
  methods: {
    ...
    hideModal(e) {
      const o = R(this.beforeClose) ? this.beforeClose(e) : !0;
  ...
  key: 0,
  class: "modal-header"
}, ie = /* @__PURE__ */ d("span", { "aria-hidden": "true" }, "×", -1), ae = [
  ie
...
function ce(e, o, t, n, i, l) {
  ...
  return u(), f("div", {
    ...
    onClick: o[3] || (o[3] = P((...s) => l.backdropClicked && l.backdropClicked(...s), ["self"]))
  }, [
    d("div", {
      ref: "dialog",
        ...
        t.footer ? (u(), f("div", re, [
          r(e.$slots, "footer", {}, () => [
            N(a, {
              ...
              default: k(() => [
                d("span", null, S(t.cancelText || l.t("uiv.modal.cancel")), 1)
              ]),
              _: 1
            }, 8, ["type"]),
            N(a, {
              ...
              default: k(() => [
                d("span", null, S(t.okText || l.t("uiv.modal.ok")), 1)
              ]),
              _: 1
            }, 8, ["type"])
          ])
