      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.indicators ? renderSlot(_ctx.$slots, "indicators", {
          ...
          createElementVNode("ol", _hoisted_1$k, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(slides, (slide, index) => {
...
const _sfc_main$u = {
  ...
  setup(__props, { expose }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["item", slideClass])
      }, [
        renderSlot(_ctx.$slots, "default")
      ], 2);
    };
        ...
        __props.todayBtn || __props.clearBtn ? (openBlock(), createElementBlock("div", _hoisted_1$d, [
          ...
          createElementVNode("div", _hoisted_3$6, [
            __props.todayBtn ? (openBlock(), createBlock(_sfc_main$q, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(unref(t)("uiv.datePicker.today")), 1)
              ]),
              _: 1
            })) : createCommentVNode("", true),
            __props.clearBtn ? (openBlock(), createBlock(_sfc_main$q, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(unref(t)("uiv.datePicker.clear")), 1)
              ]),
              _: 1
            })) : createCommentVNode("", true)
          ])
        ...
        createElementVNode("tr", null, [
          ...
          $props.showMeridian ? (openBlock(), createElementBlock("td", _hoisted_9$1, [
            ...
            createVNode(_component_btn, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString($data.meridian ? $options.t("uiv.timePicker.am") : $options.t("uiv.timePicker.pm")), 1)
              ]),
              _: 1
            }, 8, ["disabled", "onClick"])
          ])) : createCommentVNode("", true)
        ...
        __props.type === unref(TYPES$1).ALERT ? {
          ...
          fn: withCtx(() => [
            createVNode(_sfc_main$q, {
              ...
              default: withCtx(() => [
                createTextVNode(toDisplayString(unref(okBtnText)), 1)
              ]),
              _: 1
            }, 8, ["type", "data-action"])
          ])
          ...
          fn: withCtx(() => [
            __props.reverseButtons ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              __props.type === unref(TYPES$1).CONFIRM ? (openBlock(), createBlock(_sfc_main$q, {
                ...
                _: 1
              }, 8, ["type", "data-action"])) : (openBlock(), createBlock(_sfc_main$q, {
                key: 1,
                type: __props.okType,
                onClick: validate
              }, {
              ...
              createVNode(_sfc_main$q, {
                ...
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(cancelBtnText)), 1)
                ]),
                _: 1
              }, 8, ["type", "data-action"])
