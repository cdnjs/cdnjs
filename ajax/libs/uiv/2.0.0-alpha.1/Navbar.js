import { createVNode, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, renderSlot, withCtx } from "vue";
...
const _sfc_main = {
  components: { Collapse: _sfc_main$1 },
  props: {
    modelValue: Boolean,
    fluid: {
      type: Boolean,
