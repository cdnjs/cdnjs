								...
								// appearance: a, p, p
									...
									// display: d, i, s
											...
											if ((indexOf = buff.indexOf('flex')) !== -1) {
												...
												// vendor prefix
												buff = 'display: ' + webkit + temp + 'box;' + 'display: ' + webkit + temp + 'flex;' + 'display: ' + ms + 'flexbox;' + 'display: ' + temp + 'flex' + (code === 125 ? '}' : ';');
											}
										}
																				...
																				for (var j = 0; j < length; j++) {
																					...
																					if (char === 38) {
																						...
																						if (char === 58 && selector.charCodeAt(2) === 103) {
																							selector = selector.substring(1).replace(stylis.regex.global[0], '$1').replace(stylis.regex.and, prefix);
																						} else {
  ...
  var ComponentStyle = function () {
    ...
    createClass(ComponentStyle, [{
      ...
      value: function generateAndInjectStyles(executionContext) {
        ...
        var hash = hashStr(this.componentId + flatCSS);
        if (!inserted[hash]) {
