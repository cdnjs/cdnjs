...
ThemeProvider.propTypes = {
  ...
  theme: React.PropTypes.oneOfType([React.PropTypes.func, React.PropTypes.object])
};
  ...
  var createStyledComponent = function createStyledComponent(target, rules, parent) {
    ...
    var StyledComponent = function (_ParentComponent) {
      ...
      function StyledComponent() {
        ...
        var _this2 = possibleConstructorReturn(this, (StyledComponent.__proto__ || Object.getPrototypeOf(StyledComponent)).call(this));
      ...
      createClass(StyledComponent, [{
        ...
        value: function render() {
          ...
          Object.keys(this.props).filter(function (propName) {
            return !isTag || validAttr(propName);
    ...
    StyledComponent.contextTypes = defineProperty({}, CHANNEL, React.PropTypes.func);
    return StyledComponent;
  };
