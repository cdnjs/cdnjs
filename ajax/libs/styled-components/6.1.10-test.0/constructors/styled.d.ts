...
declare const baseStyled: <Target extends WebTarget, ExtraProps extends object = BaseObject>(tag: Target) => StyledInstance<"web", Target, Target extends KnownTarget ? ComponentPropsWithRef<Target> & ExtraProps : ExtraProps, BaseObject>;
declare const styled: (<Target extends WebTarget, ExtraProps extends object = BaseObject>(tag: Target) => StyledInstance<"web", Target, Target extends KnownTarget ? ComponentPropsWithRef<Target> & ExtraProps : ExtraProps, BaseObject>) & {
 ...
 */
export type LibraryStyled<ExtraProps extends object = BaseObject> = <Target extends WebTarget>(tag: Target) => typeof baseStyled<Target, ExtraProps>;
