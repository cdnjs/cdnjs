...
export declare const resetStyled: (isServer?: boolean) => (<Target extends import("..").WebTarget, ExtraProps extends object = import("../types").BaseObject>(tag: Target) => import("../constructors/constructWithOptions").Styled<"web", Target, Target extends import("../types").KnownTarget ? import("react").ComponentPropsWithRef<Target> & ExtraProps : ExtraProps, import("../types").BaseObject>) & {
