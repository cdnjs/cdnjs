...
var index$1 = process && support(supportLevel);
...
var process$1 = function process$1(node) {
...
var DOMPropertyInjection = {
  ...
  injectDOMPropertyConfig: function injectDOMPropertyConfig(domPropertyConfig) {
    ...
    for (var propName in Properties) {
      !!DOMProperty$1.properties.hasOwnProperty(propName) ? invariant(false, 'injectDOMPropertyConfig(...): You\'re trying to inject DOM property \'%s\' which has already been injected. You may be accidentally injecting the same DOM property config twice, or you may be injecting two configs that have conflicting property names.', propName) : void 0;
...
var validAttr = (function (name) {
  return hasOwnProperty$1.call(HTMLDOMPropertyConfig_1.Properties, name) || hasOwnProperty$1.call(SVGDOMPropertyConfig_1.Properties, name) || HTMLDOMPropertyConfig_1.isCustomAttribute(name.toLowerCase()) || hasOwnProperty$1.call(reactProps, name);
});
