...
var flatten = function flatten(chunks, executionContext) {
  return chunks.reduce(function (ruleSet, chunk) {
    ...
    return ruleSet.concat(isPlainObject_1(chunk) ? objToCss(chunk) : chunk.toString());
  }, []);
};
...
var validAttr = (function (name) {
  return hasOwnProperty$1.call(htmlProps, name) || hasOwnProperty$1.call(svgProps, name) || isCustomAttribute(name.toLowerCase()) || hasOwnProperty$1.call(reactProps, name);
});
  ...
  createClass(ThemeProvider, [{
    ...
    value: function getTheme(passedTheme) {
      ...
      if (isFunction_1(theme)) {
        ...
        if (!isPlainObject_1(mergedTheme)) {
          throw new Error('[ThemeProvider] Please return an object from your theme function, i.e. theme={() => ({})}!');
        }
        return mergedTheme;
      }
      if (!isPlainObject_1(theme)) {
...
var index$4 = hyphenateStyleName$2;
...
var transition_1 = createCommonjsModule(function (module, exports) {
  ...
  var _hyphenateStyleName = index$4;
