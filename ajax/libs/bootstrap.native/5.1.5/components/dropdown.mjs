import { N as it, C as R, K as S, B as bt, t as Dt, j as at, m, Z as u, G as U, Q as Z, J as T, a as z, E as dt, r as ct, y as J, v as M, L as Ct, H as yt, _ as V, x as P, M as $t, P as xt, T as X, d as F, R as lt, k as Pt, S as At, o as Ht, U as St, V as _, X as N, Y as Tt } from "./base-component-MKkLYOoi.mjs";
import { P as _t } from "./index-CwctZXUT.mjs";
...
import { i as Nt } from "./isDisabled-C2t7TiGY.mjs";
const ut = "Dropdown", ft = "dropdown-menu", ht = (n) => {
  ...
  }, { offsetWidth: w, offsetHeight: C } = e, { clientWidth: B, clientHeight: W } = $t(t), {
    left: E,
    top: y,
    width: k,
    height: wt
  } = xt(t), $ = E - w - o < 0, x = E + w + k + o >= B, Et = y + C + o >= W, G = y + C + wt + o >= W, K = y - C - o < 0, v = (!r && a || r && !a) && E + k - w < 0, b = (r && a || !r && !a) && E + w >= B;
  if (q.includes(d) && $ && x && (d = p), d === I && (r ? x : $) && (d = L), d === L && (r ? $ : x) && (d = I), d === j && K && !G && (d = p), d === p && G && !K && (d = j), q.includes(d) && Et && X(g[d], {
    top: "auto",
    bottom: 0
  }), Y.includes(d) && (v || b)) {
  ...
  }), Y.includes(d) && a && a && P(e, g[!r && v || r && b ? "menuStart" : "menuEnd"]), u(i, mt);
  ...
  s(o, M, rt), s(o, lt, rt), s(o, Pt, Bt), s(o, At, Wt), e.display === "dynamic" && (n.open ? n._observer.observe(i) : n._observer.disconnect());
}, O = (n) => {
