import { N as it, C as R, K as S, B as bt, t as Dt, j as at, m, Z as u, G as U, Q as Z, J as T, a as z, E as dt, r as ct, y as J, v as M, L as Ct, H as yt, _ as V, x as A, M as $t, P as xt, T as X, d as F, R as lt, k as At, S as Ht, o as Pt, U as St, V as _, X as N, Y as Tt } from "./base-component-BqNxSX4W.mjs";
...
import { i as Nt } from "./isDisabled-CYinJ77M.mjs";
const ut = "Dropdown", ft = "dropdown-menu", ht = (n) => {
  ...
  s(o, M, rt), s(o, lt, rt), s(o, At, Ot), s(o, Ht, Wt), e.display === "dynamic" && (n.open ? n._observer.observe(i) : n._observer.disconnect());
}, B = (n) => {
...
class kt extends bt {
  ...
  show() {
    ...
    ), u(s, H), !H.defaultPrevented && (U(i, f), U(s, f), Z(t, J, "true"), ot(this), this.open = !e, T(t), st(this), u(s, et));
  }
  hide() {
    const { element: t, open: e, menu: i, parentElement: s } = this;
    e && ([P, nt].forEach((o) => {
      o.relatedTarget = t;
    }), u(s, P), !P.defaultPrevented && (z(i, f), z(s, f), Z(t, J, "false"), this.open = !e, st(this), u(s, nt)));
  }
  _toggleEventListeners = (t) => {
    (t ? dt : ct)(this.element, M, Bt);
  };
  dispose() {
