...
},{"angular":3}],2:[function(_dereq_,module,exports){
/**
...
function $CompileProvider($provide, $$sanitizeUriProvider) {
  ...
  this.$get = [
    ...
    function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn,
      ...
      function getControllers(directiveName, _dereq_, $element, elementControllers) {
        var value, retrievalMethod = 'data', optional = false;
        var $searchElement = $element;
        var match;
        if (isString(_dereq_)) {
          match = _dereq_.match(REQUIRE_PREFIX_REGEXP);
          _dereq_ = _dereq_.substring(match[0].length);
          ...
          if (elementControllers && retrievalMethod === 'data') {
            if (value = elementControllers[_dereq_]) {
              value = value.instance;
            }
          }
          value = value || $searchElement[retrievalMethod]('$' + _dereq_ + 'Controller');

          if (!value && !optional) {
            throw $compileMinErr('ctreq',
                "Controller '{0}', required by directive '{1}', can't be found!",
                _dereq_, directiveName);
          }
          return value || null;
        } else if (isArray(_dereq_)) {
          value = [];
          forEach(_dereq_, function(_dereq_) {
            value.push(getControllers(directiveName, _dereq_, $element, elementControllers));
          });
        }
        return value;
      }
...
},{"dot-prop":5,"xtend/mutable":6}],5:[function(_dereq_,module,exports){
'use strict';
...
},{"./service":8}],8:[function(_dereq_,module,exports){
'use strict'
...
},{"stripe-as-promised":4}],9:[function(_dereq_,module,exports){
'use strict'
...
},{"./provider":7,"angular-assert-q-constructor":1}]},{},[9])(9)
});