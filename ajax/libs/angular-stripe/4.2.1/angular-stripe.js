...
var asyncMethods = ['card.createToken', 'bankAccount.createToken', 'bitcoinReceiver.createReceiver', 'bitcoinReceiver.pollReceiver'];
...
exports['default'] = function (Stripe, Promise) {
  ...
  asyncMethods.forEach(function (method) {
    ...
    var _method$split2 = _slicedToArray(_method$split, 1);

    var context = _method$split2[0];

    var fn = _deep2['default'].get(Stripe, method);
    _deep2['default'].set(stripe, method, promisify(Promise, fn, context, stripeResponseHandler));
  });
