!(function (n, e) {
  ...
  return [
    ...
    { name: 'Acorn', hex: '#7f5e50' },
    { name: 'Acoustic Brown', hex: '#766b69' },
    ...
    { name: 'After the Storm', hex: '#33616a' },
    { name: 'Afternoon Coffee', hex: '#6e544b' },
    ...
    { name: 'Anise Biscotti', hex: '#e5d5ae' },
    ...
    { name: 'Antique Port Wine', hex: '#98211a' },
    ...
    { name: 'Arctic Ice', hex: '#b6bdd0' },
    { name: 'Arctic Water', hex: '#00fcfc' },
    { name: 'Argan Oil', hex: '#9d6646' },
    ...
    { name: 'Ballet Slippers', hex: '#fca2ad' },
    { name: 'Balsamico', hex: '#130d07' },
    { name: 'Baltic', hex: '#279d9f' },
    { name: 'Baltic Amber', hex: '#fbb782' },
    ...
    { name: 'Bancha', hex: '#666a47' },
    { name: 'Bane of Royalty', hex: '#871466' },
    ...
    { name: 'Beaches of Cancun', hex: '#fbedd7' },
    ...
    { name: 'Beefy Pink', hex: '#debeef' },
    { name: 'Beekeeper', hex: '#f6e491' },
    { name: 'Beer', hex: '#fcaa12' },
    { name: 'Beeswax', hex: '#e9d7ab' },
    { name: 'Beet Red', hex: '#7e203f' },
    { name: 'Beetroot Purple', hex: '#d33376' },
    { name: 'Begonia', hex: '#fa6e79' },
    { name: 'Beige', hex: '#e6daa6' },
    { name: 'Beige and Sage', hex: '#bbc199' },
    ...
    { name: 'Berry Blast', hex: '#ff017f' },
    { name: 'Berry Butter', hex: '#efcedc' },
    { name: 'Berry Good', hex: '#edc3c5' },
    ...
    { name: 'Black Sea Night', hex: '#052462' },
    { name: 'Black Sheep', hex: '#0f0d0d' },
    { name: 'Black Stallion', hex: '#0e191c' },
    { name: 'Black Truffle', hex: '#463d3e' },
    { name: 'Black Turmeric', hex: '#2c4364' },
    { name: 'Black Velvet', hex: '#222233' },
    { name: 'Black Wash', hex: '#0c0c0c' },
    { name: 'Black-Hearted', hex: '#3e1825' },
    ...
    { name: 'Blissful Serenity', hex: '#eaeed8' },
    ...
    { name: 'Bountiful Gold', hex: '#e4c36c' },
    ...
    { name: 'Breath of Celery', hex: '#dce7cb' },
    ...
    { name: 'Brick by Brick', hex: '#b22122' },
    { name: 'Brick Red', hex: '#8f1402' },
    { name: 'Bricky Brick', hex: '#b33a22' },
    { name: 'Bridal Scent', hex: '#e5d3cc' },
    ...
    { name: 'Buckingham Gardens', hex: '#89a068' },
    ...
    { name: 'Buttercup Glow', hex: '#f1f458' },
    { name: 'Buttered Popcorn', hex: '#fff0a4' },
    { name: 'Buttered Up', hex: '#f7f0d2' },
    { name: 'Butterfly Kisses', hex: '#f0dedc' },
    ...
    { name: 'Camellia', hex: '#f6685a' },
    { name: 'Cameo', hex: '#f2debc' },
    { name: 'Camo Clay', hex: '#747f71' },
    { name: 'Campanula', hex: '#3473b7' },
    ...
    { name: 'Caramel Drizzle', hex: '#d9ad7f' },
    ...
    { name: 'Celestial', hex: '#007894' },
    { name: 'Celestial Cathedral', hex: '#daeaf6' },
    { name: 'Celestial Crown', hex: '#ead97c' },
    ...
    { name: 'Chef’s Kiss', hex: '#cc3b3b' },
    { name: 'Cherry', hex: '#cf0234' },
    { name: 'Cherry Berry', hex: '#9f4d65' },
    { name: 'Cherry Blossom', hex: '#f5c1d5' },
    ...
    { name: 'Chickery Chick', hex: '#fbe98e' },
    { name: 'Child of the Night', hex: '#220077' },
    { name: 'Chili Con Carne', hex: '#985e2b' },
    { name: 'Chili Crab', hex: '#e93a0e' },
    { name: 'Chili Pepper', hex: '#ac1e3a' },
    { name: 'Chill of the Night', hex: '#256d8d' },
    ...
    { name: 'Chocolate Truffle', hex: '#612e32' },
    ...
    { name: 'Cinnamon Sparkle', hex: '#9c5736' },
    { name: 'Cinnapink', hex: '#a6646f' },
    { name: 'Citadel', hex: '#6a7f8b' },
    ...
    { name: 'Cold Brew Coffee', hex: '#785736' },
    ...
    { name: 'Cotton Candy Comet', hex: '#ffc3cb' },
    { name: 'Cotton Candy Explosions', hex: '#dd22ff' },
    { name: 'Cotton Field', hex: '#f2f0e8' },
    { name: 'Couch', hex: '#4e2a20' },
    { name: 'Count Chocula', hex: '#5e2d10' },
    ...
    { name: 'Crashing Waves', hex: '#3e6f87' },
    ...
    { name: 'Creamy Vanilla', hex: '#f2e5bf' },
    { name: 'Crème Brûlée', hex: '#ffe39b' },
    { name: 'Crème de la Crème', hex: '#f3e7b4' },
    { name: 'Crème de Pêche', hex: '#fdf5e0' },
    { name: 'Crème Fraîche', hex: '#eceee6' },
    { name: 'Creole', hex: '#393227' },
    { name: 'Crepe', hex: '#d4bc94' },
    { name: 'Crepuscular', hex: '#e7dcce' },
    { name: 'Crimson Blaze', hex: '#ad3d1e' },
    { name: 'Crimson Boy', hex: '#b44933' },
    { name: 'Crimson Cloud', hex: '#c32f40' },
    { name: 'Crimson Glow', hex: '#c13939' },
    { name: 'Crimson Velvet Sunset', hex: '#b52604' },
    { name: 'Crisps', hex: '#e2bd67' },
    { name: 'Crispy Crunch', hex: '#7a8f68' },
    { name: 'Croissant', hex: '#c4ab86' },
    { name: 'Crow', hex: '#180614' },
    { name: 'Crown Jewel', hex: '#4f325e' },
    ...
    { name: 'Deep Lagoon', hex: '#005a6f' },
    { name: 'Deep Night', hex: '#494c55' },
    { name: 'Deep Pond', hex: '#014420' },
    { name: 'Deep Pool Teal', hex: '#366d68' },
    ...
    { name: 'Depths of Night', hex: '#2c319b' },
    ...
    { name: 'Drifting Cloud', hex: '#dbe0e1' },
    ...
    { name: 'Emerald Bliss', hex: '#4cbdac' },
    { name: 'Emerald Forest', hex: '#224347' },
    { name: 'Emerald Glitter', hex: '#66bb00' },
    { name: 'Emerald Ice Palace', hex: '#2af589' },
    { name: 'Emerald Oasis', hex: '#67a195' },
    { name: 'Emerald Rain', hex: '#80c872' },
    { name: 'Emerald Whispers', hex: '#2b8478' },
    ...
    { name: 'Enchanted Emerald', hex: '#7ed89a' },
    { name: 'Enchanted Forest', hex: '#5c821a' },
    { name: 'Enchanted Glen', hex: '#166d29' },
    { name: 'Enchanted Lavender', hex: '#bfa3d9' },
    { name: 'Enchanted Lilac', hex: '#a893c1' },
    { name: 'Enchanting Ivy', hex: '#315955' },
    { name: 'End of Summer', hex: '#cc8f15' },
    { name: 'Endive', hex: '#cee1c8' },
    { name: 'Endless Galaxy', hex: '#000044' },
    { name: 'Endless Horizon', hex: '#b1dbf5' },
    ...
    { name: 'Ether', hex: '#98b2b4' },
    { name: 'Ethereal Espresso', hex: '#3e2723' },
    { name: 'Ethereal Mist', hex: '#b0b8cc' },
    { name: 'Ethereal Moonlight', hex: '#d5e4ec' },
    ...
    { name: 'Exhilarating Green', hex: '#81c784' },
    ...
    { name: 'Extreme Carrot', hex: '#ff7133' },
    ...
    { name: 'Fairy Floss', hex: '#ebc9c6' },
    { name: 'Fairy Tale', hex: '#efb4ca' },
    ...
    { name: 'Fondant', hex: '#f4e2cf' },
    { name: 'Fondue', hex: '#fdf5c4' },
    { name: 'Fool’s Gold', hex: '#cad175' },
    { name: 'Forbidden Fruit', hex: '#fe7b7c' },
    { name: 'Forbidden Peanut', hex: '#a38052' },
    ...
    { name: 'Formosan Green', hex: '#a69a51' },
    ...
    { name: 'Freshly Baked', hex: '#e9c180' },
    { name: 'Freshly Purpleized', hex: '#5c5083' },
    ...
    { name: 'Frosted Fir', hex: '#b4d5bd' },
    { name: 'Frosted Mint Hills', hex: '#ccffc2' },
    { name: 'Frosty Pink', hex: '#dfe9e3' },
    ...
    { name: 'Future Fuchsia', hex: '#ff2040' },
    ...
    { name: 'Galactic Gossamer', hex: '#7f8cb8' },
    { name: 'Galactic Grapevine', hex: '#6b327b' },
    { name: 'Galactic Highway', hex: '#3311bb' },
    { name: 'Galactic Purple', hex: '#472e97' },
    { name: 'Galaxea', hex: '#2e305e' },
    { name: 'Galaxy Blue', hex: '#2d5284' },
    ...
    { name: 'Garden of Eden', hex: '#7fa771' },
    ...
    { name: 'Go to Hell Black', hex: '#342c21' },
    ...
    { name: 'Golden Mean', hex: '#c49b35' },
    { name: 'Golden Mist', hex: '#d4c990' },
    { name: 'Golden Nugget', hex: '#d78e48' },
    ...
    { name: 'Green Commando', hex: '#828039' },
    ...
    { name: 'H₂O', hex: '#bfe1e6' },
    { name: 'Habañero', hex: '#f98513' },
    { name: 'Habañero Gold', hex: '#fecf3c' },
    ...
    { name: 'Herbal Whispers', hex: '#6b6d4e' },
    ...
    { name: 'Honeycomb Glow', hex: '#e4cf99' },
    { name: 'Honeydew', hex: '#f0fff0' },
    { name: 'Honeydew Sand', hex: '#eece8d' },
    { name: 'Honeyed Glow', hex: '#efc488' },
    { name: 'Honeypot', hex: '#ffc863' },
    ...
    { name: 'Iced Coffee', hex: '#aa895d' },
    { name: 'Icelandic Winter', hex: '#d9e7e3' },
    { name: 'Icy Breeze', hex: '#c4ecf0' },
    { name: 'Icy Pink', hex: '#f5ced8' },
    { name: 'Icy Plains', hex: '#cfdafb' },
    { name: 'Igniting', hex: '#f4d69a' },
    { name: 'Iguana', hex: '#878757' },
    ...
    { name: 'Imperial Purple', hex: '#5b3167' },
    ...
    { name: 'In the Twilight', hex: '#84838e' },
    { name: 'In the Vines', hex: '#5c457b' },
    { name: 'Inca Gold', hex: '#aa6d28' },
    ...
    { name: 'Inkwell Inception', hex: '#1e1e21' },
    ...
    { name: 'Joyous Red', hex: '#ae2719' },
    { name: 'Jubilant Jade', hex: '#44aa77' },
    { name: 'Jubilant Meadow', hex: '#7bb92b' },
    ...
    { name: 'Little Princess', hex: '#e6aac1' },
    { name: 'Liver', hex: '#654a46' },
    { name: 'Lizard', hex: '#7b6943' },
    ...
    { name: 'Medieval Blue', hex: '#2e3858' },
    { name: 'Mediterranea', hex: '#39636a' },
    { name: 'Mediterranean Blue', hex: '#1682b9' },
    ...
    { name: 'Midnight Edition', hex: '#0c121b' },
    { name: 'Midnight Express', hex: '#21263a' },
    { name: 'Midnight in Tokyo', hex: '#000088' },
    { name: 'Midnight Interlude', hex: '#32496f' },
    { name: 'Midnight Masquerade', hex: '#2c2e47' },
    { name: 'Midnight Melancholia', hex: '#002266' },
    { name: 'Midnight Mirage', hex: '#001f3f' },
    { name: 'Midnight Ocean', hex: '#0f2d4d' },
    { name: 'Midnight Pie', hex: '#372d52' },
    ...
    { name: 'Midnight Velvet', hex: '#2a2243' },
    ...
    { name: 'Minted Elegance', hex: '#6ec9a3' },
    { name: 'Mintnight', hex: '#7cbbae' },
    { name: 'Minty Fresh', hex: '#d2f2e7' },
    ...
    { name: 'Misty Harbor', hex: '#65769a' },
    { name: 'Misty Haze', hex: '#cec9c3' },
    ...
    { name: 'Mountain View', hex: '#394c3b' },
    { name: 'Moutarde de Bénichon', hex: '#bf9005' },
    { name: 'Mr. Krabs', hex: '#d04127' },
    ...
    { name: 'Neptune’s Dream', hex: '#003368' },
    ...
    { name: 'Nightly Walk', hex: '#544563' },
    { name: 'Nightmare', hex: '#112211' },
    { name: 'Nile', hex: '#afb982' },
    { name: 'Nimbus Cloud', hex: '#c8c8cc' },
    ...
    { name: 'Noble Chocolate', hex: '#6d4433' },
    { name: 'Noble Cream', hex: '#e1dace' },
    ...
    { name: 'Ocean Slumber', hex: '#41767b' },
    { name: 'Ocean’s Embrace', hex: '#306a78' },
    { name: 'Oceanic Motion', hex: '#1d5c83' },
    { name: 'Oceanic Noir', hex: '#172b36' },
    ...
    { name: 'Orange Clown Fish', hex: '#ff550e' },
    ...
    { name: 'Orange You Glad', hex: '#ffa601' },
    ...
    { name: 'Oriole', hex: '#ff8008' },
    { name: 'Otterly Brown', hex: '#8c4512' },
    ...
    { name: 'Pepper Green', hex: '#007d58' },
    { name: 'Peppermint', hex: '#d7e7d0' },
    { name: 'Peppermint Swirl', hex: '#d35d7d' },
    ...
    { name: 'Pine Scented Lagoon', hex: '#066f6c' },
    { name: 'Pineapple', hex: '#563c0d' },
    { name: 'Pineapple Gold', hex: '#ffc72c' },
    ...
    { name: 'Pink Champagne', hex: '#e8dfed' },
    ...
    { name: 'Pink Marshmallow', hex: '#f4b6d1' },
    ...
    { name: 'Pistachio Shell', hex: '#cfc5af' },
    ...
    { name: 'Plein Air', hex: '#b9c4d2' },
    { name: 'Plum', hex: '#66386a' },
    ...
    { name: 'Polar Opposite', hex: '#c2d6ec' },
    ...
    { name: 'Purple Passion', hex: '#784674' },
    ...
    { name: 'Purple Zergling', hex: '#a15589' },
    ...
    { name: 'Quiet Harbour', hex: '#5a789a' },
    { name: 'Quill Grey', hex: '#cbc9c0' },
    { name: 'Quince', hex: '#d4cb60' },
    { name: 'Race the Sun', hex: '#eef3d0' },
    { name: 'Racing Red', hex: '#c21727' },
    { name: 'Radiant Foliage', hex: '#659c35' },
    { name: 'Radiant Hulk', hex: '#10f144' },
    { name: 'Radiant Raspberry', hex: '#e31b5d' },
    ...
    { name: 'Red Inferno', hex: '#bb1e1e' },
    { name: 'Red Mana', hex: '#f95554' },
    { name: 'Red Menace', hex: '#aa2121' },
    { name: 'Red Mist', hex: '#c92b1e' },
    ...
    { name: 'Root Beer', hex: '#81544a' },
    { name: 'Rosé', hex: '#f7746b' },
    { name: 'Rose Ashes', hex: '#b5acab' },
    { name: 'Rose Elegance', hex: '#e9a1b8' },
    { name: 'Rose Haze', hex: '#ecc5c0' },
    { name: 'Rose Laffy Taffy', hex: '#a6465b' },
    { name: 'Roseate Spoonbill', hex: '#e0adc4' },
    ...
    { name: 'Royal Robe', hex: '#614a7b' },
    { name: 'Royal Star', hex: '#fede4f' },
    { name: 'Royalty', hex: '#5930a9' },
    { name: 'Rrosy-Fingered Dawn', hex: '#c11c84' },
    ...
    { name: 'Saffronaut', hex: '#932a25' },
    { name: 'Sage', hex: '#87ae73' },
    { name: 'Sage Sensation', hex: '#b2e191' },
    ...
    { name: 'Saltwater Denim', hex: '#145c78' },
    { name: 'Salty Ice', hex: '#cce2f3' },
    { name: 'Salvia', hex: '#a8b59e' },
    { name: 'Samba', hex: '#aa262b' },
    ...
    { name: 'Seafoam Slate', hex: '#a6bcbe' },
    { name: 'Seafoam Splashes', hex: '#b0efce' },
    { name: 'Seafoam Whisper', hex: '#a1bdbf' },
    { name: 'Seashell', hex: '#fff5ee' },
    { name: 'Seaside', hex: '#66a4b0' },
    ...
    { name: 'Shadow of the Colossus', hex: '#a3a2a1' },
    ...
    { name: 'Sheaf', hex: '#d2ae84' },
    { name: 'Sheikh White', hex: '#efecee' },
    { name: 'Shiitake', hex: '#a5988a' },
    ...
    { name: 'Shivering Green', hex: '#24dd7e' },
    { name: 'Shocking Crimson', hex: '#ff0d04' },
    { name: 'Shocking Orange', hex: '#ff6e1c' },
    { name: 'Shocking Pink', hex: '#fe02a2' },
    { name: 'Shōji', hex: '#ded5c7' },
    { name: 'Shortbread', hex: '#f5e6d3' },
    ...
    { name: 'Shy Champagne Blush', hex: '#dea392' },
    { name: 'Shy Young Salmon', hex: '#dfb8bc' },
    ...
    { name: 'Silent Snowfall', hex: '#eef7fa' },
    ...
    { name: 'Silver Lining', hex: '#b8b1a5' },
    { name: 'Silver Mistral', hex: '#b4b9b9' },
    ...
    { name: 'Smidgen of Love', hex: '#f0ccd9' },
    ...
    { name: 'Smoky', hex: '#605d6b' },
    { name: 'Smoky Charcoal', hex: '#34282c' },
    ...
    { name: 'Sparkling Cosmo', hex: '#f9736e' },
    ...
    { name: 'Stellar Strawberry', hex: '#ff5c8d' },
    { name: 'Stereotypical Duck', hex: '#fff5cf' },
    { name: 'Sterling', hex: '#d1d4d1' },
    ...
    { name: 'Stormy Waters', hex: '#84a9b0' },
    { name: 'Straw Gold', hex: '#fcf679' },
    { name: 'Strawberry', hex: '#fb2943' },
    { name: 'Strawberry Avalanche', hex: '#ef4f41' },
    ...
    { name: 'Strawberry Memory', hex: '#e2958d' },
    ...
    { name: 'Sugar Cookie Crust', hex: '#e8cfb1' },
    ...
    { name: 'Testosterose', hex: '#ddaaff' },
    { name: 'Thai Chili', hex: '#ce0001' },
    { name: 'Thai Hot', hex: '#fe1c06' },
    { name: 'Thalassa', hex: '#53b1ba' },
    ...
    { name: 'Toreador', hex: '#cd123f' },
    { name: 'Torrefacto Roast', hex: '#4e241e' },
    { name: 'Tortilla', hex: '#efdba7' },
    { name: 'Tostada', hex: '#e3c19c' },
    { name: 'Tosty Crust', hex: '#a67e4b' },
    { name: 'Total Eclipse', hex: '#303543' },
    ...
    { name: 'Two Peas in a Pod', hex: '#a5ca4f' },
    ...
    { name: 'Vanilla Cake', hex: '#fcf0ca' },
    { name: 'Vanilla Cream', hex: '#f8e3ab' },
    { name: 'Vanilla Drop', hex: '#ffffeb' },
    { name: 'Vanilla Ice', hex: '#fdf2d1' },
    { name: 'Vanilla Sugar', hex: '#f1e8dc' },
    ...
    { name: 'Velvet Volcano', hex: '#ab0102' },
    { name: 'Velvet Vortex', hex: '#540d6e' },
    ...
    { name: 'Vibrant Orange', hex: '#ff6216' },
    ...
    { name: 'Walking on Sunshine', hex: '#fcfc9d' },
    ...
    { name: 'Whisper White', hex: '#eae2d3' },
    { name: 'Whispering Frost', hex: '#d7e5d8' },
    { name: 'Whispering Smoke', hex: '#d8d8d4' },
    { name: 'Whispering Willow', hex: '#919c81' },
    { name: 'Whispery Breeze', hex: '#d6e9e6' },
    ...
    { name: 'White Christmas', hex: '#f4e8e8' },
    ...
    { name: 'Woodland Wonder', hex: '#0d6323' },
    ...
    { name: 'Yell for Yellow', hex: '#fffe00' },
    ...
    { name: 'Yoghurt Brûlée', hex: '#f5e9ce' },
    ...
    { name: 'Your Darkness', hex: '#220044' },
    { name: 'Your Majesty', hex: '#61496e' },
    { name: 'Your Shadow', hex: '#787e93' },
    { name: 'Yours Truly', hex: '#fbd9cd' },
    ...
    { name: 'Zen Garden Olive', hex: '#445533' },
