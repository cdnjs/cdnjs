  ...
  return function() {
    ...
    class Particle {
      constructor(id, container, engine, position, overrideOptions, group) {
        ...
        this.pathDelay = getRangeValue(this.options.move.path.delay) * 1e3;
    ...
    class Particles {
      constructor(engine, container) {
        ...
        this.interactionManager = new InteractionManager(container, Particles_classPrivateFieldGet(this, _Particles_engine, "f"));
        const canvasSize = this.container.canvas.size;
      ...
      pushParticle(position, overrideOptions, group, initializer) {
        try {
          const particle = new Particle(this.nextId, this.container, Particles_classPrivateFieldGet(this, _Particles_engine, "f"), position, overrideOptions, group);
          let canAdd = true;
          if (initializer) {
