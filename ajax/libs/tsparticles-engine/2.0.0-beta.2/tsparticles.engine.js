(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return function() {
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      ParticleOutType: function() {
        return ParticleOutType;
      },
    ...
    const canvasClass = "tsparticles-canvas-el";
    ...
    class Container {
      constructor(id, sourceOptions, ...presets) {
        ...
        Loader.dispatchEvent(EventType.containerBuilt, {
          container: this
        });
      }
      get options() {
      ...
      play(force) {
        ...
        Loader.dispatchEvent(EventType.containerPlay, {
          container: this
        });
      ...
      pause() {
        ...
        Loader.dispatchEvent(EventType.containerPaused, {
          container: this
        });
      }
      draw(force) {
      ...
      destroy() {
        ...
        this.destroyed = true;
        Loader.dispatchEvent(EventType.containerDestroyed, {
          container: this
        });
      }
      exportImg(callback) {
      ...
      stop() {
        ...
        Loader.dispatchEvent(EventType.containerStopped, {
          container: this
        });
      }
      ...
      async start() {
        ...
        Loader.dispatchEvent(EventType.containerStarted, {
          container: this
        });
        this.play();
      }
      ...
      async init() {
        ...
        Loader.dispatchEvent(EventType.containerInit, {
          container: this
        });
        this.particles.init();
        ...
        Loader.dispatchEvent(EventType.particlesSetup, {
          container: this
        });
      }
    ...
    var main_classPrivateFieldSet = undefined && undefined.__classPrivateFieldSet || function(receiver, state, value, kind, f) {
      if (kind === "m") throw new TypeError("Private method is not writable");
      if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
      if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
      return kind === "a" ? f.call(receiver, value) : f ? f.value = value : state.set(receiver, value), 
    ...
    class Main {
      constructor() {
        ...
        main_classPrivateFieldSet(this, _Main_initialized, false, "f");
      }
      init() {
        if (!main_classPrivateFieldGet(this, _Main_initialized, "f")) {
          main_classPrivateFieldSet(this, _Main_initialized, true, "f");
        }
      }
