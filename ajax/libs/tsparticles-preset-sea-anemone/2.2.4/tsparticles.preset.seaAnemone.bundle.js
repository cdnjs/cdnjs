...
__webpack_require__.d(__webpack_exports__, {
  "loadSeaAnemonePreset": function() { return /* reexport */ loadSeaAnemonePreset; },
...
function CurvesPathGen(rndFunc, period, nbHarmonics, attenHarmonics, lowValue = 0, highValue = 1) {
  const arP0 = [],
        ...
        increments = [],
        phases = [],
        randomFunc = rndFunc !== null && rndFunc !== void 0 ? rndFunc : getRandom;
  let globAmplitude = 0;
...
class CurvesPathGenerator {
  ...
  generate(p) {
    ...
    if (p.curveVelocity === undefined) {
      p.curveVelocity = Vector_Vector.origin;
...
class EmitterInstance {
  ...
  emitParticles(quantity) {
    ...
    const position = this.getPosition(),
          size = this.getSize(),
          singleParticlesOptions = this.particlesOptions instanceof Array ? itemFromArray(this.particlesOptions) : this.particlesOptions;
