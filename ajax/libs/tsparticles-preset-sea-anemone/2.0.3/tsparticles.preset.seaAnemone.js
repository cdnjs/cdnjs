...
function loadSeaAnemonePreset(engine) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    yield (0,external_commonjs_tsparticles_path_curves_commonjs2_tsparticles_path_curves_amd_tsparticles_path_curves_root_window_.loadCurvesPath)(engine);
    yield engine.addPreset(presetName, options);
  });
}
}();
