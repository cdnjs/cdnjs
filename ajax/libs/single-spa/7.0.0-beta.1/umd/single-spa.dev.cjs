/* single-spa@7.0.0-beta.1 - UMD - dev */
(function (global, factory) {
	...
	const LOADING_SOURCE_CODE = AppOrParcelStatus.LOADING_SOURCE_CODE;
	const NOT_BOOTSTRAPPED = AppOrParcelStatus.NOT_BOOTSTRAPPED;
	const BOOTSTRAPPING = AppOrParcelStatus.BOOTSTRAPPING;
	const NOT_MOUNTED = AppOrParcelStatus.NOT_MOUNTED;
	const MOUNTING = AppOrParcelStatus.MOUNTING;
	const MOUNTED = AppOrParcelStatus.MOUNTED;
	const UPDATING = AppOrParcelStatus.UPDATING;
	const UNMOUNTING = AppOrParcelStatus.UNMOUNTING;
	const UNLOADING = AppOrParcelStatus.UNLOADING;
	const LOAD_ERROR = AppOrParcelStatus.LOAD_ERROR;
	const SKIP_BECAUSE_BROKEN = AppOrParcelStatus.SKIP_BECAUSE_BROKEN;
