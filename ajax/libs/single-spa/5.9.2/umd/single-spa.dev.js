...
(function (global, factory) {
  ...
  (global = global || self, factory(global.singleSpa = {}, global.singleSpa$1));
}(this, (function (exports, singleSpa$1) { 'use strict';
  ...
  function toUnloadPromise(app) {
    return Promise.resolve().then(function () {
      ...
      if (app.status !== NOT_MOUNTED && app.status !== singleSpa$1.LOAD_ERROR) {
        /* The app cannot be unloaded until it is unmounted.
         */
        return app;
      }

      var unloadPromise = app.status === singleSpa$1.LOAD_ERROR ? Promise.resolve() : reasonableTime(app, "unload");
