/* single-spa@5.9.2 - SystemJS - dev */
System.register(['single-spa'], function (exports) {
  'use strict';
  var LOAD_ERROR$1;
  return {
    setters: [function (module) {
      LOAD_ERROR$1 = module.LOAD_ERROR;
    }],
    execute: function () {
      ...
      function toUnloadPromise(app) {
        return Promise.resolve().then(function () {
          ...
          var unloadPromise = app.status === LOAD_ERROR$1 ? Promise.resolve() : reasonableTime(app, "unload");
