/* single-spa@7.0.0-beta.6 - SystemJS - dev */
  ...
  return {
    execute: (function () {
      ...
      var singleSpa = /*#__PURE__*/Object.freeze({
        __proto__: null,
        get AppOrParcelStatus () { return AppOrParcelStatus; },
        ...
        get setInitMaxTime () { return setInitMaxTime; },
      ...
      // App statuses
      let AppOrParcelStatus = exports("AppOrParcelStatus", /*#__PURE__*/function (AppOrParcelStatus) {
      ...
      function mountParcel(config, customProps) {
        ...
        const mountPromise = initPromise.then(() => toMountPromise(parcel, true));
...
//# sourceMappingURL=single-spa.dev.cjs.map
