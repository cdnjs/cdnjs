/* single-spa@7.0.0-beta.7 - UMD - dev */
(function (global, factory) {
    ...
    var singleSpa = /*#__PURE__*/Object.freeze({
        __proto__: null,
        get AppOrParcelStatus () { return exports.AppOrParcelStatus; },
    ...
    // App statuses
    exports.AppOrParcelStatus = void 0;
    ...
    })(exports.AppOrParcelStatus || (exports.AppOrParcelStatus = {}));
    function isActive(app) {
      return app.status === exports.AppOrParcelStatus.MOUNTED;
    }
    function shouldBeActive(app) {
      try {
        return app.activeWhen(window.location);
      } catch (err) {
        handleAppError(err, app, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
        return false;
      }
    }
    function toName(app) {
    ...
    function toInitPromise(appOrParcel, hardFail) {
      ...
      return Promise.resolve().then(() => {
        if (appOrParcel.status !== exports.AppOrParcelStatus.NOT_INITIALIZED) {
          return appOrParcel;
        }
        {
        ...
        appOrParcel.status = exports.AppOrParcelStatus.INITIALIZING;
        return reasonableTime(appOrParcel, "init").then(successfulInit).catch(err => {
          ...
          if (hardFail) {
            throw transformErr(err, appOrParcel, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
          } else {
            handleAppError(err, appOrParcel, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
            return appOrParcel;
          }
        });
      });
      function successfulInit() {
        appOrParcel.status = exports.AppOrParcelStatus.NOT_MOUNTED;
        {
    ...
    function toUnmountPromise(appOrParcel, hardFail) {
      return Promise.resolve().then(() => {
        if (appOrParcel.status !== exports.AppOrParcelStatus.MOUNTED) {
          return appOrParcel;
        }
        let startTime, profileEventType;
        {
        ...
        appOrParcel.status = exports.AppOrParcelStatus.UNMOUNTING;
        ...
        return Promise.all(unmountChildrenParcels).then(unmountAppOrParcel, parcelError => {
          ...
          return unmountAppOrParcel().then(() => {
            ...
            if (hardFail) {
              throw transformErr(parentError, appOrParcel, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
            } else {
              handleAppError(parentError, appOrParcel, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
            }
          });
        }).then(() => appOrParcel);
    ...
    function toMountPromise(appOrParcel, hardFail) {
      return Promise.resolve().then(() => {
        if (appOrParcel.status !== exports.AppOrParcelStatus.NOT_MOUNTED) {
          return appOrParcel;
        }
        let startTime, profileEventType;
        {
        ...
        appOrParcel.status = exports.AppOrParcelStatus.MOUNTING;
        return reasonableTime(appOrParcel, "mount").then(() => {
          appOrParcel.status = exports.AppOrParcelStatus.MOUNTED;
          if (!firstMountFired) {
    ...
    function toUpdatePromise(appOrParcel) {
      return Promise.resolve().then(() => {
        ...
        appOrParcel.status = exports.AppOrParcelStatus.UPDATING;
    ...
    function mountParcel(config, customProps) {
      ...
      const parcel = {
        id,
        parcels: {},
        status: passedConfigLoadingFunction ? exports.AppOrParcelStatus.LOADING_SOURCE_CODE : exports.AppOrParcelStatus.NOT_INITIALIZED,
        customProps,
        parentName: toName(owningAppOrParcel),
        unmountThisParcel() {
          return mountPromise.then(() => {
            if (parcel.status !== exports.AppOrParcelStatus.MOUNTED) {
            ...
            parcel.status = exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN;
            rejectUnmount(err);
            throw err;
          });
        }
      ...
      loadPromise = loadPromise.then(config => {
        ...
        parcel.status = exports.AppOrParcelStatus.NOT_INITIALIZED;
        parcel.name = name;
        parcel.init = init;
        parcel.mount = mount;
      ...
      let externalRepresentation = {
        mount() {
          return promiseWithoutReturnValue(Promise.resolve().then(() => {
            if (parcel.status !== exports.AppOrParcelStatus.NOT_MOUNTED) {
    ...
    function toLoadPromise(app) {
      return Promise.resolve().then(() => {
        ...
        if (app.status !== exports.AppOrParcelStatus.NOT_LOADED && app.status !== exports.AppOrParcelStatus.LOAD_ERROR) {
          return app;
        }
        let startTime;
        {
        ...
        appBeingLoaded.status = exports.AppOrParcelStatus.LOADING_SOURCE_CODE;
        ...
        return appBeingLoaded.loadPromise = Promise.resolve().then(() => {
          ...
          return loadPromise.then(val => {
            ...
            if (validationErrCode) {
              ...
              handleAppError(validationErrMessage, appBeingLoaded, exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN);
            ...
            appBeingLoaded.status = exports.AppOrParcelStatus.NOT_INITIALIZED;
          ...
          let newStatus;
          if (isUserErr) {
            newStatus = exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN;
          } else {
            newStatus = exports.AppOrParcelStatus.LOAD_ERROR;
    ...
    function toUnloadPromise(app) {
      return Promise.resolve().then(() => {
        ...
        if (app.status === exports.AppOrParcelStatus.NOT_LOADED) {
        ...
        if (app.status === exports.AppOrParcelStatus.UNLOADING) {
          /* Both unloadApplication and reroute want to unload this app.
           * It only needs to be done once, though.
           */
          return unloadInfo.promise.then(() => app);
        }
        if (app.status !== exports.AppOrParcelStatus.NOT_MOUNTED && app.status !== exports.AppOrParcelStatus.LOAD_ERROR && app.status !== exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN) {
        ...
        app.status = exports.AppOrParcelStatus.UNLOADING;
    ...
    function finishUnloadingApp(app, unloadInfo) {
      ...
      delete app.unmount;
      delete app.unload;
      app.status = exports.AppOrParcelStatus.NOT_LOADED;
    ...
    function getAppChanges() {
      ...
      apps.forEach(app => {
        const appShouldBeActive = app.status !== exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN && shouldBeActive(app);
        switch (app.status) {
          case exports.AppOrParcelStatus.LOAD_ERROR:
            if (appShouldBeActive && currentTime - app.loadErrorTime >= 200) {
              appsToLoad.push(app);
            }
            break;
          case exports.AppOrParcelStatus.NOT_LOADED:
          case exports.AppOrParcelStatus.LOADING_SOURCE_CODE:
            if (appShouldBeActive) {
              appsToLoad.push(app);
            }
            break;
          case exports.AppOrParcelStatus.NOT_INITIALIZED:
          case exports.AppOrParcelStatus.NOT_MOUNTED:
            ...
            break;
          case exports.AppOrParcelStatus.MOUNTED:
            if (!appShouldBeActive) {
    ...
    function registerApplication(appNameOrConfig, appOrLoadApp, activeWhen, customProps) {
      ...
      apps.push(Object.assign({
        loadErrorTime: null,
        status: exports.AppOrParcelStatus.NOT_LOADED,
        parcels: {},
        devtools: {
          overlays: {
            options: {},
    ...
    function reroute(pendingPromises = [], eventArguments = undefined, silentNavigation = false) {
      ...
      function getCustomEventDetail(isBeforeChanges = false, extraProperties) {
        ...
        const appsByNewStatus = {
          ...
          [exports.AppOrParcelStatus.MOUNTED]: [],
          // for apps that were unmounted
          [exports.AppOrParcelStatus.NOT_MOUNTED]: [],
          // apps that were forcibly unloaded
          [exports.AppOrParcelStatus.NOT_LOADED]: [],
          // apps that attempted to do something but are broken now
          [exports.AppOrParcelStatus.SKIP_BECAUSE_BROKEN]: []
        };
        if (isBeforeChanges) {
          appsToLoad.concat(appsToMount).forEach((app, index) => {
            addApp(app, exports.AppOrParcelStatus.MOUNTED);
          });
          appsToUnload.forEach(app => {
            addApp(app, exports.AppOrParcelStatus.NOT_LOADED);
          });
          appsToUnmount.forEach(app => {
            addApp(app, exports.AppOrParcelStatus.NOT_MOUNTED);
          });
        } else {
    ...
    var devtools = {
      getRawAppData,
      reroute,
      NOT_LOADED: exports.AppOrParcelStatus.NOT_LOADED,
      toLoadPromise,
    ...
    exports.setInitMaxTime = setInitMaxTime;
