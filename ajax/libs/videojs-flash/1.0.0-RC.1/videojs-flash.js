...
module.exports={
  ...
  "gitHead": "b903e6abdb2a1b1565dee8e550bcbecb655d27c2",
  "bugs": {
    "url": "https://github.com/videojs/video-js-swf/issues"
  },
  "_id": "videojs-swf@5.2.0",
  "_shasum": "ae20a60f8dc7746ce52de845b51dd46798ea5cfa",
  ...
  "dist": {
    "shasum": "ae20a60f8dc7746ce52de845b51dd46798ea5cfa",
    "tarball": "https://registry.npmjs.org/videojs-swf/-/videojs-swf-5.2.0.tgz"
  },
  "maintainers": [
    {
      "name": "heff",
  ...
  "_npmOperationalInternal": {
    ...
    "tmp": "tmp/videojs-swf-5.2.0.tgz_1486496894096_0.4415081855840981"
  },
  "directories": {},
  "_resolved": "https://registry.npmjs.org/videojs-swf/-/videojs-swf-5.2.0.tgz",
...
var _rtmp = require('./rtmp');

var _rtmp2 = _interopRequireDefault(_rtmp);
...
var Dom = _video2['default'].dom;
var Url = _video2['default'].url;
...
var Flash = function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      var ver = require('videojs-swf/package.json').version;
...
(0, _rtmp2['default'])(Flash);

if (Tech.getTech('Flash')) {
  _video2['default'].log.warn('Not using videojs-flash as it appears to already be registered');
  _video2['default'].log.warn('videojs-flash should only be used with video.js@6 and above');
} else {
  _video2['default'].registerTech('Flash', Flash);
}

exports['default'] = Flash;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./rtmp":1,"global/window":2,"videojs-swf/package.json":3}]},{},[4])(4)
});