...
var navigator = global.window && global.window.navigator || {};
...
Flash.version = function () {
  ...
  // IE
  try {
    version = new global.window.ActiveXObject('ShockwaveFlash.ShockwaveFlash').GetVariable('$version').replace(/\D+/g, ',').match(/^,?(.+),?$/)[1];
