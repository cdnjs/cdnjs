...
var Flash = function (_Tech) {
  ...
  Flash.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
    ...
    } else if (global.window.performance && global.window.performance.timing && typeof global.window.performance.timing.navigationStart === 'number') {
      videoPlaybackQuality.creationTime = global.window.Date.now() - global.window.performance.timing.navigationStart;
    }
