...
function isoToEpochNano(e) {
  ...
  if (void 0 !== n) {
    ...
    return [ t, o * He + (e.isoMicrosecond || 0) * ko + (e.isoNanosecond || 0) ];
  }
}
...
function formatIsoTimeFields(e, n) {
  const t = [ Fo(e.isoHour), Fo(e.isoMinute) ];
  return -1 !== n && t.push(Fo(e.isoSecond) + ((e, n, t, o) => formatSubsecNano(e * He + n * ko + t, o))(e.isoMillisecond, e.isoMicrosecond, e.isoNanosecond, n)), 
  t.join(":");
}
...
function getSingleInstantFor(e, n, t = 0, o = e.I(n)) {
  ...
  const r = isoToEpochNano(n), i = ((e, n) => {
    const t = e.R(moveBigNano(n, -Zo));
    return (e => {
      if (e > Zo) {
        throw new RangeError(po);
      }
      return e;
    })(e.R(moveBigNano(n, Zo)) - t);
  })(e, r), a = i * (2 === t ? -1 : 1);
...
function fe(e, n, t) {
  ...
  return n ? o.calendar === l && (o = -271821 === o.isoYear && 4 === o.isoMonth ? {
    ...
    ...o,
    isoYear: br
  }), R(o.C ? finalizeDateTime(o) : finalizeDate(o));
}
...
function qt(e, n) {
  ...
  const o = fe(n, 0, 1), {calendar: r} = o, i = e(r), [a, s, c] = i.v(o), [u, l] = i.q(a, s), [d, m] = i.G(u, l, c);
  return createPlainMonthDaySlots(checkIsoDateInBounds(i.V(d, m, c)), r);
}
...
function F(e) {
  ...
  return n && (n.timeZone || n.j && ii || n.offset) || e;
}
...
function diffDateLike(e, n, t, o, r, i, a, s, c = 6) {
  ...
  if (compareBigNanos(l, u)) {
    if (6 === r) {
      ...
      const e = n();
      f = e.N(t, o, r), i === c && 1 === a || (f = roundRelativeDuration(f, l, r, i, a, s, e, t, isoToEpochNano, moveDate));
    }
  } else {
    f = dr;
  }
...
function createIntlYearDataCache(e) {
  ...
  return en((t => {
    ...
    do {
      if (r += (1 - o.day) * Oo, o.year === t && (a.push(r), s.push(o.o)), r -= Oo, ++i > 100 || r < -yr) {
        throw new RangeError("BAD!");
      }
    } while ((o = e(r)).year >= t);
    return {
...
function G(e, n, t, o) {
  ...
  if (void 0 !== r.timeZone) {
    const o = t.B(r), i = refineTimeBag(r), a = e(r.timeZone);
    return {
...
function ye(e, n, t, o, r, i) {
  const a = refineCalendarFields(t, r, Ko, qo, jo), s = e(a.timeZone), [c, u, l] = Ze(i), f = t.B(a, fabricateOverflowOptions(c)), d = refineTimeBag(a, c);
...
function jt(e, n, t) {
  ...
  return Zt(checkIsoDateTimeInBounds({
    ...e.B(o, fabricateOverflowOptions(r)),
    ...refineTimeBag(o, r)
  }));
}
...
function Te(e, n, t, o, r) {
  const {calendar: i, timeZone: a} = t, s = e(i), c = n(a), u = [ ...s.fields(Ko), ...Wo ].sort(), l = (e => {
    const n = Se(e, Y), t = me(n.offsetNanoseconds), o = qi(e.calendar), [r, i, a] = o.v(n), [s, c] = o.q(r, i), u = formatMonthCode(s, c);
    return {
      ...Li(n),
      year: r,
      monthCode: u,
  ...
  })(t), f = refineFields(o, u), d = s.k(l, f), m = {
    ...l,
    ...f
  }, [p, h, g] = Ze(r, 2);
  return Ue(getMatchingInstantFor(c, {
    ...s.B(d, fabricateOverflowOptions(p)),
...
function ht(e, n, t, o) {
  ...
  var s;
  const c = refineFields(t, i), u = ut(o), l = r.k(a, c), f = {
    ...a,
    ...c
  };
  return Zt(checkIsoDateTimeInBounds({
    ...r.B(l, fabricateOverflowOptions(u)),
    ...constrainIsoTimeFields(ji(f), u)
  }));
}

function _t(e, n, t, o) {
  const r = e(n.calendar), i = r.fields(Ko).sort(), a = computeDateEssentials(n), s = refineFields(t, i), c = r.k(a, s);
  return r.B(c, o);
}

function Rt(e, n, t, o) {
  const r = e(n.calendar), i = r.fields(_o).sort(), a = (e => {
    const n = qi(e.calendar), [t, o] = n.v(e), [r, i] = n.q(t, o);
    return {
      year: t,
...
function Nt(e, n, t, o) {
  const r = e(n.calendar), i = r.fields(Ko).sort(), a = (e => {
    const n = qi(e.calendar), [t, o, r] = n.v(e), [i, a] = n.q(t, o);
    return {
...
function convertToIso(e, n, t, o, r) {
  ...
  let i = e.k(n, o);
  return i = refineFields(i, [ ...t, ...r ].sort(), []), e.B(i);
}
...
function createOptionsTransformer(e, n, t) {
  ...
  return (r, i) => {
    ...
    return t && (r.timeZone = ii, [ "full", "long" ].includes(r.J) && (r.J = "medium")), 
    r;
  };
}
...
class IntlTimeZone {
  ...
  R(e) {
    return this.nn.rn((e => epochNanoToSecMod(e)[0])(e)) * Co;
  }
  I(e) {
    const [n, t] = [ isoArgsToEpochSec((o = e).isoYear, o.isoMonth, o.isoDay, o.isoHour, o.isoMinute, o.isoSecond), o.isoMillisecond * He + o.isoMicrosecond * ko + o.isoNanosecond ];
    var o;
    return this.nn.tn(n).map((e => checkEpochNanoInBounds(moveBigNano(xe(e, Co), t))));
  }
  O(e, n) {
...
const fi = "([+-])", di = "(?:[.,](\\d{1,9}))?", mi = `(?:(?:${fi}(\\d{6}))|(\\d{4}))-?(\\d{2})`, pi = "(\\d{2})(?::?(\\d{2})(?::?(\\d{2})" + di + ")?)?", hi = fi + pi, gi = mi + "-?(\\d{2})(?:[T ]" + pi + "(Z|" + hi + ")?)?", Di = "\\[(!?)([^\\]]*)\\]", Ti = `((?:${Di}){0,9})`, Ii = /*@__PURE__*/ createRegExp(mi + Ti), Mi = /*@__PURE__*/ createRegExp("(?:--)?(\\d{2})-?(\\d{2})" + Ti), Ni = /*@__PURE__*/ createRegExp(gi + Ti), yi = /*@__PURE__*/ createRegExp("T?" + pi + "(?:" + hi + ")?" + Ti), vi = /*@__PURE__*/ createRegExp(hi), Pi = /*@__PURE__*/ new RegExp(Di, "g"), Ei = /*@__PURE__*/ createRegExp(`${fi}?P(\\d+Y)?(\\d+M)?(\\d+W)?(\\d+D)?(?:T(?:(\\d+)${di}H)?(?:(\\d+)${di}M)?(?:(\\d+)${di}S)?)?`), Si = /*@__PURE__*/ en((e => new _e(Fr, {
  ...
  P(e, n, t) {
    ...
    if (c += durationFieldsToBigNano(n, 5)[0], i || a) {
      r = ((e, n, t, o, r) => {
        ...
        if (t) {
          const [n, o] = e.q(i, a);
          i += t, a = monthCodeNumberToMonth(n, o, e.F(i)), a = clampEntity("month", a, 1, e.L(i), r);
        }
  ...
  N(e, n, t) {
    ...
    let [i, a, s] = ((e, n, t, o, r, i, a) => {
      ...
      if (s || c) {
        ...
        if (Math.sign(u) === -l) {
          const o = f;
          [r, i] = e.un(r, i, -l), s = r - n, c = i - t, f = e.U(r, i), d = l < 0 ? -o : f;
        }
        if (u = a - Math.min(o, f) + d, s) {
          const [o, a] = e.q(n, t), [u, f] = e.q(r, i);
          if (c = u - o || Number(f) - Number(a), Math.sign(c) === -l) {
            const t = l < 0 && -e.L(r);
            s = (r -= l) - n, c = i - monthCodeNumberToMonth(o, a, e.F(r)) + (t || e.L(r));
          }
        }
      }
      return [ s, c, u ];
  ...
  B(e, n) {
    ...
    return R(checkIsoDateInBounds(this.V(o, r, i)), this.id || l);
  },
  K(e, n) {
  ...
  p: isoArgsToEpochMilli,
  un: (e, n, t) => (e += divTrunc(t, Or), (n += modTrunc(t, Or)) < 1 ? (e--, n += Or) : n > Or && (e++, 
  n -= Or), [ e, n ]),
  year(e) {
    return e.isoYear;
  },
