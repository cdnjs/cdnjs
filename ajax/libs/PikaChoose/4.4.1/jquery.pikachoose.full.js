...
(function($) {
    ...
    $pc.fn.extend({
         ...
         */
        bindEvents: function() {
        	this.thumbs.unbind('click').bind('click',{self:this},this.imgClick);
        	this.imgNext.unbind('click').bind('click',{self:this},this.nextClick);
        	this.textNext.unbind('click').bind('click',{self:this},this.nextClick);
        	this.imgPrev.unbind('click').bind('click',{self:this},this.prevClick);
        	this.textPrev.unbind('click').bind('click',{self:this},this.prevClick);
        	this.imgPlay.unbind('click').bind('click',{self:this},this.playClick);
        	this.wrap.unbind('mouseenter').bind('mouseenter',{self:this},function(e){
        		e.data.self.imgNav.stop(true,true).fadeTo('slow', 1.0);
				if(e.data.self.options.hoverPause == true){
					clearTimeout(e.data.self.timeOut);
				}
        	});
        	this.wrap.unbind('mouseleave').bind('mouseleave',{self:this},function(e){
			...
			this.tooltip.unbind('mouseenter').bind('mouseenter',{self:this},function(e){
				clearTimeout(e.data.self.stillOut);
			});
			this.tooltip.unbind('mouseleave').bind('mouseleave',{self:this},function(e){
